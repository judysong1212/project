...
//            	addTrigger(Events.KeyUp, changeValueListenerAdapter4);
        ...
        listColumnDefs.add(new ColumnDef("근무일수", Dlgn0250BM.ATTR_DILNLAZPUBCHODYDUTYNUMDYS, ColumnDef.TYPE_STRING , 60, false, true, false){
            {
            	setRegEx("^[+-]?\\d*(\\.?\\d*)$");
            	setSelectOnFocus(true);
            }
        ...
        listColumnDefs.add(new ColumnDef("근무시간", Dlgn0250BM.ATTR_DILNLAZPUBCHODYDUTYTM, ColumnDef.TYPE_STRING , 70, false, true, false){
            {
            	setRegEx("^[+-]?\\d*(\\.?\\d*)$");
            	setSelectOnFocus(true);
//            	setReadOnly(true);
        ...
        listColumnDefs.add(new ColumnDef("연장시간", Dlgn0250BM.ATTR_DILNLAZHODYTOTNTOTTM, ColumnDef.TYPE_STRING , 70, false, true, false){
            {
...
//        });
        ...
        listColumnDefs.add(new ColumnDef("기본근무", Dlgn0250BM.ATTR_DILNLAZFNDTNTMRSTDUTYTM, ColumnDef.TYPE_STRING , 90, false, true, false){
            {
            	setRegEx("^[+-]?\\d*(\\.?\\d*)$");
            	setSelectOnFocus(true);
//            	setReadOnly(true);
        ...
        listColumnDefs.add(new ColumnDef("기본외근무", Dlgn0250BM.ATTR_DILNLAZTMRSTDUTYTM, ColumnDef.TYPE_STRING , 90, false, true, false){
            {
            	setRegEx("^[+-]?\\d*(\\.?\\d*)$");
            	setSelectOnFocus(true);
//            	setReadOnly(true);
        ...
        listColumnDefs.add(new ColumnDef("총시간외근무", Dlgn0250BM.ATTR_DILNLAZTOTTMRSTDUTYTM, ColumnDef.TYPE_STRING , 90, false, true, false){
            {
            	setRegEx("^[+-]?\\d*(\\.?\\d*)$");
            	setSelectOnFocus(true);
//            	setReadOnly(true);
