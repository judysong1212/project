...
//	//중간 근태생성 부분 끝
	...
	private Dlgn0200Def Dlgn0200Def_1 = new Dlgn0200Def("DLGN0200_1"); //시간외근무관리 근무내역등록 GRID (기준일 후)
	// --------- grid,Def 선언 종료 ----------
...
//		fieldRightForm.setSize(622, 145);
		...
		lblfldNewLabelfield_18 = new LabelField("* 연장, 야근, 휴일근무시간 데이터 있을 경우 종료시간 수정시 초기화 됩니다. ");
		...
		// TODO 안성은 금액이 같으므로, 휴일연장근무 입력하지 않도록 처리
		lblfldNewLabelfield_19 = new LabelField("* 연장근무시간 최대입력시간 04:00, 휴일근무시간 최대입력시간 08:00 입니다.");
