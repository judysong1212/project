...
public class Dlgn0250ExcelView extends AbstractExcelView {
...
//        
//  
//        List<Dlgn0250VO> listDlgn0250 = (List<Dlgn0250VO>) model.get("listDlgn0250");
// 
// 
...
//                setText(cell, dlgn0250Vo.getDilnlazYrMnth());  /** column 근태년월 : dilnlazYrMnth */
//                cell = getCell(sheet, 3 + i, 2);
//                setText(cell, dlgn0250Vo.getPayCd());   /** column 급여구분코드 : payCd */  
//                cell = getCell(sheet, 3 + i, 3);
//                setText(cell, dlgn0250Vo.getHanNm());    /** 성명                 */
//                cell = getCell(sheet, 3 + i, 4);
//                setText(cell, dlgn0250Vo.getResnRegnNum());  /** 주민등록번호                 */
//                cell = getCell(sheet, 3 + i, 5); 
//                setText(cell, dlgn0250Vo.getDilnlazDutyNumDys());   /** column 근태_근무일수 : dilnlazDutyNumDys */ 
//                cell = getCell(sheet, 3 + i, 6);
//                setText(cell, dlgn0250Vo.getDilnlazPaidHodyNumDys());  /** column 근태_유급휴가일수 : dilnlazPaidHodyNumDys */
//                cell = getCell(sheet, 3 + i, 7);
//                setText(cell, dlgn0250Vo.getDilnlazTotDutyNumDys());   /** column 근태_총근무일수 : dilnlazTotDutyNumDys */
//                cell = getCell(sheet, 3 + i, 8);
//                setText(cell, dlgn0250Vo.getDilnlazSpclHodyNumDys());    /** column 근태_특별휴가일수 : dilnlazSpclHodyNumDys */  
//               // dlgn0250Vo.setDilnlazLvsgNumDys(EgovExcelUtil.getValue(cell2));    /** column 근태_연가일수 : dilnlazLvsgNumDys */
//                cell = getCell(sheet, 3 + i, 9);
//                setText(cell, dlgn0250Vo.getDilnlazAbnceNumDys());   /** column 근태_결근일수 : dilnlazAbnceNumDys */
//                cell = getCell(sheet, 3 + i, 10);
//                setText(cell, dlgn0250Vo.getDilnlazAbnceDutyRcgtnDys());   /** column 근태_결근인정일수 : dilnlazAbnceDutyRcgtnDys */
//                cell = getCell(sheet, 3 + i, 11);
//                setText(cell, dlgn0250Vo.getDilnlazSckleaNumDys());    /** column 근태_병가일수 : dilnlazSckleaNumDys */
//                cell = getCell(sheet, 3 + i, 12);
//                setText(cell, dlgn0250Vo.getDilnlazOffvaNumDys());    /** column 근태_공가일수 : dilnlazOffvaNumDys */
//                cell = getCell(sheet, 3 + i, 13);
//                setText(cell, dlgn0250Vo.getDilnlazFmlyEvntNumDys());     /** column 근태_경조사일수 : dilnlazFmlyEvntNumDys */
//                cell = getCell(sheet, 3 + i, 14);
//                setText(cell, dlgn0250Vo.getDilnlazHlthCreNumDys());    /** column 근태_보건일수 : dilnlazHlthCreNumDys */
//                cell = getCell(sheet, 3 + i, 15);
//                setText(cell, "0");
//                /** 잔여월차 */
//                cell = getCell(sheet, 3 + i, 16);
//                setText(cell, dlgn0250Vo.getDilnlazPubcHodyDutyNumDys());   /** column 총휴일근무일수 : dilnlazPubcHodyDutyNumDys */
//                cell = getCell(sheet, 3 + i, 17);
//                setText(cell, dlgn0250Vo.getDilnlazSatDutyNumDys());   /** column 총토요근무일수 : dilnlazSatDutyNumDys */ 
//                cell = getCell(sheet, 3 + i, 18);
//                setText(cell, dlgn0250Vo.getDilnlazWklyHldyNumDys());   /** column 근태_주휴일수 : dilnlazWklyHldyNumDys */
//                cell = getCell(sheet, 3 + i, 19);
//                setText(cell, dlgn0250Vo.getDilnlazPaidPubcHodyNum());    /** column 근태_유급휴일수 : dilnlazPaidPubcHodyNum */   
//                cell = getCell(sheet, 3 + i, 20);
//                setText(cell, "0");
//                 /** 잔여연가 */
//                cell = getCell(sheet, 3 + i, 21);
//                setText(cell, dlgn0250Vo.getDilnlazTfcAssCstNumDys());   /** column 근태_교통보조비일수 : dilnlazTfcAssCstNumDys */
//              
//                cell = getCell(sheet, 3 + i, 22);
//                setText(cell, dlgn0250Vo.getDilnlazLnchDys());    /** column 근태_급식비일수 : dilnlazLnchDys */
//              
//                
//                cell = getCell(sheet, 3 + i, 23);
//                setText(cell, dlgn0250Vo.getDilnlazFndtnTmRstDutyTm());   /** column 근태_기본시간외근무시간 : dilnlazFndtnTmRstDutyTm */
//                cell = getCell(sheet, 3 + i, 24);
//                setText(cell, dlgn0250Vo.getDilnlazTmRstDutyTm());   /** column 근태_시간외근무시간 : dilnlazTmRstDutyTm */
//                cell = getCell(sheet, 3 + i, 25);
//                setText(cell, dlgn0250Vo.getDilnlazTotTmRstDutyTm());   /** column 근태_총시간외근무시간 : dilnlazTotTmRstDutyTm */ 
//                cell = getCell(sheet, 3 + i, 26);
//                setText(cell, dlgn0250Vo.getDilnlazTotNtotTm());  /** column 근태_총야근시간 : dilnlazTotNtotTm */
//                
...
//    }
    ...
    protected void buildExcelDocument(Map<String, Object> model,
    	...
    	XLSTransformer transformer = new XLSTransformer();
      	...
      	String xlsRelatvieFilepath =   realPath.concat("/".concat(globals.get("PayGen.XLSTemplateLink")).concat("/DLGN/UPXLS_DLGN025001.xls"));
      
		String destFileName = "근무실적관리폼";
