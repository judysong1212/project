...
//	} 
	...
	@Transactional //기준일 후
	public String insertDlgn01102(Dlgn0100DTO dto) throws Exception{
		return (String)insert("dlgn0100DAO.insertDlgn01102", dto);
	}
	...
	@Transactional //기준일 전
	public String insertDlgn0110Pre2(Dlgn0100DTO dto) throws Exception{
		return (String)insert("dlgn0100DAO.insertDlgn0110Pre2", dto);
	}
