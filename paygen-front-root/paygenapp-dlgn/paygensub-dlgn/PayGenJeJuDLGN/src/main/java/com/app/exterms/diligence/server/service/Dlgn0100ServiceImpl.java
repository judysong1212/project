...
public class Dlgn0100ServiceImpl extends AbstractCustomServiceImpl implements Dlgn0100Service {
	...
	private String detailYmKubn = DiligenceCommonConstants.ANDONG_DLGN_DT_BUNGI;
...
//	        	}  
	            ...
	            dto.setTypOccuBusinVal(MSFSharedUtils.allowNulls(dto.getTypOccuBusinVal()) );	// 복무통합구분값
	            ...
	            while ( iter.hasNext() ) {
			        ...
			        dto.setTypOccuBusinVal(MSFSharedUtils.allowNulls(String.valueOf(map.get("typOccuBusinVal"))));    /** set 복무통합구분값 : typOccuBusinVal */
	                
			        
			        // 무기계약직 이면서 직종, 직종세 없을 경우 복무 로직 skip 처리
			        if( MSFConfiguration.EMYMT_DIVCD01.equals(dto.getEmymtDivCd()) && ( "".equals(dto.getTypOccuCd()) || "".equals(dto.getDtilOccuInttnCd()))) {
...
//					infcDlgn0100Vo.setResnRegnNum(rrnDecCrypt);
					...
					infcDlgn0100Vo.setDilnlazWklyHldyNumDys(dto.getDilnlazWklyHldyNumDys()); 	/** get 근태_주휴일수 : dilnlazWklyHldyNumDys */
					infcDlgn0100Vo.setTypOccuBusinVal(dto.getTypOccuBusinVal());				/** set 복무통합구분값 : typOccuBusinVal */
	...
	public int deleteWorkTime(List<Dlgn0100DTO> list) throws Exception {
		...
		if(list != null && list.size() > 0){
			for(int i = 0; i < list.size(); i++){
        		...
        		if(MSFConfiguration.EMYMT_DIVCD01.equals(dto.getEmymtDivCd()) || MSFConfiguration.EMYMT_DIVCD01 == dto.getEmymtDivCd()) {
        			dto.setTypOccuBusinVal(dto.getDtilOccuInttnCd());
        			dtoDlgn0200.setTypOccuBusinVal(dto.getDtilOccuInttnCd());
        		}else {
        			dto.setTypOccuBusinVal(dto.getDeptCd().concat(dto.getBusinCd()));
        			dtoDlgn0200.setTypOccuBusinVal(dto.getDeptCd().concat(dto.getBusinCd()));
        		}
        ...
        try{
           ...
           if  (MSFSharedUtils.paramNull(dlgn0210DAO)) {
            ...
            for(int iPayrCnt=0; iPayrCnt < listDlgn0110Dto.size();iPayrCnt++) {
            	...
            	dlgn0110Dto.setTypOccuBusinVal(dlgn0110Dto.getTypOccuBusinVal()); 			/** column 복무통합구분값 : typOccuBusinVal */ 	
...
//            	dlgn0110Dto.setDilnlazDutyYn(dlgn0110Dto.getDilnlazDutyYn()); //근무
            	if("true".equals(dlgn0110Dto.getDilnlazAbnceYn())){
            		...
            		if(MSFConfiguration.EMYMT_DIVCD01.equals(dlgn0110Dto.getEmymtDivCd()) || MSFConfiguration.EMYMT_DIVCD01 == dlgn0110Dto.getEmymtDivCd()) {
...
//			
			...
			infcDlgn0100Vo.setDilnlazWklyHldyNumDys(dlgn0110Dto.getDilnlazWklyHldyNumDys());/** 주휴일수 dilnlazWklyHldyNumDys */
			infcDlgn0100Vo.setTypOccuBusinVal(dlgn0110Dto.getTypOccuBusinVal()); 			/** column 복무통합구분값 : typOccuBusinVal */
...
//			
			...
			infcDlgn0100Vo.setTypOccuBusinVal(dlgn01101dto.getTypOccuBusinVal());	/** column 복무통합구분값 : typOccuBusinVal */
...
//			
			...
			infcDlgn0100Vo.setTypOccuBusinVal(dlgn0110Dto.getTypOccuBusinVal());	/** set 복무통합구분값 : typOccuBusinVal */
//			if((detailYmKubn.compareTo(dlgn0110Dto.getDilnlazYrMnth().replaceAll("\\.", "")) >= 0 )){ //기준일 전
//				/****************************************************************************************************
//		         * 집계 인터페이스 모듈 호출 부분 추가 2014.10.14 ATRES  
//		         ****************************************************************************************************/
