...
public class Dlgn0300FileExcelView extends AbstractExcelView {
    ...
    protected void buildExcelDocument(Map<String, Object> model,
    	...
    	XLSTransformer transformer = new XLSTransformer();
      	...
      	String xlsRelatvieFilepath =   realPath.concat("/".concat(globals.get("PayGen.XLSTemplateLink")).concat("/DLGN/XLS_DLGN030001.xls"));
      
		String destFileName = "근무실적내역";
...
//  
//        List listDlgn0300 = (List) model.get("listFileDlgn0300");
//  
//        
//        Iterator<Map<String, Object>> iter =  listDlgn0300.iterator();
//        
//         while ( iter.hasNext() ) {
...
//               // dlgn0300Vo.setDilnlazLvsgNumDys(EgovExcelUtil.getValue(cell2));    /** column 근태_연가일수 : dilnlazLvsgNumDys */
...
//                
//              //  dlgn0300Vo.setDilnlazDdlnePrcsYn(EgovExcelUtil.getValue(cell2));    /** column 근태_마감처리여부 : dilnlazDdlnePrcsYn */
//              //  dlgn0300Vo.setDilnlazNoteCtnt(EgovExcelUtil.getValue(cell2));    /** column 근태_비고내용 : dilnlazNoteCtnt */   
////                dlgn0300Vo.setDilnlazExceDutyYrMnth(EgovExcelUtil.getValue(cell2));    /** column 근태초과근무년월 : dilnlazExceDutyYrMnth */ 
////                dlgn0300Vo.setDilnlazExceDutyBgnnDt(EgovExcelUtil.getValue(cell2));    /** column 근태_초과근무시작일자 : dilnlazExceDutyBgnnDt */
////                dlgn0300Vo.setDilnlazExceDutyEndDt(EgovExcelUtil.getValue(cell2));    /** column 근태_초과근무종료일자 : dilnlazExceDutyEndDt */ 
////                dlgn0300Vo.setDilnlazTotNtotNumDys(EgovExcelUtil.getValue(cell2));    /** column 근태_총야근일수 : dilnlazTotNtotNumDys */
//                 
//                i = i + 1;
//  
//                
