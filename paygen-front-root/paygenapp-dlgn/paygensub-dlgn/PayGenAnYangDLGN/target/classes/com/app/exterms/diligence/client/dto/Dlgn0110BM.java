...
public class Dlgn0110BM    extends MSFSimpleBaseModel implements IsSerializable   {
    ...
    public static final String ATTR_DILNLAZSPPYSNKFYN = "dilnlazSppySnkfYn";

    /** set 근태_숙직여부 : dilnlazNgtdyYn */
    public static final String ATTR_DILNLAZNGTDYYN = "dilnlazNgtdyYn";
    ...
    /** set 근태_간식비여부 : dilnlazSppySnkfYn */
    public void setDilnlazSppySnkfYn(String  dilnlazSppySnkfYn) { set( ATTR_DILNLAZSPPYSNKFYN ,dilnlazSppySnkfYn);}
    /** get 근태_간식비여부 : dilnlazSppySnkfYn */
    public String  getDilnlazSppySnkfYn() { return (String )get( ATTR_DILNLAZSPPYSNKFYN );}
    /** set 근태_숙직여부 : dilnlazNgtdyYn */
    public void setDilnlazNgtdyYn(String  dilnlazNgtdyYn) { set( ATTR_DILNLAZNGTDYYN ,dilnlazNgtdyYn);}
    /** get 근태_숙직여부 : dilnlazNgtdyYn */
    public String  getDilnlazNgtdyYn() { return (String )get( ATTR_DILNLAZNGTDYYN );}
