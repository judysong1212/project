...
public class DlgnP010001ServiceImpl extends AbstractCustomServiceImpl implements DiligenceDaoConstants, DlgnP010001Service {
	...
	public PagingLoadResult<ShowMessageBM> generateAllWorkTime(Dlgn0100DTO dlgn0100Dto, Dlgn0200DTO dlgn0200Dto) throws MSFException {
		String detailYmKubn = DiligenceCommonConstants.ANYANG_DLGN_DT_BUNGI;
//		String detailYmKubn = "201703"; //복무관리 기준일
		...
		try{
            ...
            if ("FALSE".equals(chkDeptCd)) {
         	   ...
         	   if (sessionUser.getDeptCd().equals(MSFSharedUtils.defaultNulls(dlgn0100Dto.getDeptCd(),sessionUser.getDeptCd()))) {
...
//	        }
            ...
            if ("FALSE".equals(chkDeptCd)) {
         	   ...
         	   if (sessionUser.getDeptCd().equals(MSFSharedUtils.defaultNulls(dlgn0200Dto.getCurrAffnDeptCd(),sessionUser.getDeptCd()))) {
