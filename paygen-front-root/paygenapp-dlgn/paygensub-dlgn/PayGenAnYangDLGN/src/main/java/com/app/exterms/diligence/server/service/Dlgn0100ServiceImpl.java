...
public class Dlgn0100ServiceImpl extends AbstractCustomServiceImpl implements Dlgn0100Service {
	...
	private String detailYmKubn = DiligenceCommonConstants.ANYANG_DLGN_DT_BUNGI;
...
//		dlgn0100SrhVO.setPayrMangDeptCd(MSFSharedUtils.allowNulls(sessionUser.getPayrMangDeptCd()));	//단위기관
		...
		if ("FALSE".equals(chkDeptCd )) {
		   ...
		   if (sessionUser.getDeptCd().equals(MSFSharedUtils.defaultNulls(dtoParam.getCurrAffnDeptCd(),sessionUser.getDeptCd()))) {	
...
//					dto.setDilnlazHodyYnboolean("Y".equals(tempMap.get("dilnlazHodyYn")) ? true : false);	/** set 근태_보건여부 : dilnlazHlthCreYnboolean */
					...
					dto.setDilnlazButpYnBoolean("Y".equals(tempMap.get("dilnlazButpYn")) ? true : false);						/** set 근태_출장여부 : dilnlazButpYn */
					dto.setDilnlazSppySnkfYnBoolean("Y".equals(tempMap.get("dilnlazSppySnkfYn")) ? true : false);   			/** column 근태_간식비여부 : dilnlazSppySnkfYn */
					dto.setDilnlazNgtdyYnBoolean("Y".equals(tempMap.get("dilnlazNgtdyYn")) ? true : false);    					/** column 근태_숙직여부 : dilnlazNgtdyYn */
...
//				dto.setDeptCd(dto.getDeptCd());
	            ...
	            if ("FALSE".equals(chkDeptCd )) {
	            	 ...
	            	 if (sessionUser.getDeptCd().equals(MSFSharedUtils.defaultNulls(dto.getDeptCd(),sessionUser.getDeptCd()))) {	
...
//            	dlgn0110Dto.setDilnlazHlthCreYn(dlgn0110Dto.getDilnlazHlthCreYn()); //보건
            	...
            	if("true".equals(dlgn0110Dto.getDilnlazSppySnkfYn())){ 	//간식비
            		dlgn0110Dto.setDilnlazSppySnkfYn("Y");
            	}else{
            		dlgn0110Dto.setDilnlazSppySnkfYn("N");
            	}
            	
            	if("true".equals(dlgn0110Dto.getDilnlazNgtdyYn())){ 	//숙직
            		dlgn0110Dto.setDilnlazNgtdyYn("Y");
            	}else{
            		dlgn0110Dto.setDilnlazNgtdyYn("N");
            	}
