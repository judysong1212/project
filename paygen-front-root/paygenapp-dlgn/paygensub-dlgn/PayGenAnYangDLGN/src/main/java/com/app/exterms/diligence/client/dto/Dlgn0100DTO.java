...
//        public String  getDilnlazPubcHodyDutyNumDys() { return (String )get( "dilnlazPubcHodyDutyNumDys" );}
	...
	public void setDilnlazSppySnkfYn(String  dilnlazSppySnkfYn) { set( "dilnlazSppySnkfYn" ,dilnlazSppySnkfYn);}
	/** get 근태_간식비여부 : dilnlazSppySnkfYn */
	public String  getDilnlazSppySnkfYn() { return (String )get( "dilnlazSppySnkfYn" );}
	/** set 근태_숙직여부 : dilnlazNgtdyYn */
	public void setDilnlazNgtdyYn(String  dilnlazNgtdyYn) { set( "dilnlazNgtdyYn" ,dilnlazNgtdyYn);}
	/** get 근태_숙직여부 : dilnlazNgtdyYn */
	public String  getDilnlazNgtdyYn() { return (String )get( "dilnlazNgtdyYn" );}
	...
	/** set 근태_출장여부 : dilnlazButpYn */
	public void setDilnlazButpYnBoolean(boolean dilnlazButpYnBoolean) { set("dilnlazButpYnBoolean",dilnlazButpYnBoolean);}
	/** get 근태_출장여부 : dilnlazButpYn */
	public boolean getDilnlazButpYnBoolean() { return (Boolean)get("dilnlazButpYnBoolean");}
	
	/** set 근태_간식비여부 : dilnlazSppySnkfYn */
	public void setDilnlazSppySnkfYnBoolean(boolean  dilnlazSppySnkfYnBoolean) { set( "dilnlazSppySnkfYnBoolean" ,dilnlazSppySnkfYnBoolean);}
	/** get 근태_간식비여부 : dilnlazSppySnkfYn */
	public boolean  getDilnlazSppySnkfYnBoolean() { return (Boolean )get( "dilnlazSppySnkfYnBoolean" );}
	/** set 근태_숙직여부 : dilnlazNgtdyYn */
	public void setDilnlazNgtdyYnBoolean(boolean  dilnlazNgtdyYnBoolean) { set( "dilnlazNgtdyYnBoolean" ,dilnlazNgtdyYnBoolean);}
	/** get 근태_숙직여부 : dilnlazNgtdyYn */
	public boolean  getDilnlazNgtdyYnBoolean() { return (Boolean )get( "dilnlazNgtdyYnBoolean" );}
