...
public class Dlgn0100FileExcelView extends AbstractExcelView {
...
//      	String xlsRelatvieFilepath =   realPath.concat("/GimHae/".concat(globals.get("PayGen.XLSTemplateLink")).concat("/DLGN/XLS_DLGN010001.xls"));
      	String xlsRelatvieFilepath =   realPath.concat("/"+globals.get("PayGen.MunicipalitiesName").toLowerCase() +"/".concat(globals.get("PayGen.XLSTemplateLink")).concat("/DLGN/XLS_DLGN010001.xls"));
