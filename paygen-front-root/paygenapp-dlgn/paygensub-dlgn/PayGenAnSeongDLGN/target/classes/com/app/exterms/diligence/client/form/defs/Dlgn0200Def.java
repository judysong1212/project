...
//        		addTrigger(Events.KeyUp, changeValueListenerAdapter2);
        ...
        listColumnDefs.add(new ColumnDef("퇴근", Dlgn0210BM.ATTR_DILNLAZDUTYEDTMHODYNTOT, ColumnDef.TYPE_STRING , 60, false, false, true){
        	{
//        		setSelectOnFocus(true);
        		setReadOnly(true);
        	}
        ...
        listColumnDefs.add(new ColumnDef("근무", Dlgn0210BM.ATTR_DILNLAZHODYNTOTTM, ColumnDef.TYPE_STRING , 60, true, false, true){
        	{
        		setSelectOnFocus(true);
...
//        		setSelectOnFocus(true);
        ...
        /** column 휴일연장근무(시:분)퇴근시간 : dilnlazDutyEdTmHodyNtot */
        listColumnDefs.add(new ColumnDef("퇴근시간", Dlgn0210BM.ATTR_DILNLAZDUTYEDTMHODYNTOT, ColumnDef.TYPE_STRING , 60, true, false, true){
        	{
//        		setSelectOnFocus(true);
        		setReadOnly(true);
        	}
        ...
        /** column 휴일연장근무(시:분)근무시간 : dilnlazHodyNtotTm */
        listColumnDefs.add(new ColumnDef("근무시간", Dlgn0210BM.ATTR_DILNLAZHODYNTOTTM, ColumnDef.TYPE_STRING , 60, true, false, true){
        	{
//        		setSelectOnFocus(true);
        	}
        });
