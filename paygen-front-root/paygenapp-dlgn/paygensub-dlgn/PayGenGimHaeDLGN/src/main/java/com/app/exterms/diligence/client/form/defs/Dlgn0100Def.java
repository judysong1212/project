...
public class Dlgn0100Def  extends TableDef implements DiligenceDaoConstants {
    ...
    protected ColumnListDef dilnlazEtcDivCdColumnDef;
	...
	public Dlgn0100Def(String chkDef) {
		...
		}else if ("DLGN0230_Member".equals(chkDef)) {
			setTitle("");
			setDaoClass("");
			setCustomListMethod(CLASS_DLGN0230_MEMBER_LIST);
			setAutoFillGrid(false);
			setShowFilterToolbar(false);
			setCheckBoxOnGridRows(true);
			setColumnsDefinition(getDLGN0100MemberColumnsList());
		}else if ("DLGN0230".equals(chkDef)) {
			setTitle("");
			setDaoClass("");
			setCustomListMethod(CLASS_DLGN0230_TO_DLGN0100_LIST);
			setAutoFillGrid(true);
			setShowFilterToolbar(false);
			setCheckBoxOnGridRows(true);
			setEditFieldGrid(true);
			setCellModel(true);
			setColumnsDefinition(getDLGN0100ToDLGN0230ColumnsList());
	...
	private List<ColumnDef> getDLGN0100ToDLGN0230ColumnsList() {
		...
		changeValueListenerAdapter1 = new ColumnDefListenerAdapter() {
			...
			public void run(Field field, Object valueField) {
				...
				if (dilnlazAbnceYn == false) {
					...
					// 결근 체크시 기본적으로 결근인정여부 Y 구분은 결근인정으로 처리
					formModel.set(Dlgn0110BM.ATTR_DILNLAZETCDIVCD, "N0010000");
					formModel.set(Dlgn0110BM.ATTR_DILNLAZABNCEDUTYRCGTNYN, "");
				} else {
					dilnlazDutyYn = true;
					...
					// 결근 체크시 기본적으로 결근인정여부 Y 구분은 결근인정으로 처리
					formModel.set(Dlgn0110BM.ATTR_DILNLAZETCDIVCD, "N0010010");
					formModel.set(Dlgn0110BM.ATTR_DILNLAZABNCEDUTYRCGTNYN, "Y");
					
					
//					String dilnlazEtcDivCdStr = formModel.get(Dlgn0110BM.ATTR_DILNLAZETCDIVCD);
					
//					Window.alert(dilnlazEtcDivCdStr);
//					
//					dilnlazEtcDivCdColumnDef.getTableDef().setTableColumnFilters(new SimpleColumnFilter("commCd", dilnlazEtcDivCdStr, SimpleColumnFilter.OPERATOR_EQUALS));
//					dilnlazEtcDivCdColumnDef.readData();
...
//	        	setTextFdMask("9:99");
		...
		listColumnDefs.add(new ColumnDef("근무", Dlgn0110BM.ATTR_DILNLAZDUTYYN, ColumnDef.TYPE_BOOLEAN , 60, false, false, false){
			{
				setReadOnly(true);
			}
		});
		
	    sysComBass0300Dto.setRpsttvCd("N002");
        listColumnDefs.add(new ColumnListDef("근무", Dlgn0110BM.ATTR_DILNLAZDUTYLIST, ColumnDef.TYPE_STRING, 60, true, true, true,  new LookupPrgmComBass0300(sysComBass0300Dto),PrgmComBass0300BM.ATTR_COMMCD,PrgmComBass0300BM.ATTR_COMMCDNM){
        	{
		...
		listColumnDefs.add(new ColumnDef("결근", Dlgn0110BM.ATTR_DILNLAZABNCEYN, ColumnDef.TYPE_BOOLEAN , 60, false, false, false){
			{
				addTrigger(Events.Change, changeValueListenerAdapter1);
			}
		});
		 /** column 근태_연차여부 : dilnlazLvsgYn */
		listColumnDefs.add(new ColumnDef("연차", Dlgn0110BM.ATTR_DILNLAZLVSGYN, ColumnDef.TYPE_BOOLEAN , 60, false, false, false){
			{
				addTrigger(Events.Change, changeValueListenerAdapter2);
			}
		});
		 /** column 근태_특(휴)여부 : dilnlazSpclHodyYn */
		listColumnDefs.add(new ColumnDef("특(휴)", Dlgn0110BM.ATTR_DILNLAZSPCLHODYYN, ColumnDef.TYPE_BOOLEAN , 60, false, false, false){
			{
				addTrigger(Events.Change, changeValueListenerAdapter3);
			}
		});
		 /** column 근태_병가여부 : dilnlazSckleaYn */
		listColumnDefs.add(new ColumnDef("병가", Dlgn0110BM.ATTR_DILNLAZSCKLEAYN, ColumnDef.TYPE_BOOLEAN , 60, false, false, false){
			{
				addTrigger(Events.Change, changeValueListenerAdapter4);
			}
		});
		 /** column 근태_공가여부 : dilnlazOffvaYn */
		listColumnDefs.add(new ColumnDef("공가", Dlgn0110BM.ATTR_DILNLAZOFFVAYN, ColumnDef.TYPE_BOOLEAN , 60, false, false, false){
			{
				addTrigger(Events.Change, changeValueListenerAdapter5);
			}
		});
		/** column 근태_경조사여부 : dilnlazFmlyEvntYn */
		listColumnDefs.add(new ColumnDef("경조사", Dlgn0110BM.ATTR_DILNLAZFMLYEVNTYN, ColumnDef.TYPE_BOOLEAN , 60, false, false, false){
			{
				addTrigger(Events.Change, changeValueListenerAdapter6);
			}
		});
		/** column 근태_보건여부 : dilnlazHlthCreYn */
		listColumnDefs.add(new ColumnDef("보건", Dlgn0110BM.ATTR_DILNLAZHLTHCREYN, ColumnDef.TYPE_BOOLEAN , 60, false, false, false){
			{
		...
		listColumnDefs.add(new ColumnDef("교통비", Dlgn0110BM.ATTR_DILNLAZTFCASSCSTYN, ColumnDef.TYPE_BOOLEAN , 60, true, true, true){
			{
		
			}
		});
		/** column 근태_급식비여부 : dilnlazLnchYn */
		listColumnDefs.add(new ColumnDef("급식비", Dlgn0110BM.ATTR_DILNLAZLNCHYN, ColumnDef.TYPE_BOOLEAN , 60, true, true, true){
			{
		...
		listColumnDefs.add(new ColumnDef("휴일", Dlgn0110BM.ATTR_OFFDAYKUBN, ColumnDef.TYPE_STRING , 60, true, false, true){
		  ...
		  dilnlazEtcDivCdColumnDef = new ColumnListDef("복무기타", Dlgn0110BM.ATTR_DILNLAZETCDIVCD, ColumnDef.TYPE_STRING, 150, true, true, true,  new LookupPrgmComBass0300(sysComBass0300Dto),PrgmComBass0300BM.ATTR_COMMCD,PrgmComBass0300BM.ATTR_COMMCDNM)
        	{{

            }};
            listColumnDefs.add(dilnlazEtcDivCdColumnDef);
//	    sysComBass0300Dto.setRpsttvCd("N001");
...
//				Boolean dilnlazDutyYn = false;
////				Boolean dilnlazAbnceYn = formModel.get(Dlgn0110BM.ATTR_DILNLAZABNCEYN); // 결근
////				Boolean dilnlazAbnceYn = (String) item.get("dilnlazAbnceYn")?true:false; // 결근
//				Boolean dilnlazAbnceYn =  (Boolean) valueField;
////                String dilnlazEtcDivCdStr =  item.get("dilnlazEtcDivCd") ;
//				
//
//				if (dilnlazAbnceYn == false) {
//					
...
//					dilnlazEtcDivCdColumnDef.getTableDef().setTableColumnFilters(filters);
//					dilnlazEtcDivCdColumnDef.getTableDef().addColumnFilter("rpsttvCd","N001", SimpleColumnFilter.OPERATOR_EQUALS);
//					dilnlazEtcDivCdColumnDef.getTableDef().addColumnFilter("commCd", dilnlazEtcDivCdStr, SimpleColumnFilter.OPERATOR_EQUALS);
//					dilnlazEtcDivCdColumnDef.readData();
//					
//					
//				} else {
...
//					dilnlazEtcDivCdColumnDef.getTableDef().setTableColumnFilters(filters);
//					
////					dilnlazEtcDivCdColumnDef.getTableDef().setTableColumnFilters(new SimpleColumnFilter("rpsttvCd", "N001", SimpleColumnFilter.OPERATOR_EQUALS));
////					dilnlazEtcDivCdColumnDef.getTableDef().setTableColumnFilters(new SimpleColumnFilter("commCd", dilnlazEtcDivCdStr, SimpleColumnFilter.OPERATOR_EQUALS));
////					dilnlazEtcDivCdColumnDef.getTableDef().addColumnFilter("rpsttvCd","N001", SimpleColumnFilter.OPERATOR_EQUALS);
////					dilnlazEtcDivCdColumnDef.getTableDef().addColumnFilter("commCd", dilnlazEtcDivCdStr, SimpleColumnFilter.OPERATOR_EQUALS);
//					dilnlazEtcDivCdColumnDef.getTableDef().setTableColumnFilters(new SimpleColumnFilter("rpsttvCd", "N001", SimpleColumnFilter.OPERATOR_EQUALS));
...
//	        	setTextFdMask("9:99");
		 ...
		 /** column 근태_근무여부 : dilnlazDutyYn */
		listColumnDefs.add(new ColumnDef("근무", Dlgn0110BM.ATTR_DILNLAZDUTYYN, ColumnDef.TYPE_BOOLEAN , 50, true, true, true){
			{
				setReadOnly(true);
			}
		});
		 /** column 근태_결근여부 : dilnlazAbnceYn */
		listColumnDefs.add(new ColumnDef("결근", Dlgn0110BM.ATTR_DILNLAZABNCEYN, ColumnDef.TYPE_BOOLEAN , 50, true, true, true){
			{
				addTrigger(Events.Change, changeValueListenerAdapter1);
			}
		});
		 ...
		 /** column 근태_연차여부 : dilnlazLvsgYn */
		listColumnDefs.add(new ColumnDef("연차", Dlgn0110BM.ATTR_DILNLAZLVSGYN, ColumnDef.TYPE_BOOLEAN , 50, true, true, true){
			{
				addTrigger(Events.Change, changeValueListenerAdapter2);
			}
		});
		 /** column 근태_특(휴)여부 : dilnlazSpclHodyYn */
		listColumnDefs.add(new ColumnDef("특(휴)", Dlgn0110BM.ATTR_DILNLAZSPCLHODYYN, ColumnDef.TYPE_BOOLEAN , 50, true, true, true){
			{
				addTrigger(Events.Change, changeValueListenerAdapter3);
			}
		});
		 /** column 근태_병가여부 : dilnlazSckleaYn */
		listColumnDefs.add(new ColumnDef("병가", Dlgn0110BM.ATTR_DILNLAZSCKLEAYN, ColumnDef.TYPE_BOOLEAN , 50, true, true, true){
			{
				addTrigger(Events.Change, changeValueListenerAdapter4);
			}
		});
		 /** column 근태_공가여부 : dilnlazOffvaYn */
		listColumnDefs.add(new ColumnDef("공가", Dlgn0110BM.ATTR_DILNLAZOFFVAYN, ColumnDef.TYPE_BOOLEAN , 50, true, true, true){
			{
				addTrigger(Events.Change, changeValueListenerAdapter5);
			}
		});
		/** column 근태_경조사여부 : dilnlazFmlyEvntYn */
		listColumnDefs.add(new ColumnDef("경조", Dlgn0110BM.ATTR_DILNLAZFMLYEVNTYN, ColumnDef.TYPE_BOOLEAN , 50, true, true, true){
			{
				addTrigger(Events.Change, changeValueListenerAdapter6);
			}
		});
		/** column 근태_보건여부 : dilnlazHlthCreYn */
		listColumnDefs.add(new ColumnDef("보건", Dlgn0110BM.ATTR_DILNLAZHLTHCREYN, ColumnDef.TYPE_BOOLEAN , 50, true, true, true){
			{
				addTrigger(Events.Change, changeValueListenerAdapter7);
			}
		});
		...
		sysComBass0300Dto.setRpsttvCd("N001");
		dilnlazEtcDivCdColumnDef = new ColumnListDef("복무기타", Dlgn0110BM.ATTR_DILNLAZETCDIVCD, ColumnDef.TYPE_STRING, 100, true, true, true,  new LookupPrgmComBass0300(sysComBass0300Dto),PrgmComBass0300BM.ATTR_COMMCD,PrgmComBass0300BM.ATTR_COMMCDNM)
    		{{
...
//	    sysComBass0300Dto.setRpsttvCd("N001");
//        listColumnDefs.add(new ColumnListDef("복무기타", Dlgn0110BM.ATTR_DILNLAZETCDIVCD, ColumnDef.TYPE_STRING, 70, true, true, true,  new LookupPrgmComBass0300(sysComBass0300Dto),PrgmComBass0300BM.ATTR_COMMCD,PrgmComBass0300BM.ATTR_COMMCDNM){
//        	{
//
//            }
//        });
	...
	/** 근태관리대상자정보 **/
	private List<ColumnDef> getDLGN0100MemberColumnsList() {
        ...
        /** column 한글성명 : hanNm */
        listColumnDefs.add(new ColumnDef("성명", Dlgn0250BM.ATTR_HANNM, ColumnDef.TYPE_STRING, 60, false, true, false){
          {
              setReadOnly(true);
          }
        });
        ...
        listColumnDefs.add(new ColumnDef("주민번호", Dlgn0250BM.ATTR_RESNREGNNUM, ColumnDef.TYPE_STRING, 90, false, true, false){
          {
              setReadOnly(true);
          }
        });
		...
		/** column 부서코드 : deptCd */
		listColumnDefs.add(new ColumnDef("부서", Dlgn0100BM.ATTR_DEPTNM, ColumnDef.TYPE_STRING , 90, false, true, true){
			{
		...
		listColumnDefs.add(new ColumnDef("직종세", Dlgn0100BM.ATTR_DTILOCCUINTTNNM, ColumnDef.TYPE_STRING , 90, false, true, false){
			{
		...
		/** column 사업코드 : businCd */
		listColumnDefs.add(new ColumnDef("사업", Dlgn0100BM.ATTR_BUSINNM, ColumnDef.TYPE_STRING , 90, false, true, false){
			{
		...
		listColumnDefs.add(new ColumnDef("시작일자", Dlgn0100BM.ATTR_EMYMTBGNNDT, ColumnDef.TYPE_STRING , 90, false, true, false){
			{
		...
		listColumnDefs.add(new ColumnDef("종료일자", Dlgn0100BM.ATTR_EMYMTENDDT, ColumnDef.TYPE_STRING , 90, false, true, false){
			{
        ...
        // ---
        /** column 사업장코드 : dpobCd */
		listColumnDefs.add(new ColumnDef("사업장코드", Dlgn0100BM.ATTR_DPOBCD, ColumnDef.TYPE_STRING , 90, false, false, false){
			{
		
			}
		});
		/** column SYSTEMKEY : systemkey */
		listColumnDefs.add(new ColumnDef("SYSTEMKEY", Dlgn0100BM.ATTR_SYSTEMKEY, ColumnDef.TYPE_STRING , 90, false, false, false){
			{
		
			}
		});
		/** column 급여구분코드 : payCd */
		listColumnDefs.add(new ColumnDef("급여구분코드", Dlgn0100BM.ATTR_PAYCD, ColumnDef.TYPE_STRING , 90, false, false, false){
			{
		...
		listColumnDefs.add(new ColumnDef("작업년월", Dlgn0100BM.ATTR_DILNLAZYRMNTH, ColumnDef.TYPE_STRING , 90, false, false, false){
			{
        ...
        /** column 한글성명 : hanNm */
        listColumnDefs.add(new ColumnDef("한글성명", Dlgn0250BM.ATTR_HANNM, ColumnDef.TYPE_STRING, 60, false, false, false){
          {
        	  
          }
        });
        /** column 주민등록번호 : resnRegnNum */
        listColumnDefs.add(new ColumnDef("주민등록번호", Dlgn0250BM.ATTR_RESNREGNNUM, ColumnDef.TYPE_STRING, 90, false, false, false){
          {
		...
		listColumnDefs.add(new ColumnDef("고용구분코드", Dlgn0100BM.ATTR_EMYMTDIVCD, ColumnDef.TYPE_STRING , 90, false, false, false){
			{

			}
		});
		/** column 부서코드 : deptCd */
		listColumnDefs.add(new ColumnDef("부서코드", Dlgn0100BM.ATTR_DEPTCD, ColumnDef.TYPE_STRING , 90, false, false, false){
			{

			}
		});
		/** column 사업코드 : businCd */
		listColumnDefs.add(new ColumnDef("사업코드", Dlgn0100BM.ATTR_BUSINCD, ColumnDef.TYPE_STRING , 90, false, false, false){
			{

			}
		});
		/** column 직종코드 : typOccuCd */
		listColumnDefs.add(new ColumnDef("직종코드", Dlgn0100BM.ATTR_TYPOCCUCD, ColumnDef.TYPE_STRING , 90, false, false, false){
			{

			}
		});
		/** column 직종세구분코드 : dtilOccuClsDivCd */
		listColumnDefs.add(new ColumnDef("직종세구분코드", Dlgn0100BM.ATTR_DTILOCCUCLSDIVCD, ColumnDef.TYPE_STRING , 90, false, false, false){
			{
		...
		/** column 근태_주휴일수 : dilnlazWklyHldyNumDys */
		listColumnDefs.add(new ColumnDef("근태_주휴일수", Dlgn0100BM.ATTR_DILNLAZWKLYHLDYNUMDYS, ColumnDef.TYPE_STRING , 90, false, false, false){
			{
        ...
        /** column 직종코드 : typOccuCd */
        listColumnDefs.add(new ColumnDef("직종", Dlgn0100BM.ATTR_TYPOCCUNM, ColumnDef.TYPE_STRING , 90, false, false, false){
            {
		...
		listColumnDefs.add(new ColumnDef("근태_근무시작일자", Dlgn0100BM.ATTR_DILNLAZDUTYBGNNDT, ColumnDef.TYPE_STRING , 90, false, false, false){
			{
		...
		listColumnDefs.add(new ColumnDef("근태_근무종료일자", Dlgn0100BM.ATTR_DILNLAZDUTYENDDT, ColumnDef.TYPE_STRING , 90, false, false, false){
			{
