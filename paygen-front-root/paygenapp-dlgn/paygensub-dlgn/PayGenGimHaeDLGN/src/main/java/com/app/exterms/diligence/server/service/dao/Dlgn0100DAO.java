...
//	} 
	 ...
	 * @throws Exception
	 */
	public List selectDlgn0230List(Dlgn0100SrhVO dlgn0100SrhVO) throws Exception{
		return list("dlgn0100DAO.selectDlgn0230List", dlgn0100SrhVO);
	}
	
	@SuppressWarnings("deprecation")
	public int selectDlgn0100Cnt(Dlgn0100SrhVO dlgn0100SrhVo) throws Exception {
	      return (Integer)getSqlMapClientTemplate().queryForObject("dlgn0100DAO.selectDlgn0230ListCnt", dlgn0100SrhVo);
	}
