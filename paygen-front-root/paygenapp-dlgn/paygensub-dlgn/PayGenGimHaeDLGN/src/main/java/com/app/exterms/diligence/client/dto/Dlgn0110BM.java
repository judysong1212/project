...
public class Dlgn0110BM    extends MSFSimpleBaseModel implements IsSerializable   {
    ...
    public static final String ATTR_DILNLAZDUTYLIST = "dilnlazDutyList";
    ...
    /** set 근태_근무여부 : dilnlazDutyList */
    public void setDilnlazDutyList(String  dilnlazDutyList) { set( ATTR_DILNLAZDUTYLIST ,dilnlazDutyList);}
    /** get 근태_근무여부 : dilnlazDutyList */
    public String  getDilnlazDutyList() { return (String )get( ATTR_DILNLAZDUTYLIST );}
