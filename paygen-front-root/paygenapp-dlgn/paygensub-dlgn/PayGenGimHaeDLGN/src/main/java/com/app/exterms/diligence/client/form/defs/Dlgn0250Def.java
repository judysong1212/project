...
public class Dlgn0250Def  extends TableDef implements DiligenceDaoConstants {
    ...
    private ColumnDefListenerAdapter changeValueListenerAdapter6;
           	...
           	changeValueListenerAdapter6 = new ColumnDefListenerAdapter() {
           		...
           		public void run(Field field, Object valueField) {
                	...
                	BigDecimal dayTm 	= new BigDecimal("8");		// 하루 근무시간
                   	...
                   	String dilnlazPubcHodyDutyTmStr = formModel.get(Dlgn0250BM.ATTR_DILNLAZPUBCHODYDUTYTM);				/** column 총휴일근무시간 : dilnlazPubcHodyDutyTm */
                	...
                	BigDecimal dilnlazPubcHodyDutyTm 	= BigDecimal.ZERO;												/** column 총휴일근무시간 : dilnlazPubcHodyDutyTm */
                   	...
                   	String dilnlazPubcHodyDutyNumDysStr = (String) valueField; 											/** column 총휴일근무일수 : dilnlazPubcHodyDutyNumDys */
                   	
                   	// 1. 값 셋팅 
                   	dilnlazPubcHodyDutyNumDys = new BigDecimal(dilnlazPubcHodyDutyNumDysStr);							// 총휴일근무일수 : dilnlazPubcHodyDutyNumDys 
                   	dilnlazPubcHodyDutyTm = new BigDecimal(dilnlazPubcHodyDutyTmStr);									// 총휴일근무시간 : dilnlazPubcHodyDutyTm 
                         			
                   	// 2. 값 산정
                   	dilnlazPubcHodyDutyTm = dilnlazPubcHodyDutyNumDys.multiply(dayTm);									// 총휴일근무시간 : dilnlazPubcHodyDutyTm
                   	
                   	// 3. 값 반영
                   	formModel.set(Dlgn0250BM.ATTR_DILNLAZPUBCHODYDUTYTM, String.valueOf(dilnlazPubcHodyDutyTm));		// 총휴일근무시간 : dilnlazPubcHodyDutyTm 
        ...
        listColumnDefs.add(new ColumnDef("휴일근무(일)", Dlgn0250BM.ATTR_DILNLAZPUBCHODYDUTYNUMDYS, ColumnDef.TYPE_STRING , 60, false, true, false){
            {
            	setRegEx("^[+-]?\\d*(\\.?\\d*)$");
            	setSelectOnFocus(true);
//            	addTrigger(Events.KeyUp, changeValueListenerAdapter6);
            }
        });
