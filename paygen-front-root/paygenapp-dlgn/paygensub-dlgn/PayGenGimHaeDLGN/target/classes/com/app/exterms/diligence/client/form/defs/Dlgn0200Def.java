...
public class Dlgn0200Def  extends TableDef implements DiligenceDaoConstants {
    ...
    public Dlgn0200Def(String chkDef){
    	...
    	if("DLGN0200".equals(chkDef)) {
    		...
    		setTitle("");
            setDaoClass("");
            setCustomListMethod(CLASS_DLGN0230_TO_DLGN0200_LIST);
            setAutoFillGrid(false);
            setShowFilterToolbar(false);
            setCheckBoxOnGridRows(true);
            setEditFieldGrid(true);
            setCellModel(true);
            setColumnsDefinition(getDLGN0200ColumnsList02());  
...
//        		addTrigger(Events.KeyUp, changeValueListenerAdapter4);
    ...
    private List<ColumnDef> getDLGN0200ColumnsList02() {
...
//        		setSelectOnFocus(true);
        ...
        /** column 연장근무(시:분)근무시간 : dilnlazTmRstDutyTm */
        listColumnDefs.add(new ColumnDef("근무", Dlgn0210BM.ATTR_DILNLAZTMRSTDUTYTM, ColumnDef.TYPE_STRING , 60, false, true, true){
        	{
        		setSelectOnFocus(true);
//        		TODO 임시주석
//        		addTrigger(Events.KeyUp, changeValueListenerAdapter1);
...
//        		setSelectOnFocus(true);
        ...
        /** column 야근근무(시:분)근무시간 : dilnlazNtotTm */
        listColumnDefs.add(new ColumnDef("근무", Dlgn0210BM.ATTR_DILNLAZNTOTTM, ColumnDef.TYPE_STRING , 60, false, true, true){
        	{
        		setSelectOnFocus(true);
//        		TODO 임시주석
//        		addTrigger(Events.KeyUp, changeValueListenerAdapter1);
...
//        		setSelectOnFocus(true);
        ...
        /** column 휴일근무(시:분)근무시간 : dilnlazHodyDutyTm */
        listColumnDefs.add(new ColumnDef("근무", Dlgn0210BM.ATTR_DILNLAZHODYDUTYTM, ColumnDef.TYPE_STRING , 60, false, true, true){
        	{
        		setSelectOnFocus(true);
//        		addTrigger(Events.KeyUp, changeValueListenerAdapter3);
//        		TODO 임시주석
...
//        		setSelectOnFocus(true);
        ...
        /** column 휴일연장근무(시:분)근무시간 : dilnlazHodyNtotTm */
        listColumnDefs.add(new ColumnDef("근무", Dlgn0210BM.ATTR_DILNLAZHODYNTOTTM, ColumnDef.TYPE_STRING , 60, false, true, true){
        	{
        		setSelectOnFocus(true);
//        		addTrigger(Events.KeyUp, changeValueListenerAdapter4);
