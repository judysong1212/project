...
//          Collection<Map<String, Object>> list ??????
            ...
            for(int iPayrCnt=0;iPayrCnt < listDlgn0250.size();iPayrCnt++) {
             ...
             dlgn0100Vo.setDilnlazWklyHldyNumDys(dlgn0250VO.getDilnlazWklyHldyNumDys());    								/** column ê·¼í_ì£¼í´ì¼ì : dilnlazWklyHldyNumDys */
             dlgn0100Vo.setDilnlazPaidPubcHodyNum(dlgn0250VO.getDilnlazPaidPubcHodyNum());    								/** column ê·¼í_ì ê¸í´ì¼ì : dilnlazPaidPubcHodyNum */
             dlgn0100Vo.setDilnlazDdlnePrcsYn((Boolean.TRUE.equals(dlgn0250VO.getDilnlazDdlnePrcsYn()) ? "Y" : "N") );    	/** column ê·¼í_ë§ê°ì²ë¦¬ì¬ë¶ : dilnlazDdlnePrcsYn */
             dlgn0100Vo.setDilnlazNoteCtnt(dlgn0250VO.getDilnlazNoteCtnt());    											/** column ê·¼í_ë¹ê³ ë´ì© : dilnlazNoteCtnt */ 
             dlgn0100Vo.setDilnlazSpclHodyNumDys(dlgn0250VO.getDilnlazSpclHodyNumDys());    								/** column ê·¼í_í¹ë³í´ê°ì¼ì : dilnlazSpclHodyNumDys */
             dlgn0100Vo.setDilnlazSatDutyNumDys(dlgn0250VO.getDilnlazSatDutyNumDys());    									/** column ì´í ìê·¼ë¬´ì¼ì : dilnlazSatDutyNumDys */
//             dlgn0100Vo.setDilnlazPubcHodyDutyNumDys(dlgn0250VO.getDilnlazPubcHodyDutyNumDys());    						/** column ì´í´ì¼ê·¼ë¬´ì¼ì : dilnlazPubcHodyDutyNumDys */
             dlgn0100Vo.setDilnlazHodyDutyNumDys(dlgn0250VO.getDilnlazHodyDutyNumDys());    								/** column í´ì¼ì¼ì : dilnlazHodyDutyNumDys */
             dlgn0100Vo.setDilnlazAbnceDutyRcgtnDys(dlgn0250VO.getDilnlazAbnceDutyRcgtnDys());    							/** column ê·¼í_ê²°ê·¼ì¸ì ì¼ì : dilnlazAbnceDutyRcgtnDys */
             dlgn0100Vo.setPyspGrdeCd(dlgn0250VO.getPyspGrdeCd());    														/** column í¸ë´ë±ê¸ì½ë : pyspGrdeCd */
             dlgn0100Vo.setDilnlazTotDutyTm(dlgn0250VO.getDilnlazTotDutyTm());    											/** column ê·¼í_ì´ê·¼ë¬´ìê° : dilnlazTotDutyTm */
             dlgn0100Vo.setDilnlazPaidHodyNumDys(dlgn0250VO.getDilnlazPaidHodyNumDys());    								/** column ê·¼í_ì ê¸í´ê°ì¼ì : dilnlazPaidHodyNumDys */
             dlgn0100Vo.setDilnlazTfcAssCstNumDys(dlgn0250VO.getDilnlazTfcAssCstNumDys());    								/** column ê·¼í_êµíµë³´ì¡°ë¹ì¼ì : dilnlazTfcAssCstNumDys */ 
             dlgn0100Vo.setDilnlazWkdDutyNumDys(dlgn0250VO.getDilnlazWkdDutyNumDys());    									/** column íì¼ê·¼ë¬´ì¼ì : dilnlazWkdDutyNumDys */

             dlgn0100Vo.setKybdr(sessionUser.getUsrId());    																/** column ìë ¥ì : kybdr */
             dlgn0100Vo.setInptAddr(RemoteServiceUtil.getThreadLocalRequest().getRemoteHost());    							/** column ìë ¥ì£¼ì : inptAddr */
             dlgn0100Vo.setIsmt(sessionUser.getUsrId());    																/** column ìì ì : ismt */
             dlgn0100Vo.setRevnAddr(RemoteServiceUtil.getThreadLocalRequest().getRemoteHost());    							/** column ìì ì£¼ì : revnAddr */

   
                     
             dlgn0200Vo.setDpobCd(dlgn0250VO.getDpobCd());    															/** column ì¬ìì¥ì½ë : dpobCd */
             dlgn0200Vo.setSystemkey(dlgn0250VO.getSystemkey());    													/** column SYSTEMKEY : systemkey */
             dlgn0200Vo.setDilnlazExceDutyYrMnth(dlgn0250SrhVO.getJobYrMnth().replace(".", ""));    					/** column ê·¼íì´ê³¼ê·¼ë¬´ëì : dilnlazExceDut8yYrMnth */
             dlgn0200Vo.setPayCd(dlgn0250SrhVO.getPayCd());    															/** column ê¸ì¬êµ¬ë¶ì½ë : payCd */
             dlgn0200Vo.setEmymtDivCd(dlgn0250VO.getEmymtDivCd());    													/** column ê³ ì©êµ¬ë¶ì½ë : emymtDivCd */
             dlgn0200Vo.setDeptCd(dlgn0250VO.getDeptCd());    															/** column ë¶ìì½ë : deptCd */
             dlgn0200Vo.setBusinCd(dlgn0250VO.getBusinCd());    														/** column ì¬ìì½ë : businCd */
             dlgn0200Vo.setTypOccuCd(dlgn0250VO.getTypOccuCd());    													/** column ì§ì¢ì½ë : typOccuCd */
             dlgn0200Vo.setDtilOccuInttnCd(dlgn0250VO.getDtilOccuInttnCd());    										/** column ì§ì¢ì¸êµ¬ë¶ì½ë : dtilOccuInttnCd */
             dlgn0200Vo.setDilnlazExceDutyBgnnDt(dlgn0250SrhVO.getRflctnBgnnDt());    									/** column ê·¼í_ì´ê³¼ê·¼ë¬´ììì¼ì : dilnlazExceDutyBgnnDt */
             dlgn0200Vo.setDilnlazExceDutyEndDt(dlgn0250SrhVO.getRflctnEndDt());    									/** column ê·¼í_ì´ê³¼ê·¼ë¬´ì¢ë£ì¼ì : dilnlazExceDutyEndDt */
//             dlgn0200Vo.setDilnlazPubcHodyDutyNumDys(dlgn0250VO.getDilnlazPubcHodyDutyNumDys());    					/** column ê·¼í_í´ì¼ê·¼ë¬´ì¼ì : dilnlazPubcHodyDutyNumDys */
             dlgn0200Vo.setDilnlazPubcHodyDutyNumDys(dlgn0250VO.getDilnlazHodyDutyNumDys());    						/** column í´ì¼ì¼ì : dilnlazHodyDutyNumDys */
             dlgn0200Vo.setDilnlazSatDutyNumDys(dlgn0250VO.getDilnlazSatDutyNumDys());    								/** column ê·¼í_í ìê·¼ë¬´ì¼ì : dilnlazSatDutyNumDys */
            // dlgn0200Vo.setDilnlazTotNtotNumDys(dlgn0250Dto.getDilnlazTotNtotNumDys());    /** column ê·¼í_ì´ì¼ê·¼ì¼ì : dilnlazTotNtotNumDys */
             dlgn0200Vo.setDilnlazTotNtotTm(dlgn0250VO.getDilnlazTotNtotTm());    										/** column ê·¼í_ì´ì¼ê·¼ìê° : dilnlazTotNtotTm */
             dlgn0200Vo.setDilnlazFndtnTmRstDutyTm(dlgn0250VO.getDilnlazFndtnTmRstDutyTm());    						/** column ê·¼í_ê¸°ë³¸ìê°ì¸ê·¼ë¬´ìê° : dilnlazFndtnTmRstDutyTm */
             dlgn0200Vo.setDilnlazTmRstDutyTm(dlgn0250VO.getDilnlazTmRstDutyTm());    									/** column ê·¼í_ìê°ì¸ê·¼ë¬´ìê° : dilnlazTmRstDutyTm */
             dlgn0200Vo.setDilnlazTotTmRstDutyTm(dlgn0250VO.getDilnlazTotTmRstDutyTm());    							/** column ê·¼í_ì´ìê°ì¸ê·¼ë¬´ìê° : dilnlazTotTmRstDutyTm */
             dlgn0200Vo.setDilnlazDdlnePrcsYn((Boolean.TRUE.equals(dlgn0250VO.getDilnlazDdlnePrcsYn()) ? "Y" : "N") );	/** column ê·¼í_ë§ê°ì²ë¦¬ì¬ë¶ : dilnlazDdlnePrcsYn */
             dlgn0200Vo.setDilnlazNoteCtnt(dlgn0250VO.getDilnlazNoteCtnt());    										/** column ê·¼í_ë¹ê³ ë´ì© : dilnlazNoteCtnt */
             dlgn0200Vo.setPyspGrdeCd(dlgn0250VO.getPyspGrdeCd());    													/** column í¸ë´ë±ê¸ì½ë : pyspGrdeCd */
             dlgn0200Vo.setKybdr(sessionUser.getUsrId());    															/** column ìë ¥ì : kybdr */
             dlgn0200Vo.setInptAddr(RemoteServiceUtil.getThreadLocalRequest().getRemoteHost());    						/** column ìë ¥ì£¼ì : inptAddr */
             dlgn0200Vo.setIsmt(sessionUser.getUsrId());    															/** column ìì ì : ismt */
             dlgn0200Vo.setRevnAddr(RemoteServiceUtil.getThreadLocalRequest().getRemoteHost());    						/** column ìì ì£¼ì : revnAddr */
