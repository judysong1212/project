	  ...
	  try{
		  ...
		  if(dlgn0210List !=null && dlgn0210List.size() > 0){
			  for ( int i = 0; i < dlgn0210List.size(); i++){
				  ...
				  dlgn0210Vo.setPayCd(MSFSharedUtils.allowNulls(dlgn0210Vo.getPayCd()));		/** 급여구분 column 급여구분코드 : payCd */
				  dlgn0210Vo.setHanNm(MSFSharedUtils.allowNulls(dlgn0210Vo.getHanNm()));//성명 hanNm
				  ...
				  dlgn0210Vo.setDilnlazYrMnth(MSFSharedUtils.allowNulls(dlgn0210Vo.getDilnlazYrMnth()));	/** 년월 column 근태년월 : dilnlazYrMnth */
				  dlgn0210Vo.setDilnlazApptnDt(MSFSharedUtils.allowNulls(dlgn0210Vo.getDilnlazApptnDt()));	/** 년월 column 근무일자 : dilnlazApptnDt */
				  dlgn0210Vo.setDilnlazDutyStTm(MSFSharedUtils.allowNulls(dlgn0210Vo.getDilnlazDutyStTm()));	/** 년월 column 출근시간 : dilnlazDutyStTm */
				  dlgn0210Vo.setDilnlazDutyEdTm(MSFSharedUtils.allowNulls(dlgn0210Vo.getDilnlazDutyEdTm()));	/** 년월 column 퇴근시간 : dilnlazDutyEdTm */
				  dlgn0210Vo.setDilnlazTmRstDutyTm(MSFSharedUtils.allowNulls(dlgn0210Vo.getDilnlazTmRstDutyTm()));	/** 년월 column 평일연장시간 : dilnlazTmRstDutyTm */
				  dlgn0210Vo.setDilnlazNtotTm(MSFSharedUtils.allowNulls(dlgn0210Vo.getDilnlazNtotTm()));	/** 년월 column 평일야근시간 : dilnlazNtotTm */
				  dlgn0210Vo.setDilnlazHodyDutyTm(MSFSharedUtils.allowNulls(dlgn0210Vo.getDilnlazHodyDutyTm()));	/** 년월 column 휴일근무시간 : dilnlazHodyDutyTm */
				  dlgn0210Vo.setDilnlazHodyNtotTm(MSFSharedUtils.allowNulls(dlgn0210Vo.getDilnlazHodyNtotTm()));	/** 년월 column 휴일연장시간 : dilnlazHodyRstDutyTm */
