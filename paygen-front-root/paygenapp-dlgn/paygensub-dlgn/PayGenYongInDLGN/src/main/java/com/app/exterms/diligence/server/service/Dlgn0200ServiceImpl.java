...
//	extends RemoteServiceDispatcher
	...
	private String detailYmKubn = "201612"; //복무관리 기준일
...
//		String method = calledClass + ".getDlgn0200List_01";
//		
//        Dlgn0200SrhVO   dlgn0200SrhVO = new Dlgn0200SrhVO();
...
//            
//            //조건절
//            dlgn0200SrhVO.setDpobCd(sessionUser.getDpobCd()); //사업코드
//            dlgn0200SrhVO.setDilnlazApptnDt(MSFSharedUtils.defaultNulls(MSFServerUtils.getFilterValue(columnFilters, "detailYm"), "")); //근태년월
//            dlgn0200SrhVO.setHanNm(MSFSharedUtils.defaultNulls(MSFServerUtils.getFilterValue(columnFilters, "detailName"), "")); //성명
////            dlgn0200SrhVO.setResnRegnNum(AnyCryptUtils.getEncSyncCrypt(nResult,MSFSharedUtils.defaultNulls(MSFServerUtils.getFilterValue(columnFilters, "detailRegnNum"), "").replaceAll("-",""),AnyCryptUtils.SEC_RRNUMC));	//주민번호
//            dlgn0200SrhVO.setDetailEmymtBgnnDt(MSFSharedUtils.defaultNulls(MSFServerUtils.getFilterValue(columnFilters, "detailEmymtBgnnDt"), "")); //시작일자 
//            
//            
//	         TimingInfo millisBeginDlgb0200DataList = SmrmfUtils.startTiming(logger);
//	         
//	            /**페이지 카운트 처리를 위한 부분 */ 
//	         dlgn0200SrhVO.setPageSize(pagingValues.totalRecordCount);  
//	            
//	            //Apply paging
//	            if (pagingValues.start > 0) {
//	            	dlgn0200SrhVO.setFirstIndex(pagingValues.start);
//	            }
//	            if (pagingValues.offsetLimit > 0) {
//	            	dlgn0200SrhVO.setLastIndex(Math.min(pagingValues.start + pagingValues.offsetLimit, pagingValues.totalRecordCount)); 
//	            }
//
...
//	            System.out.println("dlgn0200SrhVO ========== "+dlgn0200SrhVO);
//	            
//	            List list = dlgn0200Dao.selectDlgn0200List(dlgn0200SrhVO);
//	            
//	            for(int i = 0; i<list.size(); i++){
...
//	            	
//	            	// 1. 암호화 객체 생성
//	            	String rResult = AnyCryptUtils.XecureCryptInitialize(RemoteServiceUtil.getThreadLocalConfig(),RemoteServiceUtil.getThreadLocalRequest());
//	            	
//	                Map<String, Object> map = (Map<String, Object>) iter.next();
...
//	                 	          			
//	                 			// 주민번호(복호화)
//	                 			rrnDecCrypt = AnyCryptUtils.getDecSyncCrypt(rResult,MSFSharedUtils.allowNulls(strValue).replace("-", ""),AnyCryptUtils.SEC_RRNUMC);
//	                 	          		
...
//	            
//	            SmrmfUtils.endTiming(logger, millisBeginDlgb0200DataList, "getDlgn0200List_01");
//	            
//	            
//	            
//        }catch (Exception ex) {
...
//            	dlgn0210DAO.updateDlgn0210Grid_Yn(dlgn0210Vo);   //************************ 이전로직 : 분단위로 개발된 로직
            	
//            	dlgn0110DAO.updateDlgn0210GridDlgn0110(dlgn0210Vo);  //************************ 이전로직 : 분단위로 개발된 로직
...
////				infcDlgn0200Vo.setPyspGrdeCd(dlgn0210Vo.getPyspGrdeCd());    /** TODO 추가후 수정  column 호봉등급코드 : pyspGrdeCd */
