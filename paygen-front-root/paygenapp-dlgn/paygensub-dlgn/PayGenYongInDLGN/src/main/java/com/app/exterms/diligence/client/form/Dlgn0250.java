...
//	    };
      ...
      private void dlgn0250FormSave() {  
          ...
          if (MSFSharedUtils.paramNotNull(records)) { 
               ...
               List<Dlgn0250DTO> listDlgn0250dto = new ArrayList<Dlgn0250DTO>();  
            	   ...
            	   return ;
	                ...
	                while (records.hasNext()) {
	                  ...
	                  //  dlgn0250Dto.setPyspGrdeCd(MSFSharedUtils.allowNulls(bmMapModel.get("pyspGrdeCd")));    /** column 호봉등급코드 : pyspGrdeCd */
	                    ...
	                    dlgn0250Dto.setDilnlazButpDys(MSFSharedUtils.allowNulls(bmMapModel.get("dilnlazButpDys")));    							/** column 근태_출장일수 : dilnlazButpDys */
...
//                 layoutContainer21.add(lc31, new com.extjs.gxt.ui.client.widget.layout.ColumnData(.34));
                 layoutContainer21.add(lc21, new com.extjs.gxt.ui.client.widget.layout.ColumnData(.28));
               ...
               //  lcSchRight.setStyleAttribute("paddingRight", "10px");
                ...
                // fieldSet.setLayout(layout);  
                 ...
                 layoutContainer.add(lc1, new com.extjs.gxt.ui.client.widget.layout.ColumnData(.2));
...
//                 layoutContainer.add(lc3, new com.extjs.gxt.ui.client.widget.layout.ColumnData(.29));
                 layoutContainer.add(lc2, new com.extjs.gxt.ui.client.widget.layout.ColumnData(.28));
                 layoutContainer.add(lc3, new com.extjs.gxt.ui.client.widget.layout.ColumnData(.3));
                 layoutContainer.add(lc4, new com.extjs.gxt.ui.client.widget.layout.ColumnData(.22));
   ...
   **/ 	 
	...
	//    dlgn0250GridPanel.getGrid().getColumnModel().addHeaderGroup(0, 19, new HeaderGroupConfig("휴일근무", 1, 3));
	//    dlgn0250GridPanel.getGrid().getColumnModel().addHeaderGroup(0, 26, new HeaderGroupConfig("시간외근무", 1, 3));
...
//	                    bmData.set("dilnlazYrMnth", DateTimeFormat.getFormat("yyyy.MM").format(new Date())); /** column 근태년월 : dilnlazYrMnth */
	                    bmData.set("dilnlazYrMnth", MSFSharedUtils.getSelectedComboValue(creYear,"year")
	                    				+ MSFSharedUtils.getSelectedComboValue(creMonth,"month")); /** column 근태년월 : dilnlazYrMnth */
	                	...
	                	bmData.set("dilnlazButpDys","0");    			/** column 근태_출장일수 : dilnlazButpDys */
      ...
      @Override
       public void handleEvent(MessageBoxEvent be) {
    	  ...
    	  if(Dialog.YES.equals(be.getButtonClicked().getItemId())){
               ...
               final String year = DlgnUtils.getSelectedComboValue(creYear,"year");
               final String month = DlgnUtils.getSelectedComboValue(creMonth,"month");
               final String payCd = DlgnUtils.getSelectedComboValue(crePayCd,"commCd");
               final String workDayS = DlgnUtils.getConvertDateToString(creWorkDayS, "yyyyMMdd");
               final String workDayE = DlgnUtils.getConvertDateToString(creWorkDayE, "yyyyMMdd"); 
               final String emymtDivCd = DlgnUtils.getSelectedComboValue(creEmymtDivCd,"commCd");
               
            //   String deptCd = MSFSharedUtils.allowNulls(creCurrDeptCd.getValue());
            //   String typOccuCd = DlgnUtils.getSelectedComboValue(creTypOccuCd,"typOccuCd"); 
               
               final String deptCd = DlgnUtils.getStrValToBMMultiCombo(lscrDeptCd,creDeptCd.getValue(),"deptNmRtchnt","deptCd");  
               final String typOccuCd = DlgnUtils.getStrValToBMMultiCombo(lscrTypOccuCd,creTypOccuCd.getValue(),"typOccuNm","typOccuCd"); 
             //  String pyspGrdeCd = DlgnUtils.getStrValToBMMultiCombo(lscrTypOccuCd,creTypOccuCd.getValue(),"typOccuNm","pyspGrdeCd");  
               final String dtilOccuInttnCd = DlgnUtils.getStrValToBMMultiCombo(lscrDtilOccuInttnCd,creDtilOccuInttnCd.getValue(),"dtilOccuClsNm","dtilOccuInttnCd");  
                
               final String businCd = DlgnUtils.getSelectedComboValue(creBusinCd, "businCd"); 
               
               final String payrMangDeptCd = DlgnUtils.getSelectedComboValue(crePayrMangDeptCd,"payrMangDeptCd"); 
               ...
               }else if(GregorianCalendar.compareDate(creWorkDayS.getValue(), creWorkDayE.getValue()) >31 ){
            	   MessageBox.confirm("근태생성", "근태기간이 31일(1개월)을 초과합니다.<br>그래도 생성하시겠습니까?",new Listener<MessageBoxEvent>(){
						@Override
						public void handleEvent(MessageBoxEvent be) {
							if(Dialog.YES.equals(be.getButtonClicked().getItemId())){
								final Tracker tracker = new Tracker();
