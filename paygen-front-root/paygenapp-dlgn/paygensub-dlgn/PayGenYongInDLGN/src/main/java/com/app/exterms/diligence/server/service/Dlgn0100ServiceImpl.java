...
//            	dlgn0210DAO.updateDlgn0100Todlgn0210Tm(dlgn0110Dto);  /******************************* 이전로직 : 분단위로 개발된 로직
...
////			infcDlgn0100Vo.setPyspGrdeCd(dlgn0110Dto.getPyspGrdeCd());    			/** TODO 추가후 수정  column 호봉등급코드 : pyspGrdeCd */
