...
import com.web.smrmf.cons.WebParamKey;
import com.web.smrmf.core.command.ControlResult;
import com.web.smrmf.core.service.SchedulerService;
import com.web.smrmf.core.vo.SysmServerVO;
...
public class ControlController {
   ...
   public ModelAndView control(@ModelAttribute("cache") Cache cache, HttpServletRequest request, ModelMap map) {
      ...
      List<SysmServerVO> svrList = schedulerService.getServerList();
      for(SysmServerVO server: svrList){
         try{
