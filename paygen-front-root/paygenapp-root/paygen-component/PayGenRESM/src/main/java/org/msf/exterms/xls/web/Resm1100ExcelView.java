...
public class Resm1100ExcelView extends AbstractExcelView{
	/**
	 * 엑셀파일을 설정하고 생성한다.
	 * @param model
	 * @param wb
	...
	protected void buildExcelDocument(Map<String, Object> model,
		...
		String xlsRelatvieFilepath = realPath.concat("/".concat(globals.get("PayGen.XLSTemplateLink")).concat("/BASS/XLS_BASS0320.xls"));
		
		String destFileName = "직종업로드양식".concat(rndName);
