...
@Controller
public class Resm1100ExcelController {
	private static final Logger logger = LoggerFactory.getLogger(Resm1100ExcelController.class);  
    private static final String calledClass = Resm1100ExcelController.class.getName();
    
    @Resource(name = "Resm1100ExcelService")
    private Resm1100ExcelService bass0320ExcelService;
     ...
     * @throws Exception
     */
    @RequestMapping(value="/exp/XlsFileResm1100Export.do")
...
//        	map.put("listBass0320", excelList);
    	...
    	return new ModelAndView("resm1100ExcelView", map);
    }
     ...
     */
    @RequestMapping(value = "/imp/XlsReadResm1100Import.do", method = RequestMethod.POST)
