...
import com.app.exterms.resm.client.service.Resm5400Service;
...
@Service("Resm5400Service")
public class Resm5400ServiceImpl extends AbstractCustomServiceImpl  implements  ResmDaoConstants ,Resm5400Service {

	private static final Logger logger = LoggerFactory.getLogger(Resm5400ServiceImpl.class);
	private static final String calledClass = Resm5400ServiceImpl.class.getName();
