...
import com.app.exterms.resm.client.service.Resm2100Service;
...
@Service("Resm2100Service")
public class Resm2100ServiceImpl extends AbstractCustomServiceImpl  implements  ResmDaoConstants ,Resm2100Service {

	private static final Logger logger = LoggerFactory.getLogger(Resm2100ServiceImpl.class);
	private static final String calledClass = Resm2100ServiceImpl.class.getName();
