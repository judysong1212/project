...
@Service("Resm1200Service")
public class Resm1200ServiceImpl extends AbstractCustomServiceImpl implements	ResmDaoConstants, Resm1200Service {
	
	private static final Logger logger = LoggerFactory.getLogger(Resm1200ServiceImpl.class);
	private static final String calledClass = Resm1200ServiceImpl.class.getName();
	
	
	@Autowired
	@Resource(name = "ResmIfBass0350DAO")
	private ResmIfBass0350DAO resmIfBass0350Dao;
	...
	public PagingLoadResult<BaseModel> getSelectBass0350List(ServiceParameters serviceParameters) throws MSFException {
        ...
        String method =  CLASS_RESM1200TOBASS0350_LIST;
        List<BaseModel>  bmResult = new ArrayList<BaseModel>();
        Bass0350DTO srhDto = new Bass0350DTO();
        
        if(MSFSharedUtils.paramNull(resmIfBass0350Dao)){
        	WebApplicationContext wac = WebApplicationContextUtils.getRequiredWebApplicationContext( getHttpServletRequest().getSession().getServletContext());
        	resmIfBass0350Dao = (ResmIfBass0350DAO) wac.getBean("ResmIfBass0350DAO");
        }
        try{
            ...
            if (pagingValues.executeRecordCount ) { 
            	...
            	int iResultCnt = resmIfBass0350Dao.selectBass0350ListTotCnt(srhDto);
            ...
            List list = resmIfBass0350Dao.selectBass0350List(srhDto);
	...
	public String saveBass0350(Bass0350DTO dto, ActionDatabase actionDatabase) throws MSFException {
		...
		//직종세 유무 파악
		int iCount2 = resmIfBass0350Dao.selectBassP035001ListTotCnt(bass0350vo);
			...
			switch(actionDatabase){
				case INSERT :
					if(iCount2 > 0){
	        			...
	        			throw MSFServerUtils.getValidationException("saveBass0350_resmIfBass0350Dao.selectBassP035001ListTotCnt(bass0350vo)", errMsg1, logger) ;						
					}else{
						resmIfBass0350Dao.insertBass0350(dto);
						resmIfBass0350Dao.updateChrBass0350(dto);
						returnCnt = 1;						
					}					
					break;
				case UPDATE : 
					returnCnt = resmIfBass0350Dao.updateBass0350(dto);
					break;
				case DELETE : returnCnt = resmIfBass0350Dao.deleteBass0350(dto);
					break;
				}
