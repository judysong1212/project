...
@Service("Resm2300Service")
public class Resm2300ServiceImpl extends AbstractCustomServiceImpl  implements  ResmDaoConstants ,Resm2300Service {

	private static final Logger logger = LoggerFactory.getLogger(Resm2300ServiceImpl.class);
	private static final String calledClass = Resm2300ServiceImpl.class.getName();
