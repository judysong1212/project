...
import com.app.exterms.resm.client.dto.Bass0500BM;
...
public class Bass0500Def extends TableDef implements ResmDaoConstants {
    private int row = 0;
    ...
    public Bass0500Def(){
    	  ...
    	  setTitle("");
          setDaoClass(CLASS_RESM3200TOBASS0500_LIST); 
          setCustomListMethod(CLASS_RESM3200TOBASS0500_LIST);
...
//	        setCellModel(true);
    ...
    private List<ColumnDef> getAllColumnsList(){
        ...
        listColumnDefs.add(new ColumnDef("사업장명",  Bass0500BM.ATTR_DPOBNM, ColumnDef.TYPE_STRING, 100, true, true, true));
        /** column 부서코드 : deptCd */
...
//  });
   ...
   private List<ColumnDef> getBass0500List(){
        ...
        listColumnDefs.add(new ColumnDef("사업장명",  Bass0500BM.ATTR_DPOBNM, ColumnDef.TYPE_STRING, 100, true, false, true));
