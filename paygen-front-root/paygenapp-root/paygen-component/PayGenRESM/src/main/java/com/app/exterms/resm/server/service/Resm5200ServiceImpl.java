...
import com.app.exterms.resm.client.service.Resm5200Service;
...
@Service("Resm5200Service")
public class Resm5200ServiceImpl extends AbstractCustomServiceImpl  implements  ResmDaoConstants ,Resm5200Service {

	private static final Logger logger = LoggerFactory.getLogger(Resm5200ServiceImpl.class);
	private static final String calledClass = Resm5200ServiceImpl.class.getName();
