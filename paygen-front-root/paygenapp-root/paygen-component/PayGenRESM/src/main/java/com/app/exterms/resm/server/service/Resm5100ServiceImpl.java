...
import com.app.exterms.resm.client.service.Resm5100Service;
...
@Service("Resm5100Service")
public class Resm5100ServiceImpl extends AbstractCustomServiceImpl  implements  ResmDaoConstants ,Resm5100Service {

	private static final Logger logger = LoggerFactory.getLogger(Resm5100ServiceImpl.class);
	private static final String calledClass = Resm5100ServiceImpl.class.getName();
