...
@Repository("ResmIfBass0320DAO")
public class ResmIfBass0320DAO extends EgovAbstractDAO {
    ...
    public String insertBass0320(Bass0320VO vo) throws Exception {
        return (String)insert("resmIfBass0320DAO.insertBass0320_S", vo);
    }
    ...
    public void updateBass0320(Bass0320VO vo) throws Exception {
        update("resmIfBass0320DAO.updateBass0320_S", vo);
    }
    ...
    public void deleteBass0320(Bass0320VO vo) throws Exception {
        delete("resmIfBass0320DAO.deleteBass0320_S", vo);
    }
    ...
    public Bass0320VO selectBass0320(Bass0320VO vo) throws Exception {
        return (Bass0320VO) selectByPk("resmIfBass0320DAO.selectBass0320_S", vo);
    }
    ...
    public List<?> selectBass0320List(Bass0320SrhVO searchVO) throws Exception {
        return list("resmIfBass0320DAO.selectBass0320List_D", searchVO);
    }
    ...
    public int selectBass0320ListTotCnt(Bass0320SrhVO searchVO) {
        return (Integer)getSqlMapClientTemplate().queryForObject("resmIfBass0320DAO.selectBass0320ListTotCnt_S", searchVO);
    }
	...
	public List selectXlsBass0320List(Bass0320SrhVO bass0320SrhVo) {
		...
		return list("resmIfBass0320DAO.selectXlsBass0320List_D", bass0320SrhVo);
	}
	
	public String insertXlsBass0320(Bass0320VO bass0320vo)throws Exception {
		
		return (String)insert("resmIfBass0320DAO.insertXlsBass0320_S",bass0320vo);
	}
	
	public void updateXlsBass0320(Bass0320VO bass0320vo)throws Exception {
		
		update("resmIfBass0320DAO.updateXlsBass0320_S",bass0320vo);
	}
