...
@Service("Resm1100Service")
public class Resm1100ServiceImpl extends AbstractCustomServiceImpl  implements  ResmDaoConstants ,Resm1100Service {

	private static final Logger logger = LoggerFactory.getLogger(Resm1100ServiceImpl.class);
	private static final String calledClass = Resm1100ServiceImpl.class.getName();
