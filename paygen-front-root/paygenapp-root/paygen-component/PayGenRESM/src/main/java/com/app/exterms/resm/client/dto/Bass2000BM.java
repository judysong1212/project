 ...
 */
public class Bass2000BM    extends MSFSimpleBaseModel implements IsSerializable   {
    ...
    public static final String ATTR_REDTITEM = "redItem";
    ...
    public static final String ATTR_WORKBUSINCRETNYR = "workBusinCretnYr";

    /** set 근로사업구분코드 : workBusinDivCd */
    public static final String ATTR_WORKBUSINDIVCD = "workBusinDivCd";

    /** set 근로사업단계구분코드 : workBusinStgeDivCd */
    public static final String ATTR_WORKBUSINSTGEDIVCD = "workBusinStgeDivCd";

    /** set 근로사업시작일자 : workBusinBgnnDt */
    public static final String ATTR_WORKBUSINBGNNDT = "workBusinBgnnDt";

    /** set 근로사업종료일자 : workBusinEndDt */
    public static final String ATTR_WORKBUSINENDDT = "workBusinEndDt";

    /** set 근로사업사용여부 : workBusinUseYn */
    public static final String ATTR_WORKBUSINUSEYN = "workBusinUseYn";

    /** set 근로사업비고내용 : workBusinCtnt */
    public static final String ATTR_WORKBUSINCTNT = "workBusinCtnt";
 
    /** 생성자 */
     public Bass2000BM() { super(); } 
...
/** set 근로사업생성년도 : workBusinCretnYr */
public void setWorkBusinCretnYr(String  workBusinCretnYr) { set( ATTR_WORKBUSINCRETNYR ,workBusinCretnYr);}
/** get 근로사업생성년도 : workBusinCretnYr */
public String  getWorkBusinCretnYr() { return (String )get( ATTR_WORKBUSINCRETNYR );}

/** set 근로사업구분코드 : workBusinDivCd */
public void setWorkBusinDivCd(String  workBusinDivCd) { set( ATTR_WORKBUSINDIVCD ,workBusinDivCd);}
/** get 근로사업구분코드 : workBusinDivCd */
public String  getWorkBusinDivCd() { return (String )get( ATTR_WORKBUSINDIVCD );}

/** set 근로사업단계구분코드 : workBusinStgeDivCd */
public void setWorkBusinStgeDivCd(String  workBusinStgeDivCd) { set( ATTR_WORKBUSINSTGEDIVCD ,workBusinStgeDivCd);}
/** get 근로사업단계구분코드 : workBusinStgeDivCd */
public String  getWorkBusinStgeDivCd() { return (String )get( ATTR_WORKBUSINSTGEDIVCD );}

/** set 근로사업시작일자 : workBusinBgnnDt */
public void setWorkBusinBgnnDt(String  workBusinBgnnDt) { set( ATTR_WORKBUSINBGNNDT ,workBusinBgnnDt);}
/** get 근로사업시작일자 : workBusinBgnnDt */
public String  getWorkBusinBgnnDt() { return (String )get( ATTR_WORKBUSINBGNNDT );}

/** set 근로사업종료일자 : workBusinEndDt */
public void setWorkBusinEndDt(String  workBusinEndDt) { set( ATTR_WORKBUSINENDDT ,workBusinEndDt);}
/** get 근로사업종료일자 : workBusinEndDt */
public String  getWorkBusinEndDt() { return (String )get( ATTR_WORKBUSINENDDT );}

/** set 근로사업사용여부 : workBusinUseYn */
public void setWorkBusinUseYn(String  workBusinUseYn) { set( ATTR_WORKBUSINUSEYN ,workBusinUseYn);}
/** get 근로사업사용여부 : workBusinUseYn */
public String  getWorkBusinUseYn() { return (String )get( ATTR_WORKBUSINUSEYN );}

/** set 근로사업비고내용 : workBusinCtnt */
public void setWorkBusinCtnt(String  workBusinCtnt) { set( ATTR_WORKBUSINCTNT ,workBusinCtnt);}
/** get 근로사업비고내용 : workBusinCtnt */
public String  getWorkBusinCtnt() { return (String )get( ATTR_WORKBUSINCTNT );}
