 ...
 */
public class Bass1200BM   extends MSFSimpleBaseModel implements IsSerializable{
    ...
    /** set 정상근무시간수 : norDutyTmNum */
    public void setNorDutyTmNum(Double  norDutyTmNum) { set( ATTR_NORDUTYTMNUM ,norDutyTmNum);}
    /** get 정상근무시간수 : norDutyTmNum */
    public Double  getNorDutyTmNum() { return (Double )get( ATTR_NORDUTYTMNUM );}
