...
import com.app.exterms.resm.client.service.Resm5300Service;
...
@Service("Resm5300Service")
public class Resm5300ServiceImpl extends AbstractCustomServiceImpl  implements  ResmDaoConstants ,Resm5300Service {

	private static final Logger logger = LoggerFactory.getLogger(Resm5300ServiceImpl.class);
	private static final String calledClass = Resm5300ServiceImpl.class.getName();
