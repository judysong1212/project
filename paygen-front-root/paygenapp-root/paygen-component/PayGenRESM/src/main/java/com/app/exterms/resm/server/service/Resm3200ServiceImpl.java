...
@Service("Resm3200Service")
public class Resm3200ServiceImpl extends AbstractCustomServiceImpl implements
		ResmDaoConstants, Resm3200Service {
	
	private static final Logger logger = LoggerFactory.getLogger(Resm3200ServiceImpl.class);
	private static final String calledClass = Resm3200ServiceImpl.class.getName();
	
	@Autowired
	@Resource(name = "ResmIfBass0500DAO")
	private ResmIfBass0500DAO resmIfBass0500DAO;

	@SuppressWarnings({ "unchecked", "rawtypes" })
	public PagingLoadResult<BaseModel> getSelectResm3200ToBass0500List(ServiceParameters serviceParameters) throws Exception {

        PagingLoadResult<BaseModel> retval = null;
        String method =  CLASS_RESM3200TOBASS0500_LIST;
        List<BaseModel>  bmResult = new ArrayList<BaseModel>();
        Bass0500DTO srhDto = new Bass0500DTO();
        
        if(MSFSharedUtils.paramNull(resmIfBass0500DAO)){
        	WebApplicationContext wac = WebApplicationContextUtils.getRequiredWebApplicationContext( getHttpServletRequest().getSession().getServletContext());
        	resmIfBass0500DAO = (ResmIfBass0500DAO) wac.getBean("ResmIfBass0500DAO");
        }
...
//            String srhBusinNm = MSFServerUtils.getFilterValue(columnFilters, "srhBusinNm") == null ? "" : String.valueOf(MSFServerUtils.getFilterValue(columnFilters, "srhBusinNm"));
            ...
            if ( pagingValues.executeRecordCount ) { 
            	...
            	int iResultCnt = resmIfBass0500DAO.selectBass0500ListTotCnt(srhDto);
            ...
            List list = resmIfBass0500DAO.selectBass0500List(srhDto);
	...
	public String saveBass0500(Bass0500DTO dto, ActionDatabase actionDatabase) throws Exception {
		...
		try {
			switch(actionDatabase){
				case INSERT :returnCnt = resmIfBass0500DAO.saveBass0500(dto);
					break;
				case UPDATE : returnCnt = resmIfBass0500DAO.saveBass0500(dto);
					break;
				case DELETE : returnCnt = resmIfBass0500DAO.deleteBass0500(dto);
					break;
			}
	...
	public List<BaseModel> getBass0400List() throws Exception {
		...
		try{
			...
			egovResultDataList = resmIfBass0500DAO.getBass0400List(dto);
	...
	public List<BaseModel> getBass0500BusinYrList() throws MSFException {
		...
		try{
			...
			egovResultDataList = resmIfBass0500DAO.getCreBass0500BusinYrList(dto);
