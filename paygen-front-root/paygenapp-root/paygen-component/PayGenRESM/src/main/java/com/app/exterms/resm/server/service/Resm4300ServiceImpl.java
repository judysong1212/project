...
import com.app.exterms.resm.client.service.Resm4300Service;
...
@Service("Resm4300Service")
public class Resm4300ServiceImpl extends AbstractCustomServiceImpl  implements  ResmDaoConstants ,Resm4300Service {

	private static final Logger logger = LoggerFactory.getLogger(Resm4300ServiceImpl.class);
	private static final String calledClass = Resm4300ServiceImpl.class.getName();
