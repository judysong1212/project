...
import com.app.exterms.resm.client.service.Resm3100Service;
...
@Service("Resm3100Service")
public class Resm3100ServiceImpl extends AbstractCustomServiceImpl  implements  ResmDaoConstants ,Resm3100Service {

	private static final Logger logger = LoggerFactory.getLogger(Resm3100ServiceImpl.class);
	private static final String calledClass = Resm3100ServiceImpl.class.getName();
