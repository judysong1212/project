...
@Service("ResmP120001Service")
public class ResmP120001ServiceImpl extends AbstractCustomServiceImpl implements ResmDaoConstants, ResmP120001Service {
	
	private static final Logger logger = LoggerFactory.getLogger(ResmP120001ServiceImpl.class);
	private static final String calledClass = ResmP120001ServiceImpl.class.getName();
