...
import com.app.exterms.resm.client.service.Resm2200Service;
...
@Service("Resm2200Service")
public class Resm2200ServiceImpl extends AbstractCustomServiceImpl  implements  ResmDaoConstants ,Resm2200Service {

	private static final Logger logger = LoggerFactory.getLogger(Resm2200ServiceImpl.class);
	private static final String calledClass = Resm2200ServiceImpl.class.getName();
