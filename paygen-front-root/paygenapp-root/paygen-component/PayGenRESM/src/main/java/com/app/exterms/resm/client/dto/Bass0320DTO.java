...
public class Bass0320DTO  extends BaseModel{
...
public void setTypOccuEddt(java.lang.String typOccuEddt) {
	...
	public Boolean getTypOccuUseYn() {
		return typOccuUseYn;
	}

	public void setTypOccuUseYn(Boolean typOccuUseYn) {
	...
	public Long getTypOccuOrd() {
		return typOccuOrd;
	}

	public void setTypOccuOrd(Long typOccuOrd) {
