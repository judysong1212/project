...
import com.app.exterms.resm.client.service.Resm4100Service;
...
@Service("Resm4100Service")
public class Resm4100ServiceImpl extends AbstractCustomServiceImpl  implements  ResmDaoConstants ,Resm4100Service {

	private static final Logger logger = LoggerFactory.getLogger(Resm4100ServiceImpl.class);
	private static final String calledClass = Resm4100ServiceImpl.class.getName();
