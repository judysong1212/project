...
import com.app.exterms.resm.client.service.Resm4200Service;
...
@Service("Resm4200Service")
public class Resm4200ServiceImpl extends AbstractCustomServiceImpl  implements  ResmDaoConstants ,Resm4200Service {

	private static final Logger logger = LoggerFactory.getLogger(Resm4200ServiceImpl.class);
	private static final String calledClass = Resm4200ServiceImpl.class.getName();
