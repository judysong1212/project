 ...
 * =====================================================
 **/
public class Resm2200 extends MSFPanel {
	/**
	 * ########################################################################## 
	 * { 시스템 기본설정파일 선언부 시작}
	 * ##########################################################################
	...
	// 입력수정삭제처리 rpc 처리부
	private Resm1100ServiceAsync Resm2100Service = Resm1100Service.Util.getInstance();
			...
			MessageBox.confirm("","DELETE".equals(actionDatabase.name()) ? "삭제 하시겠습니까?" : "저장 하시겠습니까?",new Listener<MessageBoxEvent>(){
				...
				public void handleEvent(MessageBoxEvent be) {
					...
					if(Dialog.YES.equals(be.getButtonClicked().getItemId())){
						Resm2100Service.saveBass0320(dto, actionDatabase, new AsyncCallback<Long>() {
							@Override
...
//			});
	...
	public Resm2200(String txtForm) {
