...
import com.app.exterms.resm.client.dto.Bass0320BM;
...
public class Bass0320Def extends TableDef implements ResmDaoConstants {
    private int row = 0;
    ...
    public Bass0320Def(){
    	  ...
    	  setTitle("");
          setDaoClass(""); 
          setCustomListMethod(CLASS_RESM1100TOBASS0320_LIST);
