...
import com.app.exterms.resm.client.dto.Bass0350BM;
...
public class Bass0350Def extends TableDef implements ResmDaoConstants {
    private int row = 0;
    ...
    public Bass0350Def(){
    	  ...
    	  setTitle("");
          setDaoClass(""); 
          setCustomListMethod(CLASS_RESM1200TOBASS0350_LIST);
