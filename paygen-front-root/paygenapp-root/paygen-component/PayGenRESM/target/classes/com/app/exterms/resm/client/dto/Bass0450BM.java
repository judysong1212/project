 ...
 */
public class Bass0450BM   extends MSFSimpleBaseModel implements IsSerializable{
    ...
    public static final String ATTR_HHRKSRHSECTISEILNUM = "hhrkSrhSectiSeilNum";
    ...
    /** 일괄등록 처리   */
     public Bass0450BM(
     	...
     	values.put(ATTR_HHRKSRHSECTISEILNUM,hhrkSrhSectiSeilNum);
    ...
    /** set 상위검색구간사용여부 : hhrkSrhSectiSeilNum */
    public void setHhrkSrhSectiSeilNum(Long  hhrkSrhSectiSeilNum) { set( ATTR_HHRKSRHSECTISEILNUM ,hhrkSrhSectiSeilNum);}
    /** get 상위검색구간사용여부 : hhrkSrhSectiSeilNum */
    public Long  getHhrkSrhSectiSeilNum() { return (Long )get( ATTR_HHRKSRHSECTISEILNUM );}
