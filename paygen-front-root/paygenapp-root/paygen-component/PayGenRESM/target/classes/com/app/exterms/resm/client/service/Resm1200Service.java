...
public interface Resm1200Service extends RemoteService {
	/**
	 * Utility class for simplifying access to the instance of async service.
	 */
	public static class Util {
		private static Resm1200ServiceAsync instance;
		public static Resm1200ServiceAsync getInstance(){
			if (instance == null) {
				instance = GWT.create(Resm1200Service.class);
			}
			return instance;
		}
	}
