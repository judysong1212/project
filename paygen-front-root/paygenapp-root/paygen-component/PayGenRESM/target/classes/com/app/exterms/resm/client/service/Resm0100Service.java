...
@RemoteServiceRelativePath("Resm0100Service.gwt")
public interface Resm0100Service extends RemoteService {
	/**
	 * Utility class for simplifying access to the instance of async service.
	 */
	public static class Util {
		private static Resm0100ServiceAsync instance;
		public static Resm0100ServiceAsync getInstance(){
			if (instance == null) {
				instance = GWT.create(Resm0100Service.class);
			}
			return instance;
		}
	}
