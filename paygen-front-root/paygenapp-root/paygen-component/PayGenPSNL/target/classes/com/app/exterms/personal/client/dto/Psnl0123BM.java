...
public class Psnl0123BM    extends MSFSimpleBaseModel implements IsSerializable   {
    ...
    /** set 휴직구분코드 : levfAbncDivNm */
    public static final String ATTR_LEVFABNCDIVNM = "levfAbncDivNm";
    ...
    /** set 휴직일련번호 : levfAbncSeilNum */
    public void setLevfAbncSeilNum(BigDecimal  levfAbncSeilNum) { set( ATTR_LEVFABNCSEILNUM ,levfAbncSeilNum);}
    /** get 휴직일련번호 : levfAbncSeilNum */
    public BigDecimal  getLevfAbncSeilNum() { return (BigDecimal )get( ATTR_LEVFABNCSEILNUM );}
    /** set 휴직구분코드 : levfAbncDivCd */
    ...
    /** set 휴직구분코드 : levfAbncDivNm */
    public void setLevfAbncDivNm(String  levfAbncDivNm) { set( ATTR_LEVFABNCDIVNM, levfAbncDivNm);}
    /** get 휴직구분코드 : levfAbncDivNm */
    public String  getLevfAbncDivNm() { return (String )get( ATTR_LEVFABNCDIVNM );}
