 ...
 */
public class Psnl0100BM    extends MSFSimpleBaseModel implements IsSerializable   {
	...
	public static final String ATTR_ACCOUNTDIVCD = "accountDivCd";
	
	/** 생성자 */
	 public Psnl0100BM() { super(); } 
	...
	/** 일괄등록 처리   */
	 public Psnl0100BM(
	 	...
	 	values.put(ATTR_ACCOUNTDIVCD,accountDivCd); } 
	...
	/** set 담당업무구분코드 : repbtyBusinDivCd */
	public void setAccountDivCd(String  accountDivCd) { set( ATTR_ACCOUNTDIVCD ,accountDivCd);}
	/** get 담당업무구분코드 : repbtyBusinDivCd */
	public String  getAccountDivCd() { return (String)get( ATTR_ACCOUNTDIVCD );}
	...
	/** set 부서 : currDeptNm */
    public static final String ATTR_CURRDEPTNM = "currDeptNm";
    ...
    /** set 직종명 : typeOccuNm */
    public static final String ATTR_TYPEOCCUNM = "typeOccuNm";
    ...
    /** set 부서 : currDeptNm */
	public void setCurrDeptNm(String  currDeptNm) { set( ATTR_CURRDEPTNM ,currDeptNm);}
	/** get 부서 : currDeptNm */
	public String  getCurrDeptNm() { return (String )get( ATTR_CURRDEPTNM );}
    ...
    /** set 직종명 : typeOccuNm */
	public void setTypeOccuNm(String  typeOccuNm) { set( ATTR_TYPEOCCUNM ,typeOccuNm);}
    /** set 직종명 : typeOccuNm */
	public String  getTypeOccuNm() { return (String )get( ATTR_TYPEOCCUNM );}
