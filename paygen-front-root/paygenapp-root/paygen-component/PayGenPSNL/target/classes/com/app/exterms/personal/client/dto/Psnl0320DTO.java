...
public class Psnl0320DTO extends BaseModel{
	...
	/* set 호봉재획정계산일자 : pyspReMrkCalcDt */
    public void setPyspReMrkCalcDt(java.lang.String pyspReMrkCalcDt) {set("pyspReMrkCalcDt",pyspReMrkCalcDt);}
    public java.lang.String getPyspReMrkCalcDt() {return (String)get("pyspReMrkCalcDt");}


    /* set 근속일수 : logSvcDys */
    public void setLogSvcDys(java.lang.String logSvcDys) {set("logSvcDys",logSvcDys);}
    public java.lang.String getLogSvcDys() {return (String)get("logSvcDys");}
	...
	public String getCvsnRtoDivCd() { return (String)get("cvsnRtoDivCd");}
		...
		public void setPyspReMrkSeilNum(String pyspReMrkSeilNum){set("pyspReMrkSeilNum",pyspReMrkSeilNum);}
		public String getPyspReMrkSeilNum() { return (String)get("pyspReMrkSeilNum");}
		
		
		public void setPyspNm(String pyspNm){set("pyspNm",pyspNm);}
		public String getPyspNm() { return (String)get("pyspNm");}
	
			public void setLogStdBgnDt(String logStdBgnDt){set("logStdBgnDt",logStdBgnDt);}
			public String getLogStdBgnDt() { return (String)get("logStdBgnDt");}
	
			public void setReMrkDt(String reMrkDt){set("reMrkDt",reMrkDt);}
			public String getReMrkDt() { return (String)get("reMrkDt");}
	
			public void setMityCarrTotLogSvcDys(String mityCarrTotLogSvcDys){set("mityCarrTotLogSvcDys",mityCarrTotLogSvcDys);}
			public String getMityCarrTotLogSvcDys() { return (String)get("mityCarrTotLogSvcDys");}
