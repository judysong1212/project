...
public class Psnl0290DTO extends BaseModel{
	...
	public void setHodyNumDysSysCalc(String hodyNumDysSysCalc) { set("hodyNumDysSysCalc",hodyNumDysSysCalc);}
	/** get 휴가일수_시스템계산 : hodyNumDysSysCalc */
	public String getHodyNumDysSysCalc() { return (String)get("hodyNumDysSysCalc");}
	
	/** set 휴가적용일수 : hodyApptnNumDys */
	public void setHodyApptnNumDys(String hodyApptnNumDys) { set("hodyApptnNumDys",hodyApptnNumDys);}
	/** get 휴가적용일수 : hodyApptnNumDys */
	public String getHodyApptnNumDys() { return (String)get("hodyApptnNumDys");}
	
	/** set 휴가사용일수 : hodyUseNumDys */
	public void setHodyUseNumDys(String hodyUseNumDys) { set("hodyUseNumDys",hodyUseNumDys);}
	/** get 휴가사용일수 : hodyUseNumDys */
	public String getHodyUseNumDys() { return (String)get("hodyUseNumDys");}
	
	/** set 휴가잔여일수 : hodyRstNumDys */
	public void setHodyRstNumDys(String hodyRstNumDys) { set("hodyRstNumDys",hodyRstNumDys);}
	/** get 휴가잔여일수 : hodyRstNumDys */
	public String getHodyRstNumDys() { return (String)get("hodyRstNumDys");}
	
	/** set 휴가시작일자 : hodyBgnnDt */
	public void setHodyBgnnDt(String hodyBgnnDt) { set("hodyBgnnDt",hodyBgnnDt);}
	/** get 휴가시작일자 : hodyBgnnDt */
	public String getHodyBgnnDt() { return (String)get("hodyBgnnDt");}
	
	/** set 휴가종료일자 : hodyEndDt */
	public void setHodyEndDt(String hodyEndDt) { set("hodyEndDt",hodyEndDt);}
	/** get 휴가종료일자 : hodyEndDt */
	public String getHodyEndDt() { return (String)get("hodyEndDt");}
	...
	public void setHodyFixYn(String hodyFixYn) { set("hodyFixYn",hodyFixYn);}
	/** get 휴가확정여부 : hodyFixYn */
	public String getHodyFixYn() { return (String)get("hodyFixYn");}
	...
	public void setLvsgCoptnCstApptnDt(String lvsgCoptnCstApptnDt) { set("lvsgCoptnCstApptnDt",lvsgCoptnCstApptnDt);}
	/** get 연가보상비적용일자 : lvsgCoptnCstApptnDt */
	public String getLvsgCoptnCstApptnDt() { return (String)get("lvsgCoptnCstApptnDt");}
