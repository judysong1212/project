 ...
 */
public class Psnl0320BMLeft    extends MSFSimpleBaseModel implements IsSerializable   {
	...
	/** set 사업장코드 : dpobCd */
	public static final String ATTR_DPOB_CD = "dpobCd";
	...
	public static final String ATTR_DTIL_OCCU_CLS_DIV_NM = "dtilOccuClsDivNm";

	/** set 사업명 : businNm */
	public static final String ATTR_BUSIN_NM = "businNm";
	...
	/** set 고용시작일자(입사일자) : emymtBgnnDt */
	public static final String ATTR_EMYMT_BGNN_DT = "emymtBgnnDt";

	/** set 고용종료일자 : emymtEndDt */
	public static final String ATTR_EMYMTENDDT = "emymtEndDt";

    /** set 재획정일자 : reMrkDt */
    public static final String ATTR_RE_MRK_DT = "reMrkDt";

    /** set 근속기준일 : logStdDt */
    public static final String ATTR_LOG_STD_DT = "logStdDt";

	/** set 호봉코드 : pyspCd */
	public static final String ATTR_PYSP_CD = "pyspCd";
	
	/** set 호봉 : pyspCd */
	public static final String ATTR_PYSP_NM = "pyspNm";

	/** set 근속년수코드 : logSvcYrNumCd */
	public static final String ATTR_LOG_SVC_YR_NUM_CD = "logSvcYrNumCd";
	
	/** set 근속년수 : logSvcYrNumCd */
	public static final String ATTR_LOG_SVC_YR_NUM_NM = "logSvcYrNumNm";

	/** set 근속월수코드 : logSvcMnthIcmCd */
	public static final String ATTR_LOG_SVC_MNTH_ICM_CD = "logSvcMnthIcmCd";
	
	
	/** set 근속월수코드 : logSvcMnthIcmCd */
	public static final String ATTR_LOG_SVC_MNTH_ICM_NM = "logSvcMnthIcmNm";

	/** set 입대일자 : enrlntDt */
	public static final String ATTR_ENRLNT_DT = "enrlntDt";

	/** set 제대일자 : dsageDt */
	public static final String ATTR_DSAGE_DT = "dsageDt";

	/** set 복무인정기간코드 : servcRcgtnPridCd */
	public static final String ATTR_SERVC_RCGTN_PRID_CD = "servcRcgtnPridCd";
	...
	/** 생성자 */
	 public Psnl0320BMLeft() { super(); } 

		/** 일괄등록 처리   */
	 public Psnl0320BMLeft(
			  String dpobCd 
			, String systemkey 
			, String hanNm 
			, String engNm 
	 	...
	 	values.put(ATTR_BUSIN_NM,businNm);
	 	...
	 	values.put(ATTR_ENRLNT_DT,enrlntDt);
	 	values.put(ATTR_DSAGE_DT,dsageDt);
	 	...
	 	values.put(ATTR_LOG_STD_DT, logStdDt);
	 	}
	...
	/** get 근속기준일 : logStdDt */
	public String  getLogStdDt() { return (String )get( ATTR_LOG_STD_DT );}
	/** get 근속기준일 : logStdDt */
	public void setLogStdDt(String  logStdDt) {set( ATTR_LOG_STD_DT ,logStdDt);}
	...
	/** set 입대일자 : enrlntDt */
	public void setEnrlntDt(String  enrlntDt) { set( ATTR_ENRLNT_DT ,enrlntDt);}
	/** get 입대일자 : enrlntDt */
	public String  getEnrlntDt() { return (String )get( ATTR_ENRLNT_DT );}


	/** set 제대일자 : dsageDt */
	public void setDsageDt(String  dsageDt) { set( ATTR_DSAGE_DT ,dsageDt);}
	/** get 제대일자 : dsageDt */
	public String  getDsageDt() { return (String )get( ATTR_DSAGE_DT );}
    ...
    /** set 사업명 : businNm */
	public void setBusinNm(String  businNm) { set( ATTR_BUSIN_NM ,businNm);}
    /** set 사업명 : businNm */
	public String  getBusinNm() { return (String )get( ATTR_BUSIN_NM );}
