...
=====================================================**/
public class Psnl0320DefRight20  extends TableDef implements PsnlDaoConstants {
...
//	private PsnlConstants psnlLabel = PsnlConstants.INSTANCE;
	...
	public Psnl0320DefRight20(){
		
		sysComBass0300Dto = new PrgmComBass0300DTO();
		
		setTitle("");
		setDaoClass(CLASS_PSNL0320_DATA_LIST_RIGHT20);
		setCustomListMethod(CLASS_PSNL0320_DATA_LIST_RIGHT20);
		setColumnsDefinition(getPsnl0110ToPsnl032001ColumnsList());
...
public void setitemChange(Field itemField,Object itemCd) {
	...
	private List<ColumnDef> getPsnl0110ToPsnl032001ColumnsList(){
