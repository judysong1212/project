 ...
 */
public class Psnl0320VO  implements Serializable {
	...
	private java.lang.String pyspReMrkCalcDt;

	private BigDecimal logSvcDys;
    ...
    private BigDecimal  pyspReMrkSeilNum;
    
    private String servcRcgtnPridCd;
    ...
    private String logStdBgnDt;
    private BigDecimal totLogSvcDys;
    private String orgLogSvcYrCd;
    private String orgLogSvcMnthCd;
    private BigDecimal orgLogSvcDys;
    private BigDecimal orgTotLogSvcDys;
    
   
    
    private String reMrkDt;
    //private String pmtnScduDt;
    //private String reymnScduDt;
    //private String pyspPrmtnScduDt;
    private BigDecimal emymtRcgtnLogSvcYrNum;
    private BigDecimal emymtRcgtnLogSvcMnthNum;
    private BigDecimal emymtRcgtnLogSvcDys;
    private BigDecimal mityCarrRcgtnLogSvcYrNum;
    private BigDecimal mityCarrRcgtnLogSvcMnth;
    private BigDecimal mityCarrRcgtnLogSvcDys;
    private BigDecimal carrRcgtnLogSvcYrNum;
    private BigDecimal carrRcgtnLogSvcMnthNum;
    private BigDecimal carrRcgtnLogSvcDys;
    private BigDecimal dsnyActCtwpMnthIcm;
	...
	private String pysp;
	private String logSvcYrNum;
	private String logSvcMnthIcm;
	private String logSvcDay;
	...
	public String getLogSvcYrNum() {
		return logSvcYrNum;
	}

	public void setLogSvcYrNum(String logSvcYrNum) {
		this.logSvcYrNum = logSvcYrNum;
	}

	public String getLogSvcMnthIcm() {
		return logSvcMnthIcm;
	}

	public void setLogSvcMnthIcm(String logSvcMnthIcm) {
		this.logSvcMnthIcm = logSvcMnthIcm;
	}

	public String getLogSvcDay() {
		return logSvcDay;
	}

	public void setLogSvcDay(String logSvcDay) {
		this.logSvcDay = logSvcDay;
	}

	public String getLogStdBgnDt() {
		return logStdBgnDt;
	}

	public void setLogStdBgnDt(String logStdBgnDt) {
		this.logStdBgnDt = logStdBgnDt;
	}

	public BigDecimal getTotLogSvcDys() {
		return totLogSvcDys;
	}

	public void setTotLogSvcDys(BigDecimal totLogSvcDys) {
		this.totLogSvcDys = totLogSvcDys;
	}

	public String getOrgLogSvcYrCd() {
		return orgLogSvcYrCd;
	}

	public void setOrgLogSvcYrCd(String orgLogSvcYrCd) {
		this.orgLogSvcYrCd = orgLogSvcYrCd;
	}

	public String getOrgLogSvcMnthCd() {
		return orgLogSvcMnthCd;
	}

	public void setOrgLogSvcMnthCd(String orgLogSvcMnthCd) {
		this.orgLogSvcMnthCd = orgLogSvcMnthCd;
	}

	public BigDecimal getOrgLogSvcDys() {
		return orgLogSvcDys;
	}

	public void setOrgLogSvcDys(BigDecimal orgLogSvcDys) {
		this.orgLogSvcDys = orgLogSvcDys;
	}

	public BigDecimal getOrgTotLogSvcDys() {
		return orgTotLogSvcDys;
	}

	public void setOrgTotLogSvcDys(BigDecimal orgTotLogSvcDys) {
		this.orgTotLogSvcDys = orgTotLogSvcDys;
	}

	public String getReMrkDt() {
		return reMrkDt;
	}

	public void setReMrkDt(String reMrkDt) {
		this.reMrkDt = reMrkDt;
	}

	public BigDecimal getEmymtRcgtnLogSvcYrNum() {
		return emymtRcgtnLogSvcYrNum;
	}

	public void setEmymtRcgtnLogSvcYrNum(BigDecimal emymtRcgtnLogSvcYrNum) {
		this.emymtRcgtnLogSvcYrNum = emymtRcgtnLogSvcYrNum;
	}

	public BigDecimal getEmymtRcgtnLogSvcMnthNum() {
		return emymtRcgtnLogSvcMnthNum;
	}

	public void setEmymtRcgtnLogSvcMnthNum(BigDecimal emymtRcgtnLogSvcMnthNum) {
		this.emymtRcgtnLogSvcMnthNum = emymtRcgtnLogSvcMnthNum;
	}

	public BigDecimal getEmymtRcgtnLogSvcDys() {
		return emymtRcgtnLogSvcDys;
	}

	public void setEmymtRcgtnLogSvcDys(BigDecimal emymtRcgtnLogSvcDys) {
		this.emymtRcgtnLogSvcDys = emymtRcgtnLogSvcDys;
	}

	public BigDecimal getMityCarrRcgtnLogSvcYrNum() {
		return mityCarrRcgtnLogSvcYrNum;
	}

	public void setMityCarrRcgtnLogSvcYrNum(BigDecimal mityCarrRcgtnLogSvcYrNum) {
		this.mityCarrRcgtnLogSvcYrNum = mityCarrRcgtnLogSvcYrNum;
	}

	public BigDecimal getMityCarrRcgtnLogSvcMnth() {
		return mityCarrRcgtnLogSvcMnth;
	}

	public void setMityCarrRcgtnLogSvcMnth(BigDecimal mityCarrRcgtnLogSvcMnth) {
		this.mityCarrRcgtnLogSvcMnth = mityCarrRcgtnLogSvcMnth;
	}

	public BigDecimal getMityCarrRcgtnLogSvcDys() {
		return mityCarrRcgtnLogSvcDys;
	}

	public void setMityCarrRcgtnLogSvcDys(BigDecimal mityCarrRcgtnLogSvcDys) {
		this.mityCarrRcgtnLogSvcDys = mityCarrRcgtnLogSvcDys;
	}

	public BigDecimal getCarrRcgtnLogSvcYrNum() {
		return carrRcgtnLogSvcYrNum;
	}

	public void setCarrRcgtnLogSvcYrNum(BigDecimal carrRcgtnLogSvcYrNum) {
		this.carrRcgtnLogSvcYrNum = carrRcgtnLogSvcYrNum;
	}

	public BigDecimal getCarrRcgtnLogSvcMnthNum() {
		return carrRcgtnLogSvcMnthNum;
	}

	public void setCarrRcgtnLogSvcMnthNum(BigDecimal carrRcgtnLogSvcMnthNum) {
		this.carrRcgtnLogSvcMnthNum = carrRcgtnLogSvcMnthNum;
	}

	public BigDecimal getCarrRcgtnLogSvcDys() {
		return carrRcgtnLogSvcDys;
	}

	public void setCarrRcgtnLogSvcDys(BigDecimal carrRcgtnLogSvcDys) {
		this.carrRcgtnLogSvcDys = carrRcgtnLogSvcDys;
	}

	public BigDecimal getDsnyActCtwpMnthIcm() {
		return dsnyActCtwpMnthIcm;
	}

	public void setDsnyActCtwpMnthIcm(BigDecimal dsnyActCtwpMnthIcm) {
		this.dsnyActCtwpMnthIcm = dsnyActCtwpMnthIcm;
	}
	...
	public String getServcRcgtnPridCd() {
		return servcRcgtnPridCd;
	}

	public void setServcRcgtnPridCd(String servcRcgtnPridCd) {
		this.servcRcgtnPridCd = servcRcgtnPridCd;
	}

	/**
	 * Comment : 
	 * @fn BigDecimal getPyspReMrkSeilNum()
	 * @brief date:2016 2016. 8. 12. user:Administrator
	 * @return the pyspReMrkSeilNum get
	 */
	public BigDecimal getPyspReMrkSeilNum() {
		return pyspReMrkSeilNum;
	}

	/**
	 * Comment : 
	 *@fn void setPyspReMrkSeilNum(BigDecimal pyspReMrkSeilNum)
	 *@brief date:2016 2016. 8. 12. user:Administrator
	 *@param pyspReMrkSeilNum the pyspReMrkSeilNum to set
	 */
	public void setPyspReMrkSeilNum(BigDecimal pyspReMrkSeilNum) {
		this.pyspReMrkSeilNum = pyspReMrkSeilNum;
	}
    ...
    public java.lang.String getPyspReMrkCalcDt() {
        return this.pyspReMrkCalcDt;
    }

    public void setPyspReMrkCalcDt(java.lang.String pyspReMrkCalcDt) {
        this.pyspReMrkCalcDt = pyspReMrkCalcDt;
    }

    

    public BigDecimal getLogSvcDys() {
		return logSvcDys;
	}

	public void setLogSvcDys(BigDecimal logSvcDys) {
	...
	/**
	 * Comment : 
	 * @fn java.lang.String getCvsnRtoDivCd()
	 * @brief date:2016 2016. 8. 8. user:Administrator
	 * @return the cvsnRtoDivCd get
	 */
	...
	/**
	 * Comment : 
	 *@fn void setCvsnRtoDivCd(java.lang.String cvsnRtoDivCd)
	 *@brief date:2016 2016. 8. 8. user:Administrator
	 *@param cvsnRtoDivCd the cvsnRtoDivCd to set
	 */
