...
public class PsnlP020002ExcelView extends AbstractExcelView {
    ...
    protected void buildExcelDocument(Map<String, Object> model,
    	...
    	XLSTransformer transformer = new XLSTransformer();
      	...
      	String xlsRelatvieFilepath =   realPath.concat("/".concat(globals.get("PayGen.XLSTemplateLink")).concat("/PSNL/UPXLS_PSNLP020001.xls"));
      
		String destFileName = "기간제신규고용업로드폼";
