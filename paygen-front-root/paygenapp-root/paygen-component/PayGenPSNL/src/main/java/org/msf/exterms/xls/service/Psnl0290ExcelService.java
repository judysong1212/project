...
public interface Psnl0290ExcelService {
...
//    
     ...
     * @throws Exception
     */
    List  selectXlsFilePsnl0126List(Psnl0126SrhVO Psnl0126SrhVo) throws Exception;
    
    /**
     * 휴가일수 산정 조회 리스트_export 
     * @param psnl0290SrhVo
     * @return
     * @throws Exception
     */
    List  selectXlsExportPsnl0126List(Psnl0126SrhVO Psnl0126SrhVo) throws Exception;
     ...
     * @throws Exception
     */
//    List  updateXlsFilePsnl0126List(List<Psnl0126VO> listpsnl0126) throws Exception;
     ...
     * @throws Exception
     */
    void updateXlsPsnl0126(InputStream file) throws Exception;
    
    void updateXlssPsnl0126(InputStream file) throws Exception;
    ...
    Long updateXlsPsnl0290(List<Psnl0126VO> psnl0126List, HttpServletRequest request) throws MSFException;
