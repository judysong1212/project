...
public class Psnl0600ExcelView10 extends AbstractExcelView {
...
//    }
    ...
    protected void buildExcelDocument(Map<String, Object> model,
    	...
    	XLSTransformer transformer = new XLSTransformer();
      	...
      	String xlsRelatvieFilepath =   realPath.concat("/".concat(globals.get("PayGen.XLSTemplateLink")).concat("/PSNL/XLS_PSNL0600010.xls"));
      
		String destFileName = "인사통합휴직정보";
