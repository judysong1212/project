...
public class Psnl0600ExcelView01 extends AbstractExcelView {
...
//    }
    ...
    protected void buildExcelDocument(Map<String, Object> model,
    	...
    	XLSTransformer transformer = new XLSTransformer();
      	...
      	String xlsRelatvieFilepath =   realPath.concat("/".concat(globals.get("PayGen.XLSTemplateLink")).concat("/PSNL/XLS_PSNL060001.xls"));
      
		String destFileName = "인사통합기본정보";
