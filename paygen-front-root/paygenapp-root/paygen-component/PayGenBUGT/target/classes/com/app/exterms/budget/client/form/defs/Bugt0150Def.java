...
import com.app.exterms.budget.client.dto.Bugt0150BM;
...
public class Bugt0150Def extends TableDef implements BugtDaoConstants {
    private int row = 0;
    ...
    public Bugt0150Def(){
    	  ...
    	  setTitle(lblBugtConst.title_Bugt0150());
          setDaoClass(CLASS_BUGT0150_LIST); 
          setCustomListMethod(CLASS_BUGT0150_LIST);
    ...
    private List<ColumnDef> getAllColumnsList(){
        ...
        /** column 사업장코드 : dpobCd */
        listColumnDefs.add(new ColumnDef("사업장코드", Bugt0150BM.ATTR_DPOBCD, ColumnDef.TYPE_STRING, 90, true, false, true));

        /** column 회계년도 : accYr */
        listColumnDefs.add(new ColumnDef("회계년도", Bugt0150BM.ATTR_ACCYR, ColumnDef.TYPE_STRING, 90, true, false, true));

        /** column 부서결산일련번호 : deptSttmtAccSeilNum */
        listColumnDefs.add(new ColumnDef("부서결산일련번호", Bugt0150BM.ATTR_DEPTSTTMTACCSEILNUM, ColumnDef.TYPE_STRING, 90, true, false, true));

        /** column 회계단위코드 : accUntCd */
        listColumnDefs.add(new ColumnDef("회계단위코드", Bugt0150BM.ATTR_ACCUNTCD, ColumnDef.TYPE_STRING, 90, true, false, true));

        /** column 회계단위_세목코드 : accUntTxItemCd */
        listColumnDefs.add(new ColumnDef("회계단위_세목코드", Bugt0150BM.ATTR_ACCUNTTXITEMCD, ColumnDef.TYPE_STRING, 90, true, false, true));

        /** column 부서코드 : deptCd */
        listColumnDefs.add(new ColumnDef("부서코드", Bugt0150BM.ATTR_DEPTCD, ColumnDef.TYPE_STRING, 90, true, false, true));

        /** column 적요내용 : smpCtnt */
        listColumnDefs.add(new ColumnDef("적요내용", Bugt0150BM.ATTR_SMPCTNT, ColumnDef.TYPE_STRING, 90, true, false, true));

        /** column 산출근거내용 : calcBssCtnt */
        listColumnDefs.add(new ColumnDef("산출근거내용", Bugt0150BM.ATTR_CALCBSSCTNT, ColumnDef.TYPE_STRING, 90, true, false, true));

        /** column 부서지출금액 : deptExpnsSum */
        listColumnDefs.add(new ColumnDef("부서지출금액", Bugt0150BM.ATTR_DEPTEXPNSSUM, ColumnDef.TYPE_STRING, 90, true, false, true));
