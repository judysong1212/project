...
import com.app.exterms.budget.client.dto.Bugt0050BM;
...
public class Bugt0050Def extends TableDef implements BugtDaoConstants {
    private int row = 0;
    ...
    public Bugt0050Def(){
    	  ...
    	  setTitle(lblBugtConst.title_Bugt0050());
          setDaoClass(CLASS_BUGT0050_LIST); 
          setCustomListMethod(CLASS_BUGT0050_LIST);
    ...
    private List<ColumnDef> getAllColumnsList(){
        ...
        /** column 사업장코드 : dpobCd */
        listColumnDefs.add(new ColumnDef("사업장코드", Bugt0050BM.ATTR_DPOBCD, ColumnDef.TYPE_STRING, 90, true, false, true));

        /** column 회계단위코드 : accUntCd */
        listColumnDefs.add(new ColumnDef("회계단위코드", Bugt0050BM.ATTR_ACCUNTCD, ColumnDef.TYPE_STRING, 90, true, false, true));

        /** column 회계년도 : accYr */
        listColumnDefs.add(new ColumnDef("회계년도", Bugt0050BM.ATTR_ACCYR, ColumnDef.TYPE_STRING, 90, true, false, true));

        /** column 회계단위_세목코드 : accUntTxItemCd */
        listColumnDefs.add(new ColumnDef("회계단위_세목코드", Bugt0050BM.ATTR_ACCUNTTXITEMCD, ColumnDef.TYPE_STRING, 90, true, false, true));

        /** column 회계단위_세목명 : accUntTxItemNm */
        listColumnDefs.add(new ColumnDef("회계단위_세목명", Bugt0050BM.ATTR_ACCUNTTXITEMNM, ColumnDef.TYPE_STRING, 90, true, false, true));

        /** column 회계단위_세목예산금액 : accUntTxItemBugtSum */
        listColumnDefs.add(new ColumnDef("회계단위_세목예산금액", Bugt0050BM.ATTR_ACCUNTTXITEMBUGTSUM, ColumnDef.TYPE_STRING, 90, true, false, true));
