...
import com.app.exterms.budget.client.dto.Bugt0250BM;
...
public class Bugt0250Def extends TableDef implements BugtDaoConstants {
    private int row = 0;
    ...
    public Bugt0250Def(){
    	  ...
    	  setTitle(lblBugtConst.title_Bugt0250());
          setDaoClass(CLASS_BUGT0250_LIST); 
          setCustomListMethod(CLASS_BUGT0250_LIST);
    ...
    private List<ColumnDef> getAllColumnsList(){
        ...
        /** column 사업장코드 : dpobCd */
        listColumnDefs.add(new ColumnDef("사업장코드", Bugt0250BM.ATTR_DPOBCD, ColumnDef.TYPE_STRING, 90, true, false, true));

        /** column 회계년도 : accYr */
        listColumnDefs.add(new ColumnDef("회계년도", Bugt0250BM.ATTR_ACCYR, ColumnDef.TYPE_STRING, 90, true, false, true));

        /** column 부서_사업결산일련번호 : deptBusinSttmtAccSeilNum */
        listColumnDefs.add(new ColumnDef("부서_사업결산일련번호", Bugt0250BM.ATTR_DEPTBUSINSTTMTACCSEILNUM, ColumnDef.TYPE_STRING, 90, true, false, true));

        /** column 부서코드 : deptCd */
        listColumnDefs.add(new ColumnDef("부서코드", Bugt0250BM.ATTR_DEPTCD, ColumnDef.TYPE_STRING, 90, true, false, true));

        /** column 사업코드 : businCd */
        listColumnDefs.add(new ColumnDef("사업코드", Bugt0250BM.ATTR_BUSINCD, ColumnDef.TYPE_STRING, 90, true, false, true));

        /** column 회계단위코드 : accUntCd */
        listColumnDefs.add(new ColumnDef("회계단위코드", Bugt0250BM.ATTR_ACCUNTCD, ColumnDef.TYPE_STRING, 90, true, false, true));

        /** column 회계단위_세목코드 : accUntTxItemCd */
        listColumnDefs.add(new ColumnDef("회계단위_세목코드", Bugt0250BM.ATTR_ACCUNTTXITEMCD, ColumnDef.TYPE_STRING, 90, true, false, true));

        /** column 적요내용 : smpCtnt */
        listColumnDefs.add(new ColumnDef("적요내용", Bugt0250BM.ATTR_SMPCTNT, ColumnDef.TYPE_STRING, 90, true, false, true));

        /** column 산출근거내용 : calcBssCtnt */
        listColumnDefs.add(new ColumnDef("산출근거내용", Bugt0250BM.ATTR_CALCBSSCTNT, ColumnDef.TYPE_STRING, 90, true, false, true));

        /** column 부서_사업지출금액 : deptBusinExpnsSum */
        listColumnDefs.add(new ColumnDef("부서_사업지출금액", Bugt0250BM.ATTR_DEPTBUSINEXPNSSUM, ColumnDef.TYPE_STRING, 90, true, false, true));
