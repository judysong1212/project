...
public class Bugt0200Def extends TableDef implements BugtDaoConstants {
    private int row = 0;
    ...
    public Bugt0200Def(){
    	  ...
    	  setTitle(lblBugtConst.title_Bugt0200());
          setDaoClass(CLASS_BUGT0200_LIST); 
          setCustomListMethod(CLASS_BUGT0200_LIST);
