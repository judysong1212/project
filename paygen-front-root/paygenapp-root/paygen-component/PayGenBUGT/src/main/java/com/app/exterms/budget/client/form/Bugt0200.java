...
=====================================================**/
public class Bugt0200  extends MSFPanel  { 
	 ...
	 /**######################################################
	  ...
	  private FormPanel plFrmBugt0200;
...
//	    vp.setSpacing(10);
//	    createBugt0200Form();  //화면 기본정보를 설정
...
//		    };   
	  ...
	  public Bugt0200(String txtForm) {
			this.txtForm = txtForm;
	  }
	  
	  private void createBugt0200Form() {
		  
		plFrmBugt0200 = new FormPanel();
		plFrmBugt0200.setHeadingText(PayGenConst.PAYGEN_VERSION.concat(" - 부서-사업예산관리"));
		plFrmBugt0200.setIcon(Resources.APP_ICONS.text());
		plFrmBugt0200.setBodyStyleName("pad-text");
		plFrmBugt0200.setFrame(true); 
		...
		btnlogView.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				 //로그 뷰화면 호출 메서드 
				  funcLogMessage("부서-사업예산관리","BUGT0200");
				}
			});
		plFrmBugt0200.getHeader().setStyleAttribute("padding", "5px 0 2px 0");
		plFrmBugt0200.getHeader().addTool(btnlogView); 
		/************************************************************************
...
//	      }));    
	  	...
	  	plFrmBugt0200.add(buttonBar);    
	  	
		//파일업로드 처리
		plFrmBugt0200.setAction("bizform");
		plFrmBugt0200.setEncoding(Encoding.MULTIPART);
		plFrmBugt0200.setMethod(Method.POST);
		
		 
	
		vp.add(plFrmBugt0200);
		plFrmBugt0200.setSize("990px", "680px");
	  }
	  ...
	  private void createSearchForm() {   
		  ...
		  plFrmBugt0200.setLayout(new FlowLayout());
...
//		    fieldSet.add(email, formData); 
		    ...
		    comboBox_2.setFieldLabel("사업명");
		    lcSchCol.add(layoutContainer_2,new com.extjs.gxt.ui.client.widget.layout.ColumnData(.35));
		      
			
		    plFrmBugt0200.add(fieldSet); 
		//vp.add(panel);   
	  }  
	  private void createStandardForm() {
			...
			fldstNewFieldset.setHeadingHtml("부서-사업정보");
			...
			fldstNewFieldset_1.setHeadingHtml("부서-사업예산등록");
			...
			plFrmBugt0200.add(layoutContainer);
			layoutContainer.setBorders(false); 

			LayoutContainer layoutContainer11 = new LayoutContainer();
			plFrmBugt0200.add(layoutContainer11);
			...
			fldstNewFieldset_2.setHeadingHtml("부서-사업예산집행내역");
	     ...
	     private LayoutContainer occupationalRTop() {
			   ...
			   frmlytStd.setLabelAlign(LabelAlign.RIGHT);
				...
				frmlytStd.setLabelAlign(LabelAlign.RIGHT);
		  	   ...
		  	   layoutContainer_5.add(layoutContainer_6, new com.extjs.gxt.ui.client.widget.layout.ColumnData(.3));
			   ...
			   frmlytStd.setLabelAlign(LabelAlign.RIGHT);
		  	   ...
		  	   layoutContainer_5.add(layoutContainer_7, new com.extjs.gxt.ui.client.widget.layout.ColumnData(.1));
		  	 ...
		  	 layoutContainer_51.setLayout(new ColumnLayout());
				...
				layoutContainer_61.setLayout(frmlytStd);
		  	   ...
		  	   TextField textField_21 = new TextField();
		  	 layoutContainer_61.add(textField_21, new FormData("100%"));
		  	textField_21.setFieldLabel("사업명");
		  	 layoutContainer_51.add(layoutContainer_61, new com.extjs.gxt.ui.client.widget.layout.ColumnData(.3));
		  	layoutContainer_61.setBorders(false);
			   ...
			   layoutContainer_71.setLayout(frmlytStd);
		  	   ...
		  	   Button button1 = new Button("검색");
		  	 layoutContainer_71.add(button1, new FormData("100%"));
		  	 layoutContainer_51.add(layoutContainer_71, new com.extjs.gxt.ui.client.widget.layout.ColumnData(.1));
		  	layoutContainer_71.setBorders(false);
			   ...
			   frmlytStd.setLabelWidth(0); 
			   frmlytStd.setLabelAlign(LabelAlign.RIGHT);
			   layoutContainer_81.setLayout(frmlytStd);
		  	   
		  	   TextField textField_31 = new TextField();
		  	 layoutContainer_81.add(textField_31, new FormData("100%"));
		  	textField_31.setFieldLabel("");
		  	textField_31.setLabelSeparator("");
		  	 ...
		  	 lytCtr01.add(layoutContainer_51);
...
//		 	    }));   
		...
		//호봉등급별 근속년수 결과 
		 private LayoutContainer occupationalRBottom() {
	  	  ...
	  	  // 
	  	    column = new ColumnConfig("change", "사업명", 150);   
	  	    column.setAlignment(HorizontalAlignment.CENTER);    
	  	    column.setRenderer(change);   
	  	    configs.add(column);   
