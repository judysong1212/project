...
import com.app.exterms.insurance.client.service.InsrP510001ServiceAsync;
...
=====================================================**/
public  class InsrP510001    extends MSFFormPanel {  
 ...
 *++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ 
 **/ 
  private  ContentPanel cpInsr5101;  
  //건강보험
  private Insr5100Def pInsr5100Def  = new Insr5100Def("INSRP510001");   //그리드 테이블 컬럼 define  
  // private MSFCustomForm msfCustomForm; 
  private MSFGridPanel pInsr5100GridPanel;
...
//  private MSFGridPanel typOccuCdGridPanel;
   ...
   * ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
   */
  private ButtonBar topInsrP510001Bar;
  private Button btnInsrP510001Init;
  private Button btnInsrP510001Save;
  private Button btnInsrP510001Del;
  private Button btnInsrP510001Sreach;
  private Button btnInsrP510001Print;
  private Button btnInsrP510001Excel;
 ...
 **/	  
  ...
  // private AuthAction authAction;  
	...
	//  private static MessageBox authBox = MessageBox.wait("화면로딩", "설정 초기화 작업 진행 중입니다....", "설정 작업 진행 중..."); 
	   ...
	   * AuthAction 
	   */
	  private void checkInsrP510001Auth( String authAction, ListStore<BaseModel> bm) {   
        ...
        * 값순서 : 단위기관 ,고용구분, 부서, 직종, 직종세 ,사업 순으로  없으면 ""
        ...
        // GWTAuthorization.formAuthPopConfig(cpInsr5101, "srhPayrMangDeptCd","srhEmymtDivCd",strArrDeptCd,"srhTypOccuCd","srhDtilOccuInttnCd","srhBusinCd");
...
//	   * AuthAction 
//	   */
//	  private void checkInsrP510001Auth( AuthAction authAction, ListStore<BaseModel> bm, int authChk) {   
//    	   //MSFMainApp.maskMainPage("[화면로딩] 초기화 진행 중"); 
//		 
 ...
 **/
   // 검색 폼 바인딩 처리 함수 
	   ...
	   //화면 폼 바인딩 처리 
	    private void setPayr510001FormBinding() {
 ...
 **/ 
	    ...
	    private InsrP510001ServiceAsync insrP510001Service = InsrP510001Service.Util.getInstance();
	 ...
	 **/
		 ...
		 *++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ 
		 **/
			private void InsrP510001Print(String fileName) {
...
//				}
	 ...
	 **/ 		    
	  ...
	  public InsrP510001(final ActionDatabase actionDatabase, final MSFPanel caller) {
		  ...
		  //콤보 권한초기화
	       ...
	       // this.setBodyBorder(false);
	        ...
	        cpInsr5101 = new ContentPanel();
		    createInsrP510001Form();  //화면 기본정보를 설정
		    createBtnTop();
		   ...
		   cpInsr5101.setBodyBorder(false);
		   cpInsr5101.setBorders(false);
		   cpInsr5101.setHeaderVisible(false);
		  //cpInsr5101.setSize("810px", "710px");  
	   ...
	   *~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ 		
	   **/	  
	  private  void createInsrP510001Form() { 
		   
		  //멀티콤보박스 닫기 
		  cpInsr5101.addListener(Events.OnClick,new Listener<ComponentEvent>() { 
           @Override
...
//                       }
		  ...
		  cpInsr5101.setSize("976px", "640px");
	  }
...
//		     		cpInsr5101.add(typOccuCdGrid);
		    ...
		    cpInsr5101.setLayout(new FlowLayout());
		 ...
		 //   lcSchLeft.setStyleAttribute("paddingRight", "10px");
		   ...
		   // srhPayYr.setEmptyText("--년도선택--");
		    ...
		    srhPayYr.getStore().addStoreListener( new StoreListener<BaseModel>() {   
                public void handleEvent(StoreEvent<BaseModel> be) {   
                	checkInsrP510001Auth("srhPayYr",lsPayYrStore);  
		   ...
		   // srhPayMonth.setEmptyText("--월선택--");
		    ...
		    srhPayMonth.getStore().addStoreListener( new StoreListener<BaseModel>() {   
                public void handleEvent(StoreEvent<BaseModel> be) {  
                	checkInsrP510001Auth("srhPayMonth",lsPayMonth);  
			    	   ...
			    	   if (type == Store.Add) { 
	                		 /**++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
			                     ...
			                     * "srhPayrMangDeptCd","srhEmymtDivCd","srhDeptCd","srhTypOccuCd","srhBusinCd"
			                     ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++*/ 
			                	checkInsrP510001Auth("srhPayrMangDeptCd", lsPayrMangDeptCd); 
	                	 }   
	            	 ...
	            	 EventType type = be.getType();
			    	   if (type == Store.Add) { 
	                		 /**++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
			                     ...
			                     * "srhPayrMangDeptCd","srhEmymtDivCd","srhDeptCd","srhTypOccuCd","srhBusinCd"
			                     ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++*/ 
			                	checkInsrP510001Auth("srhEmymtDivCd", lsEmymtDivCd); 
	                	 }
	            }
	        });    
	     ...
	     //   srhHdofcCodtnCd.setHeight(100);
	        ...
	        srhHdofcCodtnCd.getStore().addStoreListener( new StoreListener<ModelData>() {   
	            public void handleEvent(StoreEvent<ModelData> be) {  
	            	...
	            	checkInsrP510001Auth("srhHdofcCodtnCd",lsHdofcCodtnCd); 
	            }
	        }); 
	            	 ...
	            	 EventType type = be.getType();
			    	   if (type == Store.Add) { 
	                		 /**++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
			                     ...
			                     * "srhPayrMangDeptCd","srhEmymtDivCd","srhDeptCd","srhTypOccuCd","srhBusinCd"
			                     ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++*/ 
			                	checkInsrP510001Auth("srhDeptCd", lsDeptCd); 
	                	 }
	            	 ...
	            	 EventType type = be.getType();
		               ...
		               // srhEmymtDivCd.setValue(lsEmymtDivCd.getAt(0)); 
	                		 /**++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
			                     ...
			                     * "srhPayrMangDeptCd","srhEmymtDivCd","srhDeptCd","srhTypOccuCd","srhBusinCd"
			                     ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++*/ 
			                	//checkInsrP510001Auth("srhTypOccuCd", lsTypOccuCd); 
			    		   }
			    		   }
	            }
	        });     
...
//          }   
	  ...
	  private  void createStandardForm() {
		...
		//	fldstNewFieldset_2.setSize(528, 120);
			...
			cpInsr5101.add(layoutContainer);
			layoutContainer.setBorders(false); 
...
//		    
//		    
//		    column = new ColumnConfig("change", "고용보험료", 100);   
//		    column.setAlignment(HorizontalAlignment.CENTER);    
		...
		//    lcStdGrid.setStyleAttribute("paddingRight", "10px");
		  ...
		  //  frmlytStd.setLabelWidth(85); 
		   // frmlytStd.setLabelAlign(LabelAlign.RIGHT);   
		    ...
		    pInsr5100GridPanel = new MSFGridPanel(pInsr5100Def, false, false, false, false, false);
		    pInsr5100GridPanel.setHeaderVisible(false);  
		    pInsr5100GridPanel.setBodyBorder(true);
		    pInsr5100GridPanel.setBorders(true);
			// pInsr5100GridPanel.setSize(308, 466); 
		    // msfGridPanel.setMSFFormPanel(msfCustomForm);  //폼을 그리드에 넣은다.


		    //2줄파싱 
//		    pInsr5100GridPanel.getGrid().getColumnModel().addHeaderGroup(0, 5, new HeaderGroupConfig("건강보험", 1, 7));
//		    pInsr5100GridPanel.getGrid().getColumnModel().addHeaderGroup(0, 12, new HeaderGroupConfig("장기요양보험", 1, 7));   
		    
		 

		   // GWTUtils.findColumnConfig(insr3000GridPanel, Insr5100BM.ATTR_SOCINSRDDUCETHDCD).setStyle("background-color:#F5F6CE;"); TODO 콤보박스일경우에러남. 확인후처리 
		   // GWTUtils.findColumnConfig(pInsr5100GridPanel, Insr5100BM.ATTR_HLTHINSRMNTHRUNTNAMNT).setStyle("background-color:#F5F6CE;"); 
		  //  GWTUtils.findColumnConfig(pInsr5100GridPanel, Insr5100BM.ATTR_HLTHINSRCERTNUM).setStyle("background-color:#F5F6CE;");
		   // GWTUtils.findColumnConfig(pInsr5100GridPanel, Insr5100BM.ATTR_HLTHINSRAQTNDT).setStyle("background-color:#F5F6CE;");  
		      
			
		    	 
//		    AggregationRowConfig<BaseModel> insr3000SummaryRow = new AggregationRowConfig<BaseModel>();  
//			 
//		    insr3000SummaryRow.setCellStyle(Insr5100BM.ATTR_PYMTYRMNTH,"summary_color");
//		    insr3000SummaryRow.setCellStyle(Insr5100BM.ATTR_HLTHINSRMNTHRUNTNAMNT,"summary_color");  /** column 건강보험보수월액 : hlthInsrMnthRuntnAmnt */
//		    insr3000SummaryRow.setCellStyle(Insr5100BM.ATTR_PYMTDDUCD0010200,"summary_color"); 
//		    insr3000SummaryRow.setCellStyle(Insr5100BM.ATTR_PYMTDDUCD0010400,"summary_color");  
//		    
//		    insr3000SummaryRow.setHtml(Insr5100BM.ATTR_PYMTYRMNTH, "합 계");   
//		    
//		    /** column 건강보험보수월액 : hlthInsrMnthRuntnAmnt */
//		    insr3000SummaryRow.setSummaryType(Insr5100BM.ATTR_HLTHINSRMNTHRUNTNAMNT, SummaryType.SUM);   
//		    insr3000SummaryRow.setSummaryFormat(Insr5100BM.ATTR_HLTHINSRMNTHRUNTNAMNT, NumberFormat.getFormat("#,##0;(#,##0)"));  
//		    
//		    /**
//		     * 건강보험
//		     */
//		    /** set 납부보험료 : ATTR_PYMTDDUCD0010100 */
//		    insr3000SummaryRow.setSummaryType(Insr5100BM.ATTR_PYMTDDUCD0010100, SummaryType.SUM);   
//		    insr3000SummaryRow.setSummaryFormat(Insr5100BM.ATTR_PYMTDDUCD0010100, NumberFormat.getFormat("#,##0;(#,##0)"));  
//		    
//		    /** set 정산보험료 : ATTR_PYMTDDUCD0010200 */		    
//		    insr3000SummaryRow.setSummaryType(Insr5100BM.ATTR_PYMTDDUCD0010200, SummaryType.SUM);   
//		    insr3000SummaryRow.setSummaryFormat(Insr5100BM.ATTR_PYMTDDUCD0010200, NumberFormat.getFormat("#,##0;(#,##0)"));  
//		    
//		    /** set 소급보험료 : pymtDducD0100300 */
//		    insr3000SummaryRow.setSummaryType(Insr5100BM.ATTR_PYMTDDUCD0010300, SummaryType.SUM);   
//		    insr3000SummaryRow.setSummaryFormat(Insr5100BM.ATTR_PYMTDDUCD0010300, NumberFormat.getFormat("#,##0;(#,##0)"));  
//		    /** set 휴직자분할보험료 : pymtDducD0010400 */
//		    insr3000SummaryRow.setSummaryType(Insr5100BM.ATTR_PYMTDDUCD0010400, SummaryType.SUM);   
//		    insr3000SummaryRow.setSummaryFormat(Insr5100BM.ATTR_PYMTDDUCD0010400, NumberFormat.getFormat("#,##0;(#,##0)"));  
//		    /** set 건강보험환급금이자 : pymtDducD0010500 */
//		    insr3000SummaryRow.setSummaryType(Insr5100BM.ATTR_PYMTDDUCD0010500, SummaryType.SUM);   
//		    insr3000SummaryRow.setSummaryFormat(Insr5100BM.ATTR_PYMTDDUCD0010500, NumberFormat.getFormat("#,##0;(#,##0)"));  
//		    
//		    /**
//		     * 장기요양보험
//		     */
//		    
//		    insr3000SummaryRow.setCellStyle(Insr5100BM.ATTR_PYMTDDUCD0110100,"summary_color");
//		    insr3000SummaryRow.setCellStyle(Insr5100BM.ATTR_PYMTDDUCD0110300,"summary_color");  
//		    insr3000SummaryRow.setCellStyle(Insr5100BM.ATTR_PYMTDDUCD0110500,"summary_color");  
//		    
//		    /** set 납부보험료 : PYMT_DDUC_D0110100 */
//		    insr3000SummaryRow.setSummaryType(Insr5100BM.ATTR_PYMTDDUCD0110100, SummaryType.SUM);   
//		    insr3000SummaryRow.setSummaryFormat(Insr5100BM.ATTR_PYMTDDUCD0110100, NumberFormat.getFormat("#,##0;(#,##0)"));  
//		    /** set 정산보험료 : PYMT_DDUC_D0110200 */
//		    insr3000SummaryRow.setSummaryType(Insr5100BM.ATTR_PYMTDDUCD0110200, SummaryType.SUM);   
//		    insr3000SummaryRow.setSummaryFormat(Insr5100BM.ATTR_PYMTDDUCD0110200, NumberFormat.getFormat("#,##0;(#,##0)"));  
//		    /** set 소급보험료 : pymtDducD0110300 */
//		    insr3000SummaryRow.setSummaryType(Insr5100BM.ATTR_PYMTDDUCD0110300, SummaryType.SUM);   
//		    insr3000SummaryRow.setSummaryFormat(Insr5100BM.ATTR_PYMTDDUCD0110300, NumberFormat.getFormat("#,##0;(#,##0)"));  
//		    /** set 휴직자분할보험료 : pymtDducD0110400 */
//		    insr3000SummaryRow.setSummaryType(Insr5100BM.ATTR_PYMTDDUCD0110400, SummaryType.SUM);   
//		    insr3000SummaryRow.setSummaryFormat(Insr5100BM.ATTR_PYMTDDUCD0110400, NumberFormat.getFormat("#,##0;(#,##0)"));  
//		    /** set 건강보험환급금이자 : pymtDducD0110500 */
//		    insr3000SummaryRow.setSummaryType(Insr5100BM.ATTR_PYMTDDUCD0110500, SummaryType.SUM);   
//		    insr3000SummaryRow.setSummaryFormat(Insr5100BM.ATTR_PYMTDDUCD0110500, NumberFormat.getFormat("#,##0;(#,##0)"));  
//		    
//		    
//		    
//		    pInsr5100GridPanel.getGrid().getColumnModel().addAggregationRow(insr3000SummaryRow);     
		    
		    cpGrid.add(pInsr5100GridPanel); 
		    ...
		    return lcStdGrid;
			 ...
			 private void createBtnTop() {
				 ...
				 topInsrP510001Bar = new ButtonBar();    
					topInsrP510001Bar.setAlignment(HorizontalAlignment.RIGHT);
		   
				  
//					btnInsrP510001Init = new Button("초기화");  
//				    btnInsrP510001Init.setIcon(Resources.APP_ICONS.new16());
//				    topInsrP510001Bar.add(btnInsrP510001Init);
//				    btnInsrP510001Init.addListener(Events.Select, new Listener<ButtonEvent>() {
//			    		public void handleEvent(ButtonEvent e) {
//			    			 //초기화 
//			    			formInit();
//			    		}
...
//				     
//				  	 
//				    btnInsrP510001Save = new Button("저장");  
//				    btnInsrP510001Save.setIcon(Resources.APP_ICONS.save16());
//			        topInsrP510001Bar.add(btnInsrP510001Save); 
//			   
//			        btnInsrP510001Del = new Button("삭제");  
//			        btnInsrP510001Del.setIcon(Resources.APP_ICONS.delete16());
//			  	    topInsrP510001Bar.add(btnInsrP510001Del);
			  	 
			  	    btnInsrP510001Sreach = new Button("조회"); 
			  	    btnInsrP510001Sreach.setIcon(Resources.APP_ICONS.search16());
			  	    topInsrP510001Bar.add(btnInsrP510001Sreach);
			  	    btnInsrP510001Sreach.addListener(Events.Select, new Listener<ButtonEvent>() {
			    		public void handleEvent(ButtonEvent e) {
			    			//조회버튼 클릭시 처리 
			    		    reload();  
			    		}
					...
					//   layoutContainer.setStyleAttribute("padding", "1px" );
					   ...
					   layoutContainer.setBorders(true);
					    ...
					    rdRadio.setValueAttribute("INSRT51000101"); 
					    
					    rdRadio = new Radio();
					    outputTypeRadiogroup.add(rdRadio);
					    rdRadio.setBoxLabel("개인별");
					    rdRadio.setHideLabel(true);
					    rdRadio.setValueAttribute("INSRT51000102"); 
					     
					    layoutContainer.add(outputTypeRadiogroup);  
					    topInsrP510001Bar.add(layoutContainer);  
				  	 
			  	  btnInsrP510001Print = new Button("인쇄"); 
			  	 btnInsrP510001Print.setIcon(Resources.APP_ICONS.print16()); 
			  	 topInsrP510001Bar.add(btnInsrP510001Print);  
			  	  btnInsrP510001Print.addListener(Events.Select, new Listener<ButtonEvent>() {
			    		public void handleEvent(ButtonEvent e) {
			    			//인쇄 
			    			String printType = getCheckedRadioValue(outputTypeRadiogroup); 
			    			
			    			if ("INSRT51000102".equals(printType)) {
			    				if(MSFSharedUtils.paramNull(srhDeptCd.getValue())){
			    					 MessageBox.alert("확인", "개인별검색을 하시려면 부서를 선택하셔야합니다.", null);
					    			    return;
			    				}else{
			    					InsrP510001Print("INSRT51000102", MSFMainApp.getMsg("PayGen.ReportDivisionType"));
			    				}
			    			}
			    			if ("INSRT51000101".equals(printType)) {
			    				InsrP510001Print("INSRT51000101", MSFMainApp.getMsg("PayGen.ReportDivisionType"));
			    			}
			    		}
			    	});
			  	
			  	    btnInsrP510001Excel = new Button("엑셀"); 
			  	    btnInsrP510001Excel.setIcon(Resources.APP_ICONS.excel16()); 
			  	    topInsrP510001Bar.add(btnInsrP510001Excel);  
			    	  btnInsrP510001Excel.addListener(Events.Select, new Listener<ButtonEvent>() {
			    		public void handleEvent(ButtonEvent e) {			    			
			    			//엑셀저장 
			    			String printType = getCheckedRadioValue(outputTypeRadiogroup); 
			    			...
			    			if ("INSRT51000102".equals(printType)) {
			    				if(MSFSharedUtils.paramNull(srhDeptCd.getValue())){
					    		   ...
					    		   return;
			    					...
			    					xlsExportData("InsrP51000102") ;
			    				}
			    			}
			    			if ("INSRT51000101".equals(printType)) {
			    				xlsExportData("InsrP51000101") ;
			    			}
			    		}
			    	});
			  	
			  	cpInsr5101.add(topInsrP510001Bar);     
			 }  
			...
			public void reload() {
				...
				IColumnFilter filters = null;
				  pInsr5100GridPanel.getTableDef().setTableColumnFilters(filters);
					
					pInsr5100GridPanel.getTableDef().addColumnFilter("pymtYrMnth", (MSFSharedUtils.getSelectedComboValue(srhPayYr,"year")+ MSFSharedUtils.getSelectedComboValue(srhPayMonth,"month")), SimpleColumnFilter.OPERATOR_EQUALS); 
					pInsr5100GridPanel.getTableDef().addColumnFilter("payrMangDeptCd", MSFSharedUtils.getSelectedComboValue(srhPayrMangDeptCd,"payrMangDeptCd"), SimpleColumnFilter.OPERATOR_EQUALS);
					pInsr5100GridPanel.getTableDef().addColumnFilter("emymtDivCd", MSFSharedUtils.getSelectedComboValue(srhEmymtDivCd,"commCd"), SimpleColumnFilter.OPERATOR_EQUALS); 
					pInsr5100GridPanel.getTableDef().addColumnFilter("payCd", MSFSharedUtils.getSelectedComboValue(srhPayCd,"commCd"), SimpleColumnFilter.OPERATOR_EQUALS); 
					 
		 
		            String strDeptCd = InsrUtils.getStrValToBMMultiCombo(lsDeptCd,srhDeptCd.getValue(),"deptNmRtchnt","deptCd");  
		            pInsr5100GridPanel.getTableDef().addColumnFilter("deptCd", strDeptCd , SimpleColumnFilter.OPERATOR_EQUALS);
		           
		            String strTypOccuCd = InsrUtils.getStrValToBMMultiCombo(lsTypOccuCd,srhTypOccuCd.getValue(),"typOccuNm","typOccuCd"); 
		            pInsr5100GridPanel.getTableDef().addColumnFilter("typOccuCd", strTypOccuCd, SimpleColumnFilter.OPERATOR_EQUALS); 
		         //   String strPyspGrdeCd = InsrUtils.getStrValToBMMultiCombo(lsTypOccuCd,srhTypOccuCd.getValue(),"typOccuNm","pyspGrdeCd");  
		         //   pInsr5100GridPanel.getTableDef().addColumnFilter("pyspGrdeCd", strPyspGrdeCd, SimpleColumnFilter.OPERATOR_EQUALS);  
		            ...
		            pInsr5100GridPanel.getTableDef().addColumnFilter("dtilOccuInttnCd", strDtilOccuInttnCd, SimpleColumnFilter.OPERATOR_EQUALS); 
		          
					//pInsr5100GridPanel.getTableDef().addColumnFilter("deptCd", MSFSharedUtils.allowNulls(srhDeptCd.getValue()), SimpleColumnFilter.OPERATOR_EQUALS); 
					//pInsr5100GridPanel.getTableDef().addColumnFilter("typOccuCd", MSFSharedUtils.getSelectedComboValue(srhTypOccuCd,"typOccuCd"), SimpleColumnFilter.OPERATOR_EQUALS); 
					//pInsr5100GridPanel.getTableDef().addColumnFilter("pyspGrdeCd",  MSFSharedUtils.getSelectedComboValue(srhTypOccuCd,"pyspGrdeCd") , SimpleColumnFilter.OPERATOR_EQUALS); 
					//pInsr5100GridPanel.getTableDef().addColumnFilter("dtilOccuInttnCd", MSFSharedUtils.getSelectedComboValue(srhDtilOccuInttnCd,"dtilOccuInttnCd"), SimpleColumnFilter.OPERATOR_EQUALS); 
		          
					pInsr5100GridPanel.getTableDef().addColumnFilter("businCd", MSFSharedUtils.getSelectedComboValue(srhBusinCd,"businCd"), SimpleColumnFilter.OPERATOR_EQUALS); 
					pInsr5100GridPanel.getTableDef().addColumnFilter("systemkey", MSFSharedUtils.allowNulls(srhSystemkey.getRawValue()), SimpleColumnFilter.OPERATOR_EQUALS); 
					pInsr5100GridPanel.getTableDef().addColumnFilter("hanNm", MSFSharedUtils.allowNulls(srhHanNm.getRawValue()), SimpleColumnFilter.OPERATOR_EQUALS);    
					pInsr5100GridPanel.getTableDef().addColumnFilter("resnRegnNum", MSFSharedUtils.allowNulls(srhResnRegnNum.getRawValue()), SimpleColumnFilter.OPERATOR_EQUALS);  
				   ...
				   if (MSFSharedUtils.paramNotNull(srhHdofcCodtnCd.getValue())) {
			        ...
			        pInsr5100GridPanel.getTableDef().addColumnFilter("hdofcCodtnCd", strHdofcCodtnCd, SimpleColumnFilter.OPERATOR_EQUALS); 
		              
					 
					pInsr5100GridPanel.reload();
		   ...
		   private void formInit() {
		     ...
		     pInsr5100GridPanel.getMsfGrid().clearData();
	 ...
	 private void xlsExportData(String gubun) {
		 ...
		 String checkedSystemKeys = "";
		 int keyCnt = 0;
		 List<BaseModel> list = pInsr5100GridPanel.getGrid().getSelectionModel().getSelectedItems();
		 ...
		 if("".equals(year) || "".equals(month)){
			 ...
			 pInsr5100GridPanel.callXlsExportServlet(GWT.getHostPageBaseURL() + "exp/Xls"+gubun+"Export.do","extgwtFrame" ,param);  
			 
		 }  
	 }	  
	 
	  private void InsrP510001Print(String fileName, String repType) {
