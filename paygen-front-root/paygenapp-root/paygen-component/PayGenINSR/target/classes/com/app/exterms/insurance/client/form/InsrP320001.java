...
=====================================================**/
public  class InsrP320001   extends MSFFormPanel {  
 ...
 **/	  
      ...
      // private AuthAction authAction;  
		...
		//  private static MessageBox authBox = MessageBox.wait("화면로딩", "설정 초기화 작업 진행 중입니다....", "설정 작업 진행 중..."); 
		   ...
		   * AuthAction 
		   */
		  private void checkInsrP320001Auth( String authAction, ListStore<BaseModel> bm) {   
			 ...
			 private void authExecEnabled() { 
			   ...
			   /**++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
                 ...
                 * 값순서 : 단위기관 ,고용구분, 부서, 직종, 직종세 ,사업 순으로  없으면 ""
                 ...
                 // GWTAuthorization.formAuthPopConfig(cpInsr2101, "srhPayrMangDeptCd","srhEmymtDivCd",strArrDeptCd,"srhTypOccuCd","srhDtilOccuInttnCd","srhBusinCd");
...
//    	   * AuthAction 
//    	   */
//    	  private void checkInsrP320001Auth( AuthAction authAction, ListStore<BaseModel> bm, int authChk) {   
//        	   //MSFMainApp.maskMainPage("[화면로딩] 초기화 진행 중"); 
//    		 
...
//	    }
	  ...
	  public InsrP320001(final ActionDatabase actionDatabase, final MSFPanel caller) {
...
//	        this.setHeaderVisible(false);
		  ...
		  //cpInsr2101.setSize("810px", "710px");  
		    
		    this.add(cpInsr2101);
//		    formBinding = new FormBinding(this, true);
			this.setSize("910px", "510px");  //setSize("790px", "610px");  
	  } 
...
//		    };   
		  	...
		  	Button topBtn2 = new Button("대상자선택"); 
		  	...
		  	buttonBar.add(topBtn);  
		  	 ...
		  	 topBtn = new Button("소득총액신고파일생성"); 
		  	topBtn.setIcon(Resources.APP_ICONS.text()); 
		  	buttonBar.add(topBtn);  
		  	
		  	cpInsr2101.add(buttonBar);    	
		    
		  cpInsr2101.setSize("890px", "540px");
	  }
...
//		  		cpInsr2101.add(payYrGrid); 

		  
		    cpInsr2101.setLayout(new FlowLayout());
		   ...
		   // srhPayYr.setEmptyText("--년도선택--");
		    ...
		    srhPayYr.setFieldLabel("작성기간"); 
		    srhPayYr.getStore().addStoreListener( new StoreListener<BaseModel>() {   
		        public void handleEvent(StoreEvent<BaseModel> be) {  
		        	checkInsrP320001Auth("srhPayYr",lsPayYrStore);  
		   ...
		   // srhPayMonth.setEmptyText("--월선택--");
		    ...
		    srhPayMonth.getStore().addStoreListener( new StoreListener<BaseModel>() {   
		        public void handleEvent(StoreEvent<BaseModel> be) {  
		        	checkInsrP320001Auth("srhPayMonth",lsPayMonth);  
			    	   ...
			    	   if (type == Store.Add) { 
	                		 /**++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
			                     ...
			                     * "srhPayrMangDeptCd","srhEmymtDivCd","srhDeptCd","srhTypOccuCd","srhBusinCd"
			                     ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++*/ 
			                	checkInsrP320001Auth("srhPayrMangDeptCd", lsPayrMangDeptCd); 
	                	 }
	        ...
	        srhPayCd.getStore().addStoreListener( new StoreListener<BaseModel>() {   
	            public void handleEvent(StoreEvent<BaseModel> be) {  
	            	...
	            	checkInsrP320001Auth("srhPayCd", lsPayCd); 
	            }
	        });    
...
//	            } 
//	       }); 
	        layoutContainer_5.add(layoutContainer_6,new com.extjs.gxt.ui.client.widget.layout.ColumnData(.39));
	     ...
	     //   srhResnRegnNum.setFieldLabel("주민번호");
	        ...
	        layoutContainer_5.add(layoutContainer_7,new com.extjs.gxt.ui.client.widget.layout.ColumnData(.48));
	            	 ...
	            	 EventType type = be.getType();
			    	   if (type == Store.Add) { 
	                		 /**++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
			                     ...
			                     * "srhPayrMangDeptCd","srhEmymtDivCd","srhDeptCd","srhTypOccuCd","srhBusinCd"
			                     ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++*/ 
			                	checkInsrP320001Auth("srhEmymtDivCd", lsEmymtDivCd); 
	                	 }
	            }
	        });    
	            	 ...
	            	 EventType type = be.getType();
			    	   if (type == Store.Add) { 
	                		 /**++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
			                     ...
			                     * "srhPayrMangDeptCd","srhEmymtDivCd","srhDeptCd","srhTypOccuCd","srhBusinCd"
			                     ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++*/ 
			                	checkInsrP320001Auth("srhDeptCd", lsDeptCd); 
	                	 }
	            	 ...
	            	 EventType type = be.getType();
		               ...
		               // srhEmymtDivCd.setValue(lsEmymtDivCd.getAt(0)); 
	                		 /**++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
			                     ...
			                     * "srhPayrMangDeptCd","srhEmymtDivCd","srhDeptCd","srhTypOccuCd","srhBusinCd"
			                     ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++*/ 
			                	//checkInsrP320001Auth("srhTypOccuCd", lsTypOccuCd); 
			    		   }
			    		   }
    ...
    //   idtlAccdtInsurApptnYn = new HiddenField<Boolean>() ; 
     ...
     //  cpInsr2101.add(pyspGrdeCd);
	   ...
	   cpInsr2101.add(emymtDivCd);
		    ...
		    resnRegnNum.setFieldLabel("사업장관리번호"); 
		    layoutContainer_7.setBorders(false);
		    ...
		    currAffnDeptNm.setFieldLabel("지사코드"); 
		    layoutContainer_10.setBorders(false);
		    ...
		    dtilOccuClsDivNm.setFieldLabel("팩스번호"); 
...
//		    logSvcYrNumNm.setFieldLabel("가입자전화");   
//		    layoutContainer_3_1.add(logSvcYrNumNm, new FormData("100%"));
	  ...
	  private  void createStandardForm() {
		...
		//	fldstNewFieldset_2.setSize(528, 120);
			...
			fldstNewFieldset_2.setHeadingHtml("연금소득총액신고내역");
	  ...
	  private LayoutContainer createCheckBoxGrid() {    
		    ...
		    column = new ColumnConfig();   
		    column.setId("last");   
		    column.setHeaderText("[근무기간]시작일자");   
		    column.setAlignment(HorizontalAlignment.CENTER);   
		    column.setWidth(100);   
		    column.setRenderer(gridNumber);   
		    configs.add(column);   
		    ...
		    column = new ColumnConfig("change", "[근무기간]공적휴직일수", 100);   
		    column.setAlignment(HorizontalAlignment.CENTER);    
		    column.setRenderer(change);   
		    configs.add(column);   
		    

		    column = new ColumnConfig("change", "[근무기간]실제휴직일수", 100);   
		    column.setAlignment(HorizontalAlignment.CENTER);    
		    column.setRenderer(change);   
		    configs.add(column);   
		    ...
		    column = new ColumnConfig("change", "상실여부", 100);   
		    column.setAlignment(HorizontalAlignment.CENTER);    
		    column.setRenderer(change);   
		    configs.add(column);   
