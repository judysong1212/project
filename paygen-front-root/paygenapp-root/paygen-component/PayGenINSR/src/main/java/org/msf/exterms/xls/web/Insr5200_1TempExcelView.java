...
public class Insr5200_1TempExcelView extends AbstractExcelView {
...
//        setText(cell, "20150101");    /** 취득일자            */
    	...
    	XLSTransformer transformer = new XLSTransformer();
      	...
      	String xlsRelatvieFilepath = realPath.concat("/".concat(globals.get("PayGen.XLSTemplateLink")).concat("/INSR/XlsInsr5200_1TempExport.xls"));
		String destFileName = "고용보험업로드양식(간단)"; 
