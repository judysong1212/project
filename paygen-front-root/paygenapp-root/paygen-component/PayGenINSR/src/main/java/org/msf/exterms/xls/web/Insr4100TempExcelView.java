...
public class Insr4100TempExcelView extends AbstractExcelView {
...
//        HSSFCell cell = null;
//         
//        HSSFSheet sheet = wb.createSheet("건강보험업로드샘플");
...
//        setText(getCell(sheet, 1, 3), "건강보험보수총액");
//        setText(getCell(sheet, 1, 4), "건강보험등급"); 
//        setText(getCell(sheet, 1, 5), "보수월액");
//        setText(getCell(sheet, 1, 6), "건강보험증번호");
...
//        setText(cell, "20150101");    /** 취득일자            */
 	   ...
 	   final HashMap<String, String> globals = MSFServerUtils.getLocalidedMessages(RemoteServiceUtil.getThreadLocalConfig(), RemoteServiceUtil.getThreadLocalRequest());   
     	...
     	XLSTransformer transformer = new XLSTransformer();
       	...
       	String xlsRelatvieFilepath = realPath.concat("/".concat(globals.get("PayGen.XLSTemplateLink")).concat("/INSR/XlsInsr4100TempExport.xls"));
 		String destFileName = "건강보험업로드양식"; 
