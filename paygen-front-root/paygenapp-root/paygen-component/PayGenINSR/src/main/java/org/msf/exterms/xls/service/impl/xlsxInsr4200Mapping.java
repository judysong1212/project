...
public class xlsxInsr4200Mapping  extends EgovExcelXSSFMapping {
        /**
         * 우편번호 엑셀파일 맵핑
         */
        ...
        public Object mappingColumn(XSSFRow row) {
            ...
            XSSFCell cell16 = row.getCell((int) 16);
            XSSFCell cell17 = row.getCell((int) 17);
            XSSFCell cell18 = row.getCell((int) 18);
            XSSFCell cell19 = row.getCell((int) 19);
            XSSFCell cell20 = row.getCell((int) 20);
            XSSFCell cell21 = row.getCell((int) 21);
            XSSFCell cell22 = row.getCell((int) 22);
            XSSFCell cell23 = row.getCell((int) 23);
            XSSFCell cell24 = row.getCell((int) 24);
            XSSFCell cell25 = row.getCell((int) 25);
            XSSFCell cell26 = row.getCell((int) 26);
            XSSFCell cell27 = row.getCell((int) 27);
            XSSFCell cell28 = row.getCell((int) 28);
            XSSFCell cell29 = row.getCell((int) 29);
            XSSFCell cell30 = row.getCell((int) 30);
            XSSFCell cell31 = row.getCell((int) 31);
            XSSFCell cell32 = row.getCell((int) 32);
            XSSFCell cell33 = row.getCell((int) 33);
            XSSFCell cell34 = row.getCell((int) 34); 
