...
public class Insr5400ExcelView extends AbstractExcelView {
...
logger.debug("00001");         
	   final HashMap<String, String> globals = MSFServerUtils.getLocalidedMessages(RemoteServiceUtil.getThreadLocalConfig(), RemoteServiceUtil.getThreadLocalRequest());   
    	...
    	XLSTransformer transformer = new XLSTransformer();
      	...
      	String xlsRelatvieFilepath = realPath.concat("/".concat(globals.get("PayGen.XLSTemplateLink")).concat("/INSR/XLS_INSR5400.xls"));
      	//C:\eGovFrameDev-2.7.0-64bit\workGwtSpace\paygen-root\paygen-web\PayGenApp\src\main\webapp\XlsTemplate\INSR
		String destFileName = "고용보험총액신고"; 

logger.debug("00002");
logger.debug("xlsRelatvieFilepath[" + xlsRelatvieFilepath + "]");
