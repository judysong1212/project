...
public class InsrP410002ExcelView extends AbstractExcelView {
    ...
    protected void buildExcelDocument(Map<String, Object> model,
	   ...
	   final HashMap<String, String> globals = MSFServerUtils.getLocalidedMessages(RemoteServiceUtil.getThreadLocalConfig(), RemoteServiceUtil.getThreadLocalRequest());   
    	...
    	XLSTransformer transformer = new XLSTransformer();
      	...
      	String xlsRelatvieFilepath = "";
      	String destFileName = "";
      	if("INSRP41000201".equals(model.get("gubun"))){
      		 xlsRelatvieFilepath = realPath.concat("/".concat(globals.get("PayGen.XLSTemplateLink")).concat("/INSR/XLS_"+model.get("gubun")+".xls"));
    		 destFileName = "건강보험-월별납부실적(부서별)"; 
      	}
      	
      	if("INSRP41000202".equals(model.get("gubun"))){
      		 xlsRelatvieFilepath = realPath.concat("/".concat(globals.get("PayGen.XLSTemplateLink")).concat("/INSR/XLS_"+model.get("gubun")+".xls"));
    		 destFileName = "건강보험-월별납부실적(개인별)"; 
      	}
