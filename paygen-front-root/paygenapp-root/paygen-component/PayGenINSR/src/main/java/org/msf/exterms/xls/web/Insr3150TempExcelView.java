...
public class Insr3150TempExcelView extends AbstractExcelView {
...
//        setText(cell, "160565");    //사업자소급보험료
    	...
    	XLSTransformer transformer = new XLSTransformer();
      	...
      	String xlsRelatvieFilepath = realPath.concat("/".concat(globals.get("PayGen.XLSTemplateLink")).concat("/INSR/XlsInsr3150TempExport.xls"));
		String destFileName = "국민연금월별대사내역업로드양식"; 
