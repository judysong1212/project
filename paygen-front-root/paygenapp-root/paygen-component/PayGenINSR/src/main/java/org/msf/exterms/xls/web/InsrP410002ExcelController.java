...
@Controller
public class InsrP410002ExcelController {


    private static final Logger logger = LoggerFactory.getLogger(InsrP410002ExcelController.class);  
    private static final String calledClass = InsrP410002ExcelController.class.getName();

    
    
    @Resource(name = "InsrP410002ExcelService")
    private InsrP410002ExcelService insrP410002ExcelService;
...
//     * @throws Exception
//     */
//    @RequestMapping(value="/exp/XlsInsrP410002TempExport.do")   
...
//    }
     ...
     * @throws Exception
     */
    @RequestMapping(value="/exp/XlsInsrP41000202Export.do")   
    public ModelAndView xlsInsrP41000202Export(@ModelAttribute("Insr3000SrhVO") Insr3000SrhVO insr3000SrhVo,HttpServletRequest request ,ModelMap model) 
                    throws Exception { 
       
    	String method = calledClass + ".xlsInsrP41000202Export";
    	
    	String windowNm = "건강보험기본관리";
		String windowId = "INSRP410002";
       ...
       /******************************** 권한 ************************************************************************/
        ...
        List listInsrP3000 = insrP410002ExcelService.selectXlsInsrP41000202ToInsr3000List(insr3000SrhVo);
...
//        Map<String, Object> map = new HashMap<String, Object>(); 
        ...
        return new ModelAndView("insrP410002ExcelView", map);
     ...
     * @throws Exception
     */
    @RequestMapping(value="/exp/XlsInsrP41000201Export.do")   
    public ModelAndView xlsInsrP41000201Export(@ModelAttribute("Insr3000SrhVO") Insr3000SrhVO insr3000SrhVo,HttpServletRequest request ,ModelMap model) 
                    throws Exception { 
       
    	String method = calledClass + ".xlsInsrP41000201Export";
	...
	//        }
	        ...
	        List listInsrP3000 = insrP410002ExcelService.selectXlsInsrP41000201ToInsr3000List(insr3000SrhVo);
	    	String nResult = AnyCryptUtils.XecureCryptInitialize(RemoteServiceUtil.getThreadLocalConfig(),RemoteServiceUtil.getThreadLocalRequest());
			List<EgovMap> excelList = new ArrayList<EgovMap>();
