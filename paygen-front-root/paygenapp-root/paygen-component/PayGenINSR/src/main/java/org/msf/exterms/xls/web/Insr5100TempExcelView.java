...
public class Insr5100TempExcelView extends AbstractExcelView {
...
//        setText(cell, "20150101");    /** 취득일자            */
    	...
    	XLSTransformer transformer = new XLSTransformer();
      	...
      	String xlsRelatvieFilepath = realPath.concat("/".concat(globals.get("PayGen.XLSTemplateLink")).concat("/INSR/XlsInsr5100TempExport.xls"));
