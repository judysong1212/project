...
public class Insr4500ExcelView extends AbstractExcelView {
	/**
	 * 엑셀파일을 설정하고 생성한다.
	 * @param model
	 * @param wb
	...
	protected void buildExcelDocument(	Map<String, Object> model
		...
		String xlsRelatvieFilepath =   realPath.concat("/".concat(globals.get("PayGen.XLSTemplateLink")).concat("/INSR/UPXLS_INSR3100.xls"));
		
		String destFileName = "연말정산산출내역서";
