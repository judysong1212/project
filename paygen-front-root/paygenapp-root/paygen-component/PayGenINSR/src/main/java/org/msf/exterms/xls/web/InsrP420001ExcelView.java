...
public class InsrP420001ExcelView extends AbstractExcelView {
	   ...
	   final HashMap<String, String> globals = MSFServerUtils.getLocalidedMessages(RemoteServiceUtil.getThreadLocalConfig(), RemoteServiceUtil.getThreadLocalRequest());   
    	...
    	XLSTransformer transformer = new XLSTransformer();
      	...
      	String destFileName = "";
      		 ...
      		 xlsRelatvieFilepath = realPath.concat("/".concat(globals.get("PayGen.XLSTemplateLink")).concat("/INSR/XLS_INSRP420001.xls"));
    		 destFileName = "건강보험-월별변동내역"; 
