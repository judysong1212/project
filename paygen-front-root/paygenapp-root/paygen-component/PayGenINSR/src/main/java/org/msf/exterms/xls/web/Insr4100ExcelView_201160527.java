...
public class Insr4100ExcelView_201160527 extends AbstractExcelView {
    ...
    protected void buildExcelDocument(Map<String, Object> model,
        ...
        HSSFCell cell = null;
        int i = 0; 
        HSSFSheet sheet = wb.createSheet("건강보험");
        sheet.setDefaultColumnWidth((short) 20);
  	 	 			 	 
        // put text in first cell
        cell = getCell(sheet, 0, 0);
        setText(cell, "건강보험리스트");
        ...
        List listInsr4100 = (List) model.get("listInsr3000");
