...
public class Insr4300ExcelView extends AbstractExcelView {
	/**
	 * 엑셀파일을 설정하고 생성한다.
	 * @param model
	 * @param wb
	...
	protected void buildExcelDocument(	Map<String, Object> model
		...
		String xlsRelatvieFilepath =   realPath.concat("/".concat(globals.get("PayGen.XLSTemplateLink")).concat("/INSR/UPXLS_INSR3400.xls"));
		
		String destFileName = "건강보험휴퇴직자정산내역";
