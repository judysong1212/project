 ...
 */
public class Insr3150VO implements Serializable {
    private static final long serialVersionUID = 1L;
    
    private List<Insr3150VO> insr3150List = new ArrayList<Insr3150VO>();
    
    
    public List<Insr3150VO> getInsr3150List() {
		return insr3150List;
	}

	public void setInsr3150List(List<Insr3150VO> insr3150List) {
		this.insr3150List = insr3150List;
	}
