...
/**
 * @Class Name : Insr2200DefaultVO.java
 * @Description : Insr2200 Default VO class
 ...
 */
public class Insr2200SrhVO implements Serializable {
    ...
    /** set 사회보험작성일자-시작 : soctyInsurCmptnDt */
    private java.lang.String soctyInsurCmptnDt01;
    
    /** set 사회보험작성일자- 종료 : soctyInsurCmptnDt */
    ...
    private java.lang.String retryDt; //퇴직종료일자
    
    private java.lang.String gubun; // 각 보험별 엑셀다운 구분
