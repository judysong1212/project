...
/**
 * @Class Name : Insr1200DefaultVO.java
 * @Description : Insr1200 Default VO class
 ...
 */
public class Insr1200SrhVO implements Serializable {
...
/** 엑셀저장 구분 */
private String valDiv = "";

	public String getValDiv() {
	return valDiv;
}

public void setValDiv(String valDiv) {
	this.valDiv = valDiv;
}
