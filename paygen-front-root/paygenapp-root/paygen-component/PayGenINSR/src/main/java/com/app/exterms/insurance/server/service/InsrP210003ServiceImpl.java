...
import com.app.exterms.insurance.client.service.InsrP210003Service;
import com.app.exterms.insurance.shared.InsrDaoConstants;
import com.app.smrmf.core.msfmainapp.server.service.impl.AbstractCustomServiceImpl;
@Service("InsrP210003Service")
public class InsrP210003ServiceImpl extends AbstractCustomServiceImpl implements InsrP210003Service ,InsrDaoConstants{
	
		private static final Logger logger = LoggerFactory.getLogger(InsrP210003ServiceImpl.class);
		private static final String calledClass = InsrP210003ServiceImpl.class.getName();
