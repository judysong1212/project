 ...
 */
public class Insr5100Def  extends TableDef implements InsrDaoConstants {
	  private int row = 0;
	    private InsrConstants InsrLabel = InsrConstants.INSTANCE;

	    final PrgmComBass0300DTO sysComBass0300Dto;
	    
	    public Insr5100Def(String chkDef){
	    	
	    	 sysComBass0300Dto = new PrgmComBass0300DTO(); 
	    	 
	    	  if ("INSR5100".equals(chkDef)) {
	    		    setTitle("");
	    	        setDaoClass("");
	              ...
	              setColumnsDefinition(getInsr5100ToInsr5100());
	              ...
	              setCheckBoxOnGridRows(true); 
	             // setEditFieldGrid(true); 
	              setColumnsDefinition(getInsr5100());
	              
	          } 
	    }	
	    
	    public List<ColumnDef> getInsr5100(){	  
...
//
//	    	private TextField<String> umytInsrEepnYn;   /** column 고용보험제외여부 : umytInsrEepnYn */
//
//	    	private TextField<String> umytInsrEepnReasCtnt;   /** column 고용보험제외사유내용 : umytInsrEepnReasCtnt */
//
...
//	    	private TextField<String> revnAddr;   /** column 수정주소 : revnAddr */
	    ...
	    public List<ColumnDef> getInsr5100ToInsr5100(){	  
	    	...
	    	/** column 고용보험상실일자 : umytInsrLssDt */
	    	listColumnDefs.add(new ColumnDef("상실일자", Insr5100BM.ATTR_UMYTINSRLSSDT, ColumnDef.TYPE_DATE , 90, true, true, true){
	    		{
	    			 //setReadOnly(true);
	    		}
	    	});
