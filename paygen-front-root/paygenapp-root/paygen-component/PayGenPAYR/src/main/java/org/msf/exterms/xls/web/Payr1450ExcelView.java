...
public class Payr1450ExcelView extends AbstractExcelView {
    ...
    protected void buildExcelDocument(Map<String, Object> model,
    	...
    	XLSTransformer transformer = new XLSTransformer();
      	...
      	String xlsRelatvieFilepath =   realPath.concat("/".concat(globals.get("PayGen.XLSTemplateLink")).concat("/PAYR/XLS_PAYR1450.xls"));
      
		String destFileName = "수당공제출력항목";
