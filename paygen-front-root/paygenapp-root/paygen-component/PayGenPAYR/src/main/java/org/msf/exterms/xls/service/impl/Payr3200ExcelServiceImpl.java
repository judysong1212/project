...
@Service("payr3200ExcelService")
public class Payr3200ExcelServiceImpl extends AbstractServiceImpl implements Payr3200ExcelService {
	
	private static final Logger logger = LoggerFactory.getLogger(Payr3200ExcelServiceImpl.class);
	private static final String calledClass = Payr3200ExcelService.class.getName();
  ...
  public List selectXlsPayr0520List(Payr0520VO payr0520Vo) throws Exception {
	...
	@Override
	public Long insertXlsPayr3200ToPayr0520(List<Payr0520VO> payr0520List, HttpServletRequest request)throws MSFException {
...
//         		payr0520Vo.setSystemkey(MSFSharedUtils.allowNulls(payr0520Vo.getSystemkey()));    	/** column SYSTEMKEY : systemkey */
				// 암호화
			...
			logger.error("EXCEPTION calling insertXlsPayr3200ToPayr0520(): " + ex);
			result = new Long(0);
			throw MSFServerUtils.getOperationException("insertXlsPayr3200ToPayr0520", ex, logger);
		} finally {
