...
public class Payr5400ExcelView extends AbstractExcelView {
    ...
    protected void buildExcelDocument(Map<String, Object> model,
    	...
    	XLSTransformer transformer = new XLSTransformer();
      	...
      	String xlsRelatvieFilepath =   realPath.concat("/".concat(globals.get("PayGen.XLSTemplateLink")).concat("/PAYR/UPXLS_PAYR540001.xls"));
      
		String destFileName = "개별수당리스트폼";
