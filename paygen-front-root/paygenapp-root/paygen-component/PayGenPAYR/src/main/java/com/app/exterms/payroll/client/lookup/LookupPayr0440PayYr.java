...
public class LookupPayr0440PayYr extends TableDef implements PayrDaoConstants {
     
    private PayrConstants payYrLabel = PayrConstants.INSTANCE;
    
    public LookupPayr0440PayYr(){
    	setTitle(payYrLabel.title_Payr0440PayYr());
    	setDaoClass("");
    	setCustomListMethod(CLASS_PAYR0440_PAY_YR); 
    ...
    public LookupPayr0440PayYr(String title, Class<?> pojoClass) {
        this();
        setTitle(title);
