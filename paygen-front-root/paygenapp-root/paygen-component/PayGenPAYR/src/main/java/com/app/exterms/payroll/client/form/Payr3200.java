...
=====================================================**/
public class Payr3200  extends MSFPanel { 
 ...
 **/
	...
	private Payr0520Def payr0520ToPayr3200Def = new Payr0520Def("PAYR03200_DDUCDIVCD"); // 그리드 테이블 컬럼 define
	// private MSFCustomForm msfCustomForm;
	private MSFGridPanel payr0520ToPayr3200GridPanel;

	private Payr0520Def payr0520Def = new Payr0520Def("PAYR03200"); // 그리드 테이블
																	// 컬럼 define
	// private MSFCustomForm msfCustomForm;
...
//      private TextField<String> srhMangeDeptNm; //관리부서 수정  
    ...
    //  private HiddenField<String> srhPyspGrdeCd; //직종
		...
		private ComboBox<BaseModel> srhDducDivCd; 				// 공제
	 ...
	 */
		...
		private TextField<String> payItemNm;				/** column 급여항목 : payItemNm */
		...
		private FileUploadField payr3200flUp; 				// 파일업로드처리 부분
 ...
 **/	  
	 ...
	 **/
		...
		private void authExecEnabled() {
			...
			// GWTAuthorization.formAuthPopConfig(plFrmPayr3200,
			...
			// gwtAuthorization.formAuthConfig(plFrmPayr3200,
 ...
 **/
	...
	private ListStore<BaseModel> lsDducDivCd 		= new ListStore<BaseModel>(); 	// 공제
...
//                    payr0520Dto.setRevnAddr(MSFSharedUtils.allowNulls(bmMapModel.get("revnAddr")));    /** column 수정주소 : revnAddr */
				...
				if (payr0520Dto.getPymtDducItemBgnnDt() == null || payr0520Dto.getPymtDducItemEndDt() == null) {
					doActionYn = false;
					MessageBox.alert(MSFMainApp.MSFCONSTANTS.Errore(),"시작일자와 종료일자를 입력해 주세요.", null);
				}
			...
			payr0520ToPayr3200Grid.addListener(Events.CellDoubleClick,new Listener<BaseEvent>() {
				public void handleEvent(BaseEvent be) {
					if (payr0520ToPayr3200GridPanel.getCurrentlySelectedItem() != null) {
                        	 ...
                        	 /*
                        	 if( be.getGrid().getStore().getAt(dlgn0110Grid.getStore().indexOf(dlgn0110Grid.getSelectionModel().getSelectedItem())).getDilnlazAbnceYnboolean() ) {
                    	...
                    	payr0520GridPanel.getTableDef().addColumnFilter("pymtDducDivCd", PayGenConst.PYMT_DDUC_DIV_CD_03, SimpleColumnFilter.OPERATOR_EQUALS);
 ...
 **/ 	
	...
	public Payr3200(String txtForm) {
 ...
 **/	
	private void createPayr3200Form() {
		...
		plFrmPayr3200.setHeadingText(PayGenConst.PAYGEN_VERSION.concat(" -  ")+ lblPayrConst.title_Payr3200());
		...
		btnlogView.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				 //로그 뷰화면 호출 메서드 
				  funcLogMessage(lblPayrConst.title_Payr3200(),"PAYR3200");
				}
			});
  ...
  */
	private void createSearchForm() {
		...
		lsDataStatus.add(dataStat);
		 ...
		 //--------------------공통 코드 불러 오는 함수 --------------------------------------------------
		 //공제
		 //sysComPayr0470Dto.setDpobCd("");
		 //sysComPayr0470Dto.setPymtDducDivCd("B0080030");
		 lsDducDivCd = PrgmComComboUtils.getSinglePayr0470ComboData(sysComPayr0470Dto);
...
//	    lcSchCol.add(layoutContainery,new com.extjs.gxt.ui.client.widget.layout.ColumnData(.15)); 		// 공제년도
////	    lcSchCol.add(lcSchLeft,new com.extjs.gxt.ui.client.widget.layout.ColumnData(.23)); 			
...
//	    lcSchCol.add(layoutContainer_10,new com.extjs.gxt.ui.client.widget.layout.ColumnData(.2));		// 사업
	    ...
	    lcSchCol.add(layoutContainery,new com.extjs.gxt.ui.client.widget.layout.ColumnData(.12)); 		// 공제년도
	    lcSchCol.add(layoutContainer_4,new com.extjs.gxt.ui.client.widget.layout.ColumnData(.18)); 		// 출력조건
...
//	    layoutContainer_13.add(layoutContainer_3 ,new com.extjs.gxt.ui.client.widget.layout.ColumnData(.2));	// 공제
...
//	    layoutContainer_13.add(layoutContainer_2,new com.extjs.gxt.ui.client.widget.layout.ColumnData(.28));	// 성명
	    ...
	    layoutContainer_13.add( lcSch2_1,new com.extjs.gxt.ui.client.widget.layout.ColumnData(.3));	// 공제
	    ...
	    srhDducDivCd.setDisplayField("payDducNm");
	    srhDducDivCd.setValueField("payDducCd");
	    srhDducDivCd.setTriggerAction(TriggerAction.ALL);
	    srhDducDivCd.setEmptyText("--공제선택--");
...
//		fldstNewFieldset_1.setSize(655, 140);
...
//		fldstNewFieldset_2.setSize(655, 365);
		layoutContainer_2.add(fldstNewFieldset_2);
		fldstNewFieldset_2.setHeadingHtml("공제대상자정보");
...
//	   layoutContainer_7.setBorders(false);
	   ...
	   pymtDducSum.setFieldLabel("공제금액");
	   layoutContainer_1.setBorders(false);
...
//	      
	...
	private void createSubForm() {
		...
		payr3200flUp = new FileUploadField();
		payr3200flUp.setName("payr3200flUp");
		payr3200flUp.setValidator(new Validator() {  
			@Override 
		...
		layoutContainer_21.add(payr3200flUp, new FormData("100%"));
		payr3200flUp.setFieldLabel("개별수당");
...
//			   cpGridPayr0520.setSize(635, 340);  
...
//			     cp01.add(payr0200GridPanel); 
		...
		payr0520Grid.addListener(Events.RowClick, new Listener<BaseEvent>() {
			...
			public void handleEvent(BaseEvent be) {
				...
				if (payr0520GridPanel.getCurrentlySelectedItem() != null) {
					...
					// MSFTextField itemField = (MSFTextField)
					// GWTUtils.findField(payr0520GridPanel.getMSFFormPanel(),
					// payr0520Def.COLUMN_DEF_PAYITEMCD);
					// payr0520Def.setitemChange(itemField,record.get("payItemCd"));
		...
		cpGridPayr0520.addButton(new Button("삭제", MSFMainApp.ICONS.deleteSmall(),new SelectionListener<ButtonEvent>() {   
			...
			public void componentSelected(ButtonEvent ce) {
				...
				MessageBox.confirm("경고", "해당 공제 내역을 삭제하겠습니까?</br> (삭제된 데이터는 복구되지 않습니다.)", new Listener<MessageBoxEvent>() {
					@Override
   ...
   **/ 	  
	...
	public void reload() {
			...
			payr0520ToPayr3200GridPanel.getTableDef().addColumnFilter("pymtDducDivCd", PayGenConst.PYMT_DDUC_DIV_CD_03, SimpleColumnFilter.OPERATOR_EQUALS);
			...
			String strDeptCd = PayrUtils.getStrValToBMMultiCombo(lsDeptCd,srhDeptCd.getValue(),"deptNmRtchnt","deptCd");  
            payr0520ToPayr3200GridPanel.getTableDef().addColumnFilter("deptCd", strDeptCd , SimpleColumnFilter.OPERATOR_EQUALS); 
...
//                           bmData.set("deptNm",MSFSharedUtils.allowNulls(bmMapModel.get("deptNm")));   /** column 부서 : deptNm */ 
                           ...
                           bmData.set("payItemCd$payDducCd",MSFSharedUtils.allowNulls(payItemCd.getValue()));    /** column 급여항목코드 : payItemCd */ 
                           bmData.set("payItemCd$payDducNm", MSFSharedUtils.allowNulls(payItemNm.getValue()));    /** column 급여항목코드 : payItemCd */
                           
                           bmData.set("pymtDducItemSilNum",0L);    /** column 개별지급공제항목일련번호 : pymtDducItemSilNum */
                           
                           bmData.set("pymtDducDivCd", PayGenConst.PYMT_DDUC_DIV_CD_03);  /** column 지급공제구분코드 : pymtDducDivCd */
                           bmData.set("pymtDducDivNm", "공제");  /** column 지급공제구분 : pymtDducDivNm */
...
//                           revnAddr.setValue(record.get("revnAddr"));    /** column 수정주소 : revnAddr */
      ...
      private void setFormDataMapping() {
    	  payItemCd.setValue((String)record.get("payItemCd$payDducCd"));    /** column 공제코드 : pymtDducCd */
    	  payItemNm.setValue((String)record.get("payItemCd$payDducNm"));    /** column 공제명 : pymtDducNm */
...
//	                   actionDatabase = ActionDatabase.INSERT; 
	...
	private void xlsExportData(Payr0520DTO payr0520Dto) {
		...
		payr0520GridPanel.callXlsExportServlet(GWT.getHostPageBaseURL() + "exp/XlsPayr3200TempExport.do","extgwtFrame" ,param);    
		           
	}
	
	/** 엑셀 업로드 **/
	private void xlsImportData() { 
		MessageBox.confirm("공제 생성", "개별 공제 내역을 생성하시겠습니까?</br> 이미 등록되어 있는 공제 내역은 삭제됩니다.",new Listener<MessageBoxEvent>(){
	      	@Override
	    	public void handleEvent(MessageBoxEvent be) {
	      		//if("Yes".equals(be.getButtonClicked().getText())){
	      		if(Dialog.YES.equals(be.getButtonClicked().getItemId())){
...
//		            String systemKey = MSFSharedUtils.allowNulls(systemkey.getValue()); 
	      			...
	      			String filename = MSFSharedUtils.allowNulls(payr3200flUp.getValue());
	      			if (filename.length() == 0) {
	             		...
	             		//파일업로드 처리
	             		plFrmPayr3200.setAction(GWT.getHostPageBaseURL() + "imp/XlsReadPayr3200Import.do");
	             		plFrmPayr3200.setEncoding(Encoding.MULTIPART);
	             		plFrmPayr3200.setMethod(Method.POST);   
