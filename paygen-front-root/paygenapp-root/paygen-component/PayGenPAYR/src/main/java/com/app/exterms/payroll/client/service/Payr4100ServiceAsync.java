...
public interface Payr4100ServiceAsync {
	public void activityOnPayr0530(List<Payr0530DTO> listPayr0530dto, ActionDatabase actionDatabase, AsyncCallback<Long> callback);
	
	public void activityOnPayr0520(Payr0520DTO payr0520Dto, ActionDatabase actionDatabase, AsyncCallback<Long> callback);
	
	public void activityOnPayr0540( List<Payr0540DTO> listPayr0540dto , ActionDatabase actionDatabase, AsyncCallback<Long> callback);
	 
	public void activityOnUpdatePayr4100Save(Payr0500DTO payr0500Dto, AsyncCallback<Long> callback);
