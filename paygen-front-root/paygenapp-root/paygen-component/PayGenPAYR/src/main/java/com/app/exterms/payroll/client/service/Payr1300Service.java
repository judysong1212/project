...
@RemoteServiceRelativePath("Payr1300Service.gwt")
public interface Payr1300Service extends RemoteService {
	/**
	 * Utility class for simplifying access to the instance of async service.
	 */
	public static class Util {
		private static Payr1300ServiceAsync instance;
		public static Payr1300ServiceAsync getInstance(){
			if (instance == null) {
				instance = GWT.create(Payr1300Service.class);
			}
			return instance;
		}
	}
