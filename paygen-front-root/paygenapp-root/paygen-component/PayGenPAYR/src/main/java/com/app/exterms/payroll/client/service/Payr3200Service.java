...
@RemoteServiceRelativePath("Payr3200Service.gwt")
public interface Payr3200Service extends RemoteService {
	/**
	 * Utility class for simplifying access to the instance of async service.
	 */
	public static class Util {
		private static Payr3200ServiceAsync instance;
		public static Payr3200ServiceAsync getInstance(){
			if (instance == null) {
				instance = GWT.create(Payr3200Service.class);
			}
			return instance;
		}
	}
	
	   public Long activityOnPayr3200(List<Payr0520DTO> listPayr0520dto, ActionDatabase actionDatabase);
