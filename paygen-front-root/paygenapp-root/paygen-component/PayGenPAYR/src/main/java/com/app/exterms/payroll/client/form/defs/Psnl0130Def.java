...
import com.app.exterms.payroll.client.dto.Psnl0130BM;
...
=====================================================**/
public class Psnl0130Def  extends TableDef implements PayrDaoConstants {
    ...
    public Psnl0130Def(String chkDef){
	  ...
	  public List<ColumnDef> getPsnl0130(){
	      List<ColumnDef> listColumnDefs = new ArrayList<ColumnDef>(); 
	        ...
	        /** column 급여구분코드 : payCd */
	        listColumnDefs.add(new ColumnListDef("급여구분", Psnl0130BM.ATTR_PAYCD, ColumnDef.TYPE_STRING , 90, true, true, false,  new LookupPrgmComBass0300(sysComBass0300Dto),PrgmComBass0300BM.ATTR_COMMCD,PrgmComBass0300BM.ATTR_COMMCDNM){
	            {
	        ...
	        /** column 은행코드 : bnkCd */
	        listColumnDefs.add(new ColumnListDef("은행", Psnl0130BM.ATTR_BNKCD, ColumnDef.TYPE_STRING , 90, true, true, false,  new LookupPrgmComBass0300(sysComBass0300Dto),PrgmComBass0300BM.ATTR_COMMCD,PrgmComBass0300BM.ATTR_COMMCDNM){
	            {
