...
@RemoteServiceRelativePath("Payr4201Service.gwt") //4200 ->4201 수정 6.17 -"26"
public interface Payr4201Service extends RemoteService {
	/**
	 * Utility class for simplifying access to the instance of async service.
	 */
	public static class Util {
		private static Payr4201ServiceAsync instance; //4200 ->4201 수정 6.17 -"27"
		public static Payr4201ServiceAsync getInstance(){ //4200 ->4201 수정 6.17 -"28"
			if (instance == null) {
				instance = GWT.create(Payr4201Service.class); //4200 ->4201 수정 6.17 -"29"
			}
			return instance;
		}
	}
