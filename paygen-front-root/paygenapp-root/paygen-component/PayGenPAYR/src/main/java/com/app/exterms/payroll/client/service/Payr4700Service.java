...
@RemoteServiceRelativePath("Payr4700Service.gwt")
public interface Payr4700Service extends RemoteService {
	/**
	 * Utility class for simplifying access to the instance of async service.
	 */
	public static class Util {
		private static Payr4700ServiceAsync instance;
		public static Payr4700ServiceAsync getInstance(){
			if (instance == null) {
				instance = GWT.create(Payr4700Service.class);
			}
			return instance;
		}
	}
