...
public interface Payr5220ServiceAsync {
	public void saveBass0350(Bass0350DTO dto,ActionDatabase actionDatabase, AsyncCallback<String> callback );
...
//	 * @return 등록 결과resultInsertresultInsert
//	 * @exception Exception
//	 */
