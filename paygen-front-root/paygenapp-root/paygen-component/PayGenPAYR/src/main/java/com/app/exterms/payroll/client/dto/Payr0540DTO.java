 ...
 */
public class Payr0540DTO  implements Serializable {
    ...
    /** set 면제여부 : exmtnYn */
    private Boolean exmtnYn;

    /** set 예외처리공제금액 : exptnPrcsPymtSum */
    private Long exptnPrcsPymtSum;

    /** set 예외처리공제비율 : exptnPrcsPymtRto */
    private Double exptnPrcsPymtRto;
    ...
    public Long getExptnPrcsSeilNum() {
        return exptnPrcsSeilNum;
    }

    public void setExptnPrcsSeilNum(Long exptnPrcsSeilNum) {
    ...
    public Boolean getExmtnYn() {
        return exmtnYn;
    }

    public void setExmtnYn(Boolean exmtnYn) {
        this.exmtnYn = exmtnYn;
    }

    public Long getExptnPrcsPymtSum() {
        return exptnPrcsPymtSum;
    }

    public void setExptnPrcsPymtSum(Long exptnPrcsPymtSum) {
        this.exptnPrcsPymtSum = exptnPrcsPymtSum;
    }

    public Double getExptnPrcsPymtRto() {
        return exptnPrcsPymtRto;
    }

    public void setExptnPrcsPymtRto(Double exptnPrcsPymtRto) {
