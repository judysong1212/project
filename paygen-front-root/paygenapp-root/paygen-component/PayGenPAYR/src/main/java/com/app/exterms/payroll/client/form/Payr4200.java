...
=====================================================**/
public class Payr4200  extends MSFPanel { 
...
//	            } else
					...
					public void handleEvent(MessageBoxEvent be) {
						...
						if(Dialog.YES.equals(be.getButtonClicked().getItemId())){
								...
								if (MSFSharedUtils.paramNotNull(payDdlneDt.getValue()) && ("Y".equals(payDdlneYn.getValue()))) {
						            ...
						            MessageBox.alert("마감", " 마감처리된 데이타는 삭제처리는 하실 수 없습니다.", null);
						            return;
		...
		//                                payr0304Dto.setRevnAddr(MSFSharedUtils.allowNulls(record.get("revnAddr")));    /** column 수정주소 : revnAddr */ 
		                                	...
		                                	if (MSFSharedUtils.paramNotNull((String)record.get("payDdlneDt")) && ("Y".equals((String)record.get("payDdlneYn")))) {
		    									
		    						            MessageBox.alert("오류", " 마감처리된 데이터 존재! </br> 마감처리된 데이타는 삭제처리는 하실 수 없습니다.", null);
		    						            return;
...
//			payr0302Dto.setRevnAddr(MSFSharedUtils.allowNulls(bmMapModel.get("revnAddr")));    /** column 수정주소 : revnAddr */
         ...
         if (!statCheck) {    
        	 payr4200Service.activityOnExtpyPayr4200(listPayr0302dto, actionDatabase, new AsyncCallback<PagingLoadResult<ShowMessageBM>>() { 
        		 public void onFailure(Throwable caught) {
...
//			payr0302Dto.setRevnAddr(MSFSharedUtils.allowNulls(bmMapModel.get("revnAddr")));    /** column 수정주소 : revnAddr */
         ...
         if (!statCheck) {    
        	 payr4200Service.activityOnDDucPayr4200(listPayr0302dto, actionDatabase, new AsyncCallback<PagingLoadResult<ShowMessageBM>>() { 
        		 public void onFailure(Throwable caught) {
...
private void getDlgn250Data(InfcPkgDlgn0250DTO infcPkgDlgn0250Dto) {
		...
		payr4200Service.getDlgn250Data(infcPkgDlgn0250Dto,  new AsyncCallback<InfcPkgDlgn0250DTO>() {
		    public void onFailure(Throwable caught) {
		        MessageBox.alert(MSFMainApp.MSFCONSTANTS.ExceptionTitleService(), 
 ...
 **/ 	
	...
	public Payr4200(String txtForm) {
 ...
 **/
	private void createPayr4200Form() {
		...
		// plFrmPayr4200.setHeadingText(PayGenConst.PAYGEN_VERSION.concat(" - 급여(조정)내역관리");
...
//						}
		...
		plFrmPayr4200.setSize("990px", "730px");
	}
 ...
 **/  
	private void createStandardForm() {
		...
		fldstNewFieldset.setSize("330px", "540px");
		...
		fldstNewFieldset_1.setSize(622, 350);
 ...
 private LayoutContainer occupationalLeft() {
    ...
    //   
      ...
      cp01.setLayout(new FitLayout());    
      //엣지변환
      //cp01.setSize(320, 280);
      cp01.setSize(320, 330);  
...
//        });  
 ...
 private LayoutContainer payrLeft01() {
	   ...
	   //msfCustomForm.setHeaderVisible(false);
       //Instantiate the GridPanel
	   payr0302ExtpyGridPanel = new MSFGridPanel(payr0302ExtpyDef, false, false, false, false,false);
