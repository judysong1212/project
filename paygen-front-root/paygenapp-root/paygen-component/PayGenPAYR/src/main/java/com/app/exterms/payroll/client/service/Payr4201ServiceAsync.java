...
public interface Payr4201ServiceAsync {
	...
	//일괄정리 부분
	public void activityOnPayr4201Save(Payr0304DTO payr0304Dto, ActionDatabase actionDatabase,  AsyncCallback<Long> callback);
