 ...
 */
public class Payr0440DTO  implements IsSerializable {
    ...
    public Long getUcstSum() {
        return ucstSum;
    }

    public void setUcstSum(Long ucstSum) {
        this.ucstSum = ucstSum;
    }

    public Long getUcstPrntOrd() {
        return ucstPrntOrd;
    }

    public void setUcstPrntOrd(Long ucstPrntOrd) {
        this.ucstPrntOrd = ucstPrntOrd;
    }

    public Boolean getUcstDgmUseYn() {
        return ucstDgmUseYn;
    }

    public void setUcstDgmUseYn(Boolean ucstDgmUseYn) {
