...
@RemoteServiceRelativePath("Payr1400Service.gwt")
public interface Payr1400Service extends RemoteService {
	/**
	 * Utility class for simplifying access to the instance of async service.
	 */
	public static class Util {
		private static Payr1400ServiceAsync instance;
		public static Payr1400ServiceAsync getInstance(){
			if (instance == null) {
				instance = GWT.create(Payr1400Service.class);
			}
			return instance;
		}
	}
