 ...
 */
public class Payr0417DTO  implements Serializable {
    ...
    private Long itemDlySeilNum;

    /** set 직종세단가항목일련번호 : dtilOccuDlySeilNum */
    private Long dtilOccuDlySeilNum;
    ...
    public Long getItemDlySeilNum() {
        return this.itemDlySeilNum;
    }
    
    public void setItemDlySeilNum(Long itemDlySeilNum) {
        this.itemDlySeilNum = itemDlySeilNum;
    }
    
    public Long getDtilOccuDlySeilNum() {
        return this.dtilOccuDlySeilNum;
    }
    
    public void setDtilOccuDlySeilNum(Long dtilOccuDlySeilNum) {
