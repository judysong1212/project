...
@RemoteServiceRelativePath("Payr1500Service.gwt")
public interface Payr1500Service extends RemoteService {
	/**
	 * Utility class for simplifying access to the instance of async service.
	 */
	public static class Util {
		private static Payr1500ServiceAsync instance;
		public static Payr1500ServiceAsync getInstance(){
			if (instance == null) {
				instance = GWT.create(Payr1500Service.class);
			}
			return instance;
		}
	}
