...
public interface Payr1100ServiceAsync {
	
	/** 간이소득세액이관 **/
	public void payr0100Transfer(Payr0100DTO payr0100Dto, AsyncCallback<Long> callback);
	
	/** 간이소득세액 삭제**/
	public void activityOnPayr1100(Payr0100DTO payr0100Dto, ActionDatabase actionDatabase, AsyncCallback<Long> callback);
