 ...
 */
public class Payr0309BM   extends MSFSimpleBaseModel implements IsSerializable   {
    ...
    /** 일괄등록 처리   */
     public Payr0309BM(
    		...
    		, BigDecimal  hlthInsrPayTotAmnt 
    		, BigDecimal  hlthInsrMnthRuntnAmnt 
    		, String  hlthInsrGrde 
    		, String  hlthInsrCertNum 
    		, String  natPennInsurFlucDt 
    		, BigDecimal  natPennStdIncmMnthAmnt 
    		, String  natPennGrde 
    		...
    		, BigDecimal  umytInsrPayTotAmnt 
    		, BigDecimal  umytInsrPayMnthAmnt 
    		, String  idtlAccdtFlucDt 
    		, BigDecimal  idtlAccdtPayTotAmnt 
    		, BigDecimal  idtlAccdtPayMnthAmnt ) { 
    ...
    /** set 건강보험보수총액 : hlthInsrPayTotAmnt */
    public void setHlthInsrPayTotAmnt(BigDecimal  hlthInsrPayTotAmnt) { set( ATTR_HLTHINSRPAYTOTAMNT ,hlthInsrPayTotAmnt);}
    /** get 건강보험보수총액 : hlthInsrPayTotAmnt */
    public BigDecimal  getHlthInsrPayTotAmnt() { return (BigDecimal )get( ATTR_HLTHINSRPAYTOTAMNT );}

    /** set 건강보험보수월액 : hlthInsrMnthRuntnAmnt */
    public void setHlthInsrMnthRuntnAmnt(BigDecimal  hlthInsrMnthRuntnAmnt) { set( ATTR_HLTHINSRMNTHRUNTNAMNT ,hlthInsrMnthRuntnAmnt);}
    /** get 건강보험보수월액 : hlthInsrMnthRuntnAmnt */
    public BigDecimal  getHlthInsrMnthRuntnAmnt() { return (BigDecimal )get( ATTR_HLTHINSRMNTHRUNTNAMNT );}
    ...
    /** set 국민연금기준소득월액 : natPennStdIncmMnthAmnt */
    public void setNatPennStdIncmMnthAmnt(BigDecimal  natPennStdIncmMnthAmnt) { set( ATTR_NATPENNSTDINCMMNTHAMNT ,natPennStdIncmMnthAmnt);}
    /** get 국민연금기준소득월액 : natPennStdIncmMnthAmnt */
    public BigDecimal  getNatPennStdIncmMnthAmnt() { return (BigDecimal )get( ATTR_NATPENNSTDINCMMNTHAMNT );}
    ...
    /** set 고용보험보수총액 : umytInsrPayTotAmnt */
    public void setUmytInsrPayTotAmnt(BigDecimal  umytInsrPayTotAmnt) { set( ATTR_UMYTINSRPAYTOTAMNT ,umytInsrPayTotAmnt);}
    /** get 고용보험보수총액 : umytInsrPayTotAmnt */
    public BigDecimal  getUmytInsrPayTotAmnt() { return (BigDecimal )get( ATTR_UMYTINSRPAYTOTAMNT );}

    /** set 고용보험보수월액 : umytInsrPayMnthAmnt */
    public void setUmytInsrPayMnthAmnt(BigDecimal  umytInsrPayMnthAmnt) { set( ATTR_UMYTINSRPAYMNTHAMNT ,umytInsrPayMnthAmnt);}
    /** get 고용보험보수월액 : umytInsrPayMnthAmnt */
    public BigDecimal  getUmytInsrPayMnthAmnt() { return (BigDecimal )get( ATTR_UMYTINSRPAYMNTHAMNT );}
    ...
    /** set 산재보험보수총액 : idtlAccdtPayTotAmnt */
    public void setIdtlAccdtPayTotAmnt(BigDecimal  idtlAccdtPayTotAmnt) { set( ATTR_IDTLACCDTPAYTOTAMNT ,idtlAccdtPayTotAmnt);}
    /** get 산재보험보수총액 : idtlAccdtPayTotAmnt */
    public BigDecimal  getIdtlAccdtPayTotAmnt() { return (BigDecimal )get( ATTR_IDTLACCDTPAYTOTAMNT );}

    /** set 산재보험보수월액 : idtlAccdtPayMnthAmnt */
    public void setIdtlAccdtPayMnthAmnt(BigDecimal  idtlAccdtPayMnthAmnt) { set( ATTR_IDTLACCDTPAYMNTHAMNT ,idtlAccdtPayMnthAmnt);}
    /** get 산재보험보수월액 : idtlAccdtPayMnthAmnt */
    public BigDecimal  getIdtlAccdtPayMnthAmnt() { return (BigDecimal )get( ATTR_IDTLACCDTPAYMNTHAMNT );}
