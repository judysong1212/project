...
import com.app.exterms.payroll.client.lookup.LookupBass0500PayYr;
import com.app.exterms.payroll.client.service.Payr5300Service;
import com.app.exterms.payroll.client.service.Payr5300ServiceAsync;
...
=====================================================**/
public class Payr5300  extends MSFPanel { 
 ...
 **/
	...
	// 단가표작성년도 사업년도입력에 따라 적용되도록 수정 여기는 상관없음 
	private LookupBass0500PayYr lkApptnYr = new LookupBass0500PayYr();
 ...
 **/
	//입력수정삭제처리 rpc 처리부     
	private Payr5300ServiceAsync payr5300Service = Payr5300Service.Util.getInstance();	 
 ...
 **/ 	
	  ...
	  public Payr5300(String txtForm) {
 ...
 **/	 
	  private void createPayr5300Form() {
			...
			plFrmPayr5300.setHeadingText(PayGenConst.PAYGEN_VERSION.concat(" -  ") + lblPayrConst.title_Payr5300());
		//	plFrmPayr5300.setHeadingText(PayGenConst.PAYGEN_VERSION.concat(" - 지급공제단가관리");
			...
			btnlogView.addListener(Events.Select, new Listener<ButtonEvent>() {
				public void handleEvent(ButtonEvent e) {
					 //로그 뷰화면 호출 메서드 
					  funcLogMessage(lblPayrConst.title_Payr5300(),"PAYR5300");
					}
				});
...
//           });        
	    ...
	    btnTrnrBusin.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				...
				MSFFormWindows msFwPayrP53001 = new MSFFormWindows("이전사업이관", payrP530011Form, "닫기", "800px", "350px", true);
				msFwPayrP53001.show();
