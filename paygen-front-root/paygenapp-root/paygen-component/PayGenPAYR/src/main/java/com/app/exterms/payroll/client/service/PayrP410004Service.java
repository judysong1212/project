...
@RemoteServiceRelativePath("PayrP410004Service.gwt")
public interface PayrP410004Service extends RemoteService {
	/**
	 * Utility class for simplifying access to the instance of async service.
	 */
	public static class Util {
		private static PayrP410004ServiceAsync instance;
		public static PayrP410004ServiceAsync getInstance(){
			if (instance == null) {
				instance = GWT.create(PayrP410004Service.class);
			}
			return instance;
		}
	}
	
	public Long activityOnUpdatePayrP410004Save(List<Payr0500DTO> listPayr0500Dto) throws MSFException;
