...
public class LookupBass0500PayYr extends TableDef implements PayrDaoConstants {
     
    private PayrConstants payYrLabel = PayrConstants.INSTANCE;
    
    public LookupBass0500PayYr(){
    	setTitle(payYrLabel.title_Bass0500PayYr());
    	setDaoClass("");
    	setCustomListMethod(CLASS_BASS0500_PAY_YR); 
    ...
    public LookupBass0500PayYr(String title, Class<?> pojoClass) {
        this();
        setTitle(title);
