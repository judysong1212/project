...
@RemoteServiceRelativePath("Payr1450Service.gwt")
public interface Payr1450Service extends RemoteService {
	/**
	 * Utility class for simplifying access to the instance of async service.
	 */
	public static class Util {
		private static Payr1450ServiceAsync instance;
		public static Payr1450ServiceAsync getInstance(){
			if (instance == null) {
				instance = GWT.create(Payr1450Service.class);
			}
			return instance;
		}
	}
...
//	   public Long activityOnPayr1450Save(List<Payr0470DTO>  listPayr0470dto);
	     
	    
//	   public Long activityOnPayr1450Delete(List<BaseModel> listModels);
