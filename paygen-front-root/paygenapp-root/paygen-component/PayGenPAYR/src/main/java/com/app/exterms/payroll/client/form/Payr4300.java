...
=====================================================**/
public class Payr4300  extends MSFPanel { 
 ...
 **/
	...
	private FormPanel plFrmPayr4300;
	//private FormData formData; 
	private String txtForm = "";
		 
	private Payr0301Def payr0301Def  = new Payr0301Def();   //그리드 테이블 컬럼 define  
...
//	private MSFGridPanel typOccuCdGridPanel;
	 ...
	 */
		...
		// private Button btnPayr4300Save;
		// private Button btnPayr4300Del;
		private Button btnPayr4300Sreach;
		private Button btnPayr4300Print;
 ...
 **/	  
	 ...
	 **/
		 ...
		 */
		private void checkPayr4300Auth(String authAction, ListStore<BaseModel> bm) {
	...
	private void authExecEnabled() {
		...
		// GWTAuthorization.formAuthConfig(plFrmPayr4200,"srhPayrMangDeptCd","srhEmymtDivCd","srhDeptCd","srhTypOccuCd","srhBusinCd");
 ...
 **/
	// 검색 폼 바인딩 처리 함수
	// 화면 폼 바인딩 처리
	private void setPayr4300FormBinding() {
 ...
 **/
	//입력수정삭제처리 rpc 처리부     
	//private Payr4300ServiceAsync payr4300Service = Payr4300Service.Util.getInstance();	  
 ...
 *++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ 
**/
	private void Payr4300Print(String fileName, String repType) {
	...
	private void RexPrint(String fileName) {
		...
		MessageBox.confirm("급여대장", "[YES]버튼을 누르시면 전체내역인 출력됩니다.\n[NO]를 선택하시면 선택하신 데이타에 대해서만 출력됩니다.\n출력하시겠습니까?",new Listener<MessageBoxEvent>(){
            ...
            public void handleEvent(MessageBoxEvent be) {
				...
				// 출력물 디렉토리 패스경로 인사 : PSNL  //  급여대장 : PAYR
				String strDirPath = "PAYR";
				...
				serarchParam += ""+MSFSharedUtils.getSelectedComboValue(srhPayYr01,"payYr") + MSFSharedUtils.getSelectedComboValue(srhPayMonth01,"month") + "⊥";	// parameter2
				serarchParam += ""+MSFSharedUtils.getSelectedComboValue(srhPayYr02,"payYr") + MSFSharedUtils.getSelectedComboValue(srhPayMonth02,"month") + "⊥"; 	// parameter3
				serarchParam += ""+MSFSharedUtils.getSelectedComboValue(srhPayrMangDeptCd,"payrMangDeptCd") +"⊥";	// parameter4
	     		serarchParam += ""+MSFSharedUtils.getSelectedComboValue(srhEmymtDivCd, "commCd") + "⊥"; // parameter5
	     		serarchParam += ""+MSFSharedUtils.getSelectedComboValue(srhPayCd,"commCd") + "⊥";    				// parameter6
	     		//20151212-추가 시작 
			    if (payrMangDeptCd.equals(deptCdAuth)) { 
			    	serarchParam += "⊥"; //parameter7
	            } else {
	            	serarchParam += ""+ PayrUtils.getPrintStrToMultiData(lsDeptCd,MSFSharedUtils.allowNulls(srhDeptCd.getValue()),"deptNmRtchnt","deptCd")+"⊥"; //parameter7
	            }  
			    //20151212-추가 끝			    
	     		serarchParam += ""+PayrUtils.getPrintStrToMultiData(lsTypOccuCd,MSFSharedUtils.allowNulls(srhTypOccuCd.getValue()),"typOccuNm","typOccuCd") + "⊥"; 	// parameter8
//	     		serarchParam += ""+PayrUtils.getPrintStrToMultiData(lsTypOccuCd,MSFSharedUtils.allowNulls(srhTypOccuCd.getValue()),"typOccuNm","pyspGrdeCd") + "⊥";	// 호봉등급 안쓰므로 주석
	     		serarchParam += ""+PayrUtils.getPrintStrToMultiData(lsDtilOccuInttnCd,MSFSharedUtils.allowNulls(srhDtilOccuInttnCd.getValue()),"dtilOccuClsNm","dtilOccuInttnCd") + "⊥";	// parameter9
	     		serarchParam += ""+MSFSharedUtils.getSelectedComboValue(srhBusinCd,"businCd")+"⊥";   				// parameter10
...
//	     				System.out.println("체크값 : " + checkedSystemKeys);
	     		...
	     		serarchParam = serarchParam+""+checkedSystemKeys+"⊥"; //parameter11
        
	     		
//	     		//TODO 확인 
//	     		if ("Y".equals(MSFMainApp.get().getUser().getPayrMangDeptYn())) {
//	     			serarchParam += "⊥";	// parameter12
//	     			serarchParam +=""+MSFMainApp.get().getUser().getPayrMangDeptYn() + "⊥"; // parameter13
//	     		} else {
//            
...
//	     		}
				...
				serarchParam += ""+repbtyBusinDivCd+"⊥"; //parameter17
...
//	private void Payr4300Print(String fileName) {
//  
//	    // mrd 출력물
//        rdaFileName = fileName+".mrd";
//        // 보낼 파라미터
...
//            serarchParam += "["+MSFSharedUtils.getSelectedComboValue(srhEmymtDivCd,"commCd")+"]";    //$5
//            serarchParam += "["+MSFSharedUtils.getSelectedComboValue(srhPayCd,"commCd")+"]";    //$6
//            serarchParam += "["+ PayrUtils.getPrintStrToMultiData(lsDeptCd,MSFSharedUtils.allowNulls(srhDeptCd.getValue()),"deptNmRtchnt","deptCd")+"]";
//            serarchParam += "["+ PayrUtils.getPrintStrToMultiData(lsTypOccuCd,MSFSharedUtils.allowNulls(srhTypOccuCd.getValue()),"typOccuNm","typOccuCd")+"]";//$8
...
//                        }
//                        
//                        checkedSystemKeys = chkkey.substring(0,chkkey.length()-1); //$12
//                        
//                    }
//                }
//                
...
//	    vp.setSpacing(10);
//	    createPayr4300Form();  //화면 기본정보를 설정
 ...
 **/ 	
	...
	public Payr4300(String txtForm) {
 ...
 **/	
	...
	private void createPayr4300Form() {
		  
		plFrmPayr4300 = new FormPanel();
		plFrmPayr4300.setHeadingText(PayGenConst.PAYGEN_VERSION.concat(" -  " + lblPayrConst.title_Payr4300()));
		//plFrmPayr4300.setHeadingText(PayGenConst.PAYGEN_VERSION.concat(" - 급여대장");
		plFrmPayr4300.setIcon(MSFMainApp.ICONS.text());
		plFrmPayr4300.setBodyStyleName("pad-text");
		plFrmPayr4300.setPadding(2);
		plFrmPayr4300.setFrame(true);  
		...
		btnlogView.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				 //로그 뷰화면 호출 메서드 
				  funcLogMessage(lblPayrConst.title_Payr4300(),"PAYR4300");
				}
			});
		plFrmPayr4300.getHeader().setStyleAttribute("padding", "5px 0 2px 0");
		plFrmPayr4300.getHeader().addTool(btnlogView); 
		/************************************************************************
		 * 화면 에러 처리시 필요한 부분으로 추가 
		 ************************************************************************/

		 //멀티콤보박스 닫기 
		plFrmPayr4300.addListener(Events.OnClick,new Listener<ComponentEvent>() { 
			@Override
...
//                    }
		...
		topPayr4300Bar = new ButtonBar();    
		topPayr4300Bar.setAlignment(HorizontalAlignment.RIGHT); 
	  
		btnPayr4300Init = new Button("초기화");  
		btnPayr4300Init.setIcon(MSFMainApp.ICONS.new16());
		topPayr4300Bar.add(btnPayr4300Init);
		btnPayr4300Init.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				//초기화 
				formInit();
			}
...
//		  	buttonBar.add(topBtn);
		...
		btnPayr4300Sreach = new Button("조회"); 
		btnPayr4300Sreach.setIcon(MSFMainApp.ICONS.search16());
		topPayr4300Bar.add(btnPayr4300Sreach);
		btnPayr4300Sreach.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				//조회버튼 클릭시 처리 
				reload();  
			}
		...
		btnPayr4300Print = new Button("인쇄"); 
		btnPayr4300Print.setIcon(MSFMainApp.ICONS.print16()); 
		topPayr4300Bar.add(btnPayr4300Print); 
//		  	btnPayr4300Print.addListener(Events.Select, new Listener<ButtonEvent>() {
//	    		public void handleEvent(ButtonEvent e) {
//	    			//Print버튼 클릭시 처리 
...
//	    	});
	  	btnPayr4300Print.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				...
				if(MSFSharedUtils.getSelectedComboValue(srhEmymtDivCd,"commCd") == null || "".equals(MSFSharedUtils.getSelectedComboValue(srhEmymtDivCd,"commCd"))) {
					 MessageBox.alert("확인", "고용구분을 선택해주세요.", null);
					 return;	
				}else {
					
				}
				
				Payr4300Print(printType, MSFMainApp.getMsg("PayGen.ReportDivisionType"));
				
			}
		});
	  	
		plFrmPayr4300.add(topPayr4300Bar);

		vp.add(plFrmPayr4300);
		plFrmPayr4300.setSize("990px", "680px");
  ...
  */
   ...
   */
		...
		payYrGridPanel.getGrid().addListener(Events.ViewReady, new Listener<ComponentEvent>() {  
  		...
  		plFrmPayr4300.add(payYrGrid);  
	  
	    plFrmPayr4300.setLayout(new FlowLayout());
       ...
       // srhPayYr01.setEmptyText("--년도선택--");
        ...
        lsPayYrStore01.addStoreListener(new StoreListener<BaseModel>() { 
            @Override
            public void storeAdd(StoreEvent<BaseModel> se) {
            	
            	checkPayr4300Auth("srhPayYr01", lsPayYrStore01); 
      ...
      //srhPayMonth01.setEmptyText("--월선택--");
        ...
        lsPayMonth01.addStoreListener(new StoreListener<BaseModel>() { 
            ...
            public void storeAdd(StoreEvent<BaseModel> se) {
            	...
            	checkPayr4300Auth("srhPayMonth01", lsPayMonth01); 
        ...
        lsPayYrStore02.addStoreListener(new StoreListener<BaseModel>() { 
            @Override
            public void storeAdd(StoreEvent<BaseModel> se) {
            	
            	checkPayr4300Auth("srhPayYr02", lsPayYrStore02); 
      ...
      //srhPayMonth02.setEmptyText("--월선택--");
        ...
        lsPayMonth02.addStoreListener(new StoreListener<BaseModel>() { 
            ...
            public void storeAdd(StoreEvent<BaseModel> se) {
            	...
            	checkPayr4300Auth("srhPayMonth02", lsPayMonth02); 
            ...
            public void handleEvent(StoreEvent<BaseModel> be) {  
            	...
            	if (type == Store.Add) { 
            		 ...
            		 * "srhPayrMangDeptCd","srhEmymtDivCd","srhDeptCd","srhTypOccuCd","srhBusinCd"
						++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++*/ 
            			checkPayr4300Auth("srhPayrMangDeptCd", lsPayrMangDeptCd); 
               	 }
            }
        }); 
	    ...
	    lsEmymtDivCd.addStoreListener( new StoreListener<BaseModel>() {   
	    	public void handleEvent(StoreEvent<BaseModel> be) {  
	    		...
	    		if (type == Store.Add) { 
               		  ...
               		  * "srhPayrMangDeptCd","srhEmymtDivCd","srhDeptCd","srhTypOccuCd","srhBusinCd"
						++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++*/ 
	    				checkPayr4300Auth("srhEmymtDivCd", lsEmymtDivCd ); 
	    		}      
            }
        });    
        ...
        srhDeptCd.getStore().addStoreListener( new StoreListener<ModelData>() {   
            public void handleEvent(StoreEvent<ModelData> be) {  
            	...
            	if (type == Store.Add) { 
               		  ...
               		  * "srhPayrMangDeptCd","srhEmymtDivCd","srhDeptCd","srhTypOccuCd","srhBusinCd"
						++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++*/ 
            			checkPayr4300Auth("srhDeptCd", lsDeptCd); 
            	}
            }
        });    
        ...
        srhTypOccuCd.getStore().addStoreListener( new StoreListener<ModelData>() {   
        	public void handleEvent(StoreEvent<ModelData> be) {  
        		...
        		if (type == Store.Add) { 
        			 ...
        			 * "srhPayrMangDeptCd","srhEmymtDivCd","srhDeptCd","srhTypOccuCd","srhBusinCd"
		    			++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++*/ 
		                	//checkPayr4300Auth("srhTypOccuCd", lsTypOccuCd); 
               	 }
            }
        });     
...
//        srhDtilOccuInttnCd.setHideLabel(true);
	    ...
	    srhPayCd.getStore().addStoreListener( new StoreListener<BaseModel>() {   
            public void handleEvent(StoreEvent<BaseModel> be) {  
            	checkPayr4300Auth("srhPayCd", lsPayCd); 
            }
        }); 
	   ...
	   // srhResnRegnNum.setFieldLabel("주민번호");
	    layoutContainer_5.add(layoutContainer_7,new com.extjs.gxt.ui.client.widget.layout.ColumnData(.40)); 
       ...
       LayoutContainer layoutContainer_4 = new LayoutContainer();
	    ...
	    layoutContainer_3.add(layoutContainer_14,new com.extjs.gxt.ui.client.widget.layout.ColumnData(.3));
	    layoutContainer_3.add(layoutContainer_5,new com.extjs.gxt.ui.client.widget.layout.ColumnData(.27));
	    layoutContainer_3.add(layoutContainer_4,new com.extjs.gxt.ui.client.widget.layout.ColumnData(.43));
 ...
 **/   
   ...
   **/ 	 
	private void createCheckBoxGrid() {   
		...
		outputTypeRadiogroup.setStyleAttribute("marginTop", "5px");

		Radio rdRadio = new Radio();
		rdRadio.setValue(true);
		outputTypeRadiogroup.add(rdRadio);
		rdRadio.setBoxLabel("지급명세서(부서별)");
		rdRadio.setHideLabel(true);
		rdRadio.setValueAttribute("PAYRT4300");

		rdRadio = new Radio();
		outputTypeRadiogroup.add(rdRadio);
		rdRadio.setBoxLabel("지급명세서(개인별)");
		rdRadio.setHideLabel(true);
		rdRadio.setValueAttribute("PAYRT4301"); 
	    
	    rdRadio = new Radio();
	    outputTypeRadiogroup.add(rdRadio);
	    rdRadio.setBoxLabel("지급명세서(월별)");
	    rdRadio.setHideLabel(true);
	    rdRadio.setValueAttribute("PAYRT4302"); 
	    
	    rdRadio = new Radio();
	    outputTypeRadiogroup.add(rdRadio);
	    rdRadio.setBoxLabel("지급명세서(개인)");
	    rdRadio.setHideLabel(true);
	    rdRadio.setValueAttribute("PAYRT4303"); 
	    
	    rdRadio = new Radio();
	    outputTypeRadiogroup.add(rdRadio);
	    rdRadio.setBoxLabel("지급명세서총괄(부서)");
	    rdRadio.setHideLabel(true);
	    rdRadio.setValueAttribute("PAYRT4304"); 
	    
	    rdRadio = new Radio();
	    outputTypeRadiogroup.add(rdRadio);
	    rdRadio.setBoxLabel("지급명세서총괄(개인)");
	    rdRadio.setHideLabel(true);
	    rdRadio.setValueAttribute("PAYRT4305"); 
   ...
   **/ 	  
	...
	public void reload() {
		...
		payr0301GridPanel.getTableDef().addColumnFilter("pymtYrMnth01", (MSFSharedUtils.getSelectedComboValue(srhPayYr01,"payYr")+ MSFSharedUtils.getSelectedComboValue(srhPayMonth01,"month")), SimpleColumnFilter.OPERATOR_EQUALS); 
		payr0301GridPanel.getTableDef().addColumnFilter("pymtYrMnth02", (MSFSharedUtils.getSelectedComboValue(srhPayYr02,"payYr")+ MSFSharedUtils.getSelectedComboValue(srhPayMonth02,"month")), SimpleColumnFilter.OPERATOR_EQUALS); 
		payr0301GridPanel.getTableDef().addColumnFilter("payrMangDeptCd", MSFSharedUtils.getSelectedComboValue(srhPayrMangDeptCd,"payrMangDeptCd"), SimpleColumnFilter.OPERATOR_EQUALS);
		payr0301GridPanel.getTableDef().addColumnFilter("emymtDivCd", MSFSharedUtils.getSelectedComboValue(srhEmymtDivCd,"commCd"), SimpleColumnFilter.OPERATOR_EQUALS); 
		payr0301GridPanel.getTableDef().addColumnFilter("payCd", MSFSharedUtils.getSelectedComboValue(srhPayCd,"commCd"), SimpleColumnFilter.OPERATOR_EQUALS); 
			
		//20180305추가 
		payr0301GridPanel.getTableDef().addColumnFilter("mangeDeptCd", MSFSharedUtils.getSelectedComboValue(srhMangeDeptCd,"mangeDeptCd"), SimpleColumnFilter.OPERATOR_EQUALS); 
		payr0301GridPanel.getTableDef().addColumnFilter("repbtyBusinDivCd", MSFSharedUtils.getSelectedComboValue(srhRepbtyBusinDivCd,"commCd"), SimpleColumnFilter.OPERATOR_EQUALS); 	
		
		String strDeptCd = PayrUtils.getStrValToBMMultiCombo(lsDeptCd,srhDeptCd.getValue(),"deptNmRtchnt","deptCd");  
		payr0301GridPanel.getTableDef().addColumnFilter("deptCd", strDeptCd , SimpleColumnFilter.OPERATOR_EQUALS);
           
        String strTypOccuCd = PayrUtils.getStrValToBMMultiCombo(lsTypOccuCd,srhTypOccuCd.getValue(),"typOccuNm","typOccuCd"); 
        payr0301GridPanel.getTableDef().addColumnFilter("typOccuCd", strTypOccuCd, SimpleColumnFilter.OPERATOR_EQUALS); 
		...
		payr0301GridPanel.getTableDef().addColumnFilter("businCd", MSFSharedUtils.getSelectedComboValue(srhBusinCd,"businCd"), SimpleColumnFilter.OPERATOR_EQUALS);  
		payr0301GridPanel.getTableDef().addColumnFilter("systemkey", MSFSharedUtils.allowNulls(srhSystemkey.getValue()), SimpleColumnFilter.OPERATOR_EQUALS); 
		payr0301GridPanel.getTableDef().addColumnFilter("hanNm", MSFSharedUtils.allowNulls(srhHanNm.getValue()), SimpleColumnFilter.OPERATOR_EQUALS);    
		payr0301GridPanel.getTableDef().addColumnFilter("resnRegnNum", MSFSharedUtils.allowNulls(srhResnRegnNum.getValue()), SimpleColumnFilter.OPERATOR_EQUALS);   
