...
import com.app.exterms.payroll.client.dto.Bass0500DTO;
...
@Service("Payr5270Service")
public class Payr5270ServiceImpl extends AbstractCustomServiceImpl implements Payr5270Service , PayrDaoConstants {
	
	private static final Logger logger = LoggerFactory.getLogger(Payr5270ServiceImpl.class);
	private static final String calledClass = Payr5270ServiceImpl.class.getName();
	...
	public PagingLoadResult<BaseModel> getPayr5270ToBass0500DataList(ServiceParameters serviceParameters) throws Exception {

        PagingLoadResult<BaseModel> retval = null;
        String method =  CLASS_PAYR5270TOBASS0500_LIST;
	...
	public String saveBass0500(Bass0500DTO dto, ActionDatabase actionDatabase) throws Exception {
		...
		try {
			switch(actionDatabase){
				case INSERT :
					//returnCnt = bass0500DAO.saveBass0500(dto);
					break;
				case UPDATE : 
					//returnCnt = bass0500DAO.saveBass0500(dto);
					break;
				case DELETE :
					//returnCnt = bass0500DAO.deleteBass0500(dto);
					break;
			}
