...
public interface Payr5100ServiceAsync {
	public void activityOnPayr5100Insert(Payr0420DTO   payr0420Dto,List<BaseModel> listModels, ActionDatabase actionDatabase, AsyncCallback<Long> callback);
