...
import com.app.exterms.payroll.client.service.Payr1300ServiceAsync;
...
=====================================================**/
public class Payr1300  extends MSFPanel { 
 ...
 **/
	 ...
	 // private FormData formData; 
	  ...
	  private Payr0480Def payr0480Def  = new Payr0480Def();   //그리드 테이블 컬럼 define  
 ...
 *++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ 
 **/
	    private Payr1300ServiceAsync payr1300Service = Payr1300Service.Util.getInstance();  
	   //공통 코드  
...
//	      if (isValid()) {
	        ...
	        MessageBox.confirm("저장", "데이터를 저장하시겠습니까?",new Listener<MessageBoxEvent>(){
                ...
                public void handleEvent(MessageBoxEvent be) {
                   // if("Yes".equals(be.getButtonClicked().getText())){
                	if(Dialog.YES.equals(be.getButtonClicked().getItemId())){
                            ...
                            List<Payr0480DTO> listPayr0480dto = new ArrayList<Payr0480DTO>();  
                ...
                //                setRevnAddr(revnAddr)    /** column 수정주소 : revnAddr */ 
                	        ...
                	        payr1300Service.activityOnPayr1300Save(listPayr0480dto ,  
                    ...
                    public void handleEvent(MessageBoxEvent be) {
                       // if("Yes".equals(be.getButtonClicked().getText())){
                    	if(Dialog.YES.equals(be.getButtonClicked().getItemId())){
                            ...
                            payr1300Service.activityOnPayr1300Delete(payr0480GridPanel.getGrid().getSelectionModel().getSelectedItems() , new AsyncCallback<Long>() {
 ...
 **/ 	
		  ...
		  public Payr1300(String txtForm) {
 ...
 **/	  
		  private void createPayr1300Form() {
				...
				plFrmPayr1300.setHeadingText(PayGenConst.PAYGEN_VERSION.concat(" -  ") + lblPayrConst.title_Payr1300());
				...
				btnlogView.addListener(Events.Select, new Listener<ButtonEvent>() {
					public void handleEvent(ButtonEvent e) {
						 //로그 뷰화면 호출 메서드 
						  funcLogMessage(lblPayrConst.title_Payr1300(),"PAYR1300");
						}
					});
