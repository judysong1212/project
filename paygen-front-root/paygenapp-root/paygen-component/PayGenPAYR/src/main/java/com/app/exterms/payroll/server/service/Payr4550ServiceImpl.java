...
import com.app.exterms.payroll.client.service.Payr4550Service;
...
@Service("Payr4550Service")
public class Payr4550ServiceImpl extends AbstractCustomServiceImpl implements Payr4550Service ,PayrDaoConstants {

	private static final Logger logger = LoggerFactory.getLogger(Payr4550ServiceImpl.class);
	private static final String calledClass = Payr4550ServiceImpl.class.getName();
	...
	public PagingLoadResult<BaseModel> getSelectPayr4550List(ServiceParameters serviceParameters) throws MSFException {

        PagingLoadResult<BaseModel> retval = null;
        String method =  CLASS_PAYR4550_DAO_LIST;
...
//    	String nResult = AnyCryptUtils.XecureCryptInitialize(RemoteServiceUtil.getThreadLocalConfig(),RemoteServiceUtil.getThreadLocalRequest());
        ...
        try {
           ...
           // Sysm0100BM          user             = serviceParameters.getUser();
            ...
            payr0301SrhVO.setPayYr(MSFSharedUtils.allowNulls(MSFServerUtils.getFilterValue(columnFilters, "payYr"))); //지급년  
...
//            payr0301SrhVO.setPyspGrdeCd(MSFSharedUtils.allowNulls(MSFServerUtils.getFilterValue(columnFilters, "pyspGrdeCd"))); //호봉등급코드
            ...
            //Get total record count //전체 데이터 갯수를 가지고 온다. 
	         if ( pagingValues.executeRecordCount ) { 
                ...
                int iResultCnt = payr0301DAO.selectPayr03014550ListTotCnt(payr0301SrhVO);  
...
//            Collection<Map<String, Object>> list ??????
            List list = payr0301DAO.selectPayr03014550List(payr0301SrhVO);
