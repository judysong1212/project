...
@RemoteServiceRelativePath("Payr5300Service.gwt")
public interface Payr5300Service extends RemoteService {
	/**
	 * Utility class for simplifying access to the instance of async service.
	 */
	public static class Util {
		private static Payr5300ServiceAsync instance;
		public static Payr5300ServiceAsync getInstance(){
			if (instance == null) {
				instance = GWT.create(Payr5300Service.class);
			}
			return instance;
		}
	}
