...
import com.app.exterms.payroll.client.service.Payr4300Service;
...
@Service("Payr4300Service")
public class Payr4300ServiceImpl extends AbstractCustomServiceImpl implements Payr4300Service  ,PayrDaoConstants {
	 
	private static final Logger logger = LoggerFactory.getLogger(Payr4300ServiceImpl.class);
	private static final String calledClass = Payr4300ServiceImpl.class.getName();
	...
	public PagingLoadResult<BaseModel> getPayr0301DataList(ServiceParameters serviceParameters) throws MSFException {

        PagingLoadResult<BaseModel> retval = null;
        String method =  CLASS_PAYR0301_DATA_LIST;
...
//    	String nResult = AnyCryptUtils.XecureCryptInitialize(RemoteServiceUtil.getThreadLocalConfig(),RemoteServiceUtil.getThreadLocalRequest());
        ...
        try {
           ...
           // Sysm0100BM          user             = serviceParameters.getUser();
            ...
            payr0301SrhVO.setPymtYrMnth01(MSFSharedUtils.allowNulls(MSFServerUtils.getFilterValue(columnFilters, "pymtYrMnth01"))); //지급년 
            payr0301SrhVO.setPymtYrMnth02(MSFSharedUtils.allowNulls(MSFServerUtils.getFilterValue(columnFilters, "pymtYrMnth02"))); //지급년 
...
//            payr0301SrhVO.setPyspGrdeCd(MSFSharedUtils.allowNulls(MSFServerUtils.getFilterValue(columnFilters, "pyspGrdeCd"))); //호봉등급코드
            ...
            //Get total record count //전체 데이터 갯수를 가지고 온다. 
	         if ( pagingValues.executeRecordCount ) { 
                ...
                int iResultCnt = payr0301DAO.selectPayr0301ListTotCnt(payr0301SrhVO);  
            ...
            TimingInfo millisBeginPayr0301DataList = SmrmfUtils.startTiming(logger);
...
//            Collection<Map<String, Object>> list ??????
            List list = payr0301DAO.selectPayr0301List(payr0301SrhVO);
            ...
            SmrmfUtils.endTiming(logger, millisBeginPayr0301DataList, "getPayr0301DataList");
