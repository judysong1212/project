...
=====================================================**/
public  class PayrP410003   extends MSFFormPanel {  
...
//		}
	 ...
	 **/ 		    
	  ...
	  public PayrP410003(final ActionDatabase actionDatabase, final MSFPanel caller) {
		  ...
		  //cpPayr4101.setSize("810px", "710px");  
			...
			this.setSize("510px", "350px");  //setSize("790px", "610px");  
	  } 
...
//		layoutContainer_34.setBorders(false);
		...
		cp01.addButton(new Button("저장", new SelectionListener<ButtonEvent>() {
			...
			public void componentSelected(ButtonEvent ce) {
				...
				infcPsnl0115Dto.setFamyResnRegnNum(famyResnRegnNum.getValue());    									/** column 가족주민등록번호 : famyResnRegnNum */
				...
				infcPsnl0115Service.insertOnPsnl0115(infcPsnl0115Dto, actionDatabase, new AsyncCallback<Long>() {
					...
					public void onFailure(Throwable caught) {
						MessageBox.alert(
										MSFMainApp.MSFCONSTANTS.ExceptionTitleService()
...
//				infcPsnl0115Dto.setFamySeilNum(psnl0115Dto.getFamySeilNum());    /** column 가족일련번호 : famySeilNum */

//				infcPsnl0115Dto.setYoobhMnthDay(psnl0115Dto.getYoobhMnthDay());    /** column 생년월일 : yoobhMnthDay */
//				infcPsnl0115Dto.setSclcDivCd(psnl0115Dto.getSclcDivCd());    /** column 음양구분코드 : sclcDivCd */
//				psnl0115Vo.setAcadAbtyDivCd(psnl0115Dto.getAcadAbtyDivCd());    /** column 학력구분코드 : acadAbtyDivCd */
//				psnl0115Vo.setSchlNm(psnl0115Dto.getSchlNm());    /** column 학교명 : schlNm */
//				psnl0115Vo.setCrrCd(psnl0115Dto.getCrrCd());    /** column 직업명 : crrCd */
//				psnl0115Vo.setWkOfcNm(psnl0115Dto.getWkOfcNm());    /** column 직장명 : wkOfcNm */
//				psnl0115Vo.setInbyNm(psnl0115Dto.getInbyNm());    /** column 직위명 : inbyNm */

//				psnl0115Vo.setFamyPartNoteCtnt(psnl0115Dto.getFamyPartNoteCtnt());    /** column 가족사항비고내용 : famyPartNoteCtnt */
//				psnl0115Vo.setNatnCd(psnl0115Dto.getNatnCd());    /** column 국가코드 : natnCd */
//				psnl0115Vo.setFamyChbttYn(psnl0115Dto.getFamyChbttYn());    /** column 가족동거여부 : famyChbttYn */
//				psnl0115Vo.setFamyAllwYn(psnl0115Dto.getFamyAllwYn());    /** column 가족수당여부 : famyAllwYn */
//				psnl0115Vo.setSchlExpnAdmclYn(psnl0115Dto.getSchlExpnAdmclYn());    /** column 학비보조여부 : schlExpnAdmclYn */
//				psnl0115Vo.setYrtxYn(psnl0115Dto.getYrtxYn());    /** column 연말정산여부 : yrtxYn */
//				psnl0115Vo.setKybdr(psnl0115Dto.getKybdr());    /** column 입력자 : kybdr */
//				psnl0115Vo.setInptDt(psnl0115Dto.getInptDt());    /** column 입력일자 : inptDt */
//				psnl0115Vo.setInptAddr(psnl0115Dto.getInptAddr());    /** column 입력주소 : inptAddr */
//				psnl0115Vo.setIsmt(psnl0115Dto.getIsmt());    /** column 수정자 : ismt */
//				psnl0115Vo.setRevnDt(psnl0115Dto.getRevnDt());    /** column 수정일자 : revnDt */
//				psnl0115Vo.setRevnAddr(psnl0115Dto.getRevnAddr());    /** column 수정주소 : revnAddr */
