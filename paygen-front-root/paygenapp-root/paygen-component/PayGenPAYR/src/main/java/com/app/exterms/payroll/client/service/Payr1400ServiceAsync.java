...
public interface Payr1400ServiceAsync {
	public void activityOnPayr1400Save(List<Payr0470DTO>  listPayr0470dto, AsyncCallback<Long> callback);
	     
	    
	   public void activityOnPayr1400Delete(List<BaseModel> listModels, AsyncCallback<Long> callback);
