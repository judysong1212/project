...
@RemoteServiceRelativePath("Payr1200Service.gwt")
public interface Payr1200Service extends RemoteService {
	/**
	 * Utility class for simplifying access to the instance of async service.
	 */
	public static class Util {
		private static Payr1200ServiceAsync instance;
		public static Payr1200ServiceAsync getInstance(){
			if (instance == null) {
				instance = GWT.create(Payr1200Service.class);
			}
			return instance;
		}
	}
	...
	public Long activityOnPayr0400Insert(List<BaseModel> listModels, ActionDatabase actionDatabase);
	
	//public Long activityOnPayr0400InsertCheck(List<BaseModel> listModels, ActionDatabase actionDatabase);
	
    public Long activityOnPayr0400Save(Payr0400DTO payr0400Dto, ActionDatabase actionDatabase);
     
    public Long createPyspLogSvcYrNumCd(Payr0400DTO payr0400Dto);
	  
    public Long deletePayr0430(List<BaseModel> listModels);
