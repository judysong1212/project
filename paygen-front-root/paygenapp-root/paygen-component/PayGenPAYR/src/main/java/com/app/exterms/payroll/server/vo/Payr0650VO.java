 ...
 * @since 2014.07.11
 */
public class Payr0650VO implements Serializable {
    ...
    /**
     * DIL_WRKR_INCM_BLGG_QATR_DIV_NM :: 일용근로소득귀속분기
     */
    private String dilWrkrIncmBlggQatrDivNm;
    ...
    public String aimenrRoadNmAddr;

    public String deptCd;

    public String businCd;

    public String payrMangDeptCd;
    ...
    public String getDilWrkrIncmBlggQatrDivNm() {
        return dilWrkrIncmBlggQatrDivNm;
    }

    public void setDilWrkrIncmBlggQatrDivNm(String dilWrkrIncmBlggQatrDivNm) {
        this.dilWrkrIncmBlggQatrDivNm = dilWrkrIncmBlggQatrDivNm;
    }
    ...
    public String getAimenrRoadNmAddr() {
        return aimenrRoadNmAddr;
    }

    public void setAimenrRoadNmAddr(String aimenrRoadNmAddr) {
        this.aimenrRoadNmAddr = aimenrRoadNmAddr;
    }
