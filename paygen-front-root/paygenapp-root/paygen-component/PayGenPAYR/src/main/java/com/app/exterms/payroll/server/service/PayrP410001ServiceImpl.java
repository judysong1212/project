...
import com.app.exterms.payroll.client.service.PayrP410001Service;
...
@Service("PayrP410001Service")
public class PayrP410001ServiceImpl extends AbstractCustomServiceImpl implements PayrP410001Service  ,PayrDaoConstants {  
	 
	private static final Logger logger = LoggerFactory.getLogger(PayrP410001ServiceImpl.class);
	private static final String calledClass = PayrP410001ServiceImpl.class.getName();
	...
	public PagingLoadResult<BaseModel> getPayr0304ToPayrP410001DataList(ServiceParameters serviceParameters) throws MSFException {

        PagingLoadResult<BaseModel> retval = null;
        String method =  CLASS_PAYR0304TOP410001_DATA_LIST;
           ...
           // Sysm0250BM          user             = serviceParameters.getUser();
            ...
            //Get total record count //전체 데이터 갯수를 가지고 온다. 
	         if ( pagingValues.executeRecordCount ) { 
                ...
                int iResultCnt = payr0304DAO.selectPayr0304ToPayrP410001ListTotCnt(payr0304SrhVO);  
            ...
            TimingInfo millisBeginPayr0304ToPayrP410001DataList = SmrmfUtils.startTiming(logger);
...
//            Collection<Map<String, Object>> list ??????
            List list = payr0304DAO.selectPayr0304ToPayrP410001List(payr0304SrhVO);
...
//                    }
            ...
            SmrmfUtils.endTiming(logger, millisBeginPayr0304ToPayrP410001DataList, "getPayr0304ToPayrP410001DataList");
