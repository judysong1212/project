...
@Service("Payr4200Service")
public class Payr4200ServiceImpl extends AbstractCustomServiceImpl implements Payr4200Service  ,PayrDaoConstants {

	private static final Logger logger = LoggerFactory.getLogger(Payr4200ServiceImpl.class);
	private static final String calledClass = Payr4200ServiceImpl.class.getName();
