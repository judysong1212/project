 ...
 */
public class Payr0445DTO  implements IsSerializable {
    ...
    private Long mnthUsalyAmntWag;

    /** set 월통상임금상여금액 : mnthUsalyAmntAllwBnusSum */
    private Long mnthUsalyAmntAllwBnusSum;

    /** set 통상임금일급액 : usalyAmntPdyQnty */
    private Long usalyAmntPdyQnty;

    /** set 통상임금시급액 : usalyAmntHrwgQnty */
    private Long usalyAmntHrwgQnty;
    ...
    public Long getMnthUsalyAmntWag() {
        return this.mnthUsalyAmntWag;
    }
    
    public void setMnthUsalyAmntWag(Long mnthUsalyAmntWag) {
        this.mnthUsalyAmntWag = mnthUsalyAmntWag;
    }
    
    public Long getMnthUsalyAmntAllwBnusSum() {
        return this.mnthUsalyAmntAllwBnusSum;
    }
    
    public void setMnthUsalyAmntAllwBnusSum(Long mnthUsalyAmntAllwBnusSum) {
        this.mnthUsalyAmntAllwBnusSum = mnthUsalyAmntAllwBnusSum;
    }
    
    public Long getUsalyAmntPdyQnty() {
        return this.usalyAmntPdyQnty;
    }
    
    public void setUsalyAmntPdyQnty(Long usalyAmntPdyQnty) {
        this.usalyAmntPdyQnty = usalyAmntPdyQnty;
    }
    
    public Long getUsalyAmntHrwgQnty() {
        return this.usalyAmntHrwgQnty;
    }
    
    public void setUsalyAmntHrwgQnty(Long usalyAmntHrwgQnty) {
