...
public interface Payr5500ServiceAsync {
	public void activityOnPayr5500(List<Payr0460DTO> listPayr0460dto, ActionDatabase actionDatabase, AsyncCallback<Long> callback);
