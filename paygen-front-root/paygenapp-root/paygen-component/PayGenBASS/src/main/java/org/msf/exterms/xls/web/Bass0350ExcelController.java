...
@Controller
public class Bass0350ExcelController {
	private static final Logger logger = LoggerFactory.getLogger(Bass0350ExcelController.class);  
    private static final String calledClass = Bass0350ExcelController.class.getName();
    
    @Resource(name = "bass0350ExcelService")
    private Bass0350ExcelService bass0350ExcelService;
     ...
     * @throws Exception
     */
    @RequestMapping(value="/exp/XlsFileBass0350Export.do")
    public ModelAndView xlsFileBass0350Export(@ModelAttribute("Bass0350SrhVO") Bass0350SrhVO bass0350SrhVo, HttpServletRequest request ,ModelMap model) 
    	...
    	return new ModelAndView("bass0350ExcelView", map);
    }
     ...
     */
    @RequestMapping(value = "/imp/XlsReadBass0350Import.do", method = RequestMethod.POST)
