...
@Service("bass0320ExcelService")
public class Bass0320ExcelServiceImpl extends AbstractServiceImpl implements Bass0320ExcelService  {

	private static final Logger logger = LoggerFactory.getLogger(Bass0320ExcelServiceImpl.class);
	private static final String calledClass = Bass0320ExcelService.class.getName();
