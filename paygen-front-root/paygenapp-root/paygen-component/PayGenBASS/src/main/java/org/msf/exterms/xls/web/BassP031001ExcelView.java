...
public class BassP031001ExcelView extends AbstractExcelView{
	/**
	 * 엑셀파일을 설정하고 생성한다.
	 * @param model
	 * @param wb
	...
	protected void buildExcelDocument(Map<String, Object> model,
		...
		String xlsRelatvieFilepath = realPath.concat("/".concat(globals.get("PayGen.XLSTemplateLink")).concat("/BASS/XLS_BASSP031001.xls"));
		
		String destFileName = "휴가일수일괄업로드양식".concat(rndName);
