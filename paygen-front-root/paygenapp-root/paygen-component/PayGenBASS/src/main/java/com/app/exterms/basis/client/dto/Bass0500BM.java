...
public class Bass0500BM extends MSFSimpleBaseModel implements IsSerializable {
	...
	public static final String DILNLAZ_TM_RST_DUTY_TM = "dilnlazTmRstDutyTm";
	...
	//개발_시간외근무 최대 인정시간_20201026
	public void setDilazTmRstDutyTm(String dilnlazTmRstDutyTm) {
		set(DILNLAZ_TM_RST_DUTY_TM, dilnlazTmRstDutyTm);
	}

	public String getDilazTmRstDutyTm() {
		return (String) get(DILNLAZ_TM_RST_DUTY_TM);
	}
