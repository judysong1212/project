...
@Service("Bass0320Service")
public class Bass0320ServiceImpl extends AbstractCustomServiceImpl  implements  BasisDaoConstants ,Bass0320Service {

	private static final Logger logger = LoggerFactory.getLogger(Bass0320ServiceImpl.class);
	private static final String calledClass = Bass0320ServiceImpl.class.getName();
...
public PagingLoadResult<BaseModel> getSelectBass0320ToBass0320List(ServiceParameters serviceParameters) throws MSFException {
   ...
   String method =  CLASS_BASS0320_LIST;
   ...
   if  (MSFSharedUtils.paramNull(bass0320DAO)) {
       ...
       bass0320DAO = (Bass0320DAO) wac.getBean("Bass0320DAO"); 
   }
