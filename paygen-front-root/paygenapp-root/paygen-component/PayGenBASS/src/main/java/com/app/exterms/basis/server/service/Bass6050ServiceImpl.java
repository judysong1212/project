...
import com.app.exterms.basis.server.service.dao.Bass6050DAO;
...
@Service("Bass6050Service")
public class Bass6050ServiceImpl extends AbstractCustomServiceImpl implements Bass6050Service  ,BasisDaoConstants {

    private static final Logger logger = LoggerFactory.getLogger(Bass6050ServiceImpl.class);
    private static final String calledClass = Bass6050ServiceImpl.class.getName();
    
    @Autowired
    @Resource(name="Bass6050DAO")
    private Bass6050DAO bass6050DAO;
    
    
    public List<BaseModel> activityOnBass6050Save(ServiceParameters serviceParameters) {

        List<BaseModel> lsBmResult = new ArrayList<BaseModel>();
        String result = "1";  
        Bass6050SrhVO   remt1000SrhVo = new Bass6050SrhVO();
    	String method = calledClass + ".activityOnBass6050Save";
        ...
        if  (MSFSharedUtils.paramNull(bass6050DAO)) {
            ...
            bass6050DAO = (Bass6050DAO) wac.getBean("Bass6050DAO"); 
        }
        ...
        try {
             ...
             for (BaseModel objectBm : listObjects) { 
                 ...
                 Bass6050VO      remt1000Vo = new Bass6050VO();
...
//                 remt1000Vo.setRevnAddr(dlgn0200Vo.getRevnAddr());    /** column 수정주소 : revnAddr */
                 ...
                 case INSERT: 
                     bass6050DAO.insertBass6050(remt1000Vo); 
                     break;
                 case UPDATE:  
                     bass6050DAO.updateBass6050(remt1000Vo); 
                     break;
                 case DELETE: 
                     bass6050DAO.deleteBass6050(remt1000Vo);
                     break;
                 } 
    ...
    public PagingLoadResult<BaseModel> getSelectBass6050ToRemt1000List(ServiceParameters serviceParameters) throws MSFException {

        PagingLoadResult<BaseModel> retval = null;
        String method =  CLASS_BASS6050_DATA_LIST;
        Bass6050SrhVO   remt1000SrhVo = new Bass6050SrhVO();
        ...
        try {
           ...
           // Bass6050BM          user             = serviceParameters.getUser();
            ColumnAttribute[] tableAttributes  = serviceParameters.getTableAttributes();
            ...
            //Get total record count //전체 데이터 갯수를 가지고 온다. 
                ...
                int iResultCnt = bass6050DAO.selectBass6050ListTotCnt(remt1000SrhVo);  
            ...
            TimingInfo millisBeginSelectBass6050List = SmrmfUtils.startTiming(logger);
...
//            Collection<Map<String, Object>> list ??????
            List list = bass6050DAO.selectBass6050List(remt1000SrhVo);
            ...
            SmrmfUtils.endTiming(logger, millisBeginSelectBass6050List, "selectBass6050List");
    ...
    @Override
    public Long saveBass6050Save(Bass6050DTO dto, ActionDatabase actionDatabase) throws MSFException {
        Long returnCnt = 0L;

        String method = CLASS_BASS6050_SAVE;
        ...
        try {
             ...
             * L:로그인		O:로그아웃
             */
            MSFLogHistoryUtils.tracerUserActivity(sessionUser, method, CLASS_BASS6050_SAVE, actionDatabase.toString());
            ...
            /** 에러 로그 **/
            MSFLogHistoryUtils.tracerUserExceptionActivity(sessionUser,method,CLASS_BASS6050_SAVE,actionDatabase.toString(),e, windowNm , windowId);
