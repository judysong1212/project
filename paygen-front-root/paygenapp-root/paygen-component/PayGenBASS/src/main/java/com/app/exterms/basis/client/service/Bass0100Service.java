...
@RemoteServiceRelativePath("Bass0100Service.gwt")
public interface Bass0100Service extends RemoteService {
	/**
	 * Utility class for simplifying access to the instance of async service.
	 */
	public static class Util {
		private static Bass0100ServiceAsync instance;
		public static Bass0100ServiceAsync getInstance(){
			if (instance == null) {
				instance = GWT.create(Bass0100Service.class);
			}
			return instance;
		}
	}
	...
	//public String saveBass0100(InfcBass0100DTO dto,ActionDatabase actionDatabase) throws Exception;
