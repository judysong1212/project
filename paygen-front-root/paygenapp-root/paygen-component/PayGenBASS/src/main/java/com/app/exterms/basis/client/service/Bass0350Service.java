...
public interface Bass0350Service extends RemoteService {
	/**
	 * Utility class for simplifying access to the instance of async service.
	 */
	public static class Util {
		private static Bass0350ServiceAsync instance;
		public static Bass0350ServiceAsync getInstance(){
			if (instance == null) {
				instance = GWT.create(Bass0350Service.class);
			}
			return instance;
		}
	}
