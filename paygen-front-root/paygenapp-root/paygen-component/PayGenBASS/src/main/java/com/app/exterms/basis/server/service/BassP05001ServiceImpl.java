...
@Service("BassP05001Service")
public class BassP05001ServiceImpl extends AbstractCustomServiceImpl implements
		BasisDaoConstants, BassP05001Service {
	
	private static final Logger logger = LoggerFactory.getLogger(BassP05001ServiceImpl.class);
	private static final String calledClass = BassP05001ServiceImpl.class.getName();
