package com.app.exterms.basis.client.utils;
...
public class BasisUtil {
	    ...
	    private static  List<ModelData> mDtalistSysDivCd; 			//적용시스템
	    ...
	    * @return
	    */
	   public static List<ModelData> getLstSysDivCdModelData(ListStore<BaseModel>  lsSysDivCd) {
		   mDtalistSysDivCd = new ArrayList<ModelData>();
	       for(int i=0; i< lsSysDivCd.getCount(); i++) {
	        ModelData m = new BaseModel();
	        m.set("sysDivCd", lsSysDivCd.getAt(i).get("sysDivCd"));
	        m.set("sysDivCdNm", lsSysDivCd.getAt(i).get("sysDivCdNm")); 
	        mDtalistSysDivCd.add(m);
	       }
	       return mDtalistCommCombo;
	   }
	...
	*/
	...
	public static void setCheckedCheckBoxValue(CheckBox checkBox,
