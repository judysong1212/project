 ...
 */
public class Bass0350VO  implements Serializable {
...
private java.lang.String dtilOccuInttnAccCd;

/** set 직종세회계명 : dtilOccuInttnAccNm */
private java.lang.String dtilOccuInttnAccNm;

/** set 기간제사용여부 : dtilTermUseYn */
private java.lang.String dtilTermUseYn; 

/** set 직종세단가일수 : dtilOcclsApptnUcstDys */
private java.math.BigDecimal dtilOcclsApptnUcstDys; 
...
public void setDtilOccuClsOrd(java.math.BigDecimal dtilOccuClsOrd) {
	...
	public java.lang.String getDtilOccuInttnAccCd() {
		return dtilOccuInttnAccCd;
	}

	public void setDtilOccuInttnAccCd(java.lang.String dtilOccuInttnAccCd) {
		this.dtilOccuInttnAccCd = dtilOccuInttnAccCd;
	}

	public java.lang.String getDtilTermUseYn() {
		return dtilTermUseYn;
	}

	public void setDtilTermUseYn(java.lang.String dtilTermUseYn) {
		this.dtilTermUseYn = dtilTermUseYn;
	}

	public java.lang.String getDtilOccuInttnAccNm() {
		return dtilOccuInttnAccNm;
	}

	public void setDtilOccuInttnAccNm(java.lang.String dtilOccuInttnAccNm) {
		this.dtilOccuInttnAccNm = dtilOccuInttnAccNm;
	}

	public java.math.BigDecimal getDtilOcclsApptnUcstDys() {
		return dtilOcclsApptnUcstDys;
	}

	public void setDtilOcclsApptnUcstDys(java.math.BigDecimal dtilOcclsApptnUcstDys) {
		this.dtilOcclsApptnUcstDys = dtilOcclsApptnUcstDys;
	}
