 ...
 */
public class Bass5530VO  implements Serializable {
    ...
    public PrgmComBass0300DTO getMsfComBass0300Dto() {
		return sysComBass0300Dto;
	}

	public void setMsfComBass0300Dto(PrgmComBass0300DTO sysComBass0300Dto) {
