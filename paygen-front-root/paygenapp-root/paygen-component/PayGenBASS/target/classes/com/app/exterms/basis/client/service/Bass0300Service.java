...
@RemoteServiceRelativePath("Bass0300Service.gwt")
public interface Bass0300Service extends RemoteService {
	/**
	 * Utility class for simplifying access to the instance of async service.
	 */
	public static class Util {
		private static Bass0300ServiceAsync instance;
		public static Bass0300ServiceAsync getInstance(){
			if (instance == null) {
				instance = GWT.create(Bass0300Service.class);
			}
			return instance;
		}
	}
	...
	public BaseListLoadResult<Bass0300DTOMng> selectBass0300WorkList(BaseListLoadConfig config, Bass0300DTOMng dto ) throws MSFException;
	public BaseListLoadResult<Bass0300DTOMng> selectBass0300CodeList(BaseListLoadConfig config, Bass0300DTOMng dto ) throws MSFException;
	public BaseListLoadResult<Bass0300DTOMng> selectBass0300DtlCodeList(BaseListLoadConfig config, Bass0300DTOMng dto ) throws MSFException;
