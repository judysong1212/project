...
@RemoteServiceRelativePath("Bass5540Service.gwt")
public interface Bass5540Service extends RemoteService {
	/**
	 * Utility class for simplifying access to the instance of async service.
	 */
	public static class Util {
		private static Bass5540ServiceAsync instance;
		public static Bass5540ServiceAsync getInstance(){
			if (instance == null) {
				instance = GWT.create(Bass5540Service.class);
			}
			return instance;
		}
	}
