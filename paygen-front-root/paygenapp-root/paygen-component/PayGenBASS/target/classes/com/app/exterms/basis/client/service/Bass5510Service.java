...
public interface Bass5510Service extends RemoteService {
	/**
	 * Utility class for simplifying access to the instance of async service.
	 */
	public static class Util {
		private static Bass5510ServiceAsync instance;
		public static Bass5510ServiceAsync getInstance(){
			if (instance == null) {
				instance = GWT.create(Bass5510Service.class);
			}
			return instance;
		}
	}
	...
	/** 간이소득세액이관 **/
	public Long bass5510Transfer(Bass5510DTO payr0100Dto);
	
	/** 간이소득세액 삭제 **/
	public Long activityOnBass5510(Bass5510DTO payr0100Dto, ActionDatabase actionDatabase);
