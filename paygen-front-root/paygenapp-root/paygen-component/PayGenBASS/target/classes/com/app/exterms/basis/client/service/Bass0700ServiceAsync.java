...
public interface Bass0700ServiceAsync {
	
	
    public void Payr06420_All_Create(Bass1000DTO yeta1000Dto, AsyncCallback<PagingLoadResult<ShowMessageBM>> callback);
    
    public void Payr06420_All_Add_Create(Bass1000DTO yeta1000Dto, AsyncCallback<PagingLoadResult<ShowMessageBM>> callback);
    
    
  //  public void savePayr06420_SelfAll_Create(Yeta2000DTO yeta2000Dto, AsyncCallback<PagingLoadResult<ShowMessageBM>> callback); 
     
	public void Payr06420_Payr400_Delete(List<Bass2000DTO> listYeta2000Dto, AsyncCallback<Long> callback);
	
	public void PayrExec_Yeta_Insert(List<Bass2000DTO> listYeta2000Dto, AsyncCallback<Long> callback);
