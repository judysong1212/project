...
@RemoteServiceRelativePath("BassP035001Service.gwt")
public interface BassP035001Service extends RemoteService {
	/**
	 * Utility class for simplifying access to the instance of async service.
	 */
	public static class Util {
		private static BassP035001ServiceAsync instance;
		public static BassP035001ServiceAsync getInstance(){
			if (instance == null) {
				instance = GWT.create(BassP035001Service.class);
			}
			return instance;
		}
	}
