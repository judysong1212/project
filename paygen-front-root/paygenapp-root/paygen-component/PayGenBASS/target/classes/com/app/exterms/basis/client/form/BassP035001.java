...
import com.app.exterms.basis.client.service.BassP035001ServiceAsync;
 ...
 * =====================================================
 **/
public class BassP035001 extends MSFFormPanel {
	...
	// -------------- 서비스 호출 시작 --------------
	private Bass0350ServiceAsync bass0350Service = Bass0350Service.Util.getInstance();
	private BassP035001ServiceAsync bassP035001Service = BassP035001Service.Util.getInstance();
	 ...
	 * ++++++++++++++
	 **/
	public BassP035001(final ActionDatabase actionDatabase,	final MSFPanel caller) {
...
*/		
	...
	public void reload2() {
		...
		bassP035001_02GridPanel.getTableDef().addColumnFilter("srhTypOccuCd", BasisUtil.getSelectedComboValue(chngTypOccuCdAf, "typOccuCd"), SimpleColumnFilter.OPERATOR_LIKE);	//직종명
	...
	public void reload1() {
		...
		bassP035001_01GridPanel.getTableDef().addColumnFilter("srhTypOccuCd", BasisUtil.getSelectedComboValue(chngTypOccuCdBe, "typOccuCd"), SimpleColumnFilter.OPERATOR_LIKE);	//직종명
