...
@RemoteServiceRelativePath("Bass0200Service.gwt")
public interface Bass0200Service extends RemoteService {
	/**
	 * Utility class for simplifying access to the instance of async service.
	 */
	public static class Util {
		private static Bass0200ServiceAsync instance;
		public static Bass0200ServiceAsync getInstance(){
			if (instance == null) {
