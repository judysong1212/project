...
import com.app.exterms.basis.client.dto.Bass0210BM;
...
public class Bass0210Def extends TableDef implements BasisDaoConstants {
private int row = 0;
    ...
    public Bass0210Def(){
          ...
          setDaoClass(CLASS_BASS0210_LIST); 
          setCustomListMethod(CLASS_BASS0210_LIST);
    ...
    private List<ColumnDef> getAllColumnsList(){
        ...
        /** set 사업장코드 : dpobCd */
        listColumnDefs.add(new ColumnDef("사업장코드",   Bass0210BM.ATTR_DPOBCD,   ColumnDef.TYPE_STRING, 90, false, false, false));
//        /** set 년도 : year */
...
//        listColumnDefs.add(new ColumnDef("휴일일자",   Bass0200BM.ATTR_,   ColumnDef.TYPE_DATE, 100, true, true, true));
        listColumnDefs.add(new ColumnDef("휴일일자",   Bass0210BM.ATTR_PUBCHODYDT,   ColumnDef.TYPE_DATE, 100, true, true, true));
        
        /** set 요일코드 : dotwCd */
        sysComBass0300Dto.setRpsttvCd("C001"); 
        listColumnDefs.add(new ColumnListDef("요일",   Bass0210BM.ATTR_DOTWCD,   ColumnDef.TYPE_STRING, 120, true, true, true,  new LookupPrgmComBass0300(sysComBass0300Dto),PrgmComBass0300BM.ATTR_COMMCD,PrgmComBass0300BM.ATTR_COMMCDNM));
        /** set 요일명 : dotwNm */
        listColumnDefs.add(new ColumnDef("요일",   Bass0210BM.ATTR_DOTWNM,   ColumnDef.TYPE_STRING, 90, false, false, false));
        /** set 휴일내용 : pubcHodyCtnt */
        listColumnDefs.add(new ColumnDef("휴일내용",   Bass0210BM.ATTR_PUBCHODYCTNT,   ColumnDef.TYPE_STRING, 300, true, true, true));
        /** set 휴일유무 : pubcHodyYn */
        listColumnDefs.add(new ColumnDef("휴일",   Bass0210BM.ATTR_PUBCHODYYN,   ColumnDef.TYPE_BOOLEAN, 60, false, true, true));
        /** set 유급휴일여부 : paidPubcHodyYn */
        listColumnDefs.add(new ColumnDef("유급휴일",   Bass0210BM.ATTR_PAIDPUBCHODYYN,   ColumnDef.TYPE_BOOLEAN, 60, false, true, true));
