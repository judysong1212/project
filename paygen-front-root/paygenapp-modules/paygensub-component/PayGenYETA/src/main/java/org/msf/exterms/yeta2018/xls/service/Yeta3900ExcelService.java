...
public interface Yeta3900ExcelService {
	...
	List<Pyyt0302_2018_VO> updateXlsYeta390001(Collection<Pyyt0302_2018_VO> yeta3900List, HttpServletRequest request) throws MSFException;
	...
	List<Pyyt0302_2018_VO> updateXlsYeta390002(List<Pyyt0302Exl_2018_VO> yeta3900List, HttpServletRequest request) throws MSFException;
     ...
     * @throws Exception
     */
    List<Pyyt0304_2018_VO> selectXlsPyyt0304List01(Pyyt0304Srh_2018_VO   pyyt0304SrhVo ) throws Exception;
...
//    EgovMap selectXlsPyyt0304List1(Pyyt0304SrhVO pyyt0304SrhVo) throws Exception;
    ...
    List<EgovMap> selectXlsPyyt0304List2(Pyyt0304Srh_2018_VO pyyt0304SrhVo) throws Exception;
