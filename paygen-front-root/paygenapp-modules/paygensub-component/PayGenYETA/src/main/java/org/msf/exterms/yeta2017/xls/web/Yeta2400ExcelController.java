...
@Controller
public class Yeta2400ExcelController {


    private static final Logger logger = LoggerFactory.getLogger(Yeta2400ExcelController.class);  
    private static final String calledClass = Yeta2400ExcelController.class.getName();
 
    
    @Resource(name = "Yeta2400ExcelService")
    private Yeta2400ExcelService yeta2400ExcelService;
     ...
     * @throws Exception
     */
    @RequestMapping(value="/exp/XlsYeta2400Export.do")
    public ModelAndView xlsYeta2400Export(@ModelAttribute("Ye161010SrhVO") Ye161010SrhVO ye161010SrhVo, HttpServletRequest request ,ModelMap model) 
                    throws Exception {  
    	
    	String method = calledClass + ".xlsYeta2400Export";
		...
		try{
	        ...
	        List  listYeta2400 = yeta2400ExcelService.selectYeta2400ToYeta2400List(ye161010SrhVo);
	        
	        
			List<EgovMap> excelList = new ArrayList<EgovMap>();

	    	for(int i=0; i<listYeta2400.size(); i++){
	    		EgovMap eMap  = new EgovMap();
	    		eMap = (EgovMap) listYeta2400.get(i);
	    		// TODO 주민번호
...
//	        Map<String, Object> map = new HashMap<String, Object>();
        ...
        return new ModelAndView("yeta2400ExcelView", map);
