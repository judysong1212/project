...
import org.msf.exterms.yeta2021.xls.service.Yeta6100ExcelService;
...
@Controller
public class Yeta6100ExcelController {


    private static final Logger logger = LoggerFactory.getLogger(Yeta6100ExcelController.class);  
    private static final String calledClass = Yeta6100ExcelController.class.getName();
 
    
    @Resource(name = "yeta6100ExcelService")
    private Yeta6100ExcelService yeta6100ExcelService;
     ...
     * @throws Exception
     */
    @RequestMapping(value="/exp/XlsYeta6100Export.do")
    public ModelAndView XlsYeta6100Export(@ModelAttribute("Ye161010Srh_2021_VO") Ye161010Srh_2021_VO ye161010SrhVo,HttpServletRequest request ,ModelMap model) 
                    throws Exception { 
    	
    	String method = calledClass + ".XlsYeta6100Export";
...
//	        EgovMap listPayr42001 = yeta1900ExcelService.selectXlsPyyt0304List1(pyyt0304SrhVO);
	        List<EgovMap> listPayr3100 = yeta6100ExcelService.selectXlsYeta6100List(ye161010SrhVo);
	        
	    	List<EgovMap> excelList = new ArrayList<EgovMap>();

			for(int i=0; i<listPayr3100.size(); i++){
				EgovMap eMap  = new EgovMap();
				eMap = (EgovMap) listPayr3100.get(i);
				// TODO 주민번호
			...
			map.put("listYeta6100", excelList);
        ...
        return new ModelAndView("yeta6100ExcelView", map);
