...
@Service("yeta1900ExcelService")
public class Yeta1900ExcelServiceImpl extends AbstractServiceImpl implements Yeta1900ExcelService {
	
	private static final Logger logger = LoggerFactory.getLogger(Yeta1900ExcelServiceImpl.class);
	private static final String calledClass = Yeta1900ExcelServiceImpl.class.getName();
	...
	@Override
	public List<Pyyt0302VO> updateXlsYeta190001(Collection<Pyyt0302VO> yeta1900List, HttpServletRequest request)throws MSFException {
...
//					pyyt0304Vo.setStrRtn("X");
	  ...
	  */
	@Override
	public List<Pyyt0302VO> updateXlsYeta190002(List<Pyyt0302ExlVO> yeta1900List, HttpServletRequest request)throws MSFException {
