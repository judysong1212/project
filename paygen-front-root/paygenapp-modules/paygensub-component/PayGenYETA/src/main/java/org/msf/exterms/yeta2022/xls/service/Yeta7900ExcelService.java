...
public interface Yeta7900ExcelService {
	...
	List<Pyyt0302_2022_VO> updateXlsYeta790001(Collection<Pyyt0302_2022_VO> yeta7900List, HttpServletRequest request) throws MSFException;

    /**
     *  급여업로드_엑셀파일을 등록한다. (JXLS)
     */

	List<Pyyt0302_2022_VO> updateXlsYeta790002(List<Pyyt0302Exl_2022_VO> yeta7900List, HttpServletRequest request) throws MSFException;
     ...
     * @throws Exception
     */
    List<Pyyt0304_2022_VO> selectXlsPyyt0304List01(Pyyt0304Srh_2022_VO   pyyt0304SrhVo ) throws Exception;
...
//    EgovMap selectXlsPyyt0304List1(Pyyt0304SrhVO pyyt0304SrhVo) throws Exception;
    ...
    List<EgovMap> selectXlsPyyt0304List2(Pyyt0304Srh_2022_VO pyyt0304SrhVo) throws Exception;
