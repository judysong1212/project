...
@Controller
public class Yeta5100ExcelController {


    private static final Logger logger = LoggerFactory.getLogger(Yeta5100ExcelController.class);  
    private static final String calledClass = Yeta5100ExcelController.class.getName();
 
    
    @Resource(name = "yeta5100ExcelService")
    private Yeta5100ExcelService yeta5100ExcelService;
     ...
     * @throws Exception
     */
    @RequestMapping(value="/exp/XlsYeta5100Export.do")
    public ModelAndView XlsYeta5100Export(@ModelAttribute("Ye161010Srh_2020_VO") Ye161010Srh_2020_VO ye161010SrhVo,HttpServletRequest request ,ModelMap model) 
                    throws Exception { 
    	
    	String method = calledClass + ".XlsYeta5100Export";
...
//	        EgovMap listPayr42001 = yeta1900ExcelService.selectXlsPyyt0304List1(pyyt0304SrhVO);
	        List<EgovMap> listPayr3100 = yeta5100ExcelService.selectXlsYeta5100List(ye161010SrhVo);
			...
			map.put("listYeta5100", excelList);
        ...
        return new ModelAndView("yeta5100ExcelView", map);
