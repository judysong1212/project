...
@Controller
public class Yeta7400ExcelController {


    private static final Logger logger = LoggerFactory.getLogger(Yeta7400ExcelController.class);  
    private static final String calledClass = Yeta7400ExcelController.class.getName();
 
    
    @Resource(name = "Yeta7400ExcelService")
    private Yeta7400ExcelService yeta7400ExcelService;
     ...
     * @throws Exception
     */
    @RequestMapping(value="/exp/XlsYeta7400Export.do")
    public ModelAndView xlsYeta7400Export(@ModelAttribute("Ye161010Srh_2022_VO") Ye161010Srh_2022_VO ye161010SrhVo, HttpServletRequest request ,ModelMap model) 
                    throws Exception {  
    	
    	String method = calledClass + ".xlsYeta7400Export";
		...
		try{
	        ...
	        List listYeta7400 = yeta7400ExcelService.selectYeta7400ToYeta7400List(ye161010SrhVo);
	        
	        
			List<EgovMap> excelList = new ArrayList<EgovMap>();

	    	for(int i=0; i<listYeta7400.size(); i++){
	    		EgovMap eMap  = new EgovMap();
	    		eMap = (EgovMap) listYeta7400.get(i);
	    		// TODO 주민번호
...
//	        Map<String, Object> map = new HashMap<String, Object>();
        ...
        return new ModelAndView("yeta7400ExcelView", map);
