...
@Controller
public class Yeta1400ExcelController {


    private static final Logger logger = LoggerFactory.getLogger(Yeta1400ExcelController.class);  
    private static final String calledClass = Yeta1400ExcelController.class.getName();
 
    
    @Resource(name = "yeta1400ExcelService")
    private Yeta1400ExcelService yeta1400ExcelService;
     ...
     * @throws Exception
     */
    @RequestMapping(value="/exp/XlsYeta1400Export.do")
    public ModelAndView xlsYeta2000Export(@ModelAttribute("Yeta2000SrhVO") Yeta2000SrhVO yeta2000SrhVO, HttpServletRequest request ,ModelMap model) 
		...
		try{
	        ...
	        List  listYeta1400 = yeta1400ExcelService.selectYeta1400ToYeta2000List(yeta2000SrhVO);
	        
	        
			List<EgovMap> excelList = new ArrayList<EgovMap>();

	    	for(int i=0; i<listYeta1400.size(); i++){
	    		EgovMap eMap  = new EgovMap();
	    		eMap = (EgovMap) listYeta1400.get(i);
	    		// TODO 주민번호
...
//	        Map<String, Object> map = new HashMap<String, Object>();
        ...
        return new ModelAndView("yeta1400ExcelView", map);
