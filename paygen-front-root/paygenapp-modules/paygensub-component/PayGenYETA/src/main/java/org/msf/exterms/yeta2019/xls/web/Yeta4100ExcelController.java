...
@Controller
public class Yeta4100ExcelController {


    private static final Logger logger = LoggerFactory.getLogger(Yeta4100ExcelController.class);  
    private static final String calledClass = Yeta4100ExcelController.class.getName();
 
    
    @Resource(name = "yeta4100ExcelService")
    private Yeta4100ExcelService yeta4100ExcelService;
     ...
     * @throws Exception
     */
    @RequestMapping(value="/exp/XlsYeta4100Export.do")
    public ModelAndView XlsYeta4100Export(@ModelAttribute("Ye161010Srh_2019_VO") Ye161010Srh_2019_VO ye161010SrhVo,HttpServletRequest request ,ModelMap model) 
                    throws Exception { 
    	
    	String method = calledClass + ".XlsYeta4100Export";
...
//	        EgovMap listPayr42001 = yeta1900ExcelService.selectXlsPyyt0304List1(pyyt0304SrhVO);
	        List<EgovMap> listPayr3100 = yeta4100ExcelService.selectXlsYeta4100List(ye161010SrhVo);
			...
			map.put("listYeta4100", excelList);
        ...
        return new ModelAndView("yeta4100ExcelView", map);
