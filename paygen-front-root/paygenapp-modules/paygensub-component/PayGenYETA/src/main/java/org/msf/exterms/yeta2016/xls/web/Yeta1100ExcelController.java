...
@Controller
public class Yeta1100ExcelController {


    private static final Logger logger = LoggerFactory.getLogger(Yeta1100ExcelController.class);  
    private static final String calledClass = Yeta1100ExcelController.class.getName();
 
    
    @Resource(name = "yeta1100ExcelService")
    private Yeta1100ExcelService yeta1100ExcelService;
     ...
     * @throws Exception
     */
    @RequestMapping(value="/exp/XlsYeta1100Export.do")
    public ModelAndView xlsYeta1100Export(@ModelAttribute("Yeta2000SrhVO") Yeta2000SrhVO yeta2000SrhVO, HttpServletRequest request ,ModelMap model) 
                    throws Exception {  
    	
    	String method = calledClass + ".xlsYeta1100Export";
		...
		try{
	        ...
	        /******************************** 권한 ************************************************************************/
	         ...
	         yeta2000SrhVO.setYetaDpcd(MSFSharedUtils.allowNulls(yeta2000SrhVO.getYetaDpcd()));				//원천신고부서
	         yeta2000SrhVO.setBusoprRgstnum(MSFSharedUtils.allowNulls(yeta2000SrhVO.getBusoprRgstnum()));	//사업자등록번호
	    	
	    	
	        List  listYeta2000 = yeta1100ExcelService.selectYeta1100ToYeta2000List(yeta2000SrhVO);
...
//	        Map<String, Object> map = new HashMap<String, Object>();
        ...
        return new ModelAndView("yeta0100ExcelView", map);
