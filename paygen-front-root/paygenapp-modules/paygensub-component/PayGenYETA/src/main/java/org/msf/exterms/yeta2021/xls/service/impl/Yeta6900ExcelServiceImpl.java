...
@Service("yeta6900ExcelService")
public class Yeta6900ExcelServiceImpl extends AbstractServiceImpl implements Yeta6900ExcelService {

	private static final Logger logger = LoggerFactory.getLogger(Yeta6900ExcelServiceImpl.class);
	private static final String calledClass = Yeta6900ExcelService.class.getName();
	...
	@Override
	public List<Pyyt0302_2021_VO> updateXlsYeta690001(Collection<Pyyt0302_2021_VO> yeta1900List, HttpServletRequest request)throws MSFException {
		...
		List<Pyyt0302_2021_VO> errYeta6900List = new ArrayList<Pyyt0302_2021_VO>();
		 

		
		try {  
			
			errYeta6900List = new ArrayList<Pyyt0302_2021_VO>();	// 데이터 이상으로 저장되지 않는 데이터를 리턴해주기 위한
			...
			for(int iPsnlCnt=0;iPsnlCnt < yeta1900List.size();iPsnlCnt++) {
				...
				strValue = "";
				Pyyt0302_2021_VO pyyt0302 = new Pyyt0302_2021_VO();  
				pyyt0302 = ((ArrayList<Pyyt0302_2021_VO>) yeta1900List).get(iPsnlCnt);
...
//						pyyt0304Vo.setStrRtn("X");
						errYeta6900List.add(pyyt0302Vo);
...
//						pyyt0304Vo.setPyytPernPymtSum(pyyt0304Vo.getPyytPernPymtSum());    						/** column 차인지급액 : pyytPernPymtSum */
						...
						pyyt0304SrhVo = new Pyyt0304Srh_2021_VO();
...
//					pyyt0304Vo.setStrRtn("X");
			...
			result = new Long(1);
	            ...
	            logger.error("EXCEPTION calling updateXlsYeta690002(): "+ex); 
	            
	            result = new Long(0);
	            throw MSFServerUtils.getOperationException("updateXlsYeta690002", ex, logger);
	        }
	        finally {
	          
	        }
		return errYeta6900List;
	}	
	  ...
	  */
	@Override
	public List<Pyyt0302_2021_VO> updateXlsYeta690002(List<Pyyt0302Exl_2021_VO> yeta1900List, HttpServletRequest request)throws MSFException {
		...
		try {  
			...
			for(int iPsnlCnt=0;iPsnlCnt < yeta1900List.size();iPsnlCnt++) {
				...
				Pyyt0302Exl_2021_VO pyyt0302 = new Pyyt0302Exl_2021_VO();  
...
//					pyyt0304Vo.setStrRtn("X");
			...
			result = new Long(1);
	            ...
	            MSFErrorMessage errMsg = new MSFErrorMessage("", "", 0, "업로드 데이터에 문제가 있습니다.</br> 관리자에게 문의해주세요."); 
  				throw MSFServerUtils.getValidationException("updateXlsYeta690002", errMsg, logger) ; 
...
//	}
	...
	// 급여대장(공무직)
	@Override
	public List<Pyyt0304_2021_VO> selectXlsPyyt0304List01(Pyyt0304Srh_2021_VO   pyyt0304SrhVo) throws Exception {
		return pyyt0304DAO.selectXlsYeta1900ToPyyt0304List01(pyyt0304SrhVo);
	} 
	
	// 급여대장(기간제근로자)
	public List selectXlsPyyt0304List2(Pyyt0304Srh_2021_VO pyyt0304SrhVo)throws Exception {
