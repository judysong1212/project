...
public class Yeta8400ExcelView extends AbstractExcelView {
    ...
    protected void buildExcelDocument(Map<String, Object> model,
    	...
    	XLSTransformer transformer = new XLSTransformer();
      	...
      	String xlsRelatvieFilepath =   realPath.concat("/".concat(globals.get("PayGen.XLSTemplateLink")).concat("/YETA/XLS_YETA800003.xls"));
