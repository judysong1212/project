...
@Controller
public class Yeta3100ExcelController {


    private static final Logger logger = LoggerFactory.getLogger(Yeta3100ExcelController.class);  
    private static final String calledClass = Yeta3100ExcelController.class.getName();
 
    
    @Resource(name = "yeta3100ExcelService")
    private Yeta3100ExcelService yeta3100ExcelService;
     ...
     * @throws Exception
     */
    @RequestMapping(value="/exp/XlsYeta3100Export.do")
    public ModelAndView XlsYeta3100Export(@ModelAttribute("Ye161010Srh_2018_VO") Ye161010Srh_2018_VO ye161010SrhVo,HttpServletRequest request ,ModelMap model) 
                    throws Exception { 
    	
    	String method = calledClass + ".XlsYeta3100Export";
...
//	        EgovMap listPayr42001 = yeta1900ExcelService.selectXlsPyyt0304List1(pyyt0304SrhVO);
	        List<EgovMap> listPayr3100 = yeta3100ExcelService.selectXlsYeta3100List(ye161010SrhVo);
			...
			map.put("listYeta3100", excelList);
        ...
        return new ModelAndView("yeta3100ExcelView", map);
