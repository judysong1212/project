...
@Controller
public class Yeta8100ExcelController {


    private static final Logger logger = LoggerFactory.getLogger(Yeta8100ExcelController.class);  
    private static final String calledClass = Yeta8100ExcelController.class.getName();
 
    
    @Resource(name = "yeta8100ExcelService")
    private Yeta8100ExcelService yeta8100ExcelService;
     ...
     * @throws Exception
     */
    @RequestMapping(value="/exp/XlsYeta8100Export.do")
    public ModelAndView XlsYeta8100Export(@ModelAttribute("Ye161010Srh_2023_VO") Ye161010Srh_2023_VO ye161010SrhVo,HttpServletRequest request ,ModelMap model) 
                    throws Exception { 
    	
    	String method = calledClass + ".XlsYeta8100Export";
...
//	        EgovMap listPayr42001 = yeta1900ExcelService.selectXlsPyyt0304List1(pyyt0304SrhVO);
	        List<EgovMap> listPayr3100 = yeta8100ExcelService.selectXlsYeta8100List(ye161010SrhVo);
			...
			map.put("listYeta8100", excelList);
        ...
        return new ModelAndView("yeta8100ExcelView", map);
