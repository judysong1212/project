...
public interface Yeta8900ExcelService {
	...
	List<Pyyt0302_2023_VO> updateXlsYeta890001(Collection<Pyyt0302_2023_VO> yeta8900List, HttpServletRequest request) throws MSFException;

    /**
     *  급여업로드_엑셀파일을 등록한다. (JXLS)
     */

	List<Pyyt0302_2023_VO> updateXlsYeta890002(List<Pyyt0302Exl_2023_VO> yeta8900List, HttpServletRequest request) throws MSFException;
     ...
     * @throws Exception
     */
    List<Pyyt0304_2023_VO> selectXlsPyyt0304List01(Pyyt0304Srh_2023_VO   pyyt0304SrhVo ) throws Exception;
...
//    EgovMap selectXlsPyyt0304List1(Pyyt0304SrhVO pyyt0304SrhVo) throws Exception;
    ...
    List<EgovMap> selectXlsPyyt0304List2(Pyyt0304Srh_2023_VO pyyt0304SrhVo) throws Exception;
