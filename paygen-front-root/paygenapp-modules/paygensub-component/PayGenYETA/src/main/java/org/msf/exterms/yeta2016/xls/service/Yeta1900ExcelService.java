...
public interface Yeta1900ExcelService {
...
//    Long updateXlsYeta3900(List<Yeta3900VO> yeta3900List, HttpServletRequest request) throws MSFException;
	...
	List<Pyyt0302VO> updateXlsYeta190001(Collection<Pyyt0302VO> yeta3900List, HttpServletRequest request) throws MSFException;
	...
	List<Pyyt0302VO> updateXlsYeta190002(List<Pyyt0302ExlVO> yeta3900List, HttpServletRequest request) throws MSFException;
