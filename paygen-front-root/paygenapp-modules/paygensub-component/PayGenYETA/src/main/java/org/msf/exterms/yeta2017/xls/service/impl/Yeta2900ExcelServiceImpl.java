...
@Service("yeta2900ExcelService")
public class Yeta2900ExcelServiceImpl extends AbstractServiceImpl implements Yeta2900ExcelService {

	private static final Logger logger = LoggerFactory.getLogger(Yeta2900ExcelServiceImpl.class);
	private static final String calledClass = Yeta2900ExcelService.class.getName();
	...
	@Override
	public List<Pyyt0302VO> updateXlsYeta290001(Collection<Pyyt0302VO> yeta1900List, HttpServletRequest request)throws MSFException {
		...
		List<Pyyt0302VO> errYeta1900List = new ArrayList<Pyyt0302VO>();
		 

		
		try {  
			
			errYeta1900List = new ArrayList<Pyyt0302VO>();	// 데이터 이상으로 저장되지 않는 데이터를 리턴해주기 위한
			...
			for(int iPsnlCnt=0;iPsnlCnt < yeta1900List.size();iPsnlCnt++) {
				...
				strValue = "";
				Pyyt0302VO pyyt0302 = new Pyyt0302VO();  
				pyyt0302 = ((ArrayList<Pyyt0302VO>) yeta1900List).get(iPsnlCnt);
...
//						pyyt0304Vo.setPyytPernPymtSum(pyyt0304Vo.getPyytPernPymtSum());    						/** column 차인지급액 : pyytPernPymtSum */
						...
						pyyt0304SrhVo = new Pyyt0304SrhVO();
...
//					pyyt0304Vo.setStrRtn("X");
	  ...
	  */
	@Override
	public List<Pyyt0302VO> updateXlsYeta290002(List<Pyyt0302ExlVO> yeta1900List, HttpServletRequest request)throws MSFException {
		...
		try {  
			...
			for(int iPsnlCnt=0;iPsnlCnt < yeta1900List.size();iPsnlCnt++) {
				...
				Pyyt0302ExlVO pyyt0302 = new Pyyt0302ExlVO();  
...
//	}
	...
	// 급여대장(공무직)
	@Override
	public List<Pyyt0304VO> selectXlsPyyt0304List01(Pyyt0304SrhVO   pyyt0304SrhVo) throws Exception {
		return pyyt0304DAO.selectXlsYeta1900ToPyyt0304List01(pyyt0304SrhVo);
	} 
	
	// 급여대장(기간제근로자)
	public List selectXlsPyyt0304List2(Pyyt0304SrhVO pyyt0304SrhVo)throws Exception {
