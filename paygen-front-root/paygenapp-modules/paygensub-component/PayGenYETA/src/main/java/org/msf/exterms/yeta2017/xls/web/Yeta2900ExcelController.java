...
import org.msf.exterms.yeta2017.xls.service.Yeta2900ExcelService;
...
@Controller
public class Yeta2900ExcelController {


    private static final Logger logger = LoggerFactory.getLogger(Yeta2900ExcelController.class);  
    private static final String calledClass = Yeta2900ExcelController.class.getName();
 
    
    @Resource(name = "yeta2900ExcelService")
    private Yeta2900ExcelService yeta2900ExcelService;
     ...
     * @throws Exception
     */
    @RequestMapping(value="/exp/XlsTemYeta290001Export.do")
    public ModelAndView xlsYeta2900Export01(@ModelAttribute("Payr0485SrhVO") Payr0485SrhVO Payr0485SrhVO, HttpServletRequest request ,ModelMap model) 
                    throws Exception {  
    	
    	String method = calledClass + ".xlsYeta2900Export01";
...
//    	List<String> listDeptCd = new ArrayList<String>();
		...
		try{
    		...
    		List listYeta2900 = yeta2900ExcelService.selectXlsPayr0485List(payr0485SrhVo);
...
//			}
    	...
    	return new ModelAndView("yeta290001TemExcelView", map);
     ...
     * @throws Exception
     */
    @RequestMapping(value="/exp/XlsTemYeta290002Export.do")
    public ModelAndView xlsYeta2900Export02(@ModelAttribute("Payr0485SrhVO") Payr0485SrhVO Payr0485SrhVO, HttpServletRequest request ,ModelMap model) 
                    throws Exception {  
    	
    	String method = calledClass + ".xlsYeta2900Export02";
...
//    	List<String> listDeptCd = new ArrayList<String>();
		...
		try{
			...
			map = new HashMap<String, Object>();
			map.put("listYeta2900", listYeta2900);
    	...
    	return new ModelAndView("yeta290002TemExcelView", map);
     ...
     */
    @RequestMapping(value = "/imp/XlsReadYeta290001Import.do", method = RequestMethod.POST)
    public String handleFormUpload01(@RequestParam("yeta2900flUp") MultipartFile file,
			Model model, final HttpServletRequest request) throws InvalidFormatException, IOException, SAXException {
    	
    	
    	String realPath = request.getSession().getServletContext().getRealPath(""); 
    	String xmlConfig2 = "/upXmlConfig/YETA/Yeta290001Mapping.xml";
...
//		pyyt0302List = new ArrayList<Pyyt0302VO>();
		...
		// 엑셀 업로드 서비스 호출
		errPyyt0302List = yeta2900ExcelService.updateXlsYeta290001(sumPyyt0302List, request);
     ...
     * @throws InvalidFormatException, IOException, SAXException
     */
    @RequestMapping(value = "/imp/XlsReadYeta290002Import.do", method = RequestMethod.POST)
    public String handleFormUpload02(@RequestParam("yeta2900flUp") MultipartFile file,
			Model model, final HttpServletRequest request) throws InvalidFormatException, IOException, SAXException {
    	
    	String realPath = request.getSession().getServletContext().getRealPath(""); 
    	String xmlConfig = "/upXmlConfig/YETA/Yeta290002Mapping.xml";
...
//			System.out.println("xml경로 " + realPath.concat("/WEB-INF" + xmlConfig));
			...
			if(xlsReadStatus.isStatusOK()) {
				...
				errPyyt0302List = new ArrayList<Pyyt0302VO>();
				//엑셀 업로드 서비스 호출
				errPyyt0302List = yeta2900ExcelService.updateXlsYeta290002(pyyt0302List, request);
				sResult =  "/excelPopup/excelYetaList";
	 ...
	 * @throws Exception
	 */
    @RequestMapping(value="/yeta/excelYetaList.do")
...
//    		 f.delete();
     ...
     * @throws Exception
     */
    @RequestMapping(value="/exp/XlsYeta2900Export01.do")
    public ModelAndView XlsYeta2900Export01(@ModelAttribute("Pyyt0304SrhVO") Pyyt0304SrhVO pyyt0304SrhVo,HttpServletRequest request ,ModelMap model) 
                    throws Exception { 
      
    	
    	String method = calledClass + ".XlsYeta2900Export2";
	...
	//        payr0304SrhVO.setPyspGrdeCd(MSFSharedUtils.allowNulls(param.get("pyspGrdeCd"))); //호봉등급코드
	       ...
	       // pyyt0304SrhVo.setPymtDducDivCd(MSFSharedUtils.allowNulls(pyyt0304SrhVo.getPymtDducDivCd()));	//지급공제구분
	        ...
	        List<Pyyt0304VO> listYeta2900 = yeta2900ExcelService.selectXlsPyyt0304List01(pyyt0304SrhVo);
	        List listYeta2900Str = new ArrayList<String>();
...
//	        String nResult = AnyCryptUtils.XecureCryptInitialize(RemoteServiceUtil.getThreadLocalConfig(),RemoteServiceUtil.getThreadLocalRequest());
	    	for(int i=0; i<listYeta2900.size(); i++){
	    		...
	    		pyyt0304Vo = (Pyyt0304VO) listYeta2900.get(i);
	    		...
	    		listYeta2900Str.add(pyyt0304Vo);
...
//	        Map<String, Object> map = new HashMap<String, Object>();
	        map = new HashMap<String, Object>();
	        map.put("listYeta2900", listYeta2900Str);
        ...
        return new ModelAndView("yeta290001ExcelView", map);
    }
     ...
     * @throws Exception
     */
    @RequestMapping(value="/exp/XlsYeta2900Export02.do")
    public ModelAndView XlsYeta2900Export02(@ModelAttribute("Pyyt0304SrhVO") Pyyt0304SrhVO pyyt0304SrhVO,HttpServletRequest request ,ModelMap model) 
                    throws Exception { 
...
//	        EgovMap listPayr42001 = yeta2900ExcelService.selectXlsPyyt0304List1(pyyt0304SrhVO);
	        List<EgovMap> listPayr4200 = yeta2900ExcelService.selectXlsPyyt0304List2(pyyt0304SrhVO);
...
//	        Map<String, Object> map = new HashMap<String, Object>();
	        map = new HashMap<String, Object>();
	        map.put("listYeta2900", excelList);
...
//	        map.put("rflctnBgnnDt", listPayr42001.get("rflctnBgnnDt"));
        ...
        return new ModelAndView("yeta290002ExcelView", map);
