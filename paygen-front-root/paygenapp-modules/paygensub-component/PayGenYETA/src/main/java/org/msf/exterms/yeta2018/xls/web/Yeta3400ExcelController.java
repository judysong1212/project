...
@Controller
public class Yeta3400ExcelController {


    private static final Logger logger = LoggerFactory.getLogger(Yeta3400ExcelController.class);  
    private static final String calledClass = Yeta3400ExcelController.class.getName();
 
    
    @Resource(name = "Yeta3400ExcelService")
    private Yeta3400ExcelService yeta3400ExcelService;
     ...
     * @throws Exception
     */
    @RequestMapping(value="/exp/XlsYeta3400Export.do")
    public ModelAndView xlsYeta3400Export(@ModelAttribute("Ye161010Srh_2018_VO") Ye161010Srh_2018_VO ye161010SrhVo, HttpServletRequest request ,ModelMap model) 
                    throws Exception {  
    	
    	String method = calledClass + ".xlsYeta3400Export";
		...
		try{
	        ...
	        List  listYeta3400 = yeta3400ExcelService.selectYeta3400ToYeta3400List(ye161010SrhVo);
	        
	        
			List<EgovMap> excelList = new ArrayList<EgovMap>();

	    	for(int i=0; i<listYeta3400.size(); i++){
	    		EgovMap eMap  = new EgovMap();
	    		eMap = (EgovMap) listYeta3400.get(i);
	    		// TODO 주민번호
...
//	        Map<String, Object> map = new HashMap<String, Object>();
        ...
        return new ModelAndView("yeta3400ExcelView", map);
