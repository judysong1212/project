...
@Service("yeta3900ExcelService")
public class Yeta3900ExcelServiceImpl extends AbstractServiceImpl implements Yeta3900ExcelService {

	private static final Logger logger = LoggerFactory.getLogger(Yeta3900ExcelServiceImpl.class);
	private static final String calledClass = Yeta3900ExcelService.class.getName();
	...
	@Override
	public List<Pyyt0302_2018_VO> updateXlsYeta390001(Collection<Pyyt0302_2018_VO> yeta1900List, HttpServletRequest request)throws MSFException {
		...
		List<Pyyt0302_2018_VO> errYeta1900List = new ArrayList<Pyyt0302_2018_VO>();
		 

		
		try {  
			
			errYeta1900List = new ArrayList<Pyyt0302_2018_VO>();	// 데이터 이상으로 저장되지 않는 데이터를 리턴해주기 위한
			...
			for(int iPsnlCnt=0;iPsnlCnt < yeta1900List.size();iPsnlCnt++) {
				...
				strValue = "";
				Pyyt0302_2018_VO pyyt0302 = new Pyyt0302_2018_VO();  
				pyyt0302 = ((ArrayList<Pyyt0302_2018_VO>) yeta1900List).get(iPsnlCnt);
...
//						pyyt0304Vo.setPyytPernPymtSum(pyyt0304Vo.getPyytPernPymtSum());    						/** column 차인지급액 : pyytPernPymtSum */
						...
						pyyt0304SrhVo = new Pyyt0304Srh_2018_VO();
...
//					pyyt0304Vo.setStrRtn("X");
	  ...
	  */
	@Override
	public List<Pyyt0302_2018_VO> updateXlsYeta390002(List<Pyyt0302Exl_2018_VO> yeta1900List, HttpServletRequest request)throws MSFException {
		...
		try {  
			...
			for(int iPsnlCnt=0;iPsnlCnt < yeta1900List.size();iPsnlCnt++) {
				...
				Pyyt0302Exl_2018_VO pyyt0302 = new Pyyt0302Exl_2018_VO();  
...
//	}
	...
	// 급여대장(공무직)
	@Override
	public List<Pyyt0304_2018_VO> selectXlsPyyt0304List01(Pyyt0304Srh_2018_VO   pyyt0304SrhVo) throws Exception {
		return pyyt0304DAO.selectXlsYeta1900ToPyyt0304List01(pyyt0304SrhVo);
	} 
	
	// 급여대장(기간제근로자)
	public List selectXlsPyyt0304List2(Pyyt0304Srh_2018_VO pyyt0304SrhVo)throws Exception {
