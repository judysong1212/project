...
import com.app.exterms.yearendtax.server.vo.Yeta2000Srh_2020_VO;
...
@Controller
public class Yeta5500ExcelController {


    private static final Logger logger = LoggerFactory.getLogger(Yeta5500ExcelController.class);  
    private static final String calledClass = Yeta5500ExcelController.class.getName();
 
    
    @Resource(name = "yeta5500ExcelService")
    private Yeta5500ExcelService yeta5500ExcelService;
     ...
     * @throws Exception
     */
    @RequestMapping(value="/exp/XlsYeta5500Export.do")
    public ModelAndView xlsYeta5500Export(@ModelAttribute("Ye161010Srh_2020_VO") Ye161010Srh_2020_VO ye161010SrhVo, HttpServletRequest request ,ModelMap model) 
                    throws Exception {  
		...
		try{
	        ...
	        List listYeta3000 = yeta5500ExcelService.selectYeta5500ToYeta3000List(ye161010SrhVo);
...
//	        Map<String, Object> map = new HashMap<String, Object>();
        ...
        return new ModelAndView("yeta5500ExcelView", map);
