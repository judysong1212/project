...
@Service("yeta0500ExcelService")
public class Yeta0500ExcelServiceImpl extends AbstractServiceImpl implements Yeta0500ExcelService {
	
//	private static final Logger logger = LoggerFactory.getLogger(Yeta0100ServiceImpl.class);
	private static final String calledClass = Yeta0500ExcelService.class.getName();
