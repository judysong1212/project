package org.msf.exterms.yeta2021.xls.web;
...
import org.msf.exterms.yeta2021.xls.service.Yeta6900ExcelService;
...
import com.app.exterms.yearendtax.server.vo.Payr0485Srh_2021_VO;
import com.app.exterms.yearendtax.server.vo.Payr0485_2021_VO;
import com.app.exterms.yearendtax.server.vo.Pyyt0302Exl_2021_VO;
import com.app.exterms.yearendtax.server.vo.Pyyt0302_2021_VO;
import com.app.exterms.yearendtax.server.vo.Pyyt0304Srh_2021_VO;
import com.app.exterms.yearendtax.server.vo.Pyyt0304_2021_VO;
...
@Controller
public class Yeta6900ExcelController {


    private static final Logger logger = LoggerFactory.getLogger(Yeta6900ExcelController.class);  
    private static final String calledClass = Yeta6900ExcelController.class.getName();
 
    
    @Resource(name = "yeta6900ExcelService")
    private Yeta6900ExcelService yeta6900ExcelService;

    /** EgovPropertyService */
    @Resource(name = "propertiesService")
    protected EgovPropertyService propertiesService;
    
    private List<Pyyt0302_2021_VO> errPyyt0302List = new ArrayList<Pyyt0302_2021_VO>();
     ...
     * @throws Exception
     */
    @RequestMapping(value="/exp/XlsTemYeta690001Export.do")
    public ModelAndView xlsYeta6900Export01(@ModelAttribute("Payr0485Srh_2021_VO") Payr0485Srh_2021_VO Payr0485SrhVO, HttpServletRequest request ,ModelMap model) 
                    throws Exception {  
    	
    	String method = calledClass + ".xlsYeta6900Export01";
...
//    	List<String> listDeptCd = new ArrayList<String>();
		...
		try{
    		...
    		List listYeta2900 = yeta6900ExcelService.selectXlsPayr0485List(payr0485SrhVo);
			...
			ArrayList<Payr0485_2021_VO> cols = new ArrayList<Payr0485_2021_VO>();	
//			for (int j = 0; j < 5; j++) {
			    ...
			    for(int i=0; i<listYeta2900.size(); i++){
		    		...
		    		cols.add(new Payr0485_2021_VO(strPayItemCd,strPayItemNm, "0"));
		    	} 		
...
//			}
    	...
    	return new ModelAndView("yeta690001TemExcelView", map);
     ...
     * @throws Exception
     */
    @RequestMapping(value="/exp/XlsTemYeta690002Export.do")
    public ModelAndView xlsYeta6900Export02(@ModelAttribute("Payr0485Srh_2021_VO") Payr0485Srh_2021_VO Payr0485SrhVO, HttpServletRequest request ,ModelMap model) 
                    throws Exception {  
    	
    	String method = calledClass + ".xlsYeta6900Export02";
...
//    	List<String> listDeptCd = new ArrayList<String>();
		...
		try{
    		...
    		List listYeta6900 = yeta6900ExcelService.selectXlsPayr0485List(payr0485SrhVo);
    		
			map = new HashMap<String, Object>();
			map.put("listYeta6900", listYeta6900);
    	...
    	return new ModelAndView("yeta690002TemExcelView", map);
     ...
     */
    @RequestMapping(value = "/imp/XlsReadYeta690001Import.do", method = RequestMethod.POST)
    public String handleFormUpload01(@RequestParam("yeta6900flUp") MultipartFile file,
			Model model, final HttpServletRequest request) throws InvalidFormatException, IOException, SAXException {
    	
    	
    	String realPath = request.getSession().getServletContext().getRealPath(""); 
    	String xmlConfig2 = "/upXmlConfig/YETA/Yeta690001Mapping.xml";
		...
		List<Pyyt0302_2021_VO> pyyt0302List = new ArrayList<Pyyt0302_2021_VO>();
		List<Pyyt0302_2021_VO> unionPyyt0302List = new ArrayList<Pyyt0302_2021_VO>();
		Collection<Pyyt0302_2021_VO> sumPyyt0302List = new ArrayList<Pyyt0302_2021_VO>();
		
		Pyyt0302_2021_VO pyyt302Vo = new Pyyt0302_2021_VO();
		int iCol = 0;
...
//			System.out.println("xml경로 " + realPath.concat("/WEB-INF" + xmlConfig));
			...
			if(xlsReadStatus.isStatusOK()) {
				...
				for(int i = 0; i <  pyyt0302List.size(); i ++) {
					pyyt302Vo = new Pyyt0302_2021_VO();
...
//		pyyt0302List = new ArrayList<Pyyt0302VO>();
		...
		errPyyt0302List = new ArrayList<Pyyt0302_2021_VO>();
		// 엑셀 업로드 서비스 호출
		errPyyt0302List = yeta6900ExcelService.updateXlsYeta690001(sumPyyt0302List, request);
     ...
     * @throws InvalidFormatException, IOException, SAXException
     */
    @RequestMapping(value = "/imp/XlsReadYeta690002Import.do", method = RequestMethod.POST)
    public String handleFormUpload02(@RequestParam("yeta6900flUp") MultipartFile file,
			Model model, final HttpServletRequest request) throws InvalidFormatException, IOException, SAXException {
    	
    	String realPath = request.getSession().getServletContext().getRealPath(""); 
    	String xmlConfig = "/upXmlConfig/YETA/Yeta690002Mapping.xml";
    	
    	String sResult = "";			//결과 상태값
    	InputStream inputXML = null;	//XML
		InputStream inputXLS = null;	//엑셀파일
		
		List<Pyyt0302Exl_2021_VO> pyyt0302List = new ArrayList<Pyyt0302Exl_2021_VO>();
		Map<String, List> beans = new HashMap<String, List>();
...
//			System.out.println("xml경로 " + realPath.concat("/WEB-INF" + xmlConfig));
			...
			if(xlsReadStatus.isStatusOK()) {
				...
				errPyyt0302List = new ArrayList<Pyyt0302_2021_VO>();
				//엑셀 업로드 서비스 호출
				errPyyt0302List = yeta6900ExcelService.updateXlsYeta690002(pyyt0302List, request);
				sResult =  "/excelPopup/excelYetaList";
...
//    		 f.delete();
     ...
     * @throws Exception
     */
    @RequestMapping(value="/exp/XlsYeta6900Export01.do")
    public ModelAndView XlsYeta6900Export01(@ModelAttribute("Pyyt0304Srh_2021_VO") Pyyt0304Srh_2021_VO pyyt0304SrhVo,HttpServletRequest request ,ModelMap model) 
                    throws Exception { 
      
    	
    	String method = calledClass + ".XlsYeta6900Export2";
	...
	//        payr0304SrhVO.setPyspGrdeCd(MSFSharedUtils.allowNulls(param.get("pyspGrdeCd"))); //호봉등급코드
	       ...
	       // pyyt0304SrhVo.setPymtDducDivCd(MSFSharedUtils.allowNulls(pyyt0304SrhVo.getPymtDducDivCd()));	//지급공제구분
	        ...
	        List<Pyyt0304_2021_VO> listYeta6900 = yeta6900ExcelService.selectXlsPyyt0304List01(pyyt0304SrhVo);
	        List listYeta6900Str = new ArrayList<String>();
	        
//	        String nResult = AnyCryptUtils.XecureCryptInitialize(RemoteServiceUtil.getThreadLocalConfig(),RemoteServiceUtil.getThreadLocalRequest());
	    	for(int i=0; i<listYeta6900.size(); i++){
	    		
	    		Pyyt0304_2021_VO pyyt0304Vo = new Pyyt0304_2021_VO();
	    		
	    		pyyt0304Vo = (Pyyt0304_2021_VO) listYeta6900.get(i);
	    		...
	    		listYeta6900Str.add(pyyt0304Vo);
...
//	        Map<String, Object> map = new HashMap<String, Object>();
	        map = new HashMap<String, Object>();
	        map.put("listYeta6900", listYeta6900Str);
        ...
        return new ModelAndView("yeta690001ExcelView", map);
    }
     ...
     * @throws Exception
     */
    @RequestMapping(value="/exp/XlsYeta6900Export02.do")
    public ModelAndView XlsYeta6900Export02(@ModelAttribute("Pyyt0304Srh_2021_VO") Pyyt0304Srh_2021_VO pyyt0304SrhVO,HttpServletRequest request ,ModelMap model) 
                    throws Exception { 
...
//	        EgovMap listPayr42001 = yeta2900ExcelService.selectXlsPyyt0304List1(pyyt0304SrhVO);
	        List<EgovMap> listPayr4200 = yeta6900ExcelService.selectXlsPyyt0304List2(pyyt0304SrhVO);
...
//	        Map<String, Object> map = new HashMap<String, Object>();
	        map = new HashMap<String, Object>();
	        map.put("listYeta6900", excelList);
...
//	        map.put("rflctnBgnnDt", listPayr42001.get("rflctnBgnnDt"));
        ...
        return new ModelAndView("yeta690002ExcelView", map);
