...
public class Yeta590001ExcelView extends AbstractExcelView {
    ...
    protected void buildExcelDocument(Map<String, Object> model,
        ...
        List<Pyyt0304_2020_VO>  listYeta1900 = (List<Pyyt0304_2020_VO>) model.get("listYeta5900");
  
 
        for (int i = 0; i < listYeta1900.size(); i++) {
        
        	  Pyyt0304_2020_VO pyyt0304Vo = new Pyyt0304_2020_VO();
              pyyt0304Vo = (Pyyt0304_2020_VO)listYeta1900.get(i);
