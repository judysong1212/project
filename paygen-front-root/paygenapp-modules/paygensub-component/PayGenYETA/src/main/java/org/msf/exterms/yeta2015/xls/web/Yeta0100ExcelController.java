...
@Controller
public class Yeta0100ExcelController {


    private static final Logger logger = LoggerFactory.getLogger(Yeta0100ExcelController.class);  
    private static final String calledClass = Yeta0100ExcelController.class.getName();
 
    
    @Resource(name = "yeta0100ExcelService")
    private Yeta0100ExcelService yeta0100ExcelService;
     ...
     * @throws Exception
     */
    @RequestMapping(value="/exp/XlsYeta0100Export.do")
    public ModelAndView xlsYeta3900Export(@ModelAttribute("Yeta2000SrhVO") Yeta2000SrhVO yeta2000SrhVO, HttpServletRequest request ,ModelMap model) 
                    throws Exception {  
		...
		try{
	        ...
	        List  listYeta2000 = yeta0100ExcelService.selectYeta0100ToYeta2000List(yeta2000SrhVO);
