...
@Controller
public class Yeta1500ExcelController {


    private static final Logger logger = LoggerFactory.getLogger(Yeta1500ExcelController.class);  
    private static final String calledClass = Yeta1500ExcelController.class.getName();
 
    
    @Resource(name = "yeta1500ExcelService")
    private Yeta1500ExcelService yeta1500ExcelService;
     ...
     * @throws Exception
     */
    @RequestMapping(value="/exp/XlsYeta1500Export.do")
    public ModelAndView xlsYeta2000Export(@ModelAttribute("Yeta2000SrhVO") Yeta2000SrhVO yeta2000SrhVO, HttpServletRequest request ,ModelMap model) 
		...
		try{
	        ...
	        List  listYeta2000 = yeta1500ExcelService.selectYeta0500ToYeta2000List(yeta2000SrhVO);
