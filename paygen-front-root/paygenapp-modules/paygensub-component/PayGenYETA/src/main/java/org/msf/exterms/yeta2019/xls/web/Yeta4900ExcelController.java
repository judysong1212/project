...
import org.msf.exterms.yeta2019.xls.service.Yeta4900ExcelService;
...
import com.app.exterms.yearendtax.server.vo.Payr0485Srh_2019_VO;
import com.app.exterms.yearendtax.server.vo.Payr0485_2019_VO;
...
@Controller
public class Yeta4900ExcelController {


    private static final Logger logger = LoggerFactory.getLogger(Yeta4900ExcelController.class);  
    private static final String calledClass = Yeta4900ExcelController.class.getName();
 
    
    @Resource(name = "yeta4900ExcelService")
    private Yeta4900ExcelService yeta4900ExcelService;

    /** EgovPropertyService */
    @Resource(name = "propertiesService")
    protected EgovPropertyService propertiesService;
    
    private List<Pyyt0302_2019_VO> errPyyt0302List = new ArrayList<Pyyt0302_2019_VO>();
     ...
     * @throws Exception
     */
    @RequestMapping(value="/exp/XlsTemYeta490001Export.do")
    public ModelAndView xlsYeta4900Export01(@ModelAttribute("Payr0485Srh_2019_VO") Payr0485Srh_2019_VO Payr0485SrhVO, HttpServletRequest request ,ModelMap model) 
                    throws Exception {  
    	
    	String method = calledClass + ".xlsYeta4900Export01";
...
//    	List<String> listDeptCd = new ArrayList<String>();
		...
		try{
    		...
    		List listYeta2900 = yeta4900ExcelService.selectXlsPayr0485List(payr0485SrhVo);
			...
			ArrayList<Payr0485_2019_VO> cols = new ArrayList<Payr0485_2019_VO>();	
//			for (int j = 0; j < 5; j++) {
			    ...
			    for(int i=0; i<listYeta2900.size(); i++){
		    		...
		    		cols.add(new Payr0485_2019_VO(strPayItemCd,strPayItemNm, "0"));
		    	} 		
...
//			}
    	...
    	return new ModelAndView("yeta490001TemExcelView", map);
     ...
     * @throws Exception
     */
    @RequestMapping(value="/exp/XlsTemYeta490002Export.do")
    public ModelAndView xlsYeta4900Export02(@ModelAttribute("Payr0485Srh_2019_VO") Payr0485Srh_2019_VO Payr0485SrhVO, HttpServletRequest request ,ModelMap model) 
                    throws Exception {  
    	
    	String method = calledClass + ".xlsYeta4900Export02";
...
//    	List<String> listDeptCd = new ArrayList<String>();
		...
		try{
    		...
    		List listYeta4900 = yeta4900ExcelService.selectXlsPayr0485List(payr0485SrhVo);
    		
			map = new HashMap<String, Object>();
			map.put("listYeta4900", listYeta4900);
    	...
    	return new ModelAndView("yeta490002TemExcelView", map);
     ...
     */
    @RequestMapping(value = "/imp/XlsReadYeta490001Import.do", method = RequestMethod.POST)
    public String handleFormUpload01(@RequestParam("yeta4900flUp") MultipartFile file,
			Model model, final HttpServletRequest request) throws InvalidFormatException, IOException, SAXException {
    	
    	
    	String realPath = request.getSession().getServletContext().getRealPath(""); 
    	String xmlConfig2 = "/upXmlConfig/YETA/Yeta490001Mapping.xml";
		...
		List<Pyyt0302_2019_VO> pyyt0302List = new ArrayList<Pyyt0302_2019_VO>();
		List<Pyyt0302_2019_VO> unionPyyt0302List = new ArrayList<Pyyt0302_2019_VO>();
		Collection<Pyyt0302_2019_VO> sumPyyt0302List = new ArrayList<Pyyt0302_2019_VO>();
		
		Pyyt0302_2019_VO pyyt302Vo = new Pyyt0302_2019_VO();
		int iCol = 0;
...
//			System.out.println("xml경로 " + realPath.concat("/WEB-INF" + xmlConfig));
			...
			if(xlsReadStatus.isStatusOK()) {
				...
				for(int i = 0; i <  pyyt0302List.size(); i ++) {
					pyyt302Vo = new Pyyt0302_2019_VO();
...
//		pyyt0302List = new ArrayList<Pyyt0302VO>();
		...
		errPyyt0302List = new ArrayList<Pyyt0302_2019_VO>();
		// 엑셀 업로드 서비스 호출
		errPyyt0302List = yeta4900ExcelService.updateXlsYeta490001(sumPyyt0302List, request);
     ...
     * @throws InvalidFormatException, IOException, SAXException
     */
    @RequestMapping(value = "/imp/XlsReadYeta490002Import.do", method = RequestMethod.POST)
    public String handleFormUpload02(@RequestParam("yeta4900flUp") MultipartFile file,
			Model model, final HttpServletRequest request) throws InvalidFormatException, IOException, SAXException {
    	
    	String realPath = request.getSession().getServletContext().getRealPath(""); 
    	String xmlConfig = "/upXmlConfig/YETA/Yeta490002Mapping.xml";
    	
    	String sResult = "";			//결과 상태값
    	InputStream inputXML = null;	//XML
		InputStream inputXLS = null;	//엑셀파일
		
		List<Pyyt0302Exl_2019_VO> pyyt0302List = new ArrayList<Pyyt0302Exl_2019_VO>();
		Map<String, List> beans = new HashMap<String, List>();
...
//			System.out.println("xml경로 " + realPath.concat("/WEB-INF" + xmlConfig));
			...
			if(xlsReadStatus.isStatusOK()) {
				...
				errPyyt0302List = new ArrayList<Pyyt0302_2019_VO>();
				//엑셀 업로드 서비스 호출
				errPyyt0302List = yeta4900ExcelService.updateXlsYeta490002(pyyt0302List, request);
				sResult =  "/excelPopup/excelYetaList";
...
//    		 f.delete();
     ...
     * @throws Exception
     */
    @RequestMapping(value="/exp/XlsYeta4900Export01.do")
    public ModelAndView XlsYeta4900Export01(@ModelAttribute("Pyyt0304Srh_2019_VO") Pyyt0304Srh_2019_VO pyyt0304SrhVo,HttpServletRequest request ,ModelMap model) 
                    throws Exception { 
      
    	
    	String method = calledClass + ".XlsYeta4900Export2";
	...
	//        payr0304SrhVO.setPyspGrdeCd(MSFSharedUtils.allowNulls(param.get("pyspGrdeCd"))); //호봉등급코드
	       ...
	       // pyyt0304SrhVo.setPymtDducDivCd(MSFSharedUtils.allowNulls(pyyt0304SrhVo.getPymtDducDivCd()));	//지급공제구분
	        ...
	        List<Pyyt0304_2019_VO> listYeta4900 = yeta4900ExcelService.selectXlsPyyt0304List01(pyyt0304SrhVo);
	        List listYeta4900Str = new ArrayList<String>();
	        
//	        String nResult = AnyCryptUtils.XecureCryptInitialize(RemoteServiceUtil.getThreadLocalConfig(),RemoteServiceUtil.getThreadLocalRequest());
	    	for(int i=0; i<listYeta4900.size(); i++){
	    		
	    		Pyyt0304_2019_VO pyyt0304Vo = new Pyyt0304_2019_VO();
	    		
	    		pyyt0304Vo = (Pyyt0304_2019_VO) listYeta4900.get(i);
	    		...
	    		listYeta4900Str.add(pyyt0304Vo);
...
//	        Map<String, Object> map = new HashMap<String, Object>();
	        map = new HashMap<String, Object>();
	        map.put("listYeta4900", listYeta4900Str);
        ...
        return new ModelAndView("yeta490001ExcelView", map);
    }
     ...
     * @throws Exception
     */
    @RequestMapping(value="/exp/XlsYeta4900Export02.do")
    public ModelAndView XlsYeta4900Export02(@ModelAttribute("Pyyt0304Srh_2019_VO") Pyyt0304Srh_2019_VO pyyt0304SrhVO,HttpServletRequest request ,ModelMap model) 
                    throws Exception { 
...
//	        EgovMap listPayr42001 = yeta2900ExcelService.selectXlsPyyt0304List1(pyyt0304SrhVO);
	        List<EgovMap> listPayr4200 = yeta4900ExcelService.selectXlsPyyt0304List2(pyyt0304SrhVO);
...
//	        Map<String, Object> map = new HashMap<String, Object>();
	        map = new HashMap<String, Object>();
	        map.put("listYeta4900", excelList);
...
//	        map.put("rflctnBgnnDt", listPayr42001.get("rflctnBgnnDt"));
        ...
        return new ModelAndView("yeta490002ExcelView", map);
