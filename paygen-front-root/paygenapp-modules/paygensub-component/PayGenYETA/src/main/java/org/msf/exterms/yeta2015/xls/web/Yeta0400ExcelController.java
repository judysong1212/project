...
@Controller
public class Yeta0400ExcelController {


    private static final Logger logger = LoggerFactory.getLogger(Yeta0400ExcelController.class);  
    private static final String calledClass = Yeta0400ExcelController.class.getName();
 
    
    @Resource(name = "yeta0400ExcelService")
    private Yeta0400ExcelService yeta0400ExcelService;
     ...
     * @throws Exception
     */
    @RequestMapping(value="/exp/XlsYeta0400Export.do")
    public ModelAndView xlsYeta2000Export(@ModelAttribute("Yeta2000SrhVO") Yeta2000SrhVO yeta2000SrhVO, HttpServletRequest request ,ModelMap model) 
		...
		try{
	        ...
	        List  listYeta0400 = yeta0400ExcelService.selectYeta0400ToYeta2000List(yeta2000SrhVO);
	        
	        
			List<EgovMap> excelList = new ArrayList<EgovMap>();

	    	for(int i=0; i<listYeta0400.size(); i++){
	    		EgovMap eMap  = new EgovMap();
	    		eMap = (EgovMap) listYeta0400.get(i);
	    		// TODO 주민번호
...
//	        Map<String, Object> map = new HashMap<String, Object>();
        ...
        return new ModelAndView("yeta0400ExcelView", map);
