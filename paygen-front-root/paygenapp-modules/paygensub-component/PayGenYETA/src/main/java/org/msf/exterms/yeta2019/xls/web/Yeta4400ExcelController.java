...
@Controller
public class Yeta4400ExcelController {


    private static final Logger logger = LoggerFactory.getLogger(Yeta4400ExcelController.class);  
    private static final String calledClass = Yeta4400ExcelController.class.getName();
 
    
    @Resource(name = "Yeta4400ExcelService")
    private Yeta4400ExcelService yeta4400ExcelService;
     ...
     * @throws Exception
     */
    @RequestMapping(value="/exp/XlsYeta4400Export.do")
    public ModelAndView xlsYeta4400Export(@ModelAttribute("Ye161010Srh_2019_VO") Ye161010Srh_2019_VO ye161010SrhVo, HttpServletRequest request ,ModelMap model) 
                    throws Exception {  
    	
    	String method = calledClass + ".xlsYeta4400Export";
		...
		try{
	        ...
	        List listYeta4400 = yeta4400ExcelService.selectYeta4400ToYeta4400List(ye161010SrhVo);
	        
	        
			List<EgovMap> excelList = new ArrayList<EgovMap>();

	    	for(int i=0; i<listYeta4400.size(); i++){
	    		EgovMap eMap  = new EgovMap();
	    		eMap = (EgovMap) listYeta4400.get(i);
	    		// TODO 주민번호
...
//	        Map<String, Object> map = new HashMap<String, Object>();
        ...
        return new ModelAndView("yeta4400ExcelView", map);
