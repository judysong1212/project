package org.msf.exterms.yeta2020.xls.web;
...
import org.msf.exterms.yeta2020.xls.service.Yeta5900ExcelService;
...
import com.app.exterms.yearendtax.server.vo.Pyyt0302Exl_2020_VO;
...
@Controller
public class Yeta5900ExcelController {


    private static final Logger logger = LoggerFactory.getLogger(Yeta5900ExcelController.class);  
    private static final String calledClass = Yeta5900ExcelController.class.getName();
 
    
    @Resource(name = "yeta5900ExcelService")
    private Yeta5900ExcelService yeta5900ExcelService;

    /** EgovPropertyService */
    @Resource(name = "propertiesService")
    protected EgovPropertyService propertiesService;
    
    private List<Pyyt0302_2020_VO> errPyyt0302List = new ArrayList<Pyyt0302_2020_VO>();
     ...
     * @throws Exception
     */
    @RequestMapping(value="/exp/XlsTemYeta590001Export.do")
    public ModelAndView xlsYeta5900Export01(@ModelAttribute("Payr0485Srh_2020_VO") Payr0485Srh_2020_VO Payr0485SrhVO, HttpServletRequest request ,ModelMap model) 
                    throws Exception {  
    	
    	String method = calledClass + ".xlsYeta5900Export01";
...
//    	List<String> listDeptCd = new ArrayList<String>();
		...
		try{
    		...
    		List listYeta2900 = yeta5900ExcelService.selectXlsPayr0485List(payr0485SrhVo);
			...
			ArrayList<Payr0485_2020_VO> cols = new ArrayList<Payr0485_2020_VO>();	
//			for (int j = 0; j < 5; j++) {
			    ...
			    for(int i=0; i<listYeta2900.size(); i++){
		    		...
		    		cols.add(new Payr0485_2020_VO(strPayItemCd,strPayItemNm, "0"));
		    	} 		
...
//			}
    	...
    	return new ModelAndView("yeta590001TemExcelView", map);
     ...
     * @throws Exception
     */
    @RequestMapping(value="/exp/XlsTemYeta590002Export.do")
    public ModelAndView xlsYeta5900Export02(@ModelAttribute("Payr0485Srh_2020_VO") Payr0485Srh_2020_VO Payr0485SrhVO, HttpServletRequest request ,ModelMap model) 
                    throws Exception {  
    	
    	String method = calledClass + ".xlsYeta5900Export02";
...
//    	List<String> listDeptCd = new ArrayList<String>();
		...
		try{
    		...
    		List listYeta5900 = yeta5900ExcelService.selectXlsPayr0485List(payr0485SrhVo);
    		
			map = new HashMap<String, Object>();
			map.put("listYeta5900", listYeta5900);
    	...
    	return new ModelAndView("yeta590002TemExcelView", map);
     ...
     */
    @RequestMapping(value = "/imp/XlsReadYeta590001Import.do", method = RequestMethod.POST)
    public String handleFormUpload01(@RequestParam("yeta5900flUp") MultipartFile file,
			Model model, final HttpServletRequest request) throws InvalidFormatException, IOException, SAXException {
    	
    	
    	String realPath = request.getSession().getServletContext().getRealPath(""); 
    	String xmlConfig2 = "/upXmlConfig/YETA/Yeta590001Mapping.xml";
		...
		List<Pyyt0302_2020_VO> pyyt0302List = new ArrayList<Pyyt0302_2020_VO>();
		List<Pyyt0302_2020_VO> unionPyyt0302List = new ArrayList<Pyyt0302_2020_VO>();
		Collection<Pyyt0302_2020_VO> sumPyyt0302List = new ArrayList<Pyyt0302_2020_VO>();
		
		Pyyt0302_2020_VO pyyt302Vo = new Pyyt0302_2020_VO();
		int iCol = 0;
...
//			System.out.println("xml경로 " + realPath.concat("/WEB-INF" + xmlConfig));
			...
			if(xlsReadStatus.isStatusOK()) {
				...
				for(int i = 0; i <  pyyt0302List.size(); i ++) {
					pyyt302Vo = new Pyyt0302_2020_VO();
...
//		pyyt0302List = new ArrayList<Pyyt0302VO>();
		...
		errPyyt0302List = new ArrayList<Pyyt0302_2020_VO>();
		// 엑셀 업로드 서비스 호출
		errPyyt0302List = yeta5900ExcelService.updateXlsYeta590001(sumPyyt0302List, request);
     ...
     * @throws InvalidFormatException, IOException, SAXException
     */
    @RequestMapping(value = "/imp/XlsReadYeta590002Import.do", method = RequestMethod.POST)
    public String handleFormUpload02(@RequestParam("yeta5900flUp") MultipartFile file,
			Model model, final HttpServletRequest request) throws InvalidFormatException, IOException, SAXException {
    	
    	String realPath = request.getSession().getServletContext().getRealPath(""); 
    	String xmlConfig = "/upXmlConfig/YETA/Yeta590002Mapping.xml";
    	
    	String sResult = "";			//결과 상태값
    	InputStream inputXML = null;	//XML
		InputStream inputXLS = null;	//엑셀파일
		
		List<Pyyt0302Exl_2020_VO> pyyt0302List = new ArrayList<Pyyt0302Exl_2020_VO>();
		Map<String, List> beans = new HashMap<String, List>();
...
//			System.out.println("xml경로 " + realPath.concat("/WEB-INF" + xmlConfig));
			...
			if(xlsReadStatus.isStatusOK()) {
				...
				errPyyt0302List = new ArrayList<Pyyt0302_2020_VO>();
				//엑셀 업로드 서비스 호출
				errPyyt0302List = yeta5900ExcelService.updateXlsYeta590002(pyyt0302List, request);
				sResult =  "/excelPopup/excelYetaList";
	 ...
	 * @throws Exception
	 */
    @RequestMapping(value="/yeta/excelYeta2020List.do")
...
//    		 f.delete();
     ...
     * @throws Exception
     */
    @RequestMapping(value="/exp/XlsYeta5900Export01.do")
    public ModelAndView XlsYeta5900Export01(@ModelAttribute("Pyyt0304Srh_2020_VO") Pyyt0304Srh_2020_VO pyyt0304SrhVo,HttpServletRequest request ,ModelMap model) 
                    throws Exception { 
      
    	
    	String method = calledClass + ".XlsYeta5900Export2";
	...
	//        payr0304SrhVO.setPyspGrdeCd(MSFSharedUtils.allowNulls(param.get("pyspGrdeCd"))); //호봉등급코드
	       ...
	       // pyyt0304SrhVo.setPymtDducDivCd(MSFSharedUtils.allowNulls(pyyt0304SrhVo.getPymtDducDivCd()));	//지급공제구분
	        ...
	        List<Pyyt0304_2020_VO> listYeta5900 = yeta5900ExcelService.selectXlsPyyt0304List01(pyyt0304SrhVo);
	        List listYeta5900Str = new ArrayList<String>();
	        
//	        String nResult = AnyCryptUtils.XecureCryptInitialize(RemoteServiceUtil.getThreadLocalConfig(),RemoteServiceUtil.getThreadLocalRequest());
	    	for(int i=0; i<listYeta5900.size(); i++){
	    		
	    		Pyyt0304_2020_VO pyyt0304Vo = new Pyyt0304_2020_VO();
	    		
	    		pyyt0304Vo = (Pyyt0304_2020_VO) listYeta5900.get(i);
	    		...
	    		listYeta5900Str.add(pyyt0304Vo);
...
//	        Map<String, Object> map = new HashMap<String, Object>();
	        map = new HashMap<String, Object>();
	        map.put("listYeta5900", listYeta5900Str);
        ...
        return new ModelAndView("yeta590001ExcelView", map);
    }
     ...
     * @throws Exception
     */
    @RequestMapping(value="/exp/XlsYeta5900Export02.do")
    public ModelAndView XlsYeta5900Export02(@ModelAttribute("Pyyt0304Srh_2020_VO") Pyyt0304Srh_2020_VO pyyt0304SrhVO,HttpServletRequest request ,ModelMap model) 
                    throws Exception { 
...
//	        EgovMap listPayr42001 = yeta2900ExcelService.selectXlsPyyt0304List1(pyyt0304SrhVO);
	        List<EgovMap> listPayr4200 = yeta5900ExcelService.selectXlsPyyt0304List2(pyyt0304SrhVO);
...
//	        Map<String, Object> map = new HashMap<String, Object>();
	        map = new HashMap<String, Object>();
	        map.put("listYeta5900", excelList);
...
//	        map.put("rflctnBgnnDt", listPayr42001.get("rflctnBgnnDt"));
        ...
        return new ModelAndView("yeta590002ExcelView", map);
