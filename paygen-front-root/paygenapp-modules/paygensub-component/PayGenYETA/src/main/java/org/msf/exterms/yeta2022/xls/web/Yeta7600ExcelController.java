...
@Controller
public class Yeta7600ExcelController {


    private static final Logger logger = LoggerFactory.getLogger(Yeta7600ExcelController.class);  
    private static final String calledClass = Yeta7600ExcelController.class.getName();
 
    
    @Resource(name = "yeta7600ExcelService")
    private Yeta7600ExcelService yeta7600ExcelService;
     ...
     * @throws Exception
     */
    @RequestMapping(value="/exp/XlsYeta7600Export.do")
    public ModelAndView xlsYeta7600Export(@ModelAttribute("Ye161010Srh_2022_VO") Ye161010Srh_2022_VO ye161010SrhVo, HttpServletRequest request ,ModelMap model) 
                    throws Exception {  
    	
    	String method = calledClass + "xlsYeta3000Export";
    	
    	String windowNm = "근로소득 원천징수영수증";
		String windowId = "Yeta7600";
		...
		try{
	        ...
	        List listYeta3000 = yeta7600ExcelService.selectYeta7600ToYeta3000List(ye161010SrhVo);
...
//	        Map<String, Object> map = new HashMap<String, Object>();
        ...
        return new ModelAndView("Yeta7600ExcelView", map);
