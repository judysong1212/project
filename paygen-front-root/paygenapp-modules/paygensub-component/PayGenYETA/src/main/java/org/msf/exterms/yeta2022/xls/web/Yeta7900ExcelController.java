...
import com.app.exterms.yearendtax.server.vo.Payr0485Srh_2022_VO;
import com.app.exterms.yearendtax.server.vo.Payr0485_2022_VO;
...
@Controller
public class Yeta7900ExcelController {


    private static final Logger logger = LoggerFactory.getLogger(Yeta7900ExcelController.class);  
    private static final String calledClass = Yeta7900ExcelController.class.getName();
 
    
    @Resource(name = "yeta7900ExcelService")
    private Yeta7900ExcelService yeta7900ExcelService;

    /** EgovPropertyService */
    @Resource(name = "propertiesService")
    protected EgovPropertyService propertiesService;
    
    private List<Pyyt0302_2022_VO> errPyyt0302List = new ArrayList<Pyyt0302_2022_VO>();
     ...
     * @throws Exception
     */
    @RequestMapping(value="/exp/XlsTemYeta790001Export.do")
    public ModelAndView xlsYeta7900Export01(@ModelAttribute("Payr0485Srh_2022_VO") Payr0485Srh_2022_VO Payr0485SrhVO, HttpServletRequest request ,ModelMap model) 
                    throws Exception {  
    	
    	String method = calledClass + ".xlsYeta7900Export01";
...
//    	List<String> listDeptCd = new ArrayList<String>();
		...
		try{
    		...
    		List listYeta2900 = yeta7900ExcelService.selectXlsPayr0485List(payr0485SrhVo);
			...
			ArrayList<Payr0485_2022_VO> cols = new ArrayList<Payr0485_2022_VO>();	
//			for (int j = 0; j < 5; j++) {
			    ...
			    for(int i=0; i<listYeta2900.size(); i++){
		    		...
		    		cols.add(new Payr0485_2022_VO(strPayItemCd,strPayItemNm, "0"));
		    	} 		
...
//			}
    	...
    	return new ModelAndView("yeta790001TemExcelView", map);
     ...
     * @throws Exception
     */
    @RequestMapping(value="/exp/XlsTemYeta790002Export.do")
    public ModelAndView xlsYeta7900Export02(@ModelAttribute("Payr0485Srh_2022_VO") Payr0485Srh_2022_VO Payr0485SrhVO, HttpServletRequest request ,ModelMap model) 
                    throws Exception {  
    	
    	String method = calledClass + ".xlsYeta7900Export02";
...
//    	List<String> listDeptCd = new ArrayList<String>();
		...
		try{
    		...
    		List listYeta7900 = yeta7900ExcelService.selectXlsPayr0485List(payr0485SrhVo);
    		
			map = new HashMap<String, Object>();
			map.put("listYeta7900", listYeta7900);
    	...
    	return new ModelAndView("yeta790002TemExcelView", map);
     ...
     */
    @RequestMapping(value = "/imp/XlsReadYeta790001Import.do", method = RequestMethod.POST)
    public String handleFormUpload01(@RequestParam("yeta7900flUp") MultipartFile file,
			Model model, final HttpServletRequest request) throws InvalidFormatException, IOException, SAXException {
    	
    	
    	String realPath = request.getSession().getServletContext().getRealPath(""); 
    	String xmlConfig2 = "/upXmlConfig/YETA/Yeta790001Mapping.xml";
		...
		List<Pyyt0302_2022_VO> pyyt0302List = new ArrayList<Pyyt0302_2022_VO>();
		List<Pyyt0302_2022_VO> unionPyyt0302List = new ArrayList<Pyyt0302_2022_VO>();
		Collection<Pyyt0302_2022_VO> sumPyyt0302List = new ArrayList<Pyyt0302_2022_VO>();
		
		Pyyt0302_2022_VO pyyt302Vo = new Pyyt0302_2022_VO();
		int iCol = 0;
...
//			System.out.println("xml경로 " + realPath.concat("/WEB-INF" + xmlConfig));
			...
			if(xlsReadStatus.isStatusOK()) {
				...
				for(int i = 0; i <  pyyt0302List.size(); i ++) {
					pyyt302Vo = new Pyyt0302_2022_VO();
...
//		pyyt0302List = new ArrayList<Pyyt0302VO>();
		...
		errPyyt0302List = new ArrayList<Pyyt0302_2022_VO>();
		// 엑셀 업로드 서비스 호출
		errPyyt0302List = yeta7900ExcelService.updateXlsYeta790001(sumPyyt0302List, request);
     ...
     * @throws InvalidFormatException, IOException, SAXException
     */
    @RequestMapping(value = "/imp/XlsReadYeta790002Import.do", method = RequestMethod.POST)
    public String handleFormUpload02(@RequestParam("yeta7900flUp") MultipartFile file,
			Model model, final HttpServletRequest request) throws InvalidFormatException, IOException, SAXException {
    	
    	String realPath = request.getSession().getServletContext().getRealPath(""); 
    	String xmlConfig = "/upXmlConfig/YETA/Yeta790002Mapping.xml";
    	
    	String sResult = "";			//결과 상태값
    	InputStream inputXML = null;	//XML
		InputStream inputXLS = null;	//엑셀파일
		
		List<Pyyt0302Exl_2022_VO> pyyt0302List = new ArrayList<Pyyt0302Exl_2022_VO>();
		Map<String, List> beans = new HashMap<String, List>();
...
//			System.out.println("xml경로 " + realPath.concat("/WEB-INF" + xmlConfig));
			...
			if(xlsReadStatus.isStatusOK()) {
				...
				errPyyt0302List = new ArrayList<Pyyt0302_2022_VO>();
				//엑셀 업로드 서비스 호출
				errPyyt0302List = yeta7900ExcelService.updateXlsYeta790002(pyyt0302List, request);
				sResult =  "/excelPopup/excelYetaList";
	 ...
	 * @throws Exception
	 */
    @RequestMapping(value="/yeta/excelYeta2022List.do")
...
//    		 f.delete();
     ...
     * @throws Exception
     */
    @RequestMapping(value="/exp/XlsYeta7900Export01.do")
    public ModelAndView XlsYeta7900Export01(@ModelAttribute("Pyyt0304Srh_2022_VO") Pyyt0304Srh_2022_VO pyyt0304SrhVo,HttpServletRequest request ,ModelMap model) 
                    throws Exception { 
      
    	
    	String method = calledClass + ".XlsYeta7900Export2";
	...
	//        payr0304SrhVO.setPyspGrdeCd(MSFSharedUtils.allowNulls(param.get("pyspGrdeCd"))); //호봉등급코드
	       ...
	       // pyyt0304SrhVo.setPymtDducDivCd(MSFSharedUtils.allowNulls(pyyt0304SrhVo.getPymtDducDivCd()));	//지급공제구분
	        ...
	        List<Pyyt0304_2022_VO> listYeta7900 = yeta7900ExcelService.selectXlsPyyt0304List01(pyyt0304SrhVo);
	        List listYeta7900Str = new ArrayList<String>();
	        
//	        String nResult = AnyCryptUtils.XecureCryptInitialize(RemoteServiceUtil.getThreadLocalConfig(),RemoteServiceUtil.getThreadLocalRequest());
	    	for(int i=0; i<listYeta7900.size(); i++){
	    		
	    		Pyyt0304_2022_VO pyyt0304Vo = new Pyyt0304_2022_VO();
	    		
	    		pyyt0304Vo = (Pyyt0304_2022_VO) listYeta7900.get(i);
	    		...
	    		listYeta7900Str.add(pyyt0304Vo);
...
//	        Map<String, Object> map = new HashMap<String, Object>();
	        map = new HashMap<String, Object>();
	        map.put("listYeta7900", listYeta7900Str);
        ...
        return new ModelAndView("yeta790001ExcelView", map);
    }
     ...
     * @throws Exception
     */
    @RequestMapping(value="/exp/XlsYeta7900Export02.do")
    public ModelAndView XlsYeta7900Export02(@ModelAttribute("Pyyt0304Srh_2022_VO") Pyyt0304Srh_2022_VO pyyt0304SrhVO,HttpServletRequest request ,ModelMap model) 
                    throws Exception { 
...
//	        EgovMap listPayr42001 = yeta2900ExcelService.selectXlsPyyt0304List1(pyyt0304SrhVO);
	        List<EgovMap> listPayr4200 = yeta7900ExcelService.selectXlsPyyt0304List2(pyyt0304SrhVO);
...
//	        Map<String, Object> map = new HashMap<String, Object>();
	        map = new HashMap<String, Object>();
	        map.put("listYeta7900", excelList);
...
//	        map.put("rflctnBgnnDt", listPayr42001.get("rflctnBgnnDt"));
        ...
        return new ModelAndView("yeta790002ExcelView", map);
