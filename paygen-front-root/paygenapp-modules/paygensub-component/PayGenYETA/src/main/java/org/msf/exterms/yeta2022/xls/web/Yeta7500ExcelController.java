...
import org.msf.exterms.yeta2022.xls.service.Yeta7500ExcelService;
...
import com.app.exterms.yearendtax.server.vo.Yeta2000Srh_2022_VO;
...
@Controller
public class Yeta7500ExcelController {


    private static final Logger logger = LoggerFactory.getLogger(Yeta7500ExcelController.class);  
    private static final String calledClass = Yeta7500ExcelController.class.getName();
 
    
    @Resource(name = "yeta7500ExcelService")
    private Yeta7500ExcelService yeta7500ExcelService;
     ...
     * @throws Exception
     */
    @RequestMapping(value="/exp/XlsYeta7500Export.do")
    public ModelAndView xlsYeta7500Export(@ModelAttribute("Ye161010Srh_2022_VO") Ye161010Srh_2022_VO ye161010SrhVo, HttpServletRequest request ,ModelMap model) 
                    throws Exception {  
    	
    	String method = calledClass + "xlsYeta3000Export";
    	
    	String windowNm = "연말정산급여반영";
		String windowId = "YETA7500";
		...
		try{
	        ...
	        List listYeta3000 = yeta7500ExcelService.selectYeta7500ToYeta3000List(ye161010SrhVo);
...
//	        Map<String, Object> map = new HashMap<String, Object>();
        ...
        return new ModelAndView("yeta7500ExcelView", map);
