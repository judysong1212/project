...
@Controller
public class Yeta6400ExcelController {


    private static final Logger logger = LoggerFactory.getLogger(Yeta6400ExcelController.class);  
    private static final String calledClass = Yeta6400ExcelController.class.getName();
 
    
    @Resource(name = "Yeta6400ExcelService")
    private Yeta6400ExcelService yeta6400ExcelService;
     ...
     * @throws Exception
     */
    @RequestMapping(value="/exp/XlsYeta6400Export.do")
    public ModelAndView xlsYeta6400Export(@ModelAttribute("Ye161010Srh_2021_VO") Ye161010Srh_2021_VO ye161010SrhVo, HttpServletRequest request ,ModelMap model) 
                    throws Exception {  
    	
    	String method = calledClass + ".xlsYeta6400Export";
		...
		try{
	        ...
	        List listYeta6400 = yeta6400ExcelService.selectYeta6400ToYeta6400List(ye161010SrhVo);
	        
	        
			List<EgovMap> excelList = new ArrayList<EgovMap>();

	    	for(int i=0; i<listYeta6400.size(); i++){
	    		EgovMap eMap  = new EgovMap();
	    		eMap = (EgovMap) listYeta6400.get(i);
	    		// TODO 주민번호
...
//	        Map<String, Object> map = new HashMap<String, Object>();
        ...
        return new ModelAndView("yeta6400ExcelView", map);
