...
import com.app.exterms.yearendtax.server.vo.Yeta2000Srh_2023_VO;
...
@Controller
public class Yeta8500ExcelController {


    private static final Logger logger = LoggerFactory.getLogger(Yeta8500ExcelController.class);  
    private static final String calledClass = Yeta8500ExcelController.class.getName();
 
    
    @Resource(name = "yeta8500ExcelService")
    private Yeta8500ExcelService yeta8500ExcelService;
     ...
     * @throws Exception
     */
    @RequestMapping(value="/exp/XlsYeta8500Export.do")
    public ModelAndView xlsYeta8500Export(@ModelAttribute("Ye161010Srh_2023_VO") Ye161010Srh_2023_VO ye161010SrhVo, HttpServletRequest request ,ModelMap model) 
                    throws Exception {  
    	
    	String method = calledClass + "xlsYeta3000Export";
    	
    	String windowNm = "연말정산급여반영";
		String windowId = "YETA8500";
		...
		try{
	        ...
	        List listYeta3000 = yeta8500ExcelService.selectYeta8500ToYeta3000List(ye161010SrhVo);
...
//	        Map<String, Object> map = new HashMap<String, Object>();
        ...
        return new ModelAndView("yeta8500ExcelView", map);
