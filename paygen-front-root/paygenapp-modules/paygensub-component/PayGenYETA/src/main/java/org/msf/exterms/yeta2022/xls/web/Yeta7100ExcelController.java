...
@Controller
public class Yeta7100ExcelController {


    private static final Logger logger = LoggerFactory.getLogger(Yeta7100ExcelController.class);  
    private static final String calledClass = Yeta7100ExcelController.class.getName();
 
    
    @Resource(name = "yeta7100ExcelService")
    private Yeta7100ExcelService yeta7100ExcelService;
     ...
     * @throws Exception
     */
    @RequestMapping(value="/exp/XlsYeta7100Export.do")
    public ModelAndView XlsYeta7100Export(@ModelAttribute("Ye161010Srh_2022_VO") Ye161010Srh_2022_VO ye161010SrhVo,HttpServletRequest request ,ModelMap model) 
                    throws Exception { 
    	
    	String method = calledClass + ".XlsYeta7100Export";
...
//	        EgovMap listPayr42001 = yeta1900ExcelService.selectXlsPyyt0304List1(pyyt0304SrhVO);
	        List<EgovMap> listPayr3100 = yeta7100ExcelService.selectXlsYeta7100List(ye161010SrhVo);
			...
			map.put("listYeta7100", excelList);
        ...
        return new ModelAndView("yeta7100ExcelView", map);
