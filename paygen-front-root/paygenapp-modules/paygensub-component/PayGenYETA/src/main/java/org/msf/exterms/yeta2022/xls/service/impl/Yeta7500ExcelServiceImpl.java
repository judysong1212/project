...
@Service("yeta7500ExcelService")
public class Yeta7500ExcelServiceImpl extends AbstractServiceImpl implements Yeta7500ExcelService {
	
//	private static final Logger logger = LoggerFactory.getLogger(Yeta0100ServiceImpl.class);
	private static final String calledClass = Yeta7500ExcelService.class.getName();
     ...
     * @throws Exception
     */
	public List  selectYeta7500ToYeta3000List(Ye161010Srh_2022_VO ye161010SrhVo) throws Exception {
		return ye161010DAO.selectYeta7500ToYeta3000XlsList(ye161010SrhVo);
	}
