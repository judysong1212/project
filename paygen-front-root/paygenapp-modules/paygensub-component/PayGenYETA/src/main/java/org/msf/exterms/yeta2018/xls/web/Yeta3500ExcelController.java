...
import com.app.exterms.yearendtax.server.vo.Yeta2000Srh_2018_VO;
...
@Controller
public class Yeta3500ExcelController {


    private static final Logger logger = LoggerFactory.getLogger(Yeta3500ExcelController.class);  
    private static final String calledClass = Yeta3500ExcelController.class.getName();
 
    
    @Resource(name = "yeta3500ExcelService")
    private Yeta3500ExcelService yeta3500ExcelService;
     ...
     * @throws Exception
     */
    @RequestMapping(value="/exp/XlsYeta3500Export.do")
    public ModelAndView xlsYeta3500Export(@ModelAttribute("Ye161010Srh_2018_VO") Ye161010Srh_2018_VO ye161010SrhVo, HttpServletRequest request ,ModelMap model) 
                    throws Exception {  
		...
		try{
	        ...
	        List  listYeta3000 = yeta3500ExcelService.selectYeta3500ToYeta3000List(ye161010SrhVo);
...
//	        Map<String, Object> map = new HashMap<String, Object>();
        ...
        return new ModelAndView("yeta3500ExcelView", map);
