package org.msf.exterms.yeta2016.xls.web;
...
import org.msf.exterms.yeta2016.xls.service.Yeta1900ExcelService;
...
@Controller
public class Yeta1900ExcelController {


    private static final Logger logger = LoggerFactory.getLogger(Yeta1900ExcelController.class);  
    private static final String calledClass = Yeta1900ExcelController.class.getName();
 
    
    @Resource(name = "yeta1900ExcelService")
    private Yeta1900ExcelService yeta1900ExcelService;

    /** EgovPropertyService */
    @Resource(name = "propertiesService")
    protected EgovPropertyService propertiesService;
    
    private List<Pyyt0302VO> errPyyt0302List = new ArrayList<Pyyt0302VO>();
     ...
     * @throws Exception
     */
    @RequestMapping(value="/exp/XlsTemYeta190001Export.do")
    public ModelAndView xlsYeta1900Export01(@ModelAttribute("Payr0485SrhVO") Payr0485SrhVO Payr0485SrhVO, HttpServletRequest request ,ModelMap model) 
                    throws Exception {  
    	
    	String method = calledClass + ".xlsYeta1900Export01";
...
//    	List<String> listDeptCd = new ArrayList<String>();
		...
		try{
    		...
    		List listYeta1900 = yeta1900ExcelService.selectXlsPayr0485List(payr0485SrhVo);
...
//			}
    	...
    	return new ModelAndView("yeta190001TemExcelView", map);
     ...
     * @throws Exception
     */
    @RequestMapping(value="/exp/XlsTemYeta190002Export.do")
    public ModelAndView xlsYeta1900Export02(@ModelAttribute("Payr0485SrhVO") Payr0485SrhVO Payr0485SrhVO, HttpServletRequest request ,ModelMap model) 
                    throws Exception {  
    	
    	String method = calledClass + ".xlsYeta1900Export02";
...
//    	List<String> listDeptCd = new ArrayList<String>();
		...
		try{
			...
			map = new HashMap<String, Object>();
			map.put("listYeta1900", listYeta1900);
    	...
    	return new ModelAndView("yeta190002TemExcelView", map);
     ...
     */
    @RequestMapping(value = "/imp/XlsReadYeta190001Import.do", method = RequestMethod.POST)
    public String handleFormUpload01(@RequestParam("yeta1900flUp") MultipartFile file,
			Model model, final HttpServletRequest request) throws InvalidFormatException, IOException, SAXException {
    	
    	
    	String realPath = request.getSession().getServletContext().getRealPath(""); 
    	String xmlConfig2 = "/upXmlConfig/YETA/Yeta190001Mapping.xml";
		...
		List<Pyyt0302VO> pyyt0302List = new ArrayList<Pyyt0302VO>();
		List<Pyyt0302VO> unionPyyt0302List = new ArrayList<Pyyt0302VO>();
		Collection<Pyyt0302VO> sumPyyt0302List = new ArrayList<Pyyt0302VO>();
		
		Pyyt0302VO pyyt302Vo = new Pyyt0302VO();
		int iCol = 0;
...
//		pyyt0302List = new ArrayList<Pyyt0302VO>();
		for (int i = 0; i < iCol; i++) {
			...
			try {
				...
				String xmlConfig = "/upXmlConfig/YETA/Yeta190002Mapping_".concat(rndName).concat(".xml");
...
//		System.out.println("그래서 총 리스트의 사이즈는11111?????? " + pyyt0302List.size());		
//		System.out.println("그래서 총 리스트의 사이즈는222222?????? " + sumPyyt0302List.size());
			
		errPyyt0302List = new ArrayList<Pyyt0302VO>();
		// 엑셀 업로드 서비스 호출
		errPyyt0302List = yeta1900ExcelService.updateXlsYeta190001(sumPyyt0302List, request);
		sResult = "/excelPopup/excelList";
     ...
     * @throws InvalidFormatException, IOException, SAXException
     */
    @RequestMapping(value = "/imp/XlsReadYeta190002Import.do", method = RequestMethod.POST)
    public String handleFormUpload02(@RequestParam("yeta1900flUp") MultipartFile file,
			Model model, final HttpServletRequest request) throws InvalidFormatException, IOException, SAXException {
    	
    	String realPath = request.getSession().getServletContext().getRealPath(""); 
    	String xmlConfig = "/upXmlConfig/YETA/Yeta190002Mapping.xml";
    	
    	String sResult = "";			//결과 상태값
    	InputStream inputXML = null;	//XML
		InputStream inputXLS = null;	//엑셀파일
		
		List<Pyyt0302ExlVO> pyyt0302List = new ArrayList<Pyyt0302ExlVO>();
		Map<String, List> beans = new HashMap<String, List>();
...
//			System.out.println("xml경로 " + realPath.concat("/WEB-INF" + xmlConfig));
			...
			if(xlsReadStatus.isStatusOK()) {
				...
				errPyyt0302List = new ArrayList<Pyyt0302VO>();
				//엑셀 업로드 서비스 호출
				errPyyt0302List = yeta1900ExcelService.updateXlsYeta190002(pyyt0302List, request);
				sResult =  "/excelPopup/excelList";
...
//    		 f.delete();
     ...
     * @throws Exception
     */
    @RequestMapping(value="/exp/XlsYeta1900Export01.do")
    public ModelAndView XlsYeta1900Export01(@ModelAttribute("Pyyt0304SrhVO") Pyyt0304SrhVO pyyt0304SrhVo,HttpServletRequest request ,ModelMap model) 
                    throws Exception { 
      
    	
    	String method = calledClass + ".XlsYeta1900Export2";
	...
	//        payr0304SrhVO.setPyspGrdeCd(MSFSharedUtils.allowNulls(param.get("pyspGrdeCd"))); //호봉등급코드
	       ...
	       // pyyt0304SrhVo.setPymtDducDivCd(MSFSharedUtils.allowNulls(pyyt0304SrhVo.getPymtDducDivCd()));	//지급공제구분
	        ...
	        List<Pyyt0304VO> listYeta1900 = yeta1900ExcelService.selectXlsPyyt0304List01(pyyt0304SrhVo);
	        List listYeta1900Str = new ArrayList<String>();
	        
//	        String nResult = AnyCryptUtils.XecureCryptInitialize(RemoteServiceUtil.getThreadLocalConfig(),RemoteServiceUtil.getThreadLocalRequest());
	    	for(int i=0; i<listYeta1900.size(); i++){
	    		
	    		Pyyt0304VO pyyt0304Vo = new Pyyt0304VO();
	    		
	    		pyyt0304Vo = (Pyyt0304VO) listYeta1900.get(i);
	    		...
	    		listYeta1900Str.add(pyyt0304Vo);
...
//	        Map<String, Object> map = new HashMap<String, Object>();
	        map = new HashMap<String, Object>();
	        map.put("listYeta1900", listYeta1900Str);
        ...
        return new ModelAndView("yeta190001ExcelView", map);
    }
     ...
     * @throws Exception
     */
    @RequestMapping(value="/exp/XlsYeta1900Export02.do")
    public ModelAndView XlsYeta1900Export02(@ModelAttribute("Pyyt0304SrhVO") Pyyt0304SrhVO pyyt0304SrhVO,HttpServletRequest request ,ModelMap model) 
                    throws Exception { 
...
//	        EgovMap listPayr42001 = yeta1900ExcelService.selectXlsPyyt0304List1(pyyt0304SrhVO);
	        List<EgovMap> listPayr4200 = yeta1900ExcelService.selectXlsPyyt0304List2(pyyt0304SrhVO);
...
//	        Map<String, Object> map = new HashMap<String, Object>();
	        map = new HashMap<String, Object>();
	        map.put("listYeta1900", excelList);
...
//	        map.put("rflctnBgnnDt", listPayr42001.get("rflctnBgnnDt"));
        ...
        return new ModelAndView("yeta190002ExcelView", map);
