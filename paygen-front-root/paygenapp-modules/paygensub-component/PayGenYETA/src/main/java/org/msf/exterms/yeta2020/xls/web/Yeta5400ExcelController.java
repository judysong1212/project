...
@Controller
public class Yeta5400ExcelController {


    private static final Logger logger = LoggerFactory.getLogger(Yeta5400ExcelController.class);  
    private static final String calledClass = Yeta5400ExcelController.class.getName();
 
    
    @Resource(name = "Yeta5400ExcelService")
    private Yeta5400ExcelService yeta5400ExcelService;
     ...
     * @throws Exception
     */
    @RequestMapping(value="/exp/XlsYeta5400Export.do")
    public ModelAndView xlsYeta5400Export(@ModelAttribute("Ye161010Srh_2020_VO") Ye161010Srh_2020_VO ye161010SrhVo, HttpServletRequest request ,ModelMap model) 
                    throws Exception {  
    	
    	String method = calledClass + ".xlsYeta5400Export";
		...
		try{
	        ...
	        List listYeta5400 = yeta5400ExcelService.selectYeta5400ToYeta5400List(ye161010SrhVo);
	        
	        
			List<EgovMap> excelList = new ArrayList<EgovMap>();

	    	for(int i=0; i<listYeta5400.size(); i++){
	    		EgovMap eMap  = new EgovMap();
	    		eMap = (EgovMap) listYeta5400.get(i);
	    		// TODO 주민번호
...
//	        Map<String, Object> map = new HashMap<String, Object>();
        ...
        return new ModelAndView("yeta5400ExcelView", map);
