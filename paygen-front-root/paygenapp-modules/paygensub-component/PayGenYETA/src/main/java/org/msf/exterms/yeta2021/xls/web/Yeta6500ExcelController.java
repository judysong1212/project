...
import com.app.exterms.yearendtax.server.vo.Yeta2000Srh_2021_VO;
...
@Controller
public class Yeta6500ExcelController {


    private static final Logger logger = LoggerFactory.getLogger(Yeta6500ExcelController.class);  
    private static final String calledClass = Yeta6500ExcelController.class.getName();
 
    
    @Resource(name = "yeta6500ExcelService")
    private Yeta6500ExcelService yeta6500ExcelService;
     ...
     * @throws Exception
     */
    @RequestMapping(value="/exp/XlsYeta6500Export.do")
    public ModelAndView xlsYeta6500Export(@ModelAttribute("Ye161010Srh_2021_VO") Ye161010Srh_2021_VO ye161010SrhVo, HttpServletRequest request ,ModelMap model) 
                    throws Exception {  
    	
    	String method = calledClass + "xlsYeta3000Export";
    	
    	String windowNm = "연말정산급여반영";
		String windowId = "YETA6500";
		...
		try{
	        ...
	        List listYeta3000 = yeta6500ExcelService.selectYeta6500ToYeta3000List(ye161010SrhVo);
...
//	        Map<String, Object> map = new HashMap<String, Object>();
        ...
        return new ModelAndView("yeta6500ExcelView", map);
