...
import com.app.exterms.yearendtax.client.service.yeta2019.YetaT43009Service;
import com.app.exterms.yearendtax.client.service.yeta2019.YetaT43009ServiceAsync;
...
//import com.app.exterms.yearendtax.client.form.defs.yeta2016.YetaT43009Def;
...
=====================================================**/
public  class YetaT43009   extends MSFFormPanel {  
 ...
 **/
	...
	private  ContentPanel cpYetaT43009; 
	...
	// -------------- grid 선언 시작  ---------------	  
	private MSFGridPanel YetaT43009GridPanel;
//	private YetaT43009Def YetaT43009Def = new YetaT43009Def("YetaT43009");   //TODO 일단 화면번호로 Def
	// -------------- grid 선언 종료  ---------------
	...
	// -------------- 서비스 호출 시작 --------------
	private YetaT43009ServiceAsync yetaT43009Service = YetaT43009Service.Util.getInstance();
	// -------------- 서비스 호출 종료 --------------	 
...
//					ye162510Dto.setMnthRnttyHusCnttArea((MSFSharedUtils.allowNulls(bmMapModel.get("mnthRnttyHusCnttArea"))));    		/** column 월세주택계약면적 : mnthRnttyHusCnttArea */
				...
				yetaT43009Service.activityOnYetaT43009(listYe162510Dto, actionDatabase, new AsyncCallback<Long>(){
...
//		 }
	...
	public YetaT43009(final ActionDatabase actionDatabase, final MSFPanel caller) {
...
//		initLoad(); 	
		...
		this.actionDatabase = actionDatabase;
	 	...
	 	cpYetaT43009 = new ContentPanel();  

		createSearchForm();			//기본정보 필드를 적용
	 	createMsfGridForm();		//그리드필드
		   
		cpYetaT43009.setBodyBorder(false);
		cpYetaT43009.setBorders(false);
		cpYetaT43009.setHeaderVisible(false);
		cpYetaT43009.setSize("790px", "640px");
		   
		this.add(cpYetaT43009);
...
//		     });     
		...
		cpYetaT43009.setLayout(new FlowLayout());
...
//	      	     }
//				 
//				YetaT43009GridPanel.getMsfGrid().clearData();
//				 
//				BaseModel bmData = YetaT43009GridPanel.getTableDef().getDefaultValues();  
//		              
...
//		         
//		        YetaT43009GridPanel.getMsfGrid().getGrid().stopEditing();      
//		        YetaT43009GridPanel.getMsfGrid().getGrid().getStore().insert(bmData,0);   
//		        YetaT43009GridPanel.getMsfGrid().getGrid().startEditing(YetaT43009GridPanel.getMsfGrid().getGrid().getStore().indexOf(bmData), 0);   
//
...
//			public void handleEvent(ButtonEvent e) {
//				Iterator<BaseModel> itBm = YetaT43009GridPanel.getMsfGrid().getGrid().getSelectionModel().getSelectedItems().listIterator();
...
//			public void handleEvent(ButtonEvent e) {
//				setListRecord(YetaT43009GridPanel.getMsfGrid().getStore().getModifiedRecords().iterator());
//				doAction(actionDatabase);
//
//				if ((ActionDatabase.INSERT).equals(actionDatabase)) {
//					actionDatabase = ActionDatabase.INSERT;
...
//				
//		cpYetaT43009.add(topYetaBtnBar);
...
//		YetaT43009GridPanel = new MSFGridPanel(YetaT43009Def, false, false, false, false, false);
//		YetaT43009GridPanel.setSize("790px", "420px");
//		YetaT43009GridPanel.setBorders(true);
//		YetaT43009GridPanel.setHeaderVisible(false);
...
//		
//		YetaT43009GridPanel.getGrid().getColumnModel().addAggregationRow(payrSummaryRow);  
//		
...
//		
//		YetaT43009GridPanel.getGrid().getColumnModel().addAggregationRow(payrSummaryRow1);
//		/** --- 그리드 합계 부분  종료 --- **/
		
//        cpYetaT43009.add(YetaT43009GridPanel);
		...
		cpYetaT43009.add(layoutContainer);
		cpYetaT43009.add(layoutContainer20);
		cpYetaT43009.add(layoutContainer21);
		cpYetaT43009.add(layoutContainer22);
	...
	public void reload() {
			...
			YetaT43009GridPanel.getTableDef().setTableColumnFilters(filters);
			YetaT43009GridPanel.getTableDef().addColumnFilter("yrtxBlggYr", MSFSharedUtils.allowNulls(srhYrtxBlggYr.getValue())
...
//					, SimpleColumnFilter.OPERATOR_EQUALS);//연말정산귀속년도
			YetaT43009GridPanel.getTableDef().addColumnFilter("clutSeptCd", MSFSharedUtils.getSelectedComboValue(srhClutSeptCd,"commCd")
					, SimpleColumnFilter.OPERATOR_EQUALS);//정산구분
			YetaT43009GridPanel.getTableDef().addColumnFilter("systemkey", MSFSharedUtils.allowNulls(systemkey.getValue())
					, SimpleColumnFilter.OPERATOR_EQUALS);//시스템키
		 
			YetaT43009GridPanel.reload();
