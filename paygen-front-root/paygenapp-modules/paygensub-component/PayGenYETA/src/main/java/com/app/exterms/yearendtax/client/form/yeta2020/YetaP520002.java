...
import com.app.exterms.yearendtax.client.form.defs.yeta2020.PdfA102yDef;
import com.app.exterms.yearendtax.client.form.defs.yeta2020.PdfB101yDef;
import com.app.exterms.yearendtax.client.form.defs.yeta2020.PdfB201yDef;
import com.app.exterms.yearendtax.client.form.defs.yeta2020.PdfC101yDef;
import com.app.exterms.yearendtax.client.form.defs.yeta2020.PdfC202yDef;
import com.app.exterms.yearendtax.client.form.defs.yeta2020.PdfC301yDef;
import com.app.exterms.yearendtax.client.form.defs.yeta2020.PdfC401yDef;
import com.app.exterms.yearendtax.client.form.defs.yeta2020.PdfD101yDef;
import com.app.exterms.yearendtax.client.form.defs.yeta2020.PdfE102yDef;
import com.app.exterms.yearendtax.client.form.defs.yeta2020.PdfF102yDef;
//import com.app.exterms.yearendtax.client.form.defs.yeta2020.PdfG106yDef;
//import com.app.exterms.yearendtax.client.form.defs.yeta2020.PdfG206yDef;
//import com.app.exterms.yearendtax.client.form.defs.yeta2020.PdfG306yDef;
import com.app.exterms.yearendtax.client.form.defs.yeta2020.PdfG107yDef;
import com.app.exterms.yearendtax.client.form.defs.yeta2020.PdfG207yDef;
import com.app.exterms.yearendtax.client.form.defs.yeta2020.PdfG307yDef;
import com.app.exterms.yearendtax.client.form.defs.yeta2020.PdfG407yDef;
import com.app.exterms.yearendtax.client.form.defs.yeta2020.PdfJ101yDef;
import com.app.exterms.yearendtax.client.form.defs.yeta2020.PdfJ203yDef;
import com.app.exterms.yearendtax.client.form.defs.yeta2020.PdfJ301yDef;
import com.app.exterms.yearendtax.client.form.defs.yeta2020.PdfJ401yDef;
import com.app.exterms.yearendtax.client.form.defs.yeta2020.PdfJ501yDef;
import com.app.exterms.yearendtax.client.form.defs.yeta2020.PdfK101yDef;
import com.app.exterms.yearendtax.client.form.defs.yeta2020.PdfL102yDef;
import com.app.exterms.yearendtax.client.form.defs.yeta2020.PdfN101yDef;
import com.app.exterms.yearendtax.client.form.defs.yeta2020.PdfO101yDef;
import com.app.exterms.yearendtax.client.form.defs.yeta2020.PdfP102yDef;
import com.app.exterms.yearendtax.client.form.defs.yeta2020.PdfQ101yDef;
import com.app.exterms.yearendtax.client.service.yeta2020.YetaP520001Service;
import com.app.exterms.yearendtax.client.service.yeta2020.YetaP520001ServiceAsync;
...
=====================================================**/
public  class YetaP520002   extends MSFFormPanel {  
	...
	private ButtonBar topYeta220002Bar;
	private Button btnYeta220002AllUsed; 	// 전체선택
	private Button btnYeta220002UnUsed; 		// 선택해제
	private Button btnYeta220002Save; 	// 소득공제반영
	// -------------- 권한 설정 객체 종료 --------------
	...
	private YetaP520001ServiceAsync yetaP520001Service = YetaP520001Service.Util.getInstance();
	 ...
	 *~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ 		
	 **/ 		    
	public YetaP520002(final ActionDatabase actionDatabase, final MSFPanel caller) {
		...
		cpYeta21001.setScrollMode(Scroll.AUTOY);
		cpYeta21001.setHeaderVisible(false);
		cpYeta21001.setSize("913px", "660px");
	...
	private void createBasicForm() {
		...
		topYeta220002Bar = new ButtonBar();
		topYeta220002Bar.setAlignment(HorizontalAlignment.RIGHT);
		topYeta220002Bar.setStyleAttribute("paddingRight", "15px");
		topYeta220002Bar.setStyleAttribute("paddingTop", "5px");

		btnYeta220002AllUsed = new Button("전체선택");
		topYeta220002Bar.add(btnYeta220002AllUsed);
		btnYeta220002AllUsed.addSelectionListener(new SelectionListener<ButtonEvent>() {		        
			public void componentSelected(ButtonEvent ce) { 
				...
				int  lsCnt24 = yetaPdfB201yGridPanel.getMsfGrid().getGrid().getStore().getCount();

				for(int iCnt=0;iCnt < lsCnt24;iCnt++) {
				...
				int  lsCnt25 = yetaPdfJ501yGridPanel.getMsfGrid().getGrid().getStore().getCount();

				for(int iCnt=0;iCnt < lsCnt25;iCnt++) {
				...
				int  lsCnt26 = yetaPdfQ101yGridPanel.getMsfGrid().getGrid().getStore().getCount();

				for(int iCnt=0;iCnt < lsCnt26;iCnt++) {
		...
		btnYeta220002UnUsed = new Button("선택해제");
		topYeta220002Bar.add(btnYeta220002UnUsed);
		btnYeta220002UnUsed.addListener(Events.Select, new Listener<ButtonEvent>() {
		...
		btnYeta220002Save = new Button("소득공제반영");
		topYeta220002Bar.add(btnYeta220002Save);
		btnYeta220002Save.addSelectionListener(new SelectionListener<ButtonEvent>() {   

			public void componentSelected(ButtonEvent ce) {
				final List<PdfA102yDTO> listPdfA102yDto = A102UpdateSetDto();
				final List<PdfB101yDTO> listPdfB101yDto = B101UpdateSetDto();
				final List<PdfB201yDTO> listPdfB201yDto = B201UpdateSetDto();
				...
				final List<PdfJ501yDTO> listPdfJ501yDto = J501UpdateSetDto();
				...
				final List<PdfQ101yDTO> listPdfQ101yDto = Q101UpdateSetDto();
				...
				if ((listPdfA102yDto.size() + listPdfB101yDto.size() + listPdfB201yDto.size() + listPdfC101yDto.size() +
						listPdfC202yDto.size() + listPdfC301yDto.size() + listPdfC401yDto.size() + listPdfD101yDto.size() +
						listPdfE102yDto.size() + listPdfF102yDto.size() + listPdfG107yDto.size() + listPdfG207yDto.size() + 
						listPdfG307yDto.size() + listPdfG407yDto.size() + listPdfJ101yDto.size() + listPdfJ203yDto.size() + 
						listPdfJ501yDto.size()+  listPdfJ301yDto.size() + listPdfJ401yDto.size() + listPdfK101yDto.size() + 
						listPdfL102yDto.size() +listPdfQ101yDto.size() + listPdfN101yDto.size() + listPdfO101yDto.size() + 
						listPdfP102yDto.size()) <= 0 ) {
				...
				MessageBox.confirm("","소득공제를 반영하시겠습니까?",new Listener<MessageBoxEvent>(){
					...
					public void handleEvent(MessageBoxEvent be) {
						...
						if(Dialog.YES.equals(be.getButtonClicked().getItemId())){
							...
							if (listPdfB201yDto.size() > 0) {UpdateB201(listPdfB201yDto);}     //실손의료보험금
							...
							if (listPdfJ501yDto.size() > 0) {UpdateJ501(listPdfJ501yDto);}     //월세액
							...
							if (listPdfQ101yDto.size() > 0) {UpdateQ101(listPdfQ101yDto);}     //벤처투자신탁
		...
		cpYeta21001.add(topYeta220002Bar, new FormData("100%"));
	}
	...
	private void createStandardForm() {
		...
		FieldSet fieldSet23 = new FieldSet();
		fieldSet23.setStyleAttribute("paddingTop", "15px");
		fieldSet23.setSize(885, 280);
		fieldSet23.setHeadingHtml("실손의료보험금");
		fieldSet23.add(Yeta_PDF_B201Y_Grid(), new FormData("100%"));
		layoutContainer.add(fieldSet23);
		...
		//월세액 추가
		FieldSet fieldSet24 = new FieldSet();
		fieldSet24.setStyleAttribute("paddingTop", "15px");
		fieldSet24.setSize(885, 280);
		fieldSet24.setHeadingHtml("월세액");
		fieldSet24.add(Yeta_PDF_J501Y_Grid(), new FormData("100%"));
		layoutContainer.add(fieldSet24);
		...
		//벤처투자신탁 추가
		FieldSet fieldSet25 = new FieldSet();
		fieldSet25.setStyleAttribute("paddingTop", "15px");
		fieldSet25.setSize(885, 280);
		fieldSet25.setHeadingHtml("벤처투자신탁");
		fieldSet25.add(Yeta_PDF_Q101Y_Grid(), new FormData("100%"));
		layoutContainer.add(fieldSet25);
		...
		cpYeta21001.add(panel, new FormData("100%"));
	...
	//실손의료보험금 DTO 세팅
		public List<PdfB201yDTO> B201UpdateSetDto(){
	...
	//월세액 DTO 세팅
	public List<PdfJ501yDTO> J501UpdateSetDto(){
	...
	//벤처투자신탁DTO 세팅
		...
		public List<PdfQ101yDTO> Q101UpdateSetDto(){
	...
	public void UpdateA102(List<PdfA102yDTO> listPdfA102yDto) {
		yetaP520001Service.updateYetaP520001ToPdfA102Y(listPdfA102yDto, actionDatabase, new AsyncCallback<Integer>() {
...
//				UpdateB101(listPdfB101yDto);
	...
	public void UpdateB101(List<PdfB101yDTO> listPdfB101yDto) {
		yetaP520001Service.updateYetaP520001ToPdfB101Y(listPdfB101yDto, actionDatabase, new AsyncCallback<Integer>() {
...
//실손의료보험금
	...
	public void UpdateB201(List<PdfB201yDTO> listPdfB201yDto) {
		yetaP520001Service.updateYetaP520001ToPdfB201Y(listPdfB201yDto, actionDatabase, new AsyncCallback<Integer>() {
...
//				UpdateC101(listPdfC101yDto);
	...
	public void UpdateC101(List<PdfC101yDTO> listPdfC101yDto) {
		yetaP520001Service.updateYetaP520001ToPdfC101Y(listPdfC101yDto, actionDatabase, new AsyncCallback<Integer>() {
...
//				UpdateC202(listPdfC202yDto);
	...
	public void UpdateC202(List<PdfC202yDTO> listPdfC202yDto) {
		yetaP520001Service.updateYetaP520001ToPdfC202Y(listPdfC202yDto, actionDatabase, new AsyncCallback<Integer>() {
...
//				UpdateC301(listPdfC301yDto);
	...
	public void UpdateC301(List<PdfC301yDTO> listPdfC301yDto) {
		yetaP520001Service.updateYetaP520001ToPdfC301Y(listPdfC301yDto, actionDatabase, new AsyncCallback<Integer>() {
...
//				UpdateC401(listPdfC401yDto);
	...
	public void UpdateC401(List<PdfC401yDTO> listPdfC401yDto) {
		yetaP520001Service.updateYetaP520001ToPdfC401Y(listPdfC401yDto, actionDatabase, new AsyncCallback<Integer>() {
...
//				UpdateD101(listPdfD101yDto);
	...
	public void UpdateD101(List<PdfD101yDTO> listPdfD101yDto) {
		yetaP520001Service.updateYetaP520001ToPdfD101Y(listPdfD101yDto, actionDatabase, new AsyncCallback<Integer>() {
...
//				UpdateE102(listPdfE102yDto);
	...
	public void UpdateE102(List<PdfE102yDTO> listPdfE102yDto) {
		yetaP520001Service.updateYetaP520001ToPdfE102Y(listPdfE102yDto, actionDatabase, new AsyncCallback<Integer>() {
...
//				UpdateF102(listPdfF102yDto);
	...
	public void UpdateF102(List<PdfF102yDTO> listPdfF102yDto) {
		yetaP520001Service.updateYetaP520001ToPdfF102Y(listPdfF102yDto, actionDatabase, new AsyncCallback<Integer>() {
...
//				UpdateG106(listPdfG106yDto);
	...
	public void UpdateG107(List<PdfG107yDTO> listPdfG107yDto) {
		yetaP520001Service.updateYetaP520001ToPdfG107Y(listPdfG107yDto, actionDatabase, new AsyncCallback<Integer>() {
...
//				UpdateG206(listPdfG206yDto);
	...
	public void UpdateG207(List<PdfG207yDTO> listPdfG207yDto) {
		yetaP520001Service.updateYetaP520001ToPdfG207Y(listPdfG207yDto, actionDatabase, new AsyncCallback<Integer>() {
...
//				UpdateG306(listPdfG306yDto);
	...
	public void UpdateG307(List<PdfG307yDTO> listPdfG307yDto) {
		yetaP520001Service.updateYetaP520001ToPdfG307Y(listPdfG307yDto, actionDatabase, new AsyncCallback<Integer>() {
...
//				UpdateJ101(listPdfJ101yDto);
	...
	public void UpdateG407(List<PdfG407yDTO> listPdfG407yDto) {
		yetaP520001Service.updateYetaP520001ToPdfG407Y(listPdfG407yDto, actionDatabase, new AsyncCallback<Integer>() {
...
//				UpdateJ101(listPdfJ101yDto);
	...
	public void UpdateJ101(List<PdfJ101yDTO> listPdfJ101yDto) {
		yetaP520001Service.updateYetaP520001ToPdfJ101Y(listPdfJ101yDto, actionDatabase, new AsyncCallback<Integer>() {
...
//				UpdateJ203(listPdfJ203yDto);
	...
	public void UpdateJ203(List<PdfJ203yDTO> listPdfJ203yDto) {
		yetaP520001Service.updateYetaP520001ToPdfJ203Y(listPdfJ203yDto, actionDatabase, new AsyncCallback<Integer>() {
...
//월세액 추가
	...
	public void UpdateJ501(List<PdfJ501yDTO> listPdfJ501yDto) {
		yetaP520001Service.updateYetaP520001ToPdfJ501Y(listPdfJ501yDto, actionDatabase, new AsyncCallback<Integer>() {
...
//				UpdateJ301(listPdfJ301yDto);
	...
	public void UpdateJ301(List<PdfJ301yDTO> listPdfJ301yDto) {
		yetaP520001Service.updateYetaP520001ToPdfJ301Y(listPdfJ301yDto, actionDatabase, new AsyncCallback<Integer>() {
...
//				UpdateJ401(listPdfJ401yDto);
	...
	public void UpdateJ401(List<PdfJ401yDTO> listPdfJ401yDto) {
		yetaP520001Service.updateYetaP520001ToPdfJ401Y(listPdfJ401yDto, actionDatabase, new AsyncCallback<Integer>() {
...
//				UpdateK101(listPdfK101yDto);
	...
	public void UpdateK101(List<PdfK101yDTO> listPdfK101yDto) {
		yetaP520001Service.updateYetaP520001ToPdfK101Y(listPdfK101yDto, actionDatabase, new AsyncCallback<Integer>() {
...
//				UpdateL102(listPdfL102yDto);
	...
	public void UpdateL102(List<PdfL102yDTO> listPdfL102yDto) {
		yetaP520001Service.updateYetaP520001ToPdfL102Y(listPdfL102yDto, actionDatabase, new AsyncCallback<Integer>() {
...
//				UpdateL102(listPdfL102yDto);
	...
	//벤처투자신탁
	public void UpdateQ101(List<PdfQ101yDTO> listPdfQ101yDto) {
		yetaP520001Service.updateYetaP520001ToPdfQ101Y(listPdfQ101yDto, actionDatabase, new AsyncCallback<Integer>() {
...
//				UpdateL102(listPdfL102yDto);
	...
	public void UpdateN101(List<PdfN101yDTO> listPdfN101yDto) {
		yetaP520001Service.updateYetaP520001ToPdfN101Y(listPdfN101yDto, actionDatabase, new AsyncCallback<Integer>() {
...
//				UpdateO101(listPdfO101yDto);
	...
	public void UpdateO101(List<PdfO101yDTO> listPdfO101yDto) {
		yetaP520001Service.updateYetaP520001ToPdfO101Y(listPdfO101yDto, actionDatabase, new AsyncCallback<Integer>() {
...
//				UpdateP102(listPdfP102yDto);
	...
	public void UpdateP102(List<PdfP102yDTO> listPdfP102yDto) {
		yetaP520001Service.updateYetaP520001ToPdfP102Y(listPdfP102yDto, actionDatabase, new AsyncCallback<Integer>() {
