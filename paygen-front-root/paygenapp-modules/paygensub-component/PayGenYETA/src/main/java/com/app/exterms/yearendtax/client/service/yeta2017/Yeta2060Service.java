...
@RemoteServiceRelativePath("Yeta2060Service.gwt")
public interface Yeta2060Service extends RemoteService {
	/**
	 * Utility class for simplifying access to the instance of async service.
	 */
	public static class Util {
		private static Yeta2060ServiceAsync instance;
		public static Yeta2060ServiceAsync getInstance(){
			if (instance == null) {
				instance = GWT.create(Yeta2060Service.class);
			}
			return instance;
		}
	}
	...
	public Long Yeta206001_Delete(List<Yeta2060DTO> listYeta2060Dto, ActionDatabase actionDatabase);
