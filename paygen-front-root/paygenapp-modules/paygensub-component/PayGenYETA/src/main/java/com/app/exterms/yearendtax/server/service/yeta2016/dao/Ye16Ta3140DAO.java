...
@Repository("Ye16Ta3140DAO")
public class Ye16Ta3140DAO extends EgovAbstractDAO {
	 ...
	 */
    @Transactional
    public void fnYeta1100_YETA3140_2016_CREATE_Delete(Yeta3140VO vo) throws Exception {
        delete("ye16Ta3140DAO.fnYeta1100_YETA3140_2016_CREATE_Delete_S", vo);
    }	
    ...
    public String insertYetaP03002To3140(Yeta3140VO vo) throws Exception {
        return (String)insert("ye16Ta3140DAO.insertYeta3140_S", vo);
    }
    ...
    public void updateYetaP03002To3140(Yeta3140VO vo) throws Exception {
        update("ye16Ta3140DAO.updateYeta3140_S", vo);
    }
    ...
    public void deleteYetaP03002To3140(Yeta3140VO vo) throws Exception {
        delete("ye16Ta3140DAO.deleteYeta3140_S", vo);
    }
    ...
    public int selectYetaP03002To3140ListTotCnt(Yeta3140SrhVO searchVO) {
        return (Integer)getSqlMapClientTemplate().queryForObject("ye16Ta3140DAO.selectYetaP03002To3140ListTotCnt_S", searchVO);
    }
    ...
    public List selectYetaP03002To3140List(Yeta3140SrhVO searchVO) throws Exception {
        return list("ye16Ta3140DAO.selectYetaP03002To3140List_D", searchVO);
    }
    ...
    public void fnPayr06430_PAYR430_CREATE_Delete(Yeta3140VO vo) throws Exception {
        delete("ye16Ta3140DAO.fnPayr06430_PAYR430_CREATE_Delete_S", vo);
    }
    ...
    public Yeta3140VO selectYeta3140(Yeta3140VO vo) throws Exception {
        return (Yeta3140VO) selectByPk("ye16Ta3140DAO.selectYeta3140_S", vo);
    }
    ...
    public List<?> selectYeta3140List(Yeta3140SrhVO searchVO) throws Exception {
        return list("ye16Ta3140DAO.selectYeta3140List_D", searchVO);
    }
    ...
    public int selectYeta3140ListTotCnt(Yeta3140SrhVO searchVO) {
        return (Integer)getSqlMapClientTemplate().queryForObject("ye16Ta3140DAO.selectYeta3140ListTotCnt_S", searchVO);
    }
