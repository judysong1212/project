...
//    private YetaConstants yetaLabel = YetaConstants.INSTANCE;
	...
	public Ye164010Def(String chkPayrDef) {
		...
		if ("YetaP73002".equals(chkPayrDef)) {
			setDaoClass("");
			 setCustomListMethod(CLASS_YETAP73002_TO_YE164010_DATA_LIST);
			setAutoFillGrid(false);
			setShowFilterToolbar(false);
			setCheckBoxOnGridRows(true);
			setEditableGrid(true);
			setEditFieldGrid(true);
			setColumnsDefinition(getYetaP73002ToYe164010ColumnsList());
		} else {
			setDaoClass("");
    ...
    private List<ColumnDef> getYetaP73002ToYe164010ColumnsList(){
