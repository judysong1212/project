...
@Service("YetaT43017Service")
public class YetaT43017ServiceImpl  extends AbstractCustomServiceImpl implements YetaT43017Service ,YetaDaoConstants {
	 
	private static final Logger logger = LoggerFactory.getLogger(YetaT43017ServiceImpl.class);
	private static final String calledClass = YetaT43017ServiceImpl.class.getName();
	...
	public Ye169010DTO getYetaP43017ToYe169010List(Ye169010DTO ye169010Dto)	throws MSFException {
		...
		Ye169010aSrh_2019_VO ye169010aSrhVo = new Ye169010aSrh_2019_VO();
		MSFSysm0100BM sessionUser;

		String method = calledClass + ".getYetaP43017ToYe169010List";

		String windowNm = "표준세액공제";
		String windowId = "YETAP43017";
		...
		try {
			...
			egovResultDataList = ye169010ADao.selectYetaP43017ToYe169010List(ye169010aSrhVo);
