...
@Service("YetaP430010Service")
public class YetaP430010ServiceImpl  extends AbstractCustomServiceImpl implements YetaP430010Service  ,YetaDaoConstants {

	 
	private static final Logger logger = LoggerFactory.getLogger(YetaP430010ServiceImpl.class);
	private static final String calledClass = YetaP430010ServiceImpl.class.getName();
	...
	public int activityOnYetaP430010ToYe160405(Ye160405DTO ye160405Dto, ActionDatabase actionDatabase) throws MSFException {
		...
		String method = calledClass + ".activityOnYetaP430010ToYe160405";
		...
		try {
			...
			String nResult = AnyCryptUtils.XecureCryptInitialize(RemoteServiceUtil.getThreadLocalConfig(),RemoteServiceUtil.getThreadLocalRequest());
				...
				result = ye160405DAO.updateYetaP430010ToYe160405(ye160405Vo); 
		          
		} catch (Exception ex) {
			logger.error("EXCEPTION calling activityOnYetaP430010ToYe160405(): "+ ex);
			...
			result = 0;
			throw MSFServerUtils.getOperationException("activityOnYetaP430010ToYe160405", ex, logger);
	...
	public Ye160405DTO getYetaP430010ToYe160405List(Ye160405DTO ye160405Dto) throws MSFException {
		...
		Ye160405Srh_2019_VO ye160405SrhVo = new Ye160405Srh_2019_VO();
		MSFSysm0100BM sessionUser;

		String method = calledClass + ".getYetaP430010ToYe160405List";
		...
		try {
			...
			egovResultDataList = ye160405DAO.selectYetaP430010ToYe160405List(ye160405SrhVo);
