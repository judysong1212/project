...
import com.app.exterms.yearendtax.server.service.yeta2017.dao.Ye17TaPyyt0302DAO;
import com.app.exterms.yearendtax.server.service.yeta2017.dao.Ye17TaPyyt0304DAO;
...
* </pre>
 */
@Service("Yeta2900Service")
public class Yeta2900ServiceImpl  extends AbstractCustomServiceImpl implements Yeta2900Service  ,YetaDaoConstants {

	 
	private static final Logger logger = LoggerFactory.getLogger(Yeta2900ServiceImpl.class);
	private static final String calledClass = Yeta2900ServiceImpl.class.getName();

	// 급여대상자
	@Autowired
	@Resource(name = "Ye17TaPyyt0304DAO")
	private Ye17TaPyyt0304DAO pyyt0304DAO;
	
	// 수당/공제내역
	@Autowired
	@Resource(name = "Ye17TaPyyt0302DAO")
	private Ye17TaPyyt0302DAO pyyt0302DAO;
	 ...
	 * @throws MSFException
	 */
	public PagingLoadResult<BaseModel> getYeta2900ToPyyt0304List(ServiceParameters serviceParameters) throws MSFException {

 	        PagingLoadResult<BaseModel> retval = null;
//	        String method =  "getPsnl0100ToRemt0100DataList";
	        String method = CLASS_YETA2900_TO_PYYT0304_DATA_LIST;
	        ...
	        if  (MSFSharedUtils.paramNull(pyyt0304DAO)) {
	            ...
	            pyyt0304DAO = (Ye17TaPyyt0304DAO) wac.getBean("Ye17TaPyyt0304DAO"); 
	        }
...
//	            Collection<Map<String, Object>> list  
	...
	public PagingLoadResult<BaseModel> getYeta2900ToPyyt0302ExtpyList(ServiceParameters serviceParameters) throws MSFException {
 	        ...
 	        PagingLoadResult<BaseModel> retval = null;
//	        String method =  "getPsnl0100ToRemt0100DataList";
	        String method = CLASS_YETA2900_TO_PYYT0302_EXTPY_DATA_LIST;
	        Pyyt0302SrhVO   pyyt0302SrhVo = new Pyyt0302SrhVO();
	        Pyyt0302VO      pyyt0304Vo = new Pyyt0302VO();
	        List<BaseModel>  bmResult = new ArrayList<BaseModel>();
	        ...
	        if  (MSFSharedUtils.paramNull(pyyt0302DAO)) {
	            ...
	            pyyt0302DAO = (Ye17TaPyyt0302DAO) wac.getBean("Ye17TaPyyt0302DAO"); 
	        }
...
//	            Collection<Map<String, Object>> list  
	...
	public PagingLoadResult<BaseModel> getYeta2900ToPyyt0302DducList(ServiceParameters serviceParameters) throws MSFException {
 	        ...
 	        PagingLoadResult<BaseModel> retval = null;
//	        String method =  "getPsnl0100ToRemt0100DataList";
	        String method = CLASS_YETA2900_TO_PYYT0302_DDUC_DATA_LIST;
	        Pyyt0302SrhVO   pyyt0302SrhVo = new Pyyt0302SrhVO();
	        Pyyt0302VO      pyyt0304Vo = new Pyyt0302VO();
	        List<BaseModel>  bmResult = new ArrayList<BaseModel>();
...
//	            Collection<Map<String, Object>> list  
	...
	/** 수당/공제항목 저장 및 삭제 **/ 
	@Override
	public int saveYeta2900ToPyyt0302(List<Pyyt0302DTO> listPyyt0302Dto, String flag)throws MSFException {
	...
	/** 대상자 삭제 **/ 
	@Override
	public int deleteYeta2900List(List<Pyyt0302DTO> listPyyt0302Dto)throws MSFException {
		// TODO Auto-generated method stub
...
//				pyyt0302Vo.setRevnAddr(RemoteServiceUtil.getThreadLocalRequest().getRemoteHost());
	...
	public Pyyt0304BM Yeta2900InfoList(Pyyt0304DTO pyyt0304Dto) {
		...
		String method = calledClass + ".Yeta2900InfoList";
