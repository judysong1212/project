...
@RemoteServiceRelativePath("Yeta6500Service.gwt")
public interface Yeta6500Service extends RemoteService {
	/**
	 * Utility class for simplifying access to the instance of async service.
	 */
	public static class Util {
		private static Yeta6500ServiceAsync instance;
		public static Yeta6500ServiceAsync getInstance(){
			if (instance == null) {
				instance = GWT.create(Yeta6500Service.class);
			}
			return instance;
		}
	}
