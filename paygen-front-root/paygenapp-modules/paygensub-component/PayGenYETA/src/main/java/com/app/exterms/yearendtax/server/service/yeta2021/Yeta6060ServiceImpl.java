...
import com.app.exterms.yearendtax.server.service.yeta2021.dao.Yeta6060_2021_DAO;
...
@Service("Yeta6060Service")
public class Yeta6060ServiceImpl  extends AbstractCustomServiceImpl implements YetaDaoConstantsGenerated , Yeta6060Service  {

	private static final Logger logger = LoggerFactory.getLogger(Yeta6060ServiceImpl.class);
	private static final String calledClass = Yeta6060ServiceImpl.class.getName();
	
	@Autowired
	@Resource(name="Yeta6060_2021_DAO")
	private Yeta6060_2021_DAO yeta6060DAO;
	
	@Autowired
	@Resource(name="Ye161005_2021_DAO")
	private Ye161005_2021_DAO ye161005DAO;
	...
	public PagingLoadResult<BaseModel> getSelectYeta6060List(ServiceParameters serviceParameters) throws MSFException {

        PagingLoadResult<BaseModel> retval = null;
        String nResult = null;
        String method =  CLASS_YETA6060_LIST;
        Yeta3060Srh_2021_VO   Yeta3060SrhVO = new Yeta3060Srh_2021_VO();
        //Yeta2060VO      Yeta2060Vo = new Yeta2060VO();
        List<BaseModel>  bmResult = new ArrayList<BaseModel>();
        
        MSFSysm0100BM sessionUser = MSFServerUtils.getLoggedUser(RemoteServiceUtil.getThreadLocalRequest());
        
        if(MSFSharedUtils.paramNull(yeta6060DAO)){
        	WebApplicationContext wac = WebApplicationContextUtils.getRequiredWebApplicationContext( getHttpServletRequest().getSession().getServletContext());
        	yeta6060DAO = (Yeta6060_2021_DAO) wac.getBean("Yeta6060_2021_DAO");
        }
        try{
            ...
            if ( pagingValues.executeRecordCount ) { 
            	...
            	int iResultCnt = yeta6060DAO.selectYeta6060ListTotCnt(Yeta3060SrhVO);
            	
            	SmrmfUtils.endTiming(logger, millisBeginQueryCount, "QueryCount"); 
                pagingValues.totalRecordCount = iResultCnt;	       
                logger.debug("totalRecordCount : " + pagingValues.totalRecordCount);
            }
            TimingInfo millisBeginSelectYeta6060List = SmrmfUtils.startTiming(logger);
            ...
            List list = yeta6060DAO.selectYeta6060List(Yeta3060SrhVO);
            ...
            SmrmfUtils.endTiming(logger, millisBeginSelectYeta6060List, "selectYeta6060List");
	...
	@SuppressWarnings({ "unchecked", "rawtypes" })
	public PagingLoadResult<BaseModel> getSelectYetaM6060List(ServiceParameters serviceParameters) throws MSFException {

        PagingLoadResult<BaseModel> retval = null;
        String method =  CLASS_YETA6060_MLIST;
        Yeta3060Srh_2021_VO   Yeta3060SrhVO = new Yeta3060Srh_2021_VO();
        //Yeta2060VO      Yeta2060Vo = new Yeta2060VO();
        List<BaseModel>  bmResult = new ArrayList<BaseModel>();
        MSFSysm0100BM sessionUser = MSFServerUtils.getLoggedUser(RemoteServiceUtil.getThreadLocalRequest());
...
//                	}
	...
	@SuppressWarnings({ "unchecked", "rawtypes" })
	public PagingLoadResult<BaseModel> getSelectYetaS6060List(ServiceParameters serviceParameters) throws MSFException {
...
//            Yeta3060SrhVO.setMtstBusinDivCd("C0040020");	// 종사업장코드
	...
	@SuppressWarnings({ "unchecked", "rawtypes" })
	public PagingLoadResult<BaseModel> getSelectYetaM606001List(ServiceParameters serviceParameters) throws MSFException {
        ...
        try{
            ...
            if(pagingValues.executeRecordCount){ 
            	TimingInfo millisBeginQueryCount = SmrmfUtils.startTiming(logger);
            	int iResultCnt = yeta6060DAO.selectYetaM606001ListTotCnt(Yeta3060SrhVO);
            ...
            List list = yeta6060DAO.selectYetaM606001List(Yeta3060SrhVO);
            Iterator<Map<String, Object>> iter = list.iterator();
            SmrmfUtils.endTiming(logger, millisBeginQueryMain, "QueryMain");
	...
	@SuppressWarnings({ "unchecked", "rawtypes" })
	public PagingLoadResult<BaseModel> getSelectYetaS606001List(ServiceParameters serviceParameters) throws MSFException {
		...
		try{
			...
			if(pagingValues.executeRecordCount){ 
				TimingInfo millisBeginQueryCount = SmrmfUtils.startTiming(logger);
				int iResultCnt = yeta6060DAO.selectYetaS606001ListTotCnt(Yeta3060SrhVO);
			...
			List list = yeta6060DAO.selectYetaS606001List(Yeta3060SrhVO);
			Iterator<Map<String, Object>> iter = list.iterator();
			SmrmfUtils.endTiming(logger, millisBeginQueryMain, "QueryMain");
	...
	public int chkYeta6060(Yeta6060DTO dto, ActionDatabase actionDatabase)throws MSFException {
		...
		int returnCnt = 0;
		String nResult = AnyCryptUtils.XecureCryptInitialize(RemoteServiceUtil.getThreadLocalConfig(),RemoteServiceUtil.getThreadLocalRequest());
		String method = calledClass + ".saveYeta6060";
		
		String windowNm = "사업장관리";
		String windowId = "Yeta6060";
			...
			switch(actionDatabase){
				case INSERT : 
					...
					if(dto.getMtstBusinDivCd() == "C0030010" || "C0030010".equals(dto.getMtstBusinDivCd())) {
						Yeta3060SrhVo = new Yeta3060Srh_2021_VO();
						Yeta3060SrhVo.setMtstBusinDivCd(dto.getMtstBusinDivCd());
						
						int iCnt = yeta6060DAO.selectYeta6060ListTotCnt(Yeta3060SrhVo);
	...
	public int delChkYeta6060(Yeta6060DTO dto, ActionDatabase actionDatabase)throws MSFException {
		...
		int returnCnt = 0;
		String nResult = AnyCryptUtils.XecureCryptInitialize(RemoteServiceUtil.getThreadLocalConfig(),RemoteServiceUtil.getThreadLocalRequest());
		String method = calledClass + ".delChkYeta6060";
		...
		Ye161010Srh_2021_VO ye161005SrhVo = new Ye161010Srh_2021_VO();
		...
		try {
			...
			int iCnt = ye161010DAO.selectYeta6060ToYe161010ListTotCnt(ye161005SrhVo);
	...
	public String saveYeta6060(Yeta6060DTO dto, ActionDatabase actionDatabase)throws MSFException {
		...
		Ye161005_2021_VO ye161005Vo = new Ye161005_2021_VO();
		...
		try {			
			switch(actionDatabase){
				case INSERT : 
					returnCnt = yeta6060DAO.saveYeta6060(dto);
				...
				case UPDATE : 
					...
					break;
				case DELETE : 
					returnCnt = yeta6060DAO.deleteYeta6060(dto);
	...
	public List<BaseModel> getParentDpobCd() throws MSFException {
		...
		try{
			...
			egovResultDataList = yeta6060DAO.getParentDpobCd();
...
//		MSFLogHistoryUtils.tracerUserActivity(sessionUser, method, calledClass, "S");
	...
	public List<BaseModel> getYeta6060sysDivCdList() throws MSFException {
		...
		String method = calledClass + ".getYeta6060sysDivCdList";
		MSFSysm0100BM sessionUser;
		...
		List egovResultDataList = new ArrayList();
		try{
			egovResultDataList = yeta6060DAO.selectYeta6060sysDivCdList();
...
//		MSFLogHistoryUtils.tracerUserActivity(sessionUser, method, calledClass, "S");
	...
	public List<BaseModel> getSysDpobCd() throws MSFException {
		...
		try{
			...
			egovResultDataList = yeta6060DAO.getSysDpobCd();
...
//		MSFLogHistoryUtils.tracerUserActivity(sessionUser, method, calledClass, "S");
	...
	public int insertYetaS606001(Yeta6060DTO dto, ActionDatabase actionDatabase)throws MSFException {
		...
		String nResult = AnyCryptUtils.XecureCryptInitialize(RemoteServiceUtil.getThreadLocalConfig(),RemoteServiceUtil.getThreadLocalRequest());
		String method = calledClass + ".insertYetaS606001";
		
		String windowNm = "사업장관리";
		String windowId = "Yeta6060";
		
		Yeta3060_2021_VO Yeta6060Vo = new Yeta3060_2021_VO();
		Ye161005_2021_VO ye161005Vo = new Ye161005_2021_VO();
		...
		try {
			...
			Yeta6060Vo.setDpobCd(sessionUser.getDpobCd());
			Yeta6060Vo.setUtDpobCd(MSFSharedUtils.allowNulls(dto.getUtDpobCd()));
			Yeta6060Vo.setHhrkUntDpobCd(MSFSharedUtils.allowNulls(dto.getHhrkUntDpobCd()));
			Yeta6060Vo.setBusoprRgstnNum(MSFSharedUtils.allowNulls(dto.getBusoprRgstnNum()));
			Yeta6060Vo.setBefBusoprRgstnNum(MSFSharedUtils.allowNulls(dto.getBefBusoprRgstnNum()));
			Yeta6060Vo.setMtstBusinDivCd("C0030020");
			Yeta6060Vo.setIsmt(sessionUser.getUsrId());
			Yeta6060Vo.setRevnAddr(RemoteServiceUtil.getThreadLocalRequest().getRemoteHost());
			
			returnCnt = yeta6060DAO.insertYetaS606001(Yeta6060Vo);
	...
	@Override
	public Long Yeta606001_Delete(List<Yeta6060DTO> listYeta6060Dto,ActionDatabase actionDatabase) throws MSFException {
    	
		String method = calledClass + ".Yeta606001_Delete";

		String windowNm = "주(총괄납부)사업장관리";
		String windowId = "YETA606001";
    	...
    	Yeta3060_2021_VO ye3060Vo = new Yeta3060_2021_VO(); // 현근무지급여지급명세
    	Ye161005_2021_VO ye161005Vo = new Ye161005_2021_VO();
	    ...
	    try {
			...
			for (int iCnt = 0; iCnt < listYeta6060Dto.size(); iCnt++) {
		                
				Yeta6060DTO ye3060Dto = new Yeta6060DTO(); // 연말정산대상자기본
				ye3060Dto = listYeta6060Dto.get(iCnt);
				...
				yeta6060DAO.deleteYeta606001(ye3060Vo);
				...
				ye161005DAO.deleteYeta606001ToYe161005(ye161005Vo);
	...
	public Long Yeta606001NumUpdate(List<Yeta6060DTO> listYeta6060Dto,ActionDatabase actionDatabase) throws MSFException {
		String method = calledClass + ".Yeta606001NumUpdate";
	    ...
	    try {
			...
			for (int iCnt = 0; iCnt < listYeta6060Dto.size(); iCnt++) {
				...
				Yeta6060DTO ye4060Dto = new Yeta6060DTO(); // 연말정산대상자기본
				ye4060Dto = listYeta6060Dto.get(iCnt);
				...
				yeta6060DAO.updateNumYetaS606001(ye3060Vo);
