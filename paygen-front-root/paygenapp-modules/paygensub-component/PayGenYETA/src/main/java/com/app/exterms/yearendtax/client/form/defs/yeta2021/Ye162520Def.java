...
public class Ye162520Def extends TableDef implements YetaDaoConstants{
	...
	public Ye162520Def(String chkDef) {
		...
		if ("YetaP63004".equals(chkDef)) {
			...
			setTitle("");
			setDaoClass("");
			setCustomListMethod(CLASS_YETAP63004_TO_YE162520_DATA_LIST);
			setAutoFillGrid(false);
			setShowFilterToolbar(false);
			setCheckBoxOnGridRows(true);
			setEditFieldGrid(true);
			setColumnsDefinition(getColumnsListYetaP63004ToYE162520());
...
//        		setReadOnly(true);
	...
	private List<ColumnDef> getColumnsListYetaP63004ToYE162520() {
