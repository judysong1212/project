...
@RemoteServiceRelativePath("YetaP210002Service.gwt")
public interface YetaP210002Service extends RemoteService {
	/**
	 * Utility class for simplifying access to the instance of async service.
	 */
	public static class Util {
		private static YetaP210002ServiceAsync instance;
		public static YetaP210002ServiceAsync getInstance(){
			if (instance == null) {
				instance = GWT.create(YetaP210002Service.class);
			}
			return instance;
		}
	}
...
//	
	...
	/** 원천신고부서대상자 원천신고부서 반영  **/
	public int saveYetaP210002ToYe161010(List<Ye161010DTO> ye161010Dto) throws MSFException ;
