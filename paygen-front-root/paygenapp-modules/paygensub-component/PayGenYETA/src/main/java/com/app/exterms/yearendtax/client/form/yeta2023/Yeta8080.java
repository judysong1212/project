...
import com.app.exterms.yearendtax.client.form.defs.yeta2023.Yeta8080Def;
...
=====================================================**/
public class Yeta8080  extends MSFPanel { 
	...
	private FormPanel plFrmYeta8080;
	private FormData formData; 
	private String txtForm = "";
	private XTemplate detailTp;	  
//	private Yeta8080ServiceAsync Yeta8080service = Yeta8080Service.Util.getInstance();
	...
	private Yeta8080Def Yeta8080Def 				= new Yeta8080Def("yeta8080ToBass0400");
//	private Yeta8080Def Yeta8080ToSysm0100OnDef 	= new Yeta8080Def("Yeta8080ToSysm0100On");
//	private Yeta8080Def Yeta8080ToSysm0100OffDef 	= new Yeta8080Def("Yeta8080ToSysm0100Off");	
	private InfcPkgSysm0100Def Yeta8080ToSysm0100OnDef 		= new InfcPkgSysm0100Def("yeta8080ToSysm0100On");
	private InfcPkgSysm0100Def Yeta8080ToSysm0100OffDef 	= new InfcPkgSysm0100Def("yeta8080ToSysm0100Off");
	
	private MSFGridPanel msfGridPanelYeta8080; 
...
//			final RelationDef  relBass0360 = new RelationDef(Yeta8080MSDef,false);
//			relBass0360.addJoinDef("dpobCd", "dpobCd"); 
//			relBass0360.addJoinDef("deptCd", "deptCd"); 
//			relBass0360.setLinkedObject(msfGridPanelYeta8080MS);
//			Yeta8080ToBass0500OnDef.addRelation(relBass0360); 
//
//			/**
//			 * Create the relations 
//			 */
//			final RelationDef  relBass0350 = new RelationDef(Yeta8080MSDef,false);
//			relBass0350.addJoinDef("dpobCd", "dpobCd"); 
//			relBass0350.addJoinDef("deptCd", "deptCd"); 
//			relBass0350.setLinkedObject(msfGridPanelYeta8080MS);
//			Yeta8080ToBass0500OffDef.addRelation(relBass0350); 
//
//
//			// DETAILS 
//			final Grid Yeta8080ToBass0500OffDefGrid = msfGridPanelYeta8080MS.getMsfGrid().getGrid();
//			Yeta8080ToBass0500OffDefGrid.addListener(Events.CellDoubleClick, new Listener<BaseEvent>() {
//				public void handleEvent(BaseEvent be) {  
//					if (msfGridPanelYeta8080MS.getCurrentlySelectedItem() != null) {  
//
//						Yeta8080ToBass0500OnDef.synchronizeGridDetail(
//								msfGridPanelYeta8080MS.getCurrentlySelectedItem(),
//								msfGridPanelBass0500On );
//
//						Yeta8080ToBass0500OffDef.synchronizeGridDetail(
//								msfGridPanelYeta8080MS.getCurrentlySelectedItem(),
...
//			});
	...
	public Yeta8080(String txtForm) {
...
//		lsDtilOccuInttnCd = PrgmComComboUtils.getSingleBass0350ComboData(sysComBass0350Dto);
		...
		plFrmYeta8080 = new FormPanel();
		plFrmYeta8080.setHeadingText("PayGen Ver1.0 - 연말정산등록담당자관리");
		plFrmYeta8080.setIcon(Resources.APP_ICONS.text());
		plFrmYeta8080.setBodyStyleName("pad-text");
		plFrmYeta8080.setFrame(true); 
		plFrmYeta8080.setPadding(2);
		/************************************************************************
		...
		btnlogView.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				 //로그 뷰화면 호출 메서드 
				  funcLogMessage("연말정산등록담당자관리","Yeta8080");
				}
			});
		plFrmYeta8080.getHeader().setStyleAttribute("padding", "5px 0 2px 0");
		plFrmYeta8080.getHeader().addTool(btnlogView); 
		/************************************************************************
		 * 화면 에러 처리시 필요한 부분으로 추가 
		 ************************************************************************/
		deptCd = new HiddenField<String>();
		deptCd.setName("deptCd");
		plFrmYeta8080.add(deptCd);
		
		HorizontalPanel inner = new HorizontalPanel();
		inner.setBorders(false);
		inner.setLayout(new FitLayout());
//		Yeta8080Def.setReadOnly(true);
		msfGridPanelYeta8080 = new MSFGridPanel(Yeta8080Def, false, false, false, true, false);
		msfGridPanelYeta8080.setSize(300, 610);
		msfGridPanelYeta8080.setBorders(true);
		msfGridPanelYeta8080.getGrid().setBorders(true);
		Grid grid = msfGridPanelYeta8080.getMsfGrid().getGrid();
		grid.addListener(Events.CellDoubleClick , new Listener<BaseEvent>() {
			public void handleEvent(BaseEvent be) {
				
				
				BaseModel bmData = msfGridPanelYeta8080.getCurrentlySelectedItem();  
		...
		msfGridPanelYeta8080.setTopComponent(lycSreach);
		inner.add(msfGridPanelYeta8080);
          
          
		// 선택된 사용자 
		msfGridPanelSysm0100On = new MSFGridPanel(Yeta8080ToSysm0100OnDef, false, false, false, false,false); 
...
//						infcPkgSysm0100Dto.setUntDpobCd(MSFSharedUtils.allowNulls(egovMap.get("untDpobCd")));    /** column 단위사업장코드 : untDpobCd */
		...
		bottomToolbar.add(refresh);
   	    ...
   	    Yeta8080ToSysm0100OffDef.setReadOnly(true);
   	    // ------------------------ 미선택된 사용자
   	    msfGridPanelSysm0100Off = new MSFGridPanel(Yeta8080ToSysm0100OffDef, false, false, false, false, false); 
...
//						infcPkgSysm0100Dto.setUntDpobCd(MSFSharedUtils.allowNulls(egovMap.get("untDpobCd")));    /** column 단위사업장코드 : untDpobCd */
		...
		plFrmYeta8080.add(inner);

		vp.add(plFrmYeta8080);
		plFrmYeta8080.setSize("990px", "680px");
	}

	private Yeta8080 getThis() {
		return this;
	}
    ...
    public void reDeptload() {
    	...
    	msfGridPanelYeta8080.getTableDef().setTableColumnFilters(filters);   
    	msfGridPanelYeta8080.getTableDef().addColumnFilter("deptNmHan", MSFSharedUtils.defaultNulls(deptNmHan.getValue(),""), SimpleColumnFilter.OPERATOR_LIKE); 
    	msfGridPanelYeta8080.reload();
		...
		infcPkgSysm0100Service.updateInfcPkgSysm0100Yn(infcPkgSysm0100Liar , new AsyncCallback<Integer>() {
			...
			public void onFailure(Throwable caught) {
				MessageBox.alert( MSFMainApp.MSFCONSTANTS.ExceptionTitleService()
									, MSFMainApp.ADMINMESSAGES.ExceptionMessageService("activityOnYeta8300ToYe161030("+ " 오류 : " + ") : " + caught)
									, null);
				}
