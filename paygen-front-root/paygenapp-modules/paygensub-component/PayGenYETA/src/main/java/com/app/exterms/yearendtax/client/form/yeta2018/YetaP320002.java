...
import com.app.exterms.yearendtax.client.dto.yeta2018.PdfA102yBM;
...
import com.app.exterms.yearendtax.client.form.defs.yeta2018.PdfA102yDef;
import com.app.exterms.yearendtax.client.form.defs.yeta2018.PdfB101yDef;
import com.app.exterms.yearendtax.client.form.defs.yeta2018.PdfC101yDef;
import com.app.exterms.yearendtax.client.form.defs.yeta2018.PdfC202yDef;
import com.app.exterms.yearendtax.client.form.defs.yeta2018.PdfC301yDef;
import com.app.exterms.yearendtax.client.form.defs.yeta2018.PdfC401yDef;
import com.app.exterms.yearendtax.client.form.defs.yeta2018.PdfD101yDef;
import com.app.exterms.yearendtax.client.form.defs.yeta2018.PdfE102yDef;
import com.app.exterms.yearendtax.client.form.defs.yeta2018.PdfF102yDef;
//import com.app.exterms.yearendtax.client.form.defs.yeta2018.PdfG106yDef;
//import com.app.exterms.yearendtax.client.form.defs.yeta2018.PdfG206yDef;
//import com.app.exterms.yearendtax.client.form.defs.yeta2018.PdfG306yDef;
import com.app.exterms.yearendtax.client.form.defs.yeta2018.PdfG107yDef;
import com.app.exterms.yearendtax.client.form.defs.yeta2018.PdfG207yDef;
import com.app.exterms.yearendtax.client.form.defs.yeta2018.PdfG307yDef;
import com.app.exterms.yearendtax.client.form.defs.yeta2018.PdfJ101yDef;
import com.app.exterms.yearendtax.client.form.defs.yeta2018.PdfJ203yDef;
import com.app.exterms.yearendtax.client.form.defs.yeta2018.PdfJ301yDef;
import com.app.exterms.yearendtax.client.form.defs.yeta2018.PdfJ401yDef;
import com.app.exterms.yearendtax.client.form.defs.yeta2018.PdfK101yDef;
import com.app.exterms.yearendtax.client.form.defs.yeta2018.PdfL102yDef;
import com.app.exterms.yearendtax.client.form.defs.yeta2018.PdfN101yDef;
import com.app.exterms.yearendtax.client.form.defs.yeta2018.PdfO101yDef;
import com.app.exterms.yearendtax.client.form.defs.yeta2018.PdfP102yDef;
import com.app.exterms.yearendtax.client.service.yeta2018.YetaP320001Service;
import com.app.exterms.yearendtax.client.service.yeta2018.YetaP320001ServiceAsync;
...
=====================================================**/
public  class YetaP320002   extends MSFFormPanel {  
	...
	private YetaP320001ServiceAsync yetaP320001Service = YetaP320001Service.Util.getInstance();
	 ...
	 *~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ 		
	 **/ 		    
	public YetaP320002(final ActionDatabase actionDatabase, final MSFPanel caller) {
	...
	private void createBasicForm() {
		...
		btnYeta220002AllUsed.addSelectionListener(new SelectionListener<ButtonEvent>() {		        
			public void componentSelected(ButtonEvent ce) { 
				...
				int  lsCnt14 = yetaPdfJ101yGridPanel.getMsfGrid().getGrid().getStore().getCount();
				...
				int  lsCnt15 = yetaPdfJ203yGridPanel.getMsfGrid().getGrid().getStore().getCount();
				...
				int  lsCnt16 = yetaPdfJ301yGridPanel.getMsfGrid().getGrid().getStore().getCount();
				...
				int  lsCnt17 = yetaPdfJ401yGridPanel.getMsfGrid().getGrid().getStore().getCount();
				...
				int  lsCnt18 = yetaPdfK101yGridPanel.getMsfGrid().getGrid().getStore().getCount();
				...
				int  lsCnt19 = yetaPdfL102yGridPanel.getMsfGrid().getGrid().getStore().getCount();
				...
				int  lsCnt20 = yetaPdfN101yGridPanel.getMsfGrid().getGrid().getStore().getCount();
				...
				int  lsCnt21 = yetaPdfO101yGridPanel.getMsfGrid().getGrid().getStore().getCount();
				...
				int  lsCnt22 = yetaPdfP102yGridPanel.getMsfGrid().getGrid().getStore().getCount();
		...
		btnYeta220002Save.addSelectionListener(new SelectionListener<ButtonEvent>() {   
			...
			public void componentSelected(ButtonEvent ce) {
				...
				if ((listPdfA102yDto.size() + listPdfB101yDto.size() + listPdfC101yDto.size() + listPdfC202yDto.size() +
						...
						listPdfJ101yDto.size() + listPdfJ203yDto.size() + listPdfJ301yDto.size() + listPdfJ401yDto.size() + 
						listPdfK101yDto.size() + listPdfL102yDto.size() + listPdfN101yDto.size() + listPdfO101yDto.size() + 
	...
	private void createStandardForm() {
		...
		fieldSet13.setHeadingHtml("주택임차차입금원리금상환액");
		fieldSet13.add(Yeta_PDF_J101Y_Grid(), new FormData("100%"));
		...
		fieldSet14.setHeadingHtml("장기주택저당차입금이자상환액");
		fieldSet14.add(Yeta_PDF_J203Y_Grid(), new FormData("100%"));
		...
		fieldSet15.setHeadingHtml("주택마련저축");
		fieldSet15.add(Yeta_PDF_J301Y_Grid(), new FormData("100%"));
		...
		fieldSet16.setHeadingHtml("목돈안드는전세이자상환액");
		fieldSet16.add(Yeta_PDF_J401Y_Grid(), new FormData("100%"));
		...
		fieldSet17.setHeadingHtml("소기업소상공인공제부금");
		fieldSet17.add(Yeta_PDF_K101Y_Grid(), new FormData("100%"));
		...
		fieldSet18.setHeadingHtml("기부금");
		fieldSet18.add(Yeta_PDF_L102Y_Grid(), new FormData("100%"));
		...
		fieldSet19.setHeadingHtml("장기집합투자증권저축");
		fieldSet19.add(Yeta_PDF_N101Y_Grid(), new FormData("100%"));
		...
		fieldSet20.setHeadingHtml("건강보험료");
		fieldSet20.add(Yeta_PDF_O101Y_Grid(), new FormData("100%"));
		...
		fieldSet21.setHeadingHtml("국민연금보험료");
		fieldSet21.add(Yeta_PDF_P102Y_Grid(), new FormData("100%"));
	...
	public void UpdateA102(List<PdfA102yDTO> listPdfA102yDto) {
		yetaP320001Service.updateYetaP320001ToPdfA102Y(listPdfA102yDto, actionDatabase, new AsyncCallback<Integer>() {
...
//				UpdateB101(listPdfB101yDto);
	...
	public void UpdateB101(List<PdfB101yDTO> listPdfB101yDto) {
		yetaP320001Service.updateYetaP320001ToPdfB101Y(listPdfB101yDto, actionDatabase, new AsyncCallback<Integer>() {
...
//				UpdateC101(listPdfC101yDto);
	...
	public void UpdateC101(List<PdfC101yDTO> listPdfC101yDto) {
		yetaP320001Service.updateYetaP320001ToPdfC101Y(listPdfC101yDto, actionDatabase, new AsyncCallback<Integer>() {
...
//				UpdateC202(listPdfC202yDto);
	...
	public void UpdateC202(List<PdfC202yDTO> listPdfC202yDto) {
		yetaP320001Service.updateYetaP320001ToPdfC202Y(listPdfC202yDto, actionDatabase, new AsyncCallback<Integer>() {
...
//				UpdateC301(listPdfC301yDto);
	...
	public void UpdateC301(List<PdfC301yDTO> listPdfC301yDto) {
		yetaP320001Service.updateYetaP320001ToPdfC301Y(listPdfC301yDto, actionDatabase, new AsyncCallback<Integer>() {
...
//				UpdateC401(listPdfC401yDto);
	...
	public void UpdateC401(List<PdfC401yDTO> listPdfC401yDto) {
		yetaP320001Service.updateYetaP320001ToPdfC401Y(listPdfC401yDto, actionDatabase, new AsyncCallback<Integer>() {
...
//				UpdateD101(listPdfD101yDto);
	...
	public void UpdateD101(List<PdfD101yDTO> listPdfD101yDto) {
		yetaP320001Service.updateYetaP320001ToPdfD101Y(listPdfD101yDto, actionDatabase, new AsyncCallback<Integer>() {
...
//				UpdateE102(listPdfE102yDto);
	...
	public void UpdateE102(List<PdfE102yDTO> listPdfE102yDto) {
		yetaP320001Service.updateYetaP320001ToPdfE102Y(listPdfE102yDto, actionDatabase, new AsyncCallback<Integer>() {
...
//				UpdateF102(listPdfF102yDto);
	...
	public void UpdateF102(List<PdfF102yDTO> listPdfF102yDto) {
		yetaP320001Service.updateYetaP320001ToPdfF102Y(listPdfF102yDto, actionDatabase, new AsyncCallback<Integer>() {
...
//				UpdateG106(listPdfG106yDto);
	...
	public void UpdateG107(List<PdfG107yDTO> listPdfG107yDto) {
		yetaP320001Service.updateYetaP320001ToPdfG107Y(listPdfG107yDto, actionDatabase, new AsyncCallback<Integer>() {
...
//				UpdateG206(listPdfG206yDto);
	...
	public void UpdateG207(List<PdfG207yDTO> listPdfG207yDto) {
		yetaP320001Service.updateYetaP320001ToPdfG207Y(listPdfG207yDto, actionDatabase, new AsyncCallback<Integer>() {
...
//				UpdateG306(listPdfG306yDto);
	...
	public void UpdateG307(List<PdfG307yDTO> listPdfG307yDto) {
		yetaP320001Service.updateYetaP320001ToPdfG307Y(listPdfG307yDto, actionDatabase, new AsyncCallback<Integer>() {
...
//				UpdateJ101(listPdfJ101yDto);
	...
	public void UpdateJ101(List<PdfJ101yDTO> listPdfJ101yDto) {
		yetaP320001Service.updateYetaP320001ToPdfJ101Y(listPdfJ101yDto, actionDatabase, new AsyncCallback<Integer>() {
...
//				UpdateJ203(listPdfJ203yDto);
	...
	public void UpdateJ203(List<PdfJ203yDTO> listPdfJ203yDto) {
		yetaP320001Service.updateYetaP320001ToPdfJ203Y(listPdfJ203yDto, actionDatabase, new AsyncCallback<Integer>() {
...
//				UpdateJ301(listPdfJ301yDto);
	...
	public void UpdateJ301(List<PdfJ301yDTO> listPdfJ301yDto) {
		yetaP320001Service.updateYetaP320001ToPdfJ301Y(listPdfJ301yDto, actionDatabase, new AsyncCallback<Integer>() {
...
//				UpdateJ401(listPdfJ401yDto);
	...
	public void UpdateJ401(List<PdfJ401yDTO> listPdfJ401yDto) {
		yetaP320001Service.updateYetaP320001ToPdfJ401Y(listPdfJ401yDto, actionDatabase, new AsyncCallback<Integer>() {
...
//				UpdateK101(listPdfK101yDto);
	...
	public void UpdateK101(List<PdfK101yDTO> listPdfK101yDto) {
		yetaP320001Service.updateYetaP320001ToPdfK101Y(listPdfK101yDto, actionDatabase, new AsyncCallback<Integer>() {
...
//				UpdateL102(listPdfL102yDto);
	...
	public void UpdateL102(List<PdfL102yDTO> listPdfL102yDto) {
		yetaP320001Service.updateYetaP320001ToPdfL102Y(listPdfL102yDto, actionDatabase, new AsyncCallback<Integer>() {
...
//				UpdateL102(listPdfL102yDto);
	...
	public void UpdateN101(List<PdfN101yDTO> listPdfN101yDto) {
		yetaP320001Service.updateYetaP320001ToPdfN101Y(listPdfN101yDto, actionDatabase, new AsyncCallback<Integer>() {
...
//				UpdateO101(listPdfO101yDto);
	...
	public void UpdateO101(List<PdfO101yDTO> listPdfO101yDto) {
		yetaP320001Service.updateYetaP320001ToPdfO101Y(listPdfO101yDto, actionDatabase, new AsyncCallback<Integer>() {
...
//				UpdateP102(listPdfP102yDto);
	...
	public void UpdateP102(List<PdfP102yDTO> listPdfP102yDto) {
		yetaP320001Service.updateYetaP320001ToPdfP102Y(listPdfP102yDto, actionDatabase, new AsyncCallback<Integer>() {
