...
import com.app.exterms.yearendtax.client.service.yeta2019.YetaP430011Service;
...
@Service("YetaP430011Service")
public class YetaP430011ServiceImpl  extends AbstractCustomServiceImpl implements YetaP430011Service  ,YetaDaoConstants {

	 
	private static final Logger logger = LoggerFactory.getLogger(YetaP430011ServiceImpl.class);
	private static final String calledClass = YetaP430011ServiceImpl.class.getName();
	...
	public PagingLoadResult<BaseModel> getYeta4300ToYe161090List(ServiceParameters serviceParameters) throws MSFException {
		...
		Ye161090Srh_2019_VO ye161090SrhVo = new Ye161090Srh_2019_VO();
		...
		MSFSysm0100BM sessionUser;
			...
			if  (MSFSharedUtils.paramNull(ye161090DAO)) {
				...
				ye161090DAO = (Ye161090_2019_DAO) wac.getBean("Ye161090_2019_DAO"); 
			}
...
//		      	Yeta4220SrhVo.setHanNm(MSFSharedUtils.allowNulls(MSFServerUtils.getFilterValue(columnFilters, "hanNm")));    //한글성명 
				...
				if ( pagingValues.executeRecordCount ) { 
		        	...
		        	TimingInfo millisBeginQueryCount = SmrmfUtils.startTiming(logger);
		          	...
		          	int iResultCnt = ye161090DAO.selectYeta4300ToYe161090ListTotCnt(ye161090SrhVo);  
...
////		            Collection<Map<String, Object>> list ??????
		     	List list = ye161090DAO.selectYeta4300ToYe161090List(ye161090SrhVo);
