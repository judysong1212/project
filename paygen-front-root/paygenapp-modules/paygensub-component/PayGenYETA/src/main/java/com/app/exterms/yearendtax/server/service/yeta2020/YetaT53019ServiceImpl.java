...
* </pre>
 */
@Service("YetaT53019Service")
public class YetaT53019ServiceImpl  extends AbstractCustomServiceImpl implements YetaT53019Service  ,YetaDaoConstants {

	 
	private static final Logger logger = LoggerFactory.getLogger(YetaT53019ServiceImpl.class);
	private static final String calledClass = YetaT53019ServiceImpl.class.getName();
	...
	@Override
	public Long activityOnYetaT53019ToYe162510(List<Ye162510DTO> listYe162510Dto, ActionDatabase actionDatabase) throws MSFException {
			...
			String method = calledClass + ".activityOnYetaT53019ToYe162510";
			
			String windowNm = "소득공제신고자료관리";
			String windowId = "YETAT53019";
...
//		            YETA4130Vo.setMnthRnttyBurRgsum(MSFSharedUtils.allowNulls(ye162510Dto.getMnthRnttyBurRgsum()));    	/** column 월세_주민번호 : mnthRnttyBurRgsum */
		            // 암호화
...
//		            ye162510Vo.setMnthRnttyHusCnttArea(MSFSharedUtils.allowNulls(ye162510Dto.getMnthRnttyHusCnttArea()));    	/** column 월세주택계약면적 : mnthRnttyHusCnttArea */
		            ...
		            if((ActionDatabase.INSERT).equals(actionDatabase) || (ActionDatabase.UPDATE).equals(actionDatabase)) {
		            	//신규인지 수정인지 일련번호로 구분
//		            	if("0".equals(YETA4130Vo.getMnrnSqno())) {
				...
				result = iCnt;
		            ...
		            logger.error("EXCEPTION calling activityOnYetaT53019ToYe162510(): "+ ex); 
		            ...
		            result = new Long(0);
		            throw MSFServerUtils.getOperationException("activityOnYetaT53019ToYe162510", ex, logger);
		        }
		        finally {
	...
	//월세액소득공제명세 조회
	public PagingLoadResult<BaseModel> getYetaT53019ToYe162510List(ServiceParameters serviceParameters)throws MSFException {

		PagingLoadResult<BaseModel> retval = null;
		String method =  CLASS_YETAT13019TOYE162510_DATA_LIST;
		Ye162510Srh_2020_VO	ye162510Vo = new Ye162510Srh_2020_VO();
