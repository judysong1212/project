...
@RemoteServiceRelativePath("Yeta2900Service.gwt")
public interface Yeta2900Service extends RemoteService {
	/**
	 * Utility class for simplifying access to the instance of async service.
	 */
	public static class Util {
		private static Yeta2900ServiceAsync instance;
		public static Yeta2900ServiceAsync getInstance(){
			if (instance == null) {
				instance = GWT.create(Yeta2900Service.class);
			}
			return instance;
		}
	}
    ...
    public Pyyt0304BM Yeta2900InfoList(Pyyt0304DTO Pyyt0304Dto) throws MSFException ;
