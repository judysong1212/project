...
@Repository("Yeta3100DAO")
public class Yeta3100DAO extends EgovAbstractDAO implements IsSerializable {
    ...
    public String insertYetaP03007To3100(Yeta3100VO vo) throws Exception {
        return (String)insert("yeta3100DAO.insertYeta3100_S", vo);
    }
    ...
    public void updateYetaP03007To3100(Yeta3100VO vo) throws Exception {
        update("yeta3100DAO.updateYeta3100_S", vo);
    }
    ...
    public void deleteYetaP03007To3100(Yeta3100VO vo) throws Exception {
        delete("yeta3100DAO.deleteYeta3100_S", vo);
    }
    ...
    public List selectYetaP03001To3100List(Yeta3100SrhVO searchVO) throws Exception {
        return list("yeta3100DAO.selectYetaP03001To3100List_D", searchVO);
    }
    ...
    public int selectYetaP03007To3100ListTotCnt(Yeta3100SrhVO searchVO) {
        return (Integer)getSqlMapClientTemplate().queryForObject("yeta3100DAO.selectYetaP03001To3100ListTotCnt_S", searchVO);
    }
    ...
    public void fnPayr06430_PAYR418_CREATE_Delete(Yeta3100VO vo) throws Exception {
        delete("yeta3100DAO.fnPayr06430_PAYR418_CREATE_Delete_S", vo);
    }
    ...
    public Yeta3100VO selectYeta3100(Yeta3100VO vo) throws Exception {
        return (Yeta3100VO) selectByPk("yeta3100DAO.selectYeta3100_S", vo);
    }
    ...
    public List<?> selectYeta3100List(Yeta3100SrhVO searchVO) throws Exception {
        return list("yeta3100DAO.selectYeta3100List_D", searchVO);
    }
    ...
    public int selectYeta3100ListTotCnt(Yeta3100SrhVO searchVO) {
        return (Integer)getSqlMapClientTemplate().queryForObject("yeta3100DAO.selectYeta3100ListTotCnt_S", searchVO);
    }
