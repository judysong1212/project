...
import com.app.exterms.yearendtax.client.service.yeta2019.Yeta4080Service;
import com.app.exterms.yearendtax.server.service.yeta2019.dao.Yeta4080_2019_DAO;
...
@Service("Yeta4080Service")
public class Yeta4080ServiceImpl extends AbstractCustomServiceImpl implements YetaDaoConstantsGenerated, Yeta4080Service {

	private static final Logger logger = LoggerFactory.getLogger(Yeta4080ServiceImpl.class);
	private static final String calledClass = Yeta4080ServiceImpl.class.getName();

	@Autowired
	@Resource(name = "Yeta4080_2019_DAO")
	private Yeta4080_2019_DAO yeta4080DAO;
	...
	public PagingLoadResult<BaseModel> getSelectYeta4080ToBass0400List(ServiceParameters serviceParameters) throws MSFException {

        PagingLoadResult<BaseModel> retval = null;
        String method =  CLASS_YETA2080_TO_BASS0400_LIST;
        Yeta2080Srh_2019_VO   yeta2080SrhVo = new Yeta2080Srh_2019_VO();
        //Yeta2080VO      Yeta2080Vo = new Yeta2080VO();
        List<BaseModel>  bmResult = new ArrayList<BaseModel>();
        MSFSysm0100BM sessionUser = MSFServerUtils.getLoggedUser(RemoteServiceUtil.getThreadLocalRequest());
        
        if(MSFSharedUtils.paramNull(yeta4080DAO)){
        	WebApplicationContext wac = WebApplicationContextUtils.getRequiredWebApplicationContext(getHttpServletRequest().getSession().getServletContext());
        	yeta4080DAO = (Yeta4080_2019_DAO) wac.getBean("Yeta4080_2019_DAO");
        }
        ...
        try{
            ...
            if(pagingValues.executeRecordCount){ 
            	...
            	int iResultCnt = yeta4080DAO.selectYeta4080ListTotCnt(yeta2080SrhVo);
            ...
            List list = yeta4080DAO.selectYeta4080List(yeta2080SrhVo);
            ...
            SmrmfUtils.endTiming(logger, millisBeginSelectYeta2080List, "selectYeta4080List");
