...
import com.app.exterms.yearendtax.server.service.yeta2023.dao.Ye161030_2023_DAO;
import com.app.exterms.yearendtax.server.service.yeta2023.dao.Ye161040_2023_DAO;
import com.app.exterms.yearendtax.server.service.yeta2023.dao.Ye161050_2023_DAO;
import com.app.exterms.yearendtax.server.service.yeta2023.dao.Ye161055_2023_DAO;
import com.app.exterms.yearendtax.server.service.yeta2023.dao.Ye161060_2023_DAO;
import com.app.exterms.yearendtax.server.service.yeta2023.dao.Ye161070_2023_DAO;
import com.app.exterms.yearendtax.server.service.yeta2023.dao.Ye161080_2023_DAO;
import com.app.exterms.yearendtax.server.service.yeta2023.dao.Ye161090_2023_DAO;
import com.app.exterms.yearendtax.server.service.yeta2023.dao.Ye164010_2023_DAO;
import com.app.exterms.yearendtax.server.service.yeta2023.dao.Ye165030_2023_DAO;
import com.app.exterms.yearendtax.server.service.yeta2023.dao.Ye166010_2023_DAO;
import com.app.exterms.yearendtax.server.service.yeta2023.dao.Ye169010_2023_DAO;
...
import com.app.exterms.yearendtax.server.vo.Ye161050_2023_VO;
...
import com.app.exterms.yearendtax.server.vo.Ye161090_2023_VO;
import com.app.exterms.yearendtax.server.vo.Ye164010_2023_VO;
import com.app.exterms.yearendtax.server.vo.Ye169010Srh_2023_VO;
import com.app.exterms.yearendtax.server.vo.Ye169010_2023_VO;
...
import com.app.smrmf.pkg.yeta.yeta2023.pdfxml.Func_PdfInDdc_Yeta2023_Insert;
 ...
 */
@Service("Yeta8300Service")
public class Yeta8300ServiceImpl  extends AbstractCustomServiceImpl implements Yeta8300Service  ,YetaDaoConstants {
	 
	private static final Logger logger = LoggerFactory.getLogger(Yeta8300ServiceImpl.class);
	private static final String calledClass = Yeta8300ServiceImpl.class.getName();
	...
	@Autowired
	@Resource(name = "Ye161030_2023_DAO")
	private Ye161030_2023_DAO ye161030DAO;
	
	@Autowired
	@Resource(name = "Ye161040_2023_DAO")
	private Ye161040_2023_DAO ye161040DAO;
	
	@Autowired
	@Resource(name = "Ye161050_2023_DAO")
	private Ye161050_2023_DAO ye161050DAO;
	
	@Autowired
	@Resource(name = "Ye161055_2023_DAO")
	private Ye161055_2023_DAO ye161055DAO;
	
	@Autowired
	@Resource(name = "Ye161060_2023_DAO")
	private Ye161060_2023_DAO ye161060DAO;
	
	@Autowired
	@Resource(name = "Ye161070_2023_DAO")
	private Ye161070_2023_DAO ye161070DAO;
	
	@Autowired
	@Resource(name = "Ye161080_2023_DAO")
	private Ye161080_2023_DAO ye161080DAO;
	
	// 교육비 내역
	@Autowired
	@Resource(name = "Ye161090_2023_DAO")
	private Ye161090_2023_DAO ye161090DAO;
	
	@Autowired
	@Resource(name = "Ye169010_2023_DAO")
	private Ye169010_2023_DAO ye169010DAO;
	...
	// 기부금
	@Autowired
	@Resource(name = "Ye165030_2023_DAO")
	private Ye165030_2023_DAO ye165030DAO;
	
	// 신용카드
	@Autowired
	@Resource(name = "Ye166010_2023_DAO")
	private Ye166010_2023_DAO ye166010DAO;
	
	
	

	/** 대상자 정보 조회 **/
	public PagingLoadResult<BaseModel> getYeta8300ToYe161010DataList(ServiceParameters serviceParameters) throws MSFException {
	     ...
	     //	 List<String> listTyInttnCd = new ArrayList<String>(); 
			...
			if ( pagingValues.executeRecordCount ) { 
	        	...
	        	TimingInfo millisBeginQueryCount = SmrmfUtils.startTiming(logger);
	          	...
	          	int iResultCnt = ye161010DAO.selectYeta8300ToYe161010ListTotCnt(ye161010SrhVo);  
...
//	            Collection<Map<String, Object>> list ??????
	     	List list = ye161010DAO.selectYeta8300ToYe161010List(ye161010SrhVo);
			...
			SmrmfUtils.endTiming(logger, millisBeginYe161010DataList, "getYeta8300ToYe161010DataList");
	...
	/** 세액계산 정보 조회 **/
	public PagingLoadResult<BaseModel> getYeta8300ToSubTaxList(ServiceParameters serviceParameters) throws MSFException {

		PagingLoadResult<BaseModel> retval = null;
		String method = CLASS_YETA8300_TO_YE169010_SUBTAX_LIST;
		
		
		Ye169010Srh_2023_VO ye169010SrhVo = new Ye169010Srh_2023_VO();
		List<BaseModel> bmResult = new ArrayList<BaseModel>();
		MSFSysm0100BM sessionUser;
		...
		if  (MSFSharedUtils.paramNull(ye169010DAO)) {
			WebApplicationContext wac = WebApplicationContextUtils.getRequiredWebApplicationContext( getHttpServletRequest().getSession().getServletContext());
			ye169010DAO = (Ye169010_2023_DAO) wac.getBean("Ye169010_2023_DAO" ); 
		}
			...
			if ( pagingValues.executeRecordCount ) { 
	        	...
	        	TimingInfo millisBeginQueryCount = SmrmfUtils.startTiming(logger);
	          	...
	          	if("Y".equals(ye169010SrhVo.getC152StdTxDdcYn())) {
	          		iResultCnt = ye169010aDAO.selectYeta8300ToYe169010aListTotCnt(ye169010SrhVo);
	          	}else {
	          		iResultCnt = ye169010DAO.selectYeta8300ToYe169010ListtTotCnt(ye169010SrhVo);
	          	}
...
//	            Collection<Map<String, Object>> list ??????
	    	List list;
	     	if("Y".equals(ye169010SrhVo.getC152StdTxDdcYn())) {
		    	...
		    	list = ye169010aDAO.selectYeta8300ToYe169010aList(ye169010SrhVo);
	     		
          	}else {
          		
          		list = ye169010DAO.selectYeta8300ToYe169010List(ye169010SrhVo);
          	}
	...
	/** 인적공제명세 정보 조회 **/
	public PagingLoadResult<BaseModel> getYeta8300ToYe161030List(ServiceParameters serviceParameters) throws MSFException {
		

		PagingLoadResult<BaseModel> retval = null;
		String method =  CLASS_YETA8300_TO_YE161030_DATA_LIST;
		Ye161030Srh_2023_VO   ye161030SrhVo = new Ye161030Srh_2023_VO();
		List<BaseModel>  bmResult = new ArrayList<BaseModel>();
		MSFSysm0100BM sessionUser;
		...
		if  (MSFSharedUtils.paramNull(ye161030DAO)) {
			WebApplicationContext wac = WebApplicationContextUtils.getRequiredWebApplicationContext( getHttpServletRequest().getSession().getServletContext());
			ye161030DAO = (Ye161030_2023_DAO) wac.getBean("Ye161030_2023_DAO"); 
		}
...
//	    	List<String> listDeptCd = new ArrayList<String>();    
			...
			if ( pagingValues.executeRecordCount ) { 
	        	...
	        	TimingInfo millisBeginQueryCount = SmrmfUtils.startTiming(logger);
	          	...
	          	int iResultCnt = ye161030DAO.selectYeta83001ToYe161030ListtTotCnt(ye161030SrhVo);  
	     	...
	     	@SuppressWarnings("unchecked")
//	            Collection<Map<String, Object>> list ??????
	     	List list = ye161030DAO.selectYeta83001ToYe161030List(ye161030SrhVo);
			...
			SmrmfUtils.endTiming(logger, millisBeginPsnl0126DataList, "getYeta8300To2000List");
	...
	/** 소득공제명세 정보 조회 **/	
	public PagingLoadResult<BaseModel> getYeta8300ToYe161040List(ServiceParameters serviceParameters) throws MSFException {
		

		PagingLoadResult<BaseModel> retval = null;
		String method =  CLASS_YETA8300_TO_YE161040_DATA_LIST;
		Ye161040Srh_2023_VO   ye161040SrhVo = new Ye161040Srh_2023_VO();
		List<BaseModel>  bmResult = new ArrayList<BaseModel>();
		MSFSysm0100BM sessionUser;
		...
		if  (MSFSharedUtils.paramNull(ye161040DAO)) {
			WebApplicationContext wac = WebApplicationContextUtils.getRequiredWebApplicationContext( getHttpServletRequest().getSession().getServletContext());
			ye161040DAO = (Ye161040_2023_DAO) wac.getBean("Ye161040_2023_DAO"); 
		}
...
//	    	List<String> listDeptCd = new ArrayList<String>();    
			...
			if ( pagingValues.executeRecordCount ) { 
	        	...
	        	TimingInfo millisBeginQueryCount = SmrmfUtils.startTiming(logger);
	          	...
	          	int iResultCnt = ye161040DAO.selectYeta8300ToYe161040ListTotCnt(ye161040SrhVo);  
	     	...
	     	@SuppressWarnings("unchecked")
//	            Collection<Map<String, Object>> list ??????
	     	List list = ye161040DAO.selectYeta8300ToYe161040List(ye161040SrhVo);
	...
	/** 교육비내역 조회 **/
//	public PagingLoadResult<BaseModel> getYeta8300ToYe161090List(ServiceParameters serviceParameters) throws MSFException {
//			
//
//			PagingLoadResult<BaseModel> retval = null;
...
//	}
	...
	/** 기본사항 tab 조회 **/
	public Ye161020DTO getYeta8300ToYe161020Data(Ye161020DTO ye161020Dto) throws MSFException {
		

		Ye161020Srh_2023_VO ye161020SrhVo = new Ye161020Srh_2023_VO();
		MSFSysm0100BM sessionUser;

		String method = calledClass + ".getYeta8300ToYe161020Data";

		String windowNm = "소득공제신고자료관리";
		String windowId = "YETA8300";
		...
		if (MSFSharedUtils.paramNull(ye161020DAO)) {
			...
			ye161020DAO = (Ye161020_2023_DAO) wac.getBean("Ye161020_2023_DAO");
		}
...
//		int iResultCnt = ye161020DAO.selectYeta2300ToYe161020ListtTotCnt(ye161020SrhVo);
		...
		try {
			...
			egovResultDataList = ye161020DAO.selectYeta8300ToYe161020Data(ye161020SrhVo);
...
//					
	...
	/** 기본사항 tab 수정 **/ 
	@Override
	public int saveYeta8300ToYe161020tabItem01(Ye161020DTO ye161020Dto)throws Exception {
		// TODO Auto-generated method stub
		
		int result = 0;
		
		Ye161020_2023_VO ye161020Vo = new Ye161020_2023_VO();
		Ye160404_2023_VO ye160404Vo = new Ye160404_2023_VO();
		Ye169010_2023_VO ye169010Vo = new Ye169010_2023_VO();
		...
		String method = calledClass + ".saveYeta8300ToYe161020tabItem01";
		MSFSysm0100BM sessionUser = MSFServerUtils.getLoggedUser(RemoteServiceUtil.getThreadLocalRequest());
		
		try{
			// ---------- 기본사항 수정 시작 -------------------
			ye161020Vo = new Ye161020_2023_VO();
			...
			ye161020DAO.updateYeta8300Item01ToYe161020(ye161020Vo);
...
//			ye160404DAO.updateYeta2300ToYe160404(ye160404Vo);
			...
			// 주현근무처 ye169010
			ye169010Vo = new Ye169010_2023_VO();
			...
			ye169010DAO.updateYeta8300ToYe169010(ye169010Vo);
			
			BeanUtils.copyProperties(infcPkgYe161010Vo , ye169010Vo);  
			yeta8300ListenerAdt = new Yeta8300ListenerAdapter();
			yeta8300ListenerAdt.fnYeta8300_Ye161010_2023_CalcUpdate(RemoteServiceUtil.getThreadLocalRequest(), infcPkgYe161010Vo, "YE166020_INSERT");
	...
	/** 인적공제 tab 조회 **/
	public Ye161020DTO getYeta8300TabItem02ToYe161020Data(Ye161020DTO ye161020Dto) throws MSFException {
		

		Ye161020Srh_2023_VO ye161020SrhVo = new Ye161020Srh_2023_VO();
		MSFSysm0100BM sessionUser;

		String method = calledClass + ".getYeta8300TabItem02ToYe161020Data";
		...
		int iResultCnt = ye161020DAO.selectYeta8300ToYe161020ListtTotCnt(ye161020SrhVo);
...
//					returnYe161020Dto.set표준세액공제적용여부(MSFSharedUtils.allowNulls(tempMap.get("표준세액공제적용여부")));		/** column 표준세액공제적용여부 : 표준세액공제적용여부 */
	...
	/** 연금보험료공제 tab 조회 **/
	public Ye161055DTO getYeta8300TabItem04ToYe161055Data(Ye161055DTO ye161055Dto) throws MSFException {
		

		Ye161055Srh_2023_VO ye161055SrhVo = new Ye161055Srh_2023_VO();
		MSFSysm0100BM sessionUser;

		String method = calledClass + ".getYeta8300TabItem04ToYe161055Data";
		...
		if (MSFSharedUtils.paramNull(ye161055DAO)) {
			WebApplicationContext wac = WebApplicationContextUtils.getRequiredWebApplicationContext(getHttpServletRequest()
							.getSession().getServletContext());
			ye161055DAO = (Ye161055_2023_DAO) wac.getBean("Ye161055_2023_DAO");
		}
		...
		try {
			...
			egovResultDataList = ye161055DAO.selectYeta8300ToYe161055List(ye161055SrhVo);
	...
	/** 연금보험료공제 tab 수정 **/   
	@Override
	public int saveYeta8300ToYe161055tabItem04(Ye161055DTO ye161055Dto)throws Exception {
		// TODO Auto-generated method stub
		
		int result = 0;
		String method = calledClass + ".saveYeta8300ToYe161055tabItem04";
		
		String windowNm = "소득공제신고자료관리";
		String windowId = "YETA8300";
		
		Ye161055_2023_VO ye161055Vo = new Ye161055_2023_VO();
		Ye161050_2023_VO ye161050Vo = new Ye161050_2023_VO();
		...
		try{
			...
			ye161055Vo = new Ye161055_2023_VO();
			...
			ye161050Vo = new Ye161050_2023_VO();
			...
			ye161055DAO.updateYeta8300ToYe161055(ye161055Vo);
			ye161050DAO.updateYeta8300ToYe161050(ye161050Vo);
			
			BeanUtils.copyProperties(infcPkgYe161010Vo , ye161050Vo);  
			yeta8300ListenerAdt.fnYeta8300_Ye161010_2023_CalcUpdate(RemoteServiceUtil.getThreadLocalRequest(), infcPkgYe161010Vo, "YE161050");
	...
	/** 특별소득공제 tab 조회 **/
	public Ye161060DTO getYeta8300TabItem05ToYe161060Data(Ye161060DTO ye161060Dto) throws MSFException {
		

		Ye161060Srh_2023_VO ye161060SrhVo = new Ye161060Srh_2023_VO();
		MSFSysm0100BM sessionUser;

		String method = calledClass + ".getYeta8300TabItem05ToYe161060Data";
		...
		if (MSFSharedUtils.paramNull(ye161060DAO)) {
			WebApplicationContext wac = WebApplicationContextUtils.getRequiredWebApplicationContext(getHttpServletRequest()
							.getSession().getServletContext());
			ye161060DAO = (Ye161060_2023_DAO) wac.getBean("Ye161060_2023_DAO");
		}
		...
		try {
			...
			egovResultDataList = ye161060DAO.selectYeta8300ToYe161060tabItem05List(ye161060SrhVo);
	...
	@Override
	public int saveYeta8300ToYe161060tabItem05_1(Ye161060DTO ye161060Dto)throws Exception {
		// TODO Auto-generated method stub
		
		int result = 0;
		String method = calledClass + ".saveYeta8300ToYe161060tabItem05_1";
		...
		Ye161060_2023_VO ye161060Vo = new Ye161060_2023_VO();
		MSFSysm0100BM sessionUser = MSFServerUtils.getLoggedUser(RemoteServiceUtil.getThreadLocalRequest());
		...
		try{
			...
			ye161060DAO.updateYeta8300ToYe161060tabItem05_1(ye161060Vo);
			
			BeanUtils.copyProperties(infcPkgYe161010Vo , ye161060Vo);  
			yeta8300ListenerAdt.fnYeta8300_Ye161010_2023_CalcUpdate(RemoteServiceUtil.getThreadLocalRequest(), infcPkgYe161010Vo, "YE161060");
	...
	@Override
	public int saveYeta8300ToYe161060tabItem05_2(Ye161060DTO ye161060Dto)throws Exception {
		// TODO Auto-generated method stub
		
		int result = 0;
		String method = calledClass + ".saveYeta8300ToYe161060tabItem05_2";
		...
		try{
			...
			ye161060DAO.updateYeta8300ToYe161060tabItem05_2(ye161060Vo);
	...
	/** 그밖의소득공제1 tab 조회 **/
	public Ye161070DTO getYeta8300TabItem06ToYe161070Data(Ye161070DTO ye161070Dto) throws MSFException {
		

		Ye161070Srh_2023_VO ye161070SrhVo = new Ye161070Srh_2023_VO();
		MSFSysm0100BM sessionUser;

		String method = calledClass + ".getYeta8300TabItem06ToYe161070Data";
		...
		if (MSFSharedUtils.paramNull(ye161070DAO)) {
			WebApplicationContext wac = WebApplicationContextUtils.getRequiredWebApplicationContext(getHttpServletRequest()
							.getSession().getServletContext());
			ye161070DAO = (Ye161070_2023_DAO) wac.getBean("Ye161070_2023_DAO");
		}
		...
		try {
			...
			egovResultDataList = ye161070DAO.selectYeta8300ToYe161070List(ye161070SrhVo);
			...
			if (egovResultDataList != null && egovResultDataList.size() > 0) {
				...
				for (int i = 0; i < egovResultDataList.size(); i++) {
					...
					returnYe161070Dto.setCpiv20AsctTwoUseAmt(Long.parseLong(MSFSharedUtils.defaultNulls(tempMap.get("cpiv20AsctTwoUseAmt"), "0")));    			/** column 출자투자금액_조합2등_2020납입금 : cpiv20AsctTwoUseAmt */
					returnYe161070Dto.setCpiv20AsctTwoDdcAmt(Long.parseLong(MSFSharedUtils.defaultNulls(tempMap.get("cpiv20AsctTwoDdcAmt"), "0")));    			/** column 출자투자금액 조합2등_2020공제액 : cpiv20AsctTwoDdcAmt */
					
					returnYe161070Dto.setCpiv21AsctUseAmt(Long.parseLong(MSFSharedUtils.defaultNulls(tempMap.get("cpiv21AsctUseAmt"), "0")));    			/** column 출자투자금액_조합등_2021납입금 : cpiv21AsctUseAmt */
					returnYe161070Dto.setCpiv21AsctDdcAmt(Long.parseLong(MSFSharedUtils.defaultNulls(tempMap.get("cpiv21AsctDdcAmt"), "0")));    			/** column 출자투자금액 조합등_2021공제액 : cpiv21AsctDdcAmt */
					returnYe161070Dto.setCpiv21VntUseAmt(Long.parseLong(MSFSharedUtils.defaultNulls(tempMap.get("cpiv21VntUseAmt"), "0")));    				/** column 출자투자금액벤처등_2021납입금액 : cpiv21VntUseAmt */
					returnYe161070Dto.setCpiv21VntDdcAmt(Long.parseLong(MSFSharedUtils.defaultNulls(tempMap.get("cpiv21VntDdcAmt"), "0")));    				/** column 출자투자금액벤처등_2021공제액 : cpiv21VntDdcAmt */
					returnYe161070Dto.setCpiv21AsctTwoUseAmt(Long.parseLong(MSFSharedUtils.defaultNulls(tempMap.get("cpiv21AsctTwoUseAmt"), "0")));    			/** column 출자투자금액_조합2등_2021납입금 : cpiv21AsctTwoUseAmt */
					returnYe161070Dto.setCpiv21AsctTwoDdcAmt(Long.parseLong(MSFSharedUtils.defaultNulls(tempMap.get("cpiv21AsctTwoDdcAmt"), "0")));    			/** column 출자투자금액 조합2등_2021공제액 : cpiv21AsctTwoDdcAmt */
					
					returnYe161070Dto.setCpiv22AsctUseAmt(Long.parseLong(MSFSharedUtils.defaultNulls(tempMap.get("cpiv22AsctUseAmt"), "0")));    			/** column 출자투자금액_조합등_2022납입금 : cpiv22AsctUseAmt */
					returnYe161070Dto.setCpiv22AsctDdcAmt(Long.parseLong(MSFSharedUtils.defaultNulls(tempMap.get("cpiv22AsctDdcAmt"), "0")));    			/** column 출자투자금액 조합등_2022공제액 : cpiv22AsctDdcAmt */
					returnYe161070Dto.setCpiv22VntUseAmt(Long.parseLong(MSFSharedUtils.defaultNulls(tempMap.get("cpiv22VntUseAmt"), "0")));    				/** column 출자투자금액벤처등_2022납입금액 : cpiv22VntUseAmt */
					returnYe161070Dto.setCpiv22VntDdcAmt(Long.parseLong(MSFSharedUtils.defaultNulls(tempMap.get("cpiv22VntDdcAmt"), "0")));    				/** column 출자투자금액벤처등_2022공제액 : cpiv22VntDdcAmt */
					returnYe161070Dto.setCpiv22AsctTwoUseAmt(Long.parseLong(MSFSharedUtils.defaultNulls(tempMap.get("cpiv22AsctTwoUseAmt"), "0")));    			/** column 출자투자금액_조합2등_2022납입금 : cpiv22AsctTwoUseAmt */
					returnYe161070Dto.setCpiv22AsctTwoDdcAmt(Long.parseLong(MSFSharedUtils.defaultNulls(tempMap.get("cpiv22AsctTwoDdcAmt"), "0")));    			/** column 출자투자금액 조합2등_2022공제액 : cpiv22AsctTwoDdcAmt */
	...
	/** 그밖의소득공제1tab 금액 수정 **/
	@Override
	public int saveYeta8300ToYe161070tabItem06(Ye161070DTO ye161070Dto)throws Exception {
		// TODO Auto-generated method stub
		
		int result = 0;
		String method = calledClass + ".saveYeta8300ToYe161070tabItem06";
		...
		Ye161070_2023_VO ye161070Vo = new Ye161070_2023_VO();
		MSFSysm0100BM sessionUser = MSFServerUtils.getLoggedUser(RemoteServiceUtil.getThreadLocalRequest());
		...
		ye161070Vo.setCpiv20AsctUseAmt(new BigDecimal(MSFSharedUtils.defaultNulls( ye161070Dto.getCpiv20AsctUseAmt(), "0")));    			/** column 출자투자금액_조합등_2020납입금 : cpiv20AsctUseAmt */
		ye161070Vo.setCpiv20AsctDdcAmt(new BigDecimal(MSFSharedUtils.defaultNulls( ye161070Dto.getCpiv20AsctDdcAmt(), "0")));    			/** column 출자투자금액 조합등_2020공제액 : cpiv20AsctDdcAmt */
		ye161070Vo.setCpiv20AsctTwoUseAmt(new BigDecimal(MSFSharedUtils.defaultNulls( ye161070Dto.getCpiv20AsctTwoUseAmt(), "0")));    			/** column 출자투자금액_조합2등_2020납입금 : cpiv20AsctTwoUseAmt */
		ye161070Vo.setCpiv20AsctTwoDdcAmt(new BigDecimal(MSFSharedUtils.defaultNulls( ye161070Dto.getCpiv20AsctTwoDdcAmt(), "0")));    			/** column 출자투자금액 조합2등_2020공제액 : cpiv20AsctTwoDdcAmt */
		ye161070Vo.setCpiv20VntUseAmt(new BigDecimal(MSFSharedUtils.defaultNulls( ye161070Dto.getCpiv20VntUseAmt(), "0")));    				/** column 출자투자금액벤처등_2020납입금액 : cpiv20VntUseAmt */
		ye161070Vo.setCpiv20VntDdcAmt(new BigDecimal(MSFSharedUtils.defaultNulls( ye161070Dto.getCpiv20VntDdcAmt(), "0")));    				/** column 출자투자금액벤처등_2020공제액 : cpiv20VntDdcAmt */
		
		ye161070Vo.setCpiv21AsctUseAmt(new BigDecimal(MSFSharedUtils.defaultNulls( ye161070Dto.getCpiv21AsctUseAmt(), "0")));    			/** column 출자투자금액_조합등_2021납입금 : cpiv21AsctUseAmt */
		ye161070Vo.setCpiv21AsctDdcAmt(new BigDecimal(MSFSharedUtils.defaultNulls( ye161070Dto.getCpiv21AsctDdcAmt(), "0")));    			/** column 출자투자금액 조합등_2021공제액 : cpiv21AsctDdcAmt */
		ye161070Vo.setCpiv21AsctTwoUseAmt(new BigDecimal(MSFSharedUtils.defaultNulls( ye161070Dto.getCpiv21AsctTwoUseAmt(), "0")));    			/** column 출자투자금액_조합2등_2021납입금 : cpiv21AsctTwoUseAmt */
		ye161070Vo.setCpiv21AsctTwoDdcAmt(new BigDecimal(MSFSharedUtils.defaultNulls( ye161070Dto.getCpiv21AsctTwoDdcAmt(), "0")));    			/** column 출자투자금액 조합2등_2021공제액 : cpiv21AsctTwoDdcAmt */
		ye161070Vo.setCpiv21VntUseAmt(new BigDecimal(MSFSharedUtils.defaultNulls( ye161070Dto.getCpiv21VntUseAmt(), "0")));    				/** column 출자투자금액벤처등_2021납입금액 : cpiv21VntUseAmt */
		ye161070Vo.setCpiv21VntDdcAmt(new BigDecimal(MSFSharedUtils.defaultNulls( ye161070Dto.getCpiv21VntDdcAmt(), "0")));    				/** column 출자투자금액벤처등_2021공제액 : cpiv21VntDdcAmt */
		
		ye161070Vo.setCpiv22AsctUseAmt(new BigDecimal(MSFSharedUtils.defaultNulls( ye161070Dto.getCpiv22AsctUseAmt(), "0")));    			/** column 출자투자금액_조합등_2022납입금 : cpiv22AsctUseAmt */
		ye161070Vo.setCpiv22AsctDdcAmt(new BigDecimal(MSFSharedUtils.defaultNulls( ye161070Dto.getCpiv22AsctDdcAmt(), "0")));    			/** column 출자투자금액 조합등_2022공제액 : cpiv22AsctDdcAmt */
		ye161070Vo.setCpiv22AsctTwoUseAmt(new BigDecimal(MSFSharedUtils.defaultNulls( ye161070Dto.getCpiv22AsctTwoUseAmt(), "0")));    			/** column 출자투자금액_조합2등_2022납입금 : cpiv22AsctTwoUseAmt */
		ye161070Vo.setCpiv22AsctTwoDdcAmt(new BigDecimal(MSFSharedUtils.defaultNulls( ye161070Dto.getCpiv22AsctTwoDdcAmt(), "0")));    			/** column 출자투자금액 조합2등_2022공제액 : cpiv22AsctTwoDdcAmt */
		ye161070Vo.setCpiv22VntUseAmt(new BigDecimal(MSFSharedUtils.defaultNulls( ye161070Dto.getCpiv22VntUseAmt(), "0")));    				/** column 출자투자금액벤처등_2022납입금액 : cpiv22VntUseAmt */
		ye161070Vo.setCpiv22VntDdcAmt(new BigDecimal(MSFSharedUtils.defaultNulls( ye161070Dto.getCpiv22VntDdcAmt(), "0")));    				/** column 출자투자금액벤처등_2022공제액 : cpiv22VntDdcAmt */
		
		ye161070Vo.setIvcpInvmUseAmtSum(ye161070Vo.getCpiv20AsctUseAmt().add(ye161070Vo.getCpiv20VntDdcAmt()).add(ye161070Vo.getCpiv20AsctTwoUseAmt())
												.add(ye161070Vo.getCpiv21AsctUseAmt()).add(ye161070Vo.getCpiv21VntUseAmt()).add(ye161070Vo.getCpiv21AsctTwoUseAmt())
												.add(ye161070Vo.getCpiv22AsctUseAmt()).add(ye161070Vo.getCpiv22VntUseAmt()).add(ye161070Vo.getCpiv22AsctTwoUseAmt()));    			/** column 투자조합출자등소득공제납입금액계 : ivcpInvmUseAmtSum */
		//2022연말정산_수정 : 19 -> 20, 20 -> 21, 21 -> 22
...
//		ye161070Vo.setLtrmCniSsDdcAmt(new BigDecimal(MSFSharedUtils.defaultNulls( ye161070Dto.getLtrmCniSsDdcAmt(), "0")));    				/** column 장기집합투자증권저축공제금액 : ltrmCniSsDdcAmt */
		...
		try{
			...
			ye161070DAO.updateYeta8300ToYe161070tabItem06(ye161070Vo);
			
			BeanUtils.copyProperties(infcPkgYe161010Vo , ye161070Vo);  
			yeta8300ListenerAdt.fnYeta8300_Ye161010_2023_CalcUpdate(RemoteServiceUtil.getThreadLocalRequest(), infcPkgYe161010Vo, "YE161070");
	...
	/** 그밖의소득공제2tab 금액 수정 **/
	@Override
	public int saveYeta8300ToYe161070tabItem07(Ye161070DTO ye161070Dto)throws Exception {
		// TODO Auto-generated method stub
		
		int result = 0;
		String method = calledClass + ".saveYeta8300ToYe161070tabItem07";
...
//		ye161070Vo.setTyShfyPrsAddDdcrtUseAmt(new BigDecimal(MSFSharedUtils.defaultNulls( ye161070Dto.getTyShfyPrsAddDdcrtUseAmt(), "0")));	/** column 본인추가공제율사용분_2016_상반기 : tyShfyPrsAddDdcrtUseAmt */
		...
		try{
			...
			ye161070DAO.updateYeta8300ToYe161070tabItem07(ye161070Vo);
	...
	/** 세액감면및세액공제1tab 조회 **/
	public Ye161080DTO getYeta8300TabItem08ToYe161080Data(Ye161080DTO ye161080Dto) throws MSFException {
		

		Ye161080Srh_2023_VO ye161080SrhVo = new Ye161080Srh_2023_VO();
		MSFSysm0100BM sessionUser;

		String method = calledClass + ".getYeta8300TabItem08ToYe161080Data";
		...
		if (MSFSharedUtils.paramNull(ye161080DAO)) {
			WebApplicationContext wac = WebApplicationContextUtils.getRequiredWebApplicationContext(getHttpServletRequest()
							.getSession().getServletContext());
			ye161080DAO = (Ye161080_2023_DAO) wac.getBean("Ye161080_2023_DAO");
		}
		...
		try {
			...
			egovResultDataList = ye161080DAO.selectYeta8300ToYe161080tabItem08List(ye161080SrhVo);
			...
			if (egovResultDataList != null && egovResultDataList.size() > 0) {
				...
				for (int i = 0; i < egovResultDataList.size(); i++) {
					...
					returnYe161080Dto.setRtpnIsaUseAmt(Long.parseLong(MSFSharedUtils.defaultNulls(tempMap.get("rtpnIsaUseAmt"), "0")));    						/** column 연금계좌_ISA_퇴직연금납입금액 : rtpnIsaUseAmt */
					returnYe161080Dto.setRtpnDdcIsaTrgtAmt(Long.parseLong(MSFSharedUtils.defaultNulls(tempMap.get("rtpnDdcIsaTrgtAmt"), "0")));    				/** column 연금계좌_ISA_퇴직연금공제대상금액 : rtpnDdcIsaTrgtAmt */
					returnYe161080Dto.setRtpnDdcIsaAmt(Long.parseLong(MSFSharedUtils.defaultNulls(tempMap.get("rtpnDdcIsaAmt"), "0")));   			 			/** column 연금계좌_ISA_퇴직연금공제세액 : rtpnDdcIsaAmt */
					...
					returnYe161080Dto.setPnsnSvngIsaUseAmt(Long.parseLong(MSFSharedUtils.defaultNulls(tempMap.get("pnsnSvngIsaUseAmt"), "0")));    				/** column 연금계좌_ISA_연금저축납입금액 : pnsnSvngIsaUseAmt */
					returnYe161080Dto.setPnsnSvngDdcIsaTrgtAmt(Long.parseLong(MSFSharedUtils.defaultNulls(tempMap.get("pnsnSvngDdcIsaTrgtAmt"), "0")));			/** column 연금계좌_ISA_연금저축공제대상금액 : pnsnSvngDdcIsaTrgtAmt */
					returnYe161080Dto.setPnsnSvngDdcIsaAmt(Long.parseLong(MSFSharedUtils.defaultNulls(tempMap.get("pnsnSvngDdcIsaAmt"), "0")));    				/** column 연금계좌_ISA연금저축공제세액 : pnsnSvngDdcIsaAmt */
	...
	@Override
	public int saveYeta8300ToYe161080tabItem08_1(Ye161080DTO ye161080Dto)throws Exception {
		// TODO Auto-generated method stub
		
		int result = 0;
		String method = calledClass + ".saveYeta8300ToYe161060tabItem08_1";
		...
		Ye161080_2023_VO ye161080Vo = new Ye161080_2023_VO();
		MSFSysm0100BM sessionUser = MSFServerUtils.getLoggedUser(RemoteServiceUtil.getThreadLocalRequest());
...
//		ye161080Vo.setInfeePymDdcAmtSum(new BigDecimal(MSFSharedUtils.defaultNulls(ye161080Dto.getInfeePymDdcAmtSum(), "0")));    		/** column 보험료공제세액합계 : infeePymDdcAmtSum */
		...
		try{
			...
			ye161080DAO.updateYeta8300ToYe161080tabItem08_1(ye161080Vo);
			
			BeanUtils.copyProperties(infcPkgYe161010Vo , ye161080Vo);  
			yeta8300ListenerAdt.fnYeta8300_Ye161010_2023_CalcUpdate(RemoteServiceUtil.getThreadLocalRequest(), infcPkgYe161010Vo, "YE162010");
	...
	@Override
	public int saveYeta8300ToYe161080tabItem08_3(Ye161080DTO ye161080Dto) throws Exception {
		// TODO Auto-generated method stub

		int result = 0;
		String method = calledClass + ".saveYeta8300ToYe161080tabItem08_3";
...
//		ye161080Vo.setScxpsDdcAmtSum(new BigDecimal(MSFSharedUtils.defaultNulls(ye161080Dto.getScxpsDdcAmtSum(), "0")));    /** column 교육비공제세액금액합계 : scxpsDdcAmtSum */
		...
		try{
			...
			ye161080DAO.updateYeta8300ToYe161080tabItem08_3(ye161080Vo);
			
			BeanUtils.copyProperties(infcPkgYe161010Vo , ye161080Vo);  
			yeta8300ListenerAdt.fnYeta8300_Ye161010_2023_CalcUpdate(RemoteServiceUtil.getThreadLocalRequest(), infcPkgYe161010Vo, "YE161080");
	...
	public Long saveYeta8300ToYe161090tabItem08_3(List<Ye161090DTO> listYe161090Dto, ActionDatabase actionDatabase) throws Exception {
		...
		String method = calledClass + ".saveYeta8300ToYe161090tabItem08_3";
		...
		Ye161090_2023_VO ye161090Vo = new Ye161090_2023_VO();
		...
		try {
			...
			for (int iYetaCnt = 0; iYetaCnt < listYe161090Dto.size(); iYetaCnt++) {
        		...
        		ye161090Vo = new Ye161090_2023_VO();
				...
				case INSERT:
					...
					ye161090DAO.insertYeta8300ToYe161090(ye161090Vo);
					
					break;
				case UPDATE:
					
					ye161090DAO.updateYeta8300ToYe161090(ye161090Vo);

					break;
				case DELETE:
					
					ye161090DAO.deleteYeta8300ToYe161090(ye161090Vo);
	...
	/** 세액감면및세액공제2tab 조회 **/
	public Ye161080DTO getYeta8300TabItem09ToYe161080Data(Ye161080DTO ye161080Dto) throws MSFException {
		

		Ye161080Srh_2023_VO ye161080SrhVo = new Ye161080Srh_2023_VO();
		MSFSysm0100BM sessionUser;

		String method = calledClass + ".getYeta8300TabItem09ToYe161080Data";
		...
		try {
			...
			egovResultDataList = ye161080DAO.selectYeta8300ToYe161080tabItem09List(ye161080SrhVo);
...
//					returnYe161080Dto.setYetaC119(Long.parseLong(MSFSharedUtils.defaultNulls(tempMap.get("yetaC119"), "0")));    					/** column C119_세액감면합계금액 : yetaC119 */
	...
	/** 세액감면및세액공제2 금액 수정 **/
	@Override
	public int saveYeta8300ToYe161080tabItem09(Ye161080DTO ye161080Dto)throws Exception {
		// TODO Auto-generated method stub
		
		int result = 0;
		String method = calledClass + ".saveYeta8300ToYe161080tabItem09";
...
//		ye161080Vo.setIncmDducWtnnteSumtDt(ye161080Dto.getIncmDducWtnnteSumtDt());    /** column 소득공제신고서제출일자 : incmDducWtnnteSumtDt */
			...
			ye161080DAO.updateYeta8300ToYe161080tabItem09(ye161080Vo);
			ye169010DAO.updateYeta8300ToYe169010tabItem09(ye169010Vo);
	...
	/** 추가제출서류tab 조회 **/
	public Ye161080DTO getYeta8300TabItem10ToYe161080Data(Ye161080DTO ye161080Dto) throws MSFException {
		

		Ye161080Srh_2023_VO ye161080SrhVo = new Ye161080Srh_2023_VO();
		MSFSysm0100BM sessionUser;

		String method = calledClass + ".getYeta8300TabItem10ToYe161080Data";
		...
		try {
			...
			egovResultDataList = ye161080DAO.selectYeta8300ToYe161080tabItem10List(ye161080SrhVo);
	...
	/** 추가제출서류 수정 **/
	@Override
	public int saveYeta8300ToYe161080tabItem10(Ye161080DTO ye161080Dto)throws Exception {
		// TODO Auto-generated method stub
		
		int result = 0;
		String method = calledClass + ".saveYeta8300ToYe161080tabItem10";
...
//		ye161080Vo.setCd218(ye161080Dto.getCd218());    /** column 신고인성명 : cd218 *
		...
		try{
			...
			ye161080DAO.updateYeta8300ToYe161080tabItem10(ye161080Vo);
	...
	/** 인적공제 명세 추가 **/
	@Override
	public Long activityOnYeta8300ToYe161030(List<Ye161030DTO> listYe161030Dto, ActionDatabase actionDatabase)  throws MSFException {
		...
		String method = calledClass + ".activityOnYeta8300ToYe161030";
		MSFSysm0100BM sessionUser = MSFServerUtils.getLoggedUser(RemoteServiceUtil.getThreadLocalRequest());
		...
		try { 
			Ye161020_2023_VO  ye161020Vo = new Ye161020_2023_VO();
			Ye161030_2023_VO  ye161030Vo = new Ye161030_2023_VO();
			Ye161040_2023_VO  ye161040Vo = new Ye161040_2023_VO();
			...
			for(int iYetaCnt=0; iYetaCnt < listYe161030Dto.size(); iYetaCnt++) {
				...
				/** 인적공제명세  **/
				ye161030Vo = new Ye161030_2023_VO();
	            ...
	            /** 인적소득 **/
	            ye161040Vo = new Ye161040_2023_VO();
...
//                tpPayr0530Vo.setSchlExpnExtpyPymtEndDt(payr0530Dto.getSchlExpnExtpyPymtEndDt());    /** column 학비수당지급종료일자 : schlExpnExtpyPymtEndDt */
				...
				case INSERT:
					...
					ye161030DAO.insertYeta8300ToYe161030(ye161030Vo);
...
//					payr0530Vo.setInptAddr(RemoteServiceUtil.getThreadLocalRequest().getRemoteHost());    	/** column 입력주소 : inptAddr */
					...
					ye161040DAO.deleteYeta8300ToYe161040(ye161040Vo); 
					// 소득공제명세 데이터 추가 
					ye161040DAO.insertYeta8300ToYe161040_01(ye161040Vo);
					ye161040DAO.insertYeta8300ToYe161040_02(ye161040Vo);
...
//					yeta2300ListenerAdt.fnYeta2300_Ye161010_2017_CalcUpdate(RemoteServiceUtil.getThreadLocalRequest(), infcPkgYe161010Vo, "YE166020_DELETE");
					yeta8300ListenerAdt.fnYeta8300_Ye161010_2023_CalcUpdate(RemoteServiceUtil.getThreadLocalRequest(), infcPkgYe161010Vo, "YE166020_NEW");
					yeta8300ListenerAdt.fnYeta8300_Ye161010_2023_CalcUpdate(RemoteServiceUtil.getThreadLocalRequest(), infcPkgYe161010Vo, "YE161030");
				...
				case UPDATE:
					...
					if(ye161030Vo.getTxprDscmNoCntn() != null || !"".equals(ye161030Vo.getTxprDscmNoCntn())) {
						...
						ye161030DAO.updateYeta8300ToYe161030(ye161030Vo);
					}
					...
					ye161020DAO.updateYeta8300Item02ToYe161020(ye161020Vo);
...
//					yeta3220Vo.setBeforeJumin(MSFSharedUtils.allowNulls(yeta3220Dto.getBeforeJumin().replace("-", "")));	//수정전 주민번호
					...
					// 1. 인적공제 내역 삭제
					ye161030DAO.deleteYeta8300ToYe161030(ye161030Vo);
					
					// 2. 의료비 내역
					ye164010DAO.deleteYeta8300ToYe164010(ye164010Vo);
					...
					yeta8300ListenerAdt = new Yeta8300ListenerAdapter();
					BeanUtils.copyProperties(infcPkgYe161010Vo , ye161030Vo);  
					yeta8300ListenerAdt.fnYeta8300_Ye161010_2023_CalcUpdate(RemoteServiceUtil.getThreadLocalRequest(), infcPkgYe161010Vo, "YE166020_DELETE");
			...
			result = new Long(0);
			ex.printStackTrace();
			throw MSFServerUtils.getOperationException("activityOnYeta8300ToYe161030", ex, logger);
	...
	/** 소득공제 tab 수정 **/ 
	@Override
	public int saveYeta8300ToYe1610400tabItem03(List<Ye161040DTO> listYe161040Dto_01, List<Ye161040DTO> listYe161040Dto_02)  throws MSFException {
		...
		String method = calledClass + ".saveYeta8300ToYe1610400tabItem03";
		MSFSysm0100BM sessionUser = MSFServerUtils.getLoggedUser(RemoteServiceUtil.getThreadLocalRequest());
		...
		try {
			...
			for(int iYetaCnt=0; iYetaCnt < listYe161040Dto_01.size(); iYetaCnt++) {
				...
				//2022연말정산_추가
				ye161040Vo.setTotCrdcPreSum(new BigDecimal(MSFSharedUtils.defaultNulls(ye161040Dto.getTotCrdcPreSum(), "0")));
				ye161040Vo.setTotCrdcCurrSum(new BigDecimal(MSFSharedUtils.defaultNulls(ye161040Dto.getTotCrdcCurrSum(), "0")));
				ye161040Vo.setTotTdmrPreSum(new BigDecimal(MSFSharedUtils.defaultNulls(ye161040Dto.getTotTdmrPreSum(), "0")));
				ye161040Vo.setTotTdmrCurrSum(new BigDecimal(MSFSharedUtils.defaultNulls(ye161040Dto.getTotTdmrCurrSum(), "0")));
				ye161040Vo.setTfhyPbtAmt(new BigDecimal(MSFSharedUtils.defaultNulls(ye161040Dto.getTfhyPbtAmt(), "0")));
				ye161040Vo.setShfyPbtAmt(new BigDecimal(MSFSharedUtils.defaultNulls(ye161040Dto.getShfyPbtAmt(), "0")));
				ye161040Vo.setZrtdDdcTrgtAmt(new BigDecimal(MSFSharedUtils.defaultNulls(ye161040Dto.getZrtdDdcTrgtAmt(), "0")));
				//2022연말정산_추가
...
//				ye161040Vo.setInptAddr(ye161040Dto.getInptAddr());    /** column 입력주소 : inptAddr */
		        ...
		        ye161040DAO.updateYeta8300ToYe161040(ye161040Vo);
...
//			 yeta2000DAO.updateYeta0300ToYeta2000_Item03(yeta2000Vo);  
			...
			result = 0;
			ex.printStackTrace();
			throw MSFServerUtils.getOperationException("saveYeta8300ToYe1610400tabItem03_1", ex, logger);
...
//			yeta2000DAO.updateYeta0300ToYeta2000_Item03(yeta2000Vo);  
			...
			throw MSFServerUtils.getOperationException("saveYeta8300ToYe1610400tabItem03_2", ex, logger);
   ...
   @Override
	 public PagingLoadResult<ShowMessageBM> fnYeta8300_Ye161010_2023_CalcTax(List<Ye161010DTO> listYe161010Dto) throws MSFException {
    	...
    	String method = calledClass + ".fnYeta8300_Ye161010_2023_CalcTax";
        MSFSysm0100BM sessionUser = MSFServerUtils.getLoggedUser(RemoteServiceUtil.getThreadLocalRequest());
        ...
        try {  
        	...
        	List<InfcPkgYe161010_2023_VO> listYe161010VO = new ArrayList<InfcPkgYe161010_2023_VO>();
			 
              for (int iCnt = 0;iCnt < listYe161010Dto.size();iCnt++) { 
            	  
            	    Ye161010DTO ye161010Dto = new Ye161010DTO();   
	            	Ye161010_2023_VO  ye161010Vo = new Ye161010_2023_VO(); 
...
//					 
           ...
           Yeta8300ListenerAdapter yetaLsAdtr = new Yeta8300ListenerAdapter();
           retval = yetaLsAdtr.fnYeta8300_Ye161010_2023_CalcTax(RemoteServiceUtil.getThreadLocalRequest(),listYe161010VO);
 
        }
        catch (Exception ex) {
        	 
            logger.error("EXCEPTION calling fnYeta8300_Ye161010_2023_CalcTax(): "+ex); 
            
            /** 에러 로그 **/			
            MSFLogHistoryUtils.tracerUserExceptionActivity(sessionUser,method,calledClass,"C",ex, windowNm , windowId);
             
            throw MSFServerUtils.getOperationException("fnYeta8300_Ye161010_2023_CalcTax", ex, logger);
        }
        finally {
...
*/
   @Override
 public PagingLoadResult<ShowMessageBM> fnYeta8300Ye161010_2023_AllCalcTax(Ye161010DTO ye161010Dto) throws MSFException {
    	...
    	String method = calledClass + ".fnYeta8300Ye161010_2023_AllCalcTax";
        MSFSysm0100BM sessionUser = MSFServerUtils.getLoggedUser(RemoteServiceUtil.getThreadLocalRequest());
       ...
       // yeta2200Service = (InfcPkgYeta2200Service)BeanFinder.getBean("InfcPkgYeta2200Service"); 
        ...
        try {  
	          ...
	          Ye161010Srh_2023_VO  ye161010SrhVo = new Ye161010Srh_2023_VO(); 
	          List<InfcPkgYe161010_2023_VO> listPkgYe161010VO = new ArrayList<InfcPkgYe161010_2023_VO>();
	          List<Ye161010_2023_VO> listYe161010VO = new ArrayList<Ye161010_2023_VO>();
	          ...
	          listYe161010VO = (List<Ye161010_2023_VO>)ye161010DAO.selectYeta8300ToYe161010AllList(ye161010SrhVo);
              ...
              for (int iCnt = 0;iCnt < listYe161010VO.size();iCnt++) { 
  		    	...
  		    	String nResult = AnyCryptUtils.XecureCryptInitialize(RemoteServiceUtil.getThreadLocalConfig(),RemoteServiceUtil.getThreadLocalRequest());
	            	...
	            	Ye161010_2023_VO  ye161010Vo = new Ye161010_2023_VO();  
	            	 ...
	            	 ye161010Vo = (Ye161010_2023_VO) listYe161010VO.get(iCnt); 
                  ...
                  Yeta8300ListenerAdapter yetaLsAdtr = new Yeta8300ListenerAdapter();
                  retval = yetaLsAdtr.fnYeta8300_Ye161010_2023_CalcTax(RemoteServiceUtil.getThreadLocalRequest(),listPkgYe161010VO);
   
	        } 
	        catch (Exception ex) {
	        	 
	            logger.error("EXCEPTION calling fnYeta8300Ye161010_2023_AllCalcTax(): "+ex); 
            
            /** 에러 로그 **/			
            MSFLogHistoryUtils.tracerUserExceptionActivity(sessionUser,method,calledClass,"C",ex, windowNm , windowId);
             
            throw MSFServerUtils.getOperationException("fnYeta8300Ye161010_2023_AllCalcTax", ex, logger);
        }
        finally {
   ...
   //소득공제신고서 재적용
   @Override
   public PagingLoadResult<ShowMessageBM> fnYeta8300Ye161010_2023_SbtVolUse(Ye161010DTO ye161010Dto) throws MSFException {
	   ...
	   String method = calledClass + ".fnYeta8300Ye161010_2023_SbtVolUse";
	   MSFSysm0100BM sessionUser = MSFServerUtils.getLoggedUser(RemoteServiceUtil.getThreadLocalRequest());
	   ...
	   try {  
		   ...
		   Ye161010Srh_2023_VO  ye161010SrhVo = new Ye161010Srh_2023_VO(); 
		   InfcPkgYe161010_2023_VO pkgYe161010VO = new InfcPkgYe161010_2023_VO();
		   ...
		   strReturnPdfCheck = funcPdfInDdc.pdfInDdc_Yeta2023_Insert(pkgYe161010VO, RemoteServiceUtil.getThreadLocalRequest());
   ...
   @Override
	public Ye161020DTO getYeta8300TxDdcYnToYe161020Data(Ye161020DTO ye161020Dto) throws MSFException {


		Ye161020Srh_2023_VO ye161020SrhVo = new Ye161020Srh_2023_VO();
		MSFSysm0100BM sessionUser;

		String method = calledClass + ".getYeta8300TxDdcYnToYe161020Data";
		...
		try {
			...
			egovResultDataList = ye161020DAO.getYeta8300TxDdcYnToYe161020Data(ye161020SrhVo);
	...
	/** 합계 일괄업데이트 **/
	@Override
	public int updateYeta8300All(List<Ye161040DTO> listYe161040Dto)throws MSFException {
		// TODO Auto-generated method stub
		...
		try{
            ...
            for (int iCnt = 0;iCnt < listYe161040Dto.size();iCnt++) { 
            	...
            	infcPkgYe161010Vo = new InfcPkgYe161010_2023_VO(); 
				...
				listYe161010VO.add(infcPkgYe161010Vo);
				 ...
				 yeta8300ListenerAdt.fnYeta8300_Ye161010_2023_CalcUpdate(RemoteServiceUtil.getThreadLocalRequest(), infcPkgYe161010Vo, "YE161090");
				 yeta8300ListenerAdt.fnYeta8300_Ye161010_2023_CalcUpdate(RemoteServiceUtil.getThreadLocalRequest(), infcPkgYe161010Vo, "YE161050");
				 yeta8300ListenerAdt.fnYeta8300_Ye161010_2023_CalcUpdate(RemoteServiceUtil.getThreadLocalRequest(), infcPkgYe161010Vo, "YE165010");
				 yeta8300ListenerAdt.fnYeta8300_Ye161010_2023_CalcUpdate(RemoteServiceUtil.getThreadLocalRequest(), infcPkgYe161010Vo, "YE162010");
				 yeta8300ListenerAdt.fnYeta8300_Ye161010_2023_CalcUpdate(RemoteServiceUtil.getThreadLocalRequest(), infcPkgYe161010Vo, "YE162510");
				 yeta8300ListenerAdt.fnYeta8300_Ye161010_2023_CalcUpdate(RemoteServiceUtil.getThreadLocalRequest(), infcPkgYe161010Vo, "YE166020_INSERT");
				 yeta8300ListenerAdt.fnYeta8300_Ye161010_2023_CalcUpdate(RemoteServiceUtil.getThreadLocalRequest(), infcPkgYe161010Vo, "YE166020_DELETE");
