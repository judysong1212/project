...
import com.app.exterms.yearendtax.client.dto.yeta2016.InfcPsnl0100BM;
...
//    private PayrConstants PayrLabel = PayrConstants.INSTANCE;
	...
	public InfcPsnl0100Def(String chkPayrDef) {
		...
		if ("YETAP110001".equals(chkPayrDef)) {
			// setTitle(PayrLabel.titlePayr0304());
			setDaoClass("");
			...
			setColumnsDefinition(getYetaP110001ToPsnl0100ColumnsList());
	...
	private List<ColumnDef> getYetaP110001ToPsnl0100ColumnsList(){
	    row = 0;
