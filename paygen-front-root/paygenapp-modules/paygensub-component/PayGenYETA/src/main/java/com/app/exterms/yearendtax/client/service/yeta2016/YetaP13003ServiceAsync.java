...
public interface YetaP13003ServiceAsync {
	
	/** 기부금내역 등록 팝업 수정 및 삭제 **/
	public void activityOnYetaP13003ToYeta3180(List<Ye16Ta3180DTO> listYeta3180dto, ActionDatabase actionDatabase, AsyncCallback<Long> callback) ;
