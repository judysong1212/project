...
import com.app.exterms.yearendtax.client.service.yeta2022.YetaT73009Service;
import com.app.exterms.yearendtax.client.service.yeta2022.YetaT73009ServiceAsync;
...
//import com.app.exterms.yearendtax.client.form.defs.yeta2016.YetaT73009Def;
...
=====================================================**/
public  class YetaT73009   extends MSFFormPanel {  
 ...
 **/
	...
	private  ContentPanel cpYetaT73009; 
	...
	// -------------- grid 선언 시작  ---------------	  
	private MSFGridPanel YetaT73009GridPanel;
//	private YetaT73009Def YetaT73009Def = new YetaT73009Def("YetaT73009");   //TODO 일단 화면번호로 Def
	// -------------- grid 선언 종료  ---------------
	...
	// -------------- 서비스 호출 시작 --------------
	private YetaT73009ServiceAsync yetaT73009Service = YetaT73009Service.Util.getInstance();
	// -------------- 서비스 호출 종료 --------------	 
...
//					ye162510Dto.setMnthRnttyHusCnttArea((MSFSharedUtils.allowNulls(bmMapModel.get("mnthRnttyHusCnttArea"))));    		/** column 월세주택계약면적 : mnthRnttyHusCnttArea */
				...
				yetaT73009Service.activityOnYetaT73009(listYe162510Dto, actionDatabase, new AsyncCallback<Long>(){
...
//		 }
	...
	public YetaT73009(final ActionDatabase actionDatabase, final MSFPanel caller) {
...
//		initLoad(); 	
		...
		this.actionDatabase = actionDatabase;
	 	...
	 	cpYetaT73009 = new ContentPanel();  

		createSearchForm();			//기본정보 필드를 적용
	 	createMsfGridForm();		//그리드필드
		   
		cpYetaT73009.setBodyBorder(false);
		cpYetaT73009.setBorders(false);
		cpYetaT73009.setHeaderVisible(false);
		cpYetaT73009.setSize("790px", "640px");
		   
		this.add(cpYetaT73009);
...
//		     });     
		...
		cpYetaT73009.setLayout(new FlowLayout());
...
//	      	     }
//				 
//				YetaT73009GridPanel.getMsfGrid().clearData();
//				 
//				BaseModel bmData = YetaT73009GridPanel.getTableDef().getDefaultValues();  
//		              
...
//		         
//		        YetaT73009GridPanel.getMsfGrid().getGrid().stopEditing();      
//		        YetaT73009GridPanel.getMsfGrid().getGrid().getStore().insert(bmData,0);   
//		        YetaT73009GridPanel.getMsfGrid().getGrid().startEditing(YetaT73009GridPanel.getMsfGrid().getGrid().getStore().indexOf(bmData), 0);   
//
...
//			public void handleEvent(ButtonEvent e) {
//				Iterator<BaseModel> itBm = YetaT73009GridPanel.getMsfGrid().getGrid().getSelectionModel().getSelectedItems().listIterator();
...
//			public void handleEvent(ButtonEvent e) {
//				setListRecord(YetaT73009GridPanel.getMsfGrid().getStore().getModifiedRecords().iterator());
//				doAction(actionDatabase);
//
//				if ((ActionDatabase.INSERT).equals(actionDatabase)) {
//					actionDatabase = ActionDatabase.INSERT;
...
//				
//		cpYetaT73009.add(topYetaBtnBar);
...
//		YetaT73009GridPanel = new MSFGridPanel(YetaT73009Def, false, false, false, false, false);
//		YetaT73009GridPanel.setSize("790px", "420px");
//		YetaT73009GridPanel.setBorders(true);
//		YetaT73009GridPanel.setHeaderVisible(false);
...
//		
//		YetaT73009GridPanel.getGrid().getColumnModel().addAggregationRow(payrSummaryRow);  
//		
...
//		
//		YetaT73009GridPanel.getGrid().getColumnModel().addAggregationRow(payrSummaryRow1);
//		/** --- 그리드 합계 부분  종료 --- **/
		
//        cpYetaT73009.add(YetaT73009GridPanel);
		...
		cpYetaT73009.add(layoutContainer);
		cpYetaT73009.add(layoutContainer20);
		cpYetaT73009.add(layoutContainer21);
		cpYetaT73009.add(layoutContainer22);
	...
	public void reload() {
			...
			YetaT73009GridPanel.getTableDef().setTableColumnFilters(filters);
			YetaT73009GridPanel.getTableDef().addColumnFilter("yrtxBlggYr", MSFSharedUtils.allowNulls(srhYrtxBlggYr.getValue())
...
//					, SimpleColumnFilter.OPERATOR_EQUALS);//연말정산귀속년도
			YetaT73009GridPanel.getTableDef().addColumnFilter("clutSeptCd", MSFSharedUtils.getSelectedComboValue(srhClutSeptCd,"commCd")
					, SimpleColumnFilter.OPERATOR_EQUALS);//정산구분
			YetaT73009GridPanel.getTableDef().addColumnFilter("systemkey", MSFSharedUtils.allowNulls(systemkey.getValue())
					, SimpleColumnFilter.OPERATOR_EQUALS);//시스템키
		 
			YetaT73009GridPanel.reload();
