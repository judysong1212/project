...
@RemoteServiceRelativePath("YetaP23007Service.gwt")
public interface YetaP23007Service extends RemoteService {
	/**
	 * Utility class for simplifying access to the instance of async service.
	 */
	public static class Util {
		private static YetaP23007ServiceAsync instance;
		public static YetaP23007ServiceAsync getInstance(){
			if (instance == null) {
				instance = GWT.create(YetaP23007Service.class);
			}
			return instance;
		}
	}
