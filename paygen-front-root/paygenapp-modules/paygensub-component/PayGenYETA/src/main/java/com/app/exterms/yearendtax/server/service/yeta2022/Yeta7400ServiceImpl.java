...
@Service("Yeta7400Service")
public class Yeta7400ServiceImpl  extends AbstractCustomServiceImpl implements Yeta7400Service  ,YetaDaoConstants {
 
	  private static final Logger logger = LoggerFactory.getLogger(Yeta7400ServiceImpl.class);
	  private static final String calledClass = Yeta7400ServiceImpl.class.getName();
	...
	@Autowired
	@Resource(name = "Ye161005_2022_DAO")
	private Ye161005_2022_DAO ye16Ta161005DAO;
	...
	public Ye161005BM getYeta7400List(Ye161005DTO ye161005Dto) throws MSFException {
		...
		if (MSFSharedUtils.paramNull(ye161005DAO)) {
			...
			ye161005DAO = (Ye161005_2022_DAO) wac.getBean("Ye161005_2022_DAO");
		}
...
//	   	ye161005SrhVo.setSystemkey(MSFSharedUtils.allowNulls(MSFServerUtils.getFilterValue(columnFilters, "systemkey")));  //시스템키
     ...
     //	 List<String> listTyInttnCd = new ArrayList<String>(); 
		...
		try {
			...
			egovResultDataList =  ye161005DAO.selectYeta7400ToYe161005List(ye161005SrhVo);
	...
	public Long updateYe161005(Ye161005DTO ye161005Dto) throws MSFException {
		...
		Long result = new Long(0);
			...
			if (MSFSharedUtils.paramNull(ye16Ta161005DAO)) {
				WebApplicationContext wac = WebApplicationContextUtils.getRequiredWebApplicationContext(getHttpServletRequest()
						.getSession().getServletContext());
				ye16Ta161005DAO = (Ye161005_2022_DAO) wac.getBean("Ye161005_2022_DAO");
			}
...
//			ye16Ta161005Vo.setRevnDt(ye161005Dto.getRevnDt());    /** column 수정일자 : revnDt */
			...
			ye16Ta161005Vo.setYetaC172(ye161005Dto.getYetaC172());                                                         //C172_종사업장일련번호
		  	...
		  	try{
		  		ye16Ta161005DAO.updateYeta7400ToYe161005(ye16Ta161005Vo); 
		  		result = new Long(1);
	...
	//연말정산신고내역 조회
	public PagingLoadResult<BaseModel> getYeta74000List(ServiceParameters serviceParameters) throws MSFException {
		
		PagingLoadResult<BaseModel> retval = null;
		String method =  CLASS_YETA7400LIST;
	     ...
	     //	 List<String> listTyInttnCd = new ArrayList<String>(); 
			...
			if ( pagingValues.executeRecordCount ) { 
	        	...
	        	TimingInfo millisBeginQueryCount = SmrmfUtils.startTiming(logger);
	          	...
	          	int iResultCnt = ye161010DAO.selectYeta7400GirdListTotCnt(ye161010SrhVo);  
...
//	            Collection<Map<String, Object>> list ??????
	     	List list = ye161010DAO.selectYeta7400GirdList(ye161010SrhVo);
		  	...
		  	try{
				...
				if(egovResultDataList != null && egovResultDataList.size() > 0){
					...
					for(int i = 0 ; i < egovResultDataList.size(); i++){
						...
						ye161010DAO.finishYeta7400Update(ye161010Vo);
        		  		result = new Long(1);
