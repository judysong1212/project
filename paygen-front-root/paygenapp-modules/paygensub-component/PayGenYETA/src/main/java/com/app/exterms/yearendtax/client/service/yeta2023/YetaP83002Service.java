...
@RemoteServiceRelativePath("YetaP83002Service.gwt")
public interface YetaP83002Service extends RemoteService {
	/**
	 * Utility class for simplifying access to the instance of async service.
	 */
	public static class Util {
		private static YetaP83002ServiceAsync instance;
		public static YetaP83002ServiceAsync getInstance(){
			if (instance == null) {
				instance = GWT.create(YetaP83002Service.class);
			}
			return instance;
		}
	}
