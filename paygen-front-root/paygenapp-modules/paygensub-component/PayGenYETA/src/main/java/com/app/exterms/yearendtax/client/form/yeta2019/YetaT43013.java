...
import com.app.exterms.yearendtax.client.form.defs.yeta2019.Ye162010Def;
import com.app.exterms.yearendtax.client.service.yeta2019.YetaT43013Service;
import com.app.exterms.yearendtax.client.service.yeta2019.YetaT43013ServiceAsync;
...
=====================================================**/
public  class YetaT43013   extends MSFFormPanel {  
 ...
 **/
	...
	private  ContentPanel cpYetaT43013; 
	...
	// -------------- grid 선언 시작  ---------------	  
	private MSFGridPanel YetaT43013GridPanel;
	private Ye162010Def ye162010Def = new Ye162010Def("YetaT43013");   
	// -------------- grid 선언 종료  ---------------
	...
	// -------------- 서비스 호출 시작 --------------
	private YetaT43013ServiceAsync yetaT43013Service = YetaT43013Service.Util.getInstance();
	// -------------- 서비스 호출 종료 --------------	 
...
//					ye162510Dto.setMnthRnttyHusCnttArea((MSFSharedUtils.allowNulls(bmMapModel.get("mnthRnttyHusCnttArea"))));    		/** column 월세주택계약면적 : mnthRnttyHusCnttArea */
				...
				yetaT43013Service.activityOnYetaT43013(listYe162510Dto, actionDatabase, new AsyncCallback<Long>(){
...
//		 }
	...
	public YetaT43013(final ActionDatabase actionDatabase, final MSFPanel caller) {
...
//		initLoad(); 	
		...
		this.actionDatabase = actionDatabase;
	 	...
	 	cpYetaT43013 = new ContentPanel();  

		createSearchForm();			//기본정보 필드를 적용
	 	createMsfGridForm();		//그리드필드
		   
	 	cpYetaT43013.setBodyBorder(false);
	 	cpYetaT43013.setBorders(false);
	 	cpYetaT43013.setHeaderVisible(false);
	 	cpYetaT43013.setSize("790px", "640px");
		   
		this.add(cpYetaT43013);
...
//		     });     
		...
		cpYetaT43013.setLayout(new FlowLayout());
...
//	      	     }
//				 
//				YetaT43013GridPanel.getMsfGrid().clearData();
//				 
//				BaseModel bmData = YetaT43013GridPanel.getTableDef().getDefaultValues();  
//		              
...
//		         
//		        YetaT43013GridPanel.getMsfGrid().getGrid().stopEditing();      
//		        YetaT43013GridPanel.getMsfGrid().getGrid().getStore().insert(bmData,0);   
//		        YetaT43013GridPanel.getMsfGrid().getGrid().startEditing(YetaT43013GridPanel.getMsfGrid().getGrid().getStore().indexOf(bmData), 0);   
//
...
//			public void handleEvent(ButtonEvent e) {
//				Iterator<BaseModel> itBm = YetaT43013GridPanel.getMsfGrid().getGrid().getSelectionModel().getSelectedItems().listIterator();
...
//			public void handleEvent(ButtonEvent e) {
//				setListRecord(YetaT43013GridPanel.getMsfGrid().getStore().getModifiedRecords().iterator());
//				doAction(actionDatabase);
//
//				if ((ActionDatabase.INSERT).equals(actionDatabase)) {
//					actionDatabase = ActionDatabase.INSERT;
...
//		cpYetaT43013.add(topYetaBtnBar);
...
//		cpYetaT43013.add(topYetaBtnBar);
		...
		YetaT43013GridPanel = new MSFGridPanel(ye162010Def, false, false, false, false, false);
		YetaT43013GridPanel.setSize("790px", "200px");
		YetaT43013GridPanel.setBorders(true);
		YetaT43013GridPanel.setHeaderVisible(false);
...
//		
//		YetaT43013GridPanel.getGrid().getColumnModel().addAggregationRow(payrSummaryRow);  
//		
...
//		
//		YetaT43013GridPanel.getGrid().getColumnModel().addAggregationRow(payrSummaryRow1);
//		/** --- 그리드 합계 부분  종료 --- **/
		
//        cpYetaT43013.add(YetaT43013GridPanel);
		...
		fldstNewFieldset.add(YetaT43013GridPanel);
		cpYetaT43013.add(fldstNewFieldset);
		cpYetaT43013.add(layoutContainer10);
		cpYetaT43013.add(fldstNewFieldset_1);
	...
	public void reload() {
			...
			YetaT43013GridPanel.getTableDef().setTableColumnFilters(filters);
			YetaT43013GridPanel.getTableDef().addColumnFilter("yrtxBlggYr", MSFSharedUtils.allowNulls(srhYrtxBlggYr.getValue())
...
//					, SimpleColumnFilter.OPERATOR_EQUALS);//연말정산귀속년도
			YetaT43013GridPanel.getTableDef().addColumnFilter("clutSeptCd", MSFSharedUtils.getSelectedComboValue(srhClutSeptCd,"commCd")
					, SimpleColumnFilter.OPERATOR_EQUALS);//정산구분
			YetaT43013GridPanel.getTableDef().addColumnFilter("systemkey", MSFSharedUtils.allowNulls(systemkey.getValue())
					, SimpleColumnFilter.OPERATOR_EQUALS);//시스템키
		 
			YetaT43013GridPanel.reload();
