...
public class Ye162510Def extends TableDef implements YetaDaoConstants{
	...
	public Ye162510Def(String chkDef) {
		...
		} else if ("YetaP63005".equals(chkDef)) {

			setTitle("");
			setDaoClass("");
			setCustomListMethod(CLASS_YETAP63005_TO_YE162510_DATA_LIST);
			setAutoFillGrid(false);
			setShowFilterToolbar(false);
			setCheckBoxOnGridRows(true);
			setEditFieldGrid(true);
			setColumnsDefinition(getYetaP63005ToYe16251ColumnsList());
	...
	private List<ColumnDef> getYetaP63005ToYe16251ColumnsList() {
