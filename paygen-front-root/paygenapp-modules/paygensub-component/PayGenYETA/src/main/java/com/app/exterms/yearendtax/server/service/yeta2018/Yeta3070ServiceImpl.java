...
import com.app.exterms.yearendtax.server.service.yeta2018.dao.Yeta3070_2018_DAO;
...
@Service("Yeta3070Service")
public class Yeta3070ServiceImpl extends AbstractCustomServiceImpl implements YetaDaoConstantsGenerated, Yeta3070Service {

	private static final Logger logger = LoggerFactory.getLogger(Yeta3070ServiceImpl.class);
	private static final String calledClass = Yeta3070ServiceImpl.class.getName();

	@Autowired
	@Resource(name = "Yeta3070_2018_DAO")
	private Yeta3070_2018_DAO yeta3070DAO;
	...
	public PagingLoadResult<BaseModel> getSelectYeta3070ToBass0120List(ServiceParameters serviceParameters) throws MSFException {
        ...
        String method =  CLASS_YETA3070TOBASS0120_LIST;
        Yeta2070Srh_2018_VO   Yeta2070SrhVO = new Yeta2070Srh_2018_VO();
        //Yeta2070VO      Yeta2070Vo = new Yeta2070VO();
        List<BaseModel>  bmResult = new ArrayList<BaseModel>();
        MSFSysm0100BM sessionUser = MSFServerUtils.getLoggedUser(RemoteServiceUtil.getThreadLocalRequest());
        
        if(MSFSharedUtils.paramNull(yeta3070DAO)){
        	WebApplicationContext wac = WebApplicationContextUtils.getRequiredWebApplicationContext(getHttpServletRequest().getSession().getServletContext());
        	yeta3070DAO = (Yeta3070_2018_DAO) wac.getBean("Yeta3070_2018_DAO");
        }
        try{
            ...
            if(pagingValues.executeRecordCount){ 
            	...
            	int iResultCnt = yeta3070DAO.selectYeta3070ListTotCnt(Yeta2070SrhVO);
            ...
            List list = yeta3070DAO.selectYeta3070List(Yeta2070SrhVO);
            ...
            SmrmfUtils.endTiming(logger, millisBeginSelectYeta2070List, "selectYeta3070List");
