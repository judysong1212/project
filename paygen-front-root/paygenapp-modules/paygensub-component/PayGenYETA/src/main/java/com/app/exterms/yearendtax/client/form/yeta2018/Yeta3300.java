...
import com.app.exterms.yearendtax.client.dto.yeta2018.Ye161030BM;
import com.app.exterms.yearendtax.client.dto.yeta2018.Ye161030DTO;
import com.app.exterms.yearendtax.client.dto.yeta2018.Ye161040BM;
import com.app.exterms.yearendtax.client.dto.yeta2018.Ye161040DTO;
import com.app.exterms.yearendtax.client.dto.yeta2018.Ye161055DTO;
import com.app.exterms.yearendtax.client.dto.yeta2018.Ye161060DTO;
import com.app.exterms.yearendtax.client.dto.yeta2018.Ye161070DTO;
import com.app.exterms.yearendtax.client.dto.yeta2018.Ye161080DTO;
import com.app.exterms.yearendtax.client.form.defs.yeta2015.Yeta2000Def;
import com.app.exterms.yearendtax.client.form.defs.yeta2018.Ye161010Def;
import com.app.exterms.yearendtax.client.form.defs.yeta2018.Ye161030Def;
import com.app.exterms.yearendtax.client.form.defs.yeta2018.Ye161040Def;
import com.app.exterms.yearendtax.client.form.defs.yeta2018.Ye161090Def;
import com.app.exterms.yearendtax.client.form.defs.yeta2018.Ye169010Def;
import com.app.exterms.yearendtax.client.service.yeta2018.Yeta3300Service;
import com.app.exterms.yearendtax.client.service.yeta2018.Yeta3300ServiceAsync;
 ...
 */
public class Yeta3300 extends MSFPanel {

	private VerticalPanel vp;
	private FormPanel plFrmYeta3300;
	...
	// -------------- 탭 시작 --------------
	private TabPanel tabsYeta3300 = new TabPanel();		// 전체
	private TabPanel tabsItemYeta05 = new TabPanel();	// 특별소득공제 하위
	private TabPanel tabsItemYeta08 = new TabPanel();	// 세액감면및세액공제1 하위
	// -------------- 탭 종료 --------------

	// -------------- 상단 버튼 시작 --------------
	private ButtonBar topYeta3300Bar;
	private Button btnYeta3300All; 	// 일괄자료정리
	private Button btnYeta3300Reset; 	// 초기화
	private Button btnYeta3300New; 		// 신규
	private Button btnYeta3300Save; 	// 저장
	private Button btnYeta3300Del; 		// 삭제
	private Button btnYeta3300Sreach; 	// 조회
	private Button btnYeta3300Print; 	// 인쇄
	
	private RadioGroup printType;		// 대상자 선택
	// -------------- 상단 버튼 종료 --------------

	// -------------- 중간 버튼 시작 --------------
	private Button btnYeta3300_01;			// 의료비지급명세서
	private Button btnYeta3300_02; 			// 기부금명세서
	private Button btnYeta3300_03; 			// 재계산대상자
	private Button btnYeta3300_04; 			// 삭제
	private Button btnYeta3300_05; 			// 세액계산
	private Button btnYeta3300_06; 			// 세액재계산
	private Button btnYeta3300_07; 			// 원천징수인쇄
...
//	private Yeta2000BM yeta2000Bm;
	...
	// -------------- grid 선언 시작  ---------------
	private Ye161010Def ye161010Def  		= new Ye161010Def("Yeta3300"); 		// 대상자 정보 그리드 테이블 컬럼 define
	private Yeta2000Def Ye161010Def_02  	= new Yeta2000Def("YETA300001"); 	// 대상자 정보 그리드 새로고침을 위한 define
	private Ye169010Def ye169010Def  		= new Ye169010Def("Yeta3300");		// 세액계산 정보 그리드 테이블 컬럼 define 
	private Ye161030Def ye161030Def  		= new Ye161030Def("Yeta3300");		// 인적공제 정보 그리드 테이블 컬럼 define
	
	private Ye161040Def ye161040Def_01  	= new Ye161040Def("Yeta330001"); 	// 소득공제명세 그리드 테이블 컬럼 define(국세청자료)  
	private Ye161040Def ye161040Def_02  	= new Ye161040Def("Yeta330002"); 	// 소득공제명세 그리드 테이블 컬럼 define(기타자료)
	private Ye161090Def ye161090Def  		= new Ye161090Def("Yeta3300");
	
	
	private MSFGridPanel Yeta3300ToYe169010GridPanel;
	private MSFGridPanel Yeta3300ToYe161010GridPanel;		// 대상자정보 GridPanel
	private MSFGridPanel Yeta3300ToYe161030GridPanel;		// 인적공제 GridPanel
	private MSFGridPanel Yeta3300ToYe161040GridPanel_01;	// 소득공제 - 국세청 GridPanel
	private MSFGridPanel Yeta3300ToYe161040GridPanel_02;	// 소득공제 - 기타자료 GridPanel
//	private MSFGridPanel Yeta3300ToYe161090GridPanel;		// 가족교육비 GridPanel
	// -------------- grid 선언 종료  ---------------
...
//    private MSFNumberField hsngSvngDdcAmt2015;			// 기타공제_주택마련저축_주택청약종합저축 공제액2015년 이후
    ...
    private MSFNumberField cpiv16AsctUseAmt;   			// 출자투자금액_조합등_2016납입금
    private MSFNumberField cpiv16AsctDdcAmt;   			// 출자투자금액 조합등_2016공제액
    
    private MSFNumberField cpiv16VntUseAmt;   			// 출자투자금액벤처등_2016납입금액
    private MSFNumberField cpiv16VntDdcAmt;   			// 출자투자금액벤처등_2016공제액
    
    private MSFNumberField cpiv17AsctUseAmt;   			// 출자투자금액_조합등_2018납입금
    private MSFNumberField cpiv17AsctDdcAmt;   			// 출자투자금액 조합등_2018공제액
    
    private MSFNumberField cpiv17VntUseAmt;   			// 출자투자금액벤처등_2018납입금액
    private MSFNumberField cpiv17VntDdcAmt;   			// 출자투자금액벤처등_2018공제액 
    
    private MSFNumberField cpiv18AsctUseAmt;   			// 출자투자금액_조합등_2019납입금
    private MSFNumberField cpiv18AsctDdcAmt;   			// 출자투자금액 조합등_2019공제액
    
    private MSFNumberField cpiv18VntUseAmt;   			// 출자투자금액벤처등_2019납입금액
    private MSFNumberField cpiv18VntDdcAmt;   			// 출자투자금액벤처등_2019공제액
...
//	private ListStore<BaseModel> lsCrClutMnth = new ListStore<BaseModel>(); 			//급여월
	...
	// -------------- 서비스 호출 시작 -------------- 
	private Yeta3300ServiceAsync yeta3300Service = Yeta3300Service.Util.getInstance();
	// -------------- 서비스 호출 종료 --------------
	 ...
	 */
	 private void checkYeta3300Auth( String authAction, ListStore<BaseModel>bm) {
	 ...
	 private void authExecEnabled() { 
	   //------------------
		 ...
		 srhYrtxBlggYr.setValue(lsClutYrStore.findModel("year","2018"));
	 ...
	 **/
	  ...
	  * </pre>
	  * @Method Name : fnYeta3300Payr06430CalcTax
	  * @date : Jan 26, 2016
	  * @author : leeheuisung
	  * @history : 
	  *	-----------------------------------------------------------------------
	  ...
	  *
	  */
	private void fnYeta3300Payr06430CalcTax() {
		...
		MessageBox.confirm("세액계산", "선택된 연말정산계산  대상자에 대해서 세액계산을 합니다. <br> 세액재계산을 하시겠습니까?",new Listener<MessageBoxEvent>(){
			...
			public void handleEvent(MessageBoxEvent be) {
				if (Dialog.YES.equals(be.getButtonClicked().getItemId())) {
					...
					Iterator<BaseModel> itBm = Yeta3300ToYe161010GridPanel.getMsfGrid().getGrid().getSelectionModel().getSelectedItems().listIterator();
					...
					if (MSFSharedUtils.paramNotNull(records)) {
			            ...
			            final Timer t = new Timer() {
			              ...
			              t.scheduleRepeating(500);
   	           	 		...
   	           	 		yeta3300Service.fnYeta3300_Ye161010_2018_CalcTax(listYe161010Dto,   new AsyncCallback<PagingLoadResult<ShowMessageBM>>() {
...
//   	           	                MSFMainApp.ADMINMESSAGES.ExceptionMessageService("activityOnInsertRemt0100(insert) : " + caught), null);
   	           	 			...
   	           	 			public void onSuccess(PagingLoadResult<ShowMessageBM> result) {  
   	           	 				...
   	           	 				//계산 결과에 따른 조회 호출 
   	           	 				BaseModel bmData = Yeta3300ToYe161010GridPanel.getCurrentlySelectedItem();  
   	           	 				...
   	           	 				Yeta3300ToYe161010Detail(bmData, "itemYeta01");
	...
	private void fnYeta3300Payr06430AllCalcTax() {
		...
		MessageBox.confirm("전체세액계산","선택된 연말정산계산  대상자에 대해서 전체세액계산을 합니다. <br> 세액재계산을 하시겠습니까?", new Listener<MessageBoxEvent>() {
			...
			public void handleEvent(MessageBoxEvent be) {
				if (Dialog.YES.equals(be.getButtonClicked().getItemId())) {
					...
					yeta3300Service.fnYeta3300Ye161010_2018_AllCalcTax(ye161010Dto ,new AsyncCallback<PagingLoadResult<ShowMessageBM>>() {
						public void onFailure(Throwable caught) {
...
//							reFresh();
	 ...
	 * ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
	 **/
		private void Yeta3300Print(String fileName, String repType) {
...
//			serarchParam += "[" + MSFSharedUtils.allowNulls(srhSystemkey.getValue())+"]";				//$12 시스템키 
			...
			List<BaseModel> list = Yeta3300ToYe161010GridPanel.getGrid().getSelectionModel().getSelectedItems();
...
//	      	}
	...
	public ContentPanel getViewPanel() {
		if (panel == null) {
			...
			createYeta3300Form(); 	// 화면 기본정보를 설정
			createSearchForm(); 	// 검색필드를 적용
			createContentForm(); 	// 내용 필드
			vp.setSize("1010px", "1600px");

			// 폼데이터를 바인딩
			// formBinding = new FormBinding(this.plFrmYeta3300, true);
	...
	public Yeta3300(String txtForm) {
...
//		Button btnNewButton_11 = new Button("기부금합계일괄업데이트");
//		btnNewButton_11.setIcon(MSFMainApp.ICONS.save16());
...
//				}	
//				
//				yeta3300Service.updateYeta3300All(listYe161040Dto, new AsyncCallback<Integer>() {
//
//					public void onFailure(Throwable caught) {
//						MessageBox.alert( MSFMainApp.MSFCONSTANTS.ExceptionTitleService()
//											, MSFMainApp.ADMINMESSAGES.ExceptionMessageService("activityOnYeta3300ToYe161030("+ actionDatabase.name()+ ") : " + caught)
//											, null);
//						}
//
//						@Override
...
//		btnBar.add(btnNewButton_4);
		...
		Button btnYeta3300_05 = new Button("세액계산");
		btnYeta3300_05.setIcon(MSFMainApp.ICONS.save16());
		btnBar.add(btnYeta3300_05);
		btnYeta3300_05.addListener(Events.Select, new Listener<ButtonEvent>() {
    		public void handleEvent(ButtonEvent e) {
    		 
    	        fnYeta3300Payr06430CalcTax();
    		}
    	});
		...
		plFrmYeta3300.add(conLayoutContainer);

	}

	private void createYeta3300Form() {

		plFrmYeta3300 = new FormPanel();
		plFrmYeta3300.setHeadingText(PayGenConst.PAYGEN_VERSION.concat(" - 소득공제신고자료관리"));
		plFrmYeta3300.setIcon(MSFMainApp.ICONS.text());
		plFrmYeta3300.setBodyStyleName("pad-text");
		plFrmYeta3300.setFrame(true);
		plFrmYeta3300.setPadding(2);
//		plFrmYeta3300.setSize("990px", "780px");
		plFrmYeta3300.setSize("990px", "830px");
		...
		btnlogView.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				 //로그 뷰화면 호출 메서드 
				  funcLogMessage("소득공제신고자료관리","Yeta3300");
				}
			});
		plFrmYeta3300.getHeader().setStyleAttribute("padding", "5px 0 2px 0");
		plFrmYeta3300.getHeader().addTool(btnlogView); 
		/************************************************************************
		 * 화면 에러 처리시 필요한 부분으로 추가 
		 ************************************************************************/

		//멀티콤보박스 닫기 
		plFrmYeta3300.addListener(Events.OnClick,new Listener<ComponentEvent>() { 
			@Override
		...
		topYeta3300Bar = new ButtonBar();
		topYeta3300Bar.setAlignment(HorizontalAlignment.RIGHT);
		
		if ("admin".equals(MSFMainApp.get().getUser().getUsrId()) || "D0010090".equals(MSFMainApp.get().getUser().getUsrDivCd())) {	
			btnYeta3300All = new Button("일괄자료정리");
			btnYeta3300All.setIcon(MSFMainApp.ICONS.new16());
			topYeta3300Bar.add(btnYeta3300All);
			btnYeta3300All.addListener(Events.Select, new Listener<ButtonEvent>() {
				public void handleEvent(ButtonEvent e) {
...
//	                    ye161030Dto.setFamyRelaDivCd(MSFSharedUtils.allowNulls(bmMapModel.get("famyRelaDivCd")));    	/** column 인사가족관계코드 : famyRelaDivCd */
		...
		btnYeta3300Reset = new Button("초기화");
		btnYeta3300Reset.setIcon(MSFMainApp.ICONS.new16());
		btnYeta3300Reset.addListener(Events.Select, new Listener<ButtonEvent>() {
			@Override
			public void handleEvent(ButtonEvent be) {
				// TODO Auto-generated method stub
				...
				tabsYeta3300.setSelection(tabsYeta3300.getItem(0));//탭부분 초기화
			}
		});
		topYeta3300Bar.add(btnYeta3300Reset);

		btnYeta3300Save = new Button("저장");
		btnYeta3300Save.setIcon(MSFMainApp.ICONS.save16());
		topYeta3300Bar.add(btnYeta3300Save);
		btnYeta3300Save.addListener(Events.Select, new Listener<ButtonEvent>() {
			@Override
			public void handleEvent(ButtonEvent be) {
				// TODO Auto-generated method stub
				
//				if (yrtxBlggYr.getValue().compareTo("2015") != 0) {
//					MessageBox.alert(MSFMainApp.MSFCONSTANTS.Alert(),"2015년연말정산 이전자료는 조회만 가능합니다.", null);
//					return;
//
//				}
//				    
//				if (clutSeptCd.getValue().compareTo("Y0020010") != 0) {
//					MessageBox.alert(MSFMainApp.MSFCONSTANTS.Alert(),"2015년 귀속분 연말정산만 가능합니다.", null);
...
//				}
				...
				//  {-- 기본사항 --}
				if("itemYeta01".equals(tabsYeta3300.getSelectedItem().getId())) {
					
					itemYeta01Save();	// 기본사항 저장
					
				//  {-- 인적공제 --}	
				}else if("itemYeta02".equals(tabsYeta3300.getSelectedItem().getId())) {
					
					itemYeta02Save();	// 인적공제 저장
					
				//	{-- 소득공제 --}	
				}else if("itemYeta03".equals(tabsYeta3300.getSelectedItem().getId())) {
					
					itemYeta03Save();	// 소득공제 저장
					
				// {-- 연금보험료공제--}	
				} else if ("itemYeta04".equals(tabsYeta3300.getSelectedItem().getId())) {
				
					itemYeta04Save();	// 국민연금보험료외의 연금보험료 저장
					
				// {-- 특별소득공제 --}
				} else if ("itemYeta05".equals(tabsYeta3300.getSelectedItem().getId())) {
				...
				// {-- 그밖의 소득공제--}	
				}else if("itemYeta06".equals(tabsYeta3300.getSelectedItem().getId())) {
					
					itemYeta06Save();	// 그밖의소득공제1 저장
					
				}else if("itemYeta07".equals(tabsYeta3300.getSelectedItem().getId())) {
					
					itemYeta07Save();	// 그밖의소득공제2 저장
					
				//{-- 세액감면및세액공제--}	
				}else if("itemYeta08".equals(tabsYeta3300.getSelectedItem().getId())) {
				...
				} else if ("itemYeta09".equals(tabsYeta3300.getSelectedItem().getId())) {

					// 세액감면및세액공제2 저장
					itemYeta09Save();
					
				// {-- 추가제출서류 --}
				} else if ("itemYeta10".equals(tabsYeta3300.getSelectedItem().getId())) {
...
//		btnYeta3300Del = new Button("삭제");
//		btnYeta3300Del.setIcon(MSFMainApp.ICONS.delete16());
//		topYeta3300Bar.add(btnYeta3300Del);
...
//		printType.add(radio3);
		...
		topYeta3300Bar.add(printType);

		btnYeta3300Sreach = new Button("조회");
		btnYeta3300Sreach.setIcon(MSFMainApp.ICONS.search16());
		btnYeta3300Sreach.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				//탭 선택 없애기
				tabsYeta3300.setSelection(tabsYeta3300.getItem(0));
				//대상자 정보 조회
				reload();
			}
		});
		topYeta3300Bar.add(btnYeta3300Sreach);

//		btnYeta3300Print = new Button("인쇄");
//		btnYeta3300Print.setIcon(MSFMainApp.ICONS.print16());
//		topYeta3300Bar.add(btnYeta3300Print);

		plFrmYeta3300.add(topYeta3300Bar);

		// 파일업로드 처리
		plFrmYeta3300.setAction("myurl");
		plFrmYeta3300.setEncoding(Encoding.MULTIPART);
		plFrmYeta3300.setMethod(Method.POST);

		vp.add(plFrmYeta3300);
		
		// plFrmYeta3300.setSize("990px", "730px");
	...
	private LayoutContainer createListGrid() {
	    ...
	    Yeta3300ToYe161010GridPanel = new MSFGridPanel(ye161010Def, false, false, false, false, false);
	    Yeta3300ToYe161010GridPanel.setHeaderVisible(false);  
	    Yeta3300ToYe161010GridPanel.setBodyBorder(true);
	    Yeta3300ToYe161010GridPanel.setBorders(true);
	    final Grid yeta300ToYeta2000Grid = Yeta3300ToYe161010GridPanel.getMsfGrid().getGrid();
...
//        	   funcSetPopUpRecord();
	    ...
	    cpGrid.add(Yeta3300ToYe161010GridPanel); 
...
//		plFrmYeta3300.add(deptNm);
		...
		plFrmYeta3300.setLayout(new FlowLayout());
			...
			public void handleEvent(StoreEvent<BaseModel> be) {  
				...
				if (type == Store.Add) { 
		             ...
		             * "srhPayrMangDeptCd","srhEmymtDivCd","srhDeptCd","srhTypOccuCd","srhBusinCd"
						++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++*/ 
						checkYeta3300Auth("srhPayrMangDeptCd", lsPayrMangDeptCd); 
				}
			}
		});
	        ...
	        public void handleEvent(StoreEvent<BaseModel> be) {  
	        	  EventType type = be.getType();
		    	   if (type == Store.Add) { 
	           		  ...
	           		  * "srhPayrMangDeptCd","srhEmymtDivCd","srhDeptCd","srhTypOccuCd","srhBusinCd"
		         		++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++*/ 
		                	checkYeta3300Auth("srhEmymtDivCd", lsEmymtDivCd); 
		    	   }
	        }
	    });    
	    ...
	    srhDeptCd.getStore().addStoreListener( new StoreListener<ModelData>() {   
	    	public void handleEvent(StoreEvent<ModelData> be) {  
	    		...
	    		if (type == Store.Add) { 
	    			 ...
	    			 * "srhPayrMangDeptCd","srhEmymtDivCd","srhDeptCd","srhTypOccuCd","srhBusinCd"
						++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++*/ 
	    			checkYeta3300Auth("srhDeptCd", lsDeptCd); 
	    		}
	    	}
	    });    
		...
		srhTypOccuCd.getStore().addStoreListener( new StoreListener<ModelData>() {   
			public void handleEvent(StoreEvent<ModelData> be) {  
				...
				if (type == Store.Add) { 
					 ...
					 * "srhPayrMangDeptCd","srhEmymtDivCd","srhDeptCd","srhTypOccuCd","srhBusinCd"
			    		++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++*/ 
						//checkYeta3300Auth("srhTypOccuCd", lsTypOccuCd); 
				}
			}
		});     
		...
		fileSbtBtn.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				...
				if (systemkey.getValue() == null) {
					...
					YetaP320003 yetaP320003Form = new YetaP320003(ActionDatabase.READ, getThis());
					final MSFFormWindows msFwYeta220003 = new MSFFormWindows("자료추출상세내역",yetaP320003Form, "닫기", "690px", "250px", false);
					msFwYeta220003.show();
					yetaP320003Form.setMSFFormWindows(msFwYeta220003);
					// 팝업이 닫히면 탭을 다시 조회한다.
					msFwYeta220003.addListener(Events.Hide,new Listener<BaseEvent>() { 
			    		@Override
			    		public void handleEvent(BaseEvent be) { 
			    			getItemYeta01();
			    		}
					...
					MessageBox.confirm("소득공제신고서 재적용", "선택된 대상자의 기존 정보를 삭제 후 재적용합니다.<br> 진행 하시겠습니까?",new Listener<MessageBoxEvent>(){
						...
						public void handleEvent(MessageBoxEvent be) {
							if (Dialog.YES.equals(be.getButtonClicked().getItemId())) {
								...
								yeta3300Service.fnYeta3300Ye161010_2018_SbtVolUse(ye161010Dto ,new AsyncCallback<PagingLoadResult<ShowMessageBM>>() {
									public void onFailure(Throwable caught) {
...
//										reFresh();
		...
		fileSbtBtn01.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				...
				if (systemkey.getValue() == null) {
					...
					YetaP320001 yetaP320001Form = new YetaP320001(ActionDatabase.READ, getThis());
					MSFFormWindows msFwYeta220001 = new MSFFormWindows("자료추출상세내역",yetaP320001Form, "닫기", "920px", "710px", false);
					msFwYeta220001.show();
					yetaP320001Form.setMSFFormWindows(msFwYeta220001);
		...
		fileSbtBtn02.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				...
				if (systemkey.getValue() == null) {
					...
					YetaP320002 yetaP320002Form = new YetaP320002(ActionDatabase.READ, getThis());
					final MSFFormWindows msFwYeta220002 = new MSFFormWindows("자료추출상세내역",yetaP320002Form, "닫기", "945px", "710px", false);
					msFwYeta220002.show();
					yetaP320002Form.setMSFFormWindows(msFwYeta220002);
		...
		tabsYeta3300 = new TabPanel();
		tabsYeta3300.setAutoWidth(false);
		tabsYeta3300.setAnimScroll(false);
		tabsYeta3300.setTabScroll(true);
		tabsYeta3300.setPlain(true);
		tabsYeta3300.setSize(660, 720);
		tabsYeta3300.addListener(Events.Select, new Listener<TabPanelEvent>() {
			public void handleEvent(TabPanelEvent e) {
				// 탭선택
				Yeta3300ToYe161010Detail( Yeta3300ToYe161010GridPanel.getCurrentlySelectedItem(), tabsYeta3300.getSelectedItem().getId()); 
		...
		itemYeta08.addListener(Events.Select, new Listener<TabPanelEvent>() {
			public void handleEvent(TabPanelEvent e) {
				...
				//탭선택
				Yeta3300ToYe161010Detail(Yeta3300ToYe161010GridPanel.getCurrentlySelectedItem(), tabsItemYeta08.getSelectedItem().getId());

			}
		});
		
		
		tabsYeta3300.add(itemYeta08);		
		...
		tabsYeta3300.add(itemYeta10);	
		

		fieldSet.add(tabsYeta3300);
	 ...
	 private LayoutContainer occupationalRBottom2() {
		 ...
		 Yeta3300ToYe161030GridPanel = new MSFGridPanel(ye161030Def, false, false, false, false, false);
		 Yeta3300ToYe161030GridPanel.setHeaderVisible(false);  
		 Yeta3300ToYe161030GridPanel.setBodyBorder(true);
		 Yeta3300ToYe161030GridPanel.setBorders(true);
		 
		 
		 /** --- grid 체크 컬럼 --- **/
//		 // 기본
//		 final Grid<BaseModel> grid5 = Yeta3300ToYe161030GridPanel.getMsfGrid().getGrid();
...
//         
//         // 부녀자
//		 final Grid<BaseModel> grid6 = Yeta3300ToYe161030GridPanel.getMsfGrid().getGrid();
...
//         
//         // 경로
//         final Grid<BaseModel> grid7 = Yeta3300ToYe161030GridPanel.getMsfGrid().getGrid();
...
//		 
//         // 출산
//         final Grid<BaseModel> grid8 = Yeta3300ToYe161030GridPanel.getMsfGrid().getGrid();
...
//         
//         // 6세
//         final Grid<BaseModel> grid10 = Yeta3300ToYe161030GridPanel.getMsfGrid().getGrid();
...
//         
//         // 한부모
//         final Grid<BaseModel> grid11 = Yeta3300ToYe161030GridPanel.getMsfGrid().getGrid();
...
//         grid11.getView().setForceFit(true);
		 ...
		 cpGrid.add(Yeta3300ToYe161030GridPanel); 
...
//	 }
	 ...
	 private LayoutContainer occupationalRBottom3_01() {
		 ...
		 Yeta3300ToYe161040GridPanel_01 = new MSFGridPanel(ye161040Def_01, false, false, false, false, false);
		 Yeta3300ToYe161040GridPanel_01.setHeaderVisible(false);  
		 Yeta3300ToYe161040GridPanel_01.setBodyBorder(true);
		 Yeta3300ToYe161040GridPanel_01.setBorders(true);
		 Yeta3300ToYe161040GridPanel_01.getBottomComponent().setVisible(false);
		 Yeta3300ToYe161040GridPanel_01.getGrid().getColumnModel().addHeaderGroup(0, 2, new HeaderGroupConfig("보험료", 1, 4));
		 Yeta3300ToYe161040GridPanel_01.getGrid().getColumnModel().addHeaderGroup(0, 8, new HeaderGroupConfig("신용카드 등 사용액", 1, 6)); 
		 ...
		 Yeta3300ToYe161040GridPanel_01.getGrid().getColumnModel().addAggregationRow(payrSummaryRow); 
		    
		 
		 cpGrid.add(Yeta3300ToYe161040GridPanel_01); 
	 ...
	 private LayoutContainer occupationalRBottom3_02() {
		 ...
		 Yeta3300ToYe161040GridPanel_02 = new MSFGridPanel(ye161040Def_02, false, false, false, false, false);
		 Yeta3300ToYe161040GridPanel_02.setHeaderVisible(false);  
		 Yeta3300ToYe161040GridPanel_02.setBodyBorder(true);
		 Yeta3300ToYe161040GridPanel_02.setBorders(true);
		 Yeta3300ToYe161040GridPanel_02.getBottomComponent().setVisible(false);
		 
		 Yeta3300ToYe161040GridPanel_02.getGrid().getColumnModel().addHeaderGroup(0, 2, new HeaderGroupConfig("보험료", 1, 4));
		 Yeta3300ToYe161040GridPanel_02.getGrid().getColumnModel().addHeaderGroup(0, 8, new HeaderGroupConfig("신용카드 등 사용액", 1, 6)); 
		 ...
		 Yeta3300ToYe161040GridPanel_02.getGrid().getColumnModel().addAggregationRow(payrSummaryRow); 
		    
		 cpGrid.add(Yeta3300ToYe161040GridPanel_02); 
...
//		    
//		 
//		 Yeta3300ToYe161090GridPanel = new MSFGridPanel(ye161090Def, false, false, false, false, false);
//		 Yeta3300ToYe161090GridPanel.setHeaderVisible(false);  
//		 Yeta3300ToYe161090GridPanel.setBodyBorder(true);
//		 Yeta3300ToYe161090GridPanel.setBorders(true);
//		 Yeta3300ToYe161090GridPanel.getBottomComponent().setVisible(true);
//		    
//		 cpGrid.add(Yeta3300ToYe161090GridPanel); 
//		    
//		 lcStdGrid.add(cpGrid);
//		    
//		 return lcStdGrid;		 		 
...
//			dtyStrtDt.setHeight("");
		...
		btnNewButton.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				...
				//전체내역  
				YetaP33006 yetaP33006Form = new YetaP33006(ActionDatabase.READ, getThis());   
							    
				MSFFormWindows msFwYeta33006 = new MSFFormWindows("종전근무지등록", yetaP33006Form, "닫기", "960px", "710px", true);
				msFwYeta33006.show();
				yetaP33006Form.setMSFFormWindows(msFwYeta33006);
					
				funcSetPopUpRecord();
				yetaP33006Form.bind(ppRecord); 
				
				// 팝업이 닫히면 탭을 다시 조회한다.
				msFwYeta33006.addListener(Events.Hide, new Listener<BaseEvent>() { 
		    		@Override
		    		public void handleEvent(BaseEvent be) { 
		    			getItemYeta01();
		    		}
...
//										    
//					MSFFormWindows msFwYeta33009 = new MSFFormWindows("주현근무지등록", yetaP03009Form, "닫기", "820px", "710px", true);
//					msFwYeta33009.show();
//					yetaP03009Form.setMSFFormWindows(msFwYeta33009);
//					//TODO 추후 주석해제 
...
//			layoutContainer_49_2.add(btnNewButton1);
		...
		btnNewButton1.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				// 전체내역
				YetaP33008 yetaP33008Form = new YetaP33008(ActionDatabase.READ, getThis());   
									    
				MSFFormWindows msFwYeta23008 = new MSFFormWindows("현비과세및감면", yetaP33008Form, "닫기", "820px", "710px", true);
				msFwYeta23008.show();
				yetaP33008Form.setMSFFormWindows(msFwYeta23008);
					
				funcSetPopUpRecord();
				 
				yetaP33008Form.bind(ppRecord); 
			}
		});			
...
//		layoutContainer_20.setHeight("100");
		...
		Yeta3300ToYe169010GridPanel = new MSFGridPanel(ye169010Def, false, false,false, false, false);
		Yeta3300ToYe169010GridPanel.setHeaderVisible(false);
		Yeta3300ToYe169010GridPanel.setBodyBorder(true);
		Yeta3300ToYe169010GridPanel.setBorders(true);
		Yeta3300ToYe169010GridPanel.getBottomComponent().setVisible(false);
		//
		cpGrid.add(Yeta3300ToYe169010GridPanel);
		...
		button2.addListener(Events.Select, new Listener<ButtonEvent>() {
			...
			public void handleEvent(ButtonEvent be) {
				...
				yeta3300Service.getYeta3300TxDdcYnToYe161020Data(ye161020Dto, new AsyncCallback<Ye161020DTO>() {
...
//							if (result.getC152StdTxDdcYn() == "Y" || "N".equals(result.getC152StdTxDdcYn())) {
								//전체내역  
								YetaT330171 yetaT330171Form = new YetaT330171(ActionDatabase.READ, getThis());   
										    
								MSFFormWindows msFwYetaT230171 = new MSFFormWindows("기본세액공제", yetaT330171Form, "닫기", "650px", "710px", true);
								msFwYetaT230171.show();
								yetaT330171Form.setMSFFormWindows(msFwYetaT230171);
					...
					public void onFailure(Throwable caught) {
						...
						public void onSuccess(Ye161020DTO result) {
							...
							if (result.getC152StdTxDdcYn() == "Y" || "Y".equals(result.getC152StdTxDdcYn())) {
								//전체내역  
								YetaT33017 yetaT33017Form = new YetaT33017(ActionDatabase.READ, getThis());   
										    
								MSFFormWindows msFwYetaT23017 = new MSFFormWindows("표준세액공제", yetaT33017Form, "닫기", "650px", "710px", true);
								msFwYetaT23017.show();
								yetaT33017Form.setMSFFormWindows(msFwYetaT23017);
...
//								funcSetPopUpRecord();
	...
	private LayoutContainer yetaData02() {
		...
		btnYeta3220New.addListener(Events.Select, new Listener<ButtonEvent>() {
			...
			public void handleEvent(ButtonEvent be) {
				...
				if (MSFSharedUtils.paramNull(systemkey.getValue())) {
	          	...
	          	//가족사항등록 
				YetaP330012 payrP41003Form = new YetaP330012(ActionDatabase.INSERT, getThis());   
		...
		btnYeta3220Del.addListener(Events.Select, new Listener<ButtonEvent>() {
			...
			public void handleEvent(ButtonEvent be) {
				...
				Iterator<BaseModel> itBm = Yeta3300ToYe161030GridPanel.getMsfGrid().getGrid().getSelectionModel().getSelectedItems().listIterator();
				...
				MessageBox.confirm("삭제", "선택하신 인적공제명세를 삭제하시겠습니까?</br> (삭제시 관련된  교육비, 의료비 등의 내역도 같이 삭제 처리 됩니다. )",new Listener<MessageBoxEvent>(){
					...
					public void handleEvent(MessageBoxEvent be) {
						if(Dialog.YES.equals(be.getButtonClicked().getItemId())){
							yeta3300Service.activityOnYeta3300ToYe161030(listYe161030Dto ,actionDatabase, new AsyncCallback<Long>() {
	...
	private LayoutContainer yetaData04() {
		...
		btnNewButton_9.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				// 전체내역
				YetaP33007 yetaP33007Form = new YetaP33007(ActionDatabase.READ, getThis());

				MSFFormWindows msFwYeta33007 = new MSFFormWindows("연금저축소득공제",yetaP33007Form, "닫기", "820px", "550px", true);
				msFwYeta33007.show();
				yetaP33007Form.setMSFFormWindows(msFwYeta33007);
				
				msFwYeta33007.addListener(Events.Hide,new Listener<BaseEvent>() { 
		    		@Override
		    		public void handleEvent(BaseEvent be) { 
		    			getItemYeta04();
		    		}
	...
	private LayoutContainer yetaData05() {
		...
		tabsItemYeta05.addListener(Events.Select, new Listener<TabPanelEvent>() {
			public void handleEvent(TabPanelEvent e) {
				Yeta3300ToYe161010Detail(Yeta3300ToYe161010GridPanel.getCurrentlySelectedItem(), tabsItemYeta05.getSelectedItem().getId());
			}
		});
...
//		LayoutContainer layoutContainer_301 = new LayoutContainer();
		...
		btnNewButton_15.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				//전체내역  
				YetaP33004 yetaP23004Form = new YetaP33004(ActionDatabase.READ, getThis());   
					    
				MSFFormWindows msFwYeta33004 = new MSFFormWindows("거주자간 주택임차차입금 원리금 상환액", yetaP23004Form, "닫기", "820px", "600px", true);
				msFwYeta33004.show();
				yetaP23004Form.setMSFFormWindows(msFwYeta33004);
				 
				funcSetPopUpRecord();
				//TODO 추후 주석해제 
				yetaP23004Form.bind(ppRecord); 
			}
		});	
...
//
//				MSFFormWindows msFwYeta33005 = new MSFFormWindows("월세액소득공제명세",yetaP23005Form, "닫기", "820px", "510px", true);
//				msFwYeta33005.show();
//				yetaP23005Form.setMSFFormWindows(msFwYeta33005);
//
//				funcSetPopUpRecord();
...
//		fldstNewFieldset_20.add(fldstNewFieldset_22);
		...
		lthYr2015AfthYr15Amt.setReadOnly(true);
...
//		// 버튼
//		ButtonBar buttonBar_55 = new ButtonBar();
//		buttonBar_55.setAlignment(HorizontalAlignment.RIGHT);
//
//		Button btnNewButton_13 = new Button("이월기부금등록");
//		buttonBar_55.add(btnNewButton_13);
...
//				    
//				MSFFormWindows msFwYeta33001 = new MSFFormWindows("이월기부금등록", yetaP23001Form, "닫기", "820px", "710px", true);
//				msFwYeta33001.show();
//				yetaP23001Form.setMSFFormWindows(msFwYeta33001);
//						
//				funcSetPopUpRecord();
//				
...
//			}
//		});
//		layoutContainer_359.add(buttonBar_55);
...
//		layoutContainer_224.add(layoutContainer_243);
		...
		cpiv16AsctUseAmt = new MSFNumberField();
		cpiv16AsctUseAmt.setFieldLabel("출자∙투자금액");
		cpiv16AsctUseAmt.setAllowDecimals(true); 
		cpiv16AsctUseAmt.setPropertyEditorType(Long.class); 
		cpiv16AsctUseAmt.setFormat(NumberFormat.getDecimalFormat());
		
		layoutContainer_254.add(cpiv16AsctUseAmt, new FormData("100%"));
		...
		LabelField lblfldNewLabelfield_36 = new LabelField("(2016년조합)");
		...
		cpiv16VntUseAmt = new MSFNumberField();
		cpiv16VntUseAmt.setFieldLabel("출자∙투자금액");
		cpiv16VntUseAmt.setAllowDecimals(true); 
		cpiv16VntUseAmt.setPropertyEditorType(Long.class); 
		cpiv16VntUseAmt.setFormat(NumberFormat.getDecimalFormat());
		
		layoutContainer_2545.add(cpiv16VntUseAmt, new FormData("100%"));
		...
		LabelField lblfldNewLabelfield_366 = new LabelField("(2016년벤처)");
		...
		cpiv17AsctUseAmt = new MSFNumberField();
		cpiv17AsctUseAmt.setFieldLabel("출자∙투자금액");
		cpiv17AsctUseAmt.setAllowDecimals(true); 
		cpiv17AsctUseAmt.setPropertyEditorType(Long.class); 
		cpiv17AsctUseAmt.setFormat(NumberFormat.getDecimalFormat());
		
		layoutContainer_254a.add(cpiv17AsctUseAmt, new FormData("100%"));
		...
		LabelField lblfldNewLabelfield_36a = new LabelField("(2017년조합)");
		...
		cpiv17VntUseAmt = new MSFNumberField();
		cpiv17VntUseAmt.setFieldLabel("출자∙투자금액");
		cpiv17VntUseAmt.setAllowDecimals(true); 
		cpiv17VntUseAmt.setPropertyEditorType(Long.class); 
		cpiv17VntUseAmt.setFormat(NumberFormat.getDecimalFormat());
		
		layoutContainer_2545a.add(cpiv17VntUseAmt, new FormData("100%"));
		...
		LabelField lblfldNewLabelfield_366a = new LabelField("(2017년벤처)");
		...
		cpiv18AsctUseAmt = new MSFNumberField();
		cpiv18AsctUseAmt.setFieldLabel("출자∙투자금액");
		cpiv18AsctUseAmt.setAllowDecimals(true); 
		cpiv18AsctUseAmt.setPropertyEditorType(Long.class); 
		cpiv18AsctUseAmt.setFormat(NumberFormat.getDecimalFormat());
		
		layoutContainer_254b.add(cpiv18AsctUseAmt, new FormData("100%"));
		...
		LabelField lblfldNewLabelfield_36b = new LabelField("(2018년조합)");
		...
		cpiv18VntUseAmt = new MSFNumberField();
		cpiv18VntUseAmt.setFieldLabel("출자∙투자금액");
		cpiv18VntUseAmt.setAllowDecimals(true); 
		cpiv18VntUseAmt.setPropertyEditorType(Long.class); 
		cpiv18VntUseAmt.setFormat(NumberFormat.getDecimalFormat());
		
		layoutContainer_2545b.add(cpiv18VntUseAmt, new FormData("100%"));
		...
		LabelField lblfldNewLabelfield_366b = new LabelField("(2018년벤처)");
...
//
		...
		cpiv16AsctDdcAmt = new MSFNumberField();
		cpiv16AsctDdcAmt.setReadOnly(true);
		cpiv16AsctDdcAmt.setFieldLabel("공제액");
		cpiv16AsctDdcAmt.setAllowDecimals(true); 
		cpiv16AsctDdcAmt.setPropertyEditorType(Long.class); 
		cpiv16AsctDdcAmt.setFormat(NumberFormat.getDecimalFormat());
		
		layoutContainer_248.add(cpiv16AsctDdcAmt, new FormData("100%"));
		...
		cpiv16VntDdcAmt = new MSFNumberField();
		cpiv16VntDdcAmt.setReadOnly(true);
		cpiv16VntDdcAmt.setFieldLabel("공제액");
		cpiv16VntDdcAmt.setAllowDecimals(true); 
		cpiv16VntDdcAmt.setPropertyEditorType(Long.class); 
		cpiv16VntDdcAmt.setFormat(NumberFormat.getDecimalFormat());
		
		layoutContainer_2522.add(cpiv16VntDdcAmt, new FormData("100%"));
		layoutContainer_225.add(layoutContainer_2522);
		
		
		//----------------------- 2017 공제액  -------------------------------------------------
		
		// 기타공제_투자조합출자소득공제_2016년 공제액
		...
		cpiv17AsctDdcAmt = new   MSFNumberField();
		cpiv17AsctDdcAmt.setFieldLabel("공제액");
		cpiv17AsctDdcAmt.setReadOnly(true);
		cpiv17AsctDdcAmt.setAllowDecimals(true); 
		cpiv17AsctDdcAmt.setPropertyEditorType(Long.class); 
		cpiv17AsctDdcAmt.setFormat(NumberFormat.getDecimalFormat());
		
		layoutContainer_248a.add(cpiv17AsctDdcAmt, new FormData("100%"));
		...
		cpiv17VntDdcAmt = new MSFNumberField();
		cpiv17VntDdcAmt.setReadOnly(true);
		cpiv17VntDdcAmt.setFieldLabel("공제액");
		cpiv17VntDdcAmt.setAllowDecimals(true); 
		cpiv17VntDdcAmt.setPropertyEditorType(Long.class); 
		cpiv17VntDdcAmt.setFormat(NumberFormat.getDecimalFormat());
		
		layoutContainer_2522a.add(cpiv17VntDdcAmt, new FormData("100%"));
	...
	//----------------------- 2018 공제액  -------------------------------------------------
		...
		cpiv18AsctDdcAmt = new   MSFNumberField();
		cpiv18AsctDdcAmt.setFieldLabel("공제액");
		cpiv18AsctDdcAmt.setReadOnly(true);
		cpiv18AsctDdcAmt.setAllowDecimals(true); 
		cpiv18AsctDdcAmt.setPropertyEditorType(Long.class); 
		cpiv18AsctDdcAmt.setFormat(NumberFormat.getDecimalFormat());
		
		layoutContainer_248b.add(cpiv18AsctDdcAmt, new FormData("100%"));
		...
		cpiv18VntDdcAmt = new MSFNumberField();
		cpiv18VntDdcAmt.setReadOnly(true);
		cpiv18VntDdcAmt.setFieldLabel("공제액");
		cpiv18VntDdcAmt.setAllowDecimals(true); 
		cpiv18VntDdcAmt.setPropertyEditorType(Long.class); 
		cpiv18VntDdcAmt.setFormat(NumberFormat.getDecimalFormat());
		
		layoutContainer_2522b.add(cpiv18VntDdcAmt, new FormData("100%"));
...
//		layoutContainer_132.add(layoutContainer_145);
	...
	private LayoutContainer yetaData08() {
		...
		btnNewButton_10.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				//전체내역  
				YetaP33002 yetaP23002Form = new YetaP33002(ActionDatabase.READ, getThis());   
				    
				MSFFormWindows msFwYeta33002 = new MSFFormWindows("의료비내역등록", yetaP23002Form, "닫기", "820px", "710px", true);
				msFwYeta33002.show();
				yetaP23002Form.setMSFFormWindows(msFwYeta33002);
				
				msFwYeta33002.addListener(Events.Hide,new Listener<BaseEvent>() { 
		    		@Override
		    		public void handleEvent(BaseEvent be) { 
		    			getItemYeta08();
		    		}
...
//
//		ButtonBar barYe161090 = new ButtonBar();
//		barYe161090.setAlignment(HorizontalAlignment.RIGHT);
//
//		Button btnYe161090New = new Button("추가");
//		btnYe161090New.addListener(Events.Select, new Listener<ButtonEvent>() {
//			@Override
//			public void handleEvent(ButtonEvent be) {
//				// TODO Auto-generated method stub
//
//				fnPopupCommP160("Ye161090");
//				
//			}
//		});
//		barYe161090.add(btnYe161090New);
//
//		
//		Button btnYe161090Del = new Button("삭제");
//		btnYe161090Del.addListener(Events.Select, new Listener<ButtonEvent>() {
//			@Override
//			public void handleEvent(ButtonEvent be) {
//				// TODO Auto-generated method stub
//				
//				Iterator<BaseModel> itBm  = Yeta3300ToYe161090GridPanel.getMsfGrid().getGrid().getSelectionModel().getSelectedItems().listIterator();
//				
//				List<Record>  lsRec  = new ArrayList<Record>();
//	              
//				while(itBm.hasNext()) {
...
//				actionDatabase = ActionDatabase.DELETE;  
//				
//				yeta3300Service.saveYeta3300ToYe161090tabItem08_3(listYe161090Dto, actionDatabase, new AsyncCallback<Long>() {
//			    			 
//					public void onFailure(Throwable caught) {
//						MessageBox.alert(MSFMainApp.MSFCONSTANTS.ExceptionTitleService(), 
//										MSFMainApp.ADMINMESSAGES.ExceptionMessageService("saveYeta3300ToYe161090tabItem08_3(" + actionDatabase.name() + ") : " + caught), null);
//					}
//					public void onSuccess(Long result) {  
//						reloadYe161090Grid();
//						
...
//			}
//		});
//		barYe161090.add(btnYe161090Del);
//
//		layoutContainer_407.add(barYe161090, new com.extjs.gxt.ui.client.widget.layout.ColumnData(.5));
...
//		layoutContainer_409.setLayout(new ColumnLayout());
		...
		//특별공제_교육비_취학전아동
		scxpsKidDdcTrgtAmt = new MSFNumberField();
		scxpsKidDdcTrgtAmt.setReadOnly(true);
		scxpsKidDdcTrgtAmt.setLabelSeparator("");
		...
		layoutContainer_416.add(scxpsKidDdcTrgtAmt, new FormData("100%"));
...
//		layoutContainer_411.setLayout(new ColumnLayout());
		...
		//특별공제_교육비_초중고
		scxpsStdDdcTrgtAmt = new MSFNumberField();
		scxpsStdDdcTrgtAmt.setReadOnly(true);
		scxpsStdDdcTrgtAmt.setLabelSeparator("");
		...
		layoutContainer_418.add(scxpsStdDdcTrgtAmt, new FormData("100%"));
		...
		//특별공제_교육비_대학교
		scxpsUndDdcTrgtAmt = new MSFNumberField();
		scxpsUndDdcTrgtAmt.setReadOnly(true);
		scxpsUndDdcTrgtAmt.setLabelSeparator("");
		...
		layoutContainer_420.add(scxpsUndDdcTrgtAmt, new FormData("100%"));
...
//		layoutContainer_376.setLayout(new ColumnLayout());
		...
		btnNewButton_11.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				//전체내역  
				YetaP330011 yetaP230011Form = new YetaP330011(ActionDatabase.READ, getThis());   
				    
				MSFFormWindows msFwYeta330011 = new MSFFormWindows("교육비내역등록", yetaP230011Form, "닫기", "820px", "730px", true);
				msFwYeta330011.show();
				yetaP230011Form.setMSFFormWindows(msFwYeta330011);
				
				msFwYeta330011.addListener(Events.Hide,new Listener<BaseEvent>() { 
		    		@Override
		    		public void handleEvent(BaseEvent be) { 
		    			getItemYeta08();
		    		}
...
//		});
		...
		btnNewButton_14.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				//전체내역  
				YetaP33003 yetaP23003Form = new YetaP33003(ActionDatabase.READ, getThis());   
				    
				MSFFormWindows msFwYeta33003 = new MSFFormWindows("기부금내역등록", yetaP23003Form, "닫기", "820px", "510px", true);
				msFwYeta33003.show();
				yetaP23003Form.setMSFFormWindows(msFwYeta33003);
				
				msFwYeta33003.addListener(Events.Hide,new Listener<BaseEvent>() { 
		    		@Override
		    		public void handleEvent(BaseEvent be) { 
		    			getItemYeta08();
		    		}
		...
		btnNewButton_13.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				//전체내역  
				YetaP33001 yetaP23001Form = new YetaP33001(ActionDatabase.READ, getThis());   
				    
				MSFFormWindows msFwYeta33001 = new MSFFormWindows("기부금조정명세", yetaP23001Form, "닫기", "820px", "710px", true);
				msFwYeta33001.show();
				yetaP23001Form.setMSFFormWindows(msFwYeta33001);
				
				msFwYeta33001.addListener(Events.Hide,new Listener<BaseEvent>() { 
		    		@Override
		    		public void handleEvent(BaseEvent be) { 
		    			getItemYeta05();
		    		}
...
//		layoutContainer_154.add(layoutContainer_160);
		...
		btnNewButton_16.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				// 전체내역
				YetaP33005 yetaP23005Form = new YetaP33005(ActionDatabase.READ,getThis());

				MSFFormWindows msFwYeta33005 = new MSFFormWindows("월세액소득공제명세",yetaP23005Form, "닫기", "820px", "510px", true);
				msFwYeta33005.show();
				yetaP23005Form.setMSFFormWindows(msFwYeta33005);
				
				msFwYeta33005.addListener(Events.Hide,new Listener<BaseEvent>() { 
		    		@Override
		    		public void handleEvent(BaseEvent be) { 
		    			getItemYeta09();
		    		}
				...
				public void handleEvent(BaseEvent be) {
					...
					if (mapModels != null) { 
						...
						yeta3300Service.activityOnYeta3300ToYe161030(listYe161030Dto, actionDatabase, new AsyncCallback<Long>() {
							...
							public void onFailure(Throwable caught) {
								MessageBox.alert(MSFMainApp.MSFCONSTANTS.ExceptionTitleService(), 
									MSFMainApp.ADMINMESSAGES.ExceptionMessageService("activityOnYeta3300ToYe161030(" + actionDatabase.name() + ") : " + caught), null);
							}
							public void onSuccess(Long result) {  
								reloadYe161030();
							}   
...
//		ye161020Dto.setPrifChngYn(ye161020Dto.getPrifChngYn());    /** column 인적공제항목변동여부 : prifChngYn */
		...
		yeta3300Service.saveYeta3300ToYe161020tabItem01(ye161020Dto, new AsyncCallback<Integer>() {
			@Override
			public void onFailure(Throwable caught) {
				// TODO Auto-generated method stub
					MessageBox.alert(MSFMainApp.MSFCONSTANTS.ExceptionTitleService(), 
	...
	public void itemYeta02Save() {
		...
		Iterator<Record> iterRecords = Yeta3300ToYe161030GridPanel.getMsfGrid().getGrid().getStore().getModifiedRecords().iterator(); 
...
//	        yeta3220Dto.setBeforeJumin(MSFSharedUtils.allowNulls(bmMapModel.get("rsnoNumb2")));
	...
	public void itemYeta03Save() {
		...
		//국세청자료 grid
		Iterator<Record> iterRecords = Yeta3300ToYe161040GridPanel_01.getMsfGrid().getGrid().getStore().getModifiedRecords().iterator(); 
		...
		//기타자료 grid
		iterRecords = Yeta3300ToYe161040GridPanel_02.getMsfGrid().getGrid().getStore().getModifiedRecords().iterator(); 
		...
		yeta3300Service.saveYeta3300ToYe1610400tabItem03(listYe161040Dto_01, listYe161040Dto_02, new AsyncCallback<Integer>() {
	...
	public void itemYeta04Save() {
		...
		yeta3300Service.saveYeta3300ToYe161055tabItem04(ye161055Dto, new AsyncCallback<Integer>() {
	...
	public void itemYeta05_1Save() {
		...
		yeta3300Service.saveYeta3300ToYe161060tabItem05_1(ye161060Dto, new AsyncCallback<Integer>() {
	...
	public void itemYeta05_2Save() {
		...
		yeta3300Service.saveYeta3300ToYe161060tabItem05_2(ye161060Dto, new AsyncCallback<Integer>() {
	...
	public void itemYeta06Save() {
		...
		ye161070Dto.setCpiv16AsctUseAmt			((Long) cpiv16AsctUseAmt.getValue());    	/** column 출자투자금액_조합등_2016납입금 : cpiv16AsctUseAmt */
		ye161070Dto.setCpiv16AsctDdcAmt			((Long) cpiv16AsctDdcAmt.getValue());    	/** column 출자투자금액 조합등_2016공제액 : cpiv16AsctDdcAmt */
		ye161070Dto.setCpiv16VntUseAmt			((Long) cpiv16VntUseAmt.getValue());    	/** column 출자투자금액벤처등_2016납입금액 : cpiv16VntUseAmt */
		ye161070Dto.setCpiv16VntDdcAmt			((Long) cpiv16VntDdcAmt.getValue());    	/** column 출자투자금액벤처등_2016공제액 : cpiv16VntDdcAmt */
		ye161070Dto.setCpiv17AsctUseAmt			((Long) cpiv17AsctUseAmt.getValue());    	/** column 출자투자금액_조합등_2017납입금 : cpiv17AsctUseAmt */
		ye161070Dto.setCpiv17AsctDdcAmt			((Long) cpiv17AsctDdcAmt.getValue());    	/** column 출자투자금액 조합등_2017공제액 : cpiv17AsctDdcAmt */
		ye161070Dto.setCpiv17VntUseAmt			((Long) cpiv17VntUseAmt.getValue());    	/** column 출자투자금액벤처등_2017납입금액 : cpiv17VntUseAmt */
		ye161070Dto.setCpiv17VntDdcAmt			((Long) cpiv17VntDdcAmt.getValue());    	/** column 출자투자금액벤처등_2017공제액 : cpiv17VntDdcAmt */
		ye161070Dto.setCpiv18AsctUseAmt			((Long) cpiv18AsctUseAmt.getValue());    	/** column 출자투자금액_조합등_2018납입금 : cpiv18AsctUseAmt */
		ye161070Dto.setCpiv18AsctDdcAmt			((Long) cpiv18AsctDdcAmt.getValue());    	/** column 출자투자금액 조합등_2018공제액 : cpiv18AsctDdcAmt */
		ye161070Dto.setCpiv18VntUseAmt			((Long) cpiv18VntUseAmt.getValue());    	/** column 출자투자금액벤처등_2018납입금액 : cpiv18VntUseAmt */
		ye161070Dto.setCpiv18VntDdcAmt			((Long) cpiv18VntDdcAmt.getValue());    	/** column 출자투자금액벤처등_2018공제액 : cpiv18VntDdcAmt */
...
//		ye161070Dto.setTyShfyPrsAddDdcrtUseAmt	((Long) tyShfyPrsAddDdcrtUseAmt.getValue());/** column 본인추가공제율사용분_2016_상반기 : tyShfyPrsAddDdcrtUseAmt */
		...
		yeta3300Service.saveYeta3300ToYe161070tabItem06(ye161070Dto, new AsyncCallback<Integer>() {
	...
	public void itemYeta07Save() {
		...
		yeta3300Service.saveYeta3300ToYe161070tabItem07(ye161070Dto, new AsyncCallback<Integer>() {
...
//		ye161080Vo.setYupSnmcReEndDt(ye161080Dto.getYupSnmcReEndDt());    /** column 중소기업취업자감면기간종료일자 : yupSnmcReEndDt */
		...
		yeta3300Service.saveYeta3300ToYe161080tabItem08_1(ye161080Dto, new AsyncCallback<Integer>() {
...
//		ye161080Dto.setScxpsDsbrCount		((Long) scxpsDsbrCount.getValue());    	/** column 교육비_장애인인원수 : scxpsDsbrCount */
		...
		yeta3300Service.saveYeta3300ToYe161080tabItem08_3(ye161080Dto, new AsyncCallback<Integer>() {
...
//						//-- 그리드 저장
//						
//						Iterator<Record> iterRecords = Yeta3300ToYe161090GridPanel.getMsfGrid().getGrid().getStore().getModifiedRecords().iterator(); 
//				        
//						List<Ye161090DTO> listYe161090Dto = new ArrayList<Ye161090DTO>();  
//						Ye161090DTO ye161090Dto = new Ye161090DTO(); 
//						
...
//						}
	...
	public void itemYeta09Save() {
		...
		yeta3300Service.saveYeta3300ToYe161080tabItem09(ye161080Dto, new AsyncCallback<Integer>() {
	...
	public void itemYeta10Save() {
		...
		yeta3300Service.saveYeta3300ToYe161080tabItem10(ye161080Dto, new AsyncCallback<Integer>() {
...
//		resetItemYeta01();	 
		...
		Yeta3300ToYe161010GridPanel.getTableDef().setTableColumnFilters(filters);
		
		Yeta3300ToYe161010GridPanel.getTableDef().addColumnFilter("yrtxBlggYr", MSFSharedUtils.getSelectedComboValue(srhYrtxBlggYr, "year"), SimpleColumnFilter.OPERATOR_EQUALS);
		
		Yeta3300ToYe161010GridPanel.getTableDef().addColumnFilter("clutSeptCd", MSFSharedUtils.getSelectedComboValue(srhClutSeptCd, "commCd"), SimpleColumnFilter.OPERATOR_EQUALS);
		
		Yeta3300ToYe161010GridPanel.getTableDef().addColumnFilter("payrMangDeptCd", MSFSharedUtils.getSelectedComboValue(srhPayrMangDeptCd,"payrMangDeptCd"), SimpleColumnFilter.OPERATOR_EQUALS);
		Yeta3300ToYe161010GridPanel.getTableDef().addColumnFilter("emymtDivCd", MSFSharedUtils.getSelectedComboValue(srhEmymtDivCd,"commCd"), SimpleColumnFilter.OPERATOR_EQUALS); 
		String strDeptCd =YetaUtils.getStrValToBMMultiCombo(lsDeptCd, srhDeptCd.getValue(),"deptNmRtchnt","deptCd");  
		Yeta3300ToYe161010GridPanel.getTableDef().addColumnFilter("deptCd", strDeptCd , SimpleColumnFilter.OPERATOR_EQUALS);
		           
		String strTypOccuCd = YetaUtils.getStrValToBMMultiCombo(lsTypOccuCd,srhTypOccuCd.getValue(),"typOccuNm","typOccuCd"); 
		Yeta3300ToYe161010GridPanel.getTableDef().addColumnFilter("typOccuCd", strTypOccuCd, SimpleColumnFilter.OPERATOR_EQUALS); 
		...
		Yeta3300ToYe161010GridPanel.getTableDef().addColumnFilter("dtilOccuInttnCd", strDtilOccuInttnCd, SimpleColumnFilter.OPERATOR_EQUALS); 
		       
		Yeta3300ToYe161010GridPanel.getTableDef().addColumnFilter("businCd", MSFSharedUtils.getSelectedComboValue(srhBusinCd,"businCd"), SimpleColumnFilter.OPERATOR_EQUALS);
		Yeta3300ToYe161010GridPanel.getTableDef().addColumnFilter("systemkey", MSFSharedUtils.allowNulls(srhSystemkey.getValue()), SimpleColumnFilter.OPERATOR_EQUALS);
		Yeta3300ToYe161010GridPanel.getTableDef().addColumnFilter("hanNm", MSFSharedUtils.allowNulls(srhHanNm.getValue()), SimpleColumnFilter.OPERATOR_EQUALS);    
		Yeta3300ToYe161010GridPanel.getTableDef().addColumnFilter("resnRegnNum", MSFSharedUtils.allowNulls(srhResnRegnNum.getValue()), SimpleColumnFilter.OPERATOR_EQUALS);  
		Yeta3300ToYe161010GridPanel.getTableDef().addColumnFilter("utDpobCd", MSFSharedUtils.allowNulls(utDpobCd.getValue()), SimpleColumnFilter.OPERATOR_EQUALS); 
		
		
		Yeta3300ToYe161010GridPanel.getTableDef().addColumnFilter("printType", YetaUtils.getCheckedRadioValue(printType), SimpleColumnFilter.OPERATOR_EQUALS);  

		Yeta3300ToYe161010GridPanel.reload(); 
      
	}
	
	
	/** 대상자에 따른 정보 가져옴 **/
	private void Yeta3300ToYeta2000Detail2(Yeta2000BM result) {
	//	private void Yeta3300ToYeta2000Detail2(Yeta2000BM result, String tabId) {
		//if("itemYeta01".equals(tabId)){//기본사항탭을 선택하였을 경우
		
		// TODO 임시 주석처리. 2018.12.08
//			if (MSFSharedUtils.paramNotNull(Yeta3300ToYe161010GridPanel.getCurrentlySelectedItem())){	
//				
//				dpobCd.setValue(result.getDpobCd());		/**  column 사업장코드 : dpobCd */
//				yrtxBlggYr.setValue(result.getEdacRvyy());	/** column 연말정산귀속년도 : edacRvyy */
//				clutSeptCd.setValue(result.getSettGbcd());	/** column 정산구분코드 : settGbcd */
//				systemkey.setValue(result.getSystemkey());	/**  column SYSTEMKEY : systemkey */
//				
//				YetaUtils.setCheckedRadioValue(hshrClCd, result.getHshrClCd());//세대주
//				YetaUtils.setCheckedRadioValue(rsdtClCd, result.getRsdtClCd());//거주지구분
//				
//				rsplNtnInfrNm.setValue(MSFSharedUtils.allowNulls(result.getRsplNtnInfrNm()));//국적 명
//				rsplNtnInfrCd.setValue(MSFSharedUtils.allowNulls(result.getRsplNtnInfrCd()));//국적 코드
//				rsplNtnInfrItem.setValue(MSFSharedUtils.allowNulls(result.getRsplNtnInfrItem()));//국적 코드 두자리
//				
//				dtyStrtDt.setValue(GWTUtils.getDateFromString(result.getDtyStrtDt(), "yyyyMMdd"));//근무 시작 기간
//				dtyEndDt.setValue(GWTUtils.getDateFromString(result.getDtyEndDt(), "yyyyMMdd"));//근무 종료 기간
//				reStrtDt.setValue(GWTUtils.getDateFromString(result.getReStrtDt(), "yyyyMMdd"));//감면 시작 기간
//				reEndDt.setValue(GWTUtils.getDateFromString(result.getReEndDt(), "yyyyMMdd"));//감면 종료 기간
//				rsplNtnCd.setValue(MSFSharedUtils.allowNulls(result.getRsplNtnCd()));	//거주지 코드
//				rsplNtnNm.setValue(MSFSharedUtils.allowNulls(result.getRsplNtnNm()));	//거구지국 두자리
//				rsplNtnItem.setValue(MSFSharedUtils.allowNulls(result.getRsplNtnItem()));	//거주지국 명
//				
...
//				 IColumnFilter filters = null;
//		       		
//	        	   Yeta3300GridPanel.getTableDef().setTableColumnFilters(filters); 
//	       	   	   Yeta3300GridPanel.getTableDef().addColumnFilter("edacRvyy", yrtxBlggYr.getValue(), SimpleColumnFilter.OPERATOR_EQUALS); 
//	       		   Yeta3300GridPanel.getTableDef().addColumnFilter("settGbcd", clutSeptCd.getValue(), SimpleColumnFilter.OPERATOR_EQUALS); 
//	       		   Yeta3300GridPanel.getTableDef().addColumnFilter("systemkey", systemkey.getValue(), SimpleColumnFilter.OPERATOR_EQUALS); 
//	       		   Yeta3300GridPanel.reload();
//			}
//		//}else if("itemYeta02".equals(tabId)){//인적공제
//			if (MSFSharedUtils.paramNotNull(Yeta3300ToYe161010GridPanel.getCurrentlySelectedItem())){
//				
//				reloadYe161030_item02Grid();
//				
...
//			
//				YetaUtils.setCheckedRadioValue(prifChngYn, (String) result.get("prifChngYn"));	//인적공제항목변동여부
//			}
//			
...
//				
//			
//				npHthrWaInfeeAmt.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getnpHthrWaInfeeAmt(),"0")));//종전근무지금액_국민연금
//				npHthrWaInfeeDdcAmt.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getnpHthrWaInfeeDdcAmt(),"0")));//종전근무지공제액_국민연금
//				npHthrMcurWkarInfeeAmt.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getnpHthrMcurWkarInfeeAmt(),"0")));//주현근근무지금액_국민연금
//				npHthrMcurWkarDdcAmt.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getnpHthrMcurWkarDdcAmt(),"0")));//주현근무지공제액_국민연금
//				
//				puoferAnty_02.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getpuoferAnty_02(),"0")));//공무원연금_종근무지
//				puoferAntyDducSum_02.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getpuoferAntyDducSum_02(),"0")));//공무원연금_주근무지
//				puoferAnty_01.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getpuoferAnty_01(),"0")));//공제액_공무원연금_종근무지
//				puoferAntyDducSum_01.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getpuoferAntyDducSum_01(),"0")));//공제액_공무원연금_주근무지
//				
//				mltymAnty_02.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getmltymAnty_02(),"0")));//군인연금_종근무지
//				mltymAntyDducSum_02.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getmltymAntyDducSum_02(),"0")));//군인연금_주근무지
//				mltymAnty_01.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getmltymAnty_01(),"0")));//공제액_군인연금_종근무지
//				mltymAntyDducSum_01.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getmltymAntyDducSum_01(),"0")));//공제액_군인연금_주근무지
//				
//				prtafirSchlFalymmAnty_02.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getprtafirSchlFalymmAnty_02(),"0")));//교직원연금_종근무지
//				prtafirSchlDducSum_02.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getprtafirSchlDducSum_02(),"0")));//교직원연금_주근무지
//				prtafirSchlFalymmAnty_01.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getprtafirSchlFalymmAnty_01(),"0")));//공제액_교직원연금_종근무지
//				prtafirSchlDducSum_01.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getprtafirSchlDducSum_01(),"0")));//공제액_교직원연금_주근무지
//				
//				spildtnPstoficAnty_02.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getspildtnPstoficAnty_02(),"0")));//별정우체국_종근무지
//				spildtnPstoficDducSum_02.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getspildtnPstoficDducSum_02(),"0")));//별정우체국_주근무지
//				spildtnPstoficAnty_01.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getspildtnPstoficAnty_01(),"0")));//공제액_별정우체국_종근무지
//				spildtnPstoficDducSum_01.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getspildtnPstoficDducSum_01(),"0")));//공제액_별정우체국_주근무지
//				
//				pnsnInfeeUseAmtSum.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getpnsnInfeeUseAmtSum(),"0")));//연금보험료금액계
//				pnsnInfeeDdcAmtSum.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getpnsnInfeeDdcAmtSum(),"0")));//연금보험료공제계
//			}
//			
//		//}else if("itemYeta05_1".equals(tabId)) {//특별소득공제 - 보험료
//			if (MSFSharedUtils.paramNotNull(Yeta3300ToYe161010GridPanel.getCurrentlySelectedItem())){	
//				
//				hthrHifeAmt.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.geththrHifeAmt(),"0")));//종전근무지금액_건강보험
//				hthrHifeDdcAmt.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.geththrHifeDdcAmt(),"0")));//종전근무지공제액_건강보험
//				mcurHifeAmt.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getmcurHifeAmt(),"0")));//주현근무지금액_건강보험
//				mcurHifeDdcAmt.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getmcurHifeDdcAmt(),"0")));//주현근무지공제액_건강보험
//				
//				hthrUiAmt.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.geththrUiAmt(),"0")));		//종전근무지금액_고용보험
//				hthrUiDdcAmt.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.geththrUiDdcAmt(),"0")));	//종전근무지공제액_고용보험
//				mcurUiAmt.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getmcurUiAmt(),"0")));		//주현근무지금액_고용보험
//				mcurUiDdcAmt.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getmcurUiDdcAmt(),"0")));	//주현근무지공제액_고용보험
//				
//				infeeUseAmtSum.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getinfeeUseAmtSum(),"0")));//보험료금액계
//				infeeDdcAmtSum.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getinfeeDdcAmtSum(),"0")));//보험료공제액
//			}
//			
//		//}else if("itemYeta05_2".equals(tabId)) {//특별소득공제 - 주택자금
//			if (MSFSharedUtils.paramNotNull(Yeta3300ToYe161010GridPanel.getCurrentlySelectedItem())){	
//				
//				brwLnpbSrmAmt.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getbrwLnpbSrmAmt(),"0")));		//대출기관차입
//				brwLnpbSrmDdcAmt.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getbrwLnpbSrmDdcAmt(),"0")));		//공제액_대출기관차입
//				rsdtLnpbSrmAmt.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getrsdtLnpbSrmAmt(),"0")));	//거주자차입
//				rsdtLnpbSrmDdcAmt.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getrsdtLnpbSrmDdcAmt(),"0")));	//공제액_거주자차입
//				
//				mmrUseAmt.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getmmrUseAmt(),"0")));	//특별공제_차입금원리금상환액_거주자
//				mmrDdcAmt.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getmmrDdcAmt(),"0")));	//특별공제_주택자금_월세금액
//				
//				lthYr15BlwItrAmt.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getlthYr15BlwItrAmt(),"0")));	//이자상환액(15년 미만)
//				lthYr29ItrAmt.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getlthYr29ItrAmt(),"0")));	//공제액_이자상환액(15년 미만)
//				lthY30OverItrAmt.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getlthY30OverItrAmt(),"0")));	//이자상환액(15~29년)
//				lthYr15BlwDdcAmt.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getlthYr15BlwDdcAmt(),"0")));	//공제액_이자상환액(15~29년)
//				lthYr29DdcAmt.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getlthYr29DdcAmt(),"0")));	//이자상환액(30년 이상)
//				lthY30OverDdcAmt.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getlthY30OverDdcAmt(),"0")));	//공제액_이자상환액(30년 이상)
//				
//				lthYr2012AfthY15Amt.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getlthYr2012AfthY15Amt(),"0")));		//고정금리.비거치상환
//				lthYr2012AfthY15DdcAmt.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getlthYr2012AfthY15DdcAmt(),"0")));	//공제액_고정금리 비거치상환
//				lthYr2012EtcBrwItrAmt.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getlthYr2012EtcBrwItrAmt(),"0")));		//기타대출
//				lthYr2012EtcBrwDdcAmt.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getlthYr2012EtcBrwDdcAmt(),"0")));	//공제액_기타대출
//				
//				lthYr2015AfthFxnIrItrAmt.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getlthYr2015AfthFxnIrItrAmt(),"0")));//고정금리.비거치상환 대출(15년이상)
//				lthYr2015AfthY15Amt.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getlthYr2015AfthY15Amt(),"0")));//고정금리/비거치상환 대출(15년이상)
//				lthYr2015AfthEtcAmt.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getlthYr2015AfthEtcAmt(),"0")));//기타대출(15년이상)
//				lthYr2015AfthYr15Amt.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getlthYr2015AfthYr15Amt(),"0")));//고정금리/비거치상환 대출(10년~15년)
//				
//				
//				lthYr2015AfthFxnIrDdcAmt.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getlthYr2015AfthFxnIrDdcAmt(),"0")));//공제액_고정금리.비거치상환 대출(15년이상)
//				lthYr2015AfthY15DdcAmt.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getlthYr2015AfthY15DdcAmt(),"0")));//공제액_고정금리/비거치상환 대출(15년이상)
//				lthYr2015AfthEtcDdcAmt.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getlthYr2015AfthEtcDdcAmt(),"0")));//공제액_기타대출(15년이상)
//				lthYr2015AfthYr15DdcAmt.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getlthYr2015AfthYr15DdcAmt(),"0")));//공제액_고정금리/비거치상환 대출(10년~15년)
//				
//				
//				hsngFndsDdcAmtSum.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.gethsngFndsDdcAmtSum(),"0")));//주택자금공제계
//			}
//		
...
//			if (MSFSharedUtils.paramNotNull(Yeta3300ToYe161010GridPanel.getCurrentlySelectedItem())){	
//				
//				yr2000PnsnSvngUseAmt.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getyr2000PnsnSvngUseAmt(),"0")));	//개인납입금액
//				yr2000PnsnSvngDdcAmt.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getyr2000PnsnSvngDdcAmt(),"0")));	//공제액_개인납입금액
//				smceSbizUseAmt.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getsmceSbizUseAmt(),"0")));	//소기업.소상공인공제부금 불입금
//				smceSbizDdcAmt.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getsmceSbizDdcAmt(),"0")));	//공제액_소기업.소상공인공제부금 불입금
//				
//				sbcSvngUseAmt.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getsbcSvngUseAmt(),"0")));		//청약저축
//				hsngSvngUseAmt.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.gethsngSvngUseAmt(),"0")));		//주택청약종합저축
//				lbrrPrptSvngUseAmt.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getlbrrPrptSvngUseAmt(),"0")));		//근로자주택마련저축
//				hsngIncUseAmtSum.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.gethsngIncUseAmtSum(),"0")));		//주택마련저축소득공제계
//				
//				sbcSvngDdcAmt.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getsbcSvngDdcAmt(),"0")));	//공제액_청약저축
//				hsngSvngDdcAmt.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.gethsngSvngDdcAmt(),"0")));		//공제액_주택청약종합저축
//				lbrrPrptSvngDdcAmt.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getlbrrPrptSvngDdcAmt(),"0")));		//공제액_근로자주택마련저축
//				hsngIncDdcAmtSum.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.gethsngIncDdcAmtSum(),"0")));		//공제액계_주택마련저축소득공제계
//				
//				etgdH09f.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getEtgdH09f(),"0")));	//출자.투자금액_2012년도
//				etgdH13f.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getEtgdH13f(),"0")));	//출자.투자금액_2013년도
//				cpiv14AsctUseAmt.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getcpiv14AsctUseAmt(),"0")));	//출자.투자금액_2014년도
//				cpiv15AsctUseAmt.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getcpiv15AsctUseAmt(),"0")));	//출자.투자금액_2015년도 이후
//				ivcpInvmUseAmtSum.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getivcpInvmUseAmtSum(),"0")));	//출자.투자금액계
//				
//				etgd09af.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getEtgd09af(),"0")));	//공제액_출자.투자금액_2012년도
//				etgdH13h.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getEtgdH13h(),"0")));	//공제액_출자.투자금액_2013년도
//				cpiv14AsctDdcAmt.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getcpiv14AsctDdcAmt(),"0")));	//공제액_출자.투자금액_2014년도
//				cpiv15AsctDdcAmt.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getcpiv15AsctDdcAmt(),"0")));	//공제액_출자.투자금액_2015년도 이후
//				ivcpInvmDdcAmtSum.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getivcpInvmDdcAmtSum(),"0")));	//공제액계_출자.투자금액계
//				
//				crdcUseAmt.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getcrdcUseAmt(),"0")));	//신용카드
//				drtpCardUseAmt.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getdrtpCardUseAmt(),"0")));	//직불카드등
//				cshptUseAmt.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getcshptUseAmt(),"0")));	//현금영수증
//				tdmrUseAmt.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.gettdmrUseAmt(),"0")));	//전통시장
//				pbtUseAmt.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getpbtUseAmt(),"0")));	//대중교통
//				crdcSumUseAmt.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getcrdcSumUseAmt(),"0")));	//신용카드등사용금액계
//				rdcSumDdcAmt.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getrdcSumDdcAmt(),"0")));	//신용카드등사용공제액계
//				cardEt13.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getCardEt13(),"0")));	//신용카드등(본인2013년)
//				prsCrdcUseAmt1.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getprsCrdcUseAmt1(),"0")));	//신용카드등(본인2014년)
//				etadDd13.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getEtadDd13(),"0")));	//추가공제율(본인2013년)
//				pyrPrsAddDdcrtUseAmt.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getpyrPrsAddDdcrtUseAmt(),"0")));	//추가공제율(본인20134년하)
//				
//				
//				tyYrPrsCrdcUseAmt.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.gettyYrPrsCrdcUseAmt(),"0")));	//신용카드등(본인2015년)
...
//			if (MSFSharedUtils.paramNotNull(Yeta3300ToYe161010GridPanel.getCurrentlySelectedItem())){
//				
//				emstAsctCntrUseAmt.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getemstAsctCntrUseAmt(),"0")));	//우리사주조합연출금액
//				etckUncb.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getEtckUncb(),"0")));	//우리사주조합기부금
//				empMntnSnmcUseAmt.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getempMntnSnmcUseAmt(),"0")));	//고용유지중소기업근로자 임금삭감액
//				etgdCtra.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getEtgdCtra(),"0")));	//목돈안드는전세이자상환액
//				ltrmCniSsUseAmt.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getltrmCniSsUseAmt(),"0")));	//장기집합투자증권저축 납입금액
...
//				
//				emstAsctCntrDdcAmt.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getemstAsctCntrDdcAmt(),"0")));	//공제액_우리사주조합연출금액
//				etckUncr.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getEtckUncr(),"0")));		//공제액_우리사주조합기부금
//				empMntnSnmcDdcAmt.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getempMntnSnmcDdcAmt(),"0")));		//공제액_고용유지중소기업근로자 임금삭감액
//				etgdHtra.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getEtgdHtra(),"0")));//공제액_목돈안드는전세이자상환액
//				ltrmCniSsDdcAmt.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getltrmCniSsDdcAmt(),"0")));		//공제액_장기집합투자증권저축 납입금액
...
//			if (MSFSharedUtils.paramNotNull(Yeta3300ToYe161010GridPanel.getCurrentlySelectedItem())){	
//				
//				sctcHpUseAmt.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getsctcHpUseAmt(),"0")));	//과학기술인공제
//				sctcHpDdcTrgtAmt.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getsctcHpDdcTrgtAmt(),"0")));	//공제대상_과학기술인공제
//				sctcHpDdcAmt.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getsctcHpDdcAmt(),"0")));	//공제액_과학기술인공제
//				
//				rtpnUseAmt.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getrtpnUseAmt(),"0")));	//근로자퇴직보장법
//				rtpnDdcTrgtAmt.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getrtpnDdcTrgtAmt(),"0")));	//공제대상_근로자퇴직보장법
//				rtpnDdcAmt.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getrtpnDdcAmt(),"0")));	//공제액_근로자퇴직보장법
//				
//				pnsnSvngUseAmt.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getpnsnSvngUseAmt(),"0")));	//연금저축계좌
//				pnsnSvngDdcTrgtAmt.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getpnsnSvngDdcTrgtAmt(),"0")));	//공제대상_연금저축계좌
//				pnsnSvngDdcAmt.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getpnsnSvngDdcAmt(),"0")));	//공제액_연금저축계좌
//				
//				pnsnAccUseAmtSum.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getpnsnAccUseAmtSum(),"0")));	//연금계좌제
//				pnsnAccDdcTrgtAmtSum.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getpnsnAccDdcTrgtAmtSum(),"0")));	//공제대상_연금계좌제
//				pnsnAccDdcAmtSum.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getpnsnAccDdcAmtSum(),"0")));	//공제액_연금계좌제
//				
//				cvrgInscUseAmt.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getcvrgInscUseAmt(),"0")));	//일반보장성보험_보험료금액
//				cvrgInscDdcTrgtAmt2.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getcvrgInscDdcTrgtAmt2(),"0")));	//공제대상_일반보장성보험_보험료금액
//				cvrgInscDdcAmt.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getcvrgInscDdcAmt(),"0")));//공제액_일반보장성보험_보험료금액
//				
//				dsbrEuCvrgUseAmt.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getdsbrEuCvrgUseAmt(),"0")));	//장애인전용보장성보험_보험료금액
//				dsbrEuCvrgDdcTrgtAmt.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getdsbrEuCvrgDdcTrgtAmt(),"0")));	//공제대상_장애인전용보장성보험_보험료금액
//				dsbrEuCvrgDdcAmt.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getdsbrEuCvrgDdcAmt(),"0")));//공제액_장애인전용보장성보험_보험료금액
//				
//				infeePymUseAmtSum.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getinfeePymUseAmtSum(),"0")));	//연금계좌및보험료_보험료계
//				infeePymDdcTrgtAmtSum.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getinfeePymDdcTrgtAmtSum(),"0")));	//공제대상_연금계좌및보험료_보험료금액
//				infeePymDdcAmtSum.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getinfeePymDdcAmtSum(),"0")));	//공제액_연금계좌및보험료_보험료금액
//			}
//		//}else if("itemYeta08_2".equals(tabId)) {//세액감면및세액공제1 - 의료비
//			
//			if (MSFSharedUtils.paramNotNull(Yeta3300ToYe161010GridPanel.getCurrentlySelectedItem())){
//				
//				mdxpsSftSprcdUseAmt.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getmdxpsSftSprcdUseAmt(),"0")));//지출금액_본인의료비
//				mdxpsSftSprcdDdcTrgtAmt.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getmdxpsSftSprcdDdcTrgtAmt(),"0")));//공제대상_본인의료비
//				mdxpsSftSprcdDdcAmt.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getmdxpsSftSprcdDdcAmt(),"0")));//세액공제_본인의료비
//	
//				mdxpsPrsUseAmt.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getmdxpsPrsUseAmt(),"0")));//지출금액_65세이상자 의료비
//				mdxpsPrsDdcTrgtAmt.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getmdxpsPrsDdcTrgtAmt(),"0")));//공제대상_65세이상자 의료비
//				mdxpsPrsDdcAmt.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getmdxpsPrsDdcAmt(),"0")));//세액공제_65세이상자 의료비
//				
//				mdxpsOthUseAmt.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getmdxpsOthUseAmt(),"0")));//지출금액_장애인 의료비
//				mdxpsOthDdcTrgtAmt.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getmdxpsOthDdcTrgtAmt(),"0")));//공제대상_장애인 의료비
//				mdxpsOthDdcAmt.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getmdxpsOthDdcAmt(),"0")));//세액공제_장애인 의료비
//				
...
//				
//				mdxpsUseAmtSum.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getmdxpsUseAmtSum(),"0")));//의료비금액계
//				mdxpsDdcTrgtAmtSum.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getmdxpsDdcTrgtAmtSum(),"0")));//공제대상계_의료비금액계
//				mdxpsDdcAmtSum.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getmdxpsDdcAmtSum(),"0")));//세액공제계_의료비금액계
//			}
//			
...
//			if (MSFSharedUtils.paramNotNull(Yeta3300ToYe161010GridPanel.getCurrentlySelectedItem())){	
//				
//				scxpsPrsUseAmt.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getscxpsPrsUseAmt(),"0")));//공납금(대학원포함)
//				scxpsPrsDdcTrgtAmt.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getscxpsPrsDdcTrgtAmt(),"0")));//공제대상_공납금(대학원포함)
//				scxpsPrsDdcAmt.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getscxpsPrsDdcAmt(),"0")));//세액공제_공납금(대학원포함)
//				
//				scxpsKidCount.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getscxpsKidCount(),"0")));//취학전아동_수
//				scxpsKidDdcTrgtAmt.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getscxpsKidDdcTrgtAmt(),"0")));//취학전아동_금액
//				scxpsKidDdcAmt.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getscxpsKidDdcAmt(),"0")));//취학전아동(공제)
//				
//				scxpsStdCount.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getscxpsStdCount(),"0")));//초.중.고등학교_수
//				scxpsStdDdcTrgtAmt.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getscxpsStdDdcTrgtAmt(),"0")));//초.중.고등학교_금액
//				scxpsStdDdcAmt.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getscxpsStdDdcAmt(),"0")));//초.중.고등학교(공제)
//				
//				scxpsUndCount.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getscxpsUndCount(),"0")));//대학원(대학원불포함)_수
//				scxpsUndDdcTrgtAmt.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getscxpsUndDdcTrgtAmt(),"0")));//대학원(대학원불포함)_금액
//				scxpsUndDdcAmt.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getscxpsUndDdcAmt(),"0")));//대학원(대학원불포함)(공제)
//				
//				scxpsDsbrUseAmt.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getscxpsDsbrUseAmt(),"0")));//특수교육비_장애인
//				scxpsDsbrDdcTrgtAmt.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getscxpsDsbrDdcTrgtAmt(),"0")));//공제대상계_장애인
//				scxpsDsbrDdcAmt.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getscxpsDsbrDdcAmt(),"0")));//세액공제_장애인
//				
//				scxpsUseAmtSum.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getscxpsUseAmtSum(),"0")));//교육비금액계
//				scxpsDdcTrgtAmtSum.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getscxpsDdcTrgtAmtSum(),"0")));//공제대상계_교육비금액계
//				scxpsDdcAmtSum.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getscxpsDdcAmtSum(),"0")));//세액공제계_교육비금액계
//				
//				reloadYeta3150Grid();
//				
//			}
...
//			if (MSFSharedUtils.paramNotNull(Yeta3300ToYe161010GridPanel.getCurrentlySelectedItem())){	
//				
//				conb10ttswLtUseAmt.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getconb10ttswLtUseAmt(),"0")));//정지차금(10만원이하)_기부금액
//				conb10ttswLtDdcTrgtAmt.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getconb10ttswLtDdcTrgtAmt(),"0")));//정지차금(10만원이하)_공제대상금액
//				conb10ttswLtDdcAmt.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getconb10ttswLtDdcAmt(),"0")));//정지차금(10만원이하)_공제세액
//				
//				conb10excsLtUseAmt.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getconb10excsLtUseAmt(),"0")));//정지차금(10만원초과)_기부금액
//				conb10excsLtDdcTrgtAmt.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getconb10excsLtDdcTrgtAmt(),"0")));//정지차금(10만원초과)_공제대상금액
//				conb10excsLtDdcAmt.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getconb10excsLtDdcAmt(),"0")));//정지차금(10만원초과)_공제세액
//				
//				conbLglUseAmt.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getconbLglUseAmt(),"0")));//전액공제기부금액(법정)_기부금액
//				conbLglDdcTrgtAmt.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getconbLglDdcTrgtAmt(),"0")));//전액공제기부금액(법정)_공제대상금액
//				conbLglDdcAmt.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getconbLglDdcAmt(),"0")));//전액공제기부금액(법정)_공제세액
//				
...
//				
//				conbEmstAsctUseAmt.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getconbEmstAsctUseAmt(),"0")));//우리사주조합기부금_기부금액
//				conbEmstAsctDdcTrgtAmt.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getconbEmstAsctDdcTrgtAmt(),"0")));//우리사주조합기부금_공제대상금액
//				conbEmstAsctDdcAmt.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getconbEmstAsctDdcAmt(),"0")));//우리사주조합기부금_공제세액
//				
//				conbReliOrgOthUseAmt.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getconbReliOrgOthUseAmt(),"0")));//종교단체외지정기부금_기부금액
//				conbReliOrgOthDdcTrgtAmt.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getconbReliOrgOthDdcTrgtAmt(),"0")));//종교단체외지정기부금_공제대상금액
//				conbReliOrgOthDdcAmt.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getconbReliOrgOthDdcAmt(),"0")));//종교단체외지정기부금_공제세액
//				
//				conbReliOrgUseAmt.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getconbReliOrgUseAmt(),"0")));//종교단체지정기부금_기부금액
//				conbReliOrgDdcTrgtAmt.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getconbReliOrgDdcTrgtAmt(),"0")));//종교단체지정기부금_기부금액_공제대상금액
//				conbReliOrgDdcAmt.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getconbReliOrgDdcAmt(),"0")));//종교단체지정기부금_기부금액_공제세액
//				
//				conbUseAmtSum.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getconbUseAmtSum(),"0")));//기부금액계
//				conbDdcTrgtAmtSum.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getconbDdcTrgtAmtSum(),"0")));//공제대상계_기부금액계
//				conbDdcAmtSum.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getconbDdcAmtSum(),"0")));//세액공제계_기부금액계
//				
...
//			if (MSFSharedUtils.paramNotNull(Yeta3300ToYe161010GridPanel.getCurrentlySelectedItem())){	
//				
//				//YetaUtils.setCheckedCheckBoxValue(frgrLbrrEntcPupCd, MSFSharedUtils.allowNulls((String) result.get("frgrLbrrEntcPupCd")));//입국목적
//				
//				
//				YetaUtils.setCheckedCheckBoxValue(frgrLbrrEntcPupCd1, result.getfrgrLbrrEntcPupCd1());
//				YetaUtils.setCheckedCheckBoxValue(frgrLbrrEntcPupCd2, result.getfrgrLbrrEntcPupCd2());
//				YetaUtils.setCheckedCheckBoxValue(frgrLbrrEntcPupCd3, result.getfrgrLbrrEntcPupCd3());
//				YetaUtils.setCheckedCheckBoxValue(frgrLbrrEntcPupCd4, result.getfrgrLbrrEntcPupCd4());
//				
//				frgrLbrrLbrOfrDt.setValue(GWTUtils.getDateFromString(result.getfrgrLbrrLbrOfrDt(), "yyyyMMdd"));//기술도입계약 또는 근로제공일
//				frgrLbrrReExryDt.setValue(GWTUtils.getDateFromString(result.getfrgrLbrrReExryDt(), "yyyyMMdd"));//감면기간 만료일
//				frgrLbrrReRcpnDt.setValue(GWTUtils.getDateFromString(result.getfrgrLbrrReRcpnDt(), "yyyyMMdd"));//외국인근로소득에 대한 감면 신청서 접수일자
//				frgrLbrrReAlfaSbmsDt.setValue(GWTUtils.getDateFromString(result.getfrgrLbrrReAlfaSbmsDt(), "yyyyMMdd"));//제출일자_외국인근로소득에 대한 감면 신청서 접수일자
...
//				frgrLbrrErinImnRcpnDt.setValue(GWTUtils.getDateFromString(result.getfrgrLbrrErinImnRcpnDt(), "yyyyMMdd"));//근로소득에 대한 조세조약상 면제 접수일자
//				frgrLbrrErinImnSbmsDt.setValue(GWTUtils.getDateFromString(result.getfrgrLbrrErinImnSbmsDt(), "yyyyMMdd"));//제출일자_근로소득에 대한 조세조약상 면제 접수일자
//				
//				yupSnmcReStrtDt.setValue(GWTUtils.getDateFromString(result.getyupSnmcReStrtDt(), "yyyyMMdd"));//중소기업 취업 청년감면 취업일자
//				yupSnmcReEndDt.setValue(GWTUtils.getDateFromString(result.getyupSnmcReEndDt(), "yyyyMMdd"));//감면기간 종료일_중소기업 취업 청년감면 취업일자
//				
...
//			
//				ovrsSurcIncFmt.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getovrsSurcIncFmt(),"0")));//국외원천소득
//				frgnPmtFcTxamt.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getfrgnPmtFcTxamt(),"0")));//납세액(외화)
//				frgnPmtWcTxamt.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getfrgnPmtWcTxamt(),"0")));//납세액(원화)
//				frgnPmtTxamtTxpNtnNm.setValue(MSFSharedUtils.allowNulls(result.getfrgnPmtTxamtTxpNtnNm()));//납세국명
//				frgnPmtTxamtPmtDt.setValue(GWTUtils.getDateFromString(result.getfrgnPmtTxamtPmtDt(), "yyyyMMdd"));//납부일
//				frgnPmtTxamtAlfaSbmsDt.setValue(GWTUtils.getDateFromString(result.getfrgnPmtTxamtAlfaSbmsDt(), "yyyyMMdd"));//신청서제출일
//				frgnPmtTxamtTxpNtnNm.setValue(MSFSharedUtils.allowNulls(result.getfrgnPmtTxamtTxpNtnNm()));//국외근무처
//				frgnPmtTxamtRfoNm.setValue(MSFSharedUtils.allowNulls(result.getfrgnPmtTxamtRfoNm()));//직책
//				frgnDtyTermStdt.setValue(GWTUtils.getDateFromString(result.getfrgnDtyTermStdt(), "yyyyMMdd"));//근무기간_시작_외국납부세액공제
//				frgnDtyTermEddt.setValue(GWTUtils.getDateFromString(result.getfrgnDtyTermEddt(), "yyyyMMdd"));//근무기간_종료_외국납부세액공제
//				
...
//				hsngTennLnpbUseAmt.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.gethsngTennLnpbUseAmt(),"0")));//주택자금차입금이자세액공제 이자상환
//				hsngTennLnpbDdcAmt.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.gethsngTennLnpbDdcAmt(),"0")));//주택자금차입금이자세액공제 공제액
//				
//			}
//			
...
//			if (MSFSharedUtils.paramNotNull(Yeta3300ToYe161010GridPanel.getCurrentlySelectedItem())){	
//				
//				YetaUtils.setCheckedRadioValue(d219, MSFSharedUtils.allowNulls(result.getd219()));		//1.외국인근로자 단일세율적용신청서 제출여부
//				YetaUtils.setCheckedRadioValue(cd225, MSFSharedUtils.allowNulls(result.getcd225()));		//2.연금, 저축 등 소득공제 명세서 제출여부
//				YetaUtils.setCheckedRadioValue(cd226, MSFSharedUtils.allowNulls(result.getcd226()));		//3.월세액.비거주자간 주택임차차입금 원리금 상환액 소득공제 증명서 제출여부
//				
//				YetaUtils.setCheckedRadioValue(cd227, MSFSharedUtils.allowNulls(result.getcd227()));		//의료비지급명세서
//				YetaUtils.setCheckedRadioValue(cd228, MSFSharedUtils.allowNulls(result.getcd228()));		//기부금명세서
//				YetaUtils.setCheckedRadioValue(prcspWorkIncmSumtYn, MSFSharedUtils.allowNulls(result.getprcspWorkIncmSumtYn()));		//소득공제 증빙서류
//				
//				YetaUtils.setCheckedRadioValue(fileAppPaprSbtYn, MSFSharedUtils.allowNulls(result.getfileAppPaprSbtYn()));		//소득공제신고서제출여부
//				incmDducWtnnteSumtDt.setValue(GWTUtils.getDateFromString(result.getincmDducWtnnteSumtDt(), "yyyyMMdd"));	//제출일자_소득공제신고서제출여부
//			}
	...
	/** 대상자에 따른 정보 가져옴 **/
	private void Yeta3300ToYe161010Detail(BaseModel selRecord, String tabId) {
	...
	private void getItemYeta01() {
		...
		yeta3300Service.getYeta3300ToYe161020Data(ye161020Dto, new AsyncCallback<Ye161020DTO>(){

			@Override
			public void onFailure(Throwable caught) {
				// TODO Auto-generated method stub
				MessageBox.alert(MSFMainApp.MSFCONSTANTS.ExceptionTitleService(), 
                        MSFMainApp.ADMINMESSAGES.ExceptionMessageService("getYeta3300ToYe161020Data(" + actionDatabase.name() + ") : " + caught), null);
	...
	private void getItemYeta02() {
		...
		yeta3300Service.getYeta3300TabItem02ToYe161020Data(ye161020Dto, new AsyncCallback<Ye161020DTO>(){

			@Override
			public void onFailure(Throwable caught) {
				// TODO Auto-generated method stub
				MessageBox.alert(MSFMainApp.MSFCONSTANTS.ExceptionTitleService(), 
                        MSFMainApp.ADMINMESSAGES.ExceptionMessageService("saveYeta3300ToYe161020tabItem02(" + actionDatabase.name() + ") : " + caught), null);
	...
	private void getItemYeta04() {
		...
		yeta3300Service.getYeta3300TabItem04ToYe161055Data(ye161055Dto, new AsyncCallback<Ye161055DTO>(){

			@Override
			public void onFailure(Throwable caught) {
				// TODO Auto-generated method stub
				MessageBox.alert(MSFMainApp.MSFCONSTANTS.ExceptionTitleService(), 
                        MSFMainApp.ADMINMESSAGES.ExceptionMessageService("getYeta3300TabItem04ToYe161055Data(" + actionDatabase.name() + ") : " + caught), null);
	...
	private void getItemYeta05() {
		...
		yeta3300Service.getYeta3300TabItem05ToYe161060Data(ye161060Dto, new AsyncCallback<Ye161060DTO>(){
	...
	private void getItemYeta06() {
		...
		yeta3300Service.getYeta3300TabItem06ToYe161070Data(ye161070Dto, new AsyncCallback<Ye161070DTO>(){
...
//				cpiv14AsctUseAmt.setValue(result.getCpiv14AsctUseAmt());				// 출자투자금액_조합등_2014납입금액  
//				cpiv14AsctDdcAmt.setValue(result.getCpiv14AsctDdcAmt());				// 출자투자금액_조합등_2014공제액 
//				
//				cpiv14VntUseAmt.setValue(result.getCpiv14VntUseAmt());   				// 출자투자금액_벤처등_2014납입금액 
//				cpiv14VntDdcAmt.setValue(result.getCpiv14VntDdcAmt());   				// 출자투자금액_벤처등_2014공제액

/*				cpiv15AsctUseAmt.setValue(result.getCpiv15AsctUseAmt());				// 출자투자금액_조합등_2015납입금액
				cpiv15AsctDdcAmt.setValue(result.getCpiv15AsctDdcAmt());				// 출자투자금액_조합등_2015공제액

				cpiv15VntUseAmt.setValue(result.getCpiv15VntUseAmt());   				// 출자투자금액_벤처등_2015납입금액
				cpiv15VntDdcAmt.setValue(result.getCpiv15VntDdcAmt());   				// 출자투자금액_벤처등_2015공제액
*/
				cpiv16AsctUseAmt.setValue(result.getCpiv16AsctUseAmt());   				// 출자투자금액_조합등_2016납입금
				cpiv16AsctDdcAmt.setValue(result.getCpiv16AsctDdcAmt());   				// 출자투자금액 조합등_2016공제액

				cpiv16VntUseAmt.setValue(result.getCpiv16VntUseAmt());   				// 출자투자금액벤처등_2016납입금액
				cpiv16VntDdcAmt.setValue(result.getCpiv16VntDdcAmt());   				// 출자투자금액벤처등_2016공제액

				cpiv17AsctUseAmt.setValue(result.getCpiv17AsctUseAmt());   				// 출자투자금액_조합등_2018납입금
				cpiv17AsctDdcAmt.setValue(result.getCpiv17AsctDdcAmt());   				// 출자투자금액 조합등_2018공제액

				cpiv17VntUseAmt.setValue(result.getCpiv17VntUseAmt());   				// 출자투자금액벤처등_2018납입금액
				cpiv17VntDdcAmt.setValue(result.getCpiv17VntDdcAmt());   				// 출자투자금액벤처등_2018공제액 

				cpiv18AsctUseAmt.setValue(result.getCpiv18AsctUseAmt());   				// 출자투자금액_조합등_2019납입금
				cpiv18AsctDdcAmt.setValue(result.getCpiv18AsctDdcAmt());   				// 출자투자금액 조합등_2019공제액

				cpiv18VntUseAmt.setValue(result.getCpiv18VntUseAmt());   				// 출자투자금액벤처등_2019납입금액
				cpiv18VntDdcAmt.setValue(result.getCpiv18VntDdcAmt());   				// 출자투자금액벤처등_2019공제액 
				...
				drtpCardUseAmt.setValue(result.getDrtpCardUseAmt());					// 기타공제_직불카드등사용금액
...
//				tyShfyPrsAddDdcrtUseAmt.setValue(result.getTyShfyPrsAddDdcrtUseAmt());  // 본인추가공제율사용분_2016_상반기 
	...
	private void getItemYeta08() {
		...
		yeta3300Service.getYeta3300TabItem08ToYe161080Data(ye161080Dto, new AsyncCallback<Ye161080DTO>(){
...
//				reloadYe161090Grid();
	...
	private void getItemYeta09() {
		...
		yeta3300Service.getYeta3300TabItem09ToYe161080Data(ye161080Dto, new AsyncCallback<Ye161080DTO>(){
...
//				    	
	...
	private void getItemYeta10() {
		...
		yeta3300Service.getYeta3300TabItem10ToYe161080Data(ye161080Dto, new AsyncCallback<Ye161080DTO>(){
	...
	private void reloadYe169010(){
		...
		Yeta3300ToYe169010GridPanel.getTableDef().setTableColumnFilters(filters);
		
		Yeta3300ToYe169010GridPanel.getTableDef().addColumnFilter("dpobCd", MSFSharedUtils.allowNulls(dpobCd.getValue()), SimpleColumnFilter.OPERATOR_EQUALS);
		Yeta3300ToYe169010GridPanel.getTableDef().addColumnFilter("systemkey", MSFSharedUtils.allowNulls(systemkey.getValue()), SimpleColumnFilter.OPERATOR_EQUALS);
		Yeta3300ToYe169010GridPanel.getTableDef().addColumnFilter("clutSeptCd", MSFSharedUtils.allowNulls(clutSeptCd.getValue()), SimpleColumnFilter.OPERATOR_EQUALS); 
		Yeta3300ToYe169010GridPanel.getTableDef().addColumnFilter("yrtxBlggYr", MSFSharedUtils.allowNulls(yrtxBlggYr.getValue()), SimpleColumnFilter.OPERATOR_EQUALS); 
		Yeta3300ToYe169010GridPanel.getTableDef().addColumnFilter("c152StdTxDdcYn", c152StdTxDdcYn.getValue()?"Y" : "N", SimpleColumnFilter.OPERATOR_EQUALS); 
			
		Yeta3300ToYe169010GridPanel.reload();
	...
	private void reloadYe161030(){
		...
		Yeta3300ToYe161030GridPanel.getTableDef().setTableColumnFilters(filters);
		
		Yeta3300ToYe161030GridPanel.getTableDef().addColumnFilter("dpobCd", MSFSharedUtils.allowNulls(dpobCd.getValue()), SimpleColumnFilter.OPERATOR_EQUALS);
		Yeta3300ToYe161030GridPanel.getTableDef().addColumnFilter("systemkey", MSFSharedUtils.allowNulls(systemkey.getValue()), SimpleColumnFilter.OPERATOR_EQUALS);
		Yeta3300ToYe161030GridPanel.getTableDef().addColumnFilter("clutSeptCd", MSFSharedUtils.allowNulls(clutSeptCd.getValue()), SimpleColumnFilter.OPERATOR_EQUALS); 
		Yeta3300ToYe161030GridPanel.getTableDef().addColumnFilter("yrtxBlggYr", MSFSharedUtils.allowNulls(yrtxBlggYr.getValue()), SimpleColumnFilter.OPERATOR_EQUALS); 
			
		Yeta3300ToYe161030GridPanel.reload();
	...
	private void reloadYe161040_item03Grid(){
		...
		Yeta3300ToYe161040GridPanel_01.getTableDef().setTableColumnFilters(filters);
		
		Yeta3300ToYe161040GridPanel_01.getTableDef().addColumnFilter("dpobCd"		, MSFSharedUtils.allowNulls(dpobCd.getValue()), SimpleColumnFilter.OPERATOR_EQUALS);
		Yeta3300ToYe161040GridPanel_01.getTableDef().addColumnFilter("systemkey"	, MSFSharedUtils.allowNulls(systemkey.getValue()), SimpleColumnFilter.OPERATOR_EQUALS);
		Yeta3300ToYe161040GridPanel_01.getTableDef().addColumnFilter("clutSeptCd"	, MSFSharedUtils.allowNulls(clutSeptCd.getValue()), SimpleColumnFilter.OPERATOR_EQUALS); 
		Yeta3300ToYe161040GridPanel_01.getTableDef().addColumnFilter("yrtxBlggYr"	, MSFSharedUtils.allowNulls(yrtxBlggYr.getValue()), SimpleColumnFilter.OPERATOR_EQUALS); 
		Yeta3300ToYe161040GridPanel_01.getTableDef().addColumnFilter("cdVvalKrnCd"	, "Y0140000", SimpleColumnFilter.OPERATOR_EQUALS); 
			
		Yeta3300ToYe161040GridPanel_01.reload();
		
		Yeta3300ToYe161040GridPanel_02.getTableDef().setTableColumnFilters(filters);
		
		Yeta3300ToYe161040GridPanel_02.getTableDef().addColumnFilter("dpobCd"		, MSFSharedUtils.allowNulls(dpobCd.getValue()), SimpleColumnFilter.OPERATOR_EQUALS);
		Yeta3300ToYe161040GridPanel_02.getTableDef().addColumnFilter("systemkey"	, MSFSharedUtils.allowNulls(systemkey.getValue()), SimpleColumnFilter.OPERATOR_EQUALS);
		Yeta3300ToYe161040GridPanel_02.getTableDef().addColumnFilter("clutSeptCd"	, MSFSharedUtils.allowNulls(clutSeptCd.getValue()), SimpleColumnFilter.OPERATOR_EQUALS); 
		Yeta3300ToYe161040GridPanel_02.getTableDef().addColumnFilter("yrtxBlggYr"	, MSFSharedUtils.allowNulls(yrtxBlggYr.getValue()), SimpleColumnFilter.OPERATOR_EQUALS); 
		Yeta3300ToYe161040GridPanel_02.getTableDef().addColumnFilter("cdVvalKrnCd"	, "Y0140001", SimpleColumnFilter.OPERATOR_EQUALS); 
			
		Yeta3300ToYe161040GridPanel_02.reload();
...
//		IColumnFilter filters = null;
//		
//		Yeta3300ToYe161090GridPanel.getTableDef().setTableColumnFilters(filters);
//			
//		Yeta3300ToYe161090GridPanel.getTableDef().addColumnFilter("dpobCd", MSFSharedUtils.allowNulls(dpobCd.getValue()), SimpleColumnFilter.OPERATOR_EQUALS);
//		Yeta3300ToYe161090GridPanel.getTableDef().addColumnFilter("systemkey", MSFSharedUtils.allowNulls(systemkey.getValue()), SimpleColumnFilter.OPERATOR_EQUALS); 
//		Yeta3300ToYe161090GridPanel.getTableDef().addColumnFilter("clutSeptCd", MSFSharedUtils.allowNulls(clutSeptCd.getValue()), SimpleColumnFilter.OPERATOR_EQUALS); 
//		Yeta3300ToYe161090GridPanel.getTableDef().addColumnFilter("yrtxBlggYr", MSFSharedUtils.allowNulls(yrtxBlggYr.getValue()), SimpleColumnFilter.OPERATOR_EQUALS); 
//			
//		Yeta3300ToYe161090GridPanel.reload();
//		
//	}
	...
	public void resetYeta300ToYeta2000Grid() {
		Yeta3300ToYe161010GridPanel.getMsfGrid().clearData();
	}
	...
	public void resetItemYeta02() {
		...
		Yeta3300ToYe161030GridPanel.getMsfGrid().clearData();
	...
	public void resetItemYeta03() {
		...
		//	{소득공제}
		Yeta3300ToYe161040GridPanel_01.getMsfGrid().clearData();
		Yeta3300ToYe161040GridPanel_02.getMsfGrid().clearData();
...
*/
		cpiv16AsctUseAmt.clear();   							// 출자투자금액_조합등_2016납입금
		cpiv16AsctDdcAmt.clear();   							// 출자투자금액 조합등_2016공제액

		cpiv16VntUseAmt.clear();   								// 출자투자금액벤처등_2016납입금액
		cpiv16VntDdcAmt.clear();   								// 출자투자금액벤처등_2016공제액
		...
		cpiv18AsctUseAmt.clear();   							// 출자투자금액_조합등_2018납입금
		cpiv18AsctDdcAmt.clear();   							// 출자투자금액 조합등_2018공제액

		cpiv18VntUseAmt.clear();   								// 출자투자금액벤처등_2018납입금액
		cpiv18VntDdcAmt.clear();   								// 출자투자금액벤처등_2018공제액
...
//		cpiv16VntDdcAmt.clear();   								// 출자투자금액벤처등_2016공제액
//
//		cpiv17AsctUseAmt.clear();   							// 출자투자금액_조합등_2018납입금
//		cpiv17AsctDdcAmt.clear();   							// 출자투자금액 조합등_2018공제액
//
//		cpiv17VntUseAmt.clear();   								// 출자투자금액벤처등_2018납입금액
//		cpiv17VntDdcAmt.clear();   								// 출자투자금액벤처등_2018공제액 
//
//		ivcpInvmUseAmtSum.clear();								// 투자조합출자등소득공제납입금액계
//		ivcpInvmDdcAmtSum.clear();								// 투자조합출자등소득공제공제액계
//
...
//		conb10excsLtDdcAmt.clear();								// 기부정치자금_10초과	  공제세액
//
//		conbLglUseAmt.clear();									// 법정 금액	 
//		conbLglDdcTrgtAmt.clear();								// 법정 대상금액	
//		conbLglDdcAmt.clear();									// 법정 공제세액
//
//		conbEmstAsctUseAmt.clear();								// 우리사주조합 	
//		conbEmstAsctDdcTrgtAmt.clear();							// 우리사주종합 대상금액	
//		conbEmstAsctDdcAmt.clear();								// 우리사주조합 공제세액	
//
//		conbReliOrgOthUseAmt.clear();							// 지정기부금종교단체외기부금액	
//		conbReliOrgOthDdcTrgtAmt.clear();						// 지정기부금종교단체외공제대상금액	
//		conbReliOrgOthDdcAmt.clear();							// 지정기부금종교단체외공제세액	
//
//		conbReliOrgUseAmt.clear();								// 지정기부금종교단체기부금액
//		conbReliOrgDdcTrgtAmt.clear();							// 지정기부금종교단체공제대상금액	
//		conbReliOrgDdcAmt.clear();								// 지정기부금종교단체공제세액
//
//		conbUseAmtSum.clear();									// 기부금납입금액합계	
//		conbDdcTrgtAmtSum.clear();								// 기부금공제대상금액합계	
//		conbDdcAmtSum.clear();									// 기부금공제세액합계
//
//		spciObam.clear();	//이월법정기부금액
//		spciOyam.clear();	//이월종교단체기부금
//		spciOnam.clear();	//이월종교단체외기부금
//
//		spciObam01.clear();	//이월법정기부금액_공제액
//		spciOyam01.clear();	//이월종교단체기부금_공제액
//		spciOnam01.clear();	//이월종교단체외기부금_공제액
//
//		spciSsum.clear();	//기부금(이월분)	
//		// -------------- 세액감면및세액공제1 종료 --------------
...
//		yupSnmcReEndDt.reset();									// 세액공제_중소기업청년감면종료일자
//		    	
//		txlgItct.clear();										// 세액감면_소득세법감면세액
//		taxdIcax.clear();										// 세액감면_소득세법
//
//		txlgBsta.clear();	//세액감면_취업청년감면대상총급여액
//		txlgWkta.clear();	//세액감면_취업청년감면근로자총급여액
//
//		txlgClta.clear();	//세액감면_계산감면세액금액
//		taxdTsum.clear();	//세액감면_감면세액계
//
//		txlgFrta.clear();	//세액감면_외국인기술자감면세액
//		taxdRedu.clear();	//세액공제_외국인감면세액
//
//		txlgTxty.clear();	//세액감면_조세조약감면세액
//		txlgHxtt.clear();	//세액감면_조세조약
//		    	
//		ovrsSurcIncFmt.clear();									// 세액공제_외국납부_국외원천소득금액
//		frgnPmtFcTxamt.clear();									// 세액공제_외국납부_외화납세액
//		frgnPmtWcTxamt.clear();									// 세액공제_외국납부_원화납세액
