...
import com.app.exterms.yearendtax.server.service.yeta2021.dao.Yeta6070_2021_DAO;
...
@Service("Yeta6070Service")
public class Yeta6070ServiceImpl extends AbstractCustomServiceImpl implements YetaDaoConstantsGenerated, Yeta6070Service {

	private static final Logger logger = LoggerFactory.getLogger(Yeta6070ServiceImpl.class);
	private static final String calledClass = Yeta6070ServiceImpl.class.getName();

	@Autowired
	@Resource(name = "Yeta6070_2021_DAO")
	private Yeta6070_2021_DAO yeta6070DAO;
	...
	public PagingLoadResult<BaseModel> getSelectYeta6070ToBass0120List(ServiceParameters serviceParameters) throws MSFException {
        ...
        Yeta2070Srh_2021_VO   Yeta2070SrhVO = new Yeta2070Srh_2021_VO();
        //Yeta2070VO      Yeta2070Vo = new Yeta2070VO();
        List<BaseModel>  bmResult = new ArrayList<BaseModel>();
        MSFSysm0100BM sessionUser = MSFServerUtils.getLoggedUser(RemoteServiceUtil.getThreadLocalRequest());
        
        if(MSFSharedUtils.paramNull(yeta6070DAO)){
        	WebApplicationContext wac = WebApplicationContextUtils.getRequiredWebApplicationContext(getHttpServletRequest().getSession().getServletContext());
        	yeta6070DAO = (Yeta6070_2021_DAO) wac.getBean("Yeta6070_2021_DAO");
        }
        try{
            ...
            if(pagingValues.executeRecordCount){ 
            	...
            	int iResultCnt = yeta6070DAO.selectYeta6070ListTotCnt(Yeta2070SrhVO);
            ...
            List list = yeta6070DAO.selectYeta6070List(Yeta2070SrhVO);
            ...
            SmrmfUtils.endTiming(logger, millisBeginSelectYeta2070List, "selectYeta6070List");
