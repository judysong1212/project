...
import com.app.exterms.yearendtax.client.service.yeta2020.YetaT53013Service;
import com.app.exterms.yearendtax.client.service.yeta2020.YetaT53013ServiceAsync;
...
=====================================================**/
public  class YetaT53013   extends MSFFormPanel {  
 ...
 **/
	...
	private  ContentPanel cpYetaT53013; 
	...
	// -------------- grid 선언 시작  ---------------	  
	private MSFGridPanel YetaT53013GridPanel;
	private Ye162010Def ye162010Def = new Ye162010Def("YetaT53013");   
	// -------------- grid 선언 종료  ---------------
	...
	// -------------- 서비스 호출 시작 --------------
	private YetaT53013ServiceAsync yetaT53013Service = YetaT53013Service.Util.getInstance();
	// -------------- 서비스 호출 종료 --------------	 
...
//					ye162510Dto.setMnthRnttyHusCnttArea((MSFSharedUtils.allowNulls(bmMapModel.get("mnthRnttyHusCnttArea"))));    		/** column 월세주택계약면적 : mnthRnttyHusCnttArea */
				...
				yetaT53013Service.activityOnYetaT53013(listYe162510Dto, actionDatabase, new AsyncCallback<Long>(){
...
//		 }
	...
	public YetaT53013(final ActionDatabase actionDatabase, final MSFPanel caller) {
...
//		initLoad(); 	
		...
		this.actionDatabase = actionDatabase;
	 	...
	 	cpYetaT53013 = new ContentPanel();  

		createSearchForm();			//기본정보 필드를 적용
	 	createMsfGridForm();		//그리드필드
		   
	 	cpYetaT53013.setBodyBorder(false);
	 	cpYetaT53013.setBorders(false);
	 	cpYetaT53013.setHeaderVisible(false);
	 	cpYetaT53013.setSize("790px", "640px");
		   
		this.add(cpYetaT53013);
...
//		     });     
		...
		cpYetaT53013.setLayout(new FlowLayout());
...
//	      	     }
//				 
//				YetaT53013GridPanel.getMsfGrid().clearData();
//				 
//				BaseModel bmData = YetaT53013GridPanel.getTableDef().getDefaultValues();  
//		              
...
//		         
//		        YetaT53013GridPanel.getMsfGrid().getGrid().stopEditing();      
//		        YetaT53013GridPanel.getMsfGrid().getGrid().getStore().insert(bmData,0);   
//		        YetaT53013GridPanel.getMsfGrid().getGrid().startEditing(YetaT53013GridPanel.getMsfGrid().getGrid().getStore().indexOf(bmData), 0);   
//
...
//			public void handleEvent(ButtonEvent e) {
//				Iterator<BaseModel> itBm = YetaT53013GridPanel.getMsfGrid().getGrid().getSelectionModel().getSelectedItems().listIterator();
...
//			public void handleEvent(ButtonEvent e) {
//				setListRecord(YetaT53013GridPanel.getMsfGrid().getStore().getModifiedRecords().iterator());
//				doAction(actionDatabase);
//
//				if ((ActionDatabase.INSERT).equals(actionDatabase)) {
//					actionDatabase = ActionDatabase.INSERT;
...
//		cpYetaT53013.add(topYetaBtnBar);
...
//		cpYetaT53013.add(topYetaBtnBar);
		...
		YetaT53013GridPanel = new MSFGridPanel(ye162010Def, false, false, false, false, false);
		YetaT53013GridPanel.setSize("790px", "200px");
		YetaT53013GridPanel.setBorders(true);
		YetaT53013GridPanel.setHeaderVisible(false);
...
//		
//		YetaT53013GridPanel.getGrid().getColumnModel().addAggregationRow(payrSummaryRow);  
//		
...
//		
//		YetaT53013GridPanel.getGrid().getColumnModel().addAggregationRow(payrSummaryRow1);
//		/** --- 그리드 합계 부분  종료 --- **/
		
//        cpYetaT53013.add(YetaT53013GridPanel);
		...
		fldstNewFieldset.add(YetaT53013GridPanel);
		cpYetaT53013.add(fldstNewFieldset);
		cpYetaT53013.add(layoutContainer10);
		cpYetaT53013.add(fldstNewFieldset_1);
	...
	public void reload() {
			...
			YetaT53013GridPanel.getTableDef().setTableColumnFilters(filters);
			YetaT53013GridPanel.getTableDef().addColumnFilter("yrtxBlggYr", MSFSharedUtils.allowNulls(srhYrtxBlggYr.getValue())
...
//					, SimpleColumnFilter.OPERATOR_EQUALS);//연말정산귀속년도
			YetaT53013GridPanel.getTableDef().addColumnFilter("clutSeptCd", MSFSharedUtils.getSelectedComboValue(srhClutSeptCd,"commCd")
					, SimpleColumnFilter.OPERATOR_EQUALS);//정산구분
			YetaT53013GridPanel.getTableDef().addColumnFilter("systemkey", MSFSharedUtils.allowNulls(systemkey.getValue())
					, SimpleColumnFilter.OPERATOR_EQUALS);//시스템키
		 
			YetaT53013GridPanel.reload();
