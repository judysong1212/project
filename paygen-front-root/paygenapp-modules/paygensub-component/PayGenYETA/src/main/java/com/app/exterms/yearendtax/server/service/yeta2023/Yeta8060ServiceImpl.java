...
import com.app.exterms.yearendtax.server.service.yeta2023.dao.Yeta8060_2023_DAO;
...
@Service("Yeta8060Service")
public class Yeta8060ServiceImpl  extends AbstractCustomServiceImpl implements YetaDaoConstantsGenerated , Yeta8060Service  {

	private static final Logger logger = LoggerFactory.getLogger(Yeta8060ServiceImpl.class);
	private static final String calledClass = Yeta8060ServiceImpl.class.getName();
	
	
	
	@Autowired
	@Resource(name="Yeta8060_2023_DAO")
	private Yeta8060_2023_DAO yeta8060DAO;
	
	@Autowired
	@Resource(name="Ye161005_2023_DAO")
	private Ye161005_2023_DAO ye161005DAO;
	...
	public PagingLoadResult<BaseModel> getSelectYeta8060List(ServiceParameters serviceParameters) throws MSFException {

        PagingLoadResult<BaseModel> retval = null;
        String nResult = null;
        String method =  CLASS_YETA8060_LIST;
        Yeta3060Srh_2023_VO   Yeta3060SrhVO = new Yeta3060Srh_2023_VO();
        //Yeta2060VO      Yeta2060Vo = new Yeta2060VO();
        List<BaseModel>  bmResult = new ArrayList<BaseModel>();
        
        MSFSysm0100BM sessionUser = MSFServerUtils.getLoggedUser(RemoteServiceUtil.getThreadLocalRequest());
        
        if(MSFSharedUtils.paramNull(yeta8060DAO)){
        	WebApplicationContext wac = WebApplicationContextUtils.getRequiredWebApplicationContext( getHttpServletRequest().getSession().getServletContext());
        	yeta8060DAO = (Yeta8060_2023_DAO) wac.getBean("Yeta8060_2023_DAO");
        }
        try{
            ...
            if ( pagingValues.executeRecordCount ) { 
            	...
            	int iResultCnt = yeta8060DAO.selectYeta8060ListTotCnt(Yeta3060SrhVO);
            	
            	SmrmfUtils.endTiming(logger, millisBeginQueryCount, "QueryCount"); 
                pagingValues.totalRecordCount = iResultCnt;	       
                logger.debug("totalRecordCount : " + pagingValues.totalRecordCount);
            }
            TimingInfo millisBeginSelectYeta8060List = SmrmfUtils.startTiming(logger);
            ...
            List list = yeta8060DAO.selectYeta8060List(Yeta3060SrhVO);
            ...
            SmrmfUtils.endTiming(logger, millisBeginSelectYeta8060List, "selectYeta8060List");
	...
	@SuppressWarnings({ "unchecked", "rawtypes" })
	public PagingLoadResult<BaseModel> getSelectYetaM8060List(ServiceParameters serviceParameters) throws MSFException {

        PagingLoadResult<BaseModel> retval = null;
        String method =  CLASS_YETA8060_MLIST;
        Yeta3060Srh_2023_VO   Yeta3060SrhVO = new Yeta3060Srh_2023_VO();
        //Yeta2060VO      Yeta2060Vo = new Yeta2060VO();
        List<BaseModel>  bmResult = new ArrayList<BaseModel>();
        MSFSysm0100BM sessionUser = MSFServerUtils.getLoggedUser(RemoteServiceUtil.getThreadLocalRequest());
...
//                	}
	...
	@SuppressWarnings({ "unchecked", "rawtypes" })
	public PagingLoadResult<BaseModel> getSelectYetaS8060List(ServiceParameters serviceParameters) throws MSFException {
...
//            Yeta3060SrhVO.setMtstBusinDivCd("C0040020");	// 종사업장코드
	...
	@SuppressWarnings({ "unchecked", "rawtypes" })
	public PagingLoadResult<BaseModel> getSelectYetaM806001List(ServiceParameters serviceParameters) throws MSFException {
        ...
        try{
            ...
            if(pagingValues.executeRecordCount){ 
            	TimingInfo millisBeginQueryCount = SmrmfUtils.startTiming(logger);
            	int iResultCnt = yeta8060DAO.selectYetaM806001ListTotCnt(Yeta3060SrhVO);
            ...
            List list = yeta8060DAO.selectYetaM806001List(Yeta3060SrhVO);
            Iterator<Map<String, Object>> iter = list.iterator();
            SmrmfUtils.endTiming(logger, millisBeginQueryMain, "QueryMain");
	...
	@SuppressWarnings({ "unchecked", "rawtypes" })
	public PagingLoadResult<BaseModel> getSelectYetaS806001List(ServiceParameters serviceParameters) throws MSFException {
		...
		try{
			...
			if(pagingValues.executeRecordCount){ 
				TimingInfo millisBeginQueryCount = SmrmfUtils.startTiming(logger);
				int iResultCnt = yeta8060DAO.selectYetaS806001ListTotCnt(Yeta3060SrhVO);
			...
			List list = yeta8060DAO.selectYetaS806001List(Yeta3060SrhVO);
			Iterator<Map<String, Object>> iter = list.iterator();
			SmrmfUtils.endTiming(logger, millisBeginQueryMain, "QueryMain");
	...
	public int chkYeta8060(Yeta8060DTO dto, ActionDatabase actionDatabase)throws MSFException {
		...
		int returnCnt = 0;
		String nResult = AnyCryptUtils.XecureCryptInitialize(RemoteServiceUtil.getThreadLocalConfig(),RemoteServiceUtil.getThreadLocalRequest());
		String method = calledClass + ".saveYeta8060";
		
		String windowNm = "사업장관리";
		String windowId = "Yeta8060";
			...
			switch(actionDatabase){
				case INSERT : 
					...
					if(dto.getMtstBusinDivCd() == "C0030010" || "C0030010".equals(dto.getMtstBusinDivCd())) {
						Yeta3060SrhVo = new Yeta3060Srh_2023_VO();
						Yeta3060SrhVo.setMtstBusinDivCd(dto.getMtstBusinDivCd());
						
						int iCnt = yeta8060DAO.selectYeta8060ListTotCnt(Yeta3060SrhVo);
	...
	public int delChkYeta8060(Yeta8060DTO dto, ActionDatabase actionDatabase)throws MSFException {
		...
		int returnCnt = 0;
		String nResult = AnyCryptUtils.XecureCryptInitialize(RemoteServiceUtil.getThreadLocalConfig(),RemoteServiceUtil.getThreadLocalRequest());
		String method = calledClass + ".delChkYeta8060";
		...
		Ye161010Srh_2023_VO ye161005SrhVo = new Ye161010Srh_2023_VO();
		...
		try {
			...
			int iCnt = ye161010DAO.selectYeta8060ToYe161010ListTotCnt(ye161005SrhVo);
	...
	public String saveYeta8060(Yeta8060DTO dto, ActionDatabase actionDatabase)throws MSFException {
		...
		Ye161005_2023_VO ye161005Vo = new Ye161005_2023_VO();
		...
		try {			
			switch(actionDatabase){
				case INSERT : 
					returnCnt = yeta8060DAO.saveYeta8060(dto);
				...
				case UPDATE : 
					...
					break;
				case DELETE : 
					returnCnt = yeta8060DAO.deleteYeta8060(dto);
	...
	public List<BaseModel> getParentDpobCd() throws MSFException {
		...
		try{
			...
			egovResultDataList = yeta8060DAO.getParentDpobCd();
...
//		MSFLogHistoryUtils.tracerUserActivity(sessionUser, method, calledClass, "S");
	...
	public List<BaseModel> getYeta8060sysDivCdList() throws MSFException {
		...
		String method = calledClass + ".getYeta8060sysDivCdList";
		MSFSysm0100BM sessionUser;
		...
		List egovResultDataList = new ArrayList();
		try{
			egovResultDataList = yeta8060DAO.selectYeta8060sysDivCdList();
...
//		MSFLogHistoryUtils.tracerUserActivity(sessionUser, method, calledClass, "S");
	...
	public List<BaseModel> getSysDpobCd() throws MSFException {
		...
		try{
			...
			egovResultDataList = yeta8060DAO.getSysDpobCd();
...
//		MSFLogHistoryUtils.tracerUserActivity(sessionUser, method, calledClass, "S");
	...
	public int insertYetaS806001(Yeta8060DTO dto, ActionDatabase actionDatabase)throws MSFException {
		...
		String nResult = AnyCryptUtils.XecureCryptInitialize(RemoteServiceUtil.getThreadLocalConfig(),RemoteServiceUtil.getThreadLocalRequest());
		String method = calledClass + ".insertYetaS806001";
		
		String windowNm = "사업장관리";
		String windowId = "Yeta8060";
		
		Yeta3060_2023_VO Yeta8060Vo = new Yeta3060_2023_VO();
		Ye161005_2023_VO ye161005Vo = new Ye161005_2023_VO();
		...
		try {
			...
			Yeta8060Vo.setDpobCd(sessionUser.getDpobCd());
			Yeta8060Vo.setUtDpobCd(MSFSharedUtils.allowNulls(dto.getUtDpobCd()));
			Yeta8060Vo.setHhrkUntDpobCd(MSFSharedUtils.allowNulls(dto.getHhrkUntDpobCd()));
			Yeta8060Vo.setBusoprRgstnNum(MSFSharedUtils.allowNulls(dto.getBusoprRgstnNum()));
			Yeta8060Vo.setBefBusoprRgstnNum(MSFSharedUtils.allowNulls(dto.getBefBusoprRgstnNum()));
			Yeta8060Vo.setMtstBusinDivCd("C0030020");
			Yeta8060Vo.setIsmt(sessionUser.getUsrId());
			Yeta8060Vo.setRevnAddr(RemoteServiceUtil.getThreadLocalRequest().getRemoteHost());
			
			returnCnt = yeta8060DAO.insertYetaS806001(Yeta8060Vo);
	...
	@Override
	public Long Yeta806001_Delete(List<Yeta8060DTO> listYeta8060Dto,ActionDatabase actionDatabase) throws MSFException {
    	
		String method = calledClass + ".Yeta806001_Delete";

		String windowNm = "주(총괄납부)사업장관리";
		String windowId = "YETA806001";
    	...
    	Yeta3060_2023_VO ye3060Vo = new Yeta3060_2023_VO(); // 현근무지급여지급명세
    	Ye161005_2023_VO ye161005Vo = new Ye161005_2023_VO();
	    ...
	    try {
			...
			for (int iCnt = 0; iCnt < listYeta8060Dto.size(); iCnt++) {
		                
				Yeta8060DTO ye3060Dto = new Yeta8060DTO(); // 연말정산대상자기본
				ye3060Dto = listYeta8060Dto.get(iCnt);
				...
				yeta8060DAO.deleteYeta806001(ye3060Vo);
				...
				ye161005DAO.deleteYeta806001ToYe161005(ye161005Vo);
	...
	public Long Yeta806001NumUpdate(List<Yeta8060DTO> listYeta8060Dto,ActionDatabase actionDatabase) throws MSFException {
		String method = calledClass + ".Yeta806001NumUpdate";
	    ...
	    try {
			...
			for (int iCnt = 0; iCnt < listYeta8060Dto.size(); iCnt++) {
				...
				Yeta8060DTO ye4060Dto = new Yeta8060DTO(); // 연말정산대상자기본
				ye4060Dto = listYeta8060Dto.get(iCnt);
				...
				yeta8060DAO.updateNumYetaS806001(ye3060Vo);
	            ...
	            logger.error("EXCEPTION calling Yeta8100ToYe160401_Delete(): "+ex); 
	            
	            /** 에러 로그 **/			
	            MSFLogHistoryUtils.tracerUserExceptionActivity(sessionUser,method,calledClass,"D", ex, windowNm , windowId);
	            
	            retval = 0L;
	            throw MSFServerUtils.getOperationException("Yeta8100ToYe160401_Delete", ex, logger);
	        } 
