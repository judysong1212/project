...
@Service("YetaP03001Service")
public class YetaP03001ServiceImpl  extends AbstractCustomServiceImpl implements YetaP03001Service, YetaDaoConstants {
	...
	private static final Logger logger = LoggerFactory.getLogger(YetaP03001ServiceImpl.class);
	private static final String calledClass = YetaP03001ServiceImpl.class.getName();
	...
	//이월기부금 신규 수정 삭제부
	@Override
	public Long activityOnYetaP03001ToYeta3170(List<Yeta3170DTO> listYeta3170dto, ActionDatabase actionDatabase) throws MSFException {
			...
			String windowId = "YETAP030001";
			
			MSFSysm0100BM sessionUser;
			String method = calledClass + ".activityOnYetaP03001ToYeta3170";
			...
			try {  
				if (MSFSharedUtils.paramNull(yeta3170DAO)) {
					...
					yeta3170DAO = (Yeta3170DAO) wac.getBean("yeta3170DAO" ); 
				}
...
//		        	} 
	...
	//이월기부금 조회
	public PagingLoadResult<BaseModel> getYetaP03001To3170List(ServiceParameters serviceParameters) throws MSFException {
		

		PagingLoadResult<BaseModel> retval = null;
		String method =  CLASS_YETAP03001TOYETA3170_DATA_LIST;
