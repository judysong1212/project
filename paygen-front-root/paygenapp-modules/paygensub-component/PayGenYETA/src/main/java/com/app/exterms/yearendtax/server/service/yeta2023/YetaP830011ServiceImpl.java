...
@Service("YetaP830011Service")
public class YetaP830011ServiceImpl  extends AbstractCustomServiceImpl implements YetaP830011Service  ,YetaDaoConstants {

	 
	private static final Logger logger = LoggerFactory.getLogger(YetaP830011ServiceImpl.class);
	private static final String calledClass = YetaP830011ServiceImpl.class.getName();
	...
	public PagingLoadResult<BaseModel> getYeta8300ToYe161090List(ServiceParameters serviceParameters) throws MSFException {
		...
		String method = CLASS_YETA8300_TO_YE161090_DATA_LIST;
		Ye161090Srh_2023_VO ye161090SrhVo = new Ye161090Srh_2023_VO();
		...
		MSFSysm0100BM sessionUser;
			...
			if  (MSFSharedUtils.paramNull(ye161090DAO)) {
				...
				ye161090DAO = (Ye161090_2023_DAO) wac.getBean("Ye161090_2023_DAO"); 
			}
...
//		      	Yeta4220SrhVo.setHanNm(MSFSharedUtils.allowNulls(MSFServerUtils.getFilterValue(columnFilters, "hanNm")));    //한글성명 
				...
				if ( pagingValues.executeRecordCount ) { 
		        	...
		        	TimingInfo millisBeginQueryCount = SmrmfUtils.startTiming(logger);
		          	...
		          	int iResultCnt = ye161090DAO.selectYeta8300ToYe161090ListTotCnt(ye161090SrhVo);  
...
////		            Collection<Map<String, Object>> list ??????
		     	List list = ye161090DAO.selectYeta8300ToYe161090List(ye161090SrhVo);
