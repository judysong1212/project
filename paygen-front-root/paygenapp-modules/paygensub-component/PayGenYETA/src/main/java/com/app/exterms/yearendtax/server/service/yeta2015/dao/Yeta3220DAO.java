...
@Repository("Yeta3220DAO")
public class Yeta3220DAO extends EgovAbstractDAO implements IsSerializable {
    ...
    public List selectYeta0300To3220List(Yeta3220SrhVO Yeta2000SrhVo) throws Exception {
        return list("yeta3220DAO.selectYeta0300To3220List", Yeta2000SrhVo);
    }
    ...
    public List selectYeta0300To3220SumList(Yeta3220SrhVO Yeta2000SrhVo) throws Exception {
        return list("yeta3220DAO.selectYeta0300To3220SumList", Yeta2000SrhVo);
    }
    ...
    public int selectYeta0300To3220SumListTotCnt(Yeta3220SrhVO Yeta2000SrhVo) {
        return (Integer)getSqlMapClientTemplate().queryForObject("yeta3220DAO.selectYeta0300To3220SumListTotCnt_S", Yeta2000SrhVo);
    }
    ...
    public int selectYeta0300To3220ListTotCnt(Yeta3220SrhVO Yeta2000SrhVo) {
        return (Integer)getSqlMapClientTemplate().queryForObject("yeta3220DAO.selectYeta0300To3220ListTotCnt_S", Yeta2000SrhVo);
    }
    ...
    public String insertYeta0300ToYeta3220(Yeta3220VO vo) throws Exception {
        return (String)insert("yeta3220DAO.insertYeta3220_S", vo);
    }
    ...
    public void updateYeta0300ToYeta3220(Yeta3220VO vo) throws Exception {
        update("yeta3220DAO.updateYeta0300ToYeta3220_01_S", vo);
    }
    ...
    public void updateYeta0300ToYeta3220_01(Yeta3220VO vo) throws Exception {
        update("yeta3220DAO.updateYeta3220_01", vo);
    }
    ...
    public void updateYeta0300ToYeta3220_02(Yeta3220VO vo) throws Exception {
        update("yeta3220DAO.updateYeta3220_02", vo);
    }
    ...
    public void deleteYeta0300ToYeta3220(Yeta3220VO vo) throws Exception {
        delete("yeta3220DAO.deleteYeta3220_S", vo);
    }
    ...
    public void updateYeta3220(Yeta3220VO vo) throws Exception {
        update("yeta3220DAO.updateYeta3220_S", vo);
    }
    ...
    public void fnPayr06430_PAYR410_CREATE_Delete(Yeta3220VO vo) throws Exception {
        delete("yeta3220DAO.fnPayr06430_PAYR410_CREATE_Delete_S", vo);
    } 
    ...
    public Yeta3220VO selectYeta3220(Yeta3220VO vo) throws Exception {
        return (Yeta3220VO) selectByPk("yeta3220DAO.selectYeta3220_S", vo);
    }
    ...
    public List<?> selectYeta3220List(Yeta3220SrhVO searchVO) throws Exception {
        return list("yeta3220DAO.selectYeta3220List_D", searchVO);
    }
    ...
    public int selectYeta3220ListTotCnt(Yeta3220SrhVO searchVO) {
        return (Integer)getSqlMapClientTemplate().queryForObject("yeta3220DAO.selectYeta3220ListTotCnt_S", searchVO);
    }
