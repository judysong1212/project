...
//    private YetaConstants yetaLabel = YetaConstants.INSTANCE;
	...
	public Ye164010Def(String chkPayrDef) {
		...
		if ("YetaP83002".equals(chkPayrDef)) {
			setDaoClass("");
			 setCustomListMethod(CLASS_YETAP83002_TO_YE164010_DATA_LIST);
			setAutoFillGrid(false);
			setShowFilterToolbar(false);
			setCheckBoxOnGridRows(true);
			setEditableGrid(true);
			setEditFieldGrid(true);
			setColumnsDefinition(getYetaP83002ToYe164010ColumnsList());
		} else {
			setDaoClass("");
    ...
    private List<ColumnDef> getYetaP83002ToYe164010ColumnsList(){
