...
* </pre>
 */
@Service("Yeta3500Service")
public class Yeta3500ServiceImpl  extends AbstractCustomServiceImpl implements Yeta3500Service  ,YetaDaoConstants {

 
	  private static final Logger logger = LoggerFactory.getLogger(Yeta3500ServiceImpl.class);
	  private static final String calledClass = Yeta3500ServiceImpl.class.getName();
	...
	//연말정산신고내역 조회
	public PagingLoadResult<BaseModel> getYeta35000List(ServiceParameters serviceParameters) throws MSFException {
		

		PagingLoadResult<BaseModel> retval = null;
		String method =  CLASS_YETA2500LIST;
		...
		ye161010DAO = (Ye161010_2018_DAO)BeanFinder.getBean("Ye161010_2018_DAO");
...
//	            Collection<Map<String, Object>> list ??????
	...
	public Long activityOnYeta3500List(List<Ye161010DTO> listYe161010dto) throws MSFException {
		...
		try {  
			...
			logger.error("EXCEPTION calling activityOnYeta2500List(): "+ex); 
			
			/** 에러 로그 **/			
			MSFLogHistoryUtils.tracerUserExceptionActivity(sessionUser,method,calledClass,"U",ex, windowNm , windowId);
			            
			result = new Long(0);
			throw MSFServerUtils.getOperationException("activityOnYeta2500List", ex, logger);
		}
		finally {
	...
	public Long saveYeta3500Grid(List<Ye161010DTO> listYe161010dto) throws MSFException {
		...
		String method = calledClass + ".saveYeta2500Grid";
		...
		try {  
			...
			logger.error("EXCEPTION calling saveYeta2500Ye161010(): "+ex); 
			
			/** 에러 로그 **/			
			MSFLogHistoryUtils.tracerUserExceptionActivity(sessionUser,method,calledClass,"U",ex, windowNm , windowId);
			            
			result = new Long(0);
			throw MSFServerUtils.getOperationException("saveYeta3500Ye161010", ex, logger);
		}
		finally {
