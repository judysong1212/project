...
import com.app.exterms.yearendtax.client.service.yeta2021.YetaP63008Service;
import com.app.exterms.yearendtax.client.service.yeta2021.YetaP63008ServiceAsync;
...
=====================================================**/
public  class YetaP63008   extends MSFFormPanel { 
 ...
 **/
	...
	private ContentPanel cpYeta63008;
   ...
   */
	...
	// -------------- 서비스 호출 시작 --------------
	private YetaP63008ServiceAsync yetaP63008Service = YetaP63008Service.Util.getInstance();
	// -------------- 서비스 호출 종료 --------------
 ...
 **/	  
	...
	public YetaP63008(final ActionDatabase actionDatabase, final MSFPanel caller) {
		...
		cpYeta63008 = new ContentPanel();

		createStandardForm();
		setReadOnlyTrueYetaP63008();

		cpYeta63008.setBodyBorder(false);
		cpYeta63008.setBorders(false);
		cpYeta63008.setHeaderVisible(false);
		cpYeta63008.setSize("790px", "680px");

		this.add(cpYeta63008);
		formBinding = new FormBinding(this, true);

		this.setSize("810px", "750px");
	}
	  
	public YetaP63008(final ActionDatabase actionDatabase, final MSFFormPanel caller2) {
		...
		createStandardForm();
		setReadOnlyFalseYetaP63008();

		cpYeta63008.setBodyBorder(false);
		cpYeta63008.setBorders(false);
		cpYeta63008.setHeaderVisible(false);
		cpYeta63008.setSize("790px", "640px");
...
//		lcSchCenter2_1.add(taxmSt10Bi, new FormData("100%"));
	...
	private void YetaP63008FormSave() {  
...
//		ye160403Dto.setTaxmSy21Bi((Long)taxmSy21Bi.getValue());    /** column 비과세소득_Y21_비과세 : taxmSy21Bi */
		...
		yetaP63008Service.activityOnYetaP63008ToYe160403(ye160403Dto, actionDatabase, new AsyncCallback<Long>(){
					public void onFailure(Throwable caught) {
						MessageBox.alert(MSFMainApp.MSFCONSTANTS.ExceptionTitleService(), 
	                              MSFMainApp.ADMINMESSAGES.ExceptionMessageService("activityOnYetaP63008ToYe160403(" + actionDatabase.name() + ") : " + caught), null);
					}
	...
	public void reload() {
		...
		yetaP63008Service.getYetaP63008ToYe160403List(ye160403Dto, new AsyncCallback<Ye160403DTO>(){

			@Override
			public void onFailure(Throwable caught) {
				// TODO Auto-generated method stub
				MessageBox.alert(MSFMainApp.MSFCONSTANTS.ExceptionTitleService(), 
                        MSFMainApp.ADMINMESSAGES.ExceptionMessageService("getYetaP63008ToYe160403List(" + actionDatabase.name() + ") : " + caught), null);
	...
	/** 비과세 및 감면소득 조회부 **/
	public void readYetaP63008Data(Ye160403DTO result) {
...
//		taxmSy21Bi.setValue(result.getTaxmSy21Bi());    /** column 비과세소득_Y21_비과세 : taxmSy21Bi */
	...
	public void setReadOnlyTrueYetaP63008() {
...
//		taxmSy21Bi.setReadOnly(true); // ⑱-20 Y21-장기미취업자 중소기업 취업
	...
	public void setReadOnlyFalseYetaP63008() {
