...
//    private YetaConstants yetaLabel = YetaConstants.INSTANCE;
	...
	public Ye161090Def(String chkPayrDef) {
		...
		if ("YETA330001".equals(chkPayrDef)) {
			...
			setDaoClass("");
			setCustomListMethod(CLASS_YETA3300_TO_YE161090_DATA_LIST);
			setAutoFillGrid(false);
			setShowFilterToolbar(false);
			setCheckBoxOnGridRows(true);
			setEditableGrid(true);
			setEditFieldGrid(true);
			setColumnsDefinition(getYeta2300ToYe161090ColumnsList01());
			...
			setEditableGrid(true);
			setEditFieldGrid(true);
			setColumnsDefinition(getYeta2300ToYe161090ColumnsList02());
...
//     
    ...
    private List<ColumnDef> getYeta2300ToYe161090ColumnsList01(){
    ...
    private List<ColumnDef> getYeta2300ToYe161090ColumnsList02(){
