...
import com.app.exterms.yearendtax.server.service.yeta2019.dao.Yeta4070_2019_DAO;
...
@Service("Yeta4070Service")
public class Yeta4070ServiceImpl extends AbstractCustomServiceImpl implements YetaDaoConstantsGenerated, Yeta4070Service {

	private static final Logger logger = LoggerFactory.getLogger(Yeta4070ServiceImpl.class);
	private static final String calledClass = Yeta4070ServiceImpl.class.getName();

	@Autowired
	@Resource(name = "Yeta4070_2019_DAO")
	private Yeta4070_2019_DAO yeta4070DAO;
	...
	public PagingLoadResult<BaseModel> getSelectYeta4070ToBass0120List(ServiceParameters serviceParameters) throws MSFException {
        ...
        Yeta2070Srh_2019_VO   Yeta2070SrhVO = new Yeta2070Srh_2019_VO();
        //Yeta2070VO      Yeta2070Vo = new Yeta2070VO();
        List<BaseModel>  bmResult = new ArrayList<BaseModel>();
        MSFSysm0100BM sessionUser = MSFServerUtils.getLoggedUser(RemoteServiceUtil.getThreadLocalRequest());
        
        if(MSFSharedUtils.paramNull(yeta4070DAO)){
        	WebApplicationContext wac = WebApplicationContextUtils.getRequiredWebApplicationContext(getHttpServletRequest().getSession().getServletContext());
        	yeta4070DAO = (Yeta4070_2019_DAO) wac.getBean("Yeta4070_2019_DAO");
        }
        try{
            ...
            if(pagingValues.executeRecordCount){ 
            	...
            	int iResultCnt = yeta4070DAO.selectYeta4070ListTotCnt(Yeta2070SrhVO);
            ...
            List list = yeta4070DAO.selectYeta4070List(Yeta2070SrhVO);
            ...
            SmrmfUtils.endTiming(logger, millisBeginSelectYeta2070List, "selectYeta4070List");
