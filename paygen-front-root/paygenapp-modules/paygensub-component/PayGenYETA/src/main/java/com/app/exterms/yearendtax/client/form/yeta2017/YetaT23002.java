...
import com.app.exterms.yearendtax.client.service.yeta2017.YetaT23002Service;
import com.app.exterms.yearendtax.client.service.yeta2017.YetaT23002ServiceAsync;
...
=====================================================**/
public  class YetaT23002   extends MSFFormPanel {  
 ...
 **/
	...
	// -------------- 서비스 호출 시작 --------------
	private YetaT23002ServiceAsync yetaT23002Service = YetaT23002Service.Util.getInstance();
	// -------------- 서비스 호출 종료 --------------	 
...
//					ye162510Dto.setMnthRnttyHusCnttArea((MSFSharedUtils.allowNulls(bmMapModel.get("mnthRnttyHusCnttArea"))));    		/** column 월세주택계약면적 : mnthRnttyHusCnttArea */
				...
				yetaT23002Service.activityOnYetaT23002(listYe162510Dto, actionDatabase, new AsyncCallback<Long>(){
...
//		 }
	...
	public YetaT23002(final ActionDatabase actionDatabase, final MSFPanel caller) {
...
//		fldstNewFieldset1.add(layoutContainer13);
		...
		cpYetaT23002.add(fldstNewFieldset_1);
