...
@Repository("Yeta1000DAO")
public class Yeta1000DAO extends EgovAbstractDAO implements IsSerializable {
    ...
    public List selectYeta0400List(Yeta1000SrhVO searchVO) throws Exception {
        return list("yeta1000DAO.selectYeta0400ToList_D", searchVO);
    }
    ...
    public int selectYeta0400ListTotCnt(Yeta1000SrhVO searchVO) {
        return (Integer)getSqlMapClientTemplate().queryForObject("yeta1000DAO.selectYeta0400ToListTotCnt_S", searchVO);
    }
    ...
    public void finishYeta0400List(Yeta1000VO vo) throws Exception {
        update("yeta1000DAO.finishYeta1000_S", vo);
    }
    ...
    public void saveYeta0400List(Yeta1000VO vo) throws Exception {
        update("yeta1000DAO.updateYeta0400ToYeta1000_S", vo);
    }
    ...
    public String insertYeta1000(Yeta1000VO vo) throws Exception {
        return (String)insert("yeta1000DAO.insertYeta1000_S", vo);
    }
    ...
    public void updateYeta1000(Yeta1000VO vo) throws Exception {
        update("yeta1000DAO.updateYeta1000_S", vo);
    }
    ...
    public void deleteYeta1000(Yeta1000VO vo) throws Exception {
        delete("yeta1000DAO.deleteYeta1000_S", vo);
    }
    /**
	 * YETA1000을 삭제한다.
	 * @param vo - 삭제할 정보가 담긴 Yeta1000VO
    ...
    public void fnPayr06430_PAYR420_CREATE_Delete(Yeta1000VO vo) throws Exception {
        delete("yeta1000DAO.fnPayr06430_PAYR420_CREATE_Delete_S", vo);
    }
    ...
    public Yeta1000VO selectYeta1000(Yeta1000VO vo) throws Exception {
        return (Yeta1000VO) selectByPk("yeta1000DAO.selectYeta1000_S", vo);
    }
    ...
    public List<?> selectYeta1000List(Yeta1000SrhVO searchVO) throws Exception {
        return list("yeta1000DAO.selectYeta1000List_D", searchVO);
    }
    ...
    public int selectYeta1000ListTotCnt(Yeta1000SrhVO searchVO) {
        return (Integer)getSqlMapClientTemplate().queryForObject("yeta1000DAO.selectYeta1000ListTotCnt_S", searchVO);
    }
