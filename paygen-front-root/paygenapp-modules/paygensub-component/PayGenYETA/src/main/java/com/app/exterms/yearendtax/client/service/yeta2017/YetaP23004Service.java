 ...
 */
@RemoteServiceRelativePath("YetaP23004Service.gwt")
public interface YetaP23004Service extends RemoteService {
	/**
	 * Utility class for simplifying access to the instance of async service.
	 */
	public static class Util {
		private static YetaP23004ServiceAsync instance;
		public static YetaP23004ServiceAsync getInstance(){
			if (instance == null) {
				instance = GWT.create(YetaP23004Service.class);
			}
			return instance;
		}
	}
