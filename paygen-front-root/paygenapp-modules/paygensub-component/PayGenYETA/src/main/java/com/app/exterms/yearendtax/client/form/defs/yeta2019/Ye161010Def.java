...
import com.app.exterms.yearendtax.client.dto.yeta2019.InfcPsnl0100BM;
import com.app.exterms.yearendtax.client.dto.yeta2019.Ye160401BM;
import com.app.exterms.yearendtax.client.dto.yeta2019.Ye161010BM;
import com.app.exterms.yearendtax.client.dto.yeta2019.Ye161020BM;
...
//    private PayrConstants PayrLabel = PayrConstants.INSTANCE;
	...
	public Ye161010Def(String chkPayrDef) {
		...
		if("Yeta4100".equals(chkPayrDef)){
			setDaoClass("");
			setCustomListMethod(CLASS_YETA4100_DATA_LIST);
		...
		}else if("Yeta4200".equals(chkPayrDef)){
			setDaoClass("");
			setCustomListMethod(CLASS_YETA4200_DATA_LIST);
			...
			setDaoClass("");
			setCustomListMethod(CLASS_YETA4300_TO_YE161010_DATA_LIST);
			setAutoFillGrid(false);
			setShowFilterToolbar(false);
			setCheckBoxOnGridRows(true);
			setEditFieldGrid(false);
			...
			setTitle("");
	        setDaoClass("");
	        setCustomListMethod(CLASS_YETA4200_RESULT_DATA_LIST);
	  	  	setAutoFillGrid(true);
	        setShowFilterToolbar(false);   
	        setCheckBoxOnGridRows(false); 
		    setEditFieldGrid(false);
