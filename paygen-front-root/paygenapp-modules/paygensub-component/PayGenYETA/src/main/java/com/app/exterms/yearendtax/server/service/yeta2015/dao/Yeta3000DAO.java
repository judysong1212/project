...
@Repository("Yeta3000DAO")
public class Yeta3000DAO extends EgovAbstractDAO implements IsSerializable {
    ...
    public void saveYeta0300To3000tabItem01(Yeta3000VO vo) throws Exception {
    	update("yeta3000DAO.updateYeta0300To3000tabItem01", vo);
    }
    ...
    public String insertYeta3000(Yeta3000VO vo) throws Exception {
        return (String)insert("yeta3000DAO.insertYeta3000_S", vo);
    }
    ...
    public void updateYeta3000(Yeta3000VO vo) throws Exception {
        update("yeta3000DAO.updateYeta3000_S", vo);
    }
    ...
    public void deleteYeta3000(Yeta3000VO vo) throws Exception {
        delete("yeta3000DAO.deleteYeta3000_S", vo);
    }
    ...
    /**
     ...
     public void fnPayr06430_PAYR425_CREATE_Delete(Yeta3000VO vo) throws Exception {
         delete("yeta3000DAO.fnPayr06430_PAYR425_CREATE_Delete_S", vo);
     }
    ...
    public Yeta3000VO selectYeta3000(Yeta3000VO vo) throws Exception {
        return (Yeta3000VO) selectByPk("yeta3000DAO.selectYeta3000_S", vo);
    }
    ...
    public List<?> selectYeta3000List(Yeta3000SrhVO searchVO) throws Exception {
        return list("yeta3000DAO.selectYeta3000List_D", searchVO);
    }
    ...
    public int selectYeta3000ListTotCnt(Yeta3000SrhVO searchVO) {
        return (Integer)getSqlMapClientTemplate().queryForObject("yeta3000DAO.selectYeta3000ListTotCnt_S", searchVO);
    }
    
    
    
    public List<?> selectYeta0300ToSubTaxList(Yeta3000SrhVO searchVO) throws Exception {
        return list("yeta3000DAO.selectYeta0300ToSubTaxList_D", searchVO);
    }
    ...
    public int selectYeta0300ToSubTaxListTotCnt(Yeta3000SrhVO searchVO) {
        return (Integer)getSqlMapClientTemplate().queryForObject("yeta3000DAO.selectYeta0300ToSubTaxListTotCnt_S", searchVO);
    } 
