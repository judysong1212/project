...
import com.app.exterms.yearendtax.client.dto.yeta2021.Ye161090BM;
...
import com.app.exterms.yearendtax.client.service.yeta2021.YetaP630011Service;
import com.app.exterms.yearendtax.client.service.yeta2021.YetaP630011ServiceAsync;
import com.app.exterms.yearendtax.client.service.yeta2021.YetaP63002Service;
import com.app.exterms.yearendtax.client.service.yeta2021.YetaP63002ServiceAsync;
...
=====================================================**/
public  class YetaP630011   extends MSFFormPanel {  
 ...
 **/
	...
	private  ContentPanel cpYeta630011; 
	...
	// -------------- grid 선언 시작  ---------------	  
	private MSFGridPanel yeta6300ToYe161090GridPanel01;		// 가족교육비 GridPanel (기타자료)
	private MSFGridPanel yeta6300ToYe161090GridPanel02;		// 가족교육비 GridPanel (국세청자료)
	private Ye161090Def ye161090Def_01  		= new Ye161090Def("YETA630001");
	private Ye161090Def ye161090Def_02  		= new Ye161090Def("YETA630002");
	// -------------- grid 선언 종료  ---------------	
   ...
   */
	...
	private YetaP630011ServiceAsync yetaP630011Service = YetaP630011Service.Util.getInstance();
 ...
 **/ 
	...
	// -------------- 서비스 호출 시작 --------------
	private YetaP63002ServiceAsync yetaP63002Service = YetaP63002Service.Util.getInstance();
	// -------------- 서비스 호출 종료 --------------	 	
	...
	private void yetaP23002FormSave() {
		...
		if (MSFSharedUtils.paramNotNull(records)) {
			...
			while (records.hasNext()) {
				...
				ye164010Dto.setYn3( MSFSharedUtils.defaultNulls(bmMapModel.get("yn3"), "0") );    							/** column 의료비_산후조리여부 : yn3 */				
				ye164010Dto.setYn4( MSFSharedUtils.defaultNulls(bmMapModel.get("yn4"), "0") );    							/** column 의료비_실손보험보전여부 : yn4 */				
...
//					return;
			...
			if (dataChk) {
				...
				yetaP63002Service.activityOnYetaP63002ToYe164010(listYe164010Dto, actionDatabase, new AsyncCallback<Long>(){
...
//		 }
	...
	public YetaP630011(final ActionDatabase actionDatabase, final MSFPanel caller) {
		...
		cpYeta630011 = new ContentPanel();

		createSearchForm(); 	// 기본정보 필드를 적용
//		createStandardForm(); 	// 기본정보필드
		createMsfGridForm(); 	// 그리드필드

		cpYeta630011.setBodyBorder(false);
		cpYeta630011.setBorders(false);
		cpYeta630011.setHeaderVisible(false);
		cpYeta630011.setSize("790px", "700px");

		this.add(cpYeta630011);
	...
	private void createSearchForm() {
		...
		cpYeta630011.setLayout(new FlowLayout());
...
//	      return lcFormLayer;	  
	...
	public void reload01() {
		...
		yeta6300ToYe161090GridPanel01.getTableDef().setTableColumnFilters(filters);
				
		yeta6300ToYe161090GridPanel01.getTableDef().addColumnFilter("dpobCd"		, MSFSharedUtils.allowNulls(dpobCd.getValue())		, SimpleColumnFilter.OPERATOR_EQUALS);
		yeta6300ToYe161090GridPanel01.getTableDef().addColumnFilter("systemkey"		, MSFSharedUtils.allowNulls(systemkey.getValue())	, SimpleColumnFilter.OPERATOR_EQUALS); 
		yeta6300ToYe161090GridPanel01.getTableDef().addColumnFilter("clutSeptCd"	, MSFSharedUtils.allowNulls(clutSeptCd.getValue())	, SimpleColumnFilter.OPERATOR_EQUALS); 
		yeta6300ToYe161090GridPanel01.getTableDef().addColumnFilter("yrtxBlggYr"	, MSFSharedUtils.allowNulls(yrtxBlggYr.getValue())	, SimpleColumnFilter.OPERATOR_EQUALS); 
		yeta6300ToYe161090GridPanel01.getTableDef().addColumnFilter("cdVvalKrnCd"	, MSFSharedUtils.allowNulls("Y0140001")				, SimpleColumnFilter.OPERATOR_EQUALS); 
				
		yeta6300ToYe161090GridPanel01.reload();
	...
	public void reload02() {
		...
		yeta6300ToYe161090GridPanel02.getTableDef().setTableColumnFilters(filters);
				
		yeta6300ToYe161090GridPanel02.getTableDef().addColumnFilter("dpobCd"		, MSFSharedUtils.allowNulls(dpobCd.getValue())		, SimpleColumnFilter.OPERATOR_EQUALS);
		yeta6300ToYe161090GridPanel02.getTableDef().addColumnFilter("systemkey"		, MSFSharedUtils.allowNulls(systemkey.getValue())	, SimpleColumnFilter.OPERATOR_EQUALS); 
		yeta6300ToYe161090GridPanel02.getTableDef().addColumnFilter("clutSeptCd"	, MSFSharedUtils.allowNulls(clutSeptCd.getValue())	, SimpleColumnFilter.OPERATOR_EQUALS); 
		yeta6300ToYe161090GridPanel02.getTableDef().addColumnFilter("yrtxBlggYr"	, MSFSharedUtils.allowNulls(yrtxBlggYr.getValue())	, SimpleColumnFilter.OPERATOR_EQUALS); 
		yeta6300ToYe161090GridPanel02.getTableDef().addColumnFilter("cdVvalKrnCd"	, MSFSharedUtils.allowNulls("Y0140000")				, SimpleColumnFilter.OPERATOR_EQUALS); 
				
		yeta6300ToYe161090GridPanel02.reload();
	...
	private void createMsfGridForm() {
		...
		btnYetaSave.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				...
				Iterator<Record> iterRecords = yeta6300ToYe161090GridPanel01.getMsfGrid().getGrid().getStore().getModifiedRecords().iterator(); 
...
//					// 기존데이터
//					Iterator<BaseModel> itBm  = yeta6300ToYe161090GridPanel01.getMsfGrid().getGrid().getStore().getModels().listIterator(); 
//	            	  
...
//					Iterator<BaseModel> itBm = yeta6300ToYe161090GridPanel01.getMsfGrid().getGrid().getStore().getModels().iterator(); 
//					
...
//				}
				...
				MessageBox.confirm("삭제", "선택하신 교육비 내용을 삭제하시겠습니까?",new Listener<MessageBoxEvent>(){
					...
					public void handleEvent(MessageBoxEvent be) {
						if(Dialog.YES.equals(be.getButtonClicked().getItemId())){
							...
							Iterator<BaseModel> itBm = yeta6300ToYe161090GridPanel01.getMsfGrid().getGrid().getSelectionModel().getSelectedItems().listIterator();
		...
		yeta6300ToYe161090GridPanel01 = new MSFGridPanel(ye161090Def_01, false, false, false, false, false);
		yeta6300ToYe161090GridPanel01.setHeaderVisible(false);  
		yeta6300ToYe161090GridPanel01.setBodyBorder(false);
		yeta6300ToYe161090GridPanel01.setBorders(true);
		yeta6300ToYe161090GridPanel01.getBottomComponent().setVisible(true);
		...
		yeta6300ToYe161090GridPanel01.getGrid().getColumnModel().addAggregationRow(payrSummaryRow);  
		/** --- 그리드 합계 부분  시작 --- **/		
		   
		cpGrid01.add(yeta6300ToYe161090GridPanel01); 
		...
		btnYetaSave2.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				...
				Iterator<Record> iterRecords = yeta6300ToYe161090GridPanel02.getMsfGrid().getGrid().getStore().getModifiedRecords().iterator(); 
		...
		yeta6300ToYe161090GridPanel02 = new MSFGridPanel(ye161090Def_02, false, false, false, false, false);
		yeta6300ToYe161090GridPanel02.setHeaderVisible(false);  
		yeta6300ToYe161090GridPanel02.setBodyBorder(false);
		yeta6300ToYe161090GridPanel02.setBorders(true);
		yeta6300ToYe161090GridPanel02.getBottomComponent().setVisible(true);
		...
		yeta6300ToYe161090GridPanel02.getGrid().getColumnModel().addAggregationRow(payrSummaryRow2);  
		/** --- 그리드 합계 부분  시작 --- **/		
		   
		cpGrid02.add(yeta6300ToYe161090GridPanel02); 
		...
		popBindingCom0160.addListener(Events.Change, new Listener<BaseEvent>() {
			public void handleEvent(BaseEvent be) {
				...
				if (mapModels != null) {
					...
					yetaP630011Service.saveYeta6300ToYe161090tabItem08_3(listYe161090Dto, actionDatabase, new AsyncCallback<Long>() {
