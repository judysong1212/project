...
//				fieldSet_2.add(lcSchCol2, new FormData("100%"));	
		    	...
		    	layoutContainer_1.setLayout(new HBoxLayout()); 
		     	...
		     	btnYetat13019.addListener(Events.Select, new Listener<ButtonEvent>() {
		     		public void handleEvent(ButtonEvent e) {
						  //전체내역  
						  YetaT33019 yetaT23019Form = new YetaT33019(ActionDatabase.READ, getThis());   
		    	...
		    	btnYetat13001.addListener(Events.Select, new Listener<ButtonEvent>() {
		    		public void handleEvent(ButtonEvent e) {
						  //전체내역  
						  YetaT33001 yetaT23001Form = new YetaT33001(ActionDatabase.READ, getThis());   
		    	...
		    	btnYetat13002.addListener(Events.Select, new Listener<ButtonEvent>() {
		    		public void handleEvent(ButtonEvent e) {
						  //전체내역  
						  YetaT33002 yetaT23002Form = new YetaT33002(ActionDatabase.READ, getThis());   
		    	...
		    	btnYetat13003.addListener(Events.Select, new Listener<ButtonEvent>() {
		    		public void handleEvent(ButtonEvent e) {
						  //전체내역  
						  YetaT33003 yetaT23003Form = new YetaT33003(ActionDatabase.READ, getThis());   
		    	...
		    	btnYetat13004.addListener(Events.Select, new Listener<ButtonEvent>() {
		    		public void handleEvent(ButtonEvent e) {
						  //전체내역  
						  YetaT33004 yetaT23004Form = new YetaT33004(ActionDatabase.READ, getThis());   
		    	...
		    	btnYetat13005.addListener(Events.Select, new Listener<ButtonEvent>() {
		    		public void handleEvent(ButtonEvent e) {
						  //전체내역  
						  YetaT33005 yetaT23005Form = new YetaT33005(ActionDatabase.READ, getThis());   
		    	...
		    	btnYetat13006.addListener(Events.Select, new Listener<ButtonEvent>() {
		    		public void handleEvent(ButtonEvent e) {
						  //전체내역  
						  YetaT33006 yetaT23006Form = new YetaT33006(ActionDatabase.READ, getThis());   
		    	...
		    	btnYetat13007.addListener(Events.Select, new Listener<ButtonEvent>() {
		    		public void handleEvent(ButtonEvent e) {
						  //전체내역  
						  YetaT33007 yetaT23007Form = new YetaT33007(ActionDatabase.READ, getThis());   
		    	...
		    	btnYetat13008.addListener(Events.Select, new Listener<ButtonEvent>() {
		    		public void handleEvent(ButtonEvent e) {
						  //전체내역  
						  YetaT33008 yetaT23008Form = new YetaT33008(ActionDatabase.READ, getThis());   
		    	...
		    	btnYetat13009.addListener(Events.Select, new Listener<ButtonEvent>() {
		    		public void handleEvent(ButtonEvent e) {
						  //전체내역  
						  YetaT33009 yetaT23009Form = new YetaT33009(ActionDatabase.READ, getThis());   
		    	...
		    	btnYetat13010.addListener(Events.Select, new Listener<ButtonEvent>() {
		    		public void handleEvent(ButtonEvent e) {
						  //전체내역  
						  YetaT33010 yetaT23010Form = new YetaT33010(ActionDatabase.READ, getThis());   
		    	...
		    	btnYetat13011.addListener(Events.Select, new Listener<ButtonEvent>() {
		    		public void handleEvent(ButtonEvent e) {
						  //전체내역  
						  YetaT33011 yetaT23011Form = new YetaT33011(ActionDatabase.READ, getThis());   
		    	...
		    	btnYetat13012.addListener(Events.Select, new Listener<ButtonEvent>() {
		    		public void handleEvent(ButtonEvent e) {
						  //전체내역  
						  YetaT33012 yetaT23012Form = new YetaT33012(ActionDatabase.READ, getThis());   
		    	...
		    	btnYetat13013.addListener(Events.Select, new Listener<ButtonEvent>() {
		    		public void handleEvent(ButtonEvent e) {
						  //전체내역  
						  YetaT33013 yetaT23013Form = new YetaT33013(ActionDatabase.READ, getThis());   
		    	...
		    	btnYetat13014.addListener(Events.Select, new Listener<ButtonEvent>() {
		    		public void handleEvent(ButtonEvent e) {
						  //전체내역  
						  YetaT33014 yetaT23014Form = new YetaT33014(ActionDatabase.READ, getThis());   
		    	...
		    	btnYetat13015.addListener(Events.Select, new Listener<ButtonEvent>() {
		    		public void handleEvent(ButtonEvent e) {
						  //전체내역  
						  YetaT33015 yetaT23015Form = new YetaT33015(ActionDatabase.READ, getThis());   
		    	...
		    	btnYetat13016.addListener(Events.Select, new Listener<ButtonEvent>() {
		    		public void handleEvent(ButtonEvent e) {
						  //전체내역  
						  YetaT33016 yetaT23016Form = new YetaT33016(ActionDatabase.READ, getThis());   
		    	...
		    	btnYetat13017.addListener(Events.Select, new Listener<ButtonEvent>() {
		    		public void handleEvent(ButtonEvent e) {
						  //전체내역  
						  YetaT33017 yetaT23017Form = new YetaT33017(ActionDatabase.READ, getThis());   
		    	...
		    	btnYetat13018.addListener(Events.Select, new Listener<ButtonEvent>() {
		    		public void handleEvent(ButtonEvent e) {
						  //전체내역  
						  YetaT33018 yetaT23018Form = new YetaT33018(ActionDatabase.READ, getThis());   
