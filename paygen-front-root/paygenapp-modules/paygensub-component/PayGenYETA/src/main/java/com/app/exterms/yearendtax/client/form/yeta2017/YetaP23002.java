...
import com.app.exterms.yearendtax.client.dto.yeta2017.Ye164010BM;
import com.app.exterms.yearendtax.client.dto.yeta2017.Ye164010DTO;
import com.app.exterms.yearendtax.client.form.defs.yeta2017.Ye164010Def;
...
=====================================================**/
public  class YetaP23002   extends MSFFormPanel {  
 ...
 **/
	...
	// -------------- grid 선언 시작  ---------------	  
	private MSFGridPanel yetaP23002GridPanel;
	private Ye164010Def yetaP23002ToYe164010Def  = new Ye164010Def("YETAP23002");//의료비내역 그리드 테이블 컬럼 define 
	// -------------- grid 선언 종료  ---------------	
...
//		 }
	...
	public YetaP23002(final ActionDatabase actionDatabase, final MSFPanel caller) {
...
//				}
//
//				yetaP23002GridPanel.getMsfGrid().clearData();
//
//				BaseModel bmData = yetaP23002GridPanel.getTableDef().getDefaultValues();
//					 
...
//			         
//			    yetaP23002GridPanel.getMsfGrid().getGrid().stopEditing();      
//			    yetaP23002GridPanel.getMsfGrid().getGrid().getStore().insert(bmData,0);   
//			    yetaP23002GridPanel.getMsfGrid().getGrid().startEditing(yetaP23002GridPanel.getMsfGrid().getGrid().getStore().indexOf(bmData), 0);   
//			         
//				actionDatabase = ActionDatabase.INSERT;
				...
				MessageBox.confirm("삭제", "선택하신 의료비 내용을 삭제하시겠습니까?",new Listener<MessageBoxEvent>(){
					...
					public void handleEvent(MessageBoxEvent be) {
						if(Dialog.YES.equals(be.getButtonClicked().getItemId())){
							...
							Iterator<BaseModel> itBm = yetaP23002GridPanel.getMsfGrid().getGrid().getSelectionModel().getSelectedItems().listIterator();
		...
		btnYetaSave.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				setListRecord(yetaP23002GridPanel.getMsfGrid().getStore().getModifiedRecords().iterator());
...
//			BaseModel bmData = yetaP23002GridPanel.getMsfGrid().getStore().getModels().get(0);  
//			if (MSFSharedUtils.paramNotNull(bmData)){
				// TODO Auto-generated method stub
				IColumnFilter filters = null;
				
				yetaP23002GridPanel.getTableDef().setTableColumnFilters(filters);
				yetaP23002GridPanel.getTableDef().addColumnFilter("yrtxBlggYr", MSFSharedUtils.allowNulls(srhYrtxBlggYr.getValue())
	...
	//					, SimpleColumnFilter.OPERATOR_EQUALS);//연말정산귀속년도
				yetaP23002GridPanel.getTableDef().addColumnFilter("clutSeptCd", MSFSharedUtils.getSelectedComboValue(srhClutSeptCd,"commCd")
						, SimpleColumnFilter.OPERATOR_EQUALS);//정산구분
				yetaP23002GridPanel.getTableDef().addColumnFilter("systemkey", MSFSharedUtils.allowNulls(systemkey.getValue())
						, SimpleColumnFilter.OPERATOR_EQUALS);//시스템키
			 
				yetaP23002GridPanel.reload();
...
//			actionDatabase = ActionDatabase.READ;
	...
	private void createMsfGridForm() {
		...
		yetaP23002GridPanel = new MSFGridPanel(yetaP23002ToYe164010Def, false,false, false, false, false);
		yetaP23002GridPanel.setSize("780px", "390px");
		yetaP23002GridPanel.setBorders(true);
		yetaP23002GridPanel.setBodyBorder(false);
		yetaP23002GridPanel.setHeaderVisible(false);
		yetaP23002GridPanel.getBottomComponent().setVisible(true);
		...
		yetaP23002GridPanel.getGrid().getColumnModel().addAggregationRow(payrSummaryRow);  
		/** --- 그리드 합계 부분  시작 --- **/
			
		gridFieldSet.add(yetaP23002GridPanel);
