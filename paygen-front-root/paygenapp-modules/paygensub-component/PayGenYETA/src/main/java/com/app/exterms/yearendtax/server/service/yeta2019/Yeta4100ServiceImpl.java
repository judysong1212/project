...
import com.app.exterms.yearendtax.server.service.yeta2019.dao.Yeta1100_2019_DAO;
...
* </pre>
 */
@Service("Yeta4100Service")
public class Yeta4100ServiceImpl  extends AbstractCustomServiceImpl implements Yeta4100Service  ,YetaDaoConstants {

	 
	private static final Logger logger = LoggerFactory.getLogger(Yeta4100ServiceImpl.class);
	private static final String calledClass = Yeta4100ServiceImpl.class.getName();

	@Autowired
	@Resource(name = "Yeta1100_2019_DAO")
	private Yeta1100_2019_DAO yeta1100DAO;
	...
	private Ye160401_2019_DAO ye160401DAO;
	
	// 감면소득_과세
	@Autowired
	@Resource(name = "Ye160402_2019_DAO")
	private Ye160402_2019_DAO ye160402DAO;
	
	// 감면소득_비과세
	@Autowired
	@Resource(name = "Ye160403_2019_DAO")
	private Ye160403_2019_DAO ye160403DAO;
	 ...
	 */
	//조회
	public PagingLoadResult<BaseModel> getYeta4100ToYe161010DataList(ServiceParameters serviceParameters) throws MSFException {
		

		PagingLoadResult<BaseModel> retval = null;
		String method =  CLASS_YETA4100_DATA_LIST;
...
//	            Collection<Map<String, Object>> list ??????
			...
			SmrmfUtils.endTiming(logger, millisBeginYeta2100ToYe161010DataList, "getYeta4100ToYe161010DataList");
     ...
     */
    @Override
    public  Long PayrExec_Yeta_2019_Insert(List<Ye161010DTO> listYe161010Dto) throws MSFException {
    		     
    	 
		String method = calledClass + ".PayrExec_Yeta_Insert_2019";
		...
		Ye160402_2019_VO ye160402Vo = new Ye160402_2019_VO(); // 과세감면소득
		Ye160403_2019_VO ye160403Vo = new Ye160403_2019_VO(); // 비과세감면소득
		...
		List<InfcPkgYe161010_2019_VO> listYe161010VO = new ArrayList<InfcPkgYe161010_2019_VO>();
     	...
     	//    {******************************급여자료 이관*******************************************}
		       ...
		       // [과세감면내역 삭제 ]
		        ye160401DAO.fnYeta4100_Ye160401_CREATE_Delete(ye160401Vo);
...
//				}				
				...
				yetaLsAdtr.setPayrToYeta_2019_Insert(RemoteServiceUtil.getThreadLocalRequest(),listYe161010VO);
			...
			logger.error("EXCEPTION calling PayrExec_Yeta_Insert_2019(): " + ex);
			
			/** 에러 로그 **/
			MSFLogHistoryUtils.tracerUserExceptionActivity(sessionUser, method,calledClass, "C", ex, windowNm, windowId);
		
			retval = 0L;
			throw MSFServerUtils.getOperationException("PayrExec_Yeta_Insert_2019", ex, logger);
		}
     ...
     */
    @Override
    public  Long Yeta4100ToYe160401_Delete(List<Ye161010DTO> listYe161010Dto) throws MSFException {
    	
		String method = calledClass + ".Yeta4100ToYe160401_Delete";

		String windowNm = "연말정산대상자관리";
		String windowId = "YETA4100";
...
//		Ye161020VO ye161020Vo = new Ye161020VO(); // 인적소득공제기본
	...
	@Override
	public Long UpDpobExec_Yeta_2019_Insert(List<Ye161010DTO> listYe161010Dto) throws MSFException {
		 
   	 
			String method = calledClass + ".UpDpobExec_Yeta_Insert_2019";
			...
			List<InfcPkgYe161010_2019_VO> listYe161010VO = new ArrayList<InfcPkgYe161010_2019_VO>();
	     	...
	     	//    {******************************급여자료 이관*******************************************}
				...
				if (listYe161010VO.size() > 0) {
					...
					// 컴포넌트 호출하기
					yetaLsAdtr.setUpDpopYeta_2019_Insert(RemoteServiceUtil.getThreadLocalRequest(),listYe161010VO);
				...
				logger.error("EXCEPTION calling UpDpobExec_Yeta_Insert_2019(): " + ex);
				
				/** 에러 로그 **/
				MSFLogHistoryUtils.tracerUserExceptionActivity(sessionUser, method,calledClass, "U", ex, windowNm, windowId);
			
				retval = 0L;
				throw MSFServerUtils.getOperationException("UpDpobExec_Yeta_Insert_2019", ex, logger);
			}
