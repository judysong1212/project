...
@Repository("Yeta1100_2023_DAO")
public class Yeta1100_2023_DAO extends EgovAbstractDAO {
    ...
    public List selectYetaP110001List(InfcPsnl0100Srh_2023_VO   psnl0100SrhVO) throws Exception {
        return list("yeta1100_2023_DAO.selectPsnl0100List_D", psnl0100SrhVO);
    }
    ...
    public int selectYetaP110001ListTotCnt(InfcPsnl0100Srh_2023_VO   psnl0100SrhVO) {
        return (Integer)getSqlMapClientTemplate().queryForObject("yeta1100_2023_DAO.selectPsnl0100ListCnt_S", psnl0100SrhVO);
    }
