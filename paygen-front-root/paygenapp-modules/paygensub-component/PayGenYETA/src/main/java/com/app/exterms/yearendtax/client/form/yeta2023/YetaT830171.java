...
import com.app.exterms.yearendtax.client.service.yeta2023.YetaT83017ServiceAsync;
...
=====================================================**/
public  class YetaT830171  extends MSFFormPanel {  
	...
	private  ContentPanel cpYetaT830171; 
	...
	// -------------- 서비스 호출 시작 --------------
	private YetaT83017ServiceAsync yetaT83017Service = YetaT83017Service.Util.getInstance();
	// -------------- 서비스 호출 종료 --------------	 
	...
	public YetaT830171(final ActionDatabase actionDatabase, final MSFPanel caller) {
		...
		cpYetaT830171 = new ContentPanel();  

		createSearchForm();			//기본정보 필드를 적용
		createMsfGridForm();		//그리드필드
		setReadOnlyTrueYetaP230171();

		cpYetaT830171.setBodyBorder(false);
		cpYetaT830171.setBorders(false);
		cpYetaT830171.setHeaderVisible(false);
		cpYetaT830171.setSize("630px", "640px");

		this.add(cpYetaT830171);
	...
	private void createMsfGridForm() {
		...
		cpYetaT830171.add(layoutContainer1);
		cpYetaT830171.add(layoutContainer2);
		cpYetaT830171.add(layoutContainer3);
		cpYetaT830171.add(layoutContainer4);
		cpYetaT830171.add(layoutContainer5);
		cpYetaT830171.add(layoutContainer6);
		cpYetaT830171.add(layoutContainer7);
		cpYetaT830171.add(layoutContainer8);
		cpYetaT830171.add(layoutContainer9);
	}	
	...
	public void reload() {
		...
		yetaT83017Service.getYetaP83017ToYe169010List(ye1690103Dto, new AsyncCallback<Ye169010DTO>(){
			...
			public void onSuccess(Ye169010DTO result) {
				// TODO Auto-generated method stub
				readYetaP83017Data(result);
			}
		});
	}	 
	public void readYetaP83017Data(Ye169010DTO result) {
