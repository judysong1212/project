...
import com.app.exterms.yearendtax.client.service.yeta2018.YetaT33016Service;
import com.app.exterms.yearendtax.client.service.yeta2018.YetaT33016ServiceAsync;
...
//import com.app.exterms.yearendtax.client.form.defs.yeta2016.YetaT33016Def;
...
=====================================================**/
public  class YetaT33016   extends MSFFormPanel {  
 ...
 **/
	...
	private  ContentPanel cpYetaT33016; 
	...
	// -------------- grid 선언 시작  ---------------	  
	private MSFGridPanel YetaT33016GridPanel;
//	private YetaT33016Def YetaT33016Def = new YetaT33016Def("YetaT33016");   //TODO 일단 화면번호로 Def
	// -------------- grid 선언 종료  ---------------
	...
	// -------------- 서비스 호출 시작 --------------
	private YetaT33016ServiceAsync yetaT33016Service = YetaT33016Service.Util.getInstance();
	// -------------- 서비스 호출 종료 --------------	 
...
//					ye162510Dto.setMnthRnttyHusCnttArea((MSFSharedUtils.allowNulls(bmMapModel.get("mnthRnttyHusCnttArea"))));    		/** column 월세주택계약면적 : mnthRnttyHusCnttArea */
				...
				yetaT33016Service.activityOnYetaT33016(listYe162510Dto, actionDatabase, new AsyncCallback<Long>(){
...
//		 }
	...
	public YetaT33016(final ActionDatabase actionDatabase, final MSFPanel caller) {
...
//		initLoad(); 	
		...
		this.actionDatabase = actionDatabase;
	 	...
	 	cpYetaT33016 = new ContentPanel();  

		createSearchForm();			//기본정보 필드를 적용
	 	createMsfGridForm();		//그리드필드
		   
		cpYetaT33016.setBodyBorder(false);
		cpYetaT33016.setBorders(false);
		cpYetaT33016.setHeaderVisible(false);
		cpYetaT33016.setSize("790px", "640px");
		   
		this.add(cpYetaT33016);
...
//		     });     
		...
		cpYetaT33016.setLayout(new FlowLayout());
...
//	      	     }
//				 
//				YetaT33016GridPanel.getMsfGrid().clearData();
//				 
//				BaseModel bmData = YetaT33016GridPanel.getTableDef().getDefaultValues();  
//		              
...
//		         
//		        YetaT33016GridPanel.getMsfGrid().getGrid().stopEditing();      
//		        YetaT33016GridPanel.getMsfGrid().getGrid().getStore().insert(bmData,0);   
//		        YetaT33016GridPanel.getMsfGrid().getGrid().startEditing(YetaT33016GridPanel.getMsfGrid().getGrid().getStore().indexOf(bmData), 0);   
//
...
//			public void handleEvent(ButtonEvent e) {
//				Iterator<BaseModel> itBm = YetaT33016GridPanel.getMsfGrid().getGrid().getSelectionModel().getSelectedItems().listIterator();
...
//				
		...
		btnYetaSave.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				setListRecord(YetaT33016GridPanel.getMsfGrid().getStore().getModifiedRecords().iterator());
				doAction(actionDatabase);
...
//				
		cpYetaT33016.add(topYetaBtnBar);
...
//		YetaT33016GridPanel = new MSFGridPanel(YetaT33016Def, false, false, false, false, false);
//		YetaT33016GridPanel.setSize("790px", "420px");
//		YetaT33016GridPanel.setBorders(true);
//		YetaT33016GridPanel.setHeaderVisible(false);
...
//		
//		YetaT33016GridPanel.getGrid().getColumnModel().addAggregationRow(payrSummaryRow);  
//		
...
//		
//		YetaT33016GridPanel.getGrid().getColumnModel().addAggregationRow(payrSummaryRow1);
//		/** --- 그리드 합계 부분  종료 --- **/
		
//        cpYetaT33016.add(YetaT33016GridPanel);
		...
		cpYetaT33016.add(layoutContainer);
		...
		cpYetaT33016.add(layoutContainer1);
		...
		cpYetaT33016.add(layoutContainer2);
		...
		cpYetaT33016.add(layoutContainer_gibu08);
		...
		cpYetaT33016.add(fldstNewFieldset_4);
	...
	public void reload() {
			...
			YetaT33016GridPanel.getTableDef().setTableColumnFilters(filters);
			YetaT33016GridPanel.getTableDef().addColumnFilter("yrtxBlggYr", MSFSharedUtils.allowNulls(srhYrtxBlggYr.getValue())
...
//					, SimpleColumnFilter.OPERATOR_EQUALS);//연말정산귀속년도
			YetaT33016GridPanel.getTableDef().addColumnFilter("clutSeptCd", MSFSharedUtils.getSelectedComboValue(srhClutSeptCd,"commCd")
					, SimpleColumnFilter.OPERATOR_EQUALS);//정산구분
			YetaT33016GridPanel.getTableDef().addColumnFilter("systemkey", MSFSharedUtils.allowNulls(systemkey.getValue())
					, SimpleColumnFilter.OPERATOR_EQUALS);//시스템키
		 
			YetaT33016GridPanel.reload();
