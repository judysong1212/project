...
import com.app.exterms.yearendtax.client.dto.yeta2018.InfcPsnl0100BM;
import com.app.exterms.yearendtax.client.dto.yeta2018.Ye160401BM;
import com.app.exterms.yearendtax.client.dto.yeta2018.Ye161010BM;
import com.app.exterms.yearendtax.client.dto.yeta2018.Ye161020BM;
...
//    private PayrConstants PayrLabel = PayrConstants.INSTANCE;
	...
	public Ye161010Def(String chkPayrDef) {
		...
		if("Yeta3100".equals(chkPayrDef)){
			setDaoClass("");
			setCustomListMethod(CLASS_YETA3100_DATA_LIST);
		...
		}else if("Yeta3200".equals(chkPayrDef)){
			setDaoClass("");
			setCustomListMethod(CLASS_YETA3200_DATA_LIST);
			...
			setDaoClass("");
			setCustomListMethod(CLASS_YETA3300_TO_YE161010_DATA_LIST);
			setAutoFillGrid(false);
			setShowFilterToolbar(false);
			setCheckBoxOnGridRows(true);
			setEditFieldGrid(false);
			...
			setTitle("");
	        setDaoClass("");
	        setCustomListMethod(CLASS_YETA3200_RESULT_DATA_LIST);
	  	  	setAutoFillGrid(true);
	        setShowFilterToolbar(false);   
	        setCheckBoxOnGridRows(false); 
		    setEditFieldGrid(false);
