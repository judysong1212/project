...
//	        setCustomListMethod(CLASS_YETA0100_LIST);
			...
			setTitle("");
	        setDaoClass("");
	        setCustomListMethod(CLASS_YETAP23004_TO_YE162530_DATA_LIST);
	  	  	setAutoFillGrid(false);
	        setShowFilterToolbar(false);   
	        setCheckBoxOnGridRows(true); 
		    setEditFieldGrid(true);
		    setEditableGrid(true);
		    setColumnsDefinition(getColumnsListYetaP23004ToYe162530()); 
		}else {
//			setTitle("연말정산대상자 및 내역");
			setTitle("");
	        setDaoClass("");
...
//	}
	...
	private List<ColumnDef> getColumnsListYetaP23004ToYe162530() {
