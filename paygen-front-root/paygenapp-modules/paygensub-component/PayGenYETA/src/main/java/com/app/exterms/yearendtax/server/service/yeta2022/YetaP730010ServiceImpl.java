...
@Service("YetaP730010Service")
public class YetaP730010ServiceImpl  extends AbstractCustomServiceImpl implements YetaP730010Service  ,YetaDaoConstants {

	 
	private static final Logger logger = LoggerFactory.getLogger(YetaP730010ServiceImpl.class);
	private static final String calledClass = YetaP730010ServiceImpl.class.getName();
	...
	public int activityOnYetaP730010ToYe160405(Ye160405DTO ye160405Dto, ActionDatabase actionDatabase) throws MSFException {
		...
		String method = calledClass + ".activityOnYetaP730010ToYe160405";

		String windowNm = "소득공제신고자료관리";
		String windowId = "YETAP7300";
		...
		try {
			...
			String nResult = AnyCryptUtils.XecureCryptInitialize(RemoteServiceUtil.getThreadLocalConfig(),RemoteServiceUtil.getThreadLocalRequest());
				...
				result = ye160405DAO.updateYetaP730010ToYe160405(ye160405Vo); 
		          
		} catch (Exception ex) {
			logger.error("EXCEPTION calling activityOnYetaP730010ToYe160405(): "+ ex);
			...
			result = 0;
			throw MSFServerUtils.getOperationException("activityOnYetaP730010ToYe160405", ex, logger);
	...
	public Ye160405DTO getYetaP730010ToYe160405List(Ye160405DTO ye160405Dto) throws MSFException {
		...
		Ye160405Srh_2022_VO ye160405SrhVo = new Ye160405Srh_2022_VO();
		MSFSysm0100BM sessionUser;

		String method = calledClass + ".getYetaP730010ToYe160405List";

		String windowNm = "소득공제신고자료관리";
		String windowId = "YETAP730008";
		...
		try {
			...
			egovResultDataList = ye160405DAO.selectYetaP730010ToYe160405List(ye160405SrhVo);
