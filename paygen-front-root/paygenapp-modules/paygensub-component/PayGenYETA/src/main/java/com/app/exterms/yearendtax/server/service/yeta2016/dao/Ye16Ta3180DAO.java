...
@Repository("Ye16Ta3180DAO")
public class Ye16Ta3180DAO extends EgovAbstractDAO  implements IsSerializable{
    /**
	 * YETA3180을 삭제한다.
	 ...
	 */
    @Transactional
    public void fnYeta1100_YETA3180_2016_CREATE_Delete(Yeta3180VO vo) throws Exception {
        delete("ye16Ta3180DAO.fnYeta1100_YETA3180_2016_CREATE_Delete_S", vo);
    } 
    ...
    public String insertYetaP03001To3180(Yeta3180VO vo) throws Exception {
        return (String)insert("ye16Ta3180DAO.insertYeta3180_S", vo);
    }
    ...
    public void updateYetaP03001To3180(Yeta3180VO vo) throws Exception {
        update("ye16Ta3180DAO.updateYeta3180_S", vo);
    }
    ...
    public void deleteYetaP03001To3180(Yeta3180VO vo) throws Exception {
        delete("ye16Ta3180DAO.deleteYeta3180_S", vo);
    }
    ...
    public List<?> selectYetaP03003To3180List(Yeta3180SrhVO searchVO) throws Exception {
        return list("ye16Ta3180DAO.selectYetaP03003To3180List_D", searchVO);
    }
    ...
    public int selectYetaP03003To3180ListTotCnt(Yeta3180SrhVO searchVO) {
        return (Integer)getSqlMapClientTemplate().queryForObject("ye16Ta3180DAO.selectYetaP03003To3180ListTotCnt_S", searchVO);
    }
    ...
    public void fnPayr06430_PAYR440_CREATE_Delete(Yeta3180VO vo) throws Exception {
        delete("ye16Ta3180DAO.fnPayr06430_PAYR440_CREATE_Delete_S", vo);
    } 
    ...
    public Yeta3180VO selectYeta3180(Yeta3180VO vo) throws Exception {
        return (Yeta3180VO) selectByPk("ye16Ta3180DAO.selectYeta3180_S", vo);
    }
    ...
    public List<?> selectYeta3180List(Yeta3180SrhVO searchVO) throws Exception {
        return list("ye16Ta3180DAO.selectYeta3180List_D", searchVO);
    }
    ...
    public int selectYeta3180ListTotCnt(Yeta3180SrhVO searchVO) {
        return (Integer)getSqlMapClientTemplate().queryForObject("ye16Ta3180DAO.selectYeta3180ListTotCnt_S", searchVO);
    }
