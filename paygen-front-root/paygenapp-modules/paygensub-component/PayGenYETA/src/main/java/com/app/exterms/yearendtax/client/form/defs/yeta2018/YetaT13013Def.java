...
public class YetaT13013Def extends TableDef implements YetaDaoConstants{
	private int row = 0;
	final PrgmComBass0300DTO sysComBass0300Dto;
	
	public YetaT13013Def(String chkDef) {
		
		sysComBass0300Dto = new PrgmComBass0300DTO();
		
		if("YetaT13013".equals(chkDef)) { //TODO 테이블 정의되면 다시 구현.
			setTitle("");
	        setDaoClass("");
		    ...
		    setColumnsDefinition(getColumnsListYetaT13013()); 
		}else {
...
//	        setCustomListMethod(CLASS_YETA0100_LIST);
	...
	private List<ColumnDef> getColumnsListYetaT13013() { //TODO BM 다시 정의.
        List<ColumnDef> listColumnDefs = new ArrayList<ColumnDef>();
        ...
        /** column 구분 : mnthRnttyBurRgsum */
        listColumnDefs.add(new ColumnDef("구분", YetaT13001BM.ATTR_MNTHRNTTYBURRGSUM, ColumnDef.TYPE_STRING , 80, true, true, true){
        	{
        ...
        /** column 금융회사등 : mnthRnttyHusFrmCd */
        listColumnDefs.add(new ColumnDef("금융회사등", YetaT13001BM.ATTR_MNTHRNTTYHUSFRMCD, ColumnDef.TYPE_STRING , 140, true, true, true){
        	{

        	}
        });
        /** column 계좌번호 : mnthRnttyHusFrmNm */
        listColumnDefs.add(new ColumnDef("계좌번호", YetaT13001BM.ATTR_MNTHRNTTYHUSFRMNM, ColumnDef.TYPE_STRING , 140, true, true, true){
        	{

        	}
        });
        /** column 납입금액 : mnthRnttyHusCnttArea */
        listColumnDefs.add(new ColumnDef("납입금액", YetaT13001BM.ATTR_MNTHRNTTYHUSCNTTAREA, ColumnDef.TYPE_STRING , 120, true, true, true){
        	{
