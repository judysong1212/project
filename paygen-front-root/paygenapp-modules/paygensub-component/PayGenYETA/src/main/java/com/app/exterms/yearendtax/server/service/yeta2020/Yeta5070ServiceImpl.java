...
import com.app.exterms.yearendtax.server.service.yeta2020.dao.Yeta5070_2020_DAO;
...
@Service("Yeta5070Service")
public class Yeta5070ServiceImpl extends AbstractCustomServiceImpl implements YetaDaoConstantsGenerated, Yeta5070Service {

	private static final Logger logger = LoggerFactory.getLogger(Yeta5070ServiceImpl.class);
	private static final String calledClass = Yeta5070ServiceImpl.class.getName();

	@Autowired
	@Resource(name = "Yeta5070_2020_DAO")
	private Yeta5070_2020_DAO yeta5070DAO;
	...
	public PagingLoadResult<BaseModel> getSelectYeta5070ToBass0120List(ServiceParameters serviceParameters) throws MSFException {
        ...
        String method =  CLASS_YETA5070TOBASS0120_LIST;
        Yeta2070Srh_2020_VO   Yeta2070SrhVO = new Yeta2070Srh_2020_VO();
        //Yeta2070VO      Yeta2070Vo = new Yeta2070VO();
        List<BaseModel>  bmResult = new ArrayList<BaseModel>();
        MSFSysm0100BM sessionUser = MSFServerUtils.getLoggedUser(RemoteServiceUtil.getThreadLocalRequest());
        
        if(MSFSharedUtils.paramNull(yeta5070DAO)){
        	WebApplicationContext wac = WebApplicationContextUtils.getRequiredWebApplicationContext(getHttpServletRequest().getSession().getServletContext());
        	yeta5070DAO = (Yeta5070_2020_DAO) wac.getBean("Yeta5070_2020_DAO");
        }
        try{
            ...
            if(pagingValues.executeRecordCount){ 
            	...
            	int iResultCnt = yeta5070DAO.selectYeta5070ListTotCnt(Yeta2070SrhVO);
            ...
            List list = yeta5070DAO.selectYeta5070List(Yeta2070SrhVO);
            ...
            SmrmfUtils.endTiming(logger, millisBeginSelectYeta2070List, "selectYeta5070List");
