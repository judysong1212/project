 ...
 */
public class Ye16Ta3170BM    extends MSFSimpleBaseModel implements IsSerializable   {
    ...
    /** set 기부조정명세유형구분코드명 : ctrbDdnm */
    public static final String ATTR_CTRBDDNM = "ctrbDdnm";
    ...
    /** set 기부조정명세유형구분코드명 : ctrbDdnm */
    public void setCtrbDdnm(String  ctrbDdnm) { set( ATTR_CTRBDDNM ,ctrbDdnm);}
    /** get 기부조정명세유형구분코드명 : ctrbDdnm */
    public String  getCtrbDdnm() { return (String )get( ATTR_CTRBDDNM );}
