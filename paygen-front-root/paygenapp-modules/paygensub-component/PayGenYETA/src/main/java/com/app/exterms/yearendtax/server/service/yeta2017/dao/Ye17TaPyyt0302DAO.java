...
@Repository("Ye17TaPyyt0302DAO")
public class Ye17TaPyyt0302DAO extends EgovAbstractDAO {
    ...
    public List selectPyyt0302ToPsnl0100List(Pyyt0302VO vo) throws Exception {
        return list("ye17TaPyyt0302DAO.selectPsnl0100", vo);
    }
    ...
    public int selectPyyt0302ListTotCnt(Pyyt0302SrhVO searchVO) {
        return (Integer)getSqlMapClientTemplate().queryForObject("ye17TaPyyt0302DAO.selectPyyt0302ListTotCnt_S", searchVO);
    }	
    ...
    public String insertPyyt0302(Pyyt0302VO vo) throws Exception {
        return (String)insert("ye17TaPyyt0302DAO.insertPyyt0302_S", vo);
    }
    ...
    public void updatePyyt0302(Pyyt0302VO vo) throws Exception {
        update("ye17TaPyyt0302DAO.updatePyyt0302_S", vo);
    }
//
    /**
	 * PYYT0302을 삭제한다.
    ...
    public void deletePyyt0302(Pyyt0302VO vo) throws Exception {
        delete("ye17TaPyyt0302DAO.deletePyyt0302_S", vo);
    }
    ...
    public void deletePyyt0302_D(Pyyt0302VO vo) throws Exception {
        delete("ye17TaPyyt0302DAO.deletePyyt0302", vo);
    }
//
//    /**
//	 * PYYT0302??조회?�다.
