...
import com.app.exterms.yearendtax.client.service.yeta2017.YetaT23005Service;
import com.app.exterms.yearendtax.client.service.yeta2017.YetaT23005ServiceAsync;
...
//import com.app.exterms.yearendtax.client.form.defs.yeta2016.YetaT23005Def;
...
=====================================================**/
public  class YetaT23005   extends MSFFormPanel {  
 ...
 **/
	...
	private  ContentPanel cpYetaT23005; 
	...
	// -------------- grid 선언 시작  ---------------	  
	private MSFGridPanel yetaT23005GridPanel;
//	private YetaT23005Def yetaT23005Def = new YetaT23005Def("YetaT23005");   //TODO 일단 화면번호로 Def
	// -------------- grid 선언 종료  ---------------
	...
	// -------------- 서비스 호출 시작 --------------
	private YetaT23005ServiceAsync yetaT23005Service = YetaT23005Service.Util.getInstance();
	// -------------- 서비스 호출 종료 --------------	 
...
//					ye162510Dto.setMnthRnttyHusCnttArea((MSFSharedUtils.allowNulls(bmMapModel.get("mnthRnttyHusCnttArea"))));    		/** column 월세주택계약면적 : mnthRnttyHusCnttArea */
				...
				yetaT23005Service.activityOnYetaT23005(listYe162510Dto, actionDatabase, new AsyncCallback<Long>(){
...
//		 }
	...
	public YetaT23005(final ActionDatabase actionDatabase, final MSFPanel caller) {
...
//		initLoad(); 	
		...
		this.actionDatabase = actionDatabase;
	 	...
	 	cpYetaT23005 = new ContentPanel();  

		createSearchForm();			//기본정보 필드를 적용
	 	createMsfGridForm();		//그리드필드
		   
		cpYetaT23005.setBodyBorder(false);
		cpYetaT23005.setBorders(false);
		cpYetaT23005.setHeaderVisible(false);
		cpYetaT23005.setSize("790px", "640px");
		   
		this.add(cpYetaT23005);
...
//		     });     
		...
		cpYetaT23005.setLayout(new FlowLayout());
...
//	      	     }
//				 
//				yetaT23005GridPanel.getMsfGrid().clearData();
//				 
//				BaseModel bmData = yetaT23005GridPanel.getTableDef().getDefaultValues();  
//		              
...
//		         
//		        yetaT23005GridPanel.getMsfGrid().getGrid().stopEditing();      
//		        yetaT23005GridPanel.getMsfGrid().getGrid().getStore().insert(bmData,0);   
//		        yetaT23005GridPanel.getMsfGrid().getGrid().startEditing(yetaT23005GridPanel.getMsfGrid().getGrid().getStore().indexOf(bmData), 0);   
//
...
//			public void handleEvent(ButtonEvent e) {
//				Iterator<BaseModel> itBm = yetaT23005GridPanel.getMsfGrid().getGrid().getSelectionModel().getSelectedItems().listIterator();
...
//		topYetaBtnBar.add(btnYetaDel);
		...
		btnYetaSave.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				setListRecord(yetaT23005GridPanel.getMsfGrid().getStore().getModifiedRecords().iterator());
				doAction(actionDatabase);
...
//			topYetaBtnBar.add(btnYetaClose);
		...
		cpYetaT23005.add(topYetaBtnBar);
...
//		yetaT23005GridPanel = new MSFGridPanel(yetaT23005Def, false, false, false, false, false);
//		yetaT23005GridPanel.setSize("790px", "420px");
//		yetaT23005GridPanel.setBorders(true);
//		yetaT23005GridPanel.setHeaderVisible(false);
//		
...
//		
//		yetaT23005GridPanel.getGrid().getColumnModel().addAggregationRow(payrSummaryRow);  
//		
...
//		
//		yetaT23005GridPanel.getGrid().getColumnModel().addAggregationRow(payrSummaryRow1);
//		/** --- 그리드 합계 부분  종료 --- **/
		
//      cpYetaT23005.add(yetaT23005GridPanel);
		...
		cpYetaT23005.add(fldstNewFieldset);
		cpYetaT23005.add(layoutContainer1_1);
		cpYetaT23005.add(fldstNewFieldset_1);
	...
	public void reload() {
			...
			yetaT23005GridPanel.getTableDef().setTableColumnFilters(filters);
			yetaT23005GridPanel.getTableDef().addColumnFilter("yrtxBlggYr", MSFSharedUtils.allowNulls(srhYrtxBlggYr.getValue())
...
//					, SimpleColumnFilter.OPERATOR_EQUALS);//연말정산귀속년도
			yetaT23005GridPanel.getTableDef().addColumnFilter("clutSeptCd", MSFSharedUtils.getSelectedComboValue(srhClutSeptCd,"commCd")
					, SimpleColumnFilter.OPERATOR_EQUALS);//정산구분
			yetaT23005GridPanel.getTableDef().addColumnFilter("systemkey", MSFSharedUtils.allowNulls(systemkey.getValue())
					, SimpleColumnFilter.OPERATOR_EQUALS);//시스템키
		 
			yetaT23005GridPanel.reload();
