...
import com.app.exterms.yearendtax.client.dto.yeta2017.Ye169010DTO;
import com.app.exterms.yearendtax.client.service.yeta2017.YetaT23017Service;
import com.app.exterms.yearendtax.client.service.yeta2017.YetaT23017ServiceAsync;
...
=====================================================**/
public  class YetaT230171  extends MSFFormPanel {  
	...
	private  ContentPanel cpYetaT230171; 
	...
	// -------------- 서비스 호출 시작 --------------
	private YetaT23017ServiceAsync yetaT23017Service = YetaT23017Service.Util.getInstance();
	// -------------- 서비스 호출 종료 --------------	 
	...
	public YetaT230171(final ActionDatabase actionDatabase, final MSFPanel caller) {
		...
		cpYetaT230171 = new ContentPanel();  

		createSearchForm();			//기본정보 필드를 적용
		createMsfGridForm();		//그리드필드
		setReadOnlyTrueYetaP230171();

		cpYetaT230171.setBodyBorder(false);
		cpYetaT230171.setBorders(false);
		cpYetaT230171.setHeaderVisible(false);
		cpYetaT230171.setSize("630px", "640px");

		this.add(cpYetaT230171);
	...
	private void createMsfGridForm() {
		...
		cpYetaT230171.add(layoutContainer1);
		cpYetaT230171.add(layoutContainer2);
		cpYetaT230171.add(layoutContainer3);
		cpYetaT230171.add(layoutContainer4);
		cpYetaT230171.add(layoutContainer5);
		cpYetaT230171.add(layoutContainer6);
		cpYetaT230171.add(layoutContainer7);
		cpYetaT230171.add(layoutContainer8);
		cpYetaT230171.add(layoutContainer9);
	}	
	...
	public void reload() {
		...
		yetaT23017Service.getYetaP23017ToYe169010List(ye1690103Dto, new AsyncCallback<Ye169010DTO>(){
			...
			public void onSuccess(Ye169010DTO result) {
				// TODO Auto-generated method stub
				readYetaP23017Data(result);
			}
		});
	}	 
	public void readYetaP23017Data(Ye169010DTO result) {
