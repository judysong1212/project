...
import com.app.exterms.yearendtax.client.service.yeta2021.YetaT63009Service;
import com.app.exterms.yearendtax.client.service.yeta2021.YetaT63009ServiceAsync;
...
//import com.app.exterms.yearendtax.client.form.defs.yeta2016.YetaT63009Def;
...
=====================================================**/
public  class YetaT63009   extends MSFFormPanel {  
 ...
 **/
	...
	private  ContentPanel cpYetaT63009; 
	...
	// -------------- grid 선언 시작  ---------------	  
	private MSFGridPanel YetaT63009GridPanel;
//	private YetaT63009Def YetaT63009Def = new YetaT63009Def("YetaT63009");   //TODO 일단 화면번호로 Def
	// -------------- grid 선언 종료  ---------------
	...
	// -------------- 서비스 호출 시작 --------------
	private YetaT63009ServiceAsync yetaT63009Service = YetaT63009Service.Util.getInstance();
	// -------------- 서비스 호출 종료 --------------	 
...
//					ye162510Dto.setMnthRnttyHusCnttArea((MSFSharedUtils.allowNulls(bmMapModel.get("mnthRnttyHusCnttArea"))));    		/** column 월세주택계약면적 : mnthRnttyHusCnttArea */
				...
				yetaT63009Service.activityOnYetaT63009(listYe162510Dto, actionDatabase, new AsyncCallback<Long>(){
...
//		 }
	...
	public YetaT63009(final ActionDatabase actionDatabase, final MSFPanel caller) {
...
//		initLoad(); 	
		...
		this.actionDatabase = actionDatabase;
	 	...
	 	cpYetaT63009 = new ContentPanel();  

		createSearchForm();			//기본정보 필드를 적용
	 	createMsfGridForm();		//그리드필드
		   
		cpYetaT63009.setBodyBorder(false);
		cpYetaT63009.setBorders(false);
		cpYetaT63009.setHeaderVisible(false);
		cpYetaT63009.setSize("790px", "640px");
		   
		this.add(cpYetaT63009);
...
//		     });     
		...
		cpYetaT63009.setLayout(new FlowLayout());
...
//	      	     }
//				 
//				YetaT63009GridPanel.getMsfGrid().clearData();
//				 
//				BaseModel bmData = YetaT63009GridPanel.getTableDef().getDefaultValues();  
//		              
...
//		         
//		        YetaT63009GridPanel.getMsfGrid().getGrid().stopEditing();      
//		        YetaT63009GridPanel.getMsfGrid().getGrid().getStore().insert(bmData,0);   
//		        YetaT63009GridPanel.getMsfGrid().getGrid().startEditing(YetaT63009GridPanel.getMsfGrid().getGrid().getStore().indexOf(bmData), 0);   
//
...
//			public void handleEvent(ButtonEvent e) {
//				Iterator<BaseModel> itBm = YetaT63009GridPanel.getMsfGrid().getGrid().getSelectionModel().getSelectedItems().listIterator();
...
//			public void handleEvent(ButtonEvent e) {
//				setListRecord(YetaT63009GridPanel.getMsfGrid().getStore().getModifiedRecords().iterator());
//				doAction(actionDatabase);
//
//				if ((ActionDatabase.INSERT).equals(actionDatabase)) {
//					actionDatabase = ActionDatabase.INSERT;
...
//				
//		cpYetaT63009.add(topYetaBtnBar);
...
//		YetaT63009GridPanel = new MSFGridPanel(YetaT63009Def, false, false, false, false, false);
//		YetaT63009GridPanel.setSize("790px", "420px");
//		YetaT63009GridPanel.setBorders(true);
//		YetaT63009GridPanel.setHeaderVisible(false);
...
//		
//		YetaT63009GridPanel.getGrid().getColumnModel().addAggregationRow(payrSummaryRow);  
//		
...
//		
//		YetaT63009GridPanel.getGrid().getColumnModel().addAggregationRow(payrSummaryRow1);
//		/** --- 그리드 합계 부분  종료 --- **/
		
//        cpYetaT63009.add(YetaT63009GridPanel);
		...
		cpYetaT63009.add(layoutContainer);
		cpYetaT63009.add(layoutContainer20);
		cpYetaT63009.add(layoutContainer21);
		cpYetaT63009.add(layoutContainer22);
	...
	public void reload() {
			...
			YetaT63009GridPanel.getTableDef().setTableColumnFilters(filters);
			YetaT63009GridPanel.getTableDef().addColumnFilter("yrtxBlggYr", MSFSharedUtils.allowNulls(srhYrtxBlggYr.getValue())
...
//					, SimpleColumnFilter.OPERATOR_EQUALS);//연말정산귀속년도
			YetaT63009GridPanel.getTableDef().addColumnFilter("clutSeptCd", MSFSharedUtils.getSelectedComboValue(srhClutSeptCd,"commCd")
					, SimpleColumnFilter.OPERATOR_EQUALS);//정산구분
			YetaT63009GridPanel.getTableDef().addColumnFilter("systemkey", MSFSharedUtils.allowNulls(systemkey.getValue())
					, SimpleColumnFilter.OPERATOR_EQUALS);//시스템키
		 
			YetaT63009GridPanel.reload();
