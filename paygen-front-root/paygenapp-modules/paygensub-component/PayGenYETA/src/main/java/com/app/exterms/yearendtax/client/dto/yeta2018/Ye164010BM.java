 ...
 */
public class Ye164010BM   extends MSFSimpleBaseModel implements IsSerializable  {
    ...
    public static final String ATTR_MDXPSVVALKRNCD = "mdxpsVvalKrnCd";
    
    /** set 의료비국세자료구분코드 : mdxpsVvalKrnCd */
    public static final String ATTR_MDXPSVVALKRNNM = "mdxpsVvalKrnNm";
    ...
    /** set 의료비국세자료구분코드 : mdxpsVvalKrnCd */
    public void setMdxpsVvalKrnCd(String  mdxpsVvalKrnCd) { set( ATTR_MDXPSVVALKRNCD ,mdxpsVvalKrnCd);}
    /** get 의료비국세자료구분코드 : mdxpsVvalKrnCd */
    public String  getMdxpsVvalKrnCd() { return (String )get( ATTR_MDXPSVVALKRNCD );}
    
    /** set 의료비국세자료구분코드 : mdxpsVvalKrnNm */
    public void setMdxpsVvalKrnNm(String  mdxpsVvalKrnNm) { set( ATTR_MDXPSVVALKRNNM ,mdxpsVvalKrnNm);}
    /** get 의료비국세자료구분코드 : mdxpsVvalKrnNm */
    public String  getMdxpsVvalKrnNm() { return (String )get( ATTR_MDXPSVVALKRNNM );}
