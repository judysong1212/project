...
import com.app.exterms.yearendtax.client.service.yeta2023.YetaT83012Service;
import com.app.exterms.yearendtax.client.service.yeta2023.YetaT83012ServiceAsync;
...
=====================================================**/
public  class YetaT83012   extends MSFFormPanel {  
 ...
 **/
	...
	private  ContentPanel cpYetaT83012; 
	...
	// -------------- grid 선언 시작  ---------------	  
	private MSFGridPanel YetaT83012GridPanel;
//	private YetaT83012Def YetaT83012Def = new YetaT83012Def("YetaT83012");   //TODO 일단 화면번호로 Def
	// -------------- grid 선언 종료  ---------------
	...
	// -------------- 서비스 호출 시작 --------------
	private YetaT83012ServiceAsync yetaT83012Service = YetaT83012Service.Util.getInstance();
	// -------------- 서비스 호출 종료 --------------	 
...
//					ye162510Dto.setMnthRnttyHusCnttArea((MSFSharedUtils.allowNulls(bmMapModel.get("mnthRnttyHusCnttArea"))));    		/** column 월세주택계약면적 : mnthRnttyHusCnttArea */
				...
				yetaT83012Service.activityOnYetaT83012(listYe162510Dto, actionDatabase, new AsyncCallback<Long>(){
...
//		 }
	...
	public YetaT83012(final ActionDatabase actionDatabase, final MSFPanel caller) {
...
//		initLoad(); 	
		...
		this.actionDatabase = actionDatabase;
	 	...
	 	cpYetaT83012 = new ContentPanel();  

		createSearchForm();			//기본정보 필드를 적용
	 	createMsfGridForm();		//그리드필드
		   
		cpYetaT83012.setBodyBorder(false);
		cpYetaT83012.setBorders(false);
		cpYetaT83012.setHeaderVisible(false);
		cpYetaT83012.setSize("790px", "640px");
		   
		this.add(cpYetaT83012);
...
//		     });     
		...
		cpYetaT83012.setLayout(new FlowLayout());
...
//	      	     }
//				 
//				YetaT83012GridPanel.getMsfGrid().clearData();
//				 
//				BaseModel bmData = YetaT83012GridPanel.getTableDef().getDefaultValues();  
//		              
...
//		         
//		        YetaT83012GridPanel.getMsfGrid().getGrid().stopEditing();      
//		        YetaT83012GridPanel.getMsfGrid().getGrid().getStore().insert(bmData,0);   
//		        YetaT83012GridPanel.getMsfGrid().getGrid().startEditing(YetaT83012GridPanel.getMsfGrid().getGrid().getStore().indexOf(bmData), 0);   
//
...
//			public void handleEvent(ButtonEvent e) {
//				Iterator<BaseModel> itBm = YetaT83012GridPanel.getMsfGrid().getGrid().getSelectionModel().getSelectedItems().listIterator();
...
//				
		...
		btnYetaSave.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				setListRecord(YetaT83012GridPanel.getMsfGrid().getStore().getModifiedRecords().iterator());
				doAction(actionDatabase);
...
//				
		cpYetaT83012.add(topYetaBtnBar);
...
//		YetaT83012GridPanel = new MSFGridPanel(YetaT83012Def, false, false, false, false, false);
//		YetaT83012GridPanel.setSize("790px", "420px");
//		YetaT83012GridPanel.setBorders(true);
//		YetaT83012GridPanel.setHeaderVisible(false);
...
//		
//		YetaT83012GridPanel.getGrid().getColumnModel().addAggregationRow(payrSummaryRow);  
//		
...
//		
//		YetaT83012GridPanel.getGrid().getColumnModel().addAggregationRow(payrSummaryRow1);
//		/** --- 그리드 합계 부분  종료 --- **/
		
//        cpYetaT83012.add(YetaT83012GridPanel);
...
//		layoutContainer7.setStyleAttribute("marginBottom", "5px")
		...
		cpYetaT83012.add(fldstNewFieldset_1);
		cpYetaT83012.add(fldstNewFieldset_4);
	...
	public void reload() {
			...
			YetaT83012GridPanel.getTableDef().setTableColumnFilters(filters);
			YetaT83012GridPanel.getTableDef().addColumnFilter("yrtxBlggYr", MSFSharedUtils.allowNulls(srhYrtxBlggYr.getValue())
...
//					, SimpleColumnFilter.OPERATOR_EQUALS);//연말정산귀속년도
			YetaT83012GridPanel.getTableDef().addColumnFilter("clutSeptCd", MSFSharedUtils.getSelectedComboValue(srhClutSeptCd,"commCd")
					, SimpleColumnFilter.OPERATOR_EQUALS);//정산구분
			YetaT83012GridPanel.getTableDef().addColumnFilter("systemkey", MSFSharedUtils.allowNulls(systemkey.getValue())
					, SimpleColumnFilter.OPERATOR_EQUALS);//시스템키
		 
			YetaT83012GridPanel.reload();
