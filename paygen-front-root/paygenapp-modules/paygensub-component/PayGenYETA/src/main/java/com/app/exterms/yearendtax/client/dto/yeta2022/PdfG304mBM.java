 ...
 */
public class PdfG304mBM   extends MSFSimpleBaseModel implements IsSerializable  {
    ...
    /** set 직불카드월별공제대상금액 : dirCardMmAmt */
    public void setDirCardMmAmt(Long  dirCardMmAmt) { set( ATTR_DIRCARDMMAMT ,dirCardMmAmt);}
    /** get 직불카드월별공제대상금액 : dirCardMmAmt */
    public Long  getDirCardMmAmt() { return (Long )get( ATTR_DIRCARDMMAMT );}
