...
import com.app.exterms.yearendtax.server.vo.Ye160404Srh_2021_VO;
 ...
 */
@Service("YetaP63006Service")
public class YetaP63006ServiceImpl  extends AbstractCustomServiceImpl implements YetaP63006Service , YetaDaoConstants {
	 
	private static final Logger logger = LoggerFactory.getLogger(YetaP63006ServiceImpl.class);
	private static final String calledClass = YetaP63006ServiceImpl.class.getName();
	...
	private Ye160405_2021_DAO ye160405DAO;
	...
	@Override
	public Long activityOnYetaP63006ToYe160404(List<Ye160404DTO> listYe160404Dto, ActionDatabase actionDatabase) throws MSFException {
			// TODO Auto-generated method stub
			Long result = new Long(0);
			Long iCnt = new Long(0);
			
			MSFSysm0100BM sessionUser;
			String method = calledClass + ".activityOnYetaP63006ToYe160404";
			
			String windowNm = "소득공제신고자료관리";
			String windowId = "YETAP630006";
			Ye160404DTO ye160404Dto = new Ye160404DTO();  
			Ye160404_2021_VO ye160404Vo = new Ye160404_2021_VO();
			Ye160405_2021_VO ye160405Vo = new Ye160405_2021_VO();
			Ye160406_2021_VO ye160406Vo = new Ye160406_2021_VO();
			...
			try {  
				if (MSFSharedUtils.paramNull(ye160404DAO)) {
					...
					ye160404DAO = (Ye160404_2021_DAO) wac.getBean("Ye160404_2021_DAO"); 
				}
				
				if(MSFSharedUtils.paramNull(ye160405DAO)) {
					WebApplicationContext wac = WebApplicationContextUtils.getRequiredWebApplicationContext( getHttpServletRequest().getSession().getServletContext());
					ye160405DAO = (Ye160405_2021_DAO) wac.getBean("Ye160405_2021_DAO"); 
				}
				
				
				if(MSFSharedUtils.paramNull(ye160406DAO)) {
					WebApplicationContext wac = WebApplicationContextUtils.getRequiredWebApplicationContext( getHttpServletRequest().getSession().getServletContext());
					ye160406DAO = (Ye160406_2021_DAO) wac.getBean("Ye160406_2021_DAO"); 
				}
				...
				for(int iPsnlCnt=0;iPsnlCnt < listYe160404Dto.size();iPsnlCnt++) {
					 ...
					 * 1. 종전근무처 작업
					 * **/
					ye160404Vo = new Ye160404_2021_VO();     
					 ...
					 * **/
					ye160405Vo = new Ye160405_2021_VO();
					...
					ye160406Vo = new Ye160406_2021_VO();
		        	...
		        	switch (actionDatabase) {
		        		case INSERT:
		        			...
		        			ye160404DAO.insertYetaP63006ToYe160404(ye160404Vo); 
		        			ye160405DAO.insertYetaP63006ToYe160405(ye160405Vo); 
		        			ye160406DAO.insertYetaP63006ToYe160406(ye160406Vo); 
		            	...
		            	case UPDATE:
		            		...
		            		ye160404DAO.updateYetaP63006ToYe160404(ye160404Vo);
		            		...
		            		ye160406DAO.updateYetaP63006ToYe160406(ye160406Vo);
		        			
		            		break;
		            		
		            	case DELETE: 
		            		
		            		ye160406DAO.deleteYetaP63006ToYe160406(ye160406Vo); 
		            		ye160405DAO.deleteYetaP63006ToYe160405(ye160405Vo); 
		            		ye160404DAO.deleteYetaP63006ToYe160404(ye160404Vo); 
				...
				logger.error("EXCEPTION calling activityOnYetaP63006ToYe160404(): "+ ex); 
				...
				result = new Long(0);
				throw MSFServerUtils.getOperationException("activityOnYetaP63006ToYe160404", ex, logger);
			}
			finally {
	...
	//종전근무지 조회
	public PagingLoadResult<BaseModel> getYetaP63006ToYe160404List(ServiceParameters serviceParameters) throws MSFException {
			
		PagingLoadResult<BaseModel> retval = null;
		String method = CLASS_YETAP63006_TO_YE160404_DATA_LIST;
		Ye160404Srh_2021_VO ye160404SrhVo = new Ye160404Srh_2021_VO();
		...
		try {
		    ...
		    if ( pagingValues.executeRecordCount ) { 
		    	...
		    	int iResultCnt = ye160404DAO.selectYetaP63001ToYe160404ListtTotCnt(ye160404SrhVo);  
		     	...
		     	TimingInfo millisBeginYeta4100DataList = SmrmfUtils.startTiming(logger);
...
//		            Collection<Map<String, Object>> list ??????
		     	List list = ye160404DAO.selectYetaP63001ToYe160404List(ye160404SrhVo);
				...
				SmrmfUtils.endTiming(logger, millisBeginYeta4100DataList, "getYetaP63006To4100List");
