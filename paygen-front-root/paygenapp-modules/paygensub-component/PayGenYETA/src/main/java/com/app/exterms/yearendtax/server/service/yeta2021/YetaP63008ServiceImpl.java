...
@Service("YetaP63008Service")
public class YetaP63008ServiceImpl  extends AbstractCustomServiceImpl implements YetaP63008Service  ,YetaDaoConstants {

	 
	private static final Logger logger = LoggerFactory.getLogger(YetaP63008ServiceImpl.class);
	private static final String calledClass = YetaP63008ServiceImpl.class.getName();
	...
	public Long activityOnYetaP63008ToYe160403(Ye160403DTO ye160403Dto, ActionDatabase actionDatabase) throws MSFException {
		...
		String method = calledClass + ".activityOnYetaP63008ToYe160403";

		String windowNm = "소득공제신고자료관리";
		String windowId = "YETAP6300";
			
		Ye160403_2021_VO ye160403Vo = new Ye160403_2021_VO(); 
		...
		try {
			...
			if (MSFSharedUtils.paramNull(ye160403DAO)) {
				...
				ye160403DAO = (Ye160403_2021_DAO) wac.getBean("Ye160403_2021_DAO"); 
			}
			...
			ye160403DAO.updateYetaP63008ToYe160403(ye160403Vo); 
		          
		} catch (Exception ex) {
			logger.error("EXCEPTION calling activityOnYetaP63008ToYe160403(): "+ ex);
			...
			result = new Long(0);
			throw MSFServerUtils.getOperationException("activityOnYetaP63008ToYe160403", ex, logger);
	...
	public Ye160403DTO getYetaP63008ToYe160403List(Ye160403DTO ye160403Dto) throws MSFException {
		...
		Ye160403Srh_2021_VO ye160403SrhVo = new Ye160403Srh_2021_VO();
		MSFSysm0100BM sessionUser;

		String method = calledClass + ".getYetaP63008ToYe160403List";
		...
		try {
			...
			egovResultDataList = ye160403DAO.selectYetaP63008ToYe160403List(ye160403SrhVo);
