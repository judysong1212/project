...
import com.app.exterms.yearendtax.client.dto.yeta2017.Ye161005BM;
...
import com.app.exterms.yearendtax.client.form.defs.yeta2017.Ye17Ta1000Def;
import com.app.exterms.yearendtax.client.service.yeta2017.Yeta2400Service;
import com.app.exterms.yearendtax.client.service.yeta2017.Yeta2400ServiceAsync;
 ...
 * =====================================================
 **/
public class Yeta2400 extends MSFPanel {
	...
	private FormPanel plFrmYeta2400;
	private FormData formData;
	private String txtForm = "";
	private XTemplate detailTp;
	private MSFGridPanel msfGridPanel;
	private Ye17Ta1000Def ye17Ta1000def = new Ye17Ta1000Def("YETA2400");
...
//	private MSFGridPanel typOccuCdGridPanel;
	 ...
	 **/
	// ---------- 상단 버튼 시작 ----------
	private ButtonBar topYeta2400Bar;
	private Button btnYeta2400Reset;	//초기화
	private Button btnYeta2400Save;		//저장
	private Button btnYeta2400Search;	//조회
	// ---------- 상단 버튼 종료 ----------
	
	// ---------- 엑셀 버튼 시작 ----------
	private ButtonBar exYeta2400Bar;	
...
//	private Yeta0100ServiceAsync yeta0100Service = Yeta0100Service.Util.getInstance();
	private Yeta2400ServiceAsync yeta2400Service = Yeta2400Service.Util.getInstance();
	// -------------- 서비스 호출 종료 --------------
	 ...
	 */
	private void checkYeta2400Auth(String authAction, ListStore<BaseModel> bm) {
	 ...
	 private void authExecEnabled() { 
		 ...
		 /**
			...
			creYrtxBlggYr.setValue(lsClutYrStore.findModel("year", "2017"));
			yrtxBlggYr.setValue(lscreClutYrStore.findModel("year", "2017"));
...
//			formData = new FormData("-650");
			...
			createYeta2400Form();	// 화면 기본정보를 설정
	...
	public Yeta2400(String txtForm) {
...
//
		...
		plFrmYeta2400.setLayout(new FlowLayout());
		...
		lscreEmymtDivCd.addStoreListener(new StoreListener<BaseModel>() {
			public void handleEvent(StoreEvent<BaseModel> be) {
				...
				if (type == Store.Add) {
					 ...
					 * ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
					 */
					checkYeta2400Auth("creEmymtDivCd", lscreEmymtDivCd);
				}
			}
		});
		...
		creDeptCd.getStore().addStoreListener(new StoreListener<ModelData>() {
			public void handleEvent(StoreEvent<ModelData> be) {
				...
				if (type == Store.Add) {
					 ...
					 * ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
					 */
					checkYeta2400Auth("creDeptCd", lscreDeptCd);
				}
			}
		});
		...
		creTypOccuCd.getStore().addStoreListener(new StoreListener<ModelData>() {
			public void handleEvent(StoreEvent<ModelData> be) {
				...
				if (type == Store.Add) {
					 ...
					 * ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
					 */
					//checkYeta2400Auth("creTypOccuCd", lsTypOccuCd);
				}
			}
		});
...
//					
//					Ye16Ta1005DTO ye161005ExDto = new Ye16Ta1005DTO();
////					ye161005ExDto.setDpobCd(dpobCd.getValue());
//					ye161005ExDto.setWhdgTxRegrstDeptCd(MSFSharedUtils.getSelectedComboValue(creYetaDpcd, "yetaDpcd"));
//					lscreBusoprRgstnum = YetaComboUtils.getYeta2000busoprRgstnumList(ye161005ExDto);
...
//		utDpobChk.setLabelSeparator("미맵핑");
...
//		PayrMangDeptCd = new HiddenField<String>(); //급여관리부서코드 
		...
		// 파일업로드 처리
		plFrmYeta2400.setAction("myurl");
		plFrmYeta2400.setEncoding(Encoding.MULTIPART);
		plFrmYeta2400.setMethod(Method.POST);

		plFrmYeta2400.setSize("990px", "820px");
		plFrmYeta2400.setLayout(new FlowLayout());
...
//		layoutContainer1_4.setStyleAttribute("marginBottom", "10px");
		...
		exYeta2400Bar = new ButtonBar();
		exYeta2400Bar.setAlignment(HorizontalAlignment.RIGHT);

		/*
		btnYetaVerifiction= new Button("신고사전검증");
		exYeta2400Bar.add(btnYetaVerifiction);
		...
		exYeta2400Bar.add(btnYetaExImport);

		btnYetaExSave= new Button("신고파일생성");
		exYeta2400Bar.add(btnYetaExSave);
		...
		layoutContainer11.add(exYeta2400Bar);
		...
		plFrmYeta2400.add(layoutContainer1_4,new com.extjs.gxt.ui.client.widget.layout.ColumnData(1));	// 텍스트와 버튼
...
//		});
	...
	private void createYeta2400Form() {

		plFrmYeta2400 = new FormPanel();
		plFrmYeta2400.setHeadingText(PayGenConst.PAYGEN_VERSION.concat(" - 연말정산신고파일생성"));
		plFrmYeta2400.setIcon(Resources.APP_ICONS.text());
		plFrmYeta2400.setPadding(2);
		plFrmYeta2400.setFrame(true);
		...
		plFrmYeta2400.getHeader().setStyleAttribute("padding", "5px 0 2px 0");
		plFrmYeta2400.getHeader().addTool(btnlogView); 
		/************************************************************************
		 * 화면 에러 처리시 필요한 부분으로 추가 
		 ************************************************************************/
		
		   //멀티콤보박스 닫기 
		plFrmYeta2400.addListener(Events.OnClick,new Listener<ComponentEvent>() { 
		            @Override
		            public void handleEvent(ComponentEvent ce) { 
...
//						                        }
	...
	private void createSearchForm() {
		...
		topYeta2400Bar = new ButtonBar();
		topYeta2400Bar.setAlignment(HorizontalAlignment.RIGHT);

		btnYeta2400Reset = new Button("초기화");
		btnYeta2400Reset.setIcon(MSFMainApp.ICONS.new16());
		btnYeta2400Reset.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				resetStandardForm();	//전자신고기본정보 초기화
			}
		});
		topYeta2400Bar.add(btnYeta2400Reset);

//		topBtn = new Button("신 규");
//		topBtn.setIcon(MSFMainApp.ICONS.new16());
//		topYeta2400Bar.add(topBtn);
...
//		buttonBar.add(topBtn);
		...
		btnYeta2400Save = new Button("저 장");
		btnYeta2400Save.setIcon(MSFMainApp.ICONS.save16());
		btnYeta2400Save.addListener(Events.Select, new Listener<ButtonEvent>() {
			@Override
		...
		topYeta2400Bar.add(btnYeta2400Save);

		btnYeta2400Search = new Button("조 회");
		btnYeta2400Search.setIcon(MSFMainApp.ICONS.search());
		btnYeta2400Search.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
...
//				ye161005Bm.setSrhBusinCd(MSFSharedUtils.getSelectedComboValue(srhBusinCd,"businCd"));
				...
				yeta2400Service.getYeta2400List(ye161005Dto, new AsyncCallback<Ye161005BM>(){
		...
		topYeta2400Bar.add(btnYeta2400Search);

//		topBtn = new Button("인 쇄");
//		topBtn.setIcon(MSFMainApp.ICONS.print16());
//		buttonBar.add(topBtn);
		
		plFrmYeta2400.add(topYeta2400Bar);
...
////		});
//
//		layoutContainer3.add(srhClutSeptCd, new FormData("100%"));
		layoutContainer3.setBorders(false);
		...
		lsEmymtDivCd.addStoreListener(new StoreListener<BaseModel>() {
			public void handleEvent(StoreEvent<BaseModel> be) {
				...
				if (type == Store.Add) {
					 ...
					 * ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
					 */
					checkYeta2400Auth("srhEmymtDivCd", lsEmymtDivCd);
				}
			}
		});
		...
		srhDeptCd.getStore().addStoreListener(new StoreListener<ModelData>() {
			public void handleEvent(StoreEvent<ModelData> be) {
				...
				if (type == Store.Add) {
					 ...
					 * ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
					 */
					checkYeta2400Auth("srhDeptCd", lsDeptCd);
				}
			}
		});
		...
		srhTypOccuCd.getStore().addStoreListener(new StoreListener<ModelData>() {
			public void handleEvent(StoreEvent<ModelData> be) {
				...
				if (type == Store.Add) {
					 ...
					 * ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
					 */
					//checkYeta2400Auth("srhTypOccuCd", lsTypOccuCd);
				}
			}
		});
...
////					Ye16Ta1005DTO ye161005ExDto = new Ye16Ta1005DTO();
//////					ye161005ExDto.setDpobCd(dpobCd.getValue());
////					ye161005ExDto.setWhdgTxRegrstDeptCd(MSFSharedUtils.getSelectedComboValue(srhYetaDpcd, "yetaDpcd"));
////					
////					yetaDpcd.setValue("");
////					yetaDpcd.setValue(ye161005ExDto.getWhdgTxRegrstDeptCd());
////					
////					lsBusoprRgstnum = YetaComboUtils.getYeta2000busoprRgstnumList(ye161005ExDto);
...
//					
//					ye161005Dto = new Ye161005DTO();
//					ye161005Bm = new Ye161005BM();
//					
////					ye161005Dto.setYrtxBlggYr(MSFSharedUtils.getSelectedComboValue(srhYrtxBlggYr,"year"));
//					ye161005Bm.setYrtxBlggYr(MSFSharedUtils.getSelectedComboValue(srhYrtxBlggYr,"year"));
//					
////					ye161005Dto.setClutSeptCd(MSFSharedUtils.getSelectedComboValue(srhClutSeptCd,"commCd"));
//					ye161005Bm.setClutSeptCd(MSFSharedUtils.getSelectedComboValue(srhClutSeptCd,"commCd"));
//				 
//////					ye161005Dto.setPayrMangDeptCd(MSFSharedUtils.getSelectedComboValue(srhPayrMangDeptCd,"payrMangDeptCd"));
////					ye161005Bm.setPayrMangDeptCd(MSFSharedUtils.getSelectedComboValue(srhPayrMangDeptCd,"payrMangDeptCd"));
////					
//////					ye161005Dto.setEmymtDivCd(MSFSharedUtils.getSelectedComboValue(srhEmymtDivCd,"commCd"));
////					ye161005Bm.setEmymtDivCd(MSFSharedUtils.getSelectedComboValue(srhEmymtDivCd,"commCd"));
////					
////					String strDeptCd = YetaUtils.getStrValToBMMultiCombo(lsDeptCd, srhDeptCd.getValue(),"deptNmRtchnt","deptCd");  
//////					ye161005Dto.setDeptCd(strDeptCd);
////					ye161005Bm.setDeptCd(strDeptCd);
////					
////					String strTypOccuCd = YetaUtils.getStrValToBMMultiCombo(lsTypOccuCd,srhTypOccuCd.getValue(),"typOccuNm","typOccuCd"); 
//////					ye161005Dto.setTypOccuCd(strTypOccuCd);
////					ye161005Bm.setTypOccuCd(strTypOccuCd);
////					
////					String strDtilOccuInttnCd = YetaUtils.getStrValToBMMultiCombo(lsDtilOccuInttnCd,srhDtilOccuInttnCd.getValue(),"dtilOccuClsNm","dtilOccuInttnCd");  
//////					ye161005Dto.setDtilOccuInttnCd(strDtilOccuInttnCd);
////					ye161005Bm.setDtilOccuInttnCd(strDtilOccuInttnCd);
////					
...
////					ye161005Bm.setBusinCd(strBusinCd);
////					ye161005Bm.setYetaDpcd(MSFSharedUtils.getSelectedComboValue(srhYetaDpcd, "yetaDpcd"));
//					ye161005Bm.setBusoprRgstnum(MSFSharedUtils.getSelectedComboValue(srhBusoprRgstnum, "busoprRgstnum")); 
//					yeta2400Service.getYeta2400List(ye161005Bm, new AsyncCallback<Ye161005BM>(){
//						@Override
//						public void onFailure(Throwable caught) {
//							MessageBox.alert(MSFMainApp.MSFCONSTANTS.Alert(), "조회에 실패하였습니다.", null);
//						}
...
//            	ye161005Dto = new Ye16Ta1000DTO();
//            	ye161005Dto.setDpobCd(dpobCd.getValue());
//				
//				ye161005Dto.setYrtxBlggYr(MSFSharedUtils.getSelectedComboValue(yrtxBlggYr,"year"));
//				ye161005Dto.setClutSeptCd(MSFSharedUtils.getSelectedComboValue(clutSeptCd,"commCd"));
//				ye161005Dto.setPayrMangDeptCd(PayrMangDeptCd.getValue());
//				ye161005Dto.setEdacSeilNum((Long) edacSeilNum.getValue());
//				
//				ye161005Dto.setEdacPrdt(YetaUtils.getConvertDateToString(edacPrdt, "yyyyMMdd"));//제출일자
...
//        cpGrid.add(gridFieldSet);
		...
		plFrmYeta2400.add(gridFieldSet);
//		plFrmYeta2400.add(msfGridPanel);
	}
...
//		layoutContainer1_5.setBorders(false);
//
//		plFrmYeta2400.add(layoutContainer1_5, new com.extjs.gxt.ui.client.widget.layout.ColumnData(1)); // 텍스트와 버튼
...
//		msfGridPanel.getTableDef().addColumnFilter("businCd", MSFSharedUtils.getSelectedComboValue(srhBusinCd,"businCd"), SimpleColumnFilter.OPERATOR_EQUALS);//사업
	...
	/** 정산 마감 및 풀기 **/
	private void finishYeta2400(final String flag) { 
...
//	    				ye161005Bm.setBusinCd(MSFSharedUtils.getSelectedComboValue(srhBusinCd,"businCd"));
	    			...
	    			//	ye17Ta1010Dto.setBusoprRgstnum(MSFSharedUtils.getSelectedComboValue(srhBusoprRgstnum, "busoprRgstnum"));
	      				...
	      				yeta2400Service.finishOnYe161005(ye17Ta1010Dto, new AsyncCallback<Long>(){
	                         public void onFailure(Throwable caught) {
...
//			} else { 
				msfGridPanel.callXlsExportServlet(GWT.getHostPageBaseURL() + "exp/XlsYeta2400Export.do","extgwtFrame" ,param);   
			//}
		}else{ 
			msfGridPanel.callXlsExportServlet(GWT.getHostPageBaseURL() + "exp/XlsYeta2400Export.do","extgwtFrame" ,param);  
		}
...
//		ye161005ExDto.setDpobCd(dpobCd.getValue());    														/** column 사업장코드 : dpobCd */
		...
		yeta2400Service.updateYe161005(ye161005ExDto, new AsyncCallback<Long>(){
			@Override
			public void onFailure(Throwable caught) {
...
//			if("".equals(MSFSharedUtils.getSelectedComboValue(srhBusinCd,"businCd"))){ 
			...
			//	MessageBox.alert(MSFMainApp.MSFCONSTANTS.Alert(), "사업명을 선택하십시요.", null);
			//} else { 
				msfGridPanel.callXlsExportServlet(GWT.getHostPageBaseURL() + "exp/FileYeta2400Export.do","extgwtFrame" ,param);   
			//}
		}else{ 
...
//							+ "  busoprRgstnum :  "  + param.get("busoprRgstnum"));
	...
	/*-----------------------------------------------------------------------------------------------------------------------------------
	 * 검증 추가 
	 *  @RequestMapping(value = "/exp/Yeta2400Verifiction.do") 
	 -------------------------------------------------------------------------------------------------------------------------------------*/
...
//		param.put("businCd", MSFSharedUtils.getSelectedComboValue(creBusinCd,"businCd"));
		...
		if(MSFSharedUtils.paramNull(param.get("resuNumb"))){
			...
			MessageBox.info("", "중간 생성부 부서 또는 원천징수부서는 필수 입니다.(택1)", null);
				...
				msfGridPanel.callXlsExportServlet(GWT.getHostPageBaseURL() + "exp/Yeta2400Verifiction.do","extgwtFrame" ,param);   
