...
@RemoteServiceRelativePath("Yeta6900Service.gwt")
public interface Yeta6900Service extends RemoteService {
	/**
	 * Utility class for simplifying access to the instance of async service.
	 */
	public static class Util {
		private static Yeta6900ServiceAsync instance;
		public static Yeta6900ServiceAsync getInstance(){
			if (instance == null) {
				instance = GWT.create(Yeta6900Service.class);
			}
			return instance;
		}
	}
    ...
    public Pyyt0304BM Yeta6900InfoList(Pyyt0304DTO Pyyt0304Dto) throws MSFException ;
