 ...
 */
public class Ye162520_2022_VO implements Serializable {
    ...
    private java.math.BigDecimal comrCalnSeilNum;
    ...
    private java.math.BigDecimal comrLoanItrtRate;

    /** set G21_금전소비대차_원리금상환액합계 : comrPclttAmtftAggr */
    private java.math.BigDecimal comrPclttAmtftAggr;

    /** set G22_금전소비대차_원금금액 : comrPrnilSum */
    private java.math.BigDecimal comrPrnilSum;

    /** set G23_금전소비대차_이자금액 : comrItrtSum */
    private java.math.BigDecimal comrItrtSum;

    /** set G24_금전소비대차_공제금액 : comrDducSum */
    private java.math.BigDecimal comrDducSum;
	...
	public java.math.BigDecimal getComrCalnSeilNum() {
		return comrCalnSeilNum;
	}

	public void setComrCalnSeilNum(java.math.BigDecimal comrCalnSeilNum) {
	...
	public java.math.BigDecimal getComrLoanItrtRate() {
		return comrLoanItrtRate;
	}

	public void setComrLoanItrtRate(java.math.BigDecimal comrLoanItrtRate) {
		this.comrLoanItrtRate = comrLoanItrtRate;
	}

	public java.math.BigDecimal getComrPclttAmtftAggr() {
		return comrPclttAmtftAggr;
	}

	public void setComrPclttAmtftAggr(java.math.BigDecimal comrPclttAmtftAggr) {
		this.comrPclttAmtftAggr = comrPclttAmtftAggr;
	}

	public java.math.BigDecimal getComrPrnilSum() {
		return comrPrnilSum;
	}

	public void setComrPrnilSum(java.math.BigDecimal comrPrnilSum) {
		this.comrPrnilSum = comrPrnilSum;
	}

	public java.math.BigDecimal getComrItrtSum() {
		return comrItrtSum;
	}

	public void setComrItrtSum(java.math.BigDecimal comrItrtSum) {
		this.comrItrtSum = comrItrtSum;
	}

	public java.math.BigDecimal getComrDducSum() {
		return comrDducSum;
	}

	public void setComrDducSum(java.math.BigDecimal comrDducSum) {
