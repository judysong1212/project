...
import com.app.exterms.yearendtax.client.dto.yeta2023.Ye160406BM;
...
public class Ye160404Def  extends TableDef implements YetaDaoConstants {
	...
	// 임의수정
    private static final String CLASS_YETAP83006_TO_YE160404_DATA_LIST = null;
...
//    private PayrConstants PayrLabel = PayrConstants.INSTANCE;
	...
	public Ye160404Def(String chkPayrDef) {
		...
		if ("YetaP83006".equals(chkPayrDef)) {
			// setTitle(PayrLabel.titlePayr0304());
			setDaoClass("");
			setCustomListMethod(CLASS_YETAP83006_TO_YE160404_DATA_LIST);
