 ...
 */
public class Ye16Ta3180DTO  implements Serializable {
...
/** set 기부금건수 : ctrbNcnt */
private Long ctrbNcnt;

/** set 공제대상기부금액 : ctrbTgam */
private Long ctrbTgam;

/** set 기부장려신청금액 : ctjaCham */
private Long ctjaCham;
 ...
 */
public Long getCtrbNcnt() {
	return ctrbNcnt;
}

/**
 * Comment : 
 *@fn void setCtrbNcnt(Long ctrbNcnt)
 *@brief date:2017 2017. 1. 16. user:atres-pc
 *@param ctrbNcnt the ctrbNcnt to set
 */
public void setCtrbNcnt(Long ctrbNcnt) {
 ...
 */
public Long getCtrbTgam() {
	return ctrbTgam;
}

/**
 * Comment : 
 *@fn void setCtrbTgam(Long ctrbTgam)
 *@brief date:2017 2017. 1. 16. user:atres-pc
 *@param ctrbTgam the ctrbTgam to set
 */
public void setCtrbTgam(Long ctrbTgam) {
 ...
 */
public Long getCtjaCham() {
	return ctjaCham;
}

/**
 * Comment : 
 *@fn void setCtjaCham(Long ctjaCham)
 *@brief date:2017 2017. 1. 16. user:atres-pc
 *@param ctjaCham the ctjaCham to set
 */
public void setCtjaCham(Long ctjaCham) {
