...
@Service("YetaT63017Service")
public class YetaT63017ServiceImpl  extends AbstractCustomServiceImpl implements YetaT63017Service ,YetaDaoConstants {
	 
	private static final Logger logger = LoggerFactory.getLogger(YetaT63017ServiceImpl.class);
	private static final String calledClass = YetaT63017ServiceImpl.class.getName();
	...
	@Override
	public Ye169010DTO getYetaP63017ToYe169010List(Ye169010DTO ye169010Dto)	throws MSFException {
		
		Ye169010aSrh_2021_VO ye169010aSrhVo = new Ye169010aSrh_2021_VO();
		MSFSysm0100BM sessionUser;

		String method = calledClass + ".getYetaP63017ToYe169010List";

		String windowNm = "표준세액공제";
		String windowId = "YETAP63017";
		...
		try {
			...
			egovResultDataList = ye169010ADao.selectYetaP63017ToYe169010List(ye169010aSrhVo);
