 ...
 */
public class PdfP101mBM   extends MSFSimpleBaseModel implements IsSerializable  {
    ...
    /** set 국민연금_직장가입자고지금액 : wrkpNtf */
    public void setWrkpNtf(Long  wrkpNtf) { set( ATTR_WRKPNTF ,wrkpNtf);}
    /** get 국민연금_직장가입자고지금액 : wrkpNtf */
    public Long  getWrkpNtf() { return (Long )get( ATTR_WRKPNTF );}

    /** set 국민연금_지역가입자등납입금액 : rgnPmt */
    public void setRgnPmt(Long  rgnPmt) { set( ATTR_RGNPMT ,rgnPmt);}
    /** get 국민연금_지역가입자등납입금액 : rgnPmt */
    public Long  getRgnPmt() { return (Long )get( ATTR_RGNPMT );}
