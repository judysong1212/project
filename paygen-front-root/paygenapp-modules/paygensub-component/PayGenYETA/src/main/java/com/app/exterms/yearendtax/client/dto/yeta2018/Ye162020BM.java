 ...
 */
public class Ye162020BM   extends MSFSimpleBaseModel implements IsSerializable  {
    ...
    /** get 퇴직연금소득공제구분코드 : rtpnAccRtpnCl */
