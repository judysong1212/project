...
import com.app.exterms.yearendtax.client.service.yeta2023.YetaP830010Service;
...
@Service("YetaP830010Service")
public class YetaP830010ServiceImpl  extends AbstractCustomServiceImpl implements YetaP830010Service  ,YetaDaoConstants {

	 
	private static final Logger logger = LoggerFactory.getLogger(YetaP830010ServiceImpl.class);
	private static final String calledClass = YetaP830010ServiceImpl.class.getName();
	...
	/** 현근무지비과세_감면소득 팝업 저장 **/
	@Override
	public int activityOnYetaP830010ToYe160405(Ye160405DTO ye160405Dto, ActionDatabase actionDatabase) throws MSFException {
		...
		String method = calledClass + ".activityOnYetaP830010ToYe160405";

		String windowNm = "소득공제신고자료관리";
		String windowId = "YETAP8300";
		...
		try {
			...
			String nResult = AnyCryptUtils.XecureCryptInitialize(RemoteServiceUtil.getThreadLocalConfig(),RemoteServiceUtil.getThreadLocalRequest());
				...
				result = ye160405DAO.updateYetaP830010ToYe160405(ye160405Vo); 
		          
		} catch (Exception ex) {
			logger.error("EXCEPTION calling activityOnYetaP830010ToYe160405(): "+ ex);
			...
			result = 0;
			throw MSFServerUtils.getOperationException("activityOnYetaP830010ToYe160405", ex, logger);
	...
	/** 현근무지비과세_비과세 감면소득 조회 **/
	public Ye160405DTO getYetaP830010ToYe160405List(Ye160405DTO ye160405Dto) throws MSFException {
		
		Ye160405Srh_2023_VO ye160405SrhVo = new Ye160405Srh_2023_VO();
		MSFSysm0100BM sessionUser;

		String method = calledClass + ".getYetaP830010ToYe160405List";

		String windowNm = "소득공제신고자료관리";
		String windowId = "YETAP830008";
		...
		try {
			...
			egovResultDataList = ye160405DAO.selectYetaP830010ToYe160405List(ye160405SrhVo);
