...
* </pre>
 */
@Service("YetaT43019Service")
public class YetaT43019ServiceImpl  extends AbstractCustomServiceImpl implements YetaT43019Service  ,YetaDaoConstants {

	 
	private static final Logger logger = LoggerFactory.getLogger(YetaT43019ServiceImpl.class);
	private static final String calledClass = YetaT43019ServiceImpl.class.getName();
	...
	@Override
	public Long activityOnYetaT43019ToYe162510(List<Ye162510DTO> listYe162510Dto, ActionDatabase actionDatabase) throws MSFException {
			...
			String method = calledClass + ".activityOnYetaT43019ToYe162510";
			
			String windowNm = "소득공제신고자료관리";
			String windowId = "YETAT43019";
...
//		            	if("0".equals(YETA4130Vo.getMnrnSqno())) {
				...
				result = iCnt;
		            ...
		            logger.error("EXCEPTION calling activityOnYetaT43019ToYe162510(): "+ ex); 
		            ...
		            result = new Long(0);
		            throw MSFServerUtils.getOperationException("activityOnYetaT43019ToYe162510", ex, logger);
		        }
		        finally {
	...
	//월세액소득공제명세 조회
	public PagingLoadResult<BaseModel> getYetaT43019ToYe162510List(ServiceParameters serviceParameters)throws MSFException {

		PagingLoadResult<BaseModel> retval = null;
		String method =  CLASS_YETAT13019TOYE162510_DATA_LIST;
		Ye162510Srh_2019_VO	ye162510Vo = new Ye162510Srh_2019_VO();
