...
* </pre>
 */
@Service("Yeta7200Service")
public class Yeta7200ServiceImpl  extends AbstractCustomServiceImpl implements Yeta7200Service  ,YetaDaoConstants {

	 
	private static final Logger logger = LoggerFactory.getLogger(Yeta7200ServiceImpl.class);
	private static final String calledClass = Yeta7200ServiceImpl.class.getName();
	 ...
	 */
	//조회
	public PagingLoadResult<BaseModel> getYeta7200ToYe161010DataList(ServiceParameters serviceParameters) throws MSFException {
		

		PagingLoadResult<BaseModel> retval = null;
		String method =  CLASS_YETA7200_DATA_LIST;
...
//	            Collection<Map<String, Object>> list ??????
			...
			SmrmfUtils.endTiming(logger, millisBeginYeta7100ToYe161010DataList, "getYeta4100ToYe161010DataList");
	 ...
	 */
	//조회
	public PagingLoadResult<BaseModel> getYeta7200ToYe161010ResultDataList(ServiceParameters serviceParameters) throws MSFException {
