...
import com.app.exterms.yearendtax.client.service.yeta2023.Yeta8080Service;
import com.app.exterms.yearendtax.server.service.yeta2023.dao.Yeta8080_2023_DAO;
...
@Service("Yeta8080Service")
public class Yeta8080ServiceImpl extends AbstractCustomServiceImpl implements YetaDaoConstantsGenerated, Yeta8080Service {

	private static final Logger logger = LoggerFactory.getLogger(Yeta8080ServiceImpl.class);
	private static final String calledClass = Yeta8080ServiceImpl.class.getName();

	@Autowired
	@Resource(name = "Yeta8080_2023_DAO")
	private Yeta8080_2023_DAO yeta8080DAO;
	...
	public PagingLoadResult<BaseModel> getSelectYeta8080ToBass0400List(ServiceParameters serviceParameters) throws MSFException {

        PagingLoadResult<BaseModel> retval = null;
        String method =  CLASS_YETA2080_TO_BASS0400_LIST;
        Yeta2080Srh_2023_VO   yeta2080SrhVo = new Yeta2080Srh_2023_VO();
        //Yeta2080VO      Yeta2080Vo = new Yeta2080VO();
        List<BaseModel>  bmResult = new ArrayList<BaseModel>();
        MSFSysm0100BM sessionUser = MSFServerUtils.getLoggedUser(RemoteServiceUtil.getThreadLocalRequest());
        
        if(MSFSharedUtils.paramNull(yeta8080DAO)){
        	WebApplicationContext wac = WebApplicationContextUtils.getRequiredWebApplicationContext(getHttpServletRequest().getSession().getServletContext());
        	yeta8080DAO = (Yeta8080_2023_DAO) wac.getBean("Yeta8080_2023_DAO");
        }
        ...
        try{
            ...
            if(pagingValues.executeRecordCount){ 
            	...
            	int iResultCnt = yeta8080DAO.selectYeta8080ListTotCnt(yeta2080SrhVo);
            ...
            List list = yeta8080DAO.selectYeta8080List(yeta2080SrhVo);
            ...
            SmrmfUtils.endTiming(logger, millisBeginSelectYeta2080List, "selectYeta8080List");
