...
public interface YetaP03001ServiceAsync {
	
	/** 이월기부금 등록 팝업 수정 및 삭제 **/
	public void activityOnYetaP03001ToYeta3170(List<Yeta3170DTO> listYeta3170dto, ActionDatabase actionDatabase, AsyncCallback<Long> callback) ;
