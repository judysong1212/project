...
@Repository("Ye17Ta2000DAO")
public class Ye17Ta2000DAO extends EgovAbstractDAO implements IsSerializable {
    /**
	 * YETA2000을 삭제한다.
    ...
    public void fnYeta1100_YETA2000_2016_CREATE_Delete(Yeta2000VO vo) throws Exception {
        delete("ye17Ta2000DAO.fnYeta1100_YETA2000_2016_CREATE_Delete_S", vo);
    }  
    ...
    public List selectYeta1100ToYeta2000List(Yeta2000SrhVO yeta2000SrhVo) throws Exception {
        return list("ye17Ta2000DAO.selectYeta1100ToYeta2000List_D", yeta2000SrhVo);
    }
    ...
    public int selectYeta1100ToYeta2000ListTotCnt(Yeta2000SrhVO yeta2000SrhVo) {
        return (Integer)getSqlMapClientTemplate().queryForObject("ye17Ta2000DAO.selectYeta1100ToYeta2000ListTotCnt_S", yeta2000SrhVo);
    }
    ...
    public void updateYeta2000YetaDpcd(Yeta2000VO vo) throws Exception {
    	update("ye17Ta2000DAO.updateYeta2000YetaDpcd_S", vo);
    }
    ...
    public List selectFinYeta2000List(Yeta2000VO yeta2000VO) throws Exception {
        ...
        return  list("ye17Ta2000DAO.selectFinYeta2000List", yeta2000VO);
    }
    /**
	 * 연말정산 마감 처리를 한다.
	 */
    ...
    public void finishYeta0400List(Yeta2000VO vo) throws Exception {
        update("ye17Ta2000DAO.finishYeta2000_S", vo);
    }
    ...
    public List selectYeta2000YetaDpcdList(Yeta2000SrhVO yeta2000SrhVo) throws Exception {
        // TODO Auto-generated method stub
        return  list("ye17Ta2000DAO.selectYeta2000YetaDpcdList_D", yeta2000SrhVo);
    }
    ...
    public List selectYetaP110001List(InfcPsnl0100SrhVO   psnl0100SrhVO) throws Exception {
        return list("ye17Ta2000DAO.selectPsnl0100List_D", psnl0100SrhVO);
    }
    ...
    public int selectYetaP110001ListTotCnt(InfcPsnl0100SrhVO   psnl0100SrhVO) {
        return (Integer)getSqlMapClientTemplate().queryForObject("ye17Ta2000DAO.selectPsnl0100ListCnt_S", psnl0100SrhVO);
    }
    ...
    public List selectYeta0300To2000List(Yeta2000SrhVO Yeta2000SrhVo) throws Exception {
        return list("ye17Ta2000DAO.selectYeta0300To2000List", Yeta2000SrhVo);
    }
    ...
    public int selectYeta0300To2000ListTotCnt(Yeta2000SrhVO Yeta2000SrhVo) {
        return (Integer)getSqlMapClientTemplate().queryForObject("ye17Ta2000DAO.selectYeta0300To2000ListTotCnt_S", Yeta2000SrhVo);
    }
    ...
    /**
       ...
       public List selectYeta0300ToYeta2000List(Yeta2000SrhVO Yeta2000SrhVo) throws Exception {
           return list("ye17Ta2000DAO.selectYeta0300ToYeta2000List", Yeta2000SrhVo);
       }
       ...
       public int selectYeta0300ToYeta2000ListTotCnt(Yeta2000SrhVO Yeta2000SrhVo) {
           return (Integer)getSqlMapClientTemplate().queryForObject("ye17Ta2000DAO.selectYeta0300ToYeta2000ListTotCnt_S", Yeta2000SrhVo);
       }
    ...
    public int selectYeta2400GirdListTotCnt(Ye161010SrhVO ye161010SrhVo) {
        return (Integer)getSqlMapClientTemplate().queryForObject("ye17Ta2000DAO.selectYeta0400GirdListTotCnt_S", ye161010SrhVo);
    }
    ...
    public List selectYeta2400GirdList(Ye161010SrhVO ye161010SrhVo) throws Exception {
        return list("ye17Ta2000DAO.selectYeta0400GridToList_D", ye161010SrhVo);
    }
    ...
    public int selectYeta0500GirdListTotCnt(Yeta2000SrhVO Yeta2000SrhVo) {
        return (Integer)getSqlMapClientTemplate().queryForObject("ye17Ta2000DAO.selectYeta0500GirdListTotCnt_S", Yeta2000SrhVo);
    }
    ...
    public List selectYeta0500GirdList(Yeta2000SrhVO Yeta2000SrhVo) throws Exception {
        return list("ye17Ta2000DAO.selectYeta0500GridToList_D", Yeta2000SrhVo);
    }
    ...
    public void activityOnYeta0500List(Yeta2000VO vo) throws Exception {
    	update("ye17Ta2000DAO.updateYeta0500List", vo);
    }
    ...
    public void saveYeta0500Yeta2000_Y(Yeta2000VO vo) throws Exception {
    	update("ye17Ta2000DAO.updateYeta0500To2000_Y", vo);
    }
    ...
    public void saveYeta0500Yeta2000_N(Yeta2000VO vo) throws Exception {
    	update("ye17Ta2000DAO.updateYeta0500To2000_N", vo);
    }
    ...
    public void saveYeta0300To2000tabItem01(Yeta2000VO vo) throws Exception {
    	update("ye17Ta2000DAO.updateYeta0300To2000tabItem01", vo);
    }
    ...
    public void saveYeta0300To2000tabItem02(Yeta2000VO vo) throws Exception {
    	update("ye17Ta2000DAO.updateYeta0300To2000tabItem02", vo);
    }
    ...
    public void saveYeta0300To2000tabItem04(Yeta2000VO vo) throws Exception {
    	update("ye17Ta2000DAO.updateYeta0300To2000tabItem04", vo);
    }
    ...
    public void saveYeta0300To2000tabItem05_1(Yeta2000VO vo) throws Exception {
    	update("ye17Ta2000DAO.updateYeta0300To2000tabItem05_1", vo);
    }
    ...
    public void saveYeta0300To2000tabItem05_2(Yeta2000VO vo) throws Exception {
    	update("ye17Ta2000DAO.updateYeta0300To2000tabItem05_2", vo);
    }
    ...
    public void saveYeta0300To2000tabItem06(Yeta2000VO vo) throws Exception {
    	update("ye17Ta2000DAO.updateYeta0300To2000tabItem06", vo);
    }
    ...
    public void saveYeta0300To2000tabItem07(Yeta2000VO vo) throws Exception {
    	update("ye17Ta2000DAO.updateYeta0300To2000tabItem07", vo);
    }
    ...
    public void saveYeta0300To2000tabItem08_1(Yeta2000VO vo) throws Exception {
    	update("ye17Ta2000DAO.updateYeta0300To2000tabItem08_1", vo);
    }
    ...
    public void saveYeta0300To2000tabItem08_3(Yeta2000VO vo) throws Exception {
    	update("ye17Ta2000DAO.updateYeta0300To2000tabItem08_3", vo);
    }
    ...
    public void saveYeta0300To2000tabItem09(Yeta2000VO vo) throws Exception {
    	update("ye17Ta2000DAO.updateYeta0300To2000tabItem09", vo);
    }
    ...
    public void saveYeta0300To2000tabItem10(Yeta2000VO vo) throws Exception {
    	update("ye17Ta2000DAO.updateYeta0300To2000tabItem10", vo);
    }
    /***************************************************/
    /************* 소득공제신고자료관리 저장 쿼리 종료 *************/
    /***************************************************/
    ...
    public String insertYeta2000(Yeta2000VO vo) throws Exception {
        return (String)insert("ye17Ta2000DAO.insertYeta2000_S", vo);
    }
    ...
    public void updateYeta2000(Yeta2000VO vo) throws Exception {
        update("ye17Ta2000DAO.updateYeta2000_S", vo);
    }
    
    @Transactional
    public void updateYeta0300ToYeta2000_Item03(Yeta2000VO vo) throws Exception {
        update("ye17Ta2000DAO.updateYeta0300ToYeta2000_Item03", vo);
    }
    ...
    public void deleteYeta2000(Yeta2000VO vo) throws Exception {
        delete("ye17Ta2000DAO.deleteYeta2000_S", vo);
    }
    /**
	 * YETA2000을 삭제한다.
	 * @param vo - 삭제할 정보가 담긴 Yeta2000VO
    ...
    public void fnPayr06420_PAYR415_CREATE_Delete(Yeta2000VO vo) throws Exception {
        delete("ye17Ta2000DAO.fnPayr06420_PAYR415_CREATE_Delete_S", vo);
    }  
    ...
    public Yeta2000VO selectYeta2000(Yeta2000VO vo) throws Exception {
        return (Yeta2000VO) selectByPk("ye17Ta2000DAO.selectYeta2000_S", vo);
    }
    ...
    public List<?> selectYeta2000List(Yeta2000SrhVO searchVO) throws Exception {
        return list("ye17Ta2000DAO.selectYeta2000List_D", searchVO);
    }
    ...
    public int selectYeta2000ListTotCnt(Yeta2000SrhVO searchVO) {
        return (Integer)getSqlMapClientTemplate().queryForObject("ye17Ta2000DAO.selectYeta2000ListTotCnt_S", searchVO);
    }
    ...
    public List selectYeta0100ToYeta2000XlsList(Yeta2000SrhVO searchVO) throws Exception {
        return list("ye17Ta2000DAO.selectYeta0100ToYeta2000XlsList", searchVO);
    }
   ...
   public List selectYeta0400ToYeta2000XlsList(Yeta2000SrhVO Yeta2000SrhVo) throws Exception {
       return list("ye17Ta2000DAO.selectYeta0400ToYeta2000XlsList", Yeta2000SrhVo);
   }
	 ...
	 * @exception Exception
	 */
    public List selectYeta2500ToYeta2000XlsList(Yeta2000SrhVO searchVO) throws Exception {
        return list("ye17Ta2000DAO.selectYeta2500ToYeta2000XlsList", searchVO);
    }
    ...
    public List<?> selectYeta0100ToYeta2000List(Yeta2000SrhVO searchVO) throws Exception {
        return list("ye17Ta2000DAO.selectYeta0100ToYeta2000List_D", searchVO);
    }
    ...
    public int selectYeta0100ToYeta2000ListTotCnt(Yeta2000SrhVO searchVO) {
        return (Integer)getSqlMapClientTemplate().queryForObject("ye17Ta2000DAO.selectYeta0100ToYeta2000ListTotCnt_S", searchVO);
    }
    ...
    /**
       ...
       public List<?> selectYeta1200ToYeta2000List(Yeta2000SrhVO searchVO) throws Exception {
           return list("ye17Ta2000DAO.selectYeta1200ToYeta2000List_D", searchVO);
       }
       ...
       public int selectYeta1200ToYeta2000ListTotCnt(Yeta2000SrhVO searchVO) {
           return (Integer)getSqlMapClientTemplate().queryForObject("ye17Ta2000DAO.selectYeta1200ToYeta2000ListTotCnt_S", searchVO);
       }
       
       
       public List<?> fnPayr06430_PAYR450_DelSelect(Yeta2000SrhVO searchVO) throws Exception {
           return list("ye17Ta2000DAO.fnPayr06430_PAYR450_DelSelect_D", searchVO);
       }
       ...
       /**
          ...
          public List<Yeta2000VO> selectYeta0300AllToYeta2000List(Yeta2000SrhVO searchVO) throws Exception {
              return list("ye17Ta2000DAO.selectYeta0300AllToYeta2000List_D", searchVO);
          }
