...
import com.app.exterms.yearendtax.client.dto.yeta2018.Ye160401DTO;
...
import com.app.exterms.yearendtax.server.service.yeta2018.dao.Yeta1100_2018_DAO;
...
* </pre>
 */
@Service("Yeta3100Service")
public class Yeta3100ServiceImpl  extends AbstractCustomServiceImpl implements Yeta3100Service  ,YetaDaoConstants {

	 
	private static final Logger logger = LoggerFactory.getLogger(Yeta3100ServiceImpl.class);
	private static final String calledClass = Yeta3100ServiceImpl.class.getName();

	@Autowired
	@Resource(name = "Yeta1100_2018_DAO")
	private Yeta1100_2018_DAO yeta1100DAO;
	...
	private Ye160401_2018_DAO ye160401DAO;
	
	// 감면소득_과세
	@Autowired
	@Resource(name = "Ye160402_2018_DAO")
	private Ye160402_2018_DAO ye160402DAO;
	...
	private Ye160406_2018_DAO ye160406DAO;
	 ...
	 */
	//조회
	public PagingLoadResult<BaseModel> getYeta3100ToYe161010DataList(ServiceParameters serviceParameters) throws MSFException {
		

		PagingLoadResult<BaseModel> retval = null;
		String method =  CLASS_YETA3100_DATA_LIST;
...
//	            Collection<Map<String, Object>> list ??????
			...
			SmrmfUtils.endTiming(logger, millisBeginYeta2100ToYe161010DataList, "getYeta3100ToYe161010DataList");
     ...
     */
    @Override
    public  Long PayrExec_Yeta_2018_Insert(List<Ye161010DTO> listYe161010Dto) throws MSFException {
	    	 
    	 
		String method = calledClass + ".PayrExec_Yeta_Insert_2018";
		...
		Ye160402_2018_VO ye160402Vo = new Ye160402_2018_VO(); // 과세감면소득
		Ye160403_2018_VO ye160403Vo = new Ye160403_2018_VO(); // 비과세감면소득
		...
		//List<InfcPkgYe160401VO> listYe160401VO = new ArrayList<InfcPkgYe160401VO>();
     	...
     	//    {******************************급여자료 이관*******************************************}
			...
			//	BeanUtils.copyProperties(ye169010Vo, ye161010Vo);
		       ...
		       // [과세감면내역 삭제 ]
		        ye160401DAO.fnYeta3100_Ye160401_CREATE_Delete(ye160401Vo);
...
//				}				
				...
				yetaLsAdtr.setPayrToYeta_2018_Insert(RemoteServiceUtil.getThreadLocalRequest(),listYe161010VO);
			...
			logger.error("EXCEPTION calling PayrExec_Yeta_Insert_2018(): " + ex);
			
			/** 에러 로그 **/
			MSFLogHistoryUtils.tracerUserExceptionActivity(sessionUser, method,calledClass, "C", ex, windowNm, windowId);
		
			retval = 0L;
			throw MSFServerUtils.getOperationException("PayrExec_Yeta_Insert_2018", ex, logger);
		}
     ...
     */
    @Override
    public  Long Yeta3100ToYe160401_Delete(List<Ye161010DTO> listYe161010Dto) throws MSFException {
    	
		String method = calledClass + ".Yeta3100ToYe160401_Delete";

		String windowNm = "연말정산대상자관리";
		String windowId = "YETA3100";
...
//		Ye161020VO ye161020Vo = new Ye161020VO(); // 인적소득공제기본
	...
	@Override
	public Long UpDpobExec_Yeta_2018_Insert(List<Ye161010DTO> listYe161010Dto) throws MSFException {
		 
   	 
			String method = calledClass + ".UpDpobExec_Yeta_Insert_2018";
			...
			List<InfcPkgYe161010_2018_VO> listYe161010VO = new ArrayList<InfcPkgYe161010_2018_VO>();
	     	...
	     	//    {******************************급여자료 이관*******************************************}
				...
				if (listYe161010VO.size() > 0) {
					...
					// 컴포넌트 호출하기
					yetaLsAdtr.setUpDpopYeta_2018_Insert(RemoteServiceUtil.getThreadLocalRequest(),listYe161010VO);
				...
				logger.error("EXCEPTION calling UpDpobExec_Yeta_Insert_2018(): " + ex);
				
				/** 에러 로그 **/
				MSFLogHistoryUtils.tracerUserExceptionActivity(sessionUser, method,calledClass, "U", ex, windowNm, windowId);
			
				retval = 0L;
				throw MSFServerUtils.getOperationException("UpDpobExec_Yeta_Insert_2018", ex, logger);
			}
