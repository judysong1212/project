...
import com.app.exterms.yearendtax.client.form.defs.yeta2018.Yeta3070Def;
import com.app.exterms.yearendtax.client.service.yeta2018.Yeta3070Service;
import com.app.exterms.yearendtax.client.service.yeta2018.Yeta3070ServiceAsync;
...
=====================================================**/
public class Yeta3070  extends MSFPanel { 
	...
	private FormPanel plFrmYeta3070;
	private FormData formData; 
	private String txtForm = "";
	private XTemplate detailTp;	  
	private Yeta3070ServiceAsync Yeta3070service = Yeta3070Service.Util.getInstance(); 
	...
	private Yeta3070Def Yeta3070MSDef = new Yeta3070Def("Yeta3070MS");
	private InfcPkgBass0150Def Yeta3070ToBass0150Def = new InfcPkgBass0150Def("yeta3070ToBass0150");
	private InfcPkgBass0500Def Yeta3070ToBass0500OnDef = new InfcPkgBass0500Def("YETA3070_BASS0500_ON");
	private InfcPkgBass0500Def Yeta3070ToBass0500OffDef = new InfcPkgBass0500Def("YETA3070_BASS0500_OFF");

	private MSFGridPanel msfGridPanelYeta3070MS; 
	...
	public ContentPanel getViewPanel() {
		if (panel == null) {        	
			...
			msfGridPanelYeta3070MS.reload();
			msfGridPanelBass0150.reload();

			//			final RelationDef  relBass0360 = new RelationDef(Yeta3070MSDef,false);
			//			relBass0360.addJoinDef("utDpobCd", "utDpobCd"); 
			//			relBass0360.setLinkedObject(msfGridPanelYeta3070MS);
			//			Yeta3070ToBass0500OnDef.addRelation(relBass0360); 
			//
			//			/**
			//			 * Create the relations 
			//			 */
			//			final RelationDef  relBass0350 = new RelationDef(Yeta3070MSDef,false);
			//			relBass0350.addJoinDef("utDpobCd", "utDpobCd"); 
			//			relBass0350.setLinkedObject(msfGridPanelYeta3070MS);
			//			Yeta3070ToBass0500OffDef.addRelation(relBass0350); 
			//
			//
			//			// DETAILS 
			//			final Grid Yeta3070ToBass0500OffDefGrid = msfGridPanelYeta3070MS.getMsfGrid().getGrid();
			//			Yeta3070ToBass0500OffDefGrid.addListener(Events.CellDoubleClick, new Listener<BaseEvent>() {
			//				public void handleEvent(BaseEvent be) {  
			//					if (msfGridPanelYeta3070MS.getCurrentlySelectedItem() != null) {  
			//
			//						Yeta3070ToBass0500OnDef.synchronizeGridDetail(
			//								msfGridPanelYeta3070MS.getCurrentlySelectedItem(),
			//								msfGridPanelBass0500On );
			//
			//						Yeta3070ToBass0500OffDef.synchronizeGridDetail(
			//								msfGridPanelYeta3070MS.getCurrentlySelectedItem(),
	...
	public Yeta3070(String txtForm) {
		this.txtForm = txtForm;
	}		  

	private void createSysm0500Form() {

		plFrmYeta3070 = new FormPanel();
		plFrmYeta3070.setHeadingText("PayGen Ver1.0 - 단위사업장사업관리");
		plFrmYeta3070.setIcon(Resources.APP_ICONS.text());
		plFrmYeta3070.setBodyStyleName("pad-text");
		plFrmYeta3070.setFrame(true); 
		plFrmYeta3070.setPadding(2);
		/************************************************************************
		...
		btnlogView.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				//로그 뷰화면 호출 메서드 
				funcLogMessage("단위사업장사업관리","Yeta3070");
			}
		});
		plFrmYeta3070.getHeader().setStyleAttribute("padding", "5px 0 2px 0");
		plFrmYeta3070.getHeader().addTool(btnlogView); 
		/************************************************************************
		...
		Yeta3070MSDef.setReadOnly(true);   
		msfGridPanelYeta3070MS = new MSFGridPanel(Yeta3070MSDef, false, false, false, false,false); 
		msfGridPanelYeta3070MS.setSize(350, 620);
		msfGridPanelYeta3070MS.setBorders(true);
		msfGridPanelYeta3070MS.getGrid().setBorders(true);
		Grid grid = msfGridPanelYeta3070MS.getMsfGrid().getGrid();
		grid.addListener(Events.CellDoubleClick , new Listener<BaseEvent>() {
			public void handleEvent(BaseEvent be) {

				untDpobCd = MSFSharedUtils.allowNulls(msfGridPanelYeta3070MS.getMsfGrid().getCurrentlySelectedItem().get("utDpobCd"));

				OnReload(untDpobCd);
				OffReload();
			}					
		});
		inner.add(msfGridPanelYeta3070MS);

		msfGridPanelBass0150 = new MSFGridPanel(Yeta3070ToBass0150Def, false, false, false, false, false); 
		msfGridPanelBass0150.setSize(600, 200);
		msfGridPanelBass0150.setBorders(true);
		msfGridPanelBass0150.getGrid().setBorders(true);

		// 두번째 컨테이너컬럼(사용사업정보)   
		msfGridPanelBass0500On = new MSFGridPanel(Yeta3070ToBass0500OnDef, false, false, false, false, false); 
		...
		// 세번째 컨테이너컬럼(미사용사업정보)  
		msfGridPanelBass0500Off = new MSFGridPanel(Yeta3070ToBass0500OffDef, false, false, false, false,false); 
		...
		plFrmYeta3070.add(srhOffDeptCd);
			...
			public void componentSelected(ButtonEvent ce) {  
				...
				while (iterRecords.hasNext()) {	    		            	  
					...
					if ((Boolean)bmMapModel.get("select")) {
						...
						pkgBass0500Dto.setUntDpobCd(MSFSharedUtils.allowNulls(msfGridPanelYeta3070MS.getMsfGrid().getCurrentlySelectedItem().get("utDpobCd")));
		...
		plFrmYeta3070.add(inner);

		vp.add(plFrmYeta3070);
		plFrmYeta3070.setSize("990px", "680px");
	}	

	private Yeta3070 getThis(){
		return this;
	}
