...
import com.app.exterms.yearendtax.client.service.yeta2022.YetaP710001Service;
...
import com.app.exterms.yearendtax.server.service.yeta2022.dao.Ye160405_2022_DAO;
import com.app.exterms.yearendtax.server.service.yeta2022.dao.Ye160406_2022_DAO;
import com.app.exterms.yearendtax.server.service.yeta2022.dao.Ye160510_2022_DAO;
...
import com.app.exterms.yearendtax.server.service.yeta2022.dao.Ye162010_2022_DAO;
import com.app.exterms.yearendtax.server.service.yeta2022.dao.Ye162020_2022_DAO;
import com.app.exterms.yearendtax.server.service.yeta2022.dao.Ye162030_2022_DAO;
import com.app.exterms.yearendtax.server.service.yeta2022.dao.Ye162040_2022_DAO;
import com.app.exterms.yearendtax.server.service.yeta2022.dao.Ye162510_2022_DAO;
import com.app.exterms.yearendtax.server.service.yeta2022.dao.Ye162520_2022_DAO;
import com.app.exterms.yearendtax.server.service.yeta2022.dao.Ye162530_2022_DAO;
import com.app.exterms.yearendtax.server.service.yeta2022.dao.Ye164010_2022_DAO;
import com.app.exterms.yearendtax.server.service.yeta2022.dao.Ye165010_2022_DAO;
import com.app.exterms.yearendtax.server.service.yeta2022.dao.Ye165020_2022_DAO;
import com.app.exterms.yearendtax.server.service.yeta2022.dao.Ye165030_2022_DAO;
import com.app.exterms.yearendtax.server.service.yeta2022.dao.Ye165030Temp_2022_DAO;
import com.app.exterms.yearendtax.server.service.yeta2022.dao.Ye166010_2022_DAO;
import com.app.exterms.yearendtax.server.service.yeta2022.dao.Ye166020_2022_DAO;
...
import com.app.exterms.yearendtax.server.vo.InfcPsnl0100Srh_2022_VO;
...
import com.app.exterms.yearendtax.server.vo.Ye160510_2022_VO;
...
import com.app.exterms.yearendtax.server.vo.Ye162010_2022_VO;
import com.app.exterms.yearendtax.server.vo.Ye162020_2022_VO;
import com.app.exterms.yearendtax.server.vo.Ye162030_2022_VO;
import com.app.exterms.yearendtax.server.vo.Ye162040_2022_VO;
import com.app.exterms.yearendtax.server.vo.Ye162510_2022_VO;
import com.app.exterms.yearendtax.server.vo.Ye162520_2022_VO;
import com.app.exterms.yearendtax.server.vo.Ye162530_2022_VO;
import com.app.exterms.yearendtax.server.vo.Ye164010_2022_VO;
import com.app.exterms.yearendtax.server.vo.Ye165010_2022_VO;
import com.app.exterms.yearendtax.server.vo.Ye165020_2022_VO;
import com.app.exterms.yearendtax.server.vo.Ye165030Temp_2022_VO;
import com.app.exterms.yearendtax.server.vo.Ye165030_2022_VO;
import com.app.exterms.yearendtax.server.vo.Ye166010_2022_VO;
import com.app.exterms.yearendtax.server.vo.Ye166020_2022_VO;
...
* </pre>
 */
@Service("YetaP710001Service")
public class YetaP710001ServiceImpl  extends AbstractCustomServiceImpl implements YetaP710001Service  ,YetaDaoConstants {

	 
	private static final Logger logger = LoggerFactory.getLogger(YetaP710001ServiceImpl.class);
	private static final String calledClass = YetaP710001ServiceImpl.class.getName();
 
		
	@Autowired
	@Resource(name = "Ye160401_2022_DAO")
	private Ye160401_2022_DAO ye160401DAO; //현근무지급여지급명세
	@Autowired
	@Resource(name = "Ye160402_2022_DAO")
	private Ye160402_2022_DAO  ye160402DAO;//현근무지비과세_감면소득_과세
	@Autowired
	@Resource(name = "Ye160403_2022_DAO")
	private Ye160403_2022_DAO  ye160403DAO;//현근무지비과세_감면소득_비과세
	@Autowired
	@Resource(name = "Ye160404_2022_DAO")
	private Ye160404_2022_DAO  ye160404DAO;//D_종전근무처
	@Autowired
	@Resource(name = "Ye160405_2022_DAO")
	private Ye160405_2022_DAO  ye160405DAO;//D_종전근무처비과세_감면소득_비과세
	@Autowired
	@Resource(name = "Ye160406_2022_DAO")
	private Ye160406_2022_DAO  ye160406DAO;//종전근무지연금보험료_공적연금
	@Autowired
	@Resource(name = "Ye160510_2022_DAO")
	private Ye160510_2022_DAO  ye160510DAO;//근무지별비과세_감면소득
	...
	private Ye161020_2022_DAO  ye161020DAO;//A_인적소득공제기본
	@Autowired
	@Resource(name = "Ye161030_2022_DAO")
	private Ye161030_2022_DAO  ye161030DAO;//E_인적공제명세
	@Autowired
	@Resource(name = "Ye161040_2022_DAO")
	private Ye161040_2022_DAO  ye161040DAO;//E_소득세액공제명세
	@Autowired
	@Resource(name = "Ye161050_2022_DAO")
	private Ye161050_2022_DAO  ye161050DAO;//C_연금보험료공제
	@Autowired
	@Resource(name = "Ye161055_2022_DAO")
	private Ye161055_2022_DAO  ye161055DAO;//C_연금보험료_공적연금상세
	@Autowired
	@Resource(name = "Ye161060_2022_DAO")
	private Ye161060_2022_DAO  ye161060DAO;//C_특별소득공제
	@Autowired
	@Resource(name = "Ye161070_2022_DAO")
	private Ye161070_2022_DAO  ye161070DAO;//C_그밖의소득공제
	@Autowired
	@Resource(name = "Ye161080_2022_DAO")
	private Ye161080_2022_DAO  ye161080DAO;//C_세액감면및공제
	@Autowired
	@Resource(name = "Ye161090_2022_DAO")
	private Ye161090_2022_DAO  ye161090DAO;//C_교육비내역
	@Autowired
	@Resource(name = "Ye162010_2022_DAO")
	private Ye162010_2022_DAO  ye162010DAO;//F_연금저축계좌
	@Autowired
	@Resource(name = "Ye162020_2022_DAO")
	private Ye162020_2022_DAO  ye162020DAO;//F_퇴직연금계좌명세
	@Autowired
	@Resource(name = "Ye162030_2022_DAO")
	private Ye162030_2022_DAO  ye162030DAO;//F_주택마련저축
	@Autowired
	@Resource(name = "Ye162040_2022_DAO")
	private Ye162040_2022_DAO  ye162040DAO;//F_장기집합투자증권저축_B1013
	@Autowired
	@Resource(name = "Ye162510_2022_DAO")
	private Ye162510_2022_DAO  ye162510DAO;//G_월세액소득공제명세
	@Autowired
	@Resource(name = "Ye162520_2022_DAO")
	private Ye162520_2022_DAO  ye162520DAO;//G_거주자간_금전소비대차
	@Autowired
	@Resource(name = "Ye162530_2022_DAO")
	private Ye162530_2022_DAO  ye162530DAO;//G_임대차계약
	@Autowired
	@Resource(name = "Ye164010_2022_DAO")
	private Ye164010_2022_DAO ye164010DAO; //A_의료비지급명세
	@Autowired
	@Resource(name = "Ye165010_2022_DAO")
	private Ye165010_2022_DAO  ye165010DAO;//I_해당연도기부금명세
	@Autowired
	@Resource(name = "Ye165020_2022_DAO")
	private Ye165020_2022_DAO  ye165020DAO;//I_기부자관계코드별기부금합계
	@Autowired
	@Resource(name = "Ye165030_2022_DAO")
	private Ye165030_2022_DAO  ye165030DAO;//H_기부금조정명세
	@Autowired
	@Resource(name = "Ye165030Temp_2022_DAO")
	private Ye165030Temp_2022_DAO ye165030TempDAO;    //H_기부금조정명세_TEMP	 
	@Autowired
	@Resource(name = "Ye166010_2022_DAO")
	private Ye166010_2022_DAO  ye166010DAO;//신용카드등소득공제명세
	@Autowired
	@Resource(name = "Ye166020_2022_DAO")
	private Ye166020_2022_DAO  ye166020DAO;//신용카드등소득공제상세
		 
	@Autowired
	@Resource(name = "Ye169010_2022_DAO")
	private Ye169010_2022_DAO ye169010DAO; //C_주현근무처
	@Autowired
	@Resource(name = "Ye169010a_2022_DAO")
	private Ye169010a_2022_DAO ye169010aDAO; //C_주현근무처_표준공제 
	 ...
	 */
	//조회
	public PagingLoadResult<BaseModel> getYetaP710001ToPsnl0100DataList(ServiceParameters serviceParameters) throws MSFException {
		

		PagingLoadResult<BaseModel> retval = null;
		String method =  CLASS_YETAP710001_TO_PSNL0100_DATA_LIST;
		InfcPsnl0100Srh_2022_VO   psnl0100SrhVO = new InfcPsnl0100Srh_2022_VO();
           ...
           /******************************** 권한 ************************************************************************/
			...
			if ( pagingValues.executeRecordCount ) { 
	        	...
	        	TimingInfo millisBeginQueryCount = SmrmfUtils.startTiming(logger);
	          	...
	          	int iResultCnt = ye161010DAO.selectYetaP710001ToPsnl0100ListTotCnt(psnl0100SrhVO);  
...
//	            Collection<Map<String, Object>> list ??????
	     	List list = ye161010DAO.selectYetaP710001ToPsnl0100List(psnl0100SrhVO);
	...
	/** 연말정산 대상자 생성  **/
	@Override
	public PagingLoadResult<ShowMessageBM> saveYetaP710001ToYe161010(List<Ye161010DTO> listYe161010Dto,List<Ye161020DTO> listYe161020Dto, ActionDatabase actionDatabase) throws  MSFException {
		
		String method = calledClass + ".saveYetaP710001ToYe161010";
		
		String windowNm = "연말정산대상자검색";
		String windowId = "YETAP710001";
		...
		try{
            ...
            for(int iYetaCnt=0; iYetaCnt < listYe161020Dto.size(); iYetaCnt++) {
            	...
            	if(0L < Yeta710001_All_Delete(listYe161020Dto)) {
            ...
            if (iCnt > 0) {
		    	...
		    	//컴포넌트 호출하기 
	        	retval = yetaLsAdtr.setYetaP710001ToAll_2022_Create(RemoteServiceUtil.getThreadLocalRequest(), listYe161010VO);  
	...
	private  Long Yeta710001_All_Delete(List<Ye161020DTO> listYe161020Dto) throws MSFException {
    	
		String method = calledClass + ".Yeta710001_All_Delete";

		String windowNm = "연말정산대상자관리";
		String windowId = "YETA710001";
		...
		Ye160402_2022_VO    ye160402Vo	 = new  Ye160402_2022_VO();	//현근무지비과세_감면소득_과세
		Ye160403_2022_VO    ye160403Vo	 = new  Ye160403_2022_VO();	//현근무지비과세_감면소득_비과세
		Ye160404_2022_VO    ye160404Vo	 = new  Ye160404_2022_VO();	//D_종전근무처
		Ye160405_2022_VO    ye160405Vo	 = new  Ye160405_2022_VO();	//D_종전근무처비과세_감면소득_비과세
		Ye160406_2022_VO    ye160406Vo	 = new  Ye160406_2022_VO();	//종전근무지연금보험료_공적연금
		Ye160510_2022_VO    ye160510Vo	 = new  Ye160510_2022_VO();	//근무지별비과세_감면소득
			      			        
		//Ye161005VO    ye161005Vo	 = new  Ye161005VO();	//A_원천세신고기본
			       			        
		Ye161010_2022_VO    ye161010Vo	 = new  Ye161010_2022_VO();	// 연말정산대상자기본
		
		Ye161020_2022_VO    ye161020Vo	 = new  Ye161020_2022_VO();	//A_인적소득공제기본
		Ye161030_2022_VO    ye161030Vo	 = new  Ye161030_2022_VO();	//E_인적공제명세
		Ye161040_2022_VO    ye161040Vo	 = new  Ye161040_2022_VO();	//E_소득세액공제명세
		Ye161050_2022_VO    ye161050Vo	 = new  Ye161050_2022_VO();	//C_연금보험료공제
		Ye161055_2022_VO    ye161055Vo	 = new  Ye161055_2022_VO();	//C_연금보험료_공적연금상세
		Ye161060_2022_VO    ye161060Vo	 = new  Ye161060_2022_VO();	//C_특별소득공제
		Ye161070_2022_VO    ye161070Vo	 = new  Ye161070_2022_VO();	//C_그밖의소득공제
		Ye161080_2022_VO    ye161080Vo	 = new  Ye161080_2022_VO();	//C_세액감면및공제
		Ye161090_2022_VO    ye161090Vo	 = new  Ye161090_2022_VO();	//C_교육비내역
		Ye162010_2022_VO    ye162010Vo	 = new  Ye162010_2022_VO();	//F_연금저축계좌
		Ye162020_2022_VO    ye162020Vo	 = new  Ye162020_2022_VO();	//F_퇴직연금계좌명세
		Ye162030_2022_VO    ye162030Vo	 = new  Ye162030_2022_VO();	//F_주택마련저축
		Ye162040_2022_VO    ye162040Vo	 = new  Ye162040_2022_VO();	//F_장기집합투자증권저축_B1013
		Ye162510_2022_VO    ye162510Vo	 = new  Ye162510_2022_VO();	//G_월세액소득공제명세
		Ye162520_2022_VO    ye162520Vo	 = new  Ye162520_2022_VO();	//G_거주자간_금전소비대차
		Ye162530_2022_VO    ye162530Vo	 = new  Ye162530_2022_VO();	//G_임대차계약
		Ye164010_2022_VO    ye164010Vo	 = new  Ye164010_2022_VO();	//A_의료비지급명세
		Ye165010_2022_VO    ye165010Vo	 = new  Ye165010_2022_VO();	//I_해당연도기부금명세
		Ye165020_2022_VO    ye165020Vo	 = new  Ye165020_2022_VO();	//I_기부자관계코드별기부금합계
		Ye165030_2022_VO    ye165030Vo	 = new  Ye165030_2022_VO();	//H_기부금조정명세
		Ye165030Temp_2022_VO ye165030TempVo = new  Ye165030Temp_2022_VO();  	    //H_기부금조정명세_TEMP	 
		Ye166010_2022_VO     ye166010Vo	 = new  Ye166010_2022_VO();	//신용카드등소득공제명세
		Ye166020_2022_VO     ye166020Vo	 = new  Ye166020_2022_VO();	//신용카드등소득공제상세
							 //
		Ye169010_2022_VO     ye169010Vo	 = new  Ye169010_2022_VO();	//C_주현근무처
		Ye169010a_2022_VO    ye169010AVo = new  Ye169010a_2022_VO();	//C_주현근무처_표준공제 
		...
		try {
			...
			logger.error("EXCEPTION calling Yeta710001_All_Delete(): " + ex);

			/** 에러 로그 **/
			MSFLogHistoryUtils.tracerUserExceptionActivity(sessionUser, method,calledClass, "D", ex, windowNm, windowId);

			retval = 0L;
			throw MSFServerUtils.getOperationException("Yeta710001_All_Delete", ex, logger);
		}
