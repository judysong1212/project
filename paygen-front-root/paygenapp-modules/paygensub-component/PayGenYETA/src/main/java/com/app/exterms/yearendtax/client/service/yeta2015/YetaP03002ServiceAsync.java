...
public interface YetaP03002ServiceAsync {
	
	
	/** 의료비내역 등록 팝업 수정 및 삭제 **/
	public void activityOnYetaP03002ToYeta3140(List<Yeta3140DTO> listYeta3180dto, ActionDatabase actionDatabase, AsyncCallback<Long> callback) ;
