...
import com.app.exterms.yearendtax.client.dto.yeta2018.Ye169010BM;
...
public class Ye169010Def extends TableDef implements YetaDaoConstants {
	...
	public Ye169010Def(String chkPayrDef) {
		...
		if("Yeta3300".equals(chkPayrDef)) { 
			setTitle("");
	        setDaoClass("");
	        setCustomListMethod("");
	        setCustomListMethod(CLASS_YETA3300_TO_YE169010_SUBTAX_LIST);
