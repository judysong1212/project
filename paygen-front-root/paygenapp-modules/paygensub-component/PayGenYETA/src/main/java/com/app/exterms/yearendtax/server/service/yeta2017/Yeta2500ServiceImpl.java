...
* </pre>
 */
@Service("Yeta2500Service")
public class Yeta2500ServiceImpl  extends AbstractCustomServiceImpl implements Yeta2500Service  ,YetaDaoConstants {

 
	  private static final Logger logger = LoggerFactory.getLogger(Yeta2500ServiceImpl.class);
	  private static final String calledClass = Yeta2500ServiceImpl.class.getName();
	...
	//연말정산신고내역 조회
	public PagingLoadResult<BaseModel> getYeta25000List(ServiceParameters serviceParameters) throws MSFException {
		...
		ye161010DAO = (Ye161010DAO)BeanFinder.getBean("Ye161010DAO");
...
//	            Collection<Map<String, Object>> list ??????
	...
	//당월급여반영
	public Long activityOnYeta2500List(List<Ye161010DTO> listYe161010dto) throws MSFException {
	...
	//연말정산대상자 및 내역 수정
	public Long saveYeta2500Grid(List<Ye161010DTO> listYe161010dto) throws MSFException {
		// TODO Auto-generated method stub
		...
		try {  
			...
			result = new Long(0);
			throw MSFServerUtils.getOperationException("saveYeta2500Ye161010", ex, logger);
		}
		finally {
