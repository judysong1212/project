...
@Service("YetaP43002Service")
public class YetaP43002ServiceImpl  extends AbstractCustomServiceImpl implements YetaP43002Service  ,YetaDaoConstants {

	 
	private static final Logger logger = LoggerFactory.getLogger(YetaP43002ServiceImpl.class);
	private static final String calledClass = YetaP43002ServiceImpl.class.getName();
	...
	/** 의료비내역 신규 수정 삭제부 **/
	@Override
	public Long activityOnYetaP43002ToYe164010(List<Ye164010DTO> listYe164010Dto, ActionDatabase actionDatabase) throws MSFException {
		...
		String windowId = "YETAP430002";

		MSFSysm0100BM sessionUser;
		String method = calledClass + ".activityOnYetaP43002ToYe164010";
		...
		try { 
			...
			if (MSFSharedUtils.paramNull(ye164010DAO)) {
				...
				ye164010DAO = (Ye164010_2019_DAO) wac.getBean("Ye164010_2019_DAO");
			}
			...
			for (int iPsnlCnt = 0; iPsnlCnt < listYe164010Dto.size(); iPsnlCnt++) {
				...
				case INSERT:
					...
					ye164010DAO.insertYetaP43002ToYe164010(ye164010Vo);
					break;
					
				case UPDATE:
					ye164010DAO.updateYetaP43002ToYe164010(ye164010Vo);
					break;
					
				case DELETE:
					ye164010DAO.deleteYetaP43002ToYe164010(ye164010Vo);
					break;
				}
				iCnt = iCnt + 1;
			...
			logger.error("EXCEPTION calling activityOnYetaP43002ToYe164010(): "+ ex);
			...
			result = new Long(0);
			throw MSFServerUtils.getOperationException("activityOnYetaP43002ToYe164010", ex, logger);
	...
	/** 의료비내역 조회 **/
	public PagingLoadResult<BaseModel> getYetaP43002ToYe164010DataList(ServiceParameters serviceParameters) throws MSFException {
		

		PagingLoadResult<BaseModel> retval = null;
		String method =  CLASS_YETAP43002_TO_YE164010_DATA_LIST;
		Ye164010Srh_2019_VO   ye164010SrhVo = new Ye164010Srh_2019_VO();
...
//	    	ye164010SrhVo.setResnoEncCntn(MSFSharedUtils.allowNulls(MSFServerUtils.getFilterValue(columnFilters, "resnoEncCntn")));    /** column 의료비공제대상자주민등록번호 : resnoEncCntn */
			...
			if ( pagingValues.executeRecordCount ) { 
	        	...
	        	TimingInfo millisBeginQueryCount = SmrmfUtils.startTiming(logger);
	          	...
	          	int iResultCnt = ye164010DAO.selectYetaP43002ToYe164010ListTotCnt(ye164010SrhVo);  
...
//	            Collection<Map<String, Object>> list ??????
	     	List list = ye164010DAO.selectYetaP43002ToYe164010List(ye164010SrhVo);
			...
			SmrmfUtils.endTiming(logger, millisBeginYe164010DataList, "getYetaP43002ToYe164010DataList");
