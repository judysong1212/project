...
@RemoteServiceRelativePath("YetaP13001Service.gwt")
public interface YetaP13001Service extends RemoteService {
	/**
	 * Utility class for simplifying access to the instance of async service.
	 */
	public static class Util {
		private static YetaP13001ServiceAsync instance;
		public static YetaP13001ServiceAsync getInstance(){
			if (instance == null) {
				instance = GWT.create(YetaP13001Service.class);
			}
			return instance;
		}
	}
