...
//    private YetaConstants yetaLabel = YetaConstants.INSTANCE;
	...
	public Ye161040Def(String chkPayrDef) {
		...
		// 국세청 자료
		if ("Yeta530001".equals(chkPayrDef)) {

			setDaoClass("");
			setCustomListMethod(CLASS_YETA5300_TO_YE161040_DATA_LIST);
			setAutoFillGrid(false);
			setShowFilterToolbar(false);
			setCheckBoxOnGridRows(true);
			setEditableGrid(true);
			setEditFieldGrid(true);
			setColumnsDefinition(getYeta33000ToYe161040ColumnsList01());

       // 기타자료
      }else if("Yeta530002".equals(chkPayrDef)) {
			...
			setEditableGrid(true);
			setEditFieldGrid(true);
			setColumnsDefinition(getYeta33000ToYe161040ColumnsList02());
		}

	}
     
	/** 국세청 자료 **/
	private List<ColumnDef> getYeta33000ToYe161040ColumnsList01() {
...
//        listColumnDefs.add(new ColumnDef("구분", Ye161040BM.ATTR_HEADER, ColumnDef.TYPE_STRING, 30, true, true, true));
	...
	/** 기타 자료 **/
	private List<ColumnDef> getYeta33000ToYe161040ColumnsList02() {
