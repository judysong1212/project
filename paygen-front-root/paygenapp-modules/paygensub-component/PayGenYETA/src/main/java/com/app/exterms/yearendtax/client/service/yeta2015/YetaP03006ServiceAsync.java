...
public interface YetaP03006ServiceAsync {
	
	
	/** 종전근무지등록 팝업 신규, 삭제, 저장 **/
	public void activityOnYetaP03006ToYeta3110(List<Yeta3110DTO> listYeta3110dto, ActionDatabase actionDatabase, AsyncCallback<Long> callback);
