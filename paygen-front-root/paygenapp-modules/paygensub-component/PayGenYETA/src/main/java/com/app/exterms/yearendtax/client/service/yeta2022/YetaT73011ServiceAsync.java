...
public interface YetaT73011ServiceAsync {
	
	/** 월세액소득공제명세  팝업 수정 삭제**/
	public void activityOnYetaT73011(List<Ye162510DTO> listYe162510Dto, ActionDatabase actionDatabase, AsyncCallback<Long> callback) ;
