 ...
 */
@Service("YetaP83005Service")
public class YetaP83005ServiceImpl  extends AbstractCustomServiceImpl implements YetaP83005Service  ,YetaDaoConstants {

 
	private static final Logger logger = LoggerFactory.getLogger(YetaP83005ServiceImpl.class);
	private static final String calledClass = YetaP83005ServiceImpl.class.getName();
	

	
	@Autowired
	@Resource(name = "Ye162510_2023_DAO")
	private Ye162510_2023_DAO ye162510DAO;  
	  
	  
	/** 월세액등록 - 월세액소득공제명세 수정 삭제부 **/
	@Override
	public Long  activityOnYetaP83005ToYe162510(List<Ye162510DTO> listYe162510Dto, ActionDatabase actionDatabase) throws MSFException {
		...
		String method = calledClass + ".activityOnYetaP83005ToYe162510";

		String windowNm = "소득공제신고자료관리";
		String windowId = "YETAP8P730005";
		
		Ye162510DTO ye162510Dto = new Ye162510DTO();
		Ye162510_2023_VO ye162510Vo   = new Ye162510_2023_VO();  
		...
		try {
			...
			if (MSFSharedUtils.paramNull(ye162510DAO)) {
				...
				ye162510DAO = (Ye162510_2023_DAO) wac.getBean("Ye162510_2023_DAO");
			}
			...
			for(int iPsnlCnt=0;iPsnlCnt < listYe162510Dto.size();iPsnlCnt++) {
				...
				ye162510Vo  = new Ye162510_2023_VO();
				...
				case INSERT:
					...
					ye162510DAO.insertYetaP83005ToYe162510(ye162510Vo);
					break;
				case UPDATE:
					ye162510DAO.updateYetaP83005ToYe162510(ye162510Vo);
					break;
				case DELETE:
					ye162510DAO.deleteYetaP83005ToYe162510(ye162510Vo);
					break;
				}
			...
			logger.error("EXCEPTION calling activityOnYetaP83005ToYe162510(): "+ ex); 
		    ...
		    result = new Long(0);
		    throw MSFServerUtils.getOperationException("activityOnYetaP83005ToYe162510", ex, logger);
	...
	/** 월세액소득공제명세 조회 **/
	public PagingLoadResult<BaseModel> getYetaP83005ToYe162510DataList(ServiceParameters serviceParameters) throws MSFException {
			

			PagingLoadResult<BaseModel> retval = null;
			String method =  CLASS_YETAP83005_TO_YE162510_DATA_LIST;
			Ye162510Srh_2023_VO   ye162510SrhVo = new Ye162510Srh_2023_VO();
...
//		    	ye162510SrhVo.setMnthRntQntySeilNum(ye162510Dto.getMnthRntQntySeilNum());    /** column 월세액소득공제일련번호 : mnthRntQntySeilNum */		    	
				...
				if ( pagingValues.executeRecordCount ) { 
		        	...
		        	TimingInfo millisBeginQueryCount = SmrmfUtils.startTiming(logger);
		          	...
		          	int iResultCnt = ye162510DAO.selectYetaP83005ToYe162510ListTotCnt(ye162510SrhVo);  
...
//		            Collection<Map<String, Object>> list ??????
		     	List list = ye162510DAO.selectYetaP83005ToYe162510List(ye162510SrhVo);
