...
@Service("YetaP03002Service")
public class YetaP03002ServiceImpl  extends AbstractCustomServiceImpl implements YetaP03002Service  ,YetaDaoConstants {
	...
	private static final Logger logger = LoggerFactory.getLogger(YetaP03002ServiceImpl.class);
	private static final String calledClass = YetaP03002ServiceImpl.class.getName();
	...
	//의료비내역 신규 수정 삭제부
	@Override
	public Long activityOnYetaP03002ToYeta3140(List<Yeta3140DTO> listYeta3140dto, ActionDatabase actionDatabase) throws MSFException {
				// TODO Auto-generated method stub
				Long result = new Long(0);
				Long iCnt = new Long(0);
				
				String windowNm = "소득공제신고자료관리";
				String windowId = "YETAP030002";
				
				MSFSysm0100BM sessionUser;
				String method = calledClass + ".activityOnYetaP03002ToYeta3140";
				...
				try {  
					if (MSFSharedUtils.paramNull(yeta3140DAO)) {
						...
						yeta3140DAO = (Yeta3140DAO) wac.getBean("yeta3140DAO" ); 
					}
...
//			        	} 
					...
					result = iCnt;
			            ...
			            logger.error("EXCEPTION calling activityOnYetaP03002ToYeta3140(): "+ex); 
			            ...
			            result = new Long(0);
			            throw MSFServerUtils.getOperationException("activityOnYetaP03002ToYeta3140", ex, logger);
			        }
			        finally {
	...
	//의료비내역 조회
	public PagingLoadResult<BaseModel> getYetaP03002To3140List(ServiceParameters serviceParameters) throws MSFException {
		

		PagingLoadResult<BaseModel> retval = null;
		String method =  CLASS_YETAP03002TOYETA3140_DATA_LIST;
...
//	                     break;     
			...
			SmrmfUtils.endTiming(logger, millisBeginPsnl0126DataList, "getYetaP03001To3140List");
