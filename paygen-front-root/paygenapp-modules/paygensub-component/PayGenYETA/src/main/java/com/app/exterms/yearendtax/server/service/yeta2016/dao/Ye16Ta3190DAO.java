...
@Repository("Ye16Ta3190DAO")
public class Ye16Ta3190DAO extends EgovAbstractDAO {
    ...
    /**
  	 ...
  	 */
	  @Transactional
      public void fnYeta1100_YETA3190_2016_CREATE_Delete(Yeta3190VO vo) throws Exception {
          delete("ye16Ta3190DAO.fnYeta1100_YETA3190_2016_CREATE_Delete_S", vo);
      } 	
    ...
    public String insertYeta3190(Yeta3190VO vo) throws Exception {
        return (String)insert("ye16Ta3190DAO.insertYeta3190_S", vo);
    }
    ...
    public void updateYeta3190(Yeta3190VO vo) throws Exception {
        update("ye16Ta3190DAO.updateYeta3190_S", vo);
    }
    ...
    public void deleteYeta3190(Yeta3190VO vo) throws Exception {
        delete("ye16Ta3190DAO.deleteYeta3190_S", vo);
    }
    ...
    /**
      ...
      public void fnPayr06430_PAYR443_CREATE_Delete(Yeta3190VO vo) throws Exception {
          delete("ye16Ta3190DAO.fnPayr06430_PAYR443_CREATE_Delete_S", vo);
      } 
    ...
    public Yeta3190VO selectYeta3190(Yeta3190VO vo) throws Exception {
        return (Yeta3190VO) selectByPk("ye16Ta3190DAO.selectYeta3190_S", vo);
    }
    ...
    public List<?> selectYeta3190List(Yeta3190SrhVO searchVO) throws Exception {
        return list("ye16Ta3190DAO.selectYeta3190List_D", searchVO);
    }
    ...
    public int selectYeta3190ListTotCnt(Yeta3190SrhVO searchVO) {
        return (Integer)getSqlMapClientTemplate().queryForObject("ye16Ta3190DAO.selectYeta3190ListTotCnt_S", searchVO);
    }
