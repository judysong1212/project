...
import com.app.exterms.yearendtax.client.form.defs.yeta2017.Yeta2080Def;
...
=====================================================**/
public class Yeta2080  extends MSFPanel { 
	...
	private FormPanel plFrmYeta2080;
	private FormData formData; 
	private String txtForm = "";
	private XTemplate detailTp;	  
//	private Yeta2080ServiceAsync Yeta2080service = Yeta2080Service.Util.getInstance();
	...
	private Yeta2080Def yeta2080Def 				= new Yeta2080Def("yeta2080ToBass0400");
//	private Yeta2080Def yeta2080ToSysm0100OnDef 	= new Yeta2080Def("yeta2080ToSysm0100On");
//	private Yeta2080Def yeta2080ToSysm0100OffDef 	= new Yeta2080Def("yeta2080ToSysm0100Off");	
	private InfcPkgSysm0100Def yeta2080ToSysm0100OnDef 		= new InfcPkgSysm0100Def("yeta2080ToSysm0100On");
	private InfcPkgSysm0100Def yeta2080ToSysm0100OffDef 	= new InfcPkgSysm0100Def("yeta2080ToSysm0100Off");
	
	private MSFGridPanel msfGridPanelYeta2080; 
...
//			final RelationDef  relBass0360 = new RelationDef(yeta2080MSDef,false);
//			relBass0360.addJoinDef("dpobCd", "dpobCd"); 
//			relBass0360.addJoinDef("deptCd", "deptCd"); 
//			relBass0360.setLinkedObject(msfGridPanelYeta2080MS);
//			yeta2080ToBass0500OnDef.addRelation(relBass0360); 
//
//			/**
//			 * Create the relations 
//			 */
//			final RelationDef  relBass0350 = new RelationDef(yeta2080MSDef,false);
//			relBass0350.addJoinDef("dpobCd", "dpobCd"); 
//			relBass0350.addJoinDef("deptCd", "deptCd"); 
//			relBass0350.setLinkedObject(msfGridPanelYeta2080MS);
//			yeta2080ToBass0500OffDef.addRelation(relBass0350); 
//
//
//			// DETAILS 
//			final Grid yeta2080ToBass0500OffDefGrid = msfGridPanelYeta2080MS.getMsfGrid().getGrid();
//			yeta2080ToBass0500OffDefGrid.addListener(Events.CellDoubleClick, new Listener<BaseEvent>() {
//				public void handleEvent(BaseEvent be) {  
//					if (msfGridPanelYeta2080MS.getCurrentlySelectedItem() != null) {  
//
//						yeta2080ToBass0500OnDef.synchronizeGridDetail(
//								msfGridPanelYeta2080MS.getCurrentlySelectedItem(),
//								msfGridPanelBass0500On );
//
//						yeta2080ToBass0500OffDef.synchronizeGridDetail(
//								msfGridPanelYeta2080MS.getCurrentlySelectedItem(),
...
//			});
	...
	public Yeta2080(String txtForm) {
...
//		lsDtilOccuInttnCd = PrgmComComboUtils.getSingleBass0350ComboData(sysComBass0350Dto);
		...
		plFrmYeta2080 = new FormPanel();
		plFrmYeta2080.setHeadingText("PayGen Ver1.0 - 연말정산등록담당자관리");
		plFrmYeta2080.setIcon(Resources.APP_ICONS.text());
		plFrmYeta2080.setBodyStyleName("pad-text");
		plFrmYeta2080.setFrame(true); 
		plFrmYeta2080.setPadding(2);
		/************************************************************************
		...
		btnlogView.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				 //로그 뷰화면 호출 메서드 
				  funcLogMessage("연말정산등록담당자관리","YETA2080");
				}
			});
		plFrmYeta2080.getHeader().setStyleAttribute("padding", "5px 0 2px 0");
		plFrmYeta2080.getHeader().addTool(btnlogView); 
		/************************************************************************
		 * 화면 에러 처리시 필요한 부분으로 추가 
		 ************************************************************************/
		deptCd = new HiddenField<String>();
		deptCd.setName("deptCd");
		plFrmYeta2080.add(deptCd);
		
		HorizontalPanel inner = new HorizontalPanel();
		inner.setBorders(false);
		inner.setLayout(new FitLayout());
//		yeta2080Def.setReadOnly(true);
		msfGridPanelYeta2080 = new MSFGridPanel(yeta2080Def, false, false, false, true, false);
		msfGridPanelYeta2080.setSize(300, 610);
		msfGridPanelYeta2080.setBorders(true);
		msfGridPanelYeta2080.getGrid().setBorders(true);
		Grid grid = msfGridPanelYeta2080.getMsfGrid().getGrid();
		grid.addListener(Events.CellDoubleClick , new Listener<BaseEvent>() {
			public void handleEvent(BaseEvent be) {
				
				
				BaseModel bmData = msfGridPanelYeta2080.getCurrentlySelectedItem();  
		...
		msfGridPanelYeta2080.setTopComponent(lycSreach);
		inner.add(msfGridPanelYeta2080);
          
          
		// 선택된 사용자 
		msfGridPanelSysm0100On = new MSFGridPanel(yeta2080ToSysm0100OnDef, false, false, false, false,false); 
...
//						infcPkgSysm0100Dto.setUntDpobCd(MSFSharedUtils.allowNulls(egovMap.get("untDpobCd")));    /** column 단위사업장코드 : untDpobCd */
		...
		bottomToolbar.add(refresh);
   	    ...
   	    yeta2080ToSysm0100OffDef.setReadOnly(true);
   	    // ------------------------ 미선택된 사용자
   	    msfGridPanelSysm0100Off = new MSFGridPanel(yeta2080ToSysm0100OffDef, false, false, false, false, false); 
...
//						infcPkgSysm0100Dto.setUntDpobCd(MSFSharedUtils.allowNulls(egovMap.get("untDpobCd")));    /** column 단위사업장코드 : untDpobCd */
		...
		plFrmYeta2080.add(inner);

		vp.add(plFrmYeta2080);
		plFrmYeta2080.setSize("990px", "680px");
	}

	private Yeta2080 getThis() {
		return this;
	}
    ...
    public void reDeptload() {
    	...
    	msfGridPanelYeta2080.getTableDef().setTableColumnFilters(filters);   
    	msfGridPanelYeta2080.getTableDef().addColumnFilter("deptNmHan", MSFSharedUtils.defaultNulls(deptNmHan.getValue(),""), SimpleColumnFilter.OPERATOR_LIKE); 
    	msfGridPanelYeta2080.reload();
