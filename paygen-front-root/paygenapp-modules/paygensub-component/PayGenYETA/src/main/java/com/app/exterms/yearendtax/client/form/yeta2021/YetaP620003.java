...
=====================================================**/
public  class YetaP620003   extends MSFFormPanel {  
 ...
 **/ 
	...
	public YetaP620003(final ActionDatabase actionDatabase, final MSFPanel caller) {
...
//		initLoad(); 	
		...
		this.actionDatabase = actionDatabase;
	 	...
	 	cpYeta62003 = new FormPanel();  

		createSearchForm();			//기본정보 필드를 적용
		   
		cpYeta62003.setBodyBorder(false);
		cpYeta62003.setBorders(false);
		cpYeta62003.setHeaderVisible(false);
		cpYeta62003.setSize("690px", "250px");
		   
		this.add(cpYeta62003);
	...
	private void createSearchForm() {
		...
		cpYeta62003.setLayout(new FlowLayout());
...
//							reloadYeta6200Result();
					...
					if("".equals(systemkey.getValue())){
						...
						if (filename.length() == 0) {
							...
							//submit the form
							cpYeta62003.mask("PDF 전자문서 업데이트 중입니다. 업로드 중..."); 

							//파일업로드 처리
							cpYeta62003.setAction(GWT.getHostPageBaseURL() + "/imp/XmlYeta6200DdcImport.do");
							cpYeta62003.setEncoding(Encoding.MULTIPART);
							cpYeta62003.setMethod(Method.POST);   
							cpYeta62003.submit();  
							cpYeta62003.onFrameLoad();  
							picBoolFile = true;
						...
						// after file upload 
						cpYeta62003.addListener(Events.Submit, new Listener<FormEvent>() {
