...
import com.app.exterms.yearendtax.client.service.yeta2018.YetaT33014Service;
import com.app.exterms.yearendtax.client.service.yeta2018.YetaT33014ServiceAsync;
...
//import com.app.exterms.yearendtax.client.form.defs.yeta2016.YetaT33014Def;
/**====================================================
디자인화면 수정시 extends 부분을 다음과 같이 수정하여 사용한 후 다시 원복한다.
extends MSFPanel ->  extends LayoutContainer  implements IMSFWindow { 
상속받아 소스를 구현한 경우에는 에러나는 부분을 수정하여 처리 해야함.
=====================================================**/
public  class YetaT33014   extends MSFFormPanel {  
 ...
 **/
	...
	private  ContentPanel cpYetaT33014; 
	...
	// -------------- grid 선언 시작  ---------------	  
	private MSFGridPanel YetaT33014GridPanel;
//	private YetaT33014Def YetaT33014Def = new YetaT33014Def("YetaT33014");   //TODO 일단 화면번호로 Def
	// -------------- grid 선언 종료  ---------------
	...
	// -------------- 서비스 호출 시작 --------------
	private YetaT33014ServiceAsync yetaT33014Service = YetaT33014Service.Util.getInstance();
	// -------------- 서비스 호출 종료 --------------	 
...
//					ye162510Dto.setMnthRnttyHusCnttArea((MSFSharedUtils.allowNulls(bmMapModel.get("mnthRnttyHusCnttArea"))));    		/** column 월세주택계약면적 : mnthRnttyHusCnttArea */
				...
				yetaT33014Service.activityOnYetaT33014(listYe162510Dto, actionDatabase, new AsyncCallback<Long>(){
...
//		 }
	...
	public YetaT33014(final ActionDatabase actionDatabase, final MSFPanel caller) {
...
//		initLoad(); 	
		...
		this.actionDatabase = actionDatabase;
	 	...
	 	cpYetaT33014 = new ContentPanel();  

		createSearchForm();			//기본정보 필드를 적용
	 	createMsfGridForm();		//그리드필드
		   
		cpYetaT33014.setBodyBorder(false);
		cpYetaT33014.setBorders(false);
		cpYetaT33014.setHeaderVisible(false);
		cpYetaT33014.setSize("790px", "640px");
		   
		this.add(cpYetaT33014);
...
//		     });     
		...
		cpYetaT33014.setLayout(new FlowLayout());
...
//	      	     }
//				 
//				YetaT33014GridPanel.getMsfGrid().clearData();
//				 
//				BaseModel bmData = YetaT33014GridPanel.getTableDef().getDefaultValues();  
//		              
...
//		         
//		        YetaT33014GridPanel.getMsfGrid().getGrid().stopEditing();      
//		        YetaT33014GridPanel.getMsfGrid().getGrid().getStore().insert(bmData,0);   
//		        YetaT33014GridPanel.getMsfGrid().getGrid().startEditing(YetaT33014GridPanel.getMsfGrid().getGrid().getStore().indexOf(bmData), 0);   
//
...
//			public void handleEvent(ButtonEvent e) {
//				Iterator<BaseModel> itBm = YetaT33014GridPanel.getMsfGrid().getGrid().getSelectionModel().getSelectedItems().listIterator();
...
//			public void handleEvent(ButtonEvent e) {
//				setListRecord(YetaT33014GridPanel.getMsfGrid().getStore().getModifiedRecords().iterator());
//				doAction(actionDatabase);
//
//				if ((ActionDatabase.INSERT).equals(actionDatabase)) {
//					actionDatabase = ActionDatabase.INSERT;
...
//			topYetaBtnBar.add(btnYetaClose);
		...
		cpYetaT33014.add(topYetaBtnBar);
...
//		YetaT33014GridPanel = new MSFGridPanel(YetaT33014Def, false, false, false, false, false);
//		YetaT33014GridPanel.setSize("790px", "420px");
//		YetaT33014GridPanel.setBorders(true);
//		YetaT33014GridPanel.setHeaderVisible(false);
//		
...
//		
//		YetaT33014GridPanel.getGrid().getColumnModel().addAggregationRow(payrSummaryRow);  
//		
...
//		
//		YetaT33014GridPanel.getGrid().getColumnModel().addAggregationRow(payrSummaryRow1);
//		/** --- 그리드 합계 부분  종료 --- **/
		
//        cpYetaT33014.add(YetaT33014GridPanel);
...
//		layoutContainer.add(fldstNewFieldset_1);
		...
		cpYetaT33014.add(fieldSet1);
		cpYetaT33014.add(fieldSet2);
		cpYetaT33014.add(fldstNewFieldset_1);
	...
	public void reload() {
			...
			YetaT33014GridPanel.getTableDef().setTableColumnFilters(filters);
			YetaT33014GridPanel.getTableDef().addColumnFilter("yrtxBlggYr", MSFSharedUtils.allowNulls(srhYrtxBlggYr.getValue())
...
//					, SimpleColumnFilter.OPERATOR_EQUALS);//연말정산귀속년도
			YetaT33014GridPanel.getTableDef().addColumnFilter("clutSeptCd", MSFSharedUtils.getSelectedComboValue(srhClutSeptCd,"commCd")
					, SimpleColumnFilter.OPERATOR_EQUALS);//정산구분
			YetaT33014GridPanel.getTableDef().addColumnFilter("systemkey", MSFSharedUtils.allowNulls(systemkey.getValue())
					, SimpleColumnFilter.OPERATOR_EQUALS);//시스템키
		 
			YetaT33014GridPanel.reload();
