...
import com.app.exterms.yearendtax.client.form.defs.yeta2022.Ye162010Def;
import com.app.exterms.yearendtax.client.service.yeta2022.YetaT73013Service;
import com.app.exterms.yearendtax.client.service.yeta2022.YetaT73013ServiceAsync;
...
=====================================================**/
public  class YetaT73013   extends MSFFormPanel {  
 ...
 **/
	...
	private  ContentPanel cpYetaT73013; 
	...
	// -------------- grid 선언 시작  ---------------	  
	private MSFGridPanel YetaT73013GridPanel;
	private Ye162010Def ye162010Def = new Ye162010Def("YetaT73013");   
	// -------------- grid 선언 종료  ---------------
	...
	// -------------- 서비스 호출 시작 --------------
	private YetaT73013ServiceAsync yetaT73013Service = YetaT73013Service.Util.getInstance();
	// -------------- 서비스 호출 종료 --------------	 
   ...
   */
	// -------------- 검색 조건 시작 --------------
 	...
 	private MSFNumberField srhSum1; //과학기술인공제 변수명 다시 해줘야 함.
 	private MSFNumberField srhSum2; //근로자퇴직급여 변수명 다시 해줘야 함.
 	private MSFNumberField srhSum3; //연금저축 변수명 다시 해줘야 함.
...
//					ye162510Dto.setMnthRnttyHusCnttArea((MSFSharedUtils.allowNulls(bmMapModel.get("mnthRnttyHusCnttArea"))));    		/** column 월세주택계약면적 : mnthRnttyHusCnttArea */
				...
				yetaT73013Service.activityOnYetaT73013(listYe162510Dto, actionDatabase, new AsyncCallback<Long>(){
...
//		 }
	...
	public YetaT73013(final ActionDatabase actionDatabase, final MSFPanel caller) {
...
//		initLoad(); 	
		...
		this.actionDatabase = actionDatabase;
	 	...
	 	cpYetaT73013 = new ContentPanel();  

		createSearchForm();			//기본정보 필드를 적용
	 	createMsfGridForm();		//그리드필드
		   
	 	cpYetaT73013.setBodyBorder(false);
	 	cpYetaT73013.setBorders(false);
	 	cpYetaT73013.setHeaderVisible(false);
	 	cpYetaT73013.setSize("790px", "640px");
		   
		this.add(cpYetaT73013);
...
//		     });     
		...
		cpYetaT73013.setLayout(new FlowLayout());
...
//	      	     }
//				 
//				YetaT73013GridPanel.getMsfGrid().clearData();
//				 
//				BaseModel bmData = YetaT73013GridPanel.getTableDef().getDefaultValues();  
//		              
...
//		         
//		        YetaT73013GridPanel.getMsfGrid().getGrid().stopEditing();      
//		        YetaT73013GridPanel.getMsfGrid().getGrid().getStore().insert(bmData,0);   
//		        YetaT73013GridPanel.getMsfGrid().getGrid().startEditing(YetaT73013GridPanel.getMsfGrid().getGrid().getStore().indexOf(bmData), 0);   
//
...
//			public void handleEvent(ButtonEvent e) {
//				Iterator<BaseModel> itBm = YetaT73013GridPanel.getMsfGrid().getGrid().getSelectionModel().getSelectedItems().listIterator();
...
//			public void handleEvent(ButtonEvent e) {
//				setListRecord(YetaT73013GridPanel.getMsfGrid().getStore().getModifiedRecords().iterator());
//				doAction(actionDatabase);
//
//				if ((ActionDatabase.INSERT).equals(actionDatabase)) {
//					actionDatabase = ActionDatabase.INSERT;
...
//		cpYetaT73013.add(topYetaBtnBar);
...
//		cpYetaT73013.add(topYetaBtnBar);
		...
		YetaT73013GridPanel = new MSFGridPanel(ye162010Def, false, false, false, false, false);
		YetaT73013GridPanel.setSize("790px", "200px");
		YetaT73013GridPanel.setBorders(true);
		YetaT73013GridPanel.setHeaderVisible(false);
...
//		
//		YetaT73013GridPanel.getGrid().getColumnModel().addAggregationRow(payrSummaryRow);  
//		
...
//		
//		YetaT73013GridPanel.getGrid().getColumnModel().addAggregationRow(payrSummaryRow1);
//		/** --- 그리드 합계 부분  종료 --- **/
		
//        cpYetaT73013.add(YetaT73013GridPanel);
		LayoutContainer layoutContainer10 = new LayoutContainer();
		layoutContainer10.setLayout(new ColumnLayout());
		
		
        FieldSet fldstNewFieldset = new FieldSet();
		fldstNewFieldset.setHeadingHtml("연금계좌불입액");
		...
		layoutContainer2.setStyleAttribute("marginTop", "3px");
		...
		layoutContainer10.add(layoutContainer1, new com.extjs.gxt.ui.client.widget.layout.ColumnData(.25));
		layoutContainer10.add(layoutContainer2, new com.extjs.gxt.ui.client.widget.layout.ColumnData(.25));
		layoutContainer10.add(layoutContainer3, new com.extjs.gxt.ui.client.widget.layout.ColumnData(.25));
		layoutContainer10.add(layoutContainer4, new com.extjs.gxt.ui.client.widget.layout.ColumnData(.25));
		...
		fldstNewFieldset.add(YetaT73013GridPanel);
		cpYetaT73013.add(fldstNewFieldset);
		cpYetaT73013.add(layoutContainer10);
		cpYetaT73013.add(fldstNewFieldset_1);
	...
	public void reload() {
			...
			YetaT73013GridPanel.getTableDef().setTableColumnFilters(filters);
			YetaT73013GridPanel.getTableDef().addColumnFilter("yrtxBlggYr", MSFSharedUtils.allowNulls(srhYrtxBlggYr.getValue())
...
//					, SimpleColumnFilter.OPERATOR_EQUALS);//연말정산귀속년도
			YetaT73013GridPanel.getTableDef().addColumnFilter("clutSeptCd", MSFSharedUtils.getSelectedComboValue(srhClutSeptCd,"commCd")
					, SimpleColumnFilter.OPERATOR_EQUALS);//정산구분
			YetaT73013GridPanel.getTableDef().addColumnFilter("systemkey", MSFSharedUtils.allowNulls(systemkey.getValue())
					, SimpleColumnFilter.OPERATOR_EQUALS);//시스템키
		 
			YetaT73013GridPanel.reload();
