...
@Repository("Yeta3120DAO")
public class Yeta3120DAO extends EgovAbstractDAO implements IsSerializable {
    ...
    public String insertYetaP03004To3120(Yeta3120VO vo) throws Exception {
        return (String)insert("yeta3120DAO.insertYeta3120_S", vo);
    }
    ...
    public void updateYetaP03004To3120(Yeta3120VO vo) throws Exception {
        update("yeta3120DAO.updateYeta3120_S", vo);
    }
    ...
    public void deleteYetaP03004To3120(Yeta3120VO vo) throws Exception {
        delete("yeta3120DAO.deleteYeta3120_S", vo);
    }
    ...
    public List selectYetaP03004To3120List(Yeta3120SrhVO searchVO) throws Exception {
        return list("yeta3120DAO.selectYetaP03004To3120List_D", searchVO);
    }
    ...
    public int selectYetaP03004To3120ListTotCnt(Yeta3120SrhVO searchVO) {
        return (Integer)getSqlMapClientTemplate().queryForObject("yeta3120DAO.selectYetaP03004To3120ListTotCnt_S", searchVO);
    }
    ...
    public void fnPayr06430_PAYR450_CREATE_Delete(Yeta3120VO vo) throws Exception {
        delete("yeta3120DAO.fnPayr06430_PAYR450_CREATE_Delete_S", vo);
    }
    ...
    public Yeta3120VO selectYeta3120(Yeta3120VO vo) throws Exception {
        return (Yeta3120VO) selectByPk("yeta3120DAO.selectYeta3120_S", vo);
    }
    ...
    public List<?> selectYeta3120List(Yeta3120SrhVO searchVO) throws Exception {
        return list("yeta3120DAO.selectYeta3120List_D", searchVO);
    }
    ...
    public int selectYeta3120ListTotCnt(Yeta3120SrhVO searchVO) {
        return (Integer)getSqlMapClientTemplate().queryForObject("yeta3120DAO.selectYeta3120ListTotCnt_S", searchVO);
    }
