...
import com.app.exterms.yearendtax.client.form.defs.yeta2015.Yeta3100Def;
import com.app.exterms.yearendtax.client.service.yeta2015.YetaP03007Service;
import com.app.exterms.yearendtax.client.service.yeta2015.YetaP03007ServiceAsync;
...
=====================================================**/
public  class YetaP03007   extends MSFFormPanel {  
 ...
 **/
	...
	private  ContentPanel cpYeta03007; 
	...
	// -------------- grid 선언 시작  ---------------	  
	private MSFGridPanel yetaP03007GridPanel;
...
//	private Yeta0300Def yeta0300Def_012  = new Yeta0300Def("YETA030012");	//종전근무지내역 그리드 테이블 컬럼 define 
	private Yeta3100Def yetaP03007ToYeta3100Def  = new Yeta3100Def("YETAP03007");	//종전근무지내역 그리드 테이블 컬럼 define 
	// -------------- grid 선언 종료  ---------------
 ...
 **/ 
	...
	// -------------- 서비스 호출 시작 --------------
	private YetaP03007ServiceAsync yetaP03007Service = YetaP03007Service.Util.getInstance();
	// -------------- 서비스 호출 종료 --------------		
     ...
     */  
		...
		private void yetaP03007FormSave() {  
			if (MSFSharedUtils.paramNotNull(records)) { 
	              
				List<Yeta3100DTO> listYeta3100dto = new ArrayList<Yeta3100DTO>();  
				...
				yetaP03007Service.activityOnYetaP03007ToYeta3100(listYeta3100dto, actionDatabase, new AsyncCallback<Long>(){
					public void onFailure(Throwable caught) {
						MessageBox.alert(MSFMainApp.MSFCONSTANTS.ExceptionTitleService(), 
	                              MSFMainApp.ADMINMESSAGES.ExceptionMessageService("activityOnYetaP03007ToYeta3100(" + actionDatabase.name() + ") : " + caught), null);
					}
...
//		 }
		 ...
		 * ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
		 **/		  
	  public YetaP03007(final ActionDatabase actionDatabase, final MSFPanel caller) {
...
//			initLoad(); 
	       ...
	       // this.setLayout(layout);   
	        ...
	        cpYeta03007 = new ContentPanel();  
	        
	        createSearchForm();			//검색필드를 적용
	        createMsfGridForm();		//그리드필드
		   
	           
		   cpYeta03007.setBodyBorder(false);
		   cpYeta03007.setBorders(false);
		   cpYeta03007.setHeaderVisible(false);
		   cpYeta03007.setSize("790px", "640px");
		   
		   this.add(cpYeta03007);
...
//			     });     
			...
			cpYeta03007.setLayout(new FlowLayout());
...
//					systemkey.setValue("20080013");
					 ...
					 yetaP03007GridPanel.getMsfGrid().clearData();
					 
					 BaseModel bmData = yetaP03007GridPanel.getTableDef().getDefaultValues();  
			         ...
			         yetaP03007GridPanel.getMsfGrid().getGrid().stopEditing();      
			         yetaP03007GridPanel.getMsfGrid().getGrid().getStore().insert(bmData,0);   
			         yetaP03007GridPanel.getMsfGrid().getGrid().startEditing(yetaP03007GridPanel.getMsfGrid().getGrid().getStore().indexOf(bmData), 0);   
...
//					doAction(actionDatabase);
			...
			btnYetaDel.addListener(Events.Select, new Listener<ButtonEvent>() {
				public void handleEvent(ButtonEvent e) {
					Iterator<BaseModel> itBm = yetaP03007GridPanel.getMsfGrid().getGrid().getSelectionModel().getSelectedItems().listIterator();
			...
			btnYetaSave.addListener(Events.Select, new Listener<ButtonEvent>() {
				public void handleEvent(ButtonEvent e) {
					setListRecord(yetaP03007GridPanel.getMsfGrid().getStore().getModifiedRecords().iterator());
					doAction(actionDatabase);
...
//			cpYeta03007.add(topYetaBtnBar);		
			...
			yetaP03007GridPanel = new MSFGridPanel(yetaP03007ToYeta3100Def, false, false, false, false, false);
			yetaP03007GridPanel.setSize("790px", "500px");
			yetaP03007GridPanel.setBorders(false);
			yetaP03007GridPanel.setHeaderVisible(false);
			
			cpYeta03007.add(yetaP03007GridPanel);
			...
			cpYeta03007.add(layoutContainer);
	}
		...
		public void reload() {
				...
				yetaP03007GridPanel.getTableDef().setTableColumnFilters(filters);
				yetaP03007GridPanel.getTableDef().addColumnFilter("edacRvyy", MSFSharedUtils.allowNulls(srhEdacRvyy.getValue())
...
//						, SimpleColumnFilter.OPERATOR_EQUALS);//연말정산귀속년도
				yetaP03007GridPanel.getTableDef().addColumnFilter("settGbcd", MSFSharedUtils.getSelectedComboValue(srhSettGbcd,"commCd")
						, SimpleColumnFilter.OPERATOR_EQUALS);//정산구분
				yetaP03007GridPanel.getTableDef().addColumnFilter("systemkey", MSFSharedUtils.allowNulls(systemkey.getValue())
						, SimpleColumnFilter.OPERATOR_EQUALS);//시스템키
			 
				yetaP03007GridPanel.reload();
