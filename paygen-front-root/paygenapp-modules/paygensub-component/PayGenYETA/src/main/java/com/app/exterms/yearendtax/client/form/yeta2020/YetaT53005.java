...
import com.app.exterms.yearendtax.client.service.yeta2020.YetaT53005Service;
import com.app.exterms.yearendtax.client.service.yeta2020.YetaT53005ServiceAsync;
...
//import com.app.exterms.yearendtax.client.form.defs.yeta2016.YetaT53005Def;
...
=====================================================**/
public  class YetaT53005   extends MSFFormPanel {  
 ...
 **/
	...
	private  ContentPanel cpYetaT53005; 
	...
	// -------------- grid 선언 시작  ---------------	  
	private MSFGridPanel YetaT53005GridPanel;
//	private YetaT53005Def YetaT53005Def = new YetaT53005Def("YetaT53005");   //TODO 일단 화면번호로 Def
	// -------------- grid 선언 종료  ---------------
	...
	// -------------- 서비스 호출 시작 --------------
	private YetaT53005ServiceAsync yetaT53005Service = YetaT53005Service.Util.getInstance();
	// -------------- 서비스 호출 종료 --------------	 
...
//					ye162510Dto.setMnthRnttyHusCnttArea((MSFSharedUtils.allowNulls(bmMapModel.get("mnthRnttyHusCnttArea"))));    		/** column 월세주택계약면적 : mnthRnttyHusCnttArea */
				...
				yetaT53005Service.activityOnYetaT53005(listYe162510Dto, actionDatabase, new AsyncCallback<Long>(){
...
//		 }
	...
	public YetaT53005(final ActionDatabase actionDatabase, final MSFPanel caller) {
...
//		initLoad(); 	
		...
		this.actionDatabase = actionDatabase;
	 	...
	 	cpYetaT53005 = new ContentPanel();  

		createSearchForm();			//기본정보 필드를 적용
	 	createMsfGridForm();		//그리드필드
		   
		cpYetaT53005.setBodyBorder(false);
		cpYetaT53005.setBorders(false);
		cpYetaT53005.setHeaderVisible(false);
		cpYetaT53005.setSize("790px", "640px");
		   
		this.add(cpYetaT53005);
...
//		     });     
		...
		cpYetaT53005.setLayout(new FlowLayout());
...
//	      	     }
//				 
//				YetaT53005GridPanel.getMsfGrid().clearData();
//				 
//				BaseModel bmData = YetaT53005GridPanel.getTableDef().getDefaultValues();  
//		              
...
//		         
//		        YetaT53005GridPanel.getMsfGrid().getGrid().stopEditing();      
//		        YetaT53005GridPanel.getMsfGrid().getGrid().getStore().insert(bmData,0);   
//		        YetaT53005GridPanel.getMsfGrid().getGrid().startEditing(YetaT53005GridPanel.getMsfGrid().getGrid().getStore().indexOf(bmData), 0);   
//
...
//			public void handleEvent(ButtonEvent e) {
//				Iterator<BaseModel> itBm = YetaT53005GridPanel.getMsfGrid().getGrid().getSelectionModel().getSelectedItems().listIterator();
...
//		topYetaBtnBar.add(btnYetaDel);
		...
		btnYetaSave.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				setListRecord(YetaT53005GridPanel.getMsfGrid().getStore().getModifiedRecords().iterator());
				doAction(actionDatabase);
...
//			topYetaBtnBar.add(btnYetaClose);
		...
		cpYetaT53005.add(topYetaBtnBar);
...
//		YetaT53005GridPanel = new MSFGridPanel(YetaT53005Def, false, false, false, false, false);
//		YetaT53005GridPanel.setSize("790px", "420px");
//		YetaT53005GridPanel.setBorders(true);
//		YetaT53005GridPanel.setHeaderVisible(false);
//		
...
//		
//		YetaT53005GridPanel.getGrid().getColumnModel().addAggregationRow(payrSummaryRow);  
//		
...
//		
//		YetaT53005GridPanel.getGrid().getColumnModel().addAggregationRow(payrSummaryRow1);
//		/** --- 그리드 합계 부분  종료 --- **/
		
//      cpYetaT53005.add(YetaT53005GridPanel);
		...
		cpYetaT53005.add(fldstNewFieldset);
		cpYetaT53005.add(layoutContainer1_1);
		cpYetaT53005.add(fldstNewFieldset_1);
	...
	public void reload() {
			...
			YetaT53005GridPanel.getTableDef().setTableColumnFilters(filters);
			YetaT53005GridPanel.getTableDef().addColumnFilter("yrtxBlggYr", MSFSharedUtils.allowNulls(srhYrtxBlggYr.getValue())
...
//					, SimpleColumnFilter.OPERATOR_EQUALS);//연말정산귀속년도
			YetaT53005GridPanel.getTableDef().addColumnFilter("clutSeptCd", MSFSharedUtils.getSelectedComboValue(srhClutSeptCd,"commCd")
					, SimpleColumnFilter.OPERATOR_EQUALS);//정산구분
			YetaT53005GridPanel.getTableDef().addColumnFilter("systemkey", MSFSharedUtils.allowNulls(systemkey.getValue())
					, SimpleColumnFilter.OPERATOR_EQUALS);//시스템키
		 
			YetaT53005GridPanel.reload();
