...
import com.app.exterms.yearendtax.client.form.defs.yeta2019.Ye162030Def;
import com.app.exterms.yearendtax.client.service.yeta2019.YetaT43007Service;
import com.app.exterms.yearendtax.client.service.yeta2019.YetaT43007ServiceAsync;
...
=====================================================**/
public  class YetaT43007   extends MSFFormPanel {  
 ...
 **/
	...
	private  ContentPanel cpYetaT43007; 
	...
	// -------------- grid 선언 시작  ---------------	  
	private MSFGridPanel YetaT43007GridPanel;
	private Ye162030Def ye162030Def = new Ye162030Def("YetaT43007");   
	...
	// -------------- 서비스 호출 시작 --------------
	private YetaT43007ServiceAsync yetaT43007Service = YetaT43007Service.Util.getInstance();
	// -------------- 서비스 호출 종료 --------------	 
...
//					ye162510Dto.setMnthRnttyHusCnttArea((MSFSharedUtils.allowNulls(bmMapModel.get("mnthRnttyHusCnttArea"))));    		/** column 월세주택계약면적 : mnthRnttyHusCnttArea */
				...
				yetaT43007Service.activityOnYetaT43007(listYe162510Dto, actionDatabase, new AsyncCallback<Long>(){
...
//		 }
	...
	public YetaT43007(final ActionDatabase actionDatabase, final MSFPanel caller) {
...
//		initLoad(); 	
		...
		this.actionDatabase = actionDatabase;
	 	...
	 	cpYetaT43007 = new ContentPanel();  

		createSearchForm();			//기본정보 필드를 적용
	 	createMsfGridForm();		//그리드필드
		   
		cpYetaT43007.setBodyBorder(false);
		cpYetaT43007.setBorders(false);
		cpYetaT43007.setHeaderVisible(false);
		cpYetaT43007.setSize("790px", "640px");
		   
		this.add(cpYetaT43007);
...
//		     });     
		...
		cpYetaT43007.setLayout(new FlowLayout());
...
//	      	     }
//				 
//				YetaT43007GridPanel.getMsfGrid().clearData();
//				 
//				BaseModel bmData = YetaT43007GridPanel.getTableDef().getDefaultValues();  
//		              
...
//		         
//		        YetaT43007GridPanel.getMsfGrid().getGrid().stopEditing();      
//		        YetaT43007GridPanel.getMsfGrid().getGrid().getStore().insert(bmData,0);   
//		        YetaT43007GridPanel.getMsfGrid().getGrid().startEditing(YetaT43007GridPanel.getMsfGrid().getGrid().getStore().indexOf(bmData), 0);   
//
...
//			public void handleEvent(ButtonEvent e) {
//				Iterator<BaseModel> itBm = YetaT43007GridPanel.getMsfGrid().getGrid().getSelectionModel().getSelectedItems().listIterator();
...
//			public void handleEvent(ButtonEvent e) {
//				setListRecord(YetaT43007GridPanel.getMsfGrid().getStore().getModifiedRecords().iterator());
//				doAction(actionDatabase);
//
//				if ((ActionDatabase.INSERT).equals(actionDatabase)) {
//					actionDatabase = ActionDatabase.INSERT;
...
//				
//		cpYetaT43007.add(topYetaBtnBar);
...
//		cpYetaT43007.add(topYetaBtnBar);
		...
		YetaT43007GridPanel = new MSFGridPanel(ye162030Def, false, false, false, false, false);
		YetaT43007GridPanel.setSize("790px", "200px");
		YetaT43007GridPanel.setBorders(true);
		YetaT43007GridPanel.setHeaderVisible(false);
...
//		
//		YetaT43007GridPanel.getGrid().getColumnModel().addAggregationRow(payrSummaryRow);  
//		
...
//		
//		YetaT43007GridPanel.getGrid().getColumnModel().addAggregationRow(payrSummaryRow1);
//		/** --- 그리드 합계 부분  종료 --- **/
		
//        cpYetaT43007.add(YetaT43007GridPanel);
...
//		cpYetaT43007.add(layoutContainer1);
//		cpYetaT43007.add(layoutContainer2);
		fldstNewFieldset.add(YetaT43007GridPanel);
		cpYetaT43007.add(fldstNewFieldset);
		cpYetaT43007.add(layoutContainer10);
		cpYetaT43007.add(fldstNewFieldset_1);
	...
	public void reload() {
			...
			YetaT43007GridPanel.getTableDef().setTableColumnFilters(filters);
			YetaT43007GridPanel.getTableDef().addColumnFilter("yrtxBlggYr", MSFSharedUtils.allowNulls(srhYrtxBlggYr.getValue())
...
//					, SimpleColumnFilter.OPERATOR_EQUALS);//연말정산귀속년도
			YetaT43007GridPanel.getTableDef().addColumnFilter("clutSeptCd", MSFSharedUtils.getSelectedComboValue(srhClutSeptCd,"commCd")
					, SimpleColumnFilter.OPERATOR_EQUALS);//정산구분
			YetaT43007GridPanel.getTableDef().addColumnFilter("systemkey", MSFSharedUtils.allowNulls(systemkey.getValue())
					, SimpleColumnFilter.OPERATOR_EQUALS);//시스템키
		 
			YetaT43007GridPanel.reload();
