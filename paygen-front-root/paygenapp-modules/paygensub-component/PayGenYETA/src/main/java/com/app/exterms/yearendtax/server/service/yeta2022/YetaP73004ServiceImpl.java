...
import com.app.exterms.yearendtax.server.vo.Ye162530Srh_2022_VO;
 ...
 */
@Service("YetaP73004Service")
public class YetaP73004ServiceImpl  extends AbstractCustomServiceImpl implements YetaP73004Service  ,YetaDaoConstants {

	 
	private static final Logger logger = LoggerFactory.getLogger(YetaP73004ServiceImpl.class);
	private static final String calledClass = YetaP73004ServiceImpl.class.getName();
	  
	
	@Autowired
	@Resource(name = "Ye162520_2022_DAO")
	private Ye162520_2022_DAO ye162520DAO;
	
	@Autowired
	@Resource(name = "Ye162530_2022_DAO")
	private Ye162530_2022_DAO ye162530DAO;
	...
	public Long activityOnYetaP73004ToYe162520(List<Ye162520DTO> listYe162520Dto, ActionDatabase actionDatabase) throws MSFException {
		...
		String method = calledClass + ".activityOnYetaP73004ToYe162520";

		Ye162520DTO ye162520Dto = new Ye162520DTO();
		Ye162520_2022_VO ye162520Vo = new Ye162520_2022_VO();
		...
		try {
			...
			if (MSFSharedUtils.paramNull(ye162520DAO)) {
				...
				ye162520DAO = (Ye162520_2022_DAO) wac.getBean("Ye162520_2022_DAO");
			...
			for (int iPsnlCnt = 0; iPsnlCnt < listYe162520Dto.size(); iPsnlCnt++) {
				...
				ye162520Vo = new Ye162520_2022_VO();
...
//				ye162520Vo.setEctnFlTrnrCtlYn(MSFSharedUtils.allowNulls(ye162520Dto.getEctnFlTrnrCtlYn()));    								/** column 전자파일이관여부 : ectnFlTrnrCtlYn */
				...
				case INSERT:
					...
					ye162520DAO.insertYetaP73004ToYe162520(ye162520Vo);
					break;
					
				case UPDATE:
					
					ye162520DAO.updateYetaP73004ToYe162520(ye162520Vo);
					break;
					
				case DELETE:
					
					ye162520DAO.deleteYetaP73004ToYe162520(ye162520Vo);
					break;
			...
			logger.error("EXCEPTION calling activityOnYetaP73004ToYe162520(): "+ex); 
		            
			/** 에러 로그 **/			
		    MSFLogHistoryUtils.tracerUserExceptionActivity(sessionUser,method,calledClass,"C:U:D",ex, windowNm , windowId);
		            
		    result = new Long(0);
		    throw MSFServerUtils.getOperationException("activityOnYetaP73004ToYe162520", ex, logger);
	...
	public Long activityOnYetaP73004ToYe162530(List<Ye162530DTO> listYe162530Dto, ActionDatabase actionDatabase) throws MSFException {
		...
		MSFSysm0100BM sessionUser;
		String method = calledClass + ".activityOnYetaP73004ToYe162530";

		Ye162530DTO ye162530Dto = new Ye162530DTO();
		Ye162530_2022_VO ye162530Vo = new Ye162530_2022_VO();
		...
		try {
			if (MSFSharedUtils.paramNull(ye162530DAO)) {
				...
				WebApplicationContext wac = WebApplicationContextUtils.getRequiredWebApplicationContext(getHttpServletRequest().getSession().getServletContext());
				ye162530DAO = (Ye162530_2022_DAO) wac.getBean("Ye162530_2022_DAO");
			...
			for (int iPsnlCnt = 0; iPsnlCnt < listYe162530Dto.size(); iPsnlCnt++) {
				...
				ye162530Vo = new Ye162530_2022_VO();  
...
//				ye162530Vo.setEctnFlTrnrCtlYn(MSFSharedUtils.allowNulls(ye162530Dto.getEctnFlTrnrCtlYn()));    								/** column 전자파일이관여부 : ectnFlTrnrCtlYn */				
				...
				switch (actionDatabase) {
					case INSERT:
		        		...
		        		ye162530DAO.insertYetaP73004ToYe162530(ye162530Vo); 
		        		
		        		break;
		        	
		            case UPDATE: 
		            	
		            	ye162530DAO.updateYetaP73004ToYe162530(ye162530Vo);
		            	break;
		            	
		            case DELETE: 
		            	ye162530DAO.deleteYetaP73004ToYe162530(ye162530Vo); 
		            	break;
			...
			logger.error("EXCEPTION calling activityOnYetaP73004ToYe162530(): "+ex); 
			...
			result = new Long(0);
			throw MSFServerUtils.getOperationException("activityOnYetaP73004ToYe162530", ex, logger);
	...
	/** 금전소비대차계약 조회 **/
	public PagingLoadResult<BaseModel> getYetaP73004ToYe162520DataList(ServiceParameters serviceParameters) throws MSFException {
			

			PagingLoadResult<BaseModel> retval = null;
			String method =  CLASS_YETAP73004_TO_YE162520_DATA_LIST;
			Ye162520Srh_2022_VO   ye162520SrhVo = new Ye162520Srh_2022_VO();
...
//		    	ye162520SrhVo.setComrCalnSeilNum(MSFSharedUtils.allowNulls(MSFServerUtils.getFilterValue(columnFilters, "comrCalnSeilNum")));    /** column 금전소비대차일련번호 : comrCalnSeilNum */
				...
				if ( pagingValues.executeRecordCount ) { 
		        	...
		        	TimingInfo millisBeginQueryCount = SmrmfUtils.startTiming(logger);
		          	...
		          	int iResultCnt = ye162520DAO.selectYetaP73004ToYe162520ListTotCnt(ye162520SrhVo);  
		     	...
		     	TimingInfo millisBeginYetaP73004ToYe162520DataList = SmrmfUtils.startTiming(logger);
...
//		            Collection<Map<String, Object>> list ??????
		     	List list = ye162520DAO.selectYetaP73004ToYe162520List(ye162520SrhVo);
				...
				SmrmfUtils.endTiming(logger, millisBeginYetaP73004ToYe162520DataList, "getYetaP73004ToYe162520DataList");
	...
	/** 임대차계약 조회 **/
	public PagingLoadResult<BaseModel> getYetaP73004ToYe162530DataList(ServiceParameters serviceParameters) throws MSFException {
			

		PagingLoadResult<BaseModel> retval = null;
		String method = CLASS_YETAP73004_TO_YE162530_DATA_LIST;
		Ye162530Srh_2022_VO ye162530SrhVo = new Ye162530Srh_2022_VO();
		List<BaseModel> bmResult = new ArrayList<BaseModel>();
		MSFSysm0100BM sessionUser;
			...
			try {
				...
				if ( pagingValues.executeRecordCount ) { 
		        	...
		        	TimingInfo millisBeginQueryCount = SmrmfUtils.startTiming(logger);
		          	...
		          	int iResultCnt = ye162530DAO.selectYetaP73004ToYe162530ListTotCnt(ye162530SrhVo);  
		     	...
		     	@SuppressWarnings("unchecked")
//		            Collection<Map<String, Object>> list ??????
		     	List list = ye162530DAO.selectYetaP73004ToYe162530List(ye162530SrhVo);
