...
/**
 * @Class Name : PdfG104yVO.java
 * @Description : PdfG104y VO class
 ...
 */
public class PdfG104yDTO   implements Serializable {
    ...
    private java.math.BigDecimal cardSeilNum;
    ...
    private java.math.BigDecimal cardAmtSum;
    ...
    public java.math.BigDecimal getCardSeilNum() {
        return this.cardSeilNum;
    }
    
    public void setCardSeilNum(java.math.BigDecimal cardSeilNum) {
        this.cardSeilNum = cardSeilNum;
    }
    ...
    public java.math.BigDecimal getCardAmtSum() {
        return this.cardAmtSum;
    }
    
    public void setCardAmtSum(java.math.BigDecimal cardAmtSum) {
