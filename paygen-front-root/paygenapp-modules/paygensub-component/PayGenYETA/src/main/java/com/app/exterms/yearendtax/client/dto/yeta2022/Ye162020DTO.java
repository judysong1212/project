 ...
 */
public class Ye162020DTO   implements Serializable {
    ...
    /** set 퇴직연금소득공제구분코드 : rtpnAccRtpnCl */
    ...
    private Long rtpnAccPymAmt;

    /** set 퇴직연금세액공제금액 : rtpnAccTxamtDdcAmt */
    private Long rtpnAccTxamtDdcAmt;
	...
	public Long getRtpnAccPymAmt() {
		return rtpnAccPymAmt;
	}

	public void setRtpnAccPymAmt(Long rtpnAccPymAmt) {
		this.rtpnAccPymAmt = rtpnAccPymAmt;
	}

	public Long getRtpnAccTxamtDdcAmt() {
		return rtpnAccTxamtDdcAmt;
	}

	public void setRtpnAccTxamtDdcAmt(Long rtpnAccTxamtDdcAmt) {
