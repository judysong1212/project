...
public class YetaT13014Def extends TableDef implements YetaDaoConstants{
	private int row = 0;
	final PrgmComBass0300DTO sysComBass0300Dto;
	
	public YetaT13014Def(String chkDef) {
		...
		if("YetaT13001".equals(chkDef)) { //TODO 테이블 정의되면 다시 구현.
		    ...
		    setColumnsDefinition(getColumnsListYetaT13001()); 
		}else {
...
//	        setCustomListMethod(CLASS_YETA0100_LIST);
	...
	private List<ColumnDef> getColumnsListYetaT13001() { //TODO BM 다시 정의.
        List<ColumnDef> listColumnDefs = new ArrayList<ColumnDef>();
