...
import com.app.exterms.yearendtax.server.service.yeta2015.dao.Yeta3000DAO;
import com.app.exterms.yearendtax.server.service.yeta2015.dao.Yeta3150DAO;
import com.app.exterms.yearendtax.server.service.yeta2015.dao.Yeta3170DAO;
import com.app.exterms.yearendtax.server.service.yeta2015.dao.Yeta3220DAO;
...
import com.app.smrmf.pkg.listener.yeta.yeta2015.YetaListenerAdapter;
...
* </pre>
 */
@Service("Yeta0300Service")
public class Yeta0300ServiceImpl  extends AbstractCustomServiceImpl implements Yeta0300Service  ,YetaDaoConstants {
	...
	private static final Logger logger = LoggerFactory.getLogger(Yeta0300ServiceImpl.class);
	private static final String calledClass = Yeta0300ServiceImpl.class.getName();
	...
	//대상자 정보 조회
	public PagingLoadResult<BaseModel> getYeta0300ToYeta2000List(ServiceParameters serviceParameters) throws MSFException {
		

		PagingLoadResult<BaseModel> retval = null;
		String method =  CLASS_YETA0300ToYETA2000_LIST;
...
//	            Collection<Map<String, Object>> list ??????
	...
	//인적공제명세 정보 조회
	public PagingLoadResult<BaseModel> getYeta0300To3220List(ServiceParameters serviceParameters) throws MSFException {
		

		PagingLoadResult<BaseModel> retval = null;
		String method =  CLASS_YETA0300To3220_LIST;
		...
		if  (MSFSharedUtils.paramNull(yeta3220DAO)) {
			WebApplicationContext wac = WebApplicationContextUtils.getRequiredWebApplicationContext( getHttpServletRequest().getSession().getServletContext());
			yeta3220DAO = (Yeta3220DAO) wac.getBean("Yeta3220DAO"); 
		}
...
//	            Collection<Map<String, Object>> list ??????
	...
	//교육비내역 조회
	public PagingLoadResult<BaseModel> getYeta0300To3150List(ServiceParameters serviceParameters) throws MSFException {
			

			PagingLoadResult<BaseModel> retval = null;
			String method =  CLASS_YETA0300To3150_LIST;
			...
			if  (MSFSharedUtils.paramNull(yeta3150DAO)) {
				WebApplicationContext wac = WebApplicationContextUtils.getRequiredWebApplicationContext( getHttpServletRequest().getSession().getServletContext());
				yeta3150DAO = (Yeta3150DAO) wac.getBean("Yeta3150DAO"); 
			}
...
//				SmrmfUtils.endTiming(logger, millisBeginPsnl0126DataList, "getYeta0300To2000List");
	 ...
	 * @throws MSFException
	 */
	public PagingLoadResult<BaseModel> getYeta0300ToSubTaxList(ServiceParameters serviceParameters) throws MSFException {
		

		PagingLoadResult<BaseModel> retval = null;
		String method =  CLASS_YETA0300TOSUBTAX_LIST;
		...
		if  (MSFSharedUtils.paramNull(yeta3000DAO)) {
			WebApplicationContext wac = WebApplicationContextUtils.getRequiredWebApplicationContext( getHttpServletRequest().getSession().getServletContext());
			yeta3000DAO = (Yeta3000DAO) wac.getBean("Yeta3000DAO"); 
		}
...
//	            Collection<Map<String, Object>> list ??????
			...
			SmrmfUtils.endTiming(logger, millisBeginYeta0300ToSubTaxDataList, "getYeta0300To2000List");
	...
	//소득공제명세 합계내역 조회
	public PagingLoadResult<BaseModel> getYeta0300To3220SumList(ServiceParameters serviceParameters) throws MSFException {
		

		PagingLoadResult<BaseModel> retval = null;
		String method =  CLASS_YETA0300To3220_SUM_LIST;
		Yeta3220SrhVO   yeta3220SrhVo = new Yeta3220SrhVO();
		List<BaseModel>  bmResult = new ArrayList<BaseModel>();
		MSFSysm0100BM sessionUser;
...
//	            Collection<Map<String, Object>> list ??????
	...
	/**기본사항 tab 수정 **/ 
	@Override
	public int saveYeta0300To2000tabItem01(Yeta2000DTO Yeta2000Dto)throws Exception {
		...
		String windowId = "YETA0300";
		
		// 1. 암호화 객체 생성
		String nResult = AnyCryptUtils.XecureCryptInitialize(RemoteServiceUtil.getThreadLocalConfig(),RemoteServiceUtil.getThreadLocalRequest());
		
		String method = calledClass + ".saveYeta0300To2000tabItem01";
...
//		yeta2000Vo.setInptAddr(RemoteServiceUtil.getThreadLocalRequest().getRemoteHost());
	...
	@Override
	public int saveYeta0300To2000tabItem04(Yeta2000DTO Yeta2000Dto)throws Exception {
		// TODO Auto-generated method stub
		
		int result = 0;
		String method = calledClass + ".saveYeta0300To2000tabItem04";
...
//		yeta2000Vo.setInptAddr(RemoteServiceUtil.getThreadLocalRequest().getRemoteHost());
	...
	@Override
	public int saveYeta0300To2000tabItem05_1(Yeta2000DTO Yeta2000Dto)throws Exception {
		// TODO Auto-generated method stub
		
		int result = 0;
		String method = calledClass + ".saveYeta0300To2000tabItem05_1";
	...
	@Override
	public int saveYeta0300To2000tabItem05_2(Yeta2000DTO Yeta2000Dto)throws Exception {
		// TODO Auto-generated method stub
		
		int result = 0;
		String method = calledClass + ".saveYeta0300To2000tabItem05_2";
...
//		yeta2000Vo.setInptAddr(RemoteServiceUtil.getThreadLocalRequest().getRemoteHost());
	...
	/**그밖의소득공제1tab 금액 수정 **/
	@Override
	public int saveYeta0300To2000tabItem06(Yeta2000DTO Yeta2000Dto)throws Exception {
		// TODO Auto-generated method stub
		
		int result = 0;
		String method = calledClass + ".saveYeta0300To2000tabItem06";
		...
		yeta2000Vo.setEtgdH14f(new BigDecimal(MSFSharedUtils.defaultNulls( Yeta2000Dto.getEtgdH14f(), "0"))); // 기타공제_투자조합출자금액_2014년도
		yeta2000Vo.setEtclH15f(new BigDecimal(MSFSharedUtils.defaultNulls( Yeta2000Dto.getEtclH15f(), "0"))); //기타공제_투자조합출자금액_2015년이후
		...
		yeta2000Vo.setEtadD14l(new BigDecimal(MSFSharedUtils.defaultNulls( Yeta2000Dto.getEtadD14l(), "0"))); //기타공제_본인추가공제율사용액_2014하
...
//		yeta2000Vo.setInptAddr(RemoteServiceUtil.getThreadLocalRequest().getRemoteHost());
	...
	/**그밖의소득공제2tab 금액 수정 **/
	@Override
	public int saveYeta0300To2000tabItem07(Yeta2000DTO Yeta2000Dto)throws Exception {
		// TODO Auto-generated method stub
		
		int result = 0;
		String method = calledClass + ".saveYeta0300To2000tabItem07";
...
//		yeta2000Vo.setInptAddr(RemoteServiceUtil.getThreadLocalRequest().getRemoteHost());
	...
	@Override
	public int saveYeta0300To2000tabItem08_1(Yeta2000DTO Yeta2000Dto)throws Exception {
		// TODO Auto-generated method stub
		
		int result = 0;
		String method = calledClass + ".saveYeta0300To2000tabItem08_1";
...
//		yeta2000Vo.setInptAddr(RemoteServiceUtil.getThreadLocalRequest().getRemoteHost());
	...
	@Override
	public int saveYeta0300To2000tabItem08_3(Yeta2000DTO Yeta2000Dto) throws Exception {
		// TODO Auto-generated method stub

		int result = 0;
		String method = calledClass + ".saveYeta0300To2000tabItem08_3";
...
//		yeta2000Vo.setKybdr(sessionUser.getUsrId());
	...
	@Override
	public Long saveYeta0300To2000tabItem08_3(List<Yeta3150DTO> listYeta3150dto, ActionDatabase actionDatabase) throws Exception {
...
//            	yeta3150Vo.setSystemkey(MSFSharedUtils.allowNulls(yeta3150Dto.getSystemkey())); /** column SYSTEMKEY : systemkey */
            	...
            	yeta3150Vo.setRsnoNumb(MSFSharedUtils.allowNulls(yeta3150Dto.getRsnoNumb().replace("-", "")));
...
//            	}
	...
	/**세액감면및세액공제2 금액 수정 **/
	@Override
	public int saveYeta0300To2000tabItem09(Yeta2000DTO Yeta2000Dto)throws Exception {
		// TODO Auto-generated method stub
		
		int result = 0;
		String method = calledClass + ".saveYeta0300To2000tabItem09";
...
//		yeta2000Vo.setInptAddr(RemoteServiceUtil.getThreadLocalRequest().getRemoteHost());
	...
	/**추가제출서류 수정 **/
	@Override
	public int saveYeta0300To2000tabItem10(Yeta2000DTO Yeta2000Dto)throws Exception {
		// TODO Auto-generated method stub
		
		int result = 0;
		String method = calledClass + ".saveYeta0300To2000tabItem10";
...
//		yeta2000Vo.setInptAddr(RemoteServiceUtil.getThreadLocalRequest().getRemoteHost());
	 ...
	 */
	@Override
	public Long activityOnYeta0300ToYeta3220(List<Yeta3220DTO> listYeta3220dto, ActionDatabase actionDatabase)  throws MSFException {
		...
		String method = calledClass + ".activityOnYeta0300ToYeta3220";
		MSFSysm0100BM sessionUser = MSFServerUtils.getLoggedUser(RemoteServiceUtil.getThreadLocalRequest());
...
//	            yeta3220Vo.setPantOnyn(("true".equals(yeta3220Dto.getPantOnyn()) ? "1" : "0"));	/** column 한부모공제여부 : pantOnyn */
	  ...
	  */
	@Override
	public int saveYeta0300To2000tabItem03(List<Yeta3220DTO> listYeta3220_1dto, List<Yeta3220DTO> listYeta3220_2dto)  throws MSFException {
		...
		String method = calledClass + ".saveYeta0300To2000tabItem03";
		MSFSysm0100BM sessionUser = MSFServerUtils.getLoggedUser(RemoteServiceUtil.getThreadLocalRequest());
...
//	            yeta3220Vo.setRsnoNumb(MSFSharedUtils.allowNulls(yeta3220Dto.getRsnoNumb().replace("-", "")));    		/** column 주민등록번호 : rsnoNumb */
	            ...
	            yeta3220Vo.setInsuPayr(new BigDecimal(yeta3220Dto.getInsuPayr()));    							/** column 보험료_건강고용등국세청 : insuPayr */
	            yeta3220Vo.setInsuRtyr(new BigDecimal(MSFSharedUtils.allowNulls(yeta3220Dto.getInsuRtyr())));	/** column 보험료보장성_국세청 : insuRtyr */
	            yeta3220Vo.setPsclIurr(new BigDecimal(MSFSharedUtils.allowNulls(yeta3220Dto.getPsclIurr())));   /** column 보험료장애인보장성_국세청 : psclIurr */
	            yeta3220Vo.setMediCost(new BigDecimal(MSFSharedUtils.allowNulls(yeta3220Dto.getMediCost())));   /** column 의료비_국세청 : mediCost */
	            yeta3220Vo.setEducCost(new BigDecimal(MSFSharedUtils.allowNulls(yeta3220Dto.getEducCost())));   /** column 교육비_국세청 : educCost */
	            yeta3220Vo.setCdteCard(new BigDecimal(MSFSharedUtils.allowNulls(yeta3220Dto.getCdteCard())));   /** column 신용카드등_국세청 : cdteCard */
	            yeta3220Vo.setCashRece(new BigDecimal(MSFSharedUtils.allowNulls(yeta3220Dto.getCashRece())));   /** column 현금영수증_국세청 : cashRece */
	            yeta3220Vo.setJiblCard(new BigDecimal(MSFSharedUtils.allowNulls(yeta3220Dto.getJiblCard())));   /** column 직불카드등_국세청 : jiblCard */
	            yeta3220Vo.setGrpyAmnt(new BigDecimal(MSFSharedUtils.allowNulls(yeta3220Dto.getGrpyAmnt())));   /** column 지로납부액_대중교통_국세청 : grpyAmnt */
	            yeta3220Vo.setMgntStvd(new BigDecimal(MSFSharedUtils.allowNulls(yeta3220Dto.getMgntStvd())));   /** column 전통시장사용분_국세청 : mgntStvd */
	            yeta3220Vo.setCtrbAmnt(new BigDecimal(MSFSharedUtils.allowNulls(yeta3220Dto.getCtrbAmnt())));   /** column 기부금액_국세청 : ctrbAmnt */
			...
			result = 0;
			ex.printStackTrace();
			throw MSFServerUtils.getOperationException("saveYeta0300To2000tabItem03_1", ex, logger);
...
//	            yeta3220Vo.setRsnoNumb(MSFSharedUtils.allowNulls(yeta3220Dto.getRsnoNumb().replace("-", "")));	/** column 주민등록번호 : rsnoNumb */
	            ...
	            yeta3220Vo.setInsuFetc(new BigDecimal(MSFSharedUtils.allowNulls(yeta3220Dto.getInsuFetc())));    /** column 보험료_건강고용등외FinsuRtet : insuFetc */
	            yeta3220Vo.setInsuRtet(new BigDecimal(MSFSharedUtils.allowNulls(yeta3220Dto.getInsuRtet())));    /** column 보험료보장성외 : insuRtet */
	            yeta3220Vo.setPsclIurt(new BigDecimal(MSFSharedUtils.allowNulls(yeta3220Dto.getPsclIurt())));    /** column 보험료장애인보장성외 : psclIurt */
	            yeta3220Vo.setMediExps(new BigDecimal(MSFSharedUtils.allowNulls(yeta3220Dto.getMediExps())));    /** column 의료비외 : mediExps */
	            yeta3220Vo.setEducOtec(new BigDecimal(MSFSharedUtils.allowNulls(yeta3220Dto.getEducOtec())));    /** column 교육비외 : educOtec */
	            yeta3220Vo.setCdteCdec(new BigDecimal(MSFSharedUtils.allowNulls(yeta3220Dto.getCdteCdec())));    /** column 신용카드외 : cdteCdec */
	            yeta3220Vo.setJiblCdec(new BigDecimal(MSFSharedUtils.allowNulls(yeta3220Dto.getJiblCdec())));    /** column 직불카드외 : jiblCdec */
	            yeta3220Vo.setGrpyAtec(new BigDecimal(MSFSharedUtils.allowNulls(yeta3220Dto.getGrpyAtec())));    /** column 지로납부액_대중교통외 : grpyAtec */
	            yeta3220Vo.setMgntSdec(new BigDecimal(MSFSharedUtils.allowNulls(yeta3220Dto.getMgntSdec())));    /** column 전통시장사용분외 : mgntSdec */
	            yeta3220Vo.setCtrbAmec(new BigDecimal(MSFSharedUtils.allowNulls(yeta3220Dto.getCtrbAmec())));    /** column 기부금액외 : ctrbAmec */
			...
			throw MSFServerUtils.getOperationException("saveYeta0300To2000tabItem03_2", ex, logger);
	   ...
	   @Override
		 public PagingLoadResult<ShowMessageBM> fnYeta0300Payr06430CalcTax( List<Yeta2000DTO> listYeta2000Dto ) throws MSFException {
		    	...
		    	String method = calledClass + ".fnYeta0300Payr06430CalcTax";
		        MSFSysm0100BM sessionUser = MSFServerUtils.getLoggedUser(RemoteServiceUtil.getThreadLocalRequest());
		        ...
		        try {  
	                  ...
	                  for (int iCnt = 0;iCnt < listYeta2000Dto.size();iCnt++) { 
							  ...
							  yeta2000Dto = (Yeta2000DTO) listYeta2000Dto.get(iCnt); 
...
//							  yetaPrc2000Vo.setRevnAddr(yeta2000Dto.getRevnAddr());    /** column 수정주소 : revnAddr */
		            ...
		            logger.error("EXCEPTION calling fnYeta0300Payr06430CalcTax(): "+ex); 
		            
		            /** 에러 로그 **/			
		            MSFLogHistoryUtils.tracerUserExceptionActivity(sessionUser,method,calledClass,"C",ex, windowNm , windowId);
		             
		            throw MSFServerUtils.getOperationException("fnYeta0300Payr06430CalcTax", ex, logger);
		        }
		        finally {
	   ...
	   /** 소득공제신고자료관리 새로고침 **/
	   public Yeta2000BM resultListYeta2000(Yeta2000BM yeta2000Bm) throws MSFException {
...
//	     	yeta2000SrhVo.setPyspGrdeCd(MSFSharedUtils.allowNulls(MSFServerUtils.getFilterValue(columnFilters, "pyspGrdeCd"))); //호봉등급코드
			...
			Yeta2000BM returnYeta2000 = new Yeta2000BM();
	    ...
	    *	-----------------------------------------------------------------------
	    * 
	    * @see com.app.exterms.yearendtax.client.service.yeta2015.Yeta0300Service#fnYeta0300Payr06430CalcTax(java.util.List)
	    * @param listYeta2000Dto
	    * @return
	    * @throws MSFException
	    */
	   @Override
		 public PagingLoadResult<ShowMessageBM> fnYeta0300Payr06430AllCalcTax(Yeta2000DTO yeta2000Dto) throws MSFException {
		    	...
		    	String method = calledClass + ".fnYeta0300Payr06430AllCalcTax";
		        MSFSysm0100BM sessionUser = MSFServerUtils.getLoggedUser(RemoteServiceUtil.getThreadLocalRequest());
