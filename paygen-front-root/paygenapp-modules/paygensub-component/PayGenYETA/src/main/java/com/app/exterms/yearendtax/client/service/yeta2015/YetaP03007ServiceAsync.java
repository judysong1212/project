...
public interface YetaP03007ServiceAsync {
	
	/** 연금저축소득공제 등록 팝업 수정 및 삭제 **/
	public void activityOnYetaP03007ToYeta3100(List<Yeta3100DTO> listYeta3100dto, ActionDatabase actionDatabase, AsyncCallback<Long> callback) ;
