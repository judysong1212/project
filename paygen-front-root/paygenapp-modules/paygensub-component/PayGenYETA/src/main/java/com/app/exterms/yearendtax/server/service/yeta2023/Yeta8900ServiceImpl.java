...
import com.app.exterms.yearendtax.server.service.yeta2023.dao.Ye17TaPyyt0302_2023_DAO;
import com.app.exterms.yearendtax.server.service.yeta2023.dao.Ye17TaPyyt0304_2023_DAO;
import com.app.exterms.yearendtax.server.vo.Pyyt0302Srh_2023_VO;
...
* </pre>
 */
@Service("Yeta8900Service")
public class Yeta8900ServiceImpl  extends AbstractCustomServiceImpl implements Yeta8900Service  ,YetaDaoConstants {

	 
	private static final Logger logger = LoggerFactory.getLogger(Yeta8900ServiceImpl.class);
	private static final String calledClass = Yeta8900ServiceImpl.class.getName();

	// 급여대상자
	@Autowired
	@Resource(name = "Ye17TaPyyt0304_2023_DAO")
	private Ye17TaPyyt0304_2023_DAO pyyt0304DAO;
	
	// 수당/공제내역
	@Autowired
	@Resource(name = "Ye17TaPyyt0302_2023_DAO")
	private Ye17TaPyyt0302_2023_DAO pyyt0302DAO;
	 ...
	 * @throws MSFException
	 */
	public PagingLoadResult<BaseModel> getYeta8900ToPyyt0304List(ServiceParameters serviceParameters) throws MSFException {

 	        PagingLoadResult<BaseModel> retval = null;
//	        String method =  "getPsnl0100ToRemt0100DataList";
	        String method = CLASS_YETA8900_TO_PYYT0304_DATA_LIST;
	        Pyyt0304Srh_2023_VO   pyyt0304SrhVo = new Pyyt0304Srh_2023_VO();
	        ...
	        if  (MSFSharedUtils.paramNull(pyyt0304DAO)) {
	            ...
	            pyyt0304DAO = (Ye17TaPyyt0304_2023_DAO) wac.getBean("Ye17TaPyyt0304_2023_DAO"); 
	        }
...
//	            Collection<Map<String, Object>> list  
	 ...
	 * @throws MSFException
	 */
	public PagingLoadResult<BaseModel> getYeta8900ToPyyt0302ExtpyList(ServiceParameters serviceParameters) throws MSFException {

 	        PagingLoadResult<BaseModel> retval = null;
//	        String method =  "getPsnl0100ToRemt0100DataList";
	        String method = CLASS_YETA8900_TO_PYYT0302_EXTPY_DATA_LIST;
	        Pyyt0302Srh_2023_VO   pyyt0302SrhVo = new Pyyt0302Srh_2023_VO();
	        Pyyt0302_2023_VO      pyyt0304Vo = new Pyyt0302_2023_VO();
	        List<BaseModel>  bmResult = new ArrayList<BaseModel>();
	        ...
	        if  (MSFSharedUtils.paramNull(pyyt0302DAO)) {
	            ...
	            pyyt0302DAO = (Ye17TaPyyt0302_2023_DAO) wac.getBean("Ye17TaPyyt0302_2023_DAO"); 
	        }
...
//	            Collection<Map<String, Object>> list  
	 ...
	 * @throws MSFException
	 */
	public PagingLoadResult<BaseModel> getYeta8900ToPyyt0302DducList(ServiceParameters serviceParameters) throws MSFException {

 	        PagingLoadResult<BaseModel> retval = null;
//	        String method =  "getPsnl0100ToRemt0100DataList";
	        String method = CLASS_YETA8900_TO_PYYT0302_DDUC_DATA_LIST;
	        Pyyt0302Srh_2023_VO   pyyt0302SrhVo = new Pyyt0302Srh_2023_VO();
	        Pyyt0302_2023_VO      pyyt0304Vo = new Pyyt0302_2023_VO();
	        List<BaseModel>  bmResult = new ArrayList<BaseModel>();
...
//	            Collection<Map<String, Object>> list  
	...
	/** 수당/공제항목 저장 및 삭제 **/ 
	@Override
	public int saveYeta8900ToPyyt0302(List<Pyyt0302DTO> listPyyt0302Dto, String flag)throws MSFException {
		...
		String method = calledClass + ".saveYeta8900ToPyyt0302";
		MSFSysm0100BM sessionUser = MSFServerUtils.getLoggedUser(RemoteServiceUtil.getThreadLocalRequest());
		...
		try{
			...
			for(int iYetaCnt=0; iYetaCnt < listPyyt0302Dto.size(); iYetaCnt++) {
				...
				pyyt0304Vo = new Pyyt0304_2023_VO();
	...
	/** 대상자 삭제 **/ 
	@Override
	public int deleteYeta8900List(List<Pyyt0302DTO> listPyyt0302Dto)throws MSFException {
		// TODO Auto-generated method stub
		...
		String method = calledClass + ".deleteYeta8900List";
		MSFSysm0100BM sessionUser = MSFServerUtils.getLoggedUser(RemoteServiceUtil.getThreadLocalRequest());
...
//				pyyt0302Vo.setRevnAddr(RemoteServiceUtil.getThreadLocalRequest().getRemoteHost());
	...
	public Pyyt0304BM Yeta2900InfoList(Pyyt0304DTO pyyt0304Dto) {
		...
		String method = calledClass + ".Yeta8900InfoList";
...
//			int iResultCnt = yeta2000DAO.selectYeta0300To2000ListTotCnt(pyyt0304SrhVo);  
	...
	@Override
	public Pyyt0304BM Yeta8900InfoList(Pyyt0304DTO Pyyt0304Dto)
			throws MSFException {
		// TODO Auto-generated method stub
		return null;
	}
