...
import com.app.exterms.yearendtax.client.dto.yeta2023.InfcPsnl0100BM;
import com.app.exterms.yearendtax.client.dto.yeta2023.Ye160401BM;
...
public class Ye161010Def  extends TableDef implements YetaDaoConstants {
	...
	public Ye161010Def(String chkPayrDef) {
		...
		if("Yeta8100".equals(chkPayrDef)){
			setDaoClass("");
			setCustomListMethod(CLASS_YETA8100_DATA_LIST);
		...
		}else if("Yeta8200".equals(chkPayrDef)){
			setDaoClass("");
			setCustomListMethod(CLASS_YETA8200_DATA_LIST);
			...
			setDaoClass("");
			setCustomListMethod(CLASS_YETA8300_TO_YE161010_DATA_LIST);
			setAutoFillGrid(false);
			setShowFilterToolbar(false);
			setCheckBoxOnGridRows(true);
			setEditFieldGrid(false);
			...
			setTitle("");
	        setDaoClass("");
	        setCustomListMethod(CLASS_YETA8200_RESULT_DATA_LIST);
	  	  	setAutoFillGrid(true);
	        setShowFilterToolbar(false);   
	        setCheckBoxOnGridRows(false); 
		    setEditFieldGrid(false);
