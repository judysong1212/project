 ...
 */
public class PdfP102yBM   extends MSFSimpleBaseModel implements IsSerializable  {
    ...
    public static final String ATTR_SPNTT = "spNtt";
    ...
    /** set 국민연금_총합계금액 : natAmtSum */
    public void setNatAmtSum(BigDecimal  natAmtSum) { set( ATTR_NATAMTSUM ,natAmtSum);}
    /** get 국민연금_총합계금액 : natAmtSum */
    public BigDecimal  getNatAmtSum() { return (BigDecimal )get( ATTR_NATAMTSUM );}
    /** set 국민연금_직장가입자소급고지금액합계금액 : spNtt */
    public void setSpNtt(BigDecimal  spNtt) { set( ATTR_SPNTT ,spNtt);}
    /** get 국민연금_직장가입자소급고지금액합계금액 : spNtt */
    public BigDecimal  getSpNtt() { return (BigDecimal )get( ATTR_SPNTT );}
    /** set 국민연금_추납보험료납부금액 : spym */
    public void setSpym(BigDecimal  spym) { set( ATTR_SPYM ,spym);}
    /** get 국민연금_추납보험료납부금액 : spym */
    public BigDecimal  getSpym() { return (BigDecimal )get( ATTR_SPYM );}
    /** set 국민연금_실업크레딧납부금액 : jlc */
    public void setJlc(BigDecimal  jlc) { set( ATTR_JLC ,jlc);}
    /** get 국민연금_실업크레딧납부금액 : jlc */
    public BigDecimal  getJlc() { return (BigDecimal )get( ATTR_JLC );}
    /** set 국민연금_직장가입자고지금액합계 : ntf */
    public void setNtf(BigDecimal  ntf) { set( ATTR_NTF ,ntf);}
    /** get 국민연금_직장가입자고지금액합계 : ntf */
    public BigDecimal  getNtf() { return (BigDecimal )get( ATTR_NTF );}
    /** set 국민연금_지역가입자등_납입금액합계 : pmt */
    public void setPmt(BigDecimal  pmt) { set( ATTR_PMT ,pmt);}
    /** get 국민연금_지역가입자등_납입금액합계 : pmt */
    public BigDecimal  getPmt() { return (BigDecimal )get( ATTR_PMT );}
    /** set pdf 소득공제자료적용여부 : pdfDatAppYn */
