...
@Repository("Ye16Ta1100DAO")
public class Ye16Ta1100DAO extends EgovAbstractDAO {
    ...
    public List selectYetaP110001List(InfcPsnl0100SrhVO   psnl0100SrhVO) throws Exception {
        return list("ye16Ta1100DAO.selectPsnl0100List_D", psnl0100SrhVO);
    }
    ...
    public int selectYetaP110001ListTotCnt(InfcPsnl0100SrhVO   psnl0100SrhVO) {
        return (Integer)getSqlMapClientTemplate().queryForObject("ye16Ta1100DAO.selectPsnl0100ListCnt_S", psnl0100SrhVO);
    }
