...
@RemoteServiceRelativePath("YetaP63005Service.gwt")
public interface YetaP63005Service extends RemoteService {
	/**
	 * Utility class for simplifying access to the instance of async service.
	 */
	public static class Util {
		private static YetaP63005ServiceAsync instance;
		public static YetaP63005ServiceAsync getInstance(){
			if (instance == null) {
				instance = GWT.create(YetaP63005Service.class);
			}
			return instance;
		}
	}
