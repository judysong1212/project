...
public class Yeta4060DTO extends BaseModel{
	...
	/** set 단위사업장주종코드? : mtstBusinDivCd */
	private String mtstBusinDivCd;
	
	/** set 단위사업장승인번호 : upDpobCmpNo */
	private java.lang.String upDpobCmpNo;

	/** set C171_사업자단위과세자여부 : upDpobUtynC171 */
	private java.lang.String upDpobUtynC171;

	/** set C172_종사업장일련번호 : mtstDpobSeilNumC172 */
	private java.lang.String mtstDpobSeilNumC172;

	/** set 본지점구분코드 : mnbhDivCd */
	private java.lang.String mnbhDivCd;

	/** set 원천세신고유형구분코드 : whdgTxCtypDivCd */
	private java.lang.String whdgTxCtypDivCd;
	/****************************************************************/
	/** set 시스템플래그 : sysDivCd */
	...
	private java.lang.String befBusoprRgstnNum;	
	...
	public java.lang.String getUpDpobCmpNo() {
		return upDpobCmpNo;
	}

	public void setUpDpobCmpNo(java.lang.String upDpobCmpNo) {
		this.upDpobCmpNo = upDpobCmpNo;
	}

	public java.lang.String getUpDpobUtynC171() {
		return upDpobUtynC171;
	}

	public void setUpDpobUtynC171(java.lang.String upDpobUtynC171) {
		this.upDpobUtynC171 = upDpobUtynC171;
	}

	public java.lang.String getMtstDpobSeilNumC172() {
		return mtstDpobSeilNumC172;
	}

	public void setMtstDpobSeilNumC172(java.lang.String mtstDpobSeilNumC172) {
		this.mtstDpobSeilNumC172 = mtstDpobSeilNumC172;
	}

	public java.lang.String getMnbhDivCd() {
		return mnbhDivCd;
	}

	public void setMnbhDivCd(java.lang.String mnbhDivCd) {
		this.mnbhDivCd = mnbhDivCd;
	}

	public java.lang.String getWhdgTxCtypDivCd() {
		return whdgTxCtypDivCd;
	}

	public void setWhdgTxCtypDivCd(java.lang.String whdgTxCtypDivCd) {
