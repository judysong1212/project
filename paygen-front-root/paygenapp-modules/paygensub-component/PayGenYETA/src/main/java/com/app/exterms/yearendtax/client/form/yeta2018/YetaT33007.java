...
import com.app.exterms.yearendtax.client.form.defs.yeta2018.Ye162030Def;
import com.app.exterms.yearendtax.client.service.yeta2018.YetaT33007Service;
import com.app.exterms.yearendtax.client.service.yeta2018.YetaT33007ServiceAsync;
...
=====================================================**/
public  class YetaT33007   extends MSFFormPanel {  
 ...
 **/
	...
	private  ContentPanel cpYetaT33007; 
	...
	// -------------- grid 선언 시작  ---------------	  
	private MSFGridPanel YetaT33007GridPanel;
	private Ye162030Def ye162030Def = new Ye162030Def("YetaT33007");   
	...
	// -------------- 서비스 호출 시작 --------------
	private YetaT33007ServiceAsync yetaT33007Service = YetaT33007Service.Util.getInstance();
	// -------------- 서비스 호출 종료 --------------	 
...
//					ye162510Dto.setMnthRnttyHusCnttArea((MSFSharedUtils.allowNulls(bmMapModel.get("mnthRnttyHusCnttArea"))));    		/** column 월세주택계약면적 : mnthRnttyHusCnttArea */
				...
				yetaT33007Service.activityOnYetaT33007(listYe162510Dto, actionDatabase, new AsyncCallback<Long>(){
...
//		 }
	...
	public YetaT33007(final ActionDatabase actionDatabase, final MSFPanel caller) {
...
//		initLoad(); 	
		...
		this.actionDatabase = actionDatabase;
	 	...
	 	cpYetaT33007 = new ContentPanel();  

		createSearchForm();			//기본정보 필드를 적용
	 	createMsfGridForm();		//그리드필드
		   
		cpYetaT33007.setBodyBorder(false);
		cpYetaT33007.setBorders(false);
		cpYetaT33007.setHeaderVisible(false);
		cpYetaT33007.setSize("790px", "640px");
		   
		this.add(cpYetaT33007);
...
//		     });     
		...
		cpYetaT33007.setLayout(new FlowLayout());
...
//	      	     }
//				 
//				YetaT33007GridPanel.getMsfGrid().clearData();
//				 
//				BaseModel bmData = YetaT33007GridPanel.getTableDef().getDefaultValues();  
//		              
...
//		         
//		        YetaT33007GridPanel.getMsfGrid().getGrid().stopEditing();      
//		        YetaT33007GridPanel.getMsfGrid().getGrid().getStore().insert(bmData,0);   
//		        YetaT33007GridPanel.getMsfGrid().getGrid().startEditing(YetaT33007GridPanel.getMsfGrid().getGrid().getStore().indexOf(bmData), 0);   
//
...
//			public void handleEvent(ButtonEvent e) {
//				Iterator<BaseModel> itBm = YetaT33007GridPanel.getMsfGrid().getGrid().getSelectionModel().getSelectedItems().listIterator();
...
//			public void handleEvent(ButtonEvent e) {
//				setListRecord(YetaT33007GridPanel.getMsfGrid().getStore().getModifiedRecords().iterator());
//				doAction(actionDatabase);
//
//				if ((ActionDatabase.INSERT).equals(actionDatabase)) {
//					actionDatabase = ActionDatabase.INSERT;
...
//				
//		cpYetaT33007.add(topYetaBtnBar);
...
//		cpYetaT33007.add(topYetaBtnBar);
		...
		YetaT33007GridPanel = new MSFGridPanel(ye162030Def, false, false, false, false, false);
		YetaT33007GridPanel.setSize("790px", "200px");
		YetaT33007GridPanel.setBorders(true);
		YetaT33007GridPanel.setHeaderVisible(false);
...
//		
//		YetaT33007GridPanel.getGrid().getColumnModel().addAggregationRow(payrSummaryRow);  
//		
...
//		
//		YetaT33007GridPanel.getGrid().getColumnModel().addAggregationRow(payrSummaryRow1);
//		/** --- 그리드 합계 부분  종료 --- **/
		
//        cpYetaT33007.add(YetaT33007GridPanel);
...
//		cpYetaT33007.add(layoutContainer1);
//		cpYetaT33007.add(layoutContainer2);
		fldstNewFieldset.add(YetaT33007GridPanel);
		cpYetaT33007.add(fldstNewFieldset);
		cpYetaT33007.add(layoutContainer10);
		cpYetaT33007.add(fldstNewFieldset_1);
	...
	public void reload() {
			...
			YetaT33007GridPanel.getTableDef().setTableColumnFilters(filters);
			YetaT33007GridPanel.getTableDef().addColumnFilter("yrtxBlggYr", MSFSharedUtils.allowNulls(srhYrtxBlggYr.getValue())
...
//					, SimpleColumnFilter.OPERATOR_EQUALS);//연말정산귀속년도
			YetaT33007GridPanel.getTableDef().addColumnFilter("clutSeptCd", MSFSharedUtils.getSelectedComboValue(srhClutSeptCd,"commCd")
					, SimpleColumnFilter.OPERATOR_EQUALS);//정산구분
			YetaT33007GridPanel.getTableDef().addColumnFilter("systemkey", MSFSharedUtils.allowNulls(systemkey.getValue())
					, SimpleColumnFilter.OPERATOR_EQUALS);//시스템키
		 
			YetaT33007GridPanel.reload();
