...
@Service("YetaT53017Service")
public class YetaT53017ServiceImpl  extends AbstractCustomServiceImpl implements YetaT53017Service ,YetaDaoConstants {
	 
	private static final Logger logger = LoggerFactory.getLogger(YetaT53017ServiceImpl.class);
	private static final String calledClass = YetaT53017ServiceImpl.class.getName();
	...
	@Override
	public Ye169010DTO getYetaP53017ToYe169010List(Ye169010DTO ye169010Dto)	throws MSFException {
		
		Ye169010aSrh_2020_VO ye169010aSrhVo = new Ye169010aSrh_2020_VO();
		MSFSysm0100BM sessionUser;

		String method = calledClass + ".getYetaP53017ToYe169010List";

		String windowNm = "표준세액공제";
		String windowId = "YETAP53017";
		...
		try {
			...
			egovResultDataList = ye169010ADao.selectYetaP53017ToYe169010List(ye169010aSrhVo);
