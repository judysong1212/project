 ...
 */
public class PdfB101dBM   extends MSFSimpleBaseModel implements IsSerializable  {
    ...
    /** set 의료비납입일자 : amtDd */
    public static final String ATTR_AMTDD = "amtDd";

    /** set 의료비내역일련번호 : manSeilNum */
    public static final String ATTR_MANSEILNUM = "manSeilNum";

    /** set 의료비납입금액 : manAmt */
    public static final String ATTR_MANAMT = "manAmt";
    ...
    /** 일괄등록 처리   */
     public PdfB101dBM(
     	...
     	values.put(ATTR_AMTDD,amtDd);
     	values.put(ATTR_MANSEILNUM,manSeilNum);
     	values.put(ATTR_MANAMT,manAmt);
    ...
    /** set 의료비납입일자 : amtDd */
    public void setAmtDd(String  amtDd) { set( ATTR_AMTDD ,amtDd);}
    /** get 의료비납입일자 : amtDd */
    public String  getAmtDd() { return (String )get( ATTR_AMTDD );}

    /** set 의료비내역일련번호 : manSeilNum */
    public void setManSeilNum(Long  manSeilNum) { set( ATTR_MANSEILNUM ,manSeilNum);}
    /** get 의료비내역일련번호 : manSeilNum */
    public Long  getManSeilNum() { return (Long )get( ATTR_MANSEILNUM );}

    /** set 의료비납입금액 : manAmt */
    public void setManAmt(Long  manAmt) { set( ATTR_MANAMT ,manAmt);}
    /** get 의료비납입금액 : manAmt */
    public Long  getManAmt() { return (Long )get( ATTR_MANAMT );}
