...
import com.app.smrmf.pkg.yeta.yeta2017.pdfxml.Func_PdfInDdc_Yeta2017_Insert;
 ...
 */
@Service("Yeta2300Service")
public class Yeta2300ServiceImpl  extends AbstractCustomServiceImpl implements Yeta2300Service  ,YetaDaoConstants {

	 
	private static final Logger logger = LoggerFactory.getLogger(Yeta2300ServiceImpl.class);
	private static final String calledClass = Yeta2300ServiceImpl.class.getName();
	...
	private Ye161030DAO ye161030DAO;
	
	@Autowired
	@Resource(name = "Ye161040DAO")
	private Ye161040DAO ye161040DAO;
	...
	private Ye161070DAO ye161070DAO;
	
	@Autowired
	@Resource(name = "Ye161080DAO")
	private Ye161080DAO ye161080DAO;
	
	// 교육비 내역
	@Autowired
	@Resource(name = "Ye161090DAO")
	private Ye161090DAO ye161090DAO;
	...
	private Ye169010aDAO ye169010aDAO;
	...
	private Ye166010DAO ye166010DAO;
	
	
	

	/** 대상자 정보 조회 **/
	public PagingLoadResult<BaseModel> getYeta2300ToYe161010DataList(ServiceParameters serviceParameters) throws MSFException {
	     ...
	     //	 List<String> listTyInttnCd = new ArrayList<String>(); 
			...
			if ( pagingValues.executeRecordCount ) { 
	        	...
	        	TimingInfo millisBeginQueryCount = SmrmfUtils.startTiming(logger);
	          	...
	          	int iResultCnt = ye161010DAO.selectYeta2300ToYe161010ListTotCnt(ye161010SrhVo);  
...
//	            Collection<Map<String, Object>> list ??????
	     	List list = ye161010DAO.selectYeta2300ToYe161010List(ye161010SrhVo);
			...
			SmrmfUtils.endTiming(logger, millisBeginYe161010DataList, "getYeta2300ToYe161010DataList");
	...
	/** 세액계산 정보 조회 **/
	public PagingLoadResult<BaseModel> getYeta2300ToSubTaxList(ServiceParameters serviceParameters) throws MSFException {

		PagingLoadResult<BaseModel> retval = null;
		String method = CLASS_YETA2300_TO_YE169010_SUBTAX_LIST;
		
		
		Ye169010SrhVO ye169010SrhVo = new Ye169010SrhVO();
		List<BaseModel> bmResult = new ArrayList<BaseModel>();
		MSFSysm0100BM sessionUser;
		...
		if  (MSFSharedUtils.paramNull(ye169010DAO)) {
			WebApplicationContext wac = WebApplicationContextUtils.getRequiredWebApplicationContext( getHttpServletRequest().getSession().getServletContext());
			ye169010DAO = (Ye169010DAO) wac.getBean("Ye169010DAO" ); 
		}
		
		if  (MSFSharedUtils.paramNull(ye169010aDAO)) {
			WebApplicationContext wac = WebApplicationContextUtils.getRequiredWebApplicationContext( getHttpServletRequest().getSession().getServletContext());
			ye169010aDAO = (Ye169010aDAO) wac.getBean("Ye169010aDAO" ); 
		}
			...
			if ( pagingValues.executeRecordCount ) { 
	        	...
	        	TimingInfo millisBeginQueryCount = SmrmfUtils.startTiming(logger);
	          	...
	          	if("Y".equals(ye169010SrhVo.getC152StdTxDdcYn())) {
	          		iResultCnt = ye169010aDAO.selectYeta2300ToYe169010aListTotCnt(ye169010SrhVo);
	          	}else {
	          		iResultCnt = ye169010DAO.selectYeta2300ToYe169010ListtTotCnt(ye169010SrhVo);
	          	}
...
//	            Collection<Map<String, Object>> list ??????
	    	List list;
	     	if("Y".equals(ye169010SrhVo.getC152StdTxDdcYn())) {
		    	...
		    	list = ye169010aDAO.selectYeta2300ToYe169010aList(ye169010SrhVo);
	     		
          	}else {
          		
          		list = ye169010DAO.selectYeta2300ToYe169010List(ye169010SrhVo);
          	}
	...
	/** 인적공제명세 정보 조회 **/
	public PagingLoadResult<BaseModel> getYeta2300ToYe161030List(ServiceParameters serviceParameters) throws MSFException {
		

		PagingLoadResult<BaseModel> retval = null;
		String method =  CLASS_YETA2300_TO_YE161030_DATA_LIST;
		Ye161030SrhVO   ye161030SrhVo = new Ye161030SrhVO();
		List<BaseModel>  bmResult = new ArrayList<BaseModel>();
		MSFSysm0100BM sessionUser;
		...
		if  (MSFSharedUtils.paramNull(ye161030DAO)) {
			WebApplicationContext wac = WebApplicationContextUtils.getRequiredWebApplicationContext( getHttpServletRequest().getSession().getServletContext());
			ye161030DAO = (Ye161030DAO) wac.getBean("Ye161030DAO"); 
		}
...
//	    	List<String> listDeptCd = new ArrayList<String>();    
			...
			if ( pagingValues.executeRecordCount ) { 
	        	...
	        	TimingInfo millisBeginQueryCount = SmrmfUtils.startTiming(logger);
	          	...
	          	int iResultCnt = ye161030DAO.selectYeta23001ToYe161030ListtTotCnt(ye161030SrhVo);  
	     	...
	     	@SuppressWarnings("unchecked")
//	            Collection<Map<String, Object>> list ??????
	     	List list = ye161030DAO.selectYeta23001ToYe161030List(ye161030SrhVo);
	...
	/** 소득공제명세 정보 조회 **/	
	public PagingLoadResult<BaseModel> getYeta2300ToYe161040List(ServiceParameters serviceParameters) throws MSFException {
		

		PagingLoadResult<BaseModel> retval = null;
		String method =  CLASS_YETA2300_TO_YE161040_DATA_LIST;
		Ye161040SrhVO   ye161040SrhVo = new Ye161040SrhVO();
		List<BaseModel>  bmResult = new ArrayList<BaseModel>();
		MSFSysm0100BM sessionUser;
		...
		if  (MSFSharedUtils.paramNull(ye161040DAO)) {
			WebApplicationContext wac = WebApplicationContextUtils.getRequiredWebApplicationContext( getHttpServletRequest().getSession().getServletContext());
			ye161040DAO = (Ye161040DAO) wac.getBean("Ye161040DAO"); 
		}
...
//	    	List<String> listDeptCd = new ArrayList<String>();    
			...
			if ( pagingValues.executeRecordCount ) { 
	        	...
	        	TimingInfo millisBeginQueryCount = SmrmfUtils.startTiming(logger);
	          	...
	          	int iResultCnt = ye161040DAO.selectYeta2300ToYe161040ListTotCnt(ye161040SrhVo);  
	     	...
	     	@SuppressWarnings("unchecked")
//	            Collection<Map<String, Object>> list ??????
	     	List list = ye161040DAO.selectYeta2300ToYe161040List(ye161040SrhVo);
	...
	/** 교육비내역 조회 **/
//	public PagingLoadResult<BaseModel> getYeta2300ToYe161090List(ServiceParameters serviceParameters) throws MSFException {
//			
//
//			PagingLoadResult<BaseModel> retval = null;
...
//	}
	...
	public Ye161020DTO getYeta2300ToYe161020Data(Ye161020DTO ye161020Dto) throws MSFException {
		...
		Ye161020SrhVO ye161020SrhVo = new Ye161020SrhVO();
		MSFSysm0100BM sessionUser;

		String method = calledClass + ".getYeta2300ToYe161020Data";
		...
		if (MSFSharedUtils.paramNull(ye161020DAO)) {
			...
			ye161020DAO = (Ye161020DAO) wac.getBean("Ye161020DAO");
		}
...
//		int iResultCnt = ye161020DAO.selectYeta2300ToYe161020ListtTotCnt(ye161020SrhVo);
		...
		try {
			...
			egovResultDataList = ye161020DAO.selectYeta2300ToYe161020Data(ye161020SrhVo);
...
//					
	...
	public int saveYeta2300ToYe161020tabItem01(Ye161020DTO ye161020Dto)throws Exception {
		...
		try{
			...
			ye161020DAO.updateYeta2300Item01ToYe161020(ye161020Vo);
...
//			ye160404DAO.updateYeta2300ToYe160404(ye160404Vo);
			...
			ye169010DAO.updateYeta2300ToYe169010(ye169010Vo);
...
//		}
	...
	public Ye161020DTO getYeta2300TabItem02ToYe161020Data(Ye161020DTO ye161020Dto) throws MSFException {
		...
		String method = calledClass + ".getYeta2300TabItem02ToYe161020Data";
...
//					returnYe161020Dto.set표준세액공제적용여부(MSFSharedUtils.allowNulls(tempMap.get("표준세액공제적용여부")));		/** column 표준세액공제적용여부 : 표준세액공제적용여부 */
	...
	public Ye161055DTO getYeta2300TabItem04ToYe161055Data(Ye161055DTO ye161055Dto) throws MSFException {
		...
		Ye161055SrhVO ye161055SrhVo = new Ye161055SrhVO();
		MSFSysm0100BM sessionUser;

		String method = calledClass + ".getYeta2300TabItem04ToYe161055Data";
		...
		if (MSFSharedUtils.paramNull(ye161055DAO)) {
			WebApplicationContext wac = WebApplicationContextUtils.getRequiredWebApplicationContext(getHttpServletRequest()
							.getSession().getServletContext());
			ye161055DAO = (Ye161055DAO) wac.getBean("Ye161055DAO");
		}
		...
		try {
			...
			egovResultDataList = ye161055DAO.selectYeta2300ToYe161055List(ye161055SrhVo);
	...
	public int saveYeta2300ToYe161055tabItem04(Ye161055DTO ye161055Dto)throws Exception {
		...
		try{
			...
			ye161055DAO.updateYeta2300ToYe161055(ye161055Vo);
			ye161050DAO.updateYeta2300ToYe161050(ye161050Vo);
	...
	public Ye161060DTO getYeta2300TabItem05ToYe161060Data(Ye161060DTO ye161060Dto) throws MSFException {
		...
		Ye161060SrhVO ye161060SrhVo = new Ye161060SrhVO();
		MSFSysm0100BM sessionUser;

		String method = calledClass + ".getYeta2300TabItem05ToYe161060Data";
		...
		if (MSFSharedUtils.paramNull(ye161060DAO)) {
			WebApplicationContext wac = WebApplicationContextUtils.getRequiredWebApplicationContext(getHttpServletRequest()
							.getSession().getServletContext());
			ye161060DAO = (Ye161060DAO) wac.getBean("Ye161060DAO");
		}
		...
		try {
			...
			egovResultDataList = ye161060DAO.selectYeta2300ToYe161060tabItem05List(ye161060SrhVo);
	...
	public int saveYeta2300ToYe161060tabItem05_1(Ye161060DTO ye161060Dto)throws Exception {
		...
		try{
			...
			ye161060DAO.updateYeta2300ToYe161060tabItem05_1(ye161060Vo);
			
			BeanUtils.copyProperties(infcPkgYe161010Vo , ye161060Vo);  
			yeta2300ListenerAdt.fnYeta2300_Ye161010_2017_CalcUpdate(RemoteServiceUtil.getThreadLocalRequest(), infcPkgYe161010Vo, "YE161060");
	...
	public int saveYeta2300ToYe161060tabItem05_2(Ye161060DTO ye161060Dto)throws Exception {
		...
		try{
			...
			ye161060DAO.updateYeta2300ToYe161060tabItem05_2(ye161060Vo);
	...
	public Ye161070DTO getYeta2300TabItem06ToYe161070Data(Ye161070DTO ye161070Dto) throws MSFException {
		...
		Ye161070SrhVO ye161070SrhVo = new Ye161070SrhVO();
		MSFSysm0100BM sessionUser;

		String method = calledClass + ".getYeta2300TabItem06ToYe161070Data";
		...
		if (MSFSharedUtils.paramNull(ye161070DAO)) {
			WebApplicationContext wac = WebApplicationContextUtils.getRequiredWebApplicationContext(getHttpServletRequest()
							.getSession().getServletContext());
			ye161070DAO = (Ye161070DAO) wac.getBean("Ye161070DAO");
		}
		...
		try {
			...
			egovResultDataList = ye161070DAO.selectYeta2300ToYe161070List(ye161070SrhVo);
			...
			if (egovResultDataList != null && egovResultDataList.size() > 0) {
				...
				for (int i = 0; i < egovResultDataList.size(); i++) {
					...
					returnYe161070Dto.setCpiv14AsctUseAmt(Long.parseLong(MSFSharedUtils.defaultNulls(tempMap.get("cpiv14AsctUseAmt"), "0")));    			/** column 출자투자금액_조합등_2014납입금액 : cpiv14AsctUseAmt */
					returnYe161070Dto.setCpiv14AsctDdcAmt(Long.parseLong(MSFSharedUtils.defaultNulls(tempMap.get("cpiv14AsctDdcAmt"), "0")));    			/** column 출자투자금액_조합등_2014공제액 : cpiv14AsctDdcAmt */
					returnYe161070Dto.setCpiv14VntUseAmt(Long.parseLong(MSFSharedUtils.defaultNulls(tempMap.get("cpiv14VntUseAmt"), "0")));    				/** column 출자투자금액_벤처등_2014납입금액 : cpiv14VntUseAmt */
					returnYe161070Dto.setCpiv14VntDdcAmt(Long.parseLong(MSFSharedUtils.defaultNulls(tempMap.get("cpiv14VntDdcAmt"), "0")));    				/** column 출자투자금액_벤처등_2014공제액 : cpiv14VntDdcAmt */
					returnYe161070Dto.setCpiv15AsctUseAmt(Long.parseLong(MSFSharedUtils.defaultNulls(tempMap.get("cpiv15AsctUseAmt"), "0")));    			/** column 출자투자금액_조합등_2015납입금액 : cpiv15AsctUseAmt */
					returnYe161070Dto.setCpiv15AsctDdcAmt(Long.parseLong(MSFSharedUtils.defaultNulls(tempMap.get("cpiv15AsctDdcAmt"), "0")));    			/** column 출자투자금액_조합등_2015공제액 : cpiv15AsctDdcAmt */
					returnYe161070Dto.setCpiv15VntUseAmt(Long.parseLong(MSFSharedUtils.defaultNulls(tempMap.get("cpiv15VntUseAmt"), "0")));    				/** column 출자투자금액_벤처등_2015납입금액 : cpiv15VntUseAmt */
					returnYe161070Dto.setCpiv15VntDdcAmt(Long.parseLong(MSFSharedUtils.defaultNulls(tempMap.get("cpiv15VntDdcAmt"), "0")));    				/** column 출자투자금액_벤처등_2015공제액 : cpiv15VntDdcAmt */
	...
	public int saveYeta2300ToYe161070tabItem06(Ye161070DTO ye161070Dto)throws Exception {
		...
		Ye161070VO ye161070Vo = new Ye161070VO();
		MSFSysm0100BM sessionUser = MSFServerUtils.getLoggedUser(RemoteServiceUtil.getThreadLocalRequest());
		...
		ye161070Vo.setIvcpInvmUseAmtSum(ye161070Vo.getCpiv15AsctUseAmt().add(ye161070Vo.getCpiv15VntDdcAmt())
												.add(ye161070Vo.getCpiv16AsctUseAmt()).add(ye161070Vo.getCpiv16VntUseAmt())
												.add(ye161070Vo.getCpiv17AsctUseAmt()).add(ye161070Vo.getCpiv17VntUseAmt()));    			/** column 투자조합출자등소득공제납입금액계 : ivcpInvmUseAmtSum */
...
//		ye161070Vo.setLtrmCniSsDdcAmt(new BigDecimal(MSFSharedUtils.defaultNulls( ye161070Dto.getLtrmCniSsDdcAmt(), "0")));    				/** column 장기집합투자증권저축공제금액 : ltrmCniSsDdcAmt */
		...
		try{
			...
			ye161070DAO.updateYeta2300ToYe161070tabItem06(ye161070Vo);
			
			BeanUtils.copyProperties(infcPkgYe161010Vo , ye161070Vo);  
			yeta2300ListenerAdt.fnYeta2300_Ye161010_2017_CalcUpdate(RemoteServiceUtil.getThreadLocalRequest(), infcPkgYe161010Vo, "YE161070");
...
//		ye161070Vo.setTyShfyPrsAddDdcrtUseAmt(new BigDecimal(MSFSharedUtils.defaultNulls( ye161070Dto.getTyShfyPrsAddDdcrtUseAmt(), "0")));	/** column 본인추가공제율사용분_2016_상반기 : tyShfyPrsAddDdcrtUseAmt */
		...
		try{
			...
			ye161070DAO.updateYeta2300ToYe161070tabItem07(ye161070Vo);
	...
	public Ye161080DTO getYeta2300TabItem08ToYe161080Data(Ye161080DTO ye161080Dto) throws MSFException {
		...
		Ye161080SrhVO ye161080SrhVo = new Ye161080SrhVO();
		MSFSysm0100BM sessionUser;

		String method = calledClass + ".getYeta2300TabItem08ToYe161080Data";
		...
		if (MSFSharedUtils.paramNull(ye161080DAO)) {
			WebApplicationContext wac = WebApplicationContextUtils.getRequiredWebApplicationContext(getHttpServletRequest()
							.getSession().getServletContext());
			ye161080DAO = (Ye161080DAO) wac.getBean("Ye161080DAO");
		}
		...
		try {
			...
			egovResultDataList = ye161080DAO.selectYeta2300ToYe161080tabItem08List(ye161080SrhVo);
	...
	public int saveYeta2300ToYe161080tabItem08_1(Ye161080DTO ye161080Dto)throws Exception {
		...
		Ye161080VO ye161080Vo = new Ye161080VO();
		MSFSysm0100BM sessionUser = MSFServerUtils.getLoggedUser(RemoteServiceUtil.getThreadLocalRequest());
...
//		ye161080Vo.setInfeePymDdcAmtSum(new BigDecimal(MSFSharedUtils.defaultNulls(ye161080Dto.getInfeePymDdcAmtSum(), "0")));    		/** column 보험료공제세액합계 : infeePymDdcAmtSum */
		...
		try{
			...
			ye161080DAO.updateYeta2300ToYe161080tabItem08_1(ye161080Vo);
...
//		ye161080Vo.setScxpsDdcAmtSum(new BigDecimal(MSFSharedUtils.defaultNulls(ye161080Dto.getScxpsDdcAmtSum(), "0")));    /** column 교육비공제세액금액합계 : scxpsDdcAmtSum */
		...
		try{
			...
			ye161080DAO.updateYeta2300ToYe161080tabItem08_3(ye161080Vo);
			
			BeanUtils.copyProperties(infcPkgYe161010Vo , ye161080Vo);  
			yeta2300ListenerAdt.fnYeta2300_Ye161010_2017_CalcUpdate(RemoteServiceUtil.getThreadLocalRequest(), infcPkgYe161010Vo, "YE161080");
	...
	public Long saveYeta2300ToYe161090tabItem08_3(List<Ye161090DTO> listYe161090Dto, ActionDatabase actionDatabase) throws Exception {
		...
		Ye161090VO ye161090Vo = new Ye161090VO();
		...
		try {
			...
			for (int iYetaCnt = 0; iYetaCnt < listYe161090Dto.size(); iYetaCnt++) {
				...
				case INSERT:
					...
					ye161090DAO.insertYeta2300ToYe161090(ye161090Vo);
					
					break;
				case UPDATE:
					
					ye161090DAO.updateYeta2300ToYe161090(ye161090Vo);

					break;
				case DELETE:
					
					ye161090DAO.deleteYeta2300ToYe161090(ye161090Vo);
	...
	public Ye161080DTO getYeta2300TabItem09ToYe161080Data(Ye161080DTO ye161080Dto) throws MSFException {
		...
		String method = calledClass + ".getYeta2300TabItem09ToYe161080Data";
		...
		try {
			...
			egovResultDataList = ye161080DAO.selectYeta2300ToYe161080tabItem09List(ye161080SrhVo);
...
//		ye161080Vo.setIncmDducWtnnteSumtDt(ye161080Dto.getIncmDducWtnnteSumtDt());    /** column 소득공제신고서제출일자 : incmDducWtnnteSumtDt */
			...
			ye161080DAO.updateYeta2300ToYe161080tabItem09(ye161080Vo);
			ye169010DAO.updateYeta2300ToYe169010tabItem09(ye169010Vo);
	...
	public Ye161080DTO getYeta2300TabItem10ToYe161080Data(Ye161080DTO ye161080Dto) throws MSFException {
		...
		String method = calledClass + ".getYeta2300TabItem10ToYe161080Data";
		...
		try {
			...
			egovResultDataList = ye161080DAO.selectYeta2300ToYe161080tabItem10List(ye161080SrhVo);
...
//		ye161080Vo.setCd218(ye161080Dto.getCd218());    /** column 신고인성명 : cd218 *
		...
		try{
			...
			ye161080DAO.updateYeta2300ToYe161080tabItem10(ye161080Vo);
	...
	/** 인적공제 명세 추가 **/
	@Override
	public Long activityOnYeta2300ToYe161030(List<Ye161030DTO> listYe161030Dto, ActionDatabase actionDatabase)  throws MSFException {
		...
		try { 
			Ye161020VO  ye161020Vo = new Ye161020VO();
			Ye161030VO  ye161030Vo = new Ye161030VO();
			Ye161040VO  ye161040Vo = new Ye161040VO();
...
//                tpPayr0530Vo.setSchlExpnExtpyPymtEndDt(payr0530Dto.getSchlExpnExtpyPymtEndDt());    /** column 학비수당지급종료일자 : schlExpnExtpyPymtEndDt */
				...
				case INSERT:
					...
					ye161030DAO.insertYeta2300ToYe161030(ye161030Vo);
...
//					payr0530Vo.setInptAddr(RemoteServiceUtil.getThreadLocalRequest().getRemoteHost());    	/** column 입력주소 : inptAddr */
					...
					ye161040DAO.deleteYeta2300ToYe161040(ye161040Vo); 
					// 소득공제명세 데이터 추가 
					ye161040DAO.insertYeta2300ToYe161040_01(ye161040Vo);
					ye161040DAO.insertYeta2300ToYe161040_02(ye161040Vo);
...
//					yeta2300ListenerAdt.fnYeta2300_Ye161010_2017_CalcUpdate(RemoteServiceUtil.getThreadLocalRequest(), infcPkgYe161010Vo, "YE166020_DELETE");
					...
					yeta2300ListenerAdt.fnYeta2300_Ye161010_2017_CalcUpdate(RemoteServiceUtil.getThreadLocalRequest(), infcPkgYe161010Vo, "YE161030");
				...
				case UPDATE:
					...
					if(ye161030Vo.getTxprDscmNoCntn() != null || !"".equals(ye161030Vo.getTxprDscmNoCntn())) {
						...
						ye161030DAO.updateYeta2300ToYe161030(ye161030Vo);
					}
					...
					ye161020DAO.updateYeta2300Item02ToYe161020(ye161020Vo);
...
//					yeta3220Vo.setBeforeJumin(MSFSharedUtils.allowNulls(yeta3220Dto.getBeforeJumin().replace("-", "")));	//수정전 주민번호
					...
					// 1. 인적공제 내역 삭제
					ye161030DAO.deleteYeta2300ToYe161030(ye161030Vo);
					
					// 2. 의료비 내역
					ye164010DAO.deleteYeta2300ToYe164010(ye164010Vo);
...
//			yeta2300ListenerAdt.fnYeta2300_Ye161010_2017_CalcUpdate(RemoteServiceUtil.getThreadLocalRequest(), infcPkgYe161010Vo, "YE166020_INSERT");
	...
	/** 소득공제 tab 수정 **/ 
	@Override
	public int saveYeta2300ToYe1610400tabItem03(List<Ye161040DTO> listYe161040Dto_01, List<Ye161040DTO> listYe161040Dto_02)  throws MSFException {
...
//				ye161040Vo.setInptAddr(ye161040Dto.getInptAddr());    /** column 입력주소 : inptAddr */
		        ...
		        ye161040DAO.updateYeta2300ToYe161040(ye161040Vo);
...
//			yeta2000DAO.updateYeta0300ToYeta2000_Item03(yeta2000Vo);  
   ...
   @Override
	 public PagingLoadResult<ShowMessageBM> fnYeta2300_Ye161010_2017_CalcTax(List<Ye161010DTO> listYe161010Dto) throws MSFException {
    	...
    	String method = calledClass + ".fnYeta2300_Ye161010_2017_CalcTax";
        MSFSysm0100BM sessionUser = MSFServerUtils.getLoggedUser(RemoteServiceUtil.getThreadLocalRequest());
...
//					 
           ...
           Yeta2300ListenerAdapter yetaLsAdtr = new Yeta2300ListenerAdapter();
           retval = yetaLsAdtr.fnYeta2300_Ye161010_2017_CalcTax(RemoteServiceUtil.getThreadLocalRequest(),listYe161010VO);
            ...
            throw MSFServerUtils.getOperationException("fnYeta2300_Ye161010_2017_CalcTax", ex, logger);
        }
        finally {
...
*/
 ...
 public PagingLoadResult<ShowMessageBM> fnYeta2300Ye161010_2017_AllCalcTax(Ye161010DTO ye161010Dto) throws MSFException {
    	...
    	String method = calledClass + ".fnYeta2300Ye161010_2017_AllCalcTax";
        MSFSysm0100BM sessionUser = MSFServerUtils.getLoggedUser(RemoteServiceUtil.getThreadLocalRequest());
       ...
       // yeta2200Service = (InfcPkgYeta2200Service)BeanFinder.getBean("InfcPkgYeta2200Service"); 
        ...
        try {  
	          ...
	          Ye161010SrhVO  ye161010SrhVo = new Ye161010SrhVO(); 
	          List<InfcPkgYe161010VO> listPkgYe161010VO = new ArrayList<InfcPkgYe161010VO>();
	          List<Ye161010VO> listYe161010VO = new ArrayList<Ye161010VO>();
	          ...
	          listYe161010VO = (List<Ye161010VO>)ye161010DAO.selectYeta2300ToYe161010AllList(ye161010SrhVo);
              ...
              for (int iCnt = 0;iCnt < listYe161010VO.size();iCnt++) { 
  		    	...
  		    	String nResult = AnyCryptUtils.XecureCryptInitialize(RemoteServiceUtil.getThreadLocalConfig(),RemoteServiceUtil.getThreadLocalRequest());
	            	...
	            	Ye161010VO  ye161010Vo = new Ye161010VO();  
	            	 ...
	            	 ye161010Vo = (Ye161010VO) listYe161010VO.get(iCnt); 
                  ...
                  Yeta2300ListenerAdapter yetaLsAdtr = new Yeta2300ListenerAdapter();
                  retval = yetaLsAdtr.fnYeta2300_Ye161010_2017_CalcTax(RemoteServiceUtil.getThreadLocalRequest(),listPkgYe161010VO);
   
	        } 
	        catch (Exception ex) {
	        	 
	            logger.error("EXCEPTION calling fnYeta2300Ye161010_2017_AllCalcTax(): "+ex); 
            
            /** 에러 로그 **/			
            MSFLogHistoryUtils.tracerUserExceptionActivity(sessionUser,method,calledClass,"C",ex, windowNm , windowId);
             
            throw MSFServerUtils.getOperationException("fnYeta2300Ye161010_2017_AllCalcTax", ex, logger);
        }
        finally {
   ...
   public PagingLoadResult<ShowMessageBM> fnYeta2300Ye161010_2017_SbtVolUse(Ye161010DTO ye161010Dto) throws MSFException {
	   ...
	   String method = calledClass + ".fnYeta2300Ye161010_2017_SbtVolUse";
	   MSFSysm0100BM sessionUser = MSFServerUtils.getLoggedUser(RemoteServiceUtil.getThreadLocalRequest());
	   ...
	   try {  
		   ...
		   Ye161010SrhVO  ye161010SrhVo = new Ye161010SrhVO(); 
		   InfcPkgYe161010VO pkgYe161010VO = new InfcPkgYe161010VO();
		   ...
		   strReturnPdfCheck = funcPdfInDdc.pdfInDdc_Yeta2017_Insert(pkgYe161010VO, RemoteServiceUtil.getThreadLocalRequest());
   ...
   @Override
	public Ye161020DTO getYeta2300TxDdcYnToYe161020Data(Ye161020DTO ye161020Dto) throws MSFException {
		...
		String method = calledClass + ".getYeta2300TxDdcYnToYe161020Data";
		...
		try {
			...
			egovResultDataList = ye161020DAO.getYeta2300TxDdcYnToYe161020Data(ye161020SrhVo);
		...
		try{
            ...
            for (int iCnt = 0;iCnt < listYe161040Dto.size();iCnt++) { 
				...
				listYe161010VO.add(infcPkgYe161010Vo);
				 ...
				 yeta2300ListenerAdt.fnYeta2300_Ye161010_2017_CalcUpdate(RemoteServiceUtil.getThreadLocalRequest(), infcPkgYe161010Vo, "YE161090");
				 yeta2300ListenerAdt.fnYeta2300_Ye161010_2017_CalcUpdate(RemoteServiceUtil.getThreadLocalRequest(), infcPkgYe161010Vo, "YE161050");
