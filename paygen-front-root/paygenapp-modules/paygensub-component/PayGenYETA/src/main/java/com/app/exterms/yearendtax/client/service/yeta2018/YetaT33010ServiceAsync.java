...
public interface YetaT33010ServiceAsync {
	
	/** 월세액소득공제명세  팝업 수정 삭제**/
	public void activityOnYetaT33010(List<Ye162510DTO> listYe162510Dto, ActionDatabase actionDatabase, AsyncCallback<Long> callback) ;
