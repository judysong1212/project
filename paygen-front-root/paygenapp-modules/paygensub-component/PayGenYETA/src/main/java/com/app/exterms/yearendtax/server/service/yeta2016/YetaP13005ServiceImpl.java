...
* 2. 타입명 : YetaP13005ServiceImpl.java
* 3. 작성일 : Jan 13, 2016 5:19:31 PM
* 4. 작성자 : leeheuisung
* 5. 설명 :
* </pre>
 */
@Service("YetaP13005Service")
public class YetaP13005ServiceImpl  extends AbstractCustomServiceImpl implements YetaP13005Service  ,YetaDaoConstants {

 
	private static final Logger logger = LoggerFactory.getLogger(YetaP13005ServiceImpl.class);
	private static final String calledClass = YetaP13005ServiceImpl.class.getName();
	...
	@Override
	public Long activityOnYetaP13005ToYeta3130(List<Ye16Ta3130DTO> listYeta3130dto, ActionDatabase actionDatabase) throws MSFException {
			...
			String method = calledClass + ".activityOnYetaP13005ToYeta3130";
			
			String windowNm = "소득공제신고자료관리";
			String windowId = "YETAP130005";
			...
			try {  
				if (MSFSharedUtils.paramNull(yeta3130DAO)) {
					...
					yeta3130DAO = (Ye16Ta3130DAO) wac.getBean("Ye16Ta3130DAO"); 
				}
...
//		        	} 
				...
				result = iCnt;
		            ...
		            logger.error("EXCEPTION calling activityOnYetaP13005ToYeta3130(): "+ ex); 
		            ...
		            result = new Long(0);
		            throw MSFServerUtils.getOperationException("activityOnYetaP13005ToYeta3130", ex, logger);
		        }
		        finally {
	...
	//월세액소득공제명세 조회
	public PagingLoadResult<BaseModel> getYetaP13005To3130List(ServiceParameters serviceParameters) throws MSFException {
			

			PagingLoadResult<BaseModel> retval = null;
			String method =  CLASS_YETAP13005TOYETA3130_DATA_LIST;
