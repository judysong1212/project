...
public class Ye162010Def  extends TableDef implements YetaDaoConstants {
	...
	public Ye162010Def(String chkPayrDef) {
		...
		if ("YetaP73007".equals(chkPayrDef)) {

			setDaoClass("");
			setCustomListMethod(CLASS_YETAP73007_TO_YE162010_DATA_LIST);
			setAutoFillGrid(true);
			setShowFilterToolbar(false);
			setCheckBoxOnGridRows(true);
			setColumnsDefinition(getYetaP73007ToYe162010ColumnsList());
    ...
    private List<ColumnDef> getYetaP73007ToYe162010ColumnsList(){
        row = 0;
