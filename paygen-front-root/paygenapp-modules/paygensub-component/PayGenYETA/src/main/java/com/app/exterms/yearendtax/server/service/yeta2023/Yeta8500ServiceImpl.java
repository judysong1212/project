...
* </pre>
 */
@Service("Yeta8500Service")
public class Yeta8500ServiceImpl  extends AbstractCustomServiceImpl implements Yeta8500Service  ,YetaDaoConstants {

 
	  private static final Logger logger = LoggerFactory.getLogger(Yeta8500ServiceImpl.class);
	  private static final String calledClass = Yeta8500ServiceImpl.class.getName();
	...
	//연말정산신고내역 조회
	public PagingLoadResult<BaseModel> getYeta85000List(ServiceParameters serviceParameters) throws MSFException {
		

		PagingLoadResult<BaseModel> retval = null;
		String method =  CLASS_YETA8500LIST;
		...
		ye161010DAO = (Ye161010_2023_DAO)BeanFinder.getBean("Ye161010_2023_DAO");
...
//	            Collection<Map<String, Object>> list ??????
	...
	//당월급여반영
	public Long activityOnYeta8500List(List<Ye161010DTO> listYe161010dto) throws MSFException {
		...
		try {  
			...
			logger.error("EXCEPTION calling activityOnYeta8500List(): "+ex); 
			
			/** 에러 로그 **/			
			MSFLogHistoryUtils.tracerUserExceptionActivity(sessionUser,method,calledClass,"U",ex, windowNm , windowId);
			            
			result = new Long(0);
			throw MSFServerUtils.getOperationException("activityOnYeta8500List", ex, logger);
		}
		finally {
	...
	//2023연말정산_추가 : 급여반영취소동작
	public Long activityOnYeta8500_D_List(List<Ye161010DTO> listYe161010dto) throws MSFException {
		// TODO Auto-generated method stub
		Long result = new Long(0);
		Long iCnt = new Long(0);
		BigDecimal seqn = new BigDecimal(0);
		...
		String method = calledClass + ".activityOnYeta0500ListD";
		...
		try {  
			...
			for(int iPsnlCnt=0;iPsnlCnt < listYe161010dto.size();iPsnlCnt++) {
				...
				ye161010DAO.activityOnYeta0500_D_Update(ye161010Vo); 
	...
	//연말정산대상자 및 내역 수정
	public Long saveYeta8500Grid(List<Ye161010DTO> listYe161010dto) throws MSFException {
		// TODO Auto-generated method stub
		
		String method = calledClass + ".saveYeta8500Grid";
		...
		try {  
			...
			logger.error("EXCEPTION calling saveYeta8500Ye161010(): "+ex); 
			
			/** 에러 로그 **/			
			MSFLogHistoryUtils.tracerUserExceptionActivity(sessionUser,method,calledClass,"U",ex, windowNm , windowId);
			            
			result = new Long(0);
			throw MSFServerUtils.getOperationException("saveYeta8500Ye161010", ex, logger);
		}
		finally {
