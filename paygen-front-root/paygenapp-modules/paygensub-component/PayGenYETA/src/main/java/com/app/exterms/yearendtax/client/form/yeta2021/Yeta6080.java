...
import com.app.exterms.yearendtax.client.form.defs.yeta2021.Yeta6080Def;
...
=====================================================**/
public class Yeta6080  extends MSFPanel { 
	...
	private FormPanel plFrmYeta6080;
	private FormData formData; 
	private String txtForm = "";
	private XTemplate detailTp;	  
//	private Yeta6080ServiceAsync Yeta6080service = Yeta6080Service.Util.getInstance();
	...
	private Yeta6080Def Yeta6080Def 				= new Yeta6080Def("yeta6080ToBass0400");
//	private Yeta6080Def Yeta6080ToSysm0100OnDef 	= new Yeta6080Def("Yeta6080ToSysm0100On");
//	private Yeta6080Def Yeta6080ToSysm0100OffDef 	= new Yeta6080Def("Yeta6080ToSysm0100Off");	
	private InfcPkgSysm0100Def Yeta6080ToSysm0100OnDef 		= new InfcPkgSysm0100Def("yeta6080ToSysm0100On");
	private InfcPkgSysm0100Def Yeta6080ToSysm0100OffDef 	= new InfcPkgSysm0100Def("yeta6080ToSysm0100Off");
	
	private MSFGridPanel msfGridPanelYeta6080; 
...
//			final RelationDef  relBass0360 = new RelationDef(Yeta6080MSDef,false);
//			relBass0360.addJoinDef("dpobCd", "dpobCd"); 
//			relBass0360.addJoinDef("deptCd", "deptCd"); 
//			relBass0360.setLinkedObject(msfGridPanelYeta6080MS);
//			Yeta6080ToBass0500OnDef.addRelation(relBass0360); 
//
//			/**
//			 * Create the relations 
//			 */
//			final RelationDef  relBass0350 = new RelationDef(Yeta6080MSDef,false);
//			relBass0350.addJoinDef("dpobCd", "dpobCd"); 
//			relBass0350.addJoinDef("deptCd", "deptCd"); 
//			relBass0350.setLinkedObject(msfGridPanelYeta6080MS);
//			Yeta6080ToBass0500OffDef.addRelation(relBass0350); 
//
//
//			// DETAILS 
//			final Grid Yeta6080ToBass0500OffDefGrid = msfGridPanelYeta6080MS.getMsfGrid().getGrid();
//			Yeta6080ToBass0500OffDefGrid.addListener(Events.CellDoubleClick, new Listener<BaseEvent>() {
//				public void handleEvent(BaseEvent be) {  
//					if (msfGridPanelYeta6080MS.getCurrentlySelectedItem() != null) {  
//
//						Yeta6080ToBass0500OnDef.synchronizeGridDetail(
//								msfGridPanelYeta6080MS.getCurrentlySelectedItem(),
//								msfGridPanelBass0500On );
//
//						Yeta6080ToBass0500OffDef.synchronizeGridDetail(
//								msfGridPanelYeta6080MS.getCurrentlySelectedItem(),
...
//			});
	...
	public Yeta6080(String txtForm) {
...
//		lsDtilOccuInttnCd = PrgmComComboUtils.getSingleBass0350ComboData(sysComBass0350Dto);
		...
		plFrmYeta6080 = new FormPanel();
		plFrmYeta6080.setHeadingText("PayGen Ver1.0 - 연말정산등록담당자관리");
		plFrmYeta6080.setIcon(Resources.APP_ICONS.text());
		plFrmYeta6080.setBodyStyleName("pad-text");
		plFrmYeta6080.setFrame(true); 
		plFrmYeta6080.setPadding(2);
		/************************************************************************
		...
		btnlogView.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				 //로그 뷰화면 호출 메서드 
				  funcLogMessage("연말정산등록담당자관리","Yeta6080");
				}
			});
		plFrmYeta6080.getHeader().setStyleAttribute("padding", "5px 0 2px 0");
		plFrmYeta6080.getHeader().addTool(btnlogView); 
		/************************************************************************
		 * 화면 에러 처리시 필요한 부분으로 추가 
		 ************************************************************************/
		deptCd = new HiddenField<String>();
		deptCd.setName("deptCd");
		plFrmYeta6080.add(deptCd);
		
		HorizontalPanel inner = new HorizontalPanel();
		inner.setBorders(false);
		inner.setLayout(new FitLayout());
//		Yeta6080Def.setReadOnly(true);
		msfGridPanelYeta6080 = new MSFGridPanel(Yeta6080Def, false, false, false, true, false);
		msfGridPanelYeta6080.setSize(300, 610);
		msfGridPanelYeta6080.setBorders(true);
		msfGridPanelYeta6080.getGrid().setBorders(true);
		Grid grid = msfGridPanelYeta6080.getMsfGrid().getGrid();
		grid.addListener(Events.CellDoubleClick , new Listener<BaseEvent>() {
			public void handleEvent(BaseEvent be) {
				
				
				BaseModel bmData = msfGridPanelYeta6080.getCurrentlySelectedItem();  
		...
		msfGridPanelYeta6080.setTopComponent(lycSreach);
		inner.add(msfGridPanelYeta6080);
          
          
		// 선택된 사용자 
		msfGridPanelSysm0100On = new MSFGridPanel(Yeta6080ToSysm0100OnDef, false, false, false, false,false); 
...
//						infcPkgSysm0100Dto.setUntDpobCd(MSFSharedUtils.allowNulls(egovMap.get("untDpobCd")));    /** column 단위사업장코드 : untDpobCd */
		...
		bottomToolbar.add(refresh);
   	    ...
   	    Yeta6080ToSysm0100OffDef.setReadOnly(true);
   	    // ------------------------ 미선택된 사용자
   	    msfGridPanelSysm0100Off = new MSFGridPanel(Yeta6080ToSysm0100OffDef, false, false, false, false, false); 
...
//						infcPkgSysm0100Dto.setUntDpobCd(MSFSharedUtils.allowNulls(egovMap.get("untDpobCd")));    /** column 단위사업장코드 : untDpobCd */
		...
		plFrmYeta6080.add(inner);

		vp.add(plFrmYeta6080);
		plFrmYeta6080.setSize("990px", "680px");
	}

	private Yeta6080 getThis() {
		return this;
	}
    ...
    public void reDeptload() {
    	...
    	msfGridPanelYeta6080.getTableDef().setTableColumnFilters(filters);   
    	msfGridPanelYeta6080.getTableDef().addColumnFilter("deptNmHan", MSFSharedUtils.defaultNulls(deptNmHan.getValue(),""), SimpleColumnFilter.OPERATOR_LIKE); 
    	msfGridPanelYeta6080.reload();
		...
		infcPkgSysm0100Service.updateInfcPkgSysm0100Yn(infcPkgSysm0100Liar , new AsyncCallback<Integer>() {
			...
			public void onFailure(Throwable caught) {
				MessageBox.alert( MSFMainApp.MSFCONSTANTS.ExceptionTitleService()
									, MSFMainApp.ADMINMESSAGES.ExceptionMessageService("activityOnYeta6300ToYe161030("+ " 오류 : " + ") : " + caught)
									, null);
				}
