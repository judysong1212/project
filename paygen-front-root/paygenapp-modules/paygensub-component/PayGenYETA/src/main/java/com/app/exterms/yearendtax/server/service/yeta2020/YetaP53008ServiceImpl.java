...
import com.app.exterms.yearendtax.client.service.yeta2020.YetaP53008Service;
...
@Service("YetaP53008Service")
public class YetaP53008ServiceImpl  extends AbstractCustomServiceImpl implements YetaP53008Service  ,YetaDaoConstants {

	 
	private static final Logger logger = LoggerFactory.getLogger(YetaP53008ServiceImpl.class);
	private static final String calledClass = YetaP53008ServiceImpl.class.getName();
	...
	public Long activityOnYetaP53008ToYe160403(Ye160403DTO ye160403Dto, ActionDatabase actionDatabase) throws MSFException {
		...
		String method = calledClass + ".activityOnYetaP53008ToYe160403";

		String windowNm = "소득공제신고자료관리";
		String windowId = "YETAP5300";
			
		Ye160403_2020_VO ye160403Vo = new Ye160403_2020_VO(); 
		...
		try {
			...
			if (MSFSharedUtils.paramNull(ye160403DAO)) {
				...
				ye160403DAO = (Ye160403_2020_DAO) wac.getBean("Ye160403_2020_DAO"); 
			}
			...
			ye160403DAO.updateYetaP53008ToYe160403(ye160403Vo); 
		          
		} catch (Exception ex) {
			logger.error("EXCEPTION calling activityOnYetaP53008ToYe160403(): "+ ex);
			...
			result = new Long(0);
			throw MSFServerUtils.getOperationException("activityOnYetaP53008ToYe160403", ex, logger);
	...
	public Ye160403DTO getYetaP53008ToYe160403List(Ye160403DTO ye160403Dto) throws MSFException {
		...
		Ye160403Srh_2020_VO ye160403SrhVo = new Ye160403Srh_2020_VO();
		MSFSysm0100BM sessionUser;

		String method = calledClass + ".getYetaP53008ToYe160403List";
		...
		try {
			...
			egovResultDataList = ye160403DAO.selectYetaP53008ToYe160403List(ye160403SrhVo);
