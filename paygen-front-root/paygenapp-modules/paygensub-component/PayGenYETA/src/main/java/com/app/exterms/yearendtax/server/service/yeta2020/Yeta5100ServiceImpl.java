...
import com.app.exterms.yearendtax.server.service.yeta2020.dao.Yeta1100_2020_DAO;
...
* </pre>
 */
@Service("Yeta5100Service")
public class Yeta5100ServiceImpl  extends AbstractCustomServiceImpl implements Yeta5100Service  ,YetaDaoConstants {

	 
	private static final Logger logger = LoggerFactory.getLogger(Yeta5100ServiceImpl.class);
	private static final String calledClass = Yeta5100ServiceImpl.class.getName();

	@Autowired
	@Resource(name = "Yeta1100_2020_DAO")
	private Yeta1100_2020_DAO yeta1100DAO;
	...
	private Ye160401_2020_DAO ye160401DAO;
	
	// 감면소득_과세
	@Autowired
	@Resource(name = "Ye160402_2020_DAO")
	private Ye160402_2020_DAO ye160402DAO;
	
	// 감면소득_비과세
	@Autowired
	@Resource(name = "Ye160403_2020_DAO")
	private Ye160403_2020_DAO ye160403DAO;
	...
	private Ye160406_2020_DAO ye160406DAO;
	 ...
	 */
	//조회
	public PagingLoadResult<BaseModel> getYeta5100ToYe161010DataList(ServiceParameters serviceParameters) throws MSFException {
		

		PagingLoadResult<BaseModel> retval = null;
		String method =  CLASS_YETA5100_DATA_LIST;
...
//	            Collection<Map<String, Object>> list ??????
			...
			SmrmfUtils.endTiming(logger, millisBeginYeta2100ToYe161010DataList, "getYeta5100ToYe161010DataList");
     ...
     */
    @Override
    public  Long PayrExec_Yeta_2020_Insert(List<Ye161010DTO> listYe161010Dto) throws MSFException {
    		     
    	 
		String method = calledClass + ".PayrExec_Yeta_Insert_2020";
		...
		Ye160402_2020_VO ye160402Vo = new Ye160402_2020_VO(); // 과세감면소득
		Ye160403_2020_VO ye160403Vo = new Ye160403_2020_VO(); // 비과세감면소득
		...
		List<InfcPkgYe161010_2020_VO> listYe161010VO = new ArrayList<InfcPkgYe161010_2020_VO>();
     	...
     	//    {******************************급여자료 이관*******************************************}
		       ...
		       // [과세감면내역 삭제 ]
		        ye160401DAO.fnYeta5100_Ye160401_CREATE_Delete(ye160401Vo);
...
//				}				
				...
				yetaLsAdtr.setPayrToYeta_2020_Insert(RemoteServiceUtil.getThreadLocalRequest(),listYe161010VO);
			...
			logger.error("EXCEPTION calling PayrExec_Yeta_Insert_2020(): " + ex);
			
			/** 에러 로그 **/
			MSFLogHistoryUtils.tracerUserExceptionActivity(sessionUser, method,calledClass, "C", ex, windowNm, windowId);
		
			retval = 0L;
			throw MSFServerUtils.getOperationException("PayrExec_Yeta_Insert_2020", ex, logger);
		}
     ...
     */
    @Override
    public  Long Yeta5100ToYe160401_Delete(List<Ye161010DTO> listYe161010Dto) throws MSFException {
    	
		String method = calledClass + ".Yeta5100ToYe160401_Delete";

		String windowNm = "연말정산대상자관리";
		String windowId = "YETA5100";
...
//		Ye161020VO ye161020Vo = new Ye161020VO(); // 인적소득공제기본
	    ...
	    try {
	    	...
	    	for(int i = 0; i < listYe161010Dto.size(); i ++) {
	            ...
	            logger.error("EXCEPTION calling Yeta5100ToYe160401_Delete(): "+ex); 
	            
	            /** 에러 로그 **/			
	            MSFLogHistoryUtils.tracerUserExceptionActivity(sessionUser,method,calledClass,"D", ex, windowNm , windowId);
	            
	            retval = 0L;
	            throw MSFServerUtils.getOperationException("Yeta5100ToYe160401_Delete", ex, logger);
	        } 
	...
	@Override
	public Long UpDpobExec_Yeta_2020_Insert(List<Ye161010DTO> listYe161010Dto) throws MSFException {
		 
   	 
			String method = calledClass + ".UpDpobExec_Yeta_Insert_2020";
			...
			List<InfcPkgYe161010_2020_VO> listYe161010VO = new ArrayList<InfcPkgYe161010_2020_VO>();
	     	...
	     	//    {******************************급여자료 이관*******************************************}
				...
				if (listYe161010VO.size() > 0) {
					...
					// 컴포넌트 호출하기
					yetaLsAdtr.setUpDpopYeta_2020_Insert(RemoteServiceUtil.getThreadLocalRequest(),listYe161010VO);
				...
				logger.error("EXCEPTION calling UpDpobExec_Yeta_Insert_2020(): " + ex);
				
				/** 에러 로그 **/
				MSFLogHistoryUtils.tracerUserExceptionActivity(sessionUser, method,calledClass, "U", ex, windowNm, windowId);
			
				retval = 0L;
				throw MSFServerUtils.getOperationException("UpDpobExec_Yeta_Insert_2020", ex, logger);
			}
