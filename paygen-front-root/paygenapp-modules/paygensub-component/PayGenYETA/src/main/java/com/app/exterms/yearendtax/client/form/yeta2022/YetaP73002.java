...
import com.app.exterms.yearendtax.client.dto.yeta2022.Ye164010BM;
import com.app.exterms.yearendtax.client.dto.yeta2022.Ye164010DTO;
import com.app.exterms.yearendtax.client.form.defs.yeta2022.Ye164010Def;
...
=====================================================**/
public  class YetaP73002 extends MSFFormPanel {  
 ...
 **/
	...
	private  ContentPanel cpYeta73002; 
	...
	// -------------- grid 선언 시작  ---------------	  
	private MSFGridPanel YetaP73002GridPanel;
	private Ye164010Def YetaP73002ToYe164010Def  = new Ye164010Def("YetaP73002");//의료비내역 그리드 테이블 컬럼 define 
	// -------------- grid 선언 종료  ---------------	
 ...
 **/ 
	...
	private void YetaP73002FormSave() {
				...
				yetaP73002Service.activityOnYetaP73002ToYe164010(listYe164010Dto, actionDatabase, new AsyncCallback<Long>(){
					public void onFailure(Throwable caught) {
						MessageBox.alert(MSFMainApp.MSFCONSTANTS.ExceptionTitleService()
								, MSFMainApp.ADMINMESSAGES.ExceptionMessageService("activityOnYetaP73002ToYe164010(" + actionDatabase.name() + ") : " + caught), null);
						}
	...
	public YetaP73002(final ActionDatabase actionDatabase, final MSFPanel caller) {
		...
		cpYeta73002 = new ContentPanel();

		createSearchForm(); // 기본정보 필드를 적용
		createStandardForm(); // 기본정보필드
		createMsfGridForm(); // 그리드필드

		cpYeta73002.setBodyBorder(false);
		cpYeta73002.setBorders(false);
		cpYeta73002.setHeaderVisible(false);
		cpYeta73002.setSize("790px", "640px");

		this.add(cpYeta73002);
	...
	private void createSearchForm() {
		...
		cpYeta73002.setLayout(new FlowLayout());
				...
				MessageBox.confirm("삭제", "선택하신 의료비 내용을 삭제하시겠습니까?",new Listener<MessageBoxEvent>(){
					...
					public void handleEvent(MessageBoxEvent be) {
						if(Dialog.YES.equals(be.getButtonClicked().getItemId())){
							...
							Iterator<BaseModel> itBm = YetaP73002GridPanel.getMsfGrid().getGrid().getSelectionModel().getSelectedItems().listIterator();
		...
		btnYetaSave.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				setListRecord(YetaP73002GridPanel.getMsfGrid().getStore().getModifiedRecords().iterator());
...
//			BaseModel bmData = YetaP73002GridPanel.getMsfGrid().getStore().getModels().get(0);  
//			if (MSFSharedUtils.paramNotNull(bmData)){
				// TODO Auto-generated method stub
				IColumnFilter filters = null;
				
				YetaP73002GridPanel.getTableDef().setTableColumnFilters(filters);
				YetaP73002GridPanel.getTableDef().addColumnFilter("yrtxBlggYr", MSFSharedUtils.allowNulls(srhYrtxBlggYr.getValue())
	...
	//					, SimpleColumnFilter.OPERATOR_EQUALS);//연말정산귀속년도
				YetaP73002GridPanel.getTableDef().addColumnFilter("clutSeptCd", MSFSharedUtils.getSelectedComboValue(srhClutSeptCd,"commCd")
						, SimpleColumnFilter.OPERATOR_EQUALS);//정산구분
				YetaP73002GridPanel.getTableDef().addColumnFilter("systemkey", MSFSharedUtils.allowNulls(systemkey.getValue())
						, SimpleColumnFilter.OPERATOR_EQUALS);//시스템키
			 
				YetaP73002GridPanel.reload();
...
//			actionDatabase = ActionDatabase.READ;
	...
	private void createMsfGridForm() {
		...
		YetaP73002GridPanel = new MSFGridPanel(YetaP73002ToYe164010Def, false,false, false, false, false);
		YetaP73002GridPanel.setSize("780px", "390px");
		YetaP73002GridPanel.setBorders(true);
		YetaP73002GridPanel.setBodyBorder(false);
		YetaP73002GridPanel.setHeaderVisible(false);
		YetaP73002GridPanel.getBottomComponent().setVisible(true);
		...
		YetaP73002GridPanel.getGrid().getColumnModel().addAggregationRow(payrSummaryRow);  
		/** --- 그리드 합계 부분  시작 --- **/
			
		gridFieldSet.add(YetaP73002GridPanel);

		cpYeta73002.add(gridFieldSet);
