...
* </pre>
 */
@Service("Yeta4200Service")
public class Yeta4200ServiceImpl  extends AbstractCustomServiceImpl implements Yeta4200Service  ,YetaDaoConstants {

	 
	private static final Logger logger = LoggerFactory.getLogger(Yeta4200ServiceImpl.class);
	private static final String calledClass = Yeta4200ServiceImpl.class.getName();
	 ...
	 */
	//조회
	public PagingLoadResult<BaseModel> getYeta4200ToYe161010DataList(ServiceParameters serviceParameters) throws MSFException {
		

		PagingLoadResult<BaseModel> retval = null;
		String method =  CLASS_YETA4200_DATA_LIST;
...
//	            Collection<Map<String, Object>> list ??????
	 ...
	 */
	//조회
	public PagingLoadResult<BaseModel> getYeta4200ToYe161010ResultDataList(ServiceParameters serviceParameters) throws MSFException {
