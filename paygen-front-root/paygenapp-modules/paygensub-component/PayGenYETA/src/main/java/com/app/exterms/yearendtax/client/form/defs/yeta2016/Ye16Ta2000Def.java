...
public class Ye16Ta2000Def extends TableDef implements YetaDaoConstants{
	private int row = 0;
	...
	public Ye16Ta2000Def(String chkDef) {
...
//	        setCustomListMethod(CLASS_YETA0300To2000_LIST);
	        setCustomListMethod(CLASS_YETA1100ToYETA2000_LIST);	//조회를 위해 수정
	  	  	setAutoFillGrid(false);
	        setShowFilterToolbar(false);   
	        setCheckBoxOnGridRows(true); 
		    setEditFieldGrid(false);
		    setColumnsDefinition(getColumnsListYeta0300ToYeta2000()); 			
		}else if("YETA1200".equals(chkDef)) {
			setTitle("");
	        setDaoClass("");
	        setCustomListMethod(CLASS_YETA1200ToYETA2000_LIST);
	  	  	setAutoFillGrid(false);
	        setShowFilterToolbar(false);   
	        setCheckBoxOnGridRows(true); 
		    setEditFieldGrid(false);
		    setColumnsDefinition(getYeta1200ToYeta2000List()); 	
		}else if("YETA1100".equals(chkDef)) {
			setTitle("");
	        setDaoClass("");
	        setCustomListMethod(CLASS_YETA1100ToYE16TA2000_LIST);
	  	  	setAutoFillGrid(false);
	        setShowFilterToolbar(false);   
	        setCheckBoxOnGridRows(true); 
		    setEditFieldGrid(false);
		    setColumnsDefinition(getYeta1100ToYe16Ta2000List()); 			
		}else if("YETA1300".equals(chkDef)) {
			setTitle("");
	        setDaoClass("");
	        setCustomListMethod(CLASS_YETA1300ToYETA2000_LIST);
	  	  	setAutoFillGrid(false);
	        setShowFilterToolbar(false);   
	        setCheckBoxOnGridRows(true); 
		    setEditFieldGrid(false);
		    setColumnsDefinition(getYeta0300ToYeta2000List()); 			
        } else if("YETAP110002".equals(chkDef)){
