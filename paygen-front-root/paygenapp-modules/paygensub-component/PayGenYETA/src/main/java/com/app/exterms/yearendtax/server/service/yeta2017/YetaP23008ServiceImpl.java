...
@Service("YetaP23008Service")
public class YetaP23008ServiceImpl  extends AbstractCustomServiceImpl implements YetaP23008Service  ,YetaDaoConstants {

	 
	private static final Logger logger = LoggerFactory.getLogger(YetaP23008ServiceImpl.class);
	private static final String calledClass = YetaP23008ServiceImpl.class.getName();
	...
	public Long activityOnYetaP23008ToYe160403(Ye160403DTO ye160403Dto, ActionDatabase actionDatabase) throws MSFException {
		...
		String method = calledClass + ".activityOnYetaP23008ToYe160403";

		String windowNm = "소득공제신고자료관리";
		String windowId = "YETAP2300";
			
		Ye160403VO ye160403Vo = new Ye160403VO(); 
		...
		try {
			...
			if (MSFSharedUtils.paramNull(ye160403DAO)) {
				...
				ye160403DAO = (Ye160403DAO) wac.getBean("Ye160403DAO"); 
			}
			...
			ye160403DAO.updateYetaP23008ToYe160403(ye160403Vo); 
		          
		} catch (Exception ex) {
			logger.error("EXCEPTION calling activityOnYetaP23008ToYe160403(): "+ ex);
			...
			result = new Long(0);
			throw MSFServerUtils.getOperationException("activityOnYetaP23008ToYe160403", ex, logger);
	...
	public Ye160403DTO getYetaP23008ToYe160403List(Ye160403DTO ye160403Dto) throws MSFException {
		...
		Ye160403SrhVO ye160403SrhVo = new Ye160403SrhVO();
		MSFSysm0100BM sessionUser;

		String method = calledClass + ".getYetaP23008ToYe160403List";
		...
		try {
			...
			egovResultDataList = ye160403DAO.selectYetaP23008ToYe160403List(ye160403SrhVo);
