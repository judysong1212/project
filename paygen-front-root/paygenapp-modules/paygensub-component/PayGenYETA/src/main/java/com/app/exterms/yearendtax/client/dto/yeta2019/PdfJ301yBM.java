 ...
 */
public class PdfJ301yBM   extends MSFSimpleBaseModel implements IsSerializable  {
    ...
    public static final String ATTR_HOMEAMTSUM = "homeAmtSum";
    ...
    /** 일괄등록 처리   */
     public PdfJ301yBM(
     	...
     	values.put(ATTR_HOMEAMTSUM,homeAmtSum);
