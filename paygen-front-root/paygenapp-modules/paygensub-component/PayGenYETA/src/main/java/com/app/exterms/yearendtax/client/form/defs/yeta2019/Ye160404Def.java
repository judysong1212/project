...
import com.app.exterms.yearendtax.client.dto.yeta2019.Ye160406BM;
...
//    private PayrConstants PayrLabel = PayrConstants.INSTANCE;
	...
	public Ye160404Def(String chkPayrDef) {
		...
		if ("YetaP43006".equals(chkPayrDef)) {
			// setTitle(PayrLabel.titlePayr0304());
			setDaoClass("");
			setCustomListMethod(CLASS_YETAP43006_TO_YE160404_DATA_LIST);
