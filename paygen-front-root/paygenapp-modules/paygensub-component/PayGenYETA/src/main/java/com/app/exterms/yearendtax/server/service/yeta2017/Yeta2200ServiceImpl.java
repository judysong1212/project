...
* </pre>
 */
@Service("Yeta2200Service")
public class Yeta2200ServiceImpl  extends AbstractCustomServiceImpl implements Yeta2200Service  ,YetaDaoConstants {

	 
	private static final Logger logger = LoggerFactory.getLogger(Yeta2200ServiceImpl.class);
	private static final String calledClass = Yeta2200ServiceImpl.class.getName();
	 ...
	 */
	//조회
	public PagingLoadResult<BaseModel> getYeta2200ToYe161010DataList(ServiceParameters serviceParameters) throws MSFException {
		

		PagingLoadResult<BaseModel> retval = null;
		String method =  CLASS_YETA2200_DATA_LIST;
...
//	            Collection<Map<String, Object>> list ??????
	 ...
	 */
	//조회
	public PagingLoadResult<BaseModel> getYeta2200ToYe161010ResultDataList(ServiceParameters serviceParameters) throws MSFException {
