...
import com.app.exterms.yearendtax.client.form.defs.yeta2022.Ye18Ta1000Def;
import com.app.exterms.yearendtax.client.service.yeta2022.Yeta7400Service;
import com.app.exterms.yearendtax.client.service.yeta2022.Yeta7400ServiceAsync;
 ...
 * =====================================================
 **/
public class Yeta7400 extends MSFPanel {
	...
	private FormPanel plFrmYeta7400;
...
//	private MSFGridPanel typOccuCdGridPanel;
	 ...
	 **/
	// ---------- 상단 버튼 시작 ----------
	private ButtonBar topYeta7400Bar;
	private Button btnYeta7400Reset;	//초기화
	private Button btnYeta7400Save;		//저장
	private Button btnYeta7400Search;	//조회
	// ---------- 상단 버튼 종료 ----------
	
	// ---------- 엑셀 버튼 시작 ----------
	private ButtonBar exYeta7400Bar;	
...
//	private Yeta0100ServiceAsync yeta0100Service = Yeta0100Service.Util.getInstance();
	private Yeta7400ServiceAsync yeta7400Service = Yeta7400Service.Util.getInstance();
	// -------------- 서비스 호출 종료 --------------
	 ...
	 */
	private void checkYeta7400Auth(String authAction, ListStore<BaseModel> bm) {
	 ...
	 private void authExecEnabled() { 
		 ...
		 /**
			...
			creYrtxBlggYr.setValue(lsClutYrStore.findModel("year", "2022"));
			yrtxBlggYr.setValue(lscreClutYrStore.findModel("year", "2022"));
...
//			formData = new FormData("-650");
			...
			createYeta7400Form();	// 화면 기본정보를 설정
	...
	public Yeta7400(String txtForm) {
...
//
		...
		plFrmYeta7400.setLayout(new FlowLayout());
		...
		lscreEmymtDivCd.addStoreListener(new StoreListener<BaseModel>() {
			public void handleEvent(StoreEvent<BaseModel> be) {
				...
				if (type == Store.Add) {
					 ...
					 * ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
					 */
					checkYeta7400Auth("creEmymtDivCd", lscreEmymtDivCd);
				}
			}
		});
		...
		creDeptCd.getStore().addStoreListener(new StoreListener<ModelData>() {
			public void handleEvent(StoreEvent<ModelData> be) {
				...
				if (type == Store.Add) {
					 ...
					 * ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
					 */
					checkYeta7400Auth("creDeptCd", lscreDeptCd);
				}
			}
		});
		...
		creTypOccuCd.getStore().addStoreListener(new StoreListener<ModelData>() {
			public void handleEvent(StoreEvent<ModelData> be) {
				...
				if (type == Store.Add) {
					 ...
					 * ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
					 */
					//checkYeta7400Auth("creTypOccuCd", lsTypOccuCd);
				}
			}
		});
...
//		PayrMangDeptCd = new HiddenField<String>(); //급여관리부서코드 
		...
		// 파일업로드 처리
		plFrmYeta7400.setAction("myurl");
		plFrmYeta7400.setEncoding(Encoding.MULTIPART);
		plFrmYeta7400.setMethod(Method.POST);

		plFrmYeta7400.setSize("990px", "820px");
		plFrmYeta7400.setLayout(new FlowLayout());
...
//		layoutContainer1_4.setStyleAttribute("marginBottom", "10px");
		...
		exYeta7400Bar = new ButtonBar();
		exYeta7400Bar.setAlignment(HorizontalAlignment.RIGHT);

		/*
		btnYetaVerifiction= new Button("신고사전검증");
		exYeta7400Bar.add(btnYetaVerifiction);
		...
		exYeta7400Bar.add(btnYetaExImport);

		btnYetaExSave= new Button("신고파일생성");
		exYeta7400Bar.add(btnYetaExSave);
		...
		layoutContainer11.add(exYeta7400Bar);
		...
		plFrmYeta7400.add(layoutContainer1_4,new com.extjs.gxt.ui.client.widget.layout.ColumnData(1));	// 텍스트와 버튼
...
//		});
	...
	private void createYeta7400Form() {

		plFrmYeta7400 = new FormPanel();
		plFrmYeta7400.setHeadingText(PayGenConst.PAYGEN_VERSION.concat(" - 연말정산신고파일생성"));
		plFrmYeta7400.setIcon(Resources.APP_ICONS.text());
		plFrmYeta7400.setPadding(2);
		plFrmYeta7400.setFrame(true);
		...
		plFrmYeta7400.getHeader().setStyleAttribute("padding", "5px 0 2px 0");
		plFrmYeta7400.getHeader().addTool(btnlogView); 
		/************************************************************************
		 * 화면 에러 처리시 필요한 부분으로 추가 
		 ************************************************************************/
		
		   //멀티콤보박스 닫기 
		plFrmYeta7400.addListener(Events.OnClick,new Listener<ComponentEvent>() { 
		            @Override
		            public void handleEvent(ComponentEvent ce) { 
...
//						                        }
	...
	private void createSearchForm() {
		...
		topYeta7400Bar = new ButtonBar();
		topYeta7400Bar.setAlignment(HorizontalAlignment.RIGHT);

		btnYeta7400Reset = new Button("초기화");
		btnYeta7400Reset.setIcon(MSFMainApp.ICONS.new16());
		btnYeta7400Reset.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				resetStandardForm();	//전자신고기본정보 초기화
			}
		});
		topYeta7400Bar.add(btnYeta7400Reset);

//		topBtn = new Button("신 규");
//		topBtn.setIcon(MSFMainApp.ICONS.new16());
//		topYeta7400Bar.add(topBtn);
...
//		buttonBar.add(topBtn);
		...
		btnYeta7400Save = new Button("저 장");
		btnYeta7400Save.setIcon(MSFMainApp.ICONS.save16());
		btnYeta7400Save.addListener(Events.Select, new Listener<ButtonEvent>() {
			@Override
		...
		topYeta7400Bar.add(btnYeta7400Save);

		btnYeta7400Search = new Button("조 회");
		btnYeta7400Search.setIcon(MSFMainApp.ICONS.search());
		btnYeta7400Search.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
...
//				ye161005Bm.setSrhBusinCd(MSFSharedUtils.getSelectedComboValue(srhBusinCd,"businCd"));
				...
				yeta7400Service.getYeta7400List(ye161005Dto, new AsyncCallback<Ye161005BM>(){
		...
		topYeta7400Bar.add(btnYeta7400Search);

//		topBtn = new Button("인 쇄");
//		topBtn.setIcon(MSFMainApp.ICONS.print16());
//		buttonBar.add(topBtn);
		
		plFrmYeta7400.add(topYeta7400Bar);
		...
		lsEmymtDivCd.addStoreListener(new StoreListener<BaseModel>() {
			public void handleEvent(StoreEvent<BaseModel> be) {
				...
				if (type == Store.Add) {
					 ...
					 * ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
					 */
					checkYeta7400Auth("srhEmymtDivCd", lsEmymtDivCd);
				}
			}
		});
		...
		srhDeptCd.getStore().addStoreListener(new StoreListener<ModelData>() {
			public void handleEvent(StoreEvent<ModelData> be) {
				...
				if (type == Store.Add) {
					 ...
					 * ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
					 */
					checkYeta7400Auth("srhDeptCd", lsDeptCd);
				}
			}
		});
		...
		srhTypOccuCd.getStore().addStoreListener(new StoreListener<ModelData>() {
			public void handleEvent(StoreEvent<ModelData> be) {
				...
				if (type == Store.Add) {
					 ...
					 * ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
					 */
					//checkYeta7400Auth("srhTypOccuCd", lsTypOccuCd);
				}
			}
		});
...
//        cpGrid.add(gridFieldSet);
		...
		plFrmYeta7400.add(gridFieldSet);
//		plFrmYeta7400.add(msfGridPanel);
	}
...
//		msfGridPanel.getTableDef().addColumnFilter("businCd", MSFSharedUtils.getSelectedComboValue(srhBusinCd,"businCd"), SimpleColumnFilter.OPERATOR_EQUALS);//사업
	...
	/** 정산 마감 및 풀기 **/
	private void finishYeta7400(final String flag) { 
...
//	    				ye161005Bm.setBusinCd(MSFSharedUtils.getSelectedComboValue(srhBusinCd,"businCd"));
	    			...
	    			//	ye17Ta1010Dto.setBusoprRgstnum(MSFSharedUtils.getSelectedComboValue(srhBusoprRgstnum, "busoprRgstnum"));
	      				...
	      				yeta7400Service.finishOnYe161005(ye17Ta1010Dto, new AsyncCallback<Long>(){
	                         public void onFailure(Throwable caught) {
...
//			} else { 
				msfGridPanel.callXlsExportServlet(GWT.getHostPageBaseURL() + "exp/XlsYeta7400Export.do","extgwtFrame" ,param);   
			//}
		}else{ 
			msfGridPanel.callXlsExportServlet(GWT.getHostPageBaseURL() + "exp/XlsYeta7400Export.do","extgwtFrame" ,param);  
		}
...
//		ye161005ExDto.setDpobCd(dpobCd.getValue());    														/** column 사업장코드 : dpobCd */
		...
		yeta7400Service.updateYe161005(ye161005ExDto, new AsyncCallback<Long>(){
			@Override
			public void onFailure(Throwable caught) {
...
//		param.put("businCd", MSFSharedUtils.getSelectedComboValue(creBusinCd,"businCd"));
		...
		if ("Y0090003".equals(MSFSharedUtils.allowNulls(param.get("creFile")))) {
			...
			msfGridPanel.callXlsExportServlet(GWT.getHostPageBaseURL() + "exp/FileYeta7400Export.do","extgwtFrame" ,param);   
			//}
		}else{ 
			msfGridPanel.callXlsExportServlet(GWT.getHostPageBaseURL() + "exp/FileYeta7400Export.do","extgwtFrame" ,param);  
		}	
	...
	/*-----------------------------------------------------------------------------------------------------------------------------------
	 * 검증 추가 
	 *  @RequestMapping(value = "/exp/Yeta7400Verifiction.do") 
	 -------------------------------------------------------------------------------------------------------------------------------------*/
...
//		param.put("businCd", MSFSharedUtils.getSelectedComboValue(creBusinCd,"businCd"));
		...
		if(MSFSharedUtils.paramNull(param.get("resuNumb"))){
			...
			MessageBox.info("", "중간 생성부 부서 또는 원천징수부서는 필수 입니다.(택1)", null);
				...
				msfGridPanel.callXlsExportServlet(GWT.getHostPageBaseURL() + "exp/Yeta7400Verifiction.do","extgwtFrame" ,param);   
