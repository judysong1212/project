...
@Repository("Yeta3300DAO")
public class Yeta3300DAO extends EgovAbstractDAO {
    ...
    public String insertYeta3300(Yeta3300VO vo) throws Exception {
        return (String)insert("yeta3300DAO.insertYeta3300_S", vo);
    }
    ...
    public void updateYeta3300(Yeta3300VO vo) throws Exception {
        update("yeta3300DAO.updateYeta3300_S", vo);
    }
    ...
    public void deleteYeta3300(Yeta3300VO vo) throws Exception {
        delete("yeta3300DAO.deleteYeta3300_S", vo);
    }
    ...
    public void fnPayr06430_Yeta3300_CREATE_Delete(Yeta3300VO vo) throws Exception {
        delete("yeta3300DAO.fnPayr06430_Yeta3300_CREATE_Delete_S", vo);
    } 
    ...
    public Yeta3300VO selectYeta3300(Yeta3300VO vo) throws Exception {
        return (Yeta3300VO) selectByPk("yeta3300DAO.selectYeta3300_S", vo);
    }
    ...
    public List<?> selectYeta3300List(Yeta3300SrhVO searchVO) throws Exception {
        return list("yeta3300DAO.selectYeta3300List_D", searchVO);
    }
    ...
    public int selectYeta3300ListTotCnt(Yeta3300SrhVO searchVO) {
        return (Integer)getSqlMapClientTemplate().queryForObject("yeta3300DAO.selectYeta3300ListTotCnt_S", searchVO);
    }
