...
import com.app.exterms.yearendtax.client.service.yeta2019.YetaT43005Service;
import com.app.exterms.yearendtax.client.service.yeta2019.YetaT43005ServiceAsync;
...
//import com.app.exterms.yearendtax.client.form.defs.yeta2016.YetaT43005Def;
...
=====================================================**/
public  class YetaT43005   extends MSFFormPanel {  
 ...
 **/
	...
	private  ContentPanel cpYetaT43005; 
	...
	// -------------- grid 선언 시작  ---------------	  
	private MSFGridPanel YetaT43005GridPanel;
//	private YetaT43005Def YetaT43005Def = new YetaT43005Def("YetaT43005");   //TODO 일단 화면번호로 Def
	// -------------- grid 선언 종료  ---------------
	...
	// -------------- 서비스 호출 시작 --------------
	private YetaT43005ServiceAsync yetaT43005Service = YetaT43005Service.Util.getInstance();
	// -------------- 서비스 호출 종료 --------------	 
...
//					ye162510Dto.setMnthRnttyHusCnttArea((MSFSharedUtils.allowNulls(bmMapModel.get("mnthRnttyHusCnttArea"))));    		/** column 월세주택계약면적 : mnthRnttyHusCnttArea */
				...
				yetaT43005Service.activityOnYetaT43005(listYe162510Dto, actionDatabase, new AsyncCallback<Long>(){
...
//		 }
	...
	public YetaT43005(final ActionDatabase actionDatabase, final MSFPanel caller) {
...
//		initLoad(); 	
		...
		this.actionDatabase = actionDatabase;
	 	...
	 	cpYetaT43005 = new ContentPanel();  

		createSearchForm();			//기본정보 필드를 적용
	 	createMsfGridForm();		//그리드필드
		   
		cpYetaT43005.setBodyBorder(false);
		cpYetaT43005.setBorders(false);
		cpYetaT43005.setHeaderVisible(false);
		cpYetaT43005.setSize("790px", "640px");
		   
		this.add(cpYetaT43005);
...
//		     });     
		...
		cpYetaT43005.setLayout(new FlowLayout());
...
//	      	     }
//				 
//				YetaT43005GridPanel.getMsfGrid().clearData();
//				 
//				BaseModel bmData = YetaT43005GridPanel.getTableDef().getDefaultValues();  
//		              
...
//		         
//		        YetaT43005GridPanel.getMsfGrid().getGrid().stopEditing();      
//		        YetaT43005GridPanel.getMsfGrid().getGrid().getStore().insert(bmData,0);   
//		        YetaT43005GridPanel.getMsfGrid().getGrid().startEditing(YetaT43005GridPanel.getMsfGrid().getGrid().getStore().indexOf(bmData), 0);   
//
...
//			public void handleEvent(ButtonEvent e) {
//				Iterator<BaseModel> itBm = YetaT43005GridPanel.getMsfGrid().getGrid().getSelectionModel().getSelectedItems().listIterator();
...
//		topYetaBtnBar.add(btnYetaDel);
		...
		btnYetaSave.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				setListRecord(YetaT43005GridPanel.getMsfGrid().getStore().getModifiedRecords().iterator());
				doAction(actionDatabase);
...
//			topYetaBtnBar.add(btnYetaClose);
		...
		cpYetaT43005.add(topYetaBtnBar);
...
//		YetaT43005GridPanel = new MSFGridPanel(YetaT43005Def, false, false, false, false, false);
//		YetaT43005GridPanel.setSize("790px", "420px");
//		YetaT43005GridPanel.setBorders(true);
//		YetaT43005GridPanel.setHeaderVisible(false);
//		
...
//		
//		YetaT43005GridPanel.getGrid().getColumnModel().addAggregationRow(payrSummaryRow);  
//		
...
//		
//		YetaT43005GridPanel.getGrid().getColumnModel().addAggregationRow(payrSummaryRow1);
//		/** --- 그리드 합계 부분  종료 --- **/
		
//      cpYetaT43005.add(YetaT43005GridPanel);
		...
		cpYetaT43005.add(fldstNewFieldset);
		cpYetaT43005.add(layoutContainer1_1);
		cpYetaT43005.add(fldstNewFieldset_1);
	...
	public void reload() {
			...
			YetaT43005GridPanel.getTableDef().setTableColumnFilters(filters);
			YetaT43005GridPanel.getTableDef().addColumnFilter("yrtxBlggYr", MSFSharedUtils.allowNulls(srhYrtxBlggYr.getValue())
...
//					, SimpleColumnFilter.OPERATOR_EQUALS);//연말정산귀속년도
			YetaT43005GridPanel.getTableDef().addColumnFilter("clutSeptCd", MSFSharedUtils.getSelectedComboValue(srhClutSeptCd,"commCd")
					, SimpleColumnFilter.OPERATOR_EQUALS);//정산구분
			YetaT43005GridPanel.getTableDef().addColumnFilter("systemkey", MSFSharedUtils.allowNulls(systemkey.getValue())
					, SimpleColumnFilter.OPERATOR_EQUALS);//시스템키
		 
			YetaT43005GridPanel.reload();
