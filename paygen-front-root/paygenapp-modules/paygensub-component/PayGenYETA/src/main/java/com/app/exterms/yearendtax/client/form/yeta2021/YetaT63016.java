...
import com.app.exterms.yearendtax.client.service.yeta2021.YetaT63016Service;
import com.app.exterms.yearendtax.client.service.yeta2021.YetaT63016ServiceAsync;
...
//import com.app.exterms.yearendtax.client.form.defs.yeta2016.YetaT63016Def;
...
=====================================================**/
public  class YetaT63016   extends MSFFormPanel {  
 ...
 **/
	...
	private  ContentPanel cpYetaT63016; 
	...
	// -------------- grid 선언 시작  ---------------	  
	private MSFGridPanel YetaT63016GridPanel;
//	private YetaT63016Def YetaT63016Def = new YetaT63016Def("YetaT63016");   //TODO 일단 화면번호로 Def
	// -------------- grid 선언 종료  ---------------
	...
	// -------------- 서비스 호출 시작 --------------
	private YetaT63016ServiceAsync yetaT63016Service = YetaT63016Service.Util.getInstance();
	// -------------- 서비스 호출 종료 --------------	 
...
//					ye162510Dto.setMnthRnttyHusCnttArea((MSFSharedUtils.allowNulls(bmMapModel.get("mnthRnttyHusCnttArea"))));    		/** column 월세주택계약면적 : mnthRnttyHusCnttArea */
				...
				yetaT63016Service.activityOnYetaT63016(listYe162510Dto, actionDatabase, new AsyncCallback<Long>(){
...
//		 }
	...
	public YetaT63016(final ActionDatabase actionDatabase, final MSFPanel caller) {
...
//		initLoad(); 	
		...
		this.actionDatabase = actionDatabase;
	 	...
	 	cpYetaT63016 = new ContentPanel();  

		createSearchForm();			//기본정보 필드를 적용
	 	createMsfGridForm();		//그리드필드
		   
		cpYetaT63016.setBodyBorder(false);
		cpYetaT63016.setBorders(false);
		cpYetaT63016.setHeaderVisible(false);
		cpYetaT63016.setSize("790px", "640px");
		   
		this.add(cpYetaT63016);
...
//		     });     
		...
		cpYetaT63016.setLayout(new FlowLayout());
...
//	      	     }
//				 
//				YetaT63016GridPanel.getMsfGrid().clearData();
//				 
//				BaseModel bmData = YetaT63016GridPanel.getTableDef().getDefaultValues();  
//		              
...
//		         
//		        YetaT63016GridPanel.getMsfGrid().getGrid().stopEditing();      
//		        YetaT63016GridPanel.getMsfGrid().getGrid().getStore().insert(bmData,0);   
//		        YetaT63016GridPanel.getMsfGrid().getGrid().startEditing(YetaT63016GridPanel.getMsfGrid().getGrid().getStore().indexOf(bmData), 0);   
//
...
//			public void handleEvent(ButtonEvent e) {
//				Iterator<BaseModel> itBm = YetaT63016GridPanel.getMsfGrid().getGrid().getSelectionModel().getSelectedItems().listIterator();
...
//				
		...
		btnYetaSave.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				setListRecord(YetaT63016GridPanel.getMsfGrid().getStore().getModifiedRecords().iterator());
				doAction(actionDatabase);
...
//				
		cpYetaT63016.add(topYetaBtnBar);
...
//		YetaT63016GridPanel = new MSFGridPanel(YetaT63016Def, false, false, false, false, false);
//		YetaT63016GridPanel.setSize("790px", "420px");
//		YetaT63016GridPanel.setBorders(true);
//		YetaT63016GridPanel.setHeaderVisible(false);
...
//		
//		YetaT63016GridPanel.getGrid().getColumnModel().addAggregationRow(payrSummaryRow);  
//		
...
//		
//		YetaT63016GridPanel.getGrid().getColumnModel().addAggregationRow(payrSummaryRow1);
//		/** --- 그리드 합계 부분  종료 --- **/
		
//        cpYetaT63016.add(YetaT63016GridPanel);
		...
		cpYetaT63016.add(layoutContainer);
		...
		cpYetaT63016.add(layoutContainer1);
		...
		cpYetaT63016.add(layoutContainer2);
		...
		cpYetaT63016.add(layoutContainer_gibu08);
		...
		cpYetaT63016.add(fldstNewFieldset_4);
	...
	public void reload() {
			...
			YetaT63016GridPanel.getTableDef().setTableColumnFilters(filters);
			YetaT63016GridPanel.getTableDef().addColumnFilter("yrtxBlggYr", MSFSharedUtils.allowNulls(srhYrtxBlggYr.getValue())
...
//					, SimpleColumnFilter.OPERATOR_EQUALS);//연말정산귀속년도
			YetaT63016GridPanel.getTableDef().addColumnFilter("clutSeptCd", MSFSharedUtils.getSelectedComboValue(srhClutSeptCd,"commCd")
					, SimpleColumnFilter.OPERATOR_EQUALS);//정산구분
			YetaT63016GridPanel.getTableDef().addColumnFilter("systemkey", MSFSharedUtils.allowNulls(systemkey.getValue())
					, SimpleColumnFilter.OPERATOR_EQUALS);//시스템키
		 
			YetaT63016GridPanel.reload();
