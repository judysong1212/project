...
import com.app.exterms.yearendtax.client.dto.yeta2020.Ye169010BM;
...
public class Ye169010Def extends TableDef implements YetaDaoConstants {
	...
	public Ye169010Def(String chkPayrDef) {
		...
		if("Yeta5300".equals(chkPayrDef)) { 
			setTitle("");
	        setDaoClass("");
	        setCustomListMethod("");
	        setCustomListMethod(CLASS_YETA5300_TO_YE169010_SUBTAX_LIST);
