...
import com.app.exterms.yearendtax.client.service.yeta2017.YetaP230010Service;
...
@Service("YetaP230010Service")
public class YetaP230010ServiceImpl  extends AbstractCustomServiceImpl implements YetaP230010Service  ,YetaDaoConstants {

	 
	private static final Logger logger = LoggerFactory.getLogger(YetaP230010ServiceImpl.class);
	private static final String calledClass = YetaP230010ServiceImpl.class.getName();
	...
	public int activityOnYetaP230010ToYe160405(Ye160405DTO ye160405Dto, ActionDatabase actionDatabase) throws MSFException {
		...
		String method = calledClass + ".activityOnYetaP230010ToYe160405";

		String windowNm = "소득공제신고자료관리";
		String windowId = "YETAP2300";
		...
		try {
			...
			String nResult = AnyCryptUtils.XecureCryptInitialize(RemoteServiceUtil.getThreadLocalConfig(),RemoteServiceUtil.getThreadLocalRequest());
				...
				result = ye160405DAO.updateYetaP230010ToYe160405(ye160405Vo); 
		          
		} catch (Exception ex) {
			logger.error("EXCEPTION calling activityOnYetaP230010ToYe160405(): "+ ex);
			...
			result = 0;
			throw MSFServerUtils.getOperationException("activityOnYetaP230010ToYe160405", ex, logger);
	...
	public Ye160405DTO getYetaP230010ToYe160405List(Ye160405DTO ye160405Dto) throws MSFException {
		...
		Ye160405SrhVO ye160405SrhVo = new Ye160405SrhVO();
		MSFSysm0100BM sessionUser;

		String method = calledClass + ".getYetaP230010ToYe160405List";

		String windowNm = "소득공제신고자료관리";
		String windowId = "YETAP230008";
		...
		try {
			...
			egovResultDataList = ye160405DAO.selectYetaP230010ToYe160405List(ye160405SrhVo);
