...
@Service("YetaP33001Service")
public class YetaP33001ServiceImpl  extends AbstractCustomServiceImpl implements YetaP33001Service, YetaDaoConstants {

	private static final Logger logger = LoggerFactory.getLogger(YetaP33001ServiceImpl.class);
	private static final String calledClass = YetaP33001ServiceImpl.class.getName();
	...
	//이월기부금 신규 수정 삭제부
	@Override
	public Long activityOnYetaP33001ToYe165030(List<Ye165030DTO> listYe165030Dto, ActionDatabase actionDatabase) throws MSFException {
		...
		String windowId = "YETAP330001";

		MSFSysm0100BM sessionUser;
		String method = calledClass + ".activityOnYetaP33001ToYe165030";

		Ye165030DTO ye165030Dto = new Ye165030DTO();
		Ye165030_2018_VO ye165030Vo = new Ye165030_2018_VO();
		...
		try {  
			...
			if (MSFSharedUtils.paramNull(ye165030DAO)) {
				...
				ye165030DAO = (Ye165030_2018_DAO) wac.getBean("Ye165030_2018_DAO");
			}
			...
			for (int iPsnlCnt = 0; iPsnlCnt < listYe165030Dto.size(); iPsnlCnt++) {
				...
				ye165030Vo = new Ye165030_2018_VO();
				...
				ye165030Vo.setRevnAddr(RemoteServiceUtil.getThreadLocalRequest().getRemoteHost());/** column 수정주소 : revnAddr */
		        	...
		        	switch (actionDatabase) {
		        		case INSERT:
		        			...
		        			ye165030DAO.insertYetaP33001ToYe165030(ye165030Vo); 
		        			break;
		            	case UPDATE: 
		            		ye165030DAO.updateYetaP33001ToYe165030(ye165030Vo); 
		            		break;
		            	case DELETE: 
		            		ye165030DAO.deleteYetaP33001ToYe165030(ye165030Vo); 
		            		break;
				}
			...
			result = new Long(0);
			throw MSFServerUtils.getOperationException("activityOnYetaP33001ToYe165030", ex, logger);
		} finally {
	...
	/** 이월기부금 조회 **/
	public PagingLoadResult<BaseModel> getYetaP33001ToYe165030DataList(ServiceParameters serviceParameters) throws MSFException {
		
		PagingLoadResult<BaseModel> retval = null;
		String method = CLASS_YETAP33001_TO_YE165030_DATA_LIST;
		Ye165030Srh_2018_VO ye165030SrhVo = new Ye165030Srh_2018_VO();
...
//	      	yeta3220SrhVo.setHanNm(MSFSharedUtils.allowNulls(MSFServerUtils.getFilterValue(columnFilters, "hanNm")));    //한글성명 
			...
			if ( pagingValues.executeRecordCount ) { 
	        	...
	        	TimingInfo millisBeginQueryCount = SmrmfUtils.startTiming(logger);
	          	...
	          	int iResultCnt = ye165030DAO.selectYetaP33001ToYe165030ListTotCnt(ye165030SrhVo);  
...
//	            Collection<Map<String, Object>> list ??????
	     	List list = ye165030DAO.selectYetaP33001ToYe165030List(ye165030SrhVo);
