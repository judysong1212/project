...
import com.app.exterms.yearendtax.server.service.yeta2018.dao.Yeta3060_2018_DAO;
...
@Service("Yeta3060Service")
public class Yeta3060ServiceImpl  extends AbstractCustomServiceImpl implements YetaDaoConstantsGenerated , Yeta3060Service  {

	private static final Logger logger = LoggerFactory.getLogger(Yeta3060ServiceImpl.class);
	private static final String calledClass = Yeta3060ServiceImpl.class.getName();
	
	@Autowired
	@Resource(name="Yeta3060_2018_DAO")
	private Yeta3060_2018_DAO yeta3060DAO;
	...
	public PagingLoadResult<BaseModel> getSelectYeta3060List(ServiceParameters serviceParameters) throws MSFException {

        PagingLoadResult<BaseModel> retval = null;
        String nResult = null;
        String method =  CLASS_YETA3060_LIST;
        Yeta3060Srh_2018_VO   Yeta2060SrhVO = new Yeta3060Srh_2018_VO();
        //Yeta2060VO      Yeta2060Vo = new Yeta2060VO();
        List<BaseModel>  bmResult = new ArrayList<BaseModel>();
        
        MSFSysm0100BM sessionUser = MSFServerUtils.getLoggedUser(RemoteServiceUtil.getThreadLocalRequest());
        
        if(MSFSharedUtils.paramNull(yeta3060DAO)){
        	WebApplicationContext wac = WebApplicationContextUtils.getRequiredWebApplicationContext( getHttpServletRequest().getSession().getServletContext());
        	yeta3060DAO = (Yeta3060_2018_DAO) wac.getBean("Yeta3060_2018_DAO");
        }
        try{
            ...
            if ( pagingValues.executeRecordCount ) { 
            	...
            	int iResultCnt = yeta3060DAO.selectYeta3060ListTotCnt(Yeta2060SrhVO);
            ...
            List list = yeta3060DAO.selectYeta3060List(Yeta2060SrhVO);
            ...
            SmrmfUtils.endTiming(logger, millisBeginSelectYeta2060List, "selectYeta3060List");
	...
	@SuppressWarnings({ "unchecked", "rawtypes" })
	public PagingLoadResult<BaseModel> getSelectYetaM3060List(ServiceParameters serviceParameters) throws MSFException {

        PagingLoadResult<BaseModel> retval = null;
        String method =  CLASS_YETA3060_MLIST;
        Yeta3060Srh_2018_VO   Yeta2060SrhVO = new Yeta3060Srh_2018_VO();
        //Yeta2060VO      Yeta2060Vo = new Yeta2060VO();
        List<BaseModel>  bmResult = new ArrayList<BaseModel>();
        MSFSysm0100BM sessionUser = MSFServerUtils.getLoggedUser(RemoteServiceUtil.getThreadLocalRequest());
        ...
        try{
            ...
            TimingInfo millisBeginSelectYeta3060List = SmrmfUtils.startTiming(logger);
...
//                	}
            ...
            SmrmfUtils.endTiming(logger, millisBeginSelectYeta3060List, "selectYeta3060List");
	...
	@SuppressWarnings({ "unchecked", "rawtypes" })
	public PagingLoadResult<BaseModel> getSelectYetaS3060List(ServiceParameters serviceParameters) throws MSFException {
...
//            Yeta2060SrhVO.setMtstBusinDivCd("C0030020");	// 종사업장코드
	...
	@SuppressWarnings({ "unchecked", "rawtypes" })
	public PagingLoadResult<BaseModel> getSelectYetaM306001List(ServiceParameters serviceParameters) throws MSFException {
        ...
        try{
            ...
            if(pagingValues.executeRecordCount){ 
            	TimingInfo millisBeginQueryCount = SmrmfUtils.startTiming(logger);
            	int iResultCnt = yeta3060DAO.selectYetaM306001ListTotCnt(Yeta2060SrhVO);
            ...
            List list = yeta3060DAO.selectYetaM306001List(Yeta2060SrhVO);
            Iterator<Map<String, Object>> iter = list.iterator();
            SmrmfUtils.endTiming(logger, millisBeginQueryMain, "QueryMain");
	...
	@SuppressWarnings({ "unchecked", "rawtypes" })
	public PagingLoadResult<BaseModel> getSelectYetaS306001List(ServiceParameters serviceParameters) throws MSFException {
		...
		try{
			...
			if(pagingValues.executeRecordCount){ 
				TimingInfo millisBeginQueryCount = SmrmfUtils.startTiming(logger);
				int iResultCnt = yeta3060DAO.selectYetaS306001ListTotCnt(Yeta2060SrhVO);
			...
			List list = yeta3060DAO.selectYetaS306001List(Yeta2060SrhVO);
			Iterator<Map<String, Object>> iter = list.iterator();
			SmrmfUtils.endTiming(logger, millisBeginQueryMain, "QueryMain");
	...
	@Override
	public int chkYeta3060(Yeta3060DTO dto, ActionDatabase actionDatabase)throws MSFException {
		
		int returnCnt = 0;
		String nResult = AnyCryptUtils.XecureCryptInitialize(RemoteServiceUtil.getThreadLocalConfig(),RemoteServiceUtil.getThreadLocalRequest());
		String method = calledClass + ".saveYeta3060";
		
		String windowNm = "사업장관리";
		String windowId = "Yeta3060";
			...
			switch(actionDatabase){
				case INSERT : 
					...
					if(dto.getMtstBusinDivCd() == "C0030010" || "C0030010".equals(dto.getMtstBusinDivCd())) {
						Yeta2060SrhVo = new Yeta3060Srh_2018_VO();
						Yeta2060SrhVo.setMtstBusinDivCd(dto.getMtstBusinDivCd());
						
						int iCnt = yeta3060DAO.selectYeta3060ListTotCnt(Yeta2060SrhVo);
	...
	/** 삭제 방어 로직 **/
	@Override
	public int delChkYeta3060(Yeta3060DTO dto, ActionDatabase actionDatabase)throws MSFException {
		
		int returnCnt = 0;
		String nResult = AnyCryptUtils.XecureCryptInitialize(RemoteServiceUtil.getThreadLocalConfig(),RemoteServiceUtil.getThreadLocalRequest());
		String method = calledClass + ".delChkYeta3060";
		...
		Ye161010Srh_2018_VO ye161005SrhVo = new Ye161010Srh_2018_VO();
		...
		try {
			...
			int iCnt = ye161010DAO.selectYeta3060ToYe161010ListTotCnt(ye161005SrhVo);
	...
	@SuppressWarnings("incomplete-switch")
	@Override
	public String saveYeta3060(Yeta3060DTO dto, ActionDatabase actionDatabase)throws MSFException {
		...
		try {			
			switch(actionDatabase){
				case INSERT : 
					returnCnt = yeta3060DAO.saveYeta3060(dto);
				...
				case UPDATE : 
					...
					break;
				case DELETE : 
					returnCnt = yeta3060DAO.deleteYeta3060(dto);
	...
	public List<BaseModel> getParentDpobCd() throws MSFException {
		...
		try{
			...
			egovResultDataList = yeta3060DAO.getParentDpobCd();
...
//		MSFLogHistoryUtils.tracerUserActivity(sessionUser, method, calledClass, "S");
	...
	@SuppressWarnings({ "rawtypes", "unchecked" })
	@Override
	public List<BaseModel> getYeta3060sysDivCdList() throws MSFException {
		
		String method = calledClass + ".getYeta3060sysDivCdList";
		MSFSysm0100BM sessionUser;
		...
		List egovResultDataList = new ArrayList();
		try{
			egovResultDataList = yeta3060DAO.selectYeta3060sysDivCdList();
...
//		MSFLogHistoryUtils.tracerUserActivity(sessionUser, method, calledClass, "S");
	...
	public List<BaseModel> getSysDpobCd() throws MSFException {
		...
		try{
			...
			egovResultDataList = yeta3060DAO.getSysDpobCd();
...
//		MSFLogHistoryUtils.tracerUserActivity(sessionUser, method, calledClass, "S");
	...
	@SuppressWarnings("incomplete-switch")
	@Override
	public int insertYetaS306001(Yeta3060DTO dto, ActionDatabase actionDatabase)throws MSFException {
		int returnCnt = 0;
				
		String nResult = AnyCryptUtils.XecureCryptInitialize(RemoteServiceUtil.getThreadLocalConfig(),RemoteServiceUtil.getThreadLocalRequest());
		String method = calledClass + ".insertYetaS306001";
		
		String windowNm = "사업장관리";
		String windowId = "Yeta3060";
		
		Yeta3060_2018_VO Yeta3060Vo = new Yeta3060_2018_VO();
		Ye161005_2018_VO ye161005Vo = new Ye161005_2018_VO();
		...
		try {
			...
			Yeta3060Vo.setDpobCd(sessionUser.getDpobCd());
			Yeta3060Vo.setUtDpobCd(MSFSharedUtils.allowNulls(dto.getUtDpobCd()));
			Yeta3060Vo.setHhrkUntDpobCd(MSFSharedUtils.allowNulls(dto.getHhrkUntDpobCd()));
			Yeta3060Vo.setBusoprRgstnNum(MSFSharedUtils.allowNulls(dto.getBusoprRgstnNum()));
			Yeta3060Vo.setBefBusoprRgstnNum(MSFSharedUtils.allowNulls(dto.getBefBusoprRgstnNum()));
			Yeta3060Vo.setMtstBusinDivCd("C0030020");
			Yeta3060Vo.setIsmt(sessionUser.getUsrId());
			Yeta3060Vo.setRevnAddr(RemoteServiceUtil.getThreadLocalRequest().getRemoteHost());
			
			returnCnt = yeta3060DAO.insertYetaS306001(Yeta3060Vo);
	...
	@Override
	public Long Yeta306001_Delete(List<Yeta3060DTO> listYeta3060Dto,ActionDatabase actionDatabase) throws MSFException {
    	
		String method = calledClass + ".Yeta306001_Delete";

		String windowNm = "주(총괄납부)사업장관리";
		String windowId = "YETA306001";
    	...
    	Yeta3060_2018_VO ye2060Vo = new Yeta3060_2018_VO(); // 현근무지급여지급명세
    	Ye161005_2018_VO ye161005Vo = new Ye161005_2018_VO();
	    ...
	    try {
			...
			for (int iCnt = 0; iCnt < listYeta3060Dto.size(); iCnt++) {
		                
				Yeta3060DTO ye2060Dto = new Yeta3060DTO(); // 연말정산대상자기본
				ye2060Dto = listYeta3060Dto.get(iCnt);
				...
				yeta3060DAO.deleteYeta306001(ye2060Vo);
				...
				ye161005DAO.deleteYeta306001ToYe161005(ye161005Vo);
	            ...
	            logger.error("EXCEPTION calling Yeta3100ToYe160401_Delete(): "+ex); 
	            
	            /** 에러 로그 **/			
	            MSFLogHistoryUtils.tracerUserExceptionActivity(sessionUser,method,calledClass,"D", ex, windowNm , windowId);
	            
	            retval = 0L;
	            throw MSFServerUtils.getOperationException("Yeta3100ToYe160401_Delete", ex, logger);
	        } 
	...
	@Override
	public Long Yeta306001NumUpdate(List<Yeta3060DTO> listYeta3060Dto,ActionDatabase actionDatabase) throws MSFException {
		String method = calledClass + ".Yeta306001NumUpdate";
	    ...
	    try {
			...
			for (int iCnt = 0; iCnt < listYeta3060Dto.size(); iCnt++) {
				...
				Yeta3060DTO ye3060Dto = new Yeta3060DTO(); // 연말정산대상자기본
				ye3060Dto = listYeta3060Dto.get(iCnt);
				
				ye2060Vo.setDpobCd(sessionUser.getDpobCd());
				ye2060Vo.setUtDpobCd(ye3060Dto.getUtDpobCd());
				ye2060Vo.setMtstDpobSeilNumC172(ye3060Dto.getMtstDpobSeilNumC172());
				ye2060Vo.setIsmt(sessionUser.getUsrId());
				ye2060Vo.setRevnAddr(RemoteServiceUtil.getThreadLocalRequest().getRemoteHost());
				
				yeta3060DAO.updateNumYetaS306001(ye2060Vo);
				
				ye161005Vo.setDpobCd(sessionUser.getDpobCd());
				ye161005Vo.setWhdgTxRegrstDeptCd(ye3060Dto.getUtDpobCd());
				ye161005Vo.setYetaC172(ye3060Dto.getMtstDpobSeilNumC172());
				ye161005Vo.setIsmt(sessionUser.getUsrId());
				ye161005Vo.setRevnAddr(RemoteServiceUtil.getThreadLocalRequest().getRemoteHost());
