...
import com.app.exterms.yearendtax.client.dto.yeta2020.Ye161090BM;
...
import com.app.exterms.yearendtax.client.service.yeta2020.YetaP530011ServiceAsync;
...
=====================================================**/
public  class YetaP530011   extends MSFFormPanel {  
 ...
 **/
	...
	private Ye161090Def ye161090Def_01  		= new Ye161090Def("YETA530001");
	private Ye161090Def ye161090Def_02  		= new Ye161090Def("YETA530002");
	// -------------- grid 선언 종료  ---------------	
   ...
   */
	...
	private YetaP530011ServiceAsync yetaP530011Service = YetaP530011Service.Util.getInstance();
...
//		 }
	...
	public YetaP530011(final ActionDatabase actionDatabase, final MSFPanel caller) {
		...
		popBindingCom0160.addListener(Events.Change, new Listener<BaseEvent>() {
			public void handleEvent(BaseEvent be) {
				...
				if (mapModels != null) {
					...
					yetaP530011Service.saveYeta5300ToYe161090tabItem08_3(listYe161090Dto, actionDatabase, new AsyncCallback<Long>() {
