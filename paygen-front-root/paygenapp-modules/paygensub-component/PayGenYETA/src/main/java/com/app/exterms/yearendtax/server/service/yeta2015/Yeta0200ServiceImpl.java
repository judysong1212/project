...
* </pre>
 */
@Service("Yeta0200Service")
public class Yeta0200ServiceImpl  extends AbstractCustomServiceImpl implements Yeta0200Service  ,YetaDaoConstants {
	...
	// private static final String calledClass = Yeta0100ServiceImpl.class.getName();
	  private static final Logger logger = LoggerFactory.getLogger(Yeta0200ServiceImpl.class);
	  private static final String calledClass = Yeta0200ServiceImpl.class.getName();
