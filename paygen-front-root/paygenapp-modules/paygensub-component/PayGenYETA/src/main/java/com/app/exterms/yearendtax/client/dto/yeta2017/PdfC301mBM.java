 ...
 */
public class PdfC301mBM   extends MSFSimpleBaseModel implements IsSerializable  {
    ...
    /** set 교육비1월분납입금액 : schUniMnAmt */
    public static final String ATTR_SCHUNIMNAMT = "schUniMnAmt";
    ...
    /** 일괄등록 처리   */
     public PdfC301mBM(
     	...
     	values.put(ATTR_SCHUNIMNAMT,schUnimnAmt);
    ...
    /** set 교육비1월분납입금액 : schUniMnAmt */
    public void setSchUniMnAmt(Long  schUniMnAmt) { set( ATTR_SCHUNIMNAMT ,schUniMnAmt);}
    /** get 교육비1월분납입금액 : schUniMnAmt */
    public Long  getSchUniMnAmt() { return (Long )get( ATTR_SCHUNIMNAMT );}
