...
@Service("YetaP23001Service")
public class YetaP23001ServiceImpl  extends AbstractCustomServiceImpl implements YetaP23001Service, YetaDaoConstants {

	private static final Logger logger = LoggerFactory.getLogger(YetaP23001ServiceImpl.class);
	private static final String calledClass = YetaP23001ServiceImpl.class.getName();
	...
	public Long activityOnYetaP23001ToYe165030(List<Ye165030DTO> listYe165030Dto, ActionDatabase actionDatabase) throws MSFException {
		...
		String windowId = "YETAP230001";

		MSFSysm0100BM sessionUser;
		String method = calledClass + ".activityOnYetaP23001ToYe165030";

		Ye165030DTO ye165030Dto = new Ye165030DTO();
		Ye165030VO ye165030Vo = new Ye165030VO();
		...
		try {  
			...
			if (MSFSharedUtils.paramNull(ye165030DAO)) {
				...
				ye165030DAO = (Ye165030DAO) wac.getBean("Ye165030DAO");
			}
				...
				ye165030Vo.setRevnAddr(RemoteServiceUtil.getThreadLocalRequest().getRemoteHost());/** column 수정주소 : revnAddr */
		        	...
		        	switch (actionDatabase) {
		        		case INSERT:
		        			...
		        			ye165030DAO.insertYetaP23001ToYe165030(ye165030Vo); 
		        			break;
		            	case UPDATE: 
		            		ye165030DAO.updateYetaP23001ToYe165030(ye165030Vo); 
		            		break;
		            	case DELETE: 
		            		ye165030DAO.deleteYetaP23001ToYe165030(ye165030Vo); 
		            		break;
				}
			...
			result = new Long(0);
			throw MSFServerUtils.getOperationException("activityOnYetaP23001ToYe165030", ex, logger);
		} finally {
	...
	/** 이월기부금 조회 **/
	public PagingLoadResult<BaseModel> getYetaP23001ToYe165030DataList(ServiceParameters serviceParameters) throws MSFException {
		
		PagingLoadResult<BaseModel> retval = null;
		String method = CLASS_YETAP23001_TO_YE165030_DATA_LIST;
		Ye165030SrhVO ye165030SrhVo = new Ye165030SrhVO();
...
//	      	yeta3220SrhVo.setHanNm(MSFSharedUtils.allowNulls(MSFServerUtils.getFilterValue(columnFilters, "hanNm")));    //한글성명 
			...
			if ( pagingValues.executeRecordCount ) { 
	        	...
	        	TimingInfo millisBeginQueryCount = SmrmfUtils.startTiming(logger);
	          	...
	          	int iResultCnt = ye165030DAO.selectYetaP23001ToYe165030ListTotCnt(ye165030SrhVo);  
...
//	            Collection<Map<String, Object>> list ??????
	     	List list = ye165030DAO.selectYetaP23001ToYe165030List(ye165030SrhVo);
