...
public class YetaT13015Def extends TableDef implements YetaDaoConstants{
	private int row = 0;
	final PrgmComBass0300DTO sysComBass0300Dto;
	
	public YetaT13015Def(String chkDef) {
		
		sysComBass0300Dto = new PrgmComBass0300DTO();
		
		if("YetaT13015".equals(chkDef)) { //TODO 테이블 정의되면 다시 구현.
			setTitle("");
	        setDaoClass("");
		    ...
		    setColumnsDefinition(getColumnsListYetaT13015()); 
		}else {
...
//	        setCustomListMethod(CLASS_YETA0100_LIST);
	...
	private List<ColumnDef> getColumnsListYetaT13015() { //TODO BM 다시 정의.
        List<ColumnDef> listColumnDefs = new ArrayList<ColumnDef>();
