 ...
 */
public class Payr0485_2022_VO implements Serializable {
    private static final long serialVersionUID = 1L;
    
    
	public Payr0485_2022_VO(String payItemCd, String payItemNm, String payDducSum){
		this.payItemCd= payItemCd;
		this.payItemNm= payItemNm;
		this.payDducSum= payDducSum;
	}
	
	public Payr0485_2022_VO(){
