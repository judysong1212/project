...
@RemoteServiceRelativePath("Yeta8400Service.gwt")
public interface Yeta8400Service extends RemoteService {
	/**
	 * Utility class for simplifying access to the instance of async service.
	 */
	public static class Util {
		private static Yeta8400ServiceAsync instance;
		public static Yeta8400ServiceAsync getInstance(){
			if (instance == null) {
				instance = GWT.create(Yeta8400Service.class);
			}
			return instance;
		}
	}
