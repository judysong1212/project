...
import com.app.exterms.yearendtax.client.service.yeta2020.YetaP530010Service;
...
@Service("YetaP530010Service")
public class YetaP530010ServiceImpl  extends AbstractCustomServiceImpl implements YetaP530010Service  ,YetaDaoConstants {

	 
	private static final Logger logger = LoggerFactory.getLogger(YetaP530010ServiceImpl.class);
	private static final String calledClass = YetaP530010ServiceImpl.class.getName();
	...
	public int activityOnYetaP530010ToYe160405(Ye160405DTO ye160405Dto, ActionDatabase actionDatabase) throws MSFException {
		...
		String method = calledClass + ".activityOnYetaP530010ToYe160405";

		String windowNm = "소득공제신고자료관리";
		String windowId = "YETAP5300";
		...
		try {
			...
			String nResult = AnyCryptUtils.XecureCryptInitialize(RemoteServiceUtil.getThreadLocalConfig(),RemoteServiceUtil.getThreadLocalRequest());
				...
				result = ye160405DAO.updateYetaP530010ToYe160405(ye160405Vo); 
		          
		} catch (Exception ex) {
			logger.error("EXCEPTION calling activityOnYetaP530010ToYe160405(): "+ ex);
			...
			result = 0;
			throw MSFServerUtils.getOperationException("activityOnYetaP530010ToYe160405", ex, logger);
	...
	public Ye160405DTO getYetaP530010ToYe160405List(Ye160405DTO ye160405Dto) throws MSFException {
		...
		Ye160405Srh_2020_VO ye160405SrhVo = new Ye160405Srh_2020_VO();
		MSFSysm0100BM sessionUser;

		String method = calledClass + ".getYetaP530010ToYe160405List";

		String windowNm = "소득공제신고자료관리";
		String windowId = "YETAP530008";
		...
		try {
			...
			egovResultDataList = ye160405DAO.selectYetaP530010ToYe160405List(ye160405SrhVo);
