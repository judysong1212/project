...
import com.app.exterms.yearendtax.client.service.yeta2023.YetaP83008Service;
import com.app.exterms.yearendtax.client.service.yeta2023.YetaP83008ServiceAsync;
...
=====================================================**/
public  class YetaP83008   extends MSFFormPanel { 
 ...
 **/
	...
	private ContentPanel cpYeta83008;
   ...
   */
	...
	// -------------- 서비스 호출 시작 --------------
	private YetaP83008ServiceAsync yetaP83008Service = YetaP83008Service.Util.getInstance();
	// -------------- 서비스 호출 종료 --------------
 ...
 **/	  
	...
	public YetaP83008(final ActionDatabase actionDatabase, final MSFPanel caller) {
		...
		cpYeta83008 = new ContentPanel();

		createStandardForm();
		setReadOnlyTrueYetaP83008();

		cpYeta83008.setBodyBorder(false);
		cpYeta83008.setBorders(false);
		cpYeta83008.setHeaderVisible(false);
		cpYeta83008.setSize("790px", "680px");

		this.add(cpYeta83008);
		formBinding = new FormBinding(this, true);

		this.setSize("810px", "750px");
	}
	  
	public YetaP83008(final ActionDatabase actionDatabase, final MSFFormPanel caller2) {
		...
		createStandardForm();
		setReadOnlyFalseYetaP83008();

		cpYeta83008.setBodyBorder(false);
		cpYeta83008.setBorders(false);
		cpYeta83008.setHeaderVisible(false);
		cpYeta83008.setSize("790px", "640px");
...
//		lcSchCenter2_1.add(taxmSt10Bi, new FormData("100%"));
	...
	private void YetaP83008FormSave() {  
...
//		ye160403Dto.setTaxmSy21Bi((Long)taxmSy21Bi.getValue());    /** column 비과세소득_Y21_비과세 : taxmSy21Bi */
		...
		yetaP83008Service.activityOnYetaP83008ToYe160403(ye160403Dto, actionDatabase, new AsyncCallback<Long>(){
					public void onFailure(Throwable caught) {
						MessageBox.alert(MSFMainApp.MSFCONSTANTS.ExceptionTitleService(), 
	                              MSFMainApp.ADMINMESSAGES.ExceptionMessageService("activityOnYetaP83008ToYe160403(" + actionDatabase.name() + ") : " + caught), null);
					}
	...
	public void reload() {
		...
		yetaP83008Service.getYetaP83008ToYe160403List(ye160403Dto, new AsyncCallback<Ye160403DTO>(){

			@Override
			public void onFailure(Throwable caught) {
				// TODO Auto-generated method stub
				MessageBox.alert(MSFMainApp.MSFCONSTANTS.ExceptionTitleService(), 
                        MSFMainApp.ADMINMESSAGES.ExceptionMessageService("getYetaP83008ToYe160403List(" + actionDatabase.name() + ") : " + caught), null);
	...
	/** 비과세 및 감면소득 조회부 **/
	public void readYetaP83008Data(Ye160403DTO result) {
...
//		taxmSy21Bi.setValue(result.getTaxmSy21Bi());    /** column 비과세소득_Y21_비과세 : taxmSy21Bi */
	...
	public void setReadOnlyTrueYetaP83008() {
...
//		taxmSy21Bi.setReadOnly(true); // ⑱-20 Y21-장기미취업자 중소기업 취업
	...
	public void setReadOnlyFalseYetaP83008() {
