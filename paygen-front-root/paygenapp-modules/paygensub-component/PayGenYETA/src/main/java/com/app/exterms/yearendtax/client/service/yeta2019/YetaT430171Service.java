...
public interface YetaT430171Service extends RemoteService {
	/**
	...
	public static class Util {
		...
		public static YetaT43017ServiceAsync getInstance(){
			if (instance == null) {
				instance = GWT.create(YetaT430171Service.class);
			}
			return instance;
		}
	}
	...
	public Long activityOnYetaT43017(List<Ye162510DTO> listYe162510Dto, ActionDatabase actionDatabase) throws MSFException;
}
