...
@Service("YetaP63002Service")
public class YetaP63002ServiceImpl  extends AbstractCustomServiceImpl implements YetaP63002Service  ,YetaDaoConstants {

	 
	private static final Logger logger = LoggerFactory.getLogger(YetaP63002ServiceImpl.class);
	private static final String calledClass = YetaP63002ServiceImpl.class.getName();
	...
	/** 의료비내역 신규 수정 삭제부 **/
	@Override
	public Long activityOnYetaP63002ToYe164010(List<Ye164010DTO> listYe164010Dto, ActionDatabase actionDatabase) throws MSFException {
		...
		String windowId = "YETAP630002";

		MSFSysm0100BM sessionUser;
		String method = calledClass + ".activityOnYetaP63002ToYe164010";
		...
		try { 
			...
			if (MSFSharedUtils.paramNull(ye164010DAO)) {
				...
				ye164010DAO = (Ye164010_2021_DAO) wac.getBean("Ye164010_2021_DAO");
			}
			...
			for (int iPsnlCnt = 0; iPsnlCnt < listYe164010Dto.size(); iPsnlCnt++) {
				...
				case INSERT:
					...
					ye164010DAO.insertYetaP63002ToYe164010(ye164010Vo);
					break;
					
				case UPDATE:
					ye164010DAO.updateYetaP63002ToYe164010(ye164010Vo);
					break;
					
				case DELETE:
					ye164010DAO.deleteYetaP63002ToYe164010(ye164010Vo);
					break;
				}
				iCnt = iCnt + 1;
			...
			logger.error("EXCEPTION calling activityOnYetaP63002ToYe164010(): "+ ex);
			...
			result = new Long(0);
			throw MSFServerUtils.getOperationException("activityOnYetaP63002ToYe164010", ex, logger);
	...
	/** 의료비내역 조회 **/
	public PagingLoadResult<BaseModel> getYetaP63002ToYe164010DataList(ServiceParameters serviceParameters) throws MSFException {
		

		PagingLoadResult<BaseModel> retval = null;
		String method =  CLASS_YETAP63002_TO_YE164010_DATA_LIST;
		Ye164010Srh_2021_VO   ye164010SrhVo = new Ye164010Srh_2021_VO();
...
//	    	ye164010SrhVo.setResnoEncCntn(MSFSharedUtils.allowNulls(MSFServerUtils.getFilterValue(columnFilters, "resnoEncCntn")));    /** column 의료비공제대상자주민등록번호 : resnoEncCntn */
			...
			if ( pagingValues.executeRecordCount ) { 
	        	...
	        	TimingInfo millisBeginQueryCount = SmrmfUtils.startTiming(logger);
	          	...
	          	int iResultCnt = ye164010DAO.selectYetaP63002ToYe164010ListTotCnt(ye164010SrhVo);  
...
//	            Collection<Map<String, Object>> list ??????
	     	List list = ye164010DAO.selectYetaP63002ToYe164010List(ye164010SrhVo);
			...
			SmrmfUtils.endTiming(logger, millisBeginYe164010DataList, "getYetaP63002ToYe164010DataList");
