...
@Service("YetaT33017Service")
public class YetaT33017ServiceImpl  extends AbstractCustomServiceImpl implements YetaT33017Service ,YetaDaoConstants {
	 
	private static final Logger logger = LoggerFactory.getLogger(YetaT33017ServiceImpl.class);
	private static final String calledClass = YetaT33017ServiceImpl.class.getName();
	...
	public Ye169010DTO getYetaP33017ToYe169010List(Ye169010DTO ye169010Dto)	throws MSFException {
		...
		Ye169010aSrh_2018_VO ye169010aSrhVo = new Ye169010aSrh_2018_VO();
		MSFSysm0100BM sessionUser;

		String method = calledClass + ".getYetaP33017ToYe169010List";

		String windowNm = "표준세액공제";
		String windowId = "YETAP33017";
		...
		try {
			...
			egovResultDataList = ye169010ADao.selectYetaP33017ToYe169010List(ye169010aSrhVo);
