...
import com.app.exterms.yearendtax.server.service.yeta2015.dao.Yeta3120DAO;
import com.app.exterms.yearendtax.server.service.yeta2015.dao.Yeta3130DAO;
import com.app.exterms.yearendtax.server.service.yeta2015.dao.Yeta3140DAO;
import com.app.exterms.yearendtax.server.service.yeta2015.dao.Yeta3150DAO;
import com.app.exterms.yearendtax.server.service.yeta2015.dao.Yeta3160DAO;
...
import com.app.exterms.yearendtax.server.service.yeta2015.dao.Yeta3190DAO;
import com.app.exterms.yearendtax.server.service.yeta2015.dao.Yeta3200DAO;
import com.app.exterms.yearendtax.server.service.yeta2015.dao.Yeta3210DAO;
import com.app.exterms.yearendtax.server.service.yeta2015.dao.Yeta3220DAO;
import com.app.exterms.yearendtax.server.service.yeta2015.dao.Yeta3300DAO;
...
* </pre>
 */
@Service("Yeta0100Service")
public class Yeta0100ServiceImpl  extends AbstractCustomServiceImpl implements Yeta0100Service  ,YetaDaoConstants {
...
//	        String method =  "getPsnl0100ToRemt0100DataList";
	        String method = CLASS_YETA0100ToYETA2000_LIST;
...
//	            Collection<Map<String, Object>> list  
	    ...
	    public  Long Payr06420_Payr400_Delete(List<Yeta2000DTO> listYeta2000Dto) throws MSFException {
	    		...
	    		String method = calledClass + ".Payr06420_Payr400_Delete";
	    		
	    		String windowNm = "연말정산대상자관리";
	    		String windowId = "YETA0100";
...
//							yeta2000Vo.setYrtxPrcsYn(yeta2000Dto.getYrtxPrcsYn());    /** column 연말정산처리여부 : yrtxPrcsYn */
	    ...
	    */
	    private  Long Payr06420_All_Delete(Yeta1000DTO yeta1000Dto) throws MSFException {
	    	...
	    	String method = calledClass + ".Payr06420_All_Delete";
...
//				yeta1000Vo.setResuNumb(yeta1000Dto.getResuNumb());    /** column 주민등록번호 : resuNumb */
				// 암호화
				yeta1000Vo.setResuNumb(AnyCryptUtils.getEncSyncCrypt(nResult,MSFSharedUtils.allowNulls(yeta1000Dto.getResuNumb()).replaceAll("-",""),AnyCryptUtils.SEC_RRNUMC));
	     ...
	     *	-----------------------------------------------------------------------
	     * 
	     * @see com.app.exterms.yearendtax.client.service.yeta2015.Yeta0100Service#Payr06420_All_Create(com.app.exterms.yearendtax.client.dto.yeta2015.Yeta1000DTO)
	     * @param yeta1000Dto
	     * @return
	     * @throws MSFException
	     */
	    ...
	    public  PagingLoadResult<ShowMessageBM> Payr06420_All_Create(Yeta1000DTO yeta1000Dto) throws MSFException {
	    	...
	    	String method = calledClass + ".Payr06420_All_Create";
	    ...
	    public  PagingLoadResult<ShowMessageBM> Payr06420_All_Add_Create(Yeta1000DTO yeta1000Dto) throws MSFException {
	    	   ...
	    	   PagingLoadResult<ShowMessageBM> retval = null;
	    		String method = calledClass + ".Payr06420_All_Add_Create";
	    ...
	    public  Long PayrExec_Yeta_Insert(List<Yeta2000DTO> listYeta2000Dto) throws MSFException {
	    		...
	    		String method = calledClass + ".PayrExec_Yeta_Insert";
	    	    ...
	    	    BeanUtilsBean.getInstance().getConvertUtils().register(false, false, 0);  
		        MSFSysm0100BM sessionUser = MSFServerUtils.getLoggedUser(RemoteServiceUtil.getThreadLocalRequest());
		        List<InfcPkgYeta2000VO> lstInfcPkgYeta2000Vo = new ArrayList<InfcPkgYeta2000VO>();  //연말정산기본  
		        try {   
...
//							yeta2000Vo.setEtadD15l(yeta2000Dto.getEtadD15l());    /** column 기타공제_본인추가공제율사용액2015하반기 : etadD15l */ 
		        	  ...
		        	  if (delCnt > 0) {
		        		     ...
		        		     YetaListenerAdapter yetaLsAdtr = new YetaListenerAdapter();
					    	//컴포넌트 호출하기 
					     	yetaLsAdtr.setPayrToYeta_Insert(RemoteServiceUtil.getThreadLocalRequest(),lstInfcPkgYeta2000Vo );  
