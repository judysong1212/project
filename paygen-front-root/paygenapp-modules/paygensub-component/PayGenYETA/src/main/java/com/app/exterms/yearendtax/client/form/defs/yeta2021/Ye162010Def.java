...
public class Ye162010Def  extends TableDef implements YetaDaoConstants {
	...
	public Ye162010Def(String chkPayrDef) {
		...
		if ("YetaP63007".equals(chkPayrDef)) {

			setDaoClass("");
			setCustomListMethod(CLASS_YETAP63007_TO_YE162010_DATA_LIST);
			setAutoFillGrid(true);
			setShowFilterToolbar(false);
			setCheckBoxOnGridRows(true);
			setColumnsDefinition(getYetaP63007ToYe162010ColumnsList());
    ...
    private List<ColumnDef> getYetaP63007ToYe162010ColumnsList(){
        row = 0;
