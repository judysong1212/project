...
import com.app.exterms.yearendtax.client.service.yeta2022.YetaP730011Service;
import com.app.exterms.yearendtax.client.service.yeta2022.YetaP730011ServiceAsync;
import com.app.exterms.yearendtax.client.service.yeta2022.YetaP73002Service;
import com.app.exterms.yearendtax.client.service.yeta2022.YetaP73002ServiceAsync;
...
=====================================================**/
public  class YetaP730011   extends MSFFormPanel {  
 ...
 **/
	...
	private  ContentPanel cpYeta730011; 
	...
	// -------------- grid 선언 시작  ---------------	  
	private MSFGridPanel yeta7300ToYe161090GridPanel01;		// 가족교육비 GridPanel (기타자료)
	private MSFGridPanel yeta7300ToYe161090GridPanel02;		// 가족교육비 GridPanel (국세청자료)
	private Ye161090Def ye161090Def_01  		= new Ye161090Def("YETA730001");
	private Ye161090Def ye161090Def_02  		= new Ye161090Def("YETA730002");
	// -------------- grid 선언 종료  ---------------	
   ...
   */
	...
	private YetaP730011ServiceAsync yetaP730011Service = YetaP730011Service.Util.getInstance();
 ...
 **/ 
	...
	// -------------- 서비스 호출 시작 --------------
	private YetaP73002ServiceAsync yetaP73002Service = YetaP73002Service.Util.getInstance();
	// -------------- 서비스 호출 종료 --------------	 	
...
//					return;
			...
			if (dataChk) {
				...
				yetaP73002Service.activityOnYetaP73002ToYe164010(listYe164010Dto, actionDatabase, new AsyncCallback<Long>(){
...
//		 }
	...
	public YetaP730011(final ActionDatabase actionDatabase, final MSFPanel caller) {
		...
		cpYeta730011 = new ContentPanel();

		createSearchForm(); 	// 기본정보 필드를 적용
//		createStandardForm(); 	// 기본정보필드
		createMsfGridForm(); 	// 그리드필드

		cpYeta730011.setBodyBorder(false);
		cpYeta730011.setBorders(false);
		cpYeta730011.setHeaderVisible(false);
		cpYeta730011.setSize("790px", "700px");

		this.add(cpYeta730011);
	...
	private void createSearchForm() {
		...
		cpYeta730011.setLayout(new FlowLayout());
...
//	      return lcFormLayer;	  
	...
	public void reload01() {
		...
		yeta7300ToYe161090GridPanel01.getTableDef().setTableColumnFilters(filters);
				
		yeta7300ToYe161090GridPanel01.getTableDef().addColumnFilter("dpobCd"		, MSFSharedUtils.allowNulls(dpobCd.getValue())		, SimpleColumnFilter.OPERATOR_EQUALS);
		yeta7300ToYe161090GridPanel01.getTableDef().addColumnFilter("systemkey"		, MSFSharedUtils.allowNulls(systemkey.getValue())	, SimpleColumnFilter.OPERATOR_EQUALS); 
		yeta7300ToYe161090GridPanel01.getTableDef().addColumnFilter("clutSeptCd"	, MSFSharedUtils.allowNulls(clutSeptCd.getValue())	, SimpleColumnFilter.OPERATOR_EQUALS); 
		yeta7300ToYe161090GridPanel01.getTableDef().addColumnFilter("yrtxBlggYr"	, MSFSharedUtils.allowNulls(yrtxBlggYr.getValue())	, SimpleColumnFilter.OPERATOR_EQUALS); 
		yeta7300ToYe161090GridPanel01.getTableDef().addColumnFilter("cdVvalKrnCd"	, MSFSharedUtils.allowNulls("Y0140001")				, SimpleColumnFilter.OPERATOR_EQUALS); 
				
		yeta7300ToYe161090GridPanel01.reload();
	...
	public void reload02() {
		...
		yeta7300ToYe161090GridPanel02.getTableDef().setTableColumnFilters(filters);
				
		yeta7300ToYe161090GridPanel02.getTableDef().addColumnFilter("dpobCd"		, MSFSharedUtils.allowNulls(dpobCd.getValue())		, SimpleColumnFilter.OPERATOR_EQUALS);
		yeta7300ToYe161090GridPanel02.getTableDef().addColumnFilter("systemkey"		, MSFSharedUtils.allowNulls(systemkey.getValue())	, SimpleColumnFilter.OPERATOR_EQUALS); 
		yeta7300ToYe161090GridPanel02.getTableDef().addColumnFilter("clutSeptCd"	, MSFSharedUtils.allowNulls(clutSeptCd.getValue())	, SimpleColumnFilter.OPERATOR_EQUALS); 
		yeta7300ToYe161090GridPanel02.getTableDef().addColumnFilter("yrtxBlggYr"	, MSFSharedUtils.allowNulls(yrtxBlggYr.getValue())	, SimpleColumnFilter.OPERATOR_EQUALS); 
		yeta7300ToYe161090GridPanel02.getTableDef().addColumnFilter("cdVvalKrnCd"	, MSFSharedUtils.allowNulls("Y0140000")				, SimpleColumnFilter.OPERATOR_EQUALS); 
				
		yeta7300ToYe161090GridPanel02.reload();
	...
	private void createMsfGridForm() {
		...
		btnYetaSave.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				...
				Iterator<Record> iterRecords = yeta7300ToYe161090GridPanel01.getMsfGrid().getGrid().getStore().getModifiedRecords().iterator(); 
...
//					// 기존데이터
//					Iterator<BaseModel> itBm  = yeta7300ToYe161090GridPanel01.getMsfGrid().getGrid().getStore().getModels().listIterator(); 
//	            	  
...
//					Iterator<BaseModel> itBm = yeta7300ToYe161090GridPanel01.getMsfGrid().getGrid().getStore().getModels().iterator(); 
//					
...
//				}
				...
				MessageBox.confirm("삭제", "선택하신 교육비 내용을 삭제하시겠습니까?",new Listener<MessageBoxEvent>(){
					...
					public void handleEvent(MessageBoxEvent be) {
						if(Dialog.YES.equals(be.getButtonClicked().getItemId())){
							...
							Iterator<BaseModel> itBm = yeta7300ToYe161090GridPanel01.getMsfGrid().getGrid().getSelectionModel().getSelectedItems().listIterator();
		...
		yeta7300ToYe161090GridPanel01 = new MSFGridPanel(ye161090Def_01, false, false, false, false, false);
		yeta7300ToYe161090GridPanel01.setHeaderVisible(false);  
		yeta7300ToYe161090GridPanel01.setBodyBorder(false);
		yeta7300ToYe161090GridPanel01.setBorders(true);
		yeta7300ToYe161090GridPanel01.getBottomComponent().setVisible(true);
		...
		yeta7300ToYe161090GridPanel01.getGrid().getColumnModel().addAggregationRow(payrSummaryRow);  
		/** --- 그리드 합계 부분  시작 --- **/		
		   
		cpGrid01.add(yeta7300ToYe161090GridPanel01); 
		...
		btnYetaSave2.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				...
				Iterator<Record> iterRecords = yeta7300ToYe161090GridPanel02.getMsfGrid().getGrid().getStore().getModifiedRecords().iterator(); 
		...
		yeta7300ToYe161090GridPanel02 = new MSFGridPanel(ye161090Def_02, false, false, false, false, false);
		yeta7300ToYe161090GridPanel02.setHeaderVisible(false);  
		yeta7300ToYe161090GridPanel02.setBodyBorder(false);
		yeta7300ToYe161090GridPanel02.setBorders(true);
		yeta7300ToYe161090GridPanel02.getBottomComponent().setVisible(true);
		...
		yeta7300ToYe161090GridPanel02.getGrid().getColumnModel().addAggregationRow(payrSummaryRow2);  
		/** --- 그리드 합계 부분  시작 --- **/		
		   
		cpGrid02.add(yeta7300ToYe161090GridPanel02); 
		...
		popBindingCom0160.addListener(Events.Change, new Listener<BaseEvent>() {
			public void handleEvent(BaseEvent be) {
				...
				if (mapModels != null) {
					...
					yetaP730011Service.saveYeta7300ToYe161090tabItem08_3(listYe161090Dto, actionDatabase, new AsyncCallback<Long>() {
