...
@Repository("Ye16Ta3130DAO")
public class Ye16Ta3130DAO extends EgovAbstractDAO implements IsSerializable {
	 ...
	 */
    @Transactional
    public void fnYeta1100_YETA3130_2016_CREATE_Delete(Yeta3130VO vo) throws Exception {
        delete("ye16Ta3130DAO.fnYeta1100_YETA3130_2016_CREATE_Delete_S", vo);
    }
    ...
    public String insertYetaP03004To3130(Yeta3130VO vo) throws Exception {
        return (String)insert("ye16Ta3130DAO.insertYeta3130_S", vo);
    }
    ...
    public void updateYetaP03004To3130(Yeta3130VO vo) throws Exception {
        update("ye16Ta3130DAO.updateYeta3130_S", vo);
    }
    ...
    public void deleteYetaP03004To3130(Yeta3130VO vo) throws Exception {
        delete("ye16Ta3130DAO.deleteYeta3130_S", vo);
    }
...
//        return list("ye16Ta3130DAO.selectYetaP03004To3130List_D", searchVO);
//    }
//
//    /**
...
//        return (Integer)getSqlMapClientTemplate().queryForObject("ye16Ta3130DAO.selectYetaP03004To3130ListTotCnt_S", searchVO);
//    }
    ...
    public List selectYetaP03005To3130List(Yeta3130SrhVO searchVO) throws Exception {
        return list("ye16Ta3130DAO.selectYetaP03005To3130List_D", searchVO);
    }
    ...
    public int selectYetaP03005To3130ListTotCnt(Yeta3130SrhVO searchVO) {
        return (Integer)getSqlMapClientTemplate().queryForObject("ye16Ta3130DAO.selectYetaP03005To3130ListTotCnt_S", searchVO);
    }
    ...
    public void fnPayr06430_PAYR452_CREATE_Delete(Yeta3130VO vo) throws Exception {
        delete("ye16Ta3130DAO.fnPayr06430_PAYR452_CREATE_Delete_S", vo);
    }
    ...
    public Yeta3130VO selectYeta3130(Yeta3130VO vo) throws Exception {
        return (Yeta3130VO) selectByPk("ye16Ta3130DAO.selectYeta3130_S", vo);
    }
    ...
    public List<?> selectYeta3130List(Yeta3130SrhVO searchVO) throws Exception {
        return list("ye16Ta3130DAO.selectYeta3130List_D", searchVO);
    }
    ...
    public int selectYeta3130ListTotCnt(Yeta3130SrhVO searchVO) {
        return (Integer)getSqlMapClientTemplate().queryForObject("ye16Ta3130DAO.selectYeta3130ListTotCnt_S", searchVO);
    }
