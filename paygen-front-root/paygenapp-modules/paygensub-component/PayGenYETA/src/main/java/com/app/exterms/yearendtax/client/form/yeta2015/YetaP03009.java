...
import com.app.exterms.yearendtax.client.form.defs.yeta2015.Yeta3210Def;
import com.app.exterms.yearendtax.client.service.yeta2015.YetaP03009Service;
import com.app.exterms.yearendtax.client.service.yeta2015.YetaP03009ServiceAsync;
...
=====================================================**/
public  class YetaP03009 extends MSFFormPanel {  
 ...
 **/
	...
	private  ContentPanel cpYeta03009; 
	...
	// -------------- grid 선언 시작  ---------------	  
	private MSFGridPanel yetaP03009GridPanel;
	private Yeta3210Def yetaP03009ToYeta03210Def  = new Yeta3210Def("YETAP03009");	//주현근무지내역 그리드 테이블 컬럼 define 
	// -------------- grid 선언 종료  ---------------
   ...
   */
	...
	// -------------- 서비스 호출 시작 --------------
	private YetaP03009ServiceAsync yetaP03009Service = YetaP03009Service.Util.getInstance();
	// -------------- 서비스 호출 종료 --------------
 ...
 **/ 
	 ...
	 **/ 		    
		 ...
		 */
//		 private void checkYetaP03009Auth( String authAction, ListStore<BaseModel>bm) {
...
//		 }
	...
	public YetaP03009(final ActionDatabase actionDatabase, final MSFPanel caller) {
...
//		initLoad(); 
		...
		cpYeta03009 = new ContentPanel();  

		createSearchForm();		//검색필드를 적용
		createMsfGridForm();	//그리드필드
		createStandardForm(); 	//기본정보필드   
		   
		cpYeta03009.setBodyBorder(false);
		cpYeta03009.setBorders(false);
		cpYeta03009.setHeaderVisible(false);
		cpYeta03009.setSize("790px", "640px");
		   
		this.add(cpYeta03009);
...
//		     });     
		...
		cpYeta03009.setLayout(new FlowLayout());
...
//				doAction(actionDatabase);
		...
		btnYetaDel.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				Iterator<BaseModel> itBm = yetaP03009GridPanel.getMsfGrid().getGrid().getSelectionModel().getSelectedItems().listIterator();
		...
		btnYetaSave.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				setListRecord(yetaP03009GridPanel.getMsfGrid().getStore().getModifiedRecords().iterator());
				doAction(actionDatabase);
...
//	      return lcFormLayer;	  
	...
	private void createMsfGridForm() {			
		...
		yetaP03009GridPanel = new MSFGridPanel(yetaP03009ToYeta03210Def, false, false, false, false);
		yetaP03009GridPanel.setHeaderVisible(false);  
		yetaP03009GridPanel.setSize("780px", "330px");
		yetaP03009GridPanel.setBorders(true);
		yetaP03009GridPanel.setHeadingText("");
		
		yetaP03009GridPanel.addListener(Events.DoubleClick, new Listener<ComponentEvent>() {

			@Override
			public void handleEvent(ComponentEvent be) {
				// TODO Auto-generated method stub
				//그리드 선택시
				yetaP03009ToYeta3210Detail(yetaP03009GridPanel.getCurrentlySelectedItem());
			}
			
		});
			
		gridFieldSet.add(yetaP03009GridPanel);
			
		cpYeta03009.add(gridFieldSet);
	}		
		
	private YetaP03009 getThis(){
	       return this;
	}
	...
	private void yetaP03009FormSave() {
		if (MSFSharedUtils.paramNotNull(records)) {

			List<Yeta3210DTO> listYeta3210dto = new ArrayList<Yeta3210DTO>();
			Yeta3210DTO yeta3210Dto = new Yeta3210DTO();
			
			if("INSERT".equals(actionDatabase)) {
				
				yeta3210Dto = new Yeta3210DTO();
				listYeta3210dto = new ArrayList<Yeta3210DTO>();
				...
				yetaP03009Service.activityOnYetaP03009ToYeta3210(listYeta3210dto, actionDatabase, new AsyncCallback<Long>(){
						public void onFailure(Throwable caught) {
							MessageBox.alert(MSFMainApp.MSFCONSTANTS.ExceptionTitleService()
									,MSFMainApp.ADMINMESSAGES.ExceptionMessageService("activityOnYetaP03009ToYeta3210("+ actionDatabase.name()+ ") : " + caught), null);
						}
	...
	/** 주현근무지 상세내역을 가져옴 **/
	private void yetaP03009ToYeta3210Detail(BaseModel selRecord) {
	...
	public void reload() {
		...
		yetaP03009GridPanel.getTableDef().setTableColumnFilters(filters);
		yetaP03009GridPanel.getTableDef().addColumnFilter("edacRvyy", MSFSharedUtils.allowNulls(srhEdacRvyy.getValue())
...
//				, SimpleColumnFilter.OPERATOR_EQUALS);//연말정산귀속년도
		yetaP03009GridPanel.getTableDef().addColumnFilter("settGbcd", MSFSharedUtils.getSelectedComboValue(srhSettGbcd,"commCd")
				, SimpleColumnFilter.OPERATOR_EQUALS);//정산구분
		yetaP03009GridPanel.getTableDef().addColumnFilter("systemkey", MSFSharedUtils.allowNulls(systemkey.getValue())
				, SimpleColumnFilter.OPERATOR_EQUALS);//시스템키
	 
		yetaP03009GridPanel.reload();
