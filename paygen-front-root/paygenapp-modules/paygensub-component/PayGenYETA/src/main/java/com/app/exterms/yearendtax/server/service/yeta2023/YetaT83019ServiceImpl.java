...
* </pre>
 */
@Service("YetaT83019Service")
public class YetaT83019ServiceImpl  extends AbstractCustomServiceImpl implements YetaT83019Service  ,YetaDaoConstants {

	 
	private static final Logger logger = LoggerFactory.getLogger(YetaT83019ServiceImpl.class);
	private static final String calledClass = YetaT83019ServiceImpl.class.getName();
	...
	@Override
	public Long activityOnYetaT83019ToYe162510(List<Ye162510DTO> listYe162510Dto, ActionDatabase actionDatabase) throws MSFException {
			...
			String method = calledClass + ".activityOnYetaT83019ToYe162510";
			
			String windowNm = "소득공제신고자료관리";
			String windowId = "YETAT83019";
...
//		            	if("0".equals(YETA4130Vo.getMnrnSqno())) {
				...
				result = iCnt;
		            ...
		            logger.error("EXCEPTION calling activityOnYetaT83019ToYe162510(): "+ ex); 
		            ...
		            result = new Long(0);
		            throw MSFServerUtils.getOperationException("activityOnYetaT83019ToYe162510", ex, logger);
		        }
		        finally {
	...
	//월세액소득공제명세 조회
	public PagingLoadResult<BaseModel> getYetaT83019ToYe162510List(ServiceParameters serviceParameters)throws MSFException {

		PagingLoadResult<BaseModel> retval = null;
		String method =  CLASS_YETAT13019TOYE162510_DATA_LIST;
		Ye162510Srh_2023_VO	ye162510Vo = new Ye162510Srh_2023_VO();
