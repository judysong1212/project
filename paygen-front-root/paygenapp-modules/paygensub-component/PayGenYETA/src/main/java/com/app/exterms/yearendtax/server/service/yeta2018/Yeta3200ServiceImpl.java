...
* </pre>
 */
@Service("Yeta3200Service")
public class Yeta3200ServiceImpl  extends AbstractCustomServiceImpl implements Yeta3200Service  ,YetaDaoConstants {

	 
	private static final Logger logger = LoggerFactory.getLogger(Yeta3200ServiceImpl.class);
	private static final String calledClass = Yeta3200ServiceImpl.class.getName();
	 ...
	 */
	//조회
	public PagingLoadResult<BaseModel> getYeta3200ToYe161010DataList(ServiceParameters serviceParameters) throws MSFException {
		

		PagingLoadResult<BaseModel> retval = null;
		String method =  CLASS_YETA3200_DATA_LIST;
...
//	     	psnl0100SrhVO.setPyspGrdeCd(MSFSharedUtils.allowNulls(MSFServerUtils.getFilterValue(columnFilters, "pyspGrdeCd"))); //호봉등급코드
			...
			if ( pagingValues.executeRecordCount ) { 
	     	...
	     	TimingInfo millisBeginYeta3100ToYe161010DataList = SmrmfUtils.startTiming(logger);
...
//	            Collection<Map<String, Object>> list ??????
			...
			SmrmfUtils.endTiming(logger, millisBeginYeta3100ToYe161010DataList, "getYeta3100ToYe161010DataList");
	 ...
	 */
	//조회
	public PagingLoadResult<BaseModel> getYeta3200ToYe161010ResultDataList(ServiceParameters serviceParameters) throws MSFException {
