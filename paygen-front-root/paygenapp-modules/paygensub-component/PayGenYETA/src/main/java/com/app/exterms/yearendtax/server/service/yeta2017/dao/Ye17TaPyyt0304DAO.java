...
@Repository("Ye17TaPyyt0304DAO")
public class Ye17TaPyyt0304DAO extends EgovAbstractDAO {
    ...
    public String insertPyyt0304(Pyyt0304VO vo) throws Exception {
        return (String)insert("ye17TaPyyt0304DAO.insertPyyt0304", vo);
    }
    ...
    public void updatePyyt0304(Pyyt0304VO vo) throws Exception {
        update("ye17TaPyyt0304DAO.updatePyyt0304", vo);
    }
    ...
    public void deletePyyt0304(Pyyt0304VO vo) throws Exception {
        delete("ye17TaPyyt0304DAO.deletePyyt0304_S", vo);
    }
...
//
    ...
    public List selectPyyt0304List(Pyyt0304SrhVO searchVO) throws Exception {
        return list("ye17TaPyyt0304DAO.selectPyyt0304List_D", searchVO);
    }
    ...
    public int selectPyyt0304ListTotCnt(Pyyt0304SrhVO searchVO) {
        return (Integer)getSqlMapClientTemplate().queryForObject("ye17TaPyyt0304DAO.selectPyyt0304ListTotCnt_S", searchVO);
    }
    ...
    public int selectPyyt0304Check(Pyyt0304SrhVO searchVO) {
        return (Integer)getSqlMapClientTemplate().queryForObject("ye17TaPyyt0304DAO.selectPyyt0304ListTotCnt", searchVO);
    }
...
//    } 
    ...
    public List<Pyyt0304VO> selectXlsYeta1900ToPyyt0304List01(Pyyt0304SrhVO   pyyt0304SrhVo ) {
        return (List<Pyyt0304VO>)list("ye17TaPyyt0304DAO.selectXlsYeta2900ToPyyt0304List01", pyyt0304SrhVo);
    }
    ...
    public List<EgovMap> selectXlsYeta1900ToPyyt0304List02(Pyyt0304SrhVO pyyt0304SrhVo) {
        return (List<EgovMap>)list("ye17TaPyyt0304DAO.selectXlsYeta2900ToPyyt0304List02", pyyt0304SrhVo);
    }
