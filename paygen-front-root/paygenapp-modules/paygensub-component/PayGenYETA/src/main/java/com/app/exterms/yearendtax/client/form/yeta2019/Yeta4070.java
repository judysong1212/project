...
import com.app.exterms.yearendtax.client.form.defs.yeta2019.Yeta4070Def;
import com.app.exterms.yearendtax.client.service.yeta2019.Yeta4070Service;
import com.app.exterms.yearendtax.client.service.yeta2019.Yeta4070ServiceAsync;
...
=====================================================**/
public class Yeta4070  extends MSFPanel { 
	...
	private FormPanel plFrmYeta4070;
	private FormData formData; 
	private String txtForm = "";
	private XTemplate detailTp;	  
	private Yeta4070ServiceAsync Yeta4070service = Yeta4070Service.Util.getInstance(); 
	...
	private Yeta4070Def Yeta4070MSDef = new Yeta4070Def("Yeta4070MS");
	private InfcPkgBass0150Def Yeta4070ToBass0150Def = new InfcPkgBass0150Def("yeta4070ToBass0150");
	private InfcPkgBass0500Def Yeta4070ToBass0500OnDef = new InfcPkgBass0500Def("YETA4070_BASS0500_ON");
	private InfcPkgBass0500Def Yeta4070ToBass0500OffDef = new InfcPkgBass0500Def("YETA4070_BASS0500_OFF");

	private MSFGridPanel msfGridPanelYeta4070MS; 
	...
	public ContentPanel getViewPanel() {
		if (panel == null) {        	
			...
			msfGridPanelYeta4070MS.reload();
			msfGridPanelBass0150.reload();

			//			final RelationDef  relBass0360 = new RelationDef(Yeta4070MSDef,false);
			//			relBass0360.addJoinDef("utDpobCd", "utDpobCd"); 
			//			relBass0360.setLinkedObject(msfGridPanelYeta4070MS);
			//			Yeta4070ToBass0500OnDef.addRelation(relBass0360); 
			//
			//			/**
			//			 * Create the relations 
			//			 */
			//			final RelationDef  relBass0350 = new RelationDef(Yeta4070MSDef,false);
			//			relBass0350.addJoinDef("utDpobCd", "utDpobCd"); 
			//			relBass0350.setLinkedObject(msfGridPanelYeta4070MS);
			//			Yeta4070ToBass0500OffDef.addRelation(relBass0350); 
			//
			//
			//			// DETAILS 
			//			final Grid Yeta4070ToBass0500OffDefGrid = msfGridPanelYeta4070MS.getMsfGrid().getGrid();
			//			Yeta4070ToBass0500OffDefGrid.addListener(Events.CellDoubleClick, new Listener<BaseEvent>() {
			//				public void handleEvent(BaseEvent be) {  
			//					if (msfGridPanelYeta4070MS.getCurrentlySelectedItem() != null) {  
			//
			//						Yeta4070ToBass0500OnDef.synchronizeGridDetail(
			//								msfGridPanelYeta4070MS.getCurrentlySelectedItem(),
			//								msfGridPanelBass0500On );
			//
			//						Yeta4070ToBass0500OffDef.synchronizeGridDetail(
			//								msfGridPanelYeta4070MS.getCurrentlySelectedItem(),
	...
	public Yeta4070(String txtForm) {
		this.txtForm = txtForm;
	}		  

	private void createSysm0500Form() {

		plFrmYeta4070 = new FormPanel();
		plFrmYeta4070.setHeadingText("PayGen Ver1.0 - 단위사업장사업관리");
		plFrmYeta4070.setIcon(Resources.APP_ICONS.text());
		plFrmYeta4070.setBodyStyleName("pad-text");
		plFrmYeta4070.setFrame(true); 
		plFrmYeta4070.setPadding(2);
		/************************************************************************
		...
		btnlogView.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				//로그 뷰화면 호출 메서드 
				funcLogMessage("단위사업장사업관리","Yeta4070");
			}
		});
		plFrmYeta4070.getHeader().setStyleAttribute("padding", "5px 0 2px 0");
		plFrmYeta4070.getHeader().addTool(btnlogView); 
		/************************************************************************
		...
		Yeta4070MSDef.setReadOnly(true);   
		msfGridPanelYeta4070MS = new MSFGridPanel(Yeta4070MSDef, false, false, false, false,false); 
		msfGridPanelYeta4070MS.setSize(350, 620);
		msfGridPanelYeta4070MS.setBorders(true);
		msfGridPanelYeta4070MS.getGrid().setBorders(true);
		Grid grid = msfGridPanelYeta4070MS.getMsfGrid().getGrid();
		grid.addListener(Events.CellDoubleClick , new Listener<BaseEvent>() {
			public void handleEvent(BaseEvent be) {

				untDpobCd = MSFSharedUtils.allowNulls(msfGridPanelYeta4070MS.getMsfGrid().getCurrentlySelectedItem().get("utDpobCd"));

				OnReload(untDpobCd);
				OffReload();
			}					
		});
		inner.add(msfGridPanelYeta4070MS);

		msfGridPanelBass0150 = new MSFGridPanel(Yeta4070ToBass0150Def, false, false, false, false, false); 
		msfGridPanelBass0150.setSize(600, 200);
		msfGridPanelBass0150.setBorders(true);
		msfGridPanelBass0150.getGrid().setBorders(true);

		// 두번째 컨테이너컬럼(사용사업정보)   
		msfGridPanelBass0500On = new MSFGridPanel(Yeta4070ToBass0500OnDef, false, false, false, false, false); 
		...
		// 세번째 컨테이너컬럼(미사용사업정보)  
		msfGridPanelBass0500Off = new MSFGridPanel(Yeta4070ToBass0500OffDef, false, false, false, false,false); 
		...
		plFrmYeta4070.add(srhOffDeptCd);
			...
			public void componentSelected(ButtonEvent ce) {  
				...
				while (iterRecords.hasNext()) {	    		            	  
					...
					if ((Boolean)bmMapModel.get("select")) {
						...
						pkgBass0500Dto.setUntDpobCd(MSFSharedUtils.allowNulls(msfGridPanelYeta4070MS.getMsfGrid().getCurrentlySelectedItem().get("utDpobCd")));
		...
		plFrmYeta4070.add(inner);

		vp.add(plFrmYeta4070);
		plFrmYeta4070.setSize("990px", "680px");
	}	

	private Yeta4070 getThis(){
		return this;
	}
