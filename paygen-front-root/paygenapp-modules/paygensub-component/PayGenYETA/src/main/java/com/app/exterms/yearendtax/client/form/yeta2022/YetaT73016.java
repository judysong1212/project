...
import com.app.exterms.yearendtax.client.service.yeta2022.YetaT73016Service;
import com.app.exterms.yearendtax.client.service.yeta2022.YetaT73016ServiceAsync;
...
//import com.app.exterms.yearendtax.client.form.defs.yeta2016.YetaT73016Def;
...
=====================================================**/
public  class YetaT73016   extends MSFFormPanel {  
 ...
 **/
	...
	private  ContentPanel cpYetaT73016; 
	...
	// -------------- grid 선언 시작  ---------------	  
	private MSFGridPanel YetaT73016GridPanel;
//	private YetaT73016Def YetaT73016Def = new YetaT73016Def("YetaT73016");   //TODO 일단 화면번호로 Def
	// -------------- grid 선언 종료  ---------------
	...
	// -------------- 서비스 호출 시작 --------------
	private YetaT73016ServiceAsync yetaT73016Service = YetaT73016Service.Util.getInstance();
	// -------------- 서비스 호출 종료 --------------	 
...
//					ye162510Dto.setMnthRnttyHusCnttArea((MSFSharedUtils.allowNulls(bmMapModel.get("mnthRnttyHusCnttArea"))));    		/** column 월세주택계약면적 : mnthRnttyHusCnttArea */
				...
				yetaT73016Service.activityOnYetaT73016(listYe162510Dto, actionDatabase, new AsyncCallback<Long>(){
...
//		 }
	...
	public YetaT73016(final ActionDatabase actionDatabase, final MSFPanel caller) {
...
//		initLoad(); 	
		...
		this.actionDatabase = actionDatabase;
	 	...
	 	cpYetaT73016 = new ContentPanel();  

		createSearchForm();			//기본정보 필드를 적용
	 	createMsfGridForm();		//그리드필드
		   
		cpYetaT73016.setBodyBorder(false);
		cpYetaT73016.setBorders(false);
		cpYetaT73016.setHeaderVisible(false);
		cpYetaT73016.setSize("790px", "640px");
		   
		this.add(cpYetaT73016);
...
//		     });     
		...
		cpYetaT73016.setLayout(new FlowLayout());
...
//	      	     }
//				 
//				YetaT73016GridPanel.getMsfGrid().clearData();
//				 
//				BaseModel bmData = YetaT73016GridPanel.getTableDef().getDefaultValues();  
//		              
...
//		         
//		        YetaT73016GridPanel.getMsfGrid().getGrid().stopEditing();      
//		        YetaT73016GridPanel.getMsfGrid().getGrid().getStore().insert(bmData,0);   
//		        YetaT73016GridPanel.getMsfGrid().getGrid().startEditing(YetaT73016GridPanel.getMsfGrid().getGrid().getStore().indexOf(bmData), 0);   
//
...
//			public void handleEvent(ButtonEvent e) {
//				Iterator<BaseModel> itBm = YetaT73016GridPanel.getMsfGrid().getGrid().getSelectionModel().getSelectedItems().listIterator();
...
//				
		...
		btnYetaSave.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				setListRecord(YetaT73016GridPanel.getMsfGrid().getStore().getModifiedRecords().iterator());
				doAction(actionDatabase);
...
//				
		cpYetaT73016.add(topYetaBtnBar);
...
//		YetaT73016GridPanel = new MSFGridPanel(YetaT73016Def, false, false, false, false, false);
//		YetaT73016GridPanel.setSize("790px", "420px");
//		YetaT73016GridPanel.setBorders(true);
//		YetaT73016GridPanel.setHeaderVisible(false);
...
//		
//		YetaT73016GridPanel.getGrid().getColumnModel().addAggregationRow(payrSummaryRow);  
//		
...
//		
//		YetaT73016GridPanel.getGrid().getColumnModel().addAggregationRow(payrSummaryRow1);
//		/** --- 그리드 합계 부분  종료 --- **/
		
//        cpYetaT73016.add(YetaT73016GridPanel);
		...
		cpYetaT73016.add(layoutContainer);
		...
		cpYetaT73016.add(layoutContainer1);
		...
		cpYetaT73016.add(layoutContainer2);
		...
		cpYetaT73016.add(layoutContainer_gibu08);
		...
		cpYetaT73016.add(fldstNewFieldset_4);
	...
	public void reload() {
			...
			YetaT73016GridPanel.getTableDef().setTableColumnFilters(filters);
			YetaT73016GridPanel.getTableDef().addColumnFilter("yrtxBlggYr", MSFSharedUtils.allowNulls(srhYrtxBlggYr.getValue())
...
//					, SimpleColumnFilter.OPERATOR_EQUALS);//연말정산귀속년도
			YetaT73016GridPanel.getTableDef().addColumnFilter("clutSeptCd", MSFSharedUtils.getSelectedComboValue(srhClutSeptCd,"commCd")
					, SimpleColumnFilter.OPERATOR_EQUALS);//정산구분
			YetaT73016GridPanel.getTableDef().addColumnFilter("systemkey", MSFSharedUtils.allowNulls(systemkey.getValue())
					, SimpleColumnFilter.OPERATOR_EQUALS);//시스템키
		 
			YetaT73016GridPanel.reload();
