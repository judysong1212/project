...
@Service("YetaP03004Service")
public class YetaP03004ServiceImpl  extends AbstractCustomServiceImpl implements YetaP03004Service  ,YetaDaoConstants {
	...
	private static final Logger logger = LoggerFactory.getLogger(YetaP03004ServiceImpl.class);
	private static final String calledClass = YetaP03004ServiceImpl.class.getName();
	...
	public Long activityOnYetaP03004ToYeta3120(List<Yeta3120DTO> listYeta3120dto, ActionDatabase actionDatabase) throws MSFException {
			...
			String windowId = "YETAP030004";
			
			// 1. 암호화 객체 생성
			String nResult = AnyCryptUtils.XecureCryptInitialize(RemoteServiceUtil.getThreadLocalConfig(),RemoteServiceUtil.getThreadLocalRequest());
			
			MSFSysm0100BM sessionUser;
			String method = calledClass + ".activityOnYetaP03004ToYeta3120";
			...
			try {  
				if (MSFSharedUtils.paramNull(yeta3120DAO)) {
					...
					yeta3120DAO = (Yeta3120DAO) wac.getBean("yeta3120DAO"); 
				}
...
//		        	} 
				...
				result = iCnt;
		            ...
		            logger.error("EXCEPTION calling activityOnYetaP03004ToYeta3120(): "+ex); 
		            
		            /** 에러 로그 **/			
		            MSFLogHistoryUtils.tracerUserExceptionActivity(sessionUser,method,calledClass,"C:U:D",ex, windowNm , windowId);
		            
		            result = new Long(0);
		            throw MSFServerUtils.getOperationException("activityOnYetaP03004ToYeta3120", ex, logger);
		        }
		        finally {
	...
	public Long activityOnYetaP03004ToYeta3160(List<Yeta3160DTO> listYeta3160dto, ActionDatabase actionDatabase) throws MSFException {
			...
			MSFSysm0100BM sessionUser;
			String method = calledClass + ".activityOnYetaP03004ToYeta3160";
			...
			try {  
				if (MSFSharedUtils.paramNull(yeta3160DAO)) {
					...
					yeta3160DAO = (Yeta3160DAO) wac.getBean("yeta3160DAO"); 
				}
...
//		            		yeta3160Vo.setRevnAddr(RemoteServiceUtil.getThreadLocalRequest().getRemoteHost());/** column 수정주소 : revnAddr */
				...
				result = iCnt;
		            ...
		            logger.error("EXCEPTION calling activityOnYetaP03004ToYeta3160(): "+ex); 
		            ...
		            result = new Long(0);
		            throw MSFServerUtils.getOperationException("activityOnYetaP03004ToYeta3160", ex, logger);
		        }
		        finally {
	...
	//금전소비대차계약 조회
	public PagingLoadResult<BaseModel> getYetaP03004To3120List(ServiceParameters serviceParameters) throws MSFException {
			

			PagingLoadResult<BaseModel> retval = null;
			String method =  CLASS_YETAP03004TOYETA3120_DATA_LIST;
...
//		            Collection<Map<String, Object>> list ??????
	...
	//임대차계약 조회
	public PagingLoadResult<BaseModel> getYetaP03004To3160List(ServiceParameters serviceParameters) throws MSFException {
			

			PagingLoadResult<BaseModel> retval = null;
			String method =  CLASS_YETAP03004TOYETA3160_DATA_LIST;
...
//		            Collection<Map<String, Object>> list ??????
				...
				SmrmfUtils.endTiming(logger, millisBeginPsnl0126DataList, "getYetaP03004To3160List");
