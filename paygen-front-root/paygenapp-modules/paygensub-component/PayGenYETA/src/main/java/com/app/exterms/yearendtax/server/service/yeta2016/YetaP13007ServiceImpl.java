...
@Service("YetaP13007Service")
public class YetaP13007ServiceImpl  extends AbstractCustomServiceImpl implements YetaP13007Service  ,YetaDaoConstants {

	 
	private static final Logger logger = LoggerFactory.getLogger(YetaP13007ServiceImpl.class);
	private static final String calledClass = YetaP13007ServiceImpl.class.getName();
	...
	//연금저축소득공제 수정 삭제부
	@Override
	public Long activityOnYetaP13007ToYeta3100(List<Ye16Ta3100DTO> listYeta3100dto, ActionDatabase actionDatabase) throws MSFException {
		...
		String method = calledClass + ".activityOnYetaP13007ToYeta3100";
		
		String windowNm = "소득공제신고자료관리";
		String windowId = "YETAP130007";
		...
		try {  
			if (MSFSharedUtils.paramNull(yeta3100DAO)) {
				...
				yeta3100DAO = (Ye16Ta3100DAO) wac.getBean("Ye16Ta3100DAO" ); 
			}
...
//		        	} 
				...
				result = iCnt;
		            ...
		            logger.error("EXCEPTION calling activityOnYetaP13007ToYeta3100(): "+ex); 
		            ...
		            result = new Long(0);
		            throw MSFServerUtils.getOperationException("activityOnYetaP13007ToYeta3100", ex, logger);
		        }
		        finally {
	...
	//연금저축소득공제 조회
	public PagingLoadResult<BaseModel> getYetaP13007To3100List(ServiceParameters serviceParameters) throws MSFException {
		

		PagingLoadResult<BaseModel> retval = null;
		String method =  CLASS_YETAP13007TOYETA3100_DATA_LIST;
...
//	            Collection<Map<String, Object>> list ??????
			...
			SmrmfUtils.endTiming(logger, millisBeginPsnl0126DataList, "getYetaP13007To3100List");
