...
import com.app.exterms.yearendtax.client.service.yeta2019.YetaT43016Service;
import com.app.exterms.yearendtax.client.service.yeta2019.YetaT43016ServiceAsync;
...
//import com.app.exterms.yearendtax.client.form.defs.yeta2016.YetaT43016Def;
...
=====================================================**/
public  class YetaT43016   extends MSFFormPanel {  
 ...
 **/
	...
	private  ContentPanel cpYetaT43016; 
	...
	// -------------- grid 선언 시작  ---------------	  
	private MSFGridPanel YetaT43016GridPanel;
//	private YetaT43016Def YetaT43016Def = new YetaT43016Def("YetaT43016");   //TODO 일단 화면번호로 Def
	// -------------- grid 선언 종료  ---------------
	...
	// -------------- 서비스 호출 시작 --------------
	private YetaT43016ServiceAsync yetaT43016Service = YetaT43016Service.Util.getInstance();
	// -------------- 서비스 호출 종료 --------------	 
...
//					ye162510Dto.setMnthRnttyHusCnttArea((MSFSharedUtils.allowNulls(bmMapModel.get("mnthRnttyHusCnttArea"))));    		/** column 월세주택계약면적 : mnthRnttyHusCnttArea */
				...
				yetaT43016Service.activityOnYetaT43016(listYe162510Dto, actionDatabase, new AsyncCallback<Long>(){
...
//		 }
	...
	public YetaT43016(final ActionDatabase actionDatabase, final MSFPanel caller) {
...
//		initLoad(); 	
		...
		this.actionDatabase = actionDatabase;
	 	...
	 	cpYetaT43016 = new ContentPanel();  

		createSearchForm();			//기본정보 필드를 적용
	 	createMsfGridForm();		//그리드필드
		   
		cpYetaT43016.setBodyBorder(false);
		cpYetaT43016.setBorders(false);
		cpYetaT43016.setHeaderVisible(false);
		cpYetaT43016.setSize("790px", "640px");
		   
		this.add(cpYetaT43016);
...
//		     });     
		...
		cpYetaT43016.setLayout(new FlowLayout());
...
//	      	     }
//				 
//				YetaT43016GridPanel.getMsfGrid().clearData();
//				 
//				BaseModel bmData = YetaT43016GridPanel.getTableDef().getDefaultValues();  
//		              
...
//		         
//		        YetaT43016GridPanel.getMsfGrid().getGrid().stopEditing();      
//		        YetaT43016GridPanel.getMsfGrid().getGrid().getStore().insert(bmData,0);   
//		        YetaT43016GridPanel.getMsfGrid().getGrid().startEditing(YetaT43016GridPanel.getMsfGrid().getGrid().getStore().indexOf(bmData), 0);   
//
...
//			public void handleEvent(ButtonEvent e) {
//				Iterator<BaseModel> itBm = YetaT43016GridPanel.getMsfGrid().getGrid().getSelectionModel().getSelectedItems().listIterator();
...
//				
		...
		btnYetaSave.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				setListRecord(YetaT43016GridPanel.getMsfGrid().getStore().getModifiedRecords().iterator());
				doAction(actionDatabase);
...
//				
		cpYetaT43016.add(topYetaBtnBar);
...
//		YetaT43016GridPanel = new MSFGridPanel(YetaT43016Def, false, false, false, false, false);
//		YetaT43016GridPanel.setSize("790px", "420px");
//		YetaT43016GridPanel.setBorders(true);
//		YetaT43016GridPanel.setHeaderVisible(false);
...
//		
//		YetaT43016GridPanel.getGrid().getColumnModel().addAggregationRow(payrSummaryRow);  
//		
...
//		
//		YetaT43016GridPanel.getGrid().getColumnModel().addAggregationRow(payrSummaryRow1);
//		/** --- 그리드 합계 부분  종료 --- **/
		
//        cpYetaT43016.add(YetaT43016GridPanel);
		...
		cpYetaT43016.add(layoutContainer);
		...
		cpYetaT43016.add(layoutContainer1);
		...
		cpYetaT43016.add(layoutContainer2);
		...
		cpYetaT43016.add(layoutContainer_gibu08);
		...
		cpYetaT43016.add(fldstNewFieldset_4);
	...
	public void reload() {
			...
			YetaT43016GridPanel.getTableDef().setTableColumnFilters(filters);
			YetaT43016GridPanel.getTableDef().addColumnFilter("yrtxBlggYr", MSFSharedUtils.allowNulls(srhYrtxBlggYr.getValue())
...
//					, SimpleColumnFilter.OPERATOR_EQUALS);//연말정산귀속년도
			YetaT43016GridPanel.getTableDef().addColumnFilter("clutSeptCd", MSFSharedUtils.getSelectedComboValue(srhClutSeptCd,"commCd")
					, SimpleColumnFilter.OPERATOR_EQUALS);//정산구분
			YetaT43016GridPanel.getTableDef().addColumnFilter("systemkey", MSFSharedUtils.allowNulls(systemkey.getValue())
					, SimpleColumnFilter.OPERATOR_EQUALS);//시스템키
		 
			YetaT43016GridPanel.reload();
