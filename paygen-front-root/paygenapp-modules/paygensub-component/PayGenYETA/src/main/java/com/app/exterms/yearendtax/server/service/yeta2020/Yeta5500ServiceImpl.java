...
* </pre>
 */
@Service("Yeta5500Service")
public class Yeta5500ServiceImpl  extends AbstractCustomServiceImpl implements Yeta5500Service  ,YetaDaoConstants {

 
	  private static final Logger logger = LoggerFactory.getLogger(Yeta5500ServiceImpl.class);
	  private static final String calledClass = Yeta5500ServiceImpl.class.getName();
	...
	//연말정산신고내역 조회
	public PagingLoadResult<BaseModel> getYeta55000List(ServiceParameters serviceParameters) throws MSFException {
		

		PagingLoadResult<BaseModel> retval = null;
		String method =  CLASS_YETA5500LIST;
		...
		ye161010DAO = (Ye161010_2020_DAO)BeanFinder.getBean("Ye161010_2020_DAO");
...
//	            Collection<Map<String, Object>> list ??????
	...
	//당월급여반영
	public Long activityOnYeta5500List(List<Ye161010DTO> listYe161010dto) throws MSFException {
		...
		try {  
			...
			logger.error("EXCEPTION calling activityOnYeta5500List(): "+ex); 
			
			/** 에러 로그 **/			
			MSFLogHistoryUtils.tracerUserExceptionActivity(sessionUser,method,calledClass,"U",ex, windowNm , windowId);
			            
			result = new Long(0);
			throw MSFServerUtils.getOperationException("activityOnYeta5500List", ex, logger);
		}
		finally {
	...
	//연말정산대상자 및 내역 수정
	public Long saveYeta5500Grid(List<Ye161010DTO> listYe161010dto) throws MSFException {
		// TODO Auto-generated method stub
		
		String method = calledClass + ".saveYeta5500Grid";
		...
		try {  
			...
			logger.error("EXCEPTION calling saveYeta5500Ye161010(): "+ex); 
			
			/** 에러 로그 **/			
			MSFLogHistoryUtils.tracerUserExceptionActivity(sessionUser,method,calledClass,"U",ex, windowNm , windowId);
			            
			result = new Long(0);
			throw MSFServerUtils.getOperationException("saveYeta5500Ye161010", ex, logger);
		}
		finally {
