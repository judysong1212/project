...
public interface YetaT53009ServiceAsync {
	
	/** 월세액소득공제명세  팝업 수정 삭제**/
	public void activityOnYetaT53009(List<Ye162510DTO> listYe162510Dto, ActionDatabase actionDatabase, AsyncCallback<Long> callback) ;
