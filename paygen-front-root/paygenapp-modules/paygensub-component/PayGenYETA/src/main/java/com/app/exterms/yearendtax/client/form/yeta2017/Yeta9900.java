...
//				fieldSet_2.add(lcSchCol2, new FormData("100%"));	
		    	...
		    	layoutContainer_1.setLayout(new HBoxLayout()); 
		     	...
		     	btnYetat13019.addListener(Events.Select, new Listener<ButtonEvent>() {
		     		public void handleEvent(ButtonEvent e) {
						  //전체내역  
						  YetaT23019 yetaT23019Form = new YetaT23019(ActionDatabase.READ, getThis());   
		    	...
		    	btnYetat13001.addListener(Events.Select, new Listener<ButtonEvent>() {
		    		public void handleEvent(ButtonEvent e) {
						  //전체내역  
						  YetaT23001 yetaT23001Form = new YetaT23001(ActionDatabase.READ, getThis());   
		    	...
		    	btnYetat13002.addListener(Events.Select, new Listener<ButtonEvent>() {
		    		public void handleEvent(ButtonEvent e) {
						  //전체내역  
						  YetaT23002 yetaT23002Form = new YetaT23002(ActionDatabase.READ, getThis());   
		    	...
		    	btnYetat13003.addListener(Events.Select, new Listener<ButtonEvent>() {
		    		public void handleEvent(ButtonEvent e) {
						  //전체내역  
						  YetaT23003 yetaT23003Form = new YetaT23003(ActionDatabase.READ, getThis());   
		    	...
		    	btnYetat13004.addListener(Events.Select, new Listener<ButtonEvent>() {
		    		public void handleEvent(ButtonEvent e) {
						  //전체내역  
						  YetaT23004 yetaT23004Form = new YetaT23004(ActionDatabase.READ, getThis());   
		    	...
		    	btnYetat13005.addListener(Events.Select, new Listener<ButtonEvent>() {
		    		public void handleEvent(ButtonEvent e) {
						  //전체내역  
						  YetaT23005 yetaT23005Form = new YetaT23005(ActionDatabase.READ, getThis());   
		    	...
		    	btnYetat13006.addListener(Events.Select, new Listener<ButtonEvent>() {
		    		public void handleEvent(ButtonEvent e) {
						  //전체내역  
						  YetaT23006 yetaT23006Form = new YetaT23006(ActionDatabase.READ, getThis());   
		    	...
		    	btnYetat13007.addListener(Events.Select, new Listener<ButtonEvent>() {
		    		public void handleEvent(ButtonEvent e) {
						  //전체내역  
						  YetaT23007 yetaT23007Form = new YetaT23007(ActionDatabase.READ, getThis());   
		    	...
		    	btnYetat13008.addListener(Events.Select, new Listener<ButtonEvent>() {
		    		public void handleEvent(ButtonEvent e) {
						  //전체내역  
						  YetaT23008 yetaT23008Form = new YetaT23008(ActionDatabase.READ, getThis());   
		    	...
		    	btnYetat13009.addListener(Events.Select, new Listener<ButtonEvent>() {
		    		public void handleEvent(ButtonEvent e) {
						  //전체내역  
						  YetaT23009 yetaT23009Form = new YetaT23009(ActionDatabase.READ, getThis());   
		    	...
		    	btnYetat13010.addListener(Events.Select, new Listener<ButtonEvent>() {
		    		public void handleEvent(ButtonEvent e) {
						  //전체내역  
						  YetaT23010 yetaT23010Form = new YetaT23010(ActionDatabase.READ, getThis());   
		    	...
		    	btnYetat13011.addListener(Events.Select, new Listener<ButtonEvent>() {
		    		public void handleEvent(ButtonEvent e) {
						  //전체내역  
						  YetaT23011 yetaT23011Form = new YetaT23011(ActionDatabase.READ, getThis());   
		    	...
		    	btnYetat13012.addListener(Events.Select, new Listener<ButtonEvent>() {
		    		public void handleEvent(ButtonEvent e) {
						  //전체내역  
						  YetaT23012 yetaT23012Form = new YetaT23012(ActionDatabase.READ, getThis());   
		    	...
		    	btnYetat13013.addListener(Events.Select, new Listener<ButtonEvent>() {
		    		public void handleEvent(ButtonEvent e) {
						  //전체내역  
						  YetaT23013 yetaT23013Form = new YetaT23013(ActionDatabase.READ, getThis());   
		    	...
		    	btnYetat13014.addListener(Events.Select, new Listener<ButtonEvent>() {
		    		public void handleEvent(ButtonEvent e) {
						  //전체내역  
						  YetaT23014 yetaT23014Form = new YetaT23014(ActionDatabase.READ, getThis());   
		    	...
		    	btnYetat13015.addListener(Events.Select, new Listener<ButtonEvent>() {
		    		public void handleEvent(ButtonEvent e) {
						  //전체내역  
						  YetaT23015 yetaT23015Form = new YetaT23015(ActionDatabase.READ, getThis());   
		    	...
		    	btnYetat13016.addListener(Events.Select, new Listener<ButtonEvent>() {
		    		public void handleEvent(ButtonEvent e) {
						  //전체내역  
						  YetaT23016 yetaT23016Form = new YetaT23016(ActionDatabase.READ, getThis());   
		    	...
		    	btnYetat13018.addListener(Events.Select, new Listener<ButtonEvent>() {
		    		public void handleEvent(ButtonEvent e) {
						  //전체내역  
						  YetaT23018 yetaT23018Form = new YetaT23018(ActionDatabase.READ, getThis());   
