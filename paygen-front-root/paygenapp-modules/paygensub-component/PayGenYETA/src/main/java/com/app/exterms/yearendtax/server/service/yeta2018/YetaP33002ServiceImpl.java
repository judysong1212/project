...
@Service("YetaP33002Service")
public class YetaP33002ServiceImpl  extends AbstractCustomServiceImpl implements YetaP33002Service  ,YetaDaoConstants {

	 
	private static final Logger logger = LoggerFactory.getLogger(YetaP33002ServiceImpl.class);
	private static final String calledClass = YetaP33002ServiceImpl.class.getName();
	...
	/** 의료비내역 신규 수정 삭제부 **/
	@Override
	public Long activityOnYetaP33002ToYe164010(List<Ye164010DTO> listYe164010Dto, ActionDatabase actionDatabase) throws MSFException {
		...
		String windowId = "YETAP330002";

		MSFSysm0100BM sessionUser;
		String method = calledClass + ".activityOnYetaP33002ToYe164010";
		...
		try { 
			...
			if (MSFSharedUtils.paramNull(ye164010DAO)) {
				...
				ye164010DAO = (Ye164010_2018_DAO) wac.getBean("Ye164010_2018_DAO");
			}
			...
			for (int iPsnlCnt = 0; iPsnlCnt < listYe164010Dto.size(); iPsnlCnt++) {
				...
				case INSERT:
					...
					ye164010DAO.insertYetaP33002ToYe164010(ye164010Vo);
					break;
					
				case UPDATE:
					ye164010DAO.updateYetaP33002ToYe164010(ye164010Vo);
					break;
					
				case DELETE:
					ye164010DAO.deleteYetaP33002ToYe164010(ye164010Vo);
					break;
				}
				iCnt = iCnt + 1;
			...
			logger.error("EXCEPTION calling activityOnYetaP33002ToYe164010(): "+ ex);
			...
			result = new Long(0);
			throw MSFServerUtils.getOperationException("activityOnYetaP33002ToYe164010", ex, logger);
	...
	/** 의료비내역 조회 **/
	public PagingLoadResult<BaseModel> getYetaP33002ToYe164010DataList(ServiceParameters serviceParameters) throws MSFException {
		

		PagingLoadResult<BaseModel> retval = null;
		String method =  CLASS_YETAP33002_TO_YE164010_DATA_LIST;
		Ye164010Srh_2018_VO   ye164010SrhVo = new Ye164010Srh_2018_VO();
...
//	      	yeta3220SrhVo.setHanNm(MSFSharedUtils.allowNulls(MSFServerUtils.getFilterValue(columnFilters, "hanNm")));    //한글성명 
			...
			if ( pagingValues.executeRecordCount ) { 
	        	...
	        	TimingInfo millisBeginQueryCount = SmrmfUtils.startTiming(logger);
	          	...
	          	int iResultCnt = ye164010DAO.selectYetaP33002ToYe164010ListTotCnt(ye164010SrhVo);  
...
//	            Collection<Map<String, Object>> list ??????
	     	List list = ye164010DAO.selectYetaP33002ToYe164010List(ye164010SrhVo);
			...
			SmrmfUtils.endTiming(logger, millisBeginYe164010DataList, "getYetaP33002ToYe164010DataList");
