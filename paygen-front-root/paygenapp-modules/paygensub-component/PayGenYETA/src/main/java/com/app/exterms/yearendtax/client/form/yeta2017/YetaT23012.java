...
import com.app.exterms.yearendtax.client.service.yeta2017.YetaT23012Service;
import com.app.exterms.yearendtax.client.service.yeta2017.YetaT23012ServiceAsync;
...
=====================================================**/
public  class YetaT23012   extends MSFFormPanel {  
 ...
 **/
	...
	private  ContentPanel cpYetaT23012; 
	...
	// -------------- grid 선언 시작  ---------------	  
	private MSFGridPanel yetaT23012GridPanel;
//	private YetaT23012Def yetaT23012Def = new YetaT23012Def("YetaT23012");   //TODO 일단 화면번호로 Def
	// -------------- grid 선언 종료  ---------------
	...
	// -------------- 서비스 호출 시작 --------------
	private YetaT23012ServiceAsync yetaT23012Service = YetaT23012Service.Util.getInstance();
	// -------------- 서비스 호출 종료 --------------	 
 ...
 *++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ 
 **/
	 private MSFDateField itemStdt01;			// 당해년도 감면기간 시작일
	 private MSFDateField itemStdt02;			// 당해년도 감면기간 종료일
	 private MSFDateField yupSnmcReStrtDt;			// 중소기업취업자 취업일 
	 private MSFDateField yupSnmcReEndDt;			// 중소기업취업자 감면기간 종료일 
	 private NumberField srhSum1; 		// 감면대상 총급여액 100%
	 private NumberField srhSum2; 		// 감면대상 총급여액 50%
	 private MSFNumberField srhSum3; 		// 감면대상 세액
...
//					ye162510Dto.setMnthRnttyHusCnttArea((MSFSharedUtils.allowNulls(bmMapModel.get("mnthRnttyHusCnttArea"))));    		/** column 월세주택계약면적 : mnthRnttyHusCnttArea */
				...
				yetaT23012Service.activityOnYetaT23012(listYe162510Dto, actionDatabase, new AsyncCallback<Long>(){
...
//		 }
	...
	public YetaT23012(final ActionDatabase actionDatabase, final MSFPanel caller) {
...
//		initLoad(); 	
		...
		this.actionDatabase = actionDatabase;
	 	...
	 	cpYetaT23012 = new ContentPanel();  

		createSearchForm();			//기본정보 필드를 적용
	 	createMsfGridForm();		//그리드필드
		   
		cpYetaT23012.setBodyBorder(false);
		cpYetaT23012.setBorders(false);
		cpYetaT23012.setHeaderVisible(false);
		cpYetaT23012.setSize("790px", "640px");
		   
		this.add(cpYetaT23012);
...
//		     });     
		...
		cpYetaT23012.setLayout(new FlowLayout());
...
//	      	     }
//				 
//				yetaT23012GridPanel.getMsfGrid().clearData();
//				 
//				BaseModel bmData = yetaT23012GridPanel.getTableDef().getDefaultValues();  
//		              
...
//		         
//		        yetaT23012GridPanel.getMsfGrid().getGrid().stopEditing();      
//		        yetaT23012GridPanel.getMsfGrid().getGrid().getStore().insert(bmData,0);   
//		        yetaT23012GridPanel.getMsfGrid().getGrid().startEditing(yetaT23012GridPanel.getMsfGrid().getGrid().getStore().indexOf(bmData), 0);   
//
...
//			public void handleEvent(ButtonEvent e) {
//				Iterator<BaseModel> itBm = yetaT23012GridPanel.getMsfGrid().getGrid().getSelectionModel().getSelectedItems().listIterator();
...
//				
		...
		btnYetaSave.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				setListRecord(yetaT23012GridPanel.getMsfGrid().getStore().getModifiedRecords().iterator());
				doAction(actionDatabase);
...
//				
		cpYetaT23012.add(topYetaBtnBar);
...
//		yetaT23012GridPanel = new MSFGridPanel(yetaT23012Def, false, false, false, false, false);
//		yetaT23012GridPanel.setSize("790px", "420px");
//		yetaT23012GridPanel.setBorders(true);
//		yetaT23012GridPanel.setHeaderVisible(false);
...
//		
//		yetaT23012GridPanel.getGrid().getColumnModel().addAggregationRow(payrSummaryRow);  
//		
...
//		
//		yetaT23012GridPanel.getGrid().getColumnModel().addAggregationRow(payrSummaryRow1);
//		/** --- 그리드 합계 부분  종료 --- **/
		
//        cpYetaT23012.add(yetaT23012GridPanel);
		
		LayoutContainer layoutContainer = new LayoutContainer();
		FieldSet fldstNewFieldset_1 = new FieldSet();
		fldstNewFieldset_1.setSize("790px", "240px");
		fldstNewFieldset_1.setHeadingHtml("중소기업취업자 세액감면");
		fldstNewFieldset_1.setCollapsible(false);
		fldstNewFieldset_1.setStyleAttribute("marginTop", "5px");
		fldstNewFieldset_1.setWidth(425);
		...
		frmlytSch1.setLabelWidth(180);
		frmlytSch1.setLabelAlign(LabelAlign.RIGHT);
		layoutContainer1.setLayout(frmlytSch1);
		layoutContainer1.setBorders(false);
//		layoutContainer1.setStyleAttribute("paddingRight", "230px");
		layoutContainer1.setStyleAttribute("marginTop", "10px");
//		layoutContainer1.setStyleAttribute("marginBottom", "5px");

		itemStdt01 = new MSFDateField();
		itemStdt01.setFieldLabel("당해년도 감면기간 시작일");
		itemStdt01.getPropertyEditor().setFormat(DateTimeFormat.getFormat(MSFMainApp.MSFCONSTANTS.DateFormat()));
		layoutContainer1.add(itemStdt01, new FormData("90%"));
		
		LayoutContainer layoutContainer2 = new LayoutContainer();
		FormLayout frmlytSch2 = new FormLayout();
		frmlytSch2 = new FormLayout();
		frmlytSch2.setLabelWidth(180);
		frmlytSch2.setLabelAlign(LabelAlign.RIGHT);
		layoutContainer2.setLayout(frmlytSch2);
		layoutContainer2.setBorders(false);
//		layoutContainer2.setStyleAttribute("paddingRight", "230px");
		layoutContainer2.setStyleAttribute("marginTop", "5px");
//		layoutContainer2.setStyleAttribute("marginBottom", "5px");

		itemStdt02 = new MSFDateField();
		itemStdt02.setFieldLabel("당해년도 감면기간 종료일");
		itemStdt02.getPropertyEditor().setFormat(DateTimeFormat.getFormat(MSFMainApp.MSFCONSTANTS.DateFormat()));
		layoutContainer2.add(itemStdt02, new FormData("90%"));

		LayoutContainer layoutContainer4 = new LayoutContainer();
		FormLayout frmlytSch3 = new FormLayout();
		frmlytSch3 = new FormLayout();
		frmlytSch3.setLabelWidth(180);
		frmlytSch3.setLabelAlign(LabelAlign.RIGHT);
		layoutContainer4.setLayout(frmlytSch3);
		layoutContainer4.setBorders(false);
//		layoutContainer4.setStyleAttribute("paddingRight", "230px");
		layoutContainer4.setStyleAttribute("marginTop", "5px");
//		layoutContainer4.setStyleAttribute("marginBottom", "5px");

		yupSnmcReStrtDt = new MSFDateField();
		yupSnmcReStrtDt.setFieldLabel("중소기업취업자 취업일");
		yupSnmcReStrtDt.getPropertyEditor().setFormat(DateTimeFormat.getFormat(MSFMainApp.MSFCONSTANTS.DateFormat()));
		layoutContainer4.add(yupSnmcReStrtDt, new FormData("90%"));
		
		LayoutContainer layoutContainer5 = new LayoutContainer();
		FormLayout frmlytSch4 = new FormLayout();
		frmlytSch4 = new FormLayout();
		frmlytSch4.setLabelWidth(180);
		frmlytSch4.setLabelAlign(LabelAlign.RIGHT);
		layoutContainer5.setLayout(frmlytSch4);
		layoutContainer5.setBorders(false);
//		layoutContainer5.setStyleAttribute("paddingRight", "230px");
		layoutContainer5.setStyleAttribute("marginTop", "5px");
//		layoutContainer5.setStyleAttribute("marginBottom", "5px");

		yupSnmcReEndDt = new MSFDateField();
		yupSnmcReEndDt.setFieldLabel("중소기업일자 감면기간 종료일");
		yupSnmcReEndDt.getPropertyEditor().setFormat(DateTimeFormat.getFormat(MSFMainApp.MSFCONSTANTS.DateFormat()));
		layoutContainer5.add(yupSnmcReEndDt, new FormData("90%"));
		
		LayoutContainer layoutContainer6 = new LayoutContainer();
		FormLayout frmlytSch5 = new FormLayout();
		frmlytSch5 = new FormLayout();
		frmlytSch5.setLabelWidth(180);
		frmlytSch5.setLabelAlign(LabelAlign.RIGHT);
		layoutContainer6.setLayout(frmlytSch5);
		layoutContainer6.setBorders(false);
//		layoutContainer6.setStyleAttribute("paddingRight", "230px");
		layoutContainer6.setStyleAttribute("marginTop", "5px");
//		layoutContainer5.setStyleAttribute("marginBottom", "5px")
		...
		srhSum1.setFieldLabel("감면대상 총급여액 100%");
		layoutContainer6.add(srhSum1, new FormData("90%"));
		
		LayoutContainer layoutContainer7 = new LayoutContainer();
		FormLayout frmlytSch6 = new FormLayout();
		frmlytSch6 = new FormLayout();
		frmlytSch6.setLabelWidth(180);
		frmlytSch6.setLabelAlign(LabelAlign.RIGHT);
		layoutContainer7.setLayout(frmlytSch6);
		layoutContainer7.setBorders(false);
//		layoutContainer7.setStyleAttribute("paddingRight", "230px");
		layoutContainer7.setStyleAttribute("marginTop", "5px");
//		layoutContainer7.setStyleAttribute("marginBottom", "5px")
		...
		srhSum2.setFieldLabel("감면대상 총급여액 50%");
		layoutContainer7.add(srhSum2, new FormData("90%"));
		
		LayoutContainer layoutContainer8_1 = new LayoutContainer();
		FormLayout frmlytSch7 = new FormLayout();
		frmlytSch7 = new FormLayout();
		frmlytSch7.setLabelWidth(180);
		frmlytSch7.setLabelAlign(LabelAlign.RIGHT);
		layoutContainer8_1.setLayout(frmlytSch7);
		layoutContainer8_1.setBorders(false);
//		layoutContainer8_1.setStyleAttribute("paddingRight", "230px");
		layoutContainer8_1.setStyleAttribute("marginTop", "5px");
//		layoutContainer7.setStyleAttribute("marginBottom", "5px")
		...
		srhSum3.setFieldLabel("감면대상 세액");
		layoutContainer8_1.add(srhSum3, new FormData("90%"));
		...
		fldstNewFieldset_4.setWidth(425);
		...
		textarea.setWidth(415);
		textarea.setReadOnly(true);
		layoutContainer3.add(textarea, new FormData("100%"));
		
		fldstNewFieldset_1.add(layoutContainer1);
		fldstNewFieldset_1.add(layoutContainer2);
		fldstNewFieldset_1.add(layoutContainer4);
		fldstNewFieldset_1.add(layoutContainer5);
		fldstNewFieldset_1.add(layoutContainer6);
		fldstNewFieldset_1.add(layoutContainer7);
		fldstNewFieldset_1.add(layoutContainer8_1);
		fldstNewFieldset_4.add(layoutContainer3);
		cpYetaT23012.add(fldstNewFieldset_1);
		cpYetaT23012.add(fldstNewFieldset_4);
	...
	public void reload() {
			...
			yetaT23012GridPanel.getTableDef().setTableColumnFilters(filters);
			yetaT23012GridPanel.getTableDef().addColumnFilter("yrtxBlggYr", MSFSharedUtils.allowNulls(srhYrtxBlggYr.getValue())
...
//					, SimpleColumnFilter.OPERATOR_EQUALS);//연말정산귀속년도
			yetaT23012GridPanel.getTableDef().addColumnFilter("clutSeptCd", MSFSharedUtils.getSelectedComboValue(srhClutSeptCd,"commCd")
					, SimpleColumnFilter.OPERATOR_EQUALS);//정산구분
			yetaT23012GridPanel.getTableDef().addColumnFilter("systemkey", MSFSharedUtils.allowNulls(systemkey.getValue())
					, SimpleColumnFilter.OPERATOR_EQUALS);//시스템키
		 
			yetaT23012GridPanel.reload();
