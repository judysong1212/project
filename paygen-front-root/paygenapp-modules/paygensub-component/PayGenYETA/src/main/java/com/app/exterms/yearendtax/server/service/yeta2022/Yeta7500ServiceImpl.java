...
* </pre>
 */
@Service("Yeta7500Service")
public class Yeta7500ServiceImpl  extends AbstractCustomServiceImpl implements Yeta7500Service  ,YetaDaoConstants {

 
	  private static final Logger logger = LoggerFactory.getLogger(Yeta7500ServiceImpl.class);
	  private static final String calledClass = Yeta7500ServiceImpl.class.getName();
	...
	//연말정산신고내역 조회
	public PagingLoadResult<BaseModel> getYeta75000List(ServiceParameters serviceParameters) throws MSFException {
		

		PagingLoadResult<BaseModel> retval = null;
		String method =  CLASS_YETA7500LIST;
...
//	            Collection<Map<String, Object>> list ??????
	...
	//당월급여반영
	public Long activityOnYeta7500List(List<Ye161010DTO> listYe161010dto) throws MSFException {
		...
		try {  
			...
			logger.error("EXCEPTION calling activityOnYeta7500List(): "+ex); 
			
			/** 에러 로그 **/			
			MSFLogHistoryUtils.tracerUserExceptionActivity(sessionUser,method,calledClass,"U",ex, windowNm , windowId);
			            
			result = new Long(0);
			throw MSFServerUtils.getOperationException("activityOnYeta7500List", ex, logger);
		}
		finally {
	...
	//2022연말정산_추가 : 급여반영취소동작
	public Long activityOnYeta7500_D_List(List<Ye161010DTO> listYe161010dto) throws MSFException {
		// TODO Auto-generated method stub
		Long result = new Long(0);
		Long iCnt = new Long(0);
		BigDecimal seqn = new BigDecimal(0);
	...
	//연말정산대상자 및 내역 수정
	public Long saveYeta7500Grid(List<Ye161010DTO> listYe161010dto) throws MSFException {
		// TODO Auto-generated method stub
		
		String method = calledClass + ".saveYeta7500Grid";
		...
		try {  
			...
			logger.error("EXCEPTION calling saveYeta7500Ye161010(): "+ex); 
			
			/** 에러 로그 **/			
			MSFLogHistoryUtils.tracerUserExceptionActivity(sessionUser,method,calledClass,"U",ex, windowNm , windowId);
			            
			result = new Long(0);
			throw MSFServerUtils.getOperationException("saveYeta7500Ye161010", ex, logger);
		}
		finally {
