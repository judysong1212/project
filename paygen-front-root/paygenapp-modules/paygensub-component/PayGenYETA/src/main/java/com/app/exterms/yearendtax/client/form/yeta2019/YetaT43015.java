...
import com.app.exterms.yearendtax.client.service.yeta2019.YetaT43015Service;
import com.app.exterms.yearendtax.client.service.yeta2019.YetaT43015ServiceAsync;
...
//import com.app.exterms.yearendtax.client.form.defs.yeta2016.YetaT43015Def;
...
=====================================================**/
public  class YetaT43015   extends MSFFormPanel {  
 ...
 **/
	...
	private  ContentPanel cpYetaT43015; 
	...
	// -------------- grid 선언 시작  ---------------	  
	private MSFGridPanel YetaT43015GridPanel;
//	private YetaT43015Def YetaT43015Def = new YetaT43015Def("YetaT43015");   //TODO 일단 화면번호로 Def
	// -------------- grid 선언 종료  ---------------
	...
	// -------------- 서비스 호출 시작 --------------
	private YetaT43015ServiceAsync yetaT43015Service = YetaT43015Service.Util.getInstance();
	// -------------- 서비스 호출 종료 --------------	 
...
//					ye162510Dto.setMnthRnttyHusCnttArea((MSFSharedUtils.allowNulls(bmMapModel.get("mnthRnttyHusCnttArea"))));    		/** column 월세주택계약면적 : mnthRnttyHusCnttArea */
				...
				yetaT43015Service.activityOnYetaT43015(listYe162510Dto, actionDatabase, new AsyncCallback<Long>(){
...
//		 }
	...
	public YetaT43015(final ActionDatabase actionDatabase, final MSFPanel caller) {
...
//		initLoad(); 	
		...
		this.actionDatabase = actionDatabase;
	 	...
	 	cpYetaT43015 = new ContentPanel();  

		createSearchForm();			//기본정보 필드를 적용
	 	createMsfGridForm();		//그리드필드
		   
		cpYetaT43015.setBodyBorder(false);
		cpYetaT43015.setBorders(false);
		cpYetaT43015.setHeaderVisible(false);
		cpYetaT43015.setSize("790px", "640px");
		   
		this.add(cpYetaT43015);
...
//		     });     
		...
		cpYetaT43015.setLayout(new FlowLayout());
...
//	      	     }
//				 
//				YetaT43015GridPanel.getMsfGrid().clearData();
//				 
//				BaseModel bmData = YetaT43015GridPanel.getTableDef().getDefaultValues();  
//		              
...
//		         
//		        YetaT43015GridPanel.getMsfGrid().getGrid().stopEditing();      
//		        YetaT43015GridPanel.getMsfGrid().getGrid().getStore().insert(bmData,0);   
//		        YetaT43015GridPanel.getMsfGrid().getGrid().startEditing(YetaT43015GridPanel.getMsfGrid().getGrid().getStore().indexOf(bmData), 0);   
//
...
//			public void handleEvent(ButtonEvent e) {
//				Iterator<BaseModel> itBm = YetaT43015GridPanel.getMsfGrid().getGrid().getSelectionModel().getSelectedItems().listIterator();
...
//			public void handleEvent(ButtonEvent e) {
//				setListRecord(YetaT43015GridPanel.getMsfGrid().getStore().getModifiedRecords().iterator());
//				doAction(actionDatabase);
//
//				if ((ActionDatabase.INSERT).equals(actionDatabase)) {
//					actionDatabase = ActionDatabase.INSERT;
...
//			topYetaBtnBar.add(btnYetaClose);
		...
		cpYetaT43015.add(topYetaBtnBar);
...
//		cpYetaT43015.add(topYetaBtnBar);
//		
//		YetaT43015GridPanel = new MSFGridPanel(YetaT43015Def, false, false, false, false, false);
//		YetaT43015GridPanel.setSize("790px", "420px");
//		YetaT43015GridPanel.setBorders(true);
//		YetaT43015GridPanel.setHeaderVisible(false);
...
//		
//		YetaT43015GridPanel.getGrid().getColumnModel().addAggregationRow(payrSummaryRow);  
//		
...
//		
//		YetaT43015GridPanel.getGrid().getColumnModel().addAggregationRow(payrSummaryRow1);
//		/** --- 그리드 합계 부분  종료 --- **/
		
 //       cpYetaT43015.add(YetaT43015GridPanel);
		FieldSet fieldSet = new FieldSet();
		...
		cpYetaT43015.add(fieldSet);
		cpYetaT43015.add(layoutContainer6);
		cpYetaT43015.add(fldstNewFieldset_1);
	...
	public void reload() {
			...
			YetaT43015GridPanel.getTableDef().setTableColumnFilters(filters);
			YetaT43015GridPanel.getTableDef().addColumnFilter("yrtxBlggYr", MSFSharedUtils.allowNulls(srhYrtxBlggYr.getValue())
...
//					, SimpleColumnFilter.OPERATOR_EQUALS);//연말정산귀속년도
			YetaT43015GridPanel.getTableDef().addColumnFilter("clutSeptCd", MSFSharedUtils.getSelectedComboValue(srhClutSeptCd,"commCd")
					, SimpleColumnFilter.OPERATOR_EQUALS);//정산구분
			YetaT43015GridPanel.getTableDef().addColumnFilter("systemkey", MSFSharedUtils.allowNulls(systemkey.getValue())
					, SimpleColumnFilter.OPERATOR_EQUALS);//시스템키
		 
			YetaT43015GridPanel.reload();
