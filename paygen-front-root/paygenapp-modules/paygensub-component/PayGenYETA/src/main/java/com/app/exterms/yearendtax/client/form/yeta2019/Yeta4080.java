...
import com.app.exterms.yearendtax.client.form.defs.yeta2019.Yeta4080Def;
...
=====================================================**/
public class Yeta4080  extends MSFPanel { 
	...
	private FormPanel plFrmYeta4080;
	private FormData formData; 
	private String txtForm = "";
	private XTemplate detailTp;	  
//	private Yeta4080ServiceAsync Yeta4080service = Yeta4080Service.Util.getInstance();
	...
	private Yeta4080Def Yeta4080Def 				= new Yeta4080Def("yeta4080ToBass0400");
//	private Yeta4080Def Yeta4080ToSysm0100OnDef 	= new Yeta4080Def("Yeta4080ToSysm0100On");
//	private Yeta4080Def Yeta4080ToSysm0100OffDef 	= new Yeta4080Def("Yeta4080ToSysm0100Off");	
	private InfcPkgSysm0100Def Yeta4080ToSysm0100OnDef 		= new InfcPkgSysm0100Def("yeta4080ToSysm0100On");
	private InfcPkgSysm0100Def Yeta4080ToSysm0100OffDef 	= new InfcPkgSysm0100Def("yeta4080ToSysm0100Off");
	
	private MSFGridPanel msfGridPanelYeta4080; 
...
//			final RelationDef  relBass0360 = new RelationDef(Yeta4080MSDef,false);
//			relBass0360.addJoinDef("dpobCd", "dpobCd"); 
//			relBass0360.addJoinDef("deptCd", "deptCd"); 
//			relBass0360.setLinkedObject(msfGridPanelYeta4080MS);
//			Yeta4080ToBass0500OnDef.addRelation(relBass0360); 
//
//			/**
//			 * Create the relations 
//			 */
//			final RelationDef  relBass0350 = new RelationDef(Yeta4080MSDef,false);
//			relBass0350.addJoinDef("dpobCd", "dpobCd"); 
//			relBass0350.addJoinDef("deptCd", "deptCd"); 
//			relBass0350.setLinkedObject(msfGridPanelYeta4080MS);
//			Yeta4080ToBass0500OffDef.addRelation(relBass0350); 
//
//
//			// DETAILS 
//			final Grid Yeta4080ToBass0500OffDefGrid = msfGridPanelYeta4080MS.getMsfGrid().getGrid();
//			Yeta4080ToBass0500OffDefGrid.addListener(Events.CellDoubleClick, new Listener<BaseEvent>() {
//				public void handleEvent(BaseEvent be) {  
//					if (msfGridPanelYeta4080MS.getCurrentlySelectedItem() != null) {  
//
//						Yeta4080ToBass0500OnDef.synchronizeGridDetail(
//								msfGridPanelYeta4080MS.getCurrentlySelectedItem(),
//								msfGridPanelBass0500On );
//
//						Yeta4080ToBass0500OffDef.synchronizeGridDetail(
//								msfGridPanelYeta4080MS.getCurrentlySelectedItem(),
...
//			});
	...
	public Yeta4080(String txtForm) {
...
//		lsDtilOccuInttnCd = PrgmComComboUtils.getSingleBass0350ComboData(sysComBass0350Dto);
		...
		plFrmYeta4080 = new FormPanel();
		plFrmYeta4080.setHeadingText("PayGen Ver1.0 - 연말정산등록담당자관리");
		plFrmYeta4080.setIcon(Resources.APP_ICONS.text());
		plFrmYeta4080.setBodyStyleName("pad-text");
		plFrmYeta4080.setFrame(true); 
		plFrmYeta4080.setPadding(2);
		/************************************************************************
		...
		btnlogView.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				 //로그 뷰화면 호출 메서드 
				  funcLogMessage("연말정산등록담당자관리","Yeta4080");
				}
			});
		plFrmYeta4080.getHeader().setStyleAttribute("padding", "5px 0 2px 0");
		plFrmYeta4080.getHeader().addTool(btnlogView); 
		/************************************************************************
		 * 화면 에러 처리시 필요한 부분으로 추가 
		 ************************************************************************/
		deptCd = new HiddenField<String>();
		deptCd.setName("deptCd");
		plFrmYeta4080.add(deptCd);
		
		HorizontalPanel inner = new HorizontalPanel();
		inner.setBorders(false);
		inner.setLayout(new FitLayout());
//		Yeta4080Def.setReadOnly(true);
		msfGridPanelYeta4080 = new MSFGridPanel(Yeta4080Def, false, false, false, true, false);
		msfGridPanelYeta4080.setSize(300, 610);
		msfGridPanelYeta4080.setBorders(true);
		msfGridPanelYeta4080.getGrid().setBorders(true);
		Grid grid = msfGridPanelYeta4080.getMsfGrid().getGrid();
		grid.addListener(Events.CellDoubleClick , new Listener<BaseEvent>() {
			public void handleEvent(BaseEvent be) {
				
				
				BaseModel bmData = msfGridPanelYeta4080.getCurrentlySelectedItem();  
		...
		msfGridPanelYeta4080.setTopComponent(lycSreach);
		inner.add(msfGridPanelYeta4080);
          
          
		// 선택된 사용자 
		msfGridPanelSysm0100On = new MSFGridPanel(Yeta4080ToSysm0100OnDef, false, false, false, false,false); 
...
//						infcPkgSysm0100Dto.setUntDpobCd(MSFSharedUtils.allowNulls(egovMap.get("untDpobCd")));    /** column 단위사업장코드 : untDpobCd */
		...
		bottomToolbar.add(refresh);
   	    ...
   	    Yeta4080ToSysm0100OffDef.setReadOnly(true);
   	    // ------------------------ 미선택된 사용자
   	    msfGridPanelSysm0100Off = new MSFGridPanel(Yeta4080ToSysm0100OffDef, false, false, false, false, false); 
...
//						infcPkgSysm0100Dto.setUntDpobCd(MSFSharedUtils.allowNulls(egovMap.get("untDpobCd")));    /** column 단위사업장코드 : untDpobCd */
		...
		plFrmYeta4080.add(inner);

		vp.add(plFrmYeta4080);
		plFrmYeta4080.setSize("990px", "680px");
	}

	private Yeta4080 getThis() {
		return this;
	}
    ...
    public void reDeptload() {
    	...
    	msfGridPanelYeta4080.getTableDef().setTableColumnFilters(filters);   
    	msfGridPanelYeta4080.getTableDef().addColumnFilter("deptNmHan", MSFSharedUtils.defaultNulls(deptNmHan.getValue(),""), SimpleColumnFilter.OPERATOR_LIKE); 
    	msfGridPanelYeta4080.reload();
