...
public class Ye161040Def  extends TableDef implements YetaDaoConstants {
	...
	public Ye161040Def(String chkPayrDef) {
		...
		// 국세청 자료
		if ("Yeta830001".equals(chkPayrDef)) {

			setDaoClass("");
			setCustomListMethod(CLASS_YETA8300_TO_YE161040_DATA_LIST);
			setAutoFillGrid(false);
			setShowFilterToolbar(false);
			setCheckBoxOnGridRows(true);
			setEditableGrid(true);
			setEditFieldGrid(true);
			setColumnsDefinition(getYeta83000ToYe161040ColumnsList01());

       // 기타자료
      }else if("Yeta830002".equals(chkPayrDef)) {
			...
			setEditableGrid(true);
			setEditFieldGrid(true);
			setColumnsDefinition(getYeta83000ToYe161040ColumnsList02());
		}

	}
     
	/** 국세청 자료 **/
	private List<ColumnDef> getYeta83000ToYe161040ColumnsList01() {
...
//        listColumnDefs.add(new ColumnDef("구분", Ye161040BM.ATTR_HEADER, ColumnDef.TYPE_STRING, 30, true, true, true));
        ...
        //2022년연말정산_추가
        //전년도,당해년도신용카드등금액 , 전년도,당해년도전통시장금액 , 상하반기대중교통금액
        listColumnDefs.add(new ColumnDef("작년합계액", Ye161040BM.ATTR_TOTCRDCPRESUM, ColumnDef.TYPE_LONG , 100, true, true, true){
        	{
        		setSelectOnFocus(true);
        	}
        });
        listColumnDefs.add(new ColumnDef("올해합계액", Ye161040BM.ATTR_TOTCRDCCURRSUM, ColumnDef.TYPE_LONG , 100, true, true, true){
        	{
        		setSelectOnFocus(true);
        	}
        });
        listColumnDefs.add(new ColumnDef("작년전통시장", Ye161040BM.ATTR_TOTTDMRPRESUM, ColumnDef.TYPE_LONG , 100, true, true, true){
        	{
        		setSelectOnFocus(true);
        	}
        });
        listColumnDefs.add(new ColumnDef("올해전통시장", Ye161040BM.ATTR_TOTTDMRCURRSUM, ColumnDef.TYPE_LONG , 100, true, true, true){
        	{
        		setSelectOnFocus(true);
        	}
        });
        listColumnDefs.add(new ColumnDef("상반기대중교통", Ye161040BM.ATTR_TFHYPBTAMT, ColumnDef.TYPE_LONG , 100, true, true, true){
        	{
        		setSelectOnFocus(true);
        	}
        });
        listColumnDefs.add(new ColumnDef("하반기대중교통", Ye161040BM.ATTR_SHFYPBTAMT, ColumnDef.TYPE_LONG , 100, true, true, true){
        	{
        		setSelectOnFocus(true);
        	}
        });
      //2022년연말정산_추가
        ...
        listColumnDefs.add(new ColumnDef("직불카드", Ye161040BM.ATTR_DRTPCARDDDCTRGTAMT, ColumnDef.TYPE_LONG , 100, true, true, true){
        	{
        		setSelectOnFocus(true);
        	}
        });
        ...
        //2022연말정산_추가
        //제로페이
        listColumnDefs.add(new ColumnDef("제로페이", Ye161040BM.ATTR_ZRTDDDCTRGTAMT, ColumnDef.TYPE_LONG , 100, true, true, true){
        	{
        		setSelectOnFocus(true);
        	}
        });
        ...
        /** column 직불카드등_전통대중제외금액 : drtpCardDdcTrgtAmt */
        listColumnDefs.add(new ColumnDef("직불카드_도서공연전통대중제외금액", Ye161040BM.ATTR_DRTPCARDDDCTRGTAMT, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{
        ...
        //2022연말정산_추가
        listColumnDefs.add(new ColumnDef("제로페이_도서공연전통대중제외금액", Ye161040BM.ATTR_ZRTDDDCTRGTAMT, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{
	...
	/** 기타 자료 **/
	private List<ColumnDef> getYeta83000ToYe161040ColumnsList02() {
