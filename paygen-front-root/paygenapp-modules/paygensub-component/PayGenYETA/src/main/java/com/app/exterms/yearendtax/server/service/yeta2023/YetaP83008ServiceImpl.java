...
@Service("YetaP83008Service")
public class YetaP83008ServiceImpl  extends AbstractCustomServiceImpl implements YetaP83008Service  ,YetaDaoConstants {

	 
	private static final Logger logger = LoggerFactory.getLogger(YetaP83008ServiceImpl.class);
	private static final String calledClass = YetaP83008ServiceImpl.class.getName();
	...
	public Long activityOnYetaP83008ToYe160403(Ye160403DTO ye160403Dto, ActionDatabase actionDatabase) throws MSFException {
		...
		String method = calledClass + ".activityOnYetaP83008ToYe160403";

		String windowNm = "소득공제신고자료관리";
		String windowId = "YETAP8300";
			
		Ye160403_2023_VO ye160403Vo = new Ye160403_2023_VO(); 
		...
		try {
			...
			if (MSFSharedUtils.paramNull(ye160403DAO)) {
				...
				ye160403DAO = (Ye160403_2023_DAO) wac.getBean("Ye160403_2023_DAO"); 
			}
			...
			ye160403DAO.updateYetaP83008ToYe160403(ye160403Vo); 
		          
		} catch (Exception ex) {
			logger.error("EXCEPTION calling activityOnYetaP83008ToYe160403(): "+ ex);
			...
			result = new Long(0);
			throw MSFServerUtils.getOperationException("activityOnYetaP83008ToYe160403", ex, logger);
	...
	public Ye160403DTO getYetaP83008ToYe160403List(Ye160403DTO ye160403Dto) throws MSFException {
		...
		Ye160403Srh_2023_VO ye160403SrhVo = new Ye160403Srh_2023_VO();
		MSFSysm0100BM sessionUser;

		String method = calledClass + ".getYetaP83008ToYe160403List";
		...
		try {
			...
			egovResultDataList = ye160403DAO.selectYetaP83008ToYe160403List(ye160403SrhVo);
