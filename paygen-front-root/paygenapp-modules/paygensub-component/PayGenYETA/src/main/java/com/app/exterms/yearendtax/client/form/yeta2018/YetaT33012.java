...
import com.app.exterms.yearendtax.client.service.yeta2018.YetaT33012Service;
import com.app.exterms.yearendtax.client.service.yeta2018.YetaT33012ServiceAsync;
...
=====================================================**/
public  class YetaT33012   extends MSFFormPanel {  
 ...
 **/
	...
	private  ContentPanel cpYetaT33012; 
	...
	// -------------- grid 선언 시작  ---------------	  
	private MSFGridPanel YetaT33012GridPanel;
//	private YetaT33012Def YetaT33012Def = new YetaT33012Def("YetaT33012");   //TODO 일단 화면번호로 Def
	// -------------- grid 선언 종료  ---------------
	...
	// -------------- 서비스 호출 시작 --------------
	private YetaT33012ServiceAsync yetaT33012Service = YetaT33012Service.Util.getInstance();
	// -------------- 서비스 호출 종료 --------------	 
...
//					ye162510Dto.setMnthRnttyHusCnttArea((MSFSharedUtils.allowNulls(bmMapModel.get("mnthRnttyHusCnttArea"))));    		/** column 월세주택계약면적 : mnthRnttyHusCnttArea */
				...
				yetaT33012Service.activityOnYetaT33012(listYe162510Dto, actionDatabase, new AsyncCallback<Long>(){
...
//		 }
	...
	public YetaT33012(final ActionDatabase actionDatabase, final MSFPanel caller) {
...
//		initLoad(); 	
		...
		this.actionDatabase = actionDatabase;
	 	...
	 	cpYetaT33012 = new ContentPanel();  

		createSearchForm();			//기본정보 필드를 적용
	 	createMsfGridForm();		//그리드필드
		   
		cpYetaT33012.setBodyBorder(false);
		cpYetaT33012.setBorders(false);
		cpYetaT33012.setHeaderVisible(false);
		cpYetaT33012.setSize("790px", "640px");
		   
		this.add(cpYetaT33012);
...
//		     });     
		...
		cpYetaT33012.setLayout(new FlowLayout());
...
//	      	     }
//				 
//				YetaT33012GridPanel.getMsfGrid().clearData();
//				 
//				BaseModel bmData = YetaT33012GridPanel.getTableDef().getDefaultValues();  
//		              
...
//		         
//		        YetaT33012GridPanel.getMsfGrid().getGrid().stopEditing();      
//		        YetaT33012GridPanel.getMsfGrid().getGrid().getStore().insert(bmData,0);   
//		        YetaT33012GridPanel.getMsfGrid().getGrid().startEditing(YetaT33012GridPanel.getMsfGrid().getGrid().getStore().indexOf(bmData), 0);   
//
...
//			public void handleEvent(ButtonEvent e) {
//				Iterator<BaseModel> itBm = YetaT33012GridPanel.getMsfGrid().getGrid().getSelectionModel().getSelectedItems().listIterator();
...
//				
		...
		btnYetaSave.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				setListRecord(YetaT33012GridPanel.getMsfGrid().getStore().getModifiedRecords().iterator());
				doAction(actionDatabase);
...
//				
		cpYetaT33012.add(topYetaBtnBar);
...
//		YetaT33012GridPanel = new MSFGridPanel(YetaT33012Def, false, false, false, false, false);
//		YetaT33012GridPanel.setSize("790px", "420px");
//		YetaT33012GridPanel.setBorders(true);
//		YetaT33012GridPanel.setHeaderVisible(false);
...
//		
//		YetaT33012GridPanel.getGrid().getColumnModel().addAggregationRow(payrSummaryRow);  
//		
...
//		
//		YetaT33012GridPanel.getGrid().getColumnModel().addAggregationRow(payrSummaryRow1);
//		/** --- 그리드 합계 부분  종료 --- **/
		
//        cpYetaT33012.add(YetaT33012GridPanel);
...
//		layoutContainer7.setStyleAttribute("marginBottom", "5px")
		...
		cpYetaT33012.add(fldstNewFieldset_1);
		cpYetaT33012.add(fldstNewFieldset_4);
	...
	public void reload() {
			...
			YetaT33012GridPanel.getTableDef().setTableColumnFilters(filters);
			YetaT33012GridPanel.getTableDef().addColumnFilter("yrtxBlggYr", MSFSharedUtils.allowNulls(srhYrtxBlggYr.getValue())
...
//					, SimpleColumnFilter.OPERATOR_EQUALS);//연말정산귀속년도
			YetaT33012GridPanel.getTableDef().addColumnFilter("clutSeptCd", MSFSharedUtils.getSelectedComboValue(srhClutSeptCd,"commCd")
					, SimpleColumnFilter.OPERATOR_EQUALS);//정산구분
			YetaT33012GridPanel.getTableDef().addColumnFilter("systemkey", MSFSharedUtils.allowNulls(systemkey.getValue())
					, SimpleColumnFilter.OPERATOR_EQUALS);//시스템키
		 
			YetaT33012GridPanel.reload();
