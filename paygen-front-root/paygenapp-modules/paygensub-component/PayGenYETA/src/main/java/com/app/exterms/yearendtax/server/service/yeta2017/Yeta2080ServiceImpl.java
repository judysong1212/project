...
import com.app.exterms.yearendtax.client.service.yeta2017.Yeta2080Service;
import com.app.exterms.yearendtax.server.service.yeta2017.dao.Yeta2080DAO;
...
@Service("Yeta2080Service")
public class Yeta2080ServiceImpl extends AbstractCustomServiceImpl implements YetaDaoConstantsGenerated, Yeta2080Service {

	private static final Logger logger = LoggerFactory.getLogger(Yeta2080ServiceImpl.class);
	private static final String calledClass = Yeta2080ServiceImpl.class.getName();

	@Autowired
	@Resource(name = "Yeta2080DAO")
	private Yeta2080DAO yeta2080DAO;
	...
	public PagingLoadResult<BaseModel> getSelectYeta2080ToBass0400List(ServiceParameters serviceParameters) throws MSFException {

        PagingLoadResult<BaseModel> retval = null;
        String method =  CLASS_YETA2080_TO_BASS0400_LIST;
        Yeta2080SrhVO   yeta2080SrhVo = new Yeta2080SrhVO();
        //Yeta2080VO      Yeta2080Vo = new Yeta2080VO();
        List<BaseModel>  bmResult = new ArrayList<BaseModel>();
        MSFSysm0100BM sessionUser = MSFServerUtils.getLoggedUser(RemoteServiceUtil.getThreadLocalRequest());
        
        if(MSFSharedUtils.paramNull(yeta2080DAO)){
        	WebApplicationContext wac = WebApplicationContextUtils.getRequiredWebApplicationContext(getHttpServletRequest().getSession().getServletContext());
        	yeta2080DAO = (Yeta2080DAO) wac.getBean("Yeta2080DAO");
        }
        ...
        try{
            ...
            if(pagingValues.executeRecordCount){ 
            	...
            	int iResultCnt = yeta2080DAO.selectYeta2080ListTotCnt(yeta2080SrhVo);
            ...
            List list = yeta2080DAO.selectYeta2080List(yeta2080SrhVo);
            ...
            SmrmfUtils.endTiming(logger, millisBeginSelectYeta2080List, "selectYeta2080List");
