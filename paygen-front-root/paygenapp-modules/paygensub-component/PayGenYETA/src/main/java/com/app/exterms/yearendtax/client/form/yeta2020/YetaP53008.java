...
import com.app.exterms.yearendtax.client.service.yeta2020.YetaP53008ServiceAsync;
...
=====================================================**/
public  class YetaP53008   extends MSFFormPanel { 
 ...
 **/
   ...
   */
	...
	// -------------- 서비스 호출 시작 --------------
	private YetaP53008ServiceAsync yetaP53008Service = YetaP53008Service.Util.getInstance();
	// -------------- 서비스 호출 종료 --------------
 ...
 **/	  
	...
	public YetaP53008(final ActionDatabase actionDatabase, final MSFPanel caller) {
	...
	public YetaP53008(final ActionDatabase actionDatabase, final MSFFormPanel caller2) {
...
//		lcSchCenter2_1.add(taxmSt10Bi, new FormData("100%"));
	...
	private void YetaP53008FormSave() {  
...
//		ye160403Dto.setTaxmSy21Bi((Long)taxmSy21Bi.getValue());    /** column 비과세소득_Y21_비과세 : taxmSy21Bi */
		...
		yetaP53008Service.activityOnYetaP53008ToYe160403(ye160403Dto, actionDatabase, new AsyncCallback<Long>(){
					public void onFailure(Throwable caught) {
						MessageBox.alert(MSFMainApp.MSFCONSTANTS.ExceptionTitleService(), 
	                              MSFMainApp.ADMINMESSAGES.ExceptionMessageService("activityOnYetaP53008ToYe160403(" + actionDatabase.name() + ") : " + caught), null);
					}
	...
	public void reload() {
		...
		yetaP53008Service.getYetaP53008ToYe160403List(ye160403Dto, new AsyncCallback<Ye160403DTO>(){

			@Override
			public void onFailure(Throwable caught) {
				// TODO Auto-generated method stub
				MessageBox.alert(MSFMainApp.MSFCONSTANTS.ExceptionTitleService(), 
                        MSFMainApp.ADMINMESSAGES.ExceptionMessageService("getYetaP53008ToYe160403List(" + actionDatabase.name() + ") : " + caught), null);
	...
	/** 비과세 및 감면소득 조회부 **/
	public void readYetaP53008Data(Ye160403DTO result) {
