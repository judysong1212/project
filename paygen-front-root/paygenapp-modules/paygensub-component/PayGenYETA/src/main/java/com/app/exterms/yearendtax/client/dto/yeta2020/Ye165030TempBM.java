...
/**
 * @Class Name : Ye165030TempBM.java
 * @since : 2017. 12. 12. 
 * @version : 2.2.0
 * @author : DaEun
 *
 ...
 */
public class Ye165030TempBM   extends MSFSimpleBaseModel implements IsSerializable  {
    ...
    /** 생성자 */
     public Ye165030TempBM() { super(); } 

    /** 일괄등록 처리   */
     public Ye165030TempBM(
    		 String  dpobCd 
    		, String  yrtxBlggYr 
    		, String  clutSeptCd 
    		, String  systemkey 
