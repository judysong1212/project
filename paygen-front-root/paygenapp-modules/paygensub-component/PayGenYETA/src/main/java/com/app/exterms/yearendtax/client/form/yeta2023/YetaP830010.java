...
import com.app.exterms.yearendtax.client.service.yeta2023.YetaP830010ServiceAsync;
...
=====================================================**/
public  class YetaP830010   extends MSFFormPanel { 
 ...
 **/
	...
	private ContentPanel cpYeta830010;
   ...
   */
	...
	// -------------- 서비스 호출 시작 --------------
	private YetaP830010ServiceAsync yetaP830010Service = YetaP830010Service.Util.getInstance();
	// -------------- 서비스 호출 종료 --------------
 ...
 **/	  
	...
	public YetaP830010(final ActionDatabase actionDatabase, final MSFFormPanel caller) {
		...
		cpYeta830010 = new ContentPanel();

		createStandardForm();
		setReadOnlyFalseYetaP13008();

		cpYeta830010.setBodyBorder(false);
		cpYeta830010.setBorders(false);
		cpYeta830010.setHeaderVisible(false);
		cpYeta830010.setSize("790px", "720px");

		this.add(cpYeta830010);
	...
	private void createStandardForm() {
		...
		cpYeta830010.add(whdgDebrBusoprRgstnum);
		
		
		deptNm = new HiddenField<String>();
		deptNm.setName("deptNm");
		cpYeta830010.add(deptNm);
		
		hanNm = new HiddenField<String>();
		hanNm.setName("hanNm");
		cpYeta830010.add(hanNm);
...
//				}
		...
		cpYeta830010.add(topYetaBtnBar);
...
//		lcSchCenter2_1.add(taxmSt10Jong, new FormData("100%"));
	...
	private void YetaP830010FormSave() {  
...
//		ye160405Dto.setTaxmSy21Jong((Long)taxmSy21Jong.getValue());    /** column 비과세소득_Y21_비과세 : taxmSy21Jong */
		...
		yetaP830010Service.activityOnYetaP830010ToYe160405(ye160405Dto, actionDatabase, new AsyncCallback<Integer>(){
					public void onFailure(Throwable caught) {
						MessageBox.alert(MSFMainApp.MSFCONSTANTS.ExceptionTitleService(), 
	                              MSFMainApp.ADMINMESSAGES.ExceptionMessageService("activityOnYetaP830010ToYe160405(" + actionDatabase.name() + ") : " + caught), null);
					}
	...
	public void reload() {
		...
		yetaP830010Service.getYetaP830010ToYe160405List(ye160405Dto, new AsyncCallback<Ye160405DTO>(){
	...
	/** 비과세 및 감면소득 조회부 **/
	public void readYetaP830010Data(Ye160405DTO result) {
