...
* </pre>	
 */
@Service("YetaP410002Service")
public class YetaP410002ServiceImpl  extends AbstractCustomServiceImpl implements YetaP410002Service  ,YetaDaoConstants {

	private static final Logger logger = LoggerFactory.getLogger(YetaP410002ServiceImpl.class);
	private static final String calledClass = YetaP410002ServiceImpl.class.getName();
	 ...
	 * @throws MSFException
	 */
	public PagingLoadResult<BaseModel> getYetaP410002ToYe161010List(ServiceParameters serviceParameters) throws MSFException {

		PagingLoadResult<BaseModel> retval = null;
		// String method = "getPsnl0100ToRemt0100DataList";
		String method = CLASS_YETAP410002ToYE161010_LIST;
	           ...
	           /******************************** 권한 ************************************************************************/ 
	            ...
	            //Get total record count //전체 데이터 갯수를 가지고 온다. 
	             if ( pagingValues.executeRecordCount ) { 
	                ...
	                int iResultCnt = ye161010DAO.selectYetaP410002ToYe161010ListTotCnt(ye161010SrhVo);
...
//	            Collection<Map<String, Object>> list  
	            List list =  ye161010DAO.selectYetaP410002ToYe161010List(ye161010SrhVo);
	 ...
	 */
	@Override
	public int saveYetaP410002ToYeta161005(Ye161005DTO ye161005Dto, ActionDatabase actionDatabase) throws MSFException {
	    	
		String method = calledClass + ".saveYetaP410002ToYeta161005";
		...
		try { 
			...
			Ye161005_2019_VO ye16Ta161005Vo = new Ye161005_2019_VO(); 
...
//    			}
    			...
    			break;
        	case UPDATE: 
        		ye161005DAO.updateYetaP410002ToYe161005(ye16Ta161005Vo);
        		retInt = 1;
        		break;
        	case DELETE: 
//        		ye16Ta161005DAO.deleteYe161005(ye16Ta161005Vo);
	 ...
	 */
	@Override
	public int saveYetaP410002ToYe161010(List<Ye161010DTO> lsYe161010Dto) throws MSFException {
	    	
		String method = calledClass + ".saveYetaP410002ToYe161010";
...
//		System.out.println("삭제자 : " + sessionUser.getDeptNm() + "["+ sessionUser.getUsrNm() + "]");
		...
		try { 
			...
			for(int i = 0; i < lsYe161010Dto.size(); i ++) {
				...
				ye161010Vo = new Ye161010_2019_VO();
				...
				ye161010DAO.updateYetaP410002ToYe161010(ye161010Vo);
				...
				ye161020DAO.updateYetaP410002ToYe161020(ye161020Vo);
			...
			logger.error("EXCEPTION calling saveYetaP410002ToYe161010(): "+ex); 
		            
			/** 에러 로그 **/			
			MSFLogHistoryUtils.tracerUserExceptionActivity(sessionUser,method,calledClass,"D", ex, windowNm , windowId);
		            
			retval = 0;
			throw MSFServerUtils.getOperationException("saveYetaP410002ToYe161010", ex, logger);
		} 
	...
	public Ye161005DTO getYe161005Data(Ye161005DTO ye161005Dto) throws MSFException {
		...
		Ye161005Srh_2019_VO ye161005SrhVo = new Ye161005Srh_2019_VO();
		Ye161005_2019_VO ye161005Vo = new Ye161005_2019_VO();
		
		try { 
			
			ye161005SrhVo = new Ye161005Srh_2019_VO();
			...
			ye161005Vo = ye161005DAO.selectYetaP410002ToYe161005(ye161005SrhVo);
