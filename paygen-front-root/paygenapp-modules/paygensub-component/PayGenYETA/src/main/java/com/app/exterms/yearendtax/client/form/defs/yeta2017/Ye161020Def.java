...
//    private PayrConstants PayrLabel = PayrConstants.INSTANCE;
	...
	public Ye161020Def(String chkPayrDef) {
		...
		}else if ("YetaP210002".equals(chkPayrDef)) {
			// setTitle(PayrLabel.titlePayr0304());
			setDaoClass("");
			setCustomListMethod(CLASS_YETAP210002ToYE161010_LIST);
			setAutoFillGrid(false);
			setShowFilterToolbar(false);
			setCheckBoxOnGridRows(false);
			setColumnsDefinition(getYetaP210002ToYe161020ColumnsList());
	...
	private List<ColumnDef> getYetaP210002ToYe161020ColumnsList() {
