...
=====================================================**/
public  class YetaT73017   extends MSFFormPanel {  
	...
	private  ContentPanel cpYetaT73017; 
	...
	// -------------- grid 선언 시작  ---------------	  
	private MSFGridPanel YetaT73017GridPanel;
	//	private YetaT73017Def YetaT73017Def = new YetaT73017Def("YetaT73017");   //TODO 일단 화면번호로 Def
	// -------------- grid 선언 종료  ---------------
	...
	public YetaT73017(final ActionDatabase actionDatabase, final MSFPanel caller) {
		...
		cpYetaT73017 = new ContentPanel();  

		createSearchForm();			//기본정보 필드를 적용
		createMsfGridForm();		//그리드필드
		setReadOnlyTrueYetaP23017();

		cpYetaT73017.setBodyBorder(false);
		cpYetaT73017.setBorders(false);
		cpYetaT73017.setHeaderVisible(false);
		cpYetaT73017.setSize("630px", "640px");

		this.add(cpYetaT73017);
	...
	private void createMsfGridForm() {
		...
		cpYetaT73017.add(layoutContainer1);
		cpYetaT73017.add(layoutContainer2);
		cpYetaT73017.add(layoutContainer3);
		cpYetaT73017.add(layoutContainer4);
		cpYetaT73017.add(layoutContainer5);
		cpYetaT73017.add(layoutContainer6);
		cpYetaT73017.add(layoutContainer7);
		cpYetaT73017.add(layoutContainer8);
		cpYetaT73017.add(layoutContainer9);
	}	
