...
import com.app.exterms.yearendtax.client.dto.yeta2019.Ye162010DTO;
import com.app.exterms.yearendtax.client.service.yeta2019.YetaP43007Service;
...
import com.app.exterms.yearendtax.server.vo.Ye162010Srh_2019_VO;
...
@Service("YetaP43007Service")
public class YetaP43007ServiceImpl  extends AbstractCustomServiceImpl implements YetaP43007Service  ,YetaDaoConstants {

	 
	private static final Logger logger = LoggerFactory.getLogger(YetaP43007ServiceImpl.class);
	private static final String calledClass = YetaP43007ServiceImpl.class.getName();
	
	@Autowired
	@Resource(name = "Ye162010_2019_DAO")
	private Ye162010_2019_DAO ye162010DAO;
	
	@Autowired
	@Resource(name = "Ye162020_2019_DAO")
	private Ye162020_2019_DAO ye162020DAO;
	
	@Autowired
	@Resource(name = "Ye162030_2019_DAO")
	private Ye162030_2019_DAO ye162030DAO;
	
	@Autowired
	@Resource(name = "Ye162040_2019_DAO")
	private Ye162040_2019_DAO ye162040DAO;
	
	/** 연금저축소득공제 등록 팝업 수정 및 삭제 **/
	@Override
	public Long activityOnYetaP43007ToYe162010(List<Ye162010DTO> listYe162010Dto, ActionDatabase actionDatabase) throws MSFException {
		...
		String method = calledClass + ".activityOnYetaP43007ToYe162010";
		
		String windowNm = "소득공제신고자료관리";
		String windowId = "YETAP430007";
		
		
		Ye162010DTO ye162010Dto = new Ye162010DTO();  
		Ye162010_2019_VO ye162010Vo = new Ye162010_2019_VO();  
		Ye162020_2019_VO ye162020Vo = new Ye162020_2019_VO();  
		Ye162030_2019_VO ye162030Vo = new Ye162030_2019_VO();  
		Ye162040_2019_VO ye162040Vo = new Ye162040_2019_VO();  
		...
		try { 
			...
			if (MSFSharedUtils.paramNull(ye162010DAO)) {
				...
				ye162010DAO = (Ye162010_2019_DAO) wac.getBean("Ye162010_2019_DAO" ); 
			}
			
			if (MSFSharedUtils.paramNull(ye162020DAO)) {
				WebApplicationContext wac = WebApplicationContextUtils.getRequiredWebApplicationContext( getHttpServletRequest().getSession().getServletContext());
				
				ye162020DAO = (Ye162020_2019_DAO) wac.getBean("Ye162020_2019_DAO" ); 
			}
			
			if (MSFSharedUtils.paramNull(ye162030DAO)) {
				WebApplicationContext wac = WebApplicationContextUtils.getRequiredWebApplicationContext( getHttpServletRequest().getSession().getServletContext());
				
				ye162030DAO = (Ye162030_2019_DAO) wac.getBean("Ye162030_2019_DAO" ); 
			}
			
			if (MSFSharedUtils.paramNull(ye162040DAO)) {
				WebApplicationContext wac = WebApplicationContextUtils.getRequiredWebApplicationContext( getHttpServletRequest().getSession().getServletContext());
				
				ye162040DAO = (Ye162040_2019_DAO) wac.getBean("Ye162040_2019_DAO" ); 
			}
			...
			for(int iPsnlCnt=0;iPsnlCnt < listYe162010Dto.size();iPsnlCnt++) {
				...
				ye162010Vo = new   Ye162010_2019_VO();  
        		...
        		case INSERT:
        			if (ye162010Vo.getPnsnSvngAccPnsnSvngCl().equals("Y0040010")||ye162010Vo.getPnsnSvngAccPnsnSvngCl().equals("Y0040020")) {
            			...
            			ye162010DAO.insertYetaP43007ToYe162010(ye162010Vo); 
        			}
            	...
            	case UPDATE:
            		...
            		if (ye162010Vo.getPnsnSvngAccPnsnSvngCl().equals("Y0040010")||ye162010Vo.getPnsnSvngAccPnsnSvngCl().equals("Y0040020")) {
            			...
            			ye162010DAO.updateYetaP43007ToYe162010(ye162010Vo);
            		}
            	...
            	case DELETE: 
            		if (ye162010Vo.getPnsnSvngAccPnsnSvngCl().equals("Y0040010")||ye162010Vo.getPnsnSvngAccPnsnSvngCl().equals("Y0040020")) {
            			...
            			ye162030DAO.deleteYe162030(ye162030Vo);
            			 ...
            			 ye162010DAO.deleteYetaP43007ToYe162010(ye162010Vo); 
            		}
		...
		result = iCnt;
			...
			logger.error("EXCEPTION calling activityOnYetaP43007ToYe162010(): "+ex); 
			...
			result = new Long(0);
			throw MSFServerUtils.getOperationException("activityOnYetaP43007ToYe162010", ex, logger);
	...
	/** 연금저축소득공제 조회 **/
	public PagingLoadResult<BaseModel> getYeta4300ToYe162010DataList(ServiceParameters serviceParameters) throws MSFException {
		

		PagingLoadResult<BaseModel> retval = null;
		String method =  CLASS_YETAP43007_TO_YE162010_DATA_LIST;
		Ye162010Srh_2019_VO   ye162010SrhVo = new Ye162010Srh_2019_VO();
...
//	    	ye162010SrhVo.setPnsnSvngAccAccno(MSFSharedUtils.allowNulls(MSFServerUtils.getFilterValue(columnFilters, "pnsnSvngAccAccno"))));    /** column 계좌번호_증권번호 : pnsnSvngAccAccno */
			...
			if ( pagingValues.executeRecordCount ) { 
	        	...
	        	TimingInfo millisBeginQueryCount = SmrmfUtils.startTiming(logger);
	          	...
	          	int iResultCnt = ye162010DAO.selectYetaP43007ToYe162010ListTotCnt(ye162010SrhVo);  
...
//	            Collection<Map<String, Object>> list ??????
	     	List list = ye162010DAO.selectYetaP43007ToYe162010List(ye162010SrhVo);
			...
			SmrmfUtils.endTiming(logger, millisBeginPsnl0126DataList, "getYetaP43007ToYe162010List");
