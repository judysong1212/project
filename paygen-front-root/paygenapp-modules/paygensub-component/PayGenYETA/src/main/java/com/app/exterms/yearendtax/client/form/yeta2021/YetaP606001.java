 ...
 * =====================================================
 **/
public class YetaP606001 extends MSFFormPanel {
	...
	private ContentPanel cpYetaP606001;

	// -------------- grid 선언 시작 ---------------
	private MSFGridPanel YetaP606001_01GridPanel;
	private MSFGridPanel YetaP606001_02GridPanel;

	private Yeta6060Def Yeta606001MtDef = new Yeta6060Def("Yeta606001_Mt");
	private Yeta6060Def Yeta606001StDef = new Yeta6060Def("Yeta606001_St");
	// -------------- grid 선언 종료 ---------------
	...
	//	private YetaP2060ServiceAsync YetaP606001Service = YetaP606001Service.Util.getInstance();
	 ...
	 * ++++++++++++++
	 **/
	public YetaP606001(final ActionDatabase actionDatabase,	final MSFPanel caller) {
		...
		cpYetaP606001 = new ContentPanel();

		createGridForm();

		mReload();
		cpYetaP606001.setBodyBorder(false);
		cpYetaP606001.setBorders(false);
		cpYetaP606001.setHeaderVisible(false);
		cpYetaP606001.setSize("790px", "640px");

		this.add(cpYetaP606001);
	...
	private void createGridForm() {
		...
		YetaP606001_01GridPanel = new MSFGridPanel(Yeta606001MtDef, false, false, false, false, false);
		YetaP606001_01GridPanel.setHeaderVisible(false);
		YetaP606001_01GridPanel.setSize(305, 570);
		YetaP606001_01GridPanel.setBorders(true);

		final Grid Yeta206001MGrid = YetaP606001_01GridPanel.getMsfGrid().getGrid();
		Yeta206001MGrid.addListener(Events.RowDoubleClick, new Listener<BaseEvent>() {
			public void handleEvent(BaseEvent be) {  
				if (YetaP606001_01GridPanel.getCurrentlySelectedItem() != null) { 
					BaseModel bmData = YetaP606001_01GridPanel.getCurrentlySelectedItem();
					sReload(bmData);
				}
			}
		}); 	

		fieldMtSet.add(YetaP606001_01GridPanel);
		...
		YetaP606001_02GridPanel = new MSFGridPanel(Yeta606001StDef, false, false, false, false, false);
		YetaP606001_02GridPanel.setHeaderVisible(false);
		YetaP606001_02GridPanel.setSize(460, 570);
		YetaP606001_02GridPanel.setBorders(true);
		
		fieldStSet.add(YetaP606001_02GridPanel);
		...
		btnBassSave.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				if (YetaP606001_02GridPanel.getCurrentlySelectedItem() == null) { 
		...
		cpYetaP606001.add(layoutContainer1, new FormData("100%"));
		cpYetaP606001.add(btnBar, new FormData("100%"));
	...
	public void mReload() {
		...
		YetaP606001_01GridPanel.getTableDef().setTableColumnFilters(filters);
		YetaP606001_01GridPanel.reload();
	...
	public void sReload(BaseModel bmData) {
		...
		YetaP606001_02GridPanel.getTableDef().setTableColumnFilters(filters);
		YetaP606001_02GridPanel.getTableDef().addColumnFilter("utDpobCd",MSFSharedUtils.allowNulls(bmData.get("utDpobCd")), SimpleColumnFilter.OPERATOR_LIKE);
		YetaP606001_02GridPanel.reload();
							...
							MessageBox.confirm("종사업장 등록", "선택된 사업장의 사업자번호가 주 사업자 번호로 변경됩니다.<br> 진행 하시겠습니까?",new Listener<MessageBoxEvent>(){
								...
								public void handleEvent(MessageBoxEvent be) {
									if(Dialog.YES.equals(be.getButtonClicked().getItemId())){
										BaseModel bmData = YetaP606001_01GridPanel.getCurrentlySelectedItem();
										Yeta6060DTO dto = new Yeta6060DTO();
										...
										yeta6060Service.insertYetaS606001(dto, actionDatabase, new AsyncCallback<Integer>() {
											@Override
											public void onSuccess(Integer result) {	
												...
												//상세정보 초기화
												YetaP606001_01GridPanel.reload();
												YetaP606001_02GridPanel.getMsfGrid().clearData();
											}
		...
		MessageBox.confirm("사업장 삭제", "선택된 사업장을 삭제 하시겠습니까?<br>",new Listener<MessageBoxEvent>(){
			...
			public void handleEvent(MessageBoxEvent be) {
				if(Dialog.YES.equals(be.getButtonClicked().getItemId())){
					...
					Iterator<BaseModel> itBm = YetaP606001_02GridPanel.getMsfGrid().getGrid().getSelectionModel().getSelectedItems().listIterator(); 
					List<Record>  lsRec  = new ArrayList<Record>();
					List<Yeta6060DTO> listYeta6060Dto = new ArrayList<Yeta6060DTO>();       
					...
					if (MSFSharedUtils.paramNotNull(records)) {   
						...
						while (records.hasNext()) {
							...
							listYeta6060Dto.add(dto);
						}
					}   


					if(listYeta6060Dto.size() <= 0 ) {
						MessageBox.info("경고", "삭제할 사업장을 선택해 주세요.", null);
						return;
					}

					yeta6060Service.Yeta606001_Delete(listYeta6060Dto, actionDatabase, new AsyncCallback<Long>() {
						@Override
			...
			MessageBox.confirm("주사업자 수정", "선택된 사업장의 일련번호를 변경합니다.<br> 진행 하시겠습니까?",new Listener<MessageBoxEvent>(){
				...
				public void handleEvent(MessageBoxEvent be) {
					if(Dialog.YES.equals(be.getButtonClicked().getItemId())){
						...
						BaseModel bmData1 = YetaP606001_01GridPanel.getCurrentlySelectedItem();
						...
						yeta6060Service.Yeta606001NumUpdate(listYeta6060Dto, actionDatabase, new AsyncCallback<Long>() {
							@Override
							public void onSuccess(Long result) {	
								MessageBox.info("","저장 되었습니다.", null);
