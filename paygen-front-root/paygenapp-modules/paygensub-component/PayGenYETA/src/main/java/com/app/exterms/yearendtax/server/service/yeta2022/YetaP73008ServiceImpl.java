...
@Service("YetaP73008Service")
public class YetaP73008ServiceImpl  extends AbstractCustomServiceImpl implements YetaP73008Service  ,YetaDaoConstants {

	 
	private static final Logger logger = LoggerFactory.getLogger(YetaP73008ServiceImpl.class);
	private static final String calledClass = YetaP73008ServiceImpl.class.getName();
	...
	public Long activityOnYetaP73008ToYe160403(Ye160403DTO ye160403Dto, ActionDatabase actionDatabase) throws MSFException {
		...
		String method = calledClass + ".activityOnYetaP73008ToYe160403";

		String windowNm = "소득공제신고자료관리";
		String windowId = "YETAP7300";
			
		Ye160403_2022_VO ye160403Vo = new Ye160403_2022_VO(); 
		...
		try {
			...
			if (MSFSharedUtils.paramNull(ye160403DAO)) {
				...
				ye160403DAO = (Ye160403_2022_DAO) wac.getBean("Ye160403_2022_DAO"); 
			}
			...
			ye160403DAO.updateYetaP73008ToYe160403(ye160403Vo); 
		          
		} catch (Exception ex) {
			logger.error("EXCEPTION calling activityOnYetaP73008ToYe160403(): "+ ex);
			...
			result = new Long(0);
			throw MSFServerUtils.getOperationException("activityOnYetaP73008ToYe160403", ex, logger);
	...
	public Ye160403DTO getYetaP73008ToYe160403List(Ye160403DTO ye160403Dto) throws MSFException {
		...
		Ye160403Srh_2022_VO ye160403SrhVo = new Ye160403Srh_2022_VO();
		MSFSysm0100BM sessionUser;

		String method = calledClass + ".getYetaP73008ToYe160403List";
		...
		try {
			...
			egovResultDataList = ye160403DAO.selectYetaP73008ToYe160403List(ye160403SrhVo);
