...
@RemoteServiceRelativePath("YetaP23005Service.gwt")
public interface YetaP23005Service extends RemoteService {
	/**
	 * Utility class for simplifying access to the instance of async service.
	 */
	public static class Util {
		private static YetaP23005ServiceAsync instance;
		public static YetaP23005ServiceAsync getInstance(){
			if (instance == null) {
				instance = GWT.create(YetaP23005Service.class);
			}
			return instance;
		}
	}
