 ...
 */
public class Ye166020DTO   implements Serializable {
	...
	public Long getCrdcUseAmtSum() {
		return crdcUseAmtSum;
	}

	public void setCrdcUseAmtSum(Long crdcUseAmtSum) {
	...
	public Long getEtcUseAmt() {
		return etcUseAmt;
	}

	public void setEtcUseAmt(Long etcUseAmt) {
