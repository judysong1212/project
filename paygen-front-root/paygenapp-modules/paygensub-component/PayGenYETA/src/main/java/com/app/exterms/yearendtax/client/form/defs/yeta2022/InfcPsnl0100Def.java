...
//    private PayrConstants PayrLabel = PayrConstants.INSTANCE;
	...
	public InfcPsnl0100Def(String chkPayrDef) {
		...
		if ("YetaP710001".equals(chkPayrDef)) {
			// setTitle(PayrLabel.titlePayr0304());
			setDaoClass("");
			setCustomListMethod(CLASS_YETAP710001_TO_PSNL0100_DATA_LIST);
			setAutoFillGrid(false);
			setShowFilterToolbar(false);

			setCheckBoxOnGridRows(true);

			setColumnsDefinition(getYetaP710001ToPsnl0100ColumnsList());
	...
	private List<ColumnDef> getYetaP710001ToPsnl0100ColumnsList(){
	    row = 0;
