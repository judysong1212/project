...
@Service("YetaP03009Service")
public class YetaP03009ServiceImpl  extends AbstractCustomServiceImpl implements YetaP03009Service  ,YetaDaoConstants {
	...
	private static final Logger logger = LoggerFactory.getLogger(YetaP03009ServiceImpl.class);
	private static final String calledClass = YetaP03009ServiceImpl.class.getName();
	...
	public Long activityOnYetaP03009ToYeta3210(List<Yeta3210DTO> listYeta3210dto, ActionDatabase actionDatabase) throws MSFException {
		...
		String method = calledClass + ".activityOnYetaP03009ToYeta3210";
		
		String windowNm = "소득공제신고자료관리";
		String windowId = "YETAP030009";
		...
		try {  
			if (MSFSharedUtils.paramNull(yeta3210DAO)) {
				...
				yeta3210DAO = (Yeta3210DAO) wac.getBean("yeta3210DAO" ); 
			}
...
//		            yeta3210Vo.setRevnAddr(MSFSharedUtils.allowNulls(yeta3100Dto.getrevnAddr));    /** column 수정주소 : revnAddr */
				...
				result = iCnt;
		            ...
		            logger.error("EXCEPTION calling activityOnYetaP03009ToYeta3210(): "+ex); 
		            ...
		            result = new Long(0);
		            throw MSFServerUtils.getOperationException("activityOnYetaP03009ToYeta3210", ex, logger);
		        }
		        finally {
