...
import com.app.exterms.yearendtax.client.dto.yeta2021.Ye164010BM;
import com.app.exterms.yearendtax.client.dto.yeta2021.Ye164010DTO;
import com.app.exterms.yearendtax.client.form.defs.yeta2021.Ye164010Def;
...
=====================================================**/
public  class YetaP63002 extends MSFFormPanel {  
 ...
 **/
	...
	private  ContentPanel cpYeta63002; 
	...
	// -------------- grid 선언 시작  ---------------	  
	private MSFGridPanel YetaP63002GridPanel;
	private Ye164010Def YetaP63002ToYe164010Def  = new Ye164010Def("YetaP63002");//의료비내역 그리드 테이블 컬럼 define 
	// -------------- grid 선언 종료  ---------------	
 ...
 **/ 
	...
	private void YetaP63002FormSave() {
				...
				yetaP63002Service.activityOnYetaP63002ToYe164010(listYe164010Dto, actionDatabase, new AsyncCallback<Long>(){
					public void onFailure(Throwable caught) {
						MessageBox.alert(MSFMainApp.MSFCONSTANTS.ExceptionTitleService()
								, MSFMainApp.ADMINMESSAGES.ExceptionMessageService("activityOnYetaP63002ToYe164010(" + actionDatabase.name() + ") : " + caught), null);
						}
	...
	public YetaP63002(final ActionDatabase actionDatabase, final MSFPanel caller) {
		...
		cpYeta63002 = new ContentPanel();

		createSearchForm(); // 기본정보 필드를 적용
		createStandardForm(); // 기본정보필드
		createMsfGridForm(); // 그리드필드

		cpYeta63002.setBodyBorder(false);
		cpYeta63002.setBorders(false);
		cpYeta63002.setHeaderVisible(false);
		cpYeta63002.setSize("790px", "640px");

		this.add(cpYeta63002);
	...
	private void createSearchForm() {
		...
		cpYeta63002.setLayout(new FlowLayout());
				...
				MessageBox.confirm("삭제", "선택하신 의료비 내용을 삭제하시겠습니까?",new Listener<MessageBoxEvent>(){
					...
					public void handleEvent(MessageBoxEvent be) {
						if(Dialog.YES.equals(be.getButtonClicked().getItemId())){
							...
							Iterator<BaseModel> itBm = YetaP63002GridPanel.getMsfGrid().getGrid().getSelectionModel().getSelectedItems().listIterator();
		...
		btnYetaSave.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				setListRecord(YetaP63002GridPanel.getMsfGrid().getStore().getModifiedRecords().iterator());
...
//			BaseModel bmData = YetaP63002GridPanel.getMsfGrid().getStore().getModels().get(0);  
//			if (MSFSharedUtils.paramNotNull(bmData)){
				// TODO Auto-generated method stub
				IColumnFilter filters = null;
				
				YetaP63002GridPanel.getTableDef().setTableColumnFilters(filters);
				YetaP63002GridPanel.getTableDef().addColumnFilter("yrtxBlggYr", MSFSharedUtils.allowNulls(srhYrtxBlggYr.getValue())
	...
	//					, SimpleColumnFilter.OPERATOR_EQUALS);//연말정산귀속년도
				YetaP63002GridPanel.getTableDef().addColumnFilter("clutSeptCd", MSFSharedUtils.getSelectedComboValue(srhClutSeptCd,"commCd")
						, SimpleColumnFilter.OPERATOR_EQUALS);//정산구분
				YetaP63002GridPanel.getTableDef().addColumnFilter("systemkey", MSFSharedUtils.allowNulls(systemkey.getValue())
						, SimpleColumnFilter.OPERATOR_EQUALS);//시스템키
			 
				YetaP63002GridPanel.reload();
...
//			actionDatabase = ActionDatabase.READ;
	...
	private void createMsfGridForm() {
		...
		YetaP63002GridPanel = new MSFGridPanel(YetaP63002ToYe164010Def, false,false, false, false, false);
		YetaP63002GridPanel.setSize("780px", "390px");
		YetaP63002GridPanel.setBorders(true);
		YetaP63002GridPanel.setBodyBorder(false);
		YetaP63002GridPanel.setHeaderVisible(false);
		YetaP63002GridPanel.getBottomComponent().setVisible(true);
		...
		YetaP63002GridPanel.getGrid().getColumnModel().addAggregationRow(payrSummaryRow);  
		/** --- 그리드 합계 부분  시작 --- **/
			
		gridFieldSet.add(YetaP63002GridPanel);

		cpYeta63002.add(gridFieldSet);
