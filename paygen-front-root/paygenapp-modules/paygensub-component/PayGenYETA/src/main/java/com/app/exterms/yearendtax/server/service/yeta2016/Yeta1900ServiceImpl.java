...
import com.app.exterms.yearendtax.server.service.yeta2016.dao.Pyyt0302DAO;
import com.app.exterms.yearendtax.server.service.yeta2016.dao.Pyyt0304DAO;
...
* </pre>
 */
@Service("Yeta1900Service")
public class Yeta1900ServiceImpl  extends AbstractCustomServiceImpl implements Yeta1900Service  ,YetaDaoConstants {

	// private static final Logger LOGGER =
	// LoggerFactory.getLogger(Yeta0100ServiceImpl.class);
	// private static final String calledClass =
	// Yeta0100ServiceImpl.class.getName();
	private static final Logger logger = LoggerFactory.getLogger(Yeta1900ServiceImpl.class);
	private static final String calledClass = Yeta1900ServiceImpl.class.getName();

	// 급여대상자
	@Autowired
	@Resource(name = "Pyyt0304DAO")
	private Pyyt0304DAO pyyt0304DAO;
	
	// 수당/공제내역
	@Autowired
	@Resource(name = "Pyyt0302DAO")
	private Pyyt0302DAO pyyt0302DAO;
	 ...
	 * @throws MSFException
	 */
	public PagingLoadResult<BaseModel> getYeta1900ToPyyt0304List(ServiceParameters serviceParameters) throws MSFException {

 	        PagingLoadResult<BaseModel> retval = null;
//	        String method =  "getPsnl0100ToRemt0100DataList";
	        String method = CLASS_YETA1900_TO_PYYT0304_DATA_LIST;
	        ...
	        if  (MSFSharedUtils.paramNull(pyyt0304DAO)) {
	            ...
	            pyyt0304DAO = (Pyyt0304DAO) wac.getBean("Pyyt0304DAO"); 
	        }
...
//	            Collection<Map<String, Object>> list  
	 ...
	 * @throws MSFException
	 */
	public PagingLoadResult<BaseModel> getYeta1900ToPyyt0302ExtpyList(ServiceParameters serviceParameters) throws MSFException {

 	        PagingLoadResult<BaseModel> retval = null;
//	        String method =  "getPsnl0100ToRemt0100DataList";
	        String method = CLASS_YETA1900_TO_PYYT0302_EXTPY_DATA_LIST;
	        ...
	        if  (MSFSharedUtils.paramNull(pyyt0302DAO)) {
	            ...
	            pyyt0302DAO = (Pyyt0302DAO) wac.getBean("Pyyt0302DAO"); 
	        }
...
//	            Collection<Map<String, Object>> list  
	 ...
	 * @throws MSFException
	 */
	public PagingLoadResult<BaseModel> getYeta1900ToPyyt0302DducList(ServiceParameters serviceParameters) throws MSFException {

 	        PagingLoadResult<BaseModel> retval = null;
//	        String method =  "getPsnl0100ToRemt0100DataList";
	        String method = CLASS_YETA1900_TO_PYYT0302_DDUC_DATA_LIST;
	        Pyyt0302SrhVO   pyyt0302SrhVo = new Pyyt0302SrhVO();
	        Pyyt0302VO      pyyt0304Vo = new Pyyt0302VO();
	        List<BaseModel>  bmResult = new ArrayList<BaseModel>();
...
//	            Collection<Map<String, Object>> list  
	...
	public int deleteYeta1900List(List<Pyyt0302DTO> listPyyt0302Dto)throws MSFException {
		...
		String method = calledClass + ".deleteYeta1900List";
		MSFSysm0100BM sessionUser = MSFServerUtils.getLoggedUser(RemoteServiceUtil.getThreadLocalRequest());
...
//				pyyt0302Vo.setRevnAddr(RemoteServiceUtil.getThreadLocalRequest().getRemoteHost());
	...
	/** 급여상세정보 조회 **/
	public Pyyt0304BM Yeta1900InfoList(Pyyt0304DTO pyyt0304Dto) {

		Pyyt0304SrhVO pyyt0304SrhVo = new Pyyt0304SrhVO();
		MSFSysm0100BM sessionUser;
			
		String method = calledClass + ".Yeta1900InfoList";
