...
@RemoteServiceRelativePath("YetaP530011Service.gwt")
public interface YetaP530011Service extends RemoteService {
	/**
	 * Utility class for simplifying access to the instance of async service.
	 */
	public static class Util {
		private static YetaP530011ServiceAsync instance;
		public static YetaP530011ServiceAsync getInstance(){
			if (instance == null) {
				instance = GWT.create(YetaP530011Service.class);
			}
			return instance;
		}
	}
