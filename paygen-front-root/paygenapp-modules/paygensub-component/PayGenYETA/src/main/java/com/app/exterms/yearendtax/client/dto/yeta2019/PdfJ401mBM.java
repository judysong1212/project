 ...
 */
public class PdfJ401mBM   extends MSFSimpleBaseModel implements IsSerializable  {
    ...
    /** set 목돈안전세_상환월 : sizAmtMn */
    public static final String ATTR_SIZAMTMN = "sizAmtMn";

    /** set 목돈안전세_월별상환금액 : sizMmAmt */
    public static final String ATTR_SIZMMAMT = "sizMmAmt";

    /** set 목돈안전세_월별확정구분코드 : fixCd */
    ...
    /** 일괄등록 처리   */
     public PdfJ401mBM(
     	...
     	values.put(ATTR_SIZAMTMN,sizAmtMn);
     	values.put(ATTR_SIZMMAMT,sizMmAmt);
    ...
    /** set 목돈안전세_상환월 : sizAmtMn */
    public void setSizAmtMn(String  sizAmtMn) { set( ATTR_SIZAMTMN ,sizAmtMn);}
    /** get 목돈안전세_상환월 : sizAmtMn */
    public String  getSizAmtMn() { return (String )get( ATTR_SIZAMTMN );}

    /** set 목돈안전세_월별상환금액 : sizMmAmt */
    public void setSizMmAmt(Long  sizMmAmt) { set( ATTR_SIZMMAMT ,sizMmAmt);}
    /** get 목돈안전세_월별상환금액 : sizMmAmt */
    public Long  getSizMmAmt() { return (Long )get( ATTR_SIZMMAMT );}

    /** set 목돈안전세_월별확정구분코드 : fixCd */
    public void setFixCd(String  fixCd) { set( ATTR_FIXCD ,fixCd);}
    /** get 목돈안전세_월별확정구분코드 : fixCd */
