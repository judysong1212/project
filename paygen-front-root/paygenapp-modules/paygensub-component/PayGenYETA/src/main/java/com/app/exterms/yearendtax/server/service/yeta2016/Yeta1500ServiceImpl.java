...
* </pre>
 */
@Service("Yeta1500Service")
public class Yeta1500ServiceImpl  extends AbstractCustomServiceImpl implements Yeta1500Service  ,YetaDaoConstants {

 
	  private static final Logger logger = LoggerFactory.getLogger(Yeta1500ServiceImpl.class);
	  private static final String calledClass = Yeta1500ServiceImpl.class.getName();
	...
	//연말정산신고내역 조회
	public PagingLoadResult<BaseModel> getYeta15000List(ServiceParameters serviceParameters) throws MSFException {
		

		PagingLoadResult<BaseModel> retval = null;
		String method =  CLASS_YETA1500LIST;
...
//	            Collection<Map<String, Object>> list ??????
	...
	//당월급여반영
	public Long activityOnYeta1500List(List<Ye16Ta2000DTO> listYeta2000dto) throws MSFException {
		...
		try {  
			...
			logger.error("EXCEPTION calling activityOnYeta1500List(): "+ex); 
			
			/** 에러 로그 **/			
			MSFLogHistoryUtils.tracerUserExceptionActivity(sessionUser,method,calledClass,"U",ex, windowNm , windowId);
			            
			result = new Long(0);
			throw MSFServerUtils.getOperationException("activityOnYeta1500List", ex, logger);
		}
		finally {
	...
	//연말정산대상자 및 내역 수정
	public Long saveYeta1500Grid(List<Ye16Ta2000DTO> listYeta2000dto) throws MSFException {
		// TODO Auto-generated method stub
		
		String method = calledClass + ".saveYeta1500Grid";
		...
		try {  
			...
			logger.error("EXCEPTION calling saveYeta1500Yeta2000(): "+ex); 
			
			/** 에러 로그 **/			
			MSFLogHistoryUtils.tracerUserExceptionActivity(sessionUser,method,calledClass,"U",ex, windowNm , windowId);
			            
			result = new Long(0);
			throw MSFServerUtils.getOperationException("saveYeta1500Yeta2000", ex, logger);
		}
		finally {
