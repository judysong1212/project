...
import com.app.exterms.yearendtax.client.dto.yeta2021.Ye162010BM;
import com.app.exterms.yearendtax.client.dto.yeta2021.Ye162010DTO;
import com.app.exterms.yearendtax.client.form.defs.yeta2021.Ye162010Def;
import com.app.exterms.yearendtax.client.service.yeta2021.YetaP63007Service;
import com.app.exterms.yearendtax.client.service.yeta2021.YetaP63007ServiceAsync;
...
=====================================================**/
public  class YetaP63007   extends MSFFormPanel {  
 ...
 **/
	...
	private ContentPanel cpYeta63007;
	...
	// -------------- grid 선언 시작  ---------------	  
	private MSFGridPanel YetaP63007GridPanel;
//	private Ye16Ta3100Def YetaP63007ToYe162010Def  = new Ye16Ta3100Def("YETAP13007");	//종전근무지내역 그리드 테이블 컬럼 define 
	private Ye162010Def ye162010Def  = new Ye162010Def("YetaP63007");	//종전근무지내역 그리드 테이블 컬럼 define 
	// -------------- grid 선언 종료  ---------------
...
//	private  ListStore<BaseModel> lsdacRvyyStore = new ListStore<BaseModel>(); 	// 년도
	...
	// -------------- 서비스 호출 시작 --------------
	private YetaP63007ServiceAsync yetaP63007Service = YetaP63007Service.Util.getInstance();
	// -------------- 서비스 호출 종료 --------------		
     ...
     */  
		...
		private void YetaP63007FormSave() {  
			if (MSFSharedUtils.paramNotNull(records)) { 
				...
				if(dataChk) {
					...
					yetaP63007Service.activityOnYetaP63007ToYe162010(listYe162010Dto, actionDatabase, new AsyncCallback<Long>(){
...
//		 }
		 ...
		 * ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
		 **/		  
	  public YetaP63007(final ActionDatabase actionDatabase, final MSFPanel caller) {
...
//			initLoad(); 
	       ...
	       // this.setLayout(layout);   
	        ...
	        cpYeta63007 = new ContentPanel();  
	        
	        createSearchForm();			//검색필드를 적용
	        createMsfGridForm();		//그리드필드
		   
	           
		   cpYeta63007.setBodyBorder(false);
		   cpYeta63007.setBorders(false);
		   cpYeta63007.setHeaderVisible(false);
		   cpYeta63007.setSize("790px", "530px");
		   
		   this.add(cpYeta63007);
...
//			     });     
			...
			cpYeta63007.setLayout(new FlowLayout());
			...
			btnYetaNew.addListener(Events.Select, new Listener<ButtonEvent>() {
				public void handleEvent(ButtonEvent e) {
					 ...
					 YetaP63007GridPanel.getMsfGrid().clearData();
					 
					 BaseModel bmData = YetaP63007GridPanel.getTableDef().getDefaultValues();  
			         ...
			         YetaP63007GridPanel.getMsfGrid().getGrid().stopEditing();      
			         YetaP63007GridPanel.getMsfGrid().getGrid().getStore().insert(bmData,0);   
			         YetaP63007GridPanel.getMsfGrid().getGrid().startEditing(YetaP63007GridPanel.getMsfGrid().getGrid().getStore().indexOf(bmData), 0);   
					...
					MessageBox.confirm("삭제", "선택하신 연금저축 내용을 삭제하시겠습니까?",new Listener<MessageBoxEvent>(){
						...
						public void handleEvent(MessageBoxEvent be) {
							if(Dialog.YES.equals(be.getButtonClicked().getItemId())){
								...
								Iterator<BaseModel> itBm = YetaP63007GridPanel.getMsfGrid().getGrid().getSelectionModel().getSelectedItems().listIterator();
			...
			btnYetaSave.addListener(Events.Select, new Listener<ButtonEvent>() {
				public void handleEvent(ButtonEvent e) {
					...
					setListRecord(YetaP63007GridPanel.getMsfGrid().getStore().getModifiedRecords().iterator());
					doAction(actionDatabase);
...
//	            	reload();
		...
		private void createMsfGridForm() {
			...
			YetaP63007GridPanel = new MSFGridPanel(ye162010Def, false, false, false, false, false);
//			YetaP63007GridPanel.setSize("790px", "300px");
			YetaP63007GridPanel.setBorders(false);
			YetaP63007GridPanel.setHeaderVisible(false);
			...
			YetaP63007GridPanel.getGrid().getColumnModel().addAggregationRow(payrSummaryRow);  
			/** --- 그리드 합계 부분  시작 --- **/
			
			cpYeta63007.add(YetaP63007GridPanel);
...
//			layoutContainer.setBorders(false);
			...
			cp01.add(YetaP63007GridPanel);
			
			cpYeta63007.add(cp01);
			
			
//			cpYeta63007.add(layoutContainer);
	}
	...
	public void reload() {
		...
		YetaP63007GridPanel.getTableDef().setTableColumnFilters(filters);
		
		YetaP63007GridPanel.getTableDef().addColumnFilter("yrtxBlggYr", MSFSharedUtils.allowNulls(srhYrtxBlggYr.getValue())
															, SimpleColumnFilter.OPERATOR_EQUALS);//연말정산귀속년도 
		YetaP63007GridPanel.getTableDef().addColumnFilter("clutSeptCd", MSFSharedUtils.getSelectedComboValue(srhClutSeptCd,"commCd")
															, SimpleColumnFilter.OPERATOR_EQUALS);//정산구분
		YetaP63007GridPanel.getTableDef().addColumnFilter("systemkey", MSFSharedUtils.allowNulls(systemkey.getValue())
															, SimpleColumnFilter.OPERATOR_EQUALS);//시스템키
			 
		YetaP63007GridPanel.reload();
