...
@Repository("Ye16Ta3150DAO")
public class Ye16Ta3150DAO extends EgovAbstractDAO implements IsSerializable  {
	 ...
	 */
    @Transactional
    public void fnYeta1100_YETA3150_2016_CREATE_Delete(Yeta3150VO vo) throws Exception {
        delete("ye16Ta3150DAO.fnYeta1100_YETA3150_2016_CREATE_Delete_S", vo);
    }  
    ...
    public String insertYeta0300ToYeta3150(Yeta3150VO vo) throws Exception {
        return (String)insert("ye16Ta3150DAO.insertYeta3150_S", vo);
    }
    ...
    public void updateYeta0300ToYeta3150(Yeta3150VO vo) throws Exception {
        update("ye16Ta3150DAO.updateYeta3150_S", vo);
    }
    ...
    public void deleteYeta0300ToYeta3150(Yeta3150VO vo) throws Exception {
        delete("ye16Ta3150DAO.deleteYeta3150_S", vo);
    }
	...
	public List selectYeta0300To3150List(Yeta3150SrhVO searchVO) throws Exception {
		return list("ye16Ta3150DAO.selectYeta3150_S", searchVO);
	}	 
    ...
    public void fnPayr06430_PAYR445_CREATE_Delete(Yeta3150VO vo) throws Exception {
        delete("ye16Ta3150DAO.fnPayr06430_PAYR445_CREATE_Delete_S", vo);
    }  
    ...
    public Yeta3150VO selectYeta3150(Yeta3150VO vo) throws Exception {
        return (Yeta3150VO) selectByPk("ye16Ta3150DAO.selectYeta3150_S", vo);
    }
    ...
    public List<?> selectYeta3150List(Yeta3150SrhVO searchVO) throws Exception {
        return list("ye16Ta3150DAO.selectYeta3150List_D", searchVO);
    }
    ...
    public int selectYeta3150ListTotCnt(Yeta3150SrhVO searchVO) {
        return (Integer)getSqlMapClientTemplate().queryForObject("ye16Ta3150DAO.selectYeta3150ListTotCnt_S", searchVO);
    }
