...
@Service("YetaT23017Service")
public class YetaT23017ServiceImpl  extends AbstractCustomServiceImpl implements YetaT23017Service ,YetaDaoConstants {
	 
	private static final Logger logger = LoggerFactory.getLogger(YetaT23017ServiceImpl.class);
	private static final String calledClass = YetaT23017ServiceImpl.class.getName();
	...
	@Override
	public Ye169010DTO getYetaP23017ToYe169010List(Ye169010DTO ye169010Dto)	throws MSFException {
		
		Ye169010aSrhVO ye169010aSrhVo = new Ye169010aSrhVO();
		MSFSysm0100BM sessionUser;

		String method = calledClass + ".getYetaP23017ToYe169010List";

		String windowNm = "표준세액공제";
		String windowId = "YETAP23017";
		...
		try {
			...
			egovResultDataList = ye169010ADao.selectYetaP23017ToYe169010List(ye169010aSrhVo);
