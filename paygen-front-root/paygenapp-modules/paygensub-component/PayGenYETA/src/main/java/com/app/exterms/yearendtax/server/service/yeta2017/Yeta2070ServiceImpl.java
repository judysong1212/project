...
import com.app.exterms.yearendtax.server.service.yeta2017.dao.Yeta2070DAO;
...
@Service("Yeta2070Service")
public class Yeta2070ServiceImpl extends AbstractCustomServiceImpl implements YetaDaoConstantsGenerated, Yeta2070Service {

	private static final Logger logger = LoggerFactory.getLogger(Yeta2070ServiceImpl.class);
	private static final String calledClass = Yeta2070ServiceImpl.class.getName();

	@Autowired
	@Resource(name = "Yeta2070DAO")
	private Yeta2070DAO yeta2070DAO;
	...
	public PagingLoadResult<BaseModel> getSelectYeta2070ToBass0120List(ServiceParameters serviceParameters) throws MSFException {
        ...
        String method =  CLASS_YETA2070TOBASS0120_LIST;
        Yeta2070SrhVO   Yeta2070SrhVO = new Yeta2070SrhVO();
        //Yeta2070VO      Yeta2070Vo = new Yeta2070VO();
        List<BaseModel>  bmResult = new ArrayList<BaseModel>();
        MSFSysm0100BM sessionUser = MSFServerUtils.getLoggedUser(RemoteServiceUtil.getThreadLocalRequest());
        
        if(MSFSharedUtils.paramNull(yeta2070DAO)){
        	WebApplicationContext wac = WebApplicationContextUtils.getRequiredWebApplicationContext(getHttpServletRequest().getSession().getServletContext());
        	yeta2070DAO = (Yeta2070DAO) wac.getBean("Yeta2070DAO");
        }
        try{
            ...
            if(pagingValues.executeRecordCount){ 
            	...
            	int iResultCnt = yeta2070DAO.selectYeta2070ListTotCnt(Yeta2070SrhVO);
            ...
            List list = yeta2070DAO.selectYeta2070List(Yeta2070SrhVO);
            ...
            SmrmfUtils.endTiming(logger, millisBeginSelectYeta2070List, "selectYeta2070List");
