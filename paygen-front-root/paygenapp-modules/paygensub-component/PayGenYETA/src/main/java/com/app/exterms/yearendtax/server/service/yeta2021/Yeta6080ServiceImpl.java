...
import com.app.exterms.yearendtax.client.service.yeta2021.Yeta6080Service;
import com.app.exterms.yearendtax.server.service.yeta2021.dao.Yeta6080_2021_DAO;
...
@Service("Yeta6080Service")
public class Yeta6080ServiceImpl extends AbstractCustomServiceImpl implements YetaDaoConstantsGenerated, Yeta6080Service {

	private static final Logger logger = LoggerFactory.getLogger(Yeta6080ServiceImpl.class);
	private static final String calledClass = Yeta6080ServiceImpl.class.getName();

	@Autowired
	@Resource(name = "Yeta6080_2021_DAO")
	private Yeta6080_2021_DAO yeta6080DAO;
	...
	public PagingLoadResult<BaseModel> getSelectYeta6080ToBass0400List(ServiceParameters serviceParameters) throws MSFException {

        PagingLoadResult<BaseModel> retval = null;
        String method =  CLASS_YETA2080_TO_BASS0400_LIST;
        Yeta2080Srh_2021_VO   yeta2080SrhVo = new Yeta2080Srh_2021_VO();
        //Yeta2080VO      Yeta2080Vo = new Yeta2080VO();
        List<BaseModel>  bmResult = new ArrayList<BaseModel>();
        MSFSysm0100BM sessionUser = MSFServerUtils.getLoggedUser(RemoteServiceUtil.getThreadLocalRequest());
        
        if(MSFSharedUtils.paramNull(yeta6080DAO)){
        	WebApplicationContext wac = WebApplicationContextUtils.getRequiredWebApplicationContext(getHttpServletRequest().getSession().getServletContext());
        	yeta6080DAO = (Yeta6080_2021_DAO) wac.getBean("Yeta6080_2021_DAO");
        }
        ...
        try{
            ...
            if(pagingValues.executeRecordCount){ 
            	...
            	int iResultCnt = yeta6080DAO.selectYeta6080ListTotCnt(yeta2080SrhVo);
            ...
            List list = yeta6080DAO.selectYeta6080List(yeta2080SrhVo);
            ...
            SmrmfUtils.endTiming(logger, millisBeginSelectYeta2080List, "selectYeta6080List");
