...
import com.app.exterms.yearendtax.client.dto.yeta2018.Ye161090DTO;
...
import com.app.exterms.yearendtax.server.service.yeta2018.dao.Ye161020_2018_DAO;
import com.app.exterms.yearendtax.server.service.yeta2018.dao.Ye161030_2018_DAO;
import com.app.exterms.yearendtax.server.service.yeta2018.dao.Ye161040_2018_DAO;
import com.app.exterms.yearendtax.server.service.yeta2018.dao.Ye161050_2018_DAO;
import com.app.exterms.yearendtax.server.service.yeta2018.dao.Ye161055_2018_DAO;
import com.app.exterms.yearendtax.server.service.yeta2018.dao.Ye161060_2018_DAO;
import com.app.exterms.yearendtax.server.service.yeta2018.dao.Ye161070_2018_DAO;
import com.app.exterms.yearendtax.server.service.yeta2018.dao.Ye161080_2018_DAO;
import com.app.exterms.yearendtax.server.service.yeta2018.dao.Ye161090_2018_DAO;
import com.app.exterms.yearendtax.server.service.yeta2018.dao.Ye164010_2018_DAO;
import com.app.exterms.yearendtax.server.service.yeta2018.dao.Ye165030_2018_DAO;
import com.app.exterms.yearendtax.server.service.yeta2018.dao.Ye166010_2018_DAO;
import com.app.exterms.yearendtax.server.service.yeta2018.dao.Ye169010_2018_DAO;
import com.app.exterms.yearendtax.server.service.yeta2018.dao.Ye169010a_2018_DAO;
...
import com.app.smrmf.pkg.listener.yeta.yeta2018.Yeta3300ListenerAdapter;
import com.app.smrmf.pkg.yeta.yeta2018.pdfxml.Func_PdfInDdc_Yeta2018_Insert;
 ...
 */
@Service("Yeta3300Service")
public class Yeta3300ServiceImpl  extends AbstractCustomServiceImpl implements Yeta3300Service  ,YetaDaoConstants {
	 
	private static final Logger logger = LoggerFactory.getLogger(Yeta3300ServiceImpl.class);
	private static final String calledClass = Yeta3300ServiceImpl.class.getName();
	...
	// 인적소득
	@Autowired
	@Resource(name = "Ye161020_2018_DAO")
	private Ye161020_2018_DAO ye161020DAO;
	
	@Autowired
	@Resource(name = "Ye160404_2018_DAO")
	private Ye160404_2018_DAO ye160404DAO;
	  
	@Autowired
	@Resource(name = "Ye161030_2018_DAO")
	private Ye161030_2018_DAO ye161030DAO;
	
	@Autowired
	@Resource(name = "Ye161040_2018_DAO")
	private Ye161040_2018_DAO ye161040DAO;
	
	@Autowired
	@Resource(name = "Ye161050_2018_DAO")
	private Ye161050_2018_DAO ye161050DAO;
	
	@Autowired
	@Resource(name = "Ye161055_2018_DAO")
	private Ye161055_2018_DAO ye161055DAO;
	
	@Autowired
	@Resource(name = "Ye161060_2018_DAO")
	private Ye161060_2018_DAO ye161060DAO;
	
	@Autowired
	@Resource(name = "Ye161070_2018_DAO")
	private Ye161070_2018_DAO ye161070DAO;
	
	@Autowired
	@Resource(name = "Ye161080_2018_DAO")
	private Ye161080_2018_DAO ye161080DAO;
	
	// 교육비 내역
	@Autowired
	@Resource(name = "Ye161090_2018_DAO")
	private Ye161090_2018_DAO ye161090DAO;
	
	@Autowired
	@Resource(name = "Ye169010_2018_DAO")
	private Ye169010_2018_DAO ye169010DAO;
	
	@Autowired
	@Resource(name = "Ye169010a_2018_DAO")
	private Ye169010a_2018_DAO ye169010aDAO;
	
	// 의료비 
	@Autowired
	@Resource(name = "Ye164010_2018_DAO")
	private Ye164010_2018_DAO ye164010DAO;
	
	// 기부금
	@Autowired
	@Resource(name = "Ye165030_2018_DAO")
	private Ye165030_2018_DAO ye165030DAO;
	
	// 신용카드
	@Autowired
	@Resource(name = "Ye166010_2018_DAO")
	private Ye166010_2018_DAO ye166010DAO;
	
	
	

	/** 대상자 정보 조회 **/
	public PagingLoadResult<BaseModel> getYeta3300ToYe161010DataList(ServiceParameters serviceParameters) throws MSFException {
	     ...
	     //	 List<String> listTyInttnCd = new ArrayList<String>(); 
			...
			if ( pagingValues.executeRecordCount ) { 
	        	...
	        	TimingInfo millisBeginQueryCount = SmrmfUtils.startTiming(logger);
	          	...
	          	int iResultCnt = ye161010DAO.selectYeta3300ToYe161010ListTotCnt(ye161010SrhVo);  
...
//	            Collection<Map<String, Object>> list ??????
	     	List list = ye161010DAO.selectYeta3300ToYe161010List(ye161010SrhVo);
			...
			SmrmfUtils.endTiming(logger, millisBeginYe161010DataList, "getYeta3300ToYe161010DataList");
	...
	/** 세액계산 정보 조회 **/
	public PagingLoadResult<BaseModel> getYeta3300ToSubTaxList(ServiceParameters serviceParameters) throws MSFException {

		PagingLoadResult<BaseModel> retval = null;
		String method = CLASS_YETA3300_TO_YE169010_SUBTAX_LIST;
		
		
		Ye169010Srh_2018_VO ye169010SrhVo = new Ye169010Srh_2018_VO();
		List<BaseModel> bmResult = new ArrayList<BaseModel>();
		MSFSysm0100BM sessionUser;
		...
		if  (MSFSharedUtils.paramNull(ye169010DAO)) {
			WebApplicationContext wac = WebApplicationContextUtils.getRequiredWebApplicationContext( getHttpServletRequest().getSession().getServletContext());
			ye169010DAO = (Ye169010_2018_DAO) wac.getBean("Ye169010_2018_DAO" ); 
		}
		
		if  (MSFSharedUtils.paramNull(ye169010aDAO)) {
			WebApplicationContext wac = WebApplicationContextUtils.getRequiredWebApplicationContext( getHttpServletRequest().getSession().getServletContext());
			ye169010aDAO = (Ye169010a_2018_DAO) wac.getBean("Ye169010a_2018_DAO" ); 
		}
			...
			if ( pagingValues.executeRecordCount ) { 
	        	...
	        	TimingInfo millisBeginQueryCount = SmrmfUtils.startTiming(logger);
	          	...
	          	if("Y".equals(ye169010SrhVo.getC152StdTxDdcYn())) {
	          		iResultCnt = ye169010aDAO.selectYeta3300ToYe169010aListTotCnt(ye169010SrhVo);
	          	}else {
	          		iResultCnt = ye169010DAO.selectYeta3300ToYe169010ListtTotCnt(ye169010SrhVo);
	          	}
...
//	            Collection<Map<String, Object>> list ??????
	    	List list;
	     	if("Y".equals(ye169010SrhVo.getC152StdTxDdcYn())) {
		    	...
		    	list = ye169010aDAO.selectYeta3300ToYe169010aList(ye169010SrhVo);
	     		
          	}else {
          		
          		list = ye169010DAO.selectYeta3300ToYe169010List(ye169010SrhVo);
          	}
	...
	/** 인적공제명세 정보 조회 **/
	public PagingLoadResult<BaseModel> getYeta3300ToYe161030List(ServiceParameters serviceParameters) throws MSFException {
		

		PagingLoadResult<BaseModel> retval = null;
		String method =  CLASS_YETA3300_TO_YE161030_DATA_LIST;
		Ye161030Srh_2018_VO   ye161030SrhVo = new Ye161030Srh_2018_VO();
		List<BaseModel>  bmResult = new ArrayList<BaseModel>();
		MSFSysm0100BM sessionUser;
		...
		if  (MSFSharedUtils.paramNull(ye161030DAO)) {
			WebApplicationContext wac = WebApplicationContextUtils.getRequiredWebApplicationContext( getHttpServletRequest().getSession().getServletContext());
			ye161030DAO = (Ye161030_2018_DAO) wac.getBean("Ye161030_2018_DAO"); 
		}
...
//	    	List<String> listDeptCd = new ArrayList<String>();    
			...
			if ( pagingValues.executeRecordCount ) { 
	        	...
	        	TimingInfo millisBeginQueryCount = SmrmfUtils.startTiming(logger);
	          	...
	          	int iResultCnt = ye161030DAO.selectYeta33001ToYe161030ListtTotCnt(ye161030SrhVo);  
	     	...
	     	@SuppressWarnings("unchecked")
//	            Collection<Map<String, Object>> list ??????
	     	List list = ye161030DAO.selectYeta33001ToYe161030List(ye161030SrhVo);
	...
	/** 소득공제명세 정보 조회 **/	
	public PagingLoadResult<BaseModel> getYeta3300ToYe161040List(ServiceParameters serviceParameters) throws MSFException {
		

		PagingLoadResult<BaseModel> retval = null;
		String method =  CLASS_YETA3300_TO_YE161040_DATA_LIST;
		Ye161040Srh_2018_VO   ye161040SrhVo = new Ye161040Srh_2018_VO();
		List<BaseModel>  bmResult = new ArrayList<BaseModel>();
		MSFSysm0100BM sessionUser;
		...
		if  (MSFSharedUtils.paramNull(ye161040DAO)) {
			WebApplicationContext wac = WebApplicationContextUtils.getRequiredWebApplicationContext( getHttpServletRequest().getSession().getServletContext());
			ye161040DAO = (Ye161040_2018_DAO) wac.getBean("Ye161040_2018_DAO"); 
		}
...
//	    	List<String> listDeptCd = new ArrayList<String>();    
			...
			if ( pagingValues.executeRecordCount ) { 
	        	...
	        	TimingInfo millisBeginQueryCount = SmrmfUtils.startTiming(logger);
	          	...
	          	int iResultCnt = ye161040DAO.selectYeta3300ToYe161040ListTotCnt(ye161040SrhVo);  
	     	...
	     	@SuppressWarnings("unchecked")
//	            Collection<Map<String, Object>> list ??????
	     	List list = ye161040DAO.selectYeta3300ToYe161040List(ye161040SrhVo);
	...
	/** 교육비내역 조회 **/
//	public PagingLoadResult<BaseModel> getYeta3300ToYe161090List(ServiceParameters serviceParameters) throws MSFException {
//			
//
//			PagingLoadResult<BaseModel> retval = null;
...
//	}
	...
	/** 기본사항 tab 조회 **/
	public Ye161020DTO getYeta3300ToYe161020Data(Ye161020DTO ye161020Dto) throws MSFException {
		

		Ye161020Srh_2018_VO ye161020SrhVo = new Ye161020Srh_2018_VO();
		MSFSysm0100BM sessionUser;

		String method = calledClass + ".getYeta3300ToYe161020Data";

		String windowNm = "소득공제신고자료관리";
		String windowId = "YETA3300";
		...
		if (MSFSharedUtils.paramNull(ye161020DAO)) {
			...
			ye161020DAO = (Ye161020_2018_DAO) wac.getBean("Ye161020_2018_DAO");
		}
...
//		int iResultCnt = ye161020DAO.selectYeta2300ToYe161020ListtTotCnt(ye161020SrhVo);
		...
		try {
			...
			egovResultDataList = ye161020DAO.selectYeta3300ToYe161020Data(ye161020SrhVo);
...
//					
	...
	/** 기본사항 tab 수정 **/ 
	@Override
	public int saveYeta3300ToYe161020tabItem01(Ye161020DTO ye161020Dto)throws Exception {
		// TODO Auto-generated method stub
		
		int result = 0;
		
		Ye161020_2018_VO ye161020Vo = new Ye161020_2018_VO();
		Ye160404_2018_VO ye160404Vo = new Ye160404_2018_VO();
		Ye169010_2018_VO ye169010Vo = new Ye169010_2018_VO();
		
		String windowNm = "소득공제신고자료관리";
		String windowId = "YETA2300";
		
		InfcPkgYe161010_2018_VO infcPkgYe161010Vo = new InfcPkgYe161010_2018_VO(); 
		Yeta3300ListenerAdapter  yeta3300ListenerAdt = new Yeta3300ListenerAdapter();
		
		// 1. 암호화 객체 생성
		String nResult = AnyCryptUtils.XecureCryptInitialize(RemoteServiceUtil.getThreadLocalConfig(),RemoteServiceUtil.getThreadLocalRequest());
		
		String method = calledClass + ".saveYeta2300ToYe161020tabItem01";
		MSFSysm0100BM sessionUser = MSFServerUtils.getLoggedUser(RemoteServiceUtil.getThreadLocalRequest());
		
		try{
			// ---------- 기본사항 수정 시작 -------------------
			ye161020Vo = new Ye161020_2018_VO();
			...
			ye161020DAO.updateYeta3300Item01ToYe161020(ye161020Vo);
...
//			ye160404DAO.updateYeta2300ToYe160404(ye160404Vo);
			...
			// 주현근무처 ye169010
			ye169010Vo = new Ye169010_2018_VO();
			...
			ye169010DAO.updateYeta3300ToYe169010(ye169010Vo);
			
			
			
//		ye161020Vo.setFnm(ye161020Dto.getFnm());    /** column 소득자성명 : fnm */
//		ye161020Vo.setResnoEncCntn(ye161020Dto.getResnoEncCntn());    /** column 주민등록번호 : resnoEncCntn */
//		ye161020Vo.setNnfClCd(ye161020Dto.getNnfClCd());    /** column 내외국인구분 : nnfClCd */

//		ye161020Vo.setPrifChngYn(ye161020Dto.getPrifChngYn());    /** column 인적공제항목변동여부 : prifChngYn */
//		ye161020Vo.set표준세액공제적용여부(ye161020Dto.get표준세액공제적용여부());    /** column 표준세액공제적용여부 : 표준세액공제적용여부 */
//		ye161020Vo.setChild(ye161020Dto.getChild());    /** column 자녀인원수 : child */
//		ye161020Vo.setBscDdcnFpCnt(ye161020Dto.getBscDdcnFpCnt());    /** column 기본공제인원수 : bscDdcnFpCnt */
//		ye161020Vo.setSccNfpCnt(ye161020Dto.getSccNfpCnt());    /** column 경로우대인원수 : sccNfpCnt */
//		ye161020Vo.setChbtAdopNfpCnt(ye161020Dto.getChbtAdopNfpCnt());    /** column 출산입양인원수 : chbtAdopNfpCnt */
//		ye161020Vo.setWmnNfpCnt(ye161020Dto.getWmnNfpCnt());    /** column 부녀자인원수 : wmnNfpCnt */
//		ye161020Vo.setSnprntNfpCnt(ye161020Dto.getSnprntNfpCnt());    /** column 한부모인원수 : snprntNfpCnt */
//		ye161020Vo.setDsbrNfpCnt(ye161020Dto.getDsbrNfpCnt());    /** column 장애인인원수 : dsbrNfpCnt */
//		ye161020Vo.setAge6ltNfpCnt(ye161020Dto.getAge6ltNfpCnt());    /** column 6세이하인원수 : age6ltNfpCnt */
...
//		ye161020Vo.setIssDtSeilNum(ye161020Dto.getIssDtSeilNum());    /** column 발급일자일련번호 : issDtSeilNum */	
			
			BeanUtils.copyProperties(infcPkgYe161010Vo , ye169010Vo);  
			yeta3300ListenerAdt = new Yeta3300ListenerAdapter();
			yeta3300ListenerAdt.fnYeta3300_Ye161010_2018_CalcUpdate(RemoteServiceUtil.getThreadLocalRequest(), infcPkgYe161010Vo, "YE166020_INSERT");
...
//		try{
//
//			ye161020DAO.updateYeta2300ToYe161020(yeta3000Vo);
//			
//			result = 1;
//			
//		}catch(Exception e){
...
//		}
	...
	/** 인적공제 tab 조회 **/
	public Ye161020DTO getYeta3300TabItem02ToYe161020Data(Ye161020DTO ye161020Dto) throws MSFException {
		

		Ye161020Srh_2018_VO ye161020SrhVo = new Ye161020Srh_2018_VO();
		MSFSysm0100BM sessionUser;

		String method = calledClass + ".getYeta3300TabItem02ToYe161020Data";
		...
		int iResultCnt = ye161020DAO.selectYeta3300ToYe161020ListtTotCnt(ye161020SrhVo);
...
//					returnYe161020Dto.set표준세액공제적용여부(MSFSharedUtils.allowNulls(tempMap.get("표준세액공제적용여부")));		/** column 표준세액공제적용여부 : 표준세액공제적용여부 */
	...
	/** 연금보험료공제 tab 조회 **/
	public Ye161055DTO getYeta3300TabItem04ToYe161055Data(Ye161055DTO ye161055Dto) throws MSFException {
		

		Ye161055Srh_2018_VO ye161055SrhVo = new Ye161055Srh_2018_VO();
		MSFSysm0100BM sessionUser;

		String method = calledClass + ".getYeta3300TabItem04ToYe161055Data";
		...
		if (MSFSharedUtils.paramNull(ye161055DAO)) {
			WebApplicationContext wac = WebApplicationContextUtils.getRequiredWebApplicationContext(getHttpServletRequest()
							.getSession().getServletContext());
			ye161055DAO = (Ye161055_2018_DAO) wac.getBean("Ye161055_2018_DAO");
		}
		...
		try {
			...
			egovResultDataList = ye161055DAO.selectYeta3300ToYe161055List(ye161055SrhVo);
	...
	/** 연금보험료공제 tab 수정 **/   
	@Override
	public int saveYeta3300ToYe161055tabItem04(Ye161055DTO ye161055Dto)throws Exception {
		// TODO Auto-generated method stub
		
		int result = 0;
		String method = calledClass + ".saveYeta2300ToYe161055tabItem04";
		
		String windowNm = "소득공제신고자료관리";
		String windowId = "YETA1300";
		
		Ye161055_2018_VO ye161055Vo = new Ye161055_2018_VO();
		Ye161050_2018_VO ye161050Vo = new Ye161050_2018_VO();
		...
		try{
			...
			ye161055Vo = new Ye161055_2018_VO();
			...
			ye161050Vo = new Ye161050_2018_VO();
			...
			ye161055DAO.updateYeta3300ToYe161055(ye161055Vo);
			ye161050DAO.updateYeta3300ToYe161050(ye161050Vo);
			
			BeanUtils.copyProperties(infcPkgYe161010Vo , ye161050Vo);  
			yeta3300ListenerAdt.fnYeta3300_Ye161010_2018_CalcUpdate(RemoteServiceUtil.getThreadLocalRequest(), infcPkgYe161010Vo, "YE161050");
	...
	/** 특별소득공제 tab 조회 **/
	public Ye161060DTO getYeta3300TabItem05ToYe161060Data(Ye161060DTO ye161060Dto) throws MSFException {
		

		Ye161060Srh_2018_VO ye161060SrhVo = new Ye161060Srh_2018_VO();
		MSFSysm0100BM sessionUser;

		String method = calledClass + ".getYeta3300TabItem05ToYe161060Data";
		...
		if (MSFSharedUtils.paramNull(ye161060DAO)) {
			WebApplicationContext wac = WebApplicationContextUtils.getRequiredWebApplicationContext(getHttpServletRequest()
							.getSession().getServletContext());
			ye161060DAO = (Ye161060_2018_DAO) wac.getBean("Ye161060_2018_DAO");
		}
		...
		try {
			...
			egovResultDataList = ye161060DAO.selectYeta3300ToYe161060tabItem05List(ye161060SrhVo);
	...
	@Override
	public int saveYeta3300ToYe161060tabItem05_1(Ye161060DTO ye161060Dto)throws Exception {
		// TODO Auto-generated method stub
		
		int result = 0;
		String method = calledClass + ".saveYeta2300ToYe161060tabItem05_1";
		...
		Ye161060_2018_VO ye161060Vo = new Ye161060_2018_VO();
		MSFSysm0100BM sessionUser = MSFServerUtils.getLoggedUser(RemoteServiceUtil.getThreadLocalRequest());
		...
		try{
			...
			ye161060DAO.updateYeta3300ToYe161060tabItem05_1(ye161060Vo);
			
			BeanUtils.copyProperties(infcPkgYe161010Vo , ye161060Vo);  
			yeta3300ListenerAdt.fnYeta3300_Ye161010_2018_CalcUpdate(RemoteServiceUtil.getThreadLocalRequest(), infcPkgYe161010Vo, "YE161060");
	...
	@Override
	public int saveYeta3300ToYe161060tabItem05_2(Ye161060DTO ye161060Dto)throws Exception {
		// TODO Auto-generated method stub
		
		int result = 0;
		String method = calledClass + ".saveYeta2300ToYe161060tabItem05_2";
		...
		try{
			...
			ye161060DAO.updateYeta3300ToYe161060tabItem05_2(ye161060Vo);
	...
	/** 그밖의소득공제1 tab 조회 **/
	public Ye161070DTO getYeta3300TabItem06ToYe161070Data(Ye161070DTO ye161070Dto) throws MSFException {
		

		Ye161070Srh_2018_VO ye161070SrhVo = new Ye161070Srh_2018_VO();
		MSFSysm0100BM sessionUser;

		String method = calledClass + ".getYeta3300TabItem06ToYe161070Data";
		...
		if (MSFSharedUtils.paramNull(ye161070DAO)) {
			WebApplicationContext wac = WebApplicationContextUtils.getRequiredWebApplicationContext(getHttpServletRequest()
							.getSession().getServletContext());
			ye161070DAO = (Ye161070_2018_DAO) wac.getBean("Ye161070_2018_DAO");
		}
		...
		try {
			...
			egovResultDataList = ye161070DAO.selectYeta3300ToYe161070List(ye161070SrhVo);
			...
			if (egovResultDataList != null && egovResultDataList.size() > 0) {
				...
				for (int i = 0; i < egovResultDataList.size(); i++) {
					...
					returnYe161070Dto.setCpiv16AsctUseAmt(Long.parseLong(MSFSharedUtils.defaultNulls(tempMap.get("cpiv16AsctUseAmt"), "0")));    			/** column 출자투자금액_조합등_2016납입금 : cpiv16AsctUseAmt */
					returnYe161070Dto.setCpiv16AsctDdcAmt(Long.parseLong(MSFSharedUtils.defaultNulls(tempMap.get("cpiv16AsctDdcAmt"), "0")));   	 		/** column 출자투자금액 조합등_2016공제액 : cpiv16AsctDdcAmt */
					returnYe161070Dto.setCpiv16VntUseAmt(Long.parseLong(MSFSharedUtils.defaultNulls(tempMap.get("cpiv16VntUseAmt"), "0")));    				/** column 출자투자금액벤처등_2016납입금액 : cpiv16VntUseAmt */
					returnYe161070Dto.setCpiv16VntDdcAmt(Long.parseLong(MSFSharedUtils.defaultNulls(tempMap.get("cpiv16VntDdcAmt"), "0")));    				/** column 출자투자금액벤처등_2016공제액 : cpiv16VntDdcAmt */
					returnYe161070Dto.setCpiv17AsctUseAmt(Long.parseLong(MSFSharedUtils.defaultNulls(tempMap.get("cpiv17AsctUseAmt"), "0")));    			/** column 출자투자금액_조합등_2017납입금 : cpiv17AsctUseAmt */
					returnYe161070Dto.setCpiv17AsctDdcAmt(Long.parseLong(MSFSharedUtils.defaultNulls(tempMap.get("cpiv17AsctDdcAmt"), "0")));    			/** column 출자투자금액 조합등_2017공제액 : cpiv17AsctDdcAmt */
					returnYe161070Dto.setCpiv17VntUseAmt(Long.parseLong(MSFSharedUtils.defaultNulls(tempMap.get("cpiv17VntUseAmt"), "0")));    				/** column 출자투자금액벤처등_2017납입금액 : cpiv17VntUseAmt */
					returnYe161070Dto.setCpiv17VntDdcAmt(Long.parseLong(MSFSharedUtils.defaultNulls(tempMap.get("cpiv17VntDdcAmt"), "0")));    				/** column 출자투자금액벤처등_2017공제액 : cpiv17VntDdcAmt */
	...
	/** 그밖의소득공제1tab 금액 수정 **/
	@Override
	public int saveYeta3300ToYe161070tabItem06(Ye161070DTO ye161070Dto)throws Exception {
		// TODO Auto-generated method stub
		
		int result = 0;
		String method = calledClass + ".saveYeta2300ToYe161070tabItem06";
		...
		Ye161070_2018_VO ye161070Vo = new Ye161070_2018_VO();
		MSFSysm0100BM sessionUser = MSFServerUtils.getLoggedUser(RemoteServiceUtil.getThreadLocalRequest());
...
//		ye161070Vo.setLtrmCniSsDdcAmt(new BigDecimal(MSFSharedUtils.defaultNulls( ye161070Dto.getLtrmCniSsDdcAmt(), "0")));    				/** column 장기집합투자증권저축공제금액 : ltrmCniSsDdcAmt */
		...
		try{
			...
			ye161070DAO.updateYeta3300ToYe161070tabItem06(ye161070Vo);
			
			BeanUtils.copyProperties(infcPkgYe161010Vo , ye161070Vo);  
			yeta3300ListenerAdt.fnYeta3300_Ye161010_2018_CalcUpdate(RemoteServiceUtil.getThreadLocalRequest(), infcPkgYe161010Vo, "YE161070");
	...
	/** 그밖의소득공제2tab 금액 수정 **/
	@Override
	public int saveYeta3300ToYe161070tabItem07(Ye161070DTO ye161070Dto)throws Exception {
		// TODO Auto-generated method stub
		
		int result = 0;
		String method = calledClass + ".saveYeta2300ToYe161070tabItem07";
...
//		ye161070Vo.setTyShfyPrsAddDdcrtUseAmt(new BigDecimal(MSFSharedUtils.defaultNulls( ye161070Dto.getTyShfyPrsAddDdcrtUseAmt(), "0")));	/** column 본인추가공제율사용분_2016_상반기 : tyShfyPrsAddDdcrtUseAmt */
		...
		try{
			...
			ye161070DAO.updateYeta3300ToYe161070tabItem07(ye161070Vo);
	...
	/** 세액감면및세액공제1tab 조회 **/
	public Ye161080DTO getYeta3300TabItem08ToYe161080Data(Ye161080DTO ye161080Dto) throws MSFException {
		

		Ye161080Srh_2018_VO ye161080SrhVo = new Ye161080Srh_2018_VO();
		MSFSysm0100BM sessionUser;

		String method = calledClass + ".getYeta3300TabItem08ToYe161080Data";
		...
		if (MSFSharedUtils.paramNull(ye161080DAO)) {
			WebApplicationContext wac = WebApplicationContextUtils.getRequiredWebApplicationContext(getHttpServletRequest()
							.getSession().getServletContext());
			ye161080DAO = (Ye161080_2018_DAO) wac.getBean("Ye161080_2018_DAO");
		}
		...
		try {
			...
			egovResultDataList = ye161080DAO.selectYeta3300ToYe161080tabItem08List(ye161080SrhVo);
	...
	@Override
	public int saveYeta3300ToYe161080tabItem08_1(Ye161080DTO ye161080Dto)throws Exception {
		// TODO Auto-generated method stub
		
		int result = 0;
		String method = calledClass + ".saveYeta2300ToYe161060tabItem08_1";
		...
		Ye161080_2018_VO ye161080Vo = new Ye161080_2018_VO();
		MSFSysm0100BM sessionUser = MSFServerUtils.getLoggedUser(RemoteServiceUtil.getThreadLocalRequest());
...
//		ye161080Vo.setInfeePymDdcAmtSum(new BigDecimal(MSFSharedUtils.defaultNulls(ye161080Dto.getInfeePymDdcAmtSum(), "0")));    		/** column 보험료공제세액합계 : infeePymDdcAmtSum */
		...
		try{
			...
			ye161080DAO.updateYeta3300ToYe161080tabItem08_1(ye161080Vo);
			
			BeanUtils.copyProperties(infcPkgYe161010Vo , ye161080Vo);  
			yeta3300ListenerAdt.fnYeta3300_Ye161010_2018_CalcUpdate(RemoteServiceUtil.getThreadLocalRequest(), infcPkgYe161010Vo, "YE162010");
	...
	@Override
	public int saveYeta3300ToYe161080tabItem08_3(Ye161080DTO ye161080Dto) throws Exception {
		// TODO Auto-generated method stub

		int result = 0;
		String method = calledClass + ".saveYeta2300ToYe161080tabItem08_3";
...
//		ye161080Vo.setScxpsDdcAmtSum(new BigDecimal(MSFSharedUtils.defaultNulls(ye161080Dto.getScxpsDdcAmtSum(), "0")));    /** column 교육비공제세액금액합계 : scxpsDdcAmtSum */
		...
		try{
			...
			ye161080DAO.updateYeta3300ToYe161080tabItem08_3(ye161080Vo);
			
			BeanUtils.copyProperties(infcPkgYe161010Vo , ye161080Vo);  
			yeta3300ListenerAdt.fnYeta3300_Ye161010_2018_CalcUpdate(RemoteServiceUtil.getThreadLocalRequest(), infcPkgYe161010Vo, "YE161080");
	...
	@Override
	public Long saveYeta3300ToYe161090tabItem08_3(List<Ye161090DTO> listYe161090Dto, ActionDatabase actionDatabase) throws Exception {
		
		String method = calledClass + ".saveYeta2300ToYe161090tabItem08_3";
		...
		Ye161090_2018_VO ye161090Vo = new Ye161090_2018_VO();
		...
		try {
			...
			for (int iYetaCnt = 0; iYetaCnt < listYe161090Dto.size(); iYetaCnt++) {
        		...
        		ye161090Vo = new Ye161090_2018_VO();
				...
				case INSERT:
					...
					ye161090DAO.insertYeta3300ToYe161090(ye161090Vo);
					
					break;
				case UPDATE:
					
					ye161090DAO.updateYeta3300ToYe161090(ye161090Vo);

					break;
				case DELETE:
					
					ye161090DAO.deleteYeta3300ToYe161090(ye161090Vo);
	...
	/** 세액감면및세액공제2tab 조회 **/
	public Ye161080DTO getYeta3300TabItem09ToYe161080Data(Ye161080DTO ye161080Dto) throws MSFException {
		

		Ye161080Srh_2018_VO ye161080SrhVo = new Ye161080Srh_2018_VO();
		MSFSysm0100BM sessionUser;

		String method = calledClass + ".getYeta3300TabItem09ToYe161080Data";
		...
		try {
			...
			egovResultDataList = ye161080DAO.selectYeta3300ToYe161080tabItem09List(ye161080SrhVo);
...
//					returnYe161080Dto.setYetaC119(Long.parseLong(MSFSharedUtils.defaultNulls(tempMap.get("yetaC119"), "0")));    					/** column C119_세액감면합계금액 : yetaC119 */
	...
	/** 세액감면및세액공제2 금액 수정 **/
	@Override
	public int saveYeta3300ToYe161080tabItem09(Ye161080DTO ye161080Dto)throws Exception {
		// TODO Auto-generated method stub
		
		int result = 0;
		String method = calledClass + ".saveYeta2300ToYe161080tabItem09";
...
//		ye161080Vo.setIncmDducWtnnteSumtDt(ye161080Dto.getIncmDducWtnnteSumtDt());    /** column 소득공제신고서제출일자 : incmDducWtnnteSumtDt */
			...
			ye161080DAO.updateYeta3300ToYe161080tabItem09(ye161080Vo);
			ye169010DAO.updateYeta3300ToYe169010tabItem09(ye169010Vo);
	...
	/** 추가제출서류tab 조회 **/
	public Ye161080DTO getYeta3300TabItem10ToYe161080Data(Ye161080DTO ye161080Dto) throws MSFException {
		

		Ye161080Srh_2018_VO ye161080SrhVo = new Ye161080Srh_2018_VO();
		MSFSysm0100BM sessionUser;

		String method = calledClass + ".getYeta3300TabItem10ToYe161080Data";
		...
		try {
			...
			egovResultDataList = ye161080DAO.selectYeta3300ToYe161080tabItem10List(ye161080SrhVo);
	...
	/** 추가제출서류 수정 **/
	@Override
	public int saveYeta3300ToYe161080tabItem10(Ye161080DTO ye161080Dto)throws Exception {
		// TODO Auto-generated method stub
		
		int result = 0;
		String method = calledClass + ".saveYeta2300ToYe161080tabItem10";
...
//		ye161080Vo.setCd218(ye161080Dto.getCd218());    /** column 신고인성명 : cd218 *
		...
		try{
			...
			ye161080DAO.updateYeta3300ToYe161080tabItem10(ye161080Vo);
	...
	/** 인적공제 명세 추가 **/
	@Override
	public Long activityOnYeta3300ToYe161030(List<Ye161030DTO> listYe161030Dto, ActionDatabase actionDatabase)  throws MSFException {
		...
		String method = calledClass + ".activityOnYeta2300ToYe161030";
		MSFSysm0100BM sessionUser = MSFServerUtils.getLoggedUser(RemoteServiceUtil.getThreadLocalRequest());
		...
		try { 
			Ye161020_2018_VO  ye161020Vo = new Ye161020_2018_VO();
			Ye161030_2018_VO  ye161030Vo = new Ye161030_2018_VO();
			Ye161040_2018_VO  ye161040Vo = new Ye161040_2018_VO();
			Ye164010_2018_VO  ye164010Vo = new Ye164010_2018_VO();
			Ye161090_2018_VO  ye161090Vo = new Ye161090_2018_VO();
			...
			for(int iYetaCnt=0; iYetaCnt < listYe161030Dto.size(); iYetaCnt++) {
				...
				/** 인적공제명세  **/
				ye161030Vo = new Ye161030_2018_VO();
...
//	            ye161030Vo.setInptAddr(RemoteServiceUtil.getThreadLocalRequest().getRemoteHost());    					/** column 입력주소 : inptAddr */
	            ...
	            /** 의료비  **/
	            ye164010Vo = new Ye164010_2018_VO();
	            ...
	            /** 인적소득 **/
	            ye161040Vo = new Ye161040_2018_VO();
...
//                tpPayr0530Vo.setSchlExpnExtpyPymtEndDt(payr0530Dto.getSchlExpnExtpyPymtEndDt());    /** column 학비수당지급종료일자 : schlExpnExtpyPymtEndDt */
				...
				case INSERT:
					...
					ye161030DAO.insertYeta3300ToYe161030(ye161030Vo);
...
//					payr0530Vo.setInptAddr(RemoteServiceUtil.getThreadLocalRequest().getRemoteHost());    	/** column 입력주소 : inptAddr */
					...
					ye161040DAO.deleteYeta3300ToYe161040(ye161040Vo); 
					// 소득공제명세 데이터 추가 
					ye161040DAO.insertYeta3300ToYe161040_01(ye161040Vo);
					ye161040DAO.insertYeta3300ToYe161040_02(ye161040Vo);
...
//					yeta2300ListenerAdt.fnYeta2300_Ye161010_2017_CalcUpdate(RemoteServiceUtil.getThreadLocalRequest(), infcPkgYe161010Vo, "YE166020_DELETE");
					yeta3300ListenerAdt.fnYeta3300_Ye161010_2018_CalcUpdate(RemoteServiceUtil.getThreadLocalRequest(), infcPkgYe161010Vo, "YE166020_NEW");
					yeta3300ListenerAdt.fnYeta3300_Ye161010_2018_CalcUpdate(RemoteServiceUtil.getThreadLocalRequest(), infcPkgYe161010Vo, "YE161030");
				...
				case UPDATE:
					...
					if(ye161030Vo.getTxprDscmNoCntn() != null || !"".equals(ye161030Vo.getTxprDscmNoCntn())) {
						...
						ye161030DAO.updateYeta3300ToYe161030(ye161030Vo);
					}
					...
					ye161020DAO.updateYeta3300Item02ToYe161020(ye161020Vo);
...
//					yeta3220Vo.setBeforeJumin(MSFSharedUtils.allowNulls(yeta3220Dto.getBeforeJumin().replace("-", "")));	//수정전 주민번호
					...
					// 1. 인적공제 내역 삭제
					ye161030DAO.deleteYeta3300ToYe161030(ye161030Vo);
					
					// 2. 의료비 내역
					ye164010DAO.deleteYeta3300ToYe164010(ye164010Vo);
					...
					yeta3300ListenerAdt = new Yeta3300ListenerAdapter();
					BeanUtils.copyProperties(infcPkgYe161010Vo , ye161030Vo);  
					yeta3300ListenerAdt.fnYeta3300_Ye161010_2018_CalcUpdate(RemoteServiceUtil.getThreadLocalRequest(), infcPkgYe161010Vo, "YE166020_DELETE");
...
//			yeta2300ListenerAdt.fnYeta2300_Ye161010_2017_CalcUpdate(RemoteServiceUtil.getThreadLocalRequest(), infcPkgYe161010Vo, "YE166020_INSERT");
			...
			result = new Long(0);
			ex.printStackTrace();
			throw MSFServerUtils.getOperationException("activityOnYeta2300ToYe161030", ex, logger);
	...
	/** 소득공제 tab 수정 **/ 
	@Override
	public int saveYeta3300ToYe1610400tabItem03(List<Ye161040DTO> listYe161040Dto_01, List<Ye161040DTO> listYe161040Dto_02)  throws MSFException {
		...
		String method = calledClass + ".saveYeta2300ToYe1610400tabItem03";
		MSFSysm0100BM sessionUser = MSFServerUtils.getLoggedUser(RemoteServiceUtil.getThreadLocalRequest());
...
//				ye161040Vo.setInptAddr(ye161040Dto.getInptAddr());    /** column 입력주소 : inptAddr */
		        ...
		        ye161040DAO.updateYeta3300ToYe161040(ye161040Vo);
...
//			 yeta2000DAO.updateYeta0300ToYeta2000_Item03(yeta2000Vo);  
			...
			result = 0;
			ex.printStackTrace();
			throw MSFServerUtils.getOperationException("saveYeta2300ToYe1610400tabItem03_1", ex, logger);
...
//			yeta2000DAO.updateYeta0300ToYeta2000_Item03(yeta2000Vo);  
			...
			throw MSFServerUtils.getOperationException("saveYeta2300ToYe1610400tabItem03_2", ex, logger);
   ...
   @Override
	 public PagingLoadResult<ShowMessageBM> fnYeta3300_Ye161010_2018_CalcTax(List<Ye161010DTO> listYe161010Dto) throws MSFException {
    	...
    	String method = calledClass + ".fnYeta3300_Ye161010_2018_CalcTax";
        MSFSysm0100BM sessionUser = MSFServerUtils.getLoggedUser(RemoteServiceUtil.getThreadLocalRequest());
        ...
        try {  
        	...
        	List<InfcPkgYe161010_2018_VO> listYe161010VO = new ArrayList<InfcPkgYe161010_2018_VO>();
...
//					 
           ...
           Yeta3300ListenerAdapter yetaLsAdtr = new Yeta3300ListenerAdapter();
           retval = yetaLsAdtr.fnYeta3300_Ye161010_2018_CalcTax(RemoteServiceUtil.getThreadLocalRequest(),listYe161010VO);
 
        }
        catch (Exception ex) {
        	 
            logger.error("EXCEPTION calling fnYeta2300_Ye161010_2017_CalcTax(): "+ex); 
            
            /** 에러 로그 **/			
            MSFLogHistoryUtils.tracerUserExceptionActivity(sessionUser,method,calledClass,"C",ex, windowNm , windowId);
             
            throw MSFServerUtils.getOperationException("fnYeta3300_Ye161010_2018_CalcTax", ex, logger);
        }
        finally {
...
*/
   @Override
 public PagingLoadResult<ShowMessageBM> fnYeta3300Ye161010_2018_AllCalcTax(Ye161010DTO ye161010Dto) throws MSFException {
    	...
    	String method = calledClass + ".fnYeta3300Ye161010_2018_AllCalcTax";
        MSFSysm0100BM sessionUser = MSFServerUtils.getLoggedUser(RemoteServiceUtil.getThreadLocalRequest());
       ...
       // yeta2200Service = (InfcPkgYeta2200Service)BeanFinder.getBean("InfcPkgYeta2200Service"); 
        ...
        try {  
	          ...
	          Ye161010Srh_2018_VO  ye161010SrhVo = new Ye161010Srh_2018_VO(); 
	          List<InfcPkgYe161010_2018_VO> listPkgYe161010VO = new ArrayList<InfcPkgYe161010_2018_VO>();
	          List<Ye161010_2018_VO> listYe161010VO = new ArrayList<Ye161010_2018_VO>();
	          ...
	          listYe161010VO = (List<Ye161010_2018_VO>)ye161010DAO.selectYeta3300ToYe161010AllList(ye161010SrhVo);
              ...
              for (int iCnt = 0;iCnt < listYe161010VO.size();iCnt++) { 
  		    	...
  		    	String nResult = AnyCryptUtils.XecureCryptInitialize(RemoteServiceUtil.getThreadLocalConfig(),RemoteServiceUtil.getThreadLocalRequest());
	            	...
	            	Ye161010_2018_VO  ye161010Vo = new Ye161010_2018_VO();  
	            	 ...
	            	 ye161010Vo = (Ye161010_2018_VO) listYe161010VO.get(iCnt); 
                  ...
                  Yeta3300ListenerAdapter yetaLsAdtr = new Yeta3300ListenerAdapter();
                  retval = yetaLsAdtr.fnYeta3300_Ye161010_2018_CalcTax(RemoteServiceUtil.getThreadLocalRequest(),listPkgYe161010VO);
   
	        } 
	        catch (Exception ex) {
	        	 
	            logger.error("EXCEPTION calling fnYeta3300Ye161010_2018_AllCalcTax(): "+ex); 
            
            /** 에러 로그 **/			
            MSFLogHistoryUtils.tracerUserExceptionActivity(sessionUser,method,calledClass,"C",ex, windowNm , windowId);
             
            throw MSFServerUtils.getOperationException("fnYeta3300Ye161010_2018_AllCalcTax", ex, logger);
        }
        finally {
   ...
   //소득공제신고서 재적용
   @Override
   public PagingLoadResult<ShowMessageBM> fnYeta3300Ye161010_2018_SbtVolUse(Ye161010DTO ye161010Dto) throws MSFException {
	   ...
	   String method = calledClass + ".fnYeta3300Ye161010_2018_SbtVolUse";
	   MSFSysm0100BM sessionUser = MSFServerUtils.getLoggedUser(RemoteServiceUtil.getThreadLocalRequest());
	   ...
	   try {  
		   ...
		   Ye161010Srh_2018_VO  ye161010SrhVo = new Ye161010Srh_2018_VO(); 
		   InfcPkgYe161010_2018_VO pkgYe161010VO = new InfcPkgYe161010_2018_VO();
		   ...
		   strReturnPdfCheck = funcPdfInDdc.pdfInDdc_Yeta2018_Insert(pkgYe161010VO, RemoteServiceUtil.getThreadLocalRequest());
   ...
   @Override
	public Ye161020DTO getYeta3300TxDdcYnToYe161020Data(Ye161020DTO ye161020Dto) throws MSFException {


		Ye161020Srh_2018_VO ye161020SrhVo = new Ye161020Srh_2018_VO();
		MSFSysm0100BM sessionUser;

		String method = calledClass + ".getYeta3300TxDdcYnToYe161020Data";
		...
		try {
			...
			egovResultDataList = ye161020DAO.getYeta3300TxDdcYnToYe161020Data(ye161020SrhVo);
	...
	/** 합계 일괄업데이트 **/
	@Override
	public int updateYeta3300All(List<Ye161040DTO> listYe161040Dto)throws MSFException {
		// TODO Auto-generated method stub
		...
		try{
            ...
            for (int iCnt = 0;iCnt < listYe161040Dto.size();iCnt++) { 
            	...
            	infcPkgYe161010Vo = new InfcPkgYe161010_2018_VO(); 
				...
				listYe161010VO.add(infcPkgYe161010Vo);
				 ...
				 yeta3300ListenerAdt = new Yeta3300ListenerAdapter();
				 yeta3300ListenerAdt.fnYeta3300_Ye161010_2018_CalcUpdate(RemoteServiceUtil.getThreadLocalRequest(), infcPkgYe161010Vo, "YE164010");
				 yeta3300ListenerAdt.fnYeta3300_Ye161010_2018_CalcUpdate(RemoteServiceUtil.getThreadLocalRequest(), infcPkgYe161010Vo, "YE161090");
				 yeta3300ListenerAdt.fnYeta3300_Ye161010_2018_CalcUpdate(RemoteServiceUtil.getThreadLocalRequest(), infcPkgYe161010Vo, "YE161050");
				 yeta3300ListenerAdt.fnYeta3300_Ye161010_2018_CalcUpdate(RemoteServiceUtil.getThreadLocalRequest(), infcPkgYe161010Vo, "YE165010");
				 yeta3300ListenerAdt.fnYeta3300_Ye161010_2018_CalcUpdate(RemoteServiceUtil.getThreadLocalRequest(), infcPkgYe161010Vo, "YE162010");
				 yeta3300ListenerAdt.fnYeta3300_Ye161010_2018_CalcUpdate(RemoteServiceUtil.getThreadLocalRequest(), infcPkgYe161010Vo, "YE162510");
				 yeta3300ListenerAdt.fnYeta3300_Ye161010_2018_CalcUpdate(RemoteServiceUtil.getThreadLocalRequest(), infcPkgYe161010Vo, "YE166020_INSERT");
				 yeta3300ListenerAdt.fnYeta3300_Ye161010_2018_CalcUpdate(RemoteServiceUtil.getThreadLocalRequest(), infcPkgYe161010Vo, "YE166020_DELETE");
