...
@Service("YetaP730011Service")
public class YetaP730011ServiceImpl  extends AbstractCustomServiceImpl implements YetaP730011Service  ,YetaDaoConstants {

	 
	private static final Logger logger = LoggerFactory.getLogger(YetaP730011ServiceImpl.class);
	private static final String calledClass = YetaP730011ServiceImpl.class.getName();
	...
	public PagingLoadResult<BaseModel> getYeta7300ToYe161090List(ServiceParameters serviceParameters) throws MSFException {
		...
		String method = CLASS_YETA7300_TO_YE161090_DATA_LIST;
		Ye161090Srh_2022_VO ye161090SrhVo = new Ye161090Srh_2022_VO();
		...
		MSFSysm0100BM sessionUser;
			...
			if  (MSFSharedUtils.paramNull(ye161090DAO)) {
				...
				ye161090DAO = (Ye161090_2022_DAO) wac.getBean("Ye161090_2022_DAO"); 
			}
...
//		      	Yeta4220SrhVo.setHanNm(MSFSharedUtils.allowNulls(MSFServerUtils.getFilterValue(columnFilters, "hanNm")));    //한글성명 
				...
				if ( pagingValues.executeRecordCount ) { 
		        	...
		        	TimingInfo millisBeginQueryCount = SmrmfUtils.startTiming(logger);
		          	...
		          	int iResultCnt = ye161090DAO.selectYeta7300ToYe161090ListTotCnt(ye161090SrhVo);  
...
////		            Collection<Map<String, Object>> list ??????
		     	List list = ye161090DAO.selectYeta7300ToYe161090List(ye161090SrhVo);
