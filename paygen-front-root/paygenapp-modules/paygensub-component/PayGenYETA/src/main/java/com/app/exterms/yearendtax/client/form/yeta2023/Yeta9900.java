...
//				fieldSet_2.add(lcSchCol2, new FormData("100%"));	
		    	...
		    	layoutContainer_1.setLayout(new HBoxLayout()); 
		     	...
		     	btnYetat13019.addListener(Events.Select, new Listener<ButtonEvent>() {
		     		public void handleEvent(ButtonEvent e) {
						  //전체내역  
						  YetaT83019 yetaT83019Form = new YetaT83019(ActionDatabase.READ, getThis());   
								    
						  MSFFormWindows msFwYetaT83019 = new MSFFormWindows("월세액세액공제명세", yetaT83019Form, "닫기", "820px", "710px", true);
						  msFwYetaT83019.show();
						  yetaT83019Form.setMSFFormWindows(msFwYetaT83019);
						  
						  funcSetPopUpRecord();
						  //TODO 추후 주석해제 
						  yetaT83019Form.bind(ppRecord); 
					  }
		    	});
		    	...
		    	btnYetat13001.addListener(Events.Select, new Listener<ButtonEvent>() {
		    		public void handleEvent(ButtonEvent e) {
						  //전체내역  
						  YetaT83001 yetaT83001Form = new YetaT83001(ActionDatabase.READ, getThis());   
								    
						  MSFFormWindows msFwYetaT83001 = new MSFFormWindows("비과세및감면소득", yetaT83001Form, "닫기", "820px", "710px", true);
						  msFwYetaT83001.show();
						  yetaT83001Form.setMSFFormWindows(msFwYetaT83001);
						  
						  funcSetPopUpRecord();
						  //TODO 추후 주석해제 
						  yetaT83001Form.bind(ppRecord); 
					  }
		    	}); 
		    	...
		    	btnYetat13002.addListener(Events.Select, new Listener<ButtonEvent>() {
		    		public void handleEvent(ButtonEvent e) {
						  //전체내역  
						  YetaT83002 yetaT83002Form = new YetaT83002(ActionDatabase.READ, getThis());   
								    
						  MSFFormWindows msFwYetaT83002 = new MSFFormWindows("연금보험료", yetaT83002Form, "닫기", "700px", "710px", true);
						  msFwYetaT83002.show();
						  yetaT83002Form.setMSFFormWindows(msFwYetaT83002);
						  
						  funcSetPopUpRecord();
						  //TODO 추후 주석해제 
						  yetaT83002Form.bind(ppRecord); 
					  }
		    	}); 
		    	...
		    	btnYetat13003.addListener(Events.Select, new Listener<ButtonEvent>() {
		    		public void handleEvent(ButtonEvent e) {
						  //전체내역  
						  YetaT83003 yetaT83003Form = new YetaT83003(ActionDatabase.READ, getThis());   
								    
						  MSFFormWindows msFwYetaT83003 = new MSFFormWindows("보험료(부양가족)", yetaT83003Form, "닫기", "700px", "750px", true);
						  msFwYetaT83003.show();
						  yetaT83003Form.setMSFFormWindows(msFwYetaT83003);
						  
						  funcSetPopUpRecord();
						  //TODO 추후 주석해제 
						  yetaT83003Form.bind(ppRecord); 
					  }
		    	}); 
		    	...
		    	btnYetat13004.addListener(Events.Select, new Listener<ButtonEvent>() {
		    		public void handleEvent(ButtonEvent e) {
						  //전체내역  
						  YetaT83004 yetaT83004Form = new YetaT83004(ActionDatabase.READ, getThis());   
								    
						  MSFFormWindows msFwYetaT83004 = new MSFFormWindows("주택임차차입금원리금상환액", yetaT83004Form, "닫기", "820px", "710px", true);
						  msFwYetaT83004.show();
						  yetaT83004Form.setMSFFormWindows(msFwYetaT83004);
						  
						  funcSetPopUpRecord();
						  //TODO 추후 주석해제 
						  yetaT83004Form.bind(ppRecord); 
					  }
		    	}); 
		    	...
		    	btnYetat13005.addListener(Events.Select, new Listener<ButtonEvent>() {
		    		public void handleEvent(ButtonEvent e) {
						  //전체내역  
						  YetaT83005 yetaT83005Form = new YetaT83005(ActionDatabase.READ, getThis());   
								    
						  MSFFormWindows msFwYetaT83005 = new MSFFormWindows("장기주택저당차입금이자상환액", yetaT83005Form, "닫기", "450px", "710px", true);
						  msFwYetaT83005.show();
						  yetaT83005Form.setMSFFormWindows(msFwYetaT83005);
						  
						  funcSetPopUpRecord();
						  //TODO 추후 주석해제 
						  yetaT83005Form.bind(ppRecord); 
					  }
		    	}); 
		    	...
		    	btnYetat13006.addListener(Events.Select, new Listener<ButtonEvent>() {
		    		public void handleEvent(ButtonEvent e) {
						  //전체내역  
						  YetaT83006 yetaT83006Form = new YetaT83006(ActionDatabase.READ, getThis());   
								    
						  MSFFormWindows msFwYetaT83006 = new MSFFormWindows("개인연금저축불입액", yetaT83006Form, "닫기", "820px", "710px", true);
						  msFwYetaT83006.show();
						  yetaT83006Form.setMSFFormWindows(msFwYetaT83006);
						  
						  funcSetPopUpRecord();
						  //TODO 추후 주석해제 
						  yetaT83006Form.bind(ppRecord); 
					  }
		    	}); 
		    	...
		    	btnYetat13007.addListener(Events.Select, new Listener<ButtonEvent>() {
		    		public void handleEvent(ButtonEvent e) {
						  //전체내역  
						  YetaT83007 yetaT83007Form = new YetaT83007(ActionDatabase.READ, getThis());   
								    
						  MSFFormWindows msFwYetaT83007 = new MSFFormWindows("주택마련저축", yetaT83007Form, "닫기", "820px", "710px", true);
						  msFwYetaT83007.show();
						  yetaT83007Form.setMSFFormWindows(msFwYetaT83007);
						  
						  funcSetPopUpRecord();
						  //TODO 추후 주석해제 
						  yetaT83007Form.bind(ppRecord); 
					  }
		    	}); 
		    	...
		    	btnYetat13008.addListener(Events.Select, new Listener<ButtonEvent>() {
		    		public void handleEvent(ButtonEvent e) {
						  //전체내역  
						  YetaT83008 yetaT83008Form = new YetaT83008(ActionDatabase.READ, getThis());   
								    
						  MSFFormWindows msFwYetaT83008 = new MSFFormWindows("중소기업창업투자조합출자등", yetaT83008Form, "닫기", "600px", "710px", true);
						  msFwYetaT83008.show();
						  yetaT83008Form.setMSFFormWindows(msFwYetaT83008);
						  
						  funcSetPopUpRecord();
						  //TODO 추후 주석해제 
						  yetaT83008Form.bind(ppRecord); 
					  }
		    	}); 
		    	...
		    	btnYetat13009.addListener(Events.Select, new Listener<ButtonEvent>() {
		    		public void handleEvent(ButtonEvent e) {
						  //전체내역  
						  YetaT83009 yetaT83009Form = new YetaT83009(ActionDatabase.READ, getThis());   
								    
						  MSFFormWindows msFwYetaT83009 = new MSFFormWindows("신용카드등", yetaT83009Form, "닫기", "600px", "710px", true);
						  msFwYetaT83009.show();
						  yetaT83009Form.setMSFFormWindows(msFwYetaT83009);
						  
						  funcSetPopUpRecord();
						  //TODO 추후 주석해제 
						  yetaT83009Form.bind(ppRecord); 
					  }
		    	}); 
		    	...
		    	btnYetat13010.addListener(Events.Select, new Listener<ButtonEvent>() {
		    		public void handleEvent(ButtonEvent e) {
						  //전체내역  
						  YetaT83010 yetaT83010Form = new YetaT83010(ActionDatabase.READ, getThis());   
								    
						  MSFFormWindows msFwYetaT83010 = new MSFFormWindows("장기집합투자증권저축", yetaT83010Form, "닫기", "820px", "710px", true);
						  msFwYetaT83010.show();
						  yetaT83010Form.setMSFFormWindows(msFwYetaT83010);
						  
						  funcSetPopUpRecord();
						  //TODO 추후 주석해제 
						  yetaT83010Form.bind(ppRecord); 
					  }
		    	}); 
		    	...
		    	btnYetat13011.addListener(Events.Select, new Listener<ButtonEvent>() {
		    		public void handleEvent(ButtonEvent e) {
						  //전체내역  
						  YetaT83011 yetaT83011Form = new YetaT83011(ActionDatabase.READ, getThis());   
								    
						  MSFFormWindows msFwYetaT83011 = new MSFFormWindows("외국인근로자감면세액", yetaT83011Form, "닫기", "820px", "710px", true);
						  msFwYetaT83011.show();
						  yetaT83011Form.setMSFFormWindows(msFwYetaT83011);
						  
						  funcSetPopUpRecord();
						  //TODO 추후 주석해제 
						  yetaT83011Form.bind(ppRecord); 
					  }
		    	}); 
		    	...
		    	btnYetat13012.addListener(Events.Select, new Listener<ButtonEvent>() {
		    		public void handleEvent(ButtonEvent e) {
						  //전체내역  
						  YetaT83012 yetaT83012Form = new YetaT83012(ActionDatabase.READ, getThis());   
								    
						  MSFFormWindows msFwYetaT83012 = new MSFFormWindows("중소기업취업자세액감면", yetaT83012Form, "닫기", "450px", "710px", true);
						  msFwYetaT83012.show();
						  yetaT83012Form.setMSFFormWindows(msFwYetaT83012);
						  
						  funcSetPopUpRecord();
						  //TODO 추후 주석해제 
						  yetaT83012Form.bind(ppRecord); 
					  }
		    	}); 
		    	...
		    	btnYetat13013.addListener(Events.Select, new Listener<ButtonEvent>() {
		    		public void handleEvent(ButtonEvent e) {
						  //전체내역  
						  YetaT83013 yetaT83013Form = new YetaT83013(ActionDatabase.READ, getThis());   
								    
						  MSFFormWindows msFwYetaT83013 = new MSFFormWindows("연금계좌불입액", yetaT83013Form, "닫기", "820px", "710px", true);
						  msFwYetaT83013.show();
						  yetaT83013Form.setMSFFormWindows(msFwYetaT83013);
						  
						  funcSetPopUpRecord();
						  //TODO 추후 주석해제 
						  yetaT83013Form.bind(ppRecord); 
					  }
		    	}); 
		    	...
		    	btnYetat13014.addListener(Events.Select, new Listener<ButtonEvent>() {
		    		public void handleEvent(ButtonEvent e) {
						  //전체내역  
						  YetaT83014 yetaT83014Form = new YetaT83014(ActionDatabase.READ, getThis());   
								    
						  MSFFormWindows msFwYetaT83014 = new MSFFormWindows("교육비", yetaT83014Form, "닫기", "350px", "300px", true);
						  msFwYetaT83014.show();
						  yetaT83014Form.setMSFFormWindows(msFwYetaT83014);
						  
						  funcSetPopUpRecord();
						  //TODO 추후 주석해제 
						  yetaT83014Form.bind(ppRecord); 
					  }
		    	}); 
		    	...
		    	btnYetat13015.addListener(Events.Select, new Listener<ButtonEvent>() {
		    		public void handleEvent(ButtonEvent e) {
						  //전체내역  
						  YetaT83015 yetaT83015Form = new YetaT83015(ActionDatabase.READ, getThis());   
								    
						  MSFFormWindows msFwYetaT83015 = new MSFFormWindows("교육비지출액", yetaT83015Form, "닫기", "550px", "710px", true);
						  msFwYetaT83015.show();
						  yetaT83015Form.setMSFFormWindows(msFwYetaT83015);
						  
						  funcSetPopUpRecord();
						  //TODO 추후 주석해제 
						  yetaT83015Form.bind(ppRecord); 
					  }
		    	}); 
		    	...
		    	btnYetat13016.addListener(Events.Select, new Listener<ButtonEvent>() {
		    		public void handleEvent(ButtonEvent e) {
						  //전체내역  
						  YetaT83016 yetaT83016Form = new YetaT83016(ActionDatabase.READ, getThis());   
								    
						  MSFFormWindows msFwYetaT83016 = new MSFFormWindows("기부금", yetaT83016Form, "닫기", "600px", "710px", true);
						  msFwYetaT83016.show();
						  yetaT83016Form.setMSFFormWindows(msFwYetaT83016);
						  
						  funcSetPopUpRecord();
						  //TODO 추후 주석해제 
						  yetaT83016Form.bind(ppRecord); 
					  }
		    	}); 
		    	...
		    	btnYetat13017.addListener(Events.Select, new Listener<ButtonEvent>() {
		    		public void handleEvent(ButtonEvent e) {
						  ...
						  MSFFormWindows msFwYetaT83017 = new MSFFormWindows("표준세액공제", yetaT83017Form, "닫기", "600px", "710px", true);
						  msFwYetaT83017.show();
		    	...
		    	btnYetat13018.addListener(Events.Select, new Listener<ButtonEvent>() {
		    		public void handleEvent(ButtonEvent e) {
						  //전체내역  
						  YetaT83018 yetaT83018Form = new YetaT83018(ActionDatabase.READ, getThis());   
								    
						  MSFFormWindows msFwYetaT83018 = new MSFFormWindows("외국인납부세액", yetaT83018Form, "닫기", "600px", "710px", true);
						  msFwYetaT83018.show();
						  yetaT83018Form.setMSFFormWindows(msFwYetaT83018);
						  
						  funcSetPopUpRecord();
						  //TODO 추후 주석해제 
						  yetaT83018Form.bind(ppRecord); 
					  }
		    	}); 
