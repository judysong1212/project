...
import com.app.exterms.yearendtax.client.service.yeta2018.YetaT33009Service;
import com.app.exterms.yearendtax.client.service.yeta2018.YetaT33009ServiceAsync;
...
//import com.app.exterms.yearendtax.client.form.defs.yeta2016.YetaT33009Def;
...
=====================================================**/
public  class YetaT33009   extends MSFFormPanel {  
 ...
 **/
	...
	private  ContentPanel cpYetaT33009; 
	...
	// -------------- grid 선언 시작  ---------------	  
	private MSFGridPanel YetaT33009GridPanel;
//	private YetaT33009Def YetaT33009Def = new YetaT33009Def("YetaT33009");   //TODO 일단 화면번호로 Def
	// -------------- grid 선언 종료  ---------------
	...
	// -------------- 서비스 호출 시작 --------------
	private YetaT33009ServiceAsync yetaT33009Service = YetaT33009Service.Util.getInstance();
	// -------------- 서비스 호출 종료 --------------	 
...
//					ye162510Dto.setMnthRnttyHusCnttArea((MSFSharedUtils.allowNulls(bmMapModel.get("mnthRnttyHusCnttArea"))));    		/** column 월세주택계약면적 : mnthRnttyHusCnttArea */
				...
				yetaT33009Service.activityOnYetaT33009(listYe162510Dto, actionDatabase, new AsyncCallback<Long>(){
...
//		 }
	...
	public YetaT33009(final ActionDatabase actionDatabase, final MSFPanel caller) {
...
//		initLoad(); 	
		...
		this.actionDatabase = actionDatabase;
	 	...
	 	cpYetaT33009 = new ContentPanel();  

		createSearchForm();			//기본정보 필드를 적용
	 	createMsfGridForm();		//그리드필드
		   
		cpYetaT33009.setBodyBorder(false);
		cpYetaT33009.setBorders(false);
		cpYetaT33009.setHeaderVisible(false);
		cpYetaT33009.setSize("790px", "640px");
		   
		this.add(cpYetaT33009);
...
//		     });     
		...
		cpYetaT33009.setLayout(new FlowLayout());
...
//	      	     }
//				 
//				YetaT33009GridPanel.getMsfGrid().clearData();
//				 
//				BaseModel bmData = YetaT33009GridPanel.getTableDef().getDefaultValues();  
//		              
...
//		         
//		        YetaT33009GridPanel.getMsfGrid().getGrid().stopEditing();      
//		        YetaT33009GridPanel.getMsfGrid().getGrid().getStore().insert(bmData,0);   
//		        YetaT33009GridPanel.getMsfGrid().getGrid().startEditing(YetaT33009GridPanel.getMsfGrid().getGrid().getStore().indexOf(bmData), 0);   
//
...
//			public void handleEvent(ButtonEvent e) {
//				Iterator<BaseModel> itBm = YetaT33009GridPanel.getMsfGrid().getGrid().getSelectionModel().getSelectedItems().listIterator();
...
//			public void handleEvent(ButtonEvent e) {
//				setListRecord(YetaT33009GridPanel.getMsfGrid().getStore().getModifiedRecords().iterator());
//				doAction(actionDatabase);
//
//				if ((ActionDatabase.INSERT).equals(actionDatabase)) {
//					actionDatabase = ActionDatabase.INSERT;
...
//				
//		cpYetaT33009.add(topYetaBtnBar);
...
//		YetaT33009GridPanel = new MSFGridPanel(YetaT33009Def, false, false, false, false, false);
//		YetaT33009GridPanel.setSize("790px", "420px");
//		YetaT33009GridPanel.setBorders(true);
//		YetaT33009GridPanel.setHeaderVisible(false);
...
//		
//		YetaT33009GridPanel.getGrid().getColumnModel().addAggregationRow(payrSummaryRow);  
//		
...
//		
//		YetaT33009GridPanel.getGrid().getColumnModel().addAggregationRow(payrSummaryRow1);
//		/** --- 그리드 합계 부분  종료 --- **/
		
//        cpYetaT33009.add(YetaT33009GridPanel);
		...
		cpYetaT33009.add(layoutContainer);
		cpYetaT33009.add(layoutContainer20);
		cpYetaT33009.add(layoutContainer21);
		cpYetaT33009.add(layoutContainer22);
	...
	public void reload() {
			...
			YetaT33009GridPanel.getTableDef().setTableColumnFilters(filters);
			YetaT33009GridPanel.getTableDef().addColumnFilter("yrtxBlggYr", MSFSharedUtils.allowNulls(srhYrtxBlggYr.getValue())
...
//					, SimpleColumnFilter.OPERATOR_EQUALS);//연말정산귀속년도
			YetaT33009GridPanel.getTableDef().addColumnFilter("clutSeptCd", MSFSharedUtils.getSelectedComboValue(srhClutSeptCd,"commCd")
					, SimpleColumnFilter.OPERATOR_EQUALS);//정산구분
			YetaT33009GridPanel.getTableDef().addColumnFilter("systemkey", MSFSharedUtils.allowNulls(systemkey.getValue())
					, SimpleColumnFilter.OPERATOR_EQUALS);//시스템키
		 
			YetaT33009GridPanel.reload();
