...
import com.app.exterms.yearendtax.client.dto.yeta2023.Ye161090BM;
...
import com.app.exterms.yearendtax.client.service.yeta2023.YetaP830011Service;
import com.app.exterms.yearendtax.client.service.yeta2023.YetaP830011ServiceAsync;
import com.app.exterms.yearendtax.client.service.yeta2023.YetaP83002Service;
import com.app.exterms.yearendtax.client.service.yeta2023.YetaP83002ServiceAsync;
...
=====================================================**/
public  class YetaP830011   extends MSFFormPanel {  
 ...
 **/
	...
	private  ContentPanel cpYeta830011; 
	...
	// -------------- grid 선언 시작  ---------------	  
	private MSFGridPanel yeta8300ToYe161090GridPanel01;		// 가족교육비 GridPanel (기타자료)
	private MSFGridPanel yeta8300ToYe161090GridPanel02;		// 가족교육비 GridPanel (국세청자료)
	private Ye161090Def ye161090Def_01  		= new Ye161090Def("YETA830001");
	private Ye161090Def ye161090Def_02  		= new Ye161090Def("YETA830002");
	// -------------- grid 선언 종료  ---------------	
   ...
   */
	...
	private YetaP830011ServiceAsync yetaP830011Service = YetaP830011Service.Util.getInstance();
 ...
 **/ 
	...
	// -------------- 서비스 호출 시작 --------------
	private YetaP83002ServiceAsync yetaP83002Service = YetaP83002Service.Util.getInstance();
	// -------------- 서비스 호출 종료 --------------	 	
...
//					return;
			...
			if (dataChk) {
				...
				yetaP83002Service.activityOnYetaP83002ToYe164010(listYe164010Dto, actionDatabase, new AsyncCallback<Long>(){
...
//		 }
	...
	public YetaP830011(final ActionDatabase actionDatabase, final MSFPanel caller) {
		...
		cpYeta830011 = new ContentPanel();

		createSearchForm(); 	// 기본정보 필드를 적용
//		createStandardForm(); 	// 기본정보필드
		createMsfGridForm(); 	// 그리드필드

		cpYeta830011.setBodyBorder(false);
		cpYeta830011.setBorders(false);
		cpYeta830011.setHeaderVisible(false);
		cpYeta830011.setSize("790px", "700px");

		this.add(cpYeta830011);
	...
	private void createSearchForm() {
		...
		cpYeta830011.setLayout(new FlowLayout());
...
//	      return lcFormLayer;	  
	...
	public void reload01() {
		...
		yeta8300ToYe161090GridPanel01.getTableDef().setTableColumnFilters(filters);
				
		yeta8300ToYe161090GridPanel01.getTableDef().addColumnFilter("dpobCd"		, MSFSharedUtils.allowNulls(dpobCd.getValue())		, SimpleColumnFilter.OPERATOR_EQUALS);
		yeta8300ToYe161090GridPanel01.getTableDef().addColumnFilter("systemkey"		, MSFSharedUtils.allowNulls(systemkey.getValue())	, SimpleColumnFilter.OPERATOR_EQUALS); 
		yeta8300ToYe161090GridPanel01.getTableDef().addColumnFilter("clutSeptCd"	, MSFSharedUtils.allowNulls(clutSeptCd.getValue())	, SimpleColumnFilter.OPERATOR_EQUALS); 
		yeta8300ToYe161090GridPanel01.getTableDef().addColumnFilter("yrtxBlggYr"	, MSFSharedUtils.allowNulls(yrtxBlggYr.getValue())	, SimpleColumnFilter.OPERATOR_EQUALS); 
		yeta8300ToYe161090GridPanel01.getTableDef().addColumnFilter("cdVvalKrnCd"	, MSFSharedUtils.allowNulls("Y0140001")				, SimpleColumnFilter.OPERATOR_EQUALS); 
				
		yeta8300ToYe161090GridPanel01.reload();
	...
	public void reload02() {
		...
		yeta8300ToYe161090GridPanel02.getTableDef().setTableColumnFilters(filters);
				
		yeta8300ToYe161090GridPanel02.getTableDef().addColumnFilter("dpobCd"		, MSFSharedUtils.allowNulls(dpobCd.getValue())		, SimpleColumnFilter.OPERATOR_EQUALS);
		yeta8300ToYe161090GridPanel02.getTableDef().addColumnFilter("systemkey"		, MSFSharedUtils.allowNulls(systemkey.getValue())	, SimpleColumnFilter.OPERATOR_EQUALS); 
		yeta8300ToYe161090GridPanel02.getTableDef().addColumnFilter("clutSeptCd"	, MSFSharedUtils.allowNulls(clutSeptCd.getValue())	, SimpleColumnFilter.OPERATOR_EQUALS); 
		yeta8300ToYe161090GridPanel02.getTableDef().addColumnFilter("yrtxBlggYr"	, MSFSharedUtils.allowNulls(yrtxBlggYr.getValue())	, SimpleColumnFilter.OPERATOR_EQUALS); 
		yeta8300ToYe161090GridPanel02.getTableDef().addColumnFilter("cdVvalKrnCd"	, MSFSharedUtils.allowNulls("Y0140000")				, SimpleColumnFilter.OPERATOR_EQUALS); 
				
		yeta8300ToYe161090GridPanel02.reload();
	...
	private void createMsfGridForm() {
		...
		btnYetaSave.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				...
				Iterator<Record> iterRecords = yeta8300ToYe161090GridPanel01.getMsfGrid().getGrid().getStore().getModifiedRecords().iterator(); 
...
//					// 기존데이터
//					Iterator<BaseModel> itBm  = yeta8300ToYe161090GridPanel01.getMsfGrid().getGrid().getStore().getModels().listIterator(); 
//	            	  
...
//					Iterator<BaseModel> itBm = yeta8300ToYe161090GridPanel01.getMsfGrid().getGrid().getStore().getModels().iterator(); 
//					
...
//				}
				...
				MessageBox.confirm("삭제", "선택하신 교육비 내용을 삭제하시겠습니까?",new Listener<MessageBoxEvent>(){
					...
					public void handleEvent(MessageBoxEvent be) {
						if(Dialog.YES.equals(be.getButtonClicked().getItemId())){
							...
							Iterator<BaseModel> itBm = yeta8300ToYe161090GridPanel01.getMsfGrid().getGrid().getSelectionModel().getSelectedItems().listIterator();
		...
		yeta8300ToYe161090GridPanel01 = new MSFGridPanel(ye161090Def_01, false, false, false, false, false);
		yeta8300ToYe161090GridPanel01.setHeaderVisible(false);  
		yeta8300ToYe161090GridPanel01.setBodyBorder(false);
		yeta8300ToYe161090GridPanel01.setBorders(true);
		yeta8300ToYe161090GridPanel01.getBottomComponent().setVisible(true);
		...
		yeta8300ToYe161090GridPanel01.getGrid().getColumnModel().addAggregationRow(payrSummaryRow);  
		/** --- 그리드 합계 부분  시작 --- **/		
		   
		cpGrid01.add(yeta8300ToYe161090GridPanel01); 
		...
		btnYetaSave2.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				...
				Iterator<Record> iterRecords = yeta8300ToYe161090GridPanel02.getMsfGrid().getGrid().getStore().getModifiedRecords().iterator(); 
		...
		yeta8300ToYe161090GridPanel02 = new MSFGridPanel(ye161090Def_02, false, false, false, false, false);
		yeta8300ToYe161090GridPanel02.setHeaderVisible(false);  
		yeta8300ToYe161090GridPanel02.setBodyBorder(false);
		yeta8300ToYe161090GridPanel02.setBorders(true);
		yeta8300ToYe161090GridPanel02.getBottomComponent().setVisible(true);
		...
		yeta8300ToYe161090GridPanel02.getGrid().getColumnModel().addAggregationRow(payrSummaryRow2);  
		/** --- 그리드 합계 부분  시작 --- **/		
		   
		cpGrid02.add(yeta8300ToYe161090GridPanel02); 
		...
		popBindingCom0160.addListener(Events.Change, new Listener<BaseEvent>() {
			public void handleEvent(BaseEvent be) {
				...
				if (mapModels != null) {
					...
					yetaP830011Service.saveYeta8300ToYe161090tabItem08_3(listYe161090Dto, actionDatabase, new AsyncCallback<Long>() {
