...
@Service("YetaP13003Service")
public class YetaP13003ServiceImpl  extends AbstractCustomServiceImpl implements YetaP13003Service  ,YetaDaoConstants {

	 
	private static final Logger logger = LoggerFactory.getLogger(YetaP13003ServiceImpl.class);
	private static final String calledClass = YetaP13003ServiceImpl.class.getName();
	...
	//이월기부금 신규 수정 삭제부
	@Override
	public Long activityOnYetaP13003ToYeta3180(List<Ye16Ta3180DTO> listYeta3180dto, ActionDatabase actionDatabase) throws MSFException {
			...
			String windowId = "YETAP130003";
	        
			String method = calledClass + ".activityOnYetaP13003ToYeta3180";
			...
			try {  
				if (MSFSharedUtils.paramNull(yeta3180DAO)) {
					...
					yeta3180DAO = (Ye16Ta3180DAO) wac.getBean("Ye16Ta3180DAO" ); 
				}
...
//		            yeta3180Vo.setRsnoNumb(MSFSharedUtils.allowNulls(yeta3180Dto.getRsnoNumb().replace("-", "")));    		/** column 주민등록번호 : rsnoNumb */
		            ...
		            yeta3180Vo.setCtrbNcnt(new BigDecimal(MSFSharedUtils.defaultNulls(yeta3180Dto.getCtrbNcnt(), "0"))); //  CTRB_NCNT	기부금건수 
		            yeta3180Vo.setCtrbTgam(new BigDecimal(MSFSharedUtils.defaultNulls(yeta3180Dto.getCtrbTgam(), "0"))); // CTRB_TGAM	공제대상기부금액 
		            yeta3180Vo.setCtjaCham(new BigDecimal(MSFSharedUtils.defaultNulls(yeta3180Dto.getCtjaCham(), "0"))); // CTJA_CHAM	기부장려신청금액 
		            
		            yeta3180Vo.setCtrbCtnt(MSFSharedUtils.allowNulls(yeta3180Dto.getCtrbCtnt()));    	/** column  내용 : ctrbCtnt */
...
//		        	} 
				...
				result = iCnt;
		            ...
		            result = new Long(0);
		            throw MSFServerUtils.getOperationException("activityOnYetaP13001ToYeta3180", ex, logger);
		        }
		        finally {
	...
	//기부금등록내역 조회
	public PagingLoadResult<BaseModel> getYetaP13003To3180List(ServiceParameters serviceParameters) throws MSFException {
			

			PagingLoadResult<BaseModel> retval = null;
			String method =  CLASS_YETAP13003TOYETA3180_DATA_LIST;
...
//		            Collection<Map<String, Object>> list ??????
				...
				SmrmfUtils.endTiming(logger, millisBeginPsnl0126DataList, "getYetaP13003To3180List");
