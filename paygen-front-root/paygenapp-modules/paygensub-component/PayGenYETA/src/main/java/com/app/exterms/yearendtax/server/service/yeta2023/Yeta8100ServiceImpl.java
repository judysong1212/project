...
* </pre>
 */
@Service("Yeta8100Service")
public class Yeta8100ServiceImpl  extends AbstractCustomServiceImpl implements Yeta8100Service  ,YetaDaoConstants {

	 
	private static final Logger logger = LoggerFactory.getLogger(Yeta8100ServiceImpl.class);
	private static final String calledClass = Yeta8100ServiceImpl.class.getName();
	 ...
	 */
	//조회
	public PagingLoadResult<BaseModel> getYeta8100ToYe161010DataList(ServiceParameters serviceParameters) throws MSFException {
		

		PagingLoadResult<BaseModel> retval = null;
		String method =  CLASS_YETA8100_DATA_LIST;
...
//	     	psnl0100SrhVO.setPayrMangDeptCd(MSFSharedUtils.allowNulls(MSFServerUtils.getFilterValue(columnFilters, "payrMangDeptCd")));		//단위기관코드
            ...
            if ("FALSE".equals(chkDeptCd)) {
               ...
               ye161010SrhVO.setPayrMangDeptCd(sessionUser.getPayrMangDeptCd()); 
            	...
            	ye161010SrhVO.setPayrMangDeptCd(MSFSharedUtils.allowNulls(MSFServerUtils.getFilterValue(columnFilters, "deptCd"))) ;   //단위기관코드   
...
//	            Collection<Map<String, Object>> list ??????
	     		...
	     		switch ( tableAttributes[i].getType() ) {  
	            	...
	            	break; 
	          		...
	          		case ColumnDef.TYPE_STRING: 
	          			...
	          			}else if("resnRegnNum".equals(tableAttributes[i].getName())) {
	          				String rrnDecCrypt = "";
			...
			SmrmfUtils.endTiming(logger, millisBeginYeta8100ToYe161010DataList, "getYeta8100ToYe161010DataList");
     ...
     */
    @Override
    public  Long PayrExec_Yeta_2023_Insert(List<Ye161010DTO> listYe161010Dto) throws MSFException {
    		     
    	 
		String method = calledClass + ".PayrExec_Yeta_Insert_2023";
		...
		Ye160402_2023_VO ye160402Vo = new Ye160402_2023_VO(); // 과세감면소득
		Ye160403_2023_VO ye160403Vo = new Ye160403_2023_VO(); // 비과세감면소득
		...
		List<InfcPkgYe161010_2023_VO> listYe161010VO = new ArrayList<InfcPkgYe161010_2023_VO>();
     	...
     	//    {******************************급여자료 이관*******************************************}
		       ...
		       // [과세감면내역 삭제 ]
		        ye160401DAO.fnYeta8100_Ye160401_CREATE_Delete(ye160401Vo);
...
//				}				
				...
				yetaLsAdtr.setPayrToYeta_2023_Insert(RemoteServiceUtil.getThreadLocalRequest(),listYe161010VO);
			...
			logger.error("EXCEPTION calling PayrExec_Yeta_Insert_2023(): " + ex);
			
			/** 에러 로그 **/
			MSFLogHistoryUtils.tracerUserExceptionActivity(sessionUser, method,calledClass, "C", ex, windowNm, windowId);
		
			retval = 0L;
			throw MSFServerUtils.getOperationException("PayrExec_Yeta_Insert_2023", ex, logger);
		}
     ...
     */
    @Override
    public  Long Yeta8100ToYe160401_Delete(List<Ye161010DTO> listYe161010Dto) throws MSFException {
    	
		String method = calledClass + ".Yeta8100ToYe160401_Delete";

		String windowNm = "연말정산대상자관리";
		String windowId = "YETA8100";
...
//		Ye161020VO ye161020Vo = new Ye161020VO(); // 인적소득공제기본
	...
	@Override
	public Long UpDpobExec_Yeta_2023_Insert(List<Ye161010DTO> listYe161010Dto) throws MSFException {
		 
   	 
			String method = calledClass + ".UpDpobExec_Yeta_Insert_2023";
			...
			List<InfcPkgYe161010_2023_VO> listYe161010VO = new ArrayList<InfcPkgYe161010_2023_VO>();
	     	...
	     	//    {******************************급여자료 이관*******************************************}
				...
				if (listYe161010VO.size() > 0) {
					...
					// 컴포넌트 호출하기
					yetaLsAdtr.setUpDpopYeta_2023_Insert(RemoteServiceUtil.getThreadLocalRequest(),listYe161010VO);
				...
				logger.error("EXCEPTION calling UpDpobExec_Yeta_Insert_2023(): " + ex);
				
				/** 에러 로그 **/
				MSFLogHistoryUtils.tracerUserExceptionActivity(sessionUser, method,calledClass, "U", ex, windowNm, windowId);
			
				retval = 0L;
				throw MSFServerUtils.getOperationException("UpDpobExec_Yeta_Insert_2023", ex, logger);
			}
