...
import com.app.exterms.yearendtax.client.service.yeta2023.YetaT83005Service;
import com.app.exterms.yearendtax.client.service.yeta2023.YetaT83005ServiceAsync;
...
//import com.app.exterms.yearendtax.client.form.defs.yeta2016.YetaT83005Def;
...
=====================================================**/
public  class YetaT83005   extends MSFFormPanel {  
 ...
 **/
	...
	private  ContentPanel cpYetaT83005; 
	...
	// -------------- grid 선언 시작  ---------------	  
	private MSFGridPanel YetaT83005GridPanel;
//	private YetaT83005Def YetaT83005Def = new YetaT83005Def("YetaT83005");   //TODO 일단 화면번호로 Def
	// -------------- grid 선언 종료  ---------------
	...
	// -------------- 서비스 호출 시작 --------------
	private YetaT83005ServiceAsync yetaT83005Service = YetaT83005Service.Util.getInstance();
	// -------------- 서비스 호출 종료 --------------	 
...
//					ye162510Dto.setMnthRnttyHusCnttArea((MSFSharedUtils.allowNulls(bmMapModel.get("mnthRnttyHusCnttArea"))));    		/** column 월세주택계약면적 : mnthRnttyHusCnttArea */
				...
				yetaT83005Service.activityOnYetaT83005(listYe162510Dto, actionDatabase, new AsyncCallback<Long>(){
...
//		 }
	...
	public YetaT83005(final ActionDatabase actionDatabase, final MSFPanel caller) {
...
//		initLoad(); 	
		...
		this.actionDatabase = actionDatabase;
	 	...
	 	cpYetaT83005 = new ContentPanel();  

		createSearchForm();			//기본정보 필드를 적용
	 	createMsfGridForm();		//그리드필드
		   
		cpYetaT83005.setBodyBorder(false);
		cpYetaT83005.setBorders(false);
		cpYetaT83005.setHeaderVisible(false);
		cpYetaT83005.setSize("790px", "640px");
		   
		this.add(cpYetaT83005);
...
//		     });     
		...
		cpYetaT83005.setLayout(new FlowLayout());
...
//	      	     }
//				 
//				YetaT83005GridPanel.getMsfGrid().clearData();
//				 
//				BaseModel bmData = YetaT83005GridPanel.getTableDef().getDefaultValues();  
//		              
...
//		         
//		        YetaT83005GridPanel.getMsfGrid().getGrid().stopEditing();      
//		        YetaT83005GridPanel.getMsfGrid().getGrid().getStore().insert(bmData,0);   
//		        YetaT83005GridPanel.getMsfGrid().getGrid().startEditing(YetaT83005GridPanel.getMsfGrid().getGrid().getStore().indexOf(bmData), 0);   
//
...
//			public void handleEvent(ButtonEvent e) {
//				Iterator<BaseModel> itBm = YetaT83005GridPanel.getMsfGrid().getGrid().getSelectionModel().getSelectedItems().listIterator();
...
//		topYetaBtnBar.add(btnYetaDel);
		...
		btnYetaSave.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				setListRecord(YetaT83005GridPanel.getMsfGrid().getStore().getModifiedRecords().iterator());
				doAction(actionDatabase);
...
//			topYetaBtnBar.add(btnYetaClose);
		...
		cpYetaT83005.add(topYetaBtnBar);
...
//		YetaT83005GridPanel = new MSFGridPanel(YetaT83005Def, false, false, false, false, false);
//		YetaT83005GridPanel.setSize("790px", "420px");
//		YetaT83005GridPanel.setBorders(true);
//		YetaT83005GridPanel.setHeaderVisible(false);
//		
...
//		
//		YetaT83005GridPanel.getGrid().getColumnModel().addAggregationRow(payrSummaryRow);  
//		
...
//		
//		YetaT83005GridPanel.getGrid().getColumnModel().addAggregationRow(payrSummaryRow1);
//		/** --- 그리드 합계 부분  종료 --- **/
		
//      cpYetaT83005.add(YetaT83005GridPanel);
		...
		cpYetaT83005.add(fldstNewFieldset);
		cpYetaT83005.add(layoutContainer1_1);
		cpYetaT83005.add(fldstNewFieldset_1);
	...
	public void reload() {
			...
			YetaT83005GridPanel.getTableDef().setTableColumnFilters(filters);
			YetaT83005GridPanel.getTableDef().addColumnFilter("yrtxBlggYr", MSFSharedUtils.allowNulls(srhYrtxBlggYr.getValue())
...
//					, SimpleColumnFilter.OPERATOR_EQUALS);//연말정산귀속년도
			YetaT83005GridPanel.getTableDef().addColumnFilter("clutSeptCd", MSFSharedUtils.getSelectedComboValue(srhClutSeptCd,"commCd")
					, SimpleColumnFilter.OPERATOR_EQUALS);//정산구분
			YetaT83005GridPanel.getTableDef().addColumnFilter("systemkey", MSFSharedUtils.allowNulls(systemkey.getValue())
					, SimpleColumnFilter.OPERATOR_EQUALS);//시스템키
		 
			YetaT83005GridPanel.reload();
