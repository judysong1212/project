...
import com.app.exterms.yearendtax.client.form.defs.yeta2022.Yeta7080Def;
...
=====================================================**/
public class Yeta7080  extends MSFPanel { 
	...
	private FormPanel plFrmYeta7080;
	private FormData formData; 
	private String txtForm = "";
	private XTemplate detailTp;	  
//	private Yeta7080ServiceAsync Yeta7080service = Yeta7080Service.Util.getInstance();
	...
	private Yeta7080Def Yeta7080Def 				= new Yeta7080Def("yeta7080ToBass0400");
//	private Yeta7080Def Yeta7080ToSysm0100OnDef 	= new Yeta7080Def("Yeta7080ToSysm0100On");
//	private Yeta7080Def Yeta7080ToSysm0100OffDef 	= new Yeta7080Def("Yeta7080ToSysm0100Off");	
	private InfcPkgSysm0100Def Yeta7080ToSysm0100OnDef 		= new InfcPkgSysm0100Def("yeta7080ToSysm0100On");
	private InfcPkgSysm0100Def Yeta7080ToSysm0100OffDef 	= new InfcPkgSysm0100Def("yeta7080ToSysm0100Off");
	
	private MSFGridPanel msfGridPanelYeta7080; 
...
//			final RelationDef  relBass0360 = new RelationDef(Yeta7080MSDef,false);
//			relBass0360.addJoinDef("dpobCd", "dpobCd"); 
//			relBass0360.addJoinDef("deptCd", "deptCd"); 
//			relBass0360.setLinkedObject(msfGridPanelYeta7080MS);
//			Yeta7080ToBass0500OnDef.addRelation(relBass0360); 
//
//			/**
//			 * Create the relations 
//			 */
//			final RelationDef  relBass0350 = new RelationDef(Yeta7080MSDef,false);
//			relBass0350.addJoinDef("dpobCd", "dpobCd"); 
//			relBass0350.addJoinDef("deptCd", "deptCd"); 
//			relBass0350.setLinkedObject(msfGridPanelYeta7080MS);
//			Yeta7080ToBass0500OffDef.addRelation(relBass0350); 
//
//
//			// DETAILS 
//			final Grid Yeta7080ToBass0500OffDefGrid = msfGridPanelYeta7080MS.getMsfGrid().getGrid();
//			Yeta7080ToBass0500OffDefGrid.addListener(Events.CellDoubleClick, new Listener<BaseEvent>() {
//				public void handleEvent(BaseEvent be) {  
//					if (msfGridPanelYeta7080MS.getCurrentlySelectedItem() != null) {  
//
//						Yeta7080ToBass0500OnDef.synchronizeGridDetail(
//								msfGridPanelYeta7080MS.getCurrentlySelectedItem(),
//								msfGridPanelBass0500On );
//
//						Yeta7080ToBass0500OffDef.synchronizeGridDetail(
//								msfGridPanelYeta7080MS.getCurrentlySelectedItem(),
...
//			});
	...
	public Yeta7080(String txtForm) {
...
//		lsDtilOccuInttnCd = PrgmComComboUtils.getSingleBass0350ComboData(sysComBass0350Dto);
		...
		plFrmYeta7080 = new FormPanel();
		plFrmYeta7080.setHeadingText("PayGen Ver1.0 - 연말정산등록담당자관리");
		plFrmYeta7080.setIcon(Resources.APP_ICONS.text());
		plFrmYeta7080.setBodyStyleName("pad-text");
		plFrmYeta7080.setFrame(true); 
		plFrmYeta7080.setPadding(2);
		/************************************************************************
		...
		btnlogView.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				 //로그 뷰화면 호출 메서드 
				  funcLogMessage("연말정산등록담당자관리","Yeta7080");
				}
			});
		plFrmYeta7080.getHeader().setStyleAttribute("padding", "5px 0 2px 0");
		plFrmYeta7080.getHeader().addTool(btnlogView); 
		/************************************************************************
		 * 화면 에러 처리시 필요한 부분으로 추가 
		 ************************************************************************/
		deptCd = new HiddenField<String>();
		deptCd.setName("deptCd");
		plFrmYeta7080.add(deptCd);
		
		HorizontalPanel inner = new HorizontalPanel();
		inner.setBorders(false);
		inner.setLayout(new FitLayout());
//		Yeta7080Def.setReadOnly(true);
		msfGridPanelYeta7080 = new MSFGridPanel(Yeta7080Def, false, false, false, true, false);
		msfGridPanelYeta7080.setSize(300, 610);
		msfGridPanelYeta7080.setBorders(true);
		msfGridPanelYeta7080.getGrid().setBorders(true);
		Grid grid = msfGridPanelYeta7080.getMsfGrid().getGrid();
		grid.addListener(Events.CellDoubleClick , new Listener<BaseEvent>() {
			public void handleEvent(BaseEvent be) {
				
				
				BaseModel bmData = msfGridPanelYeta7080.getCurrentlySelectedItem();  
		...
		msfGridPanelYeta7080.setTopComponent(lycSreach);
		inner.add(msfGridPanelYeta7080);
          
          
		// 선택된 사용자 
		msfGridPanelSysm0100On = new MSFGridPanel(Yeta7080ToSysm0100OnDef, false, false, false, false,false); 
...
//						infcPkgSysm0100Dto.setUntDpobCd(MSFSharedUtils.allowNulls(egovMap.get("untDpobCd")));    /** column 단위사업장코드 : untDpobCd */
		...
		bottomToolbar.add(refresh);
   	    ...
   	    Yeta7080ToSysm0100OffDef.setReadOnly(true);
   	    // ------------------------ 미선택된 사용자
   	    msfGridPanelSysm0100Off = new MSFGridPanel(Yeta7080ToSysm0100OffDef, false, false, false, false, false); 
...
//						infcPkgSysm0100Dto.setUntDpobCd(MSFSharedUtils.allowNulls(egovMap.get("untDpobCd")));    /** column 단위사업장코드 : untDpobCd */
		...
		plFrmYeta7080.add(inner);

		vp.add(plFrmYeta7080);
		plFrmYeta7080.setSize("990px", "680px");
	}

	private Yeta7080 getThis() {
		return this;
	}
    ...
    public void reDeptload() {
    	...
    	msfGridPanelYeta7080.getTableDef().setTableColumnFilters(filters);   
    	msfGridPanelYeta7080.getTableDef().addColumnFilter("deptNmHan", MSFSharedUtils.defaultNulls(deptNmHan.getValue(),""), SimpleColumnFilter.OPERATOR_LIKE); 
    	msfGridPanelYeta7080.reload();
		...
		infcPkgSysm0100Service.updateInfcPkgSysm0100Yn(infcPkgSysm0100Liar , new AsyncCallback<Integer>() {
			...
			public void onFailure(Throwable caught) {
				MessageBox.alert( MSFMainApp.MSFCONSTANTS.ExceptionTitleService()
									, MSFMainApp.ADMINMESSAGES.ExceptionMessageService("activityOnYeta7300ToYe161030("+ " 오류 : " + ") : " + caught)
									, null);
				}
