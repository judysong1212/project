 ...
 */
public class Ye167110BM   extends MSFSimpleBaseModel implements IsSerializable  {
    ...
    /** set 사업장소재지 : pdfAdr */
    public static final String ATTR_PDFADR = "pdfAdr";
    ...
    /** set 사업장소재지 : pdfAdr */
    public void setPdfAdr(String  pdfAdr) { set( ATTR_PDFADR ,pdfAdr);}
    /** get 사업장소재지 : pdfAdr */
    public String  getPdfAdr() { return (String )get( ATTR_PDFADR );}
