...
* </pre>
 */
@Service("Yeta6200Service")
public class Yeta6200ServiceImpl  extends AbstractCustomServiceImpl implements Yeta6200Service  ,YetaDaoConstants {

	 
	private static final Logger logger = LoggerFactory.getLogger(Yeta6200ServiceImpl.class);
	private static final String calledClass = Yeta6200ServiceImpl.class.getName();
	 ...
	 */
	//조회
	public PagingLoadResult<BaseModel> getYeta6200ToYe161010DataList(ServiceParameters serviceParameters) throws MSFException {
		

		PagingLoadResult<BaseModel> retval = null;
		String method =  CLASS_YETA6200_DATA_LIST;
...
//	            Collection<Map<String, Object>> list ??????
			...
			SmrmfUtils.endTiming(logger, millisBeginYeta6100ToYe161010DataList, "getYeta4100ToYe161010DataList");
	 ...
	 */
	//조회
	public PagingLoadResult<BaseModel> getYeta6200ToYe161010ResultDataList(ServiceParameters serviceParameters) throws MSFException {
