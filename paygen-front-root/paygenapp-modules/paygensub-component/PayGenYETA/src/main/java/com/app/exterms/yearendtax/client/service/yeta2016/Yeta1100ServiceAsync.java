...
public interface Yeta1100ServiceAsync {
	
	/** 연말정산 대상자 삭제 **/
	public void YETA1100_TO_YETA2000_DELETE(List<Ye16Ta2000DTO> listYeta2000Dto, AsyncCallback<Long> callback);
	
	
	/** 급여자료 이관 **/
	public void PayrExec_Yeta_2016_Insert(List<Ye16Ta2000DTO> listYeta2000Dto, AsyncCallback<Long> callback);
...
//     
//	public void Payr06420_Payr400_Delete(List<Yeta2000DTO> listYeta2000Dto, AsyncCallback<Long> callback);
//	
