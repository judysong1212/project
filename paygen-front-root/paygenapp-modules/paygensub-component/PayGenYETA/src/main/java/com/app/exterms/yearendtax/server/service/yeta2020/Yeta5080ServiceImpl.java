...
import com.app.exterms.yearendtax.client.service.yeta2020.Yeta5080Service;
import com.app.exterms.yearendtax.server.service.yeta2020.dao.Yeta5080_2020_DAO;
...
@Service("Yeta5080Service")
public class Yeta5080ServiceImpl extends AbstractCustomServiceImpl implements YetaDaoConstantsGenerated, Yeta5080Service {

	private static final Logger logger = LoggerFactory.getLogger(Yeta5080ServiceImpl.class);
	private static final String calledClass = Yeta5080ServiceImpl.class.getName();

	@Autowired
	@Resource(name = "Yeta5080_2020_DAO")
	private Yeta5080_2020_DAO yeta5080DAO;
	...
	public PagingLoadResult<BaseModel> getSelectYeta5080ToBass0400List(ServiceParameters serviceParameters) throws MSFException {

        PagingLoadResult<BaseModel> retval = null;
        String method =  CLASS_YETA2080_TO_BASS0400_LIST;
        Yeta2080Srh_2020_VO   yeta2080SrhVo = new Yeta2080Srh_2020_VO();
        //Yeta2080VO      Yeta2080Vo = new Yeta2080VO();
        List<BaseModel>  bmResult = new ArrayList<BaseModel>();
        MSFSysm0100BM sessionUser = MSFServerUtils.getLoggedUser(RemoteServiceUtil.getThreadLocalRequest());
        
        if(MSFSharedUtils.paramNull(yeta5080DAO)){
        	WebApplicationContext wac = WebApplicationContextUtils.getRequiredWebApplicationContext(getHttpServletRequest().getSession().getServletContext());
        	yeta5080DAO = (Yeta5080_2020_DAO) wac.getBean("Yeta5080_2020_DAO");
        }
        ...
        try{
            ...
            if(pagingValues.executeRecordCount){ 
            	...
            	int iResultCnt = yeta5080DAO.selectYeta5080ListTotCnt(yeta2080SrhVo);
            ...
            List list = yeta5080DAO.selectYeta5080List(yeta2080SrhVo);
            ...
            SmrmfUtils.endTiming(logger, millisBeginSelectYeta2080List, "selectYeta5080List");
