...
import com.app.exterms.yearendtax.client.service.yeta2021.YetaP630010Service;
...
@Service("YetaP630010Service")
public class YetaP630010ServiceImpl  extends AbstractCustomServiceImpl implements YetaP630010Service  ,YetaDaoConstants {

	 
	private static final Logger logger = LoggerFactory.getLogger(YetaP630010ServiceImpl.class);
	private static final String calledClass = YetaP630010ServiceImpl.class.getName();
	...
	public int activityOnYetaP630010ToYe160405(Ye160405DTO ye160405Dto, ActionDatabase actionDatabase) throws MSFException {
		...
		String method = calledClass + ".activityOnYetaP630010ToYe160405";

		String windowNm = "소득공제신고자료관리";
		String windowId = "YETAP6300";
		...
		try {
			...
			String nResult = AnyCryptUtils.XecureCryptInitialize(RemoteServiceUtil.getThreadLocalConfig(),RemoteServiceUtil.getThreadLocalRequest());
				...
				result = ye160405DAO.updateYetaP630010ToYe160405(ye160405Vo); 
		          
		} catch (Exception ex) {
			logger.error("EXCEPTION calling activityOnYetaP630010ToYe160405(): "+ ex);
			...
			result = 0;
			throw MSFServerUtils.getOperationException("activityOnYetaP630010ToYe160405", ex, logger);
	...
	public Ye160405DTO getYetaP630010ToYe160405List(Ye160405DTO ye160405Dto) throws MSFException {
		...
		Ye160405Srh_2021_VO ye160405SrhVo = new Ye160405Srh_2021_VO();
		MSFSysm0100BM sessionUser;

		String method = calledClass + ".getYetaP630010ToYe160405List";

		String windowNm = "소득공제신고자료관리";
		String windowId = "YETAP630008";
		...
		try {
			...
			egovResultDataList = ye160405DAO.selectYetaP630010ToYe160405List(ye160405SrhVo);
