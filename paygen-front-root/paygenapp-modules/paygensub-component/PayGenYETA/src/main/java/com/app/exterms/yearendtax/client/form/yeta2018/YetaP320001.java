...
=====================================================**/
public  class YetaP320001   extends MSFFormPanel {  
	...
	private TabPanel tabYetaP320001;
	 ...
	 *~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ 		
	 **/ 		    
	public YetaP320001(final ActionDatabase actionDatabase, final MSFPanel caller) {
	...
	private void createStandardForm() {
		...
		tabYetaP320001 = new TabPanel(); // 인사탭정보설정을 위한 tab
		tabYetaP320001.setStyleAttribute("paddingTop", "3px");
		tabYetaP320001.setStyleAttribute("paddingLeft", "2px");
		// tabsBass0350.setMinTabWidth(80);
		tabYetaP320001.setAutoWidth(false);
		// tabsBass0350.setResizeTabs(true);
		tabYetaP320001.setAnimScroll(true);
		tabYetaP320001.setTabScroll(true);
		tabYetaP320001.setPlain(true);
		tabYetaP320001.setSize(885, 595);
		...
		tabYetaP320001.add(item_PDF_A102Y);
		...
		tabYetaP320001.add(item_PDF_B101Y);
		...
		tabYetaP320001.add(item_PDF_C101Y);
		...
		tabYetaP320001.add(item_PDF_C202Y);
		...
		tabYetaP320001.add(item_PDF_C301Y);
		...
		tabYetaP320001.add(item_PDF_C401Y);
		...
		tabYetaP320001.add(item_PDF_D101Y);
		...
		tabYetaP320001.add(item_PDF_E102Y);
		...
		tabYetaP320001.add(item_PDF_F102Y);
		...
		tabYetaP320001.add(item_PDF_G107Y);
		...
		tabYetaP320001.add(item_PDF_G207Y);
		...
		tabYetaP320001.add(item_PDF_G307Y);
		...
		tabYetaP320001.add(item_PDF_J101Y);
		...
		tabYetaP320001.add(item_PDF_J203Y);
		...
		tabYetaP320001.add(item_PDF_J301Y);
		...
		tabYetaP320001.add(item_PDF_J401Y);
		...
		tabYetaP320001.add(item_PDF_K101Y);
		...
		tabYetaP320001.add(item_PDF_L102Y);
		...
		tabYetaP320001.add(item_PDF_N101Y);
		...
		tabYetaP320001.add(item_PDF_O101Y);
		...
		tabYetaP320001.add(item_PDF_P102Y);

		fieldSet.add(tabYetaP320001);
	...
	private void formInit() {
		...
		//		YetaP320001GridPanel.getMsfGrid().clearData();
