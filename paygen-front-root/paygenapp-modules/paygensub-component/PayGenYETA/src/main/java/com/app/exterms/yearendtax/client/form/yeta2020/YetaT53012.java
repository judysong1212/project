...
import com.app.exterms.yearendtax.client.service.yeta2020.YetaT53012Service;
import com.app.exterms.yearendtax.client.service.yeta2020.YetaT53012ServiceAsync;
...
=====================================================**/
public  class YetaT53012   extends MSFFormPanel {  
 ...
 **/
	...
	private  ContentPanel cpYetaT53012; 
	...
	// -------------- grid 선언 시작  ---------------	  
	private MSFGridPanel YetaT53012GridPanel;
//	private YetaT53012Def YetaT53012Def = new YetaT53012Def("YetaT53012");   //TODO 일단 화면번호로 Def
	// -------------- grid 선언 종료  ---------------
	...
	// -------------- 서비스 호출 시작 --------------
	private YetaT53012ServiceAsync yetaT53012Service = YetaT53012Service.Util.getInstance();
	// -------------- 서비스 호출 종료 --------------	 
...
//					ye162510Dto.setMnthRnttyHusCnttArea((MSFSharedUtils.allowNulls(bmMapModel.get("mnthRnttyHusCnttArea"))));    		/** column 월세주택계약면적 : mnthRnttyHusCnttArea */
				...
				yetaT53012Service.activityOnYetaT53012(listYe162510Dto, actionDatabase, new AsyncCallback<Long>(){
...
//		 }
	...
	public YetaT53012(final ActionDatabase actionDatabase, final MSFPanel caller) {
...
//		initLoad(); 	
		...
		this.actionDatabase = actionDatabase;
	 	...
	 	cpYetaT53012 = new ContentPanel();  

		createSearchForm();			//기본정보 필드를 적용
	 	createMsfGridForm();		//그리드필드
		   
		cpYetaT53012.setBodyBorder(false);
		cpYetaT53012.setBorders(false);
		cpYetaT53012.setHeaderVisible(false);
		cpYetaT53012.setSize("790px", "640px");
		   
		this.add(cpYetaT53012);
...
//		     });     
		...
		cpYetaT53012.setLayout(new FlowLayout());
...
//	      	     }
//				 
//				YetaT53012GridPanel.getMsfGrid().clearData();
//				 
//				BaseModel bmData = YetaT53012GridPanel.getTableDef().getDefaultValues();  
//		              
...
//		         
//		        YetaT53012GridPanel.getMsfGrid().getGrid().stopEditing();      
//		        YetaT53012GridPanel.getMsfGrid().getGrid().getStore().insert(bmData,0);   
//		        YetaT53012GridPanel.getMsfGrid().getGrid().startEditing(YetaT53012GridPanel.getMsfGrid().getGrid().getStore().indexOf(bmData), 0);   
//
...
//			public void handleEvent(ButtonEvent e) {
//				Iterator<BaseModel> itBm = YetaT53012GridPanel.getMsfGrid().getGrid().getSelectionModel().getSelectedItems().listIterator();
...
//				
		...
		btnYetaSave.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				setListRecord(YetaT53012GridPanel.getMsfGrid().getStore().getModifiedRecords().iterator());
				doAction(actionDatabase);
...
//				
		cpYetaT53012.add(topYetaBtnBar);
...
//		YetaT53012GridPanel = new MSFGridPanel(YetaT53012Def, false, false, false, false, false);
//		YetaT53012GridPanel.setSize("790px", "420px");
//		YetaT53012GridPanel.setBorders(true);
//		YetaT53012GridPanel.setHeaderVisible(false);
...
//		
//		YetaT53012GridPanel.getGrid().getColumnModel().addAggregationRow(payrSummaryRow);  
//		
...
//		
//		YetaT53012GridPanel.getGrid().getColumnModel().addAggregationRow(payrSummaryRow1);
//		/** --- 그리드 합계 부분  종료 --- **/
		
//        cpYetaT53012.add(YetaT53012GridPanel);
...
//		layoutContainer7.setStyleAttribute("marginBottom", "5px")
		...
		cpYetaT53012.add(fldstNewFieldset_1);
		cpYetaT53012.add(fldstNewFieldset_4);
	...
	public void reload() {
			...
			YetaT53012GridPanel.getTableDef().setTableColumnFilters(filters);
			YetaT53012GridPanel.getTableDef().addColumnFilter("yrtxBlggYr", MSFSharedUtils.allowNulls(srhYrtxBlggYr.getValue())
...
//					, SimpleColumnFilter.OPERATOR_EQUALS);//연말정산귀속년도
			YetaT53012GridPanel.getTableDef().addColumnFilter("clutSeptCd", MSFSharedUtils.getSelectedComboValue(srhClutSeptCd,"commCd")
					, SimpleColumnFilter.OPERATOR_EQUALS);//정산구분
			YetaT53012GridPanel.getTableDef().addColumnFilter("systemkey", MSFSharedUtils.allowNulls(systemkey.getValue())
					, SimpleColumnFilter.OPERATOR_EQUALS);//시스템키
		 
			YetaT53012GridPanel.reload();
