...
public interface YetaT330171Service extends RemoteService {
	/**
	...
	public static class Util {
		...
		public static YetaT33017ServiceAsync getInstance(){
			if (instance == null) {
				instance = GWT.create(YetaT330171Service.class);
			}
			return instance;
		}
	}
	...
	public Long activityOnYetaT33017(List<Ye162510DTO> listYe162510Dto, ActionDatabase actionDatabase) throws MSFException;
}
