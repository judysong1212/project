...
@Service("YetaP13006Service")
public class YetaP13006ServiceImpl  extends AbstractCustomServiceImpl implements YetaP13006Service  ,YetaDaoConstants {

	 
	private static final Logger logger = LoggerFactory.getLogger(YetaP13006ServiceImpl.class);
	private static final String calledClass = YetaP13006ServiceImpl.class.getName();
	...
	@Override
	public Long activityOnYetaP13006ToYeta3110(List<Ye16Ta3110DTO> listYeta3110dto, ActionDatabase actionDatabase) throws MSFException {
			// TODO Auto-generated method stub
			Long result = new Long(0);
			Long iCnt = new Long(0);
			
			MSFSysm0100BM sessionUser;
			String method = calledClass + ".activityOnYetaP13006ToYeta3110";
			
			String windowNm = "소득공제신고자료관리";
			String windowId = "YETAP130006";
			...
			try {  
				if (MSFSharedUtils.paramNull(yeta3110DAO)) {
					...
					yeta3110DAO = (Ye16Ta3110DAO) wac.getBean("Ye16Ta3110DAO" ); 
				}
				...
				logger.error("EXCEPTION calling activityOnYetaP13001ToYeta3170(): "+ ex); 
				...
				result = new Long(0);
				throw MSFServerUtils.getOperationException("activityOnYetaP13001ToYeta3170", ex, logger);
			}
			finally {
	...
	//종전근무지 조회
	public PagingLoadResult<BaseModel> getYetaP13006To3100List(ServiceParameters serviceParameters) throws MSFException {
			
		PagingLoadResult<BaseModel> retval = null;
		String method = CLASS_YETAP13006TOYETA3110_DATA_LIST;
