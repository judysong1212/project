...
import com.app.exterms.yearendtax.client.dto.yeta2020.InfcPsnl0100BM;
import com.app.exterms.yearendtax.client.dto.yeta2020.Ye160401BM;
import com.app.exterms.yearendtax.client.dto.yeta2020.Ye161010BM;
import com.app.exterms.yearendtax.client.dto.yeta2020.Ye161020BM;
...
//    private PayrConstants PayrLabel = PayrConstants.INSTANCE;
	...
	public Ye161010Def(String chkPayrDef) {
		...
		if("Yeta5100".equals(chkPayrDef)){
			setDaoClass("");
			setCustomListMethod(CLASS_YETA5100_DATA_LIST);
			setAutoFillGrid(false);
			setShowFilterToolbar(false);
			setCheckBoxOnGridRows(false);
			
			setColumnsDefinition(getYeta3100ColumnsList());
			
		}else if("Yeta5200".equals(chkPayrDef)){
			setDaoClass("");
			setCustomListMethod(CLASS_YETA5200_DATA_LIST);
			setAutoFillGrid(true);
			setShowFilterToolbar(false);
			setCheckBoxOnGridRows(true);
			setEditFieldGrid(false);
			
			setColumnsDefinition(getYeta3200ToYe161010List());
			
		}else if("Yeta5300".equals(chkPayrDef)){
			setDaoClass("");
			setCustomListMethod(CLASS_YETA5300_TO_YE161010_DATA_LIST);
			setAutoFillGrid(false);
			setShowFilterToolbar(false);
			setCheckBoxOnGridRows(true);
			setEditFieldGrid(false);
			setColumnsDefinition(getYeta3300ToYe161010List());
		}else{
			setTitle("");
	        setDaoClass("");
	        setCustomListMethod(CLASS_YETA5200_RESULT_DATA_LIST);
	  	  	setAutoFillGrid(true);
	        setShowFilterToolbar(false);   
	        setCheckBoxOnGridRows(false); 
		    setEditFieldGrid(false);
	...
	private List<ColumnDef> getYeta3100ColumnsList() {
	...
	private List<ColumnDef> getYeta3200ToYe161010List() {
	...
	private List<ColumnDef> getYeta3300ToYe161010List() {
