...
@RemoteServiceRelativePath("Yeta6400Service.gwt")
public interface Yeta6400Service extends RemoteService {
	/**
	 * Utility class for simplifying access to the instance of async service.
	 */
	public static class Util {
		private static Yeta6400ServiceAsync instance;
		public static Yeta6400ServiceAsync getInstance(){
			if (instance == null) {
				instance = GWT.create(Yeta6400Service.class);
			}
			return instance;
		}
	}
