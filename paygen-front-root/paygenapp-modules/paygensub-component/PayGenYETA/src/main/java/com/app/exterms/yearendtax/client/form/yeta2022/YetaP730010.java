...
import com.app.exterms.yearendtax.client.service.yeta2022.YetaP730010Service;
import com.app.exterms.yearendtax.client.service.yeta2022.YetaP730010ServiceAsync;
...
=====================================================**/
public  class YetaP730010   extends MSFFormPanel { 
 ...
 **/
	...
	private ContentPanel cpYeta730010;
   ...
   */
	...
	// -------------- 서비스 호출 시작 --------------
	private YetaP730010ServiceAsync yetaP730010Service = YetaP730010Service.Util.getInstance();
	// -------------- 서비스 호출 종료 --------------
 ...
 **/	  
	...
	public YetaP730010(final ActionDatabase actionDatabase, final MSFFormPanel caller) {
		...
		cpYeta730010 = new ContentPanel();

		createStandardForm();
		setReadOnlyFalseYetaP13008();

		cpYeta730010.setBodyBorder(false);
		cpYeta730010.setBorders(false);
		cpYeta730010.setHeaderVisible(false);
		cpYeta730010.setSize("790px", "720px");

		this.add(cpYeta730010);
	...
	private void createStandardForm() {
		...
		cpYeta730010.add(whdgDebrBusoprRgstnum);
		
		
		deptNm = new HiddenField<String>();
		deptNm.setName("deptNm");
		cpYeta730010.add(deptNm);
		
		hanNm = new HiddenField<String>();
		hanNm.setName("hanNm");
		cpYeta730010.add(hanNm);
...
//				}
		...
		cpYeta730010.add(topYetaBtnBar);
...
//		lcSchCenter2_1.add(taxmSt10Jong, new FormData("100%"));
	...
	private void YetaP730010FormSave() {  
...
//		ye160405Dto.setTaxmSy21Jong((Long)taxmSy21Jong.getValue());    /** column 비과세소득_Y21_비과세 : taxmSy21Jong */
		...
		yetaP730010Service.activityOnYetaP730010ToYe160405(ye160405Dto, actionDatabase, new AsyncCallback<Integer>(){
					public void onFailure(Throwable caught) {
						MessageBox.alert(MSFMainApp.MSFCONSTANTS.ExceptionTitleService(), 
	                              MSFMainApp.ADMINMESSAGES.ExceptionMessageService("activityOnYetaP730010ToYe160405(" + actionDatabase.name() + ") : " + caught), null);
					}
	...
	public void reload() {
		...
		yetaP730010Service.getYetaP730010ToYe160405List(ye160405Dto, new AsyncCallback<Ye160405DTO>(){
	...
	/** 비과세 및 감면소득 조회부 **/
	public void readYetaP730010Data(Ye160405DTO result) {
