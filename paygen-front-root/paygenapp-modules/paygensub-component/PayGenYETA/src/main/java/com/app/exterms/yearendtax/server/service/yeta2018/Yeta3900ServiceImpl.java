...
import com.app.exterms.yearendtax.server.service.yeta2018.dao.Ye17TaPyyt0302_2018_DAO;
import com.app.exterms.yearendtax.server.service.yeta2018.dao.Ye17TaPyyt0304_2018_DAO;
import com.app.exterms.yearendtax.server.vo.Pyyt0302Srh_2018_VO;
...
* </pre>
 */
@Service("Yeta3900Service")
public class Yeta3900ServiceImpl  extends AbstractCustomServiceImpl implements Yeta3900Service  ,YetaDaoConstants {

	 
	private static final Logger logger = LoggerFactory.getLogger(Yeta3900ServiceImpl.class);
	private static final String calledClass = Yeta3900ServiceImpl.class.getName();

	// 급여대상자
	@Autowired
	@Resource(name = "Ye17TaPyyt0304_2018_DAO")
	private Ye17TaPyyt0304_2018_DAO pyyt0304DAO;
	
	// 수당/공제내역
	@Autowired
	@Resource(name = "Ye17TaPyyt0302_2018_DAO")
	private Ye17TaPyyt0302_2018_DAO pyyt0302DAO;
	 ...
	 * @throws MSFException
	 */
	public PagingLoadResult<BaseModel> getYeta3900ToPyyt0304List(ServiceParameters serviceParameters) throws MSFException {

 	        PagingLoadResult<BaseModel> retval = null;
//	        String method =  "getPsnl0100ToRemt0100DataList";
	        String method = CLASS_YETA3900_TO_PYYT0304_DATA_LIST;
	        Pyyt0304Srh_2018_VO   pyyt0304SrhVo = new Pyyt0304Srh_2018_VO();
	        ...
	        if  (MSFSharedUtils.paramNull(pyyt0304DAO)) {
	            ...
	            pyyt0304DAO = (Ye17TaPyyt0304_2018_DAO) wac.getBean("Ye17TaPyyt0304_2018_DAO"); 
	        }
...
//	            Collection<Map<String, Object>> list  
	 ...
	 * @throws MSFException
	 */
	public PagingLoadResult<BaseModel> getYeta2900ToPyyt0302ExtpyList(ServiceParameters serviceParameters) throws MSFException {

 	        PagingLoadResult<BaseModel> retval = null;
//	        String method =  "getPsnl0100ToRemt0100DataList";
	        String method = CLASS_YETA3900_TO_PYYT0302_EXTPY_DATA_LIST;
	        Pyyt0302Srh_2018_VO   pyyt0302SrhVo = new Pyyt0302Srh_2018_VO();
	        Pyyt0302_2018_VO      pyyt0304Vo = new Pyyt0302_2018_VO();
	        List<BaseModel>  bmResult = new ArrayList<BaseModel>();
	        ...
	        if  (MSFSharedUtils.paramNull(pyyt0302DAO)) {
	            ...
	            pyyt0302DAO = (Ye17TaPyyt0302_2018_DAO) wac.getBean("Ye17TaPyyt0302_2018_DAO"); 
	        }
...
//	            Collection<Map<String, Object>> list  
	 ...
	 * @throws MSFException
	 */
	public PagingLoadResult<BaseModel> getYeta2900ToPyyt0302DducList(ServiceParameters serviceParameters) throws MSFException {

 	        PagingLoadResult<BaseModel> retval = null;
//	        String method =  "getPsnl0100ToRemt0100DataList";
	        String method = CLASS_YETA3900_TO_PYYT0302_DDUC_DATA_LIST;
	        Pyyt0302Srh_2018_VO   pyyt0302SrhVo = new Pyyt0302Srh_2018_VO();
	        Pyyt0302_2018_VO      pyyt0304Vo = new Pyyt0302_2018_VO();
	        List<BaseModel>  bmResult = new ArrayList<BaseModel>();
...
//	            Collection<Map<String, Object>> list  
	...
	/** 수당/공제항목 저장 및 삭제 **/ 
	@Override
	public int saveYeta3900ToPyyt0302(List<Pyyt0302DTO> listPyyt0302Dto, String flag)throws MSFException {
		...
		String method = calledClass + ".saveYeta2900ToPyyt0302";
		MSFSysm0100BM sessionUser = MSFServerUtils.getLoggedUser(RemoteServiceUtil.getThreadLocalRequest());
		...
		try{
			...
			for(int iYetaCnt=0; iYetaCnt < listPyyt0302Dto.size(); iYetaCnt++) {
				...
				pyyt0304Vo = new Pyyt0304_2018_VO();
	...
	/** 대상자 삭제 **/ 
	@Override
	public int deleteYeta3900List(List<Pyyt0302DTO> listPyyt0302Dto)throws MSFException {
		// TODO Auto-generated method stub
		...
		String method = calledClass + ".deleteYeta2900List";
		MSFSysm0100BM sessionUser = MSFServerUtils.getLoggedUser(RemoteServiceUtil.getThreadLocalRequest());
...
//				pyyt0302Vo.setRevnAddr(RemoteServiceUtil.getThreadLocalRequest().getRemoteHost());
	...
	public Pyyt0304BM Yeta2900InfoList(Pyyt0304DTO pyyt0304Dto) {
		...
		String method = calledClass + ".Yeta3900InfoList";
...
//			int iResultCnt = yeta2000DAO.selectYeta0300To2000ListTotCnt(pyyt0304SrhVo);  
	...
	@Override
	public Pyyt0304BM Yeta3900InfoList(Pyyt0304DTO Pyyt0304Dto)
			throws MSFException {
		// TODO Auto-generated method stub
		return null;
	}
