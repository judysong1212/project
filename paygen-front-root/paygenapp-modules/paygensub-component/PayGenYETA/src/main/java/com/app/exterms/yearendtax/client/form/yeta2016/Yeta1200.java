...
import com.app.exterms.yearendtax.client.service.yeta2016.Yeta1200ServiceAsync;
 ...
 * =====================================================
 **/
public class Yeta1200 extends MSFPanel {
	...
	private FormPanel plFrmYeta1200;
	private String txtForm = "";
 
	 
	private MSFGridPanel yeta2000GridPanel;
	private MSFGridPanel yeta2000XmlGridPanel;
	private Ye16Ta2000Def yeta2000def = new Ye16Ta2000Def("YETA1200");
	private Ye16Ta2000Def yeta2000defXml = new Ye16Ta2000Def("YETA1200_RESULT");
...
//	private MSFGridPanel typOccuCdGridPanel;
	...
	// -------------- 상단 버튼 시작 --------------
	private ButtonBar topYeta1200Bar;
	private Button btnYeta1200Reset; 	// 초기화
	private Button btnYeta1200New; 		// 신규
	private Button btnYeta1200Save; 	// 저장
	private Button btnYeta1200Del; 		// 삭제
	private Button btnYeta1200Sreach; 	// 조회
	private Button btnYeta1200Print; 	// 인쇄
	 ...
	 * ++++++++++++++++++++++
	 **/
	 private Yeta1200ServiceAsync yeta1200Service = Yeta1200Service.Util.getInstance(); 
	 ...
	 */
	private void checkYeta1200Auth(String authAction, ListStore<BaseModel> bm) {
	...
	public ContentPanel getViewPanel() {
		if (panel == null) {
			...
			vp.setSpacing(10);
			createYeta1200Form(); // 화면 기본정보를 설정
	...
	public Yeta1200(String txtForm) {
	 ...
	 * ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
	 **/
	private void createYeta1200Form() {

		plFrmYeta1200 = new FormPanel();
		plFrmYeta1200.setHeadingText(PayGenConst.PAYGEN_VERSION.concat(" - 연말정산파일업로드[2016귀속분]"));
		plFrmYeta1200.setIcon(MSFMainApp.ICONS.text());
		plFrmYeta1200.setPadding(2);
		plFrmYeta1200.setFrame(true);
		...
		btnlogView.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				 //로그 뷰화면 호출 메서드 
				  funcLogMessage("연말정산파일업로드","YETA1200");
				}
			});
		plFrmYeta1200.getHeader().setStyleAttribute("padding", "5px 0 2px 0");
		plFrmYeta1200.getHeader().addTool(btnlogView); 
		/************************************************************************
		 * 화면 에러 처리시 필요한 부분으로 추가 
		 ************************************************************************/

		   //멀티콤보박스 닫기 
		plFrmYeta1200.addListener(Events.OnClick,new Listener<ComponentEvent>() { 
			            @Override
...
//			                        }
		...
		/** 상단 버튼 ButtonBar **/
		topYeta1200Bar = new ButtonBar();
		topYeta1200Bar.setAlignment(HorizontalAlignment.RIGHT);

		btnYeta1200Reset = new Button("초기화");
		btnYeta1200Reset.setIcon(MSFMainApp.ICONS.new16());
		topYeta1200Bar.add(btnYeta1200Reset);
		btnYeta1200Reset.addListener(Events.Select, new Listener<ButtonEvent>() {
    		public void handleEvent(ButtonEvent e) {
    			 //초기화 
    			formInit();
...
//		buttonBar.add(topBtn);
		...
		btnYeta1200Sreach = new Button("조 회");
		btnYeta1200Sreach.setIcon(MSFMainApp.ICONS.search());
		topYeta1200Bar.add(btnYeta1200Sreach);
		btnYeta1200Sreach.addListener(Events.Select, new Listener<ButtonEvent>() {
    		public void handleEvent(ButtonEvent e) {
    			//조회버튼 클릭시 처리 
    			reloadYeta1200();  
    		}
...
//		buttonBar.add(topBtn);
		...
		plFrmYeta1200.add(topYeta1200Bar);

		// 파일업로드 처리
		plFrmYeta1200.setAction("myurl");
		plFrmYeta1200.setEncoding(Encoding.MULTIPART);
		plFrmYeta1200.setMethod(Method.POST);
		
		vp.add(plFrmYeta1200);
		plFrmYeta1200.setSize("990px", "680px");
		plFrmYeta1200.setLayout(new FlowLayout());
...
//		plFrmYeta1200.add(typOccuCdGrid);
...
//		fieldSet.setHeight("80px");
		...
		lsPayrMangDeptCd.addStoreListener(new StoreListener<BaseModel>() {
			public void handleEvent(StoreEvent<BaseModel> be) {
				...
				checkYeta1200Auth("srhPayrMangDeptCd", lsPayrMangDeptCd);
			}
		});
		...
		lsEmymtDivCd.addStoreListener(new StoreListener<BaseModel>() {
			public void handleEvent(StoreEvent<BaseModel> be) {
				...
				if (type == Store.Add) {
					 ...
					 * ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
					 */
					checkYeta1200Auth("srhEmymtDivCd", lsEmymtDivCd);
				}
			}
		});
		...
		srhDeptCd.getStore().addStoreListener(new StoreListener<ModelData>() {
			public void handleEvent(StoreEvent<ModelData> be) {
				...
				if (type == Store.Add) {
					 ...
					 * ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
					 */
					checkYeta1200Auth("srhDeptCd", lsDeptCd);
				}
			}
		});
		...
		srhTypOccuCd.getStore().addStoreListener(new StoreListener<ModelData>() {
			public void handleEvent(StoreEvent<ModelData> be) {
				...
				if (type == Store.Add) {
					 ...
					 * ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
					 */
					//checkYeta1200Auth("srhTypOccuCd", lsTypOccuCd);
				}
			}
		});
...
//		layoutContainer1_4.add(msfGridPanel, new com.extjs.gxt.ui.client.widget.layout.ColumnData(.495));
	...
	//	topBtn01.setEnabled(false);
	//	topBtn01.setVisible(false);
		...
		plFrmYeta1200.add(layoutContainer1_4);
	}
	...
	private void fnPopupPsnl0100() {
	   ...
	   private Yeta1200 getThis(){
	       return this;
	   }
	   
	   private void reloadYeta1200(){
      ...
      //    String strPyspGrdeCd = RemtUtils.getStrValToBMMultiCombo(lsTypOccuCd,srhTypOccuCd.getValue(),"typOccuNm","pyspGrdeCd");  
       //   remt2000DefGridPanel.getTableDef().addColumnFilter("pyspGrdeCd", strPyspGrdeCd, SimpleColumnFilter.OPERATOR_EQUALS);  
        ...
        yeta2000GridPanel.getTableDef().addColumnFilter("yetaDpcd", MSFSharedUtils.getSelectedComboValue(srhYetaDpcd, "yetaDpcd"), SimpleColumnFilter.OPERATOR_EQUALS);
        yeta2000GridPanel.getTableDef().addColumnFilter("busoprRgstnum", MSFSharedUtils.getSelectedComboValue(srhBusoprRgstnum, "busoprRgstnum"), SimpleColumnFilter.OPERATOR_EQUALS);
...
//		        		edacSeilNum.setValue((Long)bmData.get("edacSeilNum"));/** set 연말정산마감일련번호 : edacSeilNum */
	                    ...
	                    if("".equals(systemkey.getValue())){
	                    	...
	                    	if (filename.length() == 0) {
	                    		...
	                    		//submit the form
	                    		plFrmYeta1200.mask("PDF 전자문서 업데이트 중입니다. 업로드 중..."); 
	                    		
	                    		//파일업로드 처리
	                    		plFrmYeta1200.setAction(GWT.getHostPageBaseURL() + "/imp/XmlYeta1200Import.do");
	                    		plFrmYeta1200.setEncoding(Encoding.MULTIPART);
	                    		plFrmYeta1200.setMethod(Method.POST);   
//	                               FormElement frmEl=FormElement.as(plFrmYeta1200.getElement()); 
//	                               frmEl.setAcceptCharset("UTF-8"); 
	                    		plFrmYeta1200.submit();  
	                    		plFrmYeta1200.onFrameLoad();  
	                    		picBoolFile = true;
	                    	...
	                    	// after file upload 
	                    	plFrmYeta1200.addListener(Events.Submit, new Listener<FormEvent>() {
...
//		        		edacSeilNum.setValue((Long)bmData.get("edacSeilNum"));/** set 연말정산마감일련번호 : edacSeilNum */
	                    ...
	                    if("".equals(systemkey.getValue())){
	                    	...
	                    	if (filename.length() == 0) {
	                    		...
	                    		//파일업로드 처리
	                    		plFrmYeta1200.setAction(GWT.getHostPageBaseURL() + "/imp/XmlYeta1200UpImport.do");
	                    		plFrmYeta1200.setEncoding(Encoding.MULTIPART);
	                    		plFrmYeta1200.setMethod(Method.POST);   
//	                               FormElement frmEl=FormElement.as(plFrmYeta1200.getElement()); 
//	                               frmEl.setAcceptCharset("UTF-8"); 
