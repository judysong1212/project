...
public class Ye162010Def  extends TableDef implements YetaDaoConstants {
	...
	public Ye162010Def(String chkPayrDef) {
		...
		if ("YETAP23007".equals(chkPayrDef)) {

			setDaoClass("");
			setCustomListMethod(CLASS_YETAP23007_TO_YE162010_DATA_LIST);
			setAutoFillGrid(true);
			setShowFilterToolbar(false);
			setCheckBoxOnGridRows(true);
			setColumnsDefinition(getYetaP23007ToYe162010ColumnsList());
    ...
    private List<ColumnDef> getYetaP23007ToYe162010ColumnsList(){
        row = 0;
