...
import com.app.exterms.yearendtax.server.vo.Ye165010Srh_2019_VO;
...
@Service("YetaP43003Service")
public class YetaP43003ServiceImpl  extends AbstractCustomServiceImpl implements YetaP43003Service  ,YetaDaoConstants {

	 
	private static final Logger logger = LoggerFactory.getLogger(YetaP43003ServiceImpl.class);
	private static final String calledClass = YetaP43003ServiceImpl.class.getName();

	
	@Autowired
	@Resource(name = "Ye165010_2019_DAO")
	private Ye165010_2019_DAO ye165010DAO; 
	
	
	@Autowired
	@Resource(name = "Ye165020_2019_DAO")
	private Ye165020_2019_DAO ye165020DAO; 
	...
	/** 이월기부금 신규 수정 삭제부 **/
	@Override
	public Long activityOnYetaP43003ToYe165010(List<Ye165010DTO> listYe165010Dto, ActionDatabase actionDatabase) throws MSFException {
		...
		String windowId = "YETAP430003";
	        
		String method = calledClass + ".activityOnYetaP43003ToYe165010";

		
		Ye165010DTO ye165010Dto = new Ye165010DTO();
		Ye165010_2019_VO ye165010Vo = new Ye165010_2019_VO();
		...
		try {
			...
			if (MSFSharedUtils.paramNull(ye165010DAO)) {
				...
				ye165010DAO = (Ye165010_2019_DAO) wac.getBean("Ye165010_2019_DAO");
			}
			...
			for(int iPsnlCnt=0;iPsnlCnt < listYe165010Dto.size();iPsnlCnt++) {
				...
				ye165010Vo = new Ye165010_2019_VO();
				...
				case INSERT:
					...
					ye165010DAO.insertYetaP43003ToYe165010(ye165010Vo);
					break;
					
				case UPDATE:
					
					ye165010DAO.updateYetaP43003ToYe165010(ye165010Vo);
					break;
					
				case DELETE:
					
					ye165010DAO.deleteYetaP43003ToYe165010(ye165010Vo);
					break;
			...
			logger.error("EXCEPTION calling activityOnYetaP13001ToYeta4180(): "+ex); 
			...
			result = new Long(0);
			throw MSFServerUtils.getOperationException("activityOnYetaP43003ToYe165010", ex, logger);
	...
	/** 기부금등록내역 조회 **/
	public PagingLoadResult<BaseModel> getYetaP43003ToYe165010DataList(ServiceParameters serviceParameters) throws MSFException {
			
		PagingLoadResult<BaseModel> retval = null;
		String method = CLASS_YETAP43003_TO_YE165010_DATA_LIST;
		Ye165010Srh_2019_VO ye165010SrhVo = new Ye165010Srh_2019_VO();
...
//		    ye165010SrhVo.setCnbtSeilNum(MSFSharedUtils.allowNulls(MSFServerUtils.getFilterValue(columnFilters, "cnbtSeilNum"))); 	/** column 기부금일련번호 : cnbtSeilNum */
			...
			if (pagingValues.executeRecordCount) {
				...
				int iResultCnt = ye165010DAO.selectYetaP43003ToYe165010ListTotCnt(ye165010SrhVo);
			...
			List list = ye165010DAO.selectYetaP43003ToYe165010List(ye165010SrhVo);
			...
			SmrmfUtils.endTiming(logger, millisBeginPsnl0126DataList, "getYetaP43003ToYe165010DataList");
