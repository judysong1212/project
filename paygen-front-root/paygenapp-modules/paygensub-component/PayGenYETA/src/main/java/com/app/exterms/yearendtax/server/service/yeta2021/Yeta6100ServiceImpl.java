...
import com.app.exterms.yearendtax.server.service.yeta2021.dao.Yeta1100_2021_DAO;
...
* </pre>
 */
@Service("Yeta6100Service")
public class Yeta6100ServiceImpl  extends AbstractCustomServiceImpl implements Yeta6100Service  ,YetaDaoConstants {

	 
	private static final Logger logger = LoggerFactory.getLogger(Yeta6100ServiceImpl.class);
	private static final String calledClass = Yeta6100ServiceImpl.class.getName();

	@Autowired
	@Resource(name = "Yeta1100_2021_DAO")
	private Yeta1100_2021_DAO yeta1100DAO;
	...
	private Ye160401_2021_DAO ye160401DAO;
	
	// 감면소득_과세
	@Autowired
	@Resource(name = "Ye160402_2021_DAO")
	private Ye160402_2021_DAO ye160402DAO;
	
	// 감면소득_비과세
	@Autowired
	@Resource(name = "Ye160403_2021_DAO")
	private Ye160403_2021_DAO ye160403DAO;
	...
	private Ye160406_2021_DAO ye160406DAO;
	 ...
	 */
	//조회
	public PagingLoadResult<BaseModel> getYeta6100ToYe161010DataList(ServiceParameters serviceParameters) throws MSFException {
		

		PagingLoadResult<BaseModel> retval = null;
		String method =  CLASS_YETA6100_DATA_LIST;
...
//            }
           ...
           /******************************** 권한 ************************************************************************/
			...
			if ( pagingValues.executeRecordCount ) { 
	     	...
	     	TimingInfo millisBeginYeta6100ToYe161010DataList = SmrmfUtils.startTiming(logger);
...
//	            Collection<Map<String, Object>> list ??????
			...
			SmrmfUtils.endTiming(logger, millisBeginYeta6100ToYe161010DataList, "getYeta6100ToYe161010DataList");
     ...
     */
    @Override
    public  Long PayrExec_Yeta_2021_Insert(List<Ye161010DTO> listYe161010Dto) throws MSFException {
    		     
    	 
		String method = calledClass + ".PayrExec_Yeta_Insert_2021";
		...
		Ye160402_2021_VO ye160402Vo = new Ye160402_2021_VO(); // 과세감면소득
		Ye160403_2021_VO ye160403Vo = new Ye160403_2021_VO(); // 비과세감면소득
		...
		List<InfcPkgYe161010_2021_VO> listYe161010VO = new ArrayList<InfcPkgYe161010_2021_VO>();
     	...
     	//    {******************************급여자료 이관*******************************************}
		       ...
		       // [과세감면내역 삭제 ]
		        ye160401DAO.fnYeta6100_Ye160401_CREATE_Delete(ye160401Vo);
...
//				}				
				...
				yetaLsAdtr.setPayrToYeta_2021_Insert(RemoteServiceUtil.getThreadLocalRequest(),listYe161010VO);
			...
			logger.error("EXCEPTION calling PayrExec_Yeta_Insert_2021(): " + ex);
			
			/** 에러 로그 **/
			MSFLogHistoryUtils.tracerUserExceptionActivity(sessionUser, method,calledClass, "C", ex, windowNm, windowId);
		
			retval = 0L;
			throw MSFServerUtils.getOperationException("PayrExec_Yeta_Insert_2021", ex, logger);
		}
     ...
     */
    @Override
    public  Long Yeta6100ToYe160401_Delete(List<Ye161010DTO> listYe161010Dto) throws MSFException {
    	
		String method = calledClass + ".Yeta6100ToYe160401_Delete";

		String windowNm = "연말정산대상자관리";
		String windowId = "YETA6100";
...
//		Ye161020VO ye161020Vo = new Ye161020VO(); // 인적소득공제기본
	    ...
	    try {
	    	...
	    	for(int i = 0; i < listYe161010Dto.size(); i ++) {
	            ...
	            logger.error("EXCEPTION calling Yeta6100ToYe160401_Delete(): "+ex); 
	            
	            /** 에러 로그 **/			
	            MSFLogHistoryUtils.tracerUserExceptionActivity(sessionUser,method,calledClass,"D", ex, windowNm , windowId);
	            
	            retval = 0L;
	            throw MSFServerUtils.getOperationException("Yeta6100ToYe160401_Delete", ex, logger);
	        } 
	...
	@Override
	public Long UpDpobExec_Yeta_2021_Insert(List<Ye161010DTO> listYe161010Dto) throws MSFException {
		 
   	 
			String method = calledClass + ".UpDpobExec_Yeta_Insert_2021";
			...
			List<InfcPkgYe161010_2021_VO> listYe161010VO = new ArrayList<InfcPkgYe161010_2021_VO>();
	     	...
	     	//    {******************************급여자료 이관*******************************************}
				...
				if (listYe161010VO.size() > 0) {
					...
					// 컴포넌트 호출하기
					yetaLsAdtr.setUpDpopYeta_2021_Insert(RemoteServiceUtil.getThreadLocalRequest(),listYe161010VO);
				...
				logger.error("EXCEPTION calling UpDpobExec_Yeta_Insert_2021(): " + ex);
				
				/** 에러 로그 **/
				MSFLogHistoryUtils.tracerUserExceptionActivity(sessionUser, method,calledClass, "U", ex, windowNm, windowId);
			
				retval = 0L;
				throw MSFServerUtils.getOperationException("UpDpobExec_Yeta_Insert_2021", ex, logger);
			}
