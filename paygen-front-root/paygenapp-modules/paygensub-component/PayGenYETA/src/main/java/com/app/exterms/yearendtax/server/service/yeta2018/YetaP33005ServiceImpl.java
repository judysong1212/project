 ...
 */
@Service("YetaP33005Service")
public class YetaP33005ServiceImpl  extends AbstractCustomServiceImpl implements YetaP33005Service  ,YetaDaoConstants {

 
	private static final Logger logger = LoggerFactory.getLogger(YetaP33005ServiceImpl.class);
	private static final String calledClass = YetaP33005ServiceImpl.class.getName();
	...
	public Long  activityOnYetaP33005ToYe162510(List<Ye162510DTO> listYe162510Dto, ActionDatabase actionDatabase) throws MSFException {
		...
		String method = calledClass + ".activityOnYetaP33005ToYe162510";

		String windowNm = "소득공제신고자료관리";
		String windowId = "YETAP330005";
		...
		try {
			...
			for(int iPsnlCnt=0;iPsnlCnt < listYe162510Dto.size();iPsnlCnt++) {
				...
				ye162510Vo  = new Ye162510_2018_VO();
				...
				case INSERT:
					...
					ye162510DAO.insertYetaP33005ToYe162510(ye162510Vo);
					break;
				case UPDATE:
					ye162510DAO.updateYetaP33005ToYe162510(ye162510Vo);
					break;
				case DELETE:
					ye162510DAO.deleteYetaP33005ToYe162510(ye162510Vo);
					break;
				}
			...
			logger.error("EXCEPTION calling activityOnYetaP33005ToYe162510(): "+ ex); 
		    ...
		    result = new Long(0);
		    throw MSFServerUtils.getOperationException("activityOnYetaP33005ToYe162510", ex, logger);
	...
	/** 월세액소득공제명세 조회 **/
	public PagingLoadResult<BaseModel> getYetaP33005ToYe162510DataList(ServiceParameters serviceParameters) throws MSFException {
			

			PagingLoadResult<BaseModel> retval = null;
			String method =  CLASS_YETAP33005_TO_YE162510_DATA_LIST;
			Ye162510Srh_2018_VO   ye162510SrhVo = new Ye162510Srh_2018_VO();
...
//		      	yeta3220SrhVo.setHanNm(MSFSharedUtils.allowNulls(MSFServerUtils.getFilterValue(columnFilters, "hanNm")));    //한글성명 
				...
				if ( pagingValues.executeRecordCount ) { 
		        	...
		        	TimingInfo millisBeginQueryCount = SmrmfUtils.startTiming(logger);
		          	...
		          	int iResultCnt = ye162510DAO.selectYetaP33005ToYe162510ListTotCnt(ye162510SrhVo);  
...
//		            Collection<Map<String, Object>> list ??????
		     	List list = ye162510DAO.selectYetaP33005ToYe162510List(ye162510SrhVo);
