...
import com.app.exterms.yearendtax.client.service.yeta2019.YetaP43008Service;
...
@Service("YetaP43008Service")
public class YetaP43008ServiceImpl  extends AbstractCustomServiceImpl implements YetaP43008Service  ,YetaDaoConstants {

	 
	private static final Logger logger = LoggerFactory.getLogger(YetaP43008ServiceImpl.class);
	private static final String calledClass = YetaP43008ServiceImpl.class.getName();
	...
	public Long activityOnYetaP43008ToYe160403(Ye160403DTO ye160403Dto, ActionDatabase actionDatabase) throws MSFException {
		...
		String method = calledClass + ".activityOnYetaP43008ToYe160403";

		String windowNm = "소득공제신고자료관리";
		String windowId = "YETAP4300";
			
		Ye160403_2019_VO ye160403Vo = new Ye160403_2019_VO(); 
		...
		try {
			...
			if (MSFSharedUtils.paramNull(ye160403DAO)) {
				...
				ye160403DAO = (Ye160403_2019_DAO) wac.getBean("Ye160403_2019_DAO"); 
			}
			...
			ye160403DAO.updateYetaP43008ToYe160403(ye160403Vo); 
		          
		} catch (Exception ex) {
			logger.error("EXCEPTION calling activityOnYetaP43008ToYe160403(): "+ ex);
			...
			result = new Long(0);
			throw MSFServerUtils.getOperationException("activityOnYetaP43008ToYe160403", ex, logger);
	...
	public Ye160403DTO getYetaP43008ToYe160403List(Ye160403DTO ye160403Dto) throws MSFException {
		...
		Ye160403Srh_2019_VO ye160403SrhVo = new Ye160403Srh_2019_VO();
		MSFSysm0100BM sessionUser;

		String method = calledClass + ".getYetaP43008ToYe160403List";

		String windowNm = "소득공제신고자료관리";
		String windowId = "YETAP430008";
		...
		try {
			...
			egovResultDataList = ye160403DAO.selectYetaP43008ToYe160403List(ye160403SrhVo);
