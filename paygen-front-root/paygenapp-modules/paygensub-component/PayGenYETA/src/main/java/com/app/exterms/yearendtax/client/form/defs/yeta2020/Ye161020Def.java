...
//    private PayrConstants PayrLabel = PayrConstants.INSTANCE;
	...
	public Ye161020Def(String chkPayrDef) {
		...
		}else if ("YetaP510002".equals(chkPayrDef)) {
			// setTitle(PayrLabel.titlePayr0304());
			setDaoClass("");
			setCustomListMethod(CLASS_YETAP510002ToYE161010_LIST);
			setAutoFillGrid(false);
			setShowFilterToolbar(false);
			setCheckBoxOnGridRows(false);
			setColumnsDefinition(getYetaP310002ToYe161020ColumnsList());
	...
	private List<ColumnDef> getYetaP310002ToYe161020ColumnsList() {
