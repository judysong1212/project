...
import com.app.exterms.yearendtax.client.service.yeta2018.YetaP330011Service;
...
@Service("YetaP330011Service")
public class YetaP330011ServiceImpl  extends AbstractCustomServiceImpl implements YetaP330011Service  ,YetaDaoConstants {

	 
	private static final Logger logger = LoggerFactory.getLogger(YetaP330011ServiceImpl.class);
	private static final String calledClass = YetaP330011ServiceImpl.class.getName();
	...
	public Long saveYeta3300ToYe161090tabItem08_3(List<Ye161090DTO> listYe161090Dto, ActionDatabase actionDatabase) throws Exception {
		...
		String method = calledClass + ".saveYeta3300ToYe161090tabItem08_3";
		
		String windowNm = "소득공제신고자료관리";
		String windowId = "YETA330011";
	...
	public PagingLoadResult<BaseModel> getYeta3300ToYe161090List(ServiceParameters serviceParameters) throws MSFException {
		...
		Ye161090Srh_2018_VO ye161090SrhVo = new Ye161090Srh_2018_VO();
		...
		MSFSysm0100BM sessionUser;
			...
			if  (MSFSharedUtils.paramNull(ye161090DAO)) {
				...
				ye161090DAO = (Ye161090_2018_DAO) wac.getBean("Ye161090_2018_DAO"); 
			}
...
//		      	yeta3220SrhVo.setHanNm(MSFSharedUtils.allowNulls(MSFServerUtils.getFilterValue(columnFilters, "hanNm")));    //한글성명 
				...
				if ( pagingValues.executeRecordCount ) { 
		        	...
		        	TimingInfo millisBeginQueryCount = SmrmfUtils.startTiming(logger);
		          	...
		          	int iResultCnt = ye161090DAO.selectYeta3300ToYe161090ListTotCnt(ye161090SrhVo);  
...
////		            Collection<Map<String, Object>> list ??????
		     	List list = ye161090DAO.selectYeta3300ToYe161090List(ye161090SrhVo);
