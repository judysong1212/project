...
import com.app.exterms.yearendtax.server.vo.Pyyt0302Srh_2022_VO;
...
* </pre>
 */
@Service("Yeta7900Service")
public class Yeta7900ServiceImpl  extends AbstractCustomServiceImpl implements Yeta7900Service  ,YetaDaoConstants {

	 
	private static final Logger logger = LoggerFactory.getLogger(Yeta7900ServiceImpl.class);
	private static final String calledClass = Yeta7900ServiceImpl.class.getName();
	 ...
	 * @throws MSFException
	 */
	public PagingLoadResult<BaseModel> getYeta7900ToPyyt0304List(ServiceParameters serviceParameters) throws MSFException {

 	        PagingLoadResult<BaseModel> retval = null;
//	        String method =  "getPsnl0100ToRemt0100DataList";
	        String method = CLASS_YETA7900_TO_PYYT0304_DATA_LIST;
	        ...
	        if  (MSFSharedUtils.paramNull(pyyt0304DAO)) {
	            ...
	            pyyt0304DAO = (Ye17TaPyyt0304_2022_DAO) wac.getBean("Ye17TaPyyt0304_2022_DAO"); 
	        }
...
//	            Collection<Map<String, Object>> list  
	 ...
	 * @throws MSFException
	 */
	public PagingLoadResult<BaseModel> getYeta7900ToPyyt0302ExtpyList(ServiceParameters serviceParameters) throws MSFException {

 	        PagingLoadResult<BaseModel> retval = null;
//	        String method =  "getPsnl0100ToRemt0100DataList";
	        String method = CLASS_YETA7900_TO_PYYT0302_EXTPY_DATA_LIST;
	        Pyyt0302Srh_2022_VO   pyyt0302SrhVo = new Pyyt0302Srh_2022_VO();
	        Pyyt0302_2022_VO      pyyt0304Vo = new Pyyt0302_2022_VO();
	        List<BaseModel>  bmResult = new ArrayList<BaseModel>();
	        ...
	        if  (MSFSharedUtils.paramNull(pyyt0302DAO)) {
	            ...
	            pyyt0302DAO = (Ye17TaPyyt0302_2022_DAO) wac.getBean("Ye17TaPyyt0302_2022_DAO"); 
	        }
...
//	            Collection<Map<String, Object>> list  
	 ...
	 * @throws MSFException
	 */
	public PagingLoadResult<BaseModel> getYeta7900ToPyyt0302DducList(ServiceParameters serviceParameters) throws MSFException {

 	        PagingLoadResult<BaseModel> retval = null;
//	        String method =  "getPsnl0100ToRemt0100DataList";
	        String method = CLASS_YETA7900_TO_PYYT0302_DDUC_DATA_LIST;
	        Pyyt0302Srh_2022_VO   pyyt0302SrhVo = new Pyyt0302Srh_2022_VO();
	        Pyyt0302_2022_VO      pyyt0304Vo = new Pyyt0302_2022_VO();
	        List<BaseModel>  bmResult = new ArrayList<BaseModel>();
...
//	            Collection<Map<String, Object>> list  
	...
	public int saveYeta7900ToPyyt0302(List<Pyyt0302DTO> listPyyt0302Dto, String flag)throws MSFException {
		...
		String method = calledClass + ".saveYeta7900ToPyyt0302";
		MSFSysm0100BM sessionUser = MSFServerUtils.getLoggedUser(RemoteServiceUtil.getThreadLocalRequest());
	...
	public int deleteYeta7900List(List<Pyyt0302DTO> listPyyt0302Dto)throws MSFException {
		...
		String method = calledClass + ".deleteYeta7900List";
		MSFSysm0100BM sessionUser = MSFServerUtils.getLoggedUser(RemoteServiceUtil.getThreadLocalRequest());
...
//				pyyt0302Vo.setRevnAddr(RemoteServiceUtil.getThreadLocalRequest().getRemoteHost());
	...
	public Pyyt0304BM Yeta2900InfoList(Pyyt0304DTO pyyt0304Dto) {
		...
		String method = calledClass + ".Yeta7900InfoList";
...
//			int iResultCnt = yeta2000DAO.selectYeta0300To2000ListTotCnt(pyyt0304SrhVo);  
	...
	@Override
	public Pyyt0304BM Yeta7900InfoList(Pyyt0304DTO Pyyt0304Dto)
			throws MSFException {
		// TODO Auto-generated method stub
		return null;
	}
