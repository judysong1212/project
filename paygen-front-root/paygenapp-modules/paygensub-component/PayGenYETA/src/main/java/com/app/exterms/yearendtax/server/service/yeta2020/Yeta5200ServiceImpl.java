...
* </pre>
 */
@Service("Yeta5200Service")
public class Yeta5200ServiceImpl  extends AbstractCustomServiceImpl implements Yeta5200Service  ,YetaDaoConstants {

	 
	private static final Logger logger = LoggerFactory.getLogger(Yeta5200ServiceImpl.class);
	private static final String calledClass = Yeta5200ServiceImpl.class.getName();
	 ...
	 */
	//조회
	public PagingLoadResult<BaseModel> getYeta5200ToYe161010DataList(ServiceParameters serviceParameters) throws MSFException {
		

		PagingLoadResult<BaseModel> retval = null;
		String method =  CLASS_YETA5200_DATA_LIST;
...
//	     	psnl0100SrhVO.setPyspGrdeCd(MSFSharedUtils.allowNulls(MSFServerUtils.getFilterValue(columnFilters, "pyspGrdeCd"))); //호봉등급코드
			...
			if ( pagingValues.executeRecordCount ) { 
	     	...
	     	TimingInfo millisBeginYeta4100ToYe161010DataList = SmrmfUtils.startTiming(logger);
...
//	            Collection<Map<String, Object>> list ??????
			...
			SmrmfUtils.endTiming(logger, millisBeginYeta4100ToYe161010DataList, "getYeta4100ToYe161010DataList");
	 ...
	 */
	//조회
	public PagingLoadResult<BaseModel> getYeta5200ToYe161010ResultDataList(ServiceParameters serviceParameters) throws MSFException {
