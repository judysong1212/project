...
@Service("YetaP43001Service")
public class YetaP43001ServiceImpl  extends AbstractCustomServiceImpl implements YetaP43001Service, YetaDaoConstants {

	private static final Logger logger = LoggerFactory.getLogger(YetaP43001ServiceImpl.class);
	private static final String calledClass = YetaP43001ServiceImpl.class.getName();
	...
	//이월기부금 신규 수정 삭제부
	@Override
	public Long activityOnYetaP43001ToYe165030(List<Ye165030DTO> listYe165030Dto, ActionDatabase actionDatabase) throws MSFException {
		...
		String windowId = "YETAP430001";

		MSFSysm0100BM sessionUser;
		String method = calledClass + ".activityOnYetaP43001ToYe165030";

		Ye165030DTO ye165030Dto = new Ye165030DTO();
		Ye165030_2019_VO ye165030Vo = new Ye165030_2019_VO();
		...
		try {  
			...
			if (MSFSharedUtils.paramNull(ye165030DAO)) {
				...
				ye165030DAO = (Ye165030_2019_DAO) wac.getBean("Ye165030_2019_DAO");
			}
			...
			for (int iPsnlCnt = 0; iPsnlCnt < listYe165030Dto.size(); iPsnlCnt++) {
				...
				ye165030Vo = new Ye165030_2019_VO();
				...
				ye165030Vo.setRevnAddr(RemoteServiceUtil.getThreadLocalRequest().getRemoteHost());/** column 수정주소 : revnAddr */
		        	...
		        	switch (actionDatabase) {
		        		case INSERT:
		        			...
		        			ye165030DAO.insertYetaP43001ToYe165030(ye165030Vo); 
		        			break;
		            	case UPDATE: 
		            		ye165030DAO.updateYetaP43001ToYe165030(ye165030Vo); 
		            		break;
		            	case DELETE: 
		            		ye165030DAO.deleteYetaP43001ToYe165030(ye165030Vo); 
		            		break;
				}
			...
			result = new Long(0);
			throw MSFServerUtils.getOperationException("activityOnYetaP43001ToYe165030", ex, logger);
		} finally {
	...
	/** 이월기부금 조회 **/
	public PagingLoadResult<BaseModel> getYetaP43001ToYe165030DataList(ServiceParameters serviceParameters) throws MSFException {
		
		PagingLoadResult<BaseModel> retval = null;
		String method = CLASS_YETAP43001_TO_YE165030_DATA_LIST;
		Ye165030Srh_2019_VO ye165030SrhVo = new Ye165030Srh_2019_VO();
...
//	    	ye165030SrhVo.setConbSeilNum(MSFSharedUtils.allowNulls(MSFServerUtils.getFilterValue(columnFilters, "conbSeilNum")));    /** column 기부금조정일련번호 : conbSeilNum */	    	
			...
			if ( pagingValues.executeRecordCount ) { 
	        	...
	        	TimingInfo millisBeginQueryCount = SmrmfUtils.startTiming(logger);
	          	...
	          	int iResultCnt = ye165030DAO.selectYetaP43001ToYe165030ListTotCnt(ye165030SrhVo);  
...
//	            Collection<Map<String, Object>> list ??????
	     	List list = ye165030DAO.selectYetaP43001ToYe165030List(ye165030SrhVo);
