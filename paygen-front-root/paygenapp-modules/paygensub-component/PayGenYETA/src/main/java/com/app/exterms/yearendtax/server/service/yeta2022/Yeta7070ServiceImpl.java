...
import com.app.exterms.yearendtax.server.service.yeta2022.dao.Yeta7070_2022_DAO;
...
@Service("Yeta7070Service")
public class Yeta7070ServiceImpl extends AbstractCustomServiceImpl implements YetaDaoConstantsGenerated, Yeta7070Service {

	private static final Logger logger = LoggerFactory.getLogger(Yeta7070ServiceImpl.class);
	private static final String calledClass = Yeta7070ServiceImpl.class.getName();

	@Autowired
	@Resource(name = "Yeta7070_2022_DAO")
	private Yeta7070_2022_DAO yeta7070DAO;
	...
	public PagingLoadResult<BaseModel> getSelectYeta7070ToBass0120List(ServiceParameters serviceParameters) throws MSFException {
        ...
        Yeta2070Srh_2022_VO   Yeta2070SrhVO = new Yeta2070Srh_2022_VO();
        //Yeta2070VO      Yeta2070Vo = new Yeta2070VO();
        List<BaseModel>  bmResult = new ArrayList<BaseModel>();
        MSFSysm0100BM sessionUser = MSFServerUtils.getLoggedUser(RemoteServiceUtil.getThreadLocalRequest());
        
        if(MSFSharedUtils.paramNull(yeta7070DAO)){
        	WebApplicationContext wac = WebApplicationContextUtils.getRequiredWebApplicationContext(getHttpServletRequest().getSession().getServletContext());
        	yeta7070DAO = (Yeta7070_2022_DAO) wac.getBean("Yeta7070_2022_DAO");
        }
        try{
            ...
            if(pagingValues.executeRecordCount){ 
            	...
            	int iResultCnt = yeta7070DAO.selectYeta7070ListTotCnt(Yeta2070SrhVO);
            ...
            List list = yeta7070DAO.selectYeta7070List(Yeta2070SrhVO);
            ...
            SmrmfUtils.endTiming(logger, millisBeginSelectYeta2070List, "selectYeta7070List");
