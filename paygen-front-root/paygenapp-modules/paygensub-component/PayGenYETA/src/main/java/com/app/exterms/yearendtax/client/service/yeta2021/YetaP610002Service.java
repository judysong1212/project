...
@RemoteServiceRelativePath("YetaP610002Service.gwt")
public interface YetaP610002Service extends RemoteService {
	/**
	 * Utility class for simplifying access to the instance of async service.
	 */
	public static class Util {
		private static YetaP610002ServiceAsync instance;
		public static YetaP610002ServiceAsync getInstance(){
			if (instance == null) {
				instance = GWT.create(YetaP610002Service.class);
			}
			return instance;
		}
	}
...
//	
	...
	/** 원천신고부서대상자 원천신고부서 반영  **/
	public int saveYetaP610002ToYe161010(List<Ye161010DTO> ye161010Dto) throws MSFException ;
