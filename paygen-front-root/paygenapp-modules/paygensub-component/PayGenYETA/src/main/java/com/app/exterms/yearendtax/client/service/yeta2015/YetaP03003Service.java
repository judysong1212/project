...
@RemoteServiceRelativePath("YetaP03003Service.gwt")
public interface YetaP03003Service extends RemoteService {
	/**
	 * Utility class for simplifying access to the instance of async service.
	 */
	public static class Util {
		private static YetaP03003ServiceAsync instance;
		public static YetaP03003ServiceAsync getInstance(){
			if (instance == null) {
				instance = GWT.create(YetaP03003Service.class);
			}
			return instance;
		}
	}
