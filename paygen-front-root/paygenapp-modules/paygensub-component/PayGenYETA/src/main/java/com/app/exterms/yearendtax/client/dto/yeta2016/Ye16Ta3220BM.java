 ...
 */
public class Ye16Ta3220BM    extends MSFSimpleBaseModel implements IsSerializable   {
    ...
    public static final String ATTR_FAMYSUPPTRELADIVCD = "famySupptRelaDivCd";


/** set 고용보험_국세청 : insuGopy */
public static final String ATTR_INSUGOPY = "insuGopy";

/** set 고용보험_외 : insuGoec */
public static final String ATTR_INSUGOEC = "insuGoec";

    /** 생성자 */
     public Ye16Ta3220BM() { super(); } 
    ...
    /** set 보험료_건강고용등국세청 : insuPayr */
    public void setInsuPayr(Long  insuPayr) { set( ATTR_INSUPAYR ,insuPayr);}
    /** get 보험료_건강고용등국세청 : insuPayr */
    public Long  getInsuPayr() { return (Long )get( ATTR_INSUPAYR );}

    /** set 보험료보장성_국세청 : insuRtyr */
    public void setInsuRtyr(Long  insuRtyr) { set( ATTR_INSURTYR ,insuRtyr);}
    /** get 보험료보장성_국세청 : insuRtyr */
    public Long  getInsuRtyr() { return (Long )get( ATTR_INSURTYR );}

    /** set 보험료장애인보장성_국세청 : psclIurr */
    public void setPsclIurr(Long  psclIurr) { set( ATTR_PSCLIURR ,psclIurr);}
    /** get 보험료장애인보장성_국세청 : psclIurr */
    public Long  getPsclIurr() { return (Long )get( ATTR_PSCLIURR );}

    /** set 의료비_국세청 : mediCost */
    public void setMediCost(Long  mediCost) { set( ATTR_MEDICOST ,mediCost);}
    /** get 의료비_국세청 : mediCost */
    public Long  getMediCost() { return (Long )get( ATTR_MEDICOST );}

    /** set 교육비_국세청 : educCost */
    public void setEducCost(Long  educCost) { set( ATTR_EDUCCOST ,educCost);}
    /** get 교육비_국세청 : educCost */
    public Long  getEducCost() { return (Long )get( ATTR_EDUCCOST );}

    /** set 신용카드등_국세청 : cdteCard */
    public void setCdteCard(Long  cdteCard) { set( ATTR_CDTECARD ,cdteCard);}
    /** get 신용카드등_국세청 : cdteCard */
    public Long  getCdteCard() { return (Long )get( ATTR_CDTECARD );}

    /** set 현금영수증_국세청 : cashRece */
    public void setCashRece(Long  cashRece) { set( ATTR_CASHRECE ,cashRece);}
    /** get 현금영수증_국세청 : cashRece */
    public Long  getCashRece() { return (Long )get( ATTR_CASHRECE );}

    /** set 직불카드등_국세청 : jiblCard */
    public void setJiblCard(Long  jiblCard) { set( ATTR_JIBLCARD ,jiblCard);}
    /** get 직불카드등_국세청 : jiblCard */
    public Long  getJiblCard() { return (Long )get( ATTR_JIBLCARD );}

    /** set 지로납부액_대중교통_국세청 : grpyAmnt */
    public void setGrpyAmnt(Long  grpyAmnt) { set( ATTR_GRPYAMNT ,grpyAmnt);}
    /** get 지로납부액_대중교통_국세청 : grpyAmnt */
    public Long  getGrpyAmnt() { return (Long )get( ATTR_GRPYAMNT );}

    /** set 전통시장사용분_국세청 : mgntStvd */
    public void setMgntStvd(Long  mgntStvd) { set( ATTR_MGNTSTVD ,mgntStvd);}
    /** get 전통시장사용분_국세청 : mgntStvd */
    public Long  getMgntStvd() { return (Long )get( ATTR_MGNTSTVD );}

    /** set 기부금액_국세청 : ctrbAmnt */
    public void setCtrbAmnt(Long  ctrbAmnt) { set( ATTR_CTRBAMNT ,ctrbAmnt);}
    /** get 기부금액_국세청 : ctrbAmnt */
    public Long  getCtrbAmnt() { return (Long )get( ATTR_CTRBAMNT );}

    /** set 보험료_건강고용등외 : insuFetc */
    public void setInsuFetc(Long  insuFetc) { set( ATTR_INSUFETC ,insuFetc);}
    /** get 보험료_건강고용등외 : insuFetc */
    public Long  getInsuFetc() { return (Long )get( ATTR_INSUFETC );}

    /** set 보험료보장성외 : insuRtet */
    public void setInsuRtet(Long  insuRtet) { set( ATTR_INSURTET ,insuRtet);}
    /** get 보험료보장성외 : insuRtet */
    public Long  getInsuRtet() { return (Long )get( ATTR_INSURTET );}

    /** set 보험료장애인보장성외 : psclIurt */
    public void setPsclIurt(Long  psclIurt) { set( ATTR_PSCLIURT ,psclIurt);}
    /** get 보험료장애인보장성외 : psclIurt */
    public Long  getPsclIurt() { return (Long )get( ATTR_PSCLIURT );}

    /** set 의료비외 : mediExps */
    public void setMediExps(Long  mediExps) { set( ATTR_MEDIEXPS ,mediExps);}
    /** get 의료비외 : mediExps */
    public Long  getMediExps() { return (Long )get( ATTR_MEDIEXPS );}

    /** set 교육비외 : educOtec */
    public void setEducOtec(Long  educOtec) { set( ATTR_EDUCOTEC ,educOtec);}
    /** get 교육비외 : educOtec */
    public Long  getEducOtec() { return (Long )get( ATTR_EDUCOTEC );}

    /** set 신용카드외 : cdteCdec */
    public void setCdteCdec(Long  cdteCdec) { set( ATTR_CDTECDEC ,cdteCdec);}
    /** get 신용카드외 : cdteCdec */
    public Long  getCdteCdec() { return (Long )get( ATTR_CDTECDEC );}

    /** set 직불카드외 : jiblCdec */
    public void setJiblCdec(Long  jiblCdec) { set( ATTR_JIBLCDEC ,jiblCdec);}
    /** get 직불카드외 : jiblCdec */
    public Long  getJiblCdec() { return (Long )get( ATTR_JIBLCDEC );}

    /** set 지로납부액_대중교통외 : grpyAtec */
    public void setGrpyAtec(Long  grpyAtec) { set( ATTR_GRPYATEC ,grpyAtec);}
    /** get 지로납부액_대중교통외 : grpyAtec */
    public Long  getGrpyAtec() { return (Long )get( ATTR_GRPYATEC );}

    /** set 전통시장사용분외 : mgntSdec */
    public void setMgntSdec(Long  mgntSdec) { set( ATTR_MGNTSDEC ,mgntSdec);}
    /** get 전통시장사용분외 : mgntSdec */
    public Long  getMgntSdec() { return (Long )get( ATTR_MGNTSDEC );}

    /** set 기부금액외 : ctrbAmec */
    public void setCtrbAmec(Long  ctrbAmec) { set( ATTR_CTRBAMEC ,ctrbAmec);}
    /** get 기부금액외 : ctrbAmec */
    public Long  getCtrbAmec() { return (Long )get( ATTR_CTRBAMEC );}
    ...
    /** set 연말정산부양관계코드 : famySupptRelaDivCd */
    public void setFamySupptRelaDivCd(String  famySupptRelaDivCd) { set( ATTR_FAMYSUPPTRELADIVCD ,famySupptRelaDivCd);}
    /** get 연말정산부양관계코드 : famySupptRelaDivCd */
    public String  getFamySupptRelaDivCd() { return (String )get( ATTR_FAMYSUPPTRELADIVCD );}
    /** set 고용보험_국세청 : insuGopy */
    public void setInsuGopy(Long  insuGopy) { set( ATTR_INSUGOPY ,insuGopy);}
    /** get 고용보험_국세청 : insuGopy */
    public Long  getInsuGopy() { return (Long )get( ATTR_INSUGOPY );}

    /** set 고용보험_외 : insuGoec */
    public void setInsuGoec(Long  insuGoec) { set( ATTR_INSUGOEC ,insuGoec);}
    /** get 고용보험_외 : insuGoec */
    public Long  getInsuGoec() { return (Long )get( ATTR_INSUGOEC );}
