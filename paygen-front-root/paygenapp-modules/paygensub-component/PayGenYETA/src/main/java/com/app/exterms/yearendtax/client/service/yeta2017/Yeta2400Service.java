...
@RemoteServiceRelativePath("Yeta2400Service.gwt")
public interface Yeta2400Service extends RemoteService {
	/**
	 * Utility class for simplifying access to the instance of async service.
	 */
	public static class Util {
		private static Yeta2400ServiceAsync instance;
		public static Yeta2400ServiceAsync getInstance(){
			if (instance == null) {
				instance = GWT.create(Yeta2400Service.class);
			}
			return instance;
		}
	}
