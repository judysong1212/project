...
import com.app.exterms.yearendtax.server.service.yeta2022.dao.Ye161030_2022_DAO;
import com.app.exterms.yearendtax.server.service.yeta2022.dao.Ye161040_2022_DAO;
...
import com.app.exterms.yearendtax.server.service.yeta2022.dao.Ye161070_2022_DAO;
import com.app.exterms.yearendtax.server.service.yeta2022.dao.Ye161080_2022_DAO;
import com.app.exterms.yearendtax.server.service.yeta2022.dao.Ye161090_2022_DAO;
import com.app.exterms.yearendtax.server.service.yeta2022.dao.Ye164010_2022_DAO;
import com.app.exterms.yearendtax.server.service.yeta2022.dao.Ye165030_2022_DAO;
import com.app.exterms.yearendtax.server.service.yeta2022.dao.Ye166010_2022_DAO;
...
import com.app.exterms.yearendtax.server.vo.Ye164010_2022_VO;
...
import com.app.smrmf.pkg.listener.yeta.yeta2022.Yeta7300ListenerAdapter;
import com.app.smrmf.pkg.yeta.yeta2022.pdfxml.Func_PdfInDdc_Yeta2022_Insert;
 ...
 */
@Service("Yeta7300Service")
public class Yeta7300ServiceImpl  extends AbstractCustomServiceImpl implements Yeta7300Service  ,YetaDaoConstants {
	 
	private static final Logger logger = LoggerFactory.getLogger(Yeta7300ServiceImpl.class);
	private static final String calledClass = Yeta7300ServiceImpl.class.getName();
	...
	@Autowired
	@Resource(name = "Ye161030_2022_DAO")
	private Ye161030_2022_DAO ye161030DAO;
	
	@Autowired
	@Resource(name = "Ye161040_2022_DAO")
	private Ye161040_2022_DAO ye161040DAO;
	...
	@Autowired
	@Resource(name = "Ye161070_2022_DAO")
	private Ye161070_2022_DAO ye161070DAO;
	
	@Autowired
	@Resource(name = "Ye161080_2022_DAO")
	private Ye161080_2022_DAO ye161080DAO;
	
	// 교육비 내역
	@Autowired
	@Resource(name = "Ye161090_2022_DAO")
	private Ye161090_2022_DAO ye161090DAO;
	...
	// 의료비 
	@Autowired
	@Resource(name = "Ye164010_2022_DAO")
	private Ye164010_2022_DAO ye164010DAO;
	
	// 기부금
	@Autowired
	@Resource(name = "Ye165030_2022_DAO")
	private Ye165030_2022_DAO ye165030DAO;
	
	// 신용카드
	@Autowired
	@Resource(name = "Ye166010_2022_DAO")
	private Ye166010_2022_DAO ye166010DAO;
	
	
	

	/** 대상자 정보 조회 **/
	public PagingLoadResult<BaseModel> getYeta7300ToYe161010DataList(ServiceParameters serviceParameters) throws MSFException {
	     ...
	     //	 List<String> listTyInttnCd = new ArrayList<String>(); 
			...
			if ( pagingValues.executeRecordCount ) { 
	        	...
	        	TimingInfo millisBeginQueryCount = SmrmfUtils.startTiming(logger);
	          	...
	          	int iResultCnt = ye161010DAO.selectYeta7300ToYe161010ListTotCnt(ye161010SrhVo);  
...
//	            Collection<Map<String, Object>> list ??????
	     	List list = ye161010DAO.selectYeta7300ToYe161010List(ye161010SrhVo);
			...
			SmrmfUtils.endTiming(logger, millisBeginYe161010DataList, "getYeta7300ToYe161010DataList");
	...
	/** 세액계산 정보 조회 **/
	public PagingLoadResult<BaseModel> getYeta7300ToSubTaxList(ServiceParameters serviceParameters) throws MSFException {

		PagingLoadResult<BaseModel> retval = null;
		String method = CLASS_YETA7300_TO_YE169010_SUBTAX_LIST;
		
		
		Ye169010Srh_2022_VO ye169010SrhVo = new Ye169010Srh_2022_VO();
		List<BaseModel> bmResult = new ArrayList<BaseModel>();
		MSFSysm0100BM sessionUser;
		...
		if  (MSFSharedUtils.paramNull(ye169010DAO)) {
			WebApplicationContext wac = WebApplicationContextUtils.getRequiredWebApplicationContext( getHttpServletRequest().getSession().getServletContext());
			ye169010DAO = (Ye169010_2022_DAO) wac.getBean("Ye169010_2022_DAO" ); 
		}
			...
			if ( pagingValues.executeRecordCount ) { 
	        	...
	        	TimingInfo millisBeginQueryCount = SmrmfUtils.startTiming(logger);
	          	...
	          	if("Y".equals(ye169010SrhVo.getC152StdTxDdcYn())) {
	          		iResultCnt = ye169010aDAO.selectYeta7300ToYe169010aListTotCnt(ye169010SrhVo);
	          	}else {
	          		iResultCnt = ye169010DAO.selectYeta7300ToYe169010ListtTotCnt(ye169010SrhVo);
	          	}
...
//	            Collection<Map<String, Object>> list ??????
	    	List list;
	     	if("Y".equals(ye169010SrhVo.getC152StdTxDdcYn())) {
		    	...
		    	list = ye169010aDAO.selectYeta7300ToYe169010aList(ye169010SrhVo);
	     		
          	}else {
          		
          		list = ye169010DAO.selectYeta7300ToYe169010List(ye169010SrhVo);
          	}
	...
	/** 인적공제명세 정보 조회 **/
	public PagingLoadResult<BaseModel> getYeta7300ToYe161030List(ServiceParameters serviceParameters) throws MSFException {
		

		PagingLoadResult<BaseModel> retval = null;
		String method =  CLASS_YETA7300_TO_YE161030_DATA_LIST;
		Ye161030Srh_2022_VO   ye161030SrhVo = new Ye161030Srh_2022_VO();
		List<BaseModel>  bmResult = new ArrayList<BaseModel>();
		MSFSysm0100BM sessionUser;
		...
		if  (MSFSharedUtils.paramNull(ye161030DAO)) {
			WebApplicationContext wac = WebApplicationContextUtils.getRequiredWebApplicationContext( getHttpServletRequest().getSession().getServletContext());
			ye161030DAO = (Ye161030_2022_DAO) wac.getBean("Ye161030_2022_DAO"); 
		}
...
//	    	List<String> listDeptCd = new ArrayList<String>();    
			...
			if ( pagingValues.executeRecordCount ) { 
	        	...
	        	TimingInfo millisBeginQueryCount = SmrmfUtils.startTiming(logger);
	          	...
	          	int iResultCnt = ye161030DAO.selectYeta73001ToYe161030ListtTotCnt(ye161030SrhVo);  
	     	...
	     	@SuppressWarnings("unchecked")
//	            Collection<Map<String, Object>> list ??????
	     	List list = ye161030DAO.selectYeta73001ToYe161030List(ye161030SrhVo);
			...
			SmrmfUtils.endTiming(logger, millisBeginPsnl0126DataList, "getYeta7300To2000List");
	...
	/** 소득공제명세 정보 조회 **/	
	public PagingLoadResult<BaseModel> getYeta7300ToYe161040List(ServiceParameters serviceParameters) throws MSFException {
		

		PagingLoadResult<BaseModel> retval = null;
		String method =  CLASS_YETA7300_TO_YE161040_DATA_LIST;
		Ye161040Srh_2022_VO   ye161040SrhVo = new Ye161040Srh_2022_VO();
		List<BaseModel>  bmResult = new ArrayList<BaseModel>();
		MSFSysm0100BM sessionUser;
		...
		if  (MSFSharedUtils.paramNull(ye161040DAO)) {
			WebApplicationContext wac = WebApplicationContextUtils.getRequiredWebApplicationContext( getHttpServletRequest().getSession().getServletContext());
			ye161040DAO = (Ye161040_2022_DAO) wac.getBean("Ye161040_2022_DAO"); 
		}
...
//	    	List<String> listDeptCd = new ArrayList<String>();    
			...
			if ( pagingValues.executeRecordCount ) { 
	        	...
	        	TimingInfo millisBeginQueryCount = SmrmfUtils.startTiming(logger);
	          	...
	          	int iResultCnt = ye161040DAO.selectYeta7300ToYe161040ListTotCnt(ye161040SrhVo);  
	     	...
	     	@SuppressWarnings("unchecked")
//	            Collection<Map<String, Object>> list ??????
	     	List list = ye161040DAO.selectYeta7300ToYe161040List(ye161040SrhVo);
	...
	/** 교육비내역 조회 **/
//	public PagingLoadResult<BaseModel> getYeta7300ToYe161090List(ServiceParameters serviceParameters) throws MSFException {
//			
//
//			PagingLoadResult<BaseModel> retval = null;
...
//	}
	...
	/** 기본사항 tab 조회 **/
	public Ye161020DTO getYeta7300ToYe161020Data(Ye161020DTO ye161020Dto) throws MSFException {
		

		Ye161020Srh_2022_VO ye161020SrhVo = new Ye161020Srh_2022_VO();
		MSFSysm0100BM sessionUser;

		String method = calledClass + ".getYeta7300ToYe161020Data";

		String windowNm = "소득공제신고자료관리";
		String windowId = "YETA7300";
		...
		if (MSFSharedUtils.paramNull(ye161020DAO)) {
			...
			ye161020DAO = (Ye161020_2022_DAO) wac.getBean("Ye161020_2022_DAO");
		}
...
//		int iResultCnt = ye161020DAO.selectYeta2300ToYe161020ListtTotCnt(ye161020SrhVo);
		...
		try {
			...
			egovResultDataList = ye161020DAO.selectYeta7300ToYe161020Data(ye161020SrhVo);
...
//					
	...
	/** 기본사항 tab 수정 **/ 
	@Override
	public int saveYeta7300ToYe161020tabItem01(Ye161020DTO ye161020Dto)throws Exception {
		// TODO Auto-generated method stub
		
		int result = 0;
		
		Ye161020_2022_VO ye161020Vo = new Ye161020_2022_VO();
		Ye160404_2022_VO ye160404Vo = new Ye160404_2022_VO();
		...
		Yeta7300ListenerAdapter  yeta7300ListenerAdt = new Yeta7300ListenerAdapter();
		
		// 1. 암호화 객체 생성
		String nResult = AnyCryptUtils.XecureCryptInitialize(RemoteServiceUtil.getThreadLocalConfig(),RemoteServiceUtil.getThreadLocalRequest());
		
		String method = calledClass + ".saveYeta7300ToYe161020tabItem01";
		MSFSysm0100BM sessionUser = MSFServerUtils.getLoggedUser(RemoteServiceUtil.getThreadLocalRequest());
		
		try{
			// ---------- 기본사항 수정 시작 -------------------
			ye161020Vo = new Ye161020_2022_VO();
			...
			ye161020DAO.updateYeta7300Item01ToYe161020(ye161020Vo);
...
//			ye160404DAO.updateYeta2300ToYe160404(ye160404Vo);
			...
			// 주현근무처 ye169010
			ye169010Vo = new Ye169010_2022_VO();
			...
			ye169010DAO.updateYeta7300ToYe169010(ye169010Vo);
			
			BeanUtils.copyProperties(infcPkgYe161010Vo , ye169010Vo);  
			yeta7300ListenerAdt = new Yeta7300ListenerAdapter();
			yeta7300ListenerAdt.fnYeta7300_Ye161010_2022_CalcUpdate(RemoteServiceUtil.getThreadLocalRequest(), infcPkgYe161010Vo, "YE166020_INSERT");
	...
	/** 인적공제 tab 조회 **/
	public Ye161020DTO getYeta7300TabItem02ToYe161020Data(Ye161020DTO ye161020Dto) throws MSFException {
		

		Ye161020Srh_2022_VO ye161020SrhVo = new Ye161020Srh_2022_VO();
		MSFSysm0100BM sessionUser;

		String method = calledClass + ".getYeta7300TabItem02ToYe161020Data";
		...
		int iResultCnt = ye161020DAO.selectYeta7300ToYe161020ListtTotCnt(ye161020SrhVo);
...
//					returnYe161020Dto.set표준세액공제적용여부(MSFSharedUtils.allowNulls(tempMap.get("표준세액공제적용여부")));		/** column 표준세액공제적용여부 : 표준세액공제적용여부 */
	...
	/** 연금보험료공제 tab 조회 **/
	public Ye161055DTO getYeta7300TabItem04ToYe161055Data(Ye161055DTO ye161055Dto) throws MSFException {
		

		Ye161055Srh_2022_VO ye161055SrhVo = new Ye161055Srh_2022_VO();
		MSFSysm0100BM sessionUser;

		String method = calledClass + ".getYeta7300TabItem04ToYe161055Data";
		...
		if (MSFSharedUtils.paramNull(ye161055DAO)) {
			WebApplicationContext wac = WebApplicationContextUtils.getRequiredWebApplicationContext(getHttpServletRequest()
							.getSession().getServletContext());
			ye161055DAO = (Ye161055_2022_DAO) wac.getBean("Ye161055_2022_DAO");
		}
		...
		try {
			...
			egovResultDataList = ye161055DAO.selectYeta7300ToYe161055List(ye161055SrhVo);
	...
	/** 연금보험료공제 tab 수정 **/   
	@Override
	public int saveYeta7300ToYe161055tabItem04(Ye161055DTO ye161055Dto)throws Exception {
		// TODO Auto-generated method stub
		
		int result = 0;
		String method = calledClass + ".saveYeta7300ToYe161055tabItem04";
		...
		try{
			...
			ye161055Vo = new Ye161055_2022_VO();
			...
			ye161050Vo = new Ye161050_2022_VO();
			...
			ye161055DAO.updateYeta7300ToYe161055(ye161055Vo);
			ye161050DAO.updateYeta7300ToYe161050(ye161050Vo);
			
			BeanUtils.copyProperties(infcPkgYe161010Vo , ye161050Vo);  
			yeta7300ListenerAdt.fnYeta7300_Ye161010_2022_CalcUpdate(RemoteServiceUtil.getThreadLocalRequest(), infcPkgYe161010Vo, "YE161050");
	...
	/** 특별소득공제 tab 조회 **/
	public Ye161060DTO getYeta7300TabItem05ToYe161060Data(Ye161060DTO ye161060Dto) throws MSFException {
		

		Ye161060Srh_2022_VO ye161060SrhVo = new Ye161060Srh_2022_VO();
		MSFSysm0100BM sessionUser;

		String method = calledClass + ".getYeta7300TabItem05ToYe161060Data";
		...
		if (MSFSharedUtils.paramNull(ye161060DAO)) {
			WebApplicationContext wac = WebApplicationContextUtils.getRequiredWebApplicationContext(getHttpServletRequest()
							.getSession().getServletContext());
			ye161060DAO = (Ye161060_2022_DAO) wac.getBean("Ye161060_2022_DAO");
		}
		...
		try {
			...
			egovResultDataList = ye161060DAO.selectYeta7300ToYe161060tabItem05List(ye161060SrhVo);
	...
	@Override
	public int saveYeta7300ToYe161060tabItem05_1(Ye161060DTO ye161060Dto)throws Exception {
		// TODO Auto-generated method stub
		
		int result = 0;
		String method = calledClass + ".saveYeta7300ToYe161060tabItem05_1";
		...
		try{
			...
			ye161060DAO.updateYeta7300ToYe161060tabItem05_1(ye161060Vo);
			
			BeanUtils.copyProperties(infcPkgYe161010Vo , ye161060Vo);  
			yeta7300ListenerAdt.fnYeta7300_Ye161010_2022_CalcUpdate(RemoteServiceUtil.getThreadLocalRequest(), infcPkgYe161010Vo, "YE161060");
	...
	@Override
	public int saveYeta7300ToYe161060tabItem05_2(Ye161060DTO ye161060Dto)throws Exception {
		// TODO Auto-generated method stub
		
		int result = 0;
		String method = calledClass + ".saveYeta7300ToYe161060tabItem05_2";
		...
		try{
			...
			ye161060DAO.updateYeta7300ToYe161060tabItem05_2(ye161060Vo);
	...
	/** 그밖의소득공제1 tab 조회 **/
	public Ye161070DTO getYeta7300TabItem06ToYe161070Data(Ye161070DTO ye161070Dto) throws MSFException {
		

		Ye161070Srh_2022_VO ye161070SrhVo = new Ye161070Srh_2022_VO();
		MSFSysm0100BM sessionUser;

		String method = calledClass + ".getYeta7300TabItem06ToYe161070Data";
		...
		if (MSFSharedUtils.paramNull(ye161070DAO)) {
			WebApplicationContext wac = WebApplicationContextUtils.getRequiredWebApplicationContext(getHttpServletRequest()
							.getSession().getServletContext());
			ye161070DAO = (Ye161070_2022_DAO) wac.getBean("Ye161070_2022_DAO");
		}
		...
		try {
			...
			egovResultDataList = ye161070DAO.selectYeta7300ToYe161070List(ye161070SrhVo);
	...
	/** 그밖의소득공제1tab 금액 수정 **/
	@Override
	public int saveYeta7300ToYe161070tabItem06(Ye161070DTO ye161070Dto)throws Exception {
		// TODO Auto-generated method stub
		
		int result = 0;
		String method = calledClass + ".saveYeta7300ToYe161070tabItem06";
		...
		Ye161070_2022_VO ye161070Vo = new Ye161070_2022_VO();
		MSFSysm0100BM sessionUser = MSFServerUtils.getLoggedUser(RemoteServiceUtil.getThreadLocalRequest());
...
//		ye161070Vo.setLtrmCniSsDdcAmt(new BigDecimal(MSFSharedUtils.defaultNulls( ye161070Dto.getLtrmCniSsDdcAmt(), "0")));    				/** column 장기집합투자증권저축공제금액 : ltrmCniSsDdcAmt */
		...
		try{
			...
			ye161070DAO.updateYeta7300ToYe161070tabItem06(ye161070Vo);
			
			BeanUtils.copyProperties(infcPkgYe161010Vo , ye161070Vo);  
			yeta7300ListenerAdt.fnYeta7300_Ye161010_2022_CalcUpdate(RemoteServiceUtil.getThreadLocalRequest(), infcPkgYe161010Vo, "YE161070");
	...
	/** 그밖의소득공제2tab 금액 수정 **/
	@Override
	public int saveYeta7300ToYe161070tabItem07(Ye161070DTO ye161070Dto)throws Exception {
		// TODO Auto-generated method stub
		
		int result = 0;
		String method = calledClass + ".saveYeta7300ToYe161070tabItem07";
...
//		ye161070Vo.setTyShfyPrsAddDdcrtUseAmt(new BigDecimal(MSFSharedUtils.defaultNulls( ye161070Dto.getTyShfyPrsAddDdcrtUseAmt(), "0")));	/** column 본인추가공제율사용분_2016_상반기 : tyShfyPrsAddDdcrtUseAmt */
		...
		try{
			...
			ye161070DAO.updateYeta7300ToYe161070tabItem07(ye161070Vo);
	...
	/** 세액감면및세액공제1tab 조회 **/
	public Ye161080DTO getYeta7300TabItem08ToYe161080Data(Ye161080DTO ye161080Dto) throws MSFException {
		

		Ye161080Srh_2022_VO ye161080SrhVo = new Ye161080Srh_2022_VO();
		MSFSysm0100BM sessionUser;

		String method = calledClass + ".getYeta7300TabItem08ToYe161080Data";
		...
		if (MSFSharedUtils.paramNull(ye161080DAO)) {
			WebApplicationContext wac = WebApplicationContextUtils.getRequiredWebApplicationContext(getHttpServletRequest()
							.getSession().getServletContext());
			ye161080DAO = (Ye161080_2022_DAO) wac.getBean("Ye161080_2022_DAO");
		}
		...
		try {
			...
			egovResultDataList = ye161080DAO.selectYeta7300ToYe161080tabItem08List(ye161080SrhVo);
	...
	@Override
	public int saveYeta7300ToYe161080tabItem08_1(Ye161080DTO ye161080Dto)throws Exception {
		// TODO Auto-generated method stub
		
		int result = 0;
		String method = calledClass + ".saveYeta7300ToYe161060tabItem08_1";
		...
		Ye161080_2022_VO ye161080Vo = new Ye161080_2022_VO();
		MSFSysm0100BM sessionUser = MSFServerUtils.getLoggedUser(RemoteServiceUtil.getThreadLocalRequest());
...
//		ye161080Vo.setInfeePymDdcAmtSum(new BigDecimal(MSFSharedUtils.defaultNulls(ye161080Dto.getInfeePymDdcAmtSum(), "0")));    		/** column 보험료공제세액합계 : infeePymDdcAmtSum */
		...
		try{
			...
			ye161080DAO.updateYeta7300ToYe161080tabItem08_1(ye161080Vo);
			
			BeanUtils.copyProperties(infcPkgYe161010Vo , ye161080Vo);  
			yeta7300ListenerAdt.fnYeta7300_Ye161010_2022_CalcUpdate(RemoteServiceUtil.getThreadLocalRequest(), infcPkgYe161010Vo, "YE162010");
	...
	@Override
	public int saveYeta7300ToYe161080tabItem08_3(Ye161080DTO ye161080Dto) throws Exception {
		// TODO Auto-generated method stub

		int result = 0;
		String method = calledClass + ".saveYeta7300ToYe161080tabItem08_3";
...
//		ye161080Vo.setScxpsDdcAmtSum(new BigDecimal(MSFSharedUtils.defaultNulls(ye161080Dto.getScxpsDdcAmtSum(), "0")));    /** column 교육비공제세액금액합계 : scxpsDdcAmtSum */
		...
		try{
			...
			ye161080DAO.updateYeta7300ToYe161080tabItem08_3(ye161080Vo);
			
			BeanUtils.copyProperties(infcPkgYe161010Vo , ye161080Vo);  
			yeta7300ListenerAdt.fnYeta7300_Ye161010_2022_CalcUpdate(RemoteServiceUtil.getThreadLocalRequest(), infcPkgYe161010Vo, "YE161080");
	...
	public Long saveYeta7300ToYe161090tabItem08_3(List<Ye161090DTO> listYe161090Dto, ActionDatabase actionDatabase) throws Exception {
		...
		String method = calledClass + ".saveYeta7300ToYe161090tabItem08_3";
		...
		Ye161090_2022_VO ye161090Vo = new Ye161090_2022_VO();
		...
		try {
			...
			for (int iYetaCnt = 0; iYetaCnt < listYe161090Dto.size(); iYetaCnt++) {
        		...
        		ye161090Vo = new Ye161090_2022_VO();
				...
				case INSERT:
					...
					ye161090DAO.insertYeta7300ToYe161090(ye161090Vo);
					
					break;
				case UPDATE:
					
					ye161090DAO.updateYeta7300ToYe161090(ye161090Vo);

					break;
				case DELETE:
					
					ye161090DAO.deleteYeta7300ToYe161090(ye161090Vo);
	...
	/** 세액감면및세액공제2tab 조회 **/
	public Ye161080DTO getYeta7300TabItem09ToYe161080Data(Ye161080DTO ye161080Dto) throws MSFException {
		

		Ye161080Srh_2022_VO ye161080SrhVo = new Ye161080Srh_2022_VO();
		MSFSysm0100BM sessionUser;

		String method = calledClass + ".getYeta7300TabItem09ToYe161080Data";
		...
		try {
			...
			egovResultDataList = ye161080DAO.selectYeta7300ToYe161080tabItem09List(ye161080SrhVo);
...
//					returnYe161080Dto.setYetaC119(Long.parseLong(MSFSharedUtils.defaultNulls(tempMap.get("yetaC119"), "0")));    					/** column C119_세액감면합계금액 : yetaC119 */
	...
	/** 세액감면및세액공제2 금액 수정 **/
	@Override
	public int saveYeta7300ToYe161080tabItem09(Ye161080DTO ye161080Dto)throws Exception {
		// TODO Auto-generated method stub
		
		int result = 0;
		String method = calledClass + ".saveYeta7300ToYe161080tabItem09";
...
//		ye161080Vo.setIncmDducWtnnteSumtDt(ye161080Dto.getIncmDducWtnnteSumtDt());    /** column 소득공제신고서제출일자 : incmDducWtnnteSumtDt */
			...
			ye161080DAO.updateYeta7300ToYe161080tabItem09(ye161080Vo);
			ye169010DAO.updateYeta7300ToYe169010tabItem09(ye169010Vo);
	...
	/** 추가제출서류tab 조회 **/
	public Ye161080DTO getYeta7300TabItem10ToYe161080Data(Ye161080DTO ye161080Dto) throws MSFException {
		

		Ye161080Srh_2022_VO ye161080SrhVo = new Ye161080Srh_2022_VO();
		MSFSysm0100BM sessionUser;

		String method = calledClass + ".getYeta7300TabItem10ToYe161080Data";
		...
		try {
			...
			egovResultDataList = ye161080DAO.selectYeta7300ToYe161080tabItem10List(ye161080SrhVo);
	...
	/** 추가제출서류 수정 **/
	@Override
	public int saveYeta7300ToYe161080tabItem10(Ye161080DTO ye161080Dto)throws Exception {
		// TODO Auto-generated method stub
		
		int result = 0;
		String method = calledClass + ".saveYeta7300ToYe161080tabItem10";
...
//		ye161080Vo.setCd218(ye161080Dto.getCd218());    /** column 신고인성명 : cd218 *
		...
		try{
			...
			ye161080DAO.updateYeta7300ToYe161080tabItem10(ye161080Vo);
	...
	/** 인적공제 명세 추가 **/
	@Override
	public Long activityOnYeta7300ToYe161030(List<Ye161030DTO> listYe161030Dto, ActionDatabase actionDatabase)  throws MSFException {
		...
		String method = calledClass + ".activityOnYeta7300ToYe161030";
		MSFSysm0100BM sessionUser = MSFServerUtils.getLoggedUser(RemoteServiceUtil.getThreadLocalRequest());
		...
		try { 
			Ye161020_2022_VO  ye161020Vo = new Ye161020_2022_VO();
			Ye161030_2022_VO  ye161030Vo = new Ye161030_2022_VO();
			Ye161040_2022_VO  ye161040Vo = new Ye161040_2022_VO();
			Ye164010_2022_VO  ye164010Vo = new Ye164010_2022_VO();
			Ye161090_2022_VO  ye161090Vo = new Ye161090_2022_VO();
			...
			for(int iYetaCnt=0; iYetaCnt < listYe161030Dto.size(); iYetaCnt++) {
				...
				/** 인적공제명세  **/
				ye161030Vo = new Ye161030_2022_VO();
	            ...
	            /** 의료비  **/
	            ye164010Vo = new Ye164010_2022_VO();
	            ...
	            /** 인적소득 **/
	            ye161040Vo = new Ye161040_2022_VO();
...
//                tpPayr0530Vo.setSchlExpnExtpyPymtEndDt(payr0530Dto.getSchlExpnExtpyPymtEndDt());    /** column 학비수당지급종료일자 : schlExpnExtpyPymtEndDt */
				...
				case INSERT:
					...
					ye161030DAO.insertYeta7300ToYe161030(ye161030Vo);
...
//					payr0530Vo.setInptAddr(RemoteServiceUtil.getThreadLocalRequest().getRemoteHost());    	/** column 입력주소 : inptAddr */
					...
					ye161040DAO.deleteYeta7300ToYe161040(ye161040Vo); 
					// 소득공제명세 데이터 추가 
					ye161040DAO.insertYeta7300ToYe161040_01(ye161040Vo);
					ye161040DAO.insertYeta7300ToYe161040_02(ye161040Vo);
...
//					yeta2300ListenerAdt.fnYeta2300_Ye161010_2017_CalcUpdate(RemoteServiceUtil.getThreadLocalRequest(), infcPkgYe161010Vo, "YE166020_DELETE");
					yeta7300ListenerAdt.fnYeta7300_Ye161010_2022_CalcUpdate(RemoteServiceUtil.getThreadLocalRequest(), infcPkgYe161010Vo, "YE166020_NEW");
					yeta7300ListenerAdt.fnYeta7300_Ye161010_2022_CalcUpdate(RemoteServiceUtil.getThreadLocalRequest(), infcPkgYe161010Vo, "YE161030");
				...
				case UPDATE:
					...
					if(ye161030Vo.getTxprDscmNoCntn() != null || !"".equals(ye161030Vo.getTxprDscmNoCntn())) {
						...
						ye161030DAO.updateYeta7300ToYe161030(ye161030Vo);
					}
					...
					ye161020DAO.updateYeta7300Item02ToYe161020(ye161020Vo);
...
//					yeta3220Vo.setBeforeJumin(MSFSharedUtils.allowNulls(yeta3220Dto.getBeforeJumin().replace("-", "")));	//수정전 주민번호
					...
					// 1. 인적공제 내역 삭제
					ye161030DAO.deleteYeta7300ToYe161030(ye161030Vo);
					
					// 2. 의료비 내역
					ye164010DAO.deleteYeta7300ToYe164010(ye164010Vo);
					...
					yeta7300ListenerAdt = new Yeta7300ListenerAdapter();
					BeanUtils.copyProperties(infcPkgYe161010Vo , ye161030Vo);  
					yeta7300ListenerAdt.fnYeta7300_Ye161010_2022_CalcUpdate(RemoteServiceUtil.getThreadLocalRequest(), infcPkgYe161010Vo, "YE166020_DELETE");
			...
			result = new Long(0);
			ex.printStackTrace();
			throw MSFServerUtils.getOperationException("activityOnYeta7300ToYe161030", ex, logger);
	...
	/** 소득공제 tab 수정 **/ 
	@Override
	public int saveYeta7300ToYe1610400tabItem03(List<Ye161040DTO> listYe161040Dto_01, List<Ye161040DTO> listYe161040Dto_02)  throws MSFException {
		...
		String method = calledClass + ".saveYeta7300ToYe1610400tabItem03";
		MSFSysm0100BM sessionUser = MSFServerUtils.getLoggedUser(RemoteServiceUtil.getThreadLocalRequest());
...
//				ye161040Vo.setInptAddr(ye161040Dto.getInptAddr());    /** column 입력주소 : inptAddr */
		        ...
		        ye161040DAO.updateYeta7300ToYe161040(ye161040Vo);
...
//			 yeta2000DAO.updateYeta0300ToYeta2000_Item03(yeta2000Vo);  
			...
			result = 0;
			ex.printStackTrace();
			throw MSFServerUtils.getOperationException("saveYeta7300ToYe1610400tabItem03_1", ex, logger);
...
//			yeta2000DAO.updateYeta0300ToYeta2000_Item03(yeta2000Vo);  
			...
			throw MSFServerUtils.getOperationException("saveYeta7300ToYe1610400tabItem03_2", ex, logger);
   ...
   @Override
	 public PagingLoadResult<ShowMessageBM> fnYeta7300_Ye161010_2022_CalcTax(List<Ye161010DTO> listYe161010Dto) throws MSFException {
    	...
    	String method = calledClass + ".fnYeta7300_Ye161010_2022_CalcTax";
        MSFSysm0100BM sessionUser = MSFServerUtils.getLoggedUser(RemoteServiceUtil.getThreadLocalRequest());
...
//					 
           ...
           Yeta7300ListenerAdapter yetaLsAdtr = new Yeta7300ListenerAdapter();
           retval = yetaLsAdtr.fnYeta7300_Ye161010_2022_CalcTax(RemoteServiceUtil.getThreadLocalRequest(),listYe161010VO);
 
        }
        catch (Exception ex) {
        	 
            logger.error("EXCEPTION calling fnYeta7300_Ye161010_2022_CalcTax(): "+ex); 
            
            /** 에러 로그 **/			
            MSFLogHistoryUtils.tracerUserExceptionActivity(sessionUser,method,calledClass,"C",ex, windowNm , windowId);
             
            throw MSFServerUtils.getOperationException("fnYeta7300_Ye161010_2022_CalcTax", ex, logger);
        }
        finally {
...
*/
   @Override
 public PagingLoadResult<ShowMessageBM> fnYeta7300Ye161010_2022_AllCalcTax(Ye161010DTO ye161010Dto) throws MSFException {
    	...
    	String method = calledClass + ".fnYeta7300Ye161010_2022_AllCalcTax";
        MSFSysm0100BM sessionUser = MSFServerUtils.getLoggedUser(RemoteServiceUtil.getThreadLocalRequest());
       ...
       // yeta2200Service = (InfcPkgYeta2200Service)BeanFinder.getBean("InfcPkgYeta2200Service"); 
        ...
        try {  
	          ...
	          Ye161010Srh_2022_VO  ye161010SrhVo = new Ye161010Srh_2022_VO(); 
	          List<InfcPkgYe161010_2022_VO> listPkgYe161010VO = new ArrayList<InfcPkgYe161010_2022_VO>();
	          List<Ye161010_2022_VO> listYe161010VO = new ArrayList<Ye161010_2022_VO>();
	          ...
	          listYe161010VO = (List<Ye161010_2022_VO>)ye161010DAO.selectYeta7300ToYe161010AllList(ye161010SrhVo);
              ...
              for (int iCnt = 0;iCnt < listYe161010VO.size();iCnt++) { 
  		    	...
  		    	String nResult = AnyCryptUtils.XecureCryptInitialize(RemoteServiceUtil.getThreadLocalConfig(),RemoteServiceUtil.getThreadLocalRequest());
	            	...
	            	Ye161010_2022_VO  ye161010Vo = new Ye161010_2022_VO();  
	            	 ...
	            	 ye161010Vo = (Ye161010_2022_VO) listYe161010VO.get(iCnt); 
                  ...
                  Yeta7300ListenerAdapter yetaLsAdtr = new Yeta7300ListenerAdapter();
                  retval = yetaLsAdtr.fnYeta7300_Ye161010_2022_CalcTax(RemoteServiceUtil.getThreadLocalRequest(),listPkgYe161010VO);
   
	        } 
	        catch (Exception ex) {
	        	 
	            logger.error("EXCEPTION calling fnYeta7300Ye161010_2022_AllCalcTax(): "+ex); 
            
            /** 에러 로그 **/			
            MSFLogHistoryUtils.tracerUserExceptionActivity(sessionUser,method,calledClass,"C",ex, windowNm , windowId);
             
            throw MSFServerUtils.getOperationException("fnYeta7300Ye161010_2022_AllCalcTax", ex, logger);
        }
        finally {
   ...
   //소득공제신고서 재적용
   @Override
   public PagingLoadResult<ShowMessageBM> fnYeta7300Ye161010_2022_SbtVolUse(Ye161010DTO ye161010Dto) throws MSFException {
	   ...
	   String method = calledClass + ".fnYeta7300Ye161010_2022_SbtVolUse";
	   MSFSysm0100BM sessionUser = MSFServerUtils.getLoggedUser(RemoteServiceUtil.getThreadLocalRequest());
	   ...
	   try {  
		   ...
		   Ye161010Srh_2022_VO  ye161010SrhVo = new Ye161010Srh_2022_VO(); 
		   InfcPkgYe161010_2022_VO pkgYe161010VO = new InfcPkgYe161010_2022_VO();
		   ...
		   Func_PdfInDdc_Yeta2022_Insert funcPdfInDdc = new Func_PdfInDdc_Yeta2022_Insert();
		   strReturnPdfCheck = funcPdfInDdc.pdfInDdc_Yeta2022_Insert(pkgYe161010VO, RemoteServiceUtil.getThreadLocalRequest());
   ...
   @Override
	public Ye161020DTO getYeta7300TxDdcYnToYe161020Data(Ye161020DTO ye161020Dto) throws MSFException {


		Ye161020Srh_2022_VO ye161020SrhVo = new Ye161020Srh_2022_VO();
		MSFSysm0100BM sessionUser;

		String method = calledClass + ".getYeta7300TxDdcYnToYe161020Data";
		...
		try {
			...
			egovResultDataList = ye161020DAO.getYeta7300TxDdcYnToYe161020Data(ye161020SrhVo);
	...
	/** 합계 일괄업데이트 **/
	@Override
	public int updateYeta7300All(List<Ye161040DTO> listYe161040Dto)throws MSFException {
		// TODO Auto-generated method stub
		...
		try{
            ...
            for (int iCnt = 0;iCnt < listYe161040Dto.size();iCnt++) { 
				...
				listYe161010VO.add(infcPkgYe161010Vo);
				 ...
				 yeta7300ListenerAdt = new Yeta7300ListenerAdapter();
				 yeta7300ListenerAdt.fnYeta7300_Ye161010_2022_CalcUpdate(RemoteServiceUtil.getThreadLocalRequest(), infcPkgYe161010Vo, "YE164010");
				 yeta7300ListenerAdt.fnYeta7300_Ye161010_2022_CalcUpdate(RemoteServiceUtil.getThreadLocalRequest(), infcPkgYe161010Vo, "YE161090");
				 yeta7300ListenerAdt.fnYeta7300_Ye161010_2022_CalcUpdate(RemoteServiceUtil.getThreadLocalRequest(), infcPkgYe161010Vo, "YE161050");
				 yeta7300ListenerAdt.fnYeta7300_Ye161010_2022_CalcUpdate(RemoteServiceUtil.getThreadLocalRequest(), infcPkgYe161010Vo, "YE165010");
				 yeta7300ListenerAdt.fnYeta7300_Ye161010_2022_CalcUpdate(RemoteServiceUtil.getThreadLocalRequest(), infcPkgYe161010Vo, "YE162010");
				 yeta7300ListenerAdt.fnYeta7300_Ye161010_2022_CalcUpdate(RemoteServiceUtil.getThreadLocalRequest(), infcPkgYe161010Vo, "YE162510");
				 yeta7300ListenerAdt.fnYeta7300_Ye161010_2022_CalcUpdate(RemoteServiceUtil.getThreadLocalRequest(), infcPkgYe161010Vo, "YE166020_INSERT");
				 yeta7300ListenerAdt.fnYeta7300_Ye161010_2022_CalcUpdate(RemoteServiceUtil.getThreadLocalRequest(), infcPkgYe161010Vo, "YE166020_DELETE");
