...
@RemoteServiceRelativePath("YetaP23003Service.gwt")
public interface YetaP23003Service extends RemoteService {
	/**
	 * Utility class for simplifying access to the instance of async service.
	 */
	public static class Util {
		private static YetaP23003ServiceAsync instance;
		public static YetaP23003ServiceAsync getInstance(){
			if (instance == null) {
				instance = GWT.create(YetaP23003Service.class);
			}
			return instance;
		}
	}
