...
import com.app.exterms.yearendtax.client.dto.yeta2020.Ye161005BM;
...
import com.app.exterms.yearendtax.client.form.defs.yeta2020.Ye18Ta1000Def;
import com.app.exterms.yearendtax.client.service.yeta2020.Yeta5400Service;
import com.app.exterms.yearendtax.client.service.yeta2020.Yeta5400ServiceAsync;
 ...
 * =====================================================
 **/
public class Yeta5400 extends MSFPanel {
	...
	private FormPanel plFrmYeta5400;
...
//	private MSFGridPanel typOccuCdGridPanel;
	 ...
	 **/
	// ---------- 상단 버튼 시작 ----------
	private ButtonBar topYeta5400Bar;
	private Button btnYeta5400Reset;	//초기화
	private Button btnYeta5400Save;		//저장
	private Button btnYeta5400Search;	//조회
	// ---------- 상단 버튼 종료 ----------
	
	// ---------- 엑셀 버튼 시작 ----------
	private ButtonBar exYeta5400Bar;	
...
//	private Yeta0100ServiceAsync yeta0100Service = Yeta0100Service.Util.getInstance();
	private Yeta5400ServiceAsync yeta5400Service = Yeta5400Service.Util.getInstance();
	// -------------- 서비스 호출 종료 --------------
	 ...
	 */
	private void checkYeta5400Auth(String authAction, ListStore<BaseModel> bm) {
	 ...
	 private void authExecEnabled() { 
		 ...
		 /**
			...
			creYrtxBlggYr.setValue(lsClutYrStore.findModel("year", "2020"));
			yrtxBlggYr.setValue(lscreClutYrStore.findModel("year", "2020"));
...
//			formData = new FormData("-650");
			...
			createYeta5400Form();	// 화면 기본정보를 설정
	...
	public Yeta5400(String txtForm) {
...
//
		...
		plFrmYeta5400.setLayout(new FlowLayout());
		...
		lscreEmymtDivCd.addStoreListener(new StoreListener<BaseModel>() {
			public void handleEvent(StoreEvent<BaseModel> be) {
				...
				if (type == Store.Add) {
					 ...
					 * ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
					 */
					checkYeta5400Auth("creEmymtDivCd", lscreEmymtDivCd);
				}
			}
		});
		...
		creDeptCd.getStore().addStoreListener(new StoreListener<ModelData>() {
			public void handleEvent(StoreEvent<ModelData> be) {
				...
				if (type == Store.Add) {
					 ...
					 * ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
					 */
					checkYeta5400Auth("creDeptCd", lscreDeptCd);
				}
			}
		});
		...
		creTypOccuCd.getStore().addStoreListener(new StoreListener<ModelData>() {
			public void handleEvent(StoreEvent<ModelData> be) {
				...
				if (type == Store.Add) {
					 ...
					 * ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
					 */
					//checkYeta5400Auth("creTypOccuCd", lsTypOccuCd);
				}
			}
		});
...
//		PayrMangDeptCd = new HiddenField<String>(); //급여관리부서코드 
		...
		// 파일업로드 처리
		plFrmYeta5400.setAction("myurl");
		plFrmYeta5400.setEncoding(Encoding.MULTIPART);
		plFrmYeta5400.setMethod(Method.POST);

		plFrmYeta5400.setSize("990px", "820px");
		plFrmYeta5400.setLayout(new FlowLayout());
...
//		layoutContainer1_4.setStyleAttribute("marginBottom", "10px");
		...
		exYeta5400Bar = new ButtonBar();
		exYeta5400Bar.setAlignment(HorizontalAlignment.RIGHT);

		/*
		btnYetaVerifiction= new Button("신고사전검증");
		exYeta5400Bar.add(btnYetaVerifiction);
		...
		exYeta5400Bar.add(btnYetaExImport);

		btnYetaExSave= new Button("신고파일생성");
		exYeta5400Bar.add(btnYetaExSave);
		...
		layoutContainer11.add(exYeta5400Bar);
		...
		plFrmYeta5400.add(layoutContainer1_4,new com.extjs.gxt.ui.client.widget.layout.ColumnData(1));	// 텍스트와 버튼
...
//		});
	...
	private void createYeta5400Form() {

		plFrmYeta5400 = new FormPanel();
		plFrmYeta5400.setHeadingText(PayGenConst.PAYGEN_VERSION.concat(" - 연말정산신고파일생성"));
		plFrmYeta5400.setIcon(Resources.APP_ICONS.text());
		plFrmYeta5400.setPadding(2);
		plFrmYeta5400.setFrame(true);
		...
		plFrmYeta5400.getHeader().setStyleAttribute("padding", "5px 0 2px 0");
		plFrmYeta5400.getHeader().addTool(btnlogView); 
		/************************************************************************
		 * 화면 에러 처리시 필요한 부분으로 추가 
		 ************************************************************************/
		
		   //멀티콤보박스 닫기 
		plFrmYeta5400.addListener(Events.OnClick,new Listener<ComponentEvent>() { 
		            @Override
		            public void handleEvent(ComponentEvent ce) { 
...
//						                        }
	...
	private void createSearchForm() {
		...
		topYeta5400Bar = new ButtonBar();
		topYeta5400Bar.setAlignment(HorizontalAlignment.RIGHT);

		btnYeta5400Reset = new Button("초기화");
		btnYeta5400Reset.setIcon(MSFMainApp.ICONS.new16());
		btnYeta5400Reset.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				resetStandardForm();	//전자신고기본정보 초기화
			}
		});
		topYeta5400Bar.add(btnYeta5400Reset);

//		topBtn = new Button("신 규");
//		topBtn.setIcon(MSFMainApp.ICONS.new16());
//		topYeta5400Bar.add(topBtn);
...
//		buttonBar.add(topBtn);
		...
		btnYeta5400Save = new Button("저 장");
		btnYeta5400Save.setIcon(MSFMainApp.ICONS.save16());
		btnYeta5400Save.addListener(Events.Select, new Listener<ButtonEvent>() {
			@Override
		...
		topYeta5400Bar.add(btnYeta5400Save);

		btnYeta5400Search = new Button("조 회");
		btnYeta5400Search.setIcon(MSFMainApp.ICONS.search());
		btnYeta5400Search.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
...
//				ye161005Bm.setSrhBusinCd(MSFSharedUtils.getSelectedComboValue(srhBusinCd,"businCd"));
				...
				yeta5400Service.getYeta5400List(ye161005Dto, new AsyncCallback<Ye161005BM>(){
		...
		topYeta5400Bar.add(btnYeta5400Search);

//		topBtn = new Button("인 쇄");
//		topBtn.setIcon(MSFMainApp.ICONS.print16());
//		buttonBar.add(topBtn);
		
		plFrmYeta5400.add(topYeta5400Bar);
		...
		lsEmymtDivCd.addStoreListener(new StoreListener<BaseModel>() {
			public void handleEvent(StoreEvent<BaseModel> be) {
				...
				if (type == Store.Add) {
					 ...
					 * ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
					 */
					checkYeta5400Auth("srhEmymtDivCd", lsEmymtDivCd);
				}
			}
		});
		...
		srhDeptCd.getStore().addStoreListener(new StoreListener<ModelData>() {
			public void handleEvent(StoreEvent<ModelData> be) {
				...
				if (type == Store.Add) {
					 ...
					 * ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
					 */
					checkYeta5400Auth("srhDeptCd", lsDeptCd);
				}
			}
		});
		...
		srhTypOccuCd.getStore().addStoreListener(new StoreListener<ModelData>() {
			public void handleEvent(StoreEvent<ModelData> be) {
				...
				if (type == Store.Add) {
					 ...
					 * ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
					 */
					//checkYeta5400Auth("srhTypOccuCd", lsTypOccuCd);
				}
			}
		});
...
//        cpGrid.add(gridFieldSet);
		...
		plFrmYeta5400.add(gridFieldSet);
//		plFrmYeta5400.add(msfGridPanel);
	}
...
//		msfGridPanel.getTableDef().addColumnFilter("businCd", MSFSharedUtils.getSelectedComboValue(srhBusinCd,"businCd"), SimpleColumnFilter.OPERATOR_EQUALS);//사업
	...
	/** 정산 마감 및 풀기 **/
	private void finishYeta5400(final String flag) { 
...
//	    				ye161005Bm.setBusinCd(MSFSharedUtils.getSelectedComboValue(srhBusinCd,"businCd"));
	    			...
	    			//	ye17Ta1010Dto.setBusoprRgstnum(MSFSharedUtils.getSelectedComboValue(srhBusoprRgstnum, "busoprRgstnum"));
	      				...
	      				yeta5400Service.finishOnYe161005(ye17Ta1010Dto, new AsyncCallback<Long>(){
	                         public void onFailure(Throwable caught) {
...
//			} else { 
				msfGridPanel.callXlsExportServlet(GWT.getHostPageBaseURL() + "exp/XlsYeta5400Export.do","extgwtFrame" ,param);   
			//}
		}else{ 
			msfGridPanel.callXlsExportServlet(GWT.getHostPageBaseURL() + "exp/XlsYeta5400Export.do","extgwtFrame" ,param);  
		}
...
//		ye161005ExDto.setDpobCd(dpobCd.getValue());    														/** column 사업장코드 : dpobCd */
		...
		yeta5400Service.updateYe161005(ye161005ExDto, new AsyncCallback<Long>(){
			@Override
			public void onFailure(Throwable caught) {
...
//		param.put("businCd", MSFSharedUtils.getSelectedComboValue(creBusinCd,"businCd"));
		...
		if ("Y0090003".equals(MSFSharedUtils.allowNulls(param.get("creFile")))) {
			...
			msfGridPanel.callXlsExportServlet(GWT.getHostPageBaseURL() + "exp/FileYeta5400Export.do","extgwtFrame" ,param);   
			//}
		}else{ 
			msfGridPanel.callXlsExportServlet(GWT.getHostPageBaseURL() + "exp/FileYeta5400Export.do","extgwtFrame" ,param);  
		}	
...
//		param.put("businCd", MSFSharedUtils.getSelectedComboValue(creBusinCd,"businCd"));
		...
		if(MSFSharedUtils.paramNull(param.get("resuNumb"))){
			...
			MessageBox.info("", "중간 생성부 부서 또는 원천징수부서는 필수 입니다.(택1)", null);
				...
				msfGridPanel.callXlsExportServlet(GWT.getHostPageBaseURL() + "exp/Yeta5400Verifiction.do","extgwtFrame" ,param);   
