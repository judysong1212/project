...
//import com.app.exterms.yearendtax.client.dto.yeta2022.PdfG106yDTO;
import com.app.exterms.yearendtax.client.dto.yeta2022.PdfG107yDTO;
//import com.app.exterms.yearendtax.client.dto.yeta2022.PdfG206yDTO;
import com.app.exterms.yearendtax.client.dto.yeta2022.PdfG207yDTO;
//import com.app.exterms.yearendtax.client.dto.yeta2022.PdfG306yDTO;
...
//import com.app.exterms.yearendtax.client.form.defs.yeta2022.PdfG106yDef;
//import com.app.exterms.yearendtax.client.form.defs.yeta2022.PdfG206yDef;
//import com.app.exterms.yearendtax.client.form.defs.yeta2022.PdfG306yDef;
...
=====================================================**/
public  class YetaP720002   extends MSFFormPanel {  
	...
	private ButtonBar topYeta720002Bar;
	private Button btnYeta720002AllUsed; 	// 전체선택
	private Button btnYeta720002UnUsed; 		// 선택해제
	private Button btnYeta720002Save; 	// 소득공제반영
	// -------------- 권한 설정 객체 종료 --------------
	 ...
	 *~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ 		
	 **/ 		    
	public YetaP720002(final ActionDatabase actionDatabase, final MSFPanel caller) {
		...
		cpYeta71001.setScrollMode(Scroll.AUTOY);
		cpYeta71001.setHeaderVisible(false);
		cpYeta71001.setSize("913px", "660px");
	...
	private void createBasicForm() {
		...
		topYeta720002Bar = new ButtonBar();
		topYeta720002Bar.setAlignment(HorizontalAlignment.RIGHT);
		topYeta720002Bar.setStyleAttribute("paddingRight", "15px");
		topYeta720002Bar.setStyleAttribute("paddingTop", "5px");

		btnYeta720002AllUsed = new Button("전체선택");
		topYeta720002Bar.add(btnYeta720002AllUsed);
		btnYeta720002AllUsed.addSelectionListener(new SelectionListener<ButtonEvent>() {		        
		...
		btnYeta720002UnUsed = new Button("선택해제");
		topYeta720002Bar.add(btnYeta720002UnUsed);
		btnYeta720002UnUsed.addListener(Events.Select, new Listener<ButtonEvent>() {
		...
		btnYeta720002Save = new Button("소득공제반영");
		topYeta720002Bar.add(btnYeta720002Save);
		btnYeta720002Save.addSelectionListener(new SelectionListener<ButtonEvent>() {   
		...
		cpYeta71001.add(topYeta720002Bar, new FormData("100%"));
	}
	...
	private void createStandardForm() {
		...
		cpYeta71001.add(panel, new FormData("100%"));
