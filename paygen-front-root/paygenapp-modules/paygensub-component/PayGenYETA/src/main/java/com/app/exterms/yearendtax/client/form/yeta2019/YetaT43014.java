...
import com.app.exterms.yearendtax.client.service.yeta2019.YetaT43014Service;
import com.app.exterms.yearendtax.client.service.yeta2019.YetaT43014ServiceAsync;
...
//import com.app.exterms.yearendtax.client.form.defs.yeta2016.YetaT43014Def;
/**====================================================
디자인화면 수정시 extends 부분을 다음과 같이 수정하여 사용한 후 다시 원복한다.
extends MSFPanel ->  extends LayoutContainer  implements IMSFWindow { 
상속받아 소스를 구현한 경우에는 에러나는 부분을 수정하여 처리 해야함.
=====================================================**/
public  class YetaT43014   extends MSFFormPanel {  
 ...
 **/
	...
	private  ContentPanel cpYetaT43014; 
	...
	// -------------- grid 선언 시작  ---------------	  
	private MSFGridPanel YetaT43014GridPanel;
//	private YetaT43014Def YetaT43014Def = new YetaT43014Def("YetaT43014");   //TODO 일단 화면번호로 Def
	// -------------- grid 선언 종료  ---------------
	...
	// -------------- 서비스 호출 시작 --------------
	private YetaT43014ServiceAsync yetaT43014Service = YetaT43014Service.Util.getInstance();
	// -------------- 서비스 호출 종료 --------------	 
...
//					ye162510Dto.setMnthRnttyHusCnttArea((MSFSharedUtils.allowNulls(bmMapModel.get("mnthRnttyHusCnttArea"))));    		/** column 월세주택계약면적 : mnthRnttyHusCnttArea */
				...
				yetaT43014Service.activityOnYetaT43014(listYe162510Dto, actionDatabase, new AsyncCallback<Long>(){
...
//		 }
	...
	public YetaT43014(final ActionDatabase actionDatabase, final MSFPanel caller) {
...
//		initLoad(); 	
		...
		this.actionDatabase = actionDatabase;
	 	...
	 	cpYetaT43014 = new ContentPanel();  

		createSearchForm();			//기본정보 필드를 적용
	 	createMsfGridForm();		//그리드필드
		   
		cpYetaT43014.setBodyBorder(false);
		cpYetaT43014.setBorders(false);
		cpYetaT43014.setHeaderVisible(false);
		cpYetaT43014.setSize("790px", "640px");
		   
		this.add(cpYetaT43014);
...
//		     });     
		...
		cpYetaT43014.setLayout(new FlowLayout());
...
//	      	     }
//				 
//				YetaT43014GridPanel.getMsfGrid().clearData();
//				 
//				BaseModel bmData = YetaT43014GridPanel.getTableDef().getDefaultValues();  
//		              
...
//		         
//		        YetaT43014GridPanel.getMsfGrid().getGrid().stopEditing();      
//		        YetaT43014GridPanel.getMsfGrid().getGrid().getStore().insert(bmData,0);   
//		        YetaT43014GridPanel.getMsfGrid().getGrid().startEditing(YetaT43014GridPanel.getMsfGrid().getGrid().getStore().indexOf(bmData), 0);   
//
...
//			public void handleEvent(ButtonEvent e) {
//				Iterator<BaseModel> itBm = YetaT43014GridPanel.getMsfGrid().getGrid().getSelectionModel().getSelectedItems().listIterator();
...
//			public void handleEvent(ButtonEvent e) {
//				setListRecord(YetaT43014GridPanel.getMsfGrid().getStore().getModifiedRecords().iterator());
//				doAction(actionDatabase);
//
//				if ((ActionDatabase.INSERT).equals(actionDatabase)) {
//					actionDatabase = ActionDatabase.INSERT;
...
//			topYetaBtnBar.add(btnYetaClose);
		...
		cpYetaT43014.add(topYetaBtnBar);
...
//		YetaT43014GridPanel = new MSFGridPanel(YetaT43014Def, false, false, false, false, false);
//		YetaT43014GridPanel.setSize("790px", "420px");
//		YetaT43014GridPanel.setBorders(true);
//		YetaT43014GridPanel.setHeaderVisible(false);
//		
...
//		
//		YetaT43014GridPanel.getGrid().getColumnModel().addAggregationRow(payrSummaryRow);  
//		
...
//		
//		YetaT43014GridPanel.getGrid().getColumnModel().addAggregationRow(payrSummaryRow1);
//		/** --- 그리드 합계 부분  종료 --- **/
		
//        cpYetaT43014.add(YetaT43014GridPanel);
...
//		layoutContainer.add(fldstNewFieldset_1);
		...
		cpYetaT43014.add(fieldSet1);
		cpYetaT43014.add(fieldSet2);
		cpYetaT43014.add(fldstNewFieldset_1);
	...
	public void reload() {
			...
			YetaT43014GridPanel.getTableDef().setTableColumnFilters(filters);
			YetaT43014GridPanel.getTableDef().addColumnFilter("yrtxBlggYr", MSFSharedUtils.allowNulls(srhYrtxBlggYr.getValue())
...
//					, SimpleColumnFilter.OPERATOR_EQUALS);//연말정산귀속년도
			YetaT43014GridPanel.getTableDef().addColumnFilter("clutSeptCd", MSFSharedUtils.getSelectedComboValue(srhClutSeptCd,"commCd")
					, SimpleColumnFilter.OPERATOR_EQUALS);//정산구분
			YetaT43014GridPanel.getTableDef().addColumnFilter("systemkey", MSFSharedUtils.allowNulls(systemkey.getValue())
					, SimpleColumnFilter.OPERATOR_EQUALS);//시스템키
		 
			YetaT43014GridPanel.reload();
