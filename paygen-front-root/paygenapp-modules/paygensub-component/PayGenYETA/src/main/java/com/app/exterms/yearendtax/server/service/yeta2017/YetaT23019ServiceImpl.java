...
* </pre>
 */
@Service("YetaT23019Service")
public class YetaT23019ServiceImpl  extends AbstractCustomServiceImpl implements YetaT23019Service  ,YetaDaoConstants {

	 
	private static final Logger logger = LoggerFactory.getLogger(YetaT23019ServiceImpl.class);
	private static final String calledClass = YetaT23019ServiceImpl.class.getName();
	...
	public Long activityOnYetaT23019ToYe162510(List<Ye162510DTO> listYe162510Dto, ActionDatabase actionDatabase) throws MSFException {
			...
			String method = calledClass + ".activityOnYetaT23019ToYe162510";
			
			String windowNm = "소득공제신고자료관리";
			String windowId = "YETAT13019";
...
//		        	} 
				...
				result = iCnt;
		            ...
		            logger.error("EXCEPTION calling activityOnYetaT23019ToYe162510(): "+ ex); 
		            ...
		            result = new Long(0);
		            throw MSFServerUtils.getOperationException("activityOnYetaT23019ToYe162510", ex, logger);
		        }
		        finally {
	...
	//월세액소득공제명세 조회
	public PagingLoadResult<BaseModel> getYetaT23019ToYe162510List(ServiceParameters serviceParameters)throws MSFException {

		PagingLoadResult<BaseModel> retval = null;
		String method =  CLASS_YETAT13019TOYE162510_DATA_LIST;
		Ye162510SrhVO	ye162510Vo = new Ye162510SrhVO();
