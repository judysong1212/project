...
public interface YetaP03005ServiceAsync {
	
	/** 월세액소득공제명세  팝업 수정 삭제**/
	public void activityOnYetaP03005ToYeta3130(List<Yeta3130DTO> listYeta3130dto, ActionDatabase actionDatabase, AsyncCallback<Long> callback) ;
