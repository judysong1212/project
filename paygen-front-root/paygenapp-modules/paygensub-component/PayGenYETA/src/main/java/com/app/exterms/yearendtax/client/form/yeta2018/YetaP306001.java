 ...
 * =====================================================
 **/
public class YetaP306001 extends MSFFormPanel {
	...
	private ContentPanel cpYetaP306001;

	// -------------- grid 선언 시작 ---------------
	private MSFGridPanel YetaP306001_01GridPanel;
	private MSFGridPanel YetaP306001_02GridPanel;

	private Yeta3060Def Yeta306001MtDef = new Yeta3060Def("Yeta306001_Mt");
	private Yeta3060Def Yeta306001StDef = new Yeta3060Def("Yeta306001_St");
	// -------------- grid 선언 종료 ---------------
	...
	//	private YetaP2060ServiceAsync YetaP306001Service = YetaP306001Service.Util.getInstance();
	 ...
	 * ++++++++++++++
	 **/
	public YetaP306001(final ActionDatabase actionDatabase,	final MSFPanel caller) {
		...
		cpYetaP306001 = new ContentPanel();

		createGridForm();

		mReload();
		cpYetaP306001.setBodyBorder(false);
		cpYetaP306001.setBorders(false);
		cpYetaP306001.setHeaderVisible(false);
		cpYetaP306001.setSize("790px", "640px");

		this.add(cpYetaP306001);
	...
	private void createGridForm() {
		...
		YetaP306001_01GridPanel = new MSFGridPanel(Yeta306001MtDef, false, false, false, false, false);
		YetaP306001_01GridPanel.setHeaderVisible(false);
		YetaP306001_01GridPanel.setSize(305, 570);
		YetaP306001_01GridPanel.setBorders(true);

		final Grid Yeta206001MGrid = YetaP306001_01GridPanel.getMsfGrid().getGrid();
		Yeta206001MGrid.addListener(Events.RowDoubleClick, new Listener<BaseEvent>() {
			public void handleEvent(BaseEvent be) {  
				if (YetaP306001_01GridPanel.getCurrentlySelectedItem() != null) { 
					BaseModel bmData = YetaP306001_01GridPanel.getCurrentlySelectedItem();
					sReload(bmData);
				}
			}
		}); 	

		fieldMtSet.add(YetaP306001_01GridPanel);
		...
		YetaP306001_02GridPanel = new MSFGridPanel(Yeta306001StDef, false, false, false, false, false);
		YetaP306001_02GridPanel.setHeaderVisible(false);
		YetaP306001_02GridPanel.setSize(460, 570);
		YetaP306001_02GridPanel.setBorders(true);
		
		fieldStSet.add(YetaP306001_02GridPanel);
		...
		btnBassSave.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				if (YetaP306001_02GridPanel.getCurrentlySelectedItem() == null) { 
		...
		cpYetaP306001.add(layoutContainer1, new FormData("100%"));
		cpYetaP306001.add(btnBar, new FormData("100%"));
	...
	public void mReload() {
		...
		YetaP306001_01GridPanel.getTableDef().setTableColumnFilters(filters);
		YetaP306001_01GridPanel.reload();
	...
	public void sReload(BaseModel bmData) {
		...
		YetaP306001_02GridPanel.getTableDef().setTableColumnFilters(filters);
		YetaP306001_02GridPanel.getTableDef().addColumnFilter("utDpobCd",MSFSharedUtils.allowNulls(bmData.get("utDpobCd")), SimpleColumnFilter.OPERATOR_LIKE);
		YetaP306001_02GridPanel.reload();
							...
							MessageBox.confirm("종사업장 등록", "선택된 사업장의 사업자번호가 주 사업자 번호로 변경됩니다.<br> 진행 하시겠습니까?",new Listener<MessageBoxEvent>(){
								...
								public void handleEvent(MessageBoxEvent be) {
									if(Dialog.YES.equals(be.getButtonClicked().getItemId())){
										BaseModel bmData = YetaP306001_01GridPanel.getCurrentlySelectedItem();
										Yeta3060DTO dto = new Yeta3060DTO();
										...
										yeta3060Service.insertYetaS306001(dto, actionDatabase, new AsyncCallback<Integer>() {
											@Override
											public void onSuccess(Integer result) {	
												...
												//상세정보 초기화
												YetaP306001_01GridPanel.reload();
												YetaP306001_02GridPanel.getMsfGrid().clearData();
											}
		...
		MessageBox.confirm("사업장 삭제", "선택된 사업장을 삭제 하시겠습니까?<br>",new Listener<MessageBoxEvent>(){
			...
			public void handleEvent(MessageBoxEvent be) {
				if(Dialog.YES.equals(be.getButtonClicked().getItemId())){
					...
					Iterator<BaseModel> itBm = YetaP306001_02GridPanel.getMsfGrid().getGrid().getSelectionModel().getSelectedItems().listIterator(); 
					List<Record>  lsRec  = new ArrayList<Record>();
					List<Yeta3060DTO> listYeta3060Dto = new ArrayList<Yeta3060DTO>();       
					...
					if (MSFSharedUtils.paramNotNull(records)) {   
						...
						while (records.hasNext()) {
							...
							listYeta3060Dto.add(dto);
						}
					}   


					if(listYeta3060Dto.size() <= 0 ) {
						MessageBox.info("경고", "삭제할 사업장을 선택해 주세요.", null);
						return;
					}

					yeta3060Service.Yeta306001_Delete(listYeta3060Dto, actionDatabase, new AsyncCallback<Long>() {
						@Override
			...
			MessageBox.confirm("주사업자 수정", "선택된 사업장의 일련번호를 변경합니다.<br> 진행 하시겠습니까?",new Listener<MessageBoxEvent>(){
				...
				public void handleEvent(MessageBoxEvent be) {
					if(Dialog.YES.equals(be.getButtonClicked().getItemId())){
						...
						BaseModel bmData1 = YetaP306001_01GridPanel.getCurrentlySelectedItem();
						...
						yeta3060Service.Yeta306001NumUpdate(listYeta3060Dto, actionDatabase, new AsyncCallback<Long>() {
							@Override
							public void onSuccess(Long result) {	
								MessageBox.info("","저장 되었습니다.", null);
