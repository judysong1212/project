...
public interface YetaP13007ServiceAsync {
	
	/** 연금저축소득공제 등록 팝업 수정 및 삭제 **/
	public void activityOnYetaP13007ToYeta3100(List<Ye16Ta3100DTO> listYeta3100dto, ActionDatabase actionDatabase, AsyncCallback<Long> callback) ;
