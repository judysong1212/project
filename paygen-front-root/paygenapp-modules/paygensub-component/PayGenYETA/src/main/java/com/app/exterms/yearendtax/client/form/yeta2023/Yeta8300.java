...
import com.app.exterms.yearendtax.client.dto.yeta2023.Ye161020DTO;
import com.app.exterms.yearendtax.client.dto.yeta2023.Ye161030BM;
import com.app.exterms.yearendtax.client.dto.yeta2023.Ye161030DTO;
import com.app.exterms.yearendtax.client.dto.yeta2023.Ye161040BM;
import com.app.exterms.yearendtax.client.dto.yeta2023.Ye161040DTO;
import com.app.exterms.yearendtax.client.dto.yeta2023.Ye161055DTO;
import com.app.exterms.yearendtax.client.dto.yeta2023.Ye161060DTO;
import com.app.exterms.yearendtax.client.dto.yeta2023.Ye161070DTO;
import com.app.exterms.yearendtax.client.dto.yeta2023.Ye161080DTO;
import com.app.exterms.yearendtax.client.form.defs.yeta2015.Yeta2000Def;
import com.app.exterms.yearendtax.client.form.defs.yeta2023.Ye161010Def;
import com.app.exterms.yearendtax.client.form.defs.yeta2023.Ye161030Def;
import com.app.exterms.yearendtax.client.form.defs.yeta2023.Ye161040Def;
import com.app.exterms.yearendtax.client.form.defs.yeta2023.Ye161090Def;
import com.app.exterms.yearendtax.client.form.defs.yeta2023.Ye169010Def;
import com.app.exterms.yearendtax.client.service.yeta2023.Yeta8300Service;
import com.app.exterms.yearendtax.client.service.yeta2023.Yeta8300ServiceAsync;
 ...
 */
public class Yeta8300 extends MSFPanel {

	private VerticalPanel vp;
	private FormPanel plFrmYeta8300;
	...
	// -------------- 탭 시작 --------------
	private TabPanel tabsYeta8300 = new TabPanel();		// 전체
	private TabPanel tabsItemYeta05 = new TabPanel();	// 특별소득공제 하위
	private TabPanel tabsItemYeta08 = new TabPanel();	// 세액감면및세액공제1 하위
	// -------------- 탭 종료 --------------

	// -------------- 상단 버튼 시작 --------------
	private ButtonBar topYeta8300Bar;
	private Button btnYeta8300All; 	// 일괄자료정리
	private Button btnYeta8300Reset; 	// 초기화
	private Button btnYeta8300New; 		// 신규
	private Button btnYeta8300Save; 	// 저장
	private Button btnYeta8300Del; 		// 삭제
	private Button btnYeta8300Sreach; 	// 조회
	private Button btnYeta8300Print; 	// 인쇄
	
	private RadioGroup printType;		// 대상자 선택
	// -------------- 상단 버튼 종료 --------------

	// -------------- 중간 버튼 시작 --------------
	private Button btnYeta8300_01;			// 의료비지급명세서
	private Button btnYeta8300_02; 			// 기부금명세서
	private Button btnYeta8300_03; 			// 재계산대상자
	private Button btnYeta8300_04; 			// 삭제
	private Button btnYeta8300_05; 			// 세액계산
	private Button btnYeta8300_06; 			// 세액재계산
	private Button btnYeta8300_07; 			// 원천징수인쇄
...
//	private Yeta2000BM yeta2000Bm;
	...
	// -------------- grid 선언 시작  ---------------
	private Ye161010Def ye161010Def  		= new Ye161010Def("Yeta8300"); 		// 대상자 정보 그리드 테이블 컬럼 define
	private Yeta2000Def Ye161010Def_02  	= new Yeta2000Def("YETA300001"); 	// 대상자 정보 그리드 새로고침을 위한 define
	private Ye169010Def ye169010Def  		= new Ye169010Def("Yeta8300");		// 세액계산 정보 그리드 테이블 컬럼 define 
	private Ye161030Def ye161030Def  		= new Ye161030Def("Yeta8300");		// 인적공제 정보 그리드 테이블 컬럼 define
	
	private Ye161040Def ye161040Def_01  	= new Ye161040Def("Yeta830001"); 	// 소득공제명세 그리드 테이블 컬럼 define(국세청자료)  
	private Ye161040Def ye161040Def_02  	= new Ye161040Def("Yeta830002"); 	// 소득공제명세 그리드 테이블 컬럼 define(기타자료)
	private Ye161090Def ye161090Def  		= new Ye161090Def("Yeta8300");
	
	
	private MSFGridPanel Yeta8300ToYe169010GridPanel;
	private MSFGridPanel Yeta8300ToYe161010GridPanel;		// 대상자정보 GridPanel
	private MSFGridPanel Yeta8300ToYe161030GridPanel;		// 인적공제 GridPanel
	private MSFGridPanel Yeta8300ToYe161040GridPanel_01;	// 소득공제 - 국세청 GridPanel
	private MSFGridPanel Yeta8300ToYe161040GridPanel_02;	// 소득공제 - 기타자료 GridPanel
//	private MSFGridPanel Yeta8300ToYe161090GridPanel;		// 가족교육비 GridPanel
	// -------------- grid 선언 종료  ---------------
...
//	private ListStore<BaseModel> lsCrClutMnth = new ListStore<BaseModel>(); 			//급여월
	...
	// -------------- 서비스 호출 시작 -------------- 
	private Yeta8300ServiceAsync yeta8300Service = Yeta8300Service.Util.getInstance();
	// -------------- 서비스 호출 종료 --------------
	 ...
	 */
	 private void checkYeta8300Auth( String authAction, ListStore<BaseModel>bm) {
	 ...
	 **/
	  ...
	  * </pre>
	  * @Method Name : fnYeta8300Payr06530CalcTax
	  * @date : Jan 26, 2016
	  * @author : leeheuisung
	  * @history : 
	  *	-----------------------------------------------------------------------
	  ...
	  *
	  */
	private void fnYeta8300Payr06530CalcTax() {
		...
		MessageBox.confirm("세액계산", "선택된 연말정산계산  대상자에 대해서 세액계산을 합니다. <br> 세액재계산을 하시겠습니까?",new Listener<MessageBoxEvent>(){
			...
			public void handleEvent(MessageBoxEvent be) {
				if (Dialog.YES.equals(be.getButtonClicked().getItemId())) {
					...
					Iterator<BaseModel> itBm = Yeta8300ToYe161010GridPanel.getMsfGrid().getGrid().getSelectionModel().getSelectedItems().listIterator();
					...
					if (MSFSharedUtils.paramNotNull(records)) {
			            ...
			            final Timer t = new Timer() {
			              ...
			              t.scheduleRepeating(500);
   	           	 		...
   	           	 		yeta8300Service.fnYeta8300_Ye161010_2023_CalcTax(listYe161010Dto,   new AsyncCallback<PagingLoadResult<ShowMessageBM>>() {
...
//   	           	                MSFMainApp.ADMINMESSAGES.ExceptionMessageService("activityOnInsertRemt0100(insert) : " + caught), null);
   	           	 			...
   	           	 			public void onSuccess(PagingLoadResult<ShowMessageBM> result) {  
   	           	 				...
   	           	 				//계산 결과에 따른 조회 호출 
   	           	 				BaseModel bmData = Yeta8300ToYe161010GridPanel.getCurrentlySelectedItem();  
   	           	 				...
   	           	 				Yeta8300ToYe161010Detail(bmData, "itemYeta01");
	...
	private void fnYeta8300Payr06530AllCalcTax() {
		...
		MessageBox.confirm("전체세액계산","선택된 연말정산계산  대상자에 대해서 전체세액계산을 합니다. <br> 세액재계산을 하시겠습니까?", new Listener<MessageBoxEvent>() {
			...
			public void handleEvent(MessageBoxEvent be) {
				if (Dialog.YES.equals(be.getButtonClicked().getItemId())) {
					...
					yeta8300Service.fnYeta8300Ye161010_2023_AllCalcTax(ye161010Dto ,new AsyncCallback<PagingLoadResult<ShowMessageBM>>() {
						public void onFailure(Throwable caught) {
...
//							reFresh();
	 ...
	 * ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
	 **/
		private void Yeta8300Print(String fileName, String repType) {
...
//			serarchParam += "[" + MSFSharedUtils.allowNulls(srhSystemkey.getValue())+"]";				//$12 시스템키 
			...
			List<BaseModel> list = Yeta8300ToYe161010GridPanel.getGrid().getSelectionModel().getSelectedItems();
...
//	      	}
	...
	public ContentPanel getViewPanel() {
		if (panel == null) {
			...
			createYeta8300Form(); 	// 화면 기본정보를 설정
			createSearchForm(); 	// 검색필드를 적용
			...
			// 폼데이터를 바인딩
			// formBinding = new FormBinding(this.plFrmYeta8300, true);
	...
	public Yeta8300(String txtForm) {
...
//		btnBar.add(btnNewButton_4);
		...
		Button btnYeta8300_05 = new Button("세액계산");
		btnYeta8300_05.setIcon(MSFMainApp.ICONS.save16());
		btnBar.add(btnYeta8300_05);
		btnYeta8300_05.addListener(Events.Select, new Listener<ButtonEvent>() {
    		public void handleEvent(ButtonEvent e) {
    		 
    	        fnYeta8300Payr06530CalcTax();
    		}
    	});
		...
		plFrmYeta8300.add(conLayoutContainer);

	}

	private void createYeta8300Form() {

		plFrmYeta8300 = new FormPanel();
		plFrmYeta8300.setHeadingText(PayGenConst.PAYGEN_VERSION.concat(" - 소득공제신고자료관리"));
		plFrmYeta8300.setIcon(MSFMainApp.ICONS.text());
		plFrmYeta8300.setBodyStyleName("pad-text");
		plFrmYeta8300.setFrame(true);
		plFrmYeta8300.setPadding(2);
//		plFrmYeta8300.setSize("990px", "780px");
		//엣지변환
		//plFrmYeta8300.setSize("990px", "830px");
		plFrmYeta8300.setSize("990px", "1080px");
		...
		btnlogView.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				 //로그 뷰화면 호출 메서드 
				  funcLogMessage("소득공제신고자료관리","Yeta8300");
				}
			});
		plFrmYeta8300.getHeader().setStyleAttribute("padding", "5px 0 2px 0");
		plFrmYeta8300.getHeader().addTool(btnlogView); 
		/************************************************************************
		 * 화면 에러 처리시 필요한 부분으로 추가 
		 ************************************************************************/

		//멀티콤보박스 닫기 
		plFrmYeta8300.addListener(Events.OnClick,new Listener<ComponentEvent>() { 
			@Override
		...
		topYeta8300Bar = new ButtonBar();
		topYeta8300Bar.setAlignment(HorizontalAlignment.RIGHT);
		
		if ("admin".equals(MSFMainApp.get().getUser().getUsrId()) || "D0010090".equals(MSFMainApp.get().getUser().getUsrDivCd())) {	
			btnYeta8300All = new Button("일괄자료정리");
			btnYeta8300All.setIcon(MSFMainApp.ICONS.new16());
			topYeta8300Bar.add(btnYeta8300All);
			btnYeta8300All.addListener(Events.Select, new Listener<ButtonEvent>() {
				public void handleEvent(ButtonEvent e) {
...
//	                    ye161030Dto.setFamyRelaDivCd(MSFSharedUtils.allowNulls(bmMapModel.get("famyRelaDivCd")));    	/** column 인사가족관계코드 : famyRelaDivCd */
					...
					yeta8300Service.updateYeta8300All(listYe161040Dto, new AsyncCallback<Integer>() {

						public void onFailure(Throwable caught) {
							MessageBox.alert( MSFMainApp.MSFCONSTANTS.ExceptionTitleService()
												, MSFMainApp.ADMINMESSAGES.ExceptionMessageService("activityOnYeta8300ToYe161030("+ actionDatabase.name()+ ") : " + caught)
												, null);
							}
		...
		btnYeta8300Reset = new Button("초기화");
		btnYeta8300Reset.setIcon(MSFMainApp.ICONS.new16());
		btnYeta8300Reset.addListener(Events.Select, new Listener<ButtonEvent>() {
			@Override
			public void handleEvent(ButtonEvent be) {
				// TODO Auto-generated method stub
				...
				tabsYeta8300.setSelection(tabsYeta8300.getItem(0));//탭부분 초기화
			}
		});
		topYeta8300Bar.add(btnYeta8300Reset);

		btnYeta8300Save = new Button("저장");
		btnYeta8300Save.setIcon(MSFMainApp.ICONS.save16());
		topYeta8300Bar.add(btnYeta8300Save);
		btnYeta8300Save.addListener(Events.Select, new Listener<ButtonEvent>() {
			@Override
			public void handleEvent(ButtonEvent be) {
				// TODO Auto-generated method stub  
				//  {-- 기본사항 --}
				if("itemYeta01".equals(tabsYeta8300.getSelectedItem().getId())) {
					
					itemYeta01Save();	// 기본사항 저장
					
				//  {-- 인적공제 --}	
				}else if("itemYeta02".equals(tabsYeta8300.getSelectedItem().getId())) {
					
					itemYeta02Save();	// 인적공제 저장
					
				//	{-- 소득공제 --}	
				}else if("itemYeta03".equals(tabsYeta8300.getSelectedItem().getId())) {
					
					itemYeta03Save();	// 소득공제 저장
					
				// {-- 연금보험료공제--}	
				} else if ("itemYeta04".equals(tabsYeta8300.getSelectedItem().getId())) {
				
					itemYeta04Save();	// 국민연금보험료외의 연금보험료 저장
					
				// {-- 특별소득공제 --}
				} else if ("itemYeta05".equals(tabsYeta8300.getSelectedItem().getId())) {
				...
				// {-- 그밖의 소득공제--}	
				}else if("itemYeta06".equals(tabsYeta8300.getSelectedItem().getId())) {
					
					itemYeta06Save();	// 그밖의소득공제1 저장
					
				}else if("itemYeta07".equals(tabsYeta8300.getSelectedItem().getId())) {
					
					itemYeta07Save();	// 그밖의소득공제2 저장
					
				//{-- 세액감면및세액공제--}	
				}else if("itemYeta08".equals(tabsYeta8300.getSelectedItem().getId())) {
				...
				} else if ("itemYeta09".equals(tabsYeta8300.getSelectedItem().getId())) {

					// 세액감면및세액공제2 저장
					itemYeta09Save();
					
				// {-- 추가제출서류 --}
				} else if ("itemYeta10".equals(tabsYeta8300.getSelectedItem().getId())) {
...
//		btnYeta8300Del = new Button("삭제");
//		btnYeta8300Del.setIcon(MSFMainApp.ICONS.delete16());
//		topYeta8300Bar.add(btnYeta8300Del);
...
//		printType.add(radio3);
		...
		topYeta8300Bar.add(printType);

		btnYeta8300Sreach = new Button("조회");
		btnYeta8300Sreach.setIcon(MSFMainApp.ICONS.search16());
		btnYeta8300Sreach.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				//탭 선택 없애기
				tabsYeta8300.setSelection(tabsYeta8300.getItem(0));
				//대상자 정보 조회
				reload();
			}
		});
		topYeta8300Bar.add(btnYeta8300Sreach);

//		btnYeta8300Print = new Button("인쇄");
//		btnYeta8300Print.setIcon(MSFMainApp.ICONS.print16());
//		topYeta8300Bar.add(btnYeta8300Print);

		plFrmYeta8300.add(topYeta8300Bar);

		// 파일업로드 처리
		plFrmYeta8300.setAction("myurl");
		plFrmYeta8300.setEncoding(Encoding.MULTIPART);
		plFrmYeta8300.setMethod(Method.POST);

		vp.add(plFrmYeta8300);
		
		// plFrmYeta8300.setSize("990px", "730px");
	...
	private LayoutContainer createListGrid() {
	    ...
	    Yeta8300ToYe161010GridPanel = new MSFGridPanel(ye161010Def, false, false, false, false, false);
	    Yeta8300ToYe161010GridPanel.setHeaderVisible(false);  
	    Yeta8300ToYe161010GridPanel.setBodyBorder(true);
	    Yeta8300ToYe161010GridPanel.setBorders(true);
	    final Grid yeta300ToYeta2000Grid = Yeta8300ToYe161010GridPanel.getMsfGrid().getGrid();
...
//        	   funcSetPopUpRecord();
	    ...
	    cpGrid.add(Yeta8300ToYe161010GridPanel); 
...
//		plFrmYeta8300.add(deptNm);
		...
		plFrmYeta8300.setLayout(new FlowLayout());
			...
			public void handleEvent(StoreEvent<BaseModel> be) {  
				...
				if (type == Store.Add) { 
		             ...
		             * "srhPayrMangDeptCd","srhEmymtDivCd","srhDeptCd","srhTypOccuCd","srhBusinCd"
						++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++*/ 
						checkYeta8300Auth("srhPayrMangDeptCd", lsPayrMangDeptCd); 
				}
			}
		});
	        ...
	        public void handleEvent(StoreEvent<BaseModel> be) {  
	        	  EventType type = be.getType();
		    	   if (type == Store.Add) { 
	           		  ...
	           		  * "srhPayrMangDeptCd","srhEmymtDivCd","srhDeptCd","srhTypOccuCd","srhBusinCd"
		         		++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++*/ 
		                	checkYeta8300Auth("srhEmymtDivCd", lsEmymtDivCd); 
		    	   }
	        }
	    });    
	    ...
	    srhDeptCd.getStore().addStoreListener( new StoreListener<ModelData>() {   
	    	public void handleEvent(StoreEvent<ModelData> be) {  
	    		...
	    		if (type == Store.Add) { 
	    			 ...
	    			 * "srhPayrMangDeptCd","srhEmymtDivCd","srhDeptCd","srhTypOccuCd","srhBusinCd"
						++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++*/ 
	    			checkYeta8300Auth("srhDeptCd", lsDeptCd); 
	    		}
	    	}
	    });    
		...
		srhTypOccuCd.getStore().addStoreListener( new StoreListener<ModelData>() {   
			public void handleEvent(StoreEvent<ModelData> be) {  
				...
				if (type == Store.Add) { 
					 ...
					 * "srhPayrMangDeptCd","srhEmymtDivCd","srhDeptCd","srhTypOccuCd","srhBusinCd"
			    		++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++*/ 
						//checkYeta8300Auth("srhTypOccuCd", lsTypOccuCd); 
				}
			}
		});     
		...
		fileSbtBtn.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				...
				if (systemkey.getValue() == null) {
					...
					YetaP820003 yetaP820003Form = new YetaP820003(ActionDatabase.READ, getThis());
					final MSFFormWindows msFwYeta820003 = new MSFFormWindows("자료추출상세내역",yetaP820003Form, "닫기", "690px", "250px", false);
					msFwYeta820003.show();
					yetaP820003Form.setMSFFormWindows(msFwYeta820003);
					// 팝업이 닫히면 탭을 다시 조회한다.
					msFwYeta820003.addListener(Events.Hide,new Listener<BaseEvent>() { 
			    		@Override
			    		public void handleEvent(BaseEvent be) { 
			    			getItemYeta01();
			    		}
					...
					MessageBox.confirm("소득공제신고서 재적용", "선택된 대상자의 기존 정보를 삭제 후 재적용합니다.<br> 진행 하시겠습니까?",new Listener<MessageBoxEvent>(){
						...
						public void handleEvent(MessageBoxEvent be) {
							if (Dialog.YES.equals(be.getButtonClicked().getItemId())) {
								...
								yeta8300Service.fnYeta8300Ye161010_2023_SbtVolUse(ye161010Dto ,new AsyncCallback<PagingLoadResult<ShowMessageBM>>() {
									public void onFailure(Throwable caught) {
...
//										reFresh();
		...
		fileSbtBtn01.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				...
				if (systemkey.getValue() == null) {
					...
					YetaP820001 yetaP820001Form = new YetaP820001(ActionDatabase.READ, getThis());
					MSFFormWindows msFwYeta820001 = new MSFFormWindows("자료추출상세내역",yetaP820001Form, "닫기", "920px", "710px", false);
					msFwYeta820001.show();
					yetaP820001Form.setMSFFormWindows(msFwYeta820001);
		...
		fileSbtBtn02.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				...
				if (systemkey.getValue() == null) {
					...
					YetaP820002 yetaP820002Form = new YetaP820002(ActionDatabase.READ, getThis());
					final MSFFormWindows msFwYeta820002 = new MSFFormWindows("자료추출상세내역",yetaP820002Form, "닫기", "945px", "710px", false);
					msFwYeta820002.show();
					yetaP820002Form.setMSFFormWindows(msFwYeta820002);
		...
		tabsYeta8300 = new TabPanel();
		tabsYeta8300.setAutoWidth(false);
		tabsYeta8300.setAnimScroll(false);
		tabsYeta8300.setTabScroll(true);
		tabsYeta8300.setPlain(true);
		//엣지변환
		//tabsYeta8300.setSize(660, 720);
		tabsYeta8300.setSize(660, 920);
		tabsYeta8300.addListener(Events.Select, new Listener<TabPanelEvent>() {
			public void handleEvent(TabPanelEvent e) {
				// 탭선택
				Yeta8300ToYe161010Detail( Yeta8300ToYe161010GridPanel.getCurrentlySelectedItem(), tabsYeta8300.getSelectedItem().getId()); 
		...
		itemYeta08.addListener(Events.Select, new Listener<TabPanelEvent>() {
			public void handleEvent(TabPanelEvent e) {
				...
				//탭선택
				Yeta8300ToYe161010Detail(Yeta8300ToYe161010GridPanel.getCurrentlySelectedItem(), tabsItemYeta08.getSelectedItem().getId());

			}
		});
		
		
		tabsYeta8300.add(itemYeta08);		
		...
		tabsYeta8300.add(itemYeta10);	
		

		fieldSet.add(tabsYeta8300);
	 ...
	 private LayoutContainer occupationalRBottom2() {
		 ...
		 Yeta8300ToYe161030GridPanel = new MSFGridPanel(ye161030Def, false, false, false, false, false);
		 Yeta8300ToYe161030GridPanel.setHeaderVisible(false);  
		 Yeta8300ToYe161030GridPanel.setBodyBorder(true);
		 Yeta8300ToYe161030GridPanel.setBorders(true);
		    
		 cpGrid.add(Yeta8300ToYe161030GridPanel); 
...
//	 }
	 ...
	 private LayoutContainer occupationalRBottom3_01() {
		 ...
		 Yeta8300ToYe161040GridPanel_01 = new MSFGridPanel(ye161040Def_01, false, false, false, false, false);
		 Yeta8300ToYe161040GridPanel_01.setHeaderVisible(false);  
		 Yeta8300ToYe161040GridPanel_01.setBodyBorder(true);
		 Yeta8300ToYe161040GridPanel_01.setBorders(true);
		 Yeta8300ToYe161040GridPanel_01.getBottomComponent().setVisible(false);
		 Yeta8300ToYe161040GridPanel_01.getGrid().getColumnModel().addHeaderGroup(0, 2, new HeaderGroupConfig("보험료", 1, 4));
		 Yeta8300ToYe161040GridPanel_01.getGrid().getColumnModel().addHeaderGroup(0, 8, new HeaderGroupConfig("신용카드 등 사용액", 1, 13)); 
		 ...
		 Yeta8300ToYe161040GridPanel_01.getGrid().getColumnModel().addAggregationRow(payrSummaryRow); 
		    
		 
		 cpGrid.add(Yeta8300ToYe161040GridPanel_01); 
	 ...
	 private LayoutContainer occupationalRBottom3_02() {
		 ...
		 Yeta8300ToYe161040GridPanel_02 = new MSFGridPanel(ye161040Def_02, false, false, false, false, false);
		 Yeta8300ToYe161040GridPanel_02.setHeaderVisible(false);  
		 Yeta8300ToYe161040GridPanel_02.setBodyBorder(true);
		 Yeta8300ToYe161040GridPanel_02.setBorders(true);
		 Yeta8300ToYe161040GridPanel_02.getBottomComponent().setVisible(false);
		 
		 Yeta8300ToYe161040GridPanel_02.getGrid().getColumnModel().addHeaderGroup(0, 2, new HeaderGroupConfig("보험료", 1, 4));
		 Yeta8300ToYe161040GridPanel_02.getGrid().getColumnModel().addHeaderGroup(0, 8, new HeaderGroupConfig("신용카드 등 사용액", 1, 13)); 
		...
		//2022연말정산_추가
		 ...
		 Yeta8300ToYe161040GridPanel_02.getGrid().getColumnModel().addAggregationRow(payrSummaryRow); 
		    
		 cpGrid.add(Yeta8300ToYe161040GridPanel_02); 
...
//			dtyStrtDt.setHeight("");
		...
		btnNewButton.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				...
				//전체내역  
				YetaP83006 yetaP83006Form = new YetaP83006(ActionDatabase.READ, getThis());   
							    
				//2022연말정산_수정
				//MSFFormWindows msFwYeta83006 = new MSFFormWindows("종전근무지등록", yetaP83006Form, "닫기", "960px", "710px", true);
				MSFFormWindows msFwYeta83006 = new MSFFormWindows("종전근무지등록", yetaP83006Form, "닫기", "980px", "780px", true);
				msFwYeta83006.show();
				yetaP83006Form.setMSFFormWindows(msFwYeta83006);
					
				funcSetPopUpRecord();
				yetaP83006Form.bind(ppRecord); 
				
				// 팝업이 닫히면 탭을 다시 조회한다.
				msFwYeta83006.addListener(Events.Hide, new Listener<BaseEvent>() { 
		    		@Override
		    		public void handleEvent(BaseEvent be) { 
		    			getItemYeta01();
		    		}
...
//										    
//					MSFFormWindows msFwYeta83009 = new MSFFormWindows("주현근무지등록", yetaP03009Form, "닫기", "820px", "710px", true);
//					msFwYeta83009.show();
//					yetaP03009Form.setMSFFormWindows(msFwYeta83009);
//					//TODO 추후 주석해제 
...
//			layoutContainer_49_2.add(btnNewButton1);
		...
		btnNewButton1.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				// 전체내역
				YetaP83008 yetaP83008Form = new YetaP83008(ActionDatabase.READ, getThis());   
									    
				MSFFormWindows msFwYeta83008 = new MSFFormWindows("현비과세및감면", yetaP83008Form, "닫기", "820px", "710px", true);
				msFwYeta83008.show();
				yetaP83008Form.setMSFFormWindows(msFwYeta83008);
					
				funcSetPopUpRecord();
				 
				yetaP83008Form.bind(ppRecord); 
			}
		});			
...
//		layoutContainer_20.setHeight("100");
		...
		Yeta8300ToYe169010GridPanel = new MSFGridPanel(ye169010Def, false, false,false, false, false);
		Yeta8300ToYe169010GridPanel.setHeaderVisible(false);
		Yeta8300ToYe169010GridPanel.setBodyBorder(true);
		Yeta8300ToYe169010GridPanel.setBorders(true);
		Yeta8300ToYe169010GridPanel.getBottomComponent().setVisible(false);
		//
		cpGrid.add(Yeta8300ToYe169010GridPanel);
		...
		button2.addListener(Events.Select, new Listener<ButtonEvent>() {
			...
			public void handleEvent(ButtonEvent be) {
				...
				yeta8300Service.getYeta8300TxDdcYnToYe161020Data(ye161020Dto, new AsyncCallback<Ye161020DTO>() {
...
//							if (result.getC152StdTxDdcYn() == "Y" || "N".equals(result.getC152StdTxDdcYn())) {
								//전체내역  
								YetaT830171 yetaT830171Form = new YetaT830171(ActionDatabase.READ, getThis());   
										    
								MSFFormWindows msFwYetaT830171 = new MSFFormWindows("기본세액공제", yetaT830171Form, "닫기", "650px", "710px", true);
								msFwYetaT830171.show();
								yetaT830171Form.setMSFFormWindows(msFwYetaT830171);
					...
					public void onFailure(Throwable caught) {
						...
						public void onSuccess(Ye161020DTO result) {
							...
							if (result.getC152StdTxDdcYn() == "Y" || "Y".equals(result.getC152StdTxDdcYn())) {
								//전체내역  
								YetaT83017 yetaT83017Form = new YetaT83017(ActionDatabase.READ, getThis());   
										    
								MSFFormWindows msFwYetaT83017 = new MSFFormWindows("표준세액공제", yetaT83017Form, "닫기", "650px", "710px", true);
								msFwYetaT83017.show();
								yetaT83017Form.setMSFFormWindows(msFwYetaT83017);
...
//								funcSetPopUpRecord();
	...
	private LayoutContainer yetaData02() {
		...
		btnYeta3220New.addListener(Events.Select, new Listener<ButtonEvent>() {
			...
			public void handleEvent(ButtonEvent be) {
				...
				if (MSFSharedUtils.paramNull(systemkey.getValue())) {
	          	...
	          	//가족사항등록 
				YetaP830012 payrP41003Form = new YetaP830012(ActionDatabase.INSERT, getThis());   
		...
		btnYeta3220Del.addListener(Events.Select, new Listener<ButtonEvent>() {
			...
			public void handleEvent(ButtonEvent be) {
				...
				Iterator<BaseModel> itBm = Yeta8300ToYe161030GridPanel.getMsfGrid().getGrid().getSelectionModel().getSelectedItems().listIterator();
				...
				MessageBox.confirm("삭제", "선택하신 인적공제명세를 삭제하시겠습니까?</br> (삭제시 관련된  교육비, 의료비 등의 내역도 같이 삭제 처리 됩니다. )",new Listener<MessageBoxEvent>(){
					...
					public void handleEvent(MessageBoxEvent be) {
						if(Dialog.YES.equals(be.getButtonClicked().getItemId())){
							yeta8300Service.activityOnYeta8300ToYe161030(listYe161030Dto ,actionDatabase, new AsyncCallback<Long>() {
	...
	private LayoutContainer yetaData04() {
		...
		btnNewButton_9.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				// 전체내역
				YetaP83007 yetaP83007Form = new YetaP83007(ActionDatabase.READ, getThis());

				MSFFormWindows msFwYeta83007 = new MSFFormWindows("연금저축소득공제",yetaP83007Form, "닫기", "820px", "550px", true);
				msFwYeta83007.show();
				yetaP83007Form.setMSFFormWindows(msFwYeta83007);
				
				msFwYeta83007.addListener(Events.Hide,new Listener<BaseEvent>() { 
		    		@Override
		    		public void handleEvent(BaseEvent be) { 
		    			getItemYeta04();
		    		}
	...
	private LayoutContainer yetaData05() {
		...
		tabsItemYeta05.addListener(Events.Select, new Listener<TabPanelEvent>() {
			public void handleEvent(TabPanelEvent e) {
				Yeta8300ToYe161010Detail(Yeta8300ToYe161010GridPanel.getCurrentlySelectedItem(), tabsItemYeta05.getSelectedItem().getId());
			}
		});
...
//		LayoutContainer layoutContainer_301 = new LayoutContainer();
		...
		btnNewButton_15.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				//전체내역  
				YetaP83004 yetaP83004Form = new YetaP83004(ActionDatabase.READ, getThis());   
					    
				MSFFormWindows msFwYeta83004 = new MSFFormWindows("거주자간 주택임차차입금 원리금 상환액", yetaP83004Form, "닫기", "820px", "600px", true);
				msFwYeta83004.show();
				yetaP83004Form.setMSFFormWindows(msFwYeta83004);
				 
				funcSetPopUpRecord();
				//TODO 추후 주석해제 
				yetaP83004Form.bind(ppRecord); 
			}
		});	
...
//
//				MSFFormWindows msFwYeta83005 = new MSFFormWindows("월세액소득공제명세",yetaP23005Form, "닫기", "820px", "510px", true);
//				msFwYeta83005.show();
//				yetaP23005Form.setMSFFormWindows(msFwYeta83005);
//
//				funcSetPopUpRecord();
...
//		layoutContainer_132.add(layoutContainer_145);
	...
	private LayoutContainer yetaData08() {
		...
		btnNewButton_10.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				//전체내역  
				YetaP83002 yetaP23002Form = new YetaP83002(ActionDatabase.READ, getThis());   
				    
				MSFFormWindows msFwYeta83002 = new MSFFormWindows("의료비내역등록", yetaP23002Form, "닫기", "820px", "710px", true);
				msFwYeta83002.show();
				yetaP23002Form.setMSFFormWindows(msFwYeta83002);
				
				msFwYeta83002.addListener(Events.Hide,new Listener<BaseEvent>() { 
		    		@Override
		    		public void handleEvent(BaseEvent be) { 
		    			getItemYeta08();
		    		}
...
//		layoutContainer_376.setLayout(new ColumnLayout());
		...
		btnNewButton_11.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				//전체내역  
				YetaP830011 yetaP230011Form = new YetaP830011(ActionDatabase.READ, getThis());   
				    
				MSFFormWindows msFwYeta830011 = new MSFFormWindows("교육비내역등록", yetaP230011Form, "닫기", "820px", "730px", true);
				msFwYeta830011.show();
				yetaP230011Form.setMSFFormWindows(msFwYeta830011);
				
				msFwYeta830011.addListener(Events.Hide,new Listener<BaseEvent>() { 
		    		@Override
		    		public void handleEvent(BaseEvent be) { 
		    			getItemYeta08();
		    		}
...
//				    
//				MSFFormWindows msFwYeta83001 = new MSFFormWindows("이월기부금등록", yetaP23001Form, "닫기", "820px", "710px", true);
//				msFwYeta83001.show();
//				yetaP23001Form.setMSFFormWindows(msFwYeta83001);
//				
//				funcSetPopUpRecord();
//				
//				//TODO 추후 주석해제 
...
//		});
		...
		btnNewButton_14.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				//전체내역  
				YetaP83003 yetaP23003Form = new YetaP83003(ActionDatabase.READ, getThis());   
				    
				MSFFormWindows msFwYeta83003 = new MSFFormWindows("기부금내역등록", yetaP23003Form, "닫기", "820px", "510px", true);
				msFwYeta83003.show();
				yetaP23003Form.setMSFFormWindows(msFwYeta83003);
				
				msFwYeta83003.addListener(Events.Hide,new Listener<BaseEvent>() { 
		    		@Override
		    		public void handleEvent(BaseEvent be) { 
		    			getItemYeta08();
		    		}
		...
		btnNewButton_13.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				//전체내역  
				YetaP83001 yetaP23001Form = new YetaP83001(ActionDatabase.READ, getThis());   
				    
				MSFFormWindows msFwYeta83001 = new MSFFormWindows("기부금조정명세", yetaP23001Form, "닫기", "820px", "710px", true);
				msFwYeta83001.show();
				yetaP23001Form.setMSFFormWindows(msFwYeta83001);
				
				msFwYeta83001.addListener(Events.Hide,new Listener<BaseEvent>() { 
		    		@Override
		    		public void handleEvent(BaseEvent be) { 
		    			getItemYeta05();
		    		}
...
//		layoutContainer_154.add(layoutContainer_160);
		...
		btnNewButton_16.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				// 전체내역
				YetaP83005 yetaP23005Form = new YetaP83005(ActionDatabase.READ,getThis());

				MSFFormWindows msFwYeta83005 = new MSFFormWindows("월세액소득공제명세",yetaP23005Form, "닫기", "820px", "510px", true);
				msFwYeta83005.show();
				yetaP23005Form.setMSFFormWindows(msFwYeta83005);
				
				msFwYeta83005.addListener(Events.Hide,new Listener<BaseEvent>() { 
		    		@Override
		    		public void handleEvent(BaseEvent be) { 
		    			getItemYeta09();
		    		}
				...
				public void handleEvent(BaseEvent be) {
					...
					if (mapModels != null) { 
						...
						yeta8300Service.activityOnYeta8300ToYe161030(listYe161030Dto, actionDatabase, new AsyncCallback<Long>() {
							...
							public void onFailure(Throwable caught) {
								MessageBox.alert(MSFMainApp.MSFCONSTANTS.ExceptionTitleService(), 
									MSFMainApp.ADMINMESSAGES.ExceptionMessageService("activityOnYeta8300ToYe161030(" + actionDatabase.name() + ") : " + caught), null);
							}
							public void onSuccess(Long result) {  
								reloadYe161030();
							}   
...
//						}    
//		                
//						yeta8300Service.saveYeta8300ToYe161090tabItem08_3(listYe161090Dto, actionDatabase, new AsyncCallback<Long>() {
//			    			 
//							public void onFailure(Throwable caught) {
//								MessageBox.alert(MSFMainApp.MSFCONSTANTS.ExceptionTitleService(), 
//												MSFMainApp.ADMINMESSAGES.ExceptionMessageService("saveYeta8300ToYe161090tabItem08_3(" + actionDatabase.name() + ") : " + caught), null);
//							}
//							public void onSuccess(Long result) {  
//								reloadYe161090Grid();
//							
...
//		ye161020Dto.setPrifChngYn(ye161020Dto.getPrifChngYn());    /** column 인적공제항목변동여부 : prifChngYn */
		...
		yeta8300Service.saveYeta8300ToYe161020tabItem01(ye161020Dto, new AsyncCallback<Integer>() {
			@Override
			public void onFailure(Throwable caught) {
				// TODO Auto-generated method stub
					MessageBox.alert(MSFMainApp.MSFCONSTANTS.ExceptionTitleService(), 
	...
	public void itemYeta02Save() {
		...
		Iterator<Record> iterRecords = Yeta8300ToYe161030GridPanel.getMsfGrid().getGrid().getStore().getModifiedRecords().iterator(); 
...
//	        yeta3220Dto.setBeforeJumin(MSFSharedUtils.allowNulls(bmMapModel.get("rsnoNumb2")));
	...
	public void itemYeta03Save() {
		...
		//국세청자료 grid
		Iterator<Record> iterRecords = Yeta8300ToYe161040GridPanel_01.getMsfGrid().getGrid().getStore().getModifiedRecords().iterator(); 
		...
		//기타자료 grid
		iterRecords = Yeta8300ToYe161040GridPanel_02.getMsfGrid().getGrid().getStore().getModifiedRecords().iterator(); 
		...
		yeta8300Service.saveYeta8300ToYe1610400tabItem03(listYe161040Dto_01, listYe161040Dto_02, new AsyncCallback<Integer>() {
	...
	public void itemYeta04Save() {
		...
		yeta8300Service.saveYeta8300ToYe161055tabItem04(ye161055Dto, new AsyncCallback<Integer>() {
	...
	public void itemYeta05_1Save() {
		...
		yeta8300Service.saveYeta8300ToYe161060tabItem05_1(ye161060Dto, new AsyncCallback<Integer>() {
	...
	public void itemYeta05_2Save() {
		...
		yeta8300Service.saveYeta8300ToYe161060tabItem05_2(ye161060Dto, new AsyncCallback<Integer>() {
...
//		ye161070Dto.setTyShfyPrsAddDdcrtUseAmt	((Long) tyShfyPrsAddDdcrtUseAmt.getValue());/** column 본인추가공제율사용분_2016_상반기 : tyShfyPrsAddDdcrtUseAmt */
		...
		yeta8300Service.saveYeta8300ToYe161070tabItem06(ye161070Dto, new AsyncCallback<Integer>() {
	...
	public void itemYeta07Save() {
		...
		yeta8300Service.saveYeta8300ToYe161070tabItem07(ye161070Dto, new AsyncCallback<Integer>() {
...
//		ye161080Vo.setYupSnmcReEndDt(ye161080Dto.getYupSnmcReEndDt());    /** column 중소기업취업자감면기간종료일자 : yupSnmcReEndDt */
		...
		yeta8300Service.saveYeta8300ToYe161080tabItem08_1(ye161080Dto, new AsyncCallback<Integer>() {
...
//		ye161080Dto.setScxpsDsbrCount		((Long) scxpsDsbrCount.getValue());    	/** column 교육비_장애인인원수 : scxpsDsbrCount */
		...
		yeta8300Service.saveYeta8300ToYe161080tabItem08_3(ye161080Dto, new AsyncCallback<Integer>() {
...
//						//-- 그리드 저장
//						
//						Iterator<Record> iterRecords = Yeta8300ToYe161090GridPanel.getMsfGrid().getGrid().getStore().getModifiedRecords().iterator(); 
//				        
//						List<Ye161090DTO> listYe161090Dto = new ArrayList<Ye161090DTO>();  
//						Ye161090DTO ye161090Dto = new Ye161090DTO(); 
//						
...
//						}
	...
	public void itemYeta09Save() {
		...
		yeta8300Service.saveYeta8300ToYe161080tabItem09(ye161080Dto, new AsyncCallback<Integer>() {
	...
	public void itemYeta10Save() {
		...
		yeta8300Service.saveYeta8300ToYe161080tabItem10(ye161080Dto, new AsyncCallback<Integer>() {
...
//		resetItemYeta01();	 
		...
		Yeta8300ToYe161010GridPanel.getTableDef().setTableColumnFilters(filters);
		
		Yeta8300ToYe161010GridPanel.getTableDef().addColumnFilter("yrtxBlggYr", MSFSharedUtils.getSelectedComboValue(srhYrtxBlggYr, "year"), SimpleColumnFilter.OPERATOR_EQUALS);
		
		Yeta8300ToYe161010GridPanel.getTableDef().addColumnFilter("clutSeptCd", MSFSharedUtils.getSelectedComboValue(srhClutSeptCd, "commCd"), SimpleColumnFilter.OPERATOR_EQUALS);
		
		Yeta8300ToYe161010GridPanel.getTableDef().addColumnFilter("payrMangDeptCd", MSFSharedUtils.getSelectedComboValue(srhPayrMangDeptCd,"payrMangDeptCd"), SimpleColumnFilter.OPERATOR_EQUALS);
		Yeta8300ToYe161010GridPanel.getTableDef().addColumnFilter("emymtDivCd", MSFSharedUtils.getSelectedComboValue(srhEmymtDivCd,"commCd"), SimpleColumnFilter.OPERATOR_EQUALS); 
		String strDeptCd =YetaUtils.getStrValToBMMultiCombo(lsDeptCd, srhDeptCd.getValue(),"deptNmRtchnt","deptCd");  
		Yeta8300ToYe161010GridPanel.getTableDef().addColumnFilter("deptCd", strDeptCd , SimpleColumnFilter.OPERATOR_EQUALS);
		           
		String strTypOccuCd = YetaUtils.getStrValToBMMultiCombo(lsTypOccuCd,srhTypOccuCd.getValue(),"typOccuNm","typOccuCd"); 
		Yeta8300ToYe161010GridPanel.getTableDef().addColumnFilter("typOccuCd", strTypOccuCd, SimpleColumnFilter.OPERATOR_EQUALS); 
		...
		Yeta8300ToYe161010GridPanel.getTableDef().addColumnFilter("dtilOccuInttnCd", strDtilOccuInttnCd, SimpleColumnFilter.OPERATOR_EQUALS); 
		       
		Yeta8300ToYe161010GridPanel.getTableDef().addColumnFilter("businCd", MSFSharedUtils.getSelectedComboValue(srhBusinCd,"businCd"), SimpleColumnFilter.OPERATOR_EQUALS);
		Yeta8300ToYe161010GridPanel.getTableDef().addColumnFilter("systemkey", MSFSharedUtils.allowNulls(srhSystemkey.getValue()), SimpleColumnFilter.OPERATOR_EQUALS);
		Yeta8300ToYe161010GridPanel.getTableDef().addColumnFilter("hanNm", MSFSharedUtils.allowNulls(srhHanNm.getValue()), SimpleColumnFilter.OPERATOR_EQUALS);    
		Yeta8300ToYe161010GridPanel.getTableDef().addColumnFilter("resnRegnNum", MSFSharedUtils.allowNulls(srhResnRegnNum.getValue()), SimpleColumnFilter.OPERATOR_EQUALS);  
		Yeta8300ToYe161010GridPanel.getTableDef().addColumnFilter("utDpobCd", MSFSharedUtils.allowNulls(utDpobCd.getValue()), SimpleColumnFilter.OPERATOR_EQUALS); 
		
		
		Yeta8300ToYe161010GridPanel.getTableDef().addColumnFilter("printType", YetaUtils.getCheckedRadioValue(printType), SimpleColumnFilter.OPERATOR_EQUALS);  

		Yeta8300ToYe161010GridPanel.reload(); 
      
	}
	
	
	/** 대상자에 따른 정보 가져옴 **/
	private void Yeta8300ToYeta2000Detail2(Yeta2000BM result) {
	
	}
	
	
	/** 대상자에 따른 정보 가져옴 **/
	private void Yeta8300ToYe161010Detail(BaseModel selRecord, String tabId) {
	...
	private void getItemYeta01() {
		...
		yeta8300Service.getYeta8300ToYe161020Data(ye161020Dto, new AsyncCallback<Ye161020DTO>(){

			@Override
			public void onFailure(Throwable caught) {
				// TODO Auto-generated method stub
				MessageBox.alert(MSFMainApp.MSFCONSTANTS.ExceptionTitleService(), 
                        MSFMainApp.ADMINMESSAGES.ExceptionMessageService("getYeta8300ToYe161020Data(" + actionDatabase.name() + ") : " + caught), null);
	...
	private void getItemYeta02() {
		...
		yeta8300Service.getYeta8300TabItem02ToYe161020Data(ye161020Dto, new AsyncCallback<Ye161020DTO>(){

			@Override
			public void onFailure(Throwable caught) {
				// TODO Auto-generated method stub
				MessageBox.alert(MSFMainApp.MSFCONSTANTS.ExceptionTitleService(), 
                        MSFMainApp.ADMINMESSAGES.ExceptionMessageService("saveYeta8300ToYe161020tabItem02(" + actionDatabase.name() + ") : " + caught), null);
	...
	private void getItemYeta04() {
		...
		yeta8300Service.getYeta8300TabItem04ToYe161055Data(ye161055Dto, new AsyncCallback<Ye161055DTO>(){

			@Override
			public void onFailure(Throwable caught) {
				// TODO Auto-generated method stub
				MessageBox.alert(MSFMainApp.MSFCONSTANTS.ExceptionTitleService(), 
                        MSFMainApp.ADMINMESSAGES.ExceptionMessageService("getYeta8300TabItem04ToYe161055Data(" + actionDatabase.name() + ") : " + caught), null);
	...
	private void getItemYeta05() {
		...
		yeta8300Service.getYeta8300TabItem05ToYe161060Data(ye161060Dto, new AsyncCallback<Ye161060DTO>(){
	...
	private void getItemYeta06() {
		...
		yeta8300Service.getYeta8300TabItem06ToYe161070Data(ye161070Dto, new AsyncCallback<Ye161070DTO>(){
...
//				tyShfyPrsAddDdcrtUseAmt.setValue(result.getTyShfyPrsAddDdcrtUseAmt());  // 본인추가공제율사용분_2016_상반기 
	...
	private void getItemYeta08() {
		...
		yeta8300Service.getYeta8300TabItem08ToYe161080Data(ye161080Dto, new AsyncCallback<Ye161080DTO>(){
...
//				reloadYe161090Grid();
	...
	private void getItemYeta09() {
		...
		yeta8300Service.getYeta8300TabItem09ToYe161080Data(ye161080Dto, new AsyncCallback<Ye161080DTO>(){
...
//				    	
	...
	private void getItemYeta10() {
		...
		yeta8300Service.getYeta8300TabItem10ToYe161080Data(ye161080Dto, new AsyncCallback<Ye161080DTO>(){
	...
	private void reloadYe169010(){
		...
		Yeta8300ToYe169010GridPanel.getTableDef().setTableColumnFilters(filters);
		
		Yeta8300ToYe169010GridPanel.getTableDef().addColumnFilter("dpobCd", MSFSharedUtils.allowNulls(dpobCd.getValue()), SimpleColumnFilter.OPERATOR_EQUALS);
		Yeta8300ToYe169010GridPanel.getTableDef().addColumnFilter("systemkey", MSFSharedUtils.allowNulls(systemkey.getValue()), SimpleColumnFilter.OPERATOR_EQUALS);
		Yeta8300ToYe169010GridPanel.getTableDef().addColumnFilter("clutSeptCd", MSFSharedUtils.allowNulls(clutSeptCd.getValue()), SimpleColumnFilter.OPERATOR_EQUALS); 
		Yeta8300ToYe169010GridPanel.getTableDef().addColumnFilter("yrtxBlggYr", MSFSharedUtils.allowNulls(yrtxBlggYr.getValue()), SimpleColumnFilter.OPERATOR_EQUALS); 
		Yeta8300ToYe169010GridPanel.getTableDef().addColumnFilter("c152StdTxDdcYn", c152StdTxDdcYn.getValue()?"Y" : "N", SimpleColumnFilter.OPERATOR_EQUALS); 
			
		Yeta8300ToYe169010GridPanel.reload();
	...
	private void reloadYe161030(){
		...
		Yeta8300ToYe161030GridPanel.getTableDef().setTableColumnFilters(filters);
		
		Yeta8300ToYe161030GridPanel.getTableDef().addColumnFilter("dpobCd", MSFSharedUtils.allowNulls(dpobCd.getValue()), SimpleColumnFilter.OPERATOR_EQUALS);
		Yeta8300ToYe161030GridPanel.getTableDef().addColumnFilter("systemkey", MSFSharedUtils.allowNulls(systemkey.getValue()), SimpleColumnFilter.OPERATOR_EQUALS);
		Yeta8300ToYe161030GridPanel.getTableDef().addColumnFilter("clutSeptCd", MSFSharedUtils.allowNulls(clutSeptCd.getValue()), SimpleColumnFilter.OPERATOR_EQUALS); 
		Yeta8300ToYe161030GridPanel.getTableDef().addColumnFilter("yrtxBlggYr", MSFSharedUtils.allowNulls(yrtxBlggYr.getValue()), SimpleColumnFilter.OPERATOR_EQUALS); 
			
		Yeta8300ToYe161030GridPanel.reload();
	...
	private void reloadYe161040_item03Grid(){
		...
		Yeta8300ToYe161040GridPanel_01.getTableDef().setTableColumnFilters(filters);
		
		Yeta8300ToYe161040GridPanel_01.getTableDef().addColumnFilter("dpobCd"		, MSFSharedUtils.allowNulls(dpobCd.getValue()), SimpleColumnFilter.OPERATOR_EQUALS);
		Yeta8300ToYe161040GridPanel_01.getTableDef().addColumnFilter("systemkey"	, MSFSharedUtils.allowNulls(systemkey.getValue()), SimpleColumnFilter.OPERATOR_EQUALS);
		Yeta8300ToYe161040GridPanel_01.getTableDef().addColumnFilter("clutSeptCd"	, MSFSharedUtils.allowNulls(clutSeptCd.getValue()), SimpleColumnFilter.OPERATOR_EQUALS); 
		Yeta8300ToYe161040GridPanel_01.getTableDef().addColumnFilter("yrtxBlggYr"	, MSFSharedUtils.allowNulls(yrtxBlggYr.getValue()), SimpleColumnFilter.OPERATOR_EQUALS); 
		Yeta8300ToYe161040GridPanel_01.getTableDef().addColumnFilter("cdVvalKrnCd"	, "Y0140000", SimpleColumnFilter.OPERATOR_EQUALS); 
			
		Yeta8300ToYe161040GridPanel_01.reload();
		
		Yeta8300ToYe161040GridPanel_02.getTableDef().setTableColumnFilters(filters);
		
		Yeta8300ToYe161040GridPanel_02.getTableDef().addColumnFilter("dpobCd"		, MSFSharedUtils.allowNulls(dpobCd.getValue()), SimpleColumnFilter.OPERATOR_EQUALS);
		Yeta8300ToYe161040GridPanel_02.getTableDef().addColumnFilter("systemkey"	, MSFSharedUtils.allowNulls(systemkey.getValue()), SimpleColumnFilter.OPERATOR_EQUALS);
		Yeta8300ToYe161040GridPanel_02.getTableDef().addColumnFilter("clutSeptCd"	, MSFSharedUtils.allowNulls(clutSeptCd.getValue()), SimpleColumnFilter.OPERATOR_EQUALS); 
		Yeta8300ToYe161040GridPanel_02.getTableDef().addColumnFilter("yrtxBlggYr"	, MSFSharedUtils.allowNulls(yrtxBlggYr.getValue()), SimpleColumnFilter.OPERATOR_EQUALS); 
		Yeta8300ToYe161040GridPanel_02.getTableDef().addColumnFilter("cdVvalKrnCd"	, "Y0140001", SimpleColumnFilter.OPERATOR_EQUALS); 
			
		Yeta8300ToYe161040GridPanel_02.reload();
...
//		IColumnFilter filters = null;
//		
//		Yeta8300ToYe161090GridPanel.getTableDef().setTableColumnFilters(filters);
//			
//		Yeta8300ToYe161090GridPanel.getTableDef().addColumnFilter("dpobCd", MSFSharedUtils.allowNulls(dpobCd.getValue()), SimpleColumnFilter.OPERATOR_EQUALS);
//		Yeta8300ToYe161090GridPanel.getTableDef().addColumnFilter("systemkey", MSFSharedUtils.allowNulls(systemkey.getValue()), SimpleColumnFilter.OPERATOR_EQUALS); 
//		Yeta8300ToYe161090GridPanel.getTableDef().addColumnFilter("clutSeptCd", MSFSharedUtils.allowNulls(clutSeptCd.getValue()), SimpleColumnFilter.OPERATOR_EQUALS); 
//		Yeta8300ToYe161090GridPanel.getTableDef().addColumnFilter("yrtxBlggYr", MSFSharedUtils.allowNulls(yrtxBlggYr.getValue()), SimpleColumnFilter.OPERATOR_EQUALS); 
//			
//		Yeta8300ToYe161090GridPanel.reload();
//		
//	}
	...
	public void resetYeta300ToYeta2000Grid() {
		Yeta8300ToYe161010GridPanel.getMsfGrid().clearData();
	}
	...
	public void resetItemYeta02() {
		...
		Yeta8300ToYe161030GridPanel.getMsfGrid().clearData();
	...
	public void resetItemYeta03() {
		...
		//	{소득공제}
		Yeta8300ToYe161040GridPanel_01.getMsfGrid().clearData();
		Yeta8300ToYe161040GridPanel_02.getMsfGrid().clearData();
