...
@RemoteServiceRelativePath("YetaP630011Service.gwt")
public interface YetaP630011Service extends RemoteService {
	/**
	 * Utility class for simplifying access to the instance of async service.
	 */
	public static class Util {
		private static YetaP630011ServiceAsync instance;
		public static YetaP630011ServiceAsync getInstance(){
			if (instance == null) {
				instance = GWT.create(YetaP630011Service.class);
			}
			return instance;
		}
	}
