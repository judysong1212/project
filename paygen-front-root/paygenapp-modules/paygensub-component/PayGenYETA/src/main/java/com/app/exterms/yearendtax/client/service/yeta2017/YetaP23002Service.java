...
@RemoteServiceRelativePath("YetaP23002Service.gwt")
public interface YetaP23002Service extends RemoteService {
	/**
	 * Utility class for simplifying access to the instance of async service.
	 */
	public static class Util {
		private static YetaP23002ServiceAsync instance;
		public static YetaP23002ServiceAsync getInstance(){
			if (instance == null) {
				instance = GWT.create(YetaP23002Service.class);
			}
			return instance;
		}
	}
