 ...
 */
public class Yeta3000BM    extends MSFSimpleBaseModel implements IsSerializable   {
    ...
    /** set 종전근무지수 : befoScnt */
    public void setBefoScnt(BigDecimal  befoScnt) { set( ATTR_BEFOSCNT ,befoScnt);}
    /** get 종전근무지수 : befoScnt */
    public BigDecimal  getBefoScnt() { return (BigDecimal )get( ATTR_BEFOSCNT );}

    /** set 주근무지_급여총액 : payrTamt */
    public void setPayrTamt(BigDecimal  payrTamt) { set( ATTR_PAYRTAMT ,payrTamt);}
    /** get 주근무지_급여총액 : payrTamt */
    public BigDecimal  getPayrTamt() { return (BigDecimal )get( ATTR_PAYRTAMT );}

    /** set 주근무지_상여총액 : bonsToam */
    public void setBonsToam(BigDecimal  bonsToam) { set( ATTR_BONSTOAM ,bonsToam);}
    /** get 주근무지_상여총액 : bonsToam */
    public BigDecimal  getBonsToam() { return (BigDecimal )get( ATTR_BONSTOAM );}

    /** set 주근무지_인정상여총액 : dtmnBsam */
    public void setDtmnBsam(BigDecimal  dtmnBsam) { set( ATTR_DTMNBSAM ,dtmnBsam);}
    /** get 주근무지_인정상여총액 : dtmnBsam */
    public BigDecimal  getDtmnBsam() { return (BigDecimal )get( ATTR_DTMNBSAM );}
    ...
    /** set 주근무지총급여액 : currTots */
    public void setCurrTots(BigDecimal  currTots) { set( ATTR_CURRTOTS ,currTots);}
    /** get 주근무지총급여액 : currTots */
    public BigDecimal  getCurrTots() { return (BigDecimal )get( ATTR_CURRTOTS );}

    /** set 비과세_자가운전보조금액_del : taxmSfam */
    public void setTaxmSfam(BigDecimal  taxmSfam) { set( ATTR_TAXMSFAM ,taxmSfam);}
    /** get 비과세_자가운전보조금액_del : taxmSfam */
    public BigDecimal  getTaxmSfam() { return (BigDecimal )get( ATTR_TAXMSFAM );}
    ...
    /** set 비과세_보육수당_del : taxmBoin */
    public void setTaxmBoin(BigDecimal  taxmBoin) { set( ATTR_TAXMBOIN ,taxmBoin);}
    /** get 비과세_보육수당_del : taxmBoin */
    public BigDecimal  getTaxmBoin() { return (BigDecimal )get( ATTR_TAXMBOIN );}

    /** set 비과세_외국인소득금액_del : txecAmnt */
    public void setTxecAmnt(BigDecimal  txecAmnt) { set( ATTR_TXECAMNT ,txecAmnt);}
    /** get 비과세_외국인소득금액_del : txecAmnt */
    public BigDecimal  getTxecAmnt() { return (BigDecimal )get( ATTR_TXECAMNT );}

    /** set 총급여_현_전 : totlSala */
    public void setTotlSala(BigDecimal  totlSala) { set( ATTR_TOTLSALA ,totlSala);}
    /** get 총급여_현_전 : totlSala */
    public BigDecimal  getTotlSala() { return (BigDecimal )get( ATTR_TOTLSALA );}

    /** set 근로소득공제 : wkerDdct */
    public void setWkerDdct(BigDecimal  wkerDdct) { set( ATTR_WKERDDCT ,wkerDdct);}
    /** get 근로소득공제 : wkerDdct */
    public BigDecimal  getWkerDdct() { return (BigDecimal )get( ATTR_WKERDDCT );}

    /** set 근로소득금액 : wkerAmnt */
    public void setWkerAmnt(BigDecimal  wkerAmnt) { set( ATTR_WKERAMNT ,wkerAmnt);}
    /** get 근로소득금액 : wkerAmnt */
    public BigDecimal  getWkerAmnt() { return (BigDecimal )get( ATTR_WKERAMNT );}

    /** set 기본공제_본인 : baseSelf */
    public void setBaseSelf(BigDecimal  baseSelf) { set( ATTR_BASESELF ,baseSelf);}
    /** get 기본공제_본인 : baseSelf */
    public BigDecimal  getBaseSelf() { return (BigDecimal )get( ATTR_BASESELF );}

    /** set 기본공제_배우자 : baseWife */
    public void setBaseWife(BigDecimal  baseWife) { set( ATTR_BASEWIFE ,baseWife);}
    /** get 기본공제_배우자 : baseWife */
    public BigDecimal  getBaseWife() { return (BigDecimal )get( ATTR_BASEWIFE );}

    /** set 기본공제_부양가족 : baseFyam */
    public void setBaseFyam(BigDecimal  baseFyam) { set( ATTR_BASEFYAM ,baseFyam);}
    /** get 기본공제_부양가족 : baseFyam */
    public BigDecimal  getBaseFyam() { return (BigDecimal )get( ATTR_BASEFYAM );}

    /** set 추가공제_장애인 : addrHdam */
    public void setAddrHdam(BigDecimal  addrHdam) { set( ATTR_ADDRHDAM ,addrHdam);}
    /** get 추가공제_장애인 : addrHdam */
    public BigDecimal  getAddrHdam() { return (BigDecimal )get( ATTR_ADDRHDAM );}

    /** set 추가공제_경로우대70 : addrRpt70 */
    public void setAddrRpt70(BigDecimal  addrRpt70) { set( ATTR_ADDRRPT70 ,addrRpt70);}
    /** get 추가공제_경로우대70 : addrRpt70 */
    public BigDecimal  getAddrRpt70() { return (BigDecimal )get( ATTR_ADDRRPT70 );}

    /** set 추가공제_부녀자 : addrFame */
    public void setAddrFame(BigDecimal  addrFame) { set( ATTR_ADDRFAME ,addrFame);}
    /** get 추가공제_부녀자 : addrFame */
    public BigDecimal  getAddrFame() { return (BigDecimal )get( ATTR_ADDRFAME );}

    /** set 추가공제_자녀양육비 : addrChld */
    public void setAddrChld(BigDecimal  addrChld) { set( ATTR_ADDRCHLD ,addrChld);}
    /** get 추가공제_자녀양육비 : addrChld */
    public BigDecimal  getAddrChld() { return (BigDecimal )get( ATTR_ADDRCHLD );}

    /** set 추가공제_출산자녀양육비 : addrBrth */
    public void setAddrBrth(BigDecimal  addrBrth) { set( ATTR_ADDRBRTH ,addrBrth);}
    /** get 추가공제_출산자녀양육비 : addrBrth */
    public BigDecimal  getAddrBrth() { return (BigDecimal )get( ATTR_ADDRBRTH );}

    /** set 추가공제_한부모공제금액 : pantOnam */
    public void setPantOnam(BigDecimal  pantOnam) { set( ATTR_PANTONAM ,pantOnam);}
    /** get 추가공제_한부모공제금액 : pantOnam */
    public BigDecimal  getPantOnam() { return (BigDecimal )get( ATTR_PANTONAM );}

    /** set 추가공제_다자녀 : addrMcam */
    public void setAddrMcam(BigDecimal  addrMcam) { set( ATTR_ADDRMCAM ,addrMcam);}
    /** get 추가공제_다자녀 : addrMcam */
    public BigDecimal  getAddrMcam() { return (BigDecimal )get( ATTR_ADDRMCAM );}

    /** set 종근무지_국민연금보험료공제 : bnatDdct */
    public void setBnatDdct(BigDecimal  bnatDdct) { set( ATTR_BNATDDCT ,bnatDdct);}
    /** get 종근무지_국민연금보험료공제 : bnatDdct */
    public BigDecimal  getBnatDdct() { return (BigDecimal )get( ATTR_BNATDDCT );}

    /** set 주근무지_국민연금보험료공제 : jnatDdct */
    public void setJnatDdct(BigDecimal  jnatDdct) { set( ATTR_JNATDDCT ,jnatDdct);}
    /** get 주근무지_국민연금보험료공제 : jnatDdct */
    public BigDecimal  getJnatDdct() { return (BigDecimal )get( ATTR_JNATDDCT );}

    /** set 종근무지_별정우체국연금보험료공제 : bpssDdct */
    public void setBpssDdct(BigDecimal  bpssDdct) { set( ATTR_BPSSDDCT ,bpssDdct);}
    /** get 종근무지_별정우체국연금보험료공제 : bpssDdct */
    public BigDecimal  getBpssDdct() { return (BigDecimal )get( ATTR_BPSSDDCT );}

    /** set 종근무지_국민연금외군인연금공제 : bpssHsol */
    public void setBpssHsol(BigDecimal  bpssHsol) { set( ATTR_BPSSHSOL ,bpssHsol);}
    /** get 종근무지_국민연금외군인연금공제 : bpssHsol */
    public BigDecimal  getBpssHsol() { return (BigDecimal )get( ATTR_BPSSHSOL );}

    /** set 종근무지_국민연금외교직원연금공제 : bpssHtec */
    public void setBpssHtec(BigDecimal  bpssHtec) { set( ATTR_BPSSHTEC ,bpssHtec);}
    /** get 종근무지_국민연금외교직원연금공제 : bpssHtec */
    public BigDecimal  getBpssHtec() { return (BigDecimal )get( ATTR_BPSSHTEC );}

    /** set 종근무지_국민연금외공무원연금공제 : bpssHpul */
    public void setBpssHpul(BigDecimal  bpssHpul) { set( ATTR_BPSSHPUL ,bpssHpul);}
    /** get 종근무지_국민연금외공무원연금공제 : bpssHpul */
    public BigDecimal  getBpssHpul() { return (BigDecimal )get( ATTR_BPSSHPUL );}

    /** set 주근무지_별정우체국연금보험료공제 : jpssDdct */
    public void setJpssDdct(BigDecimal  jpssDdct) { set( ATTR_JPSSDDCT ,jpssDdct);}
    /** get 주근무지_별정우체국연금보험료공제 : jpssDdct */
    public BigDecimal  getJpssDdct() { return (BigDecimal )get( ATTR_JPSSDDCT );}

    /** set 주근무지_국민연금외군인연금공제 : jpssHsol */
    public void setJpssHsol(BigDecimal  jpssHsol) { set( ATTR_JPSSHSOL ,jpssHsol);}
    /** get 주근무지_국민연금외군인연금공제 : jpssHsol */
    public BigDecimal  getJpssHsol() { return (BigDecimal )get( ATTR_JPSSHSOL );}

    /** set 주근무지_국민연금외교직원연금공제 : jpssHtec */
    public void setJpssHtec(BigDecimal  jpssHtec) { set( ATTR_JPSSHTEC ,jpssHtec);}
    /** get 주근무지_국민연금외교직원연금공제 : jpssHtec */
    public BigDecimal  getJpssHtec() { return (BigDecimal )get( ATTR_JPSSHTEC );}

    /** set 주근무지_공무원연금보험료공제 : jpssHpul */
    public void setJpssHpul(BigDecimal  jpssHpul) { set( ATTR_JPSSHPUL ,jpssHpul);}
    /** get 주근무지_공무원연금보험료공제 : jpssHpul */
    public BigDecimal  getJpssHpul() { return (BigDecimal )get( ATTR_JPSSHPUL );}

    /** set 종근무지_퇴직연금과학기술인공제 : brtrHict */
    public void setBrtrHict(BigDecimal  brtrHict) { set( ATTR_BRTRHICT ,brtrHict);}
    /** get 종근무지_퇴직연금과학기술인공제 : brtrHict */
    public BigDecimal  getBrtrHict() { return (BigDecimal )get( ATTR_BRTRHICT );}

    /** set 종근무지_퇴직연금근로자퇴직급여보장법공제 : brtrPsrn */
    public void setBrtrPsrn(BigDecimal  brtrPsrn) { set( ATTR_BRTRPSRN ,brtrPsrn);}
    /** get 종근무지_퇴직연금근로자퇴직급여보장법공제 : brtrPsrn */
    public BigDecimal  getBrtrPsrn() { return (BigDecimal )get( ATTR_BRTRPSRN );}

    /** set 종근무지_퇴직연금연금계좌저축공제 : brtrHnsv */
    public void setBrtrHnsv(BigDecimal  brtrHnsv) { set( ATTR_BRTRHNSV ,brtrHnsv);}
    /** get 종근무지_퇴직연금연금계좌저축공제 : brtrHnsv */
    public BigDecimal  getBrtrHnsv() { return (BigDecimal )get( ATTR_BRTRHNSV );}

    /** set 주근무지_퇴직연금과학기술인공제 : jrtrHict */
    public void setJrtrHict(BigDecimal  jrtrHict) { set( ATTR_JRTRHICT ,jrtrHict);}
    /** get 주근무지_퇴직연금과학기술인공제 : jrtrHict */
    public BigDecimal  getJrtrHict() { return (BigDecimal )get( ATTR_JRTRHICT );}

    /** set 주근무지_퇴직연금근로자퇴직급여보장법공제 : jrtrPsrn */
    public void setJrtrPsrn(BigDecimal  jrtrPsrn) { set( ATTR_JRTRPSRN ,jrtrPsrn);}
    /** get 주근무지_퇴직연금근로자퇴직급여보장법공제 : jrtrPsrn */
    public BigDecimal  getJrtrPsrn() { return (BigDecimal )get( ATTR_JRTRPSRN );}

    /** set 주근무지_퇴직연금연금계좌저축공제 : jrtrHnsv */
    public void setJrtrHnsv(BigDecimal  jrtrHnsv) { set( ATTR_JRTRHNSV ,jrtrHnsv);}
    /** get 주근무지_퇴직연금연금계좌저축공제 : jrtrHnsv */
    public BigDecimal  getJrtrHnsv() { return (BigDecimal )get( ATTR_JRTRHNSV );}

    /** set 연금보험료공제계 : rrptYnam */
    public void setRrptYnam(BigDecimal  rrptYnam) { set( ATTR_RRPTYNAM ,rrptYnam);}
    /** get 연금보험료공제계 : rrptYnam */
    public BigDecimal  getRrptYnam() { return (BigDecimal )get( ATTR_RRPTYNAM );}

    /** set 특별공제_종건강보험료 : spciBhth */
    public void setSpciBhth(BigDecimal  spciBhth) { set( ATTR_SPCIBHTH ,spciBhth);}
    /** get 특별공제_종건강보험료 : spciBhth */
    public BigDecimal  getSpciBhth() { return (BigDecimal )get( ATTR_SPCIBHTH );}

    /** set 특별공제_주건강보험료 : spciJhth */
    public void setSpciJhth(BigDecimal  spciJhth) { set( ATTR_SPCIJHTH ,spciJhth);}
    /** get 특별공제_주건강보험료 : spciJhth */
    public BigDecimal  getSpciJhth() { return (BigDecimal )get( ATTR_SPCIJHTH );}

    /** set 특별공제_종고용보험료 : spciBepf */
    public void setSpciBepf(BigDecimal  spciBepf) { set( ATTR_SPCIBEPF ,spciBepf);}
    /** get 특별공제_종고용보험료 : spciBepf */
    public BigDecimal  getSpciBepf() { return (BigDecimal )get( ATTR_SPCIBEPF );}

    /** set 특별공제_주고용보험료 : spciJepf */
    public void setSpciJepf(BigDecimal  spciJepf) { set( ATTR_SPCIJEPF ,spciJepf);}
    /** get 특별공제_주고용보험료 : spciJepf */
    public BigDecimal  getSpciJepf() { return (BigDecimal )get( ATTR_SPCIJEPF );}

    /** set 특별공제_일반보장성보험료 : spciGurt */
    public void setSpciGurt(BigDecimal  spciGurt) { set( ATTR_SPCIGURT ,spciGurt);}
    /** get 특별공제_일반보장성보험료 : spciGurt */
    public BigDecimal  getSpciGurt() { return (BigDecimal )get( ATTR_SPCIGURT );}

    /** set 특별공제_장애인보장성보험료 : spciHdrc */
    public void setSpciHdrc(BigDecimal  spciHdrc) { set( ATTR_SPCIHDRC ,spciHdrc);}
    /** get 특별공제_장애인보장성보험료 : spciHdrc */
    public BigDecimal  getSpciHdrc() { return (BigDecimal )get( ATTR_SPCIHDRC );}

    /** set 특별공제_보장성보혐료세액공제금액 : spciRtde */
    public void setSpciRtde(BigDecimal  spciRtde) { set( ATTR_SPCIRTDE ,spciRtde);}
    /** get 특별공제_보장성보혐료세액공제금액 : spciRtde */
    public BigDecimal  getSpciRtde() { return (BigDecimal )get( ATTR_SPCIRTDE );}

    /** set 특별공제_보험료계 : spciHrto */
    public void setSpciHrto(BigDecimal  spciHrto) { set( ATTR_SPCIHRTO ,spciHrto);}
    /** get 특별공제_보험료계 : spciHrto */
    public BigDecimal  getSpciHrto() { return (BigDecimal )get( ATTR_SPCIHRTO );}

    /** set 특별공제_의료비_본인 : spciSelf */
    public void setSpciSelf(BigDecimal  spciSelf) { set( ATTR_SPCISELF ,spciSelf);}
    /** get 특별공제_의료비_본인 : spciSelf */
    public BigDecimal  getSpciSelf() { return (BigDecimal )get( ATTR_SPCISELF );}

    /** set 특별공제_의료비_경로65세이상 : spciHe65 */
    public void setSpciHe65(BigDecimal  spciHe65) { set( ATTR_SPCIHE65 ,spciHe65);}
    /** get 특별공제_의료비_경로65세이상 : spciHe65 */
    public BigDecimal  getSpciHe65() { return (BigDecimal )get( ATTR_SPCIHE65 );}

    /** set 특별공제_의료비_장애인 : spciHbps */
    public void setSpciHbps(BigDecimal  spciHbps) { set( ATTR_SPCIHBPS ,spciHbps);}
    /** get 특별공제_의료비_장애인 : spciHbps */
    public BigDecimal  getSpciHbps() { return (BigDecimal )get( ATTR_SPCIHBPS );}

    /** set 특별공제_의료비_기타공제대상자 : spciDetc */
    public void setSpciDetc(BigDecimal  spciDetc) { set( ATTR_SPCIDETC ,spciDetc);}
    /** get 특별공제_의료비_기타공제대상자 : spciDetc */
    public BigDecimal  getSpciDetc() { return (BigDecimal )get( ATTR_SPCIDETC );}

    /** set 특별공제_의료비세액공제액 : spciTxcr */
    public void setSpciTxcr(BigDecimal  spciTxcr) { set( ATTR_SPCITXCR ,spciTxcr);}
    /** get 특별공제_의료비세액공제액 : spciTxcr */
    public BigDecimal  getSpciTxcr() { return (BigDecimal )get( ATTR_SPCITXCR );}

    /** set 특별공제_의료비계 : spciMeto */
    public void setSpciMeto(BigDecimal  spciMeto) { set( ATTR_SPCIMETO ,spciMeto);}
    /** get 특별공제_의료비계 : spciMeto */
    public BigDecimal  getSpciMeto() { return (BigDecimal )get( ATTR_SPCIMETO );}

    /** set 특별공제_교육비_본인 : spedSelf */
    public void setSpedSelf(BigDecimal  spedSelf) { set( ATTR_SPEDSELF ,spedSelf);}
    /** get 특별공제_교육비_본인 : spedSelf */
    public BigDecimal  getSpedSelf() { return (BigDecimal )get( ATTR_SPEDSELF );}

    /** set 특별공제_교육비_취학전아동 : spedGrde */
    public void setSpedGrde(BigDecimal  spedGrde) { set( ATTR_SPEDGRDE ,spedGrde);}
    /** get 특별공제_교육비_취학전아동 : spedGrde */
    public BigDecimal  getSpedGrde() { return (BigDecimal )get( ATTR_SPEDGRDE );}

    /** set 특별공제_교육비_초중고 : spedGdto */
    public void setSpedGdto(BigDecimal  spedGdto) { set( ATTR_SPEDGDTO ,spedGdto);}
    /** get 특별공제_교육비_초중고 : spedGdto */
    public BigDecimal  getSpedGdto() { return (BigDecimal )get( ATTR_SPEDGDTO );}

    /** set 특별공제_교육비_대학교 : spedCldv */
    public void setSpedCldv(BigDecimal  spedCldv) { set( ATTR_SPEDCLDV ,spedCldv);}
    /** get 특별공제_교육비_대학교 : spedCldv */
    public BigDecimal  getSpedCldv() { return (BigDecimal )get( ATTR_SPEDCLDV );}

    /** set 특별공제_장애인특수교육비 : spciSpec */
    public void setSpciSpec(BigDecimal  spciSpec) { set( ATTR_SPCISPEC ,spciSpec);}
    /** get 특별공제_장애인특수교육비 : spciSpec */
    public BigDecimal  getSpciSpec() { return (BigDecimal )get( ATTR_SPCISPEC );}

    /** set 특별공제_교육비세액공제금액 : spedTxcr */
    public void setSpedTxcr(BigDecimal  spedTxcr) { set( ATTR_SPEDTXCR ,spedTxcr);}
    /** get 특별공제_교육비세액공제금액 : spedTxcr */
    public BigDecimal  getSpedTxcr() { return (BigDecimal )get( ATTR_SPEDTXCR );}

    /** set 특별공제_교육비계 : spedToam */
    public void setSpedToam(BigDecimal  spedToam) { set( ATTR_SPEDTOAM ,spedToam);}
    /** get 특별공제_교육비계 : spedToam */
    public BigDecimal  getSpedToam() { return (BigDecimal )get( ATTR_SPEDTOAM );}

    /** set 특별공제_차입금원리금상환액_대출기관 : spciRefn */
    public void setSpciRefn(BigDecimal  spciRefn) { set( ATTR_SPCIREFN ,spciRefn);}
    /** get 특별공제_차입금원리금상환액_대출기관 : spciRefn */
    public BigDecimal  getSpciRefn() { return (BigDecimal )get( ATTR_SPCIREFN );}

    /** set 특별공제_차입금원리금상환액_거주자 : spciResf */
    public void setSpciResf(BigDecimal  spciResf) { set( ATTR_SPCIRESF ,spciResf);}
    /** get 특별공제_차입금원리금상환액_거주자 : spciResf */
    public BigDecimal  getSpciResf() { return (BigDecimal )get( ATTR_SPCIRESF );}

    /** set 특별공제_월세세액공제대상금액 : spciTgrt */
    public void setSpciTgrt(BigDecimal  spciTgrt) { set( ATTR_SPCITGRT ,spciTgrt);}
    /** get 특별공제_월세세액공제대상금액 : spciTgrt */
    public BigDecimal  getSpciTgrt() { return (BigDecimal )get( ATTR_SPCITGRT );}

    /** set 특별공제_주택자금월세공제액 : spciRtam */
    public void setSpciRtam(BigDecimal  spciRtam) { set( ATTR_SPCIRTAM ,spciRtam);}
    /** get 특별공제_주택자금월세공제액 : spciRtam */
    public BigDecimal  getSpciRtam() { return (BigDecimal )get( ATTR_SPCIRTAM );}

    /** set 특별공제_장기주택이자상환액 : spchRefn */
    public void setSpchRefn(BigDecimal  spchRefn) { set( ATTR_SPCHREFN ,spchRefn);}
    /** get 특별공제_장기주택이자상환액 : spchRefn */
    public BigDecimal  getSpchRefn() { return (BigDecimal )get( ATTR_SPCHREFN );}

    /** set 특별공제_11장기주택저당차입금15 : spchRe15 */
    public void setSpchRe15(BigDecimal  spchRe15) { set( ATTR_SPCHRE15 ,spchRe15);}
    /** get 특별공제_11장기주택저당차입금15 : spchRe15 */
    public BigDecimal  getSpchRe15() { return (BigDecimal )get( ATTR_SPCHRE15 );}

    /** set 특별공제_11장기주택저당차입금29 : spchRe29 */
    public void setSpchRe29(BigDecimal  spchRe29) { set( ATTR_SPCHRE29 ,spchRe29);}
    /** get 특별공제_11장기주택저당차입금29 : spchRe29 */
    public BigDecimal  getSpchRe29() { return (BigDecimal )get( ATTR_SPCHRE29 );}

    /** set 특별공제_11장기주택저당차입금30 : spchRe30 */
    public void setSpchRe30(BigDecimal  spchRe30) { set( ATTR_SPCHRE30 ,spchRe30);}
    /** get 특별공제_11장기주택저당차입금30 : spchRe30 */
    public BigDecimal  getSpchRe30() { return (BigDecimal )get( ATTR_SPCHRE30 );}

    /** set 특별공제_12장기주택저당차입금_고정 : spciRefx */
    public void setSpciRefx(BigDecimal  spciRefx) { set( ATTR_SPCIREFX ,spciRefx);}
    /** get 특별공제_12장기주택저당차입금_고정 : spciRefx */
    public BigDecimal  getSpciRefx() { return (BigDecimal )get( ATTR_SPCIREFX );}

    /** set 특별공제_12장기주택저당차입금_기타 : spciReec */
    public void setSpciReec(BigDecimal  spciReec) { set( ATTR_SPCIREEC ,spciReec);}
    /** get 특별공제_12장기주택저당차입금_기타 : spciReec */
    public BigDecimal  getSpciReec() { return (BigDecimal )get( ATTR_SPCIREEC );}

    /** set 특별공제_15장기주택저당_15고정AND비거치상환 : spci15fx */
    public void setSpci15fx(BigDecimal  spci15fx) { set( ATTR_SPCI15FX ,spci15fx);}
    /** get 특별공제_15장기주택저당_15고정AND비거치상환 : spci15fx */
    public BigDecimal  getSpci15fx() { return (BigDecimal )get( ATTR_SPCI15FX );}

    /** set 특별공제_15장기주택저당_15고정OR비거치상환 : spci15fb */
    public void setSpci15fb(BigDecimal  spci15fb) { set( ATTR_SPCI15FB ,spci15fb);}
    /** get 특별공제_15장기주택저당_15고정OR비거치상환 : spci15fb */
    public BigDecimal  getSpci15fb() { return (BigDecimal )get( ATTR_SPCI15FB );}

    /** set 특별공제_15장기주택저당_15기타대출 : spci15ec */
    public void setSpci15ec(BigDecimal  spci15ec) { set( ATTR_SPCI15EC ,spci15ec);}
    /** get 특별공제_15장기주택저당_15기타대출 : spci15ec */
    public BigDecimal  getSpci15ec() { return (BigDecimal )get( ATTR_SPCI15EC );}

    /** set 특별공제_15장기주택저당_10고정OR비거치상환 : spci10fb */
    public void setSpci10fb(BigDecimal  spci10fb) { set( ATTR_SPCI10FB ,spci10fb);}
    /** get 특별공제_15장기주택저당_10고정OR비거치상환 : spci10fb */
    public BigDecimal  getSpci10fb() { return (BigDecimal )get( ATTR_SPCI10FB );}

    /** set 특별공제_15장기주택저당_10기타대출 : spci10ec */
    public void setSpci10ec(BigDecimal  spci10ec) { set( ATTR_SPCI10EC ,spci10ec);}
    /** get 특별공제_15장기주택저당_10기타대출 : spci10ec */
    public BigDecimal  getSpci10ec() { return (BigDecimal )get( ATTR_SPCI10EC );}

    /** set 특별공제_주택자금공제액계 : spchReto */
    public void setSpchReto(BigDecimal  spchReto) { set( ATTR_SPCHRETO ,spchReto);}
    /** get 특별공제_주택자금공제액계 : spchReto */
    public BigDecimal  getSpchReto() { return (BigDecimal )get( ATTR_SPCHRETO );}

    /** set 세액공제_기부정치자금 : taxdPltc */
    public void setTaxdPltc(BigDecimal  taxdPltc) { set( ATTR_TAXDPLTC ,taxdPltc);}
    /** get 세액공제_기부정치자금 : taxdPltc */
    public BigDecimal  getTaxdPltc() { return (BigDecimal )get( ATTR_TAXDPLTC );}

    /** set 특별공제_기부금_정치 : spciPltc */
    public void setSpciPltc(BigDecimal  spciPltc) { set( ATTR_SPCIPLTC ,spciPltc);}
    /** get 특별공제_기부금_정치 : spciPltc */
    public BigDecimal  getSpciPltc() { return (BigDecimal )get( ATTR_SPCIPLTC );}

    /** set 특별공제_기부금_법정 : spciFbam */
    public void setSpciFbam(BigDecimal  spciFbam) { set( ATTR_SPCIFBAM ,spciFbam);}
    /** get 특별공제_기부금_법정 : spciFbam */
    public BigDecimal  getSpciFbam() { return (BigDecimal )get( ATTR_SPCIFBAM );}

    /** set 특별공제_기부금_특례_공익법인신탁제외 : spciExam */
    public void setSpciExam(BigDecimal  spciExam) { set( ATTR_SPCIEXAM ,spciExam);}
    /** get 특별공제_기부금_특례_공익법인신탁제외 : spciExam */
    public BigDecimal  getSpciExam() { return (BigDecimal )get( ATTR_SPCIEXAM );}

    /** set 특별공제_기부금_공익법인신탁특례 : spciUnon */
    public void setSpciUnon(BigDecimal  spciUnon) { set( ATTR_SPCIUNON ,spciUnon);}
    /** get 특별공제_기부금_공익법인신탁특례 : spciUnon */
    public BigDecimal  getSpciUnon() { return (BigDecimal )get( ATTR_SPCIUNON );}

    /** set 특별공제_기부금_우리사주조합2015이후 : spciRfam */
    public void setSpciRfam(BigDecimal  spciRfam) { set( ATTR_SPCIRFAM ,spciRfam);}
    /** get 특별공제_기부금_우리사주조합2015이후 : spciRfam */
    public BigDecimal  getSpciRfam() { return (BigDecimal )get( ATTR_SPCIRFAM );}

    /** set 특별공제_기부금_종교단체 : spciYamt */
    public void setSpciYamt(BigDecimal  spciYamt) { set( ATTR_SPCIYAMT ,spciYamt);}
    /** get 특별공제_기부금_종교단체 : spciYamt */
    public BigDecimal  getSpciYamt() { return (BigDecimal )get( ATTR_SPCIYAMT );}

    /** set 특별공제_기부금_종교단체외 : spciNamt */
    public void setSpciNamt(BigDecimal  spciNamt) { set( ATTR_SPCINAMT ,spciNamt);}
    /** get 특별공제_기부금_종교단체외 : spciNamt */
    public BigDecimal  getSpciNamt() { return (BigDecimal )get( ATTR_SPCINAMT );}

    /** set 특별공제_지정기부금세액공제금액 : spciDgcr */
    public void setSpciDgcr(BigDecimal  spciDgcr) { set( ATTR_SPCIDGCR ,spciDgcr);}
    /** get 특별공제_지정기부금세액공제금액 : spciDgcr */
    public BigDecimal  getSpciDgcr() { return (BigDecimal )get( ATTR_SPCIDGCR );}

    /** set 특별공제_기부금공제액계 : spciSsum */
    public void setSpciSsum(BigDecimal  spciSsum) { set( ATTR_SPCISSUM ,spciSsum);}
    /** get 특별공제_기부금공제액계 : spciSsum */
    public BigDecimal  getSpciSsum() { return (BigDecimal )get( ATTR_SPCISSUM );}

    /** set 특별공제_표준공제 : spciDdct */
    public void setSpciDdct(BigDecimal  spciDdct) { set( ATTR_SPCIDDCT ,spciDdct);}
    /** get 특별공제_표준공제 : spciDdct */
    public BigDecimal  getSpciDdct() { return (BigDecimal )get( ATTR_SPCIDDCT );}

    /** set 차감소득금액 : subtEram */
    public void setSubtEram(BigDecimal  subtEram) { set( ATTR_SUBTERAM ,subtEram);}
    /** get 차감소득금액 : subtEram */
    public BigDecimal  getSubtEram() { return (BigDecimal )get( ATTR_SUBTERAM );}

    /** set 개인연금저축불입액_2000년이전 : etcpPsnv */
    public void setEtcpPsnv(BigDecimal  etcpPsnv) { set( ATTR_ETCPPSNV ,etcpPsnv);}
    /** get 개인연금저축불입액_2000년이전 : etcpPsnv */
    public BigDecimal  getEtcpPsnv() { return (BigDecimal )get( ATTR_ETCPPSNV );}

    /** set 개인연금저축불입액_2001이후_삭제 : etcpNsav */
    public void setEtcpNsav(BigDecimal  etcpNsav) { set( ATTR_ETCPNSAV ,etcpNsav);}
    /** get 개인연금저축불입액_2001이후_삭제 : etcpNsav */
    public BigDecimal  getEtcpNsav() { return (BigDecimal )get( ATTR_ETCPNSAV );}

    /** set 연금저축공제액계 : prcmToam */
    public void setPrcmToam(BigDecimal  prcmToam) { set( ATTR_PRCMTOAM ,prcmToam);}
    /** get 연금저축공제액계 : prcmToam */
    public BigDecimal  getPrcmToam() { return (BigDecimal )get( ATTR_PRCMTOAM );}

    /** set 기타공제_소기업공제불입금 : etchPrep */
    public void setEtchPrep(BigDecimal  etchPrep) { set( ATTR_ETCHPREP ,etchPrep);}
    /** get 기타공제_소기업공제불입금 : etchPrep */
    public BigDecimal  getEtchPrep() { return (BigDecimal )get( ATTR_ETCHPREP );}

    /** set 기타공제_주택마련저축_청약저축 : etcsComp */
    public void setEtcsComp(BigDecimal  etcsComp) { set( ATTR_ETCSCOMP ,etcsComp);}
    /** get 기타공제_주택마련저축_청약저축 : etcsComp */
    public BigDecimal  getEtcsComp() { return (BigDecimal )get( ATTR_ETCSCOMP );}

    /** set 기타공제_주택마련저축_주택청약종합저축 : etwkSbam */
    public void setEtwkSbam(BigDecimal  etwkSbam) { set( ATTR_ETWKSBAM ,etwkSbam);}
    /** get 기타공제_주택마련저축_주택청약종합저축 : etwkSbam */
    public BigDecimal  getEtwkSbam() { return (BigDecimal )get( ATTR_ETWKSBAM );}

    /** set 기타공제_주택마련저축_근로자주택마련저축 : etwkSvam */
    public void setEtwkSvam(BigDecimal  etwkSvam) { set( ATTR_ETWKSVAM ,etwkSvam);}
    /** get 기타공제_주택마련저축_근로자주택마련저축 : etwkSvam */
    public BigDecimal  getEtwkSvam() { return (BigDecimal )get( ATTR_ETWKSVAM );}

    /** set 기타공제_주택마련저축_장기주택마련저축 : etwkLgam */
    public void setEtwkLgam(BigDecimal  etwkLgam) { set( ATTR_ETWKLGAM ,etwkLgam);}
    /** get 기타공제_주택마련저축_장기주택마련저축 : etwkLgam */
    public BigDecimal  getEtwkLgam() { return (BigDecimal )get( ATTR_ETWKLGAM );}

    /** set 기타공제_주택마련저축소득공제계 : etwkBdam */
    public void setEtwkBdam(BigDecimal  etwkBdam) { set( ATTR_ETWKBDAM ,etwkBdam);}
    /** get 기타공제_주택마련저축소득공제계 : etwkBdam */
    public BigDecimal  getEtwkBdam() { return (BigDecimal )get( ATTR_ETWKBDAM );}

    /** set 기타공제_투자조합출자소득공제_2011이전 : etctConc */
    public void setEtctConc(BigDecimal  etctConc) { set( ATTR_ETCTCONC ,etctConc);}
    /** get 기타공제_투자조합출자소득공제_2011이전 : etctConc */
    public BigDecimal  getEtctConc() { return (BigDecimal )get( ATTR_ETCTCONC );}

    /** set 기타공제_투자조합출자소득공제_2012년도 : etgd09af */
    public void setEtgd09af(BigDecimal  etgd09af) { set( ATTR_ETGD09AF ,etgd09af);}
    /** get 기타공제_투자조합출자소득공제_2012년도 : etgd09af */
    public BigDecimal  getEtgd09af() { return (BigDecimal )get( ATTR_ETGD09AF );}

    /** set 기타공제_투자조합출자소득공제_2013년도 : etgdH13h */
    public void setEtgdH13h(BigDecimal  etgdH13h) { set( ATTR_ETGDH13H ,etgdH13h);}
    /** get 기타공제_투자조합출자소득공제_2013년도 : etgdH13h */
    public BigDecimal  getEtgdH13h() { return (BigDecimal )get( ATTR_ETGDH13H );}

    /** set 기타공제_투자조합출자소득공제_2014년이후 : etgdD14f */
    public void setEtgdD14f(BigDecimal  etgdD14f) { set( ATTR_ETGDD14F ,etgdD14f);}
    /** get 기타공제_투자조합출자소득공제_2014년이후 : etgdD14f */
    public BigDecimal  getEtgdD14f() { return (BigDecimal )get( ATTR_ETGDD14F );}

    /** set 기타공제_투자조합출자공제액계 : etgdDdam */
    public void setEtgdDdam(BigDecimal  etgdDdam) { set( ATTR_ETGDDDAM ,etgdDdam);}
    /** get 기타공제_투자조합출자공제액계 : etgdDdam */
    public BigDecimal  getEtgdDdam() { return (BigDecimal )get( ATTR_ETGDDDAM );}

    /** set 기타공제_신용카드등사용액소득공제 : etccCard */
    public void setEtccCard(BigDecimal  etccCard) { set( ATTR_ETCCCARD ,etccCard);}
    /** get 기타공제_신용카드등사용액소득공제 : etccCard */
    public BigDecimal  getEtccCard() { return (BigDecimal )get( ATTR_ETCCCARD );}

    /** set 기타공제_우리사주출연금공제 : etckUnon */
    public void setEtckUnon(BigDecimal  etckUnon) { set( ATTR_ETCKUNON ,etckUnon);}
    /** get 기타공제_우리사주출연금공제 : etckUnon */
    public BigDecimal  getEtckUnon() { return (BigDecimal )get( ATTR_ETCKUNON );}

    /** set 기타공제_우리사주조합기부금공제2014이전 : etckUncr */
    public void setEtckUncr(BigDecimal  etckUncr) { set( ATTR_ETCKUNCR ,etckUncr);}
    /** get 기타공제_우리사주조합기부금공제2014이전 : etckUncr */
    public BigDecimal  getEtckUncr() { return (BigDecimal )get( ATTR_ETCKUNCR );}

    /** set 기타공제_고용유지중소기업근로자임금삭감공제액 : etepMsam */
    public void setEtepMsam(BigDecimal  etepMsam) { set( ATTR_ETEPMSAM ,etepMsam);}
    /** get 기타공제_고용유지중소기업근로자임금삭감공제액 : etepMsam */
    public BigDecimal  getEtepMsam() { return (BigDecimal )get( ATTR_ETEPMSAM );}

    /** set 기타공제_목돈안드는전세이자상환소득공제액 : etgdHtra */
    public void setEtgdHtra(BigDecimal  etgdHtra) { set( ATTR_ETGDHTRA ,etgdHtra);}
    /** get 기타공제_목돈안드는전세이자상환소득공제액 : etgdHtra */
    public BigDecimal  getEtgdHtra() { return (BigDecimal )get( ATTR_ETGDHTRA );}

    /** set 기타공제_장기집합투자증권저축공제액 : etepSecr */
    public void setEtepSecr(BigDecimal  etepSecr) { set( ATTR_ETEPSECR ,etepSecr);}
    /** get 기타공제_장기집합투자증권저축공제액 : etepSecr */
    public BigDecimal  getEtepSecr() { return (BigDecimal )get( ATTR_ETEPSECR );}

    /** set 기타공제_장기주식형저축_1년차공제_삭제 : etclTo01 */
    public void setEtclTo01(BigDecimal  etclTo01) { set( ATTR_ETCLTO01 ,etclTo01);}
    /** get 기타공제_장기주식형저축_1년차공제_삭제 : etclTo01 */
    public BigDecimal  getEtclTo01() { return (BigDecimal )get( ATTR_ETCLTO01 );}

    /** set 기타공제_장기주식형저축_2년차공제_삭제 : etclTo02 */
    public void setEtclTo02(BigDecimal  etclTo02) { set( ATTR_ETCLTO02 ,etclTo02);}
    /** get 기타공제_장기주식형저축_2년차공제_삭제 : etclTo02 */
    public BigDecimal  getEtclTo02() { return (BigDecimal )get( ATTR_ETCLTO02 );}

    /** set 기타공제_장기주식형저축_3년차공제_삭제 : etclTo03 */
    public void setEtclTo03(BigDecimal  etclTo03) { set( ATTR_ETCLTO03 ,etclTo03);}
    /** get 기타공제_장기주식형저축_3년차공제_삭제 : etclTo03 */
    public BigDecimal  getEtclTo03() { return (BigDecimal )get( ATTR_ETCLTO03 );}

    /** set 기타공제_장기주식형저축소득공제_삭제 : etclHmto */
    public void setEtclHmto(BigDecimal  etclHmto) { set( ATTR_ETCLHMTO ,etclHmto);}
    /** get 기타공제_장기주식형저축소득공제_삭제 : etclHmto */
    public BigDecimal  getEtclHmto() { return (BigDecimal )get( ATTR_ETCLHMTO );}

    /** set 기타공제_공제계 : etcdTsum */
    public void setEtcdTsum(BigDecimal  etcdTsum) { set( ATTR_ETCDTSUM ,etcdTsum);}
    /** get 기타공제_공제계 : etcdTsum */
    public BigDecimal  getEtcdTsum() { return (BigDecimal )get( ATTR_ETCDTSUM );}

    /** set 특별공제_종합한도초과금액 : spchExli */
    public void setSpchExli(BigDecimal  spchExli) { set( ATTR_SPCHEXLI ,spchExli);}
    /** get 특별공제_종합한도초과금액 : spchExli */
    public BigDecimal  getSpchExli() { return (BigDecimal )get( ATTR_SPCHEXLI );}

    /** set 종합소득과세표준 : stndIncm */
    public void setStndIncm(BigDecimal  stndIncm) { set( ATTR_STNDINCM ,stndIncm);}
    /** get 종합소득과세표준 : stndIncm */
    public BigDecimal  getStndIncm() { return (BigDecimal )get( ATTR_STNDINCM );}

    /** set 산출세액 : prddTaxn */
    public void setPrddTaxn(BigDecimal  prddTaxn) { set( ATTR_PRDDTAXN ,prddTaxn);}
    /** get 산출세액 : prddTaxn */
    public BigDecimal  getPrddTaxn() { return (BigDecimal )get( ATTR_PRDDTAXN );}

    /** set 세액감면_소득세법 : taxdIcax */
    public void setTaxdIcax(BigDecimal  taxdIcax) { set( ATTR_TAXDICAX ,taxdIcax);}
    /** get 세액감면_소득세법 : taxdIcax */
    public BigDecimal  getTaxdIcax() { return (BigDecimal )get( ATTR_TAXDICAX );}

    /** set 세액감면_조세특례법 : taxdSpct */
    public void setTaxdSpct(BigDecimal  taxdSpct) { set( ATTR_TAXDSPCT ,taxdSpct);}
    /** get 세액감면_조세특례법 : taxdSpct */
    public BigDecimal  getTaxdSpct() { return (BigDecimal )get( ATTR_TAXDSPCT );}

    /** set 세액감면_조세특례법제30조 : txlgCl30 */
    public void setTxlgCl30(BigDecimal  txlgCl30) { set( ATTR_TXLGCL30 ,txlgCl30);}
    /** get 세액감면_조세특례법제30조 : txlgCl30 */
    public BigDecimal  getTxlgCl30() { return (BigDecimal )get( ATTR_TXLGCL30 );}

    /** set 세액감면_조세조약 : txlgHxtt */
    public void setTxlgHxtt(BigDecimal  txlgHxtt) { set( ATTR_TXLGHXTT ,txlgHxtt);}
    /** get 세액감면_조세조약 : txlgHxtt */
    public BigDecimal  getTxlgHxtt() { return (BigDecimal )get( ATTR_TXLGHXTT );}

    /** set 세액감면_감면세액계 : taxdTsum */
    public void setTaxdTsum(BigDecimal  taxdTsum) { set( ATTR_TAXDTSUM ,taxdTsum);}
    /** get 세액감면_감면세액계 : taxdTsum */
    public BigDecimal  getTaxdTsum() { return (BigDecimal )get( ATTR_TAXDTSUM );}

    /** set 세액공제_근로소득세액공제 : taxdWken */
    public void setTaxdWken(BigDecimal  taxdWken) { set( ATTR_TAXDWKEN ,taxdWken);}
    /** get 세액공제_근로소득세액공제 : taxdWken */
    public BigDecimal  getTaxdWken() { return (BigDecimal )get( ATTR_TAXDWKEN );}

    /** set 세액공제_납세조합공제 : taxdUnin */
    public void setTaxdUnin(BigDecimal  taxdUnin) { set( ATTR_TAXDUNIN ,taxdUnin);}
    /** get 세액공제_납세조합공제 : taxdUnin */
    public BigDecimal  getTaxdUnin() { return (BigDecimal )get( ATTR_TAXDUNIN );}

    /** set 세액공제_주택차입금 : taxdLoan */
    public void setTaxdLoan(BigDecimal  taxdLoan) { set( ATTR_TAXDLOAN ,taxdLoan);}
    /** get 세액공제_주택차입금 : taxdLoan */
    public BigDecimal  getTaxdLoan() { return (BigDecimal )get( ATTR_TAXDLOAN );}

    /** set 세액공제_외국납부 : taxdPaid */
    public void setTaxdPaid(BigDecimal  taxdPaid) { set( ATTR_TAXDPAID ,taxdPaid);}
    /** get 세액공제_외국납부 : taxdPaid */
    public BigDecimal  getTaxdPaid() { return (BigDecimal )get( ATTR_TAXDPAID );}

    /** set 세액공제_외국인감면세액 : taxdRedu */
    public void setTaxdRedu(BigDecimal  taxdRedu) { set( ATTR_TAXDREDU ,taxdRedu);}
    /** get 세액공제_외국인감면세액 : taxdRedu */
    public BigDecimal  getTaxdRedu() { return (BigDecimal )get( ATTR_TAXDREDU );}

    /** set 세액공제_자녀세액공제금액 : addrMccr */
    public void setAddrMccr(BigDecimal  addrMccr) { set( ATTR_ADDRMCCR ,addrMccr);}
    /** get 세액공제_자녀세액공제금액 : addrMccr */
    public BigDecimal  getAddrMccr() { return (BigDecimal )get( ATTR_ADDRMCCR );}

    /** set 특별세액공제계 : spciDcto */
    public void setSpciDcto(BigDecimal  spciDcto) { set( ATTR_SPCIDCTO ,spciDcto);}
    /** get 특별세액공제계 : spciDcto */
    public BigDecimal  getSpciDcto() { return (BigDecimal )get( ATTR_SPCIDCTO );}

    /** set 세액공제_공제계 : taxdCsum */
    public void setTaxdCsum(BigDecimal  taxdCsum) { set( ATTR_TAXDCSUM ,taxdCsum);}
    /** get 세액공제_공제계 : taxdCsum */
    public BigDecimal  getTaxdCsum() { return (BigDecimal )get( ATTR_TAXDCSUM );}

    /** set 결정세액_소득세 : dcsnIncm */
    public void setDcsnIncm(BigDecimal  dcsnIncm) { set( ATTR_DCSNINCM ,dcsnIncm);}
    /** get 결정세액_소득세 : dcsnIncm */
    public BigDecimal  getDcsnIncm() { return (BigDecimal )get( ATTR_DCSNINCM );}

    /** set 결정세액_주민세_지방소득세 : dcsnInhb */
    public void setDcsnInhb(BigDecimal  dcsnInhb) { set( ATTR_DCSNINHB ,dcsnInhb);}
    /** get 결정세액_주민세_지방소득세 : dcsnInhb */
    public BigDecimal  getDcsnInhb() { return (BigDecimal )get( ATTR_DCSNINHB );}

    /** set 결정세액_농특세 : dcsnFafv */
    public void setDcsnFafv(BigDecimal  dcsnFafv) { set( ATTR_DCSNFAFV ,dcsnFafv);}
    /** get 결정세액_농특세 : dcsnFafv */
    public BigDecimal  getDcsnFafv() { return (BigDecimal )get( ATTR_DCSNFAFV );}

    /** set 기납부세액_소득세 : alryPinx */
    public void setAlryPinx(BigDecimal  alryPinx) { set( ATTR_ALRYPINX ,alryPinx);}
    /** get 기납부세액_소득세 : alryPinx */
    public BigDecimal  getAlryPinx() { return (BigDecimal )get( ATTR_ALRYPINX );}

    /** set 기납부세액_주민세_지방소득세 : alryPhbx */
    public void setAlryPhbx(BigDecimal  alryPhbx) { set( ATTR_ALRYPHBX ,alryPhbx);}
    /** get 기납부세액_주민세_지방소득세 : alryPhbx */
    public BigDecimal  getAlryPhbx() { return (BigDecimal )get( ATTR_ALRYPHBX );}

    /** set 기납부세액_농특세 : alryYvtx */
    public void setAlryYvtx(BigDecimal  alryYvtx) { set( ATTR_ALRYYVTX ,alryYvtx);}
    /** get 기납부세액_농특세 : alryYvtx */
    public BigDecimal  getAlryYvtx() { return (BigDecimal )get( ATTR_ALRYYVTX );}

    /** set 이전근무지_총급여 : dcsnTots */
    public void setDcsnTots(BigDecimal  dcsnTots) { set( ATTR_DCSNTOTS ,dcsnTots);}
    /** get 이전근무지_총급여 : dcsnTots */
    public BigDecimal  getDcsnTots() { return (BigDecimal )get( ATTR_DCSNTOTS );}

    /** set 이전근무지_소득세 : dcsnItax */
    public void setDcsnItax(BigDecimal  dcsnItax) { set( ATTR_DCSNITAX ,dcsnItax);}
    /** get 이전근무지_소득세 : dcsnItax */
    public BigDecimal  getDcsnItax() { return (BigDecimal )get( ATTR_DCSNITAX );}

    /** set 이전근무지_주민세_지방소득세 : dcsnBtax */
    public void setDcsnBtax(BigDecimal  dcsnBtax) { set( ATTR_DCSNBTAX ,dcsnBtax);}
    /** get 이전근무지_주민세_지방소득세 : dcsnBtax */
    public BigDecimal  getDcsnBtax() { return (BigDecimal )get( ATTR_DCSNBTAX );}

    /** set 이전근무지_농특세 : fafvTaxi */
    public void setFafvTaxi(BigDecimal  fafvTaxi) { set( ATTR_FAFVTAXI ,fafvTaxi);}
    /** get 이전근무지_농특세 : fafvTaxi */
    public BigDecimal  getFafvTaxi() { return (BigDecimal )get( ATTR_FAFVTAXI );}

    /** set 차감징수_소득세 : subtEtax */
    public void setSubtEtax(BigDecimal  subtEtax) { set( ATTR_SUBTETAX ,subtEtax);}
    /** get 차감징수_소득세 : subtEtax */
    public BigDecimal  getSubtEtax() { return (BigDecimal )get( ATTR_SUBTETAX );}

    /** set 차감징수_주민세_지방소득세 : subtInhb */
    public void setSubtInhb(BigDecimal  subtInhb) { set( ATTR_SUBTINHB ,subtInhb);}
    /** get 차감징수_주민세_지방소득세 : subtInhb */
    public BigDecimal  getSubtInhb() { return (BigDecimal )get( ATTR_SUBTINHB );}

    /** set 차감징수_농특세 : subtFafv */
    public void setSubtFafv(BigDecimal  subtFafv) { set( ATTR_SUBTFAFV ,subtFafv);}
    /** get 차감징수_농특세 : subtFafv */
    public BigDecimal  getSubtFafv() { return (BigDecimal )get( ATTR_SUBTFAFV );}

    /** set 차감징수_세액계 : subtAmsu */
    public void setSubtAmsu(BigDecimal  subtAmsu) { set( ATTR_SUBTAMSU ,subtAmsu);}
    /** get 차감징수_세액계 : subtAmsu */
    public BigDecimal  getSubtAmsu() { return (BigDecimal )get( ATTR_SUBTAMSU );}

    /** set 연금계좌세액공제계 : jrtrHnto */
    public void setJrtrHnto(BigDecimal  jrtrHnto) { set( ATTR_JRTRHNTO ,jrtrHnto);}
    /** get 연금계좌세액공제계 : jrtrHnto */
    public BigDecimal  getJrtrHnto() { return (BigDecimal )get( ATTR_JRTRHNTO );}

    /** set 이월특례기부금_공익신탁금액 : spciOnon */
    public void setSpciOnon(BigDecimal  spciOnon) { set( ATTR_SPCIONON ,spciOnon);}
    /** get 이월특례기부금_공익신탁금액 : spciOnon */
    public BigDecimal  getSpciOnon() { return (BigDecimal )get( ATTR_SPCIONON );}

    /** set 이월법정기부금액 : spciObam */
    public void setSpciObam(BigDecimal  spciObam) { set( ATTR_SPCIOBAM ,spciObam);}
    /** get 이월법정기부금액 : spciObam */
    public BigDecimal  getSpciObam() { return (BigDecimal )get( ATTR_SPCIOBAM );}

    /** set 이월종교단체기부금 : spciOyam */
    public void setSpciOyam(BigDecimal  spciOyam) { set( ATTR_SPCIOYAM ,spciOyam);}
    /** get 이월종교단체기부금 : spciOyam */
    public BigDecimal  getSpciOyam() { return (BigDecimal )get( ATTR_SPCIOYAM );}

    /** set 이월종교단체외기부금 : spciOnam */
    public void setSpciOnam(BigDecimal  spciOnam) { set( ATTR_SPCIONAM ,spciOnam);}
    /** get 이월종교단체외기부금 : spciOnam */
    public BigDecimal  getSpciOnam() { return (BigDecimal )get( ATTR_SPCIONAM );}
