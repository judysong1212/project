...
//    private YetaConstants yetaLabel = YetaConstants.INSTANCE;
	...
	public Ye164010Def(String chkPayrDef) {
		...
		if ("YetaP63002".equals(chkPayrDef)) {
			setDaoClass("");
			 setCustomListMethod(CLASS_YETAP63002_TO_YE164010_DATA_LIST);
			setAutoFillGrid(false);
			setShowFilterToolbar(false);
			setCheckBoxOnGridRows(true);
			setEditableGrid(true);
			setEditFieldGrid(true);
			setColumnsDefinition(getYetaP63002ToYe164010ColumnsList());
		} else {
			setDaoClass("");
    ...
    private List<ColumnDef> getYe164010ColumnsList(){
        ...
        listColumnDefs.add(new ColumnDef("산후조리원여부", Ye164010BM.ATTR_YN3, ColumnDef.TYPE_STRING , 100, true, true, true){
        	{
        ...
        listColumnDefs.add(new ColumnDef("실손보험비보전여부", Ye164010BM.ATTR_YN4, ColumnDef.TYPE_STRING , 100, true, true, true){
        	{
    ...
    private List<ColumnDef> getYetaP63002ToYe164010ColumnsList(){
