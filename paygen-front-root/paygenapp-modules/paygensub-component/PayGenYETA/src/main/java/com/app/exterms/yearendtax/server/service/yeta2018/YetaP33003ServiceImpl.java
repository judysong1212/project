...
import com.app.exterms.yearendtax.server.vo.Ye165010Srh_2018_VO;
...
@Service("YetaP33003Service")
public class YetaP33003ServiceImpl  extends AbstractCustomServiceImpl implements YetaP33003Service  ,YetaDaoConstants {

	 
	private static final Logger logger = LoggerFactory.getLogger(YetaP33003ServiceImpl.class);
	private static final String calledClass = YetaP33003ServiceImpl.class.getName();

	
	@Autowired
	@Resource(name = "Ye165010_2018_DAO")
	private Ye165010_2018_DAO ye165010DAO; 
	
	
	@Autowired
	@Resource(name = "Ye165020_2018_DAO")
	private Ye165020_2018_DAO ye165020DAO; 
	...
	/** 이월기부금 신규 수정 삭제부 **/
	@Override
	public Long activityOnYetaP33003ToYe165010(List<Ye165010DTO> listYe165010Dto, ActionDatabase actionDatabase) throws MSFException {
		...
		String windowId = "YETAP330003";
	        
		String method = calledClass + ".activityOnYetaP33003ToYe165010";

		
		Ye165010DTO ye165010Dto = new Ye165010DTO();
		Ye165010_2018_VO ye165010Vo = new Ye165010_2018_VO();
		...
		try {
			...
			if (MSFSharedUtils.paramNull(ye165010DAO)) {
				...
				ye165010DAO = (Ye165010_2018_DAO) wac.getBean("Ye165010_2018_DAO");
			}
			...
			for(int iPsnlCnt=0;iPsnlCnt < listYe165010Dto.size();iPsnlCnt++) {
				...
				ye165010Vo = new Ye165010_2018_VO();
				...
				case INSERT:
					...
					ye165010DAO.insertYetaP33003ToYe165010(ye165010Vo);
					break;
					
				case UPDATE:
					
					ye165010DAO.updateYetaP33003ToYe165010(ye165010Vo);
					break;
					
				case DELETE:
					
					ye165010DAO.deleteYetaP33003ToYe165010(ye165010Vo);
					break;
...
//			yeta2300ListenerAdt.fnYeta2300_Ye161010_2017_CalcUpdate(RemoteServiceUtil.getThreadLocalRequest(), infcPkgYe161010Vo, "YE166020_INSERT");
			...
			result = new Long(0);
			throw MSFServerUtils.getOperationException("activityOnYetaP33003ToYe165010", ex, logger);
	...
	/** 기부금등록내역 조회 **/
	public PagingLoadResult<BaseModel> getYetaP33003ToYe165010DataList(ServiceParameters serviceParameters) throws MSFException {
			
		PagingLoadResult<BaseModel> retval = null;
		String method = CLASS_YETAP33003_TO_YE165010_DATA_LIST;
		Ye165010Srh_2018_VO ye165010SrhVo = new Ye165010Srh_2018_VO();
...
//		      	yeta3220SrhVo.setHanNm(MSFSharedUtils.allowNulls(MSFServerUtils.getFilterValue(columnFilters, "hanNm")));    //한글성명 
			...
			if (pagingValues.executeRecordCount) {
				...
				int iResultCnt = ye165010DAO.selectYetaP33003ToYe165010ListTotCnt(ye165010SrhVo);
			...
			List list = ye165010DAO.selectYetaP33003ToYe165010List(ye165010SrhVo);
			...
			SmrmfUtils.endTiming(logger, millisBeginPsnl0126DataList, "getYetaP33003ToYe165010DataList");
