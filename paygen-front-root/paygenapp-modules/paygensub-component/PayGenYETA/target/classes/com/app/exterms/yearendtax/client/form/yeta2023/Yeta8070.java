...
import com.app.exterms.yearendtax.client.form.defs.yeta2023.Yeta8070Def;
import com.app.exterms.yearendtax.client.service.yeta2023.Yeta8070Service;
import com.app.exterms.yearendtax.client.service.yeta2023.Yeta8070ServiceAsync;
...
=====================================================**/
public class Yeta8070  extends MSFPanel { 
	...
	private FormPanel plFrmYeta8070;
	private FormData formData; 
	private String txtForm = "";
	private XTemplate detailTp;	  
	private Yeta8070ServiceAsync Yeta8070service = Yeta8070Service.Util.getInstance(); 
	...
	private Yeta8070Def Yeta8070MSDef = new Yeta8070Def("Yeta8070MS");
	private InfcPkgBass0150Def Yeta8070ToBass0150Def = new InfcPkgBass0150Def("yeta8070ToBass0150");
	private InfcPkgBass0500Def Yeta8070ToBass0500OnDef = new InfcPkgBass0500Def("YETA8070_BASS0500_ON");
	private InfcPkgBass0500Def Yeta8070ToBass0500OffDef = new InfcPkgBass0500Def("YETA8070_BASS0500_OFF");

	private MSFGridPanel msfGridPanelYeta8070MS; 
	...
	public ContentPanel getViewPanel() {
		if (panel == null) {        	
			...
			msfGridPanelYeta8070MS.reload();
			msfGridPanelBass0150.reload();

			//			final RelationDef  relBass0360 = new RelationDef(Yeta8070MSDef,false);
			//			relBass0360.addJoinDef("utDpobCd", "utDpobCd"); 
			//			relBass0360.setLinkedObject(msfGridPanelYeta8070MS);
			//			Yeta8070ToBass0500OnDef.addRelation(relBass0360); 
			//
			//			/**
			//			 * Create the relations 
			//			 */
			//			final RelationDef  relBass0350 = new RelationDef(Yeta8070MSDef,false);
			//			relBass0350.addJoinDef("utDpobCd", "utDpobCd"); 
			//			relBass0350.setLinkedObject(msfGridPanelYeta8070MS);
			//			Yeta8070ToBass0500OffDef.addRelation(relBass0350); 
			//
			//
			//			// DETAILS 
			//			final Grid Yeta8070ToBass0500OffDefGrid = msfGridPanelYeta8070MS.getMsfGrid().getGrid();
			//			Yeta8070ToBass0500OffDefGrid.addListener(Events.CellDoubleClick, new Listener<BaseEvent>() {
			//				public void handleEvent(BaseEvent be) {  
			//					if (msfGridPanelYeta8070MS.getCurrentlySelectedItem() != null) {  
			//
			//						Yeta8070ToBass0500OnDef.synchronizeGridDetail(
			//								msfGridPanelYeta8070MS.getCurrentlySelectedItem(),
			//								msfGridPanelBass0500On );
			//
			//						Yeta8070ToBass0500OffDef.synchronizeGridDetail(
			//								msfGridPanelYeta8070MS.getCurrentlySelectedItem(),
	...
	public Yeta8070(String txtForm) {
		this.txtForm = txtForm;
	}		  

	private void createSysm0500Form() {

		plFrmYeta8070 = new FormPanel();
		plFrmYeta8070.setHeadingText("PayGen Ver1.0 - 단위사업장사업관리");
		plFrmYeta8070.setIcon(Resources.APP_ICONS.text());
		plFrmYeta8070.setBodyStyleName("pad-text");
		plFrmYeta8070.setFrame(true); 
		plFrmYeta8070.setPadding(2);
		/************************************************************************
		...
		btnlogView.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				//로그 뷰화면 호출 메서드 
				funcLogMessage("단위사업장사업관리","Yeta8070");
			}
		});
		plFrmYeta8070.getHeader().setStyleAttribute("padding", "5px 0 2px 0");
		plFrmYeta8070.getHeader().addTool(btnlogView); 
		/************************************************************************
		...
		Yeta8070MSDef.setReadOnly(true);   
		msfGridPanelYeta8070MS = new MSFGridPanel(Yeta8070MSDef, false, false, false, false,false); 
		msfGridPanelYeta8070MS.setSize(350, 620);
		msfGridPanelYeta8070MS.setBorders(true);
		msfGridPanelYeta8070MS.getGrid().setBorders(true);
		Grid grid = msfGridPanelYeta8070MS.getMsfGrid().getGrid();
		grid.addListener(Events.CellDoubleClick , new Listener<BaseEvent>() {
			public void handleEvent(BaseEvent be) {

				untDpobCd = MSFSharedUtils.allowNulls(msfGridPanelYeta8070MS.getMsfGrid().getCurrentlySelectedItem().get("utDpobCd"));

				OnReload(untDpobCd);
				OffReload();
			}					
		});
		inner.add(msfGridPanelYeta8070MS);

		msfGridPanelBass0150 = new MSFGridPanel(Yeta8070ToBass0150Def, false, false, false, false, false); 
		msfGridPanelBass0150.setSize(600, 200);
		msfGridPanelBass0150.setBorders(true);
		msfGridPanelBass0150.getGrid().setBorders(true);

		// 두번째 컨테이너컬럼(사용사업정보)   
		msfGridPanelBass0500On = new MSFGridPanel(Yeta8070ToBass0500OnDef, false, false, false, false, false); 
		...
		// 세번째 컨테이너컬럼(미사용사업정보)  
		msfGridPanelBass0500Off = new MSFGridPanel(Yeta8070ToBass0500OffDef, false, false, false, false,false); 
		...
		plFrmYeta8070.add(srhOffDeptCd);
			...
			public void componentSelected(ButtonEvent ce) {  
				...
				while (iterRecords.hasNext()) {	    		            	  
					...
					if ((Boolean)bmMapModel.get("select")) {
						...
						pkgBass0500Dto.setUntDpobCd(MSFSharedUtils.allowNulls(msfGridPanelYeta8070MS.getMsfGrid().getCurrentlySelectedItem().get("utDpobCd")));
		...
		plFrmYeta8070.add(inner);

		vp.add(plFrmYeta8070);
		plFrmYeta8070.setSize("990px", "680px");
	}	

	private Yeta8070 getThis(){
		return this;
	}
