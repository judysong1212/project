...
import com.app.exterms.yearendtax.client.service.yeta2019.YetaT43012Service;
import com.app.exterms.yearendtax.client.service.yeta2019.YetaT43012ServiceAsync;
...
=====================================================**/
public  class YetaT43012   extends MSFFormPanel {  
 ...
 **/
	...
	private  ContentPanel cpYetaT43012; 
	...
	// -------------- grid 선언 시작  ---------------	  
	private MSFGridPanel YetaT43012GridPanel;
//	private YetaT43012Def YetaT43012Def = new YetaT43012Def("YetaT43012");   //TODO 일단 화면번호로 Def
	// -------------- grid 선언 종료  ---------------
	...
	// -------------- 서비스 호출 시작 --------------
	private YetaT43012ServiceAsync yetaT43012Service = YetaT43012Service.Util.getInstance();
	// -------------- 서비스 호출 종료 --------------	 
...
//					ye162510Dto.setMnthRnttyHusCnttArea((MSFSharedUtils.allowNulls(bmMapModel.get("mnthRnttyHusCnttArea"))));    		/** column 월세주택계약면적 : mnthRnttyHusCnttArea */
				...
				yetaT43012Service.activityOnYetaT43012(listYe162510Dto, actionDatabase, new AsyncCallback<Long>(){
...
//		 }
	...
	public YetaT43012(final ActionDatabase actionDatabase, final MSFPanel caller) {
...
//		initLoad(); 	
		...
		this.actionDatabase = actionDatabase;
	 	...
	 	cpYetaT43012 = new ContentPanel();  

		createSearchForm();			//기본정보 필드를 적용
	 	createMsfGridForm();		//그리드필드
		   
		cpYetaT43012.setBodyBorder(false);
		cpYetaT43012.setBorders(false);
		cpYetaT43012.setHeaderVisible(false);
		cpYetaT43012.setSize("790px", "640px");
		   
		this.add(cpYetaT43012);
...
//		     });     
		...
		cpYetaT43012.setLayout(new FlowLayout());
...
//	      	     }
//				 
//				YetaT43012GridPanel.getMsfGrid().clearData();
//				 
//				BaseModel bmData = YetaT43012GridPanel.getTableDef().getDefaultValues();  
//		              
...
//		         
//		        YetaT43012GridPanel.getMsfGrid().getGrid().stopEditing();      
//		        YetaT43012GridPanel.getMsfGrid().getGrid().getStore().insert(bmData,0);   
//		        YetaT43012GridPanel.getMsfGrid().getGrid().startEditing(YetaT43012GridPanel.getMsfGrid().getGrid().getStore().indexOf(bmData), 0);   
//
...
//			public void handleEvent(ButtonEvent e) {
//				Iterator<BaseModel> itBm = YetaT43012GridPanel.getMsfGrid().getGrid().getSelectionModel().getSelectedItems().listIterator();
...
//				
		...
		btnYetaSave.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				setListRecord(YetaT43012GridPanel.getMsfGrid().getStore().getModifiedRecords().iterator());
				doAction(actionDatabase);
...
//				
		cpYetaT43012.add(topYetaBtnBar);
...
//		YetaT43012GridPanel = new MSFGridPanel(YetaT43012Def, false, false, false, false, false);
//		YetaT43012GridPanel.setSize("790px", "420px");
//		YetaT43012GridPanel.setBorders(true);
//		YetaT43012GridPanel.setHeaderVisible(false);
...
//		
//		YetaT43012GridPanel.getGrid().getColumnModel().addAggregationRow(payrSummaryRow);  
//		
...
//		
//		YetaT43012GridPanel.getGrid().getColumnModel().addAggregationRow(payrSummaryRow1);
//		/** --- 그리드 합계 부분  종료 --- **/
		
//        cpYetaT43012.add(YetaT43012GridPanel);
...
//		layoutContainer7.setStyleAttribute("marginBottom", "5px")
		...
		cpYetaT43012.add(fldstNewFieldset_1);
		cpYetaT43012.add(fldstNewFieldset_4);
	...
	public void reload() {
			...
			YetaT43012GridPanel.getTableDef().setTableColumnFilters(filters);
			YetaT43012GridPanel.getTableDef().addColumnFilter("yrtxBlggYr", MSFSharedUtils.allowNulls(srhYrtxBlggYr.getValue())
...
//					, SimpleColumnFilter.OPERATOR_EQUALS);//연말정산귀속년도
			YetaT43012GridPanel.getTableDef().addColumnFilter("clutSeptCd", MSFSharedUtils.getSelectedComboValue(srhClutSeptCd,"commCd")
					, SimpleColumnFilter.OPERATOR_EQUALS);//정산구분
			YetaT43012GridPanel.getTableDef().addColumnFilter("systemkey", MSFSharedUtils.allowNulls(systemkey.getValue())
					, SimpleColumnFilter.OPERATOR_EQUALS);//시스템키
		 
			YetaT43012GridPanel.reload();
