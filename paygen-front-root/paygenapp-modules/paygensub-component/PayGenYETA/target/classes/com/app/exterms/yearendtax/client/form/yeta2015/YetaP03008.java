...
import com.app.exterms.yearendtax.client.service.yeta2015.YetaP03008ServiceAsync;
...
=====================================================**/
public  class YetaP03008   extends MSFFormPanel { 
 ...
 **/
	...
	private  ContentPanel cpYeta03008; 
	 ...
	 *#######################################################*/
		...
		// -------------- DTO 선언 시작 --------------
		private  Yeta3200DTO yeta3200Dto; 
		// -------------- DTO 선언 종료 --------------
...
//	private HiddenField<String> hid_siteNumb;	/**  column 사업자등록번호 : siteNumb */
	...
	// -------------- 서비스 호출 시작 --------------
	private YetaP03008ServiceAsync yetaP03008Service = YetaP03008Service.Util.getInstance();
	// -------------- 서비스 호출 종료 --------------
  /**
   * ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
   * 입력 변수 선언 
 ...
 **/	  
	...
	public YetaP03008(final ActionDatabase actionDatabase, final MSFPanel caller) {
		...
		cpYeta03008 = new ContentPanel();

		createStandardForm();
		setReadOnlyTrueYetaP03008();

		cpYeta03008.setBodyBorder(false);
		cpYeta03008.setBorders(false);
		cpYeta03008.setHeaderVisible(false);
		cpYeta03008.setSize("790px", "640px");

		this.add(cpYeta03008);
		formBinding = new FormBinding(this, true);

		this.setSize("810px", "710px");
	} 
	  
	public YetaP03008(final ActionDatabase actionDatabase, final MSFFormPanel caller2) {
...
//			actionDatabase = ActionDatabase.UPDATE;
		...
		private void yetaP03008FormSave() {  
//			if (MSFSharedUtils.paramNotNull(records)) { 
	              
				List<Yeta3200DTO> listYeta3200dto = new ArrayList<Yeta3200DTO>();  
...
//				}  
				...
				yetaP03008Service.activityOnYetaP03008ToYeta3200(listYeta3200dto, actionDatabase, new AsyncCallback<Long>(){
					public void onFailure(Throwable caught) {
						MessageBox.alert(MSFMainApp.MSFCONSTANTS.ExceptionTitleService(), 
	                              MSFMainApp.ADMINMESSAGES.ExceptionMessageService("activityOnYetaP03008ToYeta3200(" + actionDatabase.name() + ") : " + caught), null);
					}
...
//			}
	...
	public void reload() {
		...
		yetaP03008Service.getYetaP03008To3200List(yeta3200Dto, new AsyncCallback<Yeta3200DTO>(){

			@Override
			public void onFailure(Throwable caught) {
				// TODO Auto-generated method stub
				MessageBox.alert(MSFMainApp.MSFCONSTANTS.ExceptionTitleService(), 
                        MSFMainApp.ADMINMESSAGES.ExceptionMessageService("getYetaP03008To3200List(" + actionDatabase.name() + ") : " + caught), null);
				
			}

			@Override
			public void onSuccess(Yeta3200DTO result) {
				// TODO Auto-generated method stub
				readYetaP03008Data(result);
			}
		});
	}	
	
	//비과세 및 감면소득 조회부
	public void readYetaP03008Data(Yeta3200DTO result) {
	...
	public void setReadOnlyTrueYetaP03008() {
	...
	public void setReadOnlyFalseYetaP03008() {
