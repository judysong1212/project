...
import com.app.exterms.yearendtax.client.service.yeta2017.YetaT23009Service;
import com.app.exterms.yearendtax.client.service.yeta2017.YetaT23009ServiceAsync;
...
//import com.app.exterms.yearendtax.client.form.defs.yeta2016.YetaT23009Def;
...
=====================================================**/
public  class YetaT23009   extends MSFFormPanel {  
 ...
 **/
	...
	private  ContentPanel cpYetaT23009; 
	...
	// -------------- grid 선언 시작  ---------------	  
	private MSFGridPanel yetaT23009GridPanel;
//	private YetaT23009Def yetaT23009Def = new YetaT23009Def("YetaT23009");   //TODO 일단 화면번호로 Def
	// -------------- grid 선언 종료  ---------------
	...
	// -------------- 서비스 호출 시작 --------------
	private YetaT23009ServiceAsync yetaT23009Service = YetaT23009Service.Util.getInstance();
	// -------------- 서비스 호출 종료 --------------	 
...
//					ye162510Dto.setMnthRnttyHusCnttArea((MSFSharedUtils.allowNulls(bmMapModel.get("mnthRnttyHusCnttArea"))));    		/** column 월세주택계약면적 : mnthRnttyHusCnttArea */
				...
				yetaT23009Service.activityOnYetaT23009(listYe162510Dto, actionDatabase, new AsyncCallback<Long>(){
...
//		 }
	...
	public YetaT23009(final ActionDatabase actionDatabase, final MSFPanel caller) {
...
//		initLoad(); 	
		...
		this.actionDatabase = actionDatabase;
	 	...
	 	cpYetaT23009 = new ContentPanel();  

		createSearchForm();			//기본정보 필드를 적용
	 	createMsfGridForm();		//그리드필드
		   
		cpYetaT23009.setBodyBorder(false);
		cpYetaT23009.setBorders(false);
		cpYetaT23009.setHeaderVisible(false);
		cpYetaT23009.setSize("790px", "640px");
		   
		this.add(cpYetaT23009);
...
//		     });     
		...
		cpYetaT23009.setLayout(new FlowLayout());
...
//	      	     }
//				 
//				yetaT23009GridPanel.getMsfGrid().clearData();
//				 
//				BaseModel bmData = yetaT23009GridPanel.getTableDef().getDefaultValues();  
//		              
...
//		         
//		        yetaT23009GridPanel.getMsfGrid().getGrid().stopEditing();      
//		        yetaT23009GridPanel.getMsfGrid().getGrid().getStore().insert(bmData,0);   
//		        yetaT23009GridPanel.getMsfGrid().getGrid().startEditing(yetaT23009GridPanel.getMsfGrid().getGrid().getStore().indexOf(bmData), 0);   
//
...
//			public void handleEvent(ButtonEvent e) {
//				Iterator<BaseModel> itBm = yetaT23009GridPanel.getMsfGrid().getGrid().getSelectionModel().getSelectedItems().listIterator();
...
//			public void handleEvent(ButtonEvent e) {
//				setListRecord(yetaT23009GridPanel.getMsfGrid().getStore().getModifiedRecords().iterator());
//				doAction(actionDatabase);
//
//				if ((ActionDatabase.INSERT).equals(actionDatabase)) {
//					actionDatabase = ActionDatabase.INSERT;
...
//				
//		cpYetaT23009.add(topYetaBtnBar);
...
//		yetaT23009GridPanel = new MSFGridPanel(yetaT23009Def, false, false, false, false, false);
//		yetaT23009GridPanel.setSize("790px", "420px");
//		yetaT23009GridPanel.setBorders(true);
//		yetaT23009GridPanel.setHeaderVisible(false);
...
//		
//		yetaT23009GridPanel.getGrid().getColumnModel().addAggregationRow(payrSummaryRow);  
//		
...
//		
//		yetaT23009GridPanel.getGrid().getColumnModel().addAggregationRow(payrSummaryRow1);
//		/** --- 그리드 합계 부분  종료 --- **/
		
//        cpYetaT23009.add(yetaT23009GridPanel);
		...
		cpYetaT23009.add(layoutContainer);
		cpYetaT23009.add(layoutContainer20);
		cpYetaT23009.add(layoutContainer21);
		cpYetaT23009.add(layoutContainer22);
	...
	public void reload() {
			...
			yetaT23009GridPanel.getTableDef().setTableColumnFilters(filters);
			yetaT23009GridPanel.getTableDef().addColumnFilter("yrtxBlggYr", MSFSharedUtils.allowNulls(srhYrtxBlggYr.getValue())
...
//					, SimpleColumnFilter.OPERATOR_EQUALS);//연말정산귀속년도
			yetaT23009GridPanel.getTableDef().addColumnFilter("clutSeptCd", MSFSharedUtils.getSelectedComboValue(srhClutSeptCd,"commCd")
					, SimpleColumnFilter.OPERATOR_EQUALS);//정산구분
			yetaT23009GridPanel.getTableDef().addColumnFilter("systemkey", MSFSharedUtils.allowNulls(systemkey.getValue())
					, SimpleColumnFilter.OPERATOR_EQUALS);//시스템키
		 
			yetaT23009GridPanel.reload();
