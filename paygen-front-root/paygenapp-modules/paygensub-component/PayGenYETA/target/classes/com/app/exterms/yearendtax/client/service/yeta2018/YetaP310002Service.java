...
@RemoteServiceRelativePath("YetaP310002Service.gwt")
public interface YetaP310002Service extends RemoteService {
	/**
	 * Utility class for simplifying access to the instance of async service.
	 */
	public static class Util {
		private static YetaP310002ServiceAsync instance;
		public static YetaP310002ServiceAsync getInstance(){
			if (instance == null) {
				instance = GWT.create(YetaP310002Service.class);
			}
			return instance;
		}
	}
...
//	
	...
	/** 원천신고부서대상자 원천신고부서 반영  **/
	public int saveYetaP310002ToYe161010(List<Ye161010DTO> ye161010Dto) throws MSFException ;
