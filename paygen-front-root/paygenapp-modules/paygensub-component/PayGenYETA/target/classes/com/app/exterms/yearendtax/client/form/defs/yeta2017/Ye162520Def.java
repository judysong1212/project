...
public class Ye162520Def extends TableDef implements YetaDaoConstants{
	...
	public Ye162520Def(String chkDef) {
		...
		if ("YETAP03004".equals(chkDef)) {
			...
			setTitle("");
			setDaoClass("");
			setCustomListMethod(CLASS_YETAP23004_TO_YE162520_DATA_LIST);
			setAutoFillGrid(false);
			setShowFilterToolbar(false);
			setCheckBoxOnGridRows(true);
			setEditFieldGrid(true);
			setColumnsDefinition(getColumnsListYetaP23004ToYE162520());
...
//        		setReadOnly(true);
	...
	private List<ColumnDef> getColumnsListYetaP23004ToYE162520() {
