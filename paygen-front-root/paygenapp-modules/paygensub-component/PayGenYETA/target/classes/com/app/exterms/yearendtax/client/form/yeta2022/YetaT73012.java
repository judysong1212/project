...
import com.app.exterms.yearendtax.client.service.yeta2022.YetaT73012Service;
import com.app.exterms.yearendtax.client.service.yeta2022.YetaT73012ServiceAsync;
...
=====================================================**/
public  class YetaT73012   extends MSFFormPanel {  
 ...
 **/
	...
	private  ContentPanel cpYetaT73012; 
	...
	// -------------- grid 선언 시작  ---------------	  
	private MSFGridPanel YetaT73012GridPanel;
//	private YetaT73012Def YetaT73012Def = new YetaT73012Def("YetaT73012");   //TODO 일단 화면번호로 Def
	// -------------- grid 선언 종료  ---------------
	...
	// -------------- 서비스 호출 시작 --------------
	private YetaT73012ServiceAsync yetaT73012Service = YetaT73012Service.Util.getInstance();
	// -------------- 서비스 호출 종료 --------------	 
...
//					ye162510Dto.setMnthRnttyHusCnttArea((MSFSharedUtils.allowNulls(bmMapModel.get("mnthRnttyHusCnttArea"))));    		/** column 월세주택계약면적 : mnthRnttyHusCnttArea */
				...
				yetaT73012Service.activityOnYetaT73012(listYe162510Dto, actionDatabase, new AsyncCallback<Long>(){
...
//		 }
	...
	public YetaT73012(final ActionDatabase actionDatabase, final MSFPanel caller) {
...
//		initLoad(); 	
		...
		this.actionDatabase = actionDatabase;
	 	...
	 	cpYetaT73012 = new ContentPanel();  

		createSearchForm();			//기본정보 필드를 적용
	 	createMsfGridForm();		//그리드필드
		   
		cpYetaT73012.setBodyBorder(false);
		cpYetaT73012.setBorders(false);
		cpYetaT73012.setHeaderVisible(false);
		cpYetaT73012.setSize("790px", "640px");
		   
		this.add(cpYetaT73012);
...
//		     });     
		...
		cpYetaT73012.setLayout(new FlowLayout());
...
//	      	     }
//				 
//				YetaT73012GridPanel.getMsfGrid().clearData();
//				 
//				BaseModel bmData = YetaT73012GridPanel.getTableDef().getDefaultValues();  
//		              
...
//		         
//		        YetaT73012GridPanel.getMsfGrid().getGrid().stopEditing();      
//		        YetaT73012GridPanel.getMsfGrid().getGrid().getStore().insert(bmData,0);   
//		        YetaT73012GridPanel.getMsfGrid().getGrid().startEditing(YetaT73012GridPanel.getMsfGrid().getGrid().getStore().indexOf(bmData), 0);   
//
...
//			public void handleEvent(ButtonEvent e) {
//				Iterator<BaseModel> itBm = YetaT73012GridPanel.getMsfGrid().getGrid().getSelectionModel().getSelectedItems().listIterator();
...
//				
		...
		btnYetaSave.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				setListRecord(YetaT73012GridPanel.getMsfGrid().getStore().getModifiedRecords().iterator());
				doAction(actionDatabase);
...
//				
		cpYetaT73012.add(topYetaBtnBar);
...
//		YetaT73012GridPanel = new MSFGridPanel(YetaT73012Def, false, false, false, false, false);
//		YetaT73012GridPanel.setSize("790px", "420px");
//		YetaT73012GridPanel.setBorders(true);
//		YetaT73012GridPanel.setHeaderVisible(false);
...
//		
//		YetaT73012GridPanel.getGrid().getColumnModel().addAggregationRow(payrSummaryRow);  
//		
...
//		
//		YetaT73012GridPanel.getGrid().getColumnModel().addAggregationRow(payrSummaryRow1);
//		/** --- 그리드 합계 부분  종료 --- **/
		
//        cpYetaT73012.add(YetaT73012GridPanel);
...
//		layoutContainer7.setStyleAttribute("marginBottom", "5px")
		...
		cpYetaT73012.add(fldstNewFieldset_1);
		cpYetaT73012.add(fldstNewFieldset_4);
	...
	public void reload() {
			...
			YetaT73012GridPanel.getTableDef().setTableColumnFilters(filters);
			YetaT73012GridPanel.getTableDef().addColumnFilter("yrtxBlggYr", MSFSharedUtils.allowNulls(srhYrtxBlggYr.getValue())
...
//					, SimpleColumnFilter.OPERATOR_EQUALS);//연말정산귀속년도
			YetaT73012GridPanel.getTableDef().addColumnFilter("clutSeptCd", MSFSharedUtils.getSelectedComboValue(srhClutSeptCd,"commCd")
					, SimpleColumnFilter.OPERATOR_EQUALS);//정산구분
			YetaT73012GridPanel.getTableDef().addColumnFilter("systemkey", MSFSharedUtils.allowNulls(systemkey.getValue())
					, SimpleColumnFilter.OPERATOR_EQUALS);//시스템키
		 
			YetaT73012GridPanel.reload();
