...
public class YetaT13005Def extends TableDef implements YetaDaoConstants{
	private int row = 0;
	final PrgmComBass0300DTO sysComBass0300Dto;
	
	public YetaT13005Def(String chkDef) {
		
		sysComBass0300Dto = new PrgmComBass0300DTO();
		
		if("YetaT13005".equals(chkDef)) { //TODO 테이블 정의되면 다시 구현.
			setTitle("");
	        setDaoClass("");
		    ...
		    setColumnsDefinition(getColumnsListYetaT13005()); 
		}else {
...
//	        setCustomListMethod(CLASS_YETA0100_LIST);
	...
	private List<ColumnDef> getColumnsListYetaT13005() { //TODO BM 다시 정의.
        List<ColumnDef> listColumnDefs = new ArrayList<ColumnDef>();
        ...
        listColumnDefs.add(new ColumnDef("항목명", YetaT13001BM.ATTR_MNTHRNTTYBURRGSUM, ColumnDef.TYPE_STRING , 140, true, true, true){
        	{

        	}
        });
        /** column 기지급(급여) : mnthRnttyHusFrmCd */
        listColumnDefs.add(new ColumnDef("기지급(급여)", YetaT13001BM.ATTR_MNTHRNTTYHUSFRMCD, ColumnDef.TYPE_STRING , 140, true, true, true){
        	{

        	}
        });
        /** column 기지급(종전) : mnthRnttyHusFrmNm */
        listColumnDefs.add(new ColumnDef("기지급(종전)", YetaT13001BM.ATTR_MNTHRNTTYHUSFRMNM, ColumnDef.TYPE_STRING , 140, true, true, true){
        	{

        	}
        });
        /** column 과세전환금 : mnthRnttyHusCnttArea */
        listColumnDefs.add(new ColumnDef("과세전환금", YetaT13001BM.ATTR_MNTHRNTTYHUSCNTTAREA, ColumnDef.TYPE_STRING , 140, true, true, true){
        	{
