...
//    private YetaConstants yetaLabel = YetaConstants.INSTANCE;
	...
	public Ye161040Def(String chkPayrDef) {
		...
		// 국세청 자료
		if ("YETA230001".equals(chkPayrDef)) {

			setDaoClass("");
			setCustomListMethod(CLASS_YETA2300_TO_YE161040_DATA_LIST);
			setAutoFillGrid(false);
			setShowFilterToolbar(false);
			setCheckBoxOnGridRows(true);
			setEditableGrid(true);
			setEditFieldGrid(true);
			setColumnsDefinition(getYeta23000ToYe161040ColumnsList01());
          
       // 기타자료
      }else if("YETA230002".equals(chkPayrDef)) {
			...
			setEditableGrid(true);
			setEditFieldGrid(true);
			setColumnsDefinition(getYeta23000ToYe161040ColumnsList02());
	...
	/** 국세청 자료 **/
	private List<ColumnDef> getYeta23000ToYe161040ColumnsList01() {
...
//        listColumnDefs.add(new ColumnDef("구분", Ye161040BM.ATTR_HEADER, ColumnDef.TYPE_STRING, 30, true, true, true));
        ...
        /** column 신용카드_전통대중제외금액 : crdcDdcTrgtAmt */
        listColumnDefs.add(new ColumnDef("신용카드_전통대중제외금액", Ye161040BM.ATTR_CRDCDDCTRGTAMT, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 직불카드등_전통대중제외금액 : drtpCardDdcTrgtAmt */
        listColumnDefs.add(new ColumnDef("직불카드등_전통대중제외금액", Ye161040BM.ATTR_DRTPCARDDDCTRGTAMT, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 현금영수증_전통대중제외금액 : cshptDdcTrgtAmt */
        listColumnDefs.add(new ColumnDef("현금영수증_전통대중제외금액", Ye161040BM.ATTR_CSHPTDDCTRGTAMT, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{
	...
	/** 기타 자료 **/
	private List<ColumnDef> getYeta23000ToYe161040ColumnsList02() {
