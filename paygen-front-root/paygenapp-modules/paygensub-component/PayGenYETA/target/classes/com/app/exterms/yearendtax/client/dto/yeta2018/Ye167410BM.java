 ...
 */
public class Ye167410BM   extends MSFSimpleBaseModel implements IsSerializable  {
    ...
    /** set 주소 : adr */
    public static final String ATTR_ADR = "adr";

    /** set 사업장소재지 : pfbAdr */
    public static final String ATTR_PFBADR = "pfbAdr";
    ...
    /** 일괄등록 처리   */
     public Ye167410BM(
     	...
     	values.put(ATTR_ADR,adr);
     	values.put(ATTR_PFBADR,pfbAdr);
    ...
    /** set 주소 : adr */
    public void setAdr(String  adr) { set( ATTR_ADR ,adr);}
    /** get 주소 : adr */
    public String  getAdr() { return (String )get( ATTR_ADR );}

    /** set 사업장소재지 : pfbAdr */
    public void setPfbAdr(String  pfbAdr) { set( ATTR_PFBADR ,pfbAdr);}
    /** get 사업장소재지 : pfbAdr */
    public String  getPfbAdr() { return (String )get( ATTR_PFBADR );}
