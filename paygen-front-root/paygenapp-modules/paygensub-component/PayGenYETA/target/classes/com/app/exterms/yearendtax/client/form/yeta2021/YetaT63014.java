...
import com.app.exterms.yearendtax.client.service.yeta2021.YetaT63014Service;
import com.app.exterms.yearendtax.client.service.yeta2021.YetaT63014ServiceAsync;
...
//import com.app.exterms.yearendtax.client.form.defs.yeta2016.YetaT63014Def;
/**====================================================
디자인화면 수정시 extends 부분을 다음과 같이 수정하여 사용한 후 다시 원복한다.
extends MSFPanel ->  extends LayoutContainer  implements IMSFWindow { 
상속받아 소스를 구현한 경우에는 에러나는 부분을 수정하여 처리 해야함.
=====================================================**/
public  class YetaT63014   extends MSFFormPanel {  
 ...
 **/
	...
	private  ContentPanel cpYetaT63014; 
	...
	// -------------- grid 선언 시작  ---------------	  
	private MSFGridPanel YetaT63014GridPanel;
//	private YetaT63014Def YetaT63014Def = new YetaT63014Def("YetaT63014");   //TODO 일단 화면번호로 Def
	// -------------- grid 선언 종료  ---------------
	...
	// -------------- 서비스 호출 시작 --------------
	private YetaT63014ServiceAsync yetaT63014Service = YetaT63014Service.Util.getInstance();
	// -------------- 서비스 호출 종료 --------------	 
...
//					ye162510Dto.setMnthRnttyHusCnttArea((MSFSharedUtils.allowNulls(bmMapModel.get("mnthRnttyHusCnttArea"))));    		/** column 월세주택계약면적 : mnthRnttyHusCnttArea */
				...
				yetaT63014Service.activityOnYetaT63014(listYe162510Dto, actionDatabase, new AsyncCallback<Long>(){
...
//		 }
	...
	public YetaT63014(final ActionDatabase actionDatabase, final MSFPanel caller) {
...
//		initLoad(); 	
		...
		this.actionDatabase = actionDatabase;
	 	...
	 	cpYetaT63014 = new ContentPanel();  

		createSearchForm();			//기본정보 필드를 적용
	 	createMsfGridForm();		//그리드필드
		   
		cpYetaT63014.setBodyBorder(false);
		cpYetaT63014.setBorders(false);
		cpYetaT63014.setHeaderVisible(false);
		cpYetaT63014.setSize("790px", "640px");
		   
		this.add(cpYetaT63014);
...
//		     });     
		...
		cpYetaT63014.setLayout(new FlowLayout());
...
//	      	     }
//				 
//				YetaT63014GridPanel.getMsfGrid().clearData();
//				 
//				BaseModel bmData = YetaT63014GridPanel.getTableDef().getDefaultValues();  
//		              
...
//		         
//		        YetaT63014GridPanel.getMsfGrid().getGrid().stopEditing();      
//		        YetaT63014GridPanel.getMsfGrid().getGrid().getStore().insert(bmData,0);   
//		        YetaT63014GridPanel.getMsfGrid().getGrid().startEditing(YetaT63014GridPanel.getMsfGrid().getGrid().getStore().indexOf(bmData), 0);   
//
...
//			public void handleEvent(ButtonEvent e) {
//				Iterator<BaseModel> itBm = YetaT63014GridPanel.getMsfGrid().getGrid().getSelectionModel().getSelectedItems().listIterator();
...
//			public void handleEvent(ButtonEvent e) {
//				setListRecord(YetaT63014GridPanel.getMsfGrid().getStore().getModifiedRecords().iterator());
//				doAction(actionDatabase);
//
//				if ((ActionDatabase.INSERT).equals(actionDatabase)) {
//					actionDatabase = ActionDatabase.INSERT;
...
//			topYetaBtnBar.add(btnYetaClose);
		...
		cpYetaT63014.add(topYetaBtnBar);
...
//		YetaT63014GridPanel = new MSFGridPanel(YetaT63014Def, false, false, false, false, false);
//		YetaT63014GridPanel.setSize("790px", "420px");
//		YetaT63014GridPanel.setBorders(true);
//		YetaT63014GridPanel.setHeaderVisible(false);
//		
...
//		
//		YetaT63014GridPanel.getGrid().getColumnModel().addAggregationRow(payrSummaryRow);  
//		
...
//		
//		YetaT63014GridPanel.getGrid().getColumnModel().addAggregationRow(payrSummaryRow1);
//		/** --- 그리드 합계 부분  종료 --- **/
		
//        cpYetaT63014.add(YetaT63014GridPanel);
...
//		layoutContainer.add(fldstNewFieldset_1);
		...
		cpYetaT63014.add(fieldSet1);
		cpYetaT63014.add(fieldSet2);
		cpYetaT63014.add(fldstNewFieldset_1);
	...
	public void reload() {
			...
			YetaT63014GridPanel.getTableDef().setTableColumnFilters(filters);
			YetaT63014GridPanel.getTableDef().addColumnFilter("yrtxBlggYr", MSFSharedUtils.allowNulls(srhYrtxBlggYr.getValue())
...
//					, SimpleColumnFilter.OPERATOR_EQUALS);//연말정산귀속년도
			YetaT63014GridPanel.getTableDef().addColumnFilter("clutSeptCd", MSFSharedUtils.getSelectedComboValue(srhClutSeptCd,"commCd")
					, SimpleColumnFilter.OPERATOR_EQUALS);//정산구분
			YetaT63014GridPanel.getTableDef().addColumnFilter("systemkey", MSFSharedUtils.allowNulls(systemkey.getValue())
					, SimpleColumnFilter.OPERATOR_EQUALS);//시스템키
		 
			YetaT63014GridPanel.reload();
