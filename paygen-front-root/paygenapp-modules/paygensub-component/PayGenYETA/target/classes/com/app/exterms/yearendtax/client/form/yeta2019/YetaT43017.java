...
=====================================================**/
public  class YetaT43017   extends MSFFormPanel {  
	...
	private  ContentPanel cpYetaT43017; 
	...
	// -------------- grid 선언 시작  ---------------	  
	private MSFGridPanel YetaT43017GridPanel;
	//	private YetaT43017Def YetaT43017Def = new YetaT43017Def("YetaT43017");   //TODO 일단 화면번호로 Def
	// -------------- grid 선언 종료  ---------------
	...
	public YetaT43017(final ActionDatabase actionDatabase, final MSFPanel caller) {
		...
		cpYetaT43017 = new ContentPanel();  

		createSearchForm();			//기본정보 필드를 적용
		createMsfGridForm();		//그리드필드
		setReadOnlyTrueYetaP23017();

		cpYetaT43017.setBodyBorder(false);
		cpYetaT43017.setBorders(false);
		cpYetaT43017.setHeaderVisible(false);
		cpYetaT43017.setSize("630px", "640px");

		this.add(cpYetaT43017);
	...
	private void createMsfGridForm() {
		...
		cpYetaT43017.add(layoutContainer1);
		cpYetaT43017.add(layoutContainer2);
		cpYetaT43017.add(layoutContainer3);
		cpYetaT43017.add(layoutContainer4);
		cpYetaT43017.add(layoutContainer5);
		cpYetaT43017.add(layoutContainer6);
		cpYetaT43017.add(layoutContainer7);
		cpYetaT43017.add(layoutContainer8);
		cpYetaT43017.add(layoutContainer9);
	}	
