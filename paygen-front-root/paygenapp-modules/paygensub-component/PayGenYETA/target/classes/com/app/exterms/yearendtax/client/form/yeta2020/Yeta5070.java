...
import com.app.exterms.yearendtax.client.form.defs.yeta2020.Yeta5070Def;
import com.app.exterms.yearendtax.client.service.yeta2020.Yeta5070Service;
import com.app.exterms.yearendtax.client.service.yeta2020.Yeta5070ServiceAsync;
...
=====================================================**/
public class Yeta5070  extends MSFPanel { 
	...
	private FormPanel plFrmYeta5070;
	private FormData formData; 
	private String txtForm = "";
	private XTemplate detailTp;	  
	private Yeta5070ServiceAsync Yeta5070service = Yeta5070Service.Util.getInstance(); 
	...
	private Yeta5070Def Yeta5070MSDef = new Yeta5070Def("Yeta5070MS");
	private InfcPkgBass0150Def Yeta5070ToBass0150Def = new InfcPkgBass0150Def("yeta5070ToBass0150");
	private InfcPkgBass0500Def Yeta5070ToBass0500OnDef = new InfcPkgBass0500Def("YETA5070_BASS0500_ON");
	private InfcPkgBass0500Def Yeta5070ToBass0500OffDef = new InfcPkgBass0500Def("YETA5070_BASS0500_OFF");

	private MSFGridPanel msfGridPanelYeta5070MS; 
	...
	public ContentPanel getViewPanel() {
		if (panel == null) {        	
			...
			msfGridPanelYeta5070MS.reload();
			msfGridPanelBass0150.reload();

			//			final RelationDef  relBass0360 = new RelationDef(Yeta5070MSDef,false);
			//			relBass0360.addJoinDef("utDpobCd", "utDpobCd"); 
			//			relBass0360.setLinkedObject(msfGridPanelYeta5070MS);
			//			Yeta5070ToBass0500OnDef.addRelation(relBass0360); 
			//
			//			/**
			//			 * Create the relations 
			//			 */
			//			final RelationDef  relBass0350 = new RelationDef(Yeta5070MSDef,false);
			//			relBass0350.addJoinDef("utDpobCd", "utDpobCd"); 
			//			relBass0350.setLinkedObject(msfGridPanelYeta5070MS);
			//			Yeta5070ToBass0500OffDef.addRelation(relBass0350); 
			//
			//
			//			// DETAILS 
			//			final Grid Yeta5070ToBass0500OffDefGrid = msfGridPanelYeta5070MS.getMsfGrid().getGrid();
			//			Yeta5070ToBass0500OffDefGrid.addListener(Events.CellDoubleClick, new Listener<BaseEvent>() {
			//				public void handleEvent(BaseEvent be) {  
			//					if (msfGridPanelYeta5070MS.getCurrentlySelectedItem() != null) {  
			//
			//						Yeta5070ToBass0500OnDef.synchronizeGridDetail(
			//								msfGridPanelYeta5070MS.getCurrentlySelectedItem(),
			//								msfGridPanelBass0500On );
			//
			//						Yeta5070ToBass0500OffDef.synchronizeGridDetail(
			//								msfGridPanelYeta5070MS.getCurrentlySelectedItem(),
	...
	public Yeta5070(String txtForm) {
		this.txtForm = txtForm;
	}		  

	private void createSysm0500Form() {

		plFrmYeta5070 = new FormPanel();
		plFrmYeta5070.setHeadingText("PayGen Ver1.0 - 단위사업장사업관리");
		plFrmYeta5070.setIcon(Resources.APP_ICONS.text());
		plFrmYeta5070.setBodyStyleName("pad-text");
		plFrmYeta5070.setFrame(true); 
		plFrmYeta5070.setPadding(2);
		/************************************************************************
		...
		btnlogView.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				//로그 뷰화면 호출 메서드 
				funcLogMessage("단위사업장사업관리","Yeta5070");
			}
		});
		plFrmYeta5070.getHeader().setStyleAttribute("padding", "5px 0 2px 0");
		plFrmYeta5070.getHeader().addTool(btnlogView); 
		/************************************************************************
		...
		Yeta5070MSDef.setReadOnly(true);   
		msfGridPanelYeta5070MS = new MSFGridPanel(Yeta5070MSDef, false, false, false, false,false); 
		msfGridPanelYeta5070MS.setSize(350, 620);
		msfGridPanelYeta5070MS.setBorders(true);
		msfGridPanelYeta5070MS.getGrid().setBorders(true);
		Grid grid = msfGridPanelYeta5070MS.getMsfGrid().getGrid();
		grid.addListener(Events.CellDoubleClick , new Listener<BaseEvent>() {
			public void handleEvent(BaseEvent be) {

				untDpobCd = MSFSharedUtils.allowNulls(msfGridPanelYeta5070MS.getMsfGrid().getCurrentlySelectedItem().get("utDpobCd"));

				OnReload(untDpobCd);
				OffReload();
			}					
		});
		inner.add(msfGridPanelYeta5070MS);

		msfGridPanelBass0150 = new MSFGridPanel(Yeta5070ToBass0150Def, false, false, false, false, false); 
		msfGridPanelBass0150.setSize(600, 200);
		msfGridPanelBass0150.setBorders(true);
		msfGridPanelBass0150.getGrid().setBorders(true);

		// 두번째 컨테이너컬럼(사용사업정보)   
		msfGridPanelBass0500On = new MSFGridPanel(Yeta5070ToBass0500OnDef, false, false, false, false, false); 
		...
		// 세번째 컨테이너컬럼(미사용사업정보)  
		msfGridPanelBass0500Off = new MSFGridPanel(Yeta5070ToBass0500OffDef, false, false, false, false,false); 
		...
		plFrmYeta5070.add(srhOffDeptCd);
			...
			public void componentSelected(ButtonEvent ce) {  
				...
				while (iterRecords.hasNext()) {	    		            	  
					...
					if ((Boolean)bmMapModel.get("select")) {
						...
						pkgBass0500Dto.setUntDpobCd(MSFSharedUtils.allowNulls(msfGridPanelYeta5070MS.getMsfGrid().getCurrentlySelectedItem().get("utDpobCd")));
		...
		plFrmYeta5070.add(inner);

		vp.add(plFrmYeta5070);
		plFrmYeta5070.setSize("990px", "680px");
	}	

	private Yeta5070 getThis(){
		return this;
	}
