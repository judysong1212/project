 ...
 */
public class PdfC301yBM   extends MSFSimpleBaseModel implements IsSerializable  {
    ...
    /** set 교육비학교명 : schNm */
    public static final String ATTR_SCHNM = "schNm";

    /** set 교육비납입금액합계 : schUniSum */
    public static final String ATTR_SCHUNISUM = "schUniSum";
    ...
    /** 일괄등록 처리   */
     public PdfC301yBM(
     	...
     	values.put(ATTR_SCHNM,schNm);
     	values.put(ATTR_SCHUNISUM,schUniSum);
    ...
    /** set 교육비_교복구입일련번호 : schUniSeilNum */
    public void setSchUniSeilNum(Long  schUniSeilNum) { set( ATTR_SCHUNISEILNUM ,schUniSeilNum);}
    /** get 교육비_교복구입일련번호 : schUniSeilNum */
    public Long  getSchUniSeilNum() { return (Long )get( ATTR_SCHUNISEILNUM );}
    ...
    /** set 교육비학교명 : schNm */
    public void setSchNm(String  schNm) { set( ATTR_SCHNM ,schNm);}
    /** get 교육비학교명 : schNm */
    public String  getSchNm() { return (String )get( ATTR_SCHNM );}

    /** set 교육비납입금액합계 : schUniSum */
    public void setSchUniSum(Long  schUniSum) { set( ATTR_SCHUNISUM ,schUniSum);}
    /** get 교육비납입금액합계 : schUniSum */
    public Long  getSchUniSum() { return (Long )get( ATTR_SCHUNISUM );}
