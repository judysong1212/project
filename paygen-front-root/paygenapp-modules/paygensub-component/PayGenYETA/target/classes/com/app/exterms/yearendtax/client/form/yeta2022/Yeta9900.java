...
//				fieldSet_2.add(lcSchCol2, new FormData("100%"));	
		    	...
		    	layoutContainer_1.setLayout(new HBoxLayout()); 
		     	...
		     	btnYetat13019.addListener(Events.Select, new Listener<ButtonEvent>() {
		     		public void handleEvent(ButtonEvent e) {
						  //전체내역  
						  YetaT73019 yetaT73019Form = new YetaT73019(ActionDatabase.READ, getThis());   
								    
						  MSFFormWindows msFwYetaT73019 = new MSFFormWindows("월세액세액공제명세", yetaT73019Form, "닫기", "820px", "710px", true);
						  msFwYetaT73019.show();
						  yetaT73019Form.setMSFFormWindows(msFwYetaT73019);
						  
						  funcSetPopUpRecord();
						  //TODO 추후 주석해제 
						  yetaT73019Form.bind(ppRecord); 
					  }
		    	});
		    	...
		    	btnYetat13001.addListener(Events.Select, new Listener<ButtonEvent>() {
		    		public void handleEvent(ButtonEvent e) {
						  //전체내역  
						  YetaT73001 yetaT73001Form = new YetaT73001(ActionDatabase.READ, getThis());   
								    
						  MSFFormWindows msFwYetaT73001 = new MSFFormWindows("비과세및감면소득", yetaT73001Form, "닫기", "820px", "710px", true);
						  msFwYetaT73001.show();
						  yetaT73001Form.setMSFFormWindows(msFwYetaT73001);
						  
						  funcSetPopUpRecord();
						  //TODO 추후 주석해제 
						  yetaT73001Form.bind(ppRecord); 
					  }
		    	}); 
		    	...
		    	btnYetat13002.addListener(Events.Select, new Listener<ButtonEvent>() {
		    		public void handleEvent(ButtonEvent e) {
						  //전체내역  
						  YetaT73002 yetaT73002Form = new YetaT73002(ActionDatabase.READ, getThis());   
								    
						  MSFFormWindows msFwYetaT73002 = new MSFFormWindows("연금보험료", yetaT73002Form, "닫기", "700px", "710px", true);
						  msFwYetaT73002.show();
						  yetaT73002Form.setMSFFormWindows(msFwYetaT73002);
						  
						  funcSetPopUpRecord();
						  //TODO 추후 주석해제 
						  yetaT73002Form.bind(ppRecord); 
					  }
		    	}); 
		    	...
		    	btnYetat13003.addListener(Events.Select, new Listener<ButtonEvent>() {
		    		public void handleEvent(ButtonEvent e) {
						  //전체내역  
						  YetaT73003 yetaT73003Form = new YetaT73003(ActionDatabase.READ, getThis());   
								    
						  MSFFormWindows msFwYetaT73003 = new MSFFormWindows("보험료(부양가족)", yetaT73003Form, "닫기", "700px", "750px", true);
						  msFwYetaT73003.show();
						  yetaT73003Form.setMSFFormWindows(msFwYetaT73003);
						  
						  funcSetPopUpRecord();
						  //TODO 추후 주석해제 
						  yetaT73003Form.bind(ppRecord); 
					  }
		    	}); 
		    	...
		    	btnYetat13004.addListener(Events.Select, new Listener<ButtonEvent>() {
		    		public void handleEvent(ButtonEvent e) {
						  //전체내역  
						  YetaT73004 yetaT73004Form = new YetaT73004(ActionDatabase.READ, getThis());   
								    
						  MSFFormWindows msFwYetaT73004 = new MSFFormWindows("주택임차차입금원리금상환액", yetaT73004Form, "닫기", "820px", "710px", true);
						  msFwYetaT73004.show();
						  yetaT73004Form.setMSFFormWindows(msFwYetaT73004);
						  
						  funcSetPopUpRecord();
						  //TODO 추후 주석해제 
						  yetaT73004Form.bind(ppRecord); 
					  }
		    	}); 
		    	...
		    	btnYetat13005.addListener(Events.Select, new Listener<ButtonEvent>() {
		    		public void handleEvent(ButtonEvent e) {
						  //전체내역  
						  YetaT73005 yetaT73005Form = new YetaT73005(ActionDatabase.READ, getThis());   
								    
						  MSFFormWindows msFwYetaT73005 = new MSFFormWindows("장기주택저당차입금이자상환액", yetaT73005Form, "닫기", "450px", "710px", true);
						  msFwYetaT73005.show();
						  yetaT73005Form.setMSFFormWindows(msFwYetaT73005);
						  
						  funcSetPopUpRecord();
						  //TODO 추후 주석해제 
						  yetaT73005Form.bind(ppRecord); 
					  }
		    	}); 
		    	...
		    	btnYetat13006.addListener(Events.Select, new Listener<ButtonEvent>() {
		    		public void handleEvent(ButtonEvent e) {
						  //전체내역  
						  YetaT73006 yetaT73006Form = new YetaT73006(ActionDatabase.READ, getThis());   
								    
						  MSFFormWindows msFwYetaT73006 = new MSFFormWindows("개인연금저축불입액", yetaT73006Form, "닫기", "820px", "710px", true);
						  msFwYetaT73006.show();
						  yetaT73006Form.setMSFFormWindows(msFwYetaT73006);
						  
						  funcSetPopUpRecord();
						  //TODO 추후 주석해제 
						  yetaT73006Form.bind(ppRecord); 
					  }
		    	}); 
		    	...
		    	btnYetat13007.addListener(Events.Select, new Listener<ButtonEvent>() {
		    		public void handleEvent(ButtonEvent e) {
						  //전체내역  
						  YetaT73007 yetaT73007Form = new YetaT73007(ActionDatabase.READ, getThis());   
								    
						  MSFFormWindows msFwYetaT73007 = new MSFFormWindows("주택마련저축", yetaT73007Form, "닫기", "820px", "710px", true);
						  msFwYetaT73007.show();
						  yetaT73007Form.setMSFFormWindows(msFwYetaT73007);
						  
						  funcSetPopUpRecord();
						  //TODO 추후 주석해제 
						  yetaT73007Form.bind(ppRecord); 
					  }
		    	}); 
		    	...
		    	btnYetat13008.addListener(Events.Select, new Listener<ButtonEvent>() {
		    		public void handleEvent(ButtonEvent e) {
						  //전체내역  
						  YetaT73008 yetaT73008Form = new YetaT73008(ActionDatabase.READ, getThis());   
								    
						  MSFFormWindows msFwYetaT73008 = new MSFFormWindows("중소기업창업투자조합출자등", yetaT73008Form, "닫기", "600px", "710px", true);
						  msFwYetaT73008.show();
						  yetaT73008Form.setMSFFormWindows(msFwYetaT73008);
						  
						  funcSetPopUpRecord();
						  //TODO 추후 주석해제 
						  yetaT73008Form.bind(ppRecord); 
					  }
		    	}); 
		    	...
		    	btnYetat13009.addListener(Events.Select, new Listener<ButtonEvent>() {
		    		public void handleEvent(ButtonEvent e) {
						  //전체내역  
						  YetaT73009 yetaT73009Form = new YetaT73009(ActionDatabase.READ, getThis());   
								    
						  MSFFormWindows msFwYetaT73009 = new MSFFormWindows("신용카드등", yetaT73009Form, "닫기", "600px", "710px", true);
						  msFwYetaT73009.show();
						  yetaT73009Form.setMSFFormWindows(msFwYetaT73009);
						  
						  funcSetPopUpRecord();
						  //TODO 추후 주석해제 
						  yetaT73009Form.bind(ppRecord); 
					  }
		    	}); 
		    	...
		    	btnYetat13010.addListener(Events.Select, new Listener<ButtonEvent>() {
		    		public void handleEvent(ButtonEvent e) {
						  //전체내역  
						  YetaT73010 yetaT73010Form = new YetaT73010(ActionDatabase.READ, getThis());   
								    
						  MSFFormWindows msFwYetaT73010 = new MSFFormWindows("장기집합투자증권저축", yetaT73010Form, "닫기", "820px", "710px", true);
						  msFwYetaT73010.show();
						  yetaT73010Form.setMSFFormWindows(msFwYetaT73010);
						  
						  funcSetPopUpRecord();
						  //TODO 추후 주석해제 
						  yetaT73010Form.bind(ppRecord); 
					  }
		    	}); 
		    	...
		    	btnYetat13011.addListener(Events.Select, new Listener<ButtonEvent>() {
		    		public void handleEvent(ButtonEvent e) {
						  //전체내역  
						  YetaT73011 yetaT73011Form = new YetaT73011(ActionDatabase.READ, getThis());   
								    
						  MSFFormWindows msFwYetaT73011 = new MSFFormWindows("외국인근로자감면세액", yetaT73011Form, "닫기", "820px", "710px", true);
						  msFwYetaT73011.show();
						  yetaT73011Form.setMSFFormWindows(msFwYetaT73011);
						  
						  funcSetPopUpRecord();
						  //TODO 추후 주석해제 
						  yetaT73011Form.bind(ppRecord); 
					  }
		    	}); 
		    	...
		    	btnYetat13012.addListener(Events.Select, new Listener<ButtonEvent>() {
		    		public void handleEvent(ButtonEvent e) {
						  //전체내역  
						  YetaT73012 yetaT73012Form = new YetaT73012(ActionDatabase.READ, getThis());   
								    
						  MSFFormWindows msFwYetaT73012 = new MSFFormWindows("중소기업취업자세액감면", yetaT73012Form, "닫기", "450px", "710px", true);
						  msFwYetaT73012.show();
						  yetaT73012Form.setMSFFormWindows(msFwYetaT73012);
						  
						  funcSetPopUpRecord();
						  //TODO 추후 주석해제 
						  yetaT73012Form.bind(ppRecord); 
					  }
		    	}); 
		    	...
		    	btnYetat13013.addListener(Events.Select, new Listener<ButtonEvent>() {
		    		public void handleEvent(ButtonEvent e) {
						  //전체내역  
						  YetaT73013 yetaT73013Form = new YetaT73013(ActionDatabase.READ, getThis());   
								    
						  MSFFormWindows msFwYetaT73013 = new MSFFormWindows("연금계좌불입액", yetaT73013Form, "닫기", "820px", "710px", true);
						  msFwYetaT73013.show();
						  yetaT73013Form.setMSFFormWindows(msFwYetaT73013);
						  
						  funcSetPopUpRecord();
						  //TODO 추후 주석해제 
						  yetaT73013Form.bind(ppRecord); 
					  }
		    	}); 
		    	...
		    	btnYetat13014.addListener(Events.Select, new Listener<ButtonEvent>() {
		    		public void handleEvent(ButtonEvent e) {
						  //전체내역  
						  YetaT73014 yetaT73014Form = new YetaT73014(ActionDatabase.READ, getThis());   
								    
						  MSFFormWindows msFwYetaT73014 = new MSFFormWindows("교육비", yetaT73014Form, "닫기", "350px", "300px", true);
						  msFwYetaT73014.show();
						  yetaT73014Form.setMSFFormWindows(msFwYetaT73014);
						  
						  funcSetPopUpRecord();
						  //TODO 추후 주석해제 
						  yetaT73014Form.bind(ppRecord); 
					  }
		    	}); 
		    	...
		    	btnYetat13015.addListener(Events.Select, new Listener<ButtonEvent>() {
		    		public void handleEvent(ButtonEvent e) {
						  //전체내역  
						  YetaT73015 yetaT73015Form = new YetaT73015(ActionDatabase.READ, getThis());   
								    
						  MSFFormWindows msFwYetaT73015 = new MSFFormWindows("교육비지출액", yetaT73015Form, "닫기", "550px", "710px", true);
						  msFwYetaT73015.show();
						  yetaT73015Form.setMSFFormWindows(msFwYetaT73015);
						  
						  funcSetPopUpRecord();
						  //TODO 추후 주석해제 
						  yetaT73015Form.bind(ppRecord); 
					  }
		    	}); 
		    	...
		    	btnYetat13016.addListener(Events.Select, new Listener<ButtonEvent>() {
		    		public void handleEvent(ButtonEvent e) {
						  //전체내역  
						  YetaT73016 yetaT73016Form = new YetaT73016(ActionDatabase.READ, getThis());   
								    
						  MSFFormWindows msFwYetaT73016 = new MSFFormWindows("기부금", yetaT73016Form, "닫기", "600px", "710px", true);
						  msFwYetaT73016.show();
						  yetaT73016Form.setMSFFormWindows(msFwYetaT73016);
						  
						  funcSetPopUpRecord();
						  //TODO 추후 주석해제 
						  yetaT73016Form.bind(ppRecord); 
					  }
		    	}); 
		    	...
		    	btnYetat13017.addListener(Events.Select, new Listener<ButtonEvent>() {
		    		public void handleEvent(ButtonEvent e) {
						  ...
						  MSFFormWindows msFwYetaT73017 = new MSFFormWindows("표준세액공제", yetaT73017Form, "닫기", "600px", "710px", true);
						  msFwYetaT73017.show();
		    	...
		    	btnYetat13018.addListener(Events.Select, new Listener<ButtonEvent>() {
		    		public void handleEvent(ButtonEvent e) {
						  //전체내역  
						  YetaT73018 yetaT73018Form = new YetaT73018(ActionDatabase.READ, getThis());   
								    
						  MSFFormWindows msFwYetaT73018 = new MSFFormWindows("외국인납부세액", yetaT73018Form, "닫기", "600px", "710px", true);
						  msFwYetaT73018.show();
						  yetaT73018Form.setMSFFormWindows(msFwYetaT73018);
						  
						  funcSetPopUpRecord();
						  //TODO 추후 주석해제 
						  yetaT73018Form.bind(ppRecord); 
					  }
		    	}); 
