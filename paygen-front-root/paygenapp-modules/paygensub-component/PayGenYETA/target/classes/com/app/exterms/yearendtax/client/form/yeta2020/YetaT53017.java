...
=====================================================**/
public  class YetaT53017   extends MSFFormPanel {  
	...
	private  ContentPanel cpYetaT53017; 
	...
	// -------------- grid 선언 시작  ---------------	  
	private MSFGridPanel YetaT53017GridPanel;
	//	private YetaT53017Def YetaT53017Def = new YetaT53017Def("YetaT53017");   //TODO 일단 화면번호로 Def
	// -------------- grid 선언 종료  ---------------
	...
	public YetaT53017(final ActionDatabase actionDatabase, final MSFPanel caller) {
		...
		cpYetaT53017 = new ContentPanel();  

		createSearchForm();			//기본정보 필드를 적용
		createMsfGridForm();		//그리드필드
		setReadOnlyTrueYetaP23017();

		cpYetaT53017.setBodyBorder(false);
		cpYetaT53017.setBorders(false);
		cpYetaT53017.setHeaderVisible(false);
		cpYetaT53017.setSize("630px", "640px");

		this.add(cpYetaT53017);
	...
	private void createMsfGridForm() {
		...
		cpYetaT53017.add(layoutContainer1);
		cpYetaT53017.add(layoutContainer2);
		cpYetaT53017.add(layoutContainer3);
		cpYetaT53017.add(layoutContainer4);
		cpYetaT53017.add(layoutContainer5);
		cpYetaT53017.add(layoutContainer6);
		cpYetaT53017.add(layoutContainer7);
		cpYetaT53017.add(layoutContainer8);
		cpYetaT53017.add(layoutContainer9);
	}	
