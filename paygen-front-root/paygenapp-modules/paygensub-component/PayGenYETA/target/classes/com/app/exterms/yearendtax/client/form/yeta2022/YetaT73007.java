...
import com.app.exterms.yearendtax.client.form.defs.yeta2022.Ye162030Def;
import com.app.exterms.yearendtax.client.service.yeta2022.YetaT73007Service;
import com.app.exterms.yearendtax.client.service.yeta2022.YetaT73007ServiceAsync;
...
=====================================================**/
public  class YetaT73007   extends MSFFormPanel {  
 ...
 **/
	...
	private  ContentPanel cpYetaT73007; 
	...
	// -------------- grid 선언 시작  ---------------	  
	private MSFGridPanel YetaT73007GridPanel;
	private Ye162030Def ye162030Def = new Ye162030Def("YetaT73007");   
	...
	// -------------- 서비스 호출 시작 --------------
	private YetaT73007ServiceAsync yetaT73007Service = YetaT73007Service.Util.getInstance();
	// -------------- 서비스 호출 종료 --------------	 
...
//					ye162510Dto.setMnthRnttyHusCnttArea((MSFSharedUtils.allowNulls(bmMapModel.get("mnthRnttyHusCnttArea"))));    		/** column 월세주택계약면적 : mnthRnttyHusCnttArea */
				...
				yetaT73007Service.activityOnYetaT73007(listYe162510Dto, actionDatabase, new AsyncCallback<Long>(){
...
//		 }
	...
	public YetaT73007(final ActionDatabase actionDatabase, final MSFPanel caller) {
...
//		initLoad(); 	
		...
		this.actionDatabase = actionDatabase;
	 	...
	 	cpYetaT73007 = new ContentPanel();  

		createSearchForm();			//기본정보 필드를 적용
	 	createMsfGridForm();		//그리드필드
		   
		cpYetaT73007.setBodyBorder(false);
		cpYetaT73007.setBorders(false);
		cpYetaT73007.setHeaderVisible(false);
		cpYetaT73007.setSize("790px", "640px");
		   
		this.add(cpYetaT73007);
...
//		     });     
		...
		cpYetaT73007.setLayout(new FlowLayout());
...
//	      	     }
//				 
//				YetaT73007GridPanel.getMsfGrid().clearData();
//				 
//				BaseModel bmData = YetaT73007GridPanel.getTableDef().getDefaultValues();  
//		              
...
//		         
//		        YetaT73007GridPanel.getMsfGrid().getGrid().stopEditing();      
//		        YetaT73007GridPanel.getMsfGrid().getGrid().getStore().insert(bmData,0);   
//		        YetaT73007GridPanel.getMsfGrid().getGrid().startEditing(YetaT73007GridPanel.getMsfGrid().getGrid().getStore().indexOf(bmData), 0);   
//
...
//			public void handleEvent(ButtonEvent e) {
//				Iterator<BaseModel> itBm = YetaT73007GridPanel.getMsfGrid().getGrid().getSelectionModel().getSelectedItems().listIterator();
...
//			public void handleEvent(ButtonEvent e) {
//				setListRecord(YetaT73007GridPanel.getMsfGrid().getStore().getModifiedRecords().iterator());
//				doAction(actionDatabase);
//
//				if ((ActionDatabase.INSERT).equals(actionDatabase)) {
//					actionDatabase = ActionDatabase.INSERT;
...
//				
//		cpYetaT73007.add(topYetaBtnBar);
...
//		cpYetaT73007.add(topYetaBtnBar);
		...
		YetaT73007GridPanel = new MSFGridPanel(ye162030Def, false, false, false, false, false);
		YetaT73007GridPanel.setSize("790px", "200px");
		YetaT73007GridPanel.setBorders(true);
		YetaT73007GridPanel.setHeaderVisible(false);
...
//		
//		YetaT73007GridPanel.getGrid().getColumnModel().addAggregationRow(payrSummaryRow);  
//		
...
//		
//		YetaT73007GridPanel.getGrid().getColumnModel().addAggregationRow(payrSummaryRow1);
//		/** --- 그리드 합계 부분  종료 --- **/
		
//        cpYetaT73007.add(YetaT73007GridPanel);
...
//		cpYetaT73007.add(layoutContainer1);
//		cpYetaT73007.add(layoutContainer2);
		fldstNewFieldset.add(YetaT73007GridPanel);
		cpYetaT73007.add(fldstNewFieldset);
		cpYetaT73007.add(layoutContainer10);
		cpYetaT73007.add(fldstNewFieldset_1);
	...
	public void reload() {
			...
			YetaT73007GridPanel.getTableDef().setTableColumnFilters(filters);
			YetaT73007GridPanel.getTableDef().addColumnFilter("yrtxBlggYr", MSFSharedUtils.allowNulls(srhYrtxBlggYr.getValue())
...
//					, SimpleColumnFilter.OPERATOR_EQUALS);//연말정산귀속년도
			YetaT73007GridPanel.getTableDef().addColumnFilter("clutSeptCd", MSFSharedUtils.getSelectedComboValue(srhClutSeptCd,"commCd")
					, SimpleColumnFilter.OPERATOR_EQUALS);//정산구분
			YetaT73007GridPanel.getTableDef().addColumnFilter("systemkey", MSFSharedUtils.allowNulls(systemkey.getValue())
					, SimpleColumnFilter.OPERATOR_EQUALS);//시스템키
		 
			YetaT73007GridPanel.reload();
