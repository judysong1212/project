...
public interface Yeta6900ServiceAsync {
	
	
	public void saveYeta6900ToPyyt0302(List<Pyyt0302DTO> listPyyt0302Dto, String flag, AsyncCallback<Integer> callback);
	
	public void deleteYeta6900List(List<Pyyt0302DTO> listPyyt0302Dto, AsyncCallback<Integer> callback);
	
	public void Yeta6900InfoList(Pyyt0304DTO pyyt0304Dto, AsyncCallback<Pyyt0304BM> callback);
