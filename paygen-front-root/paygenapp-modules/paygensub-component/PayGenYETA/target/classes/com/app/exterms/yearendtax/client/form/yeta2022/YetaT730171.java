...
import com.app.exterms.yearendtax.client.service.yeta2022.YetaT73017ServiceAsync;
...
=====================================================**/
public  class YetaT730171  extends MSFFormPanel {  
	...
	private  ContentPanel cpYetaT730171; 
	...
	// -------------- 서비스 호출 시작 --------------
	private YetaT73017ServiceAsync yetaT73017Service = YetaT73017Service.Util.getInstance();
	// -------------- 서비스 호출 종료 --------------	 
	...
	public YetaT730171(final ActionDatabase actionDatabase, final MSFPanel caller) {
		...
		cpYetaT730171 = new ContentPanel();  

		createSearchForm();			//기본정보 필드를 적용
		createMsfGridForm();		//그리드필드
		setReadOnlyTrueYetaP230171();

		cpYetaT730171.setBodyBorder(false);
		cpYetaT730171.setBorders(false);
		cpYetaT730171.setHeaderVisible(false);
		cpYetaT730171.setSize("630px", "640px");

		this.add(cpYetaT730171);
	...
	private void createMsfGridForm() {
		...
		cpYetaT730171.add(layoutContainer1);
		cpYetaT730171.add(layoutContainer2);
		cpYetaT730171.add(layoutContainer3);
		cpYetaT730171.add(layoutContainer4);
		cpYetaT730171.add(layoutContainer5);
		cpYetaT730171.add(layoutContainer6);
		cpYetaT730171.add(layoutContainer7);
		cpYetaT730171.add(layoutContainer8);
		cpYetaT730171.add(layoutContainer9);
	}	
	...
	public void reload() {
		...
		yetaT73017Service.getYetaP73017ToYe169010List(ye1690103Dto, new AsyncCallback<Ye169010DTO>(){
			...
			public void onSuccess(Ye169010DTO result) {
				// TODO Auto-generated method stub
				readYetaP73017Data(result);
			}
		});
	}	 
	public void readYetaP73017Data(Ye169010DTO result) {
