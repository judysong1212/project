...
@RemoteServiceRelativePath("Yeta3400Service.gwt")
public interface Yeta3400Service extends RemoteService {
	/**
	 * Utility class for simplifying access to the instance of async service.
	 */
	public static class Util {
		private static Yeta3400ServiceAsync instance;
		public static Yeta3400ServiceAsync getInstance(){
			if (instance == null) {
				instance = GWT.create(Yeta3400Service.class);
			}
			return instance;
		}
	}
