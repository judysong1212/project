...
=====================================================**/
public  class YetaT43004   extends MSFFormPanel {  
 ...
 **/
	...
	private  ContentPanel cpYetaT43004; 
	...
	// -------------- grid 선언 시작  ---------------	  
	private MSFGridPanel YetaT43004GridPanel;
	private MSFGridPanel ye162530GridPanel; //임대차계약그리드
	private MSFGridPanel ye162520GridPanel; // 금전소비대차그리드
	private Ye162520Def ye162520Def = new Ye162520Def("YetaT43004");   
	private Ye162530Def ye162530Def = new Ye162530Def("YetaT43004");   
...
//		 }
	...
	public YetaT43004(final ActionDatabase actionDatabase, final MSFPanel caller) {
...
//		initLoad(); 	
		...
		this.actionDatabase = actionDatabase;
	 	...
	 	cpYetaT43004 = new ContentPanel();  

		createSearchForm();			//기본정보 필드를 적용
	 	createMsfGridForm();		//그리드필드
		   
		cpYetaT43004.setBodyBorder(false);
		cpYetaT43004.setBorders(false);
		cpYetaT43004.setHeaderVisible(false);
		cpYetaT43004.setSize("790px", "640px");
		   
		this.add(cpYetaT43004);
...
//		     });     
		...
		cpYetaT43004.setLayout(new FlowLayout());
...
//	      	     }
//				 
//				YetaT43004GridPanel.getMsfGrid().clearData();
//				 
//				BaseModel bmData = YetaT43004GridPanel.getTableDef().getDefaultValues();  
//		              
...
//		         
//		        YetaT43004GridPanel.getMsfGrid().getGrid().stopEditing();      
//		        YetaT43004GridPanel.getMsfGrid().getGrid().getStore().insert(bmData,0);   
//		        YetaT43004GridPanel.getMsfGrid().getGrid().startEditing(YetaT43004GridPanel.getMsfGrid().getGrid().getStore().indexOf(bmData), 0);   
//
...
//			public void handleEvent(ButtonEvent e) {
//				Iterator<BaseModel> itBm = YetaT43004GridPanel.getMsfGrid().getGrid().getSelectionModel().getSelectedItems().listIterator();
...
//			public void handleEvent(ButtonEvent e) {
//				setListRecord(YetaT43004GridPanel.getMsfGrid().getStore().getModifiedRecords().iterator());
//				doAction(actionDatabase);
//
//				if ((ActionDatabase.INSERT).equals(actionDatabase)) {
//					actionDatabase = ActionDatabase.INSERT;
...
//				
//		cpYetaT43004.add(topYetaBtnBar);
...
//		
//		YetaT43004GridPanel.getGrid().getColumnModel().addAggregationRow(payrSummaryRow);  
//		
...
//		
//		YetaT43004GridPanel.getGrid().getColumnModel().addAggregationRow(payrSummaryRow1);
//		/** --- 그리드 합계 부분  종료 --- **/
		
//        cpYetaT43004.add(YetaT43004GridPanel);
		...
		cpYetaT43004.add(fldstNewFieldset);
		cpYetaT43004.add(fldstNewFieldset1);
		cpYetaT43004.add(fldstNewFieldset_1);
	...
	public void reload() {
			...
			YetaT43004GridPanel.getTableDef().setTableColumnFilters(filters);
			YetaT43004GridPanel.getTableDef().addColumnFilter("yrtxBlggYr", MSFSharedUtils.allowNulls(srhYrtxBlggYr.getValue())
...
//					, SimpleColumnFilter.OPERATOR_EQUALS);//연말정산귀속년도
			YetaT43004GridPanel.getTableDef().addColumnFilter("clutSeptCd", MSFSharedUtils.getSelectedComboValue(srhClutSeptCd,"commCd")
					, SimpleColumnFilter.OPERATOR_EQUALS);//정산구분
			YetaT43004GridPanel.getTableDef().addColumnFilter("systemkey", MSFSharedUtils.allowNulls(systemkey.getValue())
					, SimpleColumnFilter.OPERATOR_EQUALS);//시스템키
		 
			YetaT43004GridPanel.reload();
