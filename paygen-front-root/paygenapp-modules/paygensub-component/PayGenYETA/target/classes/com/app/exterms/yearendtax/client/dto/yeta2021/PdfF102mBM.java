 ...
 */
public class PdfF102mBM   extends MSFSimpleBaseModel implements IsSerializable  {
    ...
    public static final String ATTR_RETIRPNSNMMAMT = "retirPnsnMmAmt";
    ...
    /** 일괄등록 처리   */
     public PdfF102mBM(
     	...
     	values.put(ATTR_RETIRPNSNMMAMT,retirPnsnMmAmt);
    ...
    /** set 퇴직연금월별납입금액 : retirPnsnMmAmt */
    public void setRetirPnsnMmAmt(Long  retirPnsnMmAmt) { set( ATTR_RETIRPNSNMMAMT ,retirPnsnMmAmt);}
    /** get 퇴직연금월별납입금액 : retirPnsnMmAmt */
    public Long  getRetirPnsnMmAmt() { return (Long )get( ATTR_RETIRPNSNMMAMT );}

    /** set 퇴직연금월별확정구분코드 : fixCd */
    public void setFixCd(String  fixCd) { set( ATTR_FIXCD ,fixCd);}
    /** get 퇴직연금월별확정구분코드 : fixCd */
