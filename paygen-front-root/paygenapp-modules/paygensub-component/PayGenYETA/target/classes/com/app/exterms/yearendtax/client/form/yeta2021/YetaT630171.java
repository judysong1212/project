...
import com.app.exterms.yearendtax.client.dto.yeta2021.Ye169010DTO;
import com.app.exterms.yearendtax.client.service.yeta2021.YetaT63017Service;
import com.app.exterms.yearendtax.client.service.yeta2021.YetaT63017ServiceAsync;
...
=====================================================**/
public  class YetaT630171  extends MSFFormPanel {  
	...
	private  ContentPanel cpYetaT630171; 
	...
	// -------------- grid 선언 시작  ---------------	  
	private MSFGridPanel yetaT23017GridPanel;
	//	private YetaT23017Def yetaT23017Def = new YetaT23017Def("YetaT23017");   //TODO 일단 화면번호로 Def
	// -------------- grid 선언 종료  ---------------
	...
	// -------------- 서비스 호출 시작 --------------
	private YetaT63017ServiceAsync yetaT63017Service = YetaT63017Service.Util.getInstance();
	// -------------- 서비스 호출 종료 --------------	 
	...
	public YetaT630171(final ActionDatabase actionDatabase, final MSFPanel caller) {
		...
		cpYetaT630171 = new ContentPanel();  

		createSearchForm();			//기본정보 필드를 적용
		createMsfGridForm();		//그리드필드
		setReadOnlyTrueYetaP230171();

		cpYetaT630171.setBodyBorder(false);
		cpYetaT630171.setBorders(false);
		cpYetaT630171.setHeaderVisible(false);
		cpYetaT630171.setSize("630px", "640px");

		this.add(cpYetaT630171);
	...
	private void createMsfGridForm() {
		...
		cpYetaT630171.add(layoutContainer1);
		cpYetaT630171.add(layoutContainer2);
		cpYetaT630171.add(layoutContainer3);
		cpYetaT630171.add(layoutContainer4);
		cpYetaT630171.add(layoutContainer5);
		cpYetaT630171.add(layoutContainer6);
		cpYetaT630171.add(layoutContainer7);
		cpYetaT630171.add(layoutContainer8);
		cpYetaT630171.add(layoutContainer9);
	}	
	...
	public void reload() {
		...
		yetaT63017Service.getYetaP63017ToYe169010List(ye1690103Dto, new AsyncCallback<Ye169010DTO>(){
			...
			public void onSuccess(Ye169010DTO result) {
				// TODO Auto-generated method stub
				readYetaP63017Data(result);
			}
		});
	}	 
	public void readYetaP63017Data(Ye169010DTO result) {
	...
	public void setReadOnlyTrueYetaP230171() {
