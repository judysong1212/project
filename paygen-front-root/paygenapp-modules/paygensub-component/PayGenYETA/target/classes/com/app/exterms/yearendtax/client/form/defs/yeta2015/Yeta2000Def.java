...
public class Yeta2000Def extends TableDef implements YetaDaoConstants{
	private int row = 0;
	
	public Yeta2000Def(String chkDef) {
		if("YETA200001".equals(chkDef)) {
			setTitle("");
	        setDaoClass("");
//	        setCustomListMethod(CLASS_YETA0300To2000_LIST);
	        setCustomListMethod(CLASS_YETA0100ToYETA2000_LIST);	//조회를 위해 수정
	  	  	setAutoFillGrid(false);
	        setShowFilterToolbar(false);   
	        setCheckBoxOnGridRows(true); 
		    setEditFieldGrid(false);
		    setColumnsDefinition(getColumnsListYeta0300ToYeta2000()); 			
		}else if("YETA0200".equals(chkDef)) {
			setTitle("");
	        setDaoClass("");
	        setCustomListMethod(CLASS_YETA0200ToYETA2000_LIST);
	  	  	setAutoFillGrid(false);
	        setShowFilterToolbar(false);   
	        setCheckBoxOnGridRows(true); 
		    setEditFieldGrid(false);
		    setColumnsDefinition(getYeta0200ToYeta2000List()); 	
		}else if("YETA0100".equals(chkDef)) {
			setTitle("");
	        setDaoClass("");
	        setCustomListMethod(CLASS_YETA0100ToYETA2000_LIST);
	  	  	setAutoFillGrid(false);
	        setShowFilterToolbar(false);   
	        setCheckBoxOnGridRows(true); 
		    setEditFieldGrid(false);
		    setColumnsDefinition(getYeta0100ToYeta2000List()); 			
		}else if("YETA0300".equals(chkDef)) {
			setTitle("");
	        setDaoClass("");
	        setCustomListMethod(CLASS_YETA0300ToYETA2000_LIST);
	  	  	setAutoFillGrid(false);
	        setShowFilterToolbar(false);   
	        setCheckBoxOnGridRows(true); 
		    setEditFieldGrid(false);
		    setColumnsDefinition(getYeta0300ToYeta2000List()); 			
...
//	        setCustomListMethod(CLASS_YETA0100_LIST);
	...
	private List<ColumnDef> getColumnsList() {
        ...
        /** column 사업장코드 : dpobCd */
        listColumnDefs.add(new ColumnDef("사업장코드", Yeta2000BM.ATTR_DPOBCD, ColumnDef.TYPE_STRING , 90, true, false, true){
        	{

        	}
        });
        /** column 연말정산귀속년도 : edacRvyy */
        listColumnDefs.add(new ColumnDef("귀속년도", Yeta2000BM.ATTR_EDACRVYY, ColumnDef.TYPE_STRING , 90, true, false, true){
        	{

        	}
        });
        /** column 정산구분코드 : settGbcd */
        listColumnDefs.add(new ColumnDef("정산구분", Yeta2000BM.ATTR_SETTGBCD, ColumnDef.TYPE_STRING , 90, true, false, true){
        	{

        	}
        });
        /** column SYSTEMKEY : systemkey */
        listColumnDefs.add(new ColumnDef("SYSTEMKEY", Yeta2000BM.ATTR_SYSTEMKEY, ColumnDef.TYPE_STRING , 90, true, false, true){
        	{

        	}
        });
        /** column 연말정산마감일련번호 : edacSeilNum */
        listColumnDefs.add(new ColumnDef("연말정산마감일련번호", Yeta2000BM.ATTR_EDACSEILNUM, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 급여관리부서코드 : payrMangDeptCd */
        listColumnDefs.add(new ColumnDef("급여관리부서코드", Yeta2000BM.ATTR_PAYRMANGDEPTCD, ColumnDef.TYPE_STRING , 90, true, false, true){
        	{

        	}
        });
        /** column 고용구분코드 : emymtDivCd */
        listColumnDefs.add(new ColumnDef("고용구분코드", Yeta2000BM.ATTR_EMYMTDIVCD, ColumnDef.TYPE_STRING , 90, true, false, true){
        	{

        	}
        });
        /** column 한글성명 : hanNm */
        listColumnDefs.add(new ColumnDef("한글성명", Yeta2000BM.ATTR_HANNM, ColumnDef.TYPE_STRING , 90, true, false, true){
        	{

        	}
        });
        /** column 주민등록번호 : resnRegnNum */
        listColumnDefs.add(new ColumnDef("주민등록번호", Yeta2000BM.ATTR_RESNREGNNUM, ColumnDef.TYPE_STRING , 90, true, false, true){
        	{

        	}
        });
        /** column 부서코드 : deptCd */
        listColumnDefs.add(new ColumnDef("부서코드", Yeta2000BM.ATTR_DEPTCD, ColumnDef.TYPE_STRING , 90, true, false, true){
        	{

        	}
        });
        /** column 사업코드 : businCd */
        listColumnDefs.add(new ColumnDef("사업코드", Yeta2000BM.ATTR_BUSINCD, ColumnDef.TYPE_STRING , 90, true, false, true){
        	{

        	}
        });
        /** column 직종코드 : typOccuCd */
        listColumnDefs.add(new ColumnDef("직종코드", Yeta2000BM.ATTR_TYPOCCUCD, ColumnDef.TYPE_STRING , 90, true, false, true){
        	{

        	}
        });
        /** column 직종세통합코드 : dtilOccuInttnCd */
        listColumnDefs.add(new ColumnDef("직종세통합코드", Yeta2000BM.ATTR_DTILOCCUINTTNCD, ColumnDef.TYPE_STRING , 90, true, false, true){
        	{

        	}
        });
        /** column 직종세구분코드 : dtilOccuClsDivCd */
        listColumnDefs.add(new ColumnDef("직종세구분코드", Yeta2000BM.ATTR_DTILOCCUCLSDIVCD, ColumnDef.TYPE_STRING , 90, true, false, true){
        	{

        	}
        });
        /** column 직책코드 : odtyCd */
        listColumnDefs.add(new ColumnDef("직책코드", Yeta2000BM.ATTR_ODTYCD, ColumnDef.TYPE_STRING , 90, true, false, true){
        	{

        	}
        });
        /** column 호봉코드 : pyspCd */
        listColumnDefs.add(new ColumnDef("호봉코드", Yeta2000BM.ATTR_PYSPCD, ColumnDef.TYPE_STRING , 90, true, false, true){
        	{

        	}
        });
        /** column 호봉등급코드 : pyspGrdeCd */
        listColumnDefs.add(new ColumnDef("호봉등급코드", Yeta2000BM.ATTR_PYSPGRDECD, ColumnDef.TYPE_STRING , 90, true, false, true){
        	{

        	}
        });
        /** column 근속년수코드 : logSvcYrNumCd */
        listColumnDefs.add(new ColumnDef("근속년수코드", Yeta2000BM.ATTR_LOGSVCYRNUMCD, ColumnDef.TYPE_STRING , 90, true, false, true){
        	{

        	}
        });
        /** column 근속월수코드 : logSvcMnthIcmCd */
        listColumnDefs.add(new ColumnDef("근속월수코드", Yeta2000BM.ATTR_LOGSVCMNTHICMCD, ColumnDef.TYPE_STRING , 90, true, false, true){
        	{

        	}
        });
        /** column 최초고용일자 : frstEmymtDt */
        listColumnDefs.add(new ColumnDef("최초고용일자", Yeta2000BM.ATTR_FRSTEMYMTDT, ColumnDef.TYPE_STRING , 90, true, false, true){
        	{

        	}
        });
        /** column 고용시작일자 : emymtBgnnDt */
        listColumnDefs.add(new ColumnDef("고용시작일자", Yeta2000BM.ATTR_EMYMTBGNNDT, ColumnDef.TYPE_STRING , 90, true, false, true){
        	{

        	}
        });
        /** column 고용종료일자 : emymtEndDt */
        listColumnDefs.add(new ColumnDef("고용종료일자", Yeta2000BM.ATTR_EMYMTENDDT, ColumnDef.TYPE_STRING , 90, true, false, true){
        	{

        	}
        });
        /** column 재직구분코드 : hdofcDivCd */
        listColumnDefs.add(new ColumnDef("재직구분코드", Yeta2000BM.ATTR_HDOFCDIVCD, ColumnDef.TYPE_STRING , 90, true, false, true){
        	{

        	}
        });
        /** column 퇴직일자 : retryDt */
        listColumnDefs.add(new ColumnDef("퇴직일자", Yeta2000BM.ATTR_RETRYDT, ColumnDef.TYPE_STRING , 90, true, false, true){
        	{

        	}
        });
        /** column 연말정산적용년월 : yrtxApptnYrMnth */
        listColumnDefs.add(new ColumnDef("연말정산적용년월", Yeta2000BM.ATTR_YRTXAPPTNYRMNTH, ColumnDef.TYPE_STRING , 90, true, false, true){
        	{

        	}
        });
        /** column 연말정산처리일자 : yrtxPrcsDt */
        listColumnDefs.add(new ColumnDef("연말정산처리일자", Yeta2000BM.ATTR_YRTXPRCSDT, ColumnDef.TYPE_STRING , 90, true, false, true){
        	{

        	}
        });
        /** column 연말정산처리여부 : yrtxPrcsYn */
        listColumnDefs.add(new ColumnDef("연말정산처리여부", Yeta2000BM.ATTR_YRTXPRCSYN, ColumnDef.TYPE_STRING , 90, true, false, true){
        	{

        	}
        });
        /** column 분할납부구분코드 : divdPymtDivCd */
        listColumnDefs.add(new ColumnDef("분할납부구분코드", Yeta2000BM.ATTR_DIVDPYMTDIVCD, ColumnDef.TYPE_STRING , 90, true, false, true){
        	{

        	}
        });
        /** column 분할납부횟수 : divdPymt */
        listColumnDefs.add(new ColumnDef("분할납부횟수", Yeta2000BM.ATTR_DIVDPYMT, ColumnDef.TYPE_STRING , 90, true, false, true){
        	{

        	}
        });
        /** column 세대주여부 : gnanSgtf */
        listColumnDefs.add(new ColumnDef("세대주여부", Yeta2000BM.ATTR_GNANSGTF, ColumnDef.TYPE_STRING , 90, true, false, true){
        	{

        	}
        });
        /** column 외국인구분코드 : frnrYeno */
        listColumnDefs.add(new ColumnDef("외국인구분코드", Yeta2000BM.ATTR_FRNRYENO, ColumnDef.TYPE_STRING , 90, true, false, true){
        	{

        	}
        });
        /** column 귀속년월_FROM : reymStdt */
        listColumnDefs.add(new ColumnDef("귀속년월_FROM", Yeta2000BM.ATTR_REYMSTDT, ColumnDef.TYPE_STRING , 90, true, false, true){
        	{

        	}
        });
        /** column 귀속년월_TO : reymEddt */
        listColumnDefs.add(new ColumnDef("귀속년월_TO", Yeta2000BM.ATTR_REYMEDDT, ColumnDef.TYPE_STRING , 90, true, false, true){
        	{

        	}
        });
        /** column 감면기간_TO : rutrEddt */
        listColumnDefs.add(new ColumnDef("감면기간_TO", Yeta2000BM.ATTR_RUTREDDT, ColumnDef.TYPE_STRING , 90, true, false, true){
        	{

        	}
        });
        /** column 감면기간_FROM : rutrStdt */
        listColumnDefs.add(new ColumnDef("감면기간_FROM", Yeta2000BM.ATTR_RUTRSTDT, ColumnDef.TYPE_STRING , 90, true, false, true){
        	{

        	}
        });
        /** column 거주구분여부 : resdFlag */
        listColumnDefs.add(new ColumnDef("거주구분여부", Yeta2000BM.ATTR_RESDFLAG, ColumnDef.TYPE_STRING , 90, true, false, true){
        	{

        	}
        });
        /** column 국적코드 : natnGbcd */
        listColumnDefs.add(new ColumnDef("국적코드", Yeta2000BM.ATTR_NATNGBCD, ColumnDef.TYPE_STRING , 90, true, false, true){
        	{

        	}
        });
        /** column 국적명 : natnName */
        listColumnDefs.add(new ColumnDef("국적명", Yeta2000BM.ATTR_NATNNAME, ColumnDef.TYPE_STRING , 90, true, false, true){
        	{

        	}
        });
        /** column 거주지국코드 : redtGbcd */
        listColumnDefs.add(new ColumnDef("거주지국코드", Yeta2000BM.ATTR_REDTGBCD, ColumnDef.TYPE_STRING , 90, true, false, true){
        	{

        	}
        });
        /** column 거주지국명 : redtName */
        listColumnDefs.add(new ColumnDef("거주지국명", Yeta2000BM.ATTR_REDTNAME, ColumnDef.TYPE_STRING , 90, true, false, true){
        	{

        	}
        });
        /** column 인적공제항목변동여부 : humnCgue */
        listColumnDefs.add(new ColumnDef("인적공제항목변동여부", Yeta2000BM.ATTR_HUMNCGUE, ColumnDef.TYPE_STRING , 90, true, false, true){
        	{

        	}
        });
        /** column 외국인단일세율적용여부 : frnrSgyn */
        listColumnDefs.add(new ColumnDef("외국인단일세율적용여부", Yeta2000BM.ATTR_FRNRSGYN, ColumnDef.TYPE_STRING , 90, true, false, true){
        	{

        	}
        });
        /** column 기본공제_배우자유무 : baseWiyn */
        listColumnDefs.add(new ColumnDef("기본공제_배우자유무", Yeta2000BM.ATTR_BASEWIYN, ColumnDef.TYPE_STRING , 90, true, false, true){
        	{

        	}
        });
        /** column 기본공제_부양가족수 : baseFmly */
        listColumnDefs.add(new ColumnDef("기본공제_부양가족수", Yeta2000BM.ATTR_BASEFMLY, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 추가공제_경로우대_70세이상수 : addrCt70 */
        listColumnDefs.add(new ColumnDef("추가공제_경로우대_70세이상수", Yeta2000BM.ATTR_ADDRCT70, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 추가공제_장애인수 : addrHdrc */
        listColumnDefs.add(new ColumnDef("추가공제_장애인수", Yeta2000BM.ATTR_ADDRHDRC, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 추가공제_부녀자수 : addrFdsu */
        listColumnDefs.add(new ColumnDef("추가공제_부녀자수", Yeta2000BM.ATTR_ADDRFDSU, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 추가공제_자녀양육비양육수 : addrClct */
        listColumnDefs.add(new ColumnDef("추가공제_자녀양육비양육수", Yeta2000BM.ATTR_ADDRCLCT, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 추가공제_출산자녀양육수 : addrBhct */
        listColumnDefs.add(new ColumnDef("추가공제_출산자녀양육수", Yeta2000BM.ATTR_ADDRBHCT, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 추가공제_한부모수 : pantOnsu */
        listColumnDefs.add(new ColumnDef("추가공제_한부모수", Yeta2000BM.ATTR_PANTONSU, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 추가공제_다자녀인원수 : addrMrct */
        listColumnDefs.add(new ColumnDef("추가공제_다자녀인원수", Yeta2000BM.ATTR_ADDRMRCT, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 종근무지_국민연금보험료 : bnatPsnf */
        listColumnDefs.add(new ColumnDef("종근무지_국민연금보험료", Yeta2000BM.ATTR_BNATPSNF, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 주근무지_국민연금보험료 : jnatPsnf */
        listColumnDefs.add(new ColumnDef("주근무지_국민연금보험료", Yeta2000BM.ATTR_JNATPSNF, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 종근무지_국민연금외교직원연금 : bpssTech */
        listColumnDefs.add(new ColumnDef("종근무지_국민연금외교직원연금", Yeta2000BM.ATTR_BPSSTECH, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 종근무지_국민연금외공무원연금 : bpssPulc */
        listColumnDefs.add(new ColumnDef("종근무지_국민연금외공무원연금", Yeta2000BM.ATTR_BPSSPULC, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 종근무지_국민연금외별정우체국 : bpssFect */
        listColumnDefs.add(new ColumnDef("종근무지_국민연금외별정우체국", Yeta2000BM.ATTR_BPSSFECT, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 종근무지_국민연금외군인연금 : bpssSold */
        listColumnDefs.add(new ColumnDef("종근무지_국민연금외군인연금", Yeta2000BM.ATTR_BPSSSOLD, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 주근무지_국민연금외공무원연금 : jpssPulc */
        listColumnDefs.add(new ColumnDef("주근무지_국민연금외공무원연금", Yeta2000BM.ATTR_JPSSPULC, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 주근무지_국민연금외군인연금 : jpssSold */
        listColumnDefs.add(new ColumnDef("주근무지_국민연금외군인연금", Yeta2000BM.ATTR_JPSSSOLD, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 주근무지_국인연금외교직원연금 : jpssTech */
        listColumnDefs.add(new ColumnDef("주근무지_국인연금외교직원연금", Yeta2000BM.ATTR_JPSSTECH, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 주근무지_국민연금외별정우체국 : jpssFect */
        listColumnDefs.add(new ColumnDef("주근무지_국민연금외별정우체국", Yeta2000BM.ATTR_JPSSFECT, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 종근무지_종_근로자퇴직보장법 : brtrPsct */
        listColumnDefs.add(new ColumnDef("종근무지_종_근로자퇴직보장법", Yeta2000BM.ATTR_BRTRPSCT, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 종근무지_종_과학기술인공제 : brtrCict */
        listColumnDefs.add(new ColumnDef("종근무지_종_과학기술인공제", Yeta2000BM.ATTR_BRTRCICT, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 종근무지_연금계좌_연금저축 : brtrAnsv */
        listColumnDefs.add(new ColumnDef("종근무지_연금계좌_연금저축", Yeta2000BM.ATTR_BRTRANSV, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 주근무지_퇴직연금과학기술인공제 : jrtrCict */
        listColumnDefs.add(new ColumnDef("주근무지_퇴직연금과학기술인공제", Yeta2000BM.ATTR_JRTRCICT, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 주근무지_퇴직연금과학기술인공제대상금액 : jrtrCtar */
        listColumnDefs.add(new ColumnDef("주근무지_퇴직연금과학기술인공제대상금액", Yeta2000BM.ATTR_JRTRCTAR, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 주근무지_퇴직연금근로자퇴직급여보장법 : jrtrPsct */
        listColumnDefs.add(new ColumnDef("주근무지_퇴직연금근로자퇴직급여보장법", Yeta2000BM.ATTR_JRTRPSCT, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 주근무지_퇴직연금근로자퇴직급여보장대상금액 : jrtrPtar */
        listColumnDefs.add(new ColumnDef("주근무지_퇴직연금근로자퇴직급여보장대상금액", Yeta2000BM.ATTR_JRTRPTAR, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 주근무지_연금계좌_연금저축 : jrtrAnsv */
        listColumnDefs.add(new ColumnDef("주근무지_연금계좌_연금저축", Yeta2000BM.ATTR_JRTRANSV, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 주근무지_연금계좌저축공제대상금액 : jrtrAtar */
        listColumnDefs.add(new ColumnDef("주근무지_연금계좌저축공제대상금액", Yeta2000BM.ATTR_JRTRATAR, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 연금보험료계 : rrptAmnt */
        listColumnDefs.add(new ColumnDef("연금보험료계", Yeta2000BM.ATTR_RRPTAMNT, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 특별공제_종건강보험료 : spciBhlh */
        listColumnDefs.add(new ColumnDef("특별공제_종건강보험료", Yeta2000BM.ATTR_SPCIBHLH, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 특별공제_주건강보험료 : spciHhlh */
        listColumnDefs.add(new ColumnDef("특별공제_주건강보험료", Yeta2000BM.ATTR_SPCIHHLH, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 특별공제_종고용보험료 : spciBepf */
        listColumnDefs.add(new ColumnDef("특별공제_종고용보험료", Yeta2000BM.ATTR_SPCIBEPF, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 특별공제_주고용보험료 : spciJepf */
        listColumnDefs.add(new ColumnDef("특별공제_주고용보험료", Yeta2000BM.ATTR_SPCIJEPF, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 특별공제_일반보장성보험료 : spciGurt */
        listColumnDefs.add(new ColumnDef("특별공제_일반보장성보험료", Yeta2000BM.ATTR_SPCIGURT, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 특별공제_장애인전용보험료 : spciHdrc */
        listColumnDefs.add(new ColumnDef("특별공제_장애인전용보험료", Yeta2000BM.ATTR_SPCIHDRC, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 특별공제_보장성보험료공제대상금액 : spciRttg */
        listColumnDefs.add(new ColumnDef("특별공제_보장성보험료공제대상금액", Yeta2000BM.ATTR_SPCIRTTG, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 특별공제_보험료계 : spciIuam */
        listColumnDefs.add(new ColumnDef("특별공제_보험료계", Yeta2000BM.ATTR_SPCIIUAM, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 특별공제_의료비_본인 : spciSelf */
        listColumnDefs.add(new ColumnDef("특별공제_의료비_본인", Yeta2000BM.ATTR_SPCISELF, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 특별공제_의료비_경로65세이상 : spciAe65 */
        listColumnDefs.add(new ColumnDef("특별공제_의료비_경로65세이상", Yeta2000BM.ATTR_SPCIAE65, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 특별공제_의료비_장애인 : spciDbps */
        listColumnDefs.add(new ColumnDef("특별공제_의료비_장애인", Yeta2000BM.ATTR_SPCIDBPS, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 특별공제_의료비_기타공제대상자 : spciDetc */
        listColumnDefs.add(new ColumnDef("특별공제_의료비_기타공제대상자", Yeta2000BM.ATTR_SPCIDETC, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 특별공제_의료비세액공제대상금액 : spciDtar */
        listColumnDefs.add(new ColumnDef("특별공제_의료비세액공제대상금액", Yeta2000BM.ATTR_SPCIDTAR, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 특별공제_의료비계 : spciEtam */
        listColumnDefs.add(new ColumnDef("특별공제_의료비계", Yeta2000BM.ATTR_SPCIETAM, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 특별공제_교육비_본인 : spedSelf */
        listColumnDefs.add(new ColumnDef("특별공제_교육비_본인", Yeta2000BM.ATTR_SPEDSELF, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 특별공제_교육비_취학전아동수 : spedEdsu */
        listColumnDefs.add(new ColumnDef("특별공제_교육비_취학전아동수", Yeta2000BM.ATTR_SPEDEDSU, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 특별공제_교육비_취학전아동 : spedEdam */
        listColumnDefs.add(new ColumnDef("특별공제_교육비_취학전아동", Yeta2000BM.ATTR_SPEDEDAM, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 특별공제_교육비_초중고자녀수 : spedGdsu */
        listColumnDefs.add(new ColumnDef("특별공제_교육비_초중고자녀수", Yeta2000BM.ATTR_SPEDGDSU, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 특별공제_교육비_초중고 : spedGdam */
        listColumnDefs.add(new ColumnDef("특별공제_교육비_초중고", Yeta2000BM.ATTR_SPEDGDAM, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 특별공제_교육비_대학생수 : spedCvsu */
        listColumnDefs.add(new ColumnDef("특별공제_교육비_대학생수", Yeta2000BM.ATTR_SPEDCVSU, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 특별공제_교육비_대학교 : spedCvam */
        listColumnDefs.add(new ColumnDef("특별공제_교육비_대학교", Yeta2000BM.ATTR_SPEDCVAM, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 특별공제_장애인수 : spciScsu */
        listColumnDefs.add(new ColumnDef("특별공제_장애인수", Yeta2000BM.ATTR_SPCISCSU, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 특별공제_장애인특수교육비 : spciScam */
        listColumnDefs.add(new ColumnDef("특별공제_장애인특수교육비", Yeta2000BM.ATTR_SPCISCAM, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 특별공제_교육비공제대상금액 : spedEtar */
        listColumnDefs.add(new ColumnDef("특별공제_교육비공제대상금액", Yeta2000BM.ATTR_SPEDETAR, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 특별공제_교육비계 : siedToam */
        listColumnDefs.add(new ColumnDef("특별공제_교육비계", Yeta2000BM.ATTR_SIEDTOAM, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 특별공제_차입금원리금상환액_대출기관 : spciRefn */
        listColumnDefs.add(new ColumnDef("특별공제_차입금원리금상환액_대출기관", Yeta2000BM.ATTR_SPCIREFN, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 특별공제_차입금원리금상환액_거주자 : spciResf */
        listColumnDefs.add(new ColumnDef("특별공제_차입금원리금상환액_거주자", Yeta2000BM.ATTR_SPCIRESF, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 특별공제_주택자금_월세금액 : spciHtam */
        listColumnDefs.add(new ColumnDef("특별공제_주택자금_월세금액", Yeta2000BM.ATTR_SPCIHTAM, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 특별공제_장기주택이자상환액 : spchRefn */
        listColumnDefs.add(new ColumnDef("특별공제_장기주택이자상환액", Yeta2000BM.ATTR_SPCHREFN, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 특별공제_11장기주택저당차입금15 : spchRe06 */
        listColumnDefs.add(new ColumnDef("특별공제_11장기주택저당차입금15", Yeta2000BM.ATTR_SPCHRE06, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 특별공제_11장기주택저당차입금29 : spchRe10 */
        listColumnDefs.add(new ColumnDef("특별공제_11장기주택저당차입금29", Yeta2000BM.ATTR_SPCHRE10, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 특별공제_11장기주택저당차입금30 : spchRe20 */
        listColumnDefs.add(new ColumnDef("특별공제_11장기주택저당차입금30", Yeta2000BM.ATTR_SPCHRE20, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 특별공제_12장기주택저당차입금_고정 : spchRefx */
        listColumnDefs.add(new ColumnDef("특별공제_12장기주택저당차입금_고정", Yeta2000BM.ATTR_SPCHREFX, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 특별공제_12장기주택저당차입금_기타 : spchReec */
        listColumnDefs.add(new ColumnDef("특별공제_12장기주택저당차입금_기타", Yeta2000BM.ATTR_SPCHREEC, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 특별공제_15장기주택저당_15고정AND비거치상환 : spch15fx */
        listColumnDefs.add(new ColumnDef("특별공제_15장기주택저당_15고정AND비거치상환", Yeta2000BM.ATTR_SPCH15FX, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 특별공제_15장기주택저당_15고정OR비거치상환 : spch15fb */
        listColumnDefs.add(new ColumnDef("특별공제_15장기주택저당_15고정OR비거치상환", Yeta2000BM.ATTR_SPCH15FB, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 특별공제_15장기주택저당_15기타대출 : spch15ec */
        listColumnDefs.add(new ColumnDef("특별공제_15장기주택저당_15기타대출", Yeta2000BM.ATTR_SPCH15EC, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 특별공제_15장기주택저당_10고정OR비거치상환 : spch10fb */
        listColumnDefs.add(new ColumnDef("특별공제_15장기주택저당_10고정OR비거치상환", Yeta2000BM.ATTR_SPCH10FB, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 특별공제_15장기주택저당_10기타대출 : spch10ec */
        listColumnDefs.add(new ColumnDef("특별공제_15장기주택저당_10기타대출", Yeta2000BM.ATTR_SPCH10EC, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 세액공제_기부정치자금금액 : taxdPltc */
        listColumnDefs.add(new ColumnDef("세액공제_기부정치자금금액", Yeta2000BM.ATTR_TAXDPLTC, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 특별공제_기부정치자금_10이하대상금액 : taxd10tg */
        listColumnDefs.add(new ColumnDef("특별공제_기부정치자금_10이하대상금액", Yeta2000BM.ATTR_TAXD10TG, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 특별공제_기부금_정치 : spciPltc */
        listColumnDefs.add(new ColumnDef("특별공제_기부금_정치", Yeta2000BM.ATTR_SPCIPLTC, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 특별공제_기부금_정치10초과대상금액 : spciPltg */
        listColumnDefs.add(new ColumnDef("특별공제_기부금_정치10초과대상금액", Yeta2000BM.ATTR_SPCIPLTG, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 특별공제_기부금_법정 : spciFbam */
        listColumnDefs.add(new ColumnDef("특별공제_기부금_법정", Yeta2000BM.ATTR_SPCIFBAM, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 특별공제_기부금_법정대상금액 : spciFbtg */
        listColumnDefs.add(new ColumnDef("특별공제_기부금_법정대상금액", Yeta2000BM.ATTR_SPCIFBTG, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 특별공제_기부금_특례_공익법인신탁제외 : spciExam */
        listColumnDefs.add(new ColumnDef("특별공제_기부금_특례_공익법인신탁제외", Yeta2000BM.ATTR_SPCIEXAM, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 특별공제_기부금_공익법인신탁특례 : spciUnon */
        listColumnDefs.add(new ColumnDef("특별공제_기부금_공익법인신탁특례", Yeta2000BM.ATTR_SPCIUNON, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 특별공제_기부금_우리사주조합2015이후 : spciHfam */
        listColumnDefs.add(new ColumnDef("특별공제_기부금_우리사주조합2015이후", Yeta2000BM.ATTR_SPCIHFAM, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 특별공제_기부금_종교단체 : spciYamt */
        listColumnDefs.add(new ColumnDef("특별공제_기부금_종교단체", Yeta2000BM.ATTR_SPCIYAMT, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 특별공제_기부금_종교단체외 : spciNamt */
        listColumnDefs.add(new ColumnDef("특별공제_기부금_종교단체외", Yeta2000BM.ATTR_SPCINAMT, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 특별공제_지정기부금대상금액 : spciDgtg */
        listColumnDefs.add(new ColumnDef("특별공제_지정기부금대상금액", Yeta2000BM.ATTR_SPCIDGTG, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 특별공제_혼인_이사_장례비_삭제 : spciFnrl */
        listColumnDefs.add(new ColumnDef("특별공제_혼인_이사_장례비_삭제", Yeta2000BM.ATTR_SPCIFNRL, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 개인연금저축불입액_2000년이전 : prvm20be */
        listColumnDefs.add(new ColumnDef("개인연금저축불입액_2000년이전", Yeta2000BM.ATTR_PRVM20BE, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 개인연금저축불입액_2001년이후_삭제 : prvm21af */
        listColumnDefs.add(new ColumnDef("개인연금저축불입액_2001년이후_삭제", Yeta2000BM.ATTR_PRVM21AF, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 기타공제_소기업공제불입금액 : etchPrep */
        listColumnDefs.add(new ColumnDef("기타공제_소기업공제불입금액", Yeta2000BM.ATTR_ETCHPREP, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 기타공제_주택마련저축_청약저축 : etcsComp */
        listColumnDefs.add(new ColumnDef("기타공제_주택마련저축_청약저축", Yeta2000BM.ATTR_ETCSCOMP, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 기타공제_주택마련저축_근로자주택마련저축 : etwkHsvm */
        listColumnDefs.add(new ColumnDef("기타공제_주택마련저축_근로자주택마련저축", Yeta2000BM.ATTR_ETWKHSVM, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 기타공제_주택마련저축_주택청약종합저축 : etwkHsbm */
        listColumnDefs.add(new ColumnDef("기타공제_주택마련저축_주택청약종합저축", Yeta2000BM.ATTR_ETWKHSBM, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 기타공제_주택마련저축_장기주택마련저축_del : etwkHlgm */
        listColumnDefs.add(new ColumnDef("기타공제_주택마련저축_장기주택마련저축_del", Yeta2000BM.ATTR_ETWKHLGM, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 기타공제_주택마련저축소득금액 : etwkHbdm */
        listColumnDefs.add(new ColumnDef("기타공제_주택마련저축소득금액", Yeta2000BM.ATTR_ETWKHBDM, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 기타공제_투자조합출자금액_2011이전 : etctConc */
        listColumnDefs.add(new ColumnDef("기타공제_투자조합출자금액_2011이전", Yeta2000BM.ATTR_ETCTCONC, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 기타공제_투자조합출자금액_2012년도 : etgdH09f */
        listColumnDefs.add(new ColumnDef("기타공제_투자조합출자금액_2012년도", Yeta2000BM.ATTR_ETGDH09F, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 기타공제_투자조합출자금액_2013년도 : etgdH13f */
        listColumnDefs.add(new ColumnDef("기타공제_투자조합출자금액_2013년도", Yeta2000BM.ATTR_ETGDH13F, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 기타공제_투자조합출자금액_2014년도 : etgdH14f */
        listColumnDefs.add(new ColumnDef("기타공제_투자조합출자금액_2014년도", Yeta2000BM.ATTR_ETGDH14F, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 기타공제_투자조합출자금액_2015년이후 : etclH15f */
        listColumnDefs.add(new ColumnDef("기타공제_투자조합출자금액_2015년이후", Yeta2000BM.ATTR_ETCLH15F, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 기타공제투자조합출자금액계 : etgdHdam */
        listColumnDefs.add(new ColumnDef("기타공제투자조합출자금액계", Yeta2000BM.ATTR_ETGDHDAM, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 기타공제_신용카드등사용금액 : etctCard */
        listColumnDefs.add(new ColumnDef("기타공제_신용카드등사용금액", Yeta2000BM.ATTR_ETCTCARD, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 기타공제_직불카드등사용금액 : etchBcbs */
        listColumnDefs.add(new ColumnDef("기타공제_직불카드등사용금액", Yeta2000BM.ATTR_ETCHBCBS, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 기타공제_현금영수증사용금액 : etchUeam */
        listColumnDefs.add(new ColumnDef("기타공제_현금영수증사용금액", Yeta2000BM.ATTR_ETCHUEAM, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 기타공제_전통시장사용분 : etchMgvd */
        listColumnDefs.add(new ColumnDef("기타공제_전통시장사용분", Yeta2000BM.ATTR_ETCHMGVD, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 기타공제_지로납부_대중교통금액 : etchBced */
        listColumnDefs.add(new ColumnDef("기타공제_지로납부_대중교통금액", Yeta2000BM.ATTR_ETCHBCED, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 기타공제_본인신용카드등사용액_2013 : cardEt13 */
        listColumnDefs.add(new ColumnDef("기타공제_본인신용카드등사용액_2013", Yeta2000BM.ATTR_CARDET13, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 기타공제_본인신용카드등사용액_2014 : cardEt14 */
        listColumnDefs.add(new ColumnDef("기타공제_본인신용카드등사용액_2014", Yeta2000BM.ATTR_CARDET14, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 기타공제_본인추가공재율사용액_2013 : etadDd13 */
        listColumnDefs.add(new ColumnDef("기타공제_본인추가공재율사용액_2013", Yeta2000BM.ATTR_ETADDD13, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 기타공제_본인추가공제율사용액_2014하 : etadD14l */
        listColumnDefs.add(new ColumnDef("기타공제_본인추가공제율사용액_2014하", Yeta2000BM.ATTR_ETADD14L, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 기타공제_신용카드등사용공제계 : etchBcue */
        listColumnDefs.add(new ColumnDef("기타공제_신용카드등사용공제계", Yeta2000BM.ATTR_ETCHBCUE, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 기타공제_우리사주출연금액 : etckUnon */
        listColumnDefs.add(new ColumnDef("기타공제_우리사주출연금액", Yeta2000BM.ATTR_ETCKUNON, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 기타공제_우리사주조합기부금2014이전 : etckUncb */
        listColumnDefs.add(new ColumnDef("기타공제_우리사주조합기부금2014이전", Yeta2000BM.ATTR_ETCKUNCB, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 기타공제_고용유지중소기업근로자임금삭감액 : etepHsam */
        listColumnDefs.add(new ColumnDef("기타공제_고용유지중소기업근로자임금삭감액", Yeta2000BM.ATTR_ETEPHSAM, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 기타공제_목돈안드는전세이자상환금액 : etgdCtra */
        listColumnDefs.add(new ColumnDef("기타공제_목돈안드는전세이자상환금액", Yeta2000BM.ATTR_ETGDCTRA, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 기타공제_장기집합투자증권저축금액 : etepSest */
        listColumnDefs.add(new ColumnDef("기타공제_장기집합투자증권저축금액", Yeta2000BM.ATTR_ETEPSEST, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 기타공제_장기주식형저축_1년차_삭제 : etclHm01 */
        listColumnDefs.add(new ColumnDef("기타공제_장기주식형저축_1년차_삭제", Yeta2000BM.ATTR_ETCLHM01, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 기타공제_장기주식형저축_2년차_삭제 : etclHm02 */
        listColumnDefs.add(new ColumnDef("기타공제_장기주식형저축_2년차_삭제", Yeta2000BM.ATTR_ETCLHM02, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 기타공제_장기주식형저축_3년차_삭제 : etclHm03 */
        listColumnDefs.add(new ColumnDef("기타공제_장기주식형저축_3년차_삭제", Yeta2000BM.ATTR_ETCLHM03, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 기타공제_장기주식형저축_납입합계금액_삭제 : etclHmta */
        listColumnDefs.add(new ColumnDef("기타공제_장기주식형저축_납입합계금액_삭제", Yeta2000BM.ATTR_ETCLHMTA, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 기타공제_기타제목 : etclEttl */
        listColumnDefs.add(new ColumnDef("기타공제_기타제목", Yeta2000BM.ATTR_ETCLETTL, ColumnDef.TYPE_STRING , 90, true, false, true){
        	{

        	}
        });
        /** column 기타공제_기타금액 : etclEtam */
        listColumnDefs.add(new ColumnDef("기타공제_기타금액", Yeta2000BM.ATTR_ETCLETAM, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 세액공제_외국인_입국목적코드 : taxdIncd */
        listColumnDefs.add(new ColumnDef("세액공제_외국인_입국목적코드", Yeta2000BM.ATTR_TAXDINCD, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 세액공제_외국인_근로제공일자 : taxdWkdt */
        listColumnDefs.add(new ColumnDef("세액공제_외국인_근로제공일자", Yeta2000BM.ATTR_TAXDWKDT, ColumnDef.TYPE_STRING , 90, true, false, true){
        	{

        	}
        });
        /** column 세액공제_외국인_감면기간만료일자 : tamaEddt */
        listColumnDefs.add(new ColumnDef("세액공제_외국인_감면기간만료일자", Yeta2000BM.ATTR_TAMAEDDT, ColumnDef.TYPE_STRING , 90, true, false, true){
        	{

        	}
        });
        /** column 세액공제_외국인_감면신청접수일자 : tamaIndt */
        listColumnDefs.add(new ColumnDef("세액공제_외국인_감면신청접수일자", Yeta2000BM.ATTR_TAMAINDT, ColumnDef.TYPE_STRING , 90, true, false, true){
        	{

        	}
        });
        /** column 세액공제_외국인_감면신청제출일자 : tamaOudt */
        listColumnDefs.add(new ColumnDef("세액공제_외국인_감면신청제출일자", Yeta2000BM.ATTR_TAMAOUDT, ColumnDef.TYPE_STRING , 90, true, false, true){
        	{

        	}
        });
        /** column 세액공제_외국인해저광물개발감면확인일자 : txlgFrrd */
        listColumnDefs.add(new ColumnDef("세액공제_외국인해저광물개발감면확인일자", Yeta2000BM.ATTR_TXLGFRRD, ColumnDef.TYPE_STRING , 90, true, false, true){
        	{

        	}
        });
        /** column 세액공제_외국인해저광물개발감면신청일자 : txlgFrid */
        listColumnDefs.add(new ColumnDef("세액공제_외국인해저광물개발감면신청일자", Yeta2000BM.ATTR_TXLGFRID, ColumnDef.TYPE_STRING , 90, true, false, true){
        	{

        	}
        });
        /** column 세액공제_근로소득조세조약상면제접수일자 : txlgWkid */
        listColumnDefs.add(new ColumnDef("세액공제_근로소득조세조약상면제접수일자", Yeta2000BM.ATTR_TXLGWKID, ColumnDef.TYPE_STRING , 90, true, false, true){
        	{

        	}
        });
        /** column 세액공제_근로소득조세조약상면제제출일자 : txlgTxtd */
        listColumnDefs.add(new ColumnDef("세액공제_근로소득조세조약상면제제출일자", Yeta2000BM.ATTR_TXLGTXTD, ColumnDef.TYPE_STRING , 90, true, false, true){
        	{

        	}
        });
        /** column 세액공제_중소기업청년감면취업일자 : txlgBscd */
        listColumnDefs.add(new ColumnDef("세액공제_중소기업청년감면취업일자", Yeta2000BM.ATTR_TXLGBSCD, ColumnDef.TYPE_STRING , 90, true, false, true){
        	{

        	}
        });
        /** column 세액공제_중소기업청년감면종료일자 : txlgBcde */
        listColumnDefs.add(new ColumnDef("세액공제_중소기업청년감면종료일자", Yeta2000BM.ATTR_TXLGBCDE, ColumnDef.TYPE_STRING , 90, true, false, true){
        	{

        	}
        });
        /** column 세액감면_소득세법감면세액 : txlgItct */
        listColumnDefs.add(new ColumnDef("세액감면_소득세법감면세액", Yeta2000BM.ATTR_TXLGITCT, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 세액감면_취업청년감면대상총급여액 : txlgBsta */
        listColumnDefs.add(new ColumnDef("세액감면_취업청년감면대상총급여액", Yeta2000BM.ATTR_TXLGBSTA, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 세액감면_취업청년감면근로자총급여액 : txlgWkta */
        listColumnDefs.add(new ColumnDef("세액감면_취업청년감면근로자총급여액", Yeta2000BM.ATTR_TXLGWKTA, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 세액감면_계산감면세액금액 : txlgClta */
        listColumnDefs.add(new ColumnDef("세액감면_계산감면세액금액", Yeta2000BM.ATTR_TXLGCLTA, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 세액감면_외국인기술자감면세액 : txlgFrta */
        listColumnDefs.add(new ColumnDef("세액감면_외국인기술자감면세액", Yeta2000BM.ATTR_TXLGFRTA, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 세액감면_조세조약감면세액 : txlgTxty */
        listColumnDefs.add(new ColumnDef("세액감면_조세조약감면세액", Yeta2000BM.ATTR_TXLGTXTY, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 세액공제_외국납부_국외원천소득금액 : txlgInam */
        listColumnDefs.add(new ColumnDef("세액공제_외국납부_국외원천소득금액", Yeta2000BM.ATTR_TXLGINAM, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 세액공제_외국납부_외화납세액 : txlgDlam */
        listColumnDefs.add(new ColumnDef("세액공제_외국납부_외화납세액", Yeta2000BM.ATTR_TXLGDLAM, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 세액공제_외국납부_원화납세액 : txlgWnam */
        listColumnDefs.add(new ColumnDef("세액공제_외국납부_원화납세액", Yeta2000BM.ATTR_TXLGWNAM, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 세액공제_외국납부_납세국명 : txlgOtcy */
        listColumnDefs.add(new ColumnDef("세액공제_외국납부_납세국명", Yeta2000BM.ATTR_TXLGOTCY, ColumnDef.TYPE_STRING , 90, true, false, true){
        	{

        	}
        });
        /** column 세액공제_외국납부_납부일자 : txlgOtdt */
        listColumnDefs.add(new ColumnDef("세액공제_외국납부_납부일자", Yeta2000BM.ATTR_TXLGOTDT, ColumnDef.TYPE_STRING , 90, true, false, true){
        	{

        	}
        });
        /** column 세액공제_외국납부_신청서제출일자 : txlgApdt */
        listColumnDefs.add(new ColumnDef("세액공제_외국납부_신청서제출일자", Yeta2000BM.ATTR_TXLGAPDT, ColumnDef.TYPE_STRING , 90, true, false, true){
        	{

        	}
        });
        /** column 세액공제_외국납부_국외근무처명 : txlgOuwk */
        listColumnDefs.add(new ColumnDef("세액공제_외국납부_국외근무처명", Yeta2000BM.ATTR_TXLGOUWK, ColumnDef.TYPE_STRING , 90, true, false, true){
        	{

        	}
        });
        /** column 세액공제_외국납부_근무시작일자 : txapStdt */
        listColumnDefs.add(new ColumnDef("세액공제_외국납부_근무시작일자", Yeta2000BM.ATTR_TXAPSTDT, ColumnDef.TYPE_STRING , 90, true, false, true){
        	{

        	}
        });
        /** column 세액공제_외국납부_근무종료일자 : txapEddt */
        listColumnDefs.add(new ColumnDef("세액공제_외국납부_근무종료일자", Yeta2000BM.ATTR_TXAPEDDT, ColumnDef.TYPE_STRING , 90, true, false, true){
        	{

        	}
        });
        /** column 세액공제_외국납부_직책 : txapWkdy */
        listColumnDefs.add(new ColumnDef("세액공제_외국납부_직책", Yeta2000BM.ATTR_TXAPWKDY, ColumnDef.TYPE_STRING , 90, true, false, true){
        	{

        	}
        });
        /** column 세액공제_납세조합공제 : taxdUnin */
        listColumnDefs.add(new ColumnDef("세액공제_납세조합공제", Yeta2000BM.ATTR_TAXDUNIN, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 세액공제_주택차입금이자상황금액 : taxdLoaa */
        listColumnDefs.add(new ColumnDef("세액공제_주택차입금이자상황금액", Yeta2000BM.ATTR_TAXDLOAA, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 추가서류_연금저축등소득공제제출여부 : addcNtyn */
        listColumnDefs.add(new ColumnDef("추가서류_연금저축등소득공제제출여부", Yeta2000BM.ATTR_ADDCNTYN, ColumnDef.TYPE_STRING , 90, true, false, true){
        	{

        	}
        });
        /** column 추가서류_의료비지급명세서제출여부 : addcMdyn */
        listColumnDefs.add(new ColumnDef("추가서류_의료비지급명세서제출여부", Yeta2000BM.ATTR_ADDCMDYN, ColumnDef.TYPE_STRING , 90, true, false, true){
        	{

        	}
        });
        /** column 추가서류_기부금명세서제출여부 : addcCtyn */
        listColumnDefs.add(new ColumnDef("추가서류_기부금명세서제출여부", Yeta2000BM.ATTR_ADDCCTYN, ColumnDef.TYPE_STRING , 90, true, false, true){
        	{

        	}
        });
        /** column 추가서류_소득공제증빙서류제출여부 : addcPfyn */
        listColumnDefs.add(new ColumnDef("추가서류_소득공제증빙서류제출여부", Yeta2000BM.ATTR_ADDCPFYN, ColumnDef.TYPE_STRING , 90, true, false, true){
        	{

        	}
        });
        /** column 추가서류_종전근무지근로소득원천징수제출여부 : addfPvyn */
        listColumnDefs.add(new ColumnDef("추가서류_종전근무지근로소득원천징수제출여부", Yeta2000BM.ATTR_ADDFPVYN, ColumnDef.TYPE_STRING , 90, true, false, true){
        	{

        	}
        });
        /** column 추가서류_월세액_거주자_주택차입금세액공제제출여부 : spciReyn */
        listColumnDefs.add(new ColumnDef("추가서류_월세액_거주자_주택차입금세액공제제출여부", Yeta2000BM.ATTR_SPCIREYN, ColumnDef.TYPE_STRING , 90, true, false, true){
        	{

        	}
        });
        /** column 추가서류_월세_비거주간상환액제출여부 : txlgMxtm */
        listColumnDefs.add(new ColumnDef("추가서류_월세_비거주간상환액제출여부", Yeta2000BM.ATTR_TXLGMXTM, ColumnDef.TYPE_STRING , 90, true, false, true){
        	{

        	}
        });
        /** column 소득신고제출일자 : incoOudt */
        listColumnDefs.add(new ColumnDef("소득신고제출일자", Yeta2000BM.ATTR_INCOOUDT, ColumnDef.TYPE_STRING , 90, true, false, true){
        	{

        	}
        });
        /** column 소득신고제출여부 : incoOufg */
        listColumnDefs.add(new ColumnDef("소득신고제출여부", Yeta2000BM.ATTR_INCOOUFG, ColumnDef.TYPE_STRING , 90, true, false, true){
        	{

        	}
        });
        /** column 파일생성여부 : jdocFile */
        listColumnDefs.add(new ColumnDef("제출구분", Yeta2000BM.ATTR_JDOCFILE, ColumnDef.TYPE_STRING , 90, true,true, true){
        	{

        	}
        });
        /** column 연금계좌계 : jrtrAtom */
        listColumnDefs.add(new ColumnDef("연금계좌계", Yeta2000BM.ATTR_JRTRATOM, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 연금계좌공제대상금액 : jrtrTotr */
        listColumnDefs.add(new ColumnDef("연금계좌공제대상금액", Yeta2000BM.ATTR_JRTRTOTR, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 특별공제_장애인보장성대상금액 : spciHdtg */
        listColumnDefs.add(new ColumnDef("특별공제_장애인보장성대상금액", Yeta2000BM.ATTR_SPCIHDTG, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 특별공제_보장성보험료대상금액 : spciDetg */
        listColumnDefs.add(new ColumnDef("특별공제_보장성보험료대상금액", Yeta2000BM.ATTR_SPCIDETG, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 특별공제_보장성보험료계 : spciRtto */
        listColumnDefs.add(new ColumnDef("특별공제_보장성보험료계", Yeta2000BM.ATTR_SPCIRTTO, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 본인의료비공제대상금액 : spciSftg */
        listColumnDefs.add(new ColumnDef("본인의료비공제대상금액", Yeta2000BM.ATTR_SPCISFTG, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 65세이상자의료비공제대상금액 : spci65tg */
        listColumnDefs.add(new ColumnDef("65세이상자의료비공제대상금액", Yeta2000BM.ATTR_SPCI65TG, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 장애인의료비공제대상금액 : spciPstg */
        listColumnDefs.add(new ColumnDef("장애인의료비공제대상금액", Yeta2000BM.ATTR_SPCIPSTG, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 그밖의의료비공제대상금액 : spciEtcg */
        listColumnDefs.add(new ColumnDef("그밖의의료비공제대상금액", Yeta2000BM.ATTR_SPCIETCG, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 소득자본인교육비대상금액 : spedSftr */
        listColumnDefs.add(new ColumnDef("소득자본인교육비대상금액", Yeta2000BM.ATTR_SPEDSFTR, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 취학전아동교육비대상금액 : spedEdtr */
        listColumnDefs.add(new ColumnDef("취학전아동교육비대상금액", Yeta2000BM.ATTR_SPEDEDTR, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 초중고교육비대상금액 : spedGdtr */
        listColumnDefs.add(new ColumnDef("초중고교육비대상금액", Yeta2000BM.ATTR_SPEDGDTR, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 대학생교육비대상금액 : spedCvtr */
        listColumnDefs.add(new ColumnDef("대학생교육비대상금액", Yeta2000BM.ATTR_SPEDCVTR, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 특수교육비공제대상금액 : spciSctr */
        listColumnDefs.add(new ColumnDef("특수교육비공제대상금액", Yeta2000BM.ATTR_SPCISCTR, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 특례기부금_공익법인제외대상금액 : spciExtg */
        listColumnDefs.add(new ColumnDef("특례기부금_공익법인제외대상금액", Yeta2000BM.ATTR_SPCIEXTG, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 공익법인신탁대상금액 : spciUntg */
        listColumnDefs.add(new ColumnDef("공익법인신탁대상금액", Yeta2000BM.ATTR_SPCIUNTG, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 우리사주종합기부대상금액 : spciHftg */
        listColumnDefs.add(new ColumnDef("우리사주종합기부대상금액", Yeta2000BM.ATTR_SPCIHFTG, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 종교단체외지정대상금액 : spciNatg */
        listColumnDefs.add(new ColumnDef("종교단체외지정대상금액", Yeta2000BM.ATTR_SPCINATG, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 종교단체지정대상금액 : spciYatg */
        listColumnDefs.add(new ColumnDef("종교단체지정대상금액", Yeta2000BM.ATTR_SPCIYATG, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 기부금합계금액 : spciDgam */
        listColumnDefs.add(new ColumnDef("기부금합계금액", Yeta2000BM.ATTR_SPCIDGAM, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 이월특례기부금_공익신탁금액 : spciOnon */
        listColumnDefs.add(new ColumnDef("이월특례기부금_공익신탁금액", Yeta2000BM.ATTR_SPCIONON, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 이월법정기부금액 : spciObam */
        listColumnDefs.add(new ColumnDef("이월법정기부금액", Yeta2000BM.ATTR_SPCIOBAM, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 이월종교단체기부금 : spciOyam */
        listColumnDefs.add(new ColumnDef("이월종교단체기부금", Yeta2000BM.ATTR_SPCIOYAM, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 이월종교단체외기부금 : spciOnam */
        listColumnDefs.add(new ColumnDef("이월종교단체외기부금", Yeta2000BM.ATTR_SPCIONAM, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 입력자 : kybdr */
        listColumnDefs.add(new ColumnDef("입력자", Yeta2000BM.ATTR_KYBDR, ColumnDef.TYPE_STRING , 90, true, false, true){
        	{

        	}
        });
        /** column 입력일자 : inptDt */
        listColumnDefs.add(new ColumnDef("입력일자", Yeta2000BM.ATTR_INPTDT, ColumnDef.TYPE_STRING , 90, true, false, true){
        	{

        	}
        });
        /** column 입력주소 : inptAddr */
        listColumnDefs.add(new ColumnDef("입력주소", Yeta2000BM.ATTR_INPTADDR, ColumnDef.TYPE_STRING , 90, true, false, true){
        	{

        	}
        });
        /** column 수정자 : ismt */
        listColumnDefs.add(new ColumnDef("수정자", Yeta2000BM.ATTR_ISMT, ColumnDef.TYPE_STRING , 90, true, false, true){
        	{

        	}
        });
        /** column 수정일자 : revnDt */
        listColumnDefs.add(new ColumnDef("수정일자", Yeta2000BM.ATTR_REVNDT, ColumnDef.TYPE_STRING , 90, true, false, true){
        	{

        	}
        });
        /** column 수정주소 : revnAddr */
        listColumnDefs.add(new ColumnDef("수정주소", Yeta2000BM.ATTR_REVNADDR, ColumnDef.TYPE_STRING , 90, true, false, true){
        	{
        ...
        listColumnDefs.add(new ColumnDef("기타공제_본인신용카등사용액_2015", Yeta2000BM.ATTR_CARDET15, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 기타공제_본인추가공제율사용액2015상반기 : etadD15h */
        listColumnDefs.add(new ColumnDef("기타공제_본인추가공제율사용액2015상반기", Yeta2000BM.ATTR_ETADD15H, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{

        	}
        });
        /** column 기타공제_본인추가공제율사용액2015하반기 : etadD15l */
        listColumnDefs.add(new ColumnDef("기타공제_본인추가공제율사용액2015하반기", Yeta2000BM.ATTR_ETADD15L, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{
...
//        private TextField<String> revnAddr;   /** column 수정주소 : revnAddr */
	...
	private List<ColumnDef> getColumnsListYeta0300ToYeta2000() {
        ...
        /** column 부서명 : deptCd */
        listColumnDefs.add(new ColumnDef("부서", Yeta2000BM.ATTR_DEPTNM, ColumnDef.TYPE_STRING , 100, true, true, true){
        	{
        ...
        /** column 한글성명 : hanNm */
        listColumnDefs.add(new ColumnDef("한글성명", Yeta2000BM.ATTR_HANNM, ColumnDef.TYPE_STRING , 70, true, true, true){
        	{

        	}
        });
        /** column 주민등록번호 : resnRegnNum */
        listColumnDefs.add(new ColumnDef("주민등록번호", Yeta2000BM.ATTR_RESNREGNNUM, ColumnDef.TYPE_STRING , 70, true, true, true){
        	{

        	}
        });
        /** column 직종명 : typOccuCd */
        listColumnDefs.add(new ColumnDef("직종", Yeta2000BM.ATTR_TYPOCCUNM, ColumnDef.TYPE_STRING , 70, true, true, true){
        	{

        	}
        });
        /** column 직종세명 : dtilOccuInttnCd */
        listColumnDefs.add(new ColumnDef("직종세", Yeta2000BM.ATTR_DTILOCCUINTTNNM, ColumnDef.TYPE_STRING , 70, true, true, true){
        	{

        	}
        });
        /** column 사업명 : businCd */
        listColumnDefs.add(new ColumnDef("사업", Yeta2000BM.ATTR_BUSINNM, ColumnDef.TYPE_STRING , 70, true, true, true){
        	{
        ...
        /** column 연말정산귀속년도 : edacRvyy */
        listColumnDefs.add(new ColumnDef("연말정산귀속년도", Yeta2000BM.ATTR_EDACRVYY, ColumnDef.TYPE_STRING , 90, true, false, true){
        	{

        	}
        });
        /** column 정산구분코드 : settGbcd */
        listColumnDefs.add(new ColumnDef("정산구분코드", Yeta2000BM.ATTR_SETTGBCD, ColumnDef.TYPE_STRING , 90, true, false, true){
        	{
        ...
        /** column 연말정산마감일련번호 : edacSeilNum */
        listColumnDefs.add(new ColumnDef("연말정산마감일련번호", Yeta2000BM.ATTR_EDACSEILNUM, ColumnDef.TYPE_LONG , 90, false, false, false){
        	{
        ...
        listColumnDefs.add(new ColumnDef("종근무지_국민연금외군인연금", Yeta2000BM.ATTR_BPSSPULC, ColumnDef.TYPE_LONG , 90, true, false, true){
        	{
        ...
        /** column 세액공제_외국인_입국목적코드 : taxdIncd */
        listColumnDefs.add(new ColumnDef("세액공제_외국인_입국목적코드", Yeta2000BM.ATTR_TAXDINCD, ColumnDef.TYPE_STRING , 90, true, false, true){
        	{
        ...
        listColumnDefs.add(new ColumnDef("세액공제_외국인_입국목적코드", Yeta2000BM.ATTR_TAXDINCD1, ColumnDef.TYPE_BOOLEAN , 90, true, false, true){
        	{

        	}
        });
        /** column 세액공제_외국인_입국목적코드 : taxdIncd2 */
        listColumnDefs.add(new ColumnDef("세액공제_외국인_입국목적코드", Yeta2000BM.ATTR_TAXDINCD2, ColumnDef.TYPE_BOOLEAN , 90, true, false, true){
        	{

        	}
        });
        /** column 세액공제_외국인_입국목적코드 : taxdIncd3 */
        listColumnDefs.add(new ColumnDef("세액공제_외국인_입국목적코드", Yeta2000BM.ATTR_TAXDINCD3, ColumnDef.TYPE_BOOLEAN , 90, true, false, true){
        	{

        	}
        });
        /** column 세액공제_외국인_입국목적코드 : taxdIncd4 */
        listColumnDefs.add(new ColumnDef("세액공제_외국인_입국목적코드", Yeta2000BM.ATTR_TAXDINCD4, ColumnDef.TYPE_BOOLEAN , 90, true, false, true){
        	{
    ...
    */
	...
	private List<ColumnDef> getYeta0100ToYeta2000List() {
        ...
        /** column 연말정산귀속년도 : edacRvyy */
        listColumnDefs.add(new ColumnDef("귀속년도", Yeta2000BM.ATTR_EDACRVYY, ColumnDef.TYPE_STRING , 60, true, true, true){
        	{

        	}
        });
        /** column 정산구분코드 : settGbcd */
        listColumnDefs.add(new ColumnDef("정산구분코드", Yeta2000BM.ATTR_SETTGBCD, ColumnDef.TYPE_STRING , 70, true, false, true){
        	{

        	}
        });
        /** column 정산구분코드 : settGbnm */
        listColumnDefs.add(new ColumnDef("정산구분", Yeta2000BM.ATTR_SETTGBNM, ColumnDef.TYPE_STRING , 90, true, true, true){
        	{
        ...
        /** column 한글성명 : hanNm */
        listColumnDefs.add(new ColumnDef("성명", Yeta2000BM.ATTR_HANNM, ColumnDef.TYPE_STRING , 60, true, true, true){
        	{
        ...
        listColumnDefs.add(new ColumnDef("시작일자", Yeta2000BM.ATTR_REYMSTDT, ColumnDef.TYPE_DATE , 70, true, true, true){
        	{
        		setMaxLength(10);
        ...
        /** column 귀속년월_TO : reymEddt */
        listColumnDefs.add(new ColumnDef("종료일자", Yeta2000BM.ATTR_REYMEDDT, ColumnDef.TYPE_DATE , 70, true, true, true){
        	{
        		setMaxLength(10);
        		setFormatDate(DateTimeFormat.getFormat("yyyy.MM.dd"));  
        		setDtFieldMask("9999.99.99");
        ...
        /** column 주근무지_급여총액 : payrTamt */
        listColumnDefs.add(new ColumnDef("급여총액", Yeta3000BM.ATTR_PAYRTAMT, ColumnDef.TYPE_LONG , 90, true, true, true){
        	{
        ...
        /** column 주근무지_상여총액 : bonsToam */
        listColumnDefs.add(new ColumnDef("상여총액", Yeta3000BM.ATTR_BONSTOAM, ColumnDef.TYPE_LONG , 90, true, true, true){
        	{
        ...
        /** column 주근무지_국민연금보험료 : jnatPsnf */
        listColumnDefs.add(new ColumnDef("국민연금", Yeta2000BM.ATTR_JNATPSNF, ColumnDef.TYPE_LONG , 90, true, true, true){
        	{
        ...
        /** column 특별공제_주건강보험료 : spciHhlh */
        listColumnDefs.add(new ColumnDef("건강보험", Yeta2000BM.ATTR_SPCIHHLH, ColumnDef.TYPE_LONG , 90, true, true, true){
        	{
        ...
        /** column 특별공제_주고용보험료 : spciJepf */
        listColumnDefs.add(new ColumnDef("고용보험", Yeta2000BM.ATTR_SPCIJEPF, ColumnDef.TYPE_LONG , 90, true, true, true){
        	{
        ...
        /** column 기납부세액_소득세 : alryPinx */
        listColumnDefs.add(new ColumnDef("소득세", Yeta3000BM.ATTR_ALRYPINX, ColumnDef.TYPE_LONG , 90, true, true, true){
        	{

        	}
        });
        /** column 기납부세액_주민세_지방소득세 : alryPhbx */
        listColumnDefs.add(new ColumnDef("지방소득세", Yeta3000BM.ATTR_ALRYPHBX, ColumnDef.TYPE_LONG , 90, true, true, true){
        	{

        	}
        });
        /** column 기납부세액_농특세 : alryYvtx */
        listColumnDefs.add(new ColumnDef("농특세", Yeta3000BM.ATTR_ALRYYVTX, ColumnDef.TYPE_LONG , 90, true, true, true){
        	{
        ...
        listColumnDefs.add(new ColumnDef("재직", Yeta2000BM.ATTR_HDOFCDIVNM, ColumnDef.TYPE_STRING , 90, true, true, true){
        	{
	 ...
	 * @return
	 */
	private List<ColumnDef> getYeta0200ToYeta2000List() {
        ...
        /** column 주민등록번호 : resnRegnNum */
        listColumnDefs.add(new ColumnDef("주민등록번호", Yeta2000BM.ATTR_RESNREGNNUM, ColumnDef.TYPE_STRING , 70, true, false, true){
        	{
        ...
        /** column 파일생성여부 : jdocFile */
        listColumnDefs.add(new ColumnDef("제출구분", Yeta2000BM.ATTR_JDOCFNNM, ColumnDef.TYPE_STRING , 70, true,true, true){
        	{
	...
	private List<ColumnDef> getYeta0300ToYeta2000List() {
        ...
        /** column 연말정산귀속년도 : edacRvyy */
        listColumnDefs.add(new ColumnDef("귀속년도", Yeta2000BM.ATTR_EDACRVYY, ColumnDef.TYPE_STRING , 60, true, false, true){
        	{
        ...
        /** column 정산구분코드 : settGbnm */
        listColumnDefs.add(new ColumnDef("정산구분", Yeta2000BM.ATTR_SETTGBNM, ColumnDef.TYPE_STRING , 90, true, false, true){
        	{
        ...
        /** column 재직구분코드 : hdofcDivCd */
        listColumnDefs.add(new ColumnDef("재직구분코드", Yeta2000BM.ATTR_HDOFCDIVCD, ColumnDef.TYPE_STRING , 90, false, false, true){
        	{

        	}
        });
        /** column 재직 : hdofcDivNm */
        listColumnDefs.add(new ColumnDef("재직", Yeta2000BM.ATTR_HDOFCDIVNM, ColumnDef.TYPE_STRING , 90, true, false, true){
        	{
