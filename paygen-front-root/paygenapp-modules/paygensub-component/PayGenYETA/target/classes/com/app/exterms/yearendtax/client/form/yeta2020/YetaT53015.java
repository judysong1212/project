...
import com.app.exterms.yearendtax.client.service.yeta2020.YetaT53015Service;
import com.app.exterms.yearendtax.client.service.yeta2020.YetaT53015ServiceAsync;
...
//import com.app.exterms.yearendtax.client.form.defs.yeta2016.YetaT53015Def;
...
=====================================================**/
public  class YetaT53015   extends MSFFormPanel {  
 ...
 **/
	...
	private  ContentPanel cpYetaT53015; 
	...
	// -------------- grid 선언 시작  ---------------	  
	private MSFGridPanel YetaT53015GridPanel;
//	private YetaT53015Def YetaT53015Def = new YetaT53015Def("YetaT53015");   //TODO 일단 화면번호로 Def
	// -------------- grid 선언 종료  ---------------
	...
	// -------------- 서비스 호출 시작 --------------
	private YetaT53015ServiceAsync yetaT53015Service = YetaT53015Service.Util.getInstance();
	// -------------- 서비스 호출 종료 --------------	 
...
//					ye162510Dto.setMnthRnttyHusCnttArea((MSFSharedUtils.allowNulls(bmMapModel.get("mnthRnttyHusCnttArea"))));    		/** column 월세주택계약면적 : mnthRnttyHusCnttArea */
				...
				yetaT53015Service.activityOnYetaT53015(listYe162510Dto, actionDatabase, new AsyncCallback<Long>(){
...
//		 }
	...
	public YetaT53015(final ActionDatabase actionDatabase, final MSFPanel caller) {
...
//		initLoad(); 	
		...
		this.actionDatabase = actionDatabase;
	 	...
	 	cpYetaT53015 = new ContentPanel();  

		createSearchForm();			//기본정보 필드를 적용
	 	createMsfGridForm();		//그리드필드
		   
		cpYetaT53015.setBodyBorder(false);
		cpYetaT53015.setBorders(false);
		cpYetaT53015.setHeaderVisible(false);
		cpYetaT53015.setSize("790px", "640px");
		   
		this.add(cpYetaT53015);
...
//		     });     
		...
		cpYetaT53015.setLayout(new FlowLayout());
...
//	      	     }
//				 
//				YetaT53015GridPanel.getMsfGrid().clearData();
//				 
//				BaseModel bmData = YetaT53015GridPanel.getTableDef().getDefaultValues();  
//		              
...
//		         
//		        YetaT53015GridPanel.getMsfGrid().getGrid().stopEditing();      
//		        YetaT53015GridPanel.getMsfGrid().getGrid().getStore().insert(bmData,0);   
//		        YetaT53015GridPanel.getMsfGrid().getGrid().startEditing(YetaT53015GridPanel.getMsfGrid().getGrid().getStore().indexOf(bmData), 0);   
//
...
//			public void handleEvent(ButtonEvent e) {
//				Iterator<BaseModel> itBm = YetaT53015GridPanel.getMsfGrid().getGrid().getSelectionModel().getSelectedItems().listIterator();
...
//			public void handleEvent(ButtonEvent e) {
//				setListRecord(YetaT53015GridPanel.getMsfGrid().getStore().getModifiedRecords().iterator());
//				doAction(actionDatabase);
//
//				if ((ActionDatabase.INSERT).equals(actionDatabase)) {
//					actionDatabase = ActionDatabase.INSERT;
...
//			topYetaBtnBar.add(btnYetaClose);
		...
		cpYetaT53015.add(topYetaBtnBar);
...
//		cpYetaT53015.add(topYetaBtnBar);
//		
//		YetaT53015GridPanel = new MSFGridPanel(YetaT53015Def, false, false, false, false, false);
//		YetaT53015GridPanel.setSize("790px", "420px");
//		YetaT53015GridPanel.setBorders(true);
//		YetaT53015GridPanel.setHeaderVisible(false);
...
//		
//		YetaT53015GridPanel.getGrid().getColumnModel().addAggregationRow(payrSummaryRow);  
//		
...
//		
//		YetaT53015GridPanel.getGrid().getColumnModel().addAggregationRow(payrSummaryRow1);
//		/** --- 그리드 합계 부분  종료 --- **/
		
 //       cpYetaT53015.add(YetaT53015GridPanel);
		FieldSet fieldSet = new FieldSet();
		...
		cpYetaT53015.add(fieldSet);
		cpYetaT53015.add(layoutContainer6);
		cpYetaT53015.add(fldstNewFieldset_1);
	...
	public void reload() {
			...
			YetaT53015GridPanel.getTableDef().setTableColumnFilters(filters);
			YetaT53015GridPanel.getTableDef().addColumnFilter("yrtxBlggYr", MSFSharedUtils.allowNulls(srhYrtxBlggYr.getValue())
...
//					, SimpleColumnFilter.OPERATOR_EQUALS);//연말정산귀속년도
			YetaT53015GridPanel.getTableDef().addColumnFilter("clutSeptCd", MSFSharedUtils.getSelectedComboValue(srhClutSeptCd,"commCd")
					, SimpleColumnFilter.OPERATOR_EQUALS);//정산구분
			YetaT53015GridPanel.getTableDef().addColumnFilter("systemkey", MSFSharedUtils.allowNulls(systemkey.getValue())
					, SimpleColumnFilter.OPERATOR_EQUALS);//시스템키
		 
			YetaT53015GridPanel.reload();
