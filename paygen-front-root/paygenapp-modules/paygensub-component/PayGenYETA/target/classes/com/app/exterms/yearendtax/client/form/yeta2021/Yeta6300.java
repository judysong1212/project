...
import com.app.exterms.yearendtax.client.form.defs.yeta2021.Ye161010Def;
import com.app.exterms.yearendtax.client.form.defs.yeta2021.Ye161030Def;
import com.app.exterms.yearendtax.client.form.defs.yeta2021.Ye161040Def;
import com.app.exterms.yearendtax.client.form.defs.yeta2021.Ye161090Def;
import com.app.exterms.yearendtax.client.form.defs.yeta2021.Ye169010Def;
import com.app.exterms.yearendtax.client.service.yeta2021.Yeta6300Service;
import com.app.exterms.yearendtax.client.service.yeta2021.Yeta6300ServiceAsync;
 ...
 */
public class Yeta6300 extends MSFPanel {

	private VerticalPanel vp;
	private FormPanel plFrmYeta6300;
	...
	// -------------- 탭 시작 --------------
	private TabPanel tabsYeta6300 = new TabPanel();		// 전체
	private TabPanel tabsItemYeta05 = new TabPanel();	// 특별소득공제 하위
	private TabPanel tabsItemYeta08 = new TabPanel();	// 세액감면및세액공제1 하위
	// -------------- 탭 종료 --------------

	// -------------- 상단 버튼 시작 --------------
	private ButtonBar topYeta6300Bar;
	private Button btnYeta6300All; 	// 일괄자료정리
	private Button btnYeta6300Reset; 	// 초기화
	private Button btnYeta6300New; 		// 신규
	private Button btnYeta6300Save; 	// 저장
	private Button btnYeta6300Del; 		// 삭제
	private Button btnYeta6300Sreach; 	// 조회
	private Button btnYeta6300Print; 	// 인쇄
	
	private RadioGroup printType;		// 대상자 선택
	// -------------- 상단 버튼 종료 --------------

	// -------------- 중간 버튼 시작 --------------
	private Button btnYeta6300_01;			// 의료비지급명세서
	private Button btnYeta6300_02; 			// 기부금명세서
	private Button btnYeta6300_03; 			// 재계산대상자
	private Button btnYeta6300_04; 			// 삭제
	private Button btnYeta6300_05; 			// 세액계산
	private Button btnYeta6300_06; 			// 세액재계산
	private Button btnYeta6300_07; 			// 원천징수인쇄
...
//	private Yeta2000BM yeta2000Bm;
	...
	// -------------- grid 선언 시작  ---------------
	private Ye161010Def ye161010Def  		= new Ye161010Def("Yeta6300"); 		// 대상자 정보 그리드 테이블 컬럼 define
	private Yeta2000Def Ye161010Def_02  	= new Yeta2000Def("YETA300001"); 	// 대상자 정보 그리드 새로고침을 위한 define
	private Ye169010Def ye169010Def  		= new Ye169010Def("Yeta6300");		// 세액계산 정보 그리드 테이블 컬럼 define 
	private Ye161030Def ye161030Def  		= new Ye161030Def("Yeta6300");		// 인적공제 정보 그리드 테이블 컬럼 define
	
	private Ye161040Def ye161040Def_01  	= new Ye161040Def("Yeta630001"); 	// 소득공제명세 그리드 테이블 컬럼 define(국세청자료)  
	private Ye161040Def ye161040Def_02  	= new Ye161040Def("Yeta630002"); 	// 소득공제명세 그리드 테이블 컬럼 define(기타자료)
	private Ye161090Def ye161090Def  		= new Ye161090Def("Yeta6300");
	
	
	private MSFGridPanel Yeta6300ToYe169010GridPanel;
	private MSFGridPanel Yeta6300ToYe161010GridPanel;		// 대상자정보 GridPanel
	private MSFGridPanel Yeta6300ToYe161030GridPanel;		// 인적공제 GridPanel
	private MSFGridPanel Yeta6300ToYe161040GridPanel_01;	// 소득공제 - 국세청 GridPanel
	private MSFGridPanel Yeta6300ToYe161040GridPanel_02;	// 소득공제 - 기타자료 GridPanel
//	private MSFGridPanel Yeta6300ToYe161090GridPanel;		// 가족교육비 GridPanel
	// -------------- grid 선언 종료  ---------------
...
//	private ListStore<BaseModel> lsCrClutMnth = new ListStore<BaseModel>(); 			//급여월
	...
	// -------------- 서비스 호출 시작 -------------- 
	private Yeta6300ServiceAsync yeta6300Service = Yeta6300Service.Util.getInstance();
	// -------------- 서비스 호출 종료 --------------
	 ...
	 */
	 private void checkYeta6300Auth( String authAction, ListStore<BaseModel>bm) {
	 ...
	 **/
	  ...
	  * </pre>
	  * @Method Name : fnYeta6300Payr06530CalcTax
	  * @date : Jan 26, 2016
	  * @author : leeheuisung
	  * @history : 
	  *	-----------------------------------------------------------------------
	  ...
	  *
	  */
	private void fnYeta6300Payr06530CalcTax() {
		...
		MessageBox.confirm("세액계산", "선택된 연말정산계산  대상자에 대해서 세액계산을 합니다. <br> 세액재계산을 하시겠습니까?",new Listener<MessageBoxEvent>(){
			...
			public void handleEvent(MessageBoxEvent be) {
				if (Dialog.YES.equals(be.getButtonClicked().getItemId())) {
					...
					Iterator<BaseModel> itBm = Yeta6300ToYe161010GridPanel.getMsfGrid().getGrid().getSelectionModel().getSelectedItems().listIterator();
					...
					if (MSFSharedUtils.paramNotNull(records)) {
			            ...
			            final Timer t = new Timer() {
			              ...
			              t.scheduleRepeating(500);
   	           	 		...
   	           	 		yeta6300Service.fnYeta6300_Ye161010_2021_CalcTax(listYe161010Dto,   new AsyncCallback<PagingLoadResult<ShowMessageBM>>() {
...
//   	           	                MSFMainApp.ADMINMESSAGES.ExceptionMessageService("activityOnInsertRemt0100(insert) : " + caught), null);
   	           	 			...
   	           	 			public void onSuccess(PagingLoadResult<ShowMessageBM> result) {  
   	           	 				...
   	           	 				//계산 결과에 따른 조회 호출 
   	           	 				BaseModel bmData = Yeta6300ToYe161010GridPanel.getCurrentlySelectedItem();  
   	           	 				...
   	           	 				Yeta6300ToYe161010Detail(bmData, "itemYeta01");
	...
	private void fnYeta6300Payr06530AllCalcTax() {
		...
		MessageBox.confirm("전체세액계산","선택된 연말정산계산  대상자에 대해서 전체세액계산을 합니다. <br> 세액재계산을 하시겠습니까?", new Listener<MessageBoxEvent>() {
			...
			public void handleEvent(MessageBoxEvent be) {
				if (Dialog.YES.equals(be.getButtonClicked().getItemId())) {
					...
					yeta6300Service.fnYeta6300Ye161010_2021_AllCalcTax(ye161010Dto ,new AsyncCallback<PagingLoadResult<ShowMessageBM>>() {
						public void onFailure(Throwable caught) {
...
//							reFresh();
	 ...
	 * ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
	 **/
		private void Yeta6300Print(String fileName, String repType) {
...
//			serarchParam += "[" + MSFSharedUtils.allowNulls(srhSystemkey.getValue())+"]";				//$12 시스템키 
			...
			List<BaseModel> list = Yeta6300ToYe161010GridPanel.getGrid().getSelectionModel().getSelectedItems();
...
//	      	}
	...
	public ContentPanel getViewPanel() {
		if (panel == null) {
			...
			createYeta6300Form(); 	// 화면 기본정보를 설정
			createSearchForm(); 	// 검색필드를 적용
			...
			// 폼데이터를 바인딩
			// formBinding = new FormBinding(this.plFrmYeta6300, true);
	...
	public Yeta6300(String txtForm) {
...
//		btnBar.add(btnNewButton_4);
		...
		Button btnYeta6300_05 = new Button("세액계산");
		btnYeta6300_05.setIcon(MSFMainApp.ICONS.save16());
		btnBar.add(btnYeta6300_05);
		btnYeta6300_05.addListener(Events.Select, new Listener<ButtonEvent>() {
    		public void handleEvent(ButtonEvent e) {
    		 
    	        fnYeta6300Payr06530CalcTax();
    		}
    	});
		...
		plFrmYeta6300.add(conLayoutContainer);

	}

	private void createYeta6300Form() {

		plFrmYeta6300 = new FormPanel();
		plFrmYeta6300.setHeadingText(PayGenConst.PAYGEN_VERSION.concat(" - 소득공제신고자료관리"));
		plFrmYeta6300.setIcon(MSFMainApp.ICONS.text());
		plFrmYeta6300.setBodyStyleName("pad-text");
		plFrmYeta6300.setFrame(true);
		plFrmYeta6300.setPadding(2);
//		plFrmYeta6300.setSize("990px", "780px");
		//엣지변환
		//plFrmYeta6300.setSize("990px", "830px");
		plFrmYeta6300.setSize("990px", "1080px");
		...
		btnlogView.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				 //로그 뷰화면 호출 메서드 
				  funcLogMessage("소득공제신고자료관리","Yeta6300");
				}
			});
		plFrmYeta6300.getHeader().setStyleAttribute("padding", "5px 0 2px 0");
		plFrmYeta6300.getHeader().addTool(btnlogView); 
		/************************************************************************
		 * 화면 에러 처리시 필요한 부분으로 추가 
		 ************************************************************************/

		//멀티콤보박스 닫기 
		plFrmYeta6300.addListener(Events.OnClick,new Listener<ComponentEvent>() { 
			@Override
		...
		topYeta6300Bar = new ButtonBar();
		topYeta6300Bar.setAlignment(HorizontalAlignment.RIGHT);
		
		if ("admin".equals(MSFMainApp.get().getUser().getUsrId()) || "D0010090".equals(MSFMainApp.get().getUser().getUsrDivCd())) {	
			btnYeta6300All = new Button("일괄자료정리");
			btnYeta6300All.setIcon(MSFMainApp.ICONS.new16());
			topYeta6300Bar.add(btnYeta6300All);
			btnYeta6300All.addListener(Events.Select, new Listener<ButtonEvent>() {
				public void handleEvent(ButtonEvent e) {
...
//	                    ye161030Dto.setFamyRelaDivCd(MSFSharedUtils.allowNulls(bmMapModel.get("famyRelaDivCd")));    	/** column 인사가족관계코드 : famyRelaDivCd */
					...
					yeta6300Service.updateYeta6300All(listYe161040Dto, new AsyncCallback<Integer>() {

						public void onFailure(Throwable caught) {
							MessageBox.alert( MSFMainApp.MSFCONSTANTS.ExceptionTitleService()
												, MSFMainApp.ADMINMESSAGES.ExceptionMessageService("activityOnYeta6300ToYe161030("+ actionDatabase.name()+ ") : " + caught)
												, null);
							}
		...
		btnYeta6300Reset = new Button("초기화");
		btnYeta6300Reset.setIcon(MSFMainApp.ICONS.new16());
		btnYeta6300Reset.addListener(Events.Select, new Listener<ButtonEvent>() {
			@Override
			public void handleEvent(ButtonEvent be) {
				// TODO Auto-generated method stub
				...
				tabsYeta6300.setSelection(tabsYeta6300.getItem(0));//탭부분 초기화
			}
		});
		topYeta6300Bar.add(btnYeta6300Reset);

		btnYeta6300Save = new Button("저장");
		btnYeta6300Save.setIcon(MSFMainApp.ICONS.save16());
		topYeta6300Bar.add(btnYeta6300Save);
		btnYeta6300Save.addListener(Events.Select, new Listener<ButtonEvent>() {
			@Override
			public void handleEvent(ButtonEvent be) {
				// TODO Auto-generated method stub  
				//  {-- 기본사항 --}
				if("itemYeta01".equals(tabsYeta6300.getSelectedItem().getId())) {
					
					itemYeta01Save();	// 기본사항 저장
					
				//  {-- 인적공제 --}	
				}else if("itemYeta02".equals(tabsYeta6300.getSelectedItem().getId())) {
					
					itemYeta02Save();	// 인적공제 저장
					
				//	{-- 소득공제 --}	
				}else if("itemYeta03".equals(tabsYeta6300.getSelectedItem().getId())) {
					
					itemYeta03Save();	// 소득공제 저장
					
				// {-- 연금보험료공제--}	
				} else if ("itemYeta04".equals(tabsYeta6300.getSelectedItem().getId())) {
				
					itemYeta04Save();	// 국민연금보험료외의 연금보험료 저장
					
				// {-- 특별소득공제 --}
				} else if ("itemYeta05".equals(tabsYeta6300.getSelectedItem().getId())) {
				...
				// {-- 그밖의 소득공제--}	
				}else if("itemYeta06".equals(tabsYeta6300.getSelectedItem().getId())) {
					
					itemYeta06Save();	// 그밖의소득공제1 저장
					
				}else if("itemYeta07".equals(tabsYeta6300.getSelectedItem().getId())) {
					
					itemYeta07Save();	// 그밖의소득공제2 저장
					
				//{-- 세액감면및세액공제--}	
				}else if("itemYeta08".equals(tabsYeta6300.getSelectedItem().getId())) {
				...
				} else if ("itemYeta09".equals(tabsYeta6300.getSelectedItem().getId())) {

					// 세액감면및세액공제2 저장
					itemYeta09Save();
					
				// {-- 추가제출서류 --}
				} else if ("itemYeta10".equals(tabsYeta6300.getSelectedItem().getId())) {
...
//		btnYeta6300Del = new Button("삭제");
//		btnYeta6300Del.setIcon(MSFMainApp.ICONS.delete16());
//		topYeta6300Bar.add(btnYeta6300Del);
...
//		printType.add(radio3);
		...
		topYeta6300Bar.add(printType);

		btnYeta6300Sreach = new Button("조회");
		btnYeta6300Sreach.setIcon(MSFMainApp.ICONS.search16());
		btnYeta6300Sreach.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				//탭 선택 없애기
				tabsYeta6300.setSelection(tabsYeta6300.getItem(0));
				//대상자 정보 조회
				reload();
			}
		});
		topYeta6300Bar.add(btnYeta6300Sreach);

//		btnYeta6300Print = new Button("인쇄");
//		btnYeta6300Print.setIcon(MSFMainApp.ICONS.print16());
//		topYeta6300Bar.add(btnYeta6300Print);

		plFrmYeta6300.add(topYeta6300Bar);

		// 파일업로드 처리
		plFrmYeta6300.setAction("myurl");
		plFrmYeta6300.setEncoding(Encoding.MULTIPART);
		plFrmYeta6300.setMethod(Method.POST);

		vp.add(plFrmYeta6300);
		
		// plFrmYeta6300.setSize("990px", "730px");
	...
	private LayoutContainer createListGrid() {
	    ...
	    Yeta6300ToYe161010GridPanel = new MSFGridPanel(ye161010Def, false, false, false, false, false);
	    Yeta6300ToYe161010GridPanel.setHeaderVisible(false);  
	    Yeta6300ToYe161010GridPanel.setBodyBorder(true);
	    Yeta6300ToYe161010GridPanel.setBorders(true);
	    final Grid yeta300ToYeta2000Grid = Yeta6300ToYe161010GridPanel.getMsfGrid().getGrid();
...
//        	   funcSetPopUpRecord();
	    ...
	    cpGrid.add(Yeta6300ToYe161010GridPanel); 
...
//		plFrmYeta6300.add(deptNm);
		...
		plFrmYeta6300.setLayout(new FlowLayout());
			...
			public void handleEvent(StoreEvent<BaseModel> be) {  
				...
				if (type == Store.Add) { 
		             ...
		             * "srhPayrMangDeptCd","srhEmymtDivCd","srhDeptCd","srhTypOccuCd","srhBusinCd"
						++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++*/ 
						checkYeta6300Auth("srhPayrMangDeptCd", lsPayrMangDeptCd); 
				}
			}
		});
	        ...
	        public void handleEvent(StoreEvent<BaseModel> be) {  
	        	  EventType type = be.getType();
		    	   if (type == Store.Add) { 
	           		  ...
	           		  * "srhPayrMangDeptCd","srhEmymtDivCd","srhDeptCd","srhTypOccuCd","srhBusinCd"
		         		++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++*/ 
		                	checkYeta6300Auth("srhEmymtDivCd", lsEmymtDivCd); 
		    	   }
	        }
	    });    
	    ...
	    srhDeptCd.getStore().addStoreListener( new StoreListener<ModelData>() {   
	    	public void handleEvent(StoreEvent<ModelData> be) {  
	    		...
	    		if (type == Store.Add) { 
	    			 ...
	    			 * "srhPayrMangDeptCd","srhEmymtDivCd","srhDeptCd","srhTypOccuCd","srhBusinCd"
						++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++*/ 
	    			checkYeta6300Auth("srhDeptCd", lsDeptCd); 
	    		}
	    	}
	    });    
		...
		srhTypOccuCd.getStore().addStoreListener( new StoreListener<ModelData>() {   
			public void handleEvent(StoreEvent<ModelData> be) {  
				...
				if (type == Store.Add) { 
					 ...
					 * "srhPayrMangDeptCd","srhEmymtDivCd","srhDeptCd","srhTypOccuCd","srhBusinCd"
			    		++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++*/ 
						//checkYeta6300Auth("srhTypOccuCd", lsTypOccuCd); 
				}
			}
		});     
		...
		fileSbtBtn.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				...
				if (systemkey.getValue() == null) {
					...
					YetaP620003 yetaP620003Form = new YetaP620003(ActionDatabase.READ, getThis());
					final MSFFormWindows msFwYeta620003 = new MSFFormWindows("자료추출상세내역",yetaP620003Form, "닫기", "690px", "250px", false);
					msFwYeta620003.show();
					yetaP620003Form.setMSFFormWindows(msFwYeta620003);
					// 팝업이 닫히면 탭을 다시 조회한다.
					msFwYeta620003.addListener(Events.Hide,new Listener<BaseEvent>() { 
			    		@Override
			    		public void handleEvent(BaseEvent be) { 
			    			getItemYeta01();
			    		}
					...
					MessageBox.confirm("소득공제신고서 재적용", "선택된 대상자의 기존 정보를 삭제 후 재적용합니다.<br> 진행 하시겠습니까?",new Listener<MessageBoxEvent>(){
						...
						public void handleEvent(MessageBoxEvent be) {
							if (Dialog.YES.equals(be.getButtonClicked().getItemId())) {
								...
								yeta6300Service.fnYeta6300Ye161010_2021_SbtVolUse(ye161010Dto ,new AsyncCallback<PagingLoadResult<ShowMessageBM>>() {
									public void onFailure(Throwable caught) {
...
//										reFresh();
		...
		fileSbtBtn01.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				...
				if (systemkey.getValue() == null) {
					...
					YetaP620001 yetaP620001Form = new YetaP620001(ActionDatabase.READ, getThis());
					MSFFormWindows msFwYeta620001 = new MSFFormWindows("자료추출상세내역",yetaP620001Form, "닫기", "920px", "710px", false);
					msFwYeta620001.show();
					yetaP620001Form.setMSFFormWindows(msFwYeta620001);
		...
		fileSbtBtn02.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				...
				if (systemkey.getValue() == null) {
					...
					YetaP620002 yetaP620002Form = new YetaP620002(ActionDatabase.READ, getThis());
					final MSFFormWindows msFwYeta620002 = new MSFFormWindows("자료추출상세내역",yetaP620002Form, "닫기", "945px", "710px", false);
					msFwYeta620002.show();
					yetaP620002Form.setMSFFormWindows(msFwYeta620002);
		...
		tabsYeta6300 = new TabPanel();
		tabsYeta6300.setAutoWidth(false);
		tabsYeta6300.setAnimScroll(false);
		tabsYeta6300.setTabScroll(true);
		tabsYeta6300.setPlain(true);
		//엣지변환
		//tabsYeta6300.setSize(660, 720);
		tabsYeta6300.setSize(660, 920);
		tabsYeta6300.addListener(Events.Select, new Listener<TabPanelEvent>() {
			public void handleEvent(TabPanelEvent e) {
				// 탭선택
				Yeta6300ToYe161010Detail( Yeta6300ToYe161010GridPanel.getCurrentlySelectedItem(), tabsYeta6300.getSelectedItem().getId()); 
		...
		itemYeta08.addListener(Events.Select, new Listener<TabPanelEvent>() {
			public void handleEvent(TabPanelEvent e) {
				...
				//탭선택
				Yeta6300ToYe161010Detail(Yeta6300ToYe161010GridPanel.getCurrentlySelectedItem(), tabsItemYeta08.getSelectedItem().getId());

			}
		});
		
		
		tabsYeta6300.add(itemYeta08);		
		...
		tabsYeta6300.add(itemYeta10);	
		

		fieldSet.add(tabsYeta6300);
	 ...
	 private LayoutContainer occupationalRBottom2() {
		 ...
		 Yeta6300ToYe161030GridPanel = new MSFGridPanel(ye161030Def, false, false, false, false, false);
		 Yeta6300ToYe161030GridPanel.setHeaderVisible(false);  
		 Yeta6300ToYe161030GridPanel.setBodyBorder(true);
		 Yeta6300ToYe161030GridPanel.setBorders(true);
		    
		 cpGrid.add(Yeta6300ToYe161030GridPanel); 
...
//	 }
	 ...
	 private LayoutContainer occupationalRBottom3_01() {
		 ...
		 Yeta6300ToYe161040GridPanel_01 = new MSFGridPanel(ye161040Def_01, false, false, false, false, false);
		 Yeta6300ToYe161040GridPanel_01.setHeaderVisible(false);  
		 Yeta6300ToYe161040GridPanel_01.setBodyBorder(true);
		 Yeta6300ToYe161040GridPanel_01.setBorders(true);
		 Yeta6300ToYe161040GridPanel_01.getBottomComponent().setVisible(false);
		 Yeta6300ToYe161040GridPanel_01.getGrid().getColumnModel().addHeaderGroup(0, 2, new HeaderGroupConfig("보험료", 1, 4));
		 Yeta6300ToYe161040GridPanel_01.getGrid().getColumnModel().addHeaderGroup(0, 8, new HeaderGroupConfig("신용카드 등 사용액", 1, 6)); 
		 ...
		 Yeta6300ToYe161040GridPanel_01.getGrid().getColumnModel().addAggregationRow(payrSummaryRow); 
		    
		 
		 cpGrid.add(Yeta6300ToYe161040GridPanel_01); 
	 ...
	 private LayoutContainer occupationalRBottom3_02() {
		 ...
		 Yeta6300ToYe161040GridPanel_02 = new MSFGridPanel(ye161040Def_02, false, false, false, false, false);
		 Yeta6300ToYe161040GridPanel_02.setHeaderVisible(false);  
		 Yeta6300ToYe161040GridPanel_02.setBodyBorder(true);
		 Yeta6300ToYe161040GridPanel_02.setBorders(true);
		 Yeta6300ToYe161040GridPanel_02.getBottomComponent().setVisible(false);
		 
		 Yeta6300ToYe161040GridPanel_02.getGrid().getColumnModel().addHeaderGroup(0, 2, new HeaderGroupConfig("보험료", 1, 4));
		 Yeta6300ToYe161040GridPanel_02.getGrid().getColumnModel().addHeaderGroup(0, 8, new HeaderGroupConfig("신용카드 등 사용액", 1, 6)); 
		 ...
		 Yeta6300ToYe161040GridPanel_02.getGrid().getColumnModel().addAggregationRow(payrSummaryRow); 
		    
		 cpGrid.add(Yeta6300ToYe161040GridPanel_02); 
...
//			dtyStrtDt.setHeight("");
		...
		btnNewButton.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				...
				//전체내역  
				YetaP63006 yetaP63006Form = new YetaP63006(ActionDatabase.READ, getThis());   
							    
				MSFFormWindows msFwYeta63006 = new MSFFormWindows("종전근무지등록", yetaP63006Form, "닫기", "960px", "710px", true);
				msFwYeta63006.show();
				yetaP63006Form.setMSFFormWindows(msFwYeta63006);
					
				funcSetPopUpRecord();
				yetaP63006Form.bind(ppRecord); 
				
				// 팝업이 닫히면 탭을 다시 조회한다.
				msFwYeta63006.addListener(Events.Hide, new Listener<BaseEvent>() { 
		    		@Override
		    		public void handleEvent(BaseEvent be) { 
		    			getItemYeta01();
		    		}
...
//										    
//					MSFFormWindows msFwYeta63009 = new MSFFormWindows("주현근무지등록", yetaP03009Form, "닫기", "820px", "710px", true);
//					msFwYeta63009.show();
//					yetaP03009Form.setMSFFormWindows(msFwYeta63009);
//					//TODO 추후 주석해제 
...
//			layoutContainer_49_2.add(btnNewButton1);
		...
		btnNewButton1.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				// 전체내역
				YetaP63008 yetaP63008Form = new YetaP63008(ActionDatabase.READ, getThis());   
									    
				MSFFormWindows msFwYeta63008 = new MSFFormWindows("현비과세및감면", yetaP63008Form, "닫기", "820px", "710px", true);
				msFwYeta63008.show();
				yetaP63008Form.setMSFFormWindows(msFwYeta63008);
					
				funcSetPopUpRecord();
				 
				yetaP63008Form.bind(ppRecord); 
			}
		});			
...
//		layoutContainer_20.setHeight("100");
		...
		Yeta6300ToYe169010GridPanel = new MSFGridPanel(ye169010Def, false, false,false, false, false);
		Yeta6300ToYe169010GridPanel.setHeaderVisible(false);
		Yeta6300ToYe169010GridPanel.setBodyBorder(true);
		Yeta6300ToYe169010GridPanel.setBorders(true);
		Yeta6300ToYe169010GridPanel.getBottomComponent().setVisible(false);
		//
		cpGrid.add(Yeta6300ToYe169010GridPanel);
		...
		button2.addListener(Events.Select, new Listener<ButtonEvent>() {
			...
			public void handleEvent(ButtonEvent be) {
				...
				yeta6300Service.getYeta6300TxDdcYnToYe161020Data(ye161020Dto, new AsyncCallback<Ye161020DTO>() {
...
//							if (result.getC152StdTxDdcYn() == "Y" || "N".equals(result.getC152StdTxDdcYn())) {
								//전체내역  
								YetaT630171 yetaT630171Form = new YetaT630171(ActionDatabase.READ, getThis());   
										    
								MSFFormWindows msFwYetaT630171 = new MSFFormWindows("기본세액공제", yetaT630171Form, "닫기", "650px", "710px", true);
								msFwYetaT630171.show();
								yetaT630171Form.setMSFFormWindows(msFwYetaT630171);
					...
					public void onFailure(Throwable caught) {
						...
						public void onSuccess(Ye161020DTO result) {
							...
							if (result.getC152StdTxDdcYn() == "Y" || "Y".equals(result.getC152StdTxDdcYn())) {
								//전체내역  
								YetaT63017 yetaT63017Form = new YetaT63017(ActionDatabase.READ, getThis());   
										    
								MSFFormWindows msFwYetaT63017 = new MSFFormWindows("표준세액공제", yetaT63017Form, "닫기", "650px", "710px", true);
								msFwYetaT63017.show();
								yetaT63017Form.setMSFFormWindows(msFwYetaT63017);
...
//								funcSetPopUpRecord();
	...
	private LayoutContainer yetaData02() {
		...
		btnYeta3220New.addListener(Events.Select, new Listener<ButtonEvent>() {
			...
			public void handleEvent(ButtonEvent be) {
				...
				if (MSFSharedUtils.paramNull(systemkey.getValue())) {
	          	...
	          	//가족사항등록 
				YetaP630012 payrP41003Form = new YetaP630012(ActionDatabase.INSERT, getThis());   
		...
		btnYeta3220Del.addListener(Events.Select, new Listener<ButtonEvent>() {
			...
			public void handleEvent(ButtonEvent be) {
				...
				Iterator<BaseModel> itBm = Yeta6300ToYe161030GridPanel.getMsfGrid().getGrid().getSelectionModel().getSelectedItems().listIterator();
				...
				MessageBox.confirm("삭제", "선택하신 인적공제명세를 삭제하시겠습니까?</br> (삭제시 관련된  교육비, 의료비 등의 내역도 같이 삭제 처리 됩니다. )",new Listener<MessageBoxEvent>(){
					...
					public void handleEvent(MessageBoxEvent be) {
						if(Dialog.YES.equals(be.getButtonClicked().getItemId())){
							yeta6300Service.activityOnYeta6300ToYe161030(listYe161030Dto ,actionDatabase, new AsyncCallback<Long>() {
	...
	private LayoutContainer yetaData04() {
		...
		btnNewButton_9.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				// 전체내역
				YetaP63007 yetaP63007Form = new YetaP63007(ActionDatabase.READ, getThis());

				MSFFormWindows msFwYeta63007 = new MSFFormWindows("연금저축소득공제",yetaP63007Form, "닫기", "820px", "550px", true);
				msFwYeta63007.show();
				yetaP63007Form.setMSFFormWindows(msFwYeta63007);
				
				msFwYeta63007.addListener(Events.Hide,new Listener<BaseEvent>() { 
		    		@Override
		    		public void handleEvent(BaseEvent be) { 
		    			getItemYeta04();
		    		}
	...
	private LayoutContainer yetaData05() {
		...
		tabsItemYeta05.addListener(Events.Select, new Listener<TabPanelEvent>() {
			public void handleEvent(TabPanelEvent e) {
				Yeta6300ToYe161010Detail(Yeta6300ToYe161010GridPanel.getCurrentlySelectedItem(), tabsItemYeta05.getSelectedItem().getId());
			}
		});
...
//		LayoutContainer layoutContainer_301 = new LayoutContainer();
		...
		btnNewButton_15.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				//전체내역  
				YetaP63004 yetaP63004Form = new YetaP63004(ActionDatabase.READ, getThis());   
					    
				MSFFormWindows msFwYeta63004 = new MSFFormWindows("거주자간 주택임차차입금 원리금 상환액", yetaP63004Form, "닫기", "820px", "600px", true);
				msFwYeta63004.show();
				yetaP63004Form.setMSFFormWindows(msFwYeta63004);
				 
				funcSetPopUpRecord();
				//TODO 추후 주석해제 
				yetaP63004Form.bind(ppRecord); 
			}
		});	
...
//
//				MSFFormWindows msFwYeta63005 = new MSFFormWindows("월세액소득공제명세",yetaP23005Form, "닫기", "820px", "510px", true);
//				msFwYeta63005.show();
//				yetaP23005Form.setMSFFormWindows(msFwYeta63005);
//
//				funcSetPopUpRecord();
...
//		layoutContainer_224.add(layoutContainer_243);
		...
		layoutContainer_254.add(cpiv19AsctUseAmt, new FormData("100%"));
		...
		LabelField lblfldNewLabelfield_36 = new LabelField("(2019년조합)");
		...
		layoutContainer_2545.add(cpiv19VntUseAmt, new FormData("100%"));
		...
		LabelField lblfldNewLabelfield_366 = new LabelField("(2019년벤처)");
		...
		cpiv19AsctTwoUseAmt = new MSFNumberField();
		cpiv19AsctTwoUseAmt.setFieldLabel("출자∙투자금액");
		cpiv19AsctTwoUseAmt.setAllowDecimals(true); 
		cpiv19AsctTwoUseAmt.setPropertyEditorType(Long.class); 
		cpiv19AsctTwoUseAmt.setFormat(NumberFormat.getDecimalFormat());
		
		layoutContainer_25421.add(cpiv19AsctTwoUseAmt, new FormData("100%"));
		...
		LabelField lblfldNewLabelfield_3621 = new LabelField("(2019년조합2)");
		...
		layoutContainer_254a.add(cpiv20AsctUseAmt, new FormData("100%"));
		...
		LabelField lblfldNewLabelfield_36a = new LabelField("(2020년조합)");
		...
		layoutContainer_2545a.add(cpiv20VntUseAmt, new FormData("100%"));
		...
		LabelField lblfldNewLabelfield_366a = new LabelField("(2020년벤처)");
		...
		layoutContainer_25421a.add(cpiv20AsctTwoUseAmt, new FormData("100%"));
		...
		LabelField lblfldNewLabelfield_3621a = new LabelField("(2020년조합2)");
		...
		layoutContainer_254b.add(cpiv21AsctUseAmt, new FormData("100%"));
		...
		LabelField lblfldNewLabelfield_36b = new LabelField("(2021년조합)");
		...
		layoutContainer_2545b.add(cpiv21VntUseAmt, new FormData("100%"));
		...
		LabelField lblfldNewLabelfield_366b = new LabelField("(2021년벤처)");
		...
		layoutContainer_25421b.add(cpiv21AsctTwoUseAmt, new FormData("100%"));
		...
		LabelField lblfldNewLabelfield_3621b = new LabelField("(2021년조합2)");
...
//
		...
		layoutContainer_248.add(cpiv19AsctDdcAmt, new FormData("100%"));
		layoutContainer_225.add(layoutContainer_248);

		// 기타공제_투자조합출자소득공제_2019년이후 공제액
		...
		layoutContainer_2522.add(cpiv19VntDdcAmt, new FormData("100%"));
		...
		cpiv19AsctTwoDdcAmt = new MSFNumberField();
		cpiv19AsctTwoDdcAmt.setReadOnly(true);
		cpiv19AsctTwoDdcAmt.setFieldLabel("공제액");
		cpiv19AsctTwoDdcAmt.setAllowDecimals(true); 
		cpiv19AsctTwoDdcAmt.setPropertyEditorType(Long.class); 
		cpiv19AsctTwoDdcAmt.setFormat(NumberFormat.getDecimalFormat());
		
		layoutContainer_24821.add(cpiv19AsctTwoDdcAmt, new FormData("100%"));
		...
		layoutContainer_248a.add(cpiv20AsctDdcAmt, new FormData("100%"));
		...
		layoutContainer_2522a.add(cpiv20VntDdcAmt, new FormData("100%"));
		...
		layoutContainer_24821a.add(cpiv20AsctTwoDdcAmt, new FormData("100%"));
	...
	//----------------------- 2021 공제액  -------------------------------------------------
		...
		layoutContainer_248b.add(cpiv21AsctDdcAmt, new FormData("100%"));
		...
		layoutContainer_2522b.add(cpiv21VntDdcAmt, new FormData("100%"));
		...
		layoutContainer_24821b.add(cpiv21AsctTwoDdcAmt, new FormData("100%"));
...
//		layoutContainer_132.add(layoutContainer_145);
	...
	private LayoutContainer yetaData08() {
		...
		btnNewButton_10.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				//전체내역  
				YetaP63002 yetaP23002Form = new YetaP63002(ActionDatabase.READ, getThis());   
				    
				MSFFormWindows msFwYeta63002 = new MSFFormWindows("의료비내역등록", yetaP23002Form, "닫기", "820px", "710px", true);
				msFwYeta63002.show();
				yetaP23002Form.setMSFFormWindows(msFwYeta63002);
				
				msFwYeta63002.addListener(Events.Hide,new Listener<BaseEvent>() { 
		    		@Override
		    		public void handleEvent(BaseEvent be) { 
		    			getItemYeta08();
		    		}
...
//		layoutContainer_376.setLayout(new ColumnLayout());
		...
		btnNewButton_11.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				//전체내역  
				YetaP630011 yetaP230011Form = new YetaP630011(ActionDatabase.READ, getThis());   
				    
				MSFFormWindows msFwYeta630011 = new MSFFormWindows("교육비내역등록", yetaP230011Form, "닫기", "820px", "730px", true);
				msFwYeta630011.show();
				yetaP230011Form.setMSFFormWindows(msFwYeta630011);
				
				msFwYeta630011.addListener(Events.Hide,new Listener<BaseEvent>() { 
		    		@Override
		    		public void handleEvent(BaseEvent be) { 
		    			getItemYeta08();
		    		}
...
//				    
//				MSFFormWindows msFwYeta63001 = new MSFFormWindows("이월기부금등록", yetaP23001Form, "닫기", "820px", "710px", true);
//				msFwYeta63001.show();
//				yetaP23001Form.setMSFFormWindows(msFwYeta63001);
//				
//				funcSetPopUpRecord();
//				
//				//TODO 추후 주석해제 
...
//		});
		...
		btnNewButton_14.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				//전체내역  
				YetaP63003 yetaP23003Form = new YetaP63003(ActionDatabase.READ, getThis());   
				    
				MSFFormWindows msFwYeta63003 = new MSFFormWindows("기부금내역등록", yetaP23003Form, "닫기", "820px", "510px", true);
				msFwYeta63003.show();
				yetaP23003Form.setMSFFormWindows(msFwYeta63003);
				
				msFwYeta63003.addListener(Events.Hide,new Listener<BaseEvent>() { 
		    		@Override
		    		public void handleEvent(BaseEvent be) { 
		    			getItemYeta08();
		    		}
		...
		btnNewButton_13.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				//전체내역  
				YetaP63001 yetaP23001Form = new YetaP63001(ActionDatabase.READ, getThis());   
				    
				MSFFormWindows msFwYeta63001 = new MSFFormWindows("기부금조정명세", yetaP23001Form, "닫기", "820px", "710px", true);
				msFwYeta63001.show();
				yetaP23001Form.setMSFFormWindows(msFwYeta63001);
				
				msFwYeta63001.addListener(Events.Hide,new Listener<BaseEvent>() { 
		    		@Override
		    		public void handleEvent(BaseEvent be) { 
		    			getItemYeta05();
		    		}
...
//		layoutContainer_154.add(layoutContainer_160);
		...
		btnNewButton_16.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				// 전체내역
				YetaP63005 yetaP23005Form = new YetaP63005(ActionDatabase.READ,getThis());

				MSFFormWindows msFwYeta63005 = new MSFFormWindows("월세액소득공제명세",yetaP23005Form, "닫기", "820px", "510px", true);
				msFwYeta63005.show();
				yetaP23005Form.setMSFFormWindows(msFwYeta63005);
				
				msFwYeta63005.addListener(Events.Hide,new Listener<BaseEvent>() { 
		    		@Override
		    		public void handleEvent(BaseEvent be) { 
		    			getItemYeta09();
		    		}
				...
				public void handleEvent(BaseEvent be) {
					...
					if (mapModels != null) { 
						...
						yeta6300Service.activityOnYeta6300ToYe161030(listYe161030Dto, actionDatabase, new AsyncCallback<Long>() {
							...
							public void onFailure(Throwable caught) {
								MessageBox.alert(MSFMainApp.MSFCONSTANTS.ExceptionTitleService(), 
									MSFMainApp.ADMINMESSAGES.ExceptionMessageService("activityOnYeta6300ToYe161030(" + actionDatabase.name() + ") : " + caught), null);
							}
							public void onSuccess(Long result) {  
								reloadYe161030();
							}   
...
//						}    
//		                
//						yeta6300Service.saveYeta6300ToYe161090tabItem08_3(listYe161090Dto, actionDatabase, new AsyncCallback<Long>() {
//			    			 
//							public void onFailure(Throwable caught) {
//								MessageBox.alert(MSFMainApp.MSFCONSTANTS.ExceptionTitleService(), 
//												MSFMainApp.ADMINMESSAGES.ExceptionMessageService("saveYeta6300ToYe161090tabItem08_3(" + actionDatabase.name() + ") : " + caught), null);
//							}
//							public void onSuccess(Long result) {  
//								reloadYe161090Grid();
//							
...
//		ye161020Dto.setPrifChngYn(ye161020Dto.getPrifChngYn());    /** column 인적공제항목변동여부 : prifChngYn */
		...
		yeta6300Service.saveYeta6300ToYe161020tabItem01(ye161020Dto, new AsyncCallback<Integer>() {
			@Override
			public void onFailure(Throwable caught) {
				// TODO Auto-generated method stub
					MessageBox.alert(MSFMainApp.MSFCONSTANTS.ExceptionTitleService(), 
	...
	public void itemYeta02Save() {
		...
		Iterator<Record> iterRecords = Yeta6300ToYe161030GridPanel.getMsfGrid().getGrid().getStore().getModifiedRecords().iterator(); 
...
//	        yeta3220Dto.setBeforeJumin(MSFSharedUtils.allowNulls(bmMapModel.get("rsnoNumb2")));
	...
	public void itemYeta03Save() {
		...
		//국세청자료 grid
		Iterator<Record> iterRecords = Yeta6300ToYe161040GridPanel_01.getMsfGrid().getGrid().getStore().getModifiedRecords().iterator(); 
		...
		//기타자료 grid
		iterRecords = Yeta6300ToYe161040GridPanel_02.getMsfGrid().getGrid().getStore().getModifiedRecords().iterator(); 
		...
		yeta6300Service.saveYeta6300ToYe1610400tabItem03(listYe161040Dto_01, listYe161040Dto_02, new AsyncCallback<Integer>() {
	...
	public void itemYeta04Save() {
		...
		yeta6300Service.saveYeta6300ToYe161055tabItem04(ye161055Dto, new AsyncCallback<Integer>() {
	...
	public void itemYeta05_1Save() {
		...
		yeta6300Service.saveYeta6300ToYe161060tabItem05_1(ye161060Dto, new AsyncCallback<Integer>() {
	...
	public void itemYeta05_2Save() {
		...
		yeta6300Service.saveYeta6300ToYe161060tabItem05_2(ye161060Dto, new AsyncCallback<Integer>() {
	...
	public void itemYeta06Save() {
		...
		ye161070Dto.setCpiv19AsctUseAmt			((Long) cpiv19AsctUseAmt.getValue());    	/** column 출자투자금액_조합등_2019납입금 : cpiv19AsctUseAmt */
		ye161070Dto.setCpiv19AsctDdcAmt			((Long) cpiv19AsctDdcAmt.getValue());    	/** column 출자투자금액 조합등_2019공제액 : cpiv19AsctDdcAmt */
		ye161070Dto.setCpiv19AsctTwoUseAmt			((Long) cpiv19AsctTwoUseAmt.getValue());    	/** column 출자투자금액_조합2등_2019납입금 : cpiv19AsctTwoUseAmt */
		ye161070Dto.setCpiv19AsctTwoDdcAmt			((Long) cpiv19AsctTwoDdcAmt.getValue());    	/** column 출자투자금액 조합2등_2019공제액 : cpiv19AsctTwoDdcAmt */
		ye161070Dto.setCpiv19VntUseAmt			((Long) cpiv19VntUseAmt.getValue());    	/** column 출자투자금액벤처등_2019납입금액 : cpiv19VntUseAmt */
		ye161070Dto.setCpiv19VntDdcAmt			((Long) cpiv19VntDdcAmt.getValue());    	/** column 출자투자금액벤처등_2019공제액 : cpiv19VntDdcAmt */
...
//		ye161070Dto.setTyShfyPrsAddDdcrtUseAmt	((Long) tyShfyPrsAddDdcrtUseAmt.getValue());/** column 본인추가공제율사용분_2016_상반기 : tyShfyPrsAddDdcrtUseAmt */
		...
		yeta6300Service.saveYeta6300ToYe161070tabItem06(ye161070Dto, new AsyncCallback<Integer>() {
	...
	public void itemYeta07Save() {
		...
		yeta6300Service.saveYeta6300ToYe161070tabItem07(ye161070Dto, new AsyncCallback<Integer>() {
...
//		ye161080Vo.setYupSnmcReEndDt(ye161080Dto.getYupSnmcReEndDt());    /** column 중소기업취업자감면기간종료일자 : yupSnmcReEndDt */
		...
		yeta6300Service.saveYeta6300ToYe161080tabItem08_1(ye161080Dto, new AsyncCallback<Integer>() {
...
//		ye161080Dto.setScxpsDsbrCount		((Long) scxpsDsbrCount.getValue());    	/** column 교육비_장애인인원수 : scxpsDsbrCount */
		...
		yeta6300Service.saveYeta6300ToYe161080tabItem08_3(ye161080Dto, new AsyncCallback<Integer>() {
...
//						//-- 그리드 저장
//						
//						Iterator<Record> iterRecords = Yeta6300ToYe161090GridPanel.getMsfGrid().getGrid().getStore().getModifiedRecords().iterator(); 
//				        
//						List<Ye161090DTO> listYe161090Dto = new ArrayList<Ye161090DTO>();  
//						Ye161090DTO ye161090Dto = new Ye161090DTO(); 
//						
...
//						}
	...
	public void itemYeta09Save() {
		...
		yeta6300Service.saveYeta6300ToYe161080tabItem09(ye161080Dto, new AsyncCallback<Integer>() {
	...
	public void itemYeta10Save() {
		...
		yeta6300Service.saveYeta6300ToYe161080tabItem10(ye161080Dto, new AsyncCallback<Integer>() {
...
//		resetItemYeta01();	 
		...
		Yeta6300ToYe161010GridPanel.getTableDef().setTableColumnFilters(filters);
		
		Yeta6300ToYe161010GridPanel.getTableDef().addColumnFilter("yrtxBlggYr", MSFSharedUtils.getSelectedComboValue(srhYrtxBlggYr, "year"), SimpleColumnFilter.OPERATOR_EQUALS);
		
		Yeta6300ToYe161010GridPanel.getTableDef().addColumnFilter("clutSeptCd", MSFSharedUtils.getSelectedComboValue(srhClutSeptCd, "commCd"), SimpleColumnFilter.OPERATOR_EQUALS);
		
		Yeta6300ToYe161010GridPanel.getTableDef().addColumnFilter("payrMangDeptCd", MSFSharedUtils.getSelectedComboValue(srhPayrMangDeptCd,"payrMangDeptCd"), SimpleColumnFilter.OPERATOR_EQUALS);
		Yeta6300ToYe161010GridPanel.getTableDef().addColumnFilter("emymtDivCd", MSFSharedUtils.getSelectedComboValue(srhEmymtDivCd,"commCd"), SimpleColumnFilter.OPERATOR_EQUALS); 
		String strDeptCd =YetaUtils.getStrValToBMMultiCombo(lsDeptCd, srhDeptCd.getValue(),"deptNmRtchnt","deptCd");  
		Yeta6300ToYe161010GridPanel.getTableDef().addColumnFilter("deptCd", strDeptCd , SimpleColumnFilter.OPERATOR_EQUALS);
		           
		String strTypOccuCd = YetaUtils.getStrValToBMMultiCombo(lsTypOccuCd,srhTypOccuCd.getValue(),"typOccuNm","typOccuCd"); 
		Yeta6300ToYe161010GridPanel.getTableDef().addColumnFilter("typOccuCd", strTypOccuCd, SimpleColumnFilter.OPERATOR_EQUALS); 
		...
		Yeta6300ToYe161010GridPanel.getTableDef().addColumnFilter("dtilOccuInttnCd", strDtilOccuInttnCd, SimpleColumnFilter.OPERATOR_EQUALS); 
		       
		Yeta6300ToYe161010GridPanel.getTableDef().addColumnFilter("businCd", MSFSharedUtils.getSelectedComboValue(srhBusinCd,"businCd"), SimpleColumnFilter.OPERATOR_EQUALS);
		Yeta6300ToYe161010GridPanel.getTableDef().addColumnFilter("systemkey", MSFSharedUtils.allowNulls(srhSystemkey.getValue()), SimpleColumnFilter.OPERATOR_EQUALS);
		Yeta6300ToYe161010GridPanel.getTableDef().addColumnFilter("hanNm", MSFSharedUtils.allowNulls(srhHanNm.getValue()), SimpleColumnFilter.OPERATOR_EQUALS);    
		Yeta6300ToYe161010GridPanel.getTableDef().addColumnFilter("resnRegnNum", MSFSharedUtils.allowNulls(srhResnRegnNum.getValue()), SimpleColumnFilter.OPERATOR_EQUALS);  
		Yeta6300ToYe161010GridPanel.getTableDef().addColumnFilter("utDpobCd", MSFSharedUtils.allowNulls(utDpobCd.getValue()), SimpleColumnFilter.OPERATOR_EQUALS); 
		
		
		Yeta6300ToYe161010GridPanel.getTableDef().addColumnFilter("printType", YetaUtils.getCheckedRadioValue(printType), SimpleColumnFilter.OPERATOR_EQUALS);  

		Yeta6300ToYe161010GridPanel.reload(); 
      
	}
	
	
	/** 대상자에 따른 정보 가져옴 **/
	private void Yeta6300ToYeta2000Detail2(Yeta2000BM result) {
	
	}
	
	
	/** 대상자에 따른 정보 가져옴 **/
	private void Yeta6300ToYe161010Detail(BaseModel selRecord, String tabId) {
	...
	private void getItemYeta01() {
		...
		yeta6300Service.getYeta6300ToYe161020Data(ye161020Dto, new AsyncCallback<Ye161020DTO>(){

			@Override
			public void onFailure(Throwable caught) {
				// TODO Auto-generated method stub
				MessageBox.alert(MSFMainApp.MSFCONSTANTS.ExceptionTitleService(), 
                        MSFMainApp.ADMINMESSAGES.ExceptionMessageService("getYeta6300ToYe161020Data(" + actionDatabase.name() + ") : " + caught), null);
	...
	private void getItemYeta02() {
		...
		yeta6300Service.getYeta6300TabItem02ToYe161020Data(ye161020Dto, new AsyncCallback<Ye161020DTO>(){

			@Override
			public void onFailure(Throwable caught) {
				// TODO Auto-generated method stub
				MessageBox.alert(MSFMainApp.MSFCONSTANTS.ExceptionTitleService(), 
                        MSFMainApp.ADMINMESSAGES.ExceptionMessageService("saveYeta6300ToYe161020tabItem02(" + actionDatabase.name() + ") : " + caught), null);
	...
	private void getItemYeta04() {
		...
		yeta6300Service.getYeta6300TabItem04ToYe161055Data(ye161055Dto, new AsyncCallback<Ye161055DTO>(){

			@Override
			public void onFailure(Throwable caught) {
				// TODO Auto-generated method stub
				MessageBox.alert(MSFMainApp.MSFCONSTANTS.ExceptionTitleService(), 
                        MSFMainApp.ADMINMESSAGES.ExceptionMessageService("getYeta6300TabItem04ToYe161055Data(" + actionDatabase.name() + ") : " + caught), null);
	...
	private void getItemYeta05() {
		...
		yeta6300Service.getYeta6300TabItem05ToYe161060Data(ye161060Dto, new AsyncCallback<Ye161060DTO>(){
	...
	private void getItemYeta06() {
		...
		yeta6300Service.getYeta6300TabItem06ToYe161070Data(ye161070Dto, new AsyncCallback<Ye161070DTO>(){
			...
			public void onSuccess(Ye161070DTO result) {
				...
				cpiv19AsctTwoUseAmt.setValue(result.getCpiv19AsctTwoUseAmt());   				// 출자투자금액_조합2등_2019납입금
				cpiv19AsctTwoDdcAmt.setValue(result.getCpiv19AsctTwoDdcAmt());   				// 출자투자금액 조합2등_2019공제액
...
//				tyShfyPrsAddDdcrtUseAmt.setValue(result.getTyShfyPrsAddDdcrtUseAmt());  // 본인추가공제율사용분_2016_상반기 
	...
	private void getItemYeta08() {
		...
		yeta6300Service.getYeta6300TabItem08ToYe161080Data(ye161080Dto, new AsyncCallback<Ye161080DTO>(){
...
//				reloadYe161090Grid();
	...
	private void getItemYeta09() {
		...
		yeta6300Service.getYeta6300TabItem09ToYe161080Data(ye161080Dto, new AsyncCallback<Ye161080DTO>(){
...
//				    	
	...
	private void getItemYeta10() {
		...
		yeta6300Service.getYeta6300TabItem10ToYe161080Data(ye161080Dto, new AsyncCallback<Ye161080DTO>(){
	...
	private void reloadYe169010(){
		...
		Yeta6300ToYe169010GridPanel.getTableDef().setTableColumnFilters(filters);
		
		Yeta6300ToYe169010GridPanel.getTableDef().addColumnFilter("dpobCd", MSFSharedUtils.allowNulls(dpobCd.getValue()), SimpleColumnFilter.OPERATOR_EQUALS);
		Yeta6300ToYe169010GridPanel.getTableDef().addColumnFilter("systemkey", MSFSharedUtils.allowNulls(systemkey.getValue()), SimpleColumnFilter.OPERATOR_EQUALS);
		Yeta6300ToYe169010GridPanel.getTableDef().addColumnFilter("clutSeptCd", MSFSharedUtils.allowNulls(clutSeptCd.getValue()), SimpleColumnFilter.OPERATOR_EQUALS); 
		Yeta6300ToYe169010GridPanel.getTableDef().addColumnFilter("yrtxBlggYr", MSFSharedUtils.allowNulls(yrtxBlggYr.getValue()), SimpleColumnFilter.OPERATOR_EQUALS); 
		Yeta6300ToYe169010GridPanel.getTableDef().addColumnFilter("c152StdTxDdcYn", c152StdTxDdcYn.getValue()?"Y" : "N", SimpleColumnFilter.OPERATOR_EQUALS); 
			
		Yeta6300ToYe169010GridPanel.reload();
	...
	private void reloadYe161030(){
		...
		Yeta6300ToYe161030GridPanel.getTableDef().setTableColumnFilters(filters);
		
		Yeta6300ToYe161030GridPanel.getTableDef().addColumnFilter("dpobCd", MSFSharedUtils.allowNulls(dpobCd.getValue()), SimpleColumnFilter.OPERATOR_EQUALS);
		Yeta6300ToYe161030GridPanel.getTableDef().addColumnFilter("systemkey", MSFSharedUtils.allowNulls(systemkey.getValue()), SimpleColumnFilter.OPERATOR_EQUALS);
		Yeta6300ToYe161030GridPanel.getTableDef().addColumnFilter("clutSeptCd", MSFSharedUtils.allowNulls(clutSeptCd.getValue()), SimpleColumnFilter.OPERATOR_EQUALS); 
		Yeta6300ToYe161030GridPanel.getTableDef().addColumnFilter("yrtxBlggYr", MSFSharedUtils.allowNulls(yrtxBlggYr.getValue()), SimpleColumnFilter.OPERATOR_EQUALS); 
			
		Yeta6300ToYe161030GridPanel.reload();
	...
	private void reloadYe161040_item03Grid(){
		...
		Yeta6300ToYe161040GridPanel_01.getTableDef().setTableColumnFilters(filters);
		
		Yeta6300ToYe161040GridPanel_01.getTableDef().addColumnFilter("dpobCd"		, MSFSharedUtils.allowNulls(dpobCd.getValue()), SimpleColumnFilter.OPERATOR_EQUALS);
		Yeta6300ToYe161040GridPanel_01.getTableDef().addColumnFilter("systemkey"	, MSFSharedUtils.allowNulls(systemkey.getValue()), SimpleColumnFilter.OPERATOR_EQUALS);
		Yeta6300ToYe161040GridPanel_01.getTableDef().addColumnFilter("clutSeptCd"	, MSFSharedUtils.allowNulls(clutSeptCd.getValue()), SimpleColumnFilter.OPERATOR_EQUALS); 
		Yeta6300ToYe161040GridPanel_01.getTableDef().addColumnFilter("yrtxBlggYr"	, MSFSharedUtils.allowNulls(yrtxBlggYr.getValue()), SimpleColumnFilter.OPERATOR_EQUALS); 
		Yeta6300ToYe161040GridPanel_01.getTableDef().addColumnFilter("cdVvalKrnCd"	, "Y0140000", SimpleColumnFilter.OPERATOR_EQUALS); 
			
		Yeta6300ToYe161040GridPanel_01.reload();
		
		Yeta6300ToYe161040GridPanel_02.getTableDef().setTableColumnFilters(filters);
		
		Yeta6300ToYe161040GridPanel_02.getTableDef().addColumnFilter("dpobCd"		, MSFSharedUtils.allowNulls(dpobCd.getValue()), SimpleColumnFilter.OPERATOR_EQUALS);
		Yeta6300ToYe161040GridPanel_02.getTableDef().addColumnFilter("systemkey"	, MSFSharedUtils.allowNulls(systemkey.getValue()), SimpleColumnFilter.OPERATOR_EQUALS);
		Yeta6300ToYe161040GridPanel_02.getTableDef().addColumnFilter("clutSeptCd"	, MSFSharedUtils.allowNulls(clutSeptCd.getValue()), SimpleColumnFilter.OPERATOR_EQUALS); 
		Yeta6300ToYe161040GridPanel_02.getTableDef().addColumnFilter("yrtxBlggYr"	, MSFSharedUtils.allowNulls(yrtxBlggYr.getValue()), SimpleColumnFilter.OPERATOR_EQUALS); 
		Yeta6300ToYe161040GridPanel_02.getTableDef().addColumnFilter("cdVvalKrnCd"	, "Y0140001", SimpleColumnFilter.OPERATOR_EQUALS); 
			
		Yeta6300ToYe161040GridPanel_02.reload();
...
//		IColumnFilter filters = null;
//		
//		Yeta6300ToYe161090GridPanel.getTableDef().setTableColumnFilters(filters);
//			
//		Yeta6300ToYe161090GridPanel.getTableDef().addColumnFilter("dpobCd", MSFSharedUtils.allowNulls(dpobCd.getValue()), SimpleColumnFilter.OPERATOR_EQUALS);
//		Yeta6300ToYe161090GridPanel.getTableDef().addColumnFilter("systemkey", MSFSharedUtils.allowNulls(systemkey.getValue()), SimpleColumnFilter.OPERATOR_EQUALS); 
//		Yeta6300ToYe161090GridPanel.getTableDef().addColumnFilter("clutSeptCd", MSFSharedUtils.allowNulls(clutSeptCd.getValue()), SimpleColumnFilter.OPERATOR_EQUALS); 
//		Yeta6300ToYe161090GridPanel.getTableDef().addColumnFilter("yrtxBlggYr", MSFSharedUtils.allowNulls(yrtxBlggYr.getValue()), SimpleColumnFilter.OPERATOR_EQUALS); 
//			
//		Yeta6300ToYe161090GridPanel.reload();
//		
//	}
	...
	public void resetYeta300ToYeta2000Grid() {
		Yeta6300ToYe161010GridPanel.getMsfGrid().clearData();
	}
	...
	public void resetItemYeta02() {
		...
		Yeta6300ToYe161030GridPanel.getMsfGrid().clearData();
	...
	public void resetItemYeta03() {
		...
		//	{소득공제}
		Yeta6300ToYe161040GridPanel_01.getMsfGrid().clearData();
		Yeta6300ToYe161040GridPanel_02.getMsfGrid().clearData();
...
*/
		...
		cpiv19AsctTwoUseAmt.clear();   							// 출자투자금액_조합2등_2019납입금
		cpiv19AsctTwoDdcAmt.clear();   							// 출자투자금액 조합2등_2019공제액
