...
public interface Yeta7900ServiceAsync {
	
	
	public void saveYeta7900ToPyyt0302(List<Pyyt0302DTO> listPyyt0302Dto, String flag, AsyncCallback<Integer> callback);
	
	public void deleteYeta7900List(List<Pyyt0302DTO> listPyyt0302Dto, AsyncCallback<Integer> callback);
	
	public void Yeta7900InfoList(Pyyt0304DTO pyyt0304Dto, AsyncCallback<Pyyt0304BM> callback);
