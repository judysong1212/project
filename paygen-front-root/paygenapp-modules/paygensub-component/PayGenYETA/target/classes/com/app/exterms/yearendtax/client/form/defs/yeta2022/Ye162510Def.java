...
public class Ye162510Def extends TableDef implements YetaDaoConstants{
	...
	public Ye162510Def(String chkDef) {
		...
		} else if ("YetaP73005".equals(chkDef)) {

			setTitle("");
			setDaoClass("");
			setCustomListMethod(CLASS_YETAP73005_TO_YE162510_DATA_LIST);
			setAutoFillGrid(false);
			setShowFilterToolbar(false);
			setCheckBoxOnGridRows(true);
			setEditFieldGrid(true);
			setColumnsDefinition(getYetaP73005ToYe16251ColumnsList());
	...
	private List<ColumnDef> getYetaP73005ToYe16251ColumnsList() {
