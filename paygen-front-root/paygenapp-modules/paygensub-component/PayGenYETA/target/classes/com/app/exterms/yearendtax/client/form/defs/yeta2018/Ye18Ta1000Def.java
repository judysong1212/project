...
public class Ye18Ta1000Def extends TableDef implements YetaDaoConstants{
	
	private int row = 0;
	final PrgmComBass0300DTO sysComBass0300Dto;
	
	public Ye18Ta1000Def(String chkDef) {
...
//		setTitle("연말정산대상자 및 내역");
		...
		}else if("YETA4400".equals(chkDef)) {
//			setTitle("연말정산대상자 및 내역");
				setTitle("");
		        setDaoClass("");
		        setCustomListMethod(CLASS_YETA4400LIST);
		  	  	setAutoFillGrid(false);
		        setShowFilterToolbar(false);   
		        setCheckBoxOnGridRows(true); 
			    setEditFieldGrid(false);
