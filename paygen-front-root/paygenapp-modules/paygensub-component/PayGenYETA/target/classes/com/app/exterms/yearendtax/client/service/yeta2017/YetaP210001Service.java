...
@RemoteServiceRelativePath("YetaP210001Service.gwt")
public interface YetaP210001Service extends RemoteService {
	/**
	 * Utility class for simplifying access to the instance of async service.
	 */
	public static class Util {
		private static YetaP210001ServiceAsync instance;
		public static YetaP210001ServiceAsync getInstance(){
			if (instance == null) {
				instance = GWT.create(YetaP210001Service.class);
			}
			return instance;
		}
	}
