...
import com.app.exterms.yearendtax.client.service.yeta2022.YetaT73005Service;
import com.app.exterms.yearendtax.client.service.yeta2022.YetaT73005ServiceAsync;
...
//import com.app.exterms.yearendtax.client.form.defs.yeta2016.YetaT73005Def;
...
=====================================================**/
public  class YetaT73005   extends MSFFormPanel {  
 ...
 **/
	...
	private  ContentPanel cpYetaT73005; 
	...
	// -------------- grid 선언 시작  ---------------	  
	private MSFGridPanel YetaT73005GridPanel;
//	private YetaT73005Def YetaT73005Def = new YetaT73005Def("YetaT73005");   //TODO 일단 화면번호로 Def
	// -------------- grid 선언 종료  ---------------
	...
	// -------------- 서비스 호출 시작 --------------
	private YetaT73005ServiceAsync yetaT73005Service = YetaT73005Service.Util.getInstance();
	// -------------- 서비스 호출 종료 --------------	 
...
//					ye162510Dto.setMnthRnttyHusCnttArea((MSFSharedUtils.allowNulls(bmMapModel.get("mnthRnttyHusCnttArea"))));    		/** column 월세주택계약면적 : mnthRnttyHusCnttArea */
				...
				yetaT73005Service.activityOnYetaT73005(listYe162510Dto, actionDatabase, new AsyncCallback<Long>(){
...
//		 }
	...
	public YetaT73005(final ActionDatabase actionDatabase, final MSFPanel caller) {
...
//		initLoad(); 	
		...
		this.actionDatabase = actionDatabase;
	 	...
	 	cpYetaT73005 = new ContentPanel();  

		createSearchForm();			//기본정보 필드를 적용
	 	createMsfGridForm();		//그리드필드
		   
		cpYetaT73005.setBodyBorder(false);
		cpYetaT73005.setBorders(false);
		cpYetaT73005.setHeaderVisible(false);
		cpYetaT73005.setSize("790px", "640px");
		   
		this.add(cpYetaT73005);
...
//		     });     
		...
		cpYetaT73005.setLayout(new FlowLayout());
...
//	      	     }
//				 
//				YetaT73005GridPanel.getMsfGrid().clearData();
//				 
//				BaseModel bmData = YetaT73005GridPanel.getTableDef().getDefaultValues();  
//		              
...
//		         
//		        YetaT73005GridPanel.getMsfGrid().getGrid().stopEditing();      
//		        YetaT73005GridPanel.getMsfGrid().getGrid().getStore().insert(bmData,0);   
//		        YetaT73005GridPanel.getMsfGrid().getGrid().startEditing(YetaT73005GridPanel.getMsfGrid().getGrid().getStore().indexOf(bmData), 0);   
//
...
//			public void handleEvent(ButtonEvent e) {
//				Iterator<BaseModel> itBm = YetaT73005GridPanel.getMsfGrid().getGrid().getSelectionModel().getSelectedItems().listIterator();
...
//		topYetaBtnBar.add(btnYetaDel);
		...
		btnYetaSave.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				setListRecord(YetaT73005GridPanel.getMsfGrid().getStore().getModifiedRecords().iterator());
				doAction(actionDatabase);
...
//			topYetaBtnBar.add(btnYetaClose);
		...
		cpYetaT73005.add(topYetaBtnBar);
...
//		YetaT73005GridPanel = new MSFGridPanel(YetaT73005Def, false, false, false, false, false);
//		YetaT73005GridPanel.setSize("790px", "420px");
//		YetaT73005GridPanel.setBorders(true);
//		YetaT73005GridPanel.setHeaderVisible(false);
//		
...
//		
//		YetaT73005GridPanel.getGrid().getColumnModel().addAggregationRow(payrSummaryRow);  
//		
...
//		
//		YetaT73005GridPanel.getGrid().getColumnModel().addAggregationRow(payrSummaryRow1);
//		/** --- 그리드 합계 부분  종료 --- **/
		
//      cpYetaT73005.add(YetaT73005GridPanel);
		...
		cpYetaT73005.add(fldstNewFieldset);
		cpYetaT73005.add(layoutContainer1_1);
		cpYetaT73005.add(fldstNewFieldset_1);
	...
	public void reload() {
			...
			YetaT73005GridPanel.getTableDef().setTableColumnFilters(filters);
			YetaT73005GridPanel.getTableDef().addColumnFilter("yrtxBlggYr", MSFSharedUtils.allowNulls(srhYrtxBlggYr.getValue())
...
//					, SimpleColumnFilter.OPERATOR_EQUALS);//연말정산귀속년도
			YetaT73005GridPanel.getTableDef().addColumnFilter("clutSeptCd", MSFSharedUtils.getSelectedComboValue(srhClutSeptCd,"commCd")
					, SimpleColumnFilter.OPERATOR_EQUALS);//정산구분
			YetaT73005GridPanel.getTableDef().addColumnFilter("systemkey", MSFSharedUtils.allowNulls(systemkey.getValue())
					, SimpleColumnFilter.OPERATOR_EQUALS);//시스템키
		 
			YetaT73005GridPanel.reload();
