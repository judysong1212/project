...
import com.app.exterms.yearendtax.client.form.defs.yeta2021.Yeta6070Def;
import com.app.exterms.yearendtax.client.service.yeta2021.Yeta6070Service;
import com.app.exterms.yearendtax.client.service.yeta2021.Yeta6070ServiceAsync;
...
=====================================================**/
public class Yeta6070  extends MSFPanel { 
	...
	private FormPanel plFrmYeta6070;
	private FormData formData; 
	private String txtForm = "";
	private XTemplate detailTp;	  
	private Yeta6070ServiceAsync Yeta6070service = Yeta6070Service.Util.getInstance(); 
	...
	private Yeta6070Def Yeta6070MSDef = new Yeta6070Def("Yeta6070MS");
	private InfcPkgBass0150Def Yeta6070ToBass0150Def = new InfcPkgBass0150Def("yeta6070ToBass0150");
	private InfcPkgBass0500Def Yeta6070ToBass0500OnDef = new InfcPkgBass0500Def("YETA6070_BASS0500_ON");
	private InfcPkgBass0500Def Yeta6070ToBass0500OffDef = new InfcPkgBass0500Def("YETA6070_BASS0500_OFF");

	private MSFGridPanel msfGridPanelYeta6070MS; 
	...
	public ContentPanel getViewPanel() {
		if (panel == null) {        	
			...
			msfGridPanelYeta6070MS.reload();
			msfGridPanelBass0150.reload();

			//			final RelationDef  relBass0360 = new RelationDef(Yeta6070MSDef,false);
			//			relBass0360.addJoinDef("utDpobCd", "utDpobCd"); 
			//			relBass0360.setLinkedObject(msfGridPanelYeta6070MS);
			//			Yeta6070ToBass0500OnDef.addRelation(relBass0360); 
			//
			//			/**
			//			 * Create the relations 
			//			 */
			//			final RelationDef  relBass0350 = new RelationDef(Yeta6070MSDef,false);
			//			relBass0350.addJoinDef("utDpobCd", "utDpobCd"); 
			//			relBass0350.setLinkedObject(msfGridPanelYeta6070MS);
			//			Yeta6070ToBass0500OffDef.addRelation(relBass0350); 
			//
			//
			//			// DETAILS 
			//			final Grid Yeta6070ToBass0500OffDefGrid = msfGridPanelYeta6070MS.getMsfGrid().getGrid();
			//			Yeta6070ToBass0500OffDefGrid.addListener(Events.CellDoubleClick, new Listener<BaseEvent>() {
			//				public void handleEvent(BaseEvent be) {  
			//					if (msfGridPanelYeta6070MS.getCurrentlySelectedItem() != null) {  
			//
			//						Yeta6070ToBass0500OnDef.synchronizeGridDetail(
			//								msfGridPanelYeta6070MS.getCurrentlySelectedItem(),
			//								msfGridPanelBass0500On );
			//
			//						Yeta6070ToBass0500OffDef.synchronizeGridDetail(
			//								msfGridPanelYeta6070MS.getCurrentlySelectedItem(),
	...
	public Yeta6070(String txtForm) {
		this.txtForm = txtForm;
	}		  

	private void createSysm0500Form() {

		plFrmYeta6070 = new FormPanel();
		plFrmYeta6070.setHeadingText("PayGen Ver1.0 - 단위사업장사업관리");
		plFrmYeta6070.setIcon(Resources.APP_ICONS.text());
		plFrmYeta6070.setBodyStyleName("pad-text");
		plFrmYeta6070.setFrame(true); 
		plFrmYeta6070.setPadding(2);
		/************************************************************************
		...
		btnlogView.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				//로그 뷰화면 호출 메서드 
				funcLogMessage("단위사업장사업관리","Yeta6070");
			}
		});
		plFrmYeta6070.getHeader().setStyleAttribute("padding", "5px 0 2px 0");
		plFrmYeta6070.getHeader().addTool(btnlogView); 
		/************************************************************************
		...
		Yeta6070MSDef.setReadOnly(true);   
		msfGridPanelYeta6070MS = new MSFGridPanel(Yeta6070MSDef, false, false, false, false,false); 
		msfGridPanelYeta6070MS.setSize(350, 620);
		msfGridPanelYeta6070MS.setBorders(true);
		msfGridPanelYeta6070MS.getGrid().setBorders(true);
		Grid grid = msfGridPanelYeta6070MS.getMsfGrid().getGrid();
		grid.addListener(Events.CellDoubleClick , new Listener<BaseEvent>() {
			public void handleEvent(BaseEvent be) {

				untDpobCd = MSFSharedUtils.allowNulls(msfGridPanelYeta6070MS.getMsfGrid().getCurrentlySelectedItem().get("utDpobCd"));

				OnReload(untDpobCd);
				OffReload();
			}					
		});
		inner.add(msfGridPanelYeta6070MS);

		msfGridPanelBass0150 = new MSFGridPanel(Yeta6070ToBass0150Def, false, false, false, false, false); 
		msfGridPanelBass0150.setSize(600, 200);
		msfGridPanelBass0150.setBorders(true);
		msfGridPanelBass0150.getGrid().setBorders(true);

		// 두번째 컨테이너컬럼(사용사업정보)   
		msfGridPanelBass0500On = new MSFGridPanel(Yeta6070ToBass0500OnDef, false, false, false, false, false); 
		...
		// 세번째 컨테이너컬럼(미사용사업정보)  
		msfGridPanelBass0500Off = new MSFGridPanel(Yeta6070ToBass0500OffDef, false, false, false, false,false); 
		...
		plFrmYeta6070.add(srhOffDeptCd);
			...
			public void componentSelected(ButtonEvent ce) {  
				...
				while (iterRecords.hasNext()) {	    		            	  
					...
					if ((Boolean)bmMapModel.get("select")) {
						...
						pkgBass0500Dto.setUntDpobCd(MSFSharedUtils.allowNulls(msfGridPanelYeta6070MS.getMsfGrid().getCurrentlySelectedItem().get("utDpobCd")));
		...
		plFrmYeta6070.add(inner);

		vp.add(plFrmYeta6070);
		plFrmYeta6070.setSize("990px", "680px");
	}	

	private Yeta6070 getThis(){
		return this;
	}
