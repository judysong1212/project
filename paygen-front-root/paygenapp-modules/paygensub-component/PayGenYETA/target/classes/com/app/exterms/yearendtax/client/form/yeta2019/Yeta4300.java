...
import com.app.exterms.yearendtax.client.dto.yeta2019.Ye161030BM;
import com.app.exterms.yearendtax.client.dto.yeta2019.Ye161030DTO;
import com.app.exterms.yearendtax.client.dto.yeta2019.Ye161040BM;
import com.app.exterms.yearendtax.client.dto.yeta2019.Ye161040DTO;
import com.app.exterms.yearendtax.client.dto.yeta2019.Ye161055DTO;
import com.app.exterms.yearendtax.client.dto.yeta2019.Ye161060DTO;
import com.app.exterms.yearendtax.client.dto.yeta2019.Ye161070DTO;
import com.app.exterms.yearendtax.client.dto.yeta2019.Ye161080DTO;
import com.app.exterms.yearendtax.client.form.defs.yeta2015.Yeta2000Def;
import com.app.exterms.yearendtax.client.form.defs.yeta2019.Ye161010Def;
import com.app.exterms.yearendtax.client.form.defs.yeta2019.Ye161030Def;
import com.app.exterms.yearendtax.client.form.defs.yeta2019.Ye161040Def;
import com.app.exterms.yearendtax.client.form.defs.yeta2019.Ye161090Def;
import com.app.exterms.yearendtax.client.form.defs.yeta2019.Ye169010Def;
import com.app.exterms.yearendtax.client.service.yeta2019.Yeta4300Service;
import com.app.exterms.yearendtax.client.service.yeta2019.Yeta4300ServiceAsync;
 ...
 */
public class Yeta4300 extends MSFPanel {

	private VerticalPanel vp;
	private FormPanel plFrmYeta4300;
	...
	// -------------- 탭 시작 --------------
	private TabPanel tabsYeta4300 = new TabPanel();		// 전체
	private TabPanel tabsItemYeta05 = new TabPanel();	// 특별소득공제 하위
	private TabPanel tabsItemYeta08 = new TabPanel();	// 세액감면및세액공제1 하위
	// -------------- 탭 종료 --------------

	// -------------- 상단 버튼 시작 --------------
	private ButtonBar topYeta4300Bar;
	private Button btnYeta4300All; 	// 일괄자료정리
	private Button btnYeta4300Reset; 	// 초기화
	private Button btnYeta4300New; 		// 신규
	private Button btnYeta4300Save; 	// 저장
	private Button btnYeta4300Del; 		// 삭제
	private Button btnYeta4300Sreach; 	// 조회
	private Button btnYeta4300Print; 	// 인쇄
	
	private RadioGroup printType;		// 대상자 선택
	// -------------- 상단 버튼 종료 --------------

	// -------------- 중간 버튼 시작 --------------
	private Button btnYeta4300_01;			// 의료비지급명세서
	private Button btnYeta4300_02; 			// 기부금명세서
	private Button btnYeta4300_03; 			// 재계산대상자
	private Button btnYeta4300_04; 			// 삭제
	private Button btnYeta4300_05; 			// 세액계산
	private Button btnYeta4300_06; 			// 세액재계산
	private Button btnYeta4300_07; 			// 원천징수인쇄
...
//	private Yeta2000BM yeta2000Bm;
	...
	// -------------- grid 선언 시작  ---------------
	private Ye161010Def ye161010Def  		= new Ye161010Def("Yeta4300"); 		// 대상자 정보 그리드 테이블 컬럼 define
	private Yeta2000Def Ye161010Def_02  	= new Yeta2000Def("YETA300001"); 	// 대상자 정보 그리드 새로고침을 위한 define
	private Ye169010Def ye169010Def  		= new Ye169010Def("Yeta4300");		// 세액계산 정보 그리드 테이블 컬럼 define 
	private Ye161030Def ye161030Def  		= new Ye161030Def("Yeta4300");		// 인적공제 정보 그리드 테이블 컬럼 define
	
	private Ye161040Def ye161040Def_01  	= new Ye161040Def("Yeta430001"); 	// 소득공제명세 그리드 테이블 컬럼 define(국세청자료)  
	private Ye161040Def ye161040Def_02  	= new Ye161040Def("Yeta430002"); 	// 소득공제명세 그리드 테이블 컬럼 define(기타자료)
	private Ye161090Def ye161090Def  		= new Ye161090Def("Yeta4300");
	
	
	private MSFGridPanel Yeta4300ToYe169010GridPanel;
	private MSFGridPanel Yeta4300ToYe161010GridPanel;		// 대상자정보 GridPanel
	private MSFGridPanel Yeta4300ToYe161030GridPanel;		// 인적공제 GridPanel
	private MSFGridPanel Yeta4300ToYe161040GridPanel_01;	// 소득공제 - 국세청 GridPanel
	private MSFGridPanel Yeta4300ToYe161040GridPanel_02;	// 소득공제 - 기타자료 GridPanel
//	private MSFGridPanel Yeta4300ToYe161090GridPanel;		// 가족교육비 GridPanel
	// -------------- grid 선언 종료  ---------------
...
//	private ListStore<BaseModel> lsCrClutMnth = new ListStore<BaseModel>(); 			//급여월
	...
	// -------------- 서비스 호출 시작 -------------- 
	private Yeta4300ServiceAsync yeta4300Service = Yeta4300Service.Util.getInstance();
	// -------------- 서비스 호출 종료 --------------
	 ...
	 */
	 private void checkYeta4300Auth( String authAction, ListStore<BaseModel>bm) {
	 ...
	 private void authExecEnabled() { 
	   //------------------
		 ...
		 srhYrtxBlggYr.setValue(lsClutYrStore.findModel("year","2019"));
	 ...
	 **/
	  ...
	  * </pre>
	  * @Method Name : fnYeta4300Payr06430CalcTax
	  * @date : Jan 26, 2016
	  * @author : leeheuisung
	  * @history : 
	  *	-----------------------------------------------------------------------
	  ...
	  *
	  */
	private void fnYeta4300Payr06430CalcTax() {
		...
		MessageBox.confirm("세액계산", "선택된 연말정산계산  대상자에 대해서 세액계산을 합니다. <br> 세액재계산을 하시겠습니까?",new Listener<MessageBoxEvent>(){
			...
			public void handleEvent(MessageBoxEvent be) {
				if (Dialog.YES.equals(be.getButtonClicked().getItemId())) {
					...
					Iterator<BaseModel> itBm = Yeta4300ToYe161010GridPanel.getMsfGrid().getGrid().getSelectionModel().getSelectedItems().listIterator();
					...
					if (MSFSharedUtils.paramNotNull(records)) {
			            ...
			            final Timer t = new Timer() {
			              ...
			              t.scheduleRepeating(500);
   	           	 		...
   	           	 		yeta4300Service.fnYeta4300_Ye161010_2019_CalcTax(listYe161010Dto,   new AsyncCallback<PagingLoadResult<ShowMessageBM>>() {
...
//   	           	                MSFMainApp.ADMINMESSAGES.ExceptionMessageService("activityOnInsertRemt0100(insert) : " + caught), null);
   	           	 			...
   	           	 			public void onSuccess(PagingLoadResult<ShowMessageBM> result) {  
   	           	 				...
   	           	 				//계산 결과에 따른 조회 호출 
   	           	 				BaseModel bmData = Yeta4300ToYe161010GridPanel.getCurrentlySelectedItem();  
   	           	 				...
   	           	 				Yeta4300ToYe161010Detail(bmData, "itemYeta01");
	...
	private void fnYeta4300Payr06430AllCalcTax() {
		...
		MessageBox.confirm("전체세액계산","선택된 연말정산계산  대상자에 대해서 전체세액계산을 합니다. <br> 세액재계산을 하시겠습니까?", new Listener<MessageBoxEvent>() {
			...
			public void handleEvent(MessageBoxEvent be) {
				if (Dialog.YES.equals(be.getButtonClicked().getItemId())) {
					...
					yeta4300Service.fnYeta4300Ye161010_2019_AllCalcTax(ye161010Dto ,new AsyncCallback<PagingLoadResult<ShowMessageBM>>() {
						public void onFailure(Throwable caught) {
...
//							reFresh();
	 ...
	 * ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
	 **/
		private void Yeta4300Print(String fileName, String repType) {
...
//			serarchParam += "[" + MSFSharedUtils.allowNulls(srhSystemkey.getValue())+"]";				//$12 시스템키 
			...
			List<BaseModel> list = Yeta4300ToYe161010GridPanel.getGrid().getSelectionModel().getSelectedItems();
...
//	      	}
	...
	public ContentPanel getViewPanel() {
		if (panel == null) {
			...
			createYeta4300Form(); 	// 화면 기본정보를 설정
			createSearchForm(); 	// 검색필드를 적용
			createContentForm(); 	// 내용 필드
			vp.setSize("1010px", "1600px");

			// 폼데이터를 바인딩
			// formBinding = new FormBinding(this.plFrmYeta4300, true);
	...
	public Yeta4300(String txtForm) {
...
//		btnBar.add(btnNewButton_4);
		...
		Button btnYeta4300_05 = new Button("세액계산");
		btnYeta4300_05.setIcon(MSFMainApp.ICONS.save16());
		btnBar.add(btnYeta4300_05);
		btnYeta4300_05.addListener(Events.Select, new Listener<ButtonEvent>() {
    		public void handleEvent(ButtonEvent e) {
    		 
    	        fnYeta4300Payr06430CalcTax();
    		}
    	});
		...
		plFrmYeta4300.add(conLayoutContainer);

	}

	private void createYeta4300Form() {

		plFrmYeta4300 = new FormPanel();
		plFrmYeta4300.setHeadingText(PayGenConst.PAYGEN_VERSION.concat(" - 소득공제신고자료관리"));
		plFrmYeta4300.setIcon(MSFMainApp.ICONS.text());
		plFrmYeta4300.setBodyStyleName("pad-text");
		plFrmYeta4300.setFrame(true);
		plFrmYeta4300.setPadding(2);
//		plFrmYeta4300.setSize("990px", "780px");
		plFrmYeta4300.setSize("990px", "830px");
		...
		btnlogView.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				 //로그 뷰화면 호출 메서드 
				  funcLogMessage("소득공제신고자료관리","Yeta4300");
				}
			});
		plFrmYeta4300.getHeader().setStyleAttribute("padding", "5px 0 2px 0");
		plFrmYeta4300.getHeader().addTool(btnlogView); 
		/************************************************************************
		 * 화면 에러 처리시 필요한 부분으로 추가 
		 ************************************************************************/

		//멀티콤보박스 닫기 
		plFrmYeta4300.addListener(Events.OnClick,new Listener<ComponentEvent>() { 
			@Override
		...
		topYeta4300Bar = new ButtonBar();
		topYeta4300Bar.setAlignment(HorizontalAlignment.RIGHT);
		
		if ("admin".equals(MSFMainApp.get().getUser().getUsrId()) || "D0010090".equals(MSFMainApp.get().getUser().getUsrDivCd())) {	
			btnYeta4300All = new Button("일괄자료정리");
			btnYeta4300All.setIcon(MSFMainApp.ICONS.new16());
			topYeta4300Bar.add(btnYeta4300All);
			btnYeta4300All.addListener(Events.Select, new Listener<ButtonEvent>() {
				public void handleEvent(ButtonEvent e) {
...
//	                    ye161030Dto.setFamyRelaDivCd(MSFSharedUtils.allowNulls(bmMapModel.get("famyRelaDivCd")));    	/** column 인사가족관계코드 : famyRelaDivCd */
					...
					yeta4300Service.updateYeta4300All(listYe161040Dto, new AsyncCallback<Integer>() {

						public void onFailure(Throwable caught) {
							MessageBox.alert( MSFMainApp.MSFCONSTANTS.ExceptionTitleService()
												, MSFMainApp.ADMINMESSAGES.ExceptionMessageService("activityOnYeta4300ToYe161030("+ actionDatabase.name()+ ") : " + caught)
												, null);
							}
		...
		btnYeta4300Reset = new Button("초기화");
		btnYeta4300Reset.setIcon(MSFMainApp.ICONS.new16());
		btnYeta4300Reset.addListener(Events.Select, new Listener<ButtonEvent>() {
			@Override
			public void handleEvent(ButtonEvent be) {
				// TODO Auto-generated method stub
				...
				tabsYeta4300.setSelection(tabsYeta4300.getItem(0));//탭부분 초기화
			}
		});
		topYeta4300Bar.add(btnYeta4300Reset);

		btnYeta4300Save = new Button("저장");
		btnYeta4300Save.setIcon(MSFMainApp.ICONS.save16());
		topYeta4300Bar.add(btnYeta4300Save);
		btnYeta4300Save.addListener(Events.Select, new Listener<ButtonEvent>() {
			@Override
			public void handleEvent(ButtonEvent be) {
				// TODO Auto-generated method stub  
				//  {-- 기본사항 --}
				if("itemYeta01".equals(tabsYeta4300.getSelectedItem().getId())) {
					
					itemYeta01Save();	// 기본사항 저장
					
				//  {-- 인적공제 --}	
				}else if("itemYeta02".equals(tabsYeta4300.getSelectedItem().getId())) {
					
					itemYeta02Save();	// 인적공제 저장
					
				//	{-- 소득공제 --}	
				}else if("itemYeta03".equals(tabsYeta4300.getSelectedItem().getId())) {
					
					itemYeta03Save();	// 소득공제 저장
					
				// {-- 연금보험료공제--}	
				} else if ("itemYeta04".equals(tabsYeta4300.getSelectedItem().getId())) {
				
					itemYeta04Save();	// 국민연금보험료외의 연금보험료 저장
					
				// {-- 특별소득공제 --}
				} else if ("itemYeta05".equals(tabsYeta4300.getSelectedItem().getId())) {
				...
				// {-- 그밖의 소득공제--}	
				}else if("itemYeta06".equals(tabsYeta4300.getSelectedItem().getId())) {
					
					itemYeta06Save();	// 그밖의소득공제1 저장
					
				}else if("itemYeta07".equals(tabsYeta4300.getSelectedItem().getId())) {
					
					itemYeta07Save();	// 그밖의소득공제2 저장
					
				//{-- 세액감면및세액공제--}	
				}else if("itemYeta08".equals(tabsYeta4300.getSelectedItem().getId())) {
				...
				} else if ("itemYeta09".equals(tabsYeta4300.getSelectedItem().getId())) {

					// 세액감면및세액공제2 저장
					itemYeta09Save();
					
				// {-- 추가제출서류 --}
				} else if ("itemYeta10".equals(tabsYeta4300.getSelectedItem().getId())) {
...
//		btnYeta4300Del = new Button("삭제");
//		btnYeta4300Del.setIcon(MSFMainApp.ICONS.delete16());
//		topYeta4300Bar.add(btnYeta4300Del);
...
//		printType.add(radio3);
		...
		topYeta4300Bar.add(printType);

		btnYeta4300Sreach = new Button("조회");
		btnYeta4300Sreach.setIcon(MSFMainApp.ICONS.search16());
		btnYeta4300Sreach.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				//탭 선택 없애기
				tabsYeta4300.setSelection(tabsYeta4300.getItem(0));
				//대상자 정보 조회
				reload();
			}
		});
		topYeta4300Bar.add(btnYeta4300Sreach);

//		btnYeta4300Print = new Button("인쇄");
//		btnYeta4300Print.setIcon(MSFMainApp.ICONS.print16());
//		topYeta4300Bar.add(btnYeta4300Print);

		plFrmYeta4300.add(topYeta4300Bar);

		// 파일업로드 처리
		plFrmYeta4300.setAction("myurl");
		plFrmYeta4300.setEncoding(Encoding.MULTIPART);
		plFrmYeta4300.setMethod(Method.POST);

		vp.add(plFrmYeta4300);
		
		// plFrmYeta4300.setSize("990px", "730px");
	...
	private LayoutContainer createListGrid() {
	    ...
	    Yeta4300ToYe161010GridPanel = new MSFGridPanel(ye161010Def, false, false, false, false, false);
	    Yeta4300ToYe161010GridPanel.setHeaderVisible(false);  
	    Yeta4300ToYe161010GridPanel.setBodyBorder(true);
	    Yeta4300ToYe161010GridPanel.setBorders(true);
	    final Grid yeta300ToYeta2000Grid = Yeta4300ToYe161010GridPanel.getMsfGrid().getGrid();
...
//        	   funcSetPopUpRecord();
	    ...
	    cpGrid.add(Yeta4300ToYe161010GridPanel); 
...
//		plFrmYeta4300.add(deptNm);
		...
		plFrmYeta4300.setLayout(new FlowLayout());
			...
			public void handleEvent(StoreEvent<BaseModel> be) {  
				...
				if (type == Store.Add) { 
		             ...
		             * "srhPayrMangDeptCd","srhEmymtDivCd","srhDeptCd","srhTypOccuCd","srhBusinCd"
						++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++*/ 
						checkYeta4300Auth("srhPayrMangDeptCd", lsPayrMangDeptCd); 
				}
			}
		});
	        ...
	        public void handleEvent(StoreEvent<BaseModel> be) {  
	        	  EventType type = be.getType();
		    	   if (type == Store.Add) { 
	           		  ...
	           		  * "srhPayrMangDeptCd","srhEmymtDivCd","srhDeptCd","srhTypOccuCd","srhBusinCd"
		         		++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++*/ 
		                	checkYeta4300Auth("srhEmymtDivCd", lsEmymtDivCd); 
		    	   }
	        }
	    });    
	    ...
	    srhDeptCd.getStore().addStoreListener( new StoreListener<ModelData>() {   
	    	public void handleEvent(StoreEvent<ModelData> be) {  
	    		...
	    		if (type == Store.Add) { 
	    			 ...
	    			 * "srhPayrMangDeptCd","srhEmymtDivCd","srhDeptCd","srhTypOccuCd","srhBusinCd"
						++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++*/ 
	    			checkYeta4300Auth("srhDeptCd", lsDeptCd); 
	    		}
	    	}
	    });    
		...
		srhTypOccuCd.getStore().addStoreListener( new StoreListener<ModelData>() {   
			public void handleEvent(StoreEvent<ModelData> be) {  
				...
				if (type == Store.Add) { 
					 ...
					 * "srhPayrMangDeptCd","srhEmymtDivCd","srhDeptCd","srhTypOccuCd","srhBusinCd"
			    		++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++*/ 
						//checkYeta4300Auth("srhTypOccuCd", lsTypOccuCd); 
				}
			}
		});     
		...
		fileSbtBtn.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				...
				if (systemkey.getValue() == null) {
					...
					YetaP420003 yetaP420003Form = new YetaP420003(ActionDatabase.READ, getThis());
					final MSFFormWindows msFwYeta420003 = new MSFFormWindows("자료추출상세내역",yetaP420003Form, "닫기", "690px", "250px", false);
					msFwYeta420003.show();
					yetaP420003Form.setMSFFormWindows(msFwYeta420003);
					// 팝업이 닫히면 탭을 다시 조회한다.
					msFwYeta420003.addListener(Events.Hide,new Listener<BaseEvent>() { 
			    		@Override
			    		public void handleEvent(BaseEvent be) { 
			    			getItemYeta01();
			    		}
					...
					MessageBox.confirm("소득공제신고서 재적용", "선택된 대상자의 기존 정보를 삭제 후 재적용합니다.<br> 진행 하시겠습니까?",new Listener<MessageBoxEvent>(){
						...
						public void handleEvent(MessageBoxEvent be) {
							if (Dialog.YES.equals(be.getButtonClicked().getItemId())) {
								...
								yeta4300Service.fnYeta4300Ye161010_2019_SbtVolUse(ye161010Dto ,new AsyncCallback<PagingLoadResult<ShowMessageBM>>() {
									public void onFailure(Throwable caught) {
...
//										reFresh();
		...
		fileSbtBtn01.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				...
				if (systemkey.getValue() == null) {
					...
					YetaP420001 yetaP420001Form = new YetaP420001(ActionDatabase.READ, getThis());
					MSFFormWindows msFwYeta420001 = new MSFFormWindows("자료추출상세내역",yetaP420001Form, "닫기", "920px", "710px", false);
					msFwYeta420001.show();
					yetaP420001Form.setMSFFormWindows(msFwYeta420001);
		...
		fileSbtBtn02.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				...
				if (systemkey.getValue() == null) {
					...
					YetaP420002 yetaP420002Form = new YetaP420002(ActionDatabase.READ, getThis());
					final MSFFormWindows msFwYeta420002 = new MSFFormWindows("자료추출상세내역",yetaP420002Form, "닫기", "945px", "710px", false);
					msFwYeta420002.show();
					yetaP420002Form.setMSFFormWindows(msFwYeta420002);
		...
		tabsYeta4300 = new TabPanel();
		tabsYeta4300.setAutoWidth(false);
		tabsYeta4300.setAnimScroll(false);
		tabsYeta4300.setTabScroll(true);
		tabsYeta4300.setPlain(true);
		tabsYeta4300.setSize(660, 720);
		tabsYeta4300.addListener(Events.Select, new Listener<TabPanelEvent>() {
			public void handleEvent(TabPanelEvent e) {
				// 탭선택
				Yeta4300ToYe161010Detail( Yeta4300ToYe161010GridPanel.getCurrentlySelectedItem(), tabsYeta4300.getSelectedItem().getId()); 
		...
		itemYeta08.addListener(Events.Select, new Listener<TabPanelEvent>() {
			public void handleEvent(TabPanelEvent e) {
				...
				//탭선택
				Yeta4300ToYe161010Detail(Yeta4300ToYe161010GridPanel.getCurrentlySelectedItem(), tabsItemYeta08.getSelectedItem().getId());

			}
		});
		
		
		tabsYeta4300.add(itemYeta08);		
		...
		tabsYeta4300.add(itemYeta10);	
		

		fieldSet.add(tabsYeta4300);
	 ...
	 private LayoutContainer occupationalRBottom2() {
		 ...
		 Yeta4300ToYe161030GridPanel = new MSFGridPanel(ye161030Def, false, false, false, false, false);
		 Yeta4300ToYe161030GridPanel.setHeaderVisible(false);  
		 Yeta4300ToYe161030GridPanel.setBodyBorder(true);
		 Yeta4300ToYe161030GridPanel.setBorders(true);
		    
		 cpGrid.add(Yeta4300ToYe161030GridPanel); 
...
//	 }
	 ...
	 private LayoutContainer occupationalRBottom3_01() {
		 ...
		 Yeta4300ToYe161040GridPanel_01 = new MSFGridPanel(ye161040Def_01, false, false, false, false, false);
		 Yeta4300ToYe161040GridPanel_01.setHeaderVisible(false);  
		 Yeta4300ToYe161040GridPanel_01.setBodyBorder(true);
		 Yeta4300ToYe161040GridPanel_01.setBorders(true);
		 Yeta4300ToYe161040GridPanel_01.getBottomComponent().setVisible(false);
		 Yeta4300ToYe161040GridPanel_01.getGrid().getColumnModel().addHeaderGroup(0, 2, new HeaderGroupConfig("보험료", 1, 4));
		 Yeta4300ToYe161040GridPanel_01.getGrid().getColumnModel().addHeaderGroup(0, 8, new HeaderGroupConfig("신용카드 등 사용액", 1, 6)); 
		 ...
		 Yeta4300ToYe161040GridPanel_01.getGrid().getColumnModel().addAggregationRow(payrSummaryRow); 
		    
		 
		 cpGrid.add(Yeta4300ToYe161040GridPanel_01); 
	 ...
	 private LayoutContainer occupationalRBottom3_02() {
		 ...
		 Yeta4300ToYe161040GridPanel_02 = new MSFGridPanel(ye161040Def_02, false, false, false, false, false);
		 Yeta4300ToYe161040GridPanel_02.setHeaderVisible(false);  
		 Yeta4300ToYe161040GridPanel_02.setBodyBorder(true);
		 Yeta4300ToYe161040GridPanel_02.setBorders(true);
		 Yeta4300ToYe161040GridPanel_02.getBottomComponent().setVisible(false);
		 
		 Yeta4300ToYe161040GridPanel_02.getGrid().getColumnModel().addHeaderGroup(0, 2, new HeaderGroupConfig("보험료", 1, 4));
		 Yeta4300ToYe161040GridPanel_02.getGrid().getColumnModel().addHeaderGroup(0, 8, new HeaderGroupConfig("신용카드 등 사용액", 1, 6)); 
		 ...
		 Yeta4300ToYe161040GridPanel_02.getGrid().getColumnModel().addAggregationRow(payrSummaryRow); 
		    
		 cpGrid.add(Yeta4300ToYe161040GridPanel_02); 
...
//			dtyStrtDt.setHeight("");
		...
		btnNewButton.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				...
				//전체내역  
				YetaP43006 yetaP43006Form = new YetaP43006(ActionDatabase.READ, getThis());   
							    
				MSFFormWindows msFwYeta43006 = new MSFFormWindows("종전근무지등록", yetaP43006Form, "닫기", "960px", "710px", true);
				msFwYeta43006.show();
				yetaP43006Form.setMSFFormWindows(msFwYeta43006);
					
				funcSetPopUpRecord();
				yetaP43006Form.bind(ppRecord); 
				
				// 팝업이 닫히면 탭을 다시 조회한다.
				msFwYeta43006.addListener(Events.Hide, new Listener<BaseEvent>() { 
		    		@Override
		    		public void handleEvent(BaseEvent be) { 
		    			getItemYeta01();
		    		}
...
//										    
//					MSFFormWindows msFwYeta43009 = new MSFFormWindows("주현근무지등록", yetaP03009Form, "닫기", "820px", "710px", true);
//					msFwYeta43009.show();
//					yetaP03009Form.setMSFFormWindows(msFwYeta43009);
//					//TODO 추후 주석해제 
...
//			layoutContainer_49_2.add(btnNewButton1);
		...
		btnNewButton1.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				// 전체내역
				YetaP43008 yetaP43008Form = new YetaP43008(ActionDatabase.READ, getThis());   
									    
				MSFFormWindows msFwYeta43008 = new MSFFormWindows("현비과세및감면", yetaP43008Form, "닫기", "820px", "710px", true);
				msFwYeta43008.show();
				yetaP43008Form.setMSFFormWindows(msFwYeta43008);
					
				funcSetPopUpRecord();
				 
				yetaP43008Form.bind(ppRecord); 
			}
		});			
...
//		layoutContainer_20.setHeight("100");
		...
		Yeta4300ToYe169010GridPanel = new MSFGridPanel(ye169010Def, false, false,false, false, false);
		Yeta4300ToYe169010GridPanel.setHeaderVisible(false);
		Yeta4300ToYe169010GridPanel.setBodyBorder(true);
		Yeta4300ToYe169010GridPanel.setBorders(true);
		Yeta4300ToYe169010GridPanel.getBottomComponent().setVisible(false);
		//
		cpGrid.add(Yeta4300ToYe169010GridPanel);
		...
		button2.addListener(Events.Select, new Listener<ButtonEvent>() {
			...
			public void handleEvent(ButtonEvent be) {
				...
				yeta4300Service.getYeta4300TxDdcYnToYe161020Data(ye161020Dto, new AsyncCallback<Ye161020DTO>() {
...
//							if (result.getC152StdTxDdcYn() == "Y" || "N".equals(result.getC152StdTxDdcYn())) {
								//전체내역  
								YetaT430171 yetaT430171Form = new YetaT430171(ActionDatabase.READ, getThis());   
										    
								MSFFormWindows msFwYetaT430171 = new MSFFormWindows("기본세액공제", yetaT430171Form, "닫기", "650px", "710px", true);
								msFwYetaT430171.show();
								yetaT430171Form.setMSFFormWindows(msFwYetaT430171);
					...
					public void onFailure(Throwable caught) {
						...
						public void onSuccess(Ye161020DTO result) {
							...
							if (result.getC152StdTxDdcYn() == "Y" || "Y".equals(result.getC152StdTxDdcYn())) {
								//전체내역  
								YetaT43017 yetaT43017Form = new YetaT43017(ActionDatabase.READ, getThis());   
										    
								MSFFormWindows msFwYetaT43017 = new MSFFormWindows("표준세액공제", yetaT43017Form, "닫기", "650px", "710px", true);
								msFwYetaT43017.show();
								yetaT43017Form.setMSFFormWindows(msFwYetaT43017);
...
//								funcSetPopUpRecord();
	...
	private LayoutContainer yetaData02() {
		...
		btnYeta3220New.addListener(Events.Select, new Listener<ButtonEvent>() {
			...
			public void handleEvent(ButtonEvent be) {
				...
				if (MSFSharedUtils.paramNull(systemkey.getValue())) {
	          	...
	          	//가족사항등록 
				YetaP430012 payrP41003Form = new YetaP430012(ActionDatabase.INSERT, getThis());   
		...
		btnYeta3220Del.addListener(Events.Select, new Listener<ButtonEvent>() {
			...
			public void handleEvent(ButtonEvent be) {
				...
				Iterator<BaseModel> itBm = Yeta4300ToYe161030GridPanel.getMsfGrid().getGrid().getSelectionModel().getSelectedItems().listIterator();
				...
				MessageBox.confirm("삭제", "선택하신 인적공제명세를 삭제하시겠습니까?</br> (삭제시 관련된  교육비, 의료비 등의 내역도 같이 삭제 처리 됩니다. )",new Listener<MessageBoxEvent>(){
					...
					public void handleEvent(MessageBoxEvent be) {
						if(Dialog.YES.equals(be.getButtonClicked().getItemId())){
							yeta4300Service.activityOnYeta4300ToYe161030(listYe161030Dto ,actionDatabase, new AsyncCallback<Long>() {
	...
	private LayoutContainer yetaData04() {
		...
		btnNewButton_9.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				// 전체내역
				YetaP43007 yetaP43007Form = new YetaP43007(ActionDatabase.READ, getThis());

				MSFFormWindows msFwYeta43007 = new MSFFormWindows("연금저축소득공제",yetaP43007Form, "닫기", "820px", "550px", true);
				msFwYeta43007.show();
				yetaP43007Form.setMSFFormWindows(msFwYeta43007);
				
				msFwYeta43007.addListener(Events.Hide,new Listener<BaseEvent>() { 
		    		@Override
		    		public void handleEvent(BaseEvent be) { 
		    			getItemYeta04();
		    		}
	...
	private LayoutContainer yetaData05() {
		...
		tabsItemYeta05.addListener(Events.Select, new Listener<TabPanelEvent>() {
			public void handleEvent(TabPanelEvent e) {
				Yeta4300ToYe161010Detail(Yeta4300ToYe161010GridPanel.getCurrentlySelectedItem(), tabsItemYeta05.getSelectedItem().getId());
			}
		});
...
//		LayoutContainer layoutContainer_301 = new LayoutContainer();
		...
		btnNewButton_15.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				//전체내역  
				YetaP43004 yetaP43004Form = new YetaP43004(ActionDatabase.READ, getThis());   
					    
				MSFFormWindows msFwYeta43004 = new MSFFormWindows("거주자간 주택임차차입금 원리금 상환액", yetaP43004Form, "닫기", "820px", "600px", true);
				msFwYeta43004.show();
				yetaP43004Form.setMSFFormWindows(msFwYeta43004);
				 
				funcSetPopUpRecord();
				//TODO 추후 주석해제 
				yetaP43004Form.bind(ppRecord); 
			}
		});	
...
//
//				MSFFormWindows msFwYeta43005 = new MSFFormWindows("월세액소득공제명세",yetaP23005Form, "닫기", "820px", "510px", true);
//				msFwYeta43005.show();
//				yetaP23005Form.setMSFFormWindows(msFwYeta43005);
//
//				funcSetPopUpRecord();
...
//		layoutContainer_224.add(layoutContainer_243);
		...
		layoutContainer_254.add(cpiv17AsctUseAmt, new FormData("100%"));
		...
		LabelField lblfldNewLabelfield_36 = new LabelField("(2017년조합)");
		...
		layoutContainer_2545.add(cpiv17VntUseAmt, new FormData("100%"));
		...
		LabelField lblfldNewLabelfield_366 = new LabelField("(2017년벤처)");
		...
		layoutContainer_254a.add(cpiv18AsctUseAmt, new FormData("100%"));
		...
		LabelField lblfldNewLabelfield_36a = new LabelField("(2018년조합)");
		...
		layoutContainer_2545a.add(cpiv18VntUseAmt, new FormData("100%"));
		...
		LabelField lblfldNewLabelfield_366a = new LabelField("(2018년벤처)");
		...
		cpiv19AsctUseAmt = new MSFNumberField();
		cpiv19AsctUseAmt.setFieldLabel("출자∙투자금액");
		cpiv19AsctUseAmt.setAllowDecimals(true); 
		cpiv19AsctUseAmt.setPropertyEditorType(Long.class); 
		cpiv19AsctUseAmt.setFormat(NumberFormat.getDecimalFormat());
		
		layoutContainer_254b.add(cpiv19AsctUseAmt, new FormData("100%"));
		...
		LabelField lblfldNewLabelfield_36b = new LabelField("(2019년조합)");
		...
		cpiv19VntUseAmt = new MSFNumberField();
		cpiv19VntUseAmt.setFieldLabel("출자∙투자금액");
		cpiv19VntUseAmt.setAllowDecimals(true); 
		cpiv19VntUseAmt.setPropertyEditorType(Long.class); 
		cpiv19VntUseAmt.setFormat(NumberFormat.getDecimalFormat());
		
		layoutContainer_2545b.add(cpiv19VntUseAmt, new FormData("100%"));
		...
		LabelField lblfldNewLabelfield_366b = new LabelField("(2019년벤처)");
...
//
		...
		layoutContainer_248.add(cpiv17AsctDdcAmt, new FormData("100%"));
		...
		layoutContainer_2522.add(cpiv17VntDdcAmt, new FormData("100%"));
		...
		layoutContainer_248a.add(cpiv18AsctDdcAmt, new FormData("100%"));
		...
		layoutContainer_2522a.add(cpiv18VntDdcAmt, new FormData("100%"));
	...
	//----------------------- 2019 공제액  -------------------------------------------------
		...
		cpiv19AsctDdcAmt = new   MSFNumberField();
		cpiv19AsctDdcAmt.setFieldLabel("공제액");
		cpiv19AsctDdcAmt.setReadOnly(true);
		cpiv19AsctDdcAmt.setAllowDecimals(true); 
		cpiv19AsctDdcAmt.setPropertyEditorType(Long.class); 
		cpiv19AsctDdcAmt.setFormat(NumberFormat.getDecimalFormat());
		
		layoutContainer_248b.add(cpiv19AsctDdcAmt, new FormData("100%"));
		...
		cpiv19VntDdcAmt = new MSFNumberField();
		cpiv19VntDdcAmt.setReadOnly(true);
		cpiv19VntDdcAmt.setFieldLabel("공제액");
		cpiv19VntDdcAmt.setAllowDecimals(true); 
		cpiv19VntDdcAmt.setPropertyEditorType(Long.class); 
		cpiv19VntDdcAmt.setFormat(NumberFormat.getDecimalFormat());
		
		layoutContainer_2522b.add(cpiv19VntDdcAmt, new FormData("100%"));
...
//		layoutContainer_132.add(layoutContainer_145);
	...
	private LayoutContainer yetaData08() {
		...
		btnNewButton_10.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				//전체내역  
				YetaP43002 yetaP23002Form = new YetaP43002(ActionDatabase.READ, getThis());   
				    
				MSFFormWindows msFwYeta43002 = new MSFFormWindows("의료비내역등록", yetaP23002Form, "닫기", "820px", "710px", true);
				msFwYeta43002.show();
				yetaP23002Form.setMSFFormWindows(msFwYeta43002);
				
				msFwYeta43002.addListener(Events.Hide,new Listener<BaseEvent>() { 
		    		@Override
		    		public void handleEvent(BaseEvent be) { 
		    			getItemYeta08();
		    		}
...
//		layoutContainer_385.setLayout(new ColumnLayout());
		...
		*/
		...
		// 의료비금액계
		LayoutContainer layoutContainer_mdxpsLsInsrTrAmt = new LayoutContainer();
		...
		layoutContainer_mdxpsLsInsrTrAmt.setLayout(frmlytSchLsInsrTrAmt);

		mdxpsLsInsrTrAmt = new MSFNumberField();
		mdxpsLsInsrTrAmt.setReadOnly(true);
		mdxpsLsInsrTrAmt.setFieldLabel("실손보험금보전금액계");
		mdxpsLsInsrTrAmt.setAllowDecimals(true); 
		mdxpsLsInsrTrAmt.setPropertyEditorType(Long.class); 
		mdxpsLsInsrTrAmt.setFormat(NumberFormat.getDecimalFormat());
		
		layoutContainer_mdxpsLsInsrTrAmt.add(mdxpsLsInsrTrAmt, new FormData("100%"));
		fldstNewFieldset_29.add(layoutContainer_mdxpsLsInsrTrAmt);
...
//		layoutContainer_376.setLayout(new ColumnLayout());
		...
		btnNewButton_11.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				//전체내역  
				YetaP430011 yetaP230011Form = new YetaP430011(ActionDatabase.READ, getThis());   
				    
				MSFFormWindows msFwYeta430011 = new MSFFormWindows("교육비내역등록", yetaP230011Form, "닫기", "820px", "730px", true);
				msFwYeta430011.show();
				yetaP230011Form.setMSFFormWindows(msFwYeta430011);
				
				msFwYeta430011.addListener(Events.Hide,new Listener<BaseEvent>() { 
		    		@Override
		    		public void handleEvent(BaseEvent be) { 
		    			getItemYeta08();
		    		}
...
//				    
//				MSFFormWindows msFwYeta43001 = new MSFFormWindows("이월기부금등록", yetaP23001Form, "닫기", "820px", "710px", true);
//				msFwYeta43001.show();
//				yetaP23001Form.setMSFFormWindows(msFwYeta43001);
//				
//				funcSetPopUpRecord();
//				
//				//TODO 추후 주석해제 
...
//		});
		...
		btnNewButton_14.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				//전체내역  
				YetaP43003 yetaP23003Form = new YetaP43003(ActionDatabase.READ, getThis());   
				    
				MSFFormWindows msFwYeta43003 = new MSFFormWindows("기부금내역등록", yetaP23003Form, "닫기", "820px", "510px", true);
				msFwYeta43003.show();
				yetaP23003Form.setMSFFormWindows(msFwYeta43003);
				
				msFwYeta43003.addListener(Events.Hide,new Listener<BaseEvent>() { 
		    		@Override
		    		public void handleEvent(BaseEvent be) { 
		    			getItemYeta08();
		    		}
		...
		btnNewButton_13.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				//전체내역  
				YetaP43001 yetaP23001Form = new YetaP43001(ActionDatabase.READ, getThis());   
				    
				MSFFormWindows msFwYeta43001 = new MSFFormWindows("기부금조정명세", yetaP23001Form, "닫기", "820px", "710px", true);
				msFwYeta43001.show();
				yetaP23001Form.setMSFFormWindows(msFwYeta43001);
				
				msFwYeta43001.addListener(Events.Hide,new Listener<BaseEvent>() { 
		    		@Override
		    		public void handleEvent(BaseEvent be) { 
		    			getItemYeta05();
		    		}
...
//		layoutContainer_154.add(layoutContainer_160);
		...
		btnNewButton_16.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				// 전체내역
				YetaP43005 yetaP23005Form = new YetaP43005(ActionDatabase.READ,getThis());

				MSFFormWindows msFwYeta43005 = new MSFFormWindows("월세액소득공제명세",yetaP23005Form, "닫기", "820px", "510px", true);
				msFwYeta43005.show();
				yetaP23005Form.setMSFFormWindows(msFwYeta43005);
				
				msFwYeta43005.addListener(Events.Hide,new Listener<BaseEvent>() { 
		    		@Override
		    		public void handleEvent(BaseEvent be) { 
		    			getItemYeta09();
		    		}
				...
				public void handleEvent(BaseEvent be) {
					...
					if (mapModels != null) { 
						...
						yeta4300Service.activityOnYeta4300ToYe161030(listYe161030Dto, actionDatabase, new AsyncCallback<Long>() {
							...
							public void onFailure(Throwable caught) {
								MessageBox.alert(MSFMainApp.MSFCONSTANTS.ExceptionTitleService(), 
									MSFMainApp.ADMINMESSAGES.ExceptionMessageService("activityOnYeta4300ToYe161030(" + actionDatabase.name() + ") : " + caught), null);
							}
							public void onSuccess(Long result) {  
								reloadYe161030();
							}   
...
//						}    
//		                
//						yeta4300Service.saveYeta4300ToYe161090tabItem08_3(listYe161090Dto, actionDatabase, new AsyncCallback<Long>() {
//			    			 
//							public void onFailure(Throwable caught) {
//								MessageBox.alert(MSFMainApp.MSFCONSTANTS.ExceptionTitleService(), 
//												MSFMainApp.ADMINMESSAGES.ExceptionMessageService("saveYeta4300ToYe161090tabItem08_3(" + actionDatabase.name() + ") : " + caught), null);
//							}
//							public void onSuccess(Long result) {  
//								reloadYe161090Grid();
//							
...
//		ye161020Dto.setPrifChngYn(ye161020Dto.getPrifChngYn());    /** column 인적공제항목변동여부 : prifChngYn */
		...
		yeta4300Service.saveYeta4300ToYe161020tabItem01(ye161020Dto, new AsyncCallback<Integer>() {
			@Override
			public void onFailure(Throwable caught) {
				// TODO Auto-generated method stub
					MessageBox.alert(MSFMainApp.MSFCONSTANTS.ExceptionTitleService(), 
	...
	public void itemYeta02Save() {
		...
		Iterator<Record> iterRecords = Yeta4300ToYe161030GridPanel.getMsfGrid().getGrid().getStore().getModifiedRecords().iterator(); 
...
//	        yeta3220Dto.setBeforeJumin(MSFSharedUtils.allowNulls(bmMapModel.get("rsnoNumb2")));
	...
	public void itemYeta03Save() {
		...
		//국세청자료 grid
		Iterator<Record> iterRecords = Yeta4300ToYe161040GridPanel_01.getMsfGrid().getGrid().getStore().getModifiedRecords().iterator(); 
		...
		//기타자료 grid
		iterRecords = Yeta4300ToYe161040GridPanel_02.getMsfGrid().getGrid().getStore().getModifiedRecords().iterator(); 
		...
		yeta4300Service.saveYeta4300ToYe1610400tabItem03(listYe161040Dto_01, listYe161040Dto_02, new AsyncCallback<Integer>() {
	...
	public void itemYeta04Save() {
		...
		yeta4300Service.saveYeta4300ToYe161055tabItem04(ye161055Dto, new AsyncCallback<Integer>() {
	...
	public void itemYeta05_1Save() {
		...
		yeta4300Service.saveYeta4300ToYe161060tabItem05_1(ye161060Dto, new AsyncCallback<Integer>() {
	...
	public void itemYeta05_2Save() {
		...
		yeta4300Service.saveYeta4300ToYe161060tabItem05_2(ye161060Dto, new AsyncCallback<Integer>() {
	...
	public void itemYeta06Save() {
		...
		ye161070Dto.setCpiv17AsctUseAmt			((Long) cpiv17AsctUseAmt.getValue());    	/** column 출자투자금액_조합등_2017납입금 : cpiv16AsctUseAmt */
		ye161070Dto.setCpiv17AsctDdcAmt			((Long) cpiv17AsctDdcAmt.getValue());    	/** column 출자투자금액 조합등_2017공제액 : cpiv16AsctDdcAmt */
		ye161070Dto.setCpiv17VntUseAmt			((Long) cpiv17VntUseAmt.getValue());    	/** column 출자투자금액벤처등_2017납입금액 : cpiv16VntUseAmt */
		ye161070Dto.setCpiv17VntDdcAmt			((Long) cpiv17VntDdcAmt.getValue());    	/** column 출자투자금액벤처등_2017공제액 : cpiv16VntDdcAmt */
		ye161070Dto.setCpiv18AsctUseAmt			((Long) cpiv18AsctUseAmt.getValue());    	/** column 출자투자금액_조합등_2018납입금 : cpiv17AsctUseAmt */
		ye161070Dto.setCpiv18AsctDdcAmt			((Long) cpiv18AsctDdcAmt.getValue());    	/** column 출자투자금액 조합등_2018공제액 : cpiv17AsctDdcAmt */
		ye161070Dto.setCpiv18VntUseAmt			((Long) cpiv18VntUseAmt.getValue());    	/** column 출자투자금액벤처등_2018납입금액 : cpiv17VntUseAmt */
		ye161070Dto.setCpiv18VntDdcAmt			((Long) cpiv18VntDdcAmt.getValue());    	/** column 출자투자금액벤처등_2018공제액 : cpiv17VntDdcAmt */
		ye161070Dto.setCpiv19AsctUseAmt			((Long) cpiv19AsctUseAmt.getValue());    	/** column 출자투자금액_조합등_2019납입금 : cpiv18AsctUseAmt */
		ye161070Dto.setCpiv19AsctDdcAmt			((Long) cpiv19AsctDdcAmt.getValue());    	/** column 출자투자금액 조합등_2019공제액 : cpiv18AsctDdcAmt */
		ye161070Dto.setCpiv19VntUseAmt			((Long) cpiv19VntUseAmt.getValue());    	/** column 출자투자금액벤처등_2019납입금액 : cpiv18VntUseAmt */
		ye161070Dto.setCpiv19VntDdcAmt			((Long) cpiv19VntDdcAmt.getValue());    	/** column 출자투자금액벤처등_2019공제액 : cpiv18VntDdcAmt */
...
//		ye161070Dto.setTyShfyPrsAddDdcrtUseAmt	((Long) tyShfyPrsAddDdcrtUseAmt.getValue());/** column 본인추가공제율사용분_2016_상반기 : tyShfyPrsAddDdcrtUseAmt */
		...
		yeta4300Service.saveYeta4300ToYe161070tabItem06(ye161070Dto, new AsyncCallback<Integer>() {
	...
	public void itemYeta07Save() {
		...
		yeta4300Service.saveYeta4300ToYe161070tabItem07(ye161070Dto, new AsyncCallback<Integer>() {
...
//		ye161080Vo.setYupSnmcReEndDt(ye161080Dto.getYupSnmcReEndDt());    /** column 중소기업취업자감면기간종료일자 : yupSnmcReEndDt */
		...
		yeta4300Service.saveYeta4300ToYe161080tabItem08_1(ye161080Dto, new AsyncCallback<Integer>() {
...
//		ye161080Dto.setScxpsDsbrCount		((Long) scxpsDsbrCount.getValue());    	/** column 교육비_장애인인원수 : scxpsDsbrCount */
		...
		yeta4300Service.saveYeta4300ToYe161080tabItem08_3(ye161080Dto, new AsyncCallback<Integer>() {
...
//						//-- 그리드 저장
//						
//						Iterator<Record> iterRecords = Yeta4300ToYe161090GridPanel.getMsfGrid().getGrid().getStore().getModifiedRecords().iterator(); 
//				        
//						List<Ye161090DTO> listYe161090Dto = new ArrayList<Ye161090DTO>();  
//						Ye161090DTO ye161090Dto = new Ye161090DTO(); 
//						
...
//						}
	...
	public void itemYeta09Save() {
		...
		yeta4300Service.saveYeta4300ToYe161080tabItem09(ye161080Dto, new AsyncCallback<Integer>() {
	...
	public void itemYeta10Save() {
		...
		yeta4300Service.saveYeta4300ToYe161080tabItem10(ye161080Dto, new AsyncCallback<Integer>() {
...
//		resetItemYeta01();	 
		...
		Yeta4300ToYe161010GridPanel.getTableDef().setTableColumnFilters(filters);
		
		Yeta4300ToYe161010GridPanel.getTableDef().addColumnFilter("yrtxBlggYr", MSFSharedUtils.getSelectedComboValue(srhYrtxBlggYr, "year"), SimpleColumnFilter.OPERATOR_EQUALS);
		
		Yeta4300ToYe161010GridPanel.getTableDef().addColumnFilter("clutSeptCd", MSFSharedUtils.getSelectedComboValue(srhClutSeptCd, "commCd"), SimpleColumnFilter.OPERATOR_EQUALS);
		
		Yeta4300ToYe161010GridPanel.getTableDef().addColumnFilter("payrMangDeptCd", MSFSharedUtils.getSelectedComboValue(srhPayrMangDeptCd,"payrMangDeptCd"), SimpleColumnFilter.OPERATOR_EQUALS);
		Yeta4300ToYe161010GridPanel.getTableDef().addColumnFilter("emymtDivCd", MSFSharedUtils.getSelectedComboValue(srhEmymtDivCd,"commCd"), SimpleColumnFilter.OPERATOR_EQUALS); 
		String strDeptCd =YetaUtils.getStrValToBMMultiCombo(lsDeptCd, srhDeptCd.getValue(),"deptNmRtchnt","deptCd");  
		Yeta4300ToYe161010GridPanel.getTableDef().addColumnFilter("deptCd", strDeptCd , SimpleColumnFilter.OPERATOR_EQUALS);
		           
		String strTypOccuCd = YetaUtils.getStrValToBMMultiCombo(lsTypOccuCd,srhTypOccuCd.getValue(),"typOccuNm","typOccuCd"); 
		Yeta4300ToYe161010GridPanel.getTableDef().addColumnFilter("typOccuCd", strTypOccuCd, SimpleColumnFilter.OPERATOR_EQUALS); 
		...
		Yeta4300ToYe161010GridPanel.getTableDef().addColumnFilter("dtilOccuInttnCd", strDtilOccuInttnCd, SimpleColumnFilter.OPERATOR_EQUALS); 
		       
		Yeta4300ToYe161010GridPanel.getTableDef().addColumnFilter("businCd", MSFSharedUtils.getSelectedComboValue(srhBusinCd,"businCd"), SimpleColumnFilter.OPERATOR_EQUALS);
		Yeta4300ToYe161010GridPanel.getTableDef().addColumnFilter("systemkey", MSFSharedUtils.allowNulls(srhSystemkey.getValue()), SimpleColumnFilter.OPERATOR_EQUALS);
		Yeta4300ToYe161010GridPanel.getTableDef().addColumnFilter("hanNm", MSFSharedUtils.allowNulls(srhHanNm.getValue()), SimpleColumnFilter.OPERATOR_EQUALS);    
		Yeta4300ToYe161010GridPanel.getTableDef().addColumnFilter("resnRegnNum", MSFSharedUtils.allowNulls(srhResnRegnNum.getValue()), SimpleColumnFilter.OPERATOR_EQUALS);  
		Yeta4300ToYe161010GridPanel.getTableDef().addColumnFilter("utDpobCd", MSFSharedUtils.allowNulls(utDpobCd.getValue()), SimpleColumnFilter.OPERATOR_EQUALS); 
		
		
		Yeta4300ToYe161010GridPanel.getTableDef().addColumnFilter("printType", YetaUtils.getCheckedRadioValue(printType), SimpleColumnFilter.OPERATOR_EQUALS);  

		Yeta4300ToYe161010GridPanel.reload(); 
      
	}
	
	
	/** 대상자에 따른 정보 가져옴 **/
	private void Yeta4300ToYeta2000Detail2(Yeta2000BM result) {
	
	}
	
	
	/** 대상자에 따른 정보 가져옴 **/
	private void Yeta4300ToYe161010Detail(BaseModel selRecord, String tabId) {
	...
	private void getItemYeta01() {
		...
		yeta4300Service.getYeta4300ToYe161020Data(ye161020Dto, new AsyncCallback<Ye161020DTO>(){

			@Override
			public void onFailure(Throwable caught) {
				// TODO Auto-generated method stub
				MessageBox.alert(MSFMainApp.MSFCONSTANTS.ExceptionTitleService(), 
                        MSFMainApp.ADMINMESSAGES.ExceptionMessageService("getYeta4300ToYe161020Data(" + actionDatabase.name() + ") : " + caught), null);
	...
	private void getItemYeta02() {
		...
		yeta4300Service.getYeta4300TabItem02ToYe161020Data(ye161020Dto, new AsyncCallback<Ye161020DTO>(){

			@Override
			public void onFailure(Throwable caught) {
				// TODO Auto-generated method stub
				MessageBox.alert(MSFMainApp.MSFCONSTANTS.ExceptionTitleService(), 
                        MSFMainApp.ADMINMESSAGES.ExceptionMessageService("saveYeta4300ToYe161020tabItem02(" + actionDatabase.name() + ") : " + caught), null);
	...
	private void getItemYeta04() {
		...
		yeta4300Service.getYeta4300TabItem04ToYe161055Data(ye161055Dto, new AsyncCallback<Ye161055DTO>(){

			@Override
			public void onFailure(Throwable caught) {
				// TODO Auto-generated method stub
				MessageBox.alert(MSFMainApp.MSFCONSTANTS.ExceptionTitleService(), 
                        MSFMainApp.ADMINMESSAGES.ExceptionMessageService("getYeta4300TabItem04ToYe161055Data(" + actionDatabase.name() + ") : " + caught), null);
	...
	private void getItemYeta05() {
		...
		yeta4300Service.getYeta4300TabItem05ToYe161060Data(ye161060Dto, new AsyncCallback<Ye161060DTO>(){
	...
	private void getItemYeta06() {
		...
		yeta4300Service.getYeta4300TabItem06ToYe161070Data(ye161070Dto, new AsyncCallback<Ye161070DTO>(){
			...
			public void onSuccess(Ye161070DTO result) {
				...
				cpiv18AsctUseAmt.setValue(result.getCpiv18AsctUseAmt());   				// 출자투자금액_조합등_2018납입금
				cpiv18AsctDdcAmt.setValue(result.getCpiv18AsctDdcAmt());   				// 출자투자금액 조합등_2018공제액

				cpiv18VntUseAmt.setValue(result.getCpiv18VntUseAmt());   				// 출자투자금액벤처등_2018납입금액
				cpiv18VntDdcAmt.setValue(result.getCpiv18VntDdcAmt());   				// 출자투자금액벤처등_2018공제액 

				cpiv19AsctUseAmt.setValue(result.getCpiv19AsctUseAmt());   				// 출자투자금액_조합등_2019납입금
				cpiv19AsctDdcAmt.setValue(result.getCpiv19AsctDdcAmt());   				// 출자투자금액 조합등_2019공제액

				cpiv19VntUseAmt.setValue(result.getCpiv19VntUseAmt());   				// 출자투자금액벤처등_2019납입금액
				cpiv19VntDdcAmt.setValue(result.getCpiv19VntDdcAmt());   				// 출자투자금액벤처등_2019공제액 
...
//				tyShfyPrsAddDdcrtUseAmt.setValue(result.getTyShfyPrsAddDdcrtUseAmt());  // 본인추가공제율사용분_2016_상반기 
	...
	private void getItemYeta08() {
		...
		yeta4300Service.getYeta4300TabItem08ToYe161080Data(ye161080Dto, new AsyncCallback<Ye161080DTO>(){
...
//				reloadYe161090Grid();
				...
				mdxpsLsInsrTrAmt.setValue(result.getMdxpsLsInsrTrAmt());					// 실손보험료보전금액
	...
	private void getItemYeta09() {
		...
		yeta4300Service.getYeta4300TabItem09ToYe161080Data(ye161080Dto, new AsyncCallback<Ye161080DTO>(){
...
//				    	
	...
	private void getItemYeta10() {
		...
		yeta4300Service.getYeta4300TabItem10ToYe161080Data(ye161080Dto, new AsyncCallback<Ye161080DTO>(){
	...
	private void reloadYe169010(){
		...
		Yeta4300ToYe169010GridPanel.getTableDef().setTableColumnFilters(filters);
		
		Yeta4300ToYe169010GridPanel.getTableDef().addColumnFilter("dpobCd", MSFSharedUtils.allowNulls(dpobCd.getValue()), SimpleColumnFilter.OPERATOR_EQUALS);
		Yeta4300ToYe169010GridPanel.getTableDef().addColumnFilter("systemkey", MSFSharedUtils.allowNulls(systemkey.getValue()), SimpleColumnFilter.OPERATOR_EQUALS);
		Yeta4300ToYe169010GridPanel.getTableDef().addColumnFilter("clutSeptCd", MSFSharedUtils.allowNulls(clutSeptCd.getValue()), SimpleColumnFilter.OPERATOR_EQUALS); 
		Yeta4300ToYe169010GridPanel.getTableDef().addColumnFilter("yrtxBlggYr", MSFSharedUtils.allowNulls(yrtxBlggYr.getValue()), SimpleColumnFilter.OPERATOR_EQUALS); 
		Yeta4300ToYe169010GridPanel.getTableDef().addColumnFilter("c152StdTxDdcYn", c152StdTxDdcYn.getValue()?"Y" : "N", SimpleColumnFilter.OPERATOR_EQUALS); 
			
		Yeta4300ToYe169010GridPanel.reload();
	...
	private void reloadYe161030(){
		...
		Yeta4300ToYe161030GridPanel.getTableDef().setTableColumnFilters(filters);
		
		Yeta4300ToYe161030GridPanel.getTableDef().addColumnFilter("dpobCd", MSFSharedUtils.allowNulls(dpobCd.getValue()), SimpleColumnFilter.OPERATOR_EQUALS);
		Yeta4300ToYe161030GridPanel.getTableDef().addColumnFilter("systemkey", MSFSharedUtils.allowNulls(systemkey.getValue()), SimpleColumnFilter.OPERATOR_EQUALS);
		Yeta4300ToYe161030GridPanel.getTableDef().addColumnFilter("clutSeptCd", MSFSharedUtils.allowNulls(clutSeptCd.getValue()), SimpleColumnFilter.OPERATOR_EQUALS); 
		Yeta4300ToYe161030GridPanel.getTableDef().addColumnFilter("yrtxBlggYr", MSFSharedUtils.allowNulls(yrtxBlggYr.getValue()), SimpleColumnFilter.OPERATOR_EQUALS); 
			
		Yeta4300ToYe161030GridPanel.reload();
	...
	private void reloadYe161040_item03Grid(){
		...
		Yeta4300ToYe161040GridPanel_01.getTableDef().setTableColumnFilters(filters);
		
		Yeta4300ToYe161040GridPanel_01.getTableDef().addColumnFilter("dpobCd"		, MSFSharedUtils.allowNulls(dpobCd.getValue()), SimpleColumnFilter.OPERATOR_EQUALS);
		Yeta4300ToYe161040GridPanel_01.getTableDef().addColumnFilter("systemkey"	, MSFSharedUtils.allowNulls(systemkey.getValue()), SimpleColumnFilter.OPERATOR_EQUALS);
		Yeta4300ToYe161040GridPanel_01.getTableDef().addColumnFilter("clutSeptCd"	, MSFSharedUtils.allowNulls(clutSeptCd.getValue()), SimpleColumnFilter.OPERATOR_EQUALS); 
		Yeta4300ToYe161040GridPanel_01.getTableDef().addColumnFilter("yrtxBlggYr"	, MSFSharedUtils.allowNulls(yrtxBlggYr.getValue()), SimpleColumnFilter.OPERATOR_EQUALS); 
		Yeta4300ToYe161040GridPanel_01.getTableDef().addColumnFilter("cdVvalKrnCd"	, "Y0140000", SimpleColumnFilter.OPERATOR_EQUALS); 
			
		Yeta4300ToYe161040GridPanel_01.reload();
		
		Yeta4300ToYe161040GridPanel_02.getTableDef().setTableColumnFilters(filters);
		
		Yeta4300ToYe161040GridPanel_02.getTableDef().addColumnFilter("dpobCd"		, MSFSharedUtils.allowNulls(dpobCd.getValue()), SimpleColumnFilter.OPERATOR_EQUALS);
		Yeta4300ToYe161040GridPanel_02.getTableDef().addColumnFilter("systemkey"	, MSFSharedUtils.allowNulls(systemkey.getValue()), SimpleColumnFilter.OPERATOR_EQUALS);
		Yeta4300ToYe161040GridPanel_02.getTableDef().addColumnFilter("clutSeptCd"	, MSFSharedUtils.allowNulls(clutSeptCd.getValue()), SimpleColumnFilter.OPERATOR_EQUALS); 
		Yeta4300ToYe161040GridPanel_02.getTableDef().addColumnFilter("yrtxBlggYr"	, MSFSharedUtils.allowNulls(yrtxBlggYr.getValue()), SimpleColumnFilter.OPERATOR_EQUALS); 
		Yeta4300ToYe161040GridPanel_02.getTableDef().addColumnFilter("cdVvalKrnCd"	, "Y0140001", SimpleColumnFilter.OPERATOR_EQUALS); 
			
		Yeta4300ToYe161040GridPanel_02.reload();
...
//		IColumnFilter filters = null;
//		
//		Yeta4300ToYe161090GridPanel.getTableDef().setTableColumnFilters(filters);
//			
//		Yeta4300ToYe161090GridPanel.getTableDef().addColumnFilter("dpobCd", MSFSharedUtils.allowNulls(dpobCd.getValue()), SimpleColumnFilter.OPERATOR_EQUALS);
//		Yeta4300ToYe161090GridPanel.getTableDef().addColumnFilter("systemkey", MSFSharedUtils.allowNulls(systemkey.getValue()), SimpleColumnFilter.OPERATOR_EQUALS); 
//		Yeta4300ToYe161090GridPanel.getTableDef().addColumnFilter("clutSeptCd", MSFSharedUtils.allowNulls(clutSeptCd.getValue()), SimpleColumnFilter.OPERATOR_EQUALS); 
//		Yeta4300ToYe161090GridPanel.getTableDef().addColumnFilter("yrtxBlggYr", MSFSharedUtils.allowNulls(yrtxBlggYr.getValue()), SimpleColumnFilter.OPERATOR_EQUALS); 
//			
//		Yeta4300ToYe161090GridPanel.reload();
//		
//	}
	...
	public void resetYeta300ToYeta2000Grid() {
		Yeta4300ToYe161010GridPanel.getMsfGrid().clearData();
	}
	...
	public void resetItemYeta02() {
		...
		Yeta4300ToYe161030GridPanel.getMsfGrid().clearData();
	...
	public void resetItemYeta03() {
		...
		//	{소득공제}
		Yeta4300ToYe161040GridPanel_01.getMsfGrid().clearData();
		Yeta4300ToYe161040GridPanel_02.getMsfGrid().clearData();
...
*/
		...
		cpiv19AsctUseAmt.clear();   							// 출자투자금액_조합등_2019납입금
		cpiv19AsctDdcAmt.clear();   							// 출자투자금액 조합등_2019공제액

		cpiv19VntUseAmt.clear();   								// 출자투자금액벤처등_2019납입금액
		cpiv19VntDdcAmt.clear();   								// 출자투자금액벤처등_2019공제액
