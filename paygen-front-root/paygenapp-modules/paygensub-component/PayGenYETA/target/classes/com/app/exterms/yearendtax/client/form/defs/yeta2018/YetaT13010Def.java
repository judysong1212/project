...
public class YetaT13010Def extends TableDef implements YetaDaoConstants{
	private int row = 0;
	final PrgmComBass0300DTO sysComBass0300Dto;
	
	public YetaT13010Def(String chkDef) {
		
		sysComBass0300Dto = new PrgmComBass0300DTO();
		
		if("YetaT13010".equals(chkDef)) { //TODO 테이블 정의되면 다시 구현.
			setTitle("");
	        setDaoClass("");
		    ...
		    setColumnsDefinition(getColumnsListYetaT13010()); 
		}else {
...
//	        setCustomListMethod(CLASS_YETA0100_LIST);
	...
	private List<ColumnDef> getColumnsListYetaT13010() { //TODO BM 다시 정의.
        List<ColumnDef> listColumnDefs = new ArrayList<ColumnDef>();
        ...
        listColumnDefs.add(new ColumnDef("구분", YetaT13001BM.ATTR_MNTHRNTTYLEHDRNM, ColumnDef.TYPE_STRING , 100, true, true, true){
        	{
        ...
        listColumnDefs.add(new ColumnDef("납입금액", YetaT13001BM.ATTR_MNTHRNTTYHUSFRMNM, ColumnDef.TYPE_STRING , 140, true, true, true){
        	{

        	}
        });
        /** column 공제금액 : mnthRnttyHusCnttArea */
        listColumnDefs.add(new ColumnDef("공제금액", YetaT13001BM.ATTR_MNTHRNTTYHUSCNTTAREA, ColumnDef.TYPE_STRING , 140, true, true, true){
        	{
