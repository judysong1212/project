...
/**
 * @Class Name : Ye167060VO.java
 * @Description : Ye167060 VO class
 ...
 */
public class Ye167060DTO   implements Serializable {
    ...
    private java.math.BigDecimal cpivAsctUseAmt0;

    /** set 출자투자금액 조합등_2016공제액 : cpivAsctDdcAmt0 */
    private java.math.BigDecimal cpivAsctDdcAmt0;

    /** set 출자투자금액벤처등_2016납입금액 : cpivVntUseAmt0 */
    private java.math.BigDecimal cpivVntUseAmt0;

    /** set 출자투자금액벤처등_2016공제액 : cpivVntDdcAmt0 */
    private java.math.BigDecimal cpivVntDdcAmt0;
    ...
    /**
	 * Comment : 
	 * @fn java.math.BigDecimal getCpivAsctUseAmt0()
	 * @brief date:2017 2017. 1. 7. user:atres-pc
	 * @return the cpivAsctUseAmt0 get
	 */
	public java.math.BigDecimal getCpivAsctUseAmt0() {
		return cpivAsctUseAmt0;
	}

	/**
	 * Comment : 
	 *@fn void setCpivAsctUseAmt0(java.math.BigDecimal cpivAsctUseAmt0)
	 *@brief date:2017 2017. 1. 7. user:atres-pc
	 *@param cpivAsctUseAmt0 the cpivAsctUseAmt0 to set
	 */
	public void setCpivAsctUseAmt0(java.math.BigDecimal cpivAsctUseAmt0) {
		this.cpivAsctUseAmt0 = cpivAsctUseAmt0;
	}

	/**
	 * Comment : 
	 * @fn java.math.BigDecimal getCpivAsctDdcAmt0()
	 * @brief date:2017 2017. 1. 7. user:atres-pc
	 * @return the cpivAsctDdcAmt0 get
	 */
	public java.math.BigDecimal getCpivAsctDdcAmt0() {
		return cpivAsctDdcAmt0;
	}

	/**
	 * Comment : 
	 *@fn void setCpivAsctDdcAmt0(java.math.BigDecimal cpivAsctDdcAmt0)
	 *@brief date:2017 2017. 1. 7. user:atres-pc
	 *@param cpivAsctDdcAmt0 the cpivAsctDdcAmt0 to set
	 */
	public void setCpivAsctDdcAmt0(java.math.BigDecimal cpivAsctDdcAmt0) {
		this.cpivAsctDdcAmt0 = cpivAsctDdcAmt0;
	}

	/**
	 * Comment : 
	 * @fn java.math.BigDecimal getCpivVntUseAmt0()
	 * @brief date:2017 2017. 1. 7. user:atres-pc
	 * @return the cpivVntUseAmt0 get
	 */
	public java.math.BigDecimal getCpivVntUseAmt0() {
		return cpivVntUseAmt0;
	}

	/**
	 * Comment : 
	 *@fn void setCpivVntUseAmt0(java.math.BigDecimal cpivVntUseAmt0)
	 *@brief date:2017 2017. 1. 7. user:atres-pc
	 *@param cpivVntUseAmt0 the cpivVntUseAmt0 to set
	 */
	public void setCpivVntUseAmt0(java.math.BigDecimal cpivVntUseAmt0) {
		this.cpivVntUseAmt0 = cpivVntUseAmt0;
	}

	/**
	 * Comment : 
	 * @fn java.math.BigDecimal getCpivVntDdcAmt0()
	 * @brief date:2017 2017. 1. 7. user:atres-pc
	 * @return the cpivVntDdcAmt0 get
	 */
	public java.math.BigDecimal getCpivVntDdcAmt0() {
		return cpivVntDdcAmt0;
	}

	/**
	 * Comment : 
	 *@fn void setCpivVntDdcAmt0(java.math.BigDecimal cpivVntDdcAmt0)
	 *@brief date:2017 2017. 1. 7. user:atres-pc
	 *@param cpivVntDdcAmt0 the cpivVntDdcAmt0 to set
	 */
	public void setCpivVntDdcAmt0(java.math.BigDecimal cpivVntDdcAmt0) {
