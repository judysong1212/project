 ...
 */
public class Ye16Ta3150DTO  implements Serializable {
...
private Boolean guksYeno;
	...
	/**
	 * Comment : 
	 * @fn Boolean getGuksYeno()
	 * @brief date:2017 2017. 2. 1. user:atres-pc
	 * @return the guksYeno get
	 */
	public Boolean getGuksYeno() {
		return guksYeno;
	}

	/**
	 * Comment : 
	 *@fn void setGuksYeno(Boolean guksYeno)
	 *@brief date:2017 2017. 2. 1. user:atres-pc
	 *@param guksYeno the guksYeno to set
	 */
	public void setGuksYeno(Boolean guksYeno) {
