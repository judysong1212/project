...
public class Ye161090Def  extends TableDef implements YetaDaoConstants {
	...
	public Ye161090Def(String chkPayrDef) {
		...
		if ("YETA830001".equals(chkPayrDef)) {
			...
			setDaoClass("");
			setCustomListMethod(CLASS_YETA8300_TO_YE161090_DATA_LIST);
			setAutoFillGrid(false);
			setShowFilterToolbar(false);
			setCheckBoxOnGridRows(true);
			setEditableGrid(true);
			setEditFieldGrid(true);
			setColumnsDefinition(getYeta8300ToYe161090ColumnsList01());
			...
			setEditableGrid(true);
			setEditFieldGrid(true);
			setColumnsDefinition(getYeta8300ToYe161090ColumnsList02());
...
//     
    ...
    private List<ColumnDef> getYeta8300ToYe161090ColumnsList01(){
    ...
    private List<ColumnDef> getYeta8300ToYe161090ColumnsList02(){
