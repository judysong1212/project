...
import com.app.exterms.yearendtax.client.service.yeta2019.YetaT43017Service;
import com.app.exterms.yearendtax.client.service.yeta2019.YetaT43017ServiceAsync;
...
=====================================================**/
public  class YetaT430171  extends MSFFormPanel {  
	...
	private  ContentPanel cpYetaT430171; 
	...
	// -------------- 서비스 호출 시작 --------------
	private YetaT43017ServiceAsync yetaT43017Service = YetaT43017Service.Util.getInstance();
	// -------------- 서비스 호출 종료 --------------	 
	...
	public YetaT430171(final ActionDatabase actionDatabase, final MSFPanel caller) {
		...
		cpYetaT430171 = new ContentPanel();  

		createSearchForm();			//기본정보 필드를 적용
		createMsfGridForm();		//그리드필드
		setReadOnlyTrueYetaP230171();

		cpYetaT430171.setBodyBorder(false);
		cpYetaT430171.setBorders(false);
		cpYetaT430171.setHeaderVisible(false);
		cpYetaT430171.setSize("630px", "640px");

		this.add(cpYetaT430171);
	...
	private void createMsfGridForm() {
		...
		cpYetaT430171.add(layoutContainer1);
		cpYetaT430171.add(layoutContainer2);
		cpYetaT430171.add(layoutContainer3);
		cpYetaT430171.add(layoutContainer4);
		cpYetaT430171.add(layoutContainer5);
		cpYetaT430171.add(layoutContainer6);
		cpYetaT430171.add(layoutContainer7);
		cpYetaT430171.add(layoutContainer8);
		cpYetaT430171.add(layoutContainer9);
	}	
	...
	public void reload() {
		...
		yetaT43017Service.getYetaP43017ToYe169010List(ye1690103Dto, new AsyncCallback<Ye169010DTO>(){
			...
			public void onSuccess(Ye169010DTO result) {
				// TODO Auto-generated method stub
				readYetaP43017Data(result);
			}
		});
	}	 
	public void readYetaP43017Data(Ye169010DTO result) {
