...
import com.app.exterms.yearendtax.client.form.defs.yeta2018.Yeta3080Def;
...
=====================================================**/
public class Yeta3080  extends MSFPanel { 
	...
	private FormPanel plFrmYeta3080;
	private FormData formData; 
	private String txtForm = "";
	private XTemplate detailTp;	  
//	private Yeta3080ServiceAsync Yeta3080service = Yeta3080Service.Util.getInstance();
	...
	private Yeta3080Def Yeta3080Def 				= new Yeta3080Def("yeta3080ToBass0400");
//	private Yeta3080Def Yeta3080ToSysm0100OnDef 	= new Yeta3080Def("Yeta3080ToSysm0100On");
//	private Yeta3080Def Yeta3080ToSysm0100OffDef 	= new Yeta3080Def("Yeta3080ToSysm0100Off");	
	private InfcPkgSysm0100Def Yeta3080ToSysm0100OnDef 		= new InfcPkgSysm0100Def("yeta3080ToSysm0100On");
	private InfcPkgSysm0100Def Yeta3080ToSysm0100OffDef 	= new InfcPkgSysm0100Def("yeta3080ToSysm0100Off");
	
	private MSFGridPanel msfGridPanelYeta3080; 
...
//			final RelationDef  relBass0360 = new RelationDef(Yeta3080MSDef,false);
//			relBass0360.addJoinDef("dpobCd", "dpobCd"); 
//			relBass0360.addJoinDef("deptCd", "deptCd"); 
//			relBass0360.setLinkedObject(msfGridPanelYeta3080MS);
//			Yeta3080ToBass0500OnDef.addRelation(relBass0360); 
//
//			/**
//			 * Create the relations 
//			 */
//			final RelationDef  relBass0350 = new RelationDef(Yeta3080MSDef,false);
//			relBass0350.addJoinDef("dpobCd", "dpobCd"); 
//			relBass0350.addJoinDef("deptCd", "deptCd"); 
//			relBass0350.setLinkedObject(msfGridPanelYeta3080MS);
//			Yeta3080ToBass0500OffDef.addRelation(relBass0350); 
//
//
//			// DETAILS 
//			final Grid Yeta3080ToBass0500OffDefGrid = msfGridPanelYeta3080MS.getMsfGrid().getGrid();
//			Yeta3080ToBass0500OffDefGrid.addListener(Events.CellDoubleClick, new Listener<BaseEvent>() {
//				public void handleEvent(BaseEvent be) {  
//					if (msfGridPanelYeta3080MS.getCurrentlySelectedItem() != null) {  
//
//						Yeta3080ToBass0500OnDef.synchronizeGridDetail(
//								msfGridPanelYeta3080MS.getCurrentlySelectedItem(),
//								msfGridPanelBass0500On );
//
//						Yeta3080ToBass0500OffDef.synchronizeGridDetail(
//								msfGridPanelYeta3080MS.getCurrentlySelectedItem(),
...
//			});
	...
	public Yeta3080(String txtForm) {
...
//		lsDtilOccuInttnCd = PrgmComComboUtils.getSingleBass0350ComboData(sysComBass0350Dto);
		...
		plFrmYeta3080 = new FormPanel();
		plFrmYeta3080.setHeadingText("PayGen Ver1.0 - 연말정산등록담당자관리");
		plFrmYeta3080.setIcon(Resources.APP_ICONS.text());
		plFrmYeta3080.setBodyStyleName("pad-text");
		plFrmYeta3080.setFrame(true); 
		plFrmYeta3080.setPadding(2);
		/************************************************************************
		...
		btnlogView.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				 //로그 뷰화면 호출 메서드 
				  funcLogMessage("연말정산등록담당자관리","Yeta3080");
				}
			});
		plFrmYeta3080.getHeader().setStyleAttribute("padding", "5px 0 2px 0");
		plFrmYeta3080.getHeader().addTool(btnlogView); 
		/************************************************************************
		 * 화면 에러 처리시 필요한 부분으로 추가 
		 ************************************************************************/
		deptCd = new HiddenField<String>();
		deptCd.setName("deptCd");
		plFrmYeta3080.add(deptCd);
		
		HorizontalPanel inner = new HorizontalPanel();
		inner.setBorders(false);
		inner.setLayout(new FitLayout());
//		Yeta3080Def.setReadOnly(true);
		msfGridPanelYeta3080 = new MSFGridPanel(Yeta3080Def, false, false, false, true, false);
		msfGridPanelYeta3080.setSize(300, 610);
		msfGridPanelYeta3080.setBorders(true);
		msfGridPanelYeta3080.getGrid().setBorders(true);
		Grid grid = msfGridPanelYeta3080.getMsfGrid().getGrid();
		grid.addListener(Events.CellDoubleClick , new Listener<BaseEvent>() {
			public void handleEvent(BaseEvent be) {
				
				
				BaseModel bmData = msfGridPanelYeta3080.getCurrentlySelectedItem();  
		...
		msfGridPanelYeta3080.setTopComponent(lycSreach);
		inner.add(msfGridPanelYeta3080);
          
          
		// 선택된 사용자 
		msfGridPanelSysm0100On = new MSFGridPanel(Yeta3080ToSysm0100OnDef, false, false, false, false,false); 
...
//						infcPkgSysm0100Dto.setUntDpobCd(MSFSharedUtils.allowNulls(egovMap.get("untDpobCd")));    /** column 단위사업장코드 : untDpobCd */
		...
		bottomToolbar.add(refresh);
   	    ...
   	    Yeta3080ToSysm0100OffDef.setReadOnly(true);
   	    // ------------------------ 미선택된 사용자
   	    msfGridPanelSysm0100Off = new MSFGridPanel(Yeta3080ToSysm0100OffDef, false, false, false, false, false); 
...
//						infcPkgSysm0100Dto.setUntDpobCd(MSFSharedUtils.allowNulls(egovMap.get("untDpobCd")));    /** column 단위사업장코드 : untDpobCd */
		...
		plFrmYeta3080.add(inner);

		vp.add(plFrmYeta3080);
		plFrmYeta3080.setSize("990px", "680px");
	}

	private Yeta3080 getThis() {
		return this;
	}
    ...
    public void reDeptload() {
    	...
    	msfGridPanelYeta3080.getTableDef().setTableColumnFilters(filters);   
    	msfGridPanelYeta3080.getTableDef().addColumnFilter("deptNmHan", MSFSharedUtils.defaultNulls(deptNmHan.getValue(),""), SimpleColumnFilter.OPERATOR_LIKE); 
    	msfGridPanelYeta3080.reload();
		...
		infcPkgSysm0100Service.updateInfcPkgSysm0100Yn(infcPkgSysm0100Liar , new AsyncCallback<Integer>() {
			...
			public void onFailure(Throwable caught) {
				MessageBox.alert( MSFMainApp.MSFCONSTANTS.ExceptionTitleService()
									, MSFMainApp.ADMINMESSAGES.ExceptionMessageService("activityOnYeta2300ToYe161030("+ " 오류 : " + ") : " + caught)
									, null);
				}
