...
@RemoteServiceRelativePath("YetaP53007Service.gwt")
public interface YetaP53007Service extends RemoteService {
	/**
	 * Utility class for simplifying access to the instance of async service.
	 */
	public static class Util {
		private static YetaP53007ServiceAsync instance;
		public static YetaP53007ServiceAsync getInstance(){
			if (instance == null) {
				instance = GWT.create(YetaP53007Service.class);
			}
			return instance;
		}
	}
