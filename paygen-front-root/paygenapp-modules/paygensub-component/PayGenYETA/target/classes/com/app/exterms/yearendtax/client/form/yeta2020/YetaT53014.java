...
import com.app.exterms.yearendtax.client.service.yeta2020.YetaT53014Service;
import com.app.exterms.yearendtax.client.service.yeta2020.YetaT53014ServiceAsync;
...
//import com.app.exterms.yearendtax.client.form.defs.yeta2016.YetaT53014Def;
/**====================================================
디자인화면 수정시 extends 부분을 다음과 같이 수정하여 사용한 후 다시 원복한다.
extends MSFPanel ->  extends LayoutContainer  implements IMSFWindow { 
상속받아 소스를 구현한 경우에는 에러나는 부분을 수정하여 처리 해야함.
=====================================================**/
public  class YetaT53014   extends MSFFormPanel {  
 ...
 **/
	...
	private  ContentPanel cpYetaT53014; 
	...
	// -------------- grid 선언 시작  ---------------	  
	private MSFGridPanel YetaT53014GridPanel;
//	private YetaT53014Def YetaT53014Def = new YetaT53014Def("YetaT53014");   //TODO 일단 화면번호로 Def
	// -------------- grid 선언 종료  ---------------
	...
	// -------------- 서비스 호출 시작 --------------
	private YetaT53014ServiceAsync yetaT53014Service = YetaT53014Service.Util.getInstance();
	// -------------- 서비스 호출 종료 --------------	 
...
//					ye162510Dto.setMnthRnttyHusCnttArea((MSFSharedUtils.allowNulls(bmMapModel.get("mnthRnttyHusCnttArea"))));    		/** column 월세주택계약면적 : mnthRnttyHusCnttArea */
				...
				yetaT53014Service.activityOnYetaT53014(listYe162510Dto, actionDatabase, new AsyncCallback<Long>(){
...
//		 }
	...
	public YetaT53014(final ActionDatabase actionDatabase, final MSFPanel caller) {
...
//		initLoad(); 	
		...
		this.actionDatabase = actionDatabase;
	 	...
	 	cpYetaT53014 = new ContentPanel();  

		createSearchForm();			//기본정보 필드를 적용
	 	createMsfGridForm();		//그리드필드
		   
		cpYetaT53014.setBodyBorder(false);
		cpYetaT53014.setBorders(false);
		cpYetaT53014.setHeaderVisible(false);
		cpYetaT53014.setSize("790px", "640px");
		   
		this.add(cpYetaT53014);
...
//		     });     
		...
		cpYetaT53014.setLayout(new FlowLayout());
...
//	      	     }
//				 
//				YetaT53014GridPanel.getMsfGrid().clearData();
//				 
//				BaseModel bmData = YetaT53014GridPanel.getTableDef().getDefaultValues();  
//		              
...
//		         
//		        YetaT53014GridPanel.getMsfGrid().getGrid().stopEditing();      
//		        YetaT53014GridPanel.getMsfGrid().getGrid().getStore().insert(bmData,0);   
//		        YetaT53014GridPanel.getMsfGrid().getGrid().startEditing(YetaT53014GridPanel.getMsfGrid().getGrid().getStore().indexOf(bmData), 0);   
//
...
//			public void handleEvent(ButtonEvent e) {
//				Iterator<BaseModel> itBm = YetaT53014GridPanel.getMsfGrid().getGrid().getSelectionModel().getSelectedItems().listIterator();
...
//			public void handleEvent(ButtonEvent e) {
//				setListRecord(YetaT53014GridPanel.getMsfGrid().getStore().getModifiedRecords().iterator());
//				doAction(actionDatabase);
//
//				if ((ActionDatabase.INSERT).equals(actionDatabase)) {
//					actionDatabase = ActionDatabase.INSERT;
...
//			topYetaBtnBar.add(btnYetaClose);
		...
		cpYetaT53014.add(topYetaBtnBar);
...
//		YetaT53014GridPanel = new MSFGridPanel(YetaT53014Def, false, false, false, false, false);
//		YetaT53014GridPanel.setSize("790px", "420px");
//		YetaT53014GridPanel.setBorders(true);
//		YetaT53014GridPanel.setHeaderVisible(false);
//		
...
//		
//		YetaT53014GridPanel.getGrid().getColumnModel().addAggregationRow(payrSummaryRow);  
//		
...
//		
//		YetaT53014GridPanel.getGrid().getColumnModel().addAggregationRow(payrSummaryRow1);
//		/** --- 그리드 합계 부분  종료 --- **/
		
//        cpYetaT53014.add(YetaT53014GridPanel);
...
//		layoutContainer.add(fldstNewFieldset_1);
		...
		cpYetaT53014.add(fieldSet1);
		cpYetaT53014.add(fieldSet2);
		cpYetaT53014.add(fldstNewFieldset_1);
	...
	public void reload() {
			...
			YetaT53014GridPanel.getTableDef().setTableColumnFilters(filters);
			YetaT53014GridPanel.getTableDef().addColumnFilter("yrtxBlggYr", MSFSharedUtils.allowNulls(srhYrtxBlggYr.getValue())
...
//					, SimpleColumnFilter.OPERATOR_EQUALS);//연말정산귀속년도
			YetaT53014GridPanel.getTableDef().addColumnFilter("clutSeptCd", MSFSharedUtils.getSelectedComboValue(srhClutSeptCd,"commCd")
					, SimpleColumnFilter.OPERATOR_EQUALS);//정산구분
			YetaT53014GridPanel.getTableDef().addColumnFilter("systemkey", MSFSharedUtils.allowNulls(systemkey.getValue())
					, SimpleColumnFilter.OPERATOR_EQUALS);//시스템키
		 
			YetaT53014GridPanel.reload();
