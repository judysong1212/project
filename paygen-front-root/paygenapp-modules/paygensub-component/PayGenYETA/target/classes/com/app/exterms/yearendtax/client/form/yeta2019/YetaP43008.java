...
import com.app.exterms.yearendtax.client.service.yeta2019.YetaP43008ServiceAsync;
...
=====================================================**/
public  class YetaP43008   extends MSFFormPanel { 
 ...
 **/
   ...
   */
	...
	// -------------- 서비스 호출 시작 --------------
	private YetaP43008ServiceAsync yetaP43008Service = YetaP43008Service.Util.getInstance();
	// -------------- 서비스 호출 종료 --------------
 ...
 **/	  
	...
	public YetaP43008(final ActionDatabase actionDatabase, final MSFPanel caller) {
	...
	public YetaP43008(final ActionDatabase actionDatabase, final MSFFormPanel caller2) {
...
//		lcSchCenter2_1.add(taxmSt10Bi, new FormData("100%"));
	...
	private void YetaP43008FormSave() {  
...
//		ye160403Dto.setTaxmSy21Bi((Long)taxmSy21Bi.getValue());    /** column 비과세소득_Y21_비과세 : taxmSy21Bi */
		...
		yetaP43008Service.activityOnYetaP43008ToYe160403(ye160403Dto, actionDatabase, new AsyncCallback<Long>(){
					public void onFailure(Throwable caught) {
						MessageBox.alert(MSFMainApp.MSFCONSTANTS.ExceptionTitleService(), 
	                              MSFMainApp.ADMINMESSAGES.ExceptionMessageService("activityOnYetaP43008ToYe160403(" + actionDatabase.name() + ") : " + caught), null);
					}
	...
	public void reload() {
		...
		yetaP43008Service.getYetaP43008ToYe160403List(ye160403Dto, new AsyncCallback<Ye160403DTO>(){

			@Override
			public void onFailure(Throwable caught) {
				// TODO Auto-generated method stub
				MessageBox.alert(MSFMainApp.MSFCONSTANTS.ExceptionTitleService(), 
                        MSFMainApp.ADMINMESSAGES.ExceptionMessageService("getYetaP43008ToYe160403List(" + actionDatabase.name() + ") : " + caught), null);
	...
	/** 비과세 및 감면소득 조회부 **/
	public void readYetaP43008Data(Ye160403DTO result) {
