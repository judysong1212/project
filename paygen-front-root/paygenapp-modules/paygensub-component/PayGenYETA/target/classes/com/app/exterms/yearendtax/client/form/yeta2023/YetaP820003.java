...
=====================================================**/
public  class YetaP820003   extends MSFFormPanel {  
 ...
 **/ 
	...
	public YetaP820003(final ActionDatabase actionDatabase, final MSFPanel caller) {
...
//		initLoad(); 	
		...
		this.actionDatabase = actionDatabase;
	 	...
	 	cpYeta82003 = new FormPanel();  

		createSearchForm();			//기본정보 필드를 적용
		   
		cpYeta82003.setBodyBorder(false);
		cpYeta82003.setBorders(false);
		cpYeta82003.setHeaderVisible(false);
		cpYeta82003.setSize("690px", "250px");
		   
		this.add(cpYeta82003);
	...
	private void createSearchForm() {
		...
		cpYeta82003.setLayout(new FlowLayout());
...
//							reloadYeta8200Result();
					...
					if("".equals(systemkey.getValue())){
						...
						if (filename.length() == 0) {
							...
							//submit the form
							cpYeta82003.mask("PDF 전자문서 업데이트 중입니다. 업로드 중..."); 

							//파일업로드 처리
							cpYeta82003.setAction(GWT.getHostPageBaseURL() + "/imp/XmlYeta8200DdcImport.do");
							cpYeta82003.setEncoding(Encoding.MULTIPART);
							cpYeta82003.setMethod(Method.POST);   
							cpYeta82003.submit();  
							cpYeta82003.onFrameLoad();  
							picBoolFile = true;
						...
						// after file upload 
						cpYeta82003.addListener(Events.Submit, new Listener<FormEvent>() {
