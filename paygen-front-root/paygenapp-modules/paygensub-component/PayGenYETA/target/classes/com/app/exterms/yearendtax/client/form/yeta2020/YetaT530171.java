...
import com.app.exterms.yearendtax.client.service.yeta2020.YetaT53017Service;
import com.app.exterms.yearendtax.client.service.yeta2020.YetaT53017ServiceAsync;
...
=====================================================**/
public  class YetaT530171  extends MSFFormPanel {  
	...
	private  ContentPanel cpYetaT530171; 
	...
	// -------------- 서비스 호출 시작 --------------
	private YetaT53017ServiceAsync yetaT53017Service = YetaT53017Service.Util.getInstance();
	// -------------- 서비스 호출 종료 --------------	 
	...
	public YetaT530171(final ActionDatabase actionDatabase, final MSFPanel caller) {
		...
		cpYetaT530171 = new ContentPanel();  

		createSearchForm();			//기본정보 필드를 적용
		createMsfGridForm();		//그리드필드
		setReadOnlyTrueYetaP230171();

		cpYetaT530171.setBodyBorder(false);
		cpYetaT530171.setBorders(false);
		cpYetaT530171.setHeaderVisible(false);
		cpYetaT530171.setSize("630px", "640px");

		this.add(cpYetaT530171);
	...
	private void createMsfGridForm() {
		...
		cpYetaT530171.add(layoutContainer1);
		cpYetaT530171.add(layoutContainer2);
		cpYetaT530171.add(layoutContainer3);
		cpYetaT530171.add(layoutContainer4);
		cpYetaT530171.add(layoutContainer5);
		cpYetaT530171.add(layoutContainer6);
		cpYetaT530171.add(layoutContainer7);
		cpYetaT530171.add(layoutContainer8);
		cpYetaT530171.add(layoutContainer9);
	}	
	...
	public void reload() {
		...
		yetaT53017Service.getYetaP53017ToYe169010List(ye1690103Dto, new AsyncCallback<Ye169010DTO>(){
			...
			public void onSuccess(Ye169010DTO result) {
				// TODO Auto-generated method stub
				readYetaP53017Data(result);
			}
		});
	}	 
	public void readYetaP53017Data(Ye169010DTO result) {
