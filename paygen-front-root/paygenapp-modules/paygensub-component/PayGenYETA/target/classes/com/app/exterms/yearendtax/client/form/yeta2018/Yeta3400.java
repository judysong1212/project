...
import com.app.exterms.yearendtax.client.form.defs.yeta2018.Ye18Ta1000Def;
import com.app.exterms.yearendtax.client.service.yeta2018.Yeta3400Service;
import com.app.exterms.yearendtax.client.service.yeta2018.Yeta3400ServiceAsync;
 ...
 * =====================================================
 **/
public class Yeta3400 extends MSFPanel {
	...
	private FormPanel plFrmYeta3400;
...
//	private MSFGridPanel typOccuCdGridPanel;
	 ...
	 **/
	// ---------- 상단 버튼 시작 ----------
	private ButtonBar topYeta3400Bar;
	private Button btnYeta3400Reset;	//초기화
	private Button btnYeta3400Save;		//저장
	private Button btnYeta3400Search;	//조회
	// ---------- 상단 버튼 종료 ----------
	
	// ---------- 엑셀 버튼 시작 ----------
	private ButtonBar exYeta3400Bar;	
...
//	private Yeta0100ServiceAsync yeta0100Service = Yeta0100Service.Util.getInstance();
	private Yeta3400ServiceAsync yeta3400Service = Yeta3400Service.Util.getInstance();
	// -------------- 서비스 호출 종료 --------------
	 ...
	 */
	private void checkYeta3400Auth(String authAction, ListStore<BaseModel> bm) {
	 ...
	 private void authExecEnabled() { 
		 ...
		 /**
			...
			creYrtxBlggYr.setValue(lsClutYrStore.findModel("year", "2018"));
			yrtxBlggYr.setValue(lscreClutYrStore.findModel("year", "2018"));
...
//			formData = new FormData("-650");
			...
			createYeta3400Form();	// 화면 기본정보를 설정
	...
	public Yeta3400(String txtForm) {
		...
		lscreEmymtDivCd.addStoreListener(new StoreListener<BaseModel>() {
			public void handleEvent(StoreEvent<BaseModel> be) {
				...
				if (type == Store.Add) {
					 ...
					 * ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
					 */
					checkYeta3400Auth("creEmymtDivCd", lscreEmymtDivCd);
				}
			}
		});
		...
		creDeptCd.getStore().addStoreListener(new StoreListener<ModelData>() {
			public void handleEvent(StoreEvent<ModelData> be) {
				...
				if (type == Store.Add) {
					 ...
					 * ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
					 */
					checkYeta3400Auth("creDeptCd", lscreDeptCd);
				}
			}
		});
		...
		creTypOccuCd.getStore().addStoreListener(new StoreListener<ModelData>() {
			public void handleEvent(StoreEvent<ModelData> be) {
				...
				if (type == Store.Add) {
					 ...
					 * ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
					 */
					//checkYeta3400Auth("creTypOccuCd", lsTypOccuCd);
				}
			}
		});
...
//		layoutContainer1_4.setStyleAttribute("marginBottom", "10px");
		...
		exYeta3400Bar = new ButtonBar();
		exYeta3400Bar.setAlignment(HorizontalAlignment.RIGHT);

		/*
		btnYetaVerifiction= new Button("신고사전검증");
		exYeta3400Bar.add(btnYetaVerifiction);
		...
		exYeta3400Bar.add(btnYetaExImport);

		btnYetaExSave= new Button("신고파일생성");
		exYeta3400Bar.add(btnYetaExSave);
		...
		layoutContainer11.add(exYeta3400Bar);
		...
		plFrmYeta3400.add(layoutContainer1_4,new com.extjs.gxt.ui.client.widget.layout.ColumnData(1));	// 텍스트와 버튼
...
//		});
	...
	private void createYeta3400Form() {

		plFrmYeta3400 = new FormPanel();
		plFrmYeta3400.setHeadingText(PayGenConst.PAYGEN_VERSION.concat(" - 연말정산신고파일생성"));
		plFrmYeta3400.setIcon(Resources.APP_ICONS.text());
		plFrmYeta3400.setPadding(2);
		plFrmYeta3400.setFrame(true);
		...
		plFrmYeta3400.getHeader().setStyleAttribute("padding", "5px 0 2px 0");
		plFrmYeta3400.getHeader().addTool(btnlogView); 
		/************************************************************************
		 * 화면 에러 처리시 필요한 부분으로 추가 
		 ************************************************************************/
		
		   //멀티콤보박스 닫기 
		plFrmYeta3400.addListener(Events.OnClick,new Listener<ComponentEvent>() { 
		            @Override
		            public void handleEvent(ComponentEvent ce) { 
...
//						                        }
	...
	private void createSearchForm() {
		...
		topYeta3400Bar = new ButtonBar();
		topYeta3400Bar.setAlignment(HorizontalAlignment.RIGHT);

		btnYeta3400Reset = new Button("초기화");
		btnYeta3400Reset.setIcon(MSFMainApp.ICONS.new16());
		btnYeta3400Reset.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				resetStandardForm();	//전자신고기본정보 초기화
			}
		});
		topYeta3400Bar.add(btnYeta3400Reset);

//		topBtn = new Button("신 규");
//		topBtn.setIcon(MSFMainApp.ICONS.new16());
//		topYeta3400Bar.add(topBtn);
...
//		buttonBar.add(topBtn);
		...
		btnYeta3400Search = new Button("조 회");
		btnYeta3400Search.setIcon(MSFMainApp.ICONS.search());
		btnYeta3400Search.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
...
//				ye161005Bm.setSrhBusinCd(MSFSharedUtils.getSelectedComboValue(srhBusinCd,"businCd"));
				...
				yeta3400Service.getYeta3400List(ye161005Dto, new AsyncCallback<Ye161005BM>(){
		...
		topYeta3400Bar.add(btnYeta3400Search);

//		topBtn = new Button("인 쇄");
//		topBtn.setIcon(MSFMainApp.ICONS.print16());
//		buttonBar.add(topBtn);
		
		plFrmYeta3400.add(topYeta3400Bar);
		...
		lsEmymtDivCd.addStoreListener(new StoreListener<BaseModel>() {
			public void handleEvent(StoreEvent<BaseModel> be) {
				...
				if (type == Store.Add) {
					 ...
					 * ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
					 */
					checkYeta3400Auth("srhEmymtDivCd", lsEmymtDivCd);
				}
			}
		});
		...
		srhDeptCd.getStore().addStoreListener(new StoreListener<ModelData>() {
			public void handleEvent(StoreEvent<ModelData> be) {
				...
				if (type == Store.Add) {
					 ...
					 * ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
					 */
					checkYeta3400Auth("srhDeptCd", lsDeptCd);
				}
			}
		});
		...
		srhTypOccuCd.getStore().addStoreListener(new StoreListener<ModelData>() {
			public void handleEvent(StoreEvent<ModelData> be) {
				...
				if (type == Store.Add) {
					 ...
					 * ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
					 */
					//checkYeta3400Auth("srhTypOccuCd", lsTypOccuCd);
				}
			}
		});
...
//					Yeta3400Service.getYeta3400List(ye161005Bm, new AsyncCallback<Ye161005BM>(){
//						@Override
//						public void onFailure(Throwable caught) {
//							MessageBox.alert(MSFMainApp.MSFCONSTANTS.Alert(), "조회에 실패하였습니다.", null);
//						}
...
//        cpGrid.add(gridFieldSet);
		...
		plFrmYeta3400.add(gridFieldSet);
//		plFrmYeta3400.add(msfGridPanel);
	}
...
//		layoutContainer1_5.setBorders(false);
//
//		plFrmYeta3400.add(layoutContainer1_5, new com.extjs.gxt.ui.client.widget.layout.ColumnData(1)); // 텍스트와 버튼
...
//		msfGridPanel.getTableDef().addColumnFilter("businCd", MSFSharedUtils.getSelectedComboValue(srhBusinCd,"businCd"), SimpleColumnFilter.OPERATOR_EQUALS);//사업
	...
	/** 정산 마감 및 풀기 **/
	private void finishYeta3400(final String flag) { 
...
//	    				ye161005Bm.setBusinCd(MSFSharedUtils.getSelectedComboValue(srhBusinCd,"businCd"));
	    			...
	    			//	ye17Ta1010Dto.setBusoprRgstnum(MSFSharedUtils.getSelectedComboValue(srhBusoprRgstnum, "busoprRgstnum"));
	      				...
	      				yeta3400Service.finishOnYe161005(ye17Ta1010Dto, new AsyncCallback<Long>(){
	                         public void onFailure(Throwable caught) {
...
//			} else { 
				msfGridPanel.callXlsExportServlet(GWT.getHostPageBaseURL() + "exp/XlsYeta3400Export.do","extgwtFrame" ,param);   
			//}
		}else{ 
			msfGridPanel.callXlsExportServlet(GWT.getHostPageBaseURL() + "exp/XlsYeta3400Export.do","extgwtFrame" ,param);  
		}
...
//		ye161005ExDto.setDpobCd(dpobCd.getValue());    														/** column 사업장코드 : dpobCd */
		...
		yeta3400Service.updateYe161005(ye161005ExDto, new AsyncCallback<Long>(){
			@Override
			public void onFailure(Throwable caught) {
...
//			if("".equals(MSFSharedUtils.getSelectedComboValue(srhBusinCd,"businCd"))){ 
			...
			//	MessageBox.alert(MSFMainApp.MSFCONSTANTS.Alert(), "사업명을 선택하십시요.", null);
			//} else { 
				msfGridPanel.callXlsExportServlet(GWT.getHostPageBaseURL() + "exp/FileYeta3400Export.do","extgwtFrame" ,param);   
			//}
		}else{ 
...
//							+ "  busoprRgstnum :  "  + param.get("busoprRgstnum"));
	...
	/*-----------------------------------------------------------------------------------------------------------------------------------
	 * 검증 추가 
	 *  @RequestMapping(value = "/exp/Yeta3400Verifiction.do") 
	 -------------------------------------------------------------------------------------------------------------------------------------*/
...
//		param.put("businCd", MSFSharedUtils.getSelectedComboValue(creBusinCd,"businCd"));
		...
		if(MSFSharedUtils.paramNull(param.get("resuNumb"))){
			...
			MessageBox.info("", "중간 생성부 부서 또는 원천징수부서는 필수 입니다.(택1)", null);
				...
				msfGridPanel.callXlsExportServlet(GWT.getHostPageBaseURL() + "exp/Yeta3400Verifiction.do","extgwtFrame" ,param);   
