...
@RemoteServiceRelativePath("YetaP230011Service.gwt")
public interface YetaP230011Service extends RemoteService {
	/**
	 * Utility class for simplifying access to the instance of async service.
	 */
	public static class Util {
		private static YetaP230011ServiceAsync instance;
		public static YetaP230011ServiceAsync getInstance(){
			if (instance == null) {
				instance = GWT.create(YetaP230011Service.class);
			}
			return instance;
		}
	}
