...
import com.app.exterms.yearendtax.client.service.yeta2017.YetaT23014Service;
import com.app.exterms.yearendtax.client.service.yeta2017.YetaT23014ServiceAsync;
...
//import com.app.exterms.yearendtax.client.form.defs.yeta2016.YetaT23014Def;
/**====================================================
디자인화면 수정시 extends 부분을 다음과 같이 수정하여 사용한 후 다시 원복한다.
extends MSFPanel ->  extends LayoutContainer  implements IMSFWindow { 
상속받아 소스를 구현한 경우에는 에러나는 부분을 수정하여 처리 해야함.
=====================================================**/
public  class YetaT23014   extends MSFFormPanel {  
 ...
 **/
	...
	private  ContentPanel cpYetaT23014; 
	...
	// -------------- grid 선언 시작  ---------------	  
	private MSFGridPanel yetaT23014GridPanel;
//	private YetaT23014Def yetaT23014Def = new YetaT23014Def("YetaT23014");   //TODO 일단 화면번호로 Def
	// -------------- grid 선언 종료  ---------------
	...
	// -------------- 서비스 호출 시작 --------------
	private YetaT23014ServiceAsync yetaT23014Service = YetaT23014Service.Util.getInstance();
	// -------------- 서비스 호출 종료 --------------	 
...
//					ye162510Dto.setMnthRnttyHusCnttArea((MSFSharedUtils.allowNulls(bmMapModel.get("mnthRnttyHusCnttArea"))));    		/** column 월세주택계약면적 : mnthRnttyHusCnttArea */
				...
				yetaT23014Service.activityOnYetaT23014(listYe162510Dto, actionDatabase, new AsyncCallback<Long>(){
...
//		 }
	...
	public YetaT23014(final ActionDatabase actionDatabase, final MSFPanel caller) {
...
//		initLoad(); 	
		...
		this.actionDatabase = actionDatabase;
	 	...
	 	cpYetaT23014 = new ContentPanel();  

		createSearchForm();			//기본정보 필드를 적용
	 	createMsfGridForm();		//그리드필드
		   
		cpYetaT23014.setBodyBorder(false);
		cpYetaT23014.setBorders(false);
		cpYetaT23014.setHeaderVisible(false);
		cpYetaT23014.setSize("790px", "640px");
		   
		this.add(cpYetaT23014);
...
//		     });     
		...
		cpYetaT23014.setLayout(new FlowLayout());
...
//	      	     }
//				 
//				yetaT23014GridPanel.getMsfGrid().clearData();
//				 
//				BaseModel bmData = yetaT23014GridPanel.getTableDef().getDefaultValues();  
//		              
...
//		         
//		        yetaT23014GridPanel.getMsfGrid().getGrid().stopEditing();      
//		        yetaT23014GridPanel.getMsfGrid().getGrid().getStore().insert(bmData,0);   
//		        yetaT23014GridPanel.getMsfGrid().getGrid().startEditing(yetaT23014GridPanel.getMsfGrid().getGrid().getStore().indexOf(bmData), 0);   
//
...
//			public void handleEvent(ButtonEvent e) {
//				Iterator<BaseModel> itBm = yetaT23014GridPanel.getMsfGrid().getGrid().getSelectionModel().getSelectedItems().listIterator();
...
//			public void handleEvent(ButtonEvent e) {
//				setListRecord(yetaT23014GridPanel.getMsfGrid().getStore().getModifiedRecords().iterator());
//				doAction(actionDatabase);
//
//				if ((ActionDatabase.INSERT).equals(actionDatabase)) {
//					actionDatabase = ActionDatabase.INSERT;
...
//			topYetaBtnBar.add(btnYetaClose);
		...
		cpYetaT23014.add(topYetaBtnBar);
...
//		yetaT23014GridPanel = new MSFGridPanel(yetaT23014Def, false, false, false, false, false);
//		yetaT23014GridPanel.setSize("790px", "420px");
//		yetaT23014GridPanel.setBorders(true);
//		yetaT23014GridPanel.setHeaderVisible(false);
//		
...
//		
//		yetaT23014GridPanel.getGrid().getColumnModel().addAggregationRow(payrSummaryRow);  
//		
...
//		
//		yetaT23014GridPanel.getGrid().getColumnModel().addAggregationRow(payrSummaryRow1);
//		/** --- 그리드 합계 부분  종료 --- **/
		
//        cpYetaT23014.add(yetaT23014GridPanel);
...
//		layoutContainer.add(fldstNewFieldset_1);
		...
		cpYetaT23014.add(fieldSet1);
		cpYetaT23014.add(fieldSet2);
		cpYetaT23014.add(fldstNewFieldset_1);
	...
	public void reload() {
			...
			yetaT23014GridPanel.getTableDef().setTableColumnFilters(filters);
			yetaT23014GridPanel.getTableDef().addColumnFilter("yrtxBlggYr", MSFSharedUtils.allowNulls(srhYrtxBlggYr.getValue())
...
//					, SimpleColumnFilter.OPERATOR_EQUALS);//연말정산귀속년도
			yetaT23014GridPanel.getTableDef().addColumnFilter("clutSeptCd", MSFSharedUtils.getSelectedComboValue(srhClutSeptCd,"commCd")
					, SimpleColumnFilter.OPERATOR_EQUALS);//정산구분
			yetaT23014GridPanel.getTableDef().addColumnFilter("systemkey", MSFSharedUtils.allowNulls(systemkey.getValue())
					, SimpleColumnFilter.OPERATOR_EQUALS);//시스템키
		 
			yetaT23014GridPanel.reload();
