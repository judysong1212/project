...
public class Ye162010Def  extends TableDef implements YetaDaoConstants {
	...
	public Ye162010Def(String chkPayrDef) {
		...
		if ("YetaP83007".equals(chkPayrDef)) {

			setDaoClass("");
			setCustomListMethod(CLASS_YETAP83007_TO_YE162010_DATA_LIST);
			setAutoFillGrid(true);
			setShowFilterToolbar(false);
			setCheckBoxOnGridRows(true);
			setColumnsDefinition(getYetaP83007ToYe162010ColumnsList());
    ...
    private List<ColumnDef> getYetaP83007ToYe162010ColumnsList(){
        row = 0;
