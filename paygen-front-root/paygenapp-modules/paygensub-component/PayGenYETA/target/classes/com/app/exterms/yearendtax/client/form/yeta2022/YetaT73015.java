...
import com.app.exterms.yearendtax.client.service.yeta2022.YetaT73015Service;
import com.app.exterms.yearendtax.client.service.yeta2022.YetaT73015ServiceAsync;
...
//import com.app.exterms.yearendtax.client.form.defs.yeta2016.YetaT73015Def;
...
=====================================================**/
public  class YetaT73015   extends MSFFormPanel {  
 ...
 **/
	...
	private  ContentPanel cpYetaT73015; 
	...
	// -------------- grid 선언 시작  ---------------	  
	private MSFGridPanel YetaT73015GridPanel;
//	private YetaT73015Def YetaT73015Def = new YetaT73015Def("YetaT73015");   //TODO 일단 화면번호로 Def
	// -------------- grid 선언 종료  ---------------
	...
	// -------------- 서비스 호출 시작 --------------
	private YetaT73015ServiceAsync yetaT73015Service = YetaT73015Service.Util.getInstance();
	// -------------- 서비스 호출 종료 --------------	 
...
//					ye162510Dto.setMnthRnttyHusCnttArea((MSFSharedUtils.allowNulls(bmMapModel.get("mnthRnttyHusCnttArea"))));    		/** column 월세주택계약면적 : mnthRnttyHusCnttArea */
				...
				yetaT73015Service.activityOnYetaT73015(listYe162510Dto, actionDatabase, new AsyncCallback<Long>(){
...
//		 }
	...
	public YetaT73015(final ActionDatabase actionDatabase, final MSFPanel caller) {
...
//		initLoad(); 	
		...
		this.actionDatabase = actionDatabase;
	 	...
	 	cpYetaT73015 = new ContentPanel();  

		createSearchForm();			//기본정보 필드를 적용
	 	createMsfGridForm();		//그리드필드
		   
		cpYetaT73015.setBodyBorder(false);
		cpYetaT73015.setBorders(false);
		cpYetaT73015.setHeaderVisible(false);
		cpYetaT73015.setSize("790px", "640px");
		   
		this.add(cpYetaT73015);
...
//		     });     
		...
		cpYetaT73015.setLayout(new FlowLayout());
...
//	      	     }
//				 
//				YetaT73015GridPanel.getMsfGrid().clearData();
//				 
//				BaseModel bmData = YetaT73015GridPanel.getTableDef().getDefaultValues();  
//		              
...
//		         
//		        YetaT73015GridPanel.getMsfGrid().getGrid().stopEditing();      
//		        YetaT73015GridPanel.getMsfGrid().getGrid().getStore().insert(bmData,0);   
//		        YetaT73015GridPanel.getMsfGrid().getGrid().startEditing(YetaT73015GridPanel.getMsfGrid().getGrid().getStore().indexOf(bmData), 0);   
//
...
//			public void handleEvent(ButtonEvent e) {
//				Iterator<BaseModel> itBm = YetaT73015GridPanel.getMsfGrid().getGrid().getSelectionModel().getSelectedItems().listIterator();
...
//			public void handleEvent(ButtonEvent e) {
//				setListRecord(YetaT73015GridPanel.getMsfGrid().getStore().getModifiedRecords().iterator());
//				doAction(actionDatabase);
//
//				if ((ActionDatabase.INSERT).equals(actionDatabase)) {
//					actionDatabase = ActionDatabase.INSERT;
...
//			topYetaBtnBar.add(btnYetaClose);
		...
		cpYetaT73015.add(topYetaBtnBar);
...
//		cpYetaT73015.add(topYetaBtnBar);
//		
//		YetaT73015GridPanel = new MSFGridPanel(YetaT73015Def, false, false, false, false, false);
//		YetaT73015GridPanel.setSize("790px", "420px");
//		YetaT73015GridPanel.setBorders(true);
//		YetaT73015GridPanel.setHeaderVisible(false);
...
//		
//		YetaT73015GridPanel.getGrid().getColumnModel().addAggregationRow(payrSummaryRow);  
//		
...
//		
//		YetaT73015GridPanel.getGrid().getColumnModel().addAggregationRow(payrSummaryRow1);
//		/** --- 그리드 합계 부분  종료 --- **/
		
 //       cpYetaT73015.add(YetaT73015GridPanel);
		FieldSet fieldSet = new FieldSet();
		...
		cpYetaT73015.add(fieldSet);
		cpYetaT73015.add(layoutContainer6);
		cpYetaT73015.add(fldstNewFieldset_1);
	...
	public void reload() {
			...
			YetaT73015GridPanel.getTableDef().setTableColumnFilters(filters);
			YetaT73015GridPanel.getTableDef().addColumnFilter("yrtxBlggYr", MSFSharedUtils.allowNulls(srhYrtxBlggYr.getValue())
...
//					, SimpleColumnFilter.OPERATOR_EQUALS);//연말정산귀속년도
			YetaT73015GridPanel.getTableDef().addColumnFilter("clutSeptCd", MSFSharedUtils.getSelectedComboValue(srhClutSeptCd,"commCd")
					, SimpleColumnFilter.OPERATOR_EQUALS);//정산구분
			YetaT73015GridPanel.getTableDef().addColumnFilter("systemkey", MSFSharedUtils.allowNulls(systemkey.getValue())
					, SimpleColumnFilter.OPERATOR_EQUALS);//시스템키
		 
			YetaT73015GridPanel.reload();
