...
import com.app.exterms.yearendtax.client.service.yeta2017.YetaT23016Service;
import com.app.exterms.yearendtax.client.service.yeta2017.YetaT23016ServiceAsync;
...
//import com.app.exterms.yearendtax.client.form.defs.yeta2016.YetaT23016Def;
...
=====================================================**/
public  class YetaT23016   extends MSFFormPanel {  
 ...
 **/
	...
	private  ContentPanel cpYetaT23016; 
	...
	// -------------- grid 선언 시작  ---------------	  
	private MSFGridPanel yetaT23016GridPanel;
//	private YetaT23016Def yetaT23016Def = new YetaT23016Def("YetaT23016");   //TODO 일단 화면번호로 Def
	// -------------- grid 선언 종료  ---------------
	...
	// -------------- 서비스 호출 시작 --------------
	private YetaT23016ServiceAsync yetaT23016Service = YetaT23016Service.Util.getInstance();
	// -------------- 서비스 호출 종료 --------------	 
...
//					ye162510Dto.setMnthRnttyHusCnttArea((MSFSharedUtils.allowNulls(bmMapModel.get("mnthRnttyHusCnttArea"))));    		/** column 월세주택계약면적 : mnthRnttyHusCnttArea */
				...
				yetaT23016Service.activityOnYetaT23016(listYe162510Dto, actionDatabase, new AsyncCallback<Long>(){
...
//		 }
	...
	public YetaT23016(final ActionDatabase actionDatabase, final MSFPanel caller) {
...
//		initLoad(); 	
		...
		this.actionDatabase = actionDatabase;
	 	...
	 	cpYetaT23016 = new ContentPanel();  

		createSearchForm();			//기본정보 필드를 적용
	 	createMsfGridForm();		//그리드필드
		   
		cpYetaT23016.setBodyBorder(false);
		cpYetaT23016.setBorders(false);
		cpYetaT23016.setHeaderVisible(false);
		cpYetaT23016.setSize("790px", "640px");
		   
		this.add(cpYetaT23016);
...
//		     });     
		...
		cpYetaT23016.setLayout(new FlowLayout());
...
//	      	     }
//				 
//				yetaT23016GridPanel.getMsfGrid().clearData();
//				 
//				BaseModel bmData = yetaT23016GridPanel.getTableDef().getDefaultValues();  
//		              
...
//		         
//		        yetaT23016GridPanel.getMsfGrid().getGrid().stopEditing();      
//		        yetaT23016GridPanel.getMsfGrid().getGrid().getStore().insert(bmData,0);   
//		        yetaT23016GridPanel.getMsfGrid().getGrid().startEditing(yetaT23016GridPanel.getMsfGrid().getGrid().getStore().indexOf(bmData), 0);   
//
...
//			public void handleEvent(ButtonEvent e) {
//				Iterator<BaseModel> itBm = yetaT23016GridPanel.getMsfGrid().getGrid().getSelectionModel().getSelectedItems().listIterator();
...
//				
		...
		btnYetaSave.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				setListRecord(yetaT23016GridPanel.getMsfGrid().getStore().getModifiedRecords().iterator());
				doAction(actionDatabase);
...
//				
		cpYetaT23016.add(topYetaBtnBar);
...
//		yetaT23016GridPanel = new MSFGridPanel(yetaT23016Def, false, false, false, false, false);
//		yetaT23016GridPanel.setSize("790px", "420px");
//		yetaT23016GridPanel.setBorders(true);
//		yetaT23016GridPanel.setHeaderVisible(false);
...
//		
//		yetaT23016GridPanel.getGrid().getColumnModel().addAggregationRow(payrSummaryRow);  
//		
...
//		
//		yetaT23016GridPanel.getGrid().getColumnModel().addAggregationRow(payrSummaryRow1);
//		/** --- 그리드 합계 부분  종료 --- **/
		
//        cpYetaT23016.add(yetaT23016GridPanel);
		...
		cpYetaT23016.add(layoutContainer);
		...
		cpYetaT23016.add(layoutContainer1);
		...
		cpYetaT23016.add(layoutContainer2);
		...
		cpYetaT23016.add(layoutContainer_gibu08);
		...
		cpYetaT23016.add(fldstNewFieldset_4);
	...
	public void reload() {
			...
			yetaT23016GridPanel.getTableDef().setTableColumnFilters(filters);
			yetaT23016GridPanel.getTableDef().addColumnFilter("yrtxBlggYr", MSFSharedUtils.allowNulls(srhYrtxBlggYr.getValue())
...
//					, SimpleColumnFilter.OPERATOR_EQUALS);//연말정산귀속년도
			yetaT23016GridPanel.getTableDef().addColumnFilter("clutSeptCd", MSFSharedUtils.getSelectedComboValue(srhClutSeptCd,"commCd")
					, SimpleColumnFilter.OPERATOR_EQUALS);//정산구분
			yetaT23016GridPanel.getTableDef().addColumnFilter("systemkey", MSFSharedUtils.allowNulls(systemkey.getValue())
					, SimpleColumnFilter.OPERATOR_EQUALS);//시스템키
		 
			yetaT23016GridPanel.reload();
