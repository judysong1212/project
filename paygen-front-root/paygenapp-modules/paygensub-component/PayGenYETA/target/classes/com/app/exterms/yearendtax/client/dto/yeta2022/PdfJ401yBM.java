 ...
 */
public class PdfJ401yBM   extends MSFSimpleBaseModel implements IsSerializable  {
    ...
    /** set 목돈안전세_사업자등록번호 : busnid */
    public static final String ATTR_BUSNID = "busnid";

    /** set 목돈안전세_취급기관명 : tradeNm */
    public static final String ATTR_TRADENM = "tradeNm";

    /** set 목돈안전세_대출원금 : lendLoanAmt */
    public static final String ATTR_LENDLOANAMT = "lendLoanAmt";

    /** set 목돈안전세_대출일자 : lendDt */
    public static final String ATTR_LENDDT = "lendDt";

    /** set 목돈안전세_연간합계액 : sizSum */
    public static final String ATTR_SIZSUM = "sizSum";
    ...
    /** 일괄등록 처리   */
     public PdfJ401yBM(
     	...
     	values.put(ATTR_LENDLOANAMT,lendLoanAmt);
     	values.put(ATTR_LENDDT,lendDt);
     	values.put(ATTR_SIZSUM,sizSum);
    ...
    /** get 목돈안전세_사업자등록번호 : busnid */
    public String  getBusnid() { return (String )get( ATTR_BUSNID );}

    /** set 목돈안전세_취급기관명 : tradeNm */
    public void setTradeNm(String  tradeNm) { set( ATTR_TRADENM ,tradeNm);}
    /** get 목돈안전세_취급기관명 : tradeNm */
    public String  getTradeNm() { return (String )get( ATTR_TRADENM );}

    /** set 목돈안전세_대출원금 : lendLoanAmt */
    public void setLendLoanAmt(Long  lendLoanAmt) { set( ATTR_LENDLOANAMT ,lendLoanAmt);}
    /** get 목돈안전세_대출원금 : lendLoanAmt */
    public Long  getLendLoanAmt() { return (Long )get( ATTR_LENDLOANAMT );}

    /** set 목돈안전세_대출일자 : lendDt */
    public void setLendDt(String  lendDt) { set( ATTR_LENDDT ,lendDt);}
    /** get 목돈안전세_대출일자 : lendDt */
    public String  getLendDt() { return (String )get( ATTR_LENDDT );}

    /** set 목돈안전세_연간합계액 : sizSum */
    public void setSizSum(Long  sizSum) { set( ATTR_SIZSUM ,sizSum);}
    /** get 목돈안전세_연간합계액 : sizSum */
    public Long  getSizSum() { return (Long )get( ATTR_SIZSUM );}
