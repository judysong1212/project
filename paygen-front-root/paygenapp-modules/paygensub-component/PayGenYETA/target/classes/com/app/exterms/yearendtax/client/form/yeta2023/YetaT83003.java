...
import com.app.exterms.yearendtax.client.service.yeta2023.YetaT83002Service;
import com.app.exterms.yearendtax.client.service.yeta2023.YetaT83002ServiceAsync;
...
//import com.app.exterms.yearendtax.client.form.defs.yeta2016.YetaT83002Def;
...
=====================================================**/
public  class YetaT83003   extends MSFFormPanel {  
 ...
 **/
	...
	private  ContentPanel cpYetaT83002; 
	...
	// -------------- grid 선언 시작  ---------------	  
	private MSFGridPanel yetaT83002GridPanel;
//	private YetaT83002Def yetaT83002Def = new YetaT83002Def("YetaT83002");   //TODO 일단 화면번호로 Def
	// -------------- grid 선언 종료  ---------------
	...
	// -------------- 서비스 호출 시작 --------------
	private YetaT83002ServiceAsync yetaT83002Service = YetaT83002Service.Util.getInstance();
	// -------------- 서비스 호출 종료 --------------	 
...
//					ye162510Dto.setMnthRnttyHusCnttArea((MSFSharedUtils.allowNulls(bmMapModel.get("mnthRnttyHusCnttArea"))));    		/** column 월세주택계약면적 : mnthRnttyHusCnttArea */
				...
				yetaT83002Service.activityOnYetaT83002(listYe162510Dto, actionDatabase, new AsyncCallback<Long>(){
...
//		 }
	...
	public YetaT83003(final ActionDatabase actionDatabase, final MSFPanel caller) {
...
//		initLoad(); 	
		...
		this.actionDatabase = actionDatabase;
	 	...
	 	cpYetaT83002 = new ContentPanel();  

		createSearchForm();			//기본정보 필드를 적용
	 	createMsfGridForm();		//그리드필드
		   
		cpYetaT83002.setBodyBorder(false);
		cpYetaT83002.setBorders(false);
		cpYetaT83002.setHeaderVisible(false);
		cpYetaT83002.setSize("790px", "640px");
		   
		this.add(cpYetaT83002);
...
//		     });     
		...
		cpYetaT83002.setLayout(new FlowLayout());
...
//	      	     }
//				 
//				yetaT83002GridPanel.getMsfGrid().clearData();
//				 
//				BaseModel bmData = yetaT83002GridPanel.getTableDef().getDefaultValues();  
//		              
...
//		         
//		        yetaT83002GridPanel.getMsfGrid().getGrid().stopEditing();      
//		        yetaT83002GridPanel.getMsfGrid().getGrid().getStore().insert(bmData,0);   
//		        yetaT83002GridPanel.getMsfGrid().getGrid().startEditing(yetaT83002GridPanel.getMsfGrid().getGrid().getStore().indexOf(bmData), 0);   
//
...
//			public void handleEvent(ButtonEvent e) {
//				Iterator<BaseModel> itBm = yetaT83002GridPanel.getMsfGrid().getGrid().getSelectionModel().getSelectedItems().listIterator();
...
//		topYetaBtnBar.add(btnYetaDel);
		...
		btnYetaSave.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				setListRecord(yetaT83002GridPanel.getMsfGrid().getStore().getModifiedRecords().iterator());
				doAction(actionDatabase);
...
//			topYetaBtnBar.add(btnYetaClose);
		...
		cpYetaT83002.add(topYetaBtnBar);
...
//		yetaT83002GridPanel = new MSFGridPanel(yetaT83002Def, false, false, false, false, false);
//		yetaT83002GridPanel.setSize("790px", "420px");
//		yetaT83002GridPanel.setBorders(true);
//		yetaT83002GridPanel.setHeaderVisible(false);
//		
//      cpYetaT83002.add(yetaT83002GridPanel);
...
//		cpYetaT83002.add(fldstNewFieldset10);
		cpYetaT83002.add(fldstNewFieldset);
		cpYetaT83002.add(fldstNewFieldset1);
		cpYetaT83002.add(layoutContainer14);
		cpYetaT83002.add(layoutContainer15);
	...
	public void reload() {
			...
			yetaT83002GridPanel.getTableDef().setTableColumnFilters(filters);
			yetaT83002GridPanel.getTableDef().addColumnFilter("yrtxBlggYr", MSFSharedUtils.allowNulls(srhYrtxBlggYr.getValue())
...
//					, SimpleColumnFilter.OPERATOR_EQUALS);//연말정산귀속년도
			yetaT83002GridPanel.getTableDef().addColumnFilter("clutSeptCd", MSFSharedUtils.getSelectedComboValue(srhClutSeptCd,"commCd")
					, SimpleColumnFilter.OPERATOR_EQUALS);//정산구분
			yetaT83002GridPanel.getTableDef().addColumnFilter("systemkey", MSFSharedUtils.allowNulls(systemkey.getValue())
					, SimpleColumnFilter.OPERATOR_EQUALS);//시스템키
		 
			yetaT83002GridPanel.reload();
