...
import com.app.exterms.yearendtax.client.service.yeta2020.YetaT53009Service;
import com.app.exterms.yearendtax.client.service.yeta2020.YetaT53009ServiceAsync;
...
//import com.app.exterms.yearendtax.client.form.defs.yeta2016.YetaT53009Def;
...
=====================================================**/
public  class YetaT53009   extends MSFFormPanel {  
 ...
 **/
	...
	private  ContentPanel cpYetaT53009; 
	...
	// -------------- grid 선언 시작  ---------------	  
	private MSFGridPanel YetaT53009GridPanel;
//	private YetaT53009Def YetaT53009Def = new YetaT53009Def("YetaT53009");   //TODO 일단 화면번호로 Def
	// -------------- grid 선언 종료  ---------------
	...
	// -------------- 서비스 호출 시작 --------------
	private YetaT53009ServiceAsync yetaT53009Service = YetaT53009Service.Util.getInstance();
	// -------------- 서비스 호출 종료 --------------	 
...
//					ye162510Dto.setMnthRnttyHusCnttArea((MSFSharedUtils.allowNulls(bmMapModel.get("mnthRnttyHusCnttArea"))));    		/** column 월세주택계약면적 : mnthRnttyHusCnttArea */
				...
				yetaT53009Service.activityOnYetaT53009(listYe162510Dto, actionDatabase, new AsyncCallback<Long>(){
...
//		 }
	...
	public YetaT53009(final ActionDatabase actionDatabase, final MSFPanel caller) {
...
//		initLoad(); 	
		...
		this.actionDatabase = actionDatabase;
	 	...
	 	cpYetaT53009 = new ContentPanel();  

		createSearchForm();			//기본정보 필드를 적용
	 	createMsfGridForm();		//그리드필드
		   
		cpYetaT53009.setBodyBorder(false);
		cpYetaT53009.setBorders(false);
		cpYetaT53009.setHeaderVisible(false);
		cpYetaT53009.setSize("790px", "640px");
		   
		this.add(cpYetaT53009);
...
//		     });     
		...
		cpYetaT53009.setLayout(new FlowLayout());
...
//	      	     }
//				 
//				YetaT53009GridPanel.getMsfGrid().clearData();
//				 
//				BaseModel bmData = YetaT53009GridPanel.getTableDef().getDefaultValues();  
//		              
...
//		         
//		        YetaT53009GridPanel.getMsfGrid().getGrid().stopEditing();      
//		        YetaT53009GridPanel.getMsfGrid().getGrid().getStore().insert(bmData,0);   
//		        YetaT53009GridPanel.getMsfGrid().getGrid().startEditing(YetaT53009GridPanel.getMsfGrid().getGrid().getStore().indexOf(bmData), 0);   
//
...
//			public void handleEvent(ButtonEvent e) {
//				Iterator<BaseModel> itBm = YetaT53009GridPanel.getMsfGrid().getGrid().getSelectionModel().getSelectedItems().listIterator();
...
//			public void handleEvent(ButtonEvent e) {
//				setListRecord(YetaT53009GridPanel.getMsfGrid().getStore().getModifiedRecords().iterator());
//				doAction(actionDatabase);
//
//				if ((ActionDatabase.INSERT).equals(actionDatabase)) {
//					actionDatabase = ActionDatabase.INSERT;
...
//				
//		cpYetaT53009.add(topYetaBtnBar);
...
//		YetaT53009GridPanel = new MSFGridPanel(YetaT53009Def, false, false, false, false, false);
//		YetaT53009GridPanel.setSize("790px", "420px");
//		YetaT53009GridPanel.setBorders(true);
//		YetaT53009GridPanel.setHeaderVisible(false);
...
//		
//		YetaT53009GridPanel.getGrid().getColumnModel().addAggregationRow(payrSummaryRow);  
//		
...
//		
//		YetaT53009GridPanel.getGrid().getColumnModel().addAggregationRow(payrSummaryRow1);
//		/** --- 그리드 합계 부분  종료 --- **/
		
//        cpYetaT53009.add(YetaT53009GridPanel);
		...
		cpYetaT53009.add(layoutContainer);
		cpYetaT53009.add(layoutContainer20);
		cpYetaT53009.add(layoutContainer21);
		cpYetaT53009.add(layoutContainer22);
	...
	public void reload() {
			...
			YetaT53009GridPanel.getTableDef().setTableColumnFilters(filters);
			YetaT53009GridPanel.getTableDef().addColumnFilter("yrtxBlggYr", MSFSharedUtils.allowNulls(srhYrtxBlggYr.getValue())
...
//					, SimpleColumnFilter.OPERATOR_EQUALS);//연말정산귀속년도
			YetaT53009GridPanel.getTableDef().addColumnFilter("clutSeptCd", MSFSharedUtils.getSelectedComboValue(srhClutSeptCd,"commCd")
					, SimpleColumnFilter.OPERATOR_EQUALS);//정산구분
			YetaT53009GridPanel.getTableDef().addColumnFilter("systemkey", MSFSharedUtils.allowNulls(systemkey.getValue())
					, SimpleColumnFilter.OPERATOR_EQUALS);//시스템키
		 
			YetaT53009GridPanel.reload();
