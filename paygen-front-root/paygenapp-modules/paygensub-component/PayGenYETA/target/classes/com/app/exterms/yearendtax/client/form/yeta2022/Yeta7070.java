...
import com.app.exterms.yearendtax.client.form.defs.yeta2022.Yeta7070Def;
import com.app.exterms.yearendtax.client.service.yeta2022.Yeta7070Service;
import com.app.exterms.yearendtax.client.service.yeta2022.Yeta7070ServiceAsync;
...
=====================================================**/
public class Yeta7070  extends MSFPanel { 
	...
	private FormPanel plFrmYeta7070;
	private FormData formData; 
	private String txtForm = "";
	private XTemplate detailTp;	  
	private Yeta7070ServiceAsync Yeta7070service = Yeta7070Service.Util.getInstance(); 
	...
	private Yeta7070Def Yeta7070MSDef = new Yeta7070Def("Yeta7070MS");
	private InfcPkgBass0150Def Yeta7070ToBass0150Def = new InfcPkgBass0150Def("yeta7070ToBass0150");
	private InfcPkgBass0500Def Yeta7070ToBass0500OnDef = new InfcPkgBass0500Def("YETA7070_BASS0500_ON");
	private InfcPkgBass0500Def Yeta7070ToBass0500OffDef = new InfcPkgBass0500Def("YETA7070_BASS0500_OFF");

	private MSFGridPanel msfGridPanelYeta7070MS; 
	...
	public ContentPanel getViewPanel() {
		if (panel == null) {        	
			...
			msfGridPanelYeta7070MS.reload();
			msfGridPanelBass0150.reload();

			//			final RelationDef  relBass0360 = new RelationDef(Yeta7070MSDef,false);
			//			relBass0360.addJoinDef("utDpobCd", "utDpobCd"); 
			//			relBass0360.setLinkedObject(msfGridPanelYeta7070MS);
			//			Yeta7070ToBass0500OnDef.addRelation(relBass0360); 
			//
			//			/**
			//			 * Create the relations 
			//			 */
			//			final RelationDef  relBass0350 = new RelationDef(Yeta7070MSDef,false);
			//			relBass0350.addJoinDef("utDpobCd", "utDpobCd"); 
			//			relBass0350.setLinkedObject(msfGridPanelYeta7070MS);
			//			Yeta7070ToBass0500OffDef.addRelation(relBass0350); 
			//
			//
			//			// DETAILS 
			//			final Grid Yeta7070ToBass0500OffDefGrid = msfGridPanelYeta7070MS.getMsfGrid().getGrid();
			//			Yeta7070ToBass0500OffDefGrid.addListener(Events.CellDoubleClick, new Listener<BaseEvent>() {
			//				public void handleEvent(BaseEvent be) {  
			//					if (msfGridPanelYeta7070MS.getCurrentlySelectedItem() != null) {  
			//
			//						Yeta7070ToBass0500OnDef.synchronizeGridDetail(
			//								msfGridPanelYeta7070MS.getCurrentlySelectedItem(),
			//								msfGridPanelBass0500On );
			//
			//						Yeta7070ToBass0500OffDef.synchronizeGridDetail(
			//								msfGridPanelYeta7070MS.getCurrentlySelectedItem(),
	...
	public Yeta7070(String txtForm) {
		this.txtForm = txtForm;
	}		  

	private void createSysm0500Form() {

		plFrmYeta7070 = new FormPanel();
		plFrmYeta7070.setHeadingText("PayGen Ver1.0 - 단위사업장사업관리");
		plFrmYeta7070.setIcon(Resources.APP_ICONS.text());
		plFrmYeta7070.setBodyStyleName("pad-text");
		plFrmYeta7070.setFrame(true); 
		plFrmYeta7070.setPadding(2);
		/************************************************************************
		...
		btnlogView.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				//로그 뷰화면 호출 메서드 
				funcLogMessage("단위사업장사업관리","Yeta7070");
			}
		});
		plFrmYeta7070.getHeader().setStyleAttribute("padding", "5px 0 2px 0");
		plFrmYeta7070.getHeader().addTool(btnlogView); 
		/************************************************************************
		...
		Yeta7070MSDef.setReadOnly(true);   
		msfGridPanelYeta7070MS = new MSFGridPanel(Yeta7070MSDef, false, false, false, false,false); 
		msfGridPanelYeta7070MS.setSize(350, 620);
		msfGridPanelYeta7070MS.setBorders(true);
		msfGridPanelYeta7070MS.getGrid().setBorders(true);
		Grid grid = msfGridPanelYeta7070MS.getMsfGrid().getGrid();
		grid.addListener(Events.CellDoubleClick , new Listener<BaseEvent>() {
			public void handleEvent(BaseEvent be) {

				untDpobCd = MSFSharedUtils.allowNulls(msfGridPanelYeta7070MS.getMsfGrid().getCurrentlySelectedItem().get("utDpobCd"));

				OnReload(untDpobCd);
				OffReload();
			}					
		});
		inner.add(msfGridPanelYeta7070MS);

		msfGridPanelBass0150 = new MSFGridPanel(Yeta7070ToBass0150Def, false, false, false, false, false); 
		msfGridPanelBass0150.setSize(600, 200);
		msfGridPanelBass0150.setBorders(true);
		msfGridPanelBass0150.getGrid().setBorders(true);

		// 두번째 컨테이너컬럼(사용사업정보)   
		msfGridPanelBass0500On = new MSFGridPanel(Yeta7070ToBass0500OnDef, false, false, false, false, false); 
		...
		// 세번째 컨테이너컬럼(미사용사업정보)  
		msfGridPanelBass0500Off = new MSFGridPanel(Yeta7070ToBass0500OffDef, false, false, false, false,false); 
		...
		plFrmYeta7070.add(srhOffDeptCd);
			...
			public void componentSelected(ButtonEvent ce) {  
				...
				while (iterRecords.hasNext()) {	    		            	  
					...
					if ((Boolean)bmMapModel.get("select")) {
						...
						pkgBass0500Dto.setUntDpobCd(MSFSharedUtils.allowNulls(msfGridPanelYeta7070MS.getMsfGrid().getCurrentlySelectedItem().get("utDpobCd")));
		...
		plFrmYeta7070.add(inner);

		vp.add(plFrmYeta7070);
		plFrmYeta7070.setSize("990px", "680px");
	}	

	private Yeta7070 getThis(){
		return this;
	}
