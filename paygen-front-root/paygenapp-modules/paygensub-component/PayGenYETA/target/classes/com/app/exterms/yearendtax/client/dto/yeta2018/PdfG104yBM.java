 ...
 */
public class PdfG104yBM   extends MSFSimpleBaseModel implements IsSerializable  {
    ...
    /** 일괄등록 처리   */
     public PdfG104yBM(
     	...
     	values.put(ATTR_CARDSEILNUM,cardSeilNum);
     	...
     	values.put(ATTR_CARDAMTSUM,cardAmtSum);
    ...
    /** set 신용카드일련번호 : cardSeilNum */
    public void setCardSeilNum(Long  cardSeilNum) { set( ATTR_CARDSEILNUM ,cardSeilNum);}
    /** get 신용카드일련번호 : cardSeilNum */
    public Long  getCardSeilNum() { return (Long )get( ATTR_CARDSEILNUM );}
    ...
    /** get 신용카드전전년도일반공제대상금액합계 : ftyrTotAmt */
    ...
    /** get 신용카드전전년도전통시장공제대상금액합계 : ftyrMarketTotAmt */
    ...
    /** get 신용카드전전년도대중교통공제대상금액합셰 : ftyrTmoneyTotAmt */
    ...
    /** get 신용카드직전년도일반공제대상금액합계 : preTotAmt */
    ...
    /** get 신용카드직전년도전통시장공제대상금액합계 : preMarketTotAmt */
    ...
    /** get 신용카드직전년도대중교통공제대상금액합계 : preTmoneyTotAmt */
    ...
    /** get 신용카드귀속년도_상_대상금액합계_미 : firstTotAmt */
    ...
    /** get 신용카드귀속년도_하_대상금액합계_미 : secondTotAmt */
    ...
    /** get 신용카드귀속년도상반기대상금액합계 : firstYearTotAmt */
    ...
    /** get 신용카드귀속년도하반기대상금액합계 : secondYearTotAmt */
    ...
    /** get 신용카드조회기간종료월 : inqrEndMm */
    public String  getInqrEndMm() { return (String )get( ATTR_INQRENDMM );}

    /** set 신용카드공제대상금액합계 : cardAmtSum */
    public void setCardAmtSum(Long  cardAmtSum) { set( ATTR_CARDAMTSUM ,cardAmtSum);}
    /** get 신용카드공제대상금액합계 : cardAmtSum */
    public Long  getCardAmtSum() { return (Long )get( ATTR_CARDAMTSUM );}
