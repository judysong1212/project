...
import com.app.exterms.yearendtax.client.dto.yeta2017.Ye161030BM;
import com.app.exterms.yearendtax.client.dto.yeta2017.Ye161030DTO;
import com.app.exterms.yearendtax.client.dto.yeta2017.Ye161040BM;
...
import com.app.exterms.yearendtax.client.form.defs.yeta2017.Ye161030Def;
import com.app.exterms.yearendtax.client.form.defs.yeta2017.Ye161040Def;
import com.app.exterms.yearendtax.client.form.defs.yeta2017.Ye161090Def;
import com.app.exterms.yearendtax.client.form.defs.yeta2017.Ye169010Def;
import com.app.exterms.yearendtax.client.service.yeta2017.Yeta2300Service;
import com.app.exterms.yearendtax.client.service.yeta2017.Yeta2300ServiceAsync;
 ...
 */
public class Yeta2300 extends MSFPanel {

	private VerticalPanel vp;
	private FormPanel plFrmYeta2300;
	...
	// -------------- 탭 시작 --------------
	private TabPanel tabsYeta2300 = new TabPanel();		// 전체
	private TabPanel tabsItemYeta05 = new TabPanel();	// 특별소득공제 하위
	private TabPanel tabsItemYeta08 = new TabPanel();	// 세액감면및세액공제1 하위
	// -------------- 탭 종료 --------------

	// -------------- 상단 버튼 시작 --------------
	private ButtonBar topYeta2300Bar;
	private Button btnYeta2300All; 	// 일괄자료정리
	private Button btnYeta2300Reset; 	// 초기화
	private Button btnYeta2300New; 		// 신규
	private Button btnYeta2300Save; 	// 저장
	private Button btnYeta2300Del; 		// 삭제
	private Button btnYeta2300Sreach; 	// 조회
	private Button btnYeta2300Print; 	// 인쇄
	
	private RadioGroup printType;		// 대상자 선택
	// -------------- 상단 버튼 종료 --------------

	// -------------- 중간 버튼 시작 --------------
	private Button btnYeta2300_01;			// 의료비지급명세서
	private Button btnYeta2300_02; 			// 기부금명세서
	private Button btnYeta2300_03; 			// 재계산대상자
	private Button btnYeta2300_04; 			// 삭제
	private Button btnYeta2300_05; 			// 세액계산
	private Button btnYeta2300_06; 			// 세액재계산
	private Button btnYeta2300_07; 			// 원천징수인쇄
...
//	private Yeta2000BM yeta2000Bm;
	...
	// -------------- grid 선언 시작  ---------------
	private Ye161010Def ye161010Def  		= new Ye161010Def("YETA2300"); 		// 대상자 정보 그리드 테이블 컬럼 define
	private Yeta2000Def Ye161010Def_02  	= new Yeta2000Def("YETA200001"); 	// 대상자 정보 그리드 새로고침을 위한 define
	private Ye169010Def ye169010Def  		= new Ye169010Def("YETA2300");		// 세액계산 정보 그리드 테이블 컬럼 define 
	private Ye161030Def ye161030Def  		= new Ye161030Def("YETA2300");		// 인적공제 정보 그리드 테이블 컬럼 define
	
	private Ye161040Def ye161040Def_01  	= new Ye161040Def("YETA230001"); 	// 소득공제명세 그리드 테이블 컬럼 define(국세청자료)  
	private Ye161040Def ye161040Def_02  	= new Ye161040Def("YETA230002"); 	// 소득공제명세 그리드 테이블 컬럼 define(기타자료)
	private Ye161090Def ye161090Def  		= new Ye161090Def("YETA2300");
	
	
	private MSFGridPanel yeta2300ToYe169010GridPanel;
	private MSFGridPanel yeta2300ToYe161010GridPanel;		// 대상자정보 GridPanel
	private MSFGridPanel yeta2300ToYe161030GridPanel;		// 인적공제 GridPanel
	private MSFGridPanel yeta2300ToYe161040GridPanel_01;	// 소득공제 - 국세청 GridPanel
	private MSFGridPanel yeta2300ToYe161040GridPanel_02;	// 소득공제 - 기타자료 GridPanel
//	private MSFGridPanel yeta2300ToYe161090GridPanel;		// 가족교육비 GridPanel
	// -------------- grid 선언 종료  ---------------
...
//    private MSFNumberField cpiv14AsctUseAmt;			// 출자투자금액_조합등_2014납입금액  
//    private MSFNumberField cpiv14AsctDdcAmt;			// 출자투자금액_조합등_2014공제액 
//    
//    private MSFNumberField cpiv14VntUseAmt;   			// 출자투자금액_벤처등_2014납입금액 
//    private MSFNumberField cpiv14VntDdcAmt;   			// 출자투자금액_벤처등_2014공제액
    		
    private MSFNumberField cpiv15AsctUseAmt;			// 출자투자금액_조합등_2015납입금액
    private MSFNumberField cpiv15AsctDdcAmt;			// 출자투자금액_조합등_2015공제액
    
    private MSFNumberField cpiv15VntUseAmt;   			// 출자투자금액_벤처등_2015납입금액
    private MSFNumberField cpiv15VntDdcAmt;   			// 출자투자금액_벤처등_2015공제액
...
//	private ListStore<BaseModel> lsCrClutMnth = new ListStore<BaseModel>(); 			//급여월
	...
	// -------------- 서비스 호출 시작 -------------- 
	private Yeta2300ServiceAsync yeta2300Service = Yeta2300Service.Util.getInstance();
	// -------------- 서비스 호출 종료 --------------
	 ...
	 */
	 private void checkYeta2300Auth( String authAction, ListStore<BaseModel>bm) {
	 ...
	 private void authExecEnabled() { 
	   //------------------
		 ...
		 srhYrtxBlggYr.setValue(lsClutYrStore.findModel("year","2017"));
	 ...
	 **/
	  ...
	  * </pre>
	  * @Method Name : fnYeta2300Payr06430CalcTax
	  * @date : Jan 26, 2016
	  * @author : leeheuisung
	  * @history : 
	  *	-----------------------------------------------------------------------
	  ...
	  *
	  */
	private void fnYeta2300Payr06430CalcTax() {
		...
		MessageBox.confirm("세액계산", "선택된 연말정산계산  대상자에 대해서 세액계산을 합니다. <br> 세액재계산을 하시겠습니까?",new Listener<MessageBoxEvent>(){
			...
			public void handleEvent(MessageBoxEvent be) {
				if (Dialog.YES.equals(be.getButtonClicked().getItemId())) {
					...
					Iterator<BaseModel> itBm = yeta2300ToYe161010GridPanel.getMsfGrid().getGrid().getSelectionModel().getSelectedItems().listIterator();
					...
					if (MSFSharedUtils.paramNotNull(records)) {
			            ...
			            final Timer t = new Timer() {
			              ...
			              t.scheduleRepeating(500);
   	           	 		...
   	           	 		yeta2300Service.fnYeta2300_Ye161010_2017_CalcTax(listYe161010Dto,   new AsyncCallback<PagingLoadResult<ShowMessageBM>>() {
...
//   	           	                MSFMainApp.ADMINMESSAGES.ExceptionMessageService("activityOnInsertRemt0100(insert) : " + caught), null);
   	           	 			...
   	           	 			public void onSuccess(PagingLoadResult<ShowMessageBM> result) {  
   	           	 				...
   	           	 				//계산 결과에 따른 조회 호출 
   	           	 				BaseModel bmData = yeta2300ToYe161010GridPanel.getCurrentlySelectedItem();  
   	           	 				...
   	           	 				yeta2300ToYe161010Detail(bmData, "itemYeta01");
	...
	private void fnYeta2300Payr06430AllCalcTax() {
		...
		MessageBox.confirm("전체세액계산","선택된 연말정산계산  대상자에 대해서 전체세액계산을 합니다. <br> 세액재계산을 하시겠습니까?", new Listener<MessageBoxEvent>() {
			...
			public void handleEvent(MessageBoxEvent be) {
				if (Dialog.YES.equals(be.getButtonClicked().getItemId())) {
					...
					yeta2300Service.fnYeta2300Ye161010_2017_AllCalcTax(ye161010Dto ,new AsyncCallback<PagingLoadResult<ShowMessageBM>>() {
						public void onFailure(Throwable caught) {
...
//							reFresh();
	 ...
	 * ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
	 **/
		private void Yeta2300Print(String fileName, String repType) {
...
//			serarchParam += "[" + MSFSharedUtils.allowNulls(srhSystemkey.getValue())+"]";				//$12 시스템키 
			...
			List<BaseModel> list = yeta2300ToYe161010GridPanel.getGrid().getSelectionModel().getSelectedItems();
...
//	      	}
	...
	public ContentPanel getViewPanel() {
		if (panel == null) {
			...
			createYeta2300Form(); 	// 화면 기본정보를 설정
			createSearchForm(); 	// 검색필드를 적용
			createContentForm(); 	// 내용 필드
			vp.setSize("1010px", "1600px");

			// 폼데이터를 바인딩
			// formBinding = new FormBinding(this.plFrmYeta2300, true);
	...
	public Yeta2300(String txtForm) {
...
//				}	
//				
//				yeta2300Service.updateYeta2300All(listYe161040Dto, new AsyncCallback<Integer>() {
//
//					public void onFailure(Throwable caught) {
//						MessageBox.alert( MSFMainApp.MSFCONSTANTS.ExceptionTitleService()
//											, MSFMainApp.ADMINMESSAGES.ExceptionMessageService("activityOnYeta2300ToYe161030("+ actionDatabase.name()+ ") : " + caught)
//											, null);
//						}
//
//						@Override
...
//		btnBar.add(btnNewButton_4);
		...
		Button btnYeta2300_05 = new Button("세액계산");
		btnYeta2300_05.setIcon(MSFMainApp.ICONS.save16());
		btnBar.add(btnYeta2300_05);
		btnYeta2300_05.addListener(Events.Select, new Listener<ButtonEvent>() {
    		public void handleEvent(ButtonEvent e) {
    		 
    	        fnYeta2300Payr06430CalcTax();
    		}
    	});
		...
		plFrmYeta2300.add(conLayoutContainer);

	}

	private void createYeta2300Form() {

		plFrmYeta2300 = new FormPanel();
		plFrmYeta2300.setHeadingText(PayGenConst.PAYGEN_VERSION.concat(" - 소득공제신고자료관리"));
		plFrmYeta2300.setIcon(MSFMainApp.ICONS.text());
		plFrmYeta2300.setBodyStyleName("pad-text");
		plFrmYeta2300.setFrame(true);
		plFrmYeta2300.setPadding(2);
//		plFrmYeta2300.setSize("990px", "780px");
		plFrmYeta2300.setSize("990px", "830px");
		...
		btnlogView.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				 //로그 뷰화면 호출 메서드 
				  funcLogMessage("소득공제신고자료관리","YETA2300");
				}
			});
		plFrmYeta2300.getHeader().setStyleAttribute("padding", "5px 0 2px 0");
		plFrmYeta2300.getHeader().addTool(btnlogView); 
		/************************************************************************
		 * 화면 에러 처리시 필요한 부분으로 추가 
		 ************************************************************************/

		//멀티콤보박스 닫기 
		plFrmYeta2300.addListener(Events.OnClick,new Listener<ComponentEvent>() { 
			@Override
		...
		topYeta2300Bar = new ButtonBar();
		topYeta2300Bar.setAlignment(HorizontalAlignment.RIGHT);
		
		if ("admin".equals(MSFMainApp.get().getUser().getUsrId()) || "D0010090".equals(MSFMainApp.get().getUser().getUsrDivCd())) {	
			btnYeta2300All = new Button("일괄자료정리");
			btnYeta2300All.setIcon(MSFMainApp.ICONS.new16());
			topYeta2300Bar.add(btnYeta2300All);
			btnYeta2300All.addListener(Events.Select, new Listener<ButtonEvent>() {
				public void handleEvent(ButtonEvent e) {
...
//	                    ye161030Dto.setFamyRelaDivCd(MSFSharedUtils.allowNulls(bmMapModel.get("famyRelaDivCd")));    	/** column 인사가족관계코드 : famyRelaDivCd */
		...
		btnYeta2300Reset = new Button("초기화");
		btnYeta2300Reset.setIcon(MSFMainApp.ICONS.new16());
		btnYeta2300Reset.addListener(Events.Select, new Listener<ButtonEvent>() {
			@Override
			public void handleEvent(ButtonEvent be) {
				// TODO Auto-generated method stub
				...
				tabsYeta2300.setSelection(tabsYeta2300.getItem(0));//탭부분 초기화
			}
		});
		topYeta2300Bar.add(btnYeta2300Reset);

		btnYeta2300Save = new Button("저장");
		btnYeta2300Save.setIcon(MSFMainApp.ICONS.save16());
		topYeta2300Bar.add(btnYeta2300Save);
		btnYeta2300Save.addListener(Events.Select, new Listener<ButtonEvent>() {
			@Override
			public void handleEvent(ButtonEvent be) {
				// TODO Auto-generated method stub
...
//				}
				...
				//  {-- 기본사항 --}
				if("itemYeta01".equals(tabsYeta2300.getSelectedItem().getId())) {
					
					itemYeta01Save();	// 기본사항 저장
					
				//  {-- 인적공제 --}	
				}else if("itemYeta02".equals(tabsYeta2300.getSelectedItem().getId())) {
					
					itemYeta02Save();	// 인적공제 저장
					
				//	{-- 소득공제 --}	
				}else if("itemYeta03".equals(tabsYeta2300.getSelectedItem().getId())) {
					
					itemYeta03Save();	// 소득공제 저장
					
				// {-- 연금보험료공제--}	
				} else if ("itemYeta04".equals(tabsYeta2300.getSelectedItem().getId())) {
				
					itemYeta04Save();	// 국민연금보험료외의 연금보험료 저장
					
				// {-- 특별소득공제 --}
				} else if ("itemYeta05".equals(tabsYeta2300.getSelectedItem().getId())) {
				...
				// {-- 그밖의 소득공제--}	
				}else if("itemYeta06".equals(tabsYeta2300.getSelectedItem().getId())) {
					
					itemYeta06Save();	// 그밖의소득공제1 저장
					
				}else if("itemYeta07".equals(tabsYeta2300.getSelectedItem().getId())) {
					
					itemYeta07Save();	// 그밖의소득공제2 저장
					
				//{-- 세액감면및세액공제--}	
				}else if("itemYeta08".equals(tabsYeta2300.getSelectedItem().getId())) {
				...
				} else if ("itemYeta09".equals(tabsYeta2300.getSelectedItem().getId())) {

					// 세액감면및세액공제2 저장
					itemYeta09Save();
					
				// {-- 추가제출서류 --}
				} else if ("itemYeta10".equals(tabsYeta2300.getSelectedItem().getId())) {
...
//		btnYeta2300Del = new Button("삭제");
//		btnYeta2300Del.setIcon(MSFMainApp.ICONS.delete16());
//		topYeta2300Bar.add(btnYeta2300Del);
...
//		printType.add(radio3);
		...
		topYeta2300Bar.add(printType);

		btnYeta2300Sreach = new Button("조회");
		btnYeta2300Sreach.setIcon(MSFMainApp.ICONS.search16());
		btnYeta2300Sreach.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				//탭 선택 없애기
				tabsYeta2300.setSelection(tabsYeta2300.getItem(0));
				//대상자 정보 조회
				reload();
			}
		});
		topYeta2300Bar.add(btnYeta2300Sreach);

//		btnYeta2300Print = new Button("인쇄");
//		btnYeta2300Print.setIcon(MSFMainApp.ICONS.print16());
//		topYeta2300Bar.add(btnYeta2300Print);

		plFrmYeta2300.add(topYeta2300Bar);

		// 파일업로드 처리
		plFrmYeta2300.setAction("myurl");
		plFrmYeta2300.setEncoding(Encoding.MULTIPART);
		plFrmYeta2300.setMethod(Method.POST);

		vp.add(plFrmYeta2300);
		
		// plFrmYeta2300.setSize("990px", "730px");
	...
	private LayoutContainer createListGrid() {
	    ...
	    yeta2300ToYe161010GridPanel = new MSFGridPanel(ye161010Def, false, false, false, false, false);
	    yeta2300ToYe161010GridPanel.setHeaderVisible(false);  
	    yeta2300ToYe161010GridPanel.setBodyBorder(true);
	    yeta2300ToYe161010GridPanel.setBorders(true);
	    final Grid yeta300ToYeta2000Grid = yeta2300ToYe161010GridPanel.getMsfGrid().getGrid();
...
//        	   funcSetPopUpRecord();
	    ...
	    cpGrid.add(yeta2300ToYe161010GridPanel); 
...
//		plFrmYeta2300.add(deptNm);
		...
		plFrmYeta2300.setLayout(new FlowLayout());
			...
			public void handleEvent(StoreEvent<BaseModel> be) {  
				...
				if (type == Store.Add) { 
		             ...
		             * "srhPayrMangDeptCd","srhEmymtDivCd","srhDeptCd","srhTypOccuCd","srhBusinCd"
						++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++*/ 
						checkYeta2300Auth("srhPayrMangDeptCd", lsPayrMangDeptCd); 
				}
			}
		});
	        ...
	        public void handleEvent(StoreEvent<BaseModel> be) {  
	        	  EventType type = be.getType();
		    	   if (type == Store.Add) { 
	           		  ...
	           		  * "srhPayrMangDeptCd","srhEmymtDivCd","srhDeptCd","srhTypOccuCd","srhBusinCd"
		         		++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++*/ 
		                	checkYeta2300Auth("srhEmymtDivCd", lsEmymtDivCd); 
		    	   }
	        }
	    });    
	    ...
	    srhDeptCd.getStore().addStoreListener( new StoreListener<ModelData>() {   
	    	public void handleEvent(StoreEvent<ModelData> be) {  
	    		...
	    		if (type == Store.Add) { 
	    			 ...
	    			 * "srhPayrMangDeptCd","srhEmymtDivCd","srhDeptCd","srhTypOccuCd","srhBusinCd"
						++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++*/ 
	    			checkYeta2300Auth("srhDeptCd", lsDeptCd); 
	    		}
	    	}
	    });    
		...
		srhTypOccuCd.getStore().addStoreListener( new StoreListener<ModelData>() {   
			public void handleEvent(StoreEvent<ModelData> be) {  
				...
				if (type == Store.Add) { 
					 ...
					 * "srhPayrMangDeptCd","srhEmymtDivCd","srhDeptCd","srhTypOccuCd","srhBusinCd"
			    		++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++*/ 
						//checkYeta2300Auth("srhTypOccuCd", lsTypOccuCd); 
				}
			}
		});     
		...
		fileSbtBtn.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				...
				if (systemkey.getValue() == null) {
					...
					YetaP220003 yetaP220003Form = new YetaP220003(ActionDatabase.READ, getThis());
					final MSFFormWindows msFwYeta220003 = new MSFFormWindows("자료추출상세내역",yetaP220003Form, "닫기", "690px", "250px", false);
					msFwYeta220003.show();
					yetaP220003Form.setMSFFormWindows(msFwYeta220003);
					// 팝업이 닫히면 탭을 다시 조회한다.
					...
					MessageBox.confirm("소득공제신고서 재적용", "선택된 대상자의 기존 정보를 삭제 후 재적용합니다.<br> 진행 하시겠습니까?",new Listener<MessageBoxEvent>(){
						...
						public void handleEvent(MessageBoxEvent be) {
							if (Dialog.YES.equals(be.getButtonClicked().getItemId())) {
								...
								yeta2300Service.fnYeta2300Ye161010_2017_SbtVolUse(ye161010Dto ,new AsyncCallback<PagingLoadResult<ShowMessageBM>>() {
									public void onFailure(Throwable caught) {
...
//										reFresh();
		...
		fileSbtBtn01.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				...
				if (systemkey.getValue() == null) {
					...
					YetaP220001 yetaP220001Form = new YetaP220001(ActionDatabase.READ, getThis());
					MSFFormWindows msFwYeta220001 = new MSFFormWindows("자료추출상세내역",yetaP220001Form, "닫기", "920px", "710px", false);
					msFwYeta220001.show();
					yetaP220001Form.setMSFFormWindows(msFwYeta220001);
		...
		fileSbtBtn02.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				...
				if (systemkey.getValue() == null) {
					...
					YetaP220002 yetaP220002Form = new YetaP220002(ActionDatabase.READ, getThis());
					final MSFFormWindows msFwYeta220002 = new MSFFormWindows("자료추출상세내역",yetaP220002Form, "닫기", "945px", "710px", false);
					msFwYeta220002.show();
					yetaP220002Form.setMSFFormWindows(msFwYeta220002);
		...
		tabsYeta2300 = new TabPanel();
		tabsYeta2300.setAutoWidth(false);
		tabsYeta2300.setAnimScroll(false);
		tabsYeta2300.setTabScroll(true);
		tabsYeta2300.setPlain(true);
		tabsYeta2300.setSize(660, 720);
		tabsYeta2300.addListener(Events.Select, new Listener<TabPanelEvent>() {
			public void handleEvent(TabPanelEvent e) {
				// 탭선택
				yeta2300ToYe161010Detail( yeta2300ToYe161010GridPanel.getCurrentlySelectedItem(), tabsYeta2300.getSelectedItem().getId()); 
		...
		itemYeta08.addListener(Events.Select, new Listener<TabPanelEvent>() {
			public void handleEvent(TabPanelEvent e) {
				...
				//탭선택
				yeta2300ToYe161010Detail(yeta2300ToYe161010GridPanel.getCurrentlySelectedItem(), tabsItemYeta08.getSelectedItem().getId());

			}
		});
		
		
		tabsYeta2300.add(itemYeta08);		
		...
		tabsYeta2300.add(itemYeta10);	
		

		fieldSet.add(tabsYeta2300);
	 ...
	 private LayoutContainer occupationalRBottom2() {
		 ...
		 yeta2300ToYe161030GridPanel = new MSFGridPanel(ye161030Def, false, false, false, false, false);
		 yeta2300ToYe161030GridPanel.setHeaderVisible(false);  
		 yeta2300ToYe161030GridPanel.setBodyBorder(true);
		 yeta2300ToYe161030GridPanel.setBorders(true);
		 
		 
		 /** --- grid 체크 컬럼 --- **/
//		 // 기본
//		 final Grid<BaseModel> grid5 = yeta2300ToYe161030GridPanel.getMsfGrid().getGrid();
...
//         
//         // 부녀자
//		 final Grid<BaseModel> grid6 = yeta2300ToYe161030GridPanel.getMsfGrid().getGrid();
...
//         
//         // 경로
//         final Grid<BaseModel> grid7 = yeta2300ToYe161030GridPanel.getMsfGrid().getGrid();
...
//		 
//         // 출산
//         final Grid<BaseModel> grid8 = yeta2300ToYe161030GridPanel.getMsfGrid().getGrid();
...
//         
//         // 6세
//         final Grid<BaseModel> grid10 = yeta2300ToYe161030GridPanel.getMsfGrid().getGrid();
...
//         
//         // 한부모
//         final Grid<BaseModel> grid11 = yeta2300ToYe161030GridPanel.getMsfGrid().getGrid();
...
//         grid11.getView().setForceFit(true);
		 ...
		 cpGrid.add(yeta2300ToYe161030GridPanel); 
...
//	 }
	 ...
	 private LayoutContainer occupationalRBottom3_01() {
		 ...
		 yeta2300ToYe161040GridPanel_01 = new MSFGridPanel(ye161040Def_01, false, false, false, false, false);
		 yeta2300ToYe161040GridPanel_01.setHeaderVisible(false);  
		 yeta2300ToYe161040GridPanel_01.setBodyBorder(true);
		 yeta2300ToYe161040GridPanel_01.setBorders(true);
		 yeta2300ToYe161040GridPanel_01.getBottomComponent().setVisible(false);
		 yeta2300ToYe161040GridPanel_01.getGrid().getColumnModel().addHeaderGroup(0, 2, new HeaderGroupConfig("보험료", 1, 4));
		 yeta2300ToYe161040GridPanel_01.getGrid().getColumnModel().addHeaderGroup(0, 8, new HeaderGroupConfig("신용카드 등 사용액", 1, 5)); 
		 ...
		 yeta2300ToYe161040GridPanel_01.getGrid().getColumnModel().addAggregationRow(payrSummaryRow); 
		    
		 
		 cpGrid.add(yeta2300ToYe161040GridPanel_01); 
	 ...
	 private LayoutContainer occupationalRBottom3_02() {
		 ...
		 yeta2300ToYe161040GridPanel_02 = new MSFGridPanel(ye161040Def_02, false, false, false, false, false);
		 yeta2300ToYe161040GridPanel_02.setHeaderVisible(false);  
		 yeta2300ToYe161040GridPanel_02.setBodyBorder(true);
		 yeta2300ToYe161040GridPanel_02.setBorders(true);
		 yeta2300ToYe161040GridPanel_02.getBottomComponent().setVisible(false);
		 
		 yeta2300ToYe161040GridPanel_02.getGrid().getColumnModel().addHeaderGroup(0, 2, new HeaderGroupConfig("보험료", 1, 4));
		 yeta2300ToYe161040GridPanel_02.getGrid().getColumnModel().addHeaderGroup(0, 8, new HeaderGroupConfig("신용카드 등 사용액", 1, 5)); 
		 ...
		 yeta2300ToYe161040GridPanel_02.getGrid().getColumnModel().addAggregationRow(payrSummaryRow); 
		    
		 cpGrid.add(yeta2300ToYe161040GridPanel_02); 
...
//		    
//		 
//		 yeta2300ToYe161090GridPanel = new MSFGridPanel(ye161090Def, false, false, false, false, false);
//		 yeta2300ToYe161090GridPanel.setHeaderVisible(false);  
//		 yeta2300ToYe161090GridPanel.setBodyBorder(true);
//		 yeta2300ToYe161090GridPanel.setBorders(true);
//		 yeta2300ToYe161090GridPanel.getBottomComponent().setVisible(true);
//		    
//		 cpGrid.add(yeta2300ToYe161090GridPanel); 
//		    
//		 lcStdGrid.add(cpGrid);
//		    
//		 return lcStdGrid;		 		 
...
//			dtyStrtDt.setHeight("");
		...
		btnNewButton.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				...
				//전체내역  
				YetaP23006 yetaP23006Form = new YetaP23006(ActionDatabase.READ, getThis());   
							    
				MSFFormWindows msFwYeta23006 = new MSFFormWindows("종전근무지등록", yetaP23006Form, "닫기", "960px", "710px", true);
				msFwYeta23006.show();
				yetaP23006Form.setMSFFormWindows(msFwYeta23006);
					
				funcSetPopUpRecord();
				yetaP23006Form.bind(ppRecord); 
				
				// 팝업이 닫히면 탭을 다시 조회한다.
				msFwYeta23006.addListener(Events.Hide, new Listener<BaseEvent>() { 
		    		@Override
		    		public void handleEvent(BaseEvent be) { 
		    			getItemYeta01();
		    		}
...
//										    
//					MSFFormWindows msFwYeta23009 = new MSFFormWindows("주현근무지등록", yetaP03009Form, "닫기", "820px", "710px", true);
//					msFwYeta23009.show();
//					yetaP03009Form.setMSFFormWindows(msFwYeta23009);
//					//TODO 추후 주석해제 
...
//			layoutContainer_49_2.add(btnNewButton1);
		...
		btnNewButton1.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				// 전체내역
				YetaP23008 yetaP23008Form = new YetaP23008(ActionDatabase.READ, getThis());   
									    
				MSFFormWindows msFwYeta23008 = new MSFFormWindows("현비과세및감면", yetaP23008Form, "닫기", "820px", "710px", true);
				msFwYeta23008.show();
				yetaP23008Form.setMSFFormWindows(msFwYeta23008);
					
				funcSetPopUpRecord();
				 
				yetaP23008Form.bind(ppRecord); 
			}
		});			
...
//		layoutContainer_20.setHeight("100");
		...
		yeta2300ToYe169010GridPanel = new MSFGridPanel(ye169010Def, false, false,false, false, false);
		yeta2300ToYe169010GridPanel.setHeaderVisible(false);
		yeta2300ToYe169010GridPanel.setBodyBorder(true);
		yeta2300ToYe169010GridPanel.setBorders(true);
		yeta2300ToYe169010GridPanel.getBottomComponent().setVisible(false);
		//
		cpGrid.add(yeta2300ToYe169010GridPanel);
		...
		button2.addListener(Events.Select, new Listener<ButtonEvent>() {
			...
			public void handleEvent(ButtonEvent be) {
				...
				yeta2300Service.getYeta2300TxDdcYnToYe161020Data(ye161020Dto, new AsyncCallback<Ye161020DTO>() {
...
//							if (result.getC152StdTxDdcYn() == "Y" || "N".equals(result.getC152StdTxDdcYn())) {
								//전체내역  
								YetaT230171 yetaT230171Form = new YetaT230171(ActionDatabase.READ, getThis());   
										    
								MSFFormWindows msFwYetaT230171 = new MSFFormWindows("기본세액공제", yetaT230171Form, "닫기", "650px", "710px", true);
								msFwYetaT230171.show();
								yetaT230171Form.setMSFFormWindows(msFwYetaT230171);
					...
					public void onFailure(Throwable caught) {
						...
						public void onSuccess(Ye161020DTO result) {
							...
							if (result.getC152StdTxDdcYn() == "Y" || "Y".equals(result.getC152StdTxDdcYn())) {
								//전체내역  
								YetaT23017 yetaT23017Form = new YetaT23017(ActionDatabase.READ, getThis());   
										    
								MSFFormWindows msFwYetaT23017 = new MSFFormWindows("표준세액공제", yetaT23017Form, "닫기", "650px", "710px", true);
								msFwYetaT23017.show();
...
//								funcSetPopUpRecord();
	...
	private LayoutContainer yetaData02() {
		...
		btnYeta3220New.addListener(Events.Select, new Listener<ButtonEvent>() {
			...
			public void handleEvent(ButtonEvent be) {
				...
				if (MSFSharedUtils.paramNull(systemkey.getValue())) {
	          	...
	          	//가족사항등록 
				YetaP230012 payrP41003Form = new YetaP230012(ActionDatabase.INSERT, getThis());   
		...
		btnYeta3220Del.addListener(Events.Select, new Listener<ButtonEvent>() {
			...
			public void handleEvent(ButtonEvent be) {
				...
				Iterator<BaseModel> itBm = yeta2300ToYe161030GridPanel.getMsfGrid().getGrid().getSelectionModel().getSelectedItems().listIterator();
				...
				MessageBox.confirm("삭제", "선택하신 인적공제명세를 삭제하시겠습니까?</br> (삭제시 관련된  교육비, 의료비 등의 내역도 같이 삭제 처리 됩니다. )",new Listener<MessageBoxEvent>(){
					...
					public void handleEvent(MessageBoxEvent be) {
						if(Dialog.YES.equals(be.getButtonClicked().getItemId())){
							yeta2300Service.activityOnYeta2300ToYe161030(listYe161030Dto ,actionDatabase, new AsyncCallback<Long>() {
	...
	private LayoutContainer yetaData03() {
		...
		LabelField lblfldNewLabelfield_19 = new LabelField("* 신용카드, 직불카드, 현금영수증은 전통시장/대중교통비를 제외한 금액을 적습니다.");
	...
	private LayoutContainer yetaData04() {
		...
		btnNewButton_9.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				// 전체내역
				YetaP23007 yetaP23007Form = new YetaP23007(ActionDatabase.READ, getThis());

				MSFFormWindows msFwYeta23007 = new MSFFormWindows("연금저축소득공제",yetaP23007Form, "닫기", "820px", "550px", true);
				msFwYeta23007.show();
				yetaP23007Form.setMSFFormWindows(msFwYeta23007);
				
				msFwYeta23007.addListener(Events.Hide,new Listener<BaseEvent>() { 
		    		@Override
		    		public void handleEvent(BaseEvent be) { 
		    			getItemYeta04();
		    		}
	...
	private LayoutContainer yetaData05() {
		...
		tabsItemYeta05.addListener(Events.Select, new Listener<TabPanelEvent>() {
			public void handleEvent(TabPanelEvent e) {
				yeta2300ToYe161010Detail(yeta2300ToYe161010GridPanel.getCurrentlySelectedItem(), tabsItemYeta05.getSelectedItem().getId());
			}
		});
...
//		LayoutContainer layoutContainer_301 = new LayoutContainer();
		...
		btnNewButton_15.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				//전체내역  
				YetaP23004 yetaP23004Form = new YetaP23004(ActionDatabase.READ, getThis());   
					    
				MSFFormWindows msFwYeta23004 = new MSFFormWindows("거주자간 주택임차차입금 원리금 상환액", yetaP23004Form, "닫기", "820px", "600px", true);
				msFwYeta23004.show();
				yetaP23004Form.setMSFFormWindows(msFwYeta23004);
...
//
//				MSFFormWindows msFwYeta23005 = new MSFFormWindows("월세액소득공제명세",yetaP23005Form, "닫기", "820px", "510px", true);
//				msFwYeta23005.show();
//				yetaP23005Form.setMSFFormWindows(msFwYeta23005);
//
//				funcSetPopUpRecord();
...
//				    
//				MSFFormWindows msFwYeta23001 = new MSFFormWindows("이월기부금등록", yetaP23001Form, "닫기", "820px", "710px", true);
//				msFwYeta23001.show();
//				yetaP23001Form.setMSFFormWindows(msFwYeta23001);
//						
//				funcSetPopUpRecord();
//				
...
//		layoutContainer_224.add(layoutContainer_243);
		...
		cpiv15AsctUseAmt = new MSFNumberField();
		cpiv15AsctUseAmt.setFieldLabel("출자∙투자금액");
		cpiv15AsctUseAmt.setAllowDecimals(true); 
		cpiv15AsctUseAmt.setPropertyEditorType(Long.class); 
		cpiv15AsctUseAmt.setFormat(NumberFormat.getDecimalFormat());
		
		layoutContainer_254.add(cpiv15AsctUseAmt, new FormData("100%"));
		...
		cpiv15VntUseAmt = new MSFNumberField();
		cpiv15VntUseAmt.setFieldLabel("출자∙투자금액");
		cpiv15VntUseAmt.setAllowDecimals(true); 
		cpiv15VntUseAmt.setPropertyEditorType(Long.class); 
		cpiv15VntUseAmt.setFormat(NumberFormat.getDecimalFormat());
		
		layoutContainer_2545.add(cpiv15VntUseAmt, new FormData("100%"));
		...
		layoutContainer_254a.add(cpiv16AsctUseAmt, new FormData("100%"));
		...
		layoutContainer_2545a.add(cpiv16VntUseAmt, new FormData("100%"));
		...
		layoutContainer_254b.add(cpiv17AsctUseAmt, new FormData("100%"));
		...
		LabelField lblfldNewLabelfield_36b = new LabelField("(2017년조합)");
		...
		layoutContainer_2545b.add(cpiv17VntUseAmt, new FormData("100%"));
		...
		LabelField lblfldNewLabelfield_366b = new LabelField("(2017년벤처)");
...
//
		...
		cpiv15AsctDdcAmt = new MSFNumberField();
		cpiv15AsctDdcAmt.setReadOnly(true);
		cpiv15AsctDdcAmt.setFieldLabel("공제액");
		cpiv15AsctDdcAmt.setAllowDecimals(true); 
		cpiv15AsctDdcAmt.setPropertyEditorType(Long.class); 
		cpiv15AsctDdcAmt.setFormat(NumberFormat.getDecimalFormat());
		
		layoutContainer_248.add(cpiv15AsctDdcAmt, new FormData("100%"));
		...
		cpiv15VntDdcAmt = new MSFNumberField();
		cpiv15VntDdcAmt.setReadOnly(true);
		cpiv15VntDdcAmt.setFieldLabel("공제액");
		cpiv15VntDdcAmt.setAllowDecimals(true); 
		cpiv15VntDdcAmt.setPropertyEditorType(Long.class); 
		cpiv15VntDdcAmt.setFormat(NumberFormat.getDecimalFormat());
		
		layoutContainer_2522.add(cpiv15VntDdcAmt, new FormData("100%"));
		...
		layoutContainer_248a.add(cpiv16AsctDdcAmt, new FormData("100%"));
		...
		layoutContainer_2522a.add(cpiv16VntDdcAmt, new FormData("100%"));
	...
	//----------------------- 2017 공제액  -------------------------------------------------
		...
		layoutContainer_248b.add(cpiv17AsctDdcAmt, new FormData("100%"));
		...
		layoutContainer_2522b.add(cpiv17VntDdcAmt, new FormData("100%"));
	...
	//-----------------------2017 공제액 ------------------------------------------------------		
		...
		layoutContainer_231.add(cshptUseAmt, new FormData("90%"));
...
//		layoutContainer_132.add(layoutContainer_145);
	...
	private LayoutContainer yetaData08() {
		...
		btnNewButton_10.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				//전체내역  
				YetaP23002 yetaP23002Form = new YetaP23002(ActionDatabase.READ, getThis());   
				    
				MSFFormWindows msFwYeta23002 = new MSFFormWindows("의료비내역등록", yetaP23002Form, "닫기", "820px", "710px", true);
				msFwYeta23002.show();
				yetaP23002Form.setMSFFormWindows(msFwYeta23002);
				
				msFwYeta23002.addListener(Events.Hide,new Listener<BaseEvent>() { 
		    		@Override
		    		public void handleEvent(BaseEvent be) { 
		    			getItemYeta08();
		    		}
...
//				// TODO Auto-generated method stub
//				
//				Iterator<BaseModel> itBm  = yeta2300ToYe161090GridPanel.getMsfGrid().getGrid().getSelectionModel().getSelectedItems().listIterator();
//				
//				List<Record>  lsRec  = new ArrayList<Record>();
//	              
//				while(itBm.hasNext()) {
...
//				actionDatabase = ActionDatabase.DELETE;  
//				
//				yeta2300Service.saveYeta2300ToYe161090tabItem08_3(listYe161090Dto, actionDatabase, new AsyncCallback<Long>() {
//			    			 
//					public void onFailure(Throwable caught) {
//						MessageBox.alert(MSFMainApp.MSFCONSTANTS.ExceptionTitleService(), 
...
//		layoutContainer_376.setLayout(new ColumnLayout());
		...
		btnNewButton_11.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				//전체내역  
				YetaP230011 yetaP230011Form = new YetaP230011(ActionDatabase.READ, getThis());   
				    
				MSFFormWindows msFwYeta230011 = new MSFFormWindows("교육비내역등록", yetaP230011Form, "닫기", "820px", "730px", true);
				msFwYeta230011.show();
				yetaP230011Form.setMSFFormWindows(msFwYeta230011);
				
				msFwYeta230011.addListener(Events.Hide,new Listener<BaseEvent>() { 
		    		@Override
		    		public void handleEvent(BaseEvent be) { 
		    			getItemYeta08();
		    		}
...
//		});
		...
		btnNewButton_14.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				//전체내역  
				YetaP23003 yetaP23003Form = new YetaP23003(ActionDatabase.READ, getThis());   
				    
				MSFFormWindows msFwYeta23003 = new MSFFormWindows("기부금내역등록", yetaP23003Form, "닫기", "820px", "510px", true);
				msFwYeta23003.show();
				yetaP23003Form.setMSFFormWindows(msFwYeta23003);
				
				msFwYeta23003.addListener(Events.Hide,new Listener<BaseEvent>() { 
		    		@Override
		    		public void handleEvent(BaseEvent be) { 
		    			getItemYeta08();
		    		}
		...
		btnNewButton_13.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				...
				MSFFormWindows msFwYeta23001 = new MSFFormWindows("기부금조정명세", yetaP23001Form, "닫기", "820px", "710px", true);
				msFwYeta23001.show();
				yetaP23001Form.setMSFFormWindows(msFwYeta23001);
				
				msFwYeta23001.addListener(Events.Hide,new Listener<BaseEvent>() { 
		    		@Override
		    		public void handleEvent(BaseEvent be) { 
		    			getItemYeta05();
		    		}
...
//		layoutContainer_154.add(layoutContainer_160);
		...
		btnNewButton_16.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				...
				msFwYeta23005.addListener(Events.Hide,new Listener<BaseEvent>() { 
		    		@Override
		    		public void handleEvent(BaseEvent be) { 
		    			getItemYeta09();
		    		}
				...
				public void handleEvent(BaseEvent be) {
					...
					if (mapModels != null) { 
						...
						yeta2300Service.activityOnYeta2300ToYe161030(listYe161030Dto, actionDatabase, new AsyncCallback<Long>() {
							...
							public void onFailure(Throwable caught) {
								MessageBox.alert(MSFMainApp.MSFCONSTANTS.ExceptionTitleService(), 
									MSFMainApp.ADMINMESSAGES.ExceptionMessageService("activityOnYeta2300ToYe161030(" + actionDatabase.name() + ") : " + caught), null);
							}
							public void onSuccess(Long result) {  
								reloadYe161030();
							}   
...
//		ye161020Dto.setPrifChngYn(ye161020Dto.getPrifChngYn());    /** column 인적공제항목변동여부 : prifChngYn */
		...
		yeta2300Service.saveYeta2300ToYe161020tabItem01(ye161020Dto, new AsyncCallback<Integer>() {
			@Override
			public void onFailure(Throwable caught) {
				// TODO Auto-generated method stub
					MessageBox.alert(MSFMainApp.MSFCONSTANTS.ExceptionTitleService(), 
	...
	public void itemYeta02Save() {
		...
		Iterator<Record> iterRecords = yeta2300ToYe161030GridPanel.getMsfGrid().getGrid().getStore().getModifiedRecords().iterator(); 
...
//	        yeta3220Dto.setBeforeJumin(MSFSharedUtils.allowNulls(bmMapModel.get("rsnoNumb2")));
	...
	public void itemYeta03Save() {
		...
		//국세청자료 grid
		Iterator<Record> iterRecords = yeta2300ToYe161040GridPanel_01.getMsfGrid().getGrid().getStore().getModifiedRecords().iterator(); 
		...
		//기타자료 grid
		iterRecords = yeta2300ToYe161040GridPanel_02.getMsfGrid().getGrid().getStore().getModifiedRecords().iterator(); 
		...
		yeta2300Service.saveYeta2300ToYe1610400tabItem03(listYe161040Dto_01, listYe161040Dto_02, new AsyncCallback<Integer>() {
	...
	public void itemYeta04Save() {
		...
		yeta2300Service.saveYeta2300ToYe161055tabItem04(ye161055Dto, new AsyncCallback<Integer>() {
	...
	public void itemYeta05_1Save() {
		...
		yeta2300Service.saveYeta2300ToYe161060tabItem05_1(ye161060Dto, new AsyncCallback<Integer>() {
	...
	public void itemYeta05_2Save() {
		...
		yeta2300Service.saveYeta2300ToYe161060tabItem05_2(ye161060Dto, new AsyncCallback<Integer>() {
...
//		ye161070Dto.setCpiv14AsctUseAmt			((Long) cpiv14AsctUseAmt.getValue());    	/** column 출자투자금액_조합등_2014납입금액 : cpiv14AsctUseAmt */
//		ye161070Dto.setCpiv14AsctDdcAmt			((Long) cpiv14AsctDdcAmt.getValue());    	/** column 출자투자금액_조합등_2014공제액 : cpiv14AsctDdcAmt */
//		ye161070Dto.setCpiv14VntUseAmt			((Long) cpiv14VntUseAmt.getValue());    	/** column 출자투자금액_벤처등_2014납입금액 : cpiv14VntUseAmt */
//		ye161070Dto.setCpiv14VntDdcAmt			((Long) cpiv14VntDdcAmt.getValue());    	/** column 출자투자금액_벤처등_2014공제액 : cpiv14VntDdcAmt */
		ye161070Dto.setCpiv15AsctUseAmt			((Long) cpiv15AsctUseAmt.getValue());  		/** column 출자투자금액_조합등_2015납입금액 : cpiv15AsctUseAmt */
		ye161070Dto.setCpiv15AsctDdcAmt			((Long) cpiv15AsctDdcAmt.getValue());    	/** column 출자투자금액_조합등_2015공제액 : cpiv15AsctDdcAmt */
		ye161070Dto.setCpiv15VntUseAmt			((Long) cpiv15VntUseAmt.getValue());   	 	/** column 출자투자금액_벤처등_2015납입금액 : cpiv15VntUseAmt */
		ye161070Dto.setCpiv15VntDdcAmt			((Long) cpiv15VntDdcAmt.getValue());   		/** column 출자투자금액_벤처등_2015공제액 : cpiv15VntDdcAmt */
...
//		ye161070Dto.setTyShfyPrsAddDdcrtUseAmt	((Long) tyShfyPrsAddDdcrtUseAmt.getValue());/** column 본인추가공제율사용분_2016_상반기 : tyShfyPrsAddDdcrtUseAmt */
		...
		yeta2300Service.saveYeta2300ToYe161070tabItem06(ye161070Dto, new AsyncCallback<Integer>() {
	...
	public void itemYeta07Save() {
		...
		yeta2300Service.saveYeta2300ToYe161070tabItem07(ye161070Dto, new AsyncCallback<Integer>() {
...
//		ye161080Vo.setYupSnmcReEndDt(ye161080Dto.getYupSnmcReEndDt());    /** column 중소기업취업자감면기간종료일자 : yupSnmcReEndDt */
		...
		yeta2300Service.saveYeta2300ToYe161080tabItem08_1(ye161080Dto, new AsyncCallback<Integer>() {
...
//		ye161080Dto.setScxpsDsbrCount		((Long) scxpsDsbrCount.getValue());    	/** column 교육비_장애인인원수 : scxpsDsbrCount */
		...
		yeta2300Service.saveYeta2300ToYe161080tabItem08_3(ye161080Dto, new AsyncCallback<Integer>() {
...
//						//-- 그리드 저장
//						
//						Iterator<Record> iterRecords = yeta2300ToYe161090GridPanel.getMsfGrid().getGrid().getStore().getModifiedRecords().iterator(); 
//				        
//						List<Ye161090DTO> listYe161090Dto = new ArrayList<Ye161090DTO>();  
//						Ye161090DTO ye161090Dto = new Ye161090DTO(); 
//						
...
//						}
	...
	public void itemYeta09Save() {
		...
		yeta2300Service.saveYeta2300ToYe161080tabItem09(ye161080Dto, new AsyncCallback<Integer>() {
	...
	public void itemYeta10Save() {
		...
		yeta2300Service.saveYeta2300ToYe161080tabItem10(ye161080Dto, new AsyncCallback<Integer>() {
...
//		resetItemYeta01();	 
		...
		yeta2300ToYe161010GridPanel.getTableDef().setTableColumnFilters(filters);
		
		yeta2300ToYe161010GridPanel.getTableDef().addColumnFilter("yrtxBlggYr", MSFSharedUtils.getSelectedComboValue(srhYrtxBlggYr, "year"), SimpleColumnFilter.OPERATOR_EQUALS);
		
		yeta2300ToYe161010GridPanel.getTableDef().addColumnFilter("clutSeptCd", MSFSharedUtils.getSelectedComboValue(srhClutSeptCd, "commCd"), SimpleColumnFilter.OPERATOR_EQUALS);
		
		yeta2300ToYe161010GridPanel.getTableDef().addColumnFilter("payrMangDeptCd", MSFSharedUtils.getSelectedComboValue(srhPayrMangDeptCd,"payrMangDeptCd"), SimpleColumnFilter.OPERATOR_EQUALS);
		yeta2300ToYe161010GridPanel.getTableDef().addColumnFilter("emymtDivCd", MSFSharedUtils.getSelectedComboValue(srhEmymtDivCd,"commCd"), SimpleColumnFilter.OPERATOR_EQUALS); 
		String strDeptCd =YetaUtils.getStrValToBMMultiCombo(lsDeptCd, srhDeptCd.getValue(),"deptNmRtchnt","deptCd");  
		yeta2300ToYe161010GridPanel.getTableDef().addColumnFilter("deptCd", strDeptCd , SimpleColumnFilter.OPERATOR_EQUALS);
		           
		String strTypOccuCd = YetaUtils.getStrValToBMMultiCombo(lsTypOccuCd,srhTypOccuCd.getValue(),"typOccuNm","typOccuCd"); 
		yeta2300ToYe161010GridPanel.getTableDef().addColumnFilter("typOccuCd", strTypOccuCd, SimpleColumnFilter.OPERATOR_EQUALS); 
		...
		yeta2300ToYe161010GridPanel.getTableDef().addColumnFilter("dtilOccuInttnCd", strDtilOccuInttnCd, SimpleColumnFilter.OPERATOR_EQUALS); 
		       
		yeta2300ToYe161010GridPanel.getTableDef().addColumnFilter("businCd", MSFSharedUtils.getSelectedComboValue(srhBusinCd,"businCd"), SimpleColumnFilter.OPERATOR_EQUALS);
		yeta2300ToYe161010GridPanel.getTableDef().addColumnFilter("systemkey", MSFSharedUtils.allowNulls(srhSystemkey.getValue()), SimpleColumnFilter.OPERATOR_EQUALS);
		yeta2300ToYe161010GridPanel.getTableDef().addColumnFilter("hanNm", MSFSharedUtils.allowNulls(srhHanNm.getValue()), SimpleColumnFilter.OPERATOR_EQUALS);    
		yeta2300ToYe161010GridPanel.getTableDef().addColumnFilter("resnRegnNum", MSFSharedUtils.allowNulls(srhResnRegnNum.getValue()), SimpleColumnFilter.OPERATOR_EQUALS);  
		yeta2300ToYe161010GridPanel.getTableDef().addColumnFilter("utDpobCd", MSFSharedUtils.allowNulls(utDpobCd.getValue()), SimpleColumnFilter.OPERATOR_EQUALS); 
		
		
		yeta2300ToYe161010GridPanel.getTableDef().addColumnFilter("printType", YetaUtils.getCheckedRadioValue(printType), SimpleColumnFilter.OPERATOR_EQUALS);  

		yeta2300ToYe161010GridPanel.reload(); 
      
	}
	
	
	/** 대상자에 따른 정보 가져옴 **/
	private void yeta2300ToYeta2000Detail2(Yeta2000BM result) {
	//	private void yeta2300ToYeta2000Detail2(Yeta2000BM result, String tabId) {
		//if("itemYeta01".equals(tabId)){//기본사항탭을 선택하였을 경우
		
		// TODO 임시 주석처리. 2017.12.08
//			if (MSFSharedUtils.paramNotNull(yeta2300ToYe161010GridPanel.getCurrentlySelectedItem())){	
//				
...
//				 IColumnFilter filters = null;
//		       		
//	        	   yeta2300GridPanel.getTableDef().setTableColumnFilters(filters); 
//	       	   	   yeta2300GridPanel.getTableDef().addColumnFilter("edacRvyy", yrtxBlggYr.getValue(), SimpleColumnFilter.OPERATOR_EQUALS); 
//	       		   yeta2300GridPanel.getTableDef().addColumnFilter("settGbcd", clutSeptCd.getValue(), SimpleColumnFilter.OPERATOR_EQUALS); 
//	       		   yeta2300GridPanel.getTableDef().addColumnFilter("systemkey", systemkey.getValue(), SimpleColumnFilter.OPERATOR_EQUALS); 
//	       		   yeta2300GridPanel.reload();
//			}
...
//			}
	...
	/** 대상자에 따른 정보 가져옴 **/
	private void yeta2300ToYe161010Detail(BaseModel selRecord, String tabId) {
	...
	private void getItemYeta01() {
		...
		yeta2300Service.getYeta2300ToYe161020Data(ye161020Dto, new AsyncCallback<Ye161020DTO>(){

			@Override
			public void onFailure(Throwable caught) {
				// TODO Auto-generated method stub
				MessageBox.alert(MSFMainApp.MSFCONSTANTS.ExceptionTitleService(), 
                        MSFMainApp.ADMINMESSAGES.ExceptionMessageService("getYeta2300ToYe161020Data(" + actionDatabase.name() + ") : " + caught), null);
	...
	private void getItemYeta02() {
		...
		yeta2300Service.getYeta2300TabItem02ToYe161020Data(ye161020Dto, new AsyncCallback<Ye161020DTO>(){

			@Override
			public void onFailure(Throwable caught) {
				// TODO Auto-generated method stub
				MessageBox.alert(MSFMainApp.MSFCONSTANTS.ExceptionTitleService(), 
                        MSFMainApp.ADMINMESSAGES.ExceptionMessageService("saveYeta2300ToYe161020tabItem02(" + actionDatabase.name() + ") : " + caught), null);
	...
	private void getItemYeta04() {
		...
		yeta2300Service.getYeta2300TabItem04ToYe161055Data(ye161055Dto, new AsyncCallback<Ye161055DTO>(){

			@Override
			public void onFailure(Throwable caught) {
				// TODO Auto-generated method stub
				MessageBox.alert(MSFMainApp.MSFCONSTANTS.ExceptionTitleService(), 
                        MSFMainApp.ADMINMESSAGES.ExceptionMessageService("getYeta2300TabItem04ToYe161055Data(" + actionDatabase.name() + ") : " + caught), null);
	...
	private void getItemYeta05() {
		...
		yeta2300Service.getYeta2300TabItem05ToYe161060Data(ye161060Dto, new AsyncCallback<Ye161060DTO>(){
	...
	private void getItemYeta06() {
		...
		yeta2300Service.getYeta2300TabItem06ToYe161070Data(ye161070Dto, new AsyncCallback<Ye161070DTO>(){
...
//				cpiv14VntDdcAmt.setValue(result.getCpiv14VntDdcAmt());   				// 출자투자금액_벤처등_2014공제액
				...
				cpiv17AsctUseAmt.setValue(result.getCpiv17AsctUseAmt());   				// 출자투자금액_조합등_2017납입금
				cpiv17AsctDdcAmt.setValue(result.getCpiv17AsctDdcAmt());   				// 출자투자금액 조합등_2017공제액

				cpiv17VntUseAmt.setValue(result.getCpiv17VntUseAmt());   				// 출자투자금액벤처등_2017납입금액
				cpiv17VntDdcAmt.setValue(result.getCpiv17VntDdcAmt());   				// 출자투자금액벤처등_2017공제액 
...
//				tyShfyPrsAddDdcrtUseAmt.setValue(result.getTyShfyPrsAddDdcrtUseAmt());  // 본인추가공제율사용분_2016_상반기 
	...
	private void getItemYeta08() {
		...
		yeta2300Service.getYeta2300TabItem08ToYe161080Data(ye161080Dto, new AsyncCallback<Ye161080DTO>(){
...
//				reloadYe161090Grid();
	...
	private void getItemYeta09() {
		...
		yeta2300Service.getYeta2300TabItem09ToYe161080Data(ye161080Dto, new AsyncCallback<Ye161080DTO>(){
...
//				    	
	...
	private void getItemYeta10() {
		...
		yeta2300Service.getYeta2300TabItem10ToYe161080Data(ye161080Dto, new AsyncCallback<Ye161080DTO>(){
	...
	private void reloadYe169010(){
		...
		yeta2300ToYe169010GridPanel.getTableDef().setTableColumnFilters(filters);
		
		yeta2300ToYe169010GridPanel.getTableDef().addColumnFilter("dpobCd", MSFSharedUtils.allowNulls(dpobCd.getValue()), SimpleColumnFilter.OPERATOR_EQUALS);
		yeta2300ToYe169010GridPanel.getTableDef().addColumnFilter("systemkey", MSFSharedUtils.allowNulls(systemkey.getValue()), SimpleColumnFilter.OPERATOR_EQUALS);
		yeta2300ToYe169010GridPanel.getTableDef().addColumnFilter("clutSeptCd", MSFSharedUtils.allowNulls(clutSeptCd.getValue()), SimpleColumnFilter.OPERATOR_EQUALS); 
		yeta2300ToYe169010GridPanel.getTableDef().addColumnFilter("yrtxBlggYr", MSFSharedUtils.allowNulls(yrtxBlggYr.getValue()), SimpleColumnFilter.OPERATOR_EQUALS); 
		yeta2300ToYe169010GridPanel.getTableDef().addColumnFilter("c152StdTxDdcYn", c152StdTxDdcYn.getValue()?"Y" : "N", SimpleColumnFilter.OPERATOR_EQUALS); 
			
		yeta2300ToYe169010GridPanel.reload();
	...
	private void reloadYe161030(){
		...
		yeta2300ToYe161030GridPanel.getTableDef().setTableColumnFilters(filters);
		
		yeta2300ToYe161030GridPanel.getTableDef().addColumnFilter("dpobCd", MSFSharedUtils.allowNulls(dpobCd.getValue()), SimpleColumnFilter.OPERATOR_EQUALS);
		yeta2300ToYe161030GridPanel.getTableDef().addColumnFilter("systemkey", MSFSharedUtils.allowNulls(systemkey.getValue()), SimpleColumnFilter.OPERATOR_EQUALS);
		yeta2300ToYe161030GridPanel.getTableDef().addColumnFilter("clutSeptCd", MSFSharedUtils.allowNulls(clutSeptCd.getValue()), SimpleColumnFilter.OPERATOR_EQUALS); 
		yeta2300ToYe161030GridPanel.getTableDef().addColumnFilter("yrtxBlggYr", MSFSharedUtils.allowNulls(yrtxBlggYr.getValue()), SimpleColumnFilter.OPERATOR_EQUALS); 
			
		yeta2300ToYe161030GridPanel.reload();
	...
	private void reloadYe161040_item03Grid(){
		...
		yeta2300ToYe161040GridPanel_01.getTableDef().setTableColumnFilters(filters);
		
		yeta2300ToYe161040GridPanel_01.getTableDef().addColumnFilter("dpobCd"		, MSFSharedUtils.allowNulls(dpobCd.getValue()), SimpleColumnFilter.OPERATOR_EQUALS);
		yeta2300ToYe161040GridPanel_01.getTableDef().addColumnFilter("systemkey"	, MSFSharedUtils.allowNulls(systemkey.getValue()), SimpleColumnFilter.OPERATOR_EQUALS);
		yeta2300ToYe161040GridPanel_01.getTableDef().addColumnFilter("clutSeptCd"	, MSFSharedUtils.allowNulls(clutSeptCd.getValue()), SimpleColumnFilter.OPERATOR_EQUALS); 
		yeta2300ToYe161040GridPanel_01.getTableDef().addColumnFilter("yrtxBlggYr"	, MSFSharedUtils.allowNulls(yrtxBlggYr.getValue()), SimpleColumnFilter.OPERATOR_EQUALS); 
		yeta2300ToYe161040GridPanel_01.getTableDef().addColumnFilter("cdVvalKrnCd"	, "Y0140000", SimpleColumnFilter.OPERATOR_EQUALS); 
			
		yeta2300ToYe161040GridPanel_01.reload();
		
		yeta2300ToYe161040GridPanel_02.getTableDef().setTableColumnFilters(filters);
		
		yeta2300ToYe161040GridPanel_02.getTableDef().addColumnFilter("dpobCd"		, MSFSharedUtils.allowNulls(dpobCd.getValue()), SimpleColumnFilter.OPERATOR_EQUALS);
		yeta2300ToYe161040GridPanel_02.getTableDef().addColumnFilter("systemkey"	, MSFSharedUtils.allowNulls(systemkey.getValue()), SimpleColumnFilter.OPERATOR_EQUALS);
		yeta2300ToYe161040GridPanel_02.getTableDef().addColumnFilter("clutSeptCd"	, MSFSharedUtils.allowNulls(clutSeptCd.getValue()), SimpleColumnFilter.OPERATOR_EQUALS); 
		yeta2300ToYe161040GridPanel_02.getTableDef().addColumnFilter("yrtxBlggYr"	, MSFSharedUtils.allowNulls(yrtxBlggYr.getValue()), SimpleColumnFilter.OPERATOR_EQUALS); 
		yeta2300ToYe161040GridPanel_02.getTableDef().addColumnFilter("cdVvalKrnCd"	, "Y0140001", SimpleColumnFilter.OPERATOR_EQUALS); 
			
		yeta2300ToYe161040GridPanel_02.reload();
...
//		IColumnFilter filters = null;
//		
//		yeta2300ToYe161090GridPanel.getTableDef().setTableColumnFilters(filters);
//			
//		yeta2300ToYe161090GridPanel.getTableDef().addColumnFilter("dpobCd", MSFSharedUtils.allowNulls(dpobCd.getValue()), SimpleColumnFilter.OPERATOR_EQUALS);
//		yeta2300ToYe161090GridPanel.getTableDef().addColumnFilter("systemkey", MSFSharedUtils.allowNulls(systemkey.getValue()), SimpleColumnFilter.OPERATOR_EQUALS); 
//		yeta2300ToYe161090GridPanel.getTableDef().addColumnFilter("clutSeptCd", MSFSharedUtils.allowNulls(clutSeptCd.getValue()), SimpleColumnFilter.OPERATOR_EQUALS); 
//		yeta2300ToYe161090GridPanel.getTableDef().addColumnFilter("yrtxBlggYr", MSFSharedUtils.allowNulls(yrtxBlggYr.getValue()), SimpleColumnFilter.OPERATOR_EQUALS); 
//			
//		yeta2300ToYe161090GridPanel.reload();
//		
//	}
	...
	public void resetYeta300ToYeta2000Grid() {
		yeta2300ToYe161010GridPanel.getMsfGrid().clearData();
	}
	...
	public void resetItemYeta02() {
		...
		yeta2300ToYe161030GridPanel.getMsfGrid().clearData();
	...
	public void resetItemYeta03() {
		...
		//	{소득공제}
		yeta2300ToYe161040GridPanel_01.getMsfGrid().clearData();
		yeta2300ToYe161040GridPanel_02.getMsfGrid().clearData();
