...
=====================================================**/
public  class YetaT330171  extends MSFFormPanel {  
	...
	private  ContentPanel cpYetaT330171; 
	...
	public YetaT330171(final ActionDatabase actionDatabase, final MSFPanel caller) {
		...
		cpYetaT330171 = new ContentPanel();  

		createSearchForm();			//기본정보 필드를 적용
		createMsfGridForm();		//그리드필드
		setReadOnlyTrueYetaP230171();

		cpYetaT330171.setBodyBorder(false);
		cpYetaT330171.setBorders(false);
		cpYetaT330171.setHeaderVisible(false);
		cpYetaT330171.setSize("630px", "640px");

		this.add(cpYetaT330171);
	...
	private void createMsfGridForm() {
		...
		cpYetaT330171.add(layoutContainer1);
		cpYetaT330171.add(layoutContainer2);
		cpYetaT330171.add(layoutContainer3);
		cpYetaT330171.add(layoutContainer4);
		cpYetaT330171.add(layoutContainer5);
		cpYetaT330171.add(layoutContainer6);
		cpYetaT330171.add(layoutContainer7);
		cpYetaT330171.add(layoutContainer8);
		cpYetaT330171.add(layoutContainer9);
	}	
