...
import com.app.exterms.yearendtax.client.service.yeta2022.YetaT73002Service;
import com.app.exterms.yearendtax.client.service.yeta2022.YetaT73002ServiceAsync;
...
//import com.app.exterms.yearendtax.client.form.defs.yeta2016.YetaT73002Def;
...
=====================================================**/
public  class YetaT73003   extends MSFFormPanel {  
 ...
 **/
	...
	private  ContentPanel cpYetaT73002; 
	...
	// -------------- grid 선언 시작  ---------------	  
	private MSFGridPanel yetaT73002GridPanel;
//	private YetaT73002Def yetaT73002Def = new YetaT73002Def("YetaT73002");   //TODO 일단 화면번호로 Def
	// -------------- grid 선언 종료  ---------------
	...
	// -------------- 서비스 호출 시작 --------------
	private YetaT73002ServiceAsync yetaT73002Service = YetaT73002Service.Util.getInstance();
	// -------------- 서비스 호출 종료 --------------	 
...
//					ye162510Dto.setMnthRnttyHusCnttArea((MSFSharedUtils.allowNulls(bmMapModel.get("mnthRnttyHusCnttArea"))));    		/** column 월세주택계약면적 : mnthRnttyHusCnttArea */
				...
				yetaT73002Service.activityOnYetaT73002(listYe162510Dto, actionDatabase, new AsyncCallback<Long>(){
...
//		 }
	...
	public YetaT73003(final ActionDatabase actionDatabase, final MSFPanel caller) {
...
//		initLoad(); 	
		...
		this.actionDatabase = actionDatabase;
	 	...
	 	cpYetaT73002 = new ContentPanel();  

		createSearchForm();			//기본정보 필드를 적용
	 	createMsfGridForm();		//그리드필드
		   
		cpYetaT73002.setBodyBorder(false);
		cpYetaT73002.setBorders(false);
		cpYetaT73002.setHeaderVisible(false);
		cpYetaT73002.setSize("790px", "640px");
		   
		this.add(cpYetaT73002);
...
//		     });     
		...
		cpYetaT73002.setLayout(new FlowLayout());
...
//	      	     }
//				 
//				yetaT73002GridPanel.getMsfGrid().clearData();
//				 
//				BaseModel bmData = yetaT73002GridPanel.getTableDef().getDefaultValues();  
//		              
...
//		         
//		        yetaT73002GridPanel.getMsfGrid().getGrid().stopEditing();      
//		        yetaT73002GridPanel.getMsfGrid().getGrid().getStore().insert(bmData,0);   
//		        yetaT73002GridPanel.getMsfGrid().getGrid().startEditing(yetaT73002GridPanel.getMsfGrid().getGrid().getStore().indexOf(bmData), 0);   
//
...
//			public void handleEvent(ButtonEvent e) {
//				Iterator<BaseModel> itBm = yetaT73002GridPanel.getMsfGrid().getGrid().getSelectionModel().getSelectedItems().listIterator();
...
//		topYetaBtnBar.add(btnYetaDel);
		...
		btnYetaSave.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				setListRecord(yetaT73002GridPanel.getMsfGrid().getStore().getModifiedRecords().iterator());
				doAction(actionDatabase);
...
//			topYetaBtnBar.add(btnYetaClose);
		...
		cpYetaT73002.add(topYetaBtnBar);
...
//		yetaT73002GridPanel = new MSFGridPanel(yetaT73002Def, false, false, false, false, false);
//		yetaT73002GridPanel.setSize("790px", "420px");
//		yetaT73002GridPanel.setBorders(true);
//		yetaT73002GridPanel.setHeaderVisible(false);
//		
//      cpYetaT73002.add(yetaT73002GridPanel);
...
//		cpYetaT73002.add(fldstNewFieldset10);
		cpYetaT73002.add(fldstNewFieldset);
		cpYetaT73002.add(fldstNewFieldset1);
		cpYetaT73002.add(layoutContainer14);
		cpYetaT73002.add(layoutContainer15);
	...
	public void reload() {
			...
			yetaT73002GridPanel.getTableDef().setTableColumnFilters(filters);
			yetaT73002GridPanel.getTableDef().addColumnFilter("yrtxBlggYr", MSFSharedUtils.allowNulls(srhYrtxBlggYr.getValue())
...
//					, SimpleColumnFilter.OPERATOR_EQUALS);//연말정산귀속년도
			yetaT73002GridPanel.getTableDef().addColumnFilter("clutSeptCd", MSFSharedUtils.getSelectedComboValue(srhClutSeptCd,"commCd")
					, SimpleColumnFilter.OPERATOR_EQUALS);//정산구분
			yetaT73002GridPanel.getTableDef().addColumnFilter("systemkey", MSFSharedUtils.allowNulls(systemkey.getValue())
					, SimpleColumnFilter.OPERATOR_EQUALS);//시스템키
		 
			yetaT73002GridPanel.reload();
