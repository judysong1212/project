...
@RemoteServiceRelativePath("YetaP410001Service.gwt")
public interface YetaP410001Service extends RemoteService {
	/**
	 * Utility class for simplifying access to the instance of async service.
	 */
	public static class Util {
		private static YetaP410001ServiceAsync instance;
		public static YetaP410001ServiceAsync getInstance(){
			if (instance == null) {
				instance = GWT.create(YetaP410001Service.class);
			}
			return instance;
		}
	}
