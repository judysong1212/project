...
import com.app.exterms.yearendtax.client.service.yeta2015.YetaP03004Service;
import com.app.exterms.yearendtax.client.service.yeta2015.YetaP03004ServiceAsync;
...
=====================================================**/
public  class YetaP03004   extends MSFFormPanel {  
 ...
 **/
	...
	private  ContentPanel cpYeta03004; 
	...
	// -------------- grid 선언 시작  ---------------	  
	private MSFGridPanel yetaP03004GridPanel01;
//	private Yeta0300Def yeta0300Def_09_1  = new Yeta0300Def("YETA0300901");	//금전소비대차계약 그리드 테이블 컬럼 define 
	private Yeta3120Def yetaP03004ToYeta3120Def  = new Yeta3120Def("YETAP03004");	//금전소비대차계약 그리드 테이블 컬럼 define 
	
	private MSFGridPanel yetaP03004GridPanel02;
//	private Yeta0300Def yeta0300Def_09_2  = new Yeta0300Def("YETA0300902");	//임대차계약 그리드 테이블 컬럼 define 
//	private Yeta3130Def yetaP03004ToYeta3130Def  = new Yeta3130Def("YETAP03004");	//임대차계약 그리드 테이블 컬럼 define
	private Yeta3160Def yetaP03004ToYeta3160Def  = new Yeta3160Def("YETAP03004");	//임대차계약 그리드 테이블 컬럼 define 
	// -------------- grid 선언 종료  ---------------			   
 ...
 **/ 
	...
	// -------------- 서비스 호출 시작 --------------
	private YetaP03004ServiceAsync yetaP03004Service = YetaP03004Service.Util.getInstance();
	// -------------- 서비스 호출 종료 --------------	 	
	...
	private void doAction(ActionDatabase actionDatabase, String doActionFlag) {
		...
		case INSERT:
			...
			if("YETA3120".equals(doActionFlag)) {
				yetaP03004ToYeta3120FormSave();
			}else if("YETA3160".equals(doActionFlag)){
				yetaP03004ToYeta3160FormSave();
			}else {
	...
	private void yetaP03004ToYeta3120FormSave() {  
		if (MSFSharedUtils.paramNotNull(records)) { 
	              
			List<Yeta3120DTO> listYeta3120dto = new ArrayList<Yeta3120DTO>();  
			...
			while (records.hasNext()) {
				...
				Yeta3120DTO yeta3120Dto= new Yeta3120DTO();  
			...
			yetaP03004Service.activityOnYetaP03004ToYeta3120(listYeta3120dto, actionDatabase, new AsyncCallback<Long>(){
				public void onFailure(Throwable caught) {
					MessageBox.alert(MSFMainApp.MSFCONSTANTS.ExceptionTitleService(), 
	                             MSFMainApp.ADMINMESSAGES.ExceptionMessageService("activityOnYetaP03004ToYeta3120(" + actionDatabase.name() + ") : " + caught), null);
				}
	...
	private void yetaP03004ToYeta3160FormSave() {  
		if (MSFSharedUtils.paramNotNull(records)) { 
	              
			List<Yeta3160DTO> listYeta3160dto = new ArrayList<Yeta3160DTO>();  
			...
			while (records.hasNext()) {
				...
				Yeta3160DTO yeta3160Dto= new Yeta3160DTO();  
			...
			yetaP03004Service.activityOnYetaP03004ToYeta3160(listYeta3160dto, actionDatabase, new AsyncCallback<Long>(){
				public void onFailure(Throwable caught) {
					MessageBox.alert(MSFMainApp.MSFCONSTANTS.ExceptionTitleService(), 
	                             MSFMainApp.ADMINMESSAGES.ExceptionMessageService("yetaP03004ToYeta3160FormSave(" + actionDatabase.name() + ") : " + caught), null);
				}
				public void onSuccess(Long result) { 
					if (result == 0) {
						MessageBox.alert(MSFMainApp.MSFCONSTANTS.Errore(), actionDatabase + "처리가 완료되지 않았습니다. 데이타를 확인하십시요.", null);
...
//		 }
	  ...
	  public YetaP03004(final ActionDatabase actionDatabase, final MSFPanel caller) {
...
//			initLoad(); 
	       ...
	       // this.setLayout(layout);   
	        ...
	        cpYeta03004 = new ContentPanel();  

		    createSearchForm();			//검색필드를 적용
	        createMsfGridForm1();		//금전소비대차계약
	        createMsfGridForm2();		//임대차계약
	           
	        cpYeta03004.setBodyBorder(false);
	        cpYeta03004.setBorders(false);
	        cpYeta03004.setHeaderVisible(false);
	        cpYeta03004.setSize("790px", "640px");
		   
	        this.add(cpYeta03004);
	...
	private void createSearchForm() {
		...
		cpYeta03004.setLayout(new FlowLayout());
...
//					systemkey.setValue("20080013");
					...
					yetaP03004GridPanel01.getMsfGrid().clearData();
					 
					 BaseModel bmData = yetaP03004GridPanel01.getTableDef().getDefaultValues();  
...
//			         bmData.set("dpobCd",  MSFMainApp.get().getUser().getDpobCd()); /** column 사업장코드 : dpobCd */
			         ...
			         yetaP03004GridPanel01.getMsfGrid().getGrid().stopEditing();      
			         yetaP03004GridPanel01.getMsfGrid().getGrid().getStore().insert(bmData,0);   
			         yetaP03004GridPanel01.getMsfGrid().getGrid().startEditing(yetaP03004GridPanel01.getMsfGrid().getGrid().getStore().indexOf(bmData), 0);   
...
//	            	doAction(actionDatabase, "YETA3120");
			...
			btnYeta3120Del.addListener(Events.Select, new Listener<ButtonEvent>() {
				public void handleEvent(ButtonEvent e) {
					Iterator<BaseModel> itBm  = yetaP03004GridPanel01.getMsfGrid().getGrid().getSelectionModel().getSelectedItems().listIterator();
			...
			btnYeta3120Save.addListener(Events.Select, new Listener<ButtonEvent>() {
	            public void handleEvent(ButtonEvent e) {
	                setListRecord(yetaP03004GridPanel01.getMsfGrid().getStore().getModifiedRecords().iterator()); 
	                doAction(actionDatabase, "YETA3120");
...
//			topYetaBtnBar.add(btnYetaClose);
			...
			cpYeta03004.add(topYeta3120BtnBar);
//			cp01.add(topYeta3120BtnBar);
			...
			yetaP03004GridPanel01 = new MSFGridPanel(yetaP03004ToYeta3120Def, false, false, false, false, false);
			yetaP03004GridPanel01.setSize("790px", "190px");
			yetaP03004GridPanel01.setBorders(true);
			yetaP03004GridPanel01.setHeaderVisible(false);  
			yetaP03004GridPanel01.getBottomComponent().setVisible(false);
			
			
			/** --- 그리드 합계 부분  시작 --- **/
//			AggregationRowConfig<BaseModel> payrSummaryRow = new AggregationRowConfig<BaseModel>();  
//			 
//			payrSummaryRow.setCellStyle(Yeta3120BM.ATTR_CNCLITRO,"summary_color");	/** set 금전소비대차_차입금이자율 : cnclItro */
//			payrSummaryRow.setCellStyle(Yeta3120BM.ATTR_CNCLRDMT,"summary_color");	/** set 금전소비대차_원리금상환액계 : cnclRdmt */
//			payrSummaryRow.setCellStyle(Yeta3120BM.ATTR_CNCLPRPL,"summary_color");	/** set 금전소비대차_원리금 : cnclPrpl */
//			payrSummaryRow.setCellStyle(Yeta3120BM.ATTR_CNCLITRT,"summary_color");	/** set 금전소비대차_이자 : cnclItrt */
//								    
//			payrSummaryRow.setSummaryType(Yeta3120BM.ATTR_CNCLITRO, SummaryType.SUM);   
//			payrSummaryRow.setSummaryFormat(Yeta3120BM.ATTR_CNCLITRO, NumberFormat.getFormat("#,##0;(#,##0)"));  
//								    
//			payrSummaryRow.setSummaryType(Yeta3120BM.ATTR_CNCLRDMT, SummaryType.SUM);   
//			payrSummaryRow.setSummaryFormat(Yeta3120BM.ATTR_CNCLRDMT, NumberFormat.getFormat("#,##0;(#,##0)"));  
//			
//			payrSummaryRow.setSummaryType(Yeta3120BM.ATTR_CNCLPRPL, SummaryType.SUM);   
//			payrSummaryRow.setSummaryFormat(Yeta3120BM.ATTR_CNCLPRPL, NumberFormat.getFormat("#,##0;(#,##0)"));  
//			
//			payrSummaryRow.setSummaryType(Yeta3120BM.ATTR_CNCLITRT, SummaryType.SUM);   
//			payrSummaryRow.setSummaryFormat(Yeta3120BM.ATTR_CNCLITRT, NumberFormat.getFormat("#,##0;(#,##0)"));  
//			
//			yetaP03004GridPanel01.getGrid().getColumnModel().addAggregationRow(payrSummaryRow);  
			/** --- 그리드 합계 부분  종료 --- **/
			
			gridFieldSet.add(yetaP03004GridPanel01);
			cpYeta03004.add(gridFieldSet);
...
//					systemkey.setValue("20080013");
					...
					yetaP03004GridPanel02.getMsfGrid().clearData();
					 
					BaseModel bmData = yetaP03004GridPanel02.getTableDef().getDefaultValues();  
...
//			         bmData.set("dpobCd",  MSFMainApp.get().getUser().getDpobCd()); /** column 사업장코드 : dpobCd */
			        ...
			        yetaP03004GridPanel02.getMsfGrid().getGrid().stopEditing();      
			        yetaP03004GridPanel02.getMsfGrid().getGrid().getStore().insert(bmData,0);   
			        yetaP03004GridPanel02.getMsfGrid().getGrid().startEditing(yetaP03004GridPanel02.getMsfGrid().getGrid().getStore().indexOf(bmData), 0);   
			...
			btnYeta3160Del.addListener(Events.Select, new Listener<ButtonEvent>() {
				public void handleEvent(ButtonEvent e) {
					Iterator<BaseModel> itBm  = yetaP03004GridPanel02.getMsfGrid().getGrid().getSelectionModel().getSelectedItems().listIterator();
	                List<Record>  lsRec  = new ArrayList<Record>();
			...
			btnYeta3160Save.addListener(Events.Select, new Listener<ButtonEvent>() {
	            public void handleEvent(ButtonEvent e) {
	                setListRecord(yetaP03004GridPanel02.getMsfGrid().getStore().getModifiedRecords().iterator()); 
	                doAction(actionDatabase, "YETA3160");
			...
			cpYeta03004.add(topYeta3160BtnBar);
			
			FieldSet gridFieldSet = new FieldSet();
			gridFieldSet.setHeadingHtml("임대차계약");
			gridFieldSet.setBorders(true);

			yetaP03004GridPanel02 = new MSFGridPanel(yetaP03004ToYeta3160Def, false, false, false, false, false);
			yetaP03004GridPanel02.setSize("790px", "200px");
			yetaP03004GridPanel02.setBorders(false);
			yetaP03004GridPanel02.setHeaderVisible(false);  
			yetaP03004GridPanel02.getBottomComponent().setVisible(false);
			
			gridFieldSet.add(yetaP03004GridPanel02);
			cpYeta03004.add(gridFieldSet);
		}	
...
//				
//				yetaP03004GridPanel01.getTableDef().setTableColumnFilters(filters);
//				yetaP03004GridPanel01.getTableDef().addColumnFilter("edacRvyy", MSFSharedUtils.allowNulls(srhEdacRvyy.getValue())
...
////						, SimpleColumnFilter.OPERATOR_EQUALS);//연말정산귀속년도
//				yetaP03004GridPanel01.getTableDef().addColumnFilter("settGbcd", MSFSharedUtils.getSelectedComboValue(srhSettGbcd,"commCd")
//						, SimpleColumnFilter.OPERATOR_EQUALS);//정산구분
//				yetaP03004GridPanel01.getTableDef().addColumnFilter("systemkey", MSFSharedUtils.allowNulls(systemkey.getValue())
//						, SimpleColumnFilter.OPERATOR_EQUALS);//시스템키
//			 
//				yetaP03004GridPanel01.reload();
//				
//				// TODO Auto-generated method stub
//				filters = null;
//				
//				yetaP03004GridPanel02.getTableDef().setTableColumnFilters(filters);
//				yetaP03004GridPanel02.getTableDef().addColumnFilter("edacRvyy", MSFSharedUtils.allowNulls(srhEdacRvyy.getValue())
//						, SimpleColumnFilter.OPERATOR_EQUALS);//연말정산귀속년도 
////				yetaP03001GridPanel.getTableDef().addColumnFilter("edacRvyy", MSFSharedUtils.getSelectedComboValue(srhEdacRvyy, "year")
////						, SimpleColumnFilter.OPERATOR_EQUALS);//연말정산귀속년도
//				yetaP03004GridPanel02.getTableDef().addColumnFilter("settGbcd", MSFSharedUtils.getSelectedComboValue(srhSettGbcd,"commCd")
//						, SimpleColumnFilter.OPERATOR_EQUALS);//정산구분
//				yetaP03004GridPanel02.getTableDef().addColumnFilter("systemkey", MSFSharedUtils.allowNulls(systemkey.getValue())
//						, SimpleColumnFilter.OPERATOR_EQUALS);//시스템키
//			 
//				yetaP03004GridPanel02.reload();
