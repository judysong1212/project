 ...
 */
public class PdfG205mBM   extends MSFSimpleBaseModel implements IsSerializable  {
    ...
    /** set 현금영수증월별공제대상금액 : cashMmAmt */
    public void setCashMmAmt(Long  cashMmAmt) { set( ATTR_CASHMMAMT ,cashMmAmt);}
    /** get 현금영수증월별공제대상금액 : cashMmAmt */
    public Long  getCashMmAmt() { return (Long )get( ATTR_CASHMMAMT );}
