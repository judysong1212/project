...
//    private PayrConstants PayrLabel = PayrConstants.INSTANCE;
	...
	public InfcPsnl0100Def(String chkPayrDef) {
		...
		if ("YetaP610001".equals(chkPayrDef)) {
			// setTitle(PayrLabel.titlePayr0304());
			setDaoClass("");
			setCustomListMethod(CLASS_YETAP610001_TO_PSNL0100_DATA_LIST);
			setAutoFillGrid(false);
			setShowFilterToolbar(false);

			setCheckBoxOnGridRows(true);

			setColumnsDefinition(getYetaP610001ToPsnl0100ColumnsList());
	...
	private List<ColumnDef> getYetaP610001ToPsnl0100ColumnsList(){
	    row = 0;
