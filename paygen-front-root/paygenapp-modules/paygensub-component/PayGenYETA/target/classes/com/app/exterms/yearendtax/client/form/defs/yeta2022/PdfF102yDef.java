...
import com.app.exterms.yearendtax.client.dto.yeta2022.PdfF102yBM;
...
//    private YetaConstants yetaLabel = YetaConstants.INSTANCE;
    ...
    public PdfF102yDef(String chkPayrDef){
        ...
        if ("".equals(chkPayrDef)) {  
          ...
          setDaoClass("");
          setCustomListMethod(CLASS_YETA7200_PDF_F102Y_DATA_LIST);
    ...
    private List<ColumnDef> getPayr0304ToPayr4420ColumnsList(){
        ...
        //2021연말정산_추가
        listColumnDefs.add(new ColumnDef("ISA납입금액", PdfF102yBM.ATTR_ISAANNTOTAMT, ColumnDef.TYPE_BIGDECIMAL , 90, true, true, true){
        	{
        		setReadOnly(true);
        	}
        });
        
        listColumnDefs.add(new ColumnDef("ISA인출금액", PdfF102yBM.ATTR_ISATAXYEARAMT, ColumnDef.TYPE_BIGDECIMAL , 90, true, true, true){
        	{
        		setReadOnly(true);
        	}
        });
        
        listColumnDefs.add(new ColumnDef("ISA순납입금액", PdfF102yBM.ATTR_ISADDCTBSASSAMT, ColumnDef.TYPE_BIGDECIMAL , 90, true, true, true){
        	{
        		setReadOnly(true);
        	}
        });
