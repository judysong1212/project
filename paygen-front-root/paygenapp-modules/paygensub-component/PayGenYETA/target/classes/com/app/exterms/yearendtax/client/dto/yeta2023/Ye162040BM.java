 ...
 */
public class Ye162040BM   extends MSFSimpleBaseModel implements IsSerializable  {
	...
	public static final String ATTR_LTRMCNISSFNNCL = "ltrmCniSsfnnCl";
	...
	/** 일괄등록 처리   */
	 public Ye162040BM(
	 	...
	 	values.put(ATTR_LTRMCNISSFNNCL,ltrmCniSsfnnCl);
	...
	/** set 장기집합투자증권저축소득공제구분코드 : ltrmCniSsfnnCl */
	public void setLtrmCniSsfnnCl(String  ltrmCniSsfnnCl) { set( ATTR_LTRMCNISSFNNCL ,ltrmCniSsfnnCl);}
	/** get 장기집합투자증권저축소득공제구분코드 : ltrmCniSsfnnCl */
	public String  getLtrmCniSsfnnCl() { return (String )get( ATTR_LTRMCNISSFNNCL );}
	/** set 장기집합투자증권저축금융기관코드 : ltrmCniSsfnnOrgnCd */
