...
public interface Yeta0400ServiceAsync {
	
	/** 전자신고기본정보 조회 **/
	public void getYeta0400List(Yeta1000BM yeta1000Bm, AsyncCallback<Yeta1000BM> callback);
	
	/** 정산마감 **/
	public void finishOnYeta1000(Yeta1000BM yeta1000Bm, AsyncCallback<Long> callback);
	
	/** 전자신고기본정보 수정 **/
	public void updateYeta1000(Yeta1000BM yeta1000Bm, AsyncCallback<Long> callback);
