...
import com.app.exterms.yearendtax.client.form.defs.yeta2023.Ye162010Def;
import com.app.exterms.yearendtax.client.service.yeta2023.YetaT83013Service;
import com.app.exterms.yearendtax.client.service.yeta2023.YetaT83013ServiceAsync;
...
=====================================================**/
public  class YetaT83013   extends MSFFormPanel {  
 ...
 **/
	...
	private  ContentPanel cpYetaT83013; 
	...
	// -------------- grid 선언 시작  ---------------	  
	private MSFGridPanel YetaT83013GridPanel;
	private Ye162010Def ye162010Def = new Ye162010Def("YetaT83013");   
	// -------------- grid 선언 종료  ---------------
	...
	// -------------- 서비스 호출 시작 --------------
	private YetaT83013ServiceAsync yetaT83013Service = YetaT83013Service.Util.getInstance();
	// -------------- 서비스 호출 종료 --------------	 
...
//					ye162510Dto.setMnthRnttyHusCnttArea((MSFSharedUtils.allowNulls(bmMapModel.get("mnthRnttyHusCnttArea"))));    		/** column 월세주택계약면적 : mnthRnttyHusCnttArea */
				...
				yetaT83013Service.activityOnYetaT83013(listYe162510Dto, actionDatabase, new AsyncCallback<Long>(){
...
//		 }
	...
	public YetaT83013(final ActionDatabase actionDatabase, final MSFPanel caller) {
...
//		initLoad(); 	
		...
		this.actionDatabase = actionDatabase;
	 	...
	 	cpYetaT83013 = new ContentPanel();  

		createSearchForm();			//기본정보 필드를 적용
	 	createMsfGridForm();		//그리드필드
		   
	 	cpYetaT83013.setBodyBorder(false);
	 	cpYetaT83013.setBorders(false);
	 	cpYetaT83013.setHeaderVisible(false);
	 	cpYetaT83013.setSize("790px", "640px");
		   
		this.add(cpYetaT83013);
...
//		     });     
		...
		cpYetaT83013.setLayout(new FlowLayout());
...
//	      	     }
//				 
//				YetaT83013GridPanel.getMsfGrid().clearData();
//				 
//				BaseModel bmData = YetaT83013GridPanel.getTableDef().getDefaultValues();  
//		              
...
//		         
//		        YetaT83013GridPanel.getMsfGrid().getGrid().stopEditing();      
//		        YetaT83013GridPanel.getMsfGrid().getGrid().getStore().insert(bmData,0);   
//		        YetaT83013GridPanel.getMsfGrid().getGrid().startEditing(YetaT83013GridPanel.getMsfGrid().getGrid().getStore().indexOf(bmData), 0);   
//
...
//			public void handleEvent(ButtonEvent e) {
//				Iterator<BaseModel> itBm = YetaT83013GridPanel.getMsfGrid().getGrid().getSelectionModel().getSelectedItems().listIterator();
...
//			public void handleEvent(ButtonEvent e) {
//				setListRecord(YetaT83013GridPanel.getMsfGrid().getStore().getModifiedRecords().iterator());
//				doAction(actionDatabase);
//
//				if ((ActionDatabase.INSERT).equals(actionDatabase)) {
//					actionDatabase = ActionDatabase.INSERT;
...
//		cpYetaT83013.add(topYetaBtnBar);
...
//		cpYetaT83013.add(topYetaBtnBar);
		...
		YetaT83013GridPanel = new MSFGridPanel(ye162010Def, false, false, false, false, false);
		YetaT83013GridPanel.setSize("790px", "200px");
		YetaT83013GridPanel.setBorders(true);
		YetaT83013GridPanel.setHeaderVisible(false);
...
//		
//		YetaT83013GridPanel.getGrid().getColumnModel().addAggregationRow(payrSummaryRow);  
//		
...
//		
//		YetaT83013GridPanel.getGrid().getColumnModel().addAggregationRow(payrSummaryRow1);
//		/** --- 그리드 합계 부분  종료 --- **/
		
//        cpYetaT83013.add(YetaT83013GridPanel);
		...
		fldstNewFieldset.add(YetaT83013GridPanel);
		cpYetaT83013.add(fldstNewFieldset);
		cpYetaT83013.add(layoutContainer10);
		cpYetaT83013.add(fldstNewFieldset_1);
	...
	public void reload() {
			...
			YetaT83013GridPanel.getTableDef().setTableColumnFilters(filters);
			YetaT83013GridPanel.getTableDef().addColumnFilter("yrtxBlggYr", MSFSharedUtils.allowNulls(srhYrtxBlggYr.getValue())
...
//					, SimpleColumnFilter.OPERATOR_EQUALS);//연말정산귀속년도
			YetaT83013GridPanel.getTableDef().addColumnFilter("clutSeptCd", MSFSharedUtils.getSelectedComboValue(srhClutSeptCd,"commCd")
					, SimpleColumnFilter.OPERATOR_EQUALS);//정산구분
			YetaT83013GridPanel.getTableDef().addColumnFilter("systemkey", MSFSharedUtils.allowNulls(systemkey.getValue())
					, SimpleColumnFilter.OPERATOR_EQUALS);//시스템키
		 
			YetaT83013GridPanel.reload();
