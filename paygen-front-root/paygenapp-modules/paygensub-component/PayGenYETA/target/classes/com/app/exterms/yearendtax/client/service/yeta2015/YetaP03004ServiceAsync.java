...
public interface YetaP03004ServiceAsync {
	
	/** 거주자간 주택임차차입금 원리금 상환액 - 금전소비대차계약  팝업 수정 삭제**/
	public void activityOnYetaP03004ToYeta3120(List<Yeta3120DTO> listYeta3120dto, ActionDatabase actionDatabase, AsyncCallback<Long> callback) ;
	
	
	/** 거주자간 주택임차차입금 원리금 상환액 - 임대차계약  팝업 수정 삭제**/
	public void activityOnYetaP03004ToYeta3160(List<Yeta3160DTO> listYeta3160dto, ActionDatabase actionDatabase, AsyncCallback<Long> callback) ;
