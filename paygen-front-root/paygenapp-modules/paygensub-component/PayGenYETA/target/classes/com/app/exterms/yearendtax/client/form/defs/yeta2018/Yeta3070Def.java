...
import com.app.exterms.yearendtax.client.dto.yeta2018.Yeta3070BM;
import com.app.exterms.yearendtax.shared.YetaDaoConstants;
import com.app.smrmf.core.msfmainapp.client.def.ColumnDef;
import com.app.smrmf.core.msfmainapp.client.def.ColumnListDef;
import com.app.smrmf.core.msfmainapp.client.def.TableDef;

public class Yeta3070Def extends TableDef implements YetaDaoConstants {
    private int row = 0;
    
    private PrgmComBass0300DTO sysComBass0300Dto;

    public Yeta3070Def(String chkDef){
    	
    	sysComBass0300Dto = new PrgmComBass0300DTO();
    	if("Yeta3070MS".equals(chkDef)){
    		setTitle("주종사업장");
            setDaoClass(""); 
	        setCustomListMethod(CLASS_YETA3070TOBASS0120_LIST);
    ...
    private List<ColumnDef> getMasterColumnsList(){
    	...
    	listColumnDefs.add(new ColumnDef("주종사업장구분코드", Yeta3070BM.ATTR_MTSTBUSINDIVCD, ColumnDef.TYPE_STRING , 90, true, false, true){
    		{
    	...
    	/** column 사업장코드 : dpobCd */
    	listColumnDefs.add(new ColumnDef("사업장코드", Yeta3070BM.ATTR_DPOBCD, ColumnDef.TYPE_STRING , 90, true, false, true){
    		{
    	...
    	listColumnDefs.add(new ColumnDef("사업장명", Yeta3070BM.ATTR_UTDPOBNM, ColumnDef.TYPE_STRING , 55, true, true, true){
    		{
    			
    		}
    	});
    	/** column 대표자명 : degtrNm */
    	listColumnDefs.add(new ColumnDef("대표자명", Yeta3070BM.ATTR_DEGTRNM, ColumnDef.TYPE_STRING , 55, true, true, true){
    		{
    			
    		}
    	});
    	/** column 사업자등록번호 : busoprRgstnNum */
    	listColumnDefs.add(new ColumnDef("사업자번호", Yeta3070BM.ATTR_BUSOPRRGSTNNUM, ColumnDef.TYPE_STRING , 85, true, true, true){
    		{
    	...
    	listColumnDefs.add(new ColumnDef("주종구분", Yeta3070BM.ATTR_MTSTBUSINDIVNM, ColumnDef.TYPE_STRING , 60, true, true, true){
    		{
    			
    		}
    	});
    	/** column 사업장기본사용여부 : untDpobFndtnUseYn */
    	listColumnDefs.add(new ColumnDef("사용여부", Yeta3070BM.ATTR_UNTDPOBFNDTNUSEYN, ColumnDef.TYPE_BOOLEAN , 55, true, true, true){
    		{
    	...
    	listColumnDefs.add(new ColumnDef("승인번호", Yeta3070BM.ATTR_UPDPOBCMPNO, ColumnDef.TYPE_STRING , 90, true, false, true){
    		{
