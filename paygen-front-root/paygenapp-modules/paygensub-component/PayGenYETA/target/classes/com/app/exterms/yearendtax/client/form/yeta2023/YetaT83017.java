...
=====================================================**/
public  class YetaT83017   extends MSFFormPanel {  
	...
	private  ContentPanel cpYetaT83017; 
	...
	// -------------- grid 선언 시작  ---------------	  
	private MSFGridPanel YetaT83017GridPanel;
	//	private YetaT83017Def YetaT83017Def = new YetaT83017Def("YetaT83017");   //TODO 일단 화면번호로 Def
	// -------------- grid 선언 종료  ---------------
	...
	public YetaT83017(final ActionDatabase actionDatabase, final MSFPanel caller) {
		...
		cpYetaT83017 = new ContentPanel();  

		createSearchForm();			//기본정보 필드를 적용
		createMsfGridForm();		//그리드필드
		setReadOnlyTrueYetaP23017();

		cpYetaT83017.setBodyBorder(false);
		cpYetaT83017.setBorders(false);
		cpYetaT83017.setHeaderVisible(false);
		cpYetaT83017.setSize("630px", "640px");

		this.add(cpYetaT83017);
	...
	private void createMsfGridForm() {
		...
		cpYetaT83017.add(layoutContainer1);
		cpYetaT83017.add(layoutContainer2);
		cpYetaT83017.add(layoutContainer3);
		cpYetaT83017.add(layoutContainer4);
		cpYetaT83017.add(layoutContainer5);
		cpYetaT83017.add(layoutContainer6);
		cpYetaT83017.add(layoutContainer7);
		cpYetaT83017.add(layoutContainer8);
		cpYetaT83017.add(layoutContainer9);
	}	
