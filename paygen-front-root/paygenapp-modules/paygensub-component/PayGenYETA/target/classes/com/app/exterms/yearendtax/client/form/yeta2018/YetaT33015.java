...
import com.app.exterms.yearendtax.client.service.yeta2018.YetaT33015Service;
import com.app.exterms.yearendtax.client.service.yeta2018.YetaT33015ServiceAsync;
...
//import com.app.exterms.yearendtax.client.form.defs.yeta2016.YetaT33015Def;
...
=====================================================**/
public  class YetaT33015   extends MSFFormPanel {  
 ...
 **/
	...
	private  ContentPanel cpYetaT33015; 
	...
	// -------------- grid 선언 시작  ---------------	  
	private MSFGridPanel YetaT33015GridPanel;
//	private YetaT33015Def YetaT33015Def = new YetaT33015Def("YetaT33015");   //TODO 일단 화면번호로 Def
	// -------------- grid 선언 종료  ---------------
	...
	// -------------- 서비스 호출 시작 --------------
	private YetaT33015ServiceAsync yetaT33015Service = YetaT33015Service.Util.getInstance();
	// -------------- 서비스 호출 종료 --------------	 
...
//					ye162510Dto.setMnthRnttyHusCnttArea((MSFSharedUtils.allowNulls(bmMapModel.get("mnthRnttyHusCnttArea"))));    		/** column 월세주택계약면적 : mnthRnttyHusCnttArea */
				...
				yetaT33015Service.activityOnYetaT33015(listYe162510Dto, actionDatabase, new AsyncCallback<Long>(){
...
//		 }
	...
	public YetaT33015(final ActionDatabase actionDatabase, final MSFPanel caller) {
...
//		initLoad(); 	
		...
		this.actionDatabase = actionDatabase;
	 	...
	 	cpYetaT33015 = new ContentPanel();  

		createSearchForm();			//기본정보 필드를 적용
	 	createMsfGridForm();		//그리드필드
		   
		cpYetaT33015.setBodyBorder(false);
		cpYetaT33015.setBorders(false);
		cpYetaT33015.setHeaderVisible(false);
		cpYetaT33015.setSize("790px", "640px");
		   
		this.add(cpYetaT33015);
...
//		     });     
		...
		cpYetaT33015.setLayout(new FlowLayout());
...
//	      	     }
//				 
//				YetaT33015GridPanel.getMsfGrid().clearData();
//				 
//				BaseModel bmData = YetaT33015GridPanel.getTableDef().getDefaultValues();  
//		              
...
//		         
//		        YetaT33015GridPanel.getMsfGrid().getGrid().stopEditing();      
//		        YetaT33015GridPanel.getMsfGrid().getGrid().getStore().insert(bmData,0);   
//		        YetaT33015GridPanel.getMsfGrid().getGrid().startEditing(YetaT33015GridPanel.getMsfGrid().getGrid().getStore().indexOf(bmData), 0);   
//
...
//			public void handleEvent(ButtonEvent e) {
//				Iterator<BaseModel> itBm = YetaT33015GridPanel.getMsfGrid().getGrid().getSelectionModel().getSelectedItems().listIterator();
...
//			public void handleEvent(ButtonEvent e) {
//				setListRecord(YetaT33015GridPanel.getMsfGrid().getStore().getModifiedRecords().iterator());
//				doAction(actionDatabase);
//
//				if ((ActionDatabase.INSERT).equals(actionDatabase)) {
//					actionDatabase = ActionDatabase.INSERT;
...
//			topYetaBtnBar.add(btnYetaClose);
		...
		cpYetaT33015.add(topYetaBtnBar);
...
//		cpYetaT33015.add(topYetaBtnBar);
//		
//		YetaT33015GridPanel = new MSFGridPanel(YetaT33015Def, false, false, false, false, false);
//		YetaT33015GridPanel.setSize("790px", "420px");
//		YetaT33015GridPanel.setBorders(true);
//		YetaT33015GridPanel.setHeaderVisible(false);
...
//		
//		YetaT33015GridPanel.getGrid().getColumnModel().addAggregationRow(payrSummaryRow);  
//		
...
//		
//		YetaT33015GridPanel.getGrid().getColumnModel().addAggregationRow(payrSummaryRow1);
//		/** --- 그리드 합계 부분  종료 --- **/
		
 //       cpYetaT33015.add(YetaT33015GridPanel);
		FieldSet fieldSet = new FieldSet();
		...
		cpYetaT33015.add(fieldSet);
		cpYetaT33015.add(layoutContainer6);
		cpYetaT33015.add(fldstNewFieldset_1);
	...
	public void reload() {
			...
			YetaT33015GridPanel.getTableDef().setTableColumnFilters(filters);
			YetaT33015GridPanel.getTableDef().addColumnFilter("yrtxBlggYr", MSFSharedUtils.allowNulls(srhYrtxBlggYr.getValue())
...
//					, SimpleColumnFilter.OPERATOR_EQUALS);//연말정산귀속년도
			YetaT33015GridPanel.getTableDef().addColumnFilter("clutSeptCd", MSFSharedUtils.getSelectedComboValue(srhClutSeptCd,"commCd")
					, SimpleColumnFilter.OPERATOR_EQUALS);//정산구분
			YetaT33015GridPanel.getTableDef().addColumnFilter("systemkey", MSFSharedUtils.allowNulls(systemkey.getValue())
					, SimpleColumnFilter.OPERATOR_EQUALS);//시스템키
		 
			YetaT33015GridPanel.reload();
