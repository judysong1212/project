 ...
 */
public class PdfG106yBM   extends MSFSimpleBaseModel implements IsSerializable  {
    ...
    /** set 신용카드공제대상금액합계 : cardAmtSum */
    public void setCardAmtSum(BigDecimal  cardAmtSum) { set( ATTR_CARDAMTSUM ,cardAmtSum);}
    /** get 신용카드공제대상금액합계 : cardAmtSum */
    public BigDecimal  getCardAmtSum() { return (BigDecimal )get( ATTR_CARDAMTSUM );}
    /** set pdf 소득공제자료적용여부 : pdfDatAppYn */
