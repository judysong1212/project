...
=====================================================**/
public  class YetaP220002   extends MSFFormPanel {  
	 ...
	 *~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ 		
	 **/ 		    
	public YetaP220002(final ActionDatabase actionDatabase, final MSFPanel caller) {
	...
	private void createBasicForm() {
		...
		btnYeta220002AllUsed.addSelectionListener(new SelectionListener<ButtonEvent>() {		        
			public void componentSelected(ButtonEvent ce) { 
				...
				int  lsCnt11 = yetaPdfG106yGridPanel.getMsfGrid().getGrid().getStore().getCount();
				...
				int  lsCnt12 = yetaPdfG206yGridPanel.getMsfGrid().getGrid().getStore().getCount();
				...
				int  lsCnt13 = yetaPdfG306yGridPanel.getMsfGrid().getGrid().getStore().getCount();
		...
		btnYeta220002Save.addSelectionListener(new SelectionListener<ButtonEvent>() {   
			...
			public void componentSelected(ButtonEvent ce) {
				...
				final List<PdfG106yDTO> listPdfG106yDto = G106UpdateSetDto();

				final List<PdfG206yDTO> listPdfG206yDto = G206UpdateSetDto();
				final List<PdfG306yDTO> listPdfG306yDto = G306UpdateSetDto();
				...
				if ((listPdfA102yDto.size() + listPdfB101yDto.size() + listPdfC101yDto.size() + listPdfC202yDto.size() +
						...
						listPdfF102yDto.size() + listPdfG106yDto.size() + listPdfG206yDto.size() + listPdfG306yDto.size() + 
				...
				MessageBox.confirm("","소득공제를 반영하시겠습니까?",new Listener<MessageBoxEvent>(){
					...
					public void handleEvent(MessageBoxEvent be) {
						...
						if(Dialog.YES.equals(be.getButtonClicked().getItemId())){
							...
							if (listPdfG106yDto.size() > 0) {UpdateG106(listPdfG106yDto);}     //신용카드
							                                                                   
							if (listPdfG206yDto.size() > 0) {UpdateG206(listPdfG206yDto);}     //현금영수증
							if (listPdfG306yDto.size() > 0) {UpdateG306(listPdfG306yDto);}     //직불카드등
	...
	private void createStandardForm() {
		...
		fieldSet10.add(Yeta_PDF_G106Y_Grid(), new FormData("100%"));
		...
		fieldSet11.add(Yeta_PDF_G206Y_Grid(), new FormData("100%"));
		...
		fieldSet12.add(Yeta_PDF_G306Y_Grid(), new FormData("100%"));
	...
	//신용카드 DTO 세팅
	public List<PdfG106yDTO> G106UpdateSetDto(){
		...
		return listPdfG106yDto;
	}

	//현금영수증 DTO 세팅
	public List<PdfG206yDTO> G206UpdateSetDto(){
		...
		return listPdfG206yDto;
	}

	//직불카드등 DTO 세팅
	public List<PdfG306yDTO> G306UpdateSetDto(){
...
//				UpdateG106(listPdfG106yDto);
	...
	public void UpdateG106(List<PdfG106yDTO> listPdfG106yDto) {
...
//				UpdateG206(listPdfG206yDto);
	...
	public void UpdateG206(List<PdfG206yDTO> listPdfG206yDto) {
...
//				UpdateG306(listPdfG306yDto);
	...
	public void UpdateG306(List<PdfG306yDTO> listPdfG306yDto) {
