...
import com.app.exterms.yearendtax.client.service.yeta2017.YetaT23011Service;
import com.app.exterms.yearendtax.client.service.yeta2017.YetaT23011ServiceAsync;
...
//import com.app.exterms.yearendtax.client.form.defs.yeta2016.YetaT23011Def;
...
=====================================================**/
public  class YetaT23011   extends MSFFormPanel {  
 ...
 **/
	...
	private  ContentPanel cpYetaT23011; 
	...
	// -------------- grid 선언 시작  ---------------	  
	private MSFGridPanel yetaT23011GridPanel;
//	private YetaT23011Def yetaT23011Def = new YetaT23011Def("YetaT23011");   //TODO 일단 화면번호로 Def
	// -------------- grid 선언 종료  ---------------
	...
	// -------------- 서비스 호출 시작 --------------
	private YetaT23011ServiceAsync yetaT23011Service = YetaT23011Service.Util.getInstance();
	// -------------- 서비스 호출 종료 --------------	 
...
//					ye162510Dto.setMnthRnttyHusCnttArea((MSFSharedUtils.allowNulls(bmMapModel.get("mnthRnttyHusCnttArea"))));    		/** column 월세주택계약면적 : mnthRnttyHusCnttArea */
				...
				yetaT23011Service.activityOnYetaT23011(listYe162510Dto, actionDatabase, new AsyncCallback<Long>(){
...
//		 }
	...
	public YetaT23011(final ActionDatabase actionDatabase, final MSFPanel caller) {
...
//		initLoad(); 	
		...
		this.actionDatabase = actionDatabase;
	 	...
	 	cpYetaT23011 = new ContentPanel();  

		createSearchForm();			//기본정보 필드를 적용
	 	createMsfGridForm();		//그리드필드
		   
		cpYetaT23011.setBodyBorder(false);
		cpYetaT23011.setBorders(false);
		cpYetaT23011.setHeaderVisible(false);
		cpYetaT23011.setSize("790px", "640px");
		   
		this.add(cpYetaT23011);
...
//		     });     
		...
		cpYetaT23011.setLayout(new FlowLayout());
...
//	      	     }
//				 
//				yetaT23011GridPanel.getMsfGrid().clearData();
//				 
//				BaseModel bmData = yetaT23011GridPanel.getTableDef().getDefaultValues();  
//		              
...
//		         
//		        yetaT23011GridPanel.getMsfGrid().getGrid().stopEditing();      
//		        yetaT23011GridPanel.getMsfGrid().getGrid().getStore().insert(bmData,0);   
//		        yetaT23011GridPanel.getMsfGrid().getGrid().startEditing(yetaT23011GridPanel.getMsfGrid().getGrid().getStore().indexOf(bmData), 0);   
//
...
//			public void handleEvent(ButtonEvent e) {
//				Iterator<BaseModel> itBm = yetaT23011GridPanel.getMsfGrid().getGrid().getSelectionModel().getSelectedItems().listIterator();
...
//		topYetaBtnBar.add(btnYetaDel);
		...
		btnYetaSave.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				setListRecord(yetaT23011GridPanel.getMsfGrid().getStore().getModifiedRecords().iterator());
				doAction(actionDatabase);
...
//			topYetaBtnBar.add(btnYetaClose);
		...
		cpYetaT23011.add(topYetaBtnBar);
...
//		yetaT23011GridPanel = new MSFGridPanel(yetaT23011Def, false, false, false, false, false);
//		yetaT23011GridPanel.setSize("790px", "420px");
//		yetaT23011GridPanel.setBorders(true);
//		yetaT23011GridPanel.setHeaderVisible(false);
...
//		
//		yetaT23011GridPanel.getGrid().getColumnModel().addAggregationRow(payrSummaryRow);  
//		
...
//		
//		yetaT23011GridPanel.getGrid().getColumnModel().addAggregationRow(payrSummaryRow1);
//		/** --- 그리드 합계 부분  종료 --- **/
		
//        cpYetaT23011.add(yetaT23011GridPanel);
...
//		
		...
		cpYetaT23011.add(layoutContainer);
		cpYetaT23011.add(fldstNewFieldset_1);
	...
	public void reload() {
			...
			yetaT23011GridPanel.getTableDef().setTableColumnFilters(filters);
			yetaT23011GridPanel.getTableDef().addColumnFilter("yrtxBlggYr", MSFSharedUtils.allowNulls(srhYrtxBlggYr.getValue())
...
//					, SimpleColumnFilter.OPERATOR_EQUALS);//연말정산귀속년도
			yetaT23011GridPanel.getTableDef().addColumnFilter("clutSeptCd", MSFSharedUtils.getSelectedComboValue(srhClutSeptCd,"commCd")
					, SimpleColumnFilter.OPERATOR_EQUALS);//정산구분
			yetaT23011GridPanel.getTableDef().addColumnFilter("systemkey", MSFSharedUtils.allowNulls(systemkey.getValue())
					, SimpleColumnFilter.OPERATOR_EQUALS);//시스템키
		 
			yetaT23011GridPanel.reload();
