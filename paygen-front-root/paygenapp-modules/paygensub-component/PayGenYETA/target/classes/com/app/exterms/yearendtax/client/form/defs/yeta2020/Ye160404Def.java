...
import com.app.exterms.yearendtax.client.dto.yeta2020.Ye160406BM;
...
//    private PayrConstants PayrLabel = PayrConstants.INSTANCE;
	...
	public Ye160404Def(String chkPayrDef) {
		...
		if ("YetaP53006".equals(chkPayrDef)) {
			// setTitle(PayrLabel.titlePayr0304());
			setDaoClass("");
			setCustomListMethod(CLASS_YETAP53006_TO_YE160404_DATA_LIST);
