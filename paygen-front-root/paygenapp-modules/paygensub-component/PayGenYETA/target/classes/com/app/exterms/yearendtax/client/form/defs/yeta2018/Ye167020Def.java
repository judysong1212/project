...
import com.app.exterms.yearendtax.client.dto.yeta2018.Ye167020BM;
...
//
//        private TextField<String> suptFmlyRltClCd;   /** column 관계코드 : suptFmlyRltClCd */
//
//        private TextField<String> nnfClCd;   /** column 내외국인구분 : nnfClCd */
//
//        private TextField<String> child;   /** column 자녀인원수 : child */
//
//        private TextField<String> txprNm;   /** column 성명 : txprNm */
//
//        private TextField<String> txprDscmNoCntn;   /** column 주민등록번호 : txprDscmNoCntn */
//
//        private TextField<String> bscDdcClCd;   /** column 기본공제여부 : bscDdcClCd */
//
//        private TextField<String> wmnDdcClCd;   /** column 부녀자여부 : wmnDdcClCd */
//
//        private TextField<String> snprntFmlyDdcClCd;   /** column 한부모여부 : snprntFmlyDdcClCd */
//
//        private TextField<String> sccDdcClCd;   /** column 경로우대여부 : sccDdcClCd */
//
//        private TextField<String> dsbrDdcClCd;   /** column 장애인여부 : dsbrDdcClCd */
//
//        private TextField<String> chbtAtprDdcClCd;   /** column 출산입양여부 : chbtAtprDdcClCd */
//
//        private TextField<String> age6Lt;   /** column 6세이하여부 : age6Lt */
//
