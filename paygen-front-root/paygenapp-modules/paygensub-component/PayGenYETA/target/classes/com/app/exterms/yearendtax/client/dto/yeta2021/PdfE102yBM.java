...
public class PdfE102yBM   extends MSFSimpleBaseModel implements IsSerializable  {
    ...
    //2021연말정산_추가
    public static final String ATTR_ISAANNTOTAMT = "isaAnnTotAmt";
    
    public static final String ATTR_ISATAXYEARAMT = "isaTaxYearAmt";
    
    public static final String ATTR_ISADDCTBSASSAMT = "isaDdctBsAssAmt";
    ...
    /** 일괄등록 처리   */
     public PdfE102yBM(
     	...
     	values.put(ATTR_ISAANNTOTAMT,isaAnnTotAmt);
     	values.put(ATTR_ISATAXYEARAMT,isaTaxYearAmt);
     	values.put(ATTR_ISADDCTBSASSAMT,isaDdctBsAssAmt);
    ...
    //2021연말정산_추가
    public void setIsaAnnTotAmt(Long  isaAnnTotAmt) { set( ATTR_ISAANNTOTAMT ,isaAnnTotAmt);}
    
    public Long  getIsaAnnTotAmt() { return (Long )get( ATTR_ISAANNTOTAMT );}
    
    public void setIsaTaxYearAmt(Long  isaTaxYearAmt) { set( ATTR_ISATAXYEARAMT ,isaTaxYearAmt);}
    
    public Long  getIsaTaxYearAmt() { return (Long )get( ATTR_ISATAXYEARAMT );}
    
    public void setIsaDdctBsAssAmt(Long  isaDdctBsAssAmt) { set( ATTR_ISADDCTBSASSAMT ,isaDdctBsAssAmt);}
    
    public Long  getIsaDdctBsAssAmt() { return (Long )get( ATTR_ISADDCTBSASSAMT );}
