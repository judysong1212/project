...
//				fieldSet_2.add(lcSchCol2, new FormData("100%"));	
		    	...
		    	layoutContainer_1.setLayout(new HBoxLayout()); 
		     	...
		     	btnYetat13019.addListener(Events.Select, new Listener<ButtonEvent>() {
		     		public void handleEvent(ButtonEvent e) {
						  //전체내역  
						  YetaT53019 yetaT23019Form = new YetaT53019(ActionDatabase.READ, getThis());   
		    	...
		    	btnYetat13001.addListener(Events.Select, new Listener<ButtonEvent>() {
		    		public void handleEvent(ButtonEvent e) {
						  //전체내역  
						  YetaT53001 yetaT23001Form = new YetaT53001(ActionDatabase.READ, getThis());   
		    	...
		    	btnYetat13002.addListener(Events.Select, new Listener<ButtonEvent>() {
		    		public void handleEvent(ButtonEvent e) {
						  //전체내역  
						  YetaT53002 yetaT23002Form = new YetaT53002(ActionDatabase.READ, getThis());   
		    	...
		    	btnYetat13003.addListener(Events.Select, new Listener<ButtonEvent>() {
		    		public void handleEvent(ButtonEvent e) {
						  //전체내역  
						  YetaT53003 yetaT23003Form = new YetaT53003(ActionDatabase.READ, getThis());   
		    	...
		    	btnYetat13004.addListener(Events.Select, new Listener<ButtonEvent>() {
		    		public void handleEvent(ButtonEvent e) {
						  //전체내역  
						  YetaT53004 yetaT23004Form = new YetaT53004(ActionDatabase.READ, getThis());   
		    	...
		    	btnYetat13005.addListener(Events.Select, new Listener<ButtonEvent>() {
		    		public void handleEvent(ButtonEvent e) {
						  //전체내역  
						  YetaT53005 yetaT23005Form = new YetaT53005(ActionDatabase.READ, getThis());   
		    	...
		    	btnYetat13006.addListener(Events.Select, new Listener<ButtonEvent>() {
		    		public void handleEvent(ButtonEvent e) {
						  //전체내역  
						  YetaT53006 yetaT23006Form = new YetaT53006(ActionDatabase.READ, getThis());   
		    	...
		    	btnYetat13007.addListener(Events.Select, new Listener<ButtonEvent>() {
		    		public void handleEvent(ButtonEvent e) {
						  //전체내역  
						  YetaT53007 yetaT23007Form = new YetaT53007(ActionDatabase.READ, getThis());   
		    	...
		    	btnYetat13008.addListener(Events.Select, new Listener<ButtonEvent>() {
		    		public void handleEvent(ButtonEvent e) {
						  //전체내역  
						  YetaT53008 yetaT23008Form = new YetaT53008(ActionDatabase.READ, getThis());   
		    	...
		    	btnYetat13009.addListener(Events.Select, new Listener<ButtonEvent>() {
		    		public void handleEvent(ButtonEvent e) {
						  //전체내역  
						  YetaT53009 yetaT23009Form = new YetaT53009(ActionDatabase.READ, getThis());   
		    	...
		    	btnYetat13010.addListener(Events.Select, new Listener<ButtonEvent>() {
		    		public void handleEvent(ButtonEvent e) {
						  //전체내역  
						  YetaT53010 yetaT23010Form = new YetaT53010(ActionDatabase.READ, getThis());   
		    	...
		    	btnYetat13011.addListener(Events.Select, new Listener<ButtonEvent>() {
		    		public void handleEvent(ButtonEvent e) {
						  //전체내역  
						  YetaT53011 yetaT23011Form = new YetaT53011(ActionDatabase.READ, getThis());   
		    	...
		    	btnYetat13012.addListener(Events.Select, new Listener<ButtonEvent>() {
		    		public void handleEvent(ButtonEvent e) {
						  //전체내역  
						  YetaT53012 yetaT23012Form = new YetaT53012(ActionDatabase.READ, getThis());   
		    	...
		    	btnYetat13013.addListener(Events.Select, new Listener<ButtonEvent>() {
		    		public void handleEvent(ButtonEvent e) {
						  //전체내역  
						  YetaT53013 yetaT23013Form = new YetaT53013(ActionDatabase.READ, getThis());   
		    	...
		    	btnYetat13014.addListener(Events.Select, new Listener<ButtonEvent>() {
		    		public void handleEvent(ButtonEvent e) {
						  //전체내역  
						  YetaT53014 yetaT23014Form = new YetaT53014(ActionDatabase.READ, getThis());   
		    	...
		    	btnYetat13015.addListener(Events.Select, new Listener<ButtonEvent>() {
		    		public void handleEvent(ButtonEvent e) {
						  //전체내역  
						  YetaT53015 yetaT23015Form = new YetaT53015(ActionDatabase.READ, getThis());   
		    	...
		    	btnYetat13016.addListener(Events.Select, new Listener<ButtonEvent>() {
		    		public void handleEvent(ButtonEvent e) {
						  //전체내역  
						  YetaT53016 yetaT23016Form = new YetaT53016(ActionDatabase.READ, getThis());   
		    	...
		    	btnYetat13017.addListener(Events.Select, new Listener<ButtonEvent>() {
		    		public void handleEvent(ButtonEvent e) {
						  //전체내역  
						  YetaT53017 yetaT23017Form = new YetaT53017(ActionDatabase.READ, getThis());   
		    	...
		    	btnYetat13018.addListener(Events.Select, new Listener<ButtonEvent>() {
		    		public void handleEvent(ButtonEvent e) {
						  //전체내역  
						  YetaT53018 yetaT23018Form = new YetaT53018(ActionDatabase.READ, getThis());   
