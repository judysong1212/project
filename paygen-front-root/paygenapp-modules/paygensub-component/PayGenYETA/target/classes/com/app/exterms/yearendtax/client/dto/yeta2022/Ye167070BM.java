 ...
 */
public class Ye167070BM   extends MSFSimpleBaseModel implements IsSerializable  {
    ...
    /** set 종근무지명 : cd222 */
    public static final String ATTR_CD222 = "cd222";

    /** set 종급여총액 : cd221 */
    public static final String ATTR_CD221 = "cd221";

    /** set 사업자등록번호 : cd220 */
    public static final String ATTR_CD220 = "cd220";

    /** set 종결정세액 : cd223 */
    public static final String ATTR_CD223 = "cd223";
    ...
    /** 일괄등록 처리   */
     public Ye167070BM(
     	...
     	values.put(ATTR_CD222,cd222);
     	values.put(ATTR_CD221,cd221);
     	values.put(ATTR_CD220,cd220);
     	values.put(ATTR_CD223,cd223);
    ...
    /** set 종근무지명 : cd222 */
    public void setCd222(String  cd222) { set( ATTR_CD222 ,cd222);}
    /** get 종근무지명 : cd222 */
    public String  getCd222() { return (String )get( ATTR_CD222 );}

    /** set 종급여총액 : cd221 */
    public void setCd221(Long  cd221) { set( ATTR_CD221 ,cd221);}
    /** get 종급여총액 : cd221 */
    public Long  getCd221() { return (Long )get( ATTR_CD221 );}

    /** set 사업자등록번호 : cd220 */
    public void setCd220(String  cd220) { set( ATTR_CD220 ,cd220);}
    /** get 사업자등록번호 : cd220 */
    public String  getCd220() { return (String )get( ATTR_CD220 );}

    /** set 종결정세액 : cd223 */
    public void setCd223(Long  cd223) { set( ATTR_CD223 ,cd223);}
    /** get 종결정세액 : cd223 */
    public Long  getCd223() { return (Long )get( ATTR_CD223 );}
