...
import com.app.exterms.yearendtax.client.dto.yeta2020.PdfB201yBM;
...
//    private YetaConstants yetaLabel = YetaConstants.INSTANCE;
    ...
    public PdfB201yDef(String chkPayrDef){
        ...
        if ("".equals(chkPayrDef)) {  
          ...
          setDaoClass("");
          setCustomListMethod(CLASS_YETA5200_PDF_B201Y_DATA_LIST);
    ...
    private List<ColumnDef> getPayr0304ToPayr4420ColumnsList(){
        ...
        listColumnDefs.add(new ColumnDef("주민등록번호(피보험자)", PdfB201yBM.ATTR_INSURESID, ColumnDef.TYPE_STRING , 90, true, true, true){
        	{
        		setReadOnly(true);
        	}
        });
        ...
        listColumnDefs.add(new ColumnDef("성명(피보험자)", PdfB201yBM.ATTR_INSUNM, ColumnDef.TYPE_STRING , 90, true, true, true){
        	{
        		setReadOnly(true);
        	}
        });
        ...
        listColumnDefs.add(new ColumnDef("수익자주민등록번호", PdfB201yBM.ATTR_RESID, ColumnDef.TYPE_STRING , 90, true, false, true){
        	{
        		setReadOnly(true);
        	}
        });
        /** column 수익자 성명 : name */
        listColumnDefs.add(new ColumnDef("수익자성명", PdfB201yBM.ATTR_NAME, ColumnDef.TYPE_STRING , 90, true, false, true){
        	{
        		setReadOnly(true);
        	}
        });
