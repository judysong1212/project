 ...
 */
public class Ye16Ta3160DTO  implements Serializable {
    ...
    public Long getLeasSqno() {
        return this.leasSqno;
    }
    
    public void setLeasSqno(Long leasSqno) {
    ...
    public Long getLeasDpst() {
        return this.leasDpst;
    }
    
    public void setLeasDpst(Long leasDpst) {
