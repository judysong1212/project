...
public class Ye16Ta1000Def extends TableDef implements YetaDaoConstants{
	
	private int row = 0;
	final PrgmComBass0300DTO sysComBass0300Dto;
	
	public Ye16Ta1000Def(String chkDef) {
		
		sysComBass0300Dto = new PrgmComBass0300DTO();
		
		if("YETA1400".equals(chkDef)) {
//		setTitle("연말정산대상자 및 내역");
			setTitle("");
	        setDaoClass("");
	        setCustomListMethod(CLASS_YETA1400LIST);
...
//			setTitle("연말정산대상자 및 내역");
		...
		} else if("YETA2400".equals(chkDef)) {
//			setTitle("연말정산대상자 및 내역");
			setTitle("");
	        setDaoClass("");
	        setCustomListMethod(CLASS_YETA1400LIST);
