 ...
 */
public class PdfK101yBM   extends MSFSimpleBaseModel implements IsSerializable  {
    ...
    public static final String ATTR_BUSNAMTSUM = "busnAmtSum";

    /** set 소상공인공제부금소득공제대상액 : busnSumDdct */
    public static final String ATTR_BUSNSUMDDCT = "busnSumDdct";
    ...
    /** 일괄등록 처리   */
     public PdfK101yBM(
     	...
     	values.put(ATTR_PAYMETHOD,payMethod);
     	values.put(ATTR_BUSNAMTSUM,busnAmtSum);
     	values.put(ATTR_BUSNSUMDDCT,busnSumDdct);
    ...
    /** get 소상공인공제부금대상가입일자 : startDt */
    public String  getStartDt() { return (String )get( ATTR_STARTDT );}

    /** set 소상공인공제부금대상종료일자 : endDt */
    public void setEndDt(String  endDt) { set( ATTR_ENDDT ,endDt);}
    /** get 소상공인공제부금대상종료일자 : endDt */
    public String  getEndDt() { return (String )get( ATTR_ENDDT );}

    /** set 소상공인공제부금납입방법 : payMethod */
    public void setPayMethod(String  payMethod) { set( ATTR_PAYMETHOD ,payMethod);}
    /** get 소상공인공제부금납입방법 : payMethod */
    public String  getPayMethod() { return (String )get( ATTR_PAYMETHOD );}

    /** set 소상공인공제부금납입금액계 : busnAmtSum */
    public void setBusnAmtSum(Long  busnAmtSum) { set( ATTR_BUSNAMTSUM ,busnAmtSum);}
    /** get 소상공인공제부금납입금액계 : busnAmtSum */
    public Long  getBusnAmtSum() { return (Long )get( ATTR_BUSNAMTSUM );}

    /** set 소상공인공제부금소득공제대상액 : busnSumDdct */
    public void setBusnSumDdct(Long  busnSumDdct) { set( ATTR_BUSNSUMDDCT ,busnSumDdct);}
    /** get 소상공인공제부금소득공제대상액 : busnSumDdct */
    public Long  getBusnSumDdct() { return (Long )get( ATTR_BUSNSUMDDCT );}
