...
//				fieldSet_2.add(lcSchCol2, new FormData("100%"));	
		    	...
		    	layoutContainer_1.setLayout(new HBoxLayout()); 
		     	...
		     	btnYetat13019.addListener(Events.Select, new Listener<ButtonEvent>() {
		     		public void handleEvent(ButtonEvent e) {
						  //전체내역  
						  YetaT63019 yetaT63019Form = new YetaT63019(ActionDatabase.READ, getThis());   
								    
						  MSFFormWindows msFwYetaT63019 = new MSFFormWindows("월세액세액공제명세", yetaT63019Form, "닫기", "820px", "710px", true);
						  msFwYetaT63019.show();
						  yetaT63019Form.setMSFFormWindows(msFwYetaT63019);
						  
						  funcSetPopUpRecord();
						  //TODO 추후 주석해제 
						  yetaT63019Form.bind(ppRecord); 
					  }
		    	});
		    	...
		    	btnYetat13001.addListener(Events.Select, new Listener<ButtonEvent>() {
		    		public void handleEvent(ButtonEvent e) {
						  //전체내역  
						  YetaT63001 yetaT63001Form = new YetaT63001(ActionDatabase.READ, getThis());   
								    
						  MSFFormWindows msFwYetaT63001 = new MSFFormWindows("비과세및감면소득", yetaT63001Form, "닫기", "820px", "710px", true);
						  msFwYetaT63001.show();
						  yetaT63001Form.setMSFFormWindows(msFwYetaT63001);
						  
						  funcSetPopUpRecord();
						  //TODO 추후 주석해제 
						  yetaT63001Form.bind(ppRecord); 
					  }
		    	}); 
		    	...
		    	btnYetat13002.addListener(Events.Select, new Listener<ButtonEvent>() {
		    		public void handleEvent(ButtonEvent e) {
						  //전체내역  
						  YetaT63002 yetaT63002Form = new YetaT63002(ActionDatabase.READ, getThis());   
								    
						  MSFFormWindows msFwYetaT63002 = new MSFFormWindows("연금보험료", yetaT63002Form, "닫기", "700px", "710px", true);
						  msFwYetaT63002.show();
						  yetaT63002Form.setMSFFormWindows(msFwYetaT63002);
						  
						  funcSetPopUpRecord();
						  //TODO 추후 주석해제 
						  yetaT63002Form.bind(ppRecord); 
					  }
		    	}); 
		    	...
		    	btnYetat13003.addListener(Events.Select, new Listener<ButtonEvent>() {
		    		public void handleEvent(ButtonEvent e) {
						  //전체내역  
						  YetaT63003 yetaT63003Form = new YetaT63003(ActionDatabase.READ, getThis());   
								    
						  MSFFormWindows msFwYetaT63003 = new MSFFormWindows("보험료(부양가족)", yetaT63003Form, "닫기", "700px", "750px", true);
						  msFwYetaT63003.show();
						  yetaT63003Form.setMSFFormWindows(msFwYetaT63003);
						  
						  funcSetPopUpRecord();
						  //TODO 추후 주석해제 
						  yetaT63003Form.bind(ppRecord); 
					  }
		    	}); 
		    	...
		    	btnYetat13004.addListener(Events.Select, new Listener<ButtonEvent>() {
		    		public void handleEvent(ButtonEvent e) {
						  //전체내역  
						  YetaT63004 yetaT63004Form = new YetaT63004(ActionDatabase.READ, getThis());   
								    
						  MSFFormWindows msFwYetaT63004 = new MSFFormWindows("주택임차차입금원리금상환액", yetaT63004Form, "닫기", "820px", "710px", true);
						  msFwYetaT63004.show();
						  yetaT63004Form.setMSFFormWindows(msFwYetaT63004);
						  
						  funcSetPopUpRecord();
						  //TODO 추후 주석해제 
						  yetaT63004Form.bind(ppRecord); 
					  }
		    	}); 
		    	...
		    	btnYetat13005.addListener(Events.Select, new Listener<ButtonEvent>() {
		    		public void handleEvent(ButtonEvent e) {
						  //전체내역  
						  YetaT63005 yetaT63005Form = new YetaT63005(ActionDatabase.READ, getThis());   
								    
						  MSFFormWindows msFwYetaT63005 = new MSFFormWindows("장기주택저당차입금이자상환액", yetaT63005Form, "닫기", "450px", "710px", true);
						  msFwYetaT63005.show();
						  yetaT63005Form.setMSFFormWindows(msFwYetaT63005);
						  
						  funcSetPopUpRecord();
						  //TODO 추후 주석해제 
						  yetaT63005Form.bind(ppRecord); 
					  }
		    	}); 
		    	...
		    	btnYetat13006.addListener(Events.Select, new Listener<ButtonEvent>() {
		    		public void handleEvent(ButtonEvent e) {
						  //전체내역  
						  YetaT63006 yetaT63006Form = new YetaT63006(ActionDatabase.READ, getThis());   
								    
						  MSFFormWindows msFwYetaT63006 = new MSFFormWindows("개인연금저축불입액", yetaT63006Form, "닫기", "820px", "710px", true);
						  msFwYetaT63006.show();
						  yetaT63006Form.setMSFFormWindows(msFwYetaT63006);
						  
						  funcSetPopUpRecord();
						  //TODO 추후 주석해제 
						  yetaT63006Form.bind(ppRecord); 
					  }
		    	}); 
		    	...
		    	btnYetat13007.addListener(Events.Select, new Listener<ButtonEvent>() {
		    		public void handleEvent(ButtonEvent e) {
						  //전체내역  
						  YetaT63007 yetaT63007Form = new YetaT63007(ActionDatabase.READ, getThis());   
								    
						  MSFFormWindows msFwYetaT63007 = new MSFFormWindows("주택마련저축", yetaT63007Form, "닫기", "820px", "710px", true);
						  msFwYetaT63007.show();
						  yetaT63007Form.setMSFFormWindows(msFwYetaT63007);
						  
						  funcSetPopUpRecord();
						  //TODO 추후 주석해제 
						  yetaT63007Form.bind(ppRecord); 
					  }
		    	}); 
		    	...
		    	btnYetat13008.addListener(Events.Select, new Listener<ButtonEvent>() {
		    		public void handleEvent(ButtonEvent e) {
						  //전체내역  
						  YetaT63008 yetaT63008Form = new YetaT63008(ActionDatabase.READ, getThis());   
								    
						  MSFFormWindows msFwYetaT63008 = new MSFFormWindows("중소기업창업투자조합출자등", yetaT63008Form, "닫기", "600px", "710px", true);
						  msFwYetaT63008.show();
						  yetaT63008Form.setMSFFormWindows(msFwYetaT63008);
						  
						  funcSetPopUpRecord();
						  //TODO 추후 주석해제 
						  yetaT63008Form.bind(ppRecord); 
					  }
		    	}); 
		    	...
		    	btnYetat13009.addListener(Events.Select, new Listener<ButtonEvent>() {
		    		public void handleEvent(ButtonEvent e) {
						  //전체내역  
						  YetaT63009 yetaT63009Form = new YetaT63009(ActionDatabase.READ, getThis());   
								    
						  MSFFormWindows msFwYetaT63009 = new MSFFormWindows("신용카드등", yetaT63009Form, "닫기", "600px", "710px", true);
						  msFwYetaT63009.show();
						  yetaT63009Form.setMSFFormWindows(msFwYetaT63009);
						  
						  funcSetPopUpRecord();
						  //TODO 추후 주석해제 
						  yetaT63009Form.bind(ppRecord); 
					  }
		    	}); 
		    	...
		    	btnYetat13010.addListener(Events.Select, new Listener<ButtonEvent>() {
		    		public void handleEvent(ButtonEvent e) {
						  //전체내역  
						  YetaT63010 yetaT63010Form = new YetaT63010(ActionDatabase.READ, getThis());   
								    
						  MSFFormWindows msFwYetaT63010 = new MSFFormWindows("장기집합투자증권저축", yetaT63010Form, "닫기", "820px", "710px", true);
						  msFwYetaT63010.show();
						  yetaT63010Form.setMSFFormWindows(msFwYetaT63010);
						  
						  funcSetPopUpRecord();
						  //TODO 추후 주석해제 
						  yetaT63010Form.bind(ppRecord); 
					  }
		    	}); 
		    	...
		    	btnYetat13011.addListener(Events.Select, new Listener<ButtonEvent>() {
		    		public void handleEvent(ButtonEvent e) {
						  //전체내역  
						  YetaT63011 yetaT63011Form = new YetaT63011(ActionDatabase.READ, getThis());   
								    
						  MSFFormWindows msFwYetaT63011 = new MSFFormWindows("외국인근로자감면세액", yetaT63011Form, "닫기", "820px", "710px", true);
						  msFwYetaT63011.show();
						  yetaT63011Form.setMSFFormWindows(msFwYetaT63011);
						  
						  funcSetPopUpRecord();
						  //TODO 추후 주석해제 
						  yetaT63011Form.bind(ppRecord); 
					  }
		    	}); 
		    	...
		    	btnYetat13012.addListener(Events.Select, new Listener<ButtonEvent>() {
		    		public void handleEvent(ButtonEvent e) {
						  //전체내역  
						  YetaT63012 yetaT63012Form = new YetaT63012(ActionDatabase.READ, getThis());   
								    
						  MSFFormWindows msFwYetaT63012 = new MSFFormWindows("중소기업취업자세액감면", yetaT63012Form, "닫기", "450px", "710px", true);
						  msFwYetaT63012.show();
						  yetaT63012Form.setMSFFormWindows(msFwYetaT63012);
						  
						  funcSetPopUpRecord();
						  //TODO 추후 주석해제 
						  yetaT63012Form.bind(ppRecord); 
					  }
		    	}); 
		    	...
		    	btnYetat13013.addListener(Events.Select, new Listener<ButtonEvent>() {
		    		public void handleEvent(ButtonEvent e) {
						  //전체내역  
						  YetaT63013 yetaT63013Form = new YetaT63013(ActionDatabase.READ, getThis());   
								    
						  MSFFormWindows msFwYetaT63013 = new MSFFormWindows("연금계좌불입액", yetaT63013Form, "닫기", "820px", "710px", true);
						  msFwYetaT63013.show();
						  yetaT63013Form.setMSFFormWindows(msFwYetaT63013);
						  
						  funcSetPopUpRecord();
						  //TODO 추후 주석해제 
						  yetaT63013Form.bind(ppRecord); 
					  }
		    	}); 
		    	...
		    	btnYetat13014.addListener(Events.Select, new Listener<ButtonEvent>() {
		    		public void handleEvent(ButtonEvent e) {
						  //전체내역  
						  YetaT63014 yetaT63014Form = new YetaT63014(ActionDatabase.READ, getThis());   
								    
						  MSFFormWindows msFwYetaT63014 = new MSFFormWindows("교육비", yetaT63014Form, "닫기", "350px", "300px", true);
						  msFwYetaT63014.show();
						  yetaT63014Form.setMSFFormWindows(msFwYetaT63014);
						  
						  funcSetPopUpRecord();
						  //TODO 추후 주석해제 
						  yetaT63014Form.bind(ppRecord); 
					  }
		    	}); 
		    	...
		    	btnYetat13015.addListener(Events.Select, new Listener<ButtonEvent>() {
		    		public void handleEvent(ButtonEvent e) {
						  //전체내역  
						  YetaT63015 yetaT63015Form = new YetaT63015(ActionDatabase.READ, getThis());   
								    
						  MSFFormWindows msFwYetaT63015 = new MSFFormWindows("교육비지출액", yetaT63015Form, "닫기", "550px", "710px", true);
						  msFwYetaT63015.show();
						  yetaT63015Form.setMSFFormWindows(msFwYetaT63015);
						  
						  funcSetPopUpRecord();
						  //TODO 추후 주석해제 
						  yetaT63015Form.bind(ppRecord); 
					  }
		    	}); 
		    	...
		    	btnYetat13016.addListener(Events.Select, new Listener<ButtonEvent>() {
		    		public void handleEvent(ButtonEvent e) {
						  //전체내역  
						  YetaT63016 yetaT63016Form = new YetaT63016(ActionDatabase.READ, getThis());   
								    
						  MSFFormWindows msFwYetaT63016 = new MSFFormWindows("기부금", yetaT63016Form, "닫기", "600px", "710px", true);
						  msFwYetaT63016.show();
						  yetaT63016Form.setMSFFormWindows(msFwYetaT63016);
						  
						  funcSetPopUpRecord();
						  //TODO 추후 주석해제 
						  yetaT63016Form.bind(ppRecord); 
					  }
		    	}); 
		    	...
		    	btnYetat13017.addListener(Events.Select, new Listener<ButtonEvent>() {
		    		public void handleEvent(ButtonEvent e) {
						  ...
						  MSFFormWindows msFwYetaT63017 = new MSFFormWindows("표준세액공제", yetaT63017Form, "닫기", "600px", "710px", true);
						  msFwYetaT63017.show();
		    	...
		    	btnYetat13018.addListener(Events.Select, new Listener<ButtonEvent>() {
		    		public void handleEvent(ButtonEvent e) {
						  //전체내역  
						  YetaT63018 yetaT63018Form = new YetaT63018(ActionDatabase.READ, getThis());   
								    
						  MSFFormWindows msFwYetaT63018 = new MSFFormWindows("외국인납부세액", yetaT63018Form, "닫기", "600px", "710px", true);
						  msFwYetaT63018.show();
						  yetaT63018Form.setMSFFormWindows(msFwYetaT63018);
						  
						  funcSetPopUpRecord();
						  //TODO 추후 주석해제 
						  yetaT63018Form.bind(ppRecord); 
					  }
		    	}); 
