...
=====================================================**/
public  class YetaP720003   extends MSFFormPanel {  
 ...
 **/ 
	...
	public YetaP720003(final ActionDatabase actionDatabase, final MSFPanel caller) {
...
//		initLoad(); 	
		...
		this.actionDatabase = actionDatabase;
	 	...
	 	cpYeta72003 = new FormPanel();  

		createSearchForm();			//기본정보 필드를 적용
		   
		cpYeta72003.setBodyBorder(false);
		cpYeta72003.setBorders(false);
		cpYeta72003.setHeaderVisible(false);
		cpYeta72003.setSize("690px", "250px");
		   
		this.add(cpYeta72003);
	...
	private void createSearchForm() {
		...
		cpYeta72003.setLayout(new FlowLayout());
...
//							reloadYeta7200Result();
					...
					if("".equals(systemkey.getValue())){
						...
						if (filename.length() == 0) {
							...
							//submit the form
							cpYeta72003.mask("PDF 전자문서 업데이트 중입니다. 업로드 중..."); 

							//파일업로드 처리
							cpYeta72003.setAction(GWT.getHostPageBaseURL() + "/imp/XmlYeta7200DdcImport.do");
							cpYeta72003.setEncoding(Encoding.MULTIPART);
							cpYeta72003.setMethod(Method.POST);   
							cpYeta72003.submit();  
							cpYeta72003.onFrameLoad();  
							picBoolFile = true;
						...
						// after file upload 
						cpYeta72003.addListener(Events.Submit, new Listener<FormEvent>() {
