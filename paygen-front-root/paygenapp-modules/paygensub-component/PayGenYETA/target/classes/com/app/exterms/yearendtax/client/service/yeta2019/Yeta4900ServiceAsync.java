...
public interface Yeta4900ServiceAsync {
	
	
	public void saveYeta4900ToPyyt0302(List<Pyyt0302DTO> listPyyt0302Dto, String flag, AsyncCallback<Integer> callback);
	
	public void deleteYeta4900List(List<Pyyt0302DTO> listPyyt0302Dto, AsyncCallback<Integer> callback);
	
	public void Yeta4900InfoList(Pyyt0304DTO pyyt0304Dto, AsyncCallback<Pyyt0304BM> callback);
