...
import com.app.exterms.yearendtax.client.service.yeta2023.YetaT83014Service;
import com.app.exterms.yearendtax.client.service.yeta2023.YetaT83014ServiceAsync;
...
//import com.app.exterms.yearendtax.client.form.defs.yeta2016.YetaT83014Def;
/**====================================================
디자인화면 수정시 extends 부분을 다음과 같이 수정하여 사용한 후 다시 원복한다.
extends MSFPanel ->  extends LayoutContainer  implements IMSFWindow { 
상속받아 소스를 구현한 경우에는 에러나는 부분을 수정하여 처리 해야함.
=====================================================**/
public  class YetaT83014   extends MSFFormPanel {  
 ...
 **/
	...
	private  ContentPanel cpYetaT83014; 
	...
	// -------------- grid 선언 시작  ---------------	  
	private MSFGridPanel YetaT83014GridPanel;
//	private YetaT83014Def YetaT83014Def = new YetaT83014Def("YetaT83014");   //TODO 일단 화면번호로 Def
	// -------------- grid 선언 종료  ---------------
	...
	// -------------- 서비스 호출 시작 --------------
	private YetaT83014ServiceAsync yetaT83014Service = YetaT83014Service.Util.getInstance();
	// -------------- 서비스 호출 종료 --------------	 
...
//					ye162510Dto.setMnthRnttyHusCnttArea((MSFSharedUtils.allowNulls(bmMapModel.get("mnthRnttyHusCnttArea"))));    		/** column 월세주택계약면적 : mnthRnttyHusCnttArea */
				...
				yetaT83014Service.activityOnYetaT83014(listYe162510Dto, actionDatabase, new AsyncCallback<Long>(){
...
//		 }
	...
	public YetaT83014(final ActionDatabase actionDatabase, final MSFPanel caller) {
...
//		initLoad(); 	
		...
		this.actionDatabase = actionDatabase;
	 	...
	 	cpYetaT83014 = new ContentPanel();  

		createSearchForm();			//기본정보 필드를 적용
	 	createMsfGridForm();		//그리드필드
		   
		cpYetaT83014.setBodyBorder(false);
		cpYetaT83014.setBorders(false);
		cpYetaT83014.setHeaderVisible(false);
		cpYetaT83014.setSize("790px", "640px");
		   
		this.add(cpYetaT83014);
...
//		     });     
		...
		cpYetaT83014.setLayout(new FlowLayout());
...
//	      	     }
//				 
//				YetaT83014GridPanel.getMsfGrid().clearData();
//				 
//				BaseModel bmData = YetaT83014GridPanel.getTableDef().getDefaultValues();  
//		              
...
//		         
//		        YetaT83014GridPanel.getMsfGrid().getGrid().stopEditing();      
//		        YetaT83014GridPanel.getMsfGrid().getGrid().getStore().insert(bmData,0);   
//		        YetaT83014GridPanel.getMsfGrid().getGrid().startEditing(YetaT83014GridPanel.getMsfGrid().getGrid().getStore().indexOf(bmData), 0);   
//
...
//			public void handleEvent(ButtonEvent e) {
//				Iterator<BaseModel> itBm = YetaT83014GridPanel.getMsfGrid().getGrid().getSelectionModel().getSelectedItems().listIterator();
...
//			public void handleEvent(ButtonEvent e) {
//				setListRecord(YetaT83014GridPanel.getMsfGrid().getStore().getModifiedRecords().iterator());
//				doAction(actionDatabase);
//
//				if ((ActionDatabase.INSERT).equals(actionDatabase)) {
//					actionDatabase = ActionDatabase.INSERT;
...
//			topYetaBtnBar.add(btnYetaClose);
		...
		cpYetaT83014.add(topYetaBtnBar);
...
//		YetaT83014GridPanel = new MSFGridPanel(YetaT83014Def, false, false, false, false, false);
//		YetaT83014GridPanel.setSize("790px", "420px");
//		YetaT83014GridPanel.setBorders(true);
//		YetaT83014GridPanel.setHeaderVisible(false);
//		
...
//		
//		YetaT83014GridPanel.getGrid().getColumnModel().addAggregationRow(payrSummaryRow);  
//		
...
//		
//		YetaT83014GridPanel.getGrid().getColumnModel().addAggregationRow(payrSummaryRow1);
//		/** --- 그리드 합계 부분  종료 --- **/
		
//        cpYetaT83014.add(YetaT83014GridPanel);
...
//		layoutContainer.add(fldstNewFieldset_1);
		...
		cpYetaT83014.add(fieldSet1);
		cpYetaT83014.add(fieldSet2);
		cpYetaT83014.add(fldstNewFieldset_1);
	...
	public void reload() {
			...
			YetaT83014GridPanel.getTableDef().setTableColumnFilters(filters);
			YetaT83014GridPanel.getTableDef().addColumnFilter("yrtxBlggYr", MSFSharedUtils.allowNulls(srhYrtxBlggYr.getValue())
...
//					, SimpleColumnFilter.OPERATOR_EQUALS);//연말정산귀속년도
			YetaT83014GridPanel.getTableDef().addColumnFilter("clutSeptCd", MSFSharedUtils.getSelectedComboValue(srhClutSeptCd,"commCd")
					, SimpleColumnFilter.OPERATOR_EQUALS);//정산구분
			YetaT83014GridPanel.getTableDef().addColumnFilter("systemkey", MSFSharedUtils.allowNulls(systemkey.getValue())
					, SimpleColumnFilter.OPERATOR_EQUALS);//시스템키
		 
			YetaT83014GridPanel.reload();
