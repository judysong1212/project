...
import com.app.exterms.yearendtax.client.dto.yeta2022.InfcPsnl0100BM;
import com.app.exterms.yearendtax.client.dto.yeta2022.Ye160401BM;
import com.app.exterms.yearendtax.client.dto.yeta2022.Ye161010BM;
import com.app.exterms.yearendtax.client.dto.yeta2022.Ye161020BM;
...
//    private PayrConstants PayrLabel = PayrConstants.INSTANCE;
	...
	public Ye161010Def(String chkPayrDef) {
		...
		if("Yeta7100".equals(chkPayrDef)){
			setDaoClass("");
			setCustomListMethod(CLASS_YETA7100_DATA_LIST);
		...
		}else if("Yeta7200".equals(chkPayrDef)){
			setDaoClass("");
			setCustomListMethod(CLASS_YETA7200_DATA_LIST);
			...
			setDaoClass("");
			setCustomListMethod(CLASS_YETA7300_TO_YE161010_DATA_LIST);
			setAutoFillGrid(false);
			setShowFilterToolbar(false);
			setCheckBoxOnGridRows(true);
			setEditFieldGrid(false);
			...
			setTitle("");
	        setDaoClass("");
	        setCustomListMethod(CLASS_YETA7200_RESULT_DATA_LIST);
	  	  	setAutoFillGrid(true);
	        setShowFilterToolbar(false);   
	        setCheckBoxOnGridRows(false); 
		    setEditFieldGrid(false);
