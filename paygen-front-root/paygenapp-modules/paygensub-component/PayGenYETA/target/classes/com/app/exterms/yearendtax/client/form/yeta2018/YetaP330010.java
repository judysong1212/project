...
import com.app.exterms.yearendtax.client.service.yeta2018.YetaP330010ServiceAsync;
...
=====================================================**/
public  class YetaP330010   extends MSFFormPanel { 
 ...
 **/
   ...
   */
	...
	// -------------- 서비스 호출 시작 --------------
	private YetaP330010ServiceAsync yetaP330010Service = YetaP330010Service.Util.getInstance();
	// -------------- 서비스 호출 종료 --------------
 ...
 **/	  
	...
	public YetaP330010(final ActionDatabase actionDatabase, final MSFFormPanel caller) {
...
//		lcSchCenter2_1.add(taxmSt10Jong, new FormData("100%"));
	...
	private void YetaP330010FormSave() {  
...
//		ye160405Dto.setTaxmSy21Jong((Long)taxmSy21Jong.getValue());    /** column 비과세소득_Y21_비과세 : taxmSy21Jong */
		...
		yetaP330010Service.activityOnYetaP330010ToYe160405(ye160405Dto, actionDatabase, new AsyncCallback<Integer>(){
					public void onFailure(Throwable caught) {
						MessageBox.alert(MSFMainApp.MSFCONSTANTS.ExceptionTitleService(), 
	                              MSFMainApp.ADMINMESSAGES.ExceptionMessageService("activityOnYetaP330010ToYe160405(" + actionDatabase.name() + ") : " + caught), null);
					}
	...
	public void reload() {
		...
		yetaP330010Service.getYetaP330010ToYe160405List(ye160405Dto, new AsyncCallback<Ye160405DTO>(){
	...
	/** 비과세 및 감면소득 조회부 **/
	public void readYetaP330010Data(Ye160405DTO result) {
