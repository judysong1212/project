...
import com.app.exterms.yearendtax.client.form.defs.yeta2017.Ye162030Def;
import com.app.exterms.yearendtax.client.service.yeta2017.YetaT23007Service;
import com.app.exterms.yearendtax.client.service.yeta2017.YetaT23007ServiceAsync;
...
=====================================================**/
public  class YetaT23007   extends MSFFormPanel {  
 ...
 **/
	...
	private  ContentPanel cpYetaT23007; 
	...
	// -------------- grid 선언 시작  ---------------	  
	private MSFGridPanel yetaT23007GridPanel;
	private Ye162030Def ye162030Def = new Ye162030Def("YetaT23007");   
	...
	// -------------- 서비스 호출 시작 --------------
	private YetaT23007ServiceAsync yetaT23007Service = YetaT23007Service.Util.getInstance();
	// -------------- 서비스 호출 종료 --------------	 
...
//					ye162510Dto.setMnthRnttyHusCnttArea((MSFSharedUtils.allowNulls(bmMapModel.get("mnthRnttyHusCnttArea"))));    		/** column 월세주택계약면적 : mnthRnttyHusCnttArea */
				...
				yetaT23007Service.activityOnYetaT23007(listYe162510Dto, actionDatabase, new AsyncCallback<Long>(){
...
//		 }
	...
	public YetaT23007(final ActionDatabase actionDatabase, final MSFPanel caller) {
...
//		initLoad(); 	
		...
		this.actionDatabase = actionDatabase;
	 	...
	 	cpYetaT23007 = new ContentPanel();  

		createSearchForm();			//기본정보 필드를 적용
	 	createMsfGridForm();		//그리드필드
		   
		cpYetaT23007.setBodyBorder(false);
		cpYetaT23007.setBorders(false);
		cpYetaT23007.setHeaderVisible(false);
		cpYetaT23007.setSize("790px", "640px");
		   
		this.add(cpYetaT23007);
...
//		     });     
		...
		cpYetaT23007.setLayout(new FlowLayout());
...
//	      	     }
//				 
//				yetaT23007GridPanel.getMsfGrid().clearData();
//				 
//				BaseModel bmData = yetaT23007GridPanel.getTableDef().getDefaultValues();  
//		              
...
//		         
//		        yetaT23007GridPanel.getMsfGrid().getGrid().stopEditing();      
//		        yetaT23007GridPanel.getMsfGrid().getGrid().getStore().insert(bmData,0);   
//		        yetaT23007GridPanel.getMsfGrid().getGrid().startEditing(yetaT23007GridPanel.getMsfGrid().getGrid().getStore().indexOf(bmData), 0);   
//
...
//			public void handleEvent(ButtonEvent e) {
//				Iterator<BaseModel> itBm = yetaT23007GridPanel.getMsfGrid().getGrid().getSelectionModel().getSelectedItems().listIterator();
...
//			public void handleEvent(ButtonEvent e) {
//				setListRecord(yetaT23007GridPanel.getMsfGrid().getStore().getModifiedRecords().iterator());
//				doAction(actionDatabase);
//
//				if ((ActionDatabase.INSERT).equals(actionDatabase)) {
//					actionDatabase = ActionDatabase.INSERT;
...
//				
//		cpYetaT23007.add(topYetaBtnBar);
...
//		cpYetaT23007.add(topYetaBtnBar);
		...
		yetaT23007GridPanel = new MSFGridPanel(ye162030Def, false, false, false, false, false);
		yetaT23007GridPanel.setSize("790px", "200px");
		yetaT23007GridPanel.setBorders(true);
		yetaT23007GridPanel.setHeaderVisible(false);
...
//		
//		yetaT23007GridPanel.getGrid().getColumnModel().addAggregationRow(payrSummaryRow);  
//		
...
//		
//		yetaT23007GridPanel.getGrid().getColumnModel().addAggregationRow(payrSummaryRow1);
//		/** --- 그리드 합계 부분  종료 --- **/
		
//        cpYetaT23007.add(yetaT23007GridPanel);
...
//		cpYetaT23007.add(layoutContainer1);
//		cpYetaT23007.add(layoutContainer2);
		fldstNewFieldset.add(yetaT23007GridPanel);
		cpYetaT23007.add(fldstNewFieldset);
		cpYetaT23007.add(layoutContainer10);
		cpYetaT23007.add(fldstNewFieldset_1);
	...
	public void reload() {
			...
			yetaT23007GridPanel.getTableDef().setTableColumnFilters(filters);
			yetaT23007GridPanel.getTableDef().addColumnFilter("yrtxBlggYr", MSFSharedUtils.allowNulls(srhYrtxBlggYr.getValue())
...
//					, SimpleColumnFilter.OPERATOR_EQUALS);//연말정산귀속년도
			yetaT23007GridPanel.getTableDef().addColumnFilter("clutSeptCd", MSFSharedUtils.getSelectedComboValue(srhClutSeptCd,"commCd")
					, SimpleColumnFilter.OPERATOR_EQUALS);//정산구분
			yetaT23007GridPanel.getTableDef().addColumnFilter("systemkey", MSFSharedUtils.allowNulls(systemkey.getValue())
					, SimpleColumnFilter.OPERATOR_EQUALS);//시스템키
		 
			yetaT23007GridPanel.reload();
