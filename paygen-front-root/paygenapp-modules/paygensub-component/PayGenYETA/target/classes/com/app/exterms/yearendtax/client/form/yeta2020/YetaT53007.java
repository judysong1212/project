...
import com.app.exterms.yearendtax.client.form.defs.yeta2020.Ye162030Def;
import com.app.exterms.yearendtax.client.service.yeta2020.YetaT53007Service;
import com.app.exterms.yearendtax.client.service.yeta2020.YetaT53007ServiceAsync;
...
=====================================================**/
public  class YetaT53007   extends MSFFormPanel {  
 ...
 **/
	...
	private  ContentPanel cpYetaT53007; 
	...
	// -------------- grid 선언 시작  ---------------	  
	private MSFGridPanel YetaT53007GridPanel;
	private Ye162030Def ye162030Def = new Ye162030Def("YetaT53007");   
	...
	// -------------- 서비스 호출 시작 --------------
	private YetaT53007ServiceAsync yetaT53007Service = YetaT53007Service.Util.getInstance();
	// -------------- 서비스 호출 종료 --------------	 
...
//					ye162510Dto.setMnthRnttyHusCnttArea((MSFSharedUtils.allowNulls(bmMapModel.get("mnthRnttyHusCnttArea"))));    		/** column 월세주택계약면적 : mnthRnttyHusCnttArea */
				...
				yetaT53007Service.activityOnYetaT53007(listYe162510Dto, actionDatabase, new AsyncCallback<Long>(){
...
//		 }
	...
	public YetaT53007(final ActionDatabase actionDatabase, final MSFPanel caller) {
...
//		initLoad(); 	
		...
		this.actionDatabase = actionDatabase;
	 	...
	 	cpYetaT53007 = new ContentPanel();  

		createSearchForm();			//기본정보 필드를 적용
	 	createMsfGridForm();		//그리드필드
		   
		cpYetaT53007.setBodyBorder(false);
		cpYetaT53007.setBorders(false);
		cpYetaT53007.setHeaderVisible(false);
		cpYetaT53007.setSize("790px", "640px");
		   
		this.add(cpYetaT53007);
...
//		     });     
		...
		cpYetaT53007.setLayout(new FlowLayout());
...
//	      	     }
//				 
//				YetaT53007GridPanel.getMsfGrid().clearData();
//				 
//				BaseModel bmData = YetaT53007GridPanel.getTableDef().getDefaultValues();  
//		              
...
//		         
//		        YetaT53007GridPanel.getMsfGrid().getGrid().stopEditing();      
//		        YetaT53007GridPanel.getMsfGrid().getGrid().getStore().insert(bmData,0);   
//		        YetaT53007GridPanel.getMsfGrid().getGrid().startEditing(YetaT53007GridPanel.getMsfGrid().getGrid().getStore().indexOf(bmData), 0);   
//
...
//			public void handleEvent(ButtonEvent e) {
//				Iterator<BaseModel> itBm = YetaT53007GridPanel.getMsfGrid().getGrid().getSelectionModel().getSelectedItems().listIterator();
...
//			public void handleEvent(ButtonEvent e) {
//				setListRecord(YetaT53007GridPanel.getMsfGrid().getStore().getModifiedRecords().iterator());
//				doAction(actionDatabase);
//
//				if ((ActionDatabase.INSERT).equals(actionDatabase)) {
//					actionDatabase = ActionDatabase.INSERT;
...
//				
//		cpYetaT53007.add(topYetaBtnBar);
...
//		cpYetaT53007.add(topYetaBtnBar);
		...
		YetaT53007GridPanel = new MSFGridPanel(ye162030Def, false, false, false, false, false);
		YetaT53007GridPanel.setSize("790px", "200px");
		YetaT53007GridPanel.setBorders(true);
		YetaT53007GridPanel.setHeaderVisible(false);
...
//		
//		YetaT53007GridPanel.getGrid().getColumnModel().addAggregationRow(payrSummaryRow);  
//		
...
//		
//		YetaT53007GridPanel.getGrid().getColumnModel().addAggregationRow(payrSummaryRow1);
//		/** --- 그리드 합계 부분  종료 --- **/
		
//        cpYetaT53007.add(YetaT53007GridPanel);
...
//		cpYetaT53007.add(layoutContainer1);
//		cpYetaT53007.add(layoutContainer2);
		fldstNewFieldset.add(YetaT53007GridPanel);
		cpYetaT53007.add(fldstNewFieldset);
		cpYetaT53007.add(layoutContainer10);
		cpYetaT53007.add(fldstNewFieldset_1);
	...
	public void reload() {
			...
			YetaT53007GridPanel.getTableDef().setTableColumnFilters(filters);
			YetaT53007GridPanel.getTableDef().addColumnFilter("yrtxBlggYr", MSFSharedUtils.allowNulls(srhYrtxBlggYr.getValue())
...
//					, SimpleColumnFilter.OPERATOR_EQUALS);//연말정산귀속년도
			YetaT53007GridPanel.getTableDef().addColumnFilter("clutSeptCd", MSFSharedUtils.getSelectedComboValue(srhClutSeptCd,"commCd")
					, SimpleColumnFilter.OPERATOR_EQUALS);//정산구분
			YetaT53007GridPanel.getTableDef().addColumnFilter("systemkey", MSFSharedUtils.allowNulls(systemkey.getValue())
					, SimpleColumnFilter.OPERATOR_EQUALS);//시스템키
		 
			YetaT53007GridPanel.reload();
