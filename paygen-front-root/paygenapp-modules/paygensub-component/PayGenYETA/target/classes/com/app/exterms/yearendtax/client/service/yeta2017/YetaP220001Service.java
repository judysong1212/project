...
@RemoteServiceRelativePath("YetaP220001Service.gwt")
public interface YetaP220001Service extends RemoteService {
	/**
	 * Utility class for simplifying access to the instance of async service.
	 */
	public static class Util {
		private static YetaP220001ServiceAsync instance;
		public static YetaP220001ServiceAsync getInstance(){
			if (instance == null) {
				instance = GWT.create(YetaP220001Service.class);
			}
			return instance;
		}
	}
