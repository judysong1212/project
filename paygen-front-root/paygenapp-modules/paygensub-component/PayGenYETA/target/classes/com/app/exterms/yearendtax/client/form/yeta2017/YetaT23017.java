...
=====================================================**/
public  class YetaT23017   extends MSFFormPanel {  
	...
	private  ContentPanel cpYetaT23017; 
	...
	public YetaT23017(final ActionDatabase actionDatabase, final MSFPanel caller) {
		...
		cpYetaT23017 = new ContentPanel();  

		createSearchForm();			//기본정보 필드를 적용
		createMsfGridForm();		//그리드필드
		setReadOnlyTrueYetaP23017();

		cpYetaT23017.setBodyBorder(false);
		cpYetaT23017.setBorders(false);
		cpYetaT23017.setHeaderVisible(false);
		cpYetaT23017.setSize("630px", "640px");

		this.add(cpYetaT23017);
	...
	private void createMsfGridForm() {
		...
		cpYetaT23017.add(layoutContainer1);
		cpYetaT23017.add(layoutContainer2);
		cpYetaT23017.add(layoutContainer3);
		cpYetaT23017.add(layoutContainer4);
		cpYetaT23017.add(layoutContainer5);
		cpYetaT23017.add(layoutContainer6);
		cpYetaT23017.add(layoutContainer7);
		cpYetaT23017.add(layoutContainer8);
		cpYetaT23017.add(layoutContainer9);
	}	
