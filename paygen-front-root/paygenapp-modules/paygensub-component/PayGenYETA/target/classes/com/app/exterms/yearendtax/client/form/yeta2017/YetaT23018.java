...
import com.app.exterms.yearendtax.client.service.yeta2017.YetaT23018Service;
import com.app.exterms.yearendtax.client.service.yeta2017.YetaT23018ServiceAsync;
...
=====================================================**/
public  class YetaT23018   extends MSFFormPanel {  
 ...
 **/
	...
	private  ContentPanel cpYetaT23018; 
	...
	// -------------- grid 선언 시작  ---------------	  
	private MSFGridPanel yetaT23018GridPanel;
	// -------------- grid 선언 종료  ---------------
	...
	// -------------- 서비스 호출 시작 --------------
	private YetaT23018ServiceAsync yetaT23018Service = YetaT23018Service.Util.getInstance();
	// -------------- 서비스 호출 종료 --------------	 
...
//					ye162510Dto.setMnthRnttyHusCnttArea((MSFSharedUtils.allowNulls(bmMapModel.get("mnthRnttyHusCnttArea"))));    		/** column 월세주택계약면적 : mnthRnttyHusCnttArea */
				...
				yetaT23018Service.activityOnYetaT23018(listYe162510Dto, actionDatabase, new AsyncCallback<Long>(){
...
//		 }
	...
	public YetaT23018(final ActionDatabase actionDatabase, final MSFPanel caller) {
...
//		initLoad(); 	
		...
		this.actionDatabase = actionDatabase;
	 	...
	 	cpYetaT23018 = new ContentPanel();  

		createSearchForm();			//기본정보 필드를 적용
	 	createMsfGridForm();		//그리드필드
		   
		cpYetaT23018.setBodyBorder(false);
		cpYetaT23018.setBorders(false);
		cpYetaT23018.setHeaderVisible(false);
		cpYetaT23018.setSize("790px", "640px");
		   
		this.add(cpYetaT23018);
...
//		     });     
		...
		cpYetaT23018.setLayout(new FlowLayout());
...
//	      	     }
//				 
//				yetaT23018GridPanel.getMsfGrid().clearData();
//				 
//				BaseModel bmData = yetaT23018GridPanel.getTableDef().getDefaultValues();  
//		              
...
//		         
//		        yetaT23018GridPanel.getMsfGrid().getGrid().stopEditing();      
//		        yetaT23018GridPanel.getMsfGrid().getGrid().getStore().insert(bmData,0);   
//		        yetaT23018GridPanel.getMsfGrid().getGrid().startEditing(yetaT23018GridPanel.getMsfGrid().getGrid().getStore().indexOf(bmData), 0);   
//
...
//			public void handleEvent(ButtonEvent e) {
//				Iterator<BaseModel> itBm = yetaT23018GridPanel.getMsfGrid().getGrid().getSelectionModel().getSelectedItems().listIterator();
...
//				
		...
		btnYetaSave.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				setListRecord(yetaT23018GridPanel.getMsfGrid().getStore().getModifiedRecords().iterator());
				doAction(actionDatabase);
...
//				
		cpYetaT23018.add(topYetaBtnBar);
...
//		yetaT23018GridPanel = new MSFGridPanel(yetaT23018Def, false, false, false, false, false);
//		yetaT23018GridPanel.setSize("790px", "420px");
//		yetaT23018GridPanel.setBorders(true);
//		yetaT23018GridPanel.setHeaderVisible(false);
...
//		
//		yetaT23018GridPanel.getGrid().getColumnModel().addAggregationRow(payrSummaryRow);  
//		
...
//		
//		yetaT23018GridPanel.getGrid().getColumnModel().addAggregationRow(payrSummaryRow1);
//		/** --- 그리드 합계 부분  종료 --- **/
		
//        cpYetaT23018.add(yetaT23018GridPanel);
		...
		cpYetaT23018.add(layoutContainer);
	...
	public void reload() {
			...
			yetaT23018GridPanel.getTableDef().setTableColumnFilters(filters);
			yetaT23018GridPanel.getTableDef().addColumnFilter("yrtxBlggYr", MSFSharedUtils.allowNulls(srhYrtxBlggYr.getValue())
...
//					, SimpleColumnFilter.OPERATOR_EQUALS);//연말정산귀속년도
			yetaT23018GridPanel.getTableDef().addColumnFilter("clutSeptCd", MSFSharedUtils.getSelectedComboValue(srhClutSeptCd,"commCd")
					, SimpleColumnFilter.OPERATOR_EQUALS);//정산구분
			yetaT23018GridPanel.getTableDef().addColumnFilter("systemkey", MSFSharedUtils.allowNulls(systemkey.getValue())
					, SimpleColumnFilter.OPERATOR_EQUALS);//시스템키
		 
			yetaT23018GridPanel.reload();
