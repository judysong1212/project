 ...
 */
public class PdfC101yBM   extends MSFSimpleBaseModel implements IsSerializable  {
    ...
    public static final String ATTR_EDISEILNUM = "ediSeilNum";
    ...
    /** set 교육비종류코드 : eduTp */
    public static final String ATTR_EDUTP = "eduTp";

    /** set 교육비납입금액합계 : ediSum */
    public static final String ATTR_EDISUM = "ediSum";
    
    /** set 교육비구분 : ediCl */
    public static final String ATTR_EDUCL = "eduCl";
    ...
    /** 일괄등록 처리   */
     public PdfC101yBM(
     	...
     	values.put(ATTR_EDISEILNUM,ediSeilNum);
     	...
     	values.put(ATTR_EDUTP,eduTp);
     	values.put(ATTR_EDUCL,eduCl);
     	values.put(ATTR_EDISUM,ediSum);
    ...
    /** set 교육비일련번호 : ediSeilNum */
    public void setEdiSeilNum(Long  ediSeilNum) { set( ATTR_EDISEILNUM ,ediSeilNum);}
    /** get 교육비일련번호 : ediSeilNum */
    public Long  getEdiSeilNum() { return (Long )get( ATTR_EDISEILNUM );}
    ...
    /** set 교육비종류코드 : eduTp */
    public void setEduTp(String  eduTp) { set( ATTR_EDUTP ,eduTp);}
    /** get 교육비종류코드 : eduTp */
    public String  getEduTp() { return (String )get( ATTR_EDUTP );}
    
    /** set 교육비구분 : eduCl */
    public void setEduCl(String  eduCl) { set( ATTR_EDUCL ,eduCl);}
    /** get 교육비구분 : eduCl */
    public String  getEduCl() { return (String )get( ATTR_EDUCL );}

    /** set 교육비납입금액합계 : ediSum */
    public void setEdiSum(Long  ediSum) { set( ATTR_EDISUM ,ediSum);}
    /** get 교육비납입금액합계 : ediSum */
    public Long  getEdiSum() { return (Long )get( ATTR_EDISUM );}
