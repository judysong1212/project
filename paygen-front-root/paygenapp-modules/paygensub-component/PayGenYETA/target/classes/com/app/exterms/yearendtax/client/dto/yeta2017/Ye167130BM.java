 ...
 */
public class Ye167130BM   extends MSFSimpleBaseModel implements IsSerializable  {
    ...
    /** set 연금저축계좌구분 : pnsnSvngAccPnsnSvngCl */
    ...
    /** 일괄등록 처리   */
     public Ye167130BM(
    		...
    		, BigDecimal  pnsnSvngAccPymAmt 
    		, BigDecimal  ipnsnSvngAccddcAmt 
    		, String  kybdr 
    		, String  inptDt 
    		, String  inptAddr 
    		, String  ismt 
    ...
    /** get 연금저축계좌구분 : pnsnSvngAccPnsnSvngCl */
    ...
    /** set 연금저축계좌납입금액 : pnsnSvngAccPymAmt */
    public void setPnsnSvngAccPymAmt(BigDecimal  pnsnSvngAccPymAmt) { set( ATTR_PNSNSVNGACCPYMAMT ,pnsnSvngAccPymAmt);}
    /** get 연금저축계좌납입금액 : pnsnSvngAccPymAmt */
    public BigDecimal  getPnsnSvngAccPymAmt() { return (BigDecimal )get( ATTR_PNSNSVNGACCPYMAMT );}
    /** set 연금저축계좌세액공제금액 : ipnsnSvngAccddcAmt */
    public void setIpnsnSvngAccddcAmt(BigDecimal  ipnsnSvngAccddcAmt) { set( ATTR_IPNSNSVNGACCDDCAMT ,ipnsnSvngAccddcAmt);}
    /** get 연금저축계좌세액공제금액 : ipnsnSvngAccddcAmt */
    public BigDecimal  getIpnsnSvngAccddcAmt() { return (BigDecimal )get( ATTR_IPNSNSVNGACCDDCAMT );}
    /** set 입력자 : kybdr */
