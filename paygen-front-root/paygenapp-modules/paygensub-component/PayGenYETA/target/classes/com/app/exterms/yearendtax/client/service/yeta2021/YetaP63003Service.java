...
@RemoteServiceRelativePath("YetaP63003Service.gwt")
public interface YetaP63003Service extends RemoteService {
	/**
	 * Utility class for simplifying access to the instance of async service.
	 */
	public static class Util {
		private static YetaP63003ServiceAsync instance;
		public static YetaP63003ServiceAsync getInstance(){
			if (instance == null) {
				instance = GWT.create(YetaP63003Service.class);
			}
			return instance;
		}
	}
