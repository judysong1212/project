...
import com.app.exterms.yearendtax.client.form.defs.yeta2017.Ye162010Def;
import com.app.exterms.yearendtax.client.service.yeta2017.YetaT23013Service;
import com.app.exterms.yearendtax.client.service.yeta2017.YetaT23013ServiceAsync;
...
=====================================================**/
public  class YetaT23013   extends MSFFormPanel {  
 ...
 **/
	...
	private  ContentPanel cpYetaT23013; 
	...
	// -------------- grid 선언 시작  ---------------	  
	private MSFGridPanel yetaT23013GridPanel;
	private Ye162010Def ye162010Def = new Ye162010Def("YetaT23013");   
	// -------------- grid 선언 종료  ---------------
	...
	// -------------- 서비스 호출 시작 --------------
	private YetaT23013ServiceAsync yetaT23013Service = YetaT23013Service.Util.getInstance();
	// -------------- 서비스 호출 종료 --------------	 
...
//					ye162510Dto.setMnthRnttyHusCnttArea((MSFSharedUtils.allowNulls(bmMapModel.get("mnthRnttyHusCnttArea"))));    		/** column 월세주택계약면적 : mnthRnttyHusCnttArea */
				...
				yetaT23013Service.activityOnYetaT23013(listYe162510Dto, actionDatabase, new AsyncCallback<Long>(){
...
//		 }
	...
	public YetaT23013(final ActionDatabase actionDatabase, final MSFPanel caller) {
...
//		initLoad(); 	
		...
		this.actionDatabase = actionDatabase;
	 	...
	 	cpYetaT23013 = new ContentPanel();  

		createSearchForm();			//기본정보 필드를 적용
	 	createMsfGridForm();		//그리드필드
		   
	 	cpYetaT23013.setBodyBorder(false);
	 	cpYetaT23013.setBorders(false);
	 	cpYetaT23013.setHeaderVisible(false);
	 	cpYetaT23013.setSize("790px", "640px");
		   
		this.add(cpYetaT23013);
...
//		     });     
		...
		cpYetaT23013.setLayout(new FlowLayout());
...
//	      	     }
//				 
//				yetaT23013GridPanel.getMsfGrid().clearData();
//				 
//				BaseModel bmData = yetaT23013GridPanel.getTableDef().getDefaultValues();  
//		              
...
//		         
//		        yetaT23013GridPanel.getMsfGrid().getGrid().stopEditing();      
//		        yetaT23013GridPanel.getMsfGrid().getGrid().getStore().insert(bmData,0);   
//		        yetaT23013GridPanel.getMsfGrid().getGrid().startEditing(yetaT23013GridPanel.getMsfGrid().getGrid().getStore().indexOf(bmData), 0);   
//
...
//			public void handleEvent(ButtonEvent e) {
//				Iterator<BaseModel> itBm = yetaT23013GridPanel.getMsfGrid().getGrid().getSelectionModel().getSelectedItems().listIterator();
...
//			public void handleEvent(ButtonEvent e) {
//				setListRecord(yetaT23013GridPanel.getMsfGrid().getStore().getModifiedRecords().iterator());
//				doAction(actionDatabase);
//
//				if ((ActionDatabase.INSERT).equals(actionDatabase)) {
//					actionDatabase = ActionDatabase.INSERT;
...
//		cpYetaT23013.add(topYetaBtnBar);
...
//		cpYetaT23013.add(topYetaBtnBar);
		...
		yetaT23013GridPanel = new MSFGridPanel(ye162010Def, false, false, false, false, false);
		yetaT23013GridPanel.setSize("790px", "200px");
		yetaT23013GridPanel.setBorders(true);
		yetaT23013GridPanel.setHeaderVisible(false);
...
//		
//		yetaT23013GridPanel.getGrid().getColumnModel().addAggregationRow(payrSummaryRow);  
//		
...
//		
//		yetaT23013GridPanel.getGrid().getColumnModel().addAggregationRow(payrSummaryRow1);
//		/** --- 그리드 합계 부분  종료 --- **/
		
//        cpYetaT23013.add(yetaT23013GridPanel);
		...
		fldstNewFieldset.add(yetaT23013GridPanel);
		cpYetaT23013.add(fldstNewFieldset);
		cpYetaT23013.add(layoutContainer10);
		cpYetaT23013.add(fldstNewFieldset_1);
	...
	public void reload() {
			...
			yetaT23013GridPanel.getTableDef().setTableColumnFilters(filters);
			yetaT23013GridPanel.getTableDef().addColumnFilter("yrtxBlggYr", MSFSharedUtils.allowNulls(srhYrtxBlggYr.getValue())
...
//					, SimpleColumnFilter.OPERATOR_EQUALS);//연말정산귀속년도
			yetaT23013GridPanel.getTableDef().addColumnFilter("clutSeptCd", MSFSharedUtils.getSelectedComboValue(srhClutSeptCd,"commCd")
					, SimpleColumnFilter.OPERATOR_EQUALS);//정산구분
			yetaT23013GridPanel.getTableDef().addColumnFilter("systemkey", MSFSharedUtils.allowNulls(systemkey.getValue())
					, SimpleColumnFilter.OPERATOR_EQUALS);//시스템키
		 
			yetaT23013GridPanel.reload();
