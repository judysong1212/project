...
import com.app.exterms.yearendtax.client.service.yeta2023.YetaT83016Service;
import com.app.exterms.yearendtax.client.service.yeta2023.YetaT83016ServiceAsync;
...
//import com.app.exterms.yearendtax.client.form.defs.yeta2016.YetaT83016Def;
...
=====================================================**/
public  class YetaT83016   extends MSFFormPanel {  
 ...
 **/
	...
	private  ContentPanel cpYetaT83016; 
	...
	// -------------- grid 선언 시작  ---------------	  
	private MSFGridPanel YetaT83016GridPanel;
//	private YetaT83016Def YetaT83016Def = new YetaT83016Def("YetaT83016");   //TODO 일단 화면번호로 Def
	// -------------- grid 선언 종료  ---------------
	...
	// -------------- 서비스 호출 시작 --------------
	private YetaT83016ServiceAsync yetaT83016Service = YetaT83016Service.Util.getInstance();
	// -------------- 서비스 호출 종료 --------------	 
...
//					ye162510Dto.setMnthRnttyHusCnttArea((MSFSharedUtils.allowNulls(bmMapModel.get("mnthRnttyHusCnttArea"))));    		/** column 월세주택계약면적 : mnthRnttyHusCnttArea */
				...
				yetaT83016Service.activityOnYetaT83016(listYe162510Dto, actionDatabase, new AsyncCallback<Long>(){
...
//		 }
	...
	public YetaT83016(final ActionDatabase actionDatabase, final MSFPanel caller) {
...
//		initLoad(); 	
		...
		this.actionDatabase = actionDatabase;
	 	...
	 	cpYetaT83016 = new ContentPanel();  

		createSearchForm();			//기본정보 필드를 적용
	 	createMsfGridForm();		//그리드필드
		   
		cpYetaT83016.setBodyBorder(false);
		cpYetaT83016.setBorders(false);
		cpYetaT83016.setHeaderVisible(false);
		cpYetaT83016.setSize("790px", "640px");
		   
		this.add(cpYetaT83016);
...
//		     });     
		...
		cpYetaT83016.setLayout(new FlowLayout());
...
//	      	     }
//				 
//				YetaT83016GridPanel.getMsfGrid().clearData();
//				 
//				BaseModel bmData = YetaT83016GridPanel.getTableDef().getDefaultValues();  
//		              
...
//		         
//		        YetaT83016GridPanel.getMsfGrid().getGrid().stopEditing();      
//		        YetaT83016GridPanel.getMsfGrid().getGrid().getStore().insert(bmData,0);   
//		        YetaT83016GridPanel.getMsfGrid().getGrid().startEditing(YetaT83016GridPanel.getMsfGrid().getGrid().getStore().indexOf(bmData), 0);   
//
...
//			public void handleEvent(ButtonEvent e) {
//				Iterator<BaseModel> itBm = YetaT83016GridPanel.getMsfGrid().getGrid().getSelectionModel().getSelectedItems().listIterator();
...
//				
		...
		btnYetaSave.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				setListRecord(YetaT83016GridPanel.getMsfGrid().getStore().getModifiedRecords().iterator());
				doAction(actionDatabase);
...
//				
		cpYetaT83016.add(topYetaBtnBar);
...
//		YetaT83016GridPanel = new MSFGridPanel(YetaT83016Def, false, false, false, false, false);
//		YetaT83016GridPanel.setSize("790px", "420px");
//		YetaT83016GridPanel.setBorders(true);
//		YetaT83016GridPanel.setHeaderVisible(false);
...
//		
//		YetaT83016GridPanel.getGrid().getColumnModel().addAggregationRow(payrSummaryRow);  
//		
...
//		
//		YetaT83016GridPanel.getGrid().getColumnModel().addAggregationRow(payrSummaryRow1);
//		/** --- 그리드 합계 부분  종료 --- **/
		
//        cpYetaT83016.add(YetaT83016GridPanel);
		...
		cpYetaT83016.add(layoutContainer);
		...
		cpYetaT83016.add(layoutContainer1);
		...
		cpYetaT83016.add(layoutContainer2);
		...
		cpYetaT83016.add(layoutContainer_gibu08);
		...
		cpYetaT83016.add(fldstNewFieldset_4);
	...
	public void reload() {
			...
			YetaT83016GridPanel.getTableDef().setTableColumnFilters(filters);
			YetaT83016GridPanel.getTableDef().addColumnFilter("yrtxBlggYr", MSFSharedUtils.allowNulls(srhYrtxBlggYr.getValue())
...
//					, SimpleColumnFilter.OPERATOR_EQUALS);//연말정산귀속년도
			YetaT83016GridPanel.getTableDef().addColumnFilter("clutSeptCd", MSFSharedUtils.getSelectedComboValue(srhClutSeptCd,"commCd")
					, SimpleColumnFilter.OPERATOR_EQUALS);//정산구분
			YetaT83016GridPanel.getTableDef().addColumnFilter("systemkey", MSFSharedUtils.allowNulls(systemkey.getValue())
					, SimpleColumnFilter.OPERATOR_EQUALS);//시스템키
		 
			YetaT83016GridPanel.reload();
