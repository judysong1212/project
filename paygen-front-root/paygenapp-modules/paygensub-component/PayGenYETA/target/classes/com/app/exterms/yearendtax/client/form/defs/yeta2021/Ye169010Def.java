...
import com.app.exterms.yearendtax.client.dto.yeta2021.Ye169010BM;
...
public class Ye169010Def extends TableDef implements YetaDaoConstants {
	...
	public Ye169010Def(String chkPayrDef) {
		...
		if("Yeta6300".equals(chkPayrDef)) { 
			setTitle("");
	        setDaoClass("");
	        setCustomListMethod("");
	        setCustomListMethod(CLASS_YETA6300_TO_YE169010_SUBTAX_LIST);
	  	  	setAutoFillGrid(false);
	        setShowFilterToolbar(false);   
	        setCheckBoxOnGridRows(true); 
		    setEditFieldGrid(false);
		    setColumnsDefinition(getYeta6300ToYe169010ColumnsList());
    ...
    private List<ColumnDef> getYeta6300ToYe169010ColumnsList(){
        row = 0;
        List<ColumnDef> listColumnDefs = new ArrayList<ColumnDef>(); 
