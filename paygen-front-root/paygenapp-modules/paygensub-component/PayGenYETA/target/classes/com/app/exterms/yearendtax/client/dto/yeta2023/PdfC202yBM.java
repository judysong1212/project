 ...
 */
public class  PdfC202yBM   extends MSFSimpleBaseModel implements IsSerializable  {
    ...
    /** set 교육비직업훈련일련번호 : jbEdiSeilNum */
    public static final String ATTR_JBEDISEILNUM = "jbEdiSeilNum";
    ...
    /** set 교육비교육기관명 : tradeNm */
    public static final String ATTR_TRADENM = "tradeNm";

    /** set 교육비과정코드 : courseCd */
    public static final String ATTR_COURSECD = "courseCd";

    /** set 교육비과정명 : subjectNm */
    public static final String ATTR_SUBJECTNM = "subjectNm";

    /** set 교육비납입금액합계 : jobEdiSum */
    public static final String ATTR_JOBEDISUM = "jobEdiSum";
    ...
    /** 일괄등록 처리   */
     public PdfC202yBM(
     	...
     	values.put(ATTR_JBEDISEILNUM,jbEdiSeilNum);
     	...
     	values.put(ATTR_COURSECD,courseCd);
     	values.put(ATTR_SUBJECTNM,subjectNm);
     	values.put(ATTR_JOBEDISUM,jobEdiSum);
    ...
    /** set 교육비직업훈련일련번호 : jbEdiSeilNum */
    public void setJbEdiSeilNum(Long  jbEdiSeilNum) { set( ATTR_JBEDISEILNUM ,jbEdiSeilNum);}
    /** get 교육비직업훈련일련번호 : jbEdiSeilNum */
    public Long  getJbEdiSeilNum() { return (Long )get( ATTR_JBEDISEILNUM );}
    ...
    /** get 교육비교육기관명 : tradeNm */
    public String  getTradeNm() { return (String )get( ATTR_TRADENM );}

    /** set 교육비과정코드 : courseCd */
    public void setCourseCd(String  courseCd) { set( ATTR_COURSECD ,courseCd);}
    /** get 교육비과정코드 : courseCd */
    public String  getCourseCd() { return (String )get( ATTR_COURSECD );}

    /** set 교육비과정명 : subjectNm */
    public void setSubjectNm(String  subjectNm) { set( ATTR_SUBJECTNM ,subjectNm);}
    /** get 교육비과정명 : subjectNm */
    public String  getSubjectNm() { return (String )get( ATTR_SUBJECTNM );}

    /** set 교육비납입금액합계 : jobEdiSum */
    public void setJobEdiSum(Long  jobEdiSum) { set( ATTR_JOBEDISUM ,jobEdiSum);}
    /** get 교육비납입금액합계 : jobEdiSum */
    public Long  getJobEdiSum() { return (Long )get( ATTR_JOBEDISUM );}
