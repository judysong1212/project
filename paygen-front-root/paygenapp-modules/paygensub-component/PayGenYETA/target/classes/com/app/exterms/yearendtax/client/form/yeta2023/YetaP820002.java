...
//import com.app.exterms.yearendtax.client.dto.yeta2023.PdfG106yDTO;
import com.app.exterms.yearendtax.client.dto.yeta2023.PdfG107yDTO;
//import com.app.exterms.yearendtax.client.dto.yeta2023.PdfG206yDTO;
import com.app.exterms.yearendtax.client.dto.yeta2023.PdfG207yDTO;
//import com.app.exterms.yearendtax.client.dto.yeta2023.PdfG306yDTO;
...
//import com.app.exterms.yearendtax.client.form.defs.yeta2023.PdfG106yDef;
//import com.app.exterms.yearendtax.client.form.defs.yeta2023.PdfG206yDef;
//import com.app.exterms.yearendtax.client.form.defs.yeta2023.PdfG306yDef;
...
=====================================================**/
public  class YetaP820002   extends MSFFormPanel {  
	...
	private ButtonBar topYeta820002Bar;
	private Button btnYeta820002AllUsed; 	// 전체선택
	private Button btnYeta820002UnUsed; 		// 선택해제
	private Button btnYeta820002Save; 	// 소득공제반영
	// -------------- 권한 설정 객체 종료 --------------
	 ...
	 *~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ 		
	 **/ 		    
	public YetaP820002(final ActionDatabase actionDatabase, final MSFPanel caller) {
		...
		cpYeta81001.setScrollMode(Scroll.AUTOY);
		cpYeta81001.setHeaderVisible(false);
		cpYeta81001.setSize("913px", "660px");
	...
	private void createBasicForm() {
		...
		topYeta820002Bar = new ButtonBar();
		topYeta820002Bar.setAlignment(HorizontalAlignment.RIGHT);
		topYeta820002Bar.setStyleAttribute("paddingRight", "15px");
		topYeta820002Bar.setStyleAttribute("paddingTop", "5px");

		btnYeta820002AllUsed = new Button("전체선택");
		topYeta820002Bar.add(btnYeta820002AllUsed);
		btnYeta820002AllUsed.addSelectionListener(new SelectionListener<ButtonEvent>() {		        
		...
		btnYeta820002UnUsed = new Button("선택해제");
		topYeta820002Bar.add(btnYeta820002UnUsed);
		btnYeta820002UnUsed.addListener(Events.Select, new Listener<ButtonEvent>() {
		...
		btnYeta820002Save = new Button("소득공제반영");
		topYeta820002Bar.add(btnYeta820002Save);
		btnYeta820002Save.addSelectionListener(new SelectionListener<ButtonEvent>() {   
		...
		cpYeta81001.add(topYeta820002Bar, new FormData("100%"));
	}
	...
	private void createStandardForm() {
		...
		cpYeta81001.add(panel, new FormData("100%"));
