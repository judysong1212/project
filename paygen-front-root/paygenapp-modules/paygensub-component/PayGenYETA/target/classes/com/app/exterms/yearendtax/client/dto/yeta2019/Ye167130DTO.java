 ...
 */
public class Ye167130DTO   implements Serializable {
    ...
    private Long pnsnSvngAccPymAmt;

    /** set 연금저축계좌세액공제금액 : ipnsnSvngAccddcAmt */
    private Long ipnsnSvngAccddcAmt;
	...
	public Long getPnsnSvngAccPymAmt() {
		return pnsnSvngAccPymAmt;
	}

	public void setPnsnSvngAccPymAmt(Long pnsnSvngAccPymAmt) {
		this.pnsnSvngAccPymAmt = pnsnSvngAccPymAmt;
	}

	public Long getIpnsnSvngAccddcAmt() {
		return ipnsnSvngAccddcAmt;
	}

	public void setIpnsnSvngAccddcAmt(Long ipnsnSvngAccddcAmt) {
