 ...
 */
public class Ye161055BM   extends MSFSimpleBaseModel implements IsSerializable  {
    ...
    public static final String ATTR_PICLEMPLDIVCD = "piclEmplDivCd";
    ...
    /** 일괄등록 처리   */
     public Ye161055BM(
     	...
     	values.put(ATTR_PICLEMPLDIVCD,piclEmplDivCd);
    ...
    /** set 주종근무지구분코드 : piclEmplDivCd */
    public void setPiclEmplDivCd(String  piclEmplDivCd) { set( ATTR_PICLEMPLDIVCD ,piclEmplDivCd);}
    /** get 주종근무지구분코드 : piclEmplDivCd */
    public String  getPiclEmplDivCd() { return (String )get( ATTR_PICLEMPLDIVCD );}
    /** set 국민연금보험료금액 : natPennPrmmSum */
    ...
    /** get 국민연금보험료공제금액 : natPennDducSum */
