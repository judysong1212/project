...
import com.app.exterms.yearendtax.client.service.yeta2021.YetaP630010ServiceAsync;
...
=====================================================**/
public  class YetaP630010   extends MSFFormPanel { 
 ...
 **/
	...
	private ContentPanel cpYeta630010;
   ...
   */
	...
	// -------------- 서비스 호출 시작 --------------
	private YetaP630010ServiceAsync yetaP630010Service = YetaP630010Service.Util.getInstance();
	// -------------- 서비스 호출 종료 --------------
 ...
 **/	  
	...
	public YetaP630010(final ActionDatabase actionDatabase, final MSFFormPanel caller) {
		...
		cpYeta630010 = new ContentPanel();

		createStandardForm();
		setReadOnlyFalseYetaP13008();

		cpYeta630010.setBodyBorder(false);
		cpYeta630010.setBorders(false);
		cpYeta630010.setHeaderVisible(false);
		cpYeta630010.setSize("790px", "720px");

		this.add(cpYeta630010);
	...
	private void createStandardForm() {
		...
		cpYeta630010.add(whdgDebrBusoprRgstnum);
		
		
		deptNm = new HiddenField<String>();
		deptNm.setName("deptNm");
		cpYeta630010.add(deptNm);
		
		hanNm = new HiddenField<String>();
		hanNm.setName("hanNm");
		cpYeta630010.add(hanNm);
...
//				}
		...
		cpYeta630010.add(topYetaBtnBar);
...
//		lcSchCenter2_1.add(taxmSt10Jong, new FormData("100%"));
	...
	private void YetaP630010FormSave() {  
...
//		ye160405Dto.setTaxmSy21Jong((Long)taxmSy21Jong.getValue());    /** column 비과세소득_Y21_비과세 : taxmSy21Jong */
		...
		yetaP630010Service.activityOnYetaP630010ToYe160405(ye160405Dto, actionDatabase, new AsyncCallback<Integer>(){
					public void onFailure(Throwable caught) {
						MessageBox.alert(MSFMainApp.MSFCONSTANTS.ExceptionTitleService(), 
	                              MSFMainApp.ADMINMESSAGES.ExceptionMessageService("activityOnYetaP630010ToYe160405(" + actionDatabase.name() + ") : " + caught), null);
					}
	...
	public void reload() {
		...
		yetaP630010Service.getYetaP630010ToYe160405List(ye160405Dto, new AsyncCallback<Ye160405DTO>(){
	...
	/** 비과세 및 감면소득 조회부 **/
	public void readYetaP630010Data(Ye160405DTO result) {
