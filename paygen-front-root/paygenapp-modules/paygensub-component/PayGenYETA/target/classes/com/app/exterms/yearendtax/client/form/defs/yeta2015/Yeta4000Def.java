...
import com.app.exterms.yearendtax.client.dto.yeta2022.Payr0300BM;
import com.app.exterms.yearendtax.client.dto.yeta2022.Payr0301BM;
import com.app.exterms.yearendtax.client.dto.yeta2022.Payr0304BM;
...
public class Yeta4000Def extends TableDef implements YetaDaoConstants{
	...
	public Yeta4000Def(String chkDef) {
...
//		setTitle("연말정산대상자 및 내역");
		    ...
		    setColumnsDefinition(getAllColumnsList()); 
		 		...
		 		}else if("Yeta7600".equals(chkDef)) {
		 		//		setTitle("연말정산대상자 및 내역");
		 				setTitle("");
		 				setDaoClass("");
		 				setCustomListMethod(CLASS_YETA7600LIST);
		 				setAutoFillGrid(false);
		 				setShowFilterToolbar(false);   
		 				setCheckBoxOnGridRows(true); 
