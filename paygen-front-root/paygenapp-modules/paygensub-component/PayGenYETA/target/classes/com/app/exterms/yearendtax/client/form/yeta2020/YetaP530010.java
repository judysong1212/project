...
import com.app.exterms.yearendtax.client.service.yeta2020.YetaP530010ServiceAsync;
...
=====================================================**/
public  class YetaP530010   extends MSFFormPanel { 
 ...
 **/
   ...
   */
	...
	// -------------- 서비스 호출 시작 --------------
	private YetaP530010ServiceAsync yetaP530010Service = YetaP530010Service.Util.getInstance();
	// -------------- 서비스 호출 종료 --------------
 ...
 **/	  
	...
	public YetaP530010(final ActionDatabase actionDatabase, final MSFFormPanel caller) {
...
//		lcSchCenter2_1.add(taxmSt10Jong, new FormData("100%"));
	...
	private void YetaP530010FormSave() {  
...
//		ye160405Dto.setTaxmSy21Jong((Long)taxmSy21Jong.getValue());    /** column 비과세소득_Y21_비과세 : taxmSy21Jong */
		...
		yetaP530010Service.activityOnYetaP530010ToYe160405(ye160405Dto, actionDatabase, new AsyncCallback<Integer>(){
					public void onFailure(Throwable caught) {
						MessageBox.alert(MSFMainApp.MSFCONSTANTS.ExceptionTitleService(), 
	                              MSFMainApp.ADMINMESSAGES.ExceptionMessageService("activityOnYetaP530010ToYe160405(" + actionDatabase.name() + ") : " + caught), null);
					}
	...
	public void reload() {
		...
		yetaP530010Service.getYetaP530010ToYe160405List(ye160405Dto, new AsyncCallback<Ye160405DTO>(){
	...
	/** 비과세 및 감면소득 조회부 **/
	public void readYetaP530010Data(Ye160405DTO result) {
