 ...
 */
public class Ye167010BM   extends MSFSimpleBaseModel implements IsSerializable  {
    ...
    /** 일괄등록 처리   */
     public Ye167010BM(
     	...
     	values.put(ATTR_DOCTYPE,docType);
    ...
    /** get 소득세원천징수세액조정신청 : inctxWhtxTxamtMetnCd */
    ...
    /** set 문서종류 : docType */
    public void setDocType(String  docType) { set( ATTR_DOCTYPE ,docType);}
    /** get 문서종류 : docType */
    public String  getDocType() { return (String )get( ATTR_DOCTYPE );}
