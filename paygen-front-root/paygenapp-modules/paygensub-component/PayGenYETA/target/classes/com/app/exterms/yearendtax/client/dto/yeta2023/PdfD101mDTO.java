...
/**
 * @Class Name : PdfD101mVO.java
 * @Description : PdfD101m VO class
 ...
 */
public class PdfD101mDTO   implements Serializable {
    ...
    /** set 개인연금저축납입월 : pnsnAmtMn */
    private java.lang.String pnsnAmtMn;

    /** set 개인연금계좌_증권번호 : pnsnSeilNum */
    private java.math.BigDecimal pnsnSeilNum;

    /** set 개인연금월별납입금액 : pnsnMmAmt */
    private java.math.BigDecimal pnsnMmAmt;

    /** set 개인연금월별확정구분코드 : fixCd */
    ...
    public java.math.BigDecimal getPnsnSeilNum() {
        return this.pnsnSeilNum;
    }
    
    public void setPnsnSeilNum(java.math.BigDecimal pnsnSeilNum) {
