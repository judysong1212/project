...
import com.app.exterms.yearendtax.client.service.yeta2023.YetaT83011Service;
import com.app.exterms.yearendtax.client.service.yeta2023.YetaT83011ServiceAsync;
...
//import com.app.exterms.yearendtax.client.form.defs.yeta2016.YetaT83011Def;
...
=====================================================**/
public  class YetaT83011   extends MSFFormPanel {  
 ...
 **/
	...
	private  ContentPanel cpYetaT83011; 
	...
	// -------------- grid 선언 시작  ---------------	  
	private MSFGridPanel YetaT83011GridPanel;
//	private YetaT83011Def YetaT83011Def = new YetaT83011Def("YetaT83011");   //TODO 일단 화면번호로 Def
	// -------------- grid 선언 종료  ---------------
	...
	// -------------- 서비스 호출 시작 --------------
	private YetaT83011ServiceAsync yetaT83011Service = YetaT83011Service.Util.getInstance();
	// -------------- 서비스 호출 종료 --------------	 
...
//					ye162510Dto.setMnthRnttyHusCnttArea((MSFSharedUtils.allowNulls(bmMapModel.get("mnthRnttyHusCnttArea"))));    		/** column 월세주택계약면적 : mnthRnttyHusCnttArea */
				...
				yetaT83011Service.activityOnYetaT83011(listYe162510Dto, actionDatabase, new AsyncCallback<Long>(){
...
//		 }
	...
	public YetaT83011(final ActionDatabase actionDatabase, final MSFPanel caller) {
...
//		initLoad(); 	
		...
		this.actionDatabase = actionDatabase;
	 	...
	 	cpYetaT83011 = new ContentPanel();  

		createSearchForm();			//기본정보 필드를 적용
	 	createMsfGridForm();		//그리드필드
		   
		cpYetaT83011.setBodyBorder(false);
		cpYetaT83011.setBorders(false);
		cpYetaT83011.setHeaderVisible(false);
		cpYetaT83011.setSize("790px", "640px");
		   
		this.add(cpYetaT83011);
...
//		     });     
		...
		cpYetaT83011.setLayout(new FlowLayout());
...
//	      	     }
//				 
//				YetaT83011GridPanel.getMsfGrid().clearData();
//				 
//				BaseModel bmData = YetaT83011GridPanel.getTableDef().getDefaultValues();  
//		              
...
//		         
//		        YetaT83011GridPanel.getMsfGrid().getGrid().stopEditing();      
//		        YetaT83011GridPanel.getMsfGrid().getGrid().getStore().insert(bmData,0);   
//		        YetaT83011GridPanel.getMsfGrid().getGrid().startEditing(YetaT83011GridPanel.getMsfGrid().getGrid().getStore().indexOf(bmData), 0);   
//
...
//			public void handleEvent(ButtonEvent e) {
//				Iterator<BaseModel> itBm = YetaT83011GridPanel.getMsfGrid().getGrid().getSelectionModel().getSelectedItems().listIterator();
...
//		topYetaBtnBar.add(btnYetaDel);
		...
		btnYetaSave.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				setListRecord(YetaT83011GridPanel.getMsfGrid().getStore().getModifiedRecords().iterator());
				doAction(actionDatabase);
...
//			topYetaBtnBar.add(btnYetaClose);
		...
		cpYetaT83011.add(topYetaBtnBar);
...
//		YetaT83011GridPanel = new MSFGridPanel(YetaT83011Def, false, false, false, false, false);
//		YetaT83011GridPanel.setSize("790px", "420px");
//		YetaT83011GridPanel.setBorders(true);
//		YetaT83011GridPanel.setHeaderVisible(false);
...
//		
//		YetaT83011GridPanel.getGrid().getColumnModel().addAggregationRow(payrSummaryRow);  
//		
...
//		
//		YetaT83011GridPanel.getGrid().getColumnModel().addAggregationRow(payrSummaryRow1);
//		/** --- 그리드 합계 부분  종료 --- **/
		
//        cpYetaT83011.add(YetaT83011GridPanel);
...
//		
		...
		cpYetaT83011.add(layoutContainer);
		cpYetaT83011.add(fldstNewFieldset_1);
	...
	public void reload() {
			...
			YetaT83011GridPanel.getTableDef().setTableColumnFilters(filters);
			YetaT83011GridPanel.getTableDef().addColumnFilter("yrtxBlggYr", MSFSharedUtils.allowNulls(srhYrtxBlggYr.getValue())
...
//					, SimpleColumnFilter.OPERATOR_EQUALS);//연말정산귀속년도
			YetaT83011GridPanel.getTableDef().addColumnFilter("clutSeptCd", MSFSharedUtils.getSelectedComboValue(srhClutSeptCd,"commCd")
					, SimpleColumnFilter.OPERATOR_EQUALS);//정산구분
			YetaT83011GridPanel.getTableDef().addColumnFilter("systemkey", MSFSharedUtils.allowNulls(systemkey.getValue())
					, SimpleColumnFilter.OPERATOR_EQUALS);//시스템키
		 
			YetaT83011GridPanel.reload();
