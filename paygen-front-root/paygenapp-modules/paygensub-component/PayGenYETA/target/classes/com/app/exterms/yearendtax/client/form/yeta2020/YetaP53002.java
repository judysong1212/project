...
import com.app.exterms.yearendtax.client.dto.yeta2020.Ye164010BM;
import com.app.exterms.yearendtax.client.dto.yeta2020.Ye164010DTO;
import com.app.exterms.yearendtax.client.form.defs.yeta2020.Ye164010Def;
import com.app.exterms.yearendtax.client.service.yeta2020.YetaP53002Service;
import com.app.exterms.yearendtax.client.service.yeta2020.YetaP53002ServiceAsync;
...
=====================================================**/
public  class YetaP53002 extends MSFFormPanel {  
 ...
 **/
	...
	// -------------- grid 선언 시작  ---------------	  
	private MSFGridPanel YetaP53002GridPanel;
	private Ye164010Def YetaP53002ToYe164010Def  = new Ye164010Def("YetaP53002");//의료비내역 그리드 테이블 컬럼 define 
	// -------------- grid 선언 종료  ---------------	
 ...
 **/ 
	...
	// -------------- 서비스 호출 시작 --------------
	private YetaP53002ServiceAsync yetaP53002Service = YetaP53002Service.Util.getInstance();
	// -------------- 서비스 호출 종료 --------------	 	
	...
	private void YetaP53002FormSave() {
		...
		if (MSFSharedUtils.paramNotNull(records)) {
			...
			if (dataChk) {
				...
				yetaP53002Service.activityOnYetaP53002ToYe164010(listYe164010Dto, actionDatabase, new AsyncCallback<Long>(){
					public void onFailure(Throwable caught) {
						MessageBox.alert(MSFMainApp.MSFCONSTANTS.ExceptionTitleService()
								, MSFMainApp.ADMINMESSAGES.ExceptionMessageService("activityOnYetaP53002ToYe164010(" + actionDatabase.name() + ") : " + caught), null);
						}
	...
	public YetaP53002(final ActionDatabase actionDatabase, final MSFPanel caller) {
	...
	private void createSearchForm() {
				...
				MessageBox.confirm("삭제", "선택하신 의료비 내용을 삭제하시겠습니까?",new Listener<MessageBoxEvent>(){
					...
					public void handleEvent(MessageBoxEvent be) {
						if(Dialog.YES.equals(be.getButtonClicked().getItemId())){
							...
							Iterator<BaseModel> itBm = YetaP53002GridPanel.getMsfGrid().getGrid().getSelectionModel().getSelectedItems().listIterator();
		...
		btnYetaSave.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				setListRecord(YetaP53002GridPanel.getMsfGrid().getStore().getModifiedRecords().iterator());
...
//			BaseModel bmData = YetaP53002GridPanel.getMsfGrid().getStore().getModels().get(0);  
//			if (MSFSharedUtils.paramNotNull(bmData)){
				// TODO Auto-generated method stub
				IColumnFilter filters = null;
				
				YetaP53002GridPanel.getTableDef().setTableColumnFilters(filters);
				YetaP53002GridPanel.getTableDef().addColumnFilter("yrtxBlggYr", MSFSharedUtils.allowNulls(srhYrtxBlggYr.getValue())
	...
	//					, SimpleColumnFilter.OPERATOR_EQUALS);//연말정산귀속년도
				YetaP53002GridPanel.getTableDef().addColumnFilter("clutSeptCd", MSFSharedUtils.getSelectedComboValue(srhClutSeptCd,"commCd")
						, SimpleColumnFilter.OPERATOR_EQUALS);//정산구분
				YetaP53002GridPanel.getTableDef().addColumnFilter("systemkey", MSFSharedUtils.allowNulls(systemkey.getValue())
						, SimpleColumnFilter.OPERATOR_EQUALS);//시스템키
			 
				YetaP53002GridPanel.reload();
...
//			actionDatabase = ActionDatabase.READ;
	...
	private void createMsfGridForm() {
		...
		YetaP53002GridPanel = new MSFGridPanel(YetaP53002ToYe164010Def, false,false, false, false, false);
		YetaP53002GridPanel.setSize("780px", "390px");
		YetaP53002GridPanel.setBorders(true);
		YetaP53002GridPanel.setBodyBorder(false);
		YetaP53002GridPanel.setHeaderVisible(false);
		YetaP53002GridPanel.getBottomComponent().setVisible(true);
		...
		YetaP53002GridPanel.getGrid().getColumnModel().addAggregationRow(payrSummaryRow);  
		/** --- 그리드 합계 부분  시작 --- **/
			
		gridFieldSet.add(YetaP53002GridPanel);
