...
public class Ye161080BM   extends MSFSimpleBaseModel implements IsSerializable  {
    ...
    public static final String ATTR_RTPNISAUSEAMT = "rtpnIsaUseAmt";

    /** set 연금계좌_ISA_퇴직연금공제대상금액 : rtpnDdcIsaTrgtAmt */
    public static final String ATTR_RTPNDDCISATRGTAMT = "rtpnDdcIsaTrgtAmt";

    /** set 연금계좌_ISA_퇴직연금공제세액 : rtpnDdcIsaAmt */
    public static final String ATTR_RTPNDDCISAAMT = "rtpnDdcIsaAmt";
    
    /** set 연금계좌_ISA_연금저축납입금액 : pnsnSvngIsaUseAmt */
    public static final String ATTR_PNSNSVNGISAUSEAMT = "pnsnSvngIsaUseAmt";

    /** set 연금계좌_ISA_연금저축공제대상금액 : pnsnSvngDdcIsaTrgtAmt */
    public static final String ATTR_PNSNSVNGDDCISATRGTAMT = "pnsnSvngDdcIsaTrgtAmt";

    /** set 연금계좌_ISA_연금저축공제세액 : pnsnSvngDdcIsaAmt */
    public static final String ATTR_PNSNSVNGDDCISAAMT = "pnsnSvngDdcIsaAmt";
    
    /** set 의료비_실손보험금보전액 : medxpsUseAmtSum */
    public static final String ATTR_MEDXPSUSEAMTSUM = "medxpsUseAmtSum";
    ...
    /** 일괄등록 처리   */
     public Ye161080BM(
    		...
    		, String  revnAddr
    		, Long  rtpnIsaUseAmt 
    		, Long  rtpnDdcIsaTrgtAmt 
    		, Long  rtpnDdcIsaAmt
    		, Long  pnsnSvngIsaUseAmt 
    		, Long  pnsnSvngDdcIsaTrgtAmt 
    		, Long  pnsnSvngDdcIsaAmt
    		, Long  medxpsUseAmtSum
    		) { 
     	...
     	values.put(ATTR_RTPNISAUSEAMT,rtpnIsaUseAmt);
     	values.put(ATTR_RTPNDDCISATRGTAMT,rtpnDdcIsaTrgtAmt);
     	values.put(ATTR_RTPNDDCISAAMT,rtpnDdcIsaAmt); 
     	values.put(ATTR_PNSNSVNGISAUSEAMT,pnsnSvngIsaUseAmt);
     	values.put(ATTR_PNSNSVNGDDCISATRGTAMT,pnsnSvngDdcIsaTrgtAmt);
     	values.put(ATTR_PNSNSVNGDDCISAAMT,pnsnSvngDdcIsaAmt); 
     	values.put(ATTR_MEDXPSUSEAMTSUM,medxpsUseAmtSum);} 
    ...
    /** set 연금계좌_ISA_퇴직연금납입금액 : rtpnIsaUseAmt */
    public void setRtpnIsaUseAmt(Long  rtpnIsaUseAmt) { set( ATTR_RTPNISAUSEAMT ,rtpnIsaUseAmt);}
    /** get 연금계좌_ISA_퇴직연금납입금액 : rtpnIsaUseAmt */
    public Long  getRtpnIsaUseAmt() { return (Long )get( ATTR_RTPNISAUSEAMT );}
    /** set 연금계좌_ISA_퇴직연금공제대상금액 : rtpnDdcIsaTrgtAmt */
    public void setRtpnDdcIsaTrgtAmt(Long  rtpnDdcIsaTrgtAmt) { set( ATTR_RTPNDDCISATRGTAMT ,rtpnDdcIsaTrgtAmt);}
    /** get 연금계좌_ISA_퇴직연금공제대상금액 : rtpnDdcIsaTrgtAmt */
    public Long  getRtpnDdcIsaTrgtAmt() { return (Long )get( ATTR_RTPNDDCISATRGTAMT );}
    /** set 연금계좌_ISA_퇴직연금공제세액 : rtpnDdcAmt */
    public void setRtpnDdcIsaAmt(Long  rtpnDdcIsaAmt) { set( ATTR_RTPNDDCISAAMT ,rtpnDdcIsaAmt);}
    /** get 연금계좌_ISA_퇴직연금공제세액 : rtpnDdcIsaAmt */
    public Long  getRtpnDdcIsaAmt() { return (Long )get( ATTR_RTPNDDCISAAMT );}
    
    
    /** set 연금계좌_ISA_연금저축납입금액 : pnsnSvngIsaUseAmt */
    public void setPnsnSvngIsaUseAmt(Long  pnsnSvngIsaUseAmt) { set( ATTR_PNSNSVNGISAUSEAMT ,pnsnSvngIsaUseAmt);}
    /** get 연금계좌_ISA_연금저축납입금액 : pnsnSvngIsaUseAmt */
    public Long  getPnsnSvngIsaUseAmt() { return (Long )get( ATTR_PNSNSVNGISAUSEAMT );}
    /** set 연금계좌_ISA_연급저축공제대상금액 : pnsnSvngDdcIsaTrgtAmt */
    public void setPnsnSvngDdcIsaTrgtAmt(Long  pnsnSvngDdcIsaTrgtAmt) { set( ATTR_PNSNSVNGDDCISATRGTAMT ,pnsnSvngDdcIsaTrgtAmt);}
    /** get 연금계좌_ISA_연금저축공제대상금액 : pnsnSvngDdcIsaTrgtAmt */
    public Long  getPnsnSvngDdcIsaTrgtAmt() { return (Long )get( ATTR_PNSNSVNGDDCISATRGTAMT );}
    /** set 연금계좌_ISA_연금저축공제세액 : pnsnSvngDdcIsaAmt */
    public void setPnsnSvngDdcIsaAmt(Long  pnsnSvngDdcIsaAmt) { set( ATTR_PNSNSVNGDDCISAAMT ,pnsnSvngDdcIsaAmt);}
    /** get 연금계좌_ISA_연금저축공제세액 : pnsnSvngDdcIsaAmt */
    public Long  getPnsnSvngDdcIsaAmt() { return (Long )get( ATTR_PNSNSVNGDDCISAAMT );}
    
    
    /** set 의료비_실손보험금보전액  : medxpsUseAmtSum  */
    public void setMedxpsUseAmtSum (Long  medxpsUseAmtSum) { set( ATTR_MEDXPSUSEAMTSUM ,medxpsUseAmtSum);}
    /** get 의료비_실손보험금보전액  : medxpsUseAmtSum  */
    public Long  getMedxpsUseAmtSum () { return (Long )get( ATTR_MEDXPSUSEAMTSUM );}
