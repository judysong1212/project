...
import com.app.exterms.yearendtax.client.dto.yeta2023.Ye169010BM;
...
public class Ye169010Def extends TableDef implements YetaDaoConstants {
	...
	public Ye169010Def(String chkPayrDef) {
		...
		if("Yeta8300".equals(chkPayrDef)) { 
			setTitle("");
	        setDaoClass("");
	        setCustomListMethod("");
	        setCustomListMethod(CLASS_YETA8300_TO_YE169010_SUBTAX_LIST);
	  	  	setAutoFillGrid(false);
	        setShowFilterToolbar(false);   
	        setCheckBoxOnGridRows(true); 
		    setEditFieldGrid(false);
		    setColumnsDefinition(getYeta8300ToYe169010ColumnsList());
    ...
    private List<ColumnDef> getYeta8300ToYe169010ColumnsList(){
        row = 0;
        List<ColumnDef> listColumnDefs = new ArrayList<ColumnDef>(); 
