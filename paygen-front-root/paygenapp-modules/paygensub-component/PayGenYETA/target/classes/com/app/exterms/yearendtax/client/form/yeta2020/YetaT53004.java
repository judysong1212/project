...
=====================================================**/
public  class YetaT53004   extends MSFFormPanel {  
 ...
 **/
	...
	private  ContentPanel cpYetaT53004; 
	...
	// -------------- grid 선언 시작  ---------------	  
	private MSFGridPanel YetaT53004GridPanel;
	private MSFGridPanel ye162530GridPanel; //임대차계약그리드
	private MSFGridPanel ye162520GridPanel; // 금전소비대차그리드
	private Ye162520Def ye162520Def = new Ye162520Def("YetaT53004");   
	private Ye162530Def ye162530Def = new Ye162530Def("YetaT53004");   
...
//		 }
	...
	public YetaT53004(final ActionDatabase actionDatabase, final MSFPanel caller) {
...
//		initLoad(); 	
		...
		this.actionDatabase = actionDatabase;
	 	...
	 	cpYetaT53004 = new ContentPanel();  

		createSearchForm();			//기본정보 필드를 적용
	 	createMsfGridForm();		//그리드필드
		   
		cpYetaT53004.setBodyBorder(false);
		cpYetaT53004.setBorders(false);
		cpYetaT53004.setHeaderVisible(false);
		cpYetaT53004.setSize("790px", "640px");
		   
		this.add(cpYetaT53004);
...
//		     });     
		...
		cpYetaT53004.setLayout(new FlowLayout());
...
//	      	     }
//				 
//				YetaT53004GridPanel.getMsfGrid().clearData();
//				 
//				BaseModel bmData = YetaT53004GridPanel.getTableDef().getDefaultValues();  
//		              
...
//		         
//		        YetaT53004GridPanel.getMsfGrid().getGrid().stopEditing();      
//		        YetaT53004GridPanel.getMsfGrid().getGrid().getStore().insert(bmData,0);   
//		        YetaT53004GridPanel.getMsfGrid().getGrid().startEditing(YetaT53004GridPanel.getMsfGrid().getGrid().getStore().indexOf(bmData), 0);   
//
...
//			public void handleEvent(ButtonEvent e) {
//				Iterator<BaseModel> itBm = YetaT53004GridPanel.getMsfGrid().getGrid().getSelectionModel().getSelectedItems().listIterator();
...
//			public void handleEvent(ButtonEvent e) {
//				setListRecord(YetaT53004GridPanel.getMsfGrid().getStore().getModifiedRecords().iterator());
//				doAction(actionDatabase);
//
//				if ((ActionDatabase.INSERT).equals(actionDatabase)) {
//					actionDatabase = ActionDatabase.INSERT;
...
//				
//		cpYetaT53004.add(topYetaBtnBar);
...
//		
//		YetaT53004GridPanel.getGrid().getColumnModel().addAggregationRow(payrSummaryRow);  
//		
...
//		
//		YetaT53004GridPanel.getGrid().getColumnModel().addAggregationRow(payrSummaryRow1);
//		/** --- 그리드 합계 부분  종료 --- **/
		
//        cpYetaT53004.add(YetaT53004GridPanel);
		...
		cpYetaT53004.add(fldstNewFieldset);
		cpYetaT53004.add(fldstNewFieldset1);
		cpYetaT53004.add(fldstNewFieldset_1);
	...
	public void reload() {
			...
			YetaT53004GridPanel.getTableDef().setTableColumnFilters(filters);
			YetaT53004GridPanel.getTableDef().addColumnFilter("yrtxBlggYr", MSFSharedUtils.allowNulls(srhYrtxBlggYr.getValue())
...
//					, SimpleColumnFilter.OPERATOR_EQUALS);//연말정산귀속년도
			YetaT53004GridPanel.getTableDef().addColumnFilter("clutSeptCd", MSFSharedUtils.getSelectedComboValue(srhClutSeptCd,"commCd")
					, SimpleColumnFilter.OPERATOR_EQUALS);//정산구분
			YetaT53004GridPanel.getTableDef().addColumnFilter("systemkey", MSFSharedUtils.allowNulls(systemkey.getValue())
					, SimpleColumnFilter.OPERATOR_EQUALS);//시스템키
		 
			YetaT53004GridPanel.reload();
