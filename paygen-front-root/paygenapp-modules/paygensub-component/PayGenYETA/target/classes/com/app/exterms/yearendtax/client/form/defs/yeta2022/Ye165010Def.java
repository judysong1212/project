...
public class Ye165010Def  extends TableDef implements YetaDaoConstants {
	...
	public Ye165010Def(String chkPayrDef) {
		...
		if ("YetaP73003".equals(chkPayrDef)) {

			setDaoClass("");
			setCustomListMethod(CLASS_YETAP73003_TO_YE165010_DATA_LIST);
			setAutoFillGrid(false);
			setShowFilterToolbar(false);
			setCheckBoxOnGridRows(true);
			setEditableGrid(true);
			setEditFieldGrid(true);
			setColumnsDefinition(getYetaP73003ToYe165010ColumnsList());
    ...
    private List<ColumnDef> getYetaP73003ToYe165010ColumnsList(){
        row = 0;
        List<ColumnDef> listColumnDefs = new ArrayList<ColumnDef>(); 
