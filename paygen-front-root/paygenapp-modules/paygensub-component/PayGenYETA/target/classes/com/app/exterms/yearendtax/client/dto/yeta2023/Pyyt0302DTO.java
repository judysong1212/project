 ...
 */
public class Pyyt0302DTO  implements Serializable {
    ...
    private Long pyytPymtDducSum;

    /** set 지급공제과세금액 : pyytPyddTxtnAmnt */
    private Long pyytPyddTxtnAmnt;

    /** set 지급공제비과세금액 : pyytPyddFreeDtySum */
    private Long pyytPyddFreeDtySum;
	...
	public Long getPyytPymtDducSum() {
		return pyytPymtDducSum;
	}

	public void setPyytPymtDducSum(Long pyytPymtDducSum) {
		this.pyytPymtDducSum = pyytPymtDducSum;
	}

	public Long getPyytPyddTxtnAmnt() {
		return pyytPyddTxtnAmnt;
	}

	public void setPyytPyddTxtnAmnt(Long pyytPyddTxtnAmnt) {
		this.pyytPyddTxtnAmnt = pyytPyddTxtnAmnt;
	}

	public Long getPyytPyddFreeDtySum() {
		return pyytPyddFreeDtySum;
	}

	public void setPyytPyddFreeDtySum(Long pyytPyddFreeDtySum) {
