...
import com.app.exterms.yearendtax.client.dto.yeta2022.Ye169010BM;
...
public class Ye169010Def extends TableDef implements YetaDaoConstants {
	...
	public Ye169010Def(String chkPayrDef) {
		...
		if("Yeta7300".equals(chkPayrDef)) { 
			setTitle("");
	        setDaoClass("");
	        setCustomListMethod("");
	        setCustomListMethod(CLASS_YETA7300_TO_YE169010_SUBTAX_LIST);
	  	  	setAutoFillGrid(false);
	        setShowFilterToolbar(false);   
	        setCheckBoxOnGridRows(true); 
		    setEditFieldGrid(false);
		    setColumnsDefinition(getYeta7300ToYe169010ColumnsList());
    ...
    private List<ColumnDef> getYeta7300ToYe169010ColumnsList(){
        row = 0;
        List<ColumnDef> listColumnDefs = new ArrayList<ColumnDef>(); 
