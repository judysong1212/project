...
=====================================================**/
public  class YetaP420001   extends MSFFormPanel {  
	...
	private TabPanel tabYetaP420001;
	 ...
	 *~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ 		
	 **/ 		    
	public YetaP420001(final ActionDatabase actionDatabase, final MSFPanel caller) {
	...
	private void createStandardForm() {
		...
		tabYetaP420001 = new TabPanel(); // 인사탭정보설정을 위한 tab
		tabYetaP420001.setStyleAttribute("paddingTop", "3px");
		tabYetaP420001.setStyleAttribute("paddingLeft", "2px");
		// tabsBass0350.setMinTabWidth(80);
		tabYetaP420001.setAutoWidth(false);
		// tabsBass0350.setResizeTabs(true);
		tabYetaP420001.setAnimScroll(true);
		tabYetaP420001.setTabScroll(true);
		tabYetaP420001.setPlain(true);
		tabYetaP420001.setSize(885, 595);
		...
		tabYetaP420001.add(item_PDF_A102Y);
		...
		tabYetaP420001.add(item_PDF_B101Y);
		...
		tabYetaP420001.add(item_PDF_C101Y);
		...
		tabYetaP420001.add(item_PDF_C202Y);
		...
		tabYetaP420001.add(item_PDF_C301Y);
		...
		tabYetaP420001.add(item_PDF_C401Y);
		...
		tabYetaP420001.add(item_PDF_D101Y);
		...
		tabYetaP420001.add(item_PDF_E102Y);
		...
		tabYetaP420001.add(item_PDF_F102Y);
		...
		tabYetaP420001.add(item_PDF_G107Y);
		...
		tabYetaP420001.add(item_PDF_G207Y);
		...
		tabYetaP420001.add(item_PDF_G307Y);
		...
		tabYetaP420001.add(item_PDF_G407Y);
		...
		tabYetaP420001.add(item_PDF_J101Y);
		...
		tabYetaP420001.add(item_PDF_J203Y);
		...
		tabYetaP420001.add(item_PDF_J301Y);
		...
		tabYetaP420001.add(item_PDF_J401Y);
		...
		tabYetaP420001.add(item_PDF_K101Y);
		...
		tabYetaP420001.add(item_PDF_L102Y);
		...
		tabYetaP420001.add(item_PDF_N101Y);
		...
		tabYetaP420001.add(item_PDF_O101Y);
		...
		tabYetaP420001.add(item_PDF_P102Y);

		fieldSet.add(tabYetaP420001);
	...
	private void formInit() {
		...
		//		YetaP420001GridPanel.getMsfGrid().clearData();
