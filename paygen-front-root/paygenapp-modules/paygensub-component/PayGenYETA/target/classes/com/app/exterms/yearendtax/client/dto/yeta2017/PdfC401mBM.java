 ...
 */
public class PdfC401mBM   extends MSFSimpleBaseModel implements IsSerializable  {
    ...
    /** set 교육비월별납입금액 : schUniMnAmt */
    public void setSchUniMnAmt(BigDecimal  schUniMnAmt) { set( ATTR_SCHUNIMNAMT ,schUniMnAmt);}
    /** get 교육비월별납입금액 : schUniMnAmt */
    public BigDecimal  getSchUniMnAmt() { return (BigDecimal )get( ATTR_SCHUNIMNAMT );}
    /** set 입력자 : kybdr */
