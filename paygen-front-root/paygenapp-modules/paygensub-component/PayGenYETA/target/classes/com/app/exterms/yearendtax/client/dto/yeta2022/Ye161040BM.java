...
public class Ye161040BM   extends MSFSimpleBaseModel implements IsSerializable  {
    ...
    public static final String ATTR_ZRTDDDCTRGTAMT = "zrtdDdcTrgtAmt";
    ...
    //2022연말정산_추가
    public static final String ATTR_TOTCRDCPRESUM = "totCrdcPreSum";
    
    public static final String ATTR_TOTCRDCCURRSUM = "totCrdcCurrSum";
    
    public static final String ATTR_TOTTDMRPRESUM = "totTdmrPreSum";
    
    public static final String ATTR_TOTTDMRCURRSUM = "totTdmrCurrSum";
    
    public static final String ATTR_TFHYPBTAMT = "tfhyPbtAmt";
    
    public static final String ATTR_SHFYPBTAMT = "shfyPbtAmt";
    //2022연말정산_추가
    ...
    /** 일괄등록 처리   */
     public Ye161040BM(
     	...
     	values.put(ATTR_MCURUITRGTAMT, mcurUiTrgtAmt);
     	...
     	values.put(ATTR_ZRTDDDCTRGTAMT,zrtdDdcTrgtAmt);
     	...
     	values.put(ATTR_TOTCRDCPRESUM,totCrdcPreSum);
     	values.put(ATTR_TOTCRDCCURRSUM,totCrdcCurrSum);
     	values.put(ATTR_TOTTDMRPRESUM,totTdmrPreSum);
     	values.put(ATTR_TOTTDMRCURRSUM,totTdmrCurrSum);
     	values.put(ATTR_TFHYPBTAMT,tfhyPbtAmt);
     	values.put(ATTR_SHFYPBTAMT,shfyPbtAmt);
    ...
    /** set 제로페이_전통대중도서제외금액 : zrtdDdcTrgtAmt */
    public void setZrtdDdcTrgtAmt(Long  zrtdDdcTrgtAmt) { set( ATTR_ZRTDDDCTRGTAMT ,zrtdDdcTrgtAmt);}
    /** get 제로페이_전통대중도서제외금액 : zrtdDdcTrgtAmt */
    public Long  getZrtdDdcTrgtAmt() { return (Long )get( ATTR_ZRTDDDCTRGTAMT );}
    /** set 전통시작사용금액 : tdmrDdcTrgtAmt */
    ...
    public void setTotCrdcPreSum(Long  totCrdcPreSum) { set( ATTR_TOTCRDCPRESUM ,totCrdcPreSum);}
    public Long  getTotCrdcPreSum() { return (Long )get( ATTR_TOTCRDCPRESUM );}
    
    public void setTotCrdcCurrSum(Long  totCrdcCurrSum) { set( ATTR_TOTCRDCCURRSUM ,totCrdcCurrSum);}
    public Long  getTotCrdcCurrSum() { return (Long )get( ATTR_TOTCRDCCURRSUM );}
    
    public void setTotTdmrPreSum(Long  totTdmrPreSum) { set( ATTR_TOTTDMRPRESUM ,totTdmrPreSum);}
    public Long  getTotTdmrPreSum() { return (Long )get( ATTR_TOTTDMRPRESUM );}
    
    public void setTotTdmrCurrSum(Long  totTdmrCurrSum) { set( ATTR_TOTTDMRCURRSUM ,totTdmrCurrSum);}
    public Long  getTotTdmrCurrSum() { return (Long )get( ATTR_TOTTDMRCURRSUM );}
    
    public void setTfhyPbtAmt(Long  tfhyPbtAmt) { set( ATTR_TFHYPBTAMT ,tfhyPbtAmt);}
    public Long  getTfhyPbtAmt() { return (Long )get( ATTR_TFHYPBTAMT );}
    
    public void setShfyPbtAmt(Long  shfyPbtAmt) { set( ATTR_SHFYPBTAMT ,shfyPbtAmt);}
    public Long  getShfyPbtAmt() { return (Long )get( ATTR_SHFYPBTAMT );}
