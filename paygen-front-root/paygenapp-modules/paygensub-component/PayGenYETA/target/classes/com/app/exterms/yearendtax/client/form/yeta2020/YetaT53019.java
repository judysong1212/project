...
import com.app.exterms.yearendtax.client.service.yeta2020.YetaT53019Service;
import com.app.exterms.yearendtax.client.service.yeta2020.YetaT53019ServiceAsync;
...
=====================================================**/
public  class YetaT53019   extends MSFFormPanel {  
 ...
 **/
	...
	private  ContentPanel cpYetaT53019; 
	...
	// -------------- grid 선언 시작  ---------------	  
	private MSFGridPanel YetaT53019GridPanel;
	private Ye162510Def YetaT53019ToYe162510Def = new Ye162510Def("YETAT13019");   //월세새액공제명세 그리드 테이블 컬럼 define
	// -------------- grid 선언 종료  ---------------
	...
	// -------------- 서비스 호출 시작 --------------
	private YetaT53019ServiceAsync yetaT53019Service = YetaT53019Service.Util.getInstance();
	// -------------- 서비스 호출 종료 --------------	 
 ...
 **/ 
     ...
     */ 
		...
		private void YetaT53019FormSave() {  
...
//					ye162510Dto.setMnthRnttyHusCnttArea((MSFSharedUtils.allowNulls(bmMapModel.get("mnthRnttyHusCnttArea"))));    		/** column 월세주택계약면적 : mnthRnttyHusCnttArea */
				...
				yetaT53019Service.activityOnYetaT53019ToYe162510(listYe162510Dto, actionDatabase, new AsyncCallback<Long>(){
					
					public void onFailure(Throwable caught) {
						MessageBox.alert(MSFMainApp.MSFCONSTANTS.ExceptionTitleService(), 
		                             MSFMainApp.ADMINMESSAGES.ExceptionMessageService("YetaT53019FormSave(" + actionDatabase.name() + ") : " + caught), null);
					}
...
//		 }
	...
	public YetaT53019(final ActionDatabase actionDatabase, final MSFPanel caller) {
...
//		initLoad(); 	
		...
		this.actionDatabase = actionDatabase;
	 	...
	 	cpYetaT53019 = new ContentPanel();  

		createSearchForm();			//기본정보 필드를 적용
	 	createMsfGridForm();		//그리드필드
		   
		cpYetaT53019.setBodyBorder(false);
		cpYetaT53019.setBorders(false);
		cpYetaT53019.setHeaderVisible(false);
		cpYetaT53019.setSize("790px", "640px");
		   
		this.add(cpYetaT53019);
...
//		     });     
		...
		cpYetaT53019.setLayout(new FlowLayout());
		...
		btnYetaNew.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				...
				YetaT53019GridPanel.getMsfGrid().clearData();
				 
				BaseModel bmData = YetaT53019GridPanel.getTableDef().getDefaultValues();  
		        ...
		        YetaT53019GridPanel.getMsfGrid().getGrid().stopEditing();      
		        YetaT53019GridPanel.getMsfGrid().getGrid().getStore().insert(bmData,0);   
		        YetaT53019GridPanel.getMsfGrid().getGrid().startEditing(YetaT53019GridPanel.getMsfGrid().getGrid().getStore().indexOf(bmData), 0);   
...
//				doAction(actionDatabase);
		...
		btnYetaDel.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				Iterator<BaseModel> itBm = YetaT53019GridPanel.getMsfGrid().getGrid().getSelectionModel().getSelectedItems().listIterator();
		...
		btnYetaSave.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				setListRecord(YetaT53019GridPanel.getMsfGrid().getStore().getModifiedRecords().iterator());
				doAction(actionDatabase);
...
//			topYetaBtnBar.add(btnYetaClose);
		...
		cpYetaT53019.add(topYetaBtnBar);
...
//		cpYetaT53019.add(topYetaBtnBar);
		...
		YetaT53019GridPanel = new MSFGridPanel(YetaT53019ToYe162510Def, false, false, false, false, false);
		YetaT53019GridPanel.setSize("790px", "200px");
		YetaT53019GridPanel.setBorders(true);
		YetaT53019GridPanel.setHeaderVisible(false);
...
//		
//		YetaT53019GridPanel.getGrid().getColumnModel().addAggregationRow(payrSummaryRow);  
//		/** --- 그리드 합계 부분  종료 --- **/
		
//   	cpYetaT53019.add(YetaT53019GridPanel);
		...
		fldstNewFieldset.add(YetaT53019GridPanel);
		cpYetaT53019.add(fldstNewFieldset);
		cpYetaT53019.add(layoutContainer1);
		cpYetaT53019.add(fldstNewFieldset_1);
	...
	public void reload() {
			...
			YetaT53019GridPanel.getTableDef().setTableColumnFilters(filters);
			YetaT53019GridPanel.getTableDef().addColumnFilter("yrtxBlggYr", MSFSharedUtils.allowNulls(srhYrtxBlggYr.getValue())
...
//					, SimpleColumnFilter.OPERATOR_EQUALS);//연말정산귀속년도
			YetaT53019GridPanel.getTableDef().addColumnFilter("clutSeptCd", MSFSharedUtils.getSelectedComboValue(srhClutSeptCd,"commCd")
					, SimpleColumnFilter.OPERATOR_EQUALS);//정산구분
			YetaT53019GridPanel.getTableDef().addColumnFilter("systemkey", MSFSharedUtils.allowNulls(systemkey.getValue())
					, SimpleColumnFilter.OPERATOR_EQUALS);//시스템키
		 
			YetaT53019GridPanel.reload();
