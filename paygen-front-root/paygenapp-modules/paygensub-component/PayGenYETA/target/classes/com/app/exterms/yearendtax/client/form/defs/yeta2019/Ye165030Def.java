...
public class Ye165030Def  extends TableDef implements YetaDaoConstants {
	...
	public Ye165030Def(String chkPayrDef) {
		...
		if ("YetaP43001".equals(chkPayrDef)) {
			setDaoClass("");
			 setCustomListMethod(CLASS_YETAP43001_TO_YE165030_DATA_LIST);
			setAutoFillGrid(false);
			setShowFilterToolbar(false);
			setCheckBoxOnGridRows(true);
			setEditableGrid(true);
			setEditFieldGrid(true);
			setColumnsDefinition(getYetaP33001ToYe165030ColumnsList());
    ...
    private List<ColumnDef> getYetaP33001ToYe165030ColumnsList(){
        row = 0;
        List<ColumnDef> listColumnDefs = new ArrayList<ColumnDef>(); 
