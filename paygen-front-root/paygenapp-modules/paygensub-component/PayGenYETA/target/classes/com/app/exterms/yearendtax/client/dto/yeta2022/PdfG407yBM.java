 ...
 */
public class PdfG407yBM   extends MSFSimpleBaseModel implements IsSerializable  {
    ...
    /** 일괄등록 처리   */
     public PdfG407yBM(
     	...
     	values.put(ATTR_ZEROAMTSUM,zeroAmtSum);
    ...
    /** get 제로페이종류코드 : usePlaceCd */
    public String  getUsePlaceCd() { return (String )get( ATTR_USEPLACECD );}
    /** set 제로페이공제대상금액합계 : zeroAmtSum */
    public void setZeroAmtSum(BigDecimal  zeroAmtSum) { set( ATTR_ZEROAMTSUM ,zeroAmtSum);}
    /** get 제로페이공제대상금액합계 : zeroAmtSum */
    public BigDecimal  getZeroAmtSum() { return (BigDecimal )get( ATTR_ZEROAMTSUM );}
    /** set pdf 소득공제자료적용여부 : pdfDatAppYn */
