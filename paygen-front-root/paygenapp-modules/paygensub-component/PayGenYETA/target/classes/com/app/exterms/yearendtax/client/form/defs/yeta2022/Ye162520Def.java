...
public class Ye162520Def extends TableDef implements YetaDaoConstants{
	...
	public Ye162520Def(String chkDef) {
		...
		if ("YetaP73004".equals(chkDef)) {
			...
			setTitle("");
			setDaoClass("");
			setCustomListMethod(CLASS_YETAP73004_TO_YE162520_DATA_LIST);
			setAutoFillGrid(false);
			setShowFilterToolbar(false);
			setCheckBoxOnGridRows(true);
			setEditFieldGrid(true);
			setColumnsDefinition(getColumnsListYetaP73004ToYE162520());
...
//        		setReadOnly(true);
	...
	private List<ColumnDef> getColumnsListYetaP73004ToYE162520() {
