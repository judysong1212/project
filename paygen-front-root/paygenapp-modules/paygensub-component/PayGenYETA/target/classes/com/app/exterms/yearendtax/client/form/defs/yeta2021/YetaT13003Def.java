...
import com.app.exterms.yearendtax.client.dto.yeta2021.YetaT13003BM;
import com.app.exterms.yearendtax.shared.YetaDaoConstants;
import com.app.smrmf.core.msfmainapp.client.def.ColumnDef;
import com.app.smrmf.core.msfmainapp.client.def.TableDef;

public class YetaT13003Def extends TableDef implements YetaDaoConstants{
	private int row = 0;
	final PrgmComBass0300DTO sysComBass0300Dto;
	
	public YetaT13003Def(String chkDef) {
		
		sysComBass0300Dto = new PrgmComBass0300DTO();
		
		if("YetaT13003".equals(chkDef)) { //TODO 테이블 정의되면 다시 구현.
			setTitle("");
	        setDaoClass("");
		    ...
		    setColumnsDefinition(getColumnsListYetaT13003()); 
		}else {
...
//
	...
	private List<ColumnDef> getColumnsListYetaT13003() { //TODO BM 다시 정의.
        List<ColumnDef> listColumnDefs = new ArrayList<ColumnDef>();
        
        /** column SYSTEMKEY : systemkey */
        listColumnDefs.add(new ColumnDef("SYSTEMKEY", YetaT13003BM.ATTR_SYSTEMKEY, ColumnDef.TYPE_STRING , 90, true, false, true){
        	{
        ...
        /** column 사업장코드 : dpobCd */
        listColumnDefs.add(new ColumnDef("사업장코드", YetaT13003BM.ATTR_DPOBCD, ColumnDef.TYPE_STRING , 90, true, false, true){
        	{
        ...
        /** column 번호 : rNum */
        listColumnDefs.add(new ColumnDef("번호", YetaT13003BM.ATTR_RNUM, ColumnDef.TYPE_STRING , 50, true, false, true){
        	{

        	}
        });
        /** column  항목명 : item01 */
        listColumnDefs.add(new ColumnDef("항목명", YetaT13003BM.ATTR_ITEM01, ColumnDef.TYPE_STRING , 252, true, true, true){
        	{

        	}
        });
        /** column 국세청자료 : item02 */
        listColumnDefs.add(new ColumnDef("국세청자료", YetaT13003BM.ATTR_ITEM02, ColumnDef.TYPE_STRING , 252, true, true, true){
        	{

        	}
        });
        /** column 그밖의자료 : item03 */
        listColumnDefs.add(new ColumnDef("그밖의자료", YetaT13003BM.ATTR_ITEM03, ColumnDef.TYPE_STRING , 252, true, true, true){
        	{

        	}
        });
//        /** column 코드 : mnthRnttyLehdrNm */
//        listColumnDefs.add(new ColumnDef("코드", YetaT13003BM.ATTR_MNTHRNTTYLEHDRNM, ColumnDef.TYPE_STRING , 100, true, true, true){
//        	{
//
//        	}
//        });
//        /** column 항목명 : mnthRnttyBurRgsum */
//        listColumnDefs.add(new ColumnDef("항목명", YetaT13003BM.ATTR_MNTHRNTTYBURRGSUM, ColumnDef.TYPE_STRING , 140, true, true, true){
//        	{
//
//        	}
//        });
//        /** column 기지급(급여) : mnthRnttyHusFrmCd */
//        listColumnDefs.add(new ColumnDef("기지급(급여)", YetaT13003BM.ATTR_MNTHRNTTYHUSFRMCD, ColumnDef.TYPE_STRING , 140, true, true, true){
//        	{
//
//        	}
//        });
//        /** column 기지급(종전) : mnthRnttyHusFrmNm */
//        listColumnDefs.add(new ColumnDef("기지급(종전)", YetaT13003BM.ATTR_MNTHRNTTYHUSFRMNM, ColumnDef.TYPE_STRING , 140, true, true, true){
//        	{
//
//        	}
//        });
//        /** column 과세전환금 : mnthRnttyHusCnttArea */
//        listColumnDefs.add(new ColumnDef("과세전환금", YetaT13003BM.ATTR_MNTHRNTTYHUSCNTTAREA, ColumnDef.TYPE_STRING , 140, true, true, true){
//        	{
//
//        	}
//        });
