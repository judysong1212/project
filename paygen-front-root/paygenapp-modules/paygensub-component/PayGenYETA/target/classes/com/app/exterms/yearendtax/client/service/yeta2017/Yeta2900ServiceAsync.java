...
public interface Yeta2900ServiceAsync {
	
	
	public void saveYeta2900ToPyyt0302(List<Pyyt0302DTO> listPyyt0302Dto, String flag, AsyncCallback<Integer> callback);
	
	public void deleteYeta2900List(List<Pyyt0302DTO> listPyyt0302Dto, AsyncCallback<Integer> callback);
	
	public void Yeta2900InfoList(Pyyt0304DTO pyyt0304Dto, AsyncCallback<Pyyt0304BM> callback);
