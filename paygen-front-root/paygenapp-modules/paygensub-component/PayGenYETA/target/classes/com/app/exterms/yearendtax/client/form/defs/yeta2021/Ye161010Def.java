...
import com.app.exterms.yearendtax.client.dto.yeta2021.InfcPsnl0100BM;
import com.app.exterms.yearendtax.client.dto.yeta2021.Ye160401BM;
import com.app.exterms.yearendtax.client.dto.yeta2021.Ye161010BM;
import com.app.exterms.yearendtax.client.dto.yeta2021.Ye161020BM;
...
//    private PayrConstants PayrLabel = PayrConstants.INSTANCE;
	...
	public Ye161010Def(String chkPayrDef) {
		...
		if("Yeta6100".equals(chkPayrDef)){
			setDaoClass("");
			setCustomListMethod(CLASS_YETA6100_DATA_LIST);
			setAutoFillGrid(false);
			setShowFilterToolbar(false);
			setCheckBoxOnGridRows(false);
			
			setColumnsDefinition(getYeta6100ColumnsList());
			
		}else if("Yeta6200".equals(chkPayrDef)){
			setDaoClass("");
			setCustomListMethod(CLASS_YETA6200_DATA_LIST);
			setAutoFillGrid(true);
			setShowFilterToolbar(false);
			setCheckBoxOnGridRows(true);
			setEditFieldGrid(false);
			
			setColumnsDefinition(getYeta6200ToYe161010List());
			
		}else if("Yeta6300".equals(chkPayrDef)){
			setDaoClass("");
			setCustomListMethod(CLASS_YETA6300_TO_YE161010_DATA_LIST);
			setAutoFillGrid(false);
			setShowFilterToolbar(false);
			setCheckBoxOnGridRows(true);
			setEditFieldGrid(false);
			setColumnsDefinition(getYeta6300ToYe161010List());
		}else{
			setTitle("");
	        setDaoClass("");
	        setCustomListMethod(CLASS_YETA6200_RESULT_DATA_LIST);
	  	  	setAutoFillGrid(true);
	        setShowFilterToolbar(false);   
	        setCheckBoxOnGridRows(false); 
		    setEditFieldGrid(false);
	...
	private List<ColumnDef> getYeta6100ColumnsList() {
	    ...
	    listColumnDefs.add(new ColumnDef("장애인인원수", Ye161020BM.ATTR_DSBRNFPCNT, ColumnDef.TYPE_BIGDECIMAL , 90, true, false, true){
	    	{
	...
	private List<ColumnDef> getYeta6200ToYe161010List() {
	...
	private List<ColumnDef> getYeta6300ToYe161010List() {
