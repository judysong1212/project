...
import com.app.exterms.yearendtax.client.dto.yeta2019.Ye161090BM;
...
import com.app.exterms.yearendtax.client.service.yeta2019.YetaP430011ServiceAsync;
...
=====================================================**/
public  class YetaP430011   extends MSFFormPanel {  
 ...
 **/
	...
	private Ye161090Def ye161090Def_01  		= new Ye161090Def("YETA430001");
	private Ye161090Def ye161090Def_02  		= new Ye161090Def("YETA430002");
	// -------------- grid 선언 종료  ---------------	
   ...
   */
	...
	private YetaP430011ServiceAsync yetaP430011Service = YetaP430011Service.Util.getInstance();
...
//		 }
	...
	public YetaP430011(final ActionDatabase actionDatabase, final MSFPanel caller) {
		...
		popBindingCom0160.addListener(Events.Change, new Listener<BaseEvent>() {
			public void handleEvent(BaseEvent be) {
				...
				if (mapModels != null) {
					...
					yetaP430011Service.saveYeta4300ToYe161090tabItem08_3(listYe161090Dto, actionDatabase, new AsyncCallback<Long>() {
