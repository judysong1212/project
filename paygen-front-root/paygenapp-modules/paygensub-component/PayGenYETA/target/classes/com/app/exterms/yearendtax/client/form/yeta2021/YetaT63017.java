...
=====================================================**/
public  class YetaT63017   extends MSFFormPanel {  
	...
	private  ContentPanel cpYetaT63017; 
	...
	// -------------- grid 선언 시작  ---------------	  
	private MSFGridPanel YetaT63017GridPanel;
	//	private YetaT63017Def YetaT63017Def = new YetaT63017Def("YetaT63017");   //TODO 일단 화면번호로 Def
	// -------------- grid 선언 종료  ---------------
	...
	public YetaT63017(final ActionDatabase actionDatabase, final MSFPanel caller) {
		...
		cpYetaT63017 = new ContentPanel();  

		createSearchForm();			//기본정보 필드를 적용
		createMsfGridForm();		//그리드필드
		setReadOnlyTrueYetaP23017();

		cpYetaT63017.setBodyBorder(false);
		cpYetaT63017.setBorders(false);
		cpYetaT63017.setHeaderVisible(false);
		cpYetaT63017.setSize("630px", "640px");

		this.add(cpYetaT63017);
	...
	private void createMsfGridForm() {
		...
		cpYetaT63017.add(layoutContainer1);
		cpYetaT63017.add(layoutContainer2);
		cpYetaT63017.add(layoutContainer3);
		cpYetaT63017.add(layoutContainer4);
		cpYetaT63017.add(layoutContainer5);
		cpYetaT63017.add(layoutContainer6);
		cpYetaT63017.add(layoutContainer7);
		cpYetaT63017.add(layoutContainer8);
		cpYetaT63017.add(layoutContainer9);
	}	
