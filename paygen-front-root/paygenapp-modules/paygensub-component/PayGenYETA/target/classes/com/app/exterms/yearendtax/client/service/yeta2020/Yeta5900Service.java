...
@RemoteServiceRelativePath("Yeta5900Service.gwt")
public interface Yeta5900Service extends RemoteService {
	/**
	 * Utility class for simplifying access to the instance of async service.
	 */
	public static class Util {
		private static Yeta5900ServiceAsync instance;
		public static Yeta5900ServiceAsync getInstance(){
			if (instance == null) {
				instance = GWT.create(Yeta5900Service.class);
			}
			return instance;
		}
	}
    ...
    public Pyyt0304BM Yeta5900InfoList(Pyyt0304DTO Pyyt0304Dto) throws MSFException ;
