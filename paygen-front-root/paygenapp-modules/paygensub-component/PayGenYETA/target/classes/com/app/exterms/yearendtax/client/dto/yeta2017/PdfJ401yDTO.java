...
/**
 * @Class Name : PdfJ401yVO.java
 * @Description : PdfJ401y VO class
 ...
 */
public class PdfJ401yDTO   implements Serializable {
    ...
    private java.math.BigDecimal lendLoanAmt;

    /** set 목돈안전세_대출일자 : lendDt */
    private java.lang.String lendDt;

    /** set 목돈안전세_연간합계액 : sizSum */
    private java.math.BigDecimal sizSum;
    ...
    public java.math.BigDecimal getLendLoanAmt() {
        return this.lendLoanAmt;
    }
    
    public void setLendLoanAmt(java.math.BigDecimal lendLoanAmt) {
        this.lendLoanAmt = lendLoanAmt;
    }
    ...
    public java.math.BigDecimal getSizSum() {
        return this.sizSum;
    }
    
    public void setSizSum(java.math.BigDecimal sizSum) {
        this.sizSum = sizSum;
    }
