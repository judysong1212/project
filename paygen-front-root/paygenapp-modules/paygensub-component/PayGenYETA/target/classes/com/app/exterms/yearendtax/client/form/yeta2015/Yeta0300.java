...
import com.app.exterms.yearendtax.client.dto.yeta2015.Yeta3000DTO;
import com.app.exterms.yearendtax.client.dto.yeta2015.Yeta3150DTO;
import com.app.exterms.yearendtax.client.dto.yeta2015.Yeta3220BM;
import com.app.exterms.yearendtax.client.dto.yeta2015.Yeta3220DTO;
import com.app.exterms.yearendtax.client.form.defs.yeta2015.Yeta2000Def;
import com.app.exterms.yearendtax.client.form.defs.yeta2015.Yeta3000Def;
import com.app.exterms.yearendtax.client.form.defs.yeta2015.Yeta3150Def;
import com.app.exterms.yearendtax.client.form.defs.yeta2015.Yeta3220Def;
import com.app.exterms.yearendtax.client.service.yeta2015.Yeta0300Service;
import com.app.exterms.yearendtax.client.service.yeta2015.Yeta0300ServiceAsync;
...
public class Yeta0300 extends MSFPanel {

	private VerticalPanel vp;
	private FormPanel plFrmYeta0300;
	...
	// -------------- 탭 시작 --------------
	private TabPanel tabsYeta0300 = new TabPanel();		// 전체
	private TabPanel tabsItemYeta05 = new TabPanel();	// 특별소득공제 하위
	private TabPanel tabsItemYeta08 = new TabPanel();	// 세액감면및세액공제1 하위
	// -------------- 탭 종료 --------------

	// -------------- 상단 버튼 시작 --------------
	private ButtonBar topYeta0300Bar;
	private Button btnYeta0300Reset; 	// 초기화
	private Button btnYeta0300New; 		// 신규
	private Button btnYeta0300Save; 	// 저장
	private Button btnYeta0300Del; 		// 삭제
	private Button btnYeta0300Sreach; 	// 조회
	private Button btnYeta0300Print; 	// 인쇄
	
	private RadioGroup printType;		// 대상자 선택
	// -------------- 상단 버튼 종료 --------------

	// -------------- 중간 버튼 시작 --------------
	private Button btnYeta0300_01;			// 의료비지급명세서
	private Button btnYeta0300_02; 			// 기부금명세서
	private Button btnYeta0300_03; 			// 재계산대상자
	private Button btnYeta0300_04; 			// 삭제
	private Button btnYeta0300_05; 			// 세액계산
	private Button btnYeta0300_06; 			// 세액재계산
	private Button btnYeta0300_07; 			// 원천징수인쇄
	...
	// -------------- grid 선언 시작  ---------------
//	private Yeta0300Def yeta0300Def_01  = new Yeta0300Def("YETA03001");	//대상자 정보 그리드 테이블 컬럼 define  
//	private Yeta0300Def yeta0300Def_02  = new Yeta0300Def("YETA03002");	//세액계산 정보 그리드 테이블 컬럼 define 
//	private Yeta0300Def yeta0300Def_03  = new Yeta0300Def("YETA03003");	//인적공제 정보 그리드 테이블 컬럼 define
//	private Yeta0300Def yeta0300Def_04  = new Yeta0300Def("YETA03004"); //소득공제명세 그리드 테이블 컬럼 define(합계) 
//	private Yeta0300Def yeta0300Def_04_01  = new Yeta0300Def("YETA03004_01"); //소득공제명세 그리드 테이블 컬럼 define(국세청자료) 
//	private Yeta0300Def yeta0300Def_04_02  = new Yeta0300Def("YETA03004_02"); //소득공제명세 그리드 테이블 컬럼 define(기타자료)
//	private Yeta0300Def yeta0300Def_05  = new Yeta0300Def("YETA03005");	//가족교육비 그리드 테이블 컬럼 define 
	
	private Yeta2000Def Yeta2000Def_01  	= new Yeta2000Def("YETA0300"); 	//대상자 정보 그리드 테이블 컬럼 define
	private Yeta2000Def Yeta2000Def_02  	= new Yeta2000Def("YETA200001"); 		//대상자 정보 그리드 새로고침을 위한 define
	private Yeta3000Def yeta3000Def_01  	= new Yeta3000Def("YETA300001");	//세액계산 정보 그리드 테이블 컬럼 define 
	
	private Yeta3220Def Yeta3220Def_01  	= new Yeta3220Def("YETA322001");	//인적공제 정보 그리드 테이블 컬럼 define
	private Yeta3220Def Yeta3220Def_02_SUM  = new Yeta3220Def("YETA322002"); 	//소득공제명세 그리드 테이블 컬럼 define(합계) 
	private Yeta3220Def Yeta3220Def_02_01  	= new Yeta3220Def("YETA322003"); 	//소득공제명세 그리드 테이블 컬럼 define(국세청자료)  
	private Yeta3220Def Yeta3220Def_02_02  	= new Yeta3220Def("YETA322004"); 	//소득공제명세 그리드 테이블 컬럼 define(기타자료)
	private Yeta3150Def Yeta3150Def_01  	= new Yeta3150Def("YETA315001");	//가족교육비 그리드 테이블 컬럼 define 
	
	
	private MSFGridPanel yeta0300GridPanel;
	private MSFGridPanel yeta300ToYeta2000GridPanel;	//대상자정보 GridPanel
//	private MSFGridPanel yeta300ToYeta2000GridPanel2;	//대상자정보 GridPanel
	private MSFGridPanel yeta300ToYeta3220GridPanel1;	//인적공제 GridPanel
	private MSFGridPanel yeta300ToYeta3220GridPanel2;	//소득공제 - 국세청 GridPanel
	private MSFGridPanel yeta300ToYeta3220GridPanel3;	//소득공제 - 기타자료 GridPanel
	private MSFGridPanel yeta300ToYeta3220GridPanel4;	//소득공제 - 합계 GridPanel
	private MSFGridPanel yeta300ToYeta3150GridPanel;	//가족교육비 GridPanel
	// -------------- grid 선언 종료  ---------------
...
//    private HiddenField<String> pyspGrdeCd;   	/** column 호봉등급코드 : pyspGrdeCd */
    ...
    private NumberField dcsnTots;		  	//종근무지_급여총액
    private MSFNumberField currTots;			//주근무지_급여총액
    private NumberField totlSala;			//총급여_현_전
    	
    private NumberField wkerDdct;			//근로소득공제
    private NumberField wkerAmnt;			//근로소득금액
    private NumberField taxdWken;			//세액공제_근로소득세액공제
    	
    private NumberField  stndIncm; //과세표준  
    private NumberField  prddTaxn; //산출세액 
    private NumberField dcsnItax;			//결정세액_소득세
    private NumberField dcsnBtax;			//결정세액_주민세_지방소득세
    ...
    Radio humnCgue0;
    Radio humnCgue1;
    private NumberField addrMrct;		//추가공제_다자녀인원수
    private NumberField addrMccr;		//세액공제_자녀세액공제금액
...
//    private List<Yeta3220DTO> beforeJumin = new ArrayList<Yeta3220DTO>();  
    ...
    // -------------- 연금보험료 공제 시작 --------------
    //--국민보험료
    private NumberField bnatPsnf;		//종근무지_국민연금보험료
    private MSFNumberField jnatPsnf;	//주근무지_국민연금보험료
    private NumberField bnatDdct;		//종근무지_국민연금보험료공제
    private NumberField jnatDdct;		//주근무지_국민연금보험료공제

    //--국민연금보험료외의 연금보험료
    private NumberField bpssPulc;		//종근무지_국민연금외공무원연금
    private MSFNumberField jpssPulc;	//주근무지_국민연금외공무원연금
   
    private NumberField bpssSold;		//종근무지_국민연금외군인연금
    private MSFNumberField jpssSold;	//주근무지_국민연금외군인연금
    
    private NumberField bpssTech;		//종근무지_국인연금외교직원연금
    private MSFNumberField jpssTech;	//주근무지_국인연금외교직원연금
    
    private NumberField bpssFect;		//종근무지_국민연금외별정우체국
    private MSFNumberField jpssFect;	//주근무지_국민연금외별정우체국

    private NumberField bpssHpul;		//종근무지_국민연금외공무원연금공제
    private NumberField jpssHpul;		//주근무지_공무원연금보험료공제

    private NumberField bpssHsol;		//종근무지_국민연금외군인연금공제
    private NumberField jpssHsol;		//주근무지_국민연금외군인연금공제

    private NumberField bpssHtec;		//종근무지_국민연금외교직원연금공제
    private NumberField jpssHtec;		//주근무지_국민연금외교직원연금공제

    private NumberField bpssDdct;		//종근무지_별정우체국연금보험료공제
    private NumberField jpssDdct;		//주근무지_별정우체국연금보험료공제
    
    private NumberField rrptAmnt;		//연금보험료계
    private NumberField rrptYnam;		//연금보험료공제계
    // -------------- 연금보험료 공제 종료 --------------
    ...
    // -------------- 특별 소득 공제 시작 --------------
    // -- 보험료
    private NumberField spciBhlh;		//특별공제_종건강보험료
    private MSFNumberField spciHhlh;	//특별공제_주건강보험료
    private NumberField spciBhth;		//특별공제_종건강보험료 공제액
    private NumberField spciJhth;		//특별공제_주건강보험료 공제액
    	
    private NumberField spciBepf;		//특별공제_종고용보험료
    private MSFNumberField spciJepf;	//특별공제_주고용보험료

    private NumberField spciBepf01;		//특별공제_종고용보험료 공제액
    private NumberField spciJepf01;		//특별공제_주고용보험료 공제액
    	
    private NumberField spciIuam;		//특별공제_보험료계
    private NumberField spciHrto;		//특별공제_보험료계

    // -- 주택자금
    private MSFNumberField spciRefn;	//특별공제_차입금원리금상환액_대출기관
    private MSFNumberField spciResf;	//특별공제_차입금원리금상환액_거주자
    	
    private NumberField spciRefn01;		//특별공제_차입금원리금상환액_대출기관 공제액
    private NumberField spciResf01;		//특별공제_차입금원리금상환액_거주자 공제액
    	
    private MSFNumberField spciHtam;	//특별공제_주택자금_월세금액
    private NumberField spciRtam;		//특별공제_주택자금월세공제액
    ...
    private NumberField spchRefx01;		//특별공제_12장기주택저당차입금_고정  공제액
    private NumberField spchReec01;		//특별공제_12장기주택저당차입금_기타  공제액

    private NumberField spchRe15;		//특별공제_11장기주택저당차입금15 공제액
    private NumberField spchRe29;		//특별공제_11장기주택저당차입금29 공제액
    private NumberField spchRe30;		//특별공제_11장기주택저당차입금30 공제액
    ...
    private NumberField spch10fb;		//특별공제_15장기주택저당_10고정OR비거치상환
    	
    private NumberField spci15fx;		//특별공제_15장기주택저당_15고정AND비거치상환 공제액
    private NumberField spci15fb;		//특별공제_15장기주택저당_15고정OR비거치상환 공제액
    private NumberField spci15ec;		//특별공제_15장기주택저당_15기타대출 공제액
    private NumberField spci10fb;		//특별공제_15장기주택저당_10고정OR비거치상환 공제액
    	
    private NumberField spchReto;		//특별공제_주택자금공제액계
    // -------------- 특별 소득 공제 종료 --------------
    
    // -------------- 그밖의 소득 공제1 시작 --------------
    private MSFNumberField prvm20be;	//개인연금저축불입액_2000년이전
    private NumberField etcpPsnv;		//개인연금저축불입액_2000년이전
    
    private MSFNumberField etchPrep;	//기타공제_소기업공제불입금액
    private NumberField etchPrep01;		//기타공제_소기업공제불입금 공제액
    ...
    private NumberField etcsComp01;		//기타공제_주택마련저축_청약저축 공제액
    private NumberField etwkSbam;		//기타공제_주택마련저축_주택청약종합저축 공제액
    private NumberField etwkSvam;		//기타공제_주택마련저축_근로자주택마련저축 공제액
    private NumberField etwkBdam;		//기타공제_주택마련저축소득공제계
    ...
    private NumberField etgdHdam;		//기타공제투자조합출자금액계
    	
    private NumberField etgd09af;		//기타공제_투자조합출자소득공제_2012년도
    private NumberField etgdH13h;		//기타공제_투자조합출자소득공제_2013년도
    private NumberField etgdD14f;		//기타공제_투자조합출자소득공제_2014년
    private NumberField etgdD15f;		//기타공제_투자조합출자소득공제_2015년이후
    private NumberField etgdDdam;		//기타공제_투자조합출자공제액계
    	
    private NumberField etctCard;		//기타공제_신용카드등사용금액
    private NumberField etchBcbs;		//기타공제_직불카드등사용금액
    private NumberField etchUeam;		//기타공제_현금영수증사용금액
    private NumberField etchMgvd;		//기타공제_전통시장사용분
    private NumberField etchBced;		//기타공제_지로납부_대중교통금액
    private NumberField etchBcue;		//기타공제_신용카드등사용금액계
    private NumberField etccCard;		//기타공제_신용카드등사용공제계
    ...
    private NumberField etckUnon01;		//기타공제_우리사주출연금공제 공제액
    private NumberField etckUncr;		//기타공제_우리사주조합기부금공제2014이전 공제액
    private NumberField etepMsam;		//기타공제_고용유지중소기업근로자임금삭감공제액
    private NumberField etgdHtra;		//기타공제_목돈안드는전세이자상환소득공제액
    private NumberField etepSecr;		//기타공제_장기집합투자증권저축공제액
    // -------------- 그밖의 소득 공제2 종료 --------------
    
    
    // -------------- 세액감면및세액공제1 시작 --------------
    //--연금계좌및보험료
    private NumberField jrtrCict;	//주근무지_퇴직연금과학기술인공제
    private MSFNumberField jrtrCtar;//주근무지_퇴직연금과학기술인공제대상금액
    private NumberField jrtrHict;	//주근무지_퇴직연금과학기술인공제액
    	
    private NumberField jrtrPsct;	//주근무지_퇴직연금근로자퇴직급여보장법
    private MSFNumberField jrtrPtar;//주근무지_퇴직연금근로자퇴직급여보장대상금액
    private NumberField jrtrPsrn;	//주근무지_퇴직연금근로자퇴직급여보장법공제액
    	
    private NumberField jrtrAnsv;	//주근무지_연금계좌_연금저축
    private MSFNumberField jrtrAtar;//주근무지_연금계좌저축공제대상금액
    private NumberField jrtrHnsv;	//주근무지_퇴직연금연금계좌저축공제
    	
    private NumberField jrtrAtom;	//연금계좌계
    private NumberField jrtrTotr;	//연금계좌공제대상금액
    private NumberField jrtrHnto;	//연금계좌세액공제계
    	
    private MSFNumberField spciGurt;//특별공제_일반보장성보험료
    private NumberField spciRttg;	//특별공제_일반보장성보험료 공제대상금액
    private NumberField spciGurt01;	//특별공제_일반보장성보험료 공제액
    
    
    private MSFNumberField spciHdrc;//특별공제_장애인전용보험료
    private NumberField spciHdtg;	//특별공제_장애인보장성대상금액
    private NumberField spciHdrc01; //특별공제_장애인보장성대상금액 공제액
    	
    private NumberField spciRtto;	//특별공제_보장성보험료계
    private NumberField spciDetg;	//특별공제_보장성보험료대상금액
    private NumberField spciRtde;	//특별공제_보장성보혐료세액공제금액

    //--의료비
    private NumberField spciSelf;	//특별공제_의료비_본인
    private NumberField spciSftg;	//본인의료비공제대상금액
    private NumberField spciSelf01;	//본인 의료비 세액공제
    	
    private NumberField spciAe65;	//특별공제_의료비_경로65세이상
   	private NumberField spci65tg;	//65세이상자의료비공제대상금액
    private NumberField spciHe65;	//특별공제_의료비_경로65세이상
    	
    private NumberField spciDbps;	//특별공제_의료비_장애인
    private NumberField spciPstg;	//장애인의료비공제대상금액
    private NumberField spciHbps;	//특별공제_의료비_장애인 공제액
    
    private NumberField spciEtcg;	//그밖의의료비공제대상금액
    private NumberField spciDetc;	//특별공제_의료비_기타공제대상자
    private NumberField spciDetc01;	//특별공제_의료비_기타공제대상자 공제액
    	
    private NumberField spciEtam;	//특별공제_의료비계
    private NumberField spciDtar;	//특별공제_의료비세액공제대상금액
    private NumberField spciTxcr;	//특별공제_의료비세액공제액
    	

    //--교육비
    private MSFNumberField spedSelf;//특별공제_교육비_본인
    private NumberField spedSftr;	//소득자본인교육비대상금액
    private NumberField spedSelf01;	//특별공제_교육비_본인 공제액
    	
    private NumberField spedEdsu;	//특별공제_교육비_취학전아동수
    private NumberField spedEdam;	//특별공제_교육비_취학전아동
    private NumberField spedGrde;	//특별공제_교육비_취학전아동 공제액
    	
    private NumberField spedGdsu;	//특별공제_교육비_초중고자녀수
    private NumberField spedGdam;	//특별공제_교육비_초중고
    private NumberField spedGdto;	//특별공제_교육비_초중고 공제액
    	
    private NumberField spedCvsu;	//특별공제_교육비_대학생수
    private NumberField spedCvam;	//특별공제_교육비_대학교
    private NumberField spedCldv;	//특별공제_교육비_대학교
    	
    private NumberField spciSctr;	//특별공제_장애인수
    private MSFNumberField spciScam;//특별공제_장애인특수교육비
    private NumberField spciSpec;	//특별공제_장애인특수교육비
    	
    private NumberField siedToam;	//특별공제_교육비계
    private NumberField spedEtar;	//특별공제_교육비공제대상금액
    private NumberField spedTxcr;	//특별공제_교육비세액공제금액
    
    //--기부금
    private NumberField taxdPltc;	//세액공제_기부정치자금금액	
    private NumberField taxd10tg;	//특별공제_기부정치자금_10이하대상금액	
    private NumberField taxdPltc01;	//세액공제_기부정치자금 공제세액	
    		
    private NumberField spciPltc;	//특별공제_기부금_정치	
    private NumberField spciPltg;	//특별공제_기부금_정치10초과대상금액	
    private NumberField spciPltc01;	//특별공제_기부금_정치 공제세액
    		
    private NumberField spciFbam;	//특별공제_기부금_법정	
    private NumberField spciFbtg;	//특별공제_기부금_법정 대상금액	
    private NumberField spciFbam01;	//특별공제_기부금_법정 공제세액
    		
    private NumberField spciExam;	//특별공제_기부금_특례_공익법인신탁제외	
    private NumberField spciExtg;	//특례기부금_공익법인제외대상금액	
    private NumberField spciExam01;	//특별공제_기부금_특례_공익법인신탁제외	공제새액
    		
    private NumberField spciHfam;	//특별공제_기부금_우리사주조합2015이후	
    private NumberField spciHftg;	//우리사주종합기부대상금액	
    private NumberField spciRfam;	//특별공제_기부금_우리사주조합2015이후	
    		
    private NumberField spciNamt;	//특별공제_기부금_종교단체외	
    private NumberField spciNatg;	//종교단체외지정대상금액	
    private NumberField spciNamt01;	//특별공제_기부금_종교단체외	
    		
    private NumberField spciYamt;	//특별공제_기부금_종교단체	
    private NumberField spciYatg;	//종교단체지정대상금액	
    private NumberField spciYamt01;	//특별공제_기부금_종교단체	
    		
    private NumberField spciDgam;	//기부금합계금액	
    private NumberField spciDgtg;	//기부금 공제대상계	특별공제_지정기부금대상금액
    private NumberField spciDgcr;	//기부금 세액공제계	
    
    
    private NumberField spciObam;	//이월법정기부금액
    private NumberField spciOyam;	//이월종교단체기부금
    private NumberField spciOnam;	//이월종교단체외기부금
    
    private NumberField spciObam01;	//이월법정기부금액_공제액
    private NumberField spciOyam01;	//이월종교단체기부금_공제액
    private NumberField spciOnam01;	//이월종교단체외기부금_공제액

    private NumberField spciSsum;	//기부금(이월분)	
    // -------------- 세액감면및세액공제1 종료 --------------
    ...
    private NumberField txlgWkta;		//세액감면_취업청년감면근로자총급여액
    	
    private NumberField txlgClta;		//세액감면_계산감면세액금액
    private NumberField taxdTsum;		//세액감면_감면세액계
    	
    private MSFNumberField txlgFrta;	//세액감면_외국인기술자감면세액
    private NumberField taxdRedu;		//세액공제_외국인감면세액
    	
    private MSFNumberField txlgTxty;	//세액감면_조세조약감면세액
    private NumberField txlgHxtt;		//세액감면_조세조약
    ...
    private NumberField taxdUnin01;		//세액공제_납세조합공제
    	
    private MSFNumberField taxdLoaa;	//세액공제_주택차입금이자상황금액
    private NumberField taxdLoan;		//세액공제_주택차입금
...
//	private ListStore<BaseModel> lsCrClutMnth = new ListStore<BaseModel>(); 			//급여월
	...
	// -------------- 서비스 호출 시작 --------------
	private Yeta0300ServiceAsync yeta0300Service = Yeta0300Service.Util.getInstance();
	// -------------- 서비스 호출 종료 --------------
	 ...
	 */
	 private void checkYeta0300Auth( String authAction, ListStore<BaseModel>bm) {
	 ...
	 **/
	  ...
	  *
	  */
	 private void fnYeta0300Payr06430CalcTax() { 
   	      ...
   	      @Override
   	       public void handleEvent(MessageBoxEvent be) {
   	    	...
   	    	if(Dialog.YES.equals(be.getButtonClicked().getItemId())){
   	        	 	     ...
   	        	 	     Iterator<BaseModel> itBm  = yeta300ToYeta2000GridPanel.getMsfGrid().getGrid().getSelectionModel().getSelectedItems().listIterator();
...
//									yeta2000Dto.setYrtxPrcsYn(MSFSharedUtils.allowNulls(bmMapModel.get("yrtxPrcsYn")));    /** column 연말정산처리여부 : yrtxPrcsYn */
			              ...
			              t.scheduleRepeating(500);
   	           	 		...
   	           	 		yeta0300Service.fnYeta0300Payr06430CalcTax(listYeta2000Dto,  
...
//   	           	                MSFMainApp.ADMINMESSAGES.ExceptionMessageService("activityOnInsertRemt0100(insert) : " + caught), null);
	 ...
	 private void fnYeta0300Payr06430AllCalcTax() { 
	   	       ...
	   	       public void handleEvent(MessageBoxEvent be) {
	   	    	...
	   	    	if(Dialog.YES.equals(be.getButtonClicked().getItemId())){
				              ...
				              t.scheduleRepeating(500);
	   	           	 		...
	   	           	 		yeta0300Service.fnYeta0300Payr06430AllCalcTax(yeta2000Dto,  
	   	           	                new AsyncCallback<PagingLoadResult<ShowMessageBM>>() {
	   	           	        public void onFailure(Throwable caught) {
	   	           	         tracker.setStatus(true);
	   	           	          List<ShowMessageBM>  bmResult = new ArrayList<ShowMessageBM>();
...
//	   	           	                MSFMainApp.ADMINMESSAGES.ExceptionMessageService("activityOnInsertRemt0100(insert) : " + caught), null);
	                           ...
	                           //계산 결과에 따른 조회 호출 
	   	                  	  //reload() ;
	   	           	         // yeta300ToYeta2000GridPanel.getMsfGrid().getGrid() 
	   	           	          reFresh();
	   	           	        } 
	   	           	        }); 	  
	   	           }
...
class Tracker 
{
   ...
   public Iterator<Record>  getListRecord() {
	  ...
	  */
	     ...
	     *++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ 
	     **/
		private void Yeta0300Print(String fileName, String repType) {
...
//			serarchParam += "[" + MSFSharedUtils.allowNulls(srhSystemkey.getValue())+"]";				//$12 시스템키 
			...
			List<BaseModel> list = yeta300ToYeta2000GridPanel.getGrid().getSelectionModel().getSelectedItems();
...
//			serarchParam += "" + YetaUtils.getPrintStrToMultiData(lsDeptCd, MSFSharedUtils.allowNulls(srhDeptCd.getValue()),"deptNmRtchnt","deptCd") +"⊥";		
	...
	public ContentPanel getViewPanel() {
		if (panel == null) {
			...
			createYeta0300Form(); 	// 화면 기본정보를 설정
			createSearchForm(); 	// 검색필드를 적용
...
//			vp.setSize("1010px", "750px");
			...
			// 폼데이터를 바인딩
			// formBinding = new FormBinding(this.plFrmYeta0300, true);
...
//		setSize("1010px", "750px");
	...
	public Yeta0300(String txtForm) {
	...
	private void createContentForm() {
		...
		btnNewButton_2.addListener(Events.Select,  new Listener<ButtonEvent>() {
			...
			public void handleEvent(ButtonEvent be) {
				...
				Yeta0300Print("YETAT0300", MSFMainApp.getMsg("PayGen.ReportDivisionType"));
			}
		...
		btnNewButton_3.addListener(Events.Select,  new Listener<ButtonEvent>() {
			...
			public void handleEvent(ButtonEvent be) {
				// TODO Auto-generated method stub
				Yeta0300Print("YETAT0301", MSFMainApp.getMsg("PayGen.ReportDivisionType"));
			}
...
//		btnBar.add(btnNewButton_4);
		...
		Button btnYeta0300_05 = new Button("세액계산");
		btnYeta0300_05.setIcon(MSFMainApp.ICONS.save16());
		btnBar.add(btnYeta0300_05);
		btnYeta0300_05.addListener(Events.Select, new Listener<ButtonEvent>() {
    		public void handleEvent(ButtonEvent e) {
    		 
    	        fnYeta0300Payr06430CalcTax();
    		}
    	});
		...
		btnNewButton_7.addListener(Events.Select,  new Listener<ButtonEvent>() {
			...
			public void handleEvent(ButtonEvent be) {
				// TODO Auto-generated method stub
				Yeta0300Print("YETAT0302", MSFMainApp.getMsg("PayGen.ReportDivisionType"));
			}
		});
...
//		btnLayoutContainer.add(btnLayoutContainer_07, new com.extjs.gxt.ui.client.widget.layout.ColumnData(.1));
		...
		plFrmYeta0300.add(conLayoutContainer);

	}

	private void createYeta0300Form() {
		
		plFrmYeta0300 = new FormPanel();
		plFrmYeta0300.setHeadingText(PayGenConst.PAYGEN_VERSION.concat(" - 소득공제신고자료관리"));
		plFrmYeta0300.setIcon(MSFMainApp.ICONS.text());
		plFrmYeta0300.setBodyStyleName("pad-text");
		plFrmYeta0300.setFrame(true);
		plFrmYeta0300.setPadding(2);
		...
		btnlogView.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				 //로그 뷰화면 호출 메서드 
				  funcLogMessage("소득공제신고자료관리","YETA0300");
				}
			});
		plFrmYeta0300.getHeader().setStyleAttribute("padding", "5px 0 2px 0");
		plFrmYeta0300.getHeader().addTool(btnlogView); 
		/************************************************************************
		 * 화면 에러 처리시 필요한 부분으로 추가 
		 ************************************************************************/

		   //멀티콤보박스 닫기 
		plFrmYeta0300.addListener(Events.OnClick,new Listener<ComponentEvent>() { 
				            @Override
...
//				                        }
		...
		topYeta0300Bar = new ButtonBar();
		topYeta0300Bar.setAlignment(HorizontalAlignment.RIGHT);

		btnYeta0300Reset = new Button("초기화");
		btnYeta0300Reset.setIcon(MSFMainApp.ICONS.new16());
		btnYeta0300Reset.addListener(Events.Select, new Listener<ButtonEvent>() {
			...
			public void handleEvent(ButtonEvent be) {
				...
				resetYeta300ToYeta2000Grid();	//대상자정보 grid 초기화
				resetItemYeta01();				//기본사항 초기화

				tabsYeta0300.setSelection(tabsYeta0300.getItem(0));//탭부분 초기화
			}
		});
		topYeta0300Bar.add(btnYeta0300Reset);

		btnYeta0300Save = new Button("저장");
		btnYeta0300Save.setIcon(MSFMainApp.ICONS.save16());
		topYeta0300Bar.add(btnYeta0300Save);
		btnYeta0300Save.addListener(Events.Select, new Listener<ButtonEvent>() {
			@Override
			public void handleEvent(ButtonEvent be) {
				// TODO Auto-generated method stub
...
//				     actionDatabase = ActionDatabase.UPDATE;
				...
				//  {-- 기본사항 --}
				if("itemYeta01".equals(tabsYeta0300.getSelectedItem().getId())) {
					
//					MessageBox.info("", "기본사항 탭은 수정할 수 없습니다.", null);
					itemYeta01Save();	//기본사항 탭
					
				//  {-- 인적공제 --}	
				}else if("itemYeta02".equals(tabsYeta0300.getSelectedItem().getId())) {
					
//					MessageBox.info("", "인적공제 탭은 수정할 수 없습니다.", null);
					itemYeta02Save();	//인적공제 저장
				//	{-- 소득공제 --}	
				}else if("itemYeta03".equals(tabsYeta0300.getSelectedItem().getId())) {
					
					itemYeta03Save();	//소득공제
					//MessageBox.info("", "소득공제 탭은 수정할 수 없습니다.", null);
					
				}else if("itemYeta04".equals(tabsYeta0300.getSelectedItem().getId())) {
				//	  {-- 연금보험료공제--}
					itemYeta04Save();//국민연금보험료외의 연금보험료 저장
					
				}else if("itemYeta05".equals(tabsYeta0300.getSelectedItem().getId())) {
...
//						
//				}
				else if("itemYeta06".equals(tabsYeta0300.getSelectedItem().getId())) {
					// {-- 그밖의 소득공제--}
					itemYeta06Save();//그밖의소득공제1 저장
					
				}else if("itemYeta07".equals(tabsYeta0300.getSelectedItem().getId())) {
					
					itemYeta07Save();//그밖의소득공제2 저장
					
				}else if("itemYeta08".equals(tabsYeta0300.getSelectedItem().getId())) {
					//{-- 세액감면및세액공제--}
				...
				}else if("itemYeta09".equals(tabsYeta0300.getSelectedItem().getId())) {
					
					//세액감면및세액공제2 저장
					itemYeta09Save();
					
				}else if("itemYeta10".equals(tabsYeta0300.getSelectedItem().getId())) {
					//{-- 추가제출서류 --}
					//추가제출서류 저장
					itemYeta10Save();
...
//		btnYeta0300Del = new Button("삭제");
//		btnYeta0300Del.setIcon(MSFMainApp.ICONS.delete16());
//		topYeta0300Bar.add(btnYeta0300Del);
		...
		topYeta0300Bar.add(printType);

		btnYeta0300Sreach = new Button("조회");
		btnYeta0300Sreach.setIcon(MSFMainApp.ICONS.search16());
		btnYeta0300Sreach.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				
				//탭 선택 없애기
				tabsYeta0300.setSelection(tabsYeta0300.getItem(0));
	        	   
				//대상자 정보 조회
				reload();
			}
		});
		topYeta0300Bar.add(btnYeta0300Sreach);

//		btnYeta0300Print = new Button("인쇄");
//		btnYeta0300Print.setIcon(MSFMainApp.ICONS.print16());
//		topYeta0300Bar.add(btnYeta0300Print);

		plFrmYeta0300.add(topYeta0300Bar);

		// 파일업로드 처리
		plFrmYeta0300.setAction("myurl");
		plFrmYeta0300.setEncoding(Encoding.MULTIPART);
		plFrmYeta0300.setMethod(Method.POST);

		vp.add(plFrmYeta0300);
		plFrmYeta0300.setSize("990px", "680px");
//		plFrmYeta0300.setSize("990px", "730px");
	...
	private LayoutContainer createListGrid() {
	    ...
	    yeta300ToYeta2000GridPanel = new MSFGridPanel(Yeta2000Def_01, false, false, false, false, false);
	    yeta300ToYeta2000GridPanel.setHeaderVisible(false);  
	    yeta300ToYeta2000GridPanel.setBodyBorder(true);
	    yeta300ToYeta2000GridPanel.setBorders(true);
	    final Grid yeta300ToYeta2000Grid = yeta300ToYeta2000GridPanel.getMsfGrid().getGrid();
...
//        	   BaseModel bmData = yeta300ToYeta2000GridPanel.getMsfGrid().getStore().getModels().get(0);  
        	   BaseModel bmData = yeta300ToYeta2000GridPanel.getCurrentlySelectedItem();  
...
//        	   yeta300ToYeta2000Detail();
        	   reFresh();
        	   //reFresh("itemYeta01");
           }
       }); 
	    
	    cpGrid.add(yeta300ToYeta2000GridPanel); 
...
//	  	plFrmYeta0300.add(typOccuCdGrid);
		...
		plFrmYeta0300.setLayout(new FlowLayout());
			...
			public void handleEvent(StoreEvent<BaseModel> be) {  
				...
				if (type == Store.Add) { 
		             ...
		             * "srhPayrMangDeptCd","srhEmymtDivCd","srhDeptCd","srhTypOccuCd","srhBusinCd"
						++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++*/ 
						checkYeta0300Auth("srhPayrMangDeptCd", lsPayrMangDeptCd); 
				}
			}
		});
	        ...
	        public void handleEvent(StoreEvent<BaseModel> be) {  
	        	  EventType type = be.getType();
		    	   if (type == Store.Add) { 
	           		  ...
	           		  * "srhPayrMangDeptCd","srhEmymtDivCd","srhDeptCd","srhTypOccuCd","srhBusinCd"
		         		++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++*/ 
		                	checkYeta0300Auth("srhEmymtDivCd", lsEmymtDivCd); 
		    	   }
	        }
	    });    
	        ...
	        public void handleEvent(StoreEvent<ModelData> be) {  
	        	  EventType type = be.getType();
		    	   if (type == Store.Add) { 
	           		  ...
	           		  * "srhPayrMangDeptCd","srhEmymtDivCd","srhDeptCd","srhTypOccuCd","srhBusinCd"
		        		++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++*/ 
		                	checkYeta0300Auth("srhDeptCd", lsDeptCd); 
	           	 	}
	        	}
	    	});    
...
//		final TabPanel tabsYeta0300 = new TabPanel();
		tabsYeta0300 = new TabPanel();
		
		
		//하위탭을 선택하였을 경우 관련된 정보를 가져온다.
		tabsYeta0300.addListener(Events.Select, new Listener<TabPanelEvent>() {
			public void handleEvent(TabPanelEvent e) {
				
				//탭선택
//				yeta300ToYeta2000Detail(yeta300ToYeta2000GridPanel.getCurrentlySelectedItem(), tabsYeta0300.getSelectedItem().getId()); 
				//reFresh(tabsYeta0300.getSelectedItem().getId());
					
			}
		});

		// tabsPsnl.setMinTabWidth(80);
		tabsYeta0300.setAutoWidth(false);
		// tabsPsnl.setResizeTabs(true);
		tabsYeta0300.setAnimScroll(false);
		tabsYeta0300.setTabScroll(true);
		tabsYeta0300.setPlain(true);
		tabsYeta0300.setSize(660, 500);
//		tabsYeta0300.setSize(660, 540);
		...
		tabsYeta0300.add(itemYeta10);	
		

		fieldSet.add(tabsYeta0300);
	 ...
	 private LayoutContainer occupationalRBottom2() {
		 ...
		 yeta300ToYeta3220GridPanel1 = new MSFGridPanel(Yeta3220Def_01, false, false, false, false, false);
		 yeta300ToYeta3220GridPanel1.setHeaderVisible(false);  
		 yeta300ToYeta3220GridPanel1.setBodyBorder(true);
		 yeta300ToYeta3220GridPanel1.setBorders(true);
		 
		 
		 /** --- grid 체크 컬럼 --- **/
//		 // 기본
//		 final Grid<BaseModel> grid5 = yeta300ToYeta3220GridPanel1.getMsfGrid().getGrid();
...
//         
//         // 부녀자
//		 final Grid<BaseModel> grid6 = yeta300ToYeta3220GridPanel1.getMsfGrid().getGrid();
...
//         
//         // 경로
//         final Grid<BaseModel> grid7 = yeta300ToYeta3220GridPanel1.getMsfGrid().getGrid();
...
//		 
//         // 출산
//         final Grid<BaseModel> grid8 = yeta300ToYeta3220GridPanel1.getMsfGrid().getGrid();
...
//         
//         // 6세
//         final Grid<BaseModel> grid10 = yeta300ToYeta3220GridPanel1.getMsfGrid().getGrid();
...
//         
//         // 한부모
//         final Grid<BaseModel> grid11 = yeta300ToYeta3220GridPanel1.getMsfGrid().getGrid();
...
//         grid11.getView().setForceFit(true);
		 ...
		 cpGrid.add(yeta300ToYeta3220GridPanel1); 
	 ...
	 private LayoutContainer occupationalRBottom3_01() {
		 ...
		 cpGrid.setHeaderVisible(false);   
		 cpGrid.setLayout(new FitLayout());      
		 cpGrid.setSize(610, 200);  
		    
		 yeta300ToYeta3220GridPanel2 = new MSFGridPanel(Yeta3220Def_02_01, false, false, false, false, false);
		 yeta300ToYeta3220GridPanel2.setHeaderVisible(false);  
		 yeta300ToYeta3220GridPanel2.setBodyBorder(true);
		 yeta300ToYeta3220GridPanel2.setBorders(true);
		 yeta300ToYeta3220GridPanel2.getBottomComponent().setVisible(false);
		 yeta300ToYeta3220GridPanel2.getGrid().getColumnModel().addHeaderGroup(0, 2, new HeaderGroupConfig("보험료", 1, 3));
		 yeta300ToYeta3220GridPanel2.getGrid().getColumnModel().addHeaderGroup(0, 7, new HeaderGroupConfig("신용카드 등 사용액", 1, 5));
...
//			GWTUtils.findColumnConfig(yetaP03001GridPanel, Yeta3170BM.ATTR_CTRBAMNT).setStyle("Height:20px;");
		 ...
		 payrSummaryRow.setHtml(Yeta3220BM.ATTR_KORNNAME, "합 계");  
		 payrSummaryRow.setCellStyle(Yeta3220BM.ATTR_KORNNAME,"summary_color");	/** column 성명 : kornName */
		 
		 payrSummaryRow.setSummaryType(Yeta3220BM.ATTR_INSUPAYR, SummaryType.SUM);   
		 payrSummaryRow.setSummaryType(Yeta3220BM.ATTR_INSURTYR, SummaryType.SUM);   
		 payrSummaryRow.setSummaryType(Yeta3220BM.ATTR_PSCLIURR, SummaryType.SUM); 
		 
		 payrSummaryRow.setSummaryType(Yeta3220BM.ATTR_MEDICOST, SummaryType.SUM); 
		 payrSummaryRow.setSummaryType(Yeta3220BM.ATTR_EDUCCOST, SummaryType.SUM);  
		 
		 payrSummaryRow.setSummaryType(Yeta3220BM.ATTR_CDTECARD, SummaryType.SUM);   
		 payrSummaryRow.setSummaryType(Yeta3220BM.ATTR_JIBLCARD, SummaryType.SUM);   
		 payrSummaryRow.setSummaryType(Yeta3220BM.ATTR_CASHRECE, SummaryType.SUM);   
		 payrSummaryRow.setSummaryType(Yeta3220BM.ATTR_MGNTSTVD, SummaryType.SUM);   
		 payrSummaryRow.setSummaryType(Yeta3220BM.ATTR_GRPYAMNT, SummaryType.SUM); 
		 
		 payrSummaryRow.setSummaryType(Yeta3220BM.ATTR_CTRBAMNT, SummaryType.SUM);   
		 

		 payrSummaryRow.setSummaryFormat(Yeta3220BM.ATTR_INSUPAYR, NumberFormat.getFormat("#,##0;(#,##0)"));/** column 보험료_건강고용등국세청 : insuPayr */
		 payrSummaryRow.setSummaryFormat(Yeta3220BM.ATTR_INSURTYR, NumberFormat.getFormat("#,##0;(#,##0)"));/** column 보험료보장성_국세청 : insuRtyr */
		 payrSummaryRow.setSummaryFormat(Yeta3220BM.ATTR_PSCLIURR, NumberFormat.getFormat("#,##0;(#,##0)"));/** column 보험료장애인보장성_국세청 : psclIurr */    
		 
		 payrSummaryRow.setSummaryFormat(Yeta3220BM.ATTR_MEDICOST, NumberFormat.getFormat("#,##0;(#,##0)"));/** column 의료비_국세청 : mediCost */  
		 payrSummaryRow.setSummaryFormat(Yeta3220BM.ATTR_EDUCCOST, NumberFormat.getFormat("#,##0;(#,##0)"));/** column 교육비_국세청 : educCost */   
		 
		 payrSummaryRow.setSummaryFormat(Yeta3220BM.ATTR_CDTECARD, NumberFormat.getFormat("#,##0;(#,##0)"));/** column 신용카드등_국세청 : cdteCard */   
		 payrSummaryRow.setSummaryFormat(Yeta3220BM.ATTR_JIBLCARD, NumberFormat.getFormat("#,##0;(#,##0)"));/** column 직불카드등_국세청 : jiblCard */    
		 payrSummaryRow.setSummaryFormat(Yeta3220BM.ATTR_CASHRECE, NumberFormat.getFormat("#,##0;(#,##0)"));/** column 현금영수증_국세청 : cashRece */     
		 payrSummaryRow.setSummaryFormat(Yeta3220BM.ATTR_MGNTSTVD, NumberFormat.getFormat("#,##0;(#,##0)"));/** column 전통시장사용분_국세청 : mgntStvd */   
		 payrSummaryRow.setSummaryFormat(Yeta3220BM.ATTR_GRPYAMNT, NumberFormat.getFormat("#,##0;(#,##0)"));/** column 지로납부액_대중교통_국세청 : grpyAmnt */   
		 
		 payrSummaryRow.setSummaryFormat(Yeta3220BM.ATTR_CTRBAMNT, NumberFormat.getFormat("#,##0;(#,##0)"));/** column 기부금액_국세청 : ctrbAmnt */   
		 
		 
		 yeta300ToYeta3220GridPanel2.getGrid().getColumnModel().addAggregationRow(payrSummaryRow); 
		    
		 
		 cpGrid.add(yeta300ToYeta3220GridPanel2); 
	 ...
	 private LayoutContainer occupationalRBottom3_02() {
		 ...
		 yeta300ToYeta3220GridPanel3 = new MSFGridPanel(Yeta3220Def_02_02, false, false, false, false, false);
		 yeta300ToYeta3220GridPanel3.setHeaderVisible(false);  
		 yeta300ToYeta3220GridPanel3.setBodyBorder(true);
		 yeta300ToYeta3220GridPanel3.setBorders(true);
		 yeta300ToYeta3220GridPanel3.getBottomComponent().setVisible(false);
		 
		 yeta300ToYeta3220GridPanel3.getGrid().getColumnModel().addHeaderGroup(0, 2, new HeaderGroupConfig("보험료", 1, 3));
		 yeta300ToYeta3220GridPanel3.getGrid().getColumnModel().addHeaderGroup(0, 7, new HeaderGroupConfig("신용카드 등 사용액", 1, 5)); 
...
//			GWTUtils.findColumnConfig(yetaP03001GridPanel, Yeta3170BM.ATTR_CTRBAMNT).setStyle("Height:20px;");
		 ...
		 payrSummaryRow.setSummaryType(Yeta3220BM.ATTR_INSUFETC, SummaryType.SUM);   
		 
		 payrSummaryRow.setSummaryType(Yeta3220BM.ATTR_INSURTET, SummaryType.SUM);   
		 payrSummaryRow.setSummaryType(Yeta3220BM.ATTR_PSCLIURT, SummaryType.SUM); 
		 payrSummaryRow.setSummaryType(Yeta3220BM.ATTR_MEDIEXPS, SummaryType.SUM); 
		 
		 payrSummaryRow.setSummaryType(Yeta3220BM.ATTR_EDUCOTEC, SummaryType.SUM);  
		 payrSummaryRow.setSummaryType(Yeta3220BM.ATTR_CDTECDEC, SummaryType.SUM);  
		 
		 payrSummaryRow.setSummaryType(Yeta3220BM.ATTR_JIBLCDEC, SummaryType.SUM);   
//		 payrSummaryRow.setSummaryType(Yeta3220BM.ATTR_TEMP, SummaryType.SUM);   
		 payrSummaryRow.setSummaryType(Yeta3220BM.ATTR_MGNTSDEC, SummaryType.SUM);   
		 payrSummaryRow.setSummaryType(Yeta3220BM.ATTR_GRPYATEC, SummaryType.SUM); 
		 payrSummaryRow.setSummaryType(Yeta3220BM.ATTR_CTRBAMEC, SummaryType.SUM);  
		 
		 
		 payrSummaryRow.setSummaryFormat(Yeta3220BM.ATTR_INSUFETC, NumberFormat.getFormat("#,##0;(#,##0)"));/** column 보험료_건강고용등외 : insuFetc */
		 
		 payrSummaryRow.setSummaryFormat(Yeta3220BM.ATTR_INSURTET, NumberFormat.getFormat("#,##0;(#,##0)"));/** column 보험료보장성외 : insuRtet */
		 payrSummaryRow.setSummaryFormat(Yeta3220BM.ATTR_PSCLIURT, NumberFormat.getFormat("#,##0;(#,##0)"));/** column 보험료장애인보장성외 : psclIurt */   
		 payrSummaryRow.setSummaryFormat(Yeta3220BM.ATTR_MEDIEXPS, NumberFormat.getFormat("#,##0;(#,##0)"));/** column 의료비외 : mediExps */ 
		 
		 payrSummaryRow.setSummaryFormat(Yeta3220BM.ATTR_EDUCOTEC, NumberFormat.getFormat("#,##0;(#,##0)"));/** column 교육비외 : educOtec */  
		 payrSummaryRow.setSummaryFormat(Yeta3220BM.ATTR_CDTECDEC, NumberFormat.getFormat("#,##0;(#,##0)"));/** column 신용카드외 : cdteCdec */ 
		 
		 payrSummaryRow.setSummaryFormat(Yeta3220BM.ATTR_JIBLCDEC, NumberFormat.getFormat("#,##0;(#,##0)"));/** column 직불카드외 : jiblCdec */   
//		 payrSummaryRow.setSummaryFormat(Yeta3220BM.ATTR_TEMP, NumberFormat.getFormat("#,##0;(#,##0)"));	/** column 현금영수증   */  
		 payrSummaryRow.setSummaryFormat(Yeta3220BM.ATTR_MGNTSDEC, NumberFormat.getFormat("#,##0;(#,##0)"));/** column 전통시장사용분외 : mgntSdec */  
		 payrSummaryRow.setSummaryFormat(Yeta3220BM.ATTR_GRPYATEC, NumberFormat.getFormat("#,##0;(#,##0)"));/** column 지로납부액_대중교통외 : grpyAtec */   
		 payrSummaryRow.setSummaryFormat(Yeta3220BM.ATTR_CTRBAMEC, NumberFormat.getFormat("#,##0;(#,##0)"));/** column 기부금액외 : ctrbAmec */  
		 
		 yeta300ToYeta3220GridPanel3.getGrid().getColumnModel().addAggregationRow(payrSummaryRow); 
		    
		 cpGrid.add(yeta300ToYeta3220GridPanel3); 
	 ...
	 private LayoutContainer occupationalRBottom4() {
		 ...
		 yeta300ToYeta3150GridPanel = new MSFGridPanel(Yeta3150Def_01, false, false, false, false, false);
		 yeta300ToYeta3150GridPanel.setHeaderVisible(false);  
		 yeta300ToYeta3150GridPanel.setBodyBorder(true);
		 yeta300ToYeta3150GridPanel.setBorders(true);
		 yeta300ToYeta3150GridPanel.getBottomComponent().setVisible(false);
		    
		 cpGrid.add(yeta300ToYeta3150GridPanel); 
...
//			layoutContainer_18.setHeight("100");
			...
			btnNewButton.addListener(Events.Select, new Listener<ButtonEvent>() {
				public void handleEvent(ButtonEvent e) {
					...
					//전체내역  
					YetaP03006 yetaP03006Form = new YetaP03006(ActionDatabase.READ, getThis());   
							    
					MSFFormWindows msFwYeta03006 = new MSFFormWindows("종전근무지등록", yetaP03006Form, "닫기", "820px", "710px", true);
					msFwYeta03006.show();
					yetaP03006Form.setMSFFormWindows(msFwYeta03006);
...
//										    
//					MSFFormWindows msFwYeta03009 = new MSFFormWindows("주현근무지등록", yetaP03009Form, "닫기", "820px", "710px", true);
//					msFwYeta03009.show();
//					yetaP03009Form.setMSFFormWindows(msFwYeta03009);
//					//TODO 추후 주석해제 
...
//			layoutContainer_49_2.add(btnNewButton1);
			...
			btnNewButton1.addListener(Events.Select, new Listener<ButtonEvent>() {
				public void handleEvent(ButtonEvent e) {
					...
					MSFFormWindows msFwYeta03008 = new MSFFormWindows("현비과세및감면", yetaP03008Form, "닫기", "820px", "710px", true);
					msFwYeta03008.show();
...
////			layoutContainer_52.setHeight("26");
		    ...
		    yeta0300GridPanel = new MSFGridPanel(yeta3000Def_01, false, false, false, false, false);
		    yeta0300GridPanel.setHeaderVisible(false);  
		    yeta0300GridPanel.setBodyBorder(true);
		    yeta0300GridPanel.setBorders(true);
		    yeta0300GridPanel.getBottomComponent().setVisible(false);
		    //
		    cpGrid.add(yeta0300GridPanel); 
		...
		private LayoutContainer yetaData02() {
			...
			btnYeta3220Del.addListener(Events.Select, new Listener<ButtonEvent>() {
				...
				public void handleEvent(ButtonEvent be) {
					...
					Iterator<BaseModel> itBm  = yeta300ToYeta3220GridPanel1.getMsfGrid().getGrid().getSelectionModel().getSelectedItems().listIterator();
		            ...
		            List<Yeta3220DTO> listYeta3220dto = new ArrayList<Yeta3220DTO>(); 
					
//					if((ActionDatabase.INSERT).equals(actionDatabase)) {
//						yeta300ToYeta3220GridPanel1.getMsfGrid().clearData();
//
...
//					}else {
						while (iterRecords.hasNext()) {
							...
							Yeta3220DTO yeta3220Dto = new Yeta3220DTO();  
...
//					}
					...
					yeta0300Service.activityOnYeta0300ToYeta3220(listYeta3220dto, actionDatabase, new AsyncCallback<Long>() {
		 	    			 
						public void onFailure(Throwable caught) {
							MessageBox.alert(MSFMainApp.MSFCONSTANTS.ExceptionTitleService(), 
											MSFMainApp.ADMINMESSAGES.ExceptionMessageService("activityOnYeta0300ToYeta3220(" + actionDatabase.name() + ") : " + caught), null);
						}
...
//			layoutContainer_90.add(occupationalRBottom3());
	...
	private LayoutContainer yetaData04() {
		...
		btnNewButton_9.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				// 전체내역
				YetaP03007 yetaP03007Form = new YetaP03007(ActionDatabase.READ, getThis());

				MSFFormWindows msFwYeta03007 = new MSFFormWindows("연금저축소득공제",yetaP03007Form, "닫기", "820px", "710px", true);
				msFwYeta03007.show();
				yetaP03007Form.setMSFFormWindows(msFwYeta03007);
...
//		cp01.setScrollMode(Scroll.AUTOY);
		...
		tabsItemYeta05.addListener(Events.Select, new Listener<TabPanelEvent>() {
			public void handleEvent(TabPanelEvent e) {
				...
				//탭선택
//				yeta300ToYeta2000Detail(yeta300ToYeta2000GridPanel.getCurrentlySelectedItem(), tabsItemYeta05.getSelectedItem().getId());
...
//		fldstNewFieldset_18.add(layoutContainer_284);
		...
		spciBepf01.setFieldLabel("종현근무지공제액");
...
//		LayoutContainer layoutContainer_301 = new LayoutContainer();
		...
		btnNewButton_15.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				//전체내역  
				YetaP03004 yetaP03004Form = new YetaP03004(ActionDatabase.READ, getThis());   
					    
				MSFFormWindows msFwYeta03004 = new MSFFormWindows("거주자간 주택임차차입금 원리금 상환액", yetaP03004Form, "닫기", "820px", "710px", true);
				msFwYeta03004.show();
				yetaP03004Form.setMSFFormWindows(msFwYeta03004);
...
//		LayoutContainer layoutContainer_302 = new LayoutContainer();
		...
		layoutContainer_314.setLayout(frmlytSch3142);
		  ...
		  btnNewButton_16.addListener(Events.Select, new Listener<ButtonEvent>() {
			  public void handleEvent(ButtonEvent e) {
				  //전체내역  
				  YetaP03005 yetaP03005Form = new YetaP03005(ActionDatabase.READ, getThis());   
						    
				  MSFFormWindows msFwYeta03005 = new MSFFormWindows("월세액소득공제명세", yetaP03005Form, "닫기", "820px", "710px", true);
				  msFwYeta03005.show();
				  yetaP03005Form.setMSFFormWindows(msFwYeta03005);
...
//		cp01.setSize("660", "450");
		...
		etgdH09f = new MSFNumberField();
		
		etgdH09f.setAllowDecimals(true); 
		etgdH09f.setPropertyEditorType(Long.class); 
		etgdH09f.setFormat(NumberFormat.getDecimalFormat());
//		etgdH09f.setEmptyText("10%(20%) 공제율 적용금액");	
		
		layoutContainer_250.add(etgdH09f, new FormData("100%"));
		etgdH09f.setFieldLabel("출자∙투자금액");
		...
		LabelField lblfldNewLabelfield_34 = new LabelField("(2012년도)");
		...
		etgdH13f = new MSFNumberField();
		
		etgdH13f.setAllowDecimals(true); 
		etgdH13f.setPropertyEditorType(Long.class); 
		etgdH13f.setFormat(NumberFormat.getDecimalFormat());
		
		layoutContainer_252.add(etgdH13f, new FormData("100%"));
		etgdH13f.setFieldLabel("출자∙투자금액");
		...
		LabelField lblfldNewLabelfield_35 = new LabelField("(2013년도)");
		...
		layoutContainer_254.add(etgdH14f, new FormData("100%"));
		...
		LabelField lblfldNewLabelfield_36 = new LabelField("(2014년도)");
		...
		layoutContainer_2545.add(etclH15f, new FormData("100%"));
		...
		LabelField lblfldNewLabelfield_366 = new LabelField("(2015년 이후)");
		...
		etgd09af = new NumberField();
		
		etgd09af.setAllowDecimals(true); 
		etgd09af.setPropertyEditorType(Long.class); 
		etgd09af.setFormat(NumberFormat.getDecimalFormat());
		
		layoutContainer_246.add(etgd09af, new FormData("100%"));
		etgd09af.setFieldLabel("공제액");
		...
		etgdH13h = new NumberField();
		
		etgdH13h.setAllowDecimals(true); 
		etgdH13h.setPropertyEditorType(Long.class); 
		etgdH13h.setFormat(NumberFormat.getDecimalFormat());
		
		layoutContainer_247.add(etgdH13h, new FormData("100%"));
		etgdH13h.setFieldLabel("공제액");
	...
	private LayoutContainer yetaData08() {
		...
		tabsItemYeta08.addListener(Events.Select, new Listener<TabPanelEvent>() {
			public void handleEvent(TabPanelEvent e) {
				...
				//탭선택
//				yeta300ToYeta2000Detail(yeta300ToYeta2000GridPanel.getCurrentlySelectedItem(), tabsItemYeta08.getSelectedItem().getId());
...
//		itemYeta08_1.setHeight("400px");
		...
		btnNewButton_10.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				//전체내역  
				YetaP03002 yetaP03002Form = new YetaP03002(ActionDatabase.READ, getThis());   
				    
				MSFFormWindows msFwYeta03002 = new MSFFormWindows("의료비내역등록", yetaP03002Form, "닫기", "820px", "710px", true);
				msFwYeta03002.show();
				yetaP03002Form.setMSFFormWindows(msFwYeta03002);
...
//	      	     }
//				 
//				 yeta300ToYeta3150GridPanel.getMsfGrid().clearData();
//				 
//				 BaseModel bmData = yeta300ToYeta3150GridPanel.getTableDef().getDefaultValues();  
//		              
...
//		              
//		         yeta300ToYeta3150GridPanel.getMsfGrid().getGrid().stopEditing();      
//		         yeta300ToYeta3150GridPanel.getMsfGrid().getGrid().getStore().insert(bmData,0);   
//		         yeta300ToYeta3150GridPanel.getMsfGrid().getGrid().startEditing(yeta300ToYeta3150GridPanel.getMsfGrid().getGrid().getStore().indexOf(bmData), 0);   
//>>>>>>> .r1544
...
//				Iterator<Record> iterRecords = yeta300ToYeta3150GridPanel.getMsfGrid().getGrid().getStore().getModifiedRecords().iterator(); 
				Iterator<BaseModel> itBm  = yeta300ToYeta3150GridPanel.getMsfGrid().getGrid().getSelectionModel().getSelectedItems().listIterator();
				...
				List<Yeta3150DTO> listYeta3150dto = new ArrayList<Yeta3150DTO>();  
				...
				while (iterRecords.hasNext()) {
					...
					Yeta3150DTO yeta3150Dto = new Yeta3150DTO();  
				...
				yeta0300Service.saveYeta0300To2000tabItem08_3(listYeta3150dto, actionDatabase, new AsyncCallback<Long>() {
...
//		layoutContainer_376.setLayout(new ColumnLayout());
		...
		btnNewButton_13.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				//전체내역  
				YetaP03001 yetaP03001Form = new YetaP03001(ActionDatabase.READ, getThis());   
				    
				MSFFormWindows msFwYeta03001 = new MSFFormWindows("이월기부금등록", yetaP03001Form, "닫기", "820px", "710px", true);
				msFwYeta03001.show();
				yetaP03001Form.setMSFFormWindows(msFwYeta03001);
		...
		btnNewButton_14.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				//전체내역  
				YetaP03003 yetaP03003Form = new YetaP03003(ActionDatabase.READ, getThis());   
				    
				MSFFormWindows msFwYeta03003 = new MSFFormWindows("기부금내역등록", yetaP03003Form, "닫기", "820px", "710px", true);
				msFwYeta03003.show();
				yetaP03003Form.setMSFFormWindows(msFwYeta03003);
...
//	                        yeta3220Dto.setSettGbcd(MSFSharedUtils.allowNulls(bmMapModel.get("settGbcd")));    /** column 정산구분코드 : settGbcd */
				...
				public void handleEvent(BaseEvent be) {
					...
					if (mapModels != null) { 
						...
						yeta0300Service.saveYeta0300To2000tabItem08_3(listYeta3150dto, actionDatabase, new AsyncCallback<Long>() {
							...
							public void onFailure(Throwable caught) {
								MessageBox.alert(MSFMainApp.MSFCONSTANTS.ExceptionTitleService(), 
												MSFMainApp.ADMINMESSAGES.ExceptionMessageService("activityOnYeta0300ToYeta3150(" + actionDatabase.name() + ") : " + caught), null);
							}
							public void onSuccess(Long result) {  
								reloadYeta3150Grid();
	...
	public void itemYeta01Save() {
		...
		yeta2000Dto.setResdFlag(YetaUtils.getCheckedRadioValue(resdFlag));	//세대주
		...
		yeta0300Service.saveYeta0300To2000tabItem01(yeta2000Dto, new AsyncCallback<Integer>() {
			@Override
			public void onFailure(Throwable caught) {
				// TODO Auto-generated method stub
					MessageBox.alert(MSFMainApp.MSFCONSTANTS.ExceptionTitleService(), 
...
//					yeta300ToYeta2000Detail(yeta300ToYeta2000GridPanel.getCurrentlySelectedItem(), "itemYeta01");
	...
	public void itemYeta02Save() {
		...
		Iterator<Record> iterRecords = yeta300ToYeta3220GridPanel1.getMsfGrid().getGrid().getStore().getModifiedRecords().iterator(); 
...
//				yeta300ToYeta2000Detail(yeta300ToYeta2000GridPanel.getCurrentlySelectedItem(), "itemYeta01");
	...
	public void itemYeta03Save() {
		...
		//국세청자료 grid
		Iterator<Record> iterRecords = yeta300ToYeta3220GridPanel2.getMsfGrid().getGrid().getStore().getModifiedRecords().iterator(); 
		
		List<Yeta3220DTO> listYeta3220_1dto = new ArrayList<Yeta3220DTO>();  
		...
		//기타자료 grid
		iterRecords = yeta300ToYeta3220GridPanel3.getMsfGrid().getGrid().getStore().getModifiedRecords().iterator(); 
		
		List<Yeta3220DTO> listYeta3220_2dto = new ArrayList<Yeta3220DTO>();  
		...
		yeta0300Service.saveYeta0300To2000tabItem03(listYeta3220_1dto, listYeta3220_2dto, new AsyncCallback<Integer>() {
...
//				reload();
				//선택된 값을 우측 그리드에 넣기 위한 메서드 호출 
//				yeta300ToYeta2000Detail(yeta300ToYeta2000GridPanel.getCurrentlySelectedItem(), "itemYeta03");
				//reFresh("itemYeta03");
				reFresh();
			}	
		});
...
//			yeta2000Dto.setBnatPsnf((Long) bnatPsnf.getValue());//종근무지_국민연금보험료
			...
			yeta0300Service.saveYeta0300To2000tabItem04(yeta2000Dto, new AsyncCallback<Integer>() {
...
//						yeta300ToYeta2000Detail(yeta300ToYeta2000GridPanel.getCurrentlySelectedItem(), "itemYeta01");
	...
	public void itemYeta05_1Save() {
			...
			yeta0300Service.saveYeta0300To2000tabItem05_1(yeta2000Dto, new AsyncCallback<Integer>() {
...
//						yeta300ToYeta2000Detail(yeta300ToYeta2000GridPanel.getCurrentlySelectedItem(), "itemYeta01");
	...
	public void itemYeta05_2Save() {
			...
			yeta0300Service.saveYeta0300To2000tabItem05_2(yeta2000Dto, new AsyncCallback<Integer>() {
...
//						yeta300ToYeta2000Detail(yeta300ToYeta2000GridPanel.getCurrentlySelectedItem(), "itemYeta01");
	...
	//	yeta2000Dto.setSettGbcd(MSFSharedUtils.getSelectedComboValue(srhSettGbcd, "commCd")); 	/** column 정산구분코드 : settGbcd */
		...
		yeta2000Dto.setEtgdH09f((Long) etgdH09f.getValue()); 	// 기타공제_투자조합출자금액_2012년도
		yeta2000Dto.setEtgdH13f((Long) etgdH13f.getValue()); 	// 기타공제_투자조합출자금액_2013년도
		yeta2000Dto.setEtgdH14f((Long) etgdH14f.getValue()); 	// 기타공제_투자조합출자금액_2014년도
		yeta2000Dto.setEtclH15f((Long) etclH15f.getValue());	// 기타공제_투자조합출자금액_2015년이후
		...
		yeta2000Dto.setEtadD14l((Long) etadD14l.getValue());	//기타공제_본인추가공제율사용액_2014하
		...
		yeta0300Service.saveYeta0300To2000tabItem06(yeta2000Dto, new AsyncCallback<Integer>() {
			@Override
			public void onFailure(Throwable caught) {
				// TODO Auto-generated method stub
					MessageBox.alert(MSFMainApp.MSFCONSTANTS.ExceptionTitleService(), 
...
//					yeta300ToYeta2000Detail(yeta300ToYeta2000GridPanel.getCurrentlySelectedItem(), "itemYeta01");
	...
	public void itemYeta07Save() {
		...
		yeta0300Service.saveYeta0300To2000tabItem07(yeta2000Dto, new AsyncCallback<Integer>() {
			@Override
			public void onFailure(Throwable caught) {
				// TODO Auto-generated method stub
					MessageBox.alert(MSFMainApp.MSFCONSTANTS.ExceptionTitleService(), 
...
//					yeta300ToYeta2000Detail(yeta300ToYeta2000GridPanel.getCurrentlySelectedItem(), "itemYeta01");
	...
	//	yeta2000Dto.setSettGbcd(MSFSharedUtils.getSelectedComboValue(srhSettGbcd, "commCd")); 	/** column 정산구분코드 : settGbcd */
		...
		yeta0300Service.saveYeta0300To2000tabItem08_1(yeta2000Dto, new AsyncCallback<Integer>() {
			@Override
			public void onFailure(Throwable caught) {
				// TODO Auto-generated method stub
					MessageBox.alert(MSFMainApp.MSFCONSTANTS.ExceptionTitleService(), 
...
//					yeta300ToYeta2000Detail(yeta300ToYeta2000GridPanel.getCurrentlySelectedItem(), "itemYeta01");
	...
	public void itemYeta08_3Save() {
		...
		yeta0300Service.saveYeta0300To2000tabItem08_3(yeta2000Dto, new AsyncCallback<Integer>() {
			@Override
			public void onFailure(Throwable caught) {
				// TODO Auto-generated method stub
					MessageBox.alert(MSFMainApp.MSFCONSTANTS.ExceptionTitleService(), 
			...
			public void onSuccess(Integer result) {
				...
				if (result == 0) {
					...
					//Iterator<Record> iterRecords = yeta300ToYeta3150GridPanel.getMsfGrid().getGrid().getStore().getModifiedRecords().iterator(); 
//			           
//					 Iterator<BaseModel> itBm  = yeta300ToYeta3150GridPanel.getMsfGrid().getGrid().getStore().getModels().listIterator();   
//			          
//			          List<Record>  lsRec  = new ArrayList<Record>();
//			          
//			          while(itBm.hasNext()) {
...
//					yeta300ToYeta2000Detail(yeta300ToYeta2000GridPanel.getCurrentlySelectedItem(), "itemYeta01");
		...
		while (iterRecords.hasNext()) {
			...
			yeta3150Dto.setEdacDtnu((Long) bmMapModel.get("edacDtnu"));	/** column 교육비가족상세일련번호 : edacDtnu */
			yeta3150Dto.setEdacRvyy(MSFSharedUtils.allowNulls(bmMapModel.get("edacRvyy")));		/** set 정산구분코드 : settGbcd */
			yeta3150Dto.setSettGbcd(MSFSharedUtils.allowNulls(bmMapModel.get("settGbcd")));		/** column 정산구분코드 : settGbcd */
			yeta3150Dto.setDpobCd(MSFSharedUtils.allowNulls(bmMapModel.get("dpobCd")));    		/** column 사업장코드 : dpobCd */
			yeta3150Dto.setSystemkey(MSFSharedUtils.allowNulls(bmMapModel.get("systemkey")));	/** column SYSTEMKEY : systemkey */
			...
			yeta3150Dto.setFmacGbcd(MSFSharedUtils.allowNulls(bmMapModel.get("fmacGbcd$commCd")));	/** column 가족학력구분코드 : fmacGbcd */
			yeta3150Dto.setEdacOtam((Long) bmMapModel.get("edacOtam"));	/** column 교육비지급금액 : edacOtam */
			yeta3150Dto.setRsnoNumb(MSFSharedUtils.allowNulls(bmMapModel.get("rsnoNumb")));			/** set 가족주민등록번호 : rsnoNumb */
	...
	public void itemYeta09Save() {
		...
		yeta0300Service.saveYeta0300To2000tabItem09(yeta2000Dto, new AsyncCallback<Integer>() {
			@Override
			public void onFailure(Throwable caught) {
				// TODO Auto-generated method stub
					MessageBox.alert(MSFMainApp.MSFCONSTANTS.ExceptionTitleService(), 
...
//					yeta300ToYeta2000Detail(yeta300ToYeta2000GridPanel.getCurrentlySelectedItem(), "itemYeta01");
	...
	public void itemYeta10Save() {
		...
		yeta0300Service.saveYeta0300To2000tabItem10(yeta2000Dto, new AsyncCallback<Integer>() {
			@Override
			public void onFailure(Throwable caught) {
				// TODO Auto-generated method stub
					MessageBox.alert(MSFMainApp.MSFCONSTANTS.ExceptionTitleService(), 
...
//					yeta300ToYeta2000Detail(yeta300ToYeta2000GridPanel.getCurrentlySelectedItem(), "itemYeta01");
	...
	public void reload() {
		...
		yeta300ToYeta2000GridPanel.getTableDef().setTableColumnFilters(filters);
		
		yeta300ToYeta2000GridPanel.getTableDef().addColumnFilter("edacRvyy", MSFSharedUtils.getSelectedComboValue(srhEdacRvyy, "year"), SimpleColumnFilter.OPERATOR_EQUALS);
		
		yeta300ToYeta2000GridPanel.getTableDef().addColumnFilter("settGbcd", MSFSharedUtils.getSelectedComboValue(srhSettGbcd, "commCd"), SimpleColumnFilter.OPERATOR_EQUALS);
		
		yeta300ToYeta2000GridPanel.getTableDef().addColumnFilter("payrMangDeptCd", MSFSharedUtils.getSelectedComboValue(srhPayrMangDeptCd,"payrMangDeptCd"), SimpleColumnFilter.OPERATOR_EQUALS);
		yeta300ToYeta2000GridPanel.getTableDef().addColumnFilter("emymtDivCd", MSFSharedUtils.getSelectedComboValue(srhEmymtDivCd,"commCd"), SimpleColumnFilter.OPERATOR_EQUALS); 
		String strDeptCd =YetaUtils.getStrValToBMMultiCombo(lsDeptCd, srhDeptCd.getValue(),"deptNmRtchnt","deptCd");  
		yeta300ToYeta2000GridPanel.getTableDef().addColumnFilter("deptCd", strDeptCd , SimpleColumnFilter.OPERATOR_EQUALS);
		           
		String strTypOccuCd = YetaUtils.getStrValToBMMultiCombo(lsTypOccuCd,srhTypOccuCd.getValue(),"typOccuNm","typOccuCd"); 
		yeta300ToYeta2000GridPanel.getTableDef().addColumnFilter("typOccuCd", strTypOccuCd, SimpleColumnFilter.OPERATOR_EQUALS); 
		...
		yeta300ToYeta2000GridPanel.getTableDef().addColumnFilter("dtilOccuInttnCd", strDtilOccuInttnCd, SimpleColumnFilter.OPERATOR_EQUALS); 
		       
		yeta300ToYeta2000GridPanel.getTableDef().addColumnFilter("businCd", MSFSharedUtils.getSelectedComboValue(srhBusinCd,"businCd"), SimpleColumnFilter.OPERATOR_EQUALS);
		yeta300ToYeta2000GridPanel.getTableDef().addColumnFilter("systemkey", MSFSharedUtils.allowNulls(srhSystemkey.getValue()), SimpleColumnFilter.OPERATOR_EQUALS);
		yeta300ToYeta2000GridPanel.getTableDef().addColumnFilter("hanNm", MSFSharedUtils.allowNulls(srhHanNm.getValue()), SimpleColumnFilter.OPERATOR_EQUALS);    
		yeta300ToYeta2000GridPanel.getTableDef().addColumnFilter("resnRegnNum", MSFSharedUtils.allowNulls(srhResnRegnNum.getValue()), SimpleColumnFilter.OPERATOR_EQUALS);  
		
		yeta300ToYeta2000GridPanel.getTableDef().addColumnFilter("printType", YetaUtils.getCheckedRadioValue(printType), SimpleColumnFilter.OPERATOR_EQUALS);  
		
		yeta300ToYeta2000GridPanel.reload(); 
      
	}
	
	
	/** 대상자에 따른 정보 가져옴 **/
	private void yeta300ToYeta2000Detail2(Yeta2000BM result) {
	//	private void yeta300ToYeta2000Detail2(Yeta2000BM result, String tabId) {
		//if("itemYeta01".equals(tabId)){//기본사항탭을 선택하였을 경우
			if (MSFSharedUtils.paramNotNull(yeta300ToYeta2000GridPanel.getCurrentlySelectedItem())){	
				...
				alryPhbx.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getAlryPhbx(), "0")));//지방소득세_주현근무지기납부세액 
				 ...
				 IColumnFilter filters = null;
	        	   ...
	        	   yeta0300GridPanel.getTableDef().setTableColumnFilters(filters); 
	       	   	   yeta0300GridPanel.getTableDef().addColumnFilter("edacRvyy", edacRvyy.getValue(), SimpleColumnFilter.OPERATOR_EQUALS); 
	       		   yeta0300GridPanel.getTableDef().addColumnFilter("settGbcd", settGbcd.getValue(), SimpleColumnFilter.OPERATOR_EQUALS); 
	       		   yeta0300GridPanel.getTableDef().addColumnFilter("systemkey", systemkey.getValue(), SimpleColumnFilter.OPERATOR_EQUALS); 
	       		   yeta0300GridPanel.reload();
			}
		...
		//}else if("itemYeta06".equals(tabId)){ //그밖의소득공제1
			...
			if (MSFSharedUtils.paramNotNull(yeta300ToYeta2000GridPanel.getCurrentlySelectedItem())){	
				...
				etgdH14f.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getEtgdH14f(),"0")));	//출자.투자금액_2014년도
				etclH15f.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getEtclH15f(),"0")));	//출자.투자금액_2015년도 이후
				...
				etgdD14f.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getEtgdD14f(),"0")));	//공제액_출자.투자금액_2014년도
				etgdD15f.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getEtgdD15f(),"0")));	//공제액_출자.투자금액_2015년도 이후
				...
				etadD14l.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(result.getEtadD14l(),"0")));	//추가공제율(본인20134년하)
	...
	/** 대상자에 따른 정보 가져옴 **/
//	private void yeta300ToYeta2000Detail(BaseModel selRecord, String tabId) {
//		if("itemYeta01".equals(tabId)){//기본사항탭을 선택하였을 경우
...
////				Iterator<Record> iterRecords = yeta300ToYeta3220GridPanel1.getMsfGrid().getGrid().getStore().getModifiedRecords().iterator(); 
////		        
////				beforeJumin = new ArrayList<Yeta3220DTO>();  
////				
////				while (iterRecords.hasNext()) {
////				       
////					Record recData = (Record) iterRecords.next(); 
...
//				
//				etgdH09f.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(selRecord.get("etgdH09f"),"0")));	//출자.투자금액_2012년도
//				etgdH13f.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(selRecord.get("etgdH13f"),"0")));	//출자.투자금액_2013년도
//				etgdH14f.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(selRecord.get("etgdH14f"),"0")));	//출자.투자금액_2014년도
//				etclH15f.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(selRecord.get("etclH15f"),"0")));	//출자.투자금액_2015년도 이후
//				etgdHdam.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(selRecord.get("etgdHdam"),"0")));	//출자.투자금액계
//				
//				etgd09af.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(selRecord.get("etgd09af"),"0")));	//공제액_출자.투자금액_2012년도
//				etgdH13h.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(selRecord.get("etgdH13h"),"0")));	//공제액_출자.투자금액_2013년도
//				etgdD14f.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(selRecord.get("etgdD14f"),"0")));	//공제액_출자.투자금액_2014년도
//				etgdD15f.setValue(MSFSharedUtils.convertStringToLong(MSFSharedUtils.defaultNulls(selRecord.get("etgdD15f"),"0")));	//공제액_출자.투자금액_2015년도 이후
...
//	}
	...
	private void reloadYeta3220_item02Grid(){
		...
		yeta300ToYeta3220GridPanel1.getTableDef().setTableColumnFilters(filters);
		
		yeta300ToYeta3220GridPanel1.getTableDef().addColumnFilter("dpobCd", MSFSharedUtils.allowNulls(dpobCd.getValue()), SimpleColumnFilter.OPERATOR_EQUALS);
		yeta300ToYeta3220GridPanel1.getTableDef().addColumnFilter("systemkey", MSFSharedUtils.allowNulls(systemkey.getValue()), SimpleColumnFilter.OPERATOR_EQUALS);
		yeta300ToYeta3220GridPanel1.getTableDef().addColumnFilter("settGbcd", MSFSharedUtils.allowNulls(settGbcd.getValue()), SimpleColumnFilter.OPERATOR_EQUALS); 
		yeta300ToYeta3220GridPanel1.getTableDef().addColumnFilter("edacRvyy", MSFSharedUtils.allowNulls(edacRvyy.getValue()), SimpleColumnFilter.OPERATOR_EQUALS); 
			
		yeta300ToYeta3220GridPanel1.reload();
		
//		Iterator<Record> iterRecords = yeta300ToYeta3220GridPanel1.getMsfGrid().getGrid().getStore().getRecord(model); 
//        
//		beforeJumin = new ArrayList<Yeta3220DTO>();  
//		
//		while (iterRecords.hasNext()) {
...
//		}  
	...
	private void reloadYeta3220_item03Grid(){
		...
		yeta300ToYeta3220GridPanel2.getTableDef().setTableColumnFilters(filters);
		
		yeta300ToYeta3220GridPanel2.getTableDef().addColumnFilter("dpobCd", MSFSharedUtils.allowNulls(dpobCd.getValue()), SimpleColumnFilter.OPERATOR_EQUALS);
		yeta300ToYeta3220GridPanel2.getTableDef().addColumnFilter("systemkey", MSFSharedUtils.allowNulls(systemkey.getValue()), SimpleColumnFilter.OPERATOR_EQUALS);
		yeta300ToYeta3220GridPanel2.getTableDef().addColumnFilter("settGbcd", MSFSharedUtils.allowNulls(settGbcd.getValue()), SimpleColumnFilter.OPERATOR_EQUALS); 
		yeta300ToYeta3220GridPanel2.getTableDef().addColumnFilter("edacRvyy", MSFSharedUtils.allowNulls(edacRvyy.getValue()), SimpleColumnFilter.OPERATOR_EQUALS); 
			
		yeta300ToYeta3220GridPanel2.reload();
		
		yeta300ToYeta3220GridPanel3.getTableDef().setTableColumnFilters(filters);
		
		yeta300ToYeta3220GridPanel3.getTableDef().addColumnFilter("dpobCd", MSFSharedUtils.allowNulls(dpobCd.getValue()), SimpleColumnFilter.OPERATOR_EQUALS);
		yeta300ToYeta3220GridPanel3.getTableDef().addColumnFilter("systemkey", MSFSharedUtils.allowNulls(systemkey.getValue()), SimpleColumnFilter.OPERATOR_EQUALS);
		yeta300ToYeta3220GridPanel3.getTableDef().addColumnFilter("settGbcd", MSFSharedUtils.allowNulls(settGbcd.getValue()), SimpleColumnFilter.OPERATOR_EQUALS); 
		yeta300ToYeta3220GridPanel3.getTableDef().addColumnFilter("edacRvyy", MSFSharedUtils.allowNulls(edacRvyy.getValue()), SimpleColumnFilter.OPERATOR_EQUALS); 
			
		yeta300ToYeta3220GridPanel3.reload();
		
//		yeta300ToYeta3220GridPanel4.getTableDef().setTableColumnFilters(filters);
//		
//		yeta300ToYeta3220GridPanel4.getTableDef().addColumnFilter("dpobCd", MSFSharedUtils.allowNulls(dpobCd.getValue()), SimpleColumnFilter.OPERATOR_EQUALS);
//		yeta300ToYeta3220GridPanel4.getTableDef().addColumnFilter("systemkey", MSFSharedUtils.allowNulls(systemkey.getValue()), SimpleColumnFilter.OPERATOR_EQUALS);
//		yeta300ToYeta3220GridPanel4.getTableDef().addColumnFilter("settGbcd", MSFSharedUtils.allowNulls(settGbcd.getValue()), SimpleColumnFilter.OPERATOR_EQUALS); 
//		yeta300ToYeta3220GridPanel4.getTableDef().addColumnFilter("edacRvyy", MSFSharedUtils.allowNulls(edacRvyy.getValue()), SimpleColumnFilter.OPERATOR_EQUALS); 
//			
//		yeta300ToYeta3220GridPanel4.reload();
	}
	...
	private void reloadYeta3150Grid(){
		...
		yeta300ToYeta3150GridPanel.getTableDef().setTableColumnFilters(filters);
			
		yeta300ToYeta3150GridPanel.getTableDef().addColumnFilter("dpobCd", MSFSharedUtils.allowNulls(dpobCd.getValue()), SimpleColumnFilter.OPERATOR_EQUALS);
		yeta300ToYeta3150GridPanel.getTableDef().addColumnFilter("systemkey", MSFSharedUtils.allowNulls(systemkey.getValue()), SimpleColumnFilter.OPERATOR_EQUALS); 
		yeta300ToYeta3150GridPanel.getTableDef().addColumnFilter("settGbcd", MSFSharedUtils.allowNulls(settGbcd.getValue()), SimpleColumnFilter.OPERATOR_EQUALS); 
		yeta300ToYeta3150GridPanel.getTableDef().addColumnFilter("edacRvyy", MSFSharedUtils.allowNulls(edacRvyy.getValue()), SimpleColumnFilter.OPERATOR_EQUALS); 
			
		yeta300ToYeta3150GridPanel.reload();
	}
	...
	public void resetYeta300ToYeta2000Grid() {
		yeta300ToYeta2000GridPanel.getMsfGrid().clearData();
	}
	...
	public void resetItemYeta01() {  
		...
		yeta0300GridPanel.getMsfGrid().clearData();
...
//		   yeta300ToYeta3220GridPanel4.getMsfGrid().clearData(); 
		   yeta300ToYeta3220GridPanel2.getMsfGrid().clearData(); 
		   yeta300ToYeta3220GridPanel3.getMsfGrid().clearData(); 
...
//		  chkADDC_PFYN02.Checked := False;
	...
	//	private void reFresh(final String tabId) {
		...
		Yeta2000BM yeta2000Bm = new Yeta2000BM();
    	...
    	if (MSFSharedUtils.paramNotNull(yeta300ToYeta2000GridPanel.getCurrentlySelectedItem())){	
    		   ...
    		   yeta0300Service.resultListYeta2000(yeta2000Bm, new AsyncCallback<Yeta2000BM>() {
    			...
    			@Override
    			public void onSuccess(Yeta2000BM result) {
    			// TODO Auto-generated method stub
    				
    				//선택된 탭에 따라 대상자 정보 출력
    			//	yeta300ToYeta2000Detail2(result, tabId);
    				yeta300ToYeta2000Detail2(result);
