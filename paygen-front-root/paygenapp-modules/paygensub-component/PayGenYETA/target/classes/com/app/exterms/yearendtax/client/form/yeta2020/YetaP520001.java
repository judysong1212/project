...
=====================================================**/
public  class YetaP520001   extends MSFFormPanel {  
	...
	private MSFGridPanel yetaPdfB201yGridPanel; //실손의료비
	...
	private TabPanel tabYetaP520001;
	 ...
	 *~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ 		
	 **/ 		    
	public YetaP520001(final ActionDatabase actionDatabase, final MSFPanel caller) {
	...
	private void createStandardForm() {
		...
		tabYetaP520001 = new TabPanel(); // 인사탭정보설정을 위한 tab
		tabYetaP520001.setStyleAttribute("paddingTop", "3px");
		tabYetaP520001.setStyleAttribute("paddingLeft", "2px");
		// tabsBass0350.setMinTabWidth(80);
		tabYetaP520001.setAutoWidth(false);
		// tabsBass0350.setResizeTabs(true);
		tabYetaP520001.setAnimScroll(true);
		tabYetaP520001.setTabScroll(true);
		tabYetaP520001.setPlain(true);
		tabYetaP520001.setSize(885, 595);
		...
		tabYetaP520001.add(item_PDF_A102Y);
		...
		tabYetaP520001.add(item_PDF_B101Y);
		...
		tabYetaP520001.add(item_PDF_B201Y);
		...
		tabYetaP520001.add(item_PDF_C101Y);
		...
		tabYetaP520001.add(item_PDF_C202Y);
		...
		tabYetaP520001.add(item_PDF_C301Y);
		...
		tabYetaP520001.add(item_PDF_C401Y);
		...
		tabYetaP520001.add(item_PDF_D101Y);
		...
		tabYetaP520001.add(item_PDF_E102Y);
		...
		tabYetaP520001.add(item_PDF_F102Y);
		...
		tabYetaP520001.add(item_PDF_G107Y);
		...
		tabYetaP520001.add(item_PDF_G207Y);
		...
		tabYetaP520001.add(item_PDF_G307Y);
		...
		tabYetaP520001.add(item_PDF_G407Y);
		...
		tabYetaP520001.add(item_PDF_J101Y);
		...
		tabYetaP520001.add(item_PDF_J301Y);
		...
		tabYetaP520001.add(item_PDF_J401Y);
		...
		tabYetaP520001.add(item_PDF_K101Y);
		...
		tabYetaP520001.add(item_PDF_N101Y);
		...
		tabYetaP520001.add(item_PDF_O101Y);
		...
		tabYetaP520001.add(item_PDF_P102Y);

		fieldSet.add(tabYetaP520001);
	...
	private void formInit() {
		...
		//		YetaP520001GridPanel.getMsfGrid().clearData();
