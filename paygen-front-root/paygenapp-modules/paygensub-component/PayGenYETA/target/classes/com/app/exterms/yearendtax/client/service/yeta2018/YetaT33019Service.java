...
@RemoteServiceRelativePath("YetaT33019Service.gwt")
public interface YetaT33019Service extends RemoteService {
	/**
	 * Utility class for simplifying access to the instance of async service.
	 */
	public static class Util {
		private static YetaT33019ServiceAsync instance;
		public static YetaT33019ServiceAsync getInstance(){
			if (instance == null) {
				instance = GWT.create(YetaT33019Service.class);
			}
			return instance;
		}
	}
