 ...
 */
public class Ye165010BM   extends MSFSimpleBaseModel implements IsSerializable  {
    ...
    public static final String ATTR_CONBCHGCD = "conbChgCd";
    ...
    public static final String ATTR_CNBTRLTCHGCD = "cnbtRltChgCd";
    ...
    /** set 기부금기타 : cnbtEtc */
    public static final String ATTR_CNBTETC = "cnbtEtc";
    ...
    /** 일괄등록 처리   */
     public Ye165010BM(
     	...
     	values.put(ATTR_CONBCHGCD,conbChgCd);
     	...
     	values.put(ATTR_CNBTRLTCHGCD,cnbtRltChgCd);
     	...
     	values.put(ATTR_CNBTETC,cnbtEtc);
    ...
    /** set 기부유형전환코드 : conbChgCd */
    public void setConbChgCd(String  conbChgCd) { set( ATTR_CONBCHGCD ,conbChgCd);}
    /** get 기부유형전환코드 : conbChgCd */
    public String  getConbChgCd() { return (String )get( ATTR_CONBCHGCD );}
    /** set 기부국세자료구분코드 : yrsMateClCd */
    public void setYrsMateClCd(String  yrsMateClCd) { set( ATTR_YRSMATECLCD ,yrsMateClCd);}
    /** get 기부국세자료구분코드 : yrsMateClCd */
    ...
    /** set 기부자관계전환코드 : cnbtRltChgCd */
    public void setCnbtRltChgCd(String  cnbtRltChgCd) { set( ATTR_CNBTRLTCHGCD ,cnbtRltChgCd);}
    /** get 기부자관계전환코드 : cnbtRltChgCd */
    public String  getCnbtRltChgCd() { return (String )get( ATTR_CNBTRLTCHGCD );}
    /** set 기부자성명 : cnbtFnm */
    ...
    /** set 기부금기타 : cnbtEtc */
    public void setCnbtEtc(String  cnbtEtc) { set( ATTR_CNBTETC ,cnbtEtc);}
    /** get 기부금기타 : cnbtEtc */
    public String  getCnbtEtc() { return (String )get( ATTR_CNBTETC );}
    /** set 입력자 : kybdr */
