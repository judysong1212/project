...
import com.app.exterms.yearendtax.client.dto.yeta2018.Ye161090BM;
...
import com.app.exterms.yearendtax.client.service.yeta2018.YetaP330011ServiceAsync;
...
=====================================================**/
public  class YetaP330011   extends MSFFormPanel {  
 ...
 **/
	...
	private Ye161090Def ye161090Def_01  		= new Ye161090Def("YETA330001");
	private Ye161090Def ye161090Def_02  		= new Ye161090Def("YETA330002");
	// -------------- grid 선언 종료  ---------------	
   ...
   */
	...
	private YetaP330011ServiceAsync yetaP330011Service = YetaP330011Service.Util.getInstance();
...
//		 }
	...
	public YetaP330011(final ActionDatabase actionDatabase, final MSFPanel caller) {
		...
		popBindingCom0160.addListener(Events.Change, new Listener<BaseEvent>() {
			public void handleEvent(BaseEvent be) {
				...
				if (mapModels != null) {
					...
					yetaP330011Service.saveYeta3300ToYe161090tabItem08_3(listYe161090Dto, actionDatabase, new AsyncCallback<Long>() {
