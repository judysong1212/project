...
=====================================================**/
public class PrgmComP0110  extends Lov implements PrgmComDaoConstants { 
...
public static void setTypOccuCd(ComboBox<BaseModel> typOccuCd) {
	PrgmComP0110.typOccuCd = typOccuCd;
}
...
public static void setEmymtDivCd(ComboBox<BaseModel> emymtDivCd) {
	PrgmComP0110.emymtDivCd = emymtDivCd;
}
...
public static void setResnRegnNum(TextField<String> resnRegnNum) {
	PrgmComP0110.resnRegnNum = resnRegnNum;
}
...
public static void setSystemkey(HiddenField<String> systemkey) {
	PrgmComP0110.systemkey = systemkey;
}
...
public static void setHdofcCodtnCd(ComboBox<BaseModel> hdofcCodtnCd) {
	PrgmComP0110.hdofcCodtnCd = hdofcCodtnCd;
}

public PrgmComP0110(int width, int height) {
        this();
        this.width  = width;
        this.height = height;
    }
