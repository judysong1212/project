...
import com.app.exterms.prgm.client.service.PrgmComPayrP405001Service;
 ...
 */
@Service("PrgmComPayrP405001Service")  
public class PrgmComPayrP405001ServiceImpl extends AbstractCustomServiceImpl implements PrgmComDaoConstants, PrgmComPayrP405001Service{

	private static final Logger logger = LoggerFactory.getLogger(PrgmComPayrP405001ServiceImpl.class);

	public PrgmComPayrP405001ServiceImpl() {
	 ...
	 * @throws MSFException
	 */
	public PagingLoadResult<BaseModel> getPrgmComPopupPayr405001Payr0304List(ServiceParameters serviceParameters) throws MSFException {
		
		PagingLoadResult<BaseModel> retval = null;
		String method =  PRGMCOM_METHOD_POPUP_PAYR405001_PAYR0304_List;
...
//		}
		...
		try {
			...
			sysComSrhVo.setPymtYrMnth(MSFSharedUtils.allowNulls(MSFServerUtils.getFilterValue(columnFilters, "pymtYrMnth")));
			sysComSrhVo.setPayCd(MSFSharedUtils.allowNulls(MSFServerUtils.getFilterValue(columnFilters, "payCd")));
			...
			if ( pagingValues.executeRecordCount ) { 
				...
				int iResultCnt = payr0304DAO.selectPayrP405001ListTotCnt(sysComSrhVo);  
			...
			TimingInfo millisBeginSelectPayrP405001List = SmrmfUtils.startTiming(logger);
			...
			List list = payr0304DAO.selectPayrP405001List(sysComSrhVo);
			...
			SmrmfUtils.endTiming(logger, millisBeginSelectPayrP405001List, "selectPayrP405001List");
