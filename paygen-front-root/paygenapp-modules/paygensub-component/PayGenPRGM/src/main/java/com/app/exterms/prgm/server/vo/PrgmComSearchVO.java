 ...
 */
public class PrgmComSearchVO implements Serializable {
 ...
 * @brief date:2018 2018. 2. 27. user:atres
 ...
 * @brief date:2017 2017. 8. 8. user:atres
...
public void setDtilOccuClsUseYn(java.lang.String dtilOccuClsUseYn) {
	...
	/**
	 * Comment : 공통코드 가져오기 구분
	 * @fn String getCommUseYn()
	 * @brief date:2017 2017. 9. 15. user:atres
	 * @return the commUseYn get
	 */
	public String getCommUseYn() {
		return commUseYn;
	}

	/**
	 * Comment : 공통코드 가져오기 구분
	 *@fn void setCommUseYn(String commUseYn)
	 *@brief date:2017 2017. 9. 15. user:atres
	 *@param commUseYn the commUseYn to set
	 */
	public void setCommUseYn(String commUseYn) {
		this.commUseYn = commUseYn;
	}

	/**
	 * Comment : 부서사용여부
	 * @fn java.lang.String getDeptUseYn()
	 * @brief date:2017 2017. 9. 15. user:atres
	 * @return the deptUseYn get
	 */
	...
	/**
	 * Comment : 부서사용여부
	 *@fn void setDeptUseYn(java.lang.String deptUseYn)
	 *@brief date:2017 2017. 9. 15. user:atres
	 *@param deptUseYn the deptUseYn to set
	 */
	...
	/**
	 * Comment : 귀속년도
	 *@fn void getYrtxBlggYr(java.lang.String yrtxBlggYr)
	 *@brief date:2017 2017. 11. 01. user:atres
	 *@param deptUseYn the yrtxBlggYr to set
	 */
	...
	/**
	 * Comment : 지급년월
	 *@fn void getPymtYrMnth(java.lang.String pymtYrMnth)
	 *@brief date:2017 2017. 9. 15. user:atres
	 *@param deptUseYn the pymtYrMnth to set
	 */
