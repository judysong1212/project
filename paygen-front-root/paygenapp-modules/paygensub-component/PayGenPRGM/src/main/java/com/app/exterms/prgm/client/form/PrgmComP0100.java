...
=====================================================**/
public class PrgmComP0100  extends Lov implements PrgmComDaoConstants { 
	...
	public static void setTypOccuCd(ComboBox<BaseModel> typOccuCd) {
		PrgmComP0100.typOccuCd = typOccuCd;
	}
	...
	public static void setEmymtDivCd(ComboBox<BaseModel> emymtDivCd) {
		PrgmComP0100.emymtDivCd = emymtDivCd;
	}
	...
	public static void setResnRegnNum(TextField<String> resnRegnNum) {
		PrgmComP0100.resnRegnNum = resnRegnNum;
	}
	...
	public static void setSystemkey(HiddenField<String> systemkey) {
		PrgmComP0100.systemkey = systemkey;
	}
	...
	public static void setHdofcCodtnCd(ComboBox<BaseModel> hdofcCodtnCd) {
		PrgmComP0100.hdofcCodtnCd = hdofcCodtnCd;
	}

	public PrgmComP0100(int width, int height) {
	        this();
	        this.width  = width;
	        this.height = height;
	    }
	    ...
	    public PrgmComP0100() { 
	        ...
	        lovDef = new LovDef();
	        lovDef.setTitle(SysComLabel.titleSysComPopUpPsnl0100());  //팝업상단의 타이틀 
	        ...
	        /** EMYMT_DIV_NM */
	        listColumnDefs.add(new ColumnLovDef("고용구분", PrgmComPsnl0100BM.ATTR_EMYMTDIVNM, PrgmComPsnl0100BM.ATTR_EMYMTDIVNM, ColumnDef.TYPE_STRING, 100){
	            {
	            	 setIsVisibleInSearchForm(true);
	            }
	        });
