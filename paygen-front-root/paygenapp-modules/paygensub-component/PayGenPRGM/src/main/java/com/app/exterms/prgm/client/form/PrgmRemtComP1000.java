...
=====================================================**/
public class PrgmRemtComP1000  extends Lov implements PrgmComDaoConstants { 
...
//--------------------사업 불러 오는 함수 -------------------------------------------------
 ...
 private static DateField retryDt01;
 private static DateField retryDt02;
...
public static DateField getRetryDt01() {
	return retryDt01;
}

public static void setRetryDt01(DateField retryDt01) {
	PrgmRemtComP1000.retryDt01 = retryDt01;
}

public static DateField getRetryDt02() {
	return retryDt02;
}

public static void setRetryDt02(DateField retryDt02) {
	PrgmRemtComP1000.retryDt02 = retryDt02;
}
...
public static void setTypOccuCd(ComboBox<BaseModel> typOccuCd) {
	PrgmRemtComP1000.typOccuCd = typOccuCd;
}
...
public static void setEmymtDivCd(ComboBox<BaseModel> emymtDivCd) {
	PrgmRemtComP1000.emymtDivCd = emymtDivCd;
}
...
public static void setDeptCd(ComboBox<BaseModel> deptCd) {
	PrgmRemtComP1000.deptCd = deptCd;
}
...
public static void setBusinCd(ComboBox<BaseModel> businCd) {
	PrgmRemtComP1000.businCd = businCd;
}
...
public static void setResnRegnNum(TextField<String> resnRegnNum) {
	PrgmRemtComP1000.resnRegnNum = resnRegnNum;
}
...
public static void setSystemkey(HiddenField<String> systemkey) {
	PrgmRemtComP1000.systemkey = systemkey;
}
...
public static void setHdofcCodtnCd(ComboBox<BaseModel> hdofcCodtnCd) {
	PrgmRemtComP1000.hdofcCodtnCd = hdofcCodtnCd;
}
...
public static TextField<String> getHanNm() {
	...
	public static void setHanNm(TextField<String> hanNm) {
		PrgmRemtComP1000.hanNm = hanNm;
	}

public PrgmRemtComP1000(int width, int height) {
        this();
        this.width  = width;
        this.height = height;
    }

    public PrgmRemtComP1000() { 
        // 권한처리 부분 추가 전역이 아니 각 화면별로 객체 생성시 처리를 위해 변경함.
	     gwtAuthorization =   GWTAuthorization.getInstance();
	     gwtExtAuth =   GWTExtAuth.getInstance();
	    
        lovDef = new LovDef();
        lovDef.setTitle(SysComLabel.titleSysComPopUpRemt0100());  //팝업상단의 타이틀 
        lovDef.setDaoClass("");
        lovDef.setAutoFillGrid(false);   
        lovDef.showFilterForm(); 
        lovDef.setCustomListMethod(PRGMCOM_METHOD_POPUP_REMT_PSNL0100_List);
      ...
      /**
        ...
        fp03.setSize(830, 95);
          ...
          frmSearchLayer.add(typOccuCdGrid);
           ...
           retryDt01 = new DateField();
           retryDt01.setName("retryDt01");
            new DateFieldMask(retryDt01, "9999.99.99"); 
            retryDt01.getPropertyEditor().setFormat(DateTimeFormat.getFormat(MSFMainApp.MSFCONSTANTS.DateFormat()));
            retryDt01.setFieldLabel("기간선택");
          //  retryDt01.setValue(value); 
            
            layoutContainer_81.add(retryDt01, new FormData("100%"));
            ...
            retryDt02 = new DateField();
            retryDt02.setName("srhSoctyInsurCmptnDt02");
            new DateFieldMask(retryDt02, "9999.99.99"); 
            retryDt02.getPropertyEditor().setFormat(DateTimeFormat.getFormat(MSFMainApp.MSFCONSTANTS.DateFormat()));
            retryDt02.setLabelSeparator("~");
            
            
            layoutContainer_91.add(retryDt02, new FormData("100%"));
    ...
    private static void setInitDate() { 
        ...
        retryDt01.setValue(intiCal.getTime());
       ...
       // GWT.log("일수" + DateTimeFormat.getFormat("yyyy.MM.dd").format(intiCal.getTime()));
        retryDt02.setValue(intieCal.getTime());
    }
