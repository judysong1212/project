 ...
 */
public class PrgmComPayr0480BM   extends MSFSimpleBaseModel implements IsSerializable  {
   ...
   // public static final String ATTR_PRGMCOMBASS0300DTO = "sysComBass0300Dto"; 
...
public static final String ATTR_SEVEPAYYN = "sevePayYn";
    ...
    /** 생성자 */
     public PrgmComPayr0480BM() { super(); } 

    /** 일괄등록 처리   */
     public PrgmComPayr0480BM(
    		 String  dpobCd 
    		, String  payExtpyCd 
    ...
    /** set 공통코드테스트 : sysComBass0300Dto */
  //  public void setMsfComBass0300Dto(PrgmComBass0300DTO  sysComBass0300Dto) { set( ATTR_PRGMCOMBASS0300DTO ,sysComBass0300Dto);}
    /** get 공통코드테스트 : sysComBass0300Dto */
   // public PrgmComBass0300DTO  getMsfComBass0300Dto() { return (PrgmComBass0300DTO)get( ATTR_PRGMCOMBASS0300DTO );}
