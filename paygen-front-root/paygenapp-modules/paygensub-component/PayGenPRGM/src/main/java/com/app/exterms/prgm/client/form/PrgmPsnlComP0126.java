...
=====================================================**/
public class PrgmPsnlComP0126  extends Lov implements PrgmComDaoConstants { 
	...
	private static PrgmComBass0320DTO sysComBass0320Dto; // 직종코드
...
//	PrgmPsnlComP0126.emymtBgnnDt01 = emymtBgnnDt01;
//}
//
...
//	PrgmPsnlComP0126.emymtBgnnDt02 = emymtBgnnDt02;
//}
	...
	public static void setTypOccuCd(ComboBox<BaseModel> typOccuCd) {
		PrgmPsnlComP0126.typOccuCd = typOccuCd;
	}
	...
	public static void setEmymtDivCd(ComboBox<BaseModel> emymtDivCd) {
		PrgmPsnlComP0126.emymtDivCd = emymtDivCd;
	}
	...
	public static void setDeptCd(ComboBox<BaseModel> deptCd) {
		PrgmPsnlComP0126.deptCd = deptCd;
	}
	...
	public static void setBusinCd(ComboBox<BaseModel> businCd) {
		PrgmPsnlComP0126.businCd = businCd;
	}
	...
	public static void setResnRegnNum(TextField<String> resnRegnNum) {
		PrgmPsnlComP0126.resnRegnNum = resnRegnNum;
	}
	...
	public static void setSystemkey(HiddenField<String> systemkey) {
		PrgmPsnlComP0126.systemkey = systemkey;
	}
	...
	public static void setHdofcCodtnCd(ComboBox<BaseModel> hdofcCodtnCd) {
		PrgmPsnlComP0126.hdofcCodtnCd = hdofcCodtnCd;
	}

	public PrgmPsnlComP0126(int width, int height) {
		this();
		this.width = width;
		this.height = height;
	}

    public PrgmPsnlComP0126() { 
        // 권한처리 부분 추가 전역이 아니 각 화면별로 객체 생성시 처리를 위해 변경함.
	     gwtAuthorization =   GWTAuthorization.getInstance();
	     gwtExtAuth =   GWTExtAuth.getInstance();
	    
        lovDef = new LovDef();
        lovDef.setTitle(SysComLabel.titleSysComPopUpPsnl0126());  //팝업상단의 타이틀 
        lovDef.setDaoClass("");
        lovDef.setAutoFillGrid(false);   
        lovDef.showFilterForm(); 
        //lovDef.setCustomListMethod(PRGMCOM_METHOD_POPUP_INSR_PSNL0100_List);
        lovDef.setCustomListMethod(PRGMCOM_METHOD_POPUP_PSNL_PSNL0126_List);
...
//        setInitDate();
	...
	public static final LayoutContainer getMsfComP0100Filter() {
		...
		lsTypOccuCd 	= new ListStore<BaseModel>();		//직종 
...
//            typOccuCdGrid.add(typOccuCdGridPanel); 
		...
		deptCd.addSelectionChangedListener(new SelectionChangedListener<BaseModel>() {
			public void selectionChanged(SelectionChangedEvent<BaseModel> se) {
				...
				}  else  if (bmDeptCd != null && MSFConfiguration.EMYMT_DIVCD01.equals(emymtDivCd.getValue().get("commCd"))) {
