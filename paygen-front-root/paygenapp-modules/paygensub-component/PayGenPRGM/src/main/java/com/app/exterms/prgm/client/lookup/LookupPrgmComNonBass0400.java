...
=====================================================**/
public class LookupPrgmComNonBass0400  extends TableDef implements PrgmComDaoConstants {

  
    private PrgmConstants SysComLabel = PrgmConstants.INSTANCE;

    public LookupPrgmComNonBass0400(){
        setTitle(SysComLabel.titleSysComPopUpBass0500());
        setDaoClass("");
      //  setCustomListMethod(PRGMCOM_METHOD_LOOKUP_BASS0400_List);
        setCustomListMethod(PRGMCOM_METHOD_P0145_BASS0400_List); 
    ...
    public LookupPrgmComNonBass0400(PrgmComBass0400DTO sysComBass0400Dto) {
        this();
