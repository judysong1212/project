 ...
 */
public class PrgmComPsnl0115BM   extends MSFSimpleBaseModel implements IsSerializable   {
    ...
    /** set 직업 : crrNm */
    public static final String ATTR_CRRNM = "crrNm";
    ...
    /** set 장애등급코드 : dabtyGrdeNm */
    public static final String ATTR_DABTYGRDENM = "dabtyGrdeNm";
    ...
    public static final String ATTR_FAMYSUPPTYN = "famySupptYn";

    /** set 연말정산부양관계코드 : famySupptRelaDivCd */
    public static final String ATTR_FAMYSUPPTRELADIVCD = "famySupptRelaDivCd";

    /** 생성자 */
     public PrgmComPsnl0115BM() { super(); } 

    /** 일괄등록 처리   */
     public PrgmComPsnl0115BM(
             String  dpobCd 
            , String  systemkey 
            , Long  famySeilNum 
    ...
    /** set 외국인여부 : frgnrYn */
    public void setFrgnrYn(Boolean  frgnrYn) { set( ATTR_FRGNRYN ,frgnrYn);}
    /** get 외국인여부 : frgnrYn */
    public Boolean  getFrgnrYn() { return (Boolean )get( ATTR_FRGNRYN );}
    ...
    /** set 부양여부 : famySupptYn */
    public void setFamySupptYn(String  famySupptYn) { set( ATTR_FAMYSUPPTYN ,famySupptYn);}
    /** get 부양여부 : famySupptYn */
    public String  getFamySupptYn() { return (String )get( ATTR_FAMYSUPPTYN );}
    /** set 연말정산부양관계코드 : famySupptRelaDivCd */
