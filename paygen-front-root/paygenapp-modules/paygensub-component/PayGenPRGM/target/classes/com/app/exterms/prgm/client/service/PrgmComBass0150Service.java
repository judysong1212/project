...
@RemoteServiceRelativePath("PrgmComBass0150Service.gwt")
public interface PrgmComBass0150Service extends RemoteService {
	/**
	 * Utility class for simplifying access to the instance of async service.
	 */
	public static class Util {
		private static PrgmComBass0150ServiceAsync instance;
		public static PrgmComBass0150ServiceAsync getInstance(){
			if (instance == null) {
				instance = GWT.create(PrgmComBass0150Service.class);
			}
			return instance;
		}
	}
	...
	public List<BaseModel> getPrgmComComboBass0150List(PrgmComBass0150DTO sysComBass0150Dto);
	/**
	 * BASS0150을 등록한다.
