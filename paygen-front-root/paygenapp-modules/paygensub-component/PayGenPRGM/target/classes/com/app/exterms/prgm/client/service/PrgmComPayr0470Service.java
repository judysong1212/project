...
@RemoteServiceRelativePath("PrgmComPayr0470Service.gwt")
public interface PrgmComPayr0470Service extends RemoteService {
	/**
	 * Utility class for simplifying access to the instance of async service.
	 */
	public static class Util {
		private static PrgmComPayr0470ServiceAsync instance;
		public static PrgmComPayr0470ServiceAsync getInstance(){
			if (instance == null) {
				instance = GWT.create(PrgmComPayr0470Service.class);
			}
			return instance;
		}
	}
	 ...
	 public List<BaseModel> getPrgmComComboPayr0470List(PrgmComPayr0470DTO sysComPayr0470Dto);	
