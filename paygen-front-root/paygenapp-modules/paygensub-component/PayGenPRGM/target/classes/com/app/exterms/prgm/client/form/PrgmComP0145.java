...
public class PrgmComP0145  extends Lov implements PrgmComDaoConstants { 
    ...
    private static HiddenField<String> deptDspyYn ; 
    public static Button btnUsrSearch;
     
    
    /**
	 * Comment : 
	 * @fn HiddenField<String> getDeptDspyYn()
	 * @brief date:2016 Jun 22, 2016 user:leeheuisung
	 * @return the deptDspyYn get
	 */
	public static HiddenField<String> getDeptDspyYn() {
		return deptDspyYn;
	}

	/**
	 * Comment : 
	 *@fn void setDeptDspyYn(HiddenField<String> deptDspyYn)
	 *@brief date:2016 Jun 22, 2016 user:leeheuisung
	 *@param deptDspyYn the deptDspyYn to set
	 */
	public static void setDeptDspyYn(HiddenField<String> deptDspyYn) {
		PrgmComP0145.deptDspyYn = deptDspyYn;
	}
	...
	public static void setDeptNm(TextField<String> deptNm) {
		PrgmComP0145.deptNm = deptNm;
	}

	public PrgmComP0145(int width, int height) {
        this();
        this.width  = width;
        this.height = height;
    }
    ...
    public PrgmComP0145() {
        ...
        lovDef.setCustomListMethod(PRGMCOM_METHOD_P0145_BASS0400_List);
        ...
        lovDef.setCustomLayoutContainer(getMsfComP0145Filter()); 
    } 


    public static final LayoutContainer getMsfComP0145Filter() {
          
    	  deptDspyYn = new HiddenField<String>();
