...
public class Remt0400TempExcelView extends AbstractExcelView {
	...
	protected void buildExcelDocument(Map<String, Object> model,
		...
		String xlsRelatvieFilepath = realPath.concat("/".concat(globals.get("PayGen.XLSTemplateLink")).concat("/REMT/XLS_REMT040001.xls"));
		
		String destFileName = "퇴직정산업로드양식".concat(rndName);
