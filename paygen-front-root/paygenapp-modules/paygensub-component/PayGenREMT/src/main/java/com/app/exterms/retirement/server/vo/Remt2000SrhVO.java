 ...
 */
public class Remt2000SrhVO  implements Serializable {
  ...
  /** set 근속년수코드 : logSvcYrNumCd */
  private java.lang.String logSvcYrNumCdArr;
  /** set 성명 : nm */
...
public java.lang.String getLogSvcYrNumCdArr() {
	return logSvcYrNumCdArr;
}

public void setLogSvcYrNumCdArr(java.lang.String logSvcYrNumCdArr) {
