...
import com.app.exterms.retirement.client.form.def.Remt1000Def;
...
public class Remt0050 extends MSFPanel {
    /**
     * ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
     * 전역변수 선언부  시작
     * ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
//	  private  boolean maskTracker = false;  //초기화 로딩 팝업 강제 unmask 처리 
    ...
    // -------------- grid 선언 시작 --------------
    private Remt1000Def remt1000Def = new Remt1000Def();   //그리드 테이블 컬럼 define
    ...
    private SelectionListener<ButtonEvent> selectionListener = new SelectionListener<ButtonEvent>() {
        public void componentSelected(ButtonEvent ce) {
            if (ce.getButton() == btnRemt0050Save) {
                ...
                // 선택한 대상이 없을 경우
                if (MSFSharedUtils.paramNull(RemtUtils.getSelectedComboValue(typOccuCd, "typOccuCd"))) {
    ...
    public void save(final ActionDatabase actionDatabase) {
        ...
        final Remt1000DTO dto = new Remt1000DTO();

        if ("".equals(RemtUtils.getSelectedComboValue(typOccuCd, "typOccuCd"))) {
            ...
            dto.setTypOccuCd(RemtUtils.getSelectedComboValue(typOccuCd, "typOccuCd"));                                // 직종코드
            dto.setDtilOccuInttnCd(RemtUtils.getSelectedComboValue(dtilOccuInttnCd, "dtilOccuInttnCd"));                // 직종세통합코드
            dto.setSevePayAddRateFrmCd(RemtUtils.getSelectedComboValue(dtSevePayAddRateFrmCd));                                // 퇴직금가산율유형코드
            ...
            dto.setSevePayAddBgnnDt(RemtUtils.getConvertDateToString(sevePayAddBgnnDt, "yyyyMMdd"));                // 퇴직금가산시작일자
            dto.setSevePayAddEndDt(RemtUtils.getConvertDateToString(sevePayAddEndDt, "yyyyMMdd"));                    // 퇴직금가산종료일자
            ...
            MessageBox.confirm("", "DELETE".equals(actionDatabase.name()) ? "삭제 하시겠습니까?" : "저장 하시겠습니까?", new Listener<MessageBoxEvent>() {
                ...
                public void handleEvent(MessageBoxEvent be) {
                    ...
                    if (Dialog.YES.equals(be.getButtonClicked().getItemId())) {
                        remt0050Service.saveRemt1000Save(dto, actionDatabase, new AsyncCallback<Long>() {
                            @Override
                            ...
                            public void onFailure(Throwable caught) {
                                ...
                                MessageBox.alert(MSFMainApp.MSFCONSTANTS.ExceptionTitleService(),
                                        MSFMainApp.ADMINMESSAGES.ExceptionMessageService("saveRemt1000Save(" + actionDatabase.name() + ") : " + caught)
                                        , null);
                            }
                        });
                    }
                ...
                if (MSFSharedUtils.paramNotNull(sysComBass0350Dto.getTypOccuCd())) {
                    ...
                    stDtilOccuClsDivCd.addStoreListener(new StoreListener<BaseModel>() {
                        public void handleEvent(StoreEvent<BaseModel> be) {
                            ...
                            RemtUtils.setSelectedComboValue(dtilOccuInttnCd, (String) bmData.get("dtilOccuInttnCd$dtilOccuInttnCd"), "dtilOccuInttnCd");
                        }
                    });
                }
            }
    ...
    public Remt0050(String txtForm) {
...
//		plFrmRemt0050.setMethod(Method.POST);
        ...
        plFrmRemt0050.setSize("990px", "730px");
    }
        ...
        remt1000Grid.addListener(Events.RowClick, new Listener<BaseEvent>() {
            public void handleEvent(BaseEvent be) {
                if (remt1000GridPanel.getCurrentlySelectedItem() != null) {
                    ...
                    /** column 직종코드 : typOccuCd */
                    RemtUtils.setSelectedComboValue(typOccuCd, (String) bmData.get("typOccuCd$typOccuCd"), "typOccuCd");

                    /** column 직종세통합코드 : dtilOccuInttnCd */
                    RemtUtils.setSelectedComboValue(dtilOccuInttnCd, (String) bmData.get("dtilOccuInttnCd$dtilOccuInttnCd"), "dtilOccuInttnCd");

                    /** column 퇴직금가산율유형코드 : sevePayAddRateFrmCd */
                    RemtUtils.setSelectedComboValue(dtSevePayAddRateFrmCd, (String) bmData.get("sevePayAddRateFrmCd$commCd"), "commCd");
...
//                                MessageBox.alert("", "엑셀 업로드가 정상적으로 완료되었습니다.", null);
    ...
    private void xlsExportData() {
        ...
        param.put("typOccuCd", RemtUtils.getSelectedComboValue(srhTypOccuCd, "typOccuCd"));    //직종코드
        param.put("dtilOccuInttnCd", RemtUtils.getStrValToBMMultiCombo(lsDtilOccuInttnCd, srhDtilOccuInttnCd.getValue(), "dtilOccuClsNm", "dtilOccuInttnCd"));  //직종세
        param.put("sevePayAddRateFrmCd", RemtUtils.getSelectedComboValue(dtSevePayAddRateFrmCd, "dtSevePayAddRateFrmCd"));    //직종세사용여부

        remt1000GridPanel.callXlsExportServlet(GWT.getHostPageBaseURL() + "exp/XlsFileRemt0050Export.do", "extgwtFrame", param);
    }

    private Remt0050 getThis() {
        return this;
    }
