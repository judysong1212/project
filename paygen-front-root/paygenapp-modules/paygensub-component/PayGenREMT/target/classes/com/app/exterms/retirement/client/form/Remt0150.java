...
import com.app.exterms.retirement.client.service.Remt0150ServiceAsync;
...
public class Remt0150   extends MSFPanel { 
 ...
 **/
	  ...
	  private FormPanel plFrmRemt0150;
	//  private FormData formData; 
	  private String txtForm = "";  
	 
	  
	  private Remt2000Def remt2000Def  = new Remt2000Def("REMT0150");   //그리드 테이블 컬럼 define  
      // private MSFCustomForm msfCustomForm; 
      private MSFGridPanel remt2000GridPanel;
...
//      private MSFGridPanel typOccuCdGridPanel;
       ...
       * ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
       */
      private ButtonBar topRemt0150Bar;
      private Button btnRemt0150New;
      private Button btnRemt0150Save;
      private Button btnRemt0150Del;
      private Button btnRemt0150Sreach;
      private Button btnRemt0150Excel;
      /**
       * ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
       * 검색변수 선언 
       * ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
 ...
 **/	 
   ...
   // private AuthAction authAction;  
   		...
   		//  private static MessageBox authBox = MessageBox.wait("화면로딩", "설정 초기화 작업 진행 중입니다....", "설정 작업 진행 중..."); 
   		   ...
   		   * AuthAction 
   		   */
   		  private void checkRemt0150Auth( String authAction, ListStore<BaseModel> bm) {   
            ...
            * 값순서 : 단위기관 ,고용구분, 부서, 직종, 직종세 ,사업 순으로  없으면 ""
            ...
            // GWTAuthorization.formAuthPopConfig(plFrmRemt0150, "srhPayrMangDeptCd","srhEmymtDivCd",strArrDeptCd,"srhTypOccuCd","srhDtilOccuInttnCd","srhBusinCd");
...
//    	   * AuthAction 
//    	   */
//    	  private void checkRemt0150Auth( AuthAction authAction, ListStore<BaseModel> bm, int authChk) {   
//        	   //MSFMainApp.maskMainPage("[화면로딩] 초기화 진행 중"); 
//    		 
 ...
 **/
      ...
      //입력수정삭제처리 rpc 처리부     
     private Remt0150ServiceAsync payr0250Service = Remt0150Service.Util.getInstance();
 ...
 **/ 	
	  ...
	  public Remt0150(String txtForm) {
 ...
 **/	  
	  ...
	  private void createPsnl0100Form() {
		...
		plFrmRemt0150 = new FormPanel();
		plFrmRemt0150.setHeadingText(PayGenConst.PAYGEN_VERSION.concat(" -  퇴직금산정현황")); //+ lblDlgnConst.title_Remt0150());
		//plFrmRemt0150.setHeadingText(PayGenConst.PAYGEN_VERSION.concat(" - 간이소득세액표관리");
		plFrmRemt0150.setIcon(MSFMainApp.ICONS.text());
		plFrmRemt0150.setBodyStyleName("pad-text");
		plFrmRemt0150.setPadding(2);
		plFrmRemt0150.setFrame(true); 
		...
		btnlogView.addListener(Events.Select, new Listener<ButtonEvent>() {
			public void handleEvent(ButtonEvent e) {
				 //로그 뷰화면 호출 메서드 
				  funcLogMessage("퇴직금산정현황","REMT0150");
				}
			});
		plFrmRemt0150.getHeader().setStyleAttribute("padding", "5px 0 2px 0");
		plFrmRemt0150.getHeader().addTool(btnlogView); 
		/************************************************************************
		 * 화면 에러 처리시 필요한 부분으로 추가 
		 ************************************************************************/
		
		   //멀티콤보박스 닫기 
		plFrmRemt0150.addListener(Events.OnClick,new Listener<ComponentEvent>() { 
            @Override
...
//                      }
		 ...
		 topRemt0150Bar = new ButtonBar();    
		 topRemt0150Bar.setAlignment(HorizontalAlignment.RIGHT);
 
		 
//	   //신규 
//        btnRemt0150New = new Button("신규");  
//        btnRemt0150New.setIcon(MSFMainApp.ICONS.new16());
//        topRemt0150Bar.add(btnRemt0150New);
//        btnRemt0150New.addListener(Events.Select, new Listener<ButtonEvent>() {
//            public void handleEvent(ButtonEvent e) {
//                //초기화 버튼 클릭시 처리     
//                remt2000GridPanel.getMsfGrid().clearData();
//                fnPopupPsnl0110();   
//                 
//            }
//        });
//        //저장 -신규/수정 동시 처리 부분으로 나뉨 
//        btnRemt0150Save = new Button("저장");  
//        btnRemt0150Save.setIcon(MSFMainApp.ICONS.save16());
//        topRemt0150Bar.add(btnRemt0150Save); 
//        btnRemt0150Save.addListener(Events.Select, new Listener<ButtonEvent>() {
//            public void handleEvent(ButtonEvent e) {
//                
//                setListRecord(remt2000GridPanel.getMsfGrid().getStore().getModifiedRecords().iterator()); 
...
//       
//        //삭제       
//        btnRemt0150Del = new Button("삭제");  
//        btnRemt0150Del.setIcon(MSFMainApp.ICONS.delete16());
//        topRemt0150Bar.add(btnRemt0150Del);
//        btnRemt0150Del.addListener(Events.Select, new Listener<ButtonEvent>() {
//            public void handleEvent(ButtonEvent e) {
//                
//                Iterator<BaseModel> itBm  = remt2000GridPanel.getMsfGrid().getGrid().getSelectionModel().getSelectedItems().listIterator();
//                
...
//        });
	  	...
	  	btnRemt0150Sreach = new Button("조회"); 
	  	btnRemt0150Sreach.setIcon(MSFMainApp.ICONS.search16());
	  	topRemt0150Bar.add(btnRemt0150Sreach);
	  	btnRemt0150Sreach.addListener(Events.Select, new Listener<ButtonEvent>() {
    		public void handleEvent(ButtonEvent e) {
    			//조회버튼 클릭시 처리 
    		    reload();  
    		}
	  	...
	  	btnRemt0150Excel = new Button("엑셀"); 
	  	btnRemt0150Excel.setIcon(MSFMainApp.ICONS.excel16());
	  	topRemt0150Bar.add(btnRemt0150Excel);
	  	btnRemt0150Excel.addListener(Events.Select, new Listener<ButtonEvent>() {
    		public void handleEvent(ButtonEvent e) {
    			//엑셀저장  
    			excelFileExport();
    		}
...
//	  	buttonBar.add(topBtn);  
	  	...
	  	plFrmRemt0150.add(topRemt0150Bar);    	
	  	
		vp.add(plFrmRemt0150);
		//엣지변환
		//plFrmRemt0150.setSize("990px", "690px");
		plFrmRemt0150.setSize("990px", "740px");
	  }
...
//	                 plFrmRemt0150.add(typOccuCdGrid); 
...
//	            plFrmRemt0150.add(yearGrid); 
 
	        plFrmRemt0150.setLayout(new FlowLayout());
		   ...
		   // srhClutYr01.setEmptyText("--년도선택--");
		    ...
		    srhClutYr01.setFieldLabel("산정기간");    
		    srhClutYr01.getStore().addStoreListener( new StoreListener<BaseModel>() {   
		        public void handleEvent(StoreEvent<BaseModel> be) {  
 
		        	checkRemt0150Auth("srhClutYr01", lsClutYr01Store); 
		        }
		    });
		  ...
		  //srhClutMnth01.setEmptyText("--월선택--");
		    ...
		    srhClutMnth01.getStore().addStoreListener( new StoreListener<BaseModel>() {   
		         public void handleEvent(StoreEvent<BaseModel> be) {  
		        	 checkRemt0150Auth("srhClutMnth01", lsClutMnth01); 
		    ...
		    srhClutYr02.getStore().addStoreListener( new StoreListener<BaseModel>() {   
		        public void handleEvent(StoreEvent<BaseModel> be) {  
		        	 checkRemt0150Auth("srhClutYr02", lsClutYr02Store); 
		  ...
		  //srhClutMnth02.setEmptyText("--월선택--");
		    ...
		    srhClutMnth02.getStore().addStoreListener( new StoreListener<BaseModel>() {   
		         public void handleEvent(StoreEvent<BaseModel> be) {  
		        	 ...
		        	 checkRemt0150Auth("srhClutMnth02", lsClutMnth02); 
		         }
		     });
            ...
            srhCalcSevePayPsnDivCd.getStore().addStoreListener( new StoreListener<BaseModel>() {   
                public void handleEvent(StoreEvent<BaseModel> be) {  
                	checkRemt0150Auth("srhCalcSevePayPsnDivCd", lsCalcSevePayPsnDivCd); 
                }
            });    
            
            
            layoutContainer.add(srhCalcSevePayPsnDivCd, new FormData("100%"));
		    	   ...
		    	   if (type == Store.Add) { 
               		 /**++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
		                     ...
		                     * "srhPayrMangDeptCd","srhEmymtDivCd","srhDeptCd","srhTypOccuCd","srhBusinCd"
		                     ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++*/ 
		                	checkRemt0150Auth("srhPayrMangDeptCd", lsPayrMangDeptCd); 
               	 }
                ...
                public void handleEvent(StoreEvent<BaseModel> be) {  
		    	   ...
		    	   if (type == Store.Add) { 
               		 /**++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
		                     ...
		                     * "srhPayrMangDeptCd","srhEmymtDivCd","srhDeptCd","srhTypOccuCd","srhBusinCd"
		                     ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++*/ 
		                	checkRemt0150Auth("srhEmymtDivCd", lsEmymtDivCd); 
               	 }
...
//		    lcSchCol.add(lcSchLeft,new com.extjs.gxt.ui.client.widget.layout.ColumnData(.3)); 			// 산정기간
//		    lcSchCol.add(layoutContainer,new com.extjs.gxt.ui.client.widget.layout.ColumnData(.18)); 	// 정산구분
//		    lcSchCol.add(layoutContainer_14,new com.extjs.gxt.ui.client.widget.layout.ColumnData(.3)); 	// 단위기관
	            ...
	            public void handleEvent(StoreEvent<ModelData> be) {  
		    	   ...
		    	   if (type == Store.Add) { 
               		 /**++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
		                     ...
		                     * "srhPayrMangDeptCd","srhEmymtDivCd","srhDeptCd","srhTypOccuCd","srhBusinCd"
		                     ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++*/ 
		                	checkRemt0150Auth("srhDeptCd", lsDeptCd); 
               	 }
	            }
	        });    
			    		   ...
			    		   if (!gwtExtAuth.getEnableTypOccuCd()) {
	             	       ModelData  mdSelect  = srhTypOccuCd.getStore().getAt(0) ; 
	                		 ...
	                		 /**++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
			                     ...
			                     * "srhPayrMangDeptCd","srhEmymtDivCd","srhDeptCd","srhTypOccuCd","srhBusinCd"
			                     ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++*/ 
			                	//checkRemt0150Auth("srhTypOccuCd", lsTypOccuCd); 
	                	 }
                }
            });     
...
//			layoutContainer_3.add(layoutContainer_1,new com.extjs.gxt.ui.client.widget.layout.ColumnData(.2));	// 고용구분
//			layoutContainer_3.add(layoutContainer_2,new com.extjs.gxt.ui.client.widget.layout.ColumnData(.25));	// 부서
//			layoutContainer_3.add(layoutContainer_10,new com.extjs.gxt.ui.client.widget.layout.ColumnData(.33));// 직종
//		    layoutContainer_3.add(layoutContainer_4,new com.extjs.gxt.ui.client.widget.layout.ColumnData(.22));	// 사업
		    
			layoutContainer_3.add(layoutContainer,new com.extjs.gxt.ui.client.widget.layout.ColumnData(.3));	// 정산구분
 ...
 **/  
   ...
   **/ 	 
	  ...
	  private void createCheckBoxGrid() {   
	    ...
	    fieldSet1.setHeadingHtml("퇴직금산정내역");
	  ...
	  //  frmlytStd.setLabelWidth(85); 
	   // frmlytStd.setLabelAlign(LabelAlign.RIGHT);   
	    ...
	    remt2000GridPanel = new MSFGridPanel(remt2000Def, false, false, false, false);
	    remt2000GridPanel.getMsfGrid().setCellModel(true);
	    
	    remt2000GridPanel.setHeaderVisible(false);  
	    remt2000GridPanel.setBodyBorder(true);
	    remt2000GridPanel.setBorders(true);
	 //   remt2000GridPanel.setFrame(true); 
	 //   remt2000GridPanel.showExportButton(true); 
     //   msfGridPanel.setMSFFormPanel(msfCustomForm);  //폼을 그리드에 넣은다.
//	    remt2000GridPanel.getGrid().addListener(Events.Render, new Listener<BaseEvent>() {
//	        public void handleEvent(BaseEvent be)
//	        {
//	        	 remt2000GridPanel.getGrid().disableTextSelection(false);
//	        }
//	    });    
//	    remt2000GridPanel.getGrid().removeStyleName("x-unselectable"); 
	    
	    cpGrid.add(remt2000GridPanel); 
	    
	 
	    lcStdGrid.add(cpGrid);   
	    fieldSet1.add(lcStdGrid);   
	      
	    plFrmRemt0150.add(fieldSet1);
...
//			
		  if("".equals(MSFSharedUtils.getSelectedComboValue(srhBusinCd,"businCd"))){
            ...
            remt2000GridPanel.getTableDef().setTableColumnFilters(filters);
             
            remt2000GridPanel.getTableDef().addColumnFilter("clutYrMnth01", (MSFSharedUtils.getSelectedComboValue(srhClutYr01,"year")+ MSFSharedUtils.getSelectedComboValue(srhClutMnth01,"month")), SimpleColumnFilter.OPERATOR_EQUALS); 
            remt2000GridPanel.getTableDef().addColumnFilter("clutYrMnth02", (MSFSharedUtils.getSelectedComboValue(srhClutYr02,"year")+ MSFSharedUtils.getSelectedComboValue(srhClutMnth02,"month")), SimpleColumnFilter.OPERATOR_EQUALS); 
            
            remt2000GridPanel.getTableDef().addColumnFilter("payrMangDeptCd", MSFSharedUtils.getSelectedComboValue(srhPayrMangDeptCd,"payrMangDeptCd"), SimpleColumnFilter.OPERATOR_EQUALS);
            remt2000GridPanel.getTableDef().addColumnFilter("emymtDivCd", MSFSharedUtils.getSelectedComboValue(srhEmymtDivCd,"commCd"), SimpleColumnFilter.OPERATOR_EQUALS); 
            remt2000GridPanel.getTableDef().addColumnFilter("calcSevePayPsnDivCd", MSFSharedUtils.getSelectedComboValue(srhCalcSevePayPsnDivCd,"commCd"), SimpleColumnFilter.OPERATOR_EQUALS); 
          
            //remt2000GridPanel.getTableDef().addColumnFilter("deptCd", MSFSharedUtils.allowNulls(srhDeptCd.getValue()), SimpleColumnFilter.OPERATOR_EQUALS); 
            //remt2000GridPanel.getTableDef().addColumnFilter("typOccuCd", MSFSharedUtils.getSelectedComboValue(srhTypOccuCd,"typOccuCd"), SimpleColumnFilter.OPERATOR_EQUALS);
            String strDeptCd = RemtUtils.getStrValToBMMultiCombo(lsDeptCd,srhDeptCd.getValue(),"deptNmRtchnt","deptCd");  
            remt2000GridPanel.getTableDef().addColumnFilter("deptCd", strDeptCd , SimpleColumnFilter.OPERATOR_EQUALS);
           
            String strTypOccuCd = RemtUtils.getStrValToBMMultiCombo(lsTypOccuCd,srhTypOccuCd.getValue(),"typOccuNm","typOccuCd"); 
            remt2000GridPanel.getTableDef().addColumnFilter("typOccuCd", strTypOccuCd, SimpleColumnFilter.OPERATOR_EQUALS); 
           // String strPyspGrdeCd = RemtUtils.getStrValToBMMultiCombo(lsTypOccuCd,srhTypOccuCd.getValue(),"typOccuNm","pyspGrdeCd");  
          //  remt2000GridPanel.getTableDef().addColumnFilter("pyspGrdeCd", strPyspGrdeCd, SimpleColumnFilter.OPERATOR_EQUALS);  
            ...
            remt2000GridPanel.getTableDef().addColumnFilter("dtilOccuInttnCd", strDtilOccuInttnCd, SimpleColumnFilter.OPERATOR_EQUALS); 
       
            
            remt2000GridPanel.getTableDef().addColumnFilter("businCd", MSFSharedUtils.getSelectedComboValue(srhBusinCd,"businCd"), SimpleColumnFilter.OPERATOR_EQUALS);
            remt2000GridPanel.getTableDef().addColumnFilter("systemkey", MSFSharedUtils.allowNulls(srhSystemkey.getRawValue()), SimpleColumnFilter.OPERATOR_EQUALS); 
            remt2000GridPanel.getTableDef().addColumnFilter("hanNm", MSFSharedUtils.allowNulls(srhHanNm.getRawValue()), SimpleColumnFilter.OPERATOR_EQUALS);    
            remt2000GridPanel.getTableDef().addColumnFilter("resnRegnNum", MSFSharedUtils.allowNulls(srhResnRegnNum.getRawValue()), SimpleColumnFilter.OPERATOR_EQUALS);   
            
			remt2000GridPanel.reload();
		}
			          ...
			          // param.put("pyspGrdeCd", RemtUtils.getStrValToBMMultiCombo(lsTypOccuCd,srhTypOccuCd.getValue(),"typOccuNm","pyspGrdeCd"));
			           ...
			           param.put("resnRegnNum", MSFSharedUtils.allowNulls(srhResnRegnNum.getValue())); 
	                      ...
	                      if(("".equals(year01) || "".equals(month01)) && ("".equals(year02) || "".equals(month02)) ){
	                          ...
	                          remt2000GridPanel.callXlsExportServlet(GWT.getHostPageBaseURL() + "exp/XlsFileRemt0150Export.do","extgwtFrame" ,param);   
	               		     }
	                      }else{ 
