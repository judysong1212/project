...
=====================================================**/
public class RemtPayr0100Def  extends TableDef implements RemtDaoConstants {

    private int row = 0;
    private RemtConstants remtLabel = RemtConstants.INSTANCE;  
    
    public RemtPayr0100Def(String chkData){ 
    ...
    public List<ColumnDef> getRemtPayr0100Pymt(){
		...
		listColumnDefs.add(new ColumnDef("항목", RemtPayr0100BM.ATTR_PAYITEMNM, ColumnDef.TYPE_STRING , 90, true, true, true){
			{
				setReadOnly(true);
			}
		});
		...
		listColumnDefs.add(new ColumnDef("시간", RemtPayr0100BM.ATTR_ITEMTM01, ColumnDef.TYPE_DOUBLE , 40, true, true, true){
			{
				setRegEx("^[+-]?\\d*(\\.?\\d*)$");  
		...
		listColumnDefs.add(new ColumnDef("금액", RemtPayr0100BM.ATTR_ITEMAMNT01, ColumnDef.TYPE_LONG , 90, true, true, true){
			{
				//setReadOnly(true);
				setRegEx("^[+-]?\\d*(\\.?\\d*)$");  
            	setSelectOnFocus(true);
		...
		listColumnDefs.add(new ColumnDef("시간", RemtPayr0100BM.ATTR_ITEMTM02, ColumnDef.TYPE_DOUBLE , 40, true, true, true){
			{
				setRegEx("^[+-]?\\d*(\\.?\\d*)$");  
            	setSelectOnFocus(true);
			}
		...
		listColumnDefs.add(new ColumnDef("금액", RemtPayr0100BM.ATTR_ITEMAMNT02, ColumnDef.TYPE_LONG , 90, true, true, true){
			{
				//setReadOnly(true);
				setRegEx("^[+-]?\\d*(\\.?\\d*)$");  
            	setSelectOnFocus(true);
		...
		listColumnDefs.add(new ColumnDef("시간", RemtPayr0100BM.ATTR_ITEMTM03, ColumnDef.TYPE_DOUBLE , 40, true, true, true){
			{
				setRegEx("^[+-]?\\d*(\\.?\\d*)$");  
            	setSelectOnFocus(true);
			}
		...
		listColumnDefs.add(new ColumnDef("금액", RemtPayr0100BM.ATTR_ITEMAMNT03, ColumnDef.TYPE_LONG , 90, true, true, true){
			{
				//setReadOnly(true);
				setRegEx("^[+-]?\\d*(\\.?\\d*)$");  
            	setSelectOnFocus(true);
		...
		listColumnDefs.add(new ColumnDef("시간", RemtPayr0100BM.ATTR_ITEMTM04, ColumnDef.TYPE_DOUBLE , 40, true, true, true){
			{
				setRegEx("^[+-]?\\d*(\\.?\\d*)$");  
            	setSelectOnFocus(true);
			}
		...
		listColumnDefs.add(new ColumnDef("금액", RemtPayr0100BM.ATTR_ITEMAMNT04, ColumnDef.TYPE_LONG , 90, true, true, true){
			{
				//setReadOnly(true);
				setRegEx("^[+-]?\\d*(\\.?\\d*)$");  
            	setSelectOnFocus(true);
		...
		listColumnDefs.add(new ColumnDef("합계", RemtPayr0100BM.ATTR_ITEMTOTAMNT, ColumnDef.TYPE_LONG , 90, true, true, true){
			{
				setReadOnly(true);
			}
		});
