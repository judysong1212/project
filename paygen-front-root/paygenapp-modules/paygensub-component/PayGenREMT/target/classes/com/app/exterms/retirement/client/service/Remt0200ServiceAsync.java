...
public interface Remt0200ServiceAsync {
	
	public void saveRemt0200ToRemt3200(List<Remt3200DTO> listRemt3200dto , ActionDatabase actionDatabase, AsyncCallback<Long> callback);
	
	public void saveRemt0200ToDDlne(List<Remt3000DTO> listRemt3000dto , ActionDatabase actionDatabase, AsyncCallback<Long> callback);
	 
	public void activityOnReadRemt0200( Remt3100DTO remt3100Dto, AsyncCallback<Remt3100DTO> callback);
	
	public void activityOnupdateRemt0200Save(Remt3100DTO remt3100Dto, AsyncCallback<Long> callback);
	 
	public void activityOnPayrRemtCalc( List<Remt3000DTO> listRemt3000Dto, AsyncCallback<PagingLoadResult<ShowMessageBM>> callback);
