...
public class DlgnP010001ServiceImpl extends AbstractCustomServiceImpl implements DiligenceDaoConstants, DlgnP010001Service {
	...
	public PagingLoadResult<ShowMessageBM> generateAllWorkTime(Dlgn0100DTO dlgn0100Dto, Dlgn0200DTO dlgn0200Dto) throws MSFException {
		String detailYmKubn = DiligenceCommonConstants.ANDONG_DLGN_DT_BUNGI;
//		String detailYmKubn = "201703"; //복무관리 기준일
		...
		//				}else{
				        ...
				        if( MSFConfiguration.EMYMT_DIVCD01.equals(dlgn0100Dto.getEmymtDivCd()) && ( "".equals(dlgn0100Dto.getTypOccuCd()) || "".equals(dlgn0100Dto.getDtilOccuInttnCd())) ) {
		...
		//				}
		           ...
		           while ( iter01.hasNext() ) {
		               ...
		               // 무기계약직 이면서 직종, 직종세 없을 경우 복무 로직 skip 처리
				        if( MSFConfiguration.EMYMT_DIVCD01.equals(dlgn0100Dto.getEmymtDivCd()) &&  ("".equals(dlgn0200Dto.getTypOccuCd()) || "".equals(dlgn0200Dto.getDtilOccuInttnCd())) ) {
