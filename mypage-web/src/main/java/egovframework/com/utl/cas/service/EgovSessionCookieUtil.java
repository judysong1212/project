...
public class EgovSessionCookieUtil {
     ...
     */
    public static void setCookie(HttpServletResponse response, String cookieNm, String cookieVal, int minute, String path) throws UnsupportedEncodingException {
    ...
    public static void delCookie(HttpServletResponse response, String cookieNm, String Path) throws UnsupportedEncodingException {
