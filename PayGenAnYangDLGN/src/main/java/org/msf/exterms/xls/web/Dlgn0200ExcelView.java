...
public class Dlgn0200ExcelView extends AbstractExcelView {
...
//      	String xlsRelatvieFilepath =   realPathA.concat("/src/main/mncpts/gwangmyeong/GwangMyeong/XlsTemplate/DLGN/XLS_DLGN020001_2.xls");
      	
      	String realPath = request.getSession().getServletContext().getRealPath(""); 
//      	String xlsRelatvieFilepath =   realPath.concat("/GimHae/".concat(globals.get("PayGen.XLSTemplateLink")).concat("/DLGN/XLS_DLGN020001_2.xls"));
      	String xlsRelatvieFilepath =   realPath.concat("/"+globals.get("PayGen.MunicipalitiesName").toLowerCase() +"/".concat(globals.get("PayGen.XLSTemplateLink")).concat("/DLGN/XLS_DLGN020001_2.xls"));

      	
        String destFileName = "시간외근무관리폼";
