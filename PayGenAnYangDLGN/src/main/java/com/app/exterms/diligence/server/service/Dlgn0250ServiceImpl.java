...
//                    dlgn0100Vo.setDilnlazPubcHodyDutyNumDys(MSFSharedUtils.defaultNulls(dlgn0250Dto.getDilnlazPubcHodyDutyNumDys(),"0"));    /** column 총휴일근무일수 : dilnlazPubcHodyDutyNumDys */
					...
					dlgn0100Vo.setDilnlazSppySnkfNumDys(MSFSharedUtils.defaultNulls(dlgn0250Dto.getDilnlazSppySnkfNumDys(),"0"));    	/** column 근태_간식비일수 : dilnlazSppySnkfNumDys */
					dlgn0100Vo.setDilnlazNgtdyNumDys(MSFSharedUtils.defaultNulls(dlgn0250Dto.getDilnlazNgtdyNumDys(),"0"));    			/** column 근태_숙직일수 : dilnlazNgtdyNumDys */
