...
//	    dlgn0250GridPanel.getMsfGrid().setCellModel(true);
	    ...
	    dlgn0250GridPanel.getGrid().getColumnModel().addHeaderGroup(0, 24, new HeaderGroupConfig("휴일근무", 1, 3));
	    dlgn0250GridPanel.getGrid().getColumnModel().addHeaderGroup(0, 31, new HeaderGroupConfig("시간외 근무", 1, 3));
