...
public static final String ATTR_DTILOCCUINTTNCD = "dtilOccuInttnCd";
    ...
    public static final String ATTR_DILNLAZSPPYSNKFNUMDYS = "dilnlazSppySnkfNumDys";

    /** set 근태_숙직일수 : dilnlazNgtdyNumDys */
    public static final String ATTR_DILNLAZNGTDYNUMDYS = "dilnlazNgtdyNumDys";
...
//        values.put(ATTR_PYSPGRDECD,pyspGrdeCd); } 
    ...
    /** set 근태_간식비일수 : dilnlazSppySnkfNumDys */
    public void setDilnlazSppySnkfNumDys(String  dilnlazSppySnkfNumDys) { set( ATTR_DILNLAZSPPYSNKFNUMDYS ,dilnlazSppySnkfNumDys);}
    /** get 근태_간식비일수 : dilnlazSppySnkfNumDys */
    public String  getDilnlazSppySnkfNumDys() { return (String )get( ATTR_DILNLAZSPPYSNKFNUMDYS );}
    /** set 근태_숙직일수 : dilnlazNgtdyNumDys */
    public void setDilnlazNgtdyNumDys(String  dilnlazNgtdyNumDys) { set( ATTR_DILNLAZNGTDYNUMDYS ,dilnlazNgtdyNumDys);}
    /** get 근태_숙직일수 : dilnlazNgtdyNumDys */
    public String  getDilnlazNgtdyNumDys() { return (String )get( ATTR_DILNLAZNGTDYNUMDYS );}
