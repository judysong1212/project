...
//	        	setTextFdMask("9:99");
		...
		/** column 근태_간식비여부 : dilnlazSppySnkfYn */
		listColumnDefs.add(new ColumnDef("간식비", Dlgn0110BM.ATTR_DILNLAZSPPYSNKFYN, ColumnDef.TYPE_BOOLEAN , 60, true, true, true){
			{

			}
		});
		/** column 근태_숙직여부 : dilnlazNgtdyYn */
		listColumnDefs.add(new ColumnDef("숙직", Dlgn0110BM.ATTR_DILNLAZNGTDYYN, ColumnDef.TYPE_BOOLEAN , 60, true, true, true){
			{
