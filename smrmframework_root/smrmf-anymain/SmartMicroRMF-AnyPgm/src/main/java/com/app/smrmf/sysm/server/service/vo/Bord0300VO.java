 ...
 */
public class Bord0300VO implements Serializable {
    ...
    /** BULL_BORD_MSGE_CTNT */
    private String bullBordMsgeCtnt;
    ...
    public String getBullBordMsgeCtnt() {
        return this.bullBordMsgeCtnt;
    }
    
    public void setBullBordMsgeCtnt(String bullBordMsgeCtnt) {
