...
/**
 * @Class Name : Bass0360DefaultVO.java
 * @Description : Bass0360 Default VO class
 ...
 */
public class SysIfBass0360SrhVO implements Serializable {
	 ...
	 * @brief date:2015 Dec 24, 2015 user:leeheuisung
