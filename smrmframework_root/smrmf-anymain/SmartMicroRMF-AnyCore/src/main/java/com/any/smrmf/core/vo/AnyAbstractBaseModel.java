...
public abstract class AnyAbstractBaseModel {
...
//    public static final double DEFAULT_VALUE_<FIELD_NAME> = ~~~;
   ...
   protected static Logger logger = LoggerFactory.getLogger(AnyAbstractBaseModel.class);
      ...
      for (Field field : fields) {
         ...
         try {
            ...
            try {
               ...
               try{
                  defaultValueField = AnyAbstractBaseModel.class.getDeclaredField(defaultValueFieldName);
