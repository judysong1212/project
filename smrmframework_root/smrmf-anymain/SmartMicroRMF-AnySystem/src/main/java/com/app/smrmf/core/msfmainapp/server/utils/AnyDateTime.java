 ...
 */
public final class AnyDateTime { 
        ...
        public static boolean isValid(String s) throws Exception {
            return AnyDateTime.isValid(s, "yyyyMMdd");
        }
    ...
    */
         ...
         * @param String to date string
         * @return int 날짜 형식이 맞고, 존재하는 날짜일 때 2개 일자 사이의 나이 리턴
         *           형식이 잘못 되었거나 존재하지 않는 날짜: java.text.ParseException 발생 -자기 자신의 일자를 포함하는경우 처리 
         */
        public static int daysBetween(String from, String to,int addNum) throws java.text.ParseException {
            return (daysBetween(from, to, "yyyyMMdd") + addNum);
        }
