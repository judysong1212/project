...
@RemoteServiceRelativePath("Bord0300Service.gwt")
public interface Bord0300Service extends RemoteService {
	/**
	 * Utility class for simplifying access to the instance of async service.
	 */
	public static class Util {
		private static Bord0300ServiceAsync instance;
		public static Bord0300ServiceAsync getInstance(){
			if (instance == null) {
				instance = GWT.create(Bord0300Service.class);
			}
			return instance;
		}
	}
