 ...
 */
public class SysIfBass0150BM  extends MSFSimpleBaseModel implements IsSerializable{
    ...
    /** 생성자 */
     public SysIfBass0150BM() { super(); } 

    /** 일괄등록 처리   */
     public SysIfBass0150BM(
    		 String  dpobCd 
    ...
    /** get 급여관리부서우편번호 : payMangeDeptZpcd */
    ...
    /** get 급여관리부서기본주소 : payMangeDeptFNdtnAddr */
    ...
    /** get 급여관리부서상세주소 : payMangeDeptDtlPatrAddr */
    ...
    /** get 급여관리부서전화번호 : payMangeDeptPhnNum */
    ...
    /** get 급여관리부서팩스번호 : payMangeDeptFaxNum */
    ...
    /** get 급여관리부서직인문구명 : payMangeDeptSealWrdNm */
    ...
    /** get 급여관리부서직인경로 : payMangeDeptSealRftaNm */
    ...
    /** get 급여관리부서직인파일명 : payMangeDeptSealFlNm */
    ...
    /** get 급여관리부서기본사용여부 : payMangeDeptFNdtnUseYn */
    ...
    /** get 급여관리부서총괄담당자 : payMangeDeptWhlePernChrg */
    ...
    /** get 급여관리부서분임지출관 : payMangeDeptDivTskOffr */
