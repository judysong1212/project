...
public class MSFShowMessage implements Serializable {
    ...
    public MSFShowMessage() {
    }

    public MSFShowMessage(String attributeName, String attributeValue, int errorCode, String errorMessage) {
