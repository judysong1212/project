 ...
 */
public class MSFSsoxUserBM   extends MSFSimpleBaseModel implements IsSerializable {
    ...
    /** 생성자 */
     public MSFSsoxUserBM() { super(); } 

    /** 일괄등록 처리   */
     public MSFSsoxUserBM(
    		 String  userId 
    		, String  userName 
    		, String  userSn 
    		, String  userStat 
     	...
     	values.put(ATTR_SSOUSETYPE,ssoUseType); } 
    ...
    public MSFSsoxUserBM clone(){
        return new MSFSsoxUserBM( 
  		  this.getUserId() 
   		, this.getUserName() 
   		, this.getUserSn() 
   		, this.getUserStat() 
   		, this.getUserStatName() 
   		, this.getRegularity() 
   		, this.getOrgId() 
   		, this.getOrgName() 
   		, this.getDeptId() 
   		, this.getDeptName() 
   		, this.getDeptFullname() 
   		, this.getClassId() 
   		, this.getClassName() 
   		, this.getPositionId()
