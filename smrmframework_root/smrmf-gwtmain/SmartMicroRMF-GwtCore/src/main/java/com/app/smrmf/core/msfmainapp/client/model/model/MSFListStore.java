...
public class MSFListStore extends BaseModel {
  ...
  public MSFListStore(String coKey, ListStore<BaseModel> listStore, boolean succ, boolean fail,HashMap<String, Object> mapStore) {
    this.coKey = coKey;
