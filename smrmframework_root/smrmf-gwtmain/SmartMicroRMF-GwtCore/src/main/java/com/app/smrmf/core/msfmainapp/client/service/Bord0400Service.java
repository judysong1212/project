...
@RemoteServiceRelativePath("Bord0400Service.gwt")
public interface Bord0400Service extends RemoteService {
	/**
	 * Utility class for simplifying access to the instance of async service.
	 */
	public static class Util {
		private static Bord0400ServiceAsync instance;
		public static Bord0400ServiceAsync getInstance(){
			if (instance == null) {
				instance = GWT.create(Bord0400Service.class);
			}
			return instance;
		}
	}
