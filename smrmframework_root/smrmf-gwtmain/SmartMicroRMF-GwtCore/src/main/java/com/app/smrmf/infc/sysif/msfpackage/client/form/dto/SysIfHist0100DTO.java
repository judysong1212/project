 ...
 */
public class SysIfHist0100DTO implements IsSerializable {
    ...
    private Long usrConnectSeilNum;
	...
	public Long getUsrConnectSeilNum() {
		return usrConnectSeilNum;
	}

	public void setUsrConnectSeilNum(Long usrConnectSeilNum) {
