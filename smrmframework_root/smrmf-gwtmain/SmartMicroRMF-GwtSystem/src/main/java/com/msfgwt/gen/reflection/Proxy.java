...
import com.msfgwt.reflection.client.impl.AnnotationImpl;
import com.msfgwt.reflection.client.impl.AnnotationValues;
import com.msfgwt.reflection.client.impl.ClassTypeImpl;
import com.msfgwt.reflection.client.impl.ConstructorImpl;
import com.msfgwt.reflection.client.impl.FieldImpl;
import com.msfgwt.reflection.client.impl.MethodImpl;
...
public class Proxy extends ClassTypeImpl<Proxy> {
	...
	protected void addAnnotation(Annotation[] annotations){
	  ...
	  //AnnotationStoreImpl store = new AnnotationStoreImpl(com.msfgwt.test.TestAnnotation.class, values);
	}
	
	private static class org_aspectj_lang_annotation_Before extends com.msfgwt.reflection.client.impl.ClassTypeImpl {
