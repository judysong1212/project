 ...
 * 
 * Size Control
 * <li>if you put this annotation to your class, no matter if you use this class in your application, msfgwt will put it into reflection system, and GWT compiler have to create the javascript for this class.
 * 
