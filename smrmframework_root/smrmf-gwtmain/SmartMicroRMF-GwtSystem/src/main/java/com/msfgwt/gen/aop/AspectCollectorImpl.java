...
import com.msfgwt.aop.ClassFilter;
import com.msfgwt.aop.MethodMatcher;
import com.msfgwt.aop.Pointcut;
import com.msfgwt.aop.matcher.AspectJExpress;
...
public class AspectCollectorImpl implements Pointcut, ClassFilter, MethodMatcher, AspectCollector {
	...
	/* (non-Javadoc)
	 * @see com.msfgwt.gen.aop.AspectCollector#allMatches(com.google.gwt.core.ext.typeinfo.JMethod)
	 */
	...
	/* (non-Javadoc)
	 * @see com.msfgwt.gen.aop.AspectCollector#getPointcut()
	 */
