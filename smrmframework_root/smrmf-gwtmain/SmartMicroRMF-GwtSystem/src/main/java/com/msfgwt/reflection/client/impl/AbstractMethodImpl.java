...
import com.msfgwt.reflection.client.AbstractMethod;
...
public abstract class AbstractMethodImpl implements HasAnnotations, AbstractMethod {
	...
	/* (non-Javadoc)
	 * @see com.msfgwt.client.reflection.AbstractMethod#findParameter(java.lang.String)
	 */
	...
	/* (non-Javadoc)
	 * @see com.msfgwt.client.reflection.AbstractMethod#getEnclosingType()
	 */
	public abstract ClassType getEnclosingType();

	/* (non-Javadoc)
	 * @see com.msfgwt.client.reflection.AbstractMethod#getName()
	 */
	...
	/* (non-Javadoc)
	 * @see com.msfgwt.client.reflection.AbstractMethod#getParameters()
	 */
	...
	/* (non-Javadoc)
	 * @see com.msfgwt.client.reflection.AbstractMethod#getReadableDeclaration()
	 */
	public abstract String getReadableDeclaration();

	/* (non-Javadoc)
	 * @see com.msfgwt.client.reflection.AbstractMethod#getThrows()
	 */
	...
	/* (non-Javadoc)
	 * @see com.msfgwt.client.reflection.AbstractMethod#isConstructor()
	 */
	...
	/* (non-Javadoc)
	 * @see com.msfgwt.client.reflection.AbstractMethod#isVarArgs()
	 */
	...
	/* (non-Javadoc)
	 * @see com.msfgwt.client.reflection.AbstractMethod#setVarArgs()
	 */
