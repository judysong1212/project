...
import com.msfgwt.aop.client.AdviceInstanceProvider;
import com.msfgwt.aop.client.AspectException;
import com.msfgwt.aop.client.intercept.MethodInterceptor;
import com.msfgwt.aop.client.intercept.impl.MethodInterceptorFinalAdapter;
import com.msfgwt.aop.client.intercept.impl.MethodInvocationLinkedAdapter;
import com.msfgwt.client.test.aop.Interceptors.PhoneLoggerInterceptor;
import com.msfgwt.client.test.aop.Interceptors.PhoneRedirectInterceptor;
	...
	private static class InterceptorMap{
		...
		static {
		  ...
		  //loop... for every aspected method
			...
			method = aspectClass.findMethod("invoke", new String[]{"com.msfgwt.client.aop.intercept.MethodInvocation"});
