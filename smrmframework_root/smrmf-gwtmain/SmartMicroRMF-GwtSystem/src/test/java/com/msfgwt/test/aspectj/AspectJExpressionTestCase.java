...
package com.msfgwt.test.aspectj;
...
import com.msfgwt.aop.matcher.Matchers;
import com.msfgwt.client.test.aop.Phone;
...
public class AspectJExpressionTestCase extends TestCase {
	...
	public void testMatchExplicit() throws SecurityException, NoSuchMethodException {
		String expression = "execution(* com.msfgwt.client.test.aop.Phone.call(java.lang.Number))";
	...
	public void testMatchClass(){
		String expression = "matchclass(com.msfgwt.test.aspectj.TestMatcher)";
