...
package com.msfgwt.client.test.aop;
...
import com.msfgwt.aop.client.intercept.MethodInvocation;
import com.msfgwt.client.test.aop.Phone.Receiver;
...
public class Interceptors {
	...
	public static class PhoneCallErrorLog{
		...
		@AfterThrowing(pointcut="execution(* com.msfgwt.client.test.aop.Phone.call(java.lang.Number))",
				throwing="e")
	...
	public static class PhoneLoggerInterceptor {
		...
		@Before("execution(* com.msfgwt.client.test.aop.Phone.call(java.lang.Number))")
		...
		@AfterReturning(pointcut = "execution(* com.msfgwt.client.test.aop.Phone.call(java.lang.Number))",
		...
		@After("execution(* com.msfgwt.client.test.aop.Phone.call(java.lang.Number))")
	...
	public static class PhoneRedirectInterceptor {
		...
		@Around("execution(* com.msfgwt.client.test.aop.Phone.call(java.lang.Number))")
	...
	public static class PhoneTestAnnotation{
		@Before("@annotation(com.msfgwt.client.test.aop.Interceptors.AOPTestAnnotation)")
	...
	public static class PhoneTestMatchClass{
		@Before("matchclass(com.msfgwt.test.aspectj.TestMatcher)")
		public void testPhoneAnnotation(MethodInvocation invocation) throws Throwable {
			Number number = null;
			for (Object obj : invocation.getArguments()){
				if (obj instanceof Number)
