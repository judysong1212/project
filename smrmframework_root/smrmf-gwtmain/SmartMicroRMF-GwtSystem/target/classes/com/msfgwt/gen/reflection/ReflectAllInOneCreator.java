...
import com.msfgwt.common.client.CheckedExceptionWrapper;
import com.msfgwt.gen.GenExclusion;
import com.msfgwt.gen.GenUtils;
import com.msfgwt.gen.LogableSourceCreator;
...
import com.msfgwt.reflection.client.impl.TypeOracleImpl;
...
//		source.println("}");
		...
		source.println("public com.msfgwt.reflection.client.Type doGetType(String name) {");
		source.indent();
		//source.println("com.msfgwt.reflection.client.Type resultType = super.doGetType(name);");
	...
	private void genAllClasses(SourceWriter sourceWriter, Map<JClassType, String> typeNameMap){
		for(JClassType type : candidateList){
			...
			sourceWriter.println("public static interface " + className + " extends com.msfgwt.reflection.client.ClassType {}");
	...
	private void getAllReflectionClasses() throws NotFoundException{
		...
		//typeOracle.getType("com.msfgwt.client.test.reflection.TestReflectionGenerics.TestReflection1");
...
//			System.out.println("addClassIfNotExists: " + classType.getQualifiedSourceName());
	...
	protected SourceWriter doGetSourceWriter(JClassType classType) throws NotFoundException {
		...
		composer.addImport("com.msfgwt.reflection.client.*");
		composer.addImport(classType.getPackage().getName() + ".*");
		
		composer.addImport("com.msfgwt.reflection.client.impl.*");
