...
import com.msfgwt.gen.reflection.accessadapter.JFeildAdapter;
import com.msfgwt.gen.reflection.accessadapter.JMethodAdapter;
...
//		return str.replaceAll("\"", "\\\"");
	...
	public static String createAnnotationValues(com.google.gwt.core.ext.typeinfo.TypeOracle typeOracle, 
		...
		JClassType classType = typeOracle.findType(ReflectionUtils.getQualifiedSourceName(annotation.annotationType()));
  	if (classType != null){
  		sb.append("com.msfgwt.reflection.client.impl.AnnotationValues.toAnnotation(new com.msfgwt.reflection.client.impl.AnnotationValues(");
