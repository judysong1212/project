...
import com.msfgwt.reflection.client.impl.AnnotationTypeImpl;
...
public class ReflectionCreator extends LogableSourceCreator {
	...
	public SourceWriter doGetSourceWriter(JClassType classType) {
		...
		if(getReflectionType(classType).isAnnotation()!=null){
			...
			composer
					.setSuperclass("com.msfgwt.reflection.client.impl.ClassTypeImpl<"
							+ getReflectionType(classType)
									.getQualifiedSourceName() + ">");
		}else{
			composer
					.setSuperclass("com.msfgwt.reflection.client.impl.EnumTypeImpl<"
							+ getReflectionType(classType)
									.getQualifiedSourceName() + ">");
		}
		...
		composer.addImport("com.msfgwt.common.client.*");
	...
	protected String getPackageName(JClassType classType) {
		...
		return packageName;
		// return "com.msfgwt.reflection.client.gen."
