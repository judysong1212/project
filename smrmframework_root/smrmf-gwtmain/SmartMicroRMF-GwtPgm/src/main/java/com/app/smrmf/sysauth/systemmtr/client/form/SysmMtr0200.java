...
import com.app.smrmf.sysauth.systemmtr.client.service.SysmMtr0200ServiceAsync;
...
=====================================================**/
public class SysmMtr0200  extends MSFPanel { 
  ...
  private FormPanel plFrmSysmMtr0200;
  ...
  private SysmMtr0200ServiceAsync sysmMtr0200Service = SysmMtr0200Service.Util.getInstance();
  ...
  public ContentPanel getViewPanel(){
	...
	private void createPsnl0100Form() {
		  ...
		  plFrmSysmMtr0200 = new FormPanel();
		  plFrmSysmMtr0200.setHeadingText("ExTerms Ver1.0 - " + lblSysmConst.main_TitleSysmMtr0200());
		  plFrmSysmMtr0200.setIcon(Resources.APP_ICONS.text());
		  plFrmSysmMtr0200.setBodyStyleName("pad-text");
		  plFrmSysmMtr0200.setFrame(false); 
...
//            bar.add(field);  
            //	            
//            plFrmSysmMtr0200.setTopComponent(bar);
...
//            bottomToolbar.add(deleteButton);
            ...
            plFrmSysmMtr0200.setBottomComponent(bottomToolbar);  
            plFrmSysmMtr0200.add(grid);
             readVociMenu();	 
				    
			vp.add(plFrmSysmMtr0200);
			plFrmSysmMtr0200.setSize("990px", "680px");
	}		
  ...
  public SysmMtr0200(String txtForm) {
...
//        }
    ...
    private void readVociMenu(){
        ...
        //LOOP QUESTIONARI
        sysmMtr0200Service.getListSysmMtr0200Menu(new AsyncCallback<List<SysIfSysm0200BM>>(){
            public void onFailure(Throwable caught) {
                MessageBox.alert(MSFMainApp.MSFCONSTANTS.ExceptionTitleService(), 
                        MSFMainApp.ADMINMESSAGES.ExceptionMessageService("getListSysmMtr0200Menu(): "+caught), null);
            }
