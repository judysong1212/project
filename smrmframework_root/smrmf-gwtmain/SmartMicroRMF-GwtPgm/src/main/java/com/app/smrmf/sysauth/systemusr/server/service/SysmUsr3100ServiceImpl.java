 ...
 * 
* <pre>
* 1. 패키지명 : com.app.smrmf.sysauth.systemusr.server.service
...
* </pre>
 */
@Service("SysmUsr3100Service")
public class SysmUsr3100ServiceImpl  extends AbstractCustomServiceImpl implements SysmUsr3100Service  ,SysmUsrDaoConstants {

	 
		private static final Logger logger = LoggerFactory.getLogger(SysmUsr3100ServiceImpl.class);
		private static final String calledClass = SysmUsr3100ServiceImpl.class.getName();  
