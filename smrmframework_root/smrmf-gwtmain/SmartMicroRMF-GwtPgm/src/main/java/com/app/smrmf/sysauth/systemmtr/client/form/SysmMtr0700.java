...
import com.app.smrmf.sysauth.systemmtr.client.form.defs.SysMtrSysm0700Def;
...
=====================================================**/
public class SysmMtr0700  extends MSFPanel { 
 ...
 private FormPanel plFrmSysmMtr0700; 
 ...
 private SysMtrSysm0100Def  sysm0100Def  = new SysMtrSysm0100Def("SYSM0700");
 private SysMtrSysm0700Def  sysm0700Def = new SysMtrSysm0700Def("SYSM0700"); 
 private SysIfBass0360Def sysIfBass0360Btm = new SysIfBass0360Def("SYSM0700"); 
 private MSFGridPanel msfGridSysm0100; 
 private MSFGridPanel msfGridSysmMtr0700;
...
public ContentPanel getViewPanel() {
   if (panel == null) {        	
	    ...
	    vp.setSpacing(10);
	    createSysmMtr0700Form();  //화면 기본정보를 설정
...
//	         });
   ...
   return panel;
		  ...
		  public SysmMtr0700(String txtForm) {
				this.txtForm = txtForm;
		  }		  
		  
		  private void createSysmMtr0700Form() {
			  
			plFrmSysmMtr0700 = new FormPanel();
			plFrmSysmMtr0700.setHeadingText("PayGen Ver1.0 - 개인별업무권한관리");
			plFrmSysmMtr0700.setIcon(Resources.APP_ICONS.text());
			plFrmSysmMtr0700.setBodyStyleName("pad-text");
			plFrmSysmMtr0700.setFrame(true); 
	            ...
	            msfGridSysm0100 = new MSFGridPanel(sysm0100Def, false, false, false); 
	            ...
	            grid.addListener(Events.CellDoubleClick , new Listener<BaseEvent>() {
	                public void handleEvent(BaseEvent be) {
	                	...
	                	//msfGridSysmMtr0700.mask(MSFMainApp.MSFMESSAGES.LoadingData());
	                	//dtilOccuClsNm.clear();	     
	                	//readtry();
	                	//readtry2();
	                }					
	     	 ...
	     	 usrNm.addKeyListener(new KeyListener() {
	            ...
	            // 두번째 컨테이너컬럼(사용직종정보)   
	            msfGridSysmMtr0700 = new MSFGridPanel(sysm0700Def, false, false, false, false); 
	            msfGridSysmMtr0700.setSize(550, 300);
	            msfGridSysmMtr0700.getGrid().setBorders(true);
	         
	            final Grid<BaseModel> grid2 = msfGridSysmMtr0700.getMsfGrid().getGrid();
	     	   ...
	     	   dtilOccuClsNm.addKeyListener(new KeyListener() {
	     	    ...
	     	    msfGridSysmMtr0700.setTopComponent(lycSreach2);
	          ...
	          //툴바메뉴
	            ...
	            btnSelectBass0360.addSelectionListener(new SelectionListener<ButtonEvent>() {		        
	                public void componentSelected(ButtonEvent ce) { 
	                	  ...
	                	  int  lsCnt = msfGridSysmMtr0700.getMsfGrid().getGrid().getStore().getCount();
	                	  
	                	  for(int iCnt=0;iCnt < lsCnt;iCnt++) {
	                		  
	                		  msfGridSysmMtr0700.getMsfGrid().getGrid().getStore().getAt(iCnt).set("select", Boolean.TRUE);
	                		  msfGridSysmMtr0700.getMsfGrid().getGrid().getStore().commitChanges();
	                		   
	                	  } 
	                	  msfGridSysmMtr0700.getMsfGrid().getGrid().getView().refresh(true);
	    		    }
	            });
	           ...
	           // ================전체해제버튼=========================
	            ...
	            btnUnSelectBass0360.addSelectionListener(new SelectionListener<ButtonEvent>() {
	                public void componentSelected(ButtonEvent ce) {  
	                	  ...
	                	  for(int iCnt=0;iCnt < lsCnt;iCnt++) {
	                		  ...
	                		  msfGridSysmMtr0700.getMsfGrid().getGrid().getStore().getAt(iCnt).set("select", Boolean.FALSE);
	                		  msfGridSysmMtr0700.getMsfGrid().getGrid().getStore().commitChanges();
	            ...
	            saveButton.addSelectionListener(new SelectionListener<ButtonEvent>() {
	                ...
	                public void componentSelected(ButtonEvent ce) {
	                	  Iterator<BaseModel> itBm  = msfGridSysmMtr0700.getMsfGrid().getGrid().getStore().getModels().listIterator();  //.getSelectionModel().getSelectedItems().listIterator();
	         ...
	         // ================전체선택버튼=========================
	           ...
	           // ================전체해제버튼=========================
	            ...
	            //툴바 넣어주는것
	            msfGridSysmMtr0700.setBottomComponent(bottomToolbar);
	            ...
	            LayoutContainer layoutContainer_16 = new LayoutContainer();
	     	    ...
	     	    layoutContainer_16.add(msfGridSysmMtr0700);
	     	    layoutContainer_16.add(space);
	     	    layoutContainer_16.add(msfGdSysIfBass0360Btm);
	     	    
	            inner.add(layoutContainer_16);		            
	            
	        plFrmSysmMtr0700.add(inner);

			vp.add(plFrmSysmMtr0700);
			plFrmSysmMtr0700.setSize("990px", "680px");
		  }	
		  
		  
//private void readtry() {
//	 Object str = msfGridSysm0100.getMsfGrid().getCurrentlySelectedItem().get("deptCd").toString();
//    msfGridSysmMtr0700.getTableDef().setTableColumnFilters(null);
//    TextField<String> deptCd = new TextField<String>();
//    deptCd.setValue((String)str); 
//   msfGridSysmMtr0700.getTableDef().addColumnFilter("deptCd", MSFSharedUtils.defaultNulls(str,""), SimpleColumnFilter.OPERATOR_EQUALS);
//  	msfGridSysmMtr0700.unmask();
//	msfGridSysmMtr0700.reload();
//}	
//
...
public void reOccuInload() {
       ...
       msfGridSysmMtr0700.getTableDef().setTableColumnFilters(filters); 	        
       msfGridSysmMtr0700.getTableDef().addColumnFilter("usrId", MSFSharedUtils.defaultNulls(usrId,""), SimpleColumnFilter.OPERATOR_EQUALS); 
       msfGridSysmMtr0700.getTableDef().addColumnFilter("deptCd", MSFSharedUtils.defaultNulls(deptCd,""), SimpleColumnFilter.OPERATOR_EQUALS); 
       msfGridSysmMtr0700.getTableDef().addColumnFilter("dtilOccuClsNm", MSFSharedUtils.defaultNulls(dtilOccuClsNm.getValue(),""), SimpleColumnFilter.OPERATOR_EQUALS); 
       msfGridSysmMtr0700.reload();
}
