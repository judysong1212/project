...
import com.app.smrmf.sysauth.systemusr.client.service.SysmUsr0700Service;
...
/**
 * <pre>
 * com.app.smrmf.sysauth.systemusr.server.service 
 ...
 * @author : leeheuisung
 */
@Service("SysmUsr0700Service")
public class SysmUsr0700ServiceImpl extends AbstractCustomServiceImpl implements  MSFPkgDaoConstants,SysmUsrDaoConstants ,  SysmUsr0700Service {
	 
	private static final Logger logger = LoggerFactory.getLogger(SysmUsr0700ServiceImpl.class);
	private static final String calledClass = SysmUsr0700ServiceImpl.class.getName();
	 ...
	 * @throws MSFException
	 */
	public PagingLoadResult<BaseModel> getSelectSysmUsr0700ToSysm0100List(ServiceParameters serviceParameters) throws MSFException {

        PagingLoadResult<BaseModel> retval = null;
        String method =  CLASS_SYSMUSR0700TOSYSM0100_LIST;
	...
	public PagingLoadResult<BaseModel> getSelectSysm0700ToSysm0700List(ServiceParameters serviceParameters) throws MSFException {
        ...
        PagingLoadResult<BaseModel> retval = null;
        String method =  CLASS_SYSMUSR0700TOSYSM0700_LIST;
        List<BaseModel>  bmResult = new ArrayList<BaseModel>();
	...
	public PagingLoadResult<BaseModel> getSelectSysm0700ToBass0360List(ServiceParameters serviceParameters) throws MSFException {
		 PagingLoadResult<BaseModel> retval = null;
	        String method =  PKG_SYSM0700TOBASS0360_LIST;
	        List<BaseModel>  bmResult = new ArrayList<BaseModel>();
