...
@RemoteServiceRelativePath("SysmUsr0400Service.gwt")
public interface SysmUsr0400Service extends RemoteService {
	/**
	 * Utility class for simplifying access to the instance of async service.
	 */
	public static class Util {
		private static SysmUsr0400ServiceAsync instance;
		public static SysmUsr0400ServiceAsync getInstance(){
			if (instance == null) {
				instance = GWT.create(SysmUsr0400Service.class);
			}
			return instance;
		}
	}
