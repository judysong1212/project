...
import com.app.smrmf.sysauth.system.client.service.Sysm0500Service;
...
@Service("Sysm0500Service")
public class Sysm0500ServiceImpl extends AbstractCustomServiceImpl implements  SysmDaoConstants , Sysm0500Service {

	private static final Logger logger = LoggerFactory.getLogger(Sysm0500ServiceImpl.class);
	private static final String calledClass = Sysm0500ServiceImpl.class.getName();
 ...
 public Long activityOnSysm0500User(SysIfSysm0500DTO sysm0500Dto, ActionDatabase actionDatabase)   throws MSFException {
	...
	public List<SysIfSysm0500DTO> getListaSysm0500User(MSFSysm0100BM utente) {
		  ...
		  //  Session session = null;
	        ...
	        if (user!=null) {
	            try {
	                ...
	                logger.error("EXCEPTION calling getListaSysm0500User(): "+ex);
