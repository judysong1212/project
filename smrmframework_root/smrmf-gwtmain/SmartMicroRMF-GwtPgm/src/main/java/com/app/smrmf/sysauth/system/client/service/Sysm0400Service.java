...
@RemoteServiceRelativePath("Sysm0400Service.gwt")
public interface Sysm0400Service extends RemoteService {
	/**
	 * Utility class for simplifying access to the instance of async service.
	 */
	public static class Util {
		private static Sysm0400ServiceAsync instance;
		public static Sysm0400ServiceAsync getInstance(){
			if (instance == null) {
				instance = GWT.create(Sysm0400Service.class);
			}
			return instance;
		}
	}
