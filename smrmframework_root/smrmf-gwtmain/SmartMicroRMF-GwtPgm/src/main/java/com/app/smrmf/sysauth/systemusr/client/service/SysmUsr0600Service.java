...
@RemoteServiceRelativePath("SysmUsr0600Service.gwt")
public interface SysmUsr0600Service extends RemoteService {
	/**
	 * Utility class for simplifying access to the instance of async service.
	 */
	public static class Util {
		private static SysmUsr0600ServiceAsync instance;
		public static SysmUsr0600ServiceAsync getInstance(){
			if (instance == null) {
				instance = GWT.create(SysmUsr0600Service.class);
			}
			return instance;
		}
	}
