...
import com.app.smrmf.sysauth.systemusr.client.service.SysmUsr0300Service;
...
@Service("SysmUsr0300Service")
public class SysmUsr0300ServiceImpl extends AbstractCustomServiceImpl implements  SysmUsrDaoConstants ,SysmUsr0300Service {

	private static final Logger logger = LoggerFactory.getLogger(SysmUsr0300ServiceImpl.class);
	private static final String calledClass = SysmUsr0300ServiceImpl.class.getName();
