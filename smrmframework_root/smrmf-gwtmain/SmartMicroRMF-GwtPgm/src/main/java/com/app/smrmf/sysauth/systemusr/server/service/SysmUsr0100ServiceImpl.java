...
@Service("SysmUsr0100Service") 
public class SysmUsr0100ServiceImpl  extends AbstractCustomServiceImpl implements  SysmUsrDaoConstants ,SysmUsr0100Service  {

	private static final Logger logger = LoggerFactory.getLogger(SysmUsr0100ServiceImpl.class);
	private static final String calledClass = SysmUsr0100ServiceImpl.class.getName();
