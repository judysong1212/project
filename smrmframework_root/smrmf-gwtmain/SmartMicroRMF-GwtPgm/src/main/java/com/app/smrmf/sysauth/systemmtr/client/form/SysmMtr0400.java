...
import com.app.smrmf.sysauth.systemmtr.client.service.SysmMtr0400ServiceAsync;
...
=====================================================**/
public class SysmMtr0400  extends MSFPanel { 
	 ...
	 /**######################################################
	  ...
	  private FormPanel plFrmSysmMtr0400;
	  private FormData formData; 
	  private String txtForm = ""; 
	  
	  
   private EditorTreeGrid<SysIfSysm0400BM> treePanel;
   private SysmMtr0400ServiceAsync sysmMtr0400Service = SysmMtr0400Service.Util.getInstance();
   ...
   private TextField<String> authGrpNm;         //권한그룹명
	  ...
	  public ContentPanel getViewPanel(){
			if(panel == null){
				 ...
				 //   formData = new FormData("-650");
				    ...
				    vp.setSpacing(10);
				    createSysmMtr0400Form();  //화면 기본정보를 설정
	  ...
	  public SysmMtr0400(String txtForm) {
			this.txtForm = txtForm;
	  }
	  
	  private void createSysmMtr0400Form() {
		  
		plFrmSysmMtr0400 = new FormPanel();
		plFrmSysmMtr0400.setHeadingText("ExTerms Ver1.0 - 권한그룹관리");
		plFrmSysmMtr0400.setIcon(MSFMainApp.ICONS.text());
		plFrmSysmMtr0400.setBodyStyleName("pad-text");
		plFrmSysmMtr0400.setPadding(2);
		plFrmSysmMtr0400.setFrame(true); 
        ...
        // RowEditor<ModelData> rowEdit = new RowEditor<ModelData>()
         ...
         plFrmSysmMtr0400.add(inner);
		 
		    
		vp.add(plFrmSysmMtr0400);
		plFrmSysmMtr0400.setSize("990px", "680px");
	  }
	    ...
	    private void insertOrDeleteVociMenuProfile(final SysIfSysm0400BM node) {
	        ...
	        sysmMtr0400Service.activityOnVoceMenuProfile(node, actionDatabase, new AsyncCallback<String>(){
	    ...
	    private void readVociMenuProfile(SysIfSysm0300DTO prf){
	    	sysmMtr0400Service.getListaVociMenuProfile(prf, new AsyncCallback<List<SysIfSysm0400BM>>(){
	            public void onFailure(Throwable caught) {
	                MessageBox.alert(MSFMainApp.MSFCONSTANTS.ExceptionTitleService(), 
