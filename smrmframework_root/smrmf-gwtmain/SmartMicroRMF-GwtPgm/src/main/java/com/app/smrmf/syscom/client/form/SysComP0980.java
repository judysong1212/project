...
public class SysComP0980  extends Lov implements SysComDaoConstants { 
  ...
  private static SysIfBass0300DTO sysComBass0300Dto; //공통코드 dto
  private static SysIfBass0400DTO sysComBass0400Dto; //부서코드
...
public static void setUsrNm(TextField<String> usrNm) {
	SysComP0980.usrNm = usrNm;
}

	public SysComP0980(int width, int height) {
        this();
        this.width  = width;
        this.height = height;
    }
    ...
    public SysComP0980() {
        ...
        lovDef.setCustomListMethod(MSFCOM_METHOD_POPUP_SYSM0100_List);
    ...
    public static final LayoutContainer getMsfComP0500Filter() {
        ...
        //고용구분
    	 ...
    	 lsUsrDivCd = SysifComServiceUtils.getSingleBass0300ComboData( sysComBass0300Dto);
    	 //--------------------공통 코드 불러 오는 함수 --------------------------------------------------
    	
    	//--------------------부서 불러 오는 함수 ------------------------------------------------
		 lsDeptCd = SysifComServiceUtils.getDeptBass0400ComboData(sysComBass0400Dto);
		 //--------------------부서 불러 오는 함수 ------------------------------------------------
            ...
            LayoutContainer frmSearchLayer = new LayoutContainer();
             ...
             layoutContainer_12.add(layoutContainer_2,new com.extjs.gxt.ui.client.widget.layout.ColumnData(.36));
