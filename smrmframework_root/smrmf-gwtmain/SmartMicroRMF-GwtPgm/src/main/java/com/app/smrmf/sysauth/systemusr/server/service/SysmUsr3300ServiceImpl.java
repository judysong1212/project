...
* </pre>
 */
@Service("SysmUsr3300Service")
public class SysmUsr3300ServiceImpl  extends AbstractCustomServiceImpl implements SysmUsr3300Service, SysmUsrDaoConstants {

	    private static final Logger logger = LoggerFactory.getLogger(SysmUsr3300ServiceImpl.class);
	    private static final String calledClass = SysmUsr3300ServiceImpl.class.getName();  
