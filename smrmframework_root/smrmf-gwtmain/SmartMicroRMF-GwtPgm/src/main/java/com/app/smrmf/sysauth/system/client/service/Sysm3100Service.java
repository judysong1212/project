...
@RemoteServiceRelativePath("Sysm3100Service.gwt")
public interface Sysm3100Service extends RemoteService {
	/**
	 * Utility class for simplifying access to the instance of async service.
	 */
	public static class Util {
		private static Sysm3100ServiceAsync instance;
		public static Sysm3100ServiceAsync getInstance(){
			if (instance == null) {
				instance = GWT.create(Sysm3100Service.class);
			}
			return instance;
		}
	}
