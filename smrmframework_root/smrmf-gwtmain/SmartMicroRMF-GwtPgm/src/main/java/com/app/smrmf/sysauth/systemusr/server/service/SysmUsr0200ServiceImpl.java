...
@Service("SysmUsr0200Service") 
public class SysmUsr0200ServiceImpl extends AbstractCustomServiceImpl implements  SysmUsrDaoConstants , SysmUsr0200Service {
	  
	private static final Logger logger = LoggerFactory.getLogger(SysmUsr0200ServiceImpl.class);
	private static final String calledClass = SysmUsr0200ServiceImpl.class.getName();
