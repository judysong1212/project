...
import com.app.smrmf.sysauth.system.client.service.Sysm0400ServiceAsync;
...
=====================================================**/
public class Sysm0400  extends MSFPanel { 
    ...
    private Sysm0400ServiceAsync sysm0400Service = Sysm0400Service.Util.getInstance();
    ...
    private TextField<String> authGrpNm;         //권한그룹명
	  ...
	  public Sysm0400(String txtForm) {
