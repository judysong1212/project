...
import com.app.smrmf.sysauth.systemusr.client.form.defs.SysUsrSysm0700Def;
import com.app.smrmf.sysauth.systemusr.client.service.SysmUsr0700Service;
import com.app.smrmf.sysauth.systemusr.client.service.SysmUsr0700ServiceAsync;
...
=====================================================**/
public class SysmUsr0700  extends MSFPanel { 
  ...
  private SysmUsr0700ServiceAsync sysm0700Service = SysmUsr0700Service.Util.getInstance();  
  ...
  private SysUsrSysm0100Def  sysm0100Def  = new SysUsrSysm0100Def("SYSM0700");
  private SysUsrSysm0700Def  sysm0700Def = new SysUsrSysm0700Def("SYSM0700"); 
...
//	         });
    ...
    return panel;
		  ...
		  public SysmUsr0700(String txtForm) {
		  ...
		  private void createSysm0700Form() {
			...
			plFrmSysm0700.setFrame(true); 
	     	 ...
	     	 usrNm.addKeyListener(new KeyListener() {
	            ...
	            // 두번째 컨테이너컬럼(사용직종정보)   
	            msfGridSysm0700 = new MSFGridPanel(sysm0700Def, false, false, false, false); 
