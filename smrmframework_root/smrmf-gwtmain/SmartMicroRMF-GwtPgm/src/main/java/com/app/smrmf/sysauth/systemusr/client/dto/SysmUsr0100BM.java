 ...
 */
public class SysmUsr0100BM    extends MSFSimpleBaseModel implements IsSerializable {
	...
	public static final String ATTR_USEYN = "useYn";
	 ...
	 /** set 계정잠금  : lockat */
    public static final String ATTR_LOCKAT = "lockat"; // 계정잠금 추가/ hieju/06.27
	...
	/** 생성자 */
	 public SysmUsr0100BM() { super(); } 

	/** 일괄등록 처리   */
	 public SysmUsr0100BM(
			 String  sysDivCd 
			, String  usrId 
			, String  usrNm 
			, String  usrDivCd 
