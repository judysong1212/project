...
=====================================================**/
public class SysmUsr0500  extends MSFPanel { 
...
//         });
    ...
    return panel;
		  ...
		  public SysmUsr0500(String txtForm) {
		  ...
		  private void createSysmUsr0500Form() {
			...
			plFrmSysmUsr0500.setHeadingText("PayGen Ver1.0 - 단위기관별권한관리");
...
private SysmUsr0500 getThis(){
    return this;
}

private void bass0360Delete(SysIfBass0360DTO bass0360Dto) {
	sysm0500Service.bass0360Delete(bass0360Dto, new AsyncCallback<Long>() {
		@Override
...
private void bass0360Insert(SysIfBass0360DTO bass0360Dto) {
	sysm0500Service.bass0360Insert(bass0360Dto, new AsyncCallback<Long>(){
		@Override 
		public void onFailure(Throwable caught) {
			MessageBox.alert(MSFMainApp.MSFCONSTANTS.ExceptionTitleService(), 
