...
/**
 * <pre>
 * com.app.smrmf.sysauth.systemmtr.server.service 
 ...
 * @author : leeheuisung
 */
@Service("SysmMtr0700Service")
public class SysmMtr0700ServiceImpl extends AbstractCustomServiceImpl implements  SysmMtrDaoConstants ,  SysmMtr0700Service {
	 
	private static final Logger logger = LoggerFactory.getLogger(SysmMtr0700ServiceImpl.class);
	private static final String calledClass = SysmMtr0700ServiceImpl.class.getName();
	 ...
	 * @throws MSFException
	 */
	public PagingLoadResult<BaseModel> getSelectSysmMtr0700ToSysm0100List(ServiceParameters serviceParameters) throws MSFException {

        PagingLoadResult<BaseModel> retval = null;
        String method =  CLASS_SYSMMTR0700TOSYSM0100_LIST;
	  ...
	  * @throws MSFException
	  */
	public PagingLoadResult<BaseModel> getSelectSysmMtr0700ToSysm0700List(ServiceParameters serviceParameters) throws MSFException {

        PagingLoadResult<BaseModel> retval = null;
        String method =  CLASS_SYSMMTR0700TOSYSM0700_LIST;
        List<BaseModel>  bmResult = new ArrayList<BaseModel>();
	 ...
	 * @throws MSFException
	 */
	public PagingLoadResult<BaseModel> getSelectSysmMtr0700ToBass0360List(ServiceParameters serviceParameters) throws MSFException {
		 PagingLoadResult<BaseModel> retval = null;
	        String method =  CLASS_SYSMMTR0700TOBASS0360_LIST;
	        List<BaseModel>  bmResult = new ArrayList<BaseModel>();
	        ...
	        try{
	            ...
	            SmrmfUtils.endTiming(logger, millisBeginSelectSysm0700ToBass0360List, "selectSysmMtr0700ToBass0360List");
...
//		sysm0700Vo.setRevnAddr(sysm0700Dto.getRevnAddr());    /** column 수정주소 : revnAddr */
	...
	public Long sysm0700Insert(SysIfSysm0700DTO sysm0700Dto) throws MSFException {
		...
		try {
			...
			sysm0700Vo.setDeptCd(sysm0700Dto.getDeptCd());    				/** column 부서코드 : deptCd */
			sysm0700Vo.setUsrId(sysm0700Dto.getUsrId());    				/** column 사용자아이디 : usrId */
			sysm0700Vo.setKybdr(sessionUser.getUsrId());    /** column 입력자 : kybdr */
		  //	sysm0700Vo.setInptAddr(sysm0700Dto.getInptAddr());    /** column 입력주소 : inptAddr */
			sysm0700Vo.setIsmt(sessionUser.getUsrId());    /** column 수정자 : ismt */
		//    sysm0700Vo.setRevnAddr(sysm0700Dto.getRevnAddr());    /** column 수정주소 : revnAddr */
