...
@Service("SysmUsr0500Service")
public class SysmUsr0500ServiceImpl extends AbstractCustomServiceImpl implements  SysmUsrDaoConstants , SysmUsr0500Service {

	private static final Logger logger = LoggerFactory.getLogger(SysmUsr0500ServiceImpl.class);
	private static final String calledClass = SysmUsr0500ServiceImpl.class.getName();
	 ...
	 * 2. 처리내용 : 
	 * </pre>
	 * @Method Name : getSelectSysmUsr0500ToBass0150List
	 * @date : Dec 23, 2015
	 * @author : leeheuisung
	 * @history : 
	 *	-----------------------------------------------------------------------
	 ...
	 * @throws MSFException
	 */
	public PagingLoadResult<BaseModel> getSelectSysmUsr0500ToBass0150List(ServiceParameters serviceParameters) throws MSFException {

        PagingLoadResult<BaseModel> retval = null;
        String method =  CLASS_SYSMUSR0500TOBASS0150_LIST;
...
//      Bass0400VO bass0400Vo = new Bass0400VO();
        ...
        try{
            ...
            if ( pagingValues.executeRecordCount ) { 
            	...
            	int iResultCnt = sysIfBass0150Dao.selectSysmUsr0500ToBass0150ListTotCnt(sysIfBass0150SrhVo);
            ...
            List list = sysIfBass0150Dao.selectSysmUsr0500ToBass0150List(sysIfBass0150SrhVo);
	  ...
	  * 2. 처리내용 : 
	  * </pre>
	  * @Method Name : getSelectSysmUsr0500TopToBass0360List
	  * @date : Dec 23, 2015
	  * @author : leeheuisung
	  * @history : 
	  *	-----------------------------------------------------------------------
	  ...
	  * @throws MSFException
	  */
	public PagingLoadResult<BaseModel> getSelectSysmUsr0500TopToBass0360List(ServiceParameters serviceParameters) throws MSFException {

        PagingLoadResult<BaseModel> retval = null;
        String method =  CLASS_SYSMUSR0500TOPTOBASS0360_LIST;
        List<BaseModel>  bmResult = new ArrayList<BaseModel>();
        ...
        try{
            ...
            if ( pagingValues.executeRecordCount ) { 
            	TimingInfo millisBeginQueryCount = SmrmfUtils.startTiming(logger);
            	int iResultCnt = sysIfBass0360Dao.selectSysmUsr0500TopToBass0360ListTotCnt(bass0360SrhVo);
            	SmrmfUtils.endTiming(logger, millisBeginQueryCount, "QueryCount"); 
                pagingValues.totalRecordCount = iResultCnt;	
                logger.debug("totalRecordCount : " + pagingValues.totalRecordCount);
            }
            ...
            List list = sysIfBass0360Dao.selectSysmUsr0500TopToBass0360List(bass0360SrhVo);
	 ...
	 * @throws MSFException
	 */
	public PagingLoadResult<BaseModel> getSelectSysmUsr0500BtmToBass0360List(ServiceParameters serviceParameters) throws MSFException {
		 PagingLoadResult<BaseModel> retval = null;
	        String method =  CLASS_SYSMUSR0500BTMTOBASS0360_LIST;
	        List<BaseModel>  bmResult = new ArrayList<BaseModel>();
	        SysIfBass0360SrhVO bass0360SrhVo = new SysIfBass0360SrhVO();
	        MSFSysm0100BM sessionUser = MSFServerUtils.getLoggedUser(RemoteServiceUtil.getThreadLocalRequest());
	        ...
	        try{
	            ...
	            if ( pagingValues.executeRecordCount ) { 
	            	TimingInfo millisBeginQueryCount = SmrmfUtils.startTiming(logger);
	            	int iResultCnt = sysIfBass0360Dao.selectSysmUsr0500BtmToBass0360ListTotCnt(bass0360SrhVo);
	            	SmrmfUtils.endTiming(logger, millisBeginQueryCount, "QueryCount"); 
	                pagingValues.totalRecordCount = iResultCnt;	
	                logger.debug("totalRecordCount : " + pagingValues.totalRecordCount);
	            }
	            ...
	            List list = sysIfBass0360Dao.selectSysmUsr0500BtmToBass0360List(bass0360SrhVo);
