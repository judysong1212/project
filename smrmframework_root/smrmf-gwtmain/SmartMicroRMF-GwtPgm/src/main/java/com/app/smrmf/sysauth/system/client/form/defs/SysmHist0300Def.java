...
=====================================================**/
public class SysmHist0300Def  extends TableDef implements SysmDaoConstants {

    private int row = 0;
    private SysmConstants lblSysmConst = SysmConstants.INSTANCE;
    
    public SysmHist0300Def(String chkDef){
...
//	        setCellModel(true);
	...
	private List<ColumnDef> getHist0300ColumnsList(){
        ...
        listColumnDefs.add(new ColumnDef("입력주소", SysIfHist0300BM.ATTR_INPTADDR, ColumnDef.TYPE_STRING , 90, true, true, true){
        	{
        ...
        listColumnDefs.add(new ColumnDef("수정주소", SysIfHist0300BM.ATTR_REVNADDR, ColumnDef.TYPE_STRING , 90, true, true, true){
        	{
