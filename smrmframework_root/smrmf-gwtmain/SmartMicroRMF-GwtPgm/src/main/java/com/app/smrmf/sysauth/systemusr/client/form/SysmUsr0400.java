...
import com.app.smrmf.sysauth.systemusr.client.form.defs.SysUsrSysm0400Def;
...
=====================================================**/
public class SysmUsr0400  extends MSFPanel { 
	 ...
	 /**######################################################
	  ...
	  private FormPanel plFrmSysmUsr0500;
	  private FormData formData; 
	  private String txtForm = "";
	  private XTemplate detailTp;	  
	  private SysmUsr0400ServiceAsync sysUsr0400service = SysmUsr0400Service.Util.getInstance();  
	  ...
	  private SysIfBass0400BM dept;
	  private SysUsrSysm0400Def bass0400Def = new SysUsrSysm0400Def("BASS0400");
	  private SysUsrSysm0400Def bass0360Def = new SysUsrSysm0400Def("BASS0360"); 
	  private SysUsrSysm0400Def bass0350Def = new SysUsrSysm0400Def("BASS0350");
	  ...
	  private SysIfBass0320DTO sysComBass0320Dto = new SysIfBass0320DTO();	//직종
	  private SysIfBass0350DTO sysComBass0350Dto = new SysIfBass0350DTO();	//직종세
	  ...
	  public ContentPanel getViewPanel() {
        if (panel == null) {        	
		    ...
		    vp.setSpacing(10);
		    createSysmUsr0500Form();  //화면 기본정보를 설정
...
//	         }); 
        ...
        return panel;
			  ...
			  public SysmUsr0400(String txtForm) {
					this.txtForm = txtForm;
			  }		  
			  
			  private void createSysmUsr0500Form() {
				  
				listStoreA041 = SysifComServiceUtils.getSingleTypOccuCdBass0320ComboData(sysComBass0320Dto);  
				lsDtilOccuInttnCd = SysifComServiceUtils.getSingleBass0350ComboData(sysComBass0350Dto);

				
				plFrmSysmUsr0500 = new FormPanel();
				plFrmSysmUsr0500.setHeadingText("PayGen Ver1.0 - 부서별직종세맵핑관리");
				plFrmSysmUsr0500.setIcon(Resources.APP_ICONS.text());
				plFrmSysmUsr0500.setBodyStyleName("pad-text");
				plFrmSysmUsr0500.setFrame(true); 
				plFrmSysmUsr0500.setPadding(2);
				/************************************************************************
				...
				plFrmSysmUsr0500.getHeader().setStyleAttribute("padding", "5px 0 2px 0");
				plFrmSysmUsr0500.getHeader().addTool(btnlogView); 
				/************************************************************************
...
//		     	   layoutContainer_15.add(dtilOccuClsNm, new FormData("100%"));
		        ...
		        plFrmSysmUsr0500.add(inner);

				vp.add(plFrmSysmUsr0500);
				plFrmSysmUsr0500.setSize("990px", "680px");
			  }	
    ...
    private SysmUsr0400 getThis(){
        return this;
    }
    
    private void bass0360Delete(SysIfBass0360DTO bass0360Dto) {
    	sysUsr0400service.bass0360Delete(bass0360Dto, new AsyncCallback<Long>() {
			@Override
    ...
    private void bass0360Insert(SysIfBass0360DTO bass0360Dto) {
    	sysUsr0400service.bass0360Insert(bass0360Dto, new AsyncCallback<Long>(){
			@Override 
			public void onFailure(Throwable caught) {
				MessageBox.alert(MSFMainApp.MSFCONSTANTS.ExceptionTitleService(), 
