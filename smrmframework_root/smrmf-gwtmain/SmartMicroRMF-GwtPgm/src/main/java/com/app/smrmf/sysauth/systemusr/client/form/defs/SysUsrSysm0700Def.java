...
public class SysUsrSysm0700Def extends TableDef implements SysmUsrDaoConstants {
    private int row = 0;
    
    private SysmConstants lblSysmConst = SysmConstants.INSTANCE;
    
    public SysUsrSysm0700Def(String chkDef){
    	 
          if("SYSM0700".equals(chkDef)){
        	  
        	  setTitle("개별 사용직종세정보");
              setDaoClass(CLASS_SYSMUSR0700TOSYSM0700_LIST); 
              setCustomListMethod(CLASS_SYSMUSR0700TOSYSM0700_LIST);
