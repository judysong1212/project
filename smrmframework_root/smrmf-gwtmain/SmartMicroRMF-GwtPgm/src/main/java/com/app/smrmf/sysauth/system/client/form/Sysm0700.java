...
import com.app.smrmf.sysauth.system.client.service.Sysm0700ServiceAsync;
...
=====================================================**/
public class Sysm0700  extends MSFPanel { 
  ...
  private Sysm0700ServiceAsync sysm0700Service = Sysm0700Service.Util.getInstance();  
...
//	         });
    ...
    return panel;
		  ...
		  public Sysm0700(String txtForm) {
