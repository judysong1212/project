...
import com.app.smrmf.sysauth.systemusr.client.service.SysmUsr0600Service;
...
@Service("SysmUsr0600Service")
public class SysmUsr0600ServiceImpl extends AbstractCustomServiceImpl implements MSFPkgDaoConstants,SysmUsrDaoConstants, SysmUsr0600Service {  
	
	private static final Logger logger = LoggerFactory.getLogger(SysmUsr0600ServiceImpl.class);
	private static final String calledClass = SysmUsr0600ServiceImpl.class.getName();
	...
	public PagingLoadResult<BaseModel> getSelectSysm0600ToBass0150List(ServiceParameters serviceParameters) throws MSFException {
        ...
        String method =  PKG_SYSM0600TOBASS0150_LIST;
...
//      Bass0400VO bass0400Vo = new Bass0400VO();
	...
	public PagingLoadResult<BaseModel> getSelectSysm0600TopToBass0360List(ServiceParameters serviceParameters) throws MSFException {
        ...
        PagingLoadResult<BaseModel> retval = null;
        String method =  PKG_SYSM0600TOPTOBASS0360_LIST;
        List<BaseModel>  bmResult = new ArrayList<BaseModel>();
	...
	public PagingLoadResult<BaseModel> getSelectSysm0600BtmToBass0360List(ServiceParameters serviceParameters) throws MSFException {
		 PagingLoadResult<BaseModel> retval = null;
	        String method =  PKG_SYSM0600BTMTOBASS0360_LIST;
	        List<BaseModel>  bmResult = new ArrayList<BaseModel>();
	        SysIfBass0360SrhVO bass0360SrhVo = new SysIfBass0360SrhVO();
	        MSFSysm0100BM sessionUser = MSFServerUtils.getLoggedUser(RemoteServiceUtil.getThreadLocalRequest());
