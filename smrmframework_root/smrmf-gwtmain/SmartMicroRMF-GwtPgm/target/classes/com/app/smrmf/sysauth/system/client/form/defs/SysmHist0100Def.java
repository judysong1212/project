...
=====================================================**/
public class SysmHist0100Def  extends TableDef implements SysmDaoConstants {

    private int row = 0;
    private SysmConstants lblSysmConst = SysmConstants.INSTANCE;

    
    public SysmHist0100Def(String chkDef){
...
//	        setCellModel(true);
	...
	private List<ColumnDef> getHist0100ColumnsList(){
        ...
        listColumnDefs.add(new ColumnDef("입력주소", SysIfHist0100BM.ATTR_INPTADDR, ColumnDef.TYPE_STRING , 90, true, true, true){
        	{
        ...
        listColumnDefs.add(new ColumnDef("수정주소", SysIfHist0100BM.ATTR_REVNADDR, ColumnDef.TYPE_STRING , 90, true, true, true){
        	{
