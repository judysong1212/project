...
import com.app.smrmf.sysauth.systemusr.client.form.defs.SysUsrHist0300Def;
import com.app.smrmf.sysauth.systemusr.client.service.SysmUsr3300Service;
import com.app.smrmf.sysauth.systemusr.client.service.SysmUsr3300ServiceAsync;
...
=====================================================**/
public class SysmUsr3300   extends MSFPanel {
...
//	private HiddenField<String> systemkey;	/** column SYSTEMKEY : systemkey */
	...
	// -------------- grid 선언 시작  ---------------
 	private SysUsrHist0300Def hist0300Def  = new SysUsrHist0300Def("");   //그리드 테이블 컬럼 define  
	...
	// -------------- 코드 호출 시작 --------------
	private SysmUsr3300ServiceAsync hist0300Service = SysmUsr3300Service.Util.getInstance();						
	// -------------- 코드 호출 종료 --------------
/**
 *++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ 
 * 	전역변수 선언부  종료
...
//	  		detailTp = XTemplate.create(getDetailTemplate());
	 ...
	 **/ 	 
		...
		public SysmUsr3300(String txtForm) {
...
//		cpGrid.setSize(940, 430);
		...
		hist0300Grid.addListener(Events.CellDoubleClick, new Listener<BaseEvent>() {
			public void handleEvent(BaseEvent be) {  
				SysmUsrP330001 histP030001Form = new SysmUsrP330001(ActionDatabase.READ, getThis());   
