...
public class SysMtrSysm0700Def extends TableDef implements SysmMtrDaoConstants {
    private int row = 0;
    
    private SysmMtrConstants lblSysmConst = SysmMtrConstants.INSTANCE;
    
    public SysMtrSysm0700Def(String chkDef){
    	  
        	 
             if("SYSM0700".equals(chkDef)){
           	  
           	  setTitle("");
                 setDaoClass(CLASS_SYSMMTR0700TOSYSM0700_LIST); 
                 setCustomListMethod(CLASS_SYSMMTR0700TOSYSM0700_LIST);
