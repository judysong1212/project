...
public class SysMtrSysm0300Def extends TableDef implements SysmMtrDaoConstants {
    private int row = 0;
    
    private SysmMtrConstants lblSysmConst = SysmMtrConstants.INSTANCE;
    
    public SysMtrSysm0300Def(){
    	
    	  setTitle(lblSysmConst.title_SysmMtr0300());
          setDaoClass(CLASS_SYSMMTR0300_SAVE); 
          setCustomListMethod(CLASS_SYSMMTR0300_LIST);
          setAutoFillGrid(true);
          showFilterToolbar = false ;
          
    	  setColumnsDefinition(getAllColumnsList());  
    }
    public SysMtrSysm0300Def(String chkDef){
    	  
      	 
        if("SYSMMTR0500".equals(chkDef)){
      	  
      	     setTitle("");
            setDaoClass(CLASS_SYSMMTR0500TOSYSM0300_LIST); 
            setCustomListMethod(CLASS_SYSMMTR0500TOSYSM0300_LIST);
            
      	  setColumnsDefinition(getAllColumnsList());
      	  setShowFilterToolbar(false);   
      	  setAutoFillGrid(true);
            
   	      	setColumnsDefinition(getSysmMtr0500ToSysm0300ColumnsList()); 
    	} 
...
//  });
    ...
    private List<ColumnDef> getSysmMtr0500ToSysm0300ColumnsList(){
        row = 0;
        List<ColumnDef> listColumnDefs = new ArrayList<ColumnDef>();
