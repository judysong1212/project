...
=====================================================**/
public class SysUsrHist0200Def  extends TableDef implements SysmDaoConstants {

    private int row = 0;
    private SysmConstants lblSysmConst = SysmConstants.INSTANCE;

    
    public SysUsrHist0200Def(String chkDef){
...
//	        setCellModel(true);
	...
	private List<ColumnDef> getHist0200ColumnsList(){
        ...
        listColumnDefs.add(new ColumnDef("입력주소", SysIfHist0200BM.ATTR_INPTADDR, ColumnDef.TYPE_STRING , 90, true, false, true){
        	{
        ...
        listColumnDefs.add(new ColumnDef("수정주소", SysIfHist0200BM.ATTR_REVNADDR, ColumnDef.TYPE_STRING , 90, true, false, true){
        	{
