...
@RemoteServiceRelativePath("SysmUsr3200Service.gwt")
public interface SysmUsr3200Service extends RemoteService {
	/**
	 * Utility class for simplifying access to the instance of async service.
	 */
	public static class Util {
		private static SysmUsr3200ServiceAsync instance;
		public static SysmUsr3200ServiceAsync getInstance(){
			if (instance == null) {
				instance = GWT.create(SysmUsr3200Service.class);
			}
			return instance;
		}
	}
