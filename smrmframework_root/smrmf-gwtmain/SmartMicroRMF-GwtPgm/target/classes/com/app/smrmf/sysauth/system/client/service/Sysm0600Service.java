...
@RemoteServiceRelativePath("Sysm0600Service.gwt")
public interface Sysm0600Service extends RemoteService {
	/**
	 * Utility class for simplifying access to the instance of async service.
	 */
	public static class Util {
		private static Sysm0600ServiceAsync instance;
		public static Sysm0600ServiceAsync getInstance(){
			if (instance == null) {
				instance = GWT.create(Sysm0600Service.class);
			}
			return instance;
		}
	}
