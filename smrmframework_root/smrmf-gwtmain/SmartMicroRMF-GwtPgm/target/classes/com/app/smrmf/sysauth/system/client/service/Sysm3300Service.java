...
@RemoteServiceRelativePath("Sysm3300Service.gwt")
public interface Sysm3300Service extends RemoteService {
	/**
	 * Utility class for simplifying access to the instance of async service.
	 */
	public static class Util {
		private static Sysm3300ServiceAsync instance;
		public static Sysm3300ServiceAsync getInstance(){
			if (instance == null) {
				instance = GWT.create(Sysm3300Service.class);
			}
			return instance;
		}
	}
