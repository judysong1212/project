...
public interface SysmMtr0600ServiceAsync {
	public void activitySysm0300User(SysIfSysm0300DTO profiloUser, ActionDatabase actionDatabase, AsyncCallback<Long> callback);
	 
	 public void activityOnSysmMtr0600User(SysIfSysm0500DTO profiloUser, ActionDatabase actionDatabase, AsyncCallback<Long> callback);
	 
	 
	 public void getListaSysmMtr0600User(MSFSysm0100BM utente, AsyncCallback<List<SysIfSysm0500DTO>> callback);
