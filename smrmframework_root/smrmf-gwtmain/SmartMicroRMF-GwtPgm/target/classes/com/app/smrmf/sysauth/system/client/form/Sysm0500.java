...
import com.app.smrmf.sysauth.system.client.service.Sysm0500ServiceAsync;
...
=====================================================**/
public class Sysm0500  extends MSFPanel { 
	 ...
	 /**######################################################
	    ...
	    private Sysm0500ServiceAsync sysm0500Service = Sysm0500Service.Util.getInstance();
    ...
    public ContentPanel getViewPanel() {
        ...
        return panel;
			  ...
			  public Sysm0500(String txtForm) {
...
//		            btmSysm0300Tbar.add(btnSysm0300Cancel);
    ...
    private void readSysm0500(MSFSysm0100BM usrSysm0100Bm){
        gridSysm0500.mask();
