...
public interface SysCoCalendarServiceAsync {
	public void getSysComComboYearList(SysCoCalendarDTO msfCoCalendarDto, AsyncCallback<List<BaseModel>> callback);
	
	public void getSysComComboMonthList(SysCoCalendarDTO msfCoCalendarDto, AsyncCallback<List<BaseModel>> callback);
