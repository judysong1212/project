...
import com.app.smrmf.sysauth.system.client.form.defs.SysmHist0100Def;
import com.app.smrmf.sysauth.system.client.service.Sysm3100Service;
import com.app.smrmf.sysauth.system.client.service.Sysm3100ServiceAsync;
...
=====================================================**/
public class Sysm3100   extends MSFPanel {
...
//	private HiddenField<String> systemkey;	/** column SYSTEMKEY : systemkey */
	...
	// -------------- grid 선언 시작  ---------------
 	private SysmHist0100Def hist0100Def  = new SysmHist0100Def("");   //그리드 테이블 컬럼 define  
	...
	// -------------- 코드 호출 시작 --------------
	private Sysm3100ServiceAsync hist0100Service = Sysm3100Service.Util.getInstance();										//공통코드 
	// -------------- 코드 호출 종료 --------------
/**
 *++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ 
 * 	전역변수 선언부  종료
...
//	  		detailTp = XTemplate.create(getDetailTemplate());
	 ...
	 **/ 	 
		...
		public Sysm3100(String txtForm) {
