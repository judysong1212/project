...
@RemoteServiceRelativePath("SysmMtr0700Service.gwt")
public interface SysmMtr0700Service extends RemoteService {
	/**
	 * Utility class for simplifying access to the instance of async service.
	 */
	public static class Util {
		private static SysmMtr0700ServiceAsync instance;
		public static SysmMtr0700ServiceAsync getInstance(){
			if (instance == null) {
				instance = GWT.create(SysmMtr0700Service.class);
			}
			return instance;
		}
	}
