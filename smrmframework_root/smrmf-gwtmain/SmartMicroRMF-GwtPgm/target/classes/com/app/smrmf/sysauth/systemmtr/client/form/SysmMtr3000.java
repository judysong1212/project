...
=====================================================**/
public class SysmMtr3000  extends MSFPanel { 
	 ...
	 /**######################################################
	  ...
	  private SysIfBass0150Def sysIfBass0150Def ;
	  ...
	  private RelationDef  relBass0360;
	  private RelationDef  relBass0350;
    ...
    public ContentPanel getViewPanel() {
        if (panel == null) {        	
		    ...
		    /**
	          ...
	          */
			   relBass0360 = new RelationDef(sysIfBass0150Def,false);
           ...
           /**
	          * Create the relations 
	          */
			   relBass0350 = new RelationDef(sysIfBass0150Def,false);
        ...
        return panel;
			  ...
			  public SysmMtr3000(String txtForm) {
			  ...
			  private void createSysm0600Form() {
				...
				plFrmSysm0600.setFrame(true); 
		            ...
		            // 두번째 컨테이너컬럼(사용직종정보)   
		            msfGdSysIfBass0360Top = new MSFGridPanel(sysIfBass0360Top, false, false, false, false,false); 
