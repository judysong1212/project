 ...
 */
@Controller 
public class Yeta3300SunCheonProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta3300SunCheonProcContainer.class);
    ...
    public Yeta3300SunCheonProcContainer() {
