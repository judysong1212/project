...
public class DlgnSunCheonProcessContainer {
	

	private static final Logger logger = LoggerFactory.getLogger(DlgnSunCheonProcessContainer.class);
	   
    @Resource(name = "ManageCommuteService")
    protected ManageCommuteService manageCommuteService;

    public DlgnSunCheonProcessContainer() {
