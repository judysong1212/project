 ...
 */
@Controller 
public class PayrSunCheonSubProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(PayrSunCheonSubProcContainer.class);
