 ...
 */
@Controller 
public class RemtSunCheonProcessContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(RemtSunCheonProcessContainer.class);
    private static final String calledClass = RemtSunCheonProcessContainer.class.getName();
