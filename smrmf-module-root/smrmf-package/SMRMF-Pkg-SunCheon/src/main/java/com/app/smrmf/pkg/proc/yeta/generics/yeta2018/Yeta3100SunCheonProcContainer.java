 ...
 */
@Controller 
public class Yeta3100SunCheonProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta3100SunCheonProcContainer.class);
...
//
    ...
    public Yeta3100SunCheonProcContainer() {
