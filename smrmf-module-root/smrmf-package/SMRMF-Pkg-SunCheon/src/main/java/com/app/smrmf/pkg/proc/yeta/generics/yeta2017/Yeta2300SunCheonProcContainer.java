 ...
 */
@Controller 
public class Yeta2300SunCheonProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta2300SunCheonProcContainer.class);
    ...
    public Yeta2300SunCheonProcContainer() {
