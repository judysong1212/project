 ...
 */
@Controller 
public class Yeta2100SunCheonProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta2100SunCheonProcContainer.class);
...
//
    ...
    public Yeta2100SunCheonProcContainer() {
