...
//    private Payr0305DAO payr0305DAO;
    ...
    //private EgovIdGnrService egovIdGnrService;
	  ...
	  * 2. 처리내용 : 
	  * </pre>
	  * @Method Name : selectSunCheonPayrInfoList
	  * @date : 2016. 5. 26.
	  ...
	  *	-----------------------------------------------------------------------
	  * 
	  * @see com.app.smrmf.payr.pay.calculation.service.PayCalculationService#selectSunCheonPayrInfoList(com.app.smrmf.infc.payroll.vo.InfcPkgPayr0250VO)
	  * @param vo
	  * @return
	  * @throws Exception
	  */
	 public List<PkgPayrCommCalcVO> selectSunCheonPayrInfoList(InfcPkgPayr0250VO vo) throws Exception {
		 
		 return payCalculationDAO.selectSunCheonPayrInfoList(vo);
