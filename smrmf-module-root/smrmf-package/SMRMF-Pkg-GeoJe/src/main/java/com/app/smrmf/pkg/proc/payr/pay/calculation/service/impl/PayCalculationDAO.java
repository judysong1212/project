...
public class PayCalculationDAO extends EgovAbstractDAO {
     ...
     * @throws Exception
     */
    public List<PkgPayrCommCalcVO> selectGimHaePayrInfoList(InfcPkgPayr0250VO searchVO) throws Exception {
        return (List<PkgPayrCommCalcVO>)list("payCalculationDAO.selectGimHaePayrInfoList_D", searchVO);
    }
     ...
     * @throws Exception
     */
    public List<PkgPayrCommCalcVO> selectGeoJePayrInfoList(InfcPkgPayr0250VO searchVO) throws Exception {
        return (List<PkgPayrCommCalcVO>)list("payCalculationDAO.selectGeoJePayrInfoList_D", searchVO);
    }
       ...
       */
	   public InfcPkgPayr0302VO selectGHPayr0302C9020100(InfcPkgPayr0302VO vo) throws Exception {
	    ...
	    public InfcPkgPayr0410VO selectPayr0410ToPayrCalcList(InfcPkgPayr0410VO vo) throws Exception {
	        return (InfcPkgPayr0410VO) selectByPk("payCalculationDAO.selectPayr0410ToPayrCalcList_S", vo);
	    }
