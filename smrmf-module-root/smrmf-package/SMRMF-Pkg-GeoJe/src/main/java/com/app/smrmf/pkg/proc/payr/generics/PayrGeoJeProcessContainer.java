...
import com.app.smrmf.constc.geoje.ConstGeoJe;
 ...
 */
@Controller 
public class PayrGeoJeProcessContainer  extends AbstractCustomServiceImpl {
		 

	private static final Logger logger = LoggerFactory.getLogger(PayrGeoJeProcessContainer.class);
   ...
   protected PayrCommCalcService payrCommCalcService;
	  ...
	  //스케줄링에 따른 급여계산 로직
	  	...
	  	public PagingLoadResult<ShowMessageBM>  execPayr4100ToPayCalcSeft(HttpServletRequest request,InfcPkgPayr0250VO dtoPayr0250,InfcPkgPsnl0100VO voPsnl0100)  throws Exception  {
	  	     return  funcPayr4100ToPayrCalc(request,dtoPayr0250,voPsnl0100,null );
	  	}
		    ...
		    */
		    private List<ShowMessageBM>  procEmymtDivCd01(HttpServletRequest request,InfcPkgPayr0250VO dtoPayr0250,InfcPkgPsnl0100VO voPsnl0100,boolean boolInsert)  throws Exception {
		      ...
		      //     boolean boolInsert = false;
		           ...
		           BigDecimal SchlExpnC9060100 = BigDecimal.ZERO;  //노조회비처리를 위한 탬프추가 
		           ...
		           BigDecimal  tpDducTotAmnt = BigDecimal.ZERO;
		            BigDecimal  ucstNoSumD9500400 = BigDecimal.ZERO;  //노조회비 공제 대상 수당 합계           // 
		            //건강보험 
		                          ...
		                          //사람데이타 처리  
		                           ...
		                           if ("Y".equals(payCalculationVo.getPayRcptYn())) {
		                                   ...
		                                   ****************************************************************/
		                                   ...
		                                   SchlExpnC9060100 = BigDecimal.ZERO;  //노조회비처리를 위한 탬프추가 
...
//		                                                               }  
		                                                               ...
		                                                               if (ExtermsProps.getProps("PAY_CALC_TX_B005_02").equals(payr0410.getTxtnDivCd())) {
		                                                                ...
		                                                                tpExtpyTotAmnt = tpExtpyTotAmnt.add(tpSchlExpnAdmclExtpySum); 
		                                                                  ...
		                                                                  if (tpSchlExpnAdmclExtpySum.compareTo(BigDecimal.ZERO) > 0) {
		                                                                	  if (BigDecimal.ZERO.compareTo(payr0302Vo.getPymtDducSum()) < 0)  {
		                                                                		  SchlExpnC9060100 = SchlExpnC9060100.add(tpSchlExpnAdmclExtpySum);  //학비보조수당 처리추가 
		                                                                		  payrCommCalcService.insertPayr0302(payr0302Vo);  
		                                                                	  }	  
		                                                                   } 
		            ...
		            //                                                       payr0302Vo.setRevnAddr(payr0302Vo.getRevnAddr());    /** column 수정주소 : revnAddr */   
		                                                        	   ...
		                                                        	   /***********************************************************************/
		                                                        	   /* 도로보수원인경우    00400010A0060000' = AA.DTIL_OCCU_INTTN_CD   */
		                                                        	   /************************************************************************/
		                                                        	   //반장수당        
		                                                               //직책별 수당  
		                                                                 if ("00400010A0060000".equals(payCalculationVo.getDtilOccuInttnCd()) && "A0150003".equals(payCalculationVo.getOdtyCd())) {
			                                                                          ...
			                                                                          if (new BigDecimal(payCalculationVo.getDilnlazTotTmRstDutyTm()).compareTo(BigDecimal.ZERO) > 0) {
			                                                                        	...
			                                                                        	/*  00100050A0060000
			                                                                        	  ...
			                                                                        	  */
			                                                                        	  ...
			                                                                        	  if (("00100050A0060000".equals(payCalculationVo.getDtilOccuInttnCd()))
			                                                                        			  || ("00100051A0060000".equals(payCalculationVo.getDtilOccuInttnCd()))
			                                                                        			  || ("00100052A0060000".equals(payCalculationVo.getDtilOccuInttnCd()))
			                                                                        			  || ("00100053A0060000".equals(payCalculationVo.getDtilOccuInttnCd()))) {    
			                                                                        		//시간외근무  -USALY_AMNT_HRWG_QNTY 계산된 시급으로 정리한다. 통상시급 
			                                                                       ...
			                                                                       // 야간수당       -- 시간산정C9410300 MNTH_USALY_AMNT_WAG
			                                                                        ...
			                                                                        // 휴일수당        -- 일수 C9410200
			  	                                                                        	   ...
			  	                                                                        	   if (("00100050A0060000".equals(payCalculationVo.getDtilOccuInttnCd()))
			  	                                                                        		...
			  	                                                                        		// 휴일수당        -- 일수  ExtermsProps.getProps("PAY_EMYMT_PYMT_21") = "C9410200";  
							      	                                                               if (ExtermsProps.getProps("PAY_EMYMT_PYMT_21").equals(payr0410.getPayrImcd()) && (ExtermsProps.getProps("PAY_EMYMT_DYMNTH_01").equals(payr0410.getDayMnthAmntDivCd())) 
						                                                                                   ...
						                                                                                   ucstSum =  (payr0410.getBefUcstSum().compareTo(BigDecimal.ZERO) > 0 ? payr0410.getBefUcstSum() : (payr0410.getUcstSum().compareTo(BigDecimal.ZERO) > 0 ? payr0410.getUcstSum() : payr0410.getPymtDducSum())).multiply(new BigDecimal("8"));
						                                                                                   if (payr0250Vo.getJobYrMnth().substring(4,6).equals("12")) { 
						                                                                                	  ucstSum =  (payr0410.getUcstSum().compareTo(BigDecimal.ZERO) > 0 ? payr0410.getUcstSum() : payr0410.getPymtDducSum()).multiply(new BigDecimal("8"));
						                                                                                   } 
							      	                                                            	   ...
							      	                                                            	   ucstSum = (ucstSum.multiply(new BigDecimal("8"))).setScale(-5,BigDecimal.ROUND_DOWN); 
			                                                                          ...
			                                                                          // 체력단련비   -- 일수 산정 C9040100
			                                                                    	   		BigDecimal ucstSum =  BigDecimal.ZERO;
			                                                                    	          if ("00600010A0060000".equals(payCalculationVo.getDtilOccuInttnCd())) {    
		                                                                            		//환경미화원 
			                                                                          ...
			                                                                          if (new BigDecimal(payCalculationVo.getDilnlazLvsgNumDys()).compareTo(BigDecimal.ZERO) > 0) {
			                                                                              ...
			                                                                              ucstNoSumD9500400 = ucstNoSumD9500400.add(totTmSum);
			                                                                              payr0302Vo.setPymtDducSum(totTmSum);   /** column 지급공제금액 : pymtDducSum */
			                                                                              payr0302Vo.setPymtDducTxtnAmnt(totTmSum.subtract(payr0410.getFreeDtySum()) );    /** column 지급공제과세금액 : pymtDducTxtnAmnt */ 
			                                                                        	...
			                                                                        	/*  00100050A0060000
			                                                                        	  00100051A0060000
			                                                                        	  00100052A0060000
			                                                                        	  00100053A0060000 00300090A0060000
			                                                                        	  */
			                                                                        	   ...
			                                                                        	   if (("00100050A0060000".equals(payCalculationVo.getDtilOccuInttnCd()))
			                                                                        			  ...
			                                                                        			  || ("00100052A0060000".equals(payCalculationVo.getDtilOccuInttnCd()))
			                                                                        			  || ("00100053A0060000".equals(payCalculationVo.getDtilOccuInttnCd()))
			                                                                        			  || ("00300090A0060000".equals(payCalculationVo.getDtilOccuInttnCd()))) {    
				                                                                              ...
				                                                                              totTmSum = ucstSum.setScale(-1, BigDecimal.ROUND_DOWN);  
			                                                                                    ...
			                                                                                    ucstSum =   basePymtAmnt;//payr0410.getBefUcstSum().compareTo(BigDecimal.ZERO) > 0 ? payr0410.getBefUcstSum() : (payr0410.getUcstSum().compareTo(BigDecimal.ZERO) > 0 ? payr0410.getUcstSum() : payr0410.getPymtDducSum());
		      ...
		      //                                          payr0302Vo.setRevnAddr(payr0302Vo.getRevnAddr());    /** column 수정주소 : revnAddr */   
		                                                  ...
		                                                  //출장여비 및 학비보조수당 미리 입력된 경우 처리를 위한 부분 
		                                                  if (ExtermsProps.getProps("PAY_EMYMT_PYMT_17").equals(payr0520Vo.getPayItemCd())) {
		                                                	  
		                                                	  ucstNoSumD9500400 = ucstNoSumD9500400.add(payr0520Vo.getPymtDducSum());
		                                                	  
		                                                  } else if (ExtermsProps.getProps("PYMT_ITEM_02").equals(payr0520Vo.getPayItemCd())) {
		                                                	  
		                                                	  ucstNoSumD9500400 = ucstNoSumD9500400.add(payr0520Vo.getPymtDducSum());
		                                                	  
		                                                  } else if (ExtermsProps.getProps("PAY_EMYMT_PYMT_24").equals(payr0520Vo.getPayItemCd())) {
...
//			                                                               }   
			            ...
			            //                                                   payr0302Vo.setRevnAddr(payr0302Vo.getRevnAddr());    /** column 수정주소 : revnAddr */   
			                                                               ...
			                                                               basePymtAmnt = BigDecimal.ZERO;
		                                                                       ...
		                                                                       //20170530-수정 
			                                                               //노조회비 계산시 기타수당 (출장비, 자녀학비수당 제외 추가 )
			                                                               basePymtAmnt = (tpPymtTotAmnt.subtract(SchlExpnC9060100)).subtract(ucstNoSumD9500400);
...
//		                                                                           tpFreeDtyTotAmnt = tpFreeDtyTotAmnt.add(payr0410.getFreeDtySum());
		                        ...
		                        //                                                       payr0302Vo.setRevnAddr(payr0302Vo.getRevnAddr());    /** column 수정주소 : revnAddr */   
		                                                                    	  ...
		                                                                    	  //반장수당        
		                                                                          //직책별 수당  
		                                                                            if ("00200010A0060000".equals(payCalculationVo.getDtilOccuInttnCd()) && "A0150003".equals(payCalculationVo.getOdtyCd())) {
		                        ...
		                        //                                                   payr0302Vo.setRevnAddr(payr0302Vo.getRevnAddr());    /** column 수정주소 : revnAddr */   
			           	          ...
			           	          //                                                   payr0302Vo.setRevnAddr(payr0302Vo.getRevnAddr());    /** column 수정주소 : revnAddr */   
			           	                                                            ...
			           	                                                            // InfcPkgPayr0302VO tpPayr0302vo = new InfcPkgPayr0302VO();
			           	                                                             ...
			           	                                                             //if ("00100028A0060000".equals(payCalculationVo.getDtilOccuInttnCd()) 
			           	                                                            	//	 ) { 
			           	                                                            ...
			           	                                                            // }
			           	                                                             ...
			           	                                                             tpPymtTotAmnt = tpPymtTotAmnt.add(edPymtAmnt);
			           	                                                             tpExtpyTotAmnt = tpExtpyTotAmnt.add(edPymtAmnt);
			           	                                                             tpFreeDtyTotAmnt = tpFreeDtyTotAmnt.add(payr0410.getFreeDtySum()); 
