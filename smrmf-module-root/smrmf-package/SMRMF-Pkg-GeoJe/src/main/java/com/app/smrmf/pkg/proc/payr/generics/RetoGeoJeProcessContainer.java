 ...
 */
@Controller 
public class RetoGeoJeProcessContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(RetoGeoJeProcessContainer.class);
