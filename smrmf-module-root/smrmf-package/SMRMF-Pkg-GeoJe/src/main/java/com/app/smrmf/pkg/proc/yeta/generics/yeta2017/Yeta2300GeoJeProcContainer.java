 ...
 */
@Controller 
public class Yeta2300GeoJeProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta2300GeoJeProcContainer.class);
    ...
    public Yeta2300GeoJeProcContainer() {
