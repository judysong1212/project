...
//    private Payr0305DAO payr0305DAO;
	...
	//급여 - 인사정보(무기계약직)
	  ...
	  * 2. 처리내용 : 
	  * </pre>
	  * @Method Name : selectGimHaePayrInfoList
	  * @date : 2016. 5. 26.
	  ...
	  *	변경일				작성자						변경내용  
	  *	----------- ------------------- ---------------------------------------
	  *	2016. 5. 26.		Administrator				최초 작성 
	  *	-----------------------------------------------------------------------
	  * 
	  * @see com.app.smrmf.payr.pay.calculation.service.PayCalculationService#selectGimHaePayrInfoList(com.app.smrmf.infc.payroll.vo.InfcPkgPayr0250VO)
	  * @param vo
	  * @return
	  * @throws Exception
	  */
	 public List<PkgPayrCommCalcVO> selectGimHaePayrInfoList(InfcPkgPayr0250VO vo) throws Exception {
		 
		 return payCalculationDAO.selectGimHaePayrInfoList(vo);
	  ...
	  * 2. 처리내용 : 
	  * </pre>
	  * @Method Name : selectGeoJePayrInfoList
	  * @date : 2016. 5. 26.
	  * @author : Administrator
	  * @history : 
	  *	-----------------------------------------------------------------------
	  ...
	  *	-----------------------------------------------------------------------
	  * 
	  * @see com.app.smrmf.payr.pay.calculation.service.PayCalculationService#selectGeoJePayrInfoList(com.app.smrmf.infc.payroll.vo.InfcPkgPayr0250VO)
	  * @param vo
	  * @return
	  * @throws Exception
	  */
    public List<PkgPayrCommCalcVO> selectGeoJePayrInfoList(InfcPkgPayr0250VO vo) throws Exception {
		 
		 return payCalculationDAO.selectGeoJePayrInfoList(vo);
	...
	InfcPkgPayr0410VO resultVO = payCalculationDAO.selectPayr0410ToPayrCalcList(vo);
	 // if (resultVO == null)
	 //     throw processException("info.nodata.msg");
	  return resultVO;
    } 
