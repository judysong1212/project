 ...
 */
@Controller 
public class RemtGeoJeProcessContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(RemtGeoJeProcessContainer.class);
    private static final String calledClass = RemtGeoJeProcessContainer.class.getName();
