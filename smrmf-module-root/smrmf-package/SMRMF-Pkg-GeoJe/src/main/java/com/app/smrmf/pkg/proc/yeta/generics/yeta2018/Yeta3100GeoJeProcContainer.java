 ...
 */
@Controller 
public class Yeta3100GeoJeProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta3100GeoJeProcContainer.class);
...
//
    ...
    public Yeta3100GeoJeProcContainer() {
