 ...
 */
@Controller 
public class Yeta2100GeoJeProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta2100GeoJeProcContainer.class);
...
//
    ...
    public Yeta2100GeoJeProcContainer() {
