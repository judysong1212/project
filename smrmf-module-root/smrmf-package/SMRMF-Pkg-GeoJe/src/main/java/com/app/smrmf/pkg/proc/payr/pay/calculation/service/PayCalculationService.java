...
public interface PayCalculationService {
	 ...
	 * 2. 처리내용 : 
	 * </pre>
	 * @Method Name : selectPsnlPayrInfoList
	 * @date : 2016. 5. 12.
	 ...
	 * @throws Exception
	 */
	 List<PkgPayrCommCalcVO> selectPsnlPayrInfoList(InfcPkgPayr0250VO searchVO) throws Exception;
	  ...
	  * @throws Exception
	  */
	 List<PkgPayrCommCalcVO> selectGimHaePayrInfoList(InfcPkgPayr0250VO searchVO) throws Exception;
	  ...
	  * @throws Exception
	  */
	 List<PkgPayrCommCalcVO> selectGeoJePayrInfoList(InfcPkgPayr0250VO searchVO) throws Exception; 
