 ...
 */
@Controller 
public class Yeta3300GeoJeProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta3300GeoJeProcContainer.class);
    ...
    public Yeta3300GeoJeProcContainer() {
