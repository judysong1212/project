...
public class DlgnGeoJeProcessContainer {
	

	private static final Logger logger = LoggerFactory.getLogger(DlgnGeoJeProcessContainer.class);
	   
    @Resource(name = "ManageCommuteService")
    protected ManageCommuteService manageCommuteService;

    public DlgnGeoJeProcessContainer() {
