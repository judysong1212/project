 ...
 */
@Controller 
public class RemtYangJuProcessContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(RemtYangJuProcessContainer.class);
    private static final String calledClass = RemtYangJuProcessContainer.class.getName();
