 ...
 */
@Controller 
public class Yeta3100YangJuProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta3100YangJuProcContainer.class);
...
//
    ...
    public Yeta3100YangJuProcContainer() {
