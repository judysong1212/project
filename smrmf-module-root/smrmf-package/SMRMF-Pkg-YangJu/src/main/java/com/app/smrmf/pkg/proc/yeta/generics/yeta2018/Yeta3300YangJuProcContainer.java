 ...
 */
@Controller 
public class Yeta3300YangJuProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta3300YangJuProcContainer.class);
    ...
    public Yeta3300YangJuProcContainer() {
