...
public class PayCalculationDAO extends EgovAbstractDAO {
     ...
     * @throws Exception
     */
    public List<PkgPayrCommCalcVO> selectYangJuPayrInfoList(InfcPkgPayr0250VO searchVO) throws Exception {
        return (List<PkgPayrCommCalcVO>)list("payCalculationDAO.selectYangJuPayrInfoList_D", searchVO);
    }
