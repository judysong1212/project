 ...
 */
@Controller 
public class PayrYangJuSubProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(PayrYangJuSubProcContainer.class);
