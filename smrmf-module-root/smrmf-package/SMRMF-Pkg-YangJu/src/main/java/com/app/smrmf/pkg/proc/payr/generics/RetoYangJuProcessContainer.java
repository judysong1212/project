 ...
 */
@Controller 
public class RetoYangJuProcessContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(RetoYangJuProcessContainer.class);
		...
		public PagingLoadResult<ShowMessageBM> execPayr4210ToPayCalcSeft( HttpServletRequest request,InfcPkgPayr0360VO infcPayr0360Vo,ArrayList<InfcPkgPsnl0100VO> dtoListPsnl0100)  throws Exception  {
		   	   ...
		   	   // Long result = new Long(0); 
		   		...
		   		try {
			   		...
			   		RetoYangJuProcessContainer ppc = new RetoYangJuProcessContainer();
