 ...
 */
@Controller 
public class Yeta2300YangJuProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta2300YangJuProcContainer.class);
    ...
    public Yeta2300YangJuProcContainer() {
