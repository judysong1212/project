 ...
 */
@Controller 
public class Yeta2100YangJuProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta2100YangJuProcContainer.class);
...
//
    ...
    public Yeta2100YangJuProcContainer() {
