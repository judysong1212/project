 ...
 */
@Controller 
public class Yeta2300UlJuProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta2300UlJuProcContainer.class);
    ...
    public Yeta2300UlJuProcContainer() {
