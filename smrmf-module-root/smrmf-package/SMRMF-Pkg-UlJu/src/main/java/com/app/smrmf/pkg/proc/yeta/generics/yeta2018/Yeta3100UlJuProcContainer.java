 ...
 */
@Controller 
public class Yeta3100UlJuProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta3100UlJuProcContainer.class);
...
//
    ...
    public Yeta3100UlJuProcContainer() {
