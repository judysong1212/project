...
public class DlgnUlJuProcessContainer {
	

	private static final Logger logger = LoggerFactory.getLogger(DlgnUlJuProcessContainer.class);
	   
    @Resource(name = "ManageCommuteService")
    protected ManageCommuteService manageCommuteService;

    public DlgnUlJuProcessContainer() {
