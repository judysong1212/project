 ...
 */
@Controller 
public class PayrUlJuSubProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(PayrUlJuSubProcContainer.class);
   ...
   protected PayrCommCalcService payrCommCalcService;
    ...
    protected PyspLogSvcYrNumService pyspLogSvcYrNumService; 
        ...
        //                    }
                            ...
                            payCalculationVo.setAddIncmTxApptnRto(new BigDecimal(String.valueOf(tempMap.get("addIncmTxApptnRto")))); /** set 추가소득세적용비율 : addIncmTxApptnRto */ 
