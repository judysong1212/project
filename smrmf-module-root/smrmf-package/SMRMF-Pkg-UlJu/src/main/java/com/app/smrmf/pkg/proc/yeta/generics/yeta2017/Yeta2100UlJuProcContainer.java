 ...
 */
@Controller 
public class Yeta2100UlJuProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta2100UlJuProcContainer.class);
...
//
    ...
    public Yeta2100UlJuProcContainer() {
