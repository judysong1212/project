 ...
 */
@Controller 
public class Yeta3300UlJuProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta3300UlJuProcContainer.class);
    ...
    public Yeta3300UlJuProcContainer() {
