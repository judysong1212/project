 ...
 */
@Controller 
public class RetoUlJuProcessContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(RetoUlJuProcessContainer.class);
