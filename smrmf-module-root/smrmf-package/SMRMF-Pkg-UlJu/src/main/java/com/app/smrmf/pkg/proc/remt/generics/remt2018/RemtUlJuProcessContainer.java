 ...
 */
@Controller 
public class RemtUlJuProcessContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(RemtUlJuProcessContainer.class);
    private static final String calledClass = RemtUlJuProcessContainer.class.getName();
