 ...
 */
@Controller 
public class RemtJeJuProcessContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(RemtJeJuProcessContainer.class);
    private static final String calledClass = RemtJeJuProcessContainer.class.getName();
