...
//    private Payr0305DAO payr0305DAO;
    ...
    //private EgovIdGnrService egovIdGnrService;
	  ...
	  * 2. 처리내용 : 
	  * </pre>
	  * @Method Name : selectJeJuPayrInfoList
	  * @date : 2016. 5. 26.
	  ...
	  *	-----------------------------------------------------------------------
	  * 
	  * @see com.app.smrmf.payr.pay.calculation.service.PayCalculationService#selectJeJuPayrInfoList(com.app.smrmf.infc.payroll.vo.InfcPkgPayr0250VO)
	  * @param vo
	  * @return
	  * @throws Exception
	  */
	 public List<PkgPayrCommCalcVO> selectJeJuPayrInfoList(InfcPkgPayr0250VO vo) throws Exception {
		 
		 return payCalculationDAO.selectJeJuPayrInfoList(vo);
