 ...
 */
@Controller 
public class Yeta2100JeJuProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta2100JeJuProcContainer.class);
...
//
    ...
    public Yeta2100JeJuProcContainer() {
