 ...
 */
@Controller 
public class PayrJeJuSubProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(PayrJeJuSubProcContainer.class);
