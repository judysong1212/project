 ...
 */
@Controller 
public class Yeta3100JeJuProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta3100JeJuProcContainer.class);
...
//
    ...
    public Yeta3100JeJuProcContainer() {
