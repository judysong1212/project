...
public class DlgnJeJuProcessContainer {
	

	private static final Logger logger = LoggerFactory.getLogger(DlgnJeJuProcessContainer.class);
	   
    @Resource(name = "ManageCommuteService")
    protected ManageCommuteService manageCommuteService;

    public DlgnJeJuProcessContainer() {
