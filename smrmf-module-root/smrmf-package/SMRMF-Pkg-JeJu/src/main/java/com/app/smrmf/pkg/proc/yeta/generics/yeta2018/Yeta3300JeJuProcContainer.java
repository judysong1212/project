 ...
 */
@Controller 
public class Yeta3300JeJuProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta3300JeJuProcContainer.class);
    ...
    public Yeta3300JeJuProcContainer() {
