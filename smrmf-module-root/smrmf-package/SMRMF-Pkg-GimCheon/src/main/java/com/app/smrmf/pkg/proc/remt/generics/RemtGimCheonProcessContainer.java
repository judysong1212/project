package com.app.smrmf.pkg.proc.remt.generics;
 ...
 */
@Controller 
public class RemtGimCheonProcessContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(RemtGimCheonProcessContainer.class);
    private static final String calledClass = RemtGimCheonProcessContainer.class.getName();
