...
//    private Payr0305DAO payr0305DAO;
    ...
    //private EgovIdGnrService egovIdGnrService;
	  ...
	  * 2. 처리내용 : 
	  * </pre>
	  * @Method Name : selectGimCheonPayrInfoList
	  * @date : 2016. 5. 26.
	  ...
	  *	-----------------------------------------------------------------------
	  * 
	  * @see com.app.smrmf.payr.pay.calculation.service.PayCalculationService#selectGimCheonPayrInfoList(com.app.smrmf.infc.payroll.vo.InfcPkgPayr0250VO)
	  * @param vo
	  * @return
	  * @throws Exception
	  */
	 public List<PkgPayrCommCalcVO> selectGimCheonPayrInfoList(InfcPkgPayr0250VO vo) throws Exception {
		 
		 return payCalculationDAO.selectGimCheonPayrInfoList(vo);
