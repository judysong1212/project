 ...
 */
@Controller 
public class PayrGimCheonSubProcContainer  extends AbstractCustomServiceImpl {
	

private static final Logger logger = LoggerFactory.getLogger(PayrGimCheonSubProcContainer.class);
