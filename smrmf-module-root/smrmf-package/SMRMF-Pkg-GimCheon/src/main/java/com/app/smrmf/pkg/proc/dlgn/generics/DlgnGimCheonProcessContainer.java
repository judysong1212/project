...
public class DlgnGimCheonProcessContainer {
	

	private static final Logger logger = LoggerFactory.getLogger(DlgnGimCheonProcessContainer.class);
	   
    @Resource(name = "ManageCommuteService")
    protected ManageCommuteService manageCommuteService;

    public DlgnGimCheonProcessContainer() {
...
//            } 
     ...
     * 
     * <pre>
     * 1. 개요 : 시간외 근무 업데이트 쿼리 적용 집계처리를 위한 부분  시간외 분단위 처리 
     * 2. 처리내용 : 
     * </pre>
