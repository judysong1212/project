...
public class PayCalculationDAO extends EgovAbstractDAO {
     ...
     * @throws Exception
     */
    public List<PkgPayrCommCalcVO> selectGimCheonPayrInfoList(InfcPkgPayr0250VO searchVO) throws Exception {
        return (List<PkgPayrCommCalcVO>)list("payCalculationDAO.selectGimCheonPayrInfoList_D", searchVO);
    }
