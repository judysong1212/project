...
import com.app.smrmf.constc.gimcheon.ConstGimCheon;
           ...
           /*########################################################################################*/     
             ...
             while ( iterpayr0417Base.hasNext() ) { 
          	    ...
          	    if (ExtermsProps.getProps("PAY_EMYMT_PYMT_19").equals(payr0417Be.getPayrImcd())) {
               	 ...
               	 //기본급 셋팅 체크통해서 값처리 하기 
               	 if (ExtermsProps.getProps("PAYR_UNIT_B0320020").equals(MSFSharedUtils.defaultNulls(payCalculationVo.getDtilOcclsApptnUcstCd(),ExtermsProps.getProps("PAYR_UNIT_B0320010")))) {
               		 //일당내역 적용 
               		// pkgPayrAmntVo.setBasePymtAmnt(payr0417Be.getPymtDducSum().multiply((new BigDecimal(payCalculationVo.getDilnlazTotDutyNumDys()))).setScale(-1,BigDecimal.ROUND_DOWN));
               		 pkgPayrAmntVo.setBasePymtAmnt(payr0417Be.getPymtDducSum());
...
//                                                 payr0302Vo.setRevnAddr(payr0302Vo.getRevnAddr());    /** column 수정주소 : revnAddr */   
                             ...
                             if (ExtermsProps.getProps("PAYR_UNIT_B0320020").equals(MSFSharedUtils.defaultNulls(payCalculationVo.getDtilOcclsApptnUcstCd(),ExtermsProps.getProps("PAYR_UNIT_B0320010")))) {
                             	   ...
                             	   if ( (ExtermsProps.getProps("PAY_EMYMT_DYMNTH_01").equals(payr0417.getDayMnthAmntDivCd())) 
                                            && (new BigDecimal(payCalculationVo.getDilnlazTotDutyNumDys()).compareTo(BigDecimal.ZERO) > 0)) {
                                     //기본급일액 * 처리 
                             		  //일액 
                                  	   dayPayAmt = payr0417.getPymtDducSum();  
                                  	   dayPaySum = dayPayAmt.multiply((new BigDecimal(payCalculationVo.getDilnlazTotDutyNumDys()))).setScale(-1,BigDecimal.ROUND_DOWN) ;
                             	   ...
                             	   } else if ( (ExtermsProps.getProps("PAY_EMYMT_DYMNTH_04").equals(payr0417.getDayMnthAmntDivCd())) 
                                            && (new BigDecimal(payCalculationVo.getDilnlazTotDutyNumDys()).compareTo(BigDecimal.ZERO) > 0)) {
                                        //본봉 -시급처리 추가  
                             		       dayPayAmt = payr0417.getPymtDducSum();  
                                  	   dayPaySum = dayPayAmt.multiply((new BigDecimal(payCalculationVo.getDilnlazTotDutyNumDys()))).setScale(-1,BigDecimal.ROUND_DOWN) ;
                             ...
                             } else if (ExtermsProps.getProps("PAYR_UNIT_B0320040").equals(MSFSharedUtils.defaultNulls(payCalculationVo.getDtilOcclsApptnUcstCd(),ExtermsProps.getProps("PAYR_UNIT_B0320010")))) {	   
...
//                                                   payr0302Vo.setRevnAddr(payr0302Vo.getRevnAddr());    /** column 수정주소 : revnAddr */  
                           ...
                           //직책별 수당  
                              ...
                              if (  "A0150001".equals(payCalculationVo.getOdtyCd())) { 
		...
		//                                                       payr0302Vo.setRevnAddr(payr0302Vo.getRevnAddr());    /** column 수정주소 : revnAddr */    
                         ...
                         } else if (ExtermsProps.getProps("PYMT_ITEM_10").equals(payr0417.getPayrImcd())) {
                        	   /***********************************************************************/
                        	   /*    */
                        	   /************************************************************************/
                        	   //반장수당 
                                 if (  "A0150003".equals(payCalculationVo.getOdtyCd())) {
...
//                                     payr0302Vo.setRevnAddr(payr0302Vo.getRevnAddr());    /** column 수정주소 : revnAddr */   
                                     ...
                                     pkgPayrAmntVo.setTpPymtTotAmnt(pkgPayrAmntVo.getTpPymtTotAmnt().add((payr0417.getUcstSum().compareTo(BigDecimal.ZERO) > 0 ? payr0417.getUcstSum() : payr0417.getPymtDducSum()).setScale(-1,BigDecimal.ROUND_DOWN)));
                                     pkgPayrAmntVo.setTpExtpyTotAmnt(pkgPayrAmntVo.getTpExtpyTotAmnt().add((payr0417.getUcstSum().compareTo(BigDecimal.ZERO) > 0 ? payr0417.getUcstSum() : payr0417.getPymtDducSum()).setScale(-1,BigDecimal.ROUND_DOWN)));
                                     pkgPayrAmntVo.setTpFreeDtyTotAmnt(pkgPayrAmntVo.getTpFreeDtyTotAmnt().add(payr0417.getFreeDtySum().setScale(-1,BigDecimal.ROUND_DOWN))); 
                           ...
                           } else if (ExtermsProps.getProps("PYMT_ITEM_11").equals(payr0417.getPayrImcd())) {
                        	   /***********************************************************************/
                        	   /* AA.DTIL_OCCU_INTTN_CD   */
                        	   /************************************************************************/
                        	   //조장수당 
                         	  
                         	  if ( "A0150004".equals(payCalculationVo.getOdtyCd())) {
...
//                                                   payr0302Vo.setRevnAddr(payr0302Vo.getRevnAddr());    /** column 수정주소 : revnAddr */   
                         ...
                         } else if (ExtermsProps.getProps("PAY_EMYMT_PYMT_42").equals(payr0417.getPayrImcd())) {
                             /*****************************************************************************/
                                 ...
                                 // if ("00200003A0060000".equals(payCalculationVo.getDtilOccuInttnCd())    /* 농기계수리원 */ ) {  
                               	 
                               	    edPymtAmnt = payr0417.getPymtDducSum();
                                   ...
                                   // if ((payr0410.getUcstSum().compareTo(BigDecimal.ZERO) > 0 ? payr0410.getUcstSum() : payr0410.getPymtDducSum()).compareTo(BigDecimal.ZERO) > 0) {
                                        if (ExtermsProps.getProps("PAY_EMYMT_PYMT_07").equals(payr0417.getPayrImcd())) {
                                            ...
                                            if (new BigDecimal(payCalculationVo.getDilnlazTotTmRstDutyTm()).compareTo(BigDecimal.ZERO) > 0) {
                                                  ...
                                                  //시간외근무   
                                           	  if (ExtermsProps.getProps("PAYR_UNIT_B0320020").equals(MSFSharedUtils.defaultNulls(payCalculationVo.getDtilOcclsApptnUcstCd(),ExtermsProps.getProps("PAYR_UNIT_B0320010")))) {
	                                                	//기본급에 대한 금액을 일당으로 처리 함. 
                                           		  if ("B0170010".equals(payr0417.getPymtDducFrmCd())) {
                                             			  //금액처리 
                                             		       ucstSum = payr0417.getPymtDducSum();
                                             		    
                                             		    } else if ("B0170040".equals(payr0417.getPymtDducFrmCd())) {
                                                			  //별도계산  
                                                			  ucstSum = payr0417.getPymtDducSum().multiply(new BigDecimal("1.5"));
                                             		    } else if ("B0170030".equals(payr0417.getPymtDducFrmCd())) {
                                             		 	 //B0170030  별도단가 
                                                     	 ucstSum = payr0417.getPymtDducSum();		
                                                			 
                                                      } else {
                                                    	  
                                             			  ucstSum = ((pkgPayrAmntVo.getBasePymtAmnt().divide(new BigDecimal(ConstGimCheon.PAYR_BASS_WKTM_GH_01), 5)).multiply(new BigDecimal("1.5"))).setScale(5,BigDecimal.ROUND_DOWN);
                                             		   }
                                           		   
                                            	  } else {		  
                                            	    //시간외근무  -USALY_AMNT_HRWG_QNTY 계산된 시급으로 정리한다. 통상시급 
                                                          ucstSum = (((payr0417.getUsalyAmntPdyQnty().divide(new BigDecimal(ConstGimCheon.PAYR_BASS_WKTM_GH_01), 5))).multiply(new BigDecimal("1.5"))).setScale(5,BigDecimal.ROUND_DOWN); //payr0410.getBefUcstSum().compareTo(BigDecimal.ZERO) > 0 ? payr0410.getBefUcstSum() : (payr0410.getUcstSum().compareTo(BigDecimal.ZERO) > 0 ? payr0410.getUcstSum() : payr0410.getPymtDducSum());
                                                 
                                                      if (payr0250Vo.getJobYrMnth().substring(4,6).equals("12")) { 
                                                    	  ucstSum =   (((payr0417.getUsalyAmntPdyQnty().divide(new BigDecimal(ConstGimCheon.PAYR_BASS_WKTM_GH_01), 5))).multiply(new BigDecimal("1.5"))).setScale(5,BigDecimal.ROUND_DOWN);   //payr0410.getUcstSum().compareTo(BigDecimal.ZERO) > 0 ? payr0410.getUcstSum() : payr0410.getPymtDducSum();
                                                      } 
                                                      ...
                                                      //시간외가 20ㅅ간이 넘으면 20시간으로 계산 처리 루틴 추가 차후 수정 
                                                     // if (new BigDecimal(ConstAnDong.PAYR_OVER_WKTM_GHTM).compareTo(new BigDecimal(payCalculationVo.getDilnlazTotTmRstDutyTm())) > 0) {
                                                      ...
                                                      //} else {
                                                    	...
                                                    	//  totTmSum = ((new BigDecimal(ConstAnDong.PAYR_OVER_WKTM_GHTM)).multiply(ucstSum)).setScale(-1,BigDecimal.ROUND_DOWN);  //시간외근무
                                           ...
                                           if (new BigDecimal(payCalculationVo.getDilnlazSatDutyNumDys()).compareTo(BigDecimal.ZERO) > 0) {
                                           	  ...
                                           	  if (ExtermsProps.getProps("PAYR_UNIT_B0320020").equals(MSFSharedUtils.defaultNulls(payCalculationVo.getDtilOcclsApptnUcstCd(),ExtermsProps.getProps("PAYR_UNIT_B0320010")))) {
                                           		  ...
                                           		  if ("B0170010".equals(payr0417.getPymtDducFrmCd())) {
                                             		  ...
                                             		  ucstSum = (((payr0417.getUsalyAmntPdyQnty().divide(new BigDecimal(ConstGimCheon.PAYR_BASS_WKTM_GH_01), 5))).multiply(new BigDecimal("1.5"))).setScale(0,BigDecimal.ROUND_DOWN);//payr0410.getBefUcstSum().compareTo(BigDecimal.ZERO) > 0 ? payr0410.getBefUcstSum() : (payr0410.getUcstSum().compareTo(BigDecimal.ZERO) > 0 ? payr0410.getUcstSum() : payr0410.getPymtDducSum());
                                                       if (payr0250Vo.getJobYrMnth().substring(4,6).equals("12")) { 
                                                     	  ucstSum = (((payr0417.getUsalyAmntPdyQnty().divide(new BigDecimal(ConstGimCheon.PAYR_BASS_WKTM_GH_01), 5))).multiply(new BigDecimal("1.5"))).setScale(0,BigDecimal.ROUND_DOWN); //payr0410.getUcstSum().compareTo(BigDecimal.ZERO) > 0 ? payr0410.getUcstSum() : payr0410.getPymtDducSum();
                                                       } 
                                                  	  ...
                                                  	  if (ExtermsProps.getProps("PAYR_UNIT_B0320020").equals(MSFSharedUtils.defaultNulls(payCalculationVo.getDtilOcclsApptnUcstCd(),ExtermsProps.getProps("PAYR_UNIT_B0320010")))) {
                                                  		    ...
                                                  		    if (ExtermsProps.getProps("PAY_EMYMT_PYMT_21").equals(payr0417.getPayrImcd()) && (ExtermsProps.getProps("PAY_EMYMT_DYMNTH_01").equals(payr0417.getDayMnthAmntDivCd())) 
                                                  		       ...
                                                  		       if ("B0170010".equals(payr0417.getPymtDducFrmCd())) {
                                                     			  //금액처리 
                                                     		       ucstSum = payr0417.getPymtDducSum();
                                                        			  ...
                                                        			  //별도계산  
                                                        			  ucstSum = payr0417.getPymtDducSum().multiply(new BigDecimal("0.5"));
                                                     			  ...
                                                     			  ucstSum = ((pkgPayrAmntVo.getBasePymtAmnt().divide(new BigDecimal(ConstGimCheon.PAYR_BASS_WKTM_GH_01), 5)).multiply(new BigDecimal("0.5"))).setScale(5,BigDecimal.ROUND_DOWN);
                                                     		   }
                                                               ...
                                                               //시급인경우 USALY_AMNT_HRWG_QNTY
                                                                 ...
                                                                 ucstSum = (((payr0417.getUsalyAmntPdyQnty().divide(new BigDecimal(ConstGimCheon.PAYR_BASS_WKTM_GH_01), 5))).multiply(new BigDecimal("0.5"))).setScale(0,BigDecimal.ROUND_DOWN);
                                                  		   ...
                                                  		   if (ExtermsProps.getProps("PAY_EMYMT_PYMT_21").equals(payr0417.getPayrImcd()) && (ExtermsProps.getProps("PAY_EMYMT_DYMNTH_01").equals(payr0417.getDayMnthAmntDivCd())) 
                                                               ...
                                                               //월정액,월액인경우 
                                                            	 ...
                                                            	 totTmSum =  payr0417.getPymtDducSum();		 
                                                                   ...
                                                                   && (new BigDecimal(payCalculationVo.getDilnlazPubcHodyDutyTm()).compareTo(BigDecimal.ZERO) > 0)) {
                                                               //시급인경우 USALY_AMNT_HRWG_QNTY
                                                               if ("B0170010".equals(payr0417.getPymtDducFrmCd())) {
                                                      			  //금액처리 
                                                      			    ucstSum = payr0417.getPymtDducSum();
                                                              ...
                                                              totTmSum = (new BigDecimal(MSFSharedUtils.defaultNulls(payCalculationVo.getDilnlazPubcHodyDutyTm(),"0"))).multiply(ucstSum).setScale(-1,BigDecimal.ROUND_DOWN);  //휴일근무 
                                                                     ...
                                                                     totTmSum = ((new BigDecimal(MSFSharedUtils.defaultNulls(payCalculationVo.getDilnlazPubcHodyDutyNumDys(),"0"))).multiply(ucstSum)).setScale(-1,BigDecimal.ROUND_DOWN);  //토요근무수당 
	                                                                   ...
	                                                                   //월정액,월액인경우  
	                                                            	    ucstSum = BigDecimal.ZERO;
	                                                                       ...
	                                                                       && (new BigDecimal(payCalculationVo.getDilnlazPubcHodyDutyTm()).compareTo(BigDecimal.ZERO) > 0)) {
	                                                                   //시급인경우 USALY_AMNT_HRWG_QNTY
    	                                                              ucstSum = (((payr0417.getUsalyAmntHrwgQnty().divide(new BigDecimal(ConstGimCheon.PAYR_BASS_WKTM_GH_01), 5))).multiply(new BigDecimal("1.5"))).setScale(5,BigDecimal.ROUND_DOWN); //payr0410.getBefUcstSum().compareTo(BigDecimal.ZERO) > 0 ? payr0410.getBefUcstSum() : (payr0410.getUcstSum().compareTo(BigDecimal.ZERO) > 0 ? payr0410.getUcstSum() : payr0410.getPymtDducSum());
                                                                 if (payr0250Vo.getJobYrMnth().substring(4,6).equals("12")) { 
                                                               	  ucstSum = (((payr0417.getUsalyAmntHrwgQnty().divide(new BigDecimal(ConstGimCheon.PAYR_BASS_WKTM_GH_01), 5))).multiply(new BigDecimal("1.5"))).setScale(5,BigDecimal.ROUND_DOWN);//payr0410.getUcstSum().compareTo(BigDecimal.ZERO) > 0 ? payr0410.getUcstSum() : payr0410.getPymtDducSum();
                                                                 } 
                                            ...
                                            if (new BigDecimal(payCalculationVo.getDilnlazPaidPubcHodyNum()).compareTo(BigDecimal.ZERO) > 0) {
                                           	 ...
                                           	 if (ExtermsProps.getProps("PAYR_UNIT_B0320020").equals(MSFSharedUtils.defaultNulls(payCalculationVo.getDtilOcclsApptnUcstCd(),ExtermsProps.getProps("PAYR_UNIT_B0320010")))) {
                                       	    	  ...
                                       	    	  if ("B0170010".equals(payr0417.getPymtDducFrmCd())) {
                                                      ...
                                                      ucstSum = payr0417.getUsalyAmntPdyQnty();
                                                    		  //(((payr0417.getUsalyAmntPdyQnty().divide(new BigDecimal(ConstAnDong.PAYR_BASS_WKTM_GH_01), 5))).multiply(new BigDecimal("1.5"))).setScale(0,BigDecimal.ROUND_DOWN); 
                                                              //payr0410.getBefUcstSum().compareTo(BigDecimal.ZERO) > 0 ? payr0410.getBefUcstSum() : (payr0410.getUcstSum().compareTo(BigDecimal.ZERO) > 0 ? payr0410.getUcstSum() : payr0410.getPymtDducSum());
...
//                                                                            }
                                           	 ...
                                           	 BigDecimal ucstSum = BigDecimal.ZERO; 
                                             	  ...
                                             	  if (ExtermsProps.getProps("PAYR_UNIT_B0320020").equals(MSFSharedUtils.defaultNulls(payCalculationVo.getDtilOcclsApptnUcstCd(),ExtermsProps.getProps("PAYR_UNIT_B0320010")))) {
                                             		  ...
                                             		  ucstSum =  payr0417.getPymtDducSum(); 
	                                                	   ...
	                                                	   ucstSum =   payr0417.getUsalyAmntPdyQnty();//payr0410.getUcstSum().compareTo(BigDecimal.ZERO) > 0 ? payr0410.getUcstSum() : payr0410.getPymtDducSum();
                                        ...
                                        } else  if (ExtermsProps.getProps("PAY_EMYMT_PYMT_20").equals(payr0417.getPayrImcd())) { 
                                            // public static final String PAY_EMYMT_PYMT_20 = "C9410400";    // 연(월)차수당    
                                            if (new BigDecimal(payCalculationVo.getDilnlazPaidPubcHodyNum()).compareTo(BigDecimal.ZERO) > 0) {
                                                ...
                                                totTmSum = ((new BigDecimal(payCalculationVo.getDilnlazPaidPubcHodyNum())).multiply(ucstSum)).setScale(-1, BigDecimal.ROUND_DOWN);   
                                        ...
                                        } else  if (ExtermsProps.getProps("PAY_EMYMT_PYMT_08").equals(payr0417.getPayrImcd())) { 
                                               //주휴수당 
                                      	      ...
                                      	      if (ExtermsProps.getProps("PAYR_UNIT_B0320020").equals(MSFSharedUtils.defaultNulls(payCalculationVo.getDtilOcclsApptnUcstCd(),ExtermsProps.getProps("PAYR_UNIT_B0320010")))) {
                                                	//기본급에 대한 금액을 일당으로 처리 함. 
                                                     ...
                                                     if ( ExtermsProps.getProps("PAY_EMYMT_DYMNTH_01").equals(payr0417.getDayMnthAmntDivCd()) 
                                                   	  ...
                                                   	  totTmSum = (new BigDecimal(payCalculationVo.getDilnlazWklyHldyNumDys()).multiply(payr0417.getPymtDducSum())).setScale(-1,BigDecimal.ROUND_DOWN); 
                                                   
                                                     } else if (((
                                                             ExtermsProps.getProps("PAY_EMYMT_DYMNTH_02").equals(payr0417.getDayMnthAmntDivCd()) ||  ExtermsProps.getProps("PAY_EMYMT_DYMNTH_03").equals(payr0417.getDayMnthAmntDivCd()))
                                                             )  && (new BigDecimal(MSFSharedUtils.defaultNulls(payCalculationVo.getDilnlazWklyHldyNumDys(),"0")).compareTo(BigDecimal.ZERO) > 0)) {
                                                         //월정액,월액인경우  
                                                   	  totTmSum = payr0417.getPymtDducSum().setScale(-1,BigDecimal.ROUND_DOWN);
                                            ...
                                            if (BigDecimal.ZERO.compareTo(ucstSum) < 0)  {
                                           	 
                                          	  payrCommCalcService.insertPayr0302(payr0302Vo);
                                          	  
                                            }	  
                                            
                                        } else  if (ExtermsProps.getProps("PAY_EMYMT_PYMT_09").equals(payr0417.getPayrImcd())) { 
                                            //public static final String PAY_EMYMT_PYMT_09 = "C9130100";    // 위험수당
                                        ...
                                        } else  if (ExtermsProps.getProps("PAY_EMYMT_PYMT_43").equals(payr0417.getPayrImcd())) { 
                                      	//C9310550	B0080020	B0250150	목욕비
                                      	//	public static final String PAY_EMYMT_PYMT_43 = "C9310550";
                                   	     ...
                                   	     /***********************************************************************/
                                       	   /* 00100017A0060000  상수도누수수리원
 												00100024A0060000  하수도준설원   */
                                       	   /************************************************************************/
                                       	    
                                                if (("00100017A0060000".equals(payCalculationVo.getDtilOccuInttnCd())) ||
                                                		("00100024A0060000".equals(payCalculationVo.getDtilOccuInttnCd()))) {

                                               	 
                                                    ucstSum =   payr0417.getUcstSum().compareTo(BigDecimal.ZERO) > 0 ? payr0417.getUcstSum() : payr0417.getPymtDducSum();
                                                    ...
                                                    ucstSum =    payr0417.getPymtDducSum();  //payr0417.getUcstSum().compareTo(BigDecimal.ZERO) > 0 ? payr0417.getUcstSum() :
                                        ...
                                        } else  if (ExtermsProps.getProps("PAY_EMYMT_PYMT_15").equals(payr0417.getPayrImcd())) {
                                            // PAY_EMYMT_PYMT_15 = "C9990200";    // 출장여비 
                                             ...
                                             // 출장여비
                                             if (ExtermsProps.getProps("PAY_EMYMT_DYMNTH_04").equals(payr0417.getDayMnthAmntDivCd())) {
                                                 
                                           	 // tpEmymtAmnt = payr0490.getPymtDducSum().setScale(-1,BigDecimal.ROUND_DOWN);  
                                           	  totTmSum =  ((new BigDecimal(payCalculationVo.getDilnlazButpDys())).multiply(ucstSum)).setScale(-1, BigDecimal.ROUND_DOWN);  //출장여비  
                                             
                                             } else if  ((ExtermsProps.getProps("PAY_EMYMT_DYMNTH_02").equals(payr0417.getDayMnthAmntDivCd()) ||  ExtermsProps.getProps("PAY_EMYMT_DYMNTH_03").equals(payr0417.getDayMnthAmntDivCd())))  {
                                           	  
                                                 //월정액,월액인경우  
                                           	  totTmSum = ucstSum.setScale(-1,BigDecimal.ROUND_DOWN);
                                                 
                                             } else  if (ExtermsProps.getProps("PAY_EMYMT_DYMNTH_01").equals(payr0417.getDayMnthAmntDivCd())) {
