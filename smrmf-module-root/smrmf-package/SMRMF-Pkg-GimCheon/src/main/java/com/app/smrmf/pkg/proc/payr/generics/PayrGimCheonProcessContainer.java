...
import com.app.smrmf.pkg.proc.payr.gimcheon.a002001001.PayrA002001001_B0150000CalcProc;
import com.app.smrmf.pkg.proc.payr.gimcheon.a002001001.PayrA002001001_B0150001CalcProc;
import com.app.smrmf.pkg.proc.payr.gimcheon.a002001001.PayrA002001001_B0150002CalcProc;
import com.app.smrmf.pkg.proc.payr.gimcheon.a002001001.PayrA002001001_B0150003CalcProc;
import com.app.smrmf.pkg.proc.payr.gimcheon.a002001001.PayrA002001001_B0150004CalcProc;
import com.app.smrmf.pkg.proc.payr.gimcheon.a002001001.PayrA002001001_B0150005CalcProc;
import com.app.smrmf.pkg.proc.payr.gimcheon.a002001001.PayrA002001001_B0150006CalcProc;
import com.app.smrmf.pkg.proc.payr.gimcheon.a002001002.PayrA002001002_B0150000CalcProc;
import com.app.smrmf.pkg.proc.payr.gimcheon.a002001002.PayrA002001002_B0150001CalcProc;
import com.app.smrmf.pkg.proc.payr.gimcheon.a002001002.PayrA002001002_B0150002CalcProc;
import com.app.smrmf.pkg.proc.payr.gimcheon.a002001002.PayrA002001002_B0150003CalcProc;
import com.app.smrmf.pkg.proc.payr.gimcheon.a002001002.PayrA002001002_B0150004CalcProc;
import com.app.smrmf.pkg.proc.payr.gimcheon.a002001002.PayrA002001002_B0150005CalcProc;
import com.app.smrmf.pkg.proc.payr.gimcheon.a002001002.PayrA002001002_B0150006CalcProc;
import com.app.smrmf.pkg.proc.payr.gimcheon.comm.PayrCommCalcProc;
 ...
 */
@Controller 
public class PayrGimCheonProcessContainer  extends AbstractCustomServiceImpl {

	private static final Logger logger = LoggerFactory.getLogger(PayrGimCheonProcessContainer.class);
...
//                                                     } 
                                               ...
                                               // BigDecimal tpEmymtC9410300Amnt = BigDecimal.ZERO; 
                                                  ...
                                                  // 위험수당      
                                                  if (ExtermsProps.getProps("PAY_EMYMT_PYMT_09").equals(payr0490.getPayItemCd()) && (ExtermsProps.getProps("PAY_EMYMT_DYMNTH_04").equals(payr0490.getDayMnthAmntDivCd()))) {
                                                      
                                                      tpEmymtAmnt = payr0490.getPymtDducSum().setScale(-1,BigDecimal.ROUND_DOWN); 
                                                
                                                  } else if (ExtermsProps.getProps("PAY_EMYMT_PYMT_09").equals(payr0490.getPayItemCd()) && ((
                                                          ExtermsProps.getProps("PAY_EMYMT_DYMNTH_02").equals(payr0490.getDayMnthAmntDivCd()) ||  ExtermsProps.getProps("PAY_EMYMT_DYMNTH_03").equals(payr0490.getDayMnthAmntDivCd()))
                                                          )) {
                                                  ...
                                                  } else  if (ExtermsProps.getProps("PAY_EMYMT_PYMT_09").equals(payr0490.getPayItemCd()) && (ExtermsProps.getProps("PAY_EMYMT_DYMNTH_01").equals(payr0490.getDayMnthAmntDivCd()))) {
                                                       
                                                      tpEmymtAmnt = payr0490.getPymtDducSum().setScale(-1,BigDecimal.ROUND_DOWN); 
                                                
                                                  }
                                                  if (ExtermsProps.getProps("PAY_EMYMT_PYMT_15").equals(payr0490.getPayItemCd())) {   
                                                
			                                                  // 출장여비
			                                                  if (ExtermsProps.getProps("PAY_EMYMT_DYMNTH_04").equals(payr0490.getDayMnthAmntDivCd())) {
			                                                      
			                                                	 // tpEmymtAmnt = payr0490.getPymtDducSum().setScale(-1,BigDecimal.ROUND_DOWN);  
			                                                       tpEmymtAmnt =  ((new BigDecimal(payCalculationVo.getDilnlazButpDys())).multiply(payr0490.getPymtDducSum())).setScale(-1, BigDecimal.ROUND_DOWN);  //출장여비  
			                                                  
			                                                  } else if  ((ExtermsProps.getProps("PAY_EMYMT_DYMNTH_02").equals(payr0490.getDayMnthAmntDivCd()) ||  ExtermsProps.getProps("PAY_EMYMT_DYMNTH_03").equals(payr0490.getDayMnthAmntDivCd())))  {
			                                                	  
			                                                      //월정액,월액인경우  
			                                                      tpEmymtAmnt = payr0490.getPymtDducSum().setScale(-1,BigDecimal.ROUND_DOWN);
			                                                      
			                                                  } else  if (ExtermsProps.getProps("PAY_EMYMT_DYMNTH_01").equals(payr0490.getDayMnthAmntDivCd())) {
                                                  ...
                                                  if (ExtermsProps.getProps("PAY_EMYMT_PYMT_18").equals(payr0490.getPayItemCd())) {
                                               	   ...
                                               	   if (tpEmymtAmnt.compareTo(payr0490.getFreeDtySum()) >= 0) {  
                                                          ...
                                                          pkgPayrAmntVo.setTpPymtTotAmnt(pkgPayrAmntVo.getTpPymtTotAmnt().add(tpEmymtAmnt)); 
                                                          pkgPayrAmntVo.setTpFreeDtyTotAmnt(pkgPayrAmntVo.getTpFreeDtyTotAmnt().add(tpEmymtAmnt));
                                                      }
                                                  } else if (ExtermsProps.getProps("PAY_EMYMT_PYMT_38").equals(payr0490.getPayItemCd())) {
                                               	   //급식비 
                                                   	   if (tpEmymtAmnt.compareTo(payr0490.getFreeDtySum()) >= 0) {  
...
//                                                 payr0302Vo.setRevnAddr(payr0302Vo.getRevnAddr());    /** column 수정주소 : revnAddr */   
                                              ...
                                              if (payr0520Vo.getPymtDducSum().compareTo(BigDecimal.ZERO) != 0 ) {
                                           	   ...
                                           	   pkgPayrAmntVo.setTpDducTotAmnt(pkgPayrAmntVo.getTpDducTotAmnt().add(payr0520Vo.getPymtDducSum()));
                                              }
...
//                     }
                  ...
                  //--
                  List<PkgPayrCommCalcVO>  psnlList = payCalculationService.selectGimCheonPayrInfoList(payr0250Vo);  
