 ...
 */
@Controller 
public class Yeta2300GimCheonProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta2300GimCheonProcContainer.class);
    ...
    public Yeta2300GimCheonProcContainer() {
