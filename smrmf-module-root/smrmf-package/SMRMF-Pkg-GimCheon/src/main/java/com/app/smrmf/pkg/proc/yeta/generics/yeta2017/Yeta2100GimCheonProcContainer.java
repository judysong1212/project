 ...
 */
@Controller 
public class Yeta2100GimCheonProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta2100GimCheonProcContainer.class);
...
//
    ...
    public Yeta2100GimCheonProcContainer() {
