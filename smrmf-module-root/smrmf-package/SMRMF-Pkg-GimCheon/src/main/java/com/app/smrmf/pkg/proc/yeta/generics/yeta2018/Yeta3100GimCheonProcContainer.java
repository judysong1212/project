 ...
 */
@Controller 
public class Yeta3100GimCheonProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta3100GimCheonProcContainer.class);
...
//
    ...
    public Yeta3100GimCheonProcContainer() {
