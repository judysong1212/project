package com.app.smrmf.pkg.sche.insr.generics;
...
@Controller  
public class InsrScheSvcContainer {


	private static final Logger logger = LoggerFactory.getLogger(InsrScheSvcContainer.class);
   ...
   //스케줄링 
	 ...
	 */
  	private int funcPayrScheFamyUnCheck(ApplicationContext ctx) throws Exception  {
  	   ...
  	   try {
//	  		List scheLogSvcYrList = payrScheSvcService.selectScheLogSvcYrList(); 
//	  		
