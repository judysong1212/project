 ...
 */
@Controller 
public class RetoGimCheonProcessContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(RetoGimCheonProcessContainer.class);
