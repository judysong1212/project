 ...
 */
@Controller 
public class Yeta3300GimCheonProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta3300GimCheonProcContainer.class);
    ...
    public Yeta3300GimCheonProcContainer() {
