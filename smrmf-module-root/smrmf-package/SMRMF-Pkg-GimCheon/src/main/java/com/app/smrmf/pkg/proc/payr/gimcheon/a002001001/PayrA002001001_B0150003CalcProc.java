 ...
 */
@Controller 
public class PayrA002001001_B0150003CalcProc  extends AbstractCustomServiceImpl {
	 

	private static final Logger logger = LoggerFactory.getLogger(PayrA002001001_B0150003CalcProc.class);
   ...
   protected PayrCommCalcService payrCommCalcService;
     ...
     * 생성자 
     */
     public PayrA002001001_B0150003CalcProc () {
    ...
    * 2. 처리내용 : 
    * </pre>
    * @Method Name : callProcMethedPayrA0020010_B0150003
    * @date : 2017. 10. 12.
    * @author : atres
    * @history : 
    *	-----------------------------------------------------------------------
    ...
    * @param pkgInsrWorkVo
    */
	public void callProcMethedPayrA0020010_B0150003(HttpServletRequest request, InfcPkgPayr0250VO payr0250Vo,
...
//                                                   payr0302Vo.setRevnAddr(payr0302Vo.getRevnAddr());    /** column 수정주소 : revnAddr */   
                  ...
                  if ("00200003A0060000".equals(payCalculationVo.getDtilOccuInttnCd())
               	   ...
               	   totBnusAmnt = (payr0410.getUcstSum().compareTo(BigDecimal.ZERO) > 0 ? payr0410.getUcstSum() : payr0410.getPymtDducSum()).setScale(-1,BigDecimal.ROUND_DOWN);
               	   
                          
                   	   //     baseBnusAmnt = pkgPayrAmntVo.getBasePymtAmnt(); 
                          //     totBnusAmnt = (baseBnusAmnt.multiply((payr0410.getPymtDducRate().divide(new BigDecimal("100"))))).setScale(-1,BigDecimal.ROUND_DOWN) ;
                      ...
                      payr0302Vo.setPymtDducSum(totBnusAmnt);   /** column 지급공제금액 : pymtDducSum */
                      payr0302Vo.setPymtDducTxtnAmnt(totBnusAmnt.subtract(payr0410.getFreeDtySum()).setScale(-1,BigDecimal.ROUND_DOWN) );    /** column 지급공제과세금액 : pymtDducTxtnAmnt */ 
	                     
                      pkgPayrAmntVo.setTpPymtTotAmnt(pkgPayrAmntVo.getTpPymtTotAmnt().add(totBnusAmnt));
                      pkgPayrAmntVo.setTpExtpyTotAmnt(pkgPayrAmntVo.getTpExtpyTotAmnt().add(totBnusAmnt));
