 ...
 *
 */
public class PayrA002001001_B0150000CalcProc  extends AbstractCustomServiceImpl {
	 

	private static final Logger logger = LoggerFactory.getLogger(PayrA002001001_B0150000CalcProc.class);
   ...
   protected PayrCommCalcService payrCommCalcService;
     ...
     * 생성자 
     */
     public PayrA002001001_B0150000CalcProc () {
                                  ...
                                  if ((new BigDecimal(payCalculationVo.getDilnlazAbnceNumDys())).compareTo(BigDecimal.ZERO) > 0) {
                                     ...
                                     //  payCalculationVo.getDilnlazAbnceNumDys()   /** column 근태_결근일수 : dilnlazAbnceNumDys */
                                      abnceNumDysAmt = (new BigDecimal(payCalculationVo.getDilnlazAbnceNumDys()))
                                                      .multiply(payr0410.getUsalyAmntHrwgQnty().multiply(new BigDecimal(ConstGimCheon.PAYR_BASS_WKTM_GH_01)));  // USALY_AMNT_HRWG_QNTY 시급통상임금 
...
//                                                   payr0302Vo.setRevnAddr(payr0302Vo.getRevnAddr());    /** column 수정주소 : revnAddr */   
			                   ...
			                   if (  "A0150001".equals(payCalculationVo.getOdtyCd())) {        
                            	   ...
                            	   /***********************************************************************/
                            	   /* 도로보수원인경우    01700001A0060000' = AA.DTIL_OCCU_INTTN_CD   */
                            	   /************************************************************************/
                            	   //반장수당 
                                     if ("01700001A0060000".equals(payCalculationVo.getDtilOccuInttnCd()) && "A0150003".equals(payCalculationVo.getOdtyCd())) {
...
//                                                   payr0302Vo.setRevnAddr(payr0302Vo.getRevnAddr());    /** column 수정주소 : revnAddr */   
                               ...
                               } else if (ExtermsProps.getProps("PYMT_ITEM_11").equals(payr0410.getPayrImcd())) {
                            	   /***********************************************************************/
                            	   /* 도로보수원인경우    01700001A0060000' = AA.DTIL_OCCU_INTTN_CD   */
                            	   /************************************************************************/
                            	   //반장수당        
                                   //조장인경우 
                                     if ("01700001A0060000".equals(payCalculationVo.getDtilOccuInttnCd()) && "A0150004".equals(payCalculationVo.getOdtyCd())) {
...
//                                                   payr0302Vo.setRevnAddr(payr0302Vo.getRevnAddr());    /** column 수정주소 : revnAddr */   
                        	   ...
                        	   payr0450Vo.setDtilOccuInttnCd(payCalculationVo.getDtilOccuInttnCd());
                          	   ...
                          	   if (MSFSharedUtils.paramNotNull(payr0450Vo)) {   
                          		...
                          		/** 00200003A0060000	A0410020	00200003	A0060000	농기계수리원
                          		01700001A0060000	A0410170	01700001	A0060000	도로보수원
                          		01800001A0060000	A0410180	01800001	A0060000	환경미화원  */
                          		
                          		
                          		  if ( "00200003A0060000".equals(payCalculationVo.getDtilOccuInttnCd())
                          				  ||  "01700001A0060000".equals(payCalculationVo.getDtilOccuInttnCd()) ) {     
                         		   ...
                         		   } else if ("01800001A0060000".equals(payCalculationVo.getDtilOccuInttnCd()) ) {    
                         			      //01800001A0060000	A0410180	01800001	A0060000	환경미화원  
...
//                                                   payr0302Vo.setRevnAddr(payr0302Vo.getRevnAddr());    /** column 수정주소 : revnAddr */   
                                ...
                                if ("00200003A0060000".equals(payCalculationVo.getDtilOccuInttnCd())    /* 농기계수리원 */ ) {  
                               		...
                               		//edPymtAmnt = (pkgPayrAmntVo.getBasePymtAmnt().multiply((payr0410.getPymtDducRate().divide(new BigDecimal("100"))))).setScale(-1,BigDecimal.ROUND_DOWN) ;
                                ...
                                if (BigDecimal.ZERO.compareTo(payr0302Vo.getPymtDducSum()) < 0)  {  
                                 ...
                                 //"C9020100"  --  기말수당
                          	     /********************************************************************************
                          	      * 도로 보수원 적용                    01700001A0060000	A0410170	01700001	A0060000	도로보수원   
                          	      * 01800001A0060000	A0410180	01800001	A0060000	환경미화원                                              
                          	      ********************************************************************************/ 
...
//                                                   payr0302Vo.setRevnAddr(payr0302Vo.getRevnAddr());    /** column 수정주소 : revnAddr */   
                                 ...
                                 //  InfcPkgPayr0302VO tpPayr0302vo = new InfcPkgPayr0302VO();
                                  ...
                                  // edPymtAmnt = (pkgPayrAmntVo.getBasePymtAmnt().add((tpPayr0302vo.getPymtDducSum().compareTo(BigDecimal.ZERO) > 0 ? tpPayr0302vo.getPymtDducSum() 
                                   ...
                                   if ("01700001A0060000".equals(payCalculationVo.getDtilOccuInttnCd())    /* 도로보수원 */ ) {  
                                   	 // 01700001A0060000	A0410170	01700001	A0060000	도로보수원 
                               	    edPymtAmnt = pkgPayrAmntVo.getBasePymtAmnt();
                               	
                                   } else if ("00200003A0060000".equals(payCalculationVo.getDtilOccuInttnCd())    /* 환경미화원 */ ) {   
                                       ...
                                       // if ((payr0410.getUcstSum().compareTo(BigDecimal.ZERO) > 0 ? payr0410.getUcstSum() : payr0410.getPymtDducSum()).compareTo(BigDecimal.ZERO) > 0) {
                                            if (ExtermsProps.getProps("PAY_EMYMT_PYMT_07").equals(payr0410.getPayrImcd())) {
                                                   ...
                                                   if (new BigDecimal(payCalculationVo.getDilnlazTotTmRstDutyTm()).compareTo(BigDecimal.ZERO) > 0) {
                                                   	...
                                                   	//시간외근무  -USALY_AMNT_HRWG_QNTY 계산된 시급으로 정리한다. 통상시급 을 이용 할것인지 월통상임금을 기준으로 처리 할것인지에 대한 부분으로 구분하여 처리 해야함.
                                               	 if ( "01800001A0060000".equals(payCalculationVo.getDtilOccuInttnCd())) {
                                               			//환경미화원
                                               		//   ucstSum = (payr0410.getUsalyAmntHrwgQnty().multiply(new BigDecimal("1.5"))).setScale(0,BigDecimal.ROUND_DOWN); 
                                              ...
                                              // 토요근무수당  휴일근무  --일수산정C9410700 USALY_AMNT_PDY_QNTY
                                           	 BigDecimal ucstSum = BigDecimal.ZERO;
                                             ...
                                             // 야간수당       -- 시간산정C9410300 MNTH_USALY_AMNT_WAG
                                                if (new BigDecimal(MSFSharedUtils.defaultNulls(payCalculationVo.getDilnlazTotNtotTm(),"0")).compareTo(BigDecimal.ZERO) > 0) {
                                               	 ...
                                               	 if ( "01800001A0060000".equals(payCalculationVo.getDtilOccuInttnCd())) {
                                             			//환경미화원
                                             		   // ucstSum = (payr0410.getUsalyAmntHrwgQnty().multiply(new BigDecimal("0.5"))).setScale(0,BigDecimal.ROUND_DOWN); 
                                              ...
                                              // 휴일수당        -- 일수 C9410200
                                                if (MSFSharedUtils.paramNotNull(payCalculationVo.getDilnlazPubcHodyDutyNumDys())) {
                                                    ...
                                                    if (new BigDecimal(MSFSharedUtils.defaultNulls(payCalculationVo.getDilnlazPubcHodyDutyNumDys(),"0")).compareTo(BigDecimal.ZERO) > 0) {
                                                   	 ...
                                                   	 if ( "01800001A0060000".equals(payCalculationVo.getDtilOccuInttnCd())) {
                                                  			//환경미화원
//                                                  		    ucstSum = (payr0410.getUsalyAmntPdyQnty().multiply(new BigDecimal("1.5"))).setScale(0,BigDecimal.ROUND_DOWN); 
//                                                        
//                                                              if (payr0250Vo.getJobYrMnth().substring(4,6).equals("12")) {  
//                                                            	  ucstSum = (payr0410.getUsalyAmntPdyQnty().multiply(new BigDecimal("1.5"))).setScale(0,BigDecimal.ROUND_DOWN); 
//                                                              }
                                                ...
                                                if (new BigDecimal(payCalculationVo.getDilnlazPaidPubcHodyNum()).compareTo(BigDecimal.ZERO) > 0) {
                                               	 ...
                                               	 if ( "01800001A0060000".equals(payCalculationVo.getDtilOccuInttnCd())) {
                                               			//환경미화원
                                               		//    ucstSum = payr0410.getUsalyAmntPdyQnty(); 
                                                ...
                                                // 체력단련비   -- 일수 산정 C9040100
                                          	   	  ...
                                          	   	  if ( "01800001A0060000".equals(payCalculationVo.getDtilOccuInttnCd())) {  
                                              		//환경미화원  
                                                               ucstSum = payr0410.getMnthUsalyAmntAllwBnusSum();//payr0410.getBefUcstSum().compareTo(BigDecimal.ZERO) > 0 ? payr0410.getBefUcstSum() : (payr0410.getUcstSum().compareTo(BigDecimal.ZERO) > 0 ? payr0410.getUcstSum() : payr0410.getPymtDducSum());
                                                             if (payr0250Vo.getJobYrMnth().substring(4,6).equals("12")) { 
                                                           	  ucstSum = payr0410.getMnthUsalyAmntAllwBnusSum();//payr0410.getUcstSum().compareTo(BigDecimal.ZERO) > 0 ? payr0410.getUcstSum() : payr0410.getPymtDducSum();
                                                             } 
                                       	    ...
                                       	    /* 00200003A0060000	A0410020	00200003	A0060000	농기계수리원
                                           	 ...
                                           	 if ("00200003A0060000".equals(payCalculationVo.getDtilOccuInttnCd())
                                                   ...
                                                   totTmSum = ucstSum ;
                                               	 ...
                                               	 ucstSum = payr0410.getMnthUsalyAmntAllwBnusSum(); 
                                                         
                                               	 totTmSum = (ucstSum.multiply((payr0410.getPymtDducRate().divide(new BigDecimal("100"))))).setScale(-1,BigDecimal.ROUND_DOWN) ;
                                            ...
                                            } else  if (ExtermsProps.getProps("PAY_EMYMT_PYMT_30").equals(payr0410.getPayrImcd())) {
                                             	//public static final String PAY_EMYMT_PYMT_30 = "C9310100";    //		위생수당
                                             ...
                                             } else  if (ExtermsProps.getProps("PAY_EMYMT_PYMT_32").equals(payr0410.getPayrImcd())) {
                                                 ...
                                                 // PAY_EMYMT_PYMT_15 = "C9990200";    // 출장여비 
                                                  ...
                                                  // 출장여비
                                                  if (ExtermsProps.getProps("PAY_EMYMT_DYMNTH_04").equals(payr0410.getDayMnthAmntDivCd())) {
                                                  ...
                                                  } else if  ((ExtermsProps.getProps("PAY_EMYMT_DYMNTH_02").equals(payr0410.getDayMnthAmntDivCd()) ||  ExtermsProps.getProps("PAY_EMYMT_DYMNTH_03").equals(payr0410.getDayMnthAmntDivCd())))  {
                                                	  
                                                      //월정액,월액인경우  
                                                	  totTmSum = ucstSum.setScale(-1,BigDecimal.ROUND_DOWN);
                                                      
                                                  } else  if (ExtermsProps.getProps("PAY_EMYMT_DYMNTH_01").equals(payr0410.getDayMnthAmntDivCd())) {
