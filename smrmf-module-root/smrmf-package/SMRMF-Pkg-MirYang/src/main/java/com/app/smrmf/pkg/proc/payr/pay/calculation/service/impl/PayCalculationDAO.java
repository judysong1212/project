...
public class PayCalculationDAO extends EgovAbstractDAO {
     ...
     * 2. 처리내용 : 
     * </pre>
     * @Method Name : selectMuJuPayrInfoList
     * @date : 2016. 5. 26.
     ...
     * @throws Exception
     */
    public List<PkgPayrCommCalcVO> selectMuJuPayrInfoList(InfcPkgPayr0250VO searchVO) throws Exception {
        return (List<PkgPayrCommCalcVO>)list("payCalculationDAO.selectMuJuPayrInfoList_D", searchVO);
    }
