 ...
 */
@Controller 
public class RemtMirYangProcessContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(RemtMirYangProcessContainer.class);
    private static final String calledClass = RemtMirYangProcessContainer.class.getName();
