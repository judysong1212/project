 ...
 */
@Controller 
public class Yeta2300MirYangProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta2300MirYangProcContainer.class);
    ...
    public Yeta2300MirYangProcContainer() {
