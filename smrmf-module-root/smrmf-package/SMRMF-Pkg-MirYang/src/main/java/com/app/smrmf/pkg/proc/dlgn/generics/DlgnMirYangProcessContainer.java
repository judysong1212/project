...
public class DlgnMirYangProcessContainer {
	

	private static final Logger logger = LoggerFactory.getLogger(DlgnMirYangProcessContainer.class);
	   
    @Resource(name = "ManageCommuteService")
    protected ManageCommuteService manageCommuteService;

    public DlgnMirYangProcessContainer() {
