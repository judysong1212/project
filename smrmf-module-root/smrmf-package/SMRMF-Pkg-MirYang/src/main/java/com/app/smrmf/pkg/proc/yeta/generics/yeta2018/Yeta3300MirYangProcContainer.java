 ...
 */
@Controller 
public class Yeta3300MirYangProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta3300MirYangProcContainer.class);
    ...
    public Yeta3300MirYangProcContainer() {
