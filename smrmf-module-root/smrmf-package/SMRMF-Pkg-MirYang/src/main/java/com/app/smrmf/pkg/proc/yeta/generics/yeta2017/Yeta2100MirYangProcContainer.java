 ...
 */
@Controller 
public class Yeta2100MirYangProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta2100MirYangProcContainer.class);
...
//
    ...
    public Yeta2100MirYangProcContainer() {
