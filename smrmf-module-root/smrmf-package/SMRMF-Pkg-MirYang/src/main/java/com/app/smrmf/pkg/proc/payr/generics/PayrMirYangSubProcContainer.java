 ...
 */
@Controller 
public class PayrMirYangSubProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(PayrMirYangSubProcContainer.class);
