 ...
 */
@Controller 
public class Yeta3100MirYangProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta3100MirYangProcContainer.class);
...
//
    ...
    public Yeta3100MirYangProcContainer() {
