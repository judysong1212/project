 ...
 */
@Controller 
public class Yeta3300YangPyeongProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta3300YangPyeongProcContainer.class);
    ...
    public Yeta3300YangPyeongProcContainer() {
