 ...
 */
@Controller 
public class Yeta2100YangPyeongProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta2100YangPyeongProcContainer.class);
...
//
    ...
    public Yeta2100YangPyeongProcContainer() {
