...
public class PayCalculationDAO extends EgovAbstractDAO {
     ...
     * @throws Exception
     */
    public List<PkgPayrCommCalcVO> selectYangPyeongPayrInfoList(InfcPkgPayr0250VO searchVO) throws Exception {
        return (List<PkgPayrCommCalcVO>)list("payCalculationDAO.selectYangPyeongPayrInfoList_D", searchVO);
    }
