...
public class DlgnYangPyeongProcessContainer {
	

	private static final Logger logger = LoggerFactory.getLogger(DlgnYangPyeongProcessContainer.class);
	   
    @Resource(name = "ManageCommuteService")
    protected ManageCommuteService manageCommuteService;

    public DlgnYangPyeongProcessContainer() {
...
//            searchVO.setDpobCd(""); 
    ...
    public int setUpdateManageInfcDlgn0100HHMiCommuteService(HttpServletRequest request,InfcPkgDlgn0100VO infcDlgn0100Vo) throws Exception{
        ...
        try {
            ...
            //추가 20210402
            if("A0020010".equals(infcDlgn0100SrhVo.getEmymtDivCd())){ //무기계약직일 경우 20210402
            	
            	logger.debug("무기계약직select양평");
...
//                    upInfcDlgn0100Vo.setRevnAddr(infcDlgn0100Vo.getRevnAddr());    /** column 수정주소 : revnAddr */
            	...
            	logger.debug("기간제select양평");
                List list =  manageCommuteService.selectInfcDlgn0110HHMiTotList2(infcDlgn0100SrhVo); 
