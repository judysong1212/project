...
//    private Payr0305DAO payr0305DAO;
    ...
    //private EgovIdGnrService egovIdGnrService;
	  ...
	  * 2. 처리내용 : 
	  * </pre>
	  * @Method Name : selectYangJuPayrInfoList
	  * @date : 2016. 5. 26.
	  ...
	  *	-----------------------------------------------------------------------
	  * 
	  * @see com.app.smrmf.payr.pay.calculation.service.PayCalculationService#selectYangJuPayrInfoList(com.app.smrmf.infc.payroll.vo.InfcPkgPayr0250VO)
	  * @param vo
	  * @return
	  * @throws Exception
	  */
	 public List<PkgPayrCommCalcVO> selectYangPyeongPayrInfoList(InfcPkgPayr0250VO vo) throws Exception {
		 
		 return payCalculationDAO.selectYangPyeongPayrInfoList(vo);
