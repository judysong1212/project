 ...
 */
@Controller 
public class Yeta3100YangPyeongProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta3100YangPyeongProcContainer.class);
...
//
    ...
    public Yeta3100YangPyeongProcContainer() {
