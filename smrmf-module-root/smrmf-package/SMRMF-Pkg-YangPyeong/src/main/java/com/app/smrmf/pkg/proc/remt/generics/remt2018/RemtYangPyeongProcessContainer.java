 ...
 */
@Controller 
public class RemtYangPyeongProcessContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(RemtYangPyeongProcessContainer.class);
    private static final String calledClass = RemtYangPyeongProcessContainer.class.getName();
