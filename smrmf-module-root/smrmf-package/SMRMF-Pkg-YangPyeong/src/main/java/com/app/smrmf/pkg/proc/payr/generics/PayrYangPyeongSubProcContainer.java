 ...
 */
@Controller 
public class PayrYangPyeongSubProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(PayrYangPyeongSubProcContainer.class);
