 ...
 */
@Controller 
public class Yeta2300YangPyeongProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta2300YangPyeongProcContainer.class);
    ...
    public Yeta2300YangPyeongProcContainer() {
