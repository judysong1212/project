...
public class DlgnSamCheokProcessContainer {
	

	private static final Logger logger = LoggerFactory.getLogger(DlgnSamCheokProcessContainer.class);
	   
    @Resource(name = "ManageCommuteService")
    protected ManageCommuteService manageCommuteService;

    public DlgnSamCheokProcessContainer() {
