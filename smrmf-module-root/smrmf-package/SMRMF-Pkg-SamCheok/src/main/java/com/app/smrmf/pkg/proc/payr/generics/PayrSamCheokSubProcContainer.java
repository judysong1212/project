 ...
 */
@Controller 
public class PayrSamCheokSubProcContainer  extends AbstractCustomServiceImpl {

	private static final Logger logger = LoggerFactory.getLogger(PayrSamCheokSubProcContainer.class);
	private static final String calledClass = PayrSamCheokSubProcContainer.class.getName();  
