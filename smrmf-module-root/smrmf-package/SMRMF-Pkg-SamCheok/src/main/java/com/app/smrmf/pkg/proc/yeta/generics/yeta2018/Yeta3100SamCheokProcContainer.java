 ...
 */
@Controller 
public class Yeta3100SamCheokProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta3100SamCheokProcContainer.class);
...
//
    ...
    public Yeta3100SamCheokProcContainer() {
