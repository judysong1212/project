 ...
 */
@Controller 
public class Yeta3300SamCheokProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta3300SamCheokProcContainer.class);
    ...
    public Yeta3300SamCheokProcContainer() {
