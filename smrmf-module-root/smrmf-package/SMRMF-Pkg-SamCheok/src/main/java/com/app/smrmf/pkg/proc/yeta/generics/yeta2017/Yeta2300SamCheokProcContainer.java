 ...
 */
@Controller 
public class Yeta2300SamCheokProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta2300SamCheokProcContainer.class);
    ...
    public Yeta2300SamCheokProcContainer() {
