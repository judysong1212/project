 ...
 */
@Controller 
public class RetoSamCheokProcessContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(RetoSamCheokProcessContainer.class);
