 ...
 */
@Controller 
public class PayrSamCheokProcessContainer  extends AbstractCustomServiceImpl {

	private static final Logger logger = LoggerFactory.getLogger(PayrSamCheokProcessContainer.class);
	private static final String calledClass = PayrSamCheokProcessContainer.class.getName();  
	                                                                          ...
	                                                                          if (new BigDecimal(MSFSharedUtils.defaultNulls(payCalculationVo.getDilnlazPaidPubcHodyNum(),"0")).compareTo(BigDecimal.ZERO) > 0) {
	                                                                            ...
	                                                                            //PAY_EMYMT_PYMT_18 = "C9080100";    // 정액급식비
                                                                                  ...
                                                                                  if ((new BigDecimal(MSFSharedUtils.defaultNulls(payCalculationVo.getDilnlazAbnceNumDys(),"0"))).compareTo(BigDecimal.ZERO) > 0) {
	                                                                                  ...
	                                                                                  }  else  if ((new BigDecimal(MSFSharedUtils.defaultNulls(payCalculationVo.getDilnlazDutyNumDys(),"0")).compareTo((new BigDecimal(payCalculationVo.getDilnlazTotDutyNumDys())).add((new BigDecimal(payCalculationVo.getDilnlazAbnceNumDys())))) == 0)) {
                                                        ...
                                                        if ((payr0410.getUcstSum().compareTo(BigDecimal.ZERO) > 0 ? payr0410.getUcstSum() : payr0410.getPymtDducSum()).compareTo(BigDecimal.ZERO) > 0) {
                                                            if (ExtermsProps.getProps("PAY_EMYMT_PYMT_07").equals(payr0410.getPayrImcd())) {
                                                             ...
                                                             // 야간수당       -- 시간산정C9410300
                                                                ...
                                                                totTmSum = (((new BigDecimal(MSFSharedUtils.defaultNulls(payCalculationVo.getDilnlazTotNtotTm(),"0")))
                                                                		     .multiply(tpUsalyAmntHrwgGnty))
                                                                		     .add(((new BigDecimal(MSFSharedUtils.defaultNulls(payCalculationVo.getDilnlazTotNtotTm(),"0"))).multiply(ucstSum)))).setScale(-1,BigDecimal.ROUND_DOWN);  //시간외근무
                                                                             ...
                                                                             if ((payr0410.getUcstSum().compareTo(BigDecimal.ZERO) > 0 ? payr0410.getUcstSum() : payr0410.getPymtDducSum()).compareTo(BigDecimal.ZERO) > 0) {
                                                                                 if (ExtermsProps.getProps("PAY_EMYMT_PYMT_07").equals(payr0410.getPayrImcd())) {
                                                                                  ...
                                                                                  // 야간수당       -- 시간산정C9410300
                                                                                     ...
                                                                                     totTmSum = (  ((new BigDecimal(payCalculationVo.getDilnlazTotNtotTm())).multiply(tpUsalyAmntHrwgGnty))
                                                                                    		 .add(((new BigDecimal(payCalculationVo.getDilnlazTotNtotTm())).multiply(ucstSum)))).setScale(-1,BigDecimal.ROUND_DOWN);  //시간외근무
