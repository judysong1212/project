 ...
 */
@Controller 
public class Yeta3300JinAnProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta3300JinAnProcContainer.class);
    ...
    public Yeta3300JinAnProcContainer() {
