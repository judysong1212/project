 ...
 */
@Controller 
public class RemtJinAnProcessContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(RemtJinAnProcessContainer.class);
    private static final String calledClass = RemtJinAnProcessContainer.class.getName();
