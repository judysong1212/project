 ...
 */
@Controller 
public class Yeta2100JinAnProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta2100JinAnProcContainer.class);
...
//
    ...
    public Yeta2100JinAnProcContainer() {
