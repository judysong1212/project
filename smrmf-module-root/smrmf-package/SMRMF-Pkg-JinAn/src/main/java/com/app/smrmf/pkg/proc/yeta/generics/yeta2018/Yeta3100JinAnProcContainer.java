 ...
 */
@Controller 
public class Yeta3100JinAnProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta3100JinAnProcContainer.class);
...
//
    ...
    public Yeta3100JinAnProcContainer() {
