 ...
 */
@Controller 
public class PayrJinAnSubProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(PayrJinAnSubProcContainer.class);
