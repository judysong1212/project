 ...
 */
@Controller 
public class PayrSuWonSubProcContainer  extends AbstractCustomServiceImpl {
	
	private static final Logger logger = LoggerFactory.getLogger(PayrSuWonSubProcContainer.class);
	private static final String calledClass = PayrSuWonSubProcContainer.class.getName();
