 ...
 */
@Controller 
public class Yeta4100SuWonProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta4100SuWonProcContainer.class);
    ...
    public Yeta4100SuWonProcContainer() {
