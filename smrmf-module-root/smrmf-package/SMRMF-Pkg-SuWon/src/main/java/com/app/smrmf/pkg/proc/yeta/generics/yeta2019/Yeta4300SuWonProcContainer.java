 ...
 */
@Controller 
public class Yeta4300SuWonProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta4300SuWonProcContainer.class);
	  
  
    @Resource(name = "Yeta4300PayrService")
    protected Yeta4300PayrService  yeta4300;
    
     
	
    public Yeta4300SuWonProcContainer() {
