 ...
 */
@Controller 
public class Yeta5300SuWonProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta5300SuWonProcContainer.class);
	  
  
    @Resource(name = "Yeta5300PayrService")
    protected Yeta5300PayrService  yeta5300;
    
     
	
    public Yeta5300SuWonProcContainer() {
