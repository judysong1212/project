 ...
 */
@Controller 
public class Yeta3100SuWonProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta3100SuWonProcContainer.class);
...
//
    ...
    public Yeta3100SuWonProcContainer() {
