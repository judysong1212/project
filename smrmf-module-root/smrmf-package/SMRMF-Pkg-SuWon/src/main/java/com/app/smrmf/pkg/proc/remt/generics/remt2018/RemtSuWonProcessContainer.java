 ...
 */
@Controller 
public class RemtSuWonProcessContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(RemtSuWonProcessContainer.class);
    private static final String calledClass = RemtSuWonProcessContainer.class.getName();
