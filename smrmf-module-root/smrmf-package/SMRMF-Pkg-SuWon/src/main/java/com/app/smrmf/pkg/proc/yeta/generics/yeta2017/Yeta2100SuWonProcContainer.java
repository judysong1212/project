 ...
 */
@Controller 
public class Yeta2100SuWonProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta2100SuWonProcContainer.class);
...
//
    ...
    public Yeta2100SuWonProcContainer() {
