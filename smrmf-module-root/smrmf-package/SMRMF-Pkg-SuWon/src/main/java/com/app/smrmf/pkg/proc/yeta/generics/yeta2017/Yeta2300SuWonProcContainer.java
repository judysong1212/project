 ...
 */
@Controller 
public class Yeta2300SuWonProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta2300SuWonProcContainer.class);
    ...
    public Yeta2300SuWonProcContainer() {
