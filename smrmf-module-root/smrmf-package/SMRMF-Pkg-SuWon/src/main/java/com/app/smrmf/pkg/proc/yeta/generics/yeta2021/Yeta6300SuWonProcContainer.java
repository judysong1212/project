 ...
 */
@Controller 
public class Yeta6300SuWonProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta6300SuWonProcContainer.class);
	  
  
    @Resource(name = "Yeta6300PayrService")
    protected Yeta6300PayrService  yeta6300;
    
     
	
    public Yeta6300SuWonProcContainer() {
