...
public class Yeta8400FileController {
    ...
    public String expYeta8400Export(@ModelAttribute("InfcPkgYe161010_2023_VO") InfcPkgYe161010_2023_VO  ye161010VO,final HttpServletRequest request,final HttpServletResponse response
        ...
        Yeta8400PkgFileController yeta8400 = new Yeta8400PkgFileController();
...
//     	listTypCd = SysifPkgServiceUtils.funcArrBeforTypOccuCd(RemoteServiceUtil.getThreadLocalRequest(),sysIfBass0320Vo);
     ...
     //	 List<String> listTyInttnCd = new ArrayList<String>(); 
    	...
    	sysIfBass0350Vo.setDtilOccuInttnCd(ye161010VO.getDtilOccuInttnCd());
     	...
     	/************************과거 직종세에 해당하는 사람들 데이타 가져오기 **********************************************************/
		       	 ...
		       	 if (ye161010VO.getCreFile().equals("Y0090001")) {
		       		 //근로소득지급명세서 호출 
		       		  state = yeta8400.fnYeta8400_Tax_Ye161010_File_Create(request,ye161010VO,response) ;
		//       		 if state = 0 then
		//			          begin
		...
		//			          end;
		       		 ...
		       		 //의료비지급명세서 
		       		state = yeta8400.fnYeta8400_Tax_Ye164010_File_Create(request,ye161010VO,response) ;
		...
		//	          end;
		       		 ...
		       		 //기부금지급명세서 
		       		state = yeta8400.fnYeta8400_Tax_Ye165010_File_Create(request,ye161010VO,  response) ;
     ...
     //	 List<String> listTyInttnCd = new ArrayList<String>(); 
    	...
    	sysIfBass0350Vo.setDtilOccuInttnCd(ye161010VO.getDtilOccuInttnCd());
     	...
     	/************************과거 직종세에 해당하는 사람들 데이타 가져오기 **********************************************************/
		       	 ...
		       	 if (ye161010VO.getCreFile().equals("Y0090001")) {
		       		 //근로소득지급명세서 검증  
		       		rtnResult = yeta8400.fnYeta8400_Tax_Ye161010_File_Check(request,ye161010VO,response) ;
		 
		       	 
		       	 } else if (ye161010VO.getCreFile().equals("Y0090002")) {
		       		 //의료비지급명세서 검증 
		       		rtnResult = yeta8400.fnYeta8400_Tax_Ye164010_File_Check(request,ye161010VO,response) ;
		       	    
		       		
		       	 } else if (ye161010VO.getCreFile().equals("Y0090003")) {
		       		 //기부금지급명세서 검증 
		       		rtnResult = yeta8400.fnYeta8400_Tax_Ye165010_File_Check(request,ye161010VO,  response) ;
