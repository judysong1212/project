 ...
 */
@Controller 
public class Yeta3100AnSeongProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta3100AnSeongProcContainer.class);
...
//
    ...
    public Yeta3100AnSeongProcContainer() {
