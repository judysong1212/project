 ...
 */
@Controller 
public class Yeta4100AnSeongProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta4100AnSeongProcContainer.class);
...
//
    ...
    public Yeta4100AnSeongProcContainer() {
