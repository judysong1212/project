 ...
 */
@Controller 
public class Yeta8300AnSeongProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta8300AnSeongProcContainer.class);
	   
     
	
    public Yeta8300AnSeongProcContainer() {
