...
public class DlgnAnSeongProcessContainer {
	

	private static final Logger logger = LoggerFactory.getLogger(DlgnAnSeongProcessContainer.class);
	   
    @Resource(name = "ManageCommuteService")
    protected ManageCommuteService manageCommuteService;

    public DlgnAnSeongProcessContainer() {
