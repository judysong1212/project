 ...
 */
@Controller 
public class Yeta2300AnSeongProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta2300AnSeongProcContainer.class);
	   
     
	
    public Yeta2300AnSeongProcContainer() {
