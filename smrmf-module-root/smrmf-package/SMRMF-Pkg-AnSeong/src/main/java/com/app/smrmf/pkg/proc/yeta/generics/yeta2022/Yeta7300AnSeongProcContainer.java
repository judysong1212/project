 ...
 */
@Controller 
public class Yeta7300AnSeongProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta7300AnSeongProcContainer.class);
	   
     
	
    public Yeta7300AnSeongProcContainer() {
