 ...
 */
@Controller 
public class Yeta5300AnSeongProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta5300AnSeongProcContainer.class);
	   
     
	
    public Yeta5300AnSeongProcContainer() {
