 ...
 */
@Controller 
public class Yeta6300AnSeongProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta6300AnSeongProcContainer.class);
	   
     
	
    public Yeta6300AnSeongProcContainer() {
