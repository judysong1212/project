 ...
 */
@Controller 
public class Yeta3300AnSeongProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta3300AnSeongProcContainer.class);
	   
     
	
    public Yeta3300AnSeongProcContainer() {
