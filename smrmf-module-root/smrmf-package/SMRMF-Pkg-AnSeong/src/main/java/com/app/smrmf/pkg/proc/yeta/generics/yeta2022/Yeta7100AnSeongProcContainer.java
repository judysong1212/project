 ...
 */
@Controller 
public class Yeta7100AnSeongProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta7100AnSeongProcContainer.class);
...
//
    ...
    public Yeta7100AnSeongProcContainer() {
