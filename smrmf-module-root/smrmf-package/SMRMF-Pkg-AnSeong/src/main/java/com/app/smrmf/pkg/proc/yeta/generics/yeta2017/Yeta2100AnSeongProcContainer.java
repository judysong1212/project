 ...
 */
@Controller 
public class Yeta2100AnSeongProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta2100AnSeongProcContainer.class);
...
//
    ...
    public Yeta2100AnSeongProcContainer() {
