...
//    private Payr0305DAO payr0305DAO;
    ...
    //private EgovIdGnrService egovIdGnrService;
	  ...
	  * 2. 처리내용 : 
	  * </pre>
	  * @Method Name : selectAnSeongPayrInfoList
	  * @date : 2016. 5. 26.
	  ...
	  *	-----------------------------------------------------------------------
	  * 
	  * @see com.app.smrmf.payr.pay.calculation.service.PayCalculationService#selectAnSeongPayrInfoList(com.app.smrmf.infc.payroll.vo.InfcPkgPayr0250VO)
	  * @param vo
	  * @return
	  * @throws Exception
	  */
    public List<PkgPayrCommCalcVO> selectAnSeongPayrInfoList(InfcPkgPayr0250VO vo) throws Exception {
		 
		 return payCalculationDAO.selectAnSeongPayrInfoList(vo);
