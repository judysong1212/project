package com.app.smrmf.pkg.proc.yeta.yearendtax.yeta2022.pdf.xml.web;
...
import com.app.smrmf.pkg.yeta.yeta2022.pdfxml.Yeta7200PkgXmlController;
...
@Controller
public class Yeta7200XmlController {



	private static final Logger logger = LoggerFactory.getLogger(Yeta7200XmlController.class);  
	...
	@RequestMapping(value = "/imp/XmlYeta7200Import.do")
	public String xmlYeta7200Import(@ModelAttribute("InfcPkgYe161010_2022_VO") InfcPkgYe161010_2022_VO ye161010VO, HttpServletRequest request, 
		...
		if  (yeta7200Service == null) { 
			WebApplicationContext wac = WebApplicationContextUtils.
					getRequiredWebApplicationContext( request.getSession().getServletContext());

			yeta7200Service = (InfcPkgYeta7200Service) wac.getBean("InfcPkgYeta7200Service" ); 

		}
		InfcPkgYe161020_2022_VO ye161020VO = new InfcPkgYe161020_2022_VO();
		MSFSysm0100BM sessionUser = MSFServerUtils.getLoggedUser(request);
		Yeta7200PkgXmlController yete320 = new Yeta7200PkgXmlController();
		try	{
						...
						try {
							if (isSuccess) {
								...
								if (v_ret == 1) {
									...
									yeta7200Service.yeta7200_Ye161020_2022_Update(ye161020VO);
...
//									System.out.println("데이터 추출에 실패하였습니다.");
	...
	/** 소득공제 신고서 */
	@RequestMapping(value = "/imp/XmlYeta7200DdcImport.do")
	public String xmlYeta7200DdcImport(@ModelAttribute("InfcPkgYe161010_2022_VO") InfcPkgYe161010_2022_VO ye161010VO, HttpServletRequest request,
			HttpServletResponse response, Model model) throws Exception {
