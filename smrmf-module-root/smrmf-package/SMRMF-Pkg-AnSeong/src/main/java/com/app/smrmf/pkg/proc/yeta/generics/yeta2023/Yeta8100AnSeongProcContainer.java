 ...
 */
@Controller 
public class Yeta8100AnSeongProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta8100AnSeongProcContainer.class);
...
//
    ...
    public Yeta8100AnSeongProcContainer() {
