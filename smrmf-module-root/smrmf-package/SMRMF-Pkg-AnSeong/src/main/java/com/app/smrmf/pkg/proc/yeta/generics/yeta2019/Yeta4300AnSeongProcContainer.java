 ...
 */
@Controller 
public class Yeta4300AnSeongProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta4300AnSeongProcContainer.class);
	   
     
	
    public Yeta4300AnSeongProcContainer() {
