 ...
 */
@Controller 
public class RemtAnSeongProcessContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(RemtAnSeongProcessContainer.class);
    private static final String calledClass = RemtAnSeongProcessContainer.class.getName();
