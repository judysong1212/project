 ...
 */
@Controller 
public class Yeta3100AnDongProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta3100AnDongProcContainer.class);
...
//
    ...
    public Yeta3100AnDongProcContainer() {
