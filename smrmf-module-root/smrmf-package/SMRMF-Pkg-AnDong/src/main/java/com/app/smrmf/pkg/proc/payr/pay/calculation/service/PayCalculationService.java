...
public interface PayCalculationService {
    ...
    void updateYeta2017ToYe161010(InfcPkgYe161010VO    infcPkgYe161010Vo)  throws Exception;
      ...
      */
	   ...
	   * 
	   * <pre>
	   * 1. 개요 : 상여금처리를 위한 일수 가져오기  
	   * 2. 처리내용 : 
	   * </pre>
	   * @Method Name : selectADDlgn0100C9020100
	   * @date : 2017. 7. 12.
	   * @author : atres
	   * @history : 
	   *	-----------------------------------------------------------------------
	   ...
	   * @throws Exception
	   */
	  InfcPkgDlgn0100VO selectADDlgn0100C9020100(InfcPkgDlgn0100VO vo) throws Exception ;
