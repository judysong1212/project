 ...
 */
@Controller 
public class PayrAnDongSubProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(PayrAnDongSubProcContainer.class); 
                          ...
                          //  } 
                            ...
                            //과세대상금액  
              				...
              				if(ExtermsProps.getProps("PAY_CD_01").equals(payCalculationVo.getPayCd())) {
	                               ...
	                               *****************************************************************************************/
	                              BigDecimal sumD0010100 = new BigDecimal(String.valueOf(tempMap.get("sumD0010100")));   //건강보험
	                              BigDecimal sumD0110100 = new BigDecimal(String.valueOf(tempMap.get("sumD0110100")));   //건강요양보험 
	                              BigDecimal sumD0150100 = new BigDecimal(String.valueOf(tempMap.get("sumD0150100")));   //국민연금 
	                              sumReattyD0150100 = new BigDecimal(String.valueOf(tempMap.get("sumReattyD0150100")));  //2016.10.04
	                              BigDecimal sumD0160100 = new BigDecimal(String.valueOf(tempMap.get("sumD0160100")));   //고용보험 
...
//      	                  payr0301Vo.setInptDt(payr0302Vo.getInptDt());    /** column 입력일자 : inptDt */
...
//      	                  payr0301Vo.setRevnDt(payr0302Vo.getRevnDt());    /** column 수정일자 : revnDt */
