 ...
 */
@Controller 
public class Yeta2300AnDongProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta2300AnDongProcContainer.class);
    ...
    public Yeta2300AnDongProcContainer() {
