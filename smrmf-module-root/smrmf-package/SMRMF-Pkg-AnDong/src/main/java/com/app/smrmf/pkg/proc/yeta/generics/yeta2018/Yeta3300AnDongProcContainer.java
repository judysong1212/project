 ...
 */
@Controller 
public class Yeta3300AnDongProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta3300AnDongProcContainer.class);
    ...
    public Yeta3300AnDongProcContainer() {
