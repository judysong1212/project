 ...
 */
@Controller 
public class RemtAnDongProcessContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(RemtAnDongProcessContainer.class);
    private static final String calledClass = RemtAnDongProcessContainer.class.getName();
