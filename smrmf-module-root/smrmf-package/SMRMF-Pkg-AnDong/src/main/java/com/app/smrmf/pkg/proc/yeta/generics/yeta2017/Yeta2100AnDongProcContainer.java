 ...
 */
@Controller 
public class Yeta2100AnDongProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta2100AnDongProcContainer.class);
...
//
    ...
    public Yeta2100AnDongProcContainer() {
