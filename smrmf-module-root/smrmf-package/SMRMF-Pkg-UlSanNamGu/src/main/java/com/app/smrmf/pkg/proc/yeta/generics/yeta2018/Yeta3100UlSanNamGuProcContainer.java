 ...
 */
@Controller 
public class Yeta3100UlSanNamGuProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta3100UlSanNamGuProcContainer.class);
...
//
    ...
    public Yeta3100UlSanNamGuProcContainer() {
