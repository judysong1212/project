 ...
 */
@Controller 
public class Yeta2100UlSanNamGuProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta2100UlSanNamGuProcContainer.class);
...
//
    ...
    public Yeta2100UlSanNamGuProcContainer() {
