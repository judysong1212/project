 ...
 */
@Controller 
public class Yeta2300UlSanNamGuProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta2300UlSanNamGuProcContainer.class);
    ...
    public Yeta2300UlSanNamGuProcContainer() {
