 ...
 */
@Controller 
public class Yeta3300UlSanNamGuProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta3300UlSanNamGuProcContainer.class);
    ...
    public Yeta3300UlSanNamGuProcContainer() {
