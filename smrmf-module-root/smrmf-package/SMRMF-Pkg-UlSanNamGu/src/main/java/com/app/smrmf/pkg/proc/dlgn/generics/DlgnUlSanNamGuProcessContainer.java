...
public class DlgnUlSanNamGuProcessContainer {
	

	private static final Logger logger = LoggerFactory.getLogger(DlgnUlSanNamGuProcessContainer.class);
	   
    @Resource(name = "ManageCommuteService")
    protected ManageCommuteService manageCommuteService;

    public DlgnUlSanNamGuProcessContainer() {
