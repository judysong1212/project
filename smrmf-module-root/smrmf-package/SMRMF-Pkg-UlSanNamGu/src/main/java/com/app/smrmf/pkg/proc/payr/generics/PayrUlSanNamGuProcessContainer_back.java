 ...
 */
@Controller 
public class PayrUlSanNamGuProcessContainer_back  extends AbstractCustomServiceImpl {
	 

	private static final Logger logger = LoggerFactory.getLogger(PayrUlSanNamGuProcessContainer_back.class);
...
//                                                           	   strDducPayr0520.add(payr0410.getPayrImcd());  
               ...
               //                                                       payr0302Vo.setRevnAddr(payr0302Vo.getRevnAddr());    /** column 수정주소 : revnAddr */   
			               ...
			               //                                                  
				                                                              tpPymtTotAmnt = tpPymtTotAmnt.add(payr0410.getUcstSum02().setScale(-1,BigDecimal.ROUND_DOWN));
			                                                                  tpExtpyTotAmnt = tpExtpyTotAmnt.add(payr0410.getUcstSum02().setScale(-1,BigDecimal.ROUND_DOWN));
			               ...
			               //                                                 
				                                                              tpPymtTotAmnt = tpPymtTotAmnt.add(payr0410.getUcstSum().setScale(-1,BigDecimal.ROUND_DOWN));
			                                                                  tpExtpyTotAmnt = tpExtpyTotAmnt.add(payr0410.getUcstSum().setScale(-1,BigDecimal.ROUND_DOWN));
		               ...
		               //                                                   payr0302Vo.setRevnAddr(payr0302Vo.getRevnAddr());    /** column 수정주소 : revnAddr */   
                                                                ...
                                                                // 근속가산금     
                                                                 ...
                                                                 if (MSFSharedUtils.paramNotNull(payr0450Vo) ) {
                                                                     ...
                                                                     payr0302Vo.setPymtDducDivCd(payr0410.getPymtDducDivCd());    /** column 지급공제구분코드 : pymtDducDivCd */ 
                                                                     payr0302Vo.setPymtDducFreeDtySum(payr0410.getFreeDtySum().setScale(-1,BigDecimal.ROUND_DOWN));    /** column 지급공제비과세금액 : pymtDducFreeDtySum */
                                                                     payr0302Vo.setPymtDducSum((payr0450Vo.getPymtDducSum().add(payr0450Vo.getAddPymtDducSum())));   /** column 지급공제금액 : pymtDducSum */
                                                                     payr0302Vo.setPayPymtDducPrcsFlag("N");   /** column 급여지급공제처리플래그 : payPymtDducPrcsFlag */
                                                                     payr0302Vo.setPayReattyAdmntVal("0");    /** column 급여지급공제소급조정값 : payReattyAdmntVal */
              ...
              //                                                       payr0302Vo.setRevnAddr(payr0302Vo.getRevnAddr());    /** column 수정주소 : revnAddr */   
                                                                     ...
                                                                     tpPymtTotAmnt = tpPymtTotAmnt.add((payr0450Vo.getPymtDducSum().add(payr0450Vo.getAddPymtDducSum())).setScale(-1,BigDecimal.ROUND_DOWN));
                                                                     tpExtpyTotAmnt = tpExtpyTotAmnt.add((payr0450Vo.getPymtDducSum().add(payr0450Vo.getAddPymtDducSum())).setScale(-1,BigDecimal.ROUND_DOWN));
                                                                     tpFreeDtyTotAmnt = tpFreeDtyTotAmnt.add(payr0410.getFreeDtySum().setScale(-1,BigDecimal.ROUND_DOWN)); 
                                                                     if (BigDecimal.ZERO.compareTo(payr0302Vo.getPymtDducSum()) < 0)  {     
                                                                  	   payrCommCalcService.insertPayr0302(payr0302Vo); 
                                                                     }
