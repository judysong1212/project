...
import com.app.smrmf.pkg.proc.payr.ulsannamgu.a0020010.PayrA0020010_B0150000CalcProc;
import com.app.smrmf.pkg.proc.payr.ulsannamgu.a0020010.PayrA0020010_B0150001CalcProc;
import com.app.smrmf.pkg.proc.payr.ulsannamgu.a0020010.PayrA0020010_B0150002CalcProc;
import com.app.smrmf.pkg.proc.payr.ulsannamgu.a0020010.PayrA0020010_B0150003CalcProc;
import com.app.smrmf.pkg.proc.payr.ulsannamgu.a0020010.PayrA0020010_B0150004CalcProc;
import com.app.smrmf.pkg.proc.payr.ulsannamgu.a0020010.PayrA0020010_B0150005CalcProc;
import com.app.smrmf.pkg.proc.payr.ulsannamgu.a0020010.PayrA0020010_B0150006CalcProc;
import com.app.smrmf.pkg.proc.payr.ulsannamgu.comm.PayrCommCalcProc;
 ...
 */
@Controller 
public class PayrUlSanNamGuProcessContainer  extends AbstractCustomServiceImpl {
	 

	private static final Logger logger = LoggerFactory.getLogger(PayrUlSanNamGuProcessContainer.class);
                                      ...
                                      ****************************************************************/
                                      ...
                                      pkgPayrAmntVo.setTpFamyExtpySum(BigDecimal.ZERO);  //가족수당 합 
	                               	  ...
	                               	  pkgPayrAmntVo.setTpExtpyTotAmnt(BigDecimal.ZERO);  //extpyTotAmnt 수당총액 
	                                         // pkgPayrAmntVo.setTpTxtnTotAmnt(BigDecimal.ZERO);//txtnTotAmnt 총과세총액  
                                          ...
                                          *  월급여내역 마스터 정보인서트  종료
                                          @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@*/
                                           ...
                                           if (ExtermsProps.getProps("PAY_CD_01").equals(payr0250Vo.getPayCd())) {
                                        	   ...
                                        	   PayrA0020010_B0150000CalcProc callPayrB015000Calc = new PayrA0020010_B0150000CalcProc();
                                        	   ...
                                        	   PayrA0020010_B0150001CalcProc callPayrB015001Calc = new PayrA0020010_B0150001CalcProc();
                                           ...
                                           /**  @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
                                              ...
                                              */ 
                                       	   ...
                                       	   PayrA0020010_B0150002CalcProc callPayrB015002Calc = new PayrA0020010_B0150002CalcProc();
                                           ...
                                           /**  @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
                                              ...
                                              */  
                                              //C9110100  명절휴가비
                                        	  PayrA0020010_B0150003CalcProc callPayrB015003Calc = new PayrA0020010_B0150003CalcProc();
                                            ...
                                            /**@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
                                              ...
                                              */  
                                        	   ...
                                        	   PayrA0020010_B0150004CalcProc callPayrB015004Calc = new PayrA0020010_B0150004CalcProc();
                                           ...
                                           /**  @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
                                              ...
                                              */
                                        	  ...
                                        	  PayrA0020010_B0150005CalcProc callPayrB015005Calc = new PayrA0020010_B0150005CalcProc();
                                           ...
                                           /**  @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
                                              ...
                                              * @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
                                              */
                                        	  PayrA0020010_B0150006CalcProc callPayrB015006Calc = new PayrA0020010_B0150006CalcProc();
        ...
        //                                      payr0301Vo.setRevnAddr(payr0250Vo.getRevnAddr());    /** column 수정주소 : revnAddr */ 
                                                ...
                                                while (iterpayr0530Set.hasNext() ) {
                                                           ...
                                                           if ("Y".equals(payr0530.getFamyAllwPymtYn())) {
                                                        	   if(("B0260030".equals(payr0530.getFamyExtpyDivCd())) && (!PayrServerUtilsUS.getAgeYn(MSFSharedUtils.allowNulls(payr0530.getPayFamyResnRegnNum()).replaceAll("-", ""))) && ("N".equals(payr0306Vo.getDabpnDducYn()))){
                                                           		payr0306Vo.setFamyExtpySum(new BigDecimal("0"));
                                                           	}
                                                           	else if(("B0260045".equals(payr0530.getFamyExtpyDivCd())) && (!PayrServerUtilsUS.getAgeYn(MSFSharedUtils.allowNulls(payr0530.getPayFamyResnRegnNum()).replaceAll("-", ""))) && ("N".equals(payr0306Vo.getDabpnDducYn()))){
                                                           		payr0306Vo.setFamyExtpySum(new BigDecimal("0"));
                                                           	}
                                                           	else if(("B0260060".equals(payr0530.getFamyExtpyDivCd())) && (!PayrServerUtilsUS.getAgeYn(MSFSharedUtils.allowNulls(payr0530.getPayFamyResnRegnNum()).replaceAll("-", ""))) && ("N".equals(payr0306Vo.getDabpnDducYn()))){
                                                           		payr0306Vo.setFamyExtpySum(new BigDecimal("0"));
                                                           	}
                                                           	else{
