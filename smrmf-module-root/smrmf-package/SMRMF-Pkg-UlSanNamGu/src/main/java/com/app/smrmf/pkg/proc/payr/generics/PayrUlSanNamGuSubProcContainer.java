 ...
 */
@Controller 
public class PayrUlSanNamGuSubProcContainer  extends AbstractCustomServiceImpl {
	 

	private static final Logger logger = LoggerFactory.getLogger(PayrUlSanNamGuSubProcContainer.class);
