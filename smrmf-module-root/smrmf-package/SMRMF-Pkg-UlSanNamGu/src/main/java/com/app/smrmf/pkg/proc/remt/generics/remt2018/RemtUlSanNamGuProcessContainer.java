 ...
 */
@Controller 
public class RemtUlSanNamGuProcessContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(RemtUlSanNamGuProcessContainer.class);
    private static final String calledClass = RemtUlSanNamGuProcessContainer.class.getName();
