...
public class DlgnHygnProcessContainer {
	

	private static final Logger logger = LoggerFactory.getLogger(DlgnHygnProcessContainer.class);
	   
    @Resource(name = "ManageCommuteService")
    protected ManageCommuteService manageCommuteService;

    public DlgnHygnProcessContainer() {
