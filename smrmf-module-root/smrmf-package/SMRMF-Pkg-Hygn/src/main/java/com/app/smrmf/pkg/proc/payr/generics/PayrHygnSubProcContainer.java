 ...
 */
@Controller 
public class PayrHygnSubProcContainer  extends AbstractCustomServiceImpl {
	



	private static final Logger logger = LoggerFactory.getLogger(PayrHygnSubProcContainer.class);
