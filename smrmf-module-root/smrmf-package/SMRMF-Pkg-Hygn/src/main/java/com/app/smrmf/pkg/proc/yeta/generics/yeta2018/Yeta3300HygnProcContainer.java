 ...
 */
@Controller 
public class Yeta3300HygnProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta3300HygnProcContainer.class);
    ...
    public Yeta3300HygnProcContainer() {
