 ...
 */
@Controller 
public class PayrHygnProcessContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(PayrHygnProcessContainer.class);
 	...
 	public PagingLoadResult<ShowMessageBM>  setPayr4100ToPayCalcMulti(HttpServletRequest request,InfcPkgPayr0250VO voPayr0250,List<InfcPkgPsnl0100VO> listPsnl0100)  throws Exception  {
      ...
      retval =  new BasePagingLoadResult<ShowMessageBM>(bmResult, 0, bmResult.size()); 
 	  ...
 	  return retval;
	      ...
	      * 2. 처리내용 : 
	      * </pre>
	      * @Method Name : funcPayr4100ToPayrCalc
	      * @date : 2017. 6. 5.
	      * @author : atres
	      * @history : 
	      *	-----------------------------------------------------------------------
  	 ...
  	 private List<ShowMessageBM>  procEmymtDivCd01(HttpServletRequest request,InfcPkgPayr0250VO voPayr0250,InfcPkgPsnl0100VO voPsnl0100,boolean boolInsert)  throws Exception {
	  ...
	  //	  PagingLoadResult<ShowMessageBM> retval = null; 
       ...
       //    DlgnProcessContainer dlgnProcessContainer = new DlgnProcessContainer();
           Map<String, Object> mapPayr = new HashMap<String, Object>();
            ...
            if (MSFSharedUtils.paramNull(voPayr0250.getJobYrMnth()) 
            		|| MSFSharedUtils.paramNull(voPayr0250.getPayrMangDeptCd()) 
            		|| MSFSharedUtils.paramNull(voPayr0250.getPymtDt()) 
            		|| MSFSharedUtils.paramNull(voPayr0250.getRflctnBgnnDt())
            		|| MSFSharedUtils.paramNull(voPayr0250.getRflctnEndDt())) {
            	
            	 bmResult.add(new ShowMessageBM(PropPayGenConfs.PAYGEN_ERROR,"Payr","[급여]에러","스케줄정보","급여스케줄정보 이상!!! 확인요망." )); 
                 
            }
            payr0250Vo.setDpobCd(voPayr0250.getDpobCd());    /** column 사업장코드 : dpobCd */
            payr0250Vo.setJobYrMnth(voPayr0250.getJobYrMnth());    /** column 작업년월 : jobYrMnth */
            payr0250Vo.setPayCd(voPayr0250.getPayCd());    /** column 급여구분코드 : payCd */
            payr0250Vo.setPayScduSeilNum(voPayr0250.getPayScduSeilNum());    /** column 급여스케줄일련번호 : payScduSeilNum */
            payr0250Vo.setPayrMangDeptCd(voPayr0250.getPayrMangDeptCd());    /** column 급여관리부서코드 : payrMangDeptCd */
            
            payr0250Vo.setMangeDeptCd(voPayr0250.getMangeDeptCd());    /** column 관리부서코드  mangeDeptCd */
            
            payr0250Vo.setDeptCd(voPayr0250.getDeptCd());    /** column 부서코드 : deptCd */
            payr0250Vo.setBusinCd(voPayr0250.getBusinCd());    /** column 사업코드 : businCd */
            payr0250Vo.setEmymtDivCd(voPayr0250.getEmymtDivCd());    /** column 고용구분코드 : emymtDivCd */
            payr0250Vo.setPernChrgEmpIdenNum(voPayr0250.getPernChrgEmpIdenNum());    /** column 담당직원번호 : pernChrgEmpIdenNum */
            payr0250Vo.setJobNm(voPayr0250.getJobNm());    /** column 작업명 : jobNm */
            payr0250Vo.setPymtDt(voPayr0250.getPymtDt());    /** column 지급일자 : pymtDt */
            payr0250Vo.setRflctnBgnnDt(voPayr0250.getRflctnBgnnDt());    /** column 반영시작일자 : rflctnBgnnDt */
            payr0250Vo.setRflctnEndDt(voPayr0250.getRflctnEndDt());    /** column 반영종료일자 : rflctnEndDt */
            payr0250Vo.setPayDdlneDt(voPayr0250.getPayDdlneDt());    /** column 급여마감일자 : payDdlneDt */
            payr0250Vo.setGroFlCretnDt(voPayr0250.getGroFlCretnDt());    /** column 지로파일생성일자 : groFlCretnDt */
            payr0250Vo.setKybdr(voPayr0250.getKybdr());    /** column 입력자 : kybdr */
            payr0250Vo.setInptDt(voPayr0250.getInptDt());    /** column 입력일자 : inptDt */
            payr0250Vo.setInptAddr(voPayr0250.getInptAddr());    /** column 입력주소 : inptAddr */
            payr0250Vo.setIsmt(voPayr0250.getIsmt());    /** column 수정자 : ismt */
            payr0250Vo.setRevnDt(voPayr0250.getRevnDt());    /** column 수정일자 : revnDt */
            payr0250Vo.setRevnAddr(voPayr0250.getRevnAddr());    /** column 수정주소 : revnAddr */
            payr0250Vo.setTypOccuCd(voPayr0250.getTypOccuCd());    /** column 직종코드 : typOccuCd */
            //payr0250Vo.setPyspGrdeCd(voPayr0250.getPyspGrdeCd());    /** column 호봉등급코드 : pyspGrdeCd */ 
            payr0250Vo.setDtilOccuInttnCd(voPayr0250.getDtilOccuInttnCd());    /** column 직종세통합코드 : dtilOccuInttnCd */ 
        
            //사용자선택에 따른 부분 추가 20170628 atres 
            payr0250Vo.setSystemkey(voPayr0250.getSystemkey());    /** column systemkey : systemkey */  
...
//                          }
                       ...
                       List<PkgPayrCommCalcVO>  psnlList = payCalculationService.selectPsnlPayrInfoList(payr0250Vo);  
                           ...
                           if ("Y".equals(payCalculationVo.getPayRcptYn())) {
                                  ...
                                  // tpTxtnTotAmnt = BigDecimal.ZERO;             //txtnTotAmnt 과세총액 
                                   ...
                                   tpDducTotAmnt = BigDecimal.ZERO;             //dducTotAmnt  공제총액 
                                     basePymtAmnt =  BigDecimal.ZERO;  //기본급 
									pkgInsrWorkVo.setTpTxtnTotAmnt(BigDecimal.ZERO); //txtnTotAmnt 과세총액 
									pkgInsrWorkVo.setTpHlthInsrPayAmt(BigDecimal.ZERO);          //건강보험
									pkgInsrWorkVo.setTpHlthInsrRcptnPayAmt(BigDecimal.ZERO);     //요양 
									pkgInsrWorkVo.setTpNatPennAmt(BigDecimal.ZERO);              //국민연금
            ...
            //                                  payr0301Vo.setRevnAddr(payr0250Vo.getRevnAddr());    /** column 수정주소 : revnAddr */ 
                                                ...
                                                while (iterpayr0530Set.hasNext() ) {
                                                    ...
                                                    if ("Y".equals(payr0530.getFamyAllwPymtYn())) {
                                                    	if(("B0260030".equals(payr0530.getFamyExtpyDivCd())) && (!PayrServerUtilsHY.getAgeYn(MSFSharedUtils.allowNulls(payr0530.getPayFamyResnRegnNum()).replaceAll("-", ""))) && ("N".equals(payr0306Vo.getDabpnDducYn()))){
                                                    		payr0306Vo.setFamyExtpySum(new BigDecimal("0"));
                                                    	}
                                                    	else if(("B0260045".equals(payr0530.getFamyExtpyDivCd())) && (!PayrServerUtilsHY.getAgeYn(MSFSharedUtils.allowNulls(payr0530.getPayFamyResnRegnNum()).replaceAll("-", ""))) && ("N".equals(payr0306Vo.getDabpnDducYn()))){
                                                    		payr0306Vo.setFamyExtpySum(new BigDecimal("0"));
                                                    	}
                                                    	else if(("B0260060".equals(payr0530.getFamyExtpyDivCd())) && (!PayrServerUtilsHY.getAgeYn(MSFSharedUtils.allowNulls(payr0530.getPayFamyResnRegnNum()).replaceAll("-", ""))) && ("N".equals(payr0306Vo.getDabpnDducYn()))){
                                                    		payr0306Vo.setFamyExtpySum(new BigDecimal("0"));
                                                    	}
                                                    	else{
...
//                                                               }
                                                           ...
                                                           if (ExtermsProps.getProps("PAY_EMYMT_PYMT_19").equals(payr0410.getPayrImcd())) {
                                                            //기본급처리 루틴 근무일수 /실근무일수가 다른경우처리 루틴 추가    
                                                               ...
                                                               payr0302Vo.setPymtDducDivCd(payr0410.getPymtDducDivCd());    /** column 지급공제구분코드 : pymtDducDivCd */ 
                                                               payr0302Vo.setPymtDducFreeDtySum(payr0410.getFreeDtySum());    /** column 지급공제비과세금액 : pymtDducFreeDtySum */
                                                               payr0302Vo.setPymtDducSum((payr0410.getUcstSum().compareTo(BigDecimal.ZERO) > 0 ? payr0410.getUcstSum() : payr0410.getPymtDducSum()));   /** column 지급공제금액 : pymtDducSum */
                                                               payr0302Vo.setPayPymtDducPrcsFlag("N");   /** column 급여지급공제처리플래그 : payPymtDducPrcsFlag */
                                                               payr0302Vo.setPayReattyAdmntVal("0");    /** column 급여지급공제소급조정값 : payReattyAdmntVal */
                                                               payr0302Vo.setPymtDducTxtnAmnt((payr0410.getUcstSum().compareTo(BigDecimal.ZERO) > 0 ? payr0410.getUcstSum() : payr0410.getPymtDducSum()).subtract(payr0410.getFreeDtySum()) );    /** column 지급공제과세금액 : pymtDducTxtnAmnt */ 
            //                                                 payr0302Vo.setKybdr(payr0302Vo.getKybdr());    /** column 입력자 : kybdr */
            //                                                 payr0302Vo.setInptDt(payr0302Vo.getInptDt());    /** column 입력일자 : inptDt */
            //                                                 payr0302Vo.setInptAddr(payr0302Vo.getInptAddr());    /** column 입력주소 : inptAddr */
            //                                                 payr0302Vo.setIsmt(payr0302Vo.getIsmt());    /** column 수정자 : ismt */
            ...
            //                                                 payr0302Vo.setRevnAddr(payr0302Vo.getRevnAddr());    /** column 수정주소 : revnAddr */   
                                                                ...
                                                                if ((new BigDecimal(MSFSharedUtils.defaultNulls(payCalculationVo.getDilnlazAbnceNumDys(),"0"))).compareTo(BigDecimal.ZERO) > 0) {
                                                                	
                                                                	 if ((new BigDecimal(MSFSharedUtils.defaultNulls(payCalculationVo.getDilnlazDutyNumDys(),"0")).compareTo((new BigDecimal(MSFSharedUtils.defaultNulls(payCalculationVo.getDilnlazTotDutyNumDys(),"0"))).add((new BigDecimal(MSFSharedUtils.defaultNulls(payCalculationVo.getDilnlazAbnceNumDys(),"0"))))) > 0)) {
                                                                         
                                                                         mothPayAmt = (payr0410.getUcstSum().compareTo(BigDecimal.ZERO) > 0 ? payr0410.getUcstSum() : payr0410.getPymtDducSum());
                                                                        
                                                                        // dayPayAmt =  (mothPayAmt.divide((new BigDecimal(MSFSharedUtils.defaultNulls(payCalculationVo.getDilnlazDutyNumDys(),"0"))),3)).setScale(-1, 1);
                                                                        // dayPaySum = dayPayAmt.multiply((new BigDecimal(MSFSharedUtils.defaultNulls(payCalculationVo.getDilnlazTotDutyNumDys(),"0")).add(new BigDecimal(MSFSharedUtils.defaultNulls(payCalculationVo.getDilnlazAbnceDutyRcgtnDys(),"0")))));
                                                                      
                                                                         dayPaySum = (mothPayAmt.divide((new BigDecimal(MSFSharedUtils.defaultNulls(payCalculationVo.getDilnlazDutyNumDys(),"0"))),3, BigDecimal.ROUND_UP))
                                                                        		 .multiply((new BigDecimal(MSFSharedUtils.defaultNulls(payCalculationVo.getDilnlazTotDutyNumDys(),"0")).add(new BigDecimal(MSFSharedUtils.defaultNulls(payCalculationVo.getDilnlazAbnceDutyRcgtnDys(),"0")))
                                                                        				 .add((new BigDecimal(MSFSharedUtils.defaultNulls(payCalculationVo.getDilnlazAbnceNumDys(),"0")))))).setScale(-1, 1);
                                                                         
                                                                     }  else  if ((new BigDecimal(MSFSharedUtils.defaultNulls(payCalculationVo.getDilnlazDutyNumDys(),"0")).compareTo((new BigDecimal(MSFSharedUtils.defaultNulls(payCalculationVo.getDilnlazTotDutyNumDys(),"0"))).add((new BigDecimal(MSFSharedUtils.defaultNulls(payCalculationVo.getDilnlazAbnceNumDys(),"0"))))) == 0)) {
	                                                               ...
	                                                               //  payCalculationVo.getDilnlazAbnceNumDys()   /** column 근태_결근일수 : dilnlazAbnceNumDys */
	                                                                abnceNumDysAmt = (new BigDecimal(MSFSharedUtils.defaultNulls(payCalculationVo.getDilnlazAbnceNumDys(),"0")))
                                                                	  ...
                                                                	  if ((new BigDecimal(MSFSharedUtils.defaultNulls(payCalculationVo.getDilnlazDutyNumDys(),"0")).compareTo((new BigDecimal(MSFSharedUtils.defaultNulls(payCalculationVo.getDilnlazTotDutyNumDys(),"0")))) > 0)) {
                                                                         ...
                                                                         // dayPaySum = dayPayAmt.multiply((new BigDecimal(MSFSharedUtils.defaultNulls(payCalculationVo.getDilnlazTotDutyNumDys(),"0")).add(new BigDecimal(MSFSharedUtils.defaultNulls(payCalculationVo.getDilnlazAbnceDutyRcgtnDys(),"0")))));
                                                                          ...
                                                                          dayPaySum = (mothPayAmt.divide((new BigDecimal(MSFSharedUtils.defaultNulls(payCalculationVo.getDilnlazDutyNumDys(),"0"))),3, BigDecimal.ROUND_UP))
                                                                        		  .multiply((new BigDecimal(MSFSharedUtils.defaultNulls(payCalculationVo.getDilnlazTotDutyNumDys(),"0")).add(new BigDecimal(MSFSharedUtils.defaultNulls(payCalculationVo.getDilnlazAbnceDutyRcgtnDys(),"0"))))).setScale(-1, 1);
                                                               ...
                                                               // tpExtpyTotAmnt = tpExtpyTotAmnt.add(tpFamyExtpySum);
                                                                ...
                                                                //결근은 가족수당을 제외하지 않음.
                                                                	  if ((new BigDecimal(MSFSharedUtils.defaultNulls(payCalculationVo.getDilnlazDutyNumDys(),"0")).compareTo((new BigDecimal(MSFSharedUtils.defaultNulls(payCalculationVo.getDilnlazTotDutyNumDys(),"0"))).add((new BigDecimal(MSFSharedUtils.defaultNulls(payCalculationVo.getDilnlazAbnceNumDys(),"0"))))) > 0)) {
		                                                               		...
		                                                               		dayFmyPayAmt = (tpFamyExtpySum.divide((new BigDecimal(MSFSharedUtils.defaultNulls(payCalculationVo.getDilnlazDutyNumDys(),"0"))),3, BigDecimal.ROUND_UP)) 
		                                                               				.multiply((new BigDecimal(MSFSharedUtils.defaultNulls(payCalculationVo.getDilnlazTotDutyNumDys(),"0"))
		                                                               				.add(new BigDecimal(MSFSharedUtils.defaultNulls(payCalculationVo.getDilnlazAbnceDutyRcgtnDys(),"0"))).add((new BigDecimal(MSFSharedUtils.defaultNulls(payCalculationVo.getDilnlazAbnceNumDys(),"0")))))).setScale(-1, 1);
		                                                               		...
		                                                               		if (tpFamyFreeExtpySum.compareTo(BigDecimal.ZERO) > 0) { 
		                                                               			...
		                                                               			dayFreeFmyPayAmt = (tpFamyFreeExtpySum.divide((new BigDecimal(MSFSharedUtils.defaultNulls(payCalculationVo.getDilnlazDutyNumDys(),"0"))),3, BigDecimal.ROUND_UP))
		                                                               					            .multiply((new BigDecimal(MSFSharedUtils.defaultNulls(payCalculationVo.getDilnlazTotDutyNumDys(),"0"))
		                                                               					            .add(new BigDecimal(MSFSharedUtils.defaultNulls(payCalculationVo.getDilnlazAbnceDutyRcgtnDys(),"0"))).add((new BigDecimal(MSFSharedUtils.defaultNulls(payCalculationVo.getDilnlazAbnceNumDys(),"0")))))).setScale(-1, 1);
		                                                              ...
		                                                              if ((new BigDecimal(MSFSharedUtils.defaultNulls(payCalculationVo.getDilnlazDutyNumDys(),"0")).compareTo((new BigDecimal(MSFSharedUtils.defaultNulls(payCalculationVo.getDilnlazTotDutyNumDys(),"0")))) > 0)) {
		                                                               		if (tpFamyExtpySum.compareTo(BigDecimal.ZERO) > 0) { 
		                                                               			...
		                                                               			dayFmyPayAmt = (tpFamyExtpySum.divide((new BigDecimal(MSFSharedUtils.defaultNulls(payCalculationVo.getDilnlazDutyNumDys(),"0"))),3, BigDecimal.ROUND_UP))
		                                                               					         .multiply((new BigDecimal(MSFSharedUtils.defaultNulls(payCalculationVo.getDilnlazTotDutyNumDys(),"0"))
		                                                               					         .add(new BigDecimal(MSFSharedUtils.defaultNulls(payCalculationVo.getDilnlazAbnceDutyRcgtnDys(),"0"))))).setScale(-1, 1);
            ...
            //                                                   payr0302Vo.setRevnAddr(payr0302Vo.getRevnAddr());    /** column 수정주소 : revnAddr */   
                                                             ...
                                                             //직책별 수당  
                                                               ...
                                                               if (MSFSharedUtils.paramNotNull(payr0460Vo)) {
                                                                   ...
                                                                   payr0302Vo.setPymtDducDivCd(payr0410.getPymtDducDivCd());    /** column 지급공제구분코드 : pymtDducDivCd */ 
                                                                   payr0302Vo.setPymtDducFreeDtySum(payr0410.getFreeDtySum());    /** column 지급공제비과세금액 : pymtDducFreeDtySum */
                                                                   payr0302Vo.setPymtDducSum(payr0460Vo.getOdtyDtilOccuClsSum());   /** column 지급공제금액 : pymtDducSum */
                                                                   payr0302Vo.setPayPymtDducPrcsFlag("N");   /** column 급여지급공제처리플래그 : payPymtDducPrcsFlag */
                                                                   payr0302Vo.setPayReattyAdmntVal("0");    /** column 급여지급공제소급조정값 : payReattyAdmntVal */
            ...
            //                                                       payr0302Vo.setRevnAddr(payr0302Vo.getRevnAddr());    /** column 수정주소 : revnAddr */   
                                                           ...
                                                           } else if (ExtermsProps.getProps("PYMT_ITEM_10").equals(payr0410.getPayrImcd())) {
                                                          	   /***********************************************************************/
                                                          	   /* 환경미화원    70100010A0060000' = AA.DTIL_OCCU_INTTN_CD   */
                                                          	   /************************************************************************/
                                                          	   //반장수당 
                                                                   if ("70100010A0060000".equals(payCalculationVo.getDtilOccuInttnCd()) && "A0150003".equals(payCalculationVo.getOdtyCd())) {
            ...
            //                                                   payr0302Vo.setRevnAddr(payr0302Vo.getRevnAddr());    /** column 수정주소 : revnAddr */   
                                                             ...
                                                             //정근수당
                                                        	   //정근수당 -호봉제 
                                                           	   ...
                                                           	   payr0450Vo.setDtilOccuInttnCd(payCalculationVo.getDtilOccuInttnCd());
                                                           	   ...
                                                           	   if (MSFSharedUtils.paramNotNull(payr0450Vo)) {  
                                                        		   ...
                                                        		   //상여금인경우 처리를 위한 로직수정 작업  
                                                        		   baseBnusAmnt = payr0410.getMnthUsalyAmntAllwBnusSum();
                                                        		   ...
                                                        		   totTmSum = baseBnusAmnt.multiply((ucstSumRto.divide(new BigDecimal("100")))).setScale(-1,BigDecimal.ROUND_DOWN);   
        	                                                           ...
        	                                                           payr0302Vo.setPayPymtDducPrcsFlag("N");   /** column 급여지급공제처리플래그 : payPymtDducPrcsFlag */
        	                                                           payr0302Vo.setPayReattyAdmntVal("0");    /** column 급여지급공제소급조정값 : payReattyAdmntVal */
        	                                                           payr0302Vo.setPymtDducTxtnAmnt((totTmSum.subtract(payr0410.getFreeDtySum())).setScale(-1,BigDecimal.ROUND_DOWN) );    /** column 지급공제과세금액 : pymtDducTxtnAmnt */ 
        	        //                                                   payr0302Vo.setKybdr(payr0302Vo.getKybdr());    /** column 입력자 : kybdr */
        	        //                                                   payr0302Vo.setInptDt(payr0302Vo.getInptDt());    /** column 입력일자 : inptDt */
        	        //                                                   payr0302Vo.setInptAddr(payr0302Vo.getInptAddr());    /** column 입력주소 : inptAddr */
        	        //                                                   payr0302Vo.setIsmt(payr0302Vo.getIsmt());    /** column 수정자 : ismt */
            ...
            //                                                   payr0302Vo.setRevnAddr(payr0302Vo.getRevnAddr());    /** column 수정주소 : revnAddr */   
                                                               ...
                                                               //"C9020100"  --  기말수당
                                                                 ...
                                                                 payr0302Vo.setPymtDducDivCd(payr0410.getPymtDducDivCd());    /** column 지급공제구분코드 : pymtDducDivCd */ 
                                                                 payr0302Vo.setPymtDducFreeDtySum(payr0410.getFreeDtySum().setScale(-1,BigDecimal.ROUND_DOWN));    /** column 지급공제비과세금액 : pymtDducFreeDtySum */
                                                                 payr0302Vo.setPymtDducSum(payr0410.getMnthUsalyAmntAllwBnusSum());   /** column 지급공제금액 : pymtDducSum */
                                                                 payr0302Vo.setPayPymtDducPrcsFlag("N");   /** column 급여지급공제처리플래그 : payPymtDducPrcsFlag */
                                                                 payr0302Vo.setPayReattyAdmntVal("0");    /** column 급여지급공제소급조정값 : payReattyAdmntVal */
                                                                 payr0302Vo.setPymtDducTxtnAmnt(payr0410.getMnthUsalyAmntAllwBnusSum().subtract(payr0410.getFreeDtySum()).setScale(-1,BigDecimal.ROUND_DOWN) );    /** column 지급공제과세금액 : pymtDducTxtnAmnt */ 
              //                                                   payr0302Vo.setKybdr(payr0302Vo.getKybdr());    /** column 입력자 : kybdr */
              //                                                   payr0302Vo.setInptDt(payr0302Vo.getInptDt());    /** column 입력일자 : inptDt */
              //                                                   payr0302Vo.setInptAddr(payr0302Vo.getInptAddr());    /** column 입력주소 : inptAddr */
              //                                                   payr0302Vo.setIsmt(payr0302Vo.getIsmt());    /** column 수정자 : ismt */
              ...
              //                                                   payr0302Vo.setRevnAddr(payr0302Vo.getRevnAddr());    /** column 수정주소 : revnAddr */   
                                                                ...
                                                                // InfcPkgPayr0302VO tpPayr0302vo = new InfcPkgPayr0302VO();
                                                                 ...
                                                                 if ("00100025A0060000".equals(payCalculationVo.getDtilOccuInttnCd())
                                                                  		  || "00100026A0060000".equals(payCalculationVo.getDtilOccuInttnCd())
                                                                  		 || "00100027A0060000".equals(payCalculationVo.getDtilOccuInttnCd())
                                                                  		 || "00100028A0060000".equals(payCalculationVo.getDtilOccuInttnCd())) {    
                                                                	     
                                                                	      BigDecimal ucstSum =  BigDecimal.ZERO;
                                                           	    	       ucstSum =  basePymtAmnt; // payr0410.getUcstSum().compareTo(BigDecimal.ZERO) > 0 ? payr0410.getUcstSum() : payr0410.getPymtDducSum();
                                                                         
                                                                           if (payr0250Vo.getJobYrMnth().substring(4,6).equals("12")) { 
                                                                           	 ucstSum = basePymtAmnt;  //  payr0410.getUcstSum().compareTo(BigDecimal.ZERO) > 0 ? payr0410.getUcstSum() : payr0410.getPymtDducSum();
                                                                           } 
                                                                           
                                                                           edPymtAmnt = (ucstSum.multiply((payr0410.getPymtDducRate().divide(new BigDecimal("100"))))).setScale(-1,BigDecimal.ROUND_DOWN) ;
                                                                           
                                                           	     } else {
                                                           	    	 
                                                           	    	 edPymtAmnt = (payr0410.getMnthUsalyAmntAllwBnusSum().multiply((payr0410.getPymtDducRate().divide(new BigDecimal("100"))))).setScale(-1,BigDecimal.ROUND_DOWN) ;
                                                           ...
                                                           } else if (ExtermsProps.getProps("PAY_EMYMT_PYMT_42").equals(payr0410.getPayrImcd())) {
                                                               /*****************************************************************************/
                                                   		   /* public static final String PAY_EMYMT_PYMT_42 = "C9010010";    //   	상여금   */
                                                   		   /*****************************************************************************/
                                                                 ...
                                                                 payr0302Vo.setPymtDducDivCd(payr0410.getPymtDducDivCd());    /** column 지급공제구분코드 : pymtDducDivCd */ 
                                                                 payr0302Vo.setPymtDducFreeDtySum(payr0410.getFreeDtySum().setScale(-1,BigDecimal.ROUND_DOWN));    /** column 지급공제비과세금액 : pymtDducFreeDtySum */
                                                                 payr0302Vo.setPymtDducSum(basePymtAmnt.setScale(-1,BigDecimal.ROUND_DOWN));   /** column 지급공제금액 : pymtDducSum */
                                                                 payr0302Vo.setPayPymtDducPrcsFlag("N");   /** column 급여지급공제처리플래그 : payPymtDducPrcsFlag */
                                                                 payr0302Vo.setPayReattyAdmntVal("0");    /** column 급여지급공제소급조정값 : payReattyAdmntVal */
              ...
              //                                                   payr0302Vo.setRevnAddr(payr0302Vo.getRevnAddr());    /** column 수정주소 : revnAddr */   
                                                                  //정확한 기말 수당을 구하기 위한 로직 구현부 여기에 추가한다.  
                                                                 /* C0020110일자리센터안내원	N							00100024A0060000   TODO 나중에 확인 해야 함 
                                                        	     C0020000예방접종관리원	N							00100025A0060000
                                                        	     C0025020의료급여관리원	N							00100026A0060000
                                                        	     C0025030통합사례관리원	N							00100027A0060000
                                                        	     C0020000보건요원	N							00100028A0060000   */
                                                                 if ("00100026A0060000".equals(payCalculationVo.getDtilOccuInttnCd()) ) {    
                                                        	   ...
                                                        	   if ( (payr0410.getUsalyAmntHrwgQnty().compareTo(BigDecimal.ZERO) > 0) ||
                                                        			   ((payr0410.getUcstSum().compareTo(BigDecimal.ZERO) > 0 ? payr0410.getUcstSum() : payr0410.getPymtDducSum()).compareTo(BigDecimal.ZERO) > 0)) { 
	                                                               /** 각수당별로 처리하는 로직을구현한다. */
	                                                               payr0302Vo.setDpobCd(payr0410.getDpobCd());    /** column 사업장코드 : dpobCd */
	                                                               payr0302Vo.setPymtYrMnth(payr0250Vo.getJobYrMnth()) ;   /** column 지급년월 : pymtYrMnth */
	                                                               payr0302Vo.setPayCd(payr0410.getPayCd());    /** column 급여구분코드 : payCd */
	            ...
	            //                                                 payr0302Vo.setRevnAddr(payr0302Vo.getRevnAddr());    /** column 수정주소 : revnAddr */   
	                                                                 ...
	                                                                 // if ((payr0410.getUcstSum().compareTo(BigDecimal.ZERO) > 0 ? payr0410.getUcstSum() : payr0410.getPymtDducSum()).compareTo(BigDecimal.ZERO) > 0) {
	                                                                      if (ExtermsProps.getProps("PAY_EMYMT_PYMT_07").equals(payr0410.getPayrImcd())) {
	                                                                          ...
	                                                                          if (new BigDecimal(MSFSharedUtils.defaultNulls(payCalculationVo.getDilnlazTotTmRstDutyTm(),"0")).compareTo(BigDecimal.ZERO) > 0) {
	                                                                                //시간외근무 
	                                                                        	  BigDecimal ucstSum =  BigDecimal.ZERO; 
                                                                                  ucstSum = (payr0410.getUsalyAmntHrwgQnty().multiply(new BigDecimal("1.5"))).setScale(-1,BigDecimal.ROUND_DOWN);  //payr0410.getBefUcstSum().compareTo(BigDecimal.ZERO) > 0 ? payr0410.getBefUcstSum() : (payr0410.getUcstSum().compareTo(BigDecimal.ZERO) > 0 ? payr0410.getUcstSum() : payr0410.getPymtDducSum());
                                                                              
                                                                                if (payr0250Vo.getJobYrMnth().substring(4,6).equals("12")) { 
                                                                              	  ucstSum =  (payr0410.getUsalyAmntHrwgQnty().multiply(new BigDecimal("1.5"))).setScale(-1,BigDecimal.ROUND_DOWN);   //payr0410.getUcstSum().compareTo(BigDecimal.ZERO) > 0 ? payr0410.getUcstSum() : payr0410.getPymtDducSum();
                                                                                } 
	                                                                                ...
	                                                                                //	  ucstSum = payr0410.getUcstSum().compareTo(BigDecimal.ZERO) > 0 ? payr0410.getUcstSum() : payr0410.getPymtDducSum();
	                                                                                 // } 
	                                                                                  ...
	                                                                                  totTmSum = (new BigDecimal(MSFSharedUtils.defaultNulls(payCalculationVo.getDilnlazTotTmRstDutyTm(),"0"))).multiply(ucstSum);  //시간외근무
	                                                                        ...
	                                                                        // 토요근무수당   --일수산정C9410700
	                                                                         ...
	                                                                         if (new BigDecimal(MSFSharedUtils.defaultNulls(payCalculationVo.getDilnlazSatDutyNumDys(),"0")).compareTo(BigDecimal.ZERO) > 0) {
...
//                                                                                  } 
                                                                                ...
                                                                                if (payr0250Vo.getJobYrMnth().substring(4,6).equals("12")) { 
	                                                                              ...
	                                                                              totTmSum = (new BigDecimal(MSFSharedUtils.defaultNulls(payCalculationVo.getDilnlazSatDutyNumDys(),"0"))).multiply(ucstSum);  //토요근무수당 
...
//                                                                                  } 
	                                                                        	  ...
	                                                                        	  BigDecimal ucstSumSub =  BigDecimal.ZERO; 
	                                                                        	  ucstSumSub = (payr0410.getUsalyAmntHrwgQnty().multiply(new BigDecimal("0.5"))).setScale(-1,BigDecimal.ROUND_DOWN);  //payr0410.getBefUcstSum().compareTo(BigDecimal.ZERO) > 0 ? payr0410.getBefUcstSum() : (payr0410.getUcstSum().compareTo(BigDecimal.ZERO) > 0 ? payr0410.getUcstSum() : payr0410.getPymtDducSum());
                                                                              
                                                                                if (payr0250Vo.getJobYrMnth().substring(4,6).equals("12")) { 
                                                                                	ucstSumSub =  (payr0410.getUsalyAmntHrwgQnty().multiply(new BigDecimal("0.5"))).setScale(-1,BigDecimal.ROUND_DOWN);   //payr0410.getUcstSum().compareTo(BigDecimal.ZERO) > 0 ? payr0410.getUcstSum() : payr0410.getPymtDducSum();
                                                                                } 
                                                                                
                                                                                  ucstSum = ucstSum.add(ucstSumSub);
	                                                                              BigDecimal totTmSum = BigDecimal.ZERO;
	                                                                              
	                                                                              totTmSum = (new BigDecimal(MSFSharedUtils.defaultNulls(payCalculationVo.getDilnlazTotNtotTm(),"0"))).multiply(ucstSum);  //시간외근무
...
//	                                                                                  } 
	                                                                                ...
	                                                                                if (payr0250Vo.getJobYrMnth().substring(4,6).equals("12")) { 
	                                                                                  ...
	                                                                                  totTmSum = (new BigDecimal(MSFSharedUtils.defaultNulls(payCalculationVo.getDilnlazPubcHodyDutyNumDys(),"0"))).multiply(ucstSum);  //토요근무수당 
	                                                                          ...
	                                                                          if (new BigDecimal(MSFSharedUtils.defaultNulls(payCalculationVo.getDilnlazPaidPubcHodyNum(),"0")).compareTo(BigDecimal.ZERO) > 0) {
...
//                                                                                  }
	                                                                              ...
	                                                                              totTmSum = (new BigDecimal(MSFSharedUtils.defaultNulls(payCalculationVo.getDilnlazPaidPubcHodyNum(),"0"))).multiply(ucstSum);  //토요근무수당 
	                                                                            ...
	                                                                            //PAY_EMYMT_PYMT_18 = "C9080100";    // 정액급식비
                                                                                  ...
                                                                                  if ((new BigDecimal(MSFSharedUtils.defaultNulls(payCalculationVo.getDilnlazAbnceNumDys(),"0"))).compareTo(BigDecimal.ZERO) > 0) {
                                                                                	  ...
                                                                                	  if ((new BigDecimal(MSFSharedUtils.defaultNulls(payCalculationVo.getDilnlazDutyNumDys(),"0")).compareTo((new BigDecimal(MSFSharedUtils.defaultNulls(payCalculationVo.getDilnlazTotDutyNumDys(),"0"))).add((new BigDecimal(MSFSharedUtils.defaultNulls(payCalculationVo.getDilnlazAbnceNumDys(),"0"))))) > 0)) {
	                                                                                	   ...
	                                                                                	   dayPaySum = (ucstSum.divide((new BigDecimal(MSFSharedUtils.defaultNulls(payCalculationVo.getDilnlazDutyNumDys(),"0"))),3, BigDecimal.ROUND_UP))
	                                                                                			     .multiply((new BigDecimal(MSFSharedUtils.defaultNulls(payCalculationVo.getDilnlazTotDutyNumDys(),"0")).add(new BigDecimal(MSFSharedUtils.defaultNulls(payCalculationVo.getDilnlazAbnceDutyRcgtnDys(),"0")))
	                                                                                			    		 .add((new BigDecimal(MSFSharedUtils.defaultNulls(payCalculationVo.getDilnlazAbnceNumDys(),"0")))))).setScale(-1, 1);
	                                                                                  ...
	                                                                                  if ((new BigDecimal(MSFSharedUtils.defaultNulls(payCalculationVo.getDilnlazDutyNumDys(),"0")).compareTo((new BigDecimal(MSFSharedUtils.defaultNulls(payCalculationVo.getDilnlazTotDutyNumDys(),"0")))) > 0)) {
	                                                                                	   ...
	                                                                                	   dayPaySum = (ucstSum.divide((new BigDecimal(MSFSharedUtils.defaultNulls(payCalculationVo.getDilnlazDutyNumDys(),"0"))),3, BigDecimal.ROUND_UP)).multiply((new BigDecimal(MSFSharedUtils.defaultNulls(payCalculationVo.getDilnlazTotDutyNumDys(),"0"))
	                                                                                	   .add(new BigDecimal(MSFSharedUtils.defaultNulls(payCalculationVo.getDilnlazAbnceDutyRcgtnDys(),"0"))))).setScale(-1, 1);
	                                                                      ...
	                                                                      } else  if (ExtermsProps.getProps("PAY_EMYMT_PYMT_15").equals(payr0410.getPayrImcd())) {
	                                                                          // PAY_EMYMT_PYMT_15 = "C9990200";    // 출장여비 
	                                                                 	  
	                                                                           BigDecimal ucstSum =   payr0410.getUcstSum().compareTo(BigDecimal.ZERO) > 0 ? payr0410.getUcstSum() : payr0410.getPymtDducSum();
	                                                                           BigDecimal totTmSum = BigDecimal.ZERO;
	                                                                       
	                                                                           totTmSum = ucstSum.setScale(-1, BigDecimal.ROUND_DOWN);  //출장여비 
	                                                                          ...
	                                                                          if (new BigDecimal(MSFSharedUtils.defaultNulls(payCalculationVo.getDilnlazLvsgNumDys(),"0")).compareTo(BigDecimal.ZERO) > 0) {
	                                                                             ...
	                                                                             // BigDecimal ucstSum =   payr0410.getUcstSum().compareTo(BigDecimal.ZERO) > 0 ? payr0410.getUcstSum() : payr0410.getPymtDducSum();
	                                                                              ...
	                                                                              totTmSum = ((new BigDecimal(MSFSharedUtils.defaultNulls(payCalculationVo.getDilnlazLvsgNumDys(),"0"))).multiply(ucstSum)).setScale(-1, BigDecimal.ROUND_DOWN);  //토요근무수당 
	                                                                      ...
	                                                                      } else  if (ExtermsProps.getProps("PAY_EMYMT_PYMT_27").equals(payr0410.getPayrImcd())) {
	                                                                          // 체력단련비   -- 일수 산정 C9040100
	                                                                    	   		BigDecimal ucstSum =  BigDecimal.ZERO;
	                                                                    	   	  if ( "70100010A0060000".equals(payCalculationVo.getDtilOccuInttnCd())) {    

	                                                                        		//환경미화원  
	 		                                                                                ucstSum = payr0410.getMnthUsalyAmntWag();//payr0410.getBefUcstSum().compareTo(BigDecimal.ZERO) > 0 ? payr0410.getBefUcstSum() : (payr0410.getUcstSum().compareTo(BigDecimal.ZERO) > 0 ? payr0410.getUcstSum() : payr0410.getPymtDducSum());
	 		                                                                              if (payr0250Vo.getJobYrMnth().substring(4,6).equals("12")) { 
	 		                                                                            	  ucstSum = payr0410.getMnthUsalyAmntWag();//payr0410.getUcstSum().compareTo(BigDecimal.ZERO) > 0 ? payr0410.getUcstSum() : payr0410.getPymtDducSum();
	 		                                                                              } 
	                                                                              ...
	                                                                              totTmSum =  (ucstSum.multiply(payr0410.getPymtDducRate().divide(new BigDecimal("100")))).setScale(-1,BigDecimal.ROUND_DOWN);  //토요근무수당 
	                                                                      ...
	                                                                      } else  if (ExtermsProps.getProps("PAY_EMYMT_PYMT_39").equals(payr0410.getPayrImcd())) {
	                                                                            // C9070500	직무수당	
	                                                                      ...
	                                                                      } else  if (ExtermsProps.getProps("PAY_EMYMT_PYMT_08").equals(payr0410.getPayrImcd())) {
	                                                                    	   //  PAY_EMYMT_PYMT_08 = "C9410500";    // 주휴수당       --일수산정
	                                                                   	   
	                                                                             BigDecimal ucstSum =   payr0410.getUcstSum().compareTo(BigDecimal.ZERO) > 0 ? payr0410.getUcstSum() : payr0410.getPymtDducSum();
	                                                                             BigDecimal totTmSum = BigDecimal.ZERO;
	                                                                         
	                                                                             // 주휴수당       --일수산정
		                                                                          if ( ExtermsProps.getProps("PAY_EMYMT_DYMNTH_01").equals(payr0410.getDayMnthAmntDivCd()) 
		                                                                                  && (new BigDecimal(MSFSharedUtils.defaultNulls(payCalculationVo.getDilnlazWklyHldyNumDys(),"0")).compareTo(BigDecimal.ZERO) > 0)) {
		                                                                              
		                                                                        	  totTmSum = (new BigDecimal(payCalculationVo.getDilnlazWklyHldyNumDys()).multiply(ucstSum)).setScale(-1,BigDecimal.ROUND_DOWN); 
		                                                                          ...
		                                                                          } else  if ((ExtermsProps.getProps("PAY_EMYMT_DYMNTH_04").equals(payr0410.getDayMnthAmntDivCd())) 
		                                                                                  && (new BigDecimal(MSFSharedUtils.defaultNulls(payCalculationVo.getDilnlazWklyHldyNumDys(),"0")).compareTo(BigDecimal.ZERO) > 0)) {
	                                                                      ...
	                                                                      } else  if (ExtermsProps.getProps("PAY_EMYMT_PYMT_44").equals(payr0410.getPayrImcd())) {
	                                                                    	   //  PAY_EMYMT_PYMT_44 = "C9999700";   //자격(증)수당
                                             ...
                                             *   
                                             ================================================================================================*/
                                               ...
                                               while ( iterpayr0410SetDDuc.hasNext() ) { 
                                                    ...
                                                    //해당년월에 체크되어 있는경우 값을 처리한다. 
                                                    //if ("Y".equals(chkMonth)) {
                                                     if (PayrPkgUtil.funcMonthCheck(payr0250Vo, payr0410,null)) {
...
//                                                            		B017	0020	비율
	                                                               ...
	                                                               basePymtAmnt = BigDecimal.ZERO;
	                                                               basePymtAmnt = tpPymtTotAmnt;
                        ...
                        //                                                 payr0302Vo.setRevnAddr(payr0302Vo.getRevnAddr());    /** column 수정주소 : revnAddr */    
                                                                       ...
                                                                       //    if ((new BigDecimal(MSFSharedUtils.defaultNulls(payCalculationVo.getDilnlazDutyNumDys(),"0")).compareTo((new BigDecimal(MSFSharedUtils.defaultNulls(payCalculationVo.getDilnlazTotDutyNumDys(),"0")))) > 0)) {
                                                                             if ((new BigDecimal(MSFSharedUtils.defaultNulls(payCalculationVo.getDilnlazAbnceNumDys(),"0"))).compareTo(BigDecimal.ZERO) > 0) {
             	                                                                //결근이 존재하는 경우 결근 빼기 
                                                                            	 mothPayAmt = (payr0410.getUcstSum().compareTo(BigDecimal.ZERO) > 0 ? payr0410.getUcstSum() : payr0410.getPymtDducSum());
                                                                                 //dayPayAmt =  mothPayAmt.divide((new BigDecimal(MSFSharedUtils.defaultNulls(payCalculationVo.getDilnlazDutyNumDys(),"0")))).setScale(-1, 1);
                                                                                 //dayPaySum = dayPayAmt.multiply((new BigDecimal(MSFSharedUtils.defaultNulls(payCalculationVo.getDilnlazTotDutyNumDys(),"0"))));
                                                                                 dayPaySum = (mothPayAmt.divide((new BigDecimal(MSFSharedUtils.defaultNulls(payCalculationVo.getDilnlazDutyNumDys(),"0"))),3, BigDecimal.ROUND_UP))
                                                                                		 .multiply((new BigDecimal(MSFSharedUtils.defaultNulls(payCalculationVo.getDilnlazTotDutyNumDys(),"0")).add(new BigDecimal(MSFSharedUtils.defaultNulls(payCalculationVo.getDilnlazAbnceDutyRcgtnDys(),"0")))
                                                                                				 .add((new BigDecimal(MSFSharedUtils.defaultNulls(payCalculationVo.getDilnlazAbnceNumDys(),"0")))))).setScale(-1, 1);
             	                                                               //  payCalculationVo.getDilnlazAbnceNumDys()   /** column 근태_결근일수 : dilnlazAbnceNumDys */
...
//                                                          //  } 
   ...
   //                                                   payr0302Vo.setRevnAddr(payr0302Vo.getRevnAddr());    /** column 수정주소 : revnAddr */   
                                                      ...
                                                      if (new BigDecimal(MSFSharedUtils.defaultNulls(payCalculationVo.getDilnlazLvsgNumDys(),"0")).compareTo(BigDecimal.ZERO) > 0) {
                                                          ...
                                                          totTmSum = ((new BigDecimal(MSFSharedUtils.defaultNulls(payCalculationVo.getDilnlazLvsgNumDys(),"0"))).multiply(ucstSum)).setScale(-1, BigDecimal.ROUND_DOWN);  //연가보상비 
        ...
        //                                  payr0301Vo.setRevnAddr(payr0250Vo.getRevnAddr());    /** column 수정주소 : revnAddr */ 
	      ...
	      * @throws Exception
	      */ 
  	private List<ShowMessageBM> procEmymtDivCd02(HttpServletRequest request,InfcPkgPayr0250VO voPayr0250,InfcPkgPsnl0100VO voPsnl0100,boolean boolInsert)  throws Exception {
...
//                  }  
             ...
             //     if (ExtermsProps.getProps("EMYMT_DIVCD_01").equals(payr0250Vo.getEmymtDivCd())) { } else {
...
//                                                               tpFreeDtyTotAmnt = tpFreeDtyTotAmnt.add(payr0490.getFreeDtySum());
                                                              ...
                                                              BigDecimal tpEmymtAmnt = BigDecimal.ZERO;  //기간제 본봉 /수당 임시변수 ----기간제 
                                                              ...
                                                              if (ExtermsProps.getProps("PAY_EMYMT_PYMT_19").equals(payr0490.getPayItemCd()) && (ExtermsProps.getProps("PAY_EMYMT_DYMNTH_01").equals(payr0490.getDayMnthAmntDivCd())) 
                                                                      && (new BigDecimal(MSFSharedUtils.defaultNulls(payCalculationVo.getDilnlazTotDutyNumDys(),"0")).compareTo(BigDecimal.ZERO) > 0)) {
                                                                  //총 근무일수  * 본봉
                                                                  tpEmymtAmnt = (new BigDecimal(MSFSharedUtils.defaultNulls(payCalculationVo.getDilnlazTotDutyNumDys(),"0"))
                                                           	   ...
                                                           	   //월정액,월액인경우  
                                                                //  tpEmymtAmnt = payr0490.getPymtDducSum();
                                                                //  tpStdPymtTotAmnt = tpStdPymtTotAmnt.add(tpEmymtAmnt);
                                                                      ...
                                                                      && (new BigDecimal(MSFSharedUtils.defaultNulls(payCalculationVo.getDilnlazTotDutyNumDys(),"0")).compareTo(BigDecimal.ZERO) > 0)) {
                                                                  //총 근무일수  * 본봉 -시급처리 추가 
                                                                  tpEmymtAmnt = (new BigDecimal(MSFSharedUtils.defaultNulls(payCalculationVo.getDilnlazTotDutyNumDys(),"0")).multiply(payr0490.getPymtDducSum())).setScale(-1,BigDecimal.ROUND_DOWN); 
                                                                  tpStdPymtTotAmnt = tpStdPymtTotAmnt.add(tpEmymtAmnt);
                                                              }  
                                                            //  BigDecimal tpEmymtC9410700Amnt = BigDecimal.ZERO;
                                                              ...
                                                              if (ExtermsProps.getProps("PAY_EMYMT_PYMT_04").equals(payr0490.getPayItemCd()) && (ExtermsProps.getProps("PAY_EMYMT_DYMNTH_01").equals(payr0490.getDayMnthAmntDivCd())) 
                                                                      && (new BigDecimal(MSFSharedUtils.defaultNulls(payCalculationVo.getDilnlazSatDutyNumDys(),"0")).compareTo(BigDecimal.ZERO) > 0)) {
                                                                   
                                                                  tpEmymtAmnt = (new BigDecimal(MSFSharedUtils.defaultNulls(payCalculationVo.getDilnlazSatDutyNumDys(),"0")).multiply(payr0490.getPymtDducSum())); 
                                                             ...
                                                             // BigDecimal tpEmymtC9410500Amnt = BigDecimal.ZERO;
                                                              ...
                                                              if (ExtermsProps.getProps("PAY_EMYMT_PYMT_08").equals(payr0490.getPayItemCd()) && (ExtermsProps.getProps("PAY_EMYMT_DYMNTH_01").equals(payr0490.getDayMnthAmntDivCd())) 
                                                                  ...
                                                                  tpEmymtAmnt = (new BigDecimal(MSFSharedUtils.defaultNulls(payCalculationVo.getDilnlazWklyHldyNumDys(),"0")).multiply(payr0490.getPymtDducSum()).setScale(-1,BigDecimal.ROUND_DOWN)); 
                                                              ...
                                                              if (ExtermsProps.getProps("PAY_EMYMT_PYMT_20").equals(payr0490.getPayItemCd()) && (ExtermsProps.getProps("PAY_EMYMT_DYMNTH_01").equals(payr0490.getDayMnthAmntDivCd())) 
                                                                  ...
                                                                  tpEmymtAmnt = (new BigDecimal(MSFSharedUtils.defaultNulls(payCalculationVo.getDilnlazPaidPubcHodyNum(),"0")).multiply(payr0490.getPymtDducSum())); 
                                                                  ...
                                                                  tpEmymtAmnt = (BigDecimal.ONE.multiply(payr0490.getPymtDducSum())); 
                                                           ...
                                                           // 휴일수당        -- 일수  ExtermsProps.getProps("PAY_EMYMT_PYMT_21") = "C9410200";  
                                                              if (ExtermsProps.getProps("PAY_EMYMT_PYMT_21").equals(payr0490.getPayItemCd()) && (ExtermsProps.getProps("PAY_EMYMT_DYMNTH_01").equals(payr0490.getDayMnthAmntDivCd())) 
                                                                  ...
                                                                  tpEmymtAmnt = (new BigDecimal(MSFSharedUtils.defaultNulls(payCalculationVo.getDilnlazPubcHodyDutyNumDys(),"0")).multiply(payr0490.getPymtDducSum())); 
...
//                                                                 } 
                                                             ...
                                                             // BigDecimal tpEmymtC9410100Amnt = BigDecimal.ZERO; 
                                                              ...
                                                              if (ExtermsProps.getProps("PAY_EMYMT_PYMT_07").equals(payr0490.getPayItemCd()) && (ExtermsProps.getProps("PAY_EMYMT_DYMNTH_04").equals(payr0490.getDayMnthAmntDivCd())) 
                                                                      && (new BigDecimal(MSFSharedUtils.defaultNulls(payCalculationVo.getDilnlazTotTmRstDutyTm(),"0")).compareTo(BigDecimal.ZERO) > 0)) {
                                                                   
                                                                  tpEmymtAmnt = (new BigDecimal(MSFSharedUtils.defaultNulls(payCalculationVo.getDilnlazTotTmRstDutyTm(),"0")).multiply(payr0490.getPymtDducSum())); 
                                                             ...
                                                             // BigDecimal tpEmymtC9410300Amnt = BigDecimal.ZERO; 
                                                              ...
                                                              if (ExtermsProps.getProps("PAY_EMYMT_PYMT_10").equals(payr0490.getPayItemCd()) && (ExtermsProps.getProps("PAY_EMYMT_DYMNTH_04").equals(payr0490.getDayMnthAmntDivCd())) 
                                                                      && (new BigDecimal(MSFSharedUtils.defaultNulls(payCalculationVo.getDilnlazTotNtotTm(),"0")).compareTo(BigDecimal.ZERO) > 0)) {
                                                                   
                                                                  tpEmymtAmnt = (new BigDecimal(MSFSharedUtils.defaultNulls(payCalculationVo.getDilnlazTotNtotTm(),"0")).multiply(payr0490.getPymtDducSum())); 
                                                           ...
                                                           // BigDecimal tpEmymtC9410300Amnt = BigDecimal.ZERO; 
                                                              ...
                                                              if (ExtermsProps.getProps("PAY_EMYMT_PYMT_24").equals(payr0490.getPayItemCd()) && (ExtermsProps.getProps("PAY_EMYMT_DYMNTH_04").equals(payr0490.getDayMnthAmntDivCd())) 
                                                                      && (new BigDecimal(MSFSharedUtils.defaultNulls(payCalculationVo.getDilnlazLvsgNumDys(),"0")).compareTo(BigDecimal.ZERO) > 0)) {
                                                                   
                                                                  tpEmymtAmnt = (new BigDecimal(MSFSharedUtils.defaultNulls(payCalculationVo.getDilnlazLvsgNumDys(),"0")).multiply(payr0490.getPymtDducSum())).setScale(-1, BigDecimal.ROUND_DOWN); 
...
//                                                               tpFreeDtyTotAmnt = tpFreeDtyTotAmnt.add(payr0490.getFreeDtySum());
                                                              ...
                                                              if (ExtermsProps.getProps("PAY_EMYMT_PYMT_19").equals(payr0490.getPayItemCd()) && (ExtermsProps.getProps("PAY_EMYMT_DYMNTH_01").equals(payr0490.getDayMnthAmntDivCd())) 
                                                                      && (new BigDecimal(MSFSharedUtils.defaultNulls(payCalculationVo.getDilnlazTotDutyNumDys(),"0")).compareTo(BigDecimal.ZERO) > 0)) {
                                                                  //총 근무일수  * 본봉
                                                                  tpEmymtAmnt = (new BigDecimal(MSFSharedUtils.defaultNulls(payCalculationVo.getDilnlazTotDutyNumDys(),"0")).add(new BigDecimal(MSFSharedUtils.defaultNulls(payCalculationVo.getDilnlazAbnceDutyRcgtnDys(),"0")))
                                                               		          .multiply(payr0490.getPymtDducSum())).setScale(-1,BigDecimal.ROUND_DOWN); 
                                                                  tpStdPymtTotAmnt = tpStdPymtTotAmnt.add(tpEmymtAmnt);
                                                              } else if (ExtermsProps.getProps("PAY_EMYMT_PYMT_19").equals(payr0490.getPayItemCd()) && ((
                                                                      ExtermsProps.getProps("PAY_EMYMT_DYMNTH_02").equals(payr0490.getDayMnthAmntDivCd()) ||  ExtermsProps.getProps("PAY_EMYMT_DYMNTH_03").equals(payr0490.getDayMnthAmntDivCd()))
                                                            ...
                                                            //  BigDecimal tpEmymtC9410700Amnt = BigDecimal.ZERO;
                                                             ...
                                                             // BigDecimal tpEmymtC9410500Amnt = BigDecimal.ZERO;
                                                              ...
                                                              if (ExtermsProps.getProps("PAY_EMYMT_PYMT_08").equals(payr0490.getPayItemCd()) && (ExtermsProps.getProps("PAY_EMYMT_DYMNTH_01").equals(payr0490.getDayMnthAmntDivCd())) 
                                                                  ...
                                                                  tpEmymtAmnt = (new BigDecimal(MSFSharedUtils.defaultNulls(payCalculationVo.getDilnlazWklyHldyNumDys(),"0")).multiply(payr0490.getPymtDducSum())); 
                                                              ...
                                                              //BigDecimal tpEmymtC9410400Amnt = BigDecimal.ZERO;
                                                              // 월차수당        -- 일수 (퇴직시) TODO 20170426 - 임시 주석처리 월차수당 없음 유급휴일수당으로 전환 
//                                                              if (ExtermsProps.getProps("PAY_EMYMT_PYMT_20").equals(payr0490.getPayItemCd()) && (ExtermsProps.getProps("PAY_EMYMT_DYMNTH_01").equals(payr0490.getDayMnthAmntDivCd())) 
//                                                                      && (new BigDecimal(MSFSharedUtils.defaultNulls(payCalculationVo.getDilnlazPaidPubcHodyNum(),"0")).compareTo(BigDecimal.ZERO) > 0)) {
//                                                                  
//                                                                  tpEmymtAmnt = ((new BigDecimal(MSFSharedUtils.defaultNulls(payCalculationVo.getDilnlazPaidPubcHodyNum(),"0"))).multiply(payr0490.getPymtDducSum())); 
...
//                                                  payr0302Vo.setRevnAddr(payr0302Vo.getRevnAddr());    /** column 수정주소 : revnAddr */ 
             ...
             //                                  payr0301Vo.setRevnAddr(payr0250Vo.getRevnAddr());    /** column 수정주소 : revnAddr */ 
                                                ...
                                                while ( iterpayr0490Set!=null && iterpayr0490Set.hasNext() ) {
                                                      ...
                                                      if (PayrPkgUtil.funcMonthCheck(payr0250Vo, null, payr0490)) {
                                                                ...
                                                                payr0302Vo.setPymtDducDivCd(payr0490.getPymtDducDivCd());    /** column 지급공제구분코드 : pymtDducDivCd */ 
                                                                payr0302Vo.setPymtDducFreeDtySum(payr0490.getFreeDtySum());    /** column 지급공제비과세금액 : pymtDducFreeDtySum */
                                                                payr0302Vo.setPymtDducSum(payr0490.getPymtDducSum());   /** column 지급공제금액 : pymtDducSum */
                                                                payr0302Vo.setPayPymtDducPrcsFlag("N");   /** column 급여지급공제처리플래그 : payPymtDducPrcsFlag */
                                                                payr0302Vo.setPayReattyAdmntVal("0");    /** column 급여지급공제소급조정값 : payReattyAdmntVal */
                                                                payr0302Vo.setPymtDducTxtnAmnt(payr0490.getPymtDducSum().subtract(payr0490.getFreeDtySum()));    /** column 지급공제과세금액 : pymtDducTxtnAmnt */ 
             //                                                   payr0302Vo.setKybdr(payr0302Vo.getKybdr());    /** column 입력자 : kybdr */
             //                                                   payr0302Vo.setInptDt(payr0302Vo.getInptDt());    /** column 입력일자 : inptDt */
             //                                                   payr0302Vo.setInptAddr(payr0302Vo.getInptAddr());    /** column 입력주소 : inptAddr */
             //                                                   payr0302Vo.setIsmt(payr0302Vo.getIsmt());    /** column 수정자 : ismt */
             ...
             //                                                   payr0302Vo.setRevnAddr(payr0302Vo.getRevnAddr());    /** column 수정주소 : revnAddr */   
                                                                ...
                                                                tpPymtTotAmnt = tpPymtTotAmnt.add(payr0490.getPymtDducSum());
                                                                tpExtpyTotAmnt = tpExtpyTotAmnt.add(payr0490.getPymtDducSum());
                                                                tpFreeDtyTotAmnt = tpFreeDtyTotAmnt.add(payr0490.getFreeDtySum()); 
                                                                if (BigDecimal.ZERO.compareTo(payr0302Vo.getPymtDducSum()) < 0)  {
                                                             	   payrCommCalcService.insertPayr0302(payr0302Vo); 
                                                                }  
