 ...
 */
@Controller 
public class Yeta2300HygnProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta2300HygnProcContainer.class);
    ...
    public Yeta2300HygnProcContainer() {
