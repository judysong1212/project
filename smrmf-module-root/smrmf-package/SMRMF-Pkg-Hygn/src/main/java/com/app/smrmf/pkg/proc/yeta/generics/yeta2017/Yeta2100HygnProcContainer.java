 ...
 */
@Controller 
public class Yeta2100HygnProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta2100HygnProcContainer.class);
...
//
    ...
    public Yeta2100HygnProcContainer() {
