 ...
 */
@Controller 
public class RemtHygnProcessContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(RemtHygnProcessContainer.class);
    private static final String calledClass = RemtHygnProcessContainer.class.getName();
