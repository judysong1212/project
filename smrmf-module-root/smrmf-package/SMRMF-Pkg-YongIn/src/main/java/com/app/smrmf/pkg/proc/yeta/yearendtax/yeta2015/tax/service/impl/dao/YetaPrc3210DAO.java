...
@Repository("YetaPrc3210DAO")
public class YetaPrc3210DAO extends EgovAbstractDAO {
    ...
    public String insertYeta3210(InfcPkgYeta3210VO vo) throws Exception {
        return (String)insert("yetaPrc3210DAO.insertYetaPrc3210_S", vo);
    }
    ...
    public String fnPayr06420_PAYR417_2014_CREATE_Insert(InfcPkgYeta3210VO vo) throws Exception {
        return (String)insert("yetaPrc3210DAO.fnPayr06420_PAYR417_2014_CREATE_Insert_S", vo);
    } 
    ...
    public void updateYeta3210(InfcPkgYeta3210VO vo) throws Exception {
        update("yetaPrc3210DAO.updateYetaPrc3210_S", vo);
    }
    ...
    public void deleteYeta3210(InfcPkgYeta3210VO vo) throws Exception {
        delete("yetaPrc3210DAO.deleteYetaPrc3210_S", vo);
    }
    ...
    /**
     ...
     public void fnPayr06420_PAYR417_CREATE_Delete(InfcPkgYeta3210VO vo) throws Exception {
         delete("yetaPrc3210DAO.fnPayr06420_PAYR417_CREATE_Delete_S", vo);
     }
    ...
    public InfcPkgYeta3210VO selectYeta3210(InfcPkgYeta3210VO vo) throws Exception {
        return (InfcPkgYeta3210VO) selectByPk("yetaPrc3210DAO.selectYetaPrc3210_S", vo);
    }
    ...
    public List<?> selectYeta3210List(InfcPkgYeta3210SrhVO searchVO) throws Exception {
        return list("yetaPrc3210DAO.selectYetaPrc3210List_D", searchVO);
    }
    ...
    public int selectYeta3210ListTotCnt(InfcPkgYeta3210SrhVO searchVO) {
        return (Integer)getSqlMapClientTemplate().queryForObject("yetaPrc3210DAO.selectYetaPrc3210ListTotCnt_S", searchVO);
    }
