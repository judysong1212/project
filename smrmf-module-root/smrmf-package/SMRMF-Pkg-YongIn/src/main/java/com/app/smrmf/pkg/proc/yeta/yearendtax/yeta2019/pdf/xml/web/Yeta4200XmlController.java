package com.app.smrmf.pkg.proc.yeta.yearendtax.yeta2019.pdf.xml.web;
...
import com.app.smrmf.pkg.yeta.yeta2019.pdfxml.Yeta4200PkgXmlController;
...
@Controller
public class Yeta4200XmlController {



	private static final Logger logger = LoggerFactory.getLogger(Yeta4200XmlController.class);  
	...
	//전자문서자료추출에서 PDF 제출 버튼 클릭 시
	@RequestMapping(value = "/imp/XmlYeta4200Import.do")
	public String xmlYeta4200Import(@ModelAttribute("InfcPkgYe161010_2019_VO") InfcPkgYe161010_2019_VO ye161010VO, HttpServletRequest request, 
		...
		if  (yeta4200Service == null) { 
			WebApplicationContext wac = WebApplicationContextUtils.
					getRequiredWebApplicationContext( request.getSession().getServletContext());

			yeta4200Service = (InfcPkgYeta4200Service) wac.getBean("InfcPkgYeta4200Service" ); 

		}
		InfcPkgYe161020_2019_VO ye161020VO = new InfcPkgYe161020_2019_VO();
		MSFSysm0100BM sessionUser = MSFServerUtils.getLoggedUser(request);
		Yeta4200PkgXmlController yete320 = new Yeta4200PkgXmlController();
		try	{
						...
						try {
							if (isSuccess) {
								...
								if (v_ret == 1) {
									...
									yeta4200Service.yeta4200_Ye161020_2019_Update(ye161020VO);
...
//									System.out.println("데이터 추출에 실패하였습니다.");
	...
	/** 소득공제 신고서 */
	@RequestMapping(value = "/imp/XmlYeta4200DdcImport.do")
	public String xmlYeta4200DdcImport(@ModelAttribute("InfcPkgYe161010_2019_VO") InfcPkgYe161010_2019_VO ye161010VO, HttpServletRequest request,
			HttpServletResponse response, Model model) throws Exception {
