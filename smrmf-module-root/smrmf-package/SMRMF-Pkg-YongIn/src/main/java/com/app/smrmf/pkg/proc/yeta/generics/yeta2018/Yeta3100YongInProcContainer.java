 ...
 */
@Controller 
public class Yeta3100YongInProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta3100YongInProcContainer.class);
	  
	 
  
    @Resource(name = "Yeta3100PayrService")
    protected Yeta3100PayrService  yeta2100PayrService;
...
//
    ...
    public Yeta3100YongInProcContainer() {
	...
	public PagingLoadResult<ShowMessageBM> execPayrToYeta_2018_Insert(HttpServletRequest request,List<InfcPkgYe161010_2018_VO> listYe161010VO)throws Exception {
		...
		Yeta3100PkgProcContainer yeta3100 = new Yeta3100PkgProcContainer();   
		return yeta3100.execPayrToYeta_2018_Insert(request, listYe161010VO);
