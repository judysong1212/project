 ...
 */
@Controller
public class Yeta4300YongInProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta4300YongInProcContainer.class);
	 
    public Yeta4300YongInProcContainer() {
