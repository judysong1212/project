...
import com.app.smrmf.pkg.proc.yeta.yearendtax.yeta2015.tax.service.YetaPayr6440Service;
...
@Service("YetaPayr6440CreateService")
public class YetaPayr6440ServiceImpl extends AbstractServiceImpl  implements
   ...
   @Autowired
    ...
    public String fnPayr06420_PAYR420_2014_CREATE_Insert(InfcPkgYeta1000VO vo) throws Exception {
    	...
    	yetaPrc1000DAO.fnPayr06420_PAYR420_2014_CREATE_Insert(vo);
    ...
    /**
     ...
     //	LOGGER.debug(vo.toString());
     	...
     	yetaPrc3210DAO.fnPayr06420_PAYR417_2014_CREATE_Insert(yetaPrc3210Vo);
     	//TODO 해당 테이블 정보에 맞게 수정    	
         return null;
     }
     ...
     /**
      ...
      //	LOGGER.debug(vo.toString());
      	...
      	yetaPrc2000DAO.fnPayr06420_PAYR415_2014_CREATE_Insert(yetaPrc2000Vo);
      	//TODO 해당 테이블 정보에 맞게 수정    	
          return null;
      }
      ...
      /**
        ...
        /**
          ...
          //	LOGGER.debug(vo.toString());
          	...
          	yetaPrc3220DAO.fnPayr06430_PAYR410_2014_CREATE_Insert(yetaPrc2000Vo);
          	//TODO 해당 테이블 정보에 맞게 수정    	
              return null;
          }  
          ...
          public String fnPayr06430_PAYR443_2014_CREATE_Insert(InfcPkgYeta2000VO yetaPrc2000Vo) throws Exception {
            ...
            //	LOGGER.debug(vo.toString());
            	...
            	yetaPrc3190DAO.fnPayr06430_PAYR443_2014_CREATE_Insert(yetaPrc2000Vo);
            	//TODO 해당 테이블 정보에 맞게 수정    	
                return null;
            }     
          ...
          //	LOGGER.debug(vo.toString());
          	...
          	yetaPrc3000DAO.fnPayr06430_PAYR425_2014_CREATE_Insert(yetaPrc2000Vo);
          	//TODO 해당 테이블 정보에 맞게 수정    	
              return null;
          }     
    ...
    public String insertYeta3900(InfcPkgYeta3900VO vo) throws Exception {
    	...
    	yetaPrc3900DAO.insertYeta3900(vo);
    	//TODO 해당 테이블 정보에 맞게 수정    	
        return null;
    }
