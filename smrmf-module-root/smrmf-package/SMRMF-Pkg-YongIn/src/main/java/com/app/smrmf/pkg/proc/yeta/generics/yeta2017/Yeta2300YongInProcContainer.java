 ...
 */
@Controller 
public class Yeta2300YongInProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta2300YongInProcContainer.class);
	 
    public Yeta2300YongInProcContainer() {
