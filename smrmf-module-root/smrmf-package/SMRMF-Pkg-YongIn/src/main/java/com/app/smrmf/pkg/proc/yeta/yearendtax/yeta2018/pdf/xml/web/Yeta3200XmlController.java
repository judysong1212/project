package com.app.smrmf.pkg.proc.yeta.yearendtax.yeta2018.pdf.xml.web;
...
import com.app.smrmf.pkg.yeta.yeta2018.pdfxml.Yeta3200PkgXmlController;
...
@Controller
public class Yeta3200XmlController {



	private static final Logger logger = LoggerFactory.getLogger(Yeta3200XmlController.class);  
	...
	@RequestMapping(value = "/imp/XmlYeta3200Import.do")
	public String xmlYeta3200Import(@ModelAttribute("InfcPkgYe161010_2018_VO") InfcPkgYe161010_2018_VO ye161010VO, HttpServletRequest request, 
		...
		if  (yeta3200Service == null) { 
			WebApplicationContext wac = WebApplicationContextUtils.
					getRequiredWebApplicationContext( request.getSession().getServletContext());

			yeta3200Service = (InfcPkgYeta3200Service) wac.getBean("InfcPkgYeta3200Service" ); 

		}
		InfcPkgYe161020_2018_VO ye161020VO = new InfcPkgYe161020_2018_VO();
		MSFSysm0100BM sessionUser = MSFServerUtils.getLoggedUser(request);
		Yeta3200PkgXmlController yete320 = new Yeta3200PkgXmlController();
		try	{
						...
						try {
							if (isSuccess) {
								...
								if (v_ret == 1) {
									...
									yeta3200Service.yeta3200_Ye161020_2018_Update(ye161020VO);
...
//									System.out.println("데이터 추출에 실패하였습니다.");
	...
	/** 소득공제 신고서 */
	@RequestMapping(value = "/imp/XmlYeta3200DdcImport.do")
	public String xmlYeta3200DdcImport(@ModelAttribute("InfcPkgYe161010_2018_VO") InfcPkgYe161010_2018_VO ye161010VO, HttpServletRequest request,
			HttpServletResponse response, Model model) throws Exception {
