 ...
 */
@Controller 
public class Yeta1100YongInProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta1100YongInProcContainer.class);
...
//
    ...
    public Yeta1100YongInProcContainer() {
		...
		try { 
			...
			for (int iCnt01 = 0; iCnt01 < lstYeta2000Vo.size(); iCnt01++) {
				...
				infcPkgYe160401Vo.setDpobCd(infcPkgYeta2000Vo.getDpobCd());    			/** column 사업장코드 : dpobCd */
		  		...
		  		infcPkgYe160401Vo.setPayrMangDeptCd(infcPkgYeta2000Vo.getPayrMangDeptCd());    			/** column 급여관리부서코드 : payrMangDeptCd */
		  		infcPkgYe160401Vo.setDeptCd(infcPkgYeta2000Vo.getDeptCd());    							/** column 부서코드 : deptCd */
		  		infcPkgYe160401Vo.setTypOccuCd(infcPkgYeta2000Vo.getTypOccuCd());    					/** column 직종코드 : typOccuCd */
...
//		  		infcPkgYe160401Vo.setPyspGrdeCd(infcPkgYe160401Vo.getPyspGrdeCd());   				 	/** column 호봉등급코드 : pyspGrdeCd */
		        infcPkgYe160401Vo.setDtilOccuInttnCd(infcPkgYeta2000Vo.getDtilOccuInttnCd());    		/** column 직종세통합코드 : dtilOccuInttnCd */
		        infcPkgYe160401Vo.setBusinCd(infcPkgYeta2000Vo.getBusinCd());    						/** column 사업코드 : businCd */
		        infcPkgYe160401Vo.setEmymtDivCd(infcPkgYeta2000Vo.getEmymtDivCd());    					/** column 고용구분코드 : emymtDivCd */ 
