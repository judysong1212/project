package com.app.smrmf.pkg.proc.yeta.yearendtax.yeta2015.tax.service;
 ...
 */
public interface YetaPayr6420Service {
    ...
    /**
	  ...
	  * @throws Exception
	  */
   String fnPayr06420_PAYR417_2014_CREATE_Insert(InfcPkgYeta3210VO yetaPrc3210Vo) throws Exception;
    ...
    * @throws Exception
    */
   String fnPayr06420_PAYR415_2014_CREATE_Insert(InfcPkgYeta2000VO yetaPrc2000Vo) throws Exception;
    ...
    * @throws Exception
    */
   String fnPayr06420_YETA3200_2015_CREATE_Insert(InfcPkgYeta2000VO yetaPrc2000Vo) throws Exception;
    ...
    * @throws Exception
    */
   String fnPayr06430_PAYR410_2014_CREATE_Insert(InfcPkgYeta2000VO yetaPrc2000Vo) throws Exception;  
    ...
    * @throws Exception
    */
   void fnPayr06430_PAYR410_2014_CREATE_Update(InfcPkgYeta2000VO yetaPrc2000Vo) throws Exception; 
   ...
   void fnPayr06520_PAYR415_2015_CREATE1_Update(InfcPkgYeta2000VO yetaPrc2000Vo) throws Exception;  
 	  //{비과세 감면 인서트 }
     //{**************************연말정산기본 비과세 감면 업데이트   [4]********************************} 
	  	        
 	   void fnPayr06420_YETA3200_2015_CREATE1_Update(InfcPkgYeta2000VO yetaPrc2000Vo) throws Exception;   
    
  // {******************************급여자료 이관 - 연말정산 425 업데이트   [4]*******************************************}
    //425 업데이트
	  void fnPayr06530_PAYR425_2015_CREATE1_Update(InfcPkgYeta2000VO yetaPrc2000Vo) throws Exception; 
    ...
    * @throws Exception
    */
   String fnPayr06430_PAYR443_2014_CREATE_Insert(InfcPkgYeta2000VO yetaPrc2000Vo) throws Exception; 
    ...
    * @throws Exception
    */
   String fnPayr06430_PAYR425_2014_CREATE_Insert(InfcPkgYeta2000VO yetaPrc2000Vo) throws Exception; 
