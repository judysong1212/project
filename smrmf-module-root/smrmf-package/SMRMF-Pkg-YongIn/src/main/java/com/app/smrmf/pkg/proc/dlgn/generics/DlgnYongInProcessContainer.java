...
public class DlgnYongInProcessContainer {
	

	private static final Logger logger = LoggerFactory.getLogger(DlgnYongInProcessContainer.class);
	   
    @Resource(name = "ManageCommuteService")
    protected ManageCommuteService manageCommuteService;

    public DlgnYongInProcessContainer() {
