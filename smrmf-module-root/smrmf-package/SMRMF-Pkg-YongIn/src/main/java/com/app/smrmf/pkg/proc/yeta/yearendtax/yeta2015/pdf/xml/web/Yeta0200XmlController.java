package com.app.smrmf.pkg.proc.yeta.yearendtax.yeta2015.pdf.xml.web;
...
@Controller
public class Yeta0200XmlController {


    private static final Logger logger = LoggerFactory.getLogger(Yeta0200XmlController.class);  
 
    
    @Resource(name = "YetaPayr6425Service")
    private YetaPayr6425Service yetaPayr6425Service;
    ...
    @RequestMapping(value = "/imp/XmlYeta0200Import.do")
    public String xmlYeta0200Import(@ModelAttribute("InfcPkgYeta2000VO") InfcPkgYeta2000VO yeta2000VO,final HttpServletRequest request
            , Map commandMap , Model model) throws Exception {
         
    	String p_pwd = "";
        String sResult = "";
    	  
        if  (yetaPayr6425Service == null) { 
            WebApplicationContext wac = WebApplicationContextUtils.
                    getRequiredWebApplicationContext( request.getSession().getServletContext());

            yetaPayr6425Service = (YetaPayr6425Service) wac.getBean("YetaPayr6425Service" ); 
...
//        		}
                				...
                				if (v_ret == 1) {
                					...
                					System.out.print(strXml.replace("<", "&lt;")
                					  ...
                					  //DOM Document 객체 생성하기 위한 메서드 
                		               ...
                		               PayrXmlDataInsert(yeta2000VO, xmlDoc);
    ...
    @RequestMapping(value = "/imp/XmlYeta0200UpImport.do")
    public String xmlYeta0200UpImport(@ModelAttribute("InfcPkgYeta2000VO") InfcPkgYeta2000VO yeta2000VO,final HttpServletRequest request
            , Map commandMap , Model model) throws Exception {
...
//        		}
                				...
                				if (v_ret == 1) {
                					...
                					System.out.print(strXml.replace("<", "&lt;")
                					  ...
                					  //DOM Document 객체 생성하기 위한 메서드 
                		               ...
                		               PayrXmlDataUpdate(yeta2000VO, xmlDoc);
   ...
   private void PayrXmlDataInsert(InfcPkgYeta2000VO yeta2000Vo, Document xmlDoc) {
	  ...
	  // int i,j,k,l  = 0;
	   ...
	   BigDecimal edSpciGurtSum = BigDecimal.ZERO;
	   BigDecimal  edSpciHdrcSum = BigDecimal.ZERO;
	   int ddCnt = 0; 
	   String schBrith = "";
	   String strBusnid = ""; 
	   String strResid = "";
	   ...
	   String[][] arrCASH_PAY = new String[10][4];  
	     ...
	     try {
	         try {
	          ...
	          // FileName := 'C:\EOSDATA\2014\' + trim(lblFILE_SAVE.Caption) + '_' + trim(edKORN_NAME.Text); // + '.xml';
	         ...
	         //  CONNXML.LoadFromFile(ChangeFileExt(FileName, '.xml'));
	          ...
	          // ecxmlPdf.LoadFromFile(FileName);
	            ...
	            dataType = getTagValue("doc_type", xmlelDoc);    //문서종류   
	            dataPrDate =  getTagValue("seq", xmlelDoc); //일련번호 
	            dataYear = getTagValue("att_year", xmlelDoc);   //귀속년도 

	           if (!dataYear.equals("2015")) {
	                ...
	                //보장성보험(G0001) , 장애인전용보장성 보험(G0002). 기본내역
	                 ...
	                 for (int j = 0; j < subXmlElChildForm.getLength();j++) { 
	                       ...
	                       for(int k = 0; k < subXmlElChildMan.getLength();k++) {  
	                         ...
	                         if (strDatCd.equals("G0001")) {
	                          edSpciGurtSum = edSpciGurtSum.add(new BigDecimal(getTagValue("sum", subXmlElData)));
	                          arrHDRC_PAY[ddCnt][1] =  String.valueOf(new BigDecimal(arrHDRC_PAY[ddCnt][1]).add(new BigDecimal(getTagValue("sum", subXmlElData))));
	                         }
	                         else if ( strDatCd.equals("G0002")) {
	                           edSpciHdrcSum = edSpciHdrcSum.add(new BigDecimal(getTagValue("sum", subXmlElData)));
	                           arrHDRC_PAY[ddCnt][2] =  String.valueOf(new BigDecimal(arrHDRC_PAY[ddCnt][2]).add(new BigDecimal(getTagValue("sum", subXmlElData))));  
	                 ...
	                 yeta2000Vo.setSpciGurt(edSpciGurtSum);//A01
	                 yeta2000Vo.setSpciHdrc(edSpciHdrcSum); //A02
	                 
	                 yetaPayr6425Service.fnPayr06425_PAYR415_2014_Update(yeta2000Vo);
	                       ...
	                       //기관별반복구간 
	                        ...
	                        for(int k = 0; k < subXmlElChildMan.getLength();k++) {  
	                         ...
	                         if (strDatCd.equals("G0003")) { //의료비
	                          ...
	                          exCASH_UEAM =   new BigDecimal(getTagValue("sum", subXmlElData)) ;
	                         ...
	                         arrCASH_PAY[ldCnt][1] =   String.valueOf(new BigDecimal(arrCASH_PAY[ldCnt][1]).add(new BigDecimal(getTagValue("sum", subXmlElData)))); 
								...
								yetaPrc3140Vo.setEdacRvyy(yeta2000Vo.getEdacRvyy());    /** column 연말정산귀속년도 : edacRvyy */
								yetaPrc3140Vo.setSettGbcd(yeta2000Vo.getSettGbcd());    /** column 정산구분코드 : settGbcd */
								yetaPrc3140Vo.setDpobCd(yeta2000Vo.getDpobCd());    /** column 사업장코드 : dpobCd */
								yetaPrc3140Vo.setSystemkey(yeta2000Vo.getSystemkey());    /** column SYSTEMKEY : systemkey */
								yetaPrc3140Vo.setVendNumb(subXmlElData.getAttribute("busnid"));    /** column 거래처번호 : vendNumb */
								yetaPrc3140Vo.setRsnoNumb(strResid);    /** column 주민등록번호 : rsnoNumb */
								
								yetaPayr6425Service.fnPayr06430_PAYR430_2014_Delete(yetaPrc3140Vo);
								 
								
								  if (strResid.equals(yeta2000Vo.getResnRegnNum())) {
									          yetaPrc3140Vo.setPsclHpyn("1");/** column 본인등해당여부 : psclHpyn */ 
				                              // oraQryInsert.ParamByName('PSCL_HPYN').AsString := '1';
								  } else   if (((strResid.substring(0,7).equals("1")) || (strResid.substring(0,7).equals("2"))) && (!strResid.equals(yeta2000Vo.getResnRegnNum()))) {
			                          
										   schBrith =  ("19").concat(strResid.substring(0,7));
									  
			                               if  (schBrith.compareTo("19491231") <= 0) {
			                               			yetaPrc3140Vo.setPsclHpyn("1"); /** column 본인등해당여부 : psclHpyn */ 
			                               } else {
...
//								yetaPrc3140Vo.setRevnAddr(yeta3140Dto.getRevnAddr());    /** column 수정주소 : revnAddr */
								...
								yetaPayr6425Service.fnPayr06430_PAYR430_2014_Insert(yetaPrc3140Vo);		
	                 ...
	                 //의료비 종료
		                       ...
		                       for(int k = 0; k < subXmlElChildMan.getLength();k++) {  
	                            ...
	                            if (strResid.equals(yeta2000Vo.getResnRegnNum())) {
	                                 ...
	                                 if  (strEduTp.equals("H"))  {
	                                   arrPayr445[9][3] =  String.valueOf(new BigDecimal(arrPayr445[9][3]).add(new BigDecimal(getTagValue("sum", subXmlElData))));
	                                 ...
	                                 // edSpciScam  := edSpciScam  + strtofloat(subXmlItemData.NamedItem['sum'].Text);
	                                  ...
	                                  {
	                                     edSpedSelf = edSpedSelf.add(new BigDecimal(getTagValue("sum", subXmlElData)));
	                                     arrPayr445[ddCnt][2] =  String.valueOf(new BigDecimal(arrPayr445[9][2]).add(new BigDecimal(getTagValue("sum", subXmlElData)))); 
	                            ...
	                            else
	                            {
	                                 ...
	                                 if (strDatCd.equals("G0004")) { 
	                                  ...
	                                  if ( strEduTp.equals("1")) {
	                                   ...
	                                   arrPayr445[ddCnt][2] =   String.valueOf(new BigDecimal(arrPayr445[ddCnt][2]).add(new BigDecimal(getTagValue("sum", subXmlElData))));
	                                		   //floattostr(strtofloat(arrPayr445[ddCnt][2])  + strtofloat(subXmlItemData.NamedItem['sum'].Text));
	                                  }
	                                  ...
	                                  arrPayr445[ddCnt][2] =  String.valueOf(new BigDecimal(arrPayr445[ddCnt][2]).add(new BigDecimal(getTagValue("sum", subXmlElData))));
	                                   ...
	                                   arrPayr445[ddCnt][3] =  String.valueOf(new BigDecimal(arrPayr445[ddCnt][3]).add(new BigDecimal(getTagValue("sum", subXmlElData))));
	                                	   ...
	                                	   for(int l = 0; l < arrPayr445.length;l++) { 
	                                		  ...
	                                		  if (MSFSharedUtils.paramNotNull(arrPayr445[l][0])) {
		                                           if (arrPayr445[l][0].equals(strResid))  {
		                                             ...
		                                             arrPayr445[l][2] =  String.valueOf(new BigDecimal(arrPayr445[l][2]).add(new BigDecimal(getTagValue("sum", subXmlElData))));
		                                            		 //floattostr(strtofloat(arrPayr445[ddCnt][2])  + strtofloat(subXmlItemData.NamedItem['sum'].Text));
		                                             chkData = true;
		                                           }
	                                		  } 
	                  ...
	                  //Y0040030	Y004 	0030	개인연금저축					21
	                   ...
	                   yetaPrc3100Vo.setDpobCd(yeta2000Vo.getDpobCd());    /** column 사업장코드 : dpobCd */
	                   yetaPrc3100Vo.setEdacRvyy(yeta2000Vo.getEdacRvyy());    /** column 연말정산귀속년도 : edacRvyy */
	                   yetaPrc3100Vo.setSettGbcd(yeta2000Vo.getSettGbcd());    /** column 정산구분코드 : settGbcd */
	                   yetaPrc3100Vo.setSystemkey(yeta2000Vo.getSystemkey());    /** column SYSTEMKEY : systemkey */ 
	                   yetaPrc3100Vo.setImdeGbcd("Y0040030");    /** column 소득공제구분코드 : imdeGbcd */
	                   
	                   yetaPayr6425Service.fnPayr06430_Payr418_2014_Delete(yetaPrc3100Vo);
			                         ...
			                         strDatCd = subXmlElData.getAttribute("dat_cd"); 
		                              ...
		                              if (strDatCd.equals("G0009")) {
		                        	   if (strResid.equals(yeta2000Vo.getResnRegnNum())) { 
		                                 ...
		                                 edPrvm20be = edPrvm20be.add(new BigDecimal(getTagValue("sum", subXmlElData))); 
		                                		 //+   strtofloat(subXmlItemData.NamedItem['sum'].Text);
										...
										yetaPrc3100Vo.setFinaCode(getTagValue("com_cd", subXmlElData));    /** column 금융기관코드 : finaCode */
										...
										yetaPrc3100Vo.setPaytAmnt(new BigDecimal(getTagValue("sum", subXmlElData)));    /** column 불입금액 : paytAmnt */
										yetaPrc3100Vo.setDeduAmnt(BigDecimal.ZERO);    /** column 세액공제금액 : deduAmnt */
										yetaPrc3100Vo.setImdeTxcd("21");    /** column 소득공제구분국세청코드 : imdeTxcd */
										yetaPrc3100Vo.setFinaTxcd( getTagValue("com_cd", subXmlElData));    /** column 금융기관국세청코드 : finaTxcd */
...
//		                                oraQryInsert.ParamByName('DEDU_AMNT').AsString := '0';
										yetaPayr6425Service.fnPayr06430_Payr418_2014_Insert(yetaPrc3100Vo);
		                ...
		                yetaPayr6425Service.fnPayr06425_Payr415_2015_Update(yeta2000Vo);
		                 ...
		                 for (int j = 0; j < subXmlElChildForm.getLength();j++) { 
	                         ...
	                         // 상품별 반복구간
	                           ...
	                           if (strResid.equals(yeta2000Vo.getResnRegnNum())) { 
	                                ...
	                                edPrvm21af = edPrvm21af.add(new BigDecimal(getTagValue("ddct_bs_ass_amt", subXmlElData))) ;
	                           ...
	                           yetaPrc3100Vo.setDpobCd(yeta2000Vo.getDpobCd());    /** column 사업장코드 : dpobCd */
								...
								yetaPrc3100Vo.setAcntNumb(subXmlElData.getAttribute("acc_no") );    /** column 계좌번호 : acntNumb */
								yetaPrc3100Vo.setIcnmYear("");    /** column 납입연차 : icnmYear */
								yetaPrc3100Vo.setPaytAmnt(new BigDecimal(getTagValue("ddct_bs_ass_amt", subXmlElData)));    /** column 불입금액 : paytAmnt */
								yetaPrc3100Vo.setDeduAmnt(BigDecimal.ZERO);    /** column 세액공제금액 : deduAmnt */
...
//	                                oraQryInsert.ParamByName('DEDU_AMNT').AsString := '0';
	                    ...
	                    //  oraQryUpdate.ParamByName('JRTR_ANSV').AsFloat :=  ;
			                ...
			                yetaPayr6425Service.fnPayr06425_JrtrAnsv_2015_Update(yeta2000Vo);
			                 ...
			                 for (int j = 0; j < subXmlElChildForm.getLength();j++) { 
		                           ...
		                           if (strDatCd.equals("G0011")) {
		                        	   ...
		                        	   if (strResid.equals(yeta2000Vo.getResnRegnNum())) { 
		                                ...
		                                if ((getTagValue("pension_cd", subXmlElData)).equals("11")) {
		                                     // Y0040010	B011	0010	근로자퇴직연금보장법.	11
		                                      edJrtrPsct = edJrtrPsct.add(new BigDecimal(MSFSharedUtils.defaultNulls(getTagValue("ddct_bs_ass_amt", subXmlElData),"0"))) ;
		                                    		  // +   strtofloat(subXmlItemData.NamedItem['ddct_bs_ass_amt'].Text);
		                                }
		                                else if ((getTagValue("pension_cd", subXmlElData)).equals("12")) {
		                                
		                                  // Y0040020	B011	0020	과학기술인공제회	12
		                                   edJRTR_CICT = edJRTR_CICT.add(new BigDecimal(MSFSharedUtils.defaultNulls(getTagValue("ddct_bs_ass_amt", subXmlElData),"0"))) ;  
		                                		   //+   strtofloat(subXmlItemData.NamedItem['ddct_bs_ass_amt'].Text);
		                                }
		                                ...
		                                if ((getTagValue("pension_cd", subXmlElData)).equals("11")) {
		                                     ...
		                                     // Y0040010	B011	0010	근로자퇴직연금보장법.	11
		                                	   yetaPrc3100Vo.setImdeGbcd("Y0040010");    /** column 소득공제구분코드 : imdeGbcd */
				         	                   yetaPrc3100Vo.setImdeTxcd(getTagValue("pension_cd", subXmlElData));    /** column 소득공제구분국세청코드 : imdeTxcd */
...
//		                                end;
		 								...
		 								yetaPrc3100Vo.setAcntNumb(subXmlElData.getAttribute("acc_no") );    /** column 계좌번호 : acntNumb */
		 								yetaPrc3100Vo.setIcnmYear("");    /** column 납입연차 : icnmYear */
		 								yetaPrc3100Vo.setPaytAmnt(new BigDecimal(MSFSharedUtils.defaultNulls(getTagValue("ddct_bs_ass_amt", subXmlElData),"0")));    /** column 불입금액 : paytAmnt */
		 								yetaPrc3100Vo.setDeduAmnt(BigDecimal.ZERO);    /** column 세액공제금액 : deduAmnt */
...
//		                      oraQryUpdate.ParamByName('JRTR_CICT').AsFloat :=  edJRTR_CICT;
				             ...
				             yetaPayr6425Service.fnPayr06425_JrtrCict_2015_Update(yeta2000Vo);

	                   //퇴직연금 종료 
	                }
	                else if ((strFormCd.equals("G103Y")) ||  (strFormCd.equals("G103M")))  {
	                	/**+++++++++++신용카드 시작++++++++++++++++++++++++++++++++++++++++++++++++*/
	                    ...
	                    //종류확인
	                       ...
	                       subXmlElChildForm =  subXmlElForm.getElementsByTagName("man");
	  	                   ...
	  	                   for (int j = 0; j < subXmlElChildForm.getLength();j++) { 
		                       ...
		                       if (strResid.equals(yeta2000Vo.getResnRegnNum())) { 
		                    	     ...
		                    	     //2013 이전년도 전체합계
	                                  edCARD_ET13 =  edCARD_ET13.add(new BigDecimal(MSFSharedUtils.defaultNulls(subXmlElMan.getAttribute("ftyr_tot_amt"),"0")));
	                                  //+ strtofloat(subXmlItemMan.Params.Values['ftyr_tot_amt']);
	                                  edCARD_ET13 =  edCARD_ET13.add(new BigDecimal(MSFSharedUtils.defaultNulls(subXmlElMan.getAttribute("ftyr_market_tot_amt"),"0")));
	                                        //+ strtofloat(subXmlItemMan.Params.Values['ftyr_market_tot_amt']);
	                                  edCARD_ET13 =  edCARD_ET13.add(new BigDecimal(MSFSharedUtils.defaultNulls(subXmlElMan.getAttribute("ftyr_tmoney_tot_amt"),"0")));
	                                 ...
	                                 // edETAD_DD13 =  edETAD_DD13.add(new BigDecimal(subXmlElMan.getAttribute("ftyr_tot_amt") ));
	                                  edETAD_DD13 =  edETAD_DD13.add(new BigDecimal(MSFSharedUtils.defaultNulls(subXmlElMan.getAttribute("ftyr_market_tot_amt"),"0"))); 
	                                  		//+ strtofloat(subXmlItemMan.Params.Values['ftyr_market_tot_amt']);
	                                  edETAD_DD13 =  edETAD_DD13.add(new BigDecimal(MSFSharedUtils.defaultNulls(subXmlElMan.getAttribute("ftyr_tmoney_tot_amt"),"0")));
	                                  		//+ strtofloat(subXmlItemMan.Params.Values['ftyr_tmoney_tot_amt']);


		                    	     //2014 이전년도 전체합계
	                                  edCARD_ET14 =  edCARD_ET14.add(new BigDecimal(MSFSharedUtils.defaultNulls(subXmlElMan.getAttribute("pre_tot_amt"),"0"))); 
	                                  				//+ strtofloat(subXmlItemMan.Params.Values['pre_tot_amt']);
	                                  edCARD_ET14 =  edCARD_ET14.add(new BigDecimal(MSFSharedUtils.defaultNulls(subXmlElMan.getAttribute("pre_market_tot_amt"),"0"))); 
	                                  				//+ strtofloat(subXmlItemMan.Params.Values['pre_market_tot_amt']);
	                                  edCARD_ET14 =  edCARD_ET14.add(new BigDecimal(MSFSharedUtils.defaultNulls(subXmlElMan.getAttribute("pre_tmoney_tot_amt"),"0"))); 
	                                  				//+ strtofloat(subXmlItemMan.Params.Values['pre_tmoney_tot_amt']);
	                                  
	                                  //2014 이전년도 본인추가 공제율
	                                 // edETAD_D14L =  edETAD_D14L.add(new BigDecimal(subXmlElMan.getAttribute("pre_tot_amt") )); 
	 	                       ...
	 	                       for(int k = 0; k < subXmlElChildMan.getLength();k++) {  
	 	                        ...
	 	                        if (strDatCd.equals("G0012")) { // if strDatCd  = 'G01' then
	                                  ...
	                                  if ((subXmlElData.getAttribute("use_place_cd") ).equals("1") )  { 
	                                      ...
	                                      edETCT_CARD = edETCT_CARD.add(new BigDecimal(getTagValue("sum", subXmlElData))); 
	                                         // + strtofloat(subXmlItemData.NamedItem['sum'].Text);
	                                     
	                                      if (strResid.equals(yeta2000Vo.getResnRegnNum())) { 
	                                       
	                                       edCARD_ET15 = edCARD_ET15.add(new BigDecimal(getTagValue("sum", subXmlElData))); 
	                                       // +  strtofloat(subXmlItemData.NamedItem['sum'].Text);
	                                      }
	                                      arrCARD_PAY[ddCnt][1]   = String.valueOf(new BigDecimal(arrCARD_PAY[ddCnt][1]).add(new BigDecimal(getTagValue("sum", subXmlElData)))); 
	                                      ...
	                                      edETCH_MGVD = edETCH_MGVD.add(new BigDecimal(getTagValue("sum", subXmlElData))); 
	                                      // + strtofloat(subXmlItemData.NamedItem['sum'].Text);
	                                  if (strResid.equals(yeta2000Vo.getResnRegnNum())) { 
	                                    
	                                       edCARD_ET15 = edCARD_ET15.add(new BigDecimal(getTagValue("sum", subXmlElData))); 
	                                       // + strtofloat(subXmlItemData.NamedItem['sum'].Text);
	                                       edETAD_D15H = edETAD_D15H.add(new BigDecimal(MSFSharedUtils.defaultNulls(subXmlElData.getAttribute("first_year_tot_amt"),"0") )); 
	                                       // + strtofloat(subXmlItemData.Params.Values['first_year_tot_amt']);
	                                       edETAD_D15L = edETAD_D15L.add(new BigDecimal(MSFSharedUtils.defaultNulls(subXmlElData.getAttribute("second_year_tot_amt"),"0") )); 
	                                       // + strtofloat(subXmlItemData.Params.Values['second_year_tot_amt']);
	                                  }
	                                      arrCARD_PAY[ddCnt][2]   =  String.valueOf(new BigDecimal(arrCARD_PAY[ddCnt][2]).add(new BigDecimal(getTagValue("sum", subXmlElData))));
	                                      ...
	                                      edETCH_BCED = edETCH_BCED.add(new BigDecimal(getTagValue("sum", subXmlElData)));  
	                                      // + strtofloat(subXmlItemData.NamedItem['sum'].Text);
	                                  if (strResid.equals(yeta2000Vo.getResnRegnNum())) { 
	                                      ...
	                                      arrCARD_PAY[ddCnt][3]   =  String.valueOf(new BigDecimal(arrCARD_PAY[ddCnt][3]).add(new BigDecimal(getTagValue("sum", subXmlElData))));
	 	                 ...
	 	                 yetaPayr6425Service.fnPayr06425_PAYR415_2015_06_Update(yeta2000Vo);
	                      

	                   //신용카드 종료
	                }
	                else if (strFormCd.equals("G204M")) {
	                 /**+++++++++++현금 영수증 시작++++++++++++++++++++++++++++++++++++++++++++++++*/
	                  ...
	                  //종류확인.  기본서직없음. 상세...
	  	                 ...
	  	                 for (int j = 0; j < subXmlElChildForm.getLength();j++) { 
	                            ...
	                            if (strResid.equals(yeta2000Vo.getResnRegnNum())) { 
                                 ...
                                 //2013 이전년도 본인추가 공제율
                                 edETAD_DD13 =  edETAD_DD13.add(new BigDecimal(MSFSharedUtils.defaultNulls(subXmlElMan.getAttribute("ftyr_tot_amt"),"0") ));
                                 edETAD_DD13 =  edETAD_DD13.add(new BigDecimal(MSFSharedUtils.defaultNulls(subXmlElMan.getAttribute("ftyr_market_tot_amt"),"0") )); 
                                 		//+ strtofloat(subXmlItemMan.Params.Values['ftyr_market_tot_amt']);
                                 edETAD_DD13 =  edETAD_DD13.add(new BigDecimal(MSFSharedUtils.defaultNulls(subXmlElMan.getAttribute("ftyr_tmoney_tot_amt"),"0") ));
                                 		//+ strtofloat(subXmlItemMan.Params.Values['ftyr_tmoney_tot_amt']); 
...
//	                                  edETAD_DD13 :=  edETAD_DD13 + strtofloat(subXmlItemMan.Params.Values['pre_tmoney_tot_amt']);
	 	                       ...
	 	                       for(int k = 0; k < subXmlElChildMan.getLength();k++) {  
	 	                        ...
	 	                        if (strDatCd.equals("G0013")) { //if strDatCd  = 'G02' then
	                                  ...
	                                  if ((subXmlElData.getAttribute("use_place_cd")).equals("1") )  { 
	                                      ...
	                                      edETCH_UEAM = edETCH_UEAM.add(new BigDecimal(getTagValue("sum", subXmlElData))); 
	                                      //+ strtofloat(subXmlItemData.NamedItem['sum'].Text);
	                                  if (strResid.equals(yeta2000Vo.getResnRegnNum())) { 
	                                      ...
	                                      // + strtofloat(subXmlItemData.Params.Values['first_year_tot_amt']);
	                                       edETAD_D15L = edETAD_D15L.add(new BigDecimal(MSFSharedUtils.defaultNulls(subXmlElData.getAttribute("second_year_tot_amt"),"0") )); 
	                                      // + strtofloat(subXmlItemData.Params.Values['second_year_tot_amt']);
	                                       // edCARD_ET14 = edCARD_ET14 + strtofloat(subXmlItemData.NamedItem['sum'].Text);
	                                       // edETAD_D14L = edETAD_D14L + strtofloat(subXmlItemData.Params.Values['second_tot_amt']);
	                                   }

	                                      arrMONI_PAY[ddCnt][1]   =  String.valueOf(new BigDecimal(arrMONI_PAY[ddCnt][1]).add(new BigDecimal(getTagValue("sum", subXmlElData))));
	                                  ...
	                                  if (strResid.equals(yeta2000Vo.getResnRegnNum())) { 
	                                     ...
	                                     //   edCARD_ET14 = edCARD_ET14 + strtofloat(subXmlItemData.NamedItem['sum'].Text);
	                                      ...
	                                      arrMONI_PAY[ddCnt][2]   =  String.valueOf(new BigDecimal(arrMONI_PAY[ddCnt][2]).add(new BigDecimal(getTagValue("sum", subXmlElData)))); 
	                                  ...
	                                  if (strResid.equals(yeta2000Vo.getResnRegnNum())) { 
	                                      ...
	                                      arrMONI_PAY[ddCnt][3]   =  String.valueOf(new BigDecimal(arrMONI_PAY[ddCnt][3]).add(new BigDecimal(getTagValue("sum", subXmlElData))));
	                     ...
	                     // oraQryUpdate.ParamByName('ETCH_UEAM').AsFloat :=  edETCH_UEAM; 
	                      ...
	                      yeta2000Vo.setEtchUeam(edETCH_UEAM);
		 	              ...
		 	              yetaPayr6425Service.fnPayr06425_PAYR415_2015_07_Update(yeta2000Vo);
		 	                 
		 	                 
	                   //현금 영수증 종료
	                }
	                else if ((strFormCd.equals("G303Y"))  || (strFormCd.equals("G303M"))) {
	                	/**+++++++++++  직불카드 시작++++++++++++++++++++++++++++++++++++++++++++++++*/
	                	//    직불카드 시작
...
//	                                  edETAD_DD13 :=  edETAD_DD13 + strtofloat(subXmlItemMan.Params.Values['pre_tmoney_tot_amt']);
	 	                       ...
	 	                       for(int k = 0; k < subXmlElChildMan.getLength();k++) {  
	 	                        ...
	 	                        if (strDatCd.equals("G0014")) { //  if strDatCd  = 'G03' then
	                                  ...
	                                  if ((subXmlElData.getAttribute("use_place_cd")).equals("1") )  { 
	                                      ...
	                                      edETCH_BCBS = edETCH_BCBS.add(new BigDecimal(getTagValue("sum", subXmlElData))); 
	                                      // + strtofloat(subXmlItemData.NamedItem['sum'].Text);
	                                  if (strResid.equals(yeta2000Vo.getResnRegnNum())) { 
	                                      ...
	                                      arrBCBS_PAY[ddCnt][1]   = String.valueOf(new BigDecimal(arrBCBS_PAY[ddCnt][1]).add(new BigDecimal(getTagValue("sum", subXmlElData)))); 
	                                  ...
	                                  if (strResid.equals(yeta2000Vo.getResnRegnNum())) { 
	                                      ...
	                                      arrBCBS_PAY[ddCnt][2]   =  String.valueOf(new BigDecimal(arrBCBS_PAY[ddCnt][2]).add(new BigDecimal(getTagValue("sum", subXmlElData))));  
	                                  ...
	                                  if (strResid.equals(yeta2000Vo.getResnRegnNum())) { 
	                                      ...
	                                      arrBCBS_PAY[ddCnt][3]   =  String.valueOf(new BigDecimal(arrBCBS_PAY[ddCnt][3]).add(new BigDecimal(getTagValue("sum", subXmlElData))));
	                    ...
	                    //  oraQryUpdate.ParamByName('ETCH_BCBS').AsFloat :=  edETCH_BCBS;
	                      ...
	                      yeta2000Vo.setEtchBcbs(edETCH_BCBS);
		 	              ...
		 	              yetaPayr6425Service.fnPayr06425_PAYR415_2015_08_Update(yeta2000Vo);
	                   ...
	                   //주택임차차입금 원리금상환액 J101Y 연간합계 J101M 월별 J01 주택임차차입금 원리금 본인
		                       ...
		                       for(int k = 0; k < subXmlElChildMan.getLength();k++) {  
		                         ...
		                         strDatCd = subXmlElData.getAttribute("dat_cd"); 
	                               ...
	                               if (strDatCd.equals("G0016")) {
	                                 ...
	                                 edSpciRefn = edSpciRefn.add(new BigDecimal(getTagValue("sum", subXmlElData)));
	                                 // + strtofloat(subXmlItemData.NamedItem['sum'].Text);
	                     ...
	                     // oraQryUpdate.ParamByName('SPCI_REFN').AsFloat :=  edSpciRefn;
	 	                 ...
	 	                 yetaPayr6425Service.fnPayr06425_PAYR415_spciRefn_2015_Update(yeta2000Vo);
		                       ...
		                       for(int k = 0; k < subXmlElChildMan.getLength();k++) {  
		                         ...
		                         strDatCd = subXmlElData.getAttribute("dat_cd"); 
	                               ...
	                               if (strDatCd.equals("G0017")) {
	                                 ...
	                                 if ((  (getTagValue("start_dt", subXmlElData)).compareTo("20120101") < 0) 
	                                		 && (( (new BigDecimal(getTagValue("repay_years", subXmlElData))).compareTo(new BigDecimal("10")) >= 0) 
	                                	 	&& ( (new BigDecimal(getTagValue("repay_years", subXmlElData))).compareTo(new BigDecimal("15")) < 0) 
	                                		 )) {
	                                 //’03.12.31 이전 차입분으로 상환기간 10년 이상 15년 미만인
	                                   edSpchRe06  = edSpchRe06.add(new BigDecimal(getTagValue("sum", subXmlElData))); 
	                                		   //+ strtofloat(subXmlItemData.NamedItem['sum'].Text);
	                                 }
	                                 else if  (((getTagValue("start_dt", subXmlElData)).compareTo("20120101") < 0) 
	                                		 && (( (new BigDecimal(getTagValue("repay_years", subXmlElData))).compareTo(new BigDecimal("15")) >= 0)   
	                                				 && ( (new BigDecimal(getTagValue("repay_years", subXmlElData))).compareTo(new BigDecimal("30")) < 0)   )) {
	                                 //’12.1.1 이전 차입분으로 다음에 해당하는 경우 공제한도는 연 1,000만원을 적용함
	                                 //- 상환기간 15년 이상 30년 미만인 경우
	                                   edSpchRe10   = edSpchRe10.add(new BigDecimal(getTagValue("sum", subXmlElData))); 
	                                		   //+ strtofloat(subXmlItemData.NamedItem['sum'].Text);
	                                 }
	                                 else if  (((getTagValue("start_dt", subXmlElData)).compareTo("20120101") < 0)   
	                                	    && ( (new BigDecimal(getTagValue("repay_years", subXmlElData))).compareTo(new BigDecimal("30")) >= 0)) {
	                                 // ’12.1.1 이전 차입분으로 상환기간 30년 이상인 경우 
	                                   edSpchRe15   = edSpchRe15.add(new BigDecimal(getTagValue("sum", subXmlElData)));
	                                		   //+ strtofloat(subXmlItemData.NamedItem['sum'].Text);
	                                 } 
	                                 else if  (((getTagValue("start_dt", subXmlElData)).compareTo("20150101") < 0) 
	                                	        &&  ( (new BigDecimal(getTagValue("repay_years", subXmlElData))).compareTo(new BigDecimal("15")) >= 0))  {
	                                  
	                                	 if (( (new BigDecimal(getTagValue("fixed_rate_debt", subXmlElData))).compareTo(BigDecimal.ZERO) > 0)  
	                                		  ||  ( (new BigDecimal(getTagValue("not_defer_debt", subXmlElData))).compareTo(BigDecimal.ZERO) > 0)) {
	                                       //’12.1.1 이후 신규 차입분(차입금 상환기간 연장 포함)으로서 상환기간이 15년 이상인 차입금
	                                       edSPCH_REFX   = edSPCH_REFX.add(new BigDecimal(getTagValue("sum", subXmlElData))); 
	                                    		   //+ strtofloat(subXmlItemData.NamedItem['sum'].Text);
	                                	 }
	                                    else
	                                    {
	                                       //’12.1.1 이후 신규 차입분(차입금 상환 기간 연장 포함)으로서 상환기간이 15년 이상이고
	                                       edSPCH_REEC    = edSPCH_REEC.add(new BigDecimal(getTagValue("sum", subXmlElData)));
	                                   ...
	                                   if ( ( (new BigDecimal(getTagValue("fixed_rate_debt", subXmlElData))).compareTo(BigDecimal.ZERO) > 0)  
	                                       ...
	                                       //’15.1.1 이후 신규 차입분(차입금 상환기간 연장 포함)으로서 상환기간이 15년 이상인 차입금
	                                       edSPCH_15FX   = edSPCH_15FX.add(new BigDecimal(getTagValue("sum", subXmlElData)));
	                                    		   //+ strtofloat(subXmlItemData.NamedItem['sum'].Text);
	                                    } else  if  (( (new BigDecimal(getTagValue("fixed_rate_debt", subXmlElData))).compareTo(BigDecimal.ZERO) > 0)  
                               		     ||  ( (new BigDecimal(getTagValue("not_defer_debt", subXmlElData))).compareTo(BigDecimal.ZERO) > 0)) {
	                                	 
	                                       //’15.1.1 이후 신규 차입분(차입금 상환기간 연장 포함)으로서 상환기간이 15년 이상인 차입금
	                                       edSPCH_15FB  = edSPCH_15FB.add(new BigDecimal(getTagValue("sum", subXmlElData))); 
	                                    		   //+ strtofloat(subXmlItemData.NamedItem['sum'].Text);
	                                    }
	                                    else
	                                    {
	                                       //’15.1.1 이후 신규 차입분(차입금 상환 기간 연장 포함)으로서 상환기간이 15년 이상이고
	                                       edSPCH_15EC    = edSPCH_15EC.add(new BigDecimal(getTagValue("sum", subXmlElData))); 
	                                    		   //+ strtofloat(subXmlItemData.NamedItem['sum'].Text);
	                                    }
	                                 ...
	                                 //- 상환기간 10년 이상 15년 미만인 경우
	                                   if  (( (new BigDecimal(getTagValue("fixed_rate_debt", subXmlElData))).compareTo(BigDecimal.ZERO) > 0)  
	                	                                		  ||  ( (new BigDecimal(getTagValue("not_defer_debt", subXmlElData))).compareTo(BigDecimal.ZERO) > 0)) { 
	                                       //’12.1.1 이후 신규 차입분(차입금 상환기간 연장 포함)으로서 상환기간이 15년 이상인 차입금
	                                       edSPCH_10FB   = edSPCH_10FB.add(new BigDecimal(getTagValue("sum", subXmlElData))); 
	                                       // + strtofloat(subXmlItemData.NamedItem['sum'].Text);
	                                   }
...
//	                      oraQryUpdate.ParamByName('SPCH_REFX').AsFloat :=  edSPCH_REFX;
		 	                ...
		 	                yeta2000Vo.setSpchRe06(edSpchRe06);
	                        yeta2000Vo.setSpchRe10(edSpchRe10);
	                        yeta2000Vo.setSpchRe20(edSpchRe15);
	                        yeta2000Vo.setSpchReec(edSPCH_REEC);
	                        yeta2000Vo.setSpchRefx(edSPCH_REFX);
	                        yeta2000Vo.setSpch15fx(edSPCH_15FX);
	                        yeta2000Vo.setSpch15fb(edSPCH_15FB);
	                        yeta2000Vo.setSpch15ec(edSPCH_15EC);
	                        yeta2000Vo.setSpch10fb(edSPCH_10FB);
	                        
	 	                    yetaPayr6425Service.fnPayr06425_PAYR415_2015_01_Update(yeta2000Vo); 
			                           ...
			                           if (strDatCd.equals("G0018")) {
			                        	   {
			                        		   if (strResid.equals(yeta2000Vo.getResnRegnNum())) { 
					                                ...
					                                if ((getTagValue("saving_gubn", subXmlElData)).equals("1"))  {
					                                    // Y0040050	B011	0050	청약저축					31
					                                      edETCS_COMP = edETCS_COMP.add(new BigDecimal(getTagValue("sum", subXmlElData)));
					                                      //+   strtofloat(subXmlItemData.NamedItem['sum'].Text);
					                                }
					                                else  if ((getTagValue("saving_gubn", subXmlElData)).equals("2"))  {
					                                  //Y0040060	B011	0060	주택청약종합저축       					32
					                                   edETWK_HSBM = edETWK_HSBM.add(new BigDecimal(getTagValue("sum", subXmlElData)));
					                                   // +   strtofloat(subXmlItemData.NamedItem['sum'].Text);
					                                }
					                                else  if ((getTagValue("saving_gubn", subXmlElData)).equals("4"))  {
					                               
					                                   edETWK_HSVM = edETWK_HSVM.add(new BigDecimal(getTagValue("sum", subXmlElData)));
					                                      //+   strtofloat(subXmlItemData.NamedItem['sum'].Text);
					                                  //Y0040080	B011	0080	근로자주택마련저축     					34
					                                }
...
//					                                oraQryInsert.ParamByName('DEDU_AMNT').AsString := '0';
			                     ...
			                     // oraQryUpdate.ParamByName('ETWK_HSVM').AsFloat :=  edETWK_HSVM;
			 	                 ...
			 	                 yetaPayr6425Service.fnPayr06425_PAYR415_2015_02_Update(yeta2000Vo);
		                 ...
		                 for (int j = 0; j < subXmlElChildForm.getLength();j++) { 
		                       ...
		                       for(int k = 0; k < subXmlElChildMan.getLength();k++) {  
	                             ...
	                             if (strDatCd.equals("G0023")) {
	                              ...
	                              edMonyItre = edMonyItre.add(new BigDecimal(getTagValue("sum", subXmlElData))); 
	                         // + strtofloat(subXmlItemData.NamedItem['sum'].Text);
	                             }
		                       }
	                      ...
	                      yeta2000Vo.setEtgdCtra(edMonyItre);
	 	                  ...
	 	                  yetaPayr6425Service.fnPayr06425_PAYR415_2015_03_Update(yeta2000Vo);
	 	                 
	 	                 
	                }
	                else if (strFormCd.equals("K101M")) {
	                	/**+++++++++++   소상공인공제 시작++++++++++++++++++++++++++++++++++++++++++++++++*/
	                	//  소상공인공제 시작
		                	 ...
		                	 subXmlItemMan =  subXmlElChildForm.item(j);  //인원별 데이터
		                       ...
		                       for(int k = 0; k < subXmlElChildMan.getLength();k++) {  
	                             ...
	                             if (strDatCd.equals("G0019")) {
	                              ...
	                              edEtchPrep = edEtchPrep.add(new BigDecimal(getTagValue("sum", subXmlElData))); 
	                               // + strtofloat(subXmlItemData.NamedItem['sum'].Text);
	                             }
		                       }
	                   ...
	                   //  oraQryUpdate.ParamByName('ETCH_PREP').AsFloat :=  ;
		                 ...
		                 yetaPayr6425Service.fnPayr06425_PAYR415_2015_04_Update(yeta2000Vo);
		                 
	                }
	                else if ((strFormCd.equals("L101Y"))    ||  (strFormCd.equals("L101D"))) {
	                	/**+++++++++++    기부금시작++++++++++++++++++++++++++++++++++++++++++++++++*/
	                	//  기부금시작
	                               ...
	                               if (strDatCd.equals("G0020")) {
	                                 ...
	                                 //edSpciFbam, edSpciPltc,edSpciExam,edSpciUnon, edSpciNamt, edSpciYamt, edSPCI_HFAM
	                                  if ((subXmlElData.getAttribute("donation_cd")).equals("10")) { 
	                                      ...
	                                      edSpciFbam = edSpciFbam.add(new BigDecimal(getTagValue("sum", subXmlElData))); 
	                                      // + strtofloat(subXmlItemData.NamedItem['sum'].Text);
	                                      arrSPCI_PAY[ddCnt][1]   =  String.valueOf(new BigDecimal(arrSPCI_PAY[ddCnt][1]).add(new BigDecimal(getTagValue("sum", subXmlElData))));
	                                      ...
	                                      edSpciPltc = edSpciPltc.add(new BigDecimal(getTagValue("sum", subXmlElData))); 
	                                      // + strtofloat(subXmlItemData.NamedItem['sum'].Text);
	                                      arrSPCI_PAY[ddCnt][1]   =   String.valueOf(new BigDecimal(arrSPCI_PAY[ddCnt][1]).add(new BigDecimal(getTagValue("sum", subXmlElData))));
	                                      //floattostr(strtofloat(arrSPCI_PAY[ddCnt][2]) + strtofloat(subXmlItemData.NamedItem['sum'].Text));
	                                  }
	                                  ...
	                                  else  if ((subXmlElData.getAttribute("donation_cd")).equals("30")) {  
	                                      edSpciExam = edSpciExam.add(new BigDecimal(getTagValue("sum", subXmlElData)));  
	                                      // + strtofloat(subXmlItemData.NamedItem['sum'].Text);
	                                      arrSPCI_PAY[ddCnt][1]   =  String.valueOf(new BigDecimal(arrSPCI_PAY[ddCnt][1]).add(new BigDecimal(getTagValue("sum", subXmlElData))));
	                                      // floattostr(strtofloat(arrSPCI_PAY[ddCnt][2]) + strtofloat(subXmlItemData.NamedItem['sum'].Text));
	                                  }
	                                  else  if ((subXmlElData.getAttribute("donation_cd")).equals("31")) { 
	                                
	                                      edSpciUnon = edSpciUnon.add(new BigDecimal(getTagValue("sum", subXmlElData))); 
	                                      // + strtofloat(subXmlItemData.NamedItem['sum'].Text);
	                                      arrSPCI_PAY[ddCnt][1]   =   String.valueOf(new BigDecimal(arrSPCI_PAY[ddCnt][1]).add(new BigDecimal(getTagValue("sum", subXmlElData))));
	                                      //floattostr(strtofloat(arrSPCI_PAY[ddCnt][2]) + strtofloat(subXmlItemData.NamedItem['sum'].Text));
	                                  }
	                                      ...
	                                      edSpciNamt = edSpciNamt.add(new BigDecimal(getTagValue("sum", subXmlElData))); 
	                                      // + strtofloat(subXmlItemData.NamedItem['sum'].Text);
	                                      arrSPCI_PAY[ddCnt][1]   =   String.valueOf(new BigDecimal(arrSPCI_PAY[ddCnt][1]).add(new BigDecimal(getTagValue("sum", subXmlElData)))); 
	                                      //floattostr(strtofloat(arrSPCI_PAY[ddCnt][2]) + strtofloat(subXmlItemData.NamedItem['sum'].Text));
	                                  }
	                                      ...
	                                      edSpciYamt = edSpciYamt.add(new BigDecimal(getTagValue("sum", subXmlElData))); 
	                                      // + strtofloat(subXmlItemData.NamedItem['sum'].Text);
	                                      arrSPCI_PAY[ddCnt][1]   =   String.valueOf(new BigDecimal(arrSPCI_PAY[ddCnt][1]).add(new BigDecimal(getTagValue("sum", subXmlElData)))); 
	                                      //floattostr(strtofloat(arrSPCI_PAY[ddCnt][2]) + strtofloat(subXmlItemData.NamedItem['sum'].Text));
	                                  }
	                                      ...
	                                      edSPCI_HFAM = edSPCI_HFAM.add(new BigDecimal(getTagValue("sum", subXmlElData))); 
	                                      // + strtofloat(subXmlItemData.NamedItem['sum'].Text);
	                                      arrSPCI_PAY[ddCnt][1]   =   String.valueOf(new BigDecimal(arrSPCI_PAY[ddCnt][1]).add(new BigDecimal(getTagValue("sum", subXmlElData)))); 
	                                      //floattostr(strtofloat(arrSPCI_PAY[ddCnt][2]) + strtofloat(subXmlItemData.NamedItem['sum'].Text));
	                                  }
	                                  ...
	                                  if (strFormCd.equals("L101D")) {
										...
										yetaPrc3180Vo.setDpobCd(yeta2000Vo.getDpobCd());    /** column 사업장코드 : dpobCd */
										yetaPrc3180Vo.setEdacRvyy(yeta2000Vo.getEdacRvyy());    /** column 연말정산귀속년도 : edacRvyy */
										yetaPrc3180Vo.setSettGbcd(yeta2000Vo.getSettGbcd());    /** column 정산구분코드 : settGbcd */
										yetaPrc3180Vo.setSystemkey(yeta2000Vo.getSystemkey());    /** column SYSTEMKEY : systemkey */
	                                  ...
	                                  // oraQryDelete.ParamByName('CTRB_TYCD').AsString := subXmlItemData.Params.Values['donation_cd'];      //기부유형코드
	                                   ...
	                                   yetaPayr6425Service.fnPayr06430_PAYR440_2014_Delete(yetaPrc3180Vo);    //삭제  
										...
										yetaPrc3180Vo.setCtrbSeqn(BigDecimal.ZERO);    /** column 기부내역일련번호 : ctrbSeqn */
									     ...
									     yetaPrc3180Vo.setCtrbYrmn(yeta2000Vo.getEdacRvyy());    /** column 기부연도 : ctrbYrmn */
	                                     // oraQryInsert.ParamByName('CTRB_YRMN').AsString := lblEDAC_RVYY.Caption;      //기부연월- 기부년도
	                                      ...
	                                      if ((subXmlElData.getAttribute("donation_cd")).equals("10")) { 
	                                        ...
	                                        // 2012년도 이전 특례기부금이 존재하는 경우
	                                    	   yetaPrc3180Vo.setCtrbDdcd("B0230030");    /** column 기부유형구분코드 : ctrbDdcd */	
		                                        yetaPrc3180Vo.setCtrbTycd(subXmlElData.getAttribute("donation_cd"));    /** column 기부유형코드 : ctrbTycd */
		                                        
	                                    	 // oraQryInsert.ParamByName('CTRB_DDCD').AsString := '6';     //기부유형구분코드
	                                         // oraQryInsert.ParamByName('CTRB_TYCD').AsString := subXmlItemData.Params.Values['donation_cd'];      //기부유형코드
	                                      }
	                                      else  if ((subXmlElData.getAttribute("donation_cd")).equals("31")) { 
	                                         // 2012년도 이전 특례기부금이 존재하는 경우 
	                                    	    yetaPrc3180Vo.setCtrbDdcd("B0230031");    /** column 기부유형구분코드 : ctrbDdcd */	
		                                        yetaPrc3180Vo.setCtrbTycd(subXmlElData.getAttribute("donation_cd"));    /** column 기부유형코드 : ctrbTycd */
		                                        
	                                         // oraQryInsert.ParamByName('CTRB_DDCD').AsString := '7';     //기부유형구분코드
	                                         // oraQryInsert.ParamByName('CTRB_TYCD').AsString := subXmlItemData.Params.Values['donation_cd'];      //기부유형코드
	                                      }
	                                      else  if ((subXmlElData.getAttribute("donation_cd")).equals("40")) { 
										...
										yetaPrc3180Vo.setCtrbAmnt(new BigDecimal(getTagValue("sum", subXmlElData)));    /** column 기부금액 : ctrbAmnt */
										yetaPrc3180Vo.setCrtbCncd(strResid);    /** column 기부자관계구분코드 : crtbCncd */
										yetaPrc3180Vo.setCrnrFlag(strResid);    /** column 기부자내국인구분코드 : crnrFlag */
										yetaPrc3180Vo.setCbtgName(subXmlElMan.getAttribute("name"));    /** column 기부자성명 : cbtgName */
										yetaPrc3180Vo.setRsnoNumb(strResid);    /** column 주민등록번호 : rsnoNumb */
...
//	                                    oraQryInsert.ParamByName('INPT_ADDR').AsString := ''; 
	                                    ...
	                                    yetaPayr6425Service.fnPayr06430_PAYR440_2014_1_Insert(yetaPrc3180Vo); 
	                       ...
	                       yeta2000Vo.setSpciFbam(edSpciFbam);  //A01
	                       yeta2000Vo.setSpciPltc(edSpciPltc);  //A01
	                       yeta2000Vo.setSpciExam(edSpciExam);  //A01
	                       yeta2000Vo.setSpciUnon(edSpciUnon);  //A01
	                       yeta2000Vo.setSpciNamt(edSpciNamt);  //A01
	                       yeta2000Vo.setSpciYamt(edSpciYamt);  //A01
	                       yeta2000Vo.setSpciHfam(edSPCI_HFAM); //A01
	  	                  
	  	                   yetaPayr6425Service.fnPayr06425_PAYR415_2015_10_Update(yeta2000Vo);
			                       ...
			                       for(int k = 0; k < subXmlElChildMan.getLength();k++) {  
			                         ...
			                         if (strDatCd.equals("G0029")) {
			                        	   ...
			                        	   if (strResid.equals(yeta2000Vo.getResnRegnNum())) { 
			                                ...
			                                //Y0040110	B011	0110	장기집합투자증권저축					51
			                                edETEP_SEST = edETEP_SEST.add(new BigDecimal(getTagValue("sum", subXmlElData))); 
			                                        // +   strtofloat(subXmlItemData.NamedItem['sum'].Text);
...
//			                                end ;  }
			                               ...
			                               // oraQryInsert.ParamByName('DEDU_AMNT').AsString := subXmlItemData.NamedItem['ddct_bs_ass_amt'].Text;
											...
											yetaPrc3100Vo.setIcnmYear("");    /** column 납입연차 : icnmYear */
											yetaPrc3100Vo.setPaytAmnt(new BigDecimal(getTagValue("sum", subXmlElData)));    /** column 불입금액 : paytAmnt */
											yetaPrc3100Vo.setDeduAmnt(new BigDecimal(getTagValue("ddct_bs_ass_amt", subXmlElData)));    /** column 세액공제금액 : deduAmnt */
...
//											yetaPrc3100Vo.setRevnAddr(yeta3100Dto.getRevnAddr());    /** column 수정주소 : revnAddr */
	                    ...
	                    //  oraQryUpdate.ParamByName('ETEP_SEST').AsFloat :=  ;
	 	                 ...
	 	                 yetaPayr6425Service.fnPayr06425_PAYR415_2015_05_Update(yeta2000Vo);
...
//	                end;   }
                ...
                yetaPayr6425Service.fnPayr06430_PAYR445_2014_Delete(yetaPrc3150Vo);
	              ...
	              for (int l= 0; l < arrPayr445.length - 1;l++) { 
	                if (MSFSharedUtils.paramNotNull(arrPayr445[l][0])) {
		                ...
		                yetaPrc315001Vo.setDpobCd(yeta2000Vo.getDpobCd());    /** column 사업장코드 : dpobCd */
		                yetaPrc315001Vo.setEdacRvyy(yeta2000Vo.getEdacRvyy());    /** column 연말정산귀속년도 : edacRvyy */
		                yetaPrc315001Vo.setSettGbcd(yeta2000Vo.getSettGbcd());    /** column 정산구분코드 : settGbcd */
		                yetaPrc315001Vo.setSystemkey(yeta2000Vo.getSystemkey());    /** column SYSTEMKEY : systemkey */   
		                ...
		                yetaPrc315001Vo.setRsnoNumb(arrPayr445[l][0]);
		                
		                yetaPayr6425Service.fnPayr06430_PAYR445_1_2014_Insert(yetaPrc315001Vo);
...
//	             oraQryUpdate.ParamByName('SPCI_SCAM').AsFloat := edSpciScam; 
	             ...
	             yeta2000Vo.setSpedSelf(edSpedSelf);
	             yeta2000Vo.setSpedEdam(edSpedEdam);
	             yeta2000Vo.setSpedGdam(edSpedGdam);
	             yeta2000Vo.setSpedCvam(edSpedCvam);
	             yeta2000Vo.setSpciScam(edSpciScam);

                 
                 yetaPayr6425Service.fnPayr06425_PAYR415_2015_11_Update(yeta2000Vo);
                 
	              
	              
	              //이전년도 및 해당년도 사용분 및  본인추가 공제 사용액 
...
//	              oraQryUpdate.ParamByName('ETAD_D15L').AsFloat :=  edETAD_D15L; //기타공제_본인추가공제율사용액2015하반기	None
	              ...
	              yeta2000Vo.setCardEt13(edCARD_ET13);
	              yeta2000Vo.setCardEt14(edCARD_ET14);
	              yeta2000Vo.setEtadDd13(edETAD_DD13);
	              yeta2000Vo.setEtadD14l(edETAD_D14L);
	              yeta2000Vo.setCardEt15(edCARD_ET15);
	              yeta2000Vo.setEtadD15h(edETAD_D15H);
	              yeta2000Vo.setEtadD15l(edETAD_D15L); 
	                 
	              yetaPayr6425Service.fnPayr06425_PAYR415_2015_12_Update(yeta2000Vo);
	           ...
	           //   oraQryUpdate.ParamByName('ETCH_MGVD').AsFloat :=  edETCH_MGVD;
	              ...
	              yetaPayr6425Service.fnPayr06425_PAYR415_2015_13_Update(yeta2000Vo);
	             ...
	             // oraQryUpdate.ParamByName('ETCH_BCED').AsFloat :=  edETCH_BCED;
	              ...
	              yetaPayr6425Service.fnPayr06425_PAYR415_2015_14_Update(yeta2000Vo);
	              ...
	              //--------------------------------
	               ...
	               List lisInfcPkgYeta3220Vo = yetaPayr6425Service.fnPayr06430_PAYR410_2014_SelectAll(yetaPrc3220SrhVo);

	                
	               if  (lisInfcPkgYeta3220Vo.size() > 0) {

                	   Iterator<Map<String, Object>> iter = lisInfcPkgYeta3220Vo.iterator(); 
...
//	                      oraQryUpdate.ParamByName('CTRB_AMNT').AsString  :=   '0';    //기부금액_국세청';
	                   ...
	                   for (int ddCnt01 = 0; ddCnt01 < 10; ddCnt01++) { 
	                	   if (MSFSharedUtils.paramNotNull(arrHDRC_PAY[ddCnt01][0])) {
		                      if  (MSFSharedUtils.defaultNulls(mapYeta3220.get("rsnoNumb"),"").equals(arrHDRC_PAY[ddCnt01][0])) { 
		                    	  
		                    	  yetaPrc3220Vo.setInsuRtyr(new BigDecimal(arrHDRC_PAY[ddCnt01][1]).add(new BigDecimal(arrHDRC_PAY[ddCnt01][2])));    /** column 보험료_건강고용등국세청 : insuPayr */
	                	   ...
	                	   if (MSFSharedUtils.paramNotNull(arrCASH_PAY[ddCnt01][0])) {  
		                      if   (MSFSharedUtils.defaultNulls(mapYeta3220.get("rsnoNumb"),"").equals(arrCASH_PAY[ddCnt01][0])) { 
	                	   ...
	                	   if (MSFSharedUtils.paramNotNull(arrPayr445[ddCnt01][0])) {  
			                      if   (MSFSharedUtils.defaultNulls(mapYeta3220.get("rsnoNumb"),"").equals(arrPayr445[ddCnt01][0])) {  
			                    	 
			                          if (yeta2000Vo.getResnRegnNum().equals(arrPayr445[ddCnt01][0])) {   
	                      ...
	                      //일반
	                	   if (MSFSharedUtils.paramNotNull(arrCARD_PAY[ddCnt01][0])) {    
		                      if   (MSFSharedUtils.defaultNulls(mapYeta3220.get("rsnoNumb"),"").equals(arrCARD_PAY[ddCnt01][0])) { 
	                	   ...
	                	   if (MSFSharedUtils.paramNotNull(arrBCBS_PAY[ddCnt01][0])) {  
		                       if   (MSFSharedUtils.defaultNulls(mapYeta3220.get("rsnoNumb"),"").equals(arrBCBS_PAY[ddCnt01][0])) { 
	                	   ...
	                	   if (MSFSharedUtils.paramNotNull(arrMONI_PAY[ddCnt01][0])) {  
		                       if   (MSFSharedUtils.defaultNulls(mapYeta3220.get("rsnoNumb"),"").equals(arrMONI_PAY[ddCnt01][0]) ){ 
	                      ...
	                      //대중교통
	                	   ...
	                	   if (MSFSharedUtils.paramNotNull(arrSPCI_PAY[ddCnt01][0])) {    
		                       if   (MSFSharedUtils.defaultNulls(mapYeta3220.get("rsnoNumb"),"").equals(arrSPCI_PAY[ddCnt01][0])) { 
...
//						yetaPrc3220Vo.setRevnAddr(yeta3220Dto.getRevnAddr());    /** column 수정주소 : revnAddr */
	                      ...
	                      yetaPayr6425Service.fnPayr06430_PAYR410_2015_01_Update(yetaPrc3220Vo);
		           ...
		           //정산 전자문서 업데이트 쿼리 
		            yetaPayr6425Service.fnPayr06425_PAYR415_0_2014_Update(yeta2000Vo);
 ...
 private void PayrXmlDataUpdate(InfcPkgYeta2000VO yeta2000Vo, Document xmlDoc) {
...
//		                                if ((getTagValue("pension_cd", subXmlElData)).equals("11")) {
//		                                     // Y0040010	B011	0010	근로자퇴직연금보장법.	11
//		                                      edJrtrPsct = edJrtrPsct.add(new BigDecimal(getTagValue("ddct_bs_ass_amt", subXmlElData))) ;
//		                                    		  // +   strtofloat(subXmlItemData.NamedItem['ddct_bs_ass_amt'].Text);
//		                                }
//		                                else if ((getTagValue("pension_cd", subXmlElData)).equals("12")) {
//		                                
//		                                  // Y0040020	B011	0020	과학기술인공제회	12
//		                                   edJRTR_CICT = edJRTR_CICT.add(new BigDecimal(getTagValue("ddct_bs_ass_amt", subXmlElData))) ;  
//		                                		   //+   strtofloat(subXmlItemData.NamedItem['ddct_bs_ass_amt'].Text);
//		                                }
//		                                //else  if (subXmlItemData.NamedItem['pension_cd'].Text)  = '13' then
//		                                //begin
...
//	                   //퇴직연금 종료 
//	                }  else
	                if ((strFormCd.equals("G103Y")) ||  (strFormCd.equals("G103M")))  {
	                	/**+++++++++++신용카드 시작++++++++++++++++++++++++++++++++++++++++++++++++*/
