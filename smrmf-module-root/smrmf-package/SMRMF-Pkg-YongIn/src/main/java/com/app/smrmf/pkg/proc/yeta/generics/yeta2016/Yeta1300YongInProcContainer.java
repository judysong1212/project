 ...
 */
@Controller 
public class Yeta1300YongInProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta1300YongInProcContainer.class);
...
//
    ...
    public Yeta1300YongInProcContainer() {
