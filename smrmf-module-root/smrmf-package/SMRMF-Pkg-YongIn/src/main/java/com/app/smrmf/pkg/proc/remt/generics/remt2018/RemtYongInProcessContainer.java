 ...
 */
@Controller 
public class RemtYongInProcessContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(RemtYongInProcessContainer.class);
    private static final String calledClass = RemtYongInProcessContainer.class.getName();
