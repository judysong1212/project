 ...
 */
@Controller 
public class RetoYongInProcessContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(RetoYongInProcessContainer.class);
