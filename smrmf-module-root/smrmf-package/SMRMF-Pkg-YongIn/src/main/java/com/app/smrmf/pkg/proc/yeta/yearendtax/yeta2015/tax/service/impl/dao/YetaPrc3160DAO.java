...
@Repository("YetaPrc3160DAO")
public class YetaPrc3160DAO extends EgovAbstractDAO {
    ...
    public String insertYeta3160(InfcPkgYeta3160VO vo) throws Exception {
        return (String)insert("yetaPrc3160DAO.insertYetaPrc3160_S", vo);
    }
    ...
    public void updateYeta3160(InfcPkgYeta3160VO vo) throws Exception {
        update("yetaPrc3160DAO.updateYetaPrc3160_S", vo);
    }
    ...
    public void deleteYeta3160(InfcPkgYeta3160VO vo) throws Exception {
        delete("yetaPrc3160DAO.deleteYetaPrc3160_S", vo);
    }
    ...
    public void fnPayr06430_PAYR451_CREATE_Delete(InfcPkgYeta3160VO vo) throws Exception {
        delete("yetaPrc3160DAO.fnPayr06430_PAYR451_CREATE_Delete_S", vo);
    } 
    ...
    public InfcPkgYeta3160VO selectYeta3160(InfcPkgYeta3160VO vo) throws Exception {
        return (InfcPkgYeta3160VO) selectByPk("yetaPrc3160DAO.selectYetaPrc3160_S", vo);
    }
    ...
    public List<?> selectYeta3160List(InfcPkgYeta3160SrhVO searchVO) throws Exception {
        return list("yetaPrc3160DAO.selectYetaPrc3160List_D", searchVO);
    }
    ...
    public int selectYeta3160ListTotCnt(InfcPkgYeta3160SrhVO searchVO) {
        return (Integer)getSqlMapClientTemplate().queryForObject("yetaPrc3160DAO.selectYetaPrc3160ListTotCnt_S", searchVO);
    }
