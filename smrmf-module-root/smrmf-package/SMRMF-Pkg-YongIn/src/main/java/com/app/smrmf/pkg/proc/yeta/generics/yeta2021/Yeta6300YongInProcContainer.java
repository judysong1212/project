 ...
 */
@Controller
public class Yeta6300YongInProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta6300YongInProcContainer.class);
	 
    public Yeta6300YongInProcContainer() {
