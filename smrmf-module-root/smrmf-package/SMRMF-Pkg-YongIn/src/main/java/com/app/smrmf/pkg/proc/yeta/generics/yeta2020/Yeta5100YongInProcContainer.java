 ...
 */
@Controller 
public class Yeta5100YongInProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta5100YongInProcContainer.class);
	  
	 
  
    @Resource(name = "Yeta5100PayrService")
    protected Yeta5100PayrService  yeta2100PayrService;
...
//
    ...
    public Yeta5100YongInProcContainer() {
	...
	public PagingLoadResult<ShowMessageBM> execPayrToYeta_2020_Insert(HttpServletRequest request,List<InfcPkgYe161010_2020_VO> listYe161010VO)throws Exception {
		...
		Yeta5100PkgProcContainer yeta5100 = new Yeta5100PkgProcContainer();   
		return yeta5100.execPayrToYeta_2020_Insert(request, listYe161010VO);
