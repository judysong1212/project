 ...
 */
@Controller 
public class Yeta2100YongInProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta2100YongInProcContainer.class);
...
//
    ...
    public Yeta2100YongInProcContainer() {
