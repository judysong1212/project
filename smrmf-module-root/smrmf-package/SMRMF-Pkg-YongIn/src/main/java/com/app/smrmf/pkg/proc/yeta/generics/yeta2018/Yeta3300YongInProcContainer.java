 ...
 */
@Controller
public class Yeta3300YongInProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta3300YongInProcContainer.class);
	 
    public Yeta3300YongInProcContainer() {
