package com.app.smrmf.pkg.proc.yeta.yearendtax.yeta2017.pdf.xml.web;
...
import com.app.smrmf.pkg.yeta.yeta2017.pdfxml.Yeta2200PkgXmlController;
...
@Controller
public class Yeta2200XmlController {


	private static final Logger logger = LoggerFactory.getLogger(Yeta2200XmlController.class);  
	...
	@RequestMapping(value = "/imp/XmlYeta2200Import.do")
	public String xmlYeta2200Import(@ModelAttribute("InfcPkgYe161010VO") InfcPkgYe161010VO ye161010VO, HttpServletRequest request, 
		...
		if  (yeta2200Service == null) { 
			WebApplicationContext wac = WebApplicationContextUtils.
					getRequiredWebApplicationContext( request.getSession().getServletContext());

			yeta2200Service = (InfcPkgYeta2200Service) wac.getBean("InfcPkgYeta2200Service" ); 

		}
		InfcPkgYe161020VO ye161020VO = new InfcPkgYe161020VO();
		MSFSysm0100BM sessionUser = MSFServerUtils.getLoggedUser(request);
		Yeta2200PkgXmlController yete2200 = new Yeta2200PkgXmlController();
		try	{
						...
						try {
							if (isSuccess) {
								...
								if (v_ret == 1) {
									...
									sResult2 = yete2200.PayrXmlDataInsert(ye161010VO, xmlDoc, request);
									yeta2200Service.yeta2200_Ye161020_2017_Update(ye161020VO);
...
//									System.out.println("데이터 추출에 실패하였습니다.");
	...
	/** 소득공제 신고서 */
	@RequestMapping(value = "/imp/XmlYeta2200DdcImport.do")
	public String xmlYeta2200DdcImport(@ModelAttribute("InfcPkgYe161010VO") InfcPkgYe161010VO ye161010VO, HttpServletRequest request,
			HttpServletResponse response, Model model) throws Exception {
		...
		Yeta2200PkgXmlController yete220 = new Yeta2200PkgXmlController();
		try	{
						...
						try {
							if (isSuccess) {
								...
								if (v_ret == 1) {
									...
									sResult2 = yete220.PayrDdcXmlDataInsert(ye161010VO, xmlDoc, request);
									...
									if (sResult2.equals("1")) 
									{
										...
										//공제 신고서 PDF를 성공적으로 업로드 시 소득공제신고전자파일 제출여부, 적용 여부를 Y 처리한다.
										yeta2200Service.yeta2200_Ye161020_2017_Update(ye161020VO);
