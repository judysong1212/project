 ...
 */
@Controller
public class Yeta5300YongInProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta5300YongInProcContainer.class);
	 
    public Yeta5300YongInProcContainer() {
