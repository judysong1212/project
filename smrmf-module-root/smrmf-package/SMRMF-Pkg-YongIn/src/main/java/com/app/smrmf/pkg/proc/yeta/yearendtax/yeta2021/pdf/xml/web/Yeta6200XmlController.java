package com.app.smrmf.pkg.proc.yeta.yearendtax.yeta2021.pdf.xml.web;
...
import com.app.smrmf.pkg.yeta.yeta2021.pdfxml.Yeta6200PkgXmlController;
...
@Controller
public class Yeta6200XmlController {



	private static final Logger logger = LoggerFactory.getLogger(Yeta6200XmlController.class);  
	...
	@RequestMapping(value = "/imp/XmlYeta6200Import.do")
	public String xmlYeta6200Import(@ModelAttribute("InfcPkgYe161010_2021_VO") InfcPkgYe161010_2021_VO ye161010VO, HttpServletRequest request, 
		...
		if  (yeta6200Service == null) { 
			WebApplicationContext wac = WebApplicationContextUtils.
					getRequiredWebApplicationContext( request.getSession().getServletContext());

			yeta6200Service = (InfcPkgYeta6200Service) wac.getBean("InfcPkgYeta6200Service" ); 

		}
		InfcPkgYe161020_2021_VO ye161020VO = new InfcPkgYe161020_2021_VO();
		MSFSysm0100BM sessionUser = MSFServerUtils.getLoggedUser(request);
		Yeta6200PkgXmlController yete320 = new Yeta6200PkgXmlController();
		try	{
						...
						try {
							if (isSuccess) {
								...
								if (v_ret == 1) {
									...
									yeta6200Service.yeta6200_Ye161020_2021_Update(ye161020VO);
...
//									System.out.println("데이터 추출에 실패하였습니다.");
	...
	/** 소득공제 신고서 */
	@RequestMapping(value = "/imp/XmlYeta6200DdcImport.do")
	public String xmlYeta6200DdcImport(@ModelAttribute("InfcPkgYe161010_2021_VO") InfcPkgYe161010_2021_VO ye161010VO, HttpServletRequest request,
			HttpServletResponse response, Model model) throws Exception {
