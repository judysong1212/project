 ...
 */
@Controller 
public class Yeta6100AnYangProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta6100AnYangProcContainer.class);
    ...
    public Yeta6100AnYangProcContainer() {
