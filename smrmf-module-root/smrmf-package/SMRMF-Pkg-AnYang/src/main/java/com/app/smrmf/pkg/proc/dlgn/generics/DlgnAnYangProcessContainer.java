...
public class DlgnAnYangProcessContainer {
	

	private static final Logger logger = LoggerFactory.getLogger(DlgnAnYangProcessContainer.class);
	   
    @Resource(name = "ManageCommuteService")
    protected ManageCommuteService manageCommuteService;

    public DlgnAnYangProcessContainer() {
        ...
        try {
            ...
            while ( iter.hasNext() ) {
              ...
              //  upInfcDlgn0100Vo.setDilnlazDutyNumDys(infcDlgn0100Vo.getDilnlazDutyNumDys());  /** column 근태_근무일수 : dilnlazDutyNumDys */
                ...
                // 2018.01.11 안양시청 청소행정과 기간제 근로자 반영 작업.. 일단 새로 추가된 필드값들 반영.
                upInfcDlgn0100Vo.setDilnlazSppySnkfNumDys(MSFSharedUtils.allowNulls(mapInfcDlgn0100Tot.get("dilnlazSppySnkfCnt"))); 		/** column 근태_간식비여부 : dilnlazSppySnkfYn */
                upInfcDlgn0100Vo.setDilnlazNgtdyNumDys(MSFSharedUtils.allowNulls(mapInfcDlgn0100Tot.get("dilnlazNgtdyCnt")));    			/** column 근태_숙직여부 : dilnlazNgtdyYn */
