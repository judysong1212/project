 ...
 */
@Controller 
public class RemtAnYangProcessContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(RemtAnYangProcessContainer.class);
    private static final String calledClass = RemtAnYangProcessContainer.class.getName();
