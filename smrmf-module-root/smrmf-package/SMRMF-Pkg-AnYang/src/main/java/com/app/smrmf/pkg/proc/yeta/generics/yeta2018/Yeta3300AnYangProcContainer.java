 ...
 */
@Controller 
public class Yeta3300AnYangProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta3300AnYangProcContainer.class);
	   
     
	
    public Yeta3300AnYangProcContainer() {
