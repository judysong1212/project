 ...
 */
@Controller 
public class Yeta3100AnYangProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta3100AnYangProcContainer.class);
    ...
    public Yeta3100AnYangProcContainer() {
