...
import com.app.smrmf.constc.anyang.ConstAnYang;
 ...
 */
@Controller 
public class PayrAnYangSubProcContainer  extends AbstractCustomServiceImpl {

	private static final Logger logger = LoggerFactory.getLogger(PayrAnYangSubProcContainer.class);
	private static final String calledClass = PayrAnYangSubProcContainer.class.getName();
...
//    protected InComeTaxService inComeTaxService;
    ...
    protected PyspLogSvcYrNumService pyspLogSvcYrNumService; 
        ...
        private int funcPayr4200ToPayrCalc(HttpServletRequest request,InfcPkgPayr0302VO voPayr0302)  throws Exception  {
            ...
            String calledMethod = "funcPayr4200ToPayrCalc";
          ...
          //소득세계산을 위한 메서드 
            ...
            //천원미만 절사 플래그 처리 
            boolean chkPAYR_D9600200 = false; 
            int result = 1;
...
//         	 	        	                  payr0302Vo.setRevnDt(payr0302Vo.getRevnDt());    /** column 수정일자 : revnDt */
                             ...
                             BigDecimal tpPernSubPymtSum = BigDecimal.ZERO;
                             BigDecimal tpDducAmntD9600200 = BigDecimal.ZERO;
                             /**\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\*/
                             //천원미만 금액 공제 대상자에 대해 공제 처리 하는 루틴 추가 
                             /**\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\*/
                             BigDecimal sumD9600200  = new BigDecimal(String.valueOf(tempMap.get("sumD9600200")));
                             tpDducTotAmnt =  tpDducTotAmnt.subtract(sumD9600200); 
                             //공제항목 가져오기  
                             ...
                             //TODO 정상여부 확인 후 주석삭제 
                             chkPAYR_D9600200 = false;
                             
                             for (int iCnt = 0; iCnt < listDducPayr0520.size();iCnt++) {
                             	 
                             	  InfcPkgPayr0520VO payr0520Vo  = new InfcPkgPayr0520VO();
                                   ...
                                   if (MSFSharedUtils.paramNotNull(payr0520Vo) && MSFSharedUtils.paramNotNull(payr0520Vo.getPayItemCd())) { 
                                 	   //천원미만 절사 처리 
                                 	   if (ConstAnYang.PAYR_D9600200.equals(payr0520Vo.getPayItemCd())) {
                                 		   chkPAYR_D9600200 = true;
                                 		   break;
                                 	   }
                                   }	   
                             }
                             ...
                             if (chkPAYR_D9600200) {
                          	      ...
                          	      tpDducAmntD9600200 = tpPernPymtSum.subtract((tpPernPymtSum.setScale(-3,BigDecimal.ROUND_DOWN)));
                          	  
                          	      tpPernSubPymtSum = tpPernPymtSum.subtract(tpDducAmntD9600200);
                                 ...
                                 payr0302Vo.setPayItemCd("D9600200");   /** column 급여항목코드 : payItemCd */
                                 ...
                                 payr0302Vo.setPymtDducSum(tpDducAmntD9600200);   /** column 지급공제금액 : pymtDducSum */
                                 ...
                                 if (BigDecimal.ZERO.compareTo(tpDducAmntD9600200) < 0)  {  
                                	 
                                	 payrCommCalcService.deletePayr0302Payr0307(payr0302Vo); 
                                	 payrCommCalcService.insertPayr0302(payr0302Vo);    
                          		     
                                     tpDducTotAmnt = tpDducTotAmnt.add(tpDducAmntD9600200);		
                                 }
                             } else {
             ...
             //   }
            	...
            	MSFLogHistoryUtils.tracerUserExceptionActivity( sessionUser,  (calledClass + calledMethod), calledClass, "PayrAnYangProcContainer",ex,"","");
                ex.printStackTrace();
                result = 0;
            }       
        ...
        public int createPyspLogSvcYrNumCd(HttpServletRequest request,InfcPkgPayr0400VO payr0400Vo)  throws Exception  {
            int result = 1;
            String calledMethod = "createPyspLogSvcYrNumCd"; 
            MSFSysm0100BM sessionUser = MSFServerUtils.getLoggedUser(request);
