 ...
 */
@Controller 
public class Yeta2300AnYangProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta2300AnYangProcContainer.class);
    ...
    public Yeta2300AnYangProcContainer() {
