 ...
 */
@Controller 
public class Yeta2100AnYangProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta2100AnYangProcContainer.class);
    ...
    public Yeta2100AnYangProcContainer() {
