 ...
 */
@Controller 
public class RetoAnYangProcessContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(RetoAnYangProcessContainer.class);
