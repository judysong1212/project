 ...
 */
@Controller 
public class Yeta5100AnYangProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta5100AnYangProcContainer.class);
    ...
    public Yeta5100AnYangProcContainer() {
