 ...
 */
@Controller 
public class Yeta2100UscProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta2100UscProcContainer.class);
...
//
    ...
    public Yeta2100UscProcContainer() {
