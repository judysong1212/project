 ...
 */
@Controller 
public class Yeta2300UscProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta2300UscProcContainer.class);
    ...
    public Yeta2300UscProcContainer() {
