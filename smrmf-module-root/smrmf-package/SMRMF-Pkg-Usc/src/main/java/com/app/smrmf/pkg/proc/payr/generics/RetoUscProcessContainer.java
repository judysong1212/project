 ...
 */
@Controller 
public class RetoUscProcessContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(RetoUscProcessContainer.class);
