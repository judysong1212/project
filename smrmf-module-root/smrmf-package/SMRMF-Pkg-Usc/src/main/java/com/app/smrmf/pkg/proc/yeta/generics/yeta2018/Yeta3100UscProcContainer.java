 ...
 */
@Controller 
public class Yeta3100UscProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta3100UscProcContainer.class);
...
//
    ...
    public Yeta3100UscProcContainer() {
