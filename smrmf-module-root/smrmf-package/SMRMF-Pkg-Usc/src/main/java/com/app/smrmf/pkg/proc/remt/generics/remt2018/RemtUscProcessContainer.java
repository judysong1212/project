 ...
 */
@Controller 
public class RemtUscProcessContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(RemtUscProcessContainer.class);
    private static final String calledClass = RemtUscProcessContainer.class.getName();
