 ...
 */
@Controller 
public class Yeta3300UscProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta3300UscProcContainer.class);
    ...
    public Yeta3300UscProcContainer() {
