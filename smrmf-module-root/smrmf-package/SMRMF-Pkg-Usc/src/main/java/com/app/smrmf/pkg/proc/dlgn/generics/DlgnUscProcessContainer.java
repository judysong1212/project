...
public class DlgnUscProcessContainer {
	

	private static final Logger logger = LoggerFactory.getLogger(DlgnUscProcessContainer.class);
	   
    @Resource(name = "ManageCommuteService")
    protected ManageCommuteService manageCommuteService;

    public DlgnUscProcessContainer() {
