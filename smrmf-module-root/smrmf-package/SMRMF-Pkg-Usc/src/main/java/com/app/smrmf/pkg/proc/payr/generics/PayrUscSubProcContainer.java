...
public class PayrUscSubProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(PayrUscSubProcContainer.class);
