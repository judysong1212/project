 ...
 */
@Controller 
public class RemtGimHaeProcessContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(RemtGimHaeProcessContainer.class);
    private static final String calledClass = RemtGimHaeProcessContainer.class.getName();
    ...
    private PagingLoadResult<ShowMessageBM> funcRetirementPayrCalc(HttpServletRequest request,ArrayList<InfcPkgRemt2000VO> liseRemt2000)  throws Exception  {
	      ...
	      List<ShowMessageBM>  bmResult = new ArrayList<ShowMessageBM>();
	  	  ...
	  	  try {
	  		...
	  		remtPayrService = (RetirementPayrService)BeanFinder.getBean("RetirementPayrService");
	  		remtCalcService = (RetirementCalculstionService)BeanFinder.getBean("RetirementCalculstionService");
