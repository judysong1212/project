...
public class DlgnGimHaeProcessContainer {
	

	private static final Logger logger = LoggerFactory.getLogger(DlgnGimHaeProcessContainer.class);
	   
    @Resource(name = "ManageCommuteService")
    protected ManageCommuteService manageCommuteService;

    public DlgnGimHaeProcessContainer() {
...
//       }
        ...
        manageCommuteService = (ManageCommuteService)BeanFinder.getBean("ManageCommuteService");
            ...
            while ( iter.hasNext() ) {
              ...
              //  upInfcDlgn0100Vo.setDilnlazDutyNumDys(infcDlgn0100Vo.getDilnlazDutyNumDys());  /** column 근태_근무일수 : dilnlazDutyNumDys */
                ...
                if (ExtermsProps.getProps("EMYMT_DIVCD_02").equals(infcDlgn0100Vo.getEmymtDivCd())) {
	                //totDutyNumDys =(new BigDecimal(MSFSharedUtils.defaultNulls(mapInfcDlgn0100Tot.get("dilnlazDutyTmSm"),"0"))).divide(new BigDecimal(ExtermsProps.getProps("PAYR_BASS_WKTM_201401_01")), 2, BigDecimal.ROUND_HALF_UP) ;
