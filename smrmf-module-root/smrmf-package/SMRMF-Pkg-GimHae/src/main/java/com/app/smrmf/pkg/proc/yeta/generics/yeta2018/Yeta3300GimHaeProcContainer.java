 ...
 */
@Controller 
public class Yeta3300GimHaeProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta3300GimHaeProcContainer.class);
    ...
    public Yeta3300GimHaeProcContainer() {
