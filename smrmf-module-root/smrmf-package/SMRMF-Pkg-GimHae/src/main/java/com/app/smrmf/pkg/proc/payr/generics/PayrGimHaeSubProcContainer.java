 ...
 */
@Controller 
public class PayrGimHaeSubProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(PayrGimHaeSubProcContainer.class);
                          ...
                          //  } 
                            ...
                            //dducTotAmnt  공제총액 
                              ...
                              /************************************20170725  4대보험정리작업전 모듈추가  ******************************/
                               ...
                               // vo 맵핑 오타 
                               // 기존 pkgInsrWorkVo.setSumChkD0010100(String.valueOf(tempMap.get("sumChkD0110100")));   //건강요양보험
                               // -> pkgInsrWorkVo.setSumChkD0110100(String.valueOf(tempMap.get("sumChkD0110100")));   //건강요양보험  으로 변경
