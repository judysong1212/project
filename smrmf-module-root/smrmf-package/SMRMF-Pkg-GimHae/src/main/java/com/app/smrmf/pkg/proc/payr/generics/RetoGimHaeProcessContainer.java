 ...
 */
@Controller 
public class RetoGimHaeProcessContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(RetoGimHaeProcessContainer.class);
    ...
    protected RetroactivityCalculationService RetoCalcService;
	  ...
	  //스케줄링에 따른 급여계산 로직
		...
		public PagingLoadResult<ShowMessageBM> execPayr4210ToPayCalcSeft( HttpServletRequest request,InfcPkgPayr0360VO infcPayr0360Vo,ArrayList<InfcPkgPsnl0100VO> dtoListPsnl0100)  throws Exception  {
          ...
          RetoCalcService = (RetroactivityCalculationService)BeanFinder.getBean("RetroactivityCalculationService");
