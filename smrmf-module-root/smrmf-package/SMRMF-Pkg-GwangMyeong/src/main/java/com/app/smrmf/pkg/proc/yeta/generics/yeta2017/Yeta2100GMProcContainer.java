 ...
 */
@Controller 
public class Yeta2100GMProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta2100GMProcContainer.class);
...
//
    ...
    public Yeta2100GMProcContainer() {
