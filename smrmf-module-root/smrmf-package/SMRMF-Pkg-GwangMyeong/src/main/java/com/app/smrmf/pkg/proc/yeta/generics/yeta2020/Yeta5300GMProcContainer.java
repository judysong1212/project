 ...
 */
@Controller 
public class Yeta5300GMProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta5300GMProcContainer.class);
	   
     
	
    public Yeta5300GMProcContainer() {
