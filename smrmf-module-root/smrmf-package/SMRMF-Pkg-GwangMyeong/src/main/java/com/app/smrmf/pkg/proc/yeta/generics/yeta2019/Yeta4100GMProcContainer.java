 ...
 */
@Controller 
public class Yeta4100GMProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta4100GMProcContainer.class);
...
//
    ...
    public Yeta4100GMProcContainer() {
