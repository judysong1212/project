 ...
 */
@Controller 
public class Yeta6100GMProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta6100GMProcContainer.class);
...
//
    ...
    public Yeta6100GMProcContainer() {
