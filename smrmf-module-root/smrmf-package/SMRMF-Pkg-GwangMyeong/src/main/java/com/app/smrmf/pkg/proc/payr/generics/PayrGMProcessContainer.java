 ...
 */
@Controller 
public class PayrGMProcessContainer  extends AbstractCustomServiceImpl {
	
	private static final Logger logger = LoggerFactory.getLogger(PayrGMProcessContainer.class);
	private static final String calledClass = PayrGMProcessContainer.class.getName();  
      ...
      retval =  new BasePagingLoadResult<ShowMessageBM>(bmResult, 0, bmResult.size()); 
  	 ...
  	 private List<ShowMessageBM>  procEmymtDivCd01(HttpServletRequest request,InfcPkgPayr0250VO dtoPayr0250,InfcPkgPsnl0100VO voPsnl0100,boolean boolInsert)  throws Exception {
	      ...
	      List<ShowMessageBM>  bmResult = new ArrayList<ShowMessageBM>();
	  	  ...
	  	  String calledMethod = "funcPayr4100ToPayrCalc";
          ...
          // int result = 0;
           ...
           BigDecimal tpUsalyAmntHrwgGnty = BigDecimal.ZERO;   //시간외 근무  
                           ...
                           if ("Y".equals(payCalculationVo.getPayRcptYn())) {
                                 ...
                                 //  tpTxtnTotAmnt = BigDecimal.ZERO;             //txtnTotAmnt 과세총액 
                                  ...
                                  pkgInsrWorkVo.setTpWorkIncmTxtnSum(BigDecimal.ZERO);        //과세대상금액
                                   ...
                                   chkMonth = "N";                               //월 출력체크
                                   tpUsalyAmntHrwgGnty =  BigDecimal.ZERO;                      
            ...
            //                                  payr0301Vo.setRevnAddr(payr0250Vo.getRevnAddr());    /** column 수정주소 : revnAddr */ 
                                             ...
                                             if (!("A0030030".equals(payCalculationVo.getHdofcCodtnCd()) 
                                                ...
                                                while (iterpayr0530Set.hasNext() ) {
                                                    ...
                                                    if ("Y".equals(payr0530.getFamyAllwPymtYn())) {
                                                    	if(("B0260030".equals(payr0530.getFamyExtpyDivCd())) && (!PayrServerUtilsGM.getAgeYn(MSFSharedUtils.allowNulls(payr0530.getPayFamyResnRegnNum()).replaceAll("-", ""))) && ("N".equals(payr0306Vo.getDabpnDducYn()))){
                                                    		payr0306Vo.setFamyExtpySum(new BigDecimal("0"));
                                                    	}
                                                    	else if(("B0260045".equals(payr0530.getFamyExtpyDivCd())) && (!PayrServerUtilsGM.getAgeYn(MSFSharedUtils.allowNulls(payr0530.getPayFamyResnRegnNum()).replaceAll("-", ""))) && ("N".equals(payr0306Vo.getDabpnDducYn()))){
                                                    		payr0306Vo.setFamyExtpySum(new BigDecimal("0"));
                                                    	}
                                                    	else if(("B0260060".equals(payr0530.getFamyExtpyDivCd())) && (!PayrServerUtilsGM.getAgeYn(MSFSharedUtils.allowNulls(payr0530.getPayFamyResnRegnNum()).replaceAll("-", ""))) && ("N".equals(payr0306Vo.getDabpnDducYn()))){
                                                    		payr0306Vo.setFamyExtpySum(new BigDecimal("0"));
                                                    	}
                                                    	else{
                                             ...
                                             /*########################################################################################*/     
                                               ...
                                               while ( iterpayr0410Base.hasNext() ) { 
                                            	     ...
                                            	     //시간외근무인경우 전역데이타를 가지고 있어야 야간근무처리 가능으로 수정 
                                            	     if (ExtermsProps.getProps("PAY_EMYMT_PYMT_07").equals(payr0410Be.getPayrImcd())) {   
	                                            	     tpUsalyAmntHrwgGnty = payr0410Be.getUcstSum().compareTo(BigDecimal.ZERO) > 0 ? payr0410Be.getUcstSum() : payr0410Be.getPymtDducSum();  
                                                               ...
                                                               if (abnceNumDysCnt.compareTo(BigDecimal.ZERO) > 0) {
                                                            	   ...
                                                            	   if ((new BigDecimal(MSFSharedUtils.defaultNulls(payCalculationVo.getDilnlazDutyNumDys(),"0")).compareTo((new BigDecimal(MSFSharedUtils.defaultNulls(payCalculationVo.getDilnlazTotDutyNumDys(),"0")))) > 0)) {
                                                                        ...
                                                                        // dayPaySum = dayPayAmt.multiply((new BigDecimal(payCalculationVo.getDilnlazTotDutyNumDys()).add(new BigDecimal(payCalculationVo.getDilnlazAbnceDutyRcgtnDys()))));
                                                                    	 ...
                                                                    	 bmResult.add(new ShowMessageBM(PropPayGenConfs.PAYGEN_INFO,"Payr","[월급여]항목에러" + payCalculationVo.getHanNm() + " 처리중","무기계약직","근무일수보다 근무총일수가 클수 없습니다.")); 
	                                                                  ...
	                                                                  if ((payr0410.getUcstSum().compareTo(BigDecimal.ZERO) > 0 ? payr0410.getUcstSum() : payr0410.getPymtDducSum()).compareTo(BigDecimal.ZERO) > 0) {
	                                                                	  ...
	                                                                	  if (ExtermsProps.getProps("PAY_EMYMT_PYMT_07").equals(payr0410.getPayrImcd())) {
	                                                                          ...
	                                                                          if (new BigDecimal(MSFSharedUtils.defaultNulls(payCalculationVo.getDilnlazTotTmRstDutyTm(),"0")).compareTo(BigDecimal.ZERO) > 0) {
	                                                                                //시간외근무 
	                                                                                  //야근수당 처리를 위해 시간외 근무 금액을 저장 하는 루틴 지원 
	                                                                        	   
	                                                                                  BigDecimal ucstSum = payr0410.getUcstSum().compareTo(BigDecimal.ZERO) > 0 ? payr0410.getUcstSum() : payr0410.getPymtDducSum(); // payr0410.getBefUcstSum().compareTo(BigDecimal.ZERO) > 0 ? payr0410.getBefUcstSum() : ();
	                                                                       ...
	                                                                       // 야간수당       -- 시간산정C9410300
	                                                                          if (new BigDecimal(MSFSharedUtils.defaultNulls(payCalculationVo.getDilnlazTotNtotTm(),"0")).compareTo(BigDecimal.ZERO) > 0) {
	                                                                              ...
	                                                                              totTmSum = //(((new BigDecimal(payCalculationVo.getDilnlazTotNtotTm())).multiply(tpUsalyAmntHrwgGnty)).add(
	                                                                            		  ((new BigDecimal(payCalculationVo.getDilnlazTotNtotTm())).multiply(ucstSum)).setScale(-1,BigDecimal.ROUND_DOWN);  //시간외근무
                                                                               ...
                                                                               //   if ((new BigDecimal(MSFSharedUtils.defaultNulls(payCalculationVo.getDilnlazAbnceNumDys(),"0"))).compareTo(BigDecimal.ZERO) > 0) {
                                                                                  if (abnceNumDysCnt.compareTo(BigDecimal.ZERO) > 0) {
                                                                                	...
                                                                                	//  if ((new BigDecimal(MSFSharedUtils.defaultNulls(payCalculationVo.getDilnlazDutyNumDys(),"0")).compareTo((new BigDecimal(MSFSharedUtils.defaultNulls(payCalculationVo.getDilnlazTotDutyNumDys(),"0"))).add((new BigDecimal(MSFSharedUtils.defaultNulls(payCalculationVo.getDilnlazAbnceNumDys(),"0"))))) > 0)) {
	                                                                                  ...
	                                                                                  }  else  if ((new BigDecimal(MSFSharedUtils.defaultNulls(payCalculationVo.getDilnlazDutyNumDys(),"0")).compareTo((new BigDecimal(payCalculationVo.getDilnlazTotDutyNumDys()))) == 0)) {
	                                                                                  ...
	                                                                                  if ((new BigDecimal(MSFSharedUtils.defaultNulls(payCalculationVo.getDilnlazDutyNumDys(),"0")).compareTo((new BigDecimal(MSFSharedUtils.defaultNulls(payCalculationVo.getDilnlazTotDutyNumDys(),"0")))) > 0)) {
	                                                                                	   ...
	                                                                                	   dayPaySum = (ucstSum.divide((new BigDecimal(payCalculationVo.getDilnlazDutyNumDys())),3, BigDecimal.ROUND_UP)).multiply((new BigDecimal(payCalculationVo.getDilnlazTotDutyNumDys()))).setScale(-1, 1);
	                                                                                	   //.add(new BigDecimal(payCalculationVo.getDilnlazAbnceDutyRcgtnDys()))
	      ...
	      //                                          payr0302Vo.setRevnAddr(payr0302Vo.getRevnAddr());    /** column 수정주소 : revnAddr */   
	                                                  if (BigDecimal.ZERO.compareTo(payr0302Vo.getPymtDducSum()) != 0)  {
	                                                   //수당 급여 금액 
	                                                        ...
	                                                        tpFreeDtyTotAmnt = tpFreeDtyTotAmnt.add(new BigDecimal(MSFSharedUtils.defaultNulls(payr0520Vo.getPymtDducFreeDtySum(),"0")));//비과세금액 
	                                                             
	                                                  } else if (BigDecimal.ZERO.compareTo(new BigDecimal(MSFSharedUtils.defaultNulls(payr0520Vo.getPymtDducRate(),"0"))) != 0)  {
	                                                	     //급여수당 비율  전체 지급이므로 
	            ...
	            //                                          payr0302Vo.setRevnAddr(payr0302Vo.getRevnAddr());    /** column 수정주소 : revnAddr */   
                                	   ...
                                	   //휴직자인경우 공제, 지급관련에 대해 처리 하는 부분 임시 추가 
			                                               ...
			                                               if (BigDecimal.ZERO.compareTo(payr0302Vo.getPymtDducSum()) != 0)  {
			                                                //수당 급여 금액 
			                                                     ...
			                                                     tpFreeDtyTotAmnt = tpFreeDtyTotAmnt.add(new BigDecimal(MSFSharedUtils.defaultNulls(payr0520Vo.getPymtDducFreeDtySum(),"0")));//비과세금액 
			                                             	     ...
			                                             	     //급여수당 비율  전체 지급이므로 
			                                            	      BigDecimal pymtDducRate = BigDecimal.ZERO;
			                                            	      
			                                            	      if (BigDecimal.ZERO.compareTo(basePymtAmnt) < 0) {
			                                            	    	  pymtDducRate = (basePymtAmnt.multiply((new BigDecimal(MSFSharedUtils.defaultNulls(payr0520Vo.getPymtDducRate(),"0")))
			                                            	    			                               .divide(new BigDecimal("100"), 5, BigDecimal.ROUND_DOWN))).setScale(-1,BigDecimal.ROUND_DOWN);
			                                            	      } else {
        ...
        //                                                  payr0302Vo.setRevnAddr(payr0302Vo.getRevnAddr());    /** column 수정주소 : revnAddr */   
                                                        ...
                                                        if ((payr0410.getUcstSum().compareTo(BigDecimal.ZERO) > 0 ? payr0410.getUcstSum() : payr0410.getPymtDducSum()).compareTo(BigDecimal.ZERO) > 0) {
                                                            if (ExtermsProps.getProps("PAY_EMYMT_PYMT_07").equals(payr0410.getPayrImcd())) {
                                                            	...
                                                            	//tpUsalyAmntHrwgGnty = payr0410.getUcstSum().compareTo(BigDecimal.ZERO) > 0 ? payr0410.getUcstSum() : payr0410.getPymtDducSum(); //payr0410.getBefUcstSum().compareTo(BigDecimal.ZERO) > 0 ? payr0410.getBefUcstSum() : ();
                                                               //    if (payr0250Vo.getJobYrMnth().substring(4,6).equals("12")) { 
                                                               // 	   tpUsalyAmntHrwgGnty = payr0410.getUcstSum().compareTo(BigDecimal.ZERO) > 0 ? payr0410.getUcstSum() : payr0410.getPymtDducSum();
                                                               //    } 
                                                             ...
                                                             // 야간수당       -- 시간산정C9410300
                                                                ...
                                                                totTmSum =  //(((new BigDecimal(MSFSharedUtils.defaultNulls(payCalculationVo.getDilnlazTotNtotTm(),"0"))).multiply(tpUsalyAmntHrwgGnty))
                                                                		     ((new BigDecimal(MSFSharedUtils.defaultNulls(payCalculationVo.getDilnlazTotNtotTm(),"0"))).multiply(ucstSum)).setScale(-1,BigDecimal.ROUND_DOWN);  //시간외근무
                                                              ...
                                                              // 휴일수당        -- 일수 C9410200
                                                                ...
                                                                totTmSum = (new BigDecimal(MSFSharedUtils.defaultNulls(payCalculationVo.getDilnlazPaidPubcHodyNum(),"0"))).multiply(ucstSum).setScale(-1,BigDecimal.ROUND_DOWN);  //토요근무수당 
...
//                                                          //  } 
                                                     ...
                                                     //월급여내역 합계를 구한다. 
                                                       // 월급여내역  업데이트한다. - 이후 급여합계은 업데이트 한다.   
// TODO 소득세 처리 제외 20170712-UPDATE                                                       
              				                           pkgInsrWorkVo.setTpTxtnTotAmnt(tpPymtTotAmnt.subtract(tpFreeDtyTotAmnt)); 
                                                          //과세대상금액 
//                                                        pkgInsrWorkVo.setTpWorkIncmTxtnSum(BigDecimal.ZERO); //과세대상금액  
                                                      txTotAmnt =  BigDecimal.ZERO;    //과세합계
        ...
        //                                                 payr0302Vo.setRevnAddr(payr0302Vo.getRevnAddr());    /** column 수정주소 : revnAddr */   
                                                       ...
                                                       if ((payr0410.getUcstSum().compareTo(BigDecimal.ZERO) > 0 ? payr0410.getUcstSum() : payr0410.getPymtDducSum()).compareTo(BigDecimal.ZERO) > 0) {
                                                           if (ExtermsProps.getProps("PAY_EMYMT_PYMT_07").equals(payr0410.getPayrImcd())) {
                                                            ...
                                                            // 야간수당       -- 시간산정C9410300  0.5 %가산하여 지급한다. 
   ...
   //                                                   payr0302Vo.setRevnAddr(payr0302Vo.getRevnAddr());    /** column 수정주소 : revnAddr */   
        ...
        //                                  payr0301Vo.setRevnAddr(payr0250Vo.getRevnAddr());    /** column 수정주소 : revnAddr */ 
             ...
             // retval =  new BasePagingLoadResult<ShowMessageBM>(bmResult, 0, bmResult.size());  
               ...
               ex.printStackTrace();  
               MSFLogHistoryUtils.tracerUserExceptionActivity( sessionUser,  (calledClass + calledMethod), calledClass, "PayrGMProcContainer",ex,"","");
...
//	                                                                tpFreeDtyTotAmnt = tpFreeDtyTotAmnt.add(payr0490.getFreeDtySum());
	                                                               ...
	                                                               if (ExtermsProps.getProps("PAY_EMYMT_PYMT_19").equals(payr0490.getPayItemCd()) && (ExtermsProps.getProps("PAY_EMYMT_DYMNTH_01").equals(payr0490.getDayMnthAmntDivCd())) 
	                                                                   ...
	                                                                   //총 근무일수  * 본봉
	                                                                   tpEmymtAmnt = (new BigDecimal(payCalculationVo.getDilnlazTotDutyNumDys()).add(new BigDecimal(MSFSharedUtils.defaultNulls(payCalculationVo.getDilnlazAbnceDutyRcgtnDys(),"0"))).multiply(payr0490.getPymtDducSum())).setScale(-1,BigDecimal.ROUND_DOWN); 
	                                                             ...
	                                                             //  BigDecimal tpEmymtC9410700Amnt = BigDecimal.ZERO;
	                                                               ...
	                                                               if (ExtermsProps.getProps("PAY_EMYMT_PYMT_04").equals(payr0490.getPayItemCd()) && (ExtermsProps.getProps("PAY_EMYMT_DYMNTH_01").equals(payr0490.getDayMnthAmntDivCd())) 
	                                                                   ...
	                                                                   tpEmymtAmnt = (new BigDecimal(MSFSharedUtils.defaultNulls(payCalculationVo.getDilnlazSatDutyNumDys(),"0")).multiply(payr0490.getPymtDducSum())).setScale(-1,BigDecimal.ROUND_DOWN); 
...
//	                                                                  } 
	                                                              ...
	                                                              // BigDecimal tpEmymtC9410100Amnt = BigDecimal.ZERO; 
	                                                               ...
	                                                               if (ExtermsProps.getProps("PAY_EMYMT_PYMT_07").equals(payr0490.getPayItemCd()) && (ExtermsProps.getProps("PAY_EMYMT_DYMNTH_04").equals(payr0490.getDayMnthAmntDivCd())) 
	                                                                   ...
	                                                                   tpEmymtAmnt = (new BigDecimal(MSFSharedUtils.defaultNulls(payCalculationVo.getDilnlazTotTmRstDutyTm(),"0")).multiply(payr0490.getPymtDducSum())).setScale(-1,BigDecimal.ROUND_DOWN); 
