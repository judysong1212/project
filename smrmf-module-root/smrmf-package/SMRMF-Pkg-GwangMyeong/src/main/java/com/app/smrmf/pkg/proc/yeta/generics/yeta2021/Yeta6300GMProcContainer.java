 ...
 */
@Controller 
public class Yeta6300GMProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta6300GMProcContainer.class);
	   
     
	
    public Yeta6300GMProcContainer() {
