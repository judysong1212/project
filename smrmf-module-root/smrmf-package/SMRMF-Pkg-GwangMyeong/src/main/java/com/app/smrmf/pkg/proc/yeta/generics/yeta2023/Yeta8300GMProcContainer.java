 ...
 */
@Controller 
public class Yeta8300GMProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta8300GMProcContainer.class);
	   
     
	
    public Yeta8300GMProcContainer() {
