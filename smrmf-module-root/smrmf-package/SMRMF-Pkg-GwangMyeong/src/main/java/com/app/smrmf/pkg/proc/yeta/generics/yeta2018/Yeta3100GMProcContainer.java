 ...
 */
@Controller 
public class Yeta3100GMProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta3100GMProcContainer.class);
...
//
    ...
    public Yeta3100GMProcContainer() {
