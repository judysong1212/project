 ...
 */
@Controller 
public class Yeta5100GMProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta5100GMProcContainer.class);
...
//
    ...
    public Yeta5100GMProcContainer() {
