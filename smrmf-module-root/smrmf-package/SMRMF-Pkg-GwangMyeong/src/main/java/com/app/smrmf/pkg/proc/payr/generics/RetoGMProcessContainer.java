 ...
 */
@Controller 
public class RetoGMProcessContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(RetoGMProcessContainer.class);
