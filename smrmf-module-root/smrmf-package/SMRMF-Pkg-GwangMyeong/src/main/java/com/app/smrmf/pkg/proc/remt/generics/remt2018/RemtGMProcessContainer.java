 ...
 */
@Controller 
public class RemtGMProcessContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(RemtGMProcessContainer.class);
    private static final String calledClass = RemtGMProcessContainer.class.getName();
