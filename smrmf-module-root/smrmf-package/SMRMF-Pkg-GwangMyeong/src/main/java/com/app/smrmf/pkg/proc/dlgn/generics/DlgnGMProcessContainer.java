...
public class DlgnGMProcessContainer {
	

	private static final Logger logger = LoggerFactory.getLogger(DlgnGMProcessContainer.class);
	   
    @Resource(name = "ManageCommuteService")
    protected ManageCommuteService manageCommuteService;

    public DlgnGMProcessContainer() {
...
//            searchVO.setDpobCd(""); 
   ...
   */
    public int setUpdateManageInfcDlgn0100HHMiCommuteService(HttpServletRequest request,InfcPkgDlgn0100VO infcDlgn0100Vo) throws Exception{
        ...
        if("A0020010".equals(infcDlgn0100SrhVo.getEmymtDivCd())){ //무기계약직일경우
        	logger.debug("무기계약직select");
