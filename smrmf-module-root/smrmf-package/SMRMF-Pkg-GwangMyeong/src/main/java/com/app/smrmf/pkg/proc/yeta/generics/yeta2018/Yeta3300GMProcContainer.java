 ...
 */
@Controller 
public class Yeta3300GMProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta3300GMProcContainer.class);
	   
     
	
    public Yeta3300GMProcContainer() {
