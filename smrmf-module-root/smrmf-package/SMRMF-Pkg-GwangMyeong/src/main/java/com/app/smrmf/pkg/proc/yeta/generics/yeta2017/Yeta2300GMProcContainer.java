 ...
 */
@Controller 
public class Yeta2300GMProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta2300GMProcContainer.class);
    ...
    public Yeta2300GMProcContainer() {
