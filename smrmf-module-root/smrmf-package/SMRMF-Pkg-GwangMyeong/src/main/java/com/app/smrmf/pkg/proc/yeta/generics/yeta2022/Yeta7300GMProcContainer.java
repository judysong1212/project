 ...
 */
@Controller 
public class Yeta7300GMProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta7300GMProcContainer.class);
	   
     
	
    public Yeta7300GMProcContainer() {
