 ...
 */
@Controller 
public class Yeta4300GMProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta4300GMProcContainer.class);
	   
     
	
    public Yeta4300GMProcContainer() {
