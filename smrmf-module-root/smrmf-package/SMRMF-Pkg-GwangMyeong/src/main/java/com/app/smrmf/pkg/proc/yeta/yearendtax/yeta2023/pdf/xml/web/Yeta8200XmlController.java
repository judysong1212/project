package com.app.smrmf.pkg.proc.yeta.yearendtax.yeta2023.pdf.xml.web;
...
import com.app.smrmf.pkg.yeta.yeta2023.pdfxml.Yeta8200PkgXmlController;
...
@Controller
public class Yeta8200XmlController {



	private static final Logger logger = LoggerFactory.getLogger(Yeta8200XmlController.class);  
	...
	@RequestMapping(value = "/imp/XmlYeta8200Import.do")
	public String xmlYeta8200Import(@ModelAttribute("InfcPkgYe161010_2023_VO") InfcPkgYe161010_2023_VO ye161010VO, HttpServletRequest request, 
		...
		if  (yeta8200Service == null) { 
			WebApplicationContext wac = WebApplicationContextUtils.
					getRequiredWebApplicationContext( request.getSession().getServletContext());

			yeta8200Service = (InfcPkgYeta8200Service) wac.getBean("InfcPkgYeta8200Service" ); 

		}
		InfcPkgYe161020_2023_VO ye161020VO = new InfcPkgYe161020_2023_VO();
		MSFSysm0100BM sessionUser = MSFServerUtils.getLoggedUser(request);
		Yeta8200PkgXmlController yete320 = new Yeta8200PkgXmlController();
		try	{
						...
						try {
							if (isSuccess) {
								...
								if (v_ret == 1) {
									...
									yeta8200Service.yeta8200_Ye161020_2023_Update(ye161020VO);
...
//									System.out.println("데이터 추출에 실패하였습니다.");
	...
	/** 소득공제 신고서 */
	@RequestMapping(value = "/imp/XmlYeta8200DdcImport.do")
	public String xmlYeta8200DdcImport(@ModelAttribute("InfcPkgYe161010_2023_VO") InfcPkgYe161010_2023_VO ye161010VO, HttpServletRequest request,
			HttpServletResponse response, Model model) throws Exception {
