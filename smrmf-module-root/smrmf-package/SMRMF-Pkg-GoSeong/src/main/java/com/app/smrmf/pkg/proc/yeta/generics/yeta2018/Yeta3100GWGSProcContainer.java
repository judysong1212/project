 ...
 */
@Controller 
public class Yeta3100GWGSProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta3100GWGSProcContainer.class);
...
//
    ...
    public Yeta3100GWGSProcContainer() {
