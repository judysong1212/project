 ...
 */
@Controller 
public class Yeta3300GWGSProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta3300GWGSProcContainer.class);
    ...
    public Yeta3300GWGSProcContainer() {
