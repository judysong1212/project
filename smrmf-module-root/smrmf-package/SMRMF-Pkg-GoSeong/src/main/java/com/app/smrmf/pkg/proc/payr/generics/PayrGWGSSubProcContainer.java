 ...
 */
@Controller 
public class PayrGWGSSubProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(PayrGWGSSubProcContainer.class);
