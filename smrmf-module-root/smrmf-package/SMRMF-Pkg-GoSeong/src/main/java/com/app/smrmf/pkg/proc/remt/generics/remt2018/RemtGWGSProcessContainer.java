 ...
 */
@Controller 
public class RemtGWGSProcessContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(RemtGWGSProcessContainer.class);
    private static final String calledClass = RemtGWGSProcessContainer.class.getName();
