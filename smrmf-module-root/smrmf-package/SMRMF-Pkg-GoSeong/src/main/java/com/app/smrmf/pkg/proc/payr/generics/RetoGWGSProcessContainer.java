 ...
 */
@Controller 
public class RetoGWGSProcessContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(RetoGWGSProcessContainer.class);
