...
public class DlgnGWGSProcessContainer {
	

	private static final Logger logger = LoggerFactory.getLogger(DlgnGWGSProcessContainer.class);
	   
    @Resource(name = "ManageCommuteService")
    protected ManageCommuteService manageCommuteService;

    public DlgnGWGSProcessContainer() {
