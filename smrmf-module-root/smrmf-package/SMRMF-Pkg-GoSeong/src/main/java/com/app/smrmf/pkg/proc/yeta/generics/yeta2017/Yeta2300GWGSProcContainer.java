 ...
 */
@Controller 
public class Yeta2300GWGSProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta2300GWGSProcContainer.class);
    ...
    public Yeta2300GWGSProcContainer() {
