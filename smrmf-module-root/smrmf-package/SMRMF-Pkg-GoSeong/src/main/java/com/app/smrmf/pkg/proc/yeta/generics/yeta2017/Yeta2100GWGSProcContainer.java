 ...
 */
@Controller 
public class Yeta2100GWGSProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta2100GWGSProcContainer.class);
...
//
    ...
    public Yeta2100GWGSProcContainer() {
