 ...
 */
@Controller 
public class Yeta2100GoeSanProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta2100GoeSanProcContainer.class);
...
//
    ...
    public Yeta2100GoeSanProcContainer() {
