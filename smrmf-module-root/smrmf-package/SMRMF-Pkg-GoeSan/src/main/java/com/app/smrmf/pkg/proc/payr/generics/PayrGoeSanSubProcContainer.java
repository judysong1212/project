 ...
 */
@Controller 
public class PayrGoeSanSubProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(PayrGoeSanSubProcContainer.class);
