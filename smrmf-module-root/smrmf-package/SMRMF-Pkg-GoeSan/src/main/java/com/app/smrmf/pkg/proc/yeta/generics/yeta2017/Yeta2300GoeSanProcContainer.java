 ...
 */
@Controller 
public class Yeta2300GoeSanProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta2300GoeSanProcContainer.class);
    ...
    public Yeta2300GoeSanProcContainer() {
