 ...
 */
@Controller 
public class Yeta3100GoeSanProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta3100GoeSanProcContainer.class);
...
//
    ...
    public Yeta3100GoeSanProcContainer() {
