 ...
 */
@Controller 
public class PayrA002001001_B0150006CalcProc  extends AbstractCustomServiceImpl {
	 

	private static final Logger logger = LoggerFactory.getLogger(PayrA002001001_B0150006CalcProc.class);
   ...
   protected PayrCommCalcService payrCommCalcService;
     ...
     * 생성자 
     */
     public PayrA002001001_B0150006CalcProc () {
      ...
      * 2. 처리내용 : 
      * </pre>
      * @Method Name : callProcMethedPayrA0020010_B0150006
      * @date : 2017. 10. 12.
      * @author : atres
      * @history : 
      *	-----------------------------------------------------------------------
      ...
      * @param pkgInsrWorkVo
      */
	public void callProcMethedPayrA0020010_B0150006(HttpServletRequest request, InfcPkgPayr0250VO payr0250Vo,
