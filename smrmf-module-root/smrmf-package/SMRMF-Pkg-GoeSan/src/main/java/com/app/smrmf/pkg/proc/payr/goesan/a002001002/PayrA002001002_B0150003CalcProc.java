...
//                                                   payr0302Vo.setRevnAddr(payr0302Vo.getRevnAddr());    /** column 수정주소 : revnAddr */   
                             ...
                             if ("201711".compareTo(payr0250Vo.getJobYrMnth()) > 0) {
                                 ...
                                 totBnusAmnt = (baseBnusAmnt.multiply((payr0417.getPymtDducRate().divide(new BigDecimal("100"))))).setScale(-1,BigDecimal.ROUND_DOWN) ;
                                 
                                 payr0302Vo.setPymtDducSum(totBnusAmnt);   /** column 지급공제금액 : pymtDducSum */
                                 payr0302Vo.setPymtDducTxtnAmnt(totBnusAmnt.subtract(payr0417.getFreeDtySum()).setScale(-1,BigDecimal.ROUND_DOWN) );    /** column 지급공제과세금액 : pymtDducTxtnAmnt */ 
