 ...
 */
@Controller 
public class Yeta3300GoeSanProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta3300GoeSanProcContainer.class);
    ...
    public Yeta3300GoeSanProcContainer() {
