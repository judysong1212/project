 ...
 */
@Controller 
public class PayrA002001001_B0150002CalcProc  extends AbstractCustomServiceImpl {
	 

	private static final Logger logger = LoggerFactory.getLogger(PayrA002001001_B0150002CalcProc.class);
   ...
   protected PayrCommCalcService payrCommCalcService;
     ...
     * 생성자 
     */
     public PayrA002001001_B0150002CalcProc () {
                                           ...
                                           //    if ((new BigDecimal(payCalculationVo.getDilnlazDutyNumDys()).compareTo((new BigDecimal(payCalculationVo.getDilnlazTotDutyNumDys()))) > 0)) {
                                              if (abnceNumDysCnt.compareTo(BigDecimal.ZERO) > 0) {
                                                     ...
                                                     dayPaySum = (mothPayAmt.divide((new BigDecimal(payCalculationVo.getDilnlazDutyNumDys())),5, BigDecimal.ROUND_UP))
                                                    		 .multiply((new BigDecimal(payCalculationVo.getDilnlazTotDutyNumDys()).add(abnceNumDysCnt))).setScale(-1, 1);
