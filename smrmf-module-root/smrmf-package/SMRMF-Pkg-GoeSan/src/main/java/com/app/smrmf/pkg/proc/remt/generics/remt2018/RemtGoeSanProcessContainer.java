 ...
 */
@Controller 
public class RemtGoeSanProcessContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(RemtGoeSanProcessContainer.class);
    private static final String calledClass = RemtGoeSanProcessContainer.class.getName();
