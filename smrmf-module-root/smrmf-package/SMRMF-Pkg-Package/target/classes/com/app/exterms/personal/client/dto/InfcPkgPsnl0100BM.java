 ...
 * @Description : Psnl0100VO VO class
 ...
 */
public class InfcPkgPsnl0100BM   extends MSFSimpleBaseModel implements IsSerializable  {
    ...
    /** 생성자 */
     public InfcPkgPsnl0100BM() { super(); } 

    /** 일괄등록 처리   */
     public InfcPkgPsnl0100BM(
    		 String  dpobCd 
    		, String  systemkey 
    		, String  hanNm 
    		, String  engNm 
    ...
    /** set null : secResnNum */
    public void setSecResnNum(String  secResnNum) { set( ATTR_SECRESNNUM ,secResnNum);}
    /** get null : secResnNum */
    public String  getSecResnNum() { return (String )get( ATTR_SECRESNNUM );}
    /** set null : orgResnNum */
    public void setOrgResnNum(String  orgResnNum) { set( ATTR_ORGRESNNUM ,orgResnNum);}
    /** get null : orgResnNum */
    public String  getOrgResnNum() { return (String )get( ATTR_ORGRESNNUM );}
    /** set 노조가입여부 : unnMbspSttYn */
