...
=====================================================**/
public class InfcPkgRemtWfep0100Def  extends TableDef implements InfcPkgRemtDaoConstants {
...
//    private RemtConstants remtLabel = RemtConstants.INSTANCE;
    ...
    public InfcPkgRemtWfep0100Def(String chkData){ 
    ...
    public List<ColumnDef> getRemtWfep0100(){
		...
		listColumnDefs.add(new ColumnDef("항목", InfcPkgRemtPayr0100BM.ATTR_PAYITEMNM, ColumnDef.TYPE_STRING , 200, true, true, true){
			{
				 setReadOnly(true);
			}
		});
		...
		listColumnDefs.add(new ColumnDef("개월", InfcPkgRemt2000BM.ATTR_TOTLOGSVCNUMDYS, ColumnDef.TYPE_STRING , 100, true, true, true){
			{
				 setReadOnly(true);
			}
		});
		/** column 퇴직금지급액 : sevePayPymtSum */
		listColumnDefs.add(new ColumnDef("지급금액", InfcPkgRemt2000BM.ATTR_SEVEPAYPYMTSUM, ColumnDef.TYPE_LONG , 200, true, true, true){
			{
				setRegEx("^[+-]?\\d*(\\.?\\d*)$");  
