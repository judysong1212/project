 ...
 */
@Controller 
public class Yeta8300SubtTaxStdDdcPkgProc  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta8300SubtTaxStdDdcPkgProc.class);
	   
    @Resource(name = "Yeta8300PayrService")
    protected Yeta8300PayrService  infcPkgYeta8300;
    
 
    public Yeta8300SubtTaxStdDdcPkgProc() {
    	
    } 
    
    public List<ShowMessageBM> execSubtTaxStdDdcPkgProc(HttpServletRequest request,InfcPkgYe161010_2023_VO  infcPkgYe161010Vo)  throws Exception  {
    ...
    * @throws Exception
    */
    private  List<ShowMessageBM> YetaTaxCreateUpdate(HttpServletRequest request,InfcPkgYe161010_2023_VO  infcPkgYe161010Vo) throws Exception {
    ...
    private  List<ShowMessageBM> YetaTaxStdUpdate(HttpServletRequest request,InfcPkgYe161010_2023_VO  infcPkgYe161010Vo) throws Exception {
 	...
 	BeanUtils.copyProperties(infcPkgYe169010AVo, infcPkgYe161010Vo); 
       ...
       //   ---------------------특별공제 종합한도초과액 - 기타공제계-----------------
 			...
 			statCnt = 0;
 			statCnt = infcPkgYeta8300.fnYeta8300_YE169010a_Tax_2023_3001_Update(infcPkgYe169010AVo);
 			if (statCnt >= 0) {
 			/**
 			 * ####################### 종합소득과세표준 기타공제계 ############################################			 */
 			
 				statCnt = 0;
 				statCnt = infcPkgYeta8300.fnYeta8300_YE169010a_Tax_2023_3002_Update(infcPkgYe169010AVo);
 				if (statCnt >= 0) {
 				
 					/** ####################### 산출세액- 기타공제계-  * ############################################  */
 			
 					statCnt = 0;
 					statCnt = infcPkgYeta8300.fnYeta8300_YE169010a_Tax_2023_3003_Update(infcPkgYe169010AVo);
 					if (statCnt >= 0) {
 					/**
 					 * ####################### 산출세액-세액감면  ############################################ */
 				
 						statCnt = 0;
 						statCnt = infcPkgYeta8300.fnYeta8300_YE169010a_Tax_2023_3004_Update(infcPkgYe169010AVo);
 						if (statCnt >= 0) {
 						/**
 						 * ####################### 세액공제 -근로소득공제 감면세액계  ############################################
 						 */
 							...
 							statCnt = 0;
 							statCnt = infcPkgYeta8300.fnYeta8300_YE169010a_Tax_2023_3005_Update(infcPkgYe169010AVo);
 							...
 							if (statCnt >= 0) {
 								...
 								statCnt = 0;
 								statCnt =  infcPkgYeta8300.fnYeta8300_YE169010a_Tax_2023_3006_Update(infcPkgYe169010AVo);
 								if (statCnt >= 0) {
 									
 							          /**#######################  교육비합계 사용안함 나중에 확인     ############################################*/
 						 
// 									statCnt = 0;
// 									statCnt =  infcPkgYeta8300.fnPayr06430_PAYR425_ReTax_2016_CREATE_BEF_12_1_Update(infcPkgYe169010AVo); 
// 									
// 									if (statCnt >= 0) {
 								      /**#######################      ############################################*/
 									if (statCnt >= 0) {
 									...
 									statCnt = 0;
 									statCnt =  infcPkgYeta8300.fnYeta8300_YE169010a_Tax_2023_3007_Update(infcPkgYe169010AVo); 
 									...
 									if (statCnt >= 0) {	 
 										 ...
 										 *******************************************************************************************/
 									     ...
 									     // InfcPkgYe169010VO infcPkgYe169010Vo = new InfcPkgYe169010VO();  //연말정산결과  
 									      InfcPkgYe169010a_2023_VO tpInfcPkgYe169010AVo = new InfcPkgYe169010a_2023_VO();  //연말정산결과  
 									      ...
 									      tpInfcPkgYe169010AVo = infcPkgYeta8300.fnYeta8300_YE169010a_Tax_2023_2001_Select(infcPkgYe169010AVo); 
...
// 									         infcPkgYe169010AVo.setSpciDdct(exSPCI_DDCT);    /** column 특별공제_표준공제 : spciDdct */
 									       ...
 									       //  infcPkgYe169010AVo.setAddrMccr(exADDR_MCCR);    /** column 세액공제_자녀세액공제금액 : addrMccr */
 									        ...
 									        infcPkgYe169010AVo.setYetaStdC158(exTAXD_CSUM);    /** column C158_세액공제합계금액 : yetaC158 */
 									         ...
 									         statCnt = 0;
 										  	 statCnt =  infcPkgYeta8300.fnYeta8300_YE169010a_Tax_2023_3008_Update(infcPkgYe169010AVo); 
 									      ...
 									      /**#######################  특별공제)특별 세액공제계 -표준세액 공제 ############################################*/
 									           ...
 									           statCnt = 0;
 									  		   statCnt =  infcPkgYeta8300.fnYeta8300_YE169010a_Tax_2023_3009_Update(infcPkgYe169010AVo); 
 									  			if (statCnt >= 0) {
 									  		   /**#######################  세액감면 세액공제- ############################################*/
 									  	      
 									  		
 									  			statCnt = 0;
 									  			statCnt = infcPkgYeta8300.fnYeta8300_YE169010a_Tax_2023_3010_Update(infcPkgYe169010AVo); 
 									  			if (statCnt >= 0) { 
 									  	    
 									  	    /**#######################  농어촌특별세 계산 ############################################*/ 
 									  		
 									  			statCnt = 0;
 									  			statCnt =  infcPkgYeta8300.fnYeta8300_YE169010a_Tax_2023_3011_Update(infcPkgYe169010AVo); 
 									  			if (statCnt >= 0) { 
 									  	    
 									  	      /**#######################  결정세액 ############################################*/ 
 									  			
 									  				statCnt = 0;
 									  				statCnt = infcPkgYeta8300.fnYeta8300_YE169010a_Tax_2023_3012_Update(infcPkgYe169010AVo); 
    ...
    private  List<ShowMessageBM> YetaTaxBaseUpdate(HttpServletRequest request,InfcPkgYe161010_2023_VO  infcPkgYe161010Vo) throws Exception {
 	...
 	BeanUtils.copyProperties(infcPkgYe169010Vo, infcPkgYe161010Vo); 
       ...
       //   ---------------------특별공제 종합한도초과액 - 기타공제계-----------------
 			...
 			statCnt = 0;
 			statCnt = infcPkgYeta8300.fnYeta8300_YE169010_Tax_2023_3001_Update(infcPkgYe169010Vo);
 			if (statCnt >= 0) {
 			/**
 			 * ####################### 종합소득과세표준 기타공제계 ############################################			 */
 			
 				statCnt = 0;
 				statCnt = infcPkgYeta8300.fnYeta8300_YE169010_Tax_2023_3002_Update(infcPkgYe169010Vo);
 				if (statCnt >= 0) {
 				
 					/** ####################### 산출세액- 기타공제계-  * ############################################  */
 			
 					statCnt = 0;
 					statCnt = infcPkgYeta8300.fnYeta8300_YE169010_Tax_2023_3003_Update(infcPkgYe169010Vo);
 					if (statCnt >= 0) {
 					/**
 					 * ####################### 산출세액-세액감면  ############################################ */
 				
 						statCnt = 0;
 						statCnt = infcPkgYeta8300.fnYeta8300_YE169010_Tax_2023_3004_Update(infcPkgYe169010Vo);
 						if (statCnt >= 0) {
 						/**
 						 * ####################### 세액공제 -근로소득공제 감면세액계  ############################################
 						 */
 							...
 							statCnt = 0;
 							statCnt = infcPkgYeta8300.fnYeta8300_YE169010_Tax_2023_3005_Update(infcPkgYe169010Vo);

 							if (statCnt >= 0) {
 							      /**#######################  세액공제 주택차입금 ----- 외국납부    ############################################*/
 							
 								statCnt = 0;
 								statCnt =  infcPkgYeta8300.fnYeta8300_YE169010_Tax_2023_3006_Update(infcPkgYe169010Vo);
 								if (statCnt >= 0) {
 									
 							          /**#######################  교육비합계 사용안함 나중에 확인     ############################################*/
 						 
// 									statCnt = 0;
// 									statCnt =  infcPkgYeta8300.fnPayr06430_PAYR425_ReTax_2016_CREATE_BEF_12_1_Update(infcPkgYe161010Vo); 
// 									
// 									if (statCnt >= 0) {
 								      /**#######################      ############################################*/
 									if (statCnt >= 0) {
 								 //YETA_C152
 									...
 									statCnt = 0;
 									statCnt =  infcPkgYeta8300.fnYeta8300_YE169010_Tax_2023_3007_Update(infcPkgYe169010Vo); 
 									...
 									if (statCnt >= 0) {	 
 										 ...
 										 *******************************************************************************************/
 										   ...
 										   /**#######################      ############################################*/
 									     // InfcPkgYe169010VO infcPkgYe169010Vo = new InfcPkgYe169010VO();  //연말정산결과  
 									      InfcPkgYe169010_2023_VO tpInfcPkgYe169010Vo = new InfcPkgYe169010_2023_VO();  //연말정산결과  
 									      ...
 									      tpInfcPkgYe169010Vo = infcPkgYeta8300.fnYeta8300_YE169010_Tax_2023_2001_Select(infcPkgYe169010Vo); 
 									     ...
 									     else
 									     {
 									       ...
 									       //  infcPkgYe169010Vo.setAddrMccr(exADDR_MCCR);    /** column 세액공제_자녀세액공제금액 : addrMccr */
 									        ...
 									        infcPkgYe169010Vo.setYetaC158(exTAXD_CSUM);    /** column C158_세액공제합계금액 : yetaC158 */
 									         ...
 									         statCnt = 0;
 										  	 statCnt =  infcPkgYeta8300.fnYeta8300_YE169010_Tax_2023_3008_Update(infcPkgYe169010Vo); 
 									      ...
 									      /**#######################  특별공제)특별 세액공제계 -표준세액 공제 ############################################*/
 									           ...
 									           statCnt = 0;
 									  		   statCnt =  infcPkgYeta8300.fnYeta8300_YE169010_Tax_2023_3009_Update(infcPkgYe169010Vo); 
 									  			if (statCnt >= 0) {
 									  		   /**#######################  세액감면 세액공제- ############################################*/
 									  	      
 									  		
 									  			statCnt = 0;
 									  			statCnt = infcPkgYeta8300.fnYeta8300_YE169010_Tax_2023_3010_Update(infcPkgYe169010Vo); 
 									  			if (statCnt >= 0) { 
 									  	    
 									  	    /**#######################  농어촌특별세 계산 ############################################*/ 
 									  		
 									  			statCnt = 0;
 									  			statCnt =  infcPkgYeta8300.fnYeta8300_YE169010_Tax_2023_3011_Update(infcPkgYe169010Vo); 
 									  			if (statCnt >= 0) { 
 									  	    
 									  	      /**#######################  결정세액 ############################################*/ 
 									  			
 									  				statCnt = 0;
 									  				statCnt = infcPkgYeta8300.fnYeta8300_YE169010_Tax_2023_3012_Update(infcPkgYe169010Vo); 
	...
	private BigDecimal fnRtnSubTaxConTrbution(HttpServletRequest request,InfcPkgYe161010_2023_VO  infcPkgYe161010Vo,BigDecimal exTpPRDD_TAXN,String exGubun,String std_ddc_tax) throws Exception {
		...
		if  (listYetaGibu.size() > 0) {
			...
			while ( iter.hasNext() ) { 
				...
				//	inputYe169010Vo.setSpciFb17(new BigDecimal(MSFSharedUtils.defaultNulls(tempMap.get("spciFb17"),"0")));    /** column null : spciFb17 */
					...
					statCnt = 0;
			  		statCnt =  infcPkgYeta8300.fnYeta8300_YE169010_Tax_2023_TgIn03_Update( inputYe161080Vo) ;
			  		if (statCnt >= 0) {
			  			
			  			statCnt = 0;
				  		statCnt =  infcPkgYeta8300.fnYeta8300_YE169010_Tax_2023_TgIn04_Update( inputYe169010Vo) ;
			  		}
