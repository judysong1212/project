...
public class Func2022_Pdf_P101Y {

	@Resource(name = "Yeta7200XmlService")
	private static Yeta7200XmlService yetaPayr4200Service;
	...
	public static void func_2022_P101Y_P101M(InfcPkgYe161010_2022_VO ye161010VO, Element  subXmlElForm, String nResult, HttpServletRequest request ) throws Exception{
		...
		if  (yetaPayr4200Service == null) { 
			...
			yetaPayr4200Service = (Yeta7200XmlService) wac.getBean("Yeta7200XmlService" ); 
		}
		strDatCd = "";

		InfcPkgPdfP101y_2022_VO yetaPdfP101yVo = new InfcPkgPdfP101y_2022_VO();
		InfcPkgPdfP101m_2022_VO yetaPdfP101mVo = new InfcPkgPdfP101m_2022_VO();
		...
		yetaPayr4200Service.yeta7200_PDF_YE162015_2022_Delete(yetaPdfYE162015Vo);
			...
			for(int k = 0; k < subXmlElChildMan.getLength();k++) {  
				...
				if (strDatCd.equals("G0041")) {
					...
					for(int i = 0; i < subXmlElChildSum.getLength(); i++) {  
						...
						yetaPayr4200Service.yeta7200_PDF_P101Y_2022_Delete(yetaPdfP101yVo);
						yetaPayr4200Service.yeta7200_PDF_P101Y_2022_Insert(yetaPdfP101yVo);
					}
		...
		yetaPayr4200Service.yeta7200_PDF_YE162015_2022_Insert(yetaPdfYE162015Vo);
	}
	
	public static void setPdfP101mVo(InfcPkgPdfP101m_2022_VO yetaPdfP101mVo , HttpServletRequest request, Element subXmlElData) throws Exception{
		...
		yetaPayr4200Service.yeta7200_PDF_P101M_2022_Delete(yetaPdfP101mVo);
		yetaPayr4200Service.yeta7200_PDF_P101M_2022_Insert(yetaPdfP101mVo);
