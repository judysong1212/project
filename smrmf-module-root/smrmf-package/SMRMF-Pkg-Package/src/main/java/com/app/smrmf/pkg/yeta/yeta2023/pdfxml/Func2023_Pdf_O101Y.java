...
public class Func2023_Pdf_O101Y {
	...
	public static void func_2023_O101Y_O101M(InfcPkgYe161010_2023_VO ye161010VO, Element  subXmlElForm, String nResult, HttpServletRequest request ) throws Exception{
		...
		InfcPkgPdfO101y_2023_VO yetaPdfO101yVo = new InfcPkgPdfO101y_2023_VO();
		InfcPkgPdfO101m_2023_VO yetaPdfO101mVo = new InfcPkgPdfO101m_2023_VO();
			...
			for(int k = 0; k < subXmlElChildMan.getLength();k++) {  
				...
				if (strDatCd.equals("G0030")) {
					...
					for(int i = 0; i < subXmlElChildSum.getLength(); i++) {  
						...
						yetaPayr3200Service.yeta8200_PDF_O101Y_2023_Delete(yetaPdfO101yVo);
						yetaPayr3200Service.yeta8200_PDF_O101Y_2023_Insert(yetaPdfO101yVo);
					}
	...
	public static void setPdfO101mVo(InfcPkgPdfO101m_2023_VO yetaPdfO101mVo , HttpServletRequest request, Element subXmlElData) throws Exception{
		...
		yetaPayr3200Service.yeta8200_PDF_O101M_2023_Delete(yetaPdfO101mVo);
		yetaPayr3200Service.yeta8200_PDF_O101M_2023_Insert(yetaPdfO101mVo);

	}
	
	public static void func_2023_O101M_YetaCalc(InfcPkgYe161010_2023_VO ye161010VO, HttpServletRequest request) throws Exception{ 
		...
		yetaPayr3200Service.PdfYeta2023_O101M_YE161040_Update(infcPkgYe161040Vo); 
		...
		// 건강보험료 합계  
         yetaPayr3200Service.fnYeta8200_O101M_YE161060_2023_Update(infcPkgYe161060Vo); 
