...
public class Func_Pdf_C301Y {
	...
	public static void func_2017_C301Y_C301M(InfcPkgYe161010VO ye161010VO, Element  subXmlElForm, String nResult , HttpServletRequest request ) throws Exception{
		...
		InfcPkgPdfC301yVO yetaPdfC301yVo = new InfcPkgPdfC301yVO();
		InfcPkgPdfC301mVO yetaPdfC301mVo = new InfcPkgPdfC301mVO();
		...
		yetaPayr2200Service.yeta2200_PDF_C301Y_2017_Delete(yetaPdfC301yVo);
		...
		for (int j = 0; j < subXmlElChildForm.getLength();j++) { 
			...
			for(int k = 0; k < subXmlElChildMan.getLength();k++) {  
				...
				if (strDatCd.equals("G0024")) {
					...
					yetaPayr2200Service.yeta2200_PDF_C301Y_2017_Insert(yetaPdfC301yVo);
				}
	...
	public static void func_2017_C301Y_YetaCalc(InfcPkgYe161010VO ye161010VO, HttpServletRequest request) throws Exception{ 
		...
		//교육비 
		yetaPayr2200Service.PdfYeta2200_C301Y_YE161090_Delete(infcPkgYe161090Vo); 
		yetaPayr2200Service.PdfYeta2200_C301Y_YE161090_Insert(infcPkgYe161090Vo); 
