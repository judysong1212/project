...
@Repository("InfcPkgYeta3170DAO")
public class InfcPkgYeta3170DAO extends EgovAbstractDAO {
    ...
    public String insertYeta3170(InfcPkgYeta3170VO vo) throws Exception {
        return (String)insert("infcPkgYeta3170DAO.insertYetaPrc3170_S", vo);
    }
    ...
    public void updateYeta3170(InfcPkgYeta3170VO vo) throws Exception {
        update("infcPkgYeta3170DAO.updateYetaPrc3170_S", vo);
    }
    
	  @Transactional
    public int fnPayr06430_PAYR442_ReTax_2016_Update(InfcPkgYeta3170VO vo) throws Exception {
        return update("infcPkgYeta3170DAO.fnPayr06430_PAYR442_ReTax_2016_Update", vo);
    }
    ...
    public void deleteYeta3170(InfcPkgYeta3170VO vo) throws Exception {
        delete("infcPkgYeta3170DAO.deleteYetaPrc3170_S", vo);
    }
    ...
    public void fnPayr06430_PAYR442_CREATE_Delete(InfcPkgYeta3170VO vo) throws Exception {
        delete("infcPkgYeta3170DAO.fnPayr06430_PAYR442_CREATE_Delete_S", vo);
    }
    ...
    public InfcPkgYeta3170VO selectYeta3170(InfcPkgYeta3170VO vo) throws Exception {
        return (InfcPkgYeta3170VO) selectByPk("infcPkgYeta3170DAO.selectYetaPrc3170_S", vo);
    }
    ...
    public List  selectYeta3170List(InfcPkgYeta3170SrhVO searchVO) throws Exception {
        return list("infcPkgYeta3170DAO.selectYetaPrc3170List_D", searchVO);
    }
 
    
    public List  fnPayr06430_PAYR442_ReTax_2016_SelectFind(InfcPkgYeta3170SrhVO vo) throws Exception {
    	 return list("infcPkgYeta3170DAO.fnPayr06430_PAYR442_ReTax_2016_SelectFind", vo);
    ...
    public int selectYeta3170ListTotCnt(InfcPkgYeta3170SrhVO searchVO) {
        return (Integer)getSqlMapClientTemplate().queryForObject("infcPkgYeta3170DAO.selectYetaPrc3170ListTotCnt_S", searchVO);
    }
