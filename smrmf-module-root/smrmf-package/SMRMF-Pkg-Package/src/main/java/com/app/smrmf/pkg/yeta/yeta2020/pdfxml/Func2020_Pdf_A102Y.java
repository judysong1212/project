...
public class Func2020_Pdf_A102Y {
	...
	public static void func_2020_A102Y_A102M(InfcPkgYe161010_2020_VO ye161010VO, Element  subXmlElForm, String nResult, HttpServletRequest request) throws Exception{ 
		...
		InfcPkgPdfA102y_2020_VO yetaPdfA102yVo = new InfcPkgPdfA102y_2020_VO();
		InfcPkgPdfA102m_2020_VO yetaPdfA102mVo = new InfcPkgPdfA102m_2020_VO();
		...
		for (int j = 0; j < subXmlElChildForm.getLength();j++) { 
			...
			for(int k = 0; k < subXmlElChildMan.getLength();k++) {  
				...
				if (strDatCd.equals("G0001")) { //보장성 총 금액
					...
					yetaPayr3200Service.yeta5200_PDF_A102Y_2020_Delete(yetaPdfA102yVo); 
					yetaPayr3200Service.yeta5200_PDF_A102Y_2020_Insert(yetaPdfA102yVo);
					...
					//기존 장애인전용 보장성보험 소스,주석처리 20201204
	 ...
	 * 2. 처리내용 : 
	 * </pre>
	 * @Method Name : func_2020_A102Y_YetaCalc
	 * @date : 2020. 1. 22.
	 * @author : atres
	 * @history : 
	 *	-----------------------------------------------------------------------
	 ...
	 * @throws Exception
	 */
	public static void func_2020_A102Y_YetaCalc(InfcPkgYe161010_2020_VO ye161010VO, HttpServletRequest request) throws Exception{ 
		...
		yetaPayr3200Service.PdfYeta2020_A102Y_YE161040_Update(infcPkgYe161040Vo); 
		...
		//보험료 합산금액 넣기 
         yetaPayr3200Service.fnYeta5200_A102Y_YE161080_2020_Update(infcPkgYe161080Vo); 
        //보험료 종료
