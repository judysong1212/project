 ...
 */
public class InfcPkgRemt3200VO  implements Serializable {
    ...
    private java.math.BigDecimal antyAccuSeilNum;
    ...
    private java.math.BigDecimal antyAccuDepitSum;
    ...
    public java.math.BigDecimal getAntyAccuSeilNum() {
        return this.antyAccuSeilNum;
    }
    
    public void setAntyAccuSeilNum(java.math.BigDecimal antyAccuSeilNum) {
    ...
    public java.math.BigDecimal getAntyAccuDepitSum() {
        return this.antyAccuDepitSum;
    }
    
    public void setAntyAccuDepitSum(java.math.BigDecimal antyAccuDepitSum) {
