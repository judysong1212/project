...
public class Func2020_Pdf_J101Y {
	...
	public static void func_2020_J101Y_J101M(InfcPkgYe161010_2020_VO ye161010VO, Element  subXmlElForm, String nResult, HttpServletRequest request  ) throws Exception{
		...
		InfcPkgPdfJ101y_2020_VO yetaPdfJ101yVo = new InfcPkgPdfJ101y_2020_VO();
		InfcPkgPdfJ101m_2020_VO yetaPdfJ101mVo = new InfcPkgPdfJ101m_2020_VO();
		...
		yetaPayr3200Service.yeta5200_PDF_J101Y_2020_Delete(yetaPdfJ101yVo);
		...
		for (int j = 0; j < subXmlElChildForm.getLength();j++) { 
			...
			for(int k = 0; k < subXmlElChildMan.getLength();k++) {  
				...
				if (strDatCd.equals("G0016")) {
					...
					yetaPayr3200Service.yeta5200_PDF_J101Y_2020_Insert(yetaPdfJ101yVo);
				}
			}
	...
	public static void func_2020_J101Y_YetaCalc(InfcPkgYe161010_2020_VO ye161010VO, HttpServletRequest request) throws Exception{ 
		...
		// 주책 임차 차입금 원리금 합계  
         yetaPayr3200Service.fnYeta5200_J101Y_YE161060_2020_Update(infcPkgYe161060Vo); 
