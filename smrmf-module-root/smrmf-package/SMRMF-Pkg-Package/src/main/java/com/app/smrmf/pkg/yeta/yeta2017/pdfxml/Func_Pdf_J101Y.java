...
public class Func_Pdf_J101Y {
	...
	public static void func_2017_J101Y_J101M(InfcPkgYe161010VO ye161010VO, Element  subXmlElForm, String nResult, HttpServletRequest request  ) throws Exception{
		...
		InfcPkgPdfJ101yVO yetaPdfJ101yVo = new InfcPkgPdfJ101yVO();
		InfcPkgPdfJ101mVO yetaPdfJ101mVo = new InfcPkgPdfJ101mVO();
		...
		yetaPayr2200Service.yeta2200_PDF_J101Y_2017_Delete(yetaPdfJ101yVo);
		...
		for (int j = 0; j < subXmlElChildForm.getLength();j++) { 
			...
			for(int k = 0; k < subXmlElChildMan.getLength();k++) {  
				...
				if (strDatCd.equals("G0016")) {
					...
					yetaPayr2200Service.yeta2200_PDF_J101Y_2017_Insert(yetaPdfJ101yVo);
				}
			}
	...
	public static void func_2017_J101Y_YetaCalc(InfcPkgYe161010VO ye161010VO, HttpServletRequest request) throws Exception{ 
		...
		// 주책 임차 차입금 원리금 합계  
         yetaPayr2200Service.fnYeta2200_J101Y_YE161060_2017_Update(infcPkgYe161060Vo); 
