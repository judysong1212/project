 ...
 */
public class InfcPkgPayr0305VO  implements Serializable {
    ...
    private java.math.BigDecimal addIncmTxRate;

    /** set 실소득세액 : turtyIncmTxQnty */
    private java.math.BigDecimal turtyIncmTxQnty;

    /** set 수동소득세 : mnlTxtbSimfTxs */
    private java.math.BigDecimal mnlTxtbSimfTxs;

    /** set 수동지방소득세 : mnlLocTxAmt */
    private java.math.BigDecimal mnlLocTxAmt;
...
private java.lang.String payrMangDeptCd = "";
    ...
    /**
 * Comment : 
 * @fn java.math.BigDecimal getMnlTxtbSimfTxs()
 * @brief date:2017 2017. 7. 20. user:atres
 * @return the mnlTxtbSimfTxs get
 */
public java.math.BigDecimal getMnlTxtbSimfTxs() {
	return mnlTxtbSimfTxs;
}

/**
 * Comment : 
 *@fn void setMnlTxtbSimfTxs(java.math.BigDecimal mnlTxtbSimfTxs)
 *@brief date:2017 2017. 7. 20. user:atres
 *@param mnlTxtbSimfTxs the mnlTxtbSimfTxs to set
 */
public void setMnlTxtbSimfTxs(java.math.BigDecimal mnlTxtbSimfTxs) {
	this.mnlTxtbSimfTxs = mnlTxtbSimfTxs;
}

/**
 * Comment : 
 * @fn java.math.BigDecimal getMnlLocTxAmt()
 * @brief date:2017 2017. 7. 20. user:atres
 * @return the mnlLocTxAmt get
 */
public java.math.BigDecimal getMnlLocTxAmt() {
	return mnlLocTxAmt;
}

/**
 * Comment : 
 *@fn void setMnlLocTxAmt(java.math.BigDecimal mnlLocTxAmt)
 *@brief date:2017 2017. 7. 20. user:atres
 *@param mnlLocTxAmt the mnlLocTxAmt to set
 */
public void setMnlLocTxAmt(java.math.BigDecimal mnlLocTxAmt) {
...
public void setMnlTxtbSimfYn(java.lang.String mnlTxtbSimfYn) {
	...
	public java.math.BigDecimal getAddIncmTxRate() {
	return addIncmTxRate;
}

public void setAddIncmTxRate(java.math.BigDecimal addIncmTxRate) {
	this.addIncmTxRate = addIncmTxRate;
}

public java.math.BigDecimal getTurtyIncmTxQnty() {
	return turtyIncmTxQnty;
}

public void setTurtyIncmTxQnty(java.math.BigDecimal turtyIncmTxQnty) {
