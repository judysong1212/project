...
public class Func2022_Pdf_G307Y {
	...
	public static void func_2022_G307Y_G307M(InfcPkgYe161010_2022_VO ye161010VO, Element  subXmlElForm, String nResult, HttpServletRequest request ) throws Exception{
		...
		InfcPkgPdfG307y_2022_VO yetaPdfG307yVo = new InfcPkgPdfG307y_2022_VO();
		InfcPkgPdfG307m_2022_VO yetaPdfG307mVo = new InfcPkgPdfG307m_2022_VO();
		...
		yetaPayr3200Service.yeta7200_PDF_G307Y_2022_Delete(yetaPdfG307yVo);
		...
		yetaPayr3200Service.yeta7200_PDF_G307M_2022_Delete(yetaPdfG307mVo);
		...
		for (int j = 0; j < subXmlElChildForm.getLength();j++) { 
			...
			yetaPayr3200Service.yeta7200_PDF_G307M_2022_Insert(yetaPdfG307mVo);
	...
	public static void setPdfG307yVo(InfcPkgPdfG307y_2022_VO yetaPdfG307yVo , HttpServletRequest request) throws Exception{
		...
		yetaPayr3200Service.yeta7200_PDF_G307Y_2022_Insert(yetaPdfG307yVo);

	}
	

	public static void func_2022_G307Y_YetaCalc(InfcPkgYe161010_2022_VO ye161010VO, HttpServletRequest request) throws Exception{ 
		...
		yetaPayr3200Service.yeta7200_PDF_G307M_2022_Update(yetaPdfG307mVo);
		...
		dataChk = yetaPayr3200Service.PdfYeta2022_G307Y_YE161040_Update(infcPkgYe161040Vo); 
		...
		if (dataChk >= 0) { 
			...
			//직불카드 
	         yetaPayr3200Service.fnYeta7200_G307Y_YE161070_2022_Update(infcPkgYe161070Vo); 
