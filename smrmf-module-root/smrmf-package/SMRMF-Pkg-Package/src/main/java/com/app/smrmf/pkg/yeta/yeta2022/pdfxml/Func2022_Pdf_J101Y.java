...
public class Func2022_Pdf_J101Y {
	...
	public static void func_2022_J101Y_J101M(InfcPkgYe161010_2022_VO ye161010VO, Element  subXmlElForm, String nResult, HttpServletRequest request  ) throws Exception{
		...
		InfcPkgPdfJ101y_2022_VO yetaPdfJ101yVo = new InfcPkgPdfJ101y_2022_VO();
		InfcPkgPdfJ101m_2022_VO yetaPdfJ101mVo = new InfcPkgPdfJ101m_2022_VO();
		...
		yetaPayr3200Service.yeta7200_PDF_J101Y_2022_Delete(yetaPdfJ101yVo);
		...
		for (int j = 0; j < subXmlElChildForm.getLength();j++) { 
			...
			for(int k = 0; k < subXmlElChildMan.getLength();k++) {  
				...
				if (strDatCd.equals("G0016")) {
					...
					yetaPayr3200Service.yeta7200_PDF_J101Y_2022_Insert(yetaPdfJ101yVo);
				}
			}
	...
	public static void func_2022_J101Y_YetaCalc(InfcPkgYe161010_2022_VO ye161010VO, HttpServletRequest request) throws Exception{ 
		...
		// 주책 임차 차입금 원리금 합계  
         yetaPayr3200Service.fnYeta7200_J101Y_YE161060_2022_Update(infcPkgYe161060Vo); 
