 ...
 */
@Controller 
public class Yeta3300SubtTaxWkerAmntPkgProc  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta3300SubtTaxWkerAmntPkgProc.class);
	   
    @Resource(name = "Yeta3300PayrService")
    protected Yeta3300PayrService  infcPkgYeta3300;
    
 
    public Yeta3300SubtTaxWkerAmntPkgProc() {
    	
    } 
    
    public List<ShowMessageBM> execSubtTaxWkerAmntPkgProc(HttpServletRequest request,InfcPkgYe161010_2018_VO  infcPkgYe161010Vo)  throws Exception  {
     ...
     * @throws Exception
     */
    private  List<ShowMessageBM>  YetaTaxWkerAmntUpdate(HttpServletRequest request,InfcPkgYe161010_2018_VO  infcPkgYe161010Vo) throws Exception {
      ...
      //    /* (97) column 차감소득금액 : SUBT_ERAM */  
  	      ...
  	      *******************************************************************************************/  
  		      InfcPkgYe169010_2018_VO wkInfcPkgYe169010Vo = new InfcPkgYe169010_2018_VO();  //연말정산결과  
  		      InfcPkgYe169010_2018_VO tpWkInfcPkgYe169010Vo = new InfcPkgYe169010_2018_VO();  //연말정산결과  
  		    ...
  		    tpWkInfcPkgYe169010Vo = infcPkgYeta3300.fnYeta3300_YE169010_Tax_2018_2001_Select(wkInfcPkgYe169010Vo); 
...
// 		         exBNAT_DDCT  = tpWkInfcPkgYe169010Vo.getYeta0c76();   
...
// 		          exBPSS_HPUL  = tpWkInfcPkgYe169010Vo.getBpssHpul();        
...
// 		         exBPSS_HSOL  = tpWkInfcPkgYe169010Vo.getBpssHsol();       
...
// 		         exBPSS_HTEC  = tpWkInfcPkgYe169010Vo.getBpssHtec();         
...
// 		         exBPSS_DDCT  = tpWkInfcPkgYe169010Vo.getBpssDdct();    
...
// 		         exSPCI_BHTH  = tpWkInfcPkgYe169010Vo.getSpciBhth();        
...
// 		         exSPCI_BEPF  = tpWkInfcPkgYe169010Vo.getSpciBepf();       
...
//
//// 		         exSPCI_ONON  = tpWkInfcPkgYe169010Vo.getSpciOnon();     
...
//
// 		         exSPCI_ONAM  = tpWkInfcPkgYe169010Vo.getSpciOnam();         
...
// 		         exSPCI_OYAM  = tpWkInfcPkgYe169010Vo.getSpciOyam();     
...
//				wkInfcPkgYe169010Vo.setBaseSelf(exBASE_SELF);    /*(24) column 기본공제_본인 : BASE_SELF */                              
//					wkInfcPkgYe169010Vo.setBaseWife(exBASE_WIFE);    /*(25) column 기본공제_배우자 : BASE_WIFE */                             
//									   	         /*(26) column 기본공제_부양가족수 : BASE_FMLY */                      
//					wkInfcPkgYe169010Vo.setBaseFyam(exBASE_FYAM);    /*(26) column 기본공제_부양가족 : BASE_FYAM */                            
//								                          /*(70) column 추가공제_경로우대_70세이상수 : ADDR_CT70 경로우대공제인원 */          
//					wkInfcPkgYe169010Vo.setAddrRpt70(exADDR_RPT70);   /*(27) column 추가공제_경로우대70 : ADDR_RPT70 1946.12.31 */              
//								                          /*(28) column 추가공제_장애인수 : ADDR_HDRC */                            
//					wkInfcPkgYe169010Vo.setAddrHdam(exADDR_HDAM);    /*(28) column 추가공제_장애인 금액 : ADDR_HDAM */                          
//					wkInfcPkgYe169010Vo.setAddrFame(exADDR_FAME);    /*(29) column 추가공제_부녀자  금액 : ADDR_FAME */                         
//					wkInfcPkgYe169010Vo.setPantOnam(exPANT_ONAM);    /*(30) column 추가공제_한부모공제금액 : PANT_ONAM */  
...
//				wkInfcPkgYe169010Vo.setBnatDdct(exBNAT_DDCT);     // BNAT_DDCT	종근무지_국민연금보험료공제	28		                
//				wkInfcPkgYe169010Vo.setJnatDdct(exJNAT_DDCT);    // JNAT_DDCT	주근무지_국민연금보험료공제	29		                
//				                  
//				wkInfcPkgYe169010Vo.setBpssHpul(exBPSS_HPUL);  //BPSS_HPUL	종근무지_국민연금외공무원연금공제	33	                        
//				wkInfcPkgYe169010Vo.setJpssHpul(exJPSS_HPUL);  //JPSS_HPUL	주근무지_공무원연금보험료공제	37	                        
//				                  
//				wkInfcPkgYe169010Vo.setBpssHsol(exBPSS_HSOL);  // BPSS_HSOL	종근무지_국민연금외군인연금공제	31	                        
//				wkInfcPkgYe169010Vo.setJpssHsol(exJPSS_HSOL);  //JPSS_HSOL	주근무지_국민연금외군인연금공제	35	                        
//				                  
//				wkInfcPkgYe169010Vo.setBpssHtec(exBPSS_HTEC);  // BPSS_HTEC	종근무지_국민연금외교직원연금공제	32	                        
//				wkInfcPkgYe169010Vo.setJpssHtec(exJPSS_HTEC);  //JPSS_HTEC	주근무지_국민연금외교직원연금공제	36	                        
//				                  
//				wkInfcPkgYe169010Vo.setBpssDdct(exBPSS_DDCT);  //BPSS_DDCT	종근무지_별정우체국연금보험료공제	30	                        
//				wkInfcPkgYe169010Vo.setJpssDdct(exJPSS_DDCT);  //JPSS_DDCT	주근무지_별정우체국연금보험료공제	34	   
...
//				wkInfcPkgYe169010Vo.setSpciBhth(exSPCI_BHTH);  //SPCI_BHTH	특별공제_종건강보험료	45	                                
//  		    	wkInfcPkgYe169010Vo.setSpciJhth(exSPCI_JHTH);  // SPCI_JHTH	특별공제_주건강보험료	46		                        
//  		    	wkInfcPkgYe169010Vo.setSpciBepf(exSPCI_BEPF);  //SPCI_BEPF	특별공제_종고용보험료	47	                                
//  		    	wkInfcPkgYe169010Vo.setSpciJepf(exSPCI_JEPF);  // SPCI_JEPF	특별공제_주고용보험료	48	   
...
//  		    	wkInfcPkgYe169010Vo.setSpciRefn(exSPCI_REFN);   /*(34)-가 column 특별공제_차입금원리금상환액_대출기관 : SPCI_REFN */               
//  		    	wkInfcPkgYe169010Vo.setSpciResf(exSPCI_RESF);   /*(34)-가 column 특별공제_차입금원리금상환액_거주자 : SPCI_RESF */                
//  		    	wkInfcPkgYe169010Vo.setSpchRe15(exSPCH_RE15);    /*(34)-나 column 특별공제_11장기주택저당차입금15 : SPCH_RE15 */                
//  		    	wkInfcPkgYe169010Vo.setSpchRe29(exSPCH_RE29);   /*(34)-나 column 특별공제_11장기주택저당차입금29 : SPCH_RE29 */                 
//  		    	wkInfcPkgYe169010Vo.setSpchRe30(exSPCH_RE30);   /* (34)-나column 특별공제_11장기주택저당차입금30 : SPCH_RE30 */                 
//  		    	wkInfcPkgYe169010Vo.setSpciRefx(exSPCI_REFX);   /*(34)-나 column 특별공제_12장기주택저당차입금_고정 : SPCI_REFX */               
//  		    	wkInfcPkgYe169010Vo.setSpciReec(exSPCI_REEC);   /*(34)나 column 특별공제_12장기주택저당차입금_기타 : SPCI_REEC */                
//  		    	wkInfcPkgYe169010Vo.setSpci15fx(exSPCI_15FX);    /*(34)-나 column 특별공제_15장기주택저당_15고정AND비거치상환 : SPCI_15FX */       
//  		    	wkInfcPkgYe169010Vo.setSpci15fb(exSPCI_15FB);   /*(34)-나 column 특별공제_15장기주택저당_15고정OR비거치상환 : SPCI_15FB */         
//  		    	wkInfcPkgYe169010Vo.setSpci15ec(exSPCI_15EC);   /*(34)-나 column 특별공제_15장기주택저당_15기타대출 : SPCI_15EC */               
//  		    	wkInfcPkgYe169010Vo.setSpci10fb(exSPCI_10FB);   /*(34)-나 column 특별공제_15장기주택저당_10고정OR비거치상환 : SPCI_10FB */ 
  		    	
  		    	
				wkInfcPkgYe169010Vo.setYeta0c94(exSPCI_OBAM);    /** column C94_특별소득공제_기부금_이월분금액 : yeta0c94 */
				//wkInfcPkgYe169010Vo.setYeta0c96(pkgInsrAmntVo.getYeta0c96());    /** column C96_특별소득공제_특별소득공제합계 : yeta0c96 */
 
  		    	                                                                                               
//  		    	wkInfcPkgYe169010Vo.setSpciObam(exSPCI_OBAM);  // SPCI_OBAM	이월법정기부금액	152		                        
//  		    	wkInfcPkgYe169010Vo.setSpciOnon(exSPCI_ONON);  //SPCI_ONON	이월특례기부금_공익신탁금액	151	                        
//  		    	wkInfcPkgYe169010Vo.setSpciOnam(exSPCI_ONAM);  // SPCI_ONAM	이월종교단체외기부금	154		                        
//  		    	wkInfcPkgYe169010Vo.setSpciOyam(exSPCI_OYAM);  // SPCI_OYAM	이월종교단체기부금	153		                        
  		        
  		        statCnt = 0;
  			  	statCnt =  infcPkgYeta3300.fnYeta3300_YE169010_Tax_2018_2003_Select(wkInfcPkgYe169010Vo); 
