...
public class Func2022_Pdf_C301Y {
	...
	public static void func_2022_C301Y_C301M(InfcPkgYe161010_2022_VO ye161010VO, Element  subXmlElForm, String nResult , HttpServletRequest request ) throws Exception{
		...
		InfcPkgPdfC301y_2022_VO yetaPdfC301yVo = new InfcPkgPdfC301y_2022_VO();
		InfcPkgPdfC301m_2022_VO yetaPdfC301mVo = new InfcPkgPdfC301m_2022_VO();
		...
		yetaPayr3200Service.yeta7200_PDF_C301Y_2022_Delete(yetaPdfC301yVo);
		...
		for (int j = 0; j < subXmlElChildForm.getLength();j++) { 
			...
			for(int k = 0; k < subXmlElChildMan.getLength();k++) {  
				...
				if (strDatCd.equals("G0024")) {
					...
					yetaPayr3200Service.yeta7200_PDF_C301Y_2022_Insert(yetaPdfC301yVo);
				}
	...
	public static void func_2022_C301Y_YetaCalc(InfcPkgYe161010_2022_VO ye161010VO, HttpServletRequest request) throws Exception{ 
		...
		//교육비 
		yetaPayr3200Service.PdfYeta7200_C301Y_YE161090_Delete(infcPkgYe161090Vo); 
		yetaPayr3200Service.PdfYeta7200_C301Y_YE161090_Insert(infcPkgYe161090Vo); 
