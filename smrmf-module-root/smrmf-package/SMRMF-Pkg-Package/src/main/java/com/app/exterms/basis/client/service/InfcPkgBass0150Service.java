...
@RemoteServiceRelativePath("InfcPkgBass0150Service.gwt")
public interface InfcPkgBass0150Service extends RemoteService {
	/**
	 * Utility class for simplifying access to the instance of async service.
	 */
	public static class Util {
		private static InfcPkgBass0150ServiceAsync instance;
		public static InfcPkgBass0150ServiceAsync getInstance(){
			if (instance == null) {
				instance = GWT.create(InfcPkgBass0150Service.class);
			}
			return instance;
		}
	}
