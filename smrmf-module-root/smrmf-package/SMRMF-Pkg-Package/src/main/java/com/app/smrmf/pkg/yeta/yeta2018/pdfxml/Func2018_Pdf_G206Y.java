...
public class Func2018_Pdf_G206Y {
	...
	public static void func_2018_G206Y_G206M(InfcPkgYe161010_2018_VO ye161010VO, Element  subXmlElForm, String nResult , HttpServletRequest request ) throws Exception{
		...
		InfcPkgPdfG206y_2018_VO yetaPdfG206yVo = new InfcPkgPdfG206y_2018_VO();
		InfcPkgPdfG206m_2018_VO yetaPdfG206mVo = new InfcPkgPdfG206m_2018_VO();
		...
		//yetaPayr3200Service.yeta3200_PDF_G206Y_2018_Delete(yetaPdfG206yVo);
		...
		//yetaPayr3200Service.yeta3200_PDF_G206M_2018_Delete(yetaPdfG206mVo);
	...
	public static void setPdfG206yVo(InfcPkgPdfG206y_2018_VO yetaPdfG206yVo , HttpServletRequest request, Element subXmlElData) throws Exception{
		...
		//yetaPayr3200Service.yeta3200_PDF_G206Y_2018_Insert(yetaPdfG206yVo);

	}
	
	public static void setPdfG206mVo(InfcPkgPdfG206m_2018_VO yetaPdfG206mVo , HttpServletRequest request, Element subXmlElData) throws Exception{
		...
		//yetaPayr3200Service.yeta3200_PDF_G206M_2018_Insert(yetaPdfG206mVo);

	}
	
	

	public static void func_2018_G206Y_YetaCalc(InfcPkgYe161010_2018_VO ye161010VO, HttpServletRequest request) throws Exception{ 
		...
		//dataChk = yetaPayr3200Service.PdfYeta2018_G206Y_YE161040_Update(infcPkgYe161040Vo); 
		...
		if (dataChk >= 0) {
			...
			// 신용카드  
	         //yetaPayr3200Service.fnYeta3200_G206Y_YE161070_2018_Update(infcPkgYe161070Vo); 
