 ...
 */
public class InfcPkgPayr0485VO  implements Serializable {
    private static final long serialVersionUID = 1L;
    
    
	public InfcPkgPayr0485VO(String payItemCd, String payItemNm, String payDducSum){
		this.payItemCd= payItemCd;
		this.payItemNm= payItemNm;
		this.payDducSum= payDducSum;
	}
	
	public InfcPkgPayr0485VO(){
