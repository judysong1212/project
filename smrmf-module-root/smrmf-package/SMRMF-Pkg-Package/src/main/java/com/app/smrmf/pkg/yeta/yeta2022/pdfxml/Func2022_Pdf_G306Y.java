...
public class Func2022_Pdf_G306Y {
	...
	public static void func_2022_G306Y_G306M(InfcPkgYe161010_2022_VO ye161010VO, Element  subXmlElForm, String nResult, HttpServletRequest request ) throws Exception{
		...
		InfcPkgPdfG306y_2022_VO yetaPdfG306yVo = new InfcPkgPdfG306y_2022_VO();
		InfcPkgPdfG306m_2022_VO yetaPdfG306mVo = new InfcPkgPdfG306m_2022_VO();
		...
		//yetaPayr3200Service.yeta7200_PDF_G306Y_2022_Delete(yetaPdfG306yVo);
		...
		//yetaPayr3200Service.yeta7200_PDF_G306M_2022_Delete(yetaPdfG306mVo);
	...
	public static void setPdfG306yVo(InfcPkgPdfG306y_2022_VO yetaPdfG306yVo , HttpServletRequest request, Element subXmlElData) throws Exception{
		...
		//yetaPayr3200Service.yeta7200_PDF_G306Y_2022_Insert(yetaPdfG306yVo);

	}
	
	public static void setPdfG306mVo(InfcPkgPdfG306m_2022_VO yetaPdfG306mVo , HttpServletRequest request, Element subXmlElData) throws Exception{
		...
		//yetaPayr3200Service.yeta7200_PDF_G306M_2022_Insert(yetaPdfG306mVo);

	}
	

	public static void func_2022_G306Y_YetaCalc(InfcPkgYe161010_2022_VO ye161010VO, HttpServletRequest request) throws Exception{ 
		...
		//dataChk = yetaPayr3200Service.PdfYeta2022_G306Y_YE161040_Update(infcPkgYe161040Vo); 
		...
		if (dataChk >= 0) { 
			...
			//신용카드
			//yetaPayr3200Service.Pdfyeta7200_G106Y_YE166020_Update(infcPkgYe166020Vo);  
			...
			// 신용카드  
	         //yetaPayr3200Service.fnYeta7200_G306Y_YE161070_2022_Update(infcPkgYe161070Vo); 
