...
public class Func_Pdf_C401Y {
	...
	public static void func_2017_C401Y_C401M(InfcPkgYe161010VO ye161010VO, Element  subXmlElForm, String nResult , HttpServletRequest request ) throws Exception{
		//학자금대출 
		...
		InfcPkgPdfC401yVO yetaPdfC401yVo = new InfcPkgPdfC401yVO();
		InfcPkgPdfC401mVO yetaPdfC401mVo = new InfcPkgPdfC401mVO();
		...
		yetaPayr2200Service.yeta2200_PDF_C401Y_2017_Delete(yetaPdfC401yVo);
		...
		for (int j = 0; j < subXmlElChildForm.getLength();j++) { 
			...
			for(int k = 0; k < subXmlElChildMan.getLength();k++) {  
				...
				if (strDatCd.equals("G0033")) {
					...
					yetaPayr2200Service.yeta2200_PDF_C401Y_2017_Insert(yetaPdfC401yVo);
				}
	...
	public static void func_2017_C401Y_YetaCalc(InfcPkgYe161010VO ye161010VO, HttpServletRequest request) throws Exception{ 
		...
		//교육비 
		yetaPayr2200Service.PdfYeta2200_C401Y_YE161090_Delete(infcPkgYe161090Vo); 
		yetaPayr2200Service.PdfYeta2200_C401Y_YE161090_Insert(infcPkgYe161090Vo); 
