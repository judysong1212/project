...
public class Func2019_Pdf_G107Y {
	...
	public static void func_2019_G107Y_G107M(InfcPkgYe161010_2019_VO ye161010VO, Element  subXmlElForm, String nResult , HttpServletRequest request ) throws Exception{
		...
		InfcPkgPdfG107y_2019_VO yetaPdfG107yVo = new InfcPkgPdfG107y_2019_VO();
		InfcPkgPdfG107m_2019_VO yetaPdfG107mVo = new InfcPkgPdfG107m_2019_VO();
		...
		yetaPayr3200Service.yeta4200_PDF_G107Y_2019_Delete(yetaPdfG107yVo);
	...
	public static void setPdfG107yVo(InfcPkgPdfG107y_2019_VO yetaPdfG107yVo , HttpServletRequest request) throws Exception{
		...
		yetaPayr3200Service.yeta4200_PDF_G107Y_2019_Insert(yetaPdfG107yVo);

	}
	
	

	public static void func_2019_G107Y_YetaCalc(InfcPkgYe161010_2019_VO ye161010VO, HttpServletRequest request) throws Exception{ 
	...
	//  신용카드 시작
		...
		dataChk =  yetaPayr3200Service.PdfYeta2019_G107Y_YE161040_Update(infcPkgYe161040Vo); 
		...
		if (dataChk >= 0) {
			...
			// 신용카드  
	         yetaPayr3200Service.fnYeta4200_G107Y_YE161070_2019_Update(infcPkgYe161070Vo); 
