...
@Repository("InfcPkgYeta17FileDAO")
public class InfcPkgYeta17FileDAO extends EgovAbstractDAO { 
	  
    public InfcPkgYe161005VO selectYe161005(InfcPkgYe161010VO ye161010VO) throws Exception {
        return (InfcPkgYe161005VO) selectByPk("infcPkgYeta17FileDAO.selectYe161005_S", ye161010VO);
    }
    ...
    */
    public Map fnPayrHB_ReTax_Total_Select(InfcPkgYe161020VO vo) throws Exception {
	     return (Map) selectByPk("infcPkgYeta17FileDAO.fnPayrHB_ReTax_Total_Select", vo);
	 }
    ...
    public Map fnPayrB_ReTax_Total_Select(InfcPkgYe161020VO vo) throws Exception {
	     return (Map) selectByPk("infcPkgYeta17FileDAO.fnPayrB_ReTax_Total_Select", vo);
	 } 
    ...
    public List fnPayrPSNL_ReTax_Total_Select(InfcPkgYe161020VO searchVO) throws Exception {
         return list("infcPkgYeta17FileDAO.fnPayrPSNL_ReTax_Total_Select", searchVO);
    }
    ...
    public List fnPayrHC_ReTax_Total_Select(InfcPkgYe161020VO searchVO) throws Exception {
        return list("infcPkgYeta17FileDAO.fnPayrHC_ReTax_Total_Select", searchVO);
   }
    ...
    public List fnPayrHD_ReTax_Total_Select(InfcPkgYe161020VO searchVO) throws Exception {
        return list("infcPkgYeta17FileDAO.fnPayrHD_ReTax_Total_Select", searchVO);
   }
    ...
    public List fnPayrPSNL_ReTax_CA_Total_Select(InfcPkgYe161020VO searchVO) throws Exception {
        return list("infcPkgYeta17FileDAO.fnPayrPSNL_ReTax_CA_Total_Select", searchVO);
   }
    ...
    public List fnPayrCA_ReTax_Total_Select(InfcPkgYe161020VO searchVO) throws Exception {
        return list("infcPkgYeta17FileDAO.fnPayrCA_ReTax_Total_Select", searchVO);
   }
        
    public List fnPayrC_ReTax_Total_Select(InfcPkgYe161020VO searchVO) throws Exception {
        return list("infcPkgYeta17FileDAO.fnPayrC_ReTax_Total_Select", searchVO);
   }
    ...
    public List fnPayrD_ReTax_Total_Select(InfcPkgYe161020VO searchVO) throws Exception {
        return list("infcPkgYeta17FileDAO.fnPayrD_ReTax_Total_Select", searchVO);
   }
    ...
    public List fnPayrE_ReTax_Total_Select(InfcPkgYe161020VO searchVO) throws Exception {
        return list("infcPkgYeta17FileDAO.fnPayrE_ReTax_Total_Select", searchVO);
   }   
    ...
    public List fnPayrF_ReTax_Total_Select(InfcPkgYe161020VO searchVO) throws Exception {
        return list("infcPkgYeta17FileDAO.fnPayrF_ReTax_Total_Select", searchVO);
   }  
    ...
    public List fnPayrG_ReTax_Total_Select(InfcPkgYe161020VO searchVO) throws Exception {
        return list("infcPkgYeta17FileDAO.fnPayrG_ReTax_Total_Select", searchVO);
   }  
    
    public int updateYeta2400ToYe161010(InfcPkgYe161010VO ye161010VO) throws Exception {
         return update("infcPkgYeta17FileDAO.updateYeta2400ToYe161010_S", ye161010VO);
    }   
