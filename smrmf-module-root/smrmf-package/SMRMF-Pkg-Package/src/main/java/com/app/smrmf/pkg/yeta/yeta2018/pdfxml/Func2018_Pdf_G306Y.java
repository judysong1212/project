...
public class Func2018_Pdf_G306Y {
	...
	public static void func_2018_G306Y_G306M(InfcPkgYe161010_2018_VO ye161010VO, Element  subXmlElForm, String nResult, HttpServletRequest request ) throws Exception{
		...
		InfcPkgPdfG306y_2018_VO yetaPdfG306yVo = new InfcPkgPdfG306y_2018_VO();
		InfcPkgPdfG306m_2018_VO yetaPdfG306mVo = new InfcPkgPdfG306m_2018_VO();
		...
		//yetaPayr3200Service.yeta3200_PDF_G306Y_2018_Delete(yetaPdfG306yVo);
		...
		//yetaPayr3200Service.yeta3200_PDF_G306M_2018_Delete(yetaPdfG306mVo);
	...
	public static void setPdfG306yVo(InfcPkgPdfG306y_2018_VO yetaPdfG306yVo , HttpServletRequest request, Element subXmlElData) throws Exception{
		...
		//yetaPayr3200Service.yeta3200_PDF_G306Y_2018_Insert(yetaPdfG306yVo);

	}
	
	public static void setPdfG306mVo(InfcPkgPdfG306m_2018_VO yetaPdfG306mVo , HttpServletRequest request, Element subXmlElData) throws Exception{
		...
		//yetaPayr3200Service.yeta3200_PDF_G306M_2018_Insert(yetaPdfG306mVo);

	}
	

	public static void func_2018_G306Y_YetaCalc(InfcPkgYe161010_2018_VO ye161010VO, HttpServletRequest request) throws Exception{ 
		...
		//dataChk = yetaPayr3200Service.PdfYeta2018_G306Y_YE161040_Update(infcPkgYe161040Vo); 
		...
		if (dataChk >= 0) { 
			...
			// 신용카드  
	         //yetaPayr3200Service.fnYeta3200_G306Y_YE161070_2018_Update(infcPkgYe161070Vo); 
