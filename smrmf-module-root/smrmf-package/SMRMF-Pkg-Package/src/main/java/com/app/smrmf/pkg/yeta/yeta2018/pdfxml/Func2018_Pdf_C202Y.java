...
public class Func2018_Pdf_C202Y {
	...
	public static void func_2018_C202Y_C202M(InfcPkgYe161010_2018_VO ye161010VO, Element  subXmlElForm, String nResult , HttpServletRequest request ) throws Exception{
		...
		InfcPkgPdfC202y_2018_VO yetaPdfC202yVo = new InfcPkgPdfC202y_2018_VO();
		InfcPkgPdfC202m_2018_VO yetaPdfC202mVo = new InfcPkgPdfC202m_2018_VO();
		...
		yetaPayr3200Service.yeta3200_PDF_C202Y_2018_Delete(yetaPdfC202yVo);
		...
		for (int j = 0; j < subXmlElChildForm.getLength();j++) { 
			...
			for(int k = 0; k < subXmlElChildMan.getLength();k++) {   
				...
				if (strDatCd.equals("G0005")) {
					...
					yetaPayr3200Service.yeta3200_PDF_C202Y_2018_Insert(yetaPdfC202yVo);
	...
	public static void func_2018_C202Y_YetaCalc(InfcPkgYe161010_2018_VO ye161010VO, HttpServletRequest request) throws Exception{ 
		...
		//교육비 
		yetaPayr3200Service.PdfYeta3200_C202Y_YE161090_Delete(infcPkgYe161090Vo); 
		yetaPayr3200Service.PdfYeta3200_C202Y_YE161090_Insert(infcPkgYe161090Vo); 
