...
public class Func_Pdf_J203Y {
	...
	public static void func_2017_J203Y_J203M(InfcPkgYe161010VO ye161010VO, Element  subXmlElForm, String nResult, HttpServletRequest request ) throws Exception{
		...
		InfcPkgPdfJ203yVO yetaPdfJ203yVo = new InfcPkgPdfJ203yVO();
		InfcPkgPdfJ203mVO yetaPdfJ203mVo = new InfcPkgPdfJ203mVO();
		...
		yetaPayr2200Service.yeta2200_PDF_J203Y_2017_Delete(yetaPdfJ203yVo);
		...
		yetaPayr2200Service.yeta2200_PDF_J203M_2017_Delete(yetaPdfJ203mVo);
	...
	public static void setPdfJ203yVo(InfcPkgPdfJ203yVO yetaPdfJ203yVo, InfcPkgPdfJ203mVO yetaPdfJ203mVo, InfcPkgYe161010VO ye161010VO, 
		...
		for(int i = 0; i < subXmlElChildSum.getLength(); i++) {  
			...
			yetaPayr2200Service.yeta2200_PDF_J203Y_2017_Insert(yetaPdfJ203yVo);
		}
	...
	public static void setPdfJ203mVo(InfcPkgPdfJ203mVO yetaPdfJ203mVo , HttpServletRequest request, Element subXmlElData) throws Exception{
		...
		yetaPayr2200Service.yeta2200_PDF_J203M_2017_Insert(yetaPdfJ203mVo);

	}
	
	public static void func_2017_J203Y_YetaCalc(InfcPkgYe161010VO ye161010VO, HttpServletRequest request) throws Exception{ 
		...
		InfcPkgPdfJ203ySrhVO yetaPdfJ203ySrhVo = new InfcPkgPdfJ203ySrhVO();
		...
		List<InfcPkgPdfJ203yVO> infcPkgPdfJ203yList = new ArrayList<InfcPkgPdfJ203yVO>();
		
		//퇴직연금
		infcPkgPdfJ203yList = (List<InfcPkgPdfJ203yVO>)yetaPayr2200Service.PdfYeta2200_F102Y_PDF_J203Y_Select(yetaPdfJ203ySrhVo);  
		
		if (infcPkgPdfJ203yList.size() > 0) { 
			
			for(int icnt = 0;icnt < infcPkgPdfJ203yList.size();icnt++) {
				
					InfcPkgPdfJ203yVO vPdfJ203yVo = new InfcPkgPdfJ203yVO();
...
//          yeta2000Vo.setSpch10fb(edSPCH_10FB); // 특별공제_15장기주택저당_10고정 OR 비거치상환
			...
			// 장기 주택 차입금 합계  
	         yetaPayr2200Service.fnYeta2200_J203Y_YE161060_2017_Update(infcPkgYe161060Vo); 
