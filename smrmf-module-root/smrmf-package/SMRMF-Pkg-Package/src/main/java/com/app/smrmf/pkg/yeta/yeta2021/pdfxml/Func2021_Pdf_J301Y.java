...
public class Func2021_Pdf_J301Y {
	...
	public static void func_2021_J301Y_J301M(InfcPkgYe161010_2021_VO ye161010VO, Element  subXmlElForm, String nResult, HttpServletRequest request ) throws Exception{
		...
		InfcPkgPdfJ301y_2021_VO yetaPdfJ301yVo = new InfcPkgPdfJ301y_2021_VO();
		InfcPkgPdfJ301m_2021_VO yetaPdfJ301mVo = new InfcPkgPdfJ301m_2021_VO();
		...
		for (int j = 0; j < subXmlElChildForm.getLength();j++) { 
			...
			for(int k = 0; k < subXmlElChildMan.getLength();k++) {  
				...
				if (strDatCd.equals("G0018")) {
					...
					yetaPayr3200Service.yeta6200_PDF_J301Y_2021_Delete(yetaPdfJ301yVo);
					yetaPayr3200Service.yeta6200_PDF_J301Y_2021_Insert(yetaPdfJ301yVo);
				}
	...
	public static void func_2021_J301Y_YetaCalc(InfcPkgYe161010_2021_VO ye161010VO, HttpServletRequest request) throws Exception{ 
		...
		InfcPkgYe162030_2021_VO infcPkgYe162030Vo = new InfcPkgYe162030_2021_VO();
		...
		//주택마련
		yetaPayr3200Service.PdfYeta6200_J301Y_YE162030_Delete(infcPkgYe162030Vo); 
		yetaPayr3200Service.PdfYeta6200_J301Y_YE162030_Insert(infcPkgYe162030Vo); 
		...
		// 주택마련 합계  
         yetaPayr3200Service.fnYeta6200_J301Y_YE161070_2021_Update(infcPkgYe161070Vo); 
