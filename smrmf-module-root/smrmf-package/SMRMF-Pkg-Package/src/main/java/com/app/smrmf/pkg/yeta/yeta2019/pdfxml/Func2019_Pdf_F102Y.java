...
public class Func2019_Pdf_F102Y {
	...
	public static void func_2019_F102Y_F102M(InfcPkgYe161010_2019_VO ye161010VO, Element  subXmlElForm, String nResult , HttpServletRequest request ) throws Exception{
		...
		InfcPkgPdfF102y_2019_VO yetaPdfF102yVo = new InfcPkgPdfF102y_2019_VO();
		InfcPkgPdfF102m_2019_VO yetaPdfF102mVo = new InfcPkgPdfF102m_2019_VO();
...
//					yetaPdfF102yVo.setRetirPnsnAmtSum(new BigDecimal(MSFSharedUtils.defaultNulls(PkgFuncUtils.getXmlTagValue("sum", subXmlElData), "0")));
					...
					yetaPayr3200Service.yeta4200_PDF_F102Y_2019_Delete(yetaPdfF102yVo);
					yetaPayr3200Service.yeta4200_PDF_F102Y_2019_Insert(yetaPdfF102yVo);
				}
			}
	...
	public static void func_2019_F102Y_YetaCalc(InfcPkgYe161010_2019_VO ye161010VO, HttpServletRequest request) throws Exception{ 
		...
		InfcPkgYe162020_2019_VO infcPkgYe162020Vo = new InfcPkgYe162020_2019_VO();
		...
		//퇴직연금
		yetaPayr3200Service.PdfYeta4200_F102Y_YE162020_Delete(infcPkgYe162020Vo); 
		yetaPayr3200Service.PdfYeta4200_F102Y_YE162020_Insert(infcPkgYe162020Vo); 
		...
		// 퇴직연금 합계  
         yetaPayr3200Service.fnYeta4200_F102Y_YE161080_2019_Update(infcPkgYe161080Vo); 
