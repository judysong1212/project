...
public class Func2023_Pdf_J401Y {
	...
	public static void func_2023_J401Y_J401M(InfcPkgYe161010_2023_VO ye161010VO, Element  subXmlElForm, String nResult, HttpServletRequest request ) throws Exception{
		...
		InfcPkgPdfJ401y_2023_VO yetaPdfJ401yVo = new InfcPkgPdfJ401y_2023_VO();
		InfcPkgPdfJ401m_2023_VO yetaPdfJ401mVo = new InfcPkgPdfJ401m_2023_VO();
		...
		for (int j = 0; j < subXmlElChildForm.getLength();j++) { 
			...
			for(int k = 0; k < subXmlElChildMan.getLength();k++) {  
				...
				if (strDatCd.equals("G0023")) {
					...
					yetaPayr3200Service.yeta8200_PDF_J401Y_2023_Delete(yetaPdfJ401yVo);
					yetaPayr3200Service.yeta8200_PDF_J401Y_2023_Insert(yetaPdfJ401yVo);
				}
			}
