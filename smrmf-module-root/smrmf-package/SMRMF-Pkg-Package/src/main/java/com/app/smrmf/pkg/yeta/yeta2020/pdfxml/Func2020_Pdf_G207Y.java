...
public class Func2020_Pdf_G207Y {
	...
	public static void func_2020_G207Y_G207M(InfcPkgYe161010_2020_VO ye161010VO, Element  subXmlElForm, String nResult , HttpServletRequest request ) throws Exception{
		...
		InfcPkgPdfG207y_2020_VO yetaPdfG207yVo = new InfcPkgPdfG207y_2020_VO();
		InfcPkgPdfG207m_2020_VO yetaPdfG207mVo = new InfcPkgPdfG207m_2020_VO();
		...
		yetaPayr3200Service.yeta5200_PDF_G207Y_2020_Delete(yetaPdfG207yVo);
		...
		yetaPayr3200Service.yeta5200_PDF_G207M_2020_Delete(yetaPdfG207mVo);
	...
	public static void setPdfG207yVo(InfcPkgPdfG207y_2020_VO yetaPdfG207yVo , HttpServletRequest request, Element subXmlElData) throws Exception{
		...
		yetaPayr3200Service.yeta5200_PDF_G207Y_2020_Insert(yetaPdfG207yVo);

	}
	
	public static void setPdfG207mVo(InfcPkgPdfG207m_2020_VO yetaPdfG207mVo , HttpServletRequest request, Element subXmlElData) throws Exception{
		...
		yetaPayr3200Service.yeta5200_PDF_G207M_2020_Insert(yetaPdfG207mVo);

	}
	
	

	public static void func_2020_G207Y_YetaCalc(InfcPkgYe161010_2020_VO ye161010VO, HttpServletRequest request) throws Exception{ 
		...
		dataChk = yetaPayr3200Service.PdfYeta2020_G207Y_YE161040_Update(infcPkgYe161040Vo); 
		...
		if (dataChk >= 0) {
			...
			// 신용카드  
	         yetaPayr3200Service.fnYeta5200_G207Y_YE161070_2020_Update(infcPkgYe161070Vo); 
