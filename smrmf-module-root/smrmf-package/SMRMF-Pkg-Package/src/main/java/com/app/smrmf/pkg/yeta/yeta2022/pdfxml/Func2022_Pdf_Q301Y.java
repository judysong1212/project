...
public class Func2022_Pdf_Q301Y {
	...
	private static final Logger logger = LoggerFactory.getLogger(Func2022_Pdf_Q301Y.class);


	public static void func_2022_Q301Y_Q301M(InfcPkgYe161010_2022_VO ye161010VO, Element  subXmlElForm, String nResult, HttpServletRequest request) throws Exception{
		...
		InfcPkgPdfQ301y_2022_VO yetaPdfQ301yVo = new InfcPkgPdfQ301y_2022_VO();
		InfcPkgPdfQ301m_2022_VO yetaPdfQ301mVo = new InfcPkgPdfQ301m_2022_VO();
		...
		yetaPayr3200Service.yeta7200_PDF_Q301Y_2022_Delete(yetaPdfQ301yVo);
	...
	public static void setPdfQ301yVo (InfcPkgPdfQ301y_2022_VO yetaPdfQ301yVo, HttpServletRequest request, Element subXmlElData) throws Exception{
		if  (yetaPayr3200Service == null) { 
			WebApplicationContext wac = WebApplicationContextUtils.
					getRequiredWebApplicationContext( request.getSession().getServletContext());
		...
		yetaPayr3200Service.yeta7200_PDF_Q301Y_2022_Insert(yetaPdfQ301yVo);
	}
	 ...
	 * </pre>
	 * @Method Name : func_2022_Q301Y_YetaCalc
	 * @date : 2022. 1. 23.
	 * @author : atres
	 * @history : 
	 *	-----------------------------------------------------------------------
	 ...
	 * @throws Exception
	 */
	public static void func_2022_Q301Y_YetaCalc(InfcPkgYe161010_2022_VO ye161010VO, HttpServletRequest request) throws Exception{ 
		...
		yetaPayr3200Service.PdfYeta7200_Q301Y_YE166040_Delete(infcPkgYe166040Vo); 
		yetaPayr3200Service.PdfYeta7200_Q301Y_YE166040_Insert(infcPkgYe166040Vo); 
		...
		// 벤처기업투자신탁 합계  
        yetaPayr3200Service.fnYeta7200_Q301Y_YE161070_2022_Update(infcPkgYe161070Vo); 
