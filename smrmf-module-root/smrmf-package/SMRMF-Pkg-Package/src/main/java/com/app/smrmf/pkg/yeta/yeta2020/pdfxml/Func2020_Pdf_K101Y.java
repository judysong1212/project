...
public class Func2020_Pdf_K101Y {
	...
	public static void func_2020_K101M(InfcPkgYe161010_2020_VO ye161010VO, Element  subXmlElForm, String nResult, HttpServletRequest request ) throws Exception{
		...
		InfcPkgPdfK101y_2020_VO yetaPdfK101yVo = new InfcPkgPdfK101y_2020_VO();
		InfcPkgPdfK101m_2020_VO yetaPdfK101mVo = new InfcPkgPdfK101m_2020_VO();
			...
			for(int k = 0; k < subXmlElChildMan.getLength();k++) {  
				...
				if (strDatCd.equals("G0019")) {
					...
					for(int i = 0; i < subXmlElChildSum.getLength(); i++) {  
						...
						yetaPayr3200Service.yeta5200_PDF_K101Y_2020_Delete(yetaPdfK101yVo);
						yetaPayr3200Service.yeta5200_PDF_K101Y_2020_Insert(yetaPdfK101yVo);
					}
	...
	public static void setPdfK101mVo(InfcPkgPdfK101m_2020_VO yetaPdfK101mVo , HttpServletRequest request, Element subXmlElData) throws Exception{
		...
		yetaPayr3200Service.yeta5200_PDF_K101M_2020_Delete(yetaPdfK101mVo);
		yetaPayr3200Service.yeta5200_PDF_K101M_2020_Insert(yetaPdfK101mVo);

	}
	
	public static void func_2020_K101M_YetaCalc(InfcPkgYe161010_2020_VO ye161010VO, HttpServletRequest request) throws Exception{ 
       ...
       //소기업소상공인 공제부금 - - K101M 월별 K01 소기업소상공인공제부금 본인
		...
		// 주택마련 합계  
         yetaPayr3200Service.fnYeta5200_K101M_YE161070_2020_Update(infcPkgYe161070Vo); 
