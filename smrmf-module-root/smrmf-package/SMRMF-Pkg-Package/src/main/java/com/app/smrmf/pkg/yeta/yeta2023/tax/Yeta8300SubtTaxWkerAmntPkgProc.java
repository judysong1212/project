 ...
 */
@Controller 
public class Yeta8300SubtTaxWkerAmntPkgProc  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta8300SubtTaxWkerAmntPkgProc.class);
	   
    @Resource(name = "Yeta8300PayrService")
    protected Yeta8300PayrService  infcPkgYeta8300;
    
 
    public Yeta8300SubtTaxWkerAmntPkgProc() {
    	
    } 
    
    public List<ShowMessageBM> execSubtTaxWkerAmntPkgProc(HttpServletRequest request,InfcPkgYe161010_2023_VO  infcPkgYe161010Vo)  throws Exception  {
     ...
     * @throws Exception
     */
    private  List<ShowMessageBM>  YetaTaxWkerAmntUpdate(HttpServletRequest request,InfcPkgYe161010_2023_VO  infcPkgYe161010Vo) throws Exception {
      ...
      //    /* (97) column 차감소득금액 : SUBT_ERAM */  
  	      ...
  	      *******************************************************************************************/  
  		      InfcPkgYe169010_2023_VO wkInfcPkgYe169010Vo = new InfcPkgYe169010_2023_VO();  //연말정산결과  
  		      InfcPkgYe169010_2023_VO tpWkInfcPkgYe169010Vo = new InfcPkgYe169010_2023_VO();  //연말정산결과  
  		    ...
  		    tpWkInfcPkgYe169010Vo = infcPkgYeta8300.fnYeta8300_YE169010_Tax_2023_2001_Select(wkInfcPkgYe169010Vo); 
				...
				wkInfcPkgYe169010Vo.setYeta0c94(exSPCI_OBAM);    /** column C94_특별소득공제_기부금_이월분금액 : yeta0c94 */
  		        ...
  		        statCnt = 0;
  			  	statCnt =  infcPkgYeta8300.fnYeta8300_YE169010_Tax_2023_2003_Select(wkInfcPkgYe169010Vo); 
