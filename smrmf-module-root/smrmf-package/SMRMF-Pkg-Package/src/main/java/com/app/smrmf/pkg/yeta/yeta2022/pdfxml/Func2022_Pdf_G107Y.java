...
public class Func2022_Pdf_G107Y {
	...
	public static void func_2022_G107Y_G107M(InfcPkgYe161010_2022_VO ye161010VO, Element  subXmlElForm, String nResult , HttpServletRequest request ) throws Exception{
		...
		InfcPkgPdfG107y_2022_VO yetaPdfG107yVo = new InfcPkgPdfG107y_2022_VO();
		InfcPkgPdfG107m_2022_VO yetaPdfG107mVo = new InfcPkgPdfG107m_2022_VO();
		...
		yetaPayr3200Service.yeta7200_PDF_G107Y_2022_Delete(yetaPdfG107yVo);
		...
		yetaPayr3200Service.yeta7200_PDF_G107M_2022_Delete(yetaPdfG107mVo);
		...
		for (int j = 0; j < subXmlElChildForm.getLength();j++) { 
			...
			yetaPayr3200Service.yeta7200_PDF_G107M_2022_Insert(yetaPdfG107mVo);
	...
	public static void setPdfG107yVo(InfcPkgPdfG107y_2022_VO yetaPdfG107yVo , HttpServletRequest request) throws Exception{
		...
		yetaPayr3200Service.yeta7200_PDF_G107Y_2022_Insert(yetaPdfG107yVo);

	}
	
	

	public static void func_2022_G107Y_YetaCalc(InfcPkgYe161010_2022_VO ye161010VO, HttpServletRequest request) throws Exception{ 
		...
		yetaPayr3200Service.yeta7200_PDF_G107M_2022_Update(yetaPdfG107mVo);
	...
	//  신용카드 시작
		...
		dataChk =  yetaPayr3200Service.PdfYeta2022_G107Y_YE161040_Update(infcPkgYe161040Vo); 
		...
		if (dataChk >= 0) {
			...
			// 신용카드  
	         yetaPayr3200Service.fnYeta7200_G107Y_YE161070_2022_Update(infcPkgYe161070Vo); 
