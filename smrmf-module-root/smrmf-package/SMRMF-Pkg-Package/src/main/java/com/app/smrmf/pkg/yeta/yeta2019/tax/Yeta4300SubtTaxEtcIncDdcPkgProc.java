 ...
 */
@Controller 
public class Yeta4300SubtTaxEtcIncDdcPkgProc  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta4300SubtTaxEtcIncDdcPkgProc.class);
	   
    @Resource(name = "Yeta4300PayrService")
    protected Yeta4300PayrService  infcPkgYeta4300;
    
 
    public Yeta4300SubtTaxEtcIncDdcPkgProc() {
    	
    } 
    
    public  List<ShowMessageBM> execSubtTaxEtcIncDdcPkgProc(HttpServletRequest request,InfcPkgYe161010_2019_VO  ye161010VO)  throws Exception  {
    ...
    * @throws Exception
    */
    private   List<ShowMessageBM> YetaSubtCreateUpdate(HttpServletRequest request,InfcPkgYe161010_2019_VO  infcPkgYe161010Vo) throws Exception {
     ...
     * @throws Exception
     */
    private   List<ShowMessageBM> YetaSubtStdTaxUpdate(HttpServletRequest request,InfcPkgYe161010_2019_VO  infcPkgYe161010Vo) throws Exception {
  	  ...
  	  infcPkgYeta4300 = (Yeta4300PayrService)BeanFinder.getBean("Yeta4300PayrService"); 
     	...
     	infcPkgYe161010Vo.setRevnAddr(RemoteServiceUtil.getThreadLocalRequest().getRemoteHost());    			/** column 수정주소 : revnAddr */
  	      ...
  	      *******************************************************************************************/  
  		      InfcPkgYe169010a_2019_VO subInfcPkgYe169010aVo = new InfcPkgYe169010a_2019_VO();  //연말정산결과  
  		      InfcPkgYe169010a_2019_VO tpSubInfcPkgYe169010aVo = new InfcPkgYe169010a_2019_VO();  //연말정산결과  
  		    ...
  		    subInfcPkgYe169010aVo.setDpobCd(infcPkgYe161010Vo.getDpobCd());    /** column 사업장코드 : dpobCd */
  		      ...
  		      tpSubInfcPkgYe169010aVo = infcPkgYeta4300.fnYeta4300_YE169010a_Tax_2019_2001_Select(subInfcPkgYe169010aVo); 
  		      ...
  		      if (MSFSharedUtils.paramNotNull(tpSubInfcPkgYe169010aVo) && MSFSharedUtils.paramNotNull(tpSubInfcPkgYe169010aVo.getSystemkey())) {
  		        ...
  		        statCnt = 0;
  			  	statCnt =  infcPkgYeta4300.fnYeta4300_YE169010a_Tax_2019_2002_Update(subInfcPkgYe169010aVo); 
     ...
     * @throws Exception
     */
    private   List<ShowMessageBM> YetaSubtBaseTaxUpdate(HttpServletRequest request,InfcPkgYe161010_2019_VO  infcPkgYe161010Vo) throws Exception {
  	  ...
  	  infcPkgYeta4300 = (Yeta4300PayrService)BeanFinder.getBean("Yeta4300PayrService"); 
     	...
     	infcPkgYe161010Vo.setRevnAddr(RemoteServiceUtil.getThreadLocalRequest().getRemoteHost());    			/** column 수정주소 : revnAddr */
  	      ...
  	      *******************************************************************************************/  
  		      InfcPkgYe169010_2019_VO subInfcPkgYe169010Vo = new InfcPkgYe169010_2019_VO();  //연말정산결과  
  		      InfcPkgYe169010_2019_VO tpSubInfcPkgYe169010Vo = new InfcPkgYe169010_2019_VO();  //연말정산결과  
  		      ...
  		      tpSubInfcPkgYe169010Vo = infcPkgYeta4300.fnYeta4300_YE169010_Tax_2019_2001_Select(subInfcPkgYe169010Vo); 
  		      ...
  		      if (MSFSharedUtils.paramNotNull(tpSubInfcPkgYe169010Vo) && MSFSharedUtils.paramNotNull(tpSubInfcPkgYe169010Vo.getSystemkey())) {
  		        ...
  		        statCnt = 0;
  			  	statCnt =  infcPkgYeta4300.fnYeta4300_YE169010_Tax_2019_2002_Update(subInfcPkgYe169010Vo); 
