...
public class Func2021_Pdf_G207Y {
	...
	public static void func_2021_G207Y_G207M(InfcPkgYe161010_2021_VO ye161010VO, Element  subXmlElForm, String nResult , HttpServletRequest request ) throws Exception{
		...
		InfcPkgPdfG207y_2021_VO yetaPdfG207yVo = new InfcPkgPdfG207y_2021_VO();
		InfcPkgPdfG207m_2021_VO yetaPdfG207mVo = new InfcPkgPdfG207m_2021_VO();
		...
		yetaPayr3200Service.yeta6200_PDF_G207Y_2021_Delete(yetaPdfG207yVo);
		...
		yetaPayr3200Service.yeta6200_PDF_G207M_2021_Delete(yetaPdfG207mVo);
		...
		for (int j = 0; j < subXmlElChildForm.getLength();j++) { 
			...
			yetaPayr3200Service.yeta6200_PDF_G207M_2021_Insert(yetaPdfG207mVo);
	...
	public static void setPdfG207yVo(InfcPkgPdfG207y_2021_VO yetaPdfG207yVo , HttpServletRequest request) throws Exception{
		...
		yetaPayr3200Service.yeta6200_PDF_G207Y_2021_Insert(yetaPdfG207yVo);

	}
	

	public static void func_2021_G207Y_YetaCalc(InfcPkgYe161010_2021_VO ye161010VO, HttpServletRequest request) throws Exception{ 
		...
		yetaPayr3200Service.yeta6200_PDF_G207M_2021_Update(yetaPdfG207mVo);
		...
		dataChk = yetaPayr3200Service.PdfYeta2021_G207Y_YE161040_Update(infcPkgYe161040Vo); 
		...
		if (dataChk >= 0) {
			...
			// 신용카드  
	         yetaPayr3200Service.fnYeta6200_G207Y_YE161070_2021_Update(infcPkgYe161070Vo); 
