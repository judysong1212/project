...
public class Func2020_Pdf_P102Y {
	...
	public static void func_2020_P102Y_P102M(InfcPkgYe161010_2020_VO ye161010VO, Element  subXmlElForm, String nResult, HttpServletRequest request ) throws Exception{
		...
		InfcPkgPdfP102y_2020_VO yetaPdfP102yVo = new InfcPkgPdfP102y_2020_VO();
		InfcPkgPdfP102m_2020_VO yetaPdfP102mVo = new InfcPkgPdfP102m_2020_VO();
			...
			for(int k = 0; k < subXmlElChildMan.getLength();k++) {  
				...
				if (strDatCd.equals("G0031")) {
					...
					for(int i = 0; i < subXmlElChildSum.getLength(); i++) {  
						...
						yetaPayr3200Service.yeta5200_PDF_P102Y_2020_Delete(yetaPdfP102yVo);
						yetaPayr3200Service.yeta5200_PDF_P102Y_2020_Insert(yetaPdfP102yVo);
					}
	...
	public static void setPdfP102mVo(InfcPkgPdfP102m_2020_VO yetaPdfP102mVo , HttpServletRequest request, Element subXmlElData) throws Exception{
		...
		yetaPayr3200Service.yeta5200_PDF_P102M_2020_Delete(yetaPdfP102mVo);
		yetaPayr3200Service.yeta5200_PDF_P102M_2020_Insert(yetaPdfP102mVo);
		

	}
	

	public static void func_2020_P102M_YetaCalc(InfcPkgYe161010_2020_VO ye161010VO, HttpServletRequest request) throws Exception{ 
        ...
        InfcPkgYe161055_2020_VO infcPkgYe161055Vo = new InfcPkgYe161055_2020_VO();
		...
		//YE161055 국민연금 주사업장 
		yetaPayr3200Service.PdfYeta2020_P102M_YE161055_Update(infcPkgYe161055Vo); 
		 
		
		//국민연금보험료
		InfcPkgYe161050_2020_VO infcPkgYe161050Vo = new InfcPkgYe161050_2020_VO();
		...
		// 국민연금보험료 합계  
         yetaPayr3200Service.fnYeta5200_P102M_YE161050_2020_Update(infcPkgYe161050Vo); 
