 ...
 */
@Controller 
public class Yeta5300SubtTaxEtcIncDdcPkgProc  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta5300SubtTaxEtcIncDdcPkgProc.class);
	   
    @Resource(name = "Yeta5300PayrService")
    protected Yeta5300PayrService  infcPkgYeta5300;
    
 
    public Yeta5300SubtTaxEtcIncDdcPkgProc() {
    	
    } 
    
    public  List<ShowMessageBM> execSubtTaxEtcIncDdcPkgProc(HttpServletRequest request,InfcPkgYe161010_2020_VO  ye161010VO)  throws Exception  {
    ...
    * @throws Exception
    */
    private   List<ShowMessageBM> YetaSubtCreateUpdate(HttpServletRequest request,InfcPkgYe161010_2020_VO  infcPkgYe161010Vo) throws Exception {
     ...
     * @throws Exception
     */
    private   List<ShowMessageBM> YetaSubtStdTaxUpdate(HttpServletRequest request,InfcPkgYe161010_2020_VO  infcPkgYe161010Vo) throws Exception {
  	  ...
  	  infcPkgYeta5300 = (Yeta5300PayrService)BeanFinder.getBean("Yeta5300PayrService"); 
     	...
     	infcPkgYe161010Vo.setRevnAddr(RemoteServiceUtil.getThreadLocalRequest().getRemoteHost());    			/** column 수정주소 : revnAddr */
  	      ...
  	      *******************************************************************************************/  
  		      InfcPkgYe169010a_2020_VO subInfcPkgYe169010aVo = new InfcPkgYe169010a_2020_VO();  //연말정산결과  
  		      InfcPkgYe169010a_2020_VO tpSubInfcPkgYe169010aVo = new InfcPkgYe169010a_2020_VO();  //연말정산결과  
  		    ...
  		    subInfcPkgYe169010aVo.setDpobCd(infcPkgYe161010Vo.getDpobCd());    /** column 사업장코드 : dpobCd */
  		      ...
  		      tpSubInfcPkgYe169010aVo = infcPkgYeta5300.fnYeta5300_YE169010a_Tax_2020_2001_Select(subInfcPkgYe169010aVo); 
  		      ...
  		      if (MSFSharedUtils.paramNotNull(tpSubInfcPkgYe169010aVo) && MSFSharedUtils.paramNotNull(tpSubInfcPkgYe169010aVo.getSystemkey())) {
  		        ...
  		        statCnt = 0;
  			  	statCnt =  infcPkgYeta5300.fnYeta5300_YE169010a_Tax_2020_2002_Update(subInfcPkgYe169010aVo); 
     ...
     * @throws Exception
     */
    private   List<ShowMessageBM> YetaSubtBaseTaxUpdate(HttpServletRequest request,InfcPkgYe161010_2020_VO  infcPkgYe161010Vo) throws Exception {
  	  ...
  	  infcPkgYeta5300 = (Yeta5300PayrService)BeanFinder.getBean("Yeta5300PayrService"); 
     	...
     	infcPkgYe161010Vo.setRevnAddr(RemoteServiceUtil.getThreadLocalRequest().getRemoteHost());    			/** column 수정주소 : revnAddr */
  	      ...
  	      *******************************************************************************************/  
  		      InfcPkgYe169010_2020_VO subInfcPkgYe169010Vo = new InfcPkgYe169010_2020_VO();  //연말정산결과  
  		      InfcPkgYe169010_2020_VO tpSubInfcPkgYe169010Vo = new InfcPkgYe169010_2020_VO();  //연말정산결과  
  		      ...
  		      tpSubInfcPkgYe169010Vo = infcPkgYeta5300.fnYeta5300_YE169010_Tax_2020_2001_Select(subInfcPkgYe169010Vo); 
  		      ...
  		      if (MSFSharedUtils.paramNotNull(tpSubInfcPkgYe169010Vo) && MSFSharedUtils.paramNotNull(tpSubInfcPkgYe169010Vo.getSystemkey())) {
  		        ...
  		        logger.debug("신카공제금액_3 = " + tpSubInfcPkgYe169010Vo.getYetaC104());
  		        logger.debug("신카공제금액_4 = " + exETCC_CARD);
  		      ...
  		      logger.debug("신카공제금액_5 = " + tpSubInfcPkgYe169010Vo.getYetaC104());
  		      logger.debug("신카공제금액_6 = " + exETCC_CARD);
  		        ...
  		        statCnt = 0;
  			  	statCnt =  infcPkgYeta5300.fnYeta5300_YE169010_Tax_2020_2002_Update(subInfcPkgYe169010Vo); 
