...
/**
 * @Class Name : PdfE102yVO.java
 * @Description : PdfE102y VO class
 ...
 */
public class InfcPkgPdfE102y_2022_VO   implements Serializable {
    ...
    /** PNSN_SV_SEIL_NUM */
    private java.lang.String pnsnSvSeilNum;
    ...
    /** PNSN_SV_SUM */
    private java.math.BigDecimal pnsnSvSum;
    ...
    //2022연말정산_추가
    /** ISA_ANN_TOT_AMT */
    private java.math.BigDecimal isaAnnTotAmt;
    /** ISA_TAX_YEAR_AMT */
    private java.math.BigDecimal isaTaxYearAmt;
    /** ISA_DDCT_BS_ASS_AMT */
    private java.math.BigDecimal isaDdctBsAssAmt;
    //
    
    
    public java.math.BigDecimal getIsaAnnTotAmt() {
		return isaAnnTotAmt;
	}

	public void setIsaAnnTotAmt(java.math.BigDecimal isaAnnTotAmt) {
		this.isaAnnTotAmt = isaAnnTotAmt;
	}

	public java.math.BigDecimal getIsaTaxYearAmt() {
		return isaTaxYearAmt;
	}

	public void setIsaTaxYearAmt(java.math.BigDecimal isaTaxYearAmt) {
		this.isaTaxYearAmt = isaTaxYearAmt;
	}

	public java.math.BigDecimal getIsaDdctBsAssAmt() {
		return isaDdctBsAssAmt;
	}

	public void setIsaDdctBsAssAmt(java.math.BigDecimal isaDdctBsAssAmt) {
		this.isaDdctBsAssAmt = isaDdctBsAssAmt;
	}
    ...
    public java.lang.String getPnsnSvSeilNum() {
        return this.pnsnSvSeilNum;
    }
    
    public void setPnsnSvSeilNum(java.lang.String pnsnSvSeilNum) {
    ...
    public java.math.BigDecimal getPnsnSvSum() {
        return this.pnsnSvSum;
    }
    
    public void setPnsnSvSum(java.math.BigDecimal pnsnSvSum) {
        this.pnsnSvSum = pnsnSvSum;
    }
