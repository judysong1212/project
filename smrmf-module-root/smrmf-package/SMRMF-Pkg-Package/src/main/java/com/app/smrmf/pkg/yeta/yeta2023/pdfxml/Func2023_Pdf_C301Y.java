...
public class Func2023_Pdf_C301Y {
	...
	public static void func_2023_C301Y_C301M(InfcPkgYe161010_2023_VO ye161010VO, Element  subXmlElForm, String nResult , HttpServletRequest request ) throws Exception{
		...
		InfcPkgPdfC301y_2023_VO yetaPdfC301yVo = new InfcPkgPdfC301y_2023_VO();
		InfcPkgPdfC301m_2023_VO yetaPdfC301mVo = new InfcPkgPdfC301m_2023_VO();
		...
		yetaPayr3200Service.yeta8200_PDF_C301Y_2023_Delete(yetaPdfC301yVo);
		...
		for (int j = 0; j < subXmlElChildForm.getLength();j++) { 
			...
			for(int k = 0; k < subXmlElChildMan.getLength();k++) {  
				...
				if (strDatCd.equals("G0024")) {
					...
					yetaPayr3200Service.yeta8200_PDF_C301Y_2023_Insert(yetaPdfC301yVo);
				}
	...
	public static void func_2023_C301Y_YetaCalc(InfcPkgYe161010_2023_VO ye161010VO, HttpServletRequest request) throws Exception{ 
		...
		//교육비 
		yetaPayr3200Service.PdfYeta8200_C301Y_YE161090_Delete(infcPkgYe161090Vo); 
		yetaPayr3200Service.PdfYeta8200_C301Y_YE161090_Insert(infcPkgYe161090Vo); 
