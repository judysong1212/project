...
@Controller 
public class Yeta5300Tax2020ContributionCalcPkgProc  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta5300Tax2020ContributionCalcPkgProc.class);
	   
    @Resource(name = "Yeta5300PayrService")
    protected Yeta5300PayrService  infcPkgYeta5300;
    
 
    public Yeta5300Tax2020ContributionCalcPkgProc() {
    	
    } 
    
    public List<ShowMessageBM> execTax_2020_Contribution_Calc(HttpServletRequest request, InfcPkgYe161010_2020_VO  infcPkgYe161010Vo)  throws Exception  {
  	    
	  	  return  fnTax_2020_Contribution_Calc(request,  infcPkgYe161010Vo);
	}
    ...
    * @throws Exception
    */
    private  List<ShowMessageBM> fnTax_2020_Contribution_Calc(HttpServletRequest request, InfcPkgYe161010_2020_VO  infcPkgYe161010Vo) throws Exception {
      ...
      BigDecimal bgYetaAllSumSe = BigDecimal.ZERO;  //세액합계금액 
		...
		//	BeanUtils.copyProperties(infcPkgYe165030Vo, infcPkgYe161010Vo);
            ...
            // {2011-추가기능 시작 } 
             ...
             List listYetaGibu = infcPkgYeta5300.fnYeta5300_YE169010_Tax_2020_1001_Select(infcPkgYe169010Vo); 
             ...
             if  (listYetaGibu.size() > 0) {
            	   ...
            	   Iterator<Map<String, Object>> iter = listYetaGibu.iterator(); 
		            ...
		            while ( iter.hasNext() ) { 
                     ...
                     InfcPkgYe165030Srh_2020_VO infcPkgYe165030SrhVo =  new InfcPkgYe165030Srh_2020_VO(); 
                     ...
                     List listYe165030 = infcPkgYeta5300.fnPayr06430_PAYR442_ReTax_2020_SelectFind(infcPkgYe165030SrhVo);
                    	...
                    	/**********************************************************************************************************
                     	 ...
                     	 ***********************************************************************************************************/
                     	 for(int iCnt = 0; iCnt < listYe165030.size();iCnt++) {
                     		 ...
                     		 InfcPkgYe165030_2020_VO infcPkgOrgYe165030Vo =  new InfcPkgYe165030_2020_VO();
                     		 InfcPkgYe165030_2020_VO upInfcPkgYe165030Vo =  new InfcPkgYe165030_2020_VO(); 
                           		 ...
                           		 if (mTemp10Data20.compareTo(BigDecimal.ZERO) <= 0)  { 
										   ...
										   upInfcPkgYe165030Vo.setThcYrNducCrfwAmt(BigDecimal.ZERO);    /** column 해당년도_미공제이월금액 : ayyrNtam */
		                                    ...
		                                    // {
		                                     ...
		                                     statCnt = 0;
		                     		  		 statCnt =  infcPkgYeta5300.fnPayr06430_PAYR442_ReTax_2020_Update(upInfcPkgYe165030Vo);  
                			...
                			infcPkgOrgYe165030Vo.setSpciDdctCheck(infcPkgYe161010Vo.getSpciDdctCheck());   
                       		...
                       		if (infcPkgOrgYe165030Vo.getCtrbTycd().equals("10"))  {
                       			if (infcPkgOrgYe165030Vo.getAttrYr().equals("2020")) {
                       				upInfcPkgYe165030Vo  = insertYeYe165030(infcPkgOrgYe165030Vo,upInfcPkgYe165030Vo,bgSPCI_FBTG20_10,bgSPCI_FBSE20_10,BigDecimal.ZERO);
		                            statCnt = 0;
		                      		statCnt =  infcPkgYeta5300.fnPayr06430_PAYR442_ReTax_2020_Update(upInfcPkgYe165030Vo);
		                      		if( statCnt >= 0){
                     			 ...
                     			 infcPkgOrgYe165030Vo.setSpciDdctCheck(infcPkgYe161010Vo.getSpciDdctCheck());   
                            		 ...
                            		 BeanUtils.copyProperties(upInfcPkgYe165030Vo, infcPkgOrgYe165030Vo); 
                            		  ...
                            		  if (infcPkgOrgYe165030Vo.getCtrbTycd().equals("40"))  {  //if  oraQrySelect05.FieldByName('CTRB_TYCD').AsString = '10' then
                            			  ...
                            			  if (infcPkgOrgYe165030Vo.getAttrYr().equals("2020"))  {  // if  oraQrySelect05.FieldByName('CTRB_YRMN').AsString = '2016' then
     ...
     * @return
     */
    private InfcPkgYe165030_2020_VO insertYeYe165030(InfcPkgYe165030_2020_VO infcPkgOrgYe165030Vo, InfcPkgYe165030_2020_VO upInfcPkgYe165030Vo,BigDecimal bgSPCI_FBTG17_10 ,BigDecimal bgSPCI_FBSE17_10,BigDecimal orgSanChul) {
