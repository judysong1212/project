...
import com.app.smrmf.infc.yearendtax.server.vo.yeta2018.InfcPkgPdfC101m_2018_VO;
...
public class Func2018_Pdf_C101Y {
	...
	public static void func_2018_C101Y_C101M(InfcPkgYe161010_2018_VO ye161010VO, Element  subXmlElForm, String nResult , HttpServletRequest request) throws Exception{
		...
		InfcPkgPdfC101y_2018_VO yetaPdfC101yVo = new InfcPkgPdfC101y_2018_VO();
		InfcPkgPdfC101m_2018_VO yetaPdfC101mVo = new InfcPkgPdfC101m_2018_VO();
		...
		yetaPayr3200Service.yeta3200_PDF_C101Y_2018_Delete(yetaPdfC101yVo);
...
//					}
	...
	public static void setPdfC101yVo(InfcPkgPdfC101y_2018_VO yetaPdfC101yVo , HttpServletRequest request) throws Exception{
		...
		yetaPayr3200Service.yeta3200_PDF_C101Y_2018_Insert(yetaPdfC101yVo);
	 ...
	 * </pre>
	 * @Method Name : func_2018_C102Y_YetaCalc
	 * @date : 2018. 1. 23.
	 * @author : atres
	 * @history : 
	 *	-----------------------------------------------------------------------
	 ...
	 * @throws Exception
	 */
	public static void func_2018_C101Y_YetaCalc(InfcPkgYe161010_2018_VO ye161010VO, HttpServletRequest request) throws Exception{ 
      ...
      //   G0007 교육비-기타 본인+가족 개별제출
		...
		InfcPkgYe161090_2018_VO infcPkgYe161090Vo = new InfcPkgYe161090_2018_VO();
		...
		//교육비 
		yetaPayr3200Service.PdfYeta3200_C101Y_YE161090_Delete(infcPkgYe161090Vo); 
		yetaPayr3200Service.PdfYeta3200_C101Y_YE161090_Insert(infcPkgYe161090Vo); 
		...
		yetaPayr3200Service.PdfYeta2018_C101Y_YE161040_Update(infcPkgYe161040Vo); 
		...
		// 교육비 합계  
         yetaPayr3200Service.fnYeta3200_C101Y_YE161080_2018_Update(infcPkgYe161080Vo); 
