package com.app.smrmf.pkg.yeta.yeta2021.pdfxml.service.impl;
...
import com.app.smrmf.infc.yearendtax.server.service.yeta2021.dao.*;
 ...
 * </pre>
 */
@Service("Yeta6200XmlService")
public class Yeta6200XmlServiceImpl extends AbstractServiceImpl  implements  Yeta6200XmlService {

	private static final Logger LOGGER = LoggerFactory.getLogger(Yeta6200XmlServiceImpl.class);
	...
	//2021연말정산_추가
	@Autowired
	@Resource(name="InfcPkgPdfG107m_2021_DAO")
	private InfcPkgPdfG107m_2021_DAO pdfG107mDAO;
	...
	@Autowired
	@Resource(name="InfcPkgPdfYE162015_2021_DAO")
	private InfcPkgPdfYE162015_2021_DAO pdfYE162015DAO;
	
	@Autowired
	@Resource(name="InfcPkgYe167010_2021_DAO")
	private InfcPkgYe167010_2021_DAO ye167010DAO;
	
	@Autowired
	@Resource(name="InfcPkgYe167020_2021_DAO")
	private InfcPkgYe167020_2021_DAO ye167020DAO;
	
	@Autowired
	@Resource(name="InfcPkgYe167030_2021_DAO")
	private InfcPkgYe167030_2021_DAO ye167030DAO;
	
	@Autowired
	@Resource(name="InfcPkgYe167040_2021_DAO")
	private InfcPkgYe167040_2021_DAO ye167040DAO;
	
	@Autowired
	@Resource(name="InfcPkgYe167050_2021_DAO")
	private InfcPkgYe167050_2021_DAO ye167050DAO;
	
	@Autowired
	@Resource(name="InfcPkgYe167060_2021_DAO")
	private InfcPkgYe167060_2021_DAO ye167060DAO;
	
	@Autowired
	@Resource(name="InfcPkgYe167070_2021_DAO")
	private InfcPkgYe167070_2021_DAO ye167070DAO;
	
	@Autowired
	@Resource(name="InfcPkgYe167530_2021_DAO")
	private InfcPkgYe167530_2021_DAO ye167530DAO;
	
	@Autowired
	@Resource(name="InfcPkgYe167110_2021_DAO")
	private InfcPkgYe167110_2021_DAO ye167110DAO;
	
	@Autowired
	@Resource(name="InfcPkgYe167120_2021_DAO")
	private InfcPkgYe167120_2021_DAO ye167120DAO;
	
	@Autowired
	@Resource(name="InfcPkgYe167130_2021_DAO")
	private InfcPkgYe167130_2021_DAO ye167130DAO;
	
	@Autowired
	@Resource(name="InfcPkgYe167140_2021_DAO")
	private InfcPkgYe167140_2021_DAO ye167140DAO;
	
	@Autowired
	@Resource(name="InfcPkgYe167150_2021_DAO")
	private InfcPkgYe167150_2021_DAO ye167150DAO;

	@Autowired
	@Resource(name="InfcPkgYe167210_2021_DAO")
	private InfcPkgYe167210_2021_DAO ye167210DAO;
	
	@Autowired
	@Resource(name="InfcPkgYe167220_2021_DAO")
	private InfcPkgYe167220_2021_DAO ye167220DAO;
	
	@Autowired
	@Resource(name="InfcPkgYe167230_2021_DAO")
	private InfcPkgYe167230_2021_DAO ye167230DAO;
	
	@Autowired
	@Resource(name="InfcPkgYe167240_2021_DAO")
	private InfcPkgYe167240_2021_DAO ye167240DAO;
	
	@Autowired
	@Resource(name="InfcPkgYe167310_2021_DAO")
	private InfcPkgYe167310_2021_DAO ye167310DAO;
	
	@Autowired
	@Resource(name="InfcPkgYe167320_2021_DAO")
	private InfcPkgYe167320_2021_DAO ye167320DAO;

	@Autowired
	@Resource(name="InfcPkgYe167410_2021_DAO")
	private InfcPkgYe167410_2021_DAO ye167410DAO;
	
	@Autowired
	@Resource(name="InfcPkgYe167420_2021_DAO")
	private InfcPkgYe167420_2021_DAO ye167420DAO;
	
	@Autowired
	@Resource(name="InfcPkgYe167430_2021_DAO")
	private InfcPkgYe167430_2021_DAO ye167430DAO;
	
	@Autowired
	@Resource(name="InfcPkgYe167440_2021_DAO")
	private InfcPkgYe167440_2021_DAO ye167440DAO;

	@Autowired
	@Resource(name="InfcPkgYe167510_2021_DAO")
	private InfcPkgYe167510_2021_DAO ye167510DAO;
	
	@Autowired
	@Resource(name="InfcPkgYe167520_2021_DAO")
	private InfcPkgYe167520_2021_DAO ye167520DAO;
	...
	@Autowired
	@Resource(name = "InfcPkgYe166030_2021_DAO")
	private InfcPkgYe166030_2021_DAO infcPkgYe166030DAO; //실손보험금 2021연말정산
	...
	//2021연말정산_추가
	@Autowired
	@Resource(name = "InfcPkgYe166040_2021_DAO")
	private InfcPkgYe166040_2021_DAO infcPkgYe166040DAO; //C_주현근무처
	...
	@Override
	public void yeta6200_PDF_C401Y_2021_Delete(InfcPkgPdfC401y_2021_VO yetaPdfC401yVo) throws Exception {
	...
	@Override
	public void yeta6200_PDF_G107Y_2021_Delete(InfcPkgPdfG107y_2021_VO yetaPdfG107yVo) throws Exception {
	...
	//2021연말정산_추가
	@Override
	public void yeta6200_PDF_G107M_2021_Delete(InfcPkgPdfG107m_2021_VO yetaPdfG107mVo) throws Exception {
	...
	@Override
	public String yeta6200_PDF_O101Y_2021_Insert(InfcPkgPdfO101y_2021_VO yetaPdfO101yVo) throws Exception {
	...
	@Override
	public void yeta6200_PDF_Q301Y_2021_Delete(InfcPkgPdfQ301y_2021_VO yetaPdfQ301yVo) throws Exception {
		pdfQ301yDAO.deletePdfQ301y(yetaPdfQ301yVo);
		
	}
	
	@Override
	public String yeta6200_PDF_Q301Y_2021_Insert(InfcPkgPdfQ301y_2021_VO yetaPdfQ301yVo) throws Exception {
	 ...
	 *	-----------------------------------------------------------------------
	 * 
	 * @see com.app.smrmf.pkg.yeta.yeta2021.pdfxml.service.Yeta6200XmlService#PdfYeta2021_A102Y_YE161040_Update(com.app.smrmf.infc.yearendtax.server.vo.yeta2017.InfcPkgYe161010VO)
	 * @param ye161010VO
	 * @return
	 * @throws Exception
	 */
	public int PdfYeta2021_A102Y_YE161040_Update(InfcPkgYe161040_2021_VO ye161040VO) throws Exception {
	 
		return infcPkgYe161040DAO.PdfYeta2021_A102Y_YE161040_Update(ye161040VO);
	...
	public String fnYeta6200_A102Y_YE161080_2021_Update(InfcPkgYe161080_2021_VO infcPkgYe161080Vo) throws Exception {
		...
		return infcPkgYe161080DAO.fnYeta6200_A102Y_YE161080_2021_Update(infcPkgYe161080Vo);
	...
	public String PdfYeta6200_B101Y_YE164010_Delete(InfcPkgYe164010_2021_VO infcPkgYe164010Vo) throws Exception {
		...
		return infcPkgYe164010DAO.PdfYeta6200_B101Y_YE164010_Delete(infcPkgYe164010Vo);
			 
	} 
	
	public String PdfYeta6200_B101Y_YE164010_Insert(InfcPkgYe164010_2021_VO infcPkgYe164010Vo) throws Exception {
		 
		return infcPkgYe164010DAO.PdfYeta6200_B101Y_YE164010_Insert(infcPkgYe164010Vo);
			 
	} 
	
	public int PdfYeta2021_B101Y_YE161040_Update(InfcPkgYe161040_2021_VO ye161040VO) throws Exception {
		 
		return infcPkgYe161040DAO.PdfYeta2021_B101Y_YE161040_Update(ye161040VO);
	...
	public int fnYeta6200_B101Y_YE161080_2021_Update(InfcPkgYe161080_2021_VO infcPkgYe161080Vo) throws Exception {
		...
		return infcPkgYe161080DAO.fnYeta6200_B101Y_YE161080_2021_Update(infcPkgYe161080Vo);
	...
	//실손의료보험비 추가20201211 2021연말정산
		public String PdfYeta6200_B201Y_YE166030_Delete(InfcPkgYe166030_2021_VO infcPkgYe166030Vo) throws Exception {
			...
			return infcPkgYe166030DAO.PdfYeta6200_B201Y_YE166030_Delete(infcPkgYe166030Vo);
				 
		} 
		
		public String PdfYeta6200_B201Y_YE166030_Insert(InfcPkgYe166030_2021_VO infcPkgYe166030Vo) throws Exception {
			 
			return infcPkgYe166030DAO.PdfYeta6200_B201Y_YE166030_Insert(infcPkgYe166030Vo);
				 
		}
		
		public int PdfYeta2021_B201Y_YE161040_Update(InfcPkgYe161040_2021_VO ye161040VO) throws Exception {
			 
			return infcPkgYe161040DAO.PdfYeta2021_B201Y_YE161040_Update(ye161040VO);
		...
		public int fnYeta6200_B201Y_YE161080_2021_Update(InfcPkgYe161080_2021_VO infcPkgYe161080Vo) throws Exception {
			...
			return infcPkgYe161080DAO.fnYeta6200_B201Y_YE161080_2021_Update(infcPkgYe161080Vo);
		...
		public String PdfYeta6200_J501Y_YE162510_Delete(InfcPkgYe162510_2021_VO infcPkgYe162510Vo) throws Exception {
			...
			return infcPkgYe162510DAO.PdfYeta6200_J501Y_YE162510_Delete(infcPkgYe162510Vo);
				 
		} 
		
		public String PdfYeta6200_J501Y_YE162510_Insert(InfcPkgYe162510_2021_VO infcPkgYe162510Vo) throws Exception {
			 
			return infcPkgYe162510DAO.PdfYeta6200_J501Y_YE162510_Insert(infcPkgYe162510Vo);
				 
		}
		
		public String fnYeta6200_J501Y_YE161080_2021_Update(InfcPkgYe161080_2021_VO infcPkgYe161080Vo) throws Exception {
			 
			return infcPkgYe161080DAO.fnYeta6200_J501Y_YE161080_2021_Update(infcPkgYe161080Vo);
	...
	public String PdfYeta6200_C101Y_YE161090_Delete(InfcPkgYe161090_2021_VO infcPkgYe161090Vo) throws Exception {
		...
		return infcPkgYe161090DAO.PdfYeta6200_C101Y_YE161090_Delete(infcPkgYe161090Vo);
			 
	} 
	
	public String PdfYeta6200_C101Y_YE161090_Insert(InfcPkgYe161090_2021_VO infcPkgYe161090Vo) throws Exception {
		 
		return infcPkgYe161090DAO.PdfYeta6200_C101Y_YE161090_Insert(infcPkgYe161090Vo);
			 
	} 
	
	public int PdfYeta2021_C101Y_YE161040_Update(InfcPkgYe161040_2021_VO ye161040VO) throws Exception {
		 
		return infcPkgYe161040DAO.PdfYeta2021_C101Y_YE161040_Update(ye161040VO);
			 
	} 
	
	public String fnYeta6200_C101Y_YE161080_2021_Update(InfcPkgYe161080_2021_VO infcPkgYe161080Vo) throws Exception {
		 
		return infcPkgYe161080DAO.fnYeta6200_C101Y_YE161080_2021_Update(infcPkgYe161080Vo);
	...
	//직업훈련비
		...
		public String PdfYeta6200_C202Y_YE161090_Delete(InfcPkgYe161090_2021_VO infcPkgYe161090Vo) throws Exception {
			...
			return infcPkgYe161090DAO.PdfYeta6200_C202Y_YE161090_Delete(infcPkgYe161090Vo);
				 
		} 
		
		public String PdfYeta6200_C202Y_YE161090_Insert(InfcPkgYe161090_2021_VO infcPkgYe161090Vo) throws Exception {
			 
			return infcPkgYe161090DAO.PdfYeta6200_C202Y_YE161090_Insert(infcPkgYe161090Vo);
...
//교복구입비
	...
	public String PdfYeta6200_C301Y_YE161090_Delete(InfcPkgYe161090_2021_VO infcPkgYe161090Vo) throws Exception {
		...
		return infcPkgYe161090DAO.PdfYeta6200_C301Y_YE161090_Delete(infcPkgYe161090Vo);
			 
	} 
	
	public String PdfYeta6200_C301Y_YE161090_Insert(InfcPkgYe161090_2021_VO infcPkgYe161090Vo) throws Exception {
		 
		return infcPkgYe161090DAO.PdfYeta6200_C301Y_YE161090_Insert(infcPkgYe161090Vo);
		...
		public String PdfYeta6200_C401Y_YE161090_Delete(InfcPkgYe161090_2021_VO infcPkgYe161090Vo) throws Exception {
			...
			return infcPkgYe161090DAO.PdfYeta6200_C401Y_YE161090_Delete(infcPkgYe161090Vo);
				 
		} 
		
		public String PdfYeta6200_C401Y_YE161090_Insert(InfcPkgYe161090_2021_VO infcPkgYe161090Vo) throws Exception {
			 
			return infcPkgYe161090DAO.PdfYeta6200_C401Y_YE161090_Insert(infcPkgYe161090Vo);
		...
		public String PdfYeta6200_D101Y_YE162010_Delete(InfcPkgYe162010_2021_VO infcPkgYe162010Vo) throws Exception {
			...
			return infcPkgYe162010DAO.PdfYeta6200_D101Y_YE162010_Delete(infcPkgYe162010Vo);
				 
		} 
		
		public String PdfYeta6200_D101Y_YE162010_Insert(InfcPkgYe162010_2021_VO infcPkgYe162010Vo) throws Exception {
			 
			return infcPkgYe162010DAO.PdfYeta6200_D101Y_YE162010_Insert(infcPkgYe162010Vo);
		...
		public String fnYeta6200_D101Y_YE161070_2021_Update(InfcPkgYe161070_2021_VO infcPkgYe161070Vo) throws Exception {
			...
			return infcPkgYe161070DAO.fnYeta6200_D101Y_YE161070_2021_Update(infcPkgYe161070Vo);
   ...
   //연금저축 
		...
		public String PdfYeta6200_E102Y_YE162010_Delete(InfcPkgYe162010_2021_VO infcPkgYe162010Vo) throws Exception {
			...
			return infcPkgYe162010DAO.PdfYeta6200_E102Y_YE162010_Delete(infcPkgYe162010Vo);
				 
		} 
		
		public String PdfYeta6200_E102Y_YE162010_Insert(InfcPkgYe162010_2021_VO infcPkgYe162010Vo) throws Exception {
			 
			return infcPkgYe162010DAO.PdfYeta6200_E102Y_YE162010_Insert(infcPkgYe162010Vo);
		...
		public String fnYeta6200_E102Y_YE161080_2021_Update(InfcPkgYe161080_2021_VO infcPkgYe161080Vo) throws Exception {
			...
			return infcPkgYe161080DAO.fnYeta6200_E102Y_YE161080_2021_Update(infcPkgYe161080Vo);
		...
		public String PdfYeta6200_F102Y_YE162020_Delete(InfcPkgYe162020_2021_VO infcPkgYe162020Vo) throws Exception {
			...
			return infcPkgYe162020DAO.PdfYeta6200_F102Y_YE162020_Delete(infcPkgYe162020Vo);
				 
		} 
		
		public String PdfYeta6200_F102Y_YE162020_Insert(InfcPkgYe162020_2021_VO infcPkgYe162020Vo) throws Exception {
			 
			return infcPkgYe162020DAO.PdfYeta6200_F102Y_YE162020_Insert(infcPkgYe162020Vo);
		...
		public String fnYeta6200_F102Y_YE161080_2021_Update(InfcPkgYe161080_2021_VO infcPkgYe161080Vo) throws Exception {
			...
			return infcPkgYe161080DAO.fnYeta6200_F102Y_YE161080_2021_Update(infcPkgYe161080Vo);
				 
		} 
		
		//YE161040 소득공제명세에 신용카드 
		
		public int PdfYeta2021_G107Y_YE161040_Update(InfcPkgYe161040_2021_VO ye161040VO) throws Exception {
			 
			return infcPkgYe161040DAO.PdfYeta2021_G107Y_YE161040_Update(ye161040VO);
				 
		} 
		
		public String PdfYeta6200_G107Y_YE166020_Update(InfcPkgYe166020_2021_VO infcPkgYe166020Vo) throws Exception {
			 
			return infcPkgYe166020DAO.PdfYeta6200_G107Y_YE166020_Update(infcPkgYe166020Vo);
				 
		} 
		
		public String fnYeta6200_G107Y_YE161070_2021_Update(InfcPkgYe161070_2021_VO infcPkgYe161070Vo) throws Exception {
			 
			return infcPkgYe161070DAO.fnYeta6200_G107Y_YE161070_2021_Update(infcPkgYe161070Vo);
				 
		}
		
		//YE161040 소득공제명세에 현금영수증  
	
		public int PdfYeta2021_G207Y_YE161040_Update(InfcPkgYe161040_2021_VO ye161040VO) throws Exception {
			 
			return infcPkgYe161040DAO.PdfYeta2021_G207Y_YE161040_Update(ye161040VO);
				 
		} 
	 
		public String fnYeta6200_G207Y_YE161070_2021_Update(InfcPkgYe161070_2021_VO infcPkgYe161070Vo) throws Exception {
			 
			return infcPkgYe161070DAO.fnYeta6200_G207Y_YE161070_2021_Update(infcPkgYe161070Vo);
				 
		} 
		
		
		//YE161040 소득공제명세에 직불카드   
		public int PdfYeta2021_G307Y_YE161040_Update(InfcPkgYe161040_2021_VO ye161040VO) throws Exception {
			 
			return infcPkgYe161040DAO.PdfYeta2021_G307Y_YE161040_Update(ye161040VO);
				 
		} 
	 
		public String fnYeta6200_G307Y_YE161070_2021_Update(InfcPkgYe161070_2021_VO infcPkgYe161070Vo) throws Exception {
			 
			return infcPkgYe161070DAO.fnYeta6200_G307Y_YE161070_2021_Update(infcPkgYe161070Vo);
				 
		}
		
		//YE161040 소득공제명세에 제로페이   
		public int PdfYeta2021_G407Y_YE161040_Update(InfcPkgYe161040_2021_VO ye161040VO) throws Exception {
			 
			return infcPkgYe161040DAO.PdfYeta2021_G407Y_YE161040_Update(ye161040VO);
				 
		} 
	 
		public String fnYeta6200_G407Y_YE161070_2021_Update(InfcPkgYe161070_2021_VO infcPkgYe161070Vo) throws Exception {
			 
			return infcPkgYe161070DAO.fnYeta6200_G407Y_YE161070_2021_Update(infcPkgYe161070Vo);
		...
		public String fnYeta6200_J101Y_YE161060_2021_Update(InfcPkgYe161060_2021_VO infcPkgYe161060Vo) throws Exception {
			...
			return infcPkgYe161060DAO.fnYeta6200_J101Y_YE161060_2021_Update(infcPkgYe161060Vo);
		...
		public List<InfcPkgPdfJ203y_2021_VO> PdfYeta6200_F102Y_PDF_J203Y_Select(InfcPkgPdfJ203ySrh_2021_VO yetaPdfJ203yVo) throws Exception {
			...
			return (List<InfcPkgPdfJ203y_2021_VO>)pdfJ203yDAO.PdfYeta6200_F102Y_PDF_J203Y_Select(yetaPdfJ203yVo);
		...
		public String fnYeta6200_J203Y_YE161060_2021_Update(InfcPkgYe161060_2021_VO infcPkgYe161060Vo) throws Exception {
			...
			return infcPkgYe161060DAO.fnYeta6200_J203Y_YE161060_2021_Update(infcPkgYe161060Vo);
		...
		public String PdfYeta6200_J301Y_YE162030_Delete(InfcPkgYe162030_2021_VO infcPkgYe162030Vo) throws Exception {
			...
			return infcPkgYe162030DAO.PdfYeta6200_J301Y_YE162030_Delete(infcPkgYe162030Vo);
				 
		} 
		
		public String PdfYeta6200_J301Y_YE162030_Insert(InfcPkgYe162030_2021_VO infcPkgYe162030Vo) throws Exception {
			 
			return infcPkgYe162030DAO.PdfYeta6200_J301Y_YE162030_Insert(infcPkgYe162030Vo);
		...
		public String fnYeta6200_J301Y_YE161070_2021_Update(InfcPkgYe161070_2021_VO infcPkgYe161070Vo) throws Exception {
			...
			return infcPkgYe161070DAO.fnYeta6200_J301Y_YE161070_2021_Update(infcPkgYe161070Vo);
				 
		} 
		//소상공인공제  
		public String fnYeta6200_K101M_YE161070_2021_Update(InfcPkgYe161070_2021_VO infcPkgYe161070Vo) throws Exception {
			 
			return infcPkgYe161070DAO.fnYeta6200_K101M_YE161070_2021_Update(infcPkgYe161070Vo);
		...
		public String PdfYeta6200_Q101Y_YE166040_Delete(InfcPkgYe166040_2021_VO infcPkgYe166040Vo) throws Exception {
			...
			return infcPkgYe166040DAO.PdfYeta6200_Q101Y_YE166040_Delete(infcPkgYe166040Vo);
				 
		} 
		
		public String PdfYeta6200_Q101Y_YE166040_Insert(InfcPkgYe166040_2021_VO infcPkgYe166040Vo) throws Exception {
			 
			return infcPkgYe166040DAO.PdfYeta6200_Q101Y_YE166040_Insert(infcPkgYe166040Vo);
				 
		}
		
		public String fnYeta6200_Q101Y_YE161070_2021_Update(InfcPkgYe161070_2021_VO infcPkgYe161070Vo) throws Exception {
			 
			return infcPkgYe161070DAO.fnYeta6200_Q101Y_YE161070_2021_Update(infcPkgYe161070Vo);
		...
		public String PdfYeta6200_Q201Y_YE166040_Delete(InfcPkgYe166040_2021_VO infcPkgYe166040Vo) throws Exception {
			...
			return infcPkgYe166040DAO.PdfYeta6200_Q201Y_YE166040_Delete(infcPkgYe166040Vo);
				 
		} 
		
		public String PdfYeta6200_Q201Y_YE166040_Insert(InfcPkgYe166040_2021_VO infcPkgYe166040Vo) throws Exception {
			 
			return infcPkgYe166040DAO.PdfYeta6200_Q201Y_YE166040_Insert(infcPkgYe166040Vo);
				 
		}
		
		public String fnYeta6200_Q201Y_YE161070_2021_Update(InfcPkgYe161070_2021_VO infcPkgYe161070Vo) throws Exception {
			 
			return infcPkgYe161070DAO.fnYeta6200_Q201Y_YE161070_2021_Update(infcPkgYe161070Vo);
		...
		public String PdfYeta6200_Q301Y_YE166040_Delete(InfcPkgYe166040_2021_VO infcPkgYe166040Vo) throws Exception {
			...
			return infcPkgYe166040DAO.PdfYeta6200_Q301Y_YE166040_Delete(infcPkgYe166040Vo);
				 
		} 
		
		public String PdfYeta6200_Q301Y_YE166040_Insert(InfcPkgYe166040_2021_VO infcPkgYe166040Vo) throws Exception {
			 
			return infcPkgYe166040DAO.PdfYeta6200_Q301Y_YE166040_Insert(infcPkgYe166040Vo);
				 
		}
		
		public String fnYeta6200_Q301Y_YE161070_2021_Update(InfcPkgYe161070_2021_VO infcPkgYe161070Vo) throws Exception {
			 
			return infcPkgYe161070DAO.fnYeta6200_Q301Y_YE161070_2021_Update(infcPkgYe161070Vo);
		...
		public int fnYeta6200_L102Y_YE161080_2021_Update(InfcPkgYe161080_2021_VO infcPkgYe161080Vo) throws Exception {
			...
			return infcPkgYe161080DAO.fnYeta6200_L102Y_YE161080_2021_Update(infcPkgYe161080Vo);
				 
		}  
		
		public int fnYeta6200_L102Y_YE161040_2021_Update(InfcPkgYe161040_2021_VO infcPkgYe161040Vo) throws Exception {
			 
			return infcPkgYe161040DAO.fnYeta6200_L102Y_YE161040_2021_Update(infcPkgYe161040Vo);
		...
		public String fnYeta6200_L102Y_YE161060_2021_Update(InfcPkgYe161060_2021_VO infcPkgYe161060Vo) throws Exception {
			...
			return infcPkgYe161060DAO.fnYeta6200_L102Y_YE161060_2021_Update(infcPkgYe161060Vo);
		...
		public String PdfYeta6200_N101Y_YE162040_Delete(InfcPkgYe162040_2021_VO infcPkgYe162040Vo) throws Exception {
			...
			return infcPkgYe162040DAO.PdfYeta6200_N101Y_YE162040_Delete(infcPkgYe162040Vo);
				 
		} 
		
		public String PdfYeta6200_N101Y_YE162040_Insert(InfcPkgYe162040_2021_VO infcPkgYe162040Vo) throws Exception {
			 
			return infcPkgYe162040DAO.PdfYeta6200_N101Y_YE162040_Insert(infcPkgYe162040Vo);
		...
		public String fnYeta6200_N101Y_YE161070_2021_Update(InfcPkgYe161070_2021_VO infcPkgYe161070Vo) throws Exception {
			...
			return infcPkgYe161070DAO.fnYeta6200_N101Y_YE161070_2021_Update(infcPkgYe161070Vo);
		...
		public String PdfYeta2021_O101M_YE161040_Update(InfcPkgYe161040_2021_VO infcPkgYe161040Vo) throws Exception {
			...
			return infcPkgYe161040DAO.PdfYeta2021_O101M_YE161040_Update(infcPkgYe161040Vo);
				 
		} 
		
		public String fnYeta6200_O101M_YE161060_2021_Update(InfcPkgYe161060_2021_VO infcPkgYe161060Vo) throws Exception {
			 
			return infcPkgYe161060DAO.fnYeta6200_O101M_YE161060_2021_Update(infcPkgYe161060Vo);
		...
		public String PdfYeta2021_P102M_YE161055_Update(InfcPkgYe161055_2021_VO infcPkgYe161055Vo) throws Exception {
			...
			return infcPkgYe161055DAO.PdfYeta2021_P102M_YE161055_Update(infcPkgYe161055Vo);
		...
		public int PdfYeta6200_AllDelete(InfcPkgYe161010_2021_VO ye161010vo)throws Exception {
			return infcPkgYe161010DAO.PdfYeta6200_AllDelete(ye161010vo);
		}

		 
	/*********************************************************************************************** 
	 * 2021년도 간소화 자료 업데이트 부분처리 서비스 시작 정산데이타 반영부 처리 메서드 종료
	 ***********************************************************************************************/
}
