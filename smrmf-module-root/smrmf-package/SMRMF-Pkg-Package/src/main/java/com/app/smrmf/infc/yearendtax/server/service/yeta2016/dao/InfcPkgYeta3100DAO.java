...
@Repository("InfcPkgYeta3100DAO")
public class InfcPkgYeta3100DAO extends EgovAbstractDAO {
    ...
    public String insertYeta3100(InfcPkgYeta3100VO vo) throws Exception {
        return (String)insert("infcPkgYeta3100DAO.insertYetaPrc3100_S", vo);
    }
	  @Transactional
    public String fnPayr06430_Payr418_2016_Insert(InfcPkgYeta3100VO vo) throws Exception {
        return (String)insert("infcPkgYeta3100DAO.fnPayr06430_Payr418_2016_Insert", vo);
    }
    ...
    public void updateYeta3100(InfcPkgYeta3100VO vo) throws Exception {
        update("infcPkgYeta3100DAO.updateYetaPrc3100_S", vo);
    }
    ...
    public void deleteYeta3100(InfcPkgYeta3100VO vo) throws Exception {
        delete("infcPkgYeta3100DAO.deleteYetaPrc3100_S", vo);
    }
	  @Transactional
    public void fnPayr06430_Payr418_2015_Delete(InfcPkgYeta3100VO vo) throws Exception {
        delete("infcPkgYeta3100DAO.fnPayr06430_Payr418_2015_Delete", vo);
    }
    ...
    public void fnPayr06430_PAYR418_CREATE_Delete(InfcPkgYeta3100VO vo) throws Exception {
        delete("infcPkgYeta3100DAO.fnPayr06430_PAYR418_CREATE_Delete_S", vo);
    }
    ...
    public InfcPkgYeta3100VO selectYeta3100(InfcPkgYeta3100VO vo) throws Exception {
        return (InfcPkgYeta3100VO) selectByPk("infcPkgYeta3100DAO.selectYetaPrc3100_S", vo);
    }
    ...
    public List<?> selectYeta3100List(InfcPkgYeta3100SrhVO searchVO) throws Exception {
        return list("infcPkgYeta3100DAO.selectYetaPrc3100List_D", searchVO);
    }
    ...
    public int selectYeta3100ListTotCnt(InfcPkgYeta3100SrhVO searchVO) {
        return (Integer)getSqlMapClientTemplate().queryForObject("infcPkgYeta3100DAO.selectYetaPrc3100ListTotCnt_S", searchVO);
    }
