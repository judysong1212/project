 ...
 */
@Controller 
public class Yeta3300TaxPkgProc  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta3300TaxPkgProc.class);
	   
    @Resource(name = "Yeta3300PayrService")
    protected Yeta3300PayrService  infcPkgYeta3300;
    
 
    public Yeta3300TaxPkgProc() {
    	
    } 
    
    public PagingLoadResult<ShowMessageBM> execfnYeta3300TaxPkgProc(HttpServletRequest request,List<InfcPkgYe161010_2018_VO> listYe161010VO)  throws Exception  {
  	    
	  	  return  funcYeta3300TaxPkgProc(request,  listYe161010VO);
	}
     ...
     * @throws Exception
     */
    private PagingLoadResult<ShowMessageBM> funcYeta3300TaxPkgProc(HttpServletRequest request,List<InfcPkgYe161010_2018_VO> listYe161010VO)  throws Exception  {
             ...
             /************************* 대상자별로 루프 시작 ***************************************************/ 
	  		  ...
	  		  for (int iCnt01 = 0;iCnt01 < listYe161010VO.size();iCnt01++) {
		              ...
		              **********************************************************************************************/
				  		  ...
				  		  statCnt = 0;
				  		    //의료비정리
				  		   infcPkgYeta3300.fnYeta3300_B101Y_YE161080_2018_Update(infcPkgYe161010Vo);
				  		  //주택마련저축정리 
				  		  infcPkgYeta3300.fnYeta3300_TaxPkg01_2018_Update(infcPkgYe161010Vo);  
				  		  //합계처리 
				  		   infcPkgYeta3300.fnYeta3300_All_YE161080_2018_Update(infcPkgYe161010Vo);
				  		
				  	      if (statCnt >= 0) {
						  		// ############## YE161020 부양가족인원수 ##############   
						 		statCnt = 0;
						  		statCnt = infcPkgYeta3300.fnYeta3300_YE161020_Tax_2018_01_Update(infcPkgYe161020Vo);  
						  		if (statCnt >= 0) { 
							  		statCnt = 0;
							  		// ############## YE161055 국민연금등정리 ############## 
							  		statCnt = infcPkgYeta3300.fnYeta3300_YE161055_Tax_2018_02_Update(infcPkgYe161055Vo); 
							  		if (statCnt >= 0) { 
								  		statCnt = 0;
								  		// ############## YE161050 국민연금등합계 ############## 
								  		statCnt = infcPkgYeta3300.fnYeta3300_YE161050_Tax_2018_03_Update(infcPkgYe161050Vo); 
								  		if (statCnt >= 0) { 
//									  		statCnt = 0;
//									  		//국민연금등합계 XXXX
//									  		statCnt = infcPkgYeta3300.fnYeta3300_YE161050_Tax_2018_03_Update(infcPkgYe161050Vo);  
//									  		if (statCnt >= 0) { 
										  		statCnt = 0;
										  		/* ############## YE169010 비과세 정리  ##############  */
										  		statCnt = infcPkgYeta3300.fnYeta3300_YE169010_Tax_2018_04_Update(infcPkgYe169010Vo); 
										  		if (statCnt >= 0) { 
										  		    /**####################### 공제단계 시작 01 총급여등기본공제,추가공제등 공제금액인서트  ############################################*/  
											  		statCnt = 0; 
											  		statCnt = infcPkgYeta3300.fnYeta3300_YE169010_Tax_2018_05_Update(infcPkgYe169010Vo);  
											  		if (statCnt >= 0) {   
										                 /**#######################  {공제단계 시작 -소득공제 02} ############################################*/ 
												  		if (statCnt >= 0) { 
												  		statCnt = 0;
												  		statCnt =  infcPkgYeta3300.fnYeta3300_YE169010_Tax_2018_06_Update(infcPkgYe169010Vo); 	
												  		if (statCnt >= 0) {  
											                 /**#######################  {공제단계 시작 -연금보험료공제 03} ############################################*/ 
											                 //      ---------------------------연금보험료공제-------------------------------------- 
													  		statCnt = 0;
													  		statCnt =  infcPkgYeta3300.fnYeta3300_YE169010_Tax_2018_07_Update(infcPkgYe169010Vo); 
													  		if (statCnt >= 0) {
												                  /**#######################  {공제단계 시작 -특별공제 - 주택임차차임금 상환액  09 } ############################################*/ 
												                  //   ------------------특별공제 - 주택임차차임금 상환액--------------------------- 
														  		statCnt = 0;  //TODO YE161060 작업함
														  		statCnt =  infcPkgYeta3300.fnYeta3300_YE169010_Tax_2018_08_Update(infcPkgYe169010Vo); 
														  		if (statCnt >= 0) { 
												                  /**#######################  {공제단계 시작 -특별공제 - 주택마련저축  10 } ############################################*/ 
															  		statCnt = 0;
															  		statCnt = infcPkgYeta3300.fnYeta3300_YE169010_Tax_2018_09_Update(infcPkgYe169010Vo); 
														  			if (statCnt >= 0) {
													                  /**#######################  {공제단계 시작 -특별공제 - 주택마련저축 합계  10-1 } ############################################*/ 
																  	
																  		statCnt = 0;
																  		statCnt =  infcPkgYeta3300.fnYeta3300_YE169010_Tax_2018_10_Update(infcPkgYe169010Vo); 
																  		if (statCnt >= 0) {
																  			/**#######################  {공제단계 시작 -특별공제 - 장기주택이자상환액  10-2 } ############################################*/
																	  		statCnt = 0;
																	  		statCnt =  infcPkgYeta3300.fnYeta3300_YE169010_Tax_2018_11_Update(infcPkgYe169010Vo); 
																	  		if (statCnt >= 0) { 
																                 /**#######################  {공제단계 시작 -특별공제 - 장기주택이자상환액 고정금리 비거치  10-3 } ############################################*/
																		  		statCnt = 0;
																		  		statCnt = infcPkgYeta3300.fnYeta3300_YE169010_Tax_2018_12_Update(infcPkgYe169010Vo); 
																		  		if (statCnt >= 0) { 
																                  /**#######################  {공제단계 시작 -특별공제 - 장기주택이자상환액 기타 대출  10-4 } ############################################*/
																			  		
																			  		statCnt = 0;
																			  		  infcPkgYeta3300.fnYeta3300_YE169010_Tax_2018_13_Update(infcPkgYe169010Vo); 
																			  		//if (statCnt >= 0) { 
																			  			 /**#######################  {장기주택이자상환액 2015년이후 고정금리이면서 비거치상환 대출 } ############################################*/ 
																				  		statCnt = 0;
																				  		statCnt = infcPkgYeta3300.fnYeta3300_YE169010_Tax_2018_14_Update(infcPkgYe169010Vo);  
																				  		if (statCnt >= 0) { 
																				  		   /**#######################  기타로직  등 계산 로직 ############################################*/ 
																					  		statCnt = 0;
																					  		statCnt =  infcPkgYeta3300.fnYeta3300_YE169010_Tax_2018_15_Update(infcPkgYe169010Vo); 
																					  		if (statCnt >= 0) {
																				                /**#######################  투자조합출자등소득공제 2015년  ############################################*/ 
																						  		 statCnt = 0;
																						  		 statCnt =  infcPkgYeta3300.fnYeta3300_YE169010_Tax_2018_16_Update(infcPkgYe161070Vo);
																						  		 if (statCnt >= 0) {
																					                /**#######################  투자조합출자등소득공제 2016년  ############################################*/ 
																							  		 statCnt = 0;
																							  		 statCnt =  infcPkgYeta3300.fnYeta3300_YE169010_Tax_2018_17_Update(infcPkgYe161070Vo); 
																							  		 if (statCnt >= 0) {
																							  			statCnt = 0;
																								  		statCnt =  infcPkgYeta3300.fnYeta3300_YE169010_Tax_2018_18_Update(infcPkgYe161070Vo); 
																								  		if (statCnt >= 0) {	
																							                 /**#######################  신용카드  등 계산 로직  ############################################*/ 
																									  		statCnt = 0;
																									  		statCnt =  infcPkgYeta3300.fnYeta3300_YE169010_Tax_2018_19_Update(infcPkgYe169010Vo); 
																									  		if (statCnt >= 0) {
																								                 /**#######################  {공제단계 시작 -연금보험료공제 연금보험료공제  대상금액 04}  ############################################*/																										  		
																										  		statCnt = 0;
																										  		statCnt =  infcPkgYeta3300.fnYeta3300_YE169010_Tax_2018_20_Update(infcPkgYe169010Vo); 
																										  		if (statCnt >= 0) {
																								                   /**#######################  {공제단계 시작 -연금보험료공제 03_1 대상금액 구하는 로직 추가  05}############################################*/
																									                 // ---------------------------연금보험료공제-------------------------------------- 
																											  		statCnt = 0;
																											  		statCnt =  infcPkgYeta3300.fnYeta3300_YE169010_Tax_2018_21_Update(infcPkgYe169010Vo); 
																											  		if (statCnt >= 0) { 
																										                 /**#######################  {공제단계 시작 -특별공제 - 보장성/장애인  보험료  06} ############################################*/
																												  	
																												  		statCnt = 0;
																												  		statCnt = infcPkgYeta3300.fnYeta3300_YE169010_Tax_2018_22_Update(infcPkgYe169010Vo); 
																												  		if (statCnt >= 0) {
																											                 /**#######################  특별공제 - 보험료 ############################################*/

																													  		statCnt = 0;
																													  		statCnt = infcPkgYeta3300.fnYeta3300_YE169010_Tax_2018_23_Update(infcPkgYe169010Vo); 
																													  		if (statCnt >= 0) {
																												                 /**#######################  {공제단계 시작 -특별공제 - 의료비 대상금액  07 - 1} ############################################*/
																														  	
																														  		statCnt = 0;
																														  		statCnt =  infcPkgYeta3300.fnYeta3300_YE169010_Tax_2018_24_Update(infcPkgYe169010Vo); 
																														  		if (statCnt >= 0) { 
																												                  /**#######################  {공제단계 시작 -특별공제 - 의료비   07 -2 } ############################################*/
//																													               -----------------------특별공제 - 의료비 ------------------
																															  		
																															  		statCnt = 0;
																															  		statCnt =  infcPkgYeta3300.fnYeta3300_YE169010_Tax_2018_25_Update(infcPkgYe161080Vo); 
																															  		if (statCnt >= 0) {
																															  			statCnt =  infcPkgYeta3300.fnYeta3300_YE169010_Tax_2018_25_01_Update(infcPkgYe161080Vo); 
																														                 /**####################### {공제단계 시작 -특별공제 - 교육비   08 -1 }  ############################################*/   
																													                  //    ----------------------특별공제 - 교육비 ---------------------
																															  		          //TODO YE161080 에작업함 
																																	  		statCnt = 0;
																																	  		statCnt =  infcPkgYeta3300.fnYeta3300_YE169010_Tax_2018_26_Update(infcPkgYe161080Vo); 
																																	  		if (statCnt >= 0) { 
																																                 /**#######################  {공제단계 시작 -특별공제 - 교육비 공제  08 -2 }  ############################################*/
																																		  		statCnt = 0;
																																		  		statCnt =  infcPkgYeta3300.fnYeta3300_YE169010_Tax_2018_27_Update(infcPkgYe161080Vo);
																																		  		if (statCnt >= 0) { 
																																			        /**####################### {공제단계 시작 -특별공제 - 기부금관계코드 오류 정정  11 }  ############################################*/
																																	                 //   -------------------------기부금관계코드 오류 정정  ------------------------------
//																																			  		statCnt = 0;
//																																			  		statCnt =  infcPkgYeta3300.fnPayr06430_PAYR425_ReTax_2016_CREATE_06_1_Update(infcPkgYe161010Vo); 
//																																			  		if (statCnt >= 0) { 
//																																			  			
//																																			  			
//																																			  		}
																																                  ...
																																                  /**#######################  {공제단계 시작 -특별공제 - 기부금공제   12   }  ############################################*/
																																	                 //   -------------------------기부금공제 1 -이전월 포함.------------------------------
																																			  		...
																																			  		statCnt = 0;
																																			  		statCnt =  infcPkgYeta3300.fnYeta3300_YE169010_Tax_2018_29_Update(infcPkgYe169010Vo); 
																																			  		if (statCnt >= 0) {  
																																		                 /**#######################  기부금공제 1 -귀속년도 법정기부금 ############################################*/
																																				  		statCnt = 0;
																																				  		statCnt =  infcPkgYeta3300.fnYeta3300_YE169010_Tax_2018_30_Update(infcPkgYe169010Vo); 
																																				  		if (statCnt >= 0) { 
																																		                   /**#######################  기부금공제 1 -귀속년도 법정기부금. ############################################*/
																																					  		//여기부터 
																																					  		statCnt = 0;
																																					  		statCnt =  infcPkgYeta3300.fnYeta3300_YE169010_Tax_2018_31_Update(infcPkgYe169010Vo);
																																					  		if (statCnt >= 0) {
																																					  			statCnt = 0;
																																						  		statCnt =  infcPkgYeta3300.fnYeta3300_YE169010_Tax_2018_31_01_Update(infcPkgYe169010Vo);
																																						  		if (statCnt >= 0) {
...
//																																						  		statCnt = 0;
//																																						  		statCnt =  infcPkgYeta3300.fnPayr06430_PAYR425_ReTax_2016_CREATE_09_01_Update(infcPkgYe161010Vo);
//																																						  		if (statCnt >= 0) { 
//																																						  		}
	...
	statCnt = 0;
	statCnt =  infcPkgYeta3300.fnYeta3300_YE169010_Tax_2018_32_Update(infcPkgYe169010Vo); 
	if (statCnt >= 0) {
      /**#######################  기부금공제 2013년도 이전 종교단체/외 이월 기부금  ############################################*/
		statCnt = 0;   //TODO YE161060 작업함 
		statCnt =  infcPkgYeta3300.fnYeta3300_YE169010_Tax_2018_33_Update(infcPkgYe161060Vo); 		
		if (statCnt >= 0) {
			statCnt = 0;   //TODO YE161060 작업함 
			statCnt =  infcPkgYeta3300.fnYeta3300_YE169010_Tax_2018_33_02_Update(infcPkgYe161060Vo); 		
			if (statCnt >= 0) {	
				statCnt = 0;   //TODO YE161060 작업함 
				statCnt =  infcPkgYeta3300.fnYeta3300_YE169010_Tax_2018_33_03_Update(infcPkgYe169010Vo); 		
				if (statCnt >= 0) {	
					statCnt = 0;   //TODO YE161060 작업함 
					statCnt =  infcPkgYeta3300.fnYeta3300_YE169010_Tax_2018_33_04_Update(infcPkgYe169010Vo); 		
					if (statCnt >= 0) {		
          /**#######################  기부금공제 특례기부금공제,당해년도 종교단체기부금 대상금액 ############################################*/
 		
 		statCnt = 0;
 		statCnt =  infcPkgYeta3300.fnPayr06430_PAYR425_ReTax_2016_CREATE_09_021_Update(infcPkgYe169010Vo); 
 		statCnt =  infcPkgYeta3300.fnPayr06430_PAYR425_ReTax_2016_CREATE_09_022_Update(infcPkgYe169010Vo); 
 		if (statCnt >= 0) {
          /**#######################  기부금공제  2014 년도 종교단체기부금 대상금액 ############################################*/
	  	
	  		statCnt = 0;
	  		statCnt =  infcPkgYeta3300.fnPayr06430_PAYR425_ReTax_2016_CREATE_09_031_Update(infcPkgYe169010Vo); 
	  		statCnt =  infcPkgYeta3300.fnPayr06430_PAYR425_ReTax_2016_CREATE_09_032_Update(infcPkgYe169010Vo); 
	  		if (statCnt >= 0) {
              /**#######################  기부금공제 3 불러와서 년도별 수정하는걸로 변경함 ############################################*/ 
	  			
	  	         List listYetaGibu = infcPkgYeta3300.fnYeta3300_YE169010_Tax_2018_TgYear_Select(infcPkgYe169010Vo); 
	             ...
	             if  (listYetaGibu.size() > 0) {
			            ...
			            while ( iter.hasNext() ) { 
			               ...
			               BigDecimal bgYETA_C144=new BigDecimal(MSFSharedUtils.defaultNulls(mapYetaGibu.get("yetaC144"),"0"));
 		 			        ...
 		 			        InfcPkgYe169010_2018_VO     inputYe169010Vo = new InfcPkgYe169010_2018_VO();	//C_주현근무처 
 						...
 						//	InfcPkgYe161070VO    inputYe161070Vo	 = new InfcPkgYe161070VO();	//C_그밖의소득공제
 							InfcPkgYe161080_2018_VO    inputYe161080Vo	 = new InfcPkgYe161080_2018_VO();	//C_세액감면및공제
						...
						//	
							...
							statCnt = 0;
					  		statCnt =  infcPkgYeta3300.fnYeta3300_YE169010_Tax_2018_TgIn01_Update( inputYe161080Vo) ;
					  		if (statCnt >= 0) {
					  			
					  			statCnt = 0;
						  		statCnt =  infcPkgYeta3300.fnYeta3300_YE169010_Tax_2018_TgIn02_Update( inputYe169010Vo) ;
					  		}
		  		...
		  		//statCnt = 0;
		  	//	statCnt =  infcPkgYeta3300.fnPayr06430_PAYR425_ReTax_2016_CREATE_10_Update(infcPkgYe169010Vo); 
		  		//if (statCnt >= 0) {
	                 /**$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$ 기부금 처리 단계 $$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$ */
	                // {*********공제단계 시작   ******************* }
	                //  {2011년도 기부금 내역 정보 삭제  443 테이블에 필요없는데이터 삭제 - 삭제하면 다른 데이타 삭제로 제거  }
	                //    TODO 확인 차후 추가하던지 하기 
	                // infcPkgYeta3300.fnPayr06430_PAYR443_ReTax_2014_CREATE_10_1_Delete(infcPkgYe161010Vo); 	
	               // {공제단계 시작 -  기부금 내역 정보 삭제  442  -- 13 } 
	                 /**#######################  기부금공제 3 ############################################*/ 
//			  		statCnt = 0;  수시로 업데이트 하므로 삭제하면 안됨 
//			  		statCnt =   infcPkgYeta3300.fnPayr06430_PAYR425_ReTax_2016_CREATE_10_1_Delete(infcPkgYe161010Vo); 
//			  		if (statCnt >= 0) { 
//			  			
//			  		}
              ...
              /**#######################  공제단계 시작 - 이전 이월정산정리 작업 443 -> 442로이관    -- 14 ############################################*/
		  			...
		  			dataCheck = "";
		  		 	dataCheck =  infcPkgYeta3300.fnYeta3300_YE169010_Tax_2018_40_Update(infcPkgYe165030Vo);   
		  			if (statCnt >= 0) {   
	                   //  {공제단계 시작 - 기부금 내역 정보 정산.     15 - 1 } 전단계에서 자동으로 처리함 제외 
	                     /**#######################  공제단계 시작 - 기부금 내역 정보 정산.     15 - 1 ############################################*/ 
//			  		dataCheck = "";
//		  			dataCheck =   infcPkgYeta3300.fnPayr06430_PAYR425_ReTax_2016_CREATE_10_1_Update(infcPkgYe161010Vo); 
//		  			if (MSFSharedUtils.paramNull(dataCheck)) {  
//		  				
//		  			}
		  				 /**#######################  기부금 정리 이월분 정리 작업 시작   ############################################*/ 	
		  				statCnt = 0;  
		  				Yeta3300Tax2018ContributionCalcPkgProc tax2018ContributionCalcPkgProc = new Yeta3300Tax2018ContributionCalcPkgProc();
		  				bmResult.addAll(tax2018ContributionCalcPkgProc.execTax_2018_Contribution_Calc(request,infcPkgYe161010Vo)); 
		  		  		if (bmResult.size() >= 0) {
		  				//if (0 >= 0) {
		  		  		//여기까지 	
/******************************************************** 기부금 종료 전체 다시 작업  *****************************************************************************/
		              ...
		              // if (MSFSharedUtils.paramNull(dataCheck)) {         
//		                 statCnt = 0;
//		 		  		  statCnt =  infcPkgYeta3300.fnPayr06430_PAYR415_ReTax_2016_CREATE_12_1_Update(infcPkgYe169010Vo); 	
//		 		  		  if (statCnt >= 0) { 
//		 		  			TODO 확인후 상황에 맞게 수정 아니면 사용안함 
//		 		  		  }
		 		  			// 위 금액을 빼는 부분 처리를 위해 추가 된 부분 2018.03.02추가 
		 		  			statCnt = 0;
		 		  			// 
		 		  			Yeta3300SubtTaxWkerAmntPkgProc yeta2300SubtTaxWkerAmnt  =  new Yeta3300SubtTaxWkerAmntPkgProc();
		 		  			bmResult.addAll(yeta2300SubtTaxWkerAmnt.execSubtTaxWkerAmntPkgProc( request, infcPkgYe161010Vo));
		 	 		  
		 	 		        if (bmResult.size() >= 0) {     
		 	 	 		       /**#######################  공제계  합산 부분 구하는 부분 ############################################*/
//		 	 	 		  			statCnt = 0;
//		 	 	 	 		 		statCnt = infcPkgYeta3300.fnPayr06430_PAYR425_ReTax_2016_CREATE_12_Update(infcPkgYe169010Vo);
//		 	 	 		 		   if (statCnt >= 0) {
...
//		 	 	 		 		   }
		 	 	 		       ...
		 	 	 		       /**#######################  차감소득금액 ############################################*/ 
		 	 	 		 		statCnt = 0;
		 	 	 		 		statCnt =  infcPkgYeta3300.fnYeta3300_YE169010_Tax_2018_50_Update(infcPkgYe169010Vo); 
		 	 	 		       		if (statCnt >= 0) {
		 	 	 		 		       /**#######################  그밖의 소득공제 계 ############################################*/ 
		 	 	 		 		 		statCnt = 0;  
		 	 	 		 		 		statCnt = infcPkgYeta3300.fnYeta3300_YE169010_Tax_2018_50_01_Update(infcPkgYe169010Vo);		 	 	 		 	 		 		
//		 	 	 		 		 		if (statCnt >= 0) { 
//		 	 	 		 		 			 합계통합 삭제 
//		 	 	 		 		 		}
		 	 	 		 		  	 //   statCnt = 0;
		 	 	 		       	    	Yeta3300SubtTaxStdDdcPkgProc yeta2300SubtTaxStdDdc  = new Yeta3300SubtTaxStdDdcPkgProc();
		 	 	 				  		 ...
		 	 	 				  		 /**####################### 표준세액공제에 대한 값 처리 ############################################*/
		 	 	 		 		  	  if (bmResult.size() >= 0) {		 	 	 		 		  		  
		 	 	 		 		    	InfcPkgYe169010Srh_2018_VO   infcPkgYe169010SrhVo = new InfcPkgYe169010Srh_2018_VO();	
		 	 	 		 		  		InfcPkgYe169010_2018_VO   tpInfcPkgYe169010Vo = new InfcPkgYe169010_2018_VO();	//C_주현근무처 
		 	 							...
		 	 							BeanUtils.copyProperties(infcPkgYe169010AVo, infcPkgYe161010Vo); 
		 	 			  			    ...
		 	 			  			    statCnt =  infcPkgYeta3300.fnYeta3300_YE161020_Tax_2018_C152_STD_TX_DDC_YN_Update(infcPkgYe161020Vo); 
		 	 	 		 	            
	 	 	 		 	                 tpInfcPkgYe169010Vo = infcPkgYeta3300.fnYeta3300_YE169010_Tax_2018_51_Select(infcPkgYe169010SrhVo);
	 	 	 		 	                      ...
	 	 	 		 	                      if ((!"2".equals(tpInfcPkgYe169010Vo.getRsdtClCd())) && "Y".equals(tpInfcPkgYe169010Vo.getYetaC152Check())) { 
	 	 	 		 						                	 ...
	 	 	 		 						                	 if (rtnAlryPinx01.compareTo(rtnAlryPinx02) <  0) {
	 	 	 		 						                		  ...
	 	 	 		 						                		  */
	 	 	 		 						                		   //avo 테이블에 복제 작업 함.  
	 	 	 		 						                		 dataCheck = "";
	 	 	 		 						                	     infcPkgYeta3300.fnYeta3300_YE169010a_Tax_2018_52_Delete(infcPkgYe169010Vo);
	 	 	 		 						                	     dataCheck =  infcPkgYeta3300.fnYeta3300_YE169010a_Tax_2018_52_Insert(infcPkgYe169010Vo); 
...
//	 	 	 		 						                	        infcPkgYe169010AVo.setSpciSsum(BigDecimal.ZERO);    /** column 특별공제_이월기부금공제액계 : spciSsum */
	 	 	 		 						                	     ...
	 	 	 		 						                	     //   infcPkgYe169010AVo.setSpciSpec(BigDecimal.ZERO); 
	 	 	 		 						                	         ...
	 	 	 		 						                	         statCnt = 0;
	 	 	 		 						                		  	 statCnt =  infcPkgYeta3300.fnYeta3300_YE169010a_Tax_2018_52_Update(infcPkgYe169010AVo); 
...
//		 	 	 		 													
//		 	 	 		 						                		  	 statCnt = 0;
//	 	 	 		 						                		  	     statCnt =  infcPkgYeta3300.yeta2000_ReTax_2016_DCSN_INCM_Update(dscnPrc2000Vo); 
//	 	 	 		 						                		  	 
//	 	 	 		 						                	       }
	 	 	 		 						                		     if (statCnt >= 0) {
	 	 	 		 						                			    
//	 	 	 		 						                	                 statCnt = 0;
//	 	 	 		 						                	 		  		 statCnt =  infcPkgYeta3300.fnPayr06430_PAYR415_ReTax_2016_CREATE_12_1_Update(infcPkgYe161010Vo); 
//	 	 	 		 						                	                  //합계구하는 부분인데 사용안함 
//	 	 	 		 						                	 		  		if (statCnt >= 0) {      
	 	 	 		 									                			  // {retax-45} 
	 	 	 		 									                		       /**#######################  공제계  합산 부분 구하는 부분 ############################################*/
//	 	 	 		 									                		  			statCnt = 0;
//	 	 	 		 									                	 		 		statCnt = infcPkgYeta3300.fnPayr06430_PAYR425_ReTax_2016_CREATE_12_Update(infcPkgYe161010Vo);
...
//		 	 	 		 									                		 		if (statCnt >= 0) {
	 	 	 		 									                		      ...
	 	 	 		 									                		      //  -----------------'차감소득금액     ----------------------------------
	 	 	 		 									                		 		...
	 	 	 		 									                		 		statCnt = 0;
	 	 	 		 									                		 		 statCnt =  infcPkgYeta3300.fnYeta3300_YE169010a_Tax_2018_50_Update(infcPkgYe169010AVo); 
	 	 	 		 									                		 		 ...
	 	 	 		 									                		 		 *****************************************************************************************/
	 	 	 		 													           	 		 	  if (statCnt >= 0) {
	 	 	 		 													           	 		          ...
	 	 	 		 													           	 		          Yeta3300SubtTaxEtcIncDdcPkgProc subtTaxEtcIncDdc  = new Yeta3300SubtTaxEtcIncDdcPkgProc();
	 	 	 		 	 	 		 						                			          ...
	 	 	 		 	 	 		 						                			          if (bmResult.size() >= 0) { 
	 	 	 		 													           	 		 	 ...
	 	 	 		 													           	 		 	 //  {retax-47}
	 	 	 		 													                		       /**#######################  그밖의 소득공제 계 ############################################*/
	 	 	 		 													                		 		...
	 	 	 		 													                		 		statCnt = 0;
	 	 	 		 													                		 		statCnt = infcPkgYeta3300.fnYeta3300_YE169010a_Tax_2018_50_01_Update(infcPkgYe169010AVo);
	 	 	 		 													                		 		 
	 	 	 		 															               		       if (statCnt >= 0) {
	 	 	 		 															               		  	  
	 	 	 		 															               		  	       //YetaTaxCreateUpdate InfcPkgYe169010aVO
				 	 	 		 															               		 Yeta3300SubtTaxStdDdcPkgProc subtTaxStdDdc  = new Yeta3300SubtTaxStdDdcPkgProc();
				 	 	 		 			  		...
				 	 	 		 			  		if ("TRUE".equals(spciDdctCheck) ) {
					 	 	 		 			  		...
					 	 	 		 			  		statCnt =   infcPkgYeta3300.fnYeta3300_YE169010a_Tax_2018_51_Update(infcPkgYe169010AVo); 
					 	 	 		 			  		spciDdctCheck = "FALSE";
				 	 	 		 			  		} else {

					 	 	 		 			  		statCnt =   infcPkgYeta3300.fnYeta3300_YE169010_Tax_2018_51_Update(infcPkgYe169010Vo); 
					 	 	 		 			  		spciDdctCheck = "FALSE";  
				 	 	 		 			  		}
...
//				 	 	 		 			  		  statCnt =  infcPkgYeta3300.fnPayr06430_PAYR425_ReTax_2016_CREATE_19_Update(infcPkgYe169010Vo);
				 	 	 		 			  		
				 	 	 		 			  	 /**#######################   YE169010 YE169010A 복제 루틴 ############################################*/ 
				 	 	 		 			  		 
					 	 							
					 	 					 		InfcPkgYe169010Srh_2018_VO   ye169010SrhVo = new InfcPkgYe169010Srh_2018_VO();	 
					 	 							BeanUtils.copyProperties(ye169010SrhVo, infcPkgYe161010Vo); 
					 	 							
				 	 	 		 			  		 List lstPkgYe169010Vo =  infcPkgYeta3300.fnYeta3300_YE169010_Tax_2018_A01_Select(ye169010SrhVo);
						 	 	 		 			     ...
						 	 	 		 			     for (int iCnt02 = 0;iCnt02 < lstPkgYe169010Vo.size();iCnt02++) {
						 	 	 		 			      ...
						 	 	 		 			      //	InfcPkgYe169010VO   tpInfcPkgYe169010Vo = new InfcPkgYe169010VO();	//C_주현근무처 
								 	 	 		 			  	InfcPkgYe161060_2018_VO    inputYe161060Vo	 = new InfcPkgYe161060_2018_VO();	//C_특별소득공제
								 	 							InfcPkgYe161070_2018_VO    inputYe161070Vo	 = new InfcPkgYe161070_2018_VO();	//C_그밖의소득공제
								 	 							InfcPkgYe161080_2018_VO    inputYe161080Vo	 = new InfcPkgYe161080_2018_VO();	//C_세액감면및공제
								 	 							BeanUtils.copyProperties(inputYe161060Vo, infcPkgYe161010Vo);
								 	 							BeanUtils.copyProperties(inputYe161070Vo, infcPkgYe161010Vo);
								 	 							BeanUtils.copyProperties(inputYe161080Vo, infcPkgYe161010Vo); 
...
//																inputYe161060Vo.setInfeeDdcAmtSum(tempMap.get("infeeDdcAmtSum"));    /** column 건강고용_보험료공제액합계 : infeeDdcAmtSum */
															...
															//	inputYe161060Vo.setConbUseAmtSum(new BigDecimal(MSFSharedUtils.defaultNulls(tempMap.get("conbUseAmtSum"),"0")));    /** column 기부금이월분_지정기부금납입분합계 : conbUseAmtSum */
																inputYe161060Vo.setConbDdcAmtSum(new BigDecimal(MSFSharedUtils.defaultNulls(tempMap.get("yeta0c94"),"0")));    /** column 기부금이월분_지정기부금공제합계 : conbDdcAmtSum */
																 ...
																 infcPkgYeta3300.fnYeta3300_Ye161060_Tax_2018_I1_Update(inputYe161060Vo); 
																...
																inputYe161070Vo.setLtrmCniSsDdcAmt(new BigDecimal(MSFSharedUtils.defaultNulls(tempMap.get("yetaC109"),"0")));    /** column 장기집합투자증권저축공제금액 : ltrmCniSsDdcAmt */ 
																 ...
																 infcPkgYeta3300.fnYeta3300_Ye161070_Tax_2018_I2_Update(inputYe161070Vo); 
																...
																//inputYe161080Vo.setTxlgTxtyAmnt(new BigDecimal(MSFSharedUtils.defaultNulls(tempMap.get("txlgTxtyAmnt"),"0")));    /** column 세액감면_조세조약감면세액 : txlgTxtyAmnt */
																   ...
																   infcPkgYeta3300.fnYeta3300_Ye161080_Tax_2018_I3_Update(inputYe161080Vo);
																 
																 //연금저축등소득세액공제 정리 
																 
																InfcPkgYe162010Srh_2018_VO   ye162010SrhVo = new InfcPkgYe162010Srh_2018_VO();	 
									 	 						BeanUtils.copyProperties(ye162010SrhVo, infcPkgYe161010Vo); 
									 	 							
								 	 	 		 			  		 List lstPkgYe162010Vo =  infcPkgYeta3300.fnYeta3300_YE162010_Tax_2018_A01_Select(ye162010SrhVo);
								 	 	 		 			  	   ...
								 	 	 		 			  	   //  bgTotPNSN_SVNG_ACC_PYM_AMT =bgYeta0c98;
										 	 	 		 			     ...
										 	 	 		 			     for (int iCnt03 = 0;iCnt03 < lstPkgYe162010Vo.size();iCnt03++) {
										 	 	 		 			    	 ...
										 	 	 		 			    	 if ("Y0040030".equals(MSFSharedUtils.allowNulls(tempMap01.get("pnsnSvngAccPnsnSvngCl")))) {
										 	 	 		 			    	    ...
										 	 	 		 			    	    infcPkgYeta3300.updateYeta3300_Tax_Ye162010_01(infcPkgYe162010Vo);     
										 	 	 		 			      ...
										 	 	 		 			      InfcPkgYe162010_2018_VO    infcPkgYe162010Vo	 = new InfcPkgYe162010_2018_VO();	//F_연금저축계좌
								 	 	 		 			    	      BeanUtils.copyProperties(infcPkgYe162010Vo, infcPkgYe161010Vo);
										 	 	 		 			      infcPkgYeta3300.updateYeta3300_Tax_Ye162010_02(infcPkgYe162010Vo); 	   
										 	 	 		 			   
										 	 	 		 			
									 	 	 		 			      InfcPkgYe162020Srh_2018_VO   ye162020SrhVo = new InfcPkgYe162020Srh_2018_VO();	 
									 	 							  BeanUtils.copyProperties(ye162020SrhVo, infcPkgYe161010Vo); 
									 	 							
								 	 	 		 			  		   List lstPkgYe162020Vo =  infcPkgYeta3300.fnYeta3300_YE162020_Tax_2018_A01_Select(ye162020SrhVo);
								 	 	 		 			       ...
								 	 	 		 			       BigDecimal bgYetaC129 = new BigDecimal(MSFSharedUtils.defaultNulls(tempMap.get("yetaC129"),"0"));
									 	 	 		 			    	 ...
									 	 	 		 			    	 if ("Y0040010".equals(MSFSharedUtils.allowNulls(tempMap01.get("rtpnAccRtpnCl")))) {
									 	 	 		 			    	    ...
									 	 	 		 			    	    infcPkgYeta3300.updateYeta3300_Tax_Ye162020_01(infcPkgYe162020Vo);     
								 	 	 		 			    	     ...
								 	 	 		 			    	     infcPkgYeta3300.updateYeta3300_Tax_Ye162020_02(infcPkgYe162020Vo);      
											 	 	 		 			     
								 	 	 		 			     InfcPkgYe162030Srh_2018_VO   ye162030SrhVo = new InfcPkgYe162030Srh_2018_VO();	 
								 	 							 BeanUtils.copyProperties(ye162030SrhVo, infcPkgYe161010Vo); 
								 	 						 
								 	 					                
							 	 	 		 			  		 List lstPkgYe162030Vo =  infcPkgYeta3300.fnYeta3300_YE162030_Tax_2018_A01_Select(ye162030SrhVo);
									 	 	 		 			 ...
									 	 	 		 			 for (int iCnt03 = 0;iCnt03 < lstPkgYe162030Vo.size();iCnt03++) {
								 	 	 		 			    	 ...
								 	 	 		 			    	 if ("Y0040050".equals(MSFSharedUtils.allowNulls(tempMap01.get("hsngPrptSvngSvngCl")))) {
								 	 	 		 			    	    ...
								 	 	 		 			    	    infcPkgYeta3300.updateYeta3300_Tax_YE162030_01(infcPkgYe162030Vo) ;  
									 	 	 		 			    	
									 	 	 		 			     }	 
									 	 	 		 			     
									 	 	 		 			    InfcPkgYe162040Srh_2018_VO   ye162040SrhVo = new InfcPkgYe162040Srh_2018_VO();	 
									 	 							BeanUtils.copyProperties(ye162040SrhVo, infcPkgYe161010Vo); 
									 	 							
								 	 	 		 			  		 List lstPkgYe162040Vo =  infcPkgYeta3300.fnYeta3300_YE162040_Tax_2018_A01_Select(ye162040SrhVo);
								 	 	 		 			     	 BigDecimal bgYetaC109 = new BigDecimal(MSFSharedUtils.defaultNulls(tempMap.get("yetaC109"),"0"));
									 	 	 		 			    	 ...
									 	 	 		 			    	 if ("Y0040110".equals(MSFSharedUtils.allowNulls(tempMap01.get("ltrmCniSsfnnCl")))) {
									 	 	 		 			      	...
									 	 	 		 			      	infcPkgYeta3300.updateYeta3300_Tax_YE162040_01(infcPkgYe162040Vo) ;      
												 	 	 		 			  
										 	 	 		 			     }	 
																      //월세액거주자간 주책임차차임금 원리금상환 
																	
																	
																	   InfcPkgYe162510Srh_2018_VO   ye162510SrhVo = new InfcPkgYe162510Srh_2018_VO();	 
										 	 							BeanUtils.copyProperties(ye162510SrhVo, infcPkgYe161010Vo); 
										 	 							
																	  List lstPkgYe162510Vo =  infcPkgYeta3300.fnYeta3300_YE162510_Tax_2018_A01_Select(ye162510SrhVo);
								 	 	 		 			     	 BigDecimal bgYetaC156 = new BigDecimal(MSFSharedUtils.defaultNulls(tempMap.get("yetaC156"),"0"));
																		 	...
																		 	BeanUtils.copyProperties(infcPkgYe162510Vo, infcPkgYe161010Vo);
									 	 	 		 			    	    ...
									 	 	 		 			    	    infcPkgYeta3300.updateYeta3300_Tax_Ye162510_01(infcPkgYe162510Vo) ; 
										 	 	 		 			    ...
										 	 	 		 			    InfcPkgYe162510_2018_VO    infcPkgYe162510Vo	 = new InfcPkgYe162510_2018_VO();	//G_월세액소득공제명세
																	 	BeanUtils.copyProperties(infcPkgYe162510Vo, infcPkgYe161010Vo);  
									 	 	 		 			         infcPkgYeta3300.updateYeta3300_Tax_Ye162510_02(infcPkgYe162510Vo) ;      
																	   
										 	 	 		 			    
										 	 	 		 			     InfcPkgYe162520Srh_2018_VO   ye162520SrhVo = new InfcPkgYe162520Srh_2018_VO();	 
										 	 							 BeanUtils.copyProperties(ye162520SrhVo, infcPkgYe161010Vo); 
																		 
																		 List lstPkgYe162520Vo =  infcPkgYeta3300.fnYeta3300_YE162520_Tax_2018_A01_Select(ye162520SrhVo);
									 	 	 		 			     	 Long bgYeta0c84 = Long.parseLong(MSFSharedUtils.defaultNulls(tempMap.get("yeta0c84"),"0"));
										 	 	 		 			    	...
										 	 	 		 			    	infcPkgYeta3300.updateYeta3300_Tax_Ye162520_01(infcPkgYe162520Vo);    
