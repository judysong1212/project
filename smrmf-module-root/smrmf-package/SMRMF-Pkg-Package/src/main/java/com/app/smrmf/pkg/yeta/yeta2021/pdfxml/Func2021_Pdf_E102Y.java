...
public class Func2021_Pdf_E102Y {
	...
	public static void func_2021_E102Y_E102M(InfcPkgYe161010_2021_VO ye161010VO, Element  subXmlElForm, String nResult , HttpServletRequest request ) throws Exception{
		...
		InfcPkgPdfE102y_2021_VO yetaPdfE102yVo = new InfcPkgPdfE102y_2021_VO();
		InfcPkgPdfE102m_2021_VO yetaPdfE102mVo = new InfcPkgPdfE102m_2021_VO();
		...
		for (int j = 0; j < subXmlElChildForm.getLength();j++) { 
			...
			for(int k = 0; k < subXmlElChildMan.getLength();k++) {  
				...
				if (strDatCd.equals("G0010")) {
					...
					yetaPayr3200Service.yeta6200_PDF_E102Y_2021_Delete(yetaPdfE102yVo);
					yetaPayr3200Service.yeta6200_PDF_E102Y_2021_Insert(yetaPdfE102yVo);
				}
	...
	public static void func_2021_E102Y_YetaCalc(InfcPkgYe161010_2021_VO ye161010VO, HttpServletRequest request) throws Exception{ 
		...
		//연금저축 
		yetaPayr3200Service.PdfYeta6200_E102Y_YE162010_Delete(infcPkgYe162010Vo); 
		yetaPayr3200Service.PdfYeta6200_E102Y_YE162010_Insert(infcPkgYe162010Vo); 
		...
		//연금저축 합계
         yetaPayr3200Service.fnYeta6200_E102Y_YE161080_2021_Update(infcPkgYe161080Vo); 
