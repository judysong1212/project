...
public class Func2019_Pdf_C401Y {
	...
	public static void func_2019_C401Y_C401M(InfcPkgYe161010_2019_VO ye161010VO, Element  subXmlElForm, String nResult , HttpServletRequest request ) throws Exception{
		//학자금대출 
		...
		InfcPkgPdfC401y_2019_VO yetaPdfC401yVo = new InfcPkgPdfC401y_2019_VO();
		InfcPkgPdfC401m_2019_VO yetaPdfC401mVo = new InfcPkgPdfC401m_2019_VO();
		...
		yetaPayr3200Service.yeta4200_PDF_C401Y_2019_Delete(yetaPdfC401yVo);
		...
		for (int j = 0; j < subXmlElChildForm.getLength();j++) { 
			...
			for(int k = 0; k < subXmlElChildMan.getLength();k++) {  
				...
				if (strDatCd.equals("G0033")) {
					...
					yetaPayr3200Service.yeta4200_PDF_C401Y_2019_Insert(yetaPdfC401yVo);
				}
	...
	public static void func_2019_C401Y_YetaCalc(InfcPkgYe161010_2019_VO ye161010VO, HttpServletRequest request) throws Exception{ 
		...
		//교육비 
		yetaPayr3200Service.PdfYeta4200_C401Y_YE161090_Delete(infcPkgYe161090Vo); 
		yetaPayr3200Service.PdfYeta4200_C401Y_YE161090_Insert(infcPkgYe161090Vo); 
