...
public class Func2023_Pdf_DDC_C101Y {
	...
	public static void func_2023_C101Y(InfcPkgYe161010_2023_VO ye161010Vo, Element  xmlelDoc, Element  subXmlElForm, String nResult, HttpServletRequest request) throws Exception{ 
		...
		InfcPkgYe167210_2023_VO ye167210Vo = new InfcPkgYe167210_2023_VO();
		InfcPkgYe167220_2023_VO ye167220Vo = new InfcPkgYe167220_2023_VO();
		InfcPkgYe167230_2023_VO ye167230Vo = new InfcPkgYe167230_2023_VO();
		InfcPkgYe167240_2023_VO ye167240Vo = new InfcPkgYe167240_2023_VO();
		...
		for (int j = 0; j < subXmlElChildForm.getLength();j++) { 
			...
			yetaPayr3200Service.yeta8200_PDF_YE167210_2023_Delete(ye167210Vo);	//기본정보 삭제
			...
			yetaPayr3200Service.yeta8200_PDF_YE167220_2023_Delete(ye167220Vo);	//인적공제 삭제	
			...
			yetaPayr3200Service.yeta8200_PDF_YE167230_2023_Delete(ye167230Vo);	//인적공제 삭제	
			...
			yetaPayr3200Service.yeta8200_PDF_YE167240_2023_Delete(ye167240Vo);	//연금 보험 삭제
			...
			yetaPayr3200Service.yeta8200_PDF_YE167210_2023_Insert(ye167210Vo);	//기본정보 입력
	...
	public static void setYe167220Vo(InfcPkgYe167220_2023_VO ye167220Vo , HttpServletRequest request) throws Exception{
		...
		yetaPayr3200Service.yeta8200_PDF_YE167220_2023_Insert(ye167220Vo);	//기본정보 입력
	}
	
	public static void setYe167230Vo(InfcPkgYe167230_2023_VO ye167230Vo , HttpServletRequest request) throws Exception{
		...
		yetaPayr3200Service.yeta8200_PDF_YE167230_2023_Insert(ye167230Vo);	//기본정보 입력
	}
	
	public static void setYe167240Vo(InfcPkgYe167240_2023_VO ye167240Vo , HttpServletRequest request) throws Exception{
		...
		yetaPayr3200Service.yeta8200_PDF_YE167240_2023_Insert(ye167240Vo);	//기본정보 입력
	}
