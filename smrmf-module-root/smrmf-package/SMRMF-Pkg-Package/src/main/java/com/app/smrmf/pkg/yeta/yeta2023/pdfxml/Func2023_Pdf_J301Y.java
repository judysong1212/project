...
public class Func2023_Pdf_J301Y {
	...
	public static void func_2023_J301Y_J301M(InfcPkgYe161010_2023_VO ye161010VO, Element  subXmlElForm, String nResult, HttpServletRequest request ) throws Exception{
		...
		InfcPkgPdfJ301y_2023_VO yetaPdfJ301yVo = new InfcPkgPdfJ301y_2023_VO();
		InfcPkgPdfJ301m_2023_VO yetaPdfJ301mVo = new InfcPkgPdfJ301m_2023_VO();
		...
		for (int j = 0; j < subXmlElChildForm.getLength();j++) { 
			...
			for(int k = 0; k < subXmlElChildMan.getLength();k++) {  
				...
				if (strDatCd.equals("G0018")) {
					...
					yetaPayr3200Service.yeta8200_PDF_J301Y_2023_Delete(yetaPdfJ301yVo);
					yetaPayr3200Service.yeta8200_PDF_J301Y_2023_Insert(yetaPdfJ301yVo);
				}
	...
	public static void func_2023_J301Y_YetaCalc(InfcPkgYe161010_2023_VO ye161010VO, HttpServletRequest request) throws Exception{ 
		...
		InfcPkgYe162030_2023_VO infcPkgYe162030Vo = new InfcPkgYe162030_2023_VO();
		...
		//주택마련
		yetaPayr3200Service.PdfYeta8200_J301Y_YE162030_Delete(infcPkgYe162030Vo); 
		yetaPayr3200Service.PdfYeta8200_J301Y_YE162030_Insert(infcPkgYe162030Vo); 
		...
		// 주택마련 합계  
         yetaPayr3200Service.fnYeta8200_J301Y_YE161070_2023_Update(infcPkgYe161070Vo); 
