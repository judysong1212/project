 ...
 */
@Controller 
public class Yeta7300SubtTaxEtcIncDdcPkgProc  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta7300SubtTaxEtcIncDdcPkgProc.class);
	   
    @Resource(name = "Yeta7300PayrService")
    protected Yeta7300PayrService  infcPkgYeta7300;
    
 
    public Yeta7300SubtTaxEtcIncDdcPkgProc() {
    	
    } 
    
    public  List<ShowMessageBM> execSubtTaxEtcIncDdcPkgProc(HttpServletRequest request,InfcPkgYe161010_2022_VO  ye161010VO)  throws Exception  {
    ...
    * @throws Exception
    */
    private   List<ShowMessageBM> YetaSubtCreateUpdate(HttpServletRequest request,InfcPkgYe161010_2022_VO  infcPkgYe161010Vo) throws Exception {
     ...
     * @throws Exception
     */
    private   List<ShowMessageBM> YetaSubtStdTaxUpdate(HttpServletRequest request,InfcPkgYe161010_2022_VO  infcPkgYe161010Vo) throws Exception {
  	  ...
  	  infcPkgYeta7300 = (Yeta7300PayrService)BeanFinder.getBean("Yeta7300PayrService"); 
     	...
     	infcPkgYe161010Vo.setRevnAddr(RemoteServiceUtil.getThreadLocalRequest().getRemoteHost());    			/** column 수정주소 : revnAddr */
  	      ...
  	      *******************************************************************************************/  
  		      InfcPkgYe169010a_2022_VO subInfcPkgYe169010aVo = new InfcPkgYe169010a_2022_VO();  //연말정산결과  
  		      InfcPkgYe169010a_2022_VO tpSubInfcPkgYe169010aVo = new InfcPkgYe169010a_2022_VO();  //연말정산결과  
  		    ...
  		    subInfcPkgYe169010aVo.setDpobCd(infcPkgYe161010Vo.getDpobCd());    /** column 사업장코드 : dpobCd */
  		      ...
  		      tpSubInfcPkgYe169010aVo = infcPkgYeta7300.fnYeta7300_YE169010a_Tax_2022_2001_Select(subInfcPkgYe169010aVo); 
		        ...
		        else
		        {
  		        ...
  		        statCnt = 0;
  			  	statCnt =  infcPkgYeta7300.fnYeta7300_YE169010a_Tax_2022_2002_Update(subInfcPkgYe169010aVo); 
     ...
     * @throws Exception
     */
    private   List<ShowMessageBM> YetaSubtBaseTaxUpdate(HttpServletRequest request,InfcPkgYe161010_2022_VO  infcPkgYe161010Vo) throws Exception {
  	  ...
  	  infcPkgYeta7300 = (Yeta7300PayrService)BeanFinder.getBean("Yeta7300PayrService"); 
     	...
     	infcPkgYe161010Vo.setRevnAddr(RemoteServiceUtil.getThreadLocalRequest().getRemoteHost());    			/** column 수정주소 : revnAddr */
  	      ...
  	      *******************************************************************************************/  
  		      InfcPkgYe169010_2022_VO subInfcPkgYe169010Vo = new InfcPkgYe169010_2022_VO();  //연말정산결과  
  		      InfcPkgYe169010_2022_VO tpSubInfcPkgYe169010Vo = new InfcPkgYe169010_2022_VO();  //연말정산결과  
  		      ...
  		      tpSubInfcPkgYe169010Vo = infcPkgYeta7300.fnYeta7300_YE169010_Tax_2022_2001_Select(subInfcPkgYe169010Vo); 
		        ...
		        else
		        {
  		        ...
  		        statCnt = 0;
  			  	statCnt =  infcPkgYeta7300.fnYeta7300_YE169010_Tax_2022_2002_Update(subInfcPkgYe169010Vo); 
