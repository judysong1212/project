...
@Repository("InfcPkgYeta3110DAO")
public class InfcPkgYeta3110DAO extends EgovAbstractDAO {
    ...
    public String insertYeta3110(InfcPkgYeta3110VO vo) throws Exception {
        return (String)insert("infcPkgYeta3110DAO.insertYetaPrc3110_S", vo);
    }
    ...
    public void updateYeta3110(InfcPkgYeta3110VO vo) throws Exception {
        update("infcPkgYeta3110DAO.updateYetaPrc3110_S", vo);
    }
    ...
    public void deleteYeta3110(InfcPkgYeta3110VO vo) throws Exception {
        delete("infcPkgYeta3110DAO.deleteYetaPrc3110_S", vo);
    }
    ...
    public void fnPayr06430_PAYR435_CREATE_Delete(InfcPkgYeta3110VO vo) throws Exception {
        delete("infcPkgYeta3110DAO.fnPayr06430_PAYR435_CREATE_Delete_S", vo);
    }  
    ...
    public List<?> selectYeta3110List(InfcPkgYeta3110SrhVO searchVO) throws Exception {
        return list("infcPkgYeta3110DAO.selectYetaPrc3110List_D", searchVO);
    }
    ...
    public int selectYeta3110ListTotCnt(InfcPkgYeta3110SrhVO searchVO) {
        return (Integer)getSqlMapClientTemplate().queryForObject("infcPkgYeta3110DAO.selectYetaPrc3110ListTotCnt_S", searchVO);
    }
