...
import com.app.smrmf.infc.yearendtax.server.vo.yeta2022.InfcPkgPdfB201m_2022_VO;
...
public class Func2022_Pdf_B201Y {
	...
	private static final Logger logger = LoggerFactory.getLogger(Func2022_Pdf_B201Y.class);


	public static void func_2022_B201Y_B201M(InfcPkgYe161010_2022_VO ye161010VO, Element  subXmlElForm, String nResult, HttpServletRequest request) throws Exception{
		...
		InfcPkgPdfB201y_2022_VO yetaPdfB201yVo = new InfcPkgPdfB201y_2022_VO();
		InfcPkgPdfB201m_2022_VO yetaPdfB201mVo = new InfcPkgPdfB201m_2022_VO();
		...
		yetaPayr3200Service.yeta7200_PDF_B201Y_2022_Delete(yetaPdfB201yVo);
		...
		for (int j= 0;j < subXmlElChildForm.getLength();j++)  {
			...
			for(int k = 0; k < subXmlElChildMan.getLength();k++) {  
				...
				if (strDatCd.equals("G0040")) { //실손의료보험금
					...
					yetaPayr3200Service.yeta7200_PDF_B201Y_2022_Insert(yetaPdfB201yVo);
				} 
	 ...
	 * </pre>
	 * @Method Name : func_2022_B201Y_YetaCalc
	 * @date : 2022. 1. 23.
	 * @author : atres
	 * @history : 
	 *	-----------------------------------------------------------------------
	 ...
	 * @throws Exception
	 */
	public static void func_2022_B201Y_YetaCalc(InfcPkgYe161010_2022_VO ye161010VO, HttpServletRequest request) throws Exception{ 
        ...
        //실손보험금시작
        //실손보험금
		InfcPkgYe166030_2022_VO infcPkgYe166030Vo = new InfcPkgYe166030_2022_VO();
		...
		//실손의료보험 국세청 데이타 업데이트 
		yetaPayr3200Service.PdfYeta7200_B201Y_YE166030_Delete(infcPkgYe166030Vo); 
		
		yetaPayr3200Service.PdfYeta7200_B201Y_YE166030_Insert(infcPkgYe166030Vo); 
		...
		statCnt = yetaPayr3200Service.PdfYeta2022_B201Y_YE161040_Update(infcPkgYe161040Vo); 
		...
		if (statCnt >= 0) { 
			...
			// 실손보험금정리 합계  
	         yetaPayr3200Service.fnYeta7200_B201Y_YE161080_2022_Update(infcPkgYe161080Vo); 
