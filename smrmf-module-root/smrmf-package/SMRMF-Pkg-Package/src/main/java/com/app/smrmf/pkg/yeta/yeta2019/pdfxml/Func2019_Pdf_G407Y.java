...
public class Func2019_Pdf_G407Y {
	...
	public static void func_2019_G407Y_G407M(InfcPkgYe161010_2019_VO ye161010VO, Element  subXmlElForm, String nResult, HttpServletRequest request ) throws Exception{
		...
		InfcPkgPdfG407y_2019_VO yetaPdfG407yVo = new InfcPkgPdfG407y_2019_VO();
		InfcPkgPdfG407m_2019_VO yetaPdfG407mVo = new InfcPkgPdfG407m_2019_VO();
		...
		yetaPayr3200Service.yeta4200_PDF_G407Y_2019_Delete(yetaPdfG407yVo);
		...
		yetaPayr3200Service.yeta4200_PDF_G407M_2019_Delete(yetaPdfG407mVo);
	...
	public static void setPdfG407yVo(InfcPkgPdfG407y_2019_VO yetaPdfG407yVo , HttpServletRequest request, Element subXmlElData) throws Exception{
		...
		yetaPayr3200Service.yeta4200_PDF_G407Y_2019_Insert(yetaPdfG407yVo);

	}
	
	public static void setPdfG407mVo(InfcPkgPdfG407m_2019_VO yetaPdfG407mVo , HttpServletRequest request, Element subXmlElData) throws Exception{
		...
		yetaPdfG407mVo.setZeroMmAmt(new BigDecimal(MSFSharedUtils.defaultNulls(PkgFuncUtils.getXmlTagValue("amt", subXmlElData),"0")));
		
		yetaPayr3200Service.yeta4200_PDF_G407M_2019_Insert(yetaPdfG407mVo);

	}
	

	public static void func_2019_G407Y_YetaCalc(InfcPkgYe161010_2019_VO ye161010VO, HttpServletRequest request) throws Exception{ 
		...
		dataChk = yetaPayr3200Service.PdfYeta2019_G407Y_YE161040_Update(infcPkgYe161040Vo); 
		...
		if (dataChk >= 0) { 
			...
			// 신용카드  
	         yetaPayr3200Service.fnYeta4200_G407Y_YE161070_2019_Update(infcPkgYe161070Vo); 
