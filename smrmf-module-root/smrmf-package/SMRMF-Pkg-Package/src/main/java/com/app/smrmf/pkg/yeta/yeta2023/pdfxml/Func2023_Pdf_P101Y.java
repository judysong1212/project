...
public class Func2023_Pdf_P101Y {

	@Resource(name = "Yeta8200XmlService")
	private static Yeta8200XmlService yetaPayr4200Service;
	...
	public static void func_2023_P101Y_P101M(InfcPkgYe161010_2023_VO ye161010VO, Element  subXmlElForm, String nResult, HttpServletRequest request ) throws Exception{
		...
		if  (yetaPayr4200Service == null) { 
			...
			yetaPayr4200Service = (Yeta8200XmlService) wac.getBean("Yeta8200XmlService" ); 
		}
		strDatCd = "";

		InfcPkgPdfP101y_2023_VO yetaPdfP101yVo = new InfcPkgPdfP101y_2023_VO();
		InfcPkgPdfP101m_2023_VO yetaPdfP101mVo = new InfcPkgPdfP101m_2023_VO();
		...
		yetaPayr4200Service.yeta8200_PDF_YE162015_2023_Delete(yetaPdfYE162015Vo);
			...
			for(int k = 0; k < subXmlElChildMan.getLength();k++) {  
				...
				if (strDatCd.equals("G0041")) {
					...
					for(int i = 0; i < subXmlElChildSum.getLength(); i++) {  
						...
						yetaPayr4200Service.yeta8200_PDF_P101Y_2023_Delete(yetaPdfP101yVo);
						yetaPayr4200Service.yeta8200_PDF_P101Y_2023_Insert(yetaPdfP101yVo);
					}
		...
		yetaPayr4200Service.yeta8200_PDF_YE162015_2023_Insert(yetaPdfYE162015Vo);
	}
	
	public static void setPdfP101mVo(InfcPkgPdfP101m_2023_VO yetaPdfP101mVo , HttpServletRequest request, Element subXmlElData) throws Exception{
		...
		yetaPayr4200Service.yeta8200_PDF_P101M_2023_Delete(yetaPdfP101mVo);
		yetaPayr4200Service.yeta8200_PDF_P101M_2023_Insert(yetaPdfP101mVo);
