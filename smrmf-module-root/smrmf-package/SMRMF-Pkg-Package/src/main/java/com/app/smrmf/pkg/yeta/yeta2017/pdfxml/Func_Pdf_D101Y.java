...
public class Func_Pdf_D101Y {
	...
	public static void func_2017_D101Y_D101M(InfcPkgYe161010VO ye161010VO, Element  subXmlElForm, String nResult, HttpServletRequest request ) throws Exception{
		...
		InfcPkgPdfD101yVO yetaPdfD101yVo = new InfcPkgPdfD101yVO();
		InfcPkgPdfD101mVO yetaPdfD101mVo = new InfcPkgPdfD101mVO();
		...
		for (int j = 0; j < subXmlElChildForm.getLength();j++) { 
			...
			for(int k = 0; k < subXmlElChildMan.getLength();k++) {  
				...
				if (strDatCd.equals("G0009")) {
					...
					yetaPayr2200Service.yeta2200_PDF_D101Y_2017_Delete(yetaPdfD101yVo);
					yetaPayr2200Service.yeta2200_PDF_D101Y_2017_Insert(yetaPdfD101yVo);
				}
			}
	...
	public static void func_2017_D101Y_YetaCalc(InfcPkgYe161010VO ye161010VO, HttpServletRequest request) throws Exception{ 
		...
		//개인연금저축 
		yetaPayr2200Service.PdfYeta2200_D101Y_YE162010_Delete(infcPkgYe162010Vo); 
		yetaPayr2200Service.PdfYeta2200_D101Y_YE162010_Insert(infcPkgYe162010Vo); 
		...
		// 교육비 합계  
         yetaPayr2200Service.fnYeta2200_D101Y_YE161070_2017_Update(infcPkgYe161070Vo); 
