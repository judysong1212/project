...
public class Func_Pdf_G304Y {
	...
	public static void func_2017_G304Y_G304M(InfcPkgYe161010VO ye161010VO, Element  subXmlElForm, String nResult, HttpServletRequest request ) throws Exception{
		...
		InfcPkgPdfG304yVO yetaPdfG304yVo = new InfcPkgPdfG304yVO();
		InfcPkgPdfG304mVO yetaPdfG304mVo = new InfcPkgPdfG304mVO();
		...
		yetaPayr2200Service.yeta2200_PDF_G304Y_2017_Delete(yetaPdfG304yVo);
		...
		yetaPayr2200Service.yeta2200_PDF_G304M_2017_Delete(yetaPdfG304mVo);
	...
	public static void setPdfG304yVo(InfcPkgPdfG304yVO yetaPdfG304yVo , HttpServletRequest request, Element subXmlElData) throws Exception{
		...
		yetaPayr2200Service.yeta2200_PDF_G304Y_2017_Insert(yetaPdfG304yVo);

	}
	
	public static void setPdfG304mVo(InfcPkgPdfG304mVO yetaPdfG304mVo , HttpServletRequest request, Element subXmlElData) throws Exception{
		...
		yetaPayr2200Service.yeta2200_PDF_G304M_2017_Insert(yetaPdfG304mVo);
