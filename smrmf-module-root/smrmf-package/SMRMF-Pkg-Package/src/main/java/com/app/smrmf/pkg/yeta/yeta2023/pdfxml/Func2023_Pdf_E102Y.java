...
public class Func2023_Pdf_E102Y {
	...
	public static void func_2023_E102Y_E102M(InfcPkgYe161010_2023_VO ye161010VO, Element  subXmlElForm, String nResult , HttpServletRequest request ) throws Exception{
		...
		InfcPkgPdfE102y_2023_VO yetaPdfE102yVo = new InfcPkgPdfE102y_2023_VO();
		InfcPkgPdfE102m_2023_VO yetaPdfE102mVo = new InfcPkgPdfE102m_2023_VO();
		...
		for (int j = 0; j < subXmlElChildForm.getLength();j++) { 
			...
			for(int k = 0; k < subXmlElChildMan.getLength();k++) {  
				...
				if (strDatCd.equals("G0010")) {
					...
					yetaPayr3200Service.yeta8200_PDF_E102Y_2023_Delete(yetaPdfE102yVo);
					yetaPayr3200Service.yeta8200_PDF_E102Y_2023_Insert(yetaPdfE102yVo);
				}
	...
	public static void func_2023_E102Y_YetaCalc(InfcPkgYe161010_2023_VO ye161010VO, HttpServletRequest request) throws Exception{ 
		...
		InfcPkgYe162010_2023_VO infcPkgYe162010Vo = new InfcPkgYe162010_2023_VO();
		...
		//연금저축 
		yetaPayr3200Service.PdfYeta8200_E102Y_YE162010_Delete(infcPkgYe162010Vo); 
		yetaPayr3200Service.PdfYeta8200_E102Y_YE162010_Insert(infcPkgYe162010Vo); 
		...
		//연금저축 합계
         yetaPayr3200Service.fnYeta8200_E102Y_YE161080_2023_Update(infcPkgYe161080Vo); 
