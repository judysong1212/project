...
public class Func2023_Pdf_F102Y {
	...
	private static final Logger logger = LoggerFactory.getLogger(Func2023_Pdf_F102Y.class);

	public static void func_2023_F102Y_F102M(InfcPkgYe161010_2023_VO ye161010VO, Element  subXmlElForm, String nResult , HttpServletRequest request ) throws Exception{
		...
		InfcPkgPdfF102y_2023_VO yetaPdfF102yVo = new InfcPkgPdfF102y_2023_VO();
		InfcPkgPdfF102m_2023_VO yetaPdfF102mVo = new InfcPkgPdfF102m_2023_VO();
		...
		for (int j = 0; j < subXmlElChildForm.getLength();j++) { 
			...
			for(int k = 0; k < subXmlElChildMan.getLength();k++) {  
				...
				if (strDatCd.equals("G0011")) {
					...
					yetaPayr3200Service.yeta8200_PDF_F102Y_2023_Delete(yetaPdfF102yVo);
					
					yetaPayr3200Service.yeta8200_PDF_F102Y_2023_Insert(yetaPdfF102yVo);
				}
			}
	...
	public static void func_2023_F102Y_YetaCalc(InfcPkgYe161010_2023_VO ye161010VO, HttpServletRequest request) throws Exception{ 
		...
		InfcPkgYe162020_2023_VO infcPkgYe162020Vo = new InfcPkgYe162020_2023_VO();
		...
		//퇴직연금
		yetaPayr3200Service.PdfYeta8200_F102Y_YE162020_Delete(infcPkgYe162020Vo); 
		yetaPayr3200Service.PdfYeta8200_F102Y_YE162020_Insert(infcPkgYe162020Vo); 
		...
		// 퇴직연금 합계  
         yetaPayr3200Service.fnYeta8200_F102Y_YE161080_2023_Update(infcPkgYe161080Vo); 
