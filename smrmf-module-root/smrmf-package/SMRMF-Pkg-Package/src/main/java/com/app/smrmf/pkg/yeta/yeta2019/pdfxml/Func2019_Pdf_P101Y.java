...
public class Func2019_Pdf_P101Y {

	@Resource(name = "Yeta4200XmlService")
	private static Yeta4200XmlService yetaPayr4200Service;
	...
	public static void func_2019_P101Y_P101M(InfcPkgYe161010_2019_VO ye161010VO, Element  subXmlElForm, String nResult, HttpServletRequest request ) throws Exception{
		...
		if  (yetaPayr4200Service == null) { 
			...
			yetaPayr4200Service = (Yeta4200XmlService) wac.getBean("Yeta4200XmlService" ); 
		}
		strDatCd = "";

		InfcPkgPdfP101y_2019_VO yetaPdfP101yVo = new InfcPkgPdfP101y_2019_VO();
		InfcPkgPdfP101m_2019_VO yetaPdfP101mVo = new InfcPkgPdfP101m_2019_VO();
		...
		yetaPayr4200Service.yeta4200_PDF_YE162015_2019_Delete(yetaPdfYE162015Vo);
			...
			for(int k = 0; k < subXmlElChildMan.getLength();k++) {  
				...
				if (strDatCd.equals("G0041")) {
					...
					for(int i = 0; i < subXmlElChildSum.getLength(); i++) {  
						...
						yetaPayr4200Service.yeta4200_PDF_P101Y_2019_Delete(yetaPdfP101yVo);
						yetaPayr4200Service.yeta4200_PDF_P101Y_2019_Insert(yetaPdfP101yVo);
					}
		...
		yetaPayr4200Service.yeta4200_PDF_YE162015_2019_Insert(yetaPdfYE162015Vo);
	}
	
	public static void setPdfP101mVo(InfcPkgPdfP101m_2019_VO yetaPdfP101mVo , HttpServletRequest request, Element subXmlElData) throws Exception{
		...
		yetaPayr4200Service.yeta4200_PDF_P101M_2019_Delete(yetaPdfP101mVo);
		yetaPayr4200Service.yeta4200_PDF_P101M_2019_Insert(yetaPdfP101mVo);
