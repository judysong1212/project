...
@Controller 
public class Yeta7300Tax2022ContributionCalcPkgProc  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta7300Tax2022ContributionCalcPkgProc.class);
	   
    @Resource(name = "Yeta7300PayrService")
    protected Yeta7300PayrService  infcPkgYeta7300;
    
 
    public Yeta7300Tax2022ContributionCalcPkgProc() {
    	
    } 
    
    public List<ShowMessageBM> execTax_2022_Contribution_Calc(HttpServletRequest request, InfcPkgYe161010_2022_VO  infcPkgYe161010Vo)  throws Exception  {
  	    
	  	  return  fnTax_2022_Contribution_Calc(request,  infcPkgYe161010Vo);
	}
    ...
    * @throws Exception
    */
    private  List<ShowMessageBM> fnTax_2022_Contribution_Calc(HttpServletRequest request, InfcPkgYe161010_2022_VO  infcPkgYe161010Vo) throws Exception {
      ...
      BigDecimal bgYetaAllSumSe = BigDecimal.ZERO;  //세액합계금액 
		...
		//	BeanUtils.copyProperties(infcPkgYe165030Vo, infcPkgYe161010Vo);
            ...
            // {2011-추가기능 시작 } 
             ...
             List listYetaGibu = infcPkgYeta7300.fnYeta7300_YE169010_Tax_2022_1001_Select(infcPkgYe169010Vo); 
             ...
             if  (listYetaGibu.size() > 0) {
            	   ...
            	   Iterator<Map<String, Object>> iter = listYetaGibu.iterator(); 
		            ...
		            while ( iter.hasNext() ) { 
                     ...
                     InfcPkgYe165030Srh_2022_VO infcPkgYe165030SrhVo =  new InfcPkgYe165030Srh_2022_VO(); 
                     ...
                     List listYe165030 = infcPkgYeta7300.fnPayr06430_PAYR442_ReTax_2022_SelectFind(infcPkgYe165030SrhVo);
                    	...
                    	/**********************************************************************************************************
                     	 ...
                     	 ***********************************************************************************************************/
                     	 for(int iCnt = 0; iCnt < listYe165030.size();iCnt++) {
                     		 ...
                     		 InfcPkgYe165030_2022_VO infcPkgOrgYe165030Vo =  new InfcPkgYe165030_2022_VO();
                     		 InfcPkgYe165030_2022_VO upInfcPkgYe165030Vo =  new InfcPkgYe165030_2022_VO(); 
                           		 ...
                           		 if (mTemp10Data20.compareTo(BigDecimal.ZERO) <= 0)  { 
										   ...
										   upInfcPkgYe165030Vo.setThcYrNducCrfwAmt(BigDecimal.ZERO);    /** column 해당년도_미공제이월금액 : ayyrNtam */
		                                    ...
		                                    // {
		                                     ...
		                                     statCnt = 0;
		                     		  		 statCnt =  infcPkgYeta7300.fnPayr06430_PAYR442_ReTax_2022_Update(upInfcPkgYe165030Vo);  
     ...
     * @return
     */
    private InfcPkgYe165030_2022_VO insertYeYe165030(InfcPkgYe165030_2022_VO infcPkgOrgYe165030Vo, InfcPkgYe165030_2022_VO upInfcPkgYe165030Vo,BigDecimal bgSPCI_FBTG17_10 ,BigDecimal bgSPCI_FBSE17_10,BigDecimal orgSanChul) {
