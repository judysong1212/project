...
@Controller 
public class Yeta4300Tax2019ContributionCalcPkgProc  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta4300Tax2019ContributionCalcPkgProc.class);
	   
    @Resource(name = "Yeta4300PayrService")
    protected Yeta4300PayrService  infcPkgYeta4300;
    
 
    public Yeta4300Tax2019ContributionCalcPkgProc() {
    	
    } 
    
    public List<ShowMessageBM> execTax_2019_Contribution_Calc(HttpServletRequest request, InfcPkgYe161010_2019_VO  infcPkgYe161010Vo)  throws Exception  {
  	    
	  	  return  fnTax_2019_Contribution_Calc(request,  infcPkgYe161010Vo);
	}
    ...
    * @throws Exception
    */
    private  List<ShowMessageBM> fnTax_2019_Contribution_Calc(HttpServletRequest request, InfcPkgYe161010_2019_VO  infcPkgYe161010Vo) throws Exception {
      ...
      BigDecimal bgYetaAllSumSe = BigDecimal.ZERO;  //세액합계금액 
		...
		//	BeanUtils.copyProperties(infcPkgYe165030Vo, infcPkgYe161010Vo);
            ...
            // {2011-추가기능 시작 } 
             ...
             List listYetaGibu = infcPkgYeta4300.fnYeta4300_YE169010_Tax_2019_1001_Select(infcPkgYe169010Vo); 
             ...
             if  (listYetaGibu.size() > 0) {
            	   ...
            	   Iterator<Map<String, Object>> iter = listYetaGibu.iterator(); 
		            ...
		            while ( iter.hasNext() ) { 
                     ...
                     InfcPkgYe165030Srh_2019_VO infcPkgYe165030SrhVo =  new InfcPkgYe165030Srh_2019_VO(); 
                     ...
                     List listYe165030 = infcPkgYeta4300.fnPayr06430_PAYR442_ReTax_2019_SelectFind(infcPkgYe165030SrhVo);
                    	...
                    	/**********************************************************************************************************
                     	 ...
                     	 ***********************************************************************************************************/
                     	 for(int iCnt = 0; iCnt < listYe165030.size();iCnt++) {
                     		 ...
                     		 InfcPkgYe165030_2019_VO infcPkgOrgYe165030Vo =  new InfcPkgYe165030_2019_VO();
                     		 InfcPkgYe165030_2019_VO upInfcPkgYe165030Vo =  new InfcPkgYe165030_2019_VO(); 
                           		 ...
                           		 if (mTemp10Data20.compareTo(BigDecimal.ZERO) <= 0)  { 
										   ...
										   upInfcPkgYe165030Vo.setThcYrNducCrfwAmt(BigDecimal.ZERO);    /** column 해당년도_미공제이월금액 : ayyrNtam */
		                                    ...
		                                    // {
		                                     ...
		                                     statCnt = 0;
		                     		  		 statCnt =  infcPkgYeta4300.fnPayr06430_PAYR442_ReTax_2019_Update(upInfcPkgYe165030Vo);  
     ...
     * @return
     */
    private InfcPkgYe165030_2019_VO insertYeYe165030(InfcPkgYe165030_2019_VO infcPkgOrgYe165030Vo, InfcPkgYe165030_2019_VO upInfcPkgYe165030Vo,BigDecimal bgSPCI_FBTG17_10 ,BigDecimal bgSPCI_FBSE17_10,BigDecimal orgSanChul) {
