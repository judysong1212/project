...
import com.app.smrmf.infc.yearendtax.server.vo.yeta2020.InfcPkgYe160404_2020_VO;
import com.app.smrmf.infc.yearendtax.server.vo.yeta2020.InfcPkgYe160405_2020_VO;
import com.app.smrmf.infc.yearendtax.server.vo.yeta2020.InfcPkgYe160406_2020_VO;
import com.app.smrmf.infc.yearendtax.server.vo.yeta2020.InfcPkgYe160510_2020_VO;
 ...
 */
@Controller
public class Yeta5300TaxPkgProc extends AbstractCustomServiceImpl {

	private static final Logger logger = LoggerFactory.getLogger(Yeta5300TaxPkgProc.class);
	...
	private static String cLog2 = "";*/

	public Yeta5300TaxPkgProc() {

	}

	// 용인 세액계산 클릭 시
	public PagingLoadResult<ShowMessageBM> execfnYeta5300TaxPkgProc(
			HttpServletRequest request,
			List<InfcPkgYe161010_2020_VO> listYe161010VO) throws Exception {

		return funcYeta5300TaxPkgProc(request, listYe161010VO);
	}
     ...
     * @throws Exception
     */
    private PagingLoadResult<ShowMessageBM> funcYeta5300TaxPkgProc(HttpServletRequest request,List<InfcPkgYe161010_2020_VO> listYe161010VO)  throws Exception  {
		...
		InfcPkgYe160404_2020_VO   	infcPkgYe160404Vo	 = new InfcPkgYe160404_2020_VO();	//D_종전근무처
		InfcPkgYe160405_2020_VO    	infcPkgYe160405Vo	 = new InfcPkgYe160405_2020_VO();	//D_종전근무처비과세_감면소득_비과세
		InfcPkgYe160406_2020_VO    	infcPkgYe160406Vo	 = new InfcPkgYe160406_2020_VO();	//종전근무지연금보험료_공적연금
...
//		InfcPkgYe161005VO    infcPkgYe161005Vo	 = new InfcPkgYe161005VO();	//A_원천세신고기본
		...
		try { 
	  		  ...
	  		  infcPkgYeta5300 = (Yeta5300PayrService)BeanFinder.getBean("Yeta5300PayrService"); 
             ...
             /************************* 대상자별로 루프 시작 ***************************************************/ 
	  		  ...
	  		  for (int iCnt01 = 0;iCnt01 < listYe161010VO.size();iCnt01++) {
		              ...
		              **********************************************************************************************/
				  		  ...
				  		  statCnt = 0;
				  		    //의료비정리
				  		   infcPkgYeta5300.fnYeta5300_B101Y_YE161080_2020_Update(infcPkgYe161010Vo);
				  		  //주택마련저축정리 
				  		  infcPkgYeta5300.fnYeta5300_TaxPkg01_2020_Update(infcPkgYe161010Vo);  
				  		  //합계처리 (연금계좌,의료비,교육비,기부금납입금,월세액 합계)
				  		   infcPkgYeta5300.fnYeta5300_All_YE161080_2020_Update(infcPkgYe161010Vo);
				  		
				  	      if (statCnt >= 0) {
						  		// ############## YE161020 부양가족인원수 ##############   
						 		statCnt = 0;
						  		statCnt = infcPkgYeta5300.fnYeta5300_YE161020_Tax_2020_01_Update(infcPkgYe161020Vo);  
						  		if (statCnt >= 0) { 
							  		statCnt = 0;
							  		// ############## YE161055 국민연금등정리 ############## 
							  		statCnt = infcPkgYeta5300.fnYeta5300_YE161055_Tax_2020_02_Update(infcPkgYe161055Vo); 
							  		if (statCnt >= 0) { 
								  		statCnt = 0;
								  		// ############## YE161050 국민연금등합계 ############## 
								  		statCnt = infcPkgYeta5300.fnYeta5300_YE161050_Tax_2020_03_Update(infcPkgYe161050Vo); 
								  		if (statCnt >= 0) { 
										  		statCnt = 0;
										  		/* ############## YE169010 비과세 정리  ##############  */
										  		statCnt = infcPkgYeta5300.fnYeta5300_YE169010_Tax_2020_04_Update(infcPkgYe169010Vo); 
										  		if (statCnt >= 0) { 
										  		    /** 공제단계 시작 01 총급여등기본공제,추가공제등 공제금액인서트 */
											  		statCnt = 0; 
											  		statCnt = infcPkgYeta5300.fnYeta5300_YE169010_Tax_2020_05_Update(infcPkgYe169010Vo);  
											  		if (statCnt >= 0) {   
										                 /**  {공제단계 시작 -소득공제 02} */ 
												  		if (statCnt >= 0) { 
												  		statCnt = 0;
												  		statCnt =  infcPkgYeta5300.fnYeta5300_YE169010_Tax_2020_06_Update(infcPkgYe169010Vo); 	
												  		if (statCnt >= 0) {  
											                 /**  {공제단계 시작 -연금보험료공제 03} */ 
											                 //      ---------------------------연금보험료공제-------------------------------------- 
													  		statCnt = 0;
													  		statCnt =  infcPkgYeta5300.fnYeta5300_YE169010_Tax_2020_07_Update(infcPkgYe169010Vo); 
													  		if (statCnt >= 0) {
												                  /**  {공제단계 시작 -특별공제 - 주택임차차임금 상환액  09 } */ 
												                  //   ------------------특별공제 - 주택임차차임금 상환액--------------------------- 
														  		statCnt = 0;  //TODO YE161060 작업함
														  		statCnt =  infcPkgYeta5300.fnYeta5300_YE169010_Tax_2020_08_Update(infcPkgYe169010Vo); 
														  		if (statCnt >= 0) { 
												                  /**  {공제단계 시작 -특별공제 - 주택마련저축  10 } */ 
															  		statCnt = 0;
															  		statCnt = infcPkgYeta5300.fnYeta5300_YE169010_Tax_2020_09_Update(infcPkgYe169010Vo); 
														  			if (statCnt >= 0) {
													                  /**  {공제단계 시작 -특별공제 - 주택마련저축 합계  10-1 } */ 
																  	
																  		statCnt = 0;
																  		statCnt =  infcPkgYeta5300.fnYeta5300_YE169010_Tax_2020_10_Update(infcPkgYe169010Vo); 
																  		if (statCnt >= 0) {
																  			/**  {공제단계 시작 -특별공제 - 장기주택이자상환액  10-2 } */
																	  		statCnt = 0;
																	  		statCnt =  infcPkgYeta5300.fnYeta5300_YE169010_Tax_2020_11_Update(infcPkgYe169010Vo); 
																	  		if (statCnt >= 0) { 
																                 /**  {공제단계 시작 -특별공제 - 장기주택이자상환액 고정금리 비거치  10-3 } */
																	  			/*cLog = "";
																	  			cLog2 = "";
																	  			cLog = String.valueOf(infcPkgYe169010Vo.getYetaC121()); //형변환
																	  			cLog2 = String.valueOf(infcPkgYe169010Vo.getYetaC122()); //형변환
																	  			logger.debug("자녀수 = " + cLog);
																	  			logger.debug("자녀세액 = " + cLog2);
																	  			List dataList = new ArrayList();
																	  			dataList = infcPkgYeta5300.selectYeta5300ToYetaC122(infcPkgYe169010Vo);
																	  			if(dataList != null && dataList.size() > 0){
																	  				for (int i = 0; i < dataList.size(); i++){
																	  					Map dataMap = (Map) dataList.get(i);
																	  					logger.debug(spciDdctCheck, Long.parseLong(MSFSharedUtils.defaultNulls(dataMap.get("yetaC121"),"0")));
																	  					logger.debug(spciDdctCheck, Long.parseLong(MSFSharedUtils.defaultNulls(dataMap.get("yetaC122"),"0")));
																	  				}
																	  			}*/
																	  			
																		  		statCnt = 0;
																		  		statCnt = infcPkgYeta5300.fnYeta5300_YE169010_Tax_2020_12_Update(infcPkgYe169010Vo); 
																	  			...
																	  			dataList2 = infcPkgYeta5300.selectYeta5300ToYetaC122(infcPkgYe169010Vo);
																	  			if(dataList2 != null && dataList2.size() > 0){
																	  				for (int i = 0; i < dataList2.size(); i++){
																	  					Map dataMap2 = (Map) dataList2.get(i);
																	  					logger.debug(String.valueOf(Long.parseLong(MSFSharedUtils.defaultNulls(dataMap2.get("yetaC121"),"0"))));
																	  					logger.debug(String.valueOf(Long.parseLong(MSFSharedUtils.defaultNulls(dataMap2.get("yetaC122"),"0"))));
																	  				}
																	  			}*/
																                  ...
																                  /**  {공제단계 시작 -특별공제 - 장기주택이자상환액 기타 대출  10-4 } */
																			  		statCnt = 0;
																			  		  infcPkgYeta5300.fnYeta5300_YE169010_Tax_2020_13_Update(infcPkgYe169010Vo); 
																			  		//if (statCnt >= 0) { 
																			  			 /**  {장기주택이자상환액 2015년이후 고정금리이면서 비거치상환 대출 } */ 
																				  		statCnt = 0;
																				  		statCnt = infcPkgYeta5300.fnYeta5300_YE169010_Tax_2020_14_Update(infcPkgYe169010Vo);  
																				  		if (statCnt >= 0) { 
																				  		   /**  기타로직  등 계산 로직 */ 
																					  		statCnt = 0;
																					  		statCnt =  infcPkgYeta5300.fnYeta5300_YE169010_Tax_2020_15_Update(infcPkgYe169010Vo); 
																					  		if (statCnt >= 0) {
																				                /**  투자조합출자등소득공제 2018년  */ 
																						  		 statCnt = 0;
																						  		 statCnt =  infcPkgYeta5300.fnYeta5300_YE169010_Tax_2020_16_Update(infcPkgYe161070Vo);
																						  		 if (statCnt >= 0) {
																					                /**  투자조합출자등소득공제 2019년  */ 
																							  		 statCnt = 0;
																							  		 statCnt =  infcPkgYeta5300.fnYeta5300_YE169010_Tax_2020_17_Update(infcPkgYe161070Vo); 
																							  		 if (statCnt >= 0) {
																							  			statCnt = 0;
																								  		statCnt =  infcPkgYeta5300.fnYeta5300_YE169010_Tax_2020_18_Update(infcPkgYe161070Vo); 
																								  		if (statCnt >= 0) {	
																							                 /**  신용카드  등 계산 로직  */ 
																									  		statCnt = 0;
																									  		//20200110 신용카드 컬럼 추가 후 재수정작업 필요
																									  		logger.debug("신카공제금액_1 = " + infcPkgYe169010Vo.getYetaC104());
																									  		statCnt =  infcPkgYeta5300.fnYeta5300_YE169010_Tax_2020_19_Update(infcPkgYe169010Vo); 
																									  		logger.debug("신카공제금액_2 = " + infcPkgYe169010Vo.getYetaC104());
																									  		if (statCnt >= 0) {
																								                 /**  {공제단계 시작 -연금보험료공제 연금보험료공제  대상금액 04}  */																										  		
																										  		statCnt = 0;
																										  		statCnt =  infcPkgYeta5300.fnYeta5300_YE169010_Tax_2020_20_Update(infcPkgYe169010Vo); 
																										  		if (statCnt >= 0) {
																								                   /**  {공제단계 시작 -연금보험료공제 03_1 대상금액 구하는 로직 추가  05}*/
																									                 // ---------------------------연금보험료공제-------------------------------------- 
																											  		statCnt = 0;
																											  		statCnt =  infcPkgYeta5300.fnYeta5300_YE169010_Tax_2020_21_Update(infcPkgYe169010Vo); 
																											  		if (statCnt >= 0) { 
																										                 /**  {공제단계 시작 -특별공제 - 보장성/장애인  보험료  06} */
																												  		statCnt = 0;
																												  		statCnt = infcPkgYeta5300.fnYeta5300_YE169010_Tax_2020_22_Update(infcPkgYe169010Vo); 
																												  		if (statCnt >= 0) {
																											                 /**  특별공제 - 보험료 */
																													  		statCnt = 0;
																													  		statCnt = infcPkgYeta5300.fnYeta5300_YE169010_Tax_2020_23_Update(infcPkgYe169010Vo); 
																													  		if (statCnt >= 0) {
																												                 /**  {공제단계 시작 -특별공제 - 의료비 대상금액  07 - 1} */
																													  			//20200110 의료비 수정
																														  		statCnt = 0;
																														  		statCnt =  infcPkgYeta5300.fnYeta5300_YE169010_Tax_2020_24_Update(infcPkgYe169010Vo); 
																														  		if (statCnt >= 0) { 
																												                  /**  {공제단계 시작 -특별공제 - 의료비   07 -2 } */
//																													               -----------------------특별공제 - 의료비 ------------------
																															  		statCnt = 0;
																															  		statCnt =  infcPkgYeta5300.fnYeta5300_YE169010_Tax_2020_25_Update(infcPkgYe161080Vo); 
																															  		if (statCnt >= 0) {
																															  			statCnt =  infcPkgYeta5300.fnYeta5300_YE169010_Tax_2020_25_01_Update(infcPkgYe161080Vo); 
																														                 /** {공제단계 시작 -특별공제 - 교육비   08 -1 }  */   
																													                  //    ----------------------특별공제 - 교육비 ---------------------
																															  		          //TODO YE161080 에작업함 
																																	  		statCnt = 0;
																																	  		statCnt =  infcPkgYeta5300.fnYeta5300_YE169010_Tax_2020_26_Update(infcPkgYe161080Vo); 
																																	  		if (statCnt >= 0) { 
																																                 /**  {공제단계 시작 -특별공제 - 교육비 공제  08 -2 }  */
																																		  		statCnt = 0;
																																		  		statCnt =  infcPkgYeta5300.fnYeta5300_YE169010_Tax_2020_27_Update(infcPkgYe161080Vo);
																																		  		if (statCnt >= 0) { 
																																			        /** {공제단계 시작 -특별공제 - 기부금관계코드 오류 정정  11 }  */
																																	                 //   -------------------------기부금관계코드 오류 정정  ------------------------------
//																																			  		statCnt = 0;
//																																			  		statCnt =  infcPkgYeta5300.fnPayr06430_PAYR425_ReTax_2016_CREATE_06_1_Update(infcPkgYe161010Vo); 
//																																			  		if (statCnt >= 0) {}
																																                  /**  {공제단계 시작 -특별공제 - 기부금공제   12   }  */
																																	                 //   -------------------------기부금공제 1 -이전월 포함.------------------------------
																																			  		// 귀속년도 정치기부금 공제대상
																																			  		statCnt = 0;
																																			  		statCnt =  infcPkgYeta5300.fnYeta5300_YE169010_Tax_2020_29_Update(infcPkgYe169010Vo); 
																																			  		if (statCnt >= 0) {  
																																		                 /**  기부금공제 1 -귀속년도 법정기부금 */
																																			  			// 귀속년도 정치기부금 (실질적인 공제금액), 년도별 법정기부금, 종교외, 종교 공제대상금액만
																																				  		statCnt = 0;
																																				  		statCnt =  infcPkgYeta5300.fnYeta5300_YE169010_Tax_2020_30_Update(infcPkgYe169010Vo); 
																																				  		if (statCnt >= 0) { 
																																		                   /**  기부금공제 1 -귀속년도 법정기부금. */
																																					  		...
																																					  		statCnt = 0;
																																					  		statCnt =  infcPkgYeta5300.fnYeta5300_YE169010_Tax_2020_31_Update(infcPkgYe169010Vo);
																																					  		if (statCnt >= 0) {
																																					  			statCnt = 0;
																																						  		statCnt =  infcPkgYeta5300.fnYeta5300_YE169010_Tax_2020_31_01_Update(infcPkgYe169010Vo);
																																						  		if (statCnt >= 0) {
																																				                 /**  이전월 기부금공제 특례기부금공제, 현재년도 우리사주조합2 */
//																																						  		statCnt = 0;
//																																						  		statCnt =  infcPkgYeta5300.fnPayr06430_PAYR425_ReTax_2016_CREATE_09_01_Update(infcPkgYe161010Vo);
//																																						  		if (statCnt >= 0) { 
//																																						  		}

																																							     /**   현재년도 우리사주조합 대상금액 구하기  */
																																								statCnt = 0;
																																								statCnt =  infcPkgYeta5300.fnYeta5300_YE169010_Tax_2020_32_Update(infcPkgYe169010Vo); 
																																								if (statCnt >= 0) {
																																							      /**  기부금공제 2013년도 이전 종교단체/외 이월 기부금  */
																																									statCnt = 0;   //이월분 종교외공제금액작업(13년도)
																																									statCnt =  infcPkgYeta5300.fnYeta5300_YE169010_Tax_2020_33_Update(infcPkgYe161060Vo); 		
																																									if (statCnt > 0) {
																																										statCnt = 0;   //이월분 종교단체공제금액작업(13년도)
																																										statCnt =  infcPkgYeta5300.fnYeta5300_YE169010_Tax_2020_33_02_Update(infcPkgYe161060Vo); 		
																																										if (statCnt > 0) {	
																																											statCnt = 0;   //TODO YE161060 작업함 
																																											statCnt =  infcPkgYeta5300.fnYeta5300_YE169010_Tax_2020_33_03_Update(infcPkgYe169010Vo); 		
																																											if (statCnt > 0) {	
																																												statCnt = 0;   //TODO 종교외/종교기부금 공제한도금액 구하기(13년도)
																																												statCnt =  infcPkgYeta5300.fnYeta5300_YE169010_Tax_2020_33_04_Update(infcPkgYe169010Vo); 		
																																												if (statCnt >= 0) {		
																																													/**  기부금공제 특례기부금공제,당해년도 종교단체기부금 대상금액 */
																																													/* 20200109 시작 */
																																													statCnt = 0;
																																													// 종교외기부금 15,16,17
																																													statCnt =  infcPkgYeta5300.fnPayr06430_PAYR425_ReTax_2016_CREATE_09_021_Update(infcPkgYe169010Vo);
																																											 		if (statCnt > 0) {
																																											 			statCnt = 0;
																																											 			// 종교외기부금 18,19,20
																																											 			statCnt =  infcPkgYeta5300.fnPayr06430_PAYR425_ReTax_2016_CREATE_09_022_Update(infcPkgYe169010Vo); 
																																												 		if (statCnt >= 0) {
																																												          /**  기부금공제  2014 년도 종교단체기부금 대상금액 */
																																												 			//종교기부금 15,16,17
																																													  		statCnt = 0;
																																													  		statCnt =  infcPkgYeta5300.fnPayr06430_PAYR425_ReTax_2016_CREATE_09_031_Update(infcPkgYe169010Vo);
																																													  		if (statCnt >= 0) {
																																													  			//종교기부금 18,19
																																													  			statCnt = 0;
																																													  			statCnt =  infcPkgYeta5300.fnPayr06430_PAYR425_ReTax_2016_CREATE_09_032_Update(infcPkgYe169010Vo); 
																																													  		if (statCnt >= 0) {
																																												              /**  기부금공제 3 불러와서 년도별 수정하는걸로 변경함 */ 
																																													  			// 20200109 오후 시작
																																													  	         List listYetaGibu = infcPkgYeta5300.fnYeta5300_YE169010_Tax_2020_TgYear_Select(infcPkgYe169010Vo); 
																																													             ...
																																													             if  (listYetaGibu.size() > 0) {
																																															            ...
																																															            while ( iter.hasNext() ) { 
																																															               ...
																																															               InfcPkgYe169010_2020_VO     inputYe169010Vo = new InfcPkgYe169010_2020_VO();	//C_주현근무처 
																																												 						...
																																												 						//	InfcPkgYe161070VO    inputYe161070Vo	 = new InfcPkgYe161070VO();	//C_그밖의소득공제
																																															               InfcPkgYe161080_2020_VO    inputYe161080Vo	 = new InfcPkgYe161080_2020_VO();	//C_세액감면및공제
																																												 						...
																																												 						//	BeanUtils.copyProperties(inputYe161070Vo, infcPkgYe161010Vo);
																																															               ...
																																															               if (bgSPCI_FBTG18_10.compareTo(BigDecimal.ZERO) > 0) {
																																																	           ...
																																																	           if (bgYetaSumAll.compareTo(new BigDecimal("10000000")) <= 0 ) {
																																																            	   ...
																																																            	   bgSPCI_FBSE18_10 = bgSPCI_FBTG18_10.multiply(new BigDecimal("0.3"));
																																																               }
																																															               ...
																																															               if (bgSPCI_FBTG19_10.compareTo(BigDecimal.ZERO) > 0) {
																																																	           ...
																																																	           if (bgYetaSumAll.compareTo(new BigDecimal("10000000")) <= 0 ) {
																																																            	   ...
																																																            	   bgSPCI_FBSE19_10 = bgSPCI_FBTG19_10.multiply(new BigDecimal("0.3"));
																																																               }
																																															               ...
																																															               if (bgSPCI_FBTG20_10.compareTo(BigDecimal.ZERO) > 0) {
																																																	           ...
																																																	           if (bgYetaSumAll.compareTo(new BigDecimal("10000000")) <= 0 ) {
																																																            	   ...
																																																            	   bgSPCI_FBSE20_10 = bgSPCI_FBTG20_10.multiply(new BigDecimal("0.3"));
																																																               }
																																															               ...
																																															               if (bgSPCI_NATG18_40.compareTo(BigDecimal.ZERO) > 0) {
																																																	           ...
																																																	           if (bgYetaSumAll.compareTo(new BigDecimal("10000000")) <= 0 ) {
																																																	        	   bgSPCI_NASE18_40 = bgSPCI_NATG18_40.multiply(new BigDecimal("0.15"));
																																																                	...
																																																                	bgSPCI_NASE18_40 = bgSPCI_NATG18_40.multiply(new BigDecimal("0.3"));
																																																                }
																																															               ...
																																															               if (bgSPCI_NATG19_40.compareTo(BigDecimal.ZERO) > 0) {
																																																	           ...
																																																	           if (bgYetaSumAll.compareTo(new BigDecimal("10000000")) <= 0 ) {
																																																	        	   bgSPCI_NASE19_40 = bgSPCI_NATG19_40.multiply(new BigDecimal("0.15"));
																																																                	...
																																																                	bgSPCI_NASE19_40 = bgSPCI_NATG19_40.multiply(new BigDecimal("0.3"));
																																																                }
																																															               ...
																																															               if (bgSPCI_NATG20_40.compareTo(BigDecimal.ZERO) > 0) {
																																																	           ...
																																																	           if (bgYetaSumAll.compareTo(new BigDecimal("10000000")) <= 0 ) {
																																																	        	   bgSPCI_NASE20_40 = bgSPCI_NATG20_40.multiply(new BigDecimal("0.15"));
																																																                	...
																																																                	bgSPCI_NASE20_40 = bgSPCI_NATG20_40.multiply(new BigDecimal("0.3"));
																																																                }
																																															             ...
																																															             //종교단체 2020
																																															               ...
																																															               statCnt = 0;
																																															               statCnt =  infcPkgYeta5300.fnYeta5300_YE169010_Tax_2020_TgIn01_Update( inputYe161080Vo) ;
																																															               if (statCnt >= 0) {
																																															            	   statCnt = 0;
																																															            	   statCnt =  infcPkgYeta5300.fnYeta5300_YE169010_Tax_2020_TgIn02_Update(inputYe169010Vo) ;
																																															            	   }
																																															               }
																																															            }
																																													             /**  공제단계 시작 - 이전 이월정산정리 작업 443 -> 442로이관    -- 14 */
																																														  			...
																																														  			dataCheck = "";
																																														  		 	dataCheck =  infcPkgYeta5300.fnYeta5300_YE169010_Tax_2020_40_Update(infcPkgYe165030Vo);   
																																														  			if (statCnt >= 0) {   
																																													                   //  {공제단계 시작 - 기부금 내역 정보 정산.     15 - 1 } 전단계에서 자동으로 처리함 제외 
																																													                     /**  공제단계 시작 - 기부금 내역 정보 정산.     15 - 1 */ 
																																												//			  		dataCheck = "";
																																												//		  			dataCheck =   infcPkgYeta5300.fnPayr06430_PAYR425_ReTax_2016_CREATE_10_1_Update(infcPkgYe161010Vo); 
																																												//		  			if (MSFSharedUtils.paramNull(dataCheck)) {  
																																												//		  				
																																												//		  			}
																																														  				 /**  기부금 정리 이월분 정리 작업 시작   */ 	
																																														  				statCnt = 0;  
																																														  				Yeta5300Tax2020ContributionCalcPkgProc tax2020ContributionCalcPkgProc = new Yeta5300Tax2020ContributionCalcPkgProc();
																																														  				bmResult.addAll(tax2020ContributionCalcPkgProc.execTax_2020_Contribution_Calc(request,infcPkgYe161010Vo)); 
																																														  		  		if (bmResult.size() >= 0) {
																																														  				//if (0 >= 0) {
																																														  		  		//여기까지 	
																																												/******************************************************** 기부금 종료 전체 다시 작업  *****************************************************************************/
																																														              ...
																																														              // if (MSFSharedUtils.paramNull(dataCheck)) {         
																																												//		                 statCnt = 0;
																																												//		 		  		  statCnt =  infcPkgYeta5300.fnPayr06430_PAYR415_ReTax_2016_CREATE_12_1_Update(infcPkgYe169010Vo); 	
																																												//		 		  		  if (statCnt >= 0) { 
																																												//		 		  			TODO 확인후 상황에 맞게 수정 아니면 사용안함 
																																												//		 		  		  }
																																														 		  			// 위 금액을 빼는 부분 처리를 위해 추가 된 부분 2020.03.02추가 
																																														 		  			statCnt = 0;
																																														 		  			// 
																																														 		  			Yeta5300SubtTaxWkerAmntPkgProc yeta2300SubtTaxWkerAmnt  =  new Yeta5300SubtTaxWkerAmntPkgProc();
																																														 		  			bmResult.addAll(yeta2300SubtTaxWkerAmnt.execSubtTaxWkerAmntPkgProc( request, infcPkgYe161010Vo));
																																														 	 		  
																																														 	 		        if (bmResult.size() >= 0) {     
																																														 	 	 		       /**  공제계  합산 부분 구하는 부분 */
																																												//		 	 	 		  			statCnt = 0;
																																												//		 	 	 	 		 		statCnt = infcPkgYeta5300.fnPayr06430_PAYR425_ReTax_2016_CREATE_12_Update(infcPkgYe169010Vo);
																																												//		 	 	 		 		   if (statCnt >= 0) {
																																												...
																																												//		 	 	 		 		   }
																																														 	 	 		       ...
																																														 	 	 		       /**  차감소득금액 */ 
																																														 	 	 		 		statCnt = 0;
																																														 	 	 		 		statCnt =  infcPkgYeta5300.fnYeta5300_YE169010_Tax_2020_50_Update(infcPkgYe169010Vo); 
																																														 	 	 		       		if (statCnt >= 0) {
																																														 	 	 		 		       /**  그밖의 소득공제 계 */ 
																																														 	 	 		 		 		statCnt = 0;  
																																														 	 	 		 		 		statCnt = infcPkgYeta5300.fnYeta5300_YE169010_Tax_2020_50_01_Update(infcPkgYe169010Vo);		 	 	 		 	 		 		
																																												//		 	 	 		 		 		if (statCnt >= 0) { 
																																												//		 	 	 		 		 			 합계통합 삭제 
																																												//		 	 	 		 		 		}
																																														 	 	 		 		  	 //   statCnt = 0;
																																														 	 	 		 		 		logger.debug("statCnt" + statCnt);
																																														 	 	 		 		 		logger.debug("spciDdctCheck" + infcPkgYe161010Vo.getSpciDdctCheck());
																																														 	 	 		       	    	Yeta5300SubtTaxStdDdcPkgProc yeta2300SubtTaxStdDdc  = new Yeta5300SubtTaxStdDdcPkgProc();
																																														 	 	 				  		 ...
																																														 	 	 				  		 /** 표준세액공제에 대한 값 처리 */
																																														 	 	 		       	    	logger.debug("bmResult" + bmResult.size());
																																														 	 	 		 		  	  if (bmResult.size() >= 0) {		 	 	 		 		  		  
																																														 	 	 		 		    	InfcPkgYe169010Srh_2020_VO   infcPkgYe169010SrhVo = new InfcPkgYe169010Srh_2020_VO();	
																																														 	 	 		 		  		InfcPkgYe169010_2020_VO   tpInfcPkgYe169010Vo = new InfcPkgYe169010_2020_VO();	//C_주현근무처 
																																														 	 							...
																																														 	 							BeanUtils.copyProperties(infcPkgYe169010AVo, infcPkgYe161010Vo); 
																																														 	 			  			    BeanUtils.copyProperties(infcPkgYe161020Vo, infcPkgYe161010Vo);
																																														 	 			  			    logger.debug("C152StdTxDdcYn_1" + infcPkgYe161020Vo.getC152StdTxDdcYn());
																																														 	 			  			    infcPkgYe161020Vo.setC152StdTxDdcYn("N");
																																														 	 			  			    logger.debug("C152StdTxDdcYn_2" + infcPkgYe161020Vo.getC152StdTxDdcYn());
																																														 	 			  			    statCnt =  infcPkgYeta5300.fnYeta5300_YE161020_Tax_2020_C152_STD_TX_DDC_YN_Update(infcPkgYe161020Vo); 
																																														 	 	 		 	            
																																													 	 	 		 	                 tpInfcPkgYe169010Vo = infcPkgYeta5300.fnYeta5300_YE169010_Tax_2020_51_Select(infcPkgYe169010SrhVo);
																																													 	 	 		 	                      ...
																																													 	 	 		 	                      if ((!"2".equals(tpInfcPkgYe169010Vo.getRsdtClCd())) && "Y".equals(tpInfcPkgYe169010Vo.getYetaC152Check())) { 
																																									 	 	 		 						                	 ...
																																									 	 	 		 						                	 if (rtnAlryPinx01.compareTo(rtnAlryPinx02) <  0) {
																																									 	 	 		 						                		  ...
																																									 	 	 		 						                		  */
																																									 	 	 		 						                		   //avo 테이블에 복제 작업 함.  
																																									 	 	 		 						                		 dataCheck = "";
																																									 	 	 		 						                	     infcPkgYeta5300.fnYeta5300_YE169010a_Tax_2020_52_Delete(infcPkgYe169010Vo);
																																									 	 	 		 						                	     dataCheck =  infcPkgYeta5300.fnYeta5300_YE169010a_Tax_2020_52_Insert(infcPkgYe169010Vo); 
																																									 	 		 						                		     if (MSFSharedUtils.paramNotNull(tpInfcPkgYe169010Vo)) {
																																									 	 	 		 						                		  ...
																																									 	 	 		 						                		  //  InfcPkgYe169010aVO infcPkgYe169010AVo = new InfcPkgYe169010aVO(); 
																																									 	 	 		 						                		    ...
																																									 	 	 		 						                		    infcPkgYe169010AVo.setYetaStdC150b(BigDecimal.ZERO);    /** column C150B_STD_세액공제_특별세액공제_지정기부금_종교단체세액공제금액 : yetaStdC150b */
																																									 	 	 		 						                	         ...
																																									 	 	 		 						                	         statCnt = 0;
																																									 	 	 		 						                		  	 statCnt =  infcPkgYeta5300.fnYeta5300_YE169010a_Tax_2020_52_Update(infcPkgYe169010AVo); 
																																									 	 	 		 						                	
																																								//	 	 	 		 						                	       }
																																									 	 	 		 						                		     if (statCnt >= 0) {
																																									 	 	 		 						                			    
																																								//	 	 	 		 						                	                 statCnt = 0;
																																								//	 	 	 		 						                	 		  		 statCnt =  infcPkgYeta5300.fnPayr06430_PAYR415_ReTax_2016_CREATE_12_1_Update(infcPkgYe161010Vo); 
																																								//	 	 	 		 						                	                  //합계구하는 부분인데 사용안함 
																																								//	 	 	 		 						                	 		  		if (statCnt >= 0) {      
																																									 	 	 		 									                			  // {retax-45} 
																																									 	 	 		 									                		       /**  공제계  합산 부분 구하는 부분 */
																																								//	 	 	 		 									                		  			statCnt = 0;
																																								//	 	 	 		 									                	 		 		statCnt = infcPkgYeta5300.fnPayr06430_PAYR425_ReTax_2016_CREATE_12_Update(infcPkgYe161010Vo);
																																								...
																																								//		 	 	 		 									                		 		if (statCnt >= 0) {
																																									 	 	 		 									                		      ...
																																									 	 	 		 									                		      //  -----------------'차감소득금액     ----------------------------------
																																									 	 	 		 									                		 		...
																																									 	 	 		 									                		 		statCnt = 0;
																																									 	 	 		 									                		 		 statCnt =  infcPkgYeta5300.fnYeta5300_YE169010a_Tax_2020_50_Update(infcPkgYe169010AVo); 
																																									 	 	 		 									                		 		 ...
																																									 	 	 		 									                		 		 *****************************************************************************************/
																																									 	 	 		 													           	 		 	  if (statCnt >= 0) {
																																									 	 	 		 													           	 		          ...
																																									 	 	 		 													           	 		          Yeta5300SubtTaxEtcIncDdcPkgProc subtTaxEtcIncDdc  = new Yeta5300SubtTaxEtcIncDdcPkgProc();
																																									 	 	 		 	 	 		 						                			          ...
																																									 	 	 		 	 	 		 						                			          if (bmResult.size() >= 0) { 
																																									 	 	 		 													           	 		 	 ...
																																									 	 	 		 													           	 		 	 //  {retax-47}
																																									 	 	 		 													                		       /**  그밖의 소득공제 계 */
																																									 	 	 		 													                		 		...
																																									 	 	 		 													                		 		statCnt = 0;
																																									 	 	 		 													                		 		statCnt = infcPkgYeta5300.fnYeta5300_YE169010a_Tax_2020_50_01_Update(infcPkgYe169010AVo);
																																									 	 	 		 													                		 		 
																																									 	 	 		 															               		       if (statCnt >= 0) {
																																									 	 	 		 															               		  	  
																																									 	 	 		 															               		  	       //YetaTaxCreateUpdate InfcPkgYe169010aVO
																																												 	 	 		 															               		 Yeta5300SubtTaxStdDdcPkgProc subtTaxStdDdc  = new Yeta5300SubtTaxStdDdcPkgProc();
																																												 	 	 		 			  		...
																																												 	 	 		 			  		if ("TRUE".equals(spciDdctCheck) ) {
																																													 	 	 		 			  		...
																																													 	 	 		 			  		statCnt =   infcPkgYeta5300.fnYeta5300_YE169010a_Tax_2020_51_Update(infcPkgYe169010AVo); 
																																													 	 	 		 			  		spciDdctCheck = "FALSE";
																																												 	 	 		 			  		} else {
																																								
																																													 	 	 		 			  		statCnt =   infcPkgYeta5300.fnYeta5300_YE169010_Tax_2020_51_Update(infcPkgYe169010Vo); 
																																													 	 	 		 			  		spciDdctCheck = "FALSE";  
																																												 	 	 		 			  		}
																																								...
																																								//				 	 	 		 			  		  statCnt =  infcPkgYeta5300.fnPayr06430_PAYR425_ReTax_2016_CREATE_19_Update(infcPkgYe169010Vo);
																																												 	 	 		 			  		
																																												 	 	 		 			  	 /** YE169010 YE169010A 복제 루틴 */ 
																																												 	 	 		 			  		 
																																													 	 							
																																													 	 					 		InfcPkgYe169010Srh_2020_VO   ye169010SrhVo = new InfcPkgYe169010Srh_2020_VO();	 
																																													 	 							BeanUtils.copyProperties(ye169010SrhVo, infcPkgYe161010Vo); 
																																													 	 							
																																												 	 	 		 			  		 List lstPkgYe169010Vo =  infcPkgYeta5300.fnYeta5300_YE169010_Tax_2020_A01_Select(ye169010SrhVo);
																																														 	 	 		 			     ...
																																														 	 	 		 			     for (int iCnt02 = 0;iCnt02 < lstPkgYe169010Vo.size();iCnt02++) {
																																														 	 	 		 			      ...
																																														 	 	 		 			      //	InfcPkgYe169010VO   tpInfcPkgYe169010Vo = new InfcPkgYe169010VO();	//C_주현근무처 
																																																 	 	 		 			  	InfcPkgYe161060_2020_VO    inputYe161060Vo	 = new InfcPkgYe161060_2020_VO();	//C_특별소득공제
																																																 	 							InfcPkgYe161070_2020_VO    inputYe161070Vo	 = new InfcPkgYe161070_2020_VO();	//C_그밖의소득공제
																																																 	 							InfcPkgYe161080_2020_VO    inputYe161080Vo	 = new InfcPkgYe161080_2020_VO();	//C_세액감면및공제
																																																 	 							BeanUtils.copyProperties(inputYe161060Vo, infcPkgYe161010Vo);
																																																 	 							BeanUtils.copyProperties(inputYe161070Vo, infcPkgYe161010Vo);
																																																 	 							BeanUtils.copyProperties(inputYe161080Vo, infcPkgYe161010Vo); 
																																																								...
																																																								infcPkgYeta5300.fnYeta5300_Ye161060_Tax_2020_I1_Update(inputYe161060Vo); 
																																																								...
																																																								inputYe161070Vo.setLtrmCniSsDdcAmt(new BigDecimal(MSFSharedUtils.defaultNulls(tempMap.get("yetaC109"),"0")));    /** column 장기집합투자증권저축공제금액 : ltrmCniSsDdcAmt */ 
																																																								 ...
																																																								 infcPkgYeta5300.fnYeta5300_Ye161070_Tax_2020_I2_Update(inputYe161070Vo); 
																																																								...
																																																								infcPkgYeta5300.fnYeta5300_Ye161080_Tax_2020_I3_Update(inputYe161080Vo);
																																																								 
																																																								 //연금저축등소득세액공제 정리 
																																																								 
																																																								InfcPkgYe162010Srh_2020_VO   ye162010SrhVo = new InfcPkgYe162010Srh_2020_VO();	 
																																																	 	 						BeanUtils.copyProperties(ye162010SrhVo, infcPkgYe161010Vo); 
																																																	 	 							
																																																 	 	 		 			  		 List lstPkgYe162010Vo =  infcPkgYeta5300.fnYeta5300_YE162010_Tax_2020_A01_Select(ye162010SrhVo);
																																																 	 	 		 			  	   ...
																																																 	 	 		 			  	   //  bgTotPNSN_SVNG_ACC_PYM_AMT =bgYeta0c98;
																																																		 	 	 		 			     ...
																																																		 	 	 		 			     for (int iCnt03 = 0;iCnt03 < lstPkgYe162010Vo.size();iCnt03++) {
																																																		 	 	 		 			    	 ...
																																																		 	 	 		 			    	 if ("Y0040030".equals(MSFSharedUtils.allowNulls(tempMap01.get("pnsnSvngAccPnsnSvngCl")))) {
																																																		 	 	 		 			    	    ...
																																																		 	 	 		 			    	    infcPkgYeta5300.updateYeta5300_Tax_Ye162010_01(infcPkgYe162010Vo);     
																																																		 	 	 		 			      ...
																																																		 	 	 		 			      InfcPkgYe162010_2020_VO    infcPkgYe162010Vo	 = new InfcPkgYe162010_2020_VO();	//F_연금저축계좌
																																																 	 	 		 			    	      BeanUtils.copyProperties(infcPkgYe162010Vo, infcPkgYe161010Vo);
																																																		 	 	 		 			      infcPkgYeta5300.updateYeta5300_Tax_Ye162010_02(infcPkgYe162010Vo); 	   
																																																		 	 	 		 			   
																																																		 	 	 		 			
																																																	 	 	 		 			      InfcPkgYe162020Srh_2020_VO   ye162020SrhVo = new InfcPkgYe162020Srh_2020_VO();	 
																																																	 	 							  BeanUtils.copyProperties(ye162020SrhVo, infcPkgYe161010Vo); 
																																																	 	 							
																																																 	 	 		 			  		   List lstPkgYe162020Vo =  infcPkgYeta5300.fnYeta5300_YE162020_Tax_2020_A01_Select(ye162020SrhVo);
																																																 	 	 		 			       ...
																																																 	 	 		 			       BigDecimal bgYetaC129 = new BigDecimal(MSFSharedUtils.defaultNulls(tempMap.get("yetaC129"),"0"));
																																																	 	 	 		 			    	 ...
																																																	 	 	 		 			    	 if ("Y0040010".equals(MSFSharedUtils.allowNulls(tempMap01.get("rtpnAccRtpnCl")))) {
																																																	 	 	 		 			    	    ...
																																																	 	 	 		 			    	    infcPkgYeta5300.updateYeta5300_Tax_Ye162020_01(infcPkgYe162020Vo);     
																																																 	 	 		 			    	     ...
																																																 	 	 		 			    	     infcPkgYeta5300.updateYeta5300_Tax_Ye162020_02(infcPkgYe162020Vo);      
																																																			 	 	 		 			     
																																																 	 	 		 			     InfcPkgYe162030Srh_2020_VO   ye162030SrhVo = new InfcPkgYe162030Srh_2020_VO();	 
																																																 	 							 BeanUtils.copyProperties(ye162030SrhVo, infcPkgYe161010Vo); 
																																																 	 						 
																																																 	 					                
																																															 	 	 		 			  		 List lstPkgYe162030Vo =  infcPkgYeta5300.fnYeta5300_YE162030_Tax_2020_A01_Select(ye162030SrhVo);
																																																	 	 	 		 			 ...
																																																	 	 	 		 			 for (int iCnt03 = 0;iCnt03 < lstPkgYe162030Vo.size();iCnt03++) {
																																																 	 	 		 			    	 ...
																																																 	 	 		 			    	 if ("Y0040050".equals(MSFSharedUtils.allowNulls(tempMap01.get("hsngPrptSvngSvngCl")))) {
																																																 	 	 		 			    	    ...
																																																 	 	 		 			    	    infcPkgYeta5300.updateYeta5300_Tax_YE162030_01(infcPkgYe162030Vo) ;  
																																																	 	 	 		 			    	
																																																	 	 	 		 			     }	 
																																																	 	 	 		 			     
																																																	 	 	 		 			    InfcPkgYe162040Srh_2020_VO   ye162040SrhVo = new InfcPkgYe162040Srh_2020_VO();	 
																																																	 	 							BeanUtils.copyProperties(ye162040SrhVo, infcPkgYe161010Vo); 
																																																	 	 							
																																																 	 	 		 			  		 List lstPkgYe162040Vo =  infcPkgYeta5300.fnYeta5300_YE162040_Tax_2020_A01_Select(ye162040SrhVo);
																																																 	 	 		 			     	 BigDecimal bgYetaC109 = new BigDecimal(MSFSharedUtils.defaultNulls(tempMap.get("yetaC109"),"0"));
																																																	 	 	 		 			    	 ...
																																																	 	 	 		 			    	 if ("Y0040110".equals(MSFSharedUtils.allowNulls(tempMap01.get("ltrmCniSsfnnCl")))) {
																																																	 	 	 		 			      	...
																																																	 	 	 		 			      	infcPkgYeta5300.updateYeta5300_Tax_YE162040_01(infcPkgYe162040Vo) ;      
																																																				 	 	 		 			  
																																																		 	 	 		 			     }	 
																																																								      //월세액거주자간 주책임차차임금 원리금상환 
																																																									
																																																									
																																																									   InfcPkgYe162510Srh_2020_VO   ye162510SrhVo = new InfcPkgYe162510Srh_2020_VO();	 
																																																		 	 							BeanUtils.copyProperties(ye162510SrhVo, infcPkgYe161010Vo); 
																																																		 	 							
																																																									  List lstPkgYe162510Vo =  infcPkgYeta5300.fnYeta5300_YE162510_Tax_2020_A01_Select(ye162510SrhVo);
																																																 	 	 		 			     	 BigDecimal bgYetaC156 = new BigDecimal(MSFSharedUtils.defaultNulls(tempMap.get("yetaC156"),"0"));
																																																										 	...
																																																										 	BeanUtils.copyProperties(infcPkgYe162510Vo, infcPkgYe161010Vo);
																																																		 	 	 		 			    	...
																																																		 	 	 		 			    	BigDecimal bgMnthRnttyYrlyMnthSum = new BigDecimal(MSFSharedUtils.defaultNulls(tempMap01.get("mnthRnttyYrlyTgtSum"),"0"));
																																																	 	 	 		 			    	    ...
																																																	 	 	 		 			    	    infcPkgYeta5300.updateYeta5300_Tax_Ye162510_01(infcPkgYe162510Vo) ; 
																																																		 	 	 		 			    ...
																																																		 	 	 		 			    InfcPkgYe162510_2020_VO    infcPkgYe162510Vo	 = new InfcPkgYe162510_2020_VO();	//G_월세액소득공제명세
																																																									 	BeanUtils.copyProperties(infcPkgYe162510Vo, infcPkgYe161010Vo);  
																																																	 	 	 		 			         infcPkgYeta5300.updateYeta5300_Tax_Ye162510_02(infcPkgYe162510Vo) ;      
																																																									   
																																																		 	 	 		 			    
																																																		 	 	 		 			     InfcPkgYe162520Srh_2020_VO   ye162520SrhVo = new InfcPkgYe162520Srh_2020_VO();	 
																																																		 	 							 BeanUtils.copyProperties(ye162520SrhVo, infcPkgYe161010Vo); 
																																																										 
																																																										 List lstPkgYe162520Vo =  infcPkgYeta5300.fnYeta5300_YE162520_Tax_2020_A01_Select(ye162520SrhVo);
																																																	 	 	 		 			     	 Long bgYeta0c84 = Long.parseLong(MSFSharedUtils.defaultNulls(tempMap.get("yeta0c84"),"0"));
																																																		 	 	 		 			    	...
																																																		 	 	 		 			    	infcPkgYeta5300.updateYeta5300_Tax_Ye162520_01(infcPkgYe162520Vo);    
  			...
  			dataList3 = infcPkgYeta5300.selectYeta5300ToYetaC122(infcPkgYe169010Vo);
  			if(dataList3 != null && dataList3.size() > 0){
  				for (int i = 0; i < dataList3.size(); i++){
  					Map dataMap3 = (Map) dataList3.get(i);
  					logger.debug(String.valueOf(Long.parseLong(MSFSharedUtils.defaultNulls(dataMap3.get("yetaC121"),"0"))));
  					logger.debug(String.valueOf(Long.parseLong(MSFSharedUtils.defaultNulls(dataMap3.get("yetaC122"),"0"))));
  				}
  			}*/
