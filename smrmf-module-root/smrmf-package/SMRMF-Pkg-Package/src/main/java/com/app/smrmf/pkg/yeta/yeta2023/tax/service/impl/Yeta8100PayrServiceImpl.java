...
import com.app.smrmf.infc.yearendtax.server.service.yeta2023.dao.InfcPkgYe170401_2023_DAO;
import com.app.smrmf.infc.yearendtax.server.service.yeta2023.dao.InfcPkgYe170402_2023_DAO;
import com.app.smrmf.infc.yearendtax.server.service.yeta2023.dao.InfcPkgYe170403_2023_DAO;
...
@Service("Yeta8100PayrService")
public class Yeta8100PayrServiceImpl extends AbstractServiceImpl  implements
        Yeta8100PayrService {
        
    private static final Logger LOGGER = LoggerFactory.getLogger(Yeta8100PayrServiceImpl.class);

	@Autowired
	@Resource(name = "InfcPkgYe170401_2023_DAO")
	private InfcPkgYe170401_2023_DAO infcPkgYe160401DAO; //현근무지급여지급명세
	@Autowired
	@Resource(name = "InfcPkgYe170402_2023_DAO")
	private InfcPkgYe170402_2023_DAO  infcPkgYe160402DAO;//현근무지비과세_감면소득_과세
	@Autowired
	@Resource(name = "InfcPkgYe170403_2023_DAO")
	private InfcPkgYe170403_2023_DAO  infcPkgYe160403DAO;//현근무지비과세_감면소득_비과세
	@Autowired
	...
	***********************************************************************************/
     ...
     *	-----------------------------------------------------------------------
     * 
     * @see com.app.smrmf.pkg.yeta.yeta2023.tax.service.Yeta8100PayrService#fnYeta8100_YE160401_PAYR_2023_CREATE_Insert(com.app.smrmf.infc.yearendtax.server.vo.InfcPkgYe160401VO)
	...
	public String fnYeta8100_YE160401_PAYR_2023_CREATE_Insert(InfcPkgYe160401VO infcPkgYe160401Vo) throws Exception {
		...
		dataCheck = infcPkgYe160401DAO.fnYeta8100_YE160401_PAYR_2023_CREATE_Insert(infcPkgYe160401Vo);
	 ...
	 *	-----------------------------------------------------------------------
	 * 
	 * @see com.app.smrmf.pkg.yeta.yeta2023.tax.service.Yeta8100PayrService#fnYeta8100_YE160402_PAYR_2023_CREATE_Insert(com.app.smrmf.infc.yearendtax.server.vo.InfcPkgYe160402VO)
	 * @param infcPkgYe160402Vo
	 * @throws Exception
	 */
    public String fnYeta8100_YE160402_PAYR_2023_CREATE_Insert(InfcPkgYe160402VO infcPkgYe160402Vo) throws Exception {
    	String dataCheck = "";
    	dataCheck =  infcPkgYe160402DAO.fnYeta8100_YE160402_PAYR_2023_CREATE_Insert(infcPkgYe160402Vo);
    	return dataCheck;
	}
    ...
    /**
	  ...
	  *
	  */ 
    public String fnYeta8100_Ye161050_PAYR_2023_CREATE_Insert(InfcPkgYe160401VO infcPkgYe160401Vo) throws Exception {
    	return infcPkgYe161050DAO.fnYeta8100_Ye161050_PAYR_2023_CREATE_Insert(infcPkgYe160401Vo);
	}  
	 ...
	 */
	  ...
	  public String fnYeta8100_Ye161055_PAYR_2023_CREATE_Insert(InfcPkgYe160401VO infcPkgYe160401Vo) throws Exception {
		   String rtnChk = "";
		   //국민연금 주근무지
		   rtnChk = infcPkgYe161055DAO.fnYeta8100_Ye161055_PAYR_2023_Y0130001_Insert(infcPkgYe160401Vo);
		   //국민연금 종근무지
		   rtnChk = infcPkgYe161055DAO.fnYeta8100_Ye161055_PAYR_2023_Y0130002_Insert(infcPkgYe160401Vo);
	 ...
	 * @param infcPkgYe160401Vo
	 */ 
	public String fnYeta8100_Ye161060_PAYR_2023_CREATE_Insert(InfcPkgYe160401VO infcPkgYe160401Vo) throws Exception {
		  return infcPkgYe161060DAO.fnYeta8100_Ye161060_PAYR_2023_CREATE_Insert(infcPkgYe160401Vo);
		}  
    ...
    public String fnYeta8100_YE160403_PAYR_2023_CREATE_Insert(InfcPkgYe160403VO infcPkgYe160403Vo) throws Exception {
    	return infcPkgYe160403DAO.fnYeta8100_YE160403_PAYR_2023_CREATE_Insert(infcPkgYe160403Vo);
	}   
	...
	public String fnYeta8100_YE169010_PAYR_2023_CREATE_Insert(InfcPkgYe160401VO infcPkgYe160401Vo) throws Exception {
	   return infcPkgYe169010DAO.fnYeta8100_YE169010_PAYR_2023_CREATE_Insert(infcPkgYe160401Vo);
	}      
    
	           
	public String fnYeta8100_YE161010_2023_CREATE_Insert(InfcPkgYe161010_2023_VO infcPkgYe161010Vo) throws Exception {
      	//LOGGER.debug(vo.toString());
    	  String dataCheck = "";
      ...
      //	LOGGER.debug(vo.toString());
    	  ...
    	  dataCheck = infcPkgYe161010DAO.fnYeta8100_YE161010_2023_CREATE_Insert(infcPkgYe161010Vo);
		// TODO 해당 테이블 정보에 맞게 수정
		return dataCheck;
	} 
	
	public String fnYeta8100_YE161020_2023_CREATE_Insert(InfcPkgYe161020_2023_VO infcPkgYe161020Vo) throws Exception {
      	//LOGGER.debug(vo.toString());
    	  String dataCheck = "";
      	/** ID Generation Service */
      	//TODO 해당 테이블 속성에 따라 ID 제너레이션 서비스 사용
      ...
      //	LOGGER.debug(vo.toString());
    	  ...
    	  dataCheck = infcPkgYe161020DAO.fnYeta8100_YE161020_2023_CREATE_Insert(infcPkgYe161020Vo);
		// TODO 해당 테이블 정보에 맞게 수정
		return dataCheck;
	} 
	...
	public String fnYeta8100_YE166020_2023_CREATE_Insert01(InfcPkgYe166020_2023_VO infcPkgYe166020Vo) throws Exception {
      ...
      //	LOGGER.debug(vo.toString());
    	  ...
    	  dataCheck = infcPkgYe166020DAO.fnYeta8100_YE166020_2023_CREATE_Insert01(infcPkgYe166020Vo);
		// TODO 해당 테이블 정보에 맞게 수정
		return dataCheck;
	} 
	...
	public String fnYeta8100_YE166020_2023_CREATE_Insert02(InfcPkgYe166020_2023_VO infcPkgYe166020Vo) throws Exception {
      ...
      //	LOGGER.debug(vo.toString());
    	  ...
    	  dataCheck = infcPkgYe166020DAO.fnYeta8100_YE166020_2023_CREATE_Insert02(infcPkgYe166020Vo);
		// TODO 해당 테이블 정보에 맞게 수정
		return dataCheck;
	} 
	...
	public String fnYeta8100_YE166010_2023_CREATE_Insert(InfcPkgYe166010_2023_VO infcPkgYe166010Vo) throws Exception {
      ...
      //	LOGGER.debug(vo.toString());
    	  ...
    	  dataCheck = infcPkgYe166010DAO.fnYeta8100_YE166010_2023_CREATE_Insert( infcPkgYe166010Vo);
		// TODO 해당 테이블 정보에 맞게 수정
		return dataCheck;
	}
	 
	
	public String fnYeta8100_YE161030_2023_CREATE_Insert(InfcPkgYe161030_2023_VO infcPkgYe161030Vo) throws Exception {
      	//LOGGER.debug(vo.toString());
    	  String dataCheck = "";
      	/** ID Generation Service */
      	//TODO 해당 테이블 속성에 따라 ID 제너레이션 서비스 사용
      ...
      //	LOGGER.debug(vo.toString());
    	  ...
    	  dataCheck = infcPkgYe161030DAO.fnYeta8100_YE161030_2023_CREATE_Insert(infcPkgYe161030Vo);
		// TODO 해당 테이블 정보에 맞게 수정
		return dataCheck;
	} 
	...
	public String fnYeta8100_YE161040_2023_CREATE_Insert01(InfcPkgYe161040_2023_VO infcPkgYe161040Vo) throws Exception {
      ...
      //	LOGGER.debug(vo.toString());
    	  ...
    	  dataCheck = infcPkgYe161040DAO.fnYeta8100_YE161040_2023_CREATE_Insert01(infcPkgYe161040Vo);
		// TODO 해당 테이블 정보에 맞게 수정
		return dataCheck;
	} 
	...
	public String fnYeta8100_YE161040_2023_CREATE_Insert02(InfcPkgYe161040_2023_VO infcPkgYe161040Vo) throws Exception {
      ...
      //	LOGGER.debug(vo.toString());
    	  ...
    	  dataCheck = infcPkgYe161040DAO.fnYeta8100_YE161040_2023_CREATE_Insert02(infcPkgYe161040Vo);
		// TODO 해당 테이블 정보에 맞게 수정
		return dataCheck;
	} 
	...
	public int fnYeta8100_YE161040_2023_INSU_FETC_Update(InfcPkgYe161040_2023_VO infcPkgYe161040Vo) throws Exception {
      ...
      //	LOGGER.debug(vo.toString());
    	  ...
    	  return infcPkgYe161040DAO.fnYeta8100_YE161040_2023_INSU_FETC_Update(infcPkgYe161040Vo);
		// TODO 해당 테이블 정보에 맞게 수정
		 
	} 

	
	public int fnYeta8100_YE161030_2023_CREATE_Update(InfcPkgYe161030_2023_VO infcPkgYe161030Vo) throws Exception {
      	//LOGGER.debug(vo.toString()); 
      	/** ID Generation Service */
      	//TODO 해당 테이블 속성에 따라 ID 제너레이션 서비스 사용
      	//String id = egovIdGnrService.getNextStringId();
      ...
      //	LOGGER.debug(vo.toString());
    	  ...
    	  return infcPkgYe161030DAO.fnYeta8100_YE161030_2023_CREATE_Update(infcPkgYe161030Vo);
		// TODO 해당 테이블 정보에 맞게 수정
	...
	public String fnYeta8100_YE165030_TEMP_2023_CREATE_Insert(InfcPkgYe165030Temp_2023_VO infcPkgYe165030TempVo) throws Exception {
      	//LOGGER.debug(vo.toString());
    	  String dataCheck = "";
      	/** ID Generation Service */
      	//TODO 해당 테이블 속성에 따라 ID 제너레이션 서비스 사용
      ...
      //	LOGGER.debug(vo.toString());
    	  ...
    	  dataCheck = infcPkgYe165030TempDAO.fnYeta8100_YE165030_TEMP_2023_CREATE_Insert(infcPkgYe165030TempVo);
		// TODO 해당 테이블 정보에 맞게 수정
		return dataCheck;
	} 
	...
	public String fnYeta8100_YE165030TempYE165030_2023_CREATE_Insert(InfcPkgYe165030_2023_VO infcPkgYe165030Vo) throws Exception {
      ...
      //	LOGGER.debug(vo.toString());
    	  ...
    	  dataCheck = infcPkgYe165030DAO.fnYeta8100_YE165030TempYE165030_2023_CREATE_Insert(infcPkgYe165030Vo);
		// TODO 해당 테이블 정보에 맞게 수정
		return dataCheck;
	} 
	...
	public String fnYeta8100_YE161070_2023_CREATE_Insert(InfcPkgYe161070_2023_VO infcPkgYe161070Vo) throws Exception {
      ...
      //	LOGGER.debug(vo.toString());
    	  ...
    	  dataCheck = infcPkgYe161070DAO.fnYeta8100_YE161070_2023_CREATE_Insert(infcPkgYe161070Vo);
		// TODO 해당 테이블 정보에 맞게 수정
		return dataCheck;
	} 
	...
	public String fnYeta8100_YE161080_2023_CREATE_Insert(InfcPkgYe161080_2023_VO infcPkgYe161080Vo) throws Exception {
      ...
      //	LOGGER.debug(vo.toString());
    	  ...
    	  dataCheck = infcPkgYe161080DAO.fnYeta8100_YE161080_2023_CREATE_Insert(infcPkgYe161080Vo);
		// TODO 해당 테이블 정보에 맞게 수정
		return dataCheck;
	} 
	...
	public String fnYeta8100_YE161080_2023_CREATE_Update_AS(InfcPkgYe161080_2023_VO infcPkgYe161080Vo) throws Exception {
      ...
      //	LOGGER.debug(vo.toString());
    	  ...
    	  dataCheck = infcPkgYe161080DAO.fnYeta8100_YE161080_2023_CREATE_Update_AS(infcPkgYe161080Vo);
		// TODO 해당 테이블 정보에 맞게 수정
		return dataCheck;
	} 
...
//	LOGGER.debug(vo.toString());
  ...
  dataCheck = infcPkgYe169010aDAO.fnYeta8100_YE169010a_2023_CREATE_Insert(infcPkgYe169010AVo);
// TODO 해당 테이블 정보에 맞게 수정
return dataCheck;
} 
	...
	// 급여 노조회비 기부금 반영 처리 부
	public String fnYeta8100_YE165010_2023_PAYR_CREATE(InfcPkgYe165010_2023_VO infcPkgYe165010Vo) throws Exception {
      	//LOGGER.debug(vo.toString());
    	  String dataCheck = "";
      	/** ID Generation Service */
      	//TODO 해당 테이블 속성에 따라 ID 제너레이션 서비스 사용
    	  infcPkgYe165010DAO.fnYeta8100_YE165010_2023_PAYR_CREATE_DELETE(infcPkgYe165010Vo);                   
    	  dataCheck = infcPkgYe165010DAO.fnYeta8100_YE165010_2023_PAYR_CREATE_INSERT(infcPkgYe165010Vo);
    ...
    public HashMap selectBass0360SearchList(InfcPkgYe161010Srh_2023_VO infcPkgYe161010SrhVo) throws Exception {
        return infcPkgYe161010DAO.selectBass0360SearchList(infcPkgYe161010SrhVo);
    }	
    
    
    public HashMap selectBass0500SearchList(InfcPkgYe161010Srh_2023_VO infcPkgYe161010SrhVo) throws Exception {
        return infcPkgYe161010DAO.selectBass0500SearchList(infcPkgYe161010SrhVo);
    }	
    
    public void fnYeta8100_YE161010_UtDpobCd_2023_Update(InfcPkgYe161010_2023_VO infcPkgYe161010Vo) throws Exception {
          infcPkgYe161010DAO.fnYeta8100_YE161010_UtDpobCd_2023_Update(  infcPkgYe161010Vo);
    }

 
	
   /***********************************************************************************
    * 2023년귀속 연말정산 처리를 위한 함수 처리 부 종료
	***********************************************************************************/
