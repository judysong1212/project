package com.app.smrmf.pkg.yeta.yeta2021.create;
 ...
 */
@Controller 
public class Yeta6100PkgProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta6100PkgProcContainer.class);
...
//
    ...
    public Yeta6100PkgProcContainer() {
    ...
    public PagingLoadResult<ShowMessageBM> execUpDpopYeta_2021_Insert(HttpServletRequest request, List<InfcPkgYe161010_2021_VO> listYe161010VO)  throws Exception  {
	  	  ...
	  	  return  funcUpDpopYeta_2021_Insert(request,  listYe161010VO);
	}  
    
 private PagingLoadResult<ShowMessageBM> funcUpDpopYeta_2021_Insert(HttpServletRequest request, List<InfcPkgYe161010_2021_VO> listYe161010VO )  throws Exception  {
    	
		PagingLoadResult<ShowMessageBM> retval = null;
		List<ShowMessageBM> bmResult = new ArrayList<ShowMessageBM>();
		MSFSysm0100BM sessionUser = MSFServerUtils.getLoggedUser(request);
		
		   if  (yeta6100PayrService == null) { 
               WebApplicationContext wac = WebApplicationContextUtils.
                       getRequiredWebApplicationContext( request.getSession().getServletContext());
   
               yeta6100PayrService = (Yeta6100PayrService) wac.getBean("Yeta6100PayrService"); 
		...
		try {
			...
			for (int iYetaCnt = 0; iYetaCnt < listYe161010VO.size(); iYetaCnt++) { 
				...
				InfcPkgYe161010Srh_2021_VO    infcPkgYe161010SrhVo	 = new InfcPkgYe161010Srh_2021_VO();	// 연말정산대상자기본
				
				InfcPkgYe161010_2021_VO infcPkgGetYe161010Vo = new InfcPkgYe161010_2021_VO();
				...
				if (ExtermsProps.getProps("EMYMT_DIVCD_01").equals(infcPkgYe161010Vo.getEmymtDivCd())) {
					//무기계약직인경우 
					HashMap  listBass0360Data = yeta6100PayrService.selectBass0360SearchList(  infcPkgYe161010SrhVo);
					...
					if (MSFSharedUtils.paramNotNull(listBass0360Data.get("untDpobCd"))) {
						...
						logger.debug("단위사업장맵핑 업데이트 시작 ");
						  yeta6100PayrService.fnYeta6100_YE161010_UtDpobCd_2021_Update(infcPkgYe161010Vo);   //infcPkgYeta6000Vo   
					...
					//기간제인경우 맵핑데이타 존재시 아닌
					HashMap  listBass0500Data = yeta6100PayrService.selectBass0500SearchList(  infcPkgYe161010SrhVo);
    ...
    public PagingLoadResult<ShowMessageBM> execYeta6100_All_2021_Create(HttpServletRequest request, List<InfcPkgYe161010_2021_VO> listYe161010VO)  throws Exception  {
	  	  ...
	  	  return  funcYetaYeta6100_All_2021_Create(request,  listYe161010VO);
	}
     ...
     * @throws Exception
     */
    private PagingLoadResult<ShowMessageBM> funcYetaYeta6100_All_2021_Create(HttpServletRequest request, List<InfcPkgYe161010_2021_VO> listYe161010VO )  throws Exception  {
		...
		//yeta6100PayrService = (Yeta6100PayrService)BeanFinder.getBean("Yeta6100PayrService");
		...
		try {
			...
			for (int iYetaCnt = 0; iYetaCnt < listYe161010VO.size(); iYetaCnt++) {
				...
				InfcPkgYe161010_2021_VO infcPkgLstYe161010Vo = new InfcPkgYe161010_2021_VO();
				infcPkgLstYe161010Vo = listYe161010VO.get(iYetaCnt); 
						...
						if (infcPkgLstYe161010Vo.getSrhPayrMangDeptCd().equals(MSFSharedUtils.allowNulls(infcPkgLstYe161010Vo.getSrhDeptCd()))) { 
							...
							dataCheck = yeta6100PayrService.fnYeta6100_YE161010_2021_CREATE_Insert(infcPkgYe161010Vo);   //infcPkgYeta2000Vo 
							...
							yeta6100PayrService.fnYeta6100_YE161020_2021_CREATE_Insert(infcPkgYe161020Vo);
							...
							if (MSFSharedUtils.paramNull(dataCheck)) {
									...
									dataCheck = yeta6100PayrService.fnYeta6100_YE161030_2021_CREATE_Insert(infcPkgYe161030Vo);   //infcPkgYeta6220Vo   
	...
	public PagingLoadResult<ShowMessageBM> execPayrToYeta_2021_Insert(HttpServletRequest request, List<InfcPkgYe161010_2021_VO> listYe161010VO)throws Exception {
		...
		return funcPayrToYeta_2021_Insert(request, listYe161010VO);
	}  
    
	private PagingLoadResult<ShowMessageBM> funcPayrToYeta_2021_Insert(HttpServletRequest request,List<InfcPkgYe161010_2021_VO> listYe161010VO)  throws Exception  {
		...
		try { 
			...
			for (int iCnt01 = 0; iCnt01 < listYe161010VO.size(); iCnt01++) {
				...
				InfcPkgYe161010_2021_VO infcPkgYe161010GetVo = new InfcPkgYe161010_2021_VO();
				infcPkgYe161010GetVo = listYe161010VO.get(iCnt01);
		  		
				bmResult.addAll(setSelfPayrToYeta_2021_Insert(request, infcPkgYe161010GetVo));
		  	}  
			/************************* 대상자별로 루프 종료 ***************************************************/        
		} catch (Exception ex) {
			ex.printStackTrace();
	 ...
	 * 2. 처리내용 : 
	 * </pre>
	 * @Method Name : funcPayrToYeta_2021_Insert
	 * @date : 2021. 1. 8.
	 * @author : atres
	 * @history : 
	 *	-----------------------------------------------------------------------
	 ...
	 * @throws Exception
	 */
	private List<ShowMessageBM> setSelfPayrToYeta_2021_Insert(HttpServletRequest request,InfcPkgYe161010_2021_VO  infcPkgYe161010Vo)  throws Exception  {
		...
		try { 
	       ...
	       /******************************** 권한 ************************************************************************/
	        ...
	        dataCheck = yeta6100PayrService.fnYeta6100_YE160401_PAYR_2021_CREATE_Insert(infcPkgYe160401Vo);   //YE160401 현근무지 급여지급 명세
		  		...
		  		if (MSFSharedUtils.paramNull(dataCheck)) {
		  			...
		  			dataCheck = "";
		  			int dataChk = 0;
		  			dataCheck = yeta6100PayrService.fnYeta6100_Ye161055_PAYR_2021_CREATE_Insert(infcPkgYe160401Vo);   //Ye161055VO();	//C_연금보험료_공적연금상세
				  		 
		  			if (MSFSharedUtils.paramNull(dataCheck)) {
		  			// ******************************급여자료 이관 - 연말정산 4대보험 인서트 Ye161050 /Ye161055 /Ye161060 [1-2]************* 
			  			dataCheck = "";
			  			dataCheck = yeta6100PayrService.fnYeta6100_Ye161050_PAYR_2021_CREATE_Insert(infcPkgYe160401Vo);   //Ye161050VO();	//C_연금보험료공제
					        
			  			if (MSFSharedUtils.paramNull(dataCheck)) {
			  			   // ******************************급여자료 이관 - 연말정산 4대보험 인서트 Ye161050 /Ye161055 /Ye161060 [1-3]************* 
				  			dataCheck = "";
				  			dataCheck = yeta6100PayrService.fnYeta6100_Ye161060_PAYR_2021_CREATE_Insert(infcPkgYe160401Vo);   //Ye161060VO();	//C_특별소득공제 
				  			...
				  			if (MSFSharedUtils.paramNull(dataCheck)) {  
						       ...
						       /******************************** 권한 ************************************************************************/
						        ...
						        if (infcPkgYe160402Vo.getPayrMangDeptCd().equals(MSFSharedUtils.allowNulls(infcPkgYe160401Vo.getDeptCd()))) { 
						  		...
						  		dataCheck = yeta6100PayrService.fnYeta6100_YE160402_PAYR_2021_CREATE_Insert(infcPkgYe160402Vo);   //infcPkgYe160402Vo 
						  		...
						  		if (MSFSharedUtils.paramNull(dataCheck)) {    
							        ...
							        if (infcPkgYe160402Vo.getPayrMangDeptCd().equals(MSFSharedUtils.allowNulls(infcPkgYe160401Vo.getDeptCd()))) { 
							  		...
							  		dataCheck = "";
							  		dataCheck = yeta6100PayrService.fnYeta6100_YE160403_PAYR_2021_CREATE_Insert(infcPkgYe160403Vo);   //yetaPrc3200Vo 
								  	...
								  	// {가족사항 업데이트 YETA3220 고용/건강보험료외 업데이트  }
										...
										dataCheck = "";
										dataCheck =  yeta6100PayrService.fnYeta6100_YE161040_2021_CREATE_Insert01(infcPkgYe161040Vo);   //infcPkgYe161040Vo   
										...
										if (MSFSharedUtils.paramNull(dataCheck)) { 
											...
											dataCheck = "";
											dataCheck =  yeta6100PayrService.fnYeta6100_YE161040_2021_CREATE_Insert02(infcPkgYe161040Vo);   //infcPkgYe161040Vo   
											bmResult.add(new ShowMessageBM(PropPayGenConfs.PAYGEN_INFO,"Yeta","[연말정산]" + "소득공제명세생성.","데이타확인",""));
											...
											if (MSFSharedUtils.paramNull(dataCheck)) {
												...
												//2014년 고용건강보험료외 업데이트
											 	...
											 	dataChk = 0;
											 	dataChk = yeta6100PayrService.fnYeta6100_YE161040_2021_INSU_FETC_Update(infcPkgYe161040Vo);   //infcPkgYeta6220Vo   
...
//														infcPkgYe165010Vo.setDdcTrgtConbAmt(new BigDecimal("0"));    									/** column 공제대상기부금액 : ddcTrgtConbAmt */
														...
														yeta6100PayrService.fnYeta6100_YE165010_2021_PAYR_CREATE(infcPkgYe165010Vo); 
...
//												if (dataChk >= 0) { 
													...
													dataChk = 0;
													dataChk =  yeta6100PayrService.fnYeta6100_YE161030_2021_CREATE_Update(infcPkgYe161030Vo);   //infcPkgYe161030Vo   
													...
													if (dataChk >= 0) {  
														...
														dataCheck = "";
														dataCheck = yeta6100PayrService.fnYeta6100_YE166020_2021_CREATE_Insert01(infcPkgYe166020Vo);   //infcPkgYeta6220Vo 
														
														if (MSFSharedUtils.paramNull(dataCheck)) { 

															dataCheck = "";
															dataCheck = yeta6100PayrService.fnYeta6100_YE166020_2021_CREATE_Insert02(infcPkgYe166020Vo);   //infcPkgYeta6220Vo 
															...
															if (MSFSharedUtils.paramNull(dataCheck)) { 
																...
																dataCheck = "";
																dataCheck = yeta6100PayrService.fnYeta6100_YE166010_2021_CREATE_Insert(infcPkgYe166010Vo);   //infcPkgYeta6220Vo   
																...
																logger.debug("5.신용카드 INSERT 종료 ");
																	...
																	if (MSFSharedUtils.paramNull(dataCheck)) {	
																		...
																		dataCheck =    yeta6100PayrService.fnYeta6100_YE161070_2021_CREATE_Insert(infcPkgYe161070Vo);   //infcPkgYeta6000Vo   
																		...
																		if (MSFSharedUtils.paramNull(dataCheck)) {	
																			...
																			dataCheck =  yeta6100PayrService.fnYeta6100_YE161080_2021_CREATE_Insert(infcPkgYe161080Vo);   //infcPkgYeta6000Vo
																			
																			if (PropPayGenConfs.PAYGEN_MUNICIPALITIES_15.equals(extGlobals.get("PayGen.MunicipalitiesName"))) {
																				// 안성시청이면 노조회비 기부금액 update
																				dataCheck = yeta6100PayrService.fnYeta6100_YE161080_2021_CREATE_Update_AS(infcPkgYe161080Vo);
																			}
																			...
																			if (MSFSharedUtils.paramNull(dataCheck)) { 
																				...
																				dataCheck =    yeta6100PayrService.fnYeta6100_YE165030_TEMP_2021_CREATE_Insert(infcPkgYe165030TempVo);   //infcPkgYeta6190Vo   
																				...
																				if (MSFSharedUtils.paramNull(dataCheck)) {
																					...
																					dataCheck = "";
																					logger.debug("7. 이월기부금 INSERT 시작 ");
																					dataCheck =    yeta6100PayrService.fnYeta6100_YE165030TempYE165030_2021_CREATE_Insert(infcPkgYe165030Vo);   //infcPkgYeta6190Vo   
																					bmResult.add(new ShowMessageBM(PropPayGenConfs.PAYGEN_INFO,"Yeta","[연말정산]" + "이월기부금 생성.","데이타확인",""));
																					logger.debug("7. 이월기부금 INSERT 종료");
...
System.out.println("=================급여이관===========YE169010 insert start");																				 
																				 dataCheck = yeta6100PayrService.fnYeta6100_YE169010_PAYR_2021_CREATE_Insert(infcPkgYe160401Vo);   //yetaPrc3210Vo 
...
//																					dataCheck =    yeta6100PayrService.fnYeta6100_YE169010_2021_CREATE_Insert(infcPkgYe161010Vo);   //infcPkgYeta6000Vo   
...
//																					logger.debug("10. 연말정산 상세 INSERT 종료 ");
																					...
																					dataCheck =    yeta6100PayrService.fnYeta6100_YE169010a_2021_CREATE_Insert(infcPkgYe169010AVo);   //infcPkgYeta6000Vo   
