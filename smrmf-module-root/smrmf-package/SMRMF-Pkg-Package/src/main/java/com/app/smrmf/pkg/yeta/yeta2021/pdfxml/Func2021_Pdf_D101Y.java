...
public class Func2021_Pdf_D101Y {
	...
	public static void func_2021_D101Y_D101M(InfcPkgYe161010_2021_VO ye161010VO, Element  subXmlElForm, String nResult, HttpServletRequest request ) throws Exception{
		...
		InfcPkgPdfD101y_2021_VO yetaPdfD101yVo = new InfcPkgPdfD101y_2021_VO();
		InfcPkgPdfD101m_2021_VO yetaPdfD101mVo = new InfcPkgPdfD101m_2021_VO();
		...
		for (int j = 0; j < subXmlElChildForm.getLength();j++) { 
			...
			for(int k = 0; k < subXmlElChildMan.getLength();k++) {  
				...
				if (strDatCd.equals("G0009")) {
					...
					yetaPayr3200Service.yeta6200_PDF_D101Y_2021_Delete(yetaPdfD101yVo);
					yetaPayr3200Service.yeta6200_PDF_D101Y_2021_Insert(yetaPdfD101yVo);
				}
			}
	...
	public static void func_2021_D101Y_YetaCalc(InfcPkgYe161010_2021_VO ye161010VO, HttpServletRequest request) throws Exception{ 
		...
		InfcPkgYe162010_2021_VO infcPkgYe162010Vo = new InfcPkgYe162010_2021_VO();
		...
		//개인연금저축 
		yetaPayr3200Service.PdfYeta6200_D101Y_YE162010_Delete(infcPkgYe162010Vo); 
		yetaPayr3200Service.PdfYeta6200_D101Y_YE162010_Insert(infcPkgYe162010Vo); 
		...
		// 개인연금저축금액합계
         yetaPayr3200Service.fnYeta6200_D101Y_YE161070_2021_Update(infcPkgYe161070Vo); 
