...
public class Func2021_Pdf_L102Y {
	...
	public static void func_2021_L102Y_L102D(InfcPkgYe161010_2021_VO ye161010VO, Element  subXmlElForm, String nResult, HttpServletRequest request) throws Exception{
		...
		InfcPkgPdfL102y_2021_VO yetaPdfL102yVo = new InfcPkgPdfL102y_2021_VO();
		InfcPkgPdfL102d_2021_VO yetaPdfL102dVo = new InfcPkgPdfL102d_2021_VO();
		...
		yetaPayr3200Service.yeta6200_PDF_L102Y_2021_Delete(yetaPdfL102yVo);
		...
		for (int j = 0; j < subXmlElChildForm.getLength();j++) { 
			...
			for(int k = 0; k < subXmlElChildMan.getLength();k++) {  
				...
				if (strDatCd.equals("G0020")) {
					...
					yetaPayr3200Service.yeta6200_PDF_L102Y_2021_Insert(yetaPdfL102yVo);
				}
	...
	public static void func_2021_L102Y_YetaCalc(InfcPkgYe161010_2021_VO ye161010VO, HttpServletRequest request) throws Exception{ 
		...
		InfcPkgYe165010_2021_VO infcPkgYe165010Vo = new InfcPkgYe165010_2021_VO();
		...
		//기부금
		yetaPayr3200Service.PdfYeta6200_L102Y_YE165010_Delete(infcPkgYe165010Vo); 
		yetaPayr3200Service.PdfYeta6200_L102Y_YE165010_Insert(infcPkgYe165010Vo); 
		 
		
		
		InfcPkgYe165020_2021_VO infcPkgYe165020Vo = new InfcPkgYe165020_2021_VO();
		...
		//기부금
		yetaPayr3200Service.PdfYeta6200_L102Y_YE165020_Delete(infcPkgYe165020Vo); 
		yetaPayr3200Service.PdfYeta6200_L102Y_YE165020_Insert(infcPkgYe165020Vo);
		
		
        InfcPkgYe165030_2021_VO infcPkgYe165030Vo = new InfcPkgYe165030_2021_VO();
		...
		//기부금
		yetaPayr3200Service.PdfYeta6200_L102Y_YE165030_Delete(infcPkgYe165030Vo); 
		yetaPayr3200Service.PdfYeta6200_L102Y_YE165030_Insert(infcPkgYe165030Vo);
		...
		yetaPayr3200Service.fnYeta6200_L102Y_YE161040_2021_Update(infcPkgYe161040Vo); 
		...
		// 기부금 합계  
         yetaPayr3200Service.fnYeta6200_L102Y_YE161080_2021_Update(infcPkgYe161080Vo); 
       ...
       //이월기부금처리 
 		...
 		// 기부금 이월분합계  
          yetaPayr3200Service.fnYeta6200_L102Y_YE161060_2021_Update(infcPkgYe161060Vo); 
