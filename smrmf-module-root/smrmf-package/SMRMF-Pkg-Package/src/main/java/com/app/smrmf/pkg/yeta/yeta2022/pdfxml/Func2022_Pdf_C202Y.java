...
public class Func2022_Pdf_C202Y {
	...
	public static void func_2022_C202Y_C202M(InfcPkgYe161010_2022_VO ye161010VO, Element  subXmlElForm, String nResult , HttpServletRequest request ) throws Exception{
		...
		InfcPkgPdfC202y_2022_VO yetaPdfC202yVo = new InfcPkgPdfC202y_2022_VO();
		InfcPkgPdfC202m_2022_VO yetaPdfC202mVo = new InfcPkgPdfC202m_2022_VO();
		...
		yetaPayr3200Service.yeta7200_PDF_C202Y_2022_Delete(yetaPdfC202yVo);
		...
		for (int j = 0; j < subXmlElChildForm.getLength();j++) { 
			...
			for(int k = 0; k < subXmlElChildMan.getLength();k++) {   
				...
				if (strDatCd.equals("G0005")) {
					...
					yetaPayr3200Service.yeta7200_PDF_C202Y_2022_Insert(yetaPdfC202yVo);
	...
	public static void func_2022_C202Y_YetaCalc(InfcPkgYe161010_2022_VO ye161010VO, HttpServletRequest request) throws Exception{ 
		...
		//교육비 
		yetaPayr3200Service.PdfYeta7200_C202Y_YE161090_Delete(infcPkgYe161090Vo); 
		yetaPayr3200Service.PdfYeta7200_C202Y_YE161090_Insert(infcPkgYe161090Vo); 
