...
public class Func2020_Pdf_E102Y {
	...
	public static void func_2020_E102Y_E102M(InfcPkgYe161010_2020_VO ye161010VO, Element  subXmlElForm, String nResult , HttpServletRequest request ) throws Exception{
		...
		InfcPkgPdfE102y_2020_VO yetaPdfE102yVo = new InfcPkgPdfE102y_2020_VO();
		InfcPkgPdfE102m_2020_VO yetaPdfE102mVo = new InfcPkgPdfE102m_2020_VO();
...
//					yetaPdfE102yVo.setPnsnSvSum(new BigDecimal(MSFSharedUtils.defaultNulls(PkgFuncUtils.getXmlTagValue("sum", subXmlElData), "0")));
					...
					yetaPayr3200Service.yeta5200_PDF_E102Y_2020_Delete(yetaPdfE102yVo);
					yetaPayr3200Service.yeta5200_PDF_E102Y_2020_Insert(yetaPdfE102yVo);
				}
	...
	public static void func_2020_E102Y_YetaCalc(InfcPkgYe161010_2020_VO ye161010VO, HttpServletRequest request) throws Exception{ 
		...
		//연금저축 
		yetaPayr3200Service.PdfYeta5200_E102Y_YE162010_Delete(infcPkgYe162010Vo); 
		yetaPayr3200Service.PdfYeta5200_E102Y_YE162010_Insert(infcPkgYe162010Vo); 
		...
		// 교육비 합계  
         yetaPayr3200Service.fnYeta5200_E102Y_YE161080_2020_Update(infcPkgYe161080Vo); 
