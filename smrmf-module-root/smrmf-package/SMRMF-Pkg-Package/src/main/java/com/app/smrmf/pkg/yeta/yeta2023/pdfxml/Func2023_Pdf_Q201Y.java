...
public class Func2023_Pdf_Q201Y {
	...
	private static final Logger logger = LoggerFactory.getLogger(Func2023_Pdf_Q201Y.class);


	public static void func_2023_Q201Y_Q201M(InfcPkgYe161010_2023_VO ye161010VO, Element  subXmlElForm, String nResult, HttpServletRequest request) throws Exception{
		...
		InfcPkgPdfQ201y_2023_VO yetaPdfQ201yVo = new InfcPkgPdfQ201y_2023_VO();
		InfcPkgPdfQ201m_2023_VO yetaPdfQ201mVo = new InfcPkgPdfQ201m_2023_VO();
		...
		yetaPayr3200Service.yeta8200_PDF_Q201Y_2023_Delete(yetaPdfQ201yVo);
		...
		for (int j= 0;j < subXmlElChildForm.getLength();j++)  {
			...
			for(int k = 0; k < subXmlElChildMan.getLength();k++) {  
				...
				if (strDatCd.equals("G0035")) { //밴처기업투자신탁
					...
					yetaPayr3200Service.yeta8200_PDF_Q201Y_2023_Insert(yetaPdfQ201yVo);*/
				} 
	...
	public static void setPdfQ201yVo (InfcPkgPdfQ201y_2023_VO yetaPdfQ201yVo, HttpServletRequest request, Element subXmlElData) throws Exception{
		if  (yetaPayr3200Service == null) { 
			WebApplicationContext wac = WebApplicationContextUtils.
					getRequiredWebApplicationContext( request.getSession().getServletContext());
	 ...
	 * </pre>
	 * @Method Name : func_2023_Q201Y_YetaCalc
	 * @date : 2023. 1. 23.
	 * @author : atres
	 * @history : 
	 *	-----------------------------------------------------------------------
	 ...
	 * @throws Exception
	 */
	public static void func_2023_Q201Y_YetaCalc(InfcPkgYe161010_2023_VO ye161010VO, HttpServletRequest request) throws Exception{ 
		...
		yetaPayr3200Service.PdfYeta8200_Q201Y_YE166040_Delete(infcPkgYe166040Vo); 
		yetaPayr3200Service.PdfYeta8200_Q201Y_YE166040_Insert(infcPkgYe166040Vo); 
		...
		// 벤처기업투자신탁 합계  
        yetaPayr3200Service.fnYeta8200_Q201Y_YE161070_2023_Update(infcPkgYe161070Vo); 
