...
public class Func2018_Pdf_J301Y {
	...
	public static void func_2018_J301Y_J301M(InfcPkgYe161010_2018_VO ye161010VO, Element  subXmlElForm, String nResult, HttpServletRequest request ) throws Exception{
		...
		InfcPkgPdfJ301y_2018_VO yetaPdfJ301yVo = new InfcPkgPdfJ301y_2018_VO();
		InfcPkgPdfJ301m_2018_VO yetaPdfJ301mVo = new InfcPkgPdfJ301m_2018_VO();
		...
		for (int j = 0; j < subXmlElChildForm.getLength();j++) { 
			...
			for(int k = 0; k < subXmlElChildMan.getLength();k++) {  
				...
				if (strDatCd.equals("G0018")) {
					...
					yetaPayr3200Service.yeta3200_PDF_J301Y_2018_Delete(yetaPdfJ301yVo);
					yetaPayr3200Service.yeta3200_PDF_J301Y_2018_Insert(yetaPdfJ301yVo);
				}
	...
	public static void func_2018_J301Y_YetaCalc(InfcPkgYe161010_2018_VO ye161010VO, HttpServletRequest request) throws Exception{ 
		...
		InfcPkgYe162030_2018_VO infcPkgYe162030Vo = new InfcPkgYe162030_2018_VO();
		...
		//주택마련
		yetaPayr3200Service.PdfYeta3200_J301Y_YE162030_Delete(infcPkgYe162030Vo); 
		yetaPayr3200Service.PdfYeta3200_J301Y_YE162030_Insert(infcPkgYe162030Vo); 
		...
		// 주택마련 합계  
         yetaPayr3200Service.fnYeta3200_J301Y_YE161070_2018_Update(infcPkgYe161070Vo); 
