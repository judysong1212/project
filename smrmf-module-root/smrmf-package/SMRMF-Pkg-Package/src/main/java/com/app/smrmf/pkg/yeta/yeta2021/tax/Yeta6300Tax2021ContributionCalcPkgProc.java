...
@Controller 
public class Yeta6300Tax2021ContributionCalcPkgProc  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta6300Tax2021ContributionCalcPkgProc.class);
	   
    @Resource(name = "Yeta6300PayrService")
    protected Yeta6300PayrService  infcPkgYeta6300;
    
 
    public Yeta6300Tax2021ContributionCalcPkgProc() {
    	
    } 
    
    public List<ShowMessageBM> execTax_2021_Contribution_Calc(HttpServletRequest request, InfcPkgYe161010_2021_VO  infcPkgYe161010Vo)  throws Exception  {
  	    
	  	  return  fnTax_2021_Contribution_Calc(request,  infcPkgYe161010Vo);
	}
    ...
    * @throws Exception
    */
    private  List<ShowMessageBM> fnTax_2021_Contribution_Calc(HttpServletRequest request, InfcPkgYe161010_2021_VO  infcPkgYe161010Vo) throws Exception {
      ...
      BigDecimal bgYetaAllSumSe = BigDecimal.ZERO;  //세액합계금액 
		...
		//	BeanUtils.copyProperties(infcPkgYe165030Vo, infcPkgYe161010Vo);
            ...
            // {2011-추가기능 시작 } 
             ...
             List listYetaGibu = infcPkgYeta6300.fnYeta6300_YE169010_Tax_2021_1001_Select(infcPkgYe169010Vo); 
             ...
             if  (listYetaGibu.size() > 0) {
            	   ...
            	   Iterator<Map<String, Object>> iter = listYetaGibu.iterator(); 
		            ...
		            while ( iter.hasNext() ) { 
                     ...
                     InfcPkgYe165030Srh_2021_VO infcPkgYe165030SrhVo =  new InfcPkgYe165030Srh_2021_VO(); 
                     ...
                     List listYe165030 = infcPkgYeta6300.fnPayr06430_PAYR442_ReTax_2021_SelectFind(infcPkgYe165030SrhVo);
                    	...
                    	/**********************************************************************************************************
                     	 ...
                     	 ***********************************************************************************************************/
                     	 for(int iCnt = 0; iCnt < listYe165030.size();iCnt++) {
                     		 ...
                     		 InfcPkgYe165030_2021_VO infcPkgOrgYe165030Vo =  new InfcPkgYe165030_2021_VO();
                     		 InfcPkgYe165030_2021_VO upInfcPkgYe165030Vo =  new InfcPkgYe165030_2021_VO(); 
                           		 ...
                           		 if (mTemp10Data20.compareTo(BigDecimal.ZERO) <= 0)  { 
										   ...
										   upInfcPkgYe165030Vo.setThcYrNducCrfwAmt(BigDecimal.ZERO);    /** column 해당년도_미공제이월금액 : ayyrNtam */
		                                    ...
		                                    // {
		                                     ...
		                                     statCnt = 0;
		                     		  		 statCnt =  infcPkgYeta6300.fnPayr06430_PAYR442_ReTax_2021_Update(upInfcPkgYe165030Vo);  
                       	 ...
                       	 ***********************************************************************************************************/
                			...
                			infcPkgOrgYe165030Vo.setSpciDdctCheck(infcPkgYe161010Vo.getSpciDdctCheck());   
                       		...
                       		if (infcPkgOrgYe165030Vo.getAttrYr().equals("2021"))  {
                       			upInfcPkgYe165030Vo  = insertYeYe165030(infcPkgOrgYe165030Vo,upInfcPkgYe165030Vo,bgSPCI_FBTG21_10,bgSPCI_FBSE21_10,BigDecimal.ZERO);
		                        statCnt = 0;
		                      	statCnt =  infcPkgYeta6300.fnPayr06430_PAYR442_ReTax_2021_Update(upInfcPkgYe165030Vo);
                       		  if (statCnt >= 0) { 
     ...
     * @return
     */
    private InfcPkgYe165030_2021_VO insertYeYe165030(InfcPkgYe165030_2021_VO infcPkgOrgYe165030Vo, InfcPkgYe165030_2021_VO upInfcPkgYe165030Vo,BigDecimal bgSPCI_FBTG17_10 ,BigDecimal bgSPCI_FBSE17_10,BigDecimal orgSanChul) {
