...
public class Func2022_Pdf_D101Y {
	...
	public static void func_2022_D101Y_D101M(InfcPkgYe161010_2022_VO ye161010VO, Element  subXmlElForm, String nResult, HttpServletRequest request ) throws Exception{
		...
		InfcPkgPdfD101y_2022_VO yetaPdfD101yVo = new InfcPkgPdfD101y_2022_VO();
		InfcPkgPdfD101m_2022_VO yetaPdfD101mVo = new InfcPkgPdfD101m_2022_VO();
		...
		for (int j = 0; j < subXmlElChildForm.getLength();j++) { 
			...
			for(int k = 0; k < subXmlElChildMan.getLength();k++) {  
				...
				if (strDatCd.equals("G0009")) {
					...
					yetaPayr3200Service.yeta7200_PDF_D101Y_2022_Delete(yetaPdfD101yVo);
					yetaPayr3200Service.yeta7200_PDF_D101Y_2022_Insert(yetaPdfD101yVo);
				}
			}
	...
	public static void func_2022_D101Y_YetaCalc(InfcPkgYe161010_2022_VO ye161010VO, HttpServletRequest request) throws Exception{ 
		...
		//개인연금저축 
		yetaPayr3200Service.PdfYeta7200_D101Y_YE162010_Delete(infcPkgYe162010Vo); 
		yetaPayr3200Service.PdfYeta7200_D101Y_YE162010_Insert(infcPkgYe162010Vo); 
		...
		// 개인연금저축금액합계
         yetaPayr3200Service.fnYeta7200_D101Y_YE161070_2022_Update(infcPkgYe161070Vo); 
