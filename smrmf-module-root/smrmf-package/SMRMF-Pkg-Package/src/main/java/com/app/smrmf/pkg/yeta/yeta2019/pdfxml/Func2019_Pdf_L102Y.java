...
import com.app.smrmf.infc.yearendtax.server.vo.yeta2019.InfcPkgPdfL102d_2019_VO;
...
public class Func2019_Pdf_L102Y {
	...
	public static void func_2019_L102Y_L102D(InfcPkgYe161010_2019_VO ye161010VO, Element  subXmlElForm, String nResult, HttpServletRequest request) throws Exception{
		...
		InfcPkgPdfL102y_2019_VO yetaPdfL102yVo = new InfcPkgPdfL102y_2019_VO();
		InfcPkgPdfL102d_2019_VO yetaPdfL102dVo = new InfcPkgPdfL102d_2019_VO();
		...
		yetaPayr3200Service.yeta4200_PDF_L102Y_2019_Delete(yetaPdfL102yVo);
		...
		for (int j = 0; j < subXmlElChildForm.getLength();j++) { 
			...
			for(int k = 0; k < subXmlElChildMan.getLength();k++) {  
				...
				if (strDatCd.equals("G0020")) {
					...
					yetaPayr3200Service.yeta4200_PDF_L102Y_2019_Insert(yetaPdfL102yVo);
				}
	...
	public static void func_2019_L102Y_YetaCalc(InfcPkgYe161010_2019_VO ye161010VO, HttpServletRequest request) throws Exception{ 
		...
		InfcPkgYe165010_2019_VO infcPkgYe165010Vo = new InfcPkgYe165010_2019_VO();
		...
		//기부금
		yetaPayr3200Service.PdfYeta4200_L102Y_YE165010_Delete(infcPkgYe165010Vo); 
		yetaPayr3200Service.PdfYeta4200_L102Y_YE165010_Insert(infcPkgYe165010Vo); 
		 
		
		
		InfcPkgYe165020_2019_VO infcPkgYe165020Vo = new InfcPkgYe165020_2019_VO();
		...
		//기부금
		yetaPayr3200Service.PdfYeta4200_L102Y_YE165020_Delete(infcPkgYe165020Vo); 
		yetaPayr3200Service.PdfYeta4200_L102Y_YE165020_Insert(infcPkgYe165020Vo);
		
		
        InfcPkgYe165030_2019_VO infcPkgYe165030Vo = new InfcPkgYe165030_2019_VO();
		...
		//기부금
		yetaPayr3200Service.PdfYeta4200_L102Y_YE165030_Delete(infcPkgYe165030Vo); 
		yetaPayr3200Service.PdfYeta4200_L102Y_YE165030_Insert(infcPkgYe165030Vo);
		...
		yetaPayr3200Service.fnYeta4200_L102Y_YE161040_2019_Update(infcPkgYe161040Vo); 
		
		//기부금
		InfcPkgYe161080_2019_VO infcPkgYe161080Vo = new InfcPkgYe161080_2019_VO();
		...
		// 기부금 합계  
         yetaPayr3200Service.fnYeta4200_L102Y_YE161080_2019_Update(infcPkgYe161080Vo); 
     
         
         
       //이월기부금처리 
 		InfcPkgYe161060_2019_VO infcPkgYe161060Vo = new InfcPkgYe161060_2019_VO();
 		...
 		// 기부금 합계  
          yetaPayr3200Service.fnYeta4200_L102Y_YE161060_2019_Update(infcPkgYe161060Vo); 
