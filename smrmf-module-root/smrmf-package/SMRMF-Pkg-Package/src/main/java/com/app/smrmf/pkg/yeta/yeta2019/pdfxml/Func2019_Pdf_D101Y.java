...
public class Func2019_Pdf_D101Y {
	...
	public static void func_2019_D101Y_D101M(InfcPkgYe161010_2019_VO ye161010VO, Element  subXmlElForm, String nResult, HttpServletRequest request ) throws Exception{
		...
		InfcPkgPdfD101y_2019_VO yetaPdfD101yVo = new InfcPkgPdfD101y_2019_VO();
		InfcPkgPdfD101m_2019_VO yetaPdfD101mVo = new InfcPkgPdfD101m_2019_VO();
		...
		for (int j = 0; j < subXmlElChildForm.getLength();j++) { 
			...
			for(int k = 0; k < subXmlElChildMan.getLength();k++) {  
				...
				if (strDatCd.equals("G0009")) {
					...
					yetaPayr3200Service.yeta4200_PDF_D101Y_2019_Delete(yetaPdfD101yVo);
					yetaPayr3200Service.yeta4200_PDF_D101Y_2019_Insert(yetaPdfD101yVo);
				}
			}
	...
	public static void func_2019_D101Y_YetaCalc(InfcPkgYe161010_2019_VO ye161010VO, HttpServletRequest request) throws Exception{ 
		...
		//개인연금저축 
		yetaPayr3200Service.PdfYeta4200_D101Y_YE162010_Delete(infcPkgYe162010Vo); 
		yetaPayr3200Service.PdfYeta4200_D101Y_YE162010_Insert(infcPkgYe162010Vo); 
		...
		// 교육비 합계  
         yetaPayr3200Service.fnYeta4200_D101Y_YE161070_2019_Update(infcPkgYe161070Vo); 
