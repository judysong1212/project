 ...
 */
@Controller 
public class Yeta2300SubtTaxWkerAmntPkgProc  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta2300SubtTaxWkerAmntPkgProc.class);
	   
    @Resource(name = "Yeta2300PayrService")
    protected Yeta2300PayrService  infcPkgYeta2300;
    
 
    public Yeta2300SubtTaxWkerAmntPkgProc() {
    	
    } 
    
    public List<ShowMessageBM> execSubtTaxWkerAmntPkgProc(HttpServletRequest request,InfcPkgYe161010VO  infcPkgYe161010Vo)  throws Exception  {
     ...
     * @throws Exception
     */
    private  List<ShowMessageBM>  YetaTaxWkerAmntUpdate(HttpServletRequest request,InfcPkgYe161010VO  infcPkgYe161010Vo) throws Exception {
      ...
      //    /* (97) column 차감소득금액 : SUBT_ERAM */  
  	      ...
  	      *******************************************************************************************/  
  		      InfcPkgYe169010VO wkInfcPkgYe169010Vo = new InfcPkgYe169010VO();  //연말정산결과  
  		      InfcPkgYe169010VO tpWkInfcPkgYe169010Vo = new InfcPkgYe169010VO();  //연말정산결과  
  		    ...
  		    tpWkInfcPkgYe169010Vo = infcPkgYeta2300.fnYeta2300_YE169010_Tax_2017_2001_Select(wkInfcPkgYe169010Vo); 
...
//  		    	wkInfcPkgYe169010Vo.setSpciOyam(exSPCI_OYAM);  // SPCI_OYAM	이월종교단체기부금	153		                        
  		        ...
  		        statCnt = 0;
  			  	statCnt =  infcPkgYeta2300.fnYeta2300_YE169010_Tax_2017_2003_Select(wkInfcPkgYe169010Vo); 
