...
public class Func_Pdf_C101Y {
	...
	public static void func_2017_C101Y_C101M(InfcPkgYe161010VO ye161010VO, Element  subXmlElForm, String nResult , HttpServletRequest request) throws Exception{
		...
		InfcPkgPdfC101yVO yetaPdfC101yVo = new InfcPkgPdfC101yVO();
		InfcPkgPdfC101mVO yetaPdfC101mVo = new InfcPkgPdfC101mVO();
		...
		yetaPayr2200Service.yeta2200_PDF_C101Y_2017_Delete(yetaPdfC101yVo);
...
//					}
	...
	public static void setPdfC101yVo(InfcPkgPdfC101yVO yetaPdfC101yVo , HttpServletRequest request) throws Exception{
		...
		yetaPayr2200Service.yeta2200_PDF_C101Y_2017_Insert(yetaPdfC101yVo);
	 ...
	 * </pre>
	 * @Method Name : func_2017_C102Y_YetaCalc
	 * @date : 2018. 1. 23.
	 * @author : atres
	 * @history : 
	 *	-----------------------------------------------------------------------
	 ...
	 * @throws Exception
	 */
	public static void func_2017_C101Y_YetaCalc(InfcPkgYe161010VO ye161010VO, HttpServletRequest request) throws Exception{ 
      ...
      //   G0007 교육비-기타 본인+가족 개별제출
		...
		//교육비 
		yetaPayr2200Service.PdfYeta2200_C101Y_YE161090_Delete(infcPkgYe161090Vo); 
		yetaPayr2200Service.PdfYeta2200_C101Y_YE161090_Insert(infcPkgYe161090Vo); 
