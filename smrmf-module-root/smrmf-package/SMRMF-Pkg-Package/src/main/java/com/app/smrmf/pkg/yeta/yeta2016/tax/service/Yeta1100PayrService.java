package com.app.smrmf.pkg.yeta.yeta2016.tax.service;
 ...
 */
public interface Yeta1100PayrService {
	 ...
	 * @throws Exception
	 */
	String fnYeta1100_YETA1000_2016_CREATE_Insert(InfcPkgYeta1000VO  vo) throws Exception;
   
	/** 연말정산 마감 정보를 가져온다. **/
	InfcPkgYeta1000VO selectYeta1100ToCreateYetaPrc1000(InfcPkgYeta1000VO  vo) throws Exception;
	...
	* @throws Exception
	*/
	//String fnYeta1100_YE160401_2016_CREATE_Insert(InfcPkgYe160401VO yePrc160401Vo) throws Exception;  
   ...
   * @throws Exception
   */
  String fnYeta1100_YETA2000_2016_CREATE_Insert(InfcPkgYeta2000VO yetaPrc2000Vo) throws Exception;
   ...
   * 
   * <pre>
   * 1. 개요 : 연말정산 기본 과세 감면 생성  
   * 2. 처리내용 : 
   * </pre>
   * @Method Name : fnYeta1100_YE160402_2016_CREATE_Insert
   * @date : Jan 21, 2016
   * @author : leeheuisung
   * @history : 
   *	-----------------------------------------------------------------------
   ...
   * @throws Exception
   */
  String fnYeta1100_YE160402_2016_CREATE_Insert(InfcPkgYeta2000VO yetaPrc2000Vo) throws Exception;  
   ...
   * 2. 처리내용 : 
   * </pre>
   * @Method Name : fnYeta1100_YE160403_2016_CREATE_Insert
   * @date : Jan 21, 2016
   * @author : leeheuisung
   * @history : 
   *	-----------------------------------------------------------------------
   ...
   * @throws Exception
   */
  String fnYeta1100_YE160403_2016_CREATE_Insert(InfcPkgYeta2000VO yetaPrc2000Vo) throws Exception;  
   ...
   * 2. 처리내용 : 
   * </pre>
   * @Method Name : fnYeta1100_YETA3220_2016_CREATE_Insert
   * @date : Jan 21, 2016
   * @author : leeheuisung
   * @history : 
   *	-----------------------------------------------------------------------
   ...
   * @throws Exception
   */
  String fnYeta1100_YETA3220_2016_CREATE_Insert(InfcPkgYeta2000VO yetaPrc2000Vo) throws Exception;  
   ...
   * 2. 처리내용 : 
   * </pre>
   * @Method Name : fnYeta1100_YETA3220_2016_INSU_FETC_Update
   * @date : Jan 25, 2016
   * @author : leeheuisung
   * @history : 
   *	-----------------------------------------------------------------------
   ...
   * @throws Exception
   */
  void fnYeta1100_YETA3220_2016_INSU_FETC_Update(InfcPkgYeta2000VO yetaPrc2000Vo) throws Exception;
   ...
   * 2. 처리내용 : 
   * </pre>
   * @Method Name : fnYeta1100_YETA3220_2016_CREATE_Update
   * @date : Jan 25, 2016
   * @author : leeheuisung
   * @history : 
   *	-----------------------------------------------------------------------
   ...
   * @throws Exception
   */
  void fnYeta1100_YETA3220_2016_CREATE_Update(InfcPkgYeta2000VO yetaPrc2000Vo) throws Exception; 
   ...
   * 2. 처리내용 : 
   * </pre>
   * @Method Name : fnYeta1100_YETA3190_2016_CREATE_Insert
   * @date : Jan 25, 2016
   * @author : leeheuisung
   * @history : 
   *	-----------------------------------------------------------------------
   ...
   * @throws Exception
   */
  String fnYeta1100_YETA3190_2016_CREATE_Insert(InfcPkgYeta2000VO yetaPrc2000Vo) throws Exception; 
   ...
   * @throws Exception
   */
	String fnYeta1100_YETA3000_2016_CREATE_Insert(InfcPkgYeta2000VO yetaPrc2000Vo) throws Exception; 
	 ...
	 * @throws Exception
	 */
	// {******************************급여자료 이관 - 연말정산 기본 업데이트   [2]*******************************************}
	String fnYeta1100_YE160401_PAYR_2016_CREATE_Insert(InfcPkgYe160401VO yePrc160401Vo) throws Exception; 
	
	
	// {******************************급여자료 이관 - 연말정산 기본 업데이트   [3]*******************************************}
	void fnYeta1100_YETA2000_PAYR_2016_CREATE_Update(InfcPkgYe160401VO yePrc160401Vo) throws Exception;  
	
	
	//{과세 감면 인서트 }
    //{**************************연말정산기본 과세 감면 업데이트   [4 - 1]********************************} 
	void fnYeta1100_YE160402_PAYR_2016_CREATE_Insert(InfcPkgYe160402VO yePrc160402Vo) throws Exception;   
  
  
	//{비과세 감면 인서트 }
	//{**************************연말정산기본 과세 감면 업데이트   [4 - 2]********************************} 
	void fnYeta1100_YE160403_PAYR_2016_CREATE_Insert(InfcPkgYe160403VO yePrc160403Vo) throws Exception;   
  
	
	
	// {******************************급여자료 이관 - 연말정산 YETA3000 업데이트   [5]*******************************************}
    //YETA3000 업데이트
	void fnYeta1100_YETA3000_PAYR_2016_CREATE_Update(InfcPkgYe160401VO yePrc160401Vo) throws Exception;   
...
//   // {******************************급여자료 이관 - 연말정산 업데이트   [3]*******************************************}
// 
//   void fnPayr06520_PAYR415_2015_CREATE1_Update(InfcPkgYeta2000VO infcPkgYeta2000Vo) throws Exception;  
// 	  //{비과세 감면 인서트 }
//     //{**************************연말정산기본 비과세 감면 업데이트   [4]********************************} 
//	  	        
// 	   void fnPayr06420_YETA3200_2015_CREATE1_Update(InfcPkgYeta2000VO infcPkgYeta2000Vo) throws Exception;   
//    
//  // {******************************급여자료 이관 - 연말정산 425 업데이트   [4]*******************************************}
//    //425 업데이트
//	  void fnPayr06530_PAYR425_2015_CREATE1_Update(InfcPkgYeta2000VO infcPkgYeta2000Vo) throws Exception; 
//	  
//	  
//   /**
//    * 
...
//   
//   InfcPkgYeta1000VO selectYeta0100ToChkYetaPrc1000(InfcPkgYeta1000VO  vo) throws Exception;
//      
//   
//   
//    
