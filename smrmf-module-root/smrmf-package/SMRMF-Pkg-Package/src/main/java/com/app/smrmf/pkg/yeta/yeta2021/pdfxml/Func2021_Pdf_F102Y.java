...
public class Func2021_Pdf_F102Y {
	...
	private static final Logger logger = LoggerFactory.getLogger(Func2021_Pdf_F102Y.class);

	public static void func_2021_F102Y_F102M(InfcPkgYe161010_2021_VO ye161010VO, Element  subXmlElForm, String nResult , HttpServletRequest request ) throws Exception{
		...
		InfcPkgPdfF102y_2021_VO yetaPdfF102yVo = new InfcPkgPdfF102y_2021_VO();
		InfcPkgPdfF102m_2021_VO yetaPdfF102mVo = new InfcPkgPdfF102m_2021_VO();
		...
		for (int j = 0; j < subXmlElChildForm.getLength();j++) { 
			...
			for(int k = 0; k < subXmlElChildMan.getLength();k++) {  
				...
				if (strDatCd.equals("G0011")) {
					...
					yetaPayr3200Service.yeta6200_PDF_F102Y_2021_Delete(yetaPdfF102yVo);
					
					yetaPayr3200Service.yeta6200_PDF_F102Y_2021_Insert(yetaPdfF102yVo);
				}
			}
	...
	public static void func_2021_F102Y_YetaCalc(InfcPkgYe161010_2021_VO ye161010VO, HttpServletRequest request) throws Exception{ 
		...
		InfcPkgYe162020_2021_VO infcPkgYe162020Vo = new InfcPkgYe162020_2021_VO();
		...
		//퇴직연금
		yetaPayr3200Service.PdfYeta6200_F102Y_YE162020_Delete(infcPkgYe162020Vo); 
		yetaPayr3200Service.PdfYeta6200_F102Y_YE162020_Insert(infcPkgYe162020Vo); 
		...
		// 퇴직연금 합계  
         yetaPayr3200Service.fnYeta6200_F102Y_YE161080_2021_Update(infcPkgYe161080Vo); 
...
//		
//		yetaPayr3200Service.yeta3200_PDF_YE162015_2021_Insert(ye161010VO);
