...
@Controller 
public class Yeta4300IncDdcPkgProc  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta4300PkgProcContainer.class);
	   
    
    @Resource(name = "Yeta4300IncDdcService")
    protected Yeta4300IncDdcService  incDdcService;
    
    public Yeta4300IncDdcPkgProc() {
     ...
     * @throws Exception
     */
    public PagingLoadResult<ShowMessageBM> funcYeta4300IncDdcPkgProc(HttpServletRequest request,InfcPkgYe161010_2019_VO  ye161010VO,String serviceDiv)  throws Exception  {
  	    
	  	  return  funcYeta4300YetaTableCalcUpdate(request,  ye161010VO,serviceDiv);
	}
     ...
     * 2. 처리내용 : 
     * </pre>
     * @Method Name : funcYeta4300YetaTableCalcUpdate
     * @date : 2019. 1. 31.
     * @author : atres
     * @history : 
     *	-----------------------------------------------------------------------
     ...
     * @throws Exception
     */
    private PagingLoadResult<ShowMessageBM> funcYeta4300YetaTableCalcUpdate(HttpServletRequest request, InfcPkgYe161010_2019_VO ye161010VO,String serviceDiv)  throws Exception  {
    	
  	    PagingLoadResult<ShowMessageBM> retval = null; 
	    List<ShowMessageBM>  bmResult = new ArrayList<ShowMessageBM>();
	    MSFSysm0100BM sessionUser = MSFServerUtils.getLoggedUser(request);
	   
	    incDdcService = (Yeta4300IncDdcService)BeanFinder.getBean("Yeta4300IncDdcService");
    ...
    try { 
		...
		if ("YE161030".equals(serviceDiv)) {
			...
			infcPkgYe169010Vo.setRevnAddr(RemoteServiceUtil.getThreadLocalRequest().getRemoteHost());
  			...
  			statCnt = 0;
  			statCnt = incDdcService.incDdcYeta4300_YE169010_Tax_2019_06_Update(infcPkgYe169010Vo);  
  				
  			if (statCnt >= 0) {  
  				 
  				incDdcService.incDdcYeta4100_YE161030_2019_CREATE_Update(infcPkgYe161030Vo); 
    		  ...
    		  //40업데이트   
    			...
    			statCnt = 0;
    			statCnt = incDdcService.incDdcYeta2019_B101Y_YE161040_Update(infcPkgYe161040Vo);  
    				
    			if (statCnt >= 0) { 
    				// 의료비정리 합계  
    				incDdcService.incDdcYeta2019_YE161080_2019_Update(infcPkgYe161080Vo); 
    		  ...
    		  //교육비
    		    ...
    		    statCnt =  incDdcService.incDdcYeta2019_C101Y_YE161040_Update(infcPkgYe161040Vo); 
    			 
    			if (statCnt >= 0) { 
    				// 교육비 합계  
    				incDdcService.incDdcYeta2019_C101Y_YE161080_2019_Update(infcPkgYe161080Vo); 
    		  ...
    		  //기부금 
    			...
    			dataCheck = "";
    			//기부금
    			incDdcService.incDdcYeta2019_L102Y_YE165020_Delete(infcPkgYe165020Vo); 
    			dataCheck = incDdcService.incDdcYeta2019_L102Y_YE165020_Insert(infcPkgYe165020Vo);
    			...
    			if (MSFSharedUtils.paramNull(dataCheck)) {
		    			...
		    			//기부금
		    			dataCheck = "";
		    			incDdcService.incDdcYeta2019_L102Y_YE165030_Delete(infcPkgYe165030Vo); 
		    			dataCheck =  incDdcService.incDdcYeta2019_L102Y_YE165030_Insert(infcPkgYe165030Vo);
		    			
		    			if (MSFSharedUtils.paramNull(dataCheck)) {		  
		    			// 기부금 합계  
		    			 statCnt = 0;
		    			 incDdcService.incDdcYeta2019_L102Y_YE161040_2019_Update(infcPkgYe161040Vo); 
		    			 statCnt = incDdcService.incDdcYeta2019_L102Y_YE161080_2019_Update(infcPkgYe161080Vo);  
		    			 
		    				if (statCnt >= 0) { 	  
				    	 		 				 
				    	 		// 기부금 합계  
		    					incDdcService.incDdcYeta2019_L102Y_YE161060_2019_Update(infcPkgYe161060Vo); 
    		  ...
    		  //연금저축계좌  
    		  incDdcService.incDdcYeta2019_D101Y_YE161070_2019_Update(infcPkgYe161070Vo);  
    			// 교육비 합계  
    		  incDdcService.incDdcYeta2019_E102Y_YE161080_2019_Update(infcPkgYe161080Vo); 
    	           //퇴직연금
    		  incDdcService.incDdcYeta2019_F102Y_YE161080_2019_Update(infcPkgYe161080Vo); 
    	        //주택마련저축 
    		  incDdcService.incDdcYeta2019_J301Y_YE161070_2019_Update(infcPkgYe161070Vo); 
    	        
    		  incDdcService.incDdcYeta2019_N101Y_YE161070_2019_Update(infcPkgYe161070Vo); 
    	        
    	  } else if ("YE162510".equals(serviceDiv)) {	  
    		  //월세액소득공제명세 
//    		  incDdcService.incDdcYeta2019_YE162510_YE161070_2019_Update(infcPkgYe161070Vo ); 
    		  ...
    		  // 55데이타을 50으로 공적보험료공제 
    		  incDdcService.incDdcYeta2019_YE161055_2019_Update(infcPkgYe161050Vo); 
    		  
    		  
    		  incDdcService.delete_YETA3300_2019_Ye161055(infcPkgYe161055Vo); 
    		  incDdcService.insert_YETA3300_2019_Ye161055(infcPkgYe161055Vo); 
    		
    			
    		  // 소득공제 수정 시 연금보험료공제 합계 반영
    		  incDdcService.incDdcYeta2019_YE161050_2019_Update(infcPkgYe161050Vo); 
    		...
    		//신용카드
    		incDdcService.incDdcYeta2019_G107Y_YE166020_Update(infcPkgYe166020Vo);    
    				
    		// 신용카드  
    		incDdcService.incDdcYeta2019_G107Y_YE161070_2019_Update(infcPkgYe161070Vo);  
    		    	
    			   				 
    		// 현금영수증  
    		incDdcService.incDdcYeta2019_G207Y_YE161070_2019_Update(infcPkgYe161070Vo); 
    		   	 
    		// 직불카드  
    		incDdcService.incDdcYeta2019_G307Y_YE161070_2019_Update(infcPkgYe161070Vo); 
	    
    		// 제로페이  
    		incDdcService.incDdcYeta2019_G407Y_YE161070_2019_Update(infcPkgYe161070Vo); 
	    
  	    } else if ("YE166020_DELETE".equals(serviceDiv)) {	
    		  
  	    	//신용카드
			incDdcService.incDdcYeta2019_G107Y_YE166020_Delete(infcPkgYe166020Vo);    
...
//				infcPkgYe166020Vo.setRevnAddr(RemoteServiceUtil.getThreadLocalRequest().getRemoteHost());    							/** column 수정주소 : revnAddr */
				...
				// 삭제루틴 추가 
				incDdcService.incDdcYeta2019_YE166020_2019_CREATE_Delete(infcPkgYe166020Vo); 
				
				dataCheck = "";
				dataCheck = incDdcService.incDdcYeta2019_YE166020_2019_CREATE_Insert(infcPkgYe166020Vo);   
				...
				if (MSFSharedUtils.paramNull(dataCheck)) { 
					...
					logger.debug("5. 신용카드 INSERT 종료 "); 
						...
						// 삭제루틴 추가 
						incDdcService.incDdcYeta2019_YE166010_2019_CREATE_Delete(infcPkgYe166010Vo); 
						dataCheck = "";
						dataCheck = incDdcService.incDdcYeta2019_YE166010_2019_CREATE_Insert(infcPkgYe166010Vo);   //infcPkgYeta4220Vo   
    	...
    	//공통 60/70/80 업데이트 
  		   //보험료 합산금액 넣기   보장성보험 
    	    statCnt =  incDdcService.incDdcYeta2019_A102Y_YE161080_2019_Update(infcPkgYe161080Vo); 
			if (statCnt >= 0) { 
				 statCnt = 0;
				 //가족사항 업데이트 410 고용/건강보험료외 업데이트 종근무지데이타
				statCnt =  incDdcService.incDdcYeta2019_YE161040_2019_INSU_FETC01_Update(infcPkgYe161060Vo); 
				
				if (statCnt >= 0) { 
					
				statCnt = 0;
				 //보험료 종료4대보험 업데이트 
				  statCnt =  incDdcService.incDdcYeta2019_YE161040_2019_INSU_FETC_Update(infcPkgYe161040Vo); 
				  
//		    	  if (statCnt >= 0) { 
		    		  statCnt = 0;
		    		  //합계로직추가 
						  statCnt =  incDdcService.incDdcYeta2019_All_YE161060_2019_Update(infcPkgYe161060Vo); 
						 // if (statCnt >= 0) {
							  statCnt = 0; 
							  statCnt = incDdcService.incDdcYeta2019_All_YE161070_2019_Update(infcPkgYe161070Vo); 
					    	//  if (statCnt >= 0) {
							  
					    		  statCnt = 0; 
								  statCnt =  incDdcService.incDdcYeta2019_All_YE161080_2019_Update(infcPkgYe161080Vo); 
