 ...
 */
@Controller 
public class Yeta5300SubtTaxWkerAmntPkgProc  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta5300SubtTaxWkerAmntPkgProc.class);
	   
    @Resource(name = "Yeta5300PayrService")
    protected Yeta5300PayrService  infcPkgYeta5300;
    
 
    public Yeta5300SubtTaxWkerAmntPkgProc() {
    	
    } 
    
    public List<ShowMessageBM> execSubtTaxWkerAmntPkgProc(HttpServletRequest request,InfcPkgYe161010_2020_VO  infcPkgYe161010Vo)  throws Exception  {
     ...
     * @throws Exception
     */
    private  List<ShowMessageBM>  YetaTaxWkerAmntUpdate(HttpServletRequest request,InfcPkgYe161010_2020_VO  infcPkgYe161010Vo) throws Exception {
      ...
      //    /* (97) column 차감소득금액 : SUBT_ERAM */  
  	      ...
  	      *******************************************************************************************/  
  		      InfcPkgYe169010_2020_VO wkInfcPkgYe169010Vo = new InfcPkgYe169010_2020_VO();  //연말정산결과  
  		      InfcPkgYe169010_2020_VO tpWkInfcPkgYe169010Vo = new InfcPkgYe169010_2020_VO();  //연말정산결과  
  		    ...
  		    tpWkInfcPkgYe169010Vo = infcPkgYeta5300.fnYeta5300_YE169010_Tax_2020_2001_Select(wkInfcPkgYe169010Vo); 
				...
				wkInfcPkgYe169010Vo.setYeta0c94(exSPCI_OBAM);    /** column C94_특별소득공제_기부금_이월분금액 : yeta0c94 */
  		        ...
  		        statCnt = 0;
  			  	statCnt =  infcPkgYeta5300.fnYeta5300_YE169010_Tax_2020_2003_Select(wkInfcPkgYe169010Vo); 
