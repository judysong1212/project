...
import com.app.smrmf.infc.yearendtax.server.vo.yeta2022.InfcPkgPdfN101m_2022_VO;
...
public class Func2022_Pdf_N101Y {
	...
	public static void func_2022_N101Y_N101M(InfcPkgYe161010_2022_VO ye161010VO, Element  subXmlElForm, String nResult, HttpServletRequest request) throws Exception{
		...
		InfcPkgPdfN101y_2022_VO yetaPdfN101yVo = new InfcPkgPdfN101y_2022_VO();
		InfcPkgPdfN101m_2022_VO yetaPdfN101dVo = new InfcPkgPdfN101m_2022_VO();
		...
		for (int j = 0; j < subXmlElChildForm.getLength();j++) { 
			...
			for(int k = 0; k < subXmlElChildMan.getLength();k++) {  
				...
				if (strDatCd.equals("G0029")) {
					...
					//2022년 연말정산_추가
					yetaPdfN101yVo.setCtrTermMmCnt(new BigDecimal(MSFSharedUtils.defaultNulls(PkgFuncUtils.getXmlTagValue("ctr_term_mm_cnt", subXmlElData),"0")));
					
					yetaPayr3200Service.yeta7200_PDF_N101Y_2022_Delete(yetaPdfN101yVo);
					yetaPayr3200Service.yeta7200_PDF_N101Y_2022_Insert(yetaPdfN101yVo);
					
					//2022년 연말정산_추가
				} else if (strDatCd.equals("G0043")) {
					yetaPdfN101yVo.setDatCd(MSFSharedUtils.allowNulls(strDatCd));
					yetaPdfN101yVo.setBusnid(subXmlElData.getAttribute("busnid"));			//사업자번호
					yetaPdfN101yVo.setTradeNm(subXmlElData.getAttribute("trade_nm"));	//상호명		
					yetaPdfN101yVo.setSecuNo(subXmlElData.getAttribute("secu_no"));
	...
	public static void func_2022_N101Y_YetaCalc(InfcPkgYe161010_2022_VO ye161010VO, HttpServletRequest request) throws Exception{ 
       ...
       //Y0040110	B011	0110	장기집합투자증권저축					51
		...
		InfcPkgYe162040_2022_VO infcPkgYe162040Vo = new InfcPkgYe162040_2022_VO();
		...
		//장기집합 투자 증권
		yetaPayr3200Service.PdfYeta7200_N101Y_YE162040_Delete(infcPkgYe162040Vo); 
		yetaPayr3200Service.PdfYeta7200_N101Y_YE162040_Insert(infcPkgYe162040Vo); 
		...
		// 장기집합 투자 증권 합계  
         yetaPayr3200Service.fnYeta7200_N101Y_YE161070_2022_Update(infcPkgYe161070Vo); 
