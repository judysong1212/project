...
public class Func2019_Pdf_B101Y {
	...
	public static void func_2019_B101Y_B101D(InfcPkgYe161010_2019_VO ye161010VO, Element  subXmlElForm, String nResult, HttpServletRequest request) throws Exception{
		...
		InfcPkgPdfB101y_2019_VO yetaPdfB101yVo = new InfcPkgPdfB101y_2019_VO();
		InfcPkgPdfB101d_2019_VO yetaPdfB101dVo = new InfcPkgPdfB101d_2019_VO();
		...
		yetaPayr3200Service.yeta4200_PDF_B101Y_2019_Delete(yetaPdfB101yVo);
		...
		for (int j= 0;j < subXmlElChildForm.getLength();j++)  {
			...
			for(int k = 0; k < subXmlElChildMan.getLength();k++) {  
				...
				if (strDatCd.equals("G0003")) { //의료비
					...
					yetaPayr3200Service.yeta4200_PDF_B101Y_2019_Insert(yetaPdfB101yVo);
				} 
	 ...
	 * </pre>
	 * @Method Name : func_2019_B101Y_YetaCalc
	 * @date : 2019. 1. 23.
	 * @author : atres
	 * @history : 
	 *	-----------------------------------------------------------------------
	 ...
	 * @throws Exception
	 */
	public static void func_2019_B101Y_YetaCalc(InfcPkgYe161010_2019_VO ye161010VO, HttpServletRequest request) throws Exception{ 
        ...
        //의료비시작
        //의료비 . 기본내역 (B01의료비 ) B03,B04,B05
		InfcPkgYe164010_2019_VO infcPkgYe164010Vo = new InfcPkgYe164010_2019_VO();
		...
		//의료보험 국세청 데이타 업데이트 
		yetaPayr3200Service.PdfYeta4200_B101Y_YE164010_Delete(infcPkgYe164010Vo); 
		yetaPayr3200Service.PdfYeta4200_B101Y_YE164010_Insert(infcPkgYe164010Vo); 
		...
		statCnt = yetaPayr3200Service.PdfYeta2019_B101Y_YE161040_Update(infcPkgYe161040Vo); 
		...
		if (statCnt >= 0) { 
			...
			// 의료비정리 합계  
	         yetaPayr3200Service.fnYeta4200_B101Y_YE161080_2019_Update(infcPkgYe161080Vo); 
