 ...
 */
@Controller 
public class Yeta2300Tax2017ContributionCalcPkgProc  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta2300Tax2017ContributionCalcPkgProc.class);
	   
    @Resource(name = "Yeta2300PayrService")
    protected Yeta2300PayrService  infcPkgYeta2300;
    
 
    public Yeta2300Tax2017ContributionCalcPkgProc() {
    	
    } 
    
    public List<ShowMessageBM> execTax_2017_Contribution_Calc(HttpServletRequest request, InfcPkgYe161010VO  infcPkgYe161010Vo)  throws Exception  {
  	    
	  	  return  fnTax_2017_Contribution_Calc(request,  infcPkgYe161010Vo);
	}
    ...
    * @throws Exception
    */
    private  List<ShowMessageBM> fnTax_2017_Contribution_Calc(HttpServletRequest request, InfcPkgYe161010VO  infcPkgYe161010Vo) throws Exception {
      ...
      BigDecimal bgYetaAllSumSe = BigDecimal.ZERO;  //세액합계금액 
		...
		//	BeanUtils.copyProperties(infcPkgYe165030Vo, infcPkgYe161010Vo);
            ...
            // {2011-추가기능 시작 } 
             ...
             List listYetaGibu = infcPkgYeta2300.fnYeta2300_YE169010_Tax_2017_1001_Select(infcPkgYe169010Vo); 
            	   ...
            	   Iterator<Map<String, Object>> iter = listYetaGibu.iterator(); 
		            ...
		            while ( iter.hasNext() ) { 
                      ...
                      // for(int iCnt = 0; iCnt < listYetaGibu.size();iCnt++) {
		               ...
		               bgSPCI_FB14_10    = BigDecimal.ZERO;            
		               bgSPCI_FB15_10    = BigDecimal.ZERO;            
		               ...
		               bgSPCI_NA14_40    = BigDecimal.ZERO;            
		               bgSPCI_NA15_40    = BigDecimal.ZERO;            
		               ...
		               bgSPCI_YA14_41    = BigDecimal.ZERO;            
		               bgSPCI_YA15_41    = BigDecimal.ZERO;            
...
//                     mTempOData20 = new BigDecimal(MSFSharedUtils.defaultNulls(mapYetaGibu.get("spciPltc20"),"0"));  //특별세액공제_기부금_정치자금_10만원초과  공제
                     ...
                     InfcPkgYe165030SrhVO infcPkgYe165030SrhVo =  new InfcPkgYe165030SrhVO(); 
                     ...
                     List listYe165030 = infcPkgYeta2300.fnPayr06430_PAYR442_ReTax_2017_SelectFind(infcPkgYe165030SrhVo);
                    	...
                    	/**********************************************************************************************************
                     	 ...
                     	 ***********************************************************************************************************/
                     	 for(int iCnt = 0; iCnt < listYe165030.size();iCnt++) {
                     		 ...
                     		 InfcPkgYe165030VO infcPkgOrgYe165030Vo =  new InfcPkgYe165030VO();
                     		 InfcPkgYe165030VO upInfcPkgYe165030Vo =  new InfcPkgYe165030VO(); 
                           		 ...
                           		 if (mTemp10Data20.compareTo(BigDecimal.ZERO) <= 0)  { 
										   ...
										   upInfcPkgYe165030Vo.setThcYrNducCrfwAmt(BigDecimal.ZERO);    /** column 해당년도_미공제이월금액 : ayyrNtam */
		                                    ...
		                                    // {
		                                     ...
		                                     statCnt = 0;
		                     		  		 statCnt =  infcPkgYeta2300.fnPayr06430_PAYR442_ReTax_2017_Update(upInfcPkgYe165030Vo);  
                			 ...
                			 infcPkgOrgYe165030Vo.setSpciDdctCheck(infcPkgYe161010Vo.getSpciDdctCheck());   
                       		 ...
                       		 BeanUtils.copyProperties(upInfcPkgYe165030Vo, infcPkgOrgYe165030Vo); 
                       		  ...
                       		  if (infcPkgOrgYe165030Vo.getCtrbTycd().equals("10"))  {  //if  oraQrySelect05.FieldByName('CTRB_TYCD').AsString = '10' then
                       			 	...
                       			 	if (infcPkgOrgYe165030Vo.getAttrYr().equals("2017"))  {  // if  oraQrySelect05.FieldByName('CTRB_YRMN').AsString = '2016' then
		                                      ...
		                                      statCnt = 0;
		                      		  		  statCnt =  infcPkgYeta2300.fnPayr06430_PAYR442_ReTax_2017_Update(upInfcPkgYe165030Vo);
		                      		  		  if (statCnt >= 0) {  
				                      		  			if (infcPkgOrgYe165030Vo.getAttrYr().equals("2014"))  { // if (infcPkgOrgYe165030Vo.getAttrYr().equals("2014"))  { 
				                                            
				                      		  				  upInfcPkgYe165030Vo  = insertYeYe165030(infcPkgOrgYe165030Vo,upInfcPkgYe165030Vo,bgSPCI_FBTG14_10 ,bgSPCI_FBSE14_10,BigDecimal.ZERO);
						                                      
						                                      statCnt = 0;
						                      		  		  statCnt =  infcPkgYeta2300.fnPayr06430_PAYR442_ReTax_2017_Update(upInfcPkgYe165030Vo);
						                      		  		  if (statCnt >= 0) { 
						                      		  			
						                      		  			if (infcPkgOrgYe165030Vo.getAttrYr().equals("2015"))  {
						                      		  				
								                      		  			  upInfcPkgYe165030Vo  = insertYeYe165030(infcPkgOrgYe165030Vo,upInfcPkgYe165030Vo,bgSPCI_FBTG15_10 ,bgSPCI_FBSE15_10,BigDecimal.ZERO);
									                                      ...
									                                      statCnt = 0;
									                      		  	      ...
									                      		  	      if (statCnt >= 0) { 
									                      		  	    	...
									                      		  	    	if (infcPkgOrgYe165030Vo.getAttrYr().equals("2016"))  {
									                      		  	    	  ...
									                      		  	    	  upInfcPkgYe165030Vo  = insertYeYe165030(infcPkgOrgYe165030Vo,upInfcPkgYe165030Vo,bgSPCI_FBTG16_10 ,bgSPCI_FBTG16_10,BigDecimal.ZERO);
				                               	        ...
				                               	        }  else if (infcPkgOrgYe165030Vo.getAttrYr().equals("2015"))  {
                               	    ...
                               	    }  else if (infcPkgOrgYe165030Vo.getAttrYr().equals("2014"))  {
                               	    	
                               	     // if (infcPkgOrgYe165030Vo.getAttrYr().equals("2014"))  { 
     		                                      ...
     		                                      statCnt = 0;
     		                      		  		  ...
     		                      		  		  if (statCnt >= 0) {  
     				                      		  			if (infcPkgOrgYe165030Vo.getAttrYr().equals("2014"))  { // if (infcPkgOrgYe165030Vo.getAttrYr().equals("2014"))  { 
     				                      		  				  ...
     				                      		  				  upInfcPkgYe165030Vo  = insertYeYe165030(infcPkgOrgYe165030Vo,upInfcPkgYe165030Vo,bgSPCI_NATG14_40 ,bgSPCI_NASE14_40,BigDecimal.ZERO);
     						                                      ...
     						                                      statCnt = 0;
     						                      		  		  ...
     						                      		  		  if (statCnt >= 0) { 
     						                      		  			...
     						                      		  			if (infcPkgOrgYe165030Vo.getAttrYr().equals("2015"))  {
     								                      		  			  ...
     								                      		  			  upInfcPkgYe165030Vo  = insertYeYe165030(infcPkgOrgYe165030Vo,upInfcPkgYe165030Vo,bgSPCI_NATG15_40 ,bgSPCI_NASE15_40,BigDecimal.ZERO);
      		                                      ...
      		                                      statCnt = 0;
      		                      		  		  ...
      		                      		  		  if (statCnt >= 0) {  
      				                      		  			if (infcPkgOrgYe165030Vo.getAttrYr().equals("2014"))  { // if (infcPkgOrgYe165030Vo.getAttrYr().equals("2014"))  { 
      				                      		  				  ...
      				                      		  				  upInfcPkgYe165030Vo  = insertYeYe165030(infcPkgOrgYe165030Vo,upInfcPkgYe165030Vo,bgSPCI_YATG14_41 ,bgSPCI_YASE14_41,BigDecimal.ZERO);
      						                                      ...
      						                                      statCnt = 0;
      						                      		  		  ...
      						                      		  		  if (statCnt >= 0) { 
      						                      		  			...
      						                      		  			if (infcPkgOrgYe165030Vo.getAttrYr().equals("2015"))  {
      								                      		  			  ...
      								                      		  			  upInfcPkgYe165030Vo  = insertYeYe165030(infcPkgOrgYe165030Vo,upInfcPkgYe165030Vo,bgSPCI_YATG15_41 ,bgSPCI_YASE15_41,BigDecimal.ZERO);
     ...
     * @return
     */
    private InfcPkgYe165030VO insertYeYe165030(InfcPkgYe165030VO infcPkgOrgYe165030Vo, InfcPkgYe165030VO upInfcPkgYe165030Vo,BigDecimal bgSPCI_FBTG17_10 ,BigDecimal bgSPCI_FBSE17_10,BigDecimal orgSanChul) {
