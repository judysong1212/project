...
public class Func2018_Pdf_DDC_E101Y {
	...
	public static void func_2018_E101Y(InfcPkgYe161010_2018_VO ye161010Vo, Element  xmlelDoc, Element  subXmlElForm, String nResult, HttpServletRequest request) throws Exception{ 
		...
		InfcPkgYe167410_2018_VO ye167410Vo = new InfcPkgYe167410_2018_VO();
		InfcPkgYe167420_2018_VO ye167420Vo = new InfcPkgYe167420_2018_VO();
		InfcPkgYe167430_2018_VO ye167430Vo = new InfcPkgYe167430_2018_VO();
		InfcPkgYe167440_2018_VO ye167440Vo = new InfcPkgYe167440_2018_VO();
		...
		for (int j = 0; j < subXmlElChildForm.getLength();j++) { 
			...
			yetaPayr3200Service.yeta3200_PDF_YE167410_2018_Delete(ye167410Vo);	//인적공제 삭제	
			...
			yetaPayr3200Service.yeta3200_PDF_YE167420_2018_Delete(ye167420Vo);	//인적공제 삭제	
			...
			yetaPayr3200Service.yeta3200_PDF_YE167430_2018_Delete(ye167430Vo);	//인적공제 삭제	
			...
			yetaPayr3200Service.yeta3200_PDF_YE167440_2018_Delete(ye167440Vo);	//인적공제 삭제	
			...
			yetaPayr3200Service.yeta3200_PDF_YE167410_2018_Insert(ye167410Vo);	//기본정보 입력
	...
	public static void setYe167420Vo(InfcPkgYe167420_2018_VO ye167420Vo , HttpServletRequest request) throws Exception{
		...
		yetaPayr3200Service.yeta3200_PDF_YE167420_2018_Insert(ye167420Vo);	//기본정보 입력 
	}
	
	public static void setYe167430Vo(InfcPkgYe167430_2018_VO ye167430Vo , int FamCd , HttpServletRequest request) throws Exception{
		...
		yetaPayr3200Service.yeta3200_PDF_YE167430_2018_Insert(ye167430Vo);	//기본정보 입력
	}
	
	public static void setYe167440Vo(InfcPkgYe167440_2018_VO ye167440Vo , HttpServletRequest request) throws Exception{
		...
		yetaPayr3200Service.yeta3200_PDF_YE167440_2018_Insert(ye167440Vo);	//기본정보 입력
	}
}
