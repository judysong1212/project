 ...
 */
public class InfcPkgPayr0400DTO  implements Serializable {
    ...
    /** payrAdapter 실행여부  */
    private int iPayrAdapter;
    

	public int getiPayrAdapter() {
		return iPayrAdapter;
	}

	public void setiPayrAdapter(int iPayrAdapter) {
		this.iPayrAdapter = iPayrAdapter;
	}
