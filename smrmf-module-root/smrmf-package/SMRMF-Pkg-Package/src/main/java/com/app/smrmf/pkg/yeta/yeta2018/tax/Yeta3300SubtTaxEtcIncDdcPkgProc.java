 ...
 */
@Controller 
public class Yeta3300SubtTaxEtcIncDdcPkgProc  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta3300SubtTaxEtcIncDdcPkgProc.class);
	   
    @Resource(name = "Yeta3300PayrService")
    protected Yeta3300PayrService  infcPkgYeta3300;
    
 
    public Yeta3300SubtTaxEtcIncDdcPkgProc() {
    	
    } 
    
    public  List<ShowMessageBM> execSubtTaxEtcIncDdcPkgProc(HttpServletRequest request,InfcPkgYe161010_2018_VO  ye161010VO)  throws Exception  {
    ...
    * @throws Exception
    */
    private   List<ShowMessageBM> YetaSubtCreateUpdate(HttpServletRequest request,InfcPkgYe161010_2018_VO  infcPkgYe161010Vo) throws Exception {
     ...
     * @throws Exception
     */
    private   List<ShowMessageBM> YetaSubtStdTaxUpdate(HttpServletRequest request,InfcPkgYe161010_2018_VO  infcPkgYe161010Vo) throws Exception {
  	  ...
  	  infcPkgYeta3300 = (Yeta3300PayrService)BeanFinder.getBean("Yeta3300PayrService"); 
     	...
     	infcPkgYe161010Vo.setRevnAddr(RemoteServiceUtil.getThreadLocalRequest().getRemoteHost());    			/** column 수정주소 : revnAddr */
  	      ...
  	      *******************************************************************************************/  
  		      InfcPkgYe169010a_2018_VO subInfcPkgYe169010aVo = new InfcPkgYe169010a_2018_VO();  //연말정산결과  
  		      InfcPkgYe169010a_2018_VO tpSubInfcPkgYe169010aVo = new InfcPkgYe169010a_2018_VO();  //연말정산결과  
  		    ...
  		    subInfcPkgYe169010aVo.setDpobCd(infcPkgYe161010Vo.getDpobCd());    /** column 사업장코드 : dpobCd */
  		      ...
  		      tpSubInfcPkgYe169010aVo = infcPkgYeta3300.fnYeta3300_YE169010a_Tax_2018_2001_Select(subInfcPkgYe169010aVo); 
...
//  		          exETCK_UNCR  = tpSubInfcPkgYe169010aVo.getEtckUncr();  /*(44) column 기타공제_우리사주조합기부금공제2014이전 : ETCK_UNCR */
...
//  	 	      subInfcPkgYe169010aVo.setEtcpPsnv(exETCP_PSNV);    /** column 개인연금저축불입액_2000년이전 : etcpPsnv */  
//  			        subInfcPkgYe169010aVo.setEtchPrep(exETCH_PREP);    /** column 기타공제_소기업공제불입금 : etchPrep */
//  			        subInfcPkgYe169010aVo.setEtcsComp(exETCS_COMP);    /** column 기타공제_주택마련저축_청약저축 : etcsComp */
//  			        subInfcPkgYe169010aVo.setEtwkSbam(exETWK_SBAM);    /** column 기타공제_주택마련저축_주택청약종합저축 : etwkSbam */
//  			        subInfcPkgYe169010aVo.setEtwkSvam(exETWK_SVAM);    /** column 기타공제_주택마련저축_근로자주택마련저축 : etwkSvam */  
//  			        subInfcPkgYe169010aVo.setEtgdDdam(exETGD_DDAM);    /** column 기타공제_투자조합출자공제액계 : etgdDdam */
//  			        subInfcPkgYe169010aVo.setEtccCard(exETCC_CARD);    /** column 기타공제_신용카드등사용액소득공제 : etccCard */
//  			        subInfcPkgYe169010aVo.setEtckUnon(exETCK_UNON);    /** column 기타공제_우리사주출연금공제 : etckUnon */
//  			        subInfcPkgYe169010aVo.setEtckUncr(exETCK_UNCR);    /** column 기타공제_우리사주조합기부금공제2014이전 : etckUncr */
//  			        subInfcPkgYe169010aVo.setEtepMsam(exETEP_MSAM);    /** column 기타공제_고용유지중소기업근로자임금삭감공제액 : etepMsam */
//  			        subInfcPkgYe169010aVo.setEtgdHtra(exETGD_HTRA);    /** column 기타공제_목돈안드는전세이자상환소득공제액 : etgdHtra */
//  			        subInfcPkgYe169010aVo.setEtepSecr(exETEP_SECR);    /** column 기타공제_장기집합투자증권저축공제액 : etepSecr */ 
  			     
  		        
  		        statCnt = 0;
  			  	statCnt =  infcPkgYeta3300.fnYeta3300_YE169010a_Tax_2018_2002_Update(subInfcPkgYe169010aVo); 
     ...
     * @throws Exception
     */
    private   List<ShowMessageBM> YetaSubtBaseTaxUpdate(HttpServletRequest request,InfcPkgYe161010_2018_VO  infcPkgYe161010Vo) throws Exception {
  	  ...
  	  infcPkgYeta3300 = (Yeta3300PayrService)BeanFinder.getBean("Yeta3300PayrService"); 
     	...
     	infcPkgYe161010Vo.setRevnAddr(RemoteServiceUtil.getThreadLocalRequest().getRemoteHost());    			/** column 수정주소 : revnAddr */
  	      ...
  	      *******************************************************************************************/  
  		      InfcPkgYe169010_2018_VO subInfcPkgYe169010Vo = new InfcPkgYe169010_2018_VO();  //연말정산결과  
  		      InfcPkgYe169010_2018_VO tpSubInfcPkgYe169010Vo = new InfcPkgYe169010_2018_VO();  //연말정산결과  
  		      ...
  		      tpSubInfcPkgYe169010Vo = infcPkgYeta3300.fnYeta3300_YE169010_Tax_2018_2001_Select(subInfcPkgYe169010Vo); 
...
//  		          exETCK_UNCR  = tpSubInfcPkgYe169010Vo.getEtckUncr();  /*(44) column 기타공제_우리사주조합기부금공제2014이전 : ETCK_UNCR */
//  		           if (exTpSUBT_ERAM.compareTo(exETCK_UNCR ) > 0) {
//  		           exTpSUBT_ERAM = exTpSUBT_ERAM.subtract(exETCK_UNCR);
//  		           }
//  		        else
...
//  	 		        subInfcPkgYe169010Vo.setEtcpPsnv(exETCP_PSNV);    /** column 개인연금저축불입액_2000년이전 : etcpPsnv */  
//  			        subInfcPkgYe169010Vo.setEtchPrep(exETCH_PREP);    /** column 기타공제_소기업공제불입금 : etchPrep */
//  			        subInfcPkgYe169010Vo.setEtcsComp(exETCS_COMP);    /** column 기타공제_주택마련저축_청약저축 : etcsComp */
//  			        subInfcPkgYe169010Vo.setEtwkSbam(exETWK_SBAM);    /** column 기타공제_주택마련저축_주택청약종합저축 : etwkSbam */
//  			        subInfcPkgYe169010Vo.setEtwkSvam(exETWK_SVAM);    /** column 기타공제_주택마련저축_근로자주택마련저축 : etwkSvam */  
//  			        subInfcPkgYe169010Vo.setEtgdDdam(exETGD_DDAM);    /** column 기타공제_투자조합출자공제액계 : etgdDdam */
//  			        subInfcPkgYe169010Vo.setEtccCard(exETCC_CARD);    /** column 기타공제_신용카드등사용액소득공제 : etccCard */
//  			        subInfcPkgYe169010Vo.setEtckUnon(exETCK_UNON);    /** column 기타공제_우리사주출연금공제 : etckUnon */
//  			        subInfcPkgYe169010Vo.setEtckUncr(exETCK_UNCR);    /** column 기타공제_우리사주조합기부금공제2014이전 : etckUncr */
//  			        subInfcPkgYe169010Vo.setEtepMsam(exETEP_MSAM);    /** column 기타공제_고용유지중소기업근로자임금삭감공제액 : etepMsam */
//  			        subInfcPkgYe169010Vo.setEtgdHtra(exETGD_HTRA);    /** column 기타공제_목돈안드는전세이자상환소득공제액 : etgdHtra */
//  			        subInfcPkgYe169010Vo.setEtepSecr(exETEP_SECR);    /** column 기타공제_장기집합투자증권저축공제액 : etepSecr */ 
  			     
  		        
  		        statCnt = 0;
  			  	statCnt =  infcPkgYeta3300.fnYeta3300_YE169010_Tax_2018_2002_Update(subInfcPkgYe169010Vo); 
