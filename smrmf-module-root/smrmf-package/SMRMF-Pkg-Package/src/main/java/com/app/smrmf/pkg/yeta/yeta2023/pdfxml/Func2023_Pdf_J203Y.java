...
public class Func2023_Pdf_J203Y {
	...
	public static void func_2023_J203Y_J203M(InfcPkgYe161010_2023_VO ye161010VO, Element  subXmlElForm, String nResult, HttpServletRequest request ) throws Exception{
		...
		InfcPkgPdfJ203y_2023_VO yetaPdfJ203yVo = new InfcPkgPdfJ203y_2023_VO();
		InfcPkgPdfJ203m_2023_VO yetaPdfJ203mVo = new InfcPkgPdfJ203m_2023_VO();
		...
		yetaPayr3200Service.yeta8200_PDF_J203Y_2023_Delete(yetaPdfJ203yVo);
		...
		yetaPayr3200Service.yeta8200_PDF_J203M_2023_Delete(yetaPdfJ203mVo);
	...
	public static void setPdfJ203yVo(InfcPkgPdfJ203y_2023_VO yetaPdfJ203yVo, InfcPkgPdfJ203m_2023_VO yetaPdfJ203mVo, InfcPkgYe161010_2023_VO ye161010VO, 
		...
		for(int i = 0; i < subXmlElChildSum.getLength(); i++) {  
			...
			yetaPayr3200Service.yeta8200_PDF_J203Y_2023_Insert(yetaPdfJ203yVo);
		}
	...
	public static void setPdfJ203mVo(InfcPkgPdfJ203m_2023_VO yetaPdfJ203mVo , HttpServletRequest request, Element subXmlElData) throws Exception{
		...
		yetaPayr3200Service.yeta8200_PDF_J203M_2023_Insert(yetaPdfJ203mVo);

	}
	
	public static void func_2023_J203Y_YetaCalc(InfcPkgYe161010_2023_VO ye161010VO, HttpServletRequest request) throws Exception{ 
		...
		InfcPkgPdfJ203ySrh_2023_VO yetaPdfJ203ySrhVo = new InfcPkgPdfJ203ySrh_2023_VO();
		...
		List<InfcPkgPdfJ203y_2023_VO> infcPkgPdfJ203yList = new ArrayList<InfcPkgPdfJ203y_2023_VO>();
		
		//장기주택저당차입금
		infcPkgPdfJ203yList = (List<InfcPkgPdfJ203y_2023_VO>)yetaPayr3200Service.PdfYeta8200_F102Y_PDF_J203Y_Select(yetaPdfJ203ySrhVo);  
		
		if (infcPkgPdfJ203yList.size() > 0) { 
			
			for(int icnt = 0;icnt < infcPkgPdfJ203yList.size();icnt++) {
				
					InfcPkgPdfJ203y_2023_VO vPdfJ203yVo = new InfcPkgPdfJ203y_2023_VO();
...
//          yeta2000Vo.setSpch10fb(edSPCH_10FB); // 특별공제_15장기주택저당_10고정 OR 비거치상환
			...
			// 장기 주택 차입금 합계  
	         yetaPayr3200Service.fnYeta8200_J203Y_YE161060_2023_Update(infcPkgYe161060Vo); 
