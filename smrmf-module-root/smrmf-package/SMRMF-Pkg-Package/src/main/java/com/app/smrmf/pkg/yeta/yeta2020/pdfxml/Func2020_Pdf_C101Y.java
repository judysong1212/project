...
public class Func2020_Pdf_C101Y {
	...
	public static void func_2020_C101Y_C101M(InfcPkgYe161010_2020_VO ye161010VO, Element  subXmlElForm, String nResult , HttpServletRequest request) throws Exception{
		...
		InfcPkgPdfC101y_2020_VO yetaPdfC101yVo = new InfcPkgPdfC101y_2020_VO();
		InfcPkgPdfC101m_2020_VO yetaPdfC101mVo = new InfcPkgPdfC101m_2020_VO();
		...
		yetaPayr3200Service.yeta5200_PDF_C101Y_2020_Delete(yetaPdfC101yVo);
...
//					}
	...
	public static void setPdfC101yVo(InfcPkgPdfC101y_2020_VO yetaPdfC101yVo , HttpServletRequest request) throws Exception{
		...
		yetaPayr3200Service.yeta5200_PDF_C101Y_2020_Insert(yetaPdfC101yVo);
	 ...
	 * </pre>
	 * @Method Name : func_2020_C102Y_YetaCalc
	 * @date : 2020. 1. 23.
	 * @author : atres
	 * @history : 
	 *	-----------------------------------------------------------------------
	 ...
	 * @throws Exception
	 */
	public static void func_2020_C101Y_YetaCalc(InfcPkgYe161010_2020_VO ye161010VO, HttpServletRequest request) throws Exception{ 
      ...
      //   G0007 교육비-기타 본인+가족 개별제출
		...
		//교육비 
		yetaPayr3200Service.PdfYeta5200_C101Y_YE161090_Delete(infcPkgYe161090Vo); 
		yetaPayr3200Service.PdfYeta5200_C101Y_YE161090_Insert(infcPkgYe161090Vo); 
