...
public class Func2018_Pdf_F102Y {
	...
	public static void func_2018_F102Y_F102M(InfcPkgYe161010_2018_VO ye161010VO, Element  subXmlElForm, String nResult , HttpServletRequest request ) throws Exception{
		...
		InfcPkgPdfF102y_2018_VO yetaPdfF102yVo = new InfcPkgPdfF102y_2018_VO();
		InfcPkgPdfF102m_2018_VO yetaPdfF102mVo = new InfcPkgPdfF102m_2018_VO();
...
//					yetaPdfF102yVo.setRetirPnsnAmtSum(new BigDecimal(MSFSharedUtils.defaultNulls(PkgFuncUtils.getXmlTagValue("sum", subXmlElData), "0")));
					...
					yetaPayr3200Service.yeta3200_PDF_F102Y_2018_Delete(yetaPdfF102yVo);
					yetaPayr3200Service.yeta3200_PDF_F102Y_2018_Insert(yetaPdfF102yVo);
				}
			}
	...
	public static void func_2018_F102Y_YetaCalc(InfcPkgYe161010_2018_VO ye161010VO, HttpServletRequest request) throws Exception{ 
		...
		InfcPkgYe162020_2018_VO infcPkgYe162020Vo = new InfcPkgYe162020_2018_VO();
		...
		//퇴직연금
		yetaPayr3200Service.PdfYeta3200_F102Y_YE162020_Delete(infcPkgYe162020Vo); 
		yetaPayr3200Service.PdfYeta3200_F102Y_YE162020_Insert(infcPkgYe162020Vo); 
		...
		// 퇴직연금 합계  
         yetaPayr3200Service.fnYeta3200_F102Y_YE161080_2018_Update(infcPkgYe161080Vo); 
