...
public class Func2019_Pdf_G307Y {
	...
	public static void func_2019_G307Y_G307M(InfcPkgYe161010_2019_VO ye161010VO, Element  subXmlElForm, String nResult, HttpServletRequest request ) throws Exception{
		...
		InfcPkgPdfG307y_2019_VO yetaPdfG307yVo = new InfcPkgPdfG307y_2019_VO();
		InfcPkgPdfG307m_2019_VO yetaPdfG307mVo = new InfcPkgPdfG307m_2019_VO();
		...
		yetaPayr3200Service.yeta4200_PDF_G307Y_2019_Delete(yetaPdfG307yVo);
		...
		yetaPayr3200Service.yeta4200_PDF_G307M_2019_Delete(yetaPdfG307mVo);
	...
	public static void setPdfG307yVo(InfcPkgPdfG307y_2019_VO yetaPdfG307yVo , HttpServletRequest request, Element subXmlElData) throws Exception{
		...
		yetaPayr3200Service.yeta4200_PDF_G307Y_2019_Insert(yetaPdfG307yVo);

	}
	
	public static void setPdfG307mVo(InfcPkgPdfG307m_2019_VO yetaPdfG307mVo , HttpServletRequest request, Element subXmlElData) throws Exception{
		...
		yetaPayr3200Service.yeta4200_PDF_G307M_2019_Insert(yetaPdfG307mVo);

	}
	

	public static void func_2019_G307Y_YetaCalc(InfcPkgYe161010_2019_VO ye161010VO, HttpServletRequest request) throws Exception{ 
		...
		dataChk = yetaPayr3200Service.PdfYeta2019_G307Y_YE161040_Update(infcPkgYe161040Vo); 
		...
		if (dataChk >= 0) { 
			...
			//신용카드
			//yetaPayr3200Service.Pdfyeta4200_G106Y_YE166020_Update(infcPkgYe166020Vo);  
			...
			// 신용카드  
	         yetaPayr3200Service.fnYeta4200_G307Y_YE161070_2019_Update(infcPkgYe161070Vo); 
