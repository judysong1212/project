...
public class Func2018_Pdf_G107Y {
	...
	public static void func_2018_G107Y_G107M(InfcPkgYe161010_2018_VO ye161010VO, Element  subXmlElForm, String nResult , HttpServletRequest request ) throws Exception{
		...
		InfcPkgPdfG107y_2018_VO yetaPdfG107yVo = new InfcPkgPdfG107y_2018_VO();
		InfcPkgPdfG107m_2018_VO yetaPdfG107mVo = new InfcPkgPdfG107m_2018_VO();
		...
		yetaPayr3200Service.yeta3200_PDF_G107Y_2018_Delete(yetaPdfG107yVo);
	...
	public static void setPdfG107yVo(InfcPkgPdfG107y_2018_VO yetaPdfG107yVo , HttpServletRequest request) throws Exception{
		...
		yetaPayr3200Service.yeta3200_PDF_G107Y_2018_Insert(yetaPdfG107yVo);

	}
	
	

	public static void func_2018_G107Y_YetaCalc(InfcPkgYe161010_2018_VO ye161010VO, HttpServletRequest request) throws Exception{ 
	...
	//  신용카드 시작
		...
		dataChk =  yetaPayr3200Service.PdfYeta2018_G107Y_YE161040_Update(infcPkgYe161040Vo); 
		...
		if (dataChk >= 0) {
			...
			// 신용카드  
	         yetaPayr3200Service.fnYeta3200_G107Y_YE161070_2018_Update(infcPkgYe161070Vo); 
