 ...
 */
@Controller 
public class Yeta8300SubtTaxEtcIncDdcPkgProc  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta8300SubtTaxEtcIncDdcPkgProc.class);
	   
    @Resource(name = "Yeta8300PayrService")
    protected Yeta8300PayrService  infcPkgYeta8300;
    
 
    public Yeta8300SubtTaxEtcIncDdcPkgProc() {
    	
    } 
    
    public  List<ShowMessageBM> execSubtTaxEtcIncDdcPkgProc(HttpServletRequest request,InfcPkgYe161010_2023_VO  ye161010VO)  throws Exception  {
    ...
    * @throws Exception
    */
    private   List<ShowMessageBM> YetaSubtCreateUpdate(HttpServletRequest request,InfcPkgYe161010_2023_VO  infcPkgYe161010Vo) throws Exception {
     ...
     * @throws Exception
     */
    private   List<ShowMessageBM> YetaSubtStdTaxUpdate(HttpServletRequest request,InfcPkgYe161010_2023_VO  infcPkgYe161010Vo) throws Exception {
        ...
        BigDecimal exETEPY_SECR = BigDecimal.ZERO;
  	  ...
  	  infcPkgYeta8300 = (Yeta8300PayrService)BeanFinder.getBean("Yeta8300PayrService"); 
     	...
     	infcPkgYe161010Vo.setRevnAddr(RemoteServiceUtil.getThreadLocalRequest().getRemoteHost());    			/** column 수정주소 : revnAddr */
  	      ...
  	      *******************************************************************************************/  
  		      InfcPkgYe169010a_2023_VO subInfcPkgYe169010aVo = new InfcPkgYe169010a_2023_VO();  //연말정산결과  
  		      InfcPkgYe169010a_2023_VO tpSubInfcPkgYe169010aVo = new InfcPkgYe169010a_2023_VO();  //연말정산결과  
  		    ...
  		    subInfcPkgYe169010aVo.setDpobCd(infcPkgYe161010Vo.getDpobCd());    /** column 사업장코드 : dpobCd */
  		      ...
  		      tpSubInfcPkgYe169010aVo = infcPkgYeta8300.fnYeta8300_YE169010a_Tax_2023_2001_Select(subInfcPkgYe169010aVo); 
  		      ...
  		      if (MSFSharedUtils.paramNotNull(tpSubInfcPkgYe169010aVo) && MSFSharedUtils.paramNotNull(tpSubInfcPkgYe169010aVo.getSystemkey())) {
  		        ...
  		        exETEPY_SECR  = tpSubInfcPkgYe169010aVo.getYetaStdC109y(); /*(47) column 기타공제_청년형장기집합투자증권저축공제액 : ETEPY_SECR */
		          if (exTpSUBT_ERAM.compareTo(exETEPY_SECR) > 0)  {
		           exTpSUBT_ERAM = exTpSUBT_ERAM.subtract(exETEPY_SECR);
		          }
		        else
		        {
		           exETEPY_SECR  = BigDecimal.ZERO;
		            if (exTpSUBT_ERAM.compareTo(BigDecimal.ZERO)  > 0) {
		                exETEPY_SECR   = exTpSUBT_ERAM;
		                exTpSUBT_ERAM  = BigDecimal.ZERO;
		            }
		        }
  		          ...
  		          subInfcPkgYe169010aVo.setYetaStdC109y(exETEPY_SECR);    /** column C109_기타소득공제_청년형장기집합투자증권저축금액 : yetaC109 */
  		        
  		        statCnt = 0;
  			  	statCnt =  infcPkgYeta8300.fnYeta8300_YE169010a_Tax_2023_2002_Update(subInfcPkgYe169010aVo); 
     ...
     * @throws Exception
     */
    private   List<ShowMessageBM> YetaSubtBaseTaxUpdate(HttpServletRequest request,InfcPkgYe161010_2023_VO  infcPkgYe161010Vo) throws Exception {
  	  ...
  	  infcPkgYeta8300 = (Yeta8300PayrService)BeanFinder.getBean("Yeta8300PayrService"); 
     	...
     	infcPkgYe161010Vo.setRevnAddr(RemoteServiceUtil.getThreadLocalRequest().getRemoteHost());    			/** column 수정주소 : revnAddr */
  	      ...
  	      *******************************************************************************************/  
  		      InfcPkgYe169010_2023_VO subInfcPkgYe169010Vo = new InfcPkgYe169010_2023_VO();  //연말정산결과  
  		      InfcPkgYe169010_2023_VO tpSubInfcPkgYe169010Vo = new InfcPkgYe169010_2023_VO();  //연말정산결과  
  		      ...
  		      tpSubInfcPkgYe169010Vo = infcPkgYeta8300.fnYeta8300_YE169010_Tax_2023_2001_Select(subInfcPkgYe169010Vo); 
  		      ...
  		      if (MSFSharedUtils.paramNotNull(tpSubInfcPkgYe169010Vo) && MSFSharedUtils.paramNotNull(tpSubInfcPkgYe169010Vo.getSystemkey())) {
  		        ...
  		        else
  		        {
  		          ...
  		          //2022연말정산_추가
  		        exETEPY_SECR  = tpSubInfcPkgYe169010Vo.getYetaC109y(); /*(47) column 기타공제_청년형장기집합투자증권저축공제액 : ETEPY_SECR */
		          if (exTpSUBT_ERAM.compareTo(exETEPY_SECR) > 0)  {
		           exTpSUBT_ERAM = exTpSUBT_ERAM.subtract(exETEPY_SECR);
		          }
		        else
		        {
		           exETEPY_SECR  = BigDecimal.ZERO;
  		          ...
  		          subInfcPkgYe169010Vo.setYetaC109y(exETEPY_SECR);    /** column C109Y_기타소득공제_청년형장기집합투자증권저축금액 : yetaC109Y */
  		          
  		        statCnt = 0;
  			  	statCnt =  infcPkgYeta8300.fnYeta8300_YE169010_Tax_2023_2002_Update(subInfcPkgYe169010Vo); 
