...
public class Func2021_Pdf_G107Y {
	...
	public static void func_2021_G107Y_G107M(InfcPkgYe161010_2021_VO ye161010VO, Element  subXmlElForm, String nResult , HttpServletRequest request ) throws Exception{
		...
		InfcPkgPdfG107y_2021_VO yetaPdfG107yVo = new InfcPkgPdfG107y_2021_VO();
		InfcPkgPdfG107m_2021_VO yetaPdfG107mVo = new InfcPkgPdfG107m_2021_VO();
		...
		yetaPayr3200Service.yeta6200_PDF_G107Y_2021_Delete(yetaPdfG107yVo);
		...
		yetaPayr3200Service.yeta6200_PDF_G107M_2021_Delete(yetaPdfG107mVo);
		...
		for (int j = 0; j < subXmlElChildForm.getLength();j++) { 
			...
			yetaPayr3200Service.yeta6200_PDF_G107M_2021_Insert(yetaPdfG107mVo);
	...
	public static void setPdfG107yVo(InfcPkgPdfG107y_2021_VO yetaPdfG107yVo , HttpServletRequest request) throws Exception{
		...
		yetaPayr3200Service.yeta6200_PDF_G107Y_2021_Insert(yetaPdfG107yVo);

	}
	
	

	public static void func_2021_G107Y_YetaCalc(InfcPkgYe161010_2021_VO ye161010VO, HttpServletRequest request) throws Exception{ 
		...
		yetaPayr3200Service.yeta6200_PDF_G107M_2021_Update(yetaPdfG107mVo);
	...
	//  신용카드 시작
		...
		dataChk =  yetaPayr3200Service.PdfYeta2021_G107Y_YE161040_Update(infcPkgYe161040Vo); 
		...
		if (dataChk >= 0) {
			...
			// 신용카드  
	         yetaPayr3200Service.fnYeta6200_G107Y_YE161070_2021_Update(infcPkgYe161070Vo); 
