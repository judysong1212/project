...
public interface InfcPkgPayr0400ServiceAsync {
	
	/** 직종, 직종세 맵핑 후 근속년수 생성 **/
	public void createPyspLogSvcYrNumCd(InfcPkgPayr0400DTO infcPayr0400Dto, AsyncCallback<InfcPkgPayr0400DTO> callback);	
