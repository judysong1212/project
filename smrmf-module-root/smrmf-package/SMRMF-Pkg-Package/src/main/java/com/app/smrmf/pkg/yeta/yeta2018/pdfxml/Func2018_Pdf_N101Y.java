...
public class Func2018_Pdf_N101Y {
	...
	public static void func_2018_N101Y_N101M(InfcPkgYe161010_2018_VO ye161010VO, Element  subXmlElForm, String nResult, HttpServletRequest request) throws Exception{
		...
		InfcPkgPdfN101y_2018_VO yetaPdfN101yVo = new InfcPkgPdfN101y_2018_VO();
		InfcPkgPdfN101m_2018_VO yetaPdfN101dVo = new InfcPkgPdfN101m_2018_VO();
		...
		for (int j = 0; j < subXmlElChildForm.getLength();j++) { 
			...
			for(int k = 0; k < subXmlElChildMan.getLength();k++) {  
				...
				if (strDatCd.equals("G0029")) {
					...
					yetaPayr3200Service.yeta3200_PDF_N101Y_2018_Delete(yetaPdfN101yVo);
					yetaPayr3200Service.yeta3200_PDF_N101Y_2018_Insert(yetaPdfN101yVo);
	...
	public static void func_2018_N101Y_YetaCalc(InfcPkgYe161010_2018_VO ye161010VO, HttpServletRequest request) throws Exception{ 
       ...
       //Y0040110	B011	0110	장기집합투자증권저축					51
		...
		InfcPkgYe162040_2018_VO infcPkgYe162040Vo = new InfcPkgYe162040_2018_VO();
		...
		//장기집합 투자 증권
		yetaPayr3200Service.PdfYeta3200_N101Y_YE162040_Delete(infcPkgYe162040Vo); 
		yetaPayr3200Service.PdfYeta3200_N101Y_YE162040_Insert(infcPkgYe162040Vo); 
		...
		// 장기집합 투자 증권 합계  
         yetaPayr3200Service.fnYeta3200_N101Y_YE161070_2018_Update(infcPkgYe161070Vo); 
