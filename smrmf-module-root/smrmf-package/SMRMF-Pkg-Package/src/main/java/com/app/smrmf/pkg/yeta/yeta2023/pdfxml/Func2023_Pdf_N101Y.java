...
public class Func2023_Pdf_N101Y {
	...
	public static void func_2023_N101Y_N101M(InfcPkgYe161010_2023_VO ye161010VO, Element  subXmlElForm, String nResult, HttpServletRequest request) throws Exception{
		...
		InfcPkgPdfN101y_2023_VO yetaPdfN101yVo = new InfcPkgPdfN101y_2023_VO();
		InfcPkgPdfN101m_2023_VO yetaPdfN101dVo = new InfcPkgPdfN101m_2023_VO();
		...
		for (int j = 0; j < subXmlElChildForm.getLength();j++) { 
			...
			for(int k = 0; k < subXmlElChildMan.getLength();k++) {  
				...
				if (strDatCd.equals("G0029")) {
					...
					yetaPayr3200Service.yeta8200_PDF_N101Y_2023_Delete(yetaPdfN101yVo);
					yetaPayr3200Service.yeta8200_PDF_N101Y_2023_Insert(yetaPdfN101yVo);
	...
	public static void func_2023_N101Y_YetaCalc(InfcPkgYe161010_2023_VO ye161010VO, HttpServletRequest request) throws Exception{ 
       ...
       //Y0040110	B011	0110	장기집합투자증권저축					51
		...
		InfcPkgYe162040_2023_VO infcPkgYe162040Vo = new InfcPkgYe162040_2023_VO();
		...
		//장기집합 투자 증권
		yetaPayr3200Service.PdfYeta8200_N101Y_YE162040_Delete(infcPkgYe162040Vo); 
		yetaPayr3200Service.PdfYeta8200_N101Y_YE162040_Insert(infcPkgYe162040Vo); 
		...
		// 장기집합 투자 증권 합계  
         yetaPayr3200Service.fnYeta8200_N101Y_YE161070_2023_Update(infcPkgYe161070Vo); 
