...
public class Func2019_Pdf_E102Y {
	...
	public static void func_2019_E102Y_E102M(InfcPkgYe161010_2019_VO ye161010VO, Element  subXmlElForm, String nResult , HttpServletRequest request ) throws Exception{
		...
		InfcPkgPdfE102y_2019_VO yetaPdfE102yVo = new InfcPkgPdfE102y_2019_VO();
		InfcPkgPdfE102m_2019_VO yetaPdfE102mVo = new InfcPkgPdfE102m_2019_VO();
...
//					yetaPdfE102yVo.setPnsnSvSum(new BigDecimal(MSFSharedUtils.defaultNulls(PkgFuncUtils.getXmlTagValue("sum", subXmlElData), "0")));
					...
					yetaPayr3200Service.yeta4200_PDF_E102Y_2019_Delete(yetaPdfE102yVo);
					yetaPayr3200Service.yeta4200_PDF_E102Y_2019_Insert(yetaPdfE102yVo);
				}
	...
	public static void func_2019_E102Y_YetaCalc(InfcPkgYe161010_2019_VO ye161010VO, HttpServletRequest request) throws Exception{ 
		...
		InfcPkgYe162010_2019_VO infcPkgYe162010Vo = new InfcPkgYe162010_2019_VO();
		...
		//연금저축 
		yetaPayr3200Service.PdfYeta4200_E102Y_YE162010_Delete(infcPkgYe162010Vo); 
		yetaPayr3200Service.PdfYeta4200_E102Y_YE162010_Insert(infcPkgYe162010Vo); 
		...
		// 교육비 합계  
         yetaPayr3200Service.fnYeta4200_E102Y_YE161080_2019_Update(infcPkgYe161080Vo); 
