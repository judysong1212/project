...
public class Func2018_Pdf_A102Y {
	...
	public static void func_2018_A102Y_A102M(InfcPkgYe161010_2018_VO ye161010VO, Element  subXmlElForm, String nResult, HttpServletRequest request) throws Exception{ 
		...
		InfcPkgPdfA102y_2018_VO yetaPdfA102yVo = new InfcPkgPdfA102y_2018_VO();
		InfcPkgPdfA102m_2018_VO yetaPdfA102mVo = new InfcPkgPdfA102m_2018_VO();
		...
		for (int j = 0; j < subXmlElChildForm.getLength();j++) { 
			...
			for(int k = 0; k < subXmlElChildMan.getLength();k++) {  
				...
				if (strDatCd.equals("G0001")) { //보장성 총 금액
					...
					yetaPayr3200Service.yeta3200_PDF_A102Y_2018_Delete(yetaPdfA102yVo); 
					yetaPayr3200Service.yeta3200_PDF_A102Y_2018_Insert(yetaPdfA102yVo);
	 ...
	 * 2. 처리내용 : 
	 * </pre>
	 * @Method Name : func_2018_A102Y_YetaCalc
	 * @date : 2018. 1. 22.
	 * @author : atres
	 * @history : 
	 *	-----------------------------------------------------------------------
	 ...
	 * @throws Exception
	 */
	public static void func_2018_A102Y_YetaCalc(InfcPkgYe161010_2018_VO ye161010VO, HttpServletRequest request) throws Exception{ 
		...
		yetaPayr3200Service.PdfYeta2018_A102Y_YE161040_Update(infcPkgYe161040Vo); 
