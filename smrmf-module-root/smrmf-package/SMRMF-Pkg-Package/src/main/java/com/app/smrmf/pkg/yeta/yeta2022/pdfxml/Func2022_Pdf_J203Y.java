...
public class Func2022_Pdf_J203Y {
	...
	public static void func_2022_J203Y_J203M(InfcPkgYe161010_2022_VO ye161010VO, Element  subXmlElForm, String nResult, HttpServletRequest request ) throws Exception{
		...
		InfcPkgPdfJ203y_2022_VO yetaPdfJ203yVo = new InfcPkgPdfJ203y_2022_VO();
		InfcPkgPdfJ203m_2022_VO yetaPdfJ203mVo = new InfcPkgPdfJ203m_2022_VO();
		...
		yetaPayr3200Service.yeta7200_PDF_J203Y_2022_Delete(yetaPdfJ203yVo);
		...
		yetaPayr3200Service.yeta7200_PDF_J203M_2022_Delete(yetaPdfJ203mVo);
	...
	public static void setPdfJ203yVo(InfcPkgPdfJ203y_2022_VO yetaPdfJ203yVo, InfcPkgPdfJ203m_2022_VO yetaPdfJ203mVo, InfcPkgYe161010_2022_VO ye161010VO, 
		...
		for(int i = 0; i < subXmlElChildSum.getLength(); i++) {  
			...
			yetaPayr3200Service.yeta7200_PDF_J203Y_2022_Insert(yetaPdfJ203yVo);
		}
	...
	public static void setPdfJ203mVo(InfcPkgPdfJ203m_2022_VO yetaPdfJ203mVo , HttpServletRequest request, Element subXmlElData) throws Exception{
		...
		yetaPayr3200Service.yeta7200_PDF_J203M_2022_Insert(yetaPdfJ203mVo);

	}
	
	public static void func_2022_J203Y_YetaCalc(InfcPkgYe161010_2022_VO ye161010VO, HttpServletRequest request) throws Exception{ 
		...
		InfcPkgPdfJ203ySrh_2022_VO yetaPdfJ203ySrhVo = new InfcPkgPdfJ203ySrh_2022_VO();
		...
		List<InfcPkgPdfJ203y_2022_VO> infcPkgPdfJ203yList = new ArrayList<InfcPkgPdfJ203y_2022_VO>();
		
		//장기주택저당차입금
		infcPkgPdfJ203yList = (List<InfcPkgPdfJ203y_2022_VO>)yetaPayr3200Service.PdfYeta7200_F102Y_PDF_J203Y_Select(yetaPdfJ203ySrhVo);  
		
		if (infcPkgPdfJ203yList.size() > 0) { 
			
			for(int icnt = 0;icnt < infcPkgPdfJ203yList.size();icnt++) {
				
					InfcPkgPdfJ203y_2022_VO vPdfJ203yVo = new InfcPkgPdfJ203y_2022_VO();
	                ...
	                if (vPdfJ203yVo.getDatCd().equals("G0017")) {
	                    ...
	                    //’2011.12.31 이전 차입분으로 상환기간 15년 미만 , 공제한도 600만원
	                    ...
	                    // ’2011.12.31 이전 차입분으로 상환기간 30년이상, 공제한도 1500만원
	                      edSpchRe15   = edSpchRe15.add(vPdfJ203yVo.getSumDdct());
	                   	 ...
	                   	 if (( vPdfJ203yVo.getFixedRateDebt().compareTo(BigDecimal.ZERO) > 0)  
	                          ...
	                          //’2011.12.31 이후 ~ 2015.01.01 이전 차입분으로 상환기간 15년이상이면서 고정금리이거나 비거치식상환인 경우 , 공제한도 1500만원
	                          edSPCH_REFX   = edSPCH_REFX.add(vPdfJ203yVo.getSumDdct()); 
	                       		   //+ strtofloat(subXmlItemData.NamedItem['sum'].Text);
	                   	 }
	                       else
	                       {
	                          //’2011.12.31 이후 ~ 2015.01.01 이전 차입분으로 상환기간 15년이상이면서 기타대출인 경우, 공제한도 500만원
	                      ...
	                      if ( ( vPdfJ203yVo.getFixedRateDebt().compareTo(BigDecimal.ZERO) > 0)  
	                          ...
	                          //’2015.01.01 이후 차입분으로 상환기간 15년이상이면서 고정금리이면서 비거치식상환, 공제한도 1800만원
	                          edSPCH_15FX   = edSPCH_15FX.add(vPdfJ203yVo.getSumDdct());
	                       		   //+ strtofloat(subXmlItemData.NamedItem['sum'].Text);
	                       } else  if  (( vPdfJ203yVo.getFixedRateDebt().compareTo(BigDecimal.ZERO) > 0)  
	              		     ||  ( vPdfJ203yVo.getNotDeferDebt().compareTo(BigDecimal.ZERO) > 0)) {
	                   	 
	                          //’2015.01.01 이후 차입분으로 상환기간 15년이상이면서 고정금리이거나  비거치식상환, 공제한도 1500만원
	                          edSPCH_15FB  = edSPCH_15FB.add(vPdfJ203yVo.getSumDdct()); 
	                       		   //+ strtofloat(subXmlItemData.NamedItem['sum'].Text);
	                       }
	                       else
	                       {
	                          //’2015.01.01 이후 차입분으로 상환기간 15년이상이면서 기타대출, 공제한도 500만원
	                      ...
	                      if  (( vPdfJ203yVo.getFixedRateDebt().compareTo(BigDecimal.ZERO) > 0)  
	   	                                		  ||  ( vPdfJ203yVo.getNotDeferDebt().compareTo(BigDecimal.ZERO) > 0)) { 
	                          //’2015.01.01 이후 차입분으로 상환기간 10년 이상 15년 이하이면서 고정금리이거나 비거치식상환, 공제한도 300만원
			...
			//장기 주택 차입금
			InfcPkgYe161060_2022_VO infcPkgYe161060Vo = new InfcPkgYe161060_2022_VO();
...
//          yeta2000Vo.setSpch10fb(edSPCH_10FB); // 특별공제_15장기주택저당_10고정 OR 비거치상환
			...
			// 장기 주택 차입금 합계  
	         yetaPayr3200Service.fnYeta7200_J203Y_YE161060_2022_Update(infcPkgYe161060Vo); 
