...
public class Func2019_Pdf_J401Y {
	...
	public static void func_2019_J401Y_J401M(InfcPkgYe161010_2019_VO ye161010VO, Element  subXmlElForm, String nResult, HttpServletRequest request ) throws Exception{
		...
		InfcPkgPdfJ401y_2019_VO yetaPdfJ401yVo = new InfcPkgPdfJ401y_2019_VO();
		InfcPkgPdfJ401m_2019_VO yetaPdfJ401mVo = new InfcPkgPdfJ401m_2019_VO();
		...
		for (int j = 0; j < subXmlElChildForm.getLength();j++) { 
			...
			for(int k = 0; k < subXmlElChildMan.getLength();k++) {  
				...
				if (strDatCd.equals("G0023")) {
					...
					yetaPayr3200Service.yeta4200_PDF_J401Y_2019_Delete(yetaPdfJ401yVo);
					yetaPayr3200Service.yeta4200_PDF_J401Y_2019_Insert(yetaPdfJ401yVo);
				}
			}
