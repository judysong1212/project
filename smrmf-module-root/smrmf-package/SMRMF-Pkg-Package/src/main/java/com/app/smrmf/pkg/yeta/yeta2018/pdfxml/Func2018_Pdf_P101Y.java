...
public class Func2018_Pdf_P101Y {
	...
	public static void func_2018_P101Y_P101M(InfcPkgYe161010_2018_VO ye161010VO, Element  subXmlElForm, String nResult, HttpServletRequest request ) throws Exception{
		...
		InfcPkgPdfP101y_2018_VO yetaPdfP101yVo = new InfcPkgPdfP101y_2018_VO();
		InfcPkgPdfP101m_2018_VO yetaPdfP101mVo = new InfcPkgPdfP101m_2018_VO();
			...
			for(int k = 0; k < subXmlElChildMan.getLength();k++) {  
				...
				if (strDatCd.equals("G0031")) {
					...
					for(int i = 0; i < subXmlElChildSum.getLength(); i++) {  
						...
						yetaPayr3200Service.yeta3200_PDF_P101Y_2018_Delete(yetaPdfP101yVo);
						yetaPayr3200Service.yeta3200_PDF_P101Y_2018_Insert(yetaPdfP101yVo);
					}
	...
	public static void setPdfP101mVo(InfcPkgPdfP101m_2018_VO yetaPdfP101mVo , HttpServletRequest request, Element subXmlElData) throws Exception{
		...
		yetaPayr3200Service.yeta3200_PDF_P101M_2018_Delete(yetaPdfP101mVo);
		yetaPayr3200Service.yeta3200_PDF_P101M_2018_Insert(yetaPdfP101mVo);
