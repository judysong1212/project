...
public class Func2020_Pdf_F102Y {
	...
	public static void func_2020_F102Y_F102M(InfcPkgYe161010_2020_VO ye161010VO, Element  subXmlElForm, String nResult , HttpServletRequest request ) throws Exception{
		...
		InfcPkgPdfF102y_2020_VO yetaPdfF102yVo = new InfcPkgPdfF102y_2020_VO();
		InfcPkgPdfF102m_2020_VO yetaPdfF102mVo = new InfcPkgPdfF102m_2020_VO();
...
//					yetaPdfF102yVo.setRetirPnsnAmtSum(new BigDecimal(MSFSharedUtils.defaultNulls(PkgFuncUtils.getXmlTagValue("sum", subXmlElData), "0")));
					...
					yetaPayr3200Service.yeta5200_PDF_F102Y_2020_Delete(yetaPdfF102yVo);
					yetaPayr3200Service.yeta5200_PDF_F102Y_2020_Insert(yetaPdfF102yVo);
				}
			}
	...
	public static void func_2020_F102Y_YetaCalc(InfcPkgYe161010_2020_VO ye161010VO, HttpServletRequest request) throws Exception{ 
		...
		InfcPkgYe162020_2020_VO infcPkgYe162020Vo = new InfcPkgYe162020_2020_VO();
		...
		//퇴직연금
		yetaPayr3200Service.PdfYeta5200_F102Y_YE162020_Delete(infcPkgYe162020Vo); 
		yetaPayr3200Service.PdfYeta5200_F102Y_YE162020_Insert(infcPkgYe162020Vo); 
		...
		// 퇴직연금 합계  
         yetaPayr3200Service.fnYeta5200_F102Y_YE161080_2020_Update(infcPkgYe161080Vo); 
