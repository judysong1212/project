...
public class Func2023_Pdf_G207Y {
	...
	public static void func_2023_G207Y_G207M(InfcPkgYe161010_2023_VO ye161010VO, Element  subXmlElForm, String nResult , HttpServletRequest request ) throws Exception{
		...
		InfcPkgPdfG207y_2023_VO yetaPdfG207yVo = new InfcPkgPdfG207y_2023_VO();
		InfcPkgPdfG207m_2023_VO yetaPdfG207mVo = new InfcPkgPdfG207m_2023_VO();
		...
		yetaPayr3200Service.yeta8200_PDF_G207Y_2023_Delete(yetaPdfG207yVo);
		...
		yetaPayr3200Service.yeta8200_PDF_G207M_2023_Delete(yetaPdfG207mVo);
		...
		for (int j = 0; j < subXmlElChildForm.getLength();j++) { 
			...
			yetaPayr3200Service.yeta8200_PDF_G207M_2023_Insert(yetaPdfG207mVo);
	...
	public static void setPdfG207yVo(InfcPkgPdfG207y_2023_VO yetaPdfG207yVo , HttpServletRequest request) throws Exception{
		...
		yetaPayr3200Service.yeta8200_PDF_G207Y_2023_Insert(yetaPdfG207yVo);

	}
	

	public static void func_2023_G207Y_YetaCalc(InfcPkgYe161010_2023_VO ye161010VO, HttpServletRequest request) throws Exception{ 
		...
		yetaPayr3200Service.yeta8200_PDF_G207M_2023_Update(yetaPdfG207mVo);
		...
		dataChk = yetaPayr3200Service.PdfYeta2023_G207Y_YE161040_Update(infcPkgYe161040Vo); 
		...
		if (dataChk >= 0) {
			...
			// 신용카드  
	         yetaPayr3200Service.fnYeta8200_G207Y_YE161070_2023_Update(infcPkgYe161070Vo); 
