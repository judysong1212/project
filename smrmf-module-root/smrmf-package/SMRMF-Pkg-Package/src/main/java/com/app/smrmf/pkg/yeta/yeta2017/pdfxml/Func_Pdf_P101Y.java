...
public class Func_Pdf_P101Y {
	...
	public static void func_2017_P101Y_P101M(InfcPkgYe161010VO ye161010VO, Element  subXmlElForm, String nResult, HttpServletRequest request ) throws Exception{
		...
		InfcPkgPdfP101yVO yetaPdfP101yVo = new InfcPkgPdfP101yVO();
		InfcPkgPdfP101mVO yetaPdfP101mVo = new InfcPkgPdfP101mVO();
			...
			for(int k = 0; k < subXmlElChildMan.getLength();k++) {  
				...
				if (strDatCd.equals("G0031")) {
					...
					for(int i = 0; i < subXmlElChildSum.getLength(); i++) {  
						...
						yetaPayr2200Service.yeta2200_PDF_P101Y_2017_Delete(yetaPdfP101yVo);
						yetaPayr2200Service.yeta2200_PDF_P101Y_2017_Insert(yetaPdfP101yVo);
					}
	...
	public static void setPdfP101mVo(InfcPkgPdfP101mVO yetaPdfP101mVo , HttpServletRequest request, Element subXmlElData) throws Exception{
		...
		yetaPayr2200Service.yeta2200_PDF_P101M_2017_Delete(yetaPdfP101mVo);
		yetaPayr2200Service.yeta2200_PDF_P101M_2017_Insert(yetaPdfP101mVo);
