package com.app.smrmf.pkg.yeta.yeta2017.file;
...
@Controller
public class Yeta2400PkgFileController {


    private static final Logger logger = LoggerFactory.getLogger(Yeta2400PkgFileController.class);  
 
    
    @Resource(name = "Yeta2400PayrService")
    private Yeta2400PayrService yeta2400PayrService;
    ...
    public Yeta2400PkgFileController() {
    ...
    * @param ye161010VO
    */
  public int fnYeta2400_Tax_Ye161010_File_Create(HttpServletRequest request,InfcPkgYe161010VO  ye161010VO,HttpServletResponse response) throws Exception  {
	  
	  if  (yeta2400PayrService== null) {
		    WebApplicationContext wac = WebApplicationContextUtils.
		    		getRequiredWebApplicationContext( request.getSession().getServletContext());
		  
		    yeta2400PayrService = (Yeta2400PayrService) wac.getBean("Yeta2400PayrService");
		}
...
//    resultString : string;
    ...
    infcPkgYe161005Vo  = yeta2400PayrService.selectYe161005(ye161010VO);
    ...
    //{근로소득지급명세서}
	   /********************************************************암호화 처리 를 위해 반드시 해야 함................................*/
        ...
        defBUNS_LINS = StringUtils.replace(infcPkgYe161005Vo.getBusoprRgstnum(),"-","");   //사업자번호
         ...
         A_Record = ("A" + "20" + infcPkgYe161005Vo.getTxOffcCd() + String.format("%08d", Long.parseLong(StringUtils.replace(ye161010VO.getEdacPrdt(),"-","")))
                       ...
                       +  PkgFuncUtils.getRHanPad( PkgFuncUtils.subStringBytes(infcPkgYe161005Vo.getCorpFmnmNm() ,38),40," ")  
      ...
      try {
    	  ...
    	  Map mapYetaB = yeta2400PayrService.fnPayrB_ReTax_Total_Select(infcPkgYe161020Vo); 
...
//           Exit;
    	...
    	//  if (MSFSharedUtils.paramNull(StringUtils.replace(ye161010VO.getJuriNumb(),"-","")) || StringUtils.replace(ye161010VO.getJuriNumb(),"-","").equals("null")) {
           ...
           List listYetaC = yeta2400PayrService.fnPayrC_ReTax_Total_Select(infcPkgYe161020Vo);
          ...
          while ( iter.hasNext() ) { 
           ...
           Map<String, Object> mapYetaC = (Map<String, Object>) iter.next();  
               ...
               //  oraQrySelect01.FieldByName('CITY_SEQN').AsString; Format('%.11d', [])
                             ...
                             C_RecStr = C_RecStr   + infcPkgYe161005Vo.getTxOffcCd(); //세무서코드 
                             C_RecStr = C_RecStr + String.format("%06d", C_Cnt);    //원천징수읨주별로 1부터 순차부여 
                             C_RecStr = C_RecStr  +  String.format("%-10s", StringUtils.replace(MSFSharedUtils.allowNulls(mapYetaC.get("bsnoEncCntn")),"-",""));  //사업자등록번호 
                             ...
                             C_RecStr = C_RecStr  + PkgFuncUtils.getRHanPad( PkgFuncUtils.subStringBytes(MSFSharedUtils.defaultNulls(mapYetaC.get("fnm"),"") ,28),30," ") ;    //성명
                          ...
                          // 주민번호(복호화)
                             ...
                             C_RecStr = C_RecStr   + String.format("%-10s", StringUtils.replace(MSFSharedUtils.allowNulls(mapYetaC.get("bsnoEncCntn")),"-","")) ;            //주현근무처-사업자등록번호
                             C_RecStr = C_RecStr   + PkgFuncUtils.getRHanPad( PkgFuncUtils.subStringBytes(MSFSharedUtils.allowNulls(mapYetaC.get("tnm")) ,38),40," ") ;                                     //주현근무처-근무처명
                            ...
                            C_RecStr = C_RecStr   +  String.format("%011d", Long.parseLong(MSFSharedUtils.defaultNulls(mapYetaC.get("yeta0c29"),"0"))) ;                    //계
                     ...
                     //       C_RecStr = C_RecStr   + FormatFloat('0000000000', mTempData02);
                          ...
                          //  C_RecStr = C_RecStr   + "0000000000";//공란 0으로 10자리       
                            ...
                            //연금보험료공제 
                            mTempData02 =  Long.parseLong( MSFSharedUtils.defaultNulls(mapYetaC.get("yeta0c76"),"0"));    /*(31) column_국민연금보험료공제 : JNAT_DDCT */       
                            C_RecStr = C_RecStr   + String.format("%010d",  mTempData02) ;
                            mTempData02 =  Long.parseLong( MSFSharedUtils.defaultNulls(mapYetaC.get("yeta0c77"),"0"));    /*(32)-가 column  _공무원연금보험료공제 : JPSS_HPUL */   
                            C_RecStr = C_RecStr  + String.format("%010d",  mTempData02);
                            mTempData02 =  Long.parseLong( MSFSharedUtils.defaultNulls(mapYetaC.get("yeta0c78"),"0"));    /*(32)-나 column 주근무지_국민연금외군인연금공제 : JPSS_HSOL */  
                            C_RecStr = C_RecStr   + String.format("%010d", mTempData02) ;
                            mTempData02 =  Long.parseLong( MSFSharedUtils.defaultNulls(mapYetaC.get("yeta0c79"),"0"));    /*(32)-다 column 주근무지_국민연금외교직원연금공제 : JPSS_HTEC */ 
                            C_RecStr = C_RecStr   + String.format("%010d",  mTempData02) ;
                            mTempData02 = Long.parseLong( MSFSharedUtils.defaultNulls(mapYetaC.get("yeta0c80"),"0"));        /*(32)-라 column_별정우체국연금보험료공제 : JPSS_DDCT */   
                            C_RecStr = C_RecStr   + String.format("%010d",  mTempData02);
                        ...
                        //  C_RecStr = C_RecStr   + FormatFloat('0000000000', mTempData02) ;
                            ...
                            //특별소득공제 
                            mTempData02 = Long.parseLong( MSFSharedUtils.defaultNulls(mapYetaC.get("yeta0c81"),"0"));   /*(33)-가 column 특별공제_주건강보험료 : SPCI_JHTH */   
                            C_RecStr = C_RecStr   + String.format("%010d",  mTempData02) ;
                            mTempData02 = Long.parseLong( MSFSharedUtils.defaultNulls(mapYetaC.get("yeta0c82"),"0"));    /*(33)-나 column 특별공제_주고용보험료 : SPCI_JEPF */   
                            C_RecStr = C_RecStr   + String.format("%010d",  mTempData02);
                      ...
                      //      C_RecStr = C_RecStr  + FormatFloat('00000000', mTempData02);
                        ...
                        //    C_RecStr = C_RecStr   + FormatFloat('0000000000', mTempData02);
                            C_RecStr = C_RecStr   + String.format("%-20s", "") ;
               ...
               List listYetaD = yeta2400PayrService.fnPayrD_ReTax_Total_Select(infcPkgYe161020Vo);
               ...
               if (listYetaD.size() > 0) { 
                   ...
                   while ( iter01.hasNext() ) { 
                     ...
                     mTempData02 = 0L;
                     D_RecStr = "";
                     D_RecStr = "D" + "20" + infcPkgYe161005Vo.getTxOffcCd();
                                 D_RecStr = D_RecStr +   String.format("%06d", C_Cnt);  
                                 D_RecStr = D_RecStr +  String.format("%-10s", StringUtils.replace(infcPkgYe161005Vo.getBusoprRgstnum(),"-",""));
                                 ...
                                 D_RecStr = D_RecStr + PkgFuncUtils.getRHanPad( PkgFuncUtils.subStringBytes(MSFSharedUtils.defaultNulls(mapYetaD.get("prcspFmnmNm"),"") ,38),40," ") ;
                                 D_RecStr = D_RecStr + String.format("%-10s", MSFSharedUtils.defaultNulls(mapYetaD.get("prcspBusoprRgstnum"),""))  ;
                                 D_RecStr = D_RecStr + String.format("%08d",Long.parseLong(MSFSharedUtils.defaultNulls(mapYetaD.get("prcspDutyBgnnDt"),"0"))); 
                                 D_RecStr = D_RecStr + String.format("%08d",Long.parseLong(MSFSharedUtils.defaultNulls(mapYetaD.get("prcspDutyEndDt"),"0"))); 
                                 D_RecStr = D_RecStr + String.format("%08d",Long.parseLong(MSFSharedUtils.defaultNulls(mapYetaD.get("prcspReduBgnnDt"),"0"))); 
                                 D_RecStr = D_RecStr + String.format("%08d",Long.parseLong(MSFSharedUtils.defaultNulls(mapYetaD.get("prcspReduEndDt"),"0"))); 
               ...
               List listYetaE = yeta2400PayrService.fnPayrE_ReTax_Total_Select(infcPkgYe161020Vo);
               ...
               if ( listYetaE.size() > 0) { 
                 ...
                 if (listYetaE.size() + 1 > E_RowCnt)  {
                             ...
                             // E_RecStr =  E_RecStr + MSFSharedUtils.defaultNulls(mapYetaE.get("relhCode")," ");  
                                  ...
                                  E_RecStr = E_RecStr + PkgFuncUtils.getRHanPad( PkgFuncUtils.subStringBytes(MSFSharedUtils.defaultNulls(mapYetaE.get("txprNm"),"") ,18),20," ")   ;
                               ...
                               // 주민번호(복호화)
                                  ...
                                  E_RecStr = E_RecStr+ MSFSharedUtils.defaultNulls(mapYetaE.get("sccDdcClCd")," ");  

                                  E_RecStr = E_RecStr+ MSFSharedUtils.defaultNulls(mapYetaE.get("snprntFmlyDdcClCd")," ");  

                                  E_RecStr = E_RecStr+ MSFSharedUtils.defaultNulls(mapYetaE.get("chbtAtprDdcClCd")," ");  
...
//                             	 }      
              ...
              // F레코드  - 연금저축등 소득세액공제명세 레코드 
               ...
               List listYetaF = yeta2400PayrService.fnPayrF_ReTax_Total_Select(infcPkgYe161020Vo);
               ...
               if ( listYetaF.size() > 0) { 
                 ...
                 if (listYetaF.size() + 1 > F_RowCnt)  {
                                ...
                                F_RecStr = F_RecStr + String.format("%-2s", MSFSharedUtils.defaultNulls(mapYetaF.get("rtpnAccRtpnCl"),""))   
                                   ...
                                   + PkgFuncUtils.getRHanPad( PkgFuncUtils.subStringBytes(MSFSharedUtils.defaultNulls(mapYetaF.get("rtpnAccFnnCmp"),""),48),50," ")  
...
//              	 }     
      ...
      else
      {
             ...
             F_RowCnt =  F_RowCnt + 1;
               ...
               List listYetaG = yeta2400PayrService.fnPayrG_ReTax_Total_Select(infcPkgYe161020Vo);
                       ...
                       if (listYetaG.size() + 1 > G_RowCnt)  {
                    	...
                    	// 주민번호(복호화)
          				  rrnDecCrypt = AnyCryptUtils.getDecSyncCrypt(nResult,MSFSharedUtils.defaultNulls(mapYetaG.get("mnthRnttyBurRgsum"),"").replace("-", ""),AnyCryptUtils.SEC_RRNUMC);
                                    ...
                                    G_RecStr = G_RecStr + PkgFuncUtils.getRHanPad( PkgFuncUtils.subStringBytes(MSFSharedUtils.defaultNulls(mapYetaG.get("mnthRnttyLehdrNm"),""),18),20," ")  
                                       +  String.format("%-13s", rrnDecCrypt);
                                       ...
                                       rrnDecCrypt = AnyCryptUtils.getDecSyncCrypt(nResult,MSFSharedUtils.defaultNulls(mapYetaG.get("comrCdtrResnRegnNum"),"").replace("-", ""),AnyCryptUtils.SEC_RRNUMC);
                                        ...
                                        G_RecStr = G_RecStr + PkgFuncUtils.getRHanPad( PkgFuncUtils.subStringBytes(MSFSharedUtils.defaultNulls(mapYetaG.get("comrCdtrNm"),"") ,18),20," ") 
                                       + String.format("%-13s", rrnDecCrypt ) ;
                                       G_RecStr = G_RecStr + MSFSharedUtils.defaultNulls(mapYetaG.get("comrCnttPridBgnnDt"),"") ;
                                       G_RecStr = G_RecStr + MSFSharedUtils.defaultNulls(mapYetaG.get("comrCnttPridEndDt"),"")  ;
                                       ...
                                       G_RecStr = G_RecStr + PkgFuncUtils.getRHanPad( PkgFuncUtils.subStringBytes( MSFSharedUtils.defaultNulls(mapYetaG.get("rntlCttLehdrNm"),"") ,18),20," ")  
                                       + String.format("%-13s", rrnDecCrypt  );
...
//                    	 }     
     	  ...
     	  //      DEFIN = "H"; //기부금  
	        ...
	        //    Map<String, Object> mapTotData01 = (Map<String, Object>) iter.next();  
	            ...
	            List listHCData = yeta2400PayrService.fnPayrHC_ReTax_Total_Select(infcPkgYe161020Vo);  
...
//	                     } 
	                    ...
	                    strTempDataH =  "H" + "20" ;
	                    strTempDataH = strTempDataH + infcPkgYe161005Vo.getTxOffcCd(); //세무서코드 
                     mTempDataH = Long.parseLong(String.valueOf(C_Cnt));
                     strTempDataH = strTempDataH +   String.format("%06d", mTempDataH);    //소득자일련번호 
                     strTempDataH = strTempDataH  +  String.format("%-10s", StringUtils.replace(infcPkgYe161005Vo.getBusoprRgstnum(),"-",""))
                     + String.format("%-13s",rrnDecCrypt ) ; //사업자등록번호
                     ...
                     strTempDataH = strTempDataH +   String.format("%01d", mTempDataH);     
...
// 	     			    bmResult.add(yetaMessVo);
                     ...
                     strTempDataH = strTempDataH  +  String.format("%-2s",  MSFSharedUtils.defaultNulls(mapHCData.get("ctrbTycd"),""));    //유형코드
...
//  	     			     bmResult.add(yetaMessVo);
                     ...
                     strTempDataH = strTempDataH  +   String.format("%04d", mTempDataH);    //기부연도
                     ...
                     strTempDataH = strTempDataH  + String.format("%013d", mTempDataH);  //공제대상금액  -13
                     
                     strTempDataH = strTempDataH  + "0000000000000" ;   //해당년도공제금액 필요경비 THC_YR_DDC_AMT_ND_XPS
                     ...
                     strTempDataH = strTempDataH  + String.format("%013d", mTempDataH); //해당년도에 공제받지못한금액_이월금액 -3
                     strTempDataH = strTempDataH  + String.format("%05d", H_RowCnt);       //기부금조정명세일련번호 -5
                     strTempDataH = strTempDataH  + String.format("%1452s", "");      //공란 -25
		          ...
		          infcPkgYe161020Vo.setSystemkey(MSFSharedUtils.allowNulls(mapYetaC.get("systemkey")));
	              //I레코드 - 해당연도 기부명세 레코드  
	              List listHDData = yeta2400PayrService.fnPayrHD_ReTax_Total_Select(infcPkgYe161020Vo); 
	             ...
	             if (listHCData.size() > 0) { 
		          ...
		          while ( iter02.hasNext() ) { 
		            ...
		            Map<String, Object> mapHDData = (Map<String, Object>) iter02.next();
                       ...
                       strTempDataI = strTempDataI +  String.format("%-13s", StringUtils.replace(MSFSharedUtils.defaultNulls(mapHDData.get("bsnoEncCntn"),""),"-",""));    //사업자등록번호

                       strTempDataI = strTempDataI + PkgFuncUtils.getRHanPad(PkgFuncUtils.subStringBytes(MSFSharedUtils.defaultNulls(mapHDData.get("coplNm"),""),28),30," ");
                       ...
                       strTempDataI = strTempDataI +  PkgFuncUtils.getRHanPad(PkgFuncUtils.subStringBytes(MSFSharedUtils.defaultNulls(mapHDData.get("cnbtFnm"),""),18),20," "); 
                       ...
                       strTempDataI = strTempDataI +  String.format("%-13s", rrnDecCrypt);    //기부자주민등록번호 
                       ...
                       strTempDataI = strTempDataI +  String.format("%013d", mTempDataI);     //기부장려신청금액

                       strTempDataI = strTempDataI +  "0000000000000";
                       
                       strTempDataI = strTempDataI + String.format("%05d", I_Cnt);    //일련번호 
                       
                       strTempDataI = strTempDataI +  String.format("%1443s", "");    //공란 42
               ...
               // infcPkgYeta17FileDAO.updateYeta2400ToYe161010_S
              ye161010VO.setSystemkey(MSFSharedUtils.allowNulls(mapYetaC.get("systemkey"))); 
              yeta2400PayrService.updateYeta2400ToYe161010(ye161010VO); 

          } 
          
       
          
          File dir = new File("C:/EOSDATA/2017/");
          //디렉토리가 없으면 생성
          if(!dir.isDirectory()){
           dir.mkdirs();
          }
...
//        TOT_Record.SaveToFile('C:\EOSDATA\' + DEFIN + leftStr(defBUNS_LINS,7) + '.' + rightStr(defBUNS_LINS,3) + '.denc');
          String fileDir = "C:/EOSDATA/2017/" + DEFIN + StringUtils.left(defBUNS_LINS,7) + "." + StringUtils.right(defBUNS_LINS,3) + ".denc";
         // FileWriter fw = new FileWriter(fileDir); // 절대주소 경로 가능
          ...
          File objFile = new File("C:/EOSDATA/2017/" + DEFIN + StringUtils.left(defBUNS_LINS,7) + "." + StringUtils.right(defBUNS_LINS,3) + ".denc");
...
//	   	   retval =  new BasePagingLoadResult<ShowMessageBM>(bmResult, 0, bmResult.size());   
  ...
  public int fnYeta2400_Tax_Ye1611010_File_Create(HttpServletRequest request,InfcPkgYe161010VO  ye161010VO,HttpServletResponse response) throws Exception  {
...
//		  
//		  
//		  Map mapYetaB = yeta2400PayrService.fnPayrB_ReTax_Total_Select(ye161010VO); 
//		  
//		  if (mapYetaB.isEmpty()) { 
////           showMessage('B레코드 생성을 위한 정산데이터가 생성되지 않은것 같습니다. 확인후 파일생성을 해 주십시요.');
////           Result = -1;
...
//		  
//		  //c레코드 주현근무처 레코드 fnPayrC_ReTax_Total_Select
//		  List listYetaC = yeta2400PayrService.fnPayrC_ReTax_Total_Select(ye161010VO);
//		  
//		  if (listYetaC.size() <= 0) {  
//			  throw new Exception("C레코드 생성을 위한 정산데이터가 생성되지 않은것 같습니다. 확인후 파일생성을 해 주십시요.");  
//		  } 
...
//			  ye161010VO.setSystemkey(MSFSharedUtils.allowNulls(mapYetaC.get("systemkey")));
//			  
//			  List listYetaD = yeta2400PayrService.fnPayrD_ReTax_Total_Select(ye161010VO);
//			  
//			  
//			  
//			  if (listYetaD.size() > 0) { 
...
//			  ye161010VO.setSystemkey(MSFSharedUtils.allowNulls(mapYetaC.get("systemkey")));
//			  
//			  List listYetaE = yeta2400PayrService.fnPayrE_ReTax_Total_Select(ye161010VO);
//			  
//			  
//			  
//			  if ( listYetaE.size() > 0) { 
...
//			  ye161010VO.setSystemkey(MSFSharedUtils.allowNulls(mapYetaC.get("systemkey")));
//			  
//			  List listYetaF = yeta2400PayrService.fnPayrF_ReTax_Total_Select(ye161010VO);
//			  
//			  
//			  if ( listYetaF.size() > 0) { 
//				  
...
//			  ye161010VO.setSystemkey(MSFSharedUtils.allowNulls(mapYetaC.get("systemkey")));
//			  
//			  List listYetaG = yeta2400PayrService.fnPayrG_ReTax_Total_Select(ye161010VO);
//			  
//			  
//			  if ( listYetaG.size() > 0) { 
//				  
...
//	  }
      ...
      * @param ye161010VO
      */
  public int fnYeta2400_Tax_Ye164010_File_Create(HttpServletRequest request,InfcPkgYe161010VO  ye161010VO,HttpServletResponse response) throws Exception  {
    	...
    	try {
    		...
    		// A레코드 - 의료비지급명세서 레코드
    		List listYetaCA = yeta2400PayrService.fnPayrPSNL_ReTax_CA_Total_Select(infcPkgYe161020Vo);
    		...
    		if  (listYetaCA.size() > 0) { 
    		  ...
    		  //	for (int i = 0 ; i < listYeta1.size() ; i++) { 
    	            ...
    	            List listCAYeta = yeta2400PayrService.fnPayrCA_ReTax_Total_Select(infcPkgYe161020Vo);
...
//	   	   retval =  new BasePagingLoadResult<ShowMessageBM>(bmResult, 0, bmResult.size());   
  ...
  * @throws Exception
  */
  public int fnYeta2400_Tax_Ye165010_File_Create(HttpServletRequest request,InfcPkgYe161010VO  ye161010VO,HttpServletResponse response) throws Exception { 
...
// 	       
// 	    	//B레코드 - 원천징수의무자별 집계레코드 
// 	       Map mapHb = yeta2400PayrService.fnPayrHB_ReTax_Total_Select(ye161010VO);
// 	        
...
// 	          
// 	         //C 레코드 - 기부금 조정명세 레코드  
// 	         List listTotData01 = yeta2400PayrService.fnPayrPSNL_ReTax_Total_Select(ye161010VO);
// 	          
//
...
// 	              //SYSTEMKEY 가지고 데이타 가져오기 
//	            //C 레코드 - 기부금 조정명세 레코드  YETA3170
//	            List listHCData = yeta2400PayrService.fnPayrHC_ReTax_Total_Select(ye161010VO);  
//	             
...
// 	             
// 	              //D레코드 - 해당연도 기부명세 레코드  
// 	              List listHDData = yeta2400PayrService.fnPayrHD_ReTax_Total_Select(ye161010VO); 
// 	               
// 	             if (listHCData.size() > 0) { 
//	              
//	              Iterator<Map<String, Object>> iter02 = listHDData.iterator(); 
...
//      } 
  ...
  public List<YetaMessageVO> fnYeta2400_Tax_Ye161010_File_Check(HttpServletRequest request,InfcPkgYe161010VO  ye161010VO,HttpServletResponse response) throws Exception  {
...
//      }
      ...
      * @param ye161010VO
      */
  public List<YetaMessageVO> fnYeta2400_Tax_Ye164010_File_Check(HttpServletRequest request,InfcPkgYe161010VO  ye161010VO,HttpServletResponse response) throws Exception  {
...
//    	try {
//    		// A레코드 - 의료비지급명세서 레코드
//    		List listYetaCA = yeta2400PayrService.fnPayrPSNL_ReTax_CA_Total_Select(ye161010VO);
//
//    		if  (listYetaCA.size() > 0) { 
// 
//    		 	A_Cnt = 1;
...
//    	            
//    	            //A레코드 - 의료비지급명세서 레코드  내역 
//    	            List listCAYeta = yeta2400PayrService.fnPayrCA_ReTax_Total_Select(ye161010VO);
//    				
//    	            Iterator<Map<String, Object>> iter01 = listCAYeta.iterator(); 
//     	      	   
//      	            while ( iter01.hasNext() ) { 
...
//      }
  ...
  * @throws Exception
  */
 public List<YetaMessageVO> fnYeta2400_Tax_Ye165010_File_Check(HttpServletRequest request,InfcPkgYe161010VO  ye161010VO,HttpServletResponse response) throws Exception { 
