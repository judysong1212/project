...
@Repository("InfcPkgYeta3130DAO")
public class InfcPkgYeta3130DAO extends EgovAbstractDAO {
    ...
    public String insertYeta3130(InfcPkgYeta3130VO vo) throws Exception {
        return (String)insert("infcPkgYeta3130DAO.insertYetaPrc3130_S", vo);
    }
    ...
    public void updateYeta3130(InfcPkgYeta3130VO vo) throws Exception {
        update("infcPkgYeta3130DAO.updateYetaPrc3130_S", vo);
    }
    ...
    public void deleteYeta3130(InfcPkgYeta3130VO vo) throws Exception {
        delete("infcPkgYeta3130DAO.deleteYetaPrc3130_S", vo);
    }
    ...
    public void fnPayr06430_PAYR452_CREATE_Delete(InfcPkgYeta3130VO vo) throws Exception {
        delete("infcPkgYeta3130DAO.fnPayr06430_PAYR452_CREATE_Delete_S", vo);
    }
    ...
    public int selectYeta3130ListTotCnt(InfcPkgYeta3130SrhVO searchVO) {
        return (Integer)getSqlMapClientTemplate().queryForObject("infcPkgYeta3130DAO.selectYetaPrc3130ListTotCnt_S", searchVO);
    }
