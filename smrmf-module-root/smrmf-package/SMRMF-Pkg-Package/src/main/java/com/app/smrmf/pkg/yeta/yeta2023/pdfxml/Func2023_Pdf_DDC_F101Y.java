...
public class Func2023_Pdf_DDC_F101Y {
	...
	public static void func_2023_F101Y(InfcPkgYe161010_2023_VO ye161010Vo, Element  xmlelDoc, Element  subXmlElForm, String nResult, HttpServletRequest request) throws Exception{ 
		...
		InfcPkgYe167510_2023_VO ye167510Vo = new InfcPkgYe167510_2023_VO();
		InfcPkgYe167520_2023_VO ye167520Vo = new InfcPkgYe167520_2023_VO();
...
//			String strValue = AnyCryptUtils.getEncSyncCrypt(nResult,MSFSharedUtils.allowNulls(strResno).replaceAll("-",""),AnyCryptUtils.SEC_RRNUMC);	//주민번호
			...
			yetaPayr3200Service.yeta8200_PDF_YE167510_2023_Delete(ye167510Vo);	//기본정보 삭제
			...
			yetaPayr3200Service.yeta8200_PDF_YE167520_2023_Delete(ye167520Vo);	//인적공제 삭제	
			...
			yetaPayr3200Service.yeta8200_PDF_YE167510_2023_Insert(ye167510Vo);	//기본정보 입력
	...
	public static void setYe167520Vo(InfcPkgYe167520_2023_VO ye167520Vo , HttpServletRequest request) throws Exception{
		...
		yetaPayr3200Service.yeta8200_PDF_YE167520_2023_Insert(ye167520Vo);	//기본정보 입력
	}
