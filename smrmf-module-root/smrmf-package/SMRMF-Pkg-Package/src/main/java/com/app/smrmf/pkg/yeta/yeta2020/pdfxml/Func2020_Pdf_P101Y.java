...
public class Func2020_Pdf_P101Y {

	@Resource(name = "Yeta5200XmlService")
	private static Yeta5200XmlService yetaPayr5200Service;
	...
	public static void func_2020_P101Y_P101M(InfcPkgYe161010_2020_VO ye161010VO, Element  subXmlElForm, String nResult, HttpServletRequest request ) throws Exception{
		
		/**+++++++++++   국민연금보험료 시작++++++++++++++++++++++++++++++++++++++++++++++++*/
		//  국민연금보험료 시작
		if  (yetaPayr5200Service == null) { 
			WebApplicationContext wac = WebApplicationContextUtils.
					getRequiredWebApplicationContext( request.getSession().getServletContext());

			yetaPayr5200Service = (Yeta5200XmlService) wac.getBean("Yeta5200XmlService" ); 
		}
		strDatCd = "";

		InfcPkgPdfP101y_2020_VO yetaPdfP101yVo = new InfcPkgPdfP101y_2020_VO();
		InfcPkgPdfP101m_2020_VO yetaPdfP101mVo = new InfcPkgPdfP101m_2020_VO();
		...
		yetaPayr5200Service.yeta5200_PDF_YE162015_2020_Delete(yetaPdfYE162015Vo);
			...
			for(int k = 0; k < subXmlElChildMan.getLength();k++) {  
				...
				if (strDatCd.equals("G0041")) {
					...
					for(int i = 0; i < subXmlElChildSum.getLength(); i++) {  
						...
						yetaPayr5200Service.yeta5200_PDF_P101Y_2020_Delete(yetaPdfP101yVo);
						yetaPayr5200Service.yeta5200_PDF_P101Y_2020_Insert(yetaPdfP101yVo);
					}
		...
		yetaPayr5200Service.yeta5200_PDF_YE162015_2020_Insert(yetaPdfYE162015Vo);
	}
	
	public static void setPdfP101mVo(InfcPkgPdfP101m_2020_VO yetaPdfP101mVo , HttpServletRequest request, Element subXmlElData) throws Exception{
		...
		yetaPayr5200Service.yeta5200_PDF_P101M_2020_Delete(yetaPdfP101mVo);
		yetaPayr5200Service.yeta5200_PDF_P101M_2020_Insert(yetaPdfP101mVo);
