...
@Repository("InfcPkgYeta1000DAO")
public class InfcPkgYeta1000DAO extends EgovAbstractDAO {
    ...
    public String fnYeta1100_YETA1000_2016_CREATE_Insert(InfcPkgYeta1000VO vo) throws Exception {
        return (String)insert("infcPkgYeta1000DAO.fnYeta1100_YETA1000_2016_CREATE_Insert_S", vo);
    }
	
	@Transactional  
	public InfcPkgYeta1000VO selectYeta1100ToChkYetaPrc1000(InfcPkgYeta1000VO vo)throws Exception {
		return (InfcPkgYeta1000VO) selectByPk("infcPkgYeta1000DAO.selectYeta1100ToChkYetaPrc1000", vo);
	}		
	 ...
	 */
	@Transactional
    public String fnYeta2100_YETA1000_2017_CREATE_Insert(InfcPkgYeta1000VO vo) throws Exception {
        return (String)insert("infcPkgYeta1000DAO.fnYeta1100_YETA1000_2016_CREATE_Insert_S", vo);
    }
	
	@Transactional  
	public InfcPkgYeta1000VO selectYeta2100ToChkYetaPrc1000(InfcPkgYeta1000VO vo)throws Exception {
		return (InfcPkgYeta1000VO) selectByPk("infcPkgYeta1000DAO.selectYeta1100ToChkYetaPrc1000", vo);
	}	
    ...
    public String insertYeta1000(InfcPkgYeta1000VO vo) throws Exception {
        return (String)insert("infcPkgYeta1000DAO.insertYetaPrc1000_S", vo);
    }
    ...
    public String fnPayr06420_PAYR420_2014_CREATE_Insert(InfcPkgYeta1000VO vo) throws Exception {
        return (String)insert("infcPkgYeta1000DAO.fnPayr06420_PAYR420_2014_CREATE_Insert_S", vo);
    }
    ...
    public void updateYeta1000(InfcPkgYeta1000VO vo) throws Exception {
        update("infcPkgYeta1000DAO.updateYetaPrc1000_S", vo);
    }
    ...
    public void deleteYeta1000(InfcPkgYeta1000VO vo) throws Exception {
        delete("infcPkgYeta1000DAO.deleteYetaPrc1000_S", vo);
    }
    /**
	 * YETA1000을 삭제한다.
	 * @param vo - 삭제할 정보가 담긴 Yeta1000VO
    ...
    public void fnPayr06430_PAYR420_CREATE_Delete(InfcPkgYeta1000VO vo) throws Exception {
        delete("infcPkgYeta1000DAO.fnPayr06430_PAYR420_CREATE_Delete_S", vo);
    }
    ...
    public InfcPkgYeta1000VO selectYeta1000(InfcPkgYeta1000VO vo) throws Exception {
        return (InfcPkgYeta1000VO) selectByPk("infcPkgYeta1000DAO.selectYetaPrc1000_S", vo);
    }
    ...
    public InfcPkgYeta1000VO selectYeta0100ToCreateYetaPrc1000(InfcPkgYeta1000VO vo) throws Exception {
        return (InfcPkgYeta1000VO) selectByPk("infcPkgYeta1000DAO.selectYeta0100ToCreateYetaPrc1000_S", vo);
    }
    
    
    public InfcPkgYeta1000VO selectYeta0100ToChkYetaPrc1000(InfcPkgYeta1000VO vo) throws Exception {
        return (InfcPkgYeta1000VO) selectByPk("infcPkgYeta1000DAO.selectYeta0100ToChkYetaPrc1000", vo);
    }
    ...
    public List<?> selectYeta1000List(InfcPkgYeta1000SrhVO searchVO) throws Exception {
        return list("infcPkgYeta1000DAO.selectYetaPrc1000List_D", searchVO);
    }
    ...
    public int selectYeta1000ListTotCnt(InfcPkgYeta1000SrhVO searchVO) {
        return (Integer)getSqlMapClientTemplate().queryForObject("infcPkgYeta1000DAO.selectYetaPrc1000ListTotCnt_S", searchVO);
    }
