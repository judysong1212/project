...
public class Func2021_Pdf_J203Y {
	...
	public static void func_2021_J203Y_J203M(InfcPkgYe161010_2021_VO ye161010VO, Element  subXmlElForm, String nResult, HttpServletRequest request ) throws Exception{
		...
		InfcPkgPdfJ203y_2021_VO yetaPdfJ203yVo = new InfcPkgPdfJ203y_2021_VO();
		InfcPkgPdfJ203m_2021_VO yetaPdfJ203mVo = new InfcPkgPdfJ203m_2021_VO();
		...
		yetaPayr3200Service.yeta6200_PDF_J203Y_2021_Delete(yetaPdfJ203yVo);
		...
		yetaPayr3200Service.yeta6200_PDF_J203M_2021_Delete(yetaPdfJ203mVo);
	...
	public static void setPdfJ203yVo(InfcPkgPdfJ203y_2021_VO yetaPdfJ203yVo, InfcPkgPdfJ203m_2021_VO yetaPdfJ203mVo, InfcPkgYe161010_2021_VO ye161010VO, 
		...
		for(int i = 0; i < subXmlElChildSum.getLength(); i++) {  
			...
			yetaPayr3200Service.yeta6200_PDF_J203Y_2021_Insert(yetaPdfJ203yVo);
		}
	...
	public static void setPdfJ203mVo(InfcPkgPdfJ203m_2021_VO yetaPdfJ203mVo , HttpServletRequest request, Element subXmlElData) throws Exception{
		...
		yetaPayr3200Service.yeta6200_PDF_J203M_2021_Insert(yetaPdfJ203mVo);

	}
	
	public static void func_2021_J203Y_YetaCalc(InfcPkgYe161010_2021_VO ye161010VO, HttpServletRequest request) throws Exception{ 
		...
		InfcPkgPdfJ203ySrh_2021_VO yetaPdfJ203ySrhVo = new InfcPkgPdfJ203ySrh_2021_VO();
		...
		List<InfcPkgPdfJ203y_2021_VO> infcPkgPdfJ203yList = new ArrayList<InfcPkgPdfJ203y_2021_VO>();
		
		//장기주택저당차입금
		infcPkgPdfJ203yList = (List<InfcPkgPdfJ203y_2021_VO>)yetaPayr3200Service.PdfYeta6200_F102Y_PDF_J203Y_Select(yetaPdfJ203ySrhVo);  
		
		if (infcPkgPdfJ203yList.size() > 0) { 
			
			for(int icnt = 0;icnt < infcPkgPdfJ203yList.size();icnt++) {
				
					InfcPkgPdfJ203y_2021_VO vPdfJ203yVo = new InfcPkgPdfJ203y_2021_VO();
			...
			//장기 주택 차입금
			InfcPkgYe161060_2021_VO infcPkgYe161060Vo = new InfcPkgYe161060_2021_VO();
...
//          yeta2000Vo.setSpch10fb(edSPCH_10FB); // 특별공제_15장기주택저당_10고정 OR 비거치상환
			...
			// 장기 주택 차입금 합계  
	         yetaPayr3200Service.fnYeta6200_J203Y_YE161060_2021_Update(infcPkgYe161060Vo); 
