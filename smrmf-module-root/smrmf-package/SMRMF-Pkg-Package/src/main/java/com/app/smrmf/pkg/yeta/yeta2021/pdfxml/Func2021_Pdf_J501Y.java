...
public class Func2021_Pdf_J501Y {
	...
	private static final Logger logger = LoggerFactory.getLogger(Func2021_Pdf_J501Y.class);


	public static void func_2021_J501Y_J501M(InfcPkgYe161010_2021_VO ye161010VO, Element  subXmlElForm, String nResult, HttpServletRequest request) throws Exception{
		...
		InfcPkgPdfJ501y_2021_VO yetaPdfJ501yVo = new InfcPkgPdfJ501y_2021_VO();
		InfcPkgPdfJ501m_2021_VO yetaPdfJ501mVo = new InfcPkgPdfJ501m_2021_VO();
		...
		yetaPayr3200Service.yeta6200_PDF_J501Y_2021_Delete(yetaPdfJ501yVo);
		...
		for (int j= 0;j < subXmlElChildForm.getLength();j++)  {
			...
			for(int k = 0; k < subXmlElChildMan.getLength();k++) {  
				...
				if (strDatCd.equals("G0037")) { //월세액
					...
					yetaPayr3200Service.yeta6200_PDF_J501Y_2021_Insert(yetaPdfJ501yVo);*/
				} 
	...
	public static void setPdfJ501yVo (InfcPkgPdfJ501y_2021_VO yetaPdfJ501yVo, HttpServletRequest request, Element subXmlElData) throws Exception{
		if  (yetaPayr3200Service == null) { 
			WebApplicationContext wac = WebApplicationContextUtils.
					getRequiredWebApplicationContext( request.getSession().getServletContext());
	 ...
	 * </pre>
	 * @Method Name : func_2021_J501Y_YetaCalc
	 * @date : 2021. 1. 23.
	 * @author : atres
	 * @history : 
	 *	-----------------------------------------------------------------------
	 ...
	 * @throws Exception
	 */
	public static void func_2021_J501Y_YetaCalc(InfcPkgYe161010_2021_VO ye161010VO, HttpServletRequest request) throws Exception{ 
        ...
        //월세액시작,161080,162510
        //월세액
		InfcPkgYe162510_2021_VO infcPkgYe162510Vo = new InfcPkgYe162510_2021_VO();
		...
		//월세액 국세청 데이타 업데이트 
		yetaPayr3200Service.PdfYeta6200_J501Y_YE162510_Delete(infcPkgYe162510Vo); 
		yetaPayr3200Service.PdfYeta6200_J501Y_YE162510_Insert(infcPkgYe162510Vo); 
		...
		// 월세액정리 합계  
        yetaPayr3200Service.fnYeta6200_J501Y_YE161080_2021_Update(infcPkgYe161080Vo); 
