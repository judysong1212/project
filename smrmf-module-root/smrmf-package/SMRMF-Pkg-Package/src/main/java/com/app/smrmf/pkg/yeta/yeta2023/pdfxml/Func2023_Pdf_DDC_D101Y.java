...
public class Func2023_Pdf_DDC_D101Y {
	...
	public static void func_2023_D101Y(InfcPkgYe161010_2023_VO ye161010Vo, Element  xmlelDoc, Element  subXmlElForm, String nResult, HttpServletRequest request) throws Exception{ 
		...
		InfcPkgYe167310_2023_VO ye167310Vo = new InfcPkgYe167310_2023_VO();
		InfcPkgYe167320_2023_VO ye167320Vo = new InfcPkgYe167320_2023_VO();
		...
		for (int j = 0; j < subXmlElChildForm.getLength();j++) { 
			...
			yetaPayr3200Service.yeta8200_PDF_YE167310_2023_Delete(ye167310Vo);	//기본정보 삭제
			...
			yetaPayr3200Service.yeta8200_PDF_YE167320_2023_Delete(ye167320Vo);	//인적공제 삭제	
			...
			yetaPayr3200Service.yeta8200_PDF_YE167310_2023_Insert(ye167310Vo);	//기본정보 입력
	...
	public static void setYe167320Vo(InfcPkgYe167320_2023_VO ye167320Vo , HttpServletRequest request) throws Exception{
		...
		yetaPayr3200Service.yeta8200_PDF_YE167320_2023_Insert(ye167320Vo);	//기본정보 입력
	}
}
