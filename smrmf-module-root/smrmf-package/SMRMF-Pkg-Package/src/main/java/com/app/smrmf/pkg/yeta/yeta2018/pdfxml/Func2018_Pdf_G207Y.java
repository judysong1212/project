...
public class Func2018_Pdf_G207Y {
	...
	public static void func_2018_G207Y_G207M(InfcPkgYe161010_2018_VO ye161010VO, Element  subXmlElForm, String nResult , HttpServletRequest request ) throws Exception{
		...
		InfcPkgPdfG207y_2018_VO yetaPdfG207yVo = new InfcPkgPdfG207y_2018_VO();
		InfcPkgPdfG207m_2018_VO yetaPdfG207mVo = new InfcPkgPdfG207m_2018_VO();
		...
		yetaPayr3200Service.yeta3200_PDF_G207Y_2018_Delete(yetaPdfG207yVo);
		...
		yetaPayr3200Service.yeta3200_PDF_G207M_2018_Delete(yetaPdfG207mVo);
	...
	public static void setPdfG207yVo(InfcPkgPdfG207y_2018_VO yetaPdfG207yVo , HttpServletRequest request, Element subXmlElData) throws Exception{
		...
		yetaPayr3200Service.yeta3200_PDF_G207Y_2018_Insert(yetaPdfG207yVo);

	}
	
	public static void setPdfG207mVo(InfcPkgPdfG207m_2018_VO yetaPdfG207mVo , HttpServletRequest request, Element subXmlElData) throws Exception{
		...
		yetaPayr3200Service.yeta3200_PDF_G207M_2018_Insert(yetaPdfG207mVo);

	}
	
	

	public static void func_2018_G207Y_YetaCalc(InfcPkgYe161010_2018_VO ye161010VO, HttpServletRequest request) throws Exception{ 
		...
		dataChk = yetaPayr3200Service.PdfYeta2018_G207Y_YE161040_Update(infcPkgYe161040Vo); 
		...
		if (dataChk >= 0) {
			...
			//신용카드
			yetaPayr3200Service.PdfYeta3200_G107Y_YE166020_Update(infcPkgYe166020Vo);  
			...
			// 신용카드  
	         yetaPayr3200Service.fnYeta3200_G207Y_YE161070_2018_Update(infcPkgYe161070Vo); 
