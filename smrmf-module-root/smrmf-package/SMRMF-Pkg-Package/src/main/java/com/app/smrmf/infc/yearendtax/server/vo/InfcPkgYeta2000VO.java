 ...
 */
public class InfcPkgYeta2000VO  implements Serializable {
	...
	private String crePasswd; 				// PDF파일자료_패스워드
	private Boolean creOriginYn; 						// PDF파일자료_원본자동검증여부  
...
private java.math.BigDecimal spciDdct;  //계산에 의한 값을 넣은것으로 변경ㅇ 

    private java.lang.String spciDdctCheck;   //표준세액공제 값을 넣을 지 여부 판별 
    ...
    /** set 분할납부회차 : divdPymtDivSu */
    private java.lang.String divdPymtDivSu;
...
/** set 차감징수_소득세 : subtEtax01 */
private java.math.BigDecimal subtEtax01;

/** set 차감징수_주민세_지방소득세 : subtInhb01 */
private java.math.BigDecimal subtInhb01;

/** set 차감징수_농특세 : subtFafv01 */
private java.math.BigDecimal subtFafv01;

/** set 차감징수_세액계 : subtAmsu01 */
...
public void setEtadD16l(java.math.BigDecimal etadD16l) {
	...
	/**
 * Comment : 
 * @fn java.lang.String getDivdPymtDivSu()
 * @brief date:2016 Mar 16, 2016 user:leeheuisung
 * @return the divdPymtDivSu get
 */
public java.lang.String getDivdPymtDivSu() {
	return divdPymtDivSu;
}

/**
 * Comment : 
 *@fn void setDivdPymtDivSu(java.lang.String divdPymtDivSu)
 *@brief date:2016 Mar 16, 2016 user:leeheuisung
 *@param divdPymtDivSu the divdPymtDivSu to set
 */
public void setDivdPymtDivSu(java.lang.String divdPymtDivSu) {
...
/**
 * Comment : 
 * @fn java.math.BigDecimal getSubtFafv01()
 * @brief date:2016 Mar 16, 2016 user:leeheuisung
 * @return the subtFafv01 get
 */
public java.math.BigDecimal getSubtFafv01() {
	return subtFafv01;
}

/**
 * Comment : 
 *@fn void setSubtFafv01(java.math.BigDecimal subtFafv01)
 *@brief date:2016 Mar 16, 2016 user:leeheuisung
 *@param subtFafv01 the subtFafv01 to set
 */
public void setSubtFafv01(java.math.BigDecimal subtFafv01) {
	this.subtFafv01 = subtFafv01;
}
...
/**
 * Comment : 
 * @fn java.math.BigDecimal getSubtFafv()
 * @brief date:2016 Mar 16, 2016 user:leeheuisung
 * @return the subtFafv get
 */
...
/**
 * Comment : 
 *@fn void setSubtFafv(java.math.BigDecimal subtFafv)
 *@brief date:2016 Mar 16, 2016 user:leeheuisung
 *@param subtFafv the subtFafv to set
 */
...
public void setEtadD15l(java.math.BigDecimal etadD15l) {
	 ...
	 * @brief date:2017 2017. 1. 6. user:atres-pc
	...
	/**
	 * Comment : 
	 *@fn void setCrePasswd(String crePasswd)
	 *@brief date:2017 2017. 1. 6. user:atres-pc
	...
	/**
	 * Comment : 
	 * @fn Boolean getCreOriginYn()
	 * @brief date:2017 2017. 1. 6. user:atres-pc
	 * @return the creOriginYn get
	 */
	public Boolean getCreOriginYn() {
		return creOriginYn;
	}

	/**
	 * Comment : 
	 *@fn void setCreOriginYn(Boolean creOriginYn)
	 *@brief date:2017 2017. 1. 6. user:atres-pc
	 *@param creOriginYn the creOriginYn to set
	 */
	public void setCreOriginYn(Boolean creOriginYn) {
	...
	/**
	 * Comment : 
	 * @fn java.math.BigDecimal getSpciDdct()
	 * @brief date:2017 2017. 1. 6. user:atres-pc
	 * @return the spciDdct get
	 */
	...
	/**
	 * Comment : 
	 *@fn void setSpciDdct(java.math.BigDecimal spciDdct)
	 *@brief date:2017 2017. 1. 6. user:atres-pc
	 *@param spciDdct the spciDdct to set
	 */
