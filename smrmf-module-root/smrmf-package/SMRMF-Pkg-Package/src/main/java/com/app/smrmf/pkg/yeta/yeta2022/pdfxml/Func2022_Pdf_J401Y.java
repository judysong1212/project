...
public class Func2022_Pdf_J401Y {
	...
	public static void func_2022_J401Y_J401M(InfcPkgYe161010_2022_VO ye161010VO, Element  subXmlElForm, String nResult, HttpServletRequest request ) throws Exception{
		...
		InfcPkgPdfJ401y_2022_VO yetaPdfJ401yVo = new InfcPkgPdfJ401y_2022_VO();
		InfcPkgPdfJ401m_2022_VO yetaPdfJ401mVo = new InfcPkgPdfJ401m_2022_VO();
		...
		for (int j = 0; j < subXmlElChildForm.getLength();j++) { 
			...
			for(int k = 0; k < subXmlElChildMan.getLength();k++) {  
				...
				if (strDatCd.equals("G0023")) {
					...
					yetaPayr3200Service.yeta7200_PDF_J401Y_2022_Delete(yetaPdfJ401yVo);
					yetaPayr3200Service.yeta7200_PDF_J401Y_2022_Insert(yetaPdfJ401yVo);
				}
			}
