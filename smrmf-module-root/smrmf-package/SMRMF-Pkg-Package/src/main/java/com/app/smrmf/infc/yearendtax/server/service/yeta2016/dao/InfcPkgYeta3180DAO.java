...
@Repository("InfcPkgYeta3180DAO")
public class InfcPkgYeta3180DAO extends EgovAbstractDAO {
    ...
    public String insertYeta3180(InfcPkgYeta3180VO vo) throws Exception {
        return (String)insert("infcPkgYeta3180DAO.insertYetaPrc3180_S", vo);
    }
	  @Transactional
    public String fnPayr06430_PAYR440_2015_1_Insert(InfcPkgYeta3180VO vo) throws Exception {
        return (String)insert("infcPkgYeta3180DAO.fnPayr06430_PAYR440_2015_1_Insert", vo);
    }
    ...
    public void updateYeta3180(InfcPkgYeta3180VO vo) throws Exception {
        update("infcPkgYeta3180DAO.updateYetaPrc3180_S", vo);
    }
    ...
    public void deleteYeta3180(InfcPkgYeta3180VO vo) throws Exception {
        delete("infcPkgYeta3180DAO.deleteYetaPrc3180_S", vo);
    }
	  @Transactional
    public void fnPayr06430_PAYR440_2015_Delete(InfcPkgYeta3180VO vo) throws Exception {
        delete("infcPkgYeta3180DAO.fnPayr06430_PAYR440_2015_Delete", vo);
    }
    ...
    public void fnPayr06430_PAYR440_CREATE_Delete(InfcPkgYeta3180VO vo) throws Exception {
        delete("infcPkgYeta3180DAO.fnPayr06430_PAYR440_CREATE_Delete_S", vo);
    } 
    ...
    public InfcPkgYeta3180VO selectYeta3180(InfcPkgYeta3180VO vo) throws Exception {
        return (InfcPkgYeta3180VO) selectByPk("infcPkgYeta3180DAO.selectYetaPrc3180_S", vo);
    }
    ...
    public List<?> selectYeta3180List(InfcPkgYeta3180SrhVO searchVO) throws Exception {
        return list("infcPkgYeta3180DAO.selectYetaPrc3180List_D", searchVO);
    }
    ...
    public int selectYeta3180ListTotCnt(InfcPkgYeta3180SrhVO searchVO) {
        return (Integer)getSqlMapClientTemplate().queryForObject("infcPkgYeta3180DAO.selectYetaPrc3180ListTotCnt_S", searchVO);
    }
