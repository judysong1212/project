...
public class InfcPkgYeta3900VO  implements Serializable {
	...
	public java.math.BigDecimal getPayItemSeilNum() {
		return payItemSeilNum;
	}

	public void setPayItemSeilNum(java.math.BigDecimal payItemSeilNum) {
