 ...
 */
@Controller 
public class Yeta6300SubtTaxWkerAmntPkgProc  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta6300SubtTaxWkerAmntPkgProc.class);
	   
    @Resource(name = "Yeta6300PayrService")
    protected Yeta6300PayrService  infcPkgYeta6300;
    
 
    public Yeta6300SubtTaxWkerAmntPkgProc() {
    	
    } 
    
    public List<ShowMessageBM> execSubtTaxWkerAmntPkgProc(HttpServletRequest request,InfcPkgYe161010_2021_VO  infcPkgYe161010Vo)  throws Exception  {
     ...
     * @throws Exception
     */
    private  List<ShowMessageBM>  YetaTaxWkerAmntUpdate(HttpServletRequest request,InfcPkgYe161010_2021_VO  infcPkgYe161010Vo) throws Exception {
      ...
      //    /* (97) column 차감소득금액 : SUBT_ERAM */  
  	      ...
  	      *******************************************************************************************/  
  		      InfcPkgYe169010_2021_VO wkInfcPkgYe169010Vo = new InfcPkgYe169010_2021_VO();  //연말정산결과  
  		      InfcPkgYe169010_2021_VO tpWkInfcPkgYe169010Vo = new InfcPkgYe169010_2021_VO();  //연말정산결과  
  		    ...
  		    tpWkInfcPkgYe169010Vo = infcPkgYeta6300.fnYeta6300_YE169010_Tax_2021_2001_Select(wkInfcPkgYe169010Vo); 
				...
				wkInfcPkgYe169010Vo.setYeta0c94(exSPCI_OBAM);    /** column C94_특별소득공제_기부금_이월분금액 : yeta0c94 */
  		        ...
  		        statCnt = 0;
  			  	statCnt =  infcPkgYeta6300.fnYeta6300_YE169010_Tax_2021_2003_Select(wkInfcPkgYe169010Vo); 
