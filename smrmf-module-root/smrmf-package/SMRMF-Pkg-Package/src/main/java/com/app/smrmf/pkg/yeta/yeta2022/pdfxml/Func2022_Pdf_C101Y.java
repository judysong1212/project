...
public class Func2022_Pdf_C101Y {
	...
	public static void func_2022_C101Y_C101M(InfcPkgYe161010_2022_VO ye161010VO, Element  subXmlElForm, String nResult , HttpServletRequest request) throws Exception{
		...
		InfcPkgPdfC101y_2022_VO yetaPdfC101yVo = new InfcPkgPdfC101y_2022_VO();
		InfcPkgPdfC101m_2022_VO yetaPdfC101mVo = new InfcPkgPdfC101m_2022_VO();
		...
		yetaPayr3200Service.yeta7200_PDF_C101Y_2022_Delete(yetaPdfC101yVo);
	...
	public static void setPdfC101yVo(InfcPkgPdfC101y_2022_VO yetaPdfC101yVo , HttpServletRequest request) throws Exception{
		...
		yetaPayr3200Service.yeta7200_PDF_C101Y_2022_Insert(yetaPdfC101yVo);
	 ...
	 * </pre>
	 * @Method Name : func_2022_C102Y_YetaCalc
	 * @date : 2022. 1. 23.
	 * @author : atres
	 * @history : 
	 *	-----------------------------------------------------------------------
	 ...
	 * @throws Exception
	 */
	public static void func_2022_C101Y_YetaCalc(InfcPkgYe161010_2022_VO ye161010VO, HttpServletRequest request) throws Exception{ 
      ...
      //   G0007 교육비-기타 본인+가족 개별제출
		...
		//교육비 
		yetaPayr3200Service.PdfYeta7200_C101Y_YE161090_Delete(infcPkgYe161090Vo); 
		yetaPayr3200Service.PdfYeta7200_C101Y_YE161090_Insert(infcPkgYe161090Vo); 
