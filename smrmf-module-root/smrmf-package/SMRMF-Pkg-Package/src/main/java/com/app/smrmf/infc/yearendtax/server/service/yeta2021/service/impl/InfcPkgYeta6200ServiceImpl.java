package com.app.smrmf.infc.yearendtax.server.service.yeta2021.service.impl;
...
import com.app.smrmf.pkg.yeta.yeta2021.pdfxml.service.impl.Yeta6200XmlServiceImpl;

import egovframework.rte.fdl.cmmn.AbstractServiceImpl;

@Service("InfcPkgYeta6200Service")
public class InfcPkgYeta6200ServiceImpl extends AbstractServiceImpl implements InfcPkgYeta6200Service{
	...
	public void yeta6200_Ye161020_2021_Update(InfcPkgYe161020_2021_VO ye161020VO) throws Exception {
		infcPkgYe161020DAO.updateYe161020YN(ye161020VO);
    }   

	/***********************************************************************************
	 * 2021년귀속 연말정산 처리를 위한 함수 처리 부 시작  -nts pdf
	 ***********************************************************************************/
	
	public int incTaxDeducDec_nts_Yeta2021_YetaAll_Delete(InfcPkgYe161010_2021_VO  infcPkgYe161010Vo) throws Exception {
		return infcPkgYe161010DAO.incTaxDeducDec_nts_Yeta2021_YetaAll_Delete(infcPkgYe161010Vo);
    }   
	 
	//InfcPkgYe161020VO     infcPkgYe161020Vo	 = new InfcPkgYe161020VO();	//A_인적소득공제기본 
	public int incTaxDeducDec_nts_Yeta2021_Ye161020_update(InfcPkgYe161020_2021_VO  infcPkgYe161020Vo) throws Exception {
		return infcPkgYe161020DAO.incTaxDeducDec_nts_Yeta2021_Ye161020_update(infcPkgYe161020Vo);
    }   

	//InfcPkgYe161030VO     infcPkgYe161030Vo	 = new InfcPkgYe161030VO();	//E_인적공제명세
	public String incTaxDeducDec_nts_Yeta2021_Ye161030_Insert(InfcPkgYe161030_2021_VO     infcPkgYe161030Vo) throws Exception {
		return infcPkgYe161030DAO.incTaxDeducDec_nts_Yeta2021_Ye161030_Insert(infcPkgYe161030Vo);
    }    
	...
	public String incTaxDeducDec_nts_Yeta2021_Ye161040_Insert(InfcPkgYe161040_2021_VO infcPkgYe161040Vo) throws Exception {
		return infcPkgYe161040DAO.incTaxDeducDec_nts_Yeta2021_Ye161040_Insert(infcPkgYe161040Vo);
    }   
	

	//InfcPkgYe161055VO     infcPkgYe161055Vo	 = new InfcPkgYe161055VO();	//C_연금보험료_공적연금상세 - 여기도삭제안함  TODO
	public String incTaxDeducDec_nts_Yeta2021_Ye161055_Insert(InfcPkgYe161055_2021_VO     infcPkgYe161055Vo) throws Exception {
		return infcPkgYe161055DAO.incTaxDeducDec_nts_Yeta2021_Ye161055_Insert(infcPkgYe161055Vo);
    } 
	
	public String fnYeta6100_Ye161055_PAYR_2021_Y0130002_Insert(InfcPkgYe161055_2021_VO     infcPkgYe161055Vo) throws Exception {
		return infcPkgYe161055DAO.fnYeta6100_Ye161055_PAYR_2021_Y0130002_Insert(infcPkgYe161055Vo);
    } 
	...
	public String incTaxDeducDec_nts_Yeta2021_Ye161050_Insert(InfcPkgYe161050_2021_VO     infcPkgYe161050Vo) throws Exception {
		return infcPkgYe161050DAO.incTaxDeducDec_nts_Yeta2021_Ye161050_Insert(infcPkgYe161050Vo);
    }   
	...
	public String incTaxDeducDec_nts_Yeta2021_Ye161060_Insert(InfcPkgYe161060_2021_VO     infcPkgYe161060Vo) throws Exception {
		return infcPkgYe161060DAO.incTaxDeducDec_nts_Yeta2021_Ye161060_Insert(infcPkgYe161060Vo);
    }   
	...
	public String incTaxDeducDec_nts_Yeta2021_Ye161070_Insert(InfcPkgYe161070_2021_VO     infcPkgYe161070Vo) throws Exception {
		return infcPkgYe161070DAO.incTaxDeducDec_nts_Yeta2021_Ye161070_Insert(infcPkgYe161070Vo);
    }   
	...
	public String incTaxDeducDec_nts_Yeta2021_Ye161080_Insert(InfcPkgYe161080_2021_VO     infcPkgYe161080Vo) throws Exception {
		return infcPkgYe161080DAO.incTaxDeducDec_nts_Yeta2021_Ye161080_Insert(infcPkgYe161080Vo);
    }
	//InfcPkgYe161080VO     infcPkgYe161080Vo	 = new InfcPkgYe161080VO();	//C_세액감면및공제
	public String incTaxDeducDec_nts_Yeta2021_Ye161080_Insert_01(InfcPkgYe161080_2021_VO     infcPkgYe161080Vo) throws Exception {
		return infcPkgYe161080DAO.incTaxDeducDec_nts_Yeta2021_Ye161080_Insert_01(infcPkgYe161080Vo);
    }
	
	
//InfcPkgYe161090VO     infcPkgYe161090Vo	 = new InfcPkgYe161090VO();	//C_교육비내역 TODO 확인후  여기는 삭제안함 
//	public String incTaxDeducDec_nts_Yeta2021_Ye161090_Insert(InfcPkgYe161090VO     infcPkgYe161090Vo) throws Exception {
//		return infcPkgYe161090DAO.incTaxDeducDec_nts_Yeta2021_Ye161090_Insert(infcPkgYe161090Vo);
//    }   
	...
	public String incTaxDeducDec_nts_Yeta2021_Ye162010_Insert(InfcPkgYe162010_2021_VO     infcPkgYe162010Vo) throws Exception {
		return infcPkgYe162010DAO.incTaxDeducDec_nts_Yeta2021_Ye162010_Insert(infcPkgYe162010Vo);
    }   
	...
	public String incTaxDeducDec_nts_Yeta2021_Ye162020_Insert(InfcPkgYe162020_2021_VO     infcPkgYe162020Vo) throws Exception {
		return infcPkgYe162020DAO.incTaxDeducDec_nts_Yeta2021_Ye162020_Insert(infcPkgYe162020Vo);
    }   
	
	//InfcPkgYe162030VO     infcPkgYe162030Vo	 = new InfcPkgYe162030VO();	//F_주택마련저축
	public String incTaxDeducDec_nts_Yeta2021_Ye162030_Insert(InfcPkgYe162030_2021_VO     infcPkgYe162030Vo) throws Exception {
		return infcPkgYe162030DAO.incTaxDeducDec_nts_Yeta2021_Ye162030_Insert(infcPkgYe162030Vo);
    }   
	...
	public String incTaxDeducDec_nts_Yeta2021_Ye162040_Insert(InfcPkgYe162040_2021_VO     infcPkgYe162040Vo	) throws Exception {
		return infcPkgYe162040DAO.incTaxDeducDec_nts_Yeta2021_Ye162040_Insert(infcPkgYe162040Vo);
    }
	...
	public String incTaxDeducDec_nts_Yeta2021_Ye162510_Insert(InfcPkgYe162510_2021_VO     infcPkgYe162510Vo) throws Exception {
		return infcPkgYe162510DAO.incTaxDeducDec_nts_Yeta2021_Ye162510_Insert(infcPkgYe162510Vo);
    }   
	...
	public String incTaxDeducDec_nts_Yeta2021_Ye162520_Insert(InfcPkgYe162520_2021_VO     infcPkgYe162520Vo) throws Exception {
		return infcPkgYe162520DAO.incTaxDeducDec_nts_Yeta2021_Ye162520_Insert(infcPkgYe162520Vo);
    }   
	
	
	//InfcPkgYe162530VO     infcPkgYe162530Vo	 = new InfcPkgYe162530VO();	//G_임대차계약
	public String incTaxDeducDec_nts_Yeta2021_Ye162530_Insert(InfcPkgYe162530_2021_VO     infcPkgYe162530Vo) throws Exception {
		return infcPkgYe162530DAO.incTaxDeducDec_nts_Yeta2021_Ye162530_Insert(infcPkgYe162530Vo);
    }   
	...
	public String incTaxDeducDec_nts_Yeta2021_Ye164010_Insert(InfcPkgYe164010_2021_VO     infcPkgYe164010Vo) throws Exception {
		return infcPkgYe164010DAO.incTaxDeducDec_nts_Yeta2021_Ye164010_Insert(infcPkgYe164010Vo);
    }   
	
	
	//InfcPkgYe165010VO     infcPkgYe165010Vo	 = new InfcPkgYe165010VO();	//I_해당연도기부금명세
	public String incTaxDeducDec_nts_Yeta2021_Ye165010_Insert(InfcPkgYe165010_2021_VO     infcPkgYe165010Vo) throws Exception {
		return infcPkgYe165010DAO.incTaxDeducDec_nts_Yeta2021_Ye165010_Insert(infcPkgYe165010Vo);
    }   
	...
	public String incTaxDeducDec_nts_Yeta2021_Ye165020_Insert(InfcPkgYe165020_2021_VO     infcPkgYe165020Vo) throws Exception {
		return infcPkgYe165020DAO.incTaxDeducDec_nts_Yeta2021_Ye165020_Insert(infcPkgYe165020Vo);
    }   
	...
	public String incTaxDeducDec_nts_Yeta2021_Ye165030_Insert(InfcPkgYe165030_2021_VO     infcPkgYe165030Vo) throws Exception {
		return infcPkgYe165030DAO.incTaxDeducDec_nts_Yeta2021_Ye165030_Insert(infcPkgYe165030Vo);
    }   
	
	
	//InfcPkgYe165030TempVO infcPkgYe165030TempVo = new InfcPkgYe165030TempVO();  	    //H_기부금조정명세_TEMP	 
//	public String incTaxDeducDec_nts_Yeta2021_Ye165030Temp_Insert(InfcPkgYe165030TempVO infcPkgYe165030TempVo) throws Exception {
//		return infcPkgYe165030DAO.incTaxDeducDec_nts_Yeta2021_Ye165030Temp_Insert(infcPkgYe165030TempVo);
//    }   
	...
	public String incTaxDeducDec_nts_Yeta2021_Ye166010_Insert(InfcPkgYe166010_2021_VO     infcPkgYe166010Vo) throws Exception {
		return infcPkgYe166010DAO.incTaxDeducDec_nts_Yeta2021_Ye166010_Insert(infcPkgYe166010Vo);
    }   
	...
	public String incTaxDeducDec_nts_Yeta2021_Ye166020_Insert(InfcPkgYe166020_2021_VO     infcPkgYe166020Vo) throws Exception {
		return infcPkgYe166020DAO.incTaxDeducDec_nts_Yeta2021_Ye166020_Insert(infcPkgYe166020Vo);
    }

	//InfcPkgYe169010VO     infcPkgYe169010Vo	 = new InfcPkgYe169010VO();	//C_주현근무처 -안함 
//	public String incTaxDeducDec_nts_Yeta2021_Ye169010_Insert(InfcPkgYe169010VO     infcPkgYe169010Vo) throws Exception {
//		return infcPkgYe169010DAO.incTaxDeducDec_nts_Yeta2021_Ye169010_Insert(infcPkgYe169010Vo);
//    }   
	
	
	 /***********************************************************************************
	  * 2021년귀속 연말정산 처리를 위한 함수 처리 부 종료   -nts pdf
	  ***********************************************************************************/
