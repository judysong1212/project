...
import com.app.smrmf.infc.yearendtax.server.vo.yeta2023.InfcPkgPdfQ101m_2023_VO;
...
public class Func2023_Pdf_Q101Y {
	...
	private static final Logger logger = LoggerFactory.getLogger(Func2023_Pdf_Q101Y.class);


	public static void func_2023_Q101Y_Q101M(InfcPkgYe161010_2023_VO ye161010VO, Element  subXmlElForm, String nResult, HttpServletRequest request) throws Exception{
		...
		InfcPkgPdfQ101y_2023_VO yetaPdfQ101yVo = new InfcPkgPdfQ101y_2023_VO();
		InfcPkgPdfQ101m_2023_VO yetaPdfQ101mVo = new InfcPkgPdfQ101m_2023_VO();
		...
		yetaPayr3200Service.yeta8200_PDF_Q101Y_2023_Delete(yetaPdfQ101yVo);
			...
			for(int k = 0; k < subXmlElChildMan.getLength();k++) {  
				...
				if (strDatCd.equals("G0035")) { //밴처기업투자신탁
					...
					if (yetaPdfQ101yVo.getVntAsctClCd().equals("1")){
						...
						//2023연말정산_추가
					}  else if(yetaPdfQ101yVo.getVntAsctClCd().equals("3")){
					...
					yetaPayr3200Service.yeta8200_PDF_Q101Y_2023_Insert(yetaPdfQ101yVo);*/
				} 
	...
	public static void setPdfQ101yVo (InfcPkgPdfQ101y_2023_VO yetaPdfQ101yVo, HttpServletRequest request, Element subXmlElData) throws Exception{
		if  (yetaPayr3200Service == null) { 
			WebApplicationContext wac = WebApplicationContextUtils.
					getRequiredWebApplicationContext( request.getSession().getServletContext());
	 ...
	 * </pre>
	 * @Method Name : func_2023_Q101Y_YetaCalc
	 * @date : 2023. 1. 23.
	 * @author : atres
	 * @history : 
	 *	-----------------------------------------------------------------------
	 ...
	 * @throws Exception
	 */
	public static void func_2023_Q101Y_YetaCalc(InfcPkgYe161010_2023_VO ye161010VO, HttpServletRequest request) throws Exception{ 
		...
		yetaPayr3200Service.PdfYeta8200_Q101Y_YE166040_Delete(infcPkgYe166040Vo); 
		yetaPayr3200Service.PdfYeta8200_Q101Y_YE166040_Insert(infcPkgYe166040Vo); 
		...
		// 벤처기업투자신탁 합계  
        yetaPayr3200Service.fnYeta8200_Q101Y_YE161070_2023_Update(infcPkgYe161070Vo); 
