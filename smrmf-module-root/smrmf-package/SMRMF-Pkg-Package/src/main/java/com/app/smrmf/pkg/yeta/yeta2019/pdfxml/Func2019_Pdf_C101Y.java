...
import com.app.smrmf.infc.yearendtax.server.vo.yeta2019.InfcPkgPdfC101m_2019_VO;
...
public class Func2019_Pdf_C101Y {
	...
	public static void func_2019_C101Y_C101M(InfcPkgYe161010_2019_VO ye161010VO, Element  subXmlElForm, String nResult , HttpServletRequest request) throws Exception{
		...
		InfcPkgPdfC101y_2019_VO yetaPdfC101yVo = new InfcPkgPdfC101y_2019_VO();
		InfcPkgPdfC101m_2019_VO yetaPdfC101mVo = new InfcPkgPdfC101m_2019_VO();
		...
		yetaPayr3200Service.yeta4200_PDF_C101Y_2019_Delete(yetaPdfC101yVo);
...
//					}
	...
	public static void setPdfC101yVo(InfcPkgPdfC101y_2019_VO yetaPdfC101yVo , HttpServletRequest request) throws Exception{
		...
		yetaPayr3200Service.yeta4200_PDF_C101Y_2019_Insert(yetaPdfC101yVo);
	 ...
	 * </pre>
	 * @Method Name : func_2019_C102Y_YetaCalc
	 * @date : 2019. 1. 23.
	 * @author : atres
	 * @history : 
	 *	-----------------------------------------------------------------------
	 ...
	 * @throws Exception
	 */
	public static void func_2019_C101Y_YetaCalc(InfcPkgYe161010_2019_VO ye161010VO, HttpServletRequest request) throws Exception{ 
      ...
      //   G0007 교육비-기타 본인+가족 개별제출
		...
		InfcPkgYe161090_2019_VO infcPkgYe161090Vo = new InfcPkgYe161090_2019_VO();
		...
		//교육비 
		yetaPayr3200Service.PdfYeta4200_C101Y_YE161090_Delete(infcPkgYe161090Vo); 
		yetaPayr3200Service.PdfYeta4200_C101Y_YE161090_Insert(infcPkgYe161090Vo); 
		...
		yetaPayr3200Service.PdfYeta2019_C101Y_YE161040_Update(infcPkgYe161040Vo); 
		...
		// 교육비 합계  
         yetaPayr3200Service.fnYeta4200_C101Y_YE161080_2019_Update(infcPkgYe161080Vo); 
