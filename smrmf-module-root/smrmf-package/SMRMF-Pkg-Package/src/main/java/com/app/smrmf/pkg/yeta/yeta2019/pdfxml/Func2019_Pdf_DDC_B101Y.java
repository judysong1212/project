...
public class Func2019_Pdf_DDC_B101Y {
	...
	public static void func_2019_B101Y(InfcPkgYe161010_2019_VO ye161010Vo, Element  xmlelDoc, Element  subXmlElForm, String nResult, HttpServletRequest request) throws Exception{ 
		...
		InfcPkgYe167110_2019_VO ye167110Vo = new InfcPkgYe167110_2019_VO();
		InfcPkgYe167120_2019_VO ye167120Vo = new InfcPkgYe167120_2019_VO();
		InfcPkgYe167130_2019_VO ye167130Vo = new InfcPkgYe167130_2019_VO();
		InfcPkgYe167140_2019_VO ye167140Vo = new InfcPkgYe167140_2019_VO();
		InfcPkgYe167150_2019_VO ye167150Vo = new InfcPkgYe167150_2019_VO();
		...
		for (int j = 0; j < subXmlElChildForm.getLength();j++) { 
			...
			yetaPayr3200Service.yeta4200_PDF_YE167110_2019_Delete(ye167110Vo);	//기본정보 삭제
			...
			yetaPayr3200Service.yeta4200_PDF_YE167120_2019_Delete(ye167120Vo);	//퇴직 연금 계좌 삭제	
			...
			yetaPayr3200Service.yeta4200_PDF_YE167130_2019_Delete(ye167130Vo);	//연금 저축 계좌 삭제	
			...
			yetaPayr3200Service.yeta4200_PDF_YE167140_2019_Delete(ye167140Vo);	//주택마련 저축 소득 공제 삭제
			...
			yetaPayr3200Service.yeta4200_PDF_YE167150_2019_Delete(ye167150Vo);	//장기 집합 투자 증권 저축 소득 공제 삭제
			...
			yetaPayr3200Service.yeta4200_PDF_YE167110_2019_Insert(ye167110Vo);	//기본정보 입력
	...
	public static void setYe167120Vo(InfcPkgYe167120_2019_VO ye167120Vo , HttpServletRequest request) throws Exception{
		...
		yetaPayr3200Service.yeta4200_PDF_YE167120_2019_Insert(ye167120Vo);	//기본정보 입력
	}
	
	public static void setYe167130Vo(InfcPkgYe167130_2019_VO ye167130Vo , HttpServletRequest request) throws Exception{
		...
		yetaPayr3200Service.yeta4200_PDF_YE167130_2019_Insert(ye167130Vo);	//기본정보 입력
	}
	
	public static void setYe167140Vo(InfcPkgYe167140_2019_VO ye167140Vo , HttpServletRequest request) throws Exception{
		...
		yetaPayr3200Service.yeta4200_PDF_YE167140_2019_Insert(ye167140Vo);	//기본정보 입력
	}
	
	public static void setYe167150Vo(InfcPkgYe167150_2019_VO ye167150Vo , HttpServletRequest request) throws Exception{
		...
		yetaPayr3200Service.yeta4200_PDF_YE167150_2019_Insert(ye167150Vo);	//기본정보 입력
	}
}
