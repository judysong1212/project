...
public class Func_Pdf_DDC_E101Y {
	...
	public static void func_2017_E101Y(InfcPkgYe161010VO ye161010Vo, Element  xmlelDoc, Element  subXmlElForm, String nResult, HttpServletRequest request) throws Exception{ 
		...
		InfcPkgYe167410VO ye167410Vo = new InfcPkgYe167410VO();
		InfcPkgYe167420VO ye167420Vo = new InfcPkgYe167420VO();
		InfcPkgYe167430VO ye167430Vo = new InfcPkgYe167430VO();
		InfcPkgYe167440VO ye167440Vo = new InfcPkgYe167440VO();
		...
		for (int j = 0; j < subXmlElChildForm.getLength();j++) { 
			...
			yetaPayr2200Service.yeta2200_PDF_YE167410_2017_Delete(ye167410Vo);	//인적공제 삭제	
			...
			yetaPayr2200Service.yeta2200_PDF_YE167420_2017_Delete(ye167420Vo);	//인적공제 삭제	
			...
			yetaPayr2200Service.yeta2200_PDF_YE167430_2017_Delete(ye167430Vo);	//인적공제 삭제	
			...
			yetaPayr2200Service.yeta2200_PDF_YE167440_2017_Delete(ye167440Vo);	//인적공제 삭제	
			...
			yetaPayr2200Service.yeta2200_PDF_YE167410_2017_Insert(ye167410Vo);	//기본정보 입력
	...
	public static void setYe167420Vo(InfcPkgYe167420VO ye167420Vo , HttpServletRequest request) throws Exception{
		...
		yetaPayr2200Service.yeta2200_PDF_YE167420_2017_Insert(ye167420Vo);	//기본정보 입력 
	}
	
	public static void setYe167430Vo(InfcPkgYe167430VO ye167430Vo , int FamCd , HttpServletRequest request) throws Exception{
		...
		yetaPayr2200Service.yeta2200_PDF_YE167430_2017_Insert(ye167430Vo);	//기본정보 입력
	}
	
	public static void setYe167440Vo(InfcPkgYe167440VO ye167440Vo , HttpServletRequest request) throws Exception{
		...
		yetaPayr2200Service.yeta2200_PDF_YE167440_2017_Insert(ye167440Vo);	//기본정보 입력
	}
}
