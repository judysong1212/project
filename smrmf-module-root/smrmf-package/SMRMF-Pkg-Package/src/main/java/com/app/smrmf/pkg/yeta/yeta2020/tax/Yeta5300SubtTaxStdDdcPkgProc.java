 ...
 */
@Controller 
public class Yeta5300SubtTaxStdDdcPkgProc  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta5300SubtTaxStdDdcPkgProc.class);
	   
    @Resource(name = "Yeta5300PayrService")
    protected Yeta5300PayrService  infcPkgYeta5300;
    
 
    public Yeta5300SubtTaxStdDdcPkgProc() {
    	
    } 
    
    public List<ShowMessageBM> execSubtTaxStdDdcPkgProc(HttpServletRequest request,InfcPkgYe161010_2020_VO  infcPkgYe161010Vo)  throws Exception  {
    ...
    * @throws Exception
    */
    private  List<ShowMessageBM> YetaTaxCreateUpdate(HttpServletRequest request,InfcPkgYe161010_2020_VO  infcPkgYe161010Vo) throws Exception {
    ...
    private  List<ShowMessageBM> YetaTaxStdUpdate(HttpServletRequest request,InfcPkgYe161010_2020_VO  infcPkgYe161010Vo) throws Exception {
 	...
 	BeanUtils.copyProperties(infcPkgYe169010AVo, infcPkgYe161010Vo); 
       ...
       //   ---------------------특별공제 종합한도초과액 - 기타공제계-----------------
 			...
 			statCnt = 0;
 			statCnt = infcPkgYeta5300.fnYeta5300_YE169010a_Tax_2020_3001_Update(infcPkgYe169010AVo);
 			if (statCnt >= 0) {
 			/**
 			 * ####################### 종합소득과세표준 기타공제계 ############################################			 */
 			
 				statCnt = 0;
 				statCnt = infcPkgYeta5300.fnYeta5300_YE169010a_Tax_2020_3002_Update(infcPkgYe169010AVo);
 				if (statCnt >= 0) {
 				
 					/** ####################### 산출세액- 기타공제계-  * ############################################  */
 			
 					statCnt = 0;
 					statCnt = infcPkgYeta5300.fnYeta5300_YE169010a_Tax_2020_3003_Update(infcPkgYe169010AVo);
 					if (statCnt >= 0) {
 					/**
 					 * ####################### 산출세액-세액감면  ############################################ */
 				
 						statCnt = 0;
 						statCnt = infcPkgYeta5300.fnYeta5300_YE169010a_Tax_2020_3004_Update(infcPkgYe169010AVo);
 						if (statCnt >= 0) {
 						/**
 						 * ####################### 세액공제 -근로소득공제 감면세액계  ############################################
 						 */
 							...
 							statCnt = 0;
 							statCnt = infcPkgYeta5300.fnYeta5300_YE169010a_Tax_2020_3005_Update(infcPkgYe169010AVo);
 							...
 							if (statCnt >= 0) {
 								...
 								statCnt = 0;
 								statCnt =  infcPkgYeta5300.fnYeta5300_YE169010a_Tax_2020_3006_Update(infcPkgYe169010AVo);
 								if (statCnt >= 0) {
 									
 							          /**#######################  교육비합계 사용안함 나중에 확인     ############################################*/
 						 
// 									statCnt = 0;
// 									statCnt =  infcPkgYeta5300.fnPayr06430_PAYR425_ReTax_2016_CREATE_BEF_12_1_Update(infcPkgYe169010AVo); 
// 									
// 									if (statCnt >= 0) {
 								      /**#######################      ############################################*/
 									if (statCnt >= 0) {
 									...
 									statCnt = 0;
 									statCnt =  infcPkgYeta5300.fnYeta5300_YE169010a_Tax_2020_3007_Update(infcPkgYe169010AVo); 
 									...
 									if (statCnt >= 0) {	 
 										 ...
 										 *******************************************************************************************/
 									     ...
 									     // InfcPkgYe169010VO infcPkgYe169010Vo = new InfcPkgYe169010VO();  //연말정산결과  
 									      InfcPkgYe169010a_2020_VO tpInfcPkgYe169010AVo = new InfcPkgYe169010a_2020_VO();  //연말정산결과  
 									      ...
 									      tpInfcPkgYe169010AVo = infcPkgYeta5300.fnYeta5300_YE169010a_Tax_2020_2001_Select(infcPkgYe169010AVo); 
...
// 									         infcPkgYe169010AVo.setSpciDdct(exSPCI_DDCT);    /** column 특별공제_표준공제 : spciDdct */
 									       ...
 									       //  infcPkgYe169010AVo.setAddrMccr(exADDR_MCCR);    /** column 세액공제_자녀세액공제금액 : addrMccr */
 									        ...
 									        infcPkgYe169010AVo.setYetaStdC158(exTAXD_CSUM);    /** column C158_세액공제합계금액 : yetaC158 */
 									         ...
 									         statCnt = 0;
 										  	 statCnt =  infcPkgYeta5300.fnYeta5300_YE169010a_Tax_2020_3008_Update(infcPkgYe169010AVo); 
 									      ...
 									      /**#######################  특별공제)특별 세액공제계 -표준세액 공제 ############################################*/
 									           ...
 									           statCnt = 0;
 									  		   statCnt =  infcPkgYeta5300.fnYeta5300_YE169010a_Tax_2020_3009_Update(infcPkgYe169010AVo); 
 									  			if (statCnt >= 0) {
 									  		   /**#######################  세액감면 세액공제- ############################################*/
 									  	      
 									  		
 									  			statCnt = 0;
 									  			statCnt = infcPkgYeta5300.fnYeta5300_YE169010a_Tax_2020_3010_Update(infcPkgYe169010AVo); 
 									  			if (statCnt >= 0) { 
 									  	    
 									  	    /**#######################  농어촌특별세 계산 ############################################*/ 
 									  		
 									  			statCnt = 0;
 									  			statCnt =  infcPkgYeta5300.fnYeta5300_YE169010a_Tax_2020_3011_Update(infcPkgYe169010AVo); 
 									  			if (statCnt >= 0) { 
 									  	    
 									  	      /**#######################  결정세액 ############################################*/ 
 									  			
 									  				statCnt = 0;
 									  				statCnt = infcPkgYeta5300.fnYeta5300_YE169010a_Tax_2020_3012_Update(infcPkgYe169010AVo); 
    ...
    private  List<ShowMessageBM> YetaTaxBaseUpdate(HttpServletRequest request,InfcPkgYe161010_2020_VO  infcPkgYe161010Vo) throws Exception {
 	...
 	BeanUtils.copyProperties(infcPkgYe169010Vo, infcPkgYe161010Vo); 
       ...
       //   ---------------------특별공제 종합한도초과액 - 기타공제계-----------------
 			...
 			statCnt = 0;
 			statCnt = infcPkgYeta5300.fnYeta5300_YE169010_Tax_2020_3001_Update(infcPkgYe169010Vo);
 			if (statCnt >= 0) {
 			/**
 			 * ####################### 종합소득과세표준 기타공제계 ############################################			 */
 			
 				statCnt = 0;
 				statCnt = infcPkgYeta5300.fnYeta5300_YE169010_Tax_2020_3002_Update(infcPkgYe169010Vo);
 				if (statCnt >= 0) {
 				
 					/** ####################### 산출세액- 기타공제계-  * ############################################  */
 			
 					statCnt = 0;
 					statCnt = infcPkgYeta5300.fnYeta5300_YE169010_Tax_2020_3003_Update(infcPkgYe169010Vo);
 					if (statCnt >= 0) {
 					/**
 					 * ####################### 산출세액-세액감면  ############################################ */
 				
 						statCnt = 0;
 						statCnt = infcPkgYeta5300.fnYeta5300_YE169010_Tax_2020_3004_Update(infcPkgYe169010Vo);
 						if (statCnt >= 0) {
 						/**
 						 * ####################### 세액공제 -근로소득공제 감면세액계  ############################################
 						 */
 							...
 							statCnt = 0;
 							statCnt = infcPkgYeta5300.fnYeta5300_YE169010_Tax_2020_3005_Update(infcPkgYe169010Vo);

 							if (statCnt >= 0) {
 							      /**#######################  세액공제 주택차입금 ----- 외국납부    ############################################*/
 							
 								statCnt = 0;
 								statCnt =  infcPkgYeta5300.fnYeta5300_YE169010_Tax_2020_3006_Update(infcPkgYe169010Vo);
 								if (statCnt >= 0) {
 									
 							          /**#######################  교육비합계 사용안함 나중에 확인     ############################################*/
 						 
// 									statCnt = 0;
// 									statCnt =  infcPkgYeta5300.fnPayr06430_PAYR425_ReTax_2016_CREATE_BEF_12_1_Update(infcPkgYe161010Vo); 
// 									
// 									if (statCnt >= 0) {
 								      /**#######################      ############################################*/
 									if (statCnt >= 0) {
 								 //YETA_C152
 									...
 									statCnt = 0;
 									statCnt =  infcPkgYeta5300.fnYeta5300_YE169010_Tax_2020_3007_Update(infcPkgYe169010Vo); 
 									...
 									if (statCnt >= 0) {	 
 										 ...
 										 *******************************************************************************************/
 										   ...
 										   /**#######################      ############################################*/
 									     // InfcPkgYe169010VO infcPkgYe169010Vo = new InfcPkgYe169010VO();  //연말정산결과  
 									      InfcPkgYe169010_2020_VO tpInfcPkgYe169010Vo = new InfcPkgYe169010_2020_VO();  //연말정산결과  
 									     ...
 									     //logger.debug("자녀세액공제금액 1: " + tpInfcPkgYe169010Vo.getYetaC122());
 									      tpInfcPkgYe169010Vo = infcPkgYeta5300.fnYeta5300_YE169010_Tax_2020_2001_Select(infcPkgYe169010Vo); 
 									      //logger.debug("자녀세액공제금액 2: " + tpInfcPkgYe169010Vo.getYetaC122());
 									       
 									      if (MSFSharedUtils.paramNotNull(tpInfcPkgYe169010Vo) && MSFSharedUtils.paramNotNull(tpInfcPkgYe169010Vo.getSystemkey())) {
 									      
 									    	 //logger.debug("자녀세액공제금액 3: " + tpInfcPkgYe169010Vo.getYetaC122());
 									          exTpPRDD_TAXN  = BigDecimal.ZERO;
 									     ...
 									     else
 									     {
 									      ...
 									      //연말정산2020_연금계좌 일단 주석처리
 									       ...
 									       else
 									       {
 									        ...
 									        infcPkgYe169010Vo.setClutSeptCd(infcPkgYe161010Vo.getClutSeptCd());    /** column 정산구분코드 : clutSeptCd */
 									        infcPkgYe169010Vo.setSystemkey(infcPkgYe161010Vo.getSystemkey());    /** column SYSTEMKEY : systemkey */
 									        logger.debug("자녀세액공제금액 5_3: " + exADDR_MCCR);
 									       ...
 									       //  infcPkgYe169010Vo.setAddrMccr(exADDR_MCCR);    /** column 세액공제_자녀세액공제금액 : addrMccr */
 									        ...
 									        infcPkgYe169010Vo.setYetaC158(exTAXD_CSUM);    /** column C158_세액공제합계금액 : yetaC158 */
 									         ...
 									         statCnt = 0;
 										  	 statCnt =  infcPkgYeta5300.fnYeta5300_YE169010_Tax_2020_3008_Update(infcPkgYe169010Vo); 
 									      ...
 									      /**#######################  특별공제)특별 세액공제계 -표준세액 공제 ############################################*/
 									           ...
 									           statCnt = 0;
 									  		   statCnt =  infcPkgYeta5300.fnYeta5300_YE169010_Tax_2020_3009_Update(infcPkgYe169010Vo); 
 									  			if (statCnt >= 0) {
 									  		   /**#######################  세액감면 세액공제- ############################################*/
 									  	      
 									  		
 									  			statCnt = 0;
 									  			statCnt = infcPkgYeta5300.fnYeta5300_YE169010_Tax_2020_3010_Update(infcPkgYe169010Vo); 
 									  			if (statCnt >= 0) { 
 									  	    
 									  	    /**#######################  농어촌특별세 계산 ############################################*/ 
 									  		
 									  			statCnt = 0;
 									  			statCnt =  infcPkgYeta5300.fnYeta5300_YE169010_Tax_2020_3011_Update(infcPkgYe169010Vo); 
 									  			if (statCnt >= 0) { 
 									  	    
 									  	      /**#######################  결정세액 ############################################*/ 
 									  			
 									  				statCnt = 0;
 									  				statCnt = infcPkgYeta5300.fnYeta5300_YE169010_Tax_2020_3012_Update(infcPkgYe169010Vo); 
	...
	private BigDecimal fnRtnSubTaxConTrbution(HttpServletRequest request,InfcPkgYe161010_2020_VO  infcPkgYe161010Vo,BigDecimal exTpPRDD_TAXN,String exGubun,String std_ddc_tax) throws Exception {
		...
		if  (listYetaGibu.size() > 0) {
			...
			while ( iter.hasNext() ) { 
				...
				//	inputYe169010Vo.setSpciFb17(new BigDecimal(MSFSharedUtils.defaultNulls(tempMap.get("spciFb17"),"0")));    /** column null : spciFb17 */
					...
					statCnt = 0;
			  		statCnt =  infcPkgYeta5300.fnYeta5300_YE169010_Tax_2020_TgIn03_Update( inputYe161080Vo) ;
			  		if (statCnt >= 0) {
			  			
			  			statCnt = 0;
				  		statCnt =  infcPkgYeta5300.fnYeta5300_YE169010_Tax_2020_TgIn04_Update( inputYe169010Vo) ;
			  		}
