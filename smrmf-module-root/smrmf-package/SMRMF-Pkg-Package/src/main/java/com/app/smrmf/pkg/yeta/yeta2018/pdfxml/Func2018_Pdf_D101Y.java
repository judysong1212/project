...
public class Func2018_Pdf_D101Y {
	...
	public static void func_2018_D101Y_D101M(InfcPkgYe161010_2018_VO ye161010VO, Element  subXmlElForm, String nResult, HttpServletRequest request ) throws Exception{
		...
		InfcPkgPdfD101y_2018_VO yetaPdfD101yVo = new InfcPkgPdfD101y_2018_VO();
		InfcPkgPdfD101m_2018_VO yetaPdfD101mVo = new InfcPkgPdfD101m_2018_VO();
		...
		for (int j = 0; j < subXmlElChildForm.getLength();j++) { 
			...
			for(int k = 0; k < subXmlElChildMan.getLength();k++) {  
				...
				if (strDatCd.equals("G0009")) {
					...
					yetaPayr3200Service.yeta3200_PDF_D101Y_2018_Delete(yetaPdfD101yVo);
					yetaPayr3200Service.yeta3200_PDF_D101Y_2018_Insert(yetaPdfD101yVo);
				}
			}
	...
	public static void func_2018_D101Y_YetaCalc(InfcPkgYe161010_2018_VO ye161010VO, HttpServletRequest request) throws Exception{ 
		...
		//개인연금저축 
		yetaPayr3200Service.PdfYeta3200_D101Y_YE162010_Delete(infcPkgYe162010Vo); 
		yetaPayr3200Service.PdfYeta3200_D101Y_YE162010_Insert(infcPkgYe162010Vo); 
		...
		// 교육비 합계  
         yetaPayr3200Service.fnYeta3200_D101Y_YE161070_2018_Update(infcPkgYe161070Vo); 
