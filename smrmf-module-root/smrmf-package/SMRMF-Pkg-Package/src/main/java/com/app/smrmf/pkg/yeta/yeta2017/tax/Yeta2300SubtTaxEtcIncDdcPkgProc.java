 ...
 */
@Controller 
public class Yeta2300SubtTaxEtcIncDdcPkgProc  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta2300SubtTaxEtcIncDdcPkgProc.class);
	   
    @Resource(name = "Yeta2300PayrService")
    protected Yeta2300PayrService  infcPkgYeta2300;
    
 
    public Yeta2300SubtTaxEtcIncDdcPkgProc() {
    	
    } 
    
    public  List<ShowMessageBM> execSubtTaxEtcIncDdcPkgProc(HttpServletRequest request,InfcPkgYe161010VO  ye161010VO)  throws Exception  {
    ...
    * @throws Exception
    */
    private   List<ShowMessageBM> YetaSubtCreateUpdate(HttpServletRequest request,InfcPkgYe161010VO  infcPkgYe161010Vo) throws Exception {
     ...
     * @throws Exception
     */
    private   List<ShowMessageBM> YetaSubtStdTaxUpdate(HttpServletRequest request,InfcPkgYe161010VO  infcPkgYe161010Vo) throws Exception {
  	  ...
  	  infcPkgYeta2300 = (Yeta2300PayrService)BeanFinder.getBean("Yeta2300PayrService"); 
     	...
     	infcPkgYe161010Vo.setRevnAddr(RemoteServiceUtil.getThreadLocalRequest().getRemoteHost());    			/** column 수정주소 : revnAddr */
  	      ...
  	      *******************************************************************************************/  
  		      InfcPkgYe169010aVO subInfcPkgYe169010aVo = new InfcPkgYe169010aVO();  //연말정산결과  
  		      InfcPkgYe169010aVO tpSubInfcPkgYe169010aVo = new InfcPkgYe169010aVO();  //연말정산결과  
  		    ...
  		    subInfcPkgYe169010aVo.setDpobCd(infcPkgYe161010Vo.getDpobCd());    /** column 사업장코드 : dpobCd */
  		      ...
  		      tpSubInfcPkgYe169010aVo = infcPkgYeta2300.fnYeta2300_YE169010a_Tax_2017_2001_Select(subInfcPkgYe169010aVo); 
...
//  			        subInfcPkgYe169010aVo.setEtepSecr(exETEP_SECR);    /** column 기타공제_장기집합투자증권저축공제액 : etepSecr */ 
  		        ...
  		        statCnt = 0;
  			  	statCnt =  infcPkgYeta2300.fnYeta2300_YE169010a_Tax_2017_2002_Update(subInfcPkgYe169010aVo); 
     ...
     * @throws Exception
     */
    private   List<ShowMessageBM> YetaSubtBaseTaxUpdate(HttpServletRequest request,InfcPkgYe161010VO  infcPkgYe161010Vo) throws Exception {
  	  ...
  	  infcPkgYeta2300 = (Yeta2300PayrService)BeanFinder.getBean("Yeta2300PayrService"); 
     	...
     	infcPkgYe161010Vo.setRevnAddr(RemoteServiceUtil.getThreadLocalRequest().getRemoteHost());    			/** column 수정주소 : revnAddr */
  	      ...
  	      *******************************************************************************************/  
  		      InfcPkgYe169010VO subInfcPkgYe169010Vo = new InfcPkgYe169010VO();  //연말정산결과  
  		      InfcPkgYe169010VO tpSubInfcPkgYe169010Vo = new InfcPkgYe169010VO();  //연말정산결과  
  		      ...
  		      tpSubInfcPkgYe169010Vo = infcPkgYeta2300.fnYeta2300_YE169010_Tax_2017_2001_Select(subInfcPkgYe169010Vo); 
...
//  			        subInfcPkgYe169010Vo.setEtepSecr(exETEP_SECR);    /** column 기타공제_장기집합투자증권저축공제액 : etepSecr */ 
  		        ...
  		        statCnt = 0;
  			  	statCnt =  infcPkgYeta2300.fnYeta2300_YE169010_Tax_2017_2002_Update(subInfcPkgYe169010Vo); 
