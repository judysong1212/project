...
public class Func2023_Pdf_G407Y {
	...
	public static void func_2023_G407Y_G407M(InfcPkgYe161010_2023_VO ye161010VO, Element  subXmlElForm, String nResult, HttpServletRequest request ) throws Exception{
		...
		InfcPkgPdfG407y_2023_VO yetaPdfG407yVo = new InfcPkgPdfG407y_2023_VO();
		InfcPkgPdfG407m_2023_VO yetaPdfG407mVo = new InfcPkgPdfG407m_2023_VO();
		...
		yetaPayr3200Service.yeta8200_PDF_G407Y_2023_Delete(yetaPdfG407yVo);
		...
		yetaPayr3200Service.yeta8200_PDF_G407M_2023_Delete(yetaPdfG407mVo);
		...
		for (int j = 0; j < subXmlElChildForm.getLength();j++) { 
			...
			yetaPayr3200Service.yeta8200_PDF_G407M_2023_Insert(yetaPdfG407mVo);
	...
	public static void setPdfG407yVo(InfcPkgPdfG407y_2023_VO yetaPdfG407yVo , HttpServletRequest request) throws Exception{
		...
		yetaPayr3200Service.yeta8200_PDF_G407Y_2023_Insert(yetaPdfG407yVo);

	}
	
	

	public static void func_2023_G407Y_YetaCalc(InfcPkgYe161010_2023_VO ye161010VO, HttpServletRequest request) throws Exception{ 
		...
		yetaPayr3200Service.yeta8200_PDF_G407M_2023_Update(yetaPdfG407mVo);
		...
		dataChk = yetaPayr3200Service.PdfYeta2023_G407Y_YE161040_Update(infcPkgYe161040Vo); 
		...
		if (dataChk >= 0) { 
			...
			// 신용카드  
	         yetaPayr3200Service.fnYeta8200_G407Y_YE161070_2023_Update(infcPkgYe161070Vo); 
