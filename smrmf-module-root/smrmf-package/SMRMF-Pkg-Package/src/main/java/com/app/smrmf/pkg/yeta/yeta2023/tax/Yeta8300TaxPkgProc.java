 ...
 */
@Controller
public class Yeta8300TaxPkgProc extends AbstractCustomServiceImpl {

	private static final Logger logger = LoggerFactory.getLogger(Yeta8300TaxPkgProc.class);

	@Resource(name = "Yeta8300PayrService")
	protected Yeta8300PayrService infcPkgYeta8300;

	public Yeta8300TaxPkgProc() {

	}

	//액계산 클릭 시
	public PagingLoadResult<ShowMessageBM> execfnYeta8300TaxPkgProc(
			HttpServletRequest request,
			List<InfcPkgYe161010_2023_VO> listYe161010VO) throws Exception {

		return funcYeta8300TaxPkgProc(request, listYe161010VO);
	}
     ...
     * @throws Exception
     */
    private PagingLoadResult<ShowMessageBM> funcYeta8300TaxPkgProc(HttpServletRequest request,List<InfcPkgYe161010_2023_VO> listYe161010VO)  throws Exception  {
...
//		InfcPkgYe161005VO    infcPkgYe161005Vo	 = new InfcPkgYe161005VO();	//A_원천세신고기본
		...
		InfcPkgYe161010_2023_VO    	infcPkgYe161010Vo	 = new InfcPkgYe161010_2023_VO();	// 연말정산대상자기본
		...
		InfcPkgYe165030_2023_VO    	infcPkgYe165030Vo	 = new InfcPkgYe165030_2023_VO();	//H_기부금조정명세
             ...
             /************************* 대상자별로 루프 시작 ***************************************************/ 
	  		  ...
	  		  for (int iCnt01 = 0;iCnt01 < listYe161010VO.size();iCnt01++) {
		              ...
		              **********************************************************************************************/
				  		  ...
				  		  statCnt = 0;
				  		    //의료비정리
				  		   infcPkgYeta8300.fnYeta8300_B101Y_YE161080_2023_Update(infcPkgYe161010Vo);
				  		  //주택마련저축정리 
				  		  infcPkgYeta8300.fnYeta8300_TaxPkg01_2023_Update(infcPkgYe161010Vo);  
				  		  //합계처리 
				  		   infcPkgYeta8300.fnYeta8300_All_YE161080_2023_Update(infcPkgYe161010Vo);
				  		
				  	      if (statCnt >= 0) {
						  		// ############## YE161020 부양가족인원수 ##############   
						 		statCnt = 0;
						  		statCnt = infcPkgYeta8300.fnYeta8300_YE161020_Tax_2023_01_Update(infcPkgYe161020Vo);  
						  		if (statCnt >= 0) { 
							  		statCnt = 0;
							  		// ############## YE161055 국민연금등정리 ############## 
							  		statCnt = infcPkgYeta8300.fnYeta8300_YE161055_Tax_2023_02_Update(infcPkgYe161055Vo); 
							  		if (statCnt >= 0) { 
								  		statCnt = 0;
								  		// ############## YE161050 국민연금등합계 ############## 
								  		statCnt = infcPkgYeta8300.fnYeta8300_YE161050_Tax_2023_03_Update(infcPkgYe161050Vo); 
								  		if (statCnt >= 0) { 
										  		statCnt = 0;
										  		/* ############## YE169010 비과세 정리  ##############  */
										  		statCnt = infcPkgYeta8300.fnYeta8300_YE169010_Tax_2023_04_Update(infcPkgYe169010Vo); 
										  		if (statCnt >= 0) { 
										  		    /** 공제단계 시작 01 총급여등기본공제,추가공제등 공제금액인서트 */
											  		statCnt = 0; 
											  		statCnt = infcPkgYeta8300.fnYeta8300_YE169010_Tax_2023_05_Update(infcPkgYe169010Vo);  
											  		if (statCnt >= 0) {   
										                 /**  {공제단계 시작 -소득공제 02} */ 
												  		if (statCnt >= 0) { 
												  		statCnt = 0;
												  		statCnt =  infcPkgYeta8300.fnYeta8300_YE169010_Tax_2023_06_Update(infcPkgYe169010Vo); 	
												  		if (statCnt >= 0) {  
											                 /**  {공제단계 시작 -연금보험료공제 03} */ 
											                 //      ---------------------------연금보험료공제-------------------------------------- 
													  		statCnt = 0;
													  		statCnt =  infcPkgYeta8300.fnYeta8300_YE169010_Tax_2023_07_Update(infcPkgYe169010Vo); 
													  		if (statCnt >= 0) {
												                  /**  {공제단계 시작 -특별공제 - 주택임차차임금 상환액  09 } */ 
												                  //   ------------------특별공제 - 주택임차차임금 상환액--------------------------- 
														  		statCnt = 0;  //TODO YE161060 작업함
														  		statCnt =  infcPkgYeta8300.fnYeta8300_YE169010_Tax_2023_08_Update(infcPkgYe169010Vo); 
														  		if (statCnt >= 0) { 
												                  /**  {공제단계 시작 -특별공제 - 주택마련저축  10 } */ 
															  		statCnt = 0;
															  		statCnt = infcPkgYeta8300.fnYeta8300_YE169010_Tax_2023_09_Update(infcPkgYe169010Vo); 
														  			if (statCnt >= 0) {
													                  /**  {공제단계 시작 -특별공제 - 주택마련저축 합계  10-1 } */ 
																  	
																  		statCnt = 0;
																  		statCnt =  infcPkgYeta8300.fnYeta8300_YE169010_Tax_2023_10_Update(infcPkgYe169010Vo); 
																  		if (statCnt >= 0) {
																  			/**  {공제단계 시작 -특별공제 - 장기주택이자상환액  10-2 } */
																	  		statCnt = 0;
																	  		statCnt =  infcPkgYeta8300.fnYeta8300_YE169010_Tax_2023_11_Update(infcPkgYe169010Vo); 
																	  		if (statCnt >= 0) { 
																                 /**  {공제단계 시작 -특별공제 - 장기주택이자상환액 고정금리 비거치  10-3 } */
																		  		statCnt = 0;
																		  		statCnt = infcPkgYeta8300.fnYeta8300_YE169010_Tax_2023_12_Update(infcPkgYe169010Vo); 
																		  		if (statCnt >= 0) { 
																                  /**  {공제단계 시작 -특별공제 - 장기주택이자상환액 기타 대출  10-4 } */
																			  		statCnt = 0;
																			  		  infcPkgYeta8300.fnYeta8300_YE169010_Tax_2023_13_Update(infcPkgYe169010Vo); 
																			  		//if (statCnt >= 0) { 
																			  			 /**  {장기주택이자상환액 2015년이후 고정금리이면서 비거치상환 대출 } */ 
																				  		statCnt = 0;
																				  		statCnt = infcPkgYeta8300.fnYeta8300_YE169010_Tax_2023_14_Update(infcPkgYe169010Vo);  
																				  		if (statCnt >= 0) { 
																				  		   /**  기타로직  등 계산 로직 */ 
																					  		statCnt = 0;
																					  		statCnt =  infcPkgYeta8300.fnYeta8300_YE169010_Tax_2023_15_Update(infcPkgYe169010Vo); 
																					  		if (statCnt >= 0) {
																				                /**  투자조합출자등소득공제 2020년  */ 
																						  		 statCnt = 0;
																						  		 statCnt =  infcPkgYeta8300.fnYeta8300_YE169010_Tax_2023_16_Update(infcPkgYe161070Vo);
																						  		 if (statCnt >= 0) {
																					                /**  투자조합출자등소득공제 2021년  */ 
																							  		 statCnt = 0;
																							  		 statCnt =  infcPkgYeta8300.fnYeta8300_YE169010_Tax_2023_17_Update(infcPkgYe161070Vo); 
																							  		 if (statCnt >= 0) {
																							  			/**  투자조합출자등소득공제 2022년  */ 
																							  			statCnt = 0;
																								  		statCnt =  infcPkgYeta8300.fnYeta8300_YE169010_Tax_2023_18_Update(infcPkgYe161070Vo); 
																								  		if (statCnt >= 0) {	
																							                 /**  신용카드  등 계산 로직  */ 
																									  		...
																									  		statCnt = infcPkgYeta8300.fnYeta8300_YE169010_Tax_2023_18_1_Update(infcPkgYe169010Vo);
																									  		...
																									  		statCnt = infcPkgYeta8300.fnYeta8300_YE169010_Tax_2023_18_2_Update(infcPkgYe169010Vo);
																									  		//if (statCnt >= 0){
																										  	...
																										  	statCnt = infcPkgYeta8300.fnYeta8300_YE169010_Tax_2023_18_3_Update(infcPkgYe169010Vo);
																										  	//if (statCnt >= 0){
																											...
																											statCnt = infcPkgYeta8300.fnYeta8300_YE169010_Tax_2023_18_4_Update(infcPkgYe169010Vo);
																											if (statCnt >= 0){
																											...
																											statCnt = infcPkgYeta8300.fnYeta8300_YE169010_Tax_2023_18_5_Update(infcPkgYe166020Vo);
																											if (statCnt >= 0){
																											...
																											//2022연말정산_추가
																											//총급여7천초과자 PDF테이블 변경값 YE161040내 다시 적용작업
																											statCnt = infcPkgYeta8300.fnYeta8300_YE169010_Tax_2023_18_6_Update(infcPkgYe169010Vo);
																											if (statCnt >= 0){
																									  		...
																									  		statCnt =  infcPkgYeta8300.fnYeta8300_YE169010_Tax_2023_19_Update(infcPkgYe169010Vo); 
																									  		if (statCnt >= 0) {
																								                 /**  {공제단계 시작 -연금보험료공제 연금보험료공제  대상금액 04}  */																										  		
																										  		statCnt = 0;
																										  		
																										  		//2022연말정산_추가_국민연금 공제액 차감순서 마지막으로 빼기
																										  		statCnt =  infcPkgYeta8300.fnYeta8300_YE169010_Tax_2023_19_S_Update(infcPkgYe169010Vo); 
																										  		if (statCnt >= 0) {
																										  		
																										  			statCnt = 0;
																										  			
																										  			//2022연말정산_추가_국민연금 공제액 구한 뒤 각 국민연금테이블에 공제액update
																										  			statCnt = infcPkgYeta8300.fnYeta8300_YE169010_Tax_2023_19_S_1_Update(infcPkgYe169010Vo);
																												  	if (statCnt >= 0){
																										  		...
																										  		statCnt =  infcPkgYeta8300.fnYeta8300_YE169010_Tax_2023_19_1_Update(infcPkgYe169010Vo); 
																										  		if (statCnt >= 0) {
																										  		
																										  			statCnt = 0;
																										  			
																										  		statCnt =  infcPkgYeta8300.fnYeta8300_YE169010_Tax_2023_20_Update(infcPkgYe169010Vo); 
																										  		if (statCnt >= 0) {
																								                   /**  {공제단계 시작 -연금보험료공제 03_1 대상금액 구하는 로직 추가  05}*/
																									                 // ---------------------------연금보험료공제-------------------------------------- 
																											  		statCnt = 0;
																											  		statCnt =  infcPkgYeta8300.fnYeta8300_YE169010_Tax_2023_21_Update(infcPkgYe169010Vo); 
																											  		if (statCnt >= 0) { 
																										                 /**  {공제단계 시작 -특별공제 - 보장성/장애인  보험료  06} */
																												  		statCnt = 0;
																												  		statCnt = infcPkgYeta8300.fnYeta8300_YE169010_Tax_2023_22_Update(infcPkgYe169010Vo); 
																												  		if (statCnt >= 0) {
																											                 /**  특별공제 - 보험료 */
																													  		statCnt = 0;
																													  		statCnt = infcPkgYeta8300.fnYeta8300_YE169010_Tax_2023_23_Update(infcPkgYe169010Vo); 
																													  		if (statCnt >= 0) {
																												                 /**  {공제단계 시작 -특별공제 - 의료비 대상금액  07 - 1} */
																													  			//20200110 의료비 수정
																														  		statCnt = 0;
																														  		statCnt =  infcPkgYeta8300.fnYeta8300_YE169010_Tax_2023_24_Update(infcPkgYe169010Vo); 
																														  		if (statCnt >= 0) { 
																												                  /**  {공제단계 시작 -특별공제 - 의료비   07 -2 } */
//																													               -----------------------특별공제 - 의료비 ------------------
																															  		statCnt = 0;
																															  		statCnt =  infcPkgYeta8300.fnYeta8300_YE169010_Tax_2023_25_Update(infcPkgYe161080Vo); 
																															  		if (statCnt >= 0) {
																															  			statCnt =  infcPkgYeta8300.fnYeta8300_YE169010_Tax_2023_25_01_Update(infcPkgYe161080Vo); 
																														                 /** {공제단계 시작 -특별공제 - 교육비   08 -1 }  */   
																													                  //    ----------------------특별공제 - 교육비 ---------------------
																															  		          //TODO YE161080 에작업함 
																																	  		statCnt = 0;
																																	  		statCnt =  infcPkgYeta8300.fnYeta8300_YE169010_Tax_2023_26_Update(infcPkgYe161080Vo); 
																																	  		if (statCnt >= 0) { 
																																                 /**  {공제단계 시작 -특별공제 - 교육비 공제  08 -2 }  */
																																		  		statCnt = 0;
																																		  		statCnt =  infcPkgYeta8300.fnYeta8300_YE169010_Tax_2023_27_Update(infcPkgYe161080Vo);
																																		  		if (statCnt >= 0) { 
																																			        /** {공제단계 시작 -특별공제 - 기부금관계코드 오류 정정  11 }  */
																																	                 //   -------------------------기부금관계코드 오류 정정  ------------------------------
//																																			  		statCnt = 0;
//																																			  		statCnt =  infcPkgYeta8300.fnPayr06430_PAYR425_ReTax_2016_CREATE_06_1_Update(infcPkgYe161010Vo); 
//																																			  		if (statCnt >= 0) {}
																																                  /**  {공제단계 시작 -특별공제 - 기부금공제   12   }  */
																																	                 //   -------------------------기부금공제 1 -이전월 포함.------------------------------
																																			  		// 귀속년도 정치기부금 공제대상
																																			  		statCnt = 0;
																																			  		statCnt =  infcPkgYeta8300.fnYeta8300_YE169010_Tax_2023_29_Update(infcPkgYe169010Vo); 
																																			  		if (statCnt >= 0) {  
																																		                 /**  기부금공제 1 -귀속년도 법정기부금 */
																																			  			// 귀속년도 정치기부금 (실질적인 공제금액), 년도별 법정기부금, 종교외, 종교 공제대상금액만
																																				  		statCnt = 0;
																																				  		statCnt =  infcPkgYeta8300.fnYeta8300_YE169010_Tax_2023_30_Update(infcPkgYe169010Vo); 
																																				  		if (statCnt >= 0) { 
																																		                   /**  기부금공제 1 -귀속년도 법정기부금. */
																																					  		...
																																					  		statCnt = 0;
																																					  		statCnt =  infcPkgYeta8300.fnYeta8300_YE169010_Tax_2023_31_Update(infcPkgYe169010Vo);
																																					  		if (statCnt >= 0) {
																																					  			statCnt = 0;
																																						  		statCnt =  infcPkgYeta8300.fnYeta8300_YE169010_Tax_2023_31_01_Update(infcPkgYe169010Vo);
																																						  		if (statCnt >= 0) {
																																								...
																																								//2022년연말정산_추가
																																								statCnt =  infcPkgYeta8300.fnYeta8300_YE169010_Tax_2023_31_02_Update(infcPkgYe169010Vo);
																																						  		if (statCnt >= 0) {

																																							     /**   현재년도 우리사주조합 대상금액 구하기  */
																																								statCnt = 0;
																																								
																																								statCnt =  infcPkgYeta8300.fnYeta8300_YE169010_Tax_2023_32_Update(infcPkgYe169010Vo); 
																																								if (statCnt >= 0) {
																																							      /**  기부금공제 2013년도 이전 종교단체/외 이월 기부금  */
																																									statCnt = 0;   //이월분 종교외공제금액작업(13년도)
																																									statCnt =  infcPkgYeta8300.fnYeta8300_YE169010_Tax_2023_33_Update(infcPkgYe161060Vo); 		
																																									if (statCnt > 0) {
																																										statCnt = 0;   //이월분 종교단체공제금액작업(13년도)
																																										statCnt =  infcPkgYeta8300.fnYeta8300_YE169010_Tax_2023_33_02_Update(infcPkgYe161060Vo); 		
																																										if (statCnt > 0) {	
																																											statCnt = 0;   //TODO YE161060 작업함 
																																											statCnt =  infcPkgYeta8300.fnYeta8300_YE169010_Tax_2023_33_03_Update(infcPkgYe169010Vo); 		
																																											if (statCnt > 0) {	
																																												statCnt = 0;   //TODO 종교외/종교기부금 공제한도금액 구하기(13년도)
																																												statCnt =  infcPkgYeta8300.fnYeta8300_YE169010_Tax_2023_33_04_Update(infcPkgYe169010Vo); 		
																																												if (statCnt >= 0) {		
																																													/**  기부금공제 특례기부금공제,당해년도 종교단체기부금 대상금액 */
																																													/* 20200109 시작 */
																																													statCnt = 0;
																																													// 종교외기부금 15,16,17
																																													statCnt =  infcPkgYeta8300.fnPayr06430_PAYR425_ReTax_2016_CREATE_09_021_Update(infcPkgYe169010Vo);
																																											 		if (statCnt > 0) {
																																											 			statCnt = 0;
																																											 			// 종교외기부금 18,19,20,21
																																											 			statCnt =  infcPkgYeta8300.fnPayr06430_PAYR425_ReTax_2016_CREATE_09_022_Update(infcPkgYe169010Vo); 
																																												 		if (statCnt >= 0) {
																																												          /**  기부금공제  2014 년도 종교단체기부금 대상금액 */
																																												 			//종교기부금 15,16,17
																																													  		...
																																													  		//2022연말정산_추가
																																													  		statCnt =  infcPkgYeta8300.fnPayr06430_PAYR425_ReTax_2016_CREATE_09_023_Update(infcPkgYe169010Vo); 
																																													 		if (statCnt >= 0) {
																																													 			
																																														  		statCnt = 0;
																																													  		
																																													  		statCnt =  infcPkgYeta8300.fnPayr06430_PAYR425_ReTax_2016_CREATE_09_031_Update(infcPkgYe169010Vo);
																																													  		if (statCnt >= 0) {
																																													  			//종교기부금 18,19,20,21
																																													  			statCnt = 0;
																																													  			statCnt =  infcPkgYeta8300.fnPayr06430_PAYR425_ReTax_2016_CREATE_09_032_Update(infcPkgYe169010Vo); 
																																													  			
																																													  			//2022연말정산_추가
																																													  			if (statCnt >= 0) {
																																													  				
																																														  			statCnt = 0;
																																														  			statCnt =  infcPkgYeta8300.fnPayr06430_PAYR425_ReTax_2016_CREATE_09_033_Update(infcPkgYe169010Vo);
																																													  		if (statCnt >= 0) {
																																												              /**  기부금공제 3 불러와서 년도별 수정하는걸로 변경함 */ 
																																													  			// 20200109 오후 시작
																																													  	         List listYetaGibu = infcPkgYeta8300.fnYeta8300_YE169010_Tax_2023_TgYear_Select(infcPkgYe169010Vo); 
																																													             ...
																																													             if  (listYetaGibu.size() > 0) {
																																															            ...
																																															            while ( iter.hasNext() ) { 
																																															               ...
																																															               InfcPkgYe169010_2023_VO     inputYe169010Vo = new InfcPkgYe169010_2023_VO();	//C_주현근무처 
																																												 						...
																																												 						//	InfcPkgYe161070VO    inputYe161070Vo	 = new InfcPkgYe161070VO();	//C_그밖의소득공제
																																															               InfcPkgYe161080_2023_VO    inputYe161080Vo	 = new InfcPkgYe161080_2023_VO();	//C_세액감면및공제
																																															             ...
																																															             //종교단체 2022
																																															               ...
																																															               statCnt = 0;
																																															               statCnt =  infcPkgYeta8300.fnYeta8300_YE169010_Tax_2023_TgIn01_Update(inputYe161080Vo) ;
																																															               if (statCnt >= 0) {
																																															            	   statCnt = 0;
																																															            	   statCnt =  infcPkgYeta8300.fnYeta8300_YE169010_Tax_2023_TgIn02_Update(inputYe169010Vo) ;
																																															            	   }
																																															               }
																																															            }
																																													             /**  공제단계 시작 - 이전 이월정산정리 작업 443 -> 442로이관    -- 14 */
																																														  			...
																																														  			dataCheck = "";
																																														  		 	dataCheck =  infcPkgYeta8300.fnYeta8300_YE169010_Tax_2023_40_Update(infcPkgYe165030Vo);   
																																														  			if (statCnt >= 0) {   
																																													                   //  {공제단계 시작 - 기부금 내역 정보 정산.     15 - 1 } 전단계에서 자동으로 처리함 제외 
																																													                     /**  공제단계 시작 - 기부금 내역 정보 정산.     15 - 1 */ 
																																												//			  		dataCheck = "";
																																												//		  			dataCheck =   infcPkgYeta8300.fnPayr06430_PAYR425_ReTax_2016_CREATE_10_1_Update(infcPkgYe161010Vo); 
																																												//		  			if (MSFSharedUtils.paramNull(dataCheck)) {  
																																												//		  				
																																												//		  			}
																																														  				 /**  기부금 정리 이월분 정리 작업 시작   */ 	
																																														  				statCnt = 0;  
																																														  				Yeta8300Tax2023ContributionCalcPkgProc tax2023ContributionCalcPkgProc = new Yeta8300Tax2023ContributionCalcPkgProc();
																																														  				bmResult.addAll(tax2023ContributionCalcPkgProc.execTax_2023_Contribution_Calc(request,infcPkgYe161010Vo)); 
																																														  		  		if (bmResult.size() >= 0) {
																																														  				//if (0 >= 0) {
																																														  		  		//여기까지 	
																																												/******************************************************** 기부금 종료 전체 다시 작업  *****************************************************************************/
																																														              ...
																																														              // if (MSFSharedUtils.paramNull(dataCheck)) {         
																																												//		                 statCnt = 0;
																																												//		 		  		  statCnt =  infcPkgYeta8300.fnPayr06430_PAYR415_ReTax_2016_CREATE_12_1_Update(infcPkgYe169010Vo); 	
																																												//		 		  		  if (statCnt >= 0) { 
																																												...
																																												//		 		  		  }
																																														 		  			...
																																														 		  			statCnt = 0;
																																														 		  			// 
																																														 		  			Yeta8300SubtTaxWkerAmntPkgProc yeta8300SubtTaxWkerAmnt  =  new Yeta8300SubtTaxWkerAmntPkgProc();
																																														 		  			bmResult.addAll(yeta8300SubtTaxWkerAmnt.execSubtTaxWkerAmntPkgProc( request, infcPkgYe161010Vo));
																																														 	 		  
																																														 	 		        if (bmResult.size() >= 0) {     
																																														 	 	 		       /**  공제계  합산 부분 구하는 부분 */
																																												//		 	 	 		  			statCnt = 0;
																																												//		 	 	 	 		 		statCnt = infcPkgYeta8300.fnPayr06430_PAYR425_ReTax_2016_CREATE_12_Update(infcPkgYe169010Vo);
																																												//		 	 	 		 		   if (statCnt >= 0) {
																																												...
																																												//		 	 	 		 		   }
																																														 	 	 		       ...
																																														 	 	 		       /**  차감소득금액 */ 
																																														 	 	 		 		statCnt = 0;
																																														 	 	 		 		statCnt =  infcPkgYeta8300.fnYeta8300_YE169010_Tax_2023_50_Update(infcPkgYe169010Vo); 
																																														 	 	 		       		if (statCnt >= 0) {
																																														 	 	 		 		       /**  그밖의 소득공제 계 */ 
																																														 	 	 		 		 		statCnt = 0;  
																																														 	 	 		 		 		statCnt = infcPkgYeta8300.fnYeta8300_YE169010_Tax_2023_50_01_Update(infcPkgYe169010Vo);		 	 	 		 	 		 		
																																												//		 	 	 		 		 		if (statCnt >= 0) { 
																																												//		 	 	 		 		 			 합계통합 삭제 
																																												//		 	 	 		 		 		}
																																														 	 	 		 		  	 //   statCnt = 0;
																																														 	 	 		       	    	Yeta8300SubtTaxStdDdcPkgProc yeta8300SubtTaxStdDdc  = new Yeta8300SubtTaxStdDdcPkgProc();
																																														 	 	 		       	    	bmResult.addAll(yeta8300SubtTaxStdDdc.execSubtTaxStdDdcPkgProc(request, infcPkgYe161010Vo));		 	 	 		 		  	    
																																														 	 	 		 		  		/****   여기 부터 표준세액공제 때문에 공통으로 처리 해야 함 0으로 처리 해야 할부분 에 대해 업데이트 처리도 해야함 검증을 위한쿼리 추가 ****/
																																														 	 	 		 		   
																																														 	 	 				  		 /** 표준세액공제에 대한 값 처리 */
																																														 	 	 		 		  	  if (bmResult.size() >= 0) {		 	 	 		 		  		  
																																														 	 	 		 		    	InfcPkgYe169010Srh_2023_VO   infcPkgYe169010SrhVo = new InfcPkgYe169010Srh_2023_VO();	
																																														 	 	 		 		  		InfcPkgYe169010_2023_VO   tpInfcPkgYe169010Vo = new InfcPkgYe169010_2023_VO();	//C_주현근무처 
																																														 	 							...
																																														 	 							BeanUtils.copyProperties(infcPkgYe169010AVo, infcPkgYe161010Vo); 
																																														 	 			  			    ...
																																														 	 			  			    statCnt =  infcPkgYeta8300.fnYeta8300_YE161020_Tax_2023_C152_STD_TX_DDC_YN_Update(infcPkgYe161020Vo); 
																																														 	 	 		 	            
																																													 	 	 		 	                 tpInfcPkgYe169010Vo = infcPkgYeta8300.fnYeta8300_YE169010_Tax_2023_51_Select(infcPkgYe169010SrhVo);
																																													 	 	 		 	                      ...
																																													 	 	 		 	                      if ((!"2".equals(tpInfcPkgYe169010Vo.getRsdtClCd())) && "Y".equals(tpInfcPkgYe169010Vo.getYetaC152Check())) { 
																																									 	 	 		 						                	 ...
																																									 	 	 		 						                	 if (rtnAlryPinx01.compareTo(rtnAlryPinx02) <  0) {
																																									 	 	 		 						                		  ...
																																									 	 	 		 						                		  */
																																									 	 	 		 						                		   //avo 테이블에 복제 작업 함.  
																																									 	 	 		 						                		 dataCheck = "";
																																									 	 	 		 						                	     infcPkgYeta8300.fnYeta8300_YE169010a_Tax_2023_52_Delete(infcPkgYe169010Vo);
																																									 	 	 		 						                	     dataCheck =  infcPkgYeta8300.fnYeta8300_YE169010a_Tax_2023_52_Insert(infcPkgYe169010Vo); 
																																									 	 		 						                		     if (MSFSharedUtils.paramNotNull(tpInfcPkgYe169010Vo)) {
																																									 	 	 		 						                		  ...
																																									 	 	 		 						                		  //  InfcPkgYe169010aVO infcPkgYe169010AVo = new InfcPkgYe169010aVO(); 
																																									 	 	 		 						                		    ...
																																									 	 	 		 						                		    infcPkgYe169010AVo.setYetaStdC150b(BigDecimal.ZERO);    /** column C150B_STD_세액공제_특별세액공제_지정기부금_종교단체세액공제금액 : yetaStdC150b */
																																									 	 	 		 						                	         ...
																																									 	 	 		 						                	         statCnt = 0;
																																									 	 	 		 						                		  	 statCnt =  infcPkgYeta8300.fnYeta8300_YE169010a_Tax_2023_52_Update(infcPkgYe169010AVo); 
																																									 	 	 		 						                	
																																								//	 	 	 		 						                	       }
																																									 	 	 		 						                		     if (statCnt >= 0) {
																																									 	 	 		 						                			    
																																								//	 	 	 		 						                	                 statCnt = 0;
																																								//	 	 	 		 						                	 		  		 statCnt =  infcPkgYeta8300.fnPayr06430_PAYR415_ReTax_2016_CREATE_12_1_Update(infcPkgYe161010Vo); 
																																								//	 	 	 		 						                	                  //합계구하는 부분인데 사용안함 
																																								//	 	 	 		 						                	 		  		if (statCnt >= 0) {      
																																									 	 	 		 									                			  // {retax-45} 
																																									 	 	 		 									                		       /**  공제계  합산 부분 구하는 부분 */
																																								//	 	 	 		 									                		  			statCnt = 0;
																																								//	 	 	 		 									                	 		 		statCnt = infcPkgYeta8300.fnPayr06430_PAYR425_ReTax_2016_CREATE_12_Update(infcPkgYe161010Vo);
																																								...
																																								//		 	 	 		 									                		 		if (statCnt >= 0) {
																																									 	 	 		 									                		      ...
																																									 	 	 		 									                		      //  -----------------'차감소득금액     ----------------------------------
																																									 	 	 		 									                		 		...
																																									 	 	 		 									                		 		statCnt = 0;
																																									 	 	 		 									                		 		 statCnt =  infcPkgYeta8300.fnYeta8300_YE169010a_Tax_2023_50_Update(infcPkgYe169010AVo); 
																																									 	 	 		 									                		 		 ...
																																									 	 	 		 									                		 		 *****************************************************************************************/
																																									 	 	 		 													           	 		 	  if (statCnt >= 0) {
																																									 	 	 		 													           	 		          ...
																																									 	 	 		 													           	 		          Yeta8300SubtTaxEtcIncDdcPkgProc subtTaxEtcIncDdc  = new Yeta8300SubtTaxEtcIncDdcPkgProc();
																																									 	 	 		 	 	 		 						                			          ...
																																									 	 	 		 	 	 		 						                			          if (bmResult.size() >= 0) { 
																																									 	 	 		 													           	 		 	 ...
																																									 	 	 		 													           	 		 	 //  {retax-47}
																																									 	 	 		 													                		       /**  그밖의 소득공제 계 */
																																									 	 	 		 													                		 		...
																																									 	 	 		 													                		 		statCnt = 0;
																																									 	 	 		 													                		 		statCnt = infcPkgYeta8300.fnYeta8300_YE169010a_Tax_2023_50_01_Update(infcPkgYe169010AVo);
																																									 	 	 		 													                		 		 
																																									 	 	 		 															               		       if (statCnt >= 0) {
																																									 	 	 		 															               		  	  
																																									 	 	 		 															               		  	       //YetaTaxCreateUpdate InfcPkgYe169010aVO
																																												 	 	 		 															               		 Yeta8300SubtTaxStdDdcPkgProc subtTaxStdDdc  = new Yeta8300SubtTaxStdDdcPkgProc();
																																												 	 	 		 			  		...
																																												 	 	 		 			  		if ("TRUE".equals(spciDdctCheck) ) {
																																													 	 	 		 			  		...
																																													 	 	 		 			  		statCnt =   infcPkgYeta8300.fnYeta8300_YE169010a_Tax_2023_51_Update(infcPkgYe169010AVo); 
																																													 	 	 		 			  		spciDdctCheck = "FALSE";
																																												 	 	 		 			  		} else {
																																								
																																													 	 	 		 			  		statCnt =   infcPkgYeta8300.fnYeta8300_YE169010_Tax_2023_51_Update(infcPkgYe169010Vo); 
																																													 	 	 		 			  		spciDdctCheck = "FALSE";  
																																												 	 	 		 			  		}
																																								...
																																								//				 	 	 		 			  		  statCnt =  infcPkgYeta8300.fnPayr06430_PAYR425_ReTax_2016_CREATE_19_Update(infcPkgYe169010Vo);
																																												 	 	 		 			  		
																																												 	 	 		 			  	 /** YE169010 YE169010A 복제 루틴 */ 
																																												 	 	 		 			  		 
																																													 	 							
																																													 	 					 		InfcPkgYe169010Srh_2023_VO   ye169010SrhVo = new InfcPkgYe169010Srh_2023_VO();	 
																																													 	 							BeanUtils.copyProperties(ye169010SrhVo, infcPkgYe161010Vo); 
																																													 	 							
																																												 	 	 		 			  		 List lstPkgYe169010Vo =  infcPkgYeta8300.fnYeta8300_YE169010_Tax_2023_A01_Select(ye169010SrhVo);
																																														 	 	 		 			     ...
																																														 	 	 		 			     for (int iCnt02 = 0;iCnt02 < lstPkgYe169010Vo.size();iCnt02++) {
																																														 	 	 		 			      ...
																																														 	 	 		 			      //	InfcPkgYe169010VO   tpInfcPkgYe169010Vo = new InfcPkgYe169010VO();	//C_주현근무처 
																																																 	 	 		 			  	InfcPkgYe161060_2023_VO    inputYe161060Vo	 = new InfcPkgYe161060_2023_VO();	//C_특별소득공제
																																																 	 							InfcPkgYe161070_2023_VO    inputYe161070Vo	 = new InfcPkgYe161070_2023_VO();	//C_그밖의소득공제
																																																 	 							InfcPkgYe161080_2023_VO    inputYe161080Vo	 = new InfcPkgYe161080_2023_VO();	//C_세액감면및공제
																																																 	 							BeanUtils.copyProperties(inputYe161060Vo, infcPkgYe161010Vo);
																																																 	 							BeanUtils.copyProperties(inputYe161070Vo, infcPkgYe161010Vo);
																																																 	 							BeanUtils.copyProperties(inputYe161080Vo, infcPkgYe161010Vo); 
																																																								...
																																																								infcPkgYeta8300.fnYeta8300_Ye161060_Tax_2023_I1_Update(inputYe161060Vo); 
																																																								...
																																																								inputYe161070Vo.setLtrmCniYyDdcAmt(new BigDecimal(MSFSharedUtils.defaultNulls(tempMap.get("yetaC109y"),"0")));    /** column 청년형장기집합투자증권저축공제금액 : ltrmCniYyDdcAmt */ 
																																																								 ...
																																																								 infcPkgYeta8300.fnYeta8300_Ye161070_Tax_2023_I2_Update(inputYe161070Vo); 
																																																								...
																																																								infcPkgYeta8300.fnYeta8300_Ye161080_Tax_2023_I3_Update(inputYe161080Vo);
																																																								
																																																								
																																																								 /////퇴직연금/////////
																																																 	 	 		 			      InfcPkgYe162020Srh_2023_VO   ye162020SrhVo = new InfcPkgYe162020Srh_2023_VO();	 
																																																 	 							  BeanUtils.copyProperties(ye162020SrhVo, infcPkgYe161010Vo); 
																																																 	 							
																																															 	 	 		 			  		   List lstPkgYe162020Vo =  infcPkgYeta8300.fnYeta8300_YE162020_Tax_2023_A01_Select(ye162020SrhVo);
																																															 	 	 		 			       ...
																																															 	 	 		 			       BigDecimal bgYetaC13a = new BigDecimal(MSFSharedUtils.defaultNulls(tempMap.get("yetaC13a"),"0"));
																																																 	 	 		 			    	 ...
																																																 	 	 		 			    	 if ("Y0040010".equals(MSFSharedUtils.allowNulls(tempMap01.get("rtpnAccRtpnCl")))) {
																																																 	 	 		 			    	    ...
																																																 	 	 		 			    	    infcPkgYeta8300.updateYeta8300_Tax_Ye162020_01(infcPkgYe162020Vo);     
																																																 	 	 		 			    		...
																																																 	 	 		 			    		infcPkgYeta8300.updateYeta8300_Tax_Ye162020_01_S(infcPkgYe162020Vo) ; 
																																															 	 	 		 			    	     ...
																																															 	 	 		 			    	     infcPkgYeta8300.updateYeta8300_Tax_Ye162020_02(infcPkgYe162020Vo);      
																																																								 ...
																																																								 //연금저축등소득세액공제 정리 
																																																								 ///////////////////////////////////////////////////
																																																								InfcPkgYe162010Srh_2023_VO   ye162010SrhVo = new InfcPkgYe162010Srh_2023_VO();	 
																																																	 	 						BeanUtils.copyProperties(ye162010SrhVo, infcPkgYe161010Vo); 
																																																	 	 							
																																																 	 	 		 			  		 List lstPkgYe162010Vo =  infcPkgYeta8300.fnYeta8300_YE162010_Tax_2023_A01_Select(ye162010SrhVo);
																																																 	 	 		 			  	   ...
																																																 	 	 		 			  	   //  bgTotPNSN_SVNG_ACC_PYM_AMT =bgYeta0c98;
																																																		 	 	 		 			     ...
																																																		 	 	 		 			     for (int iCnt03 = 0;iCnt03 < lstPkgYe162010Vo.size();iCnt03++) {
																																																		 	 	 		 			    	 ...
																																																		 	 	 		 			    	 if ("Y0040030".equals(MSFSharedUtils.allowNulls(tempMap01.get("pnsnSvngAccPnsnSvngCl")))) {
																																																		 	 	 		 			    	    ...
																																																		 	 	 		 			    	    infcPkgYeta8300.updateYeta8300_Tax_Ye162010_01(infcPkgYe162010Vo); 
																																																		 	 	 		 			           ...
																																																		 	 	 		 			           //	infcPkgYe162010Vo.setPnsnSvngAccPymAmt();
																																																		 	 	 		 			    		...
																																																		 	 	 		 			    		infcPkgYeta8300.updateYeta8300_Tax_Ye162010_01_S(infcPkgYe162010Vo) ; 
																																																		 	 	 		 			      ...
																																																		 	 	 		 			      infcPkgYeta8300.updateYeta8300_Tax_Ye162010_02(infcPkgYe162010Vo); 	   
																																																 	 	 		 			     ...
																																																 	 	 		 			     InfcPkgYe162030Srh_2023_VO   ye162030SrhVo = new InfcPkgYe162030Srh_2023_VO();	 
																																																 	 							 BeanUtils.copyProperties(ye162030SrhVo, infcPkgYe161010Vo); 
																																																 	 						 
																																																 	 					                
																																															 	 	 		 			  		 List lstPkgYe162030Vo =  infcPkgYeta8300.fnYeta8300_YE162030_Tax_2023_A01_Select(ye162030SrhVo);
																																																	 	 	 		 			 ...
																																																	 	 	 		 			 for (int iCnt03 = 0;iCnt03 < lstPkgYe162030Vo.size();iCnt03++) {
																																																 	 	 		 			    	 ...
																																																 	 	 		 			    	 if ("Y0040050".equals(MSFSharedUtils.allowNulls(tempMap01.get("hsngPrptSvngSvngCl")))) {
																																																 	 	 		 			    	    ...
																																																 	 	 		 			    	    infcPkgYeta8300.updateYeta8300_Tax_YE162030_01(infcPkgYe162030Vo) ;  
																																																	 	 	 		 			    	
																																																	 	 	 		 			     }	 
																																																	 	 	 		 			     
																																																	 	 	 		 			    InfcPkgYe162040Srh_2023_VO   ye162040SrhVo = new InfcPkgYe162040Srh_2023_VO();	 
																																																	 	 							BeanUtils.copyProperties(ye162040SrhVo, infcPkgYe161010Vo); 
																																																	 	 							
																																																 	 	 		 			  		 List lstPkgYe162040Vo =  infcPkgYeta8300.fnYeta8300_YE162040_Tax_2023_A01_Select(ye162040SrhVo);
																																																 	 	 		 			     	 ...
																																																 	 	 		 			     	 BigDecimal bgYetaC109y = new BigDecimal(MSFSharedUtils.defaultNulls(tempMap.get("yetaC109y"),"0"));
																																																	 	 	 		 			    	 ...
																																																	 	 	 		 			    	 if ("Y0040110".equals(MSFSharedUtils.allowNulls(tempMap01.get("ltrmCniSsfnnCl")))) {
																																																	 	 	 		 			      	...
																																																	 	 	 		 			      	infcPkgYeta8300.updateYeta8300_Tax_YE162040_01(infcPkgYe162040Vo) ;      
																																																				 	 	 		 			  
																																																		 	 	 		 			     }	 
																																																								      //월세액거주자간 주책임차차임금 원리금상환 
																																																									
																																																									
																																																									   InfcPkgYe162510Srh_2023_VO   ye162510SrhVo = new InfcPkgYe162510Srh_2023_VO();	 
																																																		 	 							BeanUtils.copyProperties(ye162510SrhVo, infcPkgYe161010Vo); 
																																																		 	 							
																																																									  List lstPkgYe162510Vo =  infcPkgYeta8300.fnYeta8300_YE162510_Tax_2023_A01_Select(ye162510SrhVo);
																																																 	 	 		 			     	 BigDecimal bgYetaC156 = new BigDecimal(MSFSharedUtils.defaultNulls(tempMap.get("yetaC156"),"0"));
																																																										 	...
																																																										 	BeanUtils.copyProperties(infcPkgYe162510Vo, infcPkgYe161010Vo);
																																																	 	 	 		 			    	    ...
																																																	 	 	 		 			    	    infcPkgYeta8300.updateYeta8300_Tax_Ye162510_01(infcPkgYe162510Vo) ; 
																																																		 	 	 		 			    ...
																																																		 	 	 		 			    InfcPkgYe162510_2023_VO    infcPkgYe162510Vo	 = new InfcPkgYe162510_2023_VO();	//G_월세액소득공제명세
																																																									 	BeanUtils.copyProperties(infcPkgYe162510Vo, infcPkgYe161010Vo);  
																																																	 	 	 		 			         infcPkgYeta8300.updateYeta8300_Tax_Ye162510_02(infcPkgYe162510Vo) ;      
																																																									   
																																																		 	 	 		 			    
																																																		 	 	 		 			     InfcPkgYe162520Srh_2023_VO   ye162520SrhVo = new InfcPkgYe162520Srh_2023_VO();	 
																																																		 	 							 BeanUtils.copyProperties(ye162520SrhVo, infcPkgYe161010Vo); 
																																																										 
																																																										 List lstPkgYe162520Vo =  infcPkgYeta8300.fnYeta8300_YE162520_Tax_2023_A01_Select(ye162520SrhVo);
																																																	 	 	 		 			     	 Long bgYeta0c84 = Long.parseLong(MSFSharedUtils.defaultNulls(tempMap.get("yeta0c84"),"0"));
																																																		 	 	 		 			    	...
																																																		 	 	 		 			    	infcPkgYeta8300.updateYeta8300_Tax_Ye162520_01(infcPkgYe162520Vo);    
