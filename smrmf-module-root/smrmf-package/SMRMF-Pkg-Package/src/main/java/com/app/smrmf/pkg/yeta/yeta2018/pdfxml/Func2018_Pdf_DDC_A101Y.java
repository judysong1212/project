...
public class Func2018_Pdf_DDC_A101Y {
	...
	public static void func_2018_A101Y(InfcPkgYe161010_2018_VO ye161010Vo, Element  xmlelDoc, Element  subXmlElForm, String nResult, HttpServletRequest request) throws Exception{ 
		...
		InfcPkgYe167010_2018_VO ye167010Vo = new InfcPkgYe167010_2018_VO();
		InfcPkgYe167020_2018_VO ye167020Vo = new InfcPkgYe167020_2018_VO();
		InfcPkgYe167030_2018_VO ye167030Vo = new InfcPkgYe167030_2018_VO();
		InfcPkgYe167040_2018_VO ye167040Vo = new InfcPkgYe167040_2018_VO();
		InfcPkgYe167050_2018_VO ye167050Vo = new InfcPkgYe167050_2018_VO();
		InfcPkgYe167060_2018_VO ye167060Vo = new InfcPkgYe167060_2018_VO();
		InfcPkgYe167070_2018_VO ye167070Vo = new InfcPkgYe167070_2018_VO();
		InfcPkgYe167530_2018_VO ye167530Vo = new InfcPkgYe167530_2018_VO();
		...
		for (int j = 0; j < subXmlElChildForm.getLength();j++) { 
			...
			yetaPayr3200Service.yeta3200_PDF_YE167010_2018_Delete(ye167010Vo);	//기본정보 삭제
			...
			yetaPayr3200Service.yeta3200_PDF_YE167020_2018_Delete(ye167020Vo);	//인적공제 삭제	
			...
			yetaPayr3200Service.yeta3200_PDF_YE167030_2018_Delete(ye167030Vo);	//인적공제 삭제	
			...
			yetaPayr3200Service.yeta3200_PDF_YE167040_2018_Delete(ye167040Vo);	//연금 보험 삭제
			...
			yetaPayr3200Service.yeta3200_PDF_YE167050_2018_Delete(ye167050Vo);	//특별소득공제 삭제
			...
			yetaPayr3200Service.yeta3200_PDF_YE167060_2018_Delete(ye167060Vo);	//그 밖의 소득공제 삭제
			...
			yetaPayr3200Service.yeta3200_PDF_YE167070_2018_Delete(ye167070Vo);	//세액감면 및 공제 삭제
			...
			yetaPayr3200Service.yeta3200_PDF_YE167530_2018_Delete(ye167530Vo);	//국세청, 기타자료 항목구분 삭제
			...
			yetaPayr3200Service.yeta3200_PDF_YE167010_2018_Insert(ye167010Vo);	//기본정보 입력
	...
	public static void setYe167020Vo(InfcPkgYe167020_2018_VO ye167020Vo , HttpServletRequest request) throws Exception{
		...
		yetaPayr3200Service.yeta3200_PDF_YE167020_2018_Insert(ye167020Vo);	//인적공제 입력

	}
	
	public static void setYe167030Vo(InfcPkgYe167030_2018_VO ye167030Vo , HttpServletRequest request) throws Exception{
		...
		yetaPayr3200Service.yeta3200_PDF_YE167030_2018_Insert(ye167030Vo);	//인적공제 입력
		
	}
	
	public static void setYe167040Vo(InfcPkgYe167040_2018_VO ye167040Vo , HttpServletRequest request) throws Exception{
		...
		yetaPayr3200Service.yeta3200_PDF_YE167040_2018_Insert(ye167040Vo);	//연금 보험 입력
		
	}
	
	public static void setYe167050Vo(InfcPkgYe167050_2018_VO ye167050Vo , HttpServletRequest request) throws Exception{
		...
		yetaPayr3200Service.yeta3200_PDF_YE167050_2018_Insert(ye167050Vo);	//특별공제 입력
		
	}
	
	public static void setYe167060Vo(InfcPkgYe167060_2018_VO ye167060Vo , HttpServletRequest request) throws Exception{
		...
		yetaPayr3200Service.yeta3200_PDF_YE167060_2018_Insert(ye167060Vo);	//그 밖의 소득 공제 입력
		
	}
	
	public static void setYe167070Vo(InfcPkgYe167070_2018_VO ye167070Vo , HttpServletRequest request) throws Exception{
		...
		yetaPayr3200Service.yeta3200_PDF_YE167070_2018_Insert(ye167070Vo);	//세액 감면 및 공제 입력
	}
	
	public static void setYe167530Vo(InfcPkgYe167530_2018_VO ye167530Vo , HttpServletRequest request) throws Exception{
		...
		yetaPayr3200Service.yeta3200_PDF_YE167530_2018_Insert(ye167530Vo);	//국세청, 기타자료 항목구분 입력
	}
}
