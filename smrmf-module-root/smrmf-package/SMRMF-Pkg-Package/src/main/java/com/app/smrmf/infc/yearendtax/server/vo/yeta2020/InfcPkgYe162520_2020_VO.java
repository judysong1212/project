 ...
 */
public class InfcPkgYe162520_2020_VO  implements Serializable {
    ...
    /** set 금전소비대차_임대인성명 : comrCdtrNm */
    private java.lang.String comrCdtrNm;

    /** set 금전소비대차_주민번호 : comrCdtrResnRegnNum */
    private java.lang.String comrCdtrResnRegnNum;

    /** set 금전소비대차_계약시작일자 : comrCnttPridBgnnDt */
    private java.lang.String comrCnttPridBgnnDt;

    /** set 금전소비대차_계약종료일자 : comrCnttPridEndDt */
    private java.lang.String comrCnttPridEndDt;

    /** set 금전소비대차_차입금이자율 : comrLoanItrtRate */
    private Double comrLoanItrtRate;

    /** set 금전소비대차_원리금상환액계 : comrPclttAmtftAggr */
    private Long comrPclttAmtftAggr;

    /** set 금전소비대차_원리금 : comrPrnilSum */
    private Long comrPrnilSum;

    /** set 금전소비대차_이자 : comrItrtSum */
    private Long comrItrtSum;

    /** set 금전소비대차_공제금액 : comrDducSum */
    ...
    public java.lang.String getComrCdtrResnRegnNum() {
        return this.comrCdtrResnRegnNum;
    }
