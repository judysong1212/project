...
=====================================================**/
public class InfcPkgRemt2000Def  extends TableDef implements InfcPkgRemtDaoConstants {

    private int row = 0;
//    private InfcRemtDaoConstants remtLabel = InfcRemtDaoConstants.INSTANCE;

    
    
    public InfcPkgRemt2000Def(String chkData){ 
...
//	        setColumnsDefinition(getRemtPymt0100ToRemt2000());
    ...
    private List<ColumnDef> getMSFPsnl0100ToRemt0100() {
        ...
        listColumnDefs.add(new ColumnDef("사업장코드", InfcPkgPsnl0100BM.ATTR_DPOBCD,  ColumnDef.TYPE_STRING, 100, false, false, false){
            {
        ...
        /** DPOB_NM */
        listColumnDefs.add(new ColumnDef("사업장명", InfcPkgPsnl0100BM.ATTR_DPOBNM,  ColumnDef.TYPE_STRING, 80, false, false, false){
            {
                setAttributeCustomForm(new AttributeCustomForm(0, row++, 10));
            }
        });
        /** SYSTEMKEY */
        listColumnDefs.add(new ColumnDef("시스템키", InfcPkgPsnl0100BM.ATTR_SYSTEMKEY,  ColumnDef.TYPE_STRING, 80, false, false, false){
            {
                setAttributeCustomForm(new AttributeCustomForm(0, row++, 10));
            }
        });
		...
		listColumnDefs.add(new ColumnDef("퇴직정산구분코드", InfcPkgRemt2000BM.ATTR_CALCSEVEPAYPSNDIVCD, ColumnDef.TYPE_STRING , 90, true, false, true){
			{
		
			}
		});
		/** column 퇴직정산구분코드 : calcSevePayPsnDivNm */
		listColumnDefs.add(new ColumnDef("정산구분", InfcPkgRemt2000BM.ATTR_CALCSEVEPAYPSNDIVNM, ColumnDef.TYPE_STRING , 70, true, true, true){
			{
		
			}
		});
		/** column 정산년월 : clutYrMnth */
		listColumnDefs.add(new ColumnDef("정산년월", InfcPkgRemt2000BM.ATTR_CLUTYRMNTH, ColumnDef.TYPE_STRING , 70, true, true, true){
			{
        ...
        /** HAN_NM */
        listColumnDefs.add(new ColumnDef("성명", InfcPkgPsnl0100BM.ATTR_HANNM,  ColumnDef.TYPE_STRING, 50, false, true, true){
            {
        ...
        /** RESN_REGN_NUM */
        listColumnDefs.add(new ColumnDef("주민등록번호", InfcPkgPsnl0100BM.ATTR_RESNREGNNUM,  ColumnDef.TYPE_STRING, 80, false, true, true){
            {
        ...
        /** ATTR_SECREGNNUM */
        listColumnDefs.add(new ColumnDef("주민등록번호", InfcPkgPsnl0100BM.ATTR_SECREGNNUM,  ColumnDef.TYPE_STRING, 80, false, false, false){
            {
                setAttributeCustomForm(new AttributeCustomForm(1, row++));
               // setFormatNumeric("######-#######");
            }
        ...
        /** CURR_AFFN_DEPT_CD */
        listColumnDefs.add(new ColumnDef("부서", InfcPkgPsnl0100BM.ATTR_CURRAFFNDEPTCD,  ColumnDef.TYPE_STRING, 80, false, false, true){
            {
                setAttributeCustomForm(new AttributeCustomForm(1, row++, 100,100));
            }
        });
        /** CURR_AFFN_DEPT_NM */
        listColumnDefs.add(new ColumnDef("부서명", InfcPkgPsnl0100BM.ATTR_CURRAFFNDEPTNM,  ColumnDef.TYPE_STRING, 80, false, true, false){
            {
        ...
        /** EMYMT_DIV_CD */
        listColumnDefs.add(new ColumnDef("고용구분", InfcPkgPsnl0100BM.ATTR_EMYMTDIVCD,  ColumnDef.TYPE_STRING, 80, false, false, true){
            {
                setAttributeCustomForm(new AttributeCustomForm(0, row, 100));
            }
        });
        /** EMYMT_DIV_NM */
        listColumnDefs.add(new ColumnDef("고용구분", InfcPkgPsnl0100BM.ATTR_EMYMTDIVNM,  ColumnDef.TYPE_STRING, 80, false, false, false){
            {
                setAttributeCustomForm(new AttributeCustomForm(0, row, 10));
            }
        });
        ...
        /** TYP_OCCU_CD */
        listColumnDefs.add(new ColumnDef("직종", InfcPkgPsnl0100BM.ATTR_TYPOCCUCD,  ColumnDef.TYPE_STRING, 80, false, false, true){
            {
                setAttributeCustomForm(new AttributeCustomForm(2, row++, 10));
            }
        });
        /** TYP_OCCU_NM */
        listColumnDefs.add(new ColumnDef("직종", InfcPkgPsnl0100BM.ATTR_TYPOCCUNM,  ColumnDef.TYPE_STRING, 80, false, false, false){
            {
		...
		listColumnDefs.add(new ColumnDef("직종세", InfcPkgPsnl0100BM.ATTR_DTILOCCUCLSDIVNM, ColumnDef.TYPE_STRING, 90, false, true, true){
		{
        ...
        /** BUSIN_CD */
        listColumnDefs.add(new ColumnDef("사업", InfcPkgPsnl0100BM.ATTR_BUSINCD,  ColumnDef.TYPE_STRING, 80, false, false, true){
            {
                setAttributeCustomForm(new AttributeCustomForm(2, row++, 10));
            }
        });
        /** BUSIN_NM */
        listColumnDefs.add(new ColumnDef("사업", InfcPkgPsnl0100BM.ATTR_BUSINNM,  ColumnDef.TYPE_STRING, 80, false, true, true){
            {
                setAttributeCustomForm(new AttributeCustomForm(1, row++, 10));
            }
        }); 
        ...
        /** ODTY_CD */
        listColumnDefs.add(new ColumnDef("직책", InfcPkgPsnl0100BM.ATTR_ODTYCD,  ColumnDef.TYPE_STRING, 80, false, false, false){
            {
                setAttributeCustomForm(new AttributeCustomForm(3, row++, 10));
            }
        });
        /** ODTY_NM */
        listColumnDefs.add(new ColumnDef("직책", InfcPkgPsnl0100BM.ATTR_ODTYNM,  ColumnDef.TYPE_STRING, 80, false, false, false){
            {
                setAttributeCustomForm(new AttributeCustomForm(1, row++, 10));
            }
        });
        /** HDOFC_CODTN_CD */
        listColumnDefs.add(new ColumnDef("재직상태", InfcPkgPsnl0100BM.ATTR_HDOFCCODTNCD,  ColumnDef.TYPE_STRING, 80, false, false, false){
            {
                setAttributeCustomForm(new AttributeCustomForm(3, row++, 10));
            }
        });
        ...
        /** HDOFC_CODTN_NM */
        listColumnDefs.add(new ColumnDef("재직상태", InfcPkgPsnl0100BM.ATTR_HDOFCCODTNNM,  ColumnDef.TYPE_STRING, 80, false, true, true){
            {
                setAttributeCustomForm(new AttributeCustomForm(1, row++, 10));
            }
        });
        ...
        /** LOG_SVC_YR_NUM_CD */
        listColumnDefs.add(new ColumnDef("근속년수코드", InfcPkgPsnl0100BM.ATTR_LOGSVCYRNUMCD,  ColumnDef.TYPE_STRING, 80, false, false, false){
            {
                setAttributeCustomForm(new AttributeCustomForm(1, row++, 10));
            }
        });
        /** LOG_SVC_YR_NUM_NM */
        listColumnDefs.add(new ColumnDef("근속년수", InfcPkgPsnl0100BM.ATTR_LOGSVCYRNUMNM,  ColumnDef.TYPE_STRING, 80, false, false, false){
            {
                setAttributeCustomForm(new AttributeCustomForm(1, row++, 10));
            }
        });
//        /** LOG_SVC_MNTH_ICM_CD */
//        listColumnDefs.add(new ColumnDef("근속월수코드", InfcPkgPsnl0100BM.ATTR_LOGSVCMNTHICMCD,  ColumnDef.TYPE_STRING, 80, false, false, false){
//            {
//                setAttributeCustomForm(new AttributeCustomForm(1, row++, 10));
//            }
//        });
//        /** LOG_SVC_MNTH_ICM_NM */
//        listColumnDefs.add(new ColumnDef("근속월수", InfcPkgPsnl0100BM.ATTR_LOGSVCMNTHICMNM,  ColumnDef.TYPE_STRING, 80, false, false, false){
//            {
//                setAttributeCustomForm(new AttributeCustomForm(1, row++, 10));
//            }
//        }); 
...
//        /** SX_DIV_CD */
//        listColumnDefs.add(new ColumnDef("성별코드", InfcPkgPsnl0100BM.ATTR_SXDIVCD,  ColumnDef.TYPE_STRING, 80, false, false, false){
//            {
//                setAttributeCustomForm(new AttributeCustomForm(1, row++, 10));
//            }
//        });
//        /** SX_DIV_NM */
//        listColumnDefs.add(new ColumnDef("성별", InfcPkgPsnl0100BM.ATTR_SXDIVNM,  ColumnDef.TYPE_STRING, 80, false, false, false){
//            {
//                setAttributeCustomForm(new AttributeCustomForm(1, row++, 10));
//            }
//        });
//        /** YOOBH_MNTH_DAY */
//        listColumnDefs.add(new ColumnDef("생년월일", InfcPkgPsnl0100BM.ATTR_YOOBHMNTHDAY,  ColumnDef.TYPE_STRING, 80, false, false, false){
//            {
//                setAttributeCustomForm(new AttributeCustomForm(1, row++, 10));
//            }
//        });
...
//        
//        /** NATN_CD */
//        listColumnDefs.add(new ColumnDef("국가코드", InfcPkgPsnl0100BM.ATTR_NATNCD,  ColumnDef.TYPE_STRING, 80, false, false, false){
//            {
//                setAttributeCustomForm(new AttributeCustomForm(1, row++, 10));
//            }
//        });
//        /** NATN_Nm */
//        listColumnDefs.add(new ColumnDef("국가명", InfcPkgPsnl0100BM.ATTR_NATNNM,  ColumnDef.TYPE_STRING, 80, false, false, false){
//            {
//                setAttributeCustomForm(new AttributeCustomForm(1, row++, 10));
//            }
//        });
...
//     
//        /** FRST_EMYMT_DT */
//        listColumnDefs.add(new ColumnDef("최초고용일자", InfcPkgPsnl0100BM.ATTR_FRSTEMYMTDT,  ColumnDef.TYPE_STRING, 80, false, false, false){
//            {
//                setAttributeCustomForm(new AttributeCustomForm(1, row++, 10));
//            }
//        }); 
//        /** EMYMT_BGNN_DT */
//        listColumnDefs.add(new ColumnDef("고용시작일자", InfcPkgPsnl0100BM.ATTR_EMYMTBGNNDT,  ColumnDef.TYPE_STRING, 80, false, false, false){
//            {
//                setAttributeCustomForm(new AttributeCustomForm(1, row++, 10));
//            }
//        });
//        /** EMYMT_END_DT */
//        listColumnDefs.add(new ColumnDef("고용종료일자", InfcPkgPsnl0100BM.ATTR_EMYMTENDDT,  ColumnDef.TYPE_STRING, 80, false, false, false){
//            {
//                setAttributeCustomForm(new AttributeCustomForm(1, row++, 10));
//            }
//        });
//        /** PYSP_CD */
//        listColumnDefs.add(new ColumnDef("호봉코드", InfcPkgPsnl0100BM.ATTR_PYSPCD,  ColumnDef.TYPE_STRING, 80, false, false, false){
//            {
//                setAttributeCustomForm(new AttributeCustomForm(1, row++, 10));
//            }
//        });
//        /** PYSP_NM */
//        listColumnDefs.add(new ColumnDef("호봉", InfcPkgPsnl0100BM.ATTR_PYSPNM,  ColumnDef.TYPE_STRING, 80, false, false, false){
//            {
//                setAttributeCustomForm(new AttributeCustomForm(1, row++, 10));
//            }
//        });
//        
//        /** RETRY_DT */
//        listColumnDefs.add(new ColumnDef("퇴직일자", InfcPkgPsnl0100BM.ATTR_RETRYDT,  ColumnDef.TYPE_STRING, 80, false, false, false){
//            {
//                setAttributeCustomForm(new AttributeCustomForm(1, row++, 10));
//            }
//        });
//        /** RETRY_REAS_CTNT */
//        listColumnDefs.add(new ColumnDef("퇴직사유", InfcPkgPsnl0100BM.ATTR_RETRYREASCTNT,  ColumnDef.TYPE_STRING, 80, false, false, false){
//            {
//                setAttributeCustomForm(new AttributeCustomForm(1, row++, 10));
//            }
//        });
//        /** FRGNR_DIV_CD */
//        listColumnDefs.add(new ColumnDef("외국인구분코드", InfcPkgPsnl0100BM.ATTR_FRGNRDIVCD,  ColumnDef.TYPE_STRING, 80, false, false, false){
//            {
//                setAttributeCustomForm(new AttributeCustomForm(1, row++, 10));
//            }
//        });
...
/** column 사업장코드 : dpobCd */
listColumnDefs.add(new ColumnDef("사업장코드", InfcPkgRemt2000BM.ATTR_DPOBCD, ColumnDef.TYPE_STRING , 90, true, false, true){
	{

	}
});
/** column SYSTEMKEY : systemkey */
listColumnDefs.add(new ColumnDef("SYSTEMKEY", InfcPkgRemt2000BM.ATTR_SYSTEMKEY, ColumnDef.TYPE_STRING , 90, true, false, true){
	{
...
/** column 정산년월 : clutYrMnth */
listColumnDefs.add(new ColumnDef("정산년월", InfcPkgRemt2000BM.ATTR_CLUTYRMNTH, ColumnDef.TYPE_STRING , 90, true, false, true){
	{

	}
});
/** column 고용구분코드 : emymtDivCd */
listColumnDefs.add(new ColumnDef("고용구분코드", InfcPkgRemt2000BM.ATTR_EMYMTDIVCD, ColumnDef.TYPE_STRING , 90, true, false, true){
	{

	}
});
/** column 부서코드 : deptCd */
listColumnDefs.add(new ColumnDef("부서코드", InfcPkgRemt2000BM.ATTR_DEPTCD, ColumnDef.TYPE_STRING , 90, true, false, true){
	{

	}
});
/** column 직종코드 : typOccuCd */
listColumnDefs.add(new ColumnDef("직종코드", InfcPkgRemt2000BM.ATTR_TYPOCCUCD, ColumnDef.TYPE_STRING , 90, true, false, true){
	{

	}
});
/** column 호봉등급코드 : pyspGrdeCd */
listColumnDefs.add(new ColumnDef("호봉등급코드", InfcPkgRemt2000BM.ATTR_PYSPGRDECD, ColumnDef.TYPE_STRING , 90, true, false, true){
	{

	}
});
/** column 직종세구분코드 : dtilOccuClsDivCd */
listColumnDefs.add(new ColumnDef("직종세구분코드", InfcPkgRemt2000BM.ATTR_DTILOCCUCLSDIVCD, ColumnDef.TYPE_STRING , 90, true, false, true){
	{
	...
	/** column 직종세통합코드 : dtilOccuInttnCd */
	listColumnDefs.add(new ColumnDef("직종세통합코드", InfcPkgRemt2000BM.ATTR_DTILOCCUINTTNCD, ColumnDef.TYPE_STRING , 90, true, false, true){
	{
	...
	/** column 직종세 : dtilOccuClsDivNm */
	listColumnDefs.add(new ColumnDef("직종세", InfcPkgRemt2000BM.ATTR_DTILOCCUCLSDIVNM, ColumnDef.TYPE_STRING, 90, false, false, true){
	{
	
	}
	});       
/** column 사업코드 : businCd */
listColumnDefs.add(new ColumnDef("사업코드", InfcPkgRemt2000BM.ATTR_BUSINCD, ColumnDef.TYPE_STRING , 90, true, false, true){
	{

	}
});
/** column 직위코드 : inbyCd */
listColumnDefs.add(new ColumnDef("직위코드", InfcPkgRemt2000BM.ATTR_INBYCD, ColumnDef.TYPE_STRING , 90, true, false, true){
	{

	}
});
/** column 호봉코드 : pyspCd */
listColumnDefs.add(new ColumnDef("호봉코드", InfcPkgRemt2000BM.ATTR_PYSPCD, ColumnDef.TYPE_STRING , 90, true, false, true){
	{

	}
});
/** column 근속년수코드 : logSvcYrNumCd */
listColumnDefs.add(new ColumnDef("근속년수코드", InfcPkgRemt2000BM.ATTR_LOGSVCYRNUMCD, ColumnDef.TYPE_STRING , 90, true, false, true){
	{

	}
});
/** column 근속월수코드 : logSvcMnthIcmCd */
listColumnDefs.add(new ColumnDef("근속월수코드", InfcPkgRemt2000BM.ATTR_LOGSVCMNTHICMCD, ColumnDef.TYPE_STRING , 90, true, false, true){
	{

	}
});
/** column 성명 : nm */
listColumnDefs.add(new ColumnDef("성명", InfcPkgRemt2000BM.ATTR_NM, ColumnDef.TYPE_STRING , 90, true, false, true){
	{

	}
});
/** column 입사일자 : icncDt */
listColumnDefs.add(new ColumnDef("입사일자", InfcPkgRemt2000BM.ATTR_ICNCDT, ColumnDef.TYPE_STRING , 90, true, false, true){
	{

	}
});
/** column 기산일자 : rkfcdDt */
listColumnDefs.add(new ColumnDef("기산일자", InfcPkgRemt2000BM.ATTR_RKFCDDT, ColumnDef.TYPE_STRING , 90, true, false, true){
	{

	}
});
/** column 퇴직일자 : retryDt */
listColumnDefs.add(new ColumnDef("퇴직일자", InfcPkgRemt2000BM.ATTR_RETRYDT, ColumnDef.TYPE_STRING , 90, true, false, true){
	{

	}
});
/** column 근속년수 : logSvcYrNum */
listColumnDefs.add(new ColumnDef("근속년수", InfcPkgRemt2000BM.ATTR_LOGSVCYRNUM, ColumnDef.TYPE_LONG , 90, true, false, true){
	{

	}
});
/** column 근속월수 : logSvcMnthIcm */
listColumnDefs.add(new ColumnDef("근속월수", InfcPkgRemt2000BM.ATTR_LOGSVCMNTHICM, ColumnDef.TYPE_LONG , 90, true, false, true){
	{

	}
});
/** column 군경력근속년수 : amcrrLogSvcYrNum */
listColumnDefs.add(new ColumnDef("군경력근속년수", InfcPkgRemt2000BM.ATTR_AMCRRLOGSVCYRNUM, ColumnDef.TYPE_LONG , 90, true, false, true){
	{

	}
});
/** column 군경력근속월수 : amcrrLogSvcMnthIcm */
listColumnDefs.add(new ColumnDef("군경력근속월수", InfcPkgRemt2000BM.ATTR_AMCRRLOGSVCMNTHICM, ColumnDef.TYPE_LONG , 90, true, false, true){
	{

	}
});
/** column 제외월수_2012이전 : eepnMnthIcm2012Bfr */
listColumnDefs.add(new ColumnDef("제외월수_2012이전", InfcPkgRemt2000BM.ATTR_EEPNMNTHICM2012BFR, ColumnDef.TYPE_LONG , 90, true, false, true){
	{

	}
});
/** column 제외월수_2013이후 : eepnMnthIcm2013Aft */
listColumnDefs.add(new ColumnDef("제외월수_2013이후", InfcPkgRemt2000BM.ATTR_EEPNMNTHICM2013AFT, ColumnDef.TYPE_LONG , 90, true, false, true){
	{

	}
});
/** column 가산월수_2012이전 : addMnthIcm2012Bfr */
listColumnDefs.add(new ColumnDef("가산월수_2012이전", InfcPkgRemt2000BM.ATTR_ADDMNTHICM2012BFR, ColumnDef.TYPE_LONG , 90, true, false, true){
	{

	}
});
/** column 가산월수_2013이후 : addMnthIcm2013Aft */
listColumnDefs.add(new ColumnDef("가산월수_2013이후", InfcPkgRemt2000BM.ATTR_ADDMNTHICM2013AFT, ColumnDef.TYPE_LONG , 90, true, false, true){
	{

	}
});
/** column 제외일수 : eepnDayIcmDys */
listColumnDefs.add(new ColumnDef("제외일수", InfcPkgRemt2000BM.ATTR_EEPNDAYICMDYS, ColumnDef.TYPE_LONG , 90, true, false, true){
	{

	}
});
/** column 근속일수 : logSvcNumDys */
listColumnDefs.add(new ColumnDef("근속일수", InfcPkgRemt2000BM.ATTR_LOGSVCNUMDYS, ColumnDef.TYPE_LONG , 90, true, false, true){
	{

	}
});
/** column 군경력근무일수 : amcrrLogSvcNumDys */
listColumnDefs.add(new ColumnDef("군경력근무일수", InfcPkgRemt2000BM.ATTR_AMCRRLOGSVCNUMDYS, ColumnDef.TYPE_LONG , 90, true, false, true){
	{
...
/** column 실근무년수 : turtyDutyYrNum */
listColumnDefs.add(new ColumnDef("실근무년수", InfcPkgRemt2000BM.ATTR_TURTYDUTYYRNUM, ColumnDef.TYPE_LONG , 90, true, false, true){
	{

	}
});
/** column 실근무개월수 : turtyDutyMnthNum */
listColumnDefs.add(new ColumnDef("실근무개월수", InfcPkgRemt2000BM.ATTR_TURTYDUTYMNTHNUM, ColumnDef.TYPE_LONG , 90, true, false, true){
	{

	}
});
/** column 실근무일수 : turtyDutyNumDys */
listColumnDefs.add(new ColumnDef("실근무일수", InfcPkgRemt2000BM.ATTR_TURTYDUTYNUMDYS, ColumnDef.TYPE_LONG , 90, true, false, true){
	{
...
/** column 급여산정시작일자 : payCmpttnBgnnDt */
listColumnDefs.add(new ColumnDef("급여산정시작일자", InfcPkgRemt2000BM.ATTR_PAYCMPTTNBGNNDT, ColumnDef.TYPE_STRING , 90, true, false, true){
	{

	}
});
/** column 급여산정종료일자 : payCmpttnEndDt */
listColumnDefs.add(new ColumnDef("급여산정종료일자", InfcPkgRemt2000BM.ATTR_PAYCMPTTNENDDT, ColumnDef.TYPE_STRING , 90, true, false, true){
	{

	}
});
/** column 기본급여합계금액 : fndtnPayAggrSumSum */
listColumnDefs.add(new ColumnDef("기본급여합계금액", InfcPkgRemt2000BM.ATTR_FNDTNPAYAGGRSUMSUM, ColumnDef.TYPE_LONG , 90, true, false, true){
	{

	}
});
/** column 제수당합계금액 : snryAllwAggrSum */
listColumnDefs.add(new ColumnDef("제수당합계금액", InfcPkgRemt2000BM.ATTR_SNRYALLWAGGRSUM, ColumnDef.TYPE_LONG , 90, true, false, true){
	{

	}
});
/** column 후생복지비합계금액 : welfWelfSpdgAggrSum */
listColumnDefs.add(new ColumnDef("후생복지비합계금액", InfcPkgRemt2000BM.ATTR_WELFWELFSPDGAGGRSUM, ColumnDef.TYPE_LONG , 90, true, false, true){
	{

	}
});
/** column 3월간후생복지비 : marPubcWelfAmnt */
listColumnDefs.add(new ColumnDef("3월간후생복지비", InfcPkgRemt2000BM.ATTR_MARPUBCWELFAMNT, ColumnDef.TYPE_LONG , 90, true, false, true){
	{

	}
});
/** column 3월간총임금액 : marTotAmntWag */
listColumnDefs.add(new ColumnDef("3월간총임금액", InfcPkgRemt2000BM.ATTR_MARTOTAMNTWAG, ColumnDef.TYPE_LONG , 90, true, false, true){
	{

	}
});
/** column 1일평균임금액 : dayAvgAmntWag */
listColumnDefs.add(new ColumnDef("1일평균임금액", InfcPkgRemt2000BM.ATTR_DAYAVGAMNTWAG, ColumnDef.TYPE_LONG , 90, true, false, true){
	{

	}
});
/** column 퇴직금산정금액 : sevePayCmpttnSum */
listColumnDefs.add(new ColumnDef("퇴직금산정금액", InfcPkgRemt2000BM.ATTR_SEVEPAYCMPTTNSUM, ColumnDef.TYPE_STRING , 90, true, false, true){
	{

	}
});
/** column 퇴직금가산금액 : sevePayAddSum */
listColumnDefs.add(new ColumnDef("퇴직금가산금액", InfcPkgRemt2000BM.ATTR_SEVEPAYADDSUM, ColumnDef.TYPE_LONG , 90, true, false, true){
	{

	}
});
/** column 퇴직금가산율 : sevePayAddRate */
listColumnDefs.add(new ColumnDef("퇴직금가산율", InfcPkgRemt2000BM.ATTR_SEVEPAYADDRATE, ColumnDef.TYPE_DOUBLE , 90, true, false, true){
	{

	}
});
/** column 퇴직금가산적용금액 : sevePayAddApptnSum */
listColumnDefs.add(new ColumnDef("퇴직금가산적용금액", InfcPkgRemt2000BM.ATTR_SEVEPAYADDAPPTNSUM, ColumnDef.TYPE_LONG , 90, true, false, true){
	{

	}
});
/** column 군경력정산포함여부 : amcrrClutInsnYn */
listColumnDefs.add(new ColumnDef("군경력정산포함여부", InfcPkgRemt2000BM.ATTR_AMCRRCLUTINSNYN, ColumnDef.TYPE_STRING , 90, true, false, true){
	{

	}
});
/** column 군경력가산적용금액 : amcrrAddApptnSum */
listColumnDefs.add(new ColumnDef("군경력가산적용금액", InfcPkgRemt2000BM.ATTR_AMCRRADDAPPTNSUM, ColumnDef.TYPE_LONG , 90, true, false, true){
	{

	}
});
/** column 총근무일수 : totLogSvcNumDys */
listColumnDefs.add(new ColumnDef("총근무일수", InfcPkgRemt2000BM.ATTR_TOTLOGSVCNUMDYS, ColumnDef.TYPE_LONG , 90, true, false, true){
	{

	}
});
/** column 퇴직금지급액 : sevePayPymtSum */
listColumnDefs.add(new ColumnDef("퇴직금지급액", InfcPkgRemt2000BM.ATTR_SEVEPAYPYMTSUM, ColumnDef.TYPE_LONG , 90, true, false, true){
	{

	}
});
/** column 퇴직금산정비과세금액 : sevePayCmpttnFreeDtySum */
listColumnDefs.add(new ColumnDef("퇴직금산정비과세금액", InfcPkgRemt2000BM.ATTR_SEVEPAYCMPTTNFREEDTYSUM, ColumnDef.TYPE_STRING , 90, true, false, true){
	{

	}
});
/** column 퇴직금산정과세금액 : sevePayCmpttnTxtnSum */
listColumnDefs.add(new ColumnDef("퇴직금산정과세금액", InfcPkgRemt2000BM.ATTR_SEVEPAYCMPTTNTXTNSUM, ColumnDef.TYPE_STRING , 90, true, false, true){
	{

	}
});
/** column 퇴직금지급공제금액 : sevePayPymtDducSum */
listColumnDefs.add(new ColumnDef("퇴직금지급공제금액", InfcPkgRemt2000BM.ATTR_SEVEPAYPYMTDDUCSUM, ColumnDef.TYPE_LONG , 90, true, false, true){
	{

	}
});
/** column 퇴직금실지급금액 : sevePayTurtyPymtSum */
listColumnDefs.add(new ColumnDef("퇴직금실지급금액", InfcPkgRemt2000BM.ATTR_SEVEPAYTURTYPYMTSUM, ColumnDef.TYPE_STRING , 90, true, false, true){
	{

	}
});
/** column 퇴직금비고내용 : sevePayNoteCtnt */
listColumnDefs.add(new ColumnDef("퇴직금비고내용", InfcPkgRemt2000BM.ATTR_SEVEPAYNOTECTNT, ColumnDef.TYPE_STRING , 90, true, false, true){
	{

	}
});
/** column 퇴직금지급일자 : sevePayPymtDt */
listColumnDefs.add(new ColumnDef("퇴직금지급일자", InfcPkgRemt2000BM.ATTR_SEVEPAYPYMTDT, ColumnDef.TYPE_STRING , 90, true, false, true){
	{

	}
});
/** column 퇴직금지급여부 : sevePayPymtYn */
listColumnDefs.add(new ColumnDef("퇴직금지급여부", InfcPkgRemt2000BM.ATTR_SEVEPAYPYMTYN, ColumnDef.TYPE_STRING , 90, true, false, true){
	{

	}
});
/** column 마감여부 : ddlneYn */
listColumnDefs.add(new ColumnDef("마감여부", InfcPkgRemt2000BM.ATTR_DDLNEYN, ColumnDef.TYPE_STRING , 90, true, false, true){
	{

	}
});
/** column 마감일시 : ddlneDt */
listColumnDefs.add(new ColumnDef("마감일시", InfcPkgRemt2000BM.ATTR_DDLNEDT, ColumnDef.TYPE_STRING , 90, true, false, true){
	{

	}
});
/** column 입력자 : kybdr */
listColumnDefs.add(new ColumnDef("입력자", InfcPkgRemt2000BM.ATTR_KYBDR, ColumnDef.TYPE_STRING , 90, true, false, true){
	{

	}
});
/** column 입력일자 : inptDt */
listColumnDefs.add(new ColumnDef("입력일자", InfcPkgRemt2000BM.ATTR_INPTDT, ColumnDef.TYPE_STRING , 90, true, false, true){
	{

	}
});
/** column 입력주소 : inptAddr */
listColumnDefs.add(new ColumnDef("입력주소", InfcPkgRemt2000BM.ATTR_INPTADDR, ColumnDef.TYPE_STRING , 90, true, false, true){
	{

	}
});
/** column 수정자 : ismt */
listColumnDefs.add(new ColumnDef("수정자", InfcPkgRemt2000BM.ATTR_ISMT, ColumnDef.TYPE_STRING , 90, true, false, true){
	{

	}
});
/** column 수정일자 : revnDt */
listColumnDefs.add(new ColumnDef("수정일자", InfcPkgRemt2000BM.ATTR_REVNDT, ColumnDef.TYPE_STRING , 90, true, false, true){
	{

	}
});
/** column 수정주소 : revnAddr */
listColumnDefs.add(new ColumnDef("수정주소", InfcPkgRemt2000BM.ATTR_REVNADDR, ColumnDef.TYPE_STRING , 90, true, false, true){
	{
