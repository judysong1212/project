 ...
 */
@Controller 
public class RemtOkCheonProcessContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(RemtOkCheonProcessContainer.class);
    private static final String calledClass = RemtOkCheonProcessContainer.class.getName();
