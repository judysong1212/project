 ...
 */
@Controller 
public class Yeta3100OkCheonProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta3100OkCheonProcContainer.class);
...
//
    ...
    public Yeta3100OkCheonProcContainer() {
