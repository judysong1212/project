 ...
 */
@Controller 
public class Yeta2300OkCheonProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta2300OkCheonProcContainer.class);
    ...
    public Yeta2300OkCheonProcContainer() {
