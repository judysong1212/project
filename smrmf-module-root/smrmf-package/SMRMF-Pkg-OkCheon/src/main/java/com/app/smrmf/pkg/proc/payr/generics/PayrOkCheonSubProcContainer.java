 ...
 */
@Controller 
public class PayrOkCheonSubProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(PayrOkCheonSubProcContainer.class);
