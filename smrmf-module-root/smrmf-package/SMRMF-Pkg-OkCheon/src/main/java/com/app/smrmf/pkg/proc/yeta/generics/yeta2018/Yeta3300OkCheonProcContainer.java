 ...
 */
@Controller 
public class Yeta3300OkCheonProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta3300OkCheonProcContainer.class);
    ...
    public Yeta3300OkCheonProcContainer() {
