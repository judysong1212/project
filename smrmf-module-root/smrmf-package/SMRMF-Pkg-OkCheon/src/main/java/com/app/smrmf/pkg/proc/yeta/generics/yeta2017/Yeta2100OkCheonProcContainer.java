 ...
 */
@Controller 
public class Yeta2100OkCheonProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta2100OkCheonProcContainer.class);
...
//
    ...
    public Yeta2100OkCheonProcContainer() {
