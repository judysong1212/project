 ...
 */
@Controller 
public class Yeta3100GeoChangProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta3100GeoChangProcContainer.class);
...
//
    ...
    public Yeta3100GeoChangProcContainer() {
