 ...
 */
@Controller 
public class PayrGeoChangSubProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(PayrGeoChangSubProcContainer.class);
