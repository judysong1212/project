 ...
 */
@Controller 
public class RemtGeoChangProcessContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(RemtGeoChangProcessContainer.class);
    private static final String calledClass = RemtGeoChangProcessContainer.class.getName();
