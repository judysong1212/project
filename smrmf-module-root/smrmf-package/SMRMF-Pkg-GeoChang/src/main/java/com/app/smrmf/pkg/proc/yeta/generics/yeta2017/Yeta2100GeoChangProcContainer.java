 ...
 */
@Controller 
public class Yeta2100GeoChangProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta2100GeoChangProcContainer.class);
...
//
    ...
    public Yeta2100GeoChangProcContainer() {
