 ...
 */
@Controller 
public class Yeta3300GeoChangProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta3300GeoChangProcContainer.class);
    ...
    public Yeta3300GeoChangProcContainer() {
