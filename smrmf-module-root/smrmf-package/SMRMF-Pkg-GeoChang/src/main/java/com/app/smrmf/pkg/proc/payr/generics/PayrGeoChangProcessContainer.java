...
import com.app.smrmf.constc.geochang.ConstGeoChang;
 ...
 */
@Controller 
public class PayrGeoChangProcessContainer  extends AbstractCustomServiceImpl {  

	private static final Logger logger = LoggerFactory.getLogger(PayrGeoChangProcessContainer.class);
...
//                                                               }  
                                                                ...
                                                                if ((new BigDecimal(payCalculationVo.getDilnlazAbnceNumDys())).compareTo(BigDecimal.ZERO) > 0) {
	                                                               ...
	                                                               //  payCalculationVo.getDilnlazAbnceNumDys()   /** column 근태_결근일수 : dilnlazAbnceNumDys */
	                                                                abnceNumDysAmt = (new BigDecimal(payCalculationVo.getDilnlazAbnceNumDys()))
	                                                                                .multiply(payr0410.getUsalyAmntHrwgQnty().multiply(new BigDecimal(ConstGeoChang.PAYR_BASS_WKTM_AS_01)));  // USALY_AMNT_HRWG_QNTY 시급통상임금 
            ...
            //                                                       payr0302Vo.setRevnAddr(payr0302Vo.getRevnAddr());    /** column 수정주소 : revnAddr */   
                                                        	   ...
                                                        	   /***********************************************************************/
                                                        	   /* 도로보수원인경우    00200013A0060000' = AA.DTIL_OCCU_INTTN_CD   */
                                                        	   /************************************************************************/
                                                        	   //반장수당        
                                                               //직책별 수당  
                                                                 if ("00200013A0060000".equals(payCalculationVo.getDtilOccuInttnCd()) && "A0150003".equals(payCalculationVo.getOdtyCd())) {
                  ...
                  //                                                   payr0302Vo.setRevnAddr(payr0302Vo.getRevnAddr());    /** column 수정주소 : revnAddr */   
                                                        	   ...
                                                        	   //반장수당        
                                                               //조장인경우 
                                                                 if ("00200013A0060000".equals(payCalculationVo.getDtilOccuInttnCd()) && "A0150004".equals(payCalculationVo.getOdtyCd())) {
            ...
            //                                                   payr0302Vo.setRevnAddr(payr0302Vo.getRevnAddr());    /** column 수정주소 : revnAddr */   
	          ...
	          //                                                   payr0302Vo.setRevnAddr(payr0302Vo.getRevnAddr());    /** column 수정주소 : revnAddr */   
	                                                            ...
	                                                            // InfcPkgPayr0302VO tpPayr0302vo = new InfcPkgPayr0302VO();
	                                                             ...
	                                                             //TODO 확인후 다시 확인 
	                                                             /* A0490010의료급여관리	N							00100028A0060000
	                                                             A0490010산림병충해 예찰	N							00100029A0060000
	                                                             A0490010금연상담사	N							00100030A0060000
	                                                             A0490010건강생활실천	N							00100031A0060000
	                                                             A0490010예방접종등록원	N							00100032A0060000 */
	                                                             ...
	                                                             if ("00100028A0060000".equals(payCalculationVo.getDtilOccuInttnCd()) ||
	                                                            		 "00100029A0060000".equals(payCalculationVo.getDtilOccuInttnCd()) ||
	                                                            		 "00100030A0060000".equals(payCalculationVo.getDtilOccuInttnCd()) ||
	                                                            		 "00100031A0060000".equals(payCalculationVo.getDtilOccuInttnCd()) ||
	                                                            		 "00100032A0060000".equals(payCalculationVo.getDtilOccuInttnCd()) 
	                                                            		 ) { 
	                                                                      ...
	                                                                      if (ExtermsProps.getProps("PAY_EMYMT_PYMT_07").equals(payr0410.getPayrImcd())) {
	                                                                          ...
	                                                                          if (new BigDecimal(payCalculationVo.getDilnlazTotTmRstDutyTm()).compareTo(BigDecimal.ZERO) > 0) {
	                                                                                //시간외근무  -USALY_AMNT_HRWG_QNTY 계산된 시급으로 정리한다. 통상시급 
	                                                                                  BigDecimal ucstSum = (payr0410.getUsalyAmntHrwgQnty().multiply(new BigDecimal("1.5"))).setScale(5,BigDecimal.ROUND_DOWN); 
	                                                                                
	                                                                                  if (payr0250Vo.getJobYrMnth().substring(4,6).equals("12")) { 
	                                                                                	  ucstSum =  (payr0410.getUsalyAmntHrwgQnty().multiply(new BigDecimal("1.5"))).setScale(5,BigDecimal.ROUND_DOWN); 
	                                                                                  } 
	                                                                       ...
	                                                                       // 야간수당       -- 시간산정C9410300 MNTH_USALY_AMNT_WAG
	                                                                          if (new BigDecimal(MSFSharedUtils.defaultNulls(payCalculationVo.getDilnlazTotNtotTm(),"0")).compareTo(BigDecimal.ZERO) > 0) {
	                                                                              ...
	                                                                              // BigDecimal ucstSum = (payr0410.getUsalyAmntHrwgQnty().add(((payr0410.getMnthUsalyAmntWag().divide(new BigDecimal("209"), 3))).multiply(new BigDecimal("0.5")))).setScale(0,BigDecimal.ROUND_DOWN);
	                                                                        	  ...
	                                                                        	  BigDecimal ucstSum =  (((payr0410.getMnthUsalyAmntWag().divide(new BigDecimal("243"), 5))).multiply(new BigDecimal("2"))).setScale(0,BigDecimal.ROUND_DOWN);
	                                                                        	  if (payr0250Vo.getJobYrMnth().substring(4,6).equals("12")) { 
                                                                                	 // ucstSum = (payr0410.getUsalyAmntHrwgQnty().add(((payr0410.getMnthUsalyAmntWag().divide(new BigDecimal("209"), 3)).multiply(new BigDecimal("0.5"))))).setScale(0,BigDecimal.ROUND_DOWN);
	                                                                        		 // payr0410.getUcstSum().compareTo(BigDecimal.ZERO) > 0 ? payr0410.getUcstSum() : payr0410.getPymtDducSum();
                                                                                	  ucstSum = (((payr0410.getMnthUsalyAmntWag().divide(new BigDecimal("243"), 5)).multiply(new BigDecimal("2")))).setScale(0,BigDecimal.ROUND_DOWN);
                                                                                  } 
	                                                                              BigDecimal totTmSum = BigDecimal.ZERO;
	                                                                        ...
	                                                                        // 휴일수당        -- 일수 C9410200
	                                                                          if (MSFSharedUtils.paramNotNull(payCalculationVo.getDilnlazPubcHodyDutyNumDys())) {
	                                                                              ...
	                                                                              if (new BigDecimal(MSFSharedUtils.defaultNulls(payCalculationVo.getDilnlazPubcHodyDutyNumDys(),"0")).compareTo(BigDecimal.ZERO) > 0) {
	                                                                                  ...
	                                                                                  BigDecimal ucstSum = (payr0410.getUsalyAmntPdyQnty().multiply(new BigDecimal("1.5"))).setScale(5,BigDecimal.ROUND_DOWN); 
	                                                                                  if (payr0250Vo.getJobYrMnth().substring(4,6).equals("12")) { 
	                                                                          ...
	                                                                          if (new BigDecimal(payCalculationVo.getDilnlazLvsgNumDys()).compareTo(BigDecimal.ZERO) > 0) {
	                                                                              ...
	                                                                              BigDecimal ucstSum =  payr0410.getUsalyAmntPdyQnty();
	                                                                              //payr0410.getUcstSum().compareTo(BigDecimal.ZERO) > 0 ? payr0410.getUcstSum() : payr0410.getPymtDducSum();
	                                                                             ...
	                                                                             // PAY_EMYMT_PYMT_15 = "C9990200";    // 출장여비 
	                                                                              ...
	                                                                              BigDecimal totTmSum = BigDecimal.ZERO;
	                                                                              ucstNoSumD9500400 = ucstNoSumD9500400.add(ucstSum);
      ...
      //                                          payr0302Vo.setRevnAddr(payr0302Vo.getRevnAddr());    /** column 수정주소 : revnAddr */  
                                                  ...
                                                  if (ExtermsProps.getProps("PAY_EMYMT_PYMT_15").equals(payr0520Vo.getPayItemCd())) {
...
//	                                                               }   
	            ...
	            //                                                   payr0302Vo.setRevnAddr(payr0302Vo.getRevnAddr());    /** column 수정주소 : revnAddr */   
	                                                               ...
	                                                               basePymtAmnt = (tpPymtTotAmnt.subtract(tpSchlExpnAdmclExtpySum)).subtract(ucstNoSumD9500400);
...
//                                                          //  } 
        ...
        //                                                   payr0302Vo.setRevnAddr(payr0302Vo.getRevnAddr());    /** column 수정주소 : revnAddr */   
                                                           ...
                                                           BigDecimal baseUsalyAmnt = payr0410.getMnthUsalyAmntWag();
	                                                       
	                                                       BigDecimal totBnusAmnt = BigDecimal.ZERO;
	                                                       
	                                                       totBnusAmnt = (baseUsalyAmnt.multiply((payr0410.getPymtDducRate().divide(new BigDecimal("100"))))).setScale(-1,BigDecimal.ROUND_DOWN) ;
	                                                       
                                                           
                                                           tpPymtTotAmnt = tpPymtTotAmnt.add(totBnusAmnt);
                                                           tpExtpyTotAmnt = tpExtpyTotAmnt.add(totBnusAmnt);
                                                           tpFreeDtyTotAmnt = tpFreeDtyTotAmnt.add(payr0410.getFreeDtySum().setScale(-1,BigDecimal.ROUND_DOWN)); 
                                                           if (BigDecimal.ZERO.compareTo(payr0302Vo.getPymtDducSum()) < 0)  {
                                                        	   payrCommCalcService.insertPayr0302(payr0302Vo); 
                                                           }  
...
//	                                              List listDducPayr0520 = payrCommCalcService.selectPayr0520ToPayrCalcList(payr0520SrhVo);
	                                              ...
	                                              /*########################################################################################*/     
	                                                ...
	                                                payr0520SrhVo.setDpobCd(payr0250Vo.getDpobCd());
	                                                payr0520SrhVo.setSystemkey(payCalculationVo.getSystemkey());
	                                                payr0520SrhVo.setPymtDt(payr0250Vo.getJobYrMnth());  //지급구간 getRflctnBgnnDt
	                                                payr0520SrhVo.setPymtDducDivCd(ExtermsProps.getProps("PYMT_DDUC_DIV_CD_02"));
	                                                //공제테이블 
	                                                List listPymtPayr0520 = payrCommCalcService.selectPayr0520ToPayrCalcList(payr0520SrhVo);
