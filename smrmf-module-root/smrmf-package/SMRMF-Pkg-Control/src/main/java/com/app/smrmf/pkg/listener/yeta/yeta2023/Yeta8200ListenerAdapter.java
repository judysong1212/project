...
public class Yeta8200ListenerAdapter  implements ServletContextAware, ServletConfigAware  {

	  static final Logger LOGGER = LoggerFactory.getLogger(Yeta8200ListenerAdapter.class);
	...
	public Yeta8200ListenerAdapter() {
