...
import com.app.smrmf.pkg.proc.yeta.generics.yeta2016.Yeta1100AnYangProcContainer;
import com.app.smrmf.pkg.proc.yeta.generics.yeta2016.Yeta1100YongInProcContainer;
import com.ext.constants.PropPayGenConfs;
import com.ext.constants.SysmConf;
import com.extjs.gxt.ui.client.data.PagingLoadResult;


public class Yeta1100ListenerAdapter  implements ServletContextAware, ServletConfigAware  {

	static final Logger LOGGER = LoggerFactory.getLogger(Yeta1100ListenerAdapter.class);
	...
	public Yeta1100ListenerAdapter() {
	...
	/** 2016 연말정산 대상자 생성 **/ 
	public PagingLoadResult<ShowMessageBM> setYetaPayr06420_All_Create( HttpServletRequest request,List<InfcPkgYeta1000VO> listYetaPrc1000Vo)  throws Exception  {
		   ...
		   // Long result = new Long(0); 
	        ...
	        if (PropPayGenConfs.PAYGEN_MUNICIPALITIES_01.equals(extGlobals.get("PayGen.MunicipalitiesName"))) {
			    ...
			    retval =   ppc.execYeta1100_All_Create(request, listYetaPrc1000Vo); 
...
//			    retval =   ppc.execYetaPayr06420_All_Create(request, yetaPrc1000Vo); 
	...
	/** 급여자료이관 **/	
	public PagingLoadResult<ShowMessageBM> setYetaPayr06420_All_Add_Create( HttpServletRequest request,List<InfcPkgYeta2000VO> lstYeta2000Vo)  throws Exception  {
	...
	public PagingLoadResult<ShowMessageBM> setPayrToYeta_Insert( HttpServletRequest request,List<InfcPkgYeta2000VO>  lstInfcPkgYeta2000Vo)  throws Exception  {
			   ...
			   // Long result = new Long(0); 
		        ...
		        if (PropPayGenConfs.PAYGEN_MUNICIPALITIES_01.equals(extGlobals.get("PayGen.MunicipalitiesName"))) {
		        	...
		        	Yeta1100YongInProcContainer ppc = new Yeta1100YongInProcContainer();
 				    retval =   ppc.execPayrToYeta_2016_Insert(request, lstInfcPkgYeta2000Vo); 
