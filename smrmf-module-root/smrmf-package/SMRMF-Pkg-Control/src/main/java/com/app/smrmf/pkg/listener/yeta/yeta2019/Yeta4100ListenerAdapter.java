...
import com.app.smrmf.pkg.proc.yeta.generics.yeta2019.Yeta4100YongInProcContainer;
import com.app.smrmf.pkg.proc.yeta.generics.yeta2019.Yeta4100SuWonProcContainer;
import com.app.smrmf.pkg.proc.yeta.generics.yeta2019.Yeta4100AnSeongProcContainer;
import com.app.smrmf.pkg.proc.yeta.generics.yeta2019.Yeta4100AnYangProcContainer;
import com.app.smrmf.pkg.proc.yeta.generics.yeta2019.Yeta4100GMProcContainer;

/*import com.app.smrmf.pkg.proc.yeta.generics.yeta2019.Yeta3100AnDongProcContainer;
import com.app.smrmf.pkg.proc.yeta.generics.yeta2019.Yeta3100GWGSProcContainer;
import com.app.smrmf.pkg.proc.yeta.generics.yeta2019.Yeta3100GeoChangProcContainer;
import com.app.smrmf.pkg.proc.yeta.generics.yeta2019.Yeta3100GeoJeProcContainer;
import com.app.smrmf.pkg.proc.yeta.generics.yeta2019.Yeta3100GimCheonProcContainer;
import com.app.smrmf.pkg.proc.yeta.generics.yeta2019.Yeta3100GimHaeProcContainer;
import com.app.smrmf.pkg.proc.yeta.generics.yeta2019.Yeta3100GoeSanProcContainer;
import com.app.smrmf.pkg.proc.yeta.generics.yeta2019.Yeta3100HygnProcContainer;
import com.app.smrmf.pkg.proc.yeta.generics.yeta2019.Yeta3100JeJuProcContainer;
import com.app.smrmf.pkg.proc.yeta.generics.yeta2019.Yeta3100JeonNamProcContainer;
import com.app.smrmf.pkg.proc.yeta.generics.yeta2019.Yeta3100JinAnProcContainer;
import com.app.smrmf.pkg.proc.yeta.generics.yeta2019.Yeta3100MirYangProcContainer;
import com.app.smrmf.pkg.proc.yeta.generics.yeta2019.Yeta3100MuJuProcContainer;
import com.app.smrmf.pkg.proc.yeta.generics.yeta2019.Yeta3100OkCheonProcContainer;
import com.app.smrmf.pkg.proc.yeta.generics.yeta2019.Yeta3100SamCheokProcContainer;
import com.app.smrmf.pkg.proc.yeta.generics.yeta2019.Yeta3100SunCheonProcContainer;
import com.app.smrmf.pkg.proc.yeta.generics.yeta2019.Yeta3100UlJuProcContainer;
import com.app.smrmf.pkg.proc.yeta.generics.yeta2019.Yeta3100UlSanNamGuProcContainer;
import com.app.smrmf.pkg.proc.yeta.generics.yeta2019.Yeta3100UscProcContainer;
import com.app.smrmf.pkg.proc.yeta.generics.yeta2019.Yeta3100YangJuProcContainer;
import com.app.smrmf.pkg.proc.yeta.generics.yeta2019.Yeta3100YangPyeongProcContainer;
*/
...
public class Yeta4100ListenerAdapter  implements ServletContextAware, ServletConfigAware  {

	  static final Logger LOGGER = LoggerFactory.getLogger(Yeta4100ListenerAdapter.class);
   ...
   @Override
	...
	public Yeta4100ListenerAdapter() {
	 ...
	 public PagingLoadResult<ShowMessageBM> setUpDpopYeta_2019_Insert( HttpServletRequest request,List<InfcPkgYe161010_2019_VO> listYe161010VO)  throws Exception  {
		   ...
		   // Long result = new Long(0); 
	        ...
	        if (PropPayGenConfs.PAYGEN_MUNICIPALITIES_01.equals(extGlobals.get("PayGen.MunicipalitiesName"))) {
	 			//용인로직  
	        	Yeta4100YongInProcContainer ppc = new Yeta4100YongInProcContainer();
			    retval =   ppc.execUpDpopYeta_2019_Insert(request, listYe161010VO); 
	        } else if (PropPayGenConfs.PAYGEN_MUNICIPALITIES_04.equals(extGlobals.get("PayGen.MunicipalitiesName"))) {
	 			//안양로직 																			
	 			Yeta4100AnYangProcContainer ppc = new Yeta4100AnYangProcContainer();
	 		    retval =   ppc.execUpDpopYeta_2019_Insert(request, listYe161010VO); 
	 		} else if (PropPayGenConfs.PAYGEN_MUNICIPALITIES_05.equals(extGlobals.get("PayGen.MunicipalitiesName"))) {
	 			//광명로직 
	 			Yeta4100GMProcContainer ppc = new Yeta4100GMProcContainer();
			    retval =   ppc.execUpDpopYeta_2019_Insert(request, listYe161010VO); 
	 			...
	 			//public static final String PAYGEN_MUNICIPALITIES_15 = "ANSEONG";    //안성
	  			Yeta4100AnSeongProcContainer ppc = new Yeta4100AnSeongProcContainer();
			    retval =   ppc.execUpDpopYeta_2019_Insert(request, listYe161010VO); 
	 		
	 		} else if (PropPayGenConfs.PAYGEN_MUNICIPALITIES_07.equals(extGlobals.get("PayGen.MunicipalitiesName"))) {
	 			//수원로직 
	 			Yeta4100SuWonProcContainer ppc = new Yeta4100SuWonProcContainer();
			    retval =   ppc.execUpDpopYeta_2019_Insert(request, listYe161010VO); 
	  		...
	  		// public static final String PAYGEN_MUNICIPALITIES_20 = "JINAN";       //진안 
			    ...
			    retval =   ppc.execUpDpopYeta_2019_Insert(request, listYe161010VO); 
		  		 ...
		  		 //public static final String PAYGEN_MUNICIPALITIES_23 = "MUJU";       //무주군청 -2019년도 
	 ...
	 public PagingLoadResult<ShowMessageBM> setYetaP410001ToAll_2019_Create( HttpServletRequest request,List<InfcPkgYe161010_2019_VO> listYe161010VO)  throws Exception  {
		   ...
		   // Long result = new Long(0); 
	        ...
	        if (PropPayGenConfs.PAYGEN_MUNICIPALITIES_01.equals(extGlobals.get("PayGen.MunicipalitiesName"))) {
	        	...
	        	Yeta4100YongInProcContainer ppc = new Yeta4100YongInProcContainer();
			    retval =   ppc.execYeta4100_All_2019_Create(request, listYe161010VO); 
			 
	        } else if (PropPayGenConfs.PAYGEN_MUNICIPALITIES_04.equals(extGlobals.get("PayGen.MunicipalitiesName"))) {
	 			//안양로직 
	 			Yeta4100AnYangProcContainer ppc = new Yeta4100AnYangProcContainer();
	 		    retval =   ppc.execYeta4100_All_Create(request, listYe161010VO); 
		...
		// 급여대상자이관 
		public PagingLoadResult<ShowMessageBM> setPayrToYeta_2019_Insert( HttpServletRequest request,List<InfcPkgYe161010_2019_VO> listYe161010VO)  throws Exception  {
			   ...
			   // Long result = new Long(0); 
		        ...
		        if (PropPayGenConfs.PAYGEN_MUNICIPALITIES_01.equals(extGlobals.get("PayGen.MunicipalitiesName"))) {
		 			//용인로직 
		        	Yeta4100YongInProcContainer ppc = new Yeta4100YongInProcContainer();
				    retval =   ppc.execPayrToYeta_2019_Insert(request, listYe161010VO); 
