...
import com.app.smrmf.pkg.proc.yeta.generics.yeta2018.Yeta3100AnDongProcContainer;
import com.app.smrmf.pkg.proc.yeta.generics.yeta2018.Yeta3100GMProcContainer;
import com.app.smrmf.pkg.proc.yeta.generics.yeta2018.Yeta3100GWGSProcContainer;
import com.app.smrmf.pkg.proc.yeta.generics.yeta2018.Yeta3100GeoChangProcContainer;
import com.app.smrmf.pkg.proc.yeta.generics.yeta2018.Yeta3100GeoJeProcContainer;
import com.app.smrmf.pkg.proc.yeta.generics.yeta2018.Yeta3100GimCheonProcContainer;
import com.app.smrmf.pkg.proc.yeta.generics.yeta2018.Yeta3100GimHaeProcContainer;
import com.app.smrmf.pkg.proc.yeta.generics.yeta2018.Yeta3100GoeSanProcContainer;
import com.app.smrmf.pkg.proc.yeta.generics.yeta2018.Yeta3100HygnProcContainer;
import com.app.smrmf.pkg.proc.yeta.generics.yeta2018.Yeta3100JeJuProcContainer;
import com.app.smrmf.pkg.proc.yeta.generics.yeta2018.Yeta3100JeonNamProcContainer;
import com.app.smrmf.pkg.proc.yeta.generics.yeta2018.Yeta3100JinAnProcContainer;
import com.app.smrmf.pkg.proc.yeta.generics.yeta2018.Yeta3100MirYangProcContainer;
import com.app.smrmf.pkg.proc.yeta.generics.yeta2018.Yeta3100MuJuProcContainer;
import com.app.smrmf.pkg.proc.yeta.generics.yeta2018.Yeta3100OkCheonProcContainer;
import com.app.smrmf.pkg.proc.yeta.generics.yeta2018.Yeta3100SamCheokProcContainer;
import com.app.smrmf.pkg.proc.yeta.generics.yeta2018.Yeta3100SuWonProcContainer;
import com.app.smrmf.pkg.proc.yeta.generics.yeta2018.Yeta3100SunCheonProcContainer;
import com.app.smrmf.pkg.proc.yeta.generics.yeta2018.Yeta3100UlJuProcContainer;
import com.app.smrmf.pkg.proc.yeta.generics.yeta2018.Yeta3100UlSanNamGuProcContainer;
import com.app.smrmf.pkg.proc.yeta.generics.yeta2018.Yeta3100UscProcContainer;
import com.app.smrmf.pkg.proc.yeta.generics.yeta2018.Yeta3100YangJuProcContainer;
import com.app.smrmf.pkg.proc.yeta.generics.yeta2018.Yeta3100YangPyeongProcContainer;
import com.app.smrmf.pkg.proc.yeta.generics.yeta2018.Yeta3100YongInProcContainer;
import com.app.smrmf.pkg.proc.yeta.generics.yeta2018.Yeta3100GMProcContainer;
import com.app.smrmf.pkg.proc.yeta.generics.yeta2018.Yeta3100AnSeongProcContainer;
import com.app.smrmf.pkg.proc.yeta.generics.yeta2018.Yeta3100AnYangProcContainer;
...
public class Yeta3100ListenerAdapter  implements ServletContextAware, ServletConfigAware  {

	  static final Logger LOGGER = LoggerFactory.getLogger(Yeta3100ListenerAdapter.class);
   ...
   @Override
	...
	public Yeta3100ListenerAdapter() {
	 ...
	 public PagingLoadResult<ShowMessageBM> setUpDpopYeta_2018_Insert( HttpServletRequest request,List<InfcPkgYe161010_2018_VO> listYe161010VO)  throws Exception  {
		   ...
		   // Long result = new Long(0); 
	        ...
	        if (PropPayGenConfs.PAYGEN_MUNICIPALITIES_01.equals(extGlobals.get("PayGen.MunicipalitiesName"))) {
	 			//용인로직  
	        	Yeta3100YongInProcContainer ppc = new Yeta3100YongInProcContainer();
			    retval =   ppc.execUpDpopYeta_2018_Insert(request, listYe161010VO); 
			    ...
			    retval =   ppc.execUpDpopYeta_2018_Insert(request, listYe161010VO); 
	 			...
	 			//안양로직 
	 			Yeta3100AnYangProcContainer ppc = new Yeta3100AnYangProcContainer();
	 		    retval =   ppc.execUpDpopYeta_2018_Insert(request, listYe161010VO); 
				  
			 
	 		} else if (PropPayGenConfs.PAYGEN_MUNICIPALITIES_05.equals(extGlobals.get("PayGen.MunicipalitiesName"))) {
	 			//광명로직 
	 			Yeta3100GMProcContainer ppc = new Yeta3100GMProcContainer();
			    retval =   ppc.execUpDpopYeta_2018_Insert(request, listYe161010VO); 
			    ...
			    retval =   ppc.execUpDpopYeta_2018_Insert(request, listYe161010VO); 
	 			...
	 			//수원로직 
	 			Yeta3100SuWonProcContainer ppc = new Yeta3100SuWonProcContainer();
			    retval =   ppc.execUpDpopYeta_2018_Insert(request, listYe161010VO); 
			    ...
			    retval =   ppc.execUpDpopYeta_2018_Insert(request, listYe161010VO); 
	 			...
	 			//public static final String PAYGEN_MUNICIPALITIES_15 = "ANSEONG";    //안성
	  			Yeta3100AnSeongProcContainer ppc = new Yeta3100AnSeongProcContainer();
			    retval =   ppc.execUpDpopYeta_2018_Insert(request, listYe161010VO); 
	 ...
	 public PagingLoadResult<ShowMessageBM> setYetaP310001ToAll_2018_Create( HttpServletRequest request,List<InfcPkgYe161010_2018_VO> listYe161010VO)  throws Exception  {
		   ...
		   // Long result = new Long(0); 
	        ...
	        if (PropPayGenConfs.PAYGEN_MUNICIPALITIES_01.equals(extGlobals.get("PayGen.MunicipalitiesName"))) {
	        	...
	        	Yeta3100YongInProcContainer ppc = new Yeta3100YongInProcContainer();
			    retval =   ppc.execYeta3100_All_2018_Create(request, listYe161010VO); 
...
//				     retval =   ppc.execPayrToYeta_2016_Insert(request, lstYeta3000Vo); 
//		    	} else if (PropPayGenConfs.PAYGEN_MUNICIPALITIES_02.equals(extGlobals.get("PayGen.MunicipalitiesName"))) {
//		 			//김해로직 
//	 
//				 
...
//				     retval =   ppc.execPayrToYeta_2018_Insert(request, lstYeta3000Vo); 
//					  
//				 
//		 		} else if (PropPayGenConfs.PAYGEN_MUNICIPALITIES_05.equals(extGlobals.get("PayGen.MunicipalitiesName"))) {
//		 			//광명로직 
...
//			}
		...
		// 급여대상자이관 
		public PagingLoadResult<ShowMessageBM> setPayrToYeta_2018_Insert( HttpServletRequest request,List<InfcPkgYe161010_2018_VO> listYe161010VO)  throws Exception  {
			   ...
			   // Long result = new Long(0); 
		        ...
		        if (PropPayGenConfs.PAYGEN_MUNICIPALITIES_01.equals(extGlobals.get("PayGen.MunicipalitiesName"))) {
		 			//용인로직 
		        	Yeta3100YongInProcContainer ppc = new Yeta3100YongInProcContainer();
				    retval =   ppc.execPayrToYeta_2018_Insert(request, listYe161010VO); 
...
//		public PagingLoadResult<ShowMessageBM> fnYeta0300Payr06430CalcTax( HttpServletRequest request,List<InfcPkgYeta3000VO>  lstInfcPkgYeta3000Vo )  throws Exception  {
//			
//			   
//			   // Long result = new Long(0); 
//				PagingLoadResult<ShowMessageBM> retval = null;
...
//				   // retval =   ppc.execfnYeta0300Payr06430CalcTax(request, lstInfcPkgYeta3000Vo); 
//				 
//		 		} else if (PropPayGenConfs.PAYGEN_MUNICIPALITIES_02.equals(extGlobals.get("PayGen.MunicipalitiesName"))) {
//		 			//김해로직 
//	 
