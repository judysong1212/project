...
public class Yeta3200ListenerAdapter  implements ServletContextAware, ServletConfigAware  {

	  static final Logger LOGGER = LoggerFactory.getLogger(Yeta3200ListenerAdapter.class);
	...
	public Yeta3200ListenerAdapter() {
