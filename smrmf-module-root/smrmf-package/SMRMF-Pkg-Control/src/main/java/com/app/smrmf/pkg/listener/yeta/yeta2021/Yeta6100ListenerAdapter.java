...
import com.app.smrmf.pkg.proc.yeta.generics.yeta2021.Yeta6100YongInProcContainer;
import com.app.smrmf.pkg.proc.yeta.generics.yeta2021.Yeta6100SuWonProcContainer;
import com.app.smrmf.pkg.proc.yeta.generics.yeta2021.Yeta6100AnSeongProcContainer;
import com.app.smrmf.pkg.proc.yeta.generics.yeta2021.Yeta6100AnYangProcContainer;
import com.app.smrmf.pkg.proc.yeta.generics.yeta2021.Yeta6100GMProcContainer;

/*import com.app.smrmf.pkg.proc.yeta.generics.yeta2021.Yeta3100AnDongProcContainer;
import com.app.smrmf.pkg.proc.yeta.generics.yeta2021.Yeta3100GWGSProcContainer;
import com.app.smrmf.pkg.proc.yeta.generics.yeta2021.Yeta3100GeoChangProcContainer;
import com.app.smrmf.pkg.proc.yeta.generics.yeta2021.Yeta3100GeoJeProcContainer;
import com.app.smrmf.pkg.proc.yeta.generics.yeta2021.Yeta3100GimCheonProcContainer;
import com.app.smrmf.pkg.proc.yeta.generics.yeta2021.Yeta3100GimHaeProcContainer;
import com.app.smrmf.pkg.proc.yeta.generics.yeta2021.Yeta3100GoeSanProcContainer;
import com.app.smrmf.pkg.proc.yeta.generics.yeta2021.Yeta3100HygnProcContainer;
import com.app.smrmf.pkg.proc.yeta.generics.yeta2021.Yeta3100JeJuProcContainer;
import com.app.smrmf.pkg.proc.yeta.generics.yeta2021.Yeta3100JeonNamProcContainer;
import com.app.smrmf.pkg.proc.yeta.generics.yeta2021.Yeta3100JinAnProcContainer;
import com.app.smrmf.pkg.proc.yeta.generics.yeta2021.Yeta3100MirYangProcContainer;
import com.app.smrmf.pkg.proc.yeta.generics.yeta2021.Yeta3100MuJuProcContainer;
import com.app.smrmf.pkg.proc.yeta.generics.yeta2021.Yeta3100OkCheonProcContainer;
import com.app.smrmf.pkg.proc.yeta.generics.yeta2021.Yeta3100SamCheokProcContainer;
import com.app.smrmf.pkg.proc.yeta.generics.yeta2021.Yeta3100SunCheonProcContainer;
import com.app.smrmf.pkg.proc.yeta.generics.yeta2021.Yeta3100UlJuProcContainer;
import com.app.smrmf.pkg.proc.yeta.generics.yeta2021.Yeta3100UlSanNamGuProcContainer;
import com.app.smrmf.pkg.proc.yeta.generics.yeta2021.Yeta3100UscProcContainer;
import com.app.smrmf.pkg.proc.yeta.generics.yeta2021.Yeta3100YangJuProcContainer;
import com.app.smrmf.pkg.proc.yeta.generics.yeta2021.Yeta3100YangPyeongProcContainer;
*/
...
public class Yeta6100ListenerAdapter  implements ServletContextAware, ServletConfigAware  {

	  static final Logger LOGGER = LoggerFactory.getLogger(Yeta6100ListenerAdapter.class);
   ...
   @Override
	...
	public Yeta6100ListenerAdapter() {
	 ...
	 public PagingLoadResult<ShowMessageBM> setUpDpopYeta_2021_Insert( HttpServletRequest request,List<InfcPkgYe161010_2021_VO> listYe161010VO)  throws Exception  {
		   ...
		   // Long result = new Long(0); 
	        ...
	        if (PropPayGenConfs.PAYGEN_MUNICIPALITIES_01.equals(extGlobals.get("PayGen.MunicipalitiesName"))) {
	 			//용인로직  
	        	Yeta6100YongInProcContainer ppc = new Yeta6100YongInProcContainer();
			    retval =   ppc.execUpDpopYeta_2021_Insert(request, listYe161010VO); 
	        } else if (PropPayGenConfs.PAYGEN_MUNICIPALITIES_04.equals(extGlobals.get("PayGen.MunicipalitiesName"))) {
	 			//안양로직 																			
	 			Yeta6100AnYangProcContainer ppc = new Yeta6100AnYangProcContainer();
	 		    retval =   ppc.execUpDpopYeta_2021_Insert(request, listYe161010VO); 
	 		} else if (PropPayGenConfs.PAYGEN_MUNICIPALITIES_05.equals(extGlobals.get("PayGen.MunicipalitiesName"))) {
	 			//광명로직 
	 			Yeta6100GMProcContainer ppc = new Yeta6100GMProcContainer();
			    retval =   ppc.execUpDpopYeta_2021_Insert(request, listYe161010VO); 
	 			...
	 			//public static final String PAYGEN_MUNICIPALITIES_15 = "ANSEONG";    //안성
	  			Yeta6100AnSeongProcContainer ppc = new Yeta6100AnSeongProcContainer();
			    retval =   ppc.execUpDpopYeta_2021_Insert(request, listYe161010VO); 
	 		
	 		} else if (PropPayGenConfs.PAYGEN_MUNICIPALITIES_07.equals(extGlobals.get("PayGen.MunicipalitiesName"))) {
	 			//수원로직 
	 			Yeta6100SuWonProcContainer ppc = new Yeta6100SuWonProcContainer();
			    retval =   ppc.execUpDpopYeta_2021_Insert(request, listYe161010VO); 
	  		...
	  		// public static final String PAYGEN_MUNICIPALITIES_20 = "JINAN";       //진안 
			    ...
			    retval =   ppc.execUpDpopYeta_2021_Insert(request, listYe161010VO); 
		  		 ...
		  		 //public static final String PAYGEN_MUNICIPALITIES_23 = "MUJU";       //무주군청 -2021년도 
	 ...
	 public PagingLoadResult<ShowMessageBM> setYetaP610001ToAll_2021_Create( HttpServletRequest request,List<InfcPkgYe161010_2021_VO> listYe161010VO)  throws Exception  {
		   ...
		   // Long result = new Long(0); 
	        ...
	        if (PropPayGenConfs.PAYGEN_MUNICIPALITIES_01.equals(extGlobals.get("PayGen.MunicipalitiesName"))) {
	        	...
	        	Yeta6100YongInProcContainer ppc = new Yeta6100YongInProcContainer();
			    retval =   ppc.execYeta6100_All_2021_Create(request, listYe161010VO); 
			 
	        } else if (PropPayGenConfs.PAYGEN_MUNICIPALITIES_04.equals(extGlobals.get("PayGen.MunicipalitiesName"))) {
	 			//안양로직 
	 			Yeta6100AnYangProcContainer ppc = new Yeta6100AnYangProcContainer();
	 		    retval =   ppc.execYeta6100_All_Create(request, listYe161010VO); 
		...
		// 급여대상자이관 
		public PagingLoadResult<ShowMessageBM> setPayrToYeta_2021_Insert( HttpServletRequest request,List<InfcPkgYe161010_2021_VO> listYe161010VO)  throws Exception  {
			   ...
			   // Long result = new Long(0); 
		        ...
		        if (PropPayGenConfs.PAYGEN_MUNICIPALITIES_01.equals(extGlobals.get("PayGen.MunicipalitiesName"))) {
		 			//용인로직 
		        	Yeta6100YongInProcContainer ppc = new Yeta6100YongInProcContainer();
				    retval =   ppc.execPayrToYeta_2021_Insert(request, listYe161010VO); 
