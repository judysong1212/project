...
public class Yeta5200ListenerAdapter  implements ServletContextAware, ServletConfigAware  {

	  static final Logger LOGGER = LoggerFactory.getLogger(Yeta5200ListenerAdapter.class);
	...
	public Yeta5200ListenerAdapter() {
