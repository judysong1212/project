...
public class Yeta7200ListenerAdapter  implements ServletContextAware, ServletConfigAware  {

	  static final Logger LOGGER = LoggerFactory.getLogger(Yeta7200ListenerAdapter.class);
	...
	public Yeta7200ListenerAdapter() {
