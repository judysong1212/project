...
public class Yeta4200ListenerAdapter  implements ServletContextAware, ServletConfigAware  {

	  static final Logger LOGGER = LoggerFactory.getLogger(Yeta4200ListenerAdapter.class);
	...
	public Yeta4200ListenerAdapter() {
