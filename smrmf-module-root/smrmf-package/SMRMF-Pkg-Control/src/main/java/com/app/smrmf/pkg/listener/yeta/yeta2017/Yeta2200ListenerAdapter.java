...
public class Yeta2200ListenerAdapter  implements ServletContextAware, ServletConfigAware  {

	  static final Logger LOGGER = LoggerFactory.getLogger(Yeta2200ListenerAdapter.class);
	...
	public Yeta2200ListenerAdapter() {
