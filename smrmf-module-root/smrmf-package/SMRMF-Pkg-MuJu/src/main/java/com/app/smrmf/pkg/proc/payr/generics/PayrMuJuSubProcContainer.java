 ...
 */
@Controller 
public class PayrMuJuSubProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(PayrMuJuSubProcContainer.class);
