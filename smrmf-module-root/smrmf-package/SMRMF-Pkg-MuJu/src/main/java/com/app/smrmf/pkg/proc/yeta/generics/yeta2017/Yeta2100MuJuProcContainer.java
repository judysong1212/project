 ...
 */
@Controller 
public class Yeta2100MuJuProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta2100MuJuProcContainer.class);
...
//
    ...
    public Yeta2100MuJuProcContainer() {
