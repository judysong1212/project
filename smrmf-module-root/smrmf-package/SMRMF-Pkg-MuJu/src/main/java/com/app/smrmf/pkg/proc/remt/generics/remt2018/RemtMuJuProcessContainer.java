 ...
 */
@Controller 
public class RemtMuJuProcessContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(RemtMuJuProcessContainer.class);
    private static final String calledClass = RemtMuJuProcessContainer.class.getName();
