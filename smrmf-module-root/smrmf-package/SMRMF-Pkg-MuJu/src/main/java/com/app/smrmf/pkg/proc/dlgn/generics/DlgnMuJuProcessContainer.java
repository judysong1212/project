...
public class DlgnMuJuProcessContainer {
	

	private static final Logger logger = LoggerFactory.getLogger(DlgnMuJuProcessContainer.class);
	   
    @Resource(name = "ManageCommuteService")
    protected ManageCommuteService manageCommuteService;

    public DlgnMuJuProcessContainer() {
