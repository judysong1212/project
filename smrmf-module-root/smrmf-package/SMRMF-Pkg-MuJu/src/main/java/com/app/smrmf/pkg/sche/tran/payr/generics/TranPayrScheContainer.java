package com.app.smrmf.pkg.sche.tran.payr.generics;
...
@Controller  
public class TranPayrScheContainer {


	private static final Logger LOGGER = LoggerFactory.getLogger(TranPayrScheContainer.class);
		          ...
		          //  if (map.get("logSvcYrNumCd01").equals(map.get("logSvcYrNumCd02"))) {
					 ...
					 if (MSFSharedUtils.paramNull(map.get("turtyRntmntDt"))) {
						  //*******************************************************************************************************/
			            	...
			            	infcPsnl0123Dto.setTurtyRntmntDt( SmrmfUtils.getDateFromString(String.valueOf(map.get("levfAbncEndDt")),"yyyyMMdd") );   //마스터 재직변경 
