 ...
 */
@Controller 
public class Yeta3300MuJuProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta3300MuJuProcContainer.class);
    ...
    public Yeta3300MuJuProcContainer() {
