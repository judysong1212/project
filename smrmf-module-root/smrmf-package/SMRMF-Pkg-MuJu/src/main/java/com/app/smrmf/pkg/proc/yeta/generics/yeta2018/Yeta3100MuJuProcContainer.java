 ...
 */
@Controller 
public class Yeta3100MuJuProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta3100MuJuProcContainer.class);
...
//
    ...
    public Yeta3100MuJuProcContainer() {
