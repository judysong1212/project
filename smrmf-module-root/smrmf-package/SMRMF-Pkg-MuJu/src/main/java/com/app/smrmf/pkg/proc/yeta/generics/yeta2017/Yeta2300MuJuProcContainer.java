 ...
 */
@Controller 
public class Yeta2300MuJuProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta2300MuJuProcContainer.class);
    ...
    public Yeta2300MuJuProcContainer() {
