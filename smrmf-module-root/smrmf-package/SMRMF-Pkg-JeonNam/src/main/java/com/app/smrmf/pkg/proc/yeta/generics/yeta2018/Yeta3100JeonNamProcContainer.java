 ...
 */
@Controller 
public class Yeta3100JeonNamProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta3100JeonNamProcContainer.class);
...
//
    ...
    public Yeta3100JeonNamProcContainer() {
