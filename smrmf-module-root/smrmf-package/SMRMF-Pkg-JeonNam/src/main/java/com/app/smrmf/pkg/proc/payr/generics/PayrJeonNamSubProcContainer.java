 ...
 */
@Controller 
public class PayrJeonNamSubProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(PayrJeonNamSubProcContainer.class);
