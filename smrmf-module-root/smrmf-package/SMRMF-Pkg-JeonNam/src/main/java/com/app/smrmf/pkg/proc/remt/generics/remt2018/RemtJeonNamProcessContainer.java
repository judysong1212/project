 ...
 */
@Controller 
public class RemtJeonNamProcessContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(RemtJeonNamProcessContainer.class);
    private static final String calledClass = RemtJeonNamProcessContainer.class.getName();
