 ...
 */
@Controller 
public class Yeta2300JeonNamProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta2300JeonNamProcContainer.class);
    ...
    public Yeta2300JeonNamProcContainer() {
