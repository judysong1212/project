...
public class PayCalculationDAO extends EgovAbstractDAO {
     ...
     * @throws Exception
     */
    public List<PkgPayrCommCalcVO> selectJeonNamPayrInfoList(InfcPkgPayr0250VO searchVO) throws Exception {
        return (List<PkgPayrCommCalcVO>)list("payCalculationDAO.selectJeonNamPayrInfoList_D", searchVO);
    }
