 ...
 */
@Controller 
public class Yeta3300JeonNamProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta3300JeonNamProcContainer.class);
    ...
    public Yeta3300JeonNamProcContainer() {
