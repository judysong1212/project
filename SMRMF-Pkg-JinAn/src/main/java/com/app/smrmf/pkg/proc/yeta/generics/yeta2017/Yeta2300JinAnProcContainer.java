 ...
 */
@Controller 
public class Yeta2300JinAnProcContainer  extends AbstractCustomServiceImpl {
	

	private static final Logger logger = LoggerFactory.getLogger(Yeta2300JinAnProcContainer.class);
    ...
    public Yeta2300JinAnProcContainer() {
