...
//            	addTrigger(Events.KeyUp, changeValueListenerAdapter4);
        ...
        listColumnDefs.add(new ColumnDef("위생일수", Dlgn0250BM.ATTR_DILNLAZHLTHCRENUMDYS, ColumnDef.TYPE_STRING , 60, false, true, false){
            {
            	setRegEx("^[+-]?\\d*(\\.?\\d*)$");
            	setSelectOnFocus(true);
            }
...
//            	setReadOnly(true);
    	...
    	listColumnDefs.add(new ColumnDef("복무통합구분값", Dlgn0250BM.ATTR_TYPOCCUBUSINVAL, ColumnDef.TYPE_STRING , 90, false, false, false){
    		{
