               ...
               if (!statTrue) {
            	   return ;
	                ...
	                while (records.hasNext()) {
	                    ...
	                    dlgn0250Dto.setTypOccuBusinVal(MSFSharedUtils.allowNulls(bmMapModel.get("typOccuBusinVal"))); 							/** column 복무통합구분값 : typOccuBusinVal */
	                  ...
	                  //  dlgn0250Dto.setPyspGrdeCd(MSFSharedUtils.allowNulls(bmMapModel.get("pyspGrdeCd")));    /** column 호봉등급코드 : pyspGrdeCd */
	                    ...
	                    dlgn0250Dto.setDilnlazSppySnkfNumDys(MSFSharedUtils.allowNulls(bmMapModel.get("dilnlazSppySnkfNumDys")));  				/** column 근태_간식비일수 : dilnlazSppySnkfNumDys */
	                    dlgn0250Dto.setDilnlazNgtdyNumDys(MSFSharedUtils.allowNulls(bmMapModel.get("dilnlazNgtdyNumDys"))); 					/** column 근태_숙직일수 : dilnlazNgtdyNumDys */
...
//	        layoutContainer_16.setLayout(frmlytSch);
	        ...
	        lcSchCol3.add(layoutContainer_1,new com.extjs.gxt.ui.client.widget.layout.ColumnData(.3));	//급여구분 	
...
//	    dlgn0250GridPanel.getMsfGrid().setCellModel(true);
	    ...
	    dlgn0250GridPanel.getGrid().getColumnModel().addHeaderGroup(0, 23, new HeaderGroupConfig("휴일근무", 1, 3));
	    dlgn0250GridPanel.getGrid().getColumnModel().addHeaderGroup(0, 30, new HeaderGroupConfig("시간외 근무", 1, 3));
...
//			
		  if("".equals(MSFSharedUtils.getSelectedComboValue(srhBusinCd,"businCd"))){
      	     if (MSFConfiguration.EMYMT_DIVCD02.equals(MSFSharedUtils.getSelectedComboValue(srhEmymtDivCd,"commCd")) && "".equals(DlgnUtils.getSelectedComboValue(srhMangeDeptCd,"mangeDeptCd"))) {
            ...
            //20180305추가 
            dlgn0250GridPanel.getTableDef().addColumnFilter("mangeDeptCd", MSFSharedUtils.getSelectedComboValue(srhMangeDeptCd,"mangeDeptCd"), SimpleColumnFilter.OPERATOR_EQUALS); 
...
//		if(soctyInsurCmptnDt01 != null && !"".equals(soctyInsurCmptnDt01)) {
			...
			serarchParam += "" + mangeDeptCd														+ "⊥";	/*$23 관리부서				*/
   ...
   //엑셀 저장(상단)
	private void excelFileExport() {
		...
		if ("".equals(year) || "".equals(month)) {
			...
			if ("".equals(MSFSharedUtils.getSelectedComboValue(srhBusinCd,"businCd")) && "".equals(DlgnUtils.getSelectedComboValue(srhMangeDeptCd,"mangeDeptCd")) ) {
