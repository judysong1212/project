...
//		buttonBar.add(topBtn);
		...
		plFrmDlgn0200.setSize("990px", "800px"); 
	}
...
//	 			dlgn0210dto.setEmymtDivCd(MSFSharedUtils.allowNulls(bmMapModel.get("emymtDivCd")));    /** column 고용구분코드 : emymtDivCd */
	 			...
	 			dlgn0210dto.setTypOccuBusinVal(MSFSharedUtils.allowNulls(bmMapModel.get("typOccuBusinVal"))); 			/** column 복무통합구분값 : typOccuBusinVal */	
...
//	        layoutContainer_16.setLayout(frmlytSch);
	        ...
	        lcSchCol3.add(layoutContainer_4,new com.extjs.gxt.ui.client.widget.layout.ColumnData(.3));	// 성명
...
//		layoutContainer.add(lc4,new com.extjs.gxt.ui.client.widget.layout.ColumnData(.27));
		...
		layoutContainer.add(lcSch2_1,new com.extjs.gxt.ui.client.widget.layout.ColumnData(.3));
...
//        layoutContainer_16.setLayout(frmlytSch);
        ...
        lcSchCol3.add(lc1,new com.extjs.gxt.ui.client.widget.layout.ColumnData(.3));					// 사업
        lcSchCol3.add(lc41,new com.extjs.gxt.ui.client.widget.layout.ColumnData(.27));					// 성명
        lcSchCol3.add(lc4,new com.extjs.gxt.ui.client.widget.layout.ColumnData(.43));	// 
...
//		layoutContainer_5.setBorders(false);
	...
	private void createStandardForm() {
		...
		fieldGridLeft.setSize("330px", "407px");
...
//		fieldRightForm.setSize("625px", "145px");
		...
		fieldRightForm.setSize("635px", "75px");
...
//					detailSystemkey.setValue(se.getSelectedItem().getSystemkey());
					...
					if(MSFConfiguration.EMYMT_DIVCD01.equals(MSFSharedUtils.allowNulls(detailEmymtDivCd.getValue()))) {
						...
						Dlgn0200Grid0210.getTableDef().addColumnFilter("typOccuBusinVal", typOccuBusinVal, SimpleColumnFilter.OPERATOR_EQUALS);
					...
					if(MSFConfiguration.EMYMT_DIVCD01.equals(MSFSharedUtils.allowNulls(detailEmymtDivCd.getValue()))) {
						typOccuBusinVal =  MSFSharedUtils.allowNulls(se.getSelectedItem().getDtilOccuInttnCd());
						Dlgn0200Grid0210_1.getTableDef().addColumnFilter("typOccuBusinVal", typOccuBusinVal, SimpleColumnFilter.OPERATOR_EQUALS);
					}else if(MSFConfiguration.EMYMT_DIVCD02.equals(MSFSharedUtils.allowNulls(detailEmymtDivCd.getValue()))) {
						typOccuBusinVal =  MSFSharedUtils.allowNulls(se.getSelectedItem().getDeptCd()) + MSFSharedUtils.allowNulls(se.getSelectedItem().getBusinCd());
						Dlgn0200Grid0210_1.getTableDef().addColumnFilter("typOccuBusinVal", typOccuBusinVal, SimpleColumnFilter.OPERATOR_EQUALS);
					}
...
//		final String payrMangDeptCd = DlgnUtils.getSelectedComboValue(crePayrMangDeptCd,"payrMangDeptCd");	//단위기관 
		...
		final String payrMangDeptCd = DlgnUtils.getSelectedComboValue(crePayrMangDeptCd,"payrMangDeptCd"); //단위기관
		final String mangeDeptCd = DlgnUtils.getSelectedComboValue(creMangeDeptCd,"mangeDeptCd"); //단위기관
		...
		MessageBox.confirm("근태 생성", "초과근무생성을 하시겠습니까?<br>(등록되어있는 근태가 있을시 삭제 처리 됩니다.)",new Listener<MessageBoxEvent>(){
			...
			public void handleEvent(MessageBoxEvent be) {
				...
				if(Dialog.YES.equals(be.getButtonClicked().getItemId())){
					...
					if("".equals(year) || "".equals(month)){
					...
					}else if( ("".equals(deptCd) || "".equals(deptCd)) && ( "".equals(mangeDeptCd) || "".equals(mangeDeptCd))){
						...
						dto.setMangeDeptCd(mangeDeptCd);		//단위기관
						...
						if(MSFConfiguration.EMYMT_DIVCD01.equals(dto.getEmymtDivCd())) {
							 ...
							 dto.setTypOccuBusinVal( dto.getCurrAffnDeptCd() + dto.getBusinCd());
						}
...
private void xlsExportData() {
		  ...
		  String year = DlgnUtils.getSelectedComboValue(creYear, "year");
			...
			param.put("mangeDeptCd", mangeDeptCd);
