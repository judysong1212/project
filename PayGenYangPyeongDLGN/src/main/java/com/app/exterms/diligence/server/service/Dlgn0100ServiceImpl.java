...
public class Dlgn0100ServiceImpl extends AbstractCustomServiceImpl implements Dlgn0100Service {
	...
	private String detailYmKubn = DiligenceCommonConstants.YANGPYEONG_DLGN_DT_BUNGI;
...
//				dto.setDeptCd(dto.getDeptCd());
		        ...
		        dto.setMangeDeptCd(MSFSharedUtils.allowNulls(dto.getMangeDeptCd()));			// 관리부서
				/******************************** 권한 ************************************************************************/
	            String chkDeptCd = sessionUser.getAuthCheck().getAuthCheck03();
	            if ("FALSE".equals(chkDeptCd)) {
...
//	        	}  
	            ...
	            logger.debug("무기,기간제generateWorkTime메소드,양평");
	            ...
	            while ( iter.hasNext() ) {
			        ...
			        logger.debug("typOccuBusinVal = " + dto.getTypOccuBusinVal());
	...
	//		            }else{ //기준일 후
			                ...
			                //인서트 처리 
				            dlgn0100Dao.insertDlgn0100(dto);
				            logger.debug("무기계약직,기간제insert2양평");
				            if("A0020010".equals(map.get("emymtDivCd"))){ //무기계약직일 경우
				            	logger.debug("무기계약직insert2양평");
				            	dlgn0100Dao.insertDlgn0110(dto);
				            	
				            }else{ //기간제일경우
				            	logger.debug("기간제insert2양평");
				            	dlgn0100Dao.insertDlgn01102(dto);
	...
	//					infcDlgn0100Vo.setResnRegnNum(rrnDecCrypt);
						...
						//광명에는 없음
						infcDlgn0100Vo.setMangeDeptCd(dto.getMangeDeptCd());    		/** column 관리부서코드  mangeDeptCd */
