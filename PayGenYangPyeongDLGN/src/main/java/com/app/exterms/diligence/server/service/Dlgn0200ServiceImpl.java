			...
			try {
	            ...
	            while ( iter.hasNext() ) {
			        ...
			        if( "A0020010".equals(dto.getEmymtDivCd()) && ( "".equals(dto.getTypOccuCd()) || "".equals(dto.getDtilOccuInttnCd()))) {
						...
						infcDlgn0200Vo.setMangeDeptCd(dto.getMangeDeptCd());    					/** column 관리부서코드  mangeDeptCd */
						...
						infcDlgn0200Vo.setTypOccuBusinVal(dto.getTypOccuBusinVal());				/** set 복무통합구분값 : typOccuBusinVal */
			...
			if(list != null && list.size() > 0){
				for(int i = 0; i < list.size(); i++){
					...
					if(MSFConfiguration.EMYMT_DIVCD01.equals(dto.getEmymtDivCd()) || MSFConfiguration.EMYMT_DIVCD01 == dto.getEmymtDivCd()) {
						...
						dtoDlgn0100.setTypOccuBusinVal(dto.getDtilOccuInttnCd());
					}else {
						dto.setTypOccuBusinVal(dto.getDeptCd().concat(dto.getBusinCd()));
						dtoDlgn0100.setTypOccuBusinVal(dto.getDeptCd().concat(dto.getBusinCd()));
					}
...
//    	String nResult = AnyCryptUtils.XecureCryptInitialize(RemoteServiceUtil.getThreadLocalConfig(),RemoteServiceUtil.getThreadLocalRequest());
        ...
        try {
           ...
           // Sysm0470BM          user             = serviceParameters.getUser();
            ...
            dlgn0210SrhVO.setTypOccuBusinVal(MSFSharedUtils.allowNulls(MSFServerUtils.getFilterValue(columnFilters, "typOccuBusinVal")));	 
...
//            }
            ...
            for(int iPayrCnt=0;iPayrCnt < listDlgn0210Dto.size();iPayrCnt++) {
            	...
            	dlgn0210Vo.setTypOccuBusinVal(dlgn0210Dto.getTypOccuBusinVal()); 									/** column 복무통합구분값 : typOccuBusinVal */
...
//				
				...
				infcDlgn0200Vo.setTypOccuBusinVal(dlgn0210Vo.getTypOccuBusinVal()); 			/** column 복무통합구분값 : typOccuBusinVal */
